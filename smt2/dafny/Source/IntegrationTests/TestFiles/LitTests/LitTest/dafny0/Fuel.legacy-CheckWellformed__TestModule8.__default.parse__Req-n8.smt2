...
(declare-fun TestModule8.__default.parse__Request3 (T@U) T@U)
(declare-fun |TestModule8.__default.parse__Request3#canCall| (T@U) Bool)
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|val#0@@1| T@U) ) (!  (=> (or (|TestModule8.__default.parse__Request3#canCall| |val#0@@1|) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |val#0@@1| Tclass.TestModule8.V) (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |val#0@@1| (Lit DatatypeTypeType TestModule8.__default.CRequest__grammar))))) ($Is DatatypeTypeType (TestModule8.__default.parse__Request3 |val#0@@1|) Tclass.TestModule8.CRequest))
 :qid |Fuellegacydfy.351:56|
 :skolemid |6017|
 :pattern ( (TestModule8.__default.parse__Request3 |val#0@@1|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (=> (or |TestModule8.__default.CRequest__grammar#canCall| (< 2 $FunctionContextHeight)) (and (and |TestModule8.__default.EndPoint__grammar#canCall| |TestModule8.__default.CAppMessage__grammar#canCall|) (= TestModule8.__default.CRequest__grammar (Lit DatatypeTypeType (|#TestModule8.G.GTaggedUnion| (Lit SeqType (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#TestModule8.G.GTuple| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType (Lit DatatypeTypeType TestModule8.__default.EndPoint__grammar))) ($Box DatatypeTypeType (Lit DatatypeTypeType |#TestModule8.G.GUint64|))) ($Box DatatypeTypeType (Lit DatatypeTypeType TestModule8.__default.CAppMessage__grammar)))))))) ($Box DatatypeTypeType (Lit DatatypeTypeType |#TestModule8.G.GUint64|)))))))))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|val#0@@2| T@U) ) (!  (=> (or (|TestModule8.__default.parse__Request3#canCall| (Lit DatatypeTypeType |val#0@@2|)) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |val#0@@2| Tclass.TestModule8.V) (U_2_bool (Lit boolType (bool_2_U (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar (Lit DatatypeTypeType |val#0@@2|) (Lit DatatypeTypeType TestModule8.__default.CRequest__grammar)))))))) (and (=> (= (LitInt (TestModule8.V.c (Lit DatatypeTypeType |val#0@@2|))) (LitInt 0)) (and (|TestModule8.__default.parse__EndPoint#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (TestModule8.V.t (Lit DatatypeTypeType (TestModule8.V.val (Lit DatatypeTypeType |val#0@@2|))))) (LitInt 0)))) (|TestModule8.__default.parse__AppMessage#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (TestModule8.V.t (Lit DatatypeTypeType (TestModule8.V.val (Lit DatatypeTypeType |val#0@@2|))))) (LitInt 2)))))) (= (TestModule8.__default.parse__Request3 (Lit DatatypeTypeType |val#0@@2|)) (ite (= (LitInt (TestModule8.V.c (Lit DatatypeTypeType |val#0@@2|))) (LitInt 0)) (let ((|ep#1| (TestModule8.__default.parse__EndPoint ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (TestModule8.V.t (Lit DatatypeTypeType (TestModule8.V.val (Lit DatatypeTypeType |val#0@@2|))))) (LitInt 0))))))
(|#TestModule8.CRequest.CRequest| |ep#1| (TestModule8.V.u ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (TestModule8.V.t (Lit DatatypeTypeType (TestModule8.V.val (Lit DatatypeTypeType |val#0@@2|))))) (LitInt 1)))) (TestModule8.__default.parse__AppMessage ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (TestModule8.V.t (Lit DatatypeTypeType (TestModule8.V.val (Lit DatatypeTypeType |val#0@@2|))))) (LitInt 2)))))) |#TestModule8.CRequest.CRequestNoOp|))))
 :qid |Fuellegacydfy.351:56|
 :weight 3
 :skolemid |6021|
 :pattern ( (TestModule8.__default.parse__Request3 (Lit DatatypeTypeType |val#0@@2|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|val#0@@3| T@U) ) (!  (=> (or (|TestModule8.__default.parse__Request3#canCall| |val#0@@3|) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |val#0@@3| Tclass.TestModule8.V) (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |val#0@@3| (Lit DatatypeTypeType TestModule8.__default.CRequest__grammar))))) (and (=> (= (TestModule8.V.c |val#0@@3|) (LitInt 0)) (and (|TestModule8.__default.parse__EndPoint#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (TestModule8.V.t (TestModule8.V.val |val#0@@3|)) (LitInt 0)))) (|TestModule8.__default.parse__AppMessage#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (TestModule8.V.t (TestModule8.V.val |val#0@@3|)) (LitInt 2)))))) (= (TestModule8.__default.parse__Request3 |val#0@@3|) (ite (= (TestModule8.V.c |val#0@@3|) (LitInt 0)) (let ((|ep#0| (TestModule8.__default.parse__EndPoint ($Unbox DatatypeTypeType (|Seq#Index| (TestModule8.V.t (TestModule8.V.val |val#0@@3|)) (LitInt 0))))))
(|#TestModule8.CRequest.CRequest| |ep#0| (TestModule8.V.u ($Unbox DatatypeTypeType (|Seq#Index| (TestModule8.V.t (TestModule8.V.val |val#0@@3|)) (LitInt 1)))) (TestModule8.__default.parse__AppMessage ($Unbox DatatypeTypeType (|Seq#Index| (TestModule8.V.t (TestModule8.V.val |val#0@@3|)) (LitInt 2)))))) |#TestModule8.CRequest.CRequestNoOp|))))
 :qid |Fuellegacydfy.351:56|
 :skolemid |6020|
 :pattern ( (TestModule8.__default.parse__Request3 |val#0@@3|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap T@U) (|val#0@@4| T@U) ) (!  (=> (and (or (|TestModule8.__default.parse__EndPoint#canCall| |val#0@@4|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |val#0@@4| Tclass.TestModule8.V) ($IsAlloc DatatypeTypeType |val#0@@4| Tclass.TestModule8.V $Heap)) (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |val#0@@4| (Lit DatatypeTypeType TestModule8.__default.EndPoint__grammar))))) ($IsGoodHeap $Heap)) ($IsAllocBox (TestModule8.__default.parse__EndPoint |val#0@@4|) Tclass.TestModule8.EndPoint $Heap))
 :qid |Fuellegacydfy.323:18|
 :skolemid |5977|
 :pattern ( ($IsAllocBox (TestModule8.__default.parse__EndPoint |val#0@@4|) Tclass.TestModule8.EndPoint $Heap))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|val#0@@5| T@U) ) (!  (=> (and (or (|TestModule8.__default.parse__AppMessage#canCall| |val#0@@5|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |val#0@@5| Tclass.TestModule8.V) ($IsAlloc DatatypeTypeType |val#0@@5| Tclass.TestModule8.V $Heap@@0)) (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |val#0@@5| (Lit DatatypeTypeType TestModule8.__default.CAppMessage__grammar))))) ($IsGoodHeap $Heap@@0)) ($IsAllocBox (TestModule8.__default.parse__AppMessage |val#0@@5|) Tclass.TestModule8.CAppMessage $Heap@@0))
 :qid |Fuellegacydfy.328:18|
 :skolemid |5982|
 :pattern ( ($IsAllocBox (TestModule8.__default.parse__AppMessage |val#0@@5|) Tclass.TestModule8.CAppMessage $Heap@@0))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@1 T@U) (|val#0@@6| T@U) ) (!  (=> (and (or (|TestModule8.__default.parse__Request3#canCall| |val#0@@6|) (and (< 4 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |val#0@@6| Tclass.TestModule8.V) ($IsAlloc DatatypeTypeType |val#0@@6| Tclass.TestModule8.V $Heap@@1)) (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |val#0@@6| (Lit DatatypeTypeType TestModule8.__default.CRequest__grammar))))) ($IsGoodHeap $Heap@@1)) ($IsAlloc DatatypeTypeType (TestModule8.__default.parse__Request3 |val#0@@6|) Tclass.TestModule8.CRequest $Heap@@1))
 :qid |Fuellegacydfy.351:41|
 :skolemid |6018|
 :pattern ( ($IsAlloc DatatypeTypeType (TestModule8.__default.parse__Request3 |val#0@@6|) Tclass.TestModule8.CRequest $Heap@@1))
))))
(assert (forall (($ly T@U) (|val#0@@7| T@U) (|grammar#0| T@U) ) (! (= (TestModule8.__default.ValInGrammar ($LS $ly) |val#0@@7| |grammar#0|) (TestModule8.__default.ValInGrammar $ly |val#0@@7| |grammar#0|))
 :qid |Fuellegacydfy.308:35|
 :skolemid |5956|
 :pattern ( (TestModule8.__default.ValInGrammar ($LS $ly) |val#0@@7| |grammar#0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (=> (or |TestModule8.__default.CAppMessage__grammar#canCall| (< 1 $FunctionContextHeight)) (= TestModule8.__default.CAppMessage__grammar (Lit DatatypeTypeType (|#TestModule8.G.GTaggedUnion| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType (Lit DatatypeTypeType |#TestModule8.G.GUint64|))) ($Box DatatypeTypeType (Lit DatatypeTypeType |#TestModule8.G.GUint64|))) ($Box DatatypeTypeType (Lit DatatypeTypeType |#TestModule8.G.GUint64|))))))))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@0 T@U) (|val#0@@8| T@U) (|grammar#0@@0| T@U) ) (!  (=> (or (|TestModule8.__default.ValInGrammar#canCall| (Lit DatatypeTypeType |val#0@@8|) (Lit DatatypeTypeType |grammar#0@@0|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |val#0@@8| Tclass.TestModule8.V) ($Is DatatypeTypeType |grammar#0@@0| Tclass.TestModule8.G)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (TestModule8.V.VUint64_q (Lit DatatypeTypeType |val#0@@8|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (TestModule8.V.VTuple_q (Lit DatatypeTypeType |val#0@@8|))))) (let ((|t#3| (Lit SeqType (TestModule8.V.t (Lit DatatypeTypeType |val#0@@8|)))))
...
)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (TestModule8.V.VTuple_q (Lit DatatypeTypeType |val#0@@8|)))))) (let ((|val#4| (Lit DatatypeTypeType (TestModule8.V.val (Lit DatatypeTypeType |val#0@@8|)))))
(let ((|c#3| (LitInt (TestModule8.V.c (Lit DatatypeTypeType |val#0@@8|)))))
 (=> (U_2_bool (Lit boolType (bool_2_U (TestModule8.G.GTaggedUnion_q (Lit DatatypeTypeType |grammar#0@@0|))))) (=> (< |c#3| (|Seq#Length| (Lit SeqType (TestModule8.G.cases (Lit DatatypeTypeType |grammar#0@@0|))))) (|TestModule8.__default.ValInGrammar#canCall| |val#4| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (TestModule8.G.cases (Lit DatatypeTypeType |grammar#0@@0|))) |c#3|)))))))))) (= (TestModule8.__default.ValInGrammar ($LS $ly@@0) (Lit DatatypeTypeType |val#0@@8|) (Lit DatatypeTypeType |grammar#0@@0|)) (ite (TestModule8.V.VUint64_q (Lit DatatypeTypeType |val#0@@8|)) (TestModule8.G.GUint64_q (Lit DatatypeTypeType |grammar#0@@0|)) (ite (TestModule8.V.VTuple_q (Lit DatatypeTypeType |val#0@@8|)) (let ((|t#2| (Lit SeqType (TestModule8.V.t (Lit DatatypeTypeType |val#0@@8|)))))
...
)))) (let ((|val#3| (Lit DatatypeTypeType (TestModule8.V.val (Lit DatatypeTypeType |val#0@@8|)))))
(let ((|c#2| (LitInt (TestModule8.V.c (Lit DatatypeTypeType |val#0@@8|)))))
 ...
 :weight 3
 :skolemid |5967|
 :pattern ( (TestModule8.__default.ValInGrammar ($LS $ly@@0) (Lit DatatypeTypeType |val#0@@8|) (Lit DatatypeTypeType |grammar#0@@0|)))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@1 T@U) (|val#0@@9| T@U) (|grammar#0@@1| T@U) ) (!  (=> (or (|TestModule8.__default.ValInGrammar#canCall| |val#0@@9| |grammar#0@@1|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |val#0@@9| Tclass.TestModule8.V) ($Is DatatypeTypeType |grammar#0@@1| Tclass.TestModule8.G)))) (and (=> (not (TestModule8.V.VUint64_q |val#0@@9|)) (and (=> (TestModule8.V.VTuple_q |val#0@@9|) (let ((|t#1| (TestModule8.V.t |val#0@@9|)))
...
)))))) (=> (not (TestModule8.V.VTuple_q |val#0@@9|)) (let ((|val#2| (TestModule8.V.val |val#0@@9|)))
(let ((|c#1| (TestModule8.V.c |val#0@@9|)))
 (=> (TestModule8.G.GTaggedUnion_q |grammar#0@@1|) (=> (< |c#1| (|Seq#Length| (TestModule8.G.cases |grammar#0@@1|))) (|TestModule8.__default.ValInGrammar#canCall| |val#2| ($Unbox DatatypeTypeType (|Seq#Index| (TestModule8.G.cases |grammar#0@@1|) |c#1|)))))))))) (= (TestModule8.__default.ValInGrammar ($LS $ly@@1) |val#0@@9| |grammar#0@@1|) (ite (TestModule8.V.VUint64_q |val#0@@9|) (TestModule8.G.GUint64_q |grammar#0@@1|) (ite (TestModule8.V.VTuple_q |val#0@@9|) (let ((|t#0| (TestModule8.V.t |val#0@@9|)))
...
)))) (let ((|val#1| (TestModule8.V.val |val#0@@9|)))
(let ((|c#0| (TestModule8.V.c |val#0@@9|)))
 ...
 :qid |Fuellegacydfy.308:35|
 :skolemid |5964|
 :pattern ( (TestModule8.__default.ValInGrammar ($LS $ly@@1) |val#0@@9| |grammar#0@@1|))
))))
...
(assert (forall ((d@@20 T@U) ) (!  (=> ($Is DatatypeTypeType d@@20 Tclass.TestModule8.V) (or (or (TestModule8.V.VUint64_q d@@20) (TestModule8.V.VTuple_q d@@20)) (TestModule8.V.VCase_q d@@20)))
 :qid |unknown.0:0|
 :skolemid |6125|
 :pattern ( (TestModule8.V.VCase_q d@@20) ($Is DatatypeTypeType d@@20 Tclass.TestModule8.V))
 :pattern ( (TestModule8.V.VTuple_q d@@20) ($Is DatatypeTypeType d@@20 Tclass.TestModule8.V))
 :pattern ( (TestModule8.V.VUint64_q d@@20) ($Is DatatypeTypeType d@@20 Tclass.TestModule8.V))
)))
...
(assert (forall ((d@@21 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) ($Is DatatypeTypeType d@@21 Tclass.TestModule8.G)) ($IsAlloc DatatypeTypeType d@@21 Tclass.TestModule8.G $h@@2))
 :qid |unknown.0:0|
 :skolemid |6085|
 :pattern ( ($IsAlloc DatatypeTypeType d@@21 Tclass.TestModule8.G $h@@2))
)))
(assert (forall ((d@@22 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) ($Is DatatypeTypeType d@@22 Tclass.TestModule8.V)) ($IsAlloc DatatypeTypeType d@@22 Tclass.TestModule8.V $h@@3))
 :qid |unknown.0:0|
 :skolemid |6123|
 :pattern ( ($IsAlloc DatatypeTypeType d@@22 Tclass.TestModule8.V $h@@3))
)))
...
(assert (forall ((d@@23 T@U) ) (!  (=> ($Is DatatypeTypeType d@@23 Tclass.TestModule8.G) (or (or (or (or (TestModule8.G.GUint64_q d@@23) (TestModule8.G.GArray_q d@@23)) (TestModule8.G.GTuple_q d@@23)) (TestModule8.G.GByteArray_q d@@23)) (TestModule8.G.GTaggedUnion_q d@@23)))
 :qid |unknown.0:0|
 :skolemid |6087|
 :pattern ( (TestModule8.G.GTaggedUnion_q d@@23) ($Is DatatypeTypeType d@@23 Tclass.TestModule8.G))
 :pattern ( (TestModule8.G.GByteArray_q d@@23) ($Is DatatypeTypeType d@@23 Tclass.TestModule8.G))
 :pattern ( (TestModule8.G.GTuple_q d@@23) ($Is DatatypeTypeType d@@23 Tclass.TestModule8.G))
 :pattern ( (TestModule8.G.GArray_q d@@23) ($Is DatatypeTypeType d@@23 Tclass.TestModule8.G))
 :pattern ( (TestModule8.G.GUint64_q d@@23) ($Is DatatypeTypeType d@@23 Tclass.TestModule8.G))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (=> (or |TestModule8.__default.EndPoint__grammar#canCall| (< 1 $FunctionContextHeight)) (= TestModule8.__default.EndPoint__grammar (Lit DatatypeTypeType |#TestModule8.G.GUint64|)))))
(assert (forall ((d@@24 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (TestModule8.G.GArray_q d@@24) ($IsAlloc DatatypeTypeType d@@24 Tclass.TestModule8.G $h@@4))) ($IsAlloc DatatypeTypeType (TestModule8.G.elt d@@24) Tclass.TestModule8.G $h@@4))
 :qid |unknown.0:0|
 :skolemid |6059|
 :pattern ( ($IsAlloc DatatypeTypeType (TestModule8.G.elt d@@24) Tclass.TestModule8.G $h@@4))
)))
(assert (forall ((d@@25 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (TestModule8.V.VUint64_q d@@25) ($IsAlloc DatatypeTypeType d@@25 Tclass.TestModule8.V $h@@5))) ($IsAlloc intType (int_2_U (TestModule8.V.u d@@25)) Tclass.TestModule8.uint64 $h@@5))
 :qid |unknown.0:0|
 :skolemid |6099|
 :pattern ( ($IsAlloc intType (int_2_U (TestModule8.V.u d@@25)) Tclass.TestModule8.uint64 $h@@5))
)))
(assert (forall ((d@@26 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (TestModule8.V.VCase_q d@@26) ($IsAlloc DatatypeTypeType d@@26 Tclass.TestModule8.V $h@@6))) ($IsAlloc intType (int_2_U (TestModule8.V.c d@@26)) Tclass.TestModule8.uint64 $h@@6))
 :qid |unknown.0:0|
 :skolemid |6117|
 :pattern ( ($IsAlloc intType (int_2_U (TestModule8.V.c d@@26)) Tclass.TestModule8.uint64 $h@@6))
)))
(assert (forall ((d@@27 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (TestModule8.V.VCase_q d@@27) ($IsAlloc DatatypeTypeType d@@27 Tclass.TestModule8.V $h@@7))) ($IsAlloc DatatypeTypeType (TestModule8.V.val d@@27) Tclass.TestModule8.V $h@@7))
 :qid |unknown.0:0|
 :skolemid |6118|
 :pattern ( ($IsAlloc DatatypeTypeType (TestModule8.V.val d@@27) Tclass.TestModule8.V $h@@7))
)))
(assert (forall ((d@@28 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (TestModule8.CRequest.CRequest_q d@@28) ($IsAlloc DatatypeTypeType d@@28 Tclass.TestModule8.CRequest $h@@8))) ($IsAllocBox (TestModule8.CRequest.client d@@28) Tclass.TestModule8.EndPoint $h@@8))
 :qid |unknown.0:0|
 :skolemid |6136|
 :pattern ( ($IsAllocBox (TestModule8.CRequest.client d@@28) Tclass.TestModule8.EndPoint $h@@8))
)))
(assert (forall ((d@@29 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) (and (TestModule8.CRequest.CRequest_q d@@29) ($IsAlloc DatatypeTypeType d@@29 Tclass.TestModule8.CRequest $h@@9))) ($IsAlloc intType (int_2_U (TestModule8.CRequest.seqno d@@29)) Tclass.TestModule8.uint64 $h@@9))
 :qid |unknown.0:0|
 :skolemid |6137|
 :pattern ( ($IsAlloc intType (int_2_U (TestModule8.CRequest.seqno d@@29)) Tclass.TestModule8.uint64 $h@@9))
)))
(assert (forall ((d@@30 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) (and (TestModule8.CRequest.CRequest_q d@@30) ($IsAlloc DatatypeTypeType d@@30 Tclass.TestModule8.CRequest $h@@10))) ($IsAllocBox (TestModule8.CRequest.request d@@30) Tclass.TestModule8.CAppMessage $h@@10))
 :qid |unknown.0:0|
 :skolemid |6138|
 :pattern ( ($IsAllocBox (TestModule8.CRequest.request d@@30) Tclass.TestModule8.CAppMessage $h@@10))
)))
...
(assert (forall ((d@@31 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (TestModule8.G.GTuple_q d@@31) ($IsAlloc DatatypeTypeType d@@31 Tclass.TestModule8.G $h@@11))) ($IsAlloc SeqType (TestModule8.G.t d@@31) (TSeq Tclass.TestModule8.G) $h@@11))
 :qid |unknown.0:0|
 :skolemid |6068|
 :pattern ( ($IsAlloc SeqType (TestModule8.G.t d@@31) (TSeq Tclass.TestModule8.G) $h@@11))
)))
(assert (forall ((d@@32 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (TestModule8.G.GTaggedUnion_q d@@32) ($IsAlloc DatatypeTypeType d@@32 Tclass.TestModule8.G $h@@12))) ($IsAlloc SeqType (TestModule8.G.cases d@@32) (TSeq Tclass.TestModule8.G) $h@@12))
 :qid |unknown.0:0|
 :skolemid |6080|
 :pattern ( ($IsAlloc SeqType (TestModule8.G.cases d@@32) (TSeq Tclass.TestModule8.G) $h@@12))
)))
(assert (forall ((d@@33 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (TestModule8.V.VTuple_q d@@33) ($IsAlloc DatatypeTypeType d@@33 Tclass.TestModule8.V $h@@13))) ($IsAlloc SeqType (TestModule8.V.t d@@33) (TSeq Tclass.TestModule8.V) $h@@13))
 :qid |unknown.0:0|
 :skolemid |6107|
 :pattern ( ($IsAlloc SeqType (TestModule8.V.t d@@33) (TSeq Tclass.TestModule8.V) $h@@13))
)))
...
(assert (forall (($ly@@2 T@U) (|val#0@@10| T@U) (|grammar#0@@2| T@U) ) (! (= (TestModule8.__default.ValInGrammar $ly@@2 |val#0@@10| |grammar#0@@2|) (TestModule8.__default.ValInGrammar $LZ |val#0@@10| |grammar#0@@2|))
 :qid |Fuellegacydfy.308:35|
 :skolemid |5957|
 :pattern ( (TestModule8.__default.ValInGrammar (AsFuelBottom $ly@@2) |val#0@@10| |grammar#0@@2|))
)))
...
(declare-fun |val#0@@11| () T@U)
(declare-fun |##val#1@0| () T@U)
(declare-fun $Heap@@2 () T@U)
(declare-fun |let#0#0#0| () T@U)
(declare-fun |ep#Z#0@0| () T@U)
...
(set-info :boogie-vc-id CheckWellformed$$TestModule8.__default.parse__Request3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 32) (let ((anon8_Else_correct true))
(let ((anon8_Then_correct  (=> (= (TestModule8.V.c |val#0@@11|) (LitInt 0)) (and (=> (= (ControlFlow 0 3) (- 0 26)) (TestModule8.V.VCase_q |val#0@@11|)) (=> (TestModule8.V.VCase_q |val#0@@11|) (and (=> (= (ControlFlow 0 3) (- 0 25)) (TestModule8.V.VTuple_q (TestModule8.V.val |val#0@@11|))) (=> (TestModule8.V.VTuple_q (TestModule8.V.val |val#0@@11|)) (and (=> (= (ControlFlow 0 3) (- 0 24)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| (TestModule8.V.t (TestModule8.V.val |val#0@@11|)))))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| (TestModule8.V.t (TestModule8.V.val |val#0@@11|))))) (=> (and (= |##val#1@0| ($Unbox DatatypeTypeType (|Seq#Index| (TestModule8.V.t (TestModule8.V.val |val#0@@11|)) (LitInt 0)))) ($IsAlloc DatatypeTypeType |##val#1@0| Tclass.TestModule8.V $Heap@@2)) (and (=> (= (ControlFlow 0 3) (- 0 23)) (=> (|TestModule8.__default.ValInGrammar#canCall| |##val#1@0| (Lit DatatypeTypeType TestModule8.__default.EndPoint__grammar)) (or (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |##val#1@0| (Lit DatatypeTypeType TestModule8.__default.EndPoint__grammar)) (=> (TestModule8.V.VUint64_q |##val#1@0|) (U_2_bool (Lit boolType (bool_2_U (TestModule8.G.GUint64_q (Lit DatatypeTypeType TestModule8.__default.EndPoint__grammar))))))))) (and (=> (= (ControlFlow 0 3) (- 0 22)) (=> (|TestModule8.__default.ValInGrammar#canCall| |##val#1@0| (Lit DatatypeTypeType TestModule8.__default.EndPoint__grammar)) (or (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |##val#1@0| (Lit DatatypeTypeType TestModule8.__default.EndPoint__grammar)) (=> (not (TestModule8.V.VUint64_q |##val#1@0|)) (=> (TestModule8.V.VTuple_q |##val#1@0|) (U_2_bool (Lit boolType (bool_2_U (TestModule8.G.GTuple_q (Lit DatatypeTypeType TestModule8.__default.EndPoint__grammar)))))))))) (and (=> (= (ControlFlow 0 3) (- 0 21)) (=> (|TestModule8.__default.ValInGrammar#canCall| |##val#1@0| (Lit DatatypeTypeType TestModule8.__default.EndPoint__grammar)) (or (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |##val#1@0| (Lit DatatypeTypeType TestModule8.__default.EndPoint__grammar)) (=> (not (TestModule8.V.VUint64_q |##val#1@0|)) (=> (TestModule8.V.VTuple_q |##val#1@0|) (let ((|t#0@@0| (TestModule8.V.t |##val#1@0|)))
(= (|Seq#Length| |t#0@@0|) (|Seq#Length| (Lit SeqType (TestModule8.G.t (Lit DatatypeTypeType TestModule8.__default.EndPoint__grammar))))))))))) (and (=> (= (ControlFlow 0 3) (- 0 20)) (=> (|TestModule8.__default.ValInGrammar#canCall| |##val#1@0| (Lit DatatypeTypeType TestModule8.__default.EndPoint__grammar)) (or (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |##val#1@0| (Lit DatatypeTypeType TestModule8.__default.EndPoint__grammar)) (=> (not (TestModule8.V.VUint64_q |##val#1@0|)) (=> (TestModule8.V.VTuple_q |##val#1@0|) (let ((|t#0@@1| (TestModule8.V.t |##val#1@0|)))
(forall ((|i#0@@2| Int) ) (!  (=> (and (<= (LitInt 0) |i#0@@2|) (< |i#0@@2| (|Seq#Length| |t#0@@1|))) (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar ($Unbox DatatypeTypeType (|Seq#Index| |t#0@@1| |i#0@@2|)) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (TestModule8.G.t (Lit DatatypeTypeType TestModule8.__default.EndPoint__grammar))) |i#0@@2|))))
 :qid |Fuellegacydfy.313:49|
 :skolemid |6024|
 :pattern ( ($Unbox DatatypeTypeType (|Seq#Index| (TestModule8.G.t TestModule8.__default.EndPoint__grammar) |i#0@@2|)))
 :pattern ( ($Unbox DatatypeTypeType (|Seq#Index| |t#0@@1| |i#0@@2|)))
)))))))) (and (=> (= (ControlFlow 0 3) (- 0 19)) (=> (|TestModule8.__default.ValInGrammar#canCall| |##val#1@0| (Lit DatatypeTypeType TestModule8.__default.EndPoint__grammar)) (or (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |##val#1@0| (Lit DatatypeTypeType TestModule8.__default.EndPoint__grammar)) (=> (not (TestModule8.V.VUint64_q |##val#1@0|)) (=> (not (TestModule8.V.VTuple_q |##val#1@0|)) (U_2_bool (Lit boolType (bool_2_U (TestModule8.G.GTaggedUnion_q (Lit DatatypeTypeType TestModule8.__default.EndPoint__grammar)))))))))) (and (=> (= (ControlFlow 0 3) (- 0 18)) (=> (|TestModule8.__default.ValInGrammar#canCall| |##val#1@0| (Lit DatatypeTypeType TestModule8.__default.EndPoint__grammar)) (or (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |##val#1@0| (Lit DatatypeTypeType TestModule8.__default.EndPoint__grammar)) (=> (not (TestModule8.V.VUint64_q |##val#1@0|)) (=> (not (TestModule8.V.VTuple_q |##val#1@0|)) (let ((|c#0@@0| (TestModule8.V.c |##val#1@0|)))
(< |c#0@@0| (|Seq#Length| (Lit SeqType (TestModule8.G.cases (Lit DatatypeTypeType TestModule8.__default.EndPoint__grammar))))))))))) (and (=> (= (ControlFlow 0 3) (- 0 17)) (=> (|TestModule8.__default.ValInGrammar#canCall| |##val#1@0| (Lit DatatypeTypeType TestModule8.__default.EndPoint__grammar)) (or (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |##val#1@0| (Lit DatatypeTypeType TestModule8.__default.EndPoint__grammar)) (=> (not (TestModule8.V.VUint64_q |##val#1@0|)) (=> (not (TestModule8.V.VTuple_q |##val#1@0|)) (let ((|val#1@@0| (TestModule8.V.val |##val#1@0|)))
(let ((|c#0@@1| (TestModule8.V.c |##val#1@0|)))
(TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |val#1@@0| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (TestModule8.G.cases (Lit DatatypeTypeType TestModule8.__default.EndPoint__grammar))) |c#0@@1|)))))))))) (=> (and (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |##val#1@0| (Lit DatatypeTypeType TestModule8.__default.EndPoint__grammar)) (|TestModule8.__default.parse__EndPoint#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (TestModule8.V.t (TestModule8.V.val |val#0@@11|)) (LitInt 0))))) (=> (and (and (= |let#0#0#0| (TestModule8.__default.parse__EndPoint ($Unbox DatatypeTypeType (|Seq#Index| (TestModule8.V.t (TestModule8.V.val |val#0@@11|)) (LitInt 0))))) (|TestModule8.__default.parse__EndPoint#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (TestModule8.V.t (TestModule8.V.val |val#0@@11|)) (LitInt 0))))) (and ($IsBox |let#0#0#0| Tclass.TestModule8.EndPoint) (= |ep#Z#0@0| |let#0#0#0|))) (and (=> (= (ControlFlow 0 3) (- 0 16)) (TestModule8.V.VCase_q |val#0@@11|)) (=> (TestModule8.V.VCase_q |val#0@@11|) (and (=> (= (ControlFlow 0 3) (- 0 15)) (TestModule8.V.VTuple_q (TestModule8.V.val |val#0@@11|))) (=> (TestModule8.V.VTuple_q (TestModule8.V.val |val#0@@11|)) (and (=> (= (ControlFlow 0 3) (- 0 14)) (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| (TestModule8.V.t (TestModule8.V.val |val#0@@11|)))))) (=> (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| (TestModule8.V.t (TestModule8.V.val |val#0@@11|))))) (and (=> (= (ControlFlow 0 3) (- 0 13)) (TestModule8.V.VUint64_q ($Unbox DatatypeTypeType (|Seq#Index| (TestModule8.V.t (TestModule8.V.val |val#0@@11|)) (LitInt 1))))) (=> (TestModule8.V.VUint64_q ($Unbox DatatypeTypeType (|Seq#Index| (TestModule8.V.t (TestModule8.V.val |val#0@@11|)) (LitInt 1)))) (and (=> (= (ControlFlow 0 3) (- 0 12)) (TestModule8.V.VCase_q |val#0@@11|)) (=> (TestModule8.V.VCase_q |val#0@@11|) (and (=> (= (ControlFlow 0 3) (- 0 11)) (TestModule8.V.VTuple_q (TestModule8.V.val |val#0@@11|))) (=> (TestModule8.V.VTuple_q (TestModule8.V.val |val#0@@11|)) (and (=> (= (ControlFlow 0 3) (- 0 10)) (and (<= 0 (LitInt 2)) (< (LitInt 2) (|Seq#Length| (TestModule8.V.t (TestModule8.V.val |val#0@@11|)))))) (=> (and (<= 0 (LitInt 2)) (< (LitInt 2) (|Seq#Length| (TestModule8.V.t (TestModule8.V.val |val#0@@11|))))) (=> (and (= |##val#2@0| ($Unbox DatatypeTypeType (|Seq#Index| (TestModule8.V.t (TestModule8.V.val |val#0@@11|)) (LitInt 2)))) ($IsAlloc DatatypeTypeType |##val#2@0| Tclass.TestModule8.V $Heap@@2)) (and (=> (= (ControlFlow 0 3) (- 0 9)) (=> (|TestModule8.__default.ValInGrammar#canCall| |##val#2@0| (Lit DatatypeTypeType TestModule8.__default.CAppMessage__grammar)) (or (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |##val#2@0| (Lit DatatypeTypeType TestModule8.__default.CAppMessage__grammar)) (=> (TestModule8.V.VUint64_q |##val#2@0|) (U_2_bool (Lit boolType (bool_2_U (TestModule8.G.GUint64_q (Lit DatatypeTypeType TestModule8.__default.CAppMessage__grammar))))))))) (and (=> (= (ControlFlow 0 3) (- 0 8)) (=> (|TestModule8.__default.ValInGrammar#canCall| |##val#2@0| (Lit DatatypeTypeType TestModule8.__default.CAppMessage__grammar)) (or (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |##val#2@0| (Lit DatatypeTypeType TestModule8.__default.CAppMessage__grammar)) (=> (not (TestModule8.V.VUint64_q |##val#2@0|)) (=> (TestModule8.V.VTuple_q |##val#2@0|) (U_2_bool (Lit boolType (bool_2_U (TestModule8.G.GTuple_q (Lit DatatypeTypeType TestModule8.__default.CAppMessage__grammar)))))))))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (=> (|TestModule8.__default.ValInGrammar#canCall| |##val#2@0| (Lit DatatypeTypeType TestModule8.__default.CAppMessage__grammar)) (or (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |##val#2@0| (Lit DatatypeTypeType TestModule8.__default.CAppMessage__grammar)) (=> (not (TestModule8.V.VUint64_q |##val#2@0|)) (=> (TestModule8.V.VTuple_q |##val#2@0|) (let ((|t#2@@0| (TestModule8.V.t |##val#2@0|)))
(= (|Seq#Length| |t#2@@0|) (|Seq#Length| (Lit SeqType (TestModule8.G.t (Lit DatatypeTypeType TestModule8.__default.CAppMessage__grammar))))))))))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (=> (|TestModule8.__default.ValInGrammar#canCall| |##val#2@0| (Lit DatatypeTypeType TestModule8.__default.CAppMessage__grammar)) (or (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |##val#2@0| (Lit DatatypeTypeType TestModule8.__default.CAppMessage__grammar)) (=> (not (TestModule8.V.VUint64_q |##val#2@0|)) (=> (TestModule8.V.VTuple_q |##val#2@0|) (let ((|t#2@@1| (TestModule8.V.t |##val#2@0|)))
(forall ((|i#2@@0| Int) ) (!  (=> (and (<= (LitInt 0) |i#2@@0|) (< |i#2@@0| (|Seq#Length| |t#2@@1|))) (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar ($Unbox DatatypeTypeType (|Seq#Index| |t#2@@1| |i#2@@0|)) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (TestModule8.G.t (Lit DatatypeTypeType TestModule8.__default.CAppMessage__grammar))) |i#2@@0|))))
 :qid |Fuellegacydfy.313:49|
 :skolemid |6028|
 :pattern ( ($Unbox DatatypeTypeType (|Seq#Index| (TestModule8.G.t TestModule8.__default.CAppMessage__grammar) |i#2@@0|)))
 :pattern ( ($Unbox DatatypeTypeType (|Seq#Index| |t#2@@1| |i#2@@0|)))
)))))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (=> (|TestModule8.__default.ValInGrammar#canCall| |##val#2@0| (Lit DatatypeTypeType TestModule8.__default.CAppMessage__grammar)) (or (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |##val#2@0| (Lit DatatypeTypeType TestModule8.__default.CAppMessage__grammar)) (=> (not (TestModule8.V.VUint64_q |##val#2@0|)) (=> (not (TestModule8.V.VTuple_q |##val#2@0|)) (U_2_bool (Lit boolType (bool_2_U (TestModule8.G.GTaggedUnion_q (Lit DatatypeTypeType TestModule8.__default.CAppMessage__grammar)))))))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> (|TestModule8.__default.ValInGrammar#canCall| |##val#2@0| (Lit DatatypeTypeType TestModule8.__default.CAppMessage__grammar)) (or (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |##val#2@0| (Lit DatatypeTypeType TestModule8.__default.CAppMessage__grammar)) (=> (not (TestModule8.V.VUint64_q |##val#2@0|)) (=> (not (TestModule8.V.VTuple_q |##val#2@0|)) (let ((|c#2@@0| (TestModule8.V.c |##val#2@0|)))
(< |c#2@@0| (|Seq#Length| (Lit SeqType (TestModule8.G.cases (Lit DatatypeTypeType TestModule8.__default.CAppMessage__grammar))))))))))) (=> (= (ControlFlow 0 3) (- 0 2)) (=> (|TestModule8.__default.ValInGrammar#canCall| |##val#2@0| (Lit DatatypeTypeType TestModule8.__default.CAppMessage__grammar)) (or (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |##val#2@0| (Lit DatatypeTypeType TestModule8.__default.CAppMessage__grammar)) (=> (not (TestModule8.V.VUint64_q |##val#2@0|)) (=> (not (TestModule8.V.VTuple_q |##val#2@0|)) (let ((|val#3@@0| (TestModule8.V.val |##val#2@0|)))
(let ((|c#2@@1| (TestModule8.V.c |##val#2@0|)))
(TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |val#3@@0| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (TestModule8.G.cases (Lit DatatypeTypeType TestModule8.__default.CAppMessage__grammar))) |c#2@@1|))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 28) (- 0 30)) (TestModule8.V.VCase_q |val#0@@11|)) (=> (TestModule8.V.VCase_q |val#0@@11|) (=> (= |newtype$check#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 28) (- 0 29)) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 18446744073709551616))) (=> (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 18446744073709551616)) (and (=> (= (ControlFlow 0 28) 3) anon8_Then_correct) (=> (= (ControlFlow 0 28) 27) anon8_Else_correct)))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (= StartFuel_TestModule8._default.ValInGrammar ($LS ($LS ($LS BaseFuel_TestModule8._default.ValInGrammar))))) (=> (and (and (and (= StartFuelAssert_TestModule8._default.ValInGrammar ($LS ($LS ($LS ($LS BaseFuel_TestModule8._default.ValInGrammar))))) (= (AsFuelBottom BaseFuel_TestModule8._default.ValInGrammar) BaseFuel_TestModule8._default.ValInGrammar)) (and ($IsAlloc DatatypeTypeType |val#0@@11| Tclass.TestModule8.V $Heap@@2) |TestModule8.__default.CRequest__grammar#canCall|)) (and (and (= |##grammar#0@0| (Lit DatatypeTypeType TestModule8.__default.CRequest__grammar)) ($IsAlloc DatatypeTypeType |##grammar#0@0| Tclass.TestModule8.G $Heap@@2)) (and (|TestModule8.__default.ValInGrammar#canCall| |val#0@@11| (Lit DatatypeTypeType TestModule8.__default.CRequest__grammar)) (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |val#0@@11| (Lit DatatypeTypeType TestModule8.__default.CRequest__grammar))))) (and (=> (= (ControlFlow 0 31) 1) anon7_Then_correct) (=> (= (ControlFlow 0 31) 28) anon7_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) ($Is DatatypeTypeType |val#0@@11| Tclass.TestModule8.V)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 32) 31))) anon0_correct)))
