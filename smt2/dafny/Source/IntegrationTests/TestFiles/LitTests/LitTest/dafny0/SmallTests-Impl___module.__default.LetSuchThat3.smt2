...
|m#1|)) ($Box intType |x#12|))))) (=> (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (|Set#IsMember| (|Map#Domain| (let ((|m#2@@0| (Lit MapType |Map#Empty|)))
|m#2@@0|)) ($Box intType (int_2_U 0)))) (exists ((|x#12@@0| Int) ) (|Set#IsMember| (|Map#Domain| (let ((|m#1@@0| (Lit MapType |Map#Empty|)))
|m#1@@0|)) ($Box intType (int_2_U |x#12@@0|))))) (=> (|Set#IsMember| (|Map#Domain| (let ((|m#3| (Lit MapType |Map#Empty|)))
...
(let ((anon8_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (or (and ($Is DatatypeTypeType (Lit DatatypeTypeType |#_module.Lindgren.HerrNilsson|) Tclass._module.Lindgren) (= (Lit DatatypeTypeType |#_module.Lindgren.HerrNilsson|) (Lit DatatypeTypeType |#_module.Lindgren.HerrNilsson|))) (or (and ($Is DatatypeTypeType (Lit DatatypeTypeType |#_module.Lindgren.HerrNilsson|) Tclass._module.Lindgren) (= (Lit DatatypeTypeType |#_module.Lindgren.HerrNilsson|) (Lit DatatypeTypeType |#_module.Lindgren.HerrNilsson|))) (exists ((|y#0| T@U) )  (and ($Is DatatypeTypeType |y#0| Tclass._module.Lindgren) (= |y#0| (Lit DatatypeTypeType |#_module.Lindgren.HerrNilsson|))))))) (=> (or (and ($Is DatatypeTypeType (Lit DatatypeTypeType |#_module.Lindgren.HerrNilsson|) Tclass._module.Lindgren) (= (Lit DatatypeTypeType |#_module.Lindgren.HerrNilsson|) (Lit DatatypeTypeType |#_module.Lindgren.HerrNilsson|))) (or (and ($Is DatatypeTypeType (Lit DatatypeTypeType |#_module.Lindgren.HerrNilsson|) Tclass._module.Lindgren) (= (Lit DatatypeTypeType |#_module.Lindgren.HerrNilsson|) (Lit DatatypeTypeType |#_module.Lindgren.HerrNilsson|))) (exists ((|y#0@@0| T@U) )  (and ($Is DatatypeTypeType |y#0@@0| Tclass._module.Lindgren) (= |y#0@@0| (Lit DatatypeTypeType |#_module.Lindgren.HerrNilsson|)))))) (=> (and ($Is DatatypeTypeType |y#1@0| Tclass._module.Lindgren) ($IsAlloc DatatypeTypeType |y#1@0| Tclass._module.Lindgren $Heap)) (=> (and (and (= |y#1@0| (Lit DatatypeTypeType |#_module.Lindgren.HerrNilsson|)) |$let#8$canCall|) (and |$let#8$canCall| (= |yy#0@0| (let ((|y#0@@1| |$let#8_y|))
...
(let ((anon21_Then_correct  (and (=> (= (ControlFlow 0 25) (- 0 26)) (or (and ($Is intType (int_2_U (+ |n#0| 12)) TInt) (= (+ |n#0| 12) (+ |n#0| 12))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (= (LitInt 0) (+ |n#0| 12))) (exists ((|x#4| Int) ) (= |x#4| (+ |n#0| 12)))))) (=> (or (and ($Is intType (int_2_U (+ |n#0| 12)) TInt) (= (+ |n#0| 12) (+ |n#0| 12))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (= (LitInt 0) (+ |n#0| 12))) (exists ((|x#4@@0| Int) ) (= |x#4@@0| (+ |n#0| 12))))) (=> (and (and (= |x#5@0| (+ |n#0| 12)) (|$let#7$canCall| |n#0|)) (and (|$let#7$canCall| |n#0|) (= |xx#0@2| (let ((|x#4@@1| (|$let#7_x| |n#0|)))
(+ |x#4@@1| 10))))) (and (=> (= (ControlFlow 0 25) 23) anon22_Then_correct) (=> (= (ControlFlow 0 25) 24) anon22_Else_correct)))))))
(let ((anon21_Else_correct true))
(let ((anon20_Then_correct  (and (=> (= (ControlFlow 0 27) (- 0 28)) (or (and ($Is intType (int_2_U (LitInt 11)) TInt) (or (or (= (LitInt 11) (LitInt 3)) (= (LitInt 11) (LitInt 7))) (= (LitInt 11) (LitInt 11)))) (or (and ($Is intType (int_2_U (LitInt 7)) TInt) (or (or (= (LitInt 7) (LitInt 3)) (= (LitInt 7) (LitInt 7))) (= (LitInt 7) (LitInt 11)))) (or (and ($Is intType (int_2_U (LitInt 3)) TInt) (or (or (= (LitInt 3) (LitInt 3)) (= (LitInt 3) (LitInt 7))) (= (LitInt 3) (LitInt 11)))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (or (or (= (LitInt 0) (LitInt 3)) (= (LitInt 0) (LitInt 7))) (= (LitInt 0) (LitInt 11)))) (exists ((|x#2| Int) )  (or (or (= |x#2| (LitInt 3)) (= |x#2| (LitInt 7))) (= |x#2| (LitInt 11))))))))) (=> (or (and ($Is intType (int_2_U (LitInt 11)) TInt) (or (or (= (LitInt 11) (LitInt 3)) (= (LitInt 11) (LitInt 7))) (= (LitInt 11) (LitInt 11)))) (or (and ($Is intType (int_2_U (LitInt 7)) TInt) (or (or (= (LitInt 7) (LitInt 3)) (= (LitInt 7) (LitInt 7))) (= (LitInt 7) (LitInt 11)))) (or (and ($Is intType (int_2_U (LitInt 3)) TInt) (or (or (= (LitInt 3) (LitInt 3)) (= (LitInt 3) (LitInt 7))) (= (LitInt 3) (LitInt 11)))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (or (or (= (LitInt 0) (LitInt 3)) (= (LitInt 0) (LitInt 7))) (= (LitInt 0) (LitInt 11)))) (exists ((|x#2@@0| Int) )  (or (or (= |x#2@@0| (LitInt 3)) (= |x#2@@0| (LitInt 7))) (= |x#2@@0| (LitInt 11)))))))) (=> (and (and (or (or (= |x#3@0| (LitInt 3)) (= |x#3@0| (LitInt 7))) (= |x#3@0| (LitInt 11))) |$let#6$canCall|) (and |$let#6$canCall| (= |xx#0@1| (let ((|x#2@@1| |$let#6_x|))
(+ |x#2@@1| 10))))) (and (=> (= (ControlFlow 0 27) 25) anon21_Then_correct) (=> (= (ControlFlow 0 27) 3) anon21_Else_correct)))))))
(let ((anon20_Else_correct true))
(let ((anon19_Then_correct  (and (=> (= (ControlFlow 0 29) (- 0 30)) (or (and ($Is intType (int_2_U (LitInt 1)) TInt) (= (LitInt 1) (LitInt 1))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (= (LitInt 0) (LitInt 1))) (exists ((|x#0| Int) ) (= |x#0| (LitInt 1)))))) (=> (or (and ($Is intType (int_2_U (LitInt 1)) TInt) (= (LitInt 1) (LitInt 1))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (= (LitInt 0) (LitInt 1))) (exists ((|x#0@@0| Int) ) (= |x#0@@0| (LitInt 1))))) (=> (and (and (= |x#1@0| (LitInt 1)) |$let#5$canCall|) (and |$let#5$canCall| (= |xx#0@0| (let ((|x#0@@1| |$let#5_x|))
