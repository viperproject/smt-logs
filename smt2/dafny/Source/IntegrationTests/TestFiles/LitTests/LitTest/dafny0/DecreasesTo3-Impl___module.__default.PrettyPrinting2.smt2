...
(declare-fun |two#Z#0@0| () Int)
(declare-fun |b#0| () Bool)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.PrettyPrinting2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (= |let#0#0#0| (LitInt 2)) ($Is intType (int_2_U |let#0#0#0|) TInt)) (and (= |two#Z#0@0| |let#0#0#0|) (= (ControlFlow 0 2) (- 0 1)))) (and (not (let ((|two#0| (LitInt 2)))
(<= |two#0| |two#0|))) (= |b#0| |b#0|))))))
