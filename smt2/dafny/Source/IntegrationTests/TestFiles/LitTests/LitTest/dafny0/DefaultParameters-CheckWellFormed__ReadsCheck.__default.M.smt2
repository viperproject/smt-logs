...
(assert (distinct alloc Tagclass.ReadsCheck.Cell Tagclass.ReadsCheck.Cell? tytagFamily$Cell)
)
...
(set-info :boogie-vc-id CheckWellFormed$$ReadsCheck.__default.M)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |c#0@@1| Tclass.ReadsCheck.Cell) ($IsAlloc refType |c#0@@1| Tclass.ReadsCheck.Cell $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
