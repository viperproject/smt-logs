...
procedure {:verboseName "ConstantFieldReceiverNonNull.MMethod (well-formedness)"} CheckWellFormed$$ConstantFieldReceiverNonNull.__default.MMethod(tr#0: ref
       where $Is(tr#0, Tclass.ConstantFieldReceiverNonNull.Trait?())
         && $IsAlloc(tr#0, Tclass.ConstantFieldReceiverNonNull.Trait?(), $Heap));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "ConstantFieldReceiverNonNull.MMethod (call)"} Call$$ConstantFieldReceiverNonNull.__default.MMethod(tr#0: ref
       where $Is(tr#0, Tclass.ConstantFieldReceiverNonNull.Trait?())
         && $IsAlloc(tr#0, Tclass.ConstantFieldReceiverNonNull.Trait?(), $Heap));
  modifies $Heap;
...
procedure {:verboseName "ConstantFieldReceiverNonNull.MMethod (correctness)"} Impl$$ConstantFieldReceiverNonNull.__default.MMethod(tr#0: ref
       where $Is(tr#0, Tclass.ConstantFieldReceiverNonNull.Trait?())
         && $IsAlloc(tr#0, Tclass.ConstantFieldReceiverNonNull.Trait?(), $Heap))
...
axiom 1 < $FunctionContextHeight
   ==> $Is(ConstantFieldReceiverNonNull.Trait.y(), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ConstantFieldReceiverNonNull.MMethod (correctness)"} Impl$$ConstantFieldReceiverNonNull.__default.MMethod(tr#0: ref) returns ($_reverifyPost: bool)
{
  ...
  var newtype$check#4: int;
    ...
    // AddMethodImpl: MMethod, Impl$$ConstantFieldReceiverNonNull.__default.MMethod
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/SmallTests.dfy(898,5)
    newtype$check#0 := LitInt(7);
    assert {:id "id95"} LitInt(6) <= newtype$check#0;
    assume true;
    assert {:id "id96"} ConstantFieldReceiverNonNull.Trait.y() == LitInt(7);
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/SmallTests.dfy(899,5)
    newtype$check#1 := LitInt(7);
    assert {:id "id97"} LitInt(6) <= newtype$check#1;
    assume true;
    assert {:id "id98"} ConstantFieldReceiverNonNull.Trait.y() == LitInt(7);
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/SmallTests.dfy(900,5)
    newtype$check#2 := null;
    if (tr#0 != null)
    {
        assert {:id "id99"} {:subsumption 0} tr#0 != null;
        newtype$check#3 := LitInt(7);
        assert {:id "id100"} LitInt(6) <= newtype$check#3;
    }

    assume true;
    assert {:id "id101"} tr#0 == null || ConstantFieldReceiverNonNull.Trait.x1(tr#0) == LitInt(7);
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/SmallTests.dfy(901,5)
    assert {:id "id102"} {:subsumption 0} tr#0 != null;
    newtype$check#4 := LitInt(7);
    assert {:id "id103"} LitInt(6) <= newtype$check#4;
    assume true;
    assert {:id "id104"} ConstantFieldReceiverNonNull.Trait.x1(tr#0) == LitInt(7);
}



procedure {:verboseName "ConstantFieldReceiverNonNull.Six (well-formedness)"} CheckWellFormed$$ConstantFieldReceiverNonNull.Six(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ConstantFieldReceiverNonNull.Six (well-formedness)"} CheckWellFormed$$ConstantFieldReceiverNonNull.Six(x#0: int)
{
...
procedure {:verboseName "ConstantFieldReceiverNonNull.Trait.x1 (well-formedness)"} CheckWellFormed$$ConstantFieldReceiverNonNull.Trait.x1(this: ref
       where this != null
         && 
        $Is(this, Tclass.ConstantFieldReceiverNonNull.Trait())
         && $IsAlloc(this, Tclass.ConstantFieldReceiverNonNull.Trait(), $Heap));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ConstantFieldReceiverNonNull.Trait.x1 (well-formedness)"} CheckWellFormed$$ConstantFieldReceiverNonNull.Trait.x1(this: ref)
{
  var $_ReadsFrame: [ref,Field]bool;
  var newtype$check#0: int;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    newtype$check#0 := LitInt(7);
    assert {:id "id107"} LitInt(6) <= newtype$check#0;
    assume true;
}



procedure {:verboseName "ConstantFieldReceiverNonNull.Trait.y (well-formedness)"} CheckWellFormed$$ConstantFieldReceiverNonNull.Trait.y();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ConstantFieldReceiverNonNull.Trait.y (well-formedness)"} CheckWellFormed$$ConstantFieldReceiverNonNull.Trait.y()
{
  var $_ReadsFrame: [ref,Field]bool;
  var newtype$check#0: int;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    newtype$check#0 := LitInt(7);
    assert {:id "id108"} LitInt(6) <= newtype$check#0;
    assume true;
}
...
procedure {:verboseName "ConstantFieldReceiverNonNull.Class.Test (well-formedness)"} CheckWellFormed$$ConstantFieldReceiverNonNull.Class.Test(this: ref
       where this != null
         && 
        $Is(this, Tclass.ConstantFieldReceiverNonNull.Class())
         && $IsAlloc(this, Tclass.ConstantFieldReceiverNonNull.Class(), $Heap));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "ConstantFieldReceiverNonNull.Class.Test (call)"} Call$$ConstantFieldReceiverNonNull.Class.Test(this: ref
       where this != null
         && 
        $Is(this, Tclass.ConstantFieldReceiverNonNull.Class())
         && $IsAlloc(this, Tclass.ConstantFieldReceiverNonNull.Class(), $Heap));
...
procedure {:verboseName "ConstantFieldReceiverNonNull.Class.Test (correctness)"} Impl$$ConstantFieldReceiverNonNull.Class.Test(this: ref
       where this != null
         && 
        $Is(this, Tclass.ConstantFieldReceiverNonNull.Class())
         && $IsAlloc(this, Tclass.ConstantFieldReceiverNonNull.Class(), $Heap))
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ConstantFieldReceiverNonNull.Class.Test (correctness)"} Impl$$ConstantFieldReceiverNonNull.Class.Test(this: ref) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var newtype$check#0: int;
  var newtype$check#1: int;

    // AddMethodImpl: Test, Impl$$ConstantFieldReceiverNonNull.Class.Test
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/SmallTests.dfy(892,7)
    newtype$check#0 := LitInt(7);
    assert {:id "id109"} LitInt(6) <= newtype$check#0;
    if (ConstantFieldReceiverNonNull.Trait.x1(this) == LitInt(7))
    {
        newtype$check#1 := LitInt(7);
        assert {:id "id110"} LitInt(6) <= newtype$check#1;
    }

    assume true;
    assert {:id "id111"} {:subsumption 0} ConstantFieldReceiverNonNull.Trait.x1(this) == LitInt(7);
    assert {:id "id112"} {:subsumption 0} ConstantFieldReceiverNonNull.Trait.y() == LitInt(7);
    assume {:id "id113"} ConstantFieldReceiverNonNull.Trait.x1(this) == LitInt(7)
       && ConstantFieldReceiverNonNull.Trait.y() == LitInt(7);
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/SmallTests.dfy(893,7)
    assume true;
    assume true;
    assume true;
    assume true;
...
procedure {:verboseName "ConstantFieldReceiverNonNull.AnotherClass.M (well-formedness)"} CheckWellFormed$$ConstantFieldReceiverNonNull.AnotherClass.M(ac#0: ref
       where $Is(ac#0, Tclass.ConstantFieldReceiverNonNull.AnotherClass?())
         && $IsAlloc(ac#0, Tclass.ConstantFieldReceiverNonNull.AnotherClass?(), $Heap))
   returns (v#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "ConstantFieldReceiverNonNull.AnotherClass.M (call)"} Call$$ConstantFieldReceiverNonNull.AnotherClass.M(ac#0: ref
       where $Is(ac#0, Tclass.ConstantFieldReceiverNonNull.AnotherClass?())
         && $IsAlloc(ac#0, Tclass.ConstantFieldReceiverNonNull.AnotherClass?(), $Heap))
   returns (v#0: int);
  modifies $Heap;
...
procedure {:verboseName "ConstantFieldReceiverNonNull.AnotherClass.M (correctness)"} Impl$$ConstantFieldReceiverNonNull.AnotherClass.M(ac#0: ref
       where $Is(ac#0, Tclass.ConstantFieldReceiverNonNull.AnotherClass?())
         && $IsAlloc(ac#0, Tclass.ConstantFieldReceiverNonNull.AnotherClass?(), $Heap))
   returns (v#0: int, $_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ConstantFieldReceiverNonNull.AnotherClass.M (correctness)"} Impl$$ConstantFieldReceiverNonNull.AnotherClass.M(ac#0: ref) returns (v#0: int, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;

    // AddMethodImpl: M, Impl$$ConstantFieldReceiverNonNull.AnotherClass.M
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/SmallTests.dfy(909,9)
    assume true;
    assert {:id "id114"} ac#0 != null;
    assume true;
    v#0 := ConstantFieldReceiverNonNull.AnotherClass.u(ac#0);
}
