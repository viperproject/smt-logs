...
axiom 0 <= $FunctionContextHeight
   ==> (forall GenericPick._default.SetPick0$U: Ty, s#0: Set :: 
...
axiom 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, GenericPick._default.SetPick0$U: Ty, s#0: Set :: 
...
axiom {:id "id0"} 0 <= $FunctionContextHeight
   ==> (forall GenericPick._default.SetPick0$U: Ty, $Heap: Heap, s#0: Set :: 
    ...
    GenericPick.__default.SetPick0#canCall(GenericPick._default.SetPick0$U, s#0)
         || (0 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           && $Is(s#0, TSet(GenericPick._default.SetPick0$U))
           && !Set#Equal(s#0, Set#Empty(): Set))
       ==> $let#0$canCall(GenericPick._default.SetPick0$U, s#0)
         && GenericPick.__default.SetPick0(GenericPick._default.SetPick0$U, s#0)
           == (var x#0 := $let#0_x(GenericPick._default.SetPick0$U, s#0); x#0));
    ...
    GenericPick.__default.SetPick0#canCall(GenericPick._default.SetPick0$U, Lit(s#0))
         || (0 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           && $Is(s#0, TSet(GenericPick._default.SetPick0$U))
           && !Set#Equal(s#0, Set#Empty(): Set))
       ==> $let#0$canCall(GenericPick._default.SetPick0$U, Lit(s#0))
         && GenericPick.__default.SetPick0(GenericPick._default.SetPick0$U, Lit(s#0))
           == (var x#1 := $let#0_x(GenericPick._default.SetPick0$U, Lit(s#0)); x#1));
}
...
function $let#0_x(GenericPick._default.SetPick0$U: Ty, s: Set) : Box;

function $let#0$canCall(GenericPick._default.SetPick0$U: Ty, s: Set) : bool;

axiom (forall GenericPick._default.SetPick0$U: Ty, s: Set :: 
  { $let#0_x(GenericPick._default.SetPick0$U, s) } 
  $let#0$canCall(GenericPick._default.SetPick0$U, s)
     ==> Set#IsMember(s, $let#0_x(GenericPick._default.SetPick0$U, s)));

procedure {:verboseName "GenericPick.SetPick0 (well-formedness)"} CheckWellformed$$GenericPick.__default.SetPick0(GenericPick._default.SetPick0$U: Ty, 
    s#0: Set where $Is(s#0, TSet(GenericPick._default.SetPick0$U)));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "GenericPick.SetPick0 (well-formedness)"} CheckWellformed$$GenericPick.__default.SetPick0(GenericPick._default.SetPick0$U: Ty, s#0: Set)
{
  ...
  var x#2: Box;
    ...
    assume {:id "id2"} !Set#Equal(s#0, Set#Empty(): Set);
    ...
    if (*)
    {
        ...
        assume $IsBox(GenericPick.__default.SetPick0(GenericPick._default.SetPick0$U, s#0), 
          GenericPick._default.SetPick0$U);
        assume false;
    }
    else
    {
        ...
        havoc x#2;
        if ($IsBox(x#2, GenericPick._default.SetPick0$U)
           && $IsAllocBox(x#2, GenericPick._default.SetPick0$U, $Heap))
        {
        }

        assert {:id "id3"} (exists x#3: Box :: 
          $IsBox(x#3, GenericPick._default.SetPick0$U) && Set#IsMember(s#0, x#3));
        assume $IsBox(x#2, GenericPick._default.SetPick0$U)
           && $IsAllocBox(x#2, GenericPick._default.SetPick0$U, $Heap);
        assume Set#IsMember(s#0, x#2);
        assume $let#0$canCall(GenericPick._default.SetPick0$U, s#0);
        assume {:id "id4"} GenericPick.__default.SetPick0(GenericPick._default.SetPick0$U, s#0) == x#2;
        assume true;
...
axiom 0 <= $FunctionContextHeight
   ==> (forall GenericPick._default.SetPick1$U: Ty, s#0: Set :: 
...
axiom 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, GenericPick._default.SetPick1$U: Ty, s#0: Set :: 
...
axiom {:id "id5"} 0 <= $FunctionContextHeight
   ==> (forall GenericPick._default.SetPick1$U: Ty, $Heap: Heap, s#0: Set :: 
    ...
    GenericPick.__default.SetPick1#canCall(GenericPick._default.SetPick1$U, s#0)
         || (0 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           && $Is(s#0, TSet(GenericPick._default.SetPick1$U))
           && Set#Card(s#0) != 0)
       ==> $let#3$canCall(GenericPick._default.SetPick1$U, s#0)
         && GenericPick.__default.SetPick1(GenericPick._default.SetPick1$U, s#0)
           == (var x#0 := $let#3_x(GenericPick._default.SetPick1$U, s#0); x#0));
    ...
    GenericPick.__default.SetPick1#canCall(GenericPick._default.SetPick1$U, Lit(s#0))
         || (0 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           && $Is(s#0, TSet(GenericPick._default.SetPick1$U))
           && Set#Card(Lit(s#0)) != 0)
       ==> $let#3$canCall(GenericPick._default.SetPick1$U, Lit(s#0))
         && GenericPick.__default.SetPick1(GenericPick._default.SetPick1$U, Lit(s#0))
           == (var x#1 := $let#3_x(GenericPick._default.SetPick1$U, Lit(s#0)); x#1));
}
...
function $let#3_x(GenericPick._default.SetPick1$U: Ty, s: Set) : Box;

function $let#3$canCall(GenericPick._default.SetPick1$U: Ty, s: Set) : bool;

axiom (forall GenericPick._default.SetPick1$U: Ty, s: Set :: 
  { $let#3_x(GenericPick._default.SetPick1$U, s) } 
  $let#3$canCall(GenericPick._default.SetPick1$U, s)
     ==> Set#IsMember(s, $let#3_x(GenericPick._default.SetPick1$U, s)));

procedure {:verboseName "GenericPick.SetPick1 (well-formedness)"} CheckWellformed$$GenericPick.__default.SetPick1(GenericPick._default.SetPick1$U: Ty, 
    s#0: Set where $Is(s#0, TSet(GenericPick._default.SetPick1$U)));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "GenericPick.SetPick1 (well-formedness)"} CheckWellformed$$GenericPick.__default.SetPick1(GenericPick._default.SetPick1$U: Ty, s#0: Set)
{
  var $_ReadsFrame: [ref,Field]bool;
  var x#2: Box;
    ...
    {
        // Check well-formedness of postcondition and assume false
        assume $IsBox(GenericPick.__default.SetPick1(GenericPick._default.SetPick1$U, s#0), 
          GenericPick._default.SetPick1$U);
        assume false;
    }
    else
    {
        // Check well-formedness of body and result subset type constraint
        havoc x#2;
        if ($IsBox(x#2, GenericPick._default.SetPick1$U)
           && $IsAllocBox(x#2, GenericPick._default.SetPick1$U, $Heap))
        {
        }

        assert {:id "id8"} (exists x#3: Box :: 
          $IsBox(x#3, GenericPick._default.SetPick1$U) && Set#IsMember(s#0, x#3));
        assume $IsBox(x#2, GenericPick._default.SetPick1$U)
           && $IsAllocBox(x#2, GenericPick._default.SetPick1$U, $Heap);
        assume Set#IsMember(s#0, x#2);
        assume $let#3$canCall(GenericPick._default.SetPick1$U, s#0);
        assume {:id "id9"} GenericPick.__default.SetPick1(GenericPick._default.SetPick1$U, s#0) == x#2;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $IsBox(GenericPick.__default.SetPick1(GenericPick._default.SetPick1$U, s#0), 
          GenericPick._default.SetPick1$U);
...
axiom 0 <= $FunctionContextHeight
   ==> (forall GenericPick._default.SetPick2$U: Ty, s#0: Set :: 
...
axiom 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, GenericPick._default.SetPick2$U: Ty, s#0: Set :: 
...
axiom {:id "id10"} 0 <= $FunctionContextHeight
   ==> (forall GenericPick._default.SetPick2$U: Ty, $Heap: Heap, s#0: Set :: 
         ...
         || (0 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           ...
           && (exists x#1: Box :: 
            ...
            $IsBox(x#1, GenericPick._default.SetPick2$U) && Set#IsMember(s#0, x#1)))
       ==> $let#6$canCall(GenericPick._default.SetPick2$U, s#0)
         && GenericPick.__default.SetPick2(GenericPick._default.SetPick2$U, s#0)
           == (var x#2 := $let#6_x(GenericPick._default.SetPick2$U, s#0); x#2));
         ...
         || (0 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           ...
           && (exists x#3: Box :: 
            ...
            $IsBox(x#3, GenericPick._default.SetPick2$U) && Set#IsMember(Lit(s#0), x#3)))
       ==> $let#6$canCall(GenericPick._default.SetPick2$U, Lit(s#0))
         && GenericPick.__default.SetPick2(GenericPick._default.SetPick2$U, Lit(s#0))
           == (var x#4 := $let#6_x(GenericPick._default.SetPick2$U, Lit(s#0)); x#4));
}
...
function $let#6_x(GenericPick._default.SetPick2$U: Ty, s: Set) : Box;

function $let#6$canCall(GenericPick._default.SetPick2$U: Ty, s: Set) : bool;

axiom (forall GenericPick._default.SetPick2$U: Ty, s: Set :: 
  { $let#6_x(GenericPick._default.SetPick2$U, s) } 
  $let#6$canCall(GenericPick._default.SetPick2$U, s)
     ==> Set#IsMember(s, $let#6_x(GenericPick._default.SetPick2$U, s)));

procedure {:verboseName "GenericPick.SetPick2 (well-formedness)"} CheckWellformed$$GenericPick.__default.SetPick2(GenericPick._default.SetPick2$U: Ty, 
    s#0: Set where $Is(s#0, TSet(GenericPick._default.SetPick2$U)));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "GenericPick.SetPick2 (well-formedness)"} CheckWellformed$$GenericPick.__default.SetPick2(GenericPick._default.SetPick2$U: Ty, s#0: Set)
{
  var $_ReadsFrame: [ref,Field]bool;
  var x#5: Box;
  var x#6: Box;
    ...
    // Check well-formedness of preconditions, and then assume them
    havoc x#5;
    assume $IsBox(x#5, GenericPick._default.SetPick2$U)
       && $IsAllocBox(x#5, GenericPick._default.SetPick2$U, $Heap);
    assume {:id "id12"} Set#IsMember(s#0, x#5);
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    {
        // Check well-formedness of postcondition and assume false
        assume $IsBox(GenericPick.__default.SetPick2(GenericPick._default.SetPick2$U, s#0), 
          GenericPick._default.SetPick2$U);
        assume false;
    }
    else
    {
        // Check well-formedness of body and result subset type constraint
        havoc x#6;
        if ($IsBox(x#6, GenericPick._default.SetPick2$U)
           && $IsAllocBox(x#6, GenericPick._default.SetPick2$U, $Heap))
        {
        }

        assert {:id "id13"} (exists x#7: Box :: 
          $IsBox(x#7, GenericPick._default.SetPick2$U) && Set#IsMember(s#0, x#7));
        assume $IsBox(x#6, GenericPick._default.SetPick2$U)
           && $IsAllocBox(x#6, GenericPick._default.SetPick2$U, $Heap);
        assume Set#IsMember(s#0, x#6);
        assume $let#6$canCall(GenericPick._default.SetPick2$U, s#0);
        assume {:id "id14"} GenericPick.__default.SetPick2(GenericPick._default.SetPick2$U, s#0) == x#6;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $IsBox(GenericPick.__default.SetPick2(GenericPick._default.SetPick2$U, s#0), 
          GenericPick._default.SetPick2$U);
...
axiom 0 <= $FunctionContextHeight
   ==> (forall GenericPick._default.MultisetPick0$U: Ty, s#0: MultiSet :: 
...
axiom 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, GenericPick._default.MultisetPick0$U: Ty, s#0: MultiSet :: 
...
axiom {:id "id15"} 0 <= $FunctionContextHeight
   ==> (forall GenericPick._default.MultisetPick0$U: Ty, $Heap: Heap, s#0: MultiSet :: 
    ...
    GenericPick.__default.MultisetPick0#canCall(GenericPick._default.MultisetPick0$U, s#0)
         || (0 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           && $Is(s#0, TMultiSet(GenericPick._default.MultisetPick0$U))
           && !MultiSet#Equal(s#0, MultiSet#Empty(): MultiSet))
       ==> $let#9$canCall(GenericPick._default.MultisetPick0$U, s#0)
         && GenericPick.__default.MultisetPick0(GenericPick._default.MultisetPick0$U, s#0)
           == (var x#0 := $let#9_x(GenericPick._default.MultisetPick0$U, s#0); x#0));
    ...
    GenericPick.__default.MultisetPick0#canCall(GenericPick._default.MultisetPick0$U, Lit(s#0))
         || (0 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           && $Is(s#0, TMultiSet(GenericPick._default.MultisetPick0$U))
           && !MultiSet#Equal(s#0, MultiSet#Empty(): MultiSet))
       ==> $let#9$canCall(GenericPick._default.MultisetPick0$U, Lit(s#0))
         && GenericPick.__default.MultisetPick0(GenericPick._default.MultisetPick0$U, Lit(s#0))
           == (var x#1 := $let#9_x(GenericPick._default.MultisetPick0$U, Lit(s#0)); x#1));
}
...
function $let#9_x(GenericPick._default.MultisetPick0$U: Ty, s: MultiSet) : Box;

function $let#9$canCall(GenericPick._default.MultisetPick0$U: Ty, s: MultiSet) : bool;

axiom (forall GenericPick._default.MultisetPick0$U: Ty, s: MultiSet :: 
  { $let#9_x(GenericPick._default.MultisetPick0$U, s) } 
  $let#9$canCall(GenericPick._default.MultisetPick0$U, s)
     ==> MultiSet#Multiplicity(s, $let#9_x(GenericPick._default.MultisetPick0$U, s)) > 0);

procedure {:verboseName "GenericPick.MultisetPick0 (well-formedness)"} CheckWellformed$$GenericPick.__default.MultisetPick0(GenericPick._default.MultisetPick0$U: Ty, 
    s#0: MultiSet where $Is(s#0, TMultiSet(GenericPick._default.MultisetPick0$U)));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "GenericPick.MultisetPick0 (well-formedness)"} CheckWellformed$$GenericPick.__default.MultisetPick0(GenericPick._default.MultisetPick0$U: Ty, s#0: MultiSet)
{
  var $_ReadsFrame: [ref,Field]bool;
  var x#2: Box;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    // Check well-formedness of preconditions, and then assume them
    assume {:id "id17"} !MultiSet#Equal(s#0, MultiSet#Empty(): MultiSet);
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    {
        // Check well-formedness of postcondition and assume false
        assume $IsBox(GenericPick.__default.MultisetPick0(GenericPick._default.MultisetPick0$U, s#0), 
          GenericPick._default.MultisetPick0$U);
        assume false;
    }
    else
    {
        // Check well-formedness of body and result subset type constraint
        havoc x#2;
        if ($IsBox(x#2, GenericPick._default.MultisetPick0$U)
           && $IsAllocBox(x#2, GenericPick._default.MultisetPick0$U, $Heap))
        {
        }

        assert {:id "id18"} (exists x#3: Box :: 
          $IsBox(x#3, GenericPick._default.MultisetPick0$U)
             && MultiSet#Multiplicity(s#0, x#3) > 0);
        assume $IsBox(x#2, GenericPick._default.MultisetPick0$U)
           && $IsAllocBox(x#2, GenericPick._default.MultisetPick0$U, $Heap);
        assume MultiSet#Multiplicity(s#0, x#2) > 0;
        assume $let#9$canCall(GenericPick._default.MultisetPick0$U, s#0);
        assume {:id "id19"} GenericPick.__default.MultisetPick0(GenericPick._default.MultisetPick0$U, s#0)
           == x#2;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $IsBox(GenericPick.__default.MultisetPick0(GenericPick._default.MultisetPick0$U, s#0), 
...
axiom 0 <= $FunctionContextHeight
   ==> (forall GenericPick._default.MultisetPick1$U: Ty, s#0: MultiSet :: 
...
axiom 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, GenericPick._default.MultisetPick1$U: Ty, s#0: MultiSet :: 
...
axiom {:id "id20"} 0 <= $FunctionContextHeight
   ==> (forall GenericPick._default.MultisetPick1$U: Ty, $Heap: Heap, s#0: MultiSet :: 
    ...
    GenericPick.__default.MultisetPick1#canCall(GenericPick._default.MultisetPick1$U, s#0)
         || (0 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           && $Is(s#0, TMultiSet(GenericPick._default.MultisetPick1$U))
           && MultiSet#Card(s#0) != 0)
       ==> $let#12$canCall(GenericPick._default.MultisetPick1$U, s#0)
         && GenericPick.__default.MultisetPick1(GenericPick._default.MultisetPick1$U, s#0)
           == (var x#0 := $let#12_x(GenericPick._default.MultisetPick1$U, s#0); x#0));
...
axiom {:id "id21"} 0 <= $FunctionContextHeight
   ==> (forall GenericPick._default.MultisetPick1$U: Ty, $Heap: Heap, s#0: MultiSet :: 
    ...
    GenericPick.__default.MultisetPick1#canCall(GenericPick._default.MultisetPick1$U, Lit(s#0))
       ...
       ==> $let#12$canCall(GenericPick._default.MultisetPick1$U, Lit(s#0))
         && GenericPick.__default.MultisetPick1(GenericPick._default.MultisetPick1$U, Lit(s#0))
           == (var x#1 := $let#12_x(GenericPick._default.MultisetPick1$U, Lit(s#0)); x#1));
}
...
function $let#12_x(GenericPick._default.MultisetPick1$U: Ty, s: MultiSet) : Box;

function $let#12$canCall(GenericPick._default.MultisetPick1$U: Ty, s: MultiSet) : bool;

axiom (forall GenericPick._default.MultisetPick1$U: Ty, s: MultiSet :: 
  { $let#12_x(GenericPick._default.MultisetPick1$U, s) } 
  $let#12$canCall(GenericPick._default.MultisetPick1$U, s)
     ==> MultiSet#Multiplicity(s, $let#12_x(GenericPick._default.MultisetPick1$U, s)) > 0);

procedure {:verboseName "GenericPick.MultisetPick1 (well-formedness)"} CheckWellformed$$GenericPick.__default.MultisetPick1(GenericPick._default.MultisetPick1$U: Ty, 
    s#0: MultiSet where $Is(s#0, TMultiSet(GenericPick._default.MultisetPick1$U)));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "GenericPick.MultisetPick1 (well-formedness)"} CheckWellformed$$GenericPick.__default.MultisetPick1(GenericPick._default.MultisetPick1$U: Ty, s#0: MultiSet)
{
  var $_ReadsFrame: [ref,Field]bool;
  var x#2: Box;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    // Check well-formedness of preconditions, and then assume them
    assume {:id "id22"} MultiSet#Card(s#0) != 0;
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    {
        // Check well-formedness of postcondition and assume false
        assume $IsBox(GenericPick.__default.MultisetPick1(GenericPick._default.MultisetPick1$U, s#0), 
          GenericPick._default.MultisetPick1$U);
        assume false;
    }
    else
    {
        // Check well-formedness of body and result subset type constraint
        havoc x#2;
        if ($IsBox(x#2, GenericPick._default.MultisetPick1$U)
           && $IsAllocBox(x#2, GenericPick._default.MultisetPick1$U, $Heap))
        {
        }

        assert {:id "id23"} (exists x#3: Box :: 
          $IsBox(x#3, GenericPick._default.MultisetPick1$U)
             && MultiSet#Multiplicity(s#0, x#3) > 0);
        assume $IsBox(x#2, GenericPick._default.MultisetPick1$U)
           && $IsAllocBox(x#2, GenericPick._default.MultisetPick1$U, $Heap);
        assume MultiSet#Multiplicity(s#0, x#2) > 0;
        assume $let#12$canCall(GenericPick._default.MultisetPick1$U, s#0);
        assume {:id "id24"} GenericPick.__default.MultisetPick1(GenericPick._default.MultisetPick1$U, s#0)
           == x#2;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $IsBox(GenericPick.__default.MultisetPick1(GenericPick._default.MultisetPick1$U, s#0), 
...
axiom 0 <= $FunctionContextHeight
   ==> (forall GenericPick._default.MultisetPick2$U: Ty, s#0: MultiSet :: 
...
axiom 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, GenericPick._default.MultisetPick2$U: Ty, s#0: MultiSet :: 
...
axiom {:id "id25"} 0 <= $FunctionContextHeight
   ==> (forall GenericPick._default.MultisetPick2$U: Ty, $Heap: Heap, s#0: MultiSet :: 
    ...
    GenericPick.__default.MultisetPick2#canCall(GenericPick._default.MultisetPick2$U, s#0)
         || (0 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           && $Is(s#0, TMultiSet(GenericPick._default.MultisetPick2$U))
           && (exists x#1: Box :: 
            { MultiSet#Multiplicity(s#0, x#1) } 
            $IsBox(x#1, GenericPick._default.MultisetPick2$U)
               && MultiSet#Multiplicity(s#0, x#1) > 0))
       ==> $let#15$canCall(GenericPick._default.MultisetPick2$U, s#0)
         && GenericPick.__default.MultisetPick2(GenericPick._default.MultisetPick2$U, s#0)
           == (var x#2 := $let#15_x(GenericPick._default.MultisetPick2$U, s#0); x#2));
    ...
    GenericPick.__default.MultisetPick2#canCall(GenericPick._default.MultisetPick2$U, Lit(s#0))
         || (0 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           && $Is(s#0, TMultiSet(GenericPick._default.MultisetPick2$U))
           && (exists x#3: Box :: 
            { MultiSet#Multiplicity(s#0, x#3) } 
            $IsBox(x#3, GenericPick._default.MultisetPick2$U)
               && MultiSet#Multiplicity(Lit(s#0), x#3) > 0))
       ==> $let#15$canCall(GenericPick._default.MultisetPick2$U, Lit(s#0))
         && GenericPick.__default.MultisetPick2(GenericPick._default.MultisetPick2$U, Lit(s#0))
           == (var x#4 := $let#15_x(GenericPick._default.MultisetPick2$U, Lit(s#0)); x#4));
}
...
function $let#15_x(GenericPick._default.MultisetPick2$U: Ty, s: MultiSet) : Box;

function $let#15$canCall(GenericPick._default.MultisetPick2$U: Ty, s: MultiSet) : bool;

axiom (forall GenericPick._default.MultisetPick2$U: Ty, s: MultiSet :: 
  { $let#15_x(GenericPick._default.MultisetPick2$U, s) } 
  $let#15$canCall(GenericPick._default.MultisetPick2$U, s)
     ==> MultiSet#Multiplicity(s, $let#15_x(GenericPick._default.MultisetPick2$U, s)) > 0);

procedure {:verboseName "GenericPick.MultisetPick2 (well-formedness)"} CheckWellformed$$GenericPick.__default.MultisetPick2(GenericPick._default.MultisetPick2$U: Ty, 
    s#0: MultiSet where $Is(s#0, TMultiSet(GenericPick._default.MultisetPick2$U)));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "GenericPick.MultisetPick2 (well-formedness)"} CheckWellformed$$GenericPick.__default.MultisetPick2(GenericPick._default.MultisetPick2$U: Ty, s#0: MultiSet)
{
  var $_ReadsFrame: [ref,Field]bool;
  var x#5: Box;
  var x#6: Box;
    ...
    // Check well-formedness of preconditions, and then assume them
    havoc x#5;
    assume $IsBox(x#5, GenericPick._default.MultisetPick2$U)
       && $IsAllocBox(x#5, GenericPick._default.MultisetPick2$U, $Heap);
    assume {:id "id27"} MultiSet#Multiplicity(s#0, x#5) > 0;
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    {
        // Check well-formedness of postcondition and assume false
        assume $IsBox(GenericPick.__default.MultisetPick2(GenericPick._default.MultisetPick2$U, s#0), 
          GenericPick._default.MultisetPick2$U);
        assume false;
    }
    else
    {
        // Check well-formedness of body and result subset type constraint
        havoc x#6;
        if ($IsBox(x#6, GenericPick._default.MultisetPick2$U)
           && $IsAllocBox(x#6, GenericPick._default.MultisetPick2$U, $Heap))
        {
        }

        assert {:id "id28"} (exists x#7: Box :: 
          $IsBox(x#7, GenericPick._default.MultisetPick2$U)
             && MultiSet#Multiplicity(s#0, x#7) > 0);
        assume $IsBox(x#6, GenericPick._default.MultisetPick2$U)
           && $IsAllocBox(x#6, GenericPick._default.MultisetPick2$U, $Heap);
        assume MultiSet#Multiplicity(s#0, x#6) > 0;
        assume $let#15$canCall(GenericPick._default.MultisetPick2$U, s#0);
        assume {:id "id29"} GenericPick.__default.MultisetPick2(GenericPick._default.MultisetPick2$U, s#0)
           == x#6;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $IsBox(GenericPick.__default.MultisetPick2(GenericPick._default.MultisetPick2$U, s#0), 
...
axiom 0 <= $FunctionContextHeight
   ==> (forall GenericPick._default.MultisetPick3$U: Ty, s#0: MultiSet :: 
...
axiom 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, GenericPick._default.MultisetPick3$U: Ty, s#0: MultiSet :: 
...
axiom {:id "id30"} 0 <= $FunctionContextHeight
   ==> (forall GenericPick._default.MultisetPick3$U: Ty, $Heap: Heap, s#0: MultiSet :: 
    ...
    GenericPick.__default.MultisetPick3#canCall(GenericPick._default.MultisetPick3$U, s#0)
         || (0 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           ...
           && (exists x#1: Box :: 
            { MultiSet#Multiplicity(s#0, x#1) } 
            $IsBox(x#1, GenericPick._default.MultisetPick3$U)
               && 
              MultiSet#Multiplicity(s#0, x#1) > 0
               && MultiSet#Multiplicity(s#0, x#1) > 0))
       ==> $let#18$canCall(GenericPick._default.MultisetPick3$U, s#0)
         && GenericPick.__default.MultisetPick3(GenericPick._default.MultisetPick3$U, s#0)
           == (var x#2 := $let#18_x(GenericPick._default.MultisetPick3$U, s#0); x#2));
    ...
    GenericPick.__default.MultisetPick3#canCall(GenericPick._default.MultisetPick3$U, Lit(s#0))
         || (0 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           ...
           && (exists x#3: Box :: 
            { MultiSet#Multiplicity(s#0, x#3) } 
            $IsBox(x#3, GenericPick._default.MultisetPick3$U)
               && 
              MultiSet#Multiplicity(Lit(s#0), x#3) > 0
               && MultiSet#Multiplicity(Lit(s#0), x#3) > 0))
       ==> $let#18$canCall(GenericPick._default.MultisetPick3$U, Lit(s#0))
         && GenericPick.__default.MultisetPick3(GenericPick._default.MultisetPick3$U, Lit(s#0))
           == (var x#4 := $let#18_x(GenericPick._default.MultisetPick3$U, Lit(s#0)); x#4));
}
...
function $let#18_x(GenericPick._default.MultisetPick3$U: Ty, s: MultiSet) : Box;

function $let#18$canCall(GenericPick._default.MultisetPick3$U: Ty, s: MultiSet) : bool;

axiom (forall GenericPick._default.MultisetPick3$U: Ty, s: MultiSet :: 
  { $let#18_x(GenericPick._default.MultisetPick3$U, s) } 
  $let#18$canCall(GenericPick._default.MultisetPick3$U, s)
     ==> MultiSet#Multiplicity(s, $let#18_x(GenericPick._default.MultisetPick3$U, s)) > 0);

procedure {:verboseName "GenericPick.MultisetPick3 (well-formedness)"} CheckWellformed$$GenericPick.__default.MultisetPick3(GenericPick._default.MultisetPick3$U: Ty, 
    s#0: MultiSet where $Is(s#0, TMultiSet(GenericPick._default.MultisetPick3$U)));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "GenericPick.MultisetPick3 (well-formedness)"} CheckWellformed$$GenericPick.__default.MultisetPick3(GenericPick._default.MultisetPick3$U: Ty, s#0: MultiSet)
{
  var $_ReadsFrame: [ref,Field]bool;
  var x#5: Box;
  var x#6: Box;
    ...
    // Check well-formedness of preconditions, and then assume them
    havoc x#5;
    assume $IsBox(x#5, GenericPick._default.MultisetPick3$U)
       && $IsAllocBox(x#5, GenericPick._default.MultisetPick3$U, $Heap);
    assume {:id "id32"} MultiSet#Multiplicity(s#0, x#5) > 0;
    assume {:id "id33"} MultiSet#Multiplicity(s#0, x#5) > 0;
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    {
        // Check well-formedness of postcondition and assume false
        assume $IsBox(GenericPick.__default.MultisetPick3(GenericPick._default.MultisetPick3$U, s#0), 
          GenericPick._default.MultisetPick3$U);
        assume false;
    }
    else
    {
        // Check well-formedness of body and result subset type constraint
        havoc x#6;
        if ($IsBox(x#6, GenericPick._default.MultisetPick3$U)
           && $IsAllocBox(x#6, GenericPick._default.MultisetPick3$U, $Heap))
        {
        }

        assert {:id "id34"} (exists x#7: Box :: 
          $IsBox(x#7, GenericPick._default.MultisetPick3$U)
             && MultiSet#Multiplicity(s#0, x#7) > 0);
        assume $IsBox(x#6, GenericPick._default.MultisetPick3$U)
           && $IsAllocBox(x#6, GenericPick._default.MultisetPick3$U, $Heap);
        assume MultiSet#Multiplicity(s#0, x#6) > 0;
        assume $let#18$canCall(GenericPick._default.MultisetPick3$U, s#0);
        assume {:id "id35"} GenericPick.__default.MultisetPick3(GenericPick._default.MultisetPick3$U, s#0)
           == x#6;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $IsBox(GenericPick.__default.MultisetPick3(GenericPick._default.MultisetPick3$U, s#0), 
...
axiom 1 <= $FunctionContextHeight
   ==> (forall GenericPick._default.SeqPick0$U: Ty, s#0: Seq :: 
...
axiom 1 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, GenericPick._default.SeqPick0$U: Ty, s#0: Seq :: 
...
axiom {:id "id36"} 1 <= $FunctionContextHeight
   ==> (forall GenericPick._default.SeqPick0$U: Ty, $Heap: Heap, s#0: Seq :: 
    ...
    GenericPick.__default.SeqPick0#canCall(GenericPick._default.SeqPick0$U, s#0)
         || (1 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           && $Is(s#0, TSeq(GenericPick._default.SeqPick0$U))
           && !Seq#Equal(s#0, Seq#Empty(): Seq))
       ==> $let#21$canCall(GenericPick._default.SeqPick0$U, s#0)
         && GenericPick.__default.SeqPick0(GenericPick._default.SeqPick0$U, s#0)
           == (var x#0 := $let#21_x(GenericPick._default.SeqPick0$U, s#0); x#0));
    ...
    GenericPick.__default.SeqPick0#canCall(GenericPick._default.SeqPick0$U, Lit(s#0))
         || (1 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           && $Is(s#0, TSeq(GenericPick._default.SeqPick0$U))
           && !Seq#Equal(s#0, Seq#Empty(): Seq))
       ==> $let#21$canCall(GenericPick._default.SeqPick0$U, Lit(s#0))
         && GenericPick.__default.SeqPick0(GenericPick._default.SeqPick0$U, Lit(s#0))
           == (var x#1 := $let#21_x(GenericPick._default.SeqPick0$U, Lit(s#0)); x#1));
}
...
function $let#21_x(GenericPick._default.SeqPick0$U: Ty, s: Seq) : Box;

function $let#21$canCall(GenericPick._default.SeqPick0$U: Ty, s: Seq) : bool;

axiom (forall GenericPick._default.SeqPick0$U: Ty, s: Seq :: 
  { $let#21_x(GenericPick._default.SeqPick0$U, s) } 
  $let#21$canCall(GenericPick._default.SeqPick0$U, s)
     ==> Seq#Contains(s, $let#21_x(GenericPick._default.SeqPick0$U, s)));

procedure {:verboseName "GenericPick.SeqPick0 (well-formedness)"} CheckWellformed$$GenericPick.__default.SeqPick0(GenericPick._default.SeqPick0$U: Ty, 
    s#0: Seq where $Is(s#0, TSeq(GenericPick._default.SeqPick0$U)));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "GenericPick.SeqPick0 (well-formedness)"} CheckWellformed$$GenericPick.__default.SeqPick0(GenericPick._default.SeqPick0$U: Ty, s#0: Seq)
{
  var $_ReadsFrame: [ref,Field]bool;
  var s##0: Seq;
  var x#2: Box;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    // Check well-formedness of preconditions, and then assume them
    assume {:id "id38"} !Seq#Equal(s#0, Seq#Empty(): Seq);
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    {
        // Check well-formedness of postcondition and assume false
        assume $IsBox(GenericPick.__default.SeqPick0(GenericPick._default.SeqPick0$U, s#0), 
          GenericPick._default.SeqPick0$U);
        assume false;
    }
    else
    {
        // Check well-formedness of body and result subset type constraint
        // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/SmallTests.dfy(806,45)
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        // ProcessCallStmt: CheckSubrange
        s##0 := s#0;
        call {:id "id39"} Call$$GenericPick.__default.EquivalentWaysOfSayingSequenceIsNonempty(GenericPick._default.SeqPick0$U, s##0);
        // TrCallStmt: After ProcessCallStmt
        havoc x#2;
        if ($IsBox(x#2, GenericPick._default.SeqPick0$U)
           && $IsAllocBox(x#2, GenericPick._default.SeqPick0$U, $Heap))
        {
        }

        assert {:id "id40"} (exists x#3: Box :: 
          $IsBox(x#3, GenericPick._default.SeqPick0$U) && Seq#Contains(s#0, x#3));
        assume $IsBox(x#2, GenericPick._default.SeqPick0$U)
           && $IsAllocBox(x#2, GenericPick._default.SeqPick0$U, $Heap);
        assume Seq#Contains(s#0, x#2);
        assume $let#21$canCall(GenericPick._default.SeqPick0$U, s#0);
        assume {:id "id41"} GenericPick.__default.SeqPick0(GenericPick._default.SeqPick0$U, s#0) == x#2;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $IsBox(GenericPick.__default.SeqPick0(GenericPick._default.SeqPick0$U, s#0), 
          GenericPick._default.SeqPick0$U);
...
axiom 1 <= $FunctionContextHeight
   ==> (forall GenericPick._default.SeqPick1$U: Ty, s#0: Seq :: 
...
axiom 1 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, GenericPick._default.SeqPick1$U: Ty, s#0: Seq :: 
...
axiom {:id "id42"} 1 <= $FunctionContextHeight
   ==> (forall GenericPick._default.SeqPick1$U: Ty, $Heap: Heap, s#0: Seq :: 
    ...
    GenericPick.__default.SeqPick1#canCall(GenericPick._default.SeqPick1$U, s#0)
         || (1 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           && $Is(s#0, TSeq(GenericPick._default.SeqPick1$U))
           && Seq#Length(s#0) != 0)
       ==> $let#24$canCall(GenericPick._default.SeqPick1$U, s#0)
         && GenericPick.__default.SeqPick1(GenericPick._default.SeqPick1$U, s#0)
           == (var x#0 := $let#24_x(GenericPick._default.SeqPick1$U, s#0); x#0));
...
axiom {:id "id43"} 1 <= $FunctionContextHeight
   ==> (forall GenericPick._default.SeqPick1$U: Ty, $Heap: Heap, s#0: Seq :: 
    ...
    GenericPick.__default.SeqPick1#canCall(GenericPick._default.SeqPick1$U, Lit(s#0))
       ...
       ==> $let#24$canCall(GenericPick._default.SeqPick1$U, Lit(s#0))
         && GenericPick.__default.SeqPick1(GenericPick._default.SeqPick1$U, Lit(s#0))
           == (var x#1 := $let#24_x(GenericPick._default.SeqPick1$U, Lit(s#0)); x#1));
}
...
function $let#24_x(GenericPick._default.SeqPick1$U: Ty, s: Seq) : Box;

function $let#24$canCall(GenericPick._default.SeqPick1$U: Ty, s: Seq) : bool;

axiom (forall GenericPick._default.SeqPick1$U: Ty, s: Seq :: 
  { $let#24_x(GenericPick._default.SeqPick1$U, s) } 
  $let#24$canCall(GenericPick._default.SeqPick1$U, s)
     ==> Seq#Contains(s, $let#24_x(GenericPick._default.SeqPick1$U, s)));

procedure {:verboseName "GenericPick.SeqPick1 (well-formedness)"} CheckWellformed$$GenericPick.__default.SeqPick1(GenericPick._default.SeqPick1$U: Ty, 
    s#0: Seq where $Is(s#0, TSeq(GenericPick._default.SeqPick1$U)));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "GenericPick.SeqPick1 (well-formedness)"} CheckWellformed$$GenericPick.__default.SeqPick1(GenericPick._default.SeqPick1$U: Ty, s#0: Seq)
{
  var $_ReadsFrame: [ref,Field]bool;
  var s##0: Seq;
  var x#2: Box;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    // Check well-formedness of preconditions, and then assume them
    assume {:id "id44"} Seq#Length(s#0) != 0;
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    {
        // Check well-formedness of postcondition and assume false
        assume $IsBox(GenericPick.__default.SeqPick1(GenericPick._default.SeqPick1$U, s#0), 
          GenericPick._default.SeqPick1$U);
        assume false;
    }
    else
    {
        // Check well-formedness of body and result subset type constraint
        // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/SmallTests.dfy(812,45)
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        // ProcessCallStmt: CheckSubrange
        s##0 := s#0;
        call {:id "id45"} Call$$GenericPick.__default.EquivalentWaysOfSayingSequenceIsNonempty(GenericPick._default.SeqPick1$U, s##0);
        // TrCallStmt: After ProcessCallStmt
        havoc x#2;
        if ($IsBox(x#2, GenericPick._default.SeqPick1$U)
           && $IsAllocBox(x#2, GenericPick._default.SeqPick1$U, $Heap))
        {
        }

        assert {:id "id46"} (exists x#3: Box :: 
          $IsBox(x#3, GenericPick._default.SeqPick1$U) && Seq#Contains(s#0, x#3));
        assume $IsBox(x#2, GenericPick._default.SeqPick1$U)
           && $IsAllocBox(x#2, GenericPick._default.SeqPick1$U, $Heap);
        assume Seq#Contains(s#0, x#2);
        assume $let#24$canCall(GenericPick._default.SeqPick1$U, s#0);
        assume {:id "id47"} GenericPick.__default.SeqPick1(GenericPick._default.SeqPick1$U, s#0) == x#2;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $IsBox(GenericPick.__default.SeqPick1(GenericPick._default.SeqPick1$U, s#0), 
          GenericPick._default.SeqPick1$U);
...
axiom 0 <= $FunctionContextHeight
   ==> (forall GenericPick._default.SeqPick2$U: Ty, s#0: Seq :: 
...
axiom 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, GenericPick._default.SeqPick2$U: Ty, s#0: Seq :: 
...
axiom {:id "id48"} 0 <= $FunctionContextHeight
   ==> (forall GenericPick._default.SeqPick2$U: Ty, $Heap: Heap, s#0: Seq :: 
    ...
    GenericPick.__default.SeqPick2#canCall(GenericPick._default.SeqPick2$U, s#0)
         || (0 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           && $Is(s#0, TSeq(GenericPick._default.SeqPick2$U))
           && (exists x#1: Box :: 
            { Seq#Contains(s#0, x#1) } 
            $IsBox(x#1, GenericPick._default.SeqPick2$U) && Seq#Contains(s#0, x#1)))
       ==> $let#27$canCall(GenericPick._default.SeqPick2$U, s#0)
         && GenericPick.__default.SeqPick2(GenericPick._default.SeqPick2$U, s#0)
           == (var x#2 := $let#27_x(GenericPick._default.SeqPick2$U, s#0); x#2));
    ...
    GenericPick.__default.SeqPick2#canCall(GenericPick._default.SeqPick2$U, Lit(s#0))
         || (0 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           && $Is(s#0, TSeq(GenericPick._default.SeqPick2$U))
           && (exists x#3: Box :: 
            { Seq#Contains(s#0, x#3) } 
            $IsBox(x#3, GenericPick._default.SeqPick2$U) && Seq#Contains(s#0, x#3)))
       ==> $let#27$canCall(GenericPick._default.SeqPick2$U, Lit(s#0))
         && GenericPick.__default.SeqPick2(GenericPick._default.SeqPick2$U, Lit(s#0))
           == (var x#4 := $let#27_x(GenericPick._default.SeqPick2$U, Lit(s#0)); x#4));
}
...
function $let#27_x(GenericPick._default.SeqPick2$U: Ty, s: Seq) : Box;

function $let#27$canCall(GenericPick._default.SeqPick2$U: Ty, s: Seq) : bool;

axiom (forall GenericPick._default.SeqPick2$U: Ty, s: Seq :: 
  { $let#27_x(GenericPick._default.SeqPick2$U, s) } 
  $let#27$canCall(GenericPick._default.SeqPick2$U, s)
     ==> Seq#Contains(s, $let#27_x(GenericPick._default.SeqPick2$U, s)));

procedure {:verboseName "GenericPick.SeqPick2 (well-formedness)"} CheckWellformed$$GenericPick.__default.SeqPick2(GenericPick._default.SeqPick2$U: Ty, 
    s#0: Seq where $Is(s#0, TSeq(GenericPick._default.SeqPick2$U)));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "GenericPick.SeqPick2 (well-formedness)"} CheckWellformed$$GenericPick.__default.SeqPick2(GenericPick._default.SeqPick2$U: Ty, s#0: Seq)
{
  var $_ReadsFrame: [ref,Field]bool;
  var x#5: Box;
  var x#6: Box;
    ...
    // Check well-formedness of preconditions, and then assume them
    havoc x#5;
    assume $IsBox(x#5, GenericPick._default.SeqPick2$U)
       && $IsAllocBox(x#5, GenericPick._default.SeqPick2$U, $Heap);
    assume {:id "id50"} Seq#Contains(s#0, x#5);
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    {
        // Check well-formedness of postcondition and assume false
        assume $IsBox(GenericPick.__default.SeqPick2(GenericPick._default.SeqPick2$U, s#0), 
          GenericPick._default.SeqPick2$U);
        assume false;
    }
    else
    {
        // Check well-formedness of body and result subset type constraint
        havoc x#6;
        if ($IsBox(x#6, GenericPick._default.SeqPick2$U)
           && $IsAllocBox(x#6, GenericPick._default.SeqPick2$U, $Heap))
        {
        }

        assert {:id "id51"} (exists x#7: Box :: 
          $IsBox(x#7, GenericPick._default.SeqPick2$U) && Seq#Contains(s#0, x#7));
        assume $IsBox(x#6, GenericPick._default.SeqPick2$U)
           && $IsAllocBox(x#6, GenericPick._default.SeqPick2$U, $Heap);
        assume Seq#Contains(s#0, x#6);
        assume $let#27$canCall(GenericPick._default.SeqPick2$U, s#0);
        assume {:id "id52"} GenericPick.__default.SeqPick2(GenericPick._default.SeqPick2$U, s#0) == x#6;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $IsBox(GenericPick.__default.SeqPick2(GenericPick._default.SeqPick2$U, s#0), 
          GenericPick._default.SeqPick2$U);
...
axiom 1 <= $FunctionContextHeight
   ==> (forall GenericPick._default.SeqPick3$U: Ty, s#0: Seq :: 
...
axiom 1 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, GenericPick._default.SeqPick3$U: Ty, s#0: Seq :: 
...
axiom {:id "id53"} 1 <= $FunctionContextHeight
   ==> (forall GenericPick._default.SeqPick3$U: Ty, $Heap: Heap, s#0: Seq :: 
    ...
    GenericPick.__default.SeqPick3#canCall(GenericPick._default.SeqPick3$U, s#0)
         || (1 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           && $Is(s#0, TSeq(GenericPick._default.SeqPick3$U))
           && (exists i#1: int :: LitInt(0) <= i#1 && i#1 < Seq#Length(s#0)))
       ==> $let#30$canCall(GenericPick._default.SeqPick3$U, s#0)
         && GenericPick.__default.SeqPick3(GenericPick._default.SeqPick3$U, s#0)
           == (var x#0 := $let#30_x(GenericPick._default.SeqPick3$U, s#0); x#0));
   ...
   ==> (forall GenericPick._default.SeqPick3$U: Ty, $Heap: Heap, s#0: Seq :: 
    ...
    GenericPick.__default.SeqPick3#canCall(GenericPick._default.SeqPick3$U, Lit(s#0))
         || (1 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           && $Is(s#0, TSeq(GenericPick._default.SeqPick3$U))
           && (exists i#2: int :: LitInt(0) <= i#2 && i#2 < Seq#Length(Lit(s#0))))
       ==> $let#30$canCall(GenericPick._default.SeqPick3$U, Lit(s#0))
         && GenericPick.__default.SeqPick3(GenericPick._default.SeqPick3$U, Lit(s#0))
           == (var x#1 := $let#30_x(GenericPick._default.SeqPick3$U, Lit(s#0)); x#1));
}
...
function $let#30_x(GenericPick._default.SeqPick3$U: Ty, s: Seq) : Box;

function $let#30$canCall(GenericPick._default.SeqPick3$U: Ty, s: Seq) : bool;

axiom (forall GenericPick._default.SeqPick3$U: Ty, s: Seq :: 
  { $let#30_x(GenericPick._default.SeqPick3$U, s) } 
  $let#30$canCall(GenericPick._default.SeqPick3$U, s)
     ==> Seq#Contains(s, $let#30_x(GenericPick._default.SeqPick3$U, s)));

procedure {:verboseName "GenericPick.SeqPick3 (well-formedness)"} CheckWellformed$$GenericPick.__default.SeqPick3(GenericPick._default.SeqPick3$U: Ty, 
    s#0: Seq where $Is(s#0, TSeq(GenericPick._default.SeqPick3$U)));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "GenericPick.SeqPick3 (well-formedness)"} CheckWellformed$$GenericPick.__default.SeqPick3(GenericPick._default.SeqPick3$U: Ty, s#0: Seq)
{
  var $_ReadsFrame: [ref,Field]bool;
  var i#3: int;
  var s##0: Seq;
  var x#2: Box;
    ...
    assume {:id "id55"} LitInt(0) <= i#3 && i#3 < Seq#Length(s#0);
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    {
        // Check well-formedness of postcondition and assume false
        assume $IsBox(GenericPick.__default.SeqPick3(GenericPick._default.SeqPick3$U, s#0), 
          GenericPick._default.SeqPick3$U);
        assume false;
    }
    else
    {
        // Check well-formedness of body and result subset type constraint
        // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/SmallTests.dfy(823,45)
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        // ProcessCallStmt: CheckSubrange
        s##0 := s#0;
        call {:id "id56"} Call$$GenericPick.__default.EquivalentWaysOfSayingSequenceIsNonempty(GenericPick._default.SeqPick3$U, s##0);
        // TrCallStmt: After ProcessCallStmt
        havoc x#2;
        if ($IsBox(x#2, GenericPick._default.SeqPick3$U)
           && $IsAllocBox(x#2, GenericPick._default.SeqPick3$U, $Heap))
        {
        }

        assert {:id "id57"} (exists x#3: Box :: 
          $IsBox(x#3, GenericPick._default.SeqPick3$U) && Seq#Contains(s#0, x#3));
        assume $IsBox(x#2, GenericPick._default.SeqPick3$U)
           && $IsAllocBox(x#2, GenericPick._default.SeqPick3$U, $Heap);
        assume Seq#Contains(s#0, x#2);
        assume $let#30$canCall(GenericPick._default.SeqPick3$U, s#0);
        assume {:id "id58"} GenericPick.__default.SeqPick3(GenericPick._default.SeqPick3$U, s#0) == x#2;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $IsBox(GenericPick.__default.SeqPick3(GenericPick._default.SeqPick3$U, s#0), 
          GenericPick._default.SeqPick3$U);
...
axiom 0 <= $FunctionContextHeight
   ==> (forall GenericPick._default.SeqPick4$U: Ty, s#0: Seq :: 
...
axiom 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, GenericPick._default.SeqPick4$U: Ty, s#0: Seq :: 
...
axiom {:id "id59"} 0 <= $FunctionContextHeight
   ==> (forall GenericPick._default.SeqPick4$U: Ty, $Heap: Heap, s#0: Seq :: 
    ...
    GenericPick.__default.SeqPick4#canCall(GenericPick._default.SeqPick4$U, s#0)
         || (0 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           && $Is(s#0, TSeq(GenericPick._default.SeqPick4$U))
           && (exists i#1: int :: LitInt(0) <= i#1 && i#1 < Seq#Length(s#0)))
       ==> $let#33$canCall(GenericPick._default.SeqPick4$U, s#0)
         && GenericPick.__default.SeqPick4(GenericPick._default.SeqPick4$U, s#0)
           == (var i#2 := $let#33_i(GenericPick._default.SeqPick4$U, s#0); 
            Seq#Index(s#0, i#2)));
   ...
   ==> (forall GenericPick._default.SeqPick4$U: Ty, $Heap: Heap, s#0: Seq :: 
    ...
    GenericPick.__default.SeqPick4#canCall(GenericPick._default.SeqPick4$U, Lit(s#0))
         || (0 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           && $Is(s#0, TSeq(GenericPick._default.SeqPick4$U))
           && (exists i#3: int :: LitInt(0) <= i#3 && i#3 < Seq#Length(Lit(s#0))))
       ==> $let#33$canCall(GenericPick._default.SeqPick4$U, Lit(s#0))
         && GenericPick.__default.SeqPick4(GenericPick._default.SeqPick4$U, Lit(s#0))
           == (var i#4 := $let#33_i(GenericPick._default.SeqPick4$U, Lit(s#0)); 
            Seq#Index(Lit(s#0), i#4)));
}
...
function $let#33_i(GenericPick._default.SeqPick4$U: Ty, s: Seq) : int;

function $let#33$canCall(GenericPick._default.SeqPick4$U: Ty, s: Seq) : bool;

axiom (forall GenericPick._default.SeqPick4$U: Ty, s: Seq :: 
  { $let#33_i(GenericPick._default.SeqPick4$U, s) } 
  $let#33$canCall(GenericPick._default.SeqPick4$U, s)
     ==> LitInt(0) <= $let#33_i(GenericPick._default.SeqPick4$U, s)
       && $let#33_i(GenericPick._default.SeqPick4$U, s) < Seq#Length(s));

procedure {:verboseName "GenericPick.SeqPick4 (well-formedness)"} CheckWellformed$$GenericPick.__default.SeqPick4(GenericPick._default.SeqPick4$U: Ty, 
    s#0: Seq where $Is(s#0, TSeq(GenericPick._default.SeqPick4$U)));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "GenericPick.SeqPick4 (well-formedness)"} CheckWellformed$$GenericPick.__default.SeqPick4(GenericPick._default.SeqPick4$U: Ty, s#0: Seq)
{
  var $_ReadsFrame: [ref,Field]bool;
  var i#5: int;
  var i#6: int;
    ...
    assume {:id "id61"} LitInt(0) <= i#5 && i#5 < Seq#Length(s#0);
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    {
        // Check well-formedness of postcondition and assume false
        assume $IsBox(GenericPick.__default.SeqPick4(GenericPick._default.SeqPick4$U, s#0), 
          GenericPick._default.SeqPick4$U);
        assume false;
    }
    else
    {
        ...
        assert {:id "id62"} ($Is(Seq#Length(s#0) - 1, TInt)
             && 
          ...
          ($Is(LitInt(0), TInt) && LitInt(0) <= LitInt(0) && 0 < Seq#Length(s#0))
           || 
          ($Is(LitInt(0), TInt) && LitInt(0) <= LitInt(0) && 0 < Seq#Length(s#0))
           || (exists i#7: int :: LitInt(0) <= i#7 && i#7 < Seq#Length(s#0));
        assume true;
        assume LitInt(0) <= i#6 && i#6 < Seq#Length(s#0);
        assert {:id "id63"} 0 <= i#6 && i#6 < Seq#Length(s#0);
        assume $let#33$canCall(GenericPick._default.SeqPick4$U, s#0);
        assume {:id "id64"} GenericPick.__default.SeqPick4(GenericPick._default.SeqPick4$U, s#0)
           == Seq#Index(s#0, i#6);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $IsBox(GenericPick.__default.SeqPick4(GenericPick._default.SeqPick4$U, s#0), 
...
procedure {:verboseName "GenericPick.EquivalentWaysOfSayingSequenceIsNonempty (well-formedness)"} CheckWellFormed$$GenericPick.__default.EquivalentWaysOfSayingSequenceIsNonempty(GenericPick._default.EquivalentWaysOfSayingSequenceIsNonempty$U: Ty, 
    s#0: Seq
       where $Is(s#0, TSeq(GenericPick._default.EquivalentWaysOfSayingSequenceIsNonempty$U))
         && $IsAlloc(s#0, 
          TSeq(GenericPick._default.EquivalentWaysOfSayingSequenceIsNonempty$U), 
          $Heap));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "GenericPick.EquivalentWaysOfSayingSequenceIsNonempty (call)"} Call$$GenericPick.__default.EquivalentWaysOfSayingSequenceIsNonempty(GenericPick._default.EquivalentWaysOfSayingSequenceIsNonempty$U: Ty, 
    s#0: Seq
       where $Is(s#0, TSeq(GenericPick._default.EquivalentWaysOfSayingSequenceIsNonempty$U))
         && $IsAlloc(s#0, 
          TSeq(GenericPick._default.EquivalentWaysOfSayingSequenceIsNonempty$U), 
  ...
  requires {:id "id71"} !Seq#Equal(s#0, Seq#Empty(): Seq)
     || Seq#Length(s#0) != 0
     || (exists i#1: int :: LitInt(0) <= i#1 && i#1 < Seq#Length(s#0));
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id72"} (exists x#1: Box :: 
    { Seq#Contains(s#0, x#1) } 
    $IsBox(x#1, GenericPick._default.EquivalentWaysOfSayingSequenceIsNonempty$U)
       && Seq#Contains(s#0, x#1));
  // frame condition
...
procedure {:verboseName "GenericPick.EquivalentWaysOfSayingSequenceIsNonempty (correctness)"} Impl$$GenericPick.__default.EquivalentWaysOfSayingSequenceIsNonempty(GenericPick._default.EquivalentWaysOfSayingSequenceIsNonempty$U: Ty, 
    s#0: Seq
       where $Is(s#0, TSeq(GenericPick._default.EquivalentWaysOfSayingSequenceIsNonempty$U))
         && $IsAlloc(s#0, 
          TSeq(GenericPick._default.EquivalentWaysOfSayingSequenceIsNonempty$U), 
  ...
  free requires 0 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id73"} !Seq#Equal(s#0, Seq#Empty(): Seq)
     || Seq#Length(s#0) != 0
     || (exists i#1: int :: LitInt(0) <= i#1 && i#1 < Seq#Length(s#0));
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id74"} (exists x#1: Box :: 
    { Seq#Contains(s#0, x#1) } 
    $IsBox(x#1, GenericPick._default.EquivalentWaysOfSayingSequenceIsNonempty$U)
       && Seq#Contains(s#0, x#1));
  // frame condition
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "GenericPick.EquivalentWaysOfSayingSequenceIsNonempty (correctness)"} Impl$$GenericPick.__default.EquivalentWaysOfSayingSequenceIsNonempty(GenericPick._default.EquivalentWaysOfSayingSequenceIsNonempty$U: Ty, s#0: Seq)
   returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;

    // AddMethodImpl: EquivalentWaysOfSayingSequenceIsNonempty, Impl$$GenericPick.__default.EquivalentWaysOfSayingSequenceIsNonempty
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/SmallTests.dfy(837,5)
    assert {:id "id75"} {:subsumption 0} 0 <= LitInt(0) && LitInt(0) < Seq#Length(s#0);
    assume true;
    assert {:id "id76"} Seq#Contains(s#0, Seq#Index(s#0, LitInt(0)));
}
    ...
    GenericPick.__default.MapPick0#canCall(GenericPick._default.MapPick0$U, GenericPick._default.MapPick0$V, m#0)
         || (0 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           && $Is(m#0, TMap(GenericPick._default.MapPick0$U, GenericPick._default.MapPick0$V))
           && !Map#Equal(m#0, Map#Empty(): Map))
       ==> $let#36$canCall(GenericPick._default.MapPick0$U, GenericPick._default.MapPick0$V, m#0)
         && GenericPick.__default.MapPick0(GenericPick._default.MapPick0$U, GenericPick._default.MapPick0$V, m#0)
           == (var x#0 := $let#36_x(GenericPick._default.MapPick0$U, GenericPick._default.MapPick0$V, m#0); 
            x#0));
    ...
    GenericPick.__default.MapPick0#canCall(GenericPick._default.MapPick0$U, GenericPick._default.MapPick0$V, Lit(m#0))
         || (0 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           && $Is(m#0, TMap(GenericPick._default.MapPick0$U, GenericPick._default.MapPick0$V))
           && !Map#Equal(m#0, Map#Empty(): Map))
       ==> $let#36$canCall(GenericPick._default.MapPick0$U, GenericPick._default.MapPick0$V, Lit(m#0))
         && GenericPick.__default.MapPick0(GenericPick._default.MapPick0$U, GenericPick._default.MapPick0$V, Lit(m#0))
           == (var x#1 := $let#36_x(GenericPick._default.MapPick0$U, GenericPick._default.MapPick0$V, Lit(m#0)); 
            x#1));
}
...
function $let#36_x(GenericPick._default.MapPick0$U: Ty, GenericPick._default.MapPick0$V: Ty, m: Map)
   : Box;

function $let#36$canCall(GenericPick._default.MapPick0$U: Ty, GenericPick._default.MapPick0$V: Ty, m: Map)
   : bool;

axiom (forall GenericPick._default.MapPick0$U: Ty, GenericPick._default.MapPick0$V: Ty, m: Map :: 
  { $let#36_x(GenericPick._default.MapPick0$U, GenericPick._default.MapPick0$V, m) } 
  $let#36$canCall(GenericPick._default.MapPick0$U, GenericPick._default.MapPick0$V, m)
     ==> Set#IsMember(Map#Domain(m), 
      $let#36_x(GenericPick._default.MapPick0$U, GenericPick._default.MapPick0$V, m)));

procedure {:verboseName "GenericPick.MapPick0 (well-formedness)"} CheckWellformed$$GenericPick.__default.MapPick0(GenericPick._default.MapPick0$U: Ty, 
    GenericPick._default.MapPick0$V: Ty, 
    m#0: Map
       where $Is(m#0, TMap(GenericPick._default.MapPick0$U, GenericPick._default.MapPick0$V)));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "GenericPick.MapPick0 (well-formedness)"} CheckWellformed$$GenericPick.__default.MapPick0(GenericPick._default.MapPick0$U: Ty, 
    GenericPick._default.MapPick0$V: Ty, 
    m#0: Map)
{
  var $_ReadsFrame: [ref,Field]bool;
  var x#2: Box;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    // Check well-formedness of preconditions, and then assume them
    assume {:id "id79"} !Map#Equal(m#0, Map#Empty(): Map);
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    {
        // Check well-formedness of postcondition and assume false
        assume $IsBox(GenericPick.__default.MapPick0(GenericPick._default.MapPick0$U, GenericPick._default.MapPick0$V, m#0), 
          GenericPick._default.MapPick0$U);
        assume false;
    }
    else
    {
        // Check well-formedness of body and result subset type constraint
        havoc x#2;
        if ($IsBox(x#2, GenericPick._default.MapPick0$U)
           && $IsAllocBox(x#2, GenericPick._default.MapPick0$U, $Heap))
        {
        }

        assert {:id "id80"} (exists x#3: Box :: 
          $IsBox(x#3, GenericPick._default.MapPick0$U)
             && Set#IsMember(Map#Domain(m#0), x#3));
        assume $IsBox(x#2, GenericPick._default.MapPick0$U)
           && $IsAllocBox(x#2, GenericPick._default.MapPick0$U, $Heap);
        assume Set#IsMember(Map#Domain(m#0), x#2);
        assume $let#36$canCall(GenericPick._default.MapPick0$U, GenericPick._default.MapPick0$V, m#0);
        assume {:id "id81"} GenericPick.__default.MapPick0(GenericPick._default.MapPick0$U, GenericPick._default.MapPick0$V, m#0)
           == x#2;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $IsBox(GenericPick.__default.MapPick0(GenericPick._default.MapPick0$U, GenericPick._default.MapPick0$V, m#0), 
    ...
    GenericPick.__default.MapPick1#canCall(GenericPick._default.MapPick1$U, GenericPick._default.MapPick1$V, m#0)
         || (0 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           && $Is(m#0, TMap(GenericPick._default.MapPick1$U, GenericPick._default.MapPick1$V))
           && Map#Card(m#0) != 0)
       ==> $let#39$canCall(GenericPick._default.MapPick1$U, GenericPick._default.MapPick1$V, m#0)
         && GenericPick.__default.MapPick1(GenericPick._default.MapPick1$U, GenericPick._default.MapPick1$V, m#0)
           == (var x#0 := $let#39_x(GenericPick._default.MapPick1$U, GenericPick._default.MapPick1$V, m#0); 
            x#0));
    ...
    GenericPick.__default.MapPick1#canCall(GenericPick._default.MapPick1$U, GenericPick._default.MapPick1$V, Lit(m#0))
         || (0 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           && $Is(m#0, TMap(GenericPick._default.MapPick1$U, GenericPick._default.MapPick1$V))
           && Map#Card(Lit(m#0)) != 0)
       ==> $let#39$canCall(GenericPick._default.MapPick1$U, GenericPick._default.MapPick1$V, Lit(m#0))
         && GenericPick.__default.MapPick1(GenericPick._default.MapPick1$U, GenericPick._default.MapPick1$V, Lit(m#0))
           == (var x#1 := $let#39_x(GenericPick._default.MapPick1$U, GenericPick._default.MapPick1$V, Lit(m#0)); 
            x#1));
}
...
function $let#39_x(GenericPick._default.MapPick1$U: Ty, GenericPick._default.MapPick1$V: Ty, m: Map)
   : Box;

function $let#39$canCall(GenericPick._default.MapPick1$U: Ty, GenericPick._default.MapPick1$V: Ty, m: Map)
   : bool;

axiom (forall GenericPick._default.MapPick1$U: Ty, GenericPick._default.MapPick1$V: Ty, m: Map :: 
  { $let#39_x(GenericPick._default.MapPick1$U, GenericPick._default.MapPick1$V, m) } 
  $let#39$canCall(GenericPick._default.MapPick1$U, GenericPick._default.MapPick1$V, m)
     ==> Set#IsMember(Map#Domain(m), 
      $let#39_x(GenericPick._default.MapPick1$U, GenericPick._default.MapPick1$V, m)));

procedure {:verboseName "GenericPick.MapPick1 (well-formedness)"} CheckWellformed$$GenericPick.__default.MapPick1(GenericPick._default.MapPick1$U: Ty, 
    GenericPick._default.MapPick1$V: Ty, 
    m#0: Map
       where $Is(m#0, TMap(GenericPick._default.MapPick1$U, GenericPick._default.MapPick1$V)));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "GenericPick.MapPick1 (well-formedness)"} CheckWellformed$$GenericPick.__default.MapPick1(GenericPick._default.MapPick1$U: Ty, 
    GenericPick._default.MapPick1$V: Ty, 
    m#0: Map)
{
  var $_ReadsFrame: [ref,Field]bool;
  var x#2: Box;
    ...
    {
        // Check well-formedness of postcondition and assume false
        assume $IsBox(GenericPick.__default.MapPick1(GenericPick._default.MapPick1$U, GenericPick._default.MapPick1$V, m#0), 
          GenericPick._default.MapPick1$U);
        assume false;
    }
    else
    {
        // Check well-formedness of body and result subset type constraint
        havoc x#2;
        if ($IsBox(x#2, GenericPick._default.MapPick1$U)
           && $IsAllocBox(x#2, GenericPick._default.MapPick1$U, $Heap))
        {
        }

        assert {:id "id85"} (exists x#3: Box :: 
          $IsBox(x#3, GenericPick._default.MapPick1$U)
             && Set#IsMember(Map#Domain(m#0), x#3));
        assume $IsBox(x#2, GenericPick._default.MapPick1$U)
           && $IsAllocBox(x#2, GenericPick._default.MapPick1$U, $Heap);
        assume Set#IsMember(Map#Domain(m#0), x#2);
        assume $let#39$canCall(GenericPick._default.MapPick1$U, GenericPick._default.MapPick1$V, m#0);
        assume {:id "id86"} GenericPick.__default.MapPick1(GenericPick._default.MapPick1$U, GenericPick._default.MapPick1$V, m#0)
           == x#2;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $IsBox(GenericPick.__default.MapPick1(GenericPick._default.MapPick1$U, GenericPick._default.MapPick1$V, m#0), 
         ...
         || (0 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           ...
           && (exists x#1: Box :: 
            ...
            $IsBox(x#1, GenericPick._default.MapPick2$U)
               && Set#IsMember(Map#Domain(m#0), x#1)))
       ==> $let#42$canCall(GenericPick._default.MapPick2$U, GenericPick._default.MapPick2$V, m#0)
         && GenericPick.__default.MapPick2(GenericPick._default.MapPick2$U, GenericPick._default.MapPick2$V, m#0)
           == (var x#2 := $let#42_x(GenericPick._default.MapPick2$U, GenericPick._default.MapPick2$V, m#0); 
            x#2));
    ...
    GenericPick.__default.MapPick2#canCall(GenericPick._default.MapPick2$U, GenericPick._default.MapPick2$V, Lit(m#0))
         || (0 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           ...
           && (exists x#3: Box :: 
            { Set#IsMember(Map#Domain(m#0), x#3) } 
            $IsBox(x#3, GenericPick._default.MapPick2$U)
               && Set#IsMember(Map#Domain(m#0), x#3)))
       ==> $let#42$canCall(GenericPick._default.MapPick2$U, GenericPick._default.MapPick2$V, Lit(m#0))
         && GenericPick.__default.MapPick2(GenericPick._default.MapPick2$U, GenericPick._default.MapPick2$V, Lit(m#0))
           == (var x#4 := $let#42_x(GenericPick._default.MapPick2$U, GenericPick._default.MapPick2$V, Lit(m#0)); 
            x#4));
}
...
function $let#42_x(GenericPick._default.MapPick2$U: Ty, GenericPick._default.MapPick2$V: Ty, m: Map)
   : Box;

function $let#42$canCall(GenericPick._default.MapPick2$U: Ty, GenericPick._default.MapPick2$V: Ty, m: Map)
   : bool;

axiom (forall GenericPick._default.MapPick2$U: Ty, GenericPick._default.MapPick2$V: Ty, m: Map :: 
  { $let#42_x(GenericPick._default.MapPick2$U, GenericPick._default.MapPick2$V, m) } 
  $let#42$canCall(GenericPick._default.MapPick2$U, GenericPick._default.MapPick2$V, m)
     ==> Set#IsMember(Map#Domain(m), 
      $let#42_x(GenericPick._default.MapPick2$U, GenericPick._default.MapPick2$V, m)));

procedure {:verboseName "GenericPick.MapPick2 (well-formedness)"} CheckWellformed$$GenericPick.__default.MapPick2(GenericPick._default.MapPick2$U: Ty, 
    GenericPick._default.MapPick2$V: Ty, 
    m#0: Map
       where $Is(m#0, TMap(GenericPick._default.MapPick2$U, GenericPick._default.MapPick2$V)));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "GenericPick.MapPick2 (well-formedness)"} CheckWellformed$$GenericPick.__default.MapPick2(GenericPick._default.MapPick2$U: Ty, 
    GenericPick._default.MapPick2$V: Ty, 
    m#0: Map)
{
  var $_ReadsFrame: [ref,Field]bool;
  ...
  var x#6: Box;
    ...
    // Check well-formedness of preconditions, and then assume them
    havoc x#5;
    assume $IsBox(x#5, GenericPick._default.MapPick2$U)
       && $IsAllocBox(x#5, GenericPick._default.MapPick2$U, $Heap);
    assume {:id "id89"} Set#IsMember(Map#Domain(m#0), x#5);
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    {
        // Check well-formedness of postcondition and assume false
        assume $IsBox(GenericPick.__default.MapPick2(GenericPick._default.MapPick2$U, GenericPick._default.MapPick2$V, m#0), 
          GenericPick._default.MapPick2$U);
        assume false;
    }
    else
    {
        // Check well-formedness of body and result subset type constraint
        havoc x#6;
        if ($IsBox(x#6, GenericPick._default.MapPick2$U)
           && $IsAllocBox(x#6, GenericPick._default.MapPick2$U, $Heap))
        {
        }

        assert {:id "id90"} (exists x#7: Box :: 
          $IsBox(x#7, GenericPick._default.MapPick2$U)
             && Set#IsMember(Map#Domain(m#0), x#7));
        assume $IsBox(x#6, GenericPick._default.MapPick2$U)
           && $IsAllocBox(x#6, GenericPick._default.MapPick2$U, $Heap);
        assume Set#IsMember(Map#Domain(m#0), x#6);
        assume $let#42$canCall(GenericPick._default.MapPick2$U, GenericPick._default.MapPick2$V, m#0);
        assume {:id "id91"} GenericPick.__default.MapPick2(GenericPick._default.MapPick2$U, GenericPick._default.MapPick2$V, m#0)
           == x#6;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $IsBox(GenericPick.__default.MapPick2(GenericPick._default.MapPick2$U, GenericPick._default.MapPick2$V, m#0), 
