...
(assert (distinct TInt TagInt TagSet alloc Tagclass._System.object? Tagclass._System.object Tagclass._System.array2? Tagclass._System.array2 Tagclass._System.___hFunc2 tytagFamily$object tytagFamily$array2 |tytagFamily$_#Func2|)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|$l#0#heap#0| T@U) (|$l#0#x#0| T@U) (|$l#0#y#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType boolType (|lambda#19| |l#0| |l#1|) |$l#0#heap#0| |$l#0#x#0| |$l#0#y#0|))  (and ($IsBox |$l#0#x#0| |l#0|) ($IsBox |$l#0#y#0| |l#1|)))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |667|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType boolType (|lambda#19| |l#0| |l#1|) |$l#0#heap#0| |$l#0#x#0| |$l#0#y#0|))
)))
...
(assert (forall ((|$l#0#heap#0@@0| T@U) (|$l#0#x#0@@0| T@U) (|$l#0#y#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType BoxType |lambda#18| |$l#0#heap#0@@0| |$l#0#x#0@@0| |$l#0#y#0@@0|) ($Box intType (int_2_U (+ (U_2_int ($Unbox intType |$l#0#x#0@@0|)) (U_2_int ($Unbox intType |$l#0#y#0@@0|))))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |666|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType BoxType |lambda#18| |$l#0#heap#0@@0| |$l#0#x#0@@0| |$l#0#y#0@@0|))
)))
...
(assert (forall ((_System.array2$arg@@4 T@U) ($h@@3 T@U) ($o@@3 T@U) ($i0 Int) ($i1 Int) ) (!  (=> (and (and (and ($IsGoodHeap $h@@3) (and (or (not (= $o@@3 null)) (not true)) (= (dtype $o@@3) (Tclass._System.array2? _System.array2$arg@@4)))) (and (and (<= 0 $i0) (< $i0 (_System.array2.Length0 $o@@3))) (and (<= 0 $i1) (< $i1 (_System.array2.Length1 $o@@3))))) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@3 $o@@3) alloc)))) ($IsAllocBox (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@3 $o@@3) (MultiIndexField (IndexField $i0) $i1)) _System.array2$arg@@4 $h@@3))
 :qid |unknown.0:0|
 :skolemid |485|
 :pattern ( (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@3 $o@@3) (MultiIndexField (IndexField $i0) $i1)) (Tclass._System.array2? _System.array2$arg@@4))
)))
...
(assert (forall ((_System.array2$arg@@8 T@U) ($h@@4 T@U) ($o@@5 T@U) ($i0@@0 Int) ($i1@@0 Int) ) (!  (=> (and (and ($IsGoodHeap $h@@4) (and (or (not (= $o@@5 null)) (not true)) (= (dtype $o@@5) (Tclass._System.array2? _System.array2$arg@@8)))) (and (and (<= 0 $i0@@0) (< $i0@@0 (_System.array2.Length0 $o@@5))) (and (<= 0 $i1@@0) (< $i1@@0 (_System.array2.Length1 $o@@5))))) ($IsBox (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@4 $o@@5) (MultiIndexField (IndexField $i0@@0) $i1@@0)) _System.array2$arg@@8))
 :qid |unknown.0:0|
 :skolemid |484|
 :pattern ( (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@4 $o@@5) (MultiIndexField (IndexField $i0@@0) $i1@@0)) (Tclass._System.array2? _System.array2$arg@@8))
)))
...
(assert (forall ((v@@3 T@U) (t0@@8 T@U) (h@@8 T@U) ) (! (= ($IsAlloc SetType v@@3 (TSet t0@@8) h@@8) (forall ((bx@@7 T@U) ) (!  (=> (|Set#IsMember| v@@3 bx@@7) ($IsAllocBox bx@@7 t0@@8 h@@8))
...
(assert (forall ((|l#0@@2| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#x#0@@1| T@U) (|$l#0#y#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType SetType (|lambda#21| |l#0@@2|) |$l#0#heap#0@@1| |$l#0#x#0@@1| |$l#0#y#0@@1|) |l#0@@2|)
 :qid |ArrayElementInitCompiledfy.47:22|
 :skolemid |668|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType SetType (|lambda#21| |l#0@@2|) |$l#0#heap#0@@1| |$l#0#x#0@@1| |$l#0#y#0@@1|))
)))
(assert (forall ((_System.array2$arg@@11 T@U) ($h@@5 T@U) ($o@@7 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@5) (and (or (not (= $o@@7 null)) (not true)) (= (dtype $o@@7) (Tclass._System.array2? _System.array2$arg@@11)))) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@5 $o@@7) alloc)))) ($IsAlloc intType (int_2_U (_System.array2.Length0 $o@@7)) TInt $h@@5))
 :qid |unknown.0:0|
 :skolemid |489|
 :pattern ( (_System.array2.Length0 $o@@7) ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@5 $o@@7) alloc)) (Tclass._System.array2? _System.array2$arg@@11))
)))
(assert (forall ((_System.array2$arg@@12 T@U) ($h@@6 T@U) ($o@@8 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@6) (and (or (not (= $o@@8 null)) (not true)) (= (dtype $o@@8) (Tclass._System.array2? _System.array2$arg@@12)))) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@6 $o@@8) alloc)))) ($IsAlloc intType (int_2_U (_System.array2.Length1 $o@@8)) TInt $h@@6))
 :qid |unknown.0:0|
 :skolemid |491|
 :pattern ( (_System.array2.Length1 $o@@8) ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@6 $o@@8) alloc)) (Tclass._System.array2? _System.array2$arg@@12))
)))
(assert (forall ((f@@6 T@U) (t0@@10 T@U) (t1@@8 T@U) (t2@@7 T@U) (u0@@3 T@U) (u1@@3 T@U) (u2@@2 T@U) ) (!  (=> (and (and (and ($Is HandleTypeType f@@6 (Tclass._System.___hFunc2 t0@@10 t1@@8 t2@@7)) (forall ((bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 u0@@3) ($IsBox bx@@8 t0@@10))
 :qid |unknown.0:0|
 :skolemid |521|
 :pattern ( ($IsBox bx@@8 u0@@3))
 :pattern ( ($IsBox bx@@8 t0@@10))
))) (forall ((bx@@9 T@U) ) (!  (=> ($IsBox bx@@9 u1@@3) ($IsBox bx@@9 t1@@8))
 :qid |unknown.0:0|
 :skolemid |522|
 :pattern ( ($IsBox bx@@9 u1@@3))
 :pattern ( ($IsBox bx@@9 t1@@8))
))) (forall ((bx@@10 T@U) ) (!  (=> ($IsBox bx@@10 t2@@7) ($IsBox bx@@10 u2@@2))
 :qid |unknown.0:0|
 :skolemid |523|
 :pattern ( ($IsBox bx@@10 t2@@7))
 :pattern ( ($IsBox bx@@10 u2@@2))
...
(assert (forall ((|l#0@@3| T@U) (|l#1@@0| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@9 T@U) ($f T@U) ) (! (= (U_2_bool (MapType2Select refType FieldType boolType (|lambda#0| |l#0@@3| |l#1@@0| |l#2| |l#3|) $o@@9 $f))  (=> (and (or (not (= $o@@9 |l#0@@3|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@0| $o@@9) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |660|
 :pattern ( (MapType2Select refType FieldType boolType (|lambda#0| |l#0@@3| |l#1@@0| |l#2| |l#3|) $o@@9 $f))
)))
...
(assert (forall ((_System.array2$arg@@13 T@U) (bx@@12 T@U) ) (!  (=> ($IsBox bx@@12 (Tclass._System.array2? _System.array2$arg@@13)) (and (= ($Box refType ($Unbox refType bx@@12)) bx@@12) ($Is refType ($Unbox refType bx@@12) (Tclass._System.array2? _System.array2$arg@@13))))
 :qid |unknown.0:0|
 :skolemid |481|
 :pattern ( ($IsBox bx@@12 (Tclass._System.array2? _System.array2$arg@@13)))
)))
(assert (forall ((_System.array2$arg@@14 T@U) (bx@@13 T@U) ) (!  (=> ($IsBox bx@@13 (Tclass._System.array2 _System.array2$arg@@14)) (and (= ($Box refType ($Unbox refType bx@@13)) bx@@13) ($Is refType ($Unbox refType bx@@13) (Tclass._System.array2 _System.array2$arg@@14))))
 :qid |unknown.0:0|
 :skolemid |494|
 :pattern ( ($IsBox bx@@13 (Tclass._System.array2 _System.array2$arg@@14)))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.NewMatrix)
...
(let ((anon5_Else_correct  (=> (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array2? TInt))) (=> (and (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc)))) (= (_System.array2.Length0 $nw@0) (LitInt 5))) (and (= (_System.array2.Length1 $nw@0) (LitInt 4)) (= (ControlFlow 0 2) (- 0 1)))) (forall ((|arrayinit#0#i0#0| Int) (|arrayinit#0#i1#0| Int) ) (!  (=> (and (and (<= 0 |arrayinit#0#i0#0|) (< |arrayinit#0#i0#0| (LitInt 5))) (and (<= 0 |arrayinit#0#i1#0|) (< |arrayinit#0#i1#0| (LitInt 4)))) (Requires2 TInt TInt TInt $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle2 |lambda#18| (|lambda#19| TInt TInt) (|lambda#21| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0|)) ($Box intType (int_2_U |arrayinit#0#i1#0|))))
 :qid |ArrayElementInitCompiledfy.47:8|
 :skolemid |589|
))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 6) (- 0 8)) (<= 0 (LitInt 5))) (=> (<= 0 (LitInt 5)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= 0 (LitInt 4))) (=> (<= 0 (LitInt 4)) (and (=> (= (ControlFlow 0 6) 5) anon5_Then_correct) (=> (= (ControlFlow 0 6) 2) anon5_Else_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |m#0| (Tclass._System.array2 TInt)) ($IsAlloc refType |m#0| (Tclass._System.array2 TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 9) 6))) anon0_correct))))
