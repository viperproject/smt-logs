...
(assert (forall ((s@@1 T@U) (v T@U) ) (! (= (|Seq#Length| (|Seq#Build| s@@1 v)) (+ 1 (|Seq#Length| s@@1)))
 :qid |DafnyPreludebpl.1144:15|
 :skolemid |224|
 :pattern ( (|Seq#Build| s@@1 v))
)))
...
(assert (forall ((a@@2 T@U) (b T@U) ) (! (= (|MultiSet#Card| (|MultiSet#Union| a@@2 b)) (+ (|MultiSet#Card| a@@2) (|MultiSet#Card| b)))
 :qid |DafnyPreludebpl.994:15|
 :skolemid |198|
 :pattern ( (|MultiSet#Card| (|MultiSet#Union| a@@2 b)))
)))
...
(assert (forall ((s@@3 T@U) (x@@7 T@U) ) (! (= (exists ((i@@0 Int) ) (!  (and (and (<= 0 i@@0) (< i@@0 (|Seq#Length| s@@3))) (= x@@7 (|Seq#Index| s@@3 i@@0)))
 :qid |DafnyPreludebpl.1108:11|
 :skolemid |219|
 :pattern ( (|Seq#Index| s@@3 i@@0))
)) (< 0 (|MultiSet#Multiplicity| (|MultiSet#FromSeq| s@@3) x@@7)))
 :qid |DafnyPreludebpl.1106:15|
 :skolemid |220|
 :pattern ( (|MultiSet#Multiplicity| (|MultiSet#FromSeq| s@@3) x@@7))
)))
...
(assert (forall ((a@@4 T@U) (b@@0 T@U) ) (!  (=> (|MultiSet#Equal| a@@4 b@@0) (= a@@4 b@@0))
 :qid |DafnyPreludebpl.1054:15|
 :skolemid |209|
 :pattern ( (|MultiSet#Equal| a@@4 b@@0))
)))
(assert (forall ((s@@4 T@U) (n@@0 Int) ) (!  (=> (and (<= 0 n@@0) (<= n@@0 (|Seq#Length| s@@4))) (= (|Seq#Length| (|Seq#Take| s@@4 n@@0)) n@@0))
 :qid |DafnyPreludebpl.1238:15|
 :skolemid |244|
 :pattern ( (|Seq#Length| (|Seq#Take| s@@4 n@@0)))
)))
(assert (forall ((a@@5 T@U) (b@@1 T@U) (c T@U) ) (!  (=> (or (not (= a@@5 c)) (not true)) (=> (and ($HeapSucc a@@5 b@@1) ($HeapSucc b@@1 c)) ($HeapSucc a@@5 c)))
 :qid |DafnyPreludebpl.606:15|
 :skolemid |117|
 :pattern ( ($HeapSucc a@@5 b@@1) ($HeapSucc b@@1 c))
)))
...
(assert (forall ((a@@6 T@U) (x@@8 T@U) ) (! (= (|MultiSet#Multiplicity| (|MultiSet#UnionOne| a@@6 x@@8) x@@8) (+ (|MultiSet#Multiplicity| a@@6 x@@8) 1))
 :qid |DafnyPreludebpl.968:15|
 :skolemid |193|
 :pattern ( (|MultiSet#UnionOne| a@@6 x@@8))
)))
...
(assert (forall ((s@@7 T@U) ) (!  (and (= (= (|MultiSet#Card| s@@7) 0) (= s@@7 |MultiSet#Empty|)) (=> (or (not (= (|MultiSet#Card| s@@7) 0)) (not true)) (exists ((x@@10 T@U) ) (! (< 0 (|MultiSet#Multiplicity| s@@7 x@@10))
 :qid |DafnyPreludebpl.946:20|
 :skolemid |188|
 :pattern ( (|MultiSet#Multiplicity| s@@7 x@@10))
))))
 :qid |DafnyPreludebpl.942:15|
 :skolemid |189|
 :pattern ( (|MultiSet#Card| s@@7))
)))
(assert (forall ((a@@7 T@U) (b@@2 T@U) (o@@2 T@U) ) (! (= (|MultiSet#Multiplicity| (|MultiSet#Union| a@@7 b@@2) o@@2) (+ (|MultiSet#Multiplicity| a@@7 o@@2) (|MultiSet#Multiplicity| b@@2 o@@2)))
 :qid |DafnyPreludebpl.989:15|
 :skolemid |197|
 :pattern ( (|MultiSet#Multiplicity| (|MultiSet#Union| a@@7 b@@2) o@@2))
)))
(assert (forall ((h0 T@U) (h1 T@U) (a@@8 T@U) ) (!  (=> (and (and (and ($IsGoodHeap h0) ($IsGoodHeap h1)) ($HeapSucc h0 h1)) (= (MapType0Select refType (MapType0Type FieldType BoxType) h0 a@@8) (MapType0Select refType (MapType0Type FieldType BoxType) h1 a@@8))) (= (|Seq#FromArray| h0 a@@8) (|Seq#FromArray| h1 a@@8)))
 :qid |DafnyPreludebpl.1338:15|
 :skolemid |264|
 :pattern ( (|Seq#FromArray| h1 a@@8) ($HeapSucc h0 h1))
)))
(assert (forall ((h@@5 T@U) (a@@9 T@U) ) (! (= (|Seq#Length| (|Seq#FromArray| h@@5 a@@9)) (_System.array.Length a@@9))
 :qid |DafnyPreludebpl.1323:15|
 :skolemid |261|
 :pattern ( (|Seq#Length| (|Seq#FromArray| h@@5 a@@9)))
)))
...
(assert (forall ((s@@9 T@U) ) (! (= (|MultiSet#Card| (|MultiSet#FromSeq| s@@9)) (|Seq#Length| s@@9))
 :qid |DafnyPreludebpl.1085:15|
 :skolemid |215|
 :pattern ( (|MultiSet#Card| (|MultiSet#FromSeq| s@@9)))
)))
...
(assert (forall ((s@@10 T@U) (v@@4 T@U) ) (! (= (|MultiSet#FromSeq| (|Seq#Build| s@@10 v@@4)) (|MultiSet#UnionOne| (|MultiSet#FromSeq| s@@10) v@@4))
 :qid |DafnyPreludebpl.1089:15|
 :skolemid |216|
 :pattern ( (|MultiSet#FromSeq| (|Seq#Build| s@@10 v@@4)))
)))
...
(assert (forall ((s@@12 T@U) (n@@1 Int) ) (!  (=> (= n@@1 0) (= (|Seq#Take| s@@12 n@@1) |Seq#Empty|))
 :qid |DafnyPreludebpl.1295:15|
 :skolemid |256|
 :pattern ( (|Seq#Take| s@@12 n@@1))
)))
...
(assert (forall ((a@@12 T@U) (b@@3 T@U) ) (! (= (|MultiSet#Equal| a@@12 b@@3) (forall ((o@@4 T@U) ) (! (= (|MultiSet#Multiplicity| a@@12 o@@4) (|MultiSet#Multiplicity| b@@3 o@@4))
 :qid |DafnyPreludebpl.1050:19|
 :skolemid |207|
 :pattern ( (|MultiSet#Multiplicity| a@@12 o@@4))
 :pattern ( (|MultiSet#Multiplicity| b@@3 o@@4))
)))
 :qid |DafnyPreludebpl.1047:15|
 :skolemid |208|
 :pattern ( (|MultiSet#Equal| a@@12 b@@3))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.test6)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon3_correct  (=> (and (<= (LitInt 0) |n#0|) (< |n#0| (_System.array.Length |a#0|))) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6)) (= $o@@6 |a#0|)))
 :qid |MultiSetsdfy.51:8|
 :skolemid |511|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6))
)) ($HeapSucc $Heap $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= 0 (+ |n#0| 1)) (<= (+ |n#0| 1) (_System.array.Length |a#0|)))) (=> (and (<= 0 (+ |n#0| 1)) (<= (+ |n#0| 1) (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) (and (<= 0 |n#0|) (<= |n#0| (_System.array.Length |a#0|))))))))))))))
(let ((anon4_Else_correct  (=> (and (< |n#0| (LitInt 0)) (= (ControlFlow 0 8) 2)) anon3_correct)))
(let ((anon4_Then_correct  (=> (<= (LitInt 0) |n#0|) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (= (ControlFlow 0 6) 2) anon3_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#6| null $Heap alloc |a#0|)) (and (=> (= (ControlFlow 0 9) 6) anon4_Then_correct) (=> (= (ControlFlow 0 9) 8) anon4_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct))))
