...
(set-info :boogie-vc-id Impl$$_module.__default.test__fib3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon6_correct  (=> (and (=> (<= |y#0@0| |k#0|) (=> (< |k#0| (+ |y#0@0| |m#0|)) (=> (= |m#0| (LitInt 1)) (|_module.__default.fib#canCall| |k#0|)))) (= (ControlFlow 0 2) (- 0 1))) (=> (and (and (<= |y#0@0| |k#0|) (< |k#0| (+ |y#0@0| |m#0|))) (= |m#0| (LitInt 1))) (= (_module.__default.fib ($LS ($LS $LZ)) |k#0|) (LitInt 144))))))
(let ((anon9_Else_correct  (=> (and (not (and (and (<= |y#0@0| |k#0|) (< |k#0| (+ |y#0@0| |m#0|))) (= |m#0| (LitInt 1)))) (= (ControlFlow 0 4) 2)) anon6_correct)))
(let ((anon9_Then_correct  (=> (and (and (and (and (<= |y#0@0| |k#0|) (< |k#0| (+ |y#0@0| |m#0|))) (= |m#0| (LitInt 1))) ($IsAlloc intType (int_2_U |k#0|) Tclass._System.nat $Heap)) (and (|_module.__default.fib#canCall| |k#0|) (= (ControlFlow 0 3) 2))) anon6_correct)))
(let ((anon8_Else_correct  (=> (not (and (<= |y#0@0| |k#0|) (< |k#0| (+ |y#0@0| |m#0|)))) (and (=> (= (ControlFlow 0 6) 3) anon9_Then_correct) (=> (= (ControlFlow 0 6) 4) anon9_Else_correct)))))
(let ((anon8_Then_correct  (=> (and (<= |y#0@0| |k#0|) (< |k#0| (+ |y#0@0| |m#0|))) (and (=> (= (ControlFlow 0 5) 3) anon9_Then_correct) (=> (= (ControlFlow 0 5) 4) anon9_Else_correct)))))
(let ((anon7_Else_correct  (=> (< |k#0| |y#0@0|) (and (=> (= (ControlFlow 0 8) 5) anon8_Then_correct) (=> (= (ControlFlow 0 8) 6) anon8_Else_correct)))))
(let ((anon7_Then_correct  (=> (<= |y#0@0| |k#0|) (and (=> (= (ControlFlow 0 7) 5) anon8_Then_correct) (=> (= (ControlFlow 0 7) 6) anon8_Else_correct)))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |y#0@0| (LitInt 12))) (and (=> (= (ControlFlow 0 9) 7) anon7_Then_correct) (=> (= (ControlFlow 0 9) 8) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (<= (LitInt 0) |k#0|) (<= (LitInt 0) |m#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct))))
