...
(let ((anon8_correct  (=> (= |s##0_0@1| (U_2_bool (Lit boolType (bool_2_U true)))) (and (=> (= (ControlFlow 0 16) (- 0 28)) (forall (($o@@6 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@6) alloc)))) (or (= $o@@6 this) (|Set#IsMember| |lotsaObjects#0| ($Box refType $o@@6)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@6 $f@@0)))
 :qid |Simpledfy.26:19|
 :skolemid |1632|
))) (=> (forall (($o@@7 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@7) alloc)))) (or (= $o@@7 this) (|Set#IsMember| |lotsaObjects#0| ($Box refType $o@@7)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@7 $f@@1)))
 :qid |Simpledfy.26:19|
 :skolemid |1632|
)) (and (=> (= (ControlFlow 0 16) (- 0 27)) (or (and (not |s##0_0@1|) |s#0|) (and (= |s##0_0@1| |s#0|) (and (|Set#Subset| |lotsaObjects#0| |lotsaObjects#0|) (not (|Set#Subset| |lotsaObjects#0| |lotsaObjects#0|)))))) (=> (or (and (not |s##0_0@1|) |s#0|) (and (= |s##0_0@1| |s#0|) (and (|Set#Subset| |lotsaObjects#0| |lotsaObjects#0|) (not (|Set#Subset| |lotsaObjects#0| |lotsaObjects#0|))))) (=> (and ($Is refType |call6formal@t#0| Tclass._System.object) ($IsAlloc refType |call6formal@t#0| Tclass._System.object $Heap)) (=> (and (and ($Is SetType |call7formal@u#0| (TSet TInt)) ($IsAlloc SetType |call7formal@u#0| (TSet TInt) $Heap)) (and ($Is SeqType |call8formal@v#0| (TSeq (Tclass._module.MyClass? TBool call1formal@_module.MyClass$U))) ($IsAlloc SeqType |call8formal@v#0| (TSeq (Tclass._module.MyClass? TBool call1formal@_module.MyClass$U)) $Heap))) (and (=> (= (ControlFlow 0 16) (- 0 26)) |s##0_0@1|) (=> |s##0_0@1| (=> (and ($IsGoodHeap $Heap@6) ($IsHeapAnchor $Heap@6)) (=> (and (and ($Is refType |call6formal@t#0@0| Tclass._System.object) ($IsAlloc refType |call6formal@t#0@0| Tclass._System.object $Heap@6)) (and ($Is SetType |call7formal@u#0@0| (TSet TInt)) ($IsAlloc SetType |call7formal@u#0@0| (TSet TInt) $Heap@6))) (=> (and (and (and ($Is SeqType |call8formal@v#0@0@@0| (TSeq (Tclass._module.MyClass? TBool _module.MyClass$U@@13))) ($IsAlloc SeqType |call8formal@v#0@0@@0| (TSeq (Tclass._module.MyClass? TBool _module.MyClass$U@@13)) $Heap@6)) (and (= |call6formal@t#0@0| |call6formal@t#0@0|) (or (not (= null this)) (not true)))) (and (and (forall (($o@@8 T@U) ) (!  (=> (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@8) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@8) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@8)) (or (= $o@@8 this) (|Set#IsMember| |lotsaObjects#0| ($Box refType $o@@8)))))
 :qid |Simpledfy.10:10|
 :skolemid |1628|
 ...
 :qid |Simpledfy.28:24|
 :skolemid |1633|
))) (=> (forall (($o@@10 T@U) ($f@@3 T@U) ) (!  (=> (and (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@10) alloc)))) (or (= $o@@10 this) (|Set#IsMember| |lotsaObjects#0| ($Box refType $o@@10)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@10 $f@@3)))
 :qid |Simpledfy.28:24|
 :skolemid |1633|
)) (and (=> (= (ControlFlow 0 16) (- 0 24)) (or (and (not |s##0_1@1|) |s#0|) (and (= |s##0_1@1| |s#0|) (and (|Set#Subset| |lotsaObjects#0| |lotsaObjects#0|) (not (|Set#Subset| |lotsaObjects#0| |lotsaObjects#0|)))))) (=> (or (and (not |s##0_1@1|) |s#0|) (and (= |s##0_1@1| |s#0|) (and (|Set#Subset| |lotsaObjects#0| |lotsaObjects#0|) (not (|Set#Subset| |lotsaObjects#0| |lotsaObjects#0|))))) (=> (and ($Is refType |call6formal@t#0@@0| Tclass._System.object) ($IsAlloc refType |call6formal@t#0@@0| Tclass._System.object $Heap)) (=> (and (and ($Is SetType |call7formal@u#0@@0| (TSet TInt)) ($IsAlloc SetType |call7formal@u#0@@0| (TSet TInt) $Heap)) (and ($Is SeqType |call8formal@v#0@@0| (TSeq (Tclass._module.MyClass? TBool call1formal@_module.MyClass$U@@0))) ($IsAlloc SeqType |call8formal@v#0@@0| (TSeq (Tclass._module.MyClass? TBool call1formal@_module.MyClass$U@@0)) $Heap))) (and (=> (= (ControlFlow 0 16) (- 0 23)) |s##0_1@1|) (=> |s##0_1@1| (=> (and (and ($IsGoodHeap $Heap@7) ($IsHeapAnchor $Heap@7)) (and ($Is refType |call6formal@t#0@0@@0| Tclass._System.object) ($IsAlloc refType |call6formal@t#0@0@@0| Tclass._System.object $Heap@7))) (=> (and (and (and ($Is SetType |call7formal@u#0@0@@0| (TSet TInt)) ($IsAlloc SetType |call7formal@u#0@0@@0| (TSet TInt) $Heap@7)) (and ($Is SeqType |call8formal@v#0@0@@1| (TSeq (Tclass._module.MyClass? TBool _module.MyClass$U@@13))) ($IsAlloc SeqType |call8formal@v#0@0@@1| (TSeq (Tclass._module.MyClass? TBool _module.MyClass$U@@13)) $Heap@7))) (and (and (= |call6formal@t#0@0@@0| |call6formal@t#0@0@@0|) (or (not (= null this)) (not true))) (and (forall (($o@@11 T@U) ) (!  (=> (and (or (not (= $o@@11 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@11) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@11) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@11)) (or (= $o@@11 this) (|Set#IsMember| |lotsaObjects#0| ($Box refType $o@@11)))))
 :qid |Simpledfy.10:10|
 :skolemid |1628|
