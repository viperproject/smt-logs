...
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@0 Tclass._module.TrickySubstitution $Heap)) (=> ($IsAlloc refType this@@0 Tclass._module.TrickySubstitution $Heap) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (and ($Is intType (int_2_U (+ |f#Z#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) _module.TrickySubstitution.w))))) TInt) (= (+ |f#Z#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) _module.TrickySubstitution.w)))) (+ |f#Z#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) _module.TrickySubstitution.w)))))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (= (+ |f#Z#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) _module.TrickySubstitution.w)))) (LitInt 0))) (exists ((|g#1| Int) ) (= (+ |f#Z#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) _module.TrickySubstitution.w)))) |g#1|))))) (=> (or (and ($Is intType (int_2_U (+ |f#Z#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) _module.TrickySubstitution.w))))) TInt) (= (+ |f#Z#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) _module.TrickySubstitution.w)))) (+ |f#Z#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) _module.TrickySubstitution.w)))))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (= (+ |f#Z#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) _module.TrickySubstitution.w)))) (LitInt 0))) (exists ((|g#1@@0| Int) ) (= (+ |f#Z#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) _module.TrickySubstitution.w)))) |g#1@@0|)))) (=> (and (and (= (+ |f#Z#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) _module.TrickySubstitution.w)))) |g#0@0|) (|$let#40$canCall| $Heap this@@0 |f#Z#0@0|)) (and (let ((|f#0| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@0) _module.TrickySubstitution.v))) |x#0|)))
