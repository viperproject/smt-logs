...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@0 T@U) (this@@0 T@U) ) (!  (=> (or (|_module.Tree.Elements#canCall| this@@0) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType this@@0 Tclass._module.Tree))) (and (=> (not (_module.Tree.Empty_q this@@0)) (let ((|right#1| (_module.Tree.right this@@0)))
(let ((|left#1| (_module.Tree.left this@@0)))
 (and (|_module.Tree.Elements#canCall| |left#1|) (|_module.Tree.Elements#canCall| |right#1|))))) (= (_module.Tree.Elements ($LS $ly@@0) this@@0) (ite (_module.Tree.Empty_q this@@0) |Set#Empty| (let ((|right#0| (_module.Tree.right this@@0)))
(let ((|left#0| (_module.Tree.left this@@0)))
(|Set#Union| (_module.Tree.Elements $ly@@0 |left#0|) (_module.Tree.Elements $ly@@0 |right#0|))))))))
 :qid |LitTriggersdfy.41:18|
 :skolemid |576|
 :pattern ( (_module.Tree.Elements ($LS $ly@@0) this@@0))
))))
...
(assert (forall ((d@@3 T@U) ) (!  (=> (|$IsA#_module.Tree| d@@3) (or (_module.Tree.Empty_q d@@3) (_module.Tree.Node_q d@@3)))
 :qid |unknown.0:0|
 :skolemid |567|
 :pattern ( (|$IsA#_module.Tree| d@@3))
)))
(assert (forall ((d@@4 T@U) ) (!  (=> ($Is DatatypeTypeType d@@4 Tclass._module.Tree) (or (_module.Tree.Empty_q d@@4) (_module.Tree.Node_q d@@4)))
 :qid |unknown.0:0|
 :skolemid |568|
 :pattern ( (_module.Tree.Node_q d@@4) ($Is DatatypeTypeType d@@4 Tclass._module.Tree))
 :pattern ( (_module.Tree.Empty_q d@@4) ($Is DatatypeTypeType d@@4 Tclass._module.Tree))
)))
...
(assert (forall ((|a#8#0#0| T@U) (|a#8#1#0| T@U) ) (! (= (_module.Tree.left (|#_module.Tree.Node| |a#8#0#0| |a#8#1#0|)) |a#8#0#0|)
 :qid |LitTriggersdfy.39:30|
 :skolemid |562|
 :pattern ( (|#_module.Tree.Node| |a#8#0#0| |a#8#1#0|))
)))
(assert (forall ((|a#10#0#0| T@U) (|a#10#1#0| T@U) ) (! (= (_module.Tree.right (|#_module.Tree.Node| |a#10#0#0| |a#10#1#0|)) |a#10#1#0|)
 :qid |LitTriggersdfy.39:30|
 :skolemid |564|
...
(assert (forall (($ly@@1 T@U) (this@@1 T@U) ) (! (= (_module.Tree.Elements ($LS $ly@@1) this@@1) (_module.Tree.Elements $ly@@1 this@@1))
 :qid |LitTriggersdfy.41:18|
 :skolemid |572|
...
(assert (forall ((d@@5 T@U) ($h T@U) ) (!  (=> (and ($IsGoodHeap $h) ($Is DatatypeTypeType d@@5 Tclass._module.Tree)) ($IsAlloc DatatypeTypeType d@@5 Tclass._module.Tree $h))
 :qid |unknown.0:0|
 :skolemid |566|
 :pattern ( ($IsAlloc DatatypeTypeType d@@5 Tclass._module.Tree $h))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) (this@@2 T@U) ) (!  (=> (or (|_module.Tree.Elements#canCall| (Lit DatatypeTypeType this@@2)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType this@@2 Tclass._module.Tree))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Tree.Empty_q (Lit DatatypeTypeType this@@2)))))) (let ((|right#3| (Lit DatatypeTypeType (_module.Tree.right (Lit DatatypeTypeType this@@2)))))
(let ((|left#3| (Lit DatatypeTypeType (_module.Tree.left (Lit DatatypeTypeType this@@2)))))
 (and (|_module.Tree.Elements#canCall| |left#3|) (|_module.Tree.Elements#canCall| |right#3|))))) (= (_module.Tree.Elements ($LS $ly@@2) (Lit DatatypeTypeType this@@2)) (ite (_module.Tree.Empty_q (Lit DatatypeTypeType this@@2)) |Set#Empty| (let ((|right#2| (Lit DatatypeTypeType (_module.Tree.right (Lit DatatypeTypeType this@@2)))))
(let ((|left#2| (Lit DatatypeTypeType (_module.Tree.left (Lit DatatypeTypeType this@@2)))))
(|Set#Union| (_module.Tree.Elements ($LS $ly@@2) |left#2|) (_module.Tree.Elements ($LS $ly@@2) |right#2|))))))))
 :qid |LitTriggersdfy.41:18|
 :weight 3
 :skolemid |577|
 :pattern ( (_module.Tree.Elements ($LS $ly@@2) (Lit DatatypeTypeType this@@2)))
))))
...
(assert (forall ((d@@6 T@U) ($h@@0 T@U) ) (!  (=> (and ($IsGoodHeap $h@@0) (and (_module.Tree.Node_q d@@6) ($IsAlloc DatatypeTypeType d@@6 Tclass._module.Tree $h@@0))) ($IsAlloc DatatypeTypeType (_module.Tree.left d@@6) Tclass._module.Tree $h@@0))
 :qid |unknown.0:0|
 :skolemid |559|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Tree.left d@@6) Tclass._module.Tree $h@@0))
)))
(assert (forall ((d@@7 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.Tree.Node_q d@@7) ($IsAlloc DatatypeTypeType d@@7 Tclass._module.Tree $h@@1))) ($IsAlloc DatatypeTypeType (_module.Tree.right d@@7) Tclass._module.Tree $h@@1))
 :qid |unknown.0:0|
 :skolemid |560|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Tree.right d@@7) Tclass._module.Tree $h@@1))
)))
...
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.TimesOut)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon2_correct  (=> (and (and (=> (_module.Tree.Node_q |t#0|) (and (|_module.__default.Sum#canCall| |t#0|) (|_module.__default.IsEven#canCall| (_module.__default.Sum |t#0|)))) (= (ControlFlow 0 2) (- 0 1))) (_module.Tree.Node_q |t#0|)) (_module.__default.IsEven (_module.__default.Sum |t#0|)))))
(let ((anon3_Else_correct  (=> (and (not (_module.Tree.Node_q |t#0|)) (= (ControlFlow 0 4) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (_module.Tree.Node_q |t#0|) (=> (and ($IsAlloc DatatypeTypeType |t#0| Tclass._module.Tree $Heap) (|_module.__default.Sum#canCall| |t#0|)) (=> (and (and (= |##x#1@0| (_module.__default.Sum |t#0|)) ($IsAlloc intType (int_2_U |##x#1@0|) TInt $Heap)) (and (|_module.__default.IsEven#canCall| (_module.__default.Sum |t#0|)) (= (ControlFlow 0 3) 2))) anon2_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |t#0| Tclass._module.Tree) ($IsAlloc DatatypeTypeType |t#0| Tclass._module.Tree $Heap)) (|$IsA#_module.Tree| |t#0|)) (= 2 $FunctionContextHeight)) (and (forall ((|u#1| Int) ) (!  (=> (|Set#IsMember| (_module.Tree.Elements ($LS $LZ) |t#0|) ($Box intType (int_2_U |u#1|))) (_module.__default.IsEven |u#1|))
 :qid |LitTriggersdfy.54:19|
 :skolemid |551|
 :pattern ( (_module.__default.IsEven |u#1|))
 :pattern ( (|Set#IsMember| (_module.Tree.Elements ($LS $LZ) |t#0|) ($Box intType (int_2_U |u#1|))))
