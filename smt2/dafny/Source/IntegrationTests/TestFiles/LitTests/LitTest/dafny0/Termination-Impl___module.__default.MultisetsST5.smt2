...
(let ((anon11_correct  (and (=> (= (ControlFlow 0 16) (- 0 19)) (exists ((|$as#z0_0#0_0| T@U) )  (and ($IsBox |$as#z0_0#0_0| _module._default.MultisetsST5$Y) (> (|MultiSet#Multiplicity| |P#0| |$as#z0_0#0_0|) 0)))) (=> (exists ((|$as#z0_0#0_0@@0| T@U) )  (and ($IsBox |$as#z0_0#0_0@@0| _module._default.MultisetsST5$Y) (> (|MultiSet#Multiplicity| |P#0| |$as#z0_0#0_0@@0|) 0))) (=> (and (=> true (and ($IsBox |z#0_0@1| _module._default.MultisetsST5$Y) ($IsAllocBox |z#0_0@1| _module._default.MultisetsST5$Y $Heap))) (> (|MultiSet#Multiplicity| |P#0| |z#0_0@1|) 0)) (and (=> (= (ControlFlow 0 16) (- 0 18)) true) (=> (= |$rhs#0_0@1| (|MultiSet#Union| |s#0@0| (|MultiSet#UnionOne| |MultiSet#Empty| |z#0_0@1|))) (and (=> (= (ControlFlow 0 16) (- 0 17)) true) (=> (= |$rhs#0_1@1| (|MultiSet#Union| |t#0@1| (|MultiSet#UnionOne| |MultiSet#Empty| |z#0_0@1|))) (and (=> (= (ControlFlow 0 16) 15) anon22_Then_correct) (=> (= (ControlFlow 0 16) 11) anon22_Else_correct)))))))))))
