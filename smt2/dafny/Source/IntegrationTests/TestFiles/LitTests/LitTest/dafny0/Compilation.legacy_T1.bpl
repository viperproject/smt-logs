...
procedure {:verboseName "T1.do (well-formedness)"} CheckWellFormed$$T1.__default.do();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "T1.do (call)"} Call$$T1.__default.do();
  modifies $Heap;
...
procedure {:verboseName "T1.do (correctness)"} Impl$$T1.__default.do() returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
