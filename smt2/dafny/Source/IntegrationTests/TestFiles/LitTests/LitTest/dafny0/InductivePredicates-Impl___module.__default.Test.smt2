...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 7)) ($Is intType (int_2_U (LitInt 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 1)) Tclass._System.nat) (=> (and (and (= |##x#0@0| (Lit DatatypeTypeType (|#_module.natinf.N| (LitInt 1)))) ($IsAlloc DatatypeTypeType |##x#0@0| Tclass._module.natinf $Heap)) (and (|_module.__default.Even#canCall| (Lit DatatypeTypeType (|#_module.natinf.N| (LitInt 1)))) (|_module.__default.Even#canCall| (Lit DatatypeTypeType (|#_module.natinf.N| (LitInt 1)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (not (U_2_bool (Lit boolType (bool_2_U (_module.__default.Even ($LS ($LS $LZ)) (Lit DatatypeTypeType (|#_module.natinf.N| (LitInt 1))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.__default.Even ($LS $LZ) (Lit DatatypeTypeType (|#_module.natinf.N| (LitInt 1)))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) ($Is intType (int_2_U (LitInt 5)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 5)) Tclass._System.nat) (=> (and (and (= |##x#1@0| (Lit DatatypeTypeType (|#_module.natinf.N| (LitInt 5)))) ($IsAlloc DatatypeTypeType |##x#1@0| Tclass._module.natinf $Heap)) (and (|_module.__default.Even#canCall| (Lit DatatypeTypeType (|#_module.natinf.N| (LitInt 5)))) (|_module.__default.Even#canCall| (Lit DatatypeTypeType (|#_module.natinf.N| (LitInt 5)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (not (U_2_bool (Lit boolType (bool_2_U (_module.__default.Even ($LS ($LS $LZ)) (Lit DatatypeTypeType (|#_module.natinf.N| (LitInt 5))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.__default.Even ($LS $LZ) (Lit DatatypeTypeType (|#_module.natinf.N| (LitInt 5)))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($Is intType (int_2_U (LitInt 17)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 17)) Tclass._System.nat) (=> (= |##x#2@0| (Lit DatatypeTypeType (|#_module.natinf.N| (LitInt 17)))) (=> (and (and ($IsAlloc DatatypeTypeType |##x#2@0| Tclass._module.natinf $Heap) (|_module.__default.Even#canCall| (Lit DatatypeTypeType (|#_module.natinf.N| (LitInt 17))))) (and (|_module.__default.Even#canCall| (Lit DatatypeTypeType (|#_module.natinf.N| (LitInt 17)))) (= (ControlFlow 0 2) (- 0 1)))) (not (U_2_bool (Lit boolType (bool_2_U (_module.__default.Even ($LS ($LS $LZ)) (Lit DatatypeTypeType (|#_module.natinf.N| (LitInt 17)))))))))))))))))))))))))
