...
(set-info :boogie-vc-id Impl$$Ghost.__default.M3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_Else_correct  (=> (and (and (not (U_2_bool (Lit boolType (bool_2_U true)))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (= (ControlFlow 0 6) (- 0 5))) false)))
(let ((anon5_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (or (Types.XY.G1_q |xy#0|) (Types.XY.D1_q |xy#0|)))))
(let ((anon4_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (Types.XY.D0_q |xy#0|))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 7) 2) anon4_Then_correct) (=> (= (ControlFlow 0 7) 4) anon5_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |xy#0| Tclass.Types.XY) ($IsAlloc DatatypeTypeType |xy#0| Tclass.Types.XY $Heap)) (|$IsA#Types.XY| |xy#0|)) (= 0 $FunctionContextHeight)) (and (Types.XY.D1_q |xy#0|) (= (ControlFlow 0 8) 7))) anon0_correct))))
