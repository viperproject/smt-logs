...
(declare-fun |t#0| () T@U)
(declare-fun _module._default.TwoMethod$T () T@U)
(declare-fun |defass#a#0| () Bool)
(declare-fun |a#0| () T@U)
(declare-fun |defass#b#0| () Bool)
(declare-fun |b#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.TwoMethod)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($IsBox |t#0| _module._default.TwoMethod$T) ($IsAllocBox |t#0| _module._default.TwoMethod$T $Heap))) (and (and (=> |defass#a#0| (and ($IsBox |a#0| _module._default.TwoMethod$T) ($IsAllocBox |a#0| _module._default.TwoMethod$T $Heap))) (=> |defass#b#0| (and ($IsBox |b#0| _module._default.TwoMethod$T) ($IsAllocBox |b#0| _module._default.TwoMethod$T $Heap)))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct)))
