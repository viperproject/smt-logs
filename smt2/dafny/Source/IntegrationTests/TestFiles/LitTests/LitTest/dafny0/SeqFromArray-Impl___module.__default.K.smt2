...
(assert (forall ((v@@3 T@U) (t0@@0 T@U) (h@@2 T@U) ) (! (= ($IsAlloc SeqType v@@3 (TSeq t0@@0) h@@2) (forall ((i@@1 Int) ) (!  (=> (and (<= 0 i@@1) (< i@@1 (|Seq#Length| v@@3))) ($IsAllocBox (|Seq#Index| v@@3 i@@1) t0@@0 h@@2))
 ...
 :skolemid |74|
 :pattern ( ($IsAlloc SeqType v@@3 (TSeq t0@@0) h@@2))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 33) (let ((anon6_correct  (=> (= (ControlFlow 0 19) (- 0 18)) (forall ((|i#2_1| Int) ) (!  (=> (and (<= (LitInt 0) |i#2_1|) (< |i#2_1| |n#0|)) (= (U_2_int ($Unbox intType (|Seq#Index| |A#0@0| |i#2_1|))) (U_2_int ($Unbox intType (|Seq#Index| |C#0@0| |i#2_1|)))))
 :qid |SeqFromArraydfy.35:21|
 :skolemid |501|
 :pattern ( ($Unbox intType (|Seq#Index| |C#0@0| |i#2_1|)))
 :pattern ( ($Unbox intType (|Seq#Index| |A#0@0| |i#2_1|)))
)))))
(let ((anon18_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#2_0@0|) (< |i#2_0@0| |n#0|))) (= (ControlFlow 0 23) 19)) anon6_correct)))
(let ((anon18_Then_correct  (=> (and (<= (LitInt 0) |i#2_0@0|) (< |i#2_0@0| |n#0|)) (and (=> (= (ControlFlow 0 20) (- 0 22)) (and (<= 0 |i#2_0@0|) (< |i#2_0@0| (|Seq#Length| |A#0@0|)))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (and (<= 0 |i#2_0@0|) (< |i#2_0@0| (|Seq#Length| |C#0@0|)))) (=> (= (ControlFlow 0 20) 19) anon6_correct))))))
...
(let ((anon12_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (forall ((|i#1_1| Int) ) (!  (=> (and (<= (LitInt 0) |i#1_1|) (< |i#1_1| |n#0|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#1_1|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0@@1|) (IndexField |i#1_1|))))))
 :qid |SeqFromArraydfy.37:21|
 :skolemid |499|
...
(let ((anon22_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#1_0@0|) (< |i#1_0@0| |n#0|))) (= (ControlFlow 0 12) 6)) anon12_correct)))
(let ((anon22_Then_correct  (=> (and (<= (LitInt 0) |i#1_0@0|) (< |i#1_0@0| |n#0|)) (and (=> (= (ControlFlow 0 7) (- 0 11)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 7) (- 0 10)) (and (<= 0 |i#1_0@0|) (< |i#1_0@0| (_System.array.Length |a#0|)))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (or (not (= |c#0@@1| null)) (not true))) (=> (or (not (= |c#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (and (<= 0 |i#1_0@0|) (< |i#1_0@0| (_System.array.Length |c#0@@1|)))) (=> (= (ControlFlow 0 7) 6) anon12_correct))))))))))
(let ((anon21_Else_correct  (=> (< |i#1_0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 14) 7) anon22_Then_correct) (=> (= (ControlFlow 0 14) 12) anon22_Else_correct)))))
(let ((anon21_Then_correct  (=> (<= (LitInt 0) |i#1_0@0|) (and (=> (= (ControlFlow 0 13) 7) anon22_Then_correct) (=> (= (ControlFlow 0 13) 12) anon22_Else_correct)))))
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 28) (- 0 32)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 28) (- 0 31)) (and (<= 0 |n#0|) (<= |n#0| (_System.array.Length |a#0|)))) (=> (and (<= 0 |n#0|) (<= |n#0| (_System.array.Length |a#0|))) (=> (= |A#0@0| (|Seq#Take| (|Seq#FromArray| $Heap |a#0|) |n#0|)) (and (=> (= (ControlFlow 0 28) (- 0 30)) (or (not (= |c#0@@1| null)) (not true))) (=> (or (not (= |c#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 28) (- 0 29)) (and (<= 0 |n#0|) (<= |n#0| (_System.array.Length |c#0@@1|)))) (=> (and (<= 0 |n#0|) (<= |n#0| (_System.array.Length |c#0@@1|))) (=> (= |C#0@0| (|Seq#Take| (|Seq#FromArray| $Heap |c#0@@1|) |n#0|)) (and (and (and (=> (= (ControlFlow 0 28) 27) anon15_Then_correct) (=> (= (ControlFlow 0 28) 16) anon19_Then_correct)) (=> (= (ControlFlow 0 28) 1) anon23_Then_correct)) (=> (= (ControlFlow 0 28) 3) anon23_Else_correct)))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap))) (=> (and (and (and (and ($Is refType |c#0@@1| (Tclass._System.array TInt)) ($IsAlloc refType |c#0@@1| (Tclass._System.array TInt) $Heap)) (<= (LitInt 0) |n#0|)) (and (and ($Is SeqType |A#0| (TSeq TInt)) ($IsAlloc SeqType |A#0| (TSeq TInt) $Heap)) true)) (and (and (and ($Is SeqType |C#0| (TSeq TInt)) ($IsAlloc SeqType |C#0| (TSeq TInt) $Heap)) true) (and (and (= 0 $FunctionContextHeight) (<= |n#0| (_System.array.Length |a#0|))) (and (<= |n#0| (_System.array.Length |c#0@@1|)) (= (ControlFlow 0 33) 28))))) anon0_correct))))
