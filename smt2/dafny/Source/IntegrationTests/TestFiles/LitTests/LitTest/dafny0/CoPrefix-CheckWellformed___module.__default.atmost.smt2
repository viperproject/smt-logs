...
(assert (distinct TBool TInt TagBool TagInt alloc Tagclass._module.Stream |##_module.Stream.Nil| |##_module.Stream.Cons| tytagFamily$Stream)
)
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@1 T@U) (|a#0@@1| T@U) (|b#0@@1| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |a#0@@1| Tclass._module.Stream) ($Is DatatypeTypeType |b#0@@1| Tclass._module.Stream)) (forall ((|_k#0@@1| T@U) ) (! (_module.__default.atmost_h ($LS $ly@@1) |_k#0@@1| |a#0@@1| |b#0@@1|)
 :qid |CoPrefixdfy.25:20|
 :skolemid |1815|
 :pattern ( (_module.__default.atmost_h ($LS $ly@@1) |_k#0@@1| |a#0@@1| |b#0@@1|))
))) (_module.__default.atmost ($LS $ly@@1) |a#0@@1| |b#0@@1|))
 :qid |CoPrefixdfy.25:20|
 :skolemid |1817|
...
(let ((|h#4| (_module.Stream.head |a#0@@2|)))
 (and (and (_module.Stream.Cons_q |b#0@@2|) (<= |h#4| (_module.Stream.head |b#0@@2|))) (_module.__default.atmost_h $ly@@2 (|ORD#Minus| |_k#0@@2| (|ORD#FromNat| 1)) |t#4| (_module.Stream.tail |b#0@@2|))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@2|)) (forall ((|_k'#0| T@U) ) (!  (=> (|ORD#Less| |_k'#0| |_k#0@@2|) (|_module.__default.atmost_h#canCall| |_k'#0| |a#0@@2| |b#0@@2|))
 :qid |CoPrefixdfy.25:20|
 :skolemid |1825|
 :pattern ( (_module.__default.atmost_h $ly@@2 |_k'#0| |a#0@@2| |b#0@@2|))
))))) (= (_module.__default.atmost_h ($LS $ly@@2) |_k#0@@2| |a#0@@2| |b#0@@2|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@2|)) (ite (_module.Stream.Nil_q |a#0@@2|) true (let ((|t#2| (_module.Stream.tail |a#0@@2|)))
(let ((|h#2| (_module.Stream.head |a#0@@2|)))
 (and (and (_module.Stream.Cons_q |b#0@@2|) (<= |h#2| (_module.Stream.head |b#0@@2|))) (_module.__default.atmost_h $ly@@2 (|ORD#Minus| |_k#0@@2| (|ORD#FromNat| 1)) |t#2| (_module.Stream.tail |b#0@@2|))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@2|)) (forall ((|_k'#0@@0| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@0| |_k#0@@2|) (_module.__default.atmost_h $ly@@2 |_k'#0@@0| |a#0@@2| |b#0@@2|))
 :qid |CoPrefixdfy.25:20|
 :skolemid |1824|
 :pattern ( (_module.__default.atmost_h $ly@@2 |_k'#0@@0| |a#0@@2| |b#0@@2|))
)))))))
 :qid |CoPrefixdfy.25:20|
 :skolemid |1826|
 :pattern ( (_module.__default.atmost_h ($LS $ly@@2) |_k#0@@2| |a#0@@2| |b#0@@2|))
))))
(assert (forall (($ly@@3 T@U) (|a#0@@3| T@U) (|b#0@@3| T@U) ) (! (= (_module.__default.atmost ($LS $ly@@3) |a#0@@3| |b#0@@3|) (_module.__default.atmost $ly@@3 |a#0@@3| |b#0@@3|))
 :qid |CoPrefixdfy.25:20|
 :skolemid |1810|
 :pattern ( (_module.__default.atmost ($LS $ly@@3) |a#0@@3| |b#0@@3|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@5 T@U) (|a#0@@5| T@U) (|b#0@@5| T@U) ) (!  (=> (or (|_module.__default.atmost#canCall| |a#0@@5| |b#0@@5|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |a#0@@5| Tclass._module.Stream) ($Is DatatypeTypeType |b#0@@5| Tclass._module.Stream)))) (and (=> (not (_module.Stream.Nil_q |a#0@@5|)) (let ((|t#1| (_module.Stream.tail |a#0@@5|)))
(let ((|h#1| (_module.Stream.head |a#0@@5|)))
 (=> (_module.Stream.Cons_q |b#0@@5|) (=> (<= |h#1| (_module.Stream.head |b#0@@5|)) (|_module.__default.atmost#canCall| |t#1| (_module.Stream.tail |b#0@@5|))))))) (= (_module.__default.atmost ($LS $ly@@5) |a#0@@5| |b#0@@5|) (ite (_module.Stream.Nil_q |a#0@@5|) true (let ((|t#0| (_module.Stream.tail |a#0@@5|)))
(let ((|h#0| (_module.Stream.head |a#0@@5|)))
 (and (and (_module.Stream.Cons_q |b#0@@5|) (<= |h#0| (_module.Stream.head |b#0@@5|))) (_module.__default.atmost $ly@@5 |t#0| (_module.Stream.tail |b#0@@5|)))))))))
 :qid |CoPrefixdfy.25:20|
 :skolemid |1814|
...
(assert (forall ((d@@4 T@U) ($h T@U) ) (!  (=> (and ($IsGoodHeap $h) (and (_module.Stream.Cons_q d@@4) ($IsAlloc DatatypeTypeType d@@4 Tclass._module.Stream $h))) ($IsAlloc intType (int_2_U (_module.Stream.head d@@4)) TInt $h))
 :qid |unknown.0:0|
 :skolemid |1952|
 :pattern ( ($IsAlloc intType (int_2_U (_module.Stream.head d@@4)) TInt $h))
)))
...
(assert (forall ((d@@5 T@U) ($h@@0 T@U) ) (!  (=> (and ($IsGoodHeap $h@@0) ($Is DatatypeTypeType d@@5 Tclass._module.Stream)) ($IsAlloc DatatypeTypeType d@@5 Tclass._module.Stream $h@@0))
 :qid |unknown.0:0|
 :skolemid |1956|
 :pattern ( ($IsAlloc DatatypeTypeType d@@5 Tclass._module.Stream $h@@0))
)))
(assert (= (Tag Tclass._module.Stream) Tagclass._module.Stream))
(assert (= (TagFamily Tclass._module.Stream) tytagFamily$Stream))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@6 T@U) (|a#0@@6| T@U) (|b#0@@6| T@U) (|_k#0@@4| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |a#0@@6| Tclass._module.Stream) ($Is DatatypeTypeType |b#0@@6| Tclass._module.Stream)) (= |_k#0@@4| (|ORD#FromNat| 0))) (_module.__default.atmost_h $ly@@6 |_k#0@@4| |a#0@@6| |b#0@@6|))
 :qid |CoPrefixdfy.25:20|
 :skolemid |1818|
 :pattern ( (_module.__default.atmost_h $ly@@6 |_k#0@@4| |a#0@@6| |b#0@@6|))
))))
...
(assert (forall ((d@@6 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.Stream.Cons_q d@@6) ($IsAlloc DatatypeTypeType d@@6 Tclass._module.Stream $h@@1))) ($IsAlloc DatatypeTypeType (_module.Stream.tail d@@6) Tclass._module.Stream $h@@1))
 :qid |unknown.0:0|
 :skolemid |1953|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Stream.tail d@@6) Tclass._module.Stream $h@@1))
)))
...
(let ((|h#7| (_module.Stream.head |a#0@@7|)))
 (and (and (_module.Stream.Cons_q |b#0@@7|) (<= |h#7| (_module.Stream.head |b#0@@7|))) (_module.__default.atmost_h ($LS $ly@@7) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |t#7| (_module.Stream.tail |b#0@@7|))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@5|)) (forall ((|_k'#1| T@U) ) (!  (=> (|ORD#Less| |_k'#1| |_k#0@@5|) (|_module.__default.atmost_h#canCall| |_k'#1| |a#0@@7| |b#0@@7|))
 :qid |CoPrefixdfy.25:20|
 :skolemid |1828|
 :pattern ( (_module.__default.atmost_h ($LS $ly@@7) |_k'#1| |a#0@@7| |b#0@@7|))
))))) (= (_module.__default.atmost_h ($LS $ly@@7) (Lit BoxType |_k#0@@5|) |a#0@@7| |b#0@@7|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@5|)) (ite (_module.Stream.Nil_q |a#0@@7|) true (let ((|t#5| (_module.Stream.tail |a#0@@7|)))
(let ((|h#5| (_module.Stream.head |a#0@@7|)))
 (and (and (_module.Stream.Cons_q |b#0@@7|) (<= |h#5| (_module.Stream.head |b#0@@7|))) (_module.__default.atmost_h ($LS $ly@@7) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |t#5| (_module.Stream.tail |b#0@@7|))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@5|)) (forall ((|_k'#1@@0| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@0| |_k#0@@5|) (_module.__default.atmost_h ($LS $ly@@7) |_k'#1@@0| |a#0@@7| |b#0@@7|))
 :qid |CoPrefixdfy.25:20|
 :skolemid |1827|
 :pattern ( (_module.__default.atmost_h ($LS $ly@@7) |_k'#1@@0| |a#0@@7| |b#0@@7|))
)))))))
 :qid |CoPrefixdfy.25:20|
 :weight 3
 :skolemid |1829|
 :pattern ( (_module.__default.atmost_h ($LS $ly@@7) (Lit BoxType |_k#0@@5|) |a#0@@7| |b#0@@7|))
))))
...
(let ((anon16_Else_correct  (=> (and (not (and (_module.Stream.Cons_q |b#0@@8|) (<= |h#Z#0@0| (_module.Stream.head |b#0@@8|)))) (= (ControlFlow 0 7) 4)) anon9_correct)))
(let ((anon16_Then_correct  (=> (and (and (_module.Stream.Cons_q |b#0@@8|) (<= |h#Z#0@0| (_module.Stream.head |b#0@@8|))) ($IsAlloc DatatypeTypeType |t#Z#0@0| Tclass._module.Stream $Heap)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (_module.Stream.Cons_q |b#0@@8|)) (=> (_module.Stream.Cons_q |b#0@@8|) (=> (and (and (= |##b#0@0| (_module.Stream.tail |b#0@@8|)) ($IsAlloc DatatypeTypeType |##b#0@0| Tclass._module.Stream $Heap)) (and (|_module.__default.atmost#canCall| |t#Z#0@0| (_module.Stream.tail |b#0@@8|)) (= (ControlFlow 0 5) 4))) anon9_correct))))))
(let ((anon15_Else_correct  (=> (not (_module.Stream.Cons_q |b#0@@8|)) (and (=> (= (ControlFlow 0 10) 5) anon16_Then_correct) (=> (= (ControlFlow 0 10) 7) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (_module.Stream.Cons_q |b#0@@8|) (and (=> (= (ControlFlow 0 8) (- 0 9)) (_module.Stream.Cons_q |b#0@@8|)) (=> (_module.Stream.Cons_q |b#0@@8|) (and (=> (= (ControlFlow 0 8) 5) anon16_Then_correct) (=> (= (ControlFlow 0 8) 7) anon16_Else_correct)))))))
(let ((anon14_Then_correct  (=> (and (and (and (= |a#0@@8| (|#_module.Stream.Cons| |_mcc#0#0| |_mcc#1#0|)) ($Is DatatypeTypeType |_mcc#1#0| Tclass._module.Stream)) (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| Tclass._module.Stream))) (and (and (= |t#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|)) (and ($Is intType (int_2_U |let#1#0#0|) TInt) (= |h#Z#0@0| |let#1#0#0|)))) (and (=> (= (ControlFlow 0 11) 8) anon15_Then_correct) (=> (= (ControlFlow 0 11) 10) anon15_Else_correct)))))
(let ((anon14_Else_correct true))
(let ((anon13_Else_correct  (=> (or (not (= |a#0@@8| |#_module.Stream.Nil|)) (not true)) (and (=> (= (ControlFlow 0 12) 11) anon14_Then_correct) (=> (= (ControlFlow 0 12) 3) anon14_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |a#0@@8| Tclass._module.Stream) ($Is DatatypeTypeType |b#0@@8| Tclass._module.Stream)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct))))
