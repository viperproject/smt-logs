...
(declare-fun Tagclass.MemberCall.Ref () T@U)
(declare-fun Tagclass.MemberCall.Ref? () T@U)
(declare-fun class.MemberCall.Ref? () T@U)
...
(declare-fun MemberCall.Ref.val () T@U)
(declare-fun Tclass.MemberCall.Ref? (T@U) T@U)
...
(declare-fun Tclass.MemberCall.Ref_0 (T@U) T@U)
(declare-fun Tclass.MemberCall.Ref?_0 (T@U) T@U)
...
(assert (distinct TBool TInt TagBool TagInt alloc allocName Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 Tagclass.MemberCall.Ref Tagclass.MemberCall.Ref? class.MemberCall.Ref? |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1| tytagFamily$Ref field$val)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((MemberCall.Ref$A T@U) ($h T@U) ($o T@U) ) (!  (=> (and ($IsGoodHeap $h) (and (or (not (= $o null)) (not true)) (= (dtype $o) (Tclass.MemberCall.Ref? MemberCall.Ref$A)))) ($IsBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h $o) MemberCall.Ref.val) MemberCall.Ref$A))
 :qid |unknown.0:0|
 :skolemid |1476|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h $o) MemberCall.Ref.val) (Tclass.MemberCall.Ref? MemberCall.Ref$A))
)))
(assert (forall ((MemberCall.Ref$A@@0 T@U) ($h@@0 T@U) ($o@@0 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@0) (and (or (not (= $o@@0 null)) (not true)) (= (dtype $o@@0) (Tclass.MemberCall.Ref? MemberCall.Ref$A@@0)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@0 $o@@0) alloc)))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@0 $o@@0) MemberCall.Ref.val) MemberCall.Ref$A@@0 $h@@0))
 :qid |unknown.0:0|
 :skolemid |1477|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@0 $o@@0) MemberCall.Ref.val) (Tclass.MemberCall.Ref? MemberCall.Ref$A@@0))
)))
(assert (forall ((MemberCall.Ref$A@@1 T@U) (|c#0| T@U) ($h@@1 T@U) ) (! (= ($IsAlloc refType |c#0| (Tclass.MemberCall.Ref MemberCall.Ref$A@@1) $h@@1) ($IsAlloc refType |c#0| (Tclass.MemberCall.Ref? MemberCall.Ref$A@@1) $h@@1))
 :qid |unknown.0:0|
 :skolemid |1479|
 :pattern ( ($IsAlloc refType |c#0| (Tclass.MemberCall.Ref MemberCall.Ref$A@@1) $h@@1))
 :pattern ( ($IsAlloc refType |c#0| (Tclass.MemberCall.Ref? MemberCall.Ref$A@@1) $h@@1))
)))
...
(assert (forall ((MemberCall.Ref$A@@2 T@U) ($o@@1 T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType $o@@1 (Tclass.MemberCall.Ref? MemberCall.Ref$A@@2) $h@@2)  (or (= $o@@1 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@1) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1475|
 :pattern ( ($IsAlloc refType $o@@1 (Tclass.MemberCall.Ref? MemberCall.Ref$A@@2) $h@@2))
)))
(assert (= (FDim MemberCall.Ref.val) 0))
(assert (= (FieldOfDecl class.MemberCall.Ref? field$val) MemberCall.Ref.val))
(assert  (not ($IsGhostField MemberCall.Ref.val)))
...
(assert (forall ((MemberCall.Ref$A@@3 T@U) (|c#0@@0| T@U) ) (! (= ($Is refType |c#0@@0| (Tclass.MemberCall.Ref MemberCall.Ref$A@@3))  (and ($Is refType |c#0@@0| (Tclass.MemberCall.Ref? MemberCall.Ref$A@@3)) (or (not (= |c#0@@0| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |1478|
 :pattern ( ($Is refType |c#0@@0| (Tclass.MemberCall.Ref MemberCall.Ref$A@@3)))
 :pattern ( ($Is refType |c#0@@0| (Tclass.MemberCall.Ref? MemberCall.Ref$A@@3)))
)))
...
(assert (forall ((MemberCall.Ref$A@@4 T@U) ) (!  (and (= (Tag (Tclass.MemberCall.Ref MemberCall.Ref$A@@4)) Tagclass.MemberCall.Ref) (= (TagFamily (Tclass.MemberCall.Ref MemberCall.Ref$A@@4)) tytagFamily$Ref))
 :qid |unknown.0:0|
 :skolemid |1468|
 :pattern ( (Tclass.MemberCall.Ref MemberCall.Ref$A@@4))
)))
(assert (forall ((MemberCall.Ref$A@@5 T@U) ) (!  (and (= (Tag (Tclass.MemberCall.Ref? MemberCall.Ref$A@@5)) Tagclass.MemberCall.Ref?) (= (TagFamily (Tclass.MemberCall.Ref? MemberCall.Ref$A@@5)) tytagFamily$Ref))
 :qid |unknown.0:0|
 :skolemid |1471|
 :pattern ( (Tclass.MemberCall.Ref? MemberCall.Ref$A@@5))
)))
...
(assert (forall ((MemberCall.Ref$A@@6 T@U) ($o@@2 T@U) ) (! (= ($Is refType $o@@2 (Tclass.MemberCall.Ref? MemberCall.Ref$A@@6))  (or (= $o@@2 null) (= (dtype $o@@2) (Tclass.MemberCall.Ref? MemberCall.Ref$A@@6))))
 :qid |unknown.0:0|
 :skolemid |1474|
 :pattern ( ($Is refType $o@@2 (Tclass.MemberCall.Ref? MemberCall.Ref$A@@6)))
)))
...
(assert (forall ((MemberCall.Ref$A@@7 T@U) ) (! (= (Tclass.MemberCall.Ref_0 (Tclass.MemberCall.Ref MemberCall.Ref$A@@7)) MemberCall.Ref$A@@7)
 :qid |unknown.0:0|
 :skolemid |1469|
 :pattern ( (Tclass.MemberCall.Ref MemberCall.Ref$A@@7))
)))
(assert (forall ((MemberCall.Ref$A@@8 T@U) ) (! (= (Tclass.MemberCall.Ref?_0 (Tclass.MemberCall.Ref? MemberCall.Ref$A@@8)) MemberCall.Ref$A@@8)
 :qid |unknown.0:0|
 :skolemid |1472|
 :pattern ( (Tclass.MemberCall.Ref? MemberCall.Ref$A@@8))
)))
...
(assert (forall ((MemberCall.Ref$A@@9 T@U) (bx@@6 T@U) ) (!  (=> ($IsBox bx@@6 (Tclass.MemberCall.Ref MemberCall.Ref$A@@9)) (and (= ($Box refType ($Unbox refType bx@@6)) bx@@6) ($Is refType ($Unbox refType bx@@6) (Tclass.MemberCall.Ref MemberCall.Ref$A@@9))))
 :qid |unknown.0:0|
 :skolemid |1470|
 :pattern ( ($IsBox bx@@6 (Tclass.MemberCall.Ref MemberCall.Ref$A@@9)))
)))
(assert (forall ((MemberCall.Ref$A@@10 T@U) (bx@@7 T@U) ) (!  (=> ($IsBox bx@@7 (Tclass.MemberCall.Ref? MemberCall.Ref$A@@10)) (and (= ($Box refType ($Unbox refType bx@@7)) bx@@7) ($Is refType ($Unbox refType bx@@7) (Tclass.MemberCall.Ref? MemberCall.Ref$A@@10))))
 :qid |unknown.0:0|
 :skolemid |1473|
 :pattern ( ($IsBox bx@@7 (Tclass.MemberCall.Ref? MemberCall.Ref$A@@10)))
)))
...
(set-info :boogie-vc-id Impl$$MemberCall.__default.Nope)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass.MemberCall.Ref? (Tclass._System.___hPartialFunc1 TInt TBool)))) (=> (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc)))) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= $nw@0 null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (Requires1 TInt TBool $Heap@0 ($Unbox HandleTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0) MemberCall.Ref.val)) ($Box intType (int_2_U (LitInt 0))))) (=> (Requires1 TInt TBool $Heap@0 ($Unbox HandleTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0) MemberCall.Ref.val)) ($Box intType (int_2_U (LitInt 0)))) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool ($Unbox boolType (Apply1 TInt TBool $Heap@0 ($Unbox HandleTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0) MemberCall.Ref.val)) ($Box intType (int_2_U (LitInt 0))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (=> |defass#f#0| (and ($Is refType |f#0@@1| (Tclass.MemberCall.Ref (Tclass._System.___hPartialFunc1 TInt TBool))) ($IsAlloc refType |f#0@@1| (Tclass.MemberCall.Ref (Tclass._System.___hPartialFunc1 TInt TBool)) $Heap))) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 2))) anon0_correct))))
