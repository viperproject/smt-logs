...
(declare-fun |r#0@0| () (_ BitVec 32))
(declare-fun |x#0| () (_ BitVec 32))
(declare-fun |y#0| () (_ BitVec 32))
(declare-fun |s#0@0| () (_ BitVec 32))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |r#0@0| (bvadd |x#0| |y#0|)) (= |s#0@0| (bvsub |y#0| |x#0|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= |r#0@0| (bvadd |x#0| |y#0|))) (=> (= |r#0@0| (bvadd |x#0| |y#0|)) (=> (= (ControlFlow 0 2) (- 0 1)) (= |s#0@0| (bvsub |y#0| |x#0|)))))))))
