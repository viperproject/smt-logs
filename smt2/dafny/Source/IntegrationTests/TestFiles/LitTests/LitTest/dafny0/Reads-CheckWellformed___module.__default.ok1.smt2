...
(declare-fun _module.__default.ok1 (T@U T@U) T@U)
(declare-fun |_module.__default.ok1#canCall| (T@U T@U) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (|c#0@@0| T@U) ) (!  (=> (or (|_module.__default.ok1#canCall| $Heap |c#0@@0|) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) (and ($Is refType |c#0@@0| Tclass._module.C) ($IsAlloc refType |c#0@@0| Tclass._module.C $Heap))) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0@@0|) _module.C.u))) 0)))) ($Is DatatypeTypeType (_module.__default.ok1 $Heap |c#0@@0|) Tclass._System.Tuple0))
 :qid |Readsdfy.12:16|
 :skolemid |535|
 :pattern ( (_module.__default.ok1 $Heap |c#0@@0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|c#0@@2| T@U) ) (!  (=> (or (|_module.__default.ok1#canCall| $Heap@@0 |c#0@@2|) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) ($Is refType |c#0@@2| Tclass._module.C)) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |c#0@@2|) _module.C.u))) 0)))) (= (_module.__default.ok1 $Heap@@0 |c#0@@2|) (Lit DatatypeTypeType |#_System._tuple#0._#Make0|)))
 :qid |Readsdfy.12:16|
 :skolemid |537|
 :pattern ( (_module.__default.ok1 $Heap@@0 |c#0@@2|) ($IsGoodHeap $Heap@@0))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.ok1)
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#1| null $Heap@@1 alloc |c#0@@3|)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= |c#0@@3| null)) (not true))) (=> (or (not (= |c#0@@3| null)) (not true)) (=> (and (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |c#0@@3| _module.C.u))) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |c#0@@3|) _module.C.u))) 0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 3) 1) anon5_Then_correct) (=> (= (ControlFlow 0 3) 2) anon5_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) ($Is refType |c#0@@3| Tclass._module.C)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 3))) anon0_correct)))
