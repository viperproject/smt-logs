...
(assert (distinct TReal TagReal TagSet TagMap alloc |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 |tytagFamily$_tuple#2|)
)
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|$w#0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#71| |l#0| |l#1| |l#2|) |$w#0|))  (and ($IsBox |$w#0| |l#0|) (exists ((|a#0#0#0| Real) (|a#0#1#0| Real) ) (!  (and (and (|Set#IsMember| |l#1| ($Box realType (real_2_U |a#0#0#0|))) (|Set#IsMember| |l#2| ($Box realType (real_2_U |a#0#1#0|)))) (= (U_2_real ($Unbox realType |$w#0|)) |a#0#0#0|))
 :qid |Mapsdfy.255:17|
 :skolemid |699|
))))
 :qid |DafnyPreludebpl.30:1|
 :skolemid |941|
 :pattern ( (MapType0Select BoxType boolType (|lambda#71| |l#0| |l#1| |l#2|) |$w#0|))
)))
...
(assert (forall ((h@@2 T@U) (v@@7 T@U) ) (! ($IsAlloc realType v@@7 TReal h@@2)
 :qid |DafnyPreludebpl.290:14|
 :skolemid |62|
 :pattern ( ($IsAlloc realType v@@7 TReal h@@2))
)))
...
(declare-fun |twelve#0| () Real)
(declare-fun |map$project$11#0#n#0| (Real) Real)
(declare-fun |map$project$11#0#p#0| (Real) Real)
(declare-fun |n#0@0| () Real)
(declare-fun |p#0@0| () Real)
(declare-fun |n#prime#0@0| () Real)
(declare-fun |p#prime#0@0| () Real)
...
(set-info :boogie-vc-id Impl$$_module.__default.GeneralMaps4)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon11_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (=> (|Set#IsMember| |s#0| ($Box realType (real_2_U (LitReal 2.0)))) (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |c0#0@0|) ($Box realType (real_2_U (LitReal 2.0)))))) |twelve#0|)))))
(let ((anon17_Else_correct  (=> (and (not (|Set#IsMember| |s#0| ($Box realType (real_2_U (LitReal 2.0))))) (= (ControlFlow 0 6) 3)) anon11_correct)))
(let ((anon17_Then_correct  (=> (|Set#IsMember| |s#0| ($Box realType (real_2_U (LitReal 2.0)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (|Set#IsMember| (|Map#Domain| |c0#0@0|) ($Box realType (real_2_U (LitReal 2.0))))) (=> (= (ControlFlow 0 4) 3) anon11_correct)))))
(let ((anon9_correct  (=> (and (forall ((|a#1#0#0@@0| T@U) (|a#1#1#0@@0| T@U) ) (!  (=> (and (|Set#IsMember| |s#0| ($Box realType |a#1#0#0@@0|)) (|Set#IsMember| |s#0| ($Box realType |a#1#1#0@@0|))) (and (and (|Set#IsMember| |s#0| ($Box realType (real_2_U (|map$project$11#0#n#0| (U_2_real |a#1#0#0@@0|))))) (|Set#IsMember| |s#0| ($Box realType (real_2_U (|map$project$11#0#p#0| (U_2_real |a#1#0#0@@0|)))))) (= (U_2_real |a#1#0#0@@0|) (|map$project$11#0#n#0| (U_2_real |a#1#0#0@@0|)))))
 :qid |Mapsdfy.255:17|
 :skolemid |700|
 :pattern ( (|Set#IsMember| |s#0| ($Box realType |a#1#1#0@@0|)) (|Set#IsMember| |s#0| ($Box realType |a#1#0#0@@0|)))
)) (= |c0#0@0| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#71| TReal |s#0| |s#0|)) (|lambda#48| ($Box realType (real_2_U |twelve#0|))) (TMap TReal TReal)))) (and (=> (= (ControlFlow 0 7) 4) anon17_Then_correct) (=> (= (ControlFlow 0 7) 6) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (and (not (and (and (|Set#IsMember| |s#0| ($Box realType (real_2_U |n#0@0|))) (|Set#IsMember| |s#0| ($Box realType (real_2_U |p#0@0|)))) (and (|Set#IsMember| |s#0| ($Box realType (real_2_U |n#prime#0@0|))) (|Set#IsMember| |s#0| ($Box realType (real_2_U |p#prime#0@0|)))))) (= (ControlFlow 0 10) 7)) anon9_correct)))
(let ((anon16_Then_correct  (=> (and (and (|Set#IsMember| |s#0| ($Box realType (real_2_U |n#0@0|))) (|Set#IsMember| |s#0| ($Box realType (real_2_U |p#0@0|)))) (and (|Set#IsMember| |s#0| ($Box realType (real_2_U |n#prime#0@0|))) (|Set#IsMember| |s#0| ($Box realType (real_2_U |p#prime#0@0|))))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (or (not (= |n#0@0| |n#prime#0@0|)) (not true)) (= |twelve#0| |twelve#0|))) (=> (or (or (not (= |n#0@0| |n#prime#0@0|)) (not true)) (= |twelve#0| |twelve#0|)) (=> (= (ControlFlow 0 8) 7) anon9_correct))))))
(let ((anon15_Else_correct  (=> (not (and (|Set#IsMember| |s#0| ($Box realType (real_2_U |n#0@0|))) (|Set#IsMember| |s#0| ($Box realType (real_2_U |p#0@0|))))) (and (=> (= (ControlFlow 0 12) 8) anon16_Then_correct) (=> (= (ControlFlow 0 12) 10) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (and (|Set#IsMember| |s#0| ($Box realType (real_2_U |n#0@0|))) (|Set#IsMember| |s#0| ($Box realType (real_2_U |p#0@0|)))) (and (=> (= (ControlFlow 0 11) 8) anon16_Then_correct) (=> (= (ControlFlow 0 11) 10) anon16_Else_correct)))))
(let ((anon14_Else_correct  (=> (not (and (|Set#IsMember| |s#0| ($Box realType (real_2_U |n#0@0|))) (|Set#IsMember| |s#0| ($Box realType (real_2_U |p#0@0|))))) (and (=> (= (ControlFlow 0 14) 11) anon15_Then_correct) (=> (= (ControlFlow 0 14) 12) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (and (|Set#IsMember| |s#0| ($Box realType (real_2_U |n#0@0|))) (|Set#IsMember| |s#0| ($Box realType (real_2_U |p#0@0|)))) (and (=> (= (ControlFlow 0 13) 11) anon15_Then_correct) (=> (= (ControlFlow 0 13) 12) anon15_Else_correct)))))
(let ((anon13_Else_correct  (=> (not (|Set#IsMember| |s#0| ($Box realType (real_2_U |n#0@0|)))) (and (=> (= (ControlFlow 0 16) 13) anon14_Then_correct) (=> (= (ControlFlow 0 16) 14) anon14_Else_correct)))))
(let ((anon13_Then_correct  (=> (|Set#IsMember| |s#0| ($Box realType (real_2_U |n#0@0|))) (and (=> (= (ControlFlow 0 15) 13) anon14_Then_correct) (=> (= (ControlFlow 0 15) 14) anon14_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SetType |s#0| (TSet TReal)) ($IsAlloc SetType |s#0| (TSet TReal) $Heap))) (=> (and (and (and ($Is MapType |c0#0| (TMap TReal TReal)) ($IsAlloc MapType |c0#0| (TMap TReal TReal) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 19) 18))) anon0_correct))))
