...
(set-info :boogie-vc-id CheckWellFormed$$SeqTests.__default.Lemma2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (< |index#0| (|Seq#Length| |s#0|)) (= (ControlFlow 0 2) (- 0 1))) (and (<= 0 |index#0|) (< |index#0| (|Seq#Length| |s#0|)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($IsBox |elt#0| SeqTests._default.Lemma2$T) ($IsAllocBox |elt#0| SeqTests._default.Lemma2$T $Heap))) (=> (and (and (and ($Is SeqType |s#0| (TSeq SeqTests._default.Lemma2$T)) ($IsAlloc SeqType |s#0| (TSeq SeqTests._default.Lemma2$T) $Heap)) (<= (LitInt 0) |index#0|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
