...
(assert (forall ((d@@5 T@U) ($h T@U) ) (!  (=> (and ($IsGoodHeap $h) (and (_module.Tree.Node_q d@@5) ($IsAlloc DatatypeTypeType d@@5 Tclass._module.Tree $h))) ($IsAlloc intType (int_2_U (_module.Tree.root d@@5)) TInt $h))
 :qid |unknown.0:0|
 :skolemid |3621|
 :pattern ( ($IsAlloc intType (int_2_U (_module.Tree.root d@@5)) TInt $h))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.ExtEvensSumToEven)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (= (Mod (_module.Tree.Sum ($LS ($LS $LZ)) |t#0|) (LitInt 2)) (LitInt 0)))))
(let ((anon5_Then_correct  (=> (= |t#0| (|#_module.Tree.Node| |_mcc#0#0_0@0| |_mcc#1#0_0@0| |_mcc#2#0_0@0|)) (=> (and ($Is DatatypeTypeType |_mcc#1#0_0@0| Tclass._module.Tree) ($Is DatatypeTypeType |_mcc#2#0_0@0| Tclass._module.Tree)) (=> (and (and (and (and (and ($Is DatatypeTypeType |right#0_0@0| Tclass._module.Tree) ($IsAlloc DatatypeTypeType |right#0_0@0| Tclass._module.Tree $Heap)) (= |let#0_0#0#0| |_mcc#2#0_0@0|)) (and ($Is DatatypeTypeType |let#0_0#0#0| Tclass._module.Tree) (= |right#0_0@0| |let#0_0#0#0|))) (and (and ($Is DatatypeTypeType |left#0_0@0| Tclass._module.Tree) ($IsAlloc DatatypeTypeType |left#0_0@0| Tclass._module.Tree $Heap)) (= |let#0_1#0#0| |_mcc#1#0_0@0|))) (and (and (and ($Is DatatypeTypeType |let#0_1#0#0| Tclass._module.Tree) (= |left#0_0@0| |let#0_1#0#0|)) (and (= |let#0_2#0#0| |_mcc#0#0_0@0|) ($Is intType (int_2_U |let#0_2#0#0|) TInt))) (and (and (= |x#0_0@0| |let#0_2#0#0|) ($IsAllocBox ($Box DatatypeTypeType |t#0|) Tclass._module.Tree $Heap)) (and (|_module.Tree.Elements#canCall| |t#0|) (|_module.Tree.Elements#canCall| |t#0|))))) (and (=> (= (ControlFlow 0 5) (- 0 12)) (|Set#IsMember| (_module.Tree.Elements ($LS ($LS $LZ)) |t#0|) ($Box intType (int_2_U |x#0_0@0|)))) (=> (|Set#IsMember| (_module.Tree.Elements ($LS $LZ) |t#0|) ($Box intType (int_2_U |x#0_0@0|))) (=> (and ($IsAllocBox ($Box DatatypeTypeType |left#0_0@0|) Tclass._module.Tree $Heap) (|_module.Tree.Elements#canCall| |left#0_0@0|)) (=> (and (and ($IsAllocBox ($Box DatatypeTypeType |t#0|) Tclass._module.Tree $Heap) (|_module.Tree.Elements#canCall| |t#0|)) (and (|_module.Tree.Elements#canCall| |left#0_0@0|) (|_module.Tree.Elements#canCall| |t#0|))) (and (=> (= (ControlFlow 0 5) (- 0 11)) (|Set#Subset| (_module.Tree.Elements ($LS ($LS $LZ)) |left#0_0@0|) (_module.Tree.Elements ($LS ($LS $LZ)) |t#0|))) (=> (|Set#Subset| (_module.Tree.Elements ($LS $LZ) |left#0_0@0|) (_module.Tree.Elements ($LS $LZ) |t#0|)) (=> (and ($IsAllocBox ($Box DatatypeTypeType |right#0_0@0|) Tclass._module.Tree $Heap) (|_module.Tree.Elements#canCall| |right#0_0@0|)) (=> (and (and ($IsAllocBox ($Box DatatypeTypeType |t#0|) Tclass._module.Tree $Heap) (|_module.Tree.Elements#canCall| |t#0|)) (and (|_module.Tree.Elements#canCall| |right#0_0@0|) (|_module.Tree.Elements#canCall| |t#0|))) (and (=> (= (ControlFlow 0 5) (- 0 10)) (|Set#Subset| (_module.Tree.Elements ($LS ($LS $LZ)) |right#0_0@0|) (_module.Tree.Elements ($LS ($LS $LZ)) |t#0|))) (=> (|Set#Subset| (_module.Tree.Elements ($LS $LZ) |right#0_0@0|) (_module.Tree.Elements ($LS $LZ) |t#0|)) (and (=> (= (ControlFlow 0 5) (- 0 9)) (< (DtRank |left#0_0@0|) (DtRank |t#0|))) (=> (< (DtRank |left#0_0@0|) (DtRank |t#0|)) (and (=> (= (ControlFlow 0 5) (- 0 8)) (forall ((|u#1| Int) ) (!  (=> (|Set#IsMember| (_module.Tree.Elements ($LS ($LS $LZ)) |left#0_0@0|) ($Box intType (int_2_U |u#1|))) (= (Mod |u#1| (LitInt 2)) (LitInt 0)))
 :qid |Terminationdfy.518:19|
 :skolemid |3071|
 :pattern ( (|Set#IsMember| (_module.Tree.Elements ($LS ($LS $LZ)) |left#0_0@0|) ($Box intType (int_2_U |u#1|))))
))) (=> (forall ((|u#1@@0| T@U) ) (!  (=> (|Set#IsMember| (_module.Tree.Elements ($LS ($LS $LZ)) |left#0_0@0|) ($Box intType |u#1@@0|)) (= (Mod (U_2_int |u#1@@0|) (LitInt 2)) (LitInt 0)))
 :qid |Terminationdfy.518:19|
 :skolemid |3071|
 :pattern ( (|Set#IsMember| (_module.Tree.Elements ($LS ($LS $LZ)) |left#0_0@0|) ($Box intType |u#1@@0|)))
)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (|_module.Tree.Sum#canCall| |left#0_0@0|)) (and (= (Mod (_module.Tree.Sum ($LS ($LS $LZ)) |left#0_0@0|) (LitInt 2)) (LitInt 0)) (= $Heap $Heap@0))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (< (DtRank |right#0_0@0|) (DtRank |t#0|))) (=> (< (DtRank |right#0_0@0|) (DtRank |t#0|)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((|u#1@@1| Int) ) (!  (=> (|Set#IsMember| (_module.Tree.Elements ($LS ($LS $LZ)) |right#0_0@0|) ($Box intType (int_2_U |u#1@@1|))) (= (Mod |u#1@@1| (LitInt 2)) (LitInt 0)))
 :qid |Terminationdfy.518:19|
 :skolemid |3071|
 :pattern ( (|Set#IsMember| (_module.Tree.Elements ($LS ($LS $LZ)) |right#0_0@0|) ($Box intType (int_2_U |u#1@@1|))))
))) (=> (forall ((|u#1@@2| T@U) ) (!  (=> (|Set#IsMember| (_module.Tree.Elements ($LS ($LS $LZ)) |right#0_0@0|) ($Box intType |u#1@@2|)) (= (Mod (U_2_int |u#1@@2|) (LitInt 2)) (LitInt 0)))
 :qid |Terminationdfy.518:19|
 :skolemid |3071|
 :pattern ( (|Set#IsMember| (_module.Tree.Elements ($LS ($LS $LZ)) |right#0_0@0|) ($Box intType |u#1@@2|)))
)) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (|_module.Tree.Sum#canCall| |right#0_0@0|) (= (Mod (_module.Tree.Sum ($LS ($LS $LZ)) |right#0_0@0|) (LitInt 2)) (LitInt 0))) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 5) 3))) GeneratedUnifiedExit_correct))))))))))))))))))))))))))
(let ((anon4_Then_correct  (=> (and (= |t#0| |#_module.Tree.Empty|) (= (ControlFlow 0 4) 3)) GeneratedUnifiedExit_correct)))
(let ((anon5_Else_correct true))
(let ((anon4_Else_correct  (=> (or (not (= |t#0| |#_module.Tree.Empty|)) (not true)) (and (=> (= (ControlFlow 0 13) 5) anon5_Then_correct) (=> (= (ControlFlow 0 13) 1) anon5_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 14) 4) anon4_Then_correct) (=> (= (ControlFlow 0 14) 13) anon4_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |t#0| Tclass._module.Tree) ($IsAlloc DatatypeTypeType |t#0| Tclass._module.Tree $Heap)) (|$IsA#_module.Tree| |t#0|)) (= 2 $FunctionContextHeight)) (and (forall ((|u#1@@3| T@U) ) (!  (=> (|Set#IsMember| (_module.Tree.Elements ($LS $LZ) |t#0|) ($Box intType |u#1@@3|)) (= (Mod (U_2_int |u#1@@3|) (LitInt 2)) (LitInt 0)))
 :qid |Terminationdfy.518:19|
 :skolemid |3074|
 :pattern ( (|Set#IsMember| (_module.Tree.Elements ($LS $LZ) |t#0|) ($Box intType |u#1@@3|)))
