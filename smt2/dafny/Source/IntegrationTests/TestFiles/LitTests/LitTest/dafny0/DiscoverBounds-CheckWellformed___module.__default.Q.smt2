...
(declare-fun _module.__default.Q (Real) Bool)
(declare-fun |_module.__default.Q#canCall| (Real) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|r#0| Real) ) (!  (=> (or (|_module.__default.Q#canCall| |r#0|) (< 0 $FunctionContextHeight)) (= (_module.__default.Q |r#0|) (<= (/ |r#0| 2.0) |r#0|)))
 :qid |DiscoverBoundsdfy.52:13|
 :skolemid |513|
 :pattern ( (_module.__default.Q |r#0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|r#0@@0| Real) ) (!  (=> (or (|_module.__default.Q#canCall| (LitReal |r#0@@0|)) (< 0 $FunctionContextHeight)) (= (_module.__default.Q (LitReal |r#0@@0|)) (<= (LitReal (/ |r#0@@0| 2.0)) (LitReal |r#0@@0|))))
 :qid |DiscoverBoundsdfy.52:13|
 :weight 3
 :skolemid |514|
 :pattern ( (_module.__default.Q (LitReal |r#0@@0|)))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (or (not (= (LitReal 2.0) 0.0)) (not true)))))
