...
(set-info :boogie-vc-id Impl$$_module.__default.IMapCommonUseCase1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon7_correct  (and (=> (= (ControlFlow 0 5) (- 0 8)) (exists ((|$as#kv0_0#0_0| T@U) ) (!  (and ($Is DatatypeTypeType |$as#kv0_0#0_0| (Tclass._System.Tuple2 Tclass._module.MyClass (TBitvector 3))) (U_2_bool (MapType0Select BoxType boolType (|IMap#Items| |m#0|) ($Box DatatypeTypeType |$as#kv0_0#0_0|))))
 :qid |Mapsdfy.579:9|
 :skolemid |868|
))) (=> (exists ((|$as#kv0_0#0_0@@0| T@U) ) (!  (and ($Is DatatypeTypeType |$as#kv0_0#0_0@@0| (Tclass._System.Tuple2 Tclass._module.MyClass (TBitvector 3))) (U_2_bool (MapType0Select BoxType boolType (|IMap#Items| |m#0|) ($Box DatatypeTypeType |$as#kv0_0#0_0@@0|))))
 :qid |Mapsdfy.579:9|
 :skolemid |868|
)) (=> (and (and (=> true (and ($Is DatatypeTypeType |kv#0_0@0| (Tclass._System.Tuple2 Tclass._module.MyClass (TBitvector 3))) ($IsAlloc DatatypeTypeType |kv#0_0@0| (Tclass._System.Tuple2 Tclass._module.MyClass (TBitvector 3)) $Heap))) (U_2_bool (MapType0Select BoxType boolType (|IMap#Items| |m#0|) ($Box DatatypeTypeType |kv#0_0@0|)))) (and ($Is refType |k#0_0@0| Tclass._module.MyClass) ($IsAlloc refType |k#0_0@0| Tclass._module.MyClass $Heap))) (and (=> (= (ControlFlow 0 5) (- 0 7)) true) (=> (and (and (= |let#0_0#0#0| |kv#0_0@0|) ($Is DatatypeTypeType |let#0_0#0#0| (Tclass._System.Tuple2 Tclass._module.MyClass (TBitvector 3)))) (and (_System.Tuple2.___hMake2_q |let#0_0#0#0|) (= (|#_System._tuple#2._#Make2| ($Box refType |k#0_0@0|) ($Box bv3Type (bv3_2_U |v#0_0@0|))) |let#0_0#0#0|))) (and (=> (= (ControlFlow 0 5) (- 0 6)) ($Is intType (int_2_U (+ |s#0@0| (nat_from_bv3 |v#0_0@0|))) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ |s#0@0| (nat_from_bv3 |v#0_0@0|))) Tclass._System.nat) (=> (= |s#0@1| (+ |s#0@0| (nat_from_bv3 |v#0_0@0|))) (=> (and (= |m#1@0| (|IMap#Subtract| |m#0| (|Set#UnionOne| |Set#Empty| ($Box refType |k#0_0@0|)))) (= (ControlFlow 0 5) (- 0 4))) false)))))))))))
(let ((anon11_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |kv#0_1@0| (Tclass._System.Tuple2 Tclass._module.MyClass (TBitvector 3))) ($IsAlloc DatatypeTypeType |kv#0_1@0| (Tclass._System.Tuple2 Tclass._module.MyClass (TBitvector 3)) $Heap))) (= (ControlFlow 0 10) 5)) anon7_correct)))
(let ((anon11_Then_correct  (=> (and (and ($Is DatatypeTypeType |kv#0_1@0| (Tclass._System.Tuple2 Tclass._module.MyClass (TBitvector 3))) ($IsAlloc DatatypeTypeType |kv#0_1@0| (Tclass._System.Tuple2 Tclass._module.MyClass (TBitvector 3)) $Heap)) (= (ControlFlow 0 9) 5)) anon7_correct)))
(let ((anon10_Else_correct  (=> (and (not (|IMap#Equal| |m#0| |IMap#Empty|)) (= |$decr$loop#00@0| (|IMap#Domain| |m#0|))) (and (=> (= (ControlFlow 0 11) 9) anon11_Then_correct) (=> (= (ControlFlow 0 11) 10) anon11_Else_correct)))))
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 14) (- 0 15)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (and (= |s#0@0| (LitInt 0)) (= |$decr_init$loop#00@0| (|IMap#Domain| |m#0|))) (=> (and (and (forall (($o@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2)))
 :qid |Mapsdfy.576:3|
 :skolemid |866|
