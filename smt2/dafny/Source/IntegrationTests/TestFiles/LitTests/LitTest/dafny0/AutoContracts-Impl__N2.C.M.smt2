...
(assert (forall ((bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 Tclass.N2.C?) (and (= ($Box refType ($Unbox refType bx@@2)) bx@@2) ($Is refType ($Unbox refType bx@@2) Tclass.N2.C?)))
 :qid |unknown.0:0|
 :skolemid |2154|
 :pattern ( ($IsBox bx@@2 Tclass.N2.C?))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@0 T@U) ) (!  (=> (or (|N2.C.Valid#canCall| $Heap@@0 this@@0) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass.N2.C) ($IsAlloc refType this@@0 Tclass.N2.C $Heap@@0)))))) (=> (N2.C.Valid $Heap@@0 this@@0) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) N2.C.Repr)) ($Box refType this@@0))))
 :qid |AutoContractsdfy.65:21|
 :skolemid |2232|
 :pattern ( (N2.C.Valid $Heap@@0 this@@0))
))))
...
(set-info :boogie-vc-id Impl$$N2.C.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#2| null $Heap@@1 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) N2.C.Repr)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> false (=> (|N2.C.Valid#canCall| $Heap@@1 this@@1) (or (N2.C.Valid $Heap@@1 this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) N2.C.Repr)) ($Box refType this@@1)))))) (=> (=> false (=> (|N2.C.Valid#canCall| $Heap@@1 this@@1) (or (N2.C.Valid $Heap@@1 this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) N2.C.Repr)) ($Box refType this@@1))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> false (=> (|N2.C.Valid#canCall| $Heap@@1 this@@1) (or (N2.C.Valid $Heap@@1 this@@1) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) N2.C.Repr)) ($Box refType null))))))) (=> (=> false (=> (|N2.C.Valid#canCall| $Heap@@1 this@@1) (or (N2.C.Valid $Heap@@1 this@@1) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) N2.C.Repr)) ($Box refType null)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> false (=> (|N2.C.Valid#canCall| $Heap@@1 this@@1) (or (N2.C.Valid $Heap@@1 this@@1) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> false (=> (|N2.C.Valid#canCall| $Heap@@1 this@@1) (or (N2.C.Valid $Heap@@1 this@@1) (U_2_bool (Lit boolType (bool_2_U true)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (and (forall (($o@@6 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) N2.C.Repr)) ($Box refType $o@@6)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) N2.C.Repr)) ($Box refType $o@@6)))) (or (not (= $o@@6 null)) (not true)))
 :qid |AutoContractsdfy.72:57|
 :skolemid |2227|
 :pattern (  (or (not (= $o@@6 null)) (not true)))
)) (forall (($o@@7 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) N2.C.Repr)) ($Box refType $o@@7)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) N2.C.Repr)) ($Box refType $o@@7)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@7) alloc)))))
 :qid |AutoContractsdfy.72:57|
 :skolemid |2228|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass.N2.C) ($IsAlloc refType this@@1 Tclass.N2.C $Heap@@1))) (= 1 $FunctionContextHeight)) (and (and (|N2.C.Valid#canCall| $Heap@@1 this@@1) (and (N2.C.Valid $Heap@@1 this@@1) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) N2.C.Repr)) ($Box refType this@@1)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) N2.C.Repr)) ($Box refType null)))) true))) (= (ControlFlow 0 6) 2))) anon0_correct))))
