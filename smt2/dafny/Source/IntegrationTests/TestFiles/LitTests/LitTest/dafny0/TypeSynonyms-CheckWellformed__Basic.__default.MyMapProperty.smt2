...
(declare-fun Basic.__default.MyMapProperty (T@U Int) Bool)
(declare-fun |Basic.__default.MyMapProperty#canCall| (T@U Int) Bool)
...
(assert (distinct TBool TInt TReal TagBool TagInt TagReal TagSet TagMap alloc |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 |tytagFamily$_tuple#2|)
)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|m#0| T@U) (|x#0| Int) ) (!  (=> (or (|Basic.__default.MyMapProperty#canCall| |m#0| |x#0|) (and (< 1 $FunctionContextHeight) ($Is MapType |m#0| (TMap TInt (TMap TReal TBool))))) (= (Basic.__default.MyMapProperty |m#0| |x#0|)  (and (and (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |x#0|))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select BoxType BoxType (|Map#Elements| |m#0|) ($Box intType (int_2_U |x#0|))))) ($Box realType (real_2_U (q@Real |x#0|))))) (U_2_bool ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select BoxType BoxType (|Map#Elements| |m#0|) ($Box intType (int_2_U |x#0|))))) ($Box realType (real_2_U (q@Real |x#0|)))))))))
 :qid |TypeSynonymsdfy.51:33|
 :skolemid |548|
 :pattern ( (Basic.__default.MyMapProperty |m#0| |x#0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|m#0@@0| T@U) (|x#0@@0| Int) ) (!  (=> (or (|Basic.__default.MyMapProperty#canCall| (Lit MapType |m#0@@0|) (LitInt |x#0@@0|)) (and (< 1 $FunctionContextHeight) ($Is MapType |m#0@@0| (TMap TInt (TMap TReal TBool))))) (= (Basic.__default.MyMapProperty (Lit MapType |m#0@@0|) (LitInt |x#0@@0|))  (and (and (|Set#IsMember| (|Map#Domain| |m#0@@0|) ($Box intType (int_2_U |x#0@@0|))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType |m#0@@0|)) ($Box intType (int_2_U (LitInt |x#0@@0|)))))) ($Box realType (real_2_U (q@Real (LitInt |x#0@@0|)))))) (U_2_bool ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType |m#0@@0|)) ($Box intType (int_2_U (LitInt |x#0@@0|)))))) ($Box realType (real_2_U (q@Real (LitInt |x#0@@0|))))))))))
 :qid |TypeSynonymsdfy.51:33|
 :weight 3
 :skolemid |549|
 :pattern ( (Basic.__default.MyMapProperty (Lit MapType |m#0@@0|) (LitInt |x#0@@0|)))
))))
...
(assert (forall ((bx@@3 T@U) (s T@U) (t@@5 T@U) ) (!  (=> ($IsBox bx@@3 (TMap s t@@5)) (and (= ($Box MapType ($Unbox MapType bx@@3)) bx@@3) ($Is MapType ($Unbox MapType bx@@3) (TMap s t@@5))))
 :qid |DafnyPreludebpl.207:15|
 :skolemid |36|
 :pattern ( ($IsBox bx@@3 (TMap s t@@5)))
)))
...
(set-info :boogie-vc-id CheckWellformed$$Basic.__default.MyMapProperty)
...
(let ((anon11_Else_correct  (=> (and (not (and (|Set#IsMember| (|Map#Domain| |m#0@@1|) ($Box intType (int_2_U |x#0@@1|))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@1|) ($Box intType (int_2_U |x#0@@1|))))) ($Box realType (real_2_U (q@Real |x#0@@1|)))))) (= (ControlFlow 0 6) 2)) anon7_correct)))
(let ((anon11_Then_correct  (=> (and (|Set#IsMember| (|Map#Domain| |m#0@@1|) ($Box intType (int_2_U |x#0@@1|))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@1|) ($Box intType (int_2_U |x#0@@1|))))) ($Box realType (real_2_U (q@Real |x#0@@1|))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (|Set#IsMember| (|Map#Domain| |m#0@@1|) ($Box intType (int_2_U |x#0@@1|)))) (=> (|Set#IsMember| (|Map#Domain| |m#0@@1|) ($Box intType (int_2_U |x#0@@1|))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@1|) ($Box intType (int_2_U |x#0@@1|))))) ($Box realType (real_2_U (q@Real |x#0@@1|))))) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@1|) ($Box intType (int_2_U |x#0@@1|))))) ($Box realType (real_2_U (q@Real |x#0@@1|)))) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))))
(let ((anon10_Else_correct  (=> (not (|Set#IsMember| (|Map#Domain| |m#0@@1|) ($Box intType (int_2_U |x#0@@1|)))) (and (=> (= (ControlFlow 0 9) 3) anon11_Then_correct) (=> (= (ControlFlow 0 9) 6) anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |m#0@@1|) ($Box intType (int_2_U |x#0@@1|))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (|Set#IsMember| (|Map#Domain| |m#0@@1|) ($Box intType (int_2_U |x#0@@1|)))) (=> (|Set#IsMember| (|Map#Domain| |m#0@@1|) ($Box intType (int_2_U |x#0@@1|))) (and (=> (= (ControlFlow 0 7) 3) anon11_Then_correct) (=> (= (ControlFlow 0 7) 6) anon11_Else_correct)))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 10) 1) anon9_Then_correct) (=> (= (ControlFlow 0 10) 7) anon10_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon10_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is MapType |m#0@@1| (TMap TInt (TMap TReal TBool)))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct)))
