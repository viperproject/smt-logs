...
procedure {:verboseName "B_more.L (well-formedness)"} CheckWellFormed$$B__more.__default.L(c#0: ref
...
procedure {:verboseName "B_more.L (call)"} Call$$B__more.__default.L(c#0: ref
       where $Is(c#0, Tclass.B____more.X.Abs.C())
         && $IsAlloc(c#0, Tclass.B____more.X.Abs.C(), $Heap));
  modifies $Heap;
...
procedure {:verboseName "B_more.L (correctness)"} Impl$$B__more.__default.L(c#0: ref
       where $Is(c#0, Tclass.B____more.X.Abs.C())
         && $IsAlloc(c#0, Tclass.B____more.X.Abs.C(), $Heap))
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "B_more.L (correctness)"} Impl$$B__more.__default.L(c#0: ref) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
    ...
    $_reverifyPost := false;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/OpaqueFunctions.dfy(135,5)
    assert {:id "id160"} {:subsumption 0} c#0 != null;
    // assume allocatedness for receiver argument to function
    assume $IsAllocBox($Box(c#0), Tclass.B____more.X.Abs.C?(), $Heap);
    assume B____more.X.Abs.C.Get#canCall($Heap, c#0);
    assert {:id "id161"} {:subsumption 0} c#0 != null;
    assume B____more.X.Abs.C.Get#canCall($Heap, c#0);
    assert {:id "id162"} B____more.X.Abs.C.Get($Heap, c#0)
       == $Unbox(read($Heap, c#0, B____more.X.Abs.C.x)): int;
}
...
axiom {:id "id163"} (forall $Heap: Heap, this: ref :: 
...
axiom {:id "id164"} (forall $Heap: Heap, this: ref :: 
