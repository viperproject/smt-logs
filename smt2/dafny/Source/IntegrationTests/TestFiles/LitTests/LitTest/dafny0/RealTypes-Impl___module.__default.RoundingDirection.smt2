...
(set-info :boogie-vc-id Impl$$_module.__default.RoundingDirection)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (LitInt (q@Int (LitReal 51.500277))) (LitInt 51))) (=> (= (LitInt (q@Int (LitReal 51.500277))) (LitInt 51)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (LitInt (q@Int (LitReal (- 0.0 0.194771)))) (LitInt (- 0 1)))) (=> (= (LitInt (q@Int (LitReal (- 0.0 0.194771)))) (LitInt (- 0 1))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (LitInt (- 0 (q@Int (LitReal 0.194771)))) (LitInt 0))))))))))
