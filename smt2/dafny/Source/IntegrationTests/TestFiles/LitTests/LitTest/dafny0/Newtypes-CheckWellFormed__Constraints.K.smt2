...
(set-info :boogie-vc-id CheckWellFormed$$Constraints.K)
...
(let ((anon9_Else_correct  (=> (and (=> (<= (LitReal 10.0) |x#0|) (< (/ 200.0 (- |x#0| 20.0)) 30.0)) (= (ControlFlow 0 6) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (<= (LitReal 10.0) |x#0|) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (not (= (- |x#0| 20.0) 0.0)) (not true))) (=> (or (not (= (- |x#0| 20.0) 0.0)) (not true)) (=> (and (< (/ 200.0 (- |x#0| 20.0)) 30.0) (= (ControlFlow 0 4) 3)) anon5_correct))))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (<= (LitReal 10.0) (LitReal 0.0)) (U_2_bool (Lit boolType (bool_2_U (< (/ 200.0 (- 0.0 20.0)) 30.0))))))))
