...
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> |defass#d#0| (and ($IsBox |d#0@0| Tclass.AssignSuchThat.D) ($IsAllocBox |d#0@0| Tclass.AssignSuchThat.D $Heap)))) (and (=> (= (ControlFlow 0 5) 3) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))
