...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon9_correct  (and (=> (= (ControlFlow 0 6) (- 0 9)) (exists ((|$as#x0_0#0_0| T@U) )  (and ($IsBox |$as#x0_0#0_0| _module._default.SetsST0$Y) (and (|Set#IsMember| |s#0@0| |$as#x0_0#0_0|) (or (not (= |$as#x0_0#0_0| |y#0|)) (not true)))))) (=> (exists ((|$as#x0_0#0_0@@0| T@U) )  (and ($IsBox |$as#x0_0#0_0@@0| _module._default.SetsST0$Y) (and (|Set#IsMember| |s#0@0| |$as#x0_0#0_0@@0|) (or (not (= |$as#x0_0#0_0@@0| |y#0|)) (not true))))) (=> (=> true (and ($IsBox |x#0_0@1| _module._default.SetsST0$Y) ($IsAllocBox |x#0_0@1| _module._default.SetsST0$Y $Heap))) (=> (and (|Set#IsMember| |s#0@0| |x#0_0@1|) (or (not (= |x#0_0@1| |y#0|)) (not true))) (and (=> (= (ControlFlow 0 6) (- 0 8)) true) (=> (= |s#0@1| (|Set#Difference| |s#0@0| (|Set#UnionOne| |Set#Empty| |x#0_0@1|))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (<= 0 |$decr$loop#00@1|) (= (|Set#Card| (|Set#Difference| |s#0@1| |t#0@0|)) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (|Set#Card| (|Set#Difference| |s#0@1| |t#0@0|)) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 6) (- 0 5)) (< (|Set#Card| (|Set#Difference| |s#0@1| |t#0@0|)) |$decr$loop#00@1|))))))))))))
