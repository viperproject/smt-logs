...
(set-info :boogie-vc-id CheckWellFormed$$ITER__F.RecursiveIterator.__ctor)
...
(let ((anon5_Else_correct  (=> (and (<= 2 (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |cell#0|) ITER__F.Cell.data)))) (= (ControlFlow 0 3) 1)) anon4_correct)))
(let ((anon5_Then_correct  (=> (and (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |cell#0|) ITER__F.Cell.data))) 2) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (or (not (= |cell#0| null)) (not true)) (or (not (= |r#0| null)) (not true))) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@29 T@U) ) (!  (=> (and (or (not (= $o@@29 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@29) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@29) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@29)))
 :qid |Iteratorsdfy.361:12|
 :skolemid |3149|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@29))
)) ($HeapSucc $Heap $Heap@0))) (and (and (or (not (= this@0 null)) (not true)) (and ($Is refType this@0 Tclass.ITER__F.RecursiveIterator) ($IsAlloc refType this@0 Tclass.ITER__F.RecursiveIterator $Heap@0))) (and (= (ITER__F.RecursiveIterator.cell this@0) |cell#0|) (= (ITER__F.RecursiveIterator.n this@0) |n#0|)))) (and (and (and (= (ITER__F.RecursiveIterator.r this@0) |r#0|) (= (ITER__F.RecursiveIterator.good this@0) |good#0|)) (and ($IsAllocBox ($Box refType this@0) Tclass.ITER__F.RecursiveIterator? $Heap@0) (|ITER__F.RecursiveIterator.Valid#canCall| $Heap@0 this@0))) (and (and (ITER__F.RecursiveIterator.Valid $Heap@0 this@0) (|Set#Equal| (ITER__F.RecursiveIterator.__reads this@0) |Set#Empty|)) (and (|Set#Equal| (ITER__F.RecursiveIterator.__modifies this@0) (|Set#UnionOne| |Set#Empty| ($Box refType |cell#0|))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) ITER__F.RecursiveIterator.__new)) |Set#Empty|))))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (or (not (= |cell#0| null)) (not true))) (=> (or (not (= |cell#0| null)) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 5)) ($IsAlloc refType |cell#0| Tclass.ITER__F.Cell? $Heap)) (=> ($IsAlloc refType |cell#0| Tclass.ITER__F.Cell? $Heap) (and (=> (= (ControlFlow 0 4) 2) anon5_Then_correct) (=> (= (ControlFlow 0 4) 3) anon5_Else_correct)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |cell#0| Tclass.ITER__F.Cell?) ($IsAlloc refType |cell#0| Tclass.ITER__F.Cell? $Heap)) (<= (LitInt 0) |n#0|)) (and (and ($Is refType |r#0| Tclass.ITER__F.RecIterCaller?) ($IsAlloc refType |r#0| Tclass.ITER__F.RecIterCaller? $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 7) 4)))) anon0_correct))))
