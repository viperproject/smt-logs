...
(declare-fun |k#0| () T@U)
(declare-fun _module._default.BadCasts$W () T@U)
...
(declare-fun |defass#b'#4_0| () Bool)
(declare-fun |b'#4_0| () T@U)
(declare-fun |defass#p#4_0| () Bool)
(declare-fun |p#4_0| () T@U)
(declare-fun |defass#p'#4_0| () Bool)
(declare-fun |p'#4_0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.BadCasts)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon11_Else_correct  (=> (and (and (and (and (and (not (U_2_bool (Lit boolType (bool_2_U true)))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (= (ControlFlow 0 18) (- 0 17))) false)))
(let ((anon11_Then_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) true) (=> (= (ControlFlow 0 15) (- 0 14)) ($Is refType |k#0| (Tclass._module.A _module._default.BadCasts$W))))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 13) (- 0 12)) ($Is refType |k#0| (Tclass._module.B TInt TInt)))))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) true) (=> (= (ControlFlow 0 10) (- 0 9)) ($Is refType |k#0| (Tclass._module.B _module._default.BadCasts$W TInt))))))
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) true) (=> (= (ControlFlow 0 7) (- 0 6)) ($Is refType |k#0| (Tclass._module.B TReal _module._default.BadCasts$W))))))
(let ((anon7_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($Is refType |k#0| (Tclass._module.K _module._default.BadCasts$W))) (=> ($Is refType |k#0| (Tclass._module.K _module._default.BadCasts$W)) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (= (ControlFlow 0 2) (- 0 1)) ($Is refType |l#0@@0| (Tclass._module.K _module._default.BadCasts$W)))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (and (and (and (=> (= (ControlFlow 0 19) 2) anon7_Then_correct) (=> (= (ControlFlow 0 19) 7) anon8_Then_correct)) (=> (= (ControlFlow 0 19) 10) anon9_Then_correct)) (=> (= (ControlFlow 0 19) 13) anon10_Then_correct)) (=> (= (ControlFlow 0 19) 15) anon11_Then_correct)) (=> (= (ControlFlow 0 19) 18) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |k#0| (Tclass._module.K _module._default.BadCasts$W)) ($IsAlloc refType |k#0| (Tclass._module.K _module._default.BadCasts$W) $Heap)) (and ($Is refType |l#0@@0| (Tclass._module.L _module._default.BadCasts$W)) ($IsAlloc refType |l#0@@0| (Tclass._module.L _module._default.BadCasts$W) $Heap))) (and (and (=> |defass#o#0| (and ($Is refType |o#0| Tclass._System.object) ($IsAlloc refType |o#0| Tclass._System.object $Heap))) true) (and (=> |defass#b#0_0| (and ($Is refType |b#0_0| (Tclass._module.A _module._default.BadCasts$W)) ($IsAlloc refType |b#0_0| (Tclass._module.A _module._default.BadCasts$W) $Heap))) true))) (=> (and (and (and (and (=> |defass#b#1_0| (and ($Is refType |b#1_0| (Tclass._module.B TInt TInt)) ($IsAlloc refType |b#1_0| (Tclass._module.B TInt TInt) $Heap))) true) (and (=> |defass#b#2_0| (and ($Is refType |b#2_0| (Tclass._module.B _module._default.BadCasts$W TInt)) ($IsAlloc refType |b#2_0| (Tclass._module.B _module._default.BadCasts$W TInt) $Heap))) true)) (and (and (=> |defass#b#3_0| (and ($Is refType |b#3_0| (Tclass._module.B TReal _module._default.BadCasts$W)) ($IsAlloc refType |b#3_0| (Tclass._module.B TReal _module._default.BadCasts$W) $Heap))) true) (and (=> |defass#b#4_0| (and ($Is refType |b#4_0| (Tclass._module.B TInt _module._default.BadCasts$W)) ($IsAlloc refType |b#4_0| (Tclass._module.B TInt _module._default.BadCasts$W) $Heap))) true))) (and (and (and (=> |defass#b'#4_0| (and ($Is refType |b'#4_0| (Tclass._module.B TInt _module._default.BadCasts$W)) ($IsAlloc refType |b'#4_0| (Tclass._module.B TInt _module._default.BadCasts$W) $Heap))) true) (and (=> |defass#p#4_0| (and ($Is refType |p#4_0| (Tclass._module.K _module._default.BadCasts$W)) ($IsAlloc refType |p#4_0| (Tclass._module.K _module._default.BadCasts$W) $Heap))) true)) (and (and (=> |defass#p'#4_0| (and ($Is refType |p'#4_0| (Tclass._module.K _module._default.BadCasts$W)) ($IsAlloc refType |p'#4_0| (Tclass._module.K _module._default.BadCasts$W) $Heap))) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 20) 19))))) anon0_correct)))))
