...
(let ((anon14_Then_correct  (=> (<= |n#0| |i#0@1|) (and (=> (= (ControlFlow 0 6) (- 0 13)) (= |i#0@1| |n#0|)) (=> (= |i#0@1| |n#0|) (and (=> (= (ControlFlow 0 6) (- 0 12)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 6) (- 0 11)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |a#0|)))) (and (=> (= (ControlFlow 0 6) (- 0 10)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 6) (- 0 9)) ($IsAlloc refType |a#0| (Tclass._System.array? TInt) $Heap)) (=> ($IsAlloc refType |a#0| (Tclass._System.array? TInt) $Heap) (and (=> (= (ControlFlow 0 6) (- 0 8)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |a#0|)))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField (LitInt 0))))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField (LitInt 0))))))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField (LitInt 0))))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField (LitInt 0)))))) (=> (= (ControlFlow 0 6) (- 0 5)) (= |n#0| (LitInt 0))))))))))))))))))
(let ((anon8_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> false (<= (LitInt 0) |i#0@2|))) (=> (=> false (<= (LitInt 0) |i#0@2|)) (=> (= (ControlFlow 0 3) (- 0 2)) (=> false (<= |i#0@2| |n#0|)))))))
(let ((anon14_Else_correct  (=> (and (< |i#0@1| |n#0|) (= (ControlFlow 0 14) 3)) anon8_correct)))
(let ((anon13_Then_correct  (and (=> (= (ControlFlow 0 15) 6) anon14_Then_correct) (=> (= (ControlFlow 0 15) 14) anon14_Else_correct))))
(let ((anon11_Else_correct  (=> |$w$loop#0@1| (and (=> (= (ControlFlow 0 16) 15) anon13_Then_correct) (=> (= (ControlFlow 0 16) 3) anon8_correct)))))
(let ((anon10_LoopBody_correct  (and (=> (= (ControlFlow 0 21) 20) anon11_Then_correct) (=> (= (ControlFlow 0 21) 16) anon11_Else_correct))))
(let ((anon10_LoopDone_correct true))
(let ((anon10_LoopHead_correct  (=> (not false) (=> (and (=> |$w$loop#0@1| (<= (LitInt 0) |i#0@1|)) (=> |$w$loop#0@1| (<= |i#0@1| |n#0|))) (=> (and (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6)) (= $o@@6 |a#0|)))
 :qid |DirtyLoopsdfy.106:3|
 :skolemid |518|
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#4| null $Heap alloc |a#0|)) (=> (and (= |i#0@0| (LitInt 0)) (= |$decr_init$loop#00@0| (- |n#0| |i#0@0|))) (and (=> (= (ControlFlow 0 23) (- 0 25)) (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@0|))) (=> (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@0|)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (=> |$w$loop#0@0| (<= |i#0@0| |n#0|))) (=> (=> |$w$loop#0@0| (<= |i#0@0| |n#0|)) (=> (= (ControlFlow 0 23) 22) anon10_LoopHead_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap))) (and (and (<= (LitInt 0) |n#0|) (= 0 $FunctionContextHeight)) (and (= (_System.array.Length |a#0|) (LitInt 10)) (= (ControlFlow 0 26) 23)))) anon0_correct)))
