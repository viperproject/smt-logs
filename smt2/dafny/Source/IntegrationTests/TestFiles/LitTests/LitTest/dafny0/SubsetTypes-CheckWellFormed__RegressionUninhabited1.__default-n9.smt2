...
(set-info :boogie-vc-id CheckWellFormed$$RegressionUninhabited1.__default.x)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |newtype$check#0@0| (LitInt (- 0 1))) (= (ControlFlow 0 2) (- 0 1))) (U_2_bool (Lit boolType (bool_2_U false)))))))
