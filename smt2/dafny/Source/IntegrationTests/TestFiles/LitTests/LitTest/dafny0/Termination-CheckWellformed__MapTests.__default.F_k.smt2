...
(declare-fun MapTests.__default.F_k (T@U T@U Int) Int)
(declare-fun $LS (T@U) T@U)
(declare-fun |MapTests.__default.F_k#canCall| (T@U Int) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly T@U) (|a#0| T@U) (|n#0| Int) ) (!  (=> (or (|MapTests.__default.F_k#canCall| |a#0| |n#0|) (and (< 0 $FunctionContextHeight) (and ($Is MapType |a#0| (TMap TInt TInt)) (<= (LitInt 0) |n#0|)))) (and (=> (or (not (= |n#0| (LitInt 0))) (not true)) (|MapTests.__default.F_k#canCall| |a#0| (- |n#0| 1))) (= (MapTests.__default.F_k ($LS $ly) |a#0| |n#0|) (ite (= |n#0| (LitInt 0)) 0 (MapTests.__default.F_k $ly |a#0| (- |n#0| 1))))))
 :qid |Terminationdfy.408:18|
 :skolemid |1196|
 :pattern ( (MapTests.__default.F_k ($LS $ly) |a#0| |n#0|))
))))
...
(assert (forall (($ly@@0 T@U) (|a#0@@0| T@U) (|n#0@@0| Int) ) (! (= (MapTests.__default.F_k ($LS $ly@@0) |a#0@@0| |n#0@@0|) (MapTests.__default.F_k $ly@@0 |a#0@@0| |n#0@@0|))
 :qid |Terminationdfy.408:18|
 :skolemid |1192|
 :pattern ( (MapTests.__default.F_k ($LS $ly@@0) |a#0@@0| |n#0@@0|))
)))
...
(assert (forall ((v@@6 T@U) (t0@@4 T@U) (t1@@2 T@U) ) (! (= ($Is MapType v@@6 (TMap t0@@4 t1@@2)) (forall ((bx@@7 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@6) bx@@7) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@6) bx@@7) t1@@2) ($IsBox bx@@7 t0@@4)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@1 T@U) (|a#0@@1| T@U) (|n#0@@1| Int) ) (!  (=> (or (|MapTests.__default.F_k#canCall| (Lit MapType |a#0@@1|) (LitInt |n#0@@1|)) (and (< 0 $FunctionContextHeight) (and ($Is MapType |a#0@@1| (TMap TInt TInt)) (<= (LitInt 0) |n#0@@1|)))) (and (=> (or (not (= (LitInt |n#0@@1|) (LitInt 0))) (not true)) (|MapTests.__default.F_k#canCall| (Lit MapType |a#0@@1|) (LitInt (- |n#0@@1| 1)))) (= (MapTests.__default.F_k ($LS $ly@@1) (Lit MapType |a#0@@1|) (LitInt |n#0@@1|)) (ite (= (LitInt |n#0@@1|) (LitInt 0)) 0 (MapTests.__default.F_k ($LS $ly@@1) (Lit MapType |a#0@@1|) (LitInt (- |n#0@@1| 1)))))))
 :qid |Terminationdfy.408:18|
 :weight 3
 :skolemid |1197|
 :pattern ( (MapTests.__default.F_k ($LS $ly@@1) (Lit MapType |a#0@@1|) (LitInt |n#0@@1|)))
))))
...
(set-info :boogie-vc-id CheckWellformed$$MapTests.__default.F_k)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon8_Else_correct  (=> (and (or (not (= |n#0@@2| (LitInt 0))) (not true)) ($IsAlloc MapType |a#0@@2| (TMap TInt TInt) $Heap)) (and (=> (= (ControlFlow 0 4) (- 0 6)) ($Is intType (int_2_U (- |n#0@@2| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0@@2| 1)) Tclass._System.nat) (=> (and (= |##n#0@0| (- |n#0@@2| 1)) ($IsAlloc intType (int_2_U |##n#0@0|) Tclass._System.nat $Heap)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (or (<= 0 |n#0@@2|) (and (|Set#Subset| (|Map#Domain| |a#0@@2|) (|Map#Domain| |a#0@@2|)) (not (|Set#Subset| (|Map#Domain| |a#0@@2|) (|Map#Domain| |a#0@@2|))))) (= |##n#0@0| |n#0@@2|))) (=> (or (or (<= 0 |n#0@@2|) (and (|Set#Subset| (|Map#Domain| |a#0@@2|) (|Map#Domain| |a#0@@2|)) (not (|Set#Subset| (|Map#Domain| |a#0@@2|) (|Map#Domain| |a#0@@2|))))) (= |##n#0@0| |n#0@@2|)) (=> (= (ControlFlow 0 4) (- 0 3)) (or (and (|Set#Subset| (|Map#Domain| |a#0@@2|) (|Map#Domain| |a#0@@2|)) (not (|Set#Subset| (|Map#Domain| |a#0@@2|) (|Map#Domain| |a#0@@2|)))) (and (|Set#Equal| (|Map#Domain| |a#0@@2|) (|Map#Domain| |a#0@@2|)) (< |##n#0@0| |n#0@@2|))))))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is MapType |a#0@@2| (TMap TInt TInt)) (<= (LitInt 0) |n#0@@2|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
