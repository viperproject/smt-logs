...
(declare-fun _module.SeqOp.S5 (T@U Int) T@U)
(declare-fun LitInt (Int) Int)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.SeqOp.S5#canCall| (T@U Int) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) (|n#0| Int) ) (!  (=> (or (|_module.SeqOp.S5#canCall| this (LitInt |n#0|)) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.SeqOp) ($IsAlloc refType this Tclass._module.SeqOp $Heap)))) (<= (LitInt 0) |n#0|)))) (= (_module.SeqOp.S5 this (LitInt |n#0|)) (|Seq#Create| TReal $Heap (LitInt |n#0|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#53| 20 2.5 this _module.SeqOp.x) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#82| this))))) ($LS $LZ))))))
 :qid |Comprehensionsdfy.117:12|
 :weight 3
 :skolemid |602|
 :pattern ( (_module.SeqOp.S5 this (LitInt |n#0|)) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@0 T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.SeqOp.S5#canCall| this@@0 |n#0@@0|) (and (< 0 $FunctionContextHeight) (and (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass._module.SeqOp)) (<= (LitInt 0) |n#0@@0|)))) ($Is SeqType (_module.SeqOp.S5 this@@0 |n#0@@0|) (TSeq TReal)))
 :qid |Comprehensionsdfy.117:12|
 :skolemid |599|
 :pattern ( (_module.SeqOp.S5 this@@0 |n#0@@0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@1 T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.SeqOp.S5#canCall| this@@1 |n#0@@1|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.SeqOp) ($IsAlloc refType this@@1 Tclass._module.SeqOp $Heap@@0)))) (<= (LitInt 0) |n#0@@1|)))) (= (_module.SeqOp.S5 this@@1 |n#0@@1|) (|Seq#Create| TReal $Heap@@0 |n#0@@1| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#53| 20 2.5 this@@1 _module.SeqOp.x) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#82| this@@1))))) ($LS $LZ))))))
 :qid |Comprehensionsdfy.117:12|
 :skolemid |601|
 :pattern ( (_module.SeqOp.S5 this@@1 |n#0@@1|) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@2 T@U) (|n#0@@2| Int) ) (!  (=> (or (|_module.SeqOp.S5#canCall| (Lit refType this@@2) (LitInt |n#0@@2|)) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.SeqOp) ($IsAlloc refType this@@2 Tclass._module.SeqOp $Heap@@1)))) (<= (LitInt 0) |n#0@@2|)))) (= (_module.SeqOp.S5 (Lit refType this@@2) (LitInt |n#0@@2|)) (|Seq#Create| TReal $Heap@@1 (LitInt |n#0@@2|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#53| 20 2.5 (Lit refType this@@2) _module.SeqOp.x) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#82| (Lit refType this@@2)))))) ($LS $LZ))))))
 :qid |Comprehensionsdfy.117:12|
 :weight 3
 :skolemid |603|
 :pattern ( (_module.SeqOp.S5 (Lit refType this@@2) (LitInt |n#0@@2|)) ($IsGoodHeap $Heap@@1))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.SeqOp.S5)
...
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((|seqinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| |n#0@@3|)) (Requires1 TInt TReal $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#53| 20 2.5 this@@3 _module.SeqOp.x) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#82| this@@3))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0|))))
 ...
 :qid |Comprehensionsdfy.118:5|
 :skolemid |606|
))) (= (_module.SeqOp.S5 this@@3 |n#0@@3|) (|Seq#Create| TReal $Heap@@2 |n#0@@3| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#53| 20 2.5 this@@3 _module.SeqOp.x) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#82| this@@3))))) ($LS $LZ)))))) (and ($Is SeqType (_module.SeqOp.S5 this@@3 |n#0@@3|) (TSeq TReal)) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|))))
