...
(assert (forall ((h@@4 T@U) (a@@2 T@U) ) (! (forall ((i@@1 Int) ) (!  (=> (and (<= 0 i@@1) (< i@@1 (|Seq#Length| (|Seq#FromArray| h@@4 a@@2)))) (= (|Seq#Index| (|Seq#FromArray| h@@4 a@@2) i@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h@@4 a@@2) (IndexField i@@1))))
 :qid |DafnyPreludebpl.1328:11|
 :skolemid |262|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h@@4 a@@2) (IndexField i@@1)))
 :pattern ( (|Seq#Index| (|Seq#FromArray| h@@4 a@@2) i@@1))
))
 :qid |DafnyPreludebpl.1326:15|
 :skolemid |263|
 :pattern ( (|Seq#FromArray| h@@4 a@@2))
)))
(assert (forall ((a@@3 T@U) (b T@U) ) (!  (=> (|MultiSet#Equal| a@@3 b) (= a@@3 b))
 :qid |DafnyPreludebpl.1054:15|
 :skolemid |209|
 :pattern ( (|MultiSet#Equal| a@@3 b))
)))
...
(assert (forall ((a@@4 T@U) (b@@0 T@U) (c T@U) ) (!  (=> (or (not (= a@@4 c)) (not true)) (=> (and ($HeapSucc a@@4 b@@0) ($HeapSucc b@@0 c)) ($HeapSucc a@@4 c)))
 :qid |DafnyPreludebpl.606:15|
 :skolemid |117|
 :pattern ( ($HeapSucc a@@4 b@@0) ($HeapSucc b@@0 c))
)))
...
(assert (forall ((h0 T@U) (h1 T@U) (a@@6 T@U) ) (!  (=> (and (and (and ($IsGoodHeap h0) ($IsGoodHeap h1)) ($HeapSucc h0 h1)) (= (MapType0Select refType (MapType0Type FieldType BoxType) h0 a@@6) (MapType0Select refType (MapType0Type FieldType BoxType) h1 a@@6))) (= (|Seq#FromArray| h0 a@@6) (|Seq#FromArray| h1 a@@6)))
 :qid |DafnyPreludebpl.1338:15|
 :skolemid |264|
 :pattern ( (|Seq#FromArray| h1 a@@6) ($HeapSucc h0 h1))
)))
(assert (forall ((h@@5 T@U) (a@@7 T@U) ) (! (= (|Seq#Length| (|Seq#FromArray| h@@5 a@@7)) (_System.array.Length a@@7))
 :qid |DafnyPreludebpl.1323:15|
 :skolemid |261|
 :pattern ( (|Seq#Length| (|Seq#FromArray| h@@5 a@@7)))
)))
...
(assert (forall ((a@@8 T@U) (x@@13 T@U) (y@@0 T@U) ) (!  (=> (< 0 (|MultiSet#Multiplicity| a@@8 y@@0)) (< 0 (|MultiSet#Multiplicity| (|MultiSet#UnionOne| a@@8 x@@13) y@@0)))
 :qid |DafnyPreludebpl.973:15|
 :skolemid |194|
 :pattern ( (|MultiSet#UnionOne| a@@8 x@@13) (|MultiSet#Multiplicity| a@@8 y@@0))
)))
...
(assert (forall ((a@@9 T@U) (x@@14 T@U) (o@@2 T@U) ) (! (= (< 0 (|MultiSet#Multiplicity| (|MultiSet#UnionOne| a@@9 x@@14) o@@2))  (or (= o@@2 x@@14) (< 0 (|MultiSet#Multiplicity| a@@9 o@@2))))
 :qid |DafnyPreludebpl.963:15|
 :skolemid |192|
 :pattern ( (|MultiSet#Multiplicity| (|MultiSet#UnionOne| a@@9 x@@14) o@@2))
)))
(assert (forall ((a@@10 T@U) (b@@1 T@U) ) (! (= (|MultiSet#Equal| a@@10 b@@1) (forall ((o@@3 T@U) ) (! (= (|MultiSet#Multiplicity| a@@10 o@@3) (|MultiSet#Multiplicity| b@@1 o@@3))
 ...
 :skolemid |208|
 :pattern ( (|MultiSet#Equal| a@@10 b@@1))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.test9)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 37) (let ((anon12_correct true))
(let ((anon10_correct  (=> (and (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| |limit#0|)) (not (or (= |k#0@0| |i#0|) (= |k#0@0| |j#0|)))) (and (=> (= (ControlFlow 0 3) (- 0 8)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (and (<= 0 |k#0@0|) (< |k#0@0| (_System.array.Length |a#0|)))) (=> (and (<= 0 |k#0@0|) (< |k#0@0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 5)) ($IsAlloc refType |a#0| (Tclass._System.array? TInt) $Heap)) (=> ($IsAlloc refType |a#0| (Tclass._System.array? TInt) $Heap) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 |k#0@0|) (< |k#0@0| (_System.array.Length |a#0|)))) (=> (and (<= 0 |k#0@0|) (< |k#0@0| (_System.array.Length |a#0|))) (=> (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField |k#0@0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |k#0@0|))))) (= (ControlFlow 0 3) 1)) anon12_correct))))))))))))))
(let ((anon17_Else_correct  (=> (and (< |k#0@0| (LitInt 0)) (= (ControlFlow 0 10) 3)) anon10_correct)))
(let ((anon17_Then_correct  (=> (and (<= (LitInt 0) |k#0@0|) (= (ControlFlow 0 9) 3)) anon10_correct)))
(let ((anon16_Else_correct  (=> (and (=> (and (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| |limit#0|)) (not (or (= |k#0@0| |i#0|) (= |k#0@0| |j#0|)))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField |k#0@0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |k#0@0|)))))) (= (ControlFlow 0 2) 1)) anon12_correct)))
(let ((anon7_correct  (=> (and (and (and (and (<= (LitInt 0) |i#0|) (< |i#0| |j#0|)) (< |j#0| |limit#0|)) (<= |limit#0| (_System.array.Length |a#0|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6)) (= $o@@6 |a#0|)))
 :qid |MultiSetsdfy.81:8|
 :skolemid |526|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6))
)) ($HeapSucc $Heap $Heap@0)))) (and (=> (= (ControlFlow 0 11) (- 0 28)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 11) (- 0 27)) (and (<= 0 (LitInt 0)) (<= (LitInt 0) (_System.array.Length |a#0|)))) (=> (and (<= 0 (LitInt 0)) (<= (LitInt 0) (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 11) (- 0 26)) (and (<= (LitInt 0) |limit#0|) (<= |limit#0| (_System.array.Length |a#0|)))) (=> (and (<= (LitInt 0) |limit#0|) (<= |limit#0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 11) (- 0 25)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 11) (- 0 24)) ($IsAlloc refType |a#0| (Tclass._System.array? TInt) $Heap)) (=> ($IsAlloc refType |a#0| (Tclass._System.array? TInt) $Heap) (and (=> (= (ControlFlow 0 11) (- 0 23)) (and (<= 0 (LitInt 0)) (<= (LitInt 0) (_System.array.Length |a#0|)))) (=> (and (<= 0 (LitInt 0)) (<= (LitInt 0) (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 11) (- 0 22)) (and (<= (LitInt 0) |limit#0|) (<= |limit#0| (_System.array.Length |a#0|)))) (=> (and (<= (LitInt 0) |limit#0|) (<= |limit#0| (_System.array.Length |a#0|))) (=> (|MultiSet#Equal| (|MultiSet#FromSeq| (|Seq#Drop| (|Seq#Take| (|Seq#FromArray| $Heap@0 |a#0|) |limit#0|) (LitInt 0))) (|MultiSet#FromSeq| (|Seq#Drop| (|Seq#Take| (|Seq#FromArray| $Heap |a#0|) |limit#0|) (LitInt 0)))) (and (=> (= (ControlFlow 0 11) (- 0 21)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 11) (- 0 20)) (and (<= 0 |j#0|) (< |j#0| (_System.array.Length |a#0|)))) (=> (and (<= 0 |j#0|) (< |j#0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 11) (- 0 19)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 11) (- 0 18)) ($IsAlloc refType |a#0| (Tclass._System.array? TInt) $Heap)) (=> ($IsAlloc refType |a#0| (Tclass._System.array? TInt) $Heap) (and (=> (= (ControlFlow 0 11) (- 0 17)) (and (<= 0 |i#0|) (< |i#0| (_System.array.Length |a#0|)))) (=> (and (<= 0 |i#0|) (< |i#0| (_System.array.Length |a#0|))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField |j#0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#0|))))) (and (=> (= (ControlFlow 0 11) (- 0 16)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 11) (- 0 15)) (and (<= 0 |i#0|) (< |i#0| (_System.array.Length |a#0|)))) (=> (and (<= 0 |i#0|) (< |i#0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 11) (- 0 14)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 11) (- 0 13)) ($IsAlloc refType |a#0| (Tclass._System.array? TInt) $Heap)) (=> ($IsAlloc refType |a#0| (Tclass._System.array? TInt) $Heap) (and (=> (= (ControlFlow 0 11) (- 0 12)) (and (<= 0 |j#0|) (< |j#0| (_System.array.Length |a#0|)))) (=> (and (<= 0 |j#0|) (< |j#0| (_System.array.Length |a#0|))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField |i#0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |j#0|))))) (and (and (=> (= (ControlFlow 0 11) 2) anon16_Else_correct) (=> (= (ControlFlow 0 11) 9) anon17_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon17_Else_correct))))))))))))))))))))))))))))))))))))))))))
(let ((anon15_Else_correct  (=> (and (not (and (and (<= (LitInt 0) |i#0|) (< |i#0| |j#0|)) (< |j#0| |limit#0|))) (= (ControlFlow 0 31) 11)) anon7_correct)))
(let ((anon15_Then_correct  (=> (and (and (<= (LitInt 0) |i#0|) (< |i#0| |j#0|)) (< |j#0| |limit#0|)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (= (ControlFlow 0 29) 11) anon7_correct))))))
(let ((anon14_Else_correct  (=> (not (and (<= (LitInt 0) |i#0|) (< |i#0| |j#0|))) (and (=> (= (ControlFlow 0 33) 29) anon15_Then_correct) (=> (= (ControlFlow 0 33) 31) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (and (<= (LitInt 0) |i#0|) (< |i#0| |j#0|)) (and (=> (= (ControlFlow 0 32) 29) anon15_Then_correct) (=> (= (ControlFlow 0 32) 31) anon15_Else_correct)))))
(let ((anon13_Else_correct  (=> (< |i#0| (LitInt 0)) (and (=> (= (ControlFlow 0 35) 32) anon14_Then_correct) (=> (= (ControlFlow 0 35) 33) anon14_Else_correct)))))
(let ((anon13_Then_correct  (=> (<= (LitInt 0) |i#0|) (and (=> (= (ControlFlow 0 34) 32) anon14_Then_correct) (=> (= (ControlFlow 0 34) 33) anon14_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#6| null $Heap alloc |a#0|)) (and (=> (= (ControlFlow 0 36) 34) anon13_Then_correct) (=> (= (ControlFlow 0 36) 35) anon13_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 37) 36))) anon0_correct))))
