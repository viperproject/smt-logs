...
(set-info :boogie-vc-id Impl$$FiftyShadesOfGhost.__default.L)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) |defass#c#0|) (=> |defass#c#0| (and (=> (= (ControlFlow 0 2) (- 0 3)) |defass#d#0|) (=> |defass#d#0| (=> (= (ControlFlow 0 2) (- 0 1)) |defass#h#0|))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (=> |defass#c#0| (= (Mod |c#0@@1| (LitInt 2)) (LitInt 1))) (= (Mod |g#0| (LitInt 2)) (LitInt 1)))) (and (and (=> |defass#d#0| (and ($Is refType |d#0| Tclass.FiftyShadesOfGhost.H) ($IsAlloc refType |d#0| Tclass.FiftyShadesOfGhost.H $Heap))) (=> |defass#h#0| (and ($Is refType |h#0| Tclass.FiftyShadesOfGhost.H) ($IsAlloc refType |h#0| Tclass.FiftyShadesOfGhost.H $Heap)))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 2)))) anon0_correct)))
