...
(assert (forall (($prevHeap@@2 T@U) ($h0 T@U) ($h1 T@U) (this@@0 T@U) (|d#0@@0| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass.Hof.D))) (or (|Hof.D.P#canCall| $prevHeap@@2 $h0 this@@0 |d#0@@0|) ($Is refType |d#0@@0| Tclass.Hof.D))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@3 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@3 null)) (not true)) (= $o@@3 |d#0@@0|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@3) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@3) $f@@0)))
 :qid |unknown.0:0|
 :skolemid |2538|
...
(assert (forall (($h@@2 T@U) ($o@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (or (not (= $o@@4 null)) (not true)) (= (dtype $o@@4) Tclass.Hof.D?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@4) Hof.D.data)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2536|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@4) Hof.D.data)))
)))
...
(set-info :boogie-vc-id CheckWellformed$$Hof.D.P)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= |d#0@@2| null)) (not true))) (=> (or (not (= |d#0@@2| null)) (not true)) (=> (and (and (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |d#0@@2| Hof.D.data))) (= (Hof.D.P $Heap@@1 current$Heap this@@2 |d#0@@2|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |d#0@@2|) Hof.D.data))))) (and ($Is intType (int_2_U (Hof.D.P $Heap@@1 current$Heap this@@2 |d#0@@2|)) TInt) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass.Hof.D) ($IsAlloc refType this@@2 Tclass.Hof.D previous$Heap)))) (=> (and (and (and ($Is refType |d#0@@2| Tclass.Hof.D) ($IsAlloc refType |d#0@@2| Tclass.Hof.D previous$Heap)) (= 1 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@1) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 6) 5))) anon0_correct))))
