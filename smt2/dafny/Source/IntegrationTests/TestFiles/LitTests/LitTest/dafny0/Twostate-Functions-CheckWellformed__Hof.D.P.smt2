...
(assert (forall (($prevHeap@@2 T@U) ($h0 T@U) ($h1 T@U) (this@@0 T@U) (|d#0@@0| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass.Hof.D))) (or (|Hof.D.P#canCall| $prevHeap@@2 $h0 this@@0 |d#0@@0|) ($Is refType |d#0@@0| Tclass.Hof.D))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@3 T@U) ($f@@0 T@U) )  (=> (and (or (not (= $o@@3 null)) (not true)) (= $o@@3 |d#0@@0|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@3) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@3) $f@@0)))) (= (Hof.D.P $prevHeap@@2 $h0 this@@0 |d#0@@0|) (Hof.D.P $prevHeap@@2 $h1 this@@0 |d#0@@0|))))
