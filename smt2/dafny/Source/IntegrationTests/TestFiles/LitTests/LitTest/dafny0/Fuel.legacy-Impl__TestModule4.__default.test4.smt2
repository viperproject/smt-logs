...
(let ((anon12_Else_correct  (=> (forall ((|t#0_1| Int) )  (=> (> |t#0_1| 0) (U_2_bool (Lit boolType (bool_2_U true))))) (and (=> (= (ControlFlow 0 8) 7) anon14_Then_correct) (=> (= (ControlFlow 0 8) 2) anon11_correct)))))
