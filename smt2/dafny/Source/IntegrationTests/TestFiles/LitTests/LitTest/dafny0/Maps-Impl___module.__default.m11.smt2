...
(declare-fun _module._default.m11$U () T@U)
(declare-fun _module._default.m11$V () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.m11)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|Set#Disjoint| (|Map#Domain| |a#0|) (|Map#Domain| |b#0|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is MapType |a#0| (TMap _module._default.m11$U _module._default.m11$V)) ($IsAlloc MapType |a#0| (TMap _module._default.m11$U _module._default.m11$V) $Heap))) (=> (and (and (and ($Is MapType |b#0| (TMap _module._default.m11$U _module._default.m11$V)) ($IsAlloc MapType |b#0| (TMap _module._default.m11$U _module._default.m11$V) $Heap)) (= 0 $FunctionContextHeight)) (and (forall ((|i#1| T@U) ) (!  (=> ($IsBox |i#1| _module._default.m11$U) (not (and (|Set#IsMember| (|Map#Domain| |a#0|) |i#1|) (|Set#IsMember| (|Map#Domain| |b#0|) |i#1|))))
 :qid |Mapsdfy.140:20|
 :skolemid |594|
 :pattern ( (|Set#IsMember| (|Map#Domain| |b#0|) |i#1|))
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#0|) |i#1|))
