...
(assert (forall (($h0 T@U) ($h1 T@U) (this T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this null)) (not true)) ($Is refType this Tclass.Wellformedness.Iter1))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@6 T@U) ($f T@U) )  (=> (and (or (not (= $o@@6 null)) (not true)) (or (or (= $o@@6 this) (|Set#IsMember| (Wellformedness.Iter1.__reads this) ($Box refType $o@@6))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 this) Wellformedness.Iter1.__new)) ($Box refType $o@@6)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@6) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@6) $f)))) (= (Wellformedness.Iter1.Valid $h0 this) (Wellformedness.Iter1.Valid $h1 this))))
...
(assert (forall (($h@@3 T@U) ($o@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (or (not (= $o@@7 null)) (not true)) (= (dtype $o@@7) Tclass.Wellformedness.Iter1?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@7) Wellformedness.Iter1.__new)) (TSet Tclass._System.object?)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@7) Wellformedness.Iter1.__new)))
)))
(assert (forall (($h@@4 T@U) ($o@@8 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@4) (and (or (not (= $o@@8 null)) (not true)) (= (dtype $o@@8) Tclass.Wellformedness.Iter1?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@8) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@8) Wellformedness.Iter1.__new)) (TSet Tclass._System.object?) $h@@4))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@8) Wellformedness.Iter1.__new)))
)))
...
(assert (forall (($h@@5 T@U) ($o@@10 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@5) (and (or (not (= $o@@10 null)) (not true)) (= (dtype $o@@10) Tclass.Wellformedness.Iter1?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@10) alloc)))) ($IsAlloc intType (int_2_U (Wellformedness.Iter1.x $o@@10)) TInt $h@@5))
 :pattern ( (Wellformedness.Iter1.x $o@@10) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@10) alloc)))
)))
(assert (forall (($h@@6 T@U) ($o@@11 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@6) (and (or (not (= $o@@11 null)) (not true)) (= (dtype $o@@11) Tclass.Wellformedness.Iter1?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@11) alloc)))) ($IsAlloc intType (int_2_U (Wellformedness.Iter1.z $o@@11)) TInt $h@@6))
 :pattern ( (Wellformedness.Iter1.z $o@@11) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@11) alloc)))
)))
(assert (forall (($h@@7 T@U) ($o@@12 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@7) (and (or (not (= $o@@12 null)) (not true)) (= (dtype $o@@12) Tclass.Wellformedness.Iter1?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@12) alloc)))) ($IsAlloc intType (int_2_U (Wellformedness.Iter1.__decreases0 $o@@12)) TInt $h@@7))
 :pattern ( (Wellformedness.Iter1.__decreases0 $o@@12) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@12) alloc)))
)))
(assert (forall (($h@@8 T@U) ($o@@13 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@8) (and (or (not (= $o@@13 null)) (not true)) (= (dtype $o@@13) Tclass.Wellformedness.Iter1?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@13) alloc)))) ($IsAlloc intType (int_2_U (Wellformedness.Iter1.__decreases1 $o@@13)) TInt $h@@8))
 :pattern ( (Wellformedness.Iter1.__decreases1 $o@@13) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@13) alloc)))
)))
