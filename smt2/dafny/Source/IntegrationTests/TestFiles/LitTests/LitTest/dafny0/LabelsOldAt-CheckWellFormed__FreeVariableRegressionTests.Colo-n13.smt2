...
(assert (distinct TInt TagInt alloc allocName Tagclass.FreeVariableRegressionTests.C Tagclass.FreeVariableRegressionTests.Color class.FreeVariableRegressionTests.C? Tagclass.FreeVariableRegressionTests.C? tytagFamily$C tytagFamily$Color field$x)
)
(assert (= (FDim alloc) 0))
...
(assert (forall (($h@@2 T@U) ($o@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (or (not (= $o@@2 null)) (not true)) (= (dtype $o@@2) Tclass.FreeVariableRegressionTests.C?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@2) FreeVariableRegressionTests.C.x)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |717|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@2) FreeVariableRegressionTests.C.x)))
)))
...
(assert (forall ((d T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) ($Is DatatypeTypeType d Tclass.FreeVariableRegressionTests.Color)) ($IsAlloc DatatypeTypeType d Tclass.FreeVariableRegressionTests.Color $h@@3))
 :qid |unknown.0:0|
 :skolemid |725|
 :pattern ( ($IsAlloc DatatypeTypeType d Tclass.FreeVariableRegressionTests.Color $h@@3))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$FreeVariableRegressionTests.Color.DatatypeSaysEight)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= |c#0@@1| null)) (not true))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is DatatypeTypeType this Tclass.FreeVariableRegressionTests.Color) ($IsAlloc DatatypeTypeType this Tclass.FreeVariableRegressionTests.Color $Heap))) (and (and ($Is refType |c#0@@1| Tclass.FreeVariableRegressionTests.C) ($IsAlloc refType |c#0@@1| Tclass.FreeVariableRegressionTests.C $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
