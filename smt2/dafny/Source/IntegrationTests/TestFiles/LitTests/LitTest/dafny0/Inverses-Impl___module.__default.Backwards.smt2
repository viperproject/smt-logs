...
(set-info :boogie-vc-id Impl$$_module.__default.Backwards)
...
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (_System.array.Length $nw@0) |n#0|)) (=> (= (_System.array.Length $nw@0) |n#0|) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|i#1| Int) ) (!  (=> (and (<= (LitInt 0) |i#1|) (< |i#1| |n#0|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (IndexField |i#1|)))) (LitInt 0)))
 :qid |Inversesdfy.163:18|
 :skolemid |637|
...
(let ((anon5_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) ($HeapSucc $Heap@0 $Heap@1)) (and (and (forall (($o@@6 T@U) ($f@@0 T@U) ) (!  (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@6) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) $f@@0)) (exists ((|i#0_2| Int) ) (!  (and (and (and (<= (LitInt 0) |i#0_2|) (< |i#0_2| |n#0|)) (= $o@@6 $nw@0)) (= $f@@0 (IndexField (- (- |n#0| 1) |i#0_2|))))
 :qid |Inversesdfy.166:10|
 :skolemid |639|
)))
 :qid |Inversesdfy.166:3|
 :skolemid |640|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@6) $f@@0))
)) (forall ((|i#inv#0_0| Int) ) (!  (=> (and (<= (LitInt 0) (- (- |n#0| 1) |i#inv#0_0|)) (< (- (- |n#0| 1) |i#inv#0_0|) |n#0|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |i#inv#0_0|)) ($Box intType (int_2_U (LitInt 0)))))
 :qid |Inversesdfy.166:10|
 :skolemid |641|
