...
(let ((anon10_Then_correct  (=> (and (< (|char#ToInt| ($Unbox charType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.CharChar.c))) (|char#ToInt| |ch#0@@1|)) ($IsAllocBox ($Box refType this@@1) Tclass._module.CharChar? $Heap@@1)) (=> (and (and (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@1 _module.CharChar.c))) (= |##ch#0@0| ($Unbox charType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.CharChar.c)))) (and ($IsAlloc charType |##ch#0@0| TChar $Heap@@1) (= |b$reqreads#2@0| (forall (($o@@7 T@U) ($f@@1 T@U) )  (=> (and (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@7) alloc)))) (= $o@@7 this@@1)) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@7 $f@@1))))))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (and (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType this@@1)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@1))) (not (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType this@@1)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@1))))) (and (|Set#Equal| (|Set#UnionOne| |Set#Empty| ($Box refType this@@1)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@1))) (< (|char#ToInt| |##ch#0@0|) (|char#ToInt| |ch#0@@1|))))) (=> (or (and (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType this@@1)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@1))) (not (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType this@@1)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@1))))) (and (|Set#Equal| (|Set#UnionOne| |Set#Empty| ($Box refType this@@1)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@1))) (< (|char#ToInt| |##ch#0@0|) (|char#ToInt| |ch#0@@1|)))) (=> (and (and (|_module.CharChar.Recurse#canCall| $Heap@@1 this@@1 ($Unbox charType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.CharChar.c))) (= (_module.CharChar.Recurse ($LS $LZ) $Heap@@1 this@@1 |ch#0@@1|) (_module.CharChar.Recurse ($LS $LZ) $Heap@@1 this@@1 ($Unbox charType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.CharChar.c))))) (and (|_module.CharChar.Recurse#canCall| $Heap@@1 this@@1 ($Unbox charType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.CharChar.c))) ($Is boolType (bool_2_U (_module.CharChar.Recurse ($LS $LZ) $Heap@@1 this@@1 |ch#0@@1|)) TBool))) (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#1@0|) (=> |b$reqreads#1@0| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#2@0|))))))))))))
