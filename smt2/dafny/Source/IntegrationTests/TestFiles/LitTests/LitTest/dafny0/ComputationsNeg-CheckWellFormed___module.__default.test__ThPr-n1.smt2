...
(declare-fun |##step#0@0| () Int)
(declare-fun |##t#0@0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.test__ThProperty)
...
(assert (not
 ...
 :qid |ComputationsNegdfy.21:14|
 :skolemid |557|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0))
)) ($HeapSuccGhost $Heap $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($Is intType (int_2_U (LitInt 10)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 10)) Tclass._System.nat) (=> (= |##step#0@0| (LitInt 10)) (=> (and (and ($IsAlloc intType (int_2_U |##step#0@0|) Tclass._System.nat $Heap@0) (= |##t#0@0| (Lit DatatypeTypeType (|#_module.Nat.Succ| (Lit DatatypeTypeType |#_module.Nat.Zero|))))) (and ($IsAlloc DatatypeTypeType |##t#0@0| Tclass._module.Nat $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)))))))))
