...
(assert  (=> (< 0 $FunctionContextHeight) (forall (($o@@3 T@U) ) (!  (=> ($IsBox $o@@3 Tclass._module.Opaque) ($Is intType (int_2_U (_module.Opaque.y $o@@3)) TInt))
 :qid |unknown.0:0|
 :skolemid |537|
 :pattern ( (_module.Opaque.y $o@@3))
))))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.Opaque.Two)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null current$Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 10)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (= (_System.array.Length |a#0|) (LitInt 100)) (and (=> (= (ControlFlow 0 2) (- 0 9)) ($IsAllocBox this Tclass._module.Opaque $Heap)) (=> ($IsAllocBox this Tclass._module.Opaque $Heap) (and (=> (= (ControlFlow 0 2) (- 0 8)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 7)) ($IsAlloc refType |a#0| (Tclass._System.array? TInt) $Heap)) (=> ($IsAlloc refType |a#0| (Tclass._System.array? TInt) $Heap) (and (=> (= (ControlFlow 0 2) (- 0 6)) (and (<= 0 (LitInt 3)) (< (LitInt 3) (_System.array.Length |a#0|)))) (=> (and (<= 0 (LitInt 3)) (< (LitInt 3) (_System.array.Length |a#0|))) (=> (= (+ (_module.Opaque.y this) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField (LitInt 3)))))) (_module.Opaque.y this)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType |a#0| (Tclass._System.array? TInt) $Heap)) (=> ($IsAlloc refType |a#0| (Tclass._System.array? TInt) $Heap) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 (LitInt 3)) (< (LitInt 3) (_System.array.Length |a#0|)))) (=> (and (<= 0 (LitInt 3)) (< (LitInt 3) (_System.array.Length |a#0|))) (=> (= (ControlFlow 0 2) (- 0 1)) ($IsAllocBox this Tclass._module.Opaque $Heap)))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($IsBox this Tclass._module.Opaque) ($IsAllocBox this Tclass._module.Opaque previous$Heap))) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) previous$Heap)) (= 2 $FunctionContextHeight)) (and (and (= previous$Heap $Heap) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (and ($IsAlloc refType |a#0| (Tclass._System.array TInt) previous$Heap) (= (ControlFlow 0 11) 2)))) anon0_correct))))
