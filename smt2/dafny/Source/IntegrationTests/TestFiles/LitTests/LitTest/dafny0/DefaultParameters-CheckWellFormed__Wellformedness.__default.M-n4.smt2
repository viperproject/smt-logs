...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let (($generated@@107  (=> (= $generated@@99 ($generated@@63 $generated@@100 $generated@@101 $generated@@5 false)) (=> (and (= $generated@@102 ($generated@@46 8)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= $generated@@103 0)) (not true))))))
(let (($generated@@108  (=> (and (and ($generated@@104 $generated@@101) ($generated@@105 $generated@@101)) (and (= 0 $generated@@106) (= (ControlFlow 0 3) 2))) $generated@@107)))
$generated@@108)))
))
(check-sat)
