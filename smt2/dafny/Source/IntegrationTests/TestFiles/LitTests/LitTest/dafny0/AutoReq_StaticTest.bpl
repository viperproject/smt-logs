...
axiom {:id "id214"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    StaticTest.__default.f#canCall(x#0) || (0 < $FunctionContextHeight && x#0 > 3)
...
axiom {:id "id215"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    StaticTest.__default.f#canCall(LitInt(x#0))
...
procedure {:verboseName "StaticTest.f (well-formedness)"} CheckWellformed$$StaticTest.__default.f(x#0: int);
...
axiom {:id "id218"} 1 <= $FunctionContextHeight
   ==> (forall z#0: int :: 
    { StaticTest.__default.g(z#0) } 
    StaticTest.__default.g#canCall(z#0)
         || (1 < $FunctionContextHeight && z#0 > 3 && StaticTest.__default.f(z#0))
   ...
   ==> (forall z#0: int :: 
    ...
    StaticTest.__default.g#canCall(LitInt(z#0))
         || (1 < $FunctionContextHeight
           && 
          Lit(z#0 > 3)
           && Lit(StaticTest.__default.f(LitInt(z#0))))
...
procedure {:verboseName "StaticTest.g (well-formedness)"} CheckWellformed$$StaticTest.__default.g(z#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "StaticTest.g (well-formedness)"} CheckWellformed$$StaticTest.__default.g(z#0: int)
{
  ...
  var ##x#0: int;
    ...
    assume {:id "id220"} z#0 > 3;
    ##x#0 := z#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#0, TInt, $Heap);
    assert {:id "id221"} {:subsumption 0} ##x#0 > 3;
    assume ##x#0 > 3;
    assume StaticTest.__default.f#canCall(z#0);
    assume {:id "id222"} StaticTest.__default.f(z#0);
    ...
    else
    {
        ...
        assume {:id "id223"} StaticTest.__default.g(z#0) == Lit(true);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(StaticTest.__default.g(z#0), TBool);
        return;
...
axiom {:id "id224"} 2 <= $FunctionContextHeight
   ==> (forall y#0: int :: 
    { StaticTest.__default.h(y#0) } 
    StaticTest.__default.h#canCall(y#0)
         || (2 < $FunctionContextHeight && y#0 > 3 && StaticTest.__default.f(y#0))
...
axiom {:id "id225"} 2 <= $FunctionContextHeight
   ==> (forall y#0: int :: 
    ...
    StaticTest.__default.h#canCall(LitInt(y#0))
         || (2 < $FunctionContextHeight
           && 
          Lit(y#0 > 3)
           && Lit(StaticTest.__default.f(LitInt(y#0))))
...
procedure {:verboseName "StaticTest.h (well-formedness)"} CheckWellformed$$StaticTest.__default.h(y#0: int);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "StaticTest.h (well-formedness)"} CheckWellformed$$StaticTest.__default.h(y#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var ##x#0: int;
  var ##z#0: int;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    // Check well-formedness of preconditions, and then assume them
    assume {:id "id226"} y#0 > 3;
    ##x#0 := y#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#0, TInt, $Heap);
    assert {:id "id227"} {:subsumption 0} ##x#0 > 3;
    assume ##x#0 > 3;
    assume StaticTest.__default.f#canCall(y#0);
    assume {:id "id228"} StaticTest.__default.f(y#0);
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    ...
    else
    {
        ...
        ##z#0 := y#0;
        // assume allocatedness for argument to function
        assume $IsAlloc(##z#0, TInt, $Heap);
        assert {:id "id229"} {:subsumption 0} ##z#0 > 3;
        assume ##z#0 > 3;
        assert {:id "id230"} {:subsumption 0} StaticTest.__default.f#canCall(##z#0)
           ==> StaticTest.__default.f(##z#0) || ##z#0 > 7;
        assume StaticTest.__default.f(##z#0);
        assume StaticTest.__default.g#canCall(y#0);
        assume {:id "id231"} StaticTest.__default.h(y#0) == StaticTest.__default.g(y#0);
        assume StaticTest.__default.g#canCall(y#0);
        // CheckWellformedWithResult: any expression
        assume $Is(StaticTest.__default.h(y#0), TBool);
        return;
...
procedure {:verboseName "StaticTest.IsEven (well-formedness)"} CheckWellformed$$StaticTest.__default.IsEven(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "StaticTest.EvenDoubler (well-formedness)"} CheckWellformed$$StaticTest.__default.EvenDoubler(x#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
axiom {:id "id233"} 2 <= $FunctionContextHeight
   ==> (forall y#0: int :: 
    ...
    StaticTest.__default.test#canCall(y#0)
         || (2 < $FunctionContextHeight && StaticTest.__default.IsEven(y#0))
...
axiom {:id "id234"} 2 <= $FunctionContextHeight
   ==> (forall y#0: int :: 
    ...
    StaticTest.__default.test#canCall(LitInt(y#0))
         || (2 < $FunctionContextHeight && StaticTest.__default.IsEven(LitInt(y#0)))
...
procedure {:verboseName "StaticTest.test (well-formedness)"} CheckWellformed$$StaticTest.__default.test(y#0: int);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "StaticTest.test (well-formedness)"} CheckWellformed$$StaticTest.__default.test(y#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var ##x#0: int;
  var ##x#1: int;
    ...
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#0, TInt, $Heap);
    assume StaticTest.__default.IsEven#canCall(y#0);
    assume {:id "id235"} StaticTest.__default.IsEven(y#0);
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    ...
    else
    {
        ...
        assert {:id "id236"} {:subsumption 0} StaticTest.__default.IsEven(##x#1);
        assume StaticTest.__default.IsEven(##x#1);
        assume StaticTest.__default.EvenDoubler#canCall(y#0);
        assume {:id "id237"} StaticTest.__default.test(y#0) == StaticTest.__default.EvenDoubler(y#0);
        assume StaticTest.__default.EvenDoubler#canCall(y#0);
        // CheckWellformedWithResult: any expression
        assume $Is(StaticTest.__default.test(y#0), TInt);
        return;
