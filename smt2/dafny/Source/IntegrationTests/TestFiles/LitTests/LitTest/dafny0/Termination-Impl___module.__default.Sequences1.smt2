...
(declare-fun _module._default.Sequences1$_T0 () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.Sequences1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon8_Else_correct  (=> (not (|Seq#Equal| |Seq#Empty| |s#0@0|)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |s#0@0|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |s#0@0|))) (=> (and (= |s#0@1| (|Seq#Drop| |s#0@0| (LitInt 1))) (= (ControlFlow 0 5) (- 0 4))) (< (|Seq#Rank| |s#0@1|) (|Seq#Rank| |s#0@0|))))))))
...
(let ((anon6_LoopHead_correct  (=> (and (and (and ($Is SeqType |s#0@0| (TSeq _module._default.Sequences1$_T0)) ($IsAlloc SeqType |s#0@0| (TSeq _module._default.Sequences1$_T0) $Heap)) (not false)) (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |Terminationdfy.855:3|
 :skolemid |3272|
...
)) (<= (|Seq#Rank| |s#0@0|) (|Seq#Rank| |S#0|))))) (and (=> (= (ControlFlow 0 9) 1) anon6_LoopDone_correct) (=> (= (ControlFlow 0 9) 8) anon6_LoopBody_correct)))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 10) 9)) anon6_LoopHead_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SeqType |S#0| (TSeq _module._default.Sequences1$_T0)) ($IsAlloc SeqType |S#0| (TSeq _module._default.Sequences1$_T0) $Heap))) (=> (and (and (and ($Is SeqType |s#0| (TSeq _module._default.Sequences1$_T0)) ($IsAlloc SeqType |s#0| (TSeq _module._default.Sequences1$_T0) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct))))
