...
(set-info :boogie-vc-id Impl$$JustMethods.__default.SomeMethod)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 0 $FunctionContextHeight)) (and (U_2_bool (Lit boolType (bool_2_U true))) (= (ControlFlow 0 3) 2))) anon0_correct)))
