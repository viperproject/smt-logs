...
(set-info :boogie-vc-id Impl$$EagerTypeAssignmentOfBoundVariables.__default.MatchIt0)
...
(let ((anon3_Then_correct  (=> (= |r#0| (|#EagerTypeAssignmentOfBoundVariables.Record.Record| |_mcc#0#0_0@0|)) (=> (and (<= (LitInt 0) |_mcc#0#0_0@0|) (<= (LitInt 0) |n#0_0@0|)) (=> (and (and (= |let#0_0#0#0| |_mcc#0#0_0@0|) ($Is intType (int_2_U |let#0_0#0#0|) Tclass._System.nat)) (and (= |n#0_0@0| |let#0_0#0#0|) (= (ControlFlow 0 2) (- 0 1)))) (<= (LitInt 0) (- |n#0_0@0| 10)))))))
