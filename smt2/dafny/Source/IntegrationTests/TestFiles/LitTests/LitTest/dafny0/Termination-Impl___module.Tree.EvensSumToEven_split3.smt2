...
(set-info :boogie-vc-id Impl$$_module.Tree.EvensSumToEven_split3)
...
(assert (not
 ...
 :qid |Terminationdfy.490:49|
 :skolemid |3664|
 :pattern ( (_module.Tree.Sum ($LS $LZ) |$ih#this0#0|))
 :pattern ( (_module.Tree.Elements ($LS $LZ) |$ih#this0#0|))
)))) (and (and (or (not (= this@@6 |#_module.Tree.Empty|)) (not true)) (= this@@6 (|#_module.Tree.Node| |_mcc#0#0_0@0| |_mcc#1#0_0@0| |_mcc#2#0_0@0|))) (and ($Is DatatypeTypeType |_mcc#1#0_0@0| Tclass._module.Tree) ($Is DatatypeTypeType |_mcc#2#0_0@0| Tclass._module.Tree))))) (=> (and (and (and (and (and ($Is DatatypeTypeType |right#0_0@0| Tclass._module.Tree) ($IsAlloc DatatypeTypeType |right#0_0@0| Tclass._module.Tree $Heap@0)) (= |let#0_0#0#0| |_mcc#2#0_0@0|)) (and ($Is DatatypeTypeType |let#0_0#0#0| Tclass._module.Tree) (= |right#0_0@0| |let#0_0#0#0|))) (and (and ($Is DatatypeTypeType |left#0_0@0| Tclass._module.Tree) ($IsAlloc DatatypeTypeType |left#0_0@0| Tclass._module.Tree $Heap@0)) (and (= |let#0_1#0#0| |_mcc#1#0_0@0|) ($Is DatatypeTypeType |let#0_1#0#0| Tclass._module.Tree)))) (and (and (and (and (= |left#0_0@0| |let#0_1#0#0|) (= |let#0_2#0#0| |_mcc#0#0_0@0|)) (and ($Is intType (int_2_U |let#0_2#0#0|) TInt) (= |x#0_0@0| |let#0_2#0#0|))) (and (and ($IsAllocBox ($Box DatatypeTypeType this@@6) Tclass._module.Tree $Heap@0) (|_module.Tree.Elements#canCall| this@@6)) (and (|_module.Tree.Elements#canCall| this@@6) (|Set#IsMember| (_module.Tree.Elements ($LS $LZ) this@@6) ($Box intType (int_2_U |x#0_0@0|)))))) (and (and (and (< (DtRank |left#0_0@0|) (DtRank this@@6)) (forall ((|u#1@@0| T@U) ) (!  (=> (|Set#IsMember| (_module.Tree.Elements ($LS ($LS $LZ)) |left#0_0@0|) ($Box intType |u#1@@0|)) (= (Mod (U_2_int |u#1@@0|) (LitInt 2)) (LitInt 0)))
 :qid |Terminationdfy.491:21|
 :skolemid |3659|
 :pattern ( (|Set#IsMember| (_module.Tree.Elements ($LS ($LS $LZ)) |left#0_0@0|) ($Box intType |u#1@@0|)))
))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1))) (and (and (|_module.Tree.Sum#canCall| |left#0_0@0|) (= (Mod (_module.Tree.Sum ($LS ($LS $LZ)) |left#0_0@0|) (LitInt 2)) (LitInt 0))) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 2) (- 0 1))))))) (< (DtRank |right#0_0@0|) (DtRank this@@6)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
