...
)))) (and (and (forall ((|i#0_2@@0| Int) )  (=> (and (<= (LitInt 0) |i#0_2@@0|) (< |i#0_2@@0| (_System.array.Length |a#0|))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@0) (IndexField (Mod (+ |i#0_2@@0| 1) (_System.array.Length |a#0|)))) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (_module.__default.Id |i#0_2@@0|)))))) (= $Heap@2 $Heap@1)) (and (= |r#0@0| $nw@0) (= (ControlFlow 0 5) 2)))) GeneratedUnifiedExit_correct)))
(let ((anon12_Else_correct  (=> (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? _module._default.RotateA$T))) (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc)))) (= (_System.array.Length $nw@0) (_System.array.Length |a#0|)))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (forall ((|arrayinit#0#i0#0| Int) )  (=> (and (<= 0 |arrayinit#0#i0#0|) (< |arrayinit#0#i0#0| (_System.array.Length |a#0|))) (Requires1 TInt _module._default.RotateA$T $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| |a#0|) (|lambda#3| TInt (LitInt 0) (_System.array.Length |a#0|)) (|lambda#5| (SetRef_to_SetBox (|lambda#4| |a#0|))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0|)))))) (=> (and (and (forall ((|arrayinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0@@0|) (< |arrayinit#0#i0#0@@0| (_System.array.Length |a#0|))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) (IndexField |arrayinit#0#i0#0@@0|)) (Apply1 TInt _module._default.RotateA$T $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| |a#0|) (|lambda#3| TInt (LitInt 0) (_System.array.Length |a#0|)) (|lambda#5| (SetRef_to_SetBox (|lambda#4| |a#0|))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0@@0|)))))
