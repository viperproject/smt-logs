...
procedure {:verboseName "ITER_D.RecursiveIterator._ctor (well-formedness)"} CheckWellFormed$$ITER__D.RecursiveIterator.__ctor(n#0: int where LitInt(0) <= n#0, 
    r#0: ref
...
procedure {:verboseName "ITER_D.RecursiveIterator._ctor (call)"} Call$$ITER__D.RecursiveIterator.__ctor(n#0: int where LitInt(0) <= n#0, 
    r#0: ref
       where $Is(r#0, Tclass.ITER__D.RecIterCaller?())
         && $IsAlloc(r#0, Tclass.ITER__D.RecIterCaller?(), $Heap), 
    good#0: bool)
  ...
  requires {:id "id206"} r#0 != null;
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id207"} ITER__D.RecursiveIterator.n(this) == n#0;
  free ensures true;
  ensures {:id "id208"} ITER__D.RecursiveIterator.r(this) == r#0;
  free ensures true;
  ensures {:id "id209"} ITER__D.RecursiveIterator.good(this) == good#0;
  free ensures ITER__D.RecursiveIterator.Valid#canCall($Heap, this);
  ensures {:id "id210"} ITER__D.RecursiveIterator.Valid($Heap, this);
  free ensures true;
  ensures {:id "id211"} Set#Equal(ITER__D.RecursiveIterator.__reads(this), Set#Empty(): Set);
  free ensures true;
  ensures {:id "id212"} Set#Equal(ITER__D.RecursiveIterator.__modifies(this), Set#Empty(): Set);
  free ensures true;
  ensures {:id "id213"} Set#Equal($Unbox(read($Heap, this, ITER__D.RecursiveIterator.__new)): Set, 
    Set#Empty(): Set);
  free ensures true;
  ensures {:id "id214"} ITER__D.RecursiveIterator.__decreases0(this) == n#0;
  free ensures true;
  ensures {:id "id215"} ITER__D.RecursiveIterator.__decreases1(this) == r#0;
  free ensures true;
  ensures {:id "id216"} ITER__D.RecursiveIterator.__decreases2(this) == good#0;
...
procedure {:verboseName "ITER_D.RecursiveIterator.Valid (well-formedness)"} CheckWellformed$$ITER__D.RecursiveIterator.Valid(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__D.RecursiveIterator())
         && $IsAlloc(this, Tclass.ITER__D.RecursiveIterator(), $Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ITER_D.RecursiveIterator.Valid (well-formedness)"} CheckWellformed$$ITER__D.RecursiveIterator.Valid(this: ref)
{
  ...
  var b$reqreads#0: bool;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool
         ==> $o == this
           || Set#IsMember(ITER__D.RecursiveIterator.__reads(this), $Box($o))
           || Set#IsMember($Unbox(read($Heap, this, ITER__D.RecursiveIterator.__new)): Set, $Box($o)));
    // Check well-formedness of preconditions, and then assume them
    // Check well-formedness of the reads clause
    b$reqreads#0 := $_ReadsFrame[this, ITER__D.RecursiveIterator.__new];
...
procedure {:verboseName "ITER_D.RecursiveIterator.MoveNext (call)"} Call$$ITER__D.RecursiveIterator.MoveNext(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__D.RecursiveIterator())
         && $IsAlloc(this, Tclass.ITER__D.RecursiveIterator(), $Heap))
   returns (more#0: bool);
  // user-defined preconditions
  requires {:id "id218"} ITER__D.RecursiveIterator.Valid($Heap, this);
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id219"} (forall $o: ref :: 
      { $o != null } 
      Set#IsMember($Unbox(read($Heap, this, ITER__D.RecursiveIterator.__new)): Set, $Box($o))
           && !Set#IsMember($Unbox(read(old($Heap), this, ITER__D.RecursiveIterator.__new)): Set, $Box($o))
         ==> $o != null)
     && (forall $o: ref :: 
      ...
      Set#IsMember($Unbox(read($Heap, this, ITER__D.RecursiveIterator.__new)): Set, $Box($o))
         ...
         ==> !$Unbox(read(old($Heap), $o, alloc)): bool);
  free ensures true;
  ensures {:id "id220"} !Set#IsMember($Unbox(read($Heap, this, ITER__D.RecursiveIterator.__new)): Set, $Box(null));
  free ensures more#0 ==> ITER__D.RecursiveIterator.Valid#canCall($Heap, this);
  ensures {:id "id221"} more#0 ==> ITER__D.RecursiveIterator.Valid($Heap, this);
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
    $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
       ==> $Heap[$o] == old($Heap)[$o]
         || 
        $o == this
         || Set#IsMember(ITER__D.RecursiveIterator.__modifies(this), $Box($o))
         || Set#IsMember($Unbox(read(old($Heap), this, ITER__D.RecursiveIterator.__new)): Set, $Box($o)));
  // boilerplate
  free ensures $HeapSucc(old($Heap), $Heap);
...
procedure {:verboseName "ITER_D.RecursiveIterator (correctness)"} Impl$$ITER__D.RecursiveIterator(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__D.RecursiveIterator())
         && $IsAlloc(this, Tclass.ITER__D.RecursiveIterator(), $Heap), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ITER_D.RecursiveIterator (correctness)"} Impl$$ITER__D.RecursiveIterator(this: ref, n#0: int, r#0: ref, good#0: bool)
{
  ...
  var n##0: int;
  var incomparable##0: Set;
  var $iter_newUpdate1_0_0: Set;
  var $initHeapCallStmt#1_1_0: Heap;
  var n##1: int;
  var incomparable##1: Set;
  var $iter_newUpdate1_1_0: Set;

    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> $o == this);
    assume {:id "id234"} r#0 != null;
    assume {:id "id235"} ITER__D.RecursiveIterator.n(this) == n#0;
    assume {:id "id236"} ITER__D.RecursiveIterator.r(this) == r#0;
    assume {:id "id237"} ITER__D.RecursiveIterator.good(this) == good#0;
    assume {:id "id238"} ITER__D.RecursiveIterator.Valid($Heap, this);
    assume {:id "id239"} Set#Equal(ITER__D.RecursiveIterator.__reads(this), Set#Empty(): Set);
    assume {:id "id240"} Set#Equal(ITER__D.RecursiveIterator.__modifies(this), Set#Empty(): Set);
    assume {:id "id241"} Set#Equal($Unbox(read($Heap, this, ITER__D.RecursiveIterator.__new)): Set, 
      Set#Empty(): Set);
    assume {:id "id242"} ITER__D.RecursiveIterator.__decreases0(this) == n#0;
    assume {:id "id243"} ITER__D.RecursiveIterator.__decreases1(this) == r#0;
    assume {:id "id244"} ITER__D.RecursiveIterator.__decreases2(this) == good#0;
    assume _yieldCount#0 == 0;
    call $YieldHavoc(this, ITER__D.RecursiveIterator.__reads(this), $Unbox(read($Heap, this, ITER__D.RecursiveIterator.__new)): Set);
    $_OldIterHeap := $Heap;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Iterators.dfy(313,5)
    assume true;
    ...
    {
        // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Iterators.dfy(314,12)
        assume true;
        if (ITER__D.RecursiveIterator.good(this))
        {
            // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Iterators.dfy(315,10)
            $initHeapCallStmt#1_0_0 := $Heap;
            // TrCallStmt: Before ProcessCallStmt
            assume true;
            assert {:id "id245"} ITER__D.RecursiveIterator.r(this) != null;
            assume true;
            // ProcessCallStmt: CheckSubrange
            assert {:id "id246"} $Is(ITER__D.RecursiveIterator.n(this) - 1, Tclass._System.nat());
            n##0 := ITER__D.RecursiveIterator.n(this) - 1;
            assume true;
            // ProcessCallStmt: CheckSubrange
            incomparable##0 := Lit(Set#Empty(): Set);
            assert {:id "id247"} 0 <= n#0 || n##0 == n#0;
            assert {:id "id248"} n##0 < n#0;
            call {:id "id249"} Call$$ITER__D.RecIterCaller.M(ITER__D.RecursiveIterator.r(this), n##0, incomparable##0);
            // TrCallStmt: After ProcessCallStmt
            call $iter_newUpdate1_0_0 := $IterCollectNewObjects($initHeapCallStmt#1_0_0, $Heap, this, ITER__D.RecursiveIterator.__new);
            $Heap := update($Heap, this, ITER__D.RecursiveIterator.__new, $Box($iter_newUpdate1_0_0));
            assume $IsGoodHeap($Heap);
        }
        else
        {
            // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Iterators.dfy(317,10)
            $initHeapCallStmt#1_1_0 := $Heap;
            // TrCallStmt: Before ProcessCallStmt
            assume true;
            assert {:id "id250"} ITER__D.RecursiveIterator.r(this) != null;
            assume true;
            // ProcessCallStmt: CheckSubrange
            assert {:id "id251"} $Is(ITER__D.RecursiveIterator.n(this) + 1, Tclass._System.nat());
            n##1 := ITER__D.RecursiveIterator.n(this) + 1;
            assume true;
            // ProcessCallStmt: CheckSubrange
            incomparable##1 := Lit(Set#Empty(): Set);
            assert {:id "id252"} 0 <= n#0 || n##1 == n#0;
            assert {:id "id253"} n##1 < n#0;
            call {:id "id254"} Call$$ITER__D.RecIterCaller.M(ITER__D.RecursiveIterator.r(this), n##1, incomparable##1);
            // TrCallStmt: After ProcessCallStmt
            call $iter_newUpdate1_1_0 := $IterCollectNewObjects($initHeapCallStmt#1_1_0, $Heap, this, ITER__D.RecursiveIterator.__new);
            $Heap := update($Heap, this, ITER__D.RecursiveIterator.__new, $Box($iter_newUpdate1_1_0));
            assume $IsGoodHeap($Heap);
        }
    }
}
...
procedure {:verboseName "ITER_D.RecIterCaller.M (well-formedness)"} CheckWellFormed$$ITER__D.RecIterCaller.M(this: ref
       where this != null
         && 
...
procedure {:verboseName "ITER_D.RecIterCaller.M (call)"} Call$$ITER__D.RecIterCaller.M(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__D.RecIterCaller())
         && $IsAlloc(this, Tclass.ITER__D.RecIterCaller(), $Heap), 
...
procedure {:verboseName "ITER_D.RecIterCaller.M (correctness)"} Impl$$ITER__D.RecIterCaller.M(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__D.RecIterCaller())
         && $IsAlloc(this, Tclass.ITER__D.RecIterCaller(), $Heap), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ITER_D.RecIterCaller.M (correctness)"} Impl$$ITER__D.RecIterCaller.M(this: ref, n#0: int, incomparable#0: Set) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var good#0: bool;
  ...
  var iter#0: ref
     where defass#iter#0
       ==> $Is(iter#0, Tclass.ITER__D.RecursiveIterator())
  ...
  var $rhs##0: bool;
    ...
    $_reverifyPost := false;
    havoc good#0;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Iterators.dfy(325,16)
    assume true;
    // ----- init call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Iterators.dfy(325,19)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    n##0 := n#0;
    ...
    // ProcessCallStmt: CheckSubrange
    good##0 := good#0;
    call {:id "id255"} $nw := Call$$ITER__D.RecursiveIterator.__ctor(n##0, r##0, good##0);
    // TrCallStmt: After ProcessCallStmt
    iter#0 := $nw;
    defass#iter#0 := true;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Iterators.dfy(326,32)
    assume true;
    // TrCallStmt: Adding lhs with type bool
    // TrCallStmt: Before ProcessCallStmt
    assert {:id "id257"} defass#iter#0;
    assume true;
    assert {:id "id258"} iter#0 != null;
    assert {:id "id259"} (forall $o: ref, $f: Field :: 
      $o != null
           && $Unbox(read($Heap, $o, alloc)): bool
           && (
            $o == iter#0
             || Set#IsMember(ITER__D.RecursiveIterator.__modifies(iter#0), $Box($o))
             || Set#IsMember($Unbox(read($Heap, iter#0, ITER__D.RecursiveIterator.__new)): Set, $Box($o)))
         ==> $_ModifiesFrame[$o, $f]);
    assert {:id "id260"} 0 <= n#0 || ITER__D.RecursiveIterator.__decreases0(iter#0) == n#0;
    assert {:id "id261"} ITER__D.RecursiveIterator.__decreases0(iter#0) < n#0;
    call {:id "id262"} $rhs##0 := Call$$ITER__D.RecursiveIterator.MoveNext(iter#0);
    // TrCallStmt: After ProcessCallStmt
    more#0 := $rhs##0;
}
