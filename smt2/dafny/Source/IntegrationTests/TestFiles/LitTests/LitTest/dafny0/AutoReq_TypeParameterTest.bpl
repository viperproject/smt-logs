...
axiom {:id "id247"} 0 <= $FunctionContextHeight
   ==> (forall TypeParameterTest.MyClass$X: Ty, 
      TypeParameterTest.MyClass.P$W: Ty, 
      this: ref, 
      s#0: Seq :: 
...
procedure {:verboseName "TypeParameterTest.MyClass.P (well-formedness)"} CheckWellformed$$TypeParameterTest.MyClass.P(TypeParameterTest.MyClass$X: Ty, 
    TypeParameterTest.MyClass.P$W: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass.TypeParameterTest.MyClass(TypeParameterTest.MyClass$X))
         && $IsAlloc(this, Tclass.TypeParameterTest.MyClass(TypeParameterTest.MyClass$X), $Heap), 
...
procedure {:verboseName "TypeParameterTest.MyClass.g (well-formedness)"} CheckWellformed$$TypeParameterTest.MyClass.g(TypeParameterTest.MyClass$X: Ty, 
    TypeParameterTest.MyClass.g$Z: Ty, 
    this: ref
       where this != null
         && 
...
axiom {:id "id256"} 2 <= $FunctionContextHeight
   ==> (forall TypeParameterTest.MyClass$X: Ty, 
      TypeParameterTest.MyClass.h$Y: Ty, 
      this: ref, 
      s#0: Seq :: 
...
axiom {:id "id257"} 2 <= $FunctionContextHeight
   ==> (forall TypeParameterTest.MyClass$X: Ty, 
      TypeParameterTest.MyClass.h$Y: Ty, 
      this: ref, 
      s#0: Seq :: 
...
axiom {:id "id258"} 2 <= $FunctionContextHeight
   ==> (forall TypeParameterTest.MyClass$X: Ty, 
      TypeParameterTest.MyClass.h$Y: Ty, 
      this: ref, 
      s#0: Seq :: 
...
procedure {:verboseName "TypeParameterTest.MyClass.h (well-formedness)"} CheckWellformed$$TypeParameterTest.MyClass.h(TypeParameterTest.MyClass$X: Ty, 
    TypeParameterTest.MyClass.h$Y: Ty, 
    this: ref
       where this != null
         && 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TypeParameterTest.MyClass.h (well-formedness)"} CheckWellformed$$TypeParameterTest.MyClass.h(TypeParameterTest.MyClass$X: Ty, 
    TypeParameterTest.MyClass.h$Y: Ty, 
    this: ref, 
    s#0: Seq)
{
  ...
  var ##s#1: Seq;
    ...
    assume TypeParameterTest.MyClass.P#canCall(TypeParameterTest.MyClass$X, 
      Tclass._System.Tuple3(TypeParameterTest.MyClass$X, 
        TInt, 
        Tclass._System.Tuple2(TypeParameterTest.MyClass$X, TypeParameterTest.MyClass.h$Y)), 
      this, 
      s#0);
    assume {:id "id260"} TypeParameterTest.MyClass.P(TypeParameterTest.MyClass$X, 
      Tclass._System.Tuple3(TypeParameterTest.MyClass$X, 
        TInt, 
        Tclass._System.Tuple2(TypeParameterTest.MyClass$X, TypeParameterTest.MyClass.h$Y)), 
      this, 
    ...
    else
    {
        ...
        assert {:id "id261"} {:subsumption 0} TypeParameterTest.MyClass.P#canCall(TypeParameterTest.MyClass$X, 
            Tclass._System.Tuple3(TypeParameterTest.MyClass$X, 
              TInt, 
              Tclass._System.Tuple2(TypeParameterTest.MyClass$X, TypeParameterTest.MyClass.h$Y)), 
            this, 
           ...
           ==> TypeParameterTest.MyClass.P(TypeParameterTest.MyClass$X, 
              ...
              ##s#1)
             || Lit(true);
        assume TypeParameterTest.MyClass.P(TypeParameterTest.MyClass$X, 
          Tclass._System.Tuple3(TypeParameterTest.MyClass$X, 
            TInt, 
            Tclass._System.Tuple2(TypeParameterTest.MyClass$X, TypeParameterTest.MyClass.h$Y)), 
          this, 
          ##s#1);
        assume TypeParameterTest.MyClass.g#canCall(TypeParameterTest.MyClass$X, 
          Tclass._System.Tuple2(TypeParameterTest.MyClass$X, TypeParameterTest.MyClass.h$Y), 
          this, 
          s#0);
        assume {:id "id262"} TypeParameterTest.MyClass.h(TypeParameterTest.MyClass$X, TypeParameterTest.MyClass.h$Y, this, s#0)
           == TypeParameterTest.MyClass.g(TypeParameterTest.MyClass$X, 
            Tclass._System.Tuple2(TypeParameterTest.MyClass$X, TypeParameterTest.MyClass.h$Y), 
            this, 
            s#0);
        ...
        assume $Is(TypeParameterTest.MyClass.h(TypeParameterTest.MyClass$X, TypeParameterTest.MyClass.h$Y, this, s#0), 
          TBool);
        return;
