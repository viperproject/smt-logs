...
(declare-fun Basic.U.H1 (T@U T@U T@U) Int)
(declare-fun Lit (T@T T@U) T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |Basic.U.H1#canCall| (T@U T@U T@U) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap T@U) ($Heap T@U) (|u#0| T@U) ) (!  (=> (or (|Basic.U.H1#canCall| $prevHeap $Heap (Lit refType |u#0|)) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap) ($IsGoodHeap $Heap)) ($HeapSucc $prevHeap $Heap)) ($Is refType |u#0| Tclass.Basic.U)))) (= (Basic.U.H1 $prevHeap $Heap (Lit refType |u#0|)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap (Lit refType |u#0|)) Basic.U.aa)))))
 :qid |TwostateFunctionsdfy.16:30|
 :weight 3
 :skolemid |602|
 :pattern ( (Basic.U.H1 $prevHeap $Heap (Lit refType |u#0|)) ($IsGoodHeap $Heap))
))))
...
(assert (forall (($prevHeap@@0 T@U) ($h0 T@U) ($h1 T@U) (|u#0@@0| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|Basic.U.H1#canCall| $prevHeap@@0 $h0 |u#0@@0|) ($Is refType |u#0@@0| Tclass.Basic.U))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@2 T@U) ($f T@U) ) (! true
 :qid |unknown.0:0|
 :skolemid |597|
)) (= (Basic.U.H1 $prevHeap@@0 $h0 |u#0@@0|) (Basic.U.H1 $prevHeap@@0 $h1 |u#0@@0|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |598|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (Basic.U.H1 $prevHeap@@0 $h1 |u#0@@0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@1 T@U) ($Heap@@0 T@U) (|u#0@@1| T@U) ) (!  (=> (or (|Basic.U.H1#canCall| $prevHeap@@1 $Heap@@0 |u#0@@1|) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@1) ($IsGoodHeap $Heap@@0)) ($HeapSucc $prevHeap@@1 $Heap@@0)) ($Is refType |u#0@@1| Tclass.Basic.U)))) (= (Basic.U.H1 $prevHeap@@1 $Heap@@0 |u#0@@1|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@1 |u#0@@1|) Basic.U.aa)))))
 :qid |TwostateFunctionsdfy.16:30|
 :skolemid |601|
 :pattern ( (Basic.U.H1 $prevHeap@@1 $Heap@@0 |u#0@@1|) ($IsGoodHeap $Heap@@0))
))))
...
(set-info :boogie-vc-id CheckWellformed$$Basic.U.H1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= |u#0@@2| null)) (not true))) (=> (or (not (= |u#0@@2| null)) (not true)) (=> (= (ControlFlow 0 3) (- 0 2)) ($IsAlloc refType |u#0@@2| Tclass.Basic.U $Heap@@1))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (and ($Is refType |u#0@@2| Tclass.Basic.U) ($IsAlloc refType |u#0@@2| Tclass.Basic.U current$Heap)) (= 1 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@1) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 6) 5))) anon0_correct))))
