...
(assert (forall (($prevHeap@@0 T@U) ($h0 T@U) ($h1 T@U) (|u#0@@0| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|Basic.U.H1#canCall| $prevHeap@@0 $h0 |u#0@@0|) ($Is refType |u#0@@0| Tclass.Basic.U))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@2 T@U) ($f T@U) ) true) (= (Basic.U.H1 $prevHeap@@0 $h0 |u#0@@0|) (Basic.U.H1 $prevHeap@@0 $h1 |u#0@@0|))))
