...
(let ((anon12_correct  (and (=> (= (ControlFlow 0 8) (- 0 10)) (exists ((|$as#x0_0#0_0| T@U) )  (and ($IsBox |$as#x0_0#0_0| _module._default.SetsST2$Y) (|Set#IsMember| |s#0@0| |$as#x0_0#0_0|)))) (=> (exists ((|$as#x0_0#0_0@@0| T@U) )  (and ($IsBox |$as#x0_0#0_0@@0| _module._default.SetsST2$Y) (|Set#IsMember| |s#0@0| |$as#x0_0#0_0@@0|))) (=> (and (=> true (and ($IsBox |x#0_0@1| _module._default.SetsST2$Y) ($IsAllocBox |x#0_0@1| _module._default.SetsST2$Y $Heap))) (|Set#IsMember| |s#0@0| |x#0_0@1|)) (and (=> (= (ControlFlow 0 8) (- 0 9)) true) (and (=> (= (ControlFlow 0 8) 3) anon23_Then_correct) (=> (= (ControlFlow 0 8) 5) anon23_Else_correct))))))))
