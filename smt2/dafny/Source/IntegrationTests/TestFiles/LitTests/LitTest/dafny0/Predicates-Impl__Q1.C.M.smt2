...
(declare-fun Q1.C.P (T@U T@U) Bool)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |Q1.C.P#canCall| (T@U T@U) Bool)
...
(assert (distinct alloc Tagclass.Q1.C? Tagclass.Q1.C tytagFamily$C)
)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) ) (!  (=> (or (|Q1.C.P#canCall| $Heap this) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass.Q1.C) ($IsAlloc refType this Tclass.Q1.C $Heap)))))) (= (Q1.C.P $Heap this) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |Predicatesdfy.87:21|
 :skolemid |3076|
 :pattern ( (Q1.C.P $Heap this) ($IsGoodHeap $Heap))
))))
...
(set-info :boogie-vc-id Impl$$Q1.C.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc this@@0)) (= (ControlFlow 0 2) (- 0 1))) false) (forall ((|c#1| T@U) ) (!  (=> ($Is refType |c#1| Tclass.Q1.C) (=> ($IsAllocBox ($Box refType |c#1|) Tclass.Q1.C $Heap@@0) (Q1.C.P $Heap@@0 |c#1|)))
 :qid |Predicatesdfy.94:22|
 :skolemid |3083|
 :pattern ( (Q1.C.P $Heap@@0 |c#1|))
)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass.Q1.C) ($IsAlloc refType this@@0 Tclass.Q1.C $Heap@@0))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
