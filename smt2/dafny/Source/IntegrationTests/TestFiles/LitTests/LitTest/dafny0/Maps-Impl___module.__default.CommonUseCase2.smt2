...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon7_correct  (and (=> (= (ControlFlow 0 5) (- 0 8)) (or (exists ((|$as#v0_0#0_0| T@U) )  (and ($Is refType null Tclass._module.MyClass) (|Set#IsMember| (|Map#Items| |m#1@0|) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box refType null) ($Box bv3Type |$as#v0_0#0_0|)))))) (exists ((|$as#k0_0#0_0| T@U) (|$as#v0_0#0_0@@0| T@U) )  (and (and ($Is refType |$as#k0_0#0_0| Tclass._module.MyClass) ($IsAlloc refType |$as#k0_0#0_0| Tclass._module.MyClass $Heap)) (|Set#IsMember| (|Map#Items| |m#1@0|) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box refType |$as#k0_0#0_0|) ($Box bv3Type |$as#v0_0#0_0@@0|)))))))) (=> (or (exists ((|$as#v0_0#0_0@@1| (_ BitVec 3)) )  (and ($Is refType null Tclass._module.MyClass) (|Set#IsMember| (|Map#Items| |m#1@0|) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box refType null) ($Box bv3Type (bv3_2_U |$as#v0_0#0_0@@1|))))))) (exists ((|$as#k0_0#0_0@@0| T@U) (|$as#v0_0#0_0@@2| (_ BitVec 3)) )  (and (and ($Is refType |$as#k0_0#0_0@@0| Tclass._module.MyClass) ($IsAlloc refType |$as#k0_0#0_0@@0| Tclass._module.MyClass $Heap)) (|Set#IsMember| (|Map#Items| |m#1@0|) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box refType |$as#k0_0#0_0@@0|) ($Box bv3Type (bv3_2_U |$as#v0_0#0_0@@2|)))))))) (=> (and (=> true (and ($Is refType |k#0_0@1| Tclass._module.MyClass) ($IsAlloc refType |k#0_0@1| Tclass._module.MyClass $Heap))) (|Set#IsMember| (|Map#Items| |m#1@0|) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box refType |k#0_0@1|) ($Box bv3Type (bv3_2_U |v#0_0@1|)))))) (and (=> (= (ControlFlow 0 5) (- 0 7)) ($Is intType (int_2_U (+ |s#0@1| (nat_from_bv3 |v#0_0@1|))) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ |s#0@1| (nat_from_bv3 |v#0_0@1|))) Tclass._System.nat) (=> (= |s#0@2| (+ |s#0@1| (nat_from_bv3 |v#0_0@1|))) (and (=> (= (ControlFlow 0 5) (- 0 6)) true) (=> (and (= |m#1@1| (|Map#Subtract| |m#1@0| (|Set#UnionOne| |Set#Empty| ($Box refType |k#0_0@1|)))) (= (ControlFlow 0 5) (- 0 4))) (and (|Set#Subset| (|Map#Domain| |m#1@1|) |$decr$loop#00@1|) (not (|Set#Subset| |$decr$loop#00@1| (|Map#Domain| |m#1@1|))))))))))))))
