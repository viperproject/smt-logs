...
(assert (distinct TagSet TagMap alloc Tagclass._System.nat |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass._module.MyClass Tagclass._module.MyClass? tytagFamily$nat |tytagFamily$_tuple#2| tytagFamily$MyClass)
)
...
(assert (forall ((b@@2 (_ BitVec 3)) ) (!  (and (and (<= 0 (nat_from_bv3 b@@2)) (< (nat_from_bv3 b@@2) 8)) (= (nat_from_bv3 b@@2) (bv2int b@@2)))
 :qid |unknown.0:0|
 :skolemid |346|
 :pattern ( (nat_from_bv3 b@@2))
)))
...
(assert (forall ((v@@7 T@U) (t0@@1 T@U) (h@@4 T@U) ) (! (= ($IsAlloc SetType v@@7 (TSet t0@@1) h@@4) (forall ((bx@@4 T@U) ) (!  (=> (|Set#IsMember| v@@7 bx@@4) ($IsAllocBox bx@@4 t0@@1 h@@4))
 ...
 :skolemid |68|
 :pattern ( ($IsAlloc SetType v@@7 (TSet t0@@1) h@@4))
)))
...
(assert (forall ((v@@8 T@U) (t0@@2 T@U) (t1@@0 T@U) (h@@5 T@U) ) (! (= ($IsAlloc MapType v@@8 (TMap t0@@2 t1@@0) h@@5) (forall ((bx@@5 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@8) bx@@5) (and ($IsAllocBox (MapType0Select BoxType BoxType (|Map#Elements| v@@8) bx@@5) t1@@0 h@@5) ($IsAllocBox bx@@5 t0@@2 h@@5)))
 :qid |DafnyPreludebpl.318:19|
 :skolemid |75|
 :pattern ( (MapType0Select BoxType BoxType (|Map#Elements| v@@8) bx@@5))
 :pattern ( (|Set#IsMember| (|Map#Domain| v@@8) bx@@5))
)))
 :qid |DafnyPreludebpl.315:15|
 :skolemid |76|
 :pattern ( ($IsAlloc MapType v@@8 (TMap t0@@2 t1@@0) h@@5))
)))
...
(assert (forall ((m@@10 T@U) (v@@10 T@U) ) (! (= (|Set#IsMember| (|Map#Values| m@@10) v@@10) (exists ((u@@6 T@U) ) (!  (and (|Set#IsMember| (|Map#Domain| m@@10) u@@6) (= v@@10 (MapType0Select BoxType BoxType (|Map#Elements| m@@10) u@@6)))
...
(assert (forall ((bx@@10 T@U) ) (!  (=> ($IsBox bx@@10 (TBitvector 3)) (and (= ($Box bv3Type ($Unbox bv3Type bx@@10)) bx@@10) ($Is bv3Type ($Unbox bv3Type bx@@10) (TBitvector 3))))
 :qid |unknown.0:0|
 :skolemid |343|
 :pattern ( ($IsBox bx@@10 (TBitvector 3)))
)))
...
(assert (forall ((v@@11 T@U) (t0@@4 T@U) (t1@@2 T@U) ) (! (= ($Is MapType v@@11 (TMap t0@@4 t1@@2)) (forall ((bx@@11 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@11) bx@@11) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@11) bx@@11) t1@@2) ($IsBox bx@@11 t0@@4)))
 :qid |DafnyPreludebpl.261:19|
 :skolemid |55|
 :pattern ( (MapType0Select BoxType BoxType (|Map#Elements| v@@11) bx@@11))
 :pattern ( (|Set#IsMember| (|Map#Domain| v@@11) bx@@11))
)))
 :qid |DafnyPreludebpl.258:15|
 :skolemid |56|
 :pattern ( ($Is MapType v@@11 (TMap t0@@4 t1@@2)))
)))
...
(assert (forall ((m@@12 T@U) ) (!  (or (= m@@12 |Map#Empty|) (exists ((k@@3 T@U) (v@@12 T@U) ) (! (|Set#IsMember| (|Map#Items| m@@12) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| k@@3 v@@12)))
...
(declare-fun |k#0_0@1| () T@U)
(declare-fun |v#0_0@1| () (_ BitVec 3))
(declare-fun |s#0@1| () Int)
(declare-fun |s#0@2| () Int)
(declare-fun |m#1@1| () T@U)
(declare-fun |$decr$loop#00@1| () T@U)
(declare-fun |k#0_1@1| () T@U)
(declare-fun |$w$loop#0@0| () Bool)
(declare-fun |defass#k#0_0@0| () Bool)
...
(set-info :boogie-vc-id Impl$$_module.__default.CommonUseCase2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon7_correct  (and (=> (= (ControlFlow 0 5) (- 0 8)) (or (exists ((|$as#v0_0#0_0| T@U) ) (!  (and ($Is refType null Tclass._module.MyClass) (|Set#IsMember| (|Map#Items| |m#1@0|) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box refType null) ($Box bv3Type |$as#v0_0#0_0|)))))
 :qid |Mapsdfy.490:12|
 :skolemid |821|
)) (exists ((|$as#k0_0#0_0| T@U) (|$as#v0_0#0_0@@0| T@U) ) (!  (and (and ($Is refType |$as#k0_0#0_0| Tclass._module.MyClass) ($IsAlloc refType |$as#k0_0#0_0| Tclass._module.MyClass $Heap)) (|Set#IsMember| (|Map#Items| |m#1@0|) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box refType |$as#k0_0#0_0|) ($Box bv3Type |$as#v0_0#0_0@@0|)))))
 :qid |Mapsdfy.490:9|
 :skolemid |820|
)))) (=> (or (exists ((|$as#v0_0#0_0@@1| (_ BitVec 3)) ) (!  (and ($Is refType null Tclass._module.MyClass) (|Set#IsMember| (|Map#Items| |m#1@0|) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box refType null) ($Box bv3Type (bv3_2_U |$as#v0_0#0_0@@1|))))))
 :qid |Mapsdfy.490:12|
 :skolemid |821|
)) (exists ((|$as#k0_0#0_0@@0| T@U) (|$as#v0_0#0_0@@2| (_ BitVec 3)) ) (!  (and (and ($Is refType |$as#k0_0#0_0@@0| Tclass._module.MyClass) ($IsAlloc refType |$as#k0_0#0_0@@0| Tclass._module.MyClass $Heap)) (|Set#IsMember| (|Map#Items| |m#1@0|) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box refType |$as#k0_0#0_0@@0|) ($Box bv3Type (bv3_2_U |$as#v0_0#0_0@@2|))))))
 :qid |Mapsdfy.490:9|
 :skolemid |820|
))) (=> (and (=> true (and ($Is refType |k#0_0@1| Tclass._module.MyClass) ($IsAlloc refType |k#0_0@1| Tclass._module.MyClass $Heap))) (|Set#IsMember| (|Map#Items| |m#1@0|) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box refType |k#0_0@1|) ($Box bv3Type (bv3_2_U |v#0_0@1|)))))) (and (=> (= (ControlFlow 0 5) (- 0 7)) ($Is intType (int_2_U (+ |s#0@1| (nat_from_bv3 |v#0_0@1|))) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ |s#0@1| (nat_from_bv3 |v#0_0@1|))) Tclass._System.nat) (=> (= |s#0@2| (+ |s#0@1| (nat_from_bv3 |v#0_0@1|))) (and (=> (= (ControlFlow 0 5) (- 0 6)) true) (=> (and (= |m#1@1| (|Map#Subtract| |m#1@0| (|Set#UnionOne| |Set#Empty| ($Box refType |k#0_0@1|)))) (= (ControlFlow 0 5) (- 0 4))) (and (|Set#Subset| (|Map#Domain| |m#1@1|) |$decr$loop#00@1|) (not (|Set#Subset| |$decr$loop#00@1| (|Map#Domain| |m#1@1|))))))))))))))
(let ((anon11_Else_correct  (=> (and (not (and ($Is refType |k#0_1@1| Tclass._module.MyClass) ($IsAlloc refType |k#0_1@1| Tclass._module.MyClass $Heap))) (= (ControlFlow 0 10) 5)) anon7_correct)))
(let ((anon11_Then_correct  (=> (and (and ($Is refType |k#0_1@1| Tclass._module.MyClass) ($IsAlloc refType |k#0_1@1| Tclass._module.MyClass $Heap)) (= (ControlFlow 0 9) 5)) anon7_correct)))
(let ((anon10_Else_correct  (=> (and (not (|Map#Equal| |m#1@0| |Map#Empty|)) (= |$decr$loop#00@1| (|Map#Domain| |m#1@0|))) (and (=> (= (ControlFlow 0 11) 9) anon11_Then_correct) (=> (= (ControlFlow 0 11) 10) anon11_Else_correct)))))
(let ((anon10_Then_correct true))
(let ((anon9_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 12) 3) anon10_Then_correct) (=> (= (ControlFlow 0 12) 11) anon10_Else_correct)))))
(let ((anon9_Then_correct true))
(let ((anon8_LoopBody_correct  (and (=> (= (ControlFlow 0 13) 2) anon9_Then_correct) (=> (= (ControlFlow 0 13) 12) anon9_Else_correct))))
(let ((anon8_LoopDone_correct true))
(let ((anon8_LoopHead_correct  (=> (and (=> |defass#k#0_0@0| (and ($Is refType |k#0_0@0| Tclass._module.MyClass) ($IsAlloc refType |k#0_0@0| Tclass._module.MyClass $Heap))) (<= (LitInt 0) |s#0@1|)) (=> (and (and (and ($Is MapType |m#1@0| (TMap Tclass._module.MyClass (TBitvector 3))) ($IsAlloc MapType |m#1@0| (TMap Tclass._module.MyClass (TBitvector 3)) $Heap)) (not false)) (and (and (forall (($o@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2)))
 :qid |Mapsdfy.487:3|
 :skolemid |818|
...
)) (|Set#Subset| (|Map#Domain| |m#1@0|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 14) 1) anon8_LoopDone_correct) (=> (= (ControlFlow 0 14) 13) anon8_LoopBody_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 15) (- 0 16)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (= |s#0@0| (LitInt 0)) (=> (and (= |$decr_init$loop#00@0| (|Map#Domain| |m#0|)) (= (ControlFlow 0 15) 14)) anon8_LoopHead_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is MapType |m#0| (TMap Tclass._module.MyClass (TBitvector 3))) ($IsAlloc MapType |m#0| (TMap Tclass._module.MyClass (TBitvector 3)) $Heap)) (<= (LitInt 0) |s#0|)) (=> (and (and (and ($Is MapType |m#1| (TMap Tclass._module.MyClass (TBitvector 3))) ($IsAlloc MapType |m#1| (TMap Tclass._module.MyClass (TBitvector 3)) $Heap)) true) (and (and (=> |defass#k#0_0| (and ($Is refType |k#0_0| Tclass._module.MyClass) ($IsAlloc refType |k#0_0| Tclass._module.MyClass $Heap))) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 17) 15)))) anon0_correct)))))
