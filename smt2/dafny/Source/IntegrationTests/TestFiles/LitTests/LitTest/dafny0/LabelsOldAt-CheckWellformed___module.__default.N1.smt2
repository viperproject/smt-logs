...
(declare-fun _module.__default.N1 (T@U T@U T@U T@U T@U) Bool)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.__default.N1#canCall| (T@U T@U T@U T@U T@U) Bool)
...
(assert (forall (($prevHeap T@U) ($h0 T@U) ($h1 T@U) (|u#0| T@U) (|s#0| T@U) (|t#0| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|_module.__default.N1#canCall| $prevHeap $h0 |u#0| |s#0| |t#0|) (and (and ($Is refType |u#0| Tclass._module.C?) ($Is SetType |s#0| (TSet Tclass._module.C?))) ($Is SeqType |t#0| (TSeq Tclass._module.C?))))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@2 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (= $o@@2 |u#0|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@2) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@2) $f@@0)))
 :qid |unknown.0:0|
 :skolemid |1488|
)) (= (_module.__default.N1 $prevHeap $h0 |u#0| |s#0| |t#0|) (_module.__default.N1 $prevHeap $h1 |u#0| |s#0| |t#0|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1489|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (_module.__default.N1 $prevHeap $h1 |u#0| |s#0| |t#0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@0 T@U) ($Heap T@U) (|u#0@@0| T@U) (|s#0@@0| T@U) (|t#0@@0| T@U) ) (!  (=> (or (|_module.__default.N1#canCall| $prevHeap@@0 $Heap |u#0@@0| |s#0@@0| |t#0@@0|) (and (< 0 $FunctionContextHeight) (and (and (and (and (and ($IsGoodHeap $prevHeap@@0) ($IsGoodHeap $Heap)) ($HeapSucc $prevHeap@@0 $Heap)) ($Is refType |u#0@@0| Tclass._module.C?)) ($Is SetType |s#0@@0| (TSet Tclass._module.C?))) ($Is SeqType |t#0@@0| (TSeq Tclass._module.C?))))) (= (_module.__default.N1 $prevHeap@@0 $Heap |u#0@@0| |s#0@@0| |t#0@@0|)  (and true (forall (($o@@3 T@U) ($f@@1 T@U) ) (!  (=> (or (not (= $o@@3 null)) (not true)) (=> (= $o@@3 |u#0@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@3) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@0 $o@@3) $f@@1))))
 :qid |LabelsOldAtdfy.281:6|
 :skolemid |1492|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@3) $f@@1))
)))))
 :qid |LabelsOldAtdfy.278:20|
 :skolemid |1493|
 :pattern ( (_module.__default.N1 $prevHeap@@0 $Heap |u#0@@0| |s#0@@0| |t#0@@0|) ($IsGoodHeap $Heap))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.N1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon5_correct  (=> (= (_module.__default.N1 $Heap@@0 current$Heap |u#0@@1| |s#0@@1| |t#0@@1|)  (and true (forall (($o@@4 T@U) ($f@@2 T@U) ) (!  (=> (or (not (= $o@@4 null)) (not true)) (=> (= $o@@4 |u#0@@1|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@4) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@4) $f@@2))))
 :qid |LabelsOldAtdfy.281:6|
 :skolemid |1496|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@4) $f@@2))
)))) (=> (and ($Is boolType (bool_2_U (_module.__default.N1 $Heap@@0 current$Heap |u#0@@1| |s#0@@1| |t#0@@1|)) TBool) (= (ControlFlow 0 3) (- 0 2))) |b$reqreads#0@1|))))
(let ((anon8_Else_correct  (=> (not (U_2_bool (Lit boolType (bool_2_U true)))) (=> (and (= |b$reqreads#0@1| true) (= (ControlFlow 0 7) 3)) anon5_correct))))
(let ((anon8_Then_correct  (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (or (not (= |u#0@@1| null)) (not true))) (=> (or (not (= |u#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (=> (or (not (= |u#0@@1| null)) (not true)) ($IsAlloc refType |u#0@@1| Tclass._module.C? $Heap@@0))) (=> (=> (or (not (= |u#0@@1| null)) (not true)) ($IsAlloc refType |u#0@@1| Tclass._module.C? $Heap@@0)) (=> (= |b$reqreads#0@0| (forall (($o@@5 T@U) ($f@@3 T@U) ) (!  (=> (and (and (or (not (= $o@@5 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@5) alloc)))) (= $o@@5 |u#0@@1|)) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@5 $f@@3)))
 :qid |LabelsOldAtdfy.281:16|
 :skolemid |1494|
))) (=> (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= (ControlFlow 0 4) 3)) anon5_correct)))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#3| null current$Heap alloc |u#0@@1|)) (and (and (=> (= (ControlFlow 0 8) 1) anon7_Then_correct) (=> (= (ControlFlow 0 8) 4) anon8_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon8_Else_correct)))))
