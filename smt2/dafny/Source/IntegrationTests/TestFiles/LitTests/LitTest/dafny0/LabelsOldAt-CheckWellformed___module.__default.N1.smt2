...
(assert (forall (($prevHeap T@U) ($h0 T@U) ($h1 T@U) (|u#0| T@U) (|s#0| T@U) (|t#0| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|_module.__default.N1#canCall| $prevHeap $h0 |u#0| |s#0| |t#0|) (and (and ($Is refType |u#0| Tclass._module.C?) ($Is SetType |s#0| (TSet Tclass._module.C?))) ($Is SeqType |t#0| (TSeq Tclass._module.C?))))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@2 T@U) ($f@@0 T@U) )  (=> (and (or (not (= $o@@2 null)) (not true)) (= $o@@2 |u#0|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@2) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@2) $f@@0)))) (= (_module.__default.N1 $prevHeap $h0 |u#0| |s#0| |t#0|) (_module.__default.N1 $prevHeap $h1 |u#0| |s#0| |t#0|))))
