...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon6_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (and ($IsBox |b#0@@3| AnotherTest._default.PickFromPair$U@@4) (and (or (= |b#0@@3| |a#0@@3|) (= |b#0@@3| |b#0@@3|)) (or (not (= |b#0@@3| |a#0@@3|)) (not true)))) (or (and ($IsBox |a#0@@3| AnotherTest._default.PickFromPair$U@@4) (and (or (= |a#0@@3| |a#0@@3|) (= |a#0@@3| |b#0@@3|)) (or (not (= |a#0@@3| |a#0@@3|)) (not true)))) (exists ((|x#3| T@U) )  (and ($IsBox |x#3| AnotherTest._default.PickFromPair$U@@4) (and (or (= |x#3| |a#0@@3|) (= |x#3| |b#0@@3|)) (or (not (= |x#3| |a#0@@3|)) (not true)))))))) (=> (or (and ($IsBox |b#0@@3| AnotherTest._default.PickFromPair$U@@4) (and (or (= |b#0@@3| |a#0@@3|) (= |b#0@@3| |b#0@@3|)) (or (not (= |b#0@@3| |a#0@@3|)) (not true)))) (or (and ($IsBox |a#0@@3| AnotherTest._default.PickFromPair$U@@4) (and (or (= |a#0@@3| |a#0@@3|) (= |a#0@@3| |b#0@@3|)) (or (not (= |a#0@@3| |a#0@@3|)) (not true)))) (exists ((|x#3@@0| T@U) )  (and ($IsBox |x#3@@0| AnotherTest._default.PickFromPair$U@@4) (and (or (= |x#3@@0| |a#0@@3|) (= |x#3@@0| |b#0@@3|)) (or (not (= |x#3@@0| |a#0@@3|)) (not true))))))) (=> (and ($IsBox |x#2@0| AnotherTest._default.PickFromPair$U@@4) ($IsAllocBox |x#2@0| AnotherTest._default.PickFromPair$U@@4 $Heap@@2)) (=> (and (and (and (or (= |x#2@0| |a#0@@3|) (= |x#2@0| |b#0@@3|)) (or (not (= |x#2@0| |a#0@@3|)) (not true))) (and ($IsBox |x#4@0| AnotherTest._default.PickFromPair$U@@4) ($IsAllocBox |x#4@0| AnotherTest._default.PickFromPair$U@@4 $Heap@@2))) (and (and (or (= |x#4@0| |a#0@@3|) (= |x#4@0| |b#0@@3|)) (or (not (= |x#4@0| |a#0@@3|)) (not true))) (= (ControlFlow 0 3) (- 0 2)))) (= |x#2@0| |x#4@0|)))))))
