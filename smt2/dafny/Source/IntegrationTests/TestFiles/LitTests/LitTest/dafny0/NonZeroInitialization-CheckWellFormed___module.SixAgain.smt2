...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let (($generated@@96  (=> (= $generated@@88 ($generated 0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= ($generated 6) $generated@@88)) (=> (<= ($generated 6) $generated@@88) (=> (= (ControlFlow 0 3) (- 0 2)) (<= ($generated 4) ($generated 0))))))))
