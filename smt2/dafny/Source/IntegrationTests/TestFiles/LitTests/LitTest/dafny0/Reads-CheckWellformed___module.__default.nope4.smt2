...
(declare-fun _module.__default.nope4 (T@U T@U T@U) T@U)
(declare-fun |_module.__default.nope4#canCall| (T@U T@U T@U) Bool)
...
(assert (distinct TInt TagInt TagSet alloc allocName |##_System._tuple#0._#Make0| Tagclass._System.Tuple0 Tagclass._module.C Tagclass._module.C? class._module.C? |tytagFamily$_tuple#0| tytagFamily$C field$u)
)
(assert (= (FDim alloc) 0))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (|c#0@@1| T@U) (|xs#0| T@U) ) (!  (=> (or (|_module.__default.nope4#canCall| $Heap |c#0@@1| |xs#0|) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap) (and ($Is refType |c#0@@1| Tclass._module.C) ($IsAlloc refType |c#0@@1| Tclass._module.C $Heap))) (and ($Is SetType |xs#0| (TSet Tclass._module.C)) ($IsAlloc SetType |xs#0| (TSet Tclass._module.C) $Heap))) (=> (not (|Set#IsMember| |xs#0| ($Box refType |c#0@@1|))) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0@@1|) _module.C.u))) 0))))) ($Is DatatypeTypeType (_module.__default.nope4 $Heap |c#0@@1| |xs#0|) Tclass._System.Tuple0))
 :qid |Readsdfy.36:16|
 :skolemid |562|
 :pattern ( (_module.__default.nope4 $Heap |c#0@@1| |xs#0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|c#0@@2| T@U) (|xs#0@@0| T@U) ) (!  (=> (or (|_module.__default.nope4#canCall| $Heap@@0 |c#0@@2| |xs#0@@0|) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@0) ($Is refType |c#0@@2| Tclass._module.C)) ($Is SetType |xs#0@@0| (TSet Tclass._module.C))) (=> (not (|Set#IsMember| |xs#0@@0| ($Box refType |c#0@@2|))) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |c#0@@2|) _module.C.u))) 0))))) (= (_module.__default.nope4 $Heap@@0 |c#0@@2| |xs#0@@0|) (Lit DatatypeTypeType |#_System._tuple#0._#Make0|)))
 :qid |Readsdfy.36:16|
 :skolemid |564|
 :pattern ( (_module.__default.nope4 $Heap@@0 |c#0@@2| |xs#0@@0|) ($IsGoodHeap $Heap@@0))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.nope4)
...
(let ((anon4_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#0@1|) (=> |b$reqreads#0@1| (and (=> (= (ControlFlow 0 3) 1) anon9_Then_correct) (=> (= (ControlFlow 0 3) 2) anon9_Else_correct))))))
(let ((anon8_Else_correct  (=> (=> (not (|Set#IsMember| |xs#0@@1| ($Box refType |c#0@@3|))) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |c#0@@3|) _module.C.u))) 0)) (=> (and (= |b$reqreads#0@1| true) (= (ControlFlow 0 7) 3)) anon4_correct))))
(let ((anon8_Then_correct  (=> (not (|Set#IsMember| |xs#0@@1| ($Box refType |c#0@@3|))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= |c#0@@3| null)) (not true))) (=> (or (not (= |c#0@@3| null)) (not true)) (=> (and (and (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |c#0@@3| _module.C.u))) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |c#0@@3|) _module.C.u))) 0)) (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= (ControlFlow 0 5) 3))) anon4_correct))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#2| null $Heap@@1 alloc |xs#0@@1|)) (and (=> (= (ControlFlow 0 8) 5) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and ($Is refType |c#0@@3| Tclass._module.C) ($Is SetType |xs#0@@1| (TSet Tclass._module.C))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct))))
