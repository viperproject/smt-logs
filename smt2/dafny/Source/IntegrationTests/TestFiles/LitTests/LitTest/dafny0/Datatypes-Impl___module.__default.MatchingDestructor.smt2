...
(set-info :boogie-vc-id Impl$$_module.__default.MatchingDestructor)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon6_correct  (=> (and (= |r#0@0| (Lit DatatypeTypeType (|#_module.XList.XCons| (LitInt 5) (Lit DatatypeTypeType |#_module.XList.XNil|)))) (= (ControlFlow 0 2) (- 0 1))) (= (_module.XList.Car |r#0@0|) (LitInt 5)))))
(let ((anon5_correct  (=> (= (ControlFlow 0 5) 2) anon6_correct)))
(let ((anon8_Else_correct  (=> (and (not (_module.XList.XCons_q |d#0|)) (= (ControlFlow 0 8) 5)) anon5_correct)))
(let ((anon8_Then_correct  (=> (_module.XList.XCons_q |d#0|) (and (=> (= (ControlFlow 0 6) (- 0 7)) (_module.XList.XCons_q |d#0|)) (=> (_module.XList.XCons_q |d#0|) (=> (and (= |x1#1_0_0@0| (_module.XList.Car |d#0|)) (= (ControlFlow 0 6) 5)) anon5_correct))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 9) 6) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct))))
(let ((anon7_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (_module.XList.XCons_q |d#0|)) (=> (_module.XList.XCons_q |d#0|) (=> (and (= |x0#0_0@0| (_module.XList.Car |d#0|)) (= (ControlFlow 0 3) 2)) anon6_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 10) 3) anon7_Then_correct) (=> (= (ControlFlow 0 10) 9) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |d#0| Tclass._module.XList) ($IsAlloc DatatypeTypeType |d#0| Tclass._module.XList $Heap)) (|$IsA#_module.XList| |d#0|)) (and (and ($Is DatatypeTypeType |r#0| Tclass._module.XList) ($IsAlloc DatatypeTypeType |r#0| Tclass._module.XList $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 11) 10)))) anon0_correct))))
