...
procedure {:verboseName "Let.XYZ (well-formedness)"} CheckWellFormed$$Let.__default.XYZ(n#0: int where LitInt(0) <= n#0);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Let.XYZ (call)"} Call$$Let.__default.XYZ(n#0: int where LitInt(0) <= n#0);
  modifies $Heap;
...
procedure {:verboseName "Let.XYZ (correctness)"} Impl$$Let.__default.XYZ(n#0: int where LitInt(0) <= n#0) returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Let.XYZ (correctness)"} Impl$$Let.__default.XYZ(n#0: int) returns ($_reverifyPost: bool)
{
  ...
  var $rhs#1: int where LitInt(0) <= $rhs#1;
    ...
    // AddMethodImpl: XYZ, Impl$$Let.__default.XYZ
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/TypeAdjustments.dfy(657,11)
    assume true;
    assume true;
    i#0 := n#0;
    havoc j#0 /* where LitInt(0) <= j#0 */;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/TypeAdjustments.dfy(659,7)
    assume true;
    havoc jj#Z#0;
    assume {:id "id309"} let#0#0#0 == n#0;
    assume true;
    // CheckWellformedWithResult: any expression
    assume $Is(let#0#0#0, Tclass._System.nat());
    assume {:id "id310"} jj#Z#0 == let#0#0#0;
    assume true;
    j#0 := (var jj#0 := n#0; jj#0);
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/TypeAdjustments.dfy(660,10)
    assume true;
    assume true;
    ...
    i#0 := $rhs#0;
    j#0 := $rhs#1;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/TypeAdjustments.dfy(661,5)
    assume true;
    assert {:id "id314"} LitInt(0) <= i#0;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/TypeAdjustments.dfy(662,5)
    assume true;
    assert {:id "id315"} LitInt(0) <= j#0;
}
