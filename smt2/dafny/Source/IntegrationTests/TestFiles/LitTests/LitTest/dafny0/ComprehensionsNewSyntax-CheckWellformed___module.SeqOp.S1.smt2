...
(declare-fun _module.SeqOp.S1 (T@U T@U Int) T@U)
(declare-fun |_module.SeqOp.S1#canCall| (T@U T@U Int) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) (|n#0| Int) ) (!  (=> (or (|_module.SeqOp.S1#canCall| $Heap this |n#0|) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.SeqOp) ($IsAlloc refType this Tclass._module.SeqOp $Heap)))) (<= (LitInt 0) |n#0|)))) ($Is SeqType (_module.SeqOp.S1 $Heap this |n#0|) (TSeq TReal)))
 :qid |ComprehensionsNewSyntaxdfy.101:12|
 :skolemid |565|
 :pattern ( (_module.SeqOp.S1 $Heap this |n#0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@0 T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.SeqOp.S1#canCall| $Heap@@0 this@@0 |n#0@@0|) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.SeqOp) ($IsAlloc refType this@@0 Tclass._module.SeqOp $Heap@@0)))) (<= (LitInt 0) |n#0@@0|)))) (= (_module.SeqOp.S1 $Heap@@0 this@@0 |n#0@@0|) (|Seq#Create| TReal $Heap@@0 |n#0@@0| (|_module.SeqOp.G#Handle| this@@0))))
 :qid |ComprehensionsNewSyntaxdfy.101:12|
 :skolemid |567|
 :pattern ( (_module.SeqOp.S1 $Heap@@0 this@@0 |n#0@@0|) ($IsGoodHeap $Heap@@0))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.SeqOp.S1)
...
(assert (not
 ...
 :qid |ComprehensionsNewSyntaxdfy.104:5|
 :skolemid |568|
 ...
 :qid |ComprehensionsNewSyntaxdfy.104:5|
 :skolemid |570|
))) (= (_module.SeqOp.S1 $Heap@@3 this@@3 |n#0@@1|) (|Seq#Create| TReal $Heap@@3 |n#0@@1| (|_module.SeqOp.G#Handle| this@@3)))) (and ($Is SeqType (_module.SeqOp.S1 $Heap@@3 this@@3 |n#0@@1|) (TSeq TReal)) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#47| null $Heap@@3 alloc this@@3)) (and (=> (= (ControlFlow 0 7) 1) anon5_Then_correct) (=> (= (ControlFlow 0 7) 3) anon5_Else_correct)))))
