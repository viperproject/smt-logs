...
(assert (forall ((_module.Iter$X@@11 T@U) (_module.Iter$Y@@11 T@U) ($h0 T@U) ($h1 T@U) (this T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this null)) (not true)) ($Is refType this (Tclass._module.Iter _module.Iter$X@@11 _module.Iter$Y@@11)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@15 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@15 null)) (not true)) (or (or (= $o@@15 this) (|Set#IsMember| (_module.Iter.__reads this) ($Box refType $o@@15))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 this) _module.Iter.__new)) ($Box refType $o@@15)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@15) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@15) $f@@0)))
 :qid |unknown.0:0|
 :skolemid |558|
)) (= (_module.Iter.Valid _module.Iter$X@@11 _module.Iter$Y@@11 $h0 this) (_module.Iter.Valid _module.Iter$X@@11 _module.Iter$Y@@11 $h1 this))))
 :qid |unknown.0:0|
 :skolemid |559|
...
(assert (not
 ...
 :qid |NoReferencesVerificationdfy.39:3|
 :skolemid |528|
