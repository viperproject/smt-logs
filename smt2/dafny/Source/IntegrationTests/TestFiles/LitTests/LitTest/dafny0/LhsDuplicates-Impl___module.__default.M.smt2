...
(declare-fun _module._default.M$T () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 34) (let ((anon3_correct  (=> (and (<= (LitInt 0) |i#0_0@0|) (< |i#0_0@0| 100)) (and (=> (= (ControlFlow 0 25) (- 0 27)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 25) (- 0 26)) (and (<= 0 (LitInt 3)) (< (LitInt 3) (_System.array.Length $nw@0)))) (=> (= (ControlFlow 0 25) (- 0 24)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (LitInt 3)))))))))))
...
(let ((anon8_correct  (=> (and (<= (LitInt 0) |i#1_0@0|) (< |i#1_0@0| 100)) (and (=> (= (ControlFlow 0 14) (- 0 19)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 14) (- 0 18)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length $nw@0)))) (and (=> (= (ControlFlow 0 14) (- 0 17)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (LitInt 0))))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (LitInt 0)))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (or (not (= $nw@1 null)) (not true))) (=> (or (not (= $nw@1 null)) (not true)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length $nw@1)))) (=> (and (and (<= (LitInt 0) |i#1_1@0|) (< |i#1_1@0| 100)) (and (or (not (= |i#1_0@0| |i#1_1@0|)) (not true)) (= (ControlFlow 0 14) (- 0 13)))) (or (or (or (not (= $nw@0 $nw@0)) (not true)) (or (not (= (IndexField (LitInt 0)) (IndexField (LitInt 0)))) (not true))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@1) (IndexField (LitInt 0))) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@1) (IndexField (LitInt 0)))))))))))))))))
...
(let ((anon13_correct  (=> (and (<= (LitInt 0) |i#2_0@0|) (< |i#2_0@0| 100)) (and (=> (= (ControlFlow 0 3) (- 0 8)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length $nw@0)))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (LitInt 0))))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (LitInt 0)))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= $nw@1 null)) (not true))) (=> (or (not (= $nw@1 null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 |i#2_0@0|) (< |i#2_0@0| (_System.array.Length $nw@1)))) (=> (and (and (<= (LitInt 0) |i#2_1@0|) (< |i#2_1@0| 100)) (and (or (not (= |i#2_0@0| |i#2_1@0|)) (not true)) (= (ControlFlow 0 3) (- 0 2)))) (or (or (or (not (= $nw@0 $nw@0)) (not true)) (or (not (= (IndexField (LitInt 0)) (IndexField (LitInt 0)))) (not true))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@1) (IndexField |i#2_0@0|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@1) (IndexField |i#2_1@0|))))))))))))))))
...
(let ((anon17_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) ($HeapSucc $Heap@2 $Heap@3)) (and (forall (($o@@6 T@U) ($f@@0 T@U) ) (!  (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@6) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@6) $f@@0)) (exists ((|i#1_2| Int) ) (!  (and (and (and (<= (LitInt 0) |i#1_2|) (< |i#1_2| 100)) (= $o@@6 $nw@0)) (= $f@@0 (IndexField (LitInt 0))))
 :qid |LhsDuplicatesdfy.17:10|
 :skolemid |551|
)))
 :qid |LhsDuplicatesdfy.17:3|
 :skolemid |552|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@6) $f@@0))
)) (forall ((|i#1_2@@0| Int) ) (!  (=> (and (<= (LitInt 0) |i#1_2@@0|) (< |i#1_2@@0| 100)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField (LitInt 0))) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@1) (IndexField (LitInt 0)))))
 :qid |LhsDuplicatesdfy.17:10|
 :skolemid |553|
)))) (and (=> (= (ControlFlow 0 12) 11) anon19_Then_correct) (=> (= (ControlFlow 0 12) 1) anon19_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (and ($HeapSucc $Heap@1 $Heap@2) (forall (($o@@7 T@U) ($f@@1 T@U) ) (!  (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@7) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@7) $f@@1)) (exists ((|i#0_1| Int) ) (!  (and (and (and (<= (LitInt 0) |i#0_1|) (< |i#0_1| 100)) (= $o@@7 $nw@0)) (= $f@@1 (IndexField (LitInt 3))))
 :qid |LhsDuplicatesdfy.14:10|
 :skolemid |549|
)))
 :qid |LhsDuplicatesdfy.14:3|
 :skolemid |550|
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 31) (- 0 33)) (<= 0 (LitInt 100))) (=> (<= 0 (LitInt 100)) (=> (and (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? _module._default.M$T))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc))))) (and (and (= (_System.array.Length $nw@0) (LitInt 100)) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (=> (= (ControlFlow 0 31) (- 0 32)) (<= 0 (LitInt 100))) (=> (<= 0 (LitInt 100)) (=> (and (and (and (or (not (= $nw@1 null)) (not true)) ($Is refType $nw@1 (Tclass._System.array? _module._default.M$T))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1) alloc))))) (and (and (= (_System.array.Length $nw@1) (LitInt 100)) (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)))) (and (=> (= (ControlFlow 0 31) 30) anon15_Then_correct) (=> (= (ControlFlow 0 31) 23) anon15_Else_correct)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |a#0| (Tclass._System.array _module._default.M$T)) ($IsAlloc refType |a#0| (Tclass._System.array _module._default.M$T) $Heap)) true) (=> (and (and (and ($Is refType |b#0| (Tclass._System.array _module._default.M$T)) ($IsAlloc refType |b#0| (Tclass._System.array _module._default.M$T) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 34) 31))) anon0_correct)))))
