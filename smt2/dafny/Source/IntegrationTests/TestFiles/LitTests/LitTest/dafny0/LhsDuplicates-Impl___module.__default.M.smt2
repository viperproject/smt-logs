...
)) (forall ((|i#1_2@@0| Int) )  (=> (and (<= (LitInt 0) |i#1_2@@0|) (< |i#1_2@@0| 100)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField (LitInt 0))) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@1) (IndexField (LitInt 0)))))))) (and (=> (= (ControlFlow 0 12) 11) anon19_Then_correct) (=> (= (ControlFlow 0 12) 1) anon19_Else_correct)))))
