// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NonZeroInitialization.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NonZeroInitialization-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NonZeroInitialization.dfy
...
axiom {:id "id0"} 1 <= $FunctionContextHeight
   ==> (forall six#0: int :: 
    ...
    _module.__default.Yes#canCall(six#0)
         || (1 < $FunctionContextHeight && LitInt(6) <= six#0)
...
procedure {:verboseName "Yes (well-formedness)"} CheckWellformed$$_module.__default.Yes(six#0: int where LitInt(6) <= six#0);
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Length (well-formedness)"} CheckWellformed$$_module.__default.Length(_module._default.Length$_T0: Ty, xs#0: DatatypeType)
{
  ...
  var ##xs#0: DatatypeType;
    ...
    else
    {
        ...
        {
            assert {:id "id10"} $Is(LitInt(0), Tclass._System.nat());
            assume {:id "id11"} _module.__default.Length(_module._default.Length$_T0, $LS($LZ), xs#0)
               == LitInt(0);
            assume true;
        ...
        else if (xs#0 == #_module.List.Cons(_mcc#0#0, _mcc#1#0))
        {
            ...
            havoc tail#Z#0;
            assume {:id "id5"} let#0#0#0 == _mcc#1#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#0#0#0, Tclass._module.List(_module._default.Length$_T0));
            assume {:id "id6"} tail#Z#0 == let#0#0#0;
            ##xs#0 := tail#Z#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##xs#0, Tclass._module.List(_module._default.Length$_T0), $Heap);
            assert {:id "id7"} DtRank(##xs#0) < DtRank(xs#0);
            assume _module.__default.Length#canCall(_module._default.Length$_T0, tail#Z#0);
            assert {:id "id8"} $Is(_module.__default.Length(_module._default.Length$_T0, $LS($LZ), tail#Z#0) + 1, 
              Tclass._System.nat());
            assume {:id "id9"} _module.__default.Length(_module._default.Length$_T0, $LS($LZ), xs#0)
...
procedure {:verboseName "DefiniteAssignmentViolation (well-formedness)"} CheckWellFormed$$_module.__default.DefiniteAssignmentViolation()
...
procedure {:verboseName "DefiniteAssignmentViolation (call)"} Call$$_module.__default.DefiniteAssignmentViolation()
   returns (e#0: DatatypeType
       where $Is(e#0, Tclass._module.Yt(Tclass._module.Even()))
         && $IsAlloc(e#0, Tclass._module.Yt(Tclass._module.Even()), $Heap), 
    o#0: DatatypeType
...
procedure {:verboseName "DefiniteAssignmentViolation (correctness)"} Impl$$_module.__default.DefiniteAssignmentViolation()
   returns (e#0: DatatypeType
       where $Is(e#0, Tclass._module.Yt(Tclass._module.Even()))
         && $IsAlloc(e#0, Tclass._module.Yt(Tclass._module.Even()), $Heap), 
    o#0: DatatypeType
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "DefiniteAssignmentViolation (correctness)"} Impl$$_module.__default.DefiniteAssignmentViolation()
   returns (e#0: DatatypeType, 
    o#0: DatatypeType, 
    defass#g#0: bool, 
    g#0: DatatypeType, 
    $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    assert {:id "id12"} defass#g#0;
}



procedure {:verboseName "ArrayElementInitViolation (well-formedness)"} CheckWellFormed$$_module.__default.ArrayElementInitViolation()
   returns (e#0: ref
...
procedure {:verboseName "ArrayElementInitViolation (call)"} Call$$_module.__default.ArrayElementInitViolation()
   returns (e#0: ref
       where $Is(e#0, Tclass._System.array(Tclass._module.Yt(Tclass._module.Even())))
         && $IsAlloc(e#0, Tclass._System.array(Tclass._module.Yt(Tclass._module.Even())), $Heap), 
    o#0: ref
...
procedure {:verboseName "ArrayElementInitViolation (correctness)"} Impl$$_module.__default.ArrayElementInitViolation()
   returns (e#0: ref
       where $Is(e#0, Tclass._System.array(Tclass._module.Yt(Tclass._module.Even())))
         && $IsAlloc(e#0, Tclass._System.array(Tclass._module.Yt(Tclass._module.Even())), $Heap), 
    o#0: ref
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ArrayElementInitViolation (correctness)"} Impl$$_module.__default.ArrayElementInitViolation() returns (e#0: ref, o#0: ref, g#0: ref, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var $nw: ref;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NonZeroInitialization.dfy(56,5)
    assume true;
    assert {:id "id13"} 0 <= LitInt(20);
    havoc $nw;
    assume $nw != null
       && $Is($nw, Tclass._System.array?(Tclass._module.Yt(Tclass._module.Even())));
    ...
    e#0 := $nw;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NonZeroInitialization.dfy(57,5)
    assume true;
    assert {:id "id15"} 0 <= LitInt(20);
    havoc $nw;
    assume $nw != null
       && $Is($nw, Tclass._System.array?(Tclass._module.Yt(Tclass._module.Odd())));
    assume !$Unbox(read($Heap, $nw, alloc)): bool;
    assume _System.array.Length($nw) == LitInt(20);
    $Heap := update($Heap, $nw, alloc, $Box(true));
    assume $IsGoodHeap($Heap);
    assume $IsHeapAnchor($Heap);
    o#0 := $nw;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NonZeroInitialization.dfy(58,5)
    assume true;
    assert {:id "id17"} 0 <= LitInt(20);
    assert {:id "id18"} 0 == LitInt(20);
    havoc $nw;
    assume $nw != null
       && $Is($nw, Tclass._System.array?(Tclass._module.Yt(Tclass._module.GW())));
    assume !$Unbox(read($Heap, $nw, alloc)): bool;
    assume _System.array.Length($nw) == LitInt(20);
    $Heap := update($Heap, $nw, alloc, $Box(true));
    assume $IsGoodHeap($Heap);
...
procedure {:verboseName "MyInt_Bad (well-formedness)"} CheckWellFormed$$_module.MyInt__Bad(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MyInt_Bad (well-formedness)"} CheckWellFormed$$_module.MyInt__Bad(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assume true;
        assert {:id "id21"} LitInt(6) <= LitInt(5);
        assume false;
    }
}
...
// $Is axiom for subset type _module.MyInt_Bad
axiom (forall x#0: int :: 
  { $Is(x#0, Tclass._module.MyInt__Bad()) } 
  $Is(x#0, Tclass._module.MyInt__Bad()) <==> LitInt(6) <= x#0);

// $IsAlloc axiom for subset type _module.MyInt_Bad
axiom (forall x#0: int, $h: Heap :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MyInt (well-formedness)"} CheckWellFormed$$_module.MyInt(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        // check well-formedness of subset type witness, and that it satisfies the constraint
        assume true;
        assert {:id "id23"} LitInt(6) <= LitInt(6);
        assume false;
    }
}
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MyNewInt (well-formedness)"} CheckWellFormed$$_module.MyNewInt(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assume true;
        assert {:id "id25"} LitInt(6) <= LitInt(6);
        assume false;
    }
}
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Six (well-formedness)"} CheckWellFormed$$_module.Six(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        // check well-formedness of subset type witness, and that it satisfies the constraint
        assume true;
        assert {:id "id27"} LitInt(6) <= LitInt(6);
        assume false;
    }
}
...
procedure {:verboseName "SixAgain (well-formedness)"} CheckWellFormed$$_module.SixAgain(six#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "SixAgain (well-formedness)"} CheckWellFormed$$_module.SixAgain(six#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var newtype$check#0: int;
    ...
    {
        // check well-formedness of subset type constraint
        assume LitInt(6) <= six#0;
        assume {:id "id28"} LitInt(4) <= six#0;
        assume false;
    }
    ...
    if (*)
    {
        ...
        assert {:id "id29"} LitInt(6) <= newtype$check#0;
        assume true;
        assert {:id "id30"} LitInt(4) <= LitInt(0);
        assume false;
    }
}
...
// $Is axiom for subset type _module.SixAgain
axiom (forall six#0: int :: 
  { $Is(six#0, Tclass._module.SixAgain()) } 
  $Is(six#0, Tclass._module.SixAgain())
     <==> LitInt(6) <= six#0 && LitInt(4) <= six#0);

// $IsAlloc axiom for subset type _module.SixAgain
axiom (forall six#0: int, $h: Heap :: 
  { $IsAlloc(six#0, Tclass._module.SixAgain(), $h) } 
  $IsAlloc(six#0, Tclass._module.SixAgain(), $h));

procedure {:verboseName "SixAgainW (well-formedness)"} CheckWellFormed$$_module.SixAgainW(six#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "SixAgainW (well-formedness)"} CheckWellFormed$$_module.SixAgainW(six#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var newtype$check#0: int;
  var newtype$check#1: int;
    ...
    if (*)
    {
        ...
        assert {:id "id32"} LitInt(6) <= newtype$check#0;
        newtype$check#1 := LitInt(4);
        assert {:id "id33"} LitInt(6) <= newtype$check#1;
        assume true;
        assert {:id "id34"} LitInt(4) <= LitInt(4);
        assume false;
    }
}
...
// $Is axiom for subset type _module.SixAgainW
axiom (forall six#0: int :: 
  { $Is(six#0, Tclass._module.SixAgainW()) } 
  $Is(six#0, Tclass._module.SixAgainW())
     <==> LitInt(6) <= six#0 && LitInt(4) <= six#0);

// $IsAlloc axiom for subset type _module.SixAgainW
axiom (forall six#0: int, $h: Heap :: 
  { $IsAlloc(six#0, Tclass._module.SixAgainW(), $h) } 
  $IsAlloc(six#0, Tclass._module.SixAgainW(), $h));

procedure {:verboseName "Impossible (well-formedness)"} CheckWellFormed$$_module.Impossible(six#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Impossible (well-formedness)"} CheckWellFormed$$_module.Impossible(six#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var newtype$check#0: int;
    ...
    if (*)
    {
        // check well-formedness of subset type witness, and that it satisfies the constraint
        newtype$check#0 := LitInt(0);
        assert {:id "id36"} LitInt(6) <= newtype$check#0;
        assume true;
        assert {:id "id37"} Lit(0 < 2);
        assume false;
    }
}
...
// $Is axiom for subset type _module.Impossible
axiom (forall six#0: int :: 
  { $Is(six#0, Tclass._module.Impossible()) } 
  $Is(six#0, Tclass._module.Impossible()) <==> LitInt(6) <= six#0 && six#0 < 2);

// $IsAlloc axiom for subset type _module.Impossible
axiom (forall six#0: int, $h: Heap :: 
  { $IsAlloc(six#0, Tclass._module.Impossible(), $h) } 
  $IsAlloc(six#0, Tclass._module.Impossible(), $h));

procedure {:verboseName "NewSix (well-formedness)"} CheckWellFormed$$_module.NewSix(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NewSix (well-formedness)"} CheckWellFormed$$_module.NewSix(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        // check well-formedness of newtype witness, and that it satisfies the constraint
        assume true;
        assert {:id "id39"} LitInt(6) <= LitInt(6);
        assume false;
    }
}
...
// $Is axiom for newtype _module.NewSix
axiom (forall x#0: int :: 
  { $Is(x#0, Tclass._module.NewSix()) } 
  $Is(x#0, Tclass._module.NewSix()) <==> LitInt(6) <= x#0);

// $IsAlloc axiom for newtype _module.NewSix
axiom (forall x#0: int, $h: Heap :: 
...
procedure {:verboseName "NewSixAgain (well-formedness)"} CheckWellFormed$$_module.NewSixAgain(six#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NewSixAgain (well-formedness)"} CheckWellFormed$$_module.NewSixAgain(six#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var newtype$check#0: int;
    ...
    if (*)
    {
        // check well-formedness of newtype witness, and that it satisfies the constraint
        newtype$check#0 := LitInt(0);
        assert {:id "id41"} LitInt(6) <= newtype$check#0;
        assume true;
        assert {:id "id42"} LitInt(4) <= LitInt(0);
        assume false;
    }
}
...
// $Is axiom for newtype _module.NewSixAgain
axiom (forall six#0: int :: 
  { $Is(six#0, Tclass._module.NewSixAgain()) } 
  $Is(six#0, Tclass._module.NewSixAgain())
     <==> LitInt(6) <= six#0 && LitInt(4) <= six#0);

// $IsAlloc axiom for newtype _module.NewSixAgain
axiom (forall six#0: int, $h: Heap :: 
...
procedure {:verboseName "NewSixAgainW (well-formedness)"} CheckWellFormed$$_module.NewSixAgainW(six#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NewSixAgainW (well-formedness)"} CheckWellFormed$$_module.NewSixAgainW(six#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var newtype$check#0: int;
  var newtype$check#1: int;
    ...
    if (*)
    {
        // check well-formedness of newtype witness, and that it satisfies the constraint
        newtype$check#0 := LitInt(4);
        assert {:id "id44"} LitInt(6) <= newtype$check#0;
        newtype$check#1 := LitInt(4);
        assert {:id "id45"} LitInt(6) <= newtype$check#1;
        assume true;
        assert {:id "id46"} LitInt(4) <= LitInt(4);
        assume false;
    }
}
...
// $Is axiom for newtype _module.NewSixAgainW
axiom (forall six#0: int :: 
  { $Is(six#0, Tclass._module.NewSixAgainW()) } 
  $Is(six#0, Tclass._module.NewSixAgainW())
     <==> LitInt(6) <= six#0 && LitInt(4) <= six#0);

// $IsAlloc axiom for newtype _module.NewSixAgainW
axiom (forall six#0: int, $h: Heap :: 
...
procedure {:verboseName "NewSixAgainY (well-formedness)"} CheckWellFormed$$_module.NewSixAgainY(six#0: int);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NewSixAgainY (well-formedness)"} CheckWellFormed$$_module.NewSixAgainY(six#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var ##six#0: int;
  var newtype$check#0: int;
  var newtype$check#1: int;
    ...
    if (*)
    {
        ...
        assume {:id "id47"} _module.__default.Yes(six#0);
        assume false;
    }
    ...
    if (*)
    {
        // check well-formedness of newtype witness, and that it satisfies the constraint
        newtype$check#0 := LitInt(4);
        assert {:id "id48"} LitInt(6) <= newtype$check#0;
        newtype$check#1 := LitInt(4);
        assert {:id "id49"} LitInt(6) <= newtype$check#1;
        assume _module.__default.Yes#canCall(LitInt(4));
        assert {:id "id50"} {:subsumption 0} _module.__default.Yes#canCall(LitInt(4))
...
// $Is axiom for newtype _module.NewSixAgainY
axiom (forall six#0: int :: 
  { $Is(six#0, Tclass._module.NewSixAgainY()) } 
  $Is(six#0, Tclass._module.NewSixAgainY())
     <==> LitInt(6) <= six#0 && _module.__default.Yes(six#0));

// $IsAlloc axiom for newtype _module.NewSixAgainY
axiom (forall six#0: int, $h: Heap :: 
...
procedure {:verboseName "NewImpossible (well-formedness)"} CheckWellFormed$$_module.NewImpossible(six#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NewImpossible (well-formedness)"} CheckWellFormed$$_module.NewImpossible(six#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var newtype$check#0: int;
  var newtype$check#1: int;
    ...
    if (*)
    {
        ...
        assert {:id "id51"} LitInt(6) <= newtype$check#0;
        assume {:id "id52"} six#0 < 6;
        assume false;
    }
    ...
    if (*)
    {
        ...
        assert {:id "id53"} LitInt(6) <= newtype$check#1;
        assume true;
        assert {:id "id54"} Lit(0 < 6);
        assume false;
    }
}
...
procedure {:verboseName "YetAnotherNewSix (well-formedness)"} CheckWellFormed$$_module.YetAnotherNewSix();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "YetAnotherNewSix (well-formedness)"} CheckWellFormed$$_module.YetAnotherNewSix()
{
  var $_ReadsFrame: [ref,Field]bool;
  var newtype$check#0: int;
  var newtype$check#1: int;
    ...
    // AddWellformednessCheck for newtype YetAnotherNewSix
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    if (*)
    {
    ...
    {
        // check well-formedness of newtype witness, and that it satisfies the constraint
        newtype$check#0 := LitInt(80);
        assert {:id "id55"} LitInt(6) <= newtype$check#0;
        newtype$check#1 := LitInt(80);
        assert {:id "id56"} LitInt(6) <= newtype$check#1;
        assume false;
    }
}
...
function Tclass._module.YetAnotherNewSix() : Ty
uses {
// Tclass._module.YetAnotherNewSix Tag
axiom Tag(Tclass._module.YetAnotherNewSix()) == Tagclass._module.YetAnotherNewSix
   && TagFamily(Tclass._module.YetAnotherNewSix()) == tytagFamily$YetAnotherNewSix;
}

const unique Tagclass._module.YetAnotherNewSix: TyTag;

// Box/unbox axiom for Tclass._module.YetAnotherNewSix
axiom (forall bx: Box :: 
  { $IsBox(bx, Tclass._module.YetAnotherNewSix()) } 
  $IsBox(bx, Tclass._module.YetAnotherNewSix())
     ==> $Box($Unbox(bx): int) == bx
       && $Is($Unbox(bx): int, Tclass._module.YetAnotherNewSix()));

// $Is axiom for newtype _module.YetAnotherNewSix
axiom (forall c0#0: int :: 
  { $Is(c0#0, Tclass._module.YetAnotherNewSix()) } 
  $Is(c0#0, Tclass._module.YetAnotherNewSix()) <==> LitInt(6) <= c0#0);

// $IsAlloc axiom for newtype _module.YetAnotherNewSix
axiom (forall c1#0: int, $h: Heap :: 
  { $IsAlloc(c1#0, Tclass._module.YetAnotherNewSix(), $h) } 
  $IsAlloc(c1#0, Tclass._module.YetAnotherNewSix(), $h));
...
// Constructor $Is
axiom (forall _module.List$G: Ty, a#6#0#0: Box, a#6#1#0: DatatypeType :: 
  { $Is(#_module.List.Cons(a#6#0#0, a#6#1#0), Tclass._module.List(_module.List$G)) } 
  $Is(#_module.List.Cons(a#6#0#0, a#6#1#0), Tclass._module.List(_module.List$G))
     <==> $IsBox(a#6#0#0, _module.List$G)
       && $Is(a#6#1#0, Tclass._module.List(_module.List$G)));

// Constructor $IsAlloc
axiom (forall _module.List$G: Ty, a#6#0#0: Box, a#6#1#0: DatatypeType, $h: Heap :: 
  { $IsAlloc(#_module.List.Cons(a#6#0#0, a#6#1#0), Tclass._module.List(_module.List$G), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_module.List.Cons(a#6#0#0, a#6#1#0), Tclass._module.List(_module.List$G), $h)
       <==> $IsAllocBox(a#6#0#0, _module.List$G, $h)
         && $IsAlloc(a#6#1#0, Tclass._module.List(_module.List$G), $h)));
...
procedure {:verboseName "ListTwo (well-formedness)"} CheckWellFormed$$_module.ListTwo(_module.ListTwo$G: Ty, xs#0: DatatypeType);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ListTwo (well-formedness)"} CheckWellFormed$$_module.ListTwo(_module.ListTwo$G: Ty, xs#0: DatatypeType)
{
  var $_ReadsFrame: [ref,Field]bool;
  var ##xs#0: DatatypeType;
    ...
    {
        // check well-formedness of subset type constraint
        assume $Is(xs#0, Tclass._module.List(TSet(_module.ListTwo$G)));
        ##xs#0 := xs#0;
        // assume allocatedness for argument to function
        ...
        assume {:id "id57"} LitInt(2) <= _module.__default.Length(TSet(_module.ListTwo$G), $LS($LZ), xs#0);
        assume false;
    }
    ...
    if (*)
    {
        ...
        assume _module.__default.Length#canCall(TSet(_module.ListTwo$G), 
          Lit(#_module.List.Cons($Box(Lit(Set#Empty(): Set)), 
              Lit(#_module.List.Cons($Box(Lit(Set#Empty(): Set)), Lit(#_module.List.Nil()))))));
        assert {:id "id58"} {:subsumption 0} LitInt(2)
...
// $Is axiom for subset type _module.ListTwo
...
// $IsAlloc axiom for subset type _module.ListTwo
...
procedure {:verboseName "TwoAgain (well-formedness)"} CheckWellFormed$$_module.TwoAgain(_module.TwoAgain$G: Ty, xs#0: DatatypeType);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TwoAgain (well-formedness)"} CheckWellFormed$$_module.TwoAgain(_module.TwoAgain$G: Ty, xs#0: DatatypeType)
{
  var $_ReadsFrame: [ref,Field]bool;
  var ##xs#0: DatatypeType;
...
// $Is axiom for subset type _module.TwoAgain
...
// $IsAlloc axiom for subset type _module.TwoAgain
...
procedure {:verboseName "TwoAgainW (well-formedness)"} CheckWellFormed$$_module.TwoAgainW(_module.TwoAgainW$G: Ty, xs#0: DatatypeType);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TwoAgainW (well-formedness)"} CheckWellFormed$$_module.TwoAgainW(_module.TwoAgainW$G: Ty, xs#0: DatatypeType)
{
  var $_ReadsFrame: [ref,Field]bool;
  var ##xs#0: DatatypeType;
  var newtype$check#0: DatatypeType;
  var newtype$check#1: DatatypeType;
    ...
    {
        // check well-formedness of subset type constraint
        assume $Is(xs#0, Tclass._module.ListTwo(TSet(_module.TwoAgainW$G)));
        ##xs#0 := xs#0;
        // assume allocatedness for argument to function
    ...
    {
        // check well-formedness of subset type witness, and that it satisfies the constraint
        newtype$check#0 := Lit(#_module.List.Cons($Box(Lit(Set#Empty(): Set)), Lit(#_module.List.Nil())));
        assert {:id "id62"} LitInt(2)
           <= _module.__default.Length(TSet(TSet(_module.TwoAgainW$G)), $LS($LZ), newtype$check#0);
        newtype$check#1 := Lit(#_module.List.Cons($Box(Lit(Set#Empty(): Set)), Lit(#_module.List.Nil())));
        assert {:id "id63"} LitInt(2)
           <= _module.__default.Length(TSet(TSet(_module.TwoAgainW$G)), $LS($LZ), newtype$check#1);
        assume _module.__default.Length#canCall(TSet(TSet(_module.TwoAgainW$G)), 
          Lit(#_module.List.Cons($Box(Lit(Set#Empty(): Set)), Lit(#_module.List.Nil()))));
        assert {:id "id64"} {:subsumption 0} LitInt(1)
...
// $Is axiom for subset type _module.TwoAgainW
...
// $IsAlloc axiom for subset type _module.TwoAgainW
...
procedure {:verboseName "TwoImpossible (well-formedness)"} CheckWellFormed$$_module.TwoImpossible(_module.TwoImpossible$G: Ty, xs#0: DatatypeType);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TwoImpossible (well-formedness)"} CheckWellFormed$$_module.TwoImpossible(_module.TwoImpossible$G: Ty, xs#0: DatatypeType)
{
  var $_ReadsFrame: [ref,Field]bool;
  var ##xs#0: DatatypeType;
    ...
    {
        // check well-formedness of subset type constraint
        assume $Is(xs#0, Tclass._module.ListTwo(TSet(_module.TwoImpossible$G)));
        ##xs#0 := xs#0;
        // assume allocatedness for argument to function
        ...
        assume {:id "id65"} _module.__default.Length(TSet(TSet(_module.TwoImpossible$G)), $LS($LZ), xs#0)
           < 2;
        assume false;
    }
...
// $Is axiom for subset type _module.TwoImpossible
...
// $IsAlloc axiom for subset type _module.TwoImpossible
...
procedure {:verboseName "ListFour (well-formedness)"} CheckWellFormed$$_module.ListFour(_module.ListFour$G: Ty, xs#0: DatatypeType);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ListFour (well-formedness)"} CheckWellFormed$$_module.ListFour(_module.ListFour$G: Ty, xs#0: DatatypeType)
{
  var $_ReadsFrame: [ref,Field]bool;
  var ##xs#0: DatatypeType;
    ...
    {
        // check well-formedness of subset type constraint
        assume $Is(xs#0, Tclass._module.List(TSet(_module.ListFour$G)));
        ##xs#0 := xs#0;
        // assume allocatedness for argument to function
        ...
        assume {:id "id67"} LitInt(4) <= _module.__default.Length(TSet(_module.ListFour$G), $LS($LZ), xs#0);
        assume false;
    }
        ...
        assume _module.__default.Length#canCall(TSet(_module.ListFour$G), 
          Lit(#_module.List.Cons($Box(Lit(Set#Empty(): Set)), 
              Lit(#_module.List.Cons($Box(Lit(Set#Empty(): Set)), 
                  Lit(#_module.List.Cons($Box(Lit(Set#Empty(): Set)), 
                      Lit(#_module.List.Cons($Box(Lit(Set#Empty(): Set)), Lit(#_module.List.Nil()))))))))));
        assert {:id "id68"} {:subsumption 0} LitInt(4)
...
// $Is axiom for subset type _module.ListFour
...
// $IsAlloc axiom for subset type _module.ListFour
...
procedure {:verboseName "ListFour' (well-formedness)"} CheckWellFormed$$_module.ListFour_k(_module.ListFour'$G: Ty, xs#0: DatatypeType);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ListFour' (well-formedness)"} CheckWellFormed$$_module.ListFour_k(_module.ListFour'$G: Ty, xs#0: DatatypeType)
{
  var $_ReadsFrame: [ref,Field]bool;
  var ##xs#0: DatatypeType;
  var newtype$check#0: DatatypeType;
  var newtype$check#1: DatatypeType;
    ...
    {
        // check well-formedness of subset type constraint
        assume $Is(xs#0, Tclass._module.ListTwo(_module.ListFour'$G));
        ##xs#0 := xs#0;
        // assume allocatedness for argument to function
        assume $IsAlloc(##xs#0, Tclass._module.List(TSet(_module.ListFour'$G)), $Heap);
        assume _module.__default.Length#canCall(TSet(_module.ListFour'$G), xs#0);
        assume {:id "id69"} LitInt(4) <= _module.__default.Length(TSet(_module.ListFour'$G), $LS($LZ), xs#0);
        assume false;
    }
    ...
    {
        // check well-formedness of subset type witness, and that it satisfies the constraint
        newtype$check#0 := Lit(#_module.List.Cons($Box(Lit(Set#Empty(): Set)), 
            Lit(#_module.List.Cons($Box(Lit(Set#Empty(): Set)), 
                Lit(#_module.List.Cons($Box(Lit(Set#Empty(): Set)), 
                    Lit(#_module.List.Cons($Box(Lit(Set#Empty(): Set)), Lit(#_module.List.Nil())))))))));
        assert {:id "id70"} LitInt(2)
           <= _module.__default.Length(TSet(_module.ListFour'$G), $LS($LZ), newtype$check#0);
        newtype$check#1 := Lit(#_module.List.Cons($Box(Lit(Set#Empty(): Set)), 
            Lit(#_module.List.Cons($Box(Lit(Set#Empty(): Set)), 
                Lit(#_module.List.Cons($Box(Lit(Set#Empty(): Set)), 
                    Lit(#_module.List.Cons($Box(Lit(Set#Empty(): Set)), Lit(#_module.List.Nil())))))))));
        assert {:id "id71"} LitInt(2)
           <= _module.__default.Length(TSet(_module.ListFour'$G), $LS($LZ), newtype$check#1);
        assume _module.__default.Length#canCall(TSet(_module.ListFour'$G), 
          Lit(#_module.List.Cons($Box(Lit(Set#Empty(): Set)), 
              Lit(#_module.List.Cons($Box(Lit(Set#Empty(): Set)), 
                  Lit(#_module.List.Cons($Box(Lit(Set#Empty(): Set)), 
                      Lit(#_module.List.Cons($Box(Lit(Set#Empty(): Set)), Lit(#_module.List.Nil()))))))))));
        assert {:id "id72"} {:subsumption 0} LitInt(4)
           <= LitInt(_module.__default.Length(TSet(_module.ListFour'$G), 
              $LS($LS($LZ)), 
              Lit(#_module.List.Cons($Box(Lit(Set#Empty(): Set)), 
                  Lit(#_module.List.Cons($Box(Lit(Set#Empty(): Set)), 
...
// Constructor $IsAlloc
axiom (forall _module.Yt$Y: Ty, a#2#0#0: int, a#2#1#0: Box, $h: Heap :: 
  { $IsAlloc(#_module.Yt.MakeYt(a#2#0#0, a#2#1#0), Tclass._module.Yt(_module.Yt$Y), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_module.Yt.MakeYt(a#2#0#0, a#2#1#0), Tclass._module.Yt(_module.Yt$Y), $h)
       <==> $IsAlloc(a#2#0#0, TInt, $h) && $IsAllocBox(a#2#1#0, _module.Yt$Y, $h)));
...
// Constructor literal
axiom (forall a#3#0#0: int, a#3#1#0: Box :: 
  { #_module.Yt.MakeYt(LitInt(a#3#0#0), Lit(a#3#1#0)) } 
  #_module.Yt.MakeYt(LitInt(a#3#0#0), Lit(a#3#1#0))
     == Lit(#_module.Yt.MakeYt(a#3#0#0, a#3#1#0)));

function _module.Yt.x(DatatypeType) : int;

// Constructor injectivity
axiom (forall a#4#0#0: int, a#4#1#0: Box :: 
  { #_module.Yt.MakeYt(a#4#0#0, a#4#1#0) } 
  _module.Yt.x(#_module.Yt.MakeYt(a#4#0#0, a#4#1#0)) == a#4#0#0);
...
axiom (forall a#5#0#0: int, a#5#1#0: Box :: 
  ...
  _module.Yt.y(#_module.Yt.MakeYt(a#5#0#0, a#5#1#0)) == a#5#1#0);

// Inductive rank
axiom (forall a#6#0#0: int, a#6#1#0: Box :: 
  { #_module.Yt.MakeYt(a#6#0#0, a#6#1#0) } 
  BoxRank(a#6#1#0) < DtRank(#_module.Yt.MakeYt(a#6#0#0, a#6#1#0)));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Even (well-formedness)"} CheckWellFormed$$_module.Even(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    {
        // check well-formedness of subset type constraint
        assert {:id "id73"} LitInt(2) != 0;
        assume {:id "id74"} Mod(x#0, LitInt(2)) == LitInt(0);
        assume false;
    }
    ...
    if (*)
    {
        // check well-formedness of subset type witness, and that it satisfies the constraint
        assume true;
        assert {:id "id75"} LitInt(Mod(0, LitInt(2))) == LitInt(0);
        assume false;
    }
}
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Odd (well-formedness)"} CheckWellFormed$$_module.Odd(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assume {:id "id77"} Mod(x#0, LitInt(2)) == LitInt(1);
        assume false;
    }
    ...
    if (*)
    {
        // check well-formedness of subset type witness, and that it satisfies the constraint
        assume true;
        assert {:id "id78"} LitInt(Mod(17, LitInt(2))) == LitInt(1);
        assume false;
    }
}
...
// $Is axiom for subset type _module.Odd
axiom (forall x#0: int :: 
  { $Is(x#0, Tclass._module.Odd()) } 
  $Is(x#0, Tclass._module.Odd()) <==> Mod(x#0, LitInt(2)) == LitInt(1));

// $IsAlloc axiom for subset type _module.Odd
axiom (forall x#0: int, $h: Heap :: 
  { $IsAlloc(x#0, Tclass._module.Odd(), $h) } 
  $IsAlloc(x#0, Tclass._module.Odd(), $h));

procedure {:verboseName "GW (well-formedness)"} CheckWellFormed$$_module.GW(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "GW (well-formedness)"} CheckWellFormed$$_module.GW(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assume {:id "id80"} Mod(x#0, LitInt(2)) == LitInt(1);
        assume false;
    }
    ...
    if (*)
    {
        // check well-formedness of subset type witness, and that it satisfies the constraint
        assume true;
        assert {:id "id81"} LitInt(Mod(17, LitInt(2))) == LitInt(1);
        assume false;
    }
}
...
// $Is axiom for subset type _module.GW
axiom (forall x#0: int :: 
  { $Is(x#0, Tclass._module.GW()) } 
  $Is(x#0, Tclass._module.GW()) <==> Mod(x#0, LitInt(2)) == LitInt(1));

// $IsAlloc axiom for subset type _module.GW
axiom (forall x#0: int, $h: Heap :: 
...
const unique tytagFamily$YetAnotherNewSix: TyTagFamily;
