...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@6 T@U) ($f@@1 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#1| |l#0| |l#1| |l#2| |l#3|) $o@@6 $f@@1))  (=> (and (or (not (= $o@@6 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@6) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |2569|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#1| |l#0| |l#1| |l#2| |l#3|) $o@@6 $f@@1))
)))
...
(assert (= (Tag Tclass.M0.Tr) Tagclass.M0.Tr))
(assert (= (TagFamily Tclass.M0.Tr) tytagFamily$Tr))
(assert (forall (($o@@7 T@U) ) (! (= ($Is refType $o@@7 Tclass.M0.Tr?)  (or (= $o@@7 null) (implements$M0.Tr (dtype $o@@7))))
 :qid |unknown.0:0|
 :skolemid |1277|
 :pattern ( ($Is refType $o@@7 Tclass.M0.Tr?))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$M0.Tr.L)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null current$Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 7)) ($IsAlloc refType |c#0@@5| Tclass.M0.C $Heap@@0)) (=> ($IsAlloc refType |c#0@@5| Tclass.M0.C $Heap@@0) (=> (forall (($o@@8 T@U) ($f@@2 T@U) ) (!  (=> (or (not (= $o@@8 null)) (not true)) (=> (= $o@@8 |c#0@@5|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@8) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@8) $f@@2))))
...
)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= |c#0@@5| null)) (not true))) (=> (or (not (= |c#0@@5| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 5)) ($IsAlloc refType |c#0@@5| Tclass.M0.C $Heap@@0)) (=> ($IsAlloc refType |c#0@@5| Tclass.M0.C $Heap@@0) (=> ($IsAllocBox ($Box refType this@@1) Tclass.M0.Tr? current$Heap) (=> (and ($IsAlloc refType |c#0@@5| Tclass.M0.C? current$Heap) ($IsAlloc refType |d#0@@1| Tclass.M0.C current$Heap)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@1 Tclass.M0.Tr $Heap@@0)) (=> ($IsAlloc refType this@@1 Tclass.M0.Tr $Heap@@0) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |c#0@@5| Tclass.M0.C $Heap@@0)) (=> ($IsAlloc refType |c#0@@5| Tclass.M0.C $Heap@@0) (=> (= (ControlFlow 0 2) (- 0 1)) (or (= |c#0@@5| null) (forall (($o@@9 T@U) ($f@@3 T@U) ) (!  (=> (or (not (= $o@@9 null)) (not true)) (=> (= $o@@9 |c#0@@5|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@9) $f@@3) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@9) $f@@3))))
 :qid |TwostateFunctionsdfy.117:29|
 :skolemid |1291|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@9) $f@@3))
))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass.M0.Tr) ($IsAlloc refType this@@1 Tclass.M0.Tr previous$Heap))) (and ($Is refType |c#0@@5| Tclass.M0.C) ($IsAlloc refType |c#0@@5| Tclass.M0.C previous$Heap))) (=> (and (and (and ($Is refType |d#0@@1| Tclass.M0.C) ($IsAlloc refType |d#0@@1| Tclass.M0.C current$Heap)) (= 3 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@0) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (and ($IsAlloc refType |c#0@@5| Tclass.M0.C previous$Heap) (= (ControlFlow 0 8) 2)))) anon0_correct)))))
