...
(set-info :boogie-vc-id Impl$$_module.__default.Newtype3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon8_Else_correct  (=> (or (not (= |i#0@0| |i#0#hi@0|)) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 256))) (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 256)) (=> (= (ControlFlow 0 5) (- 0 4)) (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 256))))))))
...
(let ((anon6_LoopHead_correct  (=> (and (<= (LitInt 0) |b#0_0@0|) (< |b#0_0@0| 256)) (=> (and (and (and (and (not false) (and (<= 0 |i#0@0|) (< |i#0@0| 257))) (= |i#0#lo@0| 0)) (= |i#0#hi@0| 256)) (and (and (and (<= |i#0#lo@0| |i#0@0|) (<= |i#0@0| |i#0#hi@0|)) (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |ForLoopsdfy.317:3|
 :skolemid |641|
...
))))) (and (=> (= (ControlFlow 0 9) 1) anon6_LoopDone_correct) (=> (= (ControlFlow 0 9) 8) anon6_LoopBody_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |i#0#lo@0| (LitInt 0)) (= |i#0#hi@0| (LitInt 256))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= |i#0#lo@0| |i#0#hi@0|)) (=> (<= |i#0#lo@0| |i#0#hi@0|) (=> (= (ControlFlow 0 10) 9) anon6_LoopHead_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (<= (LitInt 0) |b#0_0|) (< |b#0_0| 256)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 12) 10))) anon0_correct))))
