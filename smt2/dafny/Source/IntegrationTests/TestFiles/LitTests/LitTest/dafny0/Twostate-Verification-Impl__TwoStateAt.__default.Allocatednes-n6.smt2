...
(declare-fun |##y#4_1@0| () Int)
(declare-fun |##y#4_2@0| () Int)
(declare-fun |a#4_0@0| () Int)
(declare-fun |##y#5_0@0| () Int)
(declare-fun |##y#6_0@0| () Int)
...
(set-info :boogie-vc-id Impl$$TwoStateAt.__default.Allocatedness__Function)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 47) (let ((anon15_Else_correct  (=> (and (and (and (and (and (and (and (not (U_2_bool (Lit boolType (bool_2_U true)))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (= (ControlFlow 0 40) (- 0 39))) false)))
(let ((anon15_Then_correct  (and (=> (= (ControlFlow 0 35) (- 0 38)) (or (not (= 2 $FunctionContextHeight)) (not true))) (=> (or (not (= 2 $FunctionContextHeight)) (not true)) (and (=> (= (ControlFlow 0 35) (- 0 37)) true) (and (=> (= (ControlFlow 0 35) (- 0 36)) (or (not (= call2formal@this@0 null)) (not true))) (=> (or (not (= call2formal@this@0 null)) (not true)) (=> (= (ControlFlow 0 35) (- 0 34)) ($IsAlloc refType call2formal@this@0 Tclass.TwoStateAt.Cell $Heap@@3)))))))))
(let ((anon14_Then_correct  (and (=> (= (ControlFlow 0 27) (- 0 33)) true) (=> ($IsAlloc refType call2formal@this@0 Tclass.TwoStateAt.Cell $Heap@1) (=> (and (= |##y#1_0@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##y#1_0@0|) TInt $Heap@1)) (and (=> (= (ControlFlow 0 27) (- 0 32)) ($IsAlloc refType call2formal@this@0 Tclass.TwoStateAt.Cell $Heap@0)) (=> ($IsAlloc refType call2formal@this@0 Tclass.TwoStateAt.Cell $Heap@0) (=> (|TwoStateAt.Cell.Sum#canCall| TInt $Heap@0 $Heap@1 call2formal@this@0 ($Box intType (int_2_U (LitInt 0)))) (and (=> (= (ControlFlow 0 27) (- 0 31)) true) (=> ($IsAlloc refType call2formal@this@0 Tclass.TwoStateAt.Cell $Heap@1) (=> (and (= |##y#1_1@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##y#1_1@0|) TInt $Heap@1)) (and (=> (= (ControlFlow 0 27) (- 0 30)) ($IsAlloc refType call2formal@this@0 Tclass.TwoStateAt.Cell $Heap@0)) (=> ($IsAlloc refType call2formal@this@0 Tclass.TwoStateAt.Cell $Heap@0) (=> (|TwoStateAt.Cell.Sum#canCall| TInt $Heap@0 $Heap@1 call2formal@this@0 ($Box intType (int_2_U (LitInt 0)))) (and (=> (= (ControlFlow 0 27) (- 0 29)) true) (=> ($IsAlloc refType call2formal@this@0 Tclass.TwoStateAt.Cell $Heap@1) (=> (and (= |##y#1_2@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##y#1_2@0|) TInt $Heap@1)) (and (=> (= (ControlFlow 0 27) (- 0 28)) ($IsAlloc refType call2formal@this@0 Tclass.TwoStateAt.Cell $Heap@1)) (=> ($IsAlloc refType call2formal@this@0 Tclass.TwoStateAt.Cell $Heap@1) (=> (|TwoStateAt.Cell.Sum#canCall| TInt $Heap@1 $Heap@1 call2formal@this@0 ($Box intType (int_2_U (LitInt 0)))) (=> (and (and (and (|TwoStateAt.Cell.Sum#canCall| TInt $Heap@0 $Heap@1 call2formal@this@0 ($Box intType (int_2_U (LitInt 0)))) (|TwoStateAt.Cell.Sum#canCall| TInt $Heap@0 $Heap@1 call2formal@this@0 ($Box intType (int_2_U (LitInt 0))))) (|TwoStateAt.Cell.Sum#canCall| TInt $Heap@1 $Heap@1 call2formal@this@0 ($Box intType (int_2_U (LitInt 0))))) (and (= |a#1_0@0| (+ (+ (TwoStateAt.Cell.Sum TInt $Heap@0 $Heap@1 call2formal@this@0 ($Box intType (int_2_U (LitInt 0)))) (TwoStateAt.Cell.Sum TInt $Heap@0 $Heap@1 call2formal@this@0 ($Box intType (int_2_U (LitInt 0))))) (TwoStateAt.Cell.Sum TInt $Heap@1 $Heap@1 call2formal@this@0 ($Box intType (int_2_U (LitInt 0)))))) (= (ControlFlow 0 27) (- 0 26)))) (= |a#1_0@0| (LitInt (+ (+ (+ 5 5) 405) 1215))))))))))))))))))))))))
(let ((anon13_Then_correct  (and (=> (= (ControlFlow 0 24) (- 0 25)) true) (=> (and (and ($IsAlloc refType call2formal@this@0 Tclass.TwoStateAt.Cell $Heap@1) (= |##y#2_0@0| (LitInt 0))) (and ($IsAlloc intType (int_2_U |##y#2_0@0|) TInt $Heap@1) (= (ControlFlow 0 24) (- 0 23)))) ($IsAlloc refType call2formal@this@0 Tclass.TwoStateAt.Cell $Heap@@3)))))
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) true) (=> (and (and ($IsAlloc refType call2formal@this@0 Tclass.TwoStateAt.Cell $Heap@1) (= |##y#3_0@0| (LitInt 0))) (and ($IsAlloc intType (int_2_U |##y#3_0@0|) TInt $Heap@1) (= (ControlFlow 0 21) (- 0 20)))) ($IsAlloc refType call2formal@this@0 Tclass.TwoStateAt.Cell $Heap@@3)))))
(let ((anon11_Then_correct  (and (=> (= (ControlFlow 0 10) (- 0 19)) true) (and (=> (= (ControlFlow 0 10) (- 0 18)) (or (not (= call2formal@this@0 null)) (not true))) (=> (or (not (= call2formal@this@0 null)) (not true)) (=> ($IsAllocBox ($Box refType call2formal@this@0) Tclass.TwoStateAt.Cell? $Heap@1) (=> (and (= |##y#4_0@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##y#4_0@0|) TInt $Heap@1)) (and (=> (= (ControlFlow 0 10) (- 0 17)) ($IsAlloc refType call2formal@this@0 Tclass.TwoStateAt.Cell $Heap@0)) (=> ($IsAlloc refType call2formal@this@0 Tclass.TwoStateAt.Cell $Heap@0) (=> (|TwoStateAt.Cell.Plus#canCall| TInt $Heap@0 $Heap@1 call2formal@this@0 ($Box intType (int_2_U (LitInt 0)))) (and (=> (= (ControlFlow 0 10) (- 0 16)) true) (and (=> (= (ControlFlow 0 10) (- 0 15)) (or (not (= call2formal@this@0 null)) (not true))) (=> (or (not (= call2formal@this@0 null)) (not true)) (=> ($IsAllocBox ($Box refType call2formal@this@0) Tclass.TwoStateAt.Cell? $Heap@1) (=> (and (= |##y#4_1@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##y#4_1@0|) TInt $Heap@1)) (and (=> (= (ControlFlow 0 10) (- 0 14)) ($IsAlloc refType call2formal@this@0 Tclass.TwoStateAt.Cell $Heap@0)) (=> ($IsAlloc refType call2formal@this@0 Tclass.TwoStateAt.Cell $Heap@0) (=> (|TwoStateAt.Cell.Plus#canCall| TInt $Heap@0 $Heap@1 call2formal@this@0 ($Box intType (int_2_U (LitInt 0)))) (and (=> (= (ControlFlow 0 10) (- 0 13)) true) (and (=> (= (ControlFlow 0 10) (- 0 12)) (or (not (= call2formal@this@0 null)) (not true))) (=> (or (not (= call2formal@this@0 null)) (not true)) (=> ($IsAllocBox ($Box refType call2formal@this@0) Tclass.TwoStateAt.Cell? $Heap@1) (=> (and (= |##y#4_2@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##y#4_2@0|) TInt $Heap@1)) (and (=> (= (ControlFlow 0 10) (- 0 11)) ($IsAlloc refType call2formal@this@0 Tclass.TwoStateAt.Cell $Heap@1)) (=> ($IsAlloc refType call2formal@this@0 Tclass.TwoStateAt.Cell $Heap@1) (=> (|TwoStateAt.Cell.Plus#canCall| TInt $Heap@1 $Heap@1 call2formal@this@0 ($Box intType (int_2_U (LitInt 0)))) (=> (and (and (and (|TwoStateAt.Cell.Plus#canCall| TInt $Heap@0 $Heap@1 call2formal@this@0 ($Box intType (int_2_U (LitInt 0)))) (|TwoStateAt.Cell.Plus#canCall| TInt $Heap@0 $Heap@1 call2formal@this@0 ($Box intType (int_2_U (LitInt 0))))) (|TwoStateAt.Cell.Plus#canCall| TInt $Heap@1 $Heap@1 call2formal@this@0 ($Box intType (int_2_U (LitInt 0))))) (and (= |a#4_0@0| (+ (+ (TwoStateAt.Cell.Plus TInt $Heap@0 $Heap@1 call2formal@this@0 ($Box intType (int_2_U (LitInt 0)))) (TwoStateAt.Cell.Plus TInt $Heap@0 $Heap@1 call2formal@this@0 ($Box intType (int_2_U (LitInt 0))))) (TwoStateAt.Cell.Plus TInt $Heap@1 $Heap@1 call2formal@this@0 ($Box intType (int_2_U (LitInt 0)))))) (= (ControlFlow 0 10) (- 0 9)))) (= |a#4_0@0| (LitInt (+ (+ (+ 5 5) 405) 1215))))))))))))))))))))))))))))))
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 6) (- 0 8)) true) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (not (= call2formal@this@0 null)) (not true))) (=> (or (not (= call2formal@this@0 null)) (not true)) (=> (and (and ($IsAllocBox ($Box refType call2formal@this@0) Tclass.TwoStateAt.Cell? $Heap@1) (= |##y#5_0@0| (LitInt 0))) (and ($IsAlloc intType (int_2_U |##y#5_0@0|) TInt $Heap@1) (= (ControlFlow 0 6) (- 0 5)))) ($IsAlloc refType call2formal@this@0 Tclass.TwoStateAt.Cell $Heap@@3)))))))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= call2formal@this@0 null)) (not true))) (=> (or (not (= call2formal@this@0 null)) (not true)) (=> (and (and ($IsAllocBox ($Box refType call2formal@this@0) Tclass.TwoStateAt.Cell? $Heap@1) (= |##y#6_0@0| (LitInt 0))) (and ($IsAlloc intType (int_2_U |##y#6_0@0|) TInt $Heap@1) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType call2formal@this@0 Tclass.TwoStateAt.Cell $Heap@@3)))))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#3| null $Heap@@3 alloc false)) (= |x##0@0| (LitInt 5))) (and (or (not (= call2formal@this null)) (not true)) (and ($Is refType call2formal@this Tclass.TwoStateAt.Cell) ($IsAlloc refType call2formal@this Tclass.TwoStateAt.Cell $Heap@@3)))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (or (not (= call2formal@this@0 null)) (not true)) (and ($Is refType call2formal@this@0 Tclass.TwoStateAt.Cell) ($IsAlloc refType call2formal@this@0 Tclass.TwoStateAt.Cell $Heap@0)))) (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) TwoStateAt.Cell.data))) |x##0@0|) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 call2formal@this@0) alloc))))) (and (forall (($o@@7 T@U) ) (!  (=> (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@7) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@7)))
 :qid |TwostateVerificationdfy.244:5|
 :skolemid |801|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7))
)) ($HeapSucc $Heap@@3 $Heap@0)))) (and (=> (= (ControlFlow 0 41) (- 0 46)) true) (and (=> (= (ControlFlow 0 41) (- 0 45)) (or (not (= call2formal@this@0 null)) (not true))) (=> (or (not (= call2formal@this@0 null)) (not true)) (and (=> (= (ControlFlow 0 41) (- 0 44)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 call2formal@this@0 TwoStateAt.Cell.data))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 call2formal@this@0 TwoStateAt.Cell.data)) (and (=> (= (ControlFlow 0 41) (- 0 43)) true) (and (=> (= (ControlFlow 0 41) (- 0 42)) (or (not (= call2formal@this@0 null)) (not true))) (=> (or (not (= call2formal@this@0 null)) (not true)) (=> (= |$rhs#0@0| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) TwoStateAt.Cell.data))) 400)) (=> (and (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) TwoStateAt.Cell.data ($Box intType (int_2_U |$rhs#0@0|))))) ($IsGoodHeap $Heap@1)) (and (and (and (and (and (and (and (=> (= (ControlFlow 0 41) 2) anon9_Then_correct) (=> (= (ControlFlow 0 41) 6) anon10_Then_correct)) (=> (= (ControlFlow 0 41) 10) anon11_Then_correct)) (=> (= (ControlFlow 0 41) 21) anon12_Then_correct)) (=> (= (ControlFlow 0 41) 24) anon13_Then_correct)) (=> (= (ControlFlow 0 41) 27) anon14_Then_correct)) (=> (= (ControlFlow 0 41) 35) anon15_Then_correct)) (=> (= (ControlFlow 0 41) 40) anon15_Else_correct))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (and (=> |defass#c#0| (and ($Is refType |c#0@@5| Tclass.TwoStateAt.Cell) ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@@3))) true)) (=> (and (and (and ($Is HandleTypeType |a#0_0| (Tclass._System.___hFunc1 TInt TInt)) ($IsAlloc HandleTypeType |a#0_0| (Tclass._System.___hFunc1 TInt TInt) $Heap@@3)) true) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 47) 41))) anon0_correct))))
