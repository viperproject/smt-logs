...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|s#0| T@U) ) (!  (=> (or (|QuantifierTestsSimple.__default.f__forall#canCall| |s#0|) (and (< 1 $FunctionContextHeight) ($Is SeqType |s#0| (TSeq TInt)))) (and (forall ((|i#0| Int) ) (!  (=> (<= (LitInt 0) |i#0|) (=> (< |i#0| (|Seq#Length| |s#0|)) (|QuantifierTestsSimple.__default.byte#canCall| (U_2_int ($Unbox intType (|Seq#Index| |s#0| |i#0|))))))
 :pattern ( ($Unbox intType (|Seq#Index| |s#0| |i#0|)))
)) (= (QuantifierTestsSimple.__default.f__forall |s#0|) (forall ((|i#0@@0| Int) ) (!  (=> (and (<= (LitInt 0) |i#0@@0|) (< |i#0@@0| (|Seq#Length| |s#0|))) (QuantifierTestsSimple.__default.byte (U_2_int ($Unbox intType (|Seq#Index| |s#0| |i#0@@0|)))))
 :pattern ( ($Unbox intType (|Seq#Index| |s#0| |i#0@@0|)))
)))))
 :pattern ( (QuantifierTestsSimple.__default.f__forall |s#0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|s#0@@0| T@U) ) (!  (=> (or (|QuantifierTestsSimple.__default.f__forall#canCall| (Lit SeqType |s#0@@0|)) (and (< 1 $FunctionContextHeight) ($Is SeqType |s#0@@0| (TSeq TInt)))) (and (forall ((|i#1| Int) ) (!  (=> (<= (LitInt 0) |i#1|) (=> (< |i#1| (|Seq#Length| (Lit SeqType |s#0@@0|))) (|QuantifierTestsSimple.__default.byte#canCall| (U_2_int ($Unbox intType (|Seq#Index| (Lit SeqType |s#0@@0|) |i#1|))))))
 :pattern ( ($Unbox intType (|Seq#Index| |s#0@@0| |i#1|)))
)) (= (QuantifierTestsSimple.__default.f__forall (Lit SeqType |s#0@@0|)) (forall ((|i#1@@0| Int) ) (!  (=> (and (<= (LitInt 0) |i#1@@0|) (< |i#1@@0| (|Seq#Length| (Lit SeqType |s#0@@0|)))) (QuantifierTestsSimple.__default.byte (U_2_int ($Unbox intType (|Seq#Index| (Lit SeqType |s#0@@0|) |i#1@@0|)))))
 :pattern ( ($Unbox intType (|Seq#Index| |s#0@@0| |i#1@@0|)))
)))))
 :weight 3
 :pattern ( (QuantifierTestsSimple.__default.f__forall (Lit SeqType |s#0@@0|)))
))))
...
(let ((anon13_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#2@0|) (< |i#2@0| (|Seq#Length| |s#0@@1|)))) (= (ControlFlow 0 6) 3)) anon8_correct)))
(let ((anon13_Then_correct  (=> (and (<= (LitInt 0) |i#2@0|) (< |i#2@0| (|Seq#Length| |s#0@@1|))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (and (<= 0 |i#2@0|) (< |i#2@0| (|Seq#Length| |s#0@@1|)))) (=> (and (<= 0 |i#2@0|) (< |i#2@0| (|Seq#Length| |s#0@@1|))) (=> (and (and (= |##x#0@0| (U_2_int ($Unbox intType (|Seq#Index| |s#0@@1| |i#2@0|)))) ($IsAlloc intType (int_2_U |##x#0@0|) TInt $Heap)) (and (|QuantifierTestsSimple.__default.byte#canCall| (U_2_int ($Unbox intType (|Seq#Index| |s#0@@1| |i#2@0|)))) (= (ControlFlow 0 4) 3))) anon8_correct))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is SeqType |s#0@@1| (TSeq TInt))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct)))
