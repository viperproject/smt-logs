...
)) (forall ((|i#1_2@@0| Int) )  (=> (and (<= (LitInt 0) |i#1_2@@0|) (< |i#1_2@@0| 2)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (|Seq#Index| |q#0@0| (LitInt 0)))) _module.MyClass.f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (|Seq#Index| |q#0@0| (LitInt 0)))) _module.MyClass.f)))))) (and (=> (= (ControlFlow 0 12) 11) anon19_Then_correct) (=> (= (ControlFlow 0 12) 1) anon19_Else_correct)))))
