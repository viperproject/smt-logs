...
(set-info :boogie-vc-id Impl$$Client.__default.L1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (and reveal_Library._default.G |Library.__default.G#canCall|) (and |Library.__default.G#canCall| (= (ControlFlow 0 2) (- 0 1))))) (= (Library.__default.G reveal_Library._default.G) (LitInt 5))))))
