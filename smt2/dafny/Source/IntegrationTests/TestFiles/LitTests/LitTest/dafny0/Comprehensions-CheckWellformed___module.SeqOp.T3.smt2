...
(declare-fun _module.SeqOp.T3 (T@U Int) T@U)
(declare-fun |_module.SeqOp.T3#canCall| (T@U Int) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) (|n#0| Int) ) (!  (=> (or (|_module.SeqOp.T3#canCall| this |n#0|) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.SeqOp) ($IsAlloc refType this Tclass._module.SeqOp $Heap)))) (<= (LitInt 0) |n#0|)) (<= |n#0| (LitInt 20))))) (= (_module.SeqOp.T3 this |n#0|) (|Seq#Create| TReal $Heap |n#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#53| 20 2.5 this _module.SeqOp.x) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#82| this))))) ($LS $LZ))))))
 :qid |Comprehensionsdfy.145:12|
 :skolemid |649|
 :pattern ( (_module.SeqOp.T3 this |n#0|) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@0 T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.SeqOp.T3#canCall| this@@0 |n#0@@0|) (and (< 0 $FunctionContextHeight) (and (and (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass._module.SeqOp)) (<= (LitInt 0) |n#0@@0|)) (<= |n#0@@0| (LitInt 20))))) ($Is SeqType (_module.SeqOp.T3 this@@0 |n#0@@0|) (TSeq TReal)))
 :qid |Comprehensionsdfy.145:12|
 :skolemid |647|
 :pattern ( (_module.SeqOp.T3 this@@0 |n#0@@0|))
))))
...
(assert (forall (($h@@4 T@U) ($o@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (or (not (= $o@@5 null)) (not true)) (= (dtype $o@@5) Tclass._module.SeqOp?))) ($Is realType ($Unbox realType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@4 $o@@5) _module.SeqOp.x)) TReal))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |538|
 :pattern ( ($Unbox realType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@4 $o@@5) _module.SeqOp.x)))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@1 T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.SeqOp.T3#canCall| (Lit refType this@@1) (LitInt |n#0@@1|)) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.SeqOp) ($IsAlloc refType this@@1 Tclass._module.SeqOp $Heap@@0)))) (<= (LitInt 0) |n#0@@1|)) (<= (LitInt |n#0@@1|) (LitInt 20))))) (= (_module.SeqOp.T3 (Lit refType this@@1) (LitInt |n#0@@1|)) (|Seq#Create| TReal $Heap@@0 (LitInt |n#0@@1|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#53| 20 2.5 (Lit refType this@@1) _module.SeqOp.x) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#82| (Lit refType this@@1)))))) ($LS $LZ))))))
 :qid |Comprehensionsdfy.145:12|
 :weight 3
 :skolemid |651|
 :pattern ( (_module.SeqOp.T3 (Lit refType this@@1) (LitInt |n#0@@1|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall ((|l#0@@4| T@U) (|l#1@@1| T@U) (|l#2@@1| T@U) (|l#3@@1| Bool) ($o@@6 T@U) ($f@@0 T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@4| |l#1@@1| |l#2@@1| |l#3@@1|) $o@@6 $f@@0))  (=> (and (or (not (= $o@@6 |l#0@@4|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@1| $o@@6) |l#2@@1|)))) |l#3@@1|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |759|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@4| |l#1@@1| |l#2@@1| |l#3@@1|) $o@@6 $f@@0))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@2 T@U) (|n#0@@2| Int) ) (!  (=> (or (|_module.SeqOp.T3#canCall| this@@2 (LitInt |n#0@@2|)) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.SeqOp) ($IsAlloc refType this@@2 Tclass._module.SeqOp $Heap@@1)))) (<= (LitInt 0) |n#0@@2|)) (<= (LitInt |n#0@@2|) (LitInt 20))))) (= (_module.SeqOp.T3 this@@2 (LitInt |n#0@@2|)) (|Seq#Create| TReal $Heap@@1 (LitInt |n#0@@2|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#53| 20 2.5 this@@2 _module.SeqOp.x) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#82| this@@2))))) ($LS $LZ))))))
 :qid |Comprehensionsdfy.145:12|
 :weight 3
 :skolemid |650|
 :pattern ( (_module.SeqOp.T3 this@@2 (LitInt |n#0@@2|)) ($IsGoodHeap $Heap@@1))
))))
...
(assert (forall ((|l#0@@5| T@U) (|$l#1#heap#0@@0| T@U) (|$l#1#_v0#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#17| |l#0@@5|) |$l#1#heap#0@@0| |$l#1#_v0#0@@0|) |l#0@@5|)
 :qid |Comprehensionsdfy.71:27|
 :skolemid |772|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#17| |l#0@@5|) |$l#1#heap#0@@0| |$l#1#_v0#0@@0|))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.SeqOp.T3)
...
(let ((anon13_Then_correct  (=> (= |$_Frame#l0@0| (|lambda#47| null |$lambdaHeap#0@0| alloc this@@3)) (and (=> (= (ControlFlow 0 10) 7) anon14_Then_correct) (=> (= (ControlFlow 0 10) 8) anon14_Else_correct)))))
...
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((|seqinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| |n#0@@3|)) (Requires1 TInt TReal $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#53| 20 2.5 this@@3 _module.SeqOp.x) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#82| this@@3))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0|))))
 :qid |Comprehensionsdfy.148:5|
 :skolemid |652|
))) (=> (and (and (= |b$reqreads#0@0| (forall ((|seqinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0@@0|) (< |seqinit#0#i0#0@@0| |n#0@@3|)) (forall (($o@@7 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@2 $o@@7) alloc)))) (|Set#IsMember| (Reads1 TInt TReal $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#53| 20 2.5 this@@3 _module.SeqOp.x) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#82| this@@3))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0@@0|))) ($Box refType $o@@7))) (U_2_bool (MapType0Select refType FieldType boolType $_ReadsFrame@0 $o@@7 $f@@1)))
 :qid |Comprehensionsdfy.148:5|
 :skolemid |653|
)))
 :qid |Comprehensionsdfy.148:5|
 :skolemid |654|
))) (= (_module.SeqOp.T3 this@@3 |n#0@@3|) (|Seq#Create| TReal $Heap@@2 |n#0@@3| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#53| 20 2.5 this@@3 _module.SeqOp.x) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#82| this@@3))))) ($LS $LZ)))))) (and ($Is SeqType (_module.SeqOp.T3 this@@3 |n#0@@3|) (TSeq TReal)) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|))))
...
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (<= |n#0@@3| (LitInt 20))) (and (=> (= (ControlFlow 0 14) 1) anon11_Then_correct) (=> (= (ControlFlow 0 14) 12) anon11_Else_correct)))))
