...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (and (<= (+ |k#0| |m#0|) (_System.array.Length |a#0|)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |c#0@@1| null)) (not true))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap))) (=> (and (and (and ($Is refType |c#0@@1| (Tclass._System.array TInt)) ($IsAlloc refType |c#0@@1| (Tclass._System.array TInt) $Heap)) (and (<= (LitInt 0) |m#0|) (<= (LitInt 0) |n#0|))) (and (and (<= (LitInt 0) |k#0|) (<= (LitInt 0) |l#0@@0|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct))))
