...
(assert (forall ((d@@1 T@U) ) (!  (=> (CoRecursion.Stream.More_q d@@1) (exists ((|a#1#0#0| T@U) (|a#1#1#0| T@U) ) (! (= d@@1 (|#CoRecursion.Stream.More| |a#1#0#0| |a#1#1#0|))
 ...
 :qid |unknown.0:0|
 :skolemid |567|
 :pattern ( (CoRecursion.Stream.More_q d@@1))
)))
...
(assert (forall ((CoRecursion.Stream$T@@4 T@U) (bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 (Tclass.CoRecursion.Stream CoRecursion.Stream$T@@4)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@1)) bx@@1) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@1) (Tclass.CoRecursion.Stream CoRecursion.Stream$T@@4))))
 :qid |unknown.0:0|
 :skolemid |532|
 :pattern ( ($IsBox bx@@1 (Tclass.CoRecursion.Stream CoRecursion.Stream$T@@4)))
)))
(assert (forall ((d@@3 T@U) (CoRecursion.Stream$T@@5 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (CoRecursion.Stream.More_q d@@3) ($IsAlloc DatatypeTypeType d@@3 (Tclass.CoRecursion.Stream CoRecursion.Stream$T@@5) $h@@1))) ($IsAlloc DatatypeTypeType (CoRecursion.Stream.rest d@@3) (Tclass.CoRecursion.Stream CoRecursion.Stream$T@@5) $h@@1))
 :qid |unknown.0:0|
 :skolemid |571|
 :pattern ( ($IsAlloc DatatypeTypeType (CoRecursion.Stream.rest d@@3) (Tclass.CoRecursion.Stream CoRecursion.Stream$T@@5) $h@@1))
)))
...
(assert (forall ((CoRecursion.Stream$T@@6 T@U) (|a#2#0#0@@0| T@U) (|a#2#1#0@@0| T@U) ($h@@2 T@U) ) (!  (=> ($IsGoodHeap $h@@2) (= ($IsAlloc DatatypeTypeType (|#CoRecursion.Stream.More| |a#2#0#0@@0| |a#2#1#0@@0|) (Tclass.CoRecursion.Stream CoRecursion.Stream$T@@6) $h@@2)  (and ($IsAllocBox |a#2#0#0@@0| CoRecursion.Stream$T@@6 $h@@2) ($IsAlloc DatatypeTypeType |a#2#1#0@@0| (Tclass.CoRecursion.Stream CoRecursion.Stream$T@@6) $h@@2))))
 :qid |unknown.0:0|
 :skolemid |569|
 :pattern ( ($IsAlloc DatatypeTypeType (|#CoRecursion.Stream.More| |a#2#0#0@@0| |a#2#1#0@@0|) (Tclass.CoRecursion.Stream CoRecursion.Stream$T@@6) $h@@2))
)))
