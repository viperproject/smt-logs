...
(assert (forall ((d T@U) ($h T@U) ) (!  (=> (and ($IsGoodHeap $h) ($Is DatatypeTypeType d Tclass.Exhaustiveness.Color)) ($IsAlloc DatatypeTypeType d Tclass.Exhaustiveness.Color $h))
 :qid |unknown.0:0|
 :skolemid |1890|
 :pattern ( ($IsAlloc DatatypeTypeType d Tclass.Exhaustiveness.Color $h))
)))
...
(set-info :boogie-vc-id Impl$$Exhaustiveness.__default.Q)
...
(let ((anon6_Else_correct  (=> (or (not (= |c#0@0| |#Exhaustiveness.Color.B|)) (not true)) (and (=> (= (ControlFlow 0 5) 3) anon7_Then_correct) (=> (= (ControlFlow 0 5) 4) anon7_Else_correct)))))
(let ((anon6_Then_correct true))
(let ((anon5_Else_correct  (=> (or (not (= |c#0@0| |#Exhaustiveness.Color.A|)) (not true)) (and (=> (= (ControlFlow 0 6) 2) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (and (<= 0 |i#0|) (< |i#0| (|Seq#Length| |s#0|)))) (=> (and (<= 0 |i#0|) (< |i#0| (|Seq#Length| |s#0|))) (=> (= |c#0@0| ($Unbox DatatypeTypeType (|Seq#Index| |s#0| |i#0|))) (and (=> (= (ControlFlow 0 7) 1) anon5_Then_correct) (=> (= (ControlFlow 0 7) 6) anon5_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SeqType |s#0| (TSeq Tclass.Exhaustiveness.Color)) ($IsAlloc SeqType |s#0| (TSeq Tclass.Exhaustiveness.Color) $Heap))) (=> (and (and (and ($Is DatatypeTypeType |c#0| Tclass.Exhaustiveness.Color) ($IsAlloc DatatypeTypeType |c#0| Tclass.Exhaustiveness.Color $Heap)) true) (and (and (= 1 $FunctionContextHeight) (<= (LitInt 0) |i#0|)) (and (< |i#0| (|Seq#Length| |s#0|)) (= (ControlFlow 0 9) 7)))) anon0_correct))))
