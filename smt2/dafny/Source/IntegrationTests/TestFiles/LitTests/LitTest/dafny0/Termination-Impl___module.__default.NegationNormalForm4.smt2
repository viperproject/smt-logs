...
(let ((anon42_Else_correct  (=> (and (and (and (not (exists ((|eg$x#0_0| T@U) )  (and ($IsBox |eg$x#0_0| _module._default.NegationNormalForm4$_T0) (|Set#IsMember| |s#0@0| |eg$x#0_0|)))) (>= 0 (|Seq#Length| |q#0@0|))) (<= 123456 |a#0@0|)) (= (ControlFlow 0 4) (- 0 3))) false)))
