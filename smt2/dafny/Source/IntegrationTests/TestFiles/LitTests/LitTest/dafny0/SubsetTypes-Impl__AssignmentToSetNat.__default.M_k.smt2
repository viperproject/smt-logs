...
(let ((anon2_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (or (and ($Is SetType |x0#0| (TSet Tclass._System.nat)) (|Set#Equal| |x0#0| |x0#0|)) (or (and ($Is SetType (Lit SetType |Set#Empty|) (TSet Tclass._System.nat)) (|Set#Equal| |Set#Empty| |x0#0|)) (exists ((|$as#c0#0| T@U) )  (and ($Is SetType |$as#c0#0| (TSet Tclass._System.nat)) (|Set#Equal| |$as#c0#0| |x0#0|)))))) (=> (or (and ($Is SetType |x0#0| (TSet Tclass._System.nat)) (|Set#Equal| |x0#0| |x0#0|)) (or (and ($Is SetType (Lit SetType |Set#Empty|) (TSet Tclass._System.nat)) (|Set#Equal| |Set#Empty| |x0#0|)) (exists ((|$as#c0#0@@0| T@U) )  (and ($Is SetType |$as#c0#0@@0| (TSet Tclass._System.nat)) (|Set#Equal| |$as#c0#0@@0| |x0#0|))))) (=> (and (and ($Is SetType |c#0@0| (TSet Tclass._System.nat)) ($IsAlloc SetType |c#0@0| (TSet Tclass._System.nat) $Heap)) (|Set#Equal| |c#0@0| |x0#0|)) (and (=> (= (ControlFlow 0 11) 9) anon6_Then_correct) (=> (= (ControlFlow 0 11) 10) anon6_Else_correct)))))))
