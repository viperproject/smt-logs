...
(assert (forall ((s@@3 T@U) (i@@0 Int) (v@@3 T@U) ) (!  (and (=> (= i@@0 (|Seq#Length| s@@3)) (= (|Seq#Index| (|Seq#Build| s@@3 v@@3) i@@0) v@@3)) (=> (or (not (= i@@0 (|Seq#Length| s@@3))) (not true)) (= (|Seq#Index| (|Seq#Build| s@@3 v@@3) i@@0) (|Seq#Index| s@@3 i@@0))))
 :qid |DafnyPreludebpl.1148:15|
 :skolemid |225|
 :pattern ( (|Seq#Index| (|Seq#Build| s@@3 v@@3) i@@0))
)))
(assert (forall ((s@@4 T@U) (x@@7 T@U) ) (! (= (|Seq#Contains| s@@4 x@@7) (exists ((i@@1 Int) ) (!  (and (and (<= 0 i@@1) (< i@@1 (|Seq#Length| s@@4))) (= (|Seq#Index| s@@4 i@@1) x@@7))
...
(assert (forall ((v@@5 T@U) (t0 T@U) (h@@0 T@U) ) (! (= ($IsAlloc SeqType v@@5 (TSeq t0) h@@0) (forall ((i@@2 Int) ) (!  (=> (and (<= 0 i@@2) (< i@@2 (|Seq#Length| v@@5))) ($IsAllocBox (|Seq#Index| v@@5 i@@2) t0 h@@0))
...
(assert (forall ((s@@6 T@U) (i@@3 Int) (v@@6 T@U) ) (!  (=> (and (<= 0 i@@3) (< i@@3 (|Seq#Length| s@@6))) (= (|Seq#Length| (|Seq#Update| s@@6 i@@3 v@@6)) (|Seq#Length| s@@6)))
 :qid |DafnyPreludebpl.1167:15|
 :skolemid |228|
 :pattern ( (|Seq#Length| (|Seq#Update| s@@6 i@@3 v@@6)))
)))
...
(assert (forall ((h@@1 T@U) (v@@7 T@U) ) (! ($IsAlloc intType v@@7 TInt h@@1)
 :qid |DafnyPreludebpl.289:14|
 :skolemid |61|
 :pattern ( ($IsAlloc intType v@@7 TInt h@@1))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 6)) (and (<= 0 (LitInt 2)) (< (LitInt 2) (|Seq#Length| |s#0@1|)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (= (U_2_int ($Unbox intType (|Seq#Index| |s#0@1| (LitInt 2)))) (LitInt 3))) (=> (= (U_2_int ($Unbox intType (|Seq#Index| |s#0@1| (LitInt 2)))) (LitInt 3)) (=> (= (ControlFlow 0 4) (- 0 3)) (|Seq#Contains| |s#0@1| ($Box intType (int_2_U 3)))))))))
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (|Seq#Contains| |s#0@1| ($Box intType (int_2_U 3))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |s#0@0| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 2)))) ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 4))))))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (|Seq#Contains| |s#0@0| ($Box intType (int_2_U 3)))) (=> (|Seq#Contains| |s#0@0| ($Box intType (int_2_U 3))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s#0@0|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s#0@0|))) (=> (= |s#0@1| (|Seq#Update| |s#0@0| (LitInt 0) ($Box intType (int_2_U (LitInt 1))))) (and (=> (= (ControlFlow 0 7) 2) anon3_Then_correct) (=> (= (ControlFlow 0 7) 4) anon3_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SeqType |s#0| (TSeq TInt)) ($IsAlloc SeqType |s#0| (TSeq TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 10) 7))) anon0_correct))))
