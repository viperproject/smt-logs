...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon6_Else_correct  (=> (and (<= (LitInt 0) |x#0|) (= (ControlFlow 0 6) (- 0 5))) (<= (LitInt 0) |x#0|))))
(let ((anon6_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (<= (LitInt 0) |x#0|))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))
(let ((anon5_Then_correct  (=> (= |x#0_0@0| (LitInt (- 0 8))) (=> (and (<= (LitInt 0) |x#0|) (= (ControlFlow 0 2) (- 0 1))) (<= (LitInt 0) |x#0_0@0|)))))
