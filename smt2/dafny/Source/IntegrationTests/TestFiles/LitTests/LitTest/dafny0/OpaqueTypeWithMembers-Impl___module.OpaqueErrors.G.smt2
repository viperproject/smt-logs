...
(assert  (=> (< 0 $FunctionContextHeight) (forall (($o@@0 T@U) ) (!  (=> ($IsBox $o@@0 Tclass._module.OpaqueErrors) ($Is intType (int_2_U (_module.OpaqueErrors.y $o@@0)) TInt))
 :qid |unknown.0:0|
 :skolemid |631|
 :pattern ( (_module.OpaqueErrors.y $o@@0))
))))
...
(set-info :boogie-vc-id Impl$$_module.OpaqueErrors.G)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= (_module.OpaqueErrors.y this) 0)) (not true)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($IsBox this Tclass._module.OpaqueErrors) ($IsAllocBox this Tclass._module.OpaqueErrors $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
