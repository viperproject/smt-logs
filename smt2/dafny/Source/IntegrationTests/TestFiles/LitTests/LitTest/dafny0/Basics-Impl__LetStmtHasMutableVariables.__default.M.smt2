...
(set-info :boogie-vc-id Impl$$LetStmtHasMutableVariables.__default.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |let#0#0#0| (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 16))) ($Box intType (int_2_U (LitInt 17)))))) ($Is DatatypeTypeType |let#0#0#0| (Tclass._System.Tuple2 TInt TInt))) (=> (and (and (_System.Tuple2.___hMake2_q |let#0#0#0|) (= (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |x#Z#0@0|)) ($Box intType (int_2_U |y#Z#0@0|))) |let#0#0#0|)) (and (= |e#0@0| (let ((|y#0| (U_2_int ($Unbox intType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 16))) ($Box intType (int_2_U (LitInt 17))))))))))
(let ((|x#0| (U_2_int ($Unbox intType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 16))) ($Box intType (int_2_U (LitInt 17))))))))))
(+ |x#0| |y#0|)))) (= (ControlFlow 0 2) (- 0 1)))) (= |e#0@0| (LitInt 33)))))))
