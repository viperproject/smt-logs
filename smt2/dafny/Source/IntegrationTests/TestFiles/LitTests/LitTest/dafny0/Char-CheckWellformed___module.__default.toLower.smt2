...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.toLower)
...
(let ((anon11_Then_correct  (=> (and (<= (|char#ToInt| (Lit charType (|char#FromInt| 65))) (|char#ToInt| |ch#0@@2|)) (<= (|char#ToInt| |ch#0@@2|) (|char#ToInt| (Lit charType (|char#FromInt| 90))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (and (<= 0 (- (|char#ToInt| |ch#0@@2|) (|char#ToInt| (Lit charType (|char#FromInt| 65))))) (< (- (|char#ToInt| |ch#0@@2|) (|char#ToInt| (Lit charType (|char#FromInt| 65)))) 55296)) (and (<= 57344 (- (|char#ToInt| |ch#0@@2|) (|char#ToInt| (Lit charType (|char#FromInt| 65))))) (< (- (|char#ToInt| |ch#0@@2|) (|char#ToInt| (Lit charType (|char#FromInt| 65)))) 1114112)))) (=> (or (and (<= 0 (- (|char#ToInt| |ch#0@@2|) (|char#ToInt| (Lit charType (|char#FromInt| 65))))) (< (- (|char#ToInt| |ch#0@@2|) (|char#ToInt| (Lit charType (|char#FromInt| 65)))) 55296)) (and (<= 57344 (- (|char#ToInt| |ch#0@@2|) (|char#ToInt| (Lit charType (|char#FromInt| 65))))) (< (- (|char#ToInt| |ch#0@@2|) (|char#ToInt| (Lit charType (|char#FromInt| 65)))) 1114112))) (=> (= (ControlFlow 0 3) (- 0 2)) (or (and (<= 0 (+ (|char#ToInt| (|char#Minus| |ch#0@@2| (|char#FromInt| 65))) (|char#ToInt| (Lit charType (|char#FromInt| 97))))) (< (+ (|char#ToInt| (|char#Minus| |ch#0@@2| (|char#FromInt| 65))) (|char#ToInt| (Lit charType (|char#FromInt| 97)))) 55296)) (and (<= 57344 (+ (|char#ToInt| (|char#Minus| |ch#0@@2| (|char#FromInt| 65))) (|char#ToInt| (Lit charType (|char#FromInt| 97))))) (< (+ (|char#ToInt| (|char#Minus| |ch#0@@2| (|char#FromInt| 65))) (|char#ToInt| (Lit charType (|char#FromInt| 97)))) 1114112)))))))))
(let ((anon10_Else_correct  (=> (< (|char#ToInt| |ch#0@@2|) (|char#ToInt| (Lit charType (|char#FromInt| 65)))) (and (=> (= (ControlFlow 0 7) 3) anon11_Then_correct) (=> (= (ControlFlow 0 7) 5) anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (<= (|char#ToInt| (Lit charType (|char#FromInt| 65))) (|char#ToInt| |ch#0@@2|)) (and (=> (= (ControlFlow 0 6) 3) anon11_Then_correct) (=> (= (ControlFlow 0 6) 5) anon11_Else_correct)))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 8) 1) anon9_Then_correct) (=> (= (ControlFlow 0 8) 6) anon10_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon10_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is charType |ch#0@@2| TChar)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct)))
