...
(set-info :boogie-vc-id CheckWellformed$$ReadsAndDecreases.C.NA)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct  (=> (= |##x#0@0| (LitInt 2)) (=> (and ($IsAlloc intType (int_2_U |##x#0@0|) TInt $Heap) ($IsAlloc refType this@@6 Tclass.ReadsAndDecreases.C $Heap)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (<= 0 (LitInt 3)) (= |##x#0@0| (LitInt 3)))) (=> (or (<= 0 (LitInt 3)) (= |##x#0@0| (LitInt 3))) (=> (= (ControlFlow 0 3) (- 0 2)) (<= |##x#0@0| (LitInt 3)))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this@@6 null)) (not true)) (and ($Is refType this@@6 Tclass.ReadsAndDecreases.C) ($IsAlloc refType this@@6 Tclass.ReadsAndDecreases.C $Heap))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 5))) anon0_correct))))
