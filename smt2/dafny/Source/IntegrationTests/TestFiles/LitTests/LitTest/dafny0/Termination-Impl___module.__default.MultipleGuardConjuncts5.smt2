...
(assert (forall ((a@@10 T@U) (x@@5 T@U) ) (! (= (|MultiSet#Multiplicity| (|MultiSet#UnionOne| a@@10 x@@5) x@@5) (+ (|MultiSet#Multiplicity| a@@10 x@@5) 1))
 :qid |DafnyPreludebpl.968:15|
 :skolemid |2571|
 :pattern ( (|MultiSet#UnionOne| a@@10 x@@5))
)))
...
(assert (forall ((a@@17 T@U) (x@@8 T@U) (y@@1 T@U) ) (!  (=> (< 0 (|MultiSet#Multiplicity| a@@17 y@@1)) (< 0 (|MultiSet#Multiplicity| (|MultiSet#UnionOne| a@@17 x@@8) y@@1)))
 :qid |DafnyPreludebpl.973:15|
 :skolemid |2572|
 :pattern ( (|MultiSet#UnionOne| a@@17 x@@8) (|MultiSet#Multiplicity| a@@17 y@@1))
)))
(assert (forall ((a@@18 T@U) (x@@9 T@U) (o@@4 T@U) ) (! (= (< 0 (|MultiSet#Multiplicity| (|MultiSet#UnionOne| a@@18 x@@9) o@@4))  (or (= o@@4 x@@9) (< 0 (|MultiSet#Multiplicity| a@@18 o@@4))))
 :qid |DafnyPreludebpl.963:15|
 :skolemid |2570|
 :pattern ( (|MultiSet#Multiplicity| (|MultiSet#UnionOne| a@@18 x@@9) o@@4))
)))
...
(declare-fun _module._default.MultipleGuardConjuncts5$_T0 () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.MultipleGuardConjuncts5)
...
(let ((anon15_Else_correct  (=> (and (not |b#0@0|) (= (ControlFlow 0 16) 14)) anon5_correct)))
(let ((anon15_Then_correct  (=> (and |b#0@0| (= (ControlFlow 0 15) 14)) anon5_correct)))
(let ((anon14_Then_correct  (=> (not |$w$loop#0@0|) (and (=> (= (ControlFlow 0 17) 15) anon15_Then_correct) (=> (= (ControlFlow 0 17) 16) anon15_Else_correct)))))
(let ((anon12_correct  (and (=> (= (ControlFlow 0 4) (- 0 6)) (exists ((|$as#x0_0#0_0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0| _module._default.MultipleGuardConjuncts5$_T0) (> (|MultiSet#Multiplicity| |s#0@0| |$as#x0_0#0_0|) 0))
 :qid |Terminationdfy.974:9|
 :skolemid |3337|
))) (=> (exists ((|$as#x0_0#0_0@@0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0@@0| _module._default.MultipleGuardConjuncts5$_T0) (> (|MultiSet#Multiplicity| |s#0@0| |$as#x0_0#0_0@@0|) 0))
 :qid |Terminationdfy.974:9|
 :skolemid |3337|
)) (=> (and (=> true (and ($IsBox |x#0_0@1| _module._default.MultipleGuardConjuncts5$_T0) ($IsAllocBox |x#0_0@1| _module._default.MultipleGuardConjuncts5$_T0 $Heap))) (> (|MultiSet#Multiplicity| |s#0@0| |x#0_0@1|) 0)) (and (=> (= (ControlFlow 0 4) (- 0 5)) true) (=> (and (= |$rhs#0_0@1| (|MultiSet#Difference| |s#0@0| (|MultiSet#UnionOne| |MultiSet#Empty| |x#0_0@1|))) (= (ControlFlow 0 4) (- 0 3))) (and (|MultiSet#Subset| (ite |$rhs#0_1@1| |$rhs#0_0@1| |MultiSet#Empty|) |$decr$loop#00@1|) (not (|MultiSet#Equal| (ite |$rhs#0_1@1| |$rhs#0_0@1| |MultiSet#Empty|) |$decr$loop#00@1|))))))))))
(let ((anon18_Else_correct  (=> (and (not (and ($IsBox |x#0_1@1| _module._default.MultipleGuardConjuncts5$_T0) ($IsAllocBox |x#0_1@1| _module._default.MultipleGuardConjuncts5$_T0 $Heap))) (= (ControlFlow 0 8) 4)) anon12_correct)))
(let ((anon18_Then_correct  (=> (and (and ($IsBox |x#0_1@1| _module._default.MultipleGuardConjuncts5$_T0) ($IsAllocBox |x#0_1@1| _module._default.MultipleGuardConjuncts5$_T0 $Heap)) (= (ControlFlow 0 7) 4)) anon12_correct)))
(let ((anon17_Else_correct  (=> (and (and |b#0@0| (not (|MultiSet#Equal| |s#0@0| |MultiSet#Empty|))) (= |$decr$loop#00@1| (ite |b#0@0| |s#0@0| |MultiSet#Empty|))) (and (=> (= (ControlFlow 0 9) 7) anon18_Then_correct) (=> (= (ControlFlow 0 9) 8) anon18_Else_correct)))))
(let ((anon17_Then_correct true))
(let ((anon8_correct  (and (=> (= (ControlFlow 0 10) 2) anon17_Then_correct) (=> (= (ControlFlow 0 10) 9) anon17_Else_correct))))
(let ((anon16_Else_correct  (=> (and (not |b#0@0|) (= (ControlFlow 0 12) 10)) anon8_correct)))
(let ((anon16_Then_correct  (=> (and |b#0@0| (= (ControlFlow 0 11) 10)) anon8_correct)))
(let ((anon14_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 13) 11) anon16_Then_correct) (=> (= (ControlFlow 0 13) 12) anon16_Else_correct)))))
(let ((anon13_LoopBody_correct  (and (=> (= (ControlFlow 0 18) 17) anon14_Then_correct) (=> (= (ControlFlow 0 18) 13) anon14_Else_correct))))
(let ((anon13_LoopDone_correct true))
(let ((anon13_LoopHead_correct  (=> (=> |defass#x#0_0@0| (and ($IsBox |x#0_0@0| _module._default.MultipleGuardConjuncts5$_T0) ($IsAllocBox |x#0_0@0| _module._default.MultipleGuardConjuncts5$_T0 $Heap))) (=> (and (and (and ($Is MultiSetType |s#0@0| (TMultiSet _module._default.MultipleGuardConjuncts5$_T0)) ($IsAlloc MultiSetType |s#0@0| (TMultiSet _module._default.MultipleGuardConjuncts5$_T0) $Heap)) (not false)) (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |Terminationdfy.973:3|
 :skolemid |3335|
...
)) (|MultiSet#Subset| (ite |b#0@0| |s#0@0| |MultiSet#Empty|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 19) 1) anon13_LoopDone_correct) (=> (= (ControlFlow 0 19) 18) anon13_LoopBody_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |$decr_init$loop#00@0| (ite |$rhs#1@0| |S#0| |MultiSet#Empty|)) (= (ControlFlow 0 20) 19)) anon13_LoopHead_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is MultiSetType |S#0| (TMultiSet _module._default.MultipleGuardConjuncts5$_T0)) ($IsAlloc MultiSetType |S#0| (TMultiSet _module._default.MultipleGuardConjuncts5$_T0) $Heap))) (=> (and (and (and ($Is MultiSetType |s#0| (TMultiSet _module._default.MultipleGuardConjuncts5$_T0)) ($IsAlloc MultiSetType |s#0| (TMultiSet _module._default.MultipleGuardConjuncts5$_T0) $Heap)) true) (and (and (=> |defass#x#0_0| (and ($IsBox |x#0_0| _module._default.MultipleGuardConjuncts5$_T0) ($IsAllocBox |x#0_0| _module._default.MultipleGuardConjuncts5$_T0 $Heap))) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 21) 20)))) anon0_correct))))
