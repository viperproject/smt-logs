...
(let ((anon12_correct  (and (=> (= (ControlFlow 0 4) (- 0 6)) (exists ((|$as#x0_0#0_0| T@U) )  (and ($IsBox |$as#x0_0#0_0| _module._default.MultipleGuardConjuncts5$_T0) (> (|MultiSet#Multiplicity| |s#0@0| |$as#x0_0#0_0|) 0)))) (=> (exists ((|$as#x0_0#0_0@@0| T@U) )  (and ($IsBox |$as#x0_0#0_0@@0| _module._default.MultipleGuardConjuncts5$_T0) (> (|MultiSet#Multiplicity| |s#0@0| |$as#x0_0#0_0@@0|) 0))) (=> (and (=> true (and ($IsBox |x#0_0@1| _module._default.MultipleGuardConjuncts5$_T0) ($IsAllocBox |x#0_0@1| _module._default.MultipleGuardConjuncts5$_T0 $Heap))) (> (|MultiSet#Multiplicity| |s#0@0| |x#0_0@1|) 0)) (and (=> (= (ControlFlow 0 4) (- 0 5)) true) (=> (and (= |$rhs#0_0@1| (|MultiSet#Difference| |s#0@0| (|MultiSet#UnionOne| |MultiSet#Empty| |x#0_0@1|))) (= (ControlFlow 0 4) (- 0 3))) (and (|MultiSet#Subset| (ite |$rhs#0_1@1| |$rhs#0_0@1| |MultiSet#Empty|) |$decr$loop#00@1|) (not (|MultiSet#Equal| (ite |$rhs#0_1@1| |$rhs#0_0@1| |MultiSet#Empty|) |$decr$loop#00@1|))))))))))
