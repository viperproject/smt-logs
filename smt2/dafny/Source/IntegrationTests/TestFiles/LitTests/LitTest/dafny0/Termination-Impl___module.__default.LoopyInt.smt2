...
(set-info :boogie-vc-id Impl$$_module.__default.LoopyInt)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon8_Else_correct  (=> (and (< |x#0| 100) (= |$decr$loop#00@1| (LitInt 58))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (<= 0 |$decr$loop#00@1|) (= (LitInt 58) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (LitInt 58) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 5) (- 0 4)) (< (LitInt 58) |$decr$loop#00@1|)))))))
...
(let ((anon6_LoopHead_correct  (=> (and (not false) (= |$decr_init$loop#00@0| 58)) (=> (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |Terminationdfy.534:3|
 :skolemid |3080|
...
)) (<= (LitInt 58) |$decr_init$loop#00@0|))) (and (=> (= (ControlFlow 0 9) 1) anon6_LoopDone_correct) (=> (= (ControlFlow 0 9) 8) anon6_LoopBody_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |$decr_init$loop#00@0| (LitInt 58)) (= (ControlFlow 0 10) 9)) anon6_LoopHead_correct))))
