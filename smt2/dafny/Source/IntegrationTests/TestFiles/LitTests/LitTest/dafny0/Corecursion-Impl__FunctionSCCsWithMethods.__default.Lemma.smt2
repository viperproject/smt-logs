...
(assert (forall ((d@@2 T@U) (FunctionSCCsWithMethods.Stream$T@@3 T@U) ($h T@U) ) (!  (=> (and ($IsGoodHeap $h) (and (FunctionSCCsWithMethods.Stream.Cons_q d@@2) ($IsAlloc DatatypeTypeType d@@2 (Tclass.FunctionSCCsWithMethods.Stream FunctionSCCsWithMethods.Stream$T@@3) $h))) ($IsAllocBox (FunctionSCCsWithMethods.Stream.head d@@2) FunctionSCCsWithMethods.Stream$T@@3 $h))
 :qid |unknown.0:0|
 :skolemid |2905|
 :pattern ( ($IsAllocBox (FunctionSCCsWithMethods.Stream.head d@@2) FunctionSCCsWithMethods.Stream$T@@3 $h))
)))
...
(assert (forall ((FunctionSCCsWithMethods.Stream$T@@4 T@U) (bx@@0 T@U) ) (!  (=> ($IsBox bx@@0 (Tclass.FunctionSCCsWithMethods.Stream FunctionSCCsWithMethods.Stream$T@@4)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@0)) bx@@0) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@0) (Tclass.FunctionSCCsWithMethods.Stream FunctionSCCsWithMethods.Stream$T@@4))))
 :qid |unknown.0:0|
 :skolemid |2875|
 :pattern ( ($IsBox bx@@0 (Tclass.FunctionSCCsWithMethods.Stream FunctionSCCsWithMethods.Stream$T@@4)))
)))
(assert (forall ((d@@3 T@U) (FunctionSCCsWithMethods.Stream$T@@5 T@U) ($h@@0 T@U) ) (!  (=> (and ($IsGoodHeap $h@@0) (and (FunctionSCCsWithMethods.Stream.Cons_q d@@3) ($IsAlloc DatatypeTypeType d@@3 (Tclass.FunctionSCCsWithMethods.Stream FunctionSCCsWithMethods.Stream$T@@5) $h@@0))) ($IsAlloc DatatypeTypeType (FunctionSCCsWithMethods.Stream.tail d@@3) (Tclass.FunctionSCCsWithMethods.Stream FunctionSCCsWithMethods.Stream$T@@5) $h@@0))
 :qid |unknown.0:0|
 :skolemid |2906|
 :pattern ( ($IsAlloc DatatypeTypeType (FunctionSCCsWithMethods.Stream.tail d@@3) (Tclass.FunctionSCCsWithMethods.Stream FunctionSCCsWithMethods.Stream$T@@5) $h@@0))
)))
...
(assert (forall ((FunctionSCCsWithMethods.Stream$T@@6 T@U) (|a#2#0#0@@0| T@U) (|a#2#1#0@@0| T@U) ($h@@1 T@U) ) (!  (=> ($IsGoodHeap $h@@1) (= ($IsAlloc DatatypeTypeType (|#FunctionSCCsWithMethods.Stream.Cons| |a#2#0#0@@0| |a#2#1#0@@0|) (Tclass.FunctionSCCsWithMethods.Stream FunctionSCCsWithMethods.Stream$T@@6) $h@@1)  (and ($IsAllocBox |a#2#0#0@@0| FunctionSCCsWithMethods.Stream$T@@6 $h@@1) ($IsAlloc DatatypeTypeType |a#2#1#0@@0| (Tclass.FunctionSCCsWithMethods.Stream FunctionSCCsWithMethods.Stream$T@@6) $h@@1))))
 :qid |unknown.0:0|
 :skolemid |2904|
 :pattern ( ($IsAlloc DatatypeTypeType (|#FunctionSCCsWithMethods.Stream.Cons| |a#2#0#0@@0| |a#2#1#0@@0|) (Tclass.FunctionSCCsWithMethods.Stream FunctionSCCsWithMethods.Stream$T@@6) $h@@1))
)))
...
(declare-fun |h#0| () T@U)
(set-info :boogie-vc-id Impl$$FunctionSCCsWithMethods.__default.Lemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (<= 0 (LitInt 1)) (= (LitInt 0) (LitInt 1)))) (=> (or (<= 0 (LitInt 1)) (= (LitInt 0) (LitInt 1))) (=> (= (ControlFlow 0 2) (- 0 1)) (< (LitInt 0) (LitInt 1))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |h#0| (Tclass.FunctionSCCsWithMethods.Stream TInt)) ($IsAlloc DatatypeTypeType |h#0| (Tclass.FunctionSCCsWithMethods.Stream TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
