...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.cinterp)
...
(let ((anon15_Then_correct  (=> (and (|Set#IsMember| (|Map#Domain| |env#0@@3|) ($Box intType (int_2_U |x#Z#0@0|))) (= (ControlFlow 0 8) (- 0 7))) (|Set#IsMember| (|Map#Domain| |env#0@@3|) ($Box intType (int_2_U |x#Z#0@0|))))))
(let ((anon14_Then_correct  (=> (and (and (= |e#0@@3| (|#_module.exp.Var| |_mcc#3#0|)) (= |let#0#0#0| |_mcc#3#0|)) (and ($Is intType (int_2_U |let#0#0#0|) TInt) (= |x#Z#0@0| |let#0#0#0|))) (and (=> (= (ControlFlow 0 10) 8) anon15_Then_correct) (=> (= (ControlFlow 0 10) 9) anon15_Else_correct)))))
(let ((anon14_Else_correct true))
(let ((anon13_Else_correct  (=> (or (not (= |e#0@@3| (|#_module.exp.Num| |_mcc#2#0|))) (not true)) (and (=> (= (ControlFlow 0 11) 10) anon14_Then_correct) (=> (= (ControlFlow 0 11) 6) anon14_Else_correct)))))
(let ((anon13_Then_correct true))
(let ((anon12_Else_correct  (=> (or (not (= |e#0@@3| (|#_module.exp.Plus| |_mcc#0#0| |_mcc#1#0|))) (not true)) (and (=> (= (ControlFlow 0 12) 5) anon13_Then_correct) (=> (= (ControlFlow 0 12) 11) anon13_Else_correct)))))
(let ((anon12_Then_correct  (=> (= |e#0@@3| (|#_module.exp.Plus| |_mcc#0#0| |_mcc#1#0|)) (=> (and ($Is DatatypeTypeType |_mcc#0#0| Tclass._module.exp) ($Is DatatypeTypeType |_mcc#1#0| Tclass._module.exp)) (=> (and (and (and (= |let#2#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#2#0#0| Tclass._module.exp)) (and (= |e2#Z#0@0| |let#2#0#0|) (= |let#3#0#0| |_mcc#0#0|))) (and (and ($Is DatatypeTypeType |let#3#0#0| Tclass._module.exp) (= |e1#Z#0@0| |let#3#0#0|)) (and ($IsAlloc MapType |env#0@@3| (TMap TInt TInt) $Heap) ($IsAlloc DatatypeTypeType |e1#Z#0@0| Tclass._module.exp $Heap)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< (DtRank |e1#Z#0@0|) (DtRank |e#0@@3|))) (=> (< (DtRank |e1#Z#0@0|) (DtRank |e#0@@3|)) (=> (and (and (|_module.__default.cinterp#canCall| |env#0@@3| |e1#Z#0@0|) ($IsAlloc MapType |env#0@@3| (TMap TInt TInt) $Heap)) (and ($IsAlloc DatatypeTypeType |e2#Z#0@0| Tclass._module.exp $Heap) (= (ControlFlow 0 3) (- 0 2)))) (< (DtRank |e2#Z#0@0|) (DtRank |e#0@@3|))))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is MapType |env#0@@3| (TMap TInt TInt)) ($Is DatatypeTypeType |e#0@@3| Tclass._module.exp)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct))))
