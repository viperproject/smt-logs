...
(declare-fun _module.Opaque.H (T@U T@U T@U T@U) Int)
(declare-fun Lit (T@T T@U) T@U)
(declare-fun |_module.Opaque.H#canCall| (T@U T@U T@U T@U) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap T@U) ($Heap T@U) (this T@U) (|a#0| T@U) ) (!  (=> (or (|_module.Opaque.H#canCall| $prevHeap $Heap this (Lit refType |a#0|)) (and (< 1 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap) ($IsGoodHeap $Heap)) ($HeapSucc $prevHeap $Heap)) (and ($IsBox this Tclass._module.Opaque) ($IsAllocBox this Tclass._module.Opaque $prevHeap))) ($Is refType |a#0| (Tclass._System.array TInt))))) (= (_module.Opaque.H $prevHeap $Heap this (Lit refType |a#0|)) (ite (= (LitInt (_System.array.Length (Lit refType |a#0|))) (LitInt 100)) (+ (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap (Lit refType |a#0|)) (IndexField (LitInt 3))))) (_module.Opaque.y this)) 2) 0)))
 :qid |OpaqueTypeWithMembersdfy.17:21|
 :weight 3
 :skolemid |554|
 :pattern ( (_module.Opaque.H $prevHeap $Heap this (Lit refType |a#0|)) ($IsGoodHeap $Heap))
))))
...
(assert (forall (($prevHeap@@0 T@U) ($h0 T@U) ($h1 T@U) (this@@0 T@U) (|a#0@@0| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) ($IsBox this@@0 Tclass._module.Opaque)) (or (|_module.Opaque.H#canCall| $prevHeap@@0 $h0 this@@0 |a#0@@0|) ($Is refType |a#0@@0| (Tclass._System.array TInt)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@2 T@U) ($f T@U) ) (! true
 :qid |unknown.0:0|
 :skolemid |549|
)) (= (_module.Opaque.H $prevHeap@@0 $h0 this@@0 |a#0@@0|) (_module.Opaque.H $prevHeap@@0 $h1 this@@0 |a#0@@0|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |550|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (_module.Opaque.H $prevHeap@@0 $h1 this@@0 |a#0@@0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@1 T@U) ($Heap@@0 T@U) (this@@1 T@U) (|a#0@@1| T@U) ) (!  (=> (or (|_module.Opaque.H#canCall| $prevHeap@@1 $Heap@@0 (Lit BoxType this@@1) (Lit refType |a#0@@1|)) (and (< 1 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@1) ($IsGoodHeap $Heap@@0)) ($HeapSucc $prevHeap@@1 $Heap@@0)) (and ($IsBox this@@1 Tclass._module.Opaque) ($IsAllocBox this@@1 Tclass._module.Opaque $prevHeap@@1))) ($Is refType |a#0@@1| (Tclass._System.array TInt))))) (= (_module.Opaque.H $prevHeap@@1 $Heap@@0 (Lit BoxType this@@1) (Lit refType |a#0@@1|)) (ite (= (LitInt (_System.array.Length (Lit refType |a#0@@1|))) (LitInt 100)) (+ (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@1 (Lit refType |a#0@@1|)) (IndexField (LitInt 3))))) (_module.Opaque.y (Lit BoxType this@@1))) 2) 0)))
 :qid |OpaqueTypeWithMembersdfy.17:21|
 :weight 3
 :skolemid |555|
 :pattern ( (_module.Opaque.H $prevHeap@@1 $Heap@@0 (Lit BoxType this@@1) (Lit refType |a#0@@1|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@2 T@U) ($Heap@@1 T@U) (this@@2 T@U) (|a#0@@2| T@U) ) (!  (=> (or (|_module.Opaque.H#canCall| $prevHeap@@2 $Heap@@1 this@@2 |a#0@@2|) (and (< 1 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@2) ($IsGoodHeap $Heap@@1)) ($HeapSucc $prevHeap@@2 $Heap@@1)) (and ($IsBox this@@2 Tclass._module.Opaque) ($IsAllocBox this@@2 Tclass._module.Opaque $prevHeap@@2))) ($Is refType |a#0@@2| (Tclass._System.array TInt))))) (= (_module.Opaque.H $prevHeap@@2 $Heap@@1 this@@2 |a#0@@2|) (ite (= (_System.array.Length |a#0@@2|) (LitInt 100)) (+ (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@2 |a#0@@2|) (IndexField (LitInt 3))))) (_module.Opaque.y this@@2)) 2) 0)))
 :qid |OpaqueTypeWithMembersdfy.17:21|
 :skolemid |553|
 :pattern ( (_module.Opaque.H $prevHeap@@2 $Heap@@1 this@@2 |a#0@@2|) ($IsGoodHeap $Heap@@1))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.Opaque.H)
...
(let ((anon8_Then_correct  (=> (= (_System.array.Length |a#0@@3|) (LitInt 100)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= |a#0@@3| null)) (not true))) (=> (or (not (= |a#0@@3| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 4)) ($IsAlloc refType |a#0@@3| (Tclass._System.array? TInt) $Heap@@2)) (=> ($IsAlloc refType |a#0@@3| (Tclass._System.array? TInt) $Heap@@2) (=> (= (ControlFlow 0 3) (- 0 2)) (and (<= 0 (LitInt 3)) (< (LitInt 3) (_System.array.Length |a#0@@3|)))))))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (not (= |a#0@@3| null)) (not true))) (=> (or (not (= |a#0@@3| null)) (not true)) (and (=> (= (ControlFlow 0 7) 3) anon8_Then_correct) (=> (= (ControlFlow 0 7) 6) anon8_Else_correct))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and ($IsBox this@@3 Tclass._module.Opaque) ($IsAllocBox this@@3 Tclass._module.Opaque previous$Heap))) (=> (and (and (and ($Is refType |a#0@@3| (Tclass._System.array TInt)) ($IsAlloc refType |a#0@@3| (Tclass._System.array TInt) previous$Heap)) (= 1 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@2) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 10) 9))) anon0_correct))))
