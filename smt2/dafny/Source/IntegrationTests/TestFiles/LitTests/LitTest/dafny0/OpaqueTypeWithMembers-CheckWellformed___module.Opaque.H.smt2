...
(assert (forall (($prevHeap@@0 T@U) ($h0 T@U) ($h1 T@U) (this@@0 T@U) (|a#0@@0| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) ($IsBox this@@0 Tclass._module.Opaque)) (or (|_module.Opaque.H#canCall| $prevHeap@@0 $h0 this@@0 |a#0@@0|) ($Is refType |a#0@@0| (Tclass._System.array TInt)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@2 T@U) ($f T@U) ) true) (= (_module.Opaque.H $prevHeap@@0 $h0 this@@0 |a#0@@0|) (_module.Opaque.H $prevHeap@@0 $h1 this@@0 |a#0@@0|))))
