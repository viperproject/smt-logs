...
(declare-fun _module.SeqOp.XT1 (T@U Int) T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.SeqOp.XT1#canCall| (T@U Int) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) (|n#0| Int) ) (!  (=> (or (|_module.SeqOp.XT1#canCall| this |n#0|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.SeqOp) ($IsAlloc refType this Tclass._module.SeqOp $Heap)))) (<= (LitInt 0) |n#0|)))) (= (_module.SeqOp.XT1 this |n#0|) (|Seq#Create| TInt $Heap |n#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#14| ($Box intType (int_2_U (LitInt 7)))) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))))))
 :qid |ComprehensionsNewSyntaxdfy.164:12|
 :skolemid |681|
 :pattern ( (_module.SeqOp.XT1 this |n#0|) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@0 T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.SeqOp.XT1#canCall| this@@0 (LitInt |n#0@@0|)) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.SeqOp) ($IsAlloc refType this@@0 Tclass._module.SeqOp $Heap@@0)))) (<= (LitInt 0) |n#0@@0|)))) (= (_module.SeqOp.XT1 this@@0 (LitInt |n#0@@0|)) (|Seq#Create| TInt $Heap@@0 (LitInt |n#0@@0|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#14| ($Box intType (int_2_U (LitInt 7)))) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))))))
 :qid |ComprehensionsNewSyntaxdfy.164:12|
 :weight 3
 :skolemid |682|
 :pattern ( (_module.SeqOp.XT1 this@@0 (LitInt |n#0@@0|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@1 T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.SeqOp.XT1#canCall| this@@1 |n#0@@1|) (and (< 0 $FunctionContextHeight) (and (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 Tclass._module.SeqOp)) (<= (LitInt 0) |n#0@@1|)))) ($Is SeqType (_module.SeqOp.XT1 this@@1 |n#0@@1|) (TSeq TInt)))
 :qid |ComprehensionsNewSyntaxdfy.164:12|
 :skolemid |679|
 :pattern ( (_module.SeqOp.XT1 this@@1 |n#0@@1|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@2 T@U) (|n#0@@2| Int) ) (!  (=> (or (|_module.SeqOp.XT1#canCall| (Lit refType this@@2) (LitInt |n#0@@2|)) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.SeqOp) ($IsAlloc refType this@@2 Tclass._module.SeqOp $Heap@@1)))) (<= (LitInt 0) |n#0@@2|)))) (= (_module.SeqOp.XT1 (Lit refType this@@2) (LitInt |n#0@@2|)) (|Seq#Create| TInt $Heap@@1 (LitInt |n#0@@2|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#14| ($Box intType (int_2_U (LitInt 7)))) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))))))
 :qid |ComprehensionsNewSyntaxdfy.164:12|
 :weight 3
 :skolemid |683|
 :pattern ( (_module.SeqOp.XT1 (Lit refType this@@2) (LitInt |n#0@@2|)) ($IsGoodHeap $Heap@@1))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.SeqOp.XT1)
...
(let ((anon10_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@2 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@2 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 8) 6) anon11_Then_correct) (=> (= (ControlFlow 0 8) 7) anon11_Else_correct)))))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((|seqinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| |n#0@@3|)) (Requires1 TInt TInt $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#14| ($Box intType (int_2_U (LitInt 7)))) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0|))))
 :qid |ComprehensionsNewSyntaxdfy.165:5|
 :skolemid |684|
))) (=> (= |b$reqreads#0@0| (forall ((|seqinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0@@0|) (< |seqinit#0#i0#0@@0| |n#0@@3|)) (forall (($o@@4 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@2 $o@@4) alloc)))) (|Set#IsMember| (Reads1 TInt TInt $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#14| ($Box intType (int_2_U (LitInt 7)))) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0@@0|))) ($Box refType $o@@4))) (U_2_bool (MapType0Select refType FieldType boolType $_ReadsFrame@0 $o@@4 $f@@0)))
 :qid |ComprehensionsNewSyntaxdfy.165:5|
 :skolemid |685|
)))
 :qid |ComprehensionsNewSyntaxdfy.165:5|
 :skolemid |686|
))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((|seqinit#0#i0#0@@1| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0@@1|) (< |seqinit#0#i0#0@@1| |n#0@@3|)) ($Is intType ($Unbox intType (Apply1 TInt TInt $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#14| ($Box intType (int_2_U (LitInt 7)))) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0@@1|)))) Tclass._System.nat))
 :qid |ComprehensionsNewSyntaxdfy.165:5|
 :skolemid |687|
))) (=> (= (_module.SeqOp.XT1 this@@3 |n#0@@3|) (|Seq#Create| TInt $Heap@@2 |n#0@@3| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#14| ($Box intType (int_2_U (LitInt 7)))) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))))) (=> (and ($Is SeqType (_module.SeqOp.XT1 this@@3 |n#0@@3|) (TSeq TInt)) (= (ControlFlow 0 3) (- 0 2))) |b$reqreads#0@0|)))))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= 0 |n#0@@3|)) (=> (<= 0 |n#0@@3|) (and (=> (= (ControlFlow 0 9) 8) anon10_Then_correct) (=> (= (ControlFlow 0 9) 3) anon10_Else_correct))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (and (=> (= (ControlFlow 0 11) 1) anon9_Then_correct) (=> (= (ControlFlow 0 11) 9) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.SeqOp) ($IsAlloc refType this@@3 Tclass._module.SeqOp $Heap@@2))) (<= (LitInt 0) |n#0@@3|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 12) 11))) anon0_correct))))
