...
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 4) (- 0 7)) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (<= (LitInt 0) (LitInt 0))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (<= (LitInt 0) (LitInt 0))) (exists ((|$as#y0#0| Int) ) (<= (LitInt 0) |$as#y0#0|))))) (=> (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (<= (LitInt 0) (LitInt 0))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (<= (LitInt 0) (LitInt 0))) (exists ((|$as#y0#0@@0| Int) ) (<= (LitInt 0) |$as#y0#0@@0|)))) (=> (and (<= (LitInt 0) |y#0@0|) (= |r#0@0| (+ |x#0| 3))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (or (not (= (LitInt 3) 0)) (not true))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (= (Mod |r#0@0| (LitInt 3)) (LitInt 0))) (=> (= (Mod |r#0@0| (LitInt 3)) (LitInt 0)) (=> (and (= |r#0@1| |r#0@0|) (= (ControlFlow 0 4) 3)) GeneratedUnifiedExit_correct)))))))))
