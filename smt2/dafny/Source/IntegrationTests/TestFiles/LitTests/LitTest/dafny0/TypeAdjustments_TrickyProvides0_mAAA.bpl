...
procedure {:verboseName "TrickyProvides0.AAA.T (well-formedness)"} CheckWellFormed$$TrickyProvides0_mAAA.T(t#0: Box);
...
axiom (var u#2 := TrickyProvides0_mBBB.__default.Empty(); Lit(true))
