...
(assert  (and (forall ((t0@@3 T@T) (t1@@1 T@T) (t2 T@T) (val@@1 T@U) (m@@5 T@U) (x0@@1 T@U) (x1 T@U) ) (! (= (MapType1Select t0@@3 t1@@1 t2 (MapType1Store t0@@3 t1@@1 t2 m@@5 x0@@1 x1 val@@1) x0@@1 x1) val@@1)
...
(assert (forall ((m@@11 T@U) (v@@9 T@U) ) (! (= (|Set#IsMember| (|Map#Values| m@@11) v@@9) (exists ((u@@5 T@U) ) (!  (and (|Set#IsMember| (|Map#Domain| m@@11) u@@5) (= v@@9 (MapType0Select BoxType BoxType (|Map#Elements| m@@11) u@@5)))
...
(assert (forall ((m@@15 T@U) ) (!  (or (= m@@15 |Map#Empty|) (exists ((k@@0 T@U) (v@@11 T@U) ) (! (|Set#IsMember| (|Map#Items| m@@15) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| k@@0 v@@11)))
...
(set-info :boogie-vc-id Impl$$_module.__default.TestMapPropertyNonempty)
...
(let ((anon9_Then_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (not (|Set#Equal| (|Map#Items| |m#0|) |Set#Empty|)))))
(let ((anon8_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (not (|Set#Equal| (|Map#Values| |m#0|) |Set#Empty|)))))
(let ((anon7_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (not (|Set#Equal| (|Map#Domain| |m#0|) |Set#Empty|)))))
(let ((anon6_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= (|Map#Card| |m#0|) 0)) (not true)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |m#0| (TMap Tclass._module.MyClass (TBitvector 3))) ($IsAlloc MapType |m#0| (TMap Tclass._module.MyClass (TBitvector 3)) $Heap)) (= 1 $FunctionContextHeight)) (and (not (|Map#Equal| |m#0| |Map#Empty|)) (= (ControlFlow 0 12) 11))) anon0_correct))))
