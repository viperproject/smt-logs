...
(assert (forall (($o@@19 T@U) ) (!  (=> (and (or (not (= $o@@19 null)) (not true)) (= (dtype $o@@19) Tclass.ITER__F.RecursiveIterator?)) ($Is refType (ITER__F.RecursiveIterator.cell $o@@19) Tclass.ITER__F.Cell?))
 :qid |unknown.0:0|
 :skolemid |3130|
 :pattern ( (ITER__F.RecursiveIterator.cell $o@@19))
)))
(assert (forall (($o@@20 T@U) ) (!  (=> (and (or (not (= $o@@20 null)) (not true)) (= (dtype $o@@20) Tclass.ITER__F.RecursiveIterator?)) ($Is intType (int_2_U (ITER__F.RecursiveIterator.n $o@@20)) Tclass._System.nat))
 :qid |unknown.0:0|
 :skolemid |3132|
 :pattern ( (ITER__F.RecursiveIterator.n $o@@20))
)))
(assert (forall (($o@@21 T@U) ) (!  (=> (and (or (not (= $o@@21 null)) (not true)) (= (dtype $o@@21) Tclass.ITER__F.RecursiveIterator?)) ($Is refType (ITER__F.RecursiveIterator.r $o@@21) Tclass.ITER__F.RecIterCaller?))
 :qid |unknown.0:0|
 :skolemid |3135|
 :pattern ( (ITER__F.RecursiveIterator.r $o@@21))
)))
...
(assert (forall (($h@@15 T@U) ($o@@22 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@15) (and (or (not (= $o@@22 null)) (not true)) (= (dtype $o@@22) Tclass.ITER__F.RecursiveIterator?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@22) alloc)))) ($IsAlloc refType (ITER__F.RecursiveIterator.cell $o@@22) Tclass.ITER__F.Cell? $h@@15))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |3131|
 :pattern ( (ITER__F.RecursiveIterator.cell $o@@22) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@22) alloc)))
)))
(assert (forall (($h@@16 T@U) ($o@@23 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@16) (and (or (not (= $o@@23 null)) (not true)) (= (dtype $o@@23) Tclass.ITER__F.RecursiveIterator?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@23) alloc)))) ($IsAlloc intType (int_2_U (ITER__F.RecursiveIterator.n $o@@23)) Tclass._System.nat $h@@16))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |3133|
 :pattern ( (ITER__F.RecursiveIterator.n $o@@23) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@23) alloc)))
)))
(assert (forall (($h@@17 T@U) ($o@@24 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@17) (and (or (not (= $o@@24 null)) (not true)) (= (dtype $o@@24) Tclass.ITER__F.RecursiveIterator?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@24) alloc)))) ($IsAlloc refType (ITER__F.RecursiveIterator.r $o@@24) Tclass.ITER__F.RecIterCaller? $h@@17))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |3136|
 :pattern ( (ITER__F.RecursiveIterator.r $o@@24) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@24) alloc)))
)))
...
(assert (= (Tag Tclass.ITER__F.RecIterCaller) Tagclass.ITER__F.RecIterCaller))
(assert (= (TagFamily Tclass.ITER__F.RecIterCaller) tytagFamily$RecIterCaller))
(assert (forall (($o@@25 T@U) ) (!  (=> (and (or (not (= $o@@25 null)) (not true)) (= (dtype $o@@25) Tclass.ITER__F.RecursiveIterator?)) ($Is SetType (ITER__F.RecursiveIterator.__reads $o@@25) (TSet Tclass._System.object?)))
 :qid |unknown.0:0|
 :skolemid |3139|
 :pattern ( (ITER__F.RecursiveIterator.__reads $o@@25))
)))
(assert (forall (($o@@26 T@U) ) (!  (=> (and (or (not (= $o@@26 null)) (not true)) (= (dtype $o@@26) Tclass.ITER__F.RecursiveIterator?)) ($Is SetType (ITER__F.RecursiveIterator.__modifies $o@@26) (TSet Tclass._System.object?)))
 :qid |unknown.0:0|
 :skolemid |3141|
 :pattern ( (ITER__F.RecursiveIterator.__modifies $o@@26))
)))
...
(declare-fun |ITER__F.RecursiveIterator.Valid#canCall| (T@U T@U) Bool)
(declare-fun |defass#cell#0| () Bool)
(declare-fun |cell#0| () T@U)
(declare-fun |defass#iter#0| () Bool)
(declare-fun |iter#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$ITER__F.RecIterCaller.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 Tclass.ITER__F.Cell?)) (=> (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc)))) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 10)) true) (=> (and (or (not (= call5formal@this null)) (not true)) (and ($Is refType call5formal@this Tclass.ITER__F.RecursiveIterator) ($IsAlloc refType call5formal@this Tclass.ITER__F.RecursiveIterator $Heap))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (or (not (= this@@0 null)) (not true))) (=> (or (not (= this@@0 null)) (not true)) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and (and (or (not (= call5formal@this@0 null)) (not true)) (and ($Is refType call5formal@this@0 Tclass.ITER__F.RecursiveIterator) ($IsAlloc refType call5formal@this@0 Tclass.ITER__F.RecursiveIterator $Heap@1))) (and (= (ITER__F.RecursiveIterator.cell call5formal@this@0) $nw@0) (= (ITER__F.RecursiveIterator.n call5formal@this@0) |n#0|))) (and (and (= (ITER__F.RecursiveIterator.r call5formal@this@0) this@@0) (= (ITER__F.RecursiveIterator.good call5formal@this@0) |good#0@0|)) (and (|ITER__F.RecursiveIterator.Valid#canCall| $Heap@1 call5formal@this@0) (ITER__F.RecursiveIterator.Valid $Heap@1 call5formal@this@0)))) (and (and (and (|Set#Equal| (ITER__F.RecursiveIterator.__reads call5formal@this@0) |Set#Empty|) (|Set#Equal| (ITER__F.RecursiveIterator.__modifies call5formal@this@0) (|Set#UnionOne| |Set#Empty| ($Box refType $nw@0)))) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call5formal@this@0) ITER__F.RecursiveIterator.__new)) |Set#Empty|) (= (ITER__F.RecursiveIterator.__decreases0 call5formal@this@0) (ite (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0) ITER__F.Cell.data))) 2) |n#0| (- (+ |n#0| |n#0|) |n#0|))))) (and (and (= (ITER__F.RecursiveIterator.__decreases1 call5formal@this@0) (LitInt 0)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call5formal@this@0) alloc))))) (and (forall (($o@@29 T@U) ) (!  (=> (and (or (not (= $o@@29 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@29) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@29) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@29)))
 :qid |Iteratorsdfy.361:12|
 :skolemid |3151|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@29))
)) ($HeapSucc $Heap@0 $Heap@1))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) true) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= call5formal@this@0 null)) (not true))) (=> (or (not (= call5formal@this@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall (($o@@30 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@30 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@30) alloc)))) (or (or (= $o@@30 call5formal@this@0) (|Set#IsMember| (ITER__F.RecursiveIterator.__modifies call5formal@this@0) ($Box refType $o@@30))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call5formal@this@0) ITER__F.RecursiveIterator.__new)) ($Box refType $o@@30)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@30 $f@@1)))
 :qid |Iteratorsdfy.380:32|
 :skolemid |3173|
))) (=> (forall (($o@@31 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@31 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@31) alloc)))) (or (or (= $o@@31 call5formal@this@0) (|Set#IsMember| (ITER__F.RecursiveIterator.__modifies call5formal@this@0) ($Box refType $o@@31))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call5formal@this@0) ITER__F.RecursiveIterator.__new)) ($Box refType $o@@31)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@31 $f@@2)))
 :qid |Iteratorsdfy.380:32|
 :skolemid |3173|
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (<= 0 |n#0|) (= (ITER__F.RecursiveIterator.__decreases0 call5formal@this@0) |n#0|))) (=> (or (<= 0 |n#0|) (= (ITER__F.RecursiveIterator.__decreases0 call5formal@this@0) |n#0|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (ITER__F.RecursiveIterator.__decreases0 call5formal@this@0) |n#0|)) (=> (<= (ITER__F.RecursiveIterator.__decreases0 call5formal@this@0) |n#0|) (=> (= (ControlFlow 0 2) (- 0 1)) (ITER__F.RecursiveIterator.Valid $Heap@1 call5formal@this@0))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass.ITER__F.RecIterCaller) ($IsAlloc refType this@@0 Tclass.ITER__F.RecIterCaller $Heap))) (<= (LitInt 0) |n#0|)) (and (=> |defass#cell#0| (and ($Is refType |cell#0| Tclass.ITER__F.Cell) ($IsAlloc refType |cell#0| Tclass.ITER__F.Cell $Heap))) true)) (and (and (=> |defass#iter#0| (and ($Is refType |iter#0| Tclass.ITER__F.RecursiveIterator) ($IsAlloc refType |iter#0| Tclass.ITER__F.RecursiveIterator $Heap))) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 11) 2)))) anon0_correct))))
