...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.interp)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon17_Else_correct true))
(let ((anon17_Then_correct  (=> (and (_module.exp.Var_q |e#0@@3|) (|Set#IsMember| (|Map#Domain| |env#0@@3|) ($Box intType (int_2_U (_module.exp.x |e#0@@3|))))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (_module.exp.Var_q |e#0@@3|)) (=> (_module.exp.Var_q |e#0@@3|) (=> (= (ControlFlow 0 10) (- 0 9)) (|Set#IsMember| (|Map#Domain| |env#0@@3|) ($Box intType (int_2_U (_module.exp.x |e#0@@3|))))))))))
(let ((anon16_Else_correct  (=> (not (_module.exp.Var_q |e#0@@3|)) (and (=> (= (ControlFlow 0 15) 10) anon17_Then_correct) (=> (= (ControlFlow 0 15) 12) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (_module.exp.Var_q |e#0@@3|) (and (=> (= (ControlFlow 0 13) (- 0 14)) (_module.exp.Var_q |e#0@@3|)) (=> (_module.exp.Var_q |e#0@@3|) (and (=> (= (ControlFlow 0 13) 10) anon17_Then_correct) (=> (= (ControlFlow 0 13) 12) anon17_Else_correct)))))))
(let ((anon15_Else_correct  (=> (not (_module.exp.Num_q |e#0@@3|)) (and (=> (= (ControlFlow 0 16) 13) anon16_Then_correct) (=> (= (ControlFlow 0 16) 15) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (and (_module.exp.Num_q |e#0@@3|) (= (ControlFlow 0 8) (- 0 7))) (_module.exp.Num_q |e#0@@3|))))
(let ((anon14_Else_correct  (=> (not (_module.exp.Plus_q |e#0@@3|)) (and (=> (= (ControlFlow 0 17) 8) anon15_Then_correct) (=> (= (ControlFlow 0 17) 16) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (and (_module.exp.Plus_q |e#0@@3|) ($IsAlloc MapType |env#0@@3| (TMap TInt TInt) $Heap)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (_module.exp.Plus_q |e#0@@3|)) (=> (_module.exp.Plus_q |e#0@@3|) (=> (and (= |##e#0@0| (_module.exp.e1 |e#0@@3|)) ($IsAlloc DatatypeTypeType |##e#0@0| Tclass._module.exp $Heap)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (< (DtRank |##e#0@0|) (DtRank |e#0@@3|))) (=> (< (DtRank |##e#0@0|) (DtRank |e#0@@3|)) (=> (and (|_module.__default.interp#canCall| |env#0@@3| (_module.exp.e1 |e#0@@3|)) ($IsAlloc MapType |env#0@@3| (TMap TInt TInt) $Heap)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (_module.exp.Plus_q |e#0@@3|)) (=> (_module.exp.Plus_q |e#0@@3|) (=> (= |##e#1@0| (_module.exp.e2 |e#0@@3|)) (=> (and ($IsAlloc DatatypeTypeType |##e#1@0| Tclass._module.exp $Heap) (= (ControlFlow 0 3) (- 0 2))) (< (DtRank |##e#1@0|) (DtRank |e#0@@3|)))))))))))))))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 18) 1) anon13_Then_correct) (=> (= (ControlFlow 0 18) 3) anon14_Then_correct)) (=> (= (ControlFlow 0 18) 17) anon14_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is MapType |env#0@@3| (TMap TInt TInt)) ($Is DatatypeTypeType |e#0@@3| Tclass._module.exp)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 19) 18))) anon0_correct))))
