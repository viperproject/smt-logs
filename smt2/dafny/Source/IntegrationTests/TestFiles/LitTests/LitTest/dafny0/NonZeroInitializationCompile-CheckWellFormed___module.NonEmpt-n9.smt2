...
(assert (forall ((a@@2 T@U) (x@@10 T@U) ) (!  (=> (|Set#IsMember| a@@2 x@@10) (= (|Set#Card| (|Set#UnionOne| a@@2 x@@10)) (|Set#Card| a@@2)))
 :qid |DafnyPreludebpl.694:15|
 :skolemid |675|
 :pattern ( (|Set#Card| (|Set#UnionOne| a@@2 x@@10)))
)))
...
(assert (forall ((a@@3 T@U) (x@@13 T@U) ) (!  (=> (not (|Set#IsMember| a@@3 x@@13)) (= (|Set#Card| (|Set#UnionOne| a@@3 x@@13)) (+ (|Set#Card| a@@3) 1)))
 :qid |DafnyPreludebpl.698:15|
 :skolemid |676|
 :pattern ( (|Set#Card| (|Set#UnionOne| a@@3 x@@13)))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.NonEmptyIntSet)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon6_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (or (not (= (|Set#Card| (Lit SetType (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U (LitInt 57)))))) 0)) (not true)))))
