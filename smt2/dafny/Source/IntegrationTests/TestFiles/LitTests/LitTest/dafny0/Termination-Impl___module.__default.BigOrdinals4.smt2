...
(set-info :boogie-vc-id Impl$$_module.__default.BigOrdinals4)
...
(let ((anon13_Else_correct  (=> (|ORD#Less| |A#0| |b#0@0|) (and (=> (= (ControlFlow 0 13) 12) anon14_Then_correct) (=> (= (ControlFlow 0 13) 6) anon14_Else_correct)))))
(let ((anon13_Then_correct true))
(let ((anon12_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 14) 3) anon13_Then_correct) (=> (= (ControlFlow 0 14) 13) anon13_Else_correct)))))
