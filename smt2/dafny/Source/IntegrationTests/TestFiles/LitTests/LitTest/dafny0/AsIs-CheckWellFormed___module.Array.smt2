...
(set-info :boogie-vc-id CheckWellFormed$$_module.Array)
...
(let ((anon5_Then_correct  (=> (and ($Is refType |a#0| (Tclass._System.array TInt)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |a#0| null)) (not true)))))
