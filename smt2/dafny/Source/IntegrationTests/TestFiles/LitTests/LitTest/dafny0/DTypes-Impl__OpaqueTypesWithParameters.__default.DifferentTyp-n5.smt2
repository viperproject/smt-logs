...
(declare-fun Tclass.OpaqueTypesWithParameters.P (T@U) T@U)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |a#0| (Tclass._System.array (Tclass.OpaqueTypesWithParameters.P TInt))) ($IsAlloc refType |a#0| (Tclass._System.array (Tclass.OpaqueTypesWithParameters.P TInt)) $Heap))) (and (and ($Is refType |b#0| (Tclass._System.array (Tclass.OpaqueTypesWithParameters.P TBool))) ($IsAlloc refType |b#0| (Tclass._System.array (Tclass.OpaqueTypesWithParameters.P TBool)) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
