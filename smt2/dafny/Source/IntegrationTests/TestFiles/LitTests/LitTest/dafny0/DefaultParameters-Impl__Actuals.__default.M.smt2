...
(set-info :boogie-vc-id Impl$$Actuals.__default.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |r#0@0| (+ |a#0| (Mul (LitInt 2) |b#0|))) (= (ControlFlow 0 2) (- 0 1))) (= |r#0@0| (+ |a#0| (Mul (LitInt 2) |b#0|)))))))
