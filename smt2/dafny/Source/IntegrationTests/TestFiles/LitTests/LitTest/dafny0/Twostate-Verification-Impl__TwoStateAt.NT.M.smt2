...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#3| null current$Heap alloc false)) (= |newtype$check#0@0| (LitInt 82))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 86))) (=> (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 86)) (=> (= |newtype$check#1@0| (LitInt 82)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 86))) (=> (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 86)) (and (=> (= (ControlFlow 0 2) (- 0 6)) ($IsAllocBox |y#0| TwoStateAt.NT.M$Y $Heap)) (=> ($IsAllocBox |y#0| TwoStateAt.NT.M$Y $Heap) (and (=> (= (ControlFlow 0 2) (- 0 5)) ($IsAlloc refType |c#0@@1| Tclass.TwoStateAt.Cell $Heap)) (=> ($IsAlloc refType |c#0@@1| Tclass.TwoStateAt.Cell $Heap) (=> (<= (LitInt 0) |call7formal@n#0|) (=> (and (= call0formal@previous$Heap@0 $Heap) (= call3formal@this@0 (LitInt 82))) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAllocBox |y#0| TwoStateAt.NT.M$Y call0formal@previous$Heap@0)) (=> ($IsAllocBox |y#0| TwoStateAt.NT.M$Y call0formal@previous$Heap@0) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |c#0@@1| Tclass.TwoStateAt.Cell call0formal@previous$Heap@0)) (=> ($IsAlloc refType |c#0@@1| Tclass.TwoStateAt.Cell call0formal@previous$Heap@0) (=> (= (ControlFlow 0 2) (- 0 1)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 |c#0@@1|) TwoStateAt.Cell.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |c#0@@1|) TwoStateAt.Cell.data)))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($IsBox |y#0| TwoStateAt.NT.M$Y) ($IsAllocBox |y#0| TwoStateAt.NT.M$Y previous$Heap)) (and ($Is refType |c#0@@1| Tclass.TwoStateAt.Cell) ($IsAlloc refType |c#0@@1| Tclass.TwoStateAt.Cell previous$Heap))) (=> (and (and (and (<= (LitInt 0) |n#0|) (= 3 $FunctionContextHeight)) (and (= previous$Heap $Heap) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap)))) (and (and ($IsAllocBox |y#0| TwoStateAt.NT.M$Y previous$Heap) ($IsAlloc refType |c#0@@1| Tclass.TwoStateAt.Cell previous$Heap)) (and (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |c#0@@1|) TwoStateAt.Cell.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |c#0@@1|) TwoStateAt.Cell.data)))) (= (ControlFlow 0 9) 2)))) anon0_correct)))))
