// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/ForbidNondeterminism.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/ForbidNondeterminism-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/ForbidNondeterminism.dfy
...
procedure {:verboseName "ArrayAllocation (well-formedness)"} CheckWellFormed$$_module.__default.ArrayAllocation(n#0: int where LitInt(0) <= n#0, 
    p#0: int where LitInt(0) <= p#0, 
    q#0: int where LitInt(0) <= q#0);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "ArrayAllocation (call)"} Call$$_module.__default.ArrayAllocation(n#0: int where LitInt(0) <= n#0, 
    p#0: int where LitInt(0) <= p#0, 
    q#0: int where LitInt(0) <= q#0);
  modifies $Heap;
...
procedure {:verboseName "ArrayAllocation (correctness)"} Impl$$_module.__default.ArrayAllocation(n#0: int where LitInt(0) <= n#0, 
    p#0: int where LitInt(0) <= p#0, 
    q#0: int where LitInt(0) <= q#0)
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ArrayAllocation (correctness)"} Impl$$_module.__default.ArrayAllocation(n#0: int, p#0: int, q#0: int) returns ($_reverifyPost: bool)
{
  ...
  var $nw: ref;
  var m#0: ref
     where $Is(m#0, Tclass._System.array2(TBool))
       && $IsAlloc(m#0, Tclass._System.array2(TBool), $Heap);

    // AddMethodImpl: ArrayAllocation, Impl$$_module.__default.ArrayAllocation
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/ForbidNondeterminism.dfy(14,9)
    assume true;
    assert {:id "id0"} 0 <= n#0;
    havoc $nw;
    ...
    a#0 := $nw;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/ForbidNondeterminism.dfy(15,9)
    assume true;
    assert {:id "id2"} 0 <= p#0;
    assert {:id "id3"} 0 <= q#0;
    havoc $nw;
    ...
    assume !$Unbox(read($Heap, $nw, alloc)): bool;
    assume _System.array2.Length0($nw) == p#0;
    assume _System.array2.Length1($nw) == q#0;
    $Heap := update($Heap, $nw, alloc, $Box(true));
    assume $IsGoodHeap($Heap);
    assume $IsHeapAnchor($Heap);
    m#0 := $nw;
...
const unique class._module.CK?: ClassName;

function Tclass._module.CK?() : Ty
uses {
// Tclass._module.CK? Tag
axiom Tag(Tclass._module.CK?()) == Tagclass._module.CK?
   && TagFamily(Tclass._module.CK?()) == tytagFamily$CK;
}

const unique Tagclass._module.CK?: TyTag;

// Box/unbox axiom for Tclass._module.CK?
axiom (forall bx: Box :: 
  { $IsBox(bx, Tclass._module.CK?()) } 
  $IsBox(bx, Tclass._module.CK?())
     ==> $Box($Unbox(bx): ref) == bx && $Is($Unbox(bx): ref, Tclass._module.CK?()));

// $Is axiom for class CK
axiom (forall $o: ref :: 
  { $Is($o, Tclass._module.CK?()) } 
  $Is($o, Tclass._module.CK?())
     <==> $o == null || dtype($o) == Tclass._module.CK?());

// $IsAlloc axiom for class CK
axiom (forall $o: ref, $h: Heap :: 
  { $IsAlloc($o, Tclass._module.CK?(), $h) } 
  $IsAlloc($o, Tclass._module.CK?(), $h)
     <==> $o == null || $Unbox(read($h, $o, alloc)): bool);

const _module.CK.x: Field
uses {
axiom FDim(_module.CK.x) == 0
   && FieldOfDecl(class._module.CK?, field$x) == _module.CK.x
   && !$IsGhostField(_module.CK.x);
}

// CK.x: Type axiom
axiom (forall $h: Heap, $o: ref :: 
  { $Unbox(read($h, $o, _module.CK.x)): int } 
  $IsGoodHeap($h) && $o != null && dtype($o) == Tclass._module.CK?()
     ==> $Is($Unbox(read($h, $o, _module.CK.x)): int, TInt));

// CK.x: Allocation axiom
axiom (forall $h: Heap, $o: ref :: 
  { $Unbox(read($h, $o, _module.CK.x)): int } 
  $IsGoodHeap($h)
       && 
      $o != null
       && dtype($o) == Tclass._module.CK?()
       && $Unbox(read($h, $o, alloc)): bool
     ==> $IsAlloc($Unbox(read($h, $o, _module.CK.x)): int, TInt, $h));

const _module.CK.y: Field
uses {
axiom FDim(_module.CK.y) == 0
   && FieldOfDecl(class._module.CK?, field$y) == _module.CK.y
   && !$IsGhostField(_module.CK.y);
}

// CK.y: Type axiom
axiom (forall $h: Heap, $o: ref :: 
  { $Unbox(read($h, $o, _module.CK.y)): int } 
  $IsGoodHeap($h) && $o != null && dtype($o) == Tclass._module.CK?()
     ==> $Is($Unbox(read($h, $o, _module.CK.y)): int, TInt));

// CK.y: Allocation axiom
axiom (forall $h: Heap, $o: ref :: 
  { $Unbox(read($h, $o, _module.CK.y)): int } 
  $IsGoodHeap($h)
       && 
      $o != null
       && dtype($o) == Tclass._module.CK?()
       && $Unbox(read($h, $o, alloc)): bool
     ==> $IsAlloc($Unbox(read($h, $o, _module.CK.y)): int, TInt, $h));

procedure {:verboseName "CK.Init (well-formedness)"} CheckWellFormed$$_module.CK.Init() returns (this: ref);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "CK.Init (call)"} Call$$_module.CK.Init()
   returns (this: ref
       where this != null
         && 
        $Is(this, Tclass._module.CK())
         && $IsAlloc(this, Tclass._module.CK(), $Heap));
  modifies $Heap;
...
procedure {:verboseName "CK.Init (correctness)"} Impl$$_module.CK.Init() returns (this: ref, $_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
// $Is axiom for non-null type _module.CK
axiom (forall c#0: ref :: 
  { $Is(c#0, Tclass._module.CK()) } { $Is(c#0, Tclass._module.CK?()) } 
  $Is(c#0, Tclass._module.CK()) <==> $Is(c#0, Tclass._module.CK?()) && c#0 != null);

// $IsAlloc axiom for non-null type _module.CK
axiom (forall c#0: ref, $h: Heap :: 
  { $IsAlloc(c#0, Tclass._module.CK(), $h) } 
    { $IsAlloc(c#0, Tclass._module.CK?(), $h) } 
  $IsAlloc(c#0, Tclass._module.CK(), $h)
     <==> $IsAlloc(c#0, Tclass._module.CK?(), $h));
...
const unique tytagFamily$CK: TyTagFamily;
