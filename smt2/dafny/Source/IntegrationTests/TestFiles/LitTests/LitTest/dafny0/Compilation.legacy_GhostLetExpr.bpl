...
procedure {:verboseName "GhostLetExpr.M (well-formedness)"} CheckWellFormed$$GhostLetExpr.__default.M();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "GhostLetExpr.M (call)"} Call$$GhostLetExpr.__default.M();
  modifies $Heap;
...
procedure {:verboseName "GhostLetExpr.M (correctness)"} Impl$$GhostLetExpr.__default.M() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "GhostLetExpr.M (correctness)"} Impl$$GhostLetExpr.__default.M() returns ($_reverifyPost: bool)
{
  ...
  var let#1#0#0: int;
    ...
    // AddMethodImpl: M, Impl$$GhostLetExpr.__default.M
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    havoc y#0;
    havoc x#0;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(218,11)
    assume true;
    ##x#0 := x#0;
    ...
    assume GhostLetExpr.__default.G#canCall(x#0, y#0);
    assume GhostLetExpr.__default.G#canCall(x#0, y#0);
    g#0 := GhostLetExpr.__default.G(x#0, y#0);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(219,17)
    assume true;
    havoc ta#Z#0;
    assume GhostLetExpr.__default.F#canCall();
    assume {:id "id92"} let#0#0#0 == LitInt(GhostLetExpr.__default.F());
    assume GhostLetExpr.__default.F#canCall();
    // CheckWellformedWithResult: any expression
    assume $Is(let#0#0#0, TInt);
    assume {:id "id93"} ta#Z#0 == let#0#0#0;
    assume GhostLetExpr.__default.F#canCall();
    h#0 := (var ta#0 := LitInt(GhostLetExpr.__default.F()); LitInt(5));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(220,11)
    assume true;
    havoc tb#Z#0;
    assume GhostLetExpr.__default.F#canCall();
    assume {:id "id95"} let#1#0#0 == LitInt(GhostLetExpr.__default.F());
    assume GhostLetExpr.__default.F#canCall();
    // CheckWellformedWithResult: any expression
    assume $Is(let#1#0#0, TInt);
    assume {:id "id96"} tb#Z#0 == let#1#0#0;
    assume GhostLetExpr.__default.F#canCall();
    j#0 := (var tb#0 := LitInt(GhostLetExpr.__default.F()); LitInt(5));
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(221,5)
    assume true;
    assert {:id "id98"} h#0 == j#0;
}
...
axiom {:id "id99"} 0 <= $FunctionContextHeight
   ==> 
  GhostLetExpr.__default.F#canCall() || 0 < $FunctionContextHeight
   ==> GhostLetExpr.__default.F() == LitInt(5);
...
procedure {:verboseName "GhostLetExpr.F (well-formedness)"} CheckWellformed$$GhostLetExpr.__default.F();
...
axiom {:id "id102"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int, y#0: int :: 
    ...
    GhostLetExpr.__default.G#canCall(x#0, y#0) || 0 < $FunctionContextHeight
...
axiom {:id "id103"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int, y#0: int :: 
    ...
    GhostLetExpr.__default.G#canCall(LitInt(x#0), LitInt(y#0))
...
procedure {:verboseName "GhostLetExpr.G (well-formedness)"} CheckWellformed$$GhostLetExpr.__default.G(x#0: int, y#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "GhostLetExpr.G (well-formedness)"} CheckWellformed$$GhostLetExpr.__default.G(x#0: int, y#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    else
    {
        ...
        // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(228,5)
        assume true;
        assert {:id "id104"} y#0 == y#0;
        assume {:id "id105"} GhostLetExpr.__default.G(x#0, y#0) == x#0;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(GhostLetExpr.__default.G(x#0, y#0), TInt);
        return;
...
procedure {:verboseName "GhostLetExpr.P (well-formedness)"} CheckWellFormed$$GhostLetExpr.__default.P(dt#0: DatatypeType
       where $Is(dt#0, Tclass.GhostLetExpr.Dt())
         && $IsAlloc(dt#0, Tclass.GhostLetExpr.Dt(), $Heap)
         && $IsA#GhostLetExpr.Dt(dt#0));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "GhostLetExpr.P (call)"} Call$$GhostLetExpr.__default.P(dt#0: DatatypeType
       where $Is(dt#0, Tclass.GhostLetExpr.Dt())
         && $IsAlloc(dt#0, Tclass.GhostLetExpr.Dt(), $Heap)
         && $IsA#GhostLetExpr.Dt(dt#0));
  modifies $Heap;
...
procedure {:verboseName "GhostLetExpr.P (correctness)"} Impl$$GhostLetExpr.__default.P(dt#0: DatatypeType
       where $Is(dt#0, Tclass.GhostLetExpr.Dt())
         && $IsAlloc(dt#0, Tclass.GhostLetExpr.Dt(), $Heap)
         && $IsA#GhostLetExpr.Dt(dt#0))
...
axiom {:id "id120"} 1 <= $FunctionContextHeight
   ==> 
  GhostLetExpr.__default.FM#canCall() || 1 < $FunctionContextHeight
   ==> GhostLetExpr.__default.F#canCall()
     && (var xyz#0 := LitInt(GhostLetExpr.__default.F()); 
      GhostLetExpr.__default.G#canCall(LitInt(5), xyz#0))
     && GhostLetExpr.__default.FM()
       == (var xyz#0 := LitInt(GhostLetExpr.__default.F()); 
        LitInt(GhostLetExpr.__default.G(LitInt(5), xyz#0)));
// definition axiom for GhostLetExpr.__default.FM for all literals (revealed)
axiom {:id "id121"} 1 <= $FunctionContextHeight
   ==> 
  GhostLetExpr.__default.FM#canCall() || 1 < $FunctionContextHeight
   ==> GhostLetExpr.__default.F#canCall()
     && (var xyz#1 := LitInt(GhostLetExpr.__default.F()); 
      GhostLetExpr.__default.G#canCall(LitInt(5), xyz#1))
     && GhostLetExpr.__default.FM()
       == (var xyz#1 := LitInt(GhostLetExpr.__default.F()); 
        LitInt(GhostLetExpr.__default.G(LitInt(5), xyz#1)));
}
...
procedure {:verboseName "GhostLetExpr.FM (well-formedness)"} CheckWellformed$$GhostLetExpr.__default.FM();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
