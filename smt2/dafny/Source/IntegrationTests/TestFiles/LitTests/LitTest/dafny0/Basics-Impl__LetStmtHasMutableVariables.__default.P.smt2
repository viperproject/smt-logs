...
(set-info :boogie-vc-id Impl$$LetStmtHasMutableVariables.__default.P)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (= |y#0@0| (LitInt 17))) (=> (= (ControlFlow 0 2) (- 0 1)) (= |x#0@0| (LitInt 16))))))
(let ((anon3_Else_correct  (=> (and (or (not (= |y#0@0| (LitInt 17))) (not true)) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and (= |y#0@0| (LitInt 17)) (= (ControlFlow 0 4) 2)) anon2_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (= |let#0#0#0| (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 16))) ($Box intType (int_2_U (LitInt 17)))))) ($Is DatatypeTypeType |let#0#0#0| (Tclass._System.Tuple2 TInt TInt))) (and (_System.Tuple2.___hMake2_q |let#0#0#0|) (= (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |x#0@0|)) ($Box intType (int_2_U |y#0@0|))) |let#0#0#0|))) (and (=> (= (ControlFlow 0 6) 4) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))
