...
(set-info :boogie-vc-id Impl$$_module.__default.W2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon8_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (<= 0.0 |$decr$loop#00@1|) (= (- |n#0@2| |i#0@2|) |$decr$loop#00@1|))) (=> (or (<= 0.0 |$decr$loop#00@1|) (= (- |n#0@2| |i#0@2|) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 5) (- 0 4)) (<= (- |n#0@2| |i#0@2|) (- |$decr$loop#00@1| 1.0)))))))
(let ((anon12_Else_correct  (=> (and (and (= |n#0@1| (- |n#0@0| 1.0)) (= |i#0@2| |i#0@0|)) (and (= |n#0@2| |n#0@1|) (= (ControlFlow 0 8) 5))) anon8_correct)))
(let ((anon12_Then_correct  (=> (and (and (= |i#0@1| (+ |i#0@0| 1.0)) (= |i#0@2| |i#0@1|)) (and (= |n#0@2| |n#0@0|) (= (ControlFlow 0 7) 5))) anon8_correct)))
(let ((anon11_Else_correct  (=> (and (< |i#0@0| |n#0@0|) (= |$decr$loop#00@1| (- |n#0@0| |i#0@0|))) (and (=> (= (ControlFlow 0 9) 7) anon12_Then_correct) (=> (= (ControlFlow 0 9) 8) anon12_Else_correct)))))
...
(let ((anon9_LoopHead_correct  (=> (and (and (and (not false) (<= 0.0 |i#0@0|)) (= |$rhs#0@0| 0.0)) (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |RealComparedfy.75:3|
 :skolemid |518|
...
)) (<= (- |n#0@0| |i#0@0|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 12) 1) anon9_LoopDone_correct) (=> (= (ControlFlow 0 12) 11) anon9_LoopBody_correct)))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |$rhs#0@0| (LitReal 0.0))) (and (= |$decr_init$loop#00@0| (- |N#0| |$rhs#0@0|)) (= (ControlFlow 0 13) 12))) anon9_LoopHead_correct)))
