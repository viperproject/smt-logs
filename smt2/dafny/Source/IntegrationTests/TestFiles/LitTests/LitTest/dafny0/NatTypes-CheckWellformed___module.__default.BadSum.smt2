...
(declare-fun _module.__default.BadSum (T@U T@U) Int)
(declare-fun $LS (T@U) T@U)
(declare-fun Lit (T@T T@U) T@U)
(declare-fun DatatypeTypeType () T@T)
(declare-fun |_module.__default.BadSum#canCall| (T@U) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly T@U) (|list#0| T@U) ) (!  (=> (or (|_module.__default.BadSum#canCall| (Lit DatatypeTypeType |list#0|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |list#0| (Tclass._module.List Tclass._System.object)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |list#0|)))))) (let ((|tail#3| (Lit DatatypeTypeType (_module.List._h4 (Lit DatatypeTypeType |list#0|)))))
(|_module.__default.BadSum#canCall| |tail#3|))) (= (_module.__default.BadSum ($LS $ly) (Lit DatatypeTypeType |list#0|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |list#0|)) 0 (let ((|tail#2| (Lit DatatypeTypeType (_module.List._h4 (Lit DatatypeTypeType |list#0|)))))
(let ((|x#2| (LitInt (_module.List._h2 (Lit DatatypeTypeType |list#0|)))))
(LitInt (- (+ |x#2| (_module.__default.BadSum ($LS $ly) |tail#2|)) 30))))))))
 :qid |NatTypesdfy.137:16|
 :weight 3
 :skolemid |583|
 :pattern ( (_module.__default.BadSum ($LS $ly) (Lit DatatypeTypeType |list#0|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@0 T@U) (|list#0@@0| T@U) ) (!  (=> (or (|_module.__default.BadSum#canCall| |list#0@@0|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |list#0@@0| (Tclass._module.List Tclass._System.object)))) (and (=> (not (_module.List.Nil_q |list#0@@0|)) (let ((|tail#1| (_module.List._h4 |list#0@@0|)))
(|_module.__default.BadSum#canCall| |tail#1|))) (= (_module.__default.BadSum ($LS $ly@@0) |list#0@@0|) (ite (_module.List.Nil_q |list#0@@0|) 0 (let ((|tail#0| (_module.List._h4 |list#0@@0|)))
(let ((|x#0@@0| (_module.List._h2 |list#0@@0|)))
(- (+ |x#0@@0| (_module.__default.BadSum $ly@@0 |tail#0|)) 30)))))))
 :qid |NatTypesdfy.137:16|
 :skolemid |582|
 :pattern ( (_module.__default.BadSum ($LS $ly@@0) |list#0@@0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@1 T@U) (|list#0@@1| T@U) ) (!  (=> (or (|_module.__default.BadSum#canCall| |list#0@@1|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |list#0@@1| (Tclass._module.List Tclass._System.object)))) (<= (LitInt 0) (_module.__default.BadSum $ly@@1 |list#0@@1|)))
 :qid |NatTypesdfy.137:16|
 :skolemid |580|
 :pattern ( (_module.__default.BadSum $ly@@1 |list#0@@1|))
))))
...
(assert (forall (($ly@@2 T@U) (|list#0@@2| T@U) ) (! (= (_module.__default.BadSum ($LS $ly@@2) |list#0@@2|) (_module.__default.BadSum $ly@@2 |list#0@@2|))
 :qid |NatTypesdfy.137:16|
 :skolemid |578|
 :pattern ( (_module.__default.BadSum ($LS $ly@@2) |list#0@@2|))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.BadSum)
