...
(set-info :boogie-vc-id Impl$$Recursion.__default.B_k_h)
...
(let ((anon6_Then_correct  (=> (and (|ORD#Less| (|ORD#FromNat| 10) |_k#0|) (= |_k##0@0| (Lit BoxType (|ORD#FromNat| 10)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (or (<= 0 |x#1|) (|ORD#Less| |_k##0@0| |_k#0|)) (= |x#1| |x#1|))) (=> (or (or (<= 0 |x#1|) (|ORD#Less| |_k##0@0| |_k#0|)) (= |x#1| |x#1|)) (=> (= (ControlFlow 0 3) (- 0 2)) (or (|ORD#Less| |_k##0@0| |_k#0|) (and (= |_k##0@0| |_k#0|) (< |x#1| |x#1|)))))))))
