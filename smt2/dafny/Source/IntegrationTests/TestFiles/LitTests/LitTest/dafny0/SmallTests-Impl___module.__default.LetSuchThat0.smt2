...
(let ((anon14_Then_correct  (=> (and ($IsAlloc intType (int_2_U |q#1@0|) TInt $Heap) (|_module.__default.LetSuchThat__P#canCall| |q#1@0|)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (_module.__default.LetSuchThat__P (LitInt 0))) (exists ((|q#0| Int) ) (_module.__default.LetSuchThat__P |q#0|)))) (=> (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (_module.__default.LetSuchThat__P (LitInt 0))) (exists ((|q#0@@0| Int) ) (_module.__default.LetSuchThat__P |q#0@@0|))) (=> (and (and (_module.__default.LetSuchThat__P |q#1@0|) |$let#0$canCall|) (and |$let#0$canCall| (= |u#0@0| (let ((|q#0@@1| |$let#0_q|))
(+ |q#0@@1| 1))))) (and (=> (= (ControlFlow 0 16) 15) anon15_Then_correct) (=> (= (ControlFlow 0 16) 3) anon15_Else_correct))))))))
(let ((anon14_Else_correct true))
(let ((anon13_Then_correct  (=> ($IsAlloc intType (int_2_U |t#1@0|) TInt $Heap) (=> (and (|_module.__default.LetSuchThat__P#canCall| |t#1@0|) (|_module.__default.LetSuchThat__P#canCall| |t#1@0|)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (_module.__default.LetSuchThat__P (LitInt 0))) (exists ((|$as#t0#0| Int) ) (_module.__default.LetSuchThat__P |$as#t0#0|)))) (=> (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (_module.__default.LetSuchThat__P (LitInt 0))) (exists ((|$as#t0#0@@0| Int) ) (_module.__default.LetSuchThat__P |$as#t0#0@@0|))) (=> (_module.__default.LetSuchThat__P |t#0@0|) (and (=> (= (ControlFlow 0 18) 16) anon14_Then_correct) (=> (= (ControlFlow 0 18) 2) anon14_Else_correct)))))))))
