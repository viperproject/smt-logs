...
(set-info :boogie-vc-id Impl$$Tight.MyNumber.Inc)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#2| null $Heap@@1 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) Tight.MyNumber.Repr)))) (=> (and (and (and (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@3 Tight.MyNumber.N)) (= |$rhs#0@0| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) Tight.MyNumber.N))) 2))) (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) Tight.MyNumber.N ($Box intType (int_2_U |$rhs#0@0|))))) ($IsGoodHeap $Heap@0))) (and (and ($IsAllocBox ($Box refType this@@3) Tclass.Tight.MyNumber? $Heap@0) (|Tight.MyNumber.CustomValid#canCall| $Heap@0 this@@3)) (and (|Tight.MyNumber.CustomValid#canCall| $Heap@0 this@@3) (Tight.MyNumber.CustomValid $Heap@0 this@@3)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> false (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) Tight.MyNumber.N))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) Tight.MyNumber.N)))))) (=> (=> false (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) Tight.MyNumber.N))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) Tight.MyNumber.N))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> false (=> (|Tight.MyNumber.Valid#canCall| $Heap@0 this@@3) (or (Tight.MyNumber.Valid $Heap@0 this@@3) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) Tight.MyNumber.Repr)) ($Box refType this@@3)))))) (=> (=> false (=> (|Tight.MyNumber.Valid#canCall| $Heap@0 this@@3) (or (Tight.MyNumber.Valid $Heap@0 this@@3) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) Tight.MyNumber.Repr)) ($Box refType this@@3))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> false (=> (|Tight.MyNumber.Valid#canCall| $Heap@0 this@@3) (or (Tight.MyNumber.Valid $Heap@0 this@@3) (<= (LitInt 0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) Tight.MyNumber.N)))))))) (=> (=> false (=> (|Tight.MyNumber.Valid#canCall| $Heap@0 this@@3) (or (Tight.MyNumber.Valid $Heap@0 this@@3) (<= (LitInt 0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) Tight.MyNumber.N))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> false (=> (|Tight.MyNumber.Valid#canCall| $Heap@0 this@@3) (or (Tight.MyNumber.Valid $Heap@0 this@@3) (Tight.MyNumber.CustomValid $Heap@0 this@@3))))) (=> (=> false (=> (|Tight.MyNumber.Valid#canCall| $Heap@0 this@@3) (or (Tight.MyNumber.Valid $Heap@0 this@@3) (Tight.MyNumber.CustomValid $Heap@0 this@@3)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> false (and (forall (($o@@10 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) Tight.MyNumber.Repr)) ($Box refType $o@@10)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) Tight.MyNumber.Repr)) ($Box refType $o@@10)))) (or (not (= $o@@10 null)) (not true)))
 :qid |Predicatesdfy.31:26|
 :skolemid |1023|
 :pattern (  (or (not (= $o@@10 null)) (not true)))
)) (forall (($o@@11 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) Tight.MyNumber.Repr)) ($Box refType $o@@11)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) Tight.MyNumber.Repr)) ($Box refType $o@@11)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@11) alloc)))))
 :qid |Predicatesdfy.31:26|
 :skolemid |1024|
...
))))) (=> (=> false (and (forall (($o@@12 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) Tight.MyNumber.Repr)) ($Box refType $o@@12)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) Tight.MyNumber.Repr)) ($Box refType $o@@12)))) (or (not (= $o@@12 null)) (not true)))
 :qid |Predicatesdfy.31:26|
 :skolemid |1023|
 :pattern (  (or (not (= $o@@12 null)) (not true)))
)) (forall (($o@@13 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) Tight.MyNumber.Repr)) ($Box refType $o@@13)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) Tight.MyNumber.Repr)) ($Box refType $o@@13)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@13) alloc)))))
 :qid |Predicatesdfy.31:26|
 :skolemid |1024|
...
)))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) Tight.MyNumber.N))) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) Tight.MyNumber.N))) 2)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.Tight.MyNumber) ($IsAlloc refType this@@3 Tclass.Tight.MyNumber $Heap@@1))) (= 2 $FunctionContextHeight)) (and (and (|Tight.MyNumber.Valid#canCall| $Heap@@1 this@@3) (and (Tight.MyNumber.Valid $Heap@@1 this@@3) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) Tight.MyNumber.Repr)) ($Box refType this@@3)) (<= (LitInt 0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) Tight.MyNumber.N))))) (Tight.MyNumber.CustomValid $Heap@@1 this@@3)))) (= (ControlFlow 0 8) 2))) anon0_correct))))
