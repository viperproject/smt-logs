...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |b#0@0| (U_2_bool (Lit boolType (bool_2_U true)))) (= (ControlFlow 0 2) (- 0 1))) (and (not |c#0|) |b#0@0|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 0 $FunctionContextHeight)) (and (not |c#0|) (= (ControlFlow 0 3) 2))) anon0_correct)))
