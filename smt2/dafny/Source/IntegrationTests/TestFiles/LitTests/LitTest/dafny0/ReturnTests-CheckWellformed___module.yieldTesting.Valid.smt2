...
(assert (distinct TagSet alloc allocName Tagclass._System.object? Tagclass._System.object class._module.yieldTesting? Tagclass._module.yieldTesting? Tagclass._module.yieldTesting tytagFamily$object tytagFamily$yieldTesting field$_new)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 Tclass._module.yieldTesting?) (and (= ($Box refType ($Unbox refType bx@@2)) bx@@2) ($Is refType ($Unbox refType bx@@2) Tclass._module.yieldTesting?)))
 :qid |unknown.0:0|
 :skolemid |512|
 :pattern ( ($IsBox bx@@2 Tclass._module.yieldTesting?))
)))
(assert (forall ((bx@@3 T@U) ) (!  (=> ($IsBox bx@@3 Tclass._module.yieldTesting) (and (= ($Box refType ($Unbox refType bx@@3)) bx@@3) ($Is refType ($Unbox refType bx@@3) Tclass._module.yieldTesting)))
 :qid |unknown.0:0|
 :skolemid |530|
 :pattern ( ($IsBox bx@@3 Tclass._module.yieldTesting))
)))
...
(assert (forall (($h@@3 T@U) ($o@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (or (not (= $o@@3 null)) (not true)) (= (dtype $o@@3) Tclass._module.yieldTesting?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@3) _module.yieldTesting.__new)) (TSet Tclass._System.object?)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |527|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@3) _module.yieldTesting.__new)))
)))
(assert (forall (($h@@4 T@U) ($o@@4 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@4) (and (or (not (= $o@@4 null)) (not true)) (= (dtype $o@@4) Tclass._module.yieldTesting?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@4) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@4) _module.yieldTesting.__new)) (TSet Tclass._System.object?) $h@@4))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |528|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@4) _module.yieldTesting.__new)))
)))
...
(assert (= (Tag Tclass._module.yieldTesting) Tagclass._module.yieldTesting))
(assert (= (TagFamily Tclass._module.yieldTesting) tytagFamily$yieldTesting))
(assert (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (= (dtype $o@@6) Tclass._module.yieldTesting?)) ($Is SetType (_module.yieldTesting.__reads $o@@6) (TSet Tclass._System.object?)))
 :qid |unknown.0:0|
 :skolemid |523|
 :pattern ( (_module.yieldTesting.__reads $o@@6))
)))
(assert (forall (($h@@5 T@U) ($o@@7 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@5) (and (or (not (= $o@@7 null)) (not true)) (= (dtype $o@@7) Tclass._module.yieldTesting?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@7) alloc)))) ($IsAlloc SetType (_module.yieldTesting.__reads $o@@7) (TSet Tclass._System.object?) $h@@5))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |524|
 :pattern ( (_module.yieldTesting.__reads $o@@7) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@7) alloc)))
)))
(push 1)
...
(set-info :boogie-vc-id CheckWellformed$$_module.yieldTesting.Valid)
...
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#7| null $Heap alloc this (_module.yieldTesting.__reads this) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.yieldTesting.__new)))) (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this _module.yieldTesting.__new)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 3) 1) anon4_Then_correct) (=> (= (ControlFlow 0 3) 2) anon4_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.yieldTesting) ($IsAlloc refType this Tclass._module.yieldTesting $Heap))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 3))) anon0_correct))))
