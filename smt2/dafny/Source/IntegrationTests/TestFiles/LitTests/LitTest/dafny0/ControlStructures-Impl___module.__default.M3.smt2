...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |d#0| Tclass._module.D) ($IsAlloc DatatypeTypeType |d#0| Tclass._module.D $Heap)) (|$IsA#_module.D| |d#0|)) (= 1 $FunctionContextHeight)) (and (|_module.D#Equal| |d#0| |#_module.D.Green|) (= (ControlFlow 0 16) 15))) anon0_correct))))
