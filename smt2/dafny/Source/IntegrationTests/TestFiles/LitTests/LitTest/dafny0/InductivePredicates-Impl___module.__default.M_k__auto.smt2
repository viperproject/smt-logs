...
(set-info :boogie-vc-id Impl$$_module.__default.M_k__auto)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.natinf| |x#0@@7|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#k0#0| T@U) (|$ih#x0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#x0#0| Tclass._module.natinf) (_module.__default.Even_h ($LS $LZ) |$ih#k0#0| |$ih#x0#0|)) (or (|ORD#Less| |$ih#k0#0| |k#0|) (and (= |$ih#k0#0| |k#0|) (< (DtRank |$ih#x0#0|) (DtRank |x#0@@7|))))) (and (_module.natinf.N_q |$ih#x0#0|) (= (Mod (_module.natinf.n |$ih#x0#0|) (LitInt 2)) (LitInt 0))))
 :qid |InductivePredicatesdfy.39:15|
 :skolemid |2858|
 :pattern ( (_module.__default.Even_h ($LS $LZ) |$ih#k0#0| |$ih#x0#0|))
)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (_module.natinf.N_q |x#0@@7|)) (=> (_module.natinf.N_q |x#0@@7|) (=> (= (ControlFlow 0 2) (- 0 1)) (= (Mod (_module.natinf.n |x#0@@7|) (LitInt 2)) (LitInt 0)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |x#0@@7| Tclass._module.natinf) ($IsAlloc DatatypeTypeType |x#0@@7| Tclass._module.natinf $Heap)) (|$IsA#_module.natinf| |x#0@@7|)) (= 3 $FunctionContextHeight)) (and (and (|_module.__default.Even_h#canCall| |k#0| |x#0@@7|) (and (_module.__default.Even_h ($LS $LZ) |k#0| |x#0@@7|) (and (=> (< 0 (|ORD#Offset| |k#0|)) (or (and (_module.natinf.N_q |x#0@@7|) (= (_module.natinf.n |x#0@@7|) (LitInt 0))) (and (and (_module.natinf.N_q |x#0@@7|) (<= (LitInt 2) (_module.natinf.n |x#0@@7|))) (_module.__default.Even_h ($LS $LZ) (|ORD#Minus| |k#0| (|ORD#FromNat| 1)) (|#_module.natinf.N| (- (_module.natinf.n |x#0@@7|) 2)))))) (=> (= (LitInt 0) (|ORD#Offset| |k#0|)) (exists ((|_k'#1@@1| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#1@@1| |k#0|) (_module.__default.Even_h ($LS $LZ) |_k'#1@@1| |x#0@@7|))
 :qid |InductivePredicatesdfy.6:17|
 :skolemid |2857|
 :pattern ( (_module.__default.Even_h ($LS $LZ) |_k'#1@@1| |x#0@@7|))
