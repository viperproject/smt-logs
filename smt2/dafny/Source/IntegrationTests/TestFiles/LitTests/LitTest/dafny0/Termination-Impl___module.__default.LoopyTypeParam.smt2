...
(declare-fun _module._default.LoopyTypeParam$Y () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.LoopyTypeParam)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon8_Else_correct  (=> (and (< |x#0| 100) (= (ControlFlow 0 5) (- 0 4))) false)))
...
)) (= |y#0| |y#0|))) (and (=> (= (ControlFlow 0 8) 1) anon6_LoopDone_correct) (=> (= (ControlFlow 0 8) 7) anon6_LoopBody_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($IsBox |y#0| _module._default.LoopyTypeParam$Y) ($IsAllocBox |y#0| _module._default.LoopyTypeParam$Y $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct))))
