...
(declare-fun BodyFree.__default.F (Int) Int)
(declare-fun |BodyFree.__default.F#canCall| (Int) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0| Int) ) (!  (=> (or (|BodyFree.__default.F#canCall| |x#0|) (< 0 $FunctionContextHeight)) (<= (LitInt 0) (BodyFree.__default.F |x#0|)))
 :qid |Refinementdfy.77:20|
 :skolemid |2968|
 :pattern ( (BodyFree.__default.F |x#0|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$BodyFree.__default.F)
