...
(set-info :boogie-vc-id Impl$$_module.__default.IL__Best_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (_module.natinf.N_q |x#1|)) (=> (_module.natinf.N_q |x#1|) (=> (= (ControlFlow 0 2) (- 0 1)) (= (Mod (_module.natinf.n |x#1|) (LitInt 2)) (LitInt 0)))))))
(let ((anon3_Else_correct  (=> (<= (|ORD#Offset| |_k#0@@5|) 0) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1)) (and (forall ((|_k'#2@@1| T@U) (|x#2| T@U) ) (!  (=> (and ($Is DatatypeTypeType |x#2| Tclass._module.natinf) (and (|ORD#Less| |_k'#2@@1| |_k#0@@5|) (_module.__default.Even_h ($LS $LZ) |_k'#2@@1| |x#2|))) (and (_module.natinf.N_q |x#2|) (= (Mod (_module.natinf.n |x#2|) (LitInt 2)) (LitInt 0))))
 :qid |InductivePredicatesdfy.70:13|
 :skolemid |2882|
...
(let ((anon3_Then_correct  (=> (and (< 0 (|ORD#Offset| |_k#0@@5|)) (= (ControlFlow 0 4) 2)) GeneratedUnifiedExit_correct)))
