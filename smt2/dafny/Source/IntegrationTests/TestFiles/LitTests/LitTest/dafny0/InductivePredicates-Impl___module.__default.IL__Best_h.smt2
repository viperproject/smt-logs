...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let (($generated@@196  (and (=> (= (ControlFlow 0 2) (- 0 3)) ($generated@@54 $generated@@186)) (=> ($generated@@54 $generated@@186) (=> (= (ControlFlow 0 2) (- 0 1)) (= ($generated@@164 ($generated@@60 $generated@@186) ($generated@@49 2)) ($generated@@49 0)))))))
...
)) (= (ControlFlow 0 5) 2))) $generated@@196))))
(let (($generated@@200  (=> (and (< 0 ($generated@@40 $generated@@187)) (= (ControlFlow 0 4) 2)) $generated@@196)))
...
)))) (and (=> (= (ControlFlow 0 6) 4) $generated@@200) (=> (= (ControlFlow 0 6) 5) $generated@@197))))))
...
)))))) (= (ControlFlow 0 7) 6))) $generated@@201))))
$generated@@204))))))
))
(check-sat)
(get-info :rlimit)
