...
(assert (forall (($prevHeap@@2 T@U) ($h0 T@U) ($h1 T@U) (|d#0| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|Hof.D.Q#canCall| $prevHeap@@2 $h0 |d#0|) ($Is refType |d#0| Tclass.Hof.D))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@3 T@U) ($f T@U) )  (=> (and (or (not (= $o@@3 null)) (not true)) (= $o@@3 |d#0|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@3) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@3) $f)))) (= (Hof.D.Q $prevHeap@@2 $h0 |d#0|) (Hof.D.Q $prevHeap@@2 $h1 |d#0|))))
