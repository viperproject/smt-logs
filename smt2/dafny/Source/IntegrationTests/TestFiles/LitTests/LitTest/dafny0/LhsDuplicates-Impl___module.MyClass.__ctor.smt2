...
(declare-fun |t#0| () T@U)
(declare-fun _module.MyClass$T@@11 () T@U)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($IsBox |t#0| _module.MyClass$T@@11) ($IsAllocBox |t#0| _module.MyClass$T@@11 $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
