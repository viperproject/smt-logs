// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/OpaqueTypeWithMembersE.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/OpaqueTypeWithMembersE-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/OpaqueTypeWithMembersE.dfy
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "M (correctness)"} Impl$$_module.__default.M() returns (r#0: Box, $_reverifyPost: bool)
{
  ...
  var r#1: Box;
    ...
    $_reverifyPost := false;
    // ----- assign-such-that statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/OpaqueTypeWithMembersE.dfy(20,5)
    havoc r#1;
...
procedure {:verboseName "N (well-formedness)"} CheckWellFormed$$_module.__default.N() returns (x#0: int);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "N (call)"} Call$$_module.__default.N() returns (x#0: int);
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "N (correctness)"} Impl$$_module.__default.N() returns (x#0: int, $_reverifyPost: bool);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "N (correctness)"} Impl$$_module.__default.N() returns (x#0: int, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var s#0: real;
  var valueOrError0#0: Box
     where $IsBox(valueOrError0#0, Tclass._module.FailureCompatible())
       && $IsAllocBox(valueOrError0#0, Tclass._module.FailureCompatible(), $Heap);
  var $rhs##0: Box;
  var t#0: real;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assign-or-return statement (:-) ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/OpaqueTypeWithMembersE.dfy(24,9)
    havoc valueOrError0#0 /* where $IsBox(valueOrError0#0, Tclass._module.FailureCompatible())
       && $IsAllocBox(valueOrError0#0, Tclass._module.FailureCompatible(), $Heap) */;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/OpaqueTypeWithMembersE.dfy(24,13)
    assume true;
    // TrCallStmt: Adding lhs with type FailureCompatible
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id2"} $rhs##0 := Call$$_module.__default.M();
    // TrCallStmt: After ProcessCallStmt
    valueOrError0#0 := $rhs##0;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/OpaqueTypeWithMembersE.dfy(24,9)
    // assume allocatedness for receiver argument to function
    assume $IsAllocBox(valueOrError0#0, Tclass._module.FailureCompatible(), $Heap);
    assume _module.FailureCompatible.IsFailure#canCall(valueOrError0#0);
    assume _module.FailureCompatible.IsFailure#canCall(valueOrError0#0);
    if (_module.FailureCompatible.IsFailure(valueOrError0#0))
    {
        push;
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/OpaqueTypeWithMembersE.dfy(24,9)
        assume true;
        // assume allocatedness for receiver argument to function
        assume $IsAllocBox(valueOrError0#0, Tclass._module.FailureCompatible(), $Heap);
        assert {:id "id4"} {:subsumption 0} _module.FailureCompatible.IsFailure#canCall(valueOrError0#0)
           ==> _module.FailureCompatible.IsFailure(valueOrError0#0)
             || _module.FailureCompatible.c(valueOrError0#0) < 10;
        assume _module.FailureCompatible.IsFailure(valueOrError0#0);
        assume _module.FailureCompatible.PropagateFailure#canCall(valueOrError0#0);
        assume _module.FailureCompatible.PropagateFailure#canCall(valueOrError0#0);
        x#0 := _module.FailureCompatible.PropagateFailure(valueOrError0#0);
        // ----- return statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/OpaqueTypeWithMembersE.dfy(24,9)
        pop;
        return;
    ...
    // assume allocatedness for receiver argument to function
    assume $IsAllocBox(valueOrError0#0, Tclass._module.FailureCompatible(), $Heap);
    assert {:id "id6"} {:subsumption 0} !_module.FailureCompatible.IsFailure(valueOrError0#0);
    assume !_module.FailureCompatible.IsFailure(valueOrError0#0);
    assume _module.FailureCompatible.Extract#canCall(valueOrError0#0);
    assume _module.FailureCompatible.Extract#canCall(valueOrError0#0);
    s#0 := _module.FailureCompatible.Extract(valueOrError0#0);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/OpaqueTypeWithMembersE.dfy(25,15)
    assume true;
    assume true;
    t#0 := s#0;
}
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "FailureCompatible.PropagateFailure (well-formedness)"} CheckWellformed$$_module.FailureCompatible.PropagateFailure(this: Box)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    assume {:id "id14"} _module.FailureCompatible.IsFailure(this);
    ...
    else
    {
        ...
        assert {:id "id15"} _module.FailureCompatible.c(this) - 10 != 0;
        assume {:id "id16"} _module.FailureCompatible.PropagateFailure(this)
           == Div(100, _module.FailureCompatible.c(this) - 10);
        assume true;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "FailureCompatible.Extract (well-formedness)"} CheckWellformed$$_module.FailureCompatible.Extract(this: Box)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    assume $IsAllocBox(this, Tclass._module.FailureCompatible(), $Heap);
    assume _module.FailureCompatible.IsFailure#canCall(this);
    assume {:id "id19"} !_module.FailureCompatible.IsFailure(this);
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    ...
    {
        // Check well-formedness of body and result subset type constraint
        assert {:id "id20"} Real(_module.FailureCompatible.c(this)) != 0e0;
        assume {:id "id21"} _module.FailureCompatible.Extract(this)
           == 1e2 / Real(_module.FailureCompatible.c(this));
        assume true;
        // CheckWellformedWithResult: any expression
