...
(declare-fun $LZ () T@U)
(declare-fun |r#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.RotateD)
...
(let ((anon13_correct  (and (=> (= (ControlFlow 0 7) (- 0 11)) (and (<= 0 (ite (= (- (_System.array.Length |a#0|) 1) |i#0_0@0|) 0 (+ |i#0_0@0| 1))) (< (ite (= (- (_System.array.Length |a#0|) 1) |i#0_0@0|) 0 (+ |i#0_0@0| 1)) (_System.array.Length $nw@0)))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (ite (= (- (_System.array.Length |a#0|) 1) |i#0_0@0|) 0 (+ |i#0_0@0| 1)))))) (=> (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (ite (= (- (_System.array.Length |a#0|) 1) |i#0_0@0|) 0 (+ |i#0_0@0| 1))))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (and ($IsAlloc intType (int_2_U |i#0_0@0|) TInt $Heap@0) (|_module.__default.Id#canCall| |i#0_0@0|)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (and (<= 0 (_module.__default.Id |i#0_0@0|)) (< (_module.__default.Id |i#0_0@0|) (_System.array.Length |a#0|)))) (=> (|_module.__default.Id#canCall| |i#0_0@0|) (=> (and (and (<= (LitInt 0) |i#0_1@0|) (< |i#0_1@0| (_System.array.Length |a#0|))) (and (or (not (= |i#0_0@0| |i#0_1@0|)) (not true)) (= (ControlFlow 0 7) (- 0 6)))) (or (or (or (not (= $nw@0 $nw@0)) (not true)) (or (not (= (IndexField (ite (= (- (_System.array.Length |a#0|) 1) |i#0_0@0|) 0 (+ |i#0_0@0| 1))) (IndexField (ite (= (- (_System.array.Length |a#0|) 1) |i#0_1@0|) 0 (+ |i#0_1@0| 1))))) (not true))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (_module.__default.Id |i#0_0@0|))) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (_module.__default.Id |i#0_1@0|))))))))))))))))
(let ((anon21_Else_correct  (=> (and (or (not (= (- (_System.array.Length |a#0|) 1) |i#0_0@0|)) (not true)) (= (ControlFlow 0 13) 7)) anon13_correct)))
(let ((anon21_Then_correct  (=> (and (= (- (_System.array.Length |a#0|) 1) |i#0_0@0|) (= (ControlFlow 0 12) 7)) anon13_correct)))
...
)))) (and (and (forall ((|i#inv#0_0@@0| Int) ) (!  (=> (and (and (<= (LitInt 0) (- |i#inv#0_0@@0| 1)) (< (- |i#inv#0_0@@0| 1) (_System.array.Length |a#0|))) (or (not (= (- (_System.array.Length |a#0|) 1) (- |i#inv#0_0@@0| 1))) (not true))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |i#inv#0_0@@0|)) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (_module.__default.Id (- |i#inv#0_0@@0| 1))))))
 :qid |Inversesdfy.104:10|
 :skolemid |587|
...
(let ((anon15_Else_correct  (=> (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? _module._default.RotateD$T))) (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc)))) (= (_System.array.Length $nw@0) (_System.array.Length |a#0|)))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((|arrayinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0|) (< |arrayinit#0#i0#0| (_System.array.Length |a#0|))) (Requires1 TInt _module._default.RotateD$T $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| |a#0|) (|lambda#3| TInt (LitInt 0) (_System.array.Length |a#0|)) (|lambda#5| (SetRef_to_SetBox (|lambda#4| |a#0|))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0|))))
 :qid |Inversesdfy.103:8|
 :skolemid |582|
))) (=> (and (and (forall ((|arrayinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0@@0|) (< |arrayinit#0#i0#0@@0| (_System.array.Length |a#0|))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) (IndexField |arrayinit#0#i0#0@@0|)) (Apply1 TInt _module._default.RotateD$T $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| |a#0|) (|lambda#3| TInt (LitInt 0) (_System.array.Length |a#0|)) (|lambda#5| (SetRef_to_SetBox (|lambda#4| |a#0|))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0@@0|)))))
 :qid |Inversesdfy.103:8|
 :skolemid |583|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |a#0| (Tclass._System.array _module._default.RotateD$T)) ($IsAlloc refType |a#0| (Tclass._System.array _module._default.RotateD$T) $Heap))) (and (and ($Is refType |r#0| (Tclass._System.array _module._default.RotateD$T)) ($IsAlloc refType |r#0| (Tclass._System.array _module._default.RotateD$T) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 38) 35)))) anon0_correct)))
