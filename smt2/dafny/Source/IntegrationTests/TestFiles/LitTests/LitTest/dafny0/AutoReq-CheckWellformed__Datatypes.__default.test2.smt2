...
(declare-fun Datatypes.__default.test2 (Int) Bool)
(declare-fun |Datatypes.__default.test2#canCall| (Int) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|x#0| Int) ) (!  (=> (or (|Datatypes.__default.f2#canCall| |x#0|) (and (< 1 $FunctionContextHeight) (forall ((|t#1| T@U) ) (!  (=> ($Is DatatypeTypeType |t#1| Tclass.Datatypes.TheType) (and (Datatypes.TheType.TheType__builder_q |t#1|) (> (Datatypes.TheType.x |t#1|) |x#0|)))
 ...
 :qid |AutoReqdfy.238:21|
 :skolemid |4687|
 :pattern ( (Datatypes.__default.f2 |x#0|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|z#0| Int) ) (!  (=> (or (|Datatypes.__default.test2#canCall| |z#0|) (and (< 2 $FunctionContextHeight) (forall ((|t#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |t#1@@0| Tclass.Datatypes.TheType) (and (Datatypes.TheType.TheType__builder_q |t#1@@0|) (> (Datatypes.TheType.x |t#1@@0|) |z#0|)))
 :qid |AutoReqdfy.239:21|
 :skolemid |4700|
 :pattern ( (Datatypes.TheType.x |t#1@@0|))
 :pattern ( (Datatypes.TheType.TheType__builder_q |t#1@@0|))
)))) (and (|Datatypes.__default.f2#canCall| |z#0|) (= (Datatypes.__default.test2 |z#0|) (Datatypes.__default.f2 |z#0|))))
 :qid |AutoReqdfy.250:35|
 :skolemid |4702|
 :pattern ( (Datatypes.__default.test2 |z#0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|z#0@@0| Int) ) (!  (=> (or (|Datatypes.__default.test2#canCall| (LitInt |z#0@@0|)) (and (< 2 $FunctionContextHeight) (forall ((|t#2@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |t#2@@0| Tclass.Datatypes.TheType) (and (Datatypes.TheType.TheType__builder_q |t#2@@0|) (> (Datatypes.TheType.x |t#2@@0|) |z#0@@0|)))
 :qid |AutoReqdfy.239:21|
 :skolemid |4703|
 :pattern ( (Datatypes.TheType.x |t#2@@0|))
 :pattern ( (Datatypes.TheType.TheType__builder_q |t#2@@0|))
)))) (and (|Datatypes.__default.f2#canCall| (LitInt |z#0@@0|)) (= (Datatypes.__default.test2 (LitInt |z#0@@0|)) (U_2_bool (Lit boolType (bool_2_U (Datatypes.__default.f2 (LitInt |z#0@@0|))))))))
 :qid |AutoReqdfy.250:35|
 :weight 3
 :skolemid |4704|
 :pattern ( (Datatypes.__default.test2 (LitInt |z#0@@0|)))
))))
...
(set-info :boogie-vc-id CheckWellformed$$Datatypes.__default.test2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon10_Else_correct  (=> (and ($IsAlloc intType (int_2_U |z#0@@1|) TInt $Heap) (= (ControlFlow 0 3) (- 0 2))) (forall ((|t#4| T@U) ) (!  (=> ($Is DatatypeTypeType |t#4| Tclass.Datatypes.TheType) (and (Datatypes.TheType.TheType__builder_q |t#4|) (> (Datatypes.TheType.x |t#4|) |z#0@@1|)))
 :qid |AutoReqdfy.239:21|
 :skolemid |4706|
 :pattern ( (Datatypes.TheType.x |t#4|))
 :pattern ( (Datatypes.TheType.TheType__builder_q |t#4|))
)))))
(let ((anon10_Then_correct true))
(let ((anon4_correct  (=> (forall ((|t#0| T@U) ) (!  (=> ($Is DatatypeTypeType |t#0| Tclass.Datatypes.TheType) (and (Datatypes.TheType.TheType__builder_q |t#0|) (> (Datatypes.TheType.x |t#0|) |z#0@@1|)))
 :qid |AutoReqdfy.239:21|
 :skolemid |4705|
 :pattern ( (Datatypes.TheType.x |t#0|))
 :pattern ( (Datatypes.TheType.TheType__builder_q |t#0|))
)) (and (=> (= (ControlFlow 0 4) 1) anon10_Then_correct) (=> (= (ControlFlow 0 4) 3) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (not (Datatypes.TheType.TheType__builder_q |t#3@0|)) (= (ControlFlow 0 8) 4)) anon4_correct)))
(let ((anon9_Then_correct  (=> (Datatypes.TheType.TheType__builder_q |t#3@0|) (and (=> (= (ControlFlow 0 6) (- 0 7)) (Datatypes.TheType.TheType__builder_q |t#3@0|)) (=> (Datatypes.TheType.TheType__builder_q |t#3@0|) (=> (= (ControlFlow 0 6) 4) anon4_correct))))))
(let ((anon8_Then_correct  (=> (and ($Is DatatypeTypeType |t#3@0| Tclass.Datatypes.TheType) ($IsAlloc DatatypeTypeType |t#3@0| Tclass.Datatypes.TheType $Heap)) (and (=> (= (ControlFlow 0 9) 6) anon9_Then_correct) (=> (= (ControlFlow 0 9) 8) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |t#3@0| Tclass.Datatypes.TheType) ($IsAlloc DatatypeTypeType |t#3@0| Tclass.Datatypes.TheType $Heap))) (= (ControlFlow 0 5) 4)) anon4_correct)))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 10) 9) anon8_Then_correct) (=> (= (ControlFlow 0 10) 5) anon8_Else_correct)))))
