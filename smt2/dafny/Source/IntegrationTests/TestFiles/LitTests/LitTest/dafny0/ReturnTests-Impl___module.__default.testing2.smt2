...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap alloc false)) (=> (and (= |$rhs#0@0| (LitInt 2)) (= |$rhs#1@0| (LitInt 1))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= |$rhs#1@0| (LitInt 1))) (=> (= |$rhs#1@0| (LitInt 1)) (=> (= (ControlFlow 0 2) (- 0 1)) (= |$rhs#0@0| (LitInt 2)))))))))
