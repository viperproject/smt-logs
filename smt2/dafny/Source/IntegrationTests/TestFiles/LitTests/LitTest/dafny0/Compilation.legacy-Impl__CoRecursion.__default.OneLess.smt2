...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let (($generated@@98 true))
(let (($generated@@99  (=> (and (< $generated@@88 $generated@@89) (< $generated@@89 $generated@@90)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (<= 0 (- $generated@@90 $generated@@88)) (= (- $generated@@90 $generated@@89) (- $generated@@90 $generated@@88)))) (=> (or (<= 0 (- $generated@@90 $generated@@88)) (= (- $generated@@90 $generated@@89) (- $generated@@90 $generated@@88))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< (- $generated@@90 $generated@@89) (- $generated@@90 $generated@@88))) (=> (< (- $generated@@90 $generated@@89) (- $generated@@90 $generated@@88)) (=> (= (ControlFlow 0 3) (- 0 2)) (< $generated@@89 $generated@@90)))))))))
(let (($generated@@100  (and (=> (= (ControlFlow 0 7) 3) $generated@@99) (=> (= (ControlFlow 0 7) 6) $generated@@98))))
(let (($generated@@101  (=> (and (<= $generated@@91 $generated@@88) (= (ControlFlow 0 9) 7)) $generated@@100)))
(let (($generated@@102  (=> (and (< $generated@@88 $generated@@91) (= (ControlFlow 0 8) 7)) $generated@@100)))
(let (($generated@@103  (and (=> (= (ControlFlow 0 10) 8) $generated@@102) (=> (= (ControlFlow 0 10) 9) $generated@@101))))
(let (($generated@@104 true))
(let (($generated@@105  (=> (= $generated@@92 ($generated@@55 $generated@@93 $generated@@94 $generated@@5 false)) (and (=> (= (ControlFlow 0 11) 10) $generated@@103) (=> (= (ControlFlow 0 11) 1) $generated@@104)))))
(let (($generated@@106  (=> (and (and (and ($generated@@95 $generated@@94) ($generated@@96 $generated@@94)) (= 0 $generated@@97)) (and (< $generated@@88 $generated@@90) (= (ControlFlow 0 12) 11))) $generated@@105)))
$generated@@106))))))))))
))
(check-sat)
(get-info :rlimit)
