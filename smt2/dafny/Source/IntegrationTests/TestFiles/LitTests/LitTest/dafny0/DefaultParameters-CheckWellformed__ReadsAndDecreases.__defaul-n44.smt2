...
(declare-fun ReadsAndDecreases.__default.ReadA1 (T@U T@U T@U) Int)
(declare-fun |ReadsAndDecreases.__default.ReadA1#canCall| (T@U T@U T@U) Bool)
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@6 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#1| |l#0| |l#1| |l#2| |l#3|) $o@@6 $f))  (=> (and (or (not (= $o@@6 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@6) |l#2|)))) (= $o@@6 |l#3|)))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |14276|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#1| |l#0| |l#1| |l#2| |l#3|) $o@@6 $f))
)))
...
(assert (forall ((_System.array2$arg@@8 T@U) ($h@@5 T@U) ($o@@9 T@U) ($i0@@1 Int) ($i1@@0 Int) ) (!  (=> (and (and ($IsGoodHeap $h@@5) (and (or (not (= $o@@9 null)) (not true)) (= (dtype $o@@9) (Tclass._System.array2? _System.array2$arg@@8)))) (and (and (<= 0 $i0@@1) (< $i0@@1 (_System.array2.Length0 $o@@9))) (and (<= 0 $i1@@0) (< $i1@@0 (_System.array2.Length1 $o@@9))))) ($IsBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@9) (MultiIndexField (IndexField $i0@@1) $i1@@0)) _System.array2$arg@@8))
 :qid |unknown.0:0|
 :skolemid |5707|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@9) (MultiIndexField (IndexField $i0@@1) $i1@@0)) (Tclass._System.array2? _System.array2$arg@@8))
)))
...
(assert (forall ((_System.array$arg@@9 T@U) ($h@@6 T@U) ($o@@10 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@6) (and (or (not (= $o@@10 null)) (not true)) (= (dtype $o@@10) (Tclass._System.array? _System.array$arg@@9)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@10) alloc)))) ($IsAlloc intType (int_2_U (_System.array.Length $o@@10)) TInt $h@@6))
 :qid |unknown.0:0|
 :skolemid |5481|
 :pattern ( (_System.array.Length $o@@10) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@10) alloc)) (Tclass._System.array? _System.array$arg@@9))
)))
(assert (forall ((_System.array2$arg@@11 T@U) ($h@@7 T@U) ($o@@11 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@7) (and (or (not (= $o@@11 null)) (not true)) (= (dtype $o@@11) (Tclass._System.array2? _System.array2$arg@@11)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@11) alloc)))) ($IsAlloc intType (int_2_U (_System.array2.Length0 $o@@11)) TInt $h@@7))
 :qid |unknown.0:0|
 :skolemid |5712|
 :pattern ( (_System.array2.Length0 $o@@11) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@11) alloc)) (Tclass._System.array2? _System.array2$arg@@11))
)))
(assert (forall ((_System.array2$arg@@12 T@U) ($h@@8 T@U) ($o@@12 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@8) (and (or (not (= $o@@12 null)) (not true)) (= (dtype $o@@12) (Tclass._System.array2? _System.array2$arg@@12)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@12) alloc)))) ($IsAlloc intType (int_2_U (_System.array2.Length1 $o@@12)) TInt $h@@8))
 :qid |unknown.0:0|
 :skolemid |5714|
 :pattern ( (_System.array2.Length1 $o@@12) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@12) alloc)) (Tclass._System.array2? _System.array2$arg@@12))
)))
(assert (forall ((_System.array$arg@@10 T@U) ($h@@9 T@U) ($o@@13 T@U) ($i0@@2 Int) ) (!  (=> (and (and ($IsGoodHeap $h@@9) (and (or (not (= $o@@13 null)) (not true)) (= (dtype $o@@13) (Tclass._System.array? _System.array$arg@@10)))) (and (<= 0 $i0@@2) (< $i0@@2 (_System.array.Length $o@@13)))) ($IsBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@13) (IndexField $i0@@2)) _System.array$arg@@10))
 :qid |unknown.0:0|
 :skolemid |5476|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@13) (IndexField $i0@@2)) (Tclass._System.array? _System.array$arg@@10))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (|a#0| T@U) (|m#0| T@U) ) (!  (=> (or (|ReadsAndDecreases.__default.ReadA1#canCall| $Heap |a#0| |m#0|) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap) ($Is refType |a#0| (Tclass._System.array TInt))) ($Is refType |m#0| (Tclass._System.array2 TInt))) (= (_System.array2.Length0 |m#0|) (LitInt 0))))) (and (|ReadsAndDecreases.__default.MoreReads#canCall| |a#0| |m#0| (ite (< 0 (_System.array.Length |a#0|)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField (LitInt 0))))) 3) (ite  (and (< 0 (_System.array2.Length0 |m#0|)) (< 0 (_System.array2.Length1 |m#0|))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |m#0|) (MultiIndexField (IndexField (LitInt 0)) (LitInt 0))))) 3)) (= (ReadsAndDecreases.__default.ReadA1 $Heap |a#0| |m#0|) (ReadsAndDecreases.__default.MoreReads |a#0| |m#0| (ite (< 0 (_System.array.Length |a#0|)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField (LitInt 0))))) 3) (ite  (and (< 0 (_System.array2.Length0 |m#0|)) (< 0 (_System.array2.Length1 |m#0|))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |m#0|) (MultiIndexField (IndexField (LitInt 0)) (LitInt 0))))) 3)))))
 :qid |DefaultParametersdfy.333:18|
 :skolemid |5851|
 :pattern ( (ReadsAndDecreases.__default.ReadA1 $Heap |a#0| |m#0|) ($IsGoodHeap $Heap))
))))
...
(set-info :boogie-vc-id CheckWellformed$$ReadsAndDecreases.__default.ReadA1)
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#1| null $Heap@@0 alloc |a#0@@0|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= |m#0@@0| null)) (not true))) (=> (or (not (= |m#0@@0| null)) (not true)) (=> (= (_System.array2.Length0 |m#0@@0|) (LitInt 0)) (and (=> (= (ControlFlow 0 3) 1) anon5_Then_correct) (=> (= (ControlFlow 0 3) 2) anon5_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is refType |a#0@@0| (Tclass._System.array TInt)) ($Is refType |m#0@@0| (Tclass._System.array2 TInt))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 3))) anon0_correct))))
