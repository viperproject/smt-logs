...
|m#4|) |MultiSet#Empty|)))) (=> (forall ((|m#3@@0| T@U) )  (=> ($Is MultiSetType |m#3@@0| (TMultiSet TInt)) (|MultiSet#Disjoint| (let ((|m#4@@0| |m#3@@0|))
|m#4@@0|) |MultiSet#Empty|))) (and (=> (= (ControlFlow 0 12) 11) anon18_Then_correct) (=> (= (ControlFlow 0 12) 4) anon18_Else_correct))))))
...
(let ((anon5_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (exists ((|m#1| T@U) )  (and ($Is MultiSetType |m#1| (TMultiSet TInt)) (not (|MultiSet#Disjoint| |m#1| (|MultiSet#UnionOne| |MultiSet#Empty| ($Box intType (int_2_U (LitInt 1))))))))) (=> (exists ((|m#1@@0| T@U) )  (and ($Is MultiSetType |m#1@@0| (TMultiSet TInt)) (not (|MultiSet#Disjoint| |m#1@@0| (|MultiSet#UnionOne| |MultiSet#Empty| ($Box intType (int_2_U (LitInt 1)))))))) (and (=> (= (ControlFlow 0 16) 14) anon17_Then_correct) (=> (= (ControlFlow 0 16) 15) anon17_Else_correct))))))
