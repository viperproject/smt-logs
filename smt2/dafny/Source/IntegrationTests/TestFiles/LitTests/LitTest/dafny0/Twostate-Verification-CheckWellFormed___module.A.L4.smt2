...
(set-info :boogie-vc-id CheckWellFormed$$_module.A.L4)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null current$Heap alloc false)) (=> (and ($IsAllocBox ($Box refType |a#0|) Tclass._module.A $Heap) (= (ControlFlow 0 2) (- 0 1))) ($IsAlloc refType |a#0| Tclass._module.A $Heap)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.A) ($IsAlloc refType this Tclass._module.A previous$Heap)))) (=> (and (and (and ($Is refType |a#0| Tclass._module.A) ($IsAlloc refType |a#0| Tclass._module.A current$Heap)) (= 1 $FunctionContextHeight)) (and (and (= previous$Heap $Heap) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 3) 2))) anon0_correct))))
