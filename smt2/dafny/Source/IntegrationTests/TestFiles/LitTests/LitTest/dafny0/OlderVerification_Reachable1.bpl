...
axiom {:id "id16"} 2 <= $FunctionContextHeight
   ==> (forall Reachable1._default.Reachable$Extra: Ty, 
      $Heap: Heap, 
      source#0: ref, 
      sink#0: ref, 
      S#0: Set :: 
    ...
    Reachable1.__default.Reachable#canCall(Reachable1._default.Reachable$Extra, $Heap, source#0, sink#0, S#0)
       ...
       ==> (forall via#0: DatatypeType :: 
          ...
          $Is(via#0, 
             ...
             ==> Reachable1.__default.ReachableVia#canCall(Reachable1._default.Reachable$Extra, $Heap, source#0, via#0, sink#0, S#0))
...
procedure {:verboseName "Reachable1.Reachable (well-formedness)"} CheckWellformed$$Reachable1.__default.Reachable(Reachable1._default.Reachable$Extra: Ty, 
    source#0: ref where $Is(source#0, Tclass.Reachable1.Node()), 
    sink#0: ref where $Is(sink#0, Tclass.Reachable1.Node()), 
    S#0: Set where $Is(S#0, TSet(Tclass.Reachable1.Node())));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Reachable1.Reachable (well-formedness)"} CheckWellformed$$Reachable1.__default.Reachable(Reachable1._default.Reachable$Extra: Ty, source#0: ref, sink#0: ref, S#0: Set)
{
  ...
  var b$reqreads#0: bool;
    ...
    else
    {
            ...
            $Heap))
        {
            ...
            assume $IsAlloc(##source#0, Tclass.Reachable1.Node(), $Heap);
            ##p#0 := via#1;
            // assume allocatedness for argument to function
            assume $IsAlloc(##p#0, 
              Tclass.Reachable1.Path(Tclass.Reachable1.Node(), Reachable1._default.Reachable$Extra), 
            ...
            ##sink#0 := sink#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##sink#0, Tclass.Reachable1.Node(), $Heap);
            ##S#0 := S#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##S#0, TSet(Tclass.Reachable1.Node()), $Heap);
            b$reqreads#0 := (forall $o: ref, $f: Field :: 
              $o != null
                   && $Unbox(read($Heap, $o, alloc)): bool
                   && Set#IsMember(##S#0, $Box($o))
                 ==> $_ReadsFrame[$o, $f]);
            assume Reachable1.__default.ReachableVia#canCall(Reachable1._default.Reachable$Extra, $Heap, source#0, via#1, sink#0, S#0);
        }

        // End Comprehension WF check
        assume {:id "id17"} Reachable1.__default.Reachable(Reachable1._default.Reachable$Extra, $Heap, source#0, sink#0, S#0)
        ...
        assume (forall via#2: DatatypeType :: 
          ...
          $Is(via#2, 
              Tclass.Reachable1.Path(Tclass.Reachable1.Node(), Reachable1._default.Reachable$Extra))
             ==> Reachable1.__default.ReachableVia#canCall(Reachable1._default.Reachable$Extra, $Heap, source#0, via#2, sink#0, S#0));
        // CheckWellformedWithResult: any expression
        assume $Is(Reachable1.__default.Reachable(Reachable1._default.Reachable$Extra, $Heap, source#0, sink#0, S#0), 
          TBool);
...
axiom 1 <= $FunctionContextHeight
   ==> (forall Reachable1._default.ReachableVia$Extra: Ty, 
      $ly: LayerType, 
      $Heap: Heap, 
      source#0: ref, 
      p#0: DatatypeType, 
   ...
   ==> (forall Reachable1._default.ReachableVia$Extra: Ty, 
    ...
    Reachable1.__default.ReachableVia#canCall(Reachable1._default.ReachableVia$Extra, $Heap, source#0, p#0, sink#0, S#0)
       ...
       ==> (!Reachable1.Path.Empty_q(p#0)
           ==> (var n#1 := $Unbox(Reachable1.Path._h3(p#0)): ref; 
            (var prefix#1 := Reachable1.Path._h2(p#0); 
              Set#IsMember(S#0, $Box(n#1))
                 ==> 
                Seq#Contains($Unbox(read($Heap, n#1, Reachable1.Node.children)): Seq, $Box(sink#0))
                 ==> Reachable1.__default.ReachableVia#canCall(Reachable1._default.ReachableVia$Extra, $Heap, source#0, prefix#1, n#1, S#0))))
         && Reachable1.__default.ReachableVia(Reachable1._default.ReachableVia$Extra, 
            $LS($ly), 
            $Heap, 
            source#0, 
           ...
           == (if Reachable1.Path.Empty_q(p#0)
             ...
             else (var extra#0 := Reachable1.Path._h4(p#0); 
              (var n#0 := $Unbox(Reachable1.Path._h3(p#0)): ref; 
                (var prefix#0 := Reachable1.Path._h2(p#0); 
                  Set#IsMember(S#0, $Box(n#0))
                     && Seq#Contains($Unbox(read($Heap, n#0, Reachable1.Node.children)): Seq, $Box(sink#0))
                     && Reachable1.__default.ReachableVia(Reachable1._default.ReachableVia$Extra, $ly, $Heap, source#0, prefix#0, n#0, S#0))))));
}
...
procedure {:verboseName "Reachable1.ReachableVia (well-formedness)"} CheckWellformed$$Reachable1.__default.ReachableVia(Reachable1._default.ReachableVia$Extra: Ty, 
    source#0: ref where $Is(source#0, Tclass.Reachable1.Node()), 
    p#0: DatatypeType
       where $Is(p#0, 
        Tclass.Reachable1.Path(Tclass.Reachable1.Node(), Reachable1._default.ReachableVia$Extra)), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Reachable1.ReachableVia (well-formedness)"} CheckWellformed$$Reachable1.__default.ReachableVia(Reachable1._default.ReachableVia$Extra: Ty, 
    source#0: ref, 
    p#0: DatatypeType, 
    sink#0: ref, 
    S#0: Set)
{
  ...
  var b$reqreads#1: bool;
    ...
    {
        // Check well-formedness of body and result subset type constraint
        if (p#0 == #Reachable1.Path.Empty())
        {
            assume {:id "id31"} Reachable1.__default.ReachableVia(Reachable1._default.ReachableVia$Extra, 
                $LS($LZ), 
                $Heap, 
                source#0, 
                p#0, 
            ...
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(Reachable1.__default.ReachableVia(Reachable1._default.ReachableVia$Extra, 
                $LS($LZ), 
                $Heap, 
                source#0, 
                p#0, 
        ...
        else if (p#0 == #Reachable1.Path.Extend(_mcc#0#0, $Box(_mcc#1#0), _mcc#2#0))
        {
            assume $Is(_mcc#0#0, 
              Tclass.Reachable1.Path(Tclass.Reachable1.Node(), Reachable1._default.ReachableVia$Extra));
            assume $Is(_mcc#1#0, Tclass.Reachable1.Node());
            assume $IsBox(_mcc#2#0, Reachable1._default.ReachableVia$Extra);
            havoc extra#Z#0;
            assume {:id "id20"} let#0#0#0 == _mcc#2#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $IsBox(let#0#0#0, Reachable1._default.ReachableVia$Extra);
            assume {:id "id21"} extra#Z#0 == let#0#0#0;
            havoc n#Z#0;
            assume {:id "id22"} let#1#0#0 == _mcc#1#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#1#0#0, Tclass.Reachable1.Node());
            assume {:id "id23"} n#Z#0 == let#1#0#0;
            havoc prefix#Z#0;
            assume {:id "id24"} let#2#0#0 == _mcc#0#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#2#0#0, 
              Tclass.Reachable1.Path(Tclass.Reachable1.Node(), Reachable1._default.ReachableVia$Extra));
            assume {:id "id25"} prefix#Z#0 == let#2#0#0;
            if (Set#IsMember(S#0, $Box(n#Z#0)))
            {
                assert {:id "id26"} n#Z#0 != null;
                b$reqreads#0 := $_ReadsFrame[n#Z#0, Reachable1.Node.children];
            }

            if (Set#IsMember(S#0, $Box(n#Z#0))
               && Seq#Contains($Unbox(read($Heap, n#Z#0, Reachable1.Node.children)): Seq, $Box(sink#0)))
            {
                ##source#0 := source#0;
                // assume allocatedness for argument to function
                assume $IsAlloc(##source#0, Tclass.Reachable1.Node(), $Heap);
                ...
                b$reqreads#1 := (forall $o: ref, $f: Field :: 
                  $o != null
                       ...
                       && Set#IsMember(##S#0, $Box($o))
                     ==> $_ReadsFrame[$o, $f]);
                assert {:id "id27"} DtRank(##p#0) < DtRank(p#0);
                assume Reachable1.__default.ReachableVia#canCall(Reachable1._default.ReachableVia$Extra, $Heap, source#0, prefix#Z#0, n#Z#0, S#0);
            }

            assume {:id "id28"} Reachable1.__default.ReachableVia(Reachable1._default.ReachableVia$Extra, 
                $LS($LZ), 
                $Heap, 
                source#0, 
                p#0, 
            ...
            assume Set#IsMember(S#0, $Box(n#Z#0))
               ==> 
              Seq#Contains($Unbox(read($Heap, n#Z#0, Reachable1.Node.children)): Seq, $Box(sink#0))
               ==> Reachable1.__default.ReachableVia#canCall(Reachable1._default.ReachableVia$Extra, $Heap, source#0, prefix#Z#0, n#Z#0, S#0);
            // CheckWellformedWithResult: any expression
            assume $Is(Reachable1.__default.ReachableVia(Reachable1._default.ReachableVia$Extra, 
                $LS($LZ), 
                $Heap, 
