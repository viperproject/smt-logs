...
(assert (= (Tag Tclass._module.CharChar) Tagclass._module.CharChar))
(assert (= (TagFamily Tclass._module.CharChar) tytagFamily$CharChar))
(assert (forall ((s@@4 T@U) (n@@3 Int) (k Int) ) (!  (=> (and (and (<= 0 n@@3) (<= n@@3 k)) (< k (|Seq#Length| s@@4))) (= (|Seq#Index| (|Seq#Drop| s@@4 n@@3) (- k n@@3)) (|Seq#Index| s@@4 k)))
 :qid |DafnyPreludebpl.1258:15|
 :weight 25
 :skolemid |248|
 :pattern ( (|Seq#Index| s@@4 k) (|Seq#Drop| s@@4 n@@3))
)))
(assert (forall ((s@@5 T@U) (m@@4 Int) (n@@4 Int) ) (!  (=> (and (and (<= 0 m@@4) (<= 0 n@@4)) (<= (+ m@@4 n@@4) (|Seq#Length| s@@5))) (= (|Seq#Drop| (|Seq#Drop| s@@5 m@@4) n@@4) (|Seq#Drop| s@@5 (+ m@@4 n@@4))))
 :qid |DafnyPreludebpl.1299:15|
 :skolemid |257|
 :pattern ( (|Seq#Drop| (|Seq#Drop| s@@5 m@@4) n@@4))
)))
...
(set-info :boogie-vc-id Impl$$_module.CharChar.MinCharLemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon10_Else_correct true))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|i#1| Int) ) (!  (=> (and (<= (LitInt 0) |i#1|) (< |i#1| (|Seq#Length| |s#0@@4|))) (<= (|char#ToInt| (_module.CharChar.MinChar ($LS ($LS $LZ)) this@@4 |s#0@@4|)) (|char#ToInt| ($Unbox charType (|Seq#Index| |s#0@@4| |i#1|)))))
 :qid |Chardfy.35:20|
 :skolemid |532|
 :pattern ( ($Unbox charType (|Seq#Index| |s#0@@4| |i#1|)))
)))))
(let ((anon7_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((|i#0_1| Int) ) (!  (and (=> (and (<= (LitInt 1) |i#0_1|) (< |i#0_1| (|Seq#Length| |s#0@@4|))) (<= (|char#ToInt| |m#0_0@0|) (|char#ToInt| ($Unbox charType (|Seq#Index| (|Seq#Drop| |s#0@@4| (LitInt 1)) (- |i#0_1| 1)))))) (=> (and (<= (LitInt 1) |i#0_1|) (< |i#0_1| (|Seq#Length| |s#0@@4|))) (= ($Unbox charType (|Seq#Index| (|Seq#Drop| |s#0@@4| (LitInt 1)) (- |i#0_1| 1))) ($Unbox charType (|Seq#Index| |s#0@@4| |i#0_1|)))))
 :qid |Chardfy.39:21|
 :skolemid |537|
 :pattern ( ($Unbox charType (|Seq#Index| |s#0@@4| |i#0_1|)))
))) (=> (forall ((|i#0_1@@0| Int) ) (!  (and (=> (and (<= (LitInt 1) |i#0_1@@0|) (< |i#0_1@@0| (|Seq#Length| |s#0@@4|))) (<= (|char#ToInt| |m#0_0@0|) (|char#ToInt| ($Unbox charType (|Seq#Index| (|Seq#Drop| |s#0@@4| (LitInt 1)) (- |i#0_1@@0| 1)))))) (=> (and (<= (LitInt 1) |i#0_1@@0|) (< |i#0_1@@0| (|Seq#Length| |s#0@@4|))) (= ($Unbox charType (|Seq#Index| (|Seq#Drop| |s#0@@4| (LitInt 1)) (- |i#0_1@@0| 1))) ($Unbox charType (|Seq#Index| |s#0@@4| |i#0_1@@0|)))))
 :qid |Chardfy.39:21|
 :skolemid |537|
 :pattern ( ($Unbox charType (|Seq#Index| |s#0@@4| |i#0_1@@0|)))
)) (=> (= (ControlFlow 0 5) 2) GeneratedUnifiedExit_correct)))))
(let ((anon13_Else_correct  (=> (and (< (|char#ToInt| ($Unbox charType (|Seq#Index| (|Seq#Drop| |s#0@@4| (LitInt 1)) (- |i#0_0@0| 1)))) (|char#ToInt| |m#0_0@0|)) (= (ControlFlow 0 12) 5)) anon7_correct)))
(let ((anon13_Then_correct  (=> (<= (|char#ToInt| |m#0_0@0|) (|char#ToInt| ($Unbox charType (|Seq#Index| (|Seq#Drop| |s#0@@4| (LitInt 1)) (- |i#0_0@0| 1))))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |s#0@@4|)))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (and (<= 0 (- |i#0_0@0| 1)) (< (- |i#0_0@0| 1) (|Seq#Length| (|Seq#Drop| |s#0@@4| (LitInt 1)))))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (and (<= 0 |i#0_0@0|) (< |i#0_0@0| (|Seq#Length| |s#0@@4|)))) (=> (= (ControlFlow 0 8) 5) anon7_correct)))))))
(let ((anon12_Then_correct  (=> (and (<= (LitInt 1) |i#0_0@0|) (< |i#0_0@0| (|Seq#Length| |s#0@@4|))) (and (=> (= (ControlFlow 0 13) (- 0 15)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |s#0@@4|)))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (and (<= 0 (- |i#0_0@0| 1)) (< (- |i#0_0@0| 1) (|Seq#Length| (|Seq#Drop| |s#0@@4| (LitInt 1)))))) (and (=> (= (ControlFlow 0 13) 8) anon13_Then_correct) (=> (= (ControlFlow 0 13) 12) anon13_Else_correct)))))))
(let ((anon12_Else_correct  (=> (and (not (and (<= (LitInt 1) |i#0_0@0|) (< |i#0_0@0| (|Seq#Length| |s#0@@4|)))) (= (ControlFlow 0 7) 5)) anon7_correct)))
(let ((anon11_Else_correct  (=> (< |i#0_0@0| (LitInt 1)) (and (=> (= (ControlFlow 0 17) 13) anon12_Then_correct) (=> (= (ControlFlow 0 17) 7) anon12_Else_correct)))))
(let ((anon11_Then_correct  (=> (<= (LitInt 1) |i#0_0@0|) (and (=> (= (ControlFlow 0 16) 13) anon12_Then_correct) (=> (= (ControlFlow 0 16) 7) anon12_Else_correct)))))
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 18) 16) anon11_Then_correct) (=> (= (ControlFlow 0 18) 17) anon11_Else_correct))))
(let ((anon9_Then_correct  (=> (and (<= (LitInt 2) (|Seq#Length| |s#0@@4|)) ($IsAllocBox ($Box refType this@@4) Tclass._module.CharChar? $Heap@0)) (and (=> (= (ControlFlow 0 19) (- 0 21)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |s#0@@4|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |s#0@@4|))) (=> (and (= |##s#0_0@0| (|Seq#Drop| |s#0@@4| (LitInt 1))) ($IsAlloc SeqType |##s#0_0@0| (TSeq TChar) $Heap@0)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (not (|Seq#Equal| |##s#0_0@0| |Seq#Empty|))) (=> (and (and (not (|Seq#Equal| |##s#0_0@0| |Seq#Empty|)) (|_module.CharChar.MinChar#canCall| this@@4 (|Seq#Drop| |s#0@@4| (LitInt 1)))) (and (|_module.CharChar.MinChar#canCall| this@@4 (|Seq#Drop| |s#0@@4| (LitInt 1))) (= |m#0_0@0| (_module.CharChar.MinChar ($LS $LZ) this@@4 (|Seq#Drop| |s#0@@4| (LitInt 1)))))) (and (=> (= (ControlFlow 0 19) 18) anon10_Then_correct) (=> (= (ControlFlow 0 19) 4) anon10_Else_correct))))))))))
(let ((anon9_Else_correct  (=> (and (< (|Seq#Length| |s#0@@4|) (LitInt 2)) (= (ControlFlow 0 3) 2)) GeneratedUnifiedExit_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#s0#0| T@U) ) (!  (=> (and (and ($Is SeqType |$ih#s0#0| (TSeq TChar)) (or (not (= (|Seq#Length| |$ih#s0#0|) 0)) (not true))) (< (|Seq#Rank| |$ih#s0#0|) (|Seq#Rank| |s#0@@4|))) (forall ((|i#2| Int) ) (!  (=> (and (<= (LitInt 0) |i#2|) (< |i#2| (|Seq#Length| |$ih#s0#0|))) (<= (|char#ToInt| (_module.CharChar.MinChar ($LS $LZ) this@@4 |$ih#s0#0|)) (|char#ToInt| ($Unbox charType (|Seq#Index| |$ih#s0#0| |i#2|)))))
 :qid |Chardfy.35:20|
 :skolemid |534|
 :pattern ( ($Unbox charType (|Seq#Index| |$ih#s0#0| |i#2|)))
)))
 :qid |Chardfy.33:22|
 :skolemid |535|
 :pattern ( (_module.CharChar.MinChar ($LS $LZ) this@@4 |$ih#s0#0|))
 :pattern ( (|Seq#Length| |$ih#s0#0|))
)))) (and (=> (= (ControlFlow 0 22) 19) anon9_Then_correct) (=> (= (ControlFlow 0 22) 3) anon9_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.CharChar) ($IsAlloc refType this@@4 Tclass._module.CharChar $Heap))) (and ($Is SeqType |s#0@@4| (TSeq TChar)) ($IsAlloc SeqType |s#0@@4| (TSeq TChar) $Heap))) (=> (and (and (and ($Is charType |m#0_0| TChar) true) (= 1 $FunctionContextHeight)) (and (or (not (= (|Seq#Length| |s#0@@4|) 0)) (not true)) (= (ControlFlow 0 23) 22))) anon0_correct)))))
