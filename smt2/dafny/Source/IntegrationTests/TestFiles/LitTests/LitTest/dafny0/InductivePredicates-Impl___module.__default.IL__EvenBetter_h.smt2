...
(set-info :boogie-vc-id Impl$$_module.__default.IL__EvenBetter_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 29) (let ((anon15_Else_correct  (=> (=> (_module.natinf.N_q |x#1|) (=> (<= (LitInt 2) (_module.natinf.n |x#1|)) (|_module.__default.Even_h#canCall| (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) (|#_module.natinf.N| (- (_module.natinf.n |x#1|) 2))))) (=> (and (and (not (and (_module.natinf.N_q |x#1|) (= (_module.natinf.n |x#1|) (LitInt 0)))) (not (and (and (_module.natinf.N_q |x#1|) (<= (LitInt 2) (_module.natinf.n |x#1|))) (_module.__default.Even_h ($LS $LZ) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) (|#_module.natinf.N| (- (_module.natinf.n |x#1|) 2)))))) (= (ControlFlow 0 6) (- 0 5))) false))))
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (_module.natinf.N_q |x#1|)) (=> (_module.natinf.N_q |x#1|) (=> (= (ControlFlow 0 2) (- 0 1)) (= (Mod (_module.natinf.n |x#1|) (LitInt 2)) (LitInt 0)))))))
(let ((anon9_correct  (=> (=> (_module.natinf.N_q |x#1|) (=> (<= (LitInt 2) (_module.natinf.n |x#1|)) (|_module.__default.Even_h#canCall| (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) (|#_module.natinf.N| (- (_module.natinf.n |x#1|) 2))))) (=> (and (and (_module.natinf.N_q |x#1|) (<= (LitInt 2) (_module.natinf.n |x#1|))) (_module.__default.Even_h ($LS $LZ) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) (|#_module.natinf.N| (- (_module.natinf.n |x#1|) 2)))) (and (=> (= (ControlFlow 0 11) (- 0 17)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 11) (- 0 16)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@5|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@5|)) (=> (= |_k##0@0| (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 11) (- 0 15)) (_module.natinf.N_q |x#1|)) (=> (_module.natinf.N_q |x#1|) (and (=> (= (ControlFlow 0 11) (- 0 14)) ($Is intType (int_2_U (- (_module.natinf.n |x#1|) 2)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- (_module.natinf.n |x#1|) 2)) Tclass._System.nat) (=> (= |x##0@0| (|#_module.natinf.N| (- (_module.natinf.n |x#1|) 2))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (=> (|_module.__default.Even_h#canCall| |_k##0@0| |x##0@0|) (or (_module.__default.Even_h ($LS $LZ) |_k##0@0| |x##0@0|) (=> (< 0 (|ORD#Offset| |_k##0@0|)) (or (and (_module.natinf.N_q |x##0@0|) (= (_module.natinf.n |x##0@0|) (LitInt 0))) (and (and (_module.natinf.N_q |x##0@0|) (<= (LitInt 2) (_module.natinf.n |x##0@0|))) (_module.__default.Even_h ($LS ($LS $LZ)) (|ORD#Minus| |_k##0@0| (|ORD#FromNat| 1)) (|#_module.natinf.N| (- (_module.natinf.n |x##0@0|) 2))))))))) (=> (=> (|_module.__default.Even_h#canCall| |_k##0@0| |x##0@0|) (or (_module.__default.Even_h ($LS $LZ) |_k##0@0| |x##0@0|) (=> (< 0 (|ORD#Offset| |_k##0@0|)) (or (and (_module.natinf.N_q |x##0@0|) (= (_module.natinf.n |x##0@0|) (LitInt 0))) (and (and (_module.natinf.N_q |x##0@0|) (<= (LitInt 2) (_module.natinf.n |x##0@0|))) (_module.__default.Even_h ($LS ($LS $LZ)) (|ORD#Minus| |_k##0@0| (|ORD#FromNat| 1)) (|#_module.natinf.N| (- (_module.natinf.n |x##0@0|) 2)))))))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (=> (|_module.__default.Even_h#canCall| |_k##0@0| |x##0@0|) (or (_module.__default.Even_h ($LS $LZ) |_k##0@0| |x##0@0|) (=> (= (LitInt 0) (|ORD#Offset| |_k##0@0|)) (exists ((|_k'#0@@1| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#0@@1| |_k##0@0|) (_module.__default.Even_h ($LS $LZ) |_k'#0@@1| |x##0@0|))
 :qid |InductivePredicatesdfy.6:17|
 :skolemid |2867|
 :pattern ( (_module.__default.Even_h ($LS $LZ) |_k'#0@@1| |x##0@0|))
)))))) (=> (=> (|_module.__default.Even_h#canCall| |_k##0@0| |x##0@0|) (or (_module.__default.Even_h ($LS $LZ) |_k##0@0| |x##0@0|) (=> (= (LitInt 0) (|ORD#Offset| |_k##0@0|)) (exists ((|_k'#0@@2| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#0@@2| |_k##0@0|) (_module.__default.Even_h ($LS $LZ) |_k'#0@@2| |x##0@0|))
 :qid |InductivePredicatesdfy.6:17|
 :skolemid |2867|
 :pattern ( (_module.__default.Even_h ($LS $LZ) |_k'#0@@2| |x##0@0|))
))))) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (_module.natinf.N_q |x##0@0|) (= (Mod (_module.natinf.n |x##0@0|) (LitInt 2)) (LitInt 0))) (and (= $Heap $Heap@1) (= (ControlFlow 0 11) 2))) GeneratedUnifiedExit_correct))))))))))))))))))))
(let ((anon17_Else_correct  (=> (and (not (and (_module.natinf.N_q |x#1|) (<= (LitInt 2) (_module.natinf.n |x#1|)))) (= (ControlFlow 0 23) 11)) anon9_correct)))
(let ((anon17_Then_correct  (=> (and (_module.natinf.N_q |x#1|) (<= (LitInt 2) (_module.natinf.n |x#1|))) (and (=> (= (ControlFlow 0 18) (- 0 22)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 18) (- 0 21)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@5|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@5|)) (=> (and (= |##_k#0@0| (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1))) ($IsAlloc BoxType |##_k#0@0| TORDINAL $Heap)) (and (=> (= (ControlFlow 0 18) (- 0 20)) (_module.natinf.N_q |x#1|)) (=> (_module.natinf.N_q |x#1|) (and (=> (= (ControlFlow 0 18) (- 0 19)) ($Is intType (int_2_U (- (_module.natinf.n |x#1|) 2)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- (_module.natinf.n |x#1|) 2)) Tclass._System.nat) (=> (and (and (= |##x#1@0| (|#_module.natinf.N| (- (_module.natinf.n |x#1|) 2))) ($IsAlloc DatatypeTypeType |##x#1@0| Tclass._module.natinf $Heap)) (and (|_module.__default.Even_h#canCall| (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) (|#_module.natinf.N| (- (_module.natinf.n |x#1|) 2))) (= (ControlFlow 0 18) 11))) anon9_correct)))))))))))))
(let ((anon16_Else_correct  (=> (not (_module.natinf.N_q |x#1|)) (and (=> (= (ControlFlow 0 26) 18) anon17_Then_correct) (=> (= (ControlFlow 0 26) 23) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (_module.natinf.N_q |x#1|) (and (=> (= (ControlFlow 0 24) (- 0 25)) (_module.natinf.N_q |x#1|)) (=> (_module.natinf.N_q |x#1|) (and (=> (= (ControlFlow 0 24) 18) anon17_Then_correct) (=> (= (ControlFlow 0 24) 23) anon17_Else_correct)))))))
(let ((anon4_correct  (=> (and (and (_module.natinf.N_q |x#1|) (= (_module.natinf.n |x#1|) (LitInt 0))) (= (ControlFlow 0 7) 2)) GeneratedUnifiedExit_correct)))
(let ((anon14_Else_correct  (=> (and (not (_module.natinf.N_q |x#1|)) (= (ControlFlow 0 10) 7)) anon4_correct)))
(let ((anon14_Then_correct  (=> (_module.natinf.N_q |x#1|) (and (=> (= (ControlFlow 0 8) (- 0 9)) (_module.natinf.N_q |x#1|)) (=> (_module.natinf.N_q |x#1|) (=> (= (ControlFlow 0 8) 7) anon4_correct))))))
(let ((anon12_Then_correct  (=> (< 0 (|ORD#Offset| |_k#0@@5|)) (and (and (and (and (=> (= (ControlFlow 0 27) 6) anon15_Else_correct) (=> (= (ControlFlow 0 27) 24) anon16_Then_correct)) (=> (= (ControlFlow 0 27) 26) anon16_Else_correct)) (=> (= (ControlFlow 0 27) 8) anon14_Then_correct)) (=> (= (ControlFlow 0 27) 10) anon14_Else_correct)))))
(let ((anon12_Else_correct  (=> (<= (|ORD#Offset| |_k#0@@5|) 0) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (forall ((|_k'#2@@1| T@U) (|x#2| T@U) ) (!  (=> (and ($Is DatatypeTypeType |x#2| Tclass._module.natinf) (and (|ORD#Less| |_k'#2@@1| |_k#0@@5|) (_module.__default.Even_h ($LS $LZ) |_k'#2@@1| |x#2|))) (and (_module.natinf.N_q |x#2|) (= (Mod (_module.natinf.n |x#2|) (LitInt 2)) (LitInt 0))))
 :qid |InductivePredicatesdfy.58:32|
 :skolemid |2874|
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 28) 27) anon12_Then_correct) (=> (= (ControlFlow 0 28) 4) anon12_Else_correct)))))
