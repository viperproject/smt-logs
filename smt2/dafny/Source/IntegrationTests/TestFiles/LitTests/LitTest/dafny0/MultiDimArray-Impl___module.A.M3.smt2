...
(declare-fun |some#0_0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.A.M3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 36) (let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 7)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this) _module.A.f)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this) _module.A.f)) null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (and (<= 0 |i#0|) (< |i#0| (_System.array3.Length0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this) _module.A.f)))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (and (<= 0 |j#0|) (< |j#0| (_System.array3.Length1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this) _module.A.f)))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 |k#0|) (< |k#0| (_System.array3.Length2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this) _module.A.f)))))) (=> (= (ControlFlow 0 3) (- 0 2)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this) _module.A.f))) (MultiIndexField (MultiIndexField (IndexField |i#0|) |j#0|) |k#0|))) |some#0_0@0|)))))))))
(let ((anon5_Then_correct  (=> (or (not (= |i#0| 0)) (not true)) (and (=> (= (ControlFlow 0 8) (- 0 34)) (<= 0 (LitInt 2))) (=> (<= 0 (LitInt 2)) (and (=> (= (ControlFlow 0 8) (- 0 33)) (<= 0 (LitInt 3))) (=> (<= 0 (LitInt 3)) (and (=> (= (ControlFlow 0 8) (- 0 32)) (<= 0 (LitInt 5))) (=> (<= 0 (LitInt 5)) (=> (and (and (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array3? Tclass._module.A?))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc))))) (and (= (_System.array3.Length0 $nw@0) (LitInt 2)) (= (_System.array3.Length1 $nw@0) (LitInt 3)))) (and (and (= (_System.array3.Length2 $nw@0) (LitInt 5)) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (=> (= (ControlFlow 0 8) (- 0 31)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 8) (- 0 30)) (and (<= 0 (LitInt 1)) (< (LitInt 1) (_System.array3.Length0 $nw@0)))) (=> (and (<= 0 (LitInt 1)) (< (LitInt 1) (_System.array3.Length0 $nw@0))) (and (=> (= (ControlFlow 0 8) (- 0 29)) (and (<= 0 (LitInt 2)) (< (LitInt 2) (_System.array3.Length1 $nw@0)))) (=> (and (<= 0 (LitInt 2)) (< (LitInt 2) (_System.array3.Length1 $nw@0))) (and (=> (= (ControlFlow 0 8) (- 0 28)) (and (<= 0 (LitInt 4)) (< (LitInt 4) (_System.array3.Length2 $nw@0)))) (=> (and (<= 0 (LitInt 4)) (< (LitInt 4) (_System.array3.Length2 $nw@0))) (=> (= |s#0_0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0) (MultiIndexField (MultiIndexField (IndexField (LitInt 1)) (LitInt 2)) (LitInt 4))))) (=> (and ($Is refType |some#0_0@0| Tclass._module.A?) ($IsAlloc refType |some#0_0@0| Tclass._module.A? $Heap@0)) (and (=> (= (ControlFlow 0 8) (- 0 27)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this) _module.A.f)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this) _module.A.f)) null)) (not true)) (and (=> (= (ControlFlow 0 8) (- 0 26)) (and (<= 0 |i#0|) (< |i#0| (_System.array3.Length0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this) _module.A.f)))))) (=> (and (<= 0 |i#0|) (< |i#0| (_System.array3.Length0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this) _module.A.f))))) (and (=> (= (ControlFlow 0 8) (- 0 25)) (and (<= 0 |j#0|) (< |j#0| (_System.array3.Length1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this) _module.A.f)))))) (=> (and (<= 0 |j#0|) (< |j#0| (_System.array3.Length1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this) _module.A.f))))) (and (=> (= (ControlFlow 0 8) (- 0 24)) (and (<= 0 |k#0|) (< |k#0| (_System.array3.Length2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this) _module.A.f)))))) (=> (and (<= 0 |k#0|) (< |k#0| (_System.array3.Length2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this) _module.A.f))))) (and (=> (= (ControlFlow 0 8) (- 0 23)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this) _module.A.f)) (MultiIndexField (MultiIndexField (IndexField |i#0|) |j#0|) |k#0|)))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this) _module.A.f)) (MultiIndexField (MultiIndexField (IndexField |i#0|) |j#0|) |k#0|))) (=> (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this) _module.A.f)) (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this) _module.A.f))) (MultiIndexField (MultiIndexField (IndexField |i#0|) |j#0|) |k#0|) ($Box refType |some#0_0@0|)))) (=> (and ($IsGoodHeap $Heap@1) (= |i##0_0@0| (- |i#0| 1))) (and (=> (= (ControlFlow 0 8) (- 0 22)) (forall (($o@@14 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@14) alloc)))) (= $o@@14 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this) _module.A.f)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@14 $f@@0)))
 :qid |MultiDimArraydfy.76:9|
 :skolemid |2803|
))) (=> (forall (($o@@15 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@15 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@15) alloc)))) (= $o@@15 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this) _module.A.f)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@15 $f@@1)))
 :qid |MultiDimArraydfy.76:9|
 :skolemid |2803|
)) (and (=> (= (ControlFlow 0 8) (- 0 21)) (or (<= 0 |i#0|) (= |i##0_0@0| |i#0|))) (=> (or (<= 0 |i#0|) (= |i##0_0@0| |i#0|)) (and (=> (= (ControlFlow 0 8) (- 0 20)) (< |i##0_0@0| |i#0|)) (=> (< |i##0_0@0| |i#0|) (and (=> (= (ControlFlow 0 8) (- 0 19)) (<= (LitInt 0) |i##0_0@0|)) (=> (<= (LitInt 0) |i##0_0@0|) (and (=> (= (ControlFlow 0 8) (- 0 18)) (< |i##0_0@0| (_System.array3.Length0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this) _module.A.f))))) (=> (< |i##0_0@0| (_System.array3.Length0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this) _module.A.f)))) (and (=> (= (ControlFlow 0 8) (- 0 17)) (<= (LitInt 0) |j#0|)) (=> (<= (LitInt 0) |j#0|) (and (=> (= (ControlFlow 0 8) (- 0 16)) (< |j#0| (_System.array3.Length1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this) _module.A.f))))) (=> (< |j#0| (_System.array3.Length1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this) _module.A.f)))) (and (=> (= (ControlFlow 0 8) (- 0 15)) (<= (LitInt 0) |k#0|)) (=> (<= (LitInt 0) |k#0|) (and (=> (= (ControlFlow 0 8) (- 0 14)) (< |k#0| (_System.array3.Length2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this) _module.A.f))))) (=> (< |k#0| (_System.array3.Length2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this) _module.A.f)))) (=> (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (and (forall (($o@@16 T@U) ) (!  (=> (and (or (not (= $o@@16 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@16) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@16) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@16)) (= $o@@16 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this) _module.A.f)))))
 :qid |MultiDimArraydfy.64:10|
 :skolemid |2801|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@16))
)) ($HeapSucc $Heap@1 $Heap@2))) (and (=> (= (ControlFlow 0 8) (- 0 13)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 8) (- 0 12)) (and (<= 0 (LitInt 1)) (< (LitInt 1) (_System.array3.Length0 $nw@0)))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (and (<= 0 (LitInt 2)) (< (LitInt 2) (_System.array3.Length1 $nw@0)))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (and (<= 0 (LitInt 4)) (< (LitInt 4) (_System.array3.Length2 $nw@0)))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (= |s#0_0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (MultiIndexField (MultiIndexField (IndexField (LitInt 1)) (LitInt 2)) (LitInt 4)))))) (=> (= |s#0_0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (MultiIndexField (MultiIndexField (IndexField (LitInt 1)) (LitInt 2)) (LitInt 4))))) (=> (= (ControlFlow 0 8) 3) anon6_Then_correct)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.A.f)))) (and (=> (= (ControlFlow 0 35) 8) anon5_Then_correct) (=> (= (ControlFlow 0 35) 1) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.A) ($IsAlloc refType this Tclass._module.A $Heap)))) (and (and ($Is refType |z#0_0| (Tclass._System.array3 Tclass._module.A?)) ($IsAlloc refType |z#0_0| (Tclass._System.array3 Tclass._module.A?) $Heap)) true)) (=> (and (and (and (and ($Is refType |s#0_0| Tclass._module.A?) ($IsAlloc refType |s#0_0| Tclass._module.A? $Heap)) true) (and (and ($Is refType |some#0_0| Tclass._module.A?) ($IsAlloc refType |some#0_0| Tclass._module.A? $Heap)) true)) (and (and (and (= 0 $FunctionContextHeight) (<= (LitInt 0) |i#0|)) (and (< |i#0| (_System.array3.Length0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.A.f)))) (<= (LitInt 0) |j#0|))) (and (and (< |j#0| (_System.array3.Length1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.A.f)))) (<= (LitInt 0) |k#0|)) (and (< |k#0| (_System.array3.Length2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.A.f)))) (= (ControlFlow 0 36) 35))))) anon0_correct))))
