...
(set-info :boogie-vc-id Impl$$_module.__default.compute__cinterp1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (= (LitInt (_module.__default.cinterp ($LS ($LS $LZ)) (Lit MapType |Map#Empty|) (Lit DatatypeTypeType (|#_module.exp.Plus| (Lit DatatypeTypeType (|#_module.exp.Plus| (Lit DatatypeTypeType (|#_module.exp.Num| (LitInt 1))) (Lit DatatypeTypeType (|#_module.exp.Num| (LitInt 2))))) (Lit DatatypeTypeType (|#_module.exp.Plus| (Lit DatatypeTypeType (|#_module.exp.Num| (LitInt 3))) (Lit DatatypeTypeType (|#_module.exp.Num| (LitInt 4))))))))) (LitInt 10)))))
