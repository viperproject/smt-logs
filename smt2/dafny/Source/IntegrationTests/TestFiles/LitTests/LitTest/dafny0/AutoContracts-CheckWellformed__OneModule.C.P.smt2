...
(declare-fun OneModule.C.P (T@U T@U) Bool)
(declare-fun |OneModule.C.P#canCall| (T@U T@U) Bool)
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@1 T@U) ) (!  (=> (or (|OneModule.C.P#canCall| $Heap@@1 this@@1) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass.OneModule.C) ($IsAlloc refType this@@1 Tclass.OneModule.C $Heap@@1)))) (OneModule.C.Valid $Heap@@1 this@@1)))) (= (OneModule.C.P $Heap@@1 this@@1) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) OneModule.C.data))) 20)))
 :qid |AutoContractsdfy.38:21|
 :skolemid |544|
 :pattern ( (OneModule.C.P $Heap@@1 this@@1) ($IsGoodHeap $Heap@@1))
))))
...
(set-info :boogie-vc-id CheckWellformed$$OneModule.C.P)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon5_Else_correct  (=> (and (and (= |b$reqreads#2@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@4 OneModule.C.data))) (= (OneModule.C.P $Heap@@4 this@@4) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@4) OneModule.C.data))) 20))) (and ($Is boolType (bool_2_U (OneModule.C.P $Heap@@4 this@@4)) TBool) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#2@0|)))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#3| null $Heap@@4 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@4) OneModule.C.Repr)))) (=> (and (and ($IsAllocBox ($Box refType this@@4) Tclass.OneModule.C? $Heap@@4) (= |b$reqreads#0@0| (forall (($o@@20 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@20 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@20) alloc)))) (or (= $o@@20 this@@4) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@4) OneModule.C.Repr)) ($Box refType $o@@20)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@20 $f@@0)))
 :qid |AutoContractsdfy.38:21|
 :skolemid |545|
)))) (and (|OneModule.C.Valid#canCall| $Heap@@4 this@@4) (OneModule.C.Valid $Heap@@4 this@@4))) (and (=> (= (ControlFlow 0 4) (- 0 6)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (=> (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@4 OneModule.C.Repr))) (and (=> (= (ControlFlow 0 4) (- 0 5)) |b$reqreads#1@0|) (=> |b$reqreads#1@0| (and (=> (= (ControlFlow 0 4) 1) anon5_Then_correct) (=> (= (ControlFlow 0 4) 3) anon5_Else_correct)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (=> (and (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass.OneModule.C) ($IsAlloc refType this@@4 Tclass.OneModule.C $Heap@@4))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 7) 4))) anon0_correct))))
