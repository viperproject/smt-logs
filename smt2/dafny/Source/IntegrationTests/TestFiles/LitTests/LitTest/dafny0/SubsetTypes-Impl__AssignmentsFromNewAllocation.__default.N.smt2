...
(assert (distinct TInt TagInt alloc Tagclass._System.array? Tagclass._System.array Tagclass.AssignmentsFromNewAllocation.Person Tagclass.AssignmentsFromNewAllocation.Person? tytagFamily$array tytagFamily$Person)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((|c#0@@0| T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType |c#0@@0| Tclass.AssignmentsFromNewAllocation.Person $h@@0) ($IsAlloc refType |c#0@@0| Tclass.AssignmentsFromNewAllocation.Person? $h@@0))
 :qid |unknown.0:0|
 :skolemid |3524|
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass.AssignmentsFromNewAllocation.Person $h@@0))
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass.AssignmentsFromNewAllocation.Person? $h@@0))
)))
...
(assert (forall (($o@@2 T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType $o@@2 Tclass.AssignmentsFromNewAllocation.Person? $h@@2)  (or (= $o@@2 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@2) alloc)))))
 :qid |unknown.0:0|
 :skolemid |3522|
 :pattern ( ($IsAlloc refType $o@@2 Tclass.AssignmentsFromNewAllocation.Person? $h@@2))
)))
...
(assert (forall ((|c#0@@2| T@U) ) (! (= ($Is refType |c#0@@2| Tclass.AssignmentsFromNewAllocation.Person)  (and ($Is refType |c#0@@2| Tclass.AssignmentsFromNewAllocation.Person?) (or (not (= |c#0@@2| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |3523|
 :pattern ( ($Is refType |c#0@@2| Tclass.AssignmentsFromNewAllocation.Person))
 :pattern ( ($Is refType |c#0@@2| Tclass.AssignmentsFromNewAllocation.Person?))
)))
...
(set-info :boogie-vc-id Impl$$AssignmentsFromNewAllocation.__default.N)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon6_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) ($Is refType $nw@1 (Tclass._System.array Tclass.AssignmentsFromNewAllocation.Person)))))
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 5) 4) anon6_Then_correct)))
(let ((anon5_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) ($Is refType $nw@0 (Tclass._System.array Tclass.AssignmentsFromNewAllocation.Person?)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 6) (- 0 9)) (<= 0 (LitInt 1))) (=> (<= 0 (LitInt 1)) (and (=> (= (ControlFlow 0 6) (- 0 8)) (= (LitInt 1) 1)) (=> (= (LitInt 1) 1) (=> (and (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? Tclass.AssignmentsFromNewAllocation.Person))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc)))) (= (_System.array.Length $nw@0) (LitInt 1)))) (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) (IndexField 0))) |p#0|) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= 0 (LitInt 1))) (=> (<= 0 (LitInt 1)) (=> (and (and (and (or (not (= $nw@1 null)) (not true)) ($Is refType $nw@1 (Tclass._System.array? Tclass.AssignmentsFromNewAllocation.Person?))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1) alloc))))) (and (and (= (_System.array.Length $nw@1) (LitInt 1)) (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)))) (and (=> (= (ControlFlow 0 6) 2) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |p#0| Tclass.AssignmentsFromNewAllocation.Person) ($IsAlloc refType |p#0| Tclass.AssignmentsFromNewAllocation.Person $Heap))) (=> (and (and (and (and ($Is refType |a#0| (Tclass._System.array Tclass.AssignmentsFromNewAllocation.Person)) ($IsAlloc refType |a#0| (Tclass._System.array Tclass.AssignmentsFromNewAllocation.Person) $Heap)) (and ($Is refType |b#0| (Tclass._System.array Tclass.AssignmentsFromNewAllocation.Person?)) ($IsAlloc refType |b#0| (Tclass._System.array Tclass.AssignmentsFromNewAllocation.Person?) $Heap))) (and (and ($Is refType |c#0@@3| (Tclass._System.array Tclass.AssignmentsFromNewAllocation.Person)) ($IsAlloc refType |c#0@@3| (Tclass._System.array Tclass.AssignmentsFromNewAllocation.Person) $Heap)) true)) (and (and (and ($Is refType |d#0| (Tclass._System.array Tclass.AssignmentsFromNewAllocation.Person?)) ($IsAlloc refType |d#0| (Tclass._System.array Tclass.AssignmentsFromNewAllocation.Person?) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 6)))) anon0_correct))))
