...
(assert (distinct TInt TagInt alloc allocName class._module.C? Tagclass._module.C? Tagclass._module.C tytagFamily$C field$f field$g)
)
(assert (= (FDim alloc) 0))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon9_Else_correct  (=> (and (and (and (and (not (U_2_bool (Lit boolType (bool_2_U true)))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (= (ControlFlow 0 17) (- 0 16))) false)))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 11) (- 0 15)) (or (not (= |c#0@@1| null)) (not true))) (=> (or (not (= |c#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 11) (- 0 14)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@1| _module.C.g))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@1| _module.C.g)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (or (not (= |c#0@@1| null)) (not true))) (=> (or (not (= |c#0@@1| null)) (not true)) (=> (= |$rhs#0_0@0| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#0@@1|) _module.C.g))) |x#0|)) (=> (and (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 |c#0@@1| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#0@@1|) _module.C.g ($Box intType (int_2_U |$rhs#0_0@0|))))) ($IsGoodHeap $Heap@1)) (and (=> (= (ControlFlow 0 11) (- 0 12)) ($IsAlloc refType |c#0@@1| Tclass._module.C $Heap)) (=> ($IsAlloc refType |c#0@@1| Tclass._module.C $Heap) (=> (= (ControlFlow 0 11) (- 0 10)) (forall (($o@@6 T@U) ($f@@0 T@U) ) (!  (=> (or (not (= $o@@6 null)) (not true)) (=> (and (= $o@@6 |c#0@@1|) (or (= $f@@0 _module.C.g) (= $f@@0 alloc))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@6) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) $f@@0))))
 :qid |Unchangeddfy.38:14|
 :skolemid |518|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@6) $f@@0))
)))))))))))))))
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) ($IsAlloc refType |c#0@@1| Tclass._module.C $Heap)) (=> ($IsAlloc refType |c#0@@1| Tclass._module.C $Heap) (=> (= (ControlFlow 0 8) (- 0 7)) (forall (($o@@7 T@U) ($f@@1 T@U) ) (!  (=> (or (not (= $o@@7 null)) (not true)) (=> (and (= $o@@7 |c#0@@1|) (or (= $f@@1 _module.C.f) (= $f@@1 alloc))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@7) $f@@1))))
 :qid |Unchangeddfy.35:26|
 :skolemid |520|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7) $f@@1))
)))))))
(let ((anon7_Then_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) ($IsAlloc refType |d#0| Tclass._module.C $Heap)) (=> ($IsAlloc refType |d#0| Tclass._module.C $Heap) (=> (= (ControlFlow 0 5) (- 0 4)) (forall (($o@@8 T@U) ($f@@2 T@U) ) (!  (=> (or (not (= $o@@8 null)) (not true)) (=> (= $o@@8 |d#0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@8) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@8) $f@@2))))
 :qid |Unchangeddfy.34:26|
 :skolemid |522|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@8) $f@@2))
)))))))
(let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |c#0@@1| Tclass._module.C $Heap)) (=> ($IsAlloc refType |c#0@@1| Tclass._module.C $Heap) (=> (= (ControlFlow 0 2) (- 0 1)) (forall (($o@@9 T@U) ($f@@3 T@U) ) (!  (=> (or (not (= $o@@9 null)) (not true)) (=> (= $o@@9 |c#0@@1|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@9) $f@@3) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@9) $f@@3))))
 :qid |Unchangeddfy.33:26|
 :skolemid |524|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@9) $f@@3))
)))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc this |c#0@@1|)) (and (=> (= (ControlFlow 0 18) (- 0 21)) (or (not (= |c#0@@1| null)) (not true))) (=> (or (not (= |c#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 18) (- 0 20)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@1| _module.C.f))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@1| _module.C.f)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (or (not (= |c#0@@1| null)) (not true))) (=> (or (not (= |c#0@@1| null)) (not true)) (=> (= |$rhs#0@0| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0@@1|) _module.C.f))) 1)) (=> (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap |c#0@@1| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0@@1|) _module.C.f ($Box intType (int_2_U |$rhs#0@0|))))) ($IsGoodHeap $Heap@0)) (and (and (and (and (=> (= (ControlFlow 0 18) 2) anon6_Then_correct) (=> (= (ControlFlow 0 18) 5) anon7_Then_correct)) (=> (= (ControlFlow 0 18) 8) anon8_Then_correct)) (=> (= (ControlFlow 0 18) 11) anon9_Then_correct)) (=> (= (ControlFlow 0 18) 17) anon9_Else_correct)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.C) ($IsAlloc refType this Tclass._module.C $Heap))) (and ($Is refType |c#0@@1| Tclass._module.C) ($IsAlloc refType |c#0@@1| Tclass._module.C $Heap))) (and (and ($Is refType |d#0| Tclass._module.C) ($IsAlloc refType |d#0| Tclass._module.C $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 22) 18)))) anon0_correct))))
