...
(set-info :boogie-vc-id Impl$$Recursion.__default.Y_h)
...
(let ((anon3_Then_correct  (=> (< 0 (|ORD#Offset| |_k#0|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (=> (= (ControlFlow 0 2) (- 0 1)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0|))))))))
