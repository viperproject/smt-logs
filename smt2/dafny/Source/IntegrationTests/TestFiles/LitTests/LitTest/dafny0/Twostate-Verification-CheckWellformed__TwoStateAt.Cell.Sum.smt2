...
(declare-fun TwoStateAt.Cell.Sum$Y@@1 () T@U)
(declare-fun $Heap@@3 () T@U)
(declare-fun |b$reqreads#0@0| () Bool)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun previous$Heap () T@U)
(set-info :boogie-vc-id CheckWellformed$$TwoStateAt.Cell.Sum)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (not (= |c#0@@5| null)) (not true))) (=> (or (not (= |c#0@@5| null)) (not true)) (=> (and ($IsAllocBox ($Box refType |c#0@@5|) Tclass.TwoStateAt.Cell? current$Heap) ($IsAllocBox |y#0@@6| TwoStateAt.Cell.Sum$Y@@1 current$Heap)) (and (=> (= (ControlFlow 0 3) (- 0 5)) ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@@3)) (=> ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@@3) (and (=> (= (ControlFlow 0 3) (- 0 4)) ($IsAllocBox |y#0@@6| TwoStateAt.Cell.Sum$Y@@1 $Heap@@3)) (=> ($IsAllocBox |y#0@@6| TwoStateAt.Cell.Sum$Y@@1 $Heap@@3) (=> (and (= |b$reqreads#0@0| (forall (($o@@7 T@U) ($f@@3 T@U) ) (!  (=> (and (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@7) alloc)))) (= $o@@7 |c#0@@5|)) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@7 $f@@3)))
 :qid |TwostateVerificationdfy.253:9|
 :skolemid |808|
))) (|TwoStateAt.Cell.Plus#canCall| TwoStateAt.Cell.Sum$Y@@1 $Heap@@3 current$Heap |c#0@@5| |y#0@@6|)) (=> (and (and (= (TwoStateAt.Cell.Sum TwoStateAt.Cell.Sum$Y@@1 $Heap@@3 current$Heap |c#0@@5| |y#0@@6|) (TwoStateAt.Cell.Plus TwoStateAt.Cell.Sum$Y@@1 $Heap@@3 current$Heap |c#0@@5| |y#0@@6|)) (|TwoStateAt.Cell.Plus#canCall| TwoStateAt.Cell.Sum$Y@@1 $Heap@@3 current$Heap |c#0@@5| |y#0@@6|)) (and ($Is intType (int_2_U (TwoStateAt.Cell.Sum TwoStateAt.Cell.Sum$Y@@1 $Heap@@3 current$Heap |c#0@@5| |y#0@@6|)) TInt) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|)))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null current$Heap alloc |c#0@@5|)) (and (=> (= (ControlFlow 0 7) 1) anon5_Then_correct) (=> (= (ControlFlow 0 7) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (and ($Is refType |c#0@@5| Tclass.TwoStateAt.Cell) ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell previous$Heap))) (=> (and (and (and ($IsBox |y#0@@6| TwoStateAt.Cell.Sum$Y@@1) ($IsAllocBox |y#0@@6| TwoStateAt.Cell.Sum$Y@@1 previous$Heap)) (= 3 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@3) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 8) 7))) anon0_correct))))
