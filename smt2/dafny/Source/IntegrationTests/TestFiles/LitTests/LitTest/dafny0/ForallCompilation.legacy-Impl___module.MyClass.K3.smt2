...
(set-info :boogie-vc-id Impl$$_module.MyClass.K3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon3_correct  (=> (and (or (= |k#0_0@0| (LitInt (- 0 3))) (= |k#0_0@0| (LitInt 4))) (<= |k#0_0@0| |i#0|)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.MyClass.arr)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.MyClass.arr)) null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (and (<= 0 |k#0_0@0|) (< |k#0_0@0| (_System.array2.Length0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.MyClass.arr)))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (and (<= 0 |j#0|) (< |j#0| (_System.array2.Length1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.MyClass.arr)))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.MyClass.arr)) (MultiIndexField (IndexField |k#0_0@0|) |j#0|)))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.MyClass.arr)) (MultiIndexField (IndexField |k#0_0@0|) |j#0|))) (=> (<= (LitInt 0) |k#0_1@0|) (=> (and (and (or (= |k#0_1@0| (LitInt (- 0 3))) (= |k#0_1@0| (LitInt 4))) (<= |k#0_1@0| |i#0|)) (and (or (not (= |k#0_0@0| |k#0_1@0|)) (not true)) (= (ControlFlow 0 3) (- 0 2)))) (or (or (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.MyClass.arr)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.MyClass.arr)))) (not true)) (or (not (= (MultiIndexField (IndexField |k#0_0@0|) |j#0|) (MultiIndexField (IndexField |k#0_1@0|) |j#0|))) (not true))) (= (LitInt 50) (LitInt 50))))))))))))))
(let ((anon6_Else_correct  (=> (and (not (or (= |k#0_0@0| (LitInt (- 0 3))) (= |k#0_0@0| (LitInt 4)))) (= (ControlFlow 0 9) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (or (= |k#0_0@0| (LitInt (- 0 3))) (= |k#0_0@0| (LitInt 4))) (= (ControlFlow 0 8) 3)) anon3_correct)))
(let ((anon5_Then_correct  (=> (<= (LitInt 0) |k#0_0@0|) (and (=> (= (ControlFlow 0 10) 8) anon6_Then_correct) (=> (= (ControlFlow 0 10) 9) anon6_Else_correct)))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap alloc ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.MyClass.arr)))) (and (=> (= (ControlFlow 0 11) 10) anon5_Then_correct) (=> (= (ControlFlow 0 11) 1) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.MyClass) ($IsAlloc refType this Tclass._module.MyClass $Heap))) (and (= 0 $FunctionContextHeight) (<= (LitInt 0) |i#0|))) (and (and (< |i#0| (_System.array2.Length0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.MyClass.arr)))) (<= (LitInt 0) |j#0|)) (and (< |j#0| (_System.array2.Length1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.MyClass.arr)))) (= (ControlFlow 0 12) 11)))) anon0_correct))))
