...
(set-info :boogie-vc-id Impl$$NeedsAllLiteralsAxiom.__default.lemma__trick)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (forall ((|$ih#n0#0| Int) (|$ih#m0#0| Int) ) (!  (=> (and (and (and (<= (LitInt 0) |$ih#n0#0|) (<= (LitInt 0) |$ih#m0#0|)) (U_2_bool (Lit boolType (bool_2_U true)))) (or (and (<= 0 |$ih#n0#0|) (< |$ih#n0#0| |n#0@@4|)) (and (= |$ih#n0#0| |n#0@@4|) (and (<= 0 |$ih#m0#0|) (< |$ih#m0#0| |m#0@@4|))))) (= (NeedsAllLiteralsAxiom.__default.trick ($LS $LZ) |$ih#n0#0| |$ih#m0#0|) |$ih#n0#0|))
 :qid |AllLiteralsAxiomdfy.16:21|
 :skolemid |536|
 :pattern ( (NeedsAllLiteralsAxiom.__default.trick ($LS $LZ) |$ih#n0#0| |$ih#m0#0|))
)) (= (ControlFlow 0 2) (- 0 1)))) (= (NeedsAllLiteralsAxiom.__default.trick ($LS ($LS $LZ)) |n#0@@4| |m#0@@4|) |n#0@@4|)))))
