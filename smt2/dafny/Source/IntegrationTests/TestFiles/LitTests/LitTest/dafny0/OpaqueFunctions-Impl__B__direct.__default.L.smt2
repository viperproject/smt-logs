...
(declare-fun B____direct.X.Abs.C.Get (T@U T@U) Int)
...
(assert (forall (($h0 T@U) ($h1 T@U) (this@@0 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass.B____direct.X.Abs.C))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@3 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@3 null)) (not true)) (= $o@@3 this@@0)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@3) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@3) $f@@0)))
 :qid |unknown.0:0|
 :skolemid |3021|
)) (= (B____direct.X.Abs.C.Valid $h0 this@@0) (B____direct.X.Abs.C.Valid $h1 this@@0))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |3022|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (B____direct.X.Abs.C.Valid $h1 this@@0))
)))
(assert (forall (($h@@2 T@U) ($o@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (or (not (= $o@@4 null)) (not true)) (= (dtype $o@@4) Tclass.B____direct.X.Abs.C?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@4) B____direct.X.Abs.C.x)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |3030|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@4) B____direct.X.Abs.C.x)))
)))
(assert (forall (($h0@@0 T@U) ($h1@@0 T@U) (this@@1 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 Tclass.B____direct.X.Abs.C))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@5 T@U) ($f@@1 T@U) ) (!  (=> (and (or (not (= $o@@5 null)) (not true)) (= $o@@5 this@@1)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@5) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@0 $o@@5) $f@@1)))
 :qid |unknown.0:0|
 :skolemid |3032|
)) (= (B____direct.X.Abs.C.Get $h0@@0 this@@1) (B____direct.X.Abs.C.Get $h1@@0 this@@1))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |3033|
 :pattern ( ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0) (B____direct.X.Abs.C.Get $h1@@0 this@@1))
)))
...
(declare-fun $Heap@0 () T@U)
(declare-fun |B____direct.X.Abs.C.Get#canCall| (T@U T@U) Bool)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$B__direct.__default.L)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon6_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 13)) (or (not (= |c#0@@1| null)) (not true))) (=> (or (not (= |c#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 10) (- 0 12)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@1| B____direct.X.Abs.C.x))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@1| B____direct.X.Abs.C.x)) (=> (= |$rhs#1_1_0@0| (LitInt 8)) (=> (and (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@0 |c#0@@1| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |c#0@@1|) B____direct.X.Abs.C.x ($Box intType (int_2_U |$rhs#1_1_0@0|))))) ($IsGoodHeap $Heap@1)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (or (not (= |c#0@@1| null)) (not true))) (=> (and (and ($IsAllocBox ($Box refType |c#0@@1|) Tclass.B____direct.X.Abs.C? $Heap@1) (|B____direct.X.Abs.C.Valid#canCall| $Heap@1 |c#0@@1|)) (and (|B____direct.X.Abs.C.Valid#canCall| $Heap@1 |c#0@@1|) (= (ControlFlow 0 10) (- 0 9)))) (B____direct.X.Abs.C.Valid $Heap@1 |c#0@@1|)))))))))))
(let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 5) (- 0 8)) (or (not (= |c#0@@1| null)) (not true))) (=> (or (not (= |c#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@1| B____direct.X.Abs.C.x))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@1| B____direct.X.Abs.C.x)) (=> (= |$rhs#1_0_0@0| (LitInt 7)) (=> (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@0 |c#0@@1| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |c#0@@1|) B____direct.X.Abs.C.x ($Box intType (int_2_U |$rhs#1_0_0@0|))))) ($IsGoodHeap $Heap@0)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= |c#0@@1| null)) (not true))) (=> (and (and ($IsAllocBox ($Box refType |c#0@@1|) Tclass.B____direct.X.Abs.C? $Heap@0) (|B____direct.X.Abs.C.Valid#canCall| $Heap@0 |c#0@@1|)) (and (|B____direct.X.Abs.C.Valid#canCall| $Heap@0 |c#0@@1|) (= (ControlFlow 0 5) (- 0 4)))) (B____direct.X.Abs.C.Valid $Heap@0 |c#0@@1|)))))))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 14) 5) anon6_Then_correct) (=> (= (ControlFlow 0 14) 10) anon6_Else_correct))))
(let ((anon5_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |c#0@@1| null)) (not true))) (=> (and (and ($IsAllocBox ($Box refType |c#0@@1|) Tclass.B____direct.X.Abs.C? $Heap@@0) (|B____direct.X.Abs.C.Valid#canCall| $Heap@@0 |c#0@@1|)) (and (|B____direct.X.Abs.C.Valid#canCall| $Heap@@0 |c#0@@1|) (= (ControlFlow 0 2) (- 0 1)))) (B____direct.X.Abs.C.Valid $Heap@@0 |c#0@@1|)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@0 alloc |c#0@@1|)) (and (=> (= (ControlFlow 0 15) (- 0 18)) (or (not (= |c#0@@1| null)) (not true))) (=> (and ($IsAllocBox ($Box refType |c#0@@1|) Tclass.B____direct.X.Abs.C? $Heap@@0) (|B____direct.X.Abs.C.Get#canCall| $Heap@@0 |c#0@@1|)) (and (=> (= (ControlFlow 0 15) (- 0 17)) (or (not (= |c#0@@1| null)) (not true))) (=> (|B____direct.X.Abs.C.Get#canCall| $Heap@@0 |c#0@@1|) (and (=> (= (ControlFlow 0 15) (- 0 16)) (= (B____direct.X.Abs.C.Get $Heap@@0 |c#0@@1|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |c#0@@1|) B____direct.X.Abs.C.x))))) (=> (= (B____direct.X.Abs.C.Get $Heap@@0 |c#0@@1|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |c#0@@1|) B____direct.X.Abs.C.x)))) (and (=> (= (ControlFlow 0 15) 2) anon5_Then_correct) (=> (= (ControlFlow 0 15) 14) anon5_Else_correct)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is refType |c#0@@1| Tclass.B____direct.X.Abs.C) ($IsAlloc refType |c#0@@1| Tclass.B____direct.X.Abs.C $Heap@@0)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 19) 15))) anon0_correct))))
