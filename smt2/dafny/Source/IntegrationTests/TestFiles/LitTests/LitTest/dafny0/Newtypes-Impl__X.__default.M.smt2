...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |newtype$check#0@0| (LitInt 4))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 100))) (=> (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 100)) (=> (= |i#0@0| (LitInt 4)) (=> (and (= |newtype$check#1@0| (LitReal 4.0)) (= (ControlFlow 0 2) (- 0 1))) (and (<= (LitReal 0.0) |newtype$check#1@0|) (<= |newtype$check#1@0| (LitReal 100.0))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (<= (LitInt 0) |i#0|) (< |i#0| 100))) (and (and (<= (LitReal 0.0) |r#0|) (<= |r#0| (LitReal 100.0))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct)))
