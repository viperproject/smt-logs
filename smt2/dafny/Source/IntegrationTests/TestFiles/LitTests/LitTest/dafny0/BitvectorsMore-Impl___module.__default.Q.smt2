...
(declare-fun |x#0| () (_ BitVec 10))
(declare-fun |y#0| () (_ BitVec 10))
...
(let ((anon3_Then_correct  (=> (and (bvult |x#0| #b0000000000) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |y#0| #b0000000000)) (not true)))))
