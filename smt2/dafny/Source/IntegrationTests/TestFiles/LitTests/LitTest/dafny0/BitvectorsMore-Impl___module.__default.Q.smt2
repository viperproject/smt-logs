...
(declare-fun $generated@@80 () (_ BitVec 10))
(declare-fun $generated@@81 () (_ BitVec 10))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let (($generated@@89 true))
(let (($generated@@90  (=> (and (bvult $generated@@80 #b0000000000) (= (ControlFlow 0 2) (- 0 1))) (or (not (= $generated@@81 #b0000000000)) (not true)))))
(let (($generated@@91  (=> (= $generated@@82 ($generated@@24 $generated@@83 $generated@@84 $generated@@85 false)) (and (=> (= (ControlFlow 0 4) 2) $generated@@90) (=> (= (ControlFlow 0 4) 3) $generated@@89)))))
