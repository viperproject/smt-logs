...
procedure {:verboseName "Datatypes.f1 (well-formedness)"} CheckWellformed$$Datatypes.__default.f1(t#0: DatatypeType where $Is(t#0, Tclass.Datatypes.TheType()));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Datatypes.f1 (well-formedness)"} CheckWellformed$$Datatypes.__default.f1(t#0: DatatypeType)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    assume {:id "id172"} Datatypes.TheType.TheType__builder_q(t#0);
    assert {:id "id173"} Datatypes.TheType.TheType__builder_q(t#0);
    assume {:id "id174"} Datatypes.TheType.x(t#0) > 3;
...
procedure {:verboseName "Datatypes.test (well-formedness)"} CheckWellformed$$Datatypes.__default.test(t#0: DatatypeType where $Is(t#0, Tclass.Datatypes.TheType()));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Datatypes.test (well-formedness)"} CheckWellformed$$Datatypes.__default.test(t#0: DatatypeType)
{
  var $_ReadsFrame: [ref,Field]bool;
  var ##t#0: DatatypeType;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    // Check well-formedness of preconditions, and then assume them
    if (Datatypes.TheType.TheType__builder_q(t#0))
    {
        assert {:id "id177"} Datatypes.TheType.TheType__builder_q(t#0);
    }

    assume {:id "id178"} Datatypes.TheType.TheType__builder_q(t#0) && Datatypes.TheType.x(t#0) > 3;
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    ...
    else
    {
        ...
        assert {:id "id179"} {:subsumption 0} Datatypes.TheType.TheType__builder_q(##t#0);
        assert {:id "id180"} {:subsumption 0} Datatypes.TheType.x(##t#0) > 3;
        assume Datatypes.TheType.TheType__builder_q(##t#0) && Datatypes.TheType.x(##t#0) > 3;
        assume Datatypes.__default.f1#canCall(t#0);
        assume {:id "id181"} Datatypes.__default.test(t#0) == Datatypes.__default.f1(t#0);
        assume Datatypes.__default.f1#canCall(t#0);
...
procedure {:verboseName "Datatypes.f2 (well-formedness)"} CheckWellformed$$Datatypes.__default.f2(x#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Datatypes.f2 (well-formedness)"} CheckWellformed$$Datatypes.__default.f2(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var t#3: DatatypeType;
    ...
    assume $Is(t#3, Tclass.Datatypes.TheType())
       && $IsAlloc(t#3, Tclass.Datatypes.TheType(), $Heap);
    assume {:id "id184"} Datatypes.TheType.TheType__builder_q(t#3);
    assert {:id "id185"} Datatypes.TheType.TheType__builder_q(t#3);
    assume {:id "id186"} Datatypes.TheType.x(t#3) > x#0;
    assume {:id "id187"} (forall t#0: DatatypeType :: 
    ...
    {
        // Check well-formedness of body and result subset type constraint
        assume {:id "id188"} Datatypes.__default.f2(x#0) == Lit(true);
        assume true;
        // CheckWellformedWithResult: any expression
...
axiom {:id "id189"} 2 <= $FunctionContextHeight
   ==> (forall y#0: int :: 
    ...
    Datatypes.__default.f3#canCall(y#0) || 2 < $FunctionContextHeight
...
axiom {:id "id190"} 2 <= $FunctionContextHeight
   ==> (forall y#0: int :: 
    ...
    Datatypes.__default.f3#canCall(LitInt(y#0)) || 2 < $FunctionContextHeight
...
procedure {:verboseName "Datatypes.f3 (well-formedness)"} CheckWellformed$$Datatypes.__default.f3(y#0: int);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Datatypes.f3 (well-formedness)"} CheckWellformed$$Datatypes.__default.f3(y#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var ##x#0: int;
    ...
    else
    {
        ...
        assert {:id "id191"} {:subsumption 0} (forall t#0: DatatypeType :: 
          { Datatypes.TheType.x(t#0) } { Datatypes.TheType.TheType__builder_q(t#0) } 
          $Is(t#0, Tclass.Datatypes.TheType())
             ==> Datatypes.TheType.TheType__builder_q(t#0) && Datatypes.TheType.x(t#0) > ##x#0);
        ...
        assume {:id "id192"} Datatypes.__default.f3(y#0) == Datatypes.__default.f2(y#0);
        assume Datatypes.__default.f2#canCall(y#0);
        // CheckWellformedWithResult: any expression
...
procedure {:verboseName "Datatypes.test2 (well-formedness)"} CheckWellformed$$Datatypes.__default.test2(z#0: int);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Datatypes.test2 (well-formedness)"} CheckWellformed$$Datatypes.__default.test2(z#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var t#3: DatatypeType;
  var ##x#0: int;
    ...
    havoc t#3;
    if ($Is(t#3, Tclass.Datatypes.TheType())
       && $IsAlloc(t#3, Tclass.Datatypes.TheType(), $Heap))
    {
        if (Datatypes.TheType.TheType__builder_q(t#3))
        {
            assert {:id "id195"} Datatypes.TheType.TheType__builder_q(t#3);
        }
    }

    // End Comprehension WF check
    assume {:id "id196"} (forall t#0: DatatypeType :: 
      { Datatypes.TheType.x(t#0) } { Datatypes.TheType.TheType__builder_q(t#0) } 
      $Is(t#0, Tclass.Datatypes.TheType())
    ...
    else
    {
        ...
        // assume allocatedness for argument to function
        assume $IsAlloc(##x#0, TInt, $Heap);
        assert {:id "id197"} {:subsumption 0} (forall t#4: DatatypeType :: 
        ...
        assume {:id "id198"} Datatypes.__default.test2(z#0) == Datatypes.__default.f2(z#0);
        assume Datatypes.__default.f2#canCall(z#0);
        // CheckWellformedWithResult: any expression
