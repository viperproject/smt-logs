...
(set-info :boogie-vc-id Impl$$_module.__default.BigOrdinals2)
...
(let ((anon15_Then_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (exists ((|$as#c0_0_0#0_0_0| T@U) ) (! (|ORD#Less| |$as#c0_0_0#0_0_0| |B#0|)
 :qid |Terminationdfy.1182:11|
 :skolemid |3429|
))) (=> (exists ((|$as#c0_0_0#0_0_0@@0| T@U) ) (! (|ORD#Less| |$as#c0_0_0#0_0_0@@0| |B#0|)
 :qid |Terminationdfy.1182:11|
 :skolemid |3429|
)) (=> (and (|ORD#Less| |c#0_0_0@0| |B#0|) (= (ControlFlow 0 9) 5)) anon10_correct)))))
