...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (= 0 $FunctionContextHeight)) (and (and (<= (LitInt 0) |i#0|) (< |i#0| |j#0|)) (and (< |j#0| (_System.array.Length |a#0|)) (= (ControlFlow 0 17) 2)))) anon0_correct))))
