...
(declare-fun _module._default.PrintSet$T () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon7_correct  (and (=> (= (ControlFlow 0 5) (- 0 8)) (exists ((|$as#x0_0#0_0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0| _module._default.PrintSet$T) (|Set#IsMember| |q#0@0| |$as#x0_0#0_0|))
 :qid |ComprehensionsNewSyntaxdfy.41:9|
 :skolemid |509|
))) (=> (exists ((|$as#x0_0#0_0@@0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0@@0| _module._default.PrintSet$T) (|Set#IsMember| |q#0@0| |$as#x0_0#0_0@@0|))
 :qid |ComprehensionsNewSyntaxdfy.41:9|
 :skolemid |509|
)) (=> (and (=> true (and ($IsBox |x#0_0@1| _module._default.PrintSet$T) ($IsAllocBox |x#0_0@1| _module._default.PrintSet$T $Heap))) (|Set#IsMember| |q#0@0| |x#0_0@1|)) (and (=> (= (ControlFlow 0 5) (- 0 7)) true) (and (=> (= (ControlFlow 0 5) (- 0 6)) true) (=> (and (= |q#0@1| (|Set#Difference| |q#0@0| (|Set#UnionOne| |Set#Empty| |x#0_0@1|))) (= (ControlFlow 0 5) (- 0 4))) (and (|Set#Subset| |q#0@1| |q#0@0|) (not (|Set#Subset| |q#0@0| |q#0@1|)))))))))))
(let ((anon12_Else_correct  (=> (and (not (and ($IsBox |x#0_1@1| _module._default.PrintSet$T) ($IsAllocBox |x#0_1@1| _module._default.PrintSet$T $Heap))) (= (ControlFlow 0 10) 5)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and (and ($IsBox |x#0_1@1| _module._default.PrintSet$T) ($IsAllocBox |x#0_1@1| _module._default.PrintSet$T $Heap)) (= (ControlFlow 0 9) 5)) anon7_correct)))
(let ((anon11_Else_correct  (=> (not (|Set#Equal| |q#0@0| |Set#Empty|)) (and (=> (= (ControlFlow 0 11) 9) anon12_Then_correct) (=> (= (ControlFlow 0 11) 10) anon12_Else_correct)))))
...
(let ((anon9_LoopHead_correct  (=> (=> |defass#x#0_0@0| (and ($IsBox |x#0_0@0| _module._default.PrintSet$T) ($IsAllocBox |x#0_0@0| _module._default.PrintSet$T $Heap))) (=> (and (and (and ($Is SetType |q#0@0| (TSet _module._default.PrintSet$T)) ($IsAlloc SetType |q#0@0| (TSet _module._default.PrintSet$T) $Heap)) (not false)) (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |ComprehensionsNewSyntaxdfy.38:3|
 :skolemid |507|
...
)) (|Set#Subset| |q#0@0| |s#0|)))) (and (=> (= (ControlFlow 0 14) 1) anon9_LoopDone_correct) (=> (= (ControlFlow 0 14) 13) anon9_LoopBody_correct))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 15) 14)) anon9_LoopHead_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SetType |s#0| (TSet _module._default.PrintSet$T)) ($IsAlloc SetType |s#0| (TSet _module._default.PrintSet$T) $Heap))) (=> (and (and (and ($Is SetType |q#0| (TSet _module._default.PrintSet$T)) ($IsAlloc SetType |q#0| (TSet _module._default.PrintSet$T) $Heap)) true) (and (and (=> |defass#x#0_0| (and ($IsBox |x#0_0| _module._default.PrintSet$T) ($IsAllocBox |x#0_0| _module._default.PrintSet$T $Heap))) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 16) 15)))) anon0_correct))))
