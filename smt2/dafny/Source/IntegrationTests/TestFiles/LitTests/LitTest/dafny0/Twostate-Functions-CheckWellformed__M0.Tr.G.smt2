...
(assert (forall (($prevHeap@@0 T@U) ($h0 T@U) ($h1 T@U) (this@@0 T@U) (|c#0@@0| T@U) (|d#0@@0| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass.M0.Tr))) (or (|M0.Tr.G#canCall| $prevHeap@@0 $h0 this@@0 |c#0@@0| |d#0@@0|) (and ($Is refType |c#0@@0| Tclass.M0.C?) ($Is refType |d#0@@0| Tclass.M0.C)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@0 T@U) ($f@@0 T@U) )  (=> (and (or (not (= $o@@0 null)) (not true)) (or (= $o@@0 |c#0@@0|) (= $o@@0 |d#0@@0|))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@0) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@0) $f@@0)))) (= (M0.Tr.G $prevHeap@@0 $h0 this@@0 |c#0@@0| |d#0@@0|) (M0.Tr.G $prevHeap@@0 $h1 this@@0 |c#0@@0| |d#0@@0|))))
