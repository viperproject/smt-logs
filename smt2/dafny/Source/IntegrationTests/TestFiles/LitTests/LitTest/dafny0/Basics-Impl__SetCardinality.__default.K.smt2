...
(declare-fun SetCardinality._default.K$T () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$SetCardinality.__default.K)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (= (+ (+ (+ (|MultiSet#Card| (|MultiSet#Intersection| |s#0| |t#0|)) (|MultiSet#Card| (|MultiSet#Intersection| |t#0| |s#0|))) (|MultiSet#Card| (|MultiSet#Difference| |s#0| |t#0|))) (|MultiSet#Card| (|MultiSet#Difference| |t#0| |s#0|))) (|MultiSet#Card| (|MultiSet#Union| |s#0| |t#0|))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is MultiSetType |s#0| (TMultiSet SetCardinality._default.K$T)) ($IsAlloc MultiSetType |s#0| (TMultiSet SetCardinality._default.K$T) $Heap))) (and (and ($Is MultiSetType |t#0| (TMultiSet SetCardinality._default.K$T)) ($IsAlloc MultiSetType |t#0| (TMultiSet SetCardinality._default.K$T) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
