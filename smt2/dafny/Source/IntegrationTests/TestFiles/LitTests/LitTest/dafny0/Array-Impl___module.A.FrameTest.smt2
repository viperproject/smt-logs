...
(declare-fun |call3formal@b#0| () T@U)
(declare-fun $Heap@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |call3formal@b#0@0| () T@U)
(declare-fun |_module.A.Q1#canCall| (T@U T@U) Bool)
(declare-fun this () T@U)
(declare-fun _module.A.Q1 (T@U T@U) Bool)
(declare-fun |a#0| () T@U)
(declare-fun |##s#1@0| () T@U)
(declare-fun |_module.A.Q0#canCall| (T@U T@U) Bool)
(declare-fun _module.A.Q0 (T@U T@U) Bool)
(declare-fun |##s#2@0| () T@U)
(declare-fun |b#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.A.FrameTest)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($Is refType |call3formal@b#0| (Tclass._System.array TInt)) ($IsAlloc refType |call3formal@b#0| (Tclass._System.array TInt) $Heap)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (=> (and (and (and (and ($Is refType |call3formal@b#0@0| (Tclass._System.array TInt)) ($IsAlloc refType |call3formal@b#0@0| (Tclass._System.array TInt) $Heap@0)) (=> (and (or (not (= |call3formal@b#0@0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |call3formal@b#0@0|) alloc))))) (|_module.A.Q1#canCall| this (|Seq#FromArray| $Heap@0 |call3formal@b#0@0|)))) (and (or (not (= |call3formal@b#0@0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |call3formal@b#0@0|) alloc)))))) (and (and (_module.A.Q1 this (|Seq#FromArray| $Heap@0 |call3formal@b#0@0|)) (forall (($o@@8 T@U) ) (!  (=> (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@8) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@8) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@8)))
 :qid |Arraydfy.148:10|
 :skolemid |1276|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@8))
))) (and ($HeapSucc $Heap $Heap@0) ($IsAllocBox ($Box refType this) Tclass._module.A? $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (and (and (= |##s#1@0| (|Seq#FromArray| $Heap@0 |a#0|)) ($IsAlloc SeqType |##s#1@0| (TSeq TInt) $Heap@0)) (and (|_module.A.Q0#canCall| this (|Seq#FromArray| $Heap@0 |a#0|)) (|_module.A.Q0#canCall| this (|Seq#FromArray| $Heap@0 |a#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (_module.A.Q0 this (|Seq#FromArray| $Heap@0 |a#0|))) (=> (_module.A.Q0 this (|Seq#FromArray| $Heap@0 |a#0|)) (=> ($IsAllocBox ($Box refType this) Tclass._module.A? $Heap@0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |call3formal@b#0@0| null)) (not true))) (=> (or (not (= |call3formal@b#0@0| null)) (not true)) (=> (= |##s#2@0| (|Seq#FromArray| $Heap@0 |call3formal@b#0@0|)) (=> (and (and ($IsAlloc SeqType |##s#2@0| (TSeq TInt) $Heap@0) (|_module.A.Q1#canCall| this (|Seq#FromArray| $Heap@0 |call3formal@b#0@0|))) (and (|_module.A.Q1#canCall| this (|Seq#FromArray| $Heap@0 |call3formal@b#0@0|)) (= (ControlFlow 0 2) (- 0 1)))) (_module.A.Q1 this (|Seq#FromArray| $Heap@0 |call3formal@b#0@0|)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.A) ($IsAlloc refType this Tclass._module.A $Heap))) (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap))) (=> (and (and (and ($Is refType |b#0| (Tclass._System.array TInt)) ($IsAlloc refType |b#0| (Tclass._System.array TInt) $Heap)) (= 2 $FunctionContextHeight)) (and (_module.A.Q0 this (|Seq#FromArray| $Heap |a#0|)) (= (ControlFlow 0 6) 2))) anon0_correct)))))
