...
(let ((anon8_LoopHead_correct  (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (and (not false) (and (<= 0 |i#0@1|) (< |i#0@1| 11))) (= |$decr_init$loop#00@0| 10)) (and (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@1|)) (=> |$w$loop#0@0| (<= |i#0@1| (LitInt 10))))) (and (and (forall (($o@@7 T@U) ) (!  (=> (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@7) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@7)))
 :qid |LoopModifiesdfy.76:4|
 :skolemid |508|
...
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |i#0@0| (LitInt 0))) (and (=> (= (ControlFlow 0 18) (- 0 21)) (forall (($o@@9 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@9) alloc)))) (= $o@@9 |a#0|)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@9 $f@@2)))
 :qid |LoopModifiesdfy.76:4|
 :skolemid |507|
 ...
 :qid |LoopModifiesdfy.76:4|
 :skolemid |507|
)) (=> (and (= |$Frame$loop#0@0| (|lambda#4| null $Heap alloc |a#0|)) (= |$decr_init$loop#00@0| (- 10 |i#0@0|))) (and (=> (= (ControlFlow 0 18) (- 0 20)) (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@0|))) (=> (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@0|)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (=> |$w$loop#0@0| (<= |i#0@0| (LitInt 10)))) (=> (=> |$w$loop#0@0| (<= |i#0@0| (LitInt 10))) (=> (= (ControlFlow 0 18) 17) anon8_LoopHead_correct)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (= 0 $FunctionContextHeight)) (and (> (_System.array.Length |a#0|) 0) (= (ControlFlow 0 22) 18))) anon0_correct))))
