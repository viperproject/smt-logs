...
(declare-fun _module._default.Multisets3$_T0 () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.Multisets3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon7_correct  (and (=> (= (ControlFlow 0 6) (- 0 9)) (exists ((|$as#x0_0#0_0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0| _module._default.Multisets3$_T0) (> (|MultiSet#Multiplicity| |s#0@0| |$as#x0_0#0_0|) 0))
 :qid |Terminationdfy.767:9|
 :skolemid |3225|
))) (=> (exists ((|$as#x0_0#0_0@@0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0@@0| _module._default.Multisets3$_T0) (> (|MultiSet#Multiplicity| |s#0@0| |$as#x0_0#0_0@@0|) 0))
 :qid |Terminationdfy.767:9|
 :skolemid |3225|
)) (=> (and (=> true (and ($IsBox |x#0_0@1| _module._default.Multisets3$_T0) ($IsAllocBox |x#0_0@1| _module._default.Multisets3$_T0 $Heap))) (> (|MultiSet#Multiplicity| |s#0@0| |x#0_0@1|) 0)) (and (=> (= (ControlFlow 0 6) (- 0 8)) true) (=> (= |s#0@1| (|MultiSet#Difference| |s#0@0| (|MultiSet#UnionOne| |MultiSet#Empty| |x#0_0@1|))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (<= 0 |$decr$loop#00@1|) (= (|MultiSet#Card| |s#0@1|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (|MultiSet#Card| |s#0@1|) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 6) (- 0 5)) (< (|MultiSet#Card| |s#0@1|) |$decr$loop#00@1|)))))))))))
(let ((anon11_Else_correct  (=> (and (not (and ($IsBox |x#0_1@1| _module._default.Multisets3$_T0) ($IsAllocBox |x#0_1@1| _module._default.Multisets3$_T0 $Heap))) (= (ControlFlow 0 11) 6)) anon7_correct)))
(let ((anon11_Then_correct  (=> (and (and ($IsBox |x#0_1@1| _module._default.Multisets3$_T0) ($IsAllocBox |x#0_1@1| _module._default.Multisets3$_T0 $Heap)) (= (ControlFlow 0 10) 6)) anon7_correct)))
...
(let ((anon8_LoopHead_correct  (=> (=> |defass#x#0_0@0| (and ($IsBox |x#0_0@0| _module._default.Multisets3$_T0) ($IsAllocBox |x#0_0@0| _module._default.Multisets3$_T0 $Heap))) (=> (and (and (and ($Is MultiSetType |s#0@0| (TMultiSet _module._default.Multisets3$_T0)) ($IsAlloc MultiSetType |s#0@0| (TMultiSet _module._default.Multisets3$_T0) $Heap)) (not false)) (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |Terminationdfy.766:3|
 :skolemid |3223|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is MultiSetType |S#0| (TMultiSet _module._default.Multisets3$_T0)) ($IsAlloc MultiSetType |S#0| (TMultiSet _module._default.Multisets3$_T0) $Heap))) (=> (and (and (and ($Is MultiSetType |s#0| (TMultiSet _module._default.Multisets3$_T0)) ($IsAlloc MultiSetType |s#0| (TMultiSet _module._default.Multisets3$_T0) $Heap)) true) (and (and (=> |defass#x#0_0| (and ($IsBox |x#0_0| _module._default.Multisets3$_T0) ($IsAllocBox |x#0_0| _module._default.Multisets3$_T0 $Heap))) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 17) 16)))) anon0_correct))))
