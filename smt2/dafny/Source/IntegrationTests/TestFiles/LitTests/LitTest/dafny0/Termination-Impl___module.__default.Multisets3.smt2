...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon7_correct  (and (=> (= (ControlFlow 0 6) (- 0 9)) (exists ((|$as#x0_0#0_0| T@U) )  (and ($IsBox |$as#x0_0#0_0| _module._default.Multisets3$_T0) (> (|MultiSet#Multiplicity| |s#0@0| |$as#x0_0#0_0|) 0)))) (=> (exists ((|$as#x0_0#0_0@@0| T@U) )  (and ($IsBox |$as#x0_0#0_0@@0| _module._default.Multisets3$_T0) (> (|MultiSet#Multiplicity| |s#0@0| |$as#x0_0#0_0@@0|) 0))) (=> (and (=> true (and ($IsBox |x#0_0@1| _module._default.Multisets3$_T0) ($IsAllocBox |x#0_0@1| _module._default.Multisets3$_T0 $Heap))) (> (|MultiSet#Multiplicity| |s#0@0| |x#0_0@1|) 0)) (and (=> (= (ControlFlow 0 6) (- 0 8)) true) (=> (= |s#0@1| (|MultiSet#Difference| |s#0@0| (|MultiSet#UnionOne| |MultiSet#Empty| |x#0_0@1|))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (<= 0 |$decr$loop#00@1|) (= (|MultiSet#Card| |s#0@1|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (|MultiSet#Card| |s#0@1|) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 6) (- 0 5)) (< (|MultiSet#Card| |s#0@1|) |$decr$loop#00@1|)))))))))))
