...
(set-info :boogie-vc-id Impl$$AssignSuchThat.__default.BadCompiled0)
...
(assert (not
 ...
 :qid |DefiniteAssignmentdfy.305:9|
 :skolemid |482|
)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (=> |defass#d#0| (and ($IsBox |d#0| Tclass.AssignSuchThat.D) ($IsAllocBox |d#0| Tclass.AssignSuchThat.D $Heap))) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 6) 5))) anon0_correct))))
