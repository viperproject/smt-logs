...
(assert (distinct TReal TagReal alloc Tagclass._System.array? Tagclass._System.array tytagFamily$array)
)
...
(set-info :boogie-vc-id Impl$$CaseInPoint.__default.DifferentTypes)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) false) (or (not (= |a#0| |b#0|)) (not true)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |a#0| (Tclass._System.array TReal)) ($IsAlloc refType |a#0| (Tclass._System.array TReal) $Heap))) (and (and ($Is refType |b#0| (Tclass._System.array TReal)) ($IsAlloc refType |b#0| (Tclass._System.array TReal) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
