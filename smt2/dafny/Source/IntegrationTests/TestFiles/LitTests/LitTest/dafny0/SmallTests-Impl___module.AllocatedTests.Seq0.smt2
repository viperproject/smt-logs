...
(set-info :boogie-vc-id Impl$$_module.AllocatedTests.Seq0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon17_Else_correct  (=> (and (and (and (and (and (and (and (and (not (U_2_bool (Lit boolType (bool_2_U true)))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (or (not (= |k#0| null)) (not true))) (or (not (= |k#0| null)) (not true))) (= |k#0| null)) (= |k#0| null)) (= (ControlFlow 0 24) (- 0 23))) false)))
(let ((anon17_Then_correct  (=> (or (not (= |k#0| null)) (not true)) (and (=> (= (ControlFlow 0 20) (- 0 22)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |U#0@0|)))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (not (and (or (not (= ($Unbox refType (|Seq#Index| |U#0@0| (LitInt 0))) null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap ($Unbox refType (|Seq#Index| |U#0@0| (LitInt 0)))) alloc))))))) (=> (not (and (or (not (= ($Unbox refType (|Seq#Index| |U#0@0| (LitInt 0))) null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap ($Unbox refType (|Seq#Index| |U#0@0| (LitInt 0)))) alloc)))))) (=> (= (ControlFlow 0 20) (- 0 19)) (not (forall (($i Int) ) (!  (=> (and (<= 0 $i) (< $i (|Seq#Length| |U#0@0|))) (and (or (not (= ($Unbox refType (|Seq#Index| |U#0@0| $i)) null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap ($Unbox refType (|Seq#Index| |U#0@0| $i))) alloc))))))
 :qid |SmallTestsdfy.245:33|
 :skolemid |3439|
))))))))))
(let ((anon16_Then_correct  (=> (and (or (not (= |k#0| null)) (not true)) (= (ControlFlow 0 18) (- 0 17))) (forall (($i@@0 Int) ) (!  (=> (and (<= 0 $i@@0) (< $i@@0 (|Seq#Length| |U#0@0|))) (and (or (not (= ($Unbox refType (|Seq#Index| |U#0@0| $i@@0)) null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap ($Unbox refType (|Seq#Index| |U#0@0| $i@@0))) alloc))))))
 :qid |SmallTestsdfy.243:31|
 :skolemid |3441|
)))))
(let ((anon15_Then_correct  (=> (= |k#0| null) (and (=> (= (ControlFlow 0 14) (- 0 16)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |U#0@0|)))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (not (and (or (not (= ($Unbox refType (|Seq#Index| |U#0@0| (LitInt 0))) null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap ($Unbox refType (|Seq#Index| |U#0@0| (LitInt 0)))) alloc))))))) (=> (not (and (or (not (= ($Unbox refType (|Seq#Index| |U#0@0| (LitInt 0))) null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap ($Unbox refType (|Seq#Index| |U#0@0| (LitInt 0)))) alloc)))))) (=> (= (ControlFlow 0 14) (- 0 13)) (not (forall (($i@@1 Int) ) (!  (=> (and (<= 0 $i@@1) (< $i@@1 (|Seq#Length| |U#0@0|))) (and (or (not (= ($Unbox refType (|Seq#Index| |U#0@0| $i@@1)) null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap ($Unbox refType (|Seq#Index| |U#0@0| $i@@1))) alloc))))))
 :qid |SmallTestsdfy.242:33|
 :skolemid |3444|
))))))))))
(let ((anon14_Then_correct  (=> (and (= |k#0| null) (= (ControlFlow 0 12) (- 0 11))) (forall (($i@@2 Int) ) (!  (=> (and (<= 0 $i@@2) (< $i@@2 (|Seq#Length| |U#0@0|))) (and (or (not (= ($Unbox refType (|Seq#Index| |U#0@0| $i@@2)) null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap ($Unbox refType (|Seq#Index| |U#0@0| $i@@2))) alloc))))))
 :qid |SmallTestsdfy.240:31|
 :skolemid |3446|
)))))
(let ((anon13_Then_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (forall (($i@@3 Int) ) (!  (=> (and (<= 0 $i@@3) (< $i@@3 (|Seq#Length| |U#0@0|))) (and (or (not (= ($Unbox refType (|Seq#Index| |U#0@0| $i@@3)) null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap ($Unbox refType (|Seq#Index| |U#0@0| $i@@3))) alloc))))))
 :qid |SmallTestsdfy.239:26|
 :skolemid |3448|
)))))
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 6) (- 0 8)) (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |U#0@0|)))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (not ($IsAllocBox (|Seq#Index| |U#0@0| (LitInt 1)) Tclass._module.Node? $Heap))) (=> (not ($IsAllocBox (|Seq#Index| |U#0@0| (LitInt 1)) Tclass._module.Node? $Heap)) (=> (= (ControlFlow 0 6) (- 0 5)) (not ($IsAllocBox ($Box SeqType |U#0@0|) (TSeq Tclass._module.Node?) $Heap))))))))
(let ((anon11_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) ($IsAllocBox ($Box SeqType |U#0@0|) (TSeq Tclass._module.Node?) $Heap))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) ($IsAllocBox ($Box SeqType |U#0@0|) (TSeq Tclass._module.Node?) $Heap@0))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 Tclass._module.Node?)) (=> (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc)))) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 25) (- 0 26)) true) (=> (= |U#0@0| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box refType |k#0|)) ($Box refType $nw@0))) (and (and (and (and (and (and (and (and (=> (= (ControlFlow 0 25) 2) anon10_Then_correct) (=> (= (ControlFlow 0 25) 4) anon11_Then_correct)) (=> (= (ControlFlow 0 25) 6) anon12_Then_correct)) (=> (= (ControlFlow 0 25) 10) anon13_Then_correct)) (=> (= (ControlFlow 0 25) 12) anon14_Then_correct)) (=> (= (ControlFlow 0 25) 14) anon15_Then_correct)) (=> (= (ControlFlow 0 25) 18) anon16_Then_correct)) (=> (= (ControlFlow 0 25) 20) anon17_Then_correct)) (=> (= (ControlFlow 0 25) 24) anon17_Else_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.AllocatedTests) ($IsAlloc refType this Tclass._module.AllocatedTests $Heap)))) (and (and ($Is refType |k#0| Tclass._module.Node?) ($IsAlloc refType |k#0| Tclass._module.Node? $Heap)) (and (=> |defass#n#0| (and ($Is refType |n#0| Tclass._module.Node) ($IsAlloc refType |n#0| Tclass._module.Node $Heap))) true))) (and (and (and ($Is SeqType |U#0| (TSeq Tclass._module.Node?)) ($IsAlloc SeqType |U#0| (TSeq Tclass._module.Node?) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 27) 25)))) anon0_correct)))
