...
(assert (distinct TBool TagBool alloc Tagclass._System.nat Tagclass.Alt.natinf |##Alt.natinf.N| |##Alt.natinf.Inf| tytagFamily$nat tytagFamily$natinf)
)
...
(set-info :boogie-vc-id CheckWellformed$$Alt.__default.Even)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon10_correct true))
(let ((anon16_Else_correct  (=> (and (not (|Alt.natinf#Equal| |x#0@@14| (Alt.__default.S (Alt.__default.S |y#1@0|)))) (= (ControlFlow 0 6) 2)) anon10_correct)))
(let ((anon16_Then_correct  (=> (and (and (|Alt.natinf#Equal| |x#0@@14| (Alt.__default.S (Alt.__default.S |y#1@0|))) ($IsAlloc DatatypeTypeType |y#1@0| Tclass.Alt.natinf $Heap)) (and (|Alt.__default.Even#canCall| |y#1@0|) (= (ControlFlow 0 5) 2))) anon10_correct)))
(let ((anon15_Then_correct  (=> (and (and (and ($Is DatatypeTypeType |y#1@0| Tclass.Alt.natinf) ($IsAlloc DatatypeTypeType |y#1@0| Tclass.Alt.natinf $Heap)) ($IsAlloc DatatypeTypeType |y#1@0| Tclass.Alt.natinf $Heap)) (and (and (|Alt.__default.S#canCall| |y#1@0|) (= |##x#0@0| (Alt.__default.S |y#1@0|))) (and ($IsAlloc DatatypeTypeType |##x#0@0| Tclass.Alt.natinf $Heap) (|Alt.__default.S#canCall| (Alt.__default.S |y#1@0|))))) (and (=> (= (ControlFlow 0 7) 5) anon16_Then_correct) (=> (= (ControlFlow 0 7) 6) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |y#1@0| Tclass.Alt.natinf) ($IsAlloc DatatypeTypeType |y#1@0| Tclass.Alt.natinf $Heap))) (= (ControlFlow 0 4) 2)) anon10_correct)))
(let ((anon14_Then_correct  (=> (not (and (Alt.natinf.N_q |x#0@@14|) (= (Alt.natinf.n |x#0@@14|) (LitInt 0)))) (and (=> (= (ControlFlow 0 8) 7) anon15_Then_correct) (=> (= (ControlFlow 0 8) 4) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (and (Alt.natinf.N_q |x#0@@14|) (= (Alt.natinf.n |x#0@@14|) (LitInt 0))) (= (ControlFlow 0 3) 2)) anon10_correct)))
(let ((anon13_Else_correct  (=> (not (Alt.natinf.N_q |x#0@@14|)) (and (=> (= (ControlFlow 0 11) 8) anon14_Then_correct) (=> (= (ControlFlow 0 11) 3) anon14_Else_correct)))))
(let ((anon13_Then_correct  (=> (Alt.natinf.N_q |x#0@@14|) (and (=> (= (ControlFlow 0 9) (- 0 10)) (Alt.natinf.N_q |x#0@@14|)) (=> (Alt.natinf.N_q |x#0@@14|) (and (=> (= (ControlFlow 0 9) 8) anon14_Then_correct) (=> (= (ControlFlow 0 9) 3) anon14_Else_correct)))))))
(let ((anon12_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 12) 1) anon12_Then_correct) (=> (= (ControlFlow 0 12) 9) anon13_Then_correct)) (=> (= (ControlFlow 0 12) 11) anon13_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |x#0@@14| Tclass.Alt.natinf)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 13) 12))) anon0_correct)))
