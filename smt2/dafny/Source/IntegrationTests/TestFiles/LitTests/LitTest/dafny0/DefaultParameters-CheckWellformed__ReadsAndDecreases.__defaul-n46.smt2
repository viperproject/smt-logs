...
(declare-fun ReadsAndDecreases.__default.ReadM1 (T@U T@U T@U) Int)
(declare-fun |ReadsAndDecreases.__default.ReadM1#canCall| (T@U T@U T@U) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (|a#0| T@U) (|m#0| T@U) ) (!  (=> (or (|ReadsAndDecreases.__default.ReadM1#canCall| $Heap |a#0| |m#0|) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap) ($Is refType |a#0| (Tclass._System.array TInt))) ($Is refType |m#0| (Tclass._System.array2 TInt))) (= (_System.array.Length |a#0|) (LitInt 0))))) (and (|ReadsAndDecreases.__default.MoreReads#canCall| |a#0| |m#0| (ite (< 0 (_System.array.Length |a#0|)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField (LitInt 0))))) 3) (ite  (and (< 0 (_System.array2.Length0 |m#0|)) (< 0 (_System.array2.Length1 |m#0|))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |m#0|) (MultiIndexField (IndexField (LitInt 0)) (LitInt 0))))) 3)) (= (ReadsAndDecreases.__default.ReadM1 $Heap |a#0| |m#0|) (ReadsAndDecreases.__default.MoreReads |a#0| |m#0| (ite (< 0 (_System.array.Length |a#0|)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField (LitInt 0))))) 3) (ite  (and (< 0 (_System.array2.Length0 |m#0|)) (< 0 (_System.array2.Length1 |m#0|))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |m#0|) (MultiIndexField (IndexField (LitInt 0)) (LitInt 0))))) 3)))))
 :qid |DefaultParametersdfy.344:18|
 :skolemid |5862|
 :pattern ( (ReadsAndDecreases.__default.ReadM1 $Heap |a#0| |m#0|) ($IsGoodHeap $Heap))
))))
...
(set-info :boogie-vc-id CheckWellformed$$ReadsAndDecreases.__default.ReadM1)
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#1| null $Heap@@0 alloc |m#0@@0|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= |a#0@@0| null)) (not true))) (=> (or (not (= |a#0@@0| null)) (not true)) (=> (= (_System.array.Length |a#0@@0|) (LitInt 0)) (and (=> (= (ControlFlow 0 3) 1) anon5_Then_correct) (=> (= (ControlFlow 0 3) 2) anon5_Else_correct))))))))
