...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon7_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (exists ((|$as#x0_0#0_0| T@U) )  (and ($IsBox |$as#x0_0#0_0| _module._default.ISets1$_T0) (U_2_bool (MapType0Select BoxType boolType |S#0| |$as#x0_0#0_0|))))) (=> (exists ((|$as#x0_0#0_0@@0| T@U) )  (and ($IsBox |$as#x0_0#0_0@@0| _module._default.ISets1$_T0) (U_2_bool (MapType0Select BoxType boolType |S#0| |$as#x0_0#0_0@@0|)))) (=> (and (=> true (and ($IsBox |x#0_0@0| _module._default.ISets1$_T0) ($IsAllocBox |x#0_0@0| _module._default.ISets1$_T0 $Heap))) (U_2_bool (MapType0Select BoxType boolType |S#0| |x#0_0@0|))) (and (=> (= (ControlFlow 0 5) (- 0 6)) true) (=> (and (= |s#0@0| (|ISet#Difference| |S#0| (|ISet#UnionOne| |ISet#Empty| |x#0_0@0|))) (= (ControlFlow 0 5) (- 0 4))) false)))))))
