...
(assert (forall ((a T@U) (b T@U) (o@@0 T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|ISet#Difference| a b) o@@0))  (and (U_2_bool (MapType0Select BoxType boolType a o@@0)) (not (U_2_bool (MapType0Select BoxType boolType b o@@0)))))
 :qid |DafnyPreludebpl.858:15|
 :skolemid |2546|
 :pattern ( (MapType0Select BoxType boolType (|ISet#Difference| a b) o@@0))
)))
...
(assert (forall ((a@@0 T@U) (x@@3 T@U) (y T@U) ) (!  (=> (U_2_bool (MapType0Select BoxType boolType a@@0 y)) (U_2_bool (MapType0Select BoxType boolType (|ISet#UnionOne| a@@0 x@@3) y)))
 :qid |DafnyPreludebpl.828:15|
 :skolemid |2536|
 :pattern ( (|ISet#UnionOne| a@@0 x@@3) (MapType0Select BoxType boolType a@@0 y))
)))
(assert (forall ((a@@1 T@U) (x@@4 T@U) (o@@1 T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|ISet#UnionOne| a@@1 x@@4) o@@1))  (or (= o@@1 x@@4) (U_2_bool (MapType0Select BoxType boolType a@@1 o@@1))))
 :qid |DafnyPreludebpl.824:15|
 :skolemid |2534|
 :pattern ( (MapType0Select BoxType boolType (|ISet#UnionOne| a@@1 x@@4) o@@1))
)))
...
(assert (forall ((a@@3 T@U) (b@@1 T@U) (y@@0 T@U) ) (!  (=> (U_2_bool (MapType0Select BoxType boolType b@@1 y@@0)) (not (U_2_bool (MapType0Select BoxType boolType (|ISet#Difference| a@@3 b@@1) y@@0))))
 :qid |DafnyPreludebpl.860:15|
 :skolemid |2547|
 :pattern ( (|ISet#Difference| a@@3 b@@1) (MapType0Select BoxType boolType b@@1 y@@0))
)))
...
(assert (forall ((a@@4 T@U) (x@@5 T@U) ) (! (U_2_bool (MapType0Select BoxType boolType (|ISet#UnionOne| a@@4 x@@5) x@@5))
 :qid |DafnyPreludebpl.826:15|
 :skolemid |2535|
 :pattern ( (|ISet#UnionOne| a@@4 x@@5))
)))
...
(assert (forall ((a@@5 T@U) (b@@2 T@U) ) (! (= (|ISet#Subset| a@@5 b@@2) (forall ((o@@3 T@U) ) (!  (=> (U_2_bool (MapType0Select BoxType boolType a@@5 o@@3)) (U_2_bool (MapType0Select BoxType boolType b@@2 o@@3)))
 :qid |DafnyPreludebpl.865:33|
 :skolemid |2548|
 :pattern ( (MapType0Select BoxType boolType a@@5 o@@3))
 :pattern ( (MapType0Select BoxType boolType b@@2 o@@3))
)))
 :qid |DafnyPreludebpl.864:15|
 :skolemid |2549|
 :pattern ( (|ISet#Subset| a@@5 b@@2))
)))
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(declare-fun _module._default.ISets1$_T0 () T@U)
(declare-fun |S#0| () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.ISets1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon7_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (exists ((|$as#x0_0#0_0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0| _module._default.ISets1$_T0) (U_2_bool (MapType0Select BoxType boolType |S#0| |$as#x0_0#0_0|)))
 :qid |Terminationdfy.723:9|
 :skolemid |3195|
))) (=> (exists ((|$as#x0_0#0_0@@0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0@@0| _module._default.ISets1$_T0) (U_2_bool (MapType0Select BoxType boolType |S#0| |$as#x0_0#0_0@@0|)))
 :qid |Terminationdfy.723:9|
 :skolemid |3195|
)) (=> (and (=> true (and ($IsBox |x#0_0@0| _module._default.ISets1$_T0) ($IsAllocBox |x#0_0@0| _module._default.ISets1$_T0 $Heap))) (U_2_bool (MapType0Select BoxType boolType |S#0| |x#0_0@0|))) (and (=> (= (ControlFlow 0 5) (- 0 6)) true) (=> (and (= |s#0@0| (|ISet#Difference| |S#0| (|ISet#UnionOne| |ISet#Empty| |x#0_0@0|))) (= (ControlFlow 0 5) (- 0 4))) false)))))))
(let ((anon11_Else_correct  (=> (and (not (and ($IsBox |x#0_1@0| _module._default.ISets1$_T0) ($IsAllocBox |x#0_1@0| _module._default.ISets1$_T0 $Heap))) (= (ControlFlow 0 9) 5)) anon7_correct)))
(let ((anon11_Then_correct  (=> (and (and ($IsBox |x#0_1@0| _module._default.ISets1$_T0) ($IsAllocBox |x#0_1@0| _module._default.ISets1$_T0 $Heap)) (= (ControlFlow 0 8) 5)) anon7_correct)))
(let ((anon10_Else_correct  (=> (and (|ISet#Subset| |ISet#Empty| |S#0|) (not (|ISet#Subset| |S#0| |ISet#Empty|))) (and (=> (= (ControlFlow 0 10) 8) anon11_Then_correct) (=> (= (ControlFlow 0 10) 9) anon11_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is (MapType0Type BoxType boolType) |S#0| (TISet _module._default.ISets1$_T0)) ($IsAlloc (MapType0Type BoxType boolType) |S#0| (TISet _module._default.ISets1$_T0) $Heap))) (=> (and (and (and ($Is (MapType0Type BoxType boolType) |s#0| (TISet _module._default.ISets1$_T0)) ($IsAlloc (MapType0Type BoxType boolType) |s#0| (TISet _module._default.ISets1$_T0) $Heap)) true) (and (and (=> |defass#x#0_0| (and ($IsBox |x#0_0| _module._default.ISets1$_T0) ($IsAllocBox |x#0_0| _module._default.ISets1$_T0 $Heap))) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 14) 13)))) anon0_correct))))
