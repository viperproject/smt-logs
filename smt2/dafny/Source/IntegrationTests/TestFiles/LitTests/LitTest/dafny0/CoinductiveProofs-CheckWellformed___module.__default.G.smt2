...
(assert (distinct TInt TagInt alloc Tagclass._module.IList |##_module.IList.INil| |##_module.IList.ICons| tytagFamily$IList)
)
(assert (= (Ctor DatatypeTypeType) 3))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.G$_T0 T@U) (|s#0| T@U) ) (!  (=> (or (|_module.__default.G#canCall| _module._default.G$_T0 |s#0|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |s#0| (Tclass._module.IList _module._default.G$_T0)))) (= (_module.__default.G _module._default.G$_T0 |s#0|) (ite (_module.IList.INil_q |s#0|) 0 (LitInt 0))))
 :qid |unknown.0:0|
 :skolemid |843|
 :pattern ( (_module.__default.G _module._default.G$_T0 |s#0|))
))))
...
(assert (forall ((_module.IList$T T@U) ) (! ($Is DatatypeTypeType |#_module.IList.INil| (Tclass._module.IList _module.IList$T))
 :qid |unknown.0:0|
 :skolemid |967|
 :pattern ( ($Is DatatypeTypeType |#_module.IList.INil| (Tclass._module.IList _module.IList$T)))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.G$_T0@@0 T@U) (|s#0@@0| T@U) ) (!  (=> (or (|_module.__default.G#canCall| _module._default.G$_T0@@0 (Lit DatatypeTypeType |s#0@@0|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |s#0@@0| (Tclass._module.IList _module._default.G$_T0@@0)))) (= (_module.__default.G _module._default.G$_T0@@0 (Lit DatatypeTypeType |s#0@@0|)) (ite (_module.IList.INil_q (Lit DatatypeTypeType |s#0@@0|)) 0 (LitInt 0))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |844|
 :pattern ( (_module.__default.G _module._default.G$_T0@@0 (Lit DatatypeTypeType |s#0@@0|)))
))))
...
(assert (forall ((_module.IList$T@@2 T@U) (d@@4 T@U) ) (!  (=> ($Is DatatypeTypeType d@@4 (Tclass._module.IList _module.IList$T@@2)) (or (_module.IList.INil_q d@@4) (_module.IList.ICons_q d@@4)))
 :qid |unknown.0:0|
 :skolemid |980|
 :pattern ( (_module.IList.ICons_q d@@4) ($Is DatatypeTypeType d@@4 (Tclass._module.IList _module.IList$T@@2)))
 :pattern ( (_module.IList.INil_q d@@4) ($Is DatatypeTypeType d@@4 (Tclass._module.IList _module.IList$T@@2)))
)))
...
(declare-fun _module._default.G$_T0@@1 () T@U)
...
(let ((anon10_Then_correct  (=> (= |s#0@@1| (|#_module.IList.ICons| |_mcc#0#0| |_mcc#1#0|)) (=> (and ($IsBox |_mcc#0#0| _module._default.G$_T0@@1) ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.IList _module._default.G$_T0@@1))) (=> (and (and (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.IList _module._default.G$_T0@@1))) (and (= |b#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|))) (and (and ($IsBox |let#1#0#0| _module._default.G$_T0@@1) (= |a#Z#0@0| |let#1#0#0|)) (and (|$IsA#_module.IList| |s#0@@1|) (= (ControlFlow 0 5) (- 0 4))))) (|$Eq#_module.IList| _module._default.G$_T0@@1 _module._default.G$_T0@@1 ($LS ($LS $LZ)) |s#0@@1| (|#_module.IList.ICons| |a#Z#0@0| |b#Z#0@0|)))))))
(let ((anon9_Else_correct  (=> (or (not (= |s#0@@1| |#_module.IList.INil|)) (not true)) (and (=> (= (ControlFlow 0 7) 5) anon10_Then_correct) (=> (= (ControlFlow 0 7) 6) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> (= |s#0@@1| |#_module.IList.INil|) (=> (and (|$IsA#_module.IList| |s#0@@1|) (= (ControlFlow 0 3) (- 0 2))) (|$Eq#_module.IList| _module._default.G$_T0@@1 _module._default.G$_T0@@1 ($LS ($LS $LZ)) |s#0@@1| |#_module.IList.INil|)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |s#0@@1| (Tclass._module.IList _module._default.G$_T0@@1))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct)))
