...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon2_correct  (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (< |x#0| 20) (<= (LitInt 10) |x#0|))) (=> (or (< |x#0| 20) (<= (LitInt 10) |x#0|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (< |x#0| 10)) (=> (< |x#0| 10) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) |x#0|)) (=> (<= (LitInt 0) |x#0|) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |Snapshots8v1dfy.11:15|
 :skolemid |484|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0))
))) (and ($HeapSucc $Heap $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (= |x#0| (LitInt 7)))))))))))
(let ((anon3_Else_correct  (=> (and (< |x#0| 20) (= (ControlFlow 0 7) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and (<= 20 |x#0|) (= (ControlFlow 0 6) 2)) anon2_correct)))
