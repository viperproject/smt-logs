...
(set-info :boogie-vc-id Impl$$_module.__default.Testing2A)
...
(let ((anon8_LoopHead_correct  (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (and (not false) (and (<= 0 |i#0@1|) (< |i#0@1| 11))) (= |$decr_init$loop#00@0| 10)) (and (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@1|)) (=> |$w$loop#0@0| (<= |i#0@1| (LitInt 10))))) (and (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6)) (= $o@@6 |a#0|)))
 :qid |LoopModifiesdfy.30:4|
 :skolemid |490|
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#4| null $Heap alloc |a#0|)) (=> (and (= |i#0@0| (LitInt 0)) (= |$decr_init$loop#00@0| (- 10 |i#0@0|))) (and (=> (= (ControlFlow 0 18) (- 0 20)) (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@0|))) (=> (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@0|)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (=> |$w$loop#0@0| (<= |i#0@0| (LitInt 10)))) (=> (=> |$w$loop#0@0| (<= |i#0@0| (LitInt 10))) (=> (= (ControlFlow 0 18) 17) anon8_LoopHead_correct)))))))))
