...
(assert (forall ((TwoStateAt._default.SP$Y T@U) ($prevHeap T@U) ($h0 T@U) ($h1 T@U) (|c#0| T@U) (|y#0| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|TwoStateAt.__default.SP#canCall| TwoStateAt._default.SP$Y $prevHeap $h0 |c#0| |y#0|) (and ($Is refType |c#0| Tclass.TwoStateAt.Cell) ($IsBox |y#0| TwoStateAt._default.SP$Y)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o T@U) ($f T@U) ) (!  (=> (and (or (not (= $o null)) (not true)) (= $o |c#0|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o) $f)))
 :qid |unknown.0:0|
 :skolemid |646|
)) (= (TwoStateAt.__default.SP TwoStateAt._default.SP$Y $prevHeap $h0 |c#0| |y#0|) (TwoStateAt.__default.SP TwoStateAt._default.SP$Y $prevHeap $h1 |c#0| |y#0|))))
 :qid |unknown.0:0|
 :skolemid |648|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (TwoStateAt.__default.SP TwoStateAt._default.SP$Y $prevHeap $h1 |c#0| |y#0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((TwoStateAt._default.SP$Y@@0 T@U) ($prevHeap@@0 T@U) ($Heap T@U) (|c#0@@1| T@U) (|y#0@@0| T@U) ) (!  (=> (or (|TwoStateAt.__default.SP#canCall| TwoStateAt._default.SP$Y@@0 $prevHeap@@0 $Heap |c#0@@1| |y#0@@0|) (and (< 1 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@0) ($IsGoodHeap $Heap)) ($HeapSucc $prevHeap@@0 $Heap)) ($Is refType |c#0@@1| Tclass.TwoStateAt.Cell)) ($IsBox |y#0@@0| TwoStateAt._default.SP$Y@@0)))) (= (TwoStateAt.__default.SP TwoStateAt._default.SP$Y@@0 $prevHeap@@0 $Heap |c#0@@1| |y#0@@0|) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@0 |c#0@@1|) TwoStateAt.Cell.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0@@1|) TwoStateAt.Cell.data))))))
 :qid |unknown.0:0|
 :skolemid |651|
 :pattern ( (TwoStateAt.__default.SP TwoStateAt._default.SP$Y@@0 $prevHeap@@0 $Heap |c#0@@1| |y#0@@0|) ($IsGoodHeap $Heap))
))))
...
(assert (forall ((bx@@0 T@U) ) (!  (=> ($IsBox bx@@0 Tclass.TwoStateAt.Cell) (and (= ($Box refType ($Unbox refType bx@@0)) bx@@0) ($Is refType ($Unbox refType bx@@0) Tclass.TwoStateAt.Cell)))
 :qid |unknown.0:0|
 :skolemid |647|
 :pattern ( ($IsBox bx@@0 Tclass.TwoStateAt.Cell))
)))
...
(declare-fun TwoStateAt._default.SP$Y@@1 () T@U)
(declare-fun current$Heap () T@U)
(declare-fun |y#0@@1| () T@U)
(declare-fun previous$Heap () T@U)
(set-info :boogie-vc-id CheckWellformed$$TwoStateAt.__default.SP)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (not (= |c#0@@3| null)) (not true))) (=> (or (not (= |c#0@@3| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 5)) ($IsAlloc refType |c#0@@3| Tclass.TwoStateAt.Cell $Heap@@0)) (=> ($IsAlloc refType |c#0@@3| Tclass.TwoStateAt.Cell $Heap@@0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= |c#0@@3| null)) (not true))) (=> (or (not (= |c#0@@3| null)) (not true)) (=> (and (and (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |c#0@@3| TwoStateAt.Cell.data))) (= (TwoStateAt.__default.SP TwoStateAt._default.SP$Y@@1 $Heap@@0 current$Heap |c#0@@3| |y#0@@1|) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |c#0@@3|) TwoStateAt.Cell.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |c#0@@3|) TwoStateAt.Cell.data)))))) (and ($Is intType (int_2_U (TwoStateAt.__default.SP TwoStateAt._default.SP$Y@@1 $Heap@@0 current$Heap |c#0@@3| |y#0@@1|)) TInt) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|)))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null current$Heap alloc |c#0@@3|)) (and (=> (= (ControlFlow 0 7) 1) anon5_Then_correct) (=> (= (ControlFlow 0 7) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and ($Is refType |c#0@@3| Tclass.TwoStateAt.Cell) ($IsAlloc refType |c#0@@3| Tclass.TwoStateAt.Cell previous$Heap))) (=> (and (and (and ($IsBox |y#0@@1| TwoStateAt._default.SP$Y@@1) ($IsAllocBox |y#0@@1| TwoStateAt._default.SP$Y@@1 previous$Heap)) (= 1 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@0) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 8) 7))) anon0_correct))))
