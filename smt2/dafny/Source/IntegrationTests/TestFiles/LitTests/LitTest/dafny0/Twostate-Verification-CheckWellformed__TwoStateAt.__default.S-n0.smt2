...
(assert (forall ((TwoStateAt._default.SP$Y T@U) ($prevHeap T@U) ($h0 T@U) ($h1 T@U) (|c#0| T@U) (|y#0| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|TwoStateAt.__default.SP#canCall| TwoStateAt._default.SP$Y $prevHeap $h0 |c#0| |y#0|) (and ($Is refType |c#0| Tclass.TwoStateAt.Cell) ($IsBox |y#0| TwoStateAt._default.SP$Y)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o T@U) ($f T@U) )  (=> (and (or (not (= $o null)) (not true)) (= $o |c#0|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o) $f)))) (= (TwoStateAt.__default.SP TwoStateAt._default.SP$Y $prevHeap $h0 |c#0| |y#0|) (TwoStateAt.__default.SP TwoStateAt._default.SP$Y $prevHeap $h1 |c#0| |y#0|))))
