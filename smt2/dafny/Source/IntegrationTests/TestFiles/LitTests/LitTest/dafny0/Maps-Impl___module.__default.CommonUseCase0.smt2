...
(set-info :boogie-vc-id Impl$$_module.__default.CommonUseCase0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon7_correct  (and (=> (= (ControlFlow 0 5) (- 0 10)) (or (and ($Is refType null Tclass._module.MyClass) (|Set#IsMember| (|Map#Domain| |m#1@0|) ($Box refType null))) (exists ((|$as#k0_0#0_0| T@U) ) (!  (and ($Is refType |$as#k0_0#0_0| Tclass._module.MyClass) (|Set#IsMember| (|Map#Domain| |m#1@0|) ($Box refType |$as#k0_0#0_0|)))
 :qid |Mapsdfy.462:9|
 :skolemid |808|
)))) (=> (or (and ($Is refType null Tclass._module.MyClass) (|Set#IsMember| (|Map#Domain| |m#1@0|) ($Box refType null))) (exists ((|$as#k0_0#0_0@@0| T@U) ) (!  (and ($Is refType |$as#k0_0#0_0@@0| Tclass._module.MyClass) (|Set#IsMember| (|Map#Domain| |m#1@0|) ($Box refType |$as#k0_0#0_0@@0|)))
 :qid |Mapsdfy.462:9|
 :skolemid |808|
))) (=> (and (=> true (and ($Is refType |k#0_0@1| Tclass._module.MyClass) ($IsAlloc refType |k#0_0@1| Tclass._module.MyClass $Heap))) (|Set#IsMember| (|Map#Domain| |m#1@0|) ($Box refType |k#0_0@1|))) (and (=> (= (ControlFlow 0 5) (- 0 9)) true) (and (=> (= (ControlFlow 0 5) (- 0 8)) (|Set#IsMember| (|Map#Domain| |m#1@0|) ($Box refType |k#0_0@1|))) (=> (|Set#IsMember| (|Map#Domain| |m#1@0|) ($Box refType |k#0_0@1|)) (=> (= |v#0_0@1| (U_2_bv3 ($Unbox bv3Type (MapType0Select BoxType BoxType (|Map#Elements| |m#1@0|) ($Box refType |k#0_0@1|))))) (and (=> (= (ControlFlow 0 5) (- 0 7)) ($Is intType (int_2_U (+ |s#0@1| (nat_from_bv3 |v#0_0@1|))) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ |s#0@1| (nat_from_bv3 |v#0_0@1|))) Tclass._System.nat) (=> (= |s#0@2| (+ |s#0@1| (nat_from_bv3 |v#0_0@1|))) (and (=> (= (ControlFlow 0 5) (- 0 6)) true) (=> (and (= |m#1@1| (|Map#Subtract| |m#1@0| (|Set#UnionOne| |Set#Empty| ($Box refType |k#0_0@1|)))) (= (ControlFlow 0 5) (- 0 4))) (and (|Set#Subset| (|Map#Domain| |m#1@1|) |$decr$loop#00@1|) (not (|Set#Subset| |$decr$loop#00@1| (|Map#Domain| |m#1@1|))))))))))))))))))
(let ((anon11_Else_correct  (=> (and (not (and ($Is refType |k#0_1@1| Tclass._module.MyClass) ($IsAlloc refType |k#0_1@1| Tclass._module.MyClass $Heap))) (= (ControlFlow 0 12) 5)) anon7_correct)))
(let ((anon11_Then_correct  (=> (and (and ($Is refType |k#0_1@1| Tclass._module.MyClass) ($IsAlloc refType |k#0_1@1| Tclass._module.MyClass $Heap)) (= (ControlFlow 0 11) 5)) anon7_correct)))
(let ((anon10_Else_correct  (=> (and (not (|Map#Equal| |m#1@0| |Map#Empty|)) (= |$decr$loop#00@1| (|Map#Domain| |m#1@0|))) (and (=> (= (ControlFlow 0 13) 11) anon11_Then_correct) (=> (= (ControlFlow 0 13) 12) anon11_Else_correct)))))
...
)) (|Set#Subset| (|Map#Domain| |m#1@0|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 16) 1) anon8_LoopDone_correct) (=> (= (ControlFlow 0 16) 15) anon8_LoopBody_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 17) (- 0 18)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (= |s#0@0| (LitInt 0)) (=> (and (= |$decr_init$loop#00@0| (|Map#Domain| |m#0|)) (= (ControlFlow 0 17) 16)) anon8_LoopHead_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is MapType |m#0| (TMap Tclass._module.MyClass (TBitvector 3))) ($IsAlloc MapType |m#0| (TMap Tclass._module.MyClass (TBitvector 3)) $Heap)) (<= (LitInt 0) |s#0|)) (=> (and (and (and ($Is MapType |m#1| (TMap Tclass._module.MyClass (TBitvector 3))) ($IsAlloc MapType |m#1| (TMap Tclass._module.MyClass (TBitvector 3)) $Heap)) true) (and (and (=> |defass#k#0_0| (and ($Is refType |k#0_0| Tclass._module.MyClass) ($IsAlloc refType |k#0_0| Tclass._module.MyClass $Heap))) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 19) 17)))) anon0_correct)))))
