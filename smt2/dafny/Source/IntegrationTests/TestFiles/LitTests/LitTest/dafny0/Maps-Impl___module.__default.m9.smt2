...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |$rhs#0@0| (Lit MapType |Map#Empty|)) (= |$rhs#1@0| (Lit MapType |Map#Empty|))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Set#Disjoint| (|Map#Domain| |$rhs#0@0|) (|Map#Domain| |$rhs#1@0|))) (=> (|Set#Disjoint| (|Map#Domain| |$rhs#0@0|) (|Map#Domain| |$rhs#1@0|)) (=> (= |b#0@0| (Lit MapType (|Map#Build| (|Map#Build| (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 4))) ($Box intType (int_2_U (LitInt 2)))) ($Box intType (int_2_U (LitInt 5))) ($Box intType (int_2_U (LitInt (- 0 6))))) ($Box intType (int_2_U (LitInt 6))) ($Box intType (int_2_U (LitInt 7)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Disjoint| (|Map#Domain| |$rhs#0@0|) (|Map#Domain| |b#0@0|))) (=> (|Set#Disjoint| (|Map#Domain| |$rhs#0@0|) (|Map#Domain| |b#0@0|)) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#Disjoint| (|Map#Domain| |b#0@0|) (|Map#Domain| (Lit MapType (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 6))) ($Box intType (int_2_U (LitInt 3)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is MapType |a#0| (TMap TInt TInt)) ($IsAlloc MapType |a#0| (TMap TInt TInt) $Heap)) true) (=> (and (and (and ($Is MapType |b#0| (TMap TInt TInt)) ($IsAlloc MapType |b#0| (TMap TInt TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct)))))
