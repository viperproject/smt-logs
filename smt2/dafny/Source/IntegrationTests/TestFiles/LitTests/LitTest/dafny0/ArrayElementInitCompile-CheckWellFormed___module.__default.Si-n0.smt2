...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.SingleValued)
...
(assert (not
 ...
 :qid |ArrayElementInitCompiledfy.28:8|
 :skolemid |569|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4))
)) ($HeapSucc $Heap $Heap@0))) (and (and ($Is refType |a#0@0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0@0| (Tclass._System.array TInt) $Heap@0)) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= |a#0@0| null)) (not true))))))
