...
(declare-fun _module.SeqOp.T5 (T@U Int) T@U)
(declare-fun |_module.SeqOp.T5#canCall| (T@U Int) Bool)
(declare-fun |lambda#211| (Int T@U T@U) T@U)
...
(declare-fun |lambda#210| (T@U) T@U)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) (|n#0| Int) ) (!  (=> (or (|_module.SeqOp.T5#canCall| this |n#0|) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.SeqOp) ($IsAlloc refType this Tclass._module.SeqOp $Heap)))) (<= (LitInt 0) |n#0|)) (<= |n#0| (LitInt 20))))) (= (_module.SeqOp.T5 this |n#0|) (|Seq#Create| TReal $Heap |n#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#53| 20 2.5 this _module.SeqOp.x) (|lambda#15| TInt) (|lambda#211| 20 |Set#Empty| (|Set#UnionOne| |Set#Empty| ($Box refType this))))) ($LS $LZ))))))
 :qid |ComprehensionsNewSyntaxdfy.155:12|
 :skolemid |665|
 :pattern ( (_module.SeqOp.T5 this |n#0|) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@0 T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.SeqOp.T5#canCall| this@@0 |n#0@@0|) (and (< 0 $FunctionContextHeight) (and (and (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass._module.SeqOp)) (<= (LitInt 0) |n#0@@0|)) (<= |n#0@@0| (LitInt 20))))) ($Is SeqType (_module.SeqOp.T5 this@@0 |n#0@@0|) (TSeq TReal)))
 :qid |ComprehensionsNewSyntaxdfy.155:12|
 :skolemid |663|
 :pattern ( (_module.SeqOp.T5 this@@0 |n#0@@0|))
))))
...
(assert (forall ((|l#0@@2| T@U) (|$l#0#o#0| T@U) ) (! (= (U_2_bool (MapType1Select refType boolType (|lambda#210| |l#0@@2|) |$l#0#o#0|)) (|Set#IsMember| |l#0@@2| ($Box refType |$l#0#o#0|)))
 :qid |ComprehensionsNewSyntaxdfy.158:20|
 :skolemid |781|
 :pattern ( (MapType1Select refType boolType (|lambda#210| |l#0@@2|) |$l#0#o#0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@1 T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.SeqOp.T5#canCall| (Lit refType this@@1) (LitInt |n#0@@1|)) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.SeqOp) ($IsAlloc refType this@@1 Tclass._module.SeqOp $Heap@@0)))) (<= (LitInt 0) |n#0@@1|)) (<= (LitInt |n#0@@1|) (LitInt 20))))) (= (_module.SeqOp.T5 (Lit refType this@@1) (LitInt |n#0@@1|)) (|Seq#Create| TReal $Heap@@0 (LitInt |n#0@@1|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#53| 20 2.5 (Lit refType this@@1) _module.SeqOp.x) (|lambda#15| TInt) (|lambda#211| 20 |Set#Empty| (|Set#UnionOne| |Set#Empty| ($Box refType (Lit refType this@@1)))))) ($LS $LZ))))))
 :qid |ComprehensionsNewSyntaxdfy.155:12|
 :weight 3
 :skolemid |667|
 :pattern ( (_module.SeqOp.T5 (Lit refType this@@1) (LitInt |n#0@@1|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@2 T@U) (|n#0@@2| Int) ) (!  (=> (or (|_module.SeqOp.T5#canCall| this@@2 (LitInt |n#0@@2|)) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.SeqOp) ($IsAlloc refType this@@2 Tclass._module.SeqOp $Heap@@1)))) (<= (LitInt 0) |n#0@@2|)) (<= (LitInt |n#0@@2|) (LitInt 20))))) (= (_module.SeqOp.T5 this@@2 (LitInt |n#0@@2|)) (|Seq#Create| TReal $Heap@@1 (LitInt |n#0@@2|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#53| 20 2.5 this@@2 _module.SeqOp.x) (|lambda#15| TInt) (|lambda#211| 20 |Set#Empty| (|Set#UnionOne| |Set#Empty| ($Box refType this@@2))))) ($LS $LZ))))))
 :qid |ComprehensionsNewSyntaxdfy.155:12|
 :weight 3
 :skolemid |666|
 :pattern ( (_module.SeqOp.T5 this@@2 (LitInt |n#0@@2|)) ($IsGoodHeap $Heap@@1))
))))
...
(assert (forall ((|l#0@@4| T@U) (|l#1@@1| T@U) (|l#2@@1| T@U) (|l#3@@1| T@U) ($o@@6 T@U) ($f@@0 T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#48| |l#0@@4| |l#1@@1| |l#2@@1| |l#3@@1|) $o@@6 $f@@0))  (=> (and (or (not (= $o@@6 |l#0@@4|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@1| $o@@6) |l#2@@1|)))) (|Set#IsMember| |l#3@@1| ($Box refType $o@@6))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |777|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#48| |l#0@@4| |l#1@@1| |l#2@@1| |l#3@@1|) $o@@6 $f@@0))
)))
...
(assert (forall ((|l#0@@5| Int) (|l#1@@2| T@U) (|l#2@@2| T@U) (|$l#0#heap#0@@0| T@U) (|$l#0#i#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#211| |l#0@@5| |l#1@@2| |l#2@@2|) |$l#0#heap#0@@0| |$l#0#i#0@@0|) (SetRef_to_SetBox (|lambda#210| (ite (< (U_2_int ($Unbox intType |$l#0#i#0@@0|)) |l#0@@5|) |l#1@@2| |l#2@@2|))))
 :qid |nofile.1:66|
 :skolemid |782|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#211| |l#0@@5| |l#1@@2| |l#2@@2|) |$l#0#heap#0@@0| |$l#0#i#0@@0|))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.SeqOp.T5)
...
(let ((anon18_Else_correct  (=> (<= 20 |i#0@0|) (and (=> (= (ControlFlow 0 8) (- 0 9)) (U_2_bool (MapType0Select refType FieldType boolType |$_Frame#l0@0| this@@3 _module.SeqOp.x))) (=> (U_2_bool (MapType0Select refType FieldType boolType |$_Frame#l0@0| this@@3 _module.SeqOp.x)) (=> (= |lambdaResult#0| (U_2_real ($Unbox realType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@2 this@@3) _module.SeqOp.x)))) (=> (and ($Is realType (real_2_U |lambdaResult#0|) TReal) (= (ControlFlow 0 8) 6)) anon11_correct)))))))
(let ((anon18_Then_correct  (=> (and (and (< |i#0@0| 20) (= |lambdaResult#0| (LitReal 2.5))) (and ($Is realType (real_2_U |lambdaResult#0|) TReal) (= (ControlFlow 0 7) 6))) anon11_correct)))
(let ((anon17_Else_correct  (=> (<= 20 |i#0@0|) (and (=> (= (ControlFlow 0 11) 7) anon18_Then_correct) (=> (= (ControlFlow 0 11) 8) anon18_Else_correct)))))
(let ((anon17_Then_correct  (=> (< |i#0@0| 20) (and (=> (= (ControlFlow 0 10) 7) anon18_Then_correct) (=> (= (ControlFlow 0 10) 8) anon18_Else_correct)))))
(let ((anon16_Then_correct  (=> (= |$_Frame#l0@0| (|lambda#48| null |$lambdaHeap#0@0| alloc (ite (< |i#0@0| 20) |Set#Empty| (|Set#UnionOne| |Set#Empty| ($Box refType this@@3))))) (and (=> (= (ControlFlow 0 12) 10) anon17_Then_correct) (=> (= (ControlFlow 0 12) 11) anon17_Else_correct)))))
(let ((anon16_Else_correct true))
(let ((anon15_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@2 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@2 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 13) 12) anon16_Then_correct) (=> (= (ControlFlow 0 13) 5) anon16_Else_correct)))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((|seqinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| |n#0@@3|)) (Requires1 TInt TReal $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#53| 20 2.5 this@@3 _module.SeqOp.x) (|lambda#15| TInt) (|lambda#211| 20 |Set#Empty| (|Set#UnionOne| |Set#Empty| ($Box refType this@@3))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0|))))
 :qid |ComprehensionsNewSyntaxdfy.158:5|
 :skolemid |668|
 ...
 :qid |ComprehensionsNewSyntaxdfy.158:5|
 :skolemid |670|
))) (= (_module.SeqOp.T5 this@@3 |n#0@@3|) (|Seq#Create| TReal $Heap@@2 |n#0@@3| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#53| 20 2.5 this@@3 _module.SeqOp.x) (|lambda#15| TInt) (|lambda#211| 20 |Set#Empty| (|Set#UnionOne| |Set#Empty| ($Box refType this@@3))))) ($LS $LZ)))))) (and ($Is SeqType (_module.SeqOp.T5 this@@3 |n#0@@3|) (TSeq TReal)) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|))))
(let ((anon14_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= 0 |n#0@@3|)) (=> (<= 0 |n#0@@3|) (and (=> (= (ControlFlow 0 14) 13) anon15_Then_correct) (=> (= (ControlFlow 0 14) 3) anon15_Else_correct))))))
(let ((anon14_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (<= |n#0@@3| (LitInt 20))) (and (=> (= (ControlFlow 0 16) 1) anon14_Then_correct) (=> (= (ControlFlow 0 16) 14) anon14_Else_correct)))))
