...
(assert (forall ((TwoStateAt.DT$X@@3 T@U) (TwoStateAt.DT.F$Y@@2 T@U) ($prevHeap@@2 T@U) ($h0 T@U) ($h1 T@U) (this T@U) (|x#0| T@U) (|y#0| T@U) (|c#0@@1| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) ($Is DatatypeTypeType this (Tclass.TwoStateAt.DT TwoStateAt.DT$X@@3))) (or (|TwoStateAt.DT.F#canCall| TwoStateAt.DT$X@@3 TwoStateAt.DT.F$Y@@2 $prevHeap@@2 $h0 this |x#0| |y#0| |c#0@@1|) (and (and ($IsBox |x#0| TwoStateAt.DT$X@@3) ($IsBox |y#0| TwoStateAt.DT.F$Y@@2)) ($Is refType |c#0@@1| Tclass.TwoStateAt.Cell)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@3 T@U) ($f@@0 T@U) )  (=> (and (or (not (= $o@@3 null)) (not true)) (= $o@@3 |c#0@@1|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@3) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@3) $f@@0)))) (= (TwoStateAt.DT.F TwoStateAt.DT$X@@3 TwoStateAt.DT.F$Y@@2 $prevHeap@@2 $h0 this |x#0| |y#0| |c#0@@1|) (TwoStateAt.DT.F TwoStateAt.DT$X@@3 TwoStateAt.DT.F$Y@@2 $prevHeap@@2 $h1 this |x#0| |y#0| |c#0@@1|))))
