...
(set-info :boogie-vc-id Impl$$TerminationRefinement1.__default.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (<= 0 (LitInt 4)) (= (LitInt 4) (LitInt 4)))) (=> (or (<= 0 (LitInt 4)) (= (LitInt 4) (LitInt 4))) (=> (= (ControlFlow 0 2) (- 0 1)) (< (LitInt 4) (LitInt 4))))))))
