...
(set-info :boogie-vc-id CheckWellFormed$$OneModule.C.NoBody)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#3| null $Heap@@3 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@5) OneModule.C.Repr)))) ($IsAllocBox ($Box refType this@@5) Tclass.OneModule.C? $Heap@@3)) (and (|OneModule.C.Valid#canCall| $Heap@@3 this@@5) (OneModule.C.Valid $Heap@@3 this@@5))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@22 T@U) ) (!  (=> (and (or (not (= $o@@22 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@22) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@22) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@22)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@5) OneModule.C.Repr)) ($Box refType $o@@22))))
 :qid |AutoContractsdfy.53:12|
 :skolemid |546|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@22))
)) ($HeapSucc $Heap@@3 $Heap@0))) (and (and ($IsAllocBox ($Box refType this@@5) Tclass.OneModule.C? $Heap@0) (|OneModule.C.Valid#canCall| $Heap@0 this@@5)) (and (OneModule.C.Valid $Heap@0 this@@5) (= (ControlFlow 0 2) (- 0 1))))) ($IsAlloc refType this@@5 Tclass.OneModule.C $Heap@@3)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and (or (not (= this@@5 null)) (not true)) (and ($Is refType this@@5 Tclass.OneModule.C) ($IsAlloc refType this@@5 Tclass.OneModule.C $Heap@@3))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
