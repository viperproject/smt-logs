...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.wrap__loop__3)
...
(let ((anon8_Then_correct  (=> (and (and (|Seq#Equal| |xs#0@@8| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.wrap.X|))) ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.wrap.X|)))) (= |##xs#0@0| (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.wrap.WS| (Lit SeqType (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.wrap.X|))) ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.wrap.X|))))))))))) (and ($IsAlloc SeqType |##xs#0@0| (TSeq Tclass._module.wrap) $Heap) (= (ControlFlow 0 3) (- 0 2)))) (< (|Seq#Rank| |##xs#0@0|) (|Seq#Rank| |xs#0@@8|)))))
