...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let (($generated@@102  (=> (= (ControlFlow 0 3) (- 0 2)) ($generated@@7 ($generated@@19 $generated@@3 ($generated@@6  (or (not (= ($generated@@28 68) ($generated@@28 68))) (not true))))))))
