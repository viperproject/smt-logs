...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@0 T@U) ) (!  (=> (or (|_module.FailureCompatible.Extract#canCall| (Lit BoxType this@@0)) (and (< 2 $FunctionContextHeight) (and ($IsBox this@@0 Tclass._module.FailureCompatible) (not (U_2_bool (Lit boolType (bool_2_U (_module.FailureCompatible.IsFailure (Lit BoxType this@@0))))))))) (= (_module.FailureCompatible.Extract (Lit BoxType this@@0)) (/ 100.0 (q@Real (_module.FailureCompatible.c (Lit BoxType this@@0))))))
 :qid |OpaqueTypeWithMembersdfy.119:12|
 :weight 3
 :skolemid |696|
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@2 T@U) ) (!  (=> (or (|_module.FailureCompatible.Extract#canCall| this@@2) (and (< 2 $FunctionContextHeight) (and ($IsBox this@@2 Tclass._module.FailureCompatible) (not (_module.FailureCompatible.IsFailure this@@2))))) (= (_module.FailureCompatible.Extract this@@2) (/ 100.0 (q@Real (_module.FailureCompatible.c this@@2)))))
 :qid |OpaqueTypeWithMembersdfy.119:12|
 :skolemid |695|
 :pattern ( (_module.FailureCompatible.Extract this@@2))
))))
...
(assert (forall ((h@@2 T@U) (v@@3 T@U) ) (! ($IsAlloc realType v@@3 TReal h@@2)
 :qid |DafnyPreludebpl.290:14|
 :skolemid |62|
 :pattern ( ($IsAlloc realType v@@3 TReal h@@2))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.FailureCompatible.Extract)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (or (not (= (q@Real (_module.FailureCompatible.c this@@3)) 0.0)) (not true)))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) ($IsAllocBox this@@3 Tclass._module.FailureCompatible $Heap)) (and (|_module.FailureCompatible.IsFailure#canCall| this@@3) (not (_module.FailureCompatible.IsFailure this@@3)))) (and (=> (= (ControlFlow 0 4) 1) anon5_Then_correct) (=> (= (ControlFlow 0 4) 3) anon5_Else_correct)))))
