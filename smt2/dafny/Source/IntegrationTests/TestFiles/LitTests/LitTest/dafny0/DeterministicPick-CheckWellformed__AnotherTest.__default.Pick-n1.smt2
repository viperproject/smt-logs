...
(declare-fun AnotherTest.__default.PickFromSingleton (T@U T@U) T@U)
(declare-fun |AnotherTest.__default.PickFromSingleton#canCall| (T@U T@U) Bool)
...
(declare-fun AnotherTest._default.PickFromSingleton$U@@4 () T@U)
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (=> (and (and ($IsBox |y#3@0| AnotherTest._default.PickFromSingleton$U@@4) ($IsAllocBox |y#3@0| AnotherTest._default.PickFromSingleton$U@@4 $Heap@@2)) (and (|Set#IsMember| |s#0@@3| |y#3@0|) (|Set#Equal| |s#0@@3| (|Set#UnionOne| |Set#Empty| |y#3@0|)))) (and (and (=> (= (ControlFlow 0 7) 1) anon7_Then_correct) (=> (= (ControlFlow 0 7) 5) anon8_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon8_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) ($Is SetType |s#0@@3| (TSet AnotherTest._default.PickFromSingleton$U@@4))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct)))
