...
(set-info :boogie-vc-id Impl$$_module.__default.Break4)
...
(let ((anon16_Then_correct  (=> (= |i#0@0| |n#0|) (and (=> (= (ControlFlow 0 8) (- 0 9)) (= |n#0| (LitInt 0))) (=> (= |n#0| (LitInt 0)) (=> (= (ControlFlow 0 8) 6) after_0_correct))))))
