...
(set-info :boogie-vc-id Impl$$_module.__default.M_k_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (Lit boolType (bool_2_U true))))))
(let ((anon3_Else_correct  (=> (<= (|ORD#Offset| |_k#0|) 0) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (forall ((|_k'#0| T@U) (|x'#2| Int) ) (!  (=> (|ORD#Less| |_k'#0| |_k#0|) (U_2_bool (Lit boolType (bool_2_U true))))
 :qid |Simpledfy.62:16|
 :skolemid |1614|
)) (= (ControlFlow 0 4) 2))) GeneratedUnifiedExit_correct))))
(let ((anon3_Then_correct  (=> (and (< 0 (|ORD#Offset| |_k#0|)) (= (ControlFlow 0 3) 2)) GeneratedUnifiedExit_correct)))
