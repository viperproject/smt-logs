...
(let ((anon3_Else_correct  (=> (<= (|ORD#Offset| |_k#0|) 0) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (forall ((|_k'#0| T@U) (|x'#2| Int) )  (=> (|ORD#Less| |_k'#0| |_k#0|) (U_2_bool (Lit boolType (bool_2_U true))))) (= (ControlFlow 0 4) 2))) GeneratedUnifiedExit_correct))))
