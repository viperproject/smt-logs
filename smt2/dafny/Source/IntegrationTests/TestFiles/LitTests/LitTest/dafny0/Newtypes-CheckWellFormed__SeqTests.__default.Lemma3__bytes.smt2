...
(set-info :boogie-vc-id CheckWellFormed$$SeqTests.__default.Lemma3__bytes)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |data#0| (TSeq Tclass.SeqTests.byte)) ($IsAlloc SeqType |data#0| (TSeq Tclass.SeqTests.byte) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 7) 2))) anon0_correct))))
