...
procedure {:verboseName "ITER_A.RecursiveIterator._ctor (well-formedness)"} CheckWellFormed$$ITER__A.RecursiveIterator.__ctor(n#0: int where LitInt(0) <= n#0, 
    r#0: ref
...
procedure {:verboseName "ITER_A.RecursiveIterator._ctor (call)"} Call$$ITER__A.RecursiveIterator.__ctor(n#0: int where LitInt(0) <= n#0, 
    r#0: ref
       where $Is(r#0, Tclass.ITER__A.RecIterCaller?())
         && $IsAlloc(r#0, Tclass.ITER__A.RecIterCaller?(), $Heap), 
    good#0: bool)
  ...
  requires {:id "id10"} r#0 != null;
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id11"} ITER__A.RecursiveIterator.n(this) == n#0;
  free ensures true;
  ensures {:id "id12"} ITER__A.RecursiveIterator.r(this) == r#0;
  free ensures true;
  ensures {:id "id13"} ITER__A.RecursiveIterator.good(this) == good#0;
  free ensures ITER__A.RecursiveIterator.Valid#canCall($Heap, this);
  ensures {:id "id14"} ITER__A.RecursiveIterator.Valid($Heap, this);
  free ensures true;
  ensures {:id "id15"} Set#Equal(ITER__A.RecursiveIterator.__reads(this), Set#Empty(): Set);
  free ensures true;
  ensures {:id "id16"} Set#Equal(ITER__A.RecursiveIterator.__modifies(this), Set#Empty(): Set);
  free ensures true;
  ensures {:id "id17"} Set#Equal($Unbox(read($Heap, this, ITER__A.RecursiveIterator.__new)): Set, 
    Set#Empty(): Set);
  free ensures true;
  ensures {:id "id18"} ITER__A.RecursiveIterator.__decreases0(this) == n#0 + 2;
  free ensures true;
  ensures {:id "id19"} ITER__A.RecursiveIterator.__decreases1(this) == LitInt(0);
...
procedure {:verboseName "ITER_A.RecursiveIterator.Valid (well-formedness)"} CheckWellformed$$ITER__A.RecursiveIterator.Valid(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__A.RecursiveIterator())
         && $IsAlloc(this, Tclass.ITER__A.RecursiveIterator(), $Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ITER_A.RecursiveIterator.Valid (well-formedness)"} CheckWellformed$$ITER__A.RecursiveIterator.Valid(this: ref)
{
  ...
  var b$reqreads#0: bool;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool
         ==> $o == this
           || Set#IsMember(ITER__A.RecursiveIterator.__reads(this), $Box($o))
           || Set#IsMember($Unbox(read($Heap, this, ITER__A.RecursiveIterator.__new)): Set, $Box($o)));
    // Check well-formedness of preconditions, and then assume them
    // Check well-formedness of the reads clause
    b$reqreads#0 := $_ReadsFrame[this, ITER__A.RecursiveIterator.__new];
...
procedure {:verboseName "ITER_A.RecursiveIterator.MoveNext (call)"} Call$$ITER__A.RecursiveIterator.MoveNext(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__A.RecursiveIterator())
         && $IsAlloc(this, Tclass.ITER__A.RecursiveIterator(), $Heap))
   returns (more#0: bool);
  // user-defined preconditions
  requires {:id "id21"} ITER__A.RecursiveIterator.Valid($Heap, this);
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id22"} (forall $o: ref :: 
      { $o != null } 
      Set#IsMember($Unbox(read($Heap, this, ITER__A.RecursiveIterator.__new)): Set, $Box($o))
           && !Set#IsMember($Unbox(read(old($Heap), this, ITER__A.RecursiveIterator.__new)): Set, $Box($o))
         ==> $o != null)
     && (forall $o: ref :: 
      ...
      Set#IsMember($Unbox(read($Heap, this, ITER__A.RecursiveIterator.__new)): Set, $Box($o))
         ...
         ==> !$Unbox(read(old($Heap), $o, alloc)): bool);
  free ensures true;
  ensures {:id "id23"} !Set#IsMember($Unbox(read($Heap, this, ITER__A.RecursiveIterator.__new)): Set, $Box(null));
  free ensures more#0 ==> ITER__A.RecursiveIterator.Valid#canCall($Heap, this);
  ensures {:id "id24"} more#0 ==> ITER__A.RecursiveIterator.Valid($Heap, this);
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
    $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
       ==> $Heap[$o] == old($Heap)[$o]
         || 
        $o == this
         || Set#IsMember(ITER__A.RecursiveIterator.__modifies(this), $Box($o))
         || Set#IsMember($Unbox(read(old($Heap), this, ITER__A.RecursiveIterator.__new)): Set, $Box($o)));
  // boilerplate
  free ensures $HeapSucc(old($Heap), $Heap);
...
procedure {:verboseName "ITER_A.RecursiveIterator (correctness)"} Impl$$ITER__A.RecursiveIterator(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__A.RecursiveIterator())
         && $IsAlloc(this, Tclass.ITER__A.RecursiveIterator(), $Heap), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ITER_A.RecursiveIterator (correctness)"} Impl$$ITER__A.RecursiveIterator(this: ref, n#0: int, r#0: ref, good#0: bool)
{
  ...
  var $iter_newUpdate1_1_0: Set;
    ...
    assume {:id "id36"} r#0 != null;
    assume {:id "id37"} ITER__A.RecursiveIterator.n(this) == n#0;
    assume {:id "id38"} ITER__A.RecursiveIterator.r(this) == r#0;
    assume {:id "id39"} ITER__A.RecursiveIterator.good(this) == good#0;
    assume {:id "id40"} ITER__A.RecursiveIterator.Valid($Heap, this);
    assume {:id "id41"} Set#Equal(ITER__A.RecursiveIterator.__reads(this), Set#Empty(): Set);
    assume {:id "id42"} Set#Equal(ITER__A.RecursiveIterator.__modifies(this), Set#Empty(): Set);
    assume {:id "id43"} Set#Equal($Unbox(read($Heap, this, ITER__A.RecursiveIterator.__new)): Set, 
      Set#Empty(): Set);
    assume {:id "id44"} ITER__A.RecursiveIterator.__decreases0(this) == n#0 + 2;
    assume {:id "id45"} ITER__A.RecursiveIterator.__decreases1(this) == LitInt(0);
    assume _yieldCount#0 == 0;
    call $YieldHavoc(this, ITER__A.RecursiveIterator.__reads(this), $Unbox(read($Heap, this, ITER__A.RecursiveIterator.__new)): Set);
    $_OldIterHeap := $Heap;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Iterators.dfy(247,5)
    assume true;
    ...
    {
        // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Iterators.dfy(248,12)
        assume true;
        if (ITER__A.RecursiveIterator.good(this))
        {
            // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Iterators.dfy(249,10)
            $initHeapCallStmt#1_0_0 := $Heap;
            // TrCallStmt: Before ProcessCallStmt
            assume true;
            assert {:id "id46"} ITER__A.RecursiveIterator.r(this) != null;
            assume true;
            // ProcessCallStmt: CheckSubrange
            assert {:id "id47"} $Is(ITER__A.RecursiveIterator.n(this) - 1, Tclass._System.nat());
            n##0 := ITER__A.RecursiveIterator.n(this) - 1;
            assert {:id "id48"} 0 <= n#0 + 2 || n##0 + 2 == n#0 + 2;
            assert {:id "id49"} n##0 + 2 < n#0 + 2;
            call {:id "id50"} Call$$ITER__A.RecIterCaller.M(ITER__A.RecursiveIterator.r(this), n##0);
            // TrCallStmt: After ProcessCallStmt
            call $iter_newUpdate1_0_0 := $IterCollectNewObjects($initHeapCallStmt#1_0_0, $Heap, this, ITER__A.RecursiveIterator.__new);
            $Heap := update($Heap, this, ITER__A.RecursiveIterator.__new, $Box($iter_newUpdate1_0_0));
            assume $IsGoodHeap($Heap);
        }
        else
        {
            // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Iterators.dfy(251,10)
            $initHeapCallStmt#1_1_0 := $Heap;
            // TrCallStmt: Before ProcessCallStmt
            assume true;
            assert {:id "id51"} ITER__A.RecursiveIterator.r(this) != null;
            assume true;
            // ProcessCallStmt: CheckSubrange
            assert {:id "id52"} $Is(ITER__A.RecursiveIterator.n(this) + 1, Tclass._System.nat());
            n##1 := ITER__A.RecursiveIterator.n(this) + 1;
            assert {:id "id53"} 0 <= n#0 + 2 || n##1 + 2 == n#0 + 2;
            assert {:id "id54"} n##1 + 2 < n#0 + 2;
            call {:id "id55"} Call$$ITER__A.RecIterCaller.M(ITER__A.RecursiveIterator.r(this), n##1);
            // TrCallStmt: After ProcessCallStmt
            call $iter_newUpdate1_1_0 := $IterCollectNewObjects($initHeapCallStmt#1_1_0, $Heap, this, ITER__A.RecursiveIterator.__new);
            $Heap := update($Heap, this, ITER__A.RecursiveIterator.__new, $Box($iter_newUpdate1_1_0));
            assume $IsGoodHeap($Heap);
        }
    }
}
...
procedure {:verboseName "ITER_A.RecIterCaller.M (well-formedness)"} CheckWellFormed$$ITER__A.RecIterCaller.M(this: ref
       where this != null
         && 
...
procedure {:verboseName "ITER_A.RecIterCaller.M (call)"} Call$$ITER__A.RecIterCaller.M(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__A.RecIterCaller())
         && $IsAlloc(this, Tclass.ITER__A.RecIterCaller(), $Heap), 
...
procedure {:verboseName "ITER_A.RecIterCaller.M (correctness)"} Impl$$ITER__A.RecIterCaller.M(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__A.RecIterCaller())
         && $IsAlloc(this, Tclass.ITER__A.RecIterCaller(), $Heap), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ITER_A.RecIterCaller.M (correctness)"} Impl$$ITER__A.RecIterCaller.M(this: ref, n#0: int) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var good#0: bool;
  ...
  var iter#0: ref
     where defass#iter#0
       ==> $Is(iter#0, Tclass.ITER__A.RecursiveIterator())
  ...
  var $rhs##0: bool;
    ...
    $_reverifyPost := false;
    havoc good#0;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Iterators.dfy(260,16)
    assume true;
    // ----- init call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Iterators.dfy(260,19)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    n##0 := n#0;
    ...
    // ProcessCallStmt: CheckSubrange
    good##0 := good#0;
    call {:id "id56"} $nw := Call$$ITER__A.RecursiveIterator.__ctor(n##0, r##0, good##0);
    // TrCallStmt: After ProcessCallStmt
    iter#0 := $nw;
    defass#iter#0 := true;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Iterators.dfy(261,32)
    assume true;
    // TrCallStmt: Adding lhs with type bool
    // TrCallStmt: Before ProcessCallStmt
    assert {:id "id58"} defass#iter#0;
    assume true;
    assert {:id "id59"} iter#0 != null;
    assert {:id "id60"} (forall $o: ref, $f: Field :: 
      $o != null
           && $Unbox(read($Heap, $o, alloc)): bool
           && (
            $o == iter#0
             || Set#IsMember(ITER__A.RecursiveIterator.__modifies(iter#0), $Box($o))
             || Set#IsMember($Unbox(read($Heap, iter#0, ITER__A.RecursiveIterator.__new)): Set, $Box($o)))
         ==> $_ModifiesFrame[$o, $f]);
    assert {:id "id61"} 0 <= n#0 + 2 || ITER__A.RecursiveIterator.__decreases0(iter#0) == n#0 + 2;
    assert {:id "id62"} ITER__A.RecursiveIterator.__decreases0(iter#0) <= n#0 + 2;
    call {:id "id63"} $rhs##0 := Call$$ITER__A.RecursiveIterator.MoveNext(iter#0);
    // TrCallStmt: After ProcessCallStmt
    more#0 := $rhs##0;
}
