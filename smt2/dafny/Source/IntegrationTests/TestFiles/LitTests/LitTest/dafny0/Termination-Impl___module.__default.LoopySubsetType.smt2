...
(assert (distinct alloc Tagclass._module.SubZOT tytagFamily$SubZOT)
)
...
(set-info :boogie-vc-id Impl$$_module.__default.LoopySubsetType)
...
)) (= |z#0@@1| |z#0@@1|))) (and (=> (= (ControlFlow 0 8) 1) anon6_LoopDone_correct) (=> (= (ControlFlow 0 8) 7) anon6_LoopBody_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($IsBox |z#0@@1| Tclass._module.SubZOT) ($IsAllocBox |z#0@@1| Tclass._module.SubZOT $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct))))
