...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon6_correct  (=> (and (<= (LitInt 125) |i#1_0@0|) (< |i#1_0@0| 250)) (and (=> (= (ControlFlow 0 10) (- 0 13)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 10) (- 0 12)) (and (<= 0 |i#1_0@0|) (< |i#1_0@0| (_System.array.Length $nw@0)))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField |i#1_0@0|)))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField |i#1_0@0|))) (=> (and (and (<= (LitInt 125) |i#1_1@0|) (< |i#1_1@0| 250)) (and (or (not (= |i#1_0@0| |i#1_1@0|)) (not true)) (= (ControlFlow 0 10) (- 0 9)))) (or (or (or (not (= $nw@0 $nw@0)) (not true)) (or (not (= (IndexField |i#1_0@0|) (IndexField |i#1_1@0|))) (not true))) (= (+ 300 |i#1_0@0|) (+ 300 |i#1_1@0|))))))))))))
(let ((anon10_Else_correct  (=> (and (< |i#1_0@0| (LitInt 125)) (= (ControlFlow 0 15) 10)) anon6_correct)))
(let ((anon10_Then_correct  (=> (and (<= (LitInt 125) |i#1_0@0|) (= (ControlFlow 0 14) 10)) anon6_correct)))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 16) 14) anon10_Then_correct) (=> (= (ControlFlow 0 16) 15) anon10_Else_correct))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (forall ((|i#1| Int) (|j#1| Int) ) (!  (=> (and (and (and (<= (LitInt 0) |i#1|) (< |i#1| (Div (_System.array.Length $nw@0) (LitInt 2)))) (<= (Div (_System.array.Length $nw@0) (LitInt 2)) |j#1|)) (< |j#1| (_System.array.Length $nw@0))) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |i#1|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |j#1|))))))
 :qid |ForallStmtdfy.104:18|
 :skolemid |630|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |j#1|))) ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |i#1|))))
)))))
(let ((anon9_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) ($HeapSucc $Heap@1 $Heap@2)) (and (and (forall (($o@@6 T@U) ($f@@0 T@U) ) (!  (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@6) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@6) $f@@0)) (exists ((|i#1_2| Int) ) (!  (and (and (and (<= (LitInt 125) |i#1_2|) (< |i#1_2| 250)) (= $o@@6 $nw@0)) (= $f@@0 (IndexField |i#1_2|)))
 :qid |ForallStmtdfy.110:10|
 :skolemid |635|
)))
 :qid |ForallStmtdfy.110:3|
 :skolemid |636|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@6) $f@@0))
)) (forall ((|i#inv#1_0| Int) ) (!  (=> (and (<= (LitInt 125) |i#inv#1_0|) (< |i#inv#1_0| 250)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (IndexField |i#inv#1_0|)) ($Box intType (int_2_U (+ 300 |i#inv#1_0|)))))
 :qid |ForallStmtdfy.110:10|
 :skolemid |637|
...
))) (and (= $Heap@3 $Heap@2) (= (ControlFlow 0 8) 7)))) GeneratedUnifiedExit_correct)))
(let ((anon8_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) ($HeapSucc $Heap@0 $Heap@1)) (and (forall (($o@@7 T@U) ($f@@1 T@U) ) (!  (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@7) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7) $f@@1)) (exists ((|i#0_2| Int) ) (!  (and (and (and (<= (LitInt 0) |i#0_2|) (< |i#0_2| 125)) (= $o@@7 $nw@0)) (= $f@@1 (IndexField |i#0_2|)))
 :qid |ForallStmtdfy.107:10|
 :skolemid |632|
)))
 :qid |ForallStmtdfy.107:3|
 :skolemid |633|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@7) $f@@1))
)) (forall ((|i#inv#0_0| Int) ) (!  (=> (and (<= (LitInt 0) |i#inv#0_0|) (and (<= (LitInt 0) |i#inv#0_0|) (< |i#inv#0_0| 125))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |i#inv#0_0|)) ($Box intType (int_2_U (LitInt 423)))))
 :qid |ForallStmtdfy.107:10|
 :skolemid |634|
...
)))) (and (=> (= (ControlFlow 0 17) 16) anon9_Then_correct) (=> (= (ControlFlow 0 17) 8) anon9_Else_correct)))))
(let ((anon8_Then_correct  (=> (and (<= (LitInt 0) |i#0_0@0|) (< |i#0_0@0| 125)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= 0 |i#0_0@0|) (< |i#0_0@0| (_System.array.Length $nw@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField |i#0_0@0|)))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField |i#0_0@0|))) (=> (and (and (<= (LitInt 0) |i#0_1@0|) (< |i#0_1@0| 125)) (and (or (not (= |i#0_0@0| |i#0_1@0|)) (not true)) (= (ControlFlow 0 2) (- 0 1)))) (or (or (or (not (= $nw@0 $nw@0)) (not true)) (or (not (= (IndexField |i#0_0@0|) (IndexField |i#0_1@0|))) (not true))) (= (LitInt 423) (LitInt 423))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap alloc false)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (<= 0 (LitInt 250))) (=> (<= 0 (LitInt 250)) (=> (and (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? TInt))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc))))) (and (and (= (_System.array.Length $nw@0) (LitInt 250)) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (=> (= (ControlFlow 0 18) 2) anon8_Then_correct) (=> (= (ControlFlow 0 18) 17) anon8_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 20) 18))) anon0_correct))))
