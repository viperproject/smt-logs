...
(assert (distinct TInt TagInt TagSet TagISet TagIMap alloc |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 |tytagFamily$_tuple#2|)
)
...
(assert (forall ((|$w#0@@0| T@U) ) (! (= (MapType0Select BoxType BoxType |lambda#30| |$w#0@@0|) |$w#0@@0|)
 :qid |IMapsdfy.112:19|
 :skolemid |598|
 :pattern ( (MapType0Select BoxType BoxType |lambda#30| |$w#0@@0|))
)))
...
(assert (forall ((v@@8 T@U) (t0@@4 T@U) (h@@2 T@U) ) (! (= ($IsAlloc SetType v@@8 (TSet t0@@4) h@@2) (forall ((bx@@4 T@U) ) (!  (=> (|Set#IsMember| v@@8 bx@@4) ($IsAllocBox bx@@4 t0@@4 h@@2))
...
(assert (forall ((v@@9 T@U) (t0@@5 T@U) (t1@@1 T@U) ) (! (= ($Is IMapType v@@9 (TIMap t0@@5 t1@@1)) (forall ((bx@@5 T@U) ) (!  (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| v@@9) bx@@5)) (and ($IsBox (MapType0Select BoxType BoxType (|IMap#Elements| v@@9) bx@@5) t1@@1) ($IsBox bx@@5 t0@@5)))
 :qid |DafnyPreludebpl.276:19|
 :skolemid |58|
 :pattern ( (MapType0Select BoxType BoxType (|IMap#Elements| v@@9) bx@@5))
 :pattern ( (MapType0Select BoxType boolType (|IMap#Domain| v@@9) bx@@5))
)))
...
(assert (forall ((bx@@6 T@U) (s T@U) (t@@10 T@U) ) (!  (=> ($IsBox bx@@6 (TIMap s t@@10)) (and (= ($Box IMapType ($Unbox IMapType bx@@6)) bx@@6) ($Is IMapType ($Unbox IMapType bx@@6) (TIMap s t@@10))))
 :qid |DafnyPreludebpl.210:15|
 :skolemid |37|
 :pattern ( ($IsBox bx@@6 (TIMap s t@@10)))
)))
...
(assert  (and (and (and (forall ((t0@@6 T@T) (t1@@2 T@T) (t2 T@T) (val@@1 T@U) (m@@9 T@U) (x0@@1 T@U) (x1 T@U) ) (! (= (MapType1Select t0@@6 t1@@2 t2 (MapType1Store t0@@6 t1@@2 t2 m@@9 x0@@1 x1 val@@1) x0@@1 x1) val@@1)
...
(assert (forall ((a@@4 T@U) (b@@1 T@U) (t0@@7 T@U) (t1@@3 T@U) ) (!  (=> (forall ((bx@@8 T@U) ) (!  (=> (U_2_bool (MapType0Select BoxType boolType a@@4 bx@@8)) (and ($IsBox bx@@8 t0@@7) ($IsBox (MapType0Select BoxType BoxType b@@1 bx@@8) t1@@3)))
 :qid |DafnyPreludebpl.1585:11|
 :skolemid |318|
)) ($Is IMapType (|IMap#Glue| a@@4 b@@1 (TIMap t0@@7 t1@@3)) (TIMap t0@@7 t1@@3)))
 :qid |DafnyPreludebpl.1582:15|
 :skolemid |319|
 :pattern ( (|IMap#Glue| a@@4 b@@1 (TIMap t0@@7 t1@@3)))
)))
...
(assert (forall ((v@@11 T@U) (t0@@8 T@U) (t1@@4 T@U) ) (!  (=> ($Is IMapType v@@11 (TIMap t0@@8 t1@@4)) (and (and ($Is (MapType0Type BoxType boolType) (|IMap#Domain| v@@11) (TISet t0@@8)) ($Is (MapType0Type BoxType boolType) (|IMap#Values| v@@11) (TISet t1@@4))) ($Is (MapType0Type BoxType boolType) (|IMap#Items| v@@11) (TISet (Tclass._System.Tuple2 t0@@8 t1@@4)))))
 :qid |DafnyPreludebpl.281:15|
 :skolemid |60|
 :pattern ( ($Is IMapType v@@11 (TIMap t0@@8 t1@@4)))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon6_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((|i#3| Int) ) (!  (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |x#0@0|) ($Box intType (int_2_U |i#3|)))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|IMap#Elements| |x#0@0|) ($Box intType (int_2_U |i#3|))))) |i#3|))
 :qid |IMapsdfy.113:18|
 :skolemid |572|
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|IMap#Elements| |x#0@0|) ($Box intType (int_2_U |i#3|)))))
 :pattern ( (MapType0Select BoxType boolType (|IMap#Domain| |x#0@0|) ($Box intType (int_2_U |i#3|))))
)))))
(let ((anon10_Else_correct  (=> (and (not (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |x#0@0|) ($Box intType (int_2_U |i#2@0|))))) (= (ControlFlow 0 7) 4)) anon6_correct)))
(let ((anon10_Then_correct  (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |x#0@0|) ($Box intType (int_2_U |i#2@0|)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |x#0@0|) ($Box intType (int_2_U |i#2@0|))))) (=> (= (ControlFlow 0 5) 4) anon6_correct)))))
...
(let ((anon3_correct  (=> (= |x#0@0| (|IMap#Glue| (|lambda#29| TInt |s#0@0|) |lambda#30| (TIMap TInt TInt))) (and (=> (= (ControlFlow 0 9) 8) anon9_Then_correct) (=> (= (ControlFlow 0 9) 2) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (not (|Set#IsMember| |s#0@0| ($Box intType (int_2_U |i#0@0|)))) (= (ControlFlow 0 11) 9)) anon3_correct)))
(let ((anon8_Then_correct  (=> (and (|Set#IsMember| |s#0@0| ($Box intType (int_2_U |i#0@0|))) (= (ControlFlow 0 10) 9)) anon3_correct)))
...
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |s#0@0| (Lit SetType (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U (LitInt 0)))) ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 4))))))) (and (=> (= (ControlFlow 0 13) 12) anon7_Then_correct) (=> (= (ControlFlow 0 13) 1) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SetType |s#0| (TSet TInt)) ($IsAlloc SetType |s#0| (TSet TInt) $Heap)) true) (=> (and (and (and ($Is IMapType |x#0| (TIMap TInt TInt)) ($IsAlloc IMapType |x#0| (TIMap TInt TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct)))))
