...
(assert (forall ((a@@4 T@U) (b@@1 T@U) (t0@@7 T@U) (t1@@3 T@U) ) (!  (=> (forall ((bx@@8 T@U) )  (=> (U_2_bool (MapType0Select BoxType boolType a@@4 bx@@8)) (and ($IsBox bx@@8 t0@@7) ($IsBox (MapType0Select BoxType BoxType b@@1 bx@@8) t1@@3)))) ($Is IMapType (|IMap#Glue| a@@4 b@@1 (TIMap t0@@7 t1@@3)) (TIMap t0@@7 t1@@3)))
