...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@0 T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.__default.fact#canCall| |n#0@@0|) (and (< 0 $FunctionContextHeight) (<= (LitInt 0) |n#0@@0|))) (and (=> (or (not (= |n#0@@0| (LitInt 0))) (not true)) (|_module.__default.fact#canCall| (- |n#0@@0| 1))) (= (_module.__default.fact ($LS $ly@@0) |n#0@@0|) (ite (= |n#0@@0| (LitInt 0)) 1 (Mul |n#0@@0| (_module.__default.fact $ly@@0 (- |n#0@@0| 1)))))))
 :qid |Computationsdfy.9:16|
 :skolemid |537|
 :pattern ( (_module.__default.fact ($LS $ly@@0) |n#0@@0|))
))))
...
(assert (forall (($ly@@1 T@U) (|n#0@@1| Int) ) (! (= (_module.__default.fact ($LS $ly@@1) |n#0@@1|) (_module.__default.fact $ly@@1 |n#0@@1|))
 :qid |Computationsdfy.9:16|
 :skolemid |533|
 :pattern ( (_module.__default.fact ($LS $ly@@1) |n#0@@1|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@2 T@U) (|n#0@@2| Int) ) (!  (=> (or (|_module.__default.fact#canCall| (LitInt |n#0@@2|)) (and (< 0 $FunctionContextHeight) (<= (LitInt 0) |n#0@@2|))) (and (=> (or (not (= (LitInt |n#0@@2|) (LitInt 0))) (not true)) (|_module.__default.fact#canCall| (LitInt (- |n#0@@2| 1)))) (= (_module.__default.fact ($LS $ly@@2) (LitInt |n#0@@2|)) (ite (= (LitInt |n#0@@2|) (LitInt 0)) 1 (Mul (LitInt |n#0@@2|) (LitInt (_module.__default.fact ($LS $ly@@2) (LitInt (- |n#0@@2| 1)))))))))
 :qid |Computationsdfy.9:16|
 :weight 3
 :skolemid |538|
 :pattern ( (_module.__default.fact ($LS $ly@@2) (LitInt |n#0@@2|)))
))))
(push 1)
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.compute__fact6)
...
(assert (not
 ...
 :qid |Computationsdfy.13:14|
 :skolemid |540|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0))
))) (and ($HeapSuccGhost $Heap $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) ($Is intType (int_2_U (LitInt 6)) Tclass._System.nat)))))
