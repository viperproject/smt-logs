...
(declare-fun _module.__default.Z_h (T@U T@U T@U) Bool)
(declare-fun |_module.__default.Z_h#canCall| (T@U T@U T@U) Bool)
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|_module._default.Z#$_T0| T@U) (|_k#0| T@U) (|s#0| T@U) ) (!  (=> (or (|_module.__default.Z_h#canCall| |_module._default.Z#$_T0| |_k#0| |s#0|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |s#0| (Tclass._module.Stream |_module._default.Z#$_T0|)))) (and (=> (=> (< 0 (|ORD#Offset| |_k#0|)) false) (=> (= (LitInt 0) (|ORD#Offset| |_k#0|)) (forall ((|_k'#0| T@U) ) (!  (=> (|ORD#Less| |_k'#0| |_k#0|) (|_module.__default.Z_h#canCall| |_module._default.Z#$_T0| |_k'#0| |s#0|))
 :qid |CoinductiveProofsdfy.157:20|
 :skolemid |764|
 :pattern ( (_module.__default.Z_h |_module._default.Z#$_T0| |_k'#0| |s#0|))
)))) (= (_module.__default.Z_h |_module._default.Z#$_T0| |_k#0| |s#0|)  (and (=> (< 0 (|ORD#Offset| |_k#0|)) false) (=> (= (LitInt 0) (|ORD#Offset| |_k#0|)) (forall ((|_k'#0@@0| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@0| |_k#0|) (_module.__default.Z_h |_module._default.Z#$_T0| |_k'#0@@0| |s#0|))
 :qid |CoinductiveProofsdfy.157:20|
 :skolemid |763|
 :pattern ( (_module.__default.Z_h |_module._default.Z#$_T0| |_k'#0@@0| |s#0|))
)))))))
 :qid |unknown.0:0|
 :skolemid |765|
 :pattern ( (_module.__default.Z_h |_module._default.Z#$_T0| |_k#0| |s#0|))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|_module._default.Z#$_T0@@0| T@U) (|s#0@@0| T@U) (|_k#0@@0| T@U) ) (!  (=> (and ($Is DatatypeTypeType |s#0@@0| (Tclass._module.Stream |_module._default.Z#$_T0@@0|)) (= |_k#0@@0| (|ORD#FromNat| 0))) (_module.__default.Z_h |_module._default.Z#$_T0@@0| |_k#0@@0| |s#0@@0|))
 :qid |unknown.0:0|
 :skolemid |760|
 :pattern ( (_module.__default.Z_h |_module._default.Z#$_T0@@0| |_k#0@@0| |s#0@@0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|_module._default.Z#$_T0@@1| T@U) (|_k#0@@1| T@U) (|s#0@@1| T@U) ) (!  (=> (or (|_module.__default.Z_h#canCall| |_module._default.Z#$_T0@@1| (Lit BoxType |_k#0@@1|) |s#0@@1|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |s#0@@1| (Tclass._module.Stream |_module._default.Z#$_T0@@1|)))) (and (=> (=> (< 0 (|ORD#Offset| |_k#0@@1|)) false) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@1|)) (forall ((|_k'#1| T@U) ) (!  (=> (|ORD#Less| |_k'#1| |_k#0@@1|) (|_module.__default.Z_h#canCall| |_module._default.Z#$_T0@@1| |_k'#1| |s#0@@1|))
 :qid |CoinductiveProofsdfy.157:20|
 :skolemid |767|
 :pattern ( (_module.__default.Z_h |_module._default.Z#$_T0@@1| |_k'#1| |s#0@@1|))
)))) (= (_module.__default.Z_h |_module._default.Z#$_T0@@1| (Lit BoxType |_k#0@@1|) |s#0@@1|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@1|)) false) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@1|)) (forall ((|_k'#1@@0| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@0| |_k#0@@1|) (_module.__default.Z_h |_module._default.Z#$_T0@@1| |_k'#1@@0| |s#0@@1|))
 :qid |CoinductiveProofsdfy.157:20|
 :skolemid |766|
 :pattern ( (_module.__default.Z_h |_module._default.Z#$_T0@@1| |_k'#1@@0| |s#0@@1|))
)))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |768|
 :pattern ( (_module.__default.Z_h |_module._default.Z#$_T0@@1| (Lit BoxType |_k#0@@1|) |s#0@@1|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|_module._default.Z#$_T0@@2| T@U) (|_k#0@@2| T@U) (|s#0@@2| T@U) ) (!  (=> (or (|_module.__default.Z_h#canCall| |_module._default.Z#$_T0@@2| (Lit BoxType |_k#0@@2|) (Lit DatatypeTypeType |s#0@@2|)) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |s#0@@2| (Tclass._module.Stream |_module._default.Z#$_T0@@2|)))) (and (=> (=> (< 0 (|ORD#Offset| |_k#0@@2|)) false) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@2|)) (forall ((|_k'#2| T@U) ) (!  (=> (|ORD#Less| |_k'#2| |_k#0@@2|) (|_module.__default.Z_h#canCall| |_module._default.Z#$_T0@@2| |_k'#2| |s#0@@2|))
 :qid |CoinductiveProofsdfy.157:20|
 :skolemid |770|
 :pattern ( (_module.__default.Z_h |_module._default.Z#$_T0@@2| |_k'#2| |s#0@@2|))
)))) (= (_module.__default.Z_h |_module._default.Z#$_T0@@2| (Lit BoxType |_k#0@@2|) (Lit DatatypeTypeType |s#0@@2|))  (and (=> (< 0 (|ORD#Offset| |_k#0@@2|)) false) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@2|)) (forall ((|_k'#2@@0| T@U) ) (!  (=> (|ORD#Less| |_k'#2@@0| |_k#0@@2|) (_module.__default.Z_h |_module._default.Z#$_T0@@2| |_k'#2@@0| |s#0@@2|))
 :qid |CoinductiveProofsdfy.157:20|
 :skolemid |769|
 :pattern ( (_module.__default.Z_h |_module._default.Z#$_T0@@2| |_k'#2@@0| |s#0@@2|))
)))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |771|
 :pattern ( (_module.__default.Z_h |_module._default.Z#$_T0@@2| (Lit BoxType |_k#0@@2|) (Lit DatatypeTypeType |s#0@@2|)))
))))
...
(declare-fun |_module._default.AlwaysLemma_Z#$_T0| () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.AlwaysLemma__Z_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.__default.Z_h#canCall| |_module._default.AlwaysLemma_Z#$_T0| |_k#0@@3| |s#1|) (or (_module.__default.Z_h |_module._default.AlwaysLemma_Z#$_T0| |_k#0@@3| |s#1|) (=> (< 0 (|ORD#Offset| |_k#0@@3|)) (U_2_bool (Lit boolType (bool_2_U false))))))) (=> (=> (|_module.__default.Z_h#canCall| |_module._default.AlwaysLemma_Z#$_T0| |_k#0@@3| |s#1|) (or (_module.__default.Z_h |_module._default.AlwaysLemma_Z#$_T0| |_k#0@@3| |s#1|) (=> (< 0 (|ORD#Offset| |_k#0@@3|)) (U_2_bool (Lit boolType (bool_2_U false)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.__default.Z_h#canCall| |_module._default.AlwaysLemma_Z#$_T0| |_k#0@@3| |s#1|) (or (_module.__default.Z_h |_module._default.AlwaysLemma_Z#$_T0| |_k#0@@3| |s#1|) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@3|)) (forall ((|_k'#1@@1| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@1| |_k#0@@3|) (_module.__default.Z_h |_module._default.AlwaysLemma_Z#$_T0| |_k'#1@@1| |s#1|))
 :qid |CoinductiveProofsdfy.157:20|
 :skolemid |774|
 :pattern ( (_module.__default.Z_h |_module._default.AlwaysLemma_Z#$_T0| |_k'#1@@1| |s#1|))
))))))))))
(let ((anon3_Else_correct  (=> (<= (|ORD#Offset| |_k#0@@3|) 0) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap $Heap@1)) (and (forall ((|_k'#2@@1| T@U) (|s#2| T@U) ) (!  (=> (and ($Is DatatypeTypeType |s#2| (Tclass._module.Stream |_module._default.AlwaysLemma_Z#$_T0|)) (|ORD#Less| |_k'#2@@1| |_k#0@@3|)) (_module.__default.Z_h |_module._default.AlwaysLemma_Z#$_T0| |_k'#2@@1| |s#2|))
 :qid |CoinductiveProofsdfy.162:35|
 :skolemid |777|
 :pattern ( (_module.__default.Z_h |_module._default.AlwaysLemma_Z#$_T0| |_k'#2@@1| |s#2|))
)) (= (ControlFlow 0 7) 2))) GeneratedUnifiedExit_correct))))
(let ((anon3_Then_correct  (=> (< 0 (|ORD#Offset| |_k#0@@3|)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@3|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@3|)) (=> (= |_k##0@0| (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (|_module.__default.Z_h#canCall| |_module._default.AlwaysLemma_Z#$_T0| |_k##0@0| |s#1|)) (and (and (|_module.__default.Z_h#canCall| |_module._default.AlwaysLemma_Z#$_T0| |_k##0@0| |s#1|) (and (_module.__default.Z_h |_module._default.AlwaysLemma_Z#$_T0| |_k##0@0| |s#1|) (and (=> (< 0 (|ORD#Offset| |_k##0@0|)) false) (=> (= (LitInt 0) (|ORD#Offset| |_k##0@0|)) (forall ((|_k'#0@@1| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@1| |_k##0@0|) (_module.__default.Z_h |_module._default.AlwaysLemma_Z#$_T0| |_k'#0@@1| |s#1|))
 :qid |CoinductiveProofsdfy.157:20|
 :skolemid |773|
 :pattern ( (_module.__default.Z_h |_module._default.AlwaysLemma_Z#$_T0| |_k'#0@@1| |s#1|))
)))))) (and (= $Heap $Heap@0) (= (ControlFlow 0 4) 2)))) GeneratedUnifiedExit_correct)))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 8) 4) anon3_Then_correct) (=> (= (ControlFlow 0 8) 7) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |s#1| (Tclass._module.Stream |_module._default.AlwaysLemma_Z#$_T0|)) ($IsAlloc DatatypeTypeType |s#1| (Tclass._module.Stream |_module._default.AlwaysLemma_Z#$_T0|) $Heap)) (|$IsA#_module.Stream| |s#1|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct))))
