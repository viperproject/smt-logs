...
(assert (forall ((d@@5 T@U) ) (!  (=> ($Is DatatypeTypeType d@@5 Tclass.NestedMatch.Nat) (or (NestedMatch.Nat.Zero_q d@@5) (NestedMatch.Nat.Suc_q d@@5)))
 :qid |unknown.0:0|
 :skolemid |580|
 :pattern ( (NestedMatch.Nat.Suc_q d@@5) ($Is DatatypeTypeType d@@5 Tclass.NestedMatch.Nat))
 :pattern ( (NestedMatch.Nat.Zero_q d@@5) ($Is DatatypeTypeType d@@5 Tclass.NestedMatch.Nat))
)))
...
(assert (forall ((d@@7 T@U) ($h T@U) ) (!  (=> (and ($IsGoodHeap $h) ($Is DatatypeTypeType d@@7 Tclass.NestedMatch.Nat)) ($IsAlloc DatatypeTypeType d@@7 Tclass.NestedMatch.Nat $h))
 :qid |unknown.0:0|
 :skolemid |578|
 :pattern ( ($IsAlloc DatatypeTypeType d@@7 Tclass.NestedMatch.Nat $h))
)))
...
(assert (forall ((d@@8 T@U) ($h@@0 T@U) ) (!  (=> (and ($IsGoodHeap $h@@0) (and (NestedMatch.Nat.Suc_q d@@8) ($IsAlloc DatatypeTypeType d@@8 Tclass.NestedMatch.Nat $h@@0))) ($IsAlloc DatatypeTypeType (NestedMatch.Nat._h0 d@@8) Tclass.NestedMatch.Nat $h@@0))
 :qid |unknown.0:0|
 :skolemid |574|
 :pattern ( ($IsAlloc DatatypeTypeType (NestedMatch.Nat._h0 d@@8) Tclass.NestedMatch.Nat $h@@0))
)))
...
(set-info :boogie-vc-id CheckWellformed$$NestedMatch.__default.minus)
...
(let ((anon18_Then_correct  (=> (= |_mcc#1#0| (|#NestedMatch.Nat.Suc| |_mcc#3#0|)) (=> (and ($Is DatatypeTypeType |_mcc#3#0| Tclass.NestedMatch.Nat) (= |let#0#0#0| |_mcc#3#0|)) (=> (and (and (and ($Is DatatypeTypeType |let#0#0#0| Tclass.NestedMatch.Nat) (= |b#Z#0@0| |let#0#0#0|)) (and (= |let#1#0#0| |_mcc#2#0|) ($Is DatatypeTypeType |let#1#0#0| Tclass.NestedMatch.Nat))) (and (and (= |a#Z#0@0| |let#1#0#0|) ($IsAlloc DatatypeTypeType |a#Z#0@0| Tclass.NestedMatch.Nat $Heap)) (and ($IsAlloc DatatypeTypeType |b#Z#0@0| Tclass.NestedMatch.Nat $Heap) (= (ControlFlow 0 7) (- 0 6))))) (or (< (DtRank |a#Z#0@0|) (DtRank |x#0@@3|)) (and (= (DtRank |a#Z#0@0|) (DtRank |x#0@@3|)) (< (DtRank |b#Z#0@0|) (DtRank |y#0@@3|)))))))))
(let ((anon17_Else_correct  (=> (or (not (= |_mcc#1#0| |#NestedMatch.Nat.Zero|)) (not true)) (and (=> (= (ControlFlow 0 9) 7) anon18_Then_correct) (=> (= (ControlFlow 0 9) 8) anon18_Else_correct)))))
(let ((anon17_Then_correct true))
(let ((anon16_Then_correct  (=> (and (= |_mcc#0#0| (|#NestedMatch.Nat.Suc| |_mcc#2#0|)) ($Is DatatypeTypeType |_mcc#2#0| Tclass.NestedMatch.Nat)) (and (=> (= (ControlFlow 0 10) 5) anon17_Then_correct) (=> (= (ControlFlow 0 10) 9) anon17_Else_correct)))))
(let ((anon16_Else_correct true))
(let ((anon15_Else_correct  (=> (or (not (= |_mcc#0#0| |#NestedMatch.Nat.Zero|)) (not true)) (and (=> (= (ControlFlow 0 11) 10) anon16_Then_correct) (=> (= (ControlFlow 0 11) 4) anon16_Else_correct)))))
(let ((anon15_Then_correct true))
(let ((anon14_Then_correct  (=> (= (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |x#0@@3|) ($Box DatatypeTypeType |y#0@@3|)) (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |_mcc#0#0|) ($Box DatatypeTypeType |_mcc#1#0|))) (=> (and ($Is DatatypeTypeType |_mcc#0#0| Tclass.NestedMatch.Nat) ($Is DatatypeTypeType |_mcc#1#0| Tclass.NestedMatch.Nat)) (and (=> (= (ControlFlow 0 12) 3) anon15_Then_correct) (=> (= (ControlFlow 0 12) 11) anon15_Else_correct))))))
(let ((anon14_Else_correct true))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 13) 1) anon13_Then_correct) (=> (= (ControlFlow 0 13) 12) anon14_Then_correct)) (=> (= (ControlFlow 0 13) 2) anon14_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |x#0@@3| Tclass.NestedMatch.Nat) ($Is DatatypeTypeType |y#0@@3| Tclass.NestedMatch.Nat)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct))))
