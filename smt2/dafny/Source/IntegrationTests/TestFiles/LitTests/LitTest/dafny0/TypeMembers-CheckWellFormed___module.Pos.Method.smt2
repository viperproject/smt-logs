...
(set-info :boogie-vc-id CheckWellFormed$$_module.Pos.Method)
...
))) (and ($HeapSucc $Heap $Heap@0) (= |newtype$check#0@0| (LitInt 3)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< 0 |newtype$check#0@0|)) (=> (< 0 |newtype$check#0@0|) (=> (and (= |newtype$check#1@0| (+ |y#0| 3)) (= (ControlFlow 0 2) (- 0 1))) (< 0 |newtype$check#1@0|))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (< 0 |y#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct)))
