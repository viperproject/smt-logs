...
(assert (forall ((ty T@U) ) (!  (=> ($AlwaysAllocated ty) (forall ((h@@4 T@U) (v@@2 T@U) ) (!  (=> ($IsBox v@@2 ty) ($IsAllocBox v@@2 ty h@@4))
 :qid |DafnyPreludebpl.337:13|
 :skolemid |2457|
 :pattern ( ($IsAllocBox v@@2 ty h@@4))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.LoopyOpaqueType)
...
)) (= |z#0| |z#0|))) (and (=> (= (ControlFlow 0 8) 1) anon6_LoopDone_correct) (=> (= (ControlFlow 0 8) 7) anon6_LoopBody_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($IsBox |z#0| Tclass._module.ZOT) ($IsAllocBox |z#0| Tclass._module.ZOT $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct))))
