...
(declare-fun |lambda#7| (Int Int Int) T@U)
...
(declare-fun |lambda#13| (Int Int Int) T@U)
...
(declare-fun |lambda#19| (Int Int) T@U)
...
(assert (forall ((|l#0| Int) (|l#1| Int) (|l#2| Int) (|$l#1_0#heap#0| T@U) (|$l#1_0#z#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#7| |l#0| |l#1| |l#2|) |$l#1_0#heap#0| |$l#1_0#z#0|) ($Box intType (int_2_U (ite (< (U_2_int ($Unbox intType |$l#1_0#z#0|)) |l#0|) (- |l#1| (U_2_int ($Unbox intType |$l#1_0#z#0|))) (- (U_2_int ($Unbox intType |$l#1_0#z#0|)) |l#2|)))))
 :qid |unknown.0:0|
 :skolemid |9984|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#7| |l#0| |l#1| |l#2|) |$l#1_0#heap#0| |$l#1_0#z#0|))
)))
(assert (forall ((|l#0@@0| T@U) (|$l#0_0#heap#0| T@U) (|$l#0_0#z#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#2| |l#0@@0|) |$l#0_0#heap#0| |$l#0_0#z#0|)) ($IsBox |$l#0_0#z#0| |l#0@@0|))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |9980|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#2| |l#0@@0|) |$l#0_0#heap#0| |$l#0_0#z#0|))
)))
...
(assert (forall ((|l#0@@1| Int) (|l#1@@0| Int) (|l#2@@0| Int) (|$l#2_0#heap#0| T@U) (|$l#2_0#z#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#13| |l#0@@1| |l#1@@0| |l#2@@0|) |$l#2_0#heap#0| |$l#2_0#z#0|) ($Box intType (int_2_U (ite (<= (U_2_int ($Unbox intType |$l#2_0#z#0|)) |l#0@@1|) (- |l#1@@0| (U_2_int ($Unbox intType |$l#2_0#z#0|))) (- (U_2_int ($Unbox intType |$l#2_0#z#0|)) |l#2@@0|)))))
 :qid |unknown.0:0|
 :skolemid |9985|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#13| |l#0@@1| |l#1@@0| |l#2@@0|) |$l#2_0#heap#0| |$l#2_0#z#0|))
)))
...
(assert (forall ((|l#0@@2| Bool) (|$l#0_0#o#0| T@U) ) (! (= (U_2_bool (MapType1Select refType boolType (|lambda#3| |l#0@@2|) |$l#0_0#o#0|)) |l#0@@2|)
 :qid |unknown.0:0|
 :skolemid |9981|
 :pattern ( (MapType1Select refType boolType (|lambda#3| |l#0@@2|) |$l#0_0#o#0|))
)))
(assert (forall ((|l#0@@3| T@U) (|$l#0_0#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#5| |l#0@@3|) |$l#0_0#ly#0|) |l#0@@3|)
 :qid |SubsetTypesdfy.184:12|
 :skolemid |9983|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#5| |l#0@@3|) |$l#0_0#ly#0|))
)))
...
(assert (forall ((|l#0@@4| Int) (|l#1@@1| Int) (|$l#3_0#heap#0| T@U) (|$l#3_0#z#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#19| |l#0@@4| |l#1@@1|) |$l#3_0#heap#0| |$l#3_0#z#0|) ($Box intType (int_2_U (ite (< (U_2_int ($Unbox intType |$l#3_0#z#0|)) |l#0@@4|) (- |l#1@@1| (U_2_int ($Unbox intType |$l#3_0#z#0|))) (U_2_int ($Unbox intType |$l#3_0#z#0|))))))
 :qid |unknown.0:0|
 :skolemid |9986|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#19| |l#0@@4| |l#1@@1|) |$l#3_0#heap#0| |$l#3_0#z#0|))
)))
...
(assert (forall ((|l#0@@5| T@U) (|l#1@@2| T@U) (|l#2@@1| T@U) (|l#3| Bool) ($o@@1 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@5| |l#1@@2| |l#2@@1| |l#3|) $o@@1 $f))  (=> (and (or (not (= $o@@1 |l#0@@5|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@2| $o@@1) |l#2@@1|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |9978|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@5| |l#1@@2| |l#2@@1| |l#3|) $o@@1 $f))
)))
...
(assert (forall ((|l#0@@6| T@U) (|$l#0_0#heap#0@@0| T@U) (|$l#0_0#z#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#1| |l#0@@6|) |$l#0_0#heap#0@@0| |$l#0_0#z#0@@0|) |l#0@@6|)
 :qid |SubsetTypesdfy.184:17|
 :skolemid |9979|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#1| |l#0@@6|) |$l#0_0#heap#0@@0| |$l#0_0#z#0@@0|))
)))
(assert (forall ((|l#0@@7| T@U) (|$l#0_0#heap#0@@1| T@U) (|$l#0_0#z#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#4| |l#0@@7|) |$l#0_0#heap#0@@1| |$l#0_0#z#0@@1|) |l#0@@7|)
 :qid |SubsetTypesdfy.184:12|
 :skolemid |9982|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#4| |l#0@@7|) |$l#0_0#heap#0@@1| |$l#0_0#z#0@@1|))
)))
...
(set-info :boogie-vc-id Impl$$SoftCasts.__default.P)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 37) (let ((anon6_correct  (=> (= |newtype$check#3_0@0| (ite (< |z#3_0@0| 0) (- 0 |z#3_0@0|) |z#3_0@0|)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (<= (LitInt 0) |newtype$check#3_0@0|)) (=> (<= (LitInt 0) |newtype$check#3_0@0|) (=> (and (= |newtype$check#3_1@0| (ite (< |z#3_0@0| 0) (- 0 |z#3_0@0|) |z#3_0@0|)) (= (ControlFlow 0 29) (- 0 28))) (<= (LitInt 0) |newtype$check#3_1@0|)))))))
(let ((anon32_Else_correct  (=> (and (<= 0 |z#3_0@0|) (= (ControlFlow 0 32) 29)) anon6_correct)))
(let ((anon32_Then_correct  (=> (and (< |z#3_0@0| 0) (= (ControlFlow 0 31) 29)) anon6_correct)))
(let ((anon31_Then_correct  (=> (= |$_Frame#l3_0@0| (|lambda#0| null |$lambdaHeap#3_0@0| alloc false)) (and (=> (= (ControlFlow 0 33) 31) anon32_Then_correct) (=> (= (ControlFlow 0 33) 32) anon32_Else_correct)))))
(let ((anon31_Else_correct true))
(let ((anon30_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#3_0@0|) (or (= $Heap |$lambdaHeap#3_0@0|) ($HeapSucc $Heap |$lambdaHeap#3_0@0|))) (and (=> (= (ControlFlow 0 34) 33) anon31_Then_correct) (=> (= (ControlFlow 0 34) 27) anon31_Else_correct)))))
(let ((anon30_Else_correct true))
(let ((anon29_Then_correct  (and (=> (= (ControlFlow 0 35) 34) anon30_Then_correct) (=> (= (ControlFlow 0 35) 26) anon30_Else_correct))))
(let ((anon14_correct true))
(let ((anon36_Else_correct  (=> (and (and (< (LitInt 0) |z#2_0@0|) (= |lambdaResult#2_0| (- |z#2_0@0| 1))) (and ($Is intType (int_2_U |lambdaResult#2_0|) TInt) (= (ControlFlow 0 22) 20))) anon14_correct)))
(let ((anon36_Then_correct  (=> (and (and (<= |z#2_0@0| (LitInt 0)) (= |lambdaResult#2_0| (- 0 |z#2_0@0|))) (and ($Is intType (int_2_U |lambdaResult#2_0|) TInt) (= (ControlFlow 0 21) 20))) anon14_correct)))
(let ((anon35_Then_correct  (=> (= |$_Frame#l2_0@0| (|lambda#0| null |$lambdaHeap#2_0@0| alloc false)) (and (=> (= (ControlFlow 0 23) 21) anon36_Then_correct) (=> (= (ControlFlow 0 23) 22) anon36_Else_correct)))))
(let ((anon35_Else_correct true))
(let ((anon34_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#2_0@0|) (or (= $Heap |$lambdaHeap#2_0@0|) ($HeapSucc $Heap |$lambdaHeap#2_0@0|))) (and (=> (= (ControlFlow 0 24) 23) anon35_Then_correct) (=> (= (ControlFlow 0 24) 19) anon35_Else_correct)))))
(let ((anon34_Else_correct  (=> (= (ControlFlow 0 18) (- 0 17)) ($Is HandleTypeType (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#13| (LitInt 0) 0 1) (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))) (Tclass._System.___hFunc1 TInt Tclass._System.nat)))))
(let ((anon33_Then_correct  (and (=> (= (ControlFlow 0 25) 24) anon34_Then_correct) (=> (= (ControlFlow 0 25) 18) anon34_Else_correct))))
(let ((anon21_correct true))
(let ((anon40_Else_correct  (=> (and (and (<= 0 |z#1_0@0|) (= |lambdaResult#1_0| (- |z#1_0@0| 1))) (and ($Is intType (int_2_U |lambdaResult#1_0|) TInt) (= (ControlFlow 0 13) 11))) anon21_correct)))
(let ((anon40_Then_correct  (=> (and (and (< |z#1_0@0| 0) (= |lambdaResult#1_0| (- 0 |z#1_0@0|))) (and ($Is intType (int_2_U |lambdaResult#1_0|) TInt) (= (ControlFlow 0 12) 11))) anon21_correct)))
(let ((anon39_Then_correct  (=> (= |$_Frame#l1_0@0| (|lambda#0| null |$lambdaHeap#1_0@0| alloc false)) (and (=> (= (ControlFlow 0 14) 12) anon40_Then_correct) (=> (= (ControlFlow 0 14) 13) anon40_Else_correct)))))
(let ((anon39_Else_correct true))
(let ((anon38_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#1_0@0|) (or (= $Heap |$lambdaHeap#1_0@0|) ($HeapSucc $Heap |$lambdaHeap#1_0@0|))) (and (=> (= (ControlFlow 0 15) 14) anon39_Then_correct) (=> (= (ControlFlow 0 15) 10) anon39_Else_correct)))))
(let ((anon38_Else_correct  (=> (= (ControlFlow 0 9) (- 0 8)) ($Is HandleTypeType (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#7| 0 0 1) (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))) (Tclass._System.___hFunc1 TInt Tclass._System.nat)))))
(let ((anon37_Then_correct  (and (=> (= (ControlFlow 0 16) 15) anon38_Then_correct) (=> (= (ControlFlow 0 16) 9) anon38_Else_correct))))
(let ((anon43_Else_correct true))
(let ((anon43_Then_correct true))
(let ((anon42_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0_0@0|) (or (= $Heap |$lambdaHeap#0_0@0|) ($HeapSucc $Heap |$lambdaHeap#0_0@0|))) (and (=> (= (ControlFlow 0 6) 4) anon43_Then_correct) (=> (= (ControlFlow 0 6) 5) anon43_Else_correct)))))
(let ((anon42_Else_correct true))
(let ((anon41_Then_correct  (and (=> (= (ControlFlow 0 7) 6) anon42_Then_correct) (=> (= (ControlFlow 0 7) 3) anon42_Else_correct))))
(let ((anon41_Else_correct  (=> (and (and (and (and (not (U_2_bool (Lit boolType (bool_2_U true)))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (= (ControlFlow 0 2) (- 0 1))) false)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (and (and (=> (= (ControlFlow 0 36) 35) anon29_Then_correct) (=> (= (ControlFlow 0 36) 25) anon33_Then_correct)) (=> (= (ControlFlow 0 36) 16) anon37_Then_correct)) (=> (= (ControlFlow 0 36) 7) anon41_Then_correct)) (=> (= (ControlFlow 0 36) 2) anon41_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |n#0|)) (and (and ($Is HandleTypeType |g#0| (Tclass._System.___hFunc1 TInt Tclass._System.nat)) ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hFunc1 TInt Tclass._System.nat) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 37) 36)))) anon0_correct)))
