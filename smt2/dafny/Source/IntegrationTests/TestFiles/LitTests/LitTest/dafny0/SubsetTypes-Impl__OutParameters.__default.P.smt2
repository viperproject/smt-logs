...
(declare-fun |x#0| () T@U)
(declare-fun OutParameters._default.P$T () T@U)
(declare-fun |defass#y#0| () Bool)
(declare-fun |y#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$OutParameters.__default.P)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($IsBox |x#0| OutParameters._default.P$T) ($IsAllocBox |x#0| OutParameters._default.P$T $Heap)) (=> |defass#y#0| (and ($IsBox |y#0| OutParameters._default.P$T) ($IsAllocBox |y#0| OutParameters._default.P$T $Heap)))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
