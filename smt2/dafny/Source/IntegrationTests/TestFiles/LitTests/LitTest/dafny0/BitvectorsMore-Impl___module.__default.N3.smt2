...
(declare-fun |z#1_0| () Int)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.N3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (or (not (= |y#0| 0)) (not true)))))
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= |y#0| 0)) (not true)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (= 0 |x#0|) (= 0 |y#0|)) (and (= 0 |z#0_0|) true)) (and (and (= 0 |z#1_0|) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 6) 5)))) anon0_correct))))
