...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let (($generated@@91  (=> (= (ControlFlow 0 4) (- 0 3)) (or (not (= $generated@@80 0)) (not true)))))
(let (($generated@@92  (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= $generated@@80 0)) (not true)))))
(let (($generated@@93  (=> (= $generated@@81 ($generated@@24 $generated@@82 $generated@@83 $generated@@84 false)) (and (=> (= (ControlFlow 0 5) 2) $generated@@92) (=> (= (ControlFlow 0 5) 4) $generated@@91)))))
(let (($generated@@94  (=> (and ($generated@@85 $generated@@83) ($generated@@86 $generated@@83)) (=> (and (and (and (= 0 $generated@@87) (= 0 $generated@@80)) (and (= 0 $generated@@88) true)) (and (and (= 0 $generated@@89) true) (and (= 0 $generated@@90) (= (ControlFlow 0 6) 5)))) $generated@@93))))
$generated@@94)))))
))
(check-sat)
