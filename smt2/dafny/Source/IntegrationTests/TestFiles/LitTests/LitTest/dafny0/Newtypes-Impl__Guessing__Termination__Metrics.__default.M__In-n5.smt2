...
(set-info :boogie-vc-id Impl$$Guessing__Termination__Metrics.__default.M__Inferred)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon8_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (<= 0 |$decr$loop#00@1|) (= (- |y#0@3| |x#0@3|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- |y#0@3| |x#0@3|) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 5) (- 0 4)) (< (- |y#0@3| |x#0@3|) |$decr$loop#00@1|))))))
(let ((anon12_Else_correct  (=> (and (<= |y#0@1| 3) (= |newtype$check#0_1_0@1| (LitInt 3))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (or (= |newtype$check#0_1_0@1| (LitInt 0)) (= |newtype$check#0_1_0@1| (LitInt 3))) (= |newtype$check#0_1_0@1| (LitInt 7)))) (=> (or (or (= |newtype$check#0_1_0@1| (LitInt 0)) (= |newtype$check#0_1_0@1| (LitInt 3))) (= |newtype$check#0_1_0@1| (LitInt 7))) (=> (and (and (= |x#0@2| (LitInt 3)) (= |x#0@3| |x#0@2|)) (and (= |y#0@3| |y#0@1|) (= (ControlFlow 0 9) 5))) anon8_correct))))))
(let ((anon12_Then_correct  (=> (and (< 3 |y#0@1|) (= |newtype$check#0_0_0@1| (LitInt 3))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (or (= |newtype$check#0_0_0@1| (LitInt 0)) (= |newtype$check#0_0_0@1| (LitInt 3))) (= |newtype$check#0_0_0@1| (LitInt 7)))) (=> (or (or (= |newtype$check#0_0_0@1| (LitInt 0)) (= |newtype$check#0_0_0@1| (LitInt 3))) (= |newtype$check#0_0_0@1| (LitInt 7))) (=> (and (and (= |y#0@2| (LitInt 3)) (= |x#0@3| |x#0@1|)) (and (= |y#0@3| |y#0@2|) (= (ControlFlow 0 7) 5))) anon8_correct))))))
(let ((anon11_Else_correct  (=> (< |x#0@1| |y#0@1|) (=> (and (= |$decr$loop#00@1| (- |y#0@1| |x#0@1|)) (= |newtype$check#0_0@1| (LitInt 3))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (or (or (= |newtype$check#0_0@1| (LitInt 0)) (= |newtype$check#0_0@1| (LitInt 3))) (= |newtype$check#0_0@1| (LitInt 7)))) (=> (or (or (= |newtype$check#0_0@1| (LitInt 0)) (= |newtype$check#0_0@1| (LitInt 3))) (= |newtype$check#0_0@1| (LitInt 7))) (and (=> (= (ControlFlow 0 11) 7) anon12_Then_correct) (=> (= (ControlFlow 0 11) 9) anon12_Else_correct))))))))
(let ((anon11_Then_correct true))
(let ((anon10_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 13) 3) anon11_Then_correct) (=> (= (ControlFlow 0 13) 11) anon11_Else_correct)))))
...
)) (<= (- |y#0@1| |x#0@1|) |$decr_init$loop#00@0|))) (and (=> (= (ControlFlow 0 15) 1) anon9_LoopDone_correct) (=> (= (ControlFlow 0 15) 14) anon9_LoopBody_correct)))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (or (or (= |x#0@0| (LitInt 0)) (= |x#0@0| (LitInt 3))) (= |x#0@0| (LitInt 7))) (or (or (= |y#0@0| (LitInt 0)) (= |y#0@0| (LitInt 3))) (= |y#0@0| (LitInt 7)))) (and (= |$decr_init$loop#00@0| (- |y#0@0| |x#0@0|)) (= (ControlFlow 0 16) 15))) anon9_LoopHead_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (or (= |x#0| (LitInt 0)) (= |x#0| (LitInt 3))) (= |x#0| (LitInt 7))) true)) (and (and (or (or (= |y#0| (LitInt 0)) (= |y#0| (LitInt 3))) (= |y#0| (LitInt 7))) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 17) 16)))) anon0_correct)))
