...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType this Tclass.Members.DM) ($IsAlloc DatatypeTypeType this Tclass.Members.DM $Heap)) (= 0 $FunctionContextHeight)) (and (not (Members.DM.A_q this)) (= (ControlFlow 0 8) 6))) anon0_correct))))
