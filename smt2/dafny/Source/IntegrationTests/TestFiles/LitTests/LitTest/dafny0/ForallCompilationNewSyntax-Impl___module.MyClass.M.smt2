...
)) (forall ((|k#0_2@@0| Int) )  (=> (|Set#IsMember| |S#0@0| ($Box intType (int_2_U |k#0_2@@0|))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (MultiIndexField (IndexField |k#0_2@@0|) (LitInt 1))) ($Box intType (int_2_U (LitInt 0)))))))) (and (=> (= (ControlFlow 0 17) 16) anon9_Then_correct) (=> (= (ControlFlow 0 17) 7) anon9_Else_correct)))))
