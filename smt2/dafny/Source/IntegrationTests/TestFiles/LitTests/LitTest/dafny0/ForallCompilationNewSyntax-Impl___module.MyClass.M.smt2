...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon6_correct  (=> (and (|Set#IsMember| |S#0@0| ($Box intType (int_2_U |k#1_0@0|))) (|Set#IsMember| |S#0@0| ($Box intType (int_2_U |j#1_0@0|)))) (and (=> (= (ControlFlow 0 9) (- 0 13)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 9) (- 0 12)) (and (<= 0 |k#1_0@0|) (< |k#1_0@0| (_System.array2.Length0 $nw@0)))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (and (<= 0 |j#1_0@0|) (< |j#1_0@0| (_System.array2.Length1 $nw@0)))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (MultiIndexField (IndexField |k#1_0@0|) |j#1_0@0|)))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (MultiIndexField (IndexField |k#1_0@0|) |j#1_0@0|))) (=> (and (and (|Set#IsMember| |S#0@0| ($Box intType (int_2_U |k#1_1@0|))) (|Set#IsMember| |S#0@0| ($Box intType (int_2_U |j#1_1@0|)))) (and (not (and (= |k#1_0@0| |k#1_1@0|) (= |j#1_0@0| |j#1_1@0|))) (= (ControlFlow 0 9) (- 0 8)))) (or (or (or (not (= $nw@0 $nw@0)) (not true)) (or (not (= (MultiIndexField (IndexField |k#1_0@0|) |j#1_0@0|) (MultiIndexField (IndexField |k#1_1@0|) |j#1_1@0|))) (not true))) (= (LitInt 0) (LitInt 0)))))))))))))
(let ((anon10_Else_correct  (=> (and (not (|Set#IsMember| |S#0@0| ($Box intType (int_2_U |k#1_0@0|)))) (= (ControlFlow 0 15) 9)) anon6_correct)))
(let ((anon10_Then_correct  (=> (and (|Set#IsMember| |S#0@0| ($Box intType (int_2_U |k#1_0@0|))) (= (ControlFlow 0 14) 9)) anon6_correct)))
...
(let ((anon8_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) ($HeapSucc $Heap@0 $Heap@1)) (and (forall (($o@@10 T@U) ($f@@0 T@U) ) (!  (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@10) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@10) $f@@0)) (exists ((|k#0_2| Int) ) (!  (and (and (|Set#IsMember| |S#0@0| ($Box intType (int_2_U |k#0_2|))) (= $o@@10 $nw@0)) (= $f@@0 (MultiIndexField (IndexField |k#0_2|) (LitInt 1))))
 :qid |ForallCompilationNewSyntaxdfy.72:12|
 :skolemid |595|
)))
 :qid |ForallCompilationNewSyntaxdfy.72:5|
 :skolemid |596|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@10) $f@@0))
)) (forall ((|k#0_2@@0| Int) ) (!  (=> (|Set#IsMember| |S#0@0| ($Box intType (int_2_U |k#0_2@@0|))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (MultiIndexField (IndexField |k#0_2@@0|) (LitInt 1))) ($Box intType (int_2_U (LitInt 0)))))
 :qid |ForallCompilationNewSyntaxdfy.72:12|
 :skolemid |597|
)))) (and (=> (= (ControlFlow 0 17) 16) anon9_Then_correct) (=> (= (ControlFlow 0 17) 7) anon9_Else_correct)))))
(let ((anon8_Then_correct  (=> (|Set#IsMember| |S#0@0| ($Box intType (int_2_U |k#0_0@0|))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 |k#0_0@0|) (< |k#0_0@0| (_System.array2.Length0 $nw@0)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= 0 (LitInt 1)) (< (LitInt 1) (_System.array2.Length1 $nw@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (MultiIndexField (IndexField |k#0_0@0|) (LitInt 1))))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (MultiIndexField (IndexField |k#0_0@0|) (LitInt 1)))) (=> (|Set#IsMember| |S#0@0| ($Box intType (int_2_U |k#0_1@0|))) (=> (and (or (not (= |k#0_0@0| |k#0_1@0|)) (not true)) (= (ControlFlow 0 2) (- 0 1))) (or (or (or (not (= $nw@0 $nw@0)) (not true)) (or (not (= (MultiIndexField (IndexField |k#0_0@0|) (LitInt 1)) (MultiIndexField (IndexField |k#0_1@0|) (LitInt 1)))) (not true))) (= (LitInt 0) (LitInt 0))))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 18) (- 0 20)) (<= 0 (LitInt 3))) (=> (<= 0 (LitInt 3)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (<= 0 (LitInt 3))) (=> (<= 0 (LitInt 3)) (=> (and (and (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array2? TInt))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc))))) (and (= (_System.array2.Length0 $nw@0) (LitInt 3)) (= (_System.array2.Length1 $nw@0) (LitInt 3)))) (and (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true))))) ($IsGoodHeap $Heap@0)) (and ($IsHeapAnchor $Heap@0) (= |S#0@0| (Lit SetType (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U (LitInt 2)))) ($Box intType (int_2_U (LitInt 0))))))))) (and (=> (= (ControlFlow 0 18) 2) anon8_Then_correct) (=> (= (ControlFlow 0 18) 17) anon8_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.MyClass) ($IsAlloc refType this Tclass._module.MyClass $Heap)))) (and (and ($Is refType |ar#0| (Tclass._System.array2 TInt)) ($IsAlloc refType |ar#0| (Tclass._System.array2 TInt) $Heap)) true)) (and (and (and ($Is SetType |S#0| (TSet TInt)) ($IsAlloc SetType |S#0| (TSet TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 21) 18)))) anon0_correct)))
