...
(set-info :boogie-vc-id Impl$$TestModule9.__default.test4)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= StartFuel_TestModule9._default.abs ($LS ($LS ($LS ($LS ($LS BaseFuel_TestModule9._default.abs)))))) (=> (and (= StartFuelAssert_TestModule9._default.abs ($LS ($LS ($LS ($LS ($LS ($LS BaseFuel_TestModule9._default.abs))))))) (= (AsFuelBottom BaseFuel_TestModule9._default.abs) BaseFuel_TestModule9._default.abs)) (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) ($IsAlloc intType (int_2_U |z#0|) TInt $Heap)) (and (|TestModule9.__default.abs#canCall| |z#0|) (|TestModule9.__default.abs#canCall| |z#0|))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (TestModule9.__default.abs StartFuelAssert_TestModule9._default.abs |z#0|) (Mul (LitInt (- 0 1)) |z#0|))) (=> (and (and (= (TestModule9.__default.abs StartFuelAssert_TestModule9._default.abs |z#0|) (Mul (LitInt (- 0 1)) |z#0|)) ($IsAlloc intType (int_2_U |y#0|) TInt $Heap)) (and (|TestModule9.__default.abs#canCall| |y#0|) (|TestModule9.__default.abs#canCall| |y#0|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (TestModule9.__default.abs StartFuelAssert_TestModule9._default.abs |y#0|) |y#0|)) (=> (and (= (TestModule9.__default.abs StartFuelAssert_TestModule9._default.abs |y#0|) |y#0|) (= |##x#2@0| (LitInt (- 0 1)))) (=> (and (and ($IsAlloc intType (int_2_U |##x#2@0|) TInt $Heap) (|TestModule9.__default.abs#canCall| (LitInt (- 0 1)))) (and (|TestModule9.__default.abs#canCall| (LitInt (- 0 1))) (= (ControlFlow 0 2) (- 0 1)))) (= (LitInt (TestModule9.__default.abs StartFuelAssert_TestModule9._default.abs (LitInt (- 0 1)))) (LitInt 1))))))))))))
