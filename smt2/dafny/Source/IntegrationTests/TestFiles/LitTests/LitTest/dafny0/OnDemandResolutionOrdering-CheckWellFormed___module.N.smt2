...
(assert  (=> (< 0 $FunctionContextHeight) ($Is intType (int_2_U _module.__default.n) TInt)))
(assert (forall ((x@@5 T@U) (T@@1 T@T) ) (! (= ($Unbox T@@1 ($Box T@@1 x@@5)) x@@5)
 :qid |DafnyPreludebpl.167:18|
 :skolemid |3036|
 :pattern ( ($Box T@@1 x@@5))
)))
(assert (= _module.__default.n (LitInt 2)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon6_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (= (LitInt 2) _module.__default.n))))
