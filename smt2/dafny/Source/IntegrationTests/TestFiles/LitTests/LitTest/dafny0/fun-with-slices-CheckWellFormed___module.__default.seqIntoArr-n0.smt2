...
(assert (forall ((v@@5 T@U) (t0@@1 T@U) (h@@5 T@U) ) (! (= ($IsAlloc SeqType v@@5 (TSeq t0@@1) h@@5) (forall ((i@@1 Int) ) (!  (=> (and (<= 0 i@@1) (< i@@1 (|Seq#Length| v@@5))) ($IsAllocBox (|Seq#Index| v@@5 i@@1) t0@@1 h@@5))
 ...
 :skolemid |74|
 :pattern ( ($IsAlloc SeqType v@@5 (TSeq t0@@1) h@@5))
)))
...
(assert (forall ((h@@6 T@U) (a@@4 T@U) ) (! (= (|Seq#Length| (|Seq#FromArray| h@@6 a@@4)) (_System.array.Length a@@4))
 :qid |DafnyPreludebpl.1323:15|
 :skolemid |261|
 :pattern ( (|Seq#Length| (|Seq#FromArray| h@@6 a@@4)))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc |a#0|)) (and (=> (= (ControlFlow 0 2) (- 0 10)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (<= (+ |index#0| (|Seq#Length| |s#0|)) (_System.array.Length |a#0|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6)) (= $o@@6 |a#0|)))
 :qid |funwithslicesdfy.6:8|
 :skolemid |479|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6))
)) ($HeapSucc $Heap $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 7)) ($IsAlloc refType |a#0| (Tclass._System.array? _module._default.seqIntoArray$A) $Heap)) (=> ($IsAlloc refType |a#0| (Tclass._System.array? _module._default.seqIntoArray$A) $Heap) (and (=> (= (ControlFlow 0 2) (- 0 6)) (and (<= 0 (LitInt 0)) (<= (LitInt 0) (_System.array.Length |a#0|)))) (=> (and (<= 0 (LitInt 0)) (<= (LitInt 0) (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= (LitInt 0) |index#0|) (<= |index#0| (_System.array.Length |a#0|)))) (=> (and (<= (LitInt 0) |index#0|) (<= |index#0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |a#0| (Tclass._System.array? _module._default.seqIntoArray$A) $Heap)) (=> ($IsAlloc refType |a#0| (Tclass._System.array? _module._default.seqIntoArray$A) $Heap) (=> (= (ControlFlow 0 2) (- 0 1)) (and (<= 0 (+ |index#0| (|Seq#Length| |s#0|))) (<= (+ |index#0| (|Seq#Length| |s#0|)) (_System.array.Length |a#0|)))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SeqType |s#0| (TSeq _module._default.seqIntoArray$A)) ($IsAlloc SeqType |s#0| (TSeq _module._default.seqIntoArray$A) $Heap))) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array _module._default.seqIntoArray$A)) ($IsAlloc refType |a#0| (Tclass._System.array _module._default.seqIntoArray$A) $Heap)) (<= (LitInt 0) |index#0|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 11) 2))) anon0_correct))))
