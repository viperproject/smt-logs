...
(declare-fun _module.SeqOp.T4 (T@U Int) T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.SeqOp.T4#canCall| (T@U Int) Bool)
...
(assert  (and (= (Ctor refType) 3) (= (Ctor HandleTypeType) 4)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) (|n#0| Int) ) (!  (=> (or (|_module.SeqOp.T4#canCall| this |n#0|) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.SeqOp) ($IsAlloc refType this Tclass._module.SeqOp $Heap)))) (<= (LitInt 0) |n#0|)) (<= |n#0| (LitInt 20))))) (= (_module.SeqOp.T4 this |n#0|) (|Seq#Create| TReal $Heap |n#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#53| 20 2.5 this _module.SeqOp.x) (|lambda#125| TInt 20) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))))))
 :qid |ComprehensionsNewSyntaxdfy.150:12|
 :skolemid |657|
 :pattern ( (_module.SeqOp.T4 this |n#0|) ($IsGoodHeap $Heap))
))))
(assert (= (FDim alloc) 0))
...
))) (= (Ctor FieldType) 6)) (= (Ctor BoxType) 7)) (= (Ctor SetType) 8)))
(assert (forall ((t0@@1 T@U) (t1@@1 T@U) (heap T@U) (h T@U) (r T@U) (rd T@U) (bx0 T@U) (bx T@U) ) (! (= (|Set#IsMember| (Reads1 t0@@1 t1@@1 heap (Handle1 h r rd) bx0) bx) (|Set#IsMember| (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType rd heap bx0) bx))
 :qid |unknown.0:0|
 :skolemid |372|
 :pattern ( (|Set#IsMember| (Reads1 t0@@1 t1@@1 heap (Handle1 h r rd) bx0) bx))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@0 T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.SeqOp.T4#canCall| (Lit refType this@@0) (LitInt |n#0@@0|)) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.SeqOp) ($IsAlloc refType this@@0 Tclass._module.SeqOp $Heap@@0)))) (<= (LitInt 0) |n#0@@0|)) (<= (LitInt |n#0@@0|) (LitInt 20))))) (= (_module.SeqOp.T4 (Lit refType this@@0) (LitInt |n#0@@0|)) (|Seq#Create| TReal $Heap@@0 (LitInt |n#0@@0|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#53| 20 2.5 (Lit refType this@@0) _module.SeqOp.x) (|lambda#125| TInt 20) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))))))
 :qid |ComprehensionsNewSyntaxdfy.150:12|
 :weight 3
 :skolemid |659|
 :pattern ( (_module.SeqOp.T4 (Lit refType this@@0) (LitInt |n#0@@0|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@1 T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.SeqOp.T4#canCall| this@@1 (LitInt |n#0@@1|)) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.SeqOp) ($IsAlloc refType this@@1 Tclass._module.SeqOp $Heap@@1)))) (<= (LitInt 0) |n#0@@1|)) (<= (LitInt |n#0@@1|) (LitInt 20))))) (= (_module.SeqOp.T4 this@@1 (LitInt |n#0@@1|)) (|Seq#Create| TReal $Heap@@1 (LitInt |n#0@@1|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#53| 20 2.5 this@@1 _module.SeqOp.x) (|lambda#125| TInt 20) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))))))
 :qid |ComprehensionsNewSyntaxdfy.150:12|
 :weight 3
 :skolemid |658|
 :pattern ( (_module.SeqOp.T4 this@@1 (LitInt |n#0@@1|)) ($IsGoodHeap $Heap@@1))
))))
(assert (forall ((|l#0| T@U) (|l#1| Int) (|$l#0#heap#0| T@U) (|$l#0#i#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#125| |l#0| |l#1|) |$l#0#heap#0| |$l#0#i#0|))  (and ($IsBox |$l#0#i#0| |l#0|) (< (U_2_int ($Unbox intType |$l#0#i#0|)) |l#1|)))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |780|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#125| |l#0| |l#1|) |$l#0#heap#0| |$l#0#i#0|))
)))
...
(assert (forall ((|l#0@@0| Int) (|l#1@@0| Real) (|l#2| T@U) (|l#3| T@U) (|$l#0#heap#0@@0| T@U) (|$l#0#i#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#53| |l#0@@0| |l#1@@0| |l#2| |l#3|) |$l#0#heap#0@@0| |$l#0#i#0@@0|) ($Box realType (real_2_U (ite (< (U_2_int ($Unbox intType |$l#0#i#0@@0|)) |l#0@@0|) |l#1@@0| (U_2_real ($Unbox realType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |$l#0#heap#0@@0| |l#2|) |l#3|)))))))
 :qid |unknown.0:0|
 :skolemid |778|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#53| |l#0@@0| |l#1@@0| |l#2| |l#3|) |$l#0#heap#0@@0| |$l#0#i#0@@0|))
)))
...
(assert (forall ((|l#0@@1| Bool) (|$l#1#o#0| T@U) ) (! (= (U_2_bool (MapType1Select refType boolType (|lambda#16| |l#0@@1|) |$l#1#o#0|)) |l#0@@1|)
 :qid |unknown.0:0|
 :skolemid |771|
 :pattern ( (MapType1Select refType boolType (|lambda#16| |l#0@@1|) |$l#1#o#0|))
)))
(assert (forall ((|l#0@@2| T@U) (|$l#1#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#18| |l#0@@2|) |$l#1#ly#0|) |l#0@@2|)
 :qid |ComprehensionsNewSyntaxdfy.71:27|
 :skolemid |773|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#18| |l#0@@2|) |$l#1#ly#0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@2 T@U) (|n#0@@2| Int) ) (!  (=> (or (|_module.SeqOp.T4#canCall| this@@2 |n#0@@2|) (and (< 0 $FunctionContextHeight) (and (and (and (or (not (= this@@2 null)) (not true)) ($Is refType this@@2 Tclass._module.SeqOp)) (<= (LitInt 0) |n#0@@2|)) (<= |n#0@@2| (LitInt 20))))) ($Is SeqType (_module.SeqOp.T4 this@@2 |n#0@@2|) (TSeq TReal)))
 :qid |ComprehensionsNewSyntaxdfy.150:12|
 :skolemid |655|
 :pattern ( (_module.SeqOp.T4 this@@2 |n#0@@2|))
))))
...
(assert (forall (($h@@4 T@U) ($o@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (or (not (= $o@@4 null)) (not true)) (= (dtype $o@@4) Tclass._module.SeqOp?))) ($Is realType ($Unbox realType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@4 $o@@4) _module.SeqOp.x)) TReal))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |538|
 :pattern ( ($Unbox realType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@4 $o@@4) _module.SeqOp.x)))
)))
...
(assert (forall ((|l#0@@3| T@U) (|l#1@@1| T@U) (|l#2@@0| T@U) (|l#3@@0| Bool) ($o@@5 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@3| |l#1@@1| |l#2@@0| |l#3@@0|) $o@@5 $f))  (=> (and (or (not (= $o@@5 |l#0@@3|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@1| $o@@5) |l#2@@0|)))) |l#3@@0|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |759|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@3| |l#1@@1| |l#2@@0| |l#3@@0|) $o@@5 $f))
)))
...
(assert (forall ((|l#0@@4| T@U) (|$l#1#heap#0| T@U) (|$l#1#_v0#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#17| |l#0@@4|) |$l#1#heap#0| |$l#1#_v0#0|) |l#0@@4|)
 :qid |ComprehensionsNewSyntaxdfy.71:27|
 :skolemid |772|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#17| |l#0@@4|) |$l#1#heap#0| |$l#1#_v0#0|))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.SeqOp.T4)
...
(let ((anon16_Else_correct  (=> (<= 20 |i#0@0|) (and (=> (= (ControlFlow 0 9) (- 0 10)) (U_2_bool (MapType0Select refType FieldType boolType |$_Frame#l0@0| this@@3 _module.SeqOp.x))) (=> (U_2_bool (MapType0Select refType FieldType boolType |$_Frame#l0@0| this@@3 _module.SeqOp.x)) (=> (= |lambdaResult#0| (U_2_real ($Unbox realType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@2 this@@3) _module.SeqOp.x)))) (=> (and ($Is realType (real_2_U |lambdaResult#0|) TReal) (= (ControlFlow 0 9) 6)) anon9_correct)))))))
(let ((anon16_Then_correct  (=> (and (and (< |i#0@0| 20) (= |lambdaResult#0| (LitReal 2.5))) (and ($Is realType (real_2_U |lambdaResult#0|) TReal) (= (ControlFlow 0 8) 6))) anon9_correct)))
(let ((anon15_Then_correct  (=> (< |i#0@0| 20) (and (=> (= (ControlFlow 0 11) 8) anon16_Then_correct) (=> (= (ControlFlow 0 11) 9) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (<= 20 |i#0@0|) (= (ControlFlow 0 7) 6)) anon9_correct)))
(let ((anon14_Then_correct  (=> (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (and (=> (= (ControlFlow 0 12) 11) anon15_Then_correct) (=> (= (ControlFlow 0 12) 7) anon15_Else_correct)))))
(let ((anon14_Else_correct true))
(let ((anon13_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@2 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@2 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 13) 12) anon14_Then_correct) (=> (= (ControlFlow 0 13) 5) anon14_Else_correct)))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((|seqinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| |n#0@@3|)) (Requires1 TInt TReal $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#53| 20 2.5 this@@3 _module.SeqOp.x) (|lambda#125| TInt 20) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0|))))
 :qid |ComprehensionsNewSyntaxdfy.153:5|
 :skolemid |660|
))) (=> (and (and (= |b$reqreads#0@0| (forall ((|seqinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0@@0|) (< |seqinit#0#i0#0@@0| |n#0@@3|)) (forall (($o@@6 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@2 $o@@6) alloc)))) (|Set#IsMember| (Reads1 TInt TReal $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#53| 20 2.5 this@@3 _module.SeqOp.x) (|lambda#125| TInt 20) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0@@0|))) ($Box refType $o@@6))) (U_2_bool (MapType0Select refType FieldType boolType $_ReadsFrame@0 $o@@6 $f@@0)))
 :qid |ComprehensionsNewSyntaxdfy.153:5|
 :skolemid |661|
)))
 :qid |ComprehensionsNewSyntaxdfy.153:5|
 :skolemid |662|
))) (= (_module.SeqOp.T4 this@@3 |n#0@@3|) (|Seq#Create| TReal $Heap@@2 |n#0@@3| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#53| 20 2.5 this@@3 _module.SeqOp.x) (|lambda#125| TInt 20) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ)))))) (and ($Is SeqType (_module.SeqOp.T4 this@@3 |n#0@@3|) (TSeq TReal)) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|))))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= 0 |n#0@@3|)) (=> (<= 0 |n#0@@3|) (and (=> (= (ControlFlow 0 14) 13) anon13_Then_correct) (=> (= (ControlFlow 0 14) 3) anon13_Else_correct))))))
(let ((anon12_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (<= |n#0@@3| (LitInt 20))) (and (=> (= (ControlFlow 0 16) 1) anon12_Then_correct) (=> (= (ControlFlow 0 16) 14) anon12_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.SeqOp) ($IsAlloc refType this@@3 Tclass._module.SeqOp $Heap@@2))) (<= (LitInt 0) |n#0@@3|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 17) 16))) anon0_correct))))
