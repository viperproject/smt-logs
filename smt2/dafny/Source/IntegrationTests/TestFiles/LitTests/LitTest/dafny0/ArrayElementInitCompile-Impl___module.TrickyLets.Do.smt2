...
|fn#0|) ($Box intType (int_2_U |arrayinit#1#i0#0|)))))) (=> (and (forall ((|arrayinit#1#i0#0@@0| Int) ) (!  (=> (and (<= 0 |arrayinit#1#i0#0@@0|) (< |arrayinit#1#i0#0@@0| (let ((|n#0@@1| (LitInt 20)))
