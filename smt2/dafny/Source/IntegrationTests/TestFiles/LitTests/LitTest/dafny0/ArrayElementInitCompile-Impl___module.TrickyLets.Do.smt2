...
(assert (distinct TChar TInt TagChar TagInt TagSet alloc allocName Tagclass._System.nat Tagclass._System.object? Tagclass._System.object Tagclass._System.array? Tagclass._System.array Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 Tagclass._System.___hTotalFunc1 Tagclass._module.TrickyLets class._module.TrickyLets? Tagclass._module.TrickyLets? tytagFamily$nat tytagFamily$object tytagFamily$array |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1| |tytagFamily$_#TotalFunc1| tytagFamily$TrickyLets field$arr)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((|c#0@@1| T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType |c#0@@1| Tclass._module.TrickyLets $h@@2) ($IsAlloc refType |c#0@@1| Tclass._module.TrickyLets? $h@@2))
 :qid |unknown.0:0|
 :skolemid |649|
 :pattern ( ($IsAlloc refType |c#0@@1| Tclass._module.TrickyLets $h@@2))
 :pattern ( ($IsAlloc refType |c#0@@1| Tclass._module.TrickyLets? $h@@2))
)))
...
(assert (forall (($o@@3 T@U) ($h@@5 T@U) ) (! (= ($IsAlloc refType $o@@3 Tclass._module.TrickyLets? $h@@5)  (or (= $o@@3 null) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@5 $o@@3) alloc)))))
 :qid |unknown.0:0|
 :skolemid |617|
 :pattern ( ($IsAlloc refType $o@@3 Tclass._module.TrickyLets? $h@@5))
)))
...
(assert (forall ((|l#0@@0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@5 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#28| |l#0@@0| |l#1| |l#2| |l#3|) $o@@5 $f))  (=> (and (or (not (= $o@@5 |l#0@@0|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1| $o@@5) |l#2|)))) (= $o@@5 |l#3|)))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |669|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#28| |l#0@@0| |l#1| |l#2| |l#3|) $o@@5 $f))
)))
...
(assert (forall (($h@@7 T@U) ($o@@6 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@7) (and (or (not (= $o@@6 null)) (not true)) (= (dtype $o@@6) Tclass._module.TrickyLets?))) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@7 $o@@6) alloc)))) ($IsAlloc refType ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@7 $o@@6) _module.TrickyLets.arr)) (Tclass._System.array TChar) $h@@7))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |621|
 :pattern ( ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@7 $o@@6) _module.TrickyLets.arr)))
)))
...
(assert (forall ((|c#0@@4| T@U) ) (! (= ($Is refType |c#0@@4| Tclass._module.TrickyLets)  (and ($Is refType |c#0@@4| Tclass._module.TrickyLets?) (or (not (= |c#0@@4| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |648|
 :pattern ( ($Is refType |c#0@@4| Tclass._module.TrickyLets))
 :pattern ( ($Is refType |c#0@@4| Tclass._module.TrickyLets?))
)))
...
(assert (forall ((|l#0@@2| T@U) (|$l#1#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#5| |l#0@@2|) |$l#1#ly#0|) |l#0@@2|)
 :qid |ArrayElementInitCompiledfy.14:22|
 :skolemid |665|
...
(assert (forall ((_System.array$arg@@9 T@U) ($h@@10 T@U) ($o@@9 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@10) (and (or (not (= $o@@9 null)) (not true)) (= (dtype $o@@9) (Tclass._System.array? _System.array$arg@@9)))) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@10 $o@@9) alloc)))) ($IsAlloc intType (int_2_U (_System.array.Length $o@@9)) TInt $h@@10))
 :qid |unknown.0:0|
 :skolemid |360|
 :pattern ( (_System.array.Length $o@@9) ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@10 $o@@9) alloc)) (Tclass._System.array? _System.array$arg@@9))
)))
(assert (forall ((_System.array$arg@@10 T@U) ($h@@11 T@U) ($o@@10 T@U) ($i0@@0 Int) ) (!  (=> (and (and ($IsGoodHeap $h@@11) (and (or (not (= $o@@10 null)) (not true)) (= (dtype $o@@10) (Tclass._System.array? _System.array$arg@@10)))) (and (<= 0 $i0@@0) (< $i0@@0 (_System.array.Length $o@@10)))) ($IsBox (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@11 $o@@10) (IndexField $i0@@0)) _System.array$arg@@10))
 :qid |unknown.0:0|
 :skolemid |355|
 :pattern ( (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@11 $o@@10) (IndexField $i0@@0)) (Tclass._System.array? _System.array$arg@@10))
)))
...
(assert (forall ((|l#0@@3| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3@@0| Bool) ($o@@11 T@U) ($f@@0 T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@3| |l#1@@0| |l#2@@0| |l#3@@0|) $o@@11 $f@@0))  (=> (and (or (not (= $o@@11 |l#0@@3|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@0| $o@@11) |l#2@@0|)))) |l#3@@0|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |660|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@3| |l#1@@0| |l#2@@0| |l#3@@0|) $o@@11 $f@@0))
)))
...
(assert (forall (($h@@12 T@U) ($o@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (or (not (= $o@@12 null)) (not true)) (= (dtype $o@@12) Tclass._module.TrickyLets?))) ($Is refType ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@12 $o@@12) _module.TrickyLets.arr)) (Tclass._System.array TChar)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |620|
 :pattern ( ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@12 $o@@12) _module.TrickyLets.arr)))
)))
...
(assert (forall ((|l#0@@4| T@U) (|$l#1#heap#0@@0| T@U) (|$l#1#_v0#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#1| |l#0@@4|) |$l#1#heap#0@@0| |$l#1#_v0#0@@0|) |l#0@@4|)
 :qid |unknown.0:0|
 :skolemid |661|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#1| |l#0@@4|) |$l#1#heap#0@@0| |$l#1#_v0#0@@0|))
)))
(assert (forall ((|l#0@@5| T@U) (|$l#1#heap#0@@1| T@U) (|$l#1#_v0#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#4| |l#0@@5|) |$l#1#heap#0@@1| |$l#1#_v0#0@@1|) |l#0@@5|)
 :qid |ArrayElementInitCompiledfy.14:22|
 :skolemid |664|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#4| |l#0@@5|) |$l#1#heap#0@@1| |$l#1#_v0#0@@1|))
)))
...
(set-info :boogie-vc-id Impl$$_module.TrickyLets.Do)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 29) (let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (< |_v2#0@0| (LitInt 0)) (= (ControlFlow 0 24) 22)) anon3_correct)))
(let ((anon10_Then_correct  (=> (<= (LitInt 0) |_v2#0@0|) (=> (and (and (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (= |lambdaResult#0| (Lit charType (|char#FromInt| 68)))) (and ($Is charType |lambdaResult#0| TChar) (= (ControlFlow 0 23) 22))) anon3_correct))))
(let ((anon9_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 25) 23) anon10_Then_correct) (=> (= (ControlFlow 0 25) 24) anon10_Else_correct)))))
(let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (< |_v3#0@0| (LitInt 0)) (= (ControlFlow 0 10) 8)) anon7_correct)))
(let ((anon12_Then_correct  (=> (<= (LitInt 0) |_v3#0@0|) (=> (and (and (= |$_Frame#l1@0| (|lambda#0| null |$lambdaHeap#1@0| alloc false)) (= |lambdaResult#1| (Lit charType (|char#FromInt| 69)))) (and ($Is charType |lambdaResult#1| TChar) (= (ControlFlow 0 9) 8))) anon7_correct))))
(let ((anon11_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#1@0|) (or (= $Heap@1 |$lambdaHeap#1@0|) ($HeapSucc $Heap@1 |$lambdaHeap#1@0|))) (and (=> (= (ControlFlow 0 11) 9) anon12_Then_correct) (=> (= (ControlFlow 0 11) 10) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (= |let#2#0#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| ($Box charType (Lit charType (|char#FromInt| 69)))) (|lambda#2| Tclass._System.nat) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))) (=> (and ($Is HandleTypeType |let#2#0#0| (Tclass._System.___hTotalFunc1 Tclass._System.nat TChar)) (= |fn#Z#0@0| |let#2#0#0|)) (=> (and (and (or (not (= $nw@1 null)) (not true)) ($Is refType $nw@1 (Tclass._System.array? TChar))) (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@1) alloc)))) (= (_System.array.Length $nw@1) (let ((|n#0| (LitInt 20)))
|n#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (forall ((|arrayinit#1#i0#0| Int) ) (!  (=> (and (<= 0 |arrayinit#1#i0#0|) (< |arrayinit#1#i0#0| (let ((|n#0@@0| (LitInt 20)))
|n#0@@0|))) (Requires1 Tclass._System.nat TChar $Heap@1 (let ((|fn#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| ($Box charType (Lit charType (|char#FromInt| 69)))) (|lambda#2| Tclass._System.nat) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))))
|fn#0|) ($Box intType (int_2_U |arrayinit#1#i0#0|))))
 :qid |ArrayElementInitCompiledfy.123:31|
 :skolemid |640|
))) (=> (and (forall ((|arrayinit#1#i0#0@@0| Int) ) (!  (=> (and (<= 0 |arrayinit#1#i0#0@@0|) (< |arrayinit#1#i0#0@@0| (let ((|n#0@@1| (LitInt 20)))
|n#0@@1|))) (= ($Unbox charType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@1) (IndexField |arrayinit#1#i0#0@@0|))) ($Unbox charType (Apply1 Tclass._System.nat TChar $Heap@1 (let ((|fn#0@@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| ($Box charType (Lit charType (|char#FromInt| 69)))) (|lambda#2| Tclass._System.nat) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))))
|fn#0@@0|) ($Box intType (int_2_U |arrayinit#1#i0#0@@0|))))))
 :qid |ArrayElementInitCompiledfy.123:31|
 :skolemid |641|
 :pattern ( (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@1) (IndexField |arrayinit#1#i0#0@@0|)))
)) (= $Heap@2 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap@1 $nw@1 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@1) alloc ($Box boolType (bool_2_U true)))))) (=> (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (and (= $Heap@3 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap@2 (let ((|u#0| this))
|u#0|) (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 (let ((|u#0@@0| this))
|u#0@@0|)) _module.TrickyLets.arr ($Box refType $nw@1)))) ($IsGoodHeap $Heap@3))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 this) _module.TrickyLets.arr)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 this) _module.TrickyLets.arr)) null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 (LitInt 13)) (< (LitInt 13) (_System.array.Length ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 this) _module.TrickyLets.arr)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= ($Unbox charType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 this) _module.TrickyLets.arr))) (IndexField (LitInt 13)))) (Lit charType (|char#FromInt| 69)))) (=> (= ($Unbox charType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 this) _module.TrickyLets.arr))) (IndexField (LitInt 13)))) (Lit charType (|char#FromInt| 69))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 this) _module.TrickyLets.arr)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 this) _module.TrickyLets.arr)) null)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) (and (<= 0 (LitInt 13)) (< (LitInt 13) (_System.array.Length ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 this) _module.TrickyLets.arr)))))))))))))))))))))
(let ((anon9_Else_correct  (=> (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? TChar))) (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc)))) (= (_System.array.Length $nw@0) (LitInt 20)))) (and (=> (= (ControlFlow 0 12) (- 0 21)) (forall ((|arrayinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0|) (< |arrayinit#0#i0#0| (LitInt 20))) (Requires1 Tclass._System.nat TChar $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| ($Box charType (Lit charType (|char#FromInt| 68)))) (|lambda#2| Tclass._System.nat) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0|))))
 :qid |ArrayElementInitCompiledfy.119:17|
 :skolemid |638|
))) (=> (and (forall ((|arrayinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0@@0|) (< |arrayinit#0#i0#0@@0| (LitInt 20))) (= ($Unbox charType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) (IndexField |arrayinit#0#i0#0@@0|))) ($Unbox charType (Apply1 Tclass._System.nat TChar $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| ($Box charType (Lit charType (|char#FromInt| 68)))) (|lambda#2| Tclass._System.nat) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0@@0|))))))
 :qid |ArrayElementInitCompiledfy.119:17|
 :skolemid |639|
...
)) (= $Heap@0 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap $nw@0 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@1 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap@0 this (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 this) _module.TrickyLets.arr ($Box refType $nw@0)))) ($IsGoodHeap $Heap@1))) (and (=> (= (ControlFlow 0 12) (- 0 20)) (or (not (= ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 this) _module.TrickyLets.arr)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 this) _module.TrickyLets.arr)) null)) (not true)) (and (=> (= (ControlFlow 0 12) (- 0 19)) (and (<= 0 (LitInt 12)) (< (LitInt 12) (_System.array.Length ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 this) _module.TrickyLets.arr)))))) (and (=> (= (ControlFlow 0 12) (- 0 18)) (= ($Unbox charType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 this) _module.TrickyLets.arr))) (IndexField (LitInt 12)))) (Lit charType (|char#FromInt| 68)))) (=> (= ($Unbox charType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 this) _module.TrickyLets.arr))) (IndexField (LitInt 12)))) (Lit charType (|char#FromInt| 68))) (and (=> (= (ControlFlow 0 12) (- 0 17)) (or (not (= ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 this) _module.TrickyLets.arr)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 this) _module.TrickyLets.arr)) null)) (not true)) (and (=> (= (ControlFlow 0 12) (- 0 16)) (and (<= 0 (LitInt 12)) (< (LitInt 12) (_System.array.Length ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 this) _module.TrickyLets.arr)))))) (=> (= |let#0#0#0| this) (=> (and ($Is refType |let#0#0#0| Tclass._module.TrickyLets) (= |u#Z#0@0| |let#0#0#0|)) (and (=> (= (ControlFlow 0 12) (- 0 15)) (or (not (= (let ((|u#0@@1| this))
|u#0@@1|) null)) (not true))) (=> (or (not (= (let ((|u#0@@2| this))
|u#0@@2|) null)) (not true)) (and (=> (= (ControlFlow 0 12) (- 0 14)) (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 (let ((|u#0@@3| this))
|u#0@@3|) _module.TrickyLets.arr))) (=> (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 (let ((|u#0@@4| this))
|u#0@@4|) _module.TrickyLets.arr)) (=> (= |let#1#0#0| (LitInt 20)) (=> (and ($Is intType (int_2_U |let#1#0#0|) TInt) (= |n#Z#0@0| |let#1#0#0|)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= 0 (let ((|n#0@@2| (LitInt 20)))
|n#0@@2|))) (=> (<= 0 (let ((|n#0@@3| (LitInt 20)))
|n#0@@3|)) (and (=> (= (ControlFlow 0 12) 11) anon11_Then_correct) (=> (= (ControlFlow 0 12) 2) anon11_Else_correct))))))))))))))))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#28| null $Heap alloc this)) (and (=> (= (ControlFlow 0 26) (- 0 28)) (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 this _module.TrickyLets.arr))) (=> (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 this _module.TrickyLets.arr)) (and (=> (= (ControlFlow 0 26) (- 0 27)) (<= 0 (LitInt 20))) (=> (<= 0 (LitInt 20)) (and (=> (= (ControlFlow 0 26) 25) anon9_Then_correct) (=> (= (ControlFlow 0 26) 12) anon9_Else_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.TrickyLets) ($IsAlloc refType this Tclass._module.TrickyLets $Heap))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 29) 26))) anon0_correct))))
