...
(assert (forall ((TwoStateAt.OT$X@@2 T@U) (TwoStateAt.OT.F$Y@@2 T@U) ($prevHeap@@2 T@U) ($h0 T@U) ($h1 T@U) (this T@U) (|x#0| T@U) (|y#0| T@U) (|c#0@@1| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) ($IsBox this (Tclass.TwoStateAt.OT TwoStateAt.OT$X@@2))) (or (|TwoStateAt.OT.F#canCall| TwoStateAt.OT$X@@2 TwoStateAt.OT.F$Y@@2 $prevHeap@@2 $h0 this |x#0| |y#0| |c#0@@1|) (and (and ($IsBox |x#0| TwoStateAt.OT$X@@2) ($IsBox |y#0| TwoStateAt.OT.F$Y@@2)) ($Is refType |c#0@@1| Tclass.TwoStateAt.Cell)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@3 T@U) ($f@@0 T@U) )  (=> (and (or (not (= $o@@3 null)) (not true)) (= $o@@3 |c#0@@1|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@3) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@3) $f@@0)))) (= (TwoStateAt.OT.F TwoStateAt.OT$X@@2 TwoStateAt.OT.F$Y@@2 $prevHeap@@2 $h0 this |x#0| |y#0| |c#0@@1|) (TwoStateAt.OT.F TwoStateAt.OT$X@@2 TwoStateAt.OT.F$Y@@2 $prevHeap@@2 $h1 this |x#0| |y#0| |c#0@@1|))))
