...
(assert (distinct TInt TagInt alloc allocName Tagclass._System.___hFunc3 Tagclass.TwoStateAt.Cell Tagclass.TwoStateAt.Cell? class.TwoStateAt.Cell? |tytagFamily$_#Func3| tytagFamily$Cell field$data)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((TwoStateAt.OT$X@@2 T@U) (TwoStateAt.OT.F$Y@@2 T@U) ($prevHeap@@2 T@U) ($h0 T@U) ($h1 T@U) (this T@U) (|x#0| T@U) (|y#0| T@U) (|c#0@@1| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) ($IsBox this (Tclass.TwoStateAt.OT TwoStateAt.OT$X@@2))) (or (|TwoStateAt.OT.F#canCall| TwoStateAt.OT$X@@2 TwoStateAt.OT.F$Y@@2 $prevHeap@@2 $h0 this |x#0| |y#0| |c#0@@1|) (and (and ($IsBox |x#0| TwoStateAt.OT$X@@2) ($IsBox |y#0| TwoStateAt.OT.F$Y@@2)) ($Is refType |c#0@@1| Tclass.TwoStateAt.Cell)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@3 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@3 null)) (not true)) (= $o@@3 |c#0@@1|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@3) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@3) $f@@0)))
 :qid |unknown.0:0|
 :skolemid |872|
)) (= (TwoStateAt.OT.F TwoStateAt.OT$X@@2 TwoStateAt.OT.F$Y@@2 $prevHeap@@2 $h0 this |x#0| |y#0| |c#0@@1|) (TwoStateAt.OT.F TwoStateAt.OT$X@@2 TwoStateAt.OT.F$Y@@2 $prevHeap@@2 $h1 this |x#0| |y#0| |c#0@@1|))))
 :qid |unknown.0:0|
 :skolemid |873|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (TwoStateAt.OT.F TwoStateAt.OT$X@@2 TwoStateAt.OT.F$Y@@2 $prevHeap@@2 $h1 this |x#0| |y#0| |c#0@@1|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((TwoStateAt.OT$X@@5 T@U) (TwoStateAt.OT.F$Y@@5 T@U) ($prevHeap@@5 T@U) ($Heap@@0 T@U) (this@@1 T@U) (|x#0@@1| T@U) (|y#0@@1| T@U) (|c#0@@3| T@U) ) (!  (=> (or (|TwoStateAt.OT.F#canCall| TwoStateAt.OT$X@@5 TwoStateAt.OT.F$Y@@5 $prevHeap@@5 $Heap@@0 this@@1 |x#0@@1| |y#0@@1| |c#0@@3|) (and (< 1 $FunctionContextHeight) (and (and (and (and (and (and ($IsGoodHeap $prevHeap@@5) ($IsGoodHeap $Heap@@0)) ($HeapSucc $prevHeap@@5 $Heap@@0)) (and ($IsBox this@@1 (Tclass.TwoStateAt.OT TwoStateAt.OT$X@@5)) ($IsAllocBox this@@1 (Tclass.TwoStateAt.OT TwoStateAt.OT$X@@5) $prevHeap@@5))) ($IsBox |x#0@@1| TwoStateAt.OT$X@@5)) ($IsBox |y#0@@1| TwoStateAt.OT.F$Y@@5)) ($Is refType |c#0@@3| Tclass.TwoStateAt.Cell)))) (= (TwoStateAt.OT.F TwoStateAt.OT$X@@5 TwoStateAt.OT.F$Y@@5 $prevHeap@@5 $Heap@@0 this@@1 |x#0@@1| |y#0@@1| |c#0@@3|) (- (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |c#0@@3|) TwoStateAt.Cell.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@5 |c#0@@3|) TwoStateAt.Cell.data))))))
 :qid |unknown.0:0|
 :skolemid |876|
 :pattern ( (TwoStateAt.OT.F TwoStateAt.OT$X@@5 TwoStateAt.OT.F$Y@@5 $prevHeap@@5 $Heap@@0 this@@1 |x#0@@1| |y#0@@1| |c#0@@3|) ($IsGoodHeap $Heap@@0))
))))
...
(declare-fun TwoStateAt.OT.F$Y@@6 () T@U)
(declare-fun current$Heap () T@U)
(declare-fun this@@2 () T@U)
(declare-fun |x#0@@2| () T@U)
(declare-fun |y#0@@2| () T@U)
(declare-fun previous$Heap () T@U)
(set-info :boogie-vc-id CheckWellformed$$TwoStateAt.OT.F)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and ($IsBox this@@2 (Tclass.TwoStateAt.OT TwoStateAt.OT$X@@6)) ($IsAllocBox this@@2 (Tclass.TwoStateAt.OT TwoStateAt.OT$X@@6) previous$Heap))) (and (and ($IsBox |x#0@@2| TwoStateAt.OT$X@@6) ($IsAllocBox |x#0@@2| TwoStateAt.OT$X@@6 previous$Heap)) (and ($IsBox |y#0@@2| TwoStateAt.OT.F$Y@@6) ($IsAllocBox |y#0@@2| TwoStateAt.OT.F$Y@@6 previous$Heap)))) (and (and (and ($Is refType |c#0@@4| Tclass.TwoStateAt.Cell) ($IsAlloc refType |c#0@@4| Tclass.TwoStateAt.Cell previous$Heap)) (= 1 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@1) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 8) 7)))) anon0_correct)))
