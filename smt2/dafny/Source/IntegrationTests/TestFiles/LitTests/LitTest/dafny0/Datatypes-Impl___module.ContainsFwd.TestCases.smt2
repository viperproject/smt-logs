...
(declare-fun class._module.ContainsFwd? () T@U)
(declare-fun Tagclass._module.ContainsFwd? () T@U)
(declare-fun Tagclass._module.ContainsFwd () T@U)
(declare-fun tytagFamily$Fwd () T@U)
(declare-fun tytagFamily$ContainsFwd () T@U)
(declare-fun field$fwd () T@U)
...
(declare-fun Tclass._module.ContainsFwd? () T@U)
...
(declare-fun _module.ContainsFwd.fwd () T@U)
...
(assert (= (FDim _module.ContainsFwd.fwd) 0))
...
(assert (= (Tag Tclass._module.ContainsFwd?) Tagclass._module.ContainsFwd?))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon2_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (_module.Fwd.FwdNil_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.ContainsFwd.fwd))) (_module.Fwd.FwdCons_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.ContainsFwd.fwd)))))))
(let ((anon3_Else_correct  (=> (and (_module.Fwd.FwdNil_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.ContainsFwd.fwd))) (= (ControlFlow 0 4) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and (not (_module.Fwd.FwdNil_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.ContainsFwd.fwd)))) (= (ControlFlow 0 3) 2)) anon2_correct)))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.ContainsFwd) ($IsAlloc refType this Tclass._module.ContainsFwd $Heap))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 6) 5))) anon0_correct))))
