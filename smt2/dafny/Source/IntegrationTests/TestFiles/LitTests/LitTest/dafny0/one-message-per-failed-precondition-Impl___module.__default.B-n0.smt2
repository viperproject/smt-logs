...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let (($generated@@95  (=> (= $generated@@88 ($generated@@55 $generated@@89 $generated@@90 $generated@@5 false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (> $generated@@91 0)) (=> (> $generated@@91 0) (=> (= (ControlFlow 0 2) (- 0 1)) (< $generated@@91 0)))))))
(let (($generated@@96  (=> (and (and ($generated@@92 $generated@@90) ($generated@@93 $generated@@90)) (and (= 1 $generated@@94) (= (ControlFlow 0 4) 2))) $generated@@95)))
$generated@@96)))
))
(check-sat)
