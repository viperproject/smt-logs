...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let (($generated@@100 true))
(let (($generated@@101  (=> (and (<= ($generated 2) $generated@@91) (< $generated@@91 $generated@@92)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (not (= $generated@@91 0)) (not true))) (=> (or (not (= $generated@@91 0)) (not true)) (=> (and (or (not (= ($generated@@85 $generated@@92 $generated@@91) 0)) (not true)) (= (ControlFlow 0 6) 4)) $generated@@100))))))
(let (($generated@@102  (=> (and (< $generated@@91 ($generated 2)) (= (ControlFlow 0 9) 6)) $generated@@101)))
(let (($generated@@103  (=> (and (<= ($generated 2) $generated@@91) (= (ControlFlow 0 8) 6)) $generated@@101)))
(let (($generated@@104  (=> (and (=> (and (<= ($generated 2) $generated@@91) (< $generated@@91 $generated@@92)) (or (not (= ($generated@@85 $generated@@92 $generated@@91) 0)) (not true))) (= (ControlFlow 0 5) 4)) $generated@@100)))
(let (($generated@@105  (=> (<= ($generated 2) $generated@@92) (and (and (=> (= (ControlFlow 0 10) 5) $generated@@104) (=> (= (ControlFlow 0 10) 8) $generated@@103)) (=> (= (ControlFlow 0 10) 9) $generated@@102)))))
(let (($generated@@106  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= ($generated 2) ($generated 2))) (=> (= (ControlFlow 0 2) (- 0 1)) (forall (($generated@@107 Int) )  (=> (and (<= ($generated 2) $generated@@107) (< $generated@@107 2)) (or (not (= ($generated@@85 2 $generated@@107) 0)) (not true))))))))
(let (($generated@@108  (=> (= $generated@@93 ($generated@@29 $generated@@94 $generated@@95 $generated@@96 false)) (and (=> (= (ControlFlow 0 11) 10) $generated@@105) (=> (= (ControlFlow 0 11) 2) $generated@@106)))))
(let (($generated@@109  (=> (and (and ($generated@@97 $generated@@95) ($generated@@98 $generated@@95)) (and (= 0 $generated@@99) (= (ControlFlow 0 12) 11))) $generated@@108)))
$generated@@109))))))))))
))
(check-sat)
(get-info :rlimit)
