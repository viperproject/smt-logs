...
(set-info :boogie-vc-id CheckWellformed$$Nested.__default.ABC0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 8)) (or (<= 0 (LitInt 6)) (= (LitInt 7) (LitInt 6)))) (=> (or (<= 0 (LitInt 6)) (= (LitInt 7) (LitInt 6))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (< (LitInt 7) (LitInt 6))) (=> (< (LitInt 7) (LitInt 6)) (=> |Nested.__default.C#canCall| (=> (and (= |##x#1@0| (LitInt (Nested.__default.C ($LS $LZ)))) ($IsAlloc intType (int_2_U |##x#1@0|) Tclass._System.nat $Heap)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (<= 0 (LitInt 6)) (= |##x#1@0| (LitInt 6)))) (=> (or (<= 0 (LitInt 6)) (= |##x#1@0| (LitInt 6))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (< |##x#1@0| (LitInt 6))) (=> (< |##x#1@0| (LitInt 6)) (=> (|Nested.__default.B#canCall| (LitInt (Nested.__default.C ($LS $LZ)))) (=> (and (= |##x#0@0| (Nested.__default.B ($LS $LZ) (LitInt (Nested.__default.C ($LS $LZ))))) ($IsAlloc intType (int_2_U |##x#0@0|) Tclass._System.nat $Heap)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (<= 0 (LitInt 6)) (= |##x#0@0| (LitInt 6)))) (=> (or (<= 0 (LitInt 6)) (= |##x#0@0| (LitInt 6))) (=> (= (ControlFlow 0 3) (- 0 2)) (< |##x#0@0| (LitInt 6)))))))))))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 9) 1) anon5_Then_correct) (=> (= (ControlFlow 0 9) 3) anon5_Else_correct)))))
