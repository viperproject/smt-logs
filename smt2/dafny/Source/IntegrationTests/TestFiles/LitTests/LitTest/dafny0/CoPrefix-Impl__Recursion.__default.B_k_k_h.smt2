...
(set-info :boogie-vc-id Impl$$Recursion.__default.B_k_k_h)
...
(let ((anon6_Then_correct  (=> (and (< 0 |x#1|) (= |x##0@0| (- |x#1| 1))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (or (<= 0 |x#1|) (|ORD#Less| |_k#0| |_k#0|)) (= |x##0@0| |x#1|))) (=> (or (or (<= 0 |x#1|) (|ORD#Less| |_k#0| |_k#0|)) (= |x##0@0| |x#1|)) (=> (= (ControlFlow 0 3) (- 0 2)) (or (|ORD#Less| |_k#0| |_k#0|) (and (= |_k#0| |_k#0|) (< |x##0@0| |x#1|)))))))))
(let ((anon5_Then_correct  (=> (< 0 (|ORD#Offset| |_k#0|)) (and (=> (= (ControlFlow 0 6) 3) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 7) 6) anon5_Then_correct) (=> (= (ControlFlow 0 7) 1) anon5_Else_correct)))))
