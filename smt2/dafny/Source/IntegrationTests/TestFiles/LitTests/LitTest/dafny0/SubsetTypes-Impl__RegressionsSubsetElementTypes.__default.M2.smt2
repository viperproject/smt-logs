...
(set-info :boogie-vc-id Impl$$RegressionsSubsetElementTypes.__default.M2)
...
(let ((anon11_Then_correct  (=> (= (ControlFlow 0 10) (- 0 9)) ($Is MapType |m#0| (TMap Tclass.RegressionsSubsetElementTypes.byte Tclass.RegressionsSubsetElementTypes.byte)))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 8) (- 0 7)) ($Is MultiSetType |u#0| (TMultiSet Tclass.RegressionsSubsetElementTypes.byte)))))
(let ((anon9_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) ($Is SetType |t#0| (TSet Tclass.RegressionsSubsetElementTypes.byte)))))
(let ((anon8_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) ($Is SeqType |s#0| (TSeq Tclass.RegressionsSubsetElementTypes.byte)))))
(let ((anon7_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) ($Is intType (int_2_U |x#0@@1|) Tclass.RegressionsSubsetElementTypes.byte))))
