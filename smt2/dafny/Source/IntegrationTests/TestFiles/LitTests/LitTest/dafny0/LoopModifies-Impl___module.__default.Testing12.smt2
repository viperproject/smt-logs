...
(set-info :boogie-vc-id Impl$$_module.__default.Testing12)
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#21| null $Heap alloc |a#0| |b#0| |c#0@@1|)) (=> (and (= |i#0@0| (LitInt 0)) (= |S#0@0| (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |a#0|)) ($Box refType |b#0|)) ($Box refType |c#0@@1|)))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (forall (($o@@7 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@7) alloc)))) (|Set#IsMember| |S#0@0| ($Box refType $o@@7))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@7 $f@@2)))
 :qid |LoopModifiesdfy.307:4|
 :skolemid |581|
))) (=> (forall (($o@@8 T@U) ($f@@3 T@U) ) (!  (=> (and (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@8) alloc)))) (|Set#IsMember| |S#0@0| ($Box refType $o@@8))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@8 $f@@3)))
 :qid |LoopModifiesdfy.307:4|
 :skolemid |581|
)) (=> (and (= |$Frame$loop#0@0| (|lambda#45| null $Heap alloc |S#0@0|)) (= (ControlFlow 0 20) 19)) anon8_LoopHead_correct)))))))
