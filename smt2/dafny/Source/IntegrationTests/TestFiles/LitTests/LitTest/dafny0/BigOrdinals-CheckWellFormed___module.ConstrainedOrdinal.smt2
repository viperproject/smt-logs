...
(set-info :boogie-vc-id CheckWellFormed$$_module.ConstrainedOrdinal)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon6_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (U_2_bool (Lit boolType (bool_2_U  (or (not (= (|ORD#FromNat| 0) (|ORD#FromNat| 16))) (not true))))))))
