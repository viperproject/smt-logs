...
(set-info :boogie-vc-id CheckWellFormed$$_module.Tree.EvensSumToEvenAutoInduction_split1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType this@@3 Tclass._module.Tree) ($IsAlloc DatatypeTypeType this@@3 Tclass._module.Tree $Heap)) (and (= 2 $FunctionContextHeight) (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)))) (and (and ($IsAllocBox ($Box DatatypeTypeType this@@3) Tclass._module.Tree $Heap) (|_module.Tree.Elements#canCall| this@@3)) (and (|Set#IsMember| (_module.Tree.Elements ($LS $LZ) this@@3) ($Box intType (int_2_U |u#0@0|))) (= (ControlFlow 0 2) (- 0 1))))) (or (not (= (LitInt 2) 0)) (not true))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
