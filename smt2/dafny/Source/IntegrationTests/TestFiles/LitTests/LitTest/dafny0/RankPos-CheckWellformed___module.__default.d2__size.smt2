...
(declare-fun |ds#Z#0@0| () T@U)
(declare-fun $Heap () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$_module.__default.d2__size)
...
(let ((anon10_Then_correct  (=> (= |x#0@@2| (|#_module.d2.B2| |_mcc#0#0|)) (=> (and ($Is SeqType |_mcc#0#0| (TSeq Tclass._module.d2)) (= |let#0#0#0| |_mcc#0#0|)) (=> (and (and ($Is SeqType |let#0#0#0| (TSeq Tclass._module.d2)) (= |ds#Z#0@0| |let#0#0#0|)) (and ($IsAlloc SeqType |ds#Z#0@0| (TSeq Tclass._module.d2) $Heap) (= (ControlFlow 0 4) (- 0 3)))) (< (|Seq#Rank| |ds#Z#0@0|) (DtRank |x#0@@2|)))))))
(let ((anon9_Else_correct  (=> (or (not (= |x#0@@2| |#_module.d2.A2|)) (not true)) (and (=> (= (ControlFlow 0 6) 4) anon10_Then_correct) (=> (= (ControlFlow 0 6) 5) anon10_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |x#0@@2| Tclass._module.d2)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct)))
