...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon6_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((|i#3| Int) ) (!  (=> (and (<= (LitInt 0) |i#3|) (< |i#3| 100)) (or (U_2_bool ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |a#0|) ($Box intType (int_2_U |i#3|))))) (U_2_bool ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |b#0|) ($Box intType (int_2_U |i#3|)))))))
 :qid |Mapsdfy.68:18|
 :skolemid |545|
 :pattern ( ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |b#0|) ($Box intType (int_2_U |i#3|)))))
 :pattern ( ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |a#0|) ($Box intType (int_2_U |i#3|)))))
)))))
(let ((anon10_Else_correct  (=> (and (U_2_bool ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |a#0|) ($Box intType (int_2_U |i#2@0|))))) (= (ControlFlow 0 7) 3)) anon6_correct)))
(let ((anon10_Then_correct  (=> (not (U_2_bool ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |a#0|) ($Box intType (int_2_U |i#2@0|)))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (|Set#IsMember| (|Map#Domain| |b#0|) ($Box intType (int_2_U |i#2@0|)))) (=> (= (ControlFlow 0 5) 3) anon6_correct)))))
(let ((anon9_Then_correct  (=> (and (<= (LitInt 0) |i#2@0|) (< |i#2@0| 100)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (|Set#IsMember| (|Map#Domain| |a#0|) ($Box intType (int_2_U |i#2@0|)))) (and (=> (= (ControlFlow 0 8) 5) anon10_Then_correct) (=> (= (ControlFlow 0 8) 7) anon10_Else_correct))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is MapType |a#0| (TMap TInt TBool)) ($IsAlloc MapType |a#0| (TMap TInt TBool) $Heap))) (=> (and (and (and ($Is MapType |b#0| (TMap TInt TBool)) ($IsAlloc MapType |b#0| (TMap TInt TBool) $Heap)) (= 0 $FunctionContextHeight)) (and (forall ((|i#1| T@U) ) (!  (=> (and (<= (LitInt 0) (U_2_int |i#1|)) (< (U_2_int |i#1|) 100)) (and (and (|Set#IsMember| (|Map#Domain| |a#0|) ($Box intType |i#1|)) (|Set#IsMember| (|Map#Domain| |b#0|) ($Box intType |i#1|))) (= (U_2_bool ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |a#0|) ($Box intType |i#1|))))  (not (U_2_bool ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |b#0|) ($Box intType |i#1|))))))))
 :qid |Mapsdfy.66:20|
 :skolemid |542|
 :pattern ( ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |b#0|) ($Box intType |i#1|))))
 :pattern ( ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |a#0|) ($Box intType |i#1|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| |b#0|) ($Box intType |i#1|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#0|) ($Box intType |i#1|)))
