...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#1| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 16) 1) anon13_Then_correct) (=> (= (ControlFlow 0 16) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 16) 15) anon14_Else_correct)))))
