...
(declare-fun |x#0@@11| () T@U)
(declare-fun |y#0@0| () T@U)
(declare-fun $LZ () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |y#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.OneMore)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (_module.natinf.N_q |x#0@@11|)) (=> (_module.natinf.N_q |x#0@@11|) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($Is intType (int_2_U (+ (_module.natinf.n |x#0@@11|) 2)) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ (_module.natinf.n |x#0@@11|) 2)) Tclass._System.nat) (=> (and (and (= |y#0@0| (|#_module.natinf.N| (+ (_module.natinf.n |x#0@@11|) 2))) (= (ControlFlow 0 2) (- 0 1))) (|_module.__default.Even#canCall| |y#0@0|)) (or (_module.__default.Even ($LS $LZ) |y#0@0|) (or (and (_module.natinf.N_q |y#0@0|) (= (_module.natinf.n |y#0@0|) (LitInt 0))) (and (and (_module.natinf.N_q |y#0@0|) (<= (LitInt 2) (_module.natinf.n |y#0@0|))) (_module.__default.Even ($LS ($LS $LZ)) (|#_module.natinf.N| (- (_module.natinf.n |y#0@0|) 2))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |x#0@@11| Tclass._module.natinf) ($IsAlloc DatatypeTypeType |x#0@@11| Tclass._module.natinf $Heap)) (|$IsA#_module.natinf| |x#0@@11|)) (=> (and (and (and ($Is DatatypeTypeType |y#0| Tclass._module.natinf) ($IsAlloc DatatypeTypeType |y#0| Tclass._module.natinf $Heap)) (= 2 $FunctionContextHeight)) (and (and (|_module.__default.Even#canCall| |x#0@@11|) (and (_module.__default.Even ($LS $LZ) |x#0@@11|) (or (and (_module.natinf.N_q |x#0@@11|) (= (_module.natinf.n |x#0@@11|) (LitInt 0))) (and (and (_module.natinf.N_q |x#0@@11|) (<= (LitInt 2) (_module.natinf.n |x#0@@11|))) (_module.__default.Even ($LS $LZ) (|#_module.natinf.N| (- (_module.natinf.n |x#0@@11|) 2))))))) (= (ControlFlow 0 5) 2))) anon0_correct)))))
