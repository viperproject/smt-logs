...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) |j#0|)) (=> (<= (LitInt 0) |j#0|) (=> (= (ControlFlow 0 2) (- 0 1)) ($Is intType (int_2_U |j#0|) Tclass._System.nat)))))))
