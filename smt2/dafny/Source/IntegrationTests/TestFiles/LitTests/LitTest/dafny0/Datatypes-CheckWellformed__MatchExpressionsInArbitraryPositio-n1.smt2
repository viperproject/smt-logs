...
(assert (forall ((MatchExpressionsInArbitraryPositions.List$T@@2 T@U) ) (! (= (Tclass.MatchExpressionsInArbitraryPositions.List_0 (Tclass.MatchExpressionsInArbitraryPositions.List MatchExpressionsInArbitraryPositions.List$T@@2)) MatchExpressionsInArbitraryPositions.List$T@@2)
 :qid |unknown.0:0|
 :skolemid |589|
 :pattern ( (Tclass.MatchExpressionsInArbitraryPositions.List MatchExpressionsInArbitraryPositions.List$T@@2))
)))
...
(assert (forall ((MatchExpressionsInArbitraryPositions.List$T@@3 T@U) (bx@@0 T@U) ) (!  (=> ($IsBox bx@@0 (Tclass.MatchExpressionsInArbitraryPositions.List MatchExpressionsInArbitraryPositions.List$T@@3)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@0)) bx@@0) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@0) (Tclass.MatchExpressionsInArbitraryPositions.List MatchExpressionsInArbitraryPositions.List$T@@3))))
 :qid |unknown.0:0|
 :skolemid |590|
 :pattern ( ($IsBox bx@@0 (Tclass.MatchExpressionsInArbitraryPositions.List MatchExpressionsInArbitraryPositions.List$T@@3)))
)))
...
(set-info :boogie-vc-id CheckWellformed$$MatchExpressionsInArbitraryPositions.__default.J)
...
(let ((anon10_Then_correct  (=> (and (= |xs#0| |#MatchExpressionsInArbitraryPositions.List.Nil|) (= (ControlFlow 0 5) (- 0 4))) false)))
(let ((anon9_Else_correct  (=> (or (not (= |xs#0| (|#MatchExpressionsInArbitraryPositions.List.Cons| |a#1#0#0@0| |a#1#1#0@0|))) (not true)) (and (=> (= (ControlFlow 0 7) 5) anon10_Then_correct) (=> (= (ControlFlow 0 7) 6) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> (and (= |xs#0| (|#MatchExpressionsInArbitraryPositions.List.Cons| |a#1#0#0@0| |a#1#1#0@0|)) (= (ControlFlow 0 3) (- 0 2))) false)))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 8) 3) anon9_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |xs#0| (Tclass.MatchExpressionsInArbitraryPositions.List TInt))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct)))
