...
(declare-fun |b#0@2| () (_ BitVec 3))
(declare-fun |a#0@2| () (_ BitVec 3))
(declare-fun |a#0@1| () (_ BitVec 3))
(declare-fun |a#0@0| () (_ BitVec 3))
(declare-fun |b#0@0| () (_ BitVec 3))
(declare-fun |b#0@1| () (_ BitVec 3))
(declare-fun |$w$loop#0@0| () Bool)
(declare-fun $Heap () T@U)
(declare-fun null () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun |$decr_init$loop#00@0| () Int)
(declare-fun |B#0| () (_ BitVec 3))
(declare-fun |A#0| () (_ BitVec 3))
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.Bitvectors0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon8_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (<= 0 |$decr$loop#00@1|) (= (- (nat_from_bv3 |b#0@2|) (nat_from_bv3 |a#0@2|)) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- (nat_from_bv3 |b#0@2|) (nat_from_bv3 |a#0@2|)) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 5) (- 0 4)) (< (- (nat_from_bv3 |b#0@2|) (nat_from_bv3 |a#0@2|)) |$decr$loop#00@1|))))))
(let ((anon12_Else_correct  (=> (and (and (= |a#0@1| (bvadd |a#0@0| #b001)) (= |a#0@2| |a#0@1|)) (and (= |b#0@2| |b#0@0|) (= (ControlFlow 0 8) 5))) anon8_correct)))
(let ((anon12_Then_correct  (=> (and (and (= |b#0@1| (bvsub |b#0@0| #b001)) (= |a#0@2| |a#0@0|)) (and (= |b#0@2| |b#0@1|) (= (ControlFlow 0 7) 5))) anon8_correct)))
(let ((anon11_Else_correct  (=> (and (bvult |a#0@0| |b#0@0|) (= |$decr$loop#00@1| (- (nat_from_bv3 |b#0@0|) (nat_from_bv3 |a#0@0|)))) (and (=> (= (ControlFlow 0 9) 7) anon12_Then_correct) (=> (= (ControlFlow 0 9) 8) anon12_Else_correct)))))
...
)) (<= (- (nat_from_bv3 |b#0@0|) (nat_from_bv3 |a#0@0|)) |$decr_init$loop#00@0|))) (and (=> (= (ControlFlow 0 12) 1) anon9_LoopDone_correct) (=> (= (ControlFlow 0 12) 11) anon9_LoopBody_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |$decr_init$loop#00@0| (- (nat_from_bv3 |B#0|) (nat_from_bv3 |A#0|))) (= (ControlFlow 0 13) 12)) anon9_LoopHead_correct))))
