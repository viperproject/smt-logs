...
(assert (distinct alloc Tagclass.ReadsAndDecreases.C Tagclass.ReadsAndDecreases.C? tytagFamily$C)
)
...
(set-info :boogie-vc-id CheckWellformed$$ReadsAndDecreases.C.NB)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and ($IsAllocBox ($Box refType this) Tclass.ReadsAndDecreases.C? $Heap) (= (ControlFlow 0 2) (- 0 1))) false))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass.ReadsAndDecreases.C) ($IsAlloc refType this Tclass.ReadsAndDecreases.C $Heap))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
