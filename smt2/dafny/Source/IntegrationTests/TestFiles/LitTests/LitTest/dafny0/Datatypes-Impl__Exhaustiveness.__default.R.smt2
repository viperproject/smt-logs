...
(set-info :boogie-vc-id Impl$$Exhaustiveness.__default.R)
...
(let ((anon9_Then_correct  (=> (and (and (and (not (|Exhaustiveness.Color#Equal| |c#0@0| |#Exhaustiveness.Color.A|)) (not (|Exhaustiveness.Color#Equal| |c#0@0| |#Exhaustiveness.Color.B|))) (not (|Exhaustiveness.Color#Equal| |c#0@0| |#Exhaustiveness.Color.C|))) (= (ControlFlow 0 2) (- 0 1))) (U_2_bool (Lit boolType (bool_2_U false))))))
(let ((anon4_correct  (=> (and (|$IsA#Exhaustiveness.Color| |c#0@0|) (=> (not (|Exhaustiveness.Color#Equal| |c#0@0| |#Exhaustiveness.Color.A|)) (and (|$IsA#Exhaustiveness.Color| |c#0@0|) (=> (not (|Exhaustiveness.Color#Equal| |c#0@0| |#Exhaustiveness.Color.B|)) (|$IsA#Exhaustiveness.Color| |c#0@0|))))) (and (=> (= (ControlFlow 0 4) 2) anon9_Then_correct) (=> (= (ControlFlow 0 4) 3) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (not (and (not (|Exhaustiveness.Color#Equal| |c#0@0| |#Exhaustiveness.Color.A|)) (not (|Exhaustiveness.Color#Equal| |c#0@0| |#Exhaustiveness.Color.B|)))) (= (ControlFlow 0 6) 4)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (and (not (|Exhaustiveness.Color#Equal| |c#0@0| |#Exhaustiveness.Color.A|)) (not (|Exhaustiveness.Color#Equal| |c#0@0| |#Exhaustiveness.Color.B|))) (= (ControlFlow 0 5) 4)) anon4_correct)))
(let ((anon7_Else_correct  (=> (|Exhaustiveness.Color#Equal| |c#0@0| |#Exhaustiveness.Color.A|) (and (=> (= (ControlFlow 0 8) 5) anon8_Then_correct) (=> (= (ControlFlow 0 8) 6) anon8_Else_correct)))))
(let ((anon7_Then_correct  (=> (not (|Exhaustiveness.Color#Equal| |c#0@0| |#Exhaustiveness.Color.A|)) (and (=> (= (ControlFlow 0 7) 5) anon8_Then_correct) (=> (= (ControlFlow 0 7) 6) anon8_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (and (<= 0 |i#0|) (< |i#0| (|Seq#Length| |s#0|)))) (=> (and (<= 0 |i#0|) (< |i#0| (|Seq#Length| |s#0|))) (=> (= |c#0@0| ($Unbox DatatypeTypeType (|Seq#Index| |s#0| |i#0|))) (and (=> (= (ControlFlow 0 9) 7) anon7_Then_correct) (=> (= (ControlFlow 0 9) 8) anon7_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SeqType |s#0| (TSeq Tclass.Exhaustiveness.Color)) ($IsAlloc SeqType |s#0| (TSeq Tclass.Exhaustiveness.Color) $Heap))) (=> (and (and (and ($Is DatatypeTypeType |c#0| Tclass.Exhaustiveness.Color) ($IsAlloc DatatypeTypeType |c#0| Tclass.Exhaustiveness.Color $Heap)) true) (and (and (= 1 $FunctionContextHeight) (<= (LitInt 0) |i#0|)) (and (< |i#0| (|Seq#Length| |s#0|)) (= (ControlFlow 0 11) 9)))) anon0_correct))))
