...
(assert (distinct TBool TagBool TagSet alloc Tagclass._module.BoxTests? Tagclass._module.BoxTests tytagFamily$BoxTests)
)
...
(set-info :boogie-vc-id Impl$$_module.BoxTests.LemmaSet4)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass._module.BoxTests _module.BoxTests$G@@9)) ($IsAlloc refType this (Tclass._module.BoxTests _module.BoxTests$G@@9) $Heap))) (and ($Is SetType |a#0| (TSet TBool)) ($IsAlloc SetType |a#0| (TSet TBool) $Heap))) (=> (and (and (and ($Is SetType |b#0| (TSet TBool)) ($IsAlloc SetType |b#0| (TSet TBool) $Heap)) (= 0 $FunctionContextHeight)) (and (forall ((|x#1| T@U) ) (!  (=> (|Set#IsMember| |a#0| ($Box boolType |x#1|)) (|Set#IsMember| |b#0| ($Box boolType |x#1|)))
 :qid |MultiSetsdfy.135:21|
 :skolemid |629|
 :pattern ( (|Set#IsMember| |b#0| ($Box boolType |x#1|)))
 :pattern ( (|Set#IsMember| |a#0| ($Box boolType |x#1|)))
