...
axiom 0 <= $FunctionContextHeight
   ==> (forall a#0: Box :: 
    ...
    VariationsOnPlurals.__default.One__None#canCall(a#0)
         || (0 < $FunctionContextHeight && $IsBox(a#0, Tclass.VariationsOnPlurals.X()))
...
procedure {:verboseName "VariationsOnPlurals.One_None (well-formedness)"} CheckWellformed$$VariationsOnPlurals.__default.One__None(a#0: Box where $IsBox(a#0, Tclass.VariationsOnPlurals.X()));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "VariationsOnPlurals.One_None (well-formedness)"} CheckWellformed$$VariationsOnPlurals.__default.One__None(a#0: Box)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    else
    {
        ...
        assume {:id "id149"} VariationsOnPlurals.__default.One__None(a#0) == Lit(true);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(VariationsOnPlurals.__default.One__None(a#0), TBool);
        return;
...
procedure {:verboseName "VariationsOnPlurals.One_One (well-formedness)"} CheckWellformed$$VariationsOnPlurals.__default.One__One(a#0: Box where $IsBox(a#0, Tclass.VariationsOnPlurals.X()), 
    b#0: Box where $IsBox(b#0, Tclass.VariationsOnPlurals.X()));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  ensures (forall $olderHeap: Heap :: 
    { $OlderTag($olderHeap) } 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "VariationsOnPlurals.One_One (well-formedness)"} CheckWellformed$$VariationsOnPlurals.__default.One__One(a#0: Box, b#0: Box)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    {
        // Check well-formedness of body and result subset type constraint
        assume {:id "id152"} VariationsOnPlurals.__default.One__One(a#0, b#0) == Lit(true);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(VariationsOnPlurals.__default.One__One(a#0, b#0), TBool);
        return;
...
axiom 0 <= $FunctionContextHeight
   ==> (forall a#0: Box, b#0: Box, c#0: Box :: 
...
procedure {:verboseName "VariationsOnPlurals.One_Many (well-formedness)"} CheckWellformed$$VariationsOnPlurals.__default.One__Many(a#0: Box where $IsBox(a#0, Tclass.VariationsOnPlurals.X()), 
    b#0: Box where $IsBox(b#0, Tclass.VariationsOnPlurals.X()), 
    c#0: Box where $IsBox(c#0, Tclass.VariationsOnPlurals.X()));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  ensures (forall $olderHeap: Heap :: 
    { $OlderTag($olderHeap) } 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "VariationsOnPlurals.One_Many (well-formedness)"} CheckWellformed$$VariationsOnPlurals.__default.One__Many(a#0: Box, b#0: Box, c#0: Box)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    {
        // Check well-formedness of body and result subset type constraint
        assume {:id "id155"} VariationsOnPlurals.__default.One__Many(a#0, b#0, c#0) == Lit(true);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(VariationsOnPlurals.__default.One__Many(a#0, b#0, c#0), TBool);
        return;
...
procedure {:verboseName "VariationsOnPlurals.Many_None (well-formedness)"} CheckWellformed$$VariationsOnPlurals.__default.Many__None(a#0: Box where $IsBox(a#0, Tclass.VariationsOnPlurals.X()), 
    b#0: Box where $IsBox(b#0, Tclass.VariationsOnPlurals.X()));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  ensures (forall $olderHeap: Heap :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "VariationsOnPlurals.Many_None (well-formedness)"} CheckWellformed$$VariationsOnPlurals.__default.Many__None(a#0: Box, b#0: Box)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    {
        // Check well-formedness of body and result subset type constraint
        assume {:id "id158"} VariationsOnPlurals.__default.Many__None(a#0, b#0) == Lit(true);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(VariationsOnPlurals.__default.Many__None(a#0, b#0), TBool);
        return;
...
procedure {:verboseName "VariationsOnPlurals.Many_One (well-formedness)"} CheckWellformed$$VariationsOnPlurals.__default.Many__One(a#0: Box where $IsBox(a#0, Tclass.VariationsOnPlurals.X()), 
    b#0: Box where $IsBox(b#0, Tclass.VariationsOnPlurals.X()), 
    c#0: Box where $IsBox(c#0, Tclass.VariationsOnPlurals.X()));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "VariationsOnPlurals.Many_One (well-formedness)"} CheckWellformed$$VariationsOnPlurals.__default.Many__One(a#0: Box, b#0: Box, c#0: Box)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    {
        // Check well-formedness of body and result subset type constraint
        assume {:id "id161"} VariationsOnPlurals.__default.Many__One(a#0, b#0, c#0) == Lit(true);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(VariationsOnPlurals.__default.Many__One(a#0, b#0, c#0), TBool);
        return;
...
axiom 0 <= $FunctionContextHeight
   ==> (forall a#0: Box, b#0: Box, c#0: Box, d#0: Box :: 
...
axiom {:id "id162"} 0 <= $FunctionContextHeight
   ==> (forall a#0: Box, b#0: Box, c#0: Box, d#0: Box :: 
    { VariationsOnPlurals.__default.Many__Many(a#0, b#0, c#0, d#0) } 
    VariationsOnPlurals.__default.Many__Many#canCall(a#0, b#0, c#0, d#0)
         || (0 < $FunctionContextHeight
...
procedure {:verboseName "VariationsOnPlurals.Many_Many (well-formedness)"} CheckWellformed$$VariationsOnPlurals.__default.Many__Many(a#0: Box where $IsBox(a#0, Tclass.VariationsOnPlurals.X()), 
    b#0: Box where $IsBox(b#0, Tclass.VariationsOnPlurals.X()), 
    c#0: Box where $IsBox(c#0, Tclass.VariationsOnPlurals.X()), 
    d#0: Box where $IsBox(d#0, Tclass.VariationsOnPlurals.X()));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  ensures (forall $olderHeap: Heap :: 
    { $OlderTag($olderHeap) } 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "VariationsOnPlurals.Many_Many (well-formedness)"} CheckWellformed$$VariationsOnPlurals.__default.Many__Many(a#0: Box, b#0: Box, c#0: Box, d#0: Box)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    {
        // Check well-formedness of body and result subset type constraint
        assume {:id "id164"} VariationsOnPlurals.__default.Many__Many(a#0, b#0, c#0, d#0) == Lit(true);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(VariationsOnPlurals.__default.Many__Many(a#0, b#0, c#0, d#0), TBool);
        return;
...
procedure {:verboseName "VariationsOnPlurals.C.One_OneWithThis (well-formedness)"} CheckWellformed$$VariationsOnPlurals.C.One__OneWithThis(this: ref
       where this != null
         && 
        $Is(this, Tclass.VariationsOnPlurals.C())
         && $IsAlloc(this, Tclass.VariationsOnPlurals.C(), $Heap), 
    a#0: Box where $IsBox(a#0, Tclass.VariationsOnPlurals.X()));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  ensures (forall $olderHeap: Heap :: 
    { $OlderTag($olderHeap) } 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "VariationsOnPlurals.C.One_OneWithThis (well-formedness)"} CheckWellformed$$VariationsOnPlurals.C.One__OneWithThis(this: ref, a#0: Box)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    {
        // Check well-formedness of body and result subset type constraint
        assume {:id "id167"} VariationsOnPlurals.C.One__OneWithThis(this, a#0) == Lit(true);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(VariationsOnPlurals.C.One__OneWithThis(this, a#0), TBool);
        return;
...
axiom 0 <= $FunctionContextHeight
   ==> (forall this: ref, a#0: Box, b#0: Box :: 
...
procedure {:verboseName "VariationsOnPlurals.C.One_ManyWithThis (well-formedness)"} CheckWellformed$$VariationsOnPlurals.C.One__ManyWithThis(this: ref
       where this != null
         && 
        $Is(this, Tclass.VariationsOnPlurals.C())
         && $IsAlloc(this, Tclass.VariationsOnPlurals.C(), $Heap), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "VariationsOnPlurals.C.One_ManyWithThis (well-formedness)"} CheckWellformed$$VariationsOnPlurals.C.One__ManyWithThis(this: ref, a#0: Box, b#0: Box)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    {
        // Check well-formedness of body and result subset type constraint
        assume {:id "id170"} VariationsOnPlurals.C.One__ManyWithThis(this, a#0, b#0) == Lit(true);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(VariationsOnPlurals.C.One__ManyWithThis(this, a#0, b#0), TBool);
        return;
