...
(assert (forall ((h@@3 T@U) (k@@2 T@U) ) (!  (=> ($HeapSuccGhost h@@3 k@@2) (and ($HeapSucc h@@3 k@@2) (forall ((o@@7 T@U) (f@@7 T@U) ) (!  (=> (not ($IsGhostField f@@7)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h@@3 o@@7) f@@7) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) k@@2 o@@7) f@@7)))
 :qid |DafnyPreludebpl.544:13|
 :skolemid |2486|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) k@@2 o@@7) f@@7))
))))
...
(assert (forall ((f@@8 T@U) (t0@@8 T@U) (t1@@8 T@U) (h@@4 T@U) ) (!  (=> (and ($IsGoodHeap h@@4) ($IsAlloc HandleTypeType f@@8 (Tclass._System.___hFunc1 t0@@8 t1@@8) h@@4)) (forall ((bx0@@6 T@U) ) (!  (=> (and ($IsAllocBox bx0@@6 t0@@8 h@@4) (Requires1 t0@@8 t1@@8 h@@4 f@@8 bx0@@6)) ($IsAllocBox (Apply1 t0@@8 t1@@8 h@@4 f@@8 bx0@@6) t1@@8 h@@4))
 :qid |unknown.0:0|
 :skolemid |2777|
 :pattern ( (Apply1 t0@@8 t1@@8 h@@4 f@@8 bx0@@6))
)))
 :qid |unknown.0:0|
 :skolemid |2778|
 :pattern ( ($IsAlloc HandleTypeType f@@8 (Tclass._System.___hFunc1 t0@@8 t1@@8) h@@4))
)))
...
(assert (forall ((f@@9 T@U) (t0@@9 T@U) (t1@@9 T@U) ) (! (= ($Is HandleTypeType f@@9 (Tclass._System.___hFunc1 t0@@9 t1@@9)) (forall ((h@@5 T@U) (bx0@@7 T@U) ) (!  (=> (and (and ($IsGoodHeap h@@5) ($IsBox bx0@@7 t0@@9)) (Requires1 t0@@9 t1@@9 h@@5 f@@9 bx0@@7)) ($IsBox (Apply1 t0@@9 t1@@9 h@@5 f@@9 bx0@@7) t1@@9))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2769|
 :pattern ( (Apply1 t0@@9 t1@@9 h@@5 f@@9 bx0@@7))
)))
 :qid |unknown.0:0|
 :skolemid |2770|
 :pattern ( ($Is HandleTypeType f@@9 (Tclass._System.___hFunc1 t0@@9 t1@@9)))
)))
...
(assert (forall ((f@@10 T@U) (t0@@10 T@U) (t1@@10 T@U) (h@@6 T@U) ) (!  (=> ($IsGoodHeap h@@6) (= ($IsAlloc HandleTypeType f@@10 (Tclass._System.___hFunc1 t0@@10 t1@@10) h@@6) (forall ((bx0@@8 T@U) ) (!  (=> (and (and ($IsBox bx0@@8 t0@@10) ($IsAllocBox bx0@@8 t0@@10 h@@6)) (Requires1 t0@@10 t1@@10 h@@6 f@@10 bx0@@8)) (forall ((r T@U) ) (!  (=> (and (or (not (= r null)) (not true)) (|Set#IsMember| (Reads1 t0@@10 t1@@10 h@@6 f@@10 bx0@@8) ($Box refType r))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h@@6 r) alloc))))
 :qid |unknown.0:0|
 :skolemid |2774|
 :pattern ( (|Set#IsMember| (Reads1 t0@@10 t1@@10 h@@6 f@@10 bx0@@8) ($Box refType r)))
)))
 :qid |unknown.0:0|
 :skolemid |2775|
 :pattern ( (Apply1 t0@@10 t1@@10 h@@6 f@@10 bx0@@8))
 :pattern ( (Reads1 t0@@10 t1@@10 h@@6 f@@10 bx0@@8))
))))
 :qid |unknown.0:0|
 :skolemid |2776|
 :pattern ( ($IsAlloc HandleTypeType f@@10 (Tclass._System.___hFunc1 t0@@10 t1@@10) h@@6))
)))
...
(assert (forall ((t0@@12 T@U) (t1@@12 T@U) (heap@@0 T@U) (f@@11 T@U) (bx0@@9 T@U) ) (!  (=> (and (and ($IsGoodHeap heap@@0) (and ($IsBox bx0@@9 t0@@12) ($Is HandleTypeType f@@11 (Tclass._System.___hFunc1 t0@@12 t1@@12)))) (|Set#Equal| (Reads1 t0@@12 t1@@12 $OneHeap f@@11 bx0@@9) |Set#Empty|)) (= (Requires1 t0@@12 t1@@12 $OneHeap f@@11 bx0@@9) (Requires1 t0@@12 t1@@12 heap@@0 f@@11 bx0@@9)))
 :qid |unknown.0:0|
 :skolemid |2768|
 :pattern ( (Requires1 t0@@12 t1@@12 $OneHeap f@@11 bx0@@9) ($IsGoodHeap heap@@0))
 :pattern ( (Requires1 t0@@12 t1@@12 heap@@0 f@@11 bx0@@9))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.LoopyFunction)
...
)) (= |f#0@@3| |f#0@@3|))) (and (=> (= (ControlFlow 0 8) 1) anon6_LoopDone_correct) (=> (= (ControlFlow 0 8) 7) anon6_LoopBody_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct))))
