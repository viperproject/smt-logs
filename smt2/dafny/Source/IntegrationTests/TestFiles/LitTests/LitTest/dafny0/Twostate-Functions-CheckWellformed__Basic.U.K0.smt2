...
(assert (forall (($prevHeap@@0 T@U) ($h0 T@U) ($h1 T@U) (this@@0 T@U) (|u#0@@0| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass.Basic.U))) (or (|Basic.U.K0#canCall| $prevHeap@@0 $h0 this@@0 |u#0@@0|) ($Is refType |u#0@@0| Tclass.Basic.U))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@0 T@U) ($f T@U) ) true) (= (Basic.U.K0 $prevHeap@@0 $h0 this@@0 |u#0@@0|) (Basic.U.K0 $prevHeap@@0 $h1 this@@0 |u#0@@0|))))
