...
(set-info :boogie-vc-id CheckWellformed$$Basic.U.K0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= |u#0@@3| null)) (not true))) (=> (or (not (= |u#0@@3| null)) (not true)) (=> (and (and (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |u#0@@3| Basic.U.aa))) (= (Basic.U.K0 $Heap@@2 current$Heap this@@3 |u#0@@3|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |u#0@@3|) Basic.U.aa))))) (and ($Is intType (int_2_U (Basic.U.K0 $Heap@@2 current$Heap this@@3 |u#0@@3|)) TInt) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|)))))
