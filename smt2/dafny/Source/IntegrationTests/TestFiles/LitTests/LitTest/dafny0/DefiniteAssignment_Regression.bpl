...
procedure {:verboseName "Regression.M (well-formedness)"} CheckWellFormed$$Regression.__default.M()
   returns (d#0: DatatypeType
       where $Is(d#0, Tclass.Regression.D(TInt, Tclass.Regression.Class()))
         && $IsAlloc(d#0, Tclass.Regression.D(TInt, Tclass.Regression.Class()), $Heap));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Regression.M (call)"} Call$$Regression.__default.M()
   returns (d#0: DatatypeType
       where $Is(d#0, Tclass.Regression.D(TInt, Tclass.Regression.Class()))
         && $IsAlloc(d#0, Tclass.Regression.D(TInt, Tclass.Regression.Class()), $Heap));
  modifies $Heap;
...
procedure {:verboseName "Regression.M (correctness)"} Impl$$Regression.__default.M()
   returns (d#0: DatatypeType
       where $Is(d#0, Tclass.Regression.D(TInt, Tclass.Regression.Class()))
         && $IsAlloc(d#0, Tclass.Regression.D(TInt, Tclass.Regression.Class()), $Heap), 
    $_reverifyPost: bool);
...
procedure {:verboseName "Regression.N (well-formedness)"} CheckWellFormed$$Regression.__default.N()
   returns (e#0: DatatypeType
       where $Is(e#0, Tclass.Regression.E(Tclass.Regression.Class()))
         && $IsAlloc(e#0, Tclass.Regression.E(Tclass.Regression.Class()), $Heap));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Regression.N (call)"} Call$$Regression.__default.N()
   returns (e#0: DatatypeType
       where $Is(e#0, Tclass.Regression.E(Tclass.Regression.Class()))
         && $IsAlloc(e#0, Tclass.Regression.E(Tclass.Regression.Class()), $Heap));
  modifies $Heap;
...
procedure {:verboseName "Regression.N (correctness)"} Impl$$Regression.__default.N()
   returns (e#0: DatatypeType
       where $Is(e#0, Tclass.Regression.E(Tclass.Regression.Class()))
         && $IsAlloc(e#0, Tclass.Regression.E(Tclass.Regression.Class()), $Heap), 
    $_reverifyPost: bool);
