...
(assert  (and (and (and (and (and (and (and (forall ((t0@@0 T@T) (t1 T@T) (val T@U) (m T@U) (x0 T@U) ) (! (= (MapType0Select t0@@0 t1 (MapType0Store t0@@0 t1 m x0 val) x0) val)
 ...
 :weight 0
))) (= (Ctor FieldType) 7)) (= (Ctor BoxType) 8)) (= (Ctor refType) 9)) (forall ((arg0@@4 T@T) (arg1 T@T) ) (! (= (Ctor (MapType0Type arg0@@4 arg1)) 10)
...
(let ((anon24_correct  (=> (and (forall ((|l'#0| Int) ) (!  (=> (<= (LitInt (- 0 2)) |l'#0|) (=> (< |l'#0| 20) (|_module.__default.P#canCall| |l'#0|)))
 :qid |DiscoverBoundsdfy.34:15|
 :skolemid |499|
)) (= |b#0@4| (forall ((|l'#0@@0| Int) ) (!  (=> (<= (LitInt (- 0 2)) |l'#0@@0|) (=> (< |l'#0@@0| 20) (_module.__default.P |l'#0@@0|)))
 :qid |DiscoverBoundsdfy.34:15|
 :skolemid |498|
)))) (and (=> (= (ControlFlow 0 8) 7) anon44_Then_correct) (=> (= (ControlFlow 0 8) 2) anon44_Else_correct)))))
...
(let ((anon21_correct  (=> (and (forall ((|u'#0| Int) ) (!  (=> (and (<= (LitInt (- 0 2)) |u'#0|) (< |u'#0| 100)) (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.__default.P#canCall| |u'#0|)))
 :qid |DiscoverBoundsdfy.33:15|
 :skolemid |497|
)) (= |b#0@3| (forall ((|u'#0@@0| Int) ) (!  (=> (and (<= (LitInt (- 0 2)) |u'#0@@0|) (< |u'#0@@0| 100)) (=> true (_module.__default.P |u'#0@@0|)))
 :qid |DiscoverBoundsdfy.33:15|
 :skolemid |496|
)))) (and (=> (= (ControlFlow 0 14) 12) anon42_Then_correct) (=> (= (ControlFlow 0 14) 9) anon42_Else_correct)))))
...
(let ((anon18_correct  (=> (and (forall ((|t'#0| Int) ) (!  (=> (and (<= (LitInt 0) |t'#0|) (< |t'#0| 100)) (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.__default.P#canCall| |t'#0|)))
 :qid |DiscoverBoundsdfy.32:15|
 :skolemid |495|
)) (= |b#0@2| (forall ((|t'#0@@0| Int) ) (!  (=> (and (<= (LitInt 0) |t'#0@@0|) (< |t'#0@@0| 100)) (=> true (_module.__default.P |t'#0@@0|)))
 :qid |DiscoverBoundsdfy.32:15|
 :skolemid |494|
)))) (and (=> (= (ControlFlow 0 19) 18) anon40_Then_correct) (=> (= (ControlFlow 0 19) 15) anon40_Else_correct)))))
...
(let ((anon15_correct  (=> (and (forall ((|n'#0| Int) ) (!  (=> (and (<= (LitInt 0) |n'#0|) (< |n'#0| 100)) (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.__default.P#canCall| |n'#0|)))
 :qid |DiscoverBoundsdfy.31:15|
 :skolemid |493|
)) (= |b#0@1| (forall ((|n'#0@@0| Int) ) (!  (=> (and (<= (LitInt 0) |n'#0@@0|) (< |n'#0@@0| 100)) (=> true (_module.__default.P |n'#0@@0|)))
 :qid |DiscoverBoundsdfy.31:15|
 :skolemid |492|
)))) (and (=> (= (ControlFlow 0 24) 23) anon38_Then_correct) (=> (= (ControlFlow 0 24) 20) anon38_Else_correct)))))
...
(let ((anon8_correct  (and (=> (= (ControlFlow 0 37) (- 0 38)) (or (and ($Is intType (int_2_U (LitInt (- 20 1))) Tclass._module.Lower) (U_2_bool (Lit boolType (bool_2_U (< (- 20 1) 20))))) (or (and ($Is intType (int_2_U (LitInt (- 0 2))) Tclass._module.Lower) (U_2_bool (Lit boolType (bool_2_U (< (- 0 2) 20))))) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._module.Lower) (U_2_bool (Lit boolType (bool_2_U (< 0 20))))) (exists ((|$as#l0#0| Int) ) (!  (and (<= (LitInt (- 0 2)) |$as#l0#0|) (< |$as#l0#0| 20))
 :qid |DiscoverBoundsdfy.19:7|
 :skolemid |490|
)))))) (=> (or (and ($Is intType (int_2_U (LitInt (- 20 1))) Tclass._module.Lower) (U_2_bool (Lit boolType (bool_2_U (< (- 20 1) 20))))) (or (and ($Is intType (int_2_U (LitInt (- 0 2))) Tclass._module.Lower) (U_2_bool (Lit boolType (bool_2_U (< (- 0 2) 20))))) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._module.Lower) (U_2_bool (Lit boolType (bool_2_U (< 0 20))))) (exists ((|$as#l0#0@@0| Int) ) (!  (and (<= (LitInt (- 0 2)) |$as#l0#0@@0|) (< |$as#l0#0@@0| 20))
 :qid |DiscoverBoundsdfy.19:7|
 :skolemid |490|
))))) (=> (and (<= (LitInt (- 0 2)) |l#0@0|) (< |l#0@0| 20)) (and (=> (= (ControlFlow 0 37) 35) anon34_Then_correct) (=> (= (ControlFlow 0 37) 36) anon34_Else_correct)))))))
