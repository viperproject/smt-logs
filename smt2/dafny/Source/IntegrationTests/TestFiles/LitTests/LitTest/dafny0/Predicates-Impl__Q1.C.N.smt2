...
(assert (forall (($h0 T@U) ($h1 T@U) (this T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this null)) (not true)) ($Is refType this Tclass.Q1.C))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@3 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@3 null)) (not true)) (= $o@@3 this)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@3) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@3) $f@@0)))
 :qid |unknown.0:0|
 :skolemid |3085|
)) (= (Q1.C.Q $h0 this) (Q1.C.Q $h1 this))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |3086|
...
(declare-fun $Heap@0 () T@U)
(set-info :boogie-vc-id Impl$$Q1.C.N)
