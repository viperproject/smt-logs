...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 0 |x#0|)) (and (and (= 0 |y#0|) (= 0 $FunctionContextHeight)) (and (or (not (= |x#0| |y#0|)) (not true)) (= (ControlFlow 0 3) 2)))) anon0_correct)))
