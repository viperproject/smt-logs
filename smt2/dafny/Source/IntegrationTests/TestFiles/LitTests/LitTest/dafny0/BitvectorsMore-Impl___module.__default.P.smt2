...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let (($generated@@94  (=> (and (= $generated@@85 ($generated@@27 $generated@@86 $generated@@87 $generated@@88 false)) (= (ControlFlow 0 2) (- 0 1))) ($generated@@5 ($generated $generated@@1 ($generated@@4 false))))))
(let (($generated@@95  (=> (and (and (and ($generated@@89 $generated@@87) ($generated@@90 $generated@@87)) (= 0 $generated@@91)) (and (and (= 0 $generated@@92) (= 0 $generated@@93)) (and (or (not (= $generated@@91 $generated@@92)) (not true)) (= (ControlFlow 0 3) 2)))) $generated@@94)))
$generated@@95)))
))
(check-sat)
(get-info :rlimit)
