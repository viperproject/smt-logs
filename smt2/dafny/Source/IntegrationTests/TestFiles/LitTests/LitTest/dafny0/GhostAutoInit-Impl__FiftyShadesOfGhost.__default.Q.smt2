...
(set-info :boogie-vc-id Impl$$FiftyShadesOfGhost.__default.Q)
...
(let ((anon3_Then_correct  (=> (and (< |z#0| |w#0|) (= (Mod |m#0_0@0| (LitInt 2)) (LitInt 1))) (=> (and (and (= (Mod |n#0_0@0| (LitInt 2)) (LitInt 1)) (= |b0#0_0@0| (= |m#0_0@0| |n#0_0@0|))) (and (=> |defass#x#0_0| (and ($Is refType |x#0_0@0| Tclass.FiftyShadesOfGhost.H) ($IsAlloc refType |x#0_0@0| Tclass.FiftyShadesOfGhost.H $Heap))) (=> |defass#y#0_0| (and ($Is refType |y#0_0@0| Tclass.FiftyShadesOfGhost.H) ($IsAlloc refType |y#0_0@0| Tclass.FiftyShadesOfGhost.H $Heap))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) |defass#x#0_0|) (=> |defass#x#0_0| (=> (= (ControlFlow 0 2) (- 0 1)) |defass#y#0_0|)))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (= (Mod |m#0_0| (LitInt 2)) (LitInt 1)) true)) (=> (and (and (and (= (Mod |n#0_0| (LitInt 2)) (LitInt 1)) true) (and (=> |defass#x#0_0| (and ($Is refType |x#0_0| Tclass.FiftyShadesOfGhost.H) ($IsAlloc refType |x#0_0| Tclass.FiftyShadesOfGhost.H $Heap))) true)) (and (and (=> |defass#y#0_0| (and ($Is refType |y#0_0| Tclass.FiftyShadesOfGhost.H) ($IsAlloc refType |y#0_0| Tclass.FiftyShadesOfGhost.H $Heap))) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 5)))) anon0_correct))))
