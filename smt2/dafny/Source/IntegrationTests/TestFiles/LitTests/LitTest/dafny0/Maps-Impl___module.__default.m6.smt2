...
(set-info :boogie-vc-id Impl$$_module.__default.m6)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |a#0@0| (Lit MapType (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 3))) ($Box intType (int_2_U (LitInt 9))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Map#Equal| (|Map#Build| |a#0@0| ($Box intType (int_2_U (LitInt 3))) ($Box intType (int_2_U (LitInt 5)))) (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 3))) ($Box intType (int_2_U (LitInt 5)))))) (=> (|Map#Equal| (|Map#Build| |a#0@0| ($Box intType (int_2_U (LitInt 3))) ($Box intType (int_2_U (LitInt 5)))) (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 3))) ($Box intType (int_2_U (LitInt 5))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Map#Equal| (|Map#Build| |a#0@0| ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 5)))) (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 5)))) ($Box intType (int_2_U (LitInt 3))) ($Box intType (int_2_U (LitInt 9)))))) (=> (|Map#Equal| (|Map#Build| |a#0@0| ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 5)))) (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 5)))) ($Box intType (int_2_U (LitInt 3))) ($Box intType (int_2_U (LitInt 9))))) (=> (= (ControlFlow 0 2) (- 0 1)) (|Map#Equal| (|Map#Build| |a#0@0| ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 5)))) (|Map#Build| (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 6)))) ($Box intType (int_2_U (LitInt 3))) ($Box intType (int_2_U (LitInt 9)))) ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 5)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |a#0| (TMap TInt TInt)) ($IsAlloc MapType |a#0| (TMap TInt TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct))))
