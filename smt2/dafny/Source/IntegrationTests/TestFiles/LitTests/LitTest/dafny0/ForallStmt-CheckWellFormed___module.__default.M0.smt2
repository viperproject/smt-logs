...
(let ((anon9_Else_correct  (=> (and (=> (and (not (|Set#IsMember| |S#0| ($Box refType |o#2@0|))) (not (and (or (not (= |o#2@0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |o#2@0|) alloc))))))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#2@0|) _module.C.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |o#2@0|) _module.C.data))))) (= (ControlFlow 0 6) 1)) anon7_correct)))
(let ((anon9_Then_correct  (=> (and (not (|Set#IsMember| |S#0| ($Box refType |o#2@0|))) (not (and (or (not (= |o#2@0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |o#2@0|) alloc))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |o#2@0| null)) (not true))) (=> (or (not (= |o#2@0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |o#2@0| null)) (not true))) (=> (or (not (= |o#2@0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |o#2@0| Tclass._module.C $Heap)) (=> ($IsAlloc refType |o#2@0| Tclass._module.C $Heap) (=> (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#2@0|) _module.C.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |o#2@0|) _module.C.data)))) (= (ControlFlow 0 2) 1)) anon7_correct))))))))))
(let ((anon4_correct  (=> (forall ((|o#1| T@U) ) (!  (=> ($Is refType |o#1| Tclass._module.C) (=> (|Set#IsMember| |S#0| ($Box refType |o#1|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#1|) _module.C.data))) (LitInt 85))))
 :qid |ForallStmtdfy.74:18|
 :skolemid |610|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#1|) _module.C.data)))
 :pattern ( (|Set#IsMember| |S#0| ($Box refType |o#1|)))
)) (=> (and ($Is refType |o#2@0| Tclass._module.C) ($IsAlloc refType |o#2@0| Tclass._module.C $Heap@0)) (and (=> (= (ControlFlow 0 7) 2) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct))))))
(let ((anon8_Else_correct  (=> (and (=> (|Set#IsMember| |S#0| ($Box refType |o#0@0|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#0@0|) _module.C.data))) (LitInt 85))) (= (ControlFlow 0 10) 7)) anon4_correct)))
(let ((anon8_Then_correct  (=> (|Set#IsMember| |S#0| ($Box refType |o#0@0|)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (not (= |o#0@0| null)) (not true))) (=> (or (not (= |o#0@0| null)) (not true)) (=> (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#0@0|) _module.C.data))) (LitInt 85)) (= (ControlFlow 0 8) 7)) anon4_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#2| null $Heap alloc |S#0|)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (forall (($o@@4 T@U) ) (!  (=> (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@4) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@4)) (|Set#IsMember| |S#0| ($Box refType $o@@4))))
 :qid |ForallStmtdfy.72:8|
 :skolemid |609|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4))
)) ($HeapSucc $Heap $Heap@0)) (and ($Is refType |o#0@0| Tclass._module.C) ($IsAlloc refType |o#0@0| Tclass._module.C $Heap@0))) (and (=> (= (ControlFlow 0 11) 8) anon8_Then_correct) (=> (= (ControlFlow 0 11) 10) anon8_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SetType |S#0| (TSet Tclass._module.C)) ($IsAlloc SetType |S#0| (TSet Tclass._module.C) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 12) 11))) anon0_correct))))
