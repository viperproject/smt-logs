...
(declare-fun |ByMethodRecursion.__default.N#canCall| () Bool)
(declare-fun ByMethodRecursion.__default.N () Int)
...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |ByMethodRecursion.__default.N#canCall| (< 0 $FunctionContextHeight)) (= ByMethodRecursion.__default.N (LitInt 5)))))
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |ByMethodRecursion.__default.N#canCall| (< 0 $FunctionContextHeight)) (= ByMethodRecursion.__default.N (LitInt 5)))))
...
(set-info :boogie-vc-id Impl$$ByMethodRecursion.__default.N)
...
(assert (not
 ...
 :qid |ByMethoddfy.161:10|
 :skolemid |1163|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0))
))) (and (and ($HeapSucc $Heap $Heap@0) (= |k#0@0| (LitInt 5))) (and |ByMethodRecursion.__default.N#canCall| (= (ControlFlow 0 2) (- 0 1))))) (= |k#0@0| (LitInt ByMethodRecursion.__default.N))))))
