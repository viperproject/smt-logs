...
(declare-fun Datatypes.__default.f3 (Int) Bool)
(declare-fun LitInt (Int) Int)
(declare-fun |Datatypes.__default.f3#canCall| (Int) Bool)
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|y#0| Int) ) (!  (=> (or (|Datatypes.__default.f3#canCall| (LitInt |y#0|)) (< 2 $FunctionContextHeight)) (and (|Datatypes.__default.f2#canCall| (LitInt |y#0|)) (= (Datatypes.__default.f3 (LitInt |y#0|)) (U_2_bool (Lit boolType (bool_2_U (Datatypes.__default.f2 (LitInt |y#0|))))))))
 :qid |AutoReqdfy.245:21|
 :weight 3
 :skolemid |4694|
 :pattern ( (Datatypes.__default.f3 (LitInt |y#0|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|y#0@@0| Int) ) (!  (=> (or (|Datatypes.__default.f3#canCall| |y#0@@0|) (< 2 $FunctionContextHeight)) (and (|Datatypes.__default.f2#canCall| |y#0@@0|) (= (Datatypes.__default.f3 |y#0@@0|) (Datatypes.__default.f2 |y#0@@0|))))
 :qid |AutoReqdfy.245:21|
 :skolemid |4693|
 :pattern ( (Datatypes.__default.f3 |y#0@@0|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$Datatypes.__default.f3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct  (=> (and ($IsAlloc intType (int_2_U |y#0@@1|) TInt $Heap) (= (ControlFlow 0 3) (- 0 2))) (forall ((|t#0| T@U) ) (!  (=> ($Is DatatypeTypeType |t#0| Tclass.Datatypes.TheType) (and (Datatypes.TheType.TheType__builder_q |t#0|) (> (Datatypes.TheType.x |t#0|) |y#0@@1|)))
 :qid |AutoReqdfy.239:21|
 :skolemid |4695|
