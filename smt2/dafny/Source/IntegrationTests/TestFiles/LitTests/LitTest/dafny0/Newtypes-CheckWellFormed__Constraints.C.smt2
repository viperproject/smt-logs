...
(set-info :boogie-vc-id CheckWellFormed$$Constraints.C)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon6_Then_correct  (=> (= |newtype$check#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= (LitInt 0) |newtype$check#0@0|)) (=> (<= (LitInt 0) |newtype$check#0@0|) (=> (= (ControlFlow 0 3) (- 0 2)) (< |newtype$check#0@0| 100)))))))
