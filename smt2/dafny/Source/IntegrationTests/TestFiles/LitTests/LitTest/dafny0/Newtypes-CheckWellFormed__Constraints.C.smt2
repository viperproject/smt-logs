...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let (($generated@@96  (=> (= $generated@@88 ($generated 0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= ($generated 0) $generated@@88)) (=> (<= ($generated 0) $generated@@88) (=> (= (ControlFlow 0 3) (- 0 2)) (< $generated@@88 100)))))))
...
(let (($generated@@99  (=> (and (and ($generated@@93 $generated@@91) ($generated@@94 $generated@@91)) (and (= 2 $generated@@95) (= (ControlFlow 0 6) 5))) $generated@@98)))
$generated@@99)))))
))
(check-sat)
(get-info :rlimit)
