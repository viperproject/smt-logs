...
(set-info :boogie-vc-id Impl$$Alt.__default.MyLemma__RealNice__AndFastToo_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (Alt.natinf.N_q |x#1|)) (=> (Alt.natinf.N_q |x#1|) (=> (= (ControlFlow 0 2) (- 0 1)) (= (Mod (Alt.natinf.n |x#1|) (LitInt 2)) (LitInt 0)))))))
(let ((anon3_Else_correct  (=> (<= (|ORD#Offset| |_k#0@@5|) 0) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1)) (and (forall ((|_k'#2@@1| T@U) (|x#2| T@U) ) (!  (=> (and ($Is DatatypeTypeType |x#2| Tclass.Alt.natinf) (and (|ORD#Less| |_k'#2@@1| |_k#0@@5|) (Alt.__default.Even_h ($LS $LZ) |_k'#2@@1| |x#2|))) (and (Alt.natinf.N_q |x#2|) (= (Mod (Alt.natinf.n |x#2|) (LitInt 2)) (LitInt 0))))
 :qid |InductivePredicatesdfy.163:15|
 :skolemid |734|
...
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#Alt.natinf| |x#1|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#_k0#0| T@U) (|$ih#x0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#x0#0| Tclass.Alt.natinf) (Alt.__default.Even_h ($LS $LZ) |$ih#_k0#0| |$ih#x0#0|)) (or (|ORD#Less| |$ih#_k0#0| |_k#0@@5|) (and (= |$ih#_k0#0| |_k#0@@5|) (< (DtRank |$ih#x0#0|) (DtRank |x#1|))))) (and (Alt.natinf.N_q |$ih#x0#0|) (= (Mod (Alt.natinf.n |$ih#x0#0|) (LitInt 2)) (LitInt 0))))
 :qid |InductivePredicatesdfy.163:15|
 :skolemid |733|
 :pattern ( (Alt.__default.Even_h ($LS $LZ) |$ih#_k0#0| |$ih#x0#0|))
)))) (and (=> (= (ControlFlow 0 6) 4) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |x#1| Tclass.Alt.natinf) ($IsAlloc DatatypeTypeType |x#1| Tclass.Alt.natinf $Heap)) (|$IsA#Alt.natinf| |x#1|)) (= 4 $FunctionContextHeight)) (and (and (|Alt.__default.Even_h#canCall| |_k#0@@5| |x#1|) (and (Alt.__default.Even_h ($LS $LZ) |_k#0@@5| |x#1|) (and (=> (< 0 (|ORD#Offset| |_k#0@@5|)) (or (and (Alt.natinf.N_q |x#1|) (= (Alt.natinf.n |x#1|) (LitInt 0))) (exists ((|y#2| T@U) ) (!  (and ($Is DatatypeTypeType |y#2| Tclass.Alt.natinf) (and (|Alt.natinf#Equal| |x#1| (Alt.__default.S (Alt.__default.S |y#2|))) (Alt.__default.Even_h ($LS $LZ) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |y#2|)))
 :qid |InductivePredicatesdfy.132:12|
 :skolemid |731|
