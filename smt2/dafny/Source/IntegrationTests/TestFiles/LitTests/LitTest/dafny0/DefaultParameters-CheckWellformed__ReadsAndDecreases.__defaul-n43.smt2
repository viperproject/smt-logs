...
(declare-fun ReadsAndDecreases.__default.ReadA0 (T@U T@U) Int)
(declare-fun |ReadsAndDecreases.__default.ReadA0#canCall| (T@U T@U) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (|a#0| T@U) (|m#0| T@U) ) (!  (=> (or (|ReadsAndDecreases.__default.ReadA0#canCall| |a#0| |m#0|) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap) ($Is refType |a#0| (Tclass._System.array TInt))) ($Is refType |m#0| (Tclass._System.array2 TInt))) (= (_System.array2.Length0 |m#0|) (LitInt 0))))) (and (|ReadsAndDecreases.__default.MoreReads#canCall| |a#0| |m#0| (ite (< 0 (_System.array.Length |a#0|)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField (LitInt 0))))) 3) (ite  (and (< 0 (_System.array2.Length0 |m#0|)) (< 0 (_System.array2.Length1 |m#0|))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |m#0|) (MultiIndexField (IndexField (LitInt 0)) (LitInt 0))))) 3)) (= (ReadsAndDecreases.__default.ReadA0 |a#0| |m#0|) (ReadsAndDecreases.__default.MoreReads |a#0| |m#0| (ite (< 0 (_System.array.Length |a#0|)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField (LitInt 0))))) 3) (ite  (and (< 0 (_System.array2.Length0 |m#0|)) (< 0 (_System.array2.Length1 |m#0|))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |m#0|) (MultiIndexField (IndexField (LitInt 0)) (LitInt 0))))) 3)))))
 :qid |DefaultParametersdfy.328:18|
 :skolemid |5844|
 :pattern ( (ReadsAndDecreases.__default.ReadA0 |a#0| |m#0|) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|a#0@@0| T@U) (|m#0@@0| T@U) ) (!  (=> (or (|ReadsAndDecreases.__default.ReadA0#canCall| (Lit refType |a#0@@0|) (Lit refType |m#0@@0|)) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@0) ($Is refType |a#0@@0| (Tclass._System.array TInt))) ($Is refType |m#0@@0| (Tclass._System.array2 TInt))) (= (LitInt (_System.array2.Length0 (Lit refType |m#0@@0|))) (LitInt 0))))) (and (|ReadsAndDecreases.__default.MoreReads#canCall| (Lit refType |a#0@@0|) (Lit refType |m#0@@0|) (ite (< 0 (_System.array.Length (Lit refType |a#0@@0|))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (Lit refType |a#0@@0|)) (IndexField (LitInt 0))))) 3) (ite  (and (< 0 (_System.array2.Length0 (Lit refType |m#0@@0|))) (< 0 (_System.array2.Length1 (Lit refType |m#0@@0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (Lit refType |m#0@@0|)) (MultiIndexField (IndexField (LitInt 0)) (LitInt 0))))) 3)) (= (ReadsAndDecreases.__default.ReadA0 (Lit refType |a#0@@0|) (Lit refType |m#0@@0|)) (ReadsAndDecreases.__default.MoreReads (Lit refType |a#0@@0|) (Lit refType |m#0@@0|) (ite (< 0 (_System.array.Length (Lit refType |a#0@@0|))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (Lit refType |a#0@@0|)) (IndexField (LitInt 0))))) 3) (ite  (and (< 0 (_System.array2.Length0 (Lit refType |m#0@@0|))) (< 0 (_System.array2.Length1 (Lit refType |m#0@@0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (Lit refType |m#0@@0|)) (MultiIndexField (IndexField (LitInt 0)) (LitInt 0))))) 3)))))
 :qid |DefaultParametersdfy.328:18|
 :weight 3
 :skolemid |5845|
 :pattern ( (ReadsAndDecreases.__default.ReadA0 (Lit refType |a#0@@0|) (Lit refType |m#0@@0|)) ($IsGoodHeap $Heap@@0))
))))
...
(set-info :boogie-vc-id CheckWellformed$$ReadsAndDecreases.__default.ReadA0)
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= |m#0@@1| null)) (not true))) (=> (or (not (= |m#0@@1| null)) (not true)) (=> (= (_System.array2.Length0 |m#0@@1|) (LitInt 0)) (and (=> (= (ControlFlow 0 3) 1) anon5_Then_correct) (=> (= (ControlFlow 0 3) 2) anon5_Else_correct))))))))
