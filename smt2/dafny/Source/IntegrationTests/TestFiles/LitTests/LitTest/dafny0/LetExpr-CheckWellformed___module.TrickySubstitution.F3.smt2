...
(declare-fun _module.TrickySubstitution.F3 (T@U Int) Int)
(declare-fun LitInt (Int) Int)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.TrickySubstitution.F3#canCall| (T@U Int) Bool)
(declare-fun null () T@U)
(declare-fun $Is (T@T T@U T@U) Bool)
(declare-fun refType () T@T)
(declare-fun Tclass._module.TrickySubstitution () T@U)
(declare-fun $IsAlloc (T@T T@U T@U T@U) Bool)
(declare-fun |$let#17$canCall| (Int) Bool)
(declare-fun |$let#19$canCall| (Int) Bool)
(declare-fun |$let#17_f| (Int) Int)
(declare-fun |$let#19_g| (Int) Int)
