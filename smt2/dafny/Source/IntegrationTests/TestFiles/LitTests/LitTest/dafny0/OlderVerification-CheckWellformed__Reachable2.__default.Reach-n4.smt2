...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@2 T@U) (|source#0@@2| T@U) (|sink#0@@2| T@U) (|S#0@@2| T@U) ) (!  (=> (or (|Reachable2.__default.Reachable#canCall| $Heap@@2 |source#0@@2| |sink#0@@2| |S#0@@2|) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@2) ($Is refType |source#0@@2| Tclass.Reachable2.Node)) ($Is refType |sink#0@@2| Tclass.Reachable2.Node)) ($Is SetType |S#0@@2| (TSet Tclass.Reachable2.Node))))) (and (forall ((|via#0| T@U) ) (!  (=> ($Is DatatypeTypeType |via#0| (Tclass.Reachable2.Path Tclass.Reachable2.Node TInt)) (|Reachable2.__default.ReachableVia#canCall| $Heap@@2 |source#0@@2| |via#0| |sink#0@@2| |S#0@@2|))
 :qid |OlderVerificationdfy.112:12|
 :skolemid |2221|
 ...
 :qid |OlderVerificationdfy.109:19|
 :skolemid |2222|
...
(set-info :boogie-vc-id CheckWellformed$$Reachable2.__default.Reachable)
...
(let ((anon8_Then_correct  (=> (and ($Is DatatypeTypeType |via#1@0| (Tclass.Reachable2.Path Tclass.Reachable2.Node TInt)) ($IsAlloc DatatypeTypeType |via#1@0| (Tclass.Reachable2.Path Tclass.Reachable2.Node TInt) $Heap@@3)) (=> (and (and (and ($IsAlloc refType |source#0@@3| Tclass.Reachable2.Node $Heap@@3) ($IsAlloc DatatypeTypeType |via#1@0| (Tclass.Reachable2.Path Tclass.Reachable2.Node TInt) $Heap@@3)) (and ($IsAlloc refType |sink#0@@3| Tclass.Reachable2.Node $Heap@@3) ($IsAlloc SetType |S#0@@3| (TSet Tclass.Reachable2.Node) $Heap@@3))) (and (and (= |b$reqreads#0@0| (forall (($o@@4 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@4) alloc)))) (|Set#IsMember| |S#0@@3| ($Box refType $o@@4))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@4 $f@@0)))
 :qid |OlderVerificationdfy.112:38|
 :skolemid |2223|
))) (|Reachable2.__default.ReachableVia#canCall| $Heap@@3 |source#0@@3| |via#1@0| |sink#0@@3| |S#0@@3|)) (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= (ControlFlow 0 4) 3)))) anon5_correct))))
