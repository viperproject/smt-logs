...
(declare-fun |_v12#3_0@0| () Int)
(declare-fun |$_Frame#l3_0@0| () T@U)
(declare-fun |$lambdaHeap#3_0@0| () T@U)
(declare-fun |lambdaResult#3_0| () T@U)
(declare-fun |s#0| () T@U)
(declare-fun _module._default.Q1$D () T@U)
...
(let ((anon12_Else_correct  (=> (and (< |_v12#3_0@0| (LitInt 0)) (= (ControlFlow 0 16) 14)) anon4_correct)))
(let ((anon12_Then_correct  (=> (<= (LitInt 0) |_v12#3_0@0|) (=> (and (and (= |$_Frame#l3_0@0| (|lambda#0| null |$lambdaHeap#3_0@0| alloc false)) (= |lambdaResult#3_0| |s#0|)) (and ($IsBox |lambdaResult#3_0| _module._default.Q1$D) (= (ControlFlow 0 15) 14))) anon4_correct))))
(let ((anon11_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#3_0@0|) (or (= $Heap |$lambdaHeap#3_0@0|) ($HeapSucc $Heap |$lambdaHeap#3_0@0|))) (and (=> (= (ControlFlow 0 17) 15) anon12_Then_correct) (=> (= (ControlFlow 0 17) 16) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (and (and (or (not (= $nw@3 null)) (not true)) ($Is refType $nw@3 (Tclass._System.array? _module._default.Q1$D))) (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@3) alloc))))) (and (= (_System.array.Length $nw@3) (LitInt 10)) (= (ControlFlow 0 13) (- 0 12)))) (forall ((|arrayinit#3_0#i0#0| Int) ) (!  (=> (and (<= 0 |arrayinit#3_0#i0#0|) (< |arrayinit#3_0#i0#0| (LitInt 10))) (Requires1 Tclass._System.nat _module._default.Q1$D $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| |s#0|) (|lambda#2| Tclass._System.nat) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#3_0#i0#0|))))
 :qid |ArrayElementInitERRdfy.85:22|
 :skolemid |771|
)))))
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (<= 0 (LitInt 10))) (=> (<= 0 (LitInt 10)) (and (=> (= (ControlFlow 0 18) 17) anon11_Then_correct) (=> (= (ControlFlow 0 18) 13) anon11_Else_correct))))))
(let ((anon15_Else_correct  (=> (and (and (and (and (not (U_2_bool (Lit boolType (bool_2_U true)))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (or (not (= |n#0| (LitInt 0))) (not true))) (< |n#0| (LitInt 0))) (= (ControlFlow 0 11) (- 0 10))) false)))
(let ((anon15_Then_correct  (=> (<= (LitInt 0) |n#0|) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= 0 |n#0|)) (=> (<= 0 |n#0|) (=> (= (ControlFlow 0 8) (- 0 7)) (= 0 |n#0|)))))))
(let ((anon14_Then_correct  (=> (= |n#0| (LitInt 0)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= 0 |n#0|)) (=> (<= 0 |n#0|) (=> (= (ControlFlow 0 5) (- 0 4)) (= 0 |n#0|)))))))
(let ((anon13_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= 0 (LitInt 10))) (=> (<= 0 (LitInt 10)) (=> (= (ControlFlow 0 2) (- 0 1)) (= 0 (LitInt 10)))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (and (and (=> (= (ControlFlow 0 20) 18) anon10_Then_correct) (=> (= (ControlFlow 0 20) 2) anon13_Then_correct)) (=> (= (ControlFlow 0 20) 5) anon14_Then_correct)) (=> (= (ControlFlow 0 20) 8) anon15_Then_correct)) (=> (= (ControlFlow 0 20) 11) anon15_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($IsBox |s#0| _module._default.Q1$D) ($IsAllocBox |s#0| _module._default.Q1$D $Heap))) (and (and ($Is refType |a#0| (Tclass._System.array _module._default.Q1$D)) ($IsAlloc refType |a#0| (Tclass._System.array _module._default.Q1$D) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 21) 20)))) anon0_correct)))
