...
(assert (forall ((a@@2 T@U) (b@@0 T@U) (o@@2 T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|ISet#Difference| a@@2 b@@0) o@@2))  (and (U_2_bool (MapType0Select BoxType boolType a@@2 o@@2)) (not (U_2_bool (MapType0Select BoxType boolType b@@0 o@@2)))))
 :qid |DafnyPreludebpl.858:15|
 :skolemid |168|
 :pattern ( (MapType0Select BoxType boolType (|ISet#Difference| a@@2 b@@0) o@@2))
)))
...
(assert (forall ((a@@4 T@U) (b@@2 T@U) (y@@0 T@U) ) (!  (=> (U_2_bool (MapType0Select BoxType boolType b@@2 y@@0)) (not (U_2_bool (MapType0Select BoxType boolType (|ISet#Difference| a@@4 b@@2) y@@0))))
 :qid |DafnyPreludebpl.860:15|
 :skolemid |169|
 :pattern ( (|ISet#Difference| a@@4 b@@2) (MapType0Select BoxType boolType b@@2 y@@0))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.IMapCommonUseCase2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon7_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (or (exists ((|$as#v0_0#0_0| T@U) ) (!  (and ($Is refType null Tclass._module.MyClass) (U_2_bool (MapType0Select BoxType boolType (|IMap#Items| |m#1@0|) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box refType null) ($Box bv3Type |$as#v0_0#0_0|))))))
 :qid |Mapsdfy.594:12|
 :skolemid |875|
)) (exists ((|$as#k0_0#0_0| T@U) (|$as#v0_0#0_0@@0| T@U) ) (!  (and (and ($Is refType |$as#k0_0#0_0| Tclass._module.MyClass) ($IsAlloc refType |$as#k0_0#0_0| Tclass._module.MyClass $Heap)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Items| |m#1@0|) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box refType |$as#k0_0#0_0|) ($Box bv3Type |$as#v0_0#0_0@@0|))))))
 :qid |Mapsdfy.594:9|
 :skolemid |874|
)))) (=> (or (exists ((|$as#v0_0#0_0@@1| (_ BitVec 3)) ) (!  (and ($Is refType null Tclass._module.MyClass) (U_2_bool (MapType0Select BoxType boolType (|IMap#Items| |m#1@0|) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box refType null) ($Box bv3Type (bv3_2_U |$as#v0_0#0_0@@1|)))))))
 :qid |Mapsdfy.594:12|
 :skolemid |875|
)) (exists ((|$as#k0_0#0_0@@0| T@U) (|$as#v0_0#0_0@@2| (_ BitVec 3)) ) (!  (and (and ($Is refType |$as#k0_0#0_0@@0| Tclass._module.MyClass) ($IsAlloc refType |$as#k0_0#0_0@@0| Tclass._module.MyClass $Heap)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Items| |m#1@0|) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box refType |$as#k0_0#0_0@@0|) ($Box bv3Type (bv3_2_U |$as#v0_0#0_0@@2|)))))))
 :qid |Mapsdfy.594:9|
 :skolemid |874|
))) (=> (and (=> true (and ($Is refType |k#0_0@1| Tclass._module.MyClass) ($IsAlloc refType |k#0_0@1| Tclass._module.MyClass $Heap))) (U_2_bool (MapType0Select BoxType boolType (|IMap#Items| |m#1@0|) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box refType |k#0_0@1|) ($Box bv3Type (bv3_2_U |v#0_0@1|))))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) ($Is intType (int_2_U (+ |s#0@1| (nat_from_bv3 |v#0_0@1|))) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ |s#0@1| (nat_from_bv3 |v#0_0@1|))) Tclass._System.nat) (=> (and (= |s#0@2| (+ |s#0@1| (nat_from_bv3 |v#0_0@1|))) (= (ControlFlow 0 5) (- 0 4))) true))))))))
(let ((anon11_Else_correct  (=> (and (not (and ($Is refType |k#0_1@1| Tclass._module.MyClass) ($IsAlloc refType |k#0_1@1| Tclass._module.MyClass $Heap))) (= (ControlFlow 0 9) 5)) anon7_correct)))
(let ((anon11_Then_correct  (=> (and (and ($Is refType |k#0_1@1| Tclass._module.MyClass) ($IsAlloc refType |k#0_1@1| Tclass._module.MyClass $Heap)) (= (ControlFlow 0 8) 5)) anon7_correct)))
(let ((anon10_Else_correct  (=> (not (|IMap#Equal| |m#1@0| |IMap#Empty|)) (and (=> (= (ControlFlow 0 10) 8) anon11_Then_correct) (=> (= (ControlFlow 0 10) 9) anon11_Else_correct)))))
...
(let ((anon8_LoopHead_correct  (=> (and (and (and (=> |defass#k#0_0@0| (and ($Is refType |k#0_0@0| Tclass._module.MyClass) ($IsAlloc refType |k#0_0@0| Tclass._module.MyClass $Heap))) (<= (LitInt 0) |s#0@1|)) (and ($Is IMapType |m#1@0| (TIMap Tclass._module.MyClass (TBitvector 3))) ($IsAlloc IMapType |m#1@0| (TIMap Tclass._module.MyClass (TBitvector 3)) $Heap))) (and (and (not false) (forall (($o@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2)))
 :qid |Mapsdfy.591:3|
 :skolemid |872|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2))
))) (and ($HeapSucc $Heap $Heap) (forall (($o@@3 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@3 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@3) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@3) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@3) $f@@0)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@3 $f@@0))))
 :qid |Mapsdfy.591:3|
 :skolemid |873|
