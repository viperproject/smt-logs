...
(let ((anon14_correct  (=> (and (forall ((|a#1#0#0@@0| Int) )  (=> (and (<= (LitInt 2) |a#1#0#0@@0|) (< |a#1#0#0@@0| 6)) (and (and (<= (LitInt 2) (|map$project$0#0#y#0| (+ |a#1#0#0@@0| 1))) (< (|map$project$0#0#y#0| (+ |a#1#0#0@@0| 1)) 6)) (= (+ |a#1#0#0@@0| 1) (+ (|map$project$0#0#y#0| (+ |a#1#0#0@@0| 1)) 1))))) (= |m#0@1| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#3| TInt (LitInt 2) 6 1)) (|lambda#4| 3) (TMap TInt TInt)))) (and (=> (= (ControlFlow 0 15) 14) anon32_Then_correct) (=> (= (ControlFlow 0 15) 3) anon32_Else_correct)))))
