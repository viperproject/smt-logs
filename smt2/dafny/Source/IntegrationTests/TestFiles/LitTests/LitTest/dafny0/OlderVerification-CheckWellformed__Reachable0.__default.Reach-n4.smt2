...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@1 T@U) (|source#0@@1| T@U) (|sink#0@@1| T@U) (|S#0@@1| T@U) ) (!  (=> (or (|Reachable0.__default.Reachable#canCall| $Heap@@1 |source#0@@1| |sink#0@@1| |S#0@@1|) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@1) ($Is refType |source#0@@1| Tclass.Reachable0.Node)) ($Is refType |sink#0@@1| Tclass.Reachable0.Node)) ($Is SetType |S#0@@1| (TSet Tclass.Reachable0.Node))))) (and (forall ((|via#0| T@U) ) (!  (=> ($Is DatatypeTypeType |via#0| (Tclass.Reachable0.Path Tclass.Reachable0.Node)) (|Reachable0.__default.ReachableVia#canCall| $Heap@@1 |source#0@@1| |via#0| |sink#0@@1| |S#0@@1|))
 :qid |OlderVerificationdfy.60:12|
 :skolemid |708|
 ...
 :qid |OlderVerificationdfy.57:19|
 :skolemid |709|
...
(set-info :boogie-vc-id CheckWellformed$$Reachable0.__default.Reachable)
...
(let ((anon8_Then_correct  (=> (and ($Is DatatypeTypeType |via#1@0| (Tclass.Reachable0.Path Tclass.Reachable0.Node)) ($IsAlloc DatatypeTypeType |via#1@0| (Tclass.Reachable0.Path Tclass.Reachable0.Node) $Heap@@3)) (=> (and (and (and ($IsAlloc refType |source#0@@3| Tclass.Reachable0.Node $Heap@@3) ($IsAlloc DatatypeTypeType |via#1@0| (Tclass.Reachable0.Path Tclass.Reachable0.Node) $Heap@@3)) (and ($IsAlloc refType |sink#0@@3| Tclass.Reachable0.Node $Heap@@3) ($IsAlloc SetType |S#0@@3| (TSet Tclass.Reachable0.Node) $Heap@@3))) (and (and (= |b$reqreads#0@0| (forall (($o@@4 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@4) alloc)))) (|Set#IsMember| |S#0@@3| ($Box refType $o@@4))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@4 $f@@0)))
 :qid |OlderVerificationdfy.60:31|
 :skolemid |710|
))) (|Reachable0.__default.ReachableVia#canCall| $Heap@@3 |source#0@@3| |via#1@0| |sink#0@@3| |S#0@@3|)) (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= (ControlFlow 0 4) 3)))) anon5_correct))))
