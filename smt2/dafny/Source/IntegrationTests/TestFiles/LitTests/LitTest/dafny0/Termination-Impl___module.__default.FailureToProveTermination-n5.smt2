...
(set-info :boogie-vc-id Impl$$_module.__default.FailureToProveTermination5)
...
(let ((anon13_Else_correct  (=> (and (not |b#0|) (= (ControlFlow 0 12) 10)) anon5_correct)))
(let ((anon13_Then_correct  (=> (and |b#0| (= (ControlFlow 0 11) 10)) anon5_correct)))
...
(let ((anon15_Else_correct  (=> (and (and |b#0| (< |n#0@0| 100)) (and (= |$decr$loop#00@1| (ite |b#0| (- 100 |n#0@0|) (- 0 1))) (= |n#0@1| (+ |n#0@0| 1)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (<= 0 |$decr$loop#00@1|) (= (ite |b#0| (- 100 |n#0@1|) (- 0 1)) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (ite |b#0| (- 100 |n#0@1|) (- 0 1)) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 4) (- 0 3)) (< (ite |b#0| (- 100 |n#0@1|) (- 0 1)) |$decr$loop#00@1|)))))))
(let ((anon15_Then_correct true))
(let ((anon8_correct  (and (=> (= (ControlFlow 0 6) 2) anon15_Then_correct) (=> (= (ControlFlow 0 6) 4) anon15_Else_correct))))
(let ((anon14_Else_correct  (=> (and (not |b#0|) (= (ControlFlow 0 8) 6)) anon8_correct)))
(let ((anon14_Then_correct  (=> (and |b#0| (= (ControlFlow 0 7) 6)) anon8_correct)))
...
)) (<= (ite |b#0| (- 100 |n#0@0|) (- 0 1)) |$decr_init$loop#00@0|))) (and (=> (= (ControlFlow 0 15) 1) anon11_LoopDone_correct) (=> (= (ControlFlow 0 15) 14) anon11_LoopBody_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |$decr_init$loop#00@0| (ite |b#0| (- 100 |N#0|) (- 0 1))) (= (ControlFlow 0 16) 15)) anon11_LoopHead_correct))))
