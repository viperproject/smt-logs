...
(set-info :boogie-vc-id Impl$$_module.__default.IL_h)
...
(let ((anon12_Else_correct  (=> (<= (|ORD#Offset| |_k#0@@5|) 0) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (forall ((|_k'#2@@1| T@U) (|x#2| T@U) ) (!  (=> (and ($Is DatatypeTypeType |x#2| Tclass._module.natinf) (and (|ORD#Less| |_k'#2@@1| |_k#0@@5|) (_module.__default.Even_h ($LS $LZ) |_k'#2@@1| |x#2|))) (and (_module.natinf.N_q |x#2|) (= (Mod (_module.natinf.n |x#2|) (LitInt 2)) (LitInt 0))))
 :qid |InductivePredicatesdfy.46:32|
 :skolemid |2866|
