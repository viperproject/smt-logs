...
(set-info :boogie-vc-id Impl$$Recursion.__default.A_k_h)
...
(let ((anon3_Then_correct  (=> (< 0 (|ORD#Offset| |_k#0|)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0|)) (=> (= |_k##0@0| (|ORD#Minus| |_k#0| (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (or (<= 0 |x#1|) (|ORD#Less| |_k##0@0| |_k#0|)) (= |x#1| |x#1|))) (=> (or (or (<= 0 |x#1|) (|ORD#Less| |_k##0@0| |_k#0|)) (= |x#1| |x#1|)) (=> (= (ControlFlow 0 2) (- 0 1)) (or (|ORD#Less| |_k##0@0| |_k#0|) (and (= |_k##0@0| |_k#0|) (< |x#1| |x#1|))))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 7) 2) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct)))))
