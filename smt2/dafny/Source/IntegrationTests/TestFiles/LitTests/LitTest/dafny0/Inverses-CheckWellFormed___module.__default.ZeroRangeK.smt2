...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.ZeroRangeK)
...
(let ((anon4_correct  (=> (and (<= |k#0| |i#0@0|) (< |i#0@0| (+ |k#0| 10))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array.Length |a#0|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array.Length |a#0|))) (=> (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField |i#0@0|)))) (LitInt 0)) (= (ControlFlow 0 3) 1)) anon6_correct))))))))
(let ((anon8_Else_correct  (=> (and (< |i#0@0| |k#0|) (= (ControlFlow 0 7) 3)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (<= |k#0| |i#0@0|) (= (ControlFlow 0 6) 3)) anon4_correct)))
(let ((anon7_Else_correct  (=> (and (=> (and (<= |k#0| |i#0@0|) (< |i#0@0| (+ |k#0| 10))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField |i#0@0|)))) (LitInt 0))) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#7| null $Heap alloc |a#0|)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (and (<= (LitInt 100) (_System.array.Length |a#0|)) (<= |k#0| (LitInt 90))) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6)) (= $o@@6 |a#0|)))
 :qid |Inversesdfy.131:8|
 :skolemid |606|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6))
)) ($HeapSucc $Heap $Heap@0))) (and (and (=> (= (ControlFlow 0 8) 2) anon7_Else_correct) (=> (= (ControlFlow 0 8) 6) anon8_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon8_Else_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (<= (LitInt 0) |k#0|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 10) 8))) anon0_correct))))
