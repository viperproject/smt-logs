...
axiom {:id "id0"} 0 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, a#0: MultiSet, n#0: int :: 
    { MultisetTests.__default.F($LS($ly), a#0, n#0) } 
    MultisetTests.__default.F#canCall(a#0, n#0)
         || (0 < $FunctionContextHeight && $Is(a#0, TMultiSet(TInt)) && LitInt(0) <= n#0)
...
procedure {:verboseName "MultisetTests.F (well-formedness)"} CheckWellformed$$MultisetTests.__default.F(a#0: MultiSet where $Is(a#0, TMultiSet(TInt)), n#0: int where LitInt(0) <= n#0);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MultisetTests.F (well-formedness)"} CheckWellformed$$MultisetTests.__default.F(a#0: MultiSet, n#0: int)
{
  ...
  var ##n#0: int;
    ...
    else
    {
        ...
        if (n#0 == LitInt(0))
        {
            assume {:id "id2"} MultisetTests.__default.F($LS($LZ), a#0, n#0) == LitInt(0);
            assume true;
        ...
        else
        {
            ...
            assert {:id "id4"} 0 <= n#0
               ...
               || ##n#0 == n#0;
            assert {:id "id5"} (MultiSet#Subset(##a#0, a#0) && !MultiSet#Equal(##a#0, a#0))
               || (MultiSet#Equal(##a#0, a#0) && ##n#0 < n#0);
            assume MultisetTests.__default.F#canCall(a#0, n#0 - 1);
            assume {:id "id6"} MultisetTests.__default.F($LS($LZ), a#0, n#0)
...
procedure {:verboseName "MultisetTests.F' (well-formedness)"} CheckWellformed$$MultisetTests.__default.F_k(a#0: MultiSet where $Is(a#0, TMultiSet(TInt)), n#0: int where LitInt(0) <= n#0);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MultisetTests.F' (well-formedness)"} CheckWellformed$$MultisetTests.__default.F_k(a#0: MultiSet, n#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var ##a#0: MultiSet;
  var ##n#0: int;
    ...
    else
    {
        ...
        if (n#0 == LitInt(0))
        {
            assume {:id "id9"} MultisetTests.__default.F_k($LS($LZ), a#0, n#0) == LitInt(0);
            assume true;
            // CheckWellformedWithResult: any expression
        ...
        else
        {
            ...
            // assume allocatedness for argument to function
            assume $IsAlloc(##a#0, TMultiSet(TInt), $Heap);
            assert {:id "id10"} $Is(n#0 - 1, Tclass._System.nat());
            ##n#0 := n#0 - 1;
            // assume allocatedness for argument to function
            assume $IsAlloc(##n#0, Tclass._System.nat(), $Heap);
            assert {:id "id11"} 0 <= n#0
               || (MultiSet#Subset(##a#0, a#0) && !MultiSet#Equal(##a#0, a#0))
               || ##n#0 == n#0;
            assert {:id "id12"} (MultiSet#Subset(##a#0, a#0) && !MultiSet#Equal(##a#0, a#0))
               || (MultiSet#Equal(##a#0, a#0) && ##n#0 < n#0);
            assume MultisetTests.__default.F_k#canCall(a#0, n#0 - 1);
            assume {:id "id13"} MultisetTests.__default.F_k($LS($LZ), a#0, n#0)
...
procedure {:verboseName "MultisetTests.M (well-formedness)"} CheckWellFormed$$MultisetTests.__default.M(n#0: int where LitInt(0) <= n#0, 
    b#0: MultiSet
...
procedure {:verboseName "MultisetTests.M (call)"} Call$$MultisetTests.__default.M(n#0: int where LitInt(0) <= n#0, 
    b#0: MultiSet
       where $Is(b#0, TMultiSet(TInt)) && $IsAlloc(b#0, TMultiSet(TInt), $Heap));
  modifies $Heap;
  // user-defined postconditions
  free ensures MultisetTests.__default.F#canCall(b#0, n#0);
  ensures {:id "id15"} MultisetTests.__default.F($LS($LS($LZ)), b#0, n#0) == LitInt(0);
  // frame condition
  free ensures old($Heap) == $Heap;



procedure {:verboseName "MultisetTests.M (correctness)"} Impl$$MultisetTests.__default.M(n#0: int where LitInt(0) <= n#0, 
    b#0: MultiSet
       where $Is(b#0, TMultiSet(TInt)) && $IsAlloc(b#0, TMultiSet(TInt), $Heap))
  ...
  // user-defined postconditions
  free ensures MultisetTests.__default.F#canCall(b#0, n#0);
  ensures {:id "id16"} MultisetTests.__default.F($LS($LS($LZ)), b#0, n#0) == LitInt(0);
  // frame condition
  free ensures old($Heap) == $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MultisetTests.M (correctness)"} Impl$$MultisetTests.__default.M(n#0: int, b#0: MultiSet) returns ($_reverifyPost: bool)
{
  ...
  var $initHeapForallStmt#0: Heap;
    ...
    assume (forall $ih#n0#0: int, $ih#b0#0: MultiSet :: 
      { MultisetTests.__default.F($LS($LZ), $ih#b0#0, $ih#n0#0) } 
      LitInt(0) <= $ih#n0#0
