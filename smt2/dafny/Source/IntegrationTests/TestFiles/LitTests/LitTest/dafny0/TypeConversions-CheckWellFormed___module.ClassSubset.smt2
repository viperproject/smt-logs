...
(assert (forall ((|c#0| T@U) ) (! (= ($Is refType |c#0| Tclass._module.Class)  (and ($Is refType |c#0| Tclass._module.Class?) (or (not (= |c#0| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |603|
 :pattern ( ($Is refType |c#0| Tclass._module.Class))
 :pattern ( ($Is refType |c#0| Tclass._module.Class?))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.ClassSubset)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) ($Is refType null Tclass._module.Class)) (=> ($Is refType null Tclass._module.Class) (=> (= (ControlFlow 0 3) (- 0 2)) (U_2_bool (Lit boolType (bool_2_U true))))))))
