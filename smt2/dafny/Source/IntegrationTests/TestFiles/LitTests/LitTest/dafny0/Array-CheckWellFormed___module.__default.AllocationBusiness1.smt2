...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.AllocationBusiness1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon3_correct  (=> (and (<= (LitInt 0) |j#0|) (< |j#0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 |j#0|) (< |j#0| (_System.array.Length |a#0|)))) (=> (and (<= 0 |j#0|) (< |j#0| (_System.array.Length |a#0|))) (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |j#0|))) null)) (not true))))))))))
(let ((anon4_Else_correct  (=> (and (< |j#0| (LitInt 0)) (= (ControlFlow 0 7) 2)) anon3_correct)))
(let ((anon4_Then_correct  (=> (<= (LitInt 0) |j#0|) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (= (ControlFlow 0 5) 2) anon3_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 8) 5) anon4_Then_correct) (=> (= (ControlFlow 0 8) 7) anon4_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |a#0| (Tclass._System.array Tclass._module.MyClass)) ($IsAlloc refType |a#0| (Tclass._System.array Tclass._module.MyClass) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct))))
