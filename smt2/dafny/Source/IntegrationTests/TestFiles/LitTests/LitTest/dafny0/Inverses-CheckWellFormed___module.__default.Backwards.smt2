...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Backwards)
...
(let ((anon4_correct  (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |n#0|)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= |a#0@0| null)) (not true))) (=> (or (not (= |a#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array.Length |a#0@0|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array.Length |a#0@0|))) (=> (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0@0|) (IndexField |i#0@0|)))) (LitInt 0)) (= (ControlFlow 0 3) 1)) anon6_correct))))))))
...
(let ((anon7_Else_correct  (=> (and (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |n#0|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0@0|) (IndexField |i#0@0|)))) (LitInt 0))) (= (ControlFlow 0 2) 1)) anon6_correct)))
