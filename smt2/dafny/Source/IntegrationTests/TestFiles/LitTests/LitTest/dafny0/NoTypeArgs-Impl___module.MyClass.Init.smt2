...
(assert (distinct alloc allocName Tagclass._module.MyClass Tagclass._module.MyClass? class._module.MyClass? tytagFamily$MyClass field$data)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((_module.MyClass$G@@2 T@U) ($o@@1 T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType $o@@1 (Tclass._module.MyClass? _module.MyClass$G@@2) $h@@2)  (or (= $o@@1 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@1) alloc)))))
 :qid |unknown.0:0|
 :skolemid |618|
 :pattern ( ($IsAlloc refType $o@@1 (Tclass._module.MyClass? _module.MyClass$G@@2) $h@@2))
)))
...
(assert (forall ((_module.MyClass$G@@6 T@U) ($o@@3 T@U) ) (! (= ($Is refType $o@@3 (Tclass._module.MyClass? _module.MyClass$G@@6))  (or (= $o@@3 null) (= (dtype $o@@3) (Tclass._module.MyClass? _module.MyClass$G@@6))))
 :qid |unknown.0:0|
 :skolemid |617|
 :pattern ( ($Is refType $o@@3 (Tclass._module.MyClass? _module.MyClass$G@@6)))
)))
...
(assert (forall ((_module.MyClass$G@@9 T@U) (bx@@0 T@U) ) (!  (=> ($IsBox bx@@0 (Tclass._module.MyClass _module.MyClass$G@@9)) (and (= ($Box refType ($Unbox refType bx@@0)) bx@@0) ($Is refType ($Unbox refType bx@@0) (Tclass._module.MyClass _module.MyClass$G@@9))))
 :qid |unknown.0:0|
 :skolemid |536|
 :pattern ( ($IsBox bx@@0 (Tclass._module.MyClass _module.MyClass$G@@9)))
)))
(assert (forall ((_module.MyClass$G@@10 T@U) (bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 (Tclass._module.MyClass? _module.MyClass$G@@10)) (and (= ($Box refType ($Unbox refType bx@@1)) bx@@1) ($Is refType ($Unbox refType bx@@1) (Tclass._module.MyClass? _module.MyClass$G@@10))))
 :qid |unknown.0:0|
 :skolemid |539|
 :pattern ( ($IsBox bx@@1 (Tclass._module.MyClass? _module.MyClass$G@@10)))
)))
...
(declare-fun _module.MyClass$G@@11 () T@U)
(declare-fun |g#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.MyClass.Init)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#6| null $Heap alloc this)) (= (ControlFlow 0 2) (- 0 1))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this _module.MyClass.data)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass._module.MyClass _module.MyClass$G@@11)) ($IsAlloc refType this (Tclass._module.MyClass _module.MyClass$G@@11) $Heap)))) (and (and ($IsBox |g#0| _module.MyClass$G@@11) ($IsAllocBox |g#0| _module.MyClass$G@@11 $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
