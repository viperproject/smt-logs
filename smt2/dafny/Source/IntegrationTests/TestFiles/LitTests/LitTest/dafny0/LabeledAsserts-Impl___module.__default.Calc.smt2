...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 25) (let (($generated@@88 true))
(let (($generated@@89  (=> (= (ControlFlow 0 21) (- 0 20)) (< $generated@@80 150))))
(let (($generated@@90  (=> (< $generated@@80 10) (and (=> (= (ControlFlow 0 23) 21) $generated@@89) (=> (= (ControlFlow 0 23) 22) $generated@@88)))))
(let (($generated@@91 true))
(let (($generated@@92  (=> (= (ControlFlow 0 15) (- 0 14)) (< $generated@@80 90))))
(let (($generated@@93  (=> (< $generated@@80 10) (and (=> (= (ControlFlow 0 17) 15) $generated@@92) (=> (= (ControlFlow 0 17) 16) $generated@@91)))))
(let (($generated@@94  (=> (and (< $generated@@80 90) (= (ControlFlow 0 12) (- 0 11))) (= (< $generated@@80 150) (< $generated@@80 100)))))
(let (($generated@@95 true))
(let (($generated@@96  (and (=> (= (ControlFlow 0 13) 10) $generated@@95) (=> (= (ControlFlow 0 13) 12) $generated@@94))))
(let (($generated@@97  (and (=> (= (ControlFlow 0 18) 17) $generated@@93) (=> (= (ControlFlow 0 18) 13) $generated@@96))))
(let (($generated@@98 true))
(let (($generated@@99  (=> (= (ControlFlow 0 8) (- 0 7)) (= (< $generated@@80 10) (< $generated@@80 100)))))
(let (($generated@@100  (=> (and (< $generated@@80 10) (= (ControlFlow 0 6) (- 0 5))) (= (< $generated@@80 100) (< $generated@@80 10)))))
(let (($generated@@101  (=> (and (< $generated@@80 150) (= (ControlFlow 0 4) (- 0 3))) (= (< $generated@@80 200) (< $generated@@80 150)))))
(let (($generated@@102 true))
(let (($generated@@103 true))
(let (($generated@@104  (and (and (and (and (and (and (=> (= (ControlFlow 0 19) 1) $generated@@103) (=> (= (ControlFlow 0 19) 2) $generated@@102)) (=> (= (ControlFlow 0 19) 4) $generated@@101)) (=> (= (ControlFlow 0 19) 18) $generated@@97)) (=> (= (ControlFlow 0 19) 6) $generated@@100)) (=> (= (ControlFlow 0 19) 8) $generated@@99)) (=> (= (ControlFlow 0 19) 9) $generated@@98))))
(let (($generated@@105  (=> (= $generated@@81 ($generated@@24 $generated@@82 $generated@@83 $generated@@84 false)) (and (=> (= (ControlFlow 0 24) 23) $generated@@90) (=> (= (ControlFlow 0 24) 19) $generated@@104)))))
(let (($generated@@106  (=> (and (and ($generated@@85 $generated@@83) ($generated@@86 $generated@@83)) (and (= 0 $generated@@87) (= (ControlFlow 0 25) 24))) $generated@@105)))
$generated@@106))))))))))))))))))))
))
(check-sat)
