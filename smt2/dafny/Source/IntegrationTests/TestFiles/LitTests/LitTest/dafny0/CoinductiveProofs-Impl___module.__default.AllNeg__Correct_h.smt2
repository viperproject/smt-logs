...
(set-info :boogie-vc-id Impl$$_module.__default.AllNeg__Correct_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (<= |x#1| (LitInt 0)))))
(let ((anon3_Else_correct  (=> (<= (|ORD#Offset| |_k#0@@5|) 0) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1)) (and (forall ((|_k'#2@@1| T@U) (|x#2| Int) ) (!  (=> (and (|ORD#Less| |_k'#2@@1| |_k#0@@5|) (_module.__default.AllNeg_h ($LS $LZ) |_k'#2@@1| |x#2|)) (<= |x#2| (LitInt 0)))
 :qid |CoinductiveProofsdfy.245:13|
 :skolemid |876|
 :pattern ( (_module.__default.AllNeg_h ($LS $LZ) |_k'#2@@1| |x#2|))
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#_k0#0| T@U) (|$ih#x0#0| Int) ) (!  (=> (and (_module.__default.AllNeg_h ($LS $LZ) |$ih#_k0#0| |$ih#x0#0|) (or (|ORD#Less| |$ih#_k0#0| |_k#0@@5|) (and (= |$ih#_k0#0| |_k#0@@5|) (and (<= 0 |$ih#x0#0|) (< |$ih#x0#0| |x#1|))))) (<= |$ih#x0#0| (LitInt 0)))
 :qid |CoinductiveProofsdfy.245:13|
 :skolemid |875|
 :pattern ( (_module.__default.AllNeg_h ($LS $LZ) |$ih#_k0#0| |$ih#x0#0|))
)))) (and (=> (= (ControlFlow 0 5) 3) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 2 $FunctionContextHeight)) (and (and (|_module.__default.AllNeg_h#canCall| |_k#0@@5| |x#1|) (and (_module.__default.AllNeg_h ($LS $LZ) |_k#0@@5| |x#1|) (and (=> (< 0 (|ORD#Offset| |_k#0@@5|)) (or (= |x#1| (LitInt 0)) (_module.__default.AllNeg_h ($LS $LZ) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) (+ |x#1| 1)))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@5|)) (exists ((|_k'#1@@1| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#1@@1| |_k#0@@5|) (_module.__default.AllNeg_h ($LS $LZ) |_k'#1@@1| |x#1|))
 :qid |CoinductiveProofsdfy.240:17|
 :skolemid |874|
 :pattern ( (_module.__default.AllNeg_h ($LS $LZ) |_k'#1@@1| |x#1|))
