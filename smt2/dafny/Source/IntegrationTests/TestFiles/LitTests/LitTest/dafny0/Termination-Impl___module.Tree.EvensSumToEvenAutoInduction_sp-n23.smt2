...
(set-info :boogie-vc-id Impl$$_module.Tree.EvensSumToEvenAutoInduction_split5)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (= (Mod (_module.Tree.Sum ($LS ($LS $LZ)) this@@6) (LitInt 2)) (LitInt 0)))))
(let ((anon4_Else_correct  (=> (and (and (and (or (not (= this@@6 |#_module.Tree.Empty|)) (not true)) (= this@@6 (|#_module.Tree.Node| |_mcc#0#0_0@0| |_mcc#1#0_0@0| |_mcc#2#0_0@0|))) (and ($Is DatatypeTypeType |_mcc#1#0_0@0| Tclass._module.Tree) ($Is DatatypeTypeType |_mcc#2#0_0@0| Tclass._module.Tree))) (and (and ($Is DatatypeTypeType |right#0_0@0| Tclass._module.Tree) ($IsAlloc DatatypeTypeType |right#0_0@0| Tclass._module.Tree $Heap@0)) (= |let#0_0#0#0| |_mcc#2#0_0@0|))) (=> (and (and (and (and (and ($Is DatatypeTypeType |let#0_0#0#0| Tclass._module.Tree) (= |right#0_0@0| |let#0_0#0#0|)) (and ($Is DatatypeTypeType |left#0_0@0| Tclass._module.Tree) ($IsAlloc DatatypeTypeType |left#0_0@0| Tclass._module.Tree $Heap@0))) (and (and (= |let#0_1#0#0| |_mcc#1#0_0@0|) ($Is DatatypeTypeType |let#0_1#0#0| Tclass._module.Tree)) (and (= |left#0_0@0| |let#0_1#0#0|) (= |let#0_2#0#0| |_mcc#0#0_0@0|)))) (and (and (and ($Is intType (int_2_U |let#0_2#0#0|) TInt) (= |x#0_0@0| |let#0_2#0#0|)) (and ($IsAllocBox ($Box DatatypeTypeType this@@6) Tclass._module.Tree $Heap@0) (|_module.Tree.Elements#canCall| this@@6))) (and (and (|_module.Tree.Elements#canCall| this@@6) (|Set#IsMember| (_module.Tree.Elements ($LS $LZ) this@@6) ($Box intType (int_2_U |x#0_0@0|)))) (and (< (DtRank |left#0_0@0|) (DtRank this@@6)) (forall ((|u#1| T@U) ) (!  (=> (|Set#IsMember| (_module.Tree.Elements ($LS ($LS $LZ)) |left#0_0@0|) ($Box intType |u#1|)) (= (Mod (U_2_int |u#1|) (LitInt 2)) (LitInt 0)))
 :qid |Terminationdfy.504:21|
 :skolemid |3668|
 :pattern ( (|Set#IsMember| (_module.Tree.Elements ($LS ($LS $LZ)) |left#0_0@0|) ($Box intType |u#1|)))
)))))) (and (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (|_module.Tree.Sum#canCall| |left#0_0@0|)) (and (= (Mod (_module.Tree.Sum ($LS ($LS $LZ)) |left#0_0@0|) (LitInt 2)) (LitInt 0)) (= $Heap@0 $Heap@1))) (and (and (and (< (DtRank |right#0_0@0|) (DtRank this@@6)) (forall ((|u#1@@0| T@U) ) (!  (=> (|Set#IsMember| (_module.Tree.Elements ($LS ($LS $LZ)) |right#0_0@0|) ($Box intType |u#1@@0|)) (= (Mod (U_2_int |u#1@@0|) (LitInt 2)) (LitInt 0)))
 :qid |Terminationdfy.504:21|
 :skolemid |3668|
 :pattern ( (|Set#IsMember| (_module.Tree.Elements ($LS ($LS $LZ)) |right#0_0@0|) ($Box intType |u#1@@0|)))
))) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2))) (and (and (|_module.Tree.Sum#canCall| |right#0_0@0|) (= (Mod (_module.Tree.Sum ($LS ($LS $LZ)) |right#0_0@0|) (LitInt 2)) (LitInt 0))) (and (= $Heap@1 $Heap@2) (= (ControlFlow 0 4) 2)))))) GeneratedUnifiedExit_correct))))
(let ((anon4_Then_correct  (=> (and (= this@@6 |#_module.Tree.Empty|) (= (ControlFlow 0 3) 2)) GeneratedUnifiedExit_correct)))
(let ((anon0_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType this@@6 Tclass._module.Tree) ($IsAlloc DatatypeTypeType this@@6 Tclass._module.Tree $Heap)) (= 2 $FunctionContextHeight)) (and (forall ((|u#1@@1| T@U) ) (!  (=> (|Set#IsMember| (_module.Tree.Elements ($LS $LZ) this@@6) ($Box intType |u#1@@1|)) (= (Mod (U_2_int |u#1@@1|) (LitInt 2)) (LitInt 0)))
 :qid |Terminationdfy.504:21|
 :skolemid |3671|
 :pattern ( (|Set#IsMember| (_module.Tree.Elements ($LS $LZ) this@@6) ($Box intType |u#1@@1|)))
)) (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#this0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#this0#0| Tclass._module.Tree) (forall ((|u#2| Int) ) (!  (=> (|Set#IsMember| (_module.Tree.Elements ($LS $LZ) |$ih#this0#0|) ($Box intType (int_2_U |u#2|))) (= (Mod |u#2| (LitInt 2)) (LitInt 0)))
 :qid |Terminationdfy.504:21|
 :skolemid |3672|
...
))))) (and (=> (= (ControlFlow 0 5) 3) anon4_Then_correct) (=> (= (ControlFlow 0 5) 4) anon4_Else_correct))))))
anon0_correct)))))
))
(check-sat)
(get-info :rlimit)
