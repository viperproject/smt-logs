...
const unique class.ExtremeNat.__default: ClassName;

// function declaration for ExtremeNat._default.P
function ExtremeNat.__default.P(x#0: int, u#0: int) : bool
uses {
// definition axiom for ExtremeNat.__default.P (revealed)
axiom {:id "id885"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int, u#0: int :: 
    { ExtremeNat.__default.P(x#0, u#0) } 
    ExtremeNat.__default.P#canCall(x#0, u#0) || 0 < $FunctionContextHeight
       ==> ExtremeNat.__default.P(x#0, u#0) == (x#0 == u#0));
}

function ExtremeNat.__default.P#canCall(x#0: int, u#0: int) : bool;

function ExtremeNat.__default.P#requires(int, int) : bool;

// #requires axiom for ExtremeNat.__default.P
axiom (forall x#0: int, u#0: int :: 
  { ExtremeNat.__default.P#requires(x#0, u#0) } 
  ExtremeNat.__default.P#requires(x#0, u#0) == true);

// 1st prefix predicate axiom for ExtremeNat.__default.P_h
axiom 1 <= $FunctionContextHeight
   ==> (forall x#0: int, u#0: int :: 
    { ExtremeNat.__default.P(x#0, u#0) } 
    ExtremeNat.__default.P(x#0, u#0)
       ==> (forall _k#0: int :: 
        { ExtremeNat.__default.P_h(_k#0, x#0, u#0) } 
        LitInt(0) <= _k#0 ==> ExtremeNat.__default.P_h(_k#0, x#0, u#0)));
...
axiom 1 <= $FunctionContextHeight
   ==> (forall x#0: int, u#0: int, _k#0: int :: 
    { ExtremeNat.__default.P_h(_k#0, x#0, u#0) } 
    _k#0 == 0 ==> ExtremeNat.__default.P_h(_k#0, x#0, u#0));

procedure {:verboseName "ExtremeNat.P (well-formedness)"} CheckWellformed$$ExtremeNat.__default.P(x#0: int, u#0: int);
...
// function declaration for ExtremeNat._default.P#
function ExtremeNat.__default.P_h(_k#0: int, x#0: int, u#0: int) : bool
uses {
// definition axiom for ExtremeNat.__default.P_h (revealed)
axiom {:id "id887"} 1 <= $FunctionContextHeight
   ==> (forall _k#0: int, x#0: int, u#0: int :: 
    { ExtremeNat.__default.P_h(_k#0, x#0, u#0) } 
    ExtremeNat.__default.P_h#canCall(_k#0, x#0, u#0)
         || (1 < $FunctionContextHeight && LitInt(0) <= _k#0)
       ==> ExtremeNat.__default.P_h(_k#0, x#0, u#0) == (0 < _k#0 ==> x#0 == u#0));
// definition axiom for ExtremeNat.__default.P_h for decreasing-related literals (revealed)
axiom {:id "id888"} 1 <= $FunctionContextHeight
   ==> (forall _k#0: int, x#0: int, u#0: int :: 
    {:weight 3} { ExtremeNat.__default.P_h(LitInt(_k#0), x#0, u#0) } 
    ExtremeNat.__default.P_h#canCall(LitInt(_k#0), x#0, u#0)
         || (1 < $FunctionContextHeight && LitInt(0) <= _k#0)
       ==> ExtremeNat.__default.P_h(LitInt(_k#0), x#0, u#0) == (0 < _k#0 ==> x#0 == u#0));
// definition axiom for ExtremeNat.__default.P_h for all literals (revealed)
axiom {:id "id889"} 1 <= $FunctionContextHeight
   ==> (forall _k#0: int, x#0: int, u#0: int :: 
    {:weight 3} { ExtremeNat.__default.P_h(LitInt(_k#0), LitInt(x#0), LitInt(u#0)) } 
    ExtremeNat.__default.P_h#canCall(LitInt(_k#0), LitInt(x#0), LitInt(u#0))
         || (1 < $FunctionContextHeight && LitInt(0) <= _k#0)
       ==> ExtremeNat.__default.P_h(LitInt(_k#0), LitInt(x#0), LitInt(u#0))
         == (0 < _k#0 ==> LitInt(x#0) == LitInt(u#0)));
}

function ExtremeNat.__default.P_h#canCall(_k#0: int, x#0: int, u#0: int) : bool;

function ExtremeNat.__default.P_h#requires(int, int, int) : bool;

// #requires axiom for ExtremeNat.__default.P_h
axiom (forall _k#0: int, x#0: int, u#0: int :: 
  { ExtremeNat.__default.P_h#requires(_k#0, x#0, u#0) } 
  LitInt(0) <= _k#0 ==> ExtremeNat.__default.P_h#requires(_k#0, x#0, u#0) == true);

// function declaration for ExtremeNat._default.Q
function ExtremeNat.__default.Q(x#0: int, u#0: int) : bool
uses {
// definition axiom for ExtremeNat.__default.Q (revealed)
axiom {:id "id890"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int, u#0: int :: 
    { ExtremeNat.__default.Q(x#0, u#0) } 
    ExtremeNat.__default.Q#canCall(x#0, u#0) || 0 < $FunctionContextHeight
       ==> ExtremeNat.__default.Q(x#0, u#0) == (x#0 == u#0));
}

function ExtremeNat.__default.Q#canCall(x#0: int, u#0: int) : bool;

function ExtremeNat.__default.Q#requires(int, int) : bool;

// #requires axiom for ExtremeNat.__default.Q
axiom (forall x#0: int, u#0: int :: 
  { ExtremeNat.__default.Q#requires(x#0, u#0) } 
  ExtremeNat.__default.Q#requires(x#0, u#0) == true);

// 1st prefix predicate axiom for ExtremeNat.__default.Q_h
axiom 1 <= $FunctionContextHeight
   ==> (forall x#0: int, u#0: int :: 
    { ExtremeNat.__default.Q(x#0, u#0) } 
    ExtremeNat.__default.Q(x#0, u#0)
       ==> (exists _k#0: int :: 
        { ExtremeNat.__default.Q_h(_k#0, x#0, u#0) } 
        LitInt(0) <= _k#0 && ExtremeNat.__default.Q_h(_k#0, x#0, u#0)));
...
axiom 1 <= $FunctionContextHeight
   ==> (forall x#0: int, u#0: int, _k#0: int :: 
    { ExtremeNat.__default.Q_h(_k#0, x#0, u#0) } 
    _k#0 == 0 ==> !ExtremeNat.__default.Q_h(_k#0, x#0, u#0));

procedure {:verboseName "ExtremeNat.Q (well-formedness)"} CheckWellformed$$ExtremeNat.__default.Q(x#0: int, u#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
// function declaration for ExtremeNat._default.Q#
function ExtremeNat.__default.Q_h(_k#0: int, x#0: int, u#0: int) : bool
uses {
// definition axiom for ExtremeNat.__default.Q_h (revealed)
axiom {:id "id892"} 1 <= $FunctionContextHeight
   ==> (forall _k#0: int, x#0: int, u#0: int :: 
    { ExtremeNat.__default.Q_h(_k#0, x#0, u#0) } 
    ExtremeNat.__default.Q_h#canCall(_k#0, x#0, u#0)
         || (1 < $FunctionContextHeight && LitInt(0) <= _k#0)
       ==> ExtremeNat.__default.Q_h(_k#0, x#0, u#0) == (0 < _k#0 && x#0 == u#0));
// definition axiom for ExtremeNat.__default.Q_h for decreasing-related literals (revealed)
axiom {:id "id893"} 1 <= $FunctionContextHeight
   ==> (forall _k#0: int, x#0: int, u#0: int :: 
    {:weight 3} { ExtremeNat.__default.Q_h(LitInt(_k#0), x#0, u#0) } 
    ExtremeNat.__default.Q_h#canCall(LitInt(_k#0), x#0, u#0)
         || (1 < $FunctionContextHeight && LitInt(0) <= _k#0)
       ==> ExtremeNat.__default.Q_h(LitInt(_k#0), x#0, u#0) == (0 < _k#0 && x#0 == u#0));
// definition axiom for ExtremeNat.__default.Q_h for all literals (revealed)
axiom {:id "id894"} 1 <= $FunctionContextHeight
   ==> (forall _k#0: int, x#0: int, u#0: int :: 
    {:weight 3} { ExtremeNat.__default.Q_h(LitInt(_k#0), LitInt(x#0), LitInt(u#0)) } 
    ExtremeNat.__default.Q_h#canCall(LitInt(_k#0), LitInt(x#0), LitInt(u#0))
         || (1 < $FunctionContextHeight && LitInt(0) <= _k#0)
       ==> ExtremeNat.__default.Q_h(LitInt(_k#0), LitInt(x#0), LitInt(u#0))
         == (0 < _k#0 && LitInt(x#0) == LitInt(u#0)));
}

function ExtremeNat.__default.Q_h#canCall(_k#0: int, x#0: int, u#0: int) : bool;

function ExtremeNat.__default.Q_h#requires(int, int, int) : bool;

// #requires axiom for ExtremeNat.__default.Q_h
axiom (forall _k#0: int, x#0: int, u#0: int :: 
  { ExtremeNat.__default.Q_h#requires(_k#0, x#0, u#0) } 
  LitInt(0) <= _k#0 ==> ExtremeNat.__default.Q_h#requires(_k#0, x#0, u#0) == true);

procedure {:verboseName "ExtremeNat.L (well-formedness)"} CheckWellFormed$$ExtremeNat.__default.L(x#0: int, u#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "ExtremeNat.L (call)"} Call$$ExtremeNat.__default.L(x#0: int, u#0: int);
  // user-defined preconditions
  requires {:id "id896"} x#0 == u#0;
  modifies $Heap;
  // frame condition
...
procedure {:verboseName "ExtremeNat.L# (co-call)"} CoCall$$ExtremeNat.__default.L_h(_k#0: int where LitInt(0) <= _k#0, x#1: int, u#1: int);
  // user-defined preconditions
  requires {:id "id897"} x#1 == u#1;
  modifies $Heap;
  // frame condition
  free ensures old($Heap) == $Heap;
...
procedure {:verboseName "ExtremeNat.L# (correctness)"} Impl$$ExtremeNat.__default.L_h(_k#0: int where LitInt(0) <= _k#0, x#1: int, u#1: int)
   returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id898"} x#1 == u#1;
  modifies $Heap;
  // frame condition
  free ensures old($Heap) == $Heap;
...
procedure {:verboseName "ExtremeNat.TestLeast (well-formedness)"} CheckWellFormed$$ExtremeNat.__default.TestLeast(y#0: int, 
    z#0: int, 
    v#0: int, 
    w#0: int, 
    a#0: int, 
    b#0: int, 
    o#0: int where LitInt(0) <= o#0);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "ExtremeNat.TestLeast (call)"} Call$$ExtremeNat.__default.TestLeast(y#0: int, 
    z#0: int, 
    v#0: int, 
    w#0: int, 
    a#0: int, 
...
procedure {:verboseName "ExtremeNat.TestLeast (correctness)"} Impl$$ExtremeNat.__default.TestLeast(y#0: int, 
    z#0: int, 
    v#0: int, 
    w#0: int, 
    a#0: int, 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ExtremeNat.TestLeast (correctness)"} Impl$$ExtremeNat.__default.TestLeast(y#0: int, z#0: int, v#0: int, w#0: int, a#0: int, b#0: int, o#0: int)
   returns ($_reverifyPost: bool)
{
  ...
  var ##u#3: int;
    ...
    // AddMethodImpl: TestLeast, Impl$$ExtremeNat.__default.TestLeast
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(592,5)
    ##x#0 := y#0;
    ...
    assume ExtremeNat.__default.P#canCall(y#0, y#0);
    assume ExtremeNat.__default.P#canCall(y#0, y#0);
    assert {:id "id899"} {:subsumption 0} ExtremeNat.__default.P#canCall(y#0, y#0)
       ==> ExtremeNat.__default.P(y#0, y#0) || y#0 == y#0;
    assume {:id "id900"} ExtremeNat.__default.P(y#0, y#0);
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(593,5)
    ##_k#0 := o#0;
    // assume allocatedness for argument to function
    ...
    assume ExtremeNat.__default.P_h#canCall(o#0, z#0, z#0);
    assume ExtremeNat.__default.P_h#canCall(o#0, z#0, z#0);
    assert {:id "id901"} {:subsumption 0} ExtremeNat.__default.P_h#canCall(o#0, z#0, z#0)
       ==> ExtremeNat.__default.P_h(o#0, z#0, z#0) || (0 < o#0 ==> z#0 == z#0);
    assume {:id "id902"} ExtremeNat.__default.P_h(o#0, z#0, z#0);
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(594,6)
    ...
    // ProcessCallStmt: CheckSubrange
    u##0 := v#0;
    call {:id "id903"} Call$$ExtremeNat.__default.L(x##0, u##0);
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(595,10)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    _k##0 := o#0;
    ...
    // ProcessCallStmt: CheckSubrange
    u##1 := w#0;
    call {:id "id904"} CoCall$$ExtremeNat.__default.L_h(_k##0, x##1, u##1);
    // TrCallStmt: After ProcessCallStmt
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(596,5)
    ##x#2 := a#0;
    // assume allocatedness for argument to function
    ...
    assume ExtremeNat.__default.Q#canCall(a#0, a#0);
    assume ExtremeNat.__default.Q#canCall(a#0, a#0);
    assert {:id "id905"} {:subsumption 0} ExtremeNat.__default.Q#canCall(a#0, a#0)
       ==> ExtremeNat.__default.Q(a#0, a#0) || a#0 == a#0;
    assume {:id "id906"} ExtremeNat.__default.Q(a#0, a#0);
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(597,5)
    if (o#0 != 0)
    {
        ##_k#1 := o#0;
        // assume allocatedness for argument to function
        ...
        assume ExtremeNat.__default.Q_h#canCall(o#0, b#0, b#0);
    }

    assume o#0 != 0 ==> ExtremeNat.__default.Q_h#canCall(o#0, b#0, b#0);
    assert {:id "id907"} {:subsumption 0} o#0 != 0
       ==> 
      ExtremeNat.__default.Q_h#canCall(o#0, b#0, b#0)
       ==> ExtremeNat.__default.Q_h(o#0, b#0, b#0) || 0 < o#0;
    assert {:id "id908"} {:subsumption 0} o#0 != 0
       ==> 
      ExtremeNat.__default.Q_h#canCall(o#0, b#0, b#0)
       ==> ExtremeNat.__default.Q_h(o#0, b#0, b#0) || b#0 == b#0;
    assume {:id "id909"} o#0 != 0 ==> ExtremeNat.__default.Q_h(o#0, b#0, b#0);
}



procedure {:verboseName "ExtremeNat.TestLeastZero (well-formedness)"} CheckWellFormed$$ExtremeNat.__default.TestLeastZero(y#0: int, 
    z#0: int, 
    v#0: int, 
    w#0: int, 
    a#0: int, 
...
procedure {:verboseName "ExtremeNat.TestLeastZero (call)"} Call$$ExtremeNat.__default.TestLeastZero(y#0: int, 
    z#0: int, 
    v#0: int, 
    w#0: int, 
    a#0: int, 
...
procedure {:verboseName "ExtremeNat.TestLeastZero (correctness)"} Impl$$ExtremeNat.__default.TestLeastZero(y#0: int, 
    z#0: int, 
    v#0: int, 
    w#0: int, 
    a#0: int, 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ExtremeNat.TestLeastZero (correctness)"} Impl$$ExtremeNat.__default.TestLeastZero(y#0: int, z#0: int, v#0: int, w#0: int, a#0: int, b#0: int, o#0: int)
   returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var ##_k#0: int;
  ...
  var ##u#0: int;
    ...
    // AddMethodImpl: TestLeastZero, Impl$$ExtremeNat.__default.TestLeastZero
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(601,5)
    ##_k#0 := o#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##_k#0, Tclass._System.nat(), $Heap);
    ##x#0 := b#0;
    ...
    assume ExtremeNat.__default.Q_h#canCall(o#0, b#0, b#0);
    assume ExtremeNat.__default.Q_h#canCall(o#0, b#0, b#0);
    assert {:id "id910"} {:subsumption 0} ExtremeNat.__default.Q_h#canCall(o#0, b#0, b#0)
       ==> ExtremeNat.__default.Q_h(o#0, b#0, b#0) || 0 < o#0;
    assert {:id "id911"} {:subsumption 0} ExtremeNat.__default.Q_h#canCall(o#0, b#0, b#0)
       ==> ExtremeNat.__default.Q_h(o#0, b#0, b#0) || b#0 == b#0;
    assume {:id "id912"} ExtremeNat.__default.Q_h(o#0, b#0, b#0);
}
