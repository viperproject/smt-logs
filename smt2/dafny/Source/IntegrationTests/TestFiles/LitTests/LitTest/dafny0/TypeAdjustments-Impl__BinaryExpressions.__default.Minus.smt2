...
(assert  (and (and (and (and (= (Ctor FieldType) 6) (= (Ctor refType) 7)) (forall ((arg0@@2 T@T) (arg1 T@T) ) (! (= (Ctor (MapType0Type arg0@@2 arg1)) 8)
...
(set-info :boogie-vc-id Impl$$BinaryExpressions.__default.Minus)
