...
(declare-fun Basic.U.K1 (T@U T@U T@U T@U) Int)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |Basic.U.K1#canCall| (T@U T@U T@U T@U) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap T@U) ($Heap T@U) (this T@U) (|u#0| T@U) ) (!  (=> (or (|Basic.U.K1#canCall| $prevHeap $Heap this |u#0|) (and (< 1 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap) ($IsGoodHeap $Heap)) ($HeapSucc $prevHeap $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass.Basic.U) ($IsAlloc refType this Tclass.Basic.U $prevHeap)))) ($Is refType |u#0| Tclass.Basic.U)))) (= (Basic.U.K1 $prevHeap $Heap this |u#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap |u#0|) Basic.U.aa)))))
 :qid |TwostateFunctionsdfy.26:23|
 :skolemid |614|
 :pattern ( (Basic.U.K1 $prevHeap $Heap this |u#0|) ($IsGoodHeap $Heap))
))))
...
(assert (forall (($prevHeap@@0 T@U) ($h0 T@U) ($h1 T@U) (this@@0 T@U) (|u#0@@0| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass.Basic.U))) (or (|Basic.U.K1#canCall| $prevHeap@@0 $h0 this@@0 |u#0@@0|) ($Is refType |u#0@@0| Tclass.Basic.U))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@0 T@U) ($f T@U) ) (! true
 :qid |unknown.0:0|
 :skolemid |610|
)) (= (Basic.U.K1 $prevHeap@@0 $h0 this@@0 |u#0@@0|) (Basic.U.K1 $prevHeap@@0 $h1 this@@0 |u#0@@0|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |611|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (Basic.U.K1 $prevHeap@@0 $h1 this@@0 |u#0@@0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@1 T@U) ($Heap@@0 T@U) (this@@1 T@U) (|u#0@@1| T@U) ) (!  (=> (or (|Basic.U.K1#canCall| $prevHeap@@1 $Heap@@0 this@@1 (Lit refType |u#0@@1|)) (and (< 1 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@1) ($IsGoodHeap $Heap@@0)) ($HeapSucc $prevHeap@@1 $Heap@@0)) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass.Basic.U) ($IsAlloc refType this@@1 Tclass.Basic.U $prevHeap@@1)))) ($Is refType |u#0@@1| Tclass.Basic.U)))) (= (Basic.U.K1 $prevHeap@@1 $Heap@@0 this@@1 (Lit refType |u#0@@1|)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@1 (Lit refType |u#0@@1|)) Basic.U.aa)))))
 :qid |TwostateFunctionsdfy.26:23|
 :weight 3
 :skolemid |615|
 :pattern ( (Basic.U.K1 $prevHeap@@1 $Heap@@0 this@@1 (Lit refType |u#0@@1|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@2 T@U) ($Heap@@1 T@U) (this@@2 T@U) (|u#0@@2| T@U) ) (!  (=> (or (|Basic.U.K1#canCall| $prevHeap@@2 $Heap@@1 (Lit refType this@@2) (Lit refType |u#0@@2|)) (and (< 1 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@2) ($IsGoodHeap $Heap@@1)) ($HeapSucc $prevHeap@@2 $Heap@@1)) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass.Basic.U) ($IsAlloc refType this@@2 Tclass.Basic.U $prevHeap@@2)))) ($Is refType |u#0@@2| Tclass.Basic.U)))) (= (Basic.U.K1 $prevHeap@@2 $Heap@@1 (Lit refType this@@2) (Lit refType |u#0@@2|)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@2 (Lit refType |u#0@@2|)) Basic.U.aa)))))
 :qid |TwostateFunctionsdfy.26:23|
 :weight 3
 :skolemid |616|
 :pattern ( (Basic.U.K1 $prevHeap@@2 $Heap@@1 (Lit refType this@@2) (Lit refType |u#0@@2|)) ($IsGoodHeap $Heap@@1))
))))
...
(set-info :boogie-vc-id CheckWellformed$$Basic.U.K1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= |u#0@@3| null)) (not true))) (=> (or (not (= |u#0@@3| null)) (not true)) (=> (= (ControlFlow 0 3) (- 0 2)) ($IsAlloc refType |u#0@@3| Tclass.Basic.U $Heap@@2))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null current$Heap alloc false)) (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.Basic.U) ($IsAlloc refType this@@3 Tclass.Basic.U previous$Heap)))) (=> (and (and (and ($Is refType |u#0@@3| Tclass.Basic.U) ($IsAlloc refType |u#0@@3| Tclass.Basic.U previous$Heap)) (= 1 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@2) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 6) 5))) anon0_correct))))
