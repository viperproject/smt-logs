...
(set-info :boogie-vc-id CheckWellFormed$$_module.Node.__ctor)
...
(let ((anon9_Else_correct  (=> (or (not (= |next#0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= |next#0| null)) (not true))) (=> (or (not (= |next#0| null)) (not true)) (=> (= (ControlFlow 0 3) 1) anon7_correct))))))
(let ((anon9_Then_correct  (=> (and (= |next#0| null) (= (ControlFlow 0 2) 1)) anon7_correct)))
...
)) ($HeapSucc $Heap@@1 $Heap@0))) (=> (and (and (and (or (not (= this@0 null)) (not true)) (and ($Is refType this@0 Tclass._module.Node) ($IsAlloc refType this@0 Tclass._module.Node $Heap@0))) ($IsAllocBox ($Box refType this@0) Tclass._module.Node? $Heap@0)) (and (|_module.Node.Valid#canCall| $Heap@0 this@0) (_module.Node.Valid ($LS $LZ) $Heap@0 this@0))) (and (=> (= (ControlFlow 0 5) 2) anon9_Then_correct) (=> (= (ControlFlow 0 5) 3) anon9_Else_correct))))))
(let ((anon8_Else_correct  (=> (and (=> (or (not (= |next#0| null)) (not true)) (_module.Node.Valid ($LS $LZ) $Heap@@1 |next#0|)) (= (ControlFlow 0 8) 5)) anon4_correct)))
(let ((anon8_Then_correct  (=> (or (not (= |next#0| null)) (not true)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (not (= |next#0| null)) (not true))) (=> (or (not (= |next#0| null)) (not true)) (=> (and (and ($IsAllocBox ($Box refType |next#0|) Tclass._module.Node? $Heap@@1) (|_module.Node.Valid#canCall| $Heap@@1 |next#0|)) (and (_module.Node.Valid ($LS $LZ) $Heap@@1 |next#0|) (= (ControlFlow 0 6) 5))) anon4_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (and (=> (= (ControlFlow 0 9) 6) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and ($Is refType |next#0| Tclass._module.Node?) ($IsAlloc refType |next#0| Tclass._module.Node? $Heap@@1)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct))))
