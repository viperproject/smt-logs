...
(declare-fun _module._default.middle$G@@3 () T@U)
(set-info :boogie-vc-id CheckWellformed$$_module.__default.middle)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= (LitInt 2) 0)) (not true))) (=> (or (not (= (LitInt 2) 0)) (not true)) (=> (= (ControlFlow 0 3) (- 0 2)) (and (<= 0 (Div (|Seq#Length| |s#0@@3|) (LitInt 2))) (< (Div (|Seq#Length| |s#0@@3|) (LitInt 2)) (|Seq#Length| |s#0@@3|))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= (LitInt 2) 0)) (not true))) (=> (or (not (= (LitInt 2) 0)) (not true)) (=> (= (Mod (|Seq#Length| |s#0@@3|) (LitInt 2)) (LitInt 1)) (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 3) anon5_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) ($Is SeqType |s#0@@3| (TSeq _module._default.middle$G@@3))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 7) 5))) anon0_correct)))
