...
(declare-fun |h#0@0| () (_ BitVec 8))
(declare-fun U_2_bv8 (T@U) (_ BitVec 8))
(declare-fun bv8Type () T@T)
(declare-fun bv8_2_U ((_ BitVec 8)) T@U)
(declare-fun |k#0@0| () (_ BitVec 8))
(declare-fun |h#0@1| () (_ BitVec 8))
(declare-fun |k#0@1| () (_ BitVec 8))
(declare-fun |h#0@2| () (_ BitVec 8))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |h#0@0| (U_2_bv8 (Lit bv8Type (bv8_2_U #x05))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= (U_2_bv8 (Lit bv8Type (bv8_2_U #x80))) #x00)) (not true))) (=> (or (not (= (U_2_bv8 (Lit bv8Type (bv8_2_U #x80))) #x00)) (not true)) (=> (= |k#0@0| (bvudiv (bvmul |h#0@0| #x80) #x80)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= |k#0@0| (U_2_bv8 (Lit bv8Type (bv8_2_U #x01))))) (=> (= |k#0@0| (U_2_bv8 (Lit bv8Type (bv8_2_U #x01)))) (=> (= |h#0@1| (U_2_bv8 (Lit bv8Type (bv8_2_U #x03)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= (U_2_bv8 (Lit bv8Type (bv8_2_U #x80))) #x00)) (not true))) (=> (or (not (= (U_2_bv8 (Lit bv8Type (bv8_2_U #x80))) #x00)) (not true)) (=> (= |k#0@1| (bvudiv (bvmul |h#0@1| #x80) #x80)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= |k#0@1| (U_2_bv8 (Lit bv8Type (bv8_2_U #x01))))) (=> (= |k#0@1| (U_2_bv8 (Lit bv8Type (bv8_2_U #x01)))) (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= |h#0@2| #x00)) (not true)))))))))))))))))
