...
(declare-fun |lambda#40| (T@U T@U T@U T@U T@U T@U) T@U)
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) (|l#5| T@U) ($o@@4 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#40| |l#0| |l#1| |l#2| |l#3| |l#4| |l#5|) $o@@4 $f))  (=> (and (or (not (= $o@@4 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@4) |l#2|)))) (or (or (= $o@@4 |l#3|) (= $o@@4 |l#4|)) (= $o@@4 |l#5|))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1375|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#40| |l#0| |l#1| |l#2| |l#3| |l#4| |l#5|) $o@@4 $f))
)))
...
(set-info :boogie-vc-id Impl$$_module.ArrayTests.M3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#40| null $Heap alloc this ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.ArrayTests.b)) |a#0|)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (and (<= 0 (LitInt 7)) (< (LitInt 7) (_System.array.Length |a#0|)))) (=> (and (<= 0 (LitInt 7)) (< (LitInt 7) (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField (LitInt 7))))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField (LitInt 7)))) (=> (= |$rhs#0@0| (LitInt 13)) (=> (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap |a#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField (LitInt 7)) ($Box intType (int_2_U |$rhs#0@0|))))) ($IsGoodHeap $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this) _module.ArrayTests.b)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this) _module.ArrayTests.b)) null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 (LitInt 7)) (< (LitInt 7) (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this) _module.ArrayTests.b)))))) (=> (and (<= 0 (LitInt 7)) (< (LitInt 7) (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this) _module.ArrayTests.b))))) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this) _module.ArrayTests.b)) (IndexField (LitInt 7))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.ArrayTests) ($IsAlloc refType this Tclass._module.ArrayTests $Heap))) (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap))) (and (and (= 0 $FunctionContextHeight) (<= (LitInt 10) (_System.array.Length |a#0|))) (and (<= (LitInt 10) (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.ArrayTests.b)))) (= (ControlFlow 0 8) 2)))) anon0_correct))))
