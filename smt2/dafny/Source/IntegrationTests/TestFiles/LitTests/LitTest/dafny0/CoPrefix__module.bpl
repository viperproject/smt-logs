...
procedure {:verboseName "append (well-formedness)"} CheckWellformed$$_module.__default.append(M#0: DatatypeType where $Is(M#0, Tclass._module.Stream()), 
...
procedure {:verboseName "atmost (well-formedness)"} CheckWellformed$$_module.__default.atmost(a#0: DatatypeType where $Is(a#0, Tclass._module.Stream()), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "atmost (well-formedness)"} CheckWellformed$$_module.__default.atmost(a#0: DatatypeType, b#0: DatatypeType)
{
  ...
  var ##b#0: DatatypeType;
    ...
    else
    {
        ...
        {
            assume {:id "id95"} _module.__default.atmost($LS($LZ), a#0, b#0) == Lit(true);
            assume true;
        ...
        else if (a#0 == #_module.Stream.Cons(_mcc#0#0, _mcc#1#0))
        {
            ...
            havoc t#Z#0;
            assume {:id "id88"} let#0#0#0 == _mcc#1#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#0#0#0, Tclass._module.Stream());
            assume {:id "id89"} t#Z#0 == let#0#0#0;
            havoc h#Z#0;
            assume {:id "id90"} let#1#0#0 == _mcc#0#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#1#0#0, TInt);
            assume {:id "id91"} h#Z#0 == let#1#0#0;
            if (_module.Stream.Cons_q(b#0))
            {
                assert {:id "id92"} _module.Stream.Cons_q(b#0);
            }
            ...
            if (_module.Stream.Cons_q(b#0) && h#Z#0 <= _module.Stream.head(b#0))
            {
                ...
                assert {:id "id93"} _module.Stream.Cons_q(b#0);
            ...
            assume {:id "id94"} _module.__default.atmost($LS($LZ), a#0, b#0)
               == (
                _module.Stream.Cons_q(b#0)
...
axiom {:id "id98"} 2 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, _k#0: Box, a#0: DatatypeType, b#0: DatatypeType :: 
    ...
    _module.__default.atmost_h#canCall(Lit(_k#0), Lit(a#0), Lit(b#0))
       ...
       ==> (0 < ORD#Offset(_k#0)
           ==> 
          !Lit(_module.Stream.Nil_q(Lit(a#0)))
           ==> (var t#9 := Lit(_module.Stream.tail(Lit(a#0))); 
            (var h#9 := LitInt(_module.Stream.head(Lit(a#0))); 
              Lit(_module.Stream.Cons_q(Lit(b#0)))
                 ==> 
                h#9 <= LitInt(_module.Stream.head(Lit(b#0)))
                 ==> _module.__default.atmost_h#canCall(ORD#Minus(_k#0, ORD#FromNat(1)), t#9, Lit(_module.Stream.tail(Lit(b#0)))))))
         && (
          (0 < ORD#Offset(_k#0)
           ==> (if _module.Stream.Nil_q(Lit(a#0))
             then true
             else (var t#10 := Lit(_module.Stream.tail(Lit(a#0))); 
              (var h#10 := LitInt(_module.Stream.head(Lit(a#0))); 
                _module.Stream.Cons_q(Lit(b#0))
                   && h#10 <= LitInt(_module.Stream.head(Lit(b#0)))
                   && _module.__default.atmost_h($LS($ly), 
                    ORD#Minus(_k#0, ORD#FromNat(1)), 
                    t#10, 
                    Lit(_module.Stream.tail(Lit(b#0))))))))
           ==> 
          LitInt(0) == ORD#Offset(_k#0)
           ==> (forall _k'#2: Box :: 
         ...
         && _module.__default.atmost_h($LS($ly), Lit(_k#0), Lit(a#0), Lit(b#0))
           == ((0 < ORD#Offset(_k#0)
               ==> (if _module.Stream.Nil_q(Lit(a#0))
                 then true
                 else (var t#8 := Lit(_module.Stream.tail(Lit(a#0))); 
                  (var h#8 := LitInt(_module.Stream.head(Lit(a#0))); 
                    _module.Stream.Cons_q(Lit(b#0))
                       && h#8 <= LitInt(_module.Stream.head(Lit(b#0)))
                       && _module.__default.atmost_h($LS($ly), 
                        ORD#Minus(_k#0, ORD#FromNat(1)), 
                        t#8, 
                        Lit(_module.Stream.tail(Lit(b#0))))))))
...
procedure {:verboseName "Theorem0 (well-formedness)"} CheckWellFormed$$_module.__default.Theorem0();
  free requires 3 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Theorem0 (call)"} Call$$_module.__default.Theorem0();
  modifies $Heap;
  ...
  free ensures {:id "id100"} _module.__default.atmost#canCall(Lit(_module.__default.zeros($LS($LZ))), Lit(_module.__default.ones($LS($LZ))))
     && 
    Lit(_module.__default.atmost($LS($LZ), 
        Lit(_module.__default.zeros($LS($LZ))), 
        Lit(_module.__default.ones($LS($LZ)))))
     && (if _module.Stream.Nil_q(Lit(_module.__default.zeros($LS($LZ))))
       then true
       else (var t#1 := Lit(_module.Stream.tail(Lit(_module.__default.zeros($LS($LZ))))); 
        (var h#1 := LitInt(_module.Stream.head(Lit(_module.__default.zeros($LS($LZ))))); 
          _module.Stream.Cons_q(Lit(_module.__default.ones($LS($LZ))))
             && h#1 <= LitInt(_module.Stream.head(Lit(_module.__default.ones($LS($LZ)))))
             && _module.__default.atmost($LS($LZ), t#1, Lit(_module.Stream.tail(Lit(_module.__default.ones($LS($LZ)))))))));
  // frame condition
...
procedure {:verboseName "Theorem0# (co-call)"} CoCall$$_module.__default.Theorem0_h(_k#0: Box);
  ...
  free ensures _module.__default.zeros#canCall()
     ...
     && _module.__default.atmost_h#canCall(_k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))));
  free ensures {:id "id101"} _module.__default.atmost_h#canCall(_k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))))
     && 
    ...
    (0 < ORD#Offset(_k#0)
       ==> (if _module.Stream.Nil_q(Lit(_module.__default.zeros($LS($LZ))))
         then true
         else (var t#3 := Lit(_module.Stream.tail(Lit(_module.__default.zeros($LS($LZ))))); 
          (var h#3 := LitInt(_module.Stream.head(Lit(_module.__default.zeros($LS($LZ))))); 
            _module.Stream.Cons_q(Lit(_module.__default.ones($LS($LZ))))
               && h#3 <= LitInt(_module.Stream.head(Lit(_module.__default.ones($LS($LZ)))))
               && _module.__default.atmost_h($LS($LZ), 
                ORD#Minus(_k#0, ORD#FromNat(1)), 
                t#3, 
                Lit(_module.Stream.tail(Lit(_module.__default.ones($LS($LZ))))))))))
     && (LitInt(0) == ORD#Offset(_k#0)
       ==> (forall _k'#0: Box :: 
        { _module.__default.atmost_h($LS($LZ), 
            _k'#0, 
...
procedure {:verboseName "Theorem0# (correctness)"} Impl$$_module.__default.Theorem0_h(_k#0: Box) returns ($_reverifyPost: bool);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap;
  // user-defined postconditions
  free ensures _module.__default.zeros#canCall()
     ...
     && _module.__default.atmost_h#canCall(_k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))));
  ensures {:id "id102"} _module.__default.atmost_h#canCall(_k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))))
     ==> _module.__default.atmost_h($LS($LZ), 
        _k#0, 
       ...
       || (0 < ORD#Offset(_k#0)
         ==> 
        Lit(_module.Stream.Nil_q(Lit(_module.__default.zeros($LS($LZ)))))
         ==> Lit(true));
  ensures {:id "id103"} _module.__default.atmost_h#canCall(_k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))))
     ==> _module.__default.atmost_h($LS($LZ), 
        _k#0, 
       ...
       || (0 < ORD#Offset(_k#0)
         ==> 
        !Lit(_module.Stream.Nil_q(Lit(_module.__default.zeros($LS($LZ)))))
         ==> (var t#4 := Lit(_module.Stream.tail(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
          (var h#4 := LitInt(_module.Stream.head(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
            Lit(_module.Stream.Cons_q(Lit(_module.__default.ones($LS($LS($LZ)))))))));
  ensures {:id "id104"} _module.__default.atmost_h#canCall(_k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))))
     ==> _module.__default.atmost_h($LS($LZ), 
        _k#0, 
       ...
       || (0 < ORD#Offset(_k#0)
        ...
        !Lit(_module.Stream.Nil_q(Lit(_module.__default.zeros($LS($LZ)))))
         ==> (var t#4 := Lit(_module.Stream.tail(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
          (var h#4 := LitInt(_module.Stream.head(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
            h#4 <= LitInt(_module.Stream.head(Lit(_module.__default.ones($LS($LS($LZ)))))))));
         ...
         ==> (var t#4 := Lit(_module.Stream.tail(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
          (var h#4 := LitInt(_module.Stream.head(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
            _module.__default.atmost_h($LS($LS($LZ)), 
              ORD#Minus(_k#0, ORD#FromNat(1)), 
              t#4, 
              Lit(_module.Stream.tail(Lit(_module.__default.ones($LS($LS($LZ))))))))));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Theorem0# (correctness)"} Impl$$_module.__default.Theorem0_h(_k#0: Box) returns ($_reverifyPost: bool)
{
  ...
  var $initHeapForallStmt#1_0_0: Heap;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(34,1)
    assume true;
    if (0 < ORD#Offset(_k#0))
    {
        // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(37,3)
        if (*)
        {
            // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(38,20)
            // TrCallStmt: Before ProcessCallStmt
            assert {:id "id107"} ORD#IsNat(Lit(ORD#FromNat(1)));
            assert {:id "id108"} ORD#Offset(Lit(ORD#FromNat(1))) <= ORD#Offset(_k#0);
            assume true;
            // ProcessCallStmt: CheckSubrange
            _k##0 := ORD#Minus(_k#0, ORD#FromNat(1));
            assert {:id "id109"} ORD#Less(_k##0, _k#0);
            call {:id "id110"} CoCall$$_module.__default.Theorem0_h(_k##0);
            // TrCallStmt: After ProcessCallStmt
        }
        else
        {
            // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(40,13)
            // TrCallStmt: Before ProcessCallStmt
            assert {:id "id111"} ORD#IsNat(Lit(ORD#FromNat(1)));
            assert {:id "id112"} ORD#Offset(Lit(ORD#FromNat(1))) <= ORD#Offset(_k#0);
            assume true;
            // ProcessCallStmt: CheckSubrange
            _k##1 := ORD#Minus(_k#0, ORD#FromNat(1));
            assert {:id "id113"} ORD#Less(_k##1, _k#0);
            call {:id "id114"} CoCall$$_module.__default.Theorem0_h(_k##1);
            // TrCallStmt: After ProcessCallStmt
        }
    }
    else
    {
        // ----- forall statement (call) ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(34,1)
...
procedure {:verboseName "Theorem0_Manual (well-formedness)"} CheckWellFormed$$_module.__default.Theorem0__Manual();
  free requires 4 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Theorem0_Manual (call)"} Call$$_module.__default.Theorem0__Manual();
  modifies $Heap;
  // user-defined postconditions
  free ensures _module.__default.zeros#canCall()
     && _module.__default.ones#canCall()
     && _module.__default.atmost#canCall(Lit(_module.__default.zeros($LS($LZ))), Lit(_module.__default.ones($LS($LZ))));
  free ensures {:id "id116"} _module.__default.atmost#canCall(Lit(_module.__default.zeros($LS($LZ))), Lit(_module.__default.ones($LS($LZ))))
     && 
    Lit(_module.__default.atmost($LS($LZ), 
        Lit(_module.__default.zeros($LS($LZ))), 
        Lit(_module.__default.ones($LS($LZ)))))
...
procedure {:verboseName "Theorem0_Manual (correctness)"} Impl$$_module.__default.Theorem0__Manual() returns ($_reverifyPost: bool);
  free requires 4 == $FunctionContextHeight;
  modifies $Heap;
  // user-defined postconditions
  free ensures _module.__default.zeros#canCall()
     && _module.__default.ones#canCall()
     && _module.__default.atmost#canCall(Lit(_module.__default.zeros($LS($LZ))), Lit(_module.__default.ones($LS($LZ))));
  ensures {:id "id117"} _module.__default.atmost#canCall(Lit(_module.__default.zeros($LS($LZ))), Lit(_module.__default.ones($LS($LZ))))
     ==> Lit(_module.__default.atmost($LS($LZ), 
          Lit(_module.__default.zeros($LS($LZ))), 
          Lit(_module.__default.ones($LS($LZ)))))
       || (Lit(_module.Stream.Nil_q(Lit(_module.__default.zeros($LS($LZ)))))
         ==> Lit(true));
  ensures {:id "id118"} _module.__default.atmost#canCall(Lit(_module.__default.zeros($LS($LZ))), Lit(_module.__default.ones($LS($LZ))))
     ==> Lit(_module.__default.atmost($LS($LZ), 
          Lit(_module.__default.zeros($LS($LZ))), 
          Lit(_module.__default.ones($LS($LZ)))))
       || (!Lit(_module.Stream.Nil_q(Lit(_module.__default.zeros($LS($LZ)))))
         ==> (var t#2 := Lit(_module.Stream.tail(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
          (var h#2 := LitInt(_module.Stream.head(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
            Lit(_module.Stream.Cons_q(Lit(_module.__default.ones($LS($LS($LZ)))))))));
  ensures {:id "id119"} _module.__default.atmost#canCall(Lit(_module.__default.zeros($LS($LZ))), Lit(_module.__default.ones($LS($LZ))))
     ==> Lit(_module.__default.atmost($LS($LZ), 
          Lit(_module.__default.zeros($LS($LZ))), 
          Lit(_module.__default.ones($LS($LZ)))))
       || (!Lit(_module.Stream.Nil_q(Lit(_module.__default.zeros($LS($LZ)))))
         ==> (var t#2 := Lit(_module.Stream.tail(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
          (var h#2 := LitInt(_module.Stream.head(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
            h#2 <= LitInt(_module.Stream.head(Lit(_module.__default.ones($LS($LS($LZ)))))))));
  ensures {:id "id120"} _module.__default.atmost#canCall(Lit(_module.__default.zeros($LS($LZ))), Lit(_module.__default.ones($LS($LZ))))
     ==> Lit(_module.__default.atmost($LS($LZ), 
          Lit(_module.__default.zeros($LS($LZ))), 
          Lit(_module.__default.ones($LS($LZ)))))
       || (!Lit(_module.Stream.Nil_q(Lit(_module.__default.zeros($LS($LZ)))))
         ==> (var t#2 := Lit(_module.Stream.tail(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
          (var h#2 := LitInt(_module.Stream.head(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
            _module.__default.atmost($LS($LS($LZ)), 
              t#2, 
              Lit(_module.Stream.tail(Lit(_module.__default.ones($LS($LS($LZ))))))))));
  // frame condition
  free ensures old($Heap) == $Heap;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Theorem0_Manual (correctness)"} Impl$$_module.__default.Theorem0__Manual() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var k#0_0: Box;
  var k##0_0: Box;
  var $initHeapForallStmt#0_0: Heap;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- forall statement (call) ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(47,3)
    if (*)
    {
        ...
        assume true;
        assume true;
        // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(48,19)
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        // ProcessCallStmt: CheckSubrange
        k##0_0 := k#0_0;
        call {:id "id121"} Call$$_module.__default.Theorem0__Lemma(k##0_0);
        // TrCallStmt: After ProcessCallStmt
        assume false;
    }
    else
...
procedure {:verboseName "Theorem0_TerminationFailure_ExplicitDecreases (well-formedness)"} CheckWellFormed$$_module.__default.Theorem0__TerminationFailure__ExplicitDecreases(y#0: DatatypeType
...
procedure {:verboseName "Theorem0_TerminationFailure_ExplicitDecreases (call)"} Call$$_module.__default.Theorem0__TerminationFailure__ExplicitDecreases(y#0: DatatypeType
       where $Is(y#0, Tclass._module.Natural())
         && $IsAlloc(y#0, Tclass._module.Natural(), $Heap)
         && $IsA#_module.Natural(y#0));
  modifies $Heap;
  ...
  free ensures _module.__default.zeros#canCall()
     && _module.__default.ones#canCall()
     && _module.__default.atmost#canCall(Lit(_module.__default.zeros($LS($LZ))), Lit(_module.__default.ones($LS($LZ))));
  free ensures {:id "id123"} _module.__default.atmost#canCall(Lit(_module.__default.zeros($LS($LZ))), Lit(_module.__default.ones($LS($LZ))))
     && 
    Lit(_module.__default.atmost($LS($LZ), 
        Lit(_module.__default.zeros($LS($LZ))), 
        Lit(_module.__default.ones($LS($LZ)))))
...
procedure {:verboseName "Theorem0_TerminationFailure_ExplicitDecreases# (co-call)"} CoCall$$_module.__default.Theorem0__TerminationFailure__ExplicitDecreases_h(_k#0: Box, 
    y#1: DatatypeType
  ...
  free ensures _module.__default.zeros#canCall()
     ...
     && _module.__default.atmost_h#canCall(_k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))));
  free ensures {:id "id124"} _module.__default.atmost_h#canCall(_k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))))
     && 
    _module.__default.atmost_h($LS($LZ), 
...
procedure {:verboseName "Theorem0_TerminationFailure_ExplicitDecreases# (correctness)"} Impl$$_module.__default.Theorem0__TerminationFailure__ExplicitDecreases_h(_k#0: Box, 
    y#1: DatatypeType
       where $Is(y#1, Tclass._module.Natural())
         && $IsAlloc(y#1, Tclass._module.Natural(), $Heap)
         && $IsA#_module.Natural(y#1))
  ...
  free ensures _module.__default.zeros#canCall()
     ...
     && _module.__default.atmost_h#canCall(_k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))));
  ensures {:id "id125"} _module.__default.atmost_h#canCall(_k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))))
     ==> _module.__default.atmost_h($LS($LZ), 
        _k#0, 
       ...
       || (0 < ORD#Offset(_k#0)
        ...
        Lit(_module.Stream.Nil_q(Lit(_module.__default.zeros($LS($LZ)))))
         ==> Lit(true));
  ensures {:id "id126"} _module.__default.atmost_h#canCall(_k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))))
     ==> _module.__default.atmost_h($LS($LZ), 
        _k#0, 
       ...
       || (0 < ORD#Offset(_k#0)
        ...
        !Lit(_module.Stream.Nil_q(Lit(_module.__default.zeros($LS($LZ)))))
         ==> (var t#4 := Lit(_module.Stream.tail(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
          (var h#4 := LitInt(_module.Stream.head(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
            Lit(_module.Stream.Cons_q(Lit(_module.__default.ones($LS($LS($LZ)))))))));
  ensures {:id "id127"} _module.__default.atmost_h#canCall(_k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))))
     ==> _module.__default.atmost_h($LS($LZ), 
        _k#0, 
       ...
       || (0 < ORD#Offset(_k#0)
        ...
        !Lit(_module.Stream.Nil_q(Lit(_module.__default.zeros($LS($LZ)))))
         ==> (var t#4 := Lit(_module.Stream.tail(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
          (var h#4 := LitInt(_module.Stream.head(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
            h#4 <= LitInt(_module.Stream.head(Lit(_module.__default.ones($LS($LS($LZ)))))))));
  ensures {:id "id128"} _module.__default.atmost_h#canCall(_k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))))
     ==> _module.__default.atmost_h($LS($LZ), 
        _k#0, 
         ...
         ==> (var t#4 := Lit(_module.Stream.tail(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
          (var h#4 := LitInt(_module.Stream.head(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
            _module.__default.atmost_h($LS($LS($LZ)), 
              ...
              t#4, 
              Lit(_module.Stream.tail(Lit(_module.__default.ones($LS($LS($LZ))))))))));
  ensures {:id "id129"} _module.__default.atmost_h#canCall(_k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))))
     ==> _module.__default.atmost_h($LS($LZ), 
        _k#0, 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Theorem0_TerminationFailure_ExplicitDecreases# (correctness)"} Impl$$_module.__default.Theorem0__TerminationFailure__ExplicitDecreases_h(_k#0: Box, y#1: DatatypeType) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  ...
  var $initHeapForallStmt#1_0_0: Heap;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(57,1)
    assume true;
    if (0 < ORD#Offset(_k#0))
    {
        assume true;
        ...
        {
            // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(63,57)
            // TrCallStmt: Before ProcessCallStmt
            assume true;
            // ProcessCallStmt: CheckSubrange
            _k##1 := _k#0;
            ...
            // ProcessCallStmt: CheckSubrange
            y##1 := y#1;
            assert {:id "id134"} ORD#Less(_k##1, _k#0) || (_k##1 == _k#0 && DtRank(y##1) < DtRank(y#1));
            call {:id "id135"} CoCall$$_module.__default.Theorem0__TerminationFailure__ExplicitDecreases_h(_k##1, y##1);
            // TrCallStmt: After ProcessCallStmt
        }
        else if (y#1 == #_module.Natural.Succ(_mcc#0#0))
        {
            ...
            assume {:id "id130"} let#0_0_0#0#0 == _mcc#0#0;
            assume true;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#0_0_0#0#0, Tclass._module.Natural());
            assume {:id "id131"} x#0 == let#0_0_0#0#0;
            // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(61,57)
            // TrCallStmt: Before ProcessCallStmt
            assume true;
            // ProcessCallStmt: CheckSubrange
            _k##0 := _k#0;
            ...
            // ProcessCallStmt: CheckSubrange
            y##0 := x#0;
            assert {:id "id132"} ORD#Less(_k##0, _k#0) || (_k##0 == _k#0 && DtRank(y##0) < DtRank(y#1));
            call {:id "id133"} CoCall$$_module.__default.Theorem0__TerminationFailure__ExplicitDecreases_h(_k##0, y##0);
            // TrCallStmt: After ProcessCallStmt
        }
        else
        {
        ...
        // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(65,55)
        // TrCallStmt: Before ProcessCallStmt
        assert {:id "id136"} ORD#IsNat(Lit(ORD#FromNat(1)));
        assert {:id "id137"} ORD#Offset(Lit(ORD#FromNat(1))) <= ORD#Offset(_k#0);
        assume true;
        // ProcessCallStmt: CheckSubrange
        ...
        // ProcessCallStmt: CheckSubrange
        y##2 := y#1;
        assert {:id "id138"} ORD#Less(_k##2, _k#0) || (_k##2 == _k#0 && DtRank(y##2) < DtRank(y#1));
        call {:id "id139"} CoCall$$_module.__default.Theorem0__TerminationFailure__ExplicitDecreases_h(_k##2, y##2);
        // TrCallStmt: After ProcessCallStmt
    }
    else
    {
        // ----- forall statement (call) ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(57,1)
        $initHeapForallStmt#1_0_0 := $Heap;
        havoc $Heap;
        assume $initHeapForallStmt#1_0_0 == $Heap;
        assume (forall _k'#2: Box, y#2: DatatypeType :: 
          $Is(y#2, Tclass._module.Natural()) && ORD#Less(_k'#2, _k#0)
             ==> _module.__default.atmost_h($LS($LZ), 
              _k'#2, 
              Lit(_module.__default.zeros($LS($LZ))), 
              Lit(_module.__default.ones($LS($LZ)))));
...
procedure {:verboseName "Theorem0_TerminationFailure_DefaultDecreases (well-formedness)"} CheckWellFormed$$_module.__default.Theorem0__TerminationFailure__DefaultDecreases(y#0: DatatypeType
       where $Is(y#0, Tclass._module.Natural())
         && $IsAlloc(y#0, Tclass._module.Natural(), $Heap)
         && $IsA#_module.Natural(y#0));
  free requires 3 == $FunctionContextHeight;
...
procedure {:verboseName "Theorem0_TerminationFailure_DefaultDecreases (call)"} Call$$_module.__default.Theorem0__TerminationFailure__DefaultDecreases(y#0: DatatypeType
       where $Is(y#0, Tclass._module.Natural())
         && $IsAlloc(y#0, Tclass._module.Natural(), $Heap)
         && $IsA#_module.Natural(y#0));
  modifies $Heap;
  ...
  free ensures _module.__default.zeros#canCall()
     && _module.__default.ones#canCall()
     && _module.__default.atmost#canCall(Lit(_module.__default.zeros($LS($LZ))), Lit(_module.__default.ones($LS($LZ))));
  free ensures {:id "id141"} _module.__default.atmost#canCall(Lit(_module.__default.zeros($LS($LZ))), Lit(_module.__default.ones($LS($LZ))))
     && 
    Lit(_module.__default.atmost($LS($LZ), 
        Lit(_module.__default.zeros($LS($LZ))), 
        Lit(_module.__default.ones($LS($LZ)))))
...
procedure {:verboseName "Theorem0_TerminationFailure_DefaultDecreases# (co-call)"} CoCall$$_module.__default.Theorem0__TerminationFailure__DefaultDecreases_h(_k#0: Box, 
    y#1: DatatypeType
       where $Is(y#1, Tclass._module.Natural())
         && $IsAlloc(y#1, Tclass._module.Natural(), $Heap)
         && $IsA#_module.Natural(y#1));
  ...
  free ensures _module.__default.zeros#canCall()
     ...
     && _module.__default.atmost_h#canCall(_k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))));
  free ensures {:id "id142"} _module.__default.atmost_h#canCall(_k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))))
     && 
    _module.__default.atmost_h($LS($LZ), 
...
procedure {:verboseName "Theorem0_TerminationFailure_DefaultDecreases# (correctness)"} Impl$$_module.__default.Theorem0__TerminationFailure__DefaultDecreases_h(_k#0: Box, 
    y#1: DatatypeType
       where $Is(y#1, Tclass._module.Natural())
         && $IsAlloc(y#1, Tclass._module.Natural(), $Heap)
         && $IsA#_module.Natural(y#1))
  ...
  free ensures _module.__default.zeros#canCall()
     ...
     && _module.__default.atmost_h#canCall(_k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))));
  ensures {:id "id143"} _module.__default.atmost_h#canCall(_k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))))
     ==> _module.__default.atmost_h($LS($LZ), 
        _k#0, 
       ...
       || (0 < ORD#Offset(_k#0)
        ...
        Lit(_module.Stream.Nil_q(Lit(_module.__default.zeros($LS($LZ)))))
         ==> Lit(true));
  ensures {:id "id144"} _module.__default.atmost_h#canCall(_k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))))
     ==> _module.__default.atmost_h($LS($LZ), 
        _k#0, 
       ...
       || (0 < ORD#Offset(_k#0)
        ...
        !Lit(_module.Stream.Nil_q(Lit(_module.__default.zeros($LS($LZ)))))
         ==> (var t#4 := Lit(_module.Stream.tail(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
          (var h#4 := LitInt(_module.Stream.head(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
            Lit(_module.Stream.Cons_q(Lit(_module.__default.ones($LS($LS($LZ)))))))));
  ensures {:id "id145"} _module.__default.atmost_h#canCall(_k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))))
     ==> _module.__default.atmost_h($LS($LZ), 
        _k#0, 
       ...
       || (0 < ORD#Offset(_k#0)
        ...
        !Lit(_module.Stream.Nil_q(Lit(_module.__default.zeros($LS($LZ)))))
         ==> (var t#4 := Lit(_module.Stream.tail(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
          (var h#4 := LitInt(_module.Stream.head(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
            h#4 <= LitInt(_module.Stream.head(Lit(_module.__default.ones($LS($LS($LZ)))))))));
  ensures {:id "id146"} _module.__default.atmost_h#canCall(_k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))))
     ==> _module.__default.atmost_h($LS($LZ), 
        _k#0, 
         ...
         ==> (var t#4 := Lit(_module.Stream.tail(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
          (var h#4 := LitInt(_module.Stream.head(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
            _module.__default.atmost_h($LS($LS($LZ)), 
              ...
              t#4, 
              Lit(_module.Stream.tail(Lit(_module.__default.ones($LS($LS($LZ))))))))));
  ensures {:id "id147"} _module.__default.atmost_h#canCall(_k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))))
     ==> _module.__default.atmost_h($LS($LZ), 
        _k#0, 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Theorem0_TerminationFailure_DefaultDecreases# (correctness)"} Impl$$_module.__default.Theorem0__TerminationFailure__DefaultDecreases_h(_k#0: Box, y#1: DatatypeType) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var _mcc#0#0: DatatypeType;
  ...
  var $initHeapForallStmt#1_0_0: Heap;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(70,1)
    assume true;
    if (0 < ORD#Offset(_k#0))
    {
        assume true;
        ...
        if (y#1 == #_module.Natural.Zero())
        {
            // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(76,56)
            // TrCallStmt: Before ProcessCallStmt
            assume true;
            // ProcessCallStmt: CheckSubrange
            _k##1 := _k#0;
            ...
            // ProcessCallStmt: CheckSubrange
            y##1 := y#1;
            assert {:id "id152"} ORD#Less(_k##1, _k#0) || (_k##1 == _k#0 && DtRank(y##1) < DtRank(y#1));
            call {:id "id153"} CoCall$$_module.__default.Theorem0__TerminationFailure__DefaultDecreases_h(_k##1, y##1);
            // TrCallStmt: After ProcessCallStmt
        }
        else if (y#1 == #_module.Natural.Succ(_mcc#0#0))
        {
            ...
            assume {:id "id148"} let#0_0_0#0#0 == _mcc#0#0;
            assume true;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#0_0_0#0#0, Tclass._module.Natural());
            assume {:id "id149"} yy#0 == let#0_0_0#0#0;
            // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(74,56)
            // TrCallStmt: Before ProcessCallStmt
            assume true;
            // ProcessCallStmt: CheckSubrange
            _k##0 := _k#0;
            ...
            // ProcessCallStmt: CheckSubrange
            y##0 := yy#0;
            assert {:id "id150"} ORD#Less(_k##0, _k#0) || (_k##0 == _k#0 && DtRank(y##0) < DtRank(y#1));
            call {:id "id151"} CoCall$$_module.__default.Theorem0__TerminationFailure__DefaultDecreases_h(_k##0, y##0);
            // TrCallStmt: After ProcessCallStmt
        }
        else
        {
        ...
        // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(78,54)
        // TrCallStmt: Before ProcessCallStmt
        ...
        // ProcessCallStmt: CheckSubrange
        y##2 := y#1;
        assert {:id "id156"} ORD#Less(_k##2, _k#0) || (_k##2 == _k#0 && DtRank(y##2) < DtRank(y#1));
        call {:id "id157"} CoCall$$_module.__default.Theorem0__TerminationFailure__DefaultDecreases_h(_k##2, y##2);
        // TrCallStmt: After ProcessCallStmt
    }
    else
    {
        // ----- forall statement (call) ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(70,1)
        $initHeapForallStmt#1_0_0 := $Heap;
        havoc $Heap;
        assume $initHeapForallStmt#1_0_0 == $Heap;
        assume (forall _k'#2: Box, y#2: DatatypeType :: 
...
procedure {:verboseName "Theorem0_Lemma (well-formedness)"} CheckWellFormed$$_module.__default.Theorem0__Lemma(k#0: Box);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Theorem0_Lemma (call)"} Call$$_module.__default.Theorem0__Lemma(k#0: Box);
  modifies $Heap;
  // user-defined postconditions
  free ensures _module.__default.zeros#canCall()
     && _module.__default.ones#canCall()
     && _module.__default.atmost_h#canCall(k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))));
  free ensures {:id "id159"} _module.__default.atmost_h#canCall(k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))))
     && 
    _module.__default.atmost_h($LS($LZ), 
...
procedure {:verboseName "Theorem0_Lemma (correctness)"} Impl$$_module.__default.Theorem0__Lemma(k#0: Box) returns ($_reverifyPost: bool);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap;
  // user-defined postconditions
  free ensures _module.__default.zeros#canCall()
     ...
     && _module.__default.atmost_h#canCall(k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))));
  ensures {:id "id160"} _module.__default.atmost_h#canCall(k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))))
     ==> _module.__default.atmost_h($LS($LZ), 
        k#0, 
       ...
       || (0 < ORD#Offset(k#0)
        ...
        Lit(_module.Stream.Nil_q(Lit(_module.__default.zeros($LS($LZ)))))
         ==> Lit(true));
  ensures {:id "id161"} _module.__default.atmost_h#canCall(k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))))
     ==> _module.__default.atmost_h($LS($LZ), 
        k#0, 
       ...
       || (0 < ORD#Offset(k#0)
        ...
        !Lit(_module.Stream.Nil_q(Lit(_module.__default.zeros($LS($LZ)))))
         ==> (var t#2 := Lit(_module.Stream.tail(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
          (var h#2 := LitInt(_module.Stream.head(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
            Lit(_module.Stream.Cons_q(Lit(_module.__default.ones($LS($LS($LZ)))))))));
  ensures {:id "id162"} _module.__default.atmost_h#canCall(k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))))
     ==> _module.__default.atmost_h($LS($LZ), 
        k#0, 
       ...
       || (0 < ORD#Offset(k#0)
        ...
        !Lit(_module.Stream.Nil_q(Lit(_module.__default.zeros($LS($LZ)))))
         ==> (var t#2 := Lit(_module.Stream.tail(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
          (var h#2 := LitInt(_module.Stream.head(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
            h#2 <= LitInt(_module.Stream.head(Lit(_module.__default.ones($LS($LS($LZ)))))))));
  ensures {:id "id163"} _module.__default.atmost_h#canCall(k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))))
     ==> _module.__default.atmost_h($LS($LZ), 
        k#0, 
         ...
         ==> (var t#2 := Lit(_module.Stream.tail(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
          (var h#2 := LitInt(_module.Stream.head(Lit(_module.__default.zeros($LS($LS($LZ)))))); 
            _module.__default.atmost_h($LS($LS($LZ)), 
              ...
              t#2, 
              Lit(_module.Stream.tail(Lit(_module.__default.ones($LS($LS($LZ))))))))));
  ensures {:id "id164"} _module.__default.atmost_h#canCall(k#0, 
      Lit(_module.__default.zeros($LS($LZ))), 
      Lit(_module.__default.ones($LS($LZ))))
     ==> _module.__default.atmost_h($LS($LZ), 
        k#0, 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Theorem0_Lemma (correctness)"} Impl$$_module.__default.Theorem0__Lemma(k#0: Box) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
...
procedure {:verboseName "Theorem1 (well-formedness)"} CheckWellFormed$$_module.__default.Theorem1();
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Theorem1 (call)"} Call$$_module.__default.Theorem1();
  modifies $Heap;
  // user-defined postconditions
  free ensures $IsA#_module.Stream(Lit(_module.__default.append($LS($LZ), 
    ...
    _module.__default.zeros#canCall()
     ...
     && _module.__default.zeros#canCall();
  ensures {:id "id166"} $Eq#_module.Stream($LS($LS($LZ)), 
...
procedure {:verboseName "Theorem1# (co-call)"} CoCall$$_module.__default.Theorem1_h(_k#0: Box);
  ...
  free ensures _module.__default.zeros#canCall()
     ...
     && _module.__default.append#canCall(Lit(_module.__default.zeros($LS($LZ))), Lit(_module.__default.ones($LS($LZ))))
     && _module.__default.zeros#canCall();
  free ensures {:id "id167"} $PrefixEq#_module.Stream(_k#0, 
    $LS($LS($LZ)), 
...
procedure {:verboseName "Theorem1# (correctness)"} Impl$$_module.__default.Theorem1_h(_k#0: Box) returns ($_reverifyPost: bool);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap;
  // user-defined postconditions
  free ensures _module.__default.zeros#canCall()
     ...
     && _module.__default.append#canCall(Lit(_module.__default.zeros($LS($LZ))), Lit(_module.__default.ones($LS($LZ))))
     && _module.__default.zeros#canCall();
  ensures {:id "id168"} $PrefixEq#_module.Stream(_k#0, 
      $LS($LS($LZ)), 
      Lit(_module.__default.append($LS($LZ), 
          Lit(_module.__default.zeros($LS($LZ))), 
          Lit(_module.__default.ones($LS($LZ))))), 
  ...
  ensures {:id "id169"} $PrefixEq#_module.Stream(_k#0, 
      $LS($LS($LZ)), 
      Lit(_module.__default.append($LS($LZ), 
          Lit(_module.__default.zeros($LS($LZ))), 
          Lit(_module.__default.ones($LS($LZ))))), 
  ...
  ensures {:id "id170"} $PrefixEq#_module.Stream(_k#0, 
      $LS($LS($LZ)), 
      Lit(_module.__default.append($LS($LZ), 
          Lit(_module.__default.zeros($LS($LZ))), 
          Lit(_module.__default.ones($LS($LZ))))), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Theorem1# (correctness)"} Impl$$_module.__default.Theorem1_h(_k#0: Box) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var _k##0: Box;
  var $initHeapForallStmt#1_0_0: Heap;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(88,1)
    assume true;
    if (0 < ORD#Offset(_k#0))
    {
        // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(89,11)
        // TrCallStmt: Before ProcessCallStmt
        ...
        // ProcessCallStmt: CheckSubrange
        _k##0 := ORD#Minus(_k#0, ORD#FromNat(1));
        call {:id "id173"} CoCall$$_module.__default.Theorem1_h(_k##0);
        // TrCallStmt: After ProcessCallStmt
    }
    else
    {
        // ----- forall statement (call) ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(88,1)
        $initHeapForallStmt#1_0_0 := $Heap;
        havoc $Heap;
        assume $initHeapForallStmt#1_0_0 == $Heap;
        assume (forall _k'#0: Box :: 
          { $PrefixEq#_module.Stream(_k'#0, 
              $LS($LS($LZ)), 
              _module.__default.append($LS($LZ), _module.__default.zeros($LS($LZ)), _module.__default.ones($LS($LZ))), 
              _module.__default.zeros($LS($LZ))) } 
            { ORD#Less(_k'#0, _k#0) } 
          ORD#Less(_k'#0, _k#0)
             ==> $PrefixEq#_module.Stream(_k'#0, 
...
axiom 1 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, n#0: int :: 
    ...
    _module.__default.UpIList#canCall(n#0) || 1 < $FunctionContextHeight
...
procedure {:verboseName "UpIList (well-formedness)"} CheckWellformed$$_module.__default.UpIList(n#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
axiom {:id "id176"} 1 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, s#0: DatatypeType :: 
    ...
    _module.__default.Pos#canCall(s#0)
         || (1 < $FunctionContextHeight && $Is(s#0, Tclass._module.IList()))
...
procedure {:verboseName "Pos (well-formedness)"} CheckWellformed$$_module.__default.Pos(s#0: DatatypeType where $Is(s#0, Tclass._module.IList()));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
axiom {:id "id178"} 2 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, _k#0: Box, s#0: DatatypeType :: 
    ...
    _module.__default.Pos_h#canCall(_k#0, s#0)
         || (2 < $FunctionContextHeight && $Is(s#0, Tclass._module.IList()))
       ==> (0 < ORD#Offset(_k#0)
           ==> _module.IList.ICons_q(s#0)
             && (_module.IList.head(s#0) > 0
               ==> _module.IList.ICons_q(s#0)
...
axiom {:id "id180"} 2 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, _k#0: Box, s#0: DatatypeType :: 
    ...
    _module.__default.Pos_h#canCall(Lit(_k#0), Lit(s#0))
         || (2 < $FunctionContextHeight && $Is(s#0, Tclass._module.IList()))
       ==> (0 < ORD#Offset(_k#0)
           ==> _module.IList.ICons_q(Lit(s#0))
             && (Lit(_module.IList.head(Lit(s#0)) > 0)
               ==> _module.IList.ICons_q(Lit(s#0))
                 && _module.__default.Pos_h#canCall(ORD#Minus(_k#0, ORD#FromNat(1)), Lit(_module.IList.tail(Lit(s#0))))))
         && (
          (0 < ORD#Offset(_k#0)
           ==> _module.IList.head(Lit(s#0)) > 0
             && _module.__default.Pos_h($LS($ly), ORD#Minus(_k#0, ORD#FromNat(1)), Lit(_module.IList.tail(Lit(s#0)))))
           ==> 
          LitInt(0) == ORD#Offset(_k#0)
           ==> (forall _k'#2: Box :: 
...
procedure {:verboseName "Theorem2 (call)"} Call$$_module.__default.Theorem2(n#0: int);
  // user-defined preconditions
  requires {:id "id183"} LitInt(1) <= n#0;
  modifies $Heap;
  // user-defined postconditions
  free ensures _module.__default.UpIList#canCall(n#0)
     && _module.__default.Pos#canCall(_module.__default.UpIList($LS($LZ), n#0));
  free ensures {:id "id184"} _module.__default.Pos#canCall(_module.__default.UpIList($LS($LZ), n#0))
     && 
...
procedure {:verboseName "Theorem2# (co-call)"} CoCall$$_module.__default.Theorem2_h(_k#0: Box, n#1: int);
  // user-defined preconditions
  requires {:id "id185"} LitInt(1) <= n#1;
  modifies $Heap;
  // user-defined postconditions
  ...
  free ensures {:id "id186"} _module.__default.Pos_h#canCall(_k#0, _module.__default.UpIList($LS($LZ), n#1))
     && 
...
procedure {:verboseName "Theorem2# (correctness)"} Impl$$_module.__default.Theorem2_h(_k#0: Box, n#1: int) returns ($_reverifyPost: bool);
  free requires 3 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id187"} LitInt(1) <= n#1;
  modifies $Heap;
  // user-defined postconditions
  free ensures _module.__default.UpIList#canCall(n#1)
     && _module.__default.Pos_h#canCall(_k#0, _module.__default.UpIList($LS($LZ), n#1));
  ensures {:id "id188"} _module.__default.Pos_h#canCall(_k#0, _module.__default.UpIList($LS($LZ), n#1))
     ==> _module.__default.Pos_h($LS($LZ), _k#0, _module.__default.UpIList($LS($LZ), n#1))
       || (0 < ORD#Offset(_k#0)
         ==> _module.IList.head(_module.__default.UpIList($LS($LS($LZ)), n#1)) > 0);
  ensures {:id "id189"} _module.__default.Pos_h#canCall(_k#0, _module.__default.UpIList($LS($LZ), n#1))
     ==> _module.__default.Pos_h($LS($LZ), _k#0, _module.__default.UpIList($LS($LZ), n#1))
       || (0 < ORD#Offset(_k#0)
         ==> _module.__default.Pos_h($LS($LS($LZ)), 
          ORD#Minus(_k#0, ORD#FromNat(1)), 
          _module.IList.tail(_module.__default.UpIList($LS($LS($LZ)), n#1))));
  ensures {:id "id190"} _module.__default.Pos_h#canCall(_k#0, _module.__default.UpIList($LS($LZ), n#1))
     ==> _module.__default.Pos_h($LS($LZ), _k#0, _module.__default.UpIList($LS($LZ), n#1))
       || (LitInt(0) == ORD#Offset(_k#0)
         ==> (forall _k'#1: Box :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Theorem2# (correctness)"} Impl$$_module.__default.Theorem2_h(_k#0: Box, n#1: int) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var _k##0: Box;
  var n##0: int;
  var $initHeapForallStmt#1_0_0: Heap;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(107,1)
    assume true;
    if (0 < ORD#Offset(_k#0))
    {
        // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(108,11)
        // TrCallStmt: Before ProcessCallStmt
        assert {:id "id191"} ORD#IsNat(Lit(ORD#FromNat(1)));
        assert {:id "id192"} ORD#Offset(Lit(ORD#FromNat(1))) <= ORD#Offset(_k#0);
        assume true;
        // ProcessCallStmt: CheckSubrange
        _k##0 := ORD#Minus(_k#0, ORD#FromNat(1));
        assume true;
        // ProcessCallStmt: CheckSubrange
        n##0 := n#1 + 1;
        call {:id "id193"} CoCall$$_module.__default.Theorem2_h(_k##0, n##0);
        // TrCallStmt: After ProcessCallStmt
    }
    else
    {
        // ----- forall statement (call) ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(107,1)
        $initHeapForallStmt#1_0_0 := $Heap;
        havoc $Heap;
        assume $initHeapForallStmt#1_0_0 == $Heap;
        assume (forall _k'#2: Box, n#2: int :: 
          { _module.__default.UpIList($LS($LZ), n#2), ORD#Less(_k'#2, _k#0) } 
...
procedure {:verboseName "Theorem2_NotAProof (well-formedness)"} CheckWellFormed$$_module.__default.Theorem2__NotAProof(n#0: int);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Theorem2_NotAProof (call)"} Call$$_module.__default.Theorem2__NotAProof(n#0: int);
  // user-defined preconditions
  requires {:id "id196"} LitInt(1) <= n#0;
  modifies $Heap;
  // user-defined postconditions
  free ensures _module.__default.UpIList#canCall(n#0)
     && _module.__default.Pos#canCall(_module.__default.UpIList($LS($LZ), n#0));
  free ensures {:id "id197"} _module.__default.Pos#canCall(_module.__default.UpIList($LS($LZ), n#0))
     && 
    _module.__default.Pos($LS($LZ), _module.__default.UpIList($LS($LZ), n#0))
     && 
    _module.IList.head(_module.__default.UpIList($LS($LZ), n#0)) > 0
...
procedure {:verboseName "Theorem2_NotAProof# (co-call)"} CoCall$$_module.__default.Theorem2__NotAProof_h(_k#0: Box, n#1: int);
  // user-defined preconditions
  requires {:id "id198"} LitInt(1) <= n#1;
  modifies $Heap;
  // user-defined postconditions
  free ensures _module.__default.UpIList#canCall(n#1)
     && _module.__default.Pos_h#canCall(_k#0, _module.__default.UpIList($LS($LZ), n#1));
  free ensures {:id "id199"} _module.__default.Pos_h#canCall(_k#0, _module.__default.UpIList($LS($LZ), n#1))
     && 
    _module.__default.Pos_h($LS($LZ), _k#0, _module.__default.UpIList($LS($LZ), n#1))
     && 
    (0 < ORD#Offset(_k#0)
...
procedure {:verboseName "Theorem2_NotAProof# (correctness)"} Impl$$_module.__default.Theorem2__NotAProof_h(_k#0: Box, n#1: int) returns ($_reverifyPost: bool);
  free requires 3 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id200"} LitInt(1) <= n#1;
  modifies $Heap;
  // user-defined postconditions
  free ensures _module.__default.UpIList#canCall(n#1)
     && _module.__default.Pos_h#canCall(_k#0, _module.__default.UpIList($LS($LZ), n#1));
  ensures {:id "id201"} _module.__default.Pos_h#canCall(_k#0, _module.__default.UpIList($LS($LZ), n#1))
     ==> _module.__default.Pos_h($LS($LZ), _k#0, _module.__default.UpIList($LS($LZ), n#1))
       || (0 < ORD#Offset(_k#0)
         ==> _module.IList.head(_module.__default.UpIList($LS($LS($LZ)), n#1)) > 0);
  ensures {:id "id202"} _module.__default.Pos_h#canCall(_k#0, _module.__default.UpIList($LS($LZ), n#1))
     ==> _module.__default.Pos_h($LS($LZ), _k#0, _module.__default.UpIList($LS($LZ), n#1))
       || (0 < ORD#Offset(_k#0)
         ==> _module.__default.Pos_h($LS($LS($LZ)), 
          ORD#Minus(_k#0, ORD#FromNat(1)), 
          _module.IList.tail(_module.__default.UpIList($LS($LS($LZ)), n#1))));
  ensures {:id "id203"} _module.__default.Pos_h#canCall(_k#0, _module.__default.UpIList($LS($LZ), n#1))
     ==> _module.__default.Pos_h($LS($LZ), _k#0, _module.__default.UpIList($LS($LZ), n#1))
       || (LitInt(0) == ORD#Offset(_k#0)
         ==> (forall _k'#1: Box :: 
          { _module.__default.Pos_h($LS($LS($LZ)), _k'#1, _module.__default.UpIList($LS($LS($LZ)), n#1)) } 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Theorem2_NotAProof# (correctness)"} Impl$$_module.__default.Theorem2__NotAProof_h(_k#0: Box, n#1: int) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var $initHeapForallStmt#1_0_0: Heap;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(114,1)
    assume true;
    if (0 < ORD#Offset(_k#0))
    {
    }
    ...
    {
        // ----- forall statement (call) ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(114,1)
        $initHeapForallStmt#1_0_0 := $Heap;
        havoc $Heap;
        assume $initHeapForallStmt#1_0_0 == $Heap;
        assume (forall _k'#2: Box, n#2: int :: 
...
axiom 0 <= $FunctionContextHeight
   ==> (forall _module._default.Next$T: Ty, t#0: Box :: 
    ...
    _module.__default.Next#canCall(_module._default.Next$T, t#0)
         || (0 < $FunctionContextHeight && $IsBox(t#0, _module._default.Next$T))
       ==> $IsBox(_module.__default.Next(_module._default.Next$T, t#0), _module._default.Next$T));
// alloc consequence axiom for _module.__default.Next
axiom 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, _module._default.Next$T: Ty, t#0: Box :: 
    { $IsAllocBox(_module.__default.Next(_module._default.Next$T, t#0), 
        _module._default.Next$T, 
        $Heap) } 
    (_module.__default.Next#canCall(_module._default.Next$T, t#0)
           || (0 < $FunctionContextHeight
             && 
            $IsBox(t#0, _module._default.Next$T)
             && $IsAllocBox(t#0, _module._default.Next$T, $Heap)))
         && $IsGoodHeap($Heap)
       ==> $IsAllocBox(_module.__default.Next(_module._default.Next$T, t#0), 
        _module._default.Next$T, 
        $Heap));
...
procedure {:verboseName "Next (well-formedness)"} CheckWellformed$$_module.__default.Next(_module._default.Next$T: Ty, t#0: Box where $IsBox(t#0, _module._default.Next$T));
...
axiom 1 <= $FunctionContextHeight
   ==> (forall _module._default.FF$T: Ty, $ly: LayerType, h#0: Box :: 
    ...
    _module.__default.FF#canCall(_module._default.FF$T, h#0)
         || (1 < $FunctionContextHeight && $IsBox(h#0, _module._default.FF$T))
...
axiom 1 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, _module._default.FF$T: Ty, $ly: LayerType, h#0: Box :: 
    { $IsAlloc(_module.__default.FF(_module._default.FF$T, $ly, h#0), 
        Tclass._module.TList(_module._default.FF$T), 
        $Heap) } 
    (_module.__default.FF#canCall(_module._default.FF$T, h#0)
           || (1 < $FunctionContextHeight
            ...
            $IsBox(h#0, _module._default.FF$T)
             && $IsAllocBox(h#0, _module._default.FF$T, $Heap)))
         && $IsGoodHeap($Heap)
       ==> $IsAlloc(_module.__default.FF(_module._default.FF$T, $ly, h#0), 
        Tclass._module.TList(_module._default.FF$T), 
        $Heap));
...
procedure {:verboseName "FF (well-formedness)"} CheckWellformed$$_module.__default.FF(_module._default.FF$T: Ty, h#0: Box where $IsBox(h#0, _module._default.FF$T));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
axiom 1 <= $FunctionContextHeight
   ==> (forall _module._default.GG$T: Ty, $ly: LayerType, h#0: Box :: 
    ...
    _module.__default.GG#canCall(_module._default.GG$T, h#0)
         || (1 < $FunctionContextHeight && $IsBox(h#0, _module._default.GG$T))
       ==> $Is(_module.__default.GG(_module._default.GG$T, $ly, h#0), 
        Tclass._module.TList(_module._default.GG$T)));
// alloc consequence axiom for _module.__default.GG
axiom 1 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, _module._default.GG$T: Ty, $ly: LayerType, h#0: Box :: 
    { $IsAlloc(_module.__default.GG(_module._default.GG$T, $ly, h#0), 
        Tclass._module.TList(_module._default.GG$T), 
        $Heap) } 
    (_module.__default.GG#canCall(_module._default.GG$T, h#0)
           || (1 < $FunctionContextHeight
            ...
            $IsBox(h#0, _module._default.GG$T)
             && $IsAllocBox(h#0, _module._default.GG$T, $Heap)))
         && $IsGoodHeap($Heap)
       ==> $IsAlloc(_module.__default.GG(_module._default.GG$T, $ly, h#0), 
        Tclass._module.TList(_module._default.GG$T), 
        $Heap));
...
procedure {:verboseName "GG (well-formedness)"} CheckWellformed$$_module.__default.GG(_module._default.GG$T: Ty, h#0: Box where $IsBox(h#0, _module._default.GG$T));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Compare (well-formedness)"} CheckWellFormed$$_module.__default.Compare(_module._default.Compare$T: Ty, 
    h#0: Box
...
procedure {:verboseName "Compare (call)"} Call$$_module.__default.Compare(_module._default.Compare$T: Ty, 
    h#0: Box
       where $IsBox(h#0, _module._default.Compare$T)
         && $IsAllocBox(h#0, _module._default.Compare$T, $Heap));
  modifies $Heap;
  ...
  ensures {:id "id209"} $Eq#_module.TList(_module._default.Compare$T, 
...
procedure {:verboseName "Compare# (co-call)"} CoCall$$_module.__default.Compare_h(_module._default.Compare#$T: Ty, 
    _k#0: Box, 
    h#1: Box
  ...
  free ensures {:id "id210"} $PrefixEq#_module.TList(_module._default.Compare#$T, 
    _module._default.Compare#$T, 
    _k#0, 
    $LS($LS($LZ)), 
...
procedure {:verboseName "Compare# (correctness)"} Impl$$_module.__default.Compare_h(_module._default.Compare#$T: Ty, 
    _k#0: Box, 
    h#1: Box
       where $IsBox(h#1, _module._default.Compare#$T)
         && $IsAllocBox(h#1, _module._default.Compare#$T, $Heap))
  ...
  free ensures _module.__default.FF#canCall(_module._default.Compare#$T, h#1)
     && _module.__default.GG#canCall(_module._default.Compare#$T, h#1);
  ensures {:id "id211"} $PrefixEq#_module.TList(_module._default.Compare#$T, 
      _module._default.Compare#$T, 
      _k#0, 
      $LS($LS($LZ)), 
      _module.__default.FF(_module._default.Compare#$T, $LS($LZ), h#1), 
  ...
  ensures {:id "id212"} $PrefixEq#_module.TList(_module._default.Compare#$T, 
      _module._default.Compare#$T, 
      _k#0, 
      $LS($LS($LZ)), 
      _module.__default.FF(_module._default.Compare#$T, $LS($LZ), h#1), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Compare# (correctness)"} Impl$$_module.__default.Compare_h(_module._default.Compare#$T: Ty, _k#0: Box, h#1: Box)
   returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var ##h#2: Box;
  ...
  var $initHeapForallStmt#1_0_0: Heap;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(133,1)
    assume true;
    if (0 < ORD#Offset(_k#0))
    {
        // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(134,3)
        ##h#2 := h#1;
        // assume allocatedness for argument to function
        ...
        assert {:id "id213"} {:subsumption 0} _module.TList.head(_module.__default.FF(_module._default.Compare#$T, $LS($LS($LZ)), h#1))
           == _module.TList.head(_module.__default.GG(_module._default.Compare#$T, $LS($LS($LZ)), h#1));
        assume {:id "id214"} _module.TList.head(_module.__default.FF(_module._default.Compare#$T, $LS($LZ), h#1))
           == _module.TList.head(_module.__default.GG(_module._default.Compare#$T, $LS($LZ), h#1));
        // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(135,10)
        // TrCallStmt: Before ProcessCallStmt
        ...
        call {:id "id217"} CoCall$$_module.__default.Compare_h(_module._default.Compare#$T, _k##0, h##0);
        // TrCallStmt: After ProcessCallStmt
        // ----- alternative statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(136,3)
        if (*)
        {
            assume true;
            assume {:id "id234"} true;
            // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(138,7)
            assert {:id "id235"} ORD#IsNat(Lit(ORD#FromNat(1)));
            assert {:id "id236"} ORD#Offset(Lit(ORD#FromNat(1))) <= ORD#Offset(_k#0);
            ##h#10 := h#1;
            // assume allocatedness for argument to function
            ...
            assume _module.__default.FF#canCall(_module._default.Compare#$T, h#1)
              ...
              _module.__default.GG#canCall(_module._default.Compare#$T, h#1)
               && _module.TList.TCons_q(_module.__default.GG(_module._default.Compare#$T, $LS($LZ), h#1));
            assert {:id "id237"} {:subsumption 0} $PrefixEq#_module.TList(_module._default.Compare#$T, 
                _module._default.Compare#$T, 
                ORD#Minus(_k#0, ORD#FromNat(1)), 
                $LS($LS($LZ)), 
            ...
            assert {:id "id238"} {:subsumption 0} $PrefixEq#_module.TList(_module._default.Compare#$T, 
                _module._default.Compare#$T, 
                ORD#Minus(_k#0, ORD#FromNat(1)), 
                $LS($LS($LZ)), 
                _module.TList.tail(_module.__default.FF(_module._default.Compare#$T, $LS($LZ), h#1)), 
              ...
              (0 < ORD#Offset(ORD#Minus(_k#0, ORD#FromNat(1)))
               ...
               || (ORD#Minus(_k#0, ORD#FromNat(1)) != ORD#FromNat(0)
                 ...
                 ==> $Eq#_module.TList(_module._default.Compare#$T, 
                  ...
                  _module.TList.tail(_module.__default.FF(_module._default.Compare#$T, $LS($LZ), h#1)), 
                  _module.TList.tail(_module.__default.GG(_module._default.Compare#$T, $LS($LZ), h#1))));
            assume {:id "id239"} $PrefixEq#_module.TList(_module._default.Compare#$T, 
              _module._default.Compare#$T, 
              ORD#Minus(_k#0, ORD#FromNat(1)), 
              $LS($LS($LZ)), 
              _module.TList.tail(_module.__default.FF(_module._default.Compare#$T, $LS($LZ), h#1)), 
        ...
        else if (*)
        {
            ...
            // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(140,7)
            ##h#8 := h#1;
            // assume allocatedness for argument to function
            ...
            assume _module.__default.FF#canCall(_module._default.Compare#$T, h#1)
               && _module.__default.GG#canCall(_module._default.Compare#$T, h#1);
            assert {:id "id231"} {:subsumption 0} $PrefixEq#_module.TList(_module._default.Compare#$T, 
                _module._default.Compare#$T, 
                _k#0, 
                $LS($LS($LZ)), 
                _module.__default.FF(_module._default.Compare#$T, $LS($LZ), h#1), 
                 ...
                 ==> _module.TList.TCons_q(_module.__default.GG(_module._default.Compare#$T, $LS($LS($LZ)), h#1))
                  ...
                  _module.TList.head(_module.__default.FF(_module._default.Compare#$T, $LS($LS($LZ)), h#1))
                   ...
                   && $PrefixEq#_module.TList(_module._default.Compare#$T, 
                    ...
                    _module.TList.tail(_module.__default.FF(_module._default.Compare#$T, $LS($LS($LZ)), h#1)), 
                    _module.TList.tail(_module.__default.GG(_module._default.Compare#$T, $LS($LS($LZ)), h#1))));
            assert {:id "id232"} {:subsumption 0} $PrefixEq#_module.TList(_module._default.Compare#$T, 
                _module._default.Compare#$T, 
                _k#0, 
                $LS($LS($LZ)), 
                _module.__default.FF(_module._default.Compare#$T, $LS($LZ), h#1), 
              ...
              (0 < ORD#Offset(_k#0)
               ...
               || (_k#0 != ORD#FromNat(0) && ORD#IsLimit(_k#0)
                 ==> $Eq#_module.TList(_module._default.Compare#$T, 
                  ...
                  _module.__default.FF(_module._default.Compare#$T, $LS($LZ), h#1), 
                  _module.__default.GG(_module._default.Compare#$T, $LS($LZ), h#1)));
            assume {:id "id233"} $PrefixEq#_module.TList(_module._default.Compare#$T, 
              _module._default.Compare#$T, 
              _k#0, 
              $LS($LS($LZ)), 
              _module.__default.FF(_module._default.Compare#$T, $LS($LZ), h#1), 
        ...
        else if (*)
        {
            ...
            // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(142,7)
            ##h#6 := h#1;
            // assume allocatedness for argument to function
            ...
            assume _module.__default.FF#canCall(_module._default.Compare#$T, h#1)
              ...
              _module.__default.GG#canCall(_module._default.Compare#$T, h#1)
               && _module.TList.TCons_q(_module.__default.GG(_module._default.Compare#$T, $LS($LZ), h#1));
            assert {:id "id227"} {:subsumption 0} $PrefixEq#_module.TList(_module._default.Compare#$T, 
                _module._default.Compare#$T, 
                _k#0, 
                $LS($LS($LZ)), 
                _module.TList.tail(_module.__default.FF(_module._default.Compare#$T, $LS($LZ), h#1)), 
                 ...
                 ==> _module.TList.TCons_q(_module.TList.tail(_module.__default.GG(_module._default.Compare#$T, $LS($LS($LZ)), h#1)))
                  ...
                  _module.TList.head(_module.TList.tail(_module.__default.FF(_module._default.Compare#$T, $LS($LS($LZ)), h#1)))
                   ...
                   && $PrefixEq#_module.TList(_module._default.Compare#$T, 
                    ...
                    _module.TList.tail(_module.TList.tail(_module.__default.FF(_module._default.Compare#$T, $LS($LS($LZ)), h#1))), 
                    _module.TList.tail(_module.TList.tail(_module.__default.GG(_module._default.Compare#$T, $LS($LS($LZ)), h#1)))));
            assert {:id "id228"} {:subsumption 0} $PrefixEq#_module.TList(_module._default.Compare#$T, 
                _module._default.Compare#$T, 
                _k#0, 
                $LS($LS($LZ)), 
                _module.TList.tail(_module.__default.FF(_module._default.Compare#$T, $LS($LZ), h#1)), 
              ...
              (0 < ORD#Offset(_k#0)
               ...
               || (_k#0 != ORD#FromNat(0) && ORD#IsLimit(_k#0)
                 ==> $Eq#_module.TList(_module._default.Compare#$T, 
                  ...
                  _module.TList.tail(_module.__default.FF(_module._default.Compare#$T, $LS($LZ), h#1)), 
                  _module.TList.tail(_module.__default.GG(_module._default.Compare#$T, $LS($LZ), h#1))));
            assume {:id "id229"} $PrefixEq#_module.TList(_module._default.Compare#$T, 
              _module._default.Compare#$T, 
              _k#0, 
              $LS($LS($LZ)), 
              _module.TList.tail(_module.__default.FF(_module._default.Compare#$T, $LS($LZ), h#1)), 
        ...
        else if (*)
        {
            ...
            // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(144,7)
            assert {:id "id221"} ORD#IsNat(Lit(ORD#FromNat(1)));
            assert {:id "id222"} ORD#Offset(Lit(ORD#FromNat(1))) <= ORD#Offset(_k#0);
            ##h#4 := h#1;
            // assume allocatedness for argument to function
            ...
            assume _module.__default.FF#canCall(_module._default.Compare#$T, h#1)
              ...
              _module.__default.GG#canCall(_module._default.Compare#$T, h#1)
               && _module.TList.TCons_q(_module.__default.GG(_module._default.Compare#$T, $LS($LZ), h#1));
            assert {:id "id223"} {:subsumption 0} $PrefixEq#_module.TList(_module._default.Compare#$T, 
                _module._default.Compare#$T, 
                ORD#Minus(_k#0, ORD#FromNat(1)), 
                $LS($LS($LZ)), 
                _module.TList.tail(_module.__default.FF(_module._default.Compare#$T, $LS($LZ), h#1)), 
                 ...
                 ==> _module.TList.TCons_q(_module.TList.tail(_module.__default.GG(_module._default.Compare#$T, $LS($LS($LZ)), h#1)))
                  ...
                  _module.TList.head(_module.TList.tail(_module.__default.FF(_module._default.Compare#$T, $LS($LS($LZ)), h#1)))
                   ...
                   && $PrefixEq#_module.TList(_module._default.Compare#$T, 
                    ...
                    _module.TList.tail(_module.TList.tail(_module.__default.FF(_module._default.Compare#$T, $LS($LS($LZ)), h#1))), 
                    _module.TList.tail(_module.TList.tail(_module.__default.GG(_module._default.Compare#$T, $LS($LS($LZ)), h#1)))));
            assert {:id "id224"} {:subsumption 0} $PrefixEq#_module.TList(_module._default.Compare#$T, 
                _module._default.Compare#$T, 
                ORD#Minus(_k#0, ORD#FromNat(1)), 
                $LS($LS($LZ)), 
                _module.TList.tail(_module.__default.FF(_module._default.Compare#$T, $LS($LZ), h#1)), 
              ...
              (0 < ORD#Offset(ORD#Minus(_k#0, ORD#FromNat(1)))
               ...
               || (ORD#Minus(_k#0, ORD#FromNat(1)) != ORD#FromNat(0)
                 ...
                 ==> $Eq#_module.TList(_module._default.Compare#$T, 
                  ...
                  _module.TList.tail(_module.__default.FF(_module._default.Compare#$T, $LS($LZ), h#1)), 
                  _module.TList.tail(_module.__default.GG(_module._default.Compare#$T, $LS($LZ), h#1))));
            assume {:id "id225"} $PrefixEq#_module.TList(_module._default.Compare#$T, 
              _module._default.Compare#$T, 
              ORD#Minus(_k#0, ORD#FromNat(1)), 
              $LS($LS($LZ)), 
              _module.TList.tail(_module.__default.FF(_module._default.Compare#$T, $LS($LZ), h#1)), 
        ...
        else
        {
            ...
            assert {:id "id218"} false;
        }
    }
    else
    {
        // ----- forall statement (call) ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(133,1)
        $initHeapForallStmt#1_0_0 := $Heap;
        havoc $Heap;
        assume $initHeapForallStmt#1_0_0 == $Heap;
        assume (forall _k'#0: Box, h#2: Box :: 
          { _module.__default.GG(_module._default.Compare#$T, $LS($LZ), h#2), ORD#Less(_k'#0, _k#0) } 
            { _module.__default.FF(_module._default.Compare#$T, $LS($LZ), h#2), ORD#Less(_k'#0, _k#0) } 
...
procedure {:verboseName "BadTheorem (well-formedness)"} CheckWellFormed$$_module.__default.BadTheorem(s#0: DatatypeType
...
procedure {:verboseName "BadTheorem (call)"} Call$$_module.__default.BadTheorem(s#0: DatatypeType
       where $Is(s#0, Tclass._module.IList())
         && $IsAlloc(s#0, Tclass._module.IList(), $Heap)
         && $IsA#_module.IList(s#0));
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id241"} Lit(false);
  // frame condition
  free ensures old($Heap) == $Heap;



procedure {:verboseName "BadTheorem# (co-call)"} CoCall$$_module.__default.BadTheorem_h(_k#0: Box, 
    s#1: DatatypeType
  ...
  // user-defined postconditions
  free ensures true;
  ensures {:id "id242"} Lit(false);
  // frame condition
  free ensures old($Heap) == $Heap;



procedure {:verboseName "BadTheorem# (correctness)"} Impl$$_module.__default.BadTheorem_h(_k#0: Box, 
    s#1: DatatypeType
       where $Is(s#1, Tclass._module.IList())
         && $IsAlloc(s#1, Tclass._module.IList(), $Heap)
         && $IsA#_module.IList(s#1))
  ...
  // user-defined postconditions
  free ensures true;
  ensures {:id "id243"} Lit(false);
  // frame condition
  free ensures old($Heap) == $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "BadTheorem# (correctness)"} Impl$$_module.__default.BadTheorem_h(_k#0: Box, s#1: DatatypeType) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var _k##0: Box;
  ...
  var $initHeapForallStmt#1_0_0: Heap;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(151,1)
    assume true;
    if (0 < ORD#Offset(_k#0))
    {
        // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(152,13)
        // TrCallStmt: Before ProcessCallStmt
        assert {:id "id244"} ORD#IsNat(Lit(ORD#FromNat(1)));
        assert {:id "id245"} ORD#Offset(Lit(ORD#FromNat(1))) <= ORD#Offset(_k#0);
        assume true;
        // ProcessCallStmt: CheckSubrange
        _k##0 := ORD#Minus(_k#0, ORD#FromNat(1));
        ...
        call {:id "id246"} CoCall$$_module.__default.BadTheorem_h(_k##0, s##0);
        // TrCallStmt: After ProcessCallStmt
    }
    else
    {
        // ----- forall statement (call) ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/CoPrefix.dfy(151,1)
        $initHeapForallStmt#1_0_0 := $Heap;
        havoc $Heap;
        assume $initHeapForallStmt#1_0_0 == $Heap;
...
axiom (forall d: DatatypeType :: 
  { _module.Stream.Cons_q(d) } 
  _module.Stream.Cons_q(d)
     ==> (exists a#4#0#0: int, a#4#1#0: DatatypeType :: 
      d == #_module.Stream.Cons(a#4#0#0, a#4#1#0)));

// Constructor $Is
axiom (forall a#5#0#0: int, a#5#1#0: DatatypeType :: 
  { $Is(#_module.Stream.Cons(a#5#0#0, a#5#1#0), Tclass._module.Stream()) } 
  $Is(#_module.Stream.Cons(a#5#0#0, a#5#1#0), Tclass._module.Stream())
     <==> $Is(a#5#0#0, TInt) && $Is(a#5#1#0, Tclass._module.Stream()));
...
axiom (forall a#12#0#0: DatatypeType :: 
  { #_module.Natural.Succ(a#12#0#0) } 
  DatatypeCtorId(#_module.Natural.Succ(a#12#0#0)) == ##_module.Natural.Succ);
}
...
axiom (forall d: DatatypeType :: 
  { _module.Natural.Succ_q(d) } 
  _module.Natural.Succ_q(d)
     ==> (exists a#13#0#0: DatatypeType :: d == #_module.Natural.Succ(a#13#0#0)));

// Constructor $Is
axiom (forall a#14#0#0: DatatypeType :: 
  { $Is(#_module.Natural.Succ(a#14#0#0), Tclass._module.Natural()) } 
  $Is(#_module.Natural.Succ(a#14#0#0), Tclass._module.Natural())
     <==> $Is(a#14#0#0, Tclass._module.Natural()));
...
axiom (forall a#15#0#0: DatatypeType :: 
  { #_module.Natural.Succ(Lit(a#15#0#0)) } 
  #_module.Natural.Succ(Lit(a#15#0#0)) == Lit(#_module.Natural.Succ(a#15#0#0)));

function _module.Natural._h0(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#16#0#0: DatatypeType :: 
  { #_module.Natural.Succ(a#16#0#0) } 
  _module.Natural._h0(#_module.Natural.Succ(a#16#0#0)) == a#16#0#0);

// Inductive rank
axiom (forall a#17#0#0: DatatypeType :: 
  { #_module.Natural.Succ(a#17#0#0) } 
  DtRank(a#17#0#0) < DtRank(#_module.Natural.Succ(a#17#0#0)));

// Datatype $IsAlloc
axiom (forall d: DatatypeType, $h: Heap :: 
  { $IsAlloc(d, Tclass._module.Natural(), $h) } 
  $IsGoodHeap($h) && $Is(d, Tclass._module.Natural())
     ==> $IsAlloc(d, Tclass._module.Natural(), $h));
...
axiom (forall a#18#0#0: int, a#18#1#0: DatatypeType :: 
  { #_module.IList.ICons(a#18#0#0, a#18#1#0) } 
  DatatypeCtorId(#_module.IList.ICons(a#18#0#0, a#18#1#0))
     == ##_module.IList.ICons);
}
...
axiom (forall d: DatatypeType :: 
  ...
  _module.IList.ICons_q(d)
     ==> (exists a#19#0#0: int, a#19#1#0: DatatypeType :: 
      d == #_module.IList.ICons(a#19#0#0, a#19#1#0)));

// Constructor $Is
axiom (forall a#20#0#0: int, a#20#1#0: DatatypeType :: 
  { $Is(#_module.IList.ICons(a#20#0#0, a#20#1#0), Tclass._module.IList()) } 
  $Is(#_module.IList.ICons(a#20#0#0, a#20#1#0), Tclass._module.IList())
     <==> $Is(a#20#0#0, TInt) && $Is(a#20#1#0, Tclass._module.IList()));
...
axiom (forall a#21#0#0: int, a#21#1#0: DatatypeType :: 
  { #_module.IList.ICons(a#21#0#0, a#21#1#0) } 
  _module.IList.head(#_module.IList.ICons(a#21#0#0, a#21#1#0)) == a#21#0#0);

function _module.IList.tail(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#22#0#0: int, a#22#1#0: DatatypeType :: 
  { #_module.IList.ICons(a#22#0#0, a#22#1#0) } 
  _module.IList.tail(#_module.IList.ICons(a#22#0#0, a#22#1#0)) == a#22#1#0);

// Datatype $IsAlloc
axiom (forall d: DatatypeType, $h: Heap :: 
  { $IsAlloc(d, Tclass._module.IList(), $h) } 
  $IsGoodHeap($h) && $Is(d, Tclass._module.IList())
     ==> $IsAlloc(d, Tclass._module.IList(), $h));
...
axiom (forall a#23#0#0: Box, a#23#1#0: DatatypeType :: 
  { #_module.TList.TCons(a#23#0#0, a#23#1#0) } 
  DatatypeCtorId(#_module.TList.TCons(a#23#0#0, a#23#1#0))
     == ##_module.TList.TCons);
}
...
axiom (forall d: DatatypeType :: 
  { _module.TList.TCons_q(d) } 
  _module.TList.TCons_q(d)
     ==> (exists a#24#0#0: Box, a#24#1#0: DatatypeType :: 
      d == #_module.TList.TCons(a#24#0#0, a#24#1#0)));

// Constructor $Is
axiom (forall _module.TList$T: Ty, a#25#0#0: Box, a#25#1#0: DatatypeType :: 
  { $Is(#_module.TList.TCons(a#25#0#0, a#25#1#0), Tclass._module.TList(_module.TList$T)) } 
  $Is(#_module.TList.TCons(a#25#0#0, a#25#1#0), Tclass._module.TList(_module.TList$T))
     <==> $IsBox(a#25#0#0, _module.TList$T)
       && $Is(a#25#1#0, Tclass._module.TList(_module.TList$T)));

// Constructor $IsAlloc
axiom (forall _module.TList$T: Ty, a#25#0#0: Box, a#25#1#0: DatatypeType, $h: Heap :: 
  { $IsAlloc(#_module.TList.TCons(a#25#0#0, a#25#1#0), 
      Tclass._module.TList(_module.TList$T), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_module.TList.TCons(a#25#0#0, a#25#1#0), 
        Tclass._module.TList(_module.TList$T), 
        $h)
       <==> $IsAllocBox(a#25#0#0, _module.TList$T, $h)
         && $IsAlloc(a#25#1#0, Tclass._module.TList(_module.TList$T), $h)));
...
axiom (forall a#26#0#0: Box, a#26#1#0: DatatypeType :: 
  { #_module.TList.TCons(a#26#0#0, a#26#1#0) } 
  _module.TList.head(#_module.TList.TCons(a#26#0#0, a#26#1#0)) == a#26#0#0);

function _module.TList.tail(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#27#0#0: Box, a#27#1#0: DatatypeType :: 
  { #_module.TList.TCons(a#27#0#0, a#27#1#0) } 
  _module.TList.tail(#_module.TList.TCons(a#27#0#0, a#27#1#0)) == a#27#1#0);
...
axiom (forall a#28#0#0: Box, a#28#1#0: DatatypeType :: 
  { #PrefixEquality.Stream.Cons(a#28#0#0, a#28#1#0) } 
  DatatypeCtorId(#PrefixEquality.Stream.Cons(a#28#0#0, a#28#1#0))
...
axiom (forall d: DatatypeType :: 
  ...
  PrefixEquality.Stream.Cons_q(d)
     ==> (exists a#29#0#0: Box, a#29#1#0: DatatypeType :: 
      d == #PrefixEquality.Stream.Cons(a#29#0#0, a#29#1#0)));
...
// Constructor $Is
axiom (forall PrefixEquality.Stream$T: Ty, a#30#0#0: Box, a#30#1#0: DatatypeType :: 
  { $Is(#PrefixEquality.Stream.Cons(a#30#0#0, a#30#1#0), 
      Tclass.PrefixEquality.Stream(PrefixEquality.Stream$T)) } 
  $Is(#PrefixEquality.Stream.Cons(a#30#0#0, a#30#1#0), 
      Tclass.PrefixEquality.Stream(PrefixEquality.Stream$T))
     <==> $IsBox(a#30#0#0, PrefixEquality.Stream$T)
       && $Is(a#30#1#0, Tclass.PrefixEquality.Stream(PrefixEquality.Stream$T)));

// Constructor $IsAlloc
axiom (forall PrefixEquality.Stream$T: Ty, a#30#0#0: Box, a#30#1#0: DatatypeType, $h: Heap :: 
  { $IsAlloc(#PrefixEquality.Stream.Cons(a#30#0#0, a#30#1#0), 
      Tclass.PrefixEquality.Stream(PrefixEquality.Stream$T), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#PrefixEquality.Stream.Cons(a#30#0#0, a#30#1#0), 
        Tclass.PrefixEquality.Stream(PrefixEquality.Stream$T), 
        $h)
       <==> $IsAllocBox(a#30#0#0, PrefixEquality.Stream$T, $h)
         && $IsAlloc(a#30#1#0, Tclass.PrefixEquality.Stream(PrefixEquality.Stream$T), $h)));
...
axiom (forall a#31#0#0: Box, a#31#1#0: DatatypeType :: 
  { #PrefixEquality.Stream.Cons(a#31#0#0, a#31#1#0) } 
  PrefixEquality.Stream.head(#PrefixEquality.Stream.Cons(a#31#0#0, a#31#1#0))
     == a#31#0#0);
...
axiom (forall a#32#0#0: Box, a#32#1#0: DatatypeType :: 
  { #PrefixEquality.Stream.Cons(a#32#0#0, a#32#1#0) } 
  PrefixEquality.Stream._h1(#PrefixEquality.Stream.Cons(a#32#0#0, a#32#1#0))
     == a#32#1#0);
