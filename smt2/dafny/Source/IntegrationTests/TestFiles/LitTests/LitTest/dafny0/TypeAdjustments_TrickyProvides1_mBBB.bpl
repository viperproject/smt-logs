...
const unique class.TrickyProvides1_mBBB.__default: ClassName;
...
axiom 1 <= $FunctionContextHeight
   ==> 
  TrickyProvides1_mBBB.__default.Empty#canCall() || 1 < $FunctionContextHeight
   ==> (var u#0 := TrickyProvides1_mBBB.__default.Empty(); Lit(true))
...
uses {
// Tclass.TrickyProvides1_mBBB.U Tag
axiom Tag(Tclass.TrickyProvides1_mBBB.U()) == Tagclass.TrickyProvides1_mBBB.U
   && TagFamily(Tclass.TrickyProvides1_mBBB.U()) == tytagFamily$U;
}

const unique Tagclass.TrickyProvides1_mBBB.U: TyTag;
...
procedure {:verboseName "TrickyProvides1.BBB.Empty (well-formedness)"} CheckWellformed$$TrickyProvides1_mBBB.__default.Empty();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  ensures {:id "id291"} (var u#1 := TrickyProvides1_mBBB.__default.Empty(); Lit(true));



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TrickyProvides1.BBB.Empty (well-formedness)"} CheckWellformed$$TrickyProvides1_mBBB.__default.Empty()
{
  ...
  var let#0#0#0: Box;
    ...
    if (*)
    {
        ...
        assume $IsBox(TrickyProvides1_mBBB.__default.Empty(), Tclass.TrickyProvides1_mBBB.U());
        havoc u#Z#0;
        assert {:id "id292"} Lit(true);
        assume Lit(true) || TrickyProvides1_mBBB.__default.Empty#canCall();
        assume {:id "id293"} let#0#0#0 == TrickyProvides1_mBBB.__default.Empty();
        assume TrickyProvides1_mBBB.__default.Empty#canCall();
        // CheckWellformedWithResult: any expression
        assume $IsBox(let#0#0#0, Tclass.TrickyProvides1_mBBB.U());
        assume {:id "id294"} u#Z#0 == let#0#0#0;
        assume {:id "id295"} (var u#1 := TrickyProvides1_mBBB.__default.Empty(); Lit(true));
        assume false;
    }
    else
    {
...
procedure {:verboseName "TrickyProvides1.BBB.U (well-formedness)"} CheckWellFormed$$TrickyProvides1_mBBB.U(w#0: Box);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



// $Is axiom for subset type TrickyProvides1.BBB.U
axiom (forall w#0: Box :: 
  { $IsBox(w#0, Tclass.TrickyProvides1_mBBB.U()) } 
  $IsBox(w#0, Tclass.TrickyProvides1_mBBB.U())
     <==> $IsBox(w#0, Tclass.TrickyProvides1_mCCC.W()) && Lit(true));

// $IsAlloc axiom for subset type TrickyProvides1.BBB.U
axiom (forall w#0: Box, $h: Heap :: 
  { $IsAllocBox(w#0, Tclass.TrickyProvides1_mBBB.U(), $h) } 
  $IsAllocBox(w#0, Tclass.TrickyProvides1_mBBB.U(), $h)
     <==> $IsAllocBox(w#0, Tclass.TrickyProvides1_mCCC.W(), $h));
