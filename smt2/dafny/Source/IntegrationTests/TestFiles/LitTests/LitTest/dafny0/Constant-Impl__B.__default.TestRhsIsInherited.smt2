...
(assert  (=> (< 0 $FunctionContextHeight) ($Is intType (int_2_U B.__default.x) TInt)))
(assert (forall ((x@@5 T@U) (T@@1 T@T) ) (! (= ($Unbox T@@1 ($Box T@@1 x@@5)) x@@5)
 :qid |DafnyPreludebpl.167:18|
 :skolemid |1030|
 :pattern ( ($Box T@@1 x@@5))
)))
(assert (= B.__default.x (LitInt 100)))
...
(set-info :boogie-vc-id Impl$$B.__default.TestRhsIsInherited)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (= B.__default.x (LitInt 100)))))
