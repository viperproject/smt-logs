...
(set-info :boogie-vc-id CheckWellFormed$$_module.Node.StillValidAfterValChanges)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon4_correct  (=> (and (forall ((|d#1| T@U) ) (!  (=> ($Is refType |d#1| Tclass._module.Node) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.Node.Repr)) ($Box refType |d#1|)) (forall (($o@@7 T@U) ($f@@1 T@U) ) (!  (=> (or (not (= $o@@7 null)) (not true)) (=> (or (and (= $o@@7 |d#1|) (or (= $f@@1 _module.Node.next) (= $f@@1 alloc))) (and (= $o@@7 |d#1|) (or (= $f@@1 _module.Node.Repr) (= $f@@1 alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@7) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@7) $f@@1))))
 ...
 :skolemid |697|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.Node.Repr)) ($Box refType |d#1|)))
)) (= (ControlFlow 0 2) (- 0 1))) ($IsAlloc refType this@@2 Tclass._module.Node $Heap@@1))))
(let ((anon5_Else_correct  (=> (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.Node.Repr)) ($Box refType |d#0@0|)) (forall (($o@@8 T@U) ($f@@2 T@U) ) (!  (=> (or (not (= $o@@8 null)) (not true)) (=> (or (and (= $o@@8 |d#0@0|) (or (= $f@@2 _module.Node.next) (= $f@@2 alloc))) (and (= $o@@8 |d#0@0|) (or (= $f@@2 _module.Node.Repr) (= $f@@2 alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@8) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@8) $f@@2))))
 :qid |MoForallCompilationdfy.177:45|
 :skolemid |695|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@8) $f@@2))
))) (= (ControlFlow 0 7) 2)) anon4_correct)))
(let ((anon5_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) ($IsAlloc refType this@@2 Tclass._module.Node $Heap@@1)) (=> ($IsAlloc refType this@@2 Tclass._module.Node $Heap@@1) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.Node.Repr)) ($Box refType |d#0@0|)) (and (=> (= (ControlFlow 0 3) (- 0 5)) ($IsAlloc refType |d#0@0| Tclass._module.Node $Heap@@1)) (=> ($IsAlloc refType |d#0@0| Tclass._module.Node $Heap@@1) (and (=> (= (ControlFlow 0 3) (- 0 4)) ($IsAlloc refType |d#0@0| Tclass._module.Node $Heap@@1)) (=> ($IsAlloc refType |d#0@0| Tclass._module.Node $Heap@@1) (=> (and (forall (($o@@9 T@U) ($f@@3 T@U) ) (!  (=> (or (not (= $o@@9 null)) (not true)) (=> (or (and (= $o@@9 |d#0@0|) (or (= $f@@3 _module.Node.next) (= $f@@3 alloc))) (and (= $o@@9 |d#0@0|) (or (= $f@@3 _module.Node.Repr) (= $f@@3 alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@9) $f@@3) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@9) $f@@3))))
 :qid |MoForallCompilationdfy.177:45|
 :skolemid |694|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@9) $f@@3))
)) (= (ControlFlow 0 3) 2)) anon4_correct))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null current$Heap alloc false)) (and (=> (= (ControlFlow 0 8) (- 0 9)) ($IsAlloc refType this@@2 Tclass._module.Node $Heap@@1)) (=> ($IsAlloc refType this@@2 Tclass._module.Node $Heap@@1) (=> (and (and (|_module.Node.Valid#canCall| $Heap@@1 this@@2) (_module.Node.Valid ($LS $LZ) $Heap@@1 this@@2)) (and ($Is refType |d#0@0| Tclass._module.Node) ($IsAlloc refType |d#0@0| Tclass._module.Node current$Heap))) (and (=> (= (ControlFlow 0 8) 3) anon5_Then_correct) (=> (= (ControlFlow 0 8) 7) anon5_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.Node) ($IsAlloc refType this@@2 Tclass._module.Node previous$Heap))) (= 1 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@1) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 10) 8))) anon0_correct))))
