...
(assert (forall ((a@@9 T@U) (x@@7 T@U) ) (! (= (|MultiSet#Multiplicity| (|MultiSet#UnionOne| a@@9 x@@7) x@@7) (+ (|MultiSet#Multiplicity| a@@9 x@@7) 1))
 :qid |DafnyPreludebpl.968:15|
 :skolemid |2571|
 :pattern ( (|MultiSet#UnionOne| a@@9 x@@7))
)))
...
(assert (forall ((a@@16 T@U) (x@@12 T@U) (y@@1 T@U) ) (!  (=> (< 0 (|MultiSet#Multiplicity| a@@16 y@@1)) (< 0 (|MultiSet#Multiplicity| (|MultiSet#UnionOne| a@@16 x@@12) y@@1)))
 :qid |DafnyPreludebpl.973:15|
 :skolemid |2572|
 :pattern ( (|MultiSet#UnionOne| a@@16 x@@12) (|MultiSet#Multiplicity| a@@16 y@@1))
)))
(assert (forall ((a@@17 T@U) (x@@13 T@U) (o@@4 T@U) ) (! (= (< 0 (|MultiSet#Multiplicity| (|MultiSet#UnionOne| a@@17 x@@13) o@@4))  (or (= o@@4 x@@13) (< 0 (|MultiSet#Multiplicity| a@@17 o@@4))))
 :qid |DafnyPreludebpl.963:15|
 :skolemid |2570|
 :pattern ( (|MultiSet#Multiplicity| (|MultiSet#UnionOne| a@@17 x@@13) o@@4))
)))
...
(declare-fun _module._default.NegationNormalForm2$_T0 () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.NegationNormalForm2)
...
(let ((anon13_Else_correct  (=> (and (< (LitInt 0) (|MultiSet#Card| |s#0@0|)) (= (ControlFlow 0 14) 12)) anon5_correct)))
(let ((anon13_Then_correct  (=> (and (<= (|MultiSet#Card| |s#0@0|) (LitInt 0)) (= (ControlFlow 0 13) 12)) anon5_correct)))
(let ((anon12_Then_correct  (=> (not |$w$loop#0@0|) (and (=> (= (ControlFlow 0 15) 13) anon13_Then_correct) (=> (= (ControlFlow 0 15) 14) anon13_Else_correct)))))
(let ((anon10_correct  (and (=> (= (ControlFlow 0 4) (- 0 7)) (exists ((|$as#x0_0#0_0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0| _module._default.NegationNormalForm2$_T0) (> (|MultiSet#Multiplicity| |s#0@0| |$as#x0_0#0_0|) 0))
 :qid |Terminationdfy.1059:9|
 :skolemid |3379|
))) (=> (exists ((|$as#x0_0#0_0@@0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0@@0| _module._default.NegationNormalForm2$_T0) (> (|MultiSet#Multiplicity| |s#0@0| |$as#x0_0#0_0@@0|) 0))
 :qid |Terminationdfy.1059:9|
 :skolemid |3379|
)) (=> (and (=> true (and ($IsBox |x#0_0@1| _module._default.NegationNormalForm2$_T0) ($IsAllocBox |x#0_0@1| _module._default.NegationNormalForm2$_T0 $Heap))) (> (|MultiSet#Multiplicity| |s#0@0| |x#0_0@1|) 0)) (and (=> (= (ControlFlow 0 4) (- 0 6)) true) (=> (= |s#0@1| (|MultiSet#Difference| |s#0@0| (|MultiSet#UnionOne| |MultiSet#Empty| |x#0_0@1|))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (<= 0 |$decr$loop#00@1|) (= (ite (<= (|MultiSet#Card| |s#0@1|) (LitInt 0)) (- 0 (|MultiSet#Card| |s#0@1|)) (- (|MultiSet#Card| |s#0@1|) 0)) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (ite (<= (|MultiSet#Card| |s#0@1|) (LitInt 0)) (- 0 (|MultiSet#Card| |s#0@1|)) (- (|MultiSet#Card| |s#0@1|) 0)) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 4) (- 0 3)) (< (ite (<= (|MultiSet#Card| |s#0@1|) (LitInt 0)) (- 0 (|MultiSet#Card| |s#0@1|)) (- (|MultiSet#Card| |s#0@1|) 0)) |$decr$loop#00@1|)))))))))))
(let ((anon15_Else_correct  (=> (and (not (and ($IsBox |x#0_1@1| _module._default.NegationNormalForm2$_T0) ($IsAllocBox |x#0_1@1| _module._default.NegationNormalForm2$_T0 $Heap))) (= (ControlFlow 0 9) 4)) anon10_correct)))
(let ((anon15_Then_correct  (=> (and (and ($IsBox |x#0_1@1| _module._default.NegationNormalForm2$_T0) ($IsAllocBox |x#0_1@1| _module._default.NegationNormalForm2$_T0 $Heap)) (= (ControlFlow 0 8) 4)) anon10_correct)))
(let ((anon14_Else_correct  (=> (and (or (not (= (|MultiSet#Card| |s#0@0|) (LitInt 0))) (not true)) (= |$decr$loop#00@1| (ite (<= (|MultiSet#Card| |s#0@0|) (LitInt 0)) (- 0 (|MultiSet#Card| |s#0@0|)) (- (|MultiSet#Card| |s#0@0|) 0)))) (and (=> (= (ControlFlow 0 10) 8) anon15_Then_correct) (=> (= (ControlFlow 0 10) 9) anon15_Else_correct)))))
(let ((anon14_Then_correct true))
(let ((anon12_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 11) 2) anon14_Then_correct) (=> (= (ControlFlow 0 11) 10) anon14_Else_correct)))))
(let ((anon11_LoopBody_correct  (and (=> (= (ControlFlow 0 16) 15) anon12_Then_correct) (=> (= (ControlFlow 0 16) 11) anon12_Else_correct))))
(let ((anon11_LoopDone_correct true))
(let ((anon11_LoopHead_correct  (=> (=> |defass#x#0_0@0| (and ($IsBox |x#0_0@0| _module._default.NegationNormalForm2$_T0) ($IsAllocBox |x#0_0@0| _module._default.NegationNormalForm2$_T0 $Heap))) (=> (and (and (and ($Is MultiSetType |s#0@0| (TMultiSet _module._default.NegationNormalForm2$_T0)) ($IsAlloc MultiSetType |s#0@0| (TMultiSet _module._default.NegationNormalForm2$_T0) $Heap)) (not false)) (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |Terminationdfy.1058:3|
 :skolemid |3377|
...
)) (<= (ite (<= (|MultiSet#Card| |s#0@0|) (LitInt 0)) (- 0 (|MultiSet#Card| |s#0@0|)) (- (|MultiSet#Card| |s#0@0|) 0)) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 17) 1) anon11_LoopDone_correct) (=> (= (ControlFlow 0 17) 16) anon11_LoopBody_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |$decr_init$loop#00@0| (ite (<= (|MultiSet#Card| |S#0|) (LitInt 0)) (- 0 (|MultiSet#Card| |S#0|)) (- (|MultiSet#Card| |S#0|) 0))) (= (ControlFlow 0 18) 17)) anon11_LoopHead_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is MultiSetType |S#0| (TMultiSet _module._default.NegationNormalForm2$_T0)) ($IsAlloc MultiSetType |S#0| (TMultiSet _module._default.NegationNormalForm2$_T0) $Heap))) (=> (and (and (and ($Is MultiSetType |s#0| (TMultiSet _module._default.NegationNormalForm2$_T0)) ($IsAlloc MultiSetType |s#0| (TMultiSet _module._default.NegationNormalForm2$_T0) $Heap)) true) (and (and (=> |defass#x#0_0| (and ($IsBox |x#0_0| _module._default.NegationNormalForm2$_T0) ($IsAllocBox |x#0_0| _module._default.NegationNormalForm2$_T0 $Heap))) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 19) 18)))) anon0_correct))))
