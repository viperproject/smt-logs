// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/NatOutcomeDt.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/NatOutcomeDt-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/NatOutcomeDt.dfy
...
axiom (forall a#12#0#0: int :: 
  { #_module.NatOutcome.NatSuccess(a#12#0#0) } 
  DatatypeCtorId(#_module.NatOutcome.NatSuccess(a#12#0#0))
...
axiom (forall d: DatatypeType :: 
  { _module.NatOutcome.NatSuccess_q(d) } 
  _module.NatOutcome.NatSuccess_q(d)
     ==> (exists a#13#0#0: int :: d == #_module.NatOutcome.NatSuccess(a#13#0#0)));
...
axiom (forall a#14#0#0: int :: 
  { $Is(#_module.NatOutcome.NatSuccess(a#14#0#0), Tclass._module.NatOutcome()) } 
  $Is(#_module.NatOutcome.NatSuccess(a#14#0#0), Tclass._module.NatOutcome())
...
axiom (forall a#15#0#0: int :: 
  { #_module.NatOutcome.NatSuccess(LitInt(a#15#0#0)) } 
  #_module.NatOutcome.NatSuccess(LitInt(a#15#0#0))
     == Lit(#_module.NatOutcome.NatSuccess(a#15#0#0)));

function _module.NatOutcome.value(DatatypeType) : int;

// Constructor injectivity
axiom (forall a#16#0#0: int :: 
  { #_module.NatOutcome.NatSuccess(a#16#0#0) } 
  _module.NatOutcome.value(#_module.NatOutcome.NatSuccess(a#16#0#0)) == a#16#0#0);
...
axiom (forall a#17#0#0: Seq :: 
  { #_module.NatOutcome.NatFailure(a#17#0#0) } 
  DatatypeCtorId(#_module.NatOutcome.NatFailure(a#17#0#0))
...
axiom (forall d: DatatypeType :: 
  { _module.NatOutcome.NatFailure_q(d) } 
  _module.NatOutcome.NatFailure_q(d)
     ==> (exists a#18#0#0: Seq :: d == #_module.NatOutcome.NatFailure(a#18#0#0)));

// Constructor $Is
axiom (forall a#19#0#0: Seq :: 
  { $Is(#_module.NatOutcome.NatFailure(a#19#0#0), Tclass._module.NatOutcome()) } 
  $Is(#_module.NatOutcome.NatFailure(a#19#0#0), Tclass._module.NatOutcome())
...
axiom (forall a#20#0#0: Seq :: 
  { #_module.NatOutcome.NatFailure(Lit(a#20#0#0)) } 
  #_module.NatOutcome.NatFailure(Lit(a#20#0#0))
     == Lit(#_module.NatOutcome.NatFailure(a#20#0#0)));

function _module.NatOutcome.error(DatatypeType) : Seq;

// Constructor injectivity
axiom (forall a#21#0#0: Seq :: 
  { #_module.NatOutcome.NatFailure(a#21#0#0) } 
  _module.NatOutcome.error(#_module.NatOutcome.NatFailure(a#21#0#0)) == a#21#0#0);

// Inductive seq element rank
axiom (forall a#22#0#0: Seq, i: int :: 
  { Seq#Index(a#22#0#0, i), #_module.NatOutcome.NatFailure(a#22#0#0) } 
  0 <= i && i < Seq#Length(a#22#0#0)
     ==> DtRank($Unbox(Seq#Index(a#22#0#0, i)): DatatypeType)
       < DtRank(#_module.NatOutcome.NatFailure(a#22#0#0)));

// Inductive seq rank
axiom (forall a#23#0#0: Seq :: 
  { #_module.NatOutcome.NatFailure(a#23#0#0) } 
  Seq#Rank(a#23#0#0) < DtRank(#_module.NatOutcome.NatFailure(a#23#0#0)));
...
axiom {:id "id0"} 0 <= $FunctionContextHeight
   ==> (forall this: DatatypeType :: 
    ...
    _module.NatOutcome.IsFailure#canCall(this)
         || (0 < $FunctionContextHeight && $Is(this, Tclass._module.NatOutcome()))
...
procedure {:verboseName "NatOutcome.IsFailure (well-formedness)"} CheckWellformed$$_module.NatOutcome.IsFailure(this: DatatypeType
       where $Is(this, Tclass._module.NatOutcome())
...
procedure {:verboseName "NatOutcome.PropagateFailure (well-formedness)"} CheckWellformed$$_module.NatOutcome.PropagateFailure(this: DatatypeType
       where $Is(this, Tclass._module.NatOutcome())
         && $IsAlloc(this, Tclass._module.NatOutcome(), $Heap));
...
procedure {:verboseName "NatOutcome.Extract (well-formedness)"} CheckWellformed$$_module.NatOutcome.Extract(this: DatatypeType
       where $Is(this, Tclass._module.NatOutcome())
         && $IsAlloc(this, Tclass._module.NatOutcome(), $Heap));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NatOutcome.Extract (well-formedness)"} CheckWellformed$$_module.NatOutcome.Extract(this: DatatypeType)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    assume $IsAllocBox($Box(this), Tclass._module.NatOutcome(), $Heap);
    assume _module.NatOutcome.IsFailure#canCall(this);
    assume {:id "id9"} !_module.NatOutcome.IsFailure(this);
    ...
    if (*)
    {
        ...
        assume LitInt(0) <= _module.NatOutcome.Extract(this);
        assume false;
    }
    else
    {
        // Check well-formedness of body and result subset type constraint
        assert {:id "id10"} _module.NatOutcome.NatSuccess_q(this);
        assume {:id "id11"} _module.NatOutcome.Extract(this) == _module.NatOutcome.value(this);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(_module.NatOutcome.Extract(this), Tclass._System.nat());
        return;
