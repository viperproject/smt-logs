// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VoidOutcome.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VoidOutcome-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VoidOutcome.dfy
...
procedure {:verboseName "MakeVoidSuccess (correctness)"} Impl$$_module.__default.MakeVoidSuccess()
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MakeVoidSuccess (correctness)"} Impl$$_module.__default.MakeVoidSuccess() returns (defass#res#0: bool, res#0: ref, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var $nw: ref;

    // AddMethodImpl: MakeVoidSuccess, Impl$$_module.__default.MakeVoidSuccess
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VoidOutcome.dfy(34,9)
    assume true;
    // ----- init call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VoidOutcome.dfy(34,12)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id0"} $nw := Call$$_module.VoidSuccess.__ctor();
    // TrCallStmt: After ProcessCallStmt
    res#0 := $nw;
    defass#res#0 := true;
    assert {:id "id2"} defass#res#0;
}
...
procedure {:verboseName "MakeVoidFailure (correctness)"} Impl$$_module.__default.MakeVoidFailure(msg#0: Seq where $Is(msg#0, TSeq(TChar)) && $IsAlloc(msg#0, TSeq(TChar), $Heap))
   returns (defass#res#0: bool, 
    res#0: ref
       where defass#res#0
         ==> $Is(res#0, Tclass._module.VoidOutcome())
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MakeVoidFailure (correctness)"} Impl$$_module.__default.MakeVoidFailure(msg#0: Seq) returns (defass#res#0: bool, res#0: ref, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var $nw: ref;
  var error##0: Seq;

    // AddMethodImpl: MakeVoidFailure, Impl$$_module.__default.MakeVoidFailure
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VoidOutcome.dfy(38,9)
    assume true;
    // ----- init call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VoidOutcome.dfy(38,12)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    error##0 := msg#0;
    call {:id "id3"} $nw := Call$$_module.VoidFailure.__ctor(error##0);
    // TrCallStmt: After ProcessCallStmt
    res#0 := $nw;
    defass#res#0 := true;
    assert {:id "id5"} defass#res#0;
}
...
procedure {:verboseName "VoidOutcome.IsFailure (well-formedness)"} CheckWellformed$$_module.VoidOutcome.IsFailure(this: ref
       where this != null
         && 
...
procedure {:verboseName "VoidOutcome.PropagateFailure (well-formedness)"} CheckWellformed$$_module.VoidOutcome.PropagateFailure(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.VoidOutcome())
         && $IsAlloc(this, Tclass._module.VoidOutcome(), $Heap));
...
procedure {:verboseName "VoidSuccess._ctor (well-formedness)"} CheckWellFormed$$_module.VoidSuccess.__ctor() returns (this: ref);
...
procedure {:verboseName "VoidSuccess._ctor (call)"} Call$$_module.VoidSuccess.__ctor()
   returns (this: ref
       where this != null
         && 
...
procedure {:verboseName "VoidSuccess._ctor (correctness)"} Impl$$_module.VoidSuccess.__ctor() returns (this: ref, $_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
procedure {:verboseName "VoidSuccess.IsFailure (well-formedness)"} CheckWellformed$$_module.VoidSuccess.IsFailure(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.VoidSuccess())
         && $IsAlloc(this, Tclass._module.VoidSuccess(), $Heap));
...
procedure {:verboseName "VoidSuccess.IsFailure (override check)"} OverrideCheck$$_module.VoidSuccess.IsFailure(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.VoidSuccess())
         && $IsAlloc(this, Tclass._module.VoidSuccess(), $Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "VoidSuccess.IsFailure (override check)"} OverrideCheck$$_module.VoidSuccess.IsFailure(this: ref)
{
  var VoidSuccess_$_ReadsFrame: [ref,Field]bool;

    assert {:id "id10"} true;
    VoidSuccess_$_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    assert {:id "id11"} (forall $o: ref, $f: Field :: true);
}
...
procedure {:verboseName "VoidSuccess.PropagateFailure (well-formedness)"} CheckWellformed$$_module.VoidSuccess.PropagateFailure(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.VoidSuccess())
         && $IsAlloc(this, Tclass._module.VoidSuccess(), $Heap));
...
procedure {:verboseName "VoidSuccess.PropagateFailure (override check)"} OverrideCheck$$_module.VoidSuccess.PropagateFailure(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.VoidSuccess())
         && $IsAlloc(this, Tclass._module.VoidSuccess(), $Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "VoidSuccess.PropagateFailure (override check)"} OverrideCheck$$_module.VoidSuccess.PropagateFailure(this: ref)
{
  var VoidSuccess_$_ReadsFrame: [ref,Field]bool;

    assume {:id "id16"} _module.VoidSuccess.IsFailure(this);
    assert {:id "id17"} _module.VoidSuccess.IsFailure#canCall(this)
       ==> _module.VoidSuccess.IsFailure(this) || Lit(false);
    assert {:id "id18"} true;
    VoidSuccess_$_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    assert {:id "id19"} (forall $o: ref, $f: Field :: true);
}
...
procedure {:verboseName "VoidFailure._ctor (well-formedness)"} CheckWellFormed$$_module.VoidFailure.__ctor(error#0: Seq
       where $Is(error#0, TSeq(TChar)) && $IsAlloc(error#0, TSeq(TChar), $Heap))
   returns (this: ref);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "VoidFailure._ctor (call)"} Call$$_module.VoidFailure.__ctor(error#0: Seq
       where $Is(error#0, TSeq(TChar)) && $IsAlloc(error#0, TSeq(TChar), $Heap))
   returns (this: ref
       where this != null
         && 
...
procedure {:verboseName "VoidFailure._ctor (correctness)"} Impl$$_module.VoidFailure.__ctor(error#0: Seq
       where $Is(error#0, TSeq(TChar)) && $IsAlloc(error#0, TSeq(TChar), $Heap))
...
procedure {:verboseName "VoidFailure.IsFailure (well-formedness)"} CheckWellformed$$_module.VoidFailure.IsFailure(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.VoidFailure())
         && $IsAlloc(this, Tclass._module.VoidFailure(), $Heap));
...
procedure {:verboseName "VoidFailure.IsFailure (override check)"} OverrideCheck$$_module.VoidFailure.IsFailure(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.VoidFailure())
         && $IsAlloc(this, Tclass._module.VoidFailure(), $Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "VoidFailure.IsFailure (override check)"} OverrideCheck$$_module.VoidFailure.IsFailure(this: ref)
{
  var VoidFailure_$_ReadsFrame: [ref,Field]bool;

    assert {:id "id24"} true;
    VoidFailure_$_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    assert {:id "id25"} (forall $o: ref, $f: Field :: true);
}
...
procedure {:verboseName "VoidFailure.PropagateFailure (well-formedness)"} CheckWellformed$$_module.VoidFailure.PropagateFailure(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.VoidFailure())
         && $IsAlloc(this, Tclass._module.VoidFailure(), $Heap));
...
procedure {:verboseName "VoidFailure.PropagateFailure (override check)"} OverrideCheck$$_module.VoidFailure.PropagateFailure(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.VoidFailure())
         && $IsAlloc(this, Tclass._module.VoidFailure(), $Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "VoidFailure.PropagateFailure (override check)"} OverrideCheck$$_module.VoidFailure.PropagateFailure(this: ref)
{
  var VoidFailure_$_ReadsFrame: [ref,Field]bool;

    assume {:id "id30"} _module.VoidFailure.IsFailure(this);
    assert {:id "id31"} _module.VoidFailure.IsFailure#canCall(this)
       ==> _module.VoidFailure.IsFailure(this) || Lit(true);
    assert {:id "id32"} true;
    VoidFailure_$_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
