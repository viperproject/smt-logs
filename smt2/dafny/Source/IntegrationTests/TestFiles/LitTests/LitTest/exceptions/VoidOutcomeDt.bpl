// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VoidOutcomeDt.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VoidOutcomeDt-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VoidOutcomeDt.dfy
...
axiom (forall a#16#0#0: Seq :: 
  { #_module.VoidOutcome.VoidFailure(a#16#0#0) } 
  DatatypeCtorId(#_module.VoidOutcome.VoidFailure(a#16#0#0))
...
axiom (forall d: DatatypeType :: 
  { _module.VoidOutcome.VoidFailure_q(d) } 
  _module.VoidOutcome.VoidFailure_q(d)
     ==> (exists a#17#0#0: Seq :: d == #_module.VoidOutcome.VoidFailure(a#17#0#0)));

// Constructor $Is
axiom (forall a#18#0#0: Seq :: 
  { $Is(#_module.VoidOutcome.VoidFailure(a#18#0#0), Tclass._module.VoidOutcome()) } 
  $Is(#_module.VoidOutcome.VoidFailure(a#18#0#0), Tclass._module.VoidOutcome())
     <==> $Is(a#18#0#0, TSeq(TChar)));
...
axiom (forall a#19#0#0: Seq :: 
  { #_module.VoidOutcome.VoidFailure(Lit(a#19#0#0)) } 
  #_module.VoidOutcome.VoidFailure(Lit(a#19#0#0))
     == Lit(#_module.VoidOutcome.VoidFailure(a#19#0#0)));

function _module.VoidOutcome.error(DatatypeType) : Seq;

// Constructor injectivity
axiom (forall a#20#0#0: Seq :: 
  { #_module.VoidOutcome.VoidFailure(a#20#0#0) } 
  _module.VoidOutcome.error(#_module.VoidOutcome.VoidFailure(a#20#0#0))
     == a#20#0#0);

// Inductive seq element rank
axiom (forall a#21#0#0: Seq, i: int :: 
  { Seq#Index(a#21#0#0, i), #_module.VoidOutcome.VoidFailure(a#21#0#0) } 
  0 <= i && i < Seq#Length(a#21#0#0)
     ==> DtRank($Unbox(Seq#Index(a#21#0#0, i)): DatatypeType)
       < DtRank(#_module.VoidOutcome.VoidFailure(a#21#0#0)));

// Inductive seq rank
axiom (forall a#22#0#0: Seq :: 
  { #_module.VoidOutcome.VoidFailure(a#22#0#0) } 
  Seq#Rank(a#22#0#0) < DtRank(#_module.VoidOutcome.VoidFailure(a#22#0#0)));
...
axiom {:id "id0"} 0 <= $FunctionContextHeight
   ==> (forall this: DatatypeType :: 
    ...
    _module.VoidOutcome.IsFailure#canCall(this)
         || (0 < $FunctionContextHeight && $Is(this, Tclass._module.VoidOutcome()))
...
procedure {:verboseName "VoidOutcome.IsFailure (well-formedness)"} CheckWellformed$$_module.VoidOutcome.IsFailure(this: DatatypeType
       where $Is(this, Tclass._module.VoidOutcome())
...
procedure {:verboseName "VoidOutcome.PropagateFailure (well-formedness)"} CheckWellformed$$_module.VoidOutcome.PropagateFailure(this: DatatypeType
       where $Is(this, Tclass._module.VoidOutcome())
         && $IsAlloc(this, Tclass._module.VoidOutcome(), $Heap));
