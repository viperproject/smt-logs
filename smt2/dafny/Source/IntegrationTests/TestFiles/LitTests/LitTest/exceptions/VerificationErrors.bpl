// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VerificationErrors.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VerificationErrors-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VerificationErrors.dfy
...
procedure {:verboseName "CheckThatVerifierRunsInsideDesugaredExprs_Nat (well-formedness)"} CheckWellFormed$$_module.__default.CheckThatVerifierRunsInsideDesugaredExprs__Nat(r1#0: ref
       where $Is(r1#0, Tclass._module.NatOutcome())
         && $IsAlloc(r1#0, Tclass._module.NatOutcome(), $Heap), 
    r2#0: ref
       where $Is(r2#0, Tclass._module.NatOutcome())
         && $IsAlloc(r2#0, Tclass._module.NatOutcome(), $Heap))
   returns (res#0: ref
...
procedure {:verboseName "CheckThatVerifierRunsInsideDesugaredExprs_Nat (call)"} Call$$_module.__default.CheckThatVerifierRunsInsideDesugaredExprs__Nat(r1#0: ref
       where $Is(r1#0, Tclass._module.NatOutcome())
         && $IsAlloc(r1#0, Tclass._module.NatOutcome(), $Heap), 
    r2#0: ref
       where $Is(r2#0, Tclass._module.NatOutcome())
...
procedure {:verboseName "CheckThatVerifierRunsInsideDesugaredExprs_Nat (correctness)"} Impl$$_module.__default.CheckThatVerifierRunsInsideDesugaredExprs__Nat(r1#0: ref
       where $Is(r1#0, Tclass._module.NatOutcome())
         && $IsAlloc(r1#0, Tclass._module.NatOutcome(), $Heap), 
    r2#0: ref
       where $Is(r2#0, Tclass._module.NatOutcome())
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "CheckThatVerifierRunsInsideDesugaredExprs_Nat (correctness)"} Impl$$_module.__default.CheckThatVerifierRunsInsideDesugaredExprs__Nat(r1#0: ref, r2#0: ref)
   returns (defass#res#0: bool, res#0: ref, $_reverifyPost: bool)
{
  ...
  var n##1: int;
    ...
    // AddMethodImpl: CheckThatVerifierRunsInsideDesugaredExprs_Nat, Impl$$_module.__default.CheckThatVerifierRunsInsideDesugaredExprs__Nat
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assign-or-return statement (:-) ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VerificationErrors.dfy(8,11)
    havoc valueOrError0#0 /* where defass#valueOrError0#0
       ==> $Is(valueOrError0#0, Tclass._module.NatOutcome())
         && $IsAlloc(valueOrError0#0, Tclass._module.NatOutcome(), $Heap) */;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VerificationErrors.dfy(8,28)
    assume true;
    // TrCallStmt: Adding lhs with type NatOutcome
    // TrCallStmt: Before ProcessCallStmt
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VerificationErrors.dfy(8,29)
    assume true;
    assert {:id "id0"} r1#0 == r2#0;
    assume true;
    // ProcessCallStmt: CheckSubrange
    assert {:id "id1"} $Is(LitInt(12), Tclass._System.nat());
    n##0 := LitInt(12);
    call {:id "id2"} $rhs##0 := Call$$_module.__default.MakeNatSuccess(n##0);
    // TrCallStmt: After ProcessCallStmt
    valueOrError0#0 := $rhs##0;
    defass#valueOrError0#0 := true;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VerificationErrors.dfy(8,11)
    assert {:id "id4"} defass#valueOrError0#0;
    assert {:id "id5"} valueOrError0#0 != null;
    ...
    {
        push;
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VerificationErrors.dfy(8,11)
        assume true;
        assert {:id "id6"} defass#valueOrError0#0;
        assert {:id "id7"} valueOrError0#0 != null;
        // assume allocatedness for receiver argument to function
        assume $IsAllocBox($Box(valueOrError0#0), Tclass._module.NatOutcome?(), $Heap);
        assert {:id "id8"} {:subsumption 0} _module.NatOutcome.IsFailure(valueOrError0#0);
        ...
        defass#res#0 := true;
        // ----- return statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VerificationErrors.dfy(8,11)
        assert {:id "id10"} defass#res#0;
        pop;
        return;
    ...
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VerificationErrors.dfy(8,11)
    assume true;
    assert {:id "id11"} defass#valueOrError0#0;
    assert {:id "id12"} valueOrError0#0 != null;
    // assume allocatedness for receiver argument to function
    assume $IsAllocBox($Box(valueOrError0#0), Tclass._module.NatOutcome?(), $Heap);
    assert {:id "id13"} {:subsumption 0} !_module.NatOutcome.IsFailure(valueOrError0#0);
    assume !_module.NatOutcome.IsFailure(valueOrError0#0);
    assume _module.NatOutcome.Extract#canCall(valueOrError0#0);
    assume _module.NatOutcome.Extract#canCall(valueOrError0#0);
    a#0 := _module.NatOutcome.Extract(valueOrError0#0);
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VerificationErrors.dfy(9,26)
    assume true;
    // TrCallStmt: Adding lhs with type NatOutcome
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    n##1 := a#0;
    call {:id "id15"} $rhs##1 := Call$$_module.__default.MakeNatSuccess(n##1);
    // TrCallStmt: After ProcessCallStmt
    res#0 := $rhs##1;
    defass#res#0 := true;
    assert {:id "id17"} defass#res#0;
}
...
procedure {:verboseName "CheckThatVerifierRunsInsideDesugaredExprs_Void (well-formedness)"} CheckWellFormed$$_module.__default.CheckThatVerifierRunsInsideDesugaredExprs__Void(r1#0: ref
       where $Is(r1#0, Tclass._module.VoidOutcome())
         && $IsAlloc(r1#0, Tclass._module.VoidOutcome(), $Heap), 
    r2#0: ref
       where $Is(r2#0, Tclass._module.VoidOutcome())
         && $IsAlloc(r2#0, Tclass._module.VoidOutcome(), $Heap))
   returns (res#0: ref
...
procedure {:verboseName "CheckThatVerifierRunsInsideDesugaredExprs_Void (call)"} Call$$_module.__default.CheckThatVerifierRunsInsideDesugaredExprs__Void(r1#0: ref
       where $Is(r1#0, Tclass._module.VoidOutcome())
         && $IsAlloc(r1#0, Tclass._module.VoidOutcome(), $Heap), 
    r2#0: ref
       where $Is(r2#0, Tclass._module.VoidOutcome())
...
procedure {:verboseName "CheckThatVerifierRunsInsideDesugaredExprs_Void (correctness)"} Impl$$_module.__default.CheckThatVerifierRunsInsideDesugaredExprs__Void(r1#0: ref
       where $Is(r1#0, Tclass._module.VoidOutcome())
         && $IsAlloc(r1#0, Tclass._module.VoidOutcome(), $Heap), 
    r2#0: ref
       where $Is(r2#0, Tclass._module.VoidOutcome())
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "CheckThatVerifierRunsInsideDesugaredExprs_Void (correctness)"} Impl$$_module.__default.CheckThatVerifierRunsInsideDesugaredExprs__Void(r1#0: ref, r2#0: ref)
   returns (defass#res#0: bool, res#0: ref, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var x#0: int;
  ...
  var valueOrError0#0: ref
    ...
    // AddMethodImpl: CheckThatVerifierRunsInsideDesugaredExprs_Void, Impl$$_module.__default.CheckThatVerifierRunsInsideDesugaredExprs__Void
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VerificationErrors.dfy(13,11)
    assume true;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VerificationErrors.dfy(13,14)
    assume true;
    assert {:id "id18"} LitInt(2 + 2) == LitInt(4);
    assume true;
    x#0 := LitInt(8);
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VerificationErrors.dfy(14,5)
    assume true;
    assert {:id "id20"} x#0 == LitInt(8);
    // ----- assign-or-return statement (:-) ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VerificationErrors.dfy(15,5)
    havoc valueOrError0#0 /* where defass#valueOrError0#0
       ==> $Is(valueOrError0#0, Tclass._module.VoidOutcome())
         && $IsAlloc(valueOrError0#0, Tclass._module.VoidOutcome(), $Heap) */;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VerificationErrors.dfy(15,8)
    assume true;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VerificationErrors.dfy(15,9)
    assume true;
    assert {:id "id21"} r1#0 == r2#0;
    assume true;
    valueOrError0#0 := r1#0;
    defass#valueOrError0#0 := true;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VerificationErrors.dfy(15,5)
    assert {:id "id23"} defass#valueOrError0#0;
    assert {:id "id24"} valueOrError0#0 != null;
    // assume allocatedness for receiver argument to function
    ...
    {
        push;
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VerificationErrors.dfy(15,5)
        assume true;
        assert {:id "id25"} defass#valueOrError0#0;
        assert {:id "id26"} valueOrError0#0 != null;
        // assume allocatedness for receiver argument to function
        assume $IsAllocBox($Box(valueOrError0#0), Tclass._module.VoidOutcome?(), $Heap);
        assert {:id "id27"} {:subsumption 0} _module.VoidOutcome.IsFailure(valueOrError0#0);
        ...
        defass#res#0 := true;
        // ----- return statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VerificationErrors.dfy(15,5)
        assert {:id "id29"} defass#res#0;
        pop;
        return;
    ...
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/VerificationErrors.dfy(16,9)
    assume true;
    assume true;
    res#0 := r1#0;
    defass#res#0 := true;
    assert {:id "id31"} defass#res#0;
}
...
axiom {:id "id32"} (forall _module._default.Unreachable$R: Ty :: 
  { _module.__default.Unreachable(_module._default.Unreachable$R) } 
  _module.__default.Unreachable#canCall(_module._default.Unreachable$R)
       || Lit(false)
     ==> _module.__default.Unreachable(_module._default.Unreachable$R)
...
axiom {:id "id33"} (forall _module._default.Unreachable$R: Ty :: 
