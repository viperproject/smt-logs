...
(assert (distinct TChar TagChar TagSeq alloc Tagclass._module.NatOutcome Tagclass._module.NatOutcome? Tagclass._module.NatFailure? Tagclass._module.NatFailure tytagFamily$NatOutcome tytagFamily$NatFailure)
)
...
(assert (forall ((bx T@U) ($h T@U) ) (!  (=> (and ($IsAllocBox bx Tclass._module.NatFailure? $h) ($IsGoodHeap $h)) ($IsAllocBox bx Tclass._module.NatOutcome? $h))
 :qid |unknown.0:0|
 :skolemid |600|
 :pattern ( ($IsAllocBox bx Tclass._module.NatFailure? $h))
)))
...
(assert (forall ((|c#0@@0| T@U) ($h@@1 T@U) ) (! (= ($IsAlloc refType |c#0@@0| Tclass._module.NatFailure $h@@1) ($IsAlloc refType |c#0@@0| Tclass._module.NatFailure? $h@@1))
 :qid |unknown.0:0|
 :skolemid |594|
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass._module.NatFailure $h@@1))
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass._module.NatFailure? $h@@1))
)))
...
(assert (forall (($o@@0 T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType $o@@0 Tclass._module.NatOutcome? $h@@2)  (or (= $o@@0 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@0) alloc)))))
 :qid |unknown.0:0|
 :skolemid |517|
 :pattern ( ($IsAlloc refType $o@@0 Tclass._module.NatOutcome? $h@@2))
)))
(assert (forall (($o@@1 T@U) ($h@@3 T@U) ) (! (= ($IsAlloc refType $o@@1 Tclass._module.NatFailure? $h@@3)  (or (= $o@@1 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@1) alloc)))))
 :qid |unknown.0:0|
 :skolemid |564|
 :pattern ( ($IsAlloc refType $o@@1 Tclass._module.NatFailure? $h@@3))
)))
...
(assert (forall ((bx@@7 T@U) ) (!  (=> ($IsBox bx@@7 Tclass._module.NatFailure?) ($IsBox bx@@7 Tclass._module.NatOutcome?))
 :qid |unknown.0:0|
 :skolemid |599|
 :pattern ( ($IsBox bx@@7 Tclass._module.NatFailure?))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.MakeNatFailure)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (or (not (= call2formal@this null)) (not true)) (and ($Is refType call2formal@this Tclass._module.NatFailure) ($IsAlloc refType call2formal@this Tclass._module.NatFailure $Heap))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (or (not (= call2formal@this@0 null)) (not true)) (and ($Is refType call2formal@this@0 Tclass._module.NatFailure) ($IsAlloc refType call2formal@this@0 Tclass._module.NatFailure $Heap@0)))) (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap call2formal@this@0) alloc)))) (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6)))
 :qid |NatOutcomedfy.39:5|
 :skolemid |569|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SeqType |msg#0| (TSeq TChar)) ($IsAlloc SeqType |msg#0| (TSeq TChar) $Heap)) (=> |defass#res#0| (and ($Is refType |res#0| Tclass._module.NatOutcome) ($IsAlloc refType |res#0| Tclass._module.NatOutcome $Heap)))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
