...
(assert (distinct alloc Tagclass._module.VoidOutcome Tagclass._module.VoidOutcome? Tagclass._module.VoidFailure? Tagclass._module.VoidFailure tytagFamily$VoidOutcome tytagFamily$VoidFailure)
)
...
(assert (forall ((|c#0| T@U) ($h T@U) ) (! (= ($IsAlloc refType |c#0| Tclass._module.VoidOutcome $h) ($IsAlloc refType |c#0| Tclass._module.VoidOutcome? $h))
 :qid |unknown.0:0|
 :skolemid |498|
 :pattern ( ($IsAlloc refType |c#0| Tclass._module.VoidOutcome $h))
 :pattern ( ($IsAlloc refType |c#0| Tclass._module.VoidOutcome? $h))
)))
(assert (forall ((|c#0@@0| T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType |c#0@@0| Tclass._module.VoidFailure $h@@0) ($IsAlloc refType |c#0@@0| Tclass._module.VoidFailure? $h@@0))
 :qid |unknown.0:0|
 :skolemid |546|
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass._module.VoidFailure $h@@0))
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass._module.VoidFailure? $h@@0))
)))
...
(assert (forall (($o@@0 T@U) ($h@@1 T@U) ) (! (= ($IsAlloc refType $o@@0 Tclass._module.VoidOutcome? $h@@1)  (or (= $o@@0 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@1 $o@@0) alloc)))))
 :qid |unknown.0:0|
 :skolemid |490|
 :pattern ( ($IsAlloc refType $o@@0 Tclass._module.VoidOutcome? $h@@1))
)))
(assert (forall (($o@@1 T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType $o@@1 Tclass._module.VoidFailure? $h@@2)  (or (= $o@@1 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@1) alloc)))))
 :qid |unknown.0:0|
 :skolemid |524|
 :pattern ( ($IsAlloc refType $o@@1 Tclass._module.VoidFailure? $h@@2))
)))
...
(declare-fun VoidFailure_$_ReadsFrame@0 () T@U)
(declare-fun $Heap () T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun this () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id OverrideCheck$$_module.VoidFailure.IsFailure)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (and (= VoidFailure_$_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (forall (($o@@6 T@U) ($f@@0 T@U) ) (! true
 :qid |VoidOutcomedfy.25:15|
 :skolemid |536|
))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.VoidFailure) ($IsAlloc refType this Tclass._module.VoidFailure $Heap))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
