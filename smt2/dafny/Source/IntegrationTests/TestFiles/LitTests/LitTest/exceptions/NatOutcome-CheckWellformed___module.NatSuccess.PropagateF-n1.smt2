...
(declare-fun _module.NatSuccess.PropagateFailure (T@U) T@U)
(declare-fun |_module.NatSuccess.PropagateFailure#canCall| (T@U) Bool)
...
(let ((anon0_correct  (=> (and (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@1 alloc false)) ($IsAllocBox ($Box refType this@@5) Tclass._module.NatSuccess? $Heap@@1)) (and (|_module.NatSuccess.IsFailure#canCall| this@@5) (_module.NatSuccess.IsFailure this@@5))) (and (=> (= (ControlFlow 0 4) 1) anon5_Then_correct) (=> (= (ControlFlow 0 4) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (or (not (= this@@5 null)) (not true)) (and ($Is refType this@@5 Tclass._module.NatSuccess) ($IsAlloc refType this@@5 Tclass._module.NatSuccess $Heap@@1))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct))))
