// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/NatOutcome.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/NatOutcome-@PROC@.smt2 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/NatOutcome.dfy
...
axiom 1 <= $FunctionContextHeight
   ==> (forall _module._default.Unreachable$R: Ty :: 
    ...
    _module.__default.Unreachable#canCall(_module._default.Unreachable$R)
         || (1 < $FunctionContextHeight && Lit(false))
...
axiom 1 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, _module._default.Unreachable$R: Ty :: 
...
procedure {:verboseName "Unreachable (well-formedness)"} CheckWellformed$$_module.__default.Unreachable(_module._default.Unreachable$R: Ty);
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Unreachable (well-formedness)"} CheckWellformed$$_module.__default.Unreachable(_module._default.Unreachable$R: Ty)
{
  ...
  var let#0#0#0: DatatypeType;
    ...
    if (*)
    {
        ...
        assume $IsBox(_module.__default.Unreachable(_module._default.Unreachable$R), 
          _module._default.Unreachable$R);
        assume false;
    }
    else
    {
        ...
        havoc o#Z#0;
        assume {:id "id3"} let#0#0#0 == Lit(#_module.Option.None());
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(let#0#0#0, Tclass._module.Option(_module._default.Unreachable$R));
        assume {:id "id4"} o#Z#0 == let#0#0#0;
        // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/NatOutcome.dfy(11,5)
        assume true;
        assert {:id "id5"} _module.Option.Some_q(o#Z#0);
        assert {:id "id6"} _module.Option.Some_q(o#Z#0);
        assume {:id "id7"} _module.__default.Unreachable(_module._default.Unreachable$R)
           == _module.Option.get(o#Z#0);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $IsBox(_module.__default.Unreachable(_module._default.Unreachable$R), 
          _module._default.Unreachable$R);
...
procedure {:verboseName "MakeNatSuccess (correctness)"} Impl$$_module.__default.MakeNatSuccess(n#0: int where LitInt(0) <= n#0)
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MakeNatSuccess (correctness)"} Impl$$_module.__default.MakeNatSuccess(n#0: int) returns (defass#res#0: bool, res#0: ref, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var $nw: ref;
  var value##0: int;

    // AddMethodImpl: MakeNatSuccess, Impl$$_module.__default.MakeNatSuccess
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/NatOutcome.dfy(54,9)
    assume true;
    // ----- init call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/NatOutcome.dfy(54,12)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    value##0 := n#0;
    call {:id "id8"} $nw := Call$$_module.NatSuccess.__ctor(value##0);
...
procedure {:verboseName "MakeNatFailure (correctness)"} Impl$$_module.__default.MakeNatFailure(msg#0: Seq where $Is(msg#0, TSeq(TChar)) && $IsAlloc(msg#0, TSeq(TChar), $Heap))
   returns (defass#res#0: bool, 
    res#0: ref
       where defass#res#0
         ==> $Is(res#0, Tclass._module.NatOutcome())
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MakeNatFailure (correctness)"} Impl$$_module.__default.MakeNatFailure(msg#0: Seq) returns (defass#res#0: bool, res#0: ref, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var $nw: ref;
  var error##0: Seq;

    // AddMethodImpl: MakeNatFailure, Impl$$_module.__default.MakeNatFailure
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/NatOutcome.dfy(58,9)
    assume true;
    // ----- init call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/exceptions/NatOutcome.dfy(58,12)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    error##0 := msg#0;
    call {:id "id11"} $nw := Call$$_module.NatFailure.__ctor(error##0);
    // TrCallStmt: After ProcessCallStmt
    res#0 := $nw;
    defass#res#0 := true;
    assert {:id "id13"} defass#res#0;
}
...
procedure {:verboseName "NatOutcome.IsFailure (well-formedness)"} CheckWellformed$$_module.NatOutcome.IsFailure(this: ref
       where this != null
         && 
...
procedure {:verboseName "NatOutcome.PropagateFailure (well-formedness)"} CheckWellformed$$_module.NatOutcome.PropagateFailure(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.NatOutcome())
         && $IsAlloc(this, Tclass._module.NatOutcome(), $Heap));
...
procedure {:verboseName "NatOutcome.Extract (well-formedness)"} CheckWellformed$$_module.NatOutcome.Extract(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.NatOutcome())
         && $IsAlloc(this, Tclass._module.NatOutcome(), $Heap));
...
procedure {:verboseName "NatSuccess._ctor (well-formedness)"} CheckWellFormed$$_module.NatSuccess.__ctor(value#0: int where LitInt(0) <= value#0) returns (this: ref);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "NatSuccess._ctor (call)"} Call$$_module.NatSuccess.__ctor(value#0: int where LitInt(0) <= value#0)
   returns (this: ref
       where this != null
         && 
...
procedure {:verboseName "NatSuccess._ctor (correctness)"} Impl$$_module.NatSuccess.__ctor(value#0: int where LitInt(0) <= value#0)
...
procedure {:verboseName "NatSuccess.IsFailure (well-formedness)"} CheckWellformed$$_module.NatSuccess.IsFailure(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.NatSuccess())
         && $IsAlloc(this, Tclass._module.NatSuccess(), $Heap));
...
procedure {:verboseName "NatSuccess.IsFailure (override check)"} OverrideCheck$$_module.NatSuccess.IsFailure(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.NatSuccess())
         && $IsAlloc(this, Tclass._module.NatSuccess(), $Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NatSuccess.IsFailure (override check)"} OverrideCheck$$_module.NatSuccess.IsFailure(this: ref)
{
  var NatSuccess_$_ReadsFrame: [ref,Field]bool;

    assert {:id "id20"} true;
    NatSuccess_$_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
...
procedure {:verboseName "NatSuccess.PropagateFailure (well-formedness)"} CheckWellformed$$_module.NatSuccess.PropagateFailure(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.NatSuccess())
         && $IsAlloc(this, Tclass._module.NatSuccess(), $Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NatSuccess.PropagateFailure (well-formedness)"} CheckWellformed$$_module.NatSuccess.PropagateFailure(this: ref)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    assume $IsAllocBox($Box(this), Tclass._module.NatSuccess?(), $Heap);
    assume _module.NatSuccess.IsFailure#canCall(this);
    assume {:id "id24"} _module.NatSuccess.IsFailure(this);
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    {
        // Check well-formedness of postcondition and assume false
        assume $Is(_module.NatSuccess.PropagateFailure(this), Tclass._module.NatOutcome());
        assume false;
    }
    else
    {
        // Check well-formedness of body and result subset type constraint
        assert {:id "id25"} {:subsumption 0} Lit(false);
        assume Lit(false);
        assume _module.__default.Unreachable#canCall(Tclass._module.NatOutcome());
        assume {:id "id26"} _module.NatSuccess.PropagateFailure(this)
           == Lit($Unbox(_module.__default.Unreachable(Tclass._module.NatOutcome())): ref);
        assume _module.__default.Unreachable#canCall(Tclass._module.NatOutcome());
        // CheckWellformedWithResult: any expression
        assume $Is(_module.NatSuccess.PropagateFailure(this), Tclass._module.NatOutcome());
...
procedure {:verboseName "NatSuccess.PropagateFailure (override check)"} OverrideCheck$$_module.NatSuccess.PropagateFailure(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.NatSuccess())
         && $IsAlloc(this, Tclass._module.NatSuccess(), $Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NatSuccess.PropagateFailure (override check)"} OverrideCheck$$_module.NatSuccess.PropagateFailure(this: ref)
{
  var NatSuccess_$_ReadsFrame: [ref,Field]bool;

    assume {:id "id27"} _module.NatSuccess.IsFailure(this);
    assert {:id "id28"} _module.NatSuccess.IsFailure#canCall(this)
       ==> _module.NatSuccess.IsFailure(this) || Lit(false);
    assert {:id "id29"} true;
    NatSuccess_$_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
...
procedure {:verboseName "NatSuccess.Extract (well-formedness)"} CheckWellformed$$_module.NatSuccess.Extract(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.NatSuccess())
         && $IsAlloc(this, Tclass._module.NatSuccess(), $Heap));
...
procedure {:verboseName "NatSuccess.Extract (override check)"} OverrideCheck$$_module.NatSuccess.Extract(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.NatSuccess())
         && $IsAlloc(this, Tclass._module.NatSuccess(), $Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NatSuccess.Extract (override check)"} OverrideCheck$$_module.NatSuccess.Extract(this: ref)
{
  var NatSuccess_$_ReadsFrame: [ref,Field]bool;

    assume {:id "id35"} !_module.NatSuccess.IsFailure(this);
    assert {:id "id36"} !_module.NatSuccess.IsFailure(this);
    assert {:id "id37"} true;
    NatSuccess_$_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
...
procedure {:verboseName "NatFailure._ctor (well-formedness)"} CheckWellFormed$$_module.NatFailure.__ctor(error#0: Seq
...
procedure {:verboseName "NatFailure._ctor (call)"} Call$$_module.NatFailure.__ctor(error#0: Seq
       where $Is(error#0, TSeq(TChar)) && $IsAlloc(error#0, TSeq(TChar), $Heap))
   returns (this: ref
       where this != null
         && 
...
procedure {:verboseName "NatFailure._ctor (correctness)"} Impl$$_module.NatFailure.__ctor(error#0: Seq
       where $Is(error#0, TSeq(TChar)) && $IsAlloc(error#0, TSeq(TChar), $Heap))
   returns (this: ref, $_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "NatFailure.IsFailure (well-formedness)"} CheckWellformed$$_module.NatFailure.IsFailure(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.NatFailure())
         && $IsAlloc(this, Tclass._module.NatFailure(), $Heap));
...
procedure {:verboseName "NatFailure.IsFailure (override check)"} OverrideCheck$$_module.NatFailure.IsFailure(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.NatFailure())
         && $IsAlloc(this, Tclass._module.NatFailure(), $Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NatFailure.IsFailure (override check)"} OverrideCheck$$_module.NatFailure.IsFailure(this: ref)
{
  var NatFailure_$_ReadsFrame: [ref,Field]bool;

    assert {:id "id43"} true;
    NatFailure_$_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
...
procedure {:verboseName "NatFailure.PropagateFailure (well-formedness)"} CheckWellformed$$_module.NatFailure.PropagateFailure(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.NatFailure())
         && $IsAlloc(this, Tclass._module.NatFailure(), $Heap));
...
procedure {:verboseName "NatFailure.PropagateFailure (override check)"} OverrideCheck$$_module.NatFailure.PropagateFailure(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.NatFailure())
         && $IsAlloc(this, Tclass._module.NatFailure(), $Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NatFailure.PropagateFailure (override check)"} OverrideCheck$$_module.NatFailure.PropagateFailure(this: ref)
{
  var NatFailure_$_ReadsFrame: [ref,Field]bool;

    assume {:id "id49"} _module.NatFailure.IsFailure(this);
    assert {:id "id50"} _module.NatFailure.IsFailure#canCall(this)
       ==> _module.NatFailure.IsFailure(this) || Lit(true);
    assert {:id "id51"} true;
    NatFailure_$_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    assert {:id "id52"} (forall $o: ref, $f: Field :: true);
}
...
procedure {:verboseName "NatFailure.Extract (well-formedness)"} CheckWellformed$$_module.NatFailure.Extract(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.NatFailure())
         && $IsAlloc(this, Tclass._module.NatFailure(), $Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NatFailure.Extract (well-formedness)"} CheckWellformed$$_module.NatFailure.Extract(this: ref)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    // Check well-formedness of preconditions, and then assume them
    // assume allocatedness for receiver argument to function
    assume $IsAllocBox($Box(this), Tclass._module.NatFailure?(), $Heap);
    assume _module.NatFailure.IsFailure#canCall(this);
    assume {:id "id55"} !_module.NatFailure.IsFailure(this);
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    {
        // Check well-formedness of postcondition and assume false
        assume LitInt(0) <= _module.NatFailure.Extract(this);
        assume false;
    }
    else
    {
        ...
        assume Lit(false);
        assume _module.__default.Unreachable#canCall(Tclass._System.nat());
        assume {:id "id57"} _module.NatFailure.Extract(this)
           == LitInt($Unbox(_module.__default.Unreachable(Tclass._System.nat())): int);
        assume _module.__default.Unreachable#canCall(Tclass._System.nat());
        // CheckWellformedWithResult: any expression
        assume $Is(_module.NatFailure.Extract(this), Tclass._System.nat());
        return;
...
procedure {:verboseName "NatFailure.Extract (override check)"} OverrideCheck$$_module.NatFailure.Extract(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.NatFailure())
         && $IsAlloc(this, Tclass._module.NatFailure(), $Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NatFailure.Extract (override check)"} OverrideCheck$$_module.NatFailure.Extract(this: ref)
{
  var NatFailure_$_ReadsFrame: [ref,Field]bool;

    assume {:id "id58"} !_module.NatFailure.IsFailure(this);
    assert {:id "id59"} !_module.NatFailure.IsFailure(this);
    assert {:id "id60"} true;
    NatFailure_$_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    assert {:id "id61"} (forall $o: ref, $f: Field :: true);
}
