...
axiom (forall a#24#0#0: Seq :: 
  { #AST.Expr_Raw.Var(a#24#0#0) } 
  DatatypeCtorId(#AST.Expr_Raw.Var(a#24#0#0)) == ##AST.Expr_Raw.Var);
}
...
axiom (forall d: DatatypeType :: 
  { AST.Expr__Raw.Var_q(d) } 
  AST.Expr__Raw.Var_q(d)
     ==> (exists a#25#0#0: Seq :: d == #AST.Expr_Raw.Var(a#25#0#0)));
...
axiom (forall a#26#0#0: Seq :: 
  { $Is(#AST.Expr_Raw.Var(a#26#0#0), Tclass.AST.Expr__Raw()) } 
  $Is(#AST.Expr_Raw.Var(a#26#0#0), Tclass.AST.Expr__Raw())
...
axiom (forall a#27#0#0: Seq :: 
  { #AST.Expr_Raw.Var(Lit(a#27#0#0)) } 
  #AST.Expr_Raw.Var(Lit(a#27#0#0)) == Lit(#AST.Expr_Raw.Var(a#27#0#0)));
...
axiom (forall a#28#0#0: Seq :: 
  ...
  AST.Expr__Raw.name(#AST.Expr_Raw.Var(a#28#0#0)) == a#28#0#0);

// Inductive seq element rank
axiom (forall a#29#0#0: Seq, i: int :: 
  { Seq#Index(a#29#0#0, i), #AST.Expr_Raw.Var(a#29#0#0) } 
  0 <= i && i < Seq#Length(a#29#0#0)
     ==> DtRank($Unbox(Seq#Index(a#29#0#0, i)): DatatypeType)
       < DtRank(#AST.Expr_Raw.Var(a#29#0#0)));

// Inductive seq rank
axiom (forall a#30#0#0: Seq :: 
  { #AST.Expr_Raw.Var(a#30#0#0) } 
  Seq#Rank(a#30#0#0) < DtRank(#AST.Expr_Raw.Var(a#30#0#0)));
...
axiom (forall a#31#0#0: int :: 
  { #AST.Expr_Raw.Literal(a#31#0#0) } 
  DatatypeCtorId(#AST.Expr_Raw.Literal(a#31#0#0)) == ##AST.Expr_Raw.Literal);
}
...
axiom (forall d: DatatypeType :: 
  { AST.Expr__Raw.Literal_q(d) } 
  AST.Expr__Raw.Literal_q(d)
     ==> (exists a#32#0#0: int :: d == #AST.Expr_Raw.Literal(a#32#0#0)));

// Constructor $Is
axiom (forall a#33#0#0: int :: 
  { $Is(#AST.Expr_Raw.Literal(a#33#0#0), Tclass.AST.Expr__Raw()) } 
  $Is(#AST.Expr_Raw.Literal(a#33#0#0), Tclass.AST.Expr__Raw())
     <==> $Is(a#33#0#0, TInt));
...
axiom (forall a#34#0#0: int :: 
  { #AST.Expr_Raw.Literal(LitInt(a#34#0#0)) } 
  #AST.Expr_Raw.Literal(LitInt(a#34#0#0)) == Lit(#AST.Expr_Raw.Literal(a#34#0#0)));

function AST.Expr__Raw.n(DatatypeType) : int;

// Constructor injectivity
axiom (forall a#35#0#0: int :: 
  { #AST.Expr_Raw.Literal(a#35#0#0) } 
  AST.Expr__Raw.n(#AST.Expr_Raw.Literal(a#35#0#0)) == a#35#0#0);
...
axiom (forall a#36#0#0: Seq, a#36#1#0: Seq, a#36#2#0: DatatypeType :: 
  { #AST.Expr_Raw.Bind(a#36#0#0, a#36#1#0, a#36#2#0) } 
  DatatypeCtorId(#AST.Expr_Raw.Bind(a#36#0#0, a#36#1#0, a#36#2#0))
     == ##AST.Expr_Raw.Bind);
}
...
axiom (forall d: DatatypeType :: 
  { AST.Expr__Raw.Bind_q(d) } 
  AST.Expr__Raw.Bind_q(d)
     ==> (exists a#37#0#0: Seq, a#37#1#0: Seq, a#37#2#0: DatatypeType :: 
      d == #AST.Expr_Raw.Bind(a#37#0#0, a#37#1#0, a#37#2#0)));

// Constructor $Is
axiom (forall a#38#0#0: Seq, a#38#1#0: Seq, a#38#2#0: DatatypeType :: 
  { $Is(#AST.Expr_Raw.Bind(a#38#0#0, a#38#1#0, a#38#2#0), Tclass.AST.Expr__Raw()) } 
  $Is(#AST.Expr_Raw.Bind(a#38#0#0, a#38#1#0, a#38#2#0), Tclass.AST.Expr__Raw())
     <==> $Is(a#38#0#0, TSeq(TSeq(TChar)))
       && $Is(a#38#1#0, TSeq(Tclass.AST.Expr__Raw()))
       && $Is(a#38#2#0, Tclass.AST.Expr__Raw()));
...
// Constructor literal
axiom (forall a#39#0#0: Seq, a#39#1#0: Seq, a#39#2#0: DatatypeType :: 
  { #AST.Expr_Raw.Bind(Lit(a#39#0#0), Lit(a#39#1#0), Lit(a#39#2#0)) } 
  #AST.Expr_Raw.Bind(Lit(a#39#0#0), Lit(a#39#1#0), Lit(a#39#2#0))
     == Lit(#AST.Expr_Raw.Bind(a#39#0#0, a#39#1#0, a#39#2#0)));
...
axiom (forall a#40#0#0: Seq, a#40#1#0: Seq, a#40#2#0: DatatypeType :: 
  ...
  AST.Expr__Raw.bvars(#AST.Expr_Raw.Bind(a#40#0#0, a#40#1#0, a#40#2#0))
     == a#40#0#0);

// Inductive seq element rank
axiom (forall a#41#0#0: Seq, a#41#1#0: Seq, a#41#2#0: DatatypeType, i: int :: 
  { Seq#Index(a#41#0#0, i), #AST.Expr_Raw.Bind(a#41#0#0, a#41#1#0, a#41#2#0) } 
  0 <= i && i < Seq#Length(a#41#0#0)
     ==> DtRank($Unbox(Seq#Index(a#41#0#0, i)): DatatypeType)
       < DtRank(#AST.Expr_Raw.Bind(a#41#0#0, a#41#1#0, a#41#2#0)));

// Inductive seq rank
axiom (forall a#42#0#0: Seq, a#42#1#0: Seq, a#42#2#0: DatatypeType :: 
  { #AST.Expr_Raw.Bind(a#42#0#0, a#42#1#0, a#42#2#0) } 
  Seq#Rank(a#42#0#0) < DtRank(#AST.Expr_Raw.Bind(a#42#0#0, a#42#1#0, a#42#2#0)));
...
axiom (forall a#43#0#0: Seq, a#43#1#0: Seq, a#43#2#0: DatatypeType :: 
  ...
  AST.Expr__Raw.bvals(#AST.Expr_Raw.Bind(a#43#0#0, a#43#1#0, a#43#2#0))
     == a#43#1#0);

// Inductive seq element rank
axiom (forall a#44#0#0: Seq, a#44#1#0: Seq, a#44#2#0: DatatypeType, i: int :: 
  { Seq#Index(a#44#1#0, i), #AST.Expr_Raw.Bind(a#44#0#0, a#44#1#0, a#44#2#0) } 
  0 <= i && i < Seq#Length(a#44#1#0)
     ==> DtRank($Unbox(Seq#Index(a#44#1#0, i)): DatatypeType)
       < DtRank(#AST.Expr_Raw.Bind(a#44#0#0, a#44#1#0, a#44#2#0)));

// Inductive seq rank
axiom (forall a#45#0#0: Seq, a#45#1#0: Seq, a#45#2#0: DatatypeType :: 
  { #AST.Expr_Raw.Bind(a#45#0#0, a#45#1#0, a#45#2#0) } 
  Seq#Rank(a#45#1#0) < DtRank(#AST.Expr_Raw.Bind(a#45#0#0, a#45#1#0, a#45#2#0)));

function AST.Expr__Raw.body(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#46#0#0: Seq, a#46#1#0: Seq, a#46#2#0: DatatypeType :: 
  { #AST.Expr_Raw.Bind(a#46#0#0, a#46#1#0, a#46#2#0) } 
  AST.Expr__Raw.body(#AST.Expr_Raw.Bind(a#46#0#0, a#46#1#0, a#46#2#0)) == a#46#2#0);

// Inductive rank
axiom (forall a#47#0#0: Seq, a#47#1#0: Seq, a#47#2#0: DatatypeType :: 
  { #AST.Expr_Raw.Bind(a#47#0#0, a#47#1#0, a#47#2#0) } 
  DtRank(a#47#2#0) < DtRank(#AST.Expr_Raw.Bind(a#47#0#0, a#47#1#0, a#47#2#0)));
...
axiom (forall a#48#0#0: Seq, a#48#1#0: Seq :: 
  { #AST.Expr_Raw.Assign(a#48#0#0, a#48#1#0) } 
  DatatypeCtorId(#AST.Expr_Raw.Assign(a#48#0#0, a#48#1#0))
     == ##AST.Expr_Raw.Assign);
}
...
axiom (forall d: DatatypeType :: 
  { AST.Expr__Raw.Assign_q(d) } 
  AST.Expr__Raw.Assign_q(d)
     ==> (exists a#49#0#0: Seq, a#49#1#0: Seq :: 
      d == #AST.Expr_Raw.Assign(a#49#0#0, a#49#1#0)));

// Constructor $Is
axiom (forall a#50#0#0: Seq, a#50#1#0: Seq :: 
  { $Is(#AST.Expr_Raw.Assign(a#50#0#0, a#50#1#0), Tclass.AST.Expr__Raw()) } 
  $Is(#AST.Expr_Raw.Assign(a#50#0#0, a#50#1#0), Tclass.AST.Expr__Raw())
     <==> $Is(a#50#0#0, TSeq(TSeq(TChar))) && $Is(a#50#1#0, TSeq(Tclass.AST.Expr__Raw())));
...
// Constructor literal
axiom (forall a#51#0#0: Seq, a#51#1#0: Seq :: 
  { #AST.Expr_Raw.Assign(Lit(a#51#0#0), Lit(a#51#1#0)) } 
  #AST.Expr_Raw.Assign(Lit(a#51#0#0), Lit(a#51#1#0))
     == Lit(#AST.Expr_Raw.Assign(a#51#0#0, a#51#1#0)));
...
axiom (forall a#52#0#0: Seq, a#52#1#0: Seq :: 
  ...
  AST.Expr__Raw.avars(#AST.Expr_Raw.Assign(a#52#0#0, a#52#1#0)) == a#52#0#0);

// Inductive seq element rank
axiom (forall a#53#0#0: Seq, a#53#1#0: Seq, i: int :: 
  { Seq#Index(a#53#0#0, i), #AST.Expr_Raw.Assign(a#53#0#0, a#53#1#0) } 
  0 <= i && i < Seq#Length(a#53#0#0)
     ==> DtRank($Unbox(Seq#Index(a#53#0#0, i)): DatatypeType)
       < DtRank(#AST.Expr_Raw.Assign(a#53#0#0, a#53#1#0)));

// Inductive seq rank
axiom (forall a#54#0#0: Seq, a#54#1#0: Seq :: 
  { #AST.Expr_Raw.Assign(a#54#0#0, a#54#1#0) } 
  Seq#Rank(a#54#0#0) < DtRank(#AST.Expr_Raw.Assign(a#54#0#0, a#54#1#0)));
...
axiom (forall a#55#0#0: Seq, a#55#1#0: Seq :: 
  ...
  AST.Expr__Raw.avals(#AST.Expr_Raw.Assign(a#55#0#0, a#55#1#0)) == a#55#1#0);

// Inductive seq element rank
axiom (forall a#56#0#0: Seq, a#56#1#0: Seq, i: int :: 
  { Seq#Index(a#56#1#0, i), #AST.Expr_Raw.Assign(a#56#0#0, a#56#1#0) } 
  0 <= i && i < Seq#Length(a#56#1#0)
     ==> DtRank($Unbox(Seq#Index(a#56#1#0, i)): DatatypeType)
       < DtRank(#AST.Expr_Raw.Assign(a#56#0#0, a#56#1#0)));

// Inductive seq rank
axiom (forall a#57#0#0: Seq, a#57#1#0: Seq :: 
  { #AST.Expr_Raw.Assign(a#57#0#0, a#57#1#0) } 
  Seq#Rank(a#57#1#0) < DtRank(#AST.Expr_Raw.Assign(a#57#0#0, a#57#1#0)));
...
axiom (forall a#58#0#0: DatatypeType, a#58#1#0: DatatypeType, a#58#2#0: DatatypeType :: 
  { #AST.Expr_Raw.If(a#58#0#0, a#58#1#0, a#58#2#0) } 
  DatatypeCtorId(#AST.Expr_Raw.If(a#58#0#0, a#58#1#0, a#58#2#0))
     == ##AST.Expr_Raw.If);
}
...
axiom (forall d: DatatypeType :: 
  { AST.Expr__Raw.If_q(d) } 
  AST.Expr__Raw.If_q(d)
     ==> (exists a#59#0#0: DatatypeType, a#59#1#0: DatatypeType, a#59#2#0: DatatypeType :: 
      d == #AST.Expr_Raw.If(a#59#0#0, a#59#1#0, a#59#2#0)));

// Constructor $Is
axiom (forall a#60#0#0: DatatypeType, a#60#1#0: DatatypeType, a#60#2#0: DatatypeType :: 
  { $Is(#AST.Expr_Raw.If(a#60#0#0, a#60#1#0, a#60#2#0), Tclass.AST.Expr__Raw()) } 
  $Is(#AST.Expr_Raw.If(a#60#0#0, a#60#1#0, a#60#2#0), Tclass.AST.Expr__Raw())
     <==> $Is(a#60#0#0, Tclass.AST.Expr__Raw())
       && $Is(a#60#1#0, Tclass.AST.Expr__Raw())
       && $Is(a#60#2#0, Tclass.AST.Expr__Raw()));
...
axiom (forall a#61#0#0: DatatypeType, a#61#1#0: DatatypeType, a#61#2#0: DatatypeType :: 
  { #AST.Expr_Raw.If(Lit(a#61#0#0), Lit(a#61#1#0), Lit(a#61#2#0)) } 
  #AST.Expr_Raw.If(Lit(a#61#0#0), Lit(a#61#1#0), Lit(a#61#2#0))
     == Lit(#AST.Expr_Raw.If(a#61#0#0, a#61#1#0, a#61#2#0)));
...
axiom (forall a#62#0#0: DatatypeType, a#62#1#0: DatatypeType, a#62#2#0: DatatypeType :: 
  ...
  AST.Expr__Raw.cond(#AST.Expr_Raw.If(a#62#0#0, a#62#1#0, a#62#2#0)) == a#62#0#0);

// Inductive rank
axiom (forall a#63#0#0: DatatypeType, a#63#1#0: DatatypeType, a#63#2#0: DatatypeType :: 
  { #AST.Expr_Raw.If(a#63#0#0, a#63#1#0, a#63#2#0) } 
  DtRank(a#63#0#0) < DtRank(#AST.Expr_Raw.If(a#63#0#0, a#63#1#0, a#63#2#0)));
...
axiom (forall a#64#0#0: DatatypeType, a#64#1#0: DatatypeType, a#64#2#0: DatatypeType :: 
  ...
  AST.Expr__Raw.thn(#AST.Expr_Raw.If(a#64#0#0, a#64#1#0, a#64#2#0)) == a#64#1#0);

// Inductive rank
axiom (forall a#65#0#0: DatatypeType, a#65#1#0: DatatypeType, a#65#2#0: DatatypeType :: 
  { #AST.Expr_Raw.If(a#65#0#0, a#65#1#0, a#65#2#0) } 
  DtRank(a#65#1#0) < DtRank(#AST.Expr_Raw.If(a#65#0#0, a#65#1#0, a#65#2#0)));
...
axiom (forall a#66#0#0: DatatypeType, a#66#1#0: DatatypeType, a#66#2#0: DatatypeType :: 
  { #AST.Expr_Raw.If(a#66#0#0, a#66#1#0, a#66#2#0) } 
  AST.Expr__Raw.els(#AST.Expr_Raw.If(a#66#0#0, a#66#1#0, a#66#2#0)) == a#66#2#0);

// Inductive rank
axiom (forall a#67#0#0: DatatypeType, a#67#1#0: DatatypeType, a#67#2#0: DatatypeType :: 
  { #AST.Expr_Raw.If(a#67#0#0, a#67#1#0, a#67#2#0) } 
  DtRank(a#67#2#0) < DtRank(#AST.Expr_Raw.If(a#67#0#0, a#67#1#0, a#67#2#0)));
...
axiom (forall a#68#0#0: DatatypeType, a#68#1#0: DatatypeType, a#68#2#0: DatatypeType :: 
  { #AST.Expr_Raw.Op(a#68#0#0, a#68#1#0, a#68#2#0) } 
  DatatypeCtorId(#AST.Expr_Raw.Op(a#68#0#0, a#68#1#0, a#68#2#0))
     == ##AST.Expr_Raw.Op);
}
...
axiom (forall d: DatatypeType :: 
  { AST.Expr__Raw.Op_q(d) } 
  AST.Expr__Raw.Op_q(d)
     ==> (exists a#69#0#0: DatatypeType, a#69#1#0: DatatypeType, a#69#2#0: DatatypeType :: 
      d == #AST.Expr_Raw.Op(a#69#0#0, a#69#1#0, a#69#2#0)));

// Constructor $Is
axiom (forall a#70#0#0: DatatypeType, a#70#1#0: DatatypeType, a#70#2#0: DatatypeType :: 
  { $Is(#AST.Expr_Raw.Op(a#70#0#0, a#70#1#0, a#70#2#0), Tclass.AST.Expr__Raw()) } 
  $Is(#AST.Expr_Raw.Op(a#70#0#0, a#70#1#0, a#70#2#0), Tclass.AST.Expr__Raw())
     <==> $Is(a#70#0#0, Tclass.AST.BinOp())
       && $Is(a#70#1#0, Tclass.AST.Expr__Raw())
       && $Is(a#70#2#0, Tclass.AST.Expr__Raw()));
...
axiom (forall a#71#0#0: DatatypeType, a#71#1#0: DatatypeType, a#71#2#0: DatatypeType :: 
  { #AST.Expr_Raw.Op(Lit(a#71#0#0), Lit(a#71#1#0), Lit(a#71#2#0)) } 
  #AST.Expr_Raw.Op(Lit(a#71#0#0), Lit(a#71#1#0), Lit(a#71#2#0))
     == Lit(#AST.Expr_Raw.Op(a#71#0#0, a#71#1#0, a#71#2#0)));
...
axiom (forall a#72#0#0: DatatypeType, a#72#1#0: DatatypeType, a#72#2#0: DatatypeType :: 
  ...
  AST.Expr__Raw.op(#AST.Expr_Raw.Op(a#72#0#0, a#72#1#0, a#72#2#0)) == a#72#0#0);

// Inductive rank
axiom (forall a#73#0#0: DatatypeType, a#73#1#0: DatatypeType, a#73#2#0: DatatypeType :: 
  { #AST.Expr_Raw.Op(a#73#0#0, a#73#1#0, a#73#2#0) } 
  DtRank(a#73#0#0) < DtRank(#AST.Expr_Raw.Op(a#73#0#0, a#73#1#0, a#73#2#0)));
...
axiom (forall a#74#0#0: DatatypeType, a#74#1#0: DatatypeType, a#74#2#0: DatatypeType :: 
  ...
  AST.Expr__Raw.oe1(#AST.Expr_Raw.Op(a#74#0#0, a#74#1#0, a#74#2#0)) == a#74#1#0);

// Inductive rank
axiom (forall a#75#0#0: DatatypeType, a#75#1#0: DatatypeType, a#75#2#0: DatatypeType :: 
  { #AST.Expr_Raw.Op(a#75#0#0, a#75#1#0, a#75#2#0) } 
  DtRank(a#75#1#0) < DtRank(#AST.Expr_Raw.Op(a#75#0#0, a#75#1#0, a#75#2#0)));

function AST.Expr__Raw.oe2(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#76#0#0: DatatypeType, a#76#1#0: DatatypeType, a#76#2#0: DatatypeType :: 
  { #AST.Expr_Raw.Op(a#76#0#0, a#76#1#0, a#76#2#0) } 
  AST.Expr__Raw.oe2(#AST.Expr_Raw.Op(a#76#0#0, a#76#1#0, a#76#2#0)) == a#76#2#0);

// Inductive rank
axiom (forall a#77#0#0: DatatypeType, a#77#1#0: DatatypeType, a#77#2#0: DatatypeType :: 
  { #AST.Expr_Raw.Op(a#77#0#0, a#77#1#0, a#77#2#0) } 
  DtRank(a#77#2#0) < DtRank(#AST.Expr_Raw.Op(a#77#0#0, a#77#1#0, a#77#2#0)));
...
axiom (forall a#78#0#0: Seq :: 
  { #AST.Expr_Raw.Seq(a#78#0#0) } 
  DatatypeCtorId(#AST.Expr_Raw.Seq(a#78#0#0)) == ##AST.Expr_Raw.Seq);
}
...
axiom (forall d: DatatypeType :: 
  { AST.Expr__Raw.Seq_q(d) } 
  AST.Expr__Raw.Seq_q(d)
     ==> (exists a#79#0#0: Seq :: d == #AST.Expr_Raw.Seq(a#79#0#0)));

// Constructor $Is
axiom (forall a#80#0#0: Seq :: 
  { $Is(#AST.Expr_Raw.Seq(a#80#0#0), Tclass.AST.Expr__Raw()) } 
  $Is(#AST.Expr_Raw.Seq(a#80#0#0), Tclass.AST.Expr__Raw())
     <==> $Is(a#80#0#0, TSeq(Tclass.AST.Expr__Raw())));
...
// Constructor literal
axiom (forall a#81#0#0: Seq :: 
  { #AST.Expr_Raw.Seq(Lit(a#81#0#0)) } 
  #AST.Expr_Raw.Seq(Lit(a#81#0#0)) == Lit(#AST.Expr_Raw.Seq(a#81#0#0)));
...
axiom (forall a#82#0#0: Seq :: 
  ...
  AST.Expr__Raw.es(#AST.Expr_Raw.Seq(a#82#0#0)) == a#82#0#0);

// Inductive seq element rank
axiom (forall a#83#0#0: Seq, i: int :: 
  { Seq#Index(a#83#0#0, i), #AST.Expr_Raw.Seq(a#83#0#0) } 
  0 <= i && i < Seq#Length(a#83#0#0)
     ==> DtRank($Unbox(Seq#Index(a#83#0#0, i)): DatatypeType)
       < DtRank(#AST.Expr_Raw.Seq(a#83#0#0)));

// Inductive seq rank
axiom (forall a#84#0#0: Seq :: 
  { #AST.Expr_Raw.Seq(a#84#0#0) } 
  Seq#Rank(a#84#0#0) < DtRank(#AST.Expr_Raw.Seq(a#84#0#0)));
...
axiom 2 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, this: DatatypeType :: 
    ...
    AST.Expr__Raw.Depth#canCall(this)
         || (2 < $FunctionContextHeight && $Is(this, Tclass.AST.Expr__Raw()))
...
procedure {:verboseName "AST.Expr_Raw.Depth (well-formedness)"} CheckWellformed$$AST.Expr__Raw.Depth(this: DatatypeType
       where $Is(this, Tclass.AST.Expr__Raw())
         && $IsAlloc(this, Tclass.AST.Expr__Raw(), $Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "AST.Expr_Raw.Depth (well-formedness)"} CheckWellformed$$AST.Expr__Raw.Depth(this: DatatypeType)
{
  ...
  var let#9#0#0: Seq;
  var ##f#1: HandleType;
  var f#Z#1: HandleType;
  var let#10#0#0: HandleType;
  ...
  var let#14#0#0: int;
  var ##f#2: HandleType;
  var f#Z#2: HandleType;
  var let#15#0#0: HandleType;
  ...
  var b$reqreads#2: bool;
    ...
    if (*)
    {
        ...
        assume LitInt(0) <= AST.Expr__Raw.Depth($LS($LZ), this);
        assume false;
    }
    else
    {
        // Check well-formedness of body and result subset type constraint
        if (this == #AST.Expr_Raw.Var(_mcc#0#0))
        {
            assume $Is(_mcc#0#0, TSeq(TChar));
        }
        else if (this == #AST.Expr_Raw.Literal(_mcc#1#0))
        {
            havoc lit#Z#0;
            assume {:id "id112"} let#16#0#0 == _mcc#1#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#16#0#0, TInt);
            assume {:id "id113"} lit#Z#0 == let#16#0#0;
        }
        else if (this == #AST.Expr_Raw.Bind(_mcc#2#0, _mcc#3#0, _mcc#4#0))
        {
            assume $Is(_mcc#2#0, TSeq(TSeq(TChar)));
            assume $Is(_mcc#3#0, TSeq(Tclass.AST.Expr__Raw()));
            assume $Is(_mcc#4#0, Tclass.AST.Expr__Raw());
            havoc body#Z#0;
            assume {:id "id97"} let#11#0#0 == _mcc#4#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#11#0#0, Tclass.AST.Expr__Raw());
            assume {:id "id98"} body#Z#0 == let#11#0#0;
            havoc bvals#Z#0;
            assume {:id "id99"} let#12#0#0 == _mcc#3#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#12#0#0, TSeq(Tclass.AST.Expr__Raw()));
            assume {:id "id100"} bvals#Z#0 == let#12#0#0;
            havoc bvars#Z#0;
            assume {:id "id101"} let#13#0#0 == _mcc#2#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#13#0#0, TSeq(TSeq(TChar)));
            assume {:id "id102"} bvars#Z#0 == let#13#0#0;
            havoc m#Z#0;
            havoc f#Z#2;
            ...
            if (*)
            {
                ...
                havoc e#2;
                if ($Is(e#2, Tclass.AST.Expr__Raw())
                   && $IsAlloc(e#2, Tclass.AST.Expr__Raw(), $lambdaHeap#2))
                {
                    $_Frame#l2 := (lambda $o: ref, $f: Field :: 
                      $o != null && $Unbox(read($lambdaHeap#2, $o, alloc)): bool ==> false);
                    if (Seq#Contains(bvals#Z#0, $Box(e#2)))
                    {
                        // assume allocatedness for receiver argument to function
                        assume $IsAllocBox($Box(e#2), Tclass.AST.Expr__Raw(), $lambdaHeap#2);
                        assert {:id "id103"} DtRank(e#2) < DtRank(this);
                        assume AST.Expr__Raw.Depth#canCall(e#2);
                        assume {:id "id104"} lambdaResult#2 == AST.Expr__Raw.Depth($LS($LZ), e#2);
                        assume AST.Expr__Raw.Depth#canCall(e#2);
                        // CheckWellformedWithResult: any expression
                        assume $Is(lambdaResult#2, Tclass._System.nat());
                    }
                }
            ...
            assume {:id "id105"} let#15#0#0
               == Lit(AtLayer((lambda $l#37#ly#0: LayerType :: 
                    Handle1((lambda $l#37#heap#0: Heap, $l#37#e#0: Box :: 
                        $Box(AST.Expr__Raw.Depth($l#37#ly#0, $Unbox($l#37#e#0): DatatypeType))), 
                      (lambda $l#37#heap#0: Heap, $l#37#e#0: Box :: 
                        $IsBox($l#37#e#0, Tclass.AST.Expr__Raw()) && Seq#Contains(bvals#Z#0, $l#37#e#0)), 
                      (lambda $l#37#heap#0: Heap, $l#37#e#0: Box :: 
                        SetRef_to_SetBox((lambda $l#37#o#0: ref :: false))))), 
                  $LS($LZ)));
            assume (forall $l#38#e#0: DatatypeType :: 
              $Is($l#38#e#0, Tclass.AST.Expr__Raw())
                 ==> 
                Seq#Contains(bvals#Z#0, $Box($l#38#e#0))
                 ==> AST.Expr__Raw.Depth#canCall($l#38#e#0));
            // CheckWellformedWithResult: any expression
            assume $Is(let#15#0#0, 
              Tclass._System.___hPartialFunc1(Tclass.AST.Expr__Raw(), Tclass._System.nat()));
            assume {:id "id106"} f#Z#2 == let#15#0#0;
            ##f#2 := (var f#14 := Lit(AtLayer((lambda $l#39#ly#0: LayerType :: 
                      Handle1((lambda $l#39#heap#0: Heap, $l#39#e#0: Box :: 
                          $Box(AST.Expr__Raw.Depth($l#39#ly#0, $Unbox($l#39#e#0): DatatypeType))), 
                        (lambda $l#39#heap#0: Heap, $l#39#e#0: Box :: 
                          $IsBox($l#39#e#0, Tclass.AST.Expr__Raw()) && Seq#Contains(bvals#Z#0, $l#39#e#0)), 
                        (lambda $l#39#heap#0: Heap, $l#39#e#0: Box :: 
                          SetRef_to_SetBox((lambda $l#39#o#0: ref :: false))))), 
                    $LS($LZ))); 
              f#14);
            // assume allocatedness for argument to function
            assume $IsAlloc(##f#2, Tclass._System.___hFunc1(Tclass.AST.Expr__Raw(), TInt), $Heap);
            ##ts#2 := bvals#Z#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##ts#2, TSeq(Tclass.AST.Expr__Raw()), $Heap);
            ##default#2 := LitInt(0);
            // assume allocatedness for argument to function
            assume $IsAlloc(##default#2, TInt, $Heap);
            assert {:id "id107"} {:subsumption 0} (forall t#6: DatatypeType :: 
              { Requires1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#2, $Box(t#6)) } 
                { Seq#Contains(##ts#2, $Box(t#6)) } 
              $Is(t#6, Tclass.AST.Expr__Raw()) && Seq#Contains(##ts#2, $Box(t#6))
                 ==> Requires1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#2, $Box(t#6)));
            assume (forall t#6: DatatypeType :: 
              { Requires1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#2, $Box(t#6)) } 
                { Seq#Contains(##ts#2, $Box(t#6)) } 
              $Is(t#6, Tclass.AST.Expr__Raw()) && Seq#Contains(##ts#2, $Box(t#6))
                 ==> Requires1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#2, $Box(t#6)));
            assert {:id "id108"} {:subsumption 0} (forall t#7: DatatypeType :: 
              { $Unbox(Apply1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#2, $Box(t#7))): int } 
                { Seq#Contains(##ts#2, $Box(t#7)) } 
              $Is(t#7, Tclass.AST.Expr__Raw()) && Seq#Contains(##ts#2, $Box(t#7))
                 ==> ##default#2
                   <= $Unbox(Apply1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#2, $Box(t#7))): int);
            assume (forall t#7: DatatypeType :: 
              { $Unbox(Apply1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#2, $Box(t#7))): int } 
                { Seq#Contains(##ts#2, $Box(t#7)) } 
              $Is(t#7, Tclass.AST.Expr__Raw()) && Seq#Contains(##ts#2, $Box(t#7))
                 ==> ##default#2
            ...
            b$reqreads#2 := (forall $o: ref, $f: Field :: 
              $o != null
                   ...
                   && (exists t#8: DatatypeType, o#2: ref :: 
                    { Set#IsMember(Reads1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#2, $Box(t#8)), $Box(o#2)) } 
                    $Is(t#8, Tclass.AST.Expr__Raw())
                       && $Is(o#2, Tclass._System.object?())
                       && 
                      Seq#Contains(##ts#2, $Box(t#8))
                       && Set#IsMember(Reads1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#2, $Box(t#8)), $Box(o#2))
                       && $Box($o) == $Box(o#2))
                 ==> $_ReadsFrame[$o, $f]);
            assume Utils.__default.MaxF#canCall(Tclass.AST.Expr__Raw(), 
              $Heap, 
              (var f#14 := Lit(AtLayer((lambda $l#40#ly#0: LayerType :: 
                        Handle1((lambda $l#40#heap#0: Heap, $l#40#e#0: Box :: 
                            $Box(AST.Expr__Raw.Depth($l#40#ly#0, $Unbox($l#40#e#0): DatatypeType))), 
                          (lambda $l#40#heap#0: Heap, $l#40#e#0: Box :: 
                            $IsBox($l#40#e#0, Tclass.AST.Expr__Raw()) && Seq#Contains(bvals#Z#0, $l#40#e#0)), 
                          (lambda $l#40#heap#0: Heap, $l#40#e#0: Box :: 
              ...
              bvals#Z#0, 
              LitInt(0));
            assume {:id "id109"} let#14#0#0
               == Utils.__default.MaxF(Tclass.AST.Expr__Raw(), 
                $LS($LZ), 
                reveal_Utils._default.MaxF, 
                $Heap, 
                (var f#14 := Lit(AtLayer((lambda $l#42#ly#0: LayerType :: 
                          Handle1((lambda $l#42#heap#0: Heap, $l#42#e#0: Box :: 
                              $Box(AST.Expr__Raw.Depth($l#42#ly#0, $Unbox($l#42#e#0): DatatypeType))), 
                            (lambda $l#42#heap#0: Heap, $l#42#e#0: Box :: 
                              $IsBox($l#42#e#0, Tclass.AST.Expr__Raw()) && Seq#Contains(bvals#Z#0, $l#42#e#0)), 
                            (lambda $l#42#heap#0: Heap, $l#42#e#0: Box :: 
                ...
                bvals#Z#0, 
                LitInt(0));
            assume (forall $l#43#e#0: DatatypeType :: 
                $Is($l#43#e#0, Tclass.AST.Expr__Raw())
                   ==> 
                  Seq#Contains(bvals#Z#0, $Box($l#43#e#0))
                   ==> AST.Expr__Raw.Depth#canCall($l#43#e#0))
               && Utils.__default.MaxF#canCall(Tclass.AST.Expr__Raw(), 
                $Heap, 
                (var f#14 := Lit(AtLayer((lambda $l#45#ly#0: LayerType :: 
                          Handle1((lambda $l#45#heap#0: Heap, $l#45#e#0: Box :: 
                              $Box(AST.Expr__Raw.Depth($l#45#ly#0, $Unbox($l#45#e#0): DatatypeType))), 
                            (lambda $l#45#heap#0: Heap, $l#45#e#0: Box :: 
                              $IsBox($l#45#e#0, Tclass.AST.Expr__Raw()) && Seq#Contains(bvals#Z#0, $l#45#e#0)), 
                            (lambda $l#45#heap#0: Heap, $l#45#e#0: Box :: 
            ...
            assume {:id "id110"} m#Z#0 == let#14#0#0;
            ##x#3 := m#Z#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##x#3, TInt, $Heap);
            // assume allocatedness for receiver argument to function
            assume $IsAllocBox($Box(body#Z#0), Tclass.AST.Expr__Raw(), $Heap);
            assert {:id "id111"} DtRank(body#Z#0) < DtRank(this);
            assume AST.Expr__Raw.Depth#canCall(body#Z#0);
            ##y#3 := AST.Expr__Raw.Depth($LS($LZ), body#Z#0);
            // assume allocatedness for argument to function
            assume $IsAlloc(##y#3, TInt, $Heap);
            assume Utils.__default.Max#canCall(m#Z#0, AST.Expr__Raw.Depth($LS($LZ), body#Z#0));
        }
        else if (this == #AST.Expr_Raw.Assign(_mcc#5#0, _mcc#6#0))
        {
            assume $Is(_mcc#5#0, TSeq(TSeq(TChar)));
            assume $Is(_mcc#6#0, TSeq(Tclass.AST.Expr__Raw()));
            havoc avals#Z#0;
            assume {:id "id87"} let#8#0#0 == _mcc#6#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#8#0#0, TSeq(Tclass.AST.Expr__Raw()));
            assume {:id "id88"} avals#Z#0 == let#8#0#0;
            havoc avars#Z#0;
            assume {:id "id89"} let#9#0#0 == _mcc#5#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#9#0#0, TSeq(TSeq(TChar)));
            assume {:id "id90"} avars#Z#0 == let#9#0#0;
            havoc f#Z#1;
            // Begin Comprehension WF check
            if (*)
            {
                ...
                havoc e#1;
                if ($Is(e#1, Tclass.AST.Expr__Raw())
                   && $IsAlloc(e#1, Tclass.AST.Expr__Raw(), $lambdaHeap#1))
                {
                    $_Frame#l1 := (lambda $o: ref, $f: Field :: 
                      $o != null && $Unbox(read($lambdaHeap#1, $o, alloc)): bool ==> false);
                    if (Seq#Contains(avals#Z#0, $Box(e#1)))
                    {
                        // assume allocatedness for receiver argument to function
                        assume $IsAllocBox($Box(e#1), Tclass.AST.Expr__Raw(), $lambdaHeap#1);
                        assert {:id "id91"} DtRank(e#1) < DtRank(this);
                        assume AST.Expr__Raw.Depth#canCall(e#1);
                        assume {:id "id92"} lambdaResult#1 == AST.Expr__Raw.Depth($LS($LZ), e#1);
                        assume AST.Expr__Raw.Depth#canCall(e#1);
                        // CheckWellformedWithResult: any expression
            ...
            // End Comprehension WF check
            assume {:id "id93"} let#10#0#0
               == Lit(AtLayer((lambda $l#32#ly#0: LayerType :: 
                    Handle1((lambda $l#32#heap#0: Heap, $l#32#e#0: Box :: 
                        $Box(AST.Expr__Raw.Depth($l#32#ly#0, $Unbox($l#32#e#0): DatatypeType))), 
                      (lambda $l#32#heap#0: Heap, $l#32#e#0: Box :: 
                        $IsBox($l#32#e#0, Tclass.AST.Expr__Raw()) && Seq#Contains(avals#Z#0, $l#32#e#0)), 
                      (lambda $l#32#heap#0: Heap, $l#32#e#0: Box :: 
                        SetRef_to_SetBox((lambda $l#32#o#0: ref :: false))))), 
                  $LS($LZ)));
            assume (forall $l#33#e#0: DatatypeType :: 
              $Is($l#33#e#0, Tclass.AST.Expr__Raw())
                 ==> 
                Seq#Contains(avals#Z#0, $Box($l#33#e#0))
                 ==> AST.Expr__Raw.Depth#canCall($l#33#e#0));
            // CheckWellformedWithResult: any expression
            assume $Is(let#10#0#0, 
              Tclass._System.___hPartialFunc1(Tclass.AST.Expr__Raw(), Tclass._System.nat()));
            assume {:id "id94"} f#Z#1 == let#10#0#0;
            ##f#1 := (var f#13 := Lit(AtLayer((lambda $l#34#ly#0: LayerType :: 
                      Handle1((lambda $l#34#heap#0: Heap, $l#34#e#0: Box :: 
                          $Box(AST.Expr__Raw.Depth($l#34#ly#0, $Unbox($l#34#e#0): DatatypeType))), 
                        (lambda $l#34#heap#0: Heap, $l#34#e#0: Box :: 
                          $IsBox($l#34#e#0, Tclass.AST.Expr__Raw()) && Seq#Contains(avals#Z#0, $l#34#e#0)), 
                        (lambda $l#34#heap#0: Heap, $l#34#e#0: Box :: 
                          SetRef_to_SetBox((lambda $l#34#o#0: ref :: false))))), 
                    $LS($LZ))); 
              f#13);
            // assume allocatedness for argument to function
            assume $IsAlloc(##f#1, Tclass._System.___hFunc1(Tclass.AST.Expr__Raw(), TInt), $Heap);
            ##ts#1 := avals#Z#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##ts#1, TSeq(Tclass.AST.Expr__Raw()), $Heap);
            ##default#1 := LitInt(0);
            // assume allocatedness for argument to function
            assume $IsAlloc(##default#1, TInt, $Heap);
            assert {:id "id95"} {:subsumption 0} (forall t#3: DatatypeType :: 
              { Requires1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#1, $Box(t#3)) } 
                { Seq#Contains(##ts#1, $Box(t#3)) } 
              $Is(t#3, Tclass.AST.Expr__Raw()) && Seq#Contains(##ts#1, $Box(t#3))
                 ==> Requires1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#1, $Box(t#3)));
            assume (forall t#3: DatatypeType :: 
              ...
              $Is(t#3, Tclass.AST.Expr__Raw()) && Seq#Contains(##ts#1, $Box(t#3))
                 ==> Requires1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#1, $Box(t#3)));
            assert {:id "id96"} {:subsumption 0} (forall t#4: DatatypeType :: 
              { $Unbox(Apply1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#1, $Box(t#4))): int } 
                { Seq#Contains(##ts#1, $Box(t#4)) } 
              $Is(t#4, Tclass.AST.Expr__Raw()) && Seq#Contains(##ts#1, $Box(t#4))
                 ==> ##default#1
                   <= $Unbox(Apply1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#1, $Box(t#4))): int);
            ...
            b$reqreads#1 := (forall $o: ref, $f: Field :: 
              $o != null
                   && $Unbox(read($Heap, $o, alloc)): bool
                   && (exists t#5: DatatypeType, o#1: ref :: 
                    { Set#IsMember(Reads1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#1, $Box(t#5)), $Box(o#1)) } 
                    $Is(t#5, Tclass.AST.Expr__Raw())
                       && $Is(o#1, Tclass._System.object?())
                       && 
                      Seq#Contains(##ts#1, $Box(t#5))
                       && Set#IsMember(Reads1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#1, $Box(t#5)), $Box(o#1))
                       && $Box($o) == $Box(o#1))
                 ==> $_ReadsFrame[$o, $f]);
            assume Utils.__default.MaxF#canCall(Tclass.AST.Expr__Raw(), 
              $Heap, 
              (var f#13 := Lit(AtLayer((lambda $l#35#ly#0: LayerType :: 
                        Handle1((lambda $l#35#heap#0: Heap, $l#35#e#0: Box :: 
                            $Box(AST.Expr__Raw.Depth($l#35#ly#0, $Unbox($l#35#e#0): DatatypeType))), 
                          (lambda $l#35#heap#0: Heap, $l#35#e#0: Box :: 
                            $IsBox($l#35#e#0, Tclass.AST.Expr__Raw()) && Seq#Contains(avals#Z#0, $l#35#e#0)), 
                          (lambda $l#35#heap#0: Heap, $l#35#e#0: Box :: 
        ...
        else if (this == #AST.Expr_Raw.If(_mcc#7#0, _mcc#8#0, _mcc#9#0))
        {
            assume $Is(_mcc#7#0, Tclass.AST.Expr__Raw());
            assume $Is(_mcc#8#0, Tclass.AST.Expr__Raw());
            assume $Is(_mcc#9#0, Tclass.AST.Expr__Raw());
            havoc els#Z#0;
            assume {:id "id78"} let#5#0#0 == _mcc#9#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#5#0#0, Tclass.AST.Expr__Raw());
            assume {:id "id79"} els#Z#0 == let#5#0#0;
            havoc thn#Z#0;
            assume {:id "id80"} let#6#0#0 == _mcc#8#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#6#0#0, Tclass.AST.Expr__Raw());
            assume {:id "id81"} thn#Z#0 == let#6#0#0;
            havoc cond#Z#0;
            assume {:id "id82"} let#7#0#0 == _mcc#7#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#7#0#0, Tclass.AST.Expr__Raw());
            assume {:id "id83"} cond#Z#0 == let#7#0#0;
            // assume allocatedness for receiver argument to function
            assume $IsAllocBox($Box(cond#Z#0), Tclass.AST.Expr__Raw(), $Heap);
            assert {:id "id84"} DtRank(cond#Z#0) < DtRank(this);
            assume AST.Expr__Raw.Depth#canCall(cond#Z#0);
            ##x#1 := AST.Expr__Raw.Depth($LS($LZ), cond#Z#0);
            // assume allocatedness for argument to function
            assume $IsAlloc(##x#1, TInt, $Heap);
            // assume allocatedness for receiver argument to function
            assume $IsAllocBox($Box(thn#Z#0), Tclass.AST.Expr__Raw(), $Heap);
            assert {:id "id85"} DtRank(thn#Z#0) < DtRank(this);
            assume AST.Expr__Raw.Depth#canCall(thn#Z#0);
            ##x#2 := AST.Expr__Raw.Depth($LS($LZ), thn#Z#0);
            // assume allocatedness for argument to function
            assume $IsAlloc(##x#2, TInt, $Heap);
            // assume allocatedness for receiver argument to function
            assume $IsAllocBox($Box(els#Z#0), Tclass.AST.Expr__Raw(), $Heap);
            assert {:id "id86"} DtRank(els#Z#0) < DtRank(this);
            assume AST.Expr__Raw.Depth#canCall(els#Z#0);
            ##y#2 := AST.Expr__Raw.Depth($LS($LZ), els#Z#0);
            // assume allocatedness for argument to function
            assume $IsAlloc(##y#2, TInt, $Heap);
            assume Utils.__default.Max#canCall(AST.Expr__Raw.Depth($LS($LZ), thn#Z#0), AST.Expr__Raw.Depth($LS($LZ), els#Z#0));
            ##y#1 := Utils.__default.Max(AST.Expr__Raw.Depth($LS($LZ), thn#Z#0), AST.Expr__Raw.Depth($LS($LZ), els#Z#0));
            // assume allocatedness for argument to function
            assume $IsAlloc(##y#1, TInt, $Heap);
            assume Utils.__default.Max#canCall(AST.Expr__Raw.Depth($LS($LZ), cond#Z#0), 
              Utils.__default.Max(AST.Expr__Raw.Depth($LS($LZ), thn#Z#0), AST.Expr__Raw.Depth($LS($LZ), els#Z#0)));
        }
        else if (this == #AST.Expr_Raw.Op(_mcc#10#0, _mcc#11#0, _mcc#12#0))
        {
            assume $Is(_mcc#10#0, Tclass.AST.BinOp());
            assume $Is(_mcc#11#0, Tclass.AST.Expr__Raw());
            assume $Is(_mcc#12#0, Tclass.AST.Expr__Raw());
            havoc e2#Z#0;
            assume {:id "id70"} let#2#0#0 == _mcc#12#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#2#0#0, Tclass.AST.Expr__Raw());
            assume {:id "id71"} e2#Z#0 == let#2#0#0;
            havoc e1#Z#0;
            assume {:id "id72"} let#3#0#0 == _mcc#11#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#3#0#0, Tclass.AST.Expr__Raw());
            assume {:id "id73"} e1#Z#0 == let#3#0#0;
            havoc op#Z#0;
            assume {:id "id74"} let#4#0#0 == _mcc#10#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#4#0#0, Tclass.AST.BinOp());
            assume {:id "id75"} op#Z#0 == let#4#0#0;
            // assume allocatedness for receiver argument to function
            assume $IsAllocBox($Box(e1#Z#0), Tclass.AST.Expr__Raw(), $Heap);
            assert {:id "id76"} DtRank(e1#Z#0) < DtRank(this);
            assume AST.Expr__Raw.Depth#canCall(e1#Z#0);
            ##x#0 := AST.Expr__Raw.Depth($LS($LZ), e1#Z#0);
            // assume allocatedness for argument to function
            assume $IsAlloc(##x#0, TInt, $Heap);
            // assume allocatedness for receiver argument to function
            assume $IsAllocBox($Box(e2#Z#0), Tclass.AST.Expr__Raw(), $Heap);
            assert {:id "id77"} DtRank(e2#Z#0) < DtRank(this);
            assume AST.Expr__Raw.Depth#canCall(e2#Z#0);
            ##y#0 := AST.Expr__Raw.Depth($LS($LZ), e2#Z#0);
            // assume allocatedness for argument to function
            assume $IsAlloc(##y#0, TInt, $Heap);
            assume Utils.__default.Max#canCall(AST.Expr__Raw.Depth($LS($LZ), e1#Z#0), AST.Expr__Raw.Depth($LS($LZ), e2#Z#0));
        }
        else if (this == #AST.Expr_Raw.Seq(_mcc#13#0))
        {
            assume $Is(_mcc#13#0, TSeq(Tclass.AST.Expr__Raw()));
            havoc es#Z#0;
            assume {:id "id62"} let#0#0#0 == _mcc#13#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#0#0#0, TSeq(Tclass.AST.Expr__Raw()));
            assume {:id "id63"} es#Z#0 == let#0#0#0;
            havoc f#Z#0;
            // Begin Comprehension WF check
            if (*)
            {
                ...
                havoc e#0;
                if ($Is(e#0, Tclass.AST.Expr__Raw())
                   && $IsAlloc(e#0, Tclass.AST.Expr__Raw(), $lambdaHeap#0))
                {
                    $_Frame#l0 := (lambda $o: ref, $f: Field :: 
                      $o != null && $Unbox(read($lambdaHeap#0, $o, alloc)): bool ==> false);
                    if (Seq#Contains(es#Z#0, $Box(e#0)))
                    {
                        // assume allocatedness for receiver argument to function
                        assume $IsAllocBox($Box(e#0), Tclass.AST.Expr__Raw(), $lambdaHeap#0);
                        assert {:id "id64"} DtRank(e#0) < DtRank(this);
                        assume AST.Expr__Raw.Depth#canCall(e#0);
                        assume {:id "id65"} lambdaResult#0 == AST.Expr__Raw.Depth($LS($LZ), e#0);
                        assume AST.Expr__Raw.Depth#canCall(e#0);
                        // CheckWellformedWithResult: any expression
            ...
            // End Comprehension WF check
            assume {:id "id66"} let#1#0#0
               == Lit(AtLayer((lambda $l#27#ly#0: LayerType :: 
                    Handle1((lambda $l#27#heap#0: Heap, $l#27#e#0: Box :: 
                        $Box(AST.Expr__Raw.Depth($l#27#ly#0, $Unbox($l#27#e#0): DatatypeType))), 
                      (lambda $l#27#heap#0: Heap, $l#27#e#0: Box :: 
                        $IsBox($l#27#e#0, Tclass.AST.Expr__Raw()) && Seq#Contains(es#Z#0, $l#27#e#0)), 
                      (lambda $l#27#heap#0: Heap, $l#27#e#0: Box :: 
                        SetRef_to_SetBox((lambda $l#27#o#0: ref :: false))))), 
                  $LS($LZ)));
            assume (forall $l#28#e#0: DatatypeType :: 
              $Is($l#28#e#0, Tclass.AST.Expr__Raw())
                 ==> 
                Seq#Contains(es#Z#0, $Box($l#28#e#0))
                 ==> AST.Expr__Raw.Depth#canCall($l#28#e#0));
            // CheckWellformedWithResult: any expression
            assume $Is(let#1#0#0, 
              Tclass._System.___hPartialFunc1(Tclass.AST.Expr__Raw(), Tclass._System.nat()));
            assume {:id "id67"} f#Z#0 == let#1#0#0;
            ##f#0 := (var f#12 := Lit(AtLayer((lambda $l#29#ly#0: LayerType :: 
                      Handle1((lambda $l#29#heap#0: Heap, $l#29#e#0: Box :: 
                          $Box(AST.Expr__Raw.Depth($l#29#ly#0, $Unbox($l#29#e#0): DatatypeType))), 
                        (lambda $l#29#heap#0: Heap, $l#29#e#0: Box :: 
                          $IsBox($l#29#e#0, Tclass.AST.Expr__Raw()) && Seq#Contains(es#Z#0, $l#29#e#0)), 
                        (lambda $l#29#heap#0: Heap, $l#29#e#0: Box :: 
                          SetRef_to_SetBox((lambda $l#29#o#0: ref :: false))))), 
                    $LS($LZ))); 
              f#12);
            // assume allocatedness for argument to function
            assume $IsAlloc(##f#0, Tclass._System.___hFunc1(Tclass.AST.Expr__Raw(), TInt), $Heap);
            ##ts#0 := es#Z#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##ts#0, TSeq(Tclass.AST.Expr__Raw()), $Heap);
            ##default#0 := LitInt(0);
            // assume allocatedness for argument to function
            assume $IsAlloc(##default#0, TInt, $Heap);
            assert {:id "id68"} {:subsumption 0} (forall t#0: DatatypeType :: 
              { Requires1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#0, $Box(t#0)) } 
                { Seq#Contains(##ts#0, $Box(t#0)) } 
              $Is(t#0, Tclass.AST.Expr__Raw()) && Seq#Contains(##ts#0, $Box(t#0))
                 ==> Requires1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#0, $Box(t#0)));
            assume (forall t#0: DatatypeType :: 
              ...
              $Is(t#0, Tclass.AST.Expr__Raw()) && Seq#Contains(##ts#0, $Box(t#0))
                 ==> Requires1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#0, $Box(t#0)));
            assert {:id "id69"} {:subsumption 0} (forall t#1: DatatypeType :: 
              { $Unbox(Apply1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#0, $Box(t#1))): int } 
                { Seq#Contains(##ts#0, $Box(t#1)) } 
              $Is(t#1, Tclass.AST.Expr__Raw()) && Seq#Contains(##ts#0, $Box(t#1))
                 ==> ##default#0
                   <= $Unbox(Apply1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#0, $Box(t#1))): int);
            ...
            b$reqreads#0 := (forall $o: ref, $f: Field :: 
              $o != null
                   && $Unbox(read($Heap, $o, alloc)): bool
                   && (exists t#2: DatatypeType, o#0: ref :: 
                    { Set#IsMember(Reads1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#0, $Box(t#2)), $Box(o#0)) } 
                    $Is(t#2, Tclass.AST.Expr__Raw())
                       && $Is(o#0, Tclass._System.object?())
                       && 
                      Seq#Contains(##ts#0, $Box(t#2))
                       && Set#IsMember(Reads1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#0, $Box(t#2)), $Box(o#0))
                       && $Box($o) == $Box(o#0))
                 ==> $_ReadsFrame[$o, $f]);
            assume Utils.__default.MaxF#canCall(Tclass.AST.Expr__Raw(), 
              $Heap, 
              (var f#12 := Lit(AtLayer((lambda $l#30#ly#0: LayerType :: 
                        Handle1((lambda $l#30#heap#0: Heap, $l#30#e#0: Box :: 
                            $Box(AST.Expr__Raw.Depth($l#30#ly#0, $Unbox($l#30#e#0): DatatypeType))), 
                          (lambda $l#30#heap#0: Heap, $l#30#e#0: Box :: 
                            $IsBox($l#30#e#0, Tclass.AST.Expr__Raw()) && Seq#Contains(es#Z#0, $l#30#e#0)), 
                          (lambda $l#30#heap#0: Heap, $l#30#e#0: Box :: 
        ...
        assert {:id "id114"} $Is(1
             + (if AST.Expr__Raw.Var_q(this)
               then 0
               else (if AST.Expr__Raw.Literal_q(this)
                 then (var lit#4 := AST.Expr__Raw.n(this); LitInt(0))
                 else (if AST.Expr__Raw.Bind_q(this)
                   then (var body#4 := AST.Expr__Raw.body(this); 
                    (var bvals#4 := AST.Expr__Raw.bvals(this); 
                      (var bvars#4 := AST.Expr__Raw.bvars(this); 
                        (var m#4 := Utils.__default.MaxF(Tclass.AST.Expr__Raw(), 
                              $LS($LZ), 
                              reveal_Utils._default.MaxF, 
                              $Heap, 
                              (var f#15 := Lit(AtLayer((lambda $l#46#ly#0: LayerType :: 
                                        Handle1((lambda $l#46#heap#0: Heap, $l#46#e#0: Box :: 
                                            $Box(AST.Expr__Raw.Depth($l#46#ly#0, $Unbox($l#46#e#0): DatatypeType))), 
                                          (lambda $l#46#heap#0: Heap, $l#46#e#0: Box :: 
                                            $IsBox($l#46#e#0, Tclass.AST.Expr__Raw()) && Seq#Contains(bvals#4, $l#46#e#0)), 
                                          (lambda $l#46#heap#0: Heap, $l#46#e#0: Box :: 
                              ...
                              bvals#4, 
                              LitInt(0)); 
                          Utils.__default.Max(m#4, AST.Expr__Raw.Depth($LS($LZ), body#4))))))
                   else (if AST.Expr__Raw.Assign_q(this)
                     then (var avals#4 := AST.Expr__Raw.avals(this); 
                      (var avars#4 := AST.Expr__Raw.avars(this); 
                        Utils.__default.MaxF(Tclass.AST.Expr__Raw(), 
                          $LS($LZ), 
                          reveal_Utils._default.MaxF, 
                          $Heap, 
                          (var f#16 := Lit(AtLayer((lambda $l#47#ly#0: LayerType :: 
                                    Handle1((lambda $l#47#heap#0: Heap, $l#47#e#0: Box :: 
                                        $Box(AST.Expr__Raw.Depth($l#47#ly#0, $Unbox($l#47#e#0): DatatypeType))), 
                                      (lambda $l#47#heap#0: Heap, $l#47#e#0: Box :: 
                                        $IsBox($l#47#e#0, Tclass.AST.Expr__Raw()) && Seq#Contains(avals#4, $l#47#e#0)), 
                                      (lambda $l#47#heap#0: Heap, $l#47#e#0: Box :: 
                       ...
                       then (var els#4 := AST.Expr__Raw.els(this); 
                        (var thn#4 := AST.Expr__Raw.thn(this); 
                          (var cond#4 := AST.Expr__Raw.cond(this); 
                            Utils.__default.Max(AST.Expr__Raw.Depth($LS($LZ), cond#4), 
                              Utils.__default.Max(AST.Expr__Raw.Depth($LS($LZ), thn#4), AST.Expr__Raw.Depth($LS($LZ), els#4))))))
                       else (if AST.Expr__Raw.Op_q(this)
                         then (var e2#4 := AST.Expr__Raw.oe2(this); 
                          (var e1#4 := AST.Expr__Raw.oe1(this); 
                            (var op#4 := AST.Expr__Raw.op(this); 
                              Utils.__default.Max(AST.Expr__Raw.Depth($LS($LZ), e1#4), AST.Expr__Raw.Depth($LS($LZ), e2#4)))))
                         else (var es#4 := AST.Expr__Raw.es(this); 
                          Utils.__default.MaxF(Tclass.AST.Expr__Raw(), 
                            $LS($LZ), 
                            reveal_Utils._default.MaxF, 
                            $Heap, 
                            (var f#17 := Lit(AtLayer((lambda $l#48#ly#0: LayerType :: 
                                      Handle1((lambda $l#48#heap#0: Heap, $l#48#e#0: Box :: 
                                          $Box(AST.Expr__Raw.Depth($l#48#ly#0, $Unbox($l#48#e#0): DatatypeType))), 
                                        (lambda $l#48#heap#0: Heap, $l#48#e#0: Box :: 
                                          $IsBox($l#48#e#0, Tclass.AST.Expr__Raw()) && Seq#Contains(es#4, $l#48#e#0)), 
                                        (lambda $l#48#heap#0: Heap, $l#48#e#0: Box :: 
                            ...
                            LitInt(0))))))))), 
          Tclass._System.nat());
        assume {:id "id115"} AST.Expr__Raw.Depth($LS($LZ), this)
           == 1
             + (if AST.Expr__Raw.Var_q(this)
               then 0
               else (if AST.Expr__Raw.Literal_q(this)
                 then (var lit#5 := AST.Expr__Raw.n(this); LitInt(0))
                 else (if AST.Expr__Raw.Bind_q(this)
                   then (var body#5 := AST.Expr__Raw.body(this); 
                    (var bvals#5 := AST.Expr__Raw.bvals(this); 
                      (var bvars#5 := AST.Expr__Raw.bvars(this); 
                        (var m#5 := Utils.__default.MaxF(Tclass.AST.Expr__Raw(), 
                              $LS($LZ), 
                              reveal_Utils._default.MaxF, 
                              $Heap, 
                              (var f#18 := Lit(AtLayer((lambda $l#49#ly#0: LayerType :: 
                                        Handle1((lambda $l#49#heap#0: Heap, $l#49#e#0: Box :: 
                                            $Box(AST.Expr__Raw.Depth($l#49#ly#0, $Unbox($l#49#e#0): DatatypeType))), 
                                          (lambda $l#49#heap#0: Heap, $l#49#e#0: Box :: 
                                            $IsBox($l#49#e#0, Tclass.AST.Expr__Raw()) && Seq#Contains(bvals#5, $l#49#e#0)), 
                                          (lambda $l#49#heap#0: Heap, $l#49#e#0: Box :: 
                              ...
                              bvals#5, 
                              LitInt(0)); 
                          Utils.__default.Max(m#5, AST.Expr__Raw.Depth($LS($LZ), body#5))))))
                   else (if AST.Expr__Raw.Assign_q(this)
                     then (var avals#5 := AST.Expr__Raw.avals(this); 
                      (var avars#5 := AST.Expr__Raw.avars(this); 
                        Utils.__default.MaxF(Tclass.AST.Expr__Raw(), 
                          $LS($LZ), 
                          reveal_Utils._default.MaxF, 
                          $Heap, 
                          (var f#19 := Lit(AtLayer((lambda $l#50#ly#0: LayerType :: 
                                    Handle1((lambda $l#50#heap#0: Heap, $l#50#e#0: Box :: 
                                        $Box(AST.Expr__Raw.Depth($l#50#ly#0, $Unbox($l#50#e#0): DatatypeType))), 
                                      (lambda $l#50#heap#0: Heap, $l#50#e#0: Box :: 
                                        $IsBox($l#50#e#0, Tclass.AST.Expr__Raw()) && Seq#Contains(avals#5, $l#50#e#0)), 
                                      (lambda $l#50#heap#0: Heap, $l#50#e#0: Box :: 
                                        SetRef_to_SetBox((lambda $l#50#o#0: ref :: false))))), 
                                  $LS($LZ))); 
                            f#19), 
                          avals#5, 
                          LitInt(0))))
                     else (if AST.Expr__Raw.If_q(this)
                       then (var els#5 := AST.Expr__Raw.els(this); 
                        (var thn#5 := AST.Expr__Raw.thn(this); 
                          (var cond#5 := AST.Expr__Raw.cond(this); 
                            Utils.__default.Max(AST.Expr__Raw.Depth($LS($LZ), cond#5), 
                              Utils.__default.Max(AST.Expr__Raw.Depth($LS($LZ), thn#5), AST.Expr__Raw.Depth($LS($LZ), els#5))))))
                       else (if AST.Expr__Raw.Op_q(this)
                         then (var e2#5 := AST.Expr__Raw.oe2(this); 
                          (var e1#5 := AST.Expr__Raw.oe1(this); 
                            (var op#5 := AST.Expr__Raw.op(this); 
                              Utils.__default.Max(AST.Expr__Raw.Depth($LS($LZ), e1#5), AST.Expr__Raw.Depth($LS($LZ), e2#5)))))
                         else (var es#5 := AST.Expr__Raw.es(this); 
                          Utils.__default.MaxF(Tclass.AST.Expr__Raw(), 
                            $LS($LZ), 
                            reveal_Utils._default.MaxF, 
                            $Heap, 
                            (var f#20 := Lit(AtLayer((lambda $l#51#ly#0: LayerType :: 
                                      Handle1((lambda $l#51#heap#0: Heap, $l#51#e#0: Box :: 
                                          $Box(AST.Expr__Raw.Depth($l#51#ly#0, $Unbox($l#51#e#0): DatatypeType))), 
                                        (lambda $l#51#heap#0: Heap, $l#51#e#0: Box :: 
                                          $IsBox($l#51#e#0, Tclass.AST.Expr__Raw()) && Seq#Contains(es#5, $l#51#e#0)), 
                                        (lambda $l#51#heap#0: Heap, $l#51#e#0: Box :: 
                            ...
                            es#5, 
                            LitInt(0)))))))));
        assume !AST.Expr__Raw.Var_q(this)
           ==> 
          !AST.Expr__Raw.Literal_q(this)
           ==> (AST.Expr__Raw.Bind_q(this)
               ==> (var body#6 := AST.Expr__Raw.body(this); 
                (var bvals#6 := AST.Expr__Raw.bvals(this); 
                  (forall $l#52#e#0: DatatypeType :: 
                      $Is($l#52#e#0, Tclass.AST.Expr__Raw())
                         ==> 
                        Seq#Contains(bvals#6, $Box($l#52#e#0))
                         ==> AST.Expr__Raw.Depth#canCall($l#52#e#0))
                     && Utils.__default.MaxF#canCall(Tclass.AST.Expr__Raw(), 
                      $Heap, 
                      (var f#21 := Lit(AtLayer((lambda $l#54#ly#0: LayerType :: 
                                Handle1((lambda $l#54#heap#0: Heap, $l#54#e#0: Box :: 
                                    $Box(AST.Expr__Raw.Depth($l#54#ly#0, $Unbox($l#54#e#0): DatatypeType))), 
                                  (lambda $l#54#heap#0: Heap, $l#54#e#0: Box :: 
                                    $IsBox($l#54#e#0, Tclass.AST.Expr__Raw()) && Seq#Contains(bvals#6, $l#54#e#0)), 
                                  (lambda $l#54#heap#0: Heap, $l#54#e#0: Box :: 
                      ...
                      bvals#6, 
                      LitInt(0))
                     && (var m#6 := Utils.__default.MaxF(Tclass.AST.Expr__Raw(), 
                          $LS($LZ), 
                          reveal_Utils._default.MaxF, 
                          $Heap, 
                          (var f#21 := Lit(AtLayer((lambda $l#55#ly#0: LayerType :: 
                                    Handle1((lambda $l#55#heap#0: Heap, $l#55#e#0: Box :: 
                                        $Box(AST.Expr__Raw.Depth($l#55#ly#0, $Unbox($l#55#e#0): DatatypeType))), 
                                      (lambda $l#55#heap#0: Heap, $l#55#e#0: Box :: 
                                        $IsBox($l#55#e#0, Tclass.AST.Expr__Raw()) && Seq#Contains(bvals#6, $l#55#e#0)), 
                                      (lambda $l#55#heap#0: Heap, $l#55#e#0: Box :: 
                          ...
                          bvals#6, 
                          LitInt(0)); 
                      AST.Expr__Raw.Depth#canCall(body#6)
                         && Utils.__default.Max#canCall(m#6, AST.Expr__Raw.Depth($LS($LZ), body#6))))))
             && (!AST.Expr__Raw.Bind_q(this)
               ==> (AST.Expr__Raw.Assign_q(this)
                   ==> (var avals#6 := AST.Expr__Raw.avals(this); 
                    (forall $l#56#e#0: DatatypeType :: 
                        $Is($l#56#e#0, Tclass.AST.Expr__Raw())
                           ==> 
                          Seq#Contains(avals#6, $Box($l#56#e#0))
                           ==> AST.Expr__Raw.Depth#canCall($l#56#e#0))
                       && Utils.__default.MaxF#canCall(Tclass.AST.Expr__Raw(), 
                        $Heap, 
                        (var f#22 := Lit(AtLayer((lambda $l#58#ly#0: LayerType :: 
                                  Handle1((lambda $l#58#heap#0: Heap, $l#58#e#0: Box :: 
                                      $Box(AST.Expr__Raw.Depth($l#58#ly#0, $Unbox($l#58#e#0): DatatypeType))), 
                                    (lambda $l#58#heap#0: Heap, $l#58#e#0: Box :: 
                                      $IsBox($l#58#e#0, Tclass.AST.Expr__Raw()) && Seq#Contains(avals#6, $l#58#e#0)), 
                                    (lambda $l#58#heap#0: Heap, $l#58#e#0: Box :: 
                                      SetRef_to_SetBox((lambda $l#58#o#0: ref :: false))))), 
                                $LS($LZ))); 
                          f#22), 
                        avals#6, 
                        LitInt(0))))
                 && (!AST.Expr__Raw.Assign_q(this)
                   ==> (AST.Expr__Raw.If_q(this)
                       ==> (var els#6 := AST.Expr__Raw.els(this); 
                        (var thn#6 := AST.Expr__Raw.thn(this); 
                          (var cond#6 := AST.Expr__Raw.cond(this); 
                            AST.Expr__Raw.Depth#canCall(cond#6)
                               && 
                              AST.Expr__Raw.Depth#canCall(thn#6)
                               && AST.Expr__Raw.Depth#canCall(els#6)
                               && Utils.__default.Max#canCall(AST.Expr__Raw.Depth($LS($LZ), thn#6), AST.Expr__Raw.Depth($LS($LZ), els#6))
                               && Utils.__default.Max#canCall(AST.Expr__Raw.Depth($LS($LZ), cond#6), 
                                Utils.__default.Max(AST.Expr__Raw.Depth($LS($LZ), thn#6), AST.Expr__Raw.Depth($LS($LZ), els#6)))))))
                     && (!AST.Expr__Raw.If_q(this)
                       ==> (AST.Expr__Raw.Op_q(this)
                           ==> (var e2#6 := AST.Expr__Raw.oe2(this); 
                            (var e1#6 := AST.Expr__Raw.oe1(this); 
                              AST.Expr__Raw.Depth#canCall(e1#6)
                                 && AST.Expr__Raw.Depth#canCall(e2#6)
                                 && Utils.__default.Max#canCall(AST.Expr__Raw.Depth($LS($LZ), e1#6), AST.Expr__Raw.Depth($LS($LZ), e2#6)))))
                         && (!AST.Expr__Raw.Op_q(this)
                           ==> (var es#6 := AST.Expr__Raw.es(this); 
                            (forall $l#59#e#0: DatatypeType :: 
                                $Is($l#59#e#0, Tclass.AST.Expr__Raw())
                                   ==> 
                                  Seq#Contains(es#6, $Box($l#59#e#0))
                                   ==> AST.Expr__Raw.Depth#canCall($l#59#e#0))
                               && Utils.__default.MaxF#canCall(Tclass.AST.Expr__Raw(), 
                                $Heap, 
                                (var f#23 := Lit(AtLayer((lambda $l#61#ly#0: LayerType :: 
                                          Handle1((lambda $l#61#heap#0: Heap, $l#61#e#0: Box :: 
                                              $Box(AST.Expr__Raw.Depth($l#61#ly#0, $Unbox($l#61#e#0): DatatypeType))), 
                                            (lambda $l#61#heap#0: Heap, $l#61#e#0: Box :: 
                                              $IsBox($l#61#e#0, Tclass.AST.Expr__Raw()) && Seq#Contains(es#6, $l#61#e#0)), 
                                            (lambda $l#61#heap#0: Heap, $l#61#e#0: Box :: 
                                ...
                                LitInt(0)))))));
        // CheckWellformedWithResult: any expression
        assume $Is(AST.Expr__Raw.Depth($LS($LZ), this), Tclass._System.nat());
        assert {:id "id116"} b$reqreads#0;
        assert {:id "id117"} b$reqreads#1;
        assert {:id "id118"} b$reqreads#2;
        return;
...
axiom {:id "id119"} 2 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, $Heap: Heap, e#0: DatatypeType, p#0: HandleType :: 
...
procedure {:verboseName "AST.Expr_Raw.All (well-formedness)"} CheckWellformed$$AST.Expr__Raw.All(e#0: DatatypeType where $Is(e#0, Tclass.AST.Expr__Raw()), 
    p#0: HandleType
       where $Is(p#0, Tclass._System.___hTotalFunc1(Tclass.AST.Expr__Raw(), TBool)));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "AST.Expr_Raw.All (well-formedness)"} CheckWellformed$$AST.Expr__Raw.All(e#0: DatatypeType, p#0: HandleType)
{
  var $_ReadsFrame: [ref,Field]bool;
  var _mcc#13#0: Seq;
  var es#Z#0: Seq;
  ...
  var let#13#0#0: Seq;
    ...
    {
        // Check well-formedness of body and result subset type constraint
        if ($Unbox(Apply1(Tclass.AST.Expr__Raw(), TBool, $Heap, p#0, $Box(e#0))): bool)
        {
            if (e#0 == #AST.Expr_Raw.Var(_mcc#0#0))
            {
                assume $Is(_mcc#0#0, TSeq(TChar));
                havoc name#Z#0;
                assume {:id "id157"} let#13#0#0 == _mcc#0#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#13#0#0, TSeq(TChar));
                assume {:id "id158"} name#Z#0 == let#13#0#0;
            }
            else if (e#0 == #AST.Expr_Raw.Literal(_mcc#1#0))
            {
                havoc n#Z#0;
                assume {:id "id155"} let#12#0#0 == _mcc#1#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#12#0#0, TInt);
                assume {:id "id156"} n#Z#0 == let#12#0#0;
            }
            else if (e#0 == #AST.Expr_Raw.Bind(_mcc#2#0, _mcc#3#0, _mcc#4#0))
            {
                ...
                assume $Is(_mcc#4#0, Tclass.AST.Expr__Raw());
                havoc body#Z#0;
                assume {:id "id147"} let#9#0#0 == _mcc#4#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#9#0#0, Tclass.AST.Expr__Raw());
                assume {:id "id148"} body#Z#0 == let#9#0#0;
                havoc bvals#Z#0;
                assume {:id "id149"} let#10#0#0 == _mcc#3#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#10#0#0, TSeq(Tclass.AST.Expr__Raw()));
                assume {:id "id150"} bvals#Z#0 == let#10#0#0;
                havoc bvars#Z#0;
                assume {:id "id151"} let#11#0#0 == _mcc#2#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#11#0#0, TSeq(TSeq(TChar)));
                assume {:id "id152"} bvars#Z#0 == let#11#0#0;
                // Begin Comprehension WF check
                havoc e#21;
                if ($Is(e#21, Tclass.AST.Expr__Raw())
                   && $IsAlloc(e#21, Tclass.AST.Expr__Raw(), $Heap))
                {
                    if (Seq#Contains(bvals#Z#0, $Box(e#21)))
                    {
                        ##e#7 := e#21;
                        // assume allocatedness for argument to function
                        assume $IsAlloc(##e#7, Tclass.AST.Expr__Raw(), $Heap);
                        ##p#7 := p#0;
                        // assume allocatedness for argument to function
                        assume $IsAlloc(##p#7, Tclass._System.___hTotalFunc1(Tclass.AST.Expr__Raw(), TBool), $Heap);
                        assert {:id "id153"} DtRank(##e#7) < DtRank(e#0);
                        assume AST.Expr__Raw.All#canCall(e#21, p#0);
                    }
                }

                // End Comprehension WF check
                if ((forall e#22: DatatypeType :: 
                  { AST.Expr__Raw.All($LS($LZ), e#22, p#0) } 
                    { Seq#Contains(bvals#Z#0, $Box(e#22)) } 
                  $Is(e#22, Tclass.AST.Expr__Raw()) && Seq#Contains(bvals#Z#0, $Box(e#22))
                     ==> AST.Expr__Raw.All($LS($LZ), e#22, p#0)))
                {
                    ##e#8 := body#Z#0;
                    // assume allocatedness for argument to function
                    assume $IsAlloc(##e#8, Tclass.AST.Expr__Raw(), $Heap);
                    ##p#8 := p#0;
                    // assume allocatedness for argument to function
                    assume $IsAlloc(##p#8, Tclass._System.___hTotalFunc1(Tclass.AST.Expr__Raw(), TBool), $Heap);
                    assert {:id "id154"} DtRank(##e#8) < DtRank(e#0);
                    assume AST.Expr__Raw.All#canCall(body#Z#0, p#0);
                }
            }
            else if (e#0 == #AST.Expr_Raw.Assign(_mcc#5#0, _mcc#6#0))
            {
                ...
                assume $Is(_mcc#6#0, TSeq(Tclass.AST.Expr__Raw()));
                havoc avals#Z#0;
                assume {:id "id142"} let#7#0#0 == _mcc#6#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#7#0#0, TSeq(Tclass.AST.Expr__Raw()));
                assume {:id "id143"} avals#Z#0 == let#7#0#0;
                havoc avars#Z#0;
                assume {:id "id144"} let#8#0#0 == _mcc#5#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#8#0#0, TSeq(TSeq(TChar)));
                assume {:id "id145"} avars#Z#0 == let#8#0#0;
                if (Lit(true))
                {
                    // Begin Comprehension WF check
                    havoc e#20;
                    if ($Is(e#20, Tclass.AST.Expr__Raw())
                       && $IsAlloc(e#20, Tclass.AST.Expr__Raw(), $Heap))
                    {
                        if (Seq#Contains(avals#Z#0, $Box(e#20)))
                        {
                            ##e#6 := e#20;
                            // assume allocatedness for argument to function
                            assume $IsAlloc(##e#6, Tclass.AST.Expr__Raw(), $Heap);
                            ##p#6 := p#0;
                            // assume allocatedness for argument to function
                            assume $IsAlloc(##p#6, Tclass._System.___hTotalFunc1(Tclass.AST.Expr__Raw(), TBool), $Heap);
                            assert {:id "id146"} DtRank(##e#6) < DtRank(e#0);
                            assume AST.Expr__Raw.All#canCall(e#20, p#0);
                        }
                    }
            ...
            else if (e#0 == #AST.Expr_Raw.If(_mcc#7#0, _mcc#8#0, _mcc#9#0))
            {
                ...
                assume $Is(_mcc#9#0, Tclass.AST.Expr__Raw());
                havoc els#Z#0;
                assume {:id "id133"} let#4#0#0 == _mcc#9#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#4#0#0, Tclass.AST.Expr__Raw());
                assume {:id "id134"} els#Z#0 == let#4#0#0;
                havoc thn#Z#0;
                assume {:id "id135"} let#5#0#0 == _mcc#8#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#5#0#0, Tclass.AST.Expr__Raw());
                assume {:id "id136"} thn#Z#0 == let#5#0#0;
                havoc cond#Z#0;
                assume {:id "id137"} let#6#0#0 == _mcc#7#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#6#0#0, Tclass.AST.Expr__Raw());
                assume {:id "id138"} cond#Z#0 == let#6#0#0;
                ##e#3 := cond#Z#0;
                // assume allocatedness for argument to function
                assume $IsAlloc(##e#3, Tclass.AST.Expr__Raw(), $Heap);
                ##p#3 := p#0;
                // assume allocatedness for argument to function
                assume $IsAlloc(##p#3, Tclass._System.___hTotalFunc1(Tclass.AST.Expr__Raw(), TBool), $Heap);
                assert {:id "id139"} DtRank(##e#3) < DtRank(e#0);
                assume AST.Expr__Raw.All#canCall(cond#Z#0, p#0);
                if (AST.Expr__Raw.All($LS($LZ), cond#Z#0, p#0))
                {
                    ##e#4 := thn#Z#0;
                    // assume allocatedness for argument to function
                    assume $IsAlloc(##e#4, Tclass.AST.Expr__Raw(), $Heap);
                    ##p#4 := p#0;
                    // assume allocatedness for argument to function
                    assume $IsAlloc(##p#4, Tclass._System.___hTotalFunc1(Tclass.AST.Expr__Raw(), TBool), $Heap);
                    assert {:id "id140"} DtRank(##e#4) < DtRank(e#0);
                    assume AST.Expr__Raw.All#canCall(thn#Z#0, p#0);
                }

                if (AST.Expr__Raw.All($LS($LZ), cond#Z#0, p#0)
                   && AST.Expr__Raw.All($LS($LZ), thn#Z#0, p#0))
                {
                    ##e#5 := els#Z#0;
                    // assume allocatedness for argument to function
                    assume $IsAlloc(##e#5, Tclass.AST.Expr__Raw(), $Heap);
                    ##p#5 := p#0;
                    // assume allocatedness for argument to function
                    assume $IsAlloc(##p#5, Tclass._System.___hTotalFunc1(Tclass.AST.Expr__Raw(), TBool), $Heap);
                    assert {:id "id141"} DtRank(##e#5) < DtRank(e#0);
                    assume AST.Expr__Raw.All#canCall(els#Z#0, p#0);
                }
            }
            else if (e#0 == #AST.Expr_Raw.Op(_mcc#10#0, _mcc#11#0, _mcc#12#0))
            {
                ...
                assume $Is(_mcc#12#0, Tclass.AST.Expr__Raw());
                havoc oe2#Z#0;
                assume {:id "id125"} let#1#0#0 == _mcc#12#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#1#0#0, Tclass.AST.Expr__Raw());
                assume {:id "id126"} oe2#Z#0 == let#1#0#0;
                havoc oe1#Z#0;
                assume {:id "id127"} let#2#0#0 == _mcc#11#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#2#0#0, Tclass.AST.Expr__Raw());
                assume {:id "id128"} oe1#Z#0 == let#2#0#0;
                havoc op#Z#0;
                assume {:id "id129"} let#3#0#0 == _mcc#10#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#3#0#0, Tclass.AST.BinOp());
                assume {:id "id130"} op#Z#0 == let#3#0#0;
                ##e#1 := oe1#Z#0;
                // assume allocatedness for argument to function
                assume $IsAlloc(##e#1, Tclass.AST.Expr__Raw(), $Heap);
                ##p#1 := p#0;
                // assume allocatedness for argument to function
                assume $IsAlloc(##p#1, Tclass._System.___hTotalFunc1(Tclass.AST.Expr__Raw(), TBool), $Heap);
                assert {:id "id131"} DtRank(##e#1) < DtRank(e#0);
                assume AST.Expr__Raw.All#canCall(oe1#Z#0, p#0);
                if (AST.Expr__Raw.All($LS($LZ), oe1#Z#0, p#0))
                {
                    ##e#2 := oe2#Z#0;
                    // assume allocatedness for argument to function
                    assume $IsAlloc(##e#2, Tclass.AST.Expr__Raw(), $Heap);
                    ##p#2 := p#0;
                    // assume allocatedness for argument to function
                    assume $IsAlloc(##p#2, Tclass._System.___hTotalFunc1(Tclass.AST.Expr__Raw(), TBool), $Heap);
                    assert {:id "id132"} DtRank(##e#2) < DtRank(e#0);
                    assume AST.Expr__Raw.All#canCall(oe2#Z#0, p#0);
                }
            }
            else if (e#0 == #AST.Expr_Raw.Seq(_mcc#13#0))
            {
                assume $Is(_mcc#13#0, TSeq(Tclass.AST.Expr__Raw()));
                havoc es#Z#0;
                assume {:id "id122"} let#0#0#0 == _mcc#13#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#0#0#0, TSeq(Tclass.AST.Expr__Raw()));
                assume {:id "id123"} es#Z#0 == let#0#0#0;
                if (Lit(true))
                {
                    // Begin Comprehension WF check
                    havoc e#19;
                       ...
                       && $IsAlloc(e#19, Tclass.AST.Expr__Raw(), $Heap))
                    {
                        if (Seq#Contains(es#Z#0, $Box(e#19)))
                        {
                            ##e#0 := e#19;
                            // assume allocatedness for argument to function
                            assume $IsAlloc(##e#0, Tclass.AST.Expr__Raw(), $Heap);
                            ##p#0 := p#0;
                            // assume allocatedness for argument to function
                            assume $IsAlloc(##p#0, Tclass._System.___hTotalFunc1(Tclass.AST.Expr__Raw(), TBool), $Heap);
                            assert {:id "id124"} DtRank(##e#0) < DtRank(e#0);
                            assume AST.Expr__Raw.All#canCall(e#19, p#0);
                        }
                    }
        ...
        assume {:id "id159"} AST.Expr__Raw.All($LS($LZ), e#0, p#0)
           == ($Unbox(Apply1(Tclass.AST.Expr__Raw(), TBool, $Heap, p#0, $Box(e#0))): bool
             && (if AST.Expr__Raw.Var_q(e#0)
               then (var name#7 := AST.Expr__Raw.name(e#0); Lit(true))
               else (if AST.Expr__Raw.Literal_q(e#0)
                 then (var n#7 := AST.Expr__Raw.n(e#0); Lit(true))
                 else (if AST.Expr__Raw.Bind_q(e#0)
                   then (var body#7 := AST.Expr__Raw.body(e#0); 
                    (var bvals#7 := AST.Expr__Raw.bvals(e#0); 
                      (var bvars#7 := AST.Expr__Raw.bvars(e#0); 
                        (forall e#26: DatatypeType :: 
                            { AST.Expr__Raw.All($LS($LZ), e#26, p#0) } 
                              { Seq#Contains(bvals#7, $Box(e#26)) } 
                            $Is(e#26, Tclass.AST.Expr__Raw()) && Seq#Contains(bvals#7, $Box(e#26))
                               ==> AST.Expr__Raw.All($LS($LZ), e#26, p#0))
                           && AST.Expr__Raw.All($LS($LZ), body#7, p#0))))
                   else (if AST.Expr__Raw.Assign_q(e#0)
                     then (var avals#7 := AST.Expr__Raw.avals(e#0); 
                      (var avars#7 := AST.Expr__Raw.avars(e#0); 
                        true
                           && (forall e#27: DatatypeType :: 
                            { AST.Expr__Raw.All($LS($LZ), e#27, p#0) } 
                              { Seq#Contains(avals#7, $Box(e#27)) } 
                            $Is(e#27, Tclass.AST.Expr__Raw()) && Seq#Contains(avals#7, $Box(e#27))
                               ==> AST.Expr__Raw.All($LS($LZ), e#27, p#0))))
                     else (if AST.Expr__Raw.If_q(e#0)
                       then (var els#7 := AST.Expr__Raw.els(e#0); 
                        (var thn#7 := AST.Expr__Raw.thn(e#0); 
                          (var cond#7 := AST.Expr__Raw.cond(e#0); 
                            AST.Expr__Raw.All($LS($LZ), cond#7, p#0)
                               && AST.Expr__Raw.All($LS($LZ), thn#7, p#0)
                               && AST.Expr__Raw.All($LS($LZ), els#7, p#0))))
                       else (if AST.Expr__Raw.Op_q(e#0)
                         then (var oe2#7 := AST.Expr__Raw.oe2(e#0); 
                          (var oe1#7 := AST.Expr__Raw.oe1(e#0); 
                            (var op#7 := AST.Expr__Raw.op(e#0); 
                              AST.Expr__Raw.All($LS($LZ), oe1#7, p#0)
                                 && AST.Expr__Raw.All($LS($LZ), oe2#7, p#0))))
                         else (var es#7 := AST.Expr__Raw.es(e#0); 
                          true
                             && (forall e#28: DatatypeType :: 
                              { AST.Expr__Raw.All($LS($LZ), e#28, p#0) } { Seq#Contains(es#7, $Box(e#28)) } 
                              $Is(e#28, Tclass.AST.Expr__Raw()) && Seq#Contains(es#7, $Box(e#28))
                                 ==> AST.Expr__Raw.All($LS($LZ), e#28, p#0))))))))));
        assume $Unbox(Apply1(Tclass.AST.Expr__Raw(), TBool, $Heap, p#0, $Box(e#0))): bool
           ==> 
          !AST.Expr__Raw.Var_q(e#0)
           ==> 
          !AST.Expr__Raw.Literal_q(e#0)
           ==> (AST.Expr__Raw.Bind_q(e#0)
               ==> (var body#8 := AST.Expr__Raw.body(e#0); 
                (var bvals#8 := AST.Expr__Raw.bvals(e#0); 
                  (forall e#29: DatatypeType :: 
                      { AST.Expr__Raw.All($LS($LZ), e#29, p#0) } 
                        { Seq#Contains(bvals#8, $Box(e#29)) } 
                      $Is(e#29, Tclass.AST.Expr__Raw())
                         ==> 
                        Seq#Contains(bvals#8, $Box(e#29))
                         ==> AST.Expr__Raw.All#canCall(e#29, p#0))
                     && ((forall e#29: DatatypeType :: 
                        { AST.Expr__Raw.All($LS($LZ), e#29, p#0) } 
                          { Seq#Contains(bvals#8, $Box(e#29)) } 
                        $Is(e#29, Tclass.AST.Expr__Raw()) && Seq#Contains(bvals#8, $Box(e#29))
                           ==> AST.Expr__Raw.All($LS($LZ), e#29, p#0))
                       ==> AST.Expr__Raw.All#canCall(body#8, p#0)))))
             && (!AST.Expr__Raw.Bind_q(e#0)
               ==> (AST.Expr__Raw.Assign_q(e#0)
                   ==> (var avals#8 := AST.Expr__Raw.avals(e#0); 
                    Lit(true)
                       ==> (forall e#30: DatatypeType :: 
                        { AST.Expr__Raw.All($LS($LZ), e#30, p#0) } 
                          { Seq#Contains(avals#8, $Box(e#30)) } 
                        $Is(e#30, Tclass.AST.Expr__Raw())
                           ==> 
                          Seq#Contains(avals#8, $Box(e#30))
                           ==> AST.Expr__Raw.All#canCall(e#30, p#0))))
                 && (!AST.Expr__Raw.Assign_q(e#0)
                   ==> (AST.Expr__Raw.If_q(e#0)
                       ==> (var els#8 := AST.Expr__Raw.els(e#0); 
                        (var thn#8 := AST.Expr__Raw.thn(e#0); 
                          (var cond#8 := AST.Expr__Raw.cond(e#0); 
                            AST.Expr__Raw.All#canCall(cond#8, p#0)
                               && (AST.Expr__Raw.All($LS($LZ), cond#8, p#0)
                                 ==> AST.Expr__Raw.All#canCall(thn#8, p#0)
                                   && (AST.Expr__Raw.All($LS($LZ), thn#8, p#0)
                                     ==> AST.Expr__Raw.All#canCall(els#8, p#0)))))))
                     && (!AST.Expr__Raw.If_q(e#0)
                       ==> (AST.Expr__Raw.Op_q(e#0)
                           ==> (var oe2#8 := AST.Expr__Raw.oe2(e#0); 
                            (var oe1#8 := AST.Expr__Raw.oe1(e#0); 
                              AST.Expr__Raw.All#canCall(oe1#8, p#0)
                                 && (AST.Expr__Raw.All($LS($LZ), oe1#8, p#0)
                                   ==> AST.Expr__Raw.All#canCall(oe2#8, p#0)))))
                         && (!AST.Expr__Raw.Op_q(e#0)
                           ==> (var es#8 := AST.Expr__Raw.es(e#0); 
                            Lit(true)
                               ==> (forall e#31: DatatypeType :: 
                                { AST.Expr__Raw.All($LS($LZ), e#31, p#0) } { Seq#Contains(es#8, $Box(e#31)) } 
                                $Is(e#31, Tclass.AST.Expr__Raw())
                                   ==> 
                                  Seq#Contains(es#8, $Box(e#31))
                                   ==> AST.Expr__Raw.All#canCall(e#31, p#0)))))));
        // CheckWellformedWithResult: any expression
        assume $Is(AST.Expr__Raw.All($LS($LZ), e#0, p#0), TBool);
        return;
...
axiom {:id "id160"} 3 <= $FunctionContextHeight
   ==> (forall es#0: Seq, p#0: HandleType :: 
...
procedure {:verboseName "AST.Expr_Raw.All_Es (well-formedness)"} CheckWellformed$$AST.Expr__Raw.All__Es(es#0: Seq where $Is(es#0, TSeq(Tclass.AST.Expr__Raw())), 
    p#0: HandleType
       where $Is(p#0, Tclass._System.___hTotalFunc1(Tclass.AST.Expr__Raw(), TBool)));
...
axiom {:id "id164"} 2 <= $FunctionContextHeight
   ==> (forall e#0: DatatypeType :: 
    ...
    AST.Expr__Raw.WellFormed__Single#canCall(e#0)
         || (2 < $FunctionContextHeight && $Is(e#0, Tclass.AST.Expr__Raw()))
       ==> AST.Expr__Raw.WellFormed__Single(e#0)
         == (if AST.Expr__Raw.Var_q(e#0)
           then (var name#0 := AST.Expr__Raw.name(e#0); Lit(true))
           else (if AST.Expr__Raw.Literal_q(e#0)
...
procedure {:verboseName "AST.Expr_Raw.WellFormed_Single (well-formedness)"} CheckWellformed$$AST.Expr__Raw.WellFormed__Single(e#0: DatatypeType where $Is(e#0, Tclass.AST.Expr__Raw()));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
...
axiom {:id "id201"} 3 <= $FunctionContextHeight
...
procedure {:verboseName "AST.Expr_Raw.WellFormed (well-formedness)"} CheckWellformed$$AST.Expr__Raw.WellFormed(this: DatatypeType
       where $Is(this, Tclass.AST.Expr__Raw())
         && $IsAlloc(this, Tclass.AST.Expr__Raw(), $Heap));
  free requires 3 == $FunctionContextHeight;
  modifies $Heap;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "AST.Expr_Raw.WellFormed (well-formedness)"} CheckWellformed$$AST.Expr__Raw.WellFormed(this: DatatypeType)
{
  var $_ReadsFrame: [ref,Field]bool;
  var ##e#0: DatatypeType;
  var ##p#0: HandleType;
    ...
    else
    {
        ...
        // assume allocatedness for argument to function
        assume $IsAlloc(##e#0, Tclass.AST.Expr__Raw(), $Heap);
        assert {:id "id203"} 2 != $FunctionContextHeight;
        ##p#0 := AST.Expr__Raw.WellFormed__Single#Handle();
        // assume allocatedness for argument to function
        assume $IsAlloc(##p#0, Tclass._System.___hTotalFunc1(Tclass.AST.Expr__Raw(), TBool), $Heap);
        assume AST.Expr__Raw.All#canCall(this, AST.Expr__Raw.WellFormed__Single#Handle());
        assume {:id "id204"} AST.Expr__Raw.WellFormed(this)
           == AST.Expr__Raw.All($LS($LZ), this, AST.Expr__Raw.WellFormed__Single#Handle());
        assume AST.Expr__Raw.All#canCall(this, AST.Expr__Raw.WellFormed__Single#Handle());
        // CheckWellformedWithResult: any expression
        assume $Is(AST.Expr__Raw.WellFormed(this), TBool);
        return;
...
procedure {:verboseName "AST.Expr (well-formedness)"} CheckWellFormed$$AST.Expr(e#0: DatatypeType);
  free requires 4 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "AST.Expr (well-formedness)"} CheckWellFormed$$AST.Expr(e#0: DatatypeType)
{
  var $_ReadsFrame: [ref,Field]bool;


    // AddWellformednessCheck for subset type Expr
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    if (*)
    {
        // check well-formedness of subset type constraint
        assume $Is(e#0, Tclass.AST.Expr__Raw());
        // assume allocatedness for receiver argument to function
        assume $IsAllocBox($Box(e#0), Tclass.AST.Expr__Raw(), $Heap);
        assume AST.Expr__Raw.WellFormed#canCall(e#0);
        assume {:id "id205"} AST.Expr__Raw.WellFormed(e#0);
        assume false;
    }
    ...
    if (*)
    {
        ...
        assume AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))));
        assert {:id "id206"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
                  Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                  AST.Expr__Raw.WellFormed__Single#Handle())
                 || $Unbox(Apply1(Tclass.AST.Expr__Raw(), 
                    TBool, 
                    $Heap, 
                    AST.Expr__Raw.WellFormed__Single#Handle(), 
                    $Box(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))): bool);
        assert {:id "id207"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
                  Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                  AST.Expr__Raw.WellFormed__Single#Handle())
                 || (Lit(AST.Expr__Raw.Var_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                   ==> (var name#0 := Lit(AST.Expr__Raw.name(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                    Lit(true))));
        assert {:id "id208"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
                 ...
                 || (!Lit(AST.Expr__Raw.Var_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                   ==> 
                  Lit(AST.Expr__Raw.Literal_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                   ==> (var n#0 := LitInt(AST.Expr__Raw.n(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                    Lit(true))));
        assert {:id "id209"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
                 ...
                 || (!Lit(AST.Expr__Raw.Var_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                  ...
                  !Lit(AST.Expr__Raw.Literal_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                   ==> 
                  Lit(AST.Expr__Raw.Bind_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                   ==> (var body#0 := Lit(AST.Expr__Raw.body(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                    (var bvals#0 := Lit(AST.Expr__Raw.bvals(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                      (var bvars#0 := Lit(AST.Expr__Raw.bvars(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                        (forall e#1: DatatypeType :: 
                          { AST.Expr__Raw.All($LS($LS($LZ)), e#1, AST.Expr__Raw.WellFormed__Single#Handle()) } 
                            { Seq#Contains(bvals#0, $Box(e#1)) } 
                          $Is(e#1, Tclass.AST.Expr__Raw()) && Seq#Contains(bvals#0, $Box(e#1))
                             ==> AST.Expr__Raw.All($LS($LS($LZ)), e#1, AST.Expr__Raw.WellFormed__Single#Handle())))))));
        assert {:id "id210"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
                 ...
                 || (!Lit(AST.Expr__Raw.Var_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                  ...
                  Lit(AST.Expr__Raw.Bind_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                   ==> (var body#0 := Lit(AST.Expr__Raw.body(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                    (var bvals#0 := Lit(AST.Expr__Raw.bvals(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                      (var bvars#0 := Lit(AST.Expr__Raw.bvars(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                        AST.Expr__Raw.All($LS($LS($LZ)), body#0, AST.Expr__Raw.WellFormed__Single#Handle()))))));
        assert {:id "id211"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
                 ...
                 || (!Lit(AST.Expr__Raw.Var_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                  ...
                  !Lit(AST.Expr__Raw.Bind_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                   ==> 
                  Lit(AST.Expr__Raw.Assign_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                   ==> (var avals#0 := Lit(AST.Expr__Raw.avals(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                    (var avars#0 := Lit(AST.Expr__Raw.avars(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                      Lit(true)))));
        assert {:id "id212"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
                 ...
                 || (!Lit(AST.Expr__Raw.Var_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                  ...
                  Lit(AST.Expr__Raw.Assign_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                   ==> (var avals#0 := Lit(AST.Expr__Raw.avals(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                    (var avars#0 := Lit(AST.Expr__Raw.avars(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                      (forall e#2: DatatypeType :: 
                        { AST.Expr__Raw.All($LS($LS($LZ)), e#2, AST.Expr__Raw.WellFormed__Single#Handle()) } 
                          { Seq#Contains(avals#0, $Box(e#2)) } 
                        $Is(e#2, Tclass.AST.Expr__Raw()) && Seq#Contains(avals#0, $Box(e#2))
                           ==> AST.Expr__Raw.All($LS($LS($LZ)), e#2, AST.Expr__Raw.WellFormed__Single#Handle()))))));
        assert {:id "id213"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
                 ...
                 || (!Lit(AST.Expr__Raw.Var_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                  ...
                  !Lit(AST.Expr__Raw.Assign_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                   ==> 
                  Lit(AST.Expr__Raw.If_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                   ==> (var els#0 := Lit(AST.Expr__Raw.els(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                    (var thn#0 := Lit(AST.Expr__Raw.thn(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                      (var cond#0 := Lit(AST.Expr__Raw.cond(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                        AST.Expr__Raw.All($LS($LS($LZ)), cond#0, AST.Expr__Raw.WellFormed__Single#Handle()))))));
        assert {:id "id214"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
                 ...
                 || (!Lit(AST.Expr__Raw.Var_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                  ...
                  Lit(AST.Expr__Raw.If_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                   ==> (var els#0 := Lit(AST.Expr__Raw.els(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                    (var thn#0 := Lit(AST.Expr__Raw.thn(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                      (var cond#0 := Lit(AST.Expr__Raw.cond(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                        AST.Expr__Raw.All($LS($LS($LZ)), thn#0, AST.Expr__Raw.WellFormed__Single#Handle()))))));
        assert {:id "id215"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
                 ...
                 || (!Lit(AST.Expr__Raw.Var_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                  ...
                  Lit(AST.Expr__Raw.If_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                   ==> (var els#0 := Lit(AST.Expr__Raw.els(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                    (var thn#0 := Lit(AST.Expr__Raw.thn(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                      (var cond#0 := Lit(AST.Expr__Raw.cond(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                        AST.Expr__Raw.All($LS($LS($LZ)), els#0, AST.Expr__Raw.WellFormed__Single#Handle()))))));
        assert {:id "id216"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
                 ...
                 || (!Lit(AST.Expr__Raw.Var_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                  ...
                  !Lit(AST.Expr__Raw.If_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                   ==> 
                  Lit(AST.Expr__Raw.Op_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                   ==> (var oe2#0 := Lit(AST.Expr__Raw.oe2(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                    (var oe1#0 := Lit(AST.Expr__Raw.oe1(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                      (var op#0 := Lit(AST.Expr__Raw.op(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                        AST.Expr__Raw.All($LS($LS($LZ)), oe1#0, AST.Expr__Raw.WellFormed__Single#Handle()))))));
        assert {:id "id217"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
                 ...
                 || (!Lit(AST.Expr__Raw.Var_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                  ...
                  Lit(AST.Expr__Raw.Op_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                   ==> (var oe2#0 := Lit(AST.Expr__Raw.oe2(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                    (var oe1#0 := Lit(AST.Expr__Raw.oe1(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                      (var op#0 := Lit(AST.Expr__Raw.op(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                        AST.Expr__Raw.All($LS($LS($LZ)), oe2#0, AST.Expr__Raw.WellFormed__Single#Handle()))))));
        assert {:id "id218"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
                 ...
                 || (!Lit(AST.Expr__Raw.Var_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                  ...
                  !Lit(AST.Expr__Raw.If_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                   ==> 
                  !Lit(AST.Expr__Raw.Op_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                   ==> (var es#0 := Lit(AST.Expr__Raw.es(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                    Lit(true))));
        assert {:id "id219"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
                 ...
                 || (!Lit(AST.Expr__Raw.Var_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                  ...
                  !Lit(AST.Expr__Raw.Op_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                   ==> (var es#0 := Lit(AST.Expr__Raw.es(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                    (forall e#3: DatatypeType :: 
                      { AST.Expr__Raw.All($LS($LS($LZ)), e#3, AST.Expr__Raw.WellFormed__Single#Handle()) } 
...
axiom {:id "id220"} (forall x#0: int, y#0: int :: 
...
axiom {:id "id221"} (forall x#0: int, y#0: int :: 
  ...
  Utils.__default.MaxF#canCall(Utils._default.MaxF$T, $Heap, f#0, ts#0, default#0)
     ...
     ==> (if Seq#Equal(ts#0, Seq#Empty(): Seq)
         then Utils.__default.MaxF(Utils._default.MaxF$T, $ly, $reveal, $Heap, f#0, ts#0, default#0)
           == default#0
         else (exists t#20: Box :: 
          { $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#20)): int } 
            { Seq#Contains(ts#0, t#20) } 
          $IsBox(t#20, Utils._default.MaxF$T)
             && Seq#Contains(ts#0, t#20)
             && $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#20)): int
               == Utils.__default.MaxF(Utils._default.MaxF$T, $ly, $reveal, $Heap, f#0, ts#0, default#0)))
       && (forall t#21: Box :: 
        { $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#21)): int } 
          { Seq#Contains(ts#0, t#21) } 
        $IsBox(t#21, Utils._default.MaxF$T) && Seq#Contains(ts#0, t#21)
           ==> $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#21)): int
             <= Utils.__default.MaxF(Utils._default.MaxF$T, $ly, $reveal, $Heap, f#0, ts#0, default#0))
       && default#0
         <= Utils.__default.MaxF(Utils._default.MaxF$T, $ly, $reveal, $Heap, f#0, ts#0, default#0));
...
axiom (forall Utils._default.MaxF$T: Ty, 
  ...
  $IsGoodHeap($Heap)
     ...
     ==> Utils.__default.MaxF#requires(Utils._default.MaxF$T, $ly, $Heap, f#0, ts#0, default#0)
       == ((forall t#22: Box :: 
          { Requires1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#22) } 
            { Seq#Contains(ts#0, t#22) } 
          $IsBox(t#22, Utils._default.MaxF$T) && Seq#Contains(ts#0, t#22)
             ==> Requires1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#22))
         && (forall t#23: Box :: 
          { $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#23)): int } 
            { Seq#Contains(ts#0, t#23) } 
          $IsBox(t#23, Utils._default.MaxF$T) && Seq#Contains(ts#0, t#23)
             ==> default#0 <= $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#23)): int)));

// definition axiom for Utils.__default.MaxF (revealed)
axiom {:id "id222"} (forall Utils._default.MaxF$T: Ty, 
    $ly: LayerType, 
    $Heap: Heap, 
    f#0: HandleType, 
    ts#0: Seq, 
...
axiom {:id "id223"} (forall Utils.Result$T: Ty, this: DatatypeType :: 
...
axiom {:id "id224"} (forall Utils.Result$T: Ty, this: DatatypeType :: 
...
axiom {:id "id225"} (forall Utils.Result$T: Ty, Utils.Result.PropagateFailure$U: Ty, this: DatatypeType :: 
  { Utils.Result.PropagateFailure(Utils.Result$T, Utils.Result.PropagateFailure$U, this) } 
  Utils.Result.PropagateFailure#canCall(Utils.Result$T, Utils.Result.PropagateFailure$U, this)
       || ($Is(this, Tclass.Utils.Result(Utils.Result$T)) && Utils.Result.Failure_q(this))
     ==> Utils.Result.PropagateFailure(Utils.Result$T, Utils.Result.PropagateFailure$U, this)
...
axiom {:id "id226"} (forall Utils.Result$T: Ty, Utils.Result.PropagateFailure$U: Ty, this: DatatypeType :: 
...
axiom {:id "id227"} (forall Utils.Result$T: Ty, this: DatatypeType :: 
  { Utils.Result.Extract(Utils.Result$T, this) } 
  Utils.Result.Extract#canCall(Utils.Result$T, this)
       || ($Is(this, Tclass.Utils.Result(Utils.Result$T)) && Utils.Result.Success_q(this))
...
axiom {:id "id228"} (forall Utils.Result$T: Ty, this: DatatypeType :: 
