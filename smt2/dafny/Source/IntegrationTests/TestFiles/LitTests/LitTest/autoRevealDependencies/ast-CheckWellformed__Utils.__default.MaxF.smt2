...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((Utils._default.MaxF$T T@U) ($ly T@U) ($reveal Bool) ($Heap T@U) (|f#0| T@U) (|ts#0| T@U) (|default#0| Int) ) (!  (=> (or (|Utils.__default.MaxF#canCall| Utils._default.MaxF$T $Heap |f#0| |ts#0| |default#0|) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap) (and ($Is HandleTypeType |f#0| (Tclass._System.___hFunc1 Utils._default.MaxF$T TInt)) ($IsAlloc HandleTypeType |f#0| (Tclass._System.___hFunc1 Utils._default.MaxF$T TInt) $Heap))) (and ($Is SeqType |ts#0| (TSeq Utils._default.MaxF$T)) ($IsAlloc SeqType |ts#0| (TSeq Utils._default.MaxF$T) $Heap))) (and (forall ((|t#1| T@U) ) (!  (=> (and ($IsBox |t#1| Utils._default.MaxF$T) (|Seq#Contains| |ts#0| |t#1|)) (Requires1 Utils._default.MaxF$T TInt $Heap |f#0| |t#1|))
 :qid |astdfy.12:21|
 :skolemid |590|
 :pattern ( (Requires1 Utils._default.MaxF$T TInt $Heap |f#0| |t#1|))
 :pattern ( (|Seq#Contains| |ts#0| |t#1|))
)) (forall ((|t#2| T@U) ) (!  (=> (and ($IsBox |t#2| Utils._default.MaxF$T) (|Seq#Contains| |ts#0| |t#2|)) (<= |default#0| (U_2_int ($Unbox intType (Apply1 Utils._default.MaxF$T TInt $Heap |f#0| |t#2|)))))
 :qid |astdfy.13:21|
 :skolemid |591|
 :pattern ( ($Unbox intType (Apply1 Utils._default.MaxF$T TInt $Heap |f#0| |t#2|)))
 :pattern ( (|Seq#Contains| |ts#0| |t#2|))
)))))) (and (and (ite (|Seq#Equal| |ts#0| |Seq#Empty|) (= (Utils.__default.MaxF Utils._default.MaxF$T $ly $reveal $Heap |f#0| |ts#0| |default#0|) |default#0|) (exists ((|t#3| T@U) ) (!  (and (and ($IsBox |t#3| Utils._default.MaxF$T) (|Seq#Contains| |ts#0| |t#3|)) (= (U_2_int ($Unbox intType (Apply1 Utils._default.MaxF$T TInt $Heap |f#0| |t#3|))) (Utils.__default.MaxF Utils._default.MaxF$T $ly $reveal $Heap |f#0| |ts#0| |default#0|)))
 :qid |astdfy.14:55|
 :skolemid |592|
 :pattern ( ($Unbox intType (Apply1 Utils._default.MaxF$T TInt $Heap |f#0| |t#3|)))
 :pattern ( (|Seq#Contains| |ts#0| |t#3|))
))) (forall ((|t#4| T@U) ) (!  (=> (and ($IsBox |t#4| Utils._default.MaxF$T) (|Seq#Contains| |ts#0| |t#4|)) (<= (U_2_int ($Unbox intType (Apply1 Utils._default.MaxF$T TInt $Heap |f#0| |t#4|))) (Utils.__default.MaxF Utils._default.MaxF$T $ly $reveal $Heap |f#0| |ts#0| |default#0|)))
 :qid |astdfy.15:20|
 :skolemid |593|
 :pattern ( ($Unbox intType (Apply1 Utils._default.MaxF$T TInt $Heap |f#0| |t#4|)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) (|l#5| T@U) (|l#6| T@U) (|l#7| T@U) (|l#8| T@U) (|l#9| T@U) (|l#10| T@U) (|l#11| T@U) (|l#12| T@U) (|l#13| T@U) ($o@@0 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3| |l#4| |l#5| |l#6| |l#7| |l#8| |l#9| |l#10| |l#11| |l#12| |l#13|) $o@@0 $f))  (=> (and (or (not (= $o@@0 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@0) |l#2|)))) (exists ((|t#0| T@U) (|o#0| T@U) ) (!  (and (and (and ($IsBox |t#0| |l#3|) ($Is refType |o#0| |l#4|)) (and (|Seq#Contains| |l#5| |t#0|) (|Set#IsMember| (Reads1 |l#6| |l#7| |l#8| |l#9| |t#0|) ($Box refType |o#0|)))) (= ($Box refType $o@@0) ($Box refType |o#0|)))
 :qid |astdfy.11:15|
 :skolemid |601|
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0| Int) (|y#0| Int) ) (!  (=> (or (|Utils.__default.Max#canCall| (LitInt |x#0|) (LitInt |y#0|)) (< 0 $FunctionContextHeight)) (= (Utils.__default.Max (LitInt |x#0|) (LitInt |y#0|)) (ite (> |x#0| |y#0|) |x#0| |y#0|)))
 :qid |astdfy.5:16|
 :weight 3
 :skolemid |584|
 :pattern ( (Utils.__default.Max (LitInt |x#0|) (LitInt |y#0|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((Utils._default.MaxF$T@@1 T@U) ($ly@@1 T@U) ($Heap@@1 T@U) (|f#0@@1| T@U) (|ts#0@@1| T@U) (|default#0@@1| Int) ) (!  (=> (or (|Utils.__default.MaxF#canCall| Utils._default.MaxF$T@@1 $Heap@@1 |f#0@@1| |ts#0@@1| |default#0@@1|) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@1) ($Is HandleTypeType |f#0@@1| (Tclass._System.___hFunc1 Utils._default.MaxF$T@@1 TInt))) ($Is SeqType |ts#0@@1| (TSeq Utils._default.MaxF$T@@1))) (and (forall ((|t#5| T@U) ) (!  (=> (and ($IsBox |t#5| Utils._default.MaxF$T@@1) (|Seq#Contains| |ts#0@@1| |t#5|)) (Requires1 Utils._default.MaxF$T@@1 TInt $Heap@@1 |f#0@@1| |t#5|))
 :qid |astdfy.12:21|
 :skolemid |595|
 :pattern ( (Requires1 Utils._default.MaxF$T@@1 TInt $Heap@@1 |f#0@@1| |t#5|))
 :pattern ( (|Seq#Contains| |ts#0@@1| |t#5|))
)) (forall ((|t#6| T@U) ) (!  (=> (and ($IsBox |t#6| Utils._default.MaxF$T@@1) (|Seq#Contains| |ts#0@@1| |t#6|)) (<= |default#0@@1| (U_2_int ($Unbox intType (Apply1 Utils._default.MaxF$T@@1 TInt $Heap@@1 |f#0@@1| |t#6|)))))
 :qid |astdfy.13:21|
 :skolemid |596|
 :pattern ( ($Unbox intType (Apply1 Utils._default.MaxF$T@@1 TInt $Heap@@1 |f#0@@1| |t#6|)))
 :pattern ( (|Seq#Contains| |ts#0@@1| |t#6|))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@0| Int) (|y#0@@0| Int) ) (!  (=> (or (|Utils.__default.Max#canCall| |x#0@@0| |y#0@@0|) (< 0 $FunctionContextHeight)) (= (Utils.__default.Max |x#0@@0| |y#0@@0|) (ite (> |x#0@@0| |y#0@@0|) |x#0@@0| |y#0@@0|)))
 :qid |astdfy.5:16|
 :skolemid |583|
 :pattern ( (Utils.__default.Max |x#0@@0| |y#0@@0|))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 51) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 10) (- 0 13)) (=> (|Seq#Equal| |ts#0@@2| |Seq#Empty|) (= |m#0| |default#0@@2|))) (=> (=> (|Seq#Equal| |ts#0@@2| |Seq#Empty|) (= |m#0| |default#0@@2|)) (and (=> (= (ControlFlow 0 10) (- 0 12)) (=> (not (|Seq#Equal| |ts#0@@2| |Seq#Empty|)) (exists ((|t#7| T@U) ) (!  (and (and ($IsBox |t#7| Utils._default.MaxF$T@@2) (|Seq#Contains| |ts#0@@2| |t#7|)) (= (U_2_int ($Unbox intType (Apply1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#7|))) |m#0|))
 :qid |astdfy.14:55|
 :skolemid |599|
 :pattern ( ($Unbox intType (Apply1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#7|)))
 :pattern ( (|Seq#Contains| |ts#0@@2| |t#7|))
)))) (=> (=> (not (|Seq#Equal| |ts#0@@2| |Seq#Empty|)) (exists ((|t#7@@0| T@U) ) (!  (and (and ($IsBox |t#7@@0| Utils._default.MaxF$T@@2) (|Seq#Contains| |ts#0@@2| |t#7@@0|)) (= (U_2_int ($Unbox intType (Apply1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#7@@0|))) |m#0|))
 :qid |astdfy.14:55|
 :skolemid |599|
 :pattern ( ($Unbox intType (Apply1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#7@@0|)))
 :pattern ( (|Seq#Contains| |ts#0@@2| |t#7@@0|))
))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((|t#8| T@U) ) (!  (=> (and ($IsBox |t#8| Utils._default.MaxF$T@@2) (|Seq#Contains| |ts#0@@2| |t#8|)) (<= (U_2_int ($Unbox intType (Apply1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#8|))) |m#0|))
 :qid |astdfy.15:20|
 :skolemid |600|
 :pattern ( ($Unbox intType (Apply1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#8|)))
 :pattern ( (|Seq#Contains| |ts#0@@2| |t#8|))
))) (=> (forall ((|t#8@@0| T@U) ) (!  (=> (and ($IsBox |t#8@@0| Utils._default.MaxF$T@@2) (|Seq#Contains| |ts#0@@2| |t#8@@0|)) (<= (U_2_int ($Unbox intType (Apply1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#8@@0|))) |m#0|))
 :qid |astdfy.15:20|
 :skolemid |600|
 :pattern ( ($Unbox intType (Apply1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#8@@0|)))
 :pattern ( (|Seq#Contains| |ts#0@@2| |t#8@@0|))
...
(let ((anon40_Else_correct  (=> (not (|Seq#Equal| |ts#0@@2| |Seq#Empty|)) (and (=> (= (ControlFlow 0 15) (- 0 24)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |ts#0@@2|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |ts#0@@2|))) (and (=> (= (ControlFlow 0 15) (- 0 23)) (Requires1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| (|Seq#Index| |ts#0@@2| (LitInt 0)))) (=> (Requires1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| (|Seq#Index| |ts#0@@2| (LitInt 0))) (=> (and (and (= |b$reqreads#3@0| (forall (($o@@2 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@2) alloc)))) (|Set#IsMember| (Reads1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| (|Seq#Index| |ts#0@@2| (LitInt 0))) ($Box refType $o@@2))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@2 $f@@0)))
 :qid |astdfy.20:11|
 :skolemid |608|
))) (= |##x#0@0| (U_2_int ($Unbox intType (Apply1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| (|Seq#Index| |ts#0@@2| (LitInt 0))))))) (and ($IsAlloc intType (int_2_U |##x#0@0|) TInt $Heap@@2) ($IsAlloc HandleTypeType |f#0@@2| (Tclass._System.___hFunc1 Utils._default.MaxF$T@@2 TInt) $Heap@@2))) (and (=> (= (ControlFlow 0 15) (- 0 22)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |ts#0@@2|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |ts#0@@2|))) (=> (= |##ts#0@0| (|Seq#Drop| |ts#0@@2| (LitInt 1))) (=> (and ($IsAlloc SeqType |##ts#0@0| (TSeq Utils._default.MaxF$T@@2) $Heap@@2) ($IsAlloc intType (int_2_U |default#0@@2|) TInt $Heap@@2)) (and (=> (= (ControlFlow 0 15) (- 0 21)) (forall ((|t#15| T@U) ) (!  (=> (and ($IsBox |t#15| Utils._default.MaxF$T@@2) (|Seq#Contains| |##ts#0@0| |t#15|)) (Requires1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#15|))
 :qid |astdfy.12:21|
 :skolemid |609|
 :pattern ( (Requires1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#15|))
 :pattern ( (|Seq#Contains| |##ts#0@0| |t#15|))
))) (=> (forall ((|t#15@@0| T@U) ) (!  (=> (and ($IsBox |t#15@@0| Utils._default.MaxF$T@@2) (|Seq#Contains| |##ts#0@0| |t#15@@0|)) (Requires1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#15@@0|))
 :qid |astdfy.12:21|
 :skolemid |610|
 :pattern ( (Requires1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#15@@0|))
 :pattern ( (|Seq#Contains| |##ts#0@0| |t#15@@0|))
)) (and (=> (= (ControlFlow 0 15) (- 0 20)) (forall ((|t#16| T@U) ) (!  (=> (and ($IsBox |t#16| Utils._default.MaxF$T@@2) (|Seq#Contains| |##ts#0@0| |t#16|)) (<= |default#0@@2| (U_2_int ($Unbox intType (Apply1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#16|)))))
 :qid |astdfy.13:21|
 :skolemid |611|
 :pattern ( ($Unbox intType (Apply1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#16|)))
 :pattern ( (|Seq#Contains| |##ts#0@0| |t#16|))
))) (=> (and (forall ((|t#16@@0| T@U) ) (!  (=> (and ($IsBox |t#16@@0| Utils._default.MaxF$T@@2) (|Seq#Contains| |##ts#0@0| |t#16@@0|)) (<= |default#0@@2| (U_2_int ($Unbox intType (Apply1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#16@@0|)))))
 :qid |astdfy.13:21|
 :skolemid |612|
 :pattern ( ($Unbox intType (Apply1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#16@@0|)))
 :pattern ( (|Seq#Contains| |##ts#0@0| |t#16@@0|))
)) (= |b$reqreads#4@0| (forall (($o@@3 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@3 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@3) alloc)))) (exists ((|t#17| T@U) (|o#3| T@U) ) (!  (and (and (and ($IsBox |t#17| Utils._default.MaxF$T@@2) ($Is refType |o#3| Tclass._System.object?)) (and (|Seq#Contains| |##ts#0@0| |t#17|) (|Set#IsMember| (Reads1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#17|) ($Box refType |o#3|)))) (= ($Box refType $o@@3) ($Box refType |o#3|)))
 :qid |astdfy.11:15|
 :skolemid |613|
 :pattern ( (|Set#IsMember| (Reads1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#17|) ($Box refType |o#3|)))
...
(let ((anon39_Else_correct  (=> (and (=> (|Seq#Contains| |ts#0@@2| |t#14@0|) (<= (U_2_int ($Unbox intType (Apply1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#14@0|))) |m#0|)) (= (ControlFlow 0 4) 1)) anon24_correct)))
(let ((anon39_Then_correct  (=> (|Seq#Contains| |ts#0@@2| |t#14@0|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (Requires1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#14@0|)) (=> (Requires1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#14@0|) (=> (and (<= (U_2_int ($Unbox intType (Apply1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#14@0|))) |m#0|) (= (ControlFlow 0 2) 1)) anon24_correct))))))
(let ((anon21_correct  (=> (and ($IsBox |t#14@0| Utils._default.MaxF$T@@2) ($IsAllocBox |t#14@0| Utils._default.MaxF$T@@2 $Heap@@2)) (and (=> (= (ControlFlow 0 5) 2) anon39_Then_correct) (=> (= (ControlFlow 0 5) 4) anon39_Else_correct)))))
(let ((anon38_Else_correct  (=> (not (|Seq#Equal| |ts#0@@2| |Seq#Empty|)) (=> (and (and ($IsBox |t#13@0| Utils._default.MaxF$T@@2) ($IsAllocBox |t#13@0| Utils._default.MaxF$T@@2 $Heap@@2)) (|Seq#Contains| |ts#0@@2| |t#13@0|)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (Requires1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#13@0|)) (=> (Requires1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#13@0|) (=> (and (= (U_2_int ($Unbox intType (Apply1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#13@0|))) |m#0|) (= (ControlFlow 0 7) 5)) anon21_correct)))))))
(let ((anon38_Then_correct  (=> (|Seq#Equal| |ts#0@@2| |Seq#Empty|) (=> (and (= |m#0| |default#0@@2|) (= (ControlFlow 0 6) 5)) anon21_correct))))
(let ((anon36_Else_correct  (=> (not (and (|Seq#Contains| |ts#0@@2| |t#12@0|) (|Set#IsMember| (Reads1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#12@0|) ($Box refType |o#2@0|)))) (and (and (and (=> (= (ControlFlow 0 27) 14) anon40_Then_correct) (=> (= (ControlFlow 0 27) 15) anon40_Else_correct)) (=> (= (ControlFlow 0 27) 6) anon38_Then_correct)) (=> (= (ControlFlow 0 27) 7) anon38_Else_correct)))))
(let ((anon36_Then_correct  (=> (and (|Seq#Contains| |ts#0@@2| |t#12@0|) (|Set#IsMember| (Reads1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#12@0|) ($Box refType |o#2@0|))) (and (and (and (=> (= (ControlFlow 0 26) 14) anon40_Then_correct) (=> (= (ControlFlow 0 26) 15) anon40_Else_correct)) (=> (= (ControlFlow 0 26) 6) anon38_Then_correct)) (=> (= (ControlFlow 0 26) 7) anon38_Else_correct)))))
(let ((anon35_Else_correct  (=> (not (|Seq#Contains| |ts#0@@2| |t#12@0|)) (and (=> (= (ControlFlow 0 30) 26) anon36_Then_correct) (=> (= (ControlFlow 0 30) 27) anon36_Else_correct)))))
(let ((anon35_Then_correct  (=> (|Seq#Contains| |ts#0@@2| |t#12@0|) (=> (and ($IsAllocBox ($Box HandleTypeType |f#0@@2|) (Tclass._System.___hFunc1 Utils._default.MaxF$T@@2 TInt) $Heap@@2) ($IsAllocBox |t#12@0| Utils._default.MaxF$T@@2 $Heap@@2)) (and (=> (= (ControlFlow 0 28) (- 0 29)) (Requires1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#12@0|)) (=> (Requires1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#12@0|) (and (=> (= (ControlFlow 0 28) 26) anon36_Then_correct) (=> (= (ControlFlow 0 28) 27) anon36_Else_correct))))))))
(let ((anon34_Then_correct  (=> (and (and ($IsBox |t#12@0| Utils._default.MaxF$T@@2) ($IsAllocBox |t#12@0| Utils._default.MaxF$T@@2 $Heap@@2)) (and ($Is refType |o#2@0| Tclass._System.object?) ($IsAlloc refType |o#2@0| Tclass._System.object? $Heap@@2))) (and (=> (= (ControlFlow 0 31) 28) anon35_Then_correct) (=> (= (ControlFlow 0 31) 30) anon35_Else_correct)))))
(let ((anon34_Else_correct  (=> (not (and (and ($IsBox |t#12@0| Utils._default.MaxF$T@@2) ($IsAllocBox |t#12@0| Utils._default.MaxF$T@@2 $Heap@@2)) (and ($Is refType |o#2@0| Tclass._System.object?) ($IsAlloc refType |o#2@0| Tclass._System.object? $Heap@@2)))) (and (and (and (=> (= (ControlFlow 0 25) 14) anon40_Then_correct) (=> (= (ControlFlow 0 25) 15) anon40_Else_correct)) (=> (= (ControlFlow 0 25) 6) anon38_Then_correct)) (=> (= (ControlFlow 0 25) 7) anon38_Else_correct)))))
...
(let ((anon33_Else_correct  (=> (not (and (|Seq#Contains| |ts#0@@2| |t#11@0|) (|Set#IsMember| (Reads1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#11@0|) ($Box refType |o#1@0|)))) (=> (and (= |b$reqreads#2@2| |b$reqreads#2@1|) (= (ControlFlow 0 36) 32)) anon12_correct))))
(let ((anon33_Then_correct  (=> (and (and (|Seq#Contains| |ts#0@@2| |t#11@0|) (|Set#IsMember| (Reads1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#11@0|) ($Box refType |o#1@0|))) (and (= |b$reqreads#2@2| |b$reqreads#2@1|) (= (ControlFlow 0 35) 32))) anon12_correct)))
(let ((anon32_Else_correct  (=> (and (not (|Seq#Contains| |ts#0@@2| |t#11@0|)) (= |b$reqreads#2@1| true)) (and (=> (= (ControlFlow 0 39) 35) anon33_Then_correct) (=> (= (ControlFlow 0 39) 36) anon33_Else_correct)))))
(let ((anon32_Then_correct  (=> (|Seq#Contains| |ts#0@@2| |t#11@0|) (=> (and ($IsAllocBox ($Box HandleTypeType |f#0@@2|) (Tclass._System.___hFunc1 Utils._default.MaxF$T@@2 TInt) $Heap@@2) ($IsAllocBox |t#11@0| Utils._default.MaxF$T@@2 $Heap@@2)) (and (=> (= (ControlFlow 0 37) (- 0 38)) (Requires1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#11@0|)) (=> (Requires1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#11@0|) (=> (and (= |b$reqreads#2@0| (forall (($o@@4 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@4) alloc)))) (|Set#IsMember| (Reads1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#11@0|) ($Box refType $o@@4))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@4 $f@@2)))
 :qid |astdfy.11:40|
 :skolemid |606|
))) (= |b$reqreads#2@1| |b$reqreads#2@0|)) (and (=> (= (ControlFlow 0 37) 35) anon33_Then_correct) (=> (= (ControlFlow 0 37) 36) anon33_Else_correct)))))))))
(let ((anon31_Then_correct  (=> (and (and ($IsBox |t#11@0| Utils._default.MaxF$T@@2) ($IsAllocBox |t#11@0| Utils._default.MaxF$T@@2 $Heap@@2)) (and ($Is refType |o#1@0| Tclass._System.object?) ($IsAlloc refType |o#1@0| Tclass._System.object? $Heap@@2))) (and (=> (= (ControlFlow 0 40) 37) anon32_Then_correct) (=> (= (ControlFlow 0 40) 39) anon32_Else_correct)))))
(let ((anon31_Else_correct  (=> (not (and (and ($IsBox |t#11@0| Utils._default.MaxF$T@@2) ($IsAllocBox |t#11@0| Utils._default.MaxF$T@@2 $Heap@@2)) (and ($Is refType |o#1@0| Tclass._System.object?) ($IsAlloc refType |o#1@0| Tclass._System.object? $Heap@@2)))) (=> (and (= |b$reqreads#2@2| true) (= (ControlFlow 0 34) 32)) anon12_correct))))
(let ((anon7_correct  (=> (forall ((|t#2@@0| T@U) ) (!  (=> (and ($IsBox |t#2@@0| Utils._default.MaxF$T@@2) (|Seq#Contains| |ts#0@@2| |t#2@@0|)) (<= |default#0@@2| (U_2_int ($Unbox intType (Apply1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#2@@0|)))))
 :qid |astdfy.13:21|
 :skolemid |605|
 :pattern ( ($Unbox intType (Apply1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#2@@0|)))
 :pattern ( (|Seq#Contains| |ts#0@@2| |t#2@@0|))
...
(let ((anon30_Else_correct  (=> (=> (|Seq#Contains| |ts#0@@2| |t#10@0|) (<= |default#0@@2| (U_2_int ($Unbox intType (Apply1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#10@0|))))) (=> (and (= |b$reqreads#1@1| true) (= (ControlFlow 0 46) 41)) anon7_correct))))
(let ((anon30_Then_correct  (=> (|Seq#Contains| |ts#0@@2| |t#10@0|) (and (=> (= (ControlFlow 0 44) (- 0 45)) (Requires1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#10@0|)) (=> (Requires1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#10@0|) (=> (and (and (= |b$reqreads#1@0| (forall (($o@@5 T@U) ($f@@3 T@U) ) (!  (=> (and (and (or (not (= $o@@5 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@5) alloc)))) (|Set#IsMember| (Reads1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#10@0|) ($Box refType $o@@5))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@5 $f@@3)))
 :qid |astdfy.13:47|
 :skolemid |604|
))) (<= |default#0@@2| (U_2_int ($Unbox intType (Apply1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#10@0|))))) (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= (ControlFlow 0 44) 41))) anon7_correct))))))
(let ((anon4_correct  (=> (forall ((|t#1@@0| T@U) ) (!  (=> (and ($IsBox |t#1@@0| Utils._default.MaxF$T@@2) (|Seq#Contains| |ts#0@@2| |t#1@@0|)) (Requires1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#1@@0|))
 :qid |astdfy.12:21|
 :skolemid |603|
 :pattern ( (Requires1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#1@@0|))
 :pattern ( (|Seq#Contains| |ts#0@@2| |t#1@@0|))
)) (=> (and ($IsBox |t#10@0| Utils._default.MaxF$T@@2) ($IsAllocBox |t#10@0| Utils._default.MaxF$T@@2 $Heap@@2)) (and (=> (= (ControlFlow 0 47) 44) anon30_Then_correct) (=> (= (ControlFlow 0 47) 46) anon30_Else_correct))))))
(let ((anon29_Else_correct  (=> (=> (|Seq#Contains| |ts#0@@2| |t#9@0|) (Requires1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#9@0|)) (=> (and (= |b$reqreads#0@1| true) (= (ControlFlow 0 49) 47)) anon4_correct))))
(let ((anon29_Then_correct  (=> (|Seq#Contains| |ts#0@@2| |t#9@0|) (=> (and ($IsAllocBox ($Box HandleTypeType |f#0@@2|) (Tclass._System.___hFunc1 Utils._default.MaxF$T@@2 TInt) $Heap@@2) ($IsAllocBox |t#9@0| Utils._default.MaxF$T@@2 $Heap@@2)) (=> (and (and (= |b$reqreads#0@0| (forall (($o@@6 T@U) ($f@@4 T@U) ) (!  (=> (and (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@6) alloc)))) (|Set#IsMember| (Reads1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#9@0|) ($Box refType $o@@6))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@6 $f@@4)))
 :qid |astdfy.12:38|
 :skolemid |602|
))) (Requires1 Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| |t#9@0|)) (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= (ControlFlow 0 48) 47))) anon4_correct)))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc Utils._default.MaxF$T@@2 Tclass._System.object? |ts#0@@2| Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2| Utils._default.MaxF$T@@2 TInt $Heap@@2 |f#0@@2|)) (=> (and ($IsBox |t#9@0| Utils._default.MaxF$T@@2) ($IsAllocBox |t#9@0| Utils._default.MaxF$T@@2 $Heap@@2)) (and (=> (= (ControlFlow 0 50) 48) anon29_Then_correct) (=> (= (ControlFlow 0 50) 49) anon29_Else_correct))))))
