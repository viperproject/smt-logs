// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/autoRevealDependencies/ast.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/autoRevealDependencies/ast-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/autoRevealDependencies/ast.dfy
...
axiom {:id "id0"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int, y#0: int :: 
    ...
    Utils.__default.Max#canCall(x#0, y#0) || 0 < $FunctionContextHeight
...
axiom {:id "id1"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int, y#0: int :: 
    ...
    Utils.__default.Max#canCall(LitInt(x#0), LitInt(y#0))
...
procedure {:verboseName "Utils.Max (well-formedness)"} CheckWellformed$$Utils.__default.Max(x#0: int, y#0: int);
...
axiom 1 <= $FunctionContextHeight
   ==> (forall Utils._default.MaxF$T: Ty, 
      $ly: LayerType, 
      $reveal: bool, 
      $Heap: Heap, 
      f#0: HandleType, 
    ...
    Utils.__default.MaxF#canCall(Utils._default.MaxF$T, $Heap, f#0, ts#0, default#0)
         || (1 < $FunctionContextHeight
          ...
          $Is(ts#0, TSeq(Utils._default.MaxF$T))
           ...
           && 
          (forall t#1: Box :: 
            { Requires1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#1) } 
           ...
           && (forall t#2: Box :: 
            ...
            $IsBox(t#2, Utils._default.MaxF$T) && Seq#Contains(ts#0, t#2)
               ==> default#0 <= $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#2)): int))
       ==> (if Seq#Equal(ts#0, Seq#Empty(): Seq)
           then Utils.__default.MaxF(Utils._default.MaxF$T, $ly, $reveal, $Heap, f#0, ts#0, default#0)
            ...
            $IsBox(t#3, Utils._default.MaxF$T)
               && Seq#Contains(ts#0, t#3)
               && $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#3)): int
                 == Utils.__default.MaxF(Utils._default.MaxF$T, $ly, $reveal, $Heap, f#0, ts#0, default#0)))
         && (forall t#4: Box :: 
          { $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#4)): int } 
    ...
    Utils.__default.MaxF#canCall(Utils._default.MaxF$T, $Heap, f#0, ts#0, default#0)
         || (1 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           ...
           && 
          (forall t#5: Box :: 
            { Requires1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#5) } 
              { Seq#Contains(ts#0, t#5) } 
            $IsBox(t#5, Utils._default.MaxF$T) && Seq#Contains(ts#0, t#5)
               ==> Requires1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#5))
           && (forall t#6: Box :: 
            { $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#6)): int } 
              { Seq#Contains(ts#0, t#6) } 
            $IsBox(t#6, Utils._default.MaxF$T) && Seq#Contains(ts#0, t#6)
               ==> default#0 <= $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#6)): int))
...
axiom (forall Utils._default.MaxF$T: Ty, 
  ...
  $IsGoodHeap($h0)
    ...
    (forall $o: ref, $f: Field :: 
      $o != null
           && (exists t#0: Box, o#0: ref :: 
            { Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $h0, f#0, t#0), $Box(o#0)) } 
            $IsBox(t#0, Utils._default.MaxF$T)
...
procedure {:verboseName "Utils.MaxF (well-formedness)"} CheckWellformed$$Utils.__default.MaxF(Utils._default.MaxF$T: Ty where $AlwaysAllocated(Utils._default.MaxF$T), 
    f#0: HandleType
       where $Is(f#0, Tclass._System.___hFunc1(Utils._default.MaxF$T, TInt)), 
    ts#0: Seq where $Is(ts#0, TSeq(Utils._default.MaxF$T)), 
    default#0: int)
   returns (m#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  ensures {:id "id5"} Seq#Equal(ts#0, Seq#Empty(): Seq) ==> m#0 == default#0;
  ensures {:id "id6"} !Seq#Equal(ts#0, Seq#Empty(): Seq)
     ==> (exists t#7: Box :: 
      { $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#7)): int } 
        { Seq#Contains(ts#0, t#7) } 
      $IsBox(t#7, Utils._default.MaxF$T)
         && Seq#Contains(ts#0, t#7)
         && $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#7)): int == m#0);
  ensures {:id "id7"} (forall t#8: Box :: 
    { $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#8)): int } 
      { Seq#Contains(ts#0, t#8) } 
    $IsBox(t#8, Utils._default.MaxF$T) && Seq#Contains(ts#0, t#8)
       ==> $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#8)): int <= m#0);
  ensures {:id "id8"} default#0 <= m#0;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Utils.MaxF (well-formedness)"} CheckWellformed$$Utils.__default.MaxF(Utils._default.MaxF$T: Ty, f#0: HandleType, ts#0: Seq, default#0: int)
   returns (m#0: int)
{
  ...
  var b$reqreads#4: bool;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool
         ==> (exists t#0: Box, o#0: ref :: 
          { Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#0), $Box(o#0)) } 
          $IsBox(t#0, Utils._default.MaxF$T)
             && $Is(o#0, Tclass._System.object?())
             && 
            Seq#Contains(ts#0, t#0)
    ...
    havoc t#9;
    assume $IsBox(t#9, Utils._default.MaxF$T)
       && $IsAllocBox(t#9, Utils._default.MaxF$T, $Heap);
    if (*)
    {
        assume {:id "id9"} Seq#Contains(ts#0, t#9);
        // assume allocatedness for receiver argument to function
        assume $IsAllocBox($Box(f#0), Tclass._System.___hFunc1(Utils._default.MaxF$T, TInt), $Heap);
        ##x0#0 := t#9;
        // assume allocatedness for argument to function
        assume $IsAllocBox(##x0#0, Utils._default.MaxF$T, $Heap);
        b$reqreads#0 := (forall $o: ref, $f: Field :: 
          $o != null
               && $Unbox(read($Heap, $o, alloc)): bool
               && Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, f#0, ##x0#0), $Box($o))
             ==> $_ReadsFrame[$o, $f]);
        assume Requires1#canCall(Utils._default.MaxF$T, TInt, $Heap, f#0, t#9);
        assume {:id "id10"} Requires1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#9);
    }
    else
    {
        assume {:id "id11"} Seq#Contains(ts#0, t#9)
           ==> Requires1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#9);
    }

    assume {:id "id12"} (forall t#1: Box :: 
      { Requires1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#1) } 
        { Seq#Contains(ts#0, t#1) } 
      $IsBox(t#1, Utils._default.MaxF$T) && Seq#Contains(ts#0, t#1)
         ==> Requires1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#1));
    havoc t#10;
    assume $IsBox(t#10, Utils._default.MaxF$T)
       && $IsAllocBox(t#10, Utils._default.MaxF$T, $Heap);
    if (*)
    {
        assume {:id "id13"} Seq#Contains(ts#0, t#10);
        assert {:id "id14"} Requires1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#10);
        b$reqreads#1 := (forall $o: ref, $f: Field :: 
          $o != null
               && $Unbox(read($Heap, $o, alloc)): bool
               && Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#10), $Box($o))
             ==> $_ReadsFrame[$o, $f]);
        assume {:id "id15"} default#0 <= $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#10)): int;
    }
    else
    {
        assume {:id "id16"} Seq#Contains(ts#0, t#10)
           ==> default#0 <= $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#10)): int;
    }

    assume {:id "id17"} (forall t#2: Box :: 
      { $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#2)): int } 
        { Seq#Contains(ts#0, t#2) } 
      $IsBox(t#2, Utils._default.MaxF$T) && Seq#Contains(ts#0, t#2)
         ==> default#0 <= $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#2)): int);
    assert {:id "id18"} b$reqreads#0;
    assert {:id "id19"} b$reqreads#1;
    // Check well-formedness of the reads clause
    // Begin Comprehension WF check
    havoc t#11;
    havoc o#1;
    if ($IsBox(t#11, Utils._default.MaxF$T)
       && $IsAllocBox(t#11, Utils._default.MaxF$T, $Heap)
       && 
      $Is(o#1, Tclass._System.object?())
       && $IsAlloc(o#1, Tclass._System.object?(), $Heap))
    {
        if (Seq#Contains(ts#0, t#11))
        {
            // assume allocatedness for receiver argument to function
            assume $IsAllocBox($Box(f#0), Tclass._System.___hFunc1(Utils._default.MaxF$T, TInt), $Heap);
            ##x0#1 := t#11;
            // assume allocatedness for argument to function
            assume $IsAllocBox(##x0#1, Utils._default.MaxF$T, $Heap);
            assert {:id "id20"} Requires1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#11);
            b$reqreads#2 := (forall $o: ref, $f: Field :: 
              $o != null
                   && $Unbox(read($Heap, $o, alloc)): bool
                   && Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#11), $Box($o))
                 ==> $_ReadsFrame[$o, $f]);
            assume Reads1#canCall(Utils._default.MaxF$T, TInt, $Heap, f#0, t#11);
        }

        if (Seq#Contains(ts#0, t#11)
           && Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#11), $Box(o#1)))
        {
        }
    }
    ...
    havoc t#12;
    havoc o#2;
    if ($IsBox(t#12, Utils._default.MaxF$T)
       && $IsAllocBox(t#12, Utils._default.MaxF$T, $Heap)
       && 
      $Is(o#2, Tclass._System.object?())
       && $IsAlloc(o#2, Tclass._System.object?(), $Heap))
    {
        if (Seq#Contains(ts#0, t#12))
        {
            // assume allocatedness for receiver argument to function
            assume $IsAllocBox($Box(f#0), Tclass._System.___hFunc1(Utils._default.MaxF$T, TInt), $Heap);
            ##x0#2 := t#12;
            // assume allocatedness for argument to function
            assume $IsAllocBox(##x0#2, Utils._default.MaxF$T, $Heap);
            assert {:id "id22"} Requires1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#12);
            assume Reads1#canCall(Utils._default.MaxF$T, TInt, $Heap, f#0, t#12);
        }

        if (Seq#Contains(ts#0, t#12)
           && Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#12), $Box(o#2)))
        {
        }
    }
    ...
    if (*)
    {
        ...
        if (*)
        {
            assume {:id "id23"} Seq#Equal(ts#0, Seq#Empty(): Seq);
            assume {:id "id24"} m#0 == default#0;
        }
        else
        {
            assume {:id "id25"} !Seq#Equal(ts#0, Seq#Empty(): Seq);
            havoc t#13;
            assume $IsBox(t#13, Utils._default.MaxF$T)
               && $IsAllocBox(t#13, Utils._default.MaxF$T, $Heap);
            assume {:id "id26"} Seq#Contains(ts#0, t#13);
            assert {:id "id27"} Requires1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#13);
            assume {:id "id28"} $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#13)): int == m#0;
        }

        havoc t#14;
        assume $IsBox(t#14, Utils._default.MaxF$T)
           && $IsAllocBox(t#14, Utils._default.MaxF$T, $Heap);
        if (*)
        {
            assume {:id "id29"} Seq#Contains(ts#0, t#14);
            assert {:id "id30"} Requires1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#14);
            assume {:id "id31"} $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#14)): int <= m#0;
        }
        else
        {
            assume {:id "id32"} Seq#Contains(ts#0, t#14)
               ==> $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#14)): int <= m#0;
        }

        assume {:id "id33"} (forall t#8: Box :: 
          { $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#8)): int } 
            { Seq#Contains(ts#0, t#8) } 
          $IsBox(t#8, Utils._default.MaxF$T) && Seq#Contains(ts#0, t#8)
             ==> $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#8)): int <= m#0);
        assume {:id "id34"} default#0 <= m#0;
        assume false;
    }
    else
    {
        ...
        if (Seq#Equal(ts#0, Seq#Empty(): Seq))
        {
            assume {:id "id35"} Utils.__default.MaxF(Utils._default.MaxF$T, 
                $LS($LZ), 
                reveal_Utils._default.MaxF, 
                $Heap, 
                f#0, 
            ...
            assume $Is(Utils.__default.MaxF(Utils._default.MaxF$T, 
                $LS($LZ), 
                reveal_Utils._default.MaxF, 
                $Heap, 
                f#0, 
                ...
                default#0), 
              TInt);
            assume {:id "id36"} Utils.__default.MaxF(Utils._default.MaxF$T, 
                $LS($LZ), 
                reveal_Utils._default.MaxF, 
                $Heap, 
                f#0, 
        ...
        {
            assert {:id "id37"} 0 <= LitInt(0) && LitInt(0) < Seq#Length(ts#0);
            assert {:id "id38"} Requires1(Utils._default.MaxF$T, TInt, $Heap, f#0, Seq#Index(ts#0, LitInt(0)));
            b$reqreads#3 := (forall $o: ref, $f: Field :: 
              $o != null
                   && $Unbox(read($Heap, $o, alloc)): bool
                   && Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, f#0, Seq#Index(ts#0, LitInt(0))), 
                    $Box($o))
                 ==> $_ReadsFrame[$o, $f]);
            ##x#0 := $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, Seq#Index(ts#0, LitInt(0)))): int;
            // assume allocatedness for argument to function
            assume $IsAlloc(##x#0, TInt, $Heap);
            ##f#0 := f#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##f#0, Tclass._System.___hFunc1(Utils._default.MaxF$T, TInt), $Heap);
            assert {:id "id39"} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(ts#0);
            ##ts#0 := Seq#Drop(ts#0, LitInt(1));
            // assume allocatedness for argument to function
            assume $IsAlloc(##ts#0, TSeq(Utils._default.MaxF$T), $Heap);
            ##default#0 := default#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##default#0, TInt, $Heap);
            assert {:id "id40"} {:subsumption 0} (forall t#15: Box :: 
              { Requires1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, t#15) } 
                { Seq#Contains(##ts#0, t#15) } 
              $IsBox(t#15, Utils._default.MaxF$T) && Seq#Contains(##ts#0, t#15)
                 ==> Requires1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, t#15));
            assume (forall t#15: Box :: 
              { Requires1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, t#15) } 
                { Seq#Contains(##ts#0, t#15) } 
              $IsBox(t#15, Utils._default.MaxF$T) && Seq#Contains(##ts#0, t#15)
                 ==> Requires1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, t#15));
            assert {:id "id41"} {:subsumption 0} (forall t#16: Box :: 
              { $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, t#16)): int } 
                { Seq#Contains(##ts#0, t#16) } 
              $IsBox(t#16, Utils._default.MaxF$T) && Seq#Contains(##ts#0, t#16)
                 ==> ##default#0
                   <= $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, t#16)): int);
            assume (forall t#16: Box :: 
              { $Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, t#16)): int } 
                { Seq#Contains(##ts#0, t#16) } 
              $IsBox(t#16, Utils._default.MaxF$T) && Seq#Contains(##ts#0, t#16)
                 ==> ##default#0
            ...
            b$reqreads#4 := (forall $o: ref, $f: Field :: 
              $o != null
                   && $Unbox(read($Heap, $o, alloc)): bool
                   && (exists t#17: Box, o#3: ref :: 
                    { Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, t#17), $Box(o#3)) } 
                    $IsBox(t#17, Utils._default.MaxF$T)
                       && $Is(o#3, Tclass._System.object?())
                       && 
                      Seq#Contains(##ts#0, t#17)
                       && Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, t#17), $Box(o#3))
                       && $Box($o) == $Box(o#3))
                 ==> $_ReadsFrame[$o, $f]);
            assert {:id "id42"} 0 <= default#0
               || (Set#Subset(Set#FromBoogieMap((lambda $y#0: Box :: 
                      (exists t#18: Box, o#4: ref :: 
                        { Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, t#18), $Box(o#4)) } 
                        $IsBox(t#18, Utils._default.MaxF$T)
                           && $Is(o#4, Tclass._System.object?())
                           && 
                          Seq#Contains(##ts#0, t#18)
                           && Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, t#18), $Box(o#4))
                           && $y#0 == $Box(o#4)))), 
                  Set#FromBoogieMap((lambda $y#1: Box :: 
                      (exists t#19: Box, o#5: ref :: 
                        { Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#19), $Box(o#5)) } 
                        $IsBox(t#19, Utils._default.MaxF$T)
                           && $Is(o#5, Tclass._System.object?())
                           && 
                          Seq#Contains(ts#0, t#19)
                           && Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#19), $Box(o#5))
                           && $y#1 == $Box(o#5)))))
                 && !Set#Subset(Set#FromBoogieMap((lambda $y#1: Box :: 
                      (exists t#19: Box, o#5: ref :: 
                        { Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, f#0, t#19), $Box(o#5)) } 
                        $IsBox(t#19, Utils._default.MaxF$T)
                           && $Is(o#5, Tclass._System.object?())
                      ...
                      (exists t#18: Box, o#4: ref :: 
                        ...
                        $IsBox(t#18, Utils._default.MaxF$T)
                          ...
                          Seq#Contains(##ts#0, t#18)
                           && Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, t#18), $Box(o#4))
                           && $y#0 == $Box(o#4))))))
               || Seq#Rank(##ts#0) < Seq#Rank(ts#0)
               || ##default#0 == default#0;
            assert {:id "id43"} (Set#Subset(Set#FromBoogieMap((lambda $y#0: Box :: 
                      (exists t#18: Box, o#4: ref :: 
                        { Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, t#18), $Box(o#4)) } 
                        $IsBox(t#18, Utils._default.MaxF$T)
                           && $Is(o#4, Tclass._System.object?())
                      ...
                      (exists t#18: Box, o#4: ref :: 
                        ...
                        $IsBox(t#18, Utils._default.MaxF$T)
                          ...
                          Seq#Contains(##ts#0, t#18)
                           && Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, t#18), $Box(o#4))
                           && $y#0 == $Box(o#4))))))
               || (Set#Equal(Set#FromBoogieMap((lambda $y#0: Box :: 
                      (exists t#18: Box, o#4: ref :: 
                        { Set#IsMember(Reads1(Utils._default.MaxF$T, TInt, $Heap, ##f#0, t#18), $Box(o#4)) } 
                        $IsBox(t#18, Utils._default.MaxF$T)
                           && $Is(o#4, Tclass._System.object?())
                      ...
                      (exists t#19: Box, o#5: ref :: 
                        ...
                        $IsBox(t#19, Utils._default.MaxF$T)
                          ...
                          Seq#Contains(ts#0, t#19)
                           ...
                           && $y#1 == $Box(o#5)))))
                 && (Seq#Rank(##ts#0) < Seq#Rank(ts#0)
                   || (Seq#Rank(##ts#0) == Seq#Rank(ts#0) && ##default#0 < default#0)));
            assume Utils.__default.MaxF#canCall(Utils._default.MaxF$T, $Heap, f#0, Seq#Drop(ts#0, LitInt(1)), default#0);
            ##y#0 := Utils.__default.MaxF(Utils._default.MaxF$T, 
              $LS($LZ), 
              reveal_Utils._default.MaxF, 
              $Heap, 
              f#0, 
            ...
            assume Utils.__default.Max#canCall($Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, Seq#Index(ts#0, LitInt(0)))): int, 
              Utils.__default.MaxF(Utils._default.MaxF$T, 
                $LS($LZ), 
                reveal_Utils._default.MaxF, 
                $Heap, 
                ...
                Seq#Drop(ts#0, LitInt(1)), 
                default#0));
            assume {:id "id44"} Utils.__default.MaxF(Utils._default.MaxF$T, 
                $LS($LZ), 
                reveal_Utils._default.MaxF, 
                $Heap, 
                f#0, 
                ts#0, 
                default#0)
               == Utils.__default.Max($Unbox(Apply1(Utils._default.MaxF$T, TInt, $Heap, f#0, Seq#Index(ts#0, LitInt(0)))): int, 
                Utils.__default.MaxF(Utils._default.MaxF$T, 
                  $LS($LZ), 
                  reveal_Utils._default.MaxF, 
                  $Heap, 
            ...
            assume $Is(Utils.__default.MaxF(Utils._default.MaxF$T, 
                ...
                default#0), 
              TInt);
            assume {:id "id45"} Utils.__default.MaxF(Utils._default.MaxF$T, 
                $LS($LZ), 
                reveal_Utils._default.MaxF, 
                $Heap, 
                f#0, 
...
procedure {:verboseName "Utils.reveal_MaxF (well-formedness)"} {:verify false} CheckWellFormed$$Utils.__default.reveal__MaxF();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Utils.reveal_MaxF (call)"} {:verify false} Call$$Utils.__default.reveal__MaxF();
  modifies $Heap;
  // frame condition
  free ensures old($Heap) == $Heap;
  free ensures reveal_Utils._default.MaxF;
...
axiom {:id "id48"} 0 <= $FunctionContextHeight
   ==> (forall Utils.Result$T: Ty, this: DatatypeType :: 
    { Utils.Result.IsFailure(Utils.Result$T, this) } 
    Utils.Result.IsFailure#canCall(Utils.Result$T, this)
         || (0 < $FunctionContextHeight && $Is(this, Tclass.Utils.Result(Utils.Result$T)))
...
procedure {:verboseName "Utils.Result.IsFailure (well-formedness)"} CheckWellformed$$Utils.Result.IsFailure(Utils.Result$T: Ty, 
    this: DatatypeType
       where $Is(this, Tclass.Utils.Result(Utils.Result$T))
...
axiom 1 <= $FunctionContextHeight
   ==> (forall Utils.Result$T: Ty, Utils.Result.PropagateFailure$U: Ty, this: DatatypeType :: 
...
axiom {:id "id51"} 1 <= $FunctionContextHeight
   ==> (forall Utils.Result$T: Ty, Utils.Result.PropagateFailure$U: Ty, this: DatatypeType :: 
    { Utils.Result.PropagateFailure(Utils.Result$T, Utils.Result.PropagateFailure$U, this) } 
    Utils.Result.PropagateFailure#canCall(Utils.Result$T, Utils.Result.PropagateFailure$U, this)
         || (1 < $FunctionContextHeight
...
procedure {:verboseName "Utils.Result.PropagateFailure (well-formedness)"} CheckWellformed$$Utils.Result.PropagateFailure(Utils.Result$T: Ty, 
    Utils.Result.PropagateFailure$U: Ty, 
    this: DatatypeType
       where $Is(this, Tclass.Utils.Result(Utils.Result$T))
         && $IsAlloc(this, Tclass.Utils.Result(Utils.Result$T), $Heap));
...
axiom 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, Utils.Result$T: Ty, this: DatatypeType :: 
...
procedure {:verboseName "Utils.Result.Extract (well-formedness)"} CheckWellformed$$Utils.Result.Extract(Utils.Result$T: Ty, 
    this: DatatypeType
       where $Is(this, Tclass.Utils.Result(Utils.Result$T))
         && $IsAlloc(this, Tclass.Utils.Result(Utils.Result$T), $Heap));
  free requires 0 == $FunctionContextHeight;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Utils.Result.Extract (well-formedness)"} CheckWellformed$$Utils.Result.Extract(Utils.Result$T: Ty, this: DatatypeType)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    // Check well-formedness of preconditions, and then assume them
    assume {:id "id57"} Utils.Result.Success_q(this);
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    {
        // Check well-formedness of postcondition and assume false
        assume $IsBox(Utils.Result.Extract(Utils.Result$T, this), Utils.Result$T);
        assume false;
    }
    else
    {
        // Check well-formedness of body and result subset type constraint
        assert {:id "id58"} Utils.Result.Success_q(this);
        assume {:id "id59"} Utils.Result.Extract(Utils.Result$T, this) == Utils.Result.value(this);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $IsBox(Utils.Result.Extract(Utils.Result$T, this), Utils.Result$T);
        return;
