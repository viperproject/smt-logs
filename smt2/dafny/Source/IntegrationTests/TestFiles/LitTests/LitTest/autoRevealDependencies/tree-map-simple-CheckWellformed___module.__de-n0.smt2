...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.ListData$_T0@@1 T@U) ($ly@@1 T@U) (|xs#0@@1| T@U) ) (!  (=> (or (|_module.__default.ListData#canCall| _module._default.ListData$_T0@@1 (Lit DatatypeTypeType |xs#0@@1|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@1| (Tclass._module.List _module._default.ListData$_T0@@1)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@1|)))))) (let ((|xs#4| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@1|)))))
(|_module.__default.ListData#canCall| _module._default.ListData$_T0@@1 |xs#4|))) (= (_module.__default.ListData _module._default.ListData$_T0@@1 ($LS $ly@@1) (Lit DatatypeTypeType |xs#0@@1|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@1|)) |Set#Empty| (let ((|xs#3| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@1|)))))
(let ((|x#3| (Lit BoxType (_module.List.head (Lit DatatypeTypeType |xs#0@@1|)))))
(|Set#Union| (|Set#UnionOne| |Set#Empty| |x#3|) (_module.__default.ListData _module._default.ListData$_T0@@1 ($LS $ly@@1) |xs#3|))))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |542|
 :pattern ( (_module.__default.ListData _module._default.ListData$_T0@@1 ($LS $ly@@1) (Lit DatatypeTypeType |xs#0@@1|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.ListData$_T0@@2 T@U) ($ly@@2 T@U) (|xs#0@@2| T@U) ) (!  (=> (or (|_module.__default.ListData#canCall| _module._default.ListData$_T0@@2 |xs#0@@2|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@2| (Tclass._module.List _module._default.ListData$_T0@@2)))) (and (forall ((|x#0| T@U) ) (!  (=> ($IsBox |x#0| _module._default.ListData$_T0@@2) (=> (|Set#IsMember| (_module.__default.ListData _module._default.ListData$_T0@@2 $ly@@2 |xs#0@@2|) |x#0|) (< (BoxRank |x#0|) (DtRank |xs#0@@2|))))
 :qid |treemapsimpledfy.13:18|
 :skolemid |537|
 :pattern ( (|Set#IsMember| (_module.__default.ListData _module._default.ListData$_T0@@2 $ly@@2 |xs#0@@2|) |x#0|))
)) ($Is SetType (_module.__default.ListData _module._default.ListData$_T0@@2 $ly@@2 |xs#0@@2|) (TSet _module._default.ListData$_T0@@2))))
 :qid |unknown.0:0|
 :skolemid |538|
 :pattern ( (_module.__default.ListData _module._default.ListData$_T0@@2 $ly@@2 |xs#0@@2|))
))))
...
(assert (forall ((a@@12 T@U) (b@@9 T@U) ) (!  (=> (and (_module.List.Nil_q a@@12) (_module.List.Nil_q b@@9)) (|_module.List#Equal| a@@12 b@@9))
 :qid |unknown.0:0|
 :skolemid |649|
 :pattern ( (|_module.List#Equal| a@@12 b@@9) (_module.List.Nil_q a@@12))
 :pattern ( (|_module.List#Equal| a@@12 b@@9) (_module.List.Nil_q b@@9))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.ListData$_T0@@3 T@U) ($ly@@3 T@U) (|xs#0@@3| T@U) ) (!  (=> (and (or (|_module.__default.ListData#canCall| _module._default.ListData$_T0@@3 |xs#0@@3|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@3| (Tclass._module.List _module._default.ListData$_T0@@3)) ($IsAlloc DatatypeTypeType |xs#0@@3| (Tclass._module.List _module._default.ListData$_T0@@3) $Heap)))) ($IsGoodHeap $Heap)) ($IsAlloc SetType (_module.__default.ListData _module._default.ListData$_T0@@3 $ly@@3 |xs#0@@3|) (TSet _module._default.ListData$_T0@@3) $Heap))
 :qid |treemapsimpledfy.12:16|
 :skolemid |539|
 :pattern ( ($IsAlloc SetType (_module.__default.ListData _module._default.ListData$_T0@@3 $ly@@3 |xs#0@@3|) (TSet _module._default.ListData$_T0@@3) $Heap))
))))
...
(assert (forall ((_module.List$A@@6 T@U) (bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 (Tclass._module.List _module.List$A@@6)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@2)) bx@@2) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@2) (Tclass._module.List _module.List$A@@6))))
 :qid |unknown.0:0|
 :skolemid |536|
 :pattern ( ($IsBox bx@@2 (Tclass._module.List _module.List$A@@6)))
)))
...
(assert (forall ((_module.List$A@@8 T@U) (|a#6#0#0@@0| T@U) (|a#6#1#0@@0| T@U) ($h@@2 T@U) ) (!  (=> ($IsGoodHeap $h@@2) (= ($IsAlloc DatatypeTypeType (|#_module.List.Cons| |a#6#0#0@@0| |a#6#1#0@@0|) (Tclass._module.List _module.List$A@@8) $h@@2)  (and ($IsAllocBox |a#6#0#0@@0| _module.List$A@@8 $h@@2) ($IsAlloc DatatypeTypeType |a#6#1#0@@0| (Tclass._module.List _module.List$A@@8) $h@@2))))
 :qid |unknown.0:0|
 :skolemid |639|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.List.Cons| |a#6#0#0@@0| |a#6#1#0@@0|) (Tclass._module.List _module.List$A@@8) $h@@2))
)))
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(declare-fun _module._default.ListData$_T0@@4 () T@U)
(declare-fun $LZ () T@U)
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.ListData)
...
(let ((anon12_Else_correct  (=> (and (=> (|Set#IsMember| (_module.__default.ListData _module._default.ListData$_T0@@4 ($LS $LZ) |xs#0@@4|) |x#6@0|) (< (BoxRank |x#6@0|) (DtRank |xs#0@@4|))) (= (ControlFlow 0 11) 8)) anon5_correct)))
(let ((anon12_Then_correct  (=> ($IsAlloc DatatypeTypeType |xs#0@@4| (Tclass._module.List _module._default.ListData$_T0@@4) $Heap@@0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (|_module.List#Equal| |xs#0@@4| |xs#0@@4|) (< (DtRank |xs#0@@4|) (DtRank |xs#0@@4|)))) (=> (or (|_module.List#Equal| |xs#0@@4| |xs#0@@4|) (< (DtRank |xs#0@@4|) (DtRank |xs#0@@4|))) (=> (and (and (or (|_module.List#Equal| |xs#0@@4| |xs#0@@4|) (|_module.__default.ListData#canCall| _module._default.ListData$_T0@@4 |xs#0@@4|)) (|Set#IsMember| (_module.__default.ListData _module._default.ListData$_T0@@4 ($LS $LZ) |xs#0@@4|) |x#6@0|)) (and (< (BoxRank |x#6@0|) (DtRank |xs#0@@4|)) (= (ControlFlow 0 9) 8))) anon5_correct))))))
(let ((anon11_Then_correct  (=> ($Is SetType (_module.__default.ListData _module._default.ListData$_T0@@4 ($LS $LZ) |xs#0@@4|) (TSet _module._default.ListData$_T0@@4)) (=> (and ($IsBox |x#6@0| _module._default.ListData$_T0@@4) ($IsAllocBox |x#6@0| _module._default.ListData$_T0@@4 $Heap@@0)) (and (=> (= (ControlFlow 0 12) 9) anon12_Then_correct) (=> (= (ControlFlow 0 12) 11) anon12_Else_correct))))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((|x#5| T@U) ) (!  (=> ($IsBox |x#5| _module._default.ListData$_T0@@4) (=> (|Set#IsMember| (_module.__default.ListData _module._default.ListData$_T0@@4 ($LS ($LS $LZ)) |xs#0@@4|) |x#5|) (< (BoxRank |x#5|) (DtRank |xs#0@@4|))))
 :qid |treemapsimpledfy.13:18|
 :skolemid |543|
 :pattern ( (|Set#IsMember| (_module.__default.ListData _module._default.ListData$_T0@@4 ($LS ($LS $LZ)) |xs#0@@4|) |x#5|))
)))))
(let ((anon14_Then_correct  (=> (and (= |xs#0@@4| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) ($IsBox |_mcc#0#0| _module._default.ListData$_T0@@4)) (=> (and (and (and ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List _module._default.ListData$_T0@@4)) (= |let#0#0#0| |_mcc#1#0|)) (and ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List _module._default.ListData$_T0@@4)) (= |xs#Z#0@0| |let#0#0#0|))) (and (and (= |let#1#0#0| |_mcc#0#0|) ($IsBox |let#1#0#0| _module._default.ListData$_T0@@4)) (and (= |x#Z#0@0| |let#1#0#0|) ($IsAlloc DatatypeTypeType |xs#Z#0@0| (Tclass._module.List _module._default.ListData$_T0@@4) $Heap@@0)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< (DtRank |xs#Z#0@0|) (DtRank |xs#0@@4|))) (=> (< (DtRank |xs#Z#0@0|) (DtRank |xs#0@@4|)) (=> (|_module.__default.ListData#canCall| _module._default.ListData$_T0@@4 |xs#Z#0@0|) (=> (and (and (= (_module.__default.ListData _module._default.ListData$_T0@@4 ($LS $LZ) |xs#0@@4|) (|Set#Union| (|Set#UnionOne| |Set#Empty| |x#Z#0@0|) (_module.__default.ListData _module._default.ListData$_T0@@4 ($LS $LZ) |xs#Z#0@0|))) (|_module.__default.ListData#canCall| _module._default.ListData$_T0@@4 |xs#Z#0@0|)) (and ($Is SetType (_module.__default.ListData _module._default.ListData$_T0@@4 ($LS $LZ) |xs#0@@4|) (TSet _module._default.ListData$_T0@@4)) (= (ControlFlow 0 5) 3))) GeneratedUnifiedExit_correct))))))))
(let ((anon13_Then_correct  (=> (and (and (= |xs#0@@4| |#_module.List.Nil|) (= (_module.__default.ListData _module._default.ListData$_T0@@4 ($LS $LZ) |xs#0@@4|) (Lit SetType |Set#Empty|))) (and ($Is SetType (_module.__default.ListData _module._default.ListData$_T0@@4 ($LS $LZ) |xs#0@@4|) (TSet _module._default.ListData$_T0@@4)) (= (ControlFlow 0 4) 3))) GeneratedUnifiedExit_correct)))
(let ((anon14_Else_correct true))
(let ((anon13_Else_correct  (=> (or (not (= |xs#0@@4| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 7) 5) anon14_Then_correct) (=> (= (ControlFlow 0 7) 1) anon14_Else_correct)))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (and (and (=> (= (ControlFlow 0 13) 12) anon11_Then_correct) (=> (= (ControlFlow 0 13) 4) anon13_Then_correct)) (=> (= (ControlFlow 0 13) 7) anon13_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) ($Is DatatypeTypeType |xs#0@@4| (Tclass._module.List _module._default.ListData$_T0@@4))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct)))
