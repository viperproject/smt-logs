...
(let ((anon4_correct  (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 10)) (and (|Set#IsMember| |s#0| ($Box intType (int_2_U |i#0@0|))) (= (ControlFlow 0 3) 1))) anon6_correct)))
(let ((anon8_Else_correct  (=> (and (< |i#0@0| (LitInt 0)) (= (ControlFlow 0 6) 3)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (<= (LitInt 0) |i#0@0|) (= |newtype$check#1@0| (LitInt 10))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 4294967296))) (=> (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 4294967296)) (=> (= (ControlFlow 0 4) 3) anon4_correct))))))
(let ((anon7_Then_correct  (=> (= |newtype$check#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 4294967296))) (=> (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 4294967296)) (and (=> (= (ControlFlow 0 7) 4) anon8_Then_correct) (=> (= (ControlFlow 0 7) 6) anon8_Else_correct)))))))
(let ((anon7_Else_correct  (=> (and (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 10)) (|Set#IsMember| |s#0| ($Box intType (int_2_U |i#0@0|)))) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 4294967296)) (and (=> (= (ControlFlow 0 9) 7) anon7_Then_correct) (=> (= (ControlFlow 0 9) 2) anon7_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SetType |s#0| (TSet Tclass._module.uint32)) ($IsAlloc SetType |s#0| (TSet Tclass._module.uint32) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct))))
