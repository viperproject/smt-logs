...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 10) (- 0 12)) (<= (LitInt 0) |n#0@3|)) (=> (<= (LitInt 0) |n#0@3|) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= |n#0@3| |len#0|)) (=> (<= |n#0@3| |len#0|) (=> (= (ControlFlow 0 10) (- 0 9)) (or (= |n#0@3| |len#0|) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |n#0@3|)))) |key#0|)))))))))
(let ((anon13_Then_correct  (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |n#0@1|)))) |key#0|) (=> (and (= |n#0@3| |n#0@1|) (= (ControlFlow 0 14) 10)) GeneratedUnifiedExit_correct))))
(let ((anon12_Then_correct  (=> (<= |len#0| |n#0@1|) (=> (and (= |n#0@3| |n#0@1|) (= (ControlFlow 0 13) 10)) GeneratedUnifiedExit_correct))))
(let ((anon13_Else_correct  (=> (and (or (not (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |n#0@1|)))) |key#0|)) (not true)) (= |newtype$check#0_0@1| (LitInt 1))) (and (=> (= (ControlFlow 0 4) (- 0 8)) (and (<= (LitInt 0) |newtype$check#0_0@1|) (< |newtype$check#0_0@1| 4294967296))) (=> (and (<= (LitInt 0) |newtype$check#0_0@1|) (< |newtype$check#0_0@1| 4294967296)) (=> (= |newtype$check#0_1@1| (+ |n#0@1| 1)) (and (=> (= (ControlFlow 0 4) (- 0 7)) (and (<= (LitInt 0) |newtype$check#0_1@1|) (< |newtype$check#0_1@1| 4294967296))) (=> (and (<= (LitInt 0) |newtype$check#0_1@1|) (< |newtype$check#0_1@1| 4294967296)) (=> (= |n#0@2| (+ |n#0@1| 1)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (or (<= 0 |$decr$loop#00@1|) (= (- |len#0| |n#0@2|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- |len#0| |n#0@2|) |$decr$loop#00@1|)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< (- |len#0| |n#0@2|) |$decr$loop#00@1|)) (=> (< (- |len#0| |n#0@2|) |$decr$loop#00@1|) (=> (= (ControlFlow 0 4) (- 0 3)) (=> |$w$loop#0@0| (<= |n#0@2| |len#0|))))))))))))))))
(let ((anon12_Else_correct  (=> (and (< |n#0@1| |len#0|) (= |$decr$loop#00@1| (- |len#0| |n#0@1|))) (and (=> (= (ControlFlow 0 15) (- 0 17)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (and (<= 0 |n#0@1|) (< |n#0@1| (_System.array.Length |a#0|)))) (=> (and (<= 0 |n#0@1|) (< |n#0@1| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 15) 14) anon13_Then_correct) (=> (= (ControlFlow 0 15) 4) anon13_Else_correct)))))))))
(let ((anon11_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 18) 13) anon12_Then_correct) (=> (= (ControlFlow 0 18) 15) anon12_Else_correct)))))
(let ((anon11_Then_correct true))
(let ((anon10_LoopBody_correct  (and (=> (= (ControlFlow 0 19) 2) anon11_Then_correct) (=> (= (ControlFlow 0 19) 18) anon11_Else_correct))))
(let ((anon10_LoopDone_correct true))
(let ((anon10_LoopHead_correct  (=> (and (<= (LitInt 0) |n#0@1|) (< |n#0@1| 4294967296)) (=> (and (and (and (and (<= 0 |n#0@1|) (not false)) (= |newtype$check#1@0| 0)) (=> |$w$loop#0@0| (<= |n#0@1| |len#0|))) (and (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6)))
 :qid |arraysdfy.29:3|
 :skolemid |489|
...
)) (<= (- |len#0| |n#0@1|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 20) 1) anon10_LoopDone_correct) (=> (= (ControlFlow 0 20) 19) anon10_LoopBody_correct))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |newtype$check#1@0| (LitInt 0))) (and (=> (= (ControlFlow 0 21) (- 0 23)) (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 4294967296))) (=> (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 4294967296)) (=> (and (= |n#0@0| (LitInt 0)) (= |$decr_init$loop#00@0| (- |len#0| |n#0@0|))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (=> |$w$loop#0@0| (<= |n#0@0| |len#0|))) (=> (=> |$w$loop#0@0| (<= |n#0@0| |len#0|)) (=> (= (ControlFlow 0 21) 20) anon10_LoopHead_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |a#0| (Tclass._System.array Tclass._module.uint32)) ($IsAlloc refType |a#0| (Tclass._System.array Tclass._module.uint32) $Heap))) (and (and (<= (LitInt 0) |len#0|) (< |len#0| 4294967296)) (and (<= (LitInt 0) |key#0|) (< |key#0| 4294967296)))) (and (and (and (<= (LitInt 0) |n#0|) (< |n#0| 4294967296)) (= 1 $FunctionContextHeight)) (and (= (_System.array.Length |a#0|) |len#0|) (= (ControlFlow 0 24) 21)))) anon0_correct)))
