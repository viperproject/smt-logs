...
(declare-fun |$IsA#_module.Example1| (T@U) Bool)
...
(assert (forall ((d T@U) ) (!  (=> (|$IsA#_module.Example1| d) (_module.Example1.Example1_q d))
 :qid |unknown.0:0|
 :skolemid |577|
 :pattern ( (|$IsA#_module.Example1| d))
)))
(assert (= (Ctor DatatypeTypeType) 3))
(assert (forall ((d@@0 T@U) ) (!  (=> ($Is DatatypeTypeType d@@0 Tclass._module.Example1) (_module.Example1.Example1_q d@@0))
 :qid |unknown.0:0|
 :skolemid |578|
 :pattern ( (_module.Example1.Example1_q d@@0) ($Is DatatypeTypeType d@@0 Tclass._module.Example1))
)))
...
(assert (forall ((d@@2 T@U) ) (!  (=> (_module.Example1.Example1_q d@@2) (exists ((|a#10#0#0| Int) (|a#10#1#0| Bool) ) (! (= d@@2 (|#_module.Example1.Example1| |a#10#0#0| |a#10#1#0|))
 :qid |datatypesdfy.9:30|
 :skolemid |568|
)))
 :qid |unknown.0:0|
 :skolemid |569|
 :pattern ( (_module.Example1.Example1_q d@@2))
)))
...
(assert (forall ((d@@3 T@U) ($h@@0 T@U) ) (!  (=> (and ($IsGoodHeap $h@@0) (and (_module.Example1.Example1_q d@@3) ($IsAlloc DatatypeTypeType d@@3 Tclass._module.Example1 $h@@0))) ($IsAlloc boolType (bool_2_U (_module.Example1.b d@@3)) TBool $h@@0))
 :qid |unknown.0:0|
 :skolemid |572|
 :pattern ( ($IsAlloc boolType (bool_2_U (_module.Example1.b d@@3)) TBool $h@@0))
)))
(assert (forall ((d@@4 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) ($Is DatatypeTypeType d@@4 Tclass._module.Example1)) ($IsAlloc DatatypeTypeType d@@4 Tclass._module.Example1 $h@@1))
 :qid |unknown.0:0|
 :skolemid |576|
 :pattern ( ($IsAlloc DatatypeTypeType d@@4 Tclass._module.Example1 $h@@1))
)))
...
(assert (forall ((d@@5 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (_module.Example1.Example1_q d@@5) ($IsAlloc DatatypeTypeType d@@5 Tclass._module.Example1 $h@@2))) ($IsAlloc intType (int_2_U (_module.Example1.u d@@5)) Tclass._module.uint32 $h@@2))
 :qid |unknown.0:0|
 :skolemid |571|
 :pattern ( ($IsAlloc intType (int_2_U (_module.Example1.u d@@5)) Tclass._module.uint32 $h@@2))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.DtUpdate)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |let#0#0#0| |e#0|)) (=> (and (and ($Is DatatypeTypeType |let#0#0#0| Tclass._module.Example1) (= |dt_update_tmp#0#Z#0@0| |let#0#0#0|)) (and (= |newtype$check#0@0| (LitInt 0)) (= (ControlFlow 0 2) (- 0 1)))) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 4294967296))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |e#0| Tclass._module.Example1) ($IsAlloc DatatypeTypeType |e#0| Tclass._module.Example1 $Heap)) (|$IsA#_module.Example1| |e#0|)) (=> (and (and (and ($Is DatatypeTypeType |x#0| Tclass._module.Example1) ($IsAlloc DatatypeTypeType |x#0| Tclass._module.Example1 $Heap)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct)))))
