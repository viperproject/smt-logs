...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (and (<= (LitInt 0) |x#0@@2|) (< |x#0@@2| 18446744073709551616))) (=> (and (<= (LitInt 0) |x#0@@2|) (< |x#0@@2| 18446744073709551616)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (and (<= (LitInt 0) |x#0@@2|) (< |x#0@@2| 18446744073709551616))) (=> (and (<= (LitInt 0) |x#0@@2|) (< |x#0@@2| 18446744073709551616)) (=> (= |newtype$check#2@0| (LitInt 1)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= (LitInt 0) |newtype$check#2@0|) (< |newtype$check#2@0| 18446744073709551616))) (=> (and (<= (LitInt 0) |newtype$check#2@0|) (< |newtype$check#2@0| 18446744073709551616)) (=> (and (= |newtype$check#3@0| (+ |x#0@@2| 1)) (= (ControlFlow 0 3) (- 0 2))) (and (<= (LitInt 0) |newtype$check#3@0|) (< |newtype$check#3@0| 18446744073709551616))))))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (<= (LitInt 0) |x#0@@2|) (< |x#0@@2| 4294967296)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
