...
(set-info :boogie-vc-id Impl$$_module.__default.BoundedLength)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |newtype$check#0@0| (|Seq#Length| |s#0|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 4294967296))) (=> (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 4294967296)) (=> (and (= |newtype$check#1@0| (|Seq#Length| |s#0|)) (= (ControlFlow 0 2) (- 0 1))) (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 4294967296))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SeqType |s#0| (TSeq Tclass._module.uint8)) ($IsAlloc SeqType |s#0| (TSeq Tclass._module.uint8) $Heap))) (=> (and (and (and (and (<= (LitInt 0) |x#0|) (< |x#0| 4294967296)) true) (= 1 $FunctionContextHeight)) (and (< (|Seq#Length| |s#0|) 10) (= (ControlFlow 0 4) 2))) anon0_correct))))
