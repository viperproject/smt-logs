...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((Test._default.Seqs$T T@U) (|s#0| T@U) (|x#0| Int) (|default_val#0| T@U) ) (!  (=> (or (|Test.__default.Seqs#canCall| Test._default.Seqs$T |s#0| |x#0| |default_val#0|) (and (< 1 $FunctionContextHeight) (and (and (and ($Is SeqType |s#0| (TSeq Test._default.Seqs$T)) (and (<= (LitInt 0) |x#0|) (< |x#0| 4294967296))) ($IsBox |default_val#0| Test._default.Seqs$T)) (< (|Seq#Length| |s#0|) 1000)))) ($IsBox (Test.__default.Seqs Test._default.Seqs$T |s#0| |x#0| |default_val#0|) Test._default.Seqs$T))
 :pattern ( (Test.__default.Seqs Test._default.Seqs$T |s#0| |x#0| |default_val#0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((Test._default.Seqs$T@@1 T@U) (|s#0@@1| T@U) (|x#0@@1| Int) (|default_val#0@@1| T@U) ) (!  (=> (or (|Test.__default.Seqs#canCall| Test._default.Seqs$T@@1 (Lit SeqType |s#0@@1|) (LitInt |x#0@@1|) |default_val#0@@1|) (and (< 1 $FunctionContextHeight) (and (and (and ($Is SeqType |s#0@@1| (TSeq Test._default.Seqs$T@@1)) (and (<= (LitInt 0) |x#0@@1|) (< |x#0@@1| 4294967296))) ($IsBox |default_val#0@@1| Test._default.Seqs$T@@1)) (< (|Seq#Length| (Lit SeqType |s#0@@1|)) 1000)))) (= (Test.__default.Seqs Test._default.Seqs$T@@1 (Lit SeqType |s#0@@1|) (LitInt |x#0@@1|) |default_val#0@@1|) (ite (> (|Seq#Length| (Lit SeqType |s#0@@1|)) |x#0@@1|) (|Seq#Index| (Lit SeqType |s#0@@1|) (LitInt |x#0@@1|)) |default_val#0@@1|)))
 :weight 3
 :pattern ( (Test.__default.Seqs Test._default.Seqs$T@@1 (Lit SeqType |s#0@@1|) (LitInt |x#0@@1|) |default_val#0@@1|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((Test._default.Seqs$T@@2 T@U) (|s#0@@2| T@U) (|x#0@@2| Int) (|default_val#0@@2| T@U) ) (!  (=> (or (|Test.__default.Seqs#canCall| Test._default.Seqs$T@@2 (Lit SeqType |s#0@@2|) (LitInt |x#0@@2|) (Lit BoxType |default_val#0@@2|)) (and (< 1 $FunctionContextHeight) (and (and (and ($Is SeqType |s#0@@2| (TSeq Test._default.Seqs$T@@2)) (and (<= (LitInt 0) |x#0@@2|) (< |x#0@@2| 4294967296))) ($IsBox |default_val#0@@2| Test._default.Seqs$T@@2)) (< (|Seq#Length| (Lit SeqType |s#0@@2|)) 1000)))) (= (Test.__default.Seqs Test._default.Seqs$T@@2 (Lit SeqType |s#0@@2|) (LitInt |x#0@@2|) (Lit BoxType |default_val#0@@2|)) (ite (> (|Seq#Length| (Lit SeqType |s#0@@2|)) |x#0@@2|) (|Seq#Index| (Lit SeqType |s#0@@2|) (LitInt |x#0@@2|)) |default_val#0@@2|)))
 :weight 3
 :pattern ( (Test.__default.Seqs Test._default.Seqs$T@@2 (Lit SeqType |s#0@@2|) (LitInt |x#0@@2|) (Lit BoxType |default_val#0@@2|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((Test._default.Seqs$T@@3 T@U) (|s#0@@3| T@U) (|x#0@@3| Int) (|default_val#0@@3| T@U) ) (!  (=> (or (|Test.__default.Seqs#canCall| Test._default.Seqs$T@@3 |s#0@@3| |x#0@@3| |default_val#0@@3|) (and (< 1 $FunctionContextHeight) (and (and (and ($Is SeqType |s#0@@3| (TSeq Test._default.Seqs$T@@3)) (and (<= (LitInt 0) |x#0@@3|) (< |x#0@@3| 4294967296))) ($IsBox |default_val#0@@3| Test._default.Seqs$T@@3)) (< (|Seq#Length| |s#0@@3|) 1000)))) (= (Test.__default.Seqs Test._default.Seqs$T@@3 |s#0@@3| |x#0@@3| |default_val#0@@3|) (ite (> (|Seq#Length| |s#0@@3|) |x#0@@3|) (|Seq#Index| |s#0@@3| |x#0@@3|) |default_val#0@@3|)))
