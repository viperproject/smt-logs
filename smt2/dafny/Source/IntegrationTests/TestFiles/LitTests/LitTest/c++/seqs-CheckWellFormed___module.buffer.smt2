...
(declare-fun |a#0| () T@U)
(declare-fun _module.buffer$T () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun $Heap () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id CheckWellFormed$$_module.buffer)
...
(let ((anon9_Else_correct  (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (and (< (_System.array.Length |a#0|) 4294967296) (= (ControlFlow 0 5) 3)) anon5_correct))))))
(let ((anon9_Then_correct  (=> (and (= |a#0| null) (= (ControlFlow 0 4) 3)) anon5_correct)))
(let ((anon8_Then_correct  (=> ($Is refType |a#0| (Tclass._System.array? _module.buffer$T)) (and (=> (= (ControlFlow 0 7) 4) anon9_Then_correct) (=> (= (ControlFlow 0 7) 5) anon9_Else_correct)))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (= null null) (< (_System.array.Length null) 4294967296)))))
