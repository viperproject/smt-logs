...
(set-info :boogie-vc-id CheckWellFormed$$_module.fixed)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon6_Then_correct  (=> (= |newtype$check#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 4294967296))) (=> (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 4294967296)) (=> (= |newtype$check#1@0| (LitInt 0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 4294967296))) (=> (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 4294967296)) (=> (= (ControlFlow 0 3) (- 0 2)) (= (|Seq#Length| (Lit SeqType (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 0)))) ($Box intType (int_2_U (LitInt 0)))))) (LitInt 2)))))))))))
