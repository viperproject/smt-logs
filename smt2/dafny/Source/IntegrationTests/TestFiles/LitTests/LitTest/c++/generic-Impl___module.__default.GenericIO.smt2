...
(declare-fun |a#0| () T@U)
(declare-fun _module._default.GenericIO$A () T@U)
(declare-fun |defass#a'#0| () Bool)
(declare-fun |a'#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.GenericIO)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($IsBox |a#0| _module._default.GenericIO$A) ($IsAllocBox |a#0| _module._default.GenericIO$A $Heap)) (=> |defass#a'#0| (and ($IsBox |a'#0| _module._default.GenericIO$A) ($IsAllocBox |a'#0| _module._default.GenericIO$A $Heap)))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
