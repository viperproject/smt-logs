...
(declare-fun |a#0| () (_ BitVec 64))
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.as__int__as__bv64)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (= |newtype$check#0@0| (nat_from_bv64 |a#0|)) (= (ControlFlow 0 2) (- 0 1)))) (and (<= 0 |newtype$check#0@0|) (< |newtype$check#0@0| 18446744073709551616))))))
