...
(declare-fun _module.MyClass.F (T@U) Int)
...
(assert (distinct alloc Tagclass._module.MyClass Tagclass._module.MyClass? Tagclass._module.uint32 tytagFamily$MyClass tytagFamily$uint32)
)
(assert (= (Ctor refType) 3))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this T@U) ) (!  (=> (or (|_module.MyClass.F#canCall| (Lit refType this)) (and (< 1 $FunctionContextHeight) (and (or (not (= this null)) (not true)) ($Is refType this Tclass._module.MyClass)))) (= (_module.MyClass.F (Lit refType this)) (LitInt 8)))
 :qid |classdfy.25:12|
 :weight 3
 :skolemid |535|
 :pattern ( (_module.MyClass.F (Lit refType this)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@0 T@U) ) (!  (=> (or (|_module.MyClass.F#canCall| this@@0) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass._module.MyClass)))) (and (<= (LitInt 0) (_module.MyClass.F this@@0)) (< (_module.MyClass.F this@@0) 4294967296)))
 :qid |classdfy.25:12|
 :skolemid |532|
 :pattern ( (_module.MyClass.F this@@0))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct  (=> (and (= |newtype$check#0@0| (LitInt 8)) (= (ControlFlow 0 3) (- 0 2))) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 4294967296)))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#2| null $Heap alloc false)) (and (=> (= (ControlFlow 0 4) 1) anon5_Then_correct) (=> (= (ControlFlow 0 4) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.MyClass) ($IsAlloc refType this@@2 Tclass._module.MyClass $Heap))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct))))
