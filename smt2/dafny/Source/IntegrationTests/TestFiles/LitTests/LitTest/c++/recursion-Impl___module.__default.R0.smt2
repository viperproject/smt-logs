...
(set-info :boogie-vc-id Impl$$_module.__default.R0)
...
(let ((anon3_Then_correct  (=> |x#0| (=> (and (= |y##0_0@0| (U_2_bool (Lit boolType (bool_2_U false)))) (= (ControlFlow 0 2) (- 0 1))) (and (not |y##0_0@0|) |x#0|)))))
