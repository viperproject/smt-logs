...
(set-info :boogie-vc-id CheckWellFormed$$_module.Ex1Sub)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon6_Then_correct  (=> (= |newtype$check#1@0| (LitInt 0)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 4294967296))) (=> (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 4294967296)) (=> (and (_module.Example1.Example1_q (Lit DatatypeTypeType (|#_module.Example1.Example1| (LitInt 0) (U_2_bool (Lit boolType (bool_2_U true)))))) (= (ControlFlow 0 4) (- 0 3))) (= (LitInt (_module.Example1.u (Lit DatatypeTypeType (|#_module.Example1.Example1| (LitInt 0) (U_2_bool (Lit boolType (bool_2_U true))))))) (LitInt 0))))))))
(let ((anon5_Then_correct  (=> (and (and ($Is DatatypeTypeType |d#0| Tclass._module.Example1) (_module.Example1.Example1_q |d#0|)) (and (= |newtype$check#0@0| (LitInt 0)) (= (ControlFlow 0 2) (- 0 1)))) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 4294967296)))))
