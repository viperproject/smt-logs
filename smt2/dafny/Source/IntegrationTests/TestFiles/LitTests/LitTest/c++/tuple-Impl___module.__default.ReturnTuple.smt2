...
(set-info :boogie-vc-id Impl$$_module.__default.ReturnTuple)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |newtype$check#0@0| (LitInt 1))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 4294967296))) (=> (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 4294967296)) (=> (and (= |newtype$check#1@0| (LitInt 2)) (= (ControlFlow 0 2) (- 0 1))) (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 4294967296))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |x#0| (Tclass._System.Tuple2 Tclass._module.uint32 Tclass._module.uint32)) ($IsAlloc DatatypeTypeType |x#0| (Tclass._System.Tuple2 Tclass._module.uint32 Tclass._module.uint32) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
