...
(assert (distinct TInt TagInt alloc Tagclass._System.array? Tagclass._System.array Tagclass._module.uint32 tytagFamily$array tytagFamily$uint32)
)
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.returnANonNullArray)
...
)) ($HeapSucc $Heap $Heap@0))) (and (and ($Is refType |a#0@0| (Tclass._System.array? Tclass._module.uint32)) ($IsAlloc refType |a#0@0| (Tclass._System.array? Tclass._module.uint32) $Heap@0)) (and (or (not (= |a#0@0| null)) (not true)) (= (ControlFlow 0 2) (- 0 1))))) (or (not (= |a#0@0| null)) (not true))))))
