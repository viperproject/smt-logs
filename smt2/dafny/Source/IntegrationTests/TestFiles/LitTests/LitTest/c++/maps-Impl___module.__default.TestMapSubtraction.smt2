...
(assert (distinct TChar TagChar TagSet TagSeq TagMap alloc |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass._module.uint32 |tytagFamily$_tuple#2| tytagFamily$uint32)
)
...
(assert (forall ((t@@2 T@U) (u@@0 T@U) ) (! (= (Inv0_TMap (TMap t@@2 u@@0)) t@@2)
 :qid |DafnyPreludebpl.57:15|
 :skolemid |9|
 :pattern ( (TMap t@@2 u@@0))
)))
(assert (forall ((t@@3 T@U) (u@@1 T@U) ) (! (= (Inv1_TMap (TMap t@@3 u@@1)) u@@1)
 :qid |DafnyPreludebpl.58:15|
 :skolemid |10|
 :pattern ( (TMap t@@3 u@@1))
)))
(assert (forall ((t@@4 T@U) (u@@2 T@U) ) (! (= (Tag (TMap t@@4 u@@2)) TagMap)
...
(assert (forall ((v@@6 T@U) (t0@@3 T@U) (t1@@0 T@U) (h@@2 T@U) ) (! (= ($IsAlloc MapType v@@6 (TMap t0@@3 t1@@0) h@@2) (forall ((bx@@4 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@6) bx@@4) (and ($IsAllocBox (MapType0Select BoxType BoxType (|Map#Elements| v@@6) bx@@4) t1@@0 h@@2) ($IsAllocBox bx@@4 t0@@3 h@@2)))
 :qid |DafnyPreludebpl.318:19|
 :skolemid |75|
 :pattern ( (MapType0Select BoxType BoxType (|Map#Elements| v@@6) bx@@4))
 :pattern ( (|Set#IsMember| (|Map#Domain| v@@6) bx@@4))
)))
...
(assert (forall ((bx@@5 T@U) (s@@4 T@U) (t@@9 T@U) ) (!  (=> ($IsBox bx@@5 (TMap s@@4 t@@9)) (and (= ($Box MapType ($Unbox MapType bx@@5)) bx@@5) ($Is MapType ($Unbox MapType bx@@5) (TMap s@@4 t@@9))))
 :qid |DafnyPreludebpl.207:15|
 :skolemid |36|
 :pattern ( ($IsBox bx@@5 (TMap s@@4 t@@9)))
)))
...
(assert (forall ((m@@8 T@U) (v@@8 T@U) ) (! (= (|Set#IsMember| (|Map#Values| m@@8) v@@8) (exists ((u@@4 T@U) ) (!  (and (|Set#IsMember| (|Map#Domain| m@@8) u@@4) (= v@@8 (MapType0Select BoxType BoxType (|Map#Elements| m@@8) u@@4)))
...
(assert (forall ((m@@9 T@U) (u@@5 T@U) (|u'| T@U) (v@@9 T@U) ) (!  (and (=> (= |u'| u@@5) (and (|Set#IsMember| (|Map#Domain| (|Map#Build| m@@9 u@@5 v@@9)) |u'|) (= (MapType0Select BoxType BoxType (|Map#Elements| (|Map#Build| m@@9 u@@5 v@@9)) |u'|) v@@9))) (=> (or (not (= |u'| u@@5)) (not true)) (and (= (|Set#IsMember| (|Map#Domain| (|Map#Build| m@@9 u@@5 v@@9)) |u'|) (|Set#IsMember| (|Map#Domain| m@@9) |u'|)) (= (MapType0Select BoxType BoxType (|Map#Elements| (|Map#Build| m@@9 u@@5 v@@9)) |u'|) (MapType0Select BoxType BoxType (|Map#Elements| m@@9) |u'|)))))
 :qid |DafnyPreludebpl.1463:15|
 :skolemid |290|
 :pattern ( (|Set#IsMember| (|Map#Domain| (|Map#Build| m@@9 u@@5 v@@9)) |u'|))
 :pattern ( (MapType0Select BoxType BoxType (|Map#Elements| (|Map#Build| m@@9 u@@5 v@@9)) |u'|))
)))
...
(assert (forall ((m@@10 T@U) (s@@6 T@U) ) (! (= (|Map#Domain| (|Map#Subtract| m@@10 s@@6)) (|Set#Difference| (|Map#Domain| m@@10) s@@6))
 :qid |DafnyPreludebpl.1486:15|
 :skolemid |295|
 :pattern ( (|Map#Domain| (|Map#Subtract| m@@10 s@@6)))
)))
...
(assert (forall ((v@@10 T@U) (t0@@5 T@U) (t1@@2 T@U) ) (! (= ($Is MapType v@@10 (TMap t0@@5 t1@@2)) (forall ((bx@@9 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@10) bx@@9) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@10) bx@@9) t1@@2) ($IsBox bx@@9 t0@@5)))
...
(assert (forall ((m@@11 T@U) ) (!  (or (= m@@11 |Map#Empty|) (exists ((k@@0 T@U) (v@@13 T@U) ) (! (|Set#IsMember| (|Map#Items| m@@11) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| k@@0 v@@13)))
...
(declare-fun |ages#0| () T@U)
(declare-fun |d#0| () T@U)
(declare-fun |e#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.TestMapSubtraction)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |newtype$check#0@0| (LitInt 66))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 4294967296))) (=> (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 4294967296)) (=> (= |newtype$check#1@0| (LitInt 66)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 4294967296))) (=> (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 4294967296)) (=> (= |newtype$check#2@0| (LitInt 70)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= (LitInt 0) |newtype$check#2@0|) (< |newtype$check#2@0| 4294967296))) (=> (and (<= (LitInt 0) |newtype$check#2@0|) (< |newtype$check#2@0| 4294967296)) (=> (= |newtype$check#3@0| (LitInt 67)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= (LitInt 0) |newtype$check#3@0|) (< |newtype$check#3@0| 4294967296))) (=> (and (<= (LitInt 0) |newtype$check#3@0|) (< |newtype$check#3@0| 4294967296)) (=> (and (= |newtype$check#4@0| (LitInt 52)) (= (ControlFlow 0 2) (- 0 1))) (and (<= (LitInt 0) |newtype$check#4@0|) (< |newtype$check#4@0| 4294967296)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is MapType |ages#0| (TMap (TSeq TChar) Tclass._module.uint32)) ($IsAlloc MapType |ages#0| (TMap (TSeq TChar) Tclass._module.uint32) $Heap)) true) (and (and ($Is MapType |d#0| (TMap (TSeq TChar) Tclass._module.uint32)) ($IsAlloc MapType |d#0| (TMap (TSeq TChar) Tclass._module.uint32) $Heap)) true)) (and (and (and ($Is MapType |e#0| (TMap (TSeq TChar) Tclass._module.uint32)) ($IsAlloc MapType |e#0| (TMap (TSeq TChar) Tclass._module.uint32) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 7) 2)))) anon0_correct))))
