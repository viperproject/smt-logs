...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon7_Else_correct  (=> (or (not (= |n#0@0| |len#0|)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (= (ControlFlow 0 3) (- 0 2)) (and (<= 0 |n#0@0|) (< |n#0@0| (_System.array.Length |a#0|)))))))))
(let ((anon7_Then_correct true))
(let ((anon3_correct  (=> (and (<= (LitInt 0) |n#0@0|) (<= |n#0@0| |len#0|)) (and (=> (= (ControlFlow 0 5) 1) anon7_Then_correct) (=> (= (ControlFlow 0 5) 3) anon7_Else_correct)))))
(let ((anon6_Else_correct  (=> (and (< |n#0@0| (LitInt 0)) (= (ControlFlow 0 7) 5)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (<= (LitInt 0) |n#0@0|) (= (ControlFlow 0 6) 5)) anon3_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (= (_System.array.Length |a#0|) |len#0|) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6)))
 :qid |arraysdfy.23:8|
 :skolemid |486|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6))
)) ($HeapSucc $Heap $Heap@0))) (and (and (<= (LitInt 0) |n#0@0|) (< |n#0@0| 4294967296)) (= |newtype$check#0@0| (LitInt 0)))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 4294967296))) (=> (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 4294967296)) (and (=> (= (ControlFlow 0 8) 6) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |a#0| (Tclass._System.array Tclass._module.uint32)) ($IsAlloc refType |a#0| (Tclass._System.array Tclass._module.uint32) $Heap))) (=> (and (and (and (<= (LitInt 0) |len#0|) (< |len#0| 4294967296)) (and (<= (LitInt 0) |key#0|) (< |key#0| 4294967296))) (and (and (<= (LitInt 0) |n#0|) (< |n#0| 4294967296)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 11) 8)))) anon0_correct))))
