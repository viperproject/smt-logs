...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.PrintArray)
...
(let ((anon5_Else_correct  (=> (and (=> (or (not (= |a#0| null)) (not true)) (= |len#0| (_System.array.Length |a#0|))) (= (ControlFlow 0 4) 1)) anon4_correct)))
(let ((anon5_Then_correct  (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (and (= |len#0| (_System.array.Length |a#0|)) (= (ControlFlow 0 2) 1)) anon4_correct))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |a#0| (Tclass._System.array? _module._default.PrintArray$A)) ($IsAlloc refType |a#0| (Tclass._System.array? _module._default.PrintArray$A) $Heap))) (and (and (<= (LitInt 0) |len#0|) (< |len#0| 4294967296)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 5)))) anon0_correct)))
