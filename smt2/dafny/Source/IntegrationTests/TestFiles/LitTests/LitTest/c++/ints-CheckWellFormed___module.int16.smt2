...
(let ((anon8_Else_correct  (=> (and (< |i#0| (LitInt (- 0 32768))) (= (ControlFlow 0 6) 4)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (<= (LitInt (- 0 32768)) |i#0|) (= (ControlFlow 0 5) 4)) anon4_correct)))
