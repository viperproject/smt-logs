...
(declare-fun |a#0| () T@U)
(declare-fun _module._default.GenericCallee$A () T@U)
(declare-fun |defass#a0#0| () Bool)
(declare-fun |a0#0| () T@U)
(declare-fun |defass#a1#0| () Bool)
(declare-fun |a1#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.GenericCallee)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($IsBox |a#0| _module._default.GenericCallee$A) ($IsAllocBox |a#0| _module._default.GenericCallee$A $Heap))) (and (and (=> |defass#a0#0| (and ($IsBox |a0#0| _module._default.GenericCallee$A) ($IsAllocBox |a0#0| _module._default.GenericCallee$A $Heap))) (=> |defass#a1#0| (and ($IsBox |a1#0| _module._default.GenericCallee$A) ($IsAllocBox |a1#0| _module._default.GenericCallee$A $Heap)))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct)))
