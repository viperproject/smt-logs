...
(set-info :boogie-vc-id Impl$$_module.__default.InSeqNoAutoTriggers)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s#0|)))) (=> (= (ControlFlow 0 2) (- 0 1)) (> (U_2_int ($Unbox intType (|Seq#Index| |s#0| (LitInt 0)))) 0))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SeqType |s#0| (TSeq TInt)) ($IsAlloc SeqType |s#0| (TSeq TInt) $Heap)) (<= (LitInt 0) |i#0|)) (and (and (= 0 $FunctionContextHeight) (forall ((|x#1| T@U) ) (!  (=> (|Seq#Contains| |s#0| ($Box intType |x#1|)) (> (U_2_int |x#1|) 0))
 :qid |sequencess0insdfy.25:19|
 :skolemid |495|
))) (and (> (|Seq#Length| |s#0|) 0) (= (ControlFlow 0 4) 2)))) anon0_correct))))
