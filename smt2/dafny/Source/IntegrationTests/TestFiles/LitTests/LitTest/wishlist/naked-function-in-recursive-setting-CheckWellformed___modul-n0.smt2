...
(declare-fun |_module.__default.fact#Handle| (T@U) T@U)
(declare-fun $Box (T@T T@U) T@U)
(declare-fun Requires1 (T@U T@U T@U T@U T@U) Bool)
(declare-fun |_module.__default.fact#requires| (T@U Int) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly T@U) ($Heap T@U) (|n#0| Int) ) (!  (=> (or (|_module.__default.fact#canCall| |n#0|) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap) (>= |n#0| (LitInt 0))))) (and (=> (or (not (= |n#0| (LitInt 0))) (not true)) (|_module.__default.fact#canCall| (- |n#0| 1))) (= (_module.__default.fact ($LS $ly) |n#0|) (ite (= |n#0| (LitInt 0)) 1 (Mul |n#0| (_module.__default.fact $ly (- |n#0| 1)))))))
 :qid |nakedfunctioninrecursivesettingdfy.4:16|
 :skolemid |483|
 :pattern ( (_module.__default.fact ($LS $ly) |n#0|) ($IsGoodHeap $Heap))
))))
...
(assert (forall (($ly@@0 T@U) ($heap T@U) (|$fh$0x#0| Int) ) (! (= (_module.__default.fact $ly@@0 |$fh$0x#0|) (U_2_int ($Unbox intType (Apply1 TInt TInt $heap (|_module.__default.fact#Handle| $ly@@0) ($Box intType (int_2_U |$fh$0x#0|))))))
 :qid |unknown.0:0|
 :skolemid |489|
 :pattern ( (_module.__default.fact $ly@@0 |$fh$0x#0|) ($IsGoodHeap $heap))
)))
...
(assert (forall (($ly@@1 T@U) ($heap@@0 T@U) (|$fh$0x#0@@0| T@U) ) (! (= (Requires1 TInt TInt $heap@@0 (|_module.__default.fact#Handle| $ly@@1) |$fh$0x#0@@0|) (|_module.__default.fact#requires| $ly@@1 (U_2_int ($Unbox intType |$fh$0x#0@@0|))))
 :qid |unknown.0:0|
 :skolemid |487|
 :pattern ( (Requires1 TInt TInt $heap@@0 (|_module.__default.fact#Handle| $ly@@1) |$fh$0x#0@@0|))
)))
(assert (forall (($ly@@2 T@U) ($Heap@@0 T@U) (|n#0@@0| Int) ) (!  (=> ($IsGoodHeap $Heap@@0) (= (|_module.__default.fact#requires| $ly@@2 |n#0@@0|) (>= |n#0@@0| (LitInt 0))))
 :qid |nakedfunctioninrecursivesettingdfy.4:16|
 :skolemid |482|
 :pattern ( (|_module.__default.fact#requires| $ly@@2 |n#0@@0|) ($IsGoodHeap $Heap@@0))
)))
...
(assert (forall (($ly@@3 T@U) ($heap@@1 T@U) (|$fh$0x#0@@1| T@U) ) (! (= (Apply1 TInt TInt $heap@@1 (|_module.__default.fact#Handle| $ly@@3) |$fh$0x#0@@1|) ($Box intType (int_2_U (_module.__default.fact $ly@@3 (U_2_int ($Unbox intType |$fh$0x#0@@1|))))))
 :qid |unknown.0:0|
 :skolemid |486|
 :pattern ( (Apply1 TInt TInt $heap@@1 (|_module.__default.fact#Handle| $ly@@3) |$fh$0x#0@@1|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@4 T@U) ($Heap@@1 T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.__default.fact#canCall| (LitInt |n#0@@1|)) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@1) (>= (LitInt |n#0@@1|) (LitInt 0))))) (and (=> (or (not (= (LitInt |n#0@@1|) (LitInt 0))) (not true)) (|_module.__default.fact#canCall| (LitInt (- |n#0@@1| 1)))) (= (_module.__default.fact ($LS $ly@@4) (LitInt |n#0@@1|)) (ite (= (LitInt |n#0@@1|) (LitInt 0)) 1 (Mul (LitInt |n#0@@1|) (LitInt (_module.__default.fact ($LS $ly@@4) (LitInt (- |n#0@@1| 1)))))))))
 :qid |nakedfunctioninrecursivesettingdfy.4:16|
 :weight 3
 :skolemid |484|
 :pattern ( (_module.__default.fact ($LS $ly@@4) (LitInt |n#0@@1|)) ($IsGoodHeap $Heap@@1))
))))
...
(assert (forall (($ly@@5 T@U) (|n#0@@2| Int) ) (! (= (_module.__default.fact ($LS $ly@@5) |n#0@@2|) (_module.__default.fact $ly@@5 |n#0@@2|))
 :qid |nakedfunctioninrecursivesettingdfy.4:16|
 :skolemid |479|
 :pattern ( (_module.__default.fact ($LS $ly@@5) |n#0@@2|))
)))
...
(assert (forall (($ly@@6 T@U) ) (! (= (|_module.__default.fact#Handle| ($LS $ly@@6)) (|_module.__default.fact#Handle| $ly@@6))
 :qid |nakedfunctioninrecursivesettingdfy.4:16|
 :skolemid |485|
 :pattern ( (|_module.__default.fact#Handle| ($LS $ly@@6)))
)))
(assert (forall (($bx T@U) ($ly@@7 T@U) ($heap@@2 T@U) (|$fh$0x#0@@2| T@U) ) (! (= (|Set#IsMember| (Reads1 TInt TInt $heap@@2 (|_module.__default.fact#Handle| $ly@@7) |$fh$0x#0@@2|) $bx) false)
 :qid |unknown.0:0|
 :skolemid |488|
 :pattern ( (|Set#IsMember| (Reads1 TInt TInt $heap@@2 (|_module.__default.fact#Handle| $ly@@7) |$fh$0x#0@@2|) $bx))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.fact)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon8_Else_correct  (=> (or (not (= |n#0@@3| (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 9)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> ($IsAllocBox ($Box HandleTypeType (|_module.__default.fact#Handle| ($LS $LZ))) (Tclass._System.___hFunc1 TInt TInt) $Heap@@2) (=> (and (= |##x0#0@0| (- |n#0@@3| 1)) ($IsAlloc intType (int_2_U |##x0#0@0|) TInt $Heap@@2)) (and (=> (= (ControlFlow 0 4) (- 0 8)) (forall (($o@@0 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@0) alloc)))) (|Set#IsMember| (Reads1 TInt TInt $Heap@@2 (|_module.__default.fact#Handle| ($LS $LZ)) ($Box intType (int_2_U |##x0#0@0|))) ($Box refType $o@@0))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@0 $f@@0)))
 :qid |nakedfunctioninrecursivesettingdfy.10:17|
 :skolemid |490|
))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (Requires1 TInt TInt $Heap@@2 (|_module.__default.fact#Handle| ($LS $LZ)) ($Box intType (int_2_U (- |n#0@@3| 1))))) (=> (Requires1 TInt TInt $Heap@@2 (|_module.__default.fact#Handle| ($LS $LZ)) ($Box intType (int_2_U (- |n#0@@3| 1)))) (=> (and (= |##n#0@0| (- |n#0@@3| 1)) ($IsAlloc intType (int_2_U |##n#0@0|) TInt $Heap@@2)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (>= |##n#0@0| (LitInt 0))) (=> (>= |##n#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (<= 0 |n#0@@3|) (= |##n#0@0| |n#0@@3|))) (=> (or (<= 0 |n#0@@3|) (= |##n#0@0| |n#0@@3|)) (=> (= (ControlFlow 0 4) (- 0 3)) (< |##n#0@0| |n#0@@3|)))))))))))))))))
(let ((anon8_Then_correct true))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (>= |n#0@@3| (LitInt 0))) (and (and (=> (= (ControlFlow 0 10) 1) anon7_Then_correct) (=> (= (ControlFlow 0 10) 2) anon8_Then_correct)) (=> (= (ControlFlow 0 10) 4) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct)))
