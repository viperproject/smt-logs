...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon8_Else_correct  (=> (> |pos#0@1| 0) (=> (and (= |$decr$loop#00@1| (- |pos#0@1| 0)) (= |pos#0@2| (- |pos#0@1| 1))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (<= 0 |$decr$loop#00@1|) (= (- |pos#0@2| 0) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- |pos#0@2| 0) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 5) (- 0 4)) (< (- |pos#0@2| 0) |$decr$loop#00@1|))))))))
...
(let ((anon6_LoopHead_correct  (=> (and (and (and (not false) (and (<= 0 |pos#0@1|) (< |pos#0@1| 11))) (= |$decr_init$loop#00@0| 10)) (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |uselesscastsindecreasesclausesdfy.6:3|
 :skolemid |482|
...
)) (<= (- |pos#0@1| 0) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 9) 1) anon6_LoopDone_correct) (=> (= (ControlFlow 0 9) 8) anon6_LoopBody_correct)))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |pos#0@0| (LitInt 10))) (and (= |$decr_init$loop#00@0| (- |pos#0@0| 0)) (= (ControlFlow 0 10) 9))) anon6_LoopHead_correct)))
