...
(set-info :boogie-vc-id Impl$$_module.__default.ManualProof)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Seq#Contains| |s#0| (|Seq#Index| |s#0| (LitInt 0)))) (=> (|Seq#Contains| |s#0| (|Seq#Index| |s#0| (LitInt 0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s#0|)))) (=> (= (ControlFlow 0 2) (- 0 1)) (> (U_2_int ($Unbox intType (|Seq#Index| |s#0| (LitInt 0)))) 0)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SeqType |s#0| (TSeq TInt)) ($IsAlloc SeqType |s#0| (TSeq TInt) $Heap)) (<= (LitInt 0) |i#0|)) (and (and (= 0 $FunctionContextHeight) (forall ((|x#1| T@U) ) (!  (=> (|Seq#Contains| |s#0| ($Box intType |x#1|)) (> (U_2_int |x#1|) 0))
 :qid |sequencess0insdfy.16:19|
 :skolemid |489|
 :pattern ( (|Seq#Contains| |s#0| ($Box intType |x#1|)))
))) (and (> (|Seq#Length| |s#0|) 0) (= (ControlFlow 0 6) 2)))) anon0_correct))))
