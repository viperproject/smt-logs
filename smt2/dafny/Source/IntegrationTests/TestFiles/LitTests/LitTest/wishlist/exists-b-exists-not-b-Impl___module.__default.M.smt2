...
(let ((anon5_Then_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (exists ((|b#1| Bool) ) |b#1|)) (=> (exists ((|b#1@@0| Bool) ) |b#1@@0|) (and (=> (= (ControlFlow 0 5) 3) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct))))))
