...
(let ((anon6_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (exists ((|b#3| Bool) ) (!  (not |b#3|)
 :qid |existsbexistsnotbdfy.9:17|
 :skolemid |485|
)))))
(let ((anon5_Then_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (exists ((|b#1| Bool) ) (! |b#1|
 :qid |existsbexistsnotbdfy.8:17|
 :skolemid |483|
))) (=> (exists ((|b#1@@0| Bool) ) (! |b#1@@0|
 :qid |existsbexistsnotbdfy.8:17|
 :skolemid |483|
)) (and (=> (= (ControlFlow 0 5) 3) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct))))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 7) 5) anon5_Then_correct) (=> (= (ControlFlow 0 7) 1) anon5_Else_correct)))))
