...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let (($generated@@87 true))
(let (($generated@@88  (=> (= (ControlFlow 0 3) (- 0 2)) (exists (($generated@@89 Bool) )  (not $generated@@89)))))
(let (($generated@@90  (and (=> (= (ControlFlow 0 5) (- 0 6)) (exists (($generated@@91 Bool) ) $generated@@91)) (=> (exists (($generated@@92 Bool) ) $generated@@92) (and (=> (= (ControlFlow 0 5) 3) $generated@@88) (=> (= (ControlFlow 0 5) 4) $generated@@87))))))
(let (($generated@@93 true))
(let (($generated@@94  (=> (= $generated@@80 ($generated@@24 $generated@@81 $generated@@82 $generated@@83 false)) (and (=> (= (ControlFlow 0 7) 5) $generated@@90) (=> (= (ControlFlow 0 7) 1) $generated@@93)))))
(let (($generated@@95  (=> (and (and ($generated@@84 $generated@@82) ($generated@@85 $generated@@82)) (and (= 0 $generated@@86) (= (ControlFlow 0 8) 7))) $generated@@94)))
$generated@@95)))))))
))
(check-sat)
