...
(set-info :boogie-vc-id Impl$$_module.Composite.Update)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#3| null $Heap@@2 alloc |S#0@@4|)) (= |delta#0@0| (- |x#0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.val)))))) (and (=> (= (ControlFlow 0 2) (- 0 20)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@4 _module.Composite.val))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@4 _module.Composite.val)) (=> (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.val ($Box intType (int_2_U |x#0|))))) ($IsGoodHeap $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 19)) (forall (($o@@14 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@14) alloc)))) (and (|Set#IsMember| |S#0@@4| ($Box refType $o@@14)) (= $f@@2 _module.Composite.sum))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@14 $f@@2)))
 :qid |Compositedfy.50:11|
 :skolemid |551|
))) (=> (forall (($o@@15 T@U) ($f@@3 T@U) ) (!  (=> (and (and (or (not (= $o@@15 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@15) alloc)))) (and (|Set#IsMember| |S#0@@4| ($Box refType $o@@15)) (= $f@@3 _module.Composite.sum))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@15 $f@@3)))
 :qid |Compositedfy.50:11|
 :skolemid |551|
)) (and (=> (= (ControlFlow 0 2) (- 0 18)) (|Set#Subset| |S#0@@4| |S#0@@4|)) (=> (|Set#Subset| |S#0@@4| |S#0@@4|) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|_module.Composite.Acyclic#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Composite.Acyclic ($LS $LZ) $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType this@@4))))) (=> (=> (|_module.Composite.Acyclic#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Composite.Acyclic ($LS $LZ) $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType this@@4)))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.Composite.Acyclic#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Composite.Acyclic ($LS $LZ) $Heap@0 this@@4 |S#0@@4|) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.parent)) null)) (not true)) (_module.Composite.Acyclic ($LS ($LS $LZ)) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.parent)) (|Set#Difference| |S#0@@4| (|Set#UnionOne| |Set#Empty| ($Box refType this@@4)))))))) (=> (=> (|_module.Composite.Acyclic#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Composite.Acyclic ($LS $LZ) $Heap@0 this@@4 |S#0@@4|) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.parent)) null)) (not true)) (_module.Composite.Acyclic ($LS ($LS $LZ)) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.parent)) (|Set#Difference| |S#0@@4| (|Set#UnionOne| |Set#Empty| ($Box refType this@@4))))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (forall ((|c#1| T@U) ) (!  (=> ($Is refType |c#1| Tclass._module.Composite) (=> (and (|Set#IsMember| |S#0@@4| ($Box refType |c#1|)) (or (not (= |c#1| this@@4)) (not true))) (_module.Composite.Valid $Heap@0 |c#1| |S#0@@4|)))
 :qid |Compositedfy.110:21|
 :skolemid |601|
 :pattern ( (_module.Composite.Valid $Heap@0 |c#1| |S#0@@4|))
 :pattern ( (|Set#IsMember| |S#0@@4| ($Box refType |c#1|)))
))) (=> (forall ((|c#1@@0| T@U) ) (!  (=> ($Is refType |c#1@@0| Tclass._module.Composite) (=> (and (|Set#IsMember| |S#0@@4| ($Box refType |c#1@@0|)) (or (not (= |c#1@@0| this@@4)) (not true))) (_module.Composite.Valid $Heap@0 |c#1@@0| |S#0@@4|)))
 :qid |Compositedfy.110:21|
 :skolemid |601|
 :pattern ( (_module.Composite.Valid $Heap@0 |c#1@@0| |S#0@@4|))
 :pattern ( (|Set#IsMember| |S#0@@4| ($Box refType |c#1@@0|)))
)) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.parent)) null)) (not true)) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.parent)))) (=> (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.parent)) null)) (not true)) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.parent))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.parent)) null)) (not true)) (or (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.parent))) _module.Composite.left)) this@@4) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.parent))) _module.Composite.right)) this@@4)))) (=> (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.parent)) null)) (not true)) (or (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.parent))) _module.Composite.left)) this@@4) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.parent))) _module.Composite.right)) this@@4))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.left)) null)) (not true)) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.left)))) (=> (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.left)) null)) (not true)) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.left))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.left)) null)) (not true)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.left))) _module.Composite.parent)) this@@4))) (=> (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.left)) null)) (not true)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.left))) _module.Composite.parent)) this@@4)) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.left)) null)) (not true)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.left)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.right)))) (not true)))) (=> (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.left)) null)) (not true)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.left)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.right)))) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.right)) null)) (not true)) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.right)))) (=> (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.right)) null)) (not true)) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.right))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.right)) null)) (not true)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.right))) _module.Composite.parent)) this@@4))) (=> (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.right)) null)) (not true)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.right))) _module.Composite.parent)) this@@4)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.right)) null)) (not true)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.left)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.right)))) (not true)))) (=> (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.right)) null)) (not true)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.left)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.right)))) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (= (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.sum))) |delta#0@0|) (+ (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.val))) (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.left)) null) 0 (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.left))) _module.Composite.sum))))) (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.right)) null) 0 (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.right))) _module.Composite.sum))))))) (=> (= (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.sum))) |delta#0@0|) (+ (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.val))) (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.left)) null) 0 (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.left))) _module.Composite.sum))))) (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.right)) null) 0 (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.right))) _module.Composite.sum)))))) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (forall ((|c#3| T@U) ) (!  (=> ($Is refType |c#3| Tclass._module.Composite) (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#3|)) (|_module.Composite.Valid#canCall| $Heap@1 |c#3| |S#0@@4|)))
 :qid |Compositedfy.120:20|
 :skolemid |602|
 :pattern ( (_module.Composite.Valid $Heap@1 |c#3| |S#0@@4|))
 :pattern ( (|Set#IsMember| |S#0@@4| ($Box refType |c#3|)))
))) (and (and (forall ((|c#3@@0| T@U) ) (!  (=> ($Is refType |c#3@@0| Tclass._module.Composite) (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#3@@0|)) (_module.Composite.Valid $Heap@1 |c#3@@0| |S#0@@4|)))
 :qid |Compositedfy.120:20|
 :skolemid |603|
 :pattern ( (_module.Composite.Valid $Heap@1 |c#3@@0| |S#0@@4|))
 :pattern ( (|Set#IsMember| |S#0@@4| ($Box refType |c#3@@0|)))
)) (forall (($o@@16 T@U) ) (!  (=> (and (or (not (= $o@@16 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@16) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@16) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@16)) (|Set#IsMember| |S#0@@4| ($Box refType $o@@16))))
 :qid |Compositedfy.107:22|
 :skolemid |604|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@16))
))) (and (forall (($o@@17 T@U) ($f@@4 T@U) ) (!  (=> (and (or (not (= $o@@17 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@17) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@17) $f@@4) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@17) $f@@4)) (and (|Set#IsMember| |S#0@@4| ($Box refType $o@@17)) (= $f@@4 _module.Composite.sum))))
 :qid |Compositedfy.107:22|
 :skolemid |605|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@17) $f@@4))
)) ($HeapSucc $Heap@0 $Heap@1)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall ((|c#3@@1| T@U) ) (!  (=> ($Is refType |c#3@@1| Tclass._module.Composite) (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#3@@1|)) (_module.Composite.Valid $Heap@1 |c#3@@1| |S#0@@4|)))
 :qid |Compositedfy.43:20|
 :skolemid |547|
 :pattern ( (_module.Composite.Valid $Heap@1 |c#3@@1| |S#0@@4|))
 :pattern ( (|Set#IsMember| |S#0@@4| ($Box refType |c#3@@1|)))
))) (=> (forall ((|c#3@@2| T@U) ) (!  (=> ($Is refType |c#3@@2| Tclass._module.Composite) (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#3@@2|)) (_module.Composite.Valid $Heap@1 |c#3@@2| |S#0@@4|)))
 :qid |Compositedfy.43:20|
 :skolemid |547|
 :pattern ( (_module.Composite.Valid $Heap@1 |c#3@@2| |S#0@@4|))
 :pattern ( (|Set#IsMember| |S#0@@4| ($Box refType |c#3@@2|)))
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((|c#5| T@U) ) (!  (=> ($Is refType |c#5| Tclass._module.Composite) (and (and (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#5|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |c#5|) _module.Composite.left)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#5|) _module.Composite.left)))) (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#5|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |c#5|) _module.Composite.right)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#5|) _module.Composite.right))))) (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#5|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |c#5|) _module.Composite.parent)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#5|) _module.Composite.parent))))))
 :qid |Compositedfy.44:20|
 :skolemid |548|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#5|) _module.Composite.parent)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |c#5|) _module.Composite.parent)))
 ...
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |c#5|) _module.Composite.right)))
 ...
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |c#5|) _module.Composite.left)))
 :pattern ( (|Set#IsMember| |S#0@@4| ($Box refType |c#5|)))
))) (=> (forall ((|c#5@@0| T@U) ) (!  (=> ($Is refType |c#5@@0| Tclass._module.Composite) (and (and (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#5@@0|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |c#5@@0|) _module.Composite.left)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#5@@0|) _module.Composite.left)))) (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#5@@0|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |c#5@@0|) _module.Composite.right)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#5@@0|) _module.Composite.right))))) (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#5@@0|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |c#5@@0|) _module.Composite.parent)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#5@@0|) _module.Composite.parent))))))
 :qid |Compositedfy.44:20|
 :skolemid |548|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#5@@0|) _module.Composite.parent)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |c#5@@0|) _module.Composite.parent)))
 ...
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |c#5@@0|) _module.Composite.right)))
 ...
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |c#5@@0|) _module.Composite.left)))
 :pattern ( (|Set#IsMember| |S#0@@4| ($Box refType |c#5@@0|)))
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((|c#7| T@U) ) (!  (=> ($Is refType |c#7| Tclass._module.Composite) (=> (and (|Set#IsMember| |S#0@@4| ($Box refType |c#7|)) (or (not (= |c#7| this@@4)) (not true))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |c#7|) _module.Composite.val))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#7|) _module.Composite.val))))))
...
))) (=> (forall ((|c#7@@0| T@U) ) (!  (=> ($Is refType |c#7@@0| Tclass._module.Composite) (=> (and (|Set#IsMember| |S#0@@4| ($Box refType |c#7@@0|)) (or (not (= |c#7@@0| this@@4)) (not true))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |c#7@@0|) _module.Composite.val))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#7@@0|) _module.Composite.val))))))
 :qid |Compositedfy.45:20|
 :skolemid |549|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |c#7@@0|) _module.Composite.val)))
 :pattern ( (|Set#IsMember| |S#0@@4| ($Box refType |c#7@@0|)))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@4) _module.Composite.val))) |x#0|)))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.Composite) ($IsAlloc refType this@@4 Tclass._module.Composite $Heap@@2)))) (=> (and (and (and ($Is SetType |S#0@@4| (TSet Tclass._module.Composite)) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Composite) $Heap@@2)) (and (= 3 $FunctionContextHeight) (|Set#IsMember| |S#0@@4| ($Box refType this@@4)))) (and (and (|_module.Composite.Acyclic#canCall| $Heap@@2 this@@4 |S#0@@4|) (and (_module.Composite.Acyclic ($LS $LZ) $Heap@@2 this@@4 |S#0@@4|) (and (|Set#IsMember| |S#0@@4| ($Box refType this@@4)) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.parent)) null)) (not true)) (_module.Composite.Acyclic ($LS $LZ) $Heap@@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.parent)) (|Set#Difference| |S#0@@4| (|Set#UnionOne| |Set#Empty| ($Box refType this@@4)))))))) (and (forall ((|c#1@@1| T@U) ) (!  (=> ($Is refType |c#1@@1| Tclass._module.Composite) (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#1@@1|)) (_module.Composite.Valid $Heap@@2 |c#1@@1| |S#0@@4|)))
 :qid |Compositedfy.41:21|
 :skolemid |545|
 :pattern ( (_module.Composite.Valid $Heap@@2 |c#1@@1| |S#0@@4|))
 :pattern ( (|Set#IsMember| |S#0@@4| ($Box refType |c#1@@1|)))
)) (= (ControlFlow 0 21) 2)))) anon0_correct))))
