...
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.Composite.Update)
...
(let ((anon17_Else_correct  (=> (and (=> (and (|Set#IsMember| |S#0@@4| ($Box refType |c#6@0|)) (or (not (= |c#6@0| this@@4)) (not true))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#6@0|) _module.Composite.val))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#6@0|) _module.Composite.val))))) (= (ControlFlow 0 6) 1)) anon13_correct)))
(let ((anon17_Then_correct  (=> (and (|Set#IsMember| |S#0@@4| ($Box refType |c#6@0|)) (or (not (= |c#6@0| this@@4)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |c#6@0| null)) (not true))) (=> (or (not (= |c#6@0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |c#6@0| null)) (not true))) (=> (or (not (= |c#6@0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |c#6@0| Tclass._module.Composite $Heap@@2)) (=> ($IsAlloc refType |c#6@0| Tclass._module.Composite $Heap@@2) (=> (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#6@0|) _module.Composite.val))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#6@0|) _module.Composite.val)))) (= (ControlFlow 0 2) 1)) anon13_correct))))))))))
(let ((anon10_correct  (=> (forall ((|c#5| T@U) ) (!  (=> ($Is refType |c#5| Tclass._module.Composite) (and (and (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#5|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#5|) _module.Composite.left)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#5|) _module.Composite.left)))) (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#5|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#5|) _module.Composite.right)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#5|) _module.Composite.right))))) (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#5|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#5|) _module.Composite.parent)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#5|) _module.Composite.parent))))))
 ...
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#5|) _module.Composite.parent)))
...
)) (=> (and ($Is refType |c#6@0| Tclass._module.Composite) ($IsAlloc refType |c#6@0| Tclass._module.Composite $Heap@0)) (and (=> (= (ControlFlow 0 7) 2) anon17_Then_correct) (=> (= (ControlFlow 0 7) 6) anon17_Else_correct))))))
(let ((anon16_Else_correct  (=> (and (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#4@0|)) (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#4@0|) _module.Composite.left)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#4@0|) _module.Composite.left))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#4@0|) _module.Composite.right)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#4@0|) _module.Composite.right)))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#4@0|) _module.Composite.parent)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#4@0|) _module.Composite.parent))))) (= (ControlFlow 0 18) 7)) anon10_correct)))
(let ((anon16_Then_correct  (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#4@0|)) (and (=> (= (ControlFlow 0 8) (- 0 17)) (or (not (= |c#4@0| null)) (not true))) (=> (or (not (= |c#4@0| null)) (not true)) (and (=> (= (ControlFlow 0 8) (- 0 16)) (or (not (= |c#4@0| null)) (not true))) (=> (or (not (= |c#4@0| null)) (not true)) (and (=> (= (ControlFlow 0 8) (- 0 15)) ($IsAlloc refType |c#4@0| Tclass._module.Composite $Heap@@2)) (=> ($IsAlloc refType |c#4@0| Tclass._module.Composite $Heap@@2) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#4@0|) _module.Composite.left)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#4@0|) _module.Composite.left))) (and (=> (= (ControlFlow 0 8) (- 0 14)) (or (not (= |c#4@0| null)) (not true))) (=> (or (not (= |c#4@0| null)) (not true)) (and (=> (= (ControlFlow 0 8) (- 0 13)) (or (not (= |c#4@0| null)) (not true))) (=> (or (not (= |c#4@0| null)) (not true)) (and (=> (= (ControlFlow 0 8) (- 0 12)) ($IsAlloc refType |c#4@0| Tclass._module.Composite $Heap@@2)) (=> ($IsAlloc refType |c#4@0| Tclass._module.Composite $Heap@@2) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#4@0|) _module.Composite.right)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#4@0|) _module.Composite.right))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (or (not (= |c#4@0| null)) (not true))) (=> (or (not (= |c#4@0| null)) (not true)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (or (not (= |c#4@0| null)) (not true))) (=> (or (not (= |c#4@0| null)) (not true)) (and (=> (= (ControlFlow 0 8) (- 0 9)) ($IsAlloc refType |c#4@0| Tclass._module.Composite $Heap@@2)) (=> ($IsAlloc refType |c#4@0| Tclass._module.Composite $Heap@@2) (=> (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#4@0|) _module.Composite.parent)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#4@0|) _module.Composite.parent))) (= (ControlFlow 0 8) 7)) anon10_correct))))))))))))))))))))))))
...
)) (=> (and ($Is refType |c#4@0| Tclass._module.Composite) ($IsAlloc refType |c#4@0| Tclass._module.Composite $Heap@0)) (and (=> (= (ControlFlow 0 19) 8) anon16_Then_correct) (=> (= (ControlFlow 0 19) 18) anon16_Else_correct))))))
(let ((anon15_Else_correct  (=> (and (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#2@0|)) (_module.Composite.Valid $Heap@0 |c#2@0| |S#0@@4|)) (= (ControlFlow 0 22) 19)) anon7_correct)))
(let ((anon15_Then_correct  (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#2@0|)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (or (not (= |c#2@0| null)) (not true))) (=> (or (not (= |c#2@0| null)) (not true)) (=> ($IsAllocBox ($Box refType |c#2@0|) Tclass._module.Composite? $Heap@0) (=> (and (and ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Composite) $Heap@0) (|_module.Composite.Valid#canCall| $Heap@0 |c#2@0| |S#0@@4|)) (and (_module.Composite.Valid $Heap@0 |c#2@0| |S#0@@4|) (= (ControlFlow 0 20) 19))) anon7_correct)))))))
...
)) ($HeapSucc $Heap@@2 $Heap@0)) (and ($Is refType |c#2@0| Tclass._module.Composite) ($IsAlloc refType |c#2@0| Tclass._module.Composite $Heap@0))) (and (=> (= (ControlFlow 0 23) 20) anon15_Then_correct) (=> (= (ControlFlow 0 23) 22) anon15_Else_correct)))))))
(let ((anon14_Else_correct  (=> (and (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#0@0|)) (_module.Composite.Valid $Heap@@2 |c#0@0| |S#0@@4|)) (= (ControlFlow 0 26) 23)) anon4_correct)))
(let ((anon14_Then_correct  (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#0@0|)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (or (not (= |c#0@0| null)) (not true))) (=> (or (not (= |c#0@0| null)) (not true)) (=> ($IsAllocBox ($Box refType |c#0@0|) Tclass._module.Composite? $Heap@@2) (=> (and (and ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Composite) $Heap@@2) (|_module.Composite.Valid#canCall| $Heap@@2 |c#0@0| |S#0@@4|)) (and (_module.Composite.Valid $Heap@@2 |c#0@0| |S#0@@4|) (= (ControlFlow 0 24) 23))) anon4_correct)))))))
(let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#3| null $Heap@@2 alloc |S#0@@4|)) (|Set#IsMember| |S#0@@4| ($Box refType this@@4))) (and ($IsAllocBox ($Box refType this@@4) Tclass._module.Composite? $Heap@@2) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Composite) $Heap@@2))) (and (and (|_module.Composite.Acyclic#canCall| $Heap@@2 this@@4 |S#0@@4|) (_module.Composite.Acyclic ($LS $LZ) $Heap@@2 this@@4 |S#0@@4|)) (and ($Is refType |c#0@0| Tclass._module.Composite) ($IsAlloc refType |c#0@0| Tclass._module.Composite $Heap@@2)))) (and (=> (= (ControlFlow 0 27) 24) anon14_Then_correct) (=> (= (ControlFlow 0 27) 26) anon14_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.Composite) ($IsAlloc refType this@@4 Tclass._module.Composite $Heap@@2)))) (and (and ($Is SetType |S#0@@4| (TSet Tclass._module.Composite)) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Composite) $Heap@@2)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 28) 27)))) anon0_correct)))
