...
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.Composite.Adjust)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 30) (let ((anon24_correct true))
(let ((anon32_Else_correct  (=> (and (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#2@0|)) (_module.Composite.Valid $Heap@0 |c#2@0| |S#0@@4|)) (= (ControlFlow 0 4) 1)) anon24_correct)))
(let ((anon32_Then_correct  (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#2@0|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |c#2@0| null)) (not true))) (=> (or (not (= |c#2@0| null)) (not true)) (=> ($IsAllocBox ($Box refType |c#2@0|) Tclass._module.Composite? $Heap@0) (=> (and (and ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Composite) $Heap@0) (|_module.Composite.Valid#canCall| $Heap@0 |c#2@0| |S#0@@4|)) (and (_module.Composite.Valid $Heap@0 |c#2@0| |S#0@@4|) (= (ControlFlow 0 2) 1))) anon24_correct)))))))
(let ((anon21_correct  (=> (= (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.sum))) |delta#0|) (+ (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.val))) (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.left)) null) 0 (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.left))) _module.Composite.sum))))) (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.right)) null) 0 (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.right))) _module.Composite.sum)))))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@14 T@U) ) (!  (=> (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@14) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@14) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@14)) (|Set#IsMember| |U#0| ($Box refType $o@@14))))
...
)) ($HeapSucc $Heap@@2 $Heap@0)) (and ($Is refType |c#2@0| Tclass._module.Composite) ($IsAlloc refType |c#2@0| Tclass._module.Composite $Heap@0)))) (and (=> (= (ControlFlow 0 5) 2) anon32_Then_correct) (=> (= (ControlFlow 0 5) 4) anon32_Else_correct))))))
(let ((anon31_Else_correct  (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.right)) null)) (not true)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.right)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.right)) null)) (not true)) (=> (= (ControlFlow 0 7) 5) anon21_correct))))))
(let ((anon31_Then_correct  (=> (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.right)) null) (= (ControlFlow 0 6) 5)) anon21_correct)))
(let ((anon30_Else_correct  (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.left)) null)) (not true)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.left)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.left)) null)) (not true)) (and (=> (= (ControlFlow 0 10) 6) anon31_Then_correct) (=> (= (ControlFlow 0 10) 7) anon31_Else_correct)))))))
(let ((anon30_Then_correct  (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.left)) null) (and (=> (= (ControlFlow 0 9) 6) anon31_Then_correct) (=> (= (ControlFlow 0 9) 7) anon31_Else_correct)))))
(let ((anon29_Else_correct  (=> (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.right)) null)) (not true)) (and (and (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.right)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.right))) _module.Composite.parent)) this@@4)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.left)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.right)))) (not true)))) (and (=> (= (ControlFlow 0 14) 9) anon30_Then_correct) (=> (= (ControlFlow 0 14) 10) anon30_Else_correct)))))
(let ((anon29_Then_correct  (=> (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.right)) null)) (not true)) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.right))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.right)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.right)) null)) (not true)) (=> (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.right))) _module.Composite.parent)) this@@4) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.left)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.right)))) (not true))) (and (=> (= (ControlFlow 0 12) 9) anon30_Then_correct) (=> (= (ControlFlow 0 12) 10) anon30_Else_correct))))))))
(let ((anon28_Else_correct  (=> (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.left)) null)) (not true)) (and (and (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.left)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.left))) _module.Composite.parent)) this@@4)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.left)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.right)))) (not true)))) (and (=> (= (ControlFlow 0 17) 12) anon29_Then_correct) (=> (= (ControlFlow 0 17) 14) anon29_Else_correct)))))
(let ((anon28_Then_correct  (=> (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.left)) null)) (not true)) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.left))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.left)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.left)) null)) (not true)) (=> (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.left))) _module.Composite.parent)) this@@4) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.left)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.right)))) (not true))) (and (=> (= (ControlFlow 0 15) 12) anon29_Then_correct) (=> (= (ControlFlow 0 15) 14) anon29_Else_correct))))))))
(let ((anon7_correct  (=> (or (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.parent))) _module.Composite.left)) this@@4) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.parent))) _module.Composite.right)) this@@4)) (and (=> (= (ControlFlow 0 19) 15) anon28_Then_correct) (=> (= (ControlFlow 0 19) 17) anon28_Else_correct)))))
(let ((anon27_Else_correct  (=> (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.parent))) _module.Composite.left)) this@@4) (= (ControlFlow 0 22) 19)) anon7_correct)))
(let ((anon27_Then_correct  (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.parent))) _module.Composite.left)) this@@4)) (not true)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.parent)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.parent)) null)) (not true)) (=> (= (ControlFlow 0 20) 19) anon7_correct))))))
(let ((anon26_Then_correct  (=> (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.parent)) null)) (not true)) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.parent))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.parent)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.parent)) null)) (not true)) (and (=> (= (ControlFlow 0 23) 20) anon27_Then_correct) (=> (= (ControlFlow 0 23) 22) anon27_Else_correct)))))))
(let ((anon26_Else_correct  (=> (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.parent)) null)) (not true)) (and (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.parent)) (or (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.parent))) _module.Composite.left)) this@@4) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Composite.parent))) _module.Composite.right)) this@@4)))) (and (=> (= (ControlFlow 0 18) 15) anon28_Then_correct) (=> (= (ControlFlow 0 18) 17) anon28_Else_correct)))))
(let ((anon4_correct  (=> (forall ((|c#1| T@U) ) (!  (=> ($Is refType |c#1| Tclass._module.Composite) (=> (and (|Set#IsMember| |S#0@@4| ($Box refType |c#1|)) (or (not (= |c#1| this@@4)) (not true))) (_module.Composite.Valid $Heap@@2 |c#1| |S#0@@4|)))
 :qid |Compositedfy.110:21|
 :skolemid |597|
 :pattern ( (_module.Composite.Valid $Heap@@2 |c#1| |S#0@@4|))
 :pattern ( (|Set#IsMember| |S#0@@4| ($Box refType |c#1|)))
)) (and (=> (= (ControlFlow 0 25) 23) anon26_Then_correct) (=> (= (ControlFlow 0 25) 18) anon26_Else_correct)))))
(let ((anon25_Else_correct  (=> (and (=> (and (|Set#IsMember| |S#0@@4| ($Box refType |c#0@0|)) (or (not (= |c#0@0| this@@4)) (not true))) (_module.Composite.Valid $Heap@@2 |c#0@0| |S#0@@4|)) (= (ControlFlow 0 28) 25)) anon4_correct)))
(let ((anon25_Then_correct  (=> (and (|Set#IsMember| |S#0@@4| ($Box refType |c#0@0|)) (or (not (= |c#0@0| this@@4)) (not true))) (and (=> (= (ControlFlow 0 26) (- 0 27)) (or (not (= |c#0@0| null)) (not true))) (=> (or (not (= |c#0@0| null)) (not true)) (=> ($IsAllocBox ($Box refType |c#0@0|) Tclass._module.Composite? $Heap@@2) (=> (and (and ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Composite) $Heap@@2) (|_module.Composite.Valid#canCall| $Heap@@2 |c#0@0| |S#0@@4|)) (and (_module.Composite.Valid $Heap@@2 |c#0@0| |S#0@@4|) (= (ControlFlow 0 26) 25))) anon4_correct)))))))
(let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#11| null $Heap@@2 alloc |U#0| _module.Composite.sum)) (|Set#Subset| |U#0| |S#0@@4|)) (and ($IsAllocBox ($Box refType this@@4) Tclass._module.Composite? $Heap@@2) ($IsAlloc SetType |U#0| (TSet Tclass._module.Composite) $Heap@@2))) (and (and (|_module.Composite.Acyclic#canCall| $Heap@@2 this@@4 |U#0|) (_module.Composite.Acyclic ($LS $LZ) $Heap@@2 this@@4 |U#0|)) (and ($Is refType |c#0@0| Tclass._module.Composite) ($IsAlloc refType |c#0@0| Tclass._module.Composite $Heap@@2)))) (and (=> (= (ControlFlow 0 29) 26) anon25_Then_correct) (=> (= (ControlFlow 0 29) 28) anon25_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.Composite) ($IsAlloc refType this@@4 Tclass._module.Composite $Heap@@2))) (and ($Is SetType |U#0| (TSet Tclass._module.Composite)) ($IsAlloc SetType |U#0| (TSet Tclass._module.Composite) $Heap@@2))) (and (and ($Is SetType |S#0@@4| (TSet Tclass._module.Composite)) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Composite) $Heap@@2)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 30) 29)))) anon0_correct))))
