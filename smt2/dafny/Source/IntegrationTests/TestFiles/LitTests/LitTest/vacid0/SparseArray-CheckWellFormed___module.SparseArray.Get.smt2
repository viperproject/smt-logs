...
(assert (forall ((_module.SparseArray$T@@15 T@U) ($o@@10 T@U) ) (! (= ($Is refType $o@@10 (Tclass._module.SparseArray? _module.SparseArray$T@@15))  (or (= $o@@10 null) (= (dtype $o@@10) (Tclass._module.SparseArray? _module.SparseArray$T@@15))))
 :qid |unknown.0:0|
 :skolemid |487|
 :pattern ( ($Is refType $o@@10 (Tclass._module.SparseArray? _module.SparseArray$T@@15)))
)))
...
(assert (forall ((_module.SparseArray$T@@16 T@U) ($h@@10 T@U) ($o@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) (and (or (not (= $o@@11 null)) (not true)) (= (dtype $o@@11) (Tclass._module.SparseArray? _module.SparseArray$T@@16)))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@11) _module.SparseArray.n)) TInt))
 :qid |unknown.0:0|
 :skolemid |499|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@11) _module.SparseArray.n)) (Tclass._module.SparseArray? _module.SparseArray$T@@16))
)))
...
(declare-fun |x#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.SparseArray.Get)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) ($IsAllocBox ($Box refType this@@1) (Tclass._module.SparseArray? _module.SparseArray$T@@27) $Heap@@0)) (=> (and (and (|_module.SparseArray.Valid#canCall| _module.SparseArray$T@@27 $Heap@@0 this@@1) (_module.SparseArray.Valid _module.SparseArray$T@@27 $Heap@@0 this@@1)) (and (<= (LitInt 0) |i#0@@0|) (< |i#0@@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.SparseArray.Contents)))))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@19 T@U) ) (!  (=> (and (or (not (= $o@@19 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@19) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@19) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@19)))
 :qid |SparseArraydfy.74:10|
 :skolemid |601|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@19))
)) ($HeapSucc $Heap@@0 $Heap@0))) (and (and ($IsBox |x#0@0| _module.SparseArray$T@@27) ($IsAllocBox |x#0@0| _module.SparseArray$T@@27 $Heap@0)) (= (ControlFlow 0 2) (- 0 1)))) (and (<= 0 |i#0@@0|) (< |i#0@@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@1) _module.SparseArray.Contents))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 (Tclass._module.SparseArray _module.SparseArray$T@@27)) ($IsAlloc refType this@@1 (Tclass._module.SparseArray _module.SparseArray$T@@27) $Heap@@0)))) (and (and ($IsBox |x#0| _module.SparseArray$T@@27) ($IsAllocBox |x#0| _module.SparseArray$T@@27 $Heap@@0)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
