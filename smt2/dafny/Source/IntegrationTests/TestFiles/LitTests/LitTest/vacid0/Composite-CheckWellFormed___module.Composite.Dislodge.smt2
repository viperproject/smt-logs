...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@11 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#3| |l#0| |l#1| |l#2| |l#3|) $o@@11 $f))  (=> (and (or (not (= $o@@11 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@11) |l#2|)))) (|Set#IsMember| |l#3| ($Box refType $o@@11))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |628|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#3| |l#0| |l#1| |l#2| |l#3|) $o@@11 $f))
)))
...
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.Composite.Dislodge)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 50) (let ((anon27_correct true))
(let ((anon25_correct  (=> (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#10@0|) _module.Composite.right)) this@@4) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#10@0|) _module.Composite.right)) null)) (= (ControlFlow 0 7) 1)) anon27_correct)))
(let ((anon37_Else_correct  (=> (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#10@0|) _module.Composite.right)) this@@4)) (not true)) (= (ControlFlow 0 10) 7)) anon25_correct)))
(let ((anon37_Then_correct  (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#10@0|) _module.Composite.right)) this@@4) (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (not (= |c#10@0| null)) (not true))) (=> (or (not (= |c#10@0| null)) (not true)) (=> (= (ControlFlow 0 8) 7) anon25_correct))))))
(let ((anon36_Else_correct  (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#10@0|) _module.Composite.right)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#10@0|) _module.Composite.right)))) (not true)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (or (not (= |c#10@0| null)) (not true))) (=> (or (not (= |c#10@0| null)) (not true)) (and (=> (= (ControlFlow 0 11) (- 0 12)) ($IsAlloc refType |c#10@0| Tclass._module.Composite $Heap@@2)) (=> ($IsAlloc refType |c#10@0| Tclass._module.Composite $Heap@@2) (and (=> (= (ControlFlow 0 11) 8) anon37_Then_correct) (=> (= (ControlFlow 0 11) 10) anon37_Else_correct)))))))))
(let ((anon36_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (not (= |c#10@0| null)) (not true))) (=> (or (not (= |c#10@0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= |c#10@0| null)) (not true))) (=> (or (not (= |c#10@0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 4)) ($IsAlloc refType |c#10@0| Tclass._module.Composite $Heap@@2)) (=> ($IsAlloc refType |c#10@0| Tclass._module.Composite $Heap@@2) (=> (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#10@0|) _module.Composite.right)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#10@0|) _module.Composite.right))) (= (ControlFlow 0 3) 1)) anon27_correct)))))))))
(let ((anon35_Then_correct  (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#10@0|)) (and (=> (= (ControlFlow 0 14) 3) anon36_Then_correct) (=> (= (ControlFlow 0 14) 11) anon36_Else_correct)))))
(let ((anon35_Else_correct  (=> (and (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#10@0|)) (or (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#10@0|) _module.Composite.right)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#10@0|) _module.Composite.right))) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#10@0|) _module.Composite.right)) this@@4) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#10@0|) _module.Composite.right)) null)))) (= (ControlFlow 0 2) 1)) anon27_correct)))
(let ((anon20_correct  (=> (forall ((|c#9| T@U) ) (!  (=> ($Is refType |c#9| Tclass._module.Composite) (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#9|)) (or (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#9|) _module.Composite.left)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#9|) _module.Composite.left))) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#9|) _module.Composite.left)) this@@4) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#9|) _module.Composite.left)) null)))))
 :qid |Compositedfy.90:20|
 :skolemid |578|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#9|) _module.Composite.left)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#9|) _module.Composite.left)))
 :pattern ( (|Set#IsMember| |S#0@@4| ($Box refType |c#9|)))
)) (=> (and ($Is refType |c#10@0| Tclass._module.Composite) ($IsAlloc refType |c#10@0| Tclass._module.Composite $Heap@0)) (and (=> (= (ControlFlow 0 15) 14) anon35_Then_correct) (=> (= (ControlFlow 0 15) 2) anon35_Else_correct))))))
(let ((anon18_correct  (=> (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#8@0|) _module.Composite.left)) this@@4) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#8@0|) _module.Composite.left)) null)) (= (ControlFlow 0 21) 15)) anon20_correct)))
(let ((anon34_Else_correct  (=> (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#8@0|) _module.Composite.left)) this@@4)) (not true)) (= (ControlFlow 0 24) 21)) anon18_correct)))
(let ((anon34_Then_correct  (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#8@0|) _module.Composite.left)) this@@4) (and (=> (= (ControlFlow 0 22) (- 0 23)) (or (not (= |c#8@0| null)) (not true))) (=> (or (not (= |c#8@0| null)) (not true)) (=> (= (ControlFlow 0 22) 21) anon18_correct))))))
(let ((anon33_Else_correct  (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#8@0|) _module.Composite.left)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#8@0|) _module.Composite.left)))) (not true)) (and (=> (= (ControlFlow 0 25) (- 0 27)) (or (not (= |c#8@0| null)) (not true))) (=> (or (not (= |c#8@0| null)) (not true)) (and (=> (= (ControlFlow 0 25) (- 0 26)) ($IsAlloc refType |c#8@0| Tclass._module.Composite $Heap@@2)) (=> ($IsAlloc refType |c#8@0| Tclass._module.Composite $Heap@@2) (and (=> (= (ControlFlow 0 25) 22) anon34_Then_correct) (=> (= (ControlFlow 0 25) 24) anon34_Else_correct)))))))))
(let ((anon33_Then_correct  (and (=> (= (ControlFlow 0 17) (- 0 20)) (or (not (= |c#8@0| null)) (not true))) (=> (or (not (= |c#8@0| null)) (not true)) (and (=> (= (ControlFlow 0 17) (- 0 19)) (or (not (= |c#8@0| null)) (not true))) (=> (or (not (= |c#8@0| null)) (not true)) (and (=> (= (ControlFlow 0 17) (- 0 18)) ($IsAlloc refType |c#8@0| Tclass._module.Composite $Heap@@2)) (=> ($IsAlloc refType |c#8@0| Tclass._module.Composite $Heap@@2) (=> (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#8@0|) _module.Composite.left)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#8@0|) _module.Composite.left))) (= (ControlFlow 0 17) 15)) anon20_correct)))))))))
(let ((anon32_Then_correct  (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#8@0|)) (and (=> (= (ControlFlow 0 28) 17) anon33_Then_correct) (=> (= (ControlFlow 0 28) 25) anon33_Else_correct)))))
(let ((anon32_Else_correct  (=> (and (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#8@0|)) (or (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#8@0|) _module.Composite.left)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#8@0|) _module.Composite.left))) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#8@0|) _module.Composite.left)) this@@4) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#8@0|) _module.Composite.left)) null)))) (= (ControlFlow 0 16) 15)) anon20_correct)))
(let ((anon13_correct  (=> (and (and (forall ((|c#7| T@U) ) (!  (=> ($Is refType |c#7| Tclass._module.Composite) (=> (and (|Set#IsMember| |S#0@@4| ($Box refType |c#7|)) (or (not (= |c#7| this@@4)) (not true))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#7|) _module.Composite.parent)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#7|) _module.Composite.parent)))))
...
)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) _module.Composite.parent)) null)) (and ($Is refType |c#8@0| Tclass._module.Composite) ($IsAlloc refType |c#8@0| Tclass._module.Composite $Heap@0))) (and (=> (= (ControlFlow 0 29) 28) anon32_Then_correct) (=> (= (ControlFlow 0 29) 16) anon32_Else_correct)))))
(let ((anon31_Else_correct  (=> (and (=> (and (|Set#IsMember| |S#0@@4| ($Box refType |c#6@0|)) (or (not (= |c#6@0| this@@4)) (not true))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#6@0|) _module.Composite.parent)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#6@0|) _module.Composite.parent)))) (= (ControlFlow 0 34) 29)) anon13_correct)))
(let ((anon31_Then_correct  (=> (and (|Set#IsMember| |S#0@@4| ($Box refType |c#6@0|)) (or (not (= |c#6@0| this@@4)) (not true))) (and (=> (= (ControlFlow 0 30) (- 0 33)) (or (not (= |c#6@0| null)) (not true))) (=> (or (not (= |c#6@0| null)) (not true)) (and (=> (= (ControlFlow 0 30) (- 0 32)) (or (not (= |c#6@0| null)) (not true))) (=> (or (not (= |c#6@0| null)) (not true)) (and (=> (= (ControlFlow 0 30) (- 0 31)) ($IsAlloc refType |c#6@0| Tclass._module.Composite $Heap@@2)) (=> ($IsAlloc refType |c#6@0| Tclass._module.Composite $Heap@@2) (=> (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#6@0|) _module.Composite.parent)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#6@0|) _module.Composite.parent))) (= (ControlFlow 0 30) 29)) anon13_correct))))))))))
(let ((anon10_correct  (=> (forall ((|c#5| T@U) ) (!  (=> ($Is refType |c#5| Tclass._module.Composite) (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#5|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#5|) _module.Composite.val))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#5|) _module.Composite.val))))))
 :qid |Compositedfy.87:20|
 :skolemid |576|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#5|) _module.Composite.val)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#5|) _module.Composite.val)))
 :pattern ( (|Set#IsMember| |S#0@@4| ($Box refType |c#5|)))
)) (=> (and ($Is refType |c#6@0| Tclass._module.Composite) ($IsAlloc refType |c#6@0| Tclass._module.Composite $Heap@0)) (and (=> (= (ControlFlow 0 35) 30) anon31_Then_correct) (=> (= (ControlFlow 0 35) 34) anon31_Else_correct))))))
(let ((anon30_Else_correct  (=> (and (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#4@0|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#4@0|) _module.Composite.val))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#4@0|) _module.Composite.val))))) (= (ControlFlow 0 40) 35)) anon10_correct)))
(let ((anon30_Then_correct  (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#4@0|)) (and (=> (= (ControlFlow 0 36) (- 0 39)) (or (not (= |c#4@0| null)) (not true))) (=> (or (not (= |c#4@0| null)) (not true)) (and (=> (= (ControlFlow 0 36) (- 0 38)) (or (not (= |c#4@0| null)) (not true))) (=> (or (not (= |c#4@0| null)) (not true)) (and (=> (= (ControlFlow 0 36) (- 0 37)) ($IsAlloc refType |c#4@0| Tclass._module.Composite $Heap@@2)) (=> ($IsAlloc refType |c#4@0| Tclass._module.Composite $Heap@@2) (=> (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#4@0|) _module.Composite.val))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#4@0|) _module.Composite.val)))) (= (ControlFlow 0 36) 35)) anon10_correct))))))))))
(let ((anon7_correct  (=> (forall ((|c#3| T@U) ) (!  (=> ($Is refType |c#3| Tclass._module.Composite) (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#3|)) (_module.Composite.Valid $Heap@0 |c#3| |S#0@@4|)))
 :qid |Compositedfy.86:20|
 :skolemid |575|
 :pattern ( (_module.Composite.Valid $Heap@0 |c#3| |S#0@@4|))
 :pattern ( (|Set#IsMember| |S#0@@4| ($Box refType |c#3|)))
)) (=> (and ($Is refType |c#4@0| Tclass._module.Composite) ($IsAlloc refType |c#4@0| Tclass._module.Composite $Heap@0)) (and (=> (= (ControlFlow 0 41) 36) anon30_Then_correct) (=> (= (ControlFlow 0 41) 40) anon30_Else_correct))))))
(let ((anon29_Else_correct  (=> (and (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#2@0|)) (_module.Composite.Valid $Heap@0 |c#2@0| |S#0@@4|)) (= (ControlFlow 0 44) 41)) anon7_correct)))
(let ((anon29_Then_correct  (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#2@0|)) (and (=> (= (ControlFlow 0 42) (- 0 43)) (or (not (= |c#2@0| null)) (not true))) (=> (or (not (= |c#2@0| null)) (not true)) (=> ($IsAllocBox ($Box refType |c#2@0|) Tclass._module.Composite? $Heap@0) (=> (and (and ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Composite) $Heap@0) (|_module.Composite.Valid#canCall| $Heap@0 |c#2@0| |S#0@@4|)) (and (_module.Composite.Valid $Heap@0 |c#2@0| |S#0@@4|) (= (ControlFlow 0 42) 41))) anon7_correct)))))))
(let ((anon4_correct  (=> (forall ((|c#1| T@U) ) (!  (=> ($Is refType |c#1| Tclass._module.Composite) (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#1|)) (_module.Composite.Valid $Heap@@2 |c#1| |S#0@@4|)))
 :qid |Compositedfy.84:21|
 :skolemid |573|
 :pattern ( (_module.Composite.Valid $Heap@@2 |c#1| |S#0@@4|))
 :pattern ( (|Set#IsMember| |S#0@@4| ($Box refType |c#1|)))
)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (forall (($o@@14 T@U) ) (!  (=> (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@14) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@14) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@14)) (|Set#IsMember| |S#0@@4| ($Box refType $o@@14))))
 :qid |Compositedfy.82:10|
 :skolemid |574|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@14))
)) ($HeapSucc $Heap@@2 $Heap@0)) (and ($Is refType |c#2@0| Tclass._module.Composite) ($IsAlloc refType |c#2@0| Tclass._module.Composite $Heap@0))) (and (=> (= (ControlFlow 0 45) 42) anon29_Then_correct) (=> (= (ControlFlow 0 45) 44) anon29_Else_correct)))))))
(let ((anon28_Else_correct  (=> (and (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#0@0|)) (_module.Composite.Valid $Heap@@2 |c#0@0| |S#0@@4|)) (= (ControlFlow 0 48) 45)) anon4_correct)))
(let ((anon28_Then_correct  (=> (|Set#IsMember| |S#0@@4| ($Box refType |c#0@0|)) (and (=> (= (ControlFlow 0 46) (- 0 47)) (or (not (= |c#0@0| null)) (not true))) (=> (or (not (= |c#0@0| null)) (not true)) (=> ($IsAllocBox ($Box refType |c#0@0|) Tclass._module.Composite? $Heap@@2) (=> (and (and ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Composite) $Heap@@2) (|_module.Composite.Valid#canCall| $Heap@@2 |c#0@0| |S#0@@4|)) (and (_module.Composite.Valid $Heap@@2 |c#0@0| |S#0@@4|) (= (ControlFlow 0 46) 45))) anon4_correct)))))))
(let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#3| null $Heap@@2 alloc |S#0@@4|)) (|Set#IsMember| |S#0@@4| ($Box refType this@@4))) (and ($IsAllocBox ($Box refType this@@4) Tclass._module.Composite? $Heap@@2) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Composite) $Heap@@2))) (and (and (|_module.Composite.Acyclic#canCall| $Heap@@2 this@@4 |S#0@@4|) (_module.Composite.Acyclic ($LS $LZ) $Heap@@2 this@@4 |S#0@@4|)) (and ($Is refType |c#0@0| Tclass._module.Composite) ($IsAlloc refType |c#0@0| Tclass._module.Composite $Heap@@2)))) (and (=> (= (ControlFlow 0 49) 46) anon28_Then_correct) (=> (= (ControlFlow 0 49) 48) anon28_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.Composite) ($IsAlloc refType this@@4 Tclass._module.Composite $Heap@@2)))) (and (and ($Is SetType |S#0@@4| (TSet Tclass._module.Composite)) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Composite) $Heap@@2)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 50) 49)))) anon0_correct)))
