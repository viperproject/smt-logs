...
(set-info :boogie-vc-id Impl$$_module.__default.Foo_split5)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 0 $FunctionContextHeight)) (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (U_2_bool (Lit boolType (bool_2_U true)))) (and (U_2_bool (Lit boolType (bool_2_U true))) (= |x#0| (LitInt 3)))) (and (and (= |r#0@0| (LitInt 7)) (= |r#0@2| |r#0@0|)) (and (> |r#0@2| 3) (= (ControlFlow 0 2) (- 0 1))))) (< |r#0@2| 10)))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
