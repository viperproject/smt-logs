...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon9_Else_correct  (=> |b#0@0| (=> (and (= |b#0@1| (U_2_bool (Lit boolType (bool_2_U false)))) (= (ControlFlow 0 6) (- 0 5))) false))))
(let ((anon9_Then_correct  (=> (and (not |b#0@0|) (= (ControlFlow 0 4) (- 0 3))) (U_2_bool (Lit boolType (bool_2_U false))))))
...
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |b#0@0| (U_2_bool (Lit boolType (bool_2_U true))))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (=> |$w$loop#0@0| (U_2_bool (Lit boolType (bool_2_U false))))) (=> (=> |$w$loop#0@0| (U_2_bool (Lit boolType (bool_2_U false)))) (=> (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |singlefiledfy.15:3|
 :skolemid |488|
