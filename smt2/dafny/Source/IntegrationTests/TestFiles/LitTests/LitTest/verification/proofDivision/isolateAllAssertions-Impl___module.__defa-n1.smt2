...
(set-info :boogie-vc-id Impl$$_module.__default.Foo_split1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (= 0 $FunctionContextHeight) (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false))) (and (U_2_bool (Lit boolType (bool_2_U true))) (= (ControlFlow 0 2) (- 0 1)))) (U_2_bool (Lit boolType (bool_2_U true)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
