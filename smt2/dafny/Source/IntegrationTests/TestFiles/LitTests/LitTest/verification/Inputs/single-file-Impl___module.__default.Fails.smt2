...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (U_2_bool (Lit boolType (bool_2_U false))))))
(let ((anon3_Else_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U false))) (= (ControlFlow 0 7) 6)) GeneratedUnifiedExit_correct)))
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (U_2_bool (Lit boolType (bool_2_U false)))) (=> (U_2_bool (Lit boolType (bool_2_U false))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (U_2_bool (Lit boolType (bool_2_U false)))) (=> (U_2_bool (Lit boolType (bool_2_U false))) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (Lit boolType (bool_2_U false))))))))))
