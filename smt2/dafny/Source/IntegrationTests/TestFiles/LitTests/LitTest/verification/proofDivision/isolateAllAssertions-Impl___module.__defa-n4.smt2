...
(set-info :boogie-vc-id Impl$$_module.__default.Foo_split4)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (= 0 $FunctionContextHeight) (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false))) (and (U_2_bool (Lit boolType (bool_2_U true))) (U_2_bool (Lit boolType (bool_2_U true))))) (and (and (= |x#0| (LitInt 3)) (= |r#0@0| (LitInt 7))) (and (= |r#0@2| |r#0@0|) (= (ControlFlow 0 2) (- 0 1))))) (> |r#0@2| 3)))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
