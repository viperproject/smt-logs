...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> |b'#0| |b'#0|)) (=> (=> |b'#0| |b'#0|) (and (=> (= (ControlFlow 0 2) (- 0 6)) (forall (($o@@5 T@U) ($f T@U) ) (! true
 :qid |ensuresstrongerdfy.16:10|
 :skolemid |496|
))) (=> (forall (($o@@6 T@U) ($f@@0 T@U) ) (! true
 :qid |ensuresstrongerdfy.16:10|
 :skolemid |496|
)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall (($o@@7 T@U) ($f@@1 T@U) ) (! true
 :qid |ensuresstrongerdfy.16:10|
 :skolemid |497|
))) (=> (forall (($o@@8 T@U) ($f@@2 T@U) ) (! true
 :qid |ensuresstrongerdfy.16:10|
 :skolemid |497|
)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@9 T@U) ) (!  (=> (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@9) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@9) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@9)))
 :qid |ensuresstrongerdfy.16:10|
 :skolemid |498|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@9))
))) (and ($HeapSucc $Heap $Heap@0) (_module.__default.P |res'#0|))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (_module.__default.P |res'#0|)) (=> (_module.__default.P |res'#0|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (_module.__default.P (+ |res'#0| 1))) (=> (_module.__default.P (+ |res'#0| 1)) (=> (= (ControlFlow 0 2) (- 0 1)) (=> |b'#0| (_module.__default.Q |res'#0|))))))))))))))))
