...
(declare-fun _module.__default.OrdinalSubtractionUnderflow (T@U T@U) T@U)
(declare-fun BoxType () T@T)
(declare-fun |_module.__default.OrdinalSubtractionUnderflow#canCall| (T@U T@U) Bool)
...
(assert (distinct TORDINAL TagORDINAL alloc)
)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|o0#0| T@U) (|o1#0| T@U) ) (!  (=> (or (|_module.__default.OrdinalSubtractionUnderflow#canCall| (Lit BoxType |o0#0|) (Lit BoxType |o1#0|)) (and (< 0 $FunctionContextHeight) (U_2_bool (Lit boolType (bool_2_U (|ORD#IsNat| (Lit BoxType |o1#0|))))))) (= (_module.__default.OrdinalSubtractionUnderflow (Lit BoxType |o0#0|) (Lit BoxType |o1#0|)) (Lit BoxType (|ORD#Minus| |o0#0| |o1#0|))))
 :qid |ordinalsubtractionunderflowdfy.4:38|
 :weight 3
 :skolemid |531|
 :pattern ( (_module.__default.OrdinalSubtractionUnderflow (Lit BoxType |o0#0|) (Lit BoxType |o1#0|)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|o0#0@@0| T@U) (|o1#0@@0| T@U) ) (!  (=> (or (|_module.__default.OrdinalSubtractionUnderflow#canCall| |o0#0@@0| |o1#0@@0|) (and (< 0 $FunctionContextHeight) (|ORD#IsNat| |o1#0@@0|))) (= (_module.__default.OrdinalSubtractionUnderflow |o0#0@@0| |o1#0@@0|) (|ORD#Minus| |o0#0@@0| |o1#0@@0|)))
 :qid |ordinalsubtractionunderflowdfy.4:38|
 :skolemid |530|
 :pattern ( (_module.__default.OrdinalSubtractionUnderflow |o0#0@@0| |o1#0@@0|))
))))
...
(declare-fun |o1#0@@1| () T@U)
(declare-fun |o0#0@@1| () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $Heap () T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$_module.__default.OrdinalSubtractionUnderflow)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (|ORD#IsNat| |o1#0@@1|)) (=> (|ORD#IsNat| |o1#0@@1|) (=> (= (ControlFlow 0 3) (- 0 2)) (<= (|ORD#Offset| |o1#0@@1|) (|ORD#Offset| |o0#0@@1|)))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (|ORD#IsNat| |o1#0@@1|)) (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 3) anon5_Else_correct)))))
