...
(assert (distinct alloc Tagclass._System.nat Tagclass._System.object? Tagclass._System.object Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 Tagclass._System.___hTotalFunc1 tytagFamily$nat tytagFamily$object |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1| |tytagFamily$_#TotalFunc1|)
)
...
(declare-fun |o#0| () T@U)
(declare-fun |p#0| () T@U)
(declare-fun _module._default.SubrangeCheck$T () T@U)
(declare-fun _module._default.SubrangeCheck$U () T@U)
(declare-fun |r#0| () T@U)
(declare-fun |i#0| () Int)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |defass#nonNullVar#0| () Bool)
(declare-fun |nonNullVar#0| () T@U)
(declare-fun |defass#totalVar#0| () Bool)
(declare-fun |totalVar#0| () T@U)
(declare-fun |partialVar#0| () T@U)
(declare-fun |natVar#0| () Int)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.SubrangeCheck)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 5)) ($Is refType |o#0| Tclass._System.object)) (=> ($Is refType |o#0| Tclass._System.object) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($Is HandleTypeType |p#0| (Tclass._System.___hTotalFunc1 _module._default.SubrangeCheck$T _module._default.SubrangeCheck$U))) (=> ($Is HandleTypeType |p#0| (Tclass._System.___hTotalFunc1 _module._default.SubrangeCheck$T _module._default.SubrangeCheck$U)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($Is HandleTypeType |r#0| (Tclass._System.___hPartialFunc1 _module._default.SubrangeCheck$T _module._default.SubrangeCheck$U))) (=> ($Is HandleTypeType |r#0| (Tclass._System.___hPartialFunc1 _module._default.SubrangeCheck$T _module._default.SubrangeCheck$U)) (=> (= (ControlFlow 0 2) (- 0 1)) ($Is intType (int_2_U |i#0|) Tclass._System.nat)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |o#0| Tclass._System.object?) ($IsAlloc refType |o#0| Tclass._System.object? $Heap))) (=> (and (and (and (and ($Is HandleTypeType |p#0| (Tclass._System.___hPartialFunc1 _module._default.SubrangeCheck$T _module._default.SubrangeCheck$U)) ($IsAlloc HandleTypeType |p#0| (Tclass._System.___hPartialFunc1 _module._default.SubrangeCheck$T _module._default.SubrangeCheck$U) $Heap)) (and ($Is HandleTypeType |r#0| (Tclass._System.___hFunc1 _module._default.SubrangeCheck$T _module._default.SubrangeCheck$U)) ($IsAlloc HandleTypeType |r#0| (Tclass._System.___hFunc1 _module._default.SubrangeCheck$T _module._default.SubrangeCheck$U) $Heap))) (and (and (=> |defass#nonNullVar#0| (and ($Is refType |nonNullVar#0| Tclass._System.object) ($IsAlloc refType |nonNullVar#0| Tclass._System.object $Heap))) true) (and (=> |defass#totalVar#0| (and ($Is HandleTypeType |totalVar#0| (Tclass._System.___hTotalFunc1 _module._default.SubrangeCheck$T _module._default.SubrangeCheck$U)) ($IsAlloc HandleTypeType |totalVar#0| (Tclass._System.___hTotalFunc1 _module._default.SubrangeCheck$T _module._default.SubrangeCheck$U) $Heap))) true))) (and (and (and ($Is HandleTypeType |partialVar#0| (Tclass._System.___hPartialFunc1 _module._default.SubrangeCheck$T _module._default.SubrangeCheck$U)) ($IsAlloc HandleTypeType |partialVar#0| (Tclass._System.___hPartialFunc1 _module._default.SubrangeCheck$T _module._default.SubrangeCheck$U) $Heap)) true) (and (and (<= (LitInt 0) |natVar#0|) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 6) 2))))) anon0_correct))))
