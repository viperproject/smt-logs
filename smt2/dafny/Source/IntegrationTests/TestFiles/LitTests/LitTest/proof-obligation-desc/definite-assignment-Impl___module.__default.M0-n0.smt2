...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let (($generated@@108  (and (=> (= (ControlFlow 0 2) (- 0 3)) $generated@@91) (=> $generated@@91 (=> (= (ControlFlow 0 2) (- 0 1)) $generated@@92)))))
(let (($generated@@109  (=> (and (and (<= 30 $generated@@93) (= $generated@@91 $generated@@94)) (and (= $generated@@92 $generated@@95) (= (ControlFlow 0 10) 2))) $generated@@108)))
(let (($generated@@110  (=> (< $generated@@93 30) (and (=> (= (ControlFlow 0 8) (- 0 9)) $generated@@95) (=> $generated@@95 (=> (= $generated@@91 true) (=> (and (= $generated@@92 true) (= (ControlFlow 0 8) 2)) $generated@@108)))))))
(let (($generated@@111  (=> (<= 20 $generated@@93) (and (=> (= (ControlFlow 0 11) 8) $generated@@110) (=> (= (ControlFlow 0 11) 10) $generated@@109)))))
(let (($generated@@112  (=> (< $generated@@93 20) (and (=> (= (ControlFlow 0 6) (- 0 7)) true) (=> (= $generated@@91 true) (=> (and (= $generated@@92 true) (= (ControlFlow 0 6) 2)) $generated@@108))))))
(let (($generated@@113  (=> (<= 10 $generated@@93) (and (=> (= (ControlFlow 0 12) 6) $generated@@112) (=> (= (ControlFlow 0 12) 11) $generated@@111)))))
(let (($generated@@114  (=> (and (and (< $generated@@93 10) (= $generated@@91 $generated@@94)) (and (= $generated@@92 true) (= (ControlFlow 0 5) 2))) $generated@@108)))
(let (($generated@@115  (=> (<= 0 $generated@@93) (and (=> (= (ControlFlow 0 13) 5) $generated@@114) (=> (= (ControlFlow 0 13) 12) $generated@@113)))))
(let (($generated@@116  (=> (and (and (< $generated@@93 0) (= $generated@@91 true)) (and (= $generated@@92 $generated@@95) (= (ControlFlow 0 4) 2))) $generated@@108)))
(let (($generated@@117  (=> (= $generated@@96 ($generated@@35 $generated@@97 $generated@@98 $generated@@99 false)) (and (=> (= (ControlFlow 0 14) 4) $generated@@116) (=> (= (ControlFlow 0 14) 13) $generated@@115)))))
(let (($generated@@118  (=> (and ($generated@@100 $generated@@98) ($generated@@101 $generated@@98)) (=> (and (and (and ($generated@@25 $generated@@102 $generated@@103) ($generated@@19 $generated@@102 $generated@@103 $generated@@98)) (and ($generated@@25 $generated@@104 $generated@@103) ($generated@@19 $generated@@104 $generated@@103 $generated@@98))) (and (and (=> $generated@@94 (and ($generated@@25 $generated@@105 $generated@@103) ($generated@@19 $generated@@105 $generated@@103 $generated@@98))) (=> $generated@@95 (and ($generated@@25 $generated@@106 $generated@@103) ($generated@@19 $generated@@106 $generated@@103 $generated@@98)))) (and (= 0 $generated@@107) (= (ControlFlow 0 15) 14)))) $generated@@117))))
$generated@@118))))))))))))
))
(check-sat)
