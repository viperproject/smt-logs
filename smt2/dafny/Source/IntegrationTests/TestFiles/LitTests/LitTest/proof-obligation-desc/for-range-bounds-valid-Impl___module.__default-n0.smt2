...
(declare-fun |_v0#0#lo@0| () Int)
(declare-fun |_v0#0#hi@0| () Int)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.ForRangeBoundsValid)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon6_LoopHead_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |_v0#0#lo@0| (LitInt 1)) (= |_v0#0#hi@0| (LitInt 0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= |_v0#0#lo@0| |_v0#0#hi@0|)) (=> (<= |_v0#0#lo@0| |_v0#0#hi@0|) (=> (= (ControlFlow 0 2) 1) anon6_LoopHead_correct)))))))
