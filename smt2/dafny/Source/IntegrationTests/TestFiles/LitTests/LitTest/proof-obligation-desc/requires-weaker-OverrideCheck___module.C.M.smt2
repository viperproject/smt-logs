...
(set-info :boogie-vc-id OverrideCheck$$_module.C.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (and (_module.__default.P |i'#0|) (_module.__default.Q |i'#0|)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (_module.__default.P |i'#0|)) (=> (_module.__default.P |i'#0|) (and (=> (= (ControlFlow 0 2) (- 0 6)) (_module.__default.Q (Mul |i'#0| (LitInt 2)))) (=> (_module.__default.Q (Mul |i'#0| (LitInt 2))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (_module.__default.P (+ |i'#0| 1)) (_module.__default.Q (+ |i'#0| 1)))) (=> (=> (_module.__default.P (+ |i'#0| 1)) (_module.__default.Q (+ |i'#0| 1))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= |i'#0| |i'#0|)) (=> (<= |i'#0| |i'#0|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@5 T@U) ($f T@U) ) (! true
 :qid |requiresweakerdfy.15:10|
 :skolemid |496|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.C) ($IsAlloc refType this Tclass._module.C $Heap))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 2))) anon0_correct))))
