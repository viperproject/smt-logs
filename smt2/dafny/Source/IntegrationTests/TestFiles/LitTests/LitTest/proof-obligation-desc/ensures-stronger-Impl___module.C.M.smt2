...
(assert (distinct TInt TagInt alloc Tagclass._module.T? Tagclass._module.T Tagclass._module.C? Tagclass._module.C tytagFamily$T tytagFamily$C)
)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |##i#1@0| (LitInt 0))) (and ($IsAlloc intType (int_2_U |##i#1@0|) TInt $Heap) (|_module.__default.P#canCall| (LitInt 0)))) (and (and (|_module.__default.P#canCall| (LitInt 0)) (_module.__default.P (LitInt 0))) (and (= |res'#0@0| (LitInt 0)) (= (ControlFlow 0 2) (- 0 1))))) (_module.__default.P |res'#0@0|))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.C) ($IsAlloc refType this Tclass._module.C $Heap))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
