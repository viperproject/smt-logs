...
(declare-fun _module.__default.OrdinalSubtractionIsNatural (T@U T@U) T@U)
(declare-fun BoxType () T@T)
(declare-fun |_module.__default.OrdinalSubtractionIsNatural#canCall| (T@U T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|o0#0| T@U) (|o1#0| T@U) ) (!  (=> (or (|_module.__default.OrdinalSubtractionIsNatural#canCall| (Lit BoxType |o0#0|) (Lit BoxType |o1#0|)) (and (< 0 $FunctionContextHeight) (<= (LitInt (|ORD#Offset| (Lit BoxType |o1#0|))) (LitInt (|ORD#Offset| (Lit BoxType |o0#0|)))))) (= (_module.__default.OrdinalSubtractionIsNatural (Lit BoxType |o0#0|) (Lit BoxType |o1#0|)) (Lit BoxType (|ORD#Minus| |o0#0| |o1#0|))))
 :qid |ordinalsubtractionisnaturaldfy.4:38|
 :weight 3
 :skolemid |531|
 :pattern ( (_module.__default.OrdinalSubtractionIsNatural (Lit BoxType |o0#0|) (Lit BoxType |o1#0|)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|o0#0@@0| T@U) (|o1#0@@0| T@U) ) (!  (=> (or (|_module.__default.OrdinalSubtractionIsNatural#canCall| |o0#0@@0| |o1#0@@0|) (and (< 0 $FunctionContextHeight) (<= (|ORD#Offset| |o1#0@@0|) (|ORD#Offset| |o0#0@@0|)))) (= (_module.__default.OrdinalSubtractionIsNatural |o0#0@@0| |o1#0@@0|) (|ORD#Minus| |o0#0@@0| |o1#0@@0|)))
 :qid |ordinalsubtractionisnaturaldfy.4:38|
 :skolemid |530|
 :pattern ( (_module.__default.OrdinalSubtractionIsNatural |o0#0@@0| |o1#0@@0|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.OrdinalSubtractionIsNatural)
...
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (<= (|ORD#Offset| |o1#0@@1|) (|ORD#Offset| |o0#0@@1|))) (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 3) anon5_Else_correct)))))
