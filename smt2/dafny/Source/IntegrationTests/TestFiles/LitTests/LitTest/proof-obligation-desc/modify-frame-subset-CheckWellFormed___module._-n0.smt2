...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.ModifyStmt)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |s#0| (TSeq Tclass._module.C)) ($IsAlloc SeqType |s#0| (TSeq Tclass._module.C) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct))))
