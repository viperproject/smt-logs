...
(assert (forall (($h@@4 T@U) ($o@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (or (not (= $o@@4 null)) (not true)) (= (dtype $o@@4) Tclass._module.C?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@4) _module.C.y)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |580|
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) (|l#5| T@U) (|l#6| T@U) ($o@@5 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#2| |l#0| |l#1| |l#2| |l#3| |l#4| |l#5| |l#6|) $o@@5 $f))  (=> (and (or (not (= $o@@5 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@5) |l#2|)))) (or (= $o@@5 |l#3|) (and (and ($Is refType $o@@5 |l#4|) (|Seq#Contains| |l#5| ($Box refType $o@@5))) (= $f |l#6|)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |600|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#2| |l#0| |l#1| |l#2| |l#3| |l#4| |l#5| |l#6|) $o@@5 $f))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.ModifyObjects)
...
(let ((anon3_Then_correct  (=> (and (and ($Is refType |c#0_0@0| Tclass._module.C) ($IsAlloc refType |c#0_0@0| Tclass._module.C $Heap)) (|Seq#Contains| |s#0| ($Box refType |c#0_0@0|))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |c#0_0@0| null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0_0@0| _module.C.x))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0_0@0| _module.C.x)) (=> (and (and (and ($Is refType |c#0_1@0| Tclass._module.C) ($IsAlloc refType |c#0_1@0| Tclass._module.C $Heap)) (|Seq#Contains| |s#0| ($Box refType |c#0_1@0|))) (and (or (not (= |c#0_0@0| |c#0_1@0|)) (not true)) (= (ControlFlow 0 2) (- 0 1)))) (or (or (or (not (= |c#0_0@0| |c#0_1@0|)) (not true)) (or (not (= _module.C.x _module.C.x)) (not true))) (= (LitInt 1) (LitInt 1))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#2| null $Heap alloc ($Unbox refType (|Seq#Index| |s#0| (LitInt 1))) Tclass._module.C |s#0| _module.C.y)) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SeqType |s#0| (TSeq Tclass._module.C)) ($IsAlloc SeqType |s#0| (TSeq Tclass._module.C) $Heap)) (= 1 $FunctionContextHeight)) (and (> (|Seq#Length| |s#0|) 1) (= (ControlFlow 0 7) 6))) anon0_correct))))
