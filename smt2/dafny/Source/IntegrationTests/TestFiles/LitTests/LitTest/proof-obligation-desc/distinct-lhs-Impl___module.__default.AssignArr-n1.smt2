...
(set-info :boogie-vc-id Impl$$_module.__default.AssignArray)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc |a#0|)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (and (<= 0 |i#0|) (< |i#0| (_System.array.Length |a#0|)))) (=> (and (<= 0 |i#0|) (< |i#0| (_System.array.Length |a#0|))) (=> (= $index0@0 (IndexField |i#0|)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| $index0@0))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| $index0@0)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= 0 |j#0|) (< |j#0| (_System.array.Length |a#0|)))) (=> (and (<= 0 |j#0|) (< |j#0| (_System.array.Length |a#0|))) (=> (= $index1@0 (IndexField |j#0|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| $index1@0))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| $index1@0)) (=> (and (= |$rhs#1@0| (+ |x#0| 1)) (= (ControlFlow 0 2) (- 0 1))) (or (or (or (not (= |a#0| |a#0|)) (not true)) (or (not (= |j#0| |i#0|)) (not true))) (= ($Box intType (int_2_U |$rhs#1@0|)) ($Box intType (int_2_U |x#0|))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (<= (LitInt 0) |i#0|) (<= (LitInt 0) |j#0|))) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (and (= 0 $FunctionContextHeight) (<= (LitInt 0) |i#0|))) (and (and (< |i#0| (_System.array.Length |a#0|)) (<= (LitInt 0) |j#0|)) (and (< |j#0| (_System.array.Length |a#0|)) (= (ControlFlow 0 9) 2)))) anon0_correct))))
