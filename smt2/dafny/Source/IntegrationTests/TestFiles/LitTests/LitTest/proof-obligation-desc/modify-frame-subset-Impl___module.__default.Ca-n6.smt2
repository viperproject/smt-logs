...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc ($Unbox refType (|Seq#Index| |s#0| (LitInt 3))) ($Unbox refType (|Seq#Index| |s#0| (LitInt 4))) _module.C.x ($Unbox refType (|Seq#Index| |s#0| (LitInt 5))) _module.C.y)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@6 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (or (or (= $o@@6 ($Unbox refType (|Seq#Index| |s#0| (LitInt 0)))) (and (= $o@@6 ($Unbox refType (|Seq#Index| |s#0| (LitInt 1)))) (= $f@@0 _module.C.x))) (and (= $o@@6 ($Unbox refType (|Seq#Index| |s#0| (LitInt 2)))) (= $f@@0 _module.C.y)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@6 $f@@0)))
 :qid |modifyframesubsetdfy.39:9|
 :skolemid |508|
))) (=> (forall (($o@@7 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@7) alloc)))) (or (or (= $o@@7 ($Unbox refType (|Seq#Index| |s#0| (LitInt 0)))) (and (= $o@@7 ($Unbox refType (|Seq#Index| |s#0| (LitInt 1)))) (= $f@@1 _module.C.x))) (and (= $o@@7 ($Unbox refType (|Seq#Index| |s#0| (LitInt 2)))) (= $f@@1 _module.C.y)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@7 $f@@1)))
 :qid |modifyframesubsetdfy.39:9|
 :skolemid |508|
)) (=> (= (ControlFlow 0 2) (- 0 1)) (> (|Seq#Length| |s#0|) 5)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SeqType |s#0| (TSeq Tclass._module.C)) ($IsAlloc SeqType |s#0| (TSeq Tclass._module.C) $Heap)) (= 2 $FunctionContextHeight)) (and (> (|Seq#Length| |s#0|) 5) (= (ControlFlow 0 4) 2))) anon0_correct))))
