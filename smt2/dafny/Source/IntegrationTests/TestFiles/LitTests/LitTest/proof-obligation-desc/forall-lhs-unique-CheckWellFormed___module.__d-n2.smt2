...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.ForallLHSUniqueObj)
...
(let ((anon9_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#1@0|) (< |i#1@0| (_System.array.Length |a#0|)))) (= (ControlFlow 0 6) 2)) anon6_correct)))
(let ((anon9_Then_correct  (=> (and (<= (LitInt 0) |i#1@0|) (< |i#1@0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 |i#1@0|) (< |i#1@0| (_System.array.Length |a#0|)))) (=> (and (<= 0 |i#1@0|) (< |i#1@0| (_System.array.Length |a#0|))) (=> (= (ControlFlow 0 3) 2) anon6_correct))))))))
(let ((anon8_Else_correct  (=> (< |i#1@0| (LitInt 0)) (and (=> (= (ControlFlow 0 9) 3) anon9_Then_correct) (=> (= (ControlFlow 0 9) 6) anon9_Else_correct)))))
(let ((anon8_Then_correct  (=> (<= (LitInt 0) |i#1@0|) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 7) 3) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))))
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#2| null $Heap alloc |a#0| (LitInt 0) (_System.array.Length |a#0|) $Heap |a#0| $Heap |a#0| _module.C.f)) (and (=> (= (ControlFlow 0 11) 10) anon7_Then_correct) (=> (= (ControlFlow 0 11) 1) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |a#0| (Tclass._System.array Tclass._module.C)) ($IsAlloc refType |a#0| (Tclass._System.array Tclass._module.C) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 12) 11))) anon0_correct))))
