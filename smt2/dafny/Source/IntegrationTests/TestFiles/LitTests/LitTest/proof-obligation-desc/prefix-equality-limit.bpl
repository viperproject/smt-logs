// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/proof-obligation-desc/prefix-equality-limit.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/proof-obligation-desc/prefix-equality-limit-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/proof-obligation-desc/prefix-equality-limit.dfy
...
procedure {:verboseName "PrefixEqualityLimit (well-formedness)"} CheckWellFormed$$_module.__default.PrefixEqualityLimit(s#0: DatatypeType
...
procedure {:verboseName "PrefixEqualityLimit (call)"} Call$$_module.__default.PrefixEqualityLimit(s#0: DatatypeType
       where $Is(s#0, Tclass._module.Stream())
         && $IsAlloc(s#0, Tclass._module.Stream(), $Heap)
         && $IsA#_module.Stream(s#0), 
    i#0: int);
...
procedure {:verboseName "PrefixEqualityLimit (correctness)"} Impl$$_module.__default.PrefixEqualityLimit(s#0: DatatypeType
       where $Is(s#0, Tclass._module.Stream())
         && $IsAlloc(s#0, Tclass._module.Stream(), $Heap)
         && $IsA#_module.Stream(s#0), 
    i#0: int)
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "PrefixEqualityLimit (correctness)"} Impl$$_module.__default.PrefixEqualityLimit(s#0: DatatypeType, i#0: int) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var g#0: bool;

    // AddMethodImpl: PrefixEqualityLimit, Impl$$_module.__default.PrefixEqualityLimit
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/proof-obligation-desc/prefix-equality-limit.dfy(7,15)
    assume true;
    assert {:id "id0"} 0 <= i#0;
    assume true;
    g#0 := $PrefixEq#_module.Stream(ORD#FromNat(i#0), $LS($LS($LZ)), s#0, s#0);
}



// Constructor function declaration
function #_module.Stream.More(DatatypeType) : DatatypeType;

const unique ##_module.Stream.More: DtCtorId
uses {
// Constructor identifier
axiom (forall a#0#0#0: DatatypeType :: 
  { #_module.Stream.More(a#0#0#0) } 
  DatatypeCtorId(#_module.Stream.More(a#0#0#0)) == ##_module.Stream.More);
}
...
axiom (forall d: DatatypeType :: 
  { _module.Stream.More_q(d) } 
  _module.Stream.More_q(d)
     ==> (exists a#1#0#0: DatatypeType :: d == #_module.Stream.More(a#1#0#0)));

// Constructor $Is
axiom (forall a#2#0#0: DatatypeType :: 
  { $Is(#_module.Stream.More(a#2#0#0), Tclass._module.Stream()) } 
  $Is(#_module.Stream.More(a#2#0#0), Tclass._module.Stream())
     <==> $Is(a#2#0#0, Tclass._module.Stream()));

// Destructor $IsAlloc
axiom (forall d: DatatypeType, $h: Heap :: 
  { $IsAlloc(_module.Stream._h0(d), Tclass._module.Stream(), $h) } 
  $IsGoodHeap($h)
       && 
      _module.Stream.More_q(d)
...
function _module.Stream._h0(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#3#0#0: DatatypeType :: 
  { #_module.Stream.More(a#3#0#0) } 
  _module.Stream._h0(#_module.Stream.More(a#3#0#0)) == a#3#0#0);
     ...
     ==> ($Eq#_module.Stream($LS(ly), d0, d1)
       <==> _module.Stream.More_q(d0)
         ...
         && (_module.Stream.More_q(d0) && _module.Stream.More_q(d1)
           ==> $Eq#_module.Stream(ly, _module.Stream._h0(d0), _module.Stream._h0(d1)))));
     ...
     ==> ($PrefixEq#_module.Stream(k, $LS(ly), d0, d1)
       <==> (0 < ORD#Offset(k)
           ==> _module.Stream.More_q(d0)
             && _module.Stream.More_q(d1)
             && (_module.Stream.More_q(d0) && _module.Stream.More_q(d1)
               ==> $PrefixEq#_module.Stream(ORD#Minus(k, ORD#FromNat(1)), ly, _module.Stream._h0(d0), _module.Stream._h0(d1))))
