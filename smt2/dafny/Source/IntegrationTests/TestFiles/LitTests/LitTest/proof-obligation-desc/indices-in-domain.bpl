// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/proof-obligation-desc/indices-in-domain.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/proof-obligation-desc/indices-in-domain-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/proof-obligation-desc/indices-in-domain.dfy
...
procedure {:verboseName "IndicesInDomain (well-formedness)"} CheckWellFormed$$_module.__default.IndicesInDomain();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "IndicesInDomain (call)"} Call$$_module.__default.IndicesInDomain();
  modifies $Heap;
...
procedure {:verboseName "IndicesInDomain (correctness)"} Impl$$_module.__default.IndicesInDomain() returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "IndicesInDomain (correctness)"} Impl$$_module.__default.IndicesInDomain() returns ($_reverifyPost: bool)
{
  ...
  var $nw: ref;
  var a2#0: ref
     where $Is(a2#0, Tclass._System.array2(TInt))
       && $IsAlloc(a2#0, Tclass._System.array2(TInt), $Heap);
  ...
  var lambdaResult#2: int;
    ...
    // AddMethodImpl: IndicesInDomain, Impl$$_module.__default.IndicesInDomain
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/proof-obligation-desc/indices-in-domain.dfy(5,12)
    assume true;
    ...
    if (*)
    {
        ...
        if (LitInt(0) <= i#0)
        {
            ...
            if (i#0 > 0)
            {
                assume {:id "id1"} lambdaResult#0 == LitInt(1);
                assume true;
      ...
      0 <= arrayinit#0#i0#0 && arrayinit#0#i0#0 < LitInt(1)
         ==> Requires1(Tclass._System.nat(), 
          ...
          Lit(AtLayer((lambda $l#0#ly#0: LayerType :: 
                Handle1((lambda $l#0#heap#0: Heap, $l#0#i#0: Box :: $Box(LitInt(1))), 
                  (lambda $l#0#heap#0: Heap, $l#0#i#0: Box :: 
                    $IsBox($l#0#i#0, Tclass._System.nat()) && $Unbox($l#0#i#0): int > 0), 
                  (lambda $l#0#heap#0: Heap, $l#0#i#0: Box :: 
    ...
    a1#0 := $nw;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/proof-obligation-desc/indices-in-domain.dfy(6,12)
    assume true;
    assert {:id "id4"} 0 <= LitInt(1);
    ...
    if (*)
    {
        ...
        if (LitInt(0) <= i#1)
        {
            ...
            if (i#1 > 0 && j#0 < 0)
            {
                assume {:id "id6"} lambdaResult#1 == LitInt(1);
                assume true;
                // CheckWellformedWithResult: any expression
    ...
    assert {:id "id7"} {:subsumption 0} (forall arrayinit#1#i0#0: int, arrayinit#1#i1#0: int :: 
      0 <= arrayinit#1#i0#0
           && arrayinit#1#i0#0 < LitInt(1)
           && 
          0 <= arrayinit#1#i1#0
           && arrayinit#1#i1#0 < LitInt(1)
         ==> Requires2(Tclass._System.nat(), 
          TInt, 
          TInt, 
          $Heap, 
          Lit(AtLayer((lambda $l#1#ly#0: LayerType :: 
                Handle2((lambda $l#1#heap#0: Heap, $l#1#i#0: Box, $l#1#j#0: Box :: $Box(LitInt(1))), 
    ...
    assume $IsHeapAnchor($Heap);
    a2#0 := $nw;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/proof-obligation-desc/indices-in-domain.dfy(7,11)
    assume true;
    assert {:id "id9"} 0 <= LitInt(1);
    // Begin Comprehension WF check
    if (*)
    {
        havoc $lambdaHeap#2;
        ...
        if (true)
        {
            ...
            if (i#2 > 0)
            {
                assume {:id "id10"} lambdaResult#2 == LitInt(1);
                assume true;
                // CheckWellformedWithResult: any expression
      ...
      0 <= seqinit#0#i0#0 && seqinit#0#i0#0 < LitInt(1)
         ==> Requires1(TInt, 
          ...
          Lit(AtLayer((lambda $l#3#ly#0: LayerType :: 
                Handle1((lambda $l#3#heap#0: Heap, $l#3#i#0: Box :: $Box(LitInt(1))), 
                  (lambda $l#3#heap#0: Heap, $l#3#i#0: Box :: 
                    $IsBox($l#3#i#0, TInt) && $Unbox($l#3#i#0): int > 0), 
                  (lambda $l#3#heap#0: Heap, $l#3#i#0: Box :: 
    ...
    s#0 := Seq#Create(TInt, 
      ...
      Lit(AtLayer((lambda $l#2#ly#0: LayerType :: 
            Handle1((lambda $l#2#heap#0: Heap, $l#2#i#0: Box :: $Box(LitInt(1))), 
              (lambda $l#2#heap#0: Heap, $l#2#i#0: Box :: 
                $IsBox($l#2#i#0, TInt) && $Unbox($l#2#i#0): int > 0), 
              (lambda $l#2#heap#0: Heap, $l#2#i#0: Box :: 
