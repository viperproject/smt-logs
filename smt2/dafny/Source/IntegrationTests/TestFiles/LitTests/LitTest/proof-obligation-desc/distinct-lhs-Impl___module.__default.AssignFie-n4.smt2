...
(assert (distinct TInt TagInt alloc allocName Tagclass._module.C class._module.C? Tagclass._module.C? tytagFamily$C field$f)
)
(assert (= (FDim alloc) 0))
...
(set-info :boogie-vc-id Impl$$_module.__default.AssignField)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc |c#0@@1|)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= |c#0@@1| null)) (not true))) (=> (or (not (= |c#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@1| _module.C.f))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@1| _module.C.f)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |c#0@@1| null)) (not true))) (=> (or (not (= |c#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@1| _module.C.f))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@1| _module.C.f)) (=> (and (= |$rhs#1@0| (+ |x#0| 1)) (= (ControlFlow 0 2) (- 0 1))) (or (or (not (= |c#0@@1| |c#0@@1|)) (not true)) (= |$rhs#1@0| |x#0|))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |c#0@@1| Tclass._module.C) ($IsAlloc refType |c#0@@1| Tclass._module.C $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 7) 2))) anon0_correct))))
