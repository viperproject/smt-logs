...
(set-info :boogie-vc-id Impl$$_module.__default.ForallLHSUniqueArray)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon3_correct  (=> (and (<= (LitInt 0) |i#0_0@0|) (< |i#0_0@0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |a#0|)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField (LitInt 0))))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField (LitInt 0)))) (=> (and (and (<= (LitInt 0) |i#0_1@0|) (< |i#0_1@0| (_System.array.Length |a#0|))) (and (or (not (= |i#0_0@0| |i#0_1@0|)) (not true)) (= (ControlFlow 0 3) (- 0 2)))) (or (or (or (not (= |a#0| |a#0|)) (not true)) (or (not (= (IndexField (LitInt 0)) (IndexField (LitInt 0)))) (not true))) (= |i#0_0@0| |i#0_1@0|)))))))))))
(let ((anon6_Else_correct  (=> (and (< |i#0_0@0| (LitInt 0)) (= (ControlFlow 0 9) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (<= (LitInt 0) |i#0_0@0|) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (not (= |a#0| null)) (not true))) (=> (= (ControlFlow 0 7) 3) anon3_correct)))))
(let ((anon5_Then_correct  (and (=> (= (ControlFlow 0 10) 7) anon6_Then_correct) (=> (= (ControlFlow 0 10) 9) anon6_Else_correct))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc |a#0|)) (and (=> (= (ControlFlow 0 11) 10) anon5_Then_correct) (=> (= (ControlFlow 0 11) 1) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 12) 11))) anon0_correct))))
