...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (=> |y#0| (U_2_bool (Lit boolType (bool_2_U false)))) (=> (= |y#0| (U_2_bool (Lit boolType (bool_2_U false)))) (<= |x#0| |x#0|)))) (=> (and (=> |y#0| (U_2_bool (Lit boolType (bool_2_U false)))) (=> (= |y#0| (U_2_bool (Lit boolType (bool_2_U false)))) (<= |x#0| |x#0|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@5 T@U) ($f T@U) ) true)) (=> (forall (($o@@6 T@U) ($f@@0 T@U) ) true) (=> (= (ControlFlow 0 2) (- 0 1)) (forall (($o@@7 T@U) ($f@@1 T@U) ) true))))))))
