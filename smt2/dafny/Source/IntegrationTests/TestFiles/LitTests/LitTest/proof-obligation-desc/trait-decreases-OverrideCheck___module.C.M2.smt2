...
(set-info :boogie-vc-id OverrideCheck$$_module.C.M2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (=> |y#0| (U_2_bool (Lit boolType (bool_2_U false)))) (=> (= |y#0| (U_2_bool (Lit boolType (bool_2_U false)))) (<= |x#0| |x#0|)))) (=> (and (=> |y#0| (U_2_bool (Lit boolType (bool_2_U false)))) (=> (= |y#0| (U_2_bool (Lit boolType (bool_2_U false)))) (<= |x#0| |x#0|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@5 T@U) ($f T@U) ) (! true
 :qid |traitdecreasesdfy.15:10|
 :skolemid |508|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.C) ($IsAlloc refType this Tclass._module.C $Heap))) (<= (LitInt 0) |x#0|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct))))
