...
(assert (distinct TInt TagInt TagSeq alloc allocName Tagclass._module.C class._module.C? Tagclass._module.C? tytagFamily$C field$y)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) (|l#5| T@U) (|l#6| T@U) ($o@@3 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#2| |l#0| |l#1| |l#2| |l#3| |l#4| |l#5| |l#6|) $o@@3 $f))  (=> (and (or (not (= $o@@3 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@3) |l#2|)))) (or (= $o@@3 |l#3|) (and (and ($Is refType $o@@3 |l#4|) (|Seq#Contains| |l#5| ($Box refType $o@@3))) (= $f |l#6|)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |600|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#2| |l#0| |l#1| |l#2| |l#3| |l#4| |l#5| |l#6|) $o@@3 $f))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.ModifyObjects)
...
(let ((anon6_Else_correct  (=> (and (not (|Seq#Contains| |s#0| ($Box refType |c#0@0|))) (= (ControlFlow 0 4) 1)) anon4_correct)))
(let ((anon6_Then_correct  (=> (and (|Seq#Contains| |s#0| ($Box refType |c#0@0|)) (= (ControlFlow 0 3) 1)) anon4_correct)))
(let ((anon5_Then_correct  (=> (and ($Is refType |c#0@0| Tclass._module.C) ($IsAlloc refType |c#0@0| Tclass._module.C $Heap)) (and (=> (= (ControlFlow 0 5) 3) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (not (and ($Is refType |c#0@0| Tclass._module.C) ($IsAlloc refType |c#0@0| Tclass._module.C $Heap))) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#2| null $Heap alloc ($Unbox refType (|Seq#Index| |s#0| (LitInt 1))) Tclass._module.C |s#0| _module.C.y)) (> (|Seq#Length| |s#0|) 1)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |s#0|)))) (=> (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |s#0|))) (and (=> (= (ControlFlow 0 6) 5) anon5_Then_correct) (=> (= (ControlFlow 0 6) 2) anon5_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |s#0| (TSeq Tclass._module.C)) ($IsAlloc SeqType |s#0| (TSeq Tclass._module.C) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 6))) anon0_correct))))
