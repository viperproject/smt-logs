...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.AssignMultiArray)
...
(let ((anon13_Else_correct  (=> (and (< |j1#0| (LitInt 0)) (= (ControlFlow 0 4) 1)) anon9_correct)))
(let ((anon13_Then_correct  (=> (<= (LitInt 0) |j1#0|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (= (ControlFlow 0 2) 1) anon9_correct))))))
(let ((anon7_correct  (=> (and (<= (LitInt 0) |j0#0|) (< |j0#0| (_System.array2.Length0 |a#0|))) (and (=> (= (ControlFlow 0 5) 2) anon13_Then_correct) (=> (= (ControlFlow 0 5) 4) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (< |j0#0| (LitInt 0)) (= (ControlFlow 0 8) 5)) anon7_correct)))
(let ((anon12_Then_correct  (=> (<= (LitInt 0) |j0#0|) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (= (ControlFlow 0 6) 5) anon7_correct))))))
(let ((anon5_correct  (=> (and (<= (LitInt 0) |i1#0|) (< |i1#0| (_System.array2.Length1 |a#0|))) (and (=> (= (ControlFlow 0 9) 6) anon12_Then_correct) (=> (= (ControlFlow 0 9) 8) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (< |i1#0| (LitInt 0)) (= (ControlFlow 0 12) 9)) anon5_correct)))
(let ((anon11_Then_correct  (=> (<= (LitInt 0) |i1#0|) (and (=> (= (ControlFlow 0 10) (- 0 11)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (= (ControlFlow 0 10) 9) anon5_correct))))))
(let ((anon3_correct  (=> (and (<= (LitInt 0) |i0#0|) (< |i0#0| (_System.array2.Length0 |a#0|))) (and (=> (= (ControlFlow 0 13) 10) anon11_Then_correct) (=> (= (ControlFlow 0 13) 12) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (< |i0#0| (LitInt 0)) (= (ControlFlow 0 16) 13)) anon3_correct)))
(let ((anon10_Then_correct  (=> (<= (LitInt 0) |i0#0|) (and (=> (= (ControlFlow 0 14) (- 0 15)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (= (ControlFlow 0 14) 13) anon3_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc |a#0|)) (and (=> (= (ControlFlow 0 17) 14) anon10_Then_correct) (=> (= (ControlFlow 0 17) 16) anon10_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (<= (LitInt 0) |i0#0|) (<= (LitInt 0) |i1#0|)) (and (<= (LitInt 0) |j0#0|) (<= (LitInt 0) |j1#0|))) (and (and ($Is refType |a#0| (Tclass._System.array2 TInt)) ($IsAlloc refType |a#0| (Tclass._System.array2 TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 18) 17)))) anon0_correct))))
