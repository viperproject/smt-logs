...
(declare-fun _module.__default.IsInteger (Real) Int)
(declare-fun |_module.__default.IsInteger#canCall| (Real) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|r#0| Real) ) (!  (=> (or (|_module.__default.IsInteger#canCall| |r#0|) (< 0 $FunctionContextHeight)) (= (_module.__default.IsInteger |r#0|) (q@Int |r#0|)))
 :qid |isintegerdfy.4:20|
 :skolemid |481|
 :pattern ( (_module.__default.IsInteger |r#0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|r#0@@0| Real) ) (!  (=> (or (|_module.__default.IsInteger#canCall| (LitReal |r#0@@0|)) (< 0 $FunctionContextHeight)) (= (_module.__default.IsInteger (LitReal |r#0@@0|)) (q@Int (LitReal |r#0@@0|))))
 :qid |isintegerdfy.4:20|
 :weight 3
 :skolemid |482|
 :pattern ( (_module.__default.IsInteger (LitReal |r#0@@0|)))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.IsInteger)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (= (q@Real (q@Int |r#0@@1|)) |r#0@@1|))))
