...
(declare-fun |a#0| () T@U)
(declare-fun _module._default.ArrayInitEmpty$T () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.ArrayInitEmpty)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= 0 (LitInt 1))) (=> (<= 0 (LitInt 1)) (=> (= (ControlFlow 0 2) (- 0 1)) (= 0 (LitInt 1))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array _module._default.ArrayInitEmpty$T)) ($IsAlloc refType |a#0| (Tclass._System.array _module._default.ArrayInitEmpty$T) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
