...
(set-info :boogie-vc-id OverrideCheck$$_module.C.M1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (not |y#0|) |y#0|)) (=> (and (not |y#0|) |y#0|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@5 T@U) ($f T@U) ) (! true
 :qid |traitdecreasesdfy.13:10|
 :skolemid |502|
