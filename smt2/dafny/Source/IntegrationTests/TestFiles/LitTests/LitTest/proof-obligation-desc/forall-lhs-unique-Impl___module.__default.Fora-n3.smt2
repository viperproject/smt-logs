...
(declare-fun |lambda#2| (T@U T@U T@U T@U Int Int T@U T@U T@U T@U T@U) T@U)
...
(assert (distinct TInt TagInt alloc allocName Tagclass._System.array? Tagclass._System.array Tagclass._module.C class._module.C? Tagclass._module.C? tytagFamily$array tytagFamily$C field$f)
)
(assert (= (FDim alloc) 0))
...
(assert (forall (($h@@4 T@U) ($o@@4 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@4) (and (or (not (= $o@@4 null)) (not true)) (= (dtype $o@@4) Tclass._module.C?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@4) alloc)))) ($IsAlloc intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@4) _module.C.f)) TInt $h@@4))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |580|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@4) _module.C.f)))
)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| Int) (|l#5| Int) (|l#6| T@U) (|l#7| T@U) (|l#8| T@U) (|l#9| T@U) (|l#10| T@U) ($o@@6 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#2| |l#0| |l#1| |l#2| |l#3| |l#4| |l#5| |l#6| |l#7| |l#8| |l#9| |l#10|) $o@@6 $f))  (=> (and (or (not (= $o@@6 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@6) |l#2|)))) (or (= $o@@6 |l#3|) (and (exists ((|i#0| Int) ) (!  (and (and (<= |l#4| |i#0|) (< |i#0| |l#5|)) (= ($Box refType $o@@6) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#6| |l#7|) (IndexField |i#0|))))
 :qid |foralllhsuniquedfy.24:18|
 :skolemid |559|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#8| |l#9|) (IndexField |i#0|))))
)) (= $f |l#10|)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |584|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#2| |l#0| |l#1| |l#2| |l#3| |l#4| |l#5| |l#6| |l#7| |l#8| |l#9| |l#10|) $o@@6 $f))
)))
...
(assert (forall (($h@@7 T@U) ($o@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (or (not (= $o@@9 null)) (not true)) (= (dtype $o@@9) Tclass._module.C?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@9) _module.C.f)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |579|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@9) _module.C.f)))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.ForallLHSUniqueObj)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon3_correct  (=> (and (<= (LitInt 0) |i#0_0@0|) (< |i#0_0@0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (and (<= 0 |i#0_0@0|) (< |i#0_0@0| (_System.array.Length |a#0|)))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#0_0@0|))) null)) (not true))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#0_0@0|))) _module.C.f))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#0_0@0|))) _module.C.f)) (=> (and (and (<= (LitInt 0) |i#0_1@0|) (< |i#0_1@0| (_System.array.Length |a#0|))) (and (or (not (= |i#0_0@0| |i#0_1@0|)) (not true)) (= (ControlFlow 0 3) (- 0 2)))) (or (or (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#0_0@0|))) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#0_1@0|))))) (not true)) (or (not (= _module.C.f _module.C.f)) (not true))) (= |i#0_0@0| |i#0_1@0|))))))))))))
(let ((anon6_Else_correct  (=> (and (< |i#0_0@0| (LitInt 0)) (= (ControlFlow 0 10) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (<= (LitInt 0) |i#0_0@0|) (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (not (= |a#0| null)) (not true))) (=> (= (ControlFlow 0 8) 3) anon3_correct)))))
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#2| null $Heap alloc |a#0| (LitInt 0) (_System.array.Length |a#0|) $Heap |a#0| $Heap |a#0| _module.C.f)) (and (=> (= (ControlFlow 0 12) 11) anon5_Then_correct) (=> (= (ControlFlow 0 12) 1) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |a#0| (Tclass._System.array Tclass._module.C)) ($IsAlloc refType |a#0| (Tclass._System.array Tclass._module.C) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 13) 12))) anon0_correct))))
