...
(declare-fun _module.__default.ShiftUpperBound ((_ BitVec 2)) (_ BitVec 2))
(declare-fun |_module.__default.ShiftUpperBound#canCall| ((_ BitVec 2)) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|b#0| (_ BitVec 2)) ) (!  (=> (or (|_module.__default.ShiftUpperBound#canCall| |b#0|) (< 0 $FunctionContextHeight)) (= (_module.__default.ShiftUpperBound |b#0|) (ext_rotate_left |b#0| #b11)))
 :qid |shiftupperbounddfy.4:26|
 :skolemid |485|
 :pattern ( (_module.__default.ShiftUpperBound |b#0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|b#0@@0| T@U) ) (!  (=> (or (|_module.__default.ShiftUpperBound#canCall| (U_2_bv2 (Lit bv2Type |b#0@@0|))) (< 0 $FunctionContextHeight)) (= (_module.__default.ShiftUpperBound (U_2_bv2 (Lit bv2Type |b#0@@0|))) (ext_rotate_left (U_2_bv2 (Lit bv2Type |b#0@@0|)) #b11)))
 :qid |shiftupperbounddfy.4:26|
 :weight 3
 :skolemid |486|
 :pattern ( (_module.__default.ShiftUpperBound (U_2_bv2 (Lit bv2Type |b#0@@0|))))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.ShiftUpperBound)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= 0 (LitInt 3))) (=> (<= 0 (LitInt 3)) (=> (= (ControlFlow 0 3) (- 0 2)) (<= (LitInt 3) 2))))))
