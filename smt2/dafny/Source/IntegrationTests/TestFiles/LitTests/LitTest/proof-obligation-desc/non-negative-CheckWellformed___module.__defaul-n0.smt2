...
(declare-fun _module.__default.NonNegative () T@U)
(declare-fun |_module.__default.NonNegative#canCall| () Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) ) (!  (=> (or |_module.__default.NonNegative#canCall| (and (< 0 $FunctionContextHeight) ($IsGoodHeap $Heap))) (= _module.__default.NonNegative (|Seq#Create| TInt $Heap (LitInt (- 0 1)) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#0| ($Box intType (int_2_U (LitInt 0)))) (|lambda#1| TInt) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))))))
 :qid |nonnegativedfy.4:10|
 :skolemid |480|
 :pattern ( _module.__default.NonNegative ($IsGoodHeap $Heap))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) ) (!  (=> (or |_module.__default.NonNegative#canCall| (and (< 0 $FunctionContextHeight) ($IsGoodHeap $Heap@@0))) (= _module.__default.NonNegative (|Seq#Create| TInt $Heap@@0 (LitInt (- 0 1)) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#0| ($Box intType (int_2_U (LitInt 0)))) (|lambda#1| TInt) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))))))
 :qid |nonnegativedfy.4:10|
 :weight 3
 :skolemid |481|
 :pattern ( _module.__default.NonNegative ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall ((|l#0@@1| T@U) (|$l#0#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#4| |l#0@@1|) |$l#0#ly#0|) |l#0@@1|)
 :qid |nonnegativedfy.6:13|
 :skolemid |489|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#4| |l#0@@1|) |$l#0#ly#0|))
)))
(assert (= (Ctor SeqType) 10))
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.NonNegative#canCall| (< 0 $FunctionContextHeight)) ($Is SeqType _module.__default.NonNegative (TSeq TInt)))))
...
(assert (forall ((|l#0@@2| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@0 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#10| |l#0@@2| |l#1| |l#2| |l#3|) $o@@0 $f))  (=> (and (or (not (= $o@@0 |l#0@@2|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1| $o@@0) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |490|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#10| |l#0@@2| |l#1| |l#2| |l#3|) $o@@0 $f))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.NonNegative)
...
(let ((anon10_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@1 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@1 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 7) 5) anon11_Then_correct) (=> (= (ControlFlow 0 7) 6) anon11_Else_correct)))))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((|seqinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| (LitInt (- 0 1)))) (Requires1 TInt TInt $Heap@@1 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#0| ($Box intType (int_2_U (LitInt 0)))) (|lambda#1| TInt) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0|))))
 :qid |nonnegativedfy.6:5|
 :skolemid |482|
))) (=> (and (and (= |b$reqreads#0@0| (forall ((|seqinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0@@0|) (< |seqinit#0#i0#0@@0| (LitInt (- 0 1)))) (forall (($o@@1 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@1 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@1 $o@@1) alloc)))) (|Set#IsMember| (Reads1 TInt TInt $Heap@@1 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#0| ($Box intType (int_2_U (LitInt 0)))) (|lambda#1| TInt) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0@@0|))) ($Box refType $o@@1))) (U_2_bool (MapType0Select refType FieldType boolType $_ReadsFrame@0 $o@@1 $f@@0)))
 :qid |nonnegativedfy.6:5|
 :skolemid |483|
)))
 :qid |nonnegativedfy.6:5|
 :skolemid |484|
))) (= _module.__default.NonNegative (|Seq#Create| TInt $Heap@@1 (LitInt (- 0 1)) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#0| ($Box intType (int_2_U (LitInt 0)))) (|lambda#1| TInt) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))))) (and ($Is SeqType _module.__default.NonNegative (TSeq TInt)) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= 0 (LitInt (- 0 1)))) (=> (<= 0 (LitInt (- 0 1))) (and (=> (= (ControlFlow 0 8) 7) anon10_Then_correct) (=> (= (ControlFlow 0 8) 3) anon10_Else_correct))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#10| null $Heap@@1 alloc false)) (and (=> (= (ControlFlow 0 10) 1) anon9_Then_correct) (=> (= (ControlFlow 0 10) 8) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct)))
