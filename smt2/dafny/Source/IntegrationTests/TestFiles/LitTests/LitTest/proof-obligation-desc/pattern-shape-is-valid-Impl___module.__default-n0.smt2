...
(assert (distinct alloc Tagclass._System.nat Tagclass._module.D |##_module.D.D0| |##_module.D.D1| tytagFamily$nat tytagFamily$D)
)
...
(assert (forall ((d@@1 T@U) ) (!  (=> (_module.D.D1_q d@@1) (= d@@1 |#_module.D.D1|))
 :qid |unknown.0:0|
 :skolemid |492|
 :pattern ( (_module.D.D1_q d@@1))
)))
(assert (forall ((d@@2 T@U) ) (!  (=> (_module.D.D0_q d@@2) (exists ((|a#1#0#0| Int) ) (! (= d@@2 (|#_module.D.D0| |a#1#0#0|))
 :qid |patternshapeisvaliddfy.4:17|
 :skolemid |485|
)))
 :qid |unknown.0:0|
 :skolemid |486|
 :pattern ( (_module.D.D0_q d@@2))
)))
...
(assert (forall ((d@@5 T@U) ($h@@0 T@U) ) (!  (=> (and ($IsGoodHeap $h@@0) ($Is DatatypeTypeType d@@5 Tclass._module.D)) ($IsAlloc DatatypeTypeType d@@5 Tclass._module.D $h@@0))
 :qid |unknown.0:0|
 :skolemid |493|
 :pattern ( ($IsAlloc DatatypeTypeType d@@5 Tclass._module.D $h@@0))
)))
...
(assert (forall ((d@@6 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.D.D0_q d@@6) ($IsAlloc DatatypeTypeType d@@6 Tclass._module.D $h@@1))) ($IsAlloc intType (int_2_U (_module.D.n d@@6)) Tclass._System.nat $h@@1))
 :qid |unknown.0:0|
 :skolemid |488|
 :pattern ( ($IsAlloc intType (int_2_U (_module.D.n d@@6)) Tclass._System.nat $h@@1))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (_module.D.D0_q |d#0|)) (=> (_module.D.D0_q |d#0|) (=> (and (and (<= (LitInt 0) |n#0@0|) (= |let#0#0#0| |d#0|)) (and ($Is DatatypeTypeType |let#0#0#0| Tclass._module.D) (= (ControlFlow 0 2) (- 0 1)))) (_module.D.D0_q |let#0#0#0|)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |d#0| Tclass._module.D) ($IsAlloc DatatypeTypeType |d#0| Tclass._module.D $Heap)) (|$IsA#_module.D| |d#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
