...
(set-info :boogie-vc-id Impl$$_module.__default.ArrayInitSizeValid)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= 0 (LitInt 1))) (=> (<= 0 (LitInt 1)) (=> (= (ControlFlow 0 2) (- 0 1)) (= (LitInt 1) 0)))))))
