...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let (($generated@@88 true))
(let (($generated@@89  (=> (= (ControlFlow 0 3) (- 0 2)) (= (+ (- $generated@@80 1) 1) (+ $generated@@80 1)))))
(let (($generated@@90 true))
(let (($generated@@91  (=> (= $generated@@81 ($generated@@24 $generated@@82 $generated@@83 $generated@@84 false)) (and (and (=> (= (ControlFlow 0 5) 1) $generated@@90) (=> (= (ControlFlow 0 5) 3) $generated@@89)) (=> (= (ControlFlow 0 5) 4) $generated@@88)))))
(let (($generated@@92  (=> (and (and ($generated@@85 $generated@@83) ($generated@@86 $generated@@83)) (and (= 0 $generated@@87) (= (ControlFlow 0 6) 5))) $generated@@91)))
$generated@@92))))))
))
(check-sat)
