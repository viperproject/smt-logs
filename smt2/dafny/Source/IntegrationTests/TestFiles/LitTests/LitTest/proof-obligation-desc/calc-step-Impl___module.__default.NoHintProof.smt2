...
(set-info :boogie-vc-id Impl$$_module.__default.NoHintProof)
...
(let ((anon5_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (= (+ (- |x#0| 1) 1) (+ |x#0| 1)))))
(let ((anon4_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 5) 1) anon4_Then_correct) (=> (= (ControlFlow 0 5) 3) anon5_Then_correct)) (=> (= (ControlFlow 0 5) 4) anon5_Else_correct)))))
