// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/proof-obligation-desc/requires-weaker.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/proof-obligation-desc/requires-weaker-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/proof-obligation-desc/requires-weaker.dfy
...
function _module.__default.P(i#0: int) : bool;

function _module.__default.P#canCall(i#0: int) : bool;

function _module.__default.P#requires(int) : bool;

// #requires axiom for _module.__default.P
axiom (forall i#0: int :: 
  { _module.__default.P#requires(i#0) } 
  _module.__default.P#requires(i#0) == true);

procedure {:verboseName "P (well-formedness)"} CheckWellformed$$_module.__default.P(i#0: int);
...
function _module.__default.Q(i#0: int) : bool;

function _module.__default.Q#canCall(i#0: int) : bool;

function _module.__default.Q#requires(int) : bool;

// #requires axiom for _module.__default.Q
axiom (forall i#0: int :: 
  { _module.__default.Q#requires(i#0) } 
  _module.__default.Q#requires(i#0) == true);

procedure {:verboseName "Q (well-formedness)"} CheckWellformed$$_module.__default.Q(i#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "T.M (well-formedness)"} CheckWellFormed$$_module.T.M(this: ref
       where this != null
         && 
...
procedure {:verboseName "T.M (call)"} Call$$_module.T.M(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.T())
         && $IsAlloc(this, Tclass._module.T(), $Heap), 
  ...
  requires {:id "id2"} _module.__default.P(i#0);
  requires {:id "id3"} _module.__default.Q(i#0);
  modifies $Heap;
...
procedure {:verboseName "C.M (override check)"} OverrideCheck$$_module.C.M(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.C())
         && $IsAlloc(this, Tclass._module.C(), $Heap), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "C.M (override check)"} OverrideCheck$$_module.C.M(this: ref, i'#0: int) returns (res'#0: bool)
{
    assume {:id "id9"} _module.__default.P(i'#0);
    assume {:id "id10"} _module.__default.Q(i'#0);
    assert {:id "id11"} _module.__default.P(i'#0);
    assert {:id "id12"} _module.__default.Q(Mul(i'#0, LitInt(2)));
    assert {:id "id13"} _module.__default.P(i'#0 + 1) ==> _module.__default.Q(i'#0 + 1);
    assert {:id "id14"} i'#0 <= i'#0;
...
procedure {:verboseName "C.M (call)"} Call$$_module.C.M(this: ref
   ...
   returns (res'#0: bool);
  // user-defined preconditions
  requires {:id "id17"} _module.__default.P(i'#0);
  requires {:id "id18"} _module.__default.Q(Mul(i'#0, LitInt(2)));
  requires {:id "id19"} _module.__default.P(i'#0 + 1) ==> _module.__default.Q(i'#0 + 1);
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "C.M (correctness)"} Impl$$_module.C.M(this: ref
  ...
  free requires 1 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id20"} _module.__default.P(i'#0);
  requires {:id "id21"} _module.__default.Q(Mul(i'#0, LitInt(2)));
  requires {:id "id22"} _module.__default.P(i'#0 + 1) ==> _module.__default.Q(i'#0 + 1);
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
