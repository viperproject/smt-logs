...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Callee)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc ($Unbox refType (|Seq#Index| |s'#0| (LitInt 0))) ($Unbox refType (|Seq#Index| |s'#0| (LitInt 1))) _module.C.x ($Unbox refType (|Seq#Index| |s'#0| (LitInt 2))) _module.C.y)) (> (|Seq#Length| |s'#0|) 5)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s'#0|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s'#0|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |s'#0|)))) (=> (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |s'#0|))) (=> (= (ControlFlow 0 2) (- 0 1)) (and (<= 0 (LitInt 2)) (< (LitInt 2) (|Seq#Length| |s'#0|)))))))))))
