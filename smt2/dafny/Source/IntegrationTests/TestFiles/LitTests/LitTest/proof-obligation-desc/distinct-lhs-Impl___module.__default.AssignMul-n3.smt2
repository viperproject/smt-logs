...
(set-info :boogie-vc-id Impl$$_module.__default.AssignMultiArray)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc |a#0|)) (and (=> (= (ControlFlow 0 2) (- 0 10)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 9)) (and (<= 0 |i0#0|) (< |i0#0| (_System.array2.Length0 |a#0|)))) (=> (and (<= 0 |i0#0|) (< |i0#0| (_System.array2.Length0 |a#0|))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (and (<= 0 |i1#0|) (< |i1#0| (_System.array2.Length1 |a#0|)))) (=> (and (<= 0 |i1#0|) (< |i1#0| (_System.array2.Length1 |a#0|))) (=> (= $index0@0 (MultiIndexField (IndexField |i0#0|) |i1#0|)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| $index0@0))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| $index0@0)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 |j0#0|) (< |j0#0| (_System.array2.Length0 |a#0|)))) (=> (and (<= 0 |j0#0|) (< |j0#0| (_System.array2.Length0 |a#0|))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= 0 |j1#0|) (< |j1#0| (_System.array2.Length1 |a#0|)))) (=> (and (<= 0 |j1#0|) (< |j1#0| (_System.array2.Length1 |a#0|))) (=> (= $index1@0 (MultiIndexField (IndexField |j0#0|) |j1#0|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| $index1@0))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| $index1@0)) (=> (and (= |$rhs#1@0| (+ |x#0| 1)) (= (ControlFlow 0 2) (- 0 1))) (or (or (or (or (not (= |a#0| |a#0|)) (not true)) (or (not (= |j0#0| |i0#0|)) (not true))) (or (not (= |j1#0| |i1#0|)) (not true))) (= ($Box intType (int_2_U |$rhs#1@0|)) ($Box intType (int_2_U |x#0|))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and (<= (LitInt 0) |i0#0|) (<= (LitInt 0) |i1#0|)) (and (<= (LitInt 0) |j0#0|) (<= (LitInt 0) |j1#0|))) (and (and ($Is refType |a#0| (Tclass._System.array2 TInt)) ($IsAlloc refType |a#0| (Tclass._System.array2 TInt) $Heap)) (and (= 0 $FunctionContextHeight) (<= (LitInt 0) |i0#0|)))) (and (and (and (< |i0#0| (_System.array2.Length0 |a#0|)) (<= (LitInt 0) |i1#0|)) (and (< |i1#0| (_System.array2.Length1 |a#0|)) (<= (LitInt 0) |j0#0|))) (and (and (< |j0#0| (_System.array2.Length0 |a#0|)) (<= (LitInt 0) |j1#0|)) (and (< |j1#0| (_System.array2.Length1 |a#0|)) (= (ControlFlow 0 11) 2))))) anon0_correct))))
