// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/proof-obligation-desc/trait-frame.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/proof-obligation-desc/trait-frame-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/proof-obligation-desc/trait-frame.dfy
...
function _module.T.F(this: ref) : bool;

function _module.T.F#canCall(this: ref) : bool;

function _module.T.F#requires(ref) : bool;

// #requires axiom for _module.T.F
axiom (forall this: ref :: 
  { _module.T.F#requires(this) } 
  this != null && $Is(this, Tclass._module.T())
     ==> _module.T.F#requires(this) == true);
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "C.M (override check)"} OverrideCheck$$_module.C.M(this: ref)
{
    assert {:id "id0"} true;
...
function _module.C.F($heap: Heap, this: ref) : bool;
...
axiom 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, this: ref :: 
    { _module.T.F(this), $Is(this, Tclass._module.C()), $IsGoodHeap($Heap) } 
      { _module.T.F(this), _module.C.F($Heap, this), $IsGoodHeap($Heap) } 
    _module.C.F#canCall($Heap, this)
         || (0 < $FunctionContextHeight && this != null && $Is(this, Tclass._module.C()))
       ==> _module.T.F(this) == _module.C.F($Heap, this));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "C.F (override check)"} OverrideCheck$$_module.C.F(this: ref)
{
