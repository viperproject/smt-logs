...
(declare-fun _module.__default.ConversionFit (Int) (_ BitVec 8))
(declare-fun |_module.__default.ConversionFit#canCall| (Int) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|i#0| Int) ) (!  (=> (or (|_module.__default.ConversionFit#canCall| |i#0|) (< 0 $FunctionContextHeight)) (= (_module.__default.ConversionFit |i#0|) ((_ int2bv 8) |i#0|)))
 :qid |conversionfitdfy.4:24|
 :skolemid |485|
 :pattern ( (_module.__default.ConversionFit |i#0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|i#0@@0| Int) ) (!  (=> (or (|_module.__default.ConversionFit#canCall| (LitInt |i#0@@0|)) (< 0 $FunctionContextHeight)) (= (_module.__default.ConversionFit (LitInt |i#0@@0|)) ((_ int2bv 8) (LitInt |i#0@@0|))))
 :qid |conversionfitdfy.4:24|
 :weight 3
 :skolemid |486|
 :pattern ( (_module.__default.ConversionFit (LitInt |i#0@@0|)))
))))
(push 1)
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.ConversionFit)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (and (<= 0 |i#0@@1|) (< |i#0@@1| 256)))))
