...
(set-info :boogie-vc-id Impl$$_module.__default.ForallLHSUniqueArray2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon6_correct  (=> (and (and (<= (LitInt 0) |i#0_0@0|) (< |i#0_0@0| (_System.array2.Length0 |a#0|))) (and (<= (LitInt 0) |j#0_0@0|) (< |j#0_0@0| (_System.array2.Length1 |a#0|)))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array2.Length0 |a#0|)))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array2.Length1 |a#0|)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (MultiIndexField (IndexField (LitInt 0)) (LitInt 0))))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (MultiIndexField (IndexField (LitInt 0)) (LitInt 0)))) (=> (and (and (and (<= (LitInt 0) |i#0_1@0|) (< |i#0_1@0| (_System.array2.Length0 |a#0|))) (and (<= (LitInt 0) |j#0_1@0|) (< |j#0_1@0| (_System.array2.Length1 |a#0|)))) (and (not (and (= |i#0_0@0| |i#0_1@0|) (= |j#0_0@0| |j#0_1@0|))) (= (ControlFlow 0 3) (- 0 2)))) (or (or (or (not (= |a#0| |a#0|)) (not true)) (or (not (= (MultiIndexField (IndexField (LitInt 0)) (LitInt 0)) (MultiIndexField (IndexField (LitInt 0)) (LitInt 0)))) (not true))) (= (+ |i#0_0@0| |j#0_0@0|) (+ |i#0_1@0| |j#0_1@0|)))))))))))))
(let ((anon11_Else_correct  (=> (and (< |j#0_0@0| (LitInt 0)) (= (ControlFlow 0 11) 3)) anon6_correct)))
(let ((anon11_Then_correct  (=> (<= (LitInt 0) |j#0_0@0|) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (not (= |a#0| null)) (not true))) (=> (= (ControlFlow 0 9) 3) anon6_correct)))))
(let ((anon10_Then_correct  (=> (and (<= (LitInt 0) |i#0_0@0|) (< |i#0_0@0| (_System.array2.Length0 |a#0|))) (and (=> (= (ControlFlow 0 12) 9) anon11_Then_correct) (=> (= (ControlFlow 0 12) 11) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#0_0@0|) (< |i#0_0@0| (_System.array2.Length0 |a#0|)))) (= (ControlFlow 0 8) 3)) anon6_correct)))
(let ((anon9_Else_correct  (=> (< |i#0_0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 15) 12) anon10_Then_correct) (=> (= (ControlFlow 0 15) 8) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> (<= (LitInt 0) |i#0_0@0|) (and (=> (= (ControlFlow 0 13) (- 0 14)) (or (not (= |a#0| null)) (not true))) (and (=> (= (ControlFlow 0 13) 12) anon10_Then_correct) (=> (= (ControlFlow 0 13) 8) anon10_Else_correct))))))
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 16) 13) anon9_Then_correct) (=> (= (ControlFlow 0 16) 15) anon9_Else_correct))))
(let ((anon8_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc |a#0|)) (and (=> (= (ControlFlow 0 17) 16) anon8_Then_correct) (=> (= (ControlFlow 0 17) 1) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |a#0| (Tclass._System.array2 TInt)) ($IsAlloc refType |a#0| (Tclass._System.array2 TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 18) 17))) anon0_correct))))
