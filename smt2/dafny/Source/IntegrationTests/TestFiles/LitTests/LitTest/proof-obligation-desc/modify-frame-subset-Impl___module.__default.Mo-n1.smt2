...
(set-info :boogie-vc-id Impl$$_module.__default.ModifyStmt)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc ($Unbox refType (|Seq#Index| |s#0| (LitInt 3))) ($Unbox refType (|Seq#Index| |s#0| (LitInt 4))) _module.C.x ($Unbox refType (|Seq#Index| |s#0| (LitInt 5))) _module.C.y)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s#0|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s#0|))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |s#0|)))) (=> (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |s#0|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 (LitInt 2)) (< (LitInt 2) (|Seq#Length| |s#0|)))) (=> (and (<= 0 (LitInt 2)) (< (LitInt 2) (|Seq#Length| |s#0|))) (=> (= (ControlFlow 0 2) (- 0 1)) (forall (($o@@6 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (or (or (= $o@@6 ($Unbox refType (|Seq#Index| |s#0| (LitInt 0)))) (and (= $o@@6 ($Unbox refType (|Seq#Index| |s#0| (LitInt 1)))) (= $f@@0 _module.C.x))) (and (= $o@@6 ($Unbox refType (|Seq#Index| |s#0| (LitInt 2)))) (= $f@@0 _module.C.y)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@6 $f@@0)))
 :qid |modifyframesubsetdfy.15:3|
 :skolemid |486|
))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SeqType |s#0| (TSeq Tclass._module.C)) ($IsAlloc SeqType |s#0| (TSeq Tclass._module.C) $Heap)) (= 1 $FunctionContextHeight)) (and (> (|Seq#Length| |s#0|) 5) (= (ControlFlow 0 6) 2))) anon0_correct))))
