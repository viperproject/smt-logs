...
(assert (distinct TInt TagInt alloc allocName Tagclass._module.C class._module.C? Tagclass._module.C? tytagFamily$C field$x field$y)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) ($o@@3 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#8| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@3 $f))  (=> (and (or (not (= $o@@3 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@3) |l#2|)))) (and (= $o@@3 |l#3|) (= $f |l#4|))))
...
(set-info :boogie-vc-id Impl$$_module.C.ModifyClassField)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#8| null $Heap alloc this _module.C.y)) (= (ControlFlow 0 2) (- 0 1))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this _module.C.x)))))
