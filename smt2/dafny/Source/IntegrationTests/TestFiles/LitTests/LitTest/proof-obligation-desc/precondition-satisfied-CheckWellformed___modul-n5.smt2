...
(declare-fun _module.__default.BadAnonLambdaDiv (Int Int) Int)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.__default.BadAnonLambdaDiv#canCall| (Int Int) Bool)
...
(assert (distinct TInt TagInt TagSet alloc Tagclass._System.object? Tagclass._System.object Tagclass._System.___hFunc2 tytagFamily$object |tytagFamily$_#Func2|)
)
(assert (= (Tag TInt) TagInt))
(assert (= (Ctor HandleTypeType) 3))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (|a#0| Int) (|b#0| Int) ) (!  (=> (or (|_module.__default.BadAnonLambdaDiv#canCall| |a#0| |b#0|) (and (< 0 $FunctionContextHeight) ($IsGoodHeap $Heap))) (= (_module.__default.BadAnonLambdaDiv |a#0| |b#0|) (U_2_int ($Unbox intType (Apply2 TInt TInt TInt $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle2 |lambda#4| (|lambda#5| TInt TInt 0) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) ($Box intType (int_2_U |a#0|)) ($Box intType (int_2_U |b#0|)))))))
 :qid |preconditionsatisfieddfy.32:10|
 :skolemid |552|
 :pattern ( (_module.__default.BadAnonLambdaDiv |a#0| |b#0|) ($IsGoodHeap $Heap))
))))
...
(assert (forall ((t0@@1 T@U) (t1@@1 T@U) (t2@@0 T@U) (heap T@U) (h@@0 T@U) (r T@U) (rd T@U) (bx0 T@U) (bx1 T@U) (bx@@0 T@U) ) (! (= (|Set#IsMember| (Reads2 t0@@1 t1@@1 t2@@0 heap (Handle2 h@@0 r rd) bx0 bx1) bx@@0) (|Set#IsMember| (MapType1Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType BoxType SetType rd heap bx0 bx1) bx@@0))
 :qid |unknown.0:0|
 :skolemid |486|
...
(assert (forall ((f@@3 T@U) (t0@@7 T@U) (t1@@6 T@U) (t2@@5 T@U) (u0@@3 T@U) (u1@@3 T@U) (u2@@2 T@U) ) (!  (=> (and (and (and ($Is HandleTypeType f@@3 (Tclass._System.___hFunc2 t0@@7 t1@@6 t2@@5)) (forall ((bx@@6 T@U) ) (!  (=> ($IsBox bx@@6 u0@@3) ($IsBox bx@@6 t0@@7))
 :qid |unknown.0:0|
 :skolemid |503|
 :pattern ( ($IsBox bx@@6 u0@@3))
 :pattern ( ($IsBox bx@@6 t0@@7))
))) (forall ((bx@@7 T@U) ) (!  (=> ($IsBox bx@@7 u1@@3) ($IsBox bx@@7 t1@@6))
 :qid |unknown.0:0|
 :skolemid |504|
 :pattern ( ($IsBox bx@@7 u1@@3))
 :pattern ( ($IsBox bx@@7 t1@@6))
))) (forall ((bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 t2@@5) ($IsBox bx@@8 u2@@2))
 :qid |unknown.0:0|
 :skolemid |505|
 :pattern ( ($IsBox bx@@8 t2@@5))
 :pattern ( ($IsBox bx@@8 u2@@2))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|a#0@@0| Int) (|b#0@@0| Int) ) (!  (=> (or (|_module.__default.BadAnonLambdaDiv#canCall| (LitInt |a#0@@0|) (LitInt |b#0@@0|)) (and (< 0 $FunctionContextHeight) ($IsGoodHeap $Heap@@0))) (= (_module.__default.BadAnonLambdaDiv (LitInt |a#0@@0|) (LitInt |b#0@@0|)) (U_2_int ($Unbox intType (Apply2 TInt TInt TInt $Heap@@0 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle2 |lambda#4| (|lambda#5| TInt TInt 0) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) ($Box intType (int_2_U (LitInt |a#0@@0|))) ($Box intType (int_2_U (LitInt |b#0@@0|))))))))
 :qid |preconditionsatisfieddfy.32:10|
 :weight 3
 :skolemid |553|
 :pattern ( (_module.__default.BadAnonLambdaDiv (LitInt |a#0@@0|) (LitInt |b#0@@0|)) ($IsGoodHeap $Heap@@0))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.BadAnonLambdaDiv)
...
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (Requires2 TInt TInt TInt $Heap@@1 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle2 |lambda#4| (|lambda#5| TInt TInt 0) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) ($Box intType (int_2_U |a#0@@1|)) ($Box intType (int_2_U |b#0@@1|))))))
