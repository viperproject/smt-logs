...
(declare-fun _module.__default.NonNull (T@U) Int)
(declare-fun |_module.__default.NonNull#canCall| (T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|a#0| T@U) ) (!  (=> (or (|_module.__default.NonNull#canCall| |a#0|) (and (< 0 $FunctionContextHeight) ($Is refType |a#0| (Tclass._System.array? TInt)))) (= (_module.__default.NonNull |a#0|) (_System.array.Length |a#0|)))
 :qid |nonnulldfy.4:18|
 :skolemid |481|
 :pattern ( (_module.__default.NonNull |a#0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|a#0@@0| T@U) ) (!  (=> (or (|_module.__default.NonNull#canCall| (Lit refType |a#0@@0|)) (and (< 0 $FunctionContextHeight) ($Is refType |a#0@@0| (Tclass._System.array? TInt)))) (= (_module.__default.NonNull (Lit refType |a#0@@0|)) (LitInt (_System.array.Length (Lit refType |a#0@@0|)))))
 :qid |nonnulldfy.4:18|
 :weight 3
 :skolemid |482|
 :pattern ( (_module.__default.NonNull (Lit refType |a#0@@0|)))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.NonNull)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (or (not (= |a#0@@1| null)) (not true)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is refType |a#0@@1| (Tclass._System.array? TInt))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct)))
