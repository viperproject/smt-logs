...
(assert (forall ((d@@2 T@U) ) (!  (=> (_module.D.D2_q d@@2) (exists ((|a#10#0#0| Bool) (|a#10#1#0| Int) ) (! (= d@@2 (|#_module.D.D2| |a#10#0#0| |a#10#1#0|))
 :qid |validconstructornamesdfy.4:35|
 :skolemid |495|
)))
 :qid |unknown.0:0|
 :skolemid |496|
...
(assert (forall ((d@@4 T@U) ) (!  (=> (_module.D.D0_q d@@4) (exists ((|a#1#0#0| Int) ) (! (= d@@4 (|#_module.D.D0| |a#1#0#0|))
 :qid |validconstructornamesdfy.4:17|
 :skolemid |485|
)))
 :qid |unknown.0:0|
 :skolemid |486|
...
(declare-fun |dt_update#n#0#Z#0@0| () Int)
...
(let ((anon4_Else_correct  (=> (not (_module.D.D0_q |dt_update_tmp#0#Z#0@0|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (_module.D.D2_q |dt_update_tmp#0#Z#0@0|)) (=> (_module.D.D2_q |dt_update_tmp#0#Z#0@0|) (=> (= (ControlFlow 0 3) 1) anon3_correct))))))
(let ((anon4_Then_correct  (=> (and (_module.D.D0_q |dt_update_tmp#0#Z#0@0|) (= (ControlFlow 0 2) 1)) anon3_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (or (_module.D.D2_q |d#0|) (_module.D.D0_q |d#0|))) (=> (or (_module.D.D2_q |d#0|) (_module.D.D0_q |d#0|)) (=> (= |let#0#0#0| |d#0|) (=> (and ($Is DatatypeTypeType |let#0#0#0| Tclass._module.D) (= |dt_update_tmp#0#Z#0@0| |let#0#0#0|)) (and (=> (= (ControlFlow 0 5) (- 0 6)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (= |let#1#0#0| (LitInt 0)) (=> (and ($Is intType (int_2_U |let#1#0#0|) Tclass._System.nat) (= |dt_update#n#0#Z#0@0| |let#1#0#0|)) (and (=> (= (ControlFlow 0 5) 2) anon4_Then_correct) (=> (= (ControlFlow 0 5) 3) anon4_Else_correct)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |d#0| Tclass._module.D) ($IsAlloc DatatypeTypeType |d#0| Tclass._module.D $Heap)) (|$IsA#_module.D| |d#0|)) (=> (and (and (and ($Is DatatypeTypeType |d'#0| Tclass._module.D) ($IsAlloc DatatypeTypeType |d'#0| Tclass._module.D $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 5))) anon0_correct)))))
