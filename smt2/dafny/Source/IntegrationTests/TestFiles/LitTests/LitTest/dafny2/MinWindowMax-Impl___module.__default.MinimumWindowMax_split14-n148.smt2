...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split149)
...
)) (=> (and (<= |k#0@0| (- |l#0@4| 1)) (or (not (= |a#0@@4| null)) (not true))) (=> (and (and (<= 0 |n#0@3|) (< |n#0@3| (_System.array.Length |a#0@@4|))) (and (or (not (= |a#0@@4| null)) (not true)) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= $nw@0 null)) (not true)))))))
