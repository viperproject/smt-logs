...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split145)
...
)))) (and (and (<= (- (- |l#0@4| 1) |k#0@0|) |$decr_init$loop#1_00@1|) (=> (= (- (- |l#0@4| 1) |k#0@0|) |$decr_init$loop#1_00@1|) (<= (ite (<= |k#0@0| (- |l#0@4| 1)) (- (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField |n#0@3|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1)))))))))) (- 0 1)) |$decr_init$loop#1_01@1|))) (and |$w$loop#1_0@1| (<= |k#0@0| (- |l#0@4| 1))))) (and (and (and (or (not (= |a#0@@4| null)) (not true)) (or (not (= $nw@0 null)) (not true))) (and (<= 0 (- |l#0@4| 1)) (< (- |l#0@4| 1) (_System.array.Length $nw@0)))) (and (and (<= 0 (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1)))))) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1))))) (_System.array.Length |a#0@@4|))) (and (or (not (= |a#0@@4| null)) (not true)) (= (ControlFlow 0 2) (- 0 1)))))))) (and (<= 0 |n#0@3|) (< |n#0@3| (_System.array.Length |a#0@@4|))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
