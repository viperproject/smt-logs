...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Count)
...
(let ((anon18_Else_correct  (=> (and (or (not (= (|Seq#Index| |a#0@@3| (- |t#0@@3| 1)) |x#0@@3|)) (not true)) (= (ControlFlow 0 5) 3)) anon12_correct)))
(let ((anon18_Then_correct  (=> (and (= (|Seq#Index| |a#0@@3| (- |t#0@@3| 1)) |x#0@@3|) (= (ControlFlow 0 4) 3)) anon12_correct)))
(let ((anon17_Else_correct  (=> (and (or (not (= |s#0@@3| |t#0@@3|)) (not true)) ($IsAlloc SeqType |a#0@@3| (TSeq _module._default.Count$T@@3) $Heap)) (=> (and (and ($IsAlloc intType (int_2_U |s#0@@3|) TInt $Heap) (= |##t#0@0| (- |t#0@@3| 1))) (and ($IsAlloc intType (int_2_U |##t#0@0|) TInt $Heap) ($IsAllocBox |x#0@@3| _module._default.Count$T@@3 $Heap))) (and (=> (= (ControlFlow 0 6) (- 0 13)) (<= (LitInt 0) |s#0@@3|)) (and (=> (= (ControlFlow 0 6) (- 0 12)) (<= |s#0@@3| |##t#0@0|)) (and (=> (= (ControlFlow 0 6) (- 0 11)) (<= |##t#0@0| (|Seq#Length| |a#0@@3|))) (=> (and (and (<= (LitInt 0) |s#0@@3|) (<= |s#0@@3| |##t#0@0|)) (<= |##t#0@0| (|Seq#Length| |a#0@@3|))) (and (=> (= (ControlFlow 0 6) (- 0 10)) (or (or (<= 0 |s#0@@3|) (< (|Seq#Rank| |a#0@@3|) (|Seq#Rank| |a#0@@3|))) (= |s#0@@3| |s#0@@3|))) (=> (or (or (<= 0 |s#0@@3|) (< (|Seq#Rank| |a#0@@3|) (|Seq#Rank| |a#0@@3|))) (= |s#0@@3| |s#0@@3|)) (and (=> (= (ControlFlow 0 6) (- 0 9)) (or (or (or (<= 0 |t#0@@3|) (< (|Seq#Rank| |a#0@@3|) (|Seq#Rank| |a#0@@3|))) (< |s#0@@3| |s#0@@3|)) (= |##t#0@0| |t#0@@3|))) (=> (or (or (or (<= 0 |t#0@@3|) (< (|Seq#Rank| |a#0@@3|) (|Seq#Rank| |a#0@@3|))) (< |s#0@@3| |s#0@@3|)) (= |##t#0@0| |t#0@@3|)) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (< (|Seq#Rank| |a#0@@3|) (|Seq#Rank| |a#0@@3|)) (and (= (|Seq#Rank| |a#0@@3|) (|Seq#Rank| |a#0@@3|)) (or (< |s#0@@3| |s#0@@3|) (and (= |s#0@@3| |s#0@@3|) (< |##t#0@0| |t#0@@3|)))))) (=> (or (< (|Seq#Rank| |a#0@@3|) (|Seq#Rank| |a#0@@3|)) (and (= (|Seq#Rank| |a#0@@3|) (|Seq#Rank| |a#0@@3|)) (or (< |s#0@@3| |s#0@@3|) (and (= |s#0@@3| |s#0@@3|) (< |##t#0@0| |t#0@@3|))))) (=> (|_module.__default.Count#canCall| _module._default.Count$T@@3 |a#0@@3| |s#0@@3| (- |t#0@@3| 1) |x#0@@3|) (and (=> (= (ControlFlow 0 6) (- 0 7)) (and (<= 0 (- |t#0@@3| 1)) (< (- |t#0@@3| 1) (|Seq#Length| |a#0@@3|)))) (=> (and (<= 0 (- |t#0@@3| 1)) (< (- |t#0@@3| 1) (|Seq#Length| |a#0@@3|))) (and (=> (= (ControlFlow 0 6) 4) anon18_Then_correct) (=> (= (ControlFlow 0 6) 5) anon18_Else_correct)))))))))))))))))))
(let ((anon17_Then_correct true))
(let ((anon16_Then_correct true))
(let ((anon5_correct  (=> (and (and (<= (LitInt 0) |s#0@@3|) (<= |s#0@@3| |t#0@@3|)) (<= |t#0@@3| (|Seq#Length| |a#0@@3|))) (and (and (=> (= (ControlFlow 0 14) 1) anon16_Then_correct) (=> (= (ControlFlow 0 14) 2) anon17_Then_correct)) (=> (= (ControlFlow 0 14) 6) anon17_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (not (and (<= (LitInt 0) |s#0@@3|) (<= |s#0@@3| |t#0@@3|))) (= (ControlFlow 0 16) 14)) anon5_correct)))
(let ((anon15_Then_correct  (=> (and (and (<= (LitInt 0) |s#0@@3|) (<= |s#0@@3| |t#0@@3|)) (= (ControlFlow 0 15) 14)) anon5_correct)))
(let ((anon14_Else_correct  (=> (< |s#0@@3| (LitInt 0)) (and (=> (= (ControlFlow 0 18) 15) anon15_Then_correct) (=> (= (ControlFlow 0 18) 16) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (<= (LitInt 0) |s#0@@3|) (and (=> (= (ControlFlow 0 17) 15) anon15_Then_correct) (=> (= (ControlFlow 0 17) 16) anon15_Else_correct)))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 19) 17) anon14_Then_correct) (=> (= (ControlFlow 0 19) 18) anon14_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |a#0@@3| (TSeq _module._default.Count$T@@3)) ($IsBox |x#0@@3| _module._default.Count$T@@3)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 20) 19))) anon0_correct))))
