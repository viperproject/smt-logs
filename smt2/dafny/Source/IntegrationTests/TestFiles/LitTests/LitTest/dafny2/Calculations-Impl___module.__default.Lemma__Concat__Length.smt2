...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.length$_T0@@0 T@U) ($ly@@3 T@U) (|l#0@@3| T@U) ) (!  (=> (or (|_module.__default.length#canCall| _module._default.length$_T0@@0 |l#0@@3|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |l#0@@3| (Tclass._module.List _module._default.length$_T0@@0)))) (and (=> (not (_module.List.Nil_q |l#0@@3|)) (let ((|xs#1@@0| (_module.List._h1 |l#0@@3|)))
(|_module.__default.length#canCall| _module._default.length$_T0@@0 |xs#1@@0|))) (= (_module.__default.length _module._default.length$_T0@@0 ($LS $ly@@3) |l#0@@3|) (ite (_module.List.Nil_q |l#0@@3|) 0 (let ((|xs#0@@0| (_module.List._h1 |l#0@@3|)))
(+ 1 (_module.__default.length _module._default.length$_T0@@0 $ly@@3 |xs#0@@0|)))))))
 :qid |unknown.0:0|
 :skolemid |535|
 :pattern ( (_module.__default.length _module._default.length$_T0@@0 ($LS $ly@@3) |l#0@@3|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.concat$_T0@@2 T@U) ($ly@@4 T@U) (|l#0@@5| T@U) (|ys#0@@2| T@U) ) (!  (=> (and (or (|_module.__default.concat#canCall| _module._default.concat$_T0@@2 |l#0@@5| |ys#0@@2|) (and (< 1 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |l#0@@5| (Tclass._module.List _module._default.concat$_T0@@2)) ($IsAlloc DatatypeTypeType |l#0@@5| (Tclass._module.List _module._default.concat$_T0@@2) $Heap)) (and ($Is DatatypeTypeType |ys#0@@2| (Tclass._module.List _module._default.concat$_T0@@2)) ($IsAlloc DatatypeTypeType |ys#0@@2| (Tclass._module.List _module._default.concat$_T0@@2) $Heap))))) ($IsGoodHeap $Heap)) ($IsAlloc DatatypeTypeType (_module.__default.concat _module._default.concat$_T0@@2 $ly@@4 |l#0@@5| |ys#0@@2|) (Tclass._module.List _module._default.concat$_T0@@2) $Heap))
 :qid |Calculationsdfy.16:16|
 :skolemid |541|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.__default.concat _module._default.concat$_T0@@2 $ly@@4 |l#0@@5| |ys#0@@2|) (Tclass._module.List _module._default.concat$_T0@@2) $Heap))
))))
...
(assert (forall ((_module._default.concat$_T0@@3 T@U) ($ly@@5 T@U) (|l#0@@6| T@U) (|ys#0@@3| T@U) ) (! (= (_module.__default.concat _module._default.concat$_T0@@3 ($LS $ly@@5) |l#0@@6| |ys#0@@3|) (_module.__default.concat _module._default.concat$_T0@@3 $ly@@5 |l#0@@6| |ys#0@@3|))
 :qid |unknown.0:0|
 :skolemid |538|
 :pattern ( (_module.__default.concat _module._default.concat$_T0@@3 ($LS $ly@@5) |l#0@@6| |ys#0@@3|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.length$_T0@@1 T@U) ($ly@@6 T@U) (|l#0@@7| T@U) ) (!  (=> (or (|_module.__default.length#canCall| _module._default.length$_T0@@1 |l#0@@7|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |l#0@@7| (Tclass._module.List _module._default.length$_T0@@1)))) (<= (LitInt 0) (_module.__default.length _module._default.length$_T0@@1 $ly@@6 |l#0@@7|)))
 :qid |unknown.0:0|
 :skolemid |533|
 :pattern ( (_module.__default.length _module._default.length$_T0@@1 $ly@@6 |l#0@@7|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.length$_T0@@2 T@U) ($ly@@7 T@U) (|l#0@@8| T@U) ) (!  (=> (or (|_module.__default.length#canCall| _module._default.length$_T0@@2 (Lit DatatypeTypeType |l#0@@8|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |l#0@@8| (Tclass._module.List _module._default.length$_T0@@2)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |l#0@@8|)))))) (let ((|xs#3@@0| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |l#0@@8|)))))
(|_module.__default.length#canCall| _module._default.length$_T0@@2 |xs#3@@0|))) (= (_module.__default.length _module._default.length$_T0@@2 ($LS $ly@@7) (Lit DatatypeTypeType |l#0@@8|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |l#0@@8|)) 0 (let ((|xs#2@@0| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |l#0@@8|)))))
(LitInt (+ 1 (_module.__default.length _module._default.length$_T0@@2 ($LS $ly@@7) |xs#2@@0|))))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |536|
 :pattern ( (_module.__default.length _module._default.length$_T0@@2 ($LS $ly@@7) (Lit DatatypeTypeType |l#0@@8|)))
))))
...
(declare-fun _module._default.Lemma_Concat_Length$_T0 () T@U)
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.Lemma__Concat__Length)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and (|$IsA#_module.List| |xs#0@@1|) (|$IsA#_module.List| |ys#0@@4|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@0 $Heap@0)) (and (forall ((|$ih#xs0#0| T@U) (|$ih#ys0#0| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |$ih#xs0#0| (Tclass._module.List _module._default.Lemma_Concat_Length$_T0)) ($Is DatatypeTypeType |$ih#ys0#0| (Tclass._module.List _module._default.Lemma_Concat_Length$_T0))) (U_2_bool (Lit boolType (bool_2_U true)))) (or (< (DtRank |$ih#xs0#0|) (DtRank |xs#0@@1|)) (and (= (DtRank |$ih#xs0#0|) (DtRank |xs#0@@1|)) (< (DtRank |$ih#ys0#0|) (DtRank |ys#0@@4|))))) (= (_module.__default.length _module._default.Lemma_Concat_Length$_T0 ($LS $LZ) (_module.__default.concat _module._default.Lemma_Concat_Length$_T0 ($LS $LZ) |$ih#xs0#0| |$ih#ys0#0|)) (+ (_module.__default.length _module._default.Lemma_Concat_Length$_T0 ($LS $LZ) |$ih#xs0#0|) (_module.__default.length _module._default.Lemma_Concat_Length$_T0 ($LS $LZ) |$ih#ys0#0|))))
 :qid |Calculationsdfy.171:27|
 :skolemid |601|
 :pattern ( (_module.__default.concat _module._default.Lemma_Concat_Length$_T0 ($LS $LZ) |$ih#xs0#0| |$ih#ys0#0|))
)) (= (ControlFlow 0 2) (- 0 1)))) (= (_module.__default.length _module._default.Lemma_Concat_Length$_T0 ($LS ($LS $LZ)) (_module.__default.concat _module._default.Lemma_Concat_Length$_T0 ($LS ($LS $LZ)) |xs#0@@1| |ys#0@@4|)) (+ (_module.__default.length _module._default.Lemma_Concat_Length$_T0 ($LS ($LS $LZ)) |xs#0@@1|) (_module.__default.length _module._default.Lemma_Concat_Length$_T0 ($LS ($LS $LZ)) |ys#0@@4|))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is DatatypeTypeType |xs#0@@1| (Tclass._module.List _module._default.Lemma_Concat_Length$_T0)) ($IsAlloc DatatypeTypeType |xs#0@@1| (Tclass._module.List _module._default.Lemma_Concat_Length$_T0) $Heap@@0)) (|$IsA#_module.List| |xs#0@@1|)) (=> (and (and (and ($Is DatatypeTypeType |ys#0@@4| (Tclass._module.List _module._default.Lemma_Concat_Length$_T0)) ($IsAlloc DatatypeTypeType |ys#0@@4| (Tclass._module.List _module._default.Lemma_Concat_Length$_T0) $Heap@@0)) (|$IsA#_module.List| |ys#0@@4|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct)))))
