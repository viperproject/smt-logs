...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.revacc$_T0 T@U) ($ly T@U) (|l#0| T@U) (|acc#0| T@U) ) (!  (=> (or (|_module.__default.revacc#canCall| _module._default.revacc$_T0 |l#0| |acc#0|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |l#0| (Tclass._module.List _module._default.revacc$_T0)) ($Is DatatypeTypeType |acc#0| (Tclass._module.List _module._default.revacc$_T0))))) (and (=> (not (_module.List.Nil_q |l#0|)) (let ((|xs#1| (_module.List._h1 |l#0|)))
(let ((|x#1| (_module.List._h0 |l#0|)))
(|_module.__default.revacc#canCall| _module._default.revacc$_T0 |xs#1| (|#_module.List.Cons| |x#1| |acc#0|))))) (= (_module.__default.revacc _module._default.revacc$_T0 ($LS $ly) |l#0| |acc#0|) (ite (_module.List.Nil_q |l#0|) |acc#0| (let ((|xs#0| (_module.List._h1 |l#0|)))
(let ((|x#0| (_module.List._h0 |l#0|)))
(_module.__default.revacc _module._default.revacc$_T0 $ly |xs#0| (|#_module.List.Cons| |x#0| |acc#0|))))))))
 :qid |unknown.0:0|
 :skolemid |560|
 :pattern ( (_module.__default.revacc _module._default.revacc$_T0 ($LS $ly) |l#0| |acc#0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.revacc$_T0@@0 T@U) ($ly@@0 T@U) (|l#0@@0| T@U) (|acc#0@@0| T@U) ) (!  (=> (or (|_module.__default.revacc#canCall| _module._default.revacc$_T0@@0 |l#0@@0| |acc#0@@0|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |l#0@@0| (Tclass._module.List _module._default.revacc$_T0@@0)) ($Is DatatypeTypeType |acc#0@@0| (Tclass._module.List _module._default.revacc$_T0@@0))))) ($Is DatatypeTypeType (_module.__default.revacc _module._default.revacc$_T0@@0 $ly@@0 |l#0@@0| |acc#0@@0|) (Tclass._module.List _module._default.revacc$_T0@@0)))
 :qid |unknown.0:0|
 :skolemid |557|
 :pattern ( (_module.__default.revacc _module._default.revacc$_T0@@0 $ly@@0 |l#0@@0| |acc#0@@0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.revacc$_T0@@1 T@U) ($ly@@1 T@U) (|l#0@@1| T@U) (|acc#0@@1| T@U) ) (!  (=> (or (|_module.__default.revacc#canCall| _module._default.revacc$_T0@@1 (Lit DatatypeTypeType |l#0@@1|) (Lit DatatypeTypeType |acc#0@@1|)) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |l#0@@1| (Tclass._module.List _module._default.revacc$_T0@@1)) ($Is DatatypeTypeType |acc#0@@1| (Tclass._module.List _module._default.revacc$_T0@@1))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |l#0@@1|)))))) (let ((|xs#3| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |l#0@@1|)))))
(let ((|x#3| (Lit BoxType (_module.List._h0 (Lit DatatypeTypeType |l#0@@1|)))))
(|_module.__default.revacc#canCall| _module._default.revacc$_T0@@1 |xs#3| (|#_module.List.Cons| |x#3| (Lit DatatypeTypeType |acc#0@@1|)))))) (= (_module.__default.revacc _module._default.revacc$_T0@@1 ($LS $ly@@1) (Lit DatatypeTypeType |l#0@@1|) (Lit DatatypeTypeType |acc#0@@1|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |l#0@@1|)) |acc#0@@1| (let ((|xs#2| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |l#0@@1|)))))
(let ((|x#2| (Lit BoxType (_module.List._h0 (Lit DatatypeTypeType |l#0@@1|)))))
(Lit DatatypeTypeType (_module.__default.revacc _module._default.revacc$_T0@@1 ($LS $ly@@1) |xs#2| (Lit DatatypeTypeType (|#_module.List.Cons| |x#2| (Lit DatatypeTypeType |acc#0@@1|)))))))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |561|
 :pattern ( (_module.__default.revacc _module._default.revacc$_T0@@1 ($LS $ly@@1) (Lit DatatypeTypeType |l#0@@1|) (Lit DatatypeTypeType |acc#0@@1|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.revacc$_T0@@2 T@U) ($ly@@2 T@U) (|l#0@@3| T@U) (|acc#0@@2| T@U) ) (!  (=> (and (or (|_module.__default.revacc#canCall| _module._default.revacc$_T0@@2 |l#0@@3| |acc#0@@2|) (and (< 1 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |l#0@@3| (Tclass._module.List _module._default.revacc$_T0@@2)) ($IsAlloc DatatypeTypeType |l#0@@3| (Tclass._module.List _module._default.revacc$_T0@@2) $Heap)) (and ($Is DatatypeTypeType |acc#0@@2| (Tclass._module.List _module._default.revacc$_T0@@2)) ($IsAlloc DatatypeTypeType |acc#0@@2| (Tclass._module.List _module._default.revacc$_T0@@2) $Heap))))) ($IsGoodHeap $Heap)) ($IsAlloc DatatypeTypeType (_module.__default.revacc _module._default.revacc$_T0@@2 $ly@@2 |l#0@@3| |acc#0@@2|) (Tclass._module.List _module._default.revacc$_T0@@2) $Heap))
 :qid |Calculationsdfy.30:16|
 :skolemid |558|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.__default.revacc _module._default.revacc$_T0@@2 $ly@@2 |l#0@@3| |acc#0@@2|) (Tclass._module.List _module._default.revacc$_T0@@2) $Heap))
))))
...
(assert (forall ((_module._default.revacc$_T0@@3 T@U) ($ly@@3 T@U) (|l#0@@4| T@U) (|acc#0@@3| T@U) ) (! (= (_module.__default.revacc _module._default.revacc$_T0@@3 ($LS $ly@@3) |l#0@@4| |acc#0@@3|) (_module.__default.revacc _module._default.revacc$_T0@@3 $ly@@3 |l#0@@4| |acc#0@@3|))
 :qid |unknown.0:0|
 :skolemid |555|
 :pattern ( (_module.__default.revacc _module._default.revacc$_T0@@3 ($LS $ly@@3) |l#0@@4| |acc#0@@3|))
)))
...
(declare-fun _module._default.revacc$_T0@@4 () T@U)
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.revacc)
...
(let ((anon10_Then_correct  (=> (= |l#0@@5| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) (=> (and (and ($IsBox |_mcc#0#0| _module._default.revacc$_T0@@4) ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List _module._default.revacc$_T0@@4))) (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List _module._default.revacc$_T0@@4)))) (=> (and (and (and (= |xs#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|)) (and ($IsBox |let#1#0#0| _module._default.revacc$_T0@@4) (= |x#Z#0@0| |let#1#0#0|))) (and (and ($IsAlloc DatatypeTypeType |xs#Z#0@0| (Tclass._module.List _module._default.revacc$_T0@@4) $Heap@@0) (= |##acc#0@0| (|#_module.List.Cons| |x#Z#0@0| |acc#0@@4|))) (and ($IsAlloc DatatypeTypeType |##acc#0@0| (Tclass._module.List _module._default.revacc$_T0@@4) $Heap@@0) (= (ControlFlow 0 4) (- 0 3))))) (or (< (DtRank |xs#Z#0@0|) (DtRank |l#0@@5|)) (and (= (DtRank |xs#Z#0@0|) (DtRank |l#0@@5|)) (< (DtRank |##acc#0@0|) (DtRank |acc#0@@4|)))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is DatatypeTypeType |l#0@@5| (Tclass._module.List _module._default.revacc$_T0@@4)) ($Is DatatypeTypeType |acc#0@@4| (Tclass._module.List _module._default.revacc$_T0@@4))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
