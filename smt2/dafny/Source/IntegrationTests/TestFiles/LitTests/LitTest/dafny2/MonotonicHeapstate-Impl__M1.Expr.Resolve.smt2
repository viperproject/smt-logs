...
(assert (forall ((a@@4 T@U) (b@@4 T@U) ) (! (= (|M1.Kind#Equal| a@@4 b@@4) (= a@@4 b@@4))
 :qid |unknown.0:0|
 :skolemid |1140|
 :pattern ( (|M1.Kind#Equal| a@@4 b@@4))
)))
...
(assert (forall ((a@@10 T@U) (b@@10 T@U) ) (!  (=> (and (M1.Kind.Constant_q a@@10) (M1.Kind.Constant_q b@@10)) (|M1.Kind#Equal| a@@10 b@@10))
 :qid |unknown.0:0|
 :skolemid |1137|
 :pattern ( (|M1.Kind#Equal| a@@10 b@@10) (M1.Kind.Constant_q a@@10))
 :pattern ( (|M1.Kind#Equal| a@@10 b@@10) (M1.Kind.Constant_q b@@10))
)))
(assert (forall ((a@@11 T@U) (b@@11 T@U) ) (!  (=> (and (M1.Kind.Ident_q a@@11) (M1.Kind.Ident_q b@@11)) (|M1.Kind#Equal| a@@11 b@@11))
 :qid |unknown.0:0|
 :skolemid |1138|
 :pattern ( (|M1.Kind#Equal| a@@11 b@@11) (M1.Kind.Ident_q a@@11))
 :pattern ( (|M1.Kind#Equal| a@@11 b@@11) (M1.Kind.Ident_q b@@11))
)))
(assert (forall ((a@@12 T@U) (b@@12 T@U) ) (!  (=> (and (M1.Kind.Binary_q a@@12) (M1.Kind.Binary_q b@@12)) (|M1.Kind#Equal| a@@12 b@@12))
 :qid |unknown.0:0|
 :skolemid |1139|
 :pattern ( (|M1.Kind#Equal| a@@12 b@@12) (M1.Kind.Binary_q a@@12))
 :pattern ( (|M1.Kind#Equal| a@@12 b@@12) (M1.Kind.Binary_q b@@12))
)))
...
(set-info :boogie-vc-id Impl$$M1.Expr.Resolve)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 42) (let ((anon9_correct  (=> (= |$rhs#0@0| (|Set#Union| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@11) M1.Expr.Repr)) (ite  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@11) M1.Expr.left)) null)) (not true)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@11) M1.Expr.left))) M1.Expr.Repr)) |Set#Empty|)) (ite  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@11) M1.Expr.right)) null)) (not true)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@11) M1.Expr.right))) M1.Expr.Repr)) |Set#Empty|))) (=> (and (= $Heap@3 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@2 this@@11 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@11) M1.Expr.Repr ($Box SetType |$rhs#0@0|)))) ($IsGoodHeap $Heap@3)) (and (=> (= (ControlFlow 0 2) (- 0 20)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@11 M1.Expr.resolved))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@11 M1.Expr.resolved)) (=> (and (and (= |$rhs#1@0| (U_2_bool (Lit boolType (bool_2_U true)))) (= $Heap@4 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@3 this@@11 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@11) M1.Expr.resolved ($Box boolType (bool_2_U |$rhs#1@0|)))))) (and ($IsGoodHeap $Heap@4) ($IsAllocBox ($Box refType this@@11) Tclass.M1.Expr? $Heap@4))) (and (=> (= (ControlFlow 0 2) (- 0 19)) (=> (|M1.Expr.Core#canCall| $Heap@4 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@4 this@@11) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.Repr)) ($Box refType this@@11))))) (and (=> (= (ControlFlow 0 2) (- 0 18)) (=> (|M1.Expr.Core#canCall| $Heap@4 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@4 this@@11) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.left)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.left)))))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|M1.Expr.Core#canCall| $Heap@4 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@4 this@@11) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.left)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.left))) M1.Expr.Repr)) ($Box refType this@@11))))))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|M1.Expr.Core#canCall| $Heap@4 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@4 this@@11) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.left)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.left))) M1.Expr.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.right))))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|M1.Expr.Core#canCall| $Heap@4 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@4 this@@11) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.left)) null)) (not true)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.left))) M1.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.Repr))))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|M1.Expr.Core#canCall| $Heap@4 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@4 this@@11) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.left)) null)) (not true)) (M1.Expr.Valid ($LS ($LS $LZ)) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.left))))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|M1.Expr.Core#canCall| $Heap@4 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@4 this@@11) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.right)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.right)))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|M1.Expr.Core#canCall| $Heap@4 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@4 this@@11) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.right)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.right))) M1.Expr.Repr)) ($Box refType this@@11))))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|M1.Expr.Core#canCall| $Heap@4 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@4 this@@11) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.right)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.right))) M1.Expr.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.left))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|M1.Expr.Core#canCall| $Heap@4 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@4 this@@11) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.right)) null)) (not true)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.right))) M1.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.Repr))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|M1.Expr.Core#canCall| $Heap@4 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@4 this@@11) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.right)) null)) (not true)) (M1.Expr.Valid ($LS ($LS $LZ)) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.right))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|M1.Expr.Core#canCall| $Heap@4 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@4 this@@11) (=> (|M1.Kind#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.kind)) |#M1.Kind.Binary|) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.left)) null)) (not true)))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|M1.Expr.Core#canCall| $Heap@4 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@4 this@@11) (=> (|M1.Kind#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.kind)) |#M1.Kind.Binary|) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.right)) null)) (not true)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|M1.Expr.Core#canCall| $Heap@4 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@4 this@@11) (=> (|M1.Kind#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.kind)) |#M1.Kind.Binary|) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.left))) M1.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.right))) M1.Expr.Repr))))))) (=> (|M1.Expr.Valid_k#canCall| $Heap@4 this@@11) (=> (and (|M1.Expr.Valid_k#canCall| $Heap@4 this@@11) (M1.Expr.Valid_k ($LS $LZ) $Heap@4 this@@11)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|M1.Expr.Valid#canCall| $Heap@4 this@@11) (or (M1.Expr.Valid ($LS $LZ) $Heap@4 this@@11) (M1.Expr.Core ($LS ($LS $LZ)) $Heap@4 this@@11)))) (=> (=> (|M1.Expr.Valid#canCall| $Heap@4 this@@11) (or (M1.Expr.Valid ($LS $LZ) $Heap@4 this@@11) (M1.Expr.Core ($LS ($LS $LZ)) $Heap@4 this@@11))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|M1.Expr.Valid#canCall| $Heap@4 this@@11) (or (M1.Expr.Valid ($LS $LZ) $Heap@4 this@@11) (M1.Expr.Valid_k ($LS ($LS $LZ)) $Heap@4 this@@11)))) (=> (=> (|M1.Expr.Valid#canCall| $Heap@4 this@@11) (or (M1.Expr.Valid ($LS $LZ) $Heap@4 this@@11) (M1.Expr.Valid_k ($LS ($LS $LZ)) $Heap@4 this@@11))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (forall (($o@@18 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.Repr)) ($Box refType $o@@18)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.Repr)) ($Box refType $o@@18)))) (or (not (= $o@@18 null)) (not true)))
 :qid |MonotonicHeapstatedfy.112:26|
 :skolemid |1092|
 :pattern (  (or (not (= $o@@18 null)) (not true)))
)) (forall (($o@@19 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.Repr)) ($Box refType $o@@19)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.Repr)) ($Box refType $o@@19)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@19) alloc)))))
 :qid |MonotonicHeapstatedfy.112:26|
 :skolemid |1093|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@19) alloc)))
)))) (=> (and (forall (($o@@20 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.Repr)) ($Box refType $o@@20)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.Repr)) ($Box refType $o@@20)))) (or (not (= $o@@20 null)) (not true)))
 :qid |MonotonicHeapstatedfy.112:26|
 :skolemid |1092|
 :pattern (  (or (not (= $o@@20 null)) (not true)))
)) (forall (($o@@21 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.Repr)) ($Box refType $o@@21)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.Repr)) ($Box refType $o@@21)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@21) alloc)))))
 :qid |MonotonicHeapstatedfy.112:26|
 :skolemid |1093|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@21) alloc)))
))) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@11) M1.Expr.resolved)))))))))))))))))))))))))))))))))
(let ((anon12_Else_correct  (=> (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@11) M1.Expr.right)) null) (= (ControlFlow 0 23) 2)) anon9_correct)))
(let ((anon12_Then_correct  (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@11) M1.Expr.right)) null)) (not true)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@11) M1.Expr.right)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@11) M1.Expr.right)) null)) (not true)) (=> (= (ControlFlow 0 21) 2) anon9_correct))))))
(let ((anon11_Else_correct  (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@11) M1.Expr.left)) null) (and (=> (= (ControlFlow 0 26) 21) anon12_Then_correct) (=> (= (ControlFlow 0 26) 23) anon12_Else_correct)))))
(let ((anon11_Then_correct  (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@11) M1.Expr.left)) null)) (not true)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@11) M1.Expr.left)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@11) M1.Expr.left)) null)) (not true)) (and (=> (= (ControlFlow 0 24) 21) anon12_Then_correct) (=> (= (ControlFlow 0 24) 23) anon12_Else_correct)))))))
(let ((anon3_correct  (and (=> (= (ControlFlow 0 27) (- 0 28)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@11 M1.Expr.Repr))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@11 M1.Expr.Repr)) (and (=> (= (ControlFlow 0 27) 24) anon11_Then_correct) (=> (= (ControlFlow 0 27) 26) anon11_Else_correct))))))
(let ((anon10_Else_correct  (=> (not (|M1.Kind#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.kind)) |#M1.Kind.Binary|)) (=> (and (= $Heap@2 $Heap@@7) (= (ControlFlow 0 40) 27)) anon3_correct))))
(let ((anon10_Then_correct  (=> (|M1.Kind#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.kind)) |#M1.Kind.Binary|) (and (=> (= (ControlFlow 0 29) (- 0 39)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.left)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.left)) null)) (not true)) (and (=> (= (ControlFlow 0 29) (- 0 38)) (forall (($o@@22 T@U) ($f@@4 T@U) ) (!  (=> (and (and (or (not (= $o@@22 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@22) alloc)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.left))) M1.Expr.Repr)) ($Box refType $o@@22))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@22 $f@@4)))
 :qid |MonotonicHeapstatedfy.117:21|
 :skolemid |1095|
))) (=> (forall (($o@@23 T@U) ($f@@5 T@U) ) (!  (=> (and (and (or (not (= $o@@23 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@23) alloc)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.left))) M1.Expr.Repr)) ($Box refType $o@@23))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@23 $f@@5)))
 :qid |MonotonicHeapstatedfy.117:21|
 :skolemid |1095|
)) (and (=> (= (ControlFlow 0 29) (- 0 37)) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.left))) M1.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.Repr))) (not (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.left))) M1.Expr.Repr)))))) (=> (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.left))) M1.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.Repr))) (not (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.left))) M1.Expr.Repr))))) (=> (= call0formal@this@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.left))) (and (=> (= (ControlFlow 0 29) (- 0 36)) (=> (|M1.Expr.Valid#canCall| $Heap@@7 call0formal@this@0) (or (M1.Expr.Valid ($LS $LZ) $Heap@@7 call0formal@this@0) (M1.Expr.Core ($LS ($LS $LZ)) $Heap@@7 call0formal@this@0)))) (=> (=> (|M1.Expr.Valid#canCall| $Heap@@7 call0formal@this@0) (or (M1.Expr.Valid ($LS $LZ) $Heap@@7 call0formal@this@0) (M1.Expr.Core ($LS ($LS $LZ)) $Heap@@7 call0formal@this@0))) (and (=> (= (ControlFlow 0 29) (- 0 35)) (=> (|M1.Expr.Valid#canCall| $Heap@@7 call0formal@this@0) (or (M1.Expr.Valid ($LS $LZ) $Heap@@7 call0formal@this@0) (M1.Expr.Valid_k ($LS ($LS $LZ)) $Heap@@7 call0formal@this@0)))) (=> (=> (|M1.Expr.Valid#canCall| $Heap@@7 call0formal@this@0) (or (M1.Expr.Valid ($LS $LZ) $Heap@@7 call0formal@this@0) (M1.Expr.Valid_k ($LS ($LS $LZ)) $Heap@@7 call0formal@this@0))) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (|M1.Expr.Valid#canCall| $Heap@0 call0formal@this@0)) (and (|M1.Expr.Valid#canCall| $Heap@0 call0formal@this@0) (and (M1.Expr.Valid ($LS $LZ) $Heap@0 call0formal@this@0) (and (M1.Expr.Core ($LS $LZ) $Heap@0 call0formal@this@0) (M1.Expr.Valid_k ($LS $LZ) $Heap@0 call0formal@this@0))))) (and (and (and (forall (($o@@24 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call0formal@this@0) M1.Expr.Repr)) ($Box refType $o@@24)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 call0formal@this@0) M1.Expr.Repr)) ($Box refType $o@@24)))) (or (not (= $o@@24 null)) (not true)))
 :qid |MonotonicHeapstatedfy.112:26|
 :skolemid |1089|
 :pattern (  (or (not (= $o@@24 null)) (not true)))
)) (forall (($o@@25 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call0formal@this@0) M1.Expr.Repr)) ($Box refType $o@@25)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 call0formal@this@0) M1.Expr.Repr)) ($Box refType $o@@25)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@25) alloc)))))
 :qid |MonotonicHeapstatedfy.112:26|
 :skolemid |1090|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@25) alloc)))
))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call0formal@this@0) M1.Expr.resolved)))) (and (forall (($o@@26 T@U) ) (!  (=> (and (or (not (= $o@@26 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@26) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@26) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@26)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 call0formal@this@0) M1.Expr.Repr)) ($Box refType $o@@26))))
 :qid |MonotonicHeapstatedfy.109:12|
 :skolemid |1091|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@26))
)) ($HeapSucc $Heap@@7 $Heap@0)))) (and (=> (= (ControlFlow 0 29) (- 0 34)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.right)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.right)) null)) (not true)) (and (=> (= (ControlFlow 0 29) (- 0 33)) (forall (($o@@27 T@U) ($f@@6 T@U) ) (!  (=> (and (and (or (not (= $o@@27 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@27) alloc)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.right))) M1.Expr.Repr)) ($Box refType $o@@27))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@27 $f@@6)))
 :qid |MonotonicHeapstatedfy.118:22|
 :skolemid |1096|
))) (=> (forall (($o@@28 T@U) ($f@@7 T@U) ) (!  (=> (and (and (or (not (= $o@@28 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@28) alloc)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.right))) M1.Expr.Repr)) ($Box refType $o@@28))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@28 $f@@7)))
 :qid |MonotonicHeapstatedfy.118:22|
 :skolemid |1096|
)) (and (=> (= (ControlFlow 0 29) (- 0 32)) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.right))) M1.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.Repr))) (not (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.right))) M1.Expr.Repr)))))) (=> (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.right))) M1.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.Repr))) (not (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.right))) M1.Expr.Repr))))) (=> (= call0formal@this@0@@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.right))) (and (=> (= (ControlFlow 0 29) (- 0 31)) (=> (|M1.Expr.Valid#canCall| $Heap@0 call0formal@this@0@@0) (or (M1.Expr.Valid ($LS $LZ) $Heap@0 call0formal@this@0@@0) (M1.Expr.Core ($LS ($LS $LZ)) $Heap@0 call0formal@this@0@@0)))) (=> (=> (|M1.Expr.Valid#canCall| $Heap@0 call0formal@this@0@@0) (or (M1.Expr.Valid ($LS $LZ) $Heap@0 call0formal@this@0@@0) (M1.Expr.Core ($LS ($LS $LZ)) $Heap@0 call0formal@this@0@@0))) (and (=> (= (ControlFlow 0 29) (- 0 30)) (=> (|M1.Expr.Valid#canCall| $Heap@0 call0formal@this@0@@0) (or (M1.Expr.Valid ($LS $LZ) $Heap@0 call0formal@this@0@@0) (M1.Expr.Valid_k ($LS ($LS $LZ)) $Heap@0 call0formal@this@0@@0)))) (=> (=> (|M1.Expr.Valid#canCall| $Heap@0 call0formal@this@0@@0) (or (M1.Expr.Valid ($LS $LZ) $Heap@0 call0formal@this@0@@0) (M1.Expr.Valid_k ($LS ($LS $LZ)) $Heap@0 call0formal@this@0@@0))) (=> (and (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (|M1.Expr.Valid#canCall| $Heap@1 call0formal@this@0@@0)) (and (|M1.Expr.Valid#canCall| $Heap@1 call0formal@this@0@@0) (and (M1.Expr.Valid ($LS $LZ) $Heap@1 call0formal@this@0@@0) (and (M1.Expr.Core ($LS $LZ) $Heap@1 call0formal@this@0@@0) (M1.Expr.Valid_k ($LS $LZ) $Heap@1 call0formal@this@0@@0))))) (and (and (and (forall (($o@@29 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0@@0) M1.Expr.Repr)) ($Box refType $o@@29)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call0formal@this@0@@0) M1.Expr.Repr)) ($Box refType $o@@29)))) (or (not (= $o@@29 null)) (not true)))
 :qid |MonotonicHeapstatedfy.112:26|
 :skolemid |1089|
 :pattern (  (or (not (= $o@@29 null)) (not true)))
)) (forall (($o@@30 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0@@0) M1.Expr.Repr)) ($Box refType $o@@30)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call0formal@this@0@@0) M1.Expr.Repr)) ($Box refType $o@@30)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@30) alloc)))))
 :qid |MonotonicHeapstatedfy.112:26|
 :skolemid |1090|
...
))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0@@0) M1.Expr.resolved)))) (and (and (forall (($o@@31 T@U) ) (!  (=> (and (or (not (= $o@@31 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@31) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@31) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@31)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call0formal@this@0@@0) M1.Expr.Repr)) ($Box refType $o@@31))))
 :qid |MonotonicHeapstatedfy.109:12|
 :skolemid |1091|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@31))
)) ($HeapSucc $Heap@0 $Heap@1)) (and (= $Heap@2 $Heap@1) (= (ControlFlow 0 29) 27))))) anon3_correct)))))))))))))))))))))))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#5| null $Heap@@7 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.Repr)))) (|$IsA#M1.Kind| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.kind)))) (and (=> (= (ControlFlow 0 41) 29) anon10_Then_correct) (=> (= (ControlFlow 0 41) 40) anon10_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@7) ($IsHeapAnchor $Heap@@7)) (=> (and (and (and (or (not (= this@@11 null)) (not true)) (and ($Is refType this@@11 Tclass.M1.Expr) ($IsAlloc refType this@@11 Tclass.M1.Expr $Heap@@7))) (= 2 $FunctionContextHeight)) (and (and (|M1.Expr.Valid#canCall| $Heap@@7 this@@11) (and (M1.Expr.Valid ($LS $LZ) $Heap@@7 this@@11) (and (M1.Expr.Core ($LS $LZ) $Heap@@7 this@@11) (M1.Expr.Valid_k ($LS $LZ) $Heap@@7 this@@11)))) (= (ControlFlow 0 42) 41))) anon0_correct))))
