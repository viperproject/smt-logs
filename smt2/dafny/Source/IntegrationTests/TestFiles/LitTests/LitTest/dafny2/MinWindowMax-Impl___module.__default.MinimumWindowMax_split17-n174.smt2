...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split175)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon53_correct  (=> (and (<= (LitInt 0) |start#0@1|) (<= |start#0@1| (- (_System.array.Length |a#0@@4|) |W#0|))) (=> (and (and ($IsAlloc refType |a#0@@4| (Tclass._System.array TInt) $Heap@5) ($IsAlloc intType (int_2_U |start#0@1|) TInt $Heap@5)) (and ($IsAlloc intType (int_2_U |W#0|) TInt $Heap@5) (= (ControlFlow 0 2) (- 0 1)))) (<= (+ |start#0@1| |W#0|) (_System.array.Length |a#0@@4|))))))
