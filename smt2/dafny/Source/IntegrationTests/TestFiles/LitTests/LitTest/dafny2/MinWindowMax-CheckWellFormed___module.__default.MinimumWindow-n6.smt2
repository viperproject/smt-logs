...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.MinimumWindowMax_split6)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_correct  (=> (and (and (and (and (<= (LitInt 0) |start#0@0|) (<= |start#0@0| (- (_System.array.Length |a#0@@2|) |W#0|))) ($IsAlloc refType |a#0@@2| (Tclass._System.array TInt) $Heap@0)) (and ($IsAlloc intType (int_2_U |start#0@0|) TInt $Heap@0) ($IsAlloc intType (int_2_U |W#0|) TInt $Heap@0))) (and (and (and (<= (LitInt 0) |start#0@0|) (<= (LitInt 1) |W#0|)) (<= (+ |start#0@0| |W#0|) (_System.array.Length |a#0@@2|))) (and (and (|_module.__default.Max#canCall| $Heap@0 |a#0@@2| |start#0@0| |W#0|) (= |m#0@0| (_module.__default.Max ($LS $LZ) $Heap@0 |a#0@@2| |start#0@0| |W#0|))) (and (<= (LitInt 0) |s#0@0|) (= (ControlFlow 0 2) (- 0 1)))))) (or (not (= |a#0@@2| null)) (not true)))))
(let ((anon12_Else_correct  (=> (and (< |start#0@0| (LitInt 0)) (= (ControlFlow 0 4) 2)) anon5_correct)))
(let ((anon12_Then_correct  (=> (<= (LitInt 0) |start#0@0|) (=> (and (or (not (= |a#0@@2| null)) (not true)) (= (ControlFlow 0 3) 2)) anon5_correct))))
...
)) ($HeapSucc $Heap@@1 $Heap@0))) (and (=> (= (ControlFlow 0 5) 3) anon12_Then_correct) (=> (= (ControlFlow 0 5) 4) anon12_Else_correct))))))
(let ((anon11_Else_correct  (=> (and (< |W#0| (LitInt 1)) (= (ControlFlow 0 7) 5)) anon3_correct)))
(let ((anon11_Then_correct  (=> (<= (LitInt 1) |W#0|) (=> (and (or (not (= |a#0@@2| null)) (not true)) (= (ControlFlow 0 6) 5)) anon3_correct))))
(let ((anon0_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and ($Is refType |a#0@@2| (Tclass._System.array TInt)) ($IsAlloc refType |a#0@@2| (Tclass._System.array TInt) $Heap@@1)) (and (= 3 $FunctionContextHeight) (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)))) (and (=> (= (ControlFlow 0 8) 6) anon11_Then_correct) (=> (= (ControlFlow 0 8) 7) anon11_Else_correct))))))
anon0_correct))))))))
))
(check-sat)
(get-info :rlimit)
