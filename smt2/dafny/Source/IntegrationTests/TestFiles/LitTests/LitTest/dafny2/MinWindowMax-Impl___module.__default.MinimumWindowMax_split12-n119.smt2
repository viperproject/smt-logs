...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split120)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon90_correct  (=> (= |n#0@4| (+ |n#0@3| 1)) (=> (and ($Is intType (int_2_U |W#0|) Tclass._System.nat) (<= (LitInt 0) |k#0@2|)) (=> (and (and (and (and (<= |k#0@2| |$rhs#1_1@1|) (<= |$rhs#1_1@1| (_System.array.Length $nw@0))) (and (forall ((|i#1@@1| Int) ) (!  (and (=> (and (<= |k#0@2| |i#1@@1|) (< |i#1@@1| |$rhs#1_1@1|)) (<= (- |n#0@4| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $nw@0) (IndexField |i#1@@1|)))))) (=> (and (<= |k#0@2| |i#1@@1|) (< |i#1@@1| |$rhs#1_1@1|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $nw@0) (IndexField |i#1@@1|)))) |n#0@4|)))
...
)))) (and (and ($IsGoodHeap $Heap@8) ($IsHeapAnchor $Heap@8)) (<= (- |$rhs#1_1@1| |k#0@2|) |W#0|))) (and (and (and (= $Heap@7 $Heap@8) (or (<= 0 |$decr$loop#10@1|) (= (- (_System.array.Length |a#0@@4|) |n#0@4|) |$decr$loop#10@1|))) (and (< (- (_System.array.Length |a#0@@4|) |n#0@4|) |$decr$loop#10@1|) (=> (and (and (and (<= (LitInt 0) |k#0@2|) (< |k#0@2| |$rhs#1_1@1|)) (<= |$rhs#1_1@1| |n#0@4|)) (<= |n#0@4| (_System.array.Length |a#0@@4|))) (and (|_module.__default.StrictlyIncreasing#canCall| $Heap@8 $nw@0 |k#0@2| |$rhs#1_1@1| (- |n#0@4| |W#0|) |n#0@4|) (=> (_module.__default.StrictlyIncreasing $Heap@8 $nw@0 |k#0@2| |$rhs#1_1@1| (- |n#0@4| |W#0|) |n#0@4|) (and (|_module.__default.RightmostMax#canCall| $Heap@8 |a#0@@4| (- |n#0@4| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |k#0@2|)))) |n#0@4|) (=> (_module.__default.RightmostMax $Heap@8 |a#0@@4| (- |n#0@4| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |k#0@2|)))) |n#0@4|) (and (forall ((|u#3| Int) (|_t#0#1| Int) ) (!  (=> (= |_t#0#1| (- |u#3| 1)) (=> (< |k#0@2| |u#3|) (=> (< |u#3| |$rhs#1_1@1|) (|_module.__default.RightmostMax#canCall| $Heap@8 |a#0@@4| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |_t#0#1|)))) 1) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |u#3|)))) |n#0@4|))))
...
))))))))))))))) (and (and (=> |$w$loop#1@0| (<= (LitInt 0) |k#0@2|)) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#1@0|))) (< |k#0@2| |$rhs#1_1@1|))))))
...
))))))) (and (and (=> |$w$loop#1@0| (=> (|_module.__default.StrictlyIncreasing#canCall| $Heap@3 $nw@0 |$rhs#1@0| |l#0@0| (- |n#0@1| |W#0|) |n#0@1|) (or (_module.__default.StrictlyIncreasing $Heap@3 $nw@0 |$rhs#1@0| |l#0@0| (- |n#0@1| |W#0|) |n#0@1|) (forall ((|i#5| Int) (|j#1@@0| Int) ) (!  (=> (and (and (<= |$rhs#1@0| |i#5|) (< |i#5| |j#1@@0|)) (< |j#1@@0| |l#0@0|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |i#5|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |j#1@@0|))))))
 :qid |MinWindowMaxdfy.147:11|
 :skolemid |691|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |j#1@@0|))) ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |i#5|))))
...
)))))) (and (=> |$w$loop#1@0| (=> (|_module.__default.StrictlyIncreasing#canCall| $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|) (or (_module.__default.StrictlyIncreasing $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|) (forall ((|i#5@@0| Int) (|j#1@@1| Int) ) (!  (=> (and (and (<= |k#0@0| |i#5@@0|) (< |i#5@@0| |j#1@@1|)) (< |j#1@@1| |l#0@3|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |i#5@@0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |j#1@@1|))))))
 :qid |MinWindowMaxdfy.147:11|
 :skolemid |691|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |j#1@@1|))) ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |i#5@@0|))))
...
)) (forall ((|i#5@@1| Int) (|j#1@@2| Int) ) (!  (=> (and (and (<= |k#0@0| |i#5@@1|) (< |i#5@@1| |j#1@@2|)) (< |j#1@@2| |l#0@3|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |i#5@@1|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |j#1@@2|))))))
 :qid |MinWindowMaxdfy.147:11|
 :skolemid |693|
