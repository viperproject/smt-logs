...
(set-info :boogie-vc-id CheckWellFormed$$SnapTree.Node.Build)
...
(let ((anon28_Then_correct  (=> (and (or (not (= |left#0@@6| null)) (not true)) (or (not (= |right#0@@6| null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |left#0@@6| null)) (not true))) (=> (or (not (= |left#0@@6| null)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= |right#0@@6| null)) (not true))))))))
(let ((anon27_Else_correct  (=> (=> (and (= |left#0@@6| null) (or (not (= |right#0@@6| null)) (not true))) (and (forall (($o@@17 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) SnapTree.Node.Repr)) ($Box refType $o@@17)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |right#0@@6|) SnapTree.Node.Repr)) ($Box refType $o@@17)))) (or (not (= $o@@17 null)) (not true)))
 :qid |SnapshotableTreesdfy.316:49|
 :skolemid |871|
 :pattern (  (or (not (= $o@@17 null)) (not true)))
)) (forall (($o@@18 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) SnapTree.Node.Repr)) ($Box refType $o@@18)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |right#0@@6|) SnapTree.Node.Repr)) ($Box refType $o@@18)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@18) alloc)))))
 :qid |SnapshotableTreesdfy.316:49|
 :skolemid |872|
...
)))) (and (=> (= (ControlFlow 0 7) 2) anon28_Then_correct) (=> (= (ControlFlow 0 7) 4) anon28_Else_correct)))))
(let ((anon27_Then_correct  (=> (and (= |left#0@@6| null) (or (not (= |right#0@@6| null)) (not true))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= |right#0@@6| null)) (not true))) (=> (or (not (= |right#0@@6| null)) (not true)) (=> (and (forall (($o@@19 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) SnapTree.Node.Repr)) ($Box refType $o@@19)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |right#0@@6|) SnapTree.Node.Repr)) ($Box refType $o@@19)))) (or (not (= $o@@19 null)) (not true)))
 :qid |SnapshotableTreesdfy.316:49|
 :skolemid |869|
 :pattern (  (or (not (= $o@@19 null)) (not true)))
)) (forall (($o@@20 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) SnapTree.Node.Repr)) ($Box refType $o@@20)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |right#0@@6|) SnapTree.Node.Repr)) ($Box refType $o@@20)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@20) alloc)))))
 :qid |SnapshotableTreesdfy.316:49|
 :skolemid |870|
...
))) (and (=> (= (ControlFlow 0 5) 2) anon28_Then_correct) (=> (= (ControlFlow 0 5) 4) anon28_Else_correct))))))))
(let ((anon26_Else_correct  (=> (=> (and (or (not (= |left#0@@6| null)) (not true)) (= |right#0@@6| null)) (and (forall (($o@@21 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) SnapTree.Node.Repr)) ($Box refType $o@@21)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |left#0@@6|) SnapTree.Node.Repr)) ($Box refType $o@@21)))) (or (not (= $o@@21 null)) (not true)))
 :qid |SnapshotableTreesdfy.315:49|
 :skolemid |867|
 :pattern (  (or (not (= $o@@21 null)) (not true)))
)) (forall (($o@@22 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) SnapTree.Node.Repr)) ($Box refType $o@@22)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |left#0@@6|) SnapTree.Node.Repr)) ($Box refType $o@@22)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@22) alloc)))))
 :qid |SnapshotableTreesdfy.315:49|
 :skolemid |868|
...
)))) (and (=> (= (ControlFlow 0 10) 5) anon27_Then_correct) (=> (= (ControlFlow 0 10) 7) anon27_Else_correct)))))
(let ((anon26_Then_correct  (=> (and (or (not (= |left#0@@6| null)) (not true)) (= |right#0@@6| null)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (not (= |left#0@@6| null)) (not true))) (=> (or (not (= |left#0@@6| null)) (not true)) (=> (and (forall (($o@@23 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) SnapTree.Node.Repr)) ($Box refType $o@@23)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |left#0@@6|) SnapTree.Node.Repr)) ($Box refType $o@@23)))) (or (not (= $o@@23 null)) (not true)))
 :qid |SnapshotableTreesdfy.315:49|
 :skolemid |865|
 :pattern (  (or (not (= $o@@23 null)) (not true)))
)) (forall (($o@@24 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) SnapTree.Node.Repr)) ($Box refType $o@@24)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |left#0@@6|) SnapTree.Node.Repr)) ($Box refType $o@@24)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@24) alloc)))))
 :qid |SnapshotableTreesdfy.315:49|
 :skolemid |866|
...
))) (and (=> (= (ControlFlow 0 8) 5) anon27_Then_correct) (=> (= (ControlFlow 0 8) 7) anon27_Else_correct))))))))
(let ((anon25_Else_correct  (=> (=> (and (= |left#0@@6| null) (= |right#0@@6| null)) (and (forall (($o@@25 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) SnapTree.Node.Repr)) ($Box refType $o@@25)) (or (not (= $o@@25 null)) (not true)))
 :qid |SnapshotableTreesdfy.314:49|
 :skolemid |863|
 :pattern (  (or (not (= $o@@25 null)) (not true)))
)) (forall (($o@@26 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) SnapTree.Node.Repr)) ($Box refType $o@@26)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@26) alloc)))))
 :qid |SnapshotableTreesdfy.314:49|
 :skolemid |864|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) SnapTree.Node.Repr)) ($Box refType $o@@26)))
)))) (and (=> (= (ControlFlow 0 12) 8) anon26_Then_correct) (=> (= (ControlFlow 0 12) 10) anon26_Else_correct)))))
(let ((anon25_Then_correct  (=> (and (and (= |left#0@@6| null) (= |right#0@@6| null)) (and (forall (($o@@27 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) SnapTree.Node.Repr)) ($Box refType $o@@27)) (or (not (= $o@@27 null)) (not true)))
 :qid |SnapshotableTreesdfy.314:49|
 :skolemid |861|
 :pattern (  (or (not (= $o@@27 null)) (not true)))
)) (forall (($o@@28 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) SnapTree.Node.Repr)) ($Box refType $o@@28)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@28) alloc)))))
 :qid |SnapshotableTreesdfy.314:49|
 :skolemid |862|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) SnapTree.Node.Repr)) ($Box refType $o@@28)))
)))) (and (=> (= (ControlFlow 0 11) 8) anon26_Then_correct) (=> (= (ControlFlow 0 11) 10) anon26_Else_correct)))))
(let ((anon10_correct  (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (forall (($o@@29 T@U) ) (!  (=> (and (or (not (= $o@@29 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@29) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@29) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@29)))
 :qid |SnapshotableTreesdfy.308:17|
 :skolemid |860|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@29))
)) ($HeapSucc $Heap@@5 $Heap@0)) (and (or (not (= this@0 null)) (not true)) (and ($Is refType this@0 Tclass.SnapTree.Node) ($IsAlloc refType this@0 Tclass.SnapTree.Node $Heap@0)))) (=> (and (and (and ($IsAllocBox ($Box refType this@0) Tclass.SnapTree.Node? $Heap@0) (|SnapTree.Node.NodeValid#canCall| $Heap@0 this@0)) (and (SnapTree.Node.NodeValid ($LS $LZ) reveal_SnapTree.Node.NodeValid $Heap@0 this@0) ($IsAlloc refType |left#0@@6| Tclass.SnapTree.Node? $Heap@0))) (and (and ($IsAlloc intType (int_2_U |x#0|) TInt $Heap@0) ($IsAlloc refType |right#0@@6| Tclass.SnapTree.Node? $Heap@0)) (and (|SnapTree.Node.CombineSplit#canCall| $Heap@0 |left#0@@6| |x#0| |right#0@@6|) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) SnapTree.Node.Contents)) (SnapTree.Node.CombineSplit $Heap@0 |left#0@@6| |x#0| |right#0@@6|))))) (and (=> (= (ControlFlow 0 13) 11) anon25_Then_correct) (=> (= (ControlFlow 0 13) 12) anon25_Else_correct)))))))
(let ((anon24_Else_correct  (=> (and (=> (and (or (not (= |left#0@@6| null)) (not true)) (or (not (= |right#0@@6| null)) (not true))) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |left#0@@6|) SnapTree.Node.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |right#0@@6|) SnapTree.Node.Repr)))) (= (ControlFlow 0 17) 13)) anon10_correct)))
(let ((anon24_Then_correct  (=> (and (or (not (= |left#0@@6| null)) (not true)) (or (not (= |right#0@@6| null)) (not true))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (or (not (= |left#0@@6| null)) (not true))) (=> (or (not (= |left#0@@6| null)) (not true)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (or (not (= |right#0@@6| null)) (not true))) (=> (or (not (= |right#0@@6| null)) (not true)) (=> (and (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |left#0@@6|) SnapTree.Node.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |right#0@@6|) SnapTree.Node.Repr))) (= (ControlFlow 0 14) 13)) anon10_correct))))))))
(let ((anon23_Else_correct  (=> (=> (or (not (= |right#0@@6| null)) (not true)) (and (SnapTree.Node.NodeValid ($LS $LZ) reveal_SnapTree.Node.NodeValid $Heap@@5 |right#0@@6|) (SnapTree.Tree.AllAbove |x#0| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |right#0@@6|) SnapTree.Node.Contents))))) (and (=> (= (ControlFlow 0 21) 14) anon24_Then_correct) (=> (= (ControlFlow 0 21) 17) anon24_Else_correct)))))
(let ((anon23_Then_correct  (=> (or (not (= |right#0@@6| null)) (not true)) (and (=> (= (ControlFlow 0 18) (- 0 20)) (or (not (= |right#0@@6| null)) (not true))) (=> (or (not (= |right#0@@6| null)) (not true)) (=> (and (and ($IsAllocBox ($Box refType |right#0@@6|) Tclass.SnapTree.Node? $Heap@@5) (|SnapTree.Node.NodeValid#canCall| $Heap@@5 |right#0@@6|)) (and (SnapTree.Node.NodeValid ($LS $LZ) reveal_SnapTree.Node.NodeValid $Heap@@5 |right#0@@6|) ($IsAlloc intType (int_2_U |x#0|) TInt $Heap@@5))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (or (not (= |right#0@@6| null)) (not true))) (=> (or (not (= |right#0@@6| null)) (not true)) (=> (and (and (= |##s#1@0| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |right#0@@6|) SnapTree.Node.Contents))) ($IsAlloc SeqType |##s#1@0| (TSeq TInt) $Heap@@5)) (and (|SnapTree.Tree.AllAbove#canCall| |x#0| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |right#0@@6|) SnapTree.Node.Contents))) (SnapTree.Tree.AllAbove |x#0| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |right#0@@6|) SnapTree.Node.Contents))))) (and (=> (= (ControlFlow 0 18) 14) anon24_Then_correct) (=> (= (ControlFlow 0 18) 17) anon24_Else_correct)))))))))))
(let ((anon22_Else_correct  (=> (=> (or (not (= |left#0@@6| null)) (not true)) (and (SnapTree.Node.NodeValid ($LS $LZ) reveal_SnapTree.Node.NodeValid $Heap@@5 |left#0@@6|) (SnapTree.Tree.AllBelow ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |left#0@@6|) SnapTree.Node.Contents)) |x#0|))) (and (=> (= (ControlFlow 0 25) 18) anon23_Then_correct) (=> (= (ControlFlow 0 25) 21) anon23_Else_correct)))))
(let ((anon22_Then_correct  (=> (or (not (= |left#0@@6| null)) (not true)) (and (=> (= (ControlFlow 0 22) (- 0 24)) (or (not (= |left#0@@6| null)) (not true))) (=> (or (not (= |left#0@@6| null)) (not true)) (=> ($IsAllocBox ($Box refType |left#0@@6|) Tclass.SnapTree.Node? $Heap@@5) (=> (and (|SnapTree.Node.NodeValid#canCall| $Heap@@5 |left#0@@6|) (SnapTree.Node.NodeValid ($LS $LZ) reveal_SnapTree.Node.NodeValid $Heap@@5 |left#0@@6|)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (or (not (= |left#0@@6| null)) (not true))) (=> (or (not (= |left#0@@6| null)) (not true)) (=> (= |##s#0@0| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |left#0@@6|) SnapTree.Node.Contents))) (=> (and (and ($IsAlloc SeqType |##s#0@0| (TSeq TInt) $Heap@@5) ($IsAlloc intType (int_2_U |x#0|) TInt $Heap@@5)) (and (|SnapTree.Tree.AllBelow#canCall| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |left#0@@6|) SnapTree.Node.Contents)) |x#0|) (SnapTree.Tree.AllBelow ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |left#0@@6|) SnapTree.Node.Contents)) |x#0|))) (and (=> (= (ControlFlow 0 22) 18) anon23_Then_correct) (=> (= (ControlFlow 0 22) 21) anon23_Else_correct)))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@5 alloc false)) (and (=> (= (ControlFlow 0 26) 22) anon22_Then_correct) (=> (= (ControlFlow 0 26) 25) anon22_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@5) ($IsHeapAnchor $Heap@@5)) (and ($Is refType |left#0@@6| Tclass.SnapTree.Node?) ($IsAlloc refType |left#0@@6| Tclass.SnapTree.Node? $Heap@@5))) (and (and ($Is refType |right#0@@6| Tclass.SnapTree.Node?) ($IsAlloc refType |right#0@@6| Tclass.SnapTree.Node? $Heap@@5)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 27) 26)))) anon0_correct)))
