...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split156)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon65_correct  (=> (and (and (<= |k#0@0| |l#0@4|) (<= |l#0@4| |n#0@3|)) (and (< |k#0@0| |l#0@4|) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= $nw@0 null)) (not true)))))
