...
(assert (forall (($reveal@@7 Bool) ($h0@@4 T@U) ($h1@@4 T@U) (this@@8 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@4) ($IsGoodHeap $h1@@4)) (and (or (not (= this@@8 null)) (not true)) ($Is refType this@@8 Tclass.SnapTree.Iterator))) (and ($IsHeapAnchor $h0@@4) ($HeapSucc $h0@@4 $h1@@4))) (=> (forall (($o@@46 T@U) ($f@@4 T@U) )  (=> (and (or (not (= $o@@46 null)) (not true)) (or (or (or (= $o@@46 this@@8) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 this@@8) SnapTree.Iterator.IterRepr)) ($Box refType $o@@46))) (= $o@@46 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 this@@8) SnapTree.Iterator.T)))) (|Set#IsMember| (ite  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 this@@8) SnapTree.Iterator.T)) null)) (not true)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 this@@8) SnapTree.Iterator.T))) SnapTree.Tree.Repr)) |Set#Empty|) ($Box refType $o@@46)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 $o@@46) $f@@4) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@4 $o@@46) $f@@4)))) (= (SnapTree.Iterator.Valid $reveal@@7 $h0@@4 this@@8) (SnapTree.Iterator.Valid $reveal@@7 $h1@@4 this@@8))))
