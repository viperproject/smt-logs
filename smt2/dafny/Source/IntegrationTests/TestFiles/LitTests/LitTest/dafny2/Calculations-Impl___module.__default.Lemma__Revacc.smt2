...
(let ((|x#1| (_module.List._h0 |l#0@@2|)))
...
(let ((|x#1@@0| (_module.List._h0 |l#0@@3|)))
...
(let ((|x#3| (Lit BoxType (_module.List._h0 (Lit DatatypeTypeType |l#0@@4|)))))
...
(let ((|x#3@@0| (Lit BoxType (_module.List._h0 (Lit DatatypeTypeType |l#0@@9|)))))
...
(declare-fun _module._default.Lemma_Revacc$_T0 () T@U)
(declare-fun |xs#0@@2| () T@U)
(declare-fun |ys#0@@4| () T@U)
(declare-fun $Heap@1 () T@U)
(declare-fun |xrest#0_0@0| () T@U)
(declare-fun |##l#0_18@0| () T@U)
(declare-fun |x#0_0@0| () T@U)
(declare-fun |##acc#0_5@0| () T@U)
(declare-fun |##acc#0_6@0| () T@U)
(declare-fun |g#0_0@0| () T@U)
(declare-fun |gs#0_0@0| () T@U)
(declare-fun |##l#0_16@0| () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $Heap@0 () T@U)
(declare-fun |##acc#0_3@0| () T@U)
(declare-fun |##l#0_12@0| () T@U)
(declare-fun |##l#0_15@0| () T@U)
(declare-fun |##acc#0_4@0| () T@U)
(declare-fun |##l#0_8@0| () T@U)
(declare-fun |##ys#0_3@0| () T@U)
(declare-fun |##l#0_7@0| () T@U)
(declare-fun |##acc#0_2@0| () T@U)
(declare-fun |##l#0_10@0| () T@U)
(declare-fun |_mcc#0#0_0@0| () T@U)
(declare-fun |_mcc#1#0_0@0| () T@U)
(declare-fun |let#0_0#0#0| () T@U)
(declare-fun |let#0_1#0#0| () T@U)
(declare-fun |##acc#0_1@0| () T@U)
(declare-fun |##l#0_2@0| () T@U)
(declare-fun |##l#0_5@0| () T@U)
(declare-fun |##ys#0_1@0| () T@U)
(declare-fun |##l#0_4@0| () T@U)
...
(let ((anon10_Else_correct  (=> (and (not (|_module.List#Equal| (_module.__default.concat _module._default.Lemma_Revacc$_T0 ($LS $LZ) (_module.__default.reverse _module._default.Lemma_Revacc$_T0 ($LS $LZ) |xs#0@@2|) |ys#0@@4|) (_module.__default.concat _module._default.Lemma_Revacc$_T0 ($LS $LZ) (_module.__default.concat _module._default.Lemma_Revacc$_T0 ($LS $LZ) (_module.__default.reverse _module._default.Lemma_Revacc$_T0 ($LS $LZ) |xrest#0_0@0|) (|#_module.List.Cons| |x#0_0@0| (Lit DatatypeTypeType |#_module.List.Nil|))) |ys#0@@4|))) (= (ControlFlow 0 15) 10)) anon4_correct)))
(let ((anon10_Then_correct  (=> (|_module.List#Equal| (_module.__default.concat _module._default.Lemma_Revacc$_T0 ($LS $LZ) (_module.__default.reverse _module._default.Lemma_Revacc$_T0 ($LS $LZ) |xs#0@@2|) |ys#0@@4|) (_module.__default.concat _module._default.Lemma_Revacc$_T0 ($LS $LZ) (_module.__default.concat _module._default.Lemma_Revacc$_T0 ($LS $LZ) (_module.__default.reverse _module._default.Lemma_Revacc$_T0 ($LS $LZ) |xrest#0_0@0|) (|#_module.List.Cons| |x#0_0@0| (Lit DatatypeTypeType |#_module.List.Nil|))) |ys#0@@4|)) (=> (and (and ($IsAlloc DatatypeTypeType |xrest#0_0@0| (Tclass._module.List _module._default.Lemma_Revacc$_T0) $Heap@0) (|_module.__default.reverse#canCall| _module._default.Lemma_Revacc$_T0 |xrest#0_0@0|)) (and (= |##l#0_8@0| (_module.__default.reverse _module._default.Lemma_Revacc$_T0 ($LS $LZ) |xrest#0_0@0|)) ($IsAlloc DatatypeTypeType |##l#0_8@0| (Tclass._module.List _module._default.Lemma_Revacc$_T0) $Heap@0))) (=> (and (and (and (and (= |##ys#0_3@0| (|#_module.List.Cons| |x#0_0@0| (Lit DatatypeTypeType |#_module.List.Nil|))) ($IsAlloc DatatypeTypeType |##ys#0_3@0| (Tclass._module.List _module._default.Lemma_Revacc$_T0) $Heap@0)) (and (|_module.__default.concat#canCall| _module._default.Lemma_Revacc$_T0 (_module.__default.reverse _module._default.Lemma_Revacc$_T0 ($LS $LZ) |xrest#0_0@0|) (|#_module.List.Cons| |x#0_0@0| (Lit DatatypeTypeType |#_module.List.Nil|))) (= |##l#0_7@0| (_module.__default.concat _module._default.Lemma_Revacc$_T0 ($LS $LZ) (_module.__default.reverse _module._default.Lemma_Revacc$_T0 ($LS $LZ) |xrest#0_0@0|) (|#_module.List.Cons| |x#0_0@0| (Lit DatatypeTypeType |#_module.List.Nil|)))))) (and (and ($IsAlloc DatatypeTypeType |##l#0_7@0| (Tclass._module.List _module._default.Lemma_Revacc$_T0) $Heap@0) ($IsAlloc DatatypeTypeType |ys#0@@4| (Tclass._module.List _module._default.Lemma_Revacc$_T0) $Heap@0)) (and (|_module.__default.concat#canCall| _module._default.Lemma_Revacc$_T0 (_module.__default.concat _module._default.Lemma_Revacc$_T0 ($LS $LZ) (_module.__default.reverse _module._default.Lemma_Revacc$_T0 ($LS $LZ) |xrest#0_0@0|) (|#_module.List.Cons| |x#0_0@0| (Lit DatatypeTypeType |#_module.List.Nil|))) |ys#0@@4|) ($IsAlloc DatatypeTypeType |xrest#0_0@0| (Tclass._module.List _module._default.Lemma_Revacc$_T0) $Heap@0)))) (and (and (and (= |##acc#0_2@0| (|#_module.List.Cons| |x#0_0@0| (Lit DatatypeTypeType |#_module.List.Nil|))) ($IsAlloc DatatypeTypeType |##acc#0_2@0| (Tclass._module.List _module._default.Lemma_Revacc$_T0) $Heap@0)) (and (|_module.__default.revacc#canCall| _module._default.Lemma_Revacc$_T0 |xrest#0_0@0| (|#_module.List.Cons| |x#0_0@0| (Lit DatatypeTypeType |#_module.List.Nil|))) (= |##l#0_10@0| (_module.__default.revacc _module._default.Lemma_Revacc$_T0 ($LS $LZ) |xrest#0_0@0| (|#_module.List.Cons| |x#0_0@0| (Lit DatatypeTypeType |#_module.List.Nil|)))))) (and (and ($IsAlloc DatatypeTypeType |##l#0_10@0| (Tclass._module.List _module._default.Lemma_Revacc$_T0) $Heap@0) ($IsAlloc DatatypeTypeType |ys#0@@4| (Tclass._module.List _module._default.Lemma_Revacc$_T0) $Heap@0)) (and (|_module.__default.concat#canCall| _module._default.Lemma_Revacc$_T0 (_module.__default.revacc _module._default.Lemma_Revacc$_T0 ($LS $LZ) |xrest#0_0@0| (|#_module.List.Cons| |x#0_0@0| (Lit DatatypeTypeType |#_module.List.Nil|))) |ys#0@@4|) (= (ControlFlow 0 14) 10))))) anon4_correct)))))
(let ((anon9_Then_correct  (=> (= |xs#0@@2| (|#_module.List.Cons| |_mcc#0#0_0@0| |_mcc#1#0_0@0|)) (=> (and ($IsBox |_mcc#0#0_0@0| _module._default.Lemma_Revacc$_T0) ($Is DatatypeTypeType |_mcc#1#0_0@0| (Tclass._module.List _module._default.Lemma_Revacc$_T0))) (=> (and (and (and ($Is DatatypeTypeType |xrest#0_0@0| (Tclass._module.List _module._default.Lemma_Revacc$_T0)) ($IsAlloc DatatypeTypeType |xrest#0_0@0| (Tclass._module.List _module._default.Lemma_Revacc$_T0) $Heap@0)) (= |let#0_0#0#0| |_mcc#1#0_0@0|)) (and ($Is DatatypeTypeType |let#0_0#0#0| (Tclass._module.List _module._default.Lemma_Revacc$_T0)) (= |xrest#0_0@0| |let#0_0#0#0|))) (=> (and (and (and (and ($IsBox |x#0_0@0| _module._default.Lemma_Revacc$_T0) ($IsAllocBox |x#0_0@0| _module._default.Lemma_Revacc$_T0 $Heap@0)) (and (= |let#0_1#0#0| |_mcc#0#0_0@0|) ($IsBox |let#0_1#0#0| _module._default.Lemma_Revacc$_T0))) (and (and (= |x#0_0@0| |let#0_1#0#0|) ($IsAlloc DatatypeTypeType |xs#0@@2| (Tclass._module.List _module._default.Lemma_Revacc$_T0) $Heap@0)) (and ($IsAlloc DatatypeTypeType |ys#0@@4| (Tclass._module.List _module._default.Lemma_Revacc$_T0) $Heap@0) (|_module.__default.revacc#canCall| _module._default.Lemma_Revacc$_T0 |xs#0@@2| |ys#0@@4|)))) (and (and (and ($IsAlloc DatatypeTypeType |xrest#0_0@0| (Tclass._module.List _module._default.Lemma_Revacc$_T0) $Heap@0) (= |##acc#0_1@0| (|#_module.List.Cons| |x#0_0@0| |ys#0@@4|))) (and ($IsAlloc DatatypeTypeType |##acc#0_1@0| (Tclass._module.List _module._default.Lemma_Revacc$_T0) $Heap@0) (|_module.__default.revacc#canCall| _module._default.Lemma_Revacc$_T0 |xrest#0_0@0| (|#_module.List.Cons| |x#0_0@0| |ys#0@@4|)))) (and (and (|$IsA#_module.List| (_module.__default.revacc _module._default.Lemma_Revacc$_T0 ($LS $LZ) |xs#0@@2| |ys#0@@4|)) (|$IsA#_module.List| (_module.__default.revacc _module._default.Lemma_Revacc$_T0 ($LS $LZ) |xrest#0_0@0| (|#_module.List.Cons| |x#0_0@0| |ys#0@@4|)))) (and (|_module.__default.revacc#canCall| _module._default.Lemma_Revacc$_T0 |xs#0@@2| |ys#0@@4|) (|_module.__default.revacc#canCall| _module._default.Lemma_Revacc$_T0 |xrest#0_0@0| (|#_module.List.Cons| |x#0_0@0| |ys#0@@4|)))))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (|_module.List#Equal| (_module.__default.revacc _module._default.Lemma_Revacc$_T0 ($LS ($LS $LZ)) |xs#0@@2| |ys#0@@4|) (_module.__default.revacc _module._default.Lemma_Revacc$_T0 ($LS ($LS $LZ)) |xrest#0_0@0| (|#_module.List.Cons| |x#0_0@0| |ys#0@@4|)))) (=> (and (|_module.List#Equal| (_module.__default.revacc _module._default.Lemma_Revacc$_T0 ($LS $LZ) |xs#0@@2| |ys#0@@4|) (_module.__default.revacc _module._default.Lemma_Revacc$_T0 ($LS $LZ) |xrest#0_0@0| (|#_module.List.Cons| |x#0_0@0| |ys#0@@4|))) ($IsAlloc DatatypeTypeType |xs#0@@2| (Tclass._module.List _module._default.Lemma_Revacc$_T0) $Heap@0)) (=> (and (and (and (and (|_module.__default.reverse#canCall| _module._default.Lemma_Revacc$_T0 |xs#0@@2|) (= |##l#0_2@0| (_module.__default.reverse _module._default.Lemma_Revacc$_T0 ($LS $LZ) |xs#0@@2|))) (and ($IsAlloc DatatypeTypeType |##l#0_2@0| (Tclass._module.List _module._default.Lemma_Revacc$_T0) $Heap@0) ($IsAlloc DatatypeTypeType |ys#0@@4| (Tclass._module.List _module._default.Lemma_Revacc$_T0) $Heap@0))) (and (and (|_module.__default.concat#canCall| _module._default.Lemma_Revacc$_T0 (_module.__default.reverse _module._default.Lemma_Revacc$_T0 ($LS $LZ) |xs#0@@2|) |ys#0@@4|) ($IsAlloc DatatypeTypeType |xrest#0_0@0| (Tclass._module.List _module._default.Lemma_Revacc$_T0) $Heap@0)) (and (|_module.__default.reverse#canCall| _module._default.Lemma_Revacc$_T0 |xrest#0_0@0|) (= |##l#0_5@0| (_module.__default.reverse _module._default.Lemma_Revacc$_T0 ($LS $LZ) |xrest#0_0@0|))))) (and (and (and ($IsAlloc DatatypeTypeType |##l#0_5@0| (Tclass._module.List _module._default.Lemma_Revacc$_T0) $Heap@0) (= |##ys#0_1@0| (|#_module.List.Cons| |x#0_0@0| (Lit DatatypeTypeType |#_module.List.Nil|)))) (and ($IsAlloc DatatypeTypeType |##ys#0_1@0| (Tclass._module.List _module._default.Lemma_Revacc$_T0) $Heap@0) (|_module.__default.concat#canCall| _module._default.Lemma_Revacc$_T0 (_module.__default.reverse _module._default.Lemma_Revacc$_T0 ($LS $LZ) |xrest#0_0@0|) (|#_module.List.Cons| |x#0_0@0| (Lit DatatypeTypeType |#_module.List.Nil|))))) (and (and (= |##l#0_4@0| (_module.__default.concat _module._default.Lemma_Revacc$_T0 ($LS $LZ) (_module.__default.reverse _module._default.Lemma_Revacc$_T0 ($LS $LZ) |xrest#0_0@0|) (|#_module.List.Cons| |x#0_0@0| (Lit DatatypeTypeType |#_module.List.Nil|)))) ($IsAlloc DatatypeTypeType |##l#0_4@0| (Tclass._module.List _module._default.Lemma_Revacc$_T0) $Heap@0)) (and ($IsAlloc DatatypeTypeType |ys#0@@4| (Tclass._module.List _module._default.Lemma_Revacc$_T0) $Heap@0) (|_module.__default.concat#canCall| _module._default.Lemma_Revacc$_T0 (_module.__default.concat _module._default.Lemma_Revacc$_T0 ($LS $LZ) (_module.__default.reverse _module._default.Lemma_Revacc$_T0 ($LS $LZ) |xrest#0_0@0|) (|#_module.List.Cons| |x#0_0@0| (Lit DatatypeTypeType |#_module.List.Nil|))) |ys#0@@4|))))) (and (=> (= (ControlFlow 0 16) 14) anon10_Then_correct) (=> (= (ControlFlow 0 16) 15) anon10_Else_correct)))))))))))
(let ((anon8_Then_correct  (=> (and (= |xs#0@@2| |#_module.List.Nil|) (= (ControlFlow 0 4) 3)) GeneratedUnifiedExit_correct)))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and ($Is DatatypeTypeType |xs#0@@2| (Tclass._module.List _module._default.Lemma_Revacc$_T0)) ($IsAlloc DatatypeTypeType |xs#0@@2| (Tclass._module.List _module._default.Lemma_Revacc$_T0) $Heap@@2)) (|$IsA#_module.List| |xs#0@@2|)) (=> (and (and (and ($Is DatatypeTypeType |ys#0@@4| (Tclass._module.List _module._default.Lemma_Revacc$_T0)) ($IsAlloc DatatypeTypeType |ys#0@@4| (Tclass._module.List _module._default.Lemma_Revacc$_T0) $Heap@@2)) (|$IsA#_module.List| |ys#0@@4|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 20) 19))) anon0_correct)))))
