...
(assert (distinct TBool TInt TagBool TagInt TagSet alloc allocName Tagclass._System.object? Tagclass._System.object Tagclass.M2.VarDecl? Tagclass.M2.VarDecl class.M2.Expr? Tagclass.M2.Expr? Tagclass.M2.Expr Tagclass.M2.Kind |##M2.Kind.Constant| |##M2.Kind.Ident| |##M2.Kind.Binary| tytagFamily$object tytagFamily$VarDecl tytagFamily$Expr tytagFamily$Kind field$decl field$Repr field$resolved field$kind field$left field$right field$value)
)
(assert (= (FDim alloc) 0))
...
(assert (= (FDim M2.Expr.value) 0))
(assert (= (FieldOfDecl class.M2.Expr? field$value) M2.Expr.value))
(assert  (not ($IsGhostField M2.Expr.value)))
...
(assert (forall (($h@@6 T@U) ($o@@8 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@6) (and (or (not (= $o@@8 null)) (not true)) (= (dtype $o@@8) Tclass.M2.Expr?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@8) alloc)))) ($IsAlloc intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@8) M2.Expr.value)) TInt $h@@6))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1690|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@8) M2.Expr.value)))
)))
...
(assert (forall (($h@@7 T@U) ($o@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (or (not (= $o@@9 null)) (not true)) (= (dtype $o@@9) Tclass.M2.Expr?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@9) M2.Expr.decl)) Tclass.M2.VarDecl?))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1629|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@9) M2.Expr.decl)))
)))
(assert (forall (($h@@8 T@U) ($o@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (or (not (= $o@@10 null)) (not true)) (= (dtype $o@@10) Tclass.M2.Expr?))) ($Is DatatypeTypeType ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@10) M2.Expr.kind)) Tclass.M2.Kind))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1687|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@10) M2.Expr.kind)))
)))
(assert (forall (($h@@9 T@U) ($o@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) (and (or (not (= $o@@11 null)) (not true)) (= (dtype $o@@11) Tclass.M2.Expr?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@11) M2.Expr.left)) Tclass.M2.Expr?))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1691|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@11) M2.Expr.left)))
)))
(assert (forall (($h@@10 T@U) ($o@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) (and (or (not (= $o@@12 null)) (not true)) (= (dtype $o@@12) Tclass.M2.Expr?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@12) M2.Expr.right)) Tclass.M2.Expr?))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1693|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@12) M2.Expr.right)))
)))
...
(assert (forall (($h@@11 T@U) ($o@@13 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@11) (and (or (not (= $o@@13 null)) (not true)) (= (dtype $o@@13) Tclass.M2.Expr?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@13) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@13) M2.Expr.decl)) Tclass.M2.VarDecl? $h@@11))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1630|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@13) M2.Expr.decl)))
)))
(assert (forall (($h@@12 T@U) ($o@@14 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@12) (and (or (not (= $o@@14 null)) (not true)) (= (dtype $o@@14) Tclass.M2.Expr?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@14) alloc)))) ($IsAlloc DatatypeTypeType ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@14) M2.Expr.kind)) Tclass.M2.Kind $h@@12))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1688|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@14) M2.Expr.kind)))
)))
(assert (forall (($h@@13 T@U) ($o@@15 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@13) (and (or (not (= $o@@15 null)) (not true)) (= (dtype $o@@15) Tclass.M2.Expr?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@15) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@15) M2.Expr.left)) Tclass.M2.Expr? $h@@13))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1692|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@15) M2.Expr.left)))
)))
(assert (forall (($h@@14 T@U) ($o@@16 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@14) (and (or (not (= $o@@16 null)) (not true)) (= (dtype $o@@16) Tclass.M2.Expr?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@16) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@16) M2.Expr.right)) Tclass.M2.Expr? $h@@14))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1694|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@16) M2.Expr.right)))
)))
...
(assert (forall (($h@@15 T@U) ($o@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (or (not (= $o@@17 null)) (not true)) (= (dtype $o@@17) Tclass.M2.Expr?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@17) M2.Expr.Repr)) (TSet Tclass._System.object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1695|
...
(assert (forall (($h@@16 T@U) ($o@@18 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@16) (and (or (not (= $o@@18 null)) (not true)) (= (dtype $o@@18) Tclass.M2.Expr?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@18) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@18) M2.Expr.Repr)) (TSet Tclass._System.object) $h@@16))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1696|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@18) M2.Expr.Repr)))
)))
...
(assert (forall ((a@@13 T@U) (b@@10 T@U) ) (!  (=> (and (M2.Kind.Constant_q a@@13) (M2.Kind.Constant_q b@@10)) (|M2.Kind#Equal| a@@13 b@@10))
 :qid |unknown.0:0|
 :skolemid |1726|
 :pattern ( (|M2.Kind#Equal| a@@13 b@@10) (M2.Kind.Constant_q a@@13))
 :pattern ( (|M2.Kind#Equal| a@@13 b@@10) (M2.Kind.Constant_q b@@10))
)))
(assert (forall ((a@@14 T@U) (b@@11 T@U) ) (!  (=> (and (M2.Kind.Ident_q a@@14) (M2.Kind.Ident_q b@@11)) (|M2.Kind#Equal| a@@14 b@@11))
 :qid |unknown.0:0|
 :skolemid |1727|
 :pattern ( (|M2.Kind#Equal| a@@14 b@@11) (M2.Kind.Ident_q a@@14))
 :pattern ( (|M2.Kind#Equal| a@@14 b@@11) (M2.Kind.Ident_q b@@11))
)))
(assert (forall ((a@@15 T@U) (b@@12 T@U) ) (!  (=> (and (M2.Kind.Binary_q a@@15) (M2.Kind.Binary_q b@@12)) (|M2.Kind#Equal| a@@15 b@@12))
 :qid |unknown.0:0|
 :skolemid |1728|
 :pattern ( (|M2.Kind#Equal| a@@15 b@@12) (M2.Kind.Binary_q a@@15))
 :pattern ( (|M2.Kind#Equal| a@@15 b@@12) (M2.Kind.Binary_q b@@12))
)))
...
(assert (forall (($h@@17 T@U) ($o@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (or (not (= $o@@20 null)) (not true)) (= (dtype $o@@20) Tclass.M2.Expr?))) ($Is boolType ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@20) M2.Expr.resolved)) TBool))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1648|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@20) M2.Expr.resolved)))
)))
(assert (forall (($h@@18 T@U) ($o@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (or (not (= $o@@21 null)) (not true)) (= (dtype $o@@21) Tclass.M2.Expr?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@21) M2.Expr.value)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1689|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@21) M2.Expr.value)))
)))
(assert (forall (($h0@@2 T@U) ($h1@@2 T@U) (this@@9 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@2) ($IsGoodHeap $h1@@2)) (and (or (not (= this@@9 null)) (not true)) ($Is refType this@@9 Tclass.M2.Expr))) (and ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2))) (=> (forall (($o@@22 T@U) ($f@@2 T@U) ) (!  (=> (and (or (not (= $o@@22 null)) (not true)) (or (= $o@@22 this@@9) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 this@@9) M2.Expr.Repr)) ($Box refType $o@@22)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 $o@@22) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@2 $o@@22) $f@@2)))
 :qid |unknown.0:0|
 :skolemid |1631|
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@23 T@U) ($f@@3 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#2| |l#0| |l#1| |l#2| |l#3|) $o@@23 $f@@3))  (=> (and (or (not (= $o@@23 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@23) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |2335|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#2| |l#0| |l#1| |l#2| |l#3|) $o@@23 $f@@3))
)))
...
(assert (forall ((d@@7 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) ($Is DatatypeTypeType d@@7 Tclass.M2.Kind)) ($IsAlloc DatatypeTypeType d@@7 Tclass.M2.Kind $h@@19))
 :qid |unknown.0:0|
 :skolemid |1723|
 :pattern ( ($IsAlloc DatatypeTypeType d@@7 Tclass.M2.Kind $h@@19))
)))
...
(set-info :boogie-vc-id Impl$$M2.Expr.CreateBinary)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#2| null $Heap@@8 alloc false)) (= this.resolved@0 (U_2_bool (Lit boolType (bool_2_U false))))) (=> (and (and (= |$rhs#0@0| (Lit DatatypeTypeType |#M2.Kind.Binary|)) (or (not (= |left#0| null)) (not true))) (and (or (not (= |right#0| null)) (not true)) (= this.Repr@0 (|Set#Union| (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box refType this@@12)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |left#0|) M2.Expr.Repr))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |right#0|) M2.Expr.Repr)))))) (=> (and (and (and (and (and (or (not (= this@@12 null)) (not true)) ($Is refType this@@12 Tclass.M2.Expr?)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) alloc))))) (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M2.Expr.decl)) this.decl) (= (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M2.Expr.resolved))) this.resolved@0)) (and (= ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M2.Expr.kind)) |$rhs#0@0|) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M2.Expr.value))) |op#0|)))) (and (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M2.Expr.left)) |left#0|) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M2.Expr.right)) |right#0|)) (and (= ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M2.Expr.Repr)) this.Repr@0) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) alloc ($Box boolType (bool_2_U true))))))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and ($IsAllocBox ($Box refType this@@12) Tclass.M2.Expr? $Heap@0) (=> (|M2.Expr.Core#canCall| $Heap@0 this@@12) (or (M2.Expr.Core ($LS $LZ) $Heap@0 this@@12) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.Repr)) ($Box refType this@@12)))))))) (and (and (and (and (=> (|M2.Expr.Core#canCall| $Heap@0 this@@12) (or (M2.Expr.Core ($LS $LZ) $Heap@0 this@@12) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.left)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.left))))) (=> (|M2.Expr.Core#canCall| $Heap@0 this@@12) (or (M2.Expr.Core ($LS $LZ) $Heap@0 this@@12) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.left)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.left))) M2.Expr.Repr)) ($Box refType this@@12))))))) (and (=> (|M2.Expr.Core#canCall| $Heap@0 this@@12) (or (M2.Expr.Core ($LS $LZ) $Heap@0 this@@12) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.left)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.left))) M2.Expr.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.right)))))) (=> (|M2.Expr.Core#canCall| $Heap@0 this@@12) (or (M2.Expr.Core ($LS $LZ) $Heap@0 this@@12) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.left)) null)) (not true)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.left))) M2.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.Repr)))))))) (and (and (=> (|M2.Expr.Core#canCall| $Heap@0 this@@12) (or (M2.Expr.Core ($LS $LZ) $Heap@0 this@@12) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.left)) null)) (not true)) (M2.Expr.Valid ($LS ($LS $LZ)) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.left)))))) (=> (|M2.Expr.Core#canCall| $Heap@0 this@@12) (or (M2.Expr.Core ($LS $LZ) $Heap@0 this@@12) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.right)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.right)))))) (and (=> (|M2.Expr.Core#canCall| $Heap@0 this@@12) (or (M2.Expr.Core ($LS $LZ) $Heap@0 this@@12) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.right)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.right))) M2.Expr.Repr)) ($Box refType this@@12)))))) (=> (|M2.Expr.Core#canCall| $Heap@0 this@@12) (or (M2.Expr.Core ($LS $LZ) $Heap@0 this@@12) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.right)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.right))) M2.Expr.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.left))))))))) (and (and (and (=> (|M2.Expr.Core#canCall| $Heap@0 this@@12) (or (M2.Expr.Core ($LS $LZ) $Heap@0 this@@12) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.right)) null)) (not true)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.right))) M2.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.Repr)))))) (=> (|M2.Expr.Core#canCall| $Heap@0 this@@12) (or (M2.Expr.Core ($LS $LZ) $Heap@0 this@@12) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.right)) null)) (not true)) (M2.Expr.Valid ($LS ($LS $LZ)) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.right))))))) (and (=> (|M2.Expr.Core#canCall| $Heap@0 this@@12) (or (M2.Expr.Core ($LS $LZ) $Heap@0 this@@12) (=> (|M2.Kind#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.kind)) |#M2.Kind.Binary|) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.left)) null)) (not true))))) (=> (|M2.Expr.Core#canCall| $Heap@0 this@@12) (or (M2.Expr.Core ($LS $LZ) $Heap@0 this@@12) (=> (|M2.Kind#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.kind)) |#M2.Kind.Binary|) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.right)) null)) (not true))))))) (and (and (=> (|M2.Expr.Core#canCall| $Heap@0 this@@12) (or (M2.Expr.Core ($LS $LZ) $Heap@0 this@@12) (=> (|M2.Kind#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.kind)) |#M2.Kind.Binary|) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.left))) M2.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.right))) M2.Expr.Repr)))))) (|M2.Expr.Valid_k#canCall| $Heap@0 this@@12)) (and (|M2.Expr.Valid_k#canCall| $Heap@0 this@@12) (M2.Expr.Valid_k ($LS $LZ) $Heap@0 this@@12)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> false (=> (|M2.Expr.Valid#canCall| $Heap@0 this@@12) (or (M2.Expr.Valid ($LS $LZ) $Heap@0 this@@12) (M2.Expr.Core ($LS ($LS $LZ)) $Heap@0 this@@12))))) (=> (=> false (=> (|M2.Expr.Valid#canCall| $Heap@0 this@@12) (or (M2.Expr.Valid ($LS $LZ) $Heap@0 this@@12) (M2.Expr.Core ($LS ($LS $LZ)) $Heap@0 this@@12)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> false (=> (|M2.Expr.Valid#canCall| $Heap@0 this@@12) (or (M2.Expr.Valid ($LS $LZ) $Heap@0 this@@12) (M2.Expr.Valid_k ($LS ($LS $LZ)) $Heap@0 this@@12))))) (=> (=> false (=> (|M2.Expr.Valid#canCall| $Heap@0 this@@12) (or (M2.Expr.Valid ($LS $LZ) $Heap@0 this@@12) (M2.Expr.Valid_k ($LS ($LS $LZ)) $Heap@0 this@@12)))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (and (forall (($o@@24 T@U) ) (!  (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.Repr)) ($Box refType $o@@24)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |left#0|) M2.Expr.Repr)) ($Box refType $o@@24)))) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |right#0|) M2.Expr.Repr)) ($Box refType $o@@24)))) (or (not (= $o@@24 null)) (not true)))
 :qid |MonotonicHeapstatedfy.62:26|
 :skolemid |1683|
 :pattern (  (or (not (= $o@@24 null)) (not true)))
)) (forall (($o@@25 T@U) ) (!  (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M2.Expr.Repr)) ($Box refType $o@@25)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |left#0|) M2.Expr.Repr)) ($Box refType $o@@25)))) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |right#0|) M2.Expr.Repr)) ($Box refType $o@@25)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@25) alloc)))))
 :qid |MonotonicHeapstatedfy.62:26|
 :skolemid |1684|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@8) ($IsHeapAnchor $Heap@@8)) (and ($Is refType |left#0| Tclass.M2.Expr) ($IsAlloc refType |left#0| Tclass.M2.Expr $Heap@@8))) (=> (and (and (and (and ($Is refType |right#0| Tclass.M2.Expr) ($IsAlloc refType |right#0| Tclass.M2.Expr $Heap@@8)) (= 3 $FunctionContextHeight)) (and (|M2.Expr.Valid#canCall| $Heap@@8 |left#0|) (and (M2.Expr.Valid ($LS $LZ) $Heap@@8 |left#0|) (and (M2.Expr.Core ($LS $LZ) $Heap@@8 |left#0|) (M2.Expr.Valid_k ($LS $LZ) $Heap@@8 |left#0|))))) (and (and (|M2.Expr.Valid#canCall| $Heap@@8 |right#0|) (and (M2.Expr.Valid ($LS $LZ) $Heap@@8 |right#0|) (and (M2.Expr.Core ($LS $LZ) $Heap@@8 |right#0|) (M2.Expr.Valid_k ($LS $LZ) $Heap@@8 |right#0|)))) (and (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |left#0|) M2.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |right#0|) M2.Expr.Repr))) (= (ControlFlow 0 5) 2)))) anon0_correct))))
