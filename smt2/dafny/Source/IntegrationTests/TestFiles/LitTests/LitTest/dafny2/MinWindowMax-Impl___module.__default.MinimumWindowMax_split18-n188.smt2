...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split189)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon114_Then_correct  (=> (and (and (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| |l#0@3|)) (<= |l#0@3| |n#0@3|)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |a#0@@4| null)) (not true)))))
(let ((anon113_Else_correct  (=> (and (not (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| |l#0@3|))) (= (ControlFlow 0 4) 2)) anon114_Then_correct)))
(let ((anon113_Then_correct  (=> (and (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| |l#0@3|)) (= (ControlFlow 0 3) 2)) anon114_Then_correct)))
(let ((anon112_Else_correct  (=> (< |k#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 6) 3) anon113_Then_correct) (=> (= (ControlFlow 0 6) 4) anon113_Else_correct)))))
(let ((anon112_Then_correct  (=> (<= (LitInt 0) |k#0@0|) (and (=> (= (ControlFlow 0 5) 3) anon113_Then_correct) (=> (= (ControlFlow 0 5) 4) anon113_Else_correct)))))
...
))) (and (<= (- (_System.array.Length |a#0@@4|) |n#0@3|) |$decr_init$loop#10@0|) (not |$w$loop#1@0|)))))) (and (=> (= (ControlFlow 0 7) 5) anon112_Then_correct) (=> (= (ControlFlow 0 7) 6) anon112_Else_correct)))))))))
anon0_correct)))))))
))
(check-sat)
(get-info :rlimit)
