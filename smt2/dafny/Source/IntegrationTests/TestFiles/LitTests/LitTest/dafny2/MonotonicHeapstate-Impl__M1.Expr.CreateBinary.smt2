...
(assert (distinct TBool TInt TagBool TagInt TagSet alloc allocName Tagclass._System.object? Tagclass._System.object class.M1.Expr? Tagclass.M1.Expr? Tagclass.M1.Expr Tagclass.M1.Kind |##M1.Kind.Constant| |##M1.Kind.Ident| |##M1.Kind.Binary| tytagFamily$object tytagFamily$Expr tytagFamily$Kind field$resolved field$Repr field$kind field$left field$right field$value)
)
(assert (= (FDim alloc) 0))
...
(assert (= (FDim M1.Expr.value) 0))
(assert (= (FieldOfDecl class.M1.Expr? field$value) M1.Expr.value))
(assert  (not ($IsGhostField M1.Expr.value)))
...
(assert (forall ((a@@7 T@U) (b@@4 T@U) ) (! (= (|M1.Kind#Equal| a@@7 b@@4) (= a@@7 b@@4))
 :qid |unknown.0:0|
 :skolemid |1140|
 :pattern ( (|M1.Kind#Equal| a@@7 b@@4))
)))
...
(assert (forall (($h@@4 T@U) ($o@@6 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@4) (and (or (not (= $o@@6 null)) (not true)) (= (dtype $o@@6) Tclass.M1.Expr?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@6) alloc)))) ($IsAlloc intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@6) M1.Expr.value)) TInt $h@@4))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1101|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@6) M1.Expr.value)))
)))
...
(assert (forall (($h@@5 T@U) ($o@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (or (not (= $o@@7 null)) (not true)) (= (dtype $o@@7) Tclass.M1.Expr?))) ($Is DatatypeTypeType ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@7) M1.Expr.kind)) Tclass.M1.Kind))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1098|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@7) M1.Expr.kind)))
)))
(assert (forall (($h@@6 T@U) ($o@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (or (not (= $o@@8 null)) (not true)) (= (dtype $o@@8) Tclass.M1.Expr?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@8) M1.Expr.left)) Tclass.M1.Expr?))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1102|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@8) M1.Expr.left)))
)))
(assert (forall (($h@@7 T@U) ($o@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (or (not (= $o@@9 null)) (not true)) (= (dtype $o@@9) Tclass.M1.Expr?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@9) M1.Expr.right)) Tclass.M1.Expr?))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1104|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@9) M1.Expr.right)))
)))
...
(assert (forall (($h@@8 T@U) ($o@@10 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@8) (and (or (not (= $o@@10 null)) (not true)) (= (dtype $o@@10) Tclass.M1.Expr?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@10) alloc)))) ($IsAlloc DatatypeTypeType ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@10) M1.Expr.kind)) Tclass.M1.Kind $h@@8))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1099|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@10) M1.Expr.kind)))
)))
(assert (forall (($h@@9 T@U) ($o@@11 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@9) (and (or (not (= $o@@11 null)) (not true)) (= (dtype $o@@11) Tclass.M1.Expr?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@11) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@11) M1.Expr.left)) Tclass.M1.Expr? $h@@9))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1103|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@11) M1.Expr.left)))
)))
(assert (forall (($h@@10 T@U) ($o@@12 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@10) (and (or (not (= $o@@12 null)) (not true)) (= (dtype $o@@12) Tclass.M1.Expr?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@12) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@12) M1.Expr.right)) Tclass.M1.Expr? $h@@10))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1105|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@12) M1.Expr.right)))
)))
...
(assert (forall (($h@@11 T@U) ($o@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (or (not (= $o@@13 null)) (not true)) (= (dtype $o@@13) Tclass.M1.Expr?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@13) M1.Expr.Repr)) (TSet Tclass._System.object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1106|
...
(assert (forall (($h@@12 T@U) ($o@@14 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@12) (and (or (not (= $o@@14 null)) (not true)) (= (dtype $o@@14) Tclass.M1.Expr?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@14) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@14) M1.Expr.Repr)) (TSet Tclass._System.object) $h@@12))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1107|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@14) M1.Expr.Repr)))
)))
...
(assert (forall ((a@@13 T@U) (b@@10 T@U) ) (!  (=> (and (M1.Kind.Constant_q a@@13) (M1.Kind.Constant_q b@@10)) (|M1.Kind#Equal| a@@13 b@@10))
 :qid |unknown.0:0|
 :skolemid |1137|
 :pattern ( (|M1.Kind#Equal| a@@13 b@@10) (M1.Kind.Constant_q a@@13))
 :pattern ( (|M1.Kind#Equal| a@@13 b@@10) (M1.Kind.Constant_q b@@10))
)))
(assert (forall ((a@@14 T@U) (b@@11 T@U) ) (!  (=> (and (M1.Kind.Ident_q a@@14) (M1.Kind.Ident_q b@@11)) (|M1.Kind#Equal| a@@14 b@@11))
 :qid |unknown.0:0|
 :skolemid |1138|
 :pattern ( (|M1.Kind#Equal| a@@14 b@@11) (M1.Kind.Ident_q a@@14))
 :pattern ( (|M1.Kind#Equal| a@@14 b@@11) (M1.Kind.Ident_q b@@11))
)))
(assert (forall ((a@@15 T@U) (b@@12 T@U) ) (!  (=> (and (M1.Kind.Binary_q a@@15) (M1.Kind.Binary_q b@@12)) (|M1.Kind#Equal| a@@15 b@@12))
 :qid |unknown.0:0|
 :skolemid |1139|
 :pattern ( (|M1.Kind#Equal| a@@15 b@@12) (M1.Kind.Binary_q a@@15))
 :pattern ( (|M1.Kind#Equal| a@@15 b@@12) (M1.Kind.Binary_q b@@12))
)))
...
(assert (forall (($h@@13 T@U) ($o@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (or (not (= $o@@16 null)) (not true)) (= (dtype $o@@16) Tclass.M1.Expr?))) ($Is boolType ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@16) M1.Expr.resolved)) TBool))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1043|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@16) M1.Expr.resolved)))
)))
(assert (forall (($h@@14 T@U) ($o@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (or (not (= $o@@17 null)) (not true)) (= (dtype $o@@17) Tclass.M1.Expr?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@17) M1.Expr.value)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1100|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@17) M1.Expr.value)))
)))
(assert (forall (($h0@@2 T@U) ($h1@@2 T@U) (this@@8 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@2) ($IsGoodHeap $h1@@2)) (and (or (not (= this@@8 null)) (not true)) ($Is refType this@@8 Tclass.M1.Expr))) (and ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2))) (=> (forall (($o@@18 T@U) ($f@@2 T@U) ) (!  (=> (and (or (not (= $o@@18 null)) (not true)) (or (= $o@@18 this@@8) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 this@@8) M1.Expr.Repr)) ($Box refType $o@@18)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 $o@@18) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@2 $o@@18) $f@@2)))
 :qid |unknown.0:0|
 :skolemid |1055|
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@19 T@U) ($f@@3 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#2| |l#0| |l#1| |l#2| |l#3|) $o@@19 $f@@3))  (=> (and (or (not (= $o@@19 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@19) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |2329|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#2| |l#0| |l#1| |l#2| |l#3|) $o@@19 $f@@3))
)))
...
(assert (forall ((d@@7 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) ($Is DatatypeTypeType d@@7 Tclass.M1.Kind)) ($IsAlloc DatatypeTypeType d@@7 Tclass.M1.Kind $h@@15))
 :qid |unknown.0:0|
 :skolemid |1134|
 :pattern ( ($IsAlloc DatatypeTypeType d@@7 Tclass.M1.Kind $h@@15))
)))
...
(declare-fun |op#0| () Int)
(declare-fun $Heap@0 () T@U)
(set-info :boogie-vc-id Impl$$M1.Expr.CreateBinary)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#2| null $Heap@@7 alloc false)) (= this.resolved@0 (U_2_bool (Lit boolType (bool_2_U false))))) (=> (and (and (= |$rhs#0@0| (Lit DatatypeTypeType |#M1.Kind.Binary|)) (or (not (= |left#0| null)) (not true))) (and (or (not (= |right#0| null)) (not true)) (= this.Repr@0 (|Set#Union| (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box refType this@@11)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |left#0|) M1.Expr.Repr))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |right#0|) M1.Expr.Repr)))))) (=> (and (and (and (and (and (or (not (= this@@11 null)) (not true)) ($Is refType this@@11 Tclass.M1.Expr?)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) alloc))))) (and (= (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.resolved))) this.resolved@0) (= ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.kind)) |$rhs#0@0|))) (and (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.value))) |op#0|) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.left)) |left#0|)) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.right)) |right#0|) (= ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) M1.Expr.Repr)) this.Repr@0))) (and (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@11) alloc ($Box boolType (bool_2_U true))))) ($IsGoodHeap $Heap@0)) (and ($IsHeapAnchor $Heap@0) ($IsAllocBox ($Box refType this@@11) Tclass.M1.Expr? $Heap@0))))) (and (and (and (and (=> (|M1.Expr.Core#canCall| $Heap@0 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@0 this@@11) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.Repr)) ($Box refType this@@11)))) (=> (|M1.Expr.Core#canCall| $Heap@0 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@0 this@@11) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.left)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.left)))))) (and (=> (|M1.Expr.Core#canCall| $Heap@0 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@0 this@@11) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.left)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.left))) M1.Expr.Repr)) ($Box refType this@@11)))))) (=> (|M1.Expr.Core#canCall| $Heap@0 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@0 this@@11) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.left)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.left))) M1.Expr.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.right)))))))) (and (and (=> (|M1.Expr.Core#canCall| $Heap@0 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@0 this@@11) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.left)) null)) (not true)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.left))) M1.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.Repr)))))) (=> (|M1.Expr.Core#canCall| $Heap@0 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@0 this@@11) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.left)) null)) (not true)) (M1.Expr.Valid ($LS ($LS $LZ)) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.left))))))) (and (=> (|M1.Expr.Core#canCall| $Heap@0 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@0 this@@11) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.right)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.right))))) (=> (|M1.Expr.Core#canCall| $Heap@0 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@0 this@@11) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.right)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.right))) M1.Expr.Repr)) ($Box refType this@@11))))))))) (and (and (and (=> (|M1.Expr.Core#canCall| $Heap@0 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@0 this@@11) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.right)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.right))) M1.Expr.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.left)))))) (=> (|M1.Expr.Core#canCall| $Heap@0 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@0 this@@11) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.right)) null)) (not true)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.right))) M1.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.Repr))))))) (and (=> (|M1.Expr.Core#canCall| $Heap@0 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@0 this@@11) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.right)) null)) (not true)) (M1.Expr.Valid ($LS ($LS $LZ)) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.right)))))) (=> (|M1.Expr.Core#canCall| $Heap@0 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@0 this@@11) (=> (|M1.Kind#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.kind)) |#M1.Kind.Binary|) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.left)) null)) (not true))))))) (and (and (=> (|M1.Expr.Core#canCall| $Heap@0 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@0 this@@11) (=> (|M1.Kind#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.kind)) |#M1.Kind.Binary|) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.right)) null)) (not true))))) (=> (|M1.Expr.Core#canCall| $Heap@0 this@@11) (or (M1.Expr.Core ($LS $LZ) $Heap@0 this@@11) (=> (|M1.Kind#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.kind)) |#M1.Kind.Binary|) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.left))) M1.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.right))) M1.Expr.Repr))))))) (and (|M1.Expr.Valid_k#canCall| $Heap@0 this@@11) (|M1.Expr.Valid_k#canCall| $Heap@0 this@@11)))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (M1.Expr.Valid_k ($LS ($LS $LZ)) $Heap@0 this@@11)) (=> (M1.Expr.Valid_k ($LS $LZ) $Heap@0 this@@11) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> false (=> (|M1.Expr.Valid#canCall| $Heap@0 this@@11) (or (M1.Expr.Valid ($LS $LZ) $Heap@0 this@@11) (M1.Expr.Core ($LS ($LS $LZ)) $Heap@0 this@@11))))) (=> (=> false (=> (|M1.Expr.Valid#canCall| $Heap@0 this@@11) (or (M1.Expr.Valid ($LS $LZ) $Heap@0 this@@11) (M1.Expr.Core ($LS ($LS $LZ)) $Heap@0 this@@11)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> false (=> (|M1.Expr.Valid#canCall| $Heap@0 this@@11) (or (M1.Expr.Valid ($LS $LZ) $Heap@0 this@@11) (M1.Expr.Valid_k ($LS ($LS $LZ)) $Heap@0 this@@11))))) (=> (=> false (=> (|M1.Expr.Valid#canCall| $Heap@0 this@@11) (or (M1.Expr.Valid ($LS $LZ) $Heap@0 this@@11) (M1.Expr.Valid_k ($LS ($LS $LZ)) $Heap@0 this@@11)))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (and (forall (($o@@20 T@U) ) (!  (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.Repr)) ($Box refType $o@@20)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |left#0|) M1.Expr.Repr)) ($Box refType $o@@20)))) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |right#0|) M1.Expr.Repr)) ($Box refType $o@@20)))) (or (not (= $o@@20 null)) (not true)))
 :qid |MonotonicHeapstatedfy.62:26|
 :skolemid |1083|
 :pattern (  (or (not (= $o@@20 null)) (not true)))
)) (forall (($o@@21 T@U) ) (!  (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@11) M1.Expr.Repr)) ($Box refType $o@@21)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |left#0|) M1.Expr.Repr)) ($Box refType $o@@21)))) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |right#0|) M1.Expr.Repr)) ($Box refType $o@@21)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@21) alloc)))))
 :qid |MonotonicHeapstatedfy.62:26|
 :skolemid |1084|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@7) ($IsHeapAnchor $Heap@@7)) (and ($Is refType |left#0| Tclass.M1.Expr) ($IsAlloc refType |left#0| Tclass.M1.Expr $Heap@@7))) (=> (and (and (and (and ($Is refType |right#0| Tclass.M1.Expr) ($IsAlloc refType |right#0| Tclass.M1.Expr $Heap@@7)) (= 2 $FunctionContextHeight)) (and (|M1.Expr.Valid#canCall| $Heap@@7 |left#0|) (and (M1.Expr.Valid ($LS $LZ) $Heap@@7 |left#0|) (and (M1.Expr.Core ($LS $LZ) $Heap@@7 |left#0|) (M1.Expr.Valid_k ($LS $LZ) $Heap@@7 |left#0|))))) (and (and (|M1.Expr.Valid#canCall| $Heap@@7 |right#0|) (and (M1.Expr.Valid ($LS $LZ) $Heap@@7 |right#0|) (and (M1.Expr.Core ($LS $LZ) $Heap@@7 |right#0|) (M1.Expr.Valid_k ($LS $LZ) $Heap@@7 |right#0|)))) (and (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |left#0|) M1.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |right#0|) M1.Expr.Repr))) (= (ControlFlow 0 6) 2)))) anon0_correct))))
