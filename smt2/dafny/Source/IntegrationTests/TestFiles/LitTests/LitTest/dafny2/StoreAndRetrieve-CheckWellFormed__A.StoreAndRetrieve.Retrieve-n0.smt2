...
(assert (forall ((A.StoreAndRetrieve$Thing@@9 T@U) ($h@@6 T@U) ($o@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (or (not (= $o@@5 null)) (not true)) (= (dtype $o@@5) (Tclass.A.StoreAndRetrieve? A.StoreAndRetrieve$Thing@@9)))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@5) A.StoreAndRetrieve.Repr)) (TSet Tclass._System.object?)))
 :qid |unknown.0:0|
 :skolemid |1050|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@5) A.StoreAndRetrieve.Repr)) (Tclass.A.StoreAndRetrieve? A.StoreAndRetrieve$Thing@@9))
)))
...
(assert (forall ((A.StoreAndRetrieve$Thing@@10 T@U) ($h@@7 T@U) ($o@@6 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@7) (and (or (not (= $o@@6 null)) (not true)) (= (dtype $o@@6) (Tclass.A.StoreAndRetrieve? A.StoreAndRetrieve$Thing@@10)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@6) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@6) A.StoreAndRetrieve.Repr)) (TSet Tclass._System.object?) $h@@7))
 :qid |unknown.0:0|
 :skolemid |1051|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@6) A.StoreAndRetrieve.Repr)) (Tclass.A.StoreAndRetrieve? A.StoreAndRetrieve$Thing@@10))
)))
...
(assert (forall ((A.StoreAndRetrieve$Thing@@13 T@U) ($h@@8 T@U) ($o@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (or (not (= $o@@8 null)) (not true)) (= (dtype $o@@8) (Tclass.A.StoreAndRetrieve? A.StoreAndRetrieve$Thing@@13)))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@8) A.StoreAndRetrieve.Contents)) (TSet A.StoreAndRetrieve$Thing@@13)))
 :qid |unknown.0:0|
 :skolemid |1038|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@8) A.StoreAndRetrieve.Contents)) (Tclass.A.StoreAndRetrieve? A.StoreAndRetrieve$Thing@@13))
)))
...
(assert (forall ((A.StoreAndRetrieve$Thing@@14 T@U) (bx@@11 T@U) ) (!  (=> ($IsBox bx@@11 (Tclass.A.StoreAndRetrieve? A.StoreAndRetrieve$Thing@@14)) (and (= ($Box refType ($Unbox refType bx@@11)) bx@@11) ($Is refType ($Unbox refType bx@@11) (Tclass.A.StoreAndRetrieve? A.StoreAndRetrieve$Thing@@14))))
 :qid |unknown.0:0|
 :skolemid |1003|
 :pattern ( ($IsBox bx@@11 (Tclass.A.StoreAndRetrieve? A.StoreAndRetrieve$Thing@@14)))
)))
(assert (forall ((A.StoreAndRetrieve$Thing@@15 T@U) (bx@@12 T@U) ) (!  (=> ($IsBox bx@@12 (Tclass.A.StoreAndRetrieve A.StoreAndRetrieve$Thing@@15)) (and (= ($Box refType ($Unbox refType bx@@12)) bx@@12) ($Is refType ($Unbox refType bx@@12) (Tclass.A.StoreAndRetrieve A.StoreAndRetrieve$Thing@@15))))
 :qid |unknown.0:0|
 :skolemid |1009|
 :pattern ( ($IsBox bx@@12 (Tclass.A.StoreAndRetrieve A.StoreAndRetrieve$Thing@@15)))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$A.StoreAndRetrieve.Retrieve)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 (Tclass.A.StoreAndRetrieve A.StoreAndRetrieve$Thing@@17)) ($IsAlloc refType this@@3 (Tclass.A.StoreAndRetrieve A.StoreAndRetrieve$Thing@@17) $Heap@@1))) (and ($Is HandleTypeType |matchCriterion#0| (Tclass._System.___hTotalFunc1 A.StoreAndRetrieve$Thing@@17 TBool)) ($IsAlloc HandleTypeType |matchCriterion#0| (Tclass._System.___hTotalFunc1 A.StoreAndRetrieve$Thing@@17 TBool) $Heap@@1))) (and (and ($IsBox |thing#0| A.StoreAndRetrieve$Thing@@17) ($IsAllocBox |thing#0| A.StoreAndRetrieve$Thing@@17 $Heap@@1)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct))))
