...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split126)
...
)))) (=> (and (and (and ($IsGoodHeap $Heap@8) ($IsHeapAnchor $Heap@8)) (<= (- |$rhs#1_1@1| |k#0@2|) |W#0|)) (and (= $Heap@7 $Heap@8) (or (<= 0 |$decr$loop#10@1|) (= (- (_System.array.Length |a#0@@4|) |n#0@4|) |$decr$loop#10@1|)))) (=> (and (and (and (and (< (- (_System.array.Length |a#0@@4|) |n#0@4|) |$decr$loop#10@1|) (=> (and (and (and (<= (LitInt 0) |k#0@2|) (< |k#0@2| |$rhs#1_1@1|)) (<= |$rhs#1_1@1| |n#0@4|)) (<= |n#0@4| (_System.array.Length |a#0@@4|))) (and (|_module.__default.StrictlyIncreasing#canCall| $Heap@8 $nw@0 |k#0@2| |$rhs#1_1@1| (- |n#0@4| |W#0|) |n#0@4|) (=> (_module.__default.StrictlyIncreasing $Heap@8 $nw@0 |k#0@2| |$rhs#1_1@1| (- |n#0@4| |W#0|) |n#0@4|) (and (|_module.__default.RightmostMax#canCall| $Heap@8 |a#0@@4| (- |n#0@4| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |k#0@2|)))) |n#0@4|) (=> (_module.__default.RightmostMax $Heap@8 |a#0@@4| (- |n#0@4| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |k#0@2|)))) |n#0@4|) (and (forall ((|u#3| Int) (|_t#0#1| Int) ) (!  (=> (= |_t#0#1| (- |u#3| 1)) (=> (< |k#0@2| |u#3|) (=> (< |u#3| |$rhs#1_1@1|) (|_module.__default.RightmostMax#canCall| $Heap@8 |a#0@@4| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |_t#0#1|)))) 1) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |u#3|)))) |n#0@4|))))
