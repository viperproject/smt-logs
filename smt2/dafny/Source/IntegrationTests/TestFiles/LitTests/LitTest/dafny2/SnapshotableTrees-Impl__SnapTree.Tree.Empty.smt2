...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@29 T@U) ($f@@3 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#1| |l#0| |l#1| |l#2| |l#3|) $o@@29 $f@@3))  (=> (and (or (not (= $o@@29 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@29) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1950|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#1| |l#0| |l#1| |l#2| |l#3|) $o@@29 $f@@3))
)))
...
(assert (forall (($h@@25 T@U) ($o@@30 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (or (not (= $o@@30 null)) (not true)) (= (dtype $o@@30) Tclass.SnapTree.Tree?))) ($Is SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@25 $o@@30) SnapTree.Tree.Contents)) (TSeq TInt)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |663|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@25 $o@@30) SnapTree.Tree.Contents)))
)))
(assert (forall (($h@@26 T@U) ($o@@31 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (or (not (= $o@@31 null)) (not true)) (= (dtype $o@@31) Tclass.SnapTree.Node?))) ($Is SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@26 $o@@31) SnapTree.Node.Contents)) (TSeq TInt)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |814|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@26 $o@@31) SnapTree.Node.Contents)))
)))
...
(assert (forall ((h@@7 T@U) (v@@8 T@U) ) (! ($IsAlloc boolType v@@8 TBool h@@7)
 :qid |DafnyPreludebpl.291:14|
 :skolemid |63|
 :pattern ( ($IsAlloc boolType v@@8 TBool h@@7))
)))
...
(declare-fun this.IsReadonly () Bool)
(declare-fun this.Repr () T@U)
(declare-fun this.MutableRepr () T@U)
(declare-fun this.root () T@U)
(declare-fun this.reprIsShared () Bool)
...
(set-info :boogie-vc-id Impl$$SnapTree.Tree.Empty)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@7 alloc false)) (=> (and (and (and (and (or (not (= this@@6 null)) (not true)) ($Is refType this@@6 Tclass.SnapTree.Tree?)) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@6) alloc)))) (= ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@6) SnapTree.Tree.Contents)) this.Contents))) (and (and (= (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@6) SnapTree.Tree.IsReadonly))) this.IsReadonly) (= ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@6) SnapTree.Tree.Repr)) this.Repr)) (and (= ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@6) SnapTree.Tree.MutableRepr)) this.MutableRepr) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@6) SnapTree.Tree.root)) this.root)))) (and (and (and (= (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@6) SnapTree.Tree.reprIsShared))) this.reprIsShared) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@7 this@@6 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@6) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (= $Heap@0 $Heap@1) reveal_SnapTree.Tree.Valid)))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@6 SnapTree.Tree.Contents))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@6 SnapTree.Tree.Contents)) (=> (= |$rhs#0@0| (Lit SeqType |Seq#Empty|)) (=> (and (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 this@@6 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@6) SnapTree.Tree.Contents ($Box SeqType |$rhs#0@0|)))) ($IsGoodHeap $Heap@2)) (and (=> (= (ControlFlow 0 2) (- 0 11)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@6 SnapTree.Tree.IsReadonly))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@6 SnapTree.Tree.IsReadonly)) (=> (= |$rhs#1@0| (U_2_bool (Lit boolType (bool_2_U false)))) (=> (and (= $Heap@3 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@2 this@@6 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@6) SnapTree.Tree.IsReadonly ($Box boolType (bool_2_U |$rhs#1@0|))))) ($IsGoodHeap $Heap@3)) (and (=> (= (ControlFlow 0 2) (- 0 10)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@6 SnapTree.Tree.MutableRepr))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@6 SnapTree.Tree.MutableRepr)) (=> (= |$rhs#2@0| (|Set#UnionOne| |Set#Empty| ($Box refType this@@6))) (=> (and (= $Heap@4 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@3 this@@6 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@6) SnapTree.Tree.MutableRepr ($Box SetType |$rhs#2@0|)))) ($IsGoodHeap $Heap@4)) (and (=> (= (ControlFlow 0 2) (- 0 9)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@6 SnapTree.Tree.Repr))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@6 SnapTree.Tree.Repr)) (=> (= |$rhs#3@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@6) SnapTree.Tree.MutableRepr))) (=> (and (= $Heap@5 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@4 this@@6 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@6) SnapTree.Tree.Repr ($Box SetType |$rhs#3@0|)))) ($IsGoodHeap $Heap@5)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@6 SnapTree.Tree.root))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@6 SnapTree.Tree.root)) (=> (and (= $Heap@6 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@5 this@@6 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@6) SnapTree.Tree.root ($Box refType null)))) ($IsGoodHeap $Heap@6)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@6 SnapTree.Tree.reprIsShared))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@6 SnapTree.Tree.reprIsShared)) (=> (and (and (= |$rhs#5@0| (U_2_bool (Lit boolType (bool_2_U false)))) (= $Heap@7 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@6 this@@6 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@6) SnapTree.Tree.reprIsShared ($Box boolType (bool_2_U |$rhs#5@0|)))))) (and ($IsGoodHeap $Heap@7) (= |s##0@0| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@6) SnapTree.Tree.Contents))))) (=> (and (and (and ($IsGoodHeap $Heap@8) ($IsHeapAnchor $Heap@8)) (=> (<= (|Seq#Length| |s##0@0|) (LitInt 1)) (|SnapTree.Tree.IsSorted#canCall| |s##0@0|))) (and (=> (<= (|Seq#Length| |s##0@0|) (LitInt 1)) (SnapTree.Tree.IsSorted reveal_SnapTree.Tree.IsSorted |s##0@0|)) (= $Heap@7 $Heap@8))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (SnapTree.Tree.Valid reveal_SnapTree.Tree.Valid $Heap@8 this@@6)) (=> (SnapTree.Tree.Valid reveal_SnapTree.Tree.Valid $Heap@8 this@@6) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) SnapTree.Tree.Contents)) |Seq#Empty|)) (=> (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) SnapTree.Tree.Contents)) |Seq#Empty|) (and (=> (= (ControlFlow 0 2) (- 0 4)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) SnapTree.Tree.IsReadonly))))) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) SnapTree.Tree.IsReadonly)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) SnapTree.Tree.MutableRepr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) SnapTree.Tree.Repr)))) (=> (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) SnapTree.Tree.MutableRepr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) SnapTree.Tree.Repr))) (=> (= (ControlFlow 0 2) (- 0 1)) (and (forall (($o@@32 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) SnapTree.Tree.Repr)) ($Box refType $o@@32)) (or (not (= $o@@32 null)) (not true)))
 :qid |SnapshotableTreesdfy.146:38|
 :skolemid |736|
 :pattern (  (or (not (= $o@@32 null)) (not true)))
)) (forall (($o@@33 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) SnapTree.Tree.Repr)) ($Box refType $o@@33)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@33) alloc)))))
 :qid |SnapshotableTreesdfy.146:38|
 :skolemid |737|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) SnapTree.Tree.Repr)) ($Box refType $o@@33)))
)))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@7) ($IsHeapAnchor $Heap@@7)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 13) 2))) anon0_correct)))
