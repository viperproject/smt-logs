...
(assert (distinct TagSet alloc Tagclass._System.nat Tagclass._module.List |##_module.List.Nil| |##_module.List.Cons| tytagFamily$nat tytagFamily$List)
)
...
(assert (forall ((d@@5 T@U) (_module.List$X@@5 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.List.Cons_q d@@5) ($IsAlloc DatatypeTypeType d@@5 (Tclass._module.List _module.List$X@@5) $h@@1))) ($IsAllocBox (_module.List.head d@@5) _module.List$X@@5 $h@@1))
 :qid |unknown.0:0|
 :skolemid |766|
 :pattern ( ($IsAllocBox (_module.List.head d@@5) _module.List$X@@5 $h@@1))
)))
...
(assert (forall ((_module.List$X@@6 T@U) (bx@@3 T@U) ) (!  (=> ($IsBox bx@@3 (Tclass._module.List _module.List$X@@6)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@3)) bx@@3) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@3) (Tclass._module.List _module.List$X@@6))))
 :qid |unknown.0:0|
 :skolemid |586|
 :pattern ( ($IsBox bx@@3 (Tclass._module.List _module.List$X@@6)))
)))
(assert (forall ((d@@7 T@U) (_module.List$X@@7 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (_module.List.Cons_q d@@7) ($IsAlloc DatatypeTypeType d@@7 (Tclass._module.List _module.List$X@@7) $h@@2))) ($IsAlloc DatatypeTypeType (_module.List.tail d@@7) (Tclass._module.List _module.List$X@@7) $h@@2))
 :qid |unknown.0:0|
 :skolemid |767|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.List.tail d@@7) (Tclass._module.List _module.List$X@@7) $h@@2))
)))
...
(assert (forall ((_module.List$X@@8 T@U) (|a#6#0#0@@0| T@U) (|a#6#1#0@@0| T@U) ($h@@3 T@U) ) (!  (=> ($IsGoodHeap $h@@3) (= ($IsAlloc DatatypeTypeType (|#_module.List.Cons| |a#6#0#0@@0| |a#6#1#0@@0|) (Tclass._module.List _module.List$X@@8) $h@@3)  (and ($IsAllocBox |a#6#0#0@@0| _module.List$X@@8 $h@@3) ($IsAlloc DatatypeTypeType |a#6#1#0@@0| (Tclass._module.List _module.List$X@@8) $h@@3))))
 :qid |unknown.0:0|
 :skolemid |765|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.List.Cons| |a#6#0#0@@0| |a#6#1#0@@0|) (Tclass._module.List _module.List$X@@8) $h@@3))
)))
(push 1)
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.SMN_k_k__Correct)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon4_correct  (=> (and (and (forall ((|x#1@@0| T@U) ) (!  (=> (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |xs#0@@11|) ($Box intType |x#1@@0|)) (<= |n#0| (U_2_int |x#1@@0|)))
 :qid |SmallestMissingNumberfunctionaldfy.274:19|
 :skolemid |737|
 :pattern ( (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |xs#0@@11|) ($Box intType |x#1@@0|)))
)) ($IsAlloc DatatypeTypeType |xs#0@@11| (Tclass._module.List Tclass._System.nat) $Heap@@0)) (and (|_module.__default.Length#canCall| Tclass._System.nat |xs#0@@11|) (= |len#0| (_module.__default.Length Tclass._System.nat ($LS $LZ) |xs#0@@11|)))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@0 $Heap@0)) (and (and ($IsAlloc DatatypeTypeType |xs#0@@11| (Tclass._module.List Tclass._System.nat) $Heap@0) ($IsAlloc intType (int_2_U |n#0|) Tclass._System.nat $Heap@0)) (and ($IsAlloc intType (int_2_U |len#0|) Tclass._System.nat $Heap@0) (= (ControlFlow 0 2) (- 0 1))))) (= |len#0| (_module.__default.Length Tclass._System.nat ($LS ($LS $LZ)) |xs#0@@11|))))))
(let ((anon16_Else_correct  (=> (and (=> (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |xs#0@@11|) ($Box intType (int_2_U |x#0@0|))) (<= |n#0| |x#0@0|)) (= (ControlFlow 0 4) 2)) anon4_correct)))
(let ((anon16_Then_correct  (=> ($IsAlloc DatatypeTypeType |xs#0@@11| (Tclass._module.List Tclass._System.nat) $Heap@@0) (=> (and (and (|_module.__default.Elements#canCall| Tclass._System.nat |xs#0@@11|) (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |xs#0@@11|) ($Box intType (int_2_U |x#0@0|)))) (and (<= |n#0| |x#0@0|) (= (ControlFlow 0 3) 2))) anon4_correct))))
(let ((anon0_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (and (and ($Is DatatypeTypeType |xs#0@@11| (Tclass._module.List Tclass._System.nat)) ($IsAlloc DatatypeTypeType |xs#0@@11| (Tclass._module.List Tclass._System.nat) $Heap@@0)) (|$IsA#_module.List| |xs#0@@11|)) (<= (LitInt 0) |n#0|)) (and (<= (LitInt 0) |len#0|) (= 4 $FunctionContextHeight))) (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) ($IsAlloc DatatypeTypeType |xs#0@@11| (Tclass._module.List Tclass._System.nat) $Heap@@0)) (and (|_module.__default.NoDuplicates#canCall| Tclass._System.nat |xs#0@@11|) (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |xs#0@@11|)))) (and (=> (= (ControlFlow 0 5) 3) anon16_Then_correct) (=> (= (ControlFlow 0 5) 4) anon16_Else_correct))))))
anon0_correct)))))
))
(check-sat)
(get-info :rlimit)
