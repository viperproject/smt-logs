...
(assert (forall (($h@@12 T@U) ($o@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (or (not (= $o@@15 null)) (not true)) (= (dtype $o@@15) Tclass.SnapTree.Node?))) ($Is SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@15) SnapTree.Node.Contents)) (TSeq TInt)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |814|
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@16 T@U) ($f@@2 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#9| |l#0| |l#1| |l#2| |l#3|) $o@@16 $f@@2))  (=> (and (or (not (= $o@@16 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@16) |l#2|)))) (|Set#IsMember| |l#3| ($Box refType $o@@16))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1951|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#9| |l#0| |l#1| |l#2| |l#3|) $o@@16 $f@@2))
)))
...
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id CheckWellFormed$$SnapTree.Node.MutatingInsert__Right)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon9_correct  (=> (and (and (<= (LitInt 0) |pos#0@0|) (< |pos#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.Contents))))) (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.Contents))) (+ (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents))) 1))) (and (=> (= (ControlFlow 0 3) (- 0 6)) ($IsAlloc refType this@@3 Tclass.SnapTree.Node $Heap@@5)) (=> ($IsAlloc refType this@@3 Tclass.SnapTree.Node $Heap@@5) (and (=> (= (ControlFlow 0 3) (- 0 5)) (and (<= 0 |pos#0@0|) (<= |pos#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents)))))) (=> (and (<= 0 |pos#0@0|) (<= |pos#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) ($IsAlloc refType this@@3 Tclass.SnapTree.Node $Heap@@5)) (=> ($IsAlloc refType this@@3 Tclass.SnapTree.Node $Heap@@5) (=> (= (ControlFlow 0 3) (- 0 2)) (and (<= 0 |pos#0@0|) (<= |pos#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents)))))))))))))))
(let ((anon14_Else_correct  (=> (and (not (and (<= (LitInt 0) |pos#0@0|) (< |pos#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.Contents)))))) (= (ControlFlow 0 9) 3)) anon9_correct)))
(let ((anon14_Then_correct  (=> (and (<= (LitInt 0) |pos#0@0|) (< |pos#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.Contents))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) ($IsAlloc refType this@@3 Tclass.SnapTree.Node $Heap@@5)) (=> ($IsAlloc refType this@@3 Tclass.SnapTree.Node $Heap@@5) (=> (= (ControlFlow 0 7) 3) anon9_correct))))))
(let ((anon13_Else_correct  (=> (< |pos#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 11) 7) anon14_Then_correct) (=> (= (ControlFlow 0 11) 9) anon14_Else_correct)))))
(let ((anon13_Then_correct  (=> (<= (LitInt 0) |pos#0@0|) (and (=> (= (ControlFlow 0 10) 7) anon14_Then_correct) (=> (= (ControlFlow 0 10) 9) anon14_Else_correct)))))
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) ($IsAlloc refType this@@3 Tclass.SnapTree.Node $Heap@@5)) (=> ($IsAlloc refType this@@3 Tclass.SnapTree.Node $Heap@@5) (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (and (=> (= (ControlFlow 0 12) 10) anon13_Then_correct) (=> (= (ControlFlow 0 12) 11) anon13_Else_correct)))))))
(let ((anon12_Else_correct true))
(let ((anon11_Else_correct  (=> (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))) (and (< |pos#0@0| 0) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.Contents)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents))))) (and (=> (= (ControlFlow 0 17) 12) anon12_Then_correct) (=> (= (ControlFlow 0 17) 1) anon12_Else_correct)))))
(let ((anon11_Then_correct  (and (=> (= (ControlFlow 0 14) (- 0 16)) ($IsAlloc refType this@@3 Tclass.SnapTree.Node $Heap@@5)) (=> ($IsAlloc refType this@@3 Tclass.SnapTree.Node $Heap@@5) (=> (and (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))) (< |pos#0@0| 0)) (and (=> (= (ControlFlow 0 14) (- 0 15)) ($IsAlloc refType this@@3 Tclass.SnapTree.Node $Heap@@5)) (=> ($IsAlloc refType this@@3 Tclass.SnapTree.Node $Heap@@5) (=> (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.Contents)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents))) (and (=> (= (ControlFlow 0 14) 12) anon12_Then_correct) (=> (= (ControlFlow 0 14) 1) anon12_Else_correct))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#9| null $Heap@@5 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Repr)))) (=> (and (and ($IsAllocBox ($Box refType this@@3) Tclass.SnapTree.Node? $Heap@@5) (|SnapTree.Node.NodeValid#canCall| $Heap@@5 this@@3)) (and (SnapTree.Node.NodeValid ($LS $LZ) reveal_SnapTree.Node.NodeValid $Heap@@5 this@@3) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.data))) |x#0|))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@17 T@U) ) (!  (=> (and (or (not (= $o@@17 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@17) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@17) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@17)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Repr)) ($Box refType $o@@17))))
 :qid |SnapshotableTreesdfy.451:12|
 :skolemid |980|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@17))
))) (and (and ($HeapSucc $Heap@@5 $Heap@0) ($IsAllocBox ($Box refType this@@3) Tclass.SnapTree.Node? $Heap@0)) (and (|SnapTree.Node.NodeValid#canCall| $Heap@0 this@@3) (SnapTree.Node.NodeValid ($LS $LZ) reveal_SnapTree.Node.NodeValid $Heap@0 this@@3)))) (and (=> (= (ControlFlow 0 18) (- 0 19)) ($IsAlloc refType this@@3 Tclass.SnapTree.Node $Heap@@5)) (=> ($IsAlloc refType this@@3 Tclass.SnapTree.Node $Heap@@5) (=> (and (forall (($o@@18 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.Repr)) ($Box refType $o@@18)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Repr)) ($Box refType $o@@18)))) (or (not (= $o@@18 null)) (not true)))
 :qid |SnapshotableTreesdfy.454:30|
 :skolemid |981|
 :pattern (  (or (not (= $o@@18 null)) (not true)))
)) (forall (($o@@19 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.Repr)) ($Box refType $o@@19)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Repr)) ($Box refType $o@@19)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@19) alloc)))))
 :qid |SnapshotableTreesdfy.454:30|
 :skolemid |982|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@19) alloc)))
))) (and (=> (= (ControlFlow 0 18) 14) anon11_Then_correct) (=> (= (ControlFlow 0 18) 17) anon11_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@5) ($IsHeapAnchor $Heap@@5)) (=> (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.SnapTree.Node) ($IsAlloc refType this@@3 Tclass.SnapTree.Node $Heap@@5))) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 20) 18))) anon0_correct))))
