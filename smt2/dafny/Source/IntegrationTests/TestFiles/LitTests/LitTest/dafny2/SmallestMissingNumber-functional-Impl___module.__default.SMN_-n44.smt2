...
(set-info :boogie-vc-id Impl$$_module.__default.SMN_k_k__Correct_split24)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((GeneratedUnifiedExit_correct  (=> (and (let ((|s#0| (_module.__default.SMN_k_k ($LS ($LS $LZ)) |xs#0@@20| |n#0@@4| |len#0@@9|)))
(<= |n#0@@4| |s#0|)) (= (ControlFlow 0 2) (- 0 1))) (let ((|s#0@@0| (_module.__default.SMN_k_k ($LS ($LS $LZ)) |xs#0@@20| |n#0@@4| |len#0@@9|)))
(<= |s#0@@0| (+ |n#0@@4| |len#0@@9|))))))
...
)) (= |len##1_1_0@0| (_module.__default.Length Tclass._System.nat ($LS ($LS $LZ)) |R#1_0@0|))) (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4))))) (and (and (and (and (|_module.__default.SMN_k_k#canCall| |R#1_0@0| |n##1_1_0@0| |len##1_1_0@0|) (let ((|s#0@@1| (_module.__default.SMN_k_k ($LS $LZ) |R#1_0@0| |n##1_1_0@0| |len##1_1_0@0|)))
 (=> (and (<= |n##1_1_0@0| |s#0@@1|) (<= |s#0@@1| (+ |n##1_1_0@0| |len##1_1_0@0|))) (and (|_module.__default.Elements#canCall| Tclass._System.nat |R#1_0@0|) (=> (not (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |R#1_0@0|) ($Box intType (int_2_U |s#0@@1|)))) (forall ((|x#3@@0| T@U) ) (!  (=> (and (<= |n##1_1_0@0| (U_2_int |x#3@@0|)) (< (U_2_int |x#3@@0|) |s#0@@1|)) (|_module.__default.Elements#canCall| Tclass._System.nat |R#1_0@0|))
...
))))))) (let ((|s#0@@2| (_module.__default.SMN_k_k ($LS ($LS $LZ)) |R#1_0@0| |n##1_1_0@0| |len##1_1_0@0|)))
(<= |n##1_1_0@0| |s#0@@2|))) (and (let ((|s#0@@3| (_module.__default.SMN_k_k ($LS ($LS $LZ)) |R#1_0@0| |n##1_1_0@0| |len##1_1_0@0|)))
(<= |s#0@@3| (+ |n##1_1_0@0| |len##1_1_0@0|))) (let ((|s#0@@4| (_module.__default.SMN_k_k ($LS ($LS $LZ)) |R#1_0@0| |n##1_1_0@0| |len##1_1_0@0|)))
 (not (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS ($LS $LZ)) |R#1_0@0|) ($Box intType (int_2_U |s#0@@4|))))))) (and (and (let ((|s#0@@5| (_module.__default.SMN_k_k ($LS ($LS $LZ)) |R#1_0@0| |n##1_1_0@0| |len##1_1_0@0|)))
(forall ((|x#3@@1| T@U) ) (!  (=> (and (<= |n##1_1_0@0| (U_2_int |x#3@@1|)) (< (U_2_int |x#3@@1|) |s#0@@5|)) (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |R#1_0@0|) ($Box intType |x#3@@1|)))
 :qid |SmallestMissingNumberfunctionaldfy.279:12|
 :skolemid |743|
...
)) (= |llen#1_0@0| (_module.__default.Length Tclass._System.nat ($LS ($LS $LZ)) |L#1_0@0|))) (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)))) (and (and (and (|_module.__default.SMN_k_k#canCall| |L#1_0@0| |n#0@@4| |llen#1_0@0|) (let ((|s#0@@6| (_module.__default.SMN_k_k ($LS $LZ) |L#1_0@0| |n#0@@4| |llen#1_0@0|)))
 (=> (and (<= |n#0@@4| |s#0@@6|) (<= |s#0@@6| (+ |n#0@@4| |llen#1_0@0|))) (and (|_module.__default.Elements#canCall| Tclass._System.nat |L#1_0@0|) (=> (not (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |L#1_0@0|) ($Box intType (int_2_U |s#0@@6|)))) (forall ((|x#3@@2| T@U) ) (!  (=> (and (<= |n#0@@4| (U_2_int |x#3@@2|)) (< (U_2_int |x#3@@2|) |s#0@@6|)) (|_module.__default.Elements#canCall| Tclass._System.nat |L#1_0@0|))
 :qid |SmallestMissingNumberfunctionaldfy.279:12|
 :skolemid |741|
 :pattern ( (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |L#1_0@0|) ($Box intType |x#3@@2|)))
))))))) (and (let ((|s#0@@7| (_module.__default.SMN_k_k ($LS ($LS $LZ)) |L#1_0@0| |n#0@@4| |llen#1_0@0|)))
(<= |n#0@@4| |s#0@@7|)) (let ((|s#0@@8| (_module.__default.SMN_k_k ($LS ($LS $LZ)) |L#1_0@0| |n#0@@4| |llen#1_0@0|)))
(<= |s#0@@8| (+ |n#0@@4| |llen#1_0@0|))))) (and (and (let ((|s#0@@9| (_module.__default.SMN_k_k ($LS ($LS $LZ)) |L#1_0@0| |n#0@@4| |llen#1_0@0|)))
 (not (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS ($LS $LZ)) |L#1_0@0|) ($Box intType (int_2_U |s#0@@9|))))) (let ((|s#0@@10| (_module.__default.SMN_k_k ($LS ($LS $LZ)) |L#1_0@0| |n#0@@4| |llen#1_0@0|)))
(forall ((|x#3@@3| T@U) ) (!  (=> (and (<= |n#0@@4| (U_2_int |x#3@@3|)) (< (U_2_int |x#3@@3|) |s#0@@10|)) (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |L#1_0@0|) ($Box intType |x#3@@3|)))
 :qid |SmallestMissingNumberfunctionaldfy.279:12|
 :skolemid |743|
