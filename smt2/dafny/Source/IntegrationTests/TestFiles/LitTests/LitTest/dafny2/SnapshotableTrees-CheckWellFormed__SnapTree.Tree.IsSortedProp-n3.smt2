...
(set-info :boogie-vc-id CheckWellFormed$$SnapTree.Tree.IsSortedProperty)
...
(let ((anon12_Else_correct  (=> (and (not (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |j#0@0|)) (< |j#0@0| (|Seq#Length| |c#0@@1|)))) (= (ControlFlow 0 6) 2)) anon8_correct)))
(let ((anon12_Then_correct  (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |j#0@0|)) (< |j#0@0| (|Seq#Length| |c#0@@1|))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |c#0@@1|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |c#0@@1|))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 |j#0@0|) (< |j#0@0| (|Seq#Length| |c#0@@1|)))) (=> (and (<= 0 |j#0@0|) (< |j#0@0| (|Seq#Length| |c#0@@1|))) (=> (= (ControlFlow 0 3) 2) anon8_correct))))))))
(let ((anon11_Else_correct  (=> (not (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |j#0@0|))) (and (=> (= (ControlFlow 0 8) 3) anon12_Then_correct) (=> (= (ControlFlow 0 8) 6) anon12_Else_correct)))))
(let ((anon11_Then_correct  (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |j#0@0|)) (and (=> (= (ControlFlow 0 7) 3) anon12_Then_correct) (=> (= (ControlFlow 0 7) 6) anon12_Else_correct)))))
(let ((anon10_Else_correct  (=> (< |i#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 10) 7) anon11_Then_correct) (=> (= (ControlFlow 0 10) 8) anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 9) 7) anon11_Then_correct) (=> (= (ControlFlow 0 9) 8) anon11_Else_correct)))))
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and ($IsAlloc SeqType |c#0@@1| (TSeq TInt) $Heap@0) (|SnapTree.Tree.IsSorted#canCall| |c#0@@1|))) (and (=> (= (ControlFlow 0 12) 11) anon9_Then_correct) (=> (= (ControlFlow 0 12) 1) anon9_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |c#0@@1| (TSeq TInt)) ($IsAlloc SeqType |c#0@@1| (TSeq TInt) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 13) 12))) anon0_correct))))
