...
(declare-fun |R#0| () T@U)
(set-info :boogie-vc-id Impl$$SnapTree.Node.MutatingInsert__Left)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 31) (let ((anon6_correct  (and (=> (= (ControlFlow 0 2) (- 0 18)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@3 SnapTree.Node.Repr))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@3 SnapTree.Node.Repr)) (and (=> (= (ControlFlow 0 2) (- 0 17)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@3) SnapTree.Node.left)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@3) SnapTree.Node.left)) null)) (not true)) (=> (= |$rhs#0@0| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@3) SnapTree.Node.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@3) SnapTree.Node.left))) SnapTree.Node.Repr)))) (=> (and (= $Heap@6 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@5 this@@3 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@3) SnapTree.Node.Repr ($Box SetType |$rhs#0@0|)))) ($IsGoodHeap $Heap@6)) (and (=> (= (ControlFlow 0 2) (- 0 16)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@3 SnapTree.Node.Contents))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@3 SnapTree.Node.Contents)) (and (=> (= (ControlFlow 0 2) (- 0 15)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@3) SnapTree.Node.left)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@3) SnapTree.Node.left)) null)) (not true)) (=> (= |$rhs#1@0| (|Seq#Append| (|Seq#Append| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@3) SnapTree.Node.left))) SnapTree.Node.Contents)) (|Seq#Build| |Seq#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@3) SnapTree.Node.data))) |R#0@0|)) (=> (and (= $Heap@7 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@6 this@@3 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@3) SnapTree.Node.Contents ($Box SeqType |$rhs#1@0|)))) ($IsGoodHeap $Heap@7)) (and (=> (= (ControlFlow 0 2) (- 0 14)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@3) SnapTree.Node.left)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@3) SnapTree.Node.left)) null)) (not true)) (=> (and (= |left##0@0| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@3) SnapTree.Node.left))) SnapTree.Node.Contents))) (= |data##0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@3) SnapTree.Node.data))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|SnapTree.Tree.SortedSplit#canCall| |left##0@0| |data##0@0| |R#0@0|) (or (SnapTree.Tree.SortedSplit |left##0@0| |data##0@0| |R#0@0|) (SnapTree.Tree.IsSorted reveal_SnapTree.Tree.IsSorted |left##0@0|)))) (=> (=> (|SnapTree.Tree.SortedSplit#canCall| |left##0@0| |data##0@0| |R#0@0|) (or (SnapTree.Tree.SortedSplit |left##0@0| |data##0@0| |R#0@0|) (SnapTree.Tree.IsSorted reveal_SnapTree.Tree.IsSorted |left##0@0|))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|SnapTree.Tree.SortedSplit#canCall| |left##0@0| |data##0@0| |R#0@0|) (or (SnapTree.Tree.SortedSplit |left##0@0| |data##0@0| |R#0@0|) (SnapTree.Tree.IsSorted reveal_SnapTree.Tree.IsSorted |R#0@0|)))) (=> (=> (|SnapTree.Tree.SortedSplit#canCall| |left##0@0| |data##0@0| |R#0@0|) (or (SnapTree.Tree.SortedSplit |left##0@0| |data##0@0| |R#0@0|) (SnapTree.Tree.IsSorted reveal_SnapTree.Tree.IsSorted |R#0@0|))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|SnapTree.Tree.SortedSplit#canCall| |left##0@0| |data##0@0| |R#0@0|) (or (SnapTree.Tree.SortedSplit |left##0@0| |data##0@0| |R#0@0|) (=> (|SnapTree.Tree.AllBelow#canCall| |left##0@0| |data##0@0|) (or (SnapTree.Tree.AllBelow |left##0@0| |data##0@0|) (forall ((|i#0@@2| Int) ) (!  (=> (and (<= (LitInt 0) |i#0@@2|) (< |i#0@@2| (|Seq#Length| |left##0@0|))) (< (U_2_int ($Unbox intType (|Seq#Index| |left##0@0| |i#0@@2|))) |data##0@0|))
 :qid |SnapshotableTreesdfy.126:14|
 :skolemid |721|
 :pattern ( ($Unbox intType (|Seq#Index| |left##0@0| |i#0@@2|)))
))))))) (=> (=> (|SnapTree.Tree.SortedSplit#canCall| |left##0@0| |data##0@0| |R#0@0|) (or (SnapTree.Tree.SortedSplit |left##0@0| |data##0@0| |R#0@0|) (=> (|SnapTree.Tree.AllBelow#canCall| |left##0@0| |data##0@0|) (or (SnapTree.Tree.AllBelow |left##0@0| |data##0@0|) (forall ((|i#0@@3| Int) ) (!  (=> (and (<= (LitInt 0) |i#0@@3|) (< |i#0@@3| (|Seq#Length| |left##0@0|))) (< (U_2_int ($Unbox intType (|Seq#Index| |left##0@0| |i#0@@3|))) |data##0@0|))
 :qid |SnapshotableTreesdfy.126:14|
 :skolemid |721|
 :pattern ( ($Unbox intType (|Seq#Index| |left##0@0| |i#0@@3|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|SnapTree.Tree.SortedSplit#canCall| |left##0@0| |data##0@0| |R#0@0|) (or (SnapTree.Tree.SortedSplit |left##0@0| |data##0@0| |R#0@0|) (=> (|SnapTree.Tree.AllAbove#canCall| |data##0@0| |R#0@0|) (or (SnapTree.Tree.AllAbove |data##0@0| |R#0@0|) (forall ((|i#1@@2| Int) ) (!  (=> (and (<= (LitInt 0) |i#1@@2|) (< |i#1@@2| (|Seq#Length| |R#0@0|))) (< |data##0@0| (U_2_int ($Unbox intType (|Seq#Index| |R#0@0| |i#1@@2|)))))
 :qid |SnapshotableTreesdfy.130:14|
 :skolemid |723|
 :pattern ( ($Unbox intType (|Seq#Index| |R#0@0| |i#1@@2|)))
))))))) (=> (=> (|SnapTree.Tree.SortedSplit#canCall| |left##0@0| |data##0@0| |R#0@0|) (or (SnapTree.Tree.SortedSplit |left##0@0| |data##0@0| |R#0@0|) (=> (|SnapTree.Tree.AllAbove#canCall| |data##0@0| |R#0@0|) (or (SnapTree.Tree.AllAbove |data##0@0| |R#0@0|) (forall ((|i#1@@3| Int) ) (!  (=> (and (<= (LitInt 0) |i#1@@3|) (< |i#1@@3| (|Seq#Length| |R#0@0|))) (< |data##0@0| (U_2_int ($Unbox intType (|Seq#Index| |R#0@0| |i#1@@3|)))))
 :qid |SnapshotableTreesdfy.130:14|
 :skolemid |723|
 :pattern ( ($Unbox intType (|Seq#Index| |R#0@0| |i#1@@3|)))
)))))) (=> (and (and (and (and ($IsGoodHeap $Heap@8) ($IsHeapAnchor $Heap@8)) (|SnapTree.Tree.IsSorted#canCall| (|Seq#Append| (|Seq#Append| |left##0@0| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |data##0@0|)))) |R#0@0|))) (and (SnapTree.Tree.IsSorted reveal_SnapTree.Tree.IsSorted (|Seq#Append| (|Seq#Append| |left##0@0| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |data##0@0|)))) |R#0@0|)) (= $Heap@7 $Heap@8))) (and (and ($IsGoodHeap $Heap@9) ($IsHeapAnchor $Heap@9)) (and (= $Heap@8 $Heap@9) reveal_SnapTree.Node.NodeValid))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@9 this@@3)) (=> (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@9 this@@3) (and (=> (= (ControlFlow 0 2) (- 0 8)) (and (forall (($o@@17 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@3) SnapTree.Node.Repr)) ($Box refType $o@@17)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Repr)) ($Box refType $o@@17)))) (or (not (= $o@@17 null)) (not true)))
...
(let ((anon8_Else_correct  (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@3) SnapTree.Node.left)) null)) (not true)) (and (=> (= (ControlFlow 0 21) (- 0 25)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@3) SnapTree.Node.left)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@3) SnapTree.Node.left)) null)) (not true)) (and (=> (= (ControlFlow 0 21) (- 0 24)) (forall (($o@@21 T@U) ($f@@3 T@U) ) (!  (=> (and (and (or (not (= $o@@21 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@21) alloc)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@3) SnapTree.Node.left))) SnapTree.Node.Repr)) ($Box refType $o@@21))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@21 $f@@3)))
 :qid |SnapshotableTreesdfy.443:35|
 :skolemid |977|
))) (=> (forall (($o@@22 T@U) ($f@@4 T@U) ) (!  (=> (and (and (or (not (= $o@@22 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@22) alloc)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@3) SnapTree.Node.left))) SnapTree.Node.Repr)) ($Box refType $o@@22))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@22 $f@@4)))
 :qid |SnapshotableTreesdfy.443:35|
 :skolemid |977|
)) (and (=> (= (ControlFlow 0 21) (- 0 23)) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@3) SnapTree.Node.left))) SnapTree.Node.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Repr))) (not (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@3) SnapTree.Node.left))) SnapTree.Node.Repr)))))) (=> (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@3) SnapTree.Node.left))) SnapTree.Node.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Repr))) (not (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@3) SnapTree.Node.left))) SnapTree.Node.Repr))))) (=> (= call0formal@this@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@3) SnapTree.Node.left))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@1 call0formal@this@0)) (=> (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@1 call0formal@this@0) (=> (and (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (and (|SnapTree.Node.NodeValid#canCall| $Heap@4 call0formal@this@0) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@4 call0formal@this@0))) (=> (and (and (and (and (forall (($o@@23 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call0formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@23)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@23)))) (or (not (= $o@@23 null)) (not true)))
 :qid |SnapshotableTreesdfy.409:30|
 :skolemid |956|
 :pattern (  (or (not (= $o@@23 null)) (not true)))
)) (forall (($o@@24 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call0formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@24)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@24)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@24) alloc)))))
 :qid |SnapshotableTreesdfy.409:30|
 :skolemid |957|
...
))) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))) (< |call3formal@pos#0@0| 0))) (and (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call0formal@this@0) SnapTree.Node.Contents)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0) SnapTree.Node.Contents)))) (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (<= (LitInt 0) |call3formal@pos#0@0|)))) (and (and (and (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (< |call3formal@pos#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call0formal@this@0) SnapTree.Node.Contents))))) (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call0formal@this@0) SnapTree.Node.Contents))) (+ (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0) SnapTree.Node.Contents))) 1)))) (and (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call0formal@this@0) SnapTree.Node.Contents)) (|Seq#Append| (|Seq#Append| (|Seq#Take| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0) SnapTree.Node.Contents)) |call3formal@pos#0@0|) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |x#0|)))) (|Seq#Drop| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0) SnapTree.Node.Contents)) |call3formal@pos#0@0|)))) (forall (($o@@25 T@U) ) (!  (=> (and (or (not (= $o@@25 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@25) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@25) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@25)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@25))))
 :qid |SnapshotableTreesdfy.406:12|
 :skolemid |958|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@25))
)))) (and (and ($HeapSucc $Heap@1 $Heap@4) (= $Heap@5 $Heap@4)) (and (= |pos#0@1| |call3formal@pos#0@0|) (= (ControlFlow 0 21) 2))))) anon6_correct))))))))))))))
(let ((anon8_Then_correct  (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@3) SnapTree.Node.left)) null) (and (=> (= (ControlFlow 0 19) (- 0 20)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@3 SnapTree.Node.left))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@3 SnapTree.Node.left)) (=> (and (and (or (not (= call2formal@this null)) (not true)) (and ($Is refType call2formal@this Tclass.SnapTree.Node) ($IsAlloc refType call2formal@this Tclass.SnapTree.Node $Heap@@5))) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2))) (=> (and (and (and (and (or (not (= call2formal@this@0 null)) (not true)) (and ($Is refType call2formal@this@0 Tclass.SnapTree.Node) ($IsAlloc refType call2formal@this@0 Tclass.SnapTree.Node $Heap@2))) (and (|SnapTree.Node.NodeValid#canCall| $Heap@2 call2formal@this@0) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@2 call2formal@this@0))) (and (and (forall (($o@@26 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call2formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@26)) (or (not (= $o@@26 null)) (not true)))
 :qid |SnapshotableTreesdfy.296:30|
 :skolemid |851|
 :pattern (  (or (not (= $o@@26 null)) (not true)))
)) (forall (($o@@27 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call2formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@27)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@27) alloc)))))
 :qid |SnapshotableTreesdfy.296:30|
 :skolemid |852|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call2formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@27)))
))) (and (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call2formal@this@0) SnapTree.Node.Contents)) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |x#0|)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call2formal@this@0) alloc))))))) (and (and (and (forall (($o@@28 T@U) ) (!  (=> (and (or (not (= $o@@28 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@28) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@28) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@28)))
 :qid |SnapshotableTreesdfy.295:17|
 :skolemid |853|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@28))
)) ($HeapSucc $Heap@1 $Heap@2)) (and (= $Heap@3 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@2 this@@3 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@3) SnapTree.Node.left ($Box refType call2formal@this@0)))) ($IsGoodHeap $Heap@3))) (and (and (= |pos#0@0| (LitInt 0)) (= $Heap@5 $Heap@3)) (and (= |pos#0@1| |pos#0@0|) (= (ControlFlow 0 19) 2))))) anon6_correct)))))))
(let ((anon3_correct  (=> (and (= |R#0@0| (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.right)) null) |Seq#Empty| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.right))) SnapTree.Node.Contents)))) (= |s##0@0| (Lit SeqType |Seq#Empty|))) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (<= (|Seq#Length| |s##0@0|) (LitInt 1)) (|SnapTree.Tree.IsSorted#canCall| |s##0@0|))) (and (=> (<= (|Seq#Length| |s##0@0|) (LitInt 1)) (SnapTree.Tree.IsSorted reveal_SnapTree.Tree.IsSorted |s##0@0|)) (= $Heap@0 $Heap@1))) (and (=> (= (ControlFlow 0 26) 19) anon8_Then_correct) (=> (= (ControlFlow 0 26) 21) anon8_Else_correct))))))
(let ((anon7_Else_correct  (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.right)) null)) (not true)) (and (=> (= (ControlFlow 0 28) (- 0 29)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.right)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.right)) null)) (not true)) (=> (= (ControlFlow 0 28) 26) anon3_correct))))))
(let ((anon7_Then_correct  (=> (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.right)) null) (= (ControlFlow 0 27) 26)) anon3_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#9| null $Heap@@5 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Repr)))) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@5 $Heap@0) reveal_SnapTree.Node.NodeValid)) (and (=> (= (ControlFlow 0 30) 27) anon7_Then_correct) (=> (= (ControlFlow 0 30) 28) anon7_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@5) ($IsHeapAnchor $Heap@@5)) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.SnapTree.Node) ($IsAlloc refType this@@3 Tclass.SnapTree.Node $Heap@@5)))) (=> (and (and (and ($Is SeqType |R#0| (TSeq TInt)) ($IsAlloc SeqType |R#0| (TSeq TInt) $Heap@@5)) true) (and (and (= 5 $FunctionContextHeight) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@@5 this@@3)) (and (< |x#0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.data)))) (= (ControlFlow 0 31) 30)))) anon0_correct))))
