...
(declare-fun |iter#0@0| () T@U)
(declare-fun |iter#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$SnapTree.Tree.CreateIterator)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@11 alloc false)) ($IsAllocBox ($Box refType this@@9) Tclass.SnapTree.Tree? $Heap@@11)) (=> (and (and (and (|SnapTree.Tree.Valid#canCall| $Heap@@11 this@@9) (SnapTree.Tree.Valid reveal_SnapTree.Tree.Valid $Heap@@11 this@@9)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (forall (($o@@48 T@U) ) (!  (=> (and (or (not (= $o@@48 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 $o@@48) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@48) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 $o@@48)))
 :qid |SnapshotableTreesdfy.218:12|
 :skolemid |785|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@48))
)) ($HeapSucc $Heap@@11 $Heap@0)) (and ($Is refType |iter#0@0| Tclass.SnapTree.Iterator) ($IsAlloc refType |iter#0@0| Tclass.SnapTree.Iterator $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= |iter#0@0| null)) (not true))) (=> (or (not (= |iter#0@0| null)) (not true)) (=> ($IsAllocBox ($Box refType |iter#0@0|) Tclass.SnapTree.Iterator? $Heap@0) (=> (and (|SnapTree.Iterator.Valid#canCall| $Heap@0 |iter#0@0|) (SnapTree.Iterator.Valid reveal_SnapTree.Iterator.Valid $Heap@0 |iter#0@0|)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |iter#0@0| null)) (not true))) (=> (or (not (= |iter#0@0| null)) (not true)) (=> (and (forall (($o@@49 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |iter#0@0|) SnapTree.Iterator.IterRepr)) ($Box refType $o@@49)) (or (not (= $o@@49 null)) (not true)))
 :qid |SnapshotableTreesdfy.220:31|
 :skolemid |787|
 :pattern (  (or (not (= $o@@49 null)) (not true)))
)) (forall (($o@@50 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |iter#0@0|) SnapTree.Iterator.IterRepr)) ($Box refType $o@@50)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 $o@@50) alloc)))))
 :qid |SnapshotableTreesdfy.220:31|
 :skolemid |788|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |iter#0@0|) SnapTree.Iterator.IterRepr)) ($Box refType $o@@50)))
))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |iter#0@0| null)) (not true))) (=> (or (not (= |iter#0@0| null)) (not true)) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |iter#0@0|) SnapTree.Iterator.T)) this@@9) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |iter#0@0| null)) (not true))) (=> (or (not (= |iter#0@0| null)) (not true)) (=> (and (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |iter#0@0|) SnapTree.Iterator.Contents)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@9) SnapTree.Tree.Contents))) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |iter#0@0| null)) (not true)))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@11) ($IsHeapAnchor $Heap@@11)) (and (or (not (= this@@9 null)) (not true)) (and ($Is refType this@@9 Tclass.SnapTree.Tree) ($IsAlloc refType this@@9 Tclass.SnapTree.Tree $Heap@@11)))) (and (and ($Is refType |iter#0| Tclass.SnapTree.Iterator) ($IsAlloc refType |iter#0| Tclass.SnapTree.Iterator $Heap@@11)) (and (= 8 $FunctionContextHeight) (= (ControlFlow 0 7) 2)))) anon0_correct)))
