...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|xs#0@@7| T@U) ) (!  (=> (or (|_module.__default.SmallestMissingNumber#canCall| |xs#0@@7|) (and (< 4 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@7| (Tclass._module.List Tclass._System.nat)))) (<= (LitInt 0) (_module.__default.SmallestMissingNumber |xs#0@@7|)))
 :qid |SmallestMissingNumberfunctionaldfy.33:32|
 :skolemid |594|
 :pattern ( (_module.__default.SmallestMissingNumber |xs#0@@7|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@7 T@U) (|xs#0@@8| T@U) (|n#0@@1| Int) (|len#0@@1| Int) ) (!  (=> (or (|_module.__default.SMN#canCall| |xs#0@@8| |n#0@@1| (LitInt |len#0@@1|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |xs#0@@8| (Tclass._module.List Tclass._System.nat)) (<= (LitInt 0) |n#0@@1|)) (<= (LitInt 0) |len#0@@1|)) (= (LitInt |len#0@@1|) (_module.__default.Length Tclass._System.nat ($LS $LZ) |xs#0@@8|))))) (and (=> (<= (LitInt 2) (LitInt |len#0@@1|)) (and (|_module.__default.Split#canCall| |xs#0@@8| (+ |n#0@@1| (Div |len#0@@1| (LitInt 2)))) (let ((|R#1| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@8| (+ |n#0@@1| (Div |len#0@@1| (LitInt 2))))))))
(let ((|L#1| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@8| (+ |n#0@@1| (Div |len#0@@1| (LitInt 2))))))))
 ...
 (and (=> (< |llen#1| (Div |len#0@@1| (LitInt 2))) (|_module.__default.SMN#canCall| |L#1| |n#0@@1| |llen#1|)) (=> (<= (Div |len#0@@1| (LitInt 2)) |llen#1|) (|_module.__default.SMN#canCall| |R#1| (+ |n#0@@1| |llen#1|) (- |len#0@@1| |llen#1|)))))))))) (= (_module.__default.SMN ($LS $ly@@7) |xs#0@@8| |n#0@@1| (LitInt |len#0@@1|)) (ite (<= (LitInt 2) (LitInt |len#0@@1|)) (let ((|R#1@@0| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@8| (+ |n#0@@1| (Div |len#0@@1| (LitInt 2))))))))
(let ((|L#1@@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@8| (+ |n#0@@1| (Div |len#0@@1| (LitInt 2))))))))
(let ((|llen#1@@0| (_module.__default.Length Tclass._System.nat ($LS $LZ) |L#1@@0|)))
(ite (< |llen#1@@0| (Div |len#0@@1| (LitInt 2))) (_module.__default.SMN ($LS $ly@@7) |L#1@@0| |n#0@@1| |llen#1@@0|) (_module.__default.SMN ($LS $ly@@7) |R#1@@0| (+ |n#0@@1| |llen#1@@0|) (- |len#0@@1| |llen#1@@0|)))))) (ite (_module.List.Cons_q |xs#0@@8|) (ite (= (U_2_int ($Unbox intType (_module.List.head |xs#0@@8|))) |n#0@@1|) (+ |n#0@@1| 1) |n#0@@1|) |n#0@@1|)))))
 :qid |SmallestMissingNumberfunctionaldfy.38:10|
 :weight 3
 :skolemid |605|
 :pattern ( (_module.__default.SMN ($LS $ly@@7) |xs#0@@8| |n#0@@1| (LitInt |len#0@@1|)))
))))
(assert (forall (($ly@@8 T@U) (|xs#0@@9| T@U) (|n#0@@2| Int) (|len#0@@2| Int) ) (! (= (_module.__default.SMN ($LS $ly@@8) |xs#0@@9| |n#0@@2| |len#0@@2|) (_module.__default.SMN $ly@@8 |xs#0@@9| |n#0@@2| |len#0@@2|))
 :qid |SmallestMissingNumberfunctionaldfy.38:10|
 :skolemid |600|
 :pattern ( (_module.__default.SMN ($LS $ly@@8) |xs#0@@9| |n#0@@2| |len#0@@2|))
)))
(assert (forall (($ly@@9 T@U) ($reveal@@0 Bool) (|xs#0@@10| T@U) (|b#0@@2| Int) ) (! (= (_module.__default.Split ($LS $ly@@9) $reveal@@0 |xs#0@@10| |b#0@@2|) (_module.__default.Split $ly@@9 $reveal@@0 |xs#0@@10| |b#0@@2|))
 :qid |SmallestMissingNumberfunctionaldfy.93:17|
 :skolemid |636|
 :pattern ( (_module.__default.Split ($LS $ly@@9) $reveal@@0 |xs#0@@10| |b#0@@2|))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|xs#0@@11| T@U) ) (!  (=> (or (|_module.__default.SmallestMissingNumber#canCall| |xs#0@@11|) (and (< 4 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@11| (Tclass._module.List Tclass._System.nat)))) (and (and (|_module.__default.Length#canCall| Tclass._System.nat |xs#0@@11|) (|_module.__default.SMN#canCall| |xs#0@@11| (LitInt 0) (_module.__default.Length Tclass._System.nat ($LS $LZ) |xs#0@@11|))) (= (_module.__default.SmallestMissingNumber |xs#0@@11|) (_module.__default.SMN ($LS $LZ) |xs#0@@11| (LitInt 0) (_module.__default.Length Tclass._System.nat ($LS $LZ) |xs#0@@11|)))))
 :qid |SmallestMissingNumberfunctionaldfy.33:32|
 :skolemid |596|
 :pattern ( (_module.__default.SmallestMissingNumber |xs#0@@11|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|xs#0@@12| T@U) ) (!  (=> (or (|_module.__default.SmallestMissingNumber#canCall| (Lit DatatypeTypeType |xs#0@@12|)) (and (< 4 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@12| (Tclass._module.List Tclass._System.nat)))) (and (and (|_module.__default.Length#canCall| Tclass._System.nat (Lit DatatypeTypeType |xs#0@@12|)) (|_module.__default.SMN#canCall| (Lit DatatypeTypeType |xs#0@@12|) (LitInt 0) (LitInt (_module.__default.Length Tclass._System.nat ($LS $LZ) (Lit DatatypeTypeType |xs#0@@12|))))) (= (_module.__default.SmallestMissingNumber (Lit DatatypeTypeType |xs#0@@12|)) (LitInt (_module.__default.SMN ($LS $LZ) (Lit DatatypeTypeType |xs#0@@12|) (LitInt 0) (LitInt (_module.__default.Length Tclass._System.nat ($LS $LZ) (Lit DatatypeTypeType |xs#0@@12|))))))))
 :qid |SmallestMissingNumberfunctionaldfy.33:32|
 :weight 3
 :skolemid |597|
 :pattern ( (_module.__default.SmallestMissingNumber (Lit DatatypeTypeType |xs#0@@12|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.Length$_T0@@2 T@U) ($ly@@10 T@U) (|xs#0@@13| T@U) ) (!  (=> (or (|_module.__default.Length#canCall| _module._default.Length$_T0@@2 |xs#0@@13|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@13| (Tclass._module.List _module._default.Length$_T0@@2)))) (<= (LitInt 0) (_module.__default.Length _module._default.Length$_T0@@2 $ly@@10 |xs#0@@13|)))
 :qid |unknown.0:0|
 :skolemid |589|
 :pattern ( (_module.__default.Length _module._default.Length$_T0@@2 $ly@@10 |xs#0@@13|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@11 T@U) (|xs#0@@14| T@U) (|n#0@@3| Int) (|len#0@@3| Int) ) (!  (=> (or (|_module.__default.SMN#canCall| |xs#0@@14| |n#0@@3| |len#0@@3|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |xs#0@@14| (Tclass._module.List Tclass._System.nat)) (<= (LitInt 0) |n#0@@3|)) (<= (LitInt 0) |len#0@@3|)) (= |len#0@@3| (_module.__default.Length Tclass._System.nat ($LS $LZ) |xs#0@@14|))))) (and (=> (<= (LitInt 2) |len#0@@3|) (and (|_module.__default.Split#canCall| |xs#0@@14| (+ |n#0@@3| (Div |len#0@@3| (LitInt 2)))) (let ((|R#0@@0| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@14| (+ |n#0@@3| (Div |len#0@@3| (LitInt 2))))))))
(let ((|L#0@@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@14| (+ |n#0@@3| (Div |len#0@@3| (LitInt 2))))))))
 ...
 (and (=> (< |llen#0| (Div |len#0@@3| (LitInt 2))) (|_module.__default.SMN#canCall| |L#0@@0| |n#0@@3| |llen#0|)) (=> (<= (Div |len#0@@3| (LitInt 2)) |llen#0|) (|_module.__default.SMN#canCall| |R#0@@0| (+ |n#0@@3| |llen#0|) (- |len#0@@3| |llen#0|)))))))))) (= (_module.__default.SMN ($LS $ly@@11) |xs#0@@14| |n#0@@3| |len#0@@3|) (ite (<= (LitInt 2) |len#0@@3|) (let ((|R#0@@1| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@14| (+ |n#0@@3| (Div |len#0@@3| (LitInt 2))))))))
(let ((|L#0@@1| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@14| (+ |n#0@@3| (Div |len#0@@3| (LitInt 2))))))))
(let ((|llen#0@@0| (_module.__default.Length Tclass._System.nat ($LS $LZ) |L#0@@1|)))
(ite (< |llen#0@@0| (Div |len#0@@3| (LitInt 2))) (_module.__default.SMN $ly@@11 |L#0@@1| |n#0@@3| |llen#0@@0|) (_module.__default.SMN $ly@@11 |R#0@@1| (+ |n#0@@3| |llen#0@@0|) (- |len#0@@3| |llen#0@@0|)))))) (ite (_module.List.Cons_q |xs#0@@14|) (ite (= (U_2_int ($Unbox intType (_module.List.head |xs#0@@14|))) |n#0@@3|) (+ |n#0@@3| 1) |n#0@@3|) |n#0@@3|)))))
 :qid |SmallestMissingNumberfunctionaldfy.38:10|
 :skolemid |604|
 :pattern ( (_module.__default.SMN ($LS $ly@@11) |xs#0@@14| |n#0@@3| |len#0@@3|))
))))
(push 1)
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.SmallestMissingNumber)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct  (=> ($IsAlloc DatatypeTypeType |xs#0@@15| (Tclass._module.List Tclass._System.nat) $Heap) (and (=> (= (ControlFlow 0 3) (- 0 4)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (= |##n#0@0| (LitInt 0)) (=> (and ($IsAlloc intType (int_2_U |##n#0@0|) Tclass._System.nat $Heap) ($IsAlloc DatatypeTypeType |xs#0@@15| (Tclass._module.List Tclass._System.nat) $Heap)) (=> (and (and (|_module.__default.Length#canCall| Tclass._System.nat |xs#0@@15|) (= |##len#0@0| (_module.__default.Length Tclass._System.nat ($LS $LZ) |xs#0@@15|))) (and ($IsAlloc intType (int_2_U |##len#0@0|) Tclass._System.nat $Heap) (= (ControlFlow 0 3) (- 0 2)))) (= |##len#0@0| (_module.__default.Length Tclass._System.nat ($LS ($LS $LZ)) |xs#0@@15|))))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |xs#0@@15| (Tclass._module.List Tclass._System.nat))) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 6) 5))) anon0_correct)))
