...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split97)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon79_correct  (=> (not (and (<= |k#0@0| (- |l#0@4| 1)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1))))))))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField |n#0@3|))))))) (=> (and (or (not (= $nw@0 null)) (not true)) (= (ControlFlow 0 2) (- 0 1))) (and (<= 0 |l#0@4|) (< |l#0@4| (_System.array.Length $nw@0)))))))
(let ((anon131_Else_correct  (=> (and (< (- |l#0@4| 1) |k#0@0|) (= (ControlFlow 0 4) 2)) anon79_correct)))
(let ((anon131_Then_correct  (=> (<= |k#0@0| (- |l#0@4| 1)) (=> (and (and (or (not (= |a#0@@4| null)) (not true)) (or (not (= $nw@0 null)) (not true))) (and (<= 0 (- |l#0@4| 1)) (< (- |l#0@4| 1) (_System.array.Length $nw@0)))) (=> (and (and (and (<= 0 (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1)))))) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1))))) (_System.array.Length |a#0@@4|))) (or (not (= |a#0@@4| null)) (not true))) (and (and (<= 0 |n#0@3|) (< |n#0@3| (_System.array.Length |a#0@@4|))) (= (ControlFlow 0 3) 2))) anon79_correct)))))
