...
(set-info :boogie-vc-id Impl$$SnapTree.Iterator.Push_split9)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap@@7) ($IsHeapAnchor $Heap@@7)) (=> (and (and (and (and (and (and (and ($Is DatatypeTypeType |stIn#0| Tclass.SnapTree.List) ($IsAlloc DatatypeTypeType |stIn#0| Tclass.SnapTree.List $Heap@@7)) (|$IsA#SnapTree.List| |stIn#0|)) (and ($Is refType |p#0@@0| Tclass.SnapTree.Node) ($IsAlloc refType |p#0@@0| Tclass.SnapTree.Node $Heap@@7))) (and (and ($Is SeqType |C#0@@1| (TSeq TInt)) ($IsAlloc SeqType |C#0@@1| (TSeq TInt) $Heap@@7)) (and ($Is SetType |Nodes#0@@1| (TSet Tclass._System.object)) ($IsAlloc SetType |Nodes#0@@1| (TSet Tclass._System.object) $Heap@@7)))) (and (and (and ($Is DatatypeTypeType |st#0| Tclass.SnapTree.List) ($IsAlloc DatatypeTypeType |st#0| Tclass.SnapTree.List $Heap@@7)) (and (= 5 $FunctionContextHeight) (|Set#IsMember| |Nodes#0@@1| ($Box refType |p#0@@0|)))) (and (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#0@@0|) SnapTree.Node.Repr)) |Nodes#0@@1|) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@@7 |p#0@@0|)) (and (<= (LitInt 0) |n#0@@1|) (<= |n#0@@1| (|Seq#Length| |C#0@@1|)))))) (and (and (and (and (<= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#0@@0|) SnapTree.Node.Contents))) (|Seq#Length| (|Seq#Drop| |C#0@@1| |n#0@@1|))) (|Seq#SameUntil| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#0@@0|) SnapTree.Node.Contents)) (|Seq#Drop| |C#0@@1| |n#0@@1|) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#0@@0|) SnapTree.Node.Contents))))) (SnapTree.Iterator.R ($LS ($LS $LZ)) reveal_SnapTree.Iterator.R $Heap@@7 |stIn#0| (+ |n#0@@1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#0@@0|) SnapTree.Node.Contents)))) |C#0@@1| |Nodes#0@@1|)) (and (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@7 alloc false)) (= |st#0@0| (|#SnapTree.List.Cons| |p#0@@0| |stIn#0|)))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@7 $Heap@0) reveal_SnapTree.Iterator.R)))) (and (and (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1)) (and reveal_SnapTree.Node.NodeValid (or (not (= |p#0@@0| null)) (not true)))) (and (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |p#0@@0|) SnapTree.Node.left)) null)) (not true)) (or (not (= |p#0@@0| null)) (not true))) (and ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |p#0@@0|) SnapTree.Node.left)) Tclass.SnapTree.Node) (= |p##0_0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |p#0@@0|) SnapTree.Node.left)))))) (and (and (and (or (<= 0 (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#0@@0|) SnapTree.Node.Contents)))) (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |p##0_0@0|) SnapTree.Node.Contents))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#0@@0|) SnapTree.Node.Contents))))) (< (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |p##0_0@0|) SnapTree.Node.Contents))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#0@@0|) SnapTree.Node.Contents))))) (and ($Is DatatypeTypeType |call6formal@st#0| Tclass.SnapTree.List) ($IsAlloc DatatypeTypeType |call6formal@st#0| Tclass.SnapTree.List $Heap@@7))) (and (and (|Set#IsMember| |Nodes#0@@1| ($Box refType |p##0_0@0|)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |p##0_0@0|) SnapTree.Node.Repr)) |Nodes#0@@1|)) (and (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@1 |p##0_0@0|) (= (ControlFlow 0 2) (- 0 1))))))) (<= (LitInt 0) |n#0@@1|)))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
