...
(declare-fun $Heap@@0 () T@U)
(declare-fun |s#0| () Int)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.SmallestMissing__Loop)
...
(let ((anon9_correct  (=> (and (and (<= (LitInt 0) |x#0@0|) (< |x#0@0| |s#0@0|)) ($IsAlloc refType |a#0@@1| (Tclass._System.array Tclass._System.nat) $Heap@0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) ($Is intType (int_2_U |x#0@0|) Tclass._System.nat)) (=> ($Is intType (int_2_U |x#0@0|) Tclass._System.nat) (=> (and (and ($IsAlloc intType (int_2_U |x#0@0|) Tclass._System.nat $Heap@0) (|_module.__default.Has#canCall| Tclass._System.nat $Heap@0 |a#0@@1| ($Box intType (int_2_U |x#0@0|)))) (and (_module.__default.Has Tclass._System.nat $Heap@0 |a#0@@1| ($Box intType (int_2_U |x#0@0|))) (= (ControlFlow 0 3) 1))) anon11_correct))))))
(let ((anon15_Else_correct  (=> (and (< |x#0@0| (LitInt 0)) (= (ControlFlow 0 6) 3)) anon9_correct)))
(let ((anon15_Then_correct  (=> (and (<= (LitInt 0) |x#0@0|) (= (ControlFlow 0 5) 3)) anon9_correct)))
(let ((anon14_Else_correct  (=> (and (=> (and (<= (LitInt 0) |x#0@0|) (< |x#0@0| |s#0@0|)) (_module.__default.Has Tclass._System.nat $Heap@0 |a#0@@1| ($Box intType (int_2_U |x#0@0|)))) (= (ControlFlow 0 2) 1)) anon11_correct)))
(let ((anon6_correct  (=> (forall ((|i#1| Int) ) (!  (=> (and (<= (LitInt 0) |i#1|) (< |i#1| (_System.array.Length |a#0@@1|))) (or (not (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0@@1|) (IndexField |i#1|)))) |s#0@0|)) (not true)))
 :qid |SmallestMissingNumberimperativedfy.83:18|
 :skolemid |583|
...
)) (and (and (=> (= (ControlFlow 0 7) 2) anon14_Else_correct) (=> (= (ControlFlow 0 7) 5) anon15_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon15_Else_correct)))))
(let ((anon4_correct  (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (_System.array.Length |a#0@@1|))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (or (not (= |a#0@@1| null)) (not true))) (=> (or (not (= |a#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array.Length |a#0@@1|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array.Length |a#0@@1|))) (=> (and (or (not (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0@@1|) (IndexField |i#0@0|)))) |s#0@0|)) (not true)) (= (ControlFlow 0 9) 7)) anon6_correct))))))))
(let ((anon13_Else_correct  (=> (and (< |i#0@0| (LitInt 0)) (= (ControlFlow 0 14) 9)) anon4_correct)))
(let ((anon13_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 12) (- 0 13)) (or (not (= |a#0@@1| null)) (not true))) (=> (or (not (= |a#0@@1| null)) (not true)) (=> (= (ControlFlow 0 12) 9) anon4_correct))))))
(let ((anon12_Else_correct  (=> (and (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (_System.array.Length |a#0@@1|))) (or (not (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0@@1|) (IndexField |i#0@0|)))) |s#0@0|)) (not true))) (= (ControlFlow 0 8) 7)) anon6_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@7 T@U) ) (!  (=> (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@7) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@7)))
 :qid |SmallestMissingNumberimperativedfy.82:8|
 :skolemid |582|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7))
))) (and ($HeapSucc $Heap@@0 $Heap@0) (<= (LitInt 0) |s#0@0|))) (and (and (=> (= (ControlFlow 0 15) 8) anon12_Else_correct) (=> (= (ControlFlow 0 15) 12) anon13_Then_correct)) (=> (= (ControlFlow 0 15) 14) anon13_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and ($Is refType |a#0@@1| (Tclass._System.array Tclass._System.nat)) ($IsAlloc refType |a#0@@1| (Tclass._System.array Tclass._System.nat) $Heap@@0)) (<= (LitInt 0) |s#0|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 16) 15))) anon0_correct))))
