...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.MinimumWindowMax_split0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_correct  (=> (and (<= (LitInt 0) |start#0@0|) (<= |start#0@0| (- (_System.array.Length |a#0|) |W#0|))) (=> (and (and ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap@0) ($IsAlloc intType (int_2_U |start#0@0|) TInt $Heap@0)) (and ($IsAlloc intType (int_2_U |W#0|) TInt $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (<= (LitInt 0) |start#0@0|)))))
