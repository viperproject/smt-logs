...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap))) (=> (and (and (and (and (and ($Is refType |b#0| (Tclass._System.array TInt)) ($IsAlloc refType |b#0| (Tclass._System.array TInt) $Heap)) true) (and (= 3 $FunctionContextHeight) (<= (LitInt 1) |W#0|))) (and (and (<= |W#0| (_System.array.Length |a#0|)) (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false))) (and (or (not (= |a#0| null)) (not true)) (<= 0 (_System.array.Length |a#0|))))) (and (and (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? TInt))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc))))) (and (= (_System.array.Length $nw@0) (_System.array.Length |a#0|)) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true))))))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (or (not (= $nw@0 null)) (not true)) (= (ControlFlow 0 2) (- 0 1)))))) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length $nw@0)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
