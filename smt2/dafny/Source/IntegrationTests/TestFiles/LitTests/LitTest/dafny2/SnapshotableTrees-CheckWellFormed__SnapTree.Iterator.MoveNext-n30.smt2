...
(set-info :boogie-vc-id CheckWellFormed$$SnapTree.Iterator.MoveNext_split9)
...
))) (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@9) SnapTree.Iterator.T)) null)) (not true)) ($IsAlloc refType this@@9 Tclass.SnapTree.Iterator $Heap@@11)))) (and (and (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@9) SnapTree.Iterator.T)) null)) (not true)) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@9) SnapTree.Iterator.T)) Tclass.SnapTree.Tree? $Heap@@11)) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@9) SnapTree.Iterator.T))) SnapTree.Tree.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@9) SnapTree.Iterator.T))) SnapTree.Tree.Repr))) ($IsAlloc refType this@@9 Tclass.SnapTree.Iterator $Heap@@11))) (and (and (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@9) SnapTree.Iterator.Contents)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@9) SnapTree.Iterator.Contents))) ($IsAlloc refType this@@9 Tclass.SnapTree.Iterator $Heap@@11)) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@9) SnapTree.Iterator.T)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@9) SnapTree.Iterator.T))) (= (ControlFlow 0 2) (- 0 1)))))) ($IsAlloc refType this@@9 Tclass.SnapTree.Iterator $Heap@@11)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
