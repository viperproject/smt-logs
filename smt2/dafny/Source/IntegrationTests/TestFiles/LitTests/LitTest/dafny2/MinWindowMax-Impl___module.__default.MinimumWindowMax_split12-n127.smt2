...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split128)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon90_correct  (=> (= |n#0@4| (+ |n#0@3| 1)) (=> (and ($Is intType (int_2_U |W#0|) Tclass._System.nat) (<= (LitInt 0) |k#0@2|)) (=> (and (and (and (<= |k#0@2| |$rhs#1_1@1|) (<= |$rhs#1_1@1| (_System.array.Length $nw@0))) (and (forall ((|i#1@@1| Int) ) (!  (and (=> (and (<= |k#0@2| |i#1@@1|) (< |i#1@@1| |$rhs#1_1@1|)) (<= (- |n#0@4| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $nw@0) (IndexField |i#1@@1|)))))) (=> (and (<= |k#0@2| |i#1@@1|) (< |i#1@@1| |$rhs#1_1@1|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $nw@0) (IndexField |i#1@@1|)))) |n#0@4|)))
...
)))) (and (and ($IsGoodHeap $Heap@8) ($IsHeapAnchor $Heap@8)) (<= (- |$rhs#1_1@1| |k#0@2|) |W#0|))) (=> (and (and (and (and (= $Heap@7 $Heap@8) (or (<= 0 |$decr$loop#10@1|) (= (- (_System.array.Length |a#0@@4|) |n#0@4|) |$decr$loop#10@1|))) (and (< (- (_System.array.Length |a#0@@4|) |n#0@4|) |$decr$loop#10@1|) (=> (and (and (and (<= (LitInt 0) |k#0@2|) (< |k#0@2| |$rhs#1_1@1|)) (<= |$rhs#1_1@1| |n#0@4|)) (<= |n#0@4| (_System.array.Length |a#0@@4|))) (and (|_module.__default.StrictlyIncreasing#canCall| $Heap@8 $nw@0 |k#0@2| |$rhs#1_1@1| (- |n#0@4| |W#0|) |n#0@4|) (=> (_module.__default.StrictlyIncreasing $Heap@8 $nw@0 |k#0@2| |$rhs#1_1@1| (- |n#0@4| |W#0|) |n#0@4|) (and (|_module.__default.RightmostMax#canCall| $Heap@8 |a#0@@4| (- |n#0@4| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |k#0@2|)))) |n#0@4|) (=> (_module.__default.RightmostMax $Heap@8 |a#0@@4| (- |n#0@4| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |k#0@2|)))) |n#0@4|) (and (forall ((|u#3| Int) (|_t#0#1| Int) ) (!  (=> (= |_t#0#1| (- |u#3| 1)) (=> (< |k#0@2| |u#3|) (=> (< |u#3| |$rhs#1_1@1|) (|_module.__default.RightmostMax#canCall| $Heap@8 |a#0@@4| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |_t#0#1|)))) 1) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |u#3|)))) |n#0@4|))))
...
))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#1@0|))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField (- |$rhs#1_1@1| 1))))) (- |n#0@4| 1))))))))
...
)))) (and (=> |$w$loop#1@0| (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@3| 1))))) (- |n#0@3| 1))) (=> |$w$loop#1@0| (<= (LitInt 0) |start#0@1|)))) (and (and (=> |$w$loop#1@0| (<= |start#0@1| (- (_System.array.Length |a#0@@4|) |W#0|))) (=> |$w$loop#1@0| (|_module.__default.Max#canCall| $Heap@5 |a#0@@4| |start#0@1| |W#0|))) (and (=> |$w$loop#1@0| (= |m#0@1| (_module.__default.Max ($LS ($LS $LZ)) $Heap@5 |a#0@@4| |start#0@1| |W#0|))) (=> |$w$loop#1@0| (forall ((|s#3@@1| Int) ) (!  (=> (and (<= (LitInt 0) |s#3@@1|) (<= |s#3@@1| (- |n#0@3| |W#0|))) (|_module.__default.Max#canCall| $Heap@5 |a#0@@4| |s#3@@1| |W#0|))
 :qid |MinWindowMaxdfy.70:22|
 :skolemid |705|
 :pattern ( (_module.__default.Max ($LS $LZ) $Heap@5 |a#0@@4| |s#3@@1| |W#0|))
))))))) (and (and (and (and (=> |$w$loop#1@0| (forall ((|s#3@@2| Int) ) (!  (=> (and (<= (LitInt 0) |s#3@@2|) (<= |s#3@@2| (- |n#0@3| |W#0|))) (<= |m#0@1| (_module.__default.Max ($LS ($LS $LZ)) $Heap@5 |a#0@@4| |s#3@@2| |W#0|)))
 :qid |MinWindowMaxdfy.70:22|
 :skolemid |706|
 :pattern ( (_module.__default.Max ($LS ($LS $LZ)) $Heap@5 |a#0@@4| |s#3@@2| |W#0|))
))) (=> |$w$loop#1@0| (forall ((|s#3@@3| Int) ) (!  (=> (and (<= (LitInt 0) |s#3@@3|) (<= |s#3@@3| (- |n#0@3| |W#0|))) (<= |m#0@1| (_module.__default.Max ($LS $LZ) $Heap@5 |a#0@@4| |s#3@@3| |W#0|)))
 :qid |MinWindowMaxdfy.70:22|
 :skolemid |707|
 :pattern ( (_module.__default.Max ($LS $LZ) $Heap@5 |a#0@@4| |s#3@@3| |W#0|))
