...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split98)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon79_correct  (=> (and (not (and (<= |k#0@0| (- |l#0@4| 1)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1))))))))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField |n#0@3|))))))) (or (not (= $nw@0 null)) (not true))) (=> (and (and (<= 0 |l#0@4|) (< |l#0@4| (_System.array.Length $nw@0))) (and (= $index0@3 (IndexField |l#0@4|)) (= (ControlFlow 0 2) (- 0 1)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 $index0@3))))))
