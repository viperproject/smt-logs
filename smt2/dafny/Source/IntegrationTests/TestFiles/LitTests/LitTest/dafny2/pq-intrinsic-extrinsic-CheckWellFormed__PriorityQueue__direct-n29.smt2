...
(set-info :boogie-vc-id CheckWellFormed$$PriorityQueue__direct.__default.AboutMin)
...
(let ((anon5_Else_correct  (=> (and (=> (> (|MultiSet#Multiplicity| (PriorityQueue__direct.__default.Elements ($LS $LZ) |t#0@@8|) ($Box intType (int_2_U |x#0@0|))) 0) (<= (PriorityQueue__direct.T_k.val |t#0@@8|) |x#0@0|)) (= (ControlFlow 0 4) 1)) anon4_correct)))
(let ((anon5_Then_correct  (=> ($IsAlloc DatatypeTypeType |t#0@@8| Tclass.PriorityQueue__direct.T $Heap@0) (=> (and (|PriorityQueue__direct.__default.Elements#canCall| |t#0@@8|) (> (|MultiSet#Multiplicity| (PriorityQueue__direct.__default.Elements ($LS $LZ) |t#0@@8|) ($Box intType (int_2_U |x#0@0|))) 0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (PriorityQueue__direct.T_k.Node_q |t#0@@8|)) (=> (PriorityQueue__direct.T_k.Node_q |t#0@@8|) (=> (and (<= (PriorityQueue__direct.T_k.val |t#0@@8|) |x#0@0|) (= (ControlFlow 0 2) 1)) anon4_correct)))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (not (|PriorityQueue__direct.T_k#Equal| |t#0@@8| |#PriorityQueue_direct.T'.Leaf|))) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (PriorityQueue__direct.T_k.Node_q |t#0@@8|)) (=> (PriorityQueue__direct.T_k.Node_q |t#0@@8|) (=> ($IsAlloc DatatypeTypeType |t#0@@8| Tclass.PriorityQueue__direct.T $Heap@0) (=> (and (|PriorityQueue__direct.__default.Elements#canCall| |t#0@@8|) (> (|MultiSet#Multiplicity| (PriorityQueue__direct.__default.Elements ($LS $LZ) |t#0@@8|) ($Box intType (int_2_U (PriorityQueue__direct.T_k.val |t#0@@8|)))) 0)) (and (=> (= (ControlFlow 0 5) 2) anon5_Then_correct) (=> (= (ControlFlow 0 5) 4) anon5_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |t#0@@8| Tclass.PriorityQueue__direct.T) ($IsAlloc DatatypeTypeType |t#0@@8| Tclass.PriorityQueue__direct.T $Heap)) (|$IsA#PriorityQueue__direct.T_k| |t#0@@8|)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 7) 5))) anon0_correct))))
