...
(set-info :boogie-vc-id CheckWellFormed$$SnapTree.Iterator.MoveNext_split1)
...
))) (= (ControlFlow 0 2) (- 0 1))))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@9) SnapTree.Iterator.T)) null)) (not true)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
