...
(assert (forall (($h0@@1 T@U) ($h1@@1 T@U) (|a#0@@3| T@U) (|lo#0@@2| Int) (|x#0@@0| Int) (|hi#0@@2| Int) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@1) ($IsGoodHeap $h1@@1)) (or (|_module.__default.RightmostMax#canCall| $h0@@1 |a#0@@3| |lo#0@@2| |x#0@@0| |hi#0@@2|) ($Is refType |a#0@@3| (Tclass._System.array TInt)))) (and ($IsHeapAnchor $h0@@1) ($HeapSucc $h0@@1 $h1@@1))) (=> (forall (($o@@8 T@U) ($f@@2 T@U) ) (!  (=> (and (or (not (= $o@@8 null)) (not true)) (= $o@@8 |a#0@@3|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@1 $o@@8) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@1 $o@@8) $f@@2)))
 :qid |unknown.0:0|
 :skolemid |746|
)) (= (_module.__default.RightmostMax $h0@@1 |a#0@@3| |lo#0@@2| |x#0@@0| |hi#0@@2|) (_module.__default.RightmostMax $h1@@1 |a#0@@3| |lo#0@@2| |x#0@@0| |hi#0@@2|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |747|
...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split179)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon121_Then_correct  (=> (and (<= (LitInt 0) |s#2@0|) (<= |s#2@0| (- |n#0@3| |W#0|))) (=> (and (and ($IsAlloc refType |a#0@@4| (Tclass._System.array TInt) $Heap@5) ($IsAlloc intType (int_2_U |s#2@0|) TInt $Heap@5)) (and ($IsAlloc intType (int_2_U |W#0|) TInt $Heap@5) (= (ControlFlow 0 2) (- 0 1)))) (<= (+ |s#2@0| |W#0|) (_System.array.Length |a#0@@4|))))))
(let ((anon120_Else_correct  (=> (and (< |s#2@0| (LitInt 0)) (= (ControlFlow 0 4) 2)) anon121_Then_correct)))
(let ((anon120_Then_correct  (=> (and (<= (LitInt 0) |s#2@0|) (= (ControlFlow 0 3) 2)) anon121_Then_correct)))
(let ((anon53_correct  (=> (and (and (and (<= (LitInt 0) |start#0@1|) (<= |start#0@1| (- (_System.array.Length |a#0@@4|) |W#0|))) (and ($IsAlloc refType |a#0@@4| (Tclass._System.array TInt) $Heap@5) ($IsAlloc intType (int_2_U |start#0@1|) TInt $Heap@5))) (and (and ($IsAlloc intType (int_2_U |W#0|) TInt $Heap@5) (|_module.__default.Max#canCall| $Heap@5 |a#0@@4| |start#0@1| |W#0|)) (and (|_module.__default.Max#canCall| $Heap@5 |a#0@@4| |start#0@1| |W#0|) (= |m#0@1| (_module.__default.Max ($LS $LZ) $Heap@5 |a#0@@4| |start#0@1| |W#0|))))) (and (=> (= (ControlFlow 0 5) 3) anon120_Then_correct) (=> (= (ControlFlow 0 5) 4) anon120_Else_correct)))))
(let ((anon118_Else_correct  (=> (and (< |start#0@1| (LitInt 0)) (= (ControlFlow 0 7) 5)) anon53_correct)))
(let ((anon118_Then_correct  (=> (and (<= (LitInt 0) |start#0@1|) (= (ControlFlow 0 6) 5)) anon53_correct)))
(let ((anon51_correct  (=> (and (and (forall ((|u#3| Int) (|_t#0#1| Int) ) (!  (=> (= |_t#0#1| (- |u#3| 1)) (=> (< |k#0@0| |u#3|) (=> (< |u#3| |l#0@3|) (|_module.__default.RightmostMax#canCall| $Heap@5 |a#0@@4| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |_t#0#1|)))) 1) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |u#3|)))) |n#0@3|))))
 :qid |MinWindowMaxdfy.65:22|
 :skolemid |698|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |u#3|))) ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |_t#0#1|))))
)) (forall ((|u#3@@0| Int) (|_t#0#1@@0| Int) ) (!  (=> (= |_t#0#1@@0| (- |u#3@@0| 1)) (=> (and (< |k#0@0| |u#3@@0|) (< |u#3@@0| |l#0@3|)) (_module.__default.RightmostMax $Heap@5 |a#0@@4| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |_t#0#1@@0|)))) 1) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |u#3@@0|)))) |n#0@3|)))
 :qid |MinWindowMaxdfy.65:22|
 :skolemid |699|
...
))) (and (or (not (= $nw@0 null)) (not true)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@3| 1))))) (- |n#0@3| 1)))) (and (=> (= (ControlFlow 0 8) 6) anon118_Then_correct) (=> (= (ControlFlow 0 8) 7) anon118_Else_correct)))))
(let ((anon117_Else_correct  (=> (and (not (and (< |k#0@0| |u#2@0|) (< |u#2@0| |l#0@3|))) (= (ControlFlow 0 10) 8)) anon51_correct)))
(let ((anon117_Then_correct  (=> (and (and (< |k#0@0| |u#2@0|) (< |u#2@0| |l#0@3|)) (and ($IsAlloc refType |a#0@@4| (Tclass._System.array TInt) $Heap@5) (or (not (= $nw@0 null)) (not true)))) (=> (and (and (and (= |##lo#5@0| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |u#2@0| 1))))) 1)) ($IsAlloc intType (int_2_U |##lo#5@0|) TInt $Heap@5)) (and (or (not (= $nw@0 null)) (not true)) (= |##x#3@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |u#2@0|))))))) (and (and ($IsAlloc intType (int_2_U |##x#3@0|) TInt $Heap@5) ($IsAlloc intType (int_2_U |n#0@3|) TInt $Heap@5)) (and (|_module.__default.RightmostMax#canCall| $Heap@5 |a#0@@4| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |u#2@0| 1))))) 1) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |u#2@0|)))) |n#0@3|) (= (ControlFlow 0 9) 8)))) anon51_correct))))
(let ((anon116_Else_correct  (=> (<= |u#2@0| |k#0@0|) (and (=> (= (ControlFlow 0 12) 9) anon117_Then_correct) (=> (= (ControlFlow 0 12) 10) anon117_Else_correct)))))
(let ((anon116_Then_correct  (=> (< |k#0@0| |u#2@0|) (and (=> (= (ControlFlow 0 11) 9) anon117_Then_correct) (=> (= (ControlFlow 0 11) 10) anon117_Else_correct)))))
(let ((anon46_correct  (=> (and (and (and (and (and (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| |l#0@3|)) (<= |l#0@3| |n#0@3|)) (<= |n#0@3| (_System.array.Length |a#0@@4|))) ($IsAlloc refType $nw@0 (Tclass._System.array TInt) $Heap@5)) (and ($IsAlloc intType (int_2_U |k#0@0|) TInt $Heap@5) ($IsAlloc intType (int_2_U |l#0@3|) TInt $Heap@5))) (and (and (and (and (= |##lo#3@0| (- |n#0@3| |W#0|)) ($IsAlloc intType (int_2_U |##lo#3@0|) TInt $Heap@5)) (and ($IsAlloc intType (int_2_U |n#0@3|) TInt $Heap@5) (|_module.__default.StrictlyIncreasing#canCall| $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|))) (and (and (|_module.__default.StrictlyIncreasing#canCall| $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|) (_module.__default.StrictlyIncreasing $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|)) (and ($IsAlloc refType |a#0@@4| (Tclass._System.array TInt) $Heap@5) (= |##lo#4@0| (- |n#0@3| |W#0|))))) (and (and (and ($IsAlloc intType (int_2_U |##lo#4@0|) TInt $Heap@5) (or (not (= $nw@0 null)) (not true))) (and (= |##x#2@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|))))) ($IsAlloc intType (int_2_U |##x#2@0|) TInt $Heap@5))) (and (and ($IsAlloc intType (int_2_U |n#0@3|) TInt $Heap@5) (|_module.__default.RightmostMax#canCall| $Heap@5 |a#0@@4| (- |n#0@3| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|)))) |n#0@3|)) (and (|_module.__default.RightmostMax#canCall| $Heap@5 |a#0@@4| (- |n#0@3| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|)))) |n#0@3|) (_module.__default.RightmostMax $Heap@5 |a#0@@4| (- |n#0@3| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|)))) |n#0@3|)))))) (and (=> (= (ControlFlow 0 13) 11) anon116_Then_correct) (=> (= (ControlFlow 0 13) 12) anon116_Else_correct)))))
(let ((anon114_Else_correct  (=> (and (not (and (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| |l#0@3|)) (<= |l#0@3| |n#0@3|))) (= (ControlFlow 0 15) 13)) anon46_correct)))
(let ((anon114_Then_correct  (=> (and (and (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| |l#0@3|)) (<= |l#0@3| |n#0@3|)) (= (ControlFlow 0 14) 13)) anon46_correct)))
(let ((anon113_Else_correct  (=> (not (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| |l#0@3|))) (and (=> (= (ControlFlow 0 17) 14) anon114_Then_correct) (=> (= (ControlFlow 0 17) 15) anon114_Else_correct)))))
(let ((anon113_Then_correct  (=> (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| |l#0@3|)) (and (=> (= (ControlFlow 0 16) 14) anon114_Then_correct) (=> (= (ControlFlow 0 16) 15) anon114_Else_correct)))))
(let ((anon112_Else_correct  (=> (< |k#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 19) 16) anon113_Then_correct) (=> (= (ControlFlow 0 19) 17) anon113_Else_correct)))))
(let ((anon112_Then_correct  (=> (<= (LitInt 0) |k#0@0|) (and (=> (= (ControlFlow 0 18) 16) anon113_Then_correct) (=> (= (ControlFlow 0 18) 17) anon113_Else_correct)))))
...
))))) (=> |$w$loop#1@0| (forall ((|u#3@@1| Int) (|_t#0#1@@1| Int) ) (!  (=> (= |_t#0#1@@1| (- |u#3@@1| 1)) (=> (and (< |$rhs#1@0| |u#3@@1|) (< |u#3@@1| |l#0@0|)) (_module.__default.RightmostMax $Heap@3 |a#0@@4| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |_t#0#1@@1|)))) 1) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |u#3@@1|)))) |n#0@1|)))
 :qid |MinWindowMaxdfy.65:22|
 :skolemid |702|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |u#3@@1|))) ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |_t#0#1@@1|))))
...
))) (=> |$w$loop#1@0| (<= (- |l#0@0| |$rhs#1@0|) |W#0|))) (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5))))))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (not false) (= |$rhs#0@0| 0)) (<= 0 |k#0@0|)) (<= 1 |l#0@3|)) (= |$rhs#1@0| 0)) (= |$rhs#2@0| 1)) (<= 1 |n#0@3|)) (<= 0 |$decr_init$loop#00@0|)) |$w$loop#0@0|) (= |lo##0@0| 0)) (<= 1 |n#0@1|)) (and (and (=> |$w$loop#1@0| (<= (LitInt 0) |k#0@0|)) (=> |$w$loop#1@0| (< |k#0@0| |l#0@3|))) (and (=> |$w$loop#1@0| (<= |l#0@3| |n#0@3|)) (=> |$w$loop#1@0| (<= |n#0@3| (_System.array.Length |a#0@@4|)))))) (and (and (and (=> |$w$loop#1@0| (|_module.__default.StrictlyIncreasing#canCall| $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|)) (=> |$w$loop#1@0| (=> (|_module.__default.StrictlyIncreasing#canCall| $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|) (or (_module.__default.StrictlyIncreasing $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|) (forall ((|i#4@@0| Int) ) (!  (and (=> (and (<= |k#0@0| |i#4@@0|) (< |i#4@@0| |l#0@3|)) (<= (- |n#0@3| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |i#4@@0|)))))) (=> (and (<= |k#0@0| |i#4@@0|) (< |i#4@@0| |l#0@3|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |i#4@@0|)))) |n#0@3|)))
 :qid |MinWindowMaxdfy.146:11|
 :skolemid |690|
...
)))))))))) (and (and (and (and (=> |$w$loop#1@0| (forall ((|u#3@@2| Int) (|_t#0#1@@2| Int) ) (!  (=> (= |_t#0#1@@2| (- |u#3@@2| 1)) (=> (< |k#0@0| |u#3@@2|) (=> (< |u#3@@2| |l#0@3|) (|_module.__default.RightmostMax#canCall| $Heap@5 |a#0@@4| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |_t#0#1@@2|)))) 1) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |u#3@@2|)))) |n#0@3|))))
 :qid |MinWindowMaxdfy.65:22|
 :skolemid |700|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |u#3@@2|))) ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |_t#0#1@@2|))))
))) (=> |$w$loop#1@0| (forall ((|u#3@@3| Int) (|_t#0#1@@3| Int) ) (!  (=> (= |_t#0#1@@3| (- |u#3@@3| 1)) (=> (and (< |k#0@0| |u#3@@3|) (< |u#3@@3| |l#0@3|)) (_module.__default.RightmostMax $Heap@5 |a#0@@4| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |_t#0#1@@3|)))) 1) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |u#3@@3|)))) |n#0@3|)))
 :qid |MinWindowMaxdfy.65:22|
 :skolemid |702|
...
)))))) (and (and (and (=> |$w$loop#1@0| (forall ((|s#3@@1| Int) ) (!  (=> (and (<= (LitInt 0) |s#3@@1|) (<= |s#3@@1| (- |n#0@3| |W#0|))) (<= |m#0@1| (_module.__default.Max ($LS ($LS $LZ)) $Heap@5 |a#0@@4| |s#3@@1| |W#0|)))
 :qid |MinWindowMaxdfy.70:22|
 :skolemid |706|
...
))) (and (<= (- (_System.array.Length |a#0@@4|) |n#0@3|) |$decr_init$loop#10@0|) (not |$w$loop#1@0|)))))) (and (=> (= (ControlFlow 0 20) 18) anon112_Then_correct) (=> (= (ControlFlow 0 20) 19) anon112_Else_correct)))))))))
anon0_correct))))))))))))))))))))
))
(check-sat)
(get-info :rlimit)
