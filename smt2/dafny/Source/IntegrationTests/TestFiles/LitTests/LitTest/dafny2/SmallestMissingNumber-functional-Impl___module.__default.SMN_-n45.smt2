...
(set-info :boogie-vc-id Impl$$_module.__default.SMN_k_k__Correct_split25)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((GeneratedUnifiedExit_correct  (=> (let ((|s#0| (_module.__default.SMN_k_k ($LS ($LS $LZ)) |xs#0@@20| |n#0@@4| |len#0@@9|)))
(<= |n#0@@4| |s#0|)) (=> (and (let ((|s#0@@0| (_module.__default.SMN_k_k ($LS ($LS $LZ)) |xs#0@@20| |n#0@@4| |len#0@@9|)))
(<= |s#0@@0| (+ |n#0@@4| |len#0@@9|))) (= (ControlFlow 0 2) (- 0 1))) (let ((|s#0@@1| (_module.__default.SMN_k_k ($LS ($LS $LZ)) |xs#0@@20| |n#0@@4| |len#0@@9|)))
 (not (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS ($LS $LZ)) |xs#0@@20|) ($Box intType (int_2_U |s#0@@1|)))))))))
(let ((anon15_Else_correct  (=> (<= |half#1_0@0| |llen#1_0@0|) (=> (and (and (and ($IsAlloc DatatypeTypeType |R#1_0@0| (Tclass._module.List Tclass._System.nat) $Heap@2) ($Is intType (int_2_U (+ |n#0@@4| |llen#1_0@0|)) Tclass._System.nat)) (and (= |##n#1_1_0@0| (+ |n#0@@4| |llen#1_0@0|)) ($IsAlloc intType (int_2_U |##n#1_1_0@0|) Tclass._System.nat $Heap@2))) (and (and ($Is intType (int_2_U (- |len#0@@9| |llen#1_0@0|)) Tclass._System.nat) (= |##len#1_1_0@0| (- |len#0@@9| |llen#1_0@0|))) (and ($IsAlloc intType (int_2_U |##len#1_1_0@0|) Tclass._System.nat $Heap@2) (= |##len#1_1_0@0| (_module.__default.Length Tclass._System.nat ($LS $LZ) |R#1_0@0|))))) (=> (and (and (and (and (and (|_module.__default.SMN_k_k#canCall| |R#1_0@0| (+ |n#0@@4| |llen#1_0@0|) (- |len#0@@9| |llen#1_0@0|)) (|_module.__default.SMN_k_k#canCall| |R#1_0@0| (+ |n#0@@4| |llen#1_0@0|) (- |len#0@@9| |llen#1_0@0|))) (and (= |s#1_1_0@0| (_module.__default.SMN_k_k ($LS $LZ) |R#1_0@0| (+ |n#0@@4| |llen#1_0@0|) (- |len#0@@9| |llen#1_0@0|))) ($Is intType (int_2_U (+ |n#0@@4| |llen#1_0@0|)) Tclass._System.nat))) (and (and (= |n##1_1_0@0| (+ |n#0@@4| |llen#1_0@0|)) ($Is intType (int_2_U (- |len#0@@9| |llen#1_0@0|)) Tclass._System.nat)) (and (= |len##1_1_0@0| (- |len#0@@9| |llen#1_0@0|)) (or (<= 0 |len#0@@9|) (= |len##1_1_0@0| |len#0@@9|))))) (and (and (and (< |len##1_1_0@0| |len#0@@9|) (=> (|_module.__default.NoDuplicates#canCall| Tclass._System.nat |R#1_0@0|) (or (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |R#1_0@0|) (=> (_module.List.Nil_q |R#1_0@0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (|_module.__default.NoDuplicates#canCall| Tclass._System.nat |R#1_0@0|) (or (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |R#1_0@0|) (=> (not (_module.List.Nil_q |R#1_0@0|)) (let ((|tail#0@@3| (_module.List.tail |R#1_0@0|)))
(let ((|x#4| (U_2_int ($Unbox intType (_module.List.head |R#1_0@0|)))))
 (not (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS ($LS $LZ)) |tail#0@@3|) ($Box intType (int_2_U |x#4|))))))))) (=> (|_module.__default.NoDuplicates#canCall| Tclass._System.nat |R#1_0@0|) (or (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |R#1_0@0|) (=> (not (_module.List.Nil_q |R#1_0@0|)) (let ((|tail#0@@4| (_module.List.tail |R#1_0@0|)))
(_module.__default.NoDuplicates Tclass._System.nat ($LS ($LS $LZ)) |tail#0@@4|))))))) (and (and (forall ((|x#1@@0| T@U) ) (!  (=> (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS ($LS $LZ)) |R#1_0@0|) ($Box intType |x#1@@0|)) (<= |n##1_1_0@0| (U_2_int |x#1@@0|)))
 :qid |SmallestMissingNumberfunctionaldfy.274:19|
 :skolemid |739|
 :pattern ( (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS ($LS $LZ)) |R#1_0@0|) ($Box intType |x#1@@0|)))
)) (= |len##1_1_0@0| (_module.__default.Length Tclass._System.nat ($LS ($LS $LZ)) |R#1_0@0|))) (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4))))) (and (and (and (and (|_module.__default.SMN_k_k#canCall| |R#1_0@0| |n##1_1_0@0| |len##1_1_0@0|) (let ((|s#0@@2| (_module.__default.SMN_k_k ($LS $LZ) |R#1_0@0| |n##1_1_0@0| |len##1_1_0@0|)))
 (=> (and (<= |n##1_1_0@0| |s#0@@2|) (<= |s#0@@2| (+ |n##1_1_0@0| |len##1_1_0@0|))) (and (|_module.__default.Elements#canCall| Tclass._System.nat |R#1_0@0|) (=> (not (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |R#1_0@0|) ($Box intType (int_2_U |s#0@@2|)))) (forall ((|x#3@@0| T@U) ) (!  (=> (and (<= |n##1_1_0@0| (U_2_int |x#3@@0|)) (< (U_2_int |x#3@@0|) |s#0@@2|)) (|_module.__default.Elements#canCall| Tclass._System.nat |R#1_0@0|))
 :qid |SmallestMissingNumberfunctionaldfy.279:12|
 :skolemid |741|
 :pattern ( (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |R#1_0@0|) ($Box intType |x#3@@0|)))
))))))) (let ((|s#0@@3| (_module.__default.SMN_k_k ($LS ($LS $LZ)) |R#1_0@0| |n##1_1_0@0| |len##1_1_0@0|)))
(<= |n##1_1_0@0| |s#0@@3|))) (and (let ((|s#0@@4| (_module.__default.SMN_k_k ($LS ($LS $LZ)) |R#1_0@0| |n##1_1_0@0| |len##1_1_0@0|)))
(<= |s#0@@4| (+ |n##1_1_0@0| |len##1_1_0@0|))) (let ((|s#0@@5| (_module.__default.SMN_k_k ($LS ($LS $LZ)) |R#1_0@0| |n##1_1_0@0| |len##1_1_0@0|)))
 (not (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS ($LS $LZ)) |R#1_0@0|) ($Box intType (int_2_U |s#0@@5|))))))) (and (and (let ((|s#0@@6| (_module.__default.SMN_k_k ($LS ($LS $LZ)) |R#1_0@0| |n##1_1_0@0| |len##1_1_0@0|)))
(forall ((|x#3@@1| T@U) ) (!  (=> (and (<= |n##1_1_0@0| (U_2_int |x#3@@1|)) (< (U_2_int |x#3@@1|) |s#0@@6|)) (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |R#1_0@0|) ($Box intType |x#3@@1|)))
 :qid |SmallestMissingNumberfunctionaldfy.279:12|
 :skolemid |743|
 :pattern ( (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |R#1_0@0|) ($Box intType |x#3@@1|)))
))) (= $Heap@2 $Heap@4)) (and (forall ((|x#1_1_0_1| T@U) ) (!  (=> (and (<= |n#0@@4| (U_2_int |x#1_1_0_1|)) (< (U_2_int |x#1_1_0_1|) |s#1_1_0@0|)) (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |xs#0@@20|) ($Box intType |x#1_1_0_1|)))
 :qid |SmallestMissingNumberfunctionaldfy.296:14|
 :skolemid |755|
 :pattern ( (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |xs#0@@20|) ($Box intType |x#1_1_0_1|)))
)) (= (ControlFlow 0 5) 2))))) GeneratedUnifiedExit_correct)))))
(let ((anon15_Then_correct  (=> (< |llen#1_0@0| |half#1_0@0|) (=> (and ($Is intType (int_2_U |llen#1_0@0|) Tclass._System.nat) (or (<= 0 |len#0@@9|) (= |llen#1_0@0| |len#0@@9|))) (=> (and (and (and (and (< |llen#1_0@0| |len#0@@9|) (=> (|_module.__default.NoDuplicates#canCall| Tclass._System.nat |L#1_0@0|) (or (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |L#1_0@0|) (=> (_module.List.Nil_q |L#1_0@0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (|_module.__default.NoDuplicates#canCall| Tclass._System.nat |L#1_0@0|) (or (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |L#1_0@0|) (=> (not (_module.List.Nil_q |L#1_0@0|)) (let ((|tail#0@@5| (_module.List.tail |L#1_0@0|)))
(let ((|x#4@@0| (U_2_int ($Unbox intType (_module.List.head |L#1_0@0|)))))
 (not (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS ($LS $LZ)) |tail#0@@5|) ($Box intType (int_2_U |x#4@@0|))))))))) (=> (|_module.__default.NoDuplicates#canCall| Tclass._System.nat |L#1_0@0|) (or (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |L#1_0@0|) (=> (not (_module.List.Nil_q |L#1_0@0|)) (let ((|tail#0@@6| (_module.List.tail |L#1_0@0|)))
(_module.__default.NoDuplicates Tclass._System.nat ($LS ($LS $LZ)) |tail#0@@6|))))))) (and (and (forall ((|x#1@@1| T@U) ) (!  (=> (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS ($LS $LZ)) |L#1_0@0|) ($Box intType |x#1@@1|)) (<= |n#0@@4| (U_2_int |x#1@@1|)))
 :qid |SmallestMissingNumberfunctionaldfy.274:19|
 :skolemid |739|
 :pattern ( (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS ($LS $LZ)) |L#1_0@0|) ($Box intType |x#1@@1|)))
)) (= |llen#1_0@0| (_module.__default.Length Tclass._System.nat ($LS ($LS $LZ)) |L#1_0@0|))) (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)))) (and (and (and (|_module.__default.SMN_k_k#canCall| |L#1_0@0| |n#0@@4| |llen#1_0@0|) (let ((|s#0@@7| (_module.__default.SMN_k_k ($LS $LZ) |L#1_0@0| |n#0@@4| |llen#1_0@0|)))
 (=> (and (<= |n#0@@4| |s#0@@7|) (<= |s#0@@7| (+ |n#0@@4| |llen#1_0@0|))) (and (|_module.__default.Elements#canCall| Tclass._System.nat |L#1_0@0|) (=> (not (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |L#1_0@0|) ($Box intType (int_2_U |s#0@@7|)))) (forall ((|x#3@@2| T@U) ) (!  (=> (and (<= |n#0@@4| (U_2_int |x#3@@2|)) (< (U_2_int |x#3@@2|) |s#0@@7|)) (|_module.__default.Elements#canCall| Tclass._System.nat |L#1_0@0|))
 :qid |SmallestMissingNumberfunctionaldfy.279:12|
 :skolemid |741|
 :pattern ( (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |L#1_0@0|) ($Box intType |x#3@@2|)))
))))))) (and (let ((|s#0@@8| (_module.__default.SMN_k_k ($LS ($LS $LZ)) |L#1_0@0| |n#0@@4| |llen#1_0@0|)))
(<= |n#0@@4| |s#0@@8|)) (let ((|s#0@@9| (_module.__default.SMN_k_k ($LS ($LS $LZ)) |L#1_0@0| |n#0@@4| |llen#1_0@0|)))
(<= |s#0@@9| (+ |n#0@@4| |llen#1_0@0|))))) (and (and (let ((|s#0@@10| (_module.__default.SMN_k_k ($LS ($LS $LZ)) |L#1_0@0| |n#0@@4| |llen#1_0@0|)))
 (not (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS ($LS $LZ)) |L#1_0@0|) ($Box intType (int_2_U |s#0@@10|))))) (let ((|s#0@@11| (_module.__default.SMN_k_k ($LS ($LS $LZ)) |L#1_0@0| |n#0@@4| |llen#1_0@0|)))
(forall ((|x#3@@3| T@U) ) (!  (=> (and (<= |n#0@@4| (U_2_int |x#3@@3|)) (< (U_2_int |x#3@@3|) |s#0@@11|)) (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |L#1_0@0|) ($Box intType |x#3@@3|)))
 :qid |SmallestMissingNumberfunctionaldfy.279:12|
 :skolemid |743|
 :pattern ( (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |L#1_0@0|) ($Box intType |x#3@@3|)))
)))) (and (= $Heap@2 $Heap@3) (= (ControlFlow 0 4) 2))))) GeneratedUnifiedExit_correct)))))
(let ((anon14_Else_correct  (=> (not (|_module.List#Equal| |xs#0@@20| |#_module.List.Nil|)) (=> (and (and (or (not (= (LitInt 2) 0)) (not true)) (= |half#1_0@0| (+ (Div |len#0@@9| (LitInt 2)) 1))) (and ($Is DatatypeTypeType |L#1_0@0| (Tclass._module.List Tclass._System.nat)) ($IsAlloc DatatypeTypeType |L#1_0@0| (Tclass._module.List Tclass._System.nat) $Heap@@0))) (=> (and (and (and (and (and (and ($Is DatatypeTypeType |R#1_0@0| (Tclass._module.List Tclass._System.nat)) ($IsAlloc DatatypeTypeType |R#1_0@0| (Tclass._module.List Tclass._System.nat) $Heap@@0)) ($IsAlloc DatatypeTypeType |xs#0@@20| (Tclass._module.List Tclass._System.nat) $Heap@@0)) (and ($Is intType (int_2_U (+ |n#0@@4| |half#1_0@0|)) Tclass._System.nat) (= |##b#1_0@0| (+ |n#0@@4| |half#1_0@0|)))) (and (and (and ($IsAlloc intType (int_2_U |##b#1_0@0|) Tclass._System.nat $Heap@@0) (|_module.__default.Split#canCall| |xs#0@@20| (+ |n#0@@4| |half#1_0@0|))) (and (_System.Tuple2.___hMake2_q (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@20| (+ |n#0@@4| |half#1_0@0|))) (= |let#1_0#0#0| (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@20| (+ |n#0@@4| |half#1_0@0|))))) (and (and (|_module.__default.Split#canCall| |xs#0@@20| (+ |n#0@@4| |half#1_0@0|)) (|_module.__default.Split#canCall| |xs#0@@20| (+ |n#0@@4| |half#1_0@0|))) (and ($Is DatatypeTypeType |let#1_0#0#0| (Tclass._System.Tuple2 (Tclass._module.List Tclass._System.nat) (Tclass._module.List Tclass._System.nat))) (_System.Tuple2.___hMake2_q |let#1_0#0#0|))))) (and (and (and (and (= (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |L#1_0@0|) ($Box DatatypeTypeType |R#1_0@0|)) |let#1_0#0#0|) ($Is intType (int_2_U (+ |n#0@@4| |half#1_0@0|)) Tclass._System.nat)) (and (= |b##1_0@0| (+ |n#0@@4| |half#1_0@0|)) (=> (|_module.__default.NoDuplicates#canCall| Tclass._System.nat |xs#0@@20|) (or (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |xs#0@@20|) (=> (_module.List.Nil_q |xs#0@@20|) (U_2_bool (Lit boolType (bool_2_U true)))))))) (and (and (=> (|_module.__default.NoDuplicates#canCall| Tclass._System.nat |xs#0@@20|) (or (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |xs#0@@20|) (=> (not (_module.List.Nil_q |xs#0@@20|)) (let ((|tail#0@@7| (_module.List.tail |xs#0@@20|)))
(let ((|x#2@@2| (U_2_int ($Unbox intType (_module.List.head |xs#0@@20|)))))
 (not (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS ($LS $LZ)) |tail#0@@7|) ($Box intType (int_2_U |x#2@@2|))))))))) (=> (|_module.__default.NoDuplicates#canCall| Tclass._System.nat |xs#0@@20|) (or (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |xs#0@@20|) (=> (not (_module.List.Nil_q |xs#0@@20|)) (let ((|tail#0@@8| (_module.List.tail |xs#0@@20|)))
(_module.__default.NoDuplicates Tclass._System.nat ($LS ($LS $LZ)) |tail#0@@8|)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (and (and (|_module.__default.Split#canCall| |xs#0@@20| |b##1_0@0|) (let ((|r#0@@0| (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@20| |b##1_0@0|)))
...
(let ((|x#7| (U_2_int ($Unbox intType (_module.List.head ($Unbox DatatypeTypeType (_System.Tuple2._0 |r#0@@3|)))))))
 (and (not (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |tail#3@@3|) ($Box intType (int_2_U |x#7|)))) (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |tail#3@@3|)))))))))))) (and (and (and (and (and (let ((|r#0@@4| (_module.__default.Split ($LS ($LS $LZ)) reveal__module._default.Split |xs#0@@20| |b##1_0@0|)))
...
(let ((|x#9| (U_2_int ($Unbox intType (_module.List.head ($Unbox DatatypeTypeType (_System.Tuple2._1 |r#0@@4|)))))))
 (and (not (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |tail#5|) ($Box intType (int_2_U |x#9|)))) (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |tail#5|)))))))) (= $Heap@@0 $Heap@0)) (and ($IsAlloc DatatypeTypeType |L#1_0@0| (Tclass._module.List Tclass._System.nat) $Heap@0) (|_module.__default.Length#canCall| Tclass._System.nat |L#1_0@0|))) (and (and (|_module.__default.Length#canCall| Tclass._System.nat |L#1_0@0|) (= |llen#1_0@0| (_module.__default.Length Tclass._System.nat ($LS $LZ) |L#1_0@0|))) (and (= call0formal@_module._default.Elements_Property$_T0@0 Tclass._System.nat) (=> (|_module.__default.NoDuplicates#canCall| call0formal@_module._default.Elements_Property$_T0@0 |L#1_0@0|) (or (_module.__default.NoDuplicates call0formal@_module._default.Elements_Property$_T0@0 ($LS $LZ) |L#1_0@0|) (=> (_module.List.Nil_q |L#1_0@0|) (U_2_bool (Lit boolType (bool_2_U true))))))))) (and (and (and (=> (|_module.__default.NoDuplicates#canCall| call0formal@_module._default.Elements_Property$_T0@0 |L#1_0@0|) (or (_module.__default.NoDuplicates call0formal@_module._default.Elements_Property$_T0@0 ($LS $LZ) |L#1_0@0|) (=> (not (_module.List.Nil_q |L#1_0@0|)) (let ((|tail#0@@9| (_module.List.tail |L#1_0@0|)))
(let ((|x#0@@5| (_module.List.head |L#1_0@0|)))
 (not (|Set#IsMember| (_module.__default.Elements call0formal@_module._default.Elements_Property$_T0@0 ($LS ($LS $LZ)) |tail#0@@9|) |x#0@@5|))))))) (=> (|_module.__default.NoDuplicates#canCall| call0formal@_module._default.Elements_Property$_T0@0 |L#1_0@0|) (or (_module.__default.NoDuplicates call0formal@_module._default.Elements_Property$_T0@0 ($LS $LZ) |L#1_0@0|) (=> (not (_module.List.Nil_q |L#1_0@0|)) (let ((|tail#0@@10| (_module.List.tail |L#1_0@0|)))
(_module.__default.NoDuplicates call0formal@_module._default.Elements_Property$_T0@0 ($LS ($LS $LZ)) |tail#0@@10|)))))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1))) (and (and (|_module.__default.Elements#canCall| call0formal@_module._default.Elements_Property$_T0@0 |L#1_0@0|) (|_module.__default.Length#canCall| call0formal@_module._default.Elements_Property$_T0@0 |L#1_0@0|)) (and (= (|Set#Card| (_module.__default.Elements call0formal@_module._default.Elements_Property$_T0@0 ($LS ($LS $LZ)) |L#1_0@0|)) (_module.__default.Length call0formal@_module._default.Elements_Property$_T0@0 ($LS ($LS $LZ)) |L#1_0@0|)) (= $Heap@0 $Heap@1))))) (and (and (and (and ($IsAlloc intType (int_2_U |n#0@@4|) Tclass._System.nat $Heap@1) ($Is intType (int_2_U |half#1_0@0|) Tclass._System.nat)) (and ($IsAlloc intType (int_2_U |half#1_0@0|) Tclass._System.nat $Heap@1) (|_module.__default.IntRange#canCall| |n#0@@4| |half#1_0@0|))) (and (and (|_module.__default.IntRange#canCall| |n#0@@4| |half#1_0@0|) (= |bound#1_0@0| (_module.__default.IntRange ($LS $LZ) reveal__module._default.IntRange |n#0@@4| |half#1_0@0|))) (and ($IsAlloc DatatypeTypeType |L#1_0@0| (Tclass._module.List Tclass._System.nat) $Heap@1) (|_module.__default.Elements#canCall| Tclass._System.nat |L#1_0@0|)))) (and (and (and (|_module.__default.Elements#canCall| Tclass._System.nat |L#1_0@0|) (= |A##1_0@0| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |L#1_0@0|))) (and (= call0formal@_module._default.Cardinality$_T0@0 Tclass._System.nat) (|Set#Subset| |A##1_0@0| |bound#1_0@0|))) (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (and (<= (|Set#Card| |A##1_0@0|) (|Set#Card| |bound#1_0@0|)) (= $Heap@1 $Heap@2))))))) (and (=> (= (ControlFlow 0 6) 4) anon15_Then_correct) (=> (= (ControlFlow 0 6) 5) anon15_Else_correct)))))))
(let ((anon14_Then_correct  (=> (and (|_module.List#Equal| |xs#0@@20| |#_module.List.Nil|) (= (ControlFlow 0 3) 2)) GeneratedUnifiedExit_correct)))
(let ((anon0_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and ($Is DatatypeTypeType |xs#0@@20| (Tclass._module.List Tclass._System.nat)) ($IsAlloc DatatypeTypeType |xs#0@@20| (Tclass._module.List Tclass._System.nat) $Heap@@0)) (|$IsA#_module.List| |xs#0@@20|)) (and (<= (LitInt 0) |n#0@@4|) (<= (LitInt 0) |len#0@@9|))) (=> (and (and (and (and (and ($Is SetType |bound#1_0| (TSet Tclass._System.nat)) ($IsAlloc SetType |bound#1_0| (TSet Tclass._System.nat) $Heap@@0)) true) (= 4 $FunctionContextHeight)) (and (|_module.__default.NoDuplicates#canCall| Tclass._System.nat |xs#0@@20|) (and (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |xs#0@@20|) (ite (_module.List.Nil_q |xs#0@@20|) true (let ((|tail#3@@4| (_module.List.tail |xs#0@@20|)))
(let ((|x#7@@0| (U_2_int ($Unbox intType (_module.List.head |xs#0@@20|)))))
 (and (not (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |tail#3@@4|) ($Box intType (int_2_U |x#7@@0|)))) (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |tail#3@@4|)))))))) (and (and (forall ((|x#1@@2| T@U) ) (!  (=> (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |xs#0@@20|) ($Box intType |x#1@@2|)) (<= |n#0@@4| (U_2_int |x#1@@2|)))
 :qid |SmallestMissingNumberfunctionaldfy.274:19|
 :skolemid |745|
 :pattern ( (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |xs#0@@20|) ($Box intType |x#1@@2|)))
)) (= |len#0@@9| (_module.__default.Length Tclass._System.nat ($LS ($LS $LZ)) |xs#0@@20|))) (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (|$IsA#_module.List| |xs#0@@20|)))) (and (=> (= (ControlFlow 0 7) 3) anon14_Then_correct) (=> (= (ControlFlow 0 7) 6) anon14_Else_correct)))))))
anon0_correct)))))))
))
(check-sat)
(get-info :rlimit)
