...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split15)
...
))))) (and (and (=> |$w$loop#0@0| (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (IndexField (- |$rhs#2@0| 1))))) (- |n#0@0| 1))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|)))) (<= (- |$rhs#2@0| |$rhs#1@0|) |W#0|))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
