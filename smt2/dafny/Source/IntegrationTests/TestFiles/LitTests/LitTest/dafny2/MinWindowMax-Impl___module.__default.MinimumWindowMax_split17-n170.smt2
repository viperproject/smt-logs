...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split171)
...
)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= $nw@0 null)) (not true))))))
(let ((anon117_Else_correct  (=> (and (not (and (< |k#0@0| |u#2@0|) (< |u#2@0| |l#0@3|))) (= (ControlFlow 0 4) 2)) anon51_correct)))
(let ((anon117_Then_correct  (=> (and (and (< |k#0@0| |u#2@0|) (< |u#2@0| |l#0@3|)) (and ($IsAlloc refType |a#0@@4| (Tclass._System.array TInt) $Heap@5) (or (not (= $nw@0 null)) (not true)))) (=> (and (and (and (= |##lo#5@0| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |u#2@0| 1))))) 1)) ($IsAlloc intType (int_2_U |##lo#5@0|) TInt $Heap@5)) (and (or (not (= $nw@0 null)) (not true)) (= |##x#3@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |u#2@0|))))))) (and (and ($IsAlloc intType (int_2_U |##x#3@0|) TInt $Heap@5) ($IsAlloc intType (int_2_U |n#0@3|) TInt $Heap@5)) (and (|_module.__default.RightmostMax#canCall| $Heap@5 |a#0@@4| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |u#2@0| 1))))) 1) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |u#2@0|)))) |n#0@3|) (= (ControlFlow 0 3) 2)))) anon51_correct))))
(let ((anon116_Else_correct  (=> (<= |u#2@0| |k#0@0|) (and (=> (= (ControlFlow 0 6) 3) anon117_Then_correct) (=> (= (ControlFlow 0 6) 4) anon117_Else_correct)))))
(let ((anon116_Then_correct  (=> (< |k#0@0| |u#2@0|) (and (=> (= (ControlFlow 0 5) 3) anon117_Then_correct) (=> (= (ControlFlow 0 5) 4) anon117_Else_correct)))))
(let ((anon46_correct  (=> (and (and (and (and (and (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| |l#0@3|)) (<= |l#0@3| |n#0@3|)) (<= |n#0@3| (_System.array.Length |a#0@@4|))) ($IsAlloc refType $nw@0 (Tclass._System.array TInt) $Heap@5)) (and ($IsAlloc intType (int_2_U |k#0@0|) TInt $Heap@5) ($IsAlloc intType (int_2_U |l#0@3|) TInt $Heap@5))) (and (and (and (and (= |##lo#3@0| (- |n#0@3| |W#0|)) ($IsAlloc intType (int_2_U |##lo#3@0|) TInt $Heap@5)) (and ($IsAlloc intType (int_2_U |n#0@3|) TInt $Heap@5) (|_module.__default.StrictlyIncreasing#canCall| $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|))) (and (and (|_module.__default.StrictlyIncreasing#canCall| $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|) (_module.__default.StrictlyIncreasing $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|)) (and ($IsAlloc refType |a#0@@4| (Tclass._System.array TInt) $Heap@5) (= |##lo#4@0| (- |n#0@3| |W#0|))))) (and (and (and ($IsAlloc intType (int_2_U |##lo#4@0|) TInt $Heap@5) (or (not (= $nw@0 null)) (not true))) (and (= |##x#2@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|))))) ($IsAlloc intType (int_2_U |##x#2@0|) TInt $Heap@5))) (and (and ($IsAlloc intType (int_2_U |n#0@3|) TInt $Heap@5) (|_module.__default.RightmostMax#canCall| $Heap@5 |a#0@@4| (- |n#0@3| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|)))) |n#0@3|)) (and (|_module.__default.RightmostMax#canCall| $Heap@5 |a#0@@4| (- |n#0@3| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|)))) |n#0@3|) (_module.__default.RightmostMax $Heap@5 |a#0@@4| (- |n#0@3| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|)))) |n#0@3|)))))) (and (=> (= (ControlFlow 0 7) 5) anon116_Then_correct) (=> (= (ControlFlow 0 7) 6) anon116_Else_correct)))))
(let ((anon114_Else_correct  (=> (and (not (and (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| |l#0@3|)) (<= |l#0@3| |n#0@3|))) (= (ControlFlow 0 9) 7)) anon46_correct)))
(let ((anon114_Then_correct  (=> (and (and (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| |l#0@3|)) (<= |l#0@3| |n#0@3|)) (= (ControlFlow 0 8) 7)) anon46_correct)))
(let ((anon113_Else_correct  (=> (not (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| |l#0@3|))) (and (=> (= (ControlFlow 0 11) 8) anon114_Then_correct) (=> (= (ControlFlow 0 11) 9) anon114_Else_correct)))))
(let ((anon113_Then_correct  (=> (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| |l#0@3|)) (and (=> (= (ControlFlow 0 10) 8) anon114_Then_correct) (=> (= (ControlFlow 0 10) 9) anon114_Else_correct)))))
(let ((anon112_Else_correct  (=> (< |k#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 13) 10) anon113_Then_correct) (=> (= (ControlFlow 0 13) 11) anon113_Else_correct)))))
(let ((anon112_Then_correct  (=> (<= (LitInt 0) |k#0@0|) (and (=> (= (ControlFlow 0 12) 10) anon113_Then_correct) (=> (= (ControlFlow 0 12) 11) anon113_Else_correct)))))
...
))) (and (<= (- (_System.array.Length |a#0@@4|) |n#0@3|) |$decr_init$loop#10@0|) (not |$w$loop#1@0|)))))) (and (=> (= (ControlFlow 0 14) 12) anon112_Then_correct) (=> (= (ControlFlow 0 14) 13) anon112_Else_correct)))))))))
anon0_correct))))))))))))))
))
(check-sat)
(get-info :rlimit)
