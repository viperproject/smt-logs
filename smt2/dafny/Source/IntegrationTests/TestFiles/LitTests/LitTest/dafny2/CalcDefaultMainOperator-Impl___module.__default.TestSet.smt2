...
(set-info :boogie-vc-id Impl$$_module.__default.TestSet)
...
(let ((anon14_Then_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (|Set#Subset| |Nonempty#0| |Set#Empty|))))
(let ((anon13_Then_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (|Set#Subset| |Empty#0| |Nonempty#0|))))
(let ((anon12_Then_correct true))
(let ((anon11_Else_correct  (=> (|Set#Subset| |Empty#0| |Set#Empty|) (and (and (and (=> (= (ControlFlow 0 12) 6) anon12_Then_correct) (=> (= (ControlFlow 0 12) 8) anon13_Then_correct)) (=> (= (ControlFlow 0 12) 10) anon14_Then_correct)) (=> (= (ControlFlow 0 12) 11) anon14_Else_correct)))))
(let ((anon11_Then_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (|Set#Subset| |Empty#0| |Nonempty#0|))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (|Set#Subset| |Nonempty#0| |Set#Empty|))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SetType |Empty#0| (TSet TInt)) ($IsAlloc SetType |Empty#0| (TSet TInt) $Heap)) (and ($Is SetType |Nonempty#0| (TSet TInt)) ($IsAlloc SetType |Nonempty#0| (TSet TInt) $Heap))) (and (and (= 0 $FunctionContextHeight) (= (|Set#Card| |Empty#0|) (LitInt 0))) (and (> (|Set#Card| |Nonempty#0|) 0) (= (ControlFlow 0 14) 13)))) anon0_correct))))
