...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split100)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon87_correct  (=> (= |lo##1_0@1| (+ (- |n#0@3| |W#0|) 1)) (=> (and (or (not (= $nw@0 null)) (not true)) (= (ControlFlow 0 2) (- 0 1))) (and (<= 0 |k#0@2|) (< |k#0@2| (_System.array.Length $nw@0)))))))
