...
(declare-fun |L#0| () T@U)
(set-info :boogie-vc-id Impl$$SnapTree.Node.MutatingInsert__Right)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 34) (let ((anon9_correct  (and (=> (= (ControlFlow 0 2) (- 0 18)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@3 SnapTree.Node.Repr))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@3 SnapTree.Node.Repr)) (and (=> (= (ControlFlow 0 2) (- 0 17)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@3) SnapTree.Node.right)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@3) SnapTree.Node.right)) null)) (not true)) (=> (= |$rhs#0@0| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@3) SnapTree.Node.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@3) SnapTree.Node.right))) SnapTree.Node.Repr)))) (=> (and (= $Heap@5 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@4 this@@3 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@3) SnapTree.Node.Repr ($Box SetType |$rhs#0@0|)))) ($IsGoodHeap $Heap@5)) (and (=> (= (ControlFlow 0 2) (- 0 16)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@3 SnapTree.Node.Contents))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@3 SnapTree.Node.Contents)) (and (=> (= (ControlFlow 0 2) (- 0 15)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@3) SnapTree.Node.right)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@3) SnapTree.Node.right)) null)) (not true)) (=> (and (= |$rhs#1@0| (|Seq#Append| (|Seq#Append| |L#0@0| (|Seq#Build| |Seq#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@3) SnapTree.Node.data))) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@3) SnapTree.Node.right))) SnapTree.Node.Contents)))) (= $Heap@6 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@5 this@@3 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@3) SnapTree.Node.Contents ($Box SeqType |$rhs#1@0|))))) (=> (and (and (and ($IsGoodHeap $Heap@6) (= |s##0@0| (Lit SeqType |Seq#Empty|))) (and ($IsGoodHeap $Heap@7) ($IsHeapAnchor $Heap@7))) (and (and (=> (<= (|Seq#Length| |s##0@0|) (LitInt 1)) (|SnapTree.Tree.IsSorted#canCall| |s##0@0|)) (=> (<= (|Seq#Length| |s##0@0|) (LitInt 1)) (SnapTree.Tree.IsSorted reveal_SnapTree.Tree.IsSorted |s##0@0|))) (and (= $Heap@6 $Heap@7) (= |data##0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@3) SnapTree.Node.data))))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@3) SnapTree.Node.right)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@3) SnapTree.Node.right)) null)) (not true)) (=> (= |right##0@0| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@3) SnapTree.Node.right))) SnapTree.Node.Contents))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|SnapTree.Tree.SortedSplit#canCall| |L#0@0| |data##0@0| |right##0@0|) (or (SnapTree.Tree.SortedSplit |L#0@0| |data##0@0| |right##0@0|) (SnapTree.Tree.IsSorted reveal_SnapTree.Tree.IsSorted |L#0@0|)))) (=> (=> (|SnapTree.Tree.SortedSplit#canCall| |L#0@0| |data##0@0| |right##0@0|) (or (SnapTree.Tree.SortedSplit |L#0@0| |data##0@0| |right##0@0|) (SnapTree.Tree.IsSorted reveal_SnapTree.Tree.IsSorted |L#0@0|))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|SnapTree.Tree.SortedSplit#canCall| |L#0@0| |data##0@0| |right##0@0|) (or (SnapTree.Tree.SortedSplit |L#0@0| |data##0@0| |right##0@0|) (SnapTree.Tree.IsSorted reveal_SnapTree.Tree.IsSorted |right##0@0|)))) (=> (=> (|SnapTree.Tree.SortedSplit#canCall| |L#0@0| |data##0@0| |right##0@0|) (or (SnapTree.Tree.SortedSplit |L#0@0| |data##0@0| |right##0@0|) (SnapTree.Tree.IsSorted reveal_SnapTree.Tree.IsSorted |right##0@0|))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|SnapTree.Tree.SortedSplit#canCall| |L#0@0| |data##0@0| |right##0@0|) (or (SnapTree.Tree.SortedSplit |L#0@0| |data##0@0| |right##0@0|) (=> (|SnapTree.Tree.AllBelow#canCall| |L#0@0| |data##0@0|) (or (SnapTree.Tree.AllBelow |L#0@0| |data##0@0|) (forall ((|i#0@@2| Int) ) (!  (=> (and (<= (LitInt 0) |i#0@@2|) (< |i#0@@2| (|Seq#Length| |L#0@0|))) (< (U_2_int ($Unbox intType (|Seq#Index| |L#0@0| |i#0@@2|))) |data##0@0|))
 :qid |SnapshotableTreesdfy.126:14|
 :skolemid |721|
 :pattern ( ($Unbox intType (|Seq#Index| |L#0@0| |i#0@@2|)))
))))))) (=> (=> (|SnapTree.Tree.SortedSplit#canCall| |L#0@0| |data##0@0| |right##0@0|) (or (SnapTree.Tree.SortedSplit |L#0@0| |data##0@0| |right##0@0|) (=> (|SnapTree.Tree.AllBelow#canCall| |L#0@0| |data##0@0|) (or (SnapTree.Tree.AllBelow |L#0@0| |data##0@0|) (forall ((|i#0@@3| Int) ) (!  (=> (and (<= (LitInt 0) |i#0@@3|) (< |i#0@@3| (|Seq#Length| |L#0@0|))) (< (U_2_int ($Unbox intType (|Seq#Index| |L#0@0| |i#0@@3|))) |data##0@0|))
 :qid |SnapshotableTreesdfy.126:14|
 :skolemid |721|
 :pattern ( ($Unbox intType (|Seq#Index| |L#0@0| |i#0@@3|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|SnapTree.Tree.SortedSplit#canCall| |L#0@0| |data##0@0| |right##0@0|) (or (SnapTree.Tree.SortedSplit |L#0@0| |data##0@0| |right##0@0|) (=> (|SnapTree.Tree.AllAbove#canCall| |data##0@0| |right##0@0|) (or (SnapTree.Tree.AllAbove |data##0@0| |right##0@0|) (forall ((|i#1@@2| Int) ) (!  (=> (and (<= (LitInt 0) |i#1@@2|) (< |i#1@@2| (|Seq#Length| |right##0@0|))) (< |data##0@0| (U_2_int ($Unbox intType (|Seq#Index| |right##0@0| |i#1@@2|)))))
 :qid |SnapshotableTreesdfy.130:14|
 :skolemid |723|
 :pattern ( ($Unbox intType (|Seq#Index| |right##0@0| |i#1@@2|)))
))))))) (=> (=> (|SnapTree.Tree.SortedSplit#canCall| |L#0@0| |data##0@0| |right##0@0|) (or (SnapTree.Tree.SortedSplit |L#0@0| |data##0@0| |right##0@0|) (=> (|SnapTree.Tree.AllAbove#canCall| |data##0@0| |right##0@0|) (or (SnapTree.Tree.AllAbove |data##0@0| |right##0@0|) (forall ((|i#1@@3| Int) ) (!  (=> (and (<= (LitInt 0) |i#1@@3|) (< |i#1@@3| (|Seq#Length| |right##0@0|))) (< |data##0@0| (U_2_int ($Unbox intType (|Seq#Index| |right##0@0| |i#1@@3|)))))
 :qid |SnapshotableTreesdfy.130:14|
 :skolemid |723|
 :pattern ( ($Unbox intType (|Seq#Index| |right##0@0| |i#1@@3|)))
)))))) (=> (and (and (and (and ($IsGoodHeap $Heap@8) ($IsHeapAnchor $Heap@8)) (|SnapTree.Tree.IsSorted#canCall| (|Seq#Append| (|Seq#Append| |L#0@0| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |data##0@0|)))) |right##0@0|))) (and (SnapTree.Tree.IsSorted reveal_SnapTree.Tree.IsSorted (|Seq#Append| (|Seq#Append| |L#0@0| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |data##0@0|)))) |right##0@0|)) (= $Heap@7 $Heap@8))) (and (and ($IsGoodHeap $Heap@9) ($IsHeapAnchor $Heap@9)) (and (= $Heap@8 $Heap@9) reveal_SnapTree.Node.NodeValid))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@9 this@@3)) (=> (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@9 this@@3) (and (=> (= (ControlFlow 0 2) (- 0 8)) (and (forall (($o@@17 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@3) SnapTree.Node.Repr)) ($Box refType $o@@17)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Repr)) ($Box refType $o@@17)))) (or (not (= $o@@17 null)) (not true)))
 :qid |SnapshotableTreesdfy.454:30|
 :skolemid |986|
 :pattern (  (or (not (= $o@@17 null)) (not true)))
)) (forall (($o@@18 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@3) SnapTree.Node.Repr)) ($Box refType $o@@18)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Repr)) ($Box refType $o@@18)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@18) alloc)))))
 :qid |SnapshotableTreesdfy.454:30|
 :skolemid |987|
...
)))) (=> (and (forall (($o@@19 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@3) SnapTree.Node.Repr)) ($Box refType $o@@19)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Repr)) ($Box refType $o@@19)))) (or (not (= $o@@19 null)) (not true)))
 :qid |SnapshotableTreesdfy.454:30|
 :skolemid |986|
 :pattern (  (or (not (= $o@@19 null)) (not true)))
)) (forall (($o@@20 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@3) SnapTree.Node.Repr)) ($Box refType $o@@20)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Repr)) ($Box refType $o@@20)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@20) alloc)))))
 :qid |SnapshotableTreesdfy.454:30|
 :skolemid |987|
...
))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))) (< |pos#0@2| 0))) (=> (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))) (< |pos#0@2| 0)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@3) SnapTree.Node.Contents)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents))))) (=> (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@3) SnapTree.Node.Contents)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (<= (LitInt 0) |pos#0@2|))) (=> (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (<= (LitInt 0) |pos#0@2|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (< |pos#0@2| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@3) SnapTree.Node.Contents)))))) (=> (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (< |pos#0@2| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@3) SnapTree.Node.Contents))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@3) SnapTree.Node.Contents))) (+ (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents))) 1)))) (=> (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@3) SnapTree.Node.Contents))) (+ (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents))) 1))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@3) SnapTree.Node.Contents)) (|Seq#Append| (|Seq#Append| (|Seq#Take| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents)) |pos#0@2|) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |x#0|)))) (|Seq#Drop| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Contents)) |pos#0@2|)))))))))))))))))))))))))))))))))))))))))))))
(let ((anon8_correct  (=> (= $Heap@4 $Heap@3) (=> (and (= |pos#0@2| |pos#0@1|) (= (ControlFlow 0 21) 2)) anon9_correct))))
(let ((anon12_Else_correct  (=> (and (and (<= 0 |call3formal@pos#0@0|) (= |pos#0@0| (+ |Llen#0@0| |call3formal@pos#0@0|))) (and (= |pos#0@1| |pos#0@0|) (= (ControlFlow 0 23) 21))) anon8_correct)))
(let ((anon12_Then_correct  (=> (< |call3formal@pos#0@0| 0) (=> (and (= |pos#0@1| |call3formal@pos#0@0|) (= (ControlFlow 0 22) 21)) anon8_correct))))
(let ((anon11_Else_correct  (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.right)) null)) (not true)) (and (=> (= (ControlFlow 0 24) (- 0 28)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.right)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.right)) null)) (not true)) (and (=> (= (ControlFlow 0 24) (- 0 27)) (forall (($o@@21 T@U) ($f@@3 T@U) ) (!  (=> (and (and (or (not (= $o@@21 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@21) alloc)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.right))) SnapTree.Node.Repr)) ($Box refType $o@@21))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@21 $f@@3)))
 :qid |SnapshotableTreesdfy.468:36|
 :skolemid |991|
))) (=> (forall (($o@@22 T@U) ($f@@4 T@U) ) (!  (=> (and (and (or (not (= $o@@22 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@22) alloc)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.right))) SnapTree.Node.Repr)) ($Box refType $o@@22))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@22 $f@@4)))
 :qid |SnapshotableTreesdfy.468:36|
 :skolemid |991|
)) (and (=> (= (ControlFlow 0 24) (- 0 26)) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.right))) SnapTree.Node.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Repr))) (not (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.right))) SnapTree.Node.Repr)))))) (=> (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.right))) SnapTree.Node.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Repr))) (not (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.right))) SnapTree.Node.Repr))))) (=> (= call0formal@this@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.right))) (and (=> (= (ControlFlow 0 24) (- 0 25)) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@0 call0formal@this@0)) (=> (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@0 call0formal@this@0) (=> (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (=> (and (and (|SnapTree.Node.NodeValid#canCall| $Heap@3 call0formal@this@0) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@3 call0formal@this@0)) (and (forall (($o@@23 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@23)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call0formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@23)))) (or (not (= $o@@23 null)) (not true)))
 :qid |SnapshotableTreesdfy.409:30|
 :skolemid |956|
 :pattern (  (or (not (= $o@@23 null)) (not true)))
)) (forall (($o@@24 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@24)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call0formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@24)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@24) alloc)))))
 :qid |SnapshotableTreesdfy.409:30|
 :skolemid |957|
...
)))) (=> (and (and (and (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call0formal@this@0) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))) (< |call3formal@pos#0@0| 0)) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call0formal@this@0) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0) SnapTree.Node.Contents)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call0formal@this@0) SnapTree.Node.Contents))))) (and (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call0formal@this@0) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (<= (LitInt 0) |call3formal@pos#0@0|)) (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call0formal@this@0) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (< |call3formal@pos#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0) SnapTree.Node.Contents))))))) (and (and (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call0formal@this@0) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0) SnapTree.Node.Contents))) (+ (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call0formal@this@0) SnapTree.Node.Contents))) 1))) (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call0formal@this@0) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0) SnapTree.Node.Contents)) (|Seq#Append| (|Seq#Append| (|Seq#Take| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call0formal@this@0) SnapTree.Node.Contents)) |call3formal@pos#0@0|) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |x#0|)))) (|Seq#Drop| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call0formal@this@0) SnapTree.Node.Contents)) |call3formal@pos#0@0|))))) (and (forall (($o@@25 T@U) ) (!  (=> (and (or (not (= $o@@25 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@25) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@25) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@25)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call0formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@25))))
 :qid |SnapshotableTreesdfy.406:12|
 :skolemid |958|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@25))
)) ($HeapSucc $Heap@0 $Heap@3)))) (and (=> (= (ControlFlow 0 24) 22) anon12_Then_correct) (=> (= (ControlFlow 0 24) 23) anon12_Else_correct)))))))))))))))))
(let ((anon11_Then_correct  (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.right)) null) (and (=> (= (ControlFlow 0 19) (- 0 20)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@3 SnapTree.Node.right))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@3 SnapTree.Node.right)) (=> (and (and (or (not (= call2formal@this null)) (not true)) (and ($Is refType call2formal@this Tclass.SnapTree.Node) ($IsAlloc refType call2formal@this Tclass.SnapTree.Node $Heap@@5))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1))) (=> (and (and (and (and (or (not (= call2formal@this@0 null)) (not true)) (and ($Is refType call2formal@this@0 Tclass.SnapTree.Node) ($IsAlloc refType call2formal@this@0 Tclass.SnapTree.Node $Heap@1))) (and (|SnapTree.Node.NodeValid#canCall| $Heap@1 call2formal@this@0) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@1 call2formal@this@0))) (and (and (forall (($o@@26 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call2formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@26)) (or (not (= $o@@26 null)) (not true)))
 :qid |SnapshotableTreesdfy.296:30|
 :skolemid |851|
 :pattern (  (or (not (= $o@@26 null)) (not true)))
)) (forall (($o@@27 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call2formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@27)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@27) alloc)))))
 :qid |SnapshotableTreesdfy.296:30|
 :skolemid |852|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call2formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@27)))
))) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call2formal@this@0) SnapTree.Node.Contents)) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |x#0|)))))) (and (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) alloc)))) (forall (($o@@28 T@U) ) (!  (=> (and (or (not (= $o@@28 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@28) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@28) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@28)))
 :qid |SnapshotableTreesdfy.295:17|
 :skolemid |853|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@28))
))) (and ($HeapSucc $Heap@0 $Heap@1) (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 this@@3 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@3) SnapTree.Node.right ($Box refType call2formal@this@0)))))) (and (and ($IsGoodHeap $Heap@2) (= $Heap@4 $Heap@2)) (and (= |pos#0@2| |Llen#0@0|) (= (ControlFlow 0 19) 2))))) anon9_correct)))))))
(let ((anon3_correct  (=> (and (= |L#0@0| (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.left)) null) |Seq#Empty| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.left))) SnapTree.Node.Contents)))) (= |Llen#0@0| (+ (|Seq#Length| |L#0@0|) 1))) (and (=> (= (ControlFlow 0 29) 19) anon11_Then_correct) (=> (= (ControlFlow 0 29) 24) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.left)) null)) (not true)) (and (=> (= (ControlFlow 0 31) (- 0 32)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.left)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.left)) null)) (not true)) (=> (= (ControlFlow 0 31) 29) anon3_correct))))))
(let ((anon10_Then_correct  (=> (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) SnapTree.Node.left)) null) (= (ControlFlow 0 30) 29)) anon3_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#9| null $Heap@@5 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.Repr)))) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@5 $Heap@0) reveal_SnapTree.Node.NodeValid)) (and (=> (= (ControlFlow 0 33) 30) anon10_Then_correct) (=> (= (ControlFlow 0 33) 31) anon10_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@5) ($IsHeapAnchor $Heap@@5)) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.SnapTree.Node) ($IsAlloc refType this@@3 Tclass.SnapTree.Node $Heap@@5)))) (=> (and (and (and ($Is SeqType |L#0| (TSeq TInt)) ($IsAlloc SeqType |L#0| (TSeq TInt) $Heap@@5)) true) (and (and (= 5 $FunctionContextHeight) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@@5 this@@3)) (and (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@3) SnapTree.Node.data))) |x#0|) (= (ControlFlow 0 34) 33)))) anon0_correct))))
