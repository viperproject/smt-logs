...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split116)
...
)) (= (ControlFlow 0 2) (- 0 1)))) (forall ((|i#3| Int) (|j#1| Int) ) (!  (=> (and (and (<= |k#0@2| |i#3|) (< |i#3| |j#1|)) (< |j#1| |$rhs#1_1@1|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $nw@0) (IndexField |i#3|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $nw@0) (IndexField |j#1|))))))
