...
(declare-fun |lambda#40| (T@U T@U T@U T@U) T@U)
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@15 T@U) ($f@@3 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#40| |l#0| |l#1| |l#2| |l#3|) $o@@15 $f@@3))  (=> (and (or (not (= $o@@15 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@15) |l#2|)))) (= $o@@15 |l#3|)))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1954|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#40| |l#0| |l#1| |l#2| |l#3|) $o@@15 $f@@3))
)))
...
(assert (forall (($h@@14 T@U) ($o@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (or (not (= $o@@16 null)) (not true)) (= (dtype $o@@16) Tclass.SnapTree.Tree?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@16) SnapTree.Tree.root)) Tclass.SnapTree.Node?))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |672|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@16) SnapTree.Tree.root)))
)))
(assert (forall (($h@@15 T@U) ($o@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (or (not (= $o@@17 null)) (not true)) (= (dtype $o@@17) Tclass.SnapTree.Node?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@17) SnapTree.Node.left)) Tclass.SnapTree.Node?))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |820|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@17) SnapTree.Node.left)))
)))
(assert (forall (($h@@16 T@U) ($o@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (or (not (= $o@@18 null)) (not true)) (= (dtype $o@@18) Tclass.SnapTree.Node?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@18) SnapTree.Node.right)) Tclass.SnapTree.Node?))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |822|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@18) SnapTree.Node.right)))
)))
(assert (forall (($h@@17 T@U) ($o@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (or (not (= $o@@19 null)) (not true)) (= (dtype $o@@19) Tclass.SnapTree.Iterator?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@19) SnapTree.Iterator.T)) Tclass.SnapTree.Tree?))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1005|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@19) SnapTree.Iterator.T)))
)))
(assert (forall (($h@@18 T@U) ($o@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (or (not (= $o@@20 null)) (not true)) (= (dtype $o@@20) Tclass.SnapTree.Iterator?))) ($Is DatatypeTypeType ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@20) SnapTree.Iterator.stack)) Tclass.SnapTree.List))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1009|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@20) SnapTree.Iterator.stack)))
)))
...
(assert (forall (($h@@19 T@U) ($o@@21 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@19) (and (or (not (= $o@@21 null)) (not true)) (= (dtype $o@@21) Tclass.SnapTree.Tree?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@21) alloc)))) ($IsAlloc SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@21) SnapTree.Tree.Contents)) (TSeq TInt) $h@@19))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |664|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@21) SnapTree.Tree.Contents)))
)))
(assert (forall (($h@@20 T@U) ($o@@22 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@20) (and (or (not (= $o@@22 null)) (not true)) (= (dtype $o@@22) Tclass.SnapTree.Node?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@20 $o@@22) alloc)))) ($IsAlloc SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@20 $o@@22) SnapTree.Node.Contents)) (TSeq TInt) $h@@20))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |815|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@20 $o@@22) SnapTree.Node.Contents)))
)))
(assert (forall (($h@@21 T@U) ($o@@23 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@21) (and (or (not (= $o@@23 null)) (not true)) (= (dtype $o@@23) Tclass.SnapTree.Iterator?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@21 $o@@23) alloc)))) ($IsAlloc SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@21 $o@@23) SnapTree.Iterator.Contents)) (TSeq TInt) $h@@21))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1002|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@21 $o@@23) SnapTree.Iterator.Contents)))
)))
...
(assert (forall (($h@@22 T@U) ($o@@24 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@22) (and (or (not (= $o@@24 null)) (not true)) (= (dtype $o@@24) Tclass.SnapTree.Tree?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@22 $o@@24) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@22 $o@@24) SnapTree.Tree.root)) Tclass.SnapTree.Node? $h@@22))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |673|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@22 $o@@24) SnapTree.Tree.root)))
)))
(assert (forall (($h@@23 T@U) ($o@@25 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@23) (and (or (not (= $o@@25 null)) (not true)) (= (dtype $o@@25) Tclass.SnapTree.Node?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@23 $o@@25) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@23 $o@@25) SnapTree.Node.left)) Tclass.SnapTree.Node? $h@@23))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |821|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@23 $o@@25) SnapTree.Node.left)))
)))
(assert (forall (($h@@24 T@U) ($o@@26 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@24) (and (or (not (= $o@@26 null)) (not true)) (= (dtype $o@@26) Tclass.SnapTree.Node?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@24 $o@@26) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@24 $o@@26) SnapTree.Node.right)) Tclass.SnapTree.Node? $h@@24))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |823|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@24 $o@@26) SnapTree.Node.right)))
)))
(assert (forall (($h@@25 T@U) ($o@@27 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@25) (and (or (not (= $o@@27 null)) (not true)) (= (dtype $o@@27) Tclass.SnapTree.Iterator?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@25 $o@@27) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@25 $o@@27) SnapTree.Iterator.T)) Tclass.SnapTree.Tree? $h@@25))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1006|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@25 $o@@27) SnapTree.Iterator.T)))
)))
(assert (forall (($h@@26 T@U) ($o@@28 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@26) (and (or (not (= $o@@28 null)) (not true)) (= (dtype $o@@28) Tclass.SnapTree.Iterator?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@26 $o@@28) alloc)))) ($IsAlloc DatatypeTypeType ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@26 $o@@28) SnapTree.Iterator.stack)) Tclass.SnapTree.List $h@@26))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1010|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@26 $o@@28) SnapTree.Iterator.stack)))
)))
...
(assert (forall (($h@@27 T@U) ($o@@30 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (or (not (= $o@@30 null)) (not true)) (= (dtype $o@@30) Tclass.SnapTree.Tree?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@27 $o@@30) SnapTree.Tree.Repr)) (TSet Tclass._System.object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |667|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@27 $o@@30) SnapTree.Tree.Repr)))
)))
(assert (forall (($h@@28 T@U) ($o@@31 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (or (not (= $o@@31 null)) (not true)) (= (dtype $o@@31) Tclass.SnapTree.Tree?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@28 $o@@31) SnapTree.Tree.MutableRepr)) (TSet Tclass._System.object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |669|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@28 $o@@31) SnapTree.Tree.MutableRepr)))
)))
(assert (forall (($h@@29 T@U) ($o@@32 T@U) ) (!  (=> (and ($IsGoodHeap $h@@29) (and (or (not (= $o@@32 null)) (not true)) (= (dtype $o@@32) Tclass.SnapTree.Node?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@29 $o@@32) SnapTree.Node.Repr)) (TSet Tclass._System.object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |816|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@29 $o@@32) SnapTree.Node.Repr)))
)))
(assert (forall (($h@@30 T@U) ($o@@33 T@U) ) (!  (=> (and ($IsGoodHeap $h@@30) (and (or (not (= $o@@33 null)) (not true)) (= (dtype $o@@33) Tclass.SnapTree.Iterator?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@30 $o@@33) SnapTree.Iterator.IterRepr)) (TSet Tclass._System.object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |999|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@30 $o@@33) SnapTree.Iterator.IterRepr)))
)))
(assert (forall (($h@@31 T@U) ($o@@34 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@31) (and (or (not (= $o@@34 null)) (not true)) (= (dtype $o@@34) Tclass.SnapTree.Tree?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@31 $o@@34) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@31 $o@@34) SnapTree.Tree.Repr)) (TSet Tclass._System.object) $h@@31))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |668|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@31 $o@@34) SnapTree.Tree.Repr)))
)))
(assert (forall (($h@@32 T@U) ($o@@35 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@32) (and (or (not (= $o@@35 null)) (not true)) (= (dtype $o@@35) Tclass.SnapTree.Tree?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@32 $o@@35) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@32 $o@@35) SnapTree.Tree.MutableRepr)) (TSet Tclass._System.object) $h@@32))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |670|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@32 $o@@35) SnapTree.Tree.MutableRepr)))
)))
(assert (forall (($h@@33 T@U) ($o@@36 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@33) (and (or (not (= $o@@36 null)) (not true)) (= (dtype $o@@36) Tclass.SnapTree.Node?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@33 $o@@36) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@33 $o@@36) SnapTree.Node.Repr)) (TSet Tclass._System.object) $h@@33))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |817|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@33 $o@@36) SnapTree.Node.Repr)))
)))
(assert (forall (($h@@34 T@U) ($o@@37 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@34) (and (or (not (= $o@@37 null)) (not true)) (= (dtype $o@@37) Tclass.SnapTree.Iterator?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@34 $o@@37) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@34 $o@@37) SnapTree.Iterator.IterRepr)) (TSet Tclass._System.object) $h@@34))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1000|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@34 $o@@37) SnapTree.Iterator.IterRepr)))
)))
...
(assert (forall ((v@@6 T@U) (t0@@2 T@U) (h@@3 T@U) ) (! (= ($IsAlloc SetType v@@6 (TSet t0@@2) h@@3) (forall ((bx@@13 T@U) ) (!  (=> (|Set#IsMember| v@@6 bx@@13) ($IsAllocBox bx@@13 t0@@2 h@@3))
...
(assert (forall (($o@@38 T@U) ) (! ($Is refType $o@@38 Tclass._System.object?)
 :qid |unknown.0:0|
 :skolemid |347|
 :pattern ( ($Is refType $o@@38 Tclass._System.object?))
)))
(assert (forall ((v@@7 T@U) (t0@@3 T@U) (h@@4 T@U) ) (! (= ($IsAlloc SeqType v@@7 (TSeq t0@@3) h@@4) (forall ((i@@3 Int) ) (!  (=> (and (<= 0 i@@3) (< i@@3 (|Seq#Length| v@@7))) ($IsAllocBox (|Seq#Index| v@@7 i@@3) t0@@3 h@@4))
...
(assert (forall (($h@@35 T@U) ($o@@39 T@U) ) (!  (=> (and ($IsGoodHeap $h@@35) (and (or (not (= $o@@39 null)) (not true)) (= (dtype $o@@39) Tclass.SnapTree.Tree?))) ($Is boolType ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@35 $o@@39) SnapTree.Tree.IsReadonly)) TBool))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |665|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@35 $o@@39) SnapTree.Tree.IsReadonly)))
)))
(assert (forall (($h@@36 T@U) ($o@@40 T@U) ) (!  (=> (and ($IsGoodHeap $h@@36) (and (or (not (= $o@@40 null)) (not true)) (= (dtype $o@@40) Tclass.SnapTree.Tree?))) ($Is boolType ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@36 $o@@40) SnapTree.Tree.reprIsShared)) TBool))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |674|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@36 $o@@40) SnapTree.Tree.reprIsShared)))
)))
(assert (forall (($h@@37 T@U) ($o@@41 T@U) ) (!  (=> (and ($IsGoodHeap $h@@37) (and (or (not (= $o@@41 null)) (not true)) (= (dtype $o@@41) Tclass.SnapTree.Node?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@37 $o@@41) SnapTree.Node.data)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |818|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@37 $o@@41) SnapTree.Node.data)))
)))
(assert (forall (($h@@38 T@U) ($o@@42 T@U) ) (!  (=> (and ($IsGoodHeap $h@@38) (and (or (not (= $o@@42 null)) (not true)) (= (dtype $o@@42) Tclass.SnapTree.Iterator?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@38 $o@@42) SnapTree.Iterator.N)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1003|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@38 $o@@42) SnapTree.Iterator.N)))
)))
(assert (forall (($h@@39 T@U) ($o@@43 T@U) ) (!  (=> (and ($IsGoodHeap $h@@39) (and (or (not (= $o@@43 null)) (not true)) (= (dtype $o@@43) Tclass.SnapTree.Iterator?))) ($Is boolType ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@39 $o@@43) SnapTree.Iterator.initialized)) TBool))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1007|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@39 $o@@43) SnapTree.Iterator.initialized)))
)))
...
(assert (forall (($reveal@@6 Bool) ($h0@@4 T@U) ($h1@@4 T@U) (this@@7 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@4) ($IsGoodHeap $h1@@4)) (and (or (not (= this@@7 null)) (not true)) ($Is refType this@@7 Tclass.SnapTree.Iterator))) (and ($IsHeapAnchor $h0@@4) ($HeapSucc $h0@@4 $h1@@4))) (=> (forall (($o@@47 T@U) ($f@@5 T@U) ) (!  (=> (and (or (not (= $o@@47 null)) (not true)) (or (or (or (= $o@@47 this@@7) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 this@@7) SnapTree.Iterator.IterRepr)) ($Box refType $o@@47))) (= $o@@47 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 this@@7) SnapTree.Iterator.T)))) (|Set#IsMember| (ite  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 this@@7) SnapTree.Iterator.T)) null)) (not true)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 this@@7) SnapTree.Iterator.T))) SnapTree.Tree.Repr)) |Set#Empty|) ($Box refType $o@@47)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 $o@@47) $f@@5) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@4 $o@@47) $f@@5)))
 :qid |unknown.0:0|
 :skolemid |1011|
...
(set-info :boogie-vc-id CheckWellFormed$$SnapTree.Iterator.Init__Aux)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 32) (let ((anon13_correct  (=> (and (and (forall (($o@@48 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@9) SnapTree.Iterator.IterRepr)) ($Box refType $o@@48)) (or (not (= $o@@48 this@@9)) (not true))) (or (not (= $o@@48 null)) (not true)))
 :qid |SnapshotableTreesdfy.547:15|
 :skolemid |1043|
 :pattern (  (or (not (= $o@@48 null)) (not true)))
)) (forall (($o@@49 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@9) SnapTree.Iterator.IterRepr)) ($Box refType $o@@49)) (or (not (= $o@@49 this@@9)) (not true))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 $o@@49) alloc)))))
 :qid |SnapshotableTreesdfy.547:15|
 :skolemid |1044|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 $o@@49) alloc)))
))) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@9) SnapTree.Iterator.T)) |t#0|) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= |t#0| null)) (not true)))))
(let ((anon17_Else_correct  (=> (and (=> (SnapTree.Tree.Valid reveal_SnapTree.Tree.Valid $Heap@0 |t#0|) (SnapTree.Iterator.Valid reveal_SnapTree.Iterator.Valid $Heap@0 this@@9)) (= (ControlFlow 0 5) 2)) anon13_correct)))
(let ((anon17_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= |t#0| null)) (not true))) (=> (or (not (= |t#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |t#0|) Tclass.SnapTree.Tree? $Heap@0) (=> (and (|SnapTree.Tree.Valid#canCall| $Heap@0 |t#0|) (SnapTree.Tree.Valid reveal_SnapTree.Tree.Valid $Heap@0 |t#0|)) (=> (and (and ($IsAllocBox ($Box refType this@@9) Tclass.SnapTree.Iterator? $Heap@0) (|SnapTree.Iterator.Valid#canCall| $Heap@0 this@@9)) (and (SnapTree.Iterator.Valid reveal_SnapTree.Iterator.Valid $Heap@0 this@@9) (= (ControlFlow 0 3) 2))) anon13_correct)))))))
(let ((anon10_correct  (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@50 T@U) ) (!  (=> (and (or (not (= $o@@50 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 $o@@50) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@50) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 $o@@50)) (= $o@@50 this@@9)))
 :qid |SnapshotableTreesdfy.539:12|
 :skolemid |1042|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@50))
)) ($HeapSucc $Heap@@11 $Heap@0))) (and (=> (= (ControlFlow 0 6) 3) anon17_Then_correct) (=> (= (ControlFlow 0 6) 5) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (and (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root)) null)) (not true)) (and (and (<= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root))) SnapTree.Node.Contents))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.Contents)))) (|Seq#SameUntil| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root))) SnapTree.Node.Contents)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.Contents)) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root))) SnapTree.Node.Contents))))) (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.Contents))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root))) SnapTree.Node.Contents)))))) (= (ControlFlow 0 15) 6)) anon10_correct)))
(let ((anon16_Then_correct  (and (=> (= (ControlFlow 0 7) (- 0 14)) (or (not (= |t#0| null)) (not true))) (=> (or (not (= |t#0| null)) (not true)) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root)) null)) (not true)) (and (=> (= (ControlFlow 0 7) (- 0 13)) (or (not (= |t#0| null)) (not true))) (=> (or (not (= |t#0| null)) (not true)) (and (=> (= (ControlFlow 0 7) (- 0 12)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root)) null)) (not true)) (and (=> (= (ControlFlow 0 7) (- 0 11)) (or (not (= |t#0| null)) (not true))) (=> (or (not (= |t#0| null)) (not true)) (=> (and (<= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root))) SnapTree.Node.Contents))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.Contents)))) (|Seq#SameUntil| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root))) SnapTree.Node.Contents)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.Contents)) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root))) SnapTree.Node.Contents))))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (or (not (= |t#0| null)) (not true))) (=> (or (not (= |t#0| null)) (not true)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (or (not (= |t#0| null)) (not true))) (=> (or (not (= |t#0| null)) (not true)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root)) null)) (not true)) (=> (and (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.Contents))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root))) SnapTree.Node.Contents)))) (= (ControlFlow 0 7) 6)) anon10_correct)))))))))))))))))))
(let ((anon15_Else_correct  (=> (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root)) null)) (not true)) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root))) SnapTree.Node.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.Repr)))) (SnapTree.Node.NodeValid ($LS $LZ) reveal_SnapTree.Node.NodeValid $Heap@@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root))))) (and (=> (= (ControlFlow 0 25) 7) anon16_Then_correct) (=> (= (ControlFlow 0 25) 15) anon16_Else_correct)))))
(let ((anon15_Then_correct  (and (=> (= (ControlFlow 0 16) (- 0 24)) (or (not (= |t#0| null)) (not true))) (=> (or (not (= |t#0| null)) (not true)) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root)) null)) (not true)) (and (=> (= (ControlFlow 0 16) (- 0 23)) (or (not (= |t#0| null)) (not true))) (=> (or (not (= |t#0| null)) (not true)) (and (=> (= (ControlFlow 0 16) (- 0 22)) (or (not (= |t#0| null)) (not true))) (=> (or (not (= |t#0| null)) (not true)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root)) (and (=> (= (ControlFlow 0 16) (- 0 21)) (or (not (= |t#0| null)) (not true))) (=> (or (not (= |t#0| null)) (not true)) (and (=> (= (ControlFlow 0 16) (- 0 20)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root)) null)) (not true)) (and (=> (= (ControlFlow 0 16) (- 0 19)) (or (not (= |t#0| null)) (not true))) (=> (or (not (= |t#0| null)) (not true)) (=> (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root))) SnapTree.Node.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.Repr))) (and (=> (= (ControlFlow 0 16) (- 0 18)) (or (not (= |t#0| null)) (not true))) (=> (or (not (= |t#0| null)) (not true)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root)) null)) (not true)) (=> ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root) Tclass.SnapTree.Node? $Heap@@11) (=> (and (|SnapTree.Node.NodeValid#canCall| $Heap@@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root))) (SnapTree.Node.NodeValid ($LS $LZ) reveal_SnapTree.Node.NodeValid $Heap@@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root)))) (and (=> (= (ControlFlow 0 16) 7) anon16_Then_correct) (=> (= (ControlFlow 0 16) 15) anon16_Else_correct)))))))))))))))))))))))))
(let ((anon14_Else_correct  (=> (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root)) null) (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.Contents))) (LitInt 0))) (and (=> (= (ControlFlow 0 29) 16) anon15_Then_correct) (=> (= (ControlFlow 0 29) 25) anon15_Else_correct)))))
(let ((anon14_Then_correct  (and (=> (= (ControlFlow 0 26) (- 0 28)) (or (not (= |t#0| null)) (not true))) (=> (or (not (= |t#0| null)) (not true)) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root)) null) (and (=> (= (ControlFlow 0 26) (- 0 27)) (or (not (= |t#0| null)) (not true))) (=> (or (not (= |t#0| null)) (not true)) (=> (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.Contents))) (LitInt 0)) (and (=> (= (ControlFlow 0 26) 16) anon15_Then_correct) (=> (= (ControlFlow 0 26) 25) anon15_Else_correct))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#40| null $Heap@@11 alloc this@@9)) (and (=> (= (ControlFlow 0 30) (- 0 31)) (or (not (= |t#0| null)) (not true))) (=> (or (not (= |t#0| null)) (not true)) (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.Repr)) ($Box refType this@@9))) (and (=> (= (ControlFlow 0 30) 26) anon14_Then_correct) (=> (= (ControlFlow 0 30) 29) anon14_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@11) ($IsHeapAnchor $Heap@@11)) (and (or (not (= this@@9 null)) (not true)) (and ($Is refType this@@9 Tclass.SnapTree.Iterator) ($IsAlloc refType this@@9 Tclass.SnapTree.Iterator $Heap@@11)))) (and (and ($Is refType |t#0| Tclass.SnapTree.Tree) ($IsAlloc refType |t#0| Tclass.SnapTree.Tree $Heap@@11)) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 32) 30)))) anon0_correct)))
