...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.MinimumWindowMax_split7)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_correct  (=> (and (and (and (<= (LitInt 1) |W#0|) (<= |W#0| (_System.array.Length |a#0|))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (forall (($o@@4 T@U) ) (!  (=> (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@4) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@4)))
 :qid |MinWindowMaxdfy.28:56|
 :skolemid |657|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4))
)) ($HeapSucc $Heap $Heap@0)) (and (<= (LitInt 0) |start#0@0|) (= (ControlFlow 0 2) (- 0 1))))) (or (not (= |a#0| null)) (not true)))))
(let ((anon11_Else_correct  (=> (and (< |W#0| (LitInt 1)) (= (ControlFlow 0 4) 2)) anon3_correct)))
(let ((anon11_Then_correct  (=> (<= (LitInt 1) |W#0|) (=> (and (or (not (= |a#0| null)) (not true)) (= (ControlFlow 0 3) 2)) anon3_correct))))
(let ((anon0_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (and (= 3 $FunctionContextHeight) (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)))) (and (=> (= (ControlFlow 0 5) 3) anon11_Then_correct) (=> (= (ControlFlow 0 5) 4) anon11_Else_correct))))))
anon0_correct)))))
))
(check-sat)
(get-info :rlimit)
