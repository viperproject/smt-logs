...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split153)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon129_Then_correct  (=> (and (and (<= (ite (< |k#0@0| |l#0@4|) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1))))) 1) (- |n#0@3| |W#0|)) |i#1_0@0|) (< |i#1_0@0| |n#0@3|)) (and (or (not (= |a#0@@4| null)) (not true)) (= (ControlFlow 0 2) (- 0 1)))) (and (<= 0 |i#1_0@0|) (< |i#1_0@0| (_System.array.Length |a#0@@4|))))))
(let ((anon128_Else_correct  (=> (and (< |i#1_0@0| (ite (< |k#0@0| |l#0@4|) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1))))) 1) (- |n#0@3| |W#0|))) (= (ControlFlow 0 4) 2)) anon129_Then_correct)))
(let ((anon128_Then_correct  (=> (and (<= (ite (< |k#0@0| |l#0@4|) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1))))) 1) (- |n#0@3| |W#0|)) |i#1_0@0|) (= (ControlFlow 0 3) 2)) anon129_Then_correct)))
(let ((anon127_Else_correct  (=> (<= |l#0@4| |k#0@0|) (and (=> (= (ControlFlow 0 6) 3) anon128_Then_correct) (=> (= (ControlFlow 0 6) 4) anon128_Else_correct)))))
(let ((anon127_Then_correct  (=> (and (< |k#0@0| |l#0@4|) (or (not (= $nw@0 null)) (not true))) (and (=> (= (ControlFlow 0 5) 3) anon128_Then_correct) (=> (= (ControlFlow 0 5) 4) anon128_Else_correct)))))
(let ((anon65_correct  (=> (and (<= |k#0@0| |l#0@4|) (<= |l#0@4| |n#0@3|)) (and (=> (= (ControlFlow 0 7) 5) anon127_Then_correct) (=> (= (ControlFlow 0 7) 6) anon127_Else_correct)))))
(let ((anon125_Else_correct  (=> (and (< |l#0@4| |k#0@0|) (= (ControlFlow 0 9) 7)) anon65_correct)))
(let ((anon125_Then_correct  (=> (and (<= |k#0@0| |l#0@4|) (= (ControlFlow 0 8) 7)) anon65_correct)))
