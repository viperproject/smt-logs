...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|t#0@@1| T@U) ) (!  (=> (or (|PriorityQueue__extrinsic.__default.Min#canCall| (Lit DatatypeTypeType |t#0@@1|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |t#0@@1| Tclass.PriorityQueue__extrinsic.T) (not (|MultiSet#Equal| (PriorityQueue__extrinsic.__default.Elements ($LS $LZ) (Lit DatatypeTypeType |t#0@@1|)) |MultiSet#Empty|))))) (= (PriorityQueue__extrinsic.__default.Min (Lit DatatypeTypeType |t#0@@1|)) (LitInt (PriorityQueue__extrinsic.T.val (Lit DatatypeTypeType |t#0@@1|)))))
 :qid |pqintrinsicextrinsicdfy.239:16|
 :weight 3
 :skolemid |557|
 :pattern ( (PriorityQueue__extrinsic.__default.Min (Lit DatatypeTypeType |t#0@@1|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@1 T@U) (|t#0@@2| T@U) ) (!  (=> (or (|PriorityQueue__extrinsic.__default.Elements#canCall| |t#0@@2|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |t#0@@2| Tclass.PriorityQueue__extrinsic.T))) (and (=> (not (PriorityQueue__extrinsic.T.Leaf_q |t#0@@2|)) (let ((|right#1| (PriorityQueue__extrinsic.T.right |t#0@@2|)))
(let ((|left#1| (PriorityQueue__extrinsic.T.left |t#0@@2|)))
 (and (|PriorityQueue__extrinsic.__default.Elements#canCall| |left#1|) (|PriorityQueue__extrinsic.__default.Elements#canCall| |right#1|))))) (= (PriorityQueue__extrinsic.__default.Elements ($LS $ly@@1) |t#0@@2|) (ite (PriorityQueue__extrinsic.T.Leaf_q |t#0@@2|) |MultiSet#Empty| (let ((|right#0| (PriorityQueue__extrinsic.T.right |t#0@@2|)))
...
(|MultiSet#Union| (|MultiSet#Union| (|MultiSet#UnionOne| |MultiSet#Empty| ($Box intType (int_2_U |x#0|))) (PriorityQueue__extrinsic.__default.Elements $ly@@1 |left#0|)) (PriorityQueue__extrinsic.__default.Elements $ly@@1 |right#0|)))))))))
 :qid |pqintrinsicextrinsicdfy.199:18|
 :skolemid |541|
 :pattern ( (PriorityQueue__extrinsic.__default.Elements ($LS $ly@@1) |t#0@@2|))
))))
...
(assert (forall (($ly@@2 T@U) (|t#0@@3| T@U) ) (! (= (PriorityQueue__extrinsic.__default.Elements ($LS $ly@@2) |t#0@@3|) (PriorityQueue__extrinsic.__default.Elements $ly@@2 |t#0@@3|))
 :qid |pqintrinsicextrinsicdfy.199:18|
 :skolemid |537|
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|t#0@@4| T@U) ) (!  (=> (or (|PriorityQueue__extrinsic.__default.Min#canCall| |t#0@@4|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |t#0@@4| Tclass.PriorityQueue__extrinsic.T) (not (|MultiSet#Equal| (PriorityQueue__extrinsic.__default.Elements ($LS $LZ) |t#0@@4|) |MultiSet#Empty|))))) (= (PriorityQueue__extrinsic.__default.Min |t#0@@4|) (PriorityQueue__extrinsic.T.val |t#0@@4|)))
 :qid |pqintrinsicextrinsicdfy.239:16|
 :skolemid |556|
 :pattern ( (PriorityQueue__extrinsic.__default.Min |t#0@@4|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$PriorityQueue__extrinsic.__default.Min)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (PriorityQueue__extrinsic.T.Node_q |t#0@@5|))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) ($IsAlloc DatatypeTypeType |t#0@@5| Tclass.PriorityQueue__extrinsic.T $Heap)) (and (|PriorityQueue__extrinsic.__default.Elements#canCall| |t#0@@5|) (not (|MultiSet#Equal| (PriorityQueue__extrinsic.__default.Elements ($LS $LZ) |t#0@@5|) |MultiSet#Empty|)))) (and (=> (= (ControlFlow 0 4) 1) anon5_Then_correct) (=> (= (ControlFlow 0 4) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |t#0@@5| Tclass.PriorityQueue__extrinsic.T)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct)))
