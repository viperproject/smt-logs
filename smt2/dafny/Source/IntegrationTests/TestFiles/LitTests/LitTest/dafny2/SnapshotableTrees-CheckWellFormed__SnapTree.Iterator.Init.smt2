...
(set-info :boogie-vc-id CheckWellFormed$$SnapTree.Iterator.Init)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@11 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |t#0| null)) (not true))) (=> (or (not (= |t#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |t#0|) Tclass.SnapTree.Tree? $Heap@@11) (=> (and (|SnapTree.Tree.Valid#canCall| $Heap@@11 |t#0|) (SnapTree.Tree.Valid reveal_SnapTree.Tree.Valid $Heap@@11 |t#0|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@48 T@U) ) (!  (=> (and (or (not (= $o@@48 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 $o@@48) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@48) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 $o@@48)))
 :qid |SnapshotableTreesdfy.528:17|
 :skolemid |1029|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@48))
)) ($HeapSucc $Heap@@11 $Heap@0))) (=> (and (and (and (and (or (not (= this@0 null)) (not true)) (and ($Is refType this@0 Tclass.SnapTree.Iterator) ($IsAlloc refType this@0 Tclass.SnapTree.Iterator $Heap@0))) ($IsAllocBox ($Box refType this@0) Tclass.SnapTree.Iterator? $Heap@0)) (and (|SnapTree.Iterator.Valid#canCall| $Heap@0 this@0) (SnapTree.Iterator.Valid reveal_SnapTree.Iterator.Valid $Heap@0 this@0))) (and (and (forall (($o@@49 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) SnapTree.Iterator.IterRepr)) ($Box refType $o@@49)) (or (not (= $o@@49 null)) (not true)))
 :qid |SnapshotableTreesdfy.530:26|
 :skolemid |1030|
 :pattern (  (or (not (= $o@@49 null)) (not true)))
)) (forall (($o@@50 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) SnapTree.Iterator.IterRepr)) ($Box refType $o@@50)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 $o@@50) alloc)))))
 :qid |SnapshotableTreesdfy.530:26|
 :skolemid |1031|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) SnapTree.Iterator.IterRepr)) ($Box refType $o@@50)))
))) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) SnapTree.Iterator.T)) |t#0|) (= (ControlFlow 0 2) (- 0 1))))) (or (not (= |t#0| null)) (not true)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@11) ($IsHeapAnchor $Heap@@11)) (=> (and (and ($Is refType |t#0| Tclass.SnapTree.Tree) ($IsAlloc refType |t#0| Tclass.SnapTree.Tree $Heap@@11)) (and (= 7 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
