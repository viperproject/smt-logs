...
(declare-fun |r#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$SnapTree.Node.FunctionalInsert)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 39) (let ((anon24_correct  (=> (and (and (<= (LitInt 0) |pos#0@0|) (< |pos#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) SnapTree.Node.Contents))))) (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) SnapTree.Node.Contents))) (+ (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0|) SnapTree.Node.Contents))) 1))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (or (not (= |r#0@0| null)) (not true))) (=> (or (not (= |r#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (and (<= 0 |pos#0@0|) (<= |pos#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0|) SnapTree.Node.Contents)))))) (=> (and (<= 0 |pos#0@0|) (<= |pos#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0|) SnapTree.Node.Contents))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (=> (= (ControlFlow 0 3) (- 0 2)) (and (<= 0 |pos#0@0|) (<= |pos#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0|) SnapTree.Node.Contents)))))))))))))))))
(let ((anon34_Else_correct  (=> (and (not (and (<= (LitInt 0) |pos#0@0|) (< |pos#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) SnapTree.Node.Contents)))))) (= (ControlFlow 0 11) 3)) anon24_correct)))
(let ((anon34_Then_correct  (=> (and (<= (LitInt 0) |pos#0@0|) (< |pos#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) SnapTree.Node.Contents))))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (or (not (= |r#0@0| null)) (not true))) (=> (or (not (= |r#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (=> (= (ControlFlow 0 8) 3) anon24_correct))))))))
(let ((anon33_Else_correct  (=> (< |pos#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 14) 8) anon34_Then_correct) (=> (= (ControlFlow 0 14) 11) anon34_Else_correct)))))
(let ((anon33_Then_correct  (=> (<= (LitInt 0) |pos#0@0|) (and (=> (= (ControlFlow 0 12) (- 0 13)) (or (not (= |r#0@0| null)) (not true))) (=> (or (not (= |r#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 12) 8) anon34_Then_correct) (=> (= (ControlFlow 0 12) 11) anon34_Else_correct)))))))
(let ((anon32_Then_correct  (=> (or (not (= |n#0| null)) (not true)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (and (=> (= (ControlFlow 0 15) 12) anon33_Then_correct) (=> (= (ControlFlow 0 15) 14) anon33_Else_correct))))))))
(let ((anon32_Else_correct true))
(let ((anon31_Else_correct  (=> (=> (and (or (not (= |n#0| null)) (not true)) (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (and (= |r#0@0| |n#0|) (< |pos#0@0| 0))) (and (=> (= (ControlFlow 0 19) 15) anon32_Then_correct) (=> (= (ControlFlow 0 19) 1) anon32_Else_correct)))))
(let ((anon31_Then_correct  (=> (or (not (= |n#0| null)) (not true)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))) (=> (and (= |r#0@0| |n#0|) (< |pos#0@0| 0)) (and (=> (= (ControlFlow 0 17) 15) anon32_Then_correct) (=> (= (ControlFlow 0 17) 1) anon32_Else_correct)))))))))
(let ((anon30_Else_correct  (=> (=> (= |n#0| null) (and (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) SnapTree.Node.Contents)) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |x#0|)))) (= |pos#0@0| (LitInt 0)))) (and (=> (= (ControlFlow 0 22) 17) anon31_Then_correct) (=> (= (ControlFlow 0 22) 19) anon31_Else_correct)))))
(let ((anon30_Then_correct  (=> (= |n#0| null) (and (=> (= (ControlFlow 0 20) (- 0 21)) (or (not (= |r#0@0| null)) (not true))) (=> (or (not (= |r#0@0| null)) (not true)) (=> (and (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) SnapTree.Node.Contents)) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |x#0|)))) (= |pos#0@0| (LitInt 0))) (and (=> (= (ControlFlow 0 20) 17) anon31_Then_correct) (=> (= (ControlFlow 0 20) 19) anon31_Else_correct))))))))
(let ((anon29_Else_correct  (=> (=> (or (not (= |n#0| null)) (not true)) (and (forall (($o@@17 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@17)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0|) SnapTree.Node.Repr)) ($Box refType $o@@17)))) (or (not (= $o@@17 null)) (not true)))
 :qid |SnapshotableTreesdfy.342:29|
 :skolemid |913|
 :pattern (  (or (not (= $o@@17 null)) (not true)))
)) (forall (($o@@18 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@18)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0|) SnapTree.Node.Repr)) ($Box refType $o@@18)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@18) alloc)))))
 :qid |SnapshotableTreesdfy.342:29|
 :skolemid |914|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@18) alloc)))
)))) (and (=> (= (ControlFlow 0 26) 20) anon30_Then_correct) (=> (= (ControlFlow 0 26) 22) anon30_Else_correct)))))
(let ((anon29_Then_correct  (=> (or (not (= |n#0| null)) (not true)) (and (=> (= (ControlFlow 0 23) (- 0 25)) (or (not (= |r#0@0| null)) (not true))) (=> (or (not (= |r#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (=> (and (forall (($o@@19 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@19)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0|) SnapTree.Node.Repr)) ($Box refType $o@@19)))) (or (not (= $o@@19 null)) (not true)))
 :qid |SnapshotableTreesdfy.342:29|
 :skolemid |911|
 :pattern (  (or (not (= $o@@19 null)) (not true)))
)) (forall (($o@@20 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@20)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0|) SnapTree.Node.Repr)) ($Box refType $o@@20)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@20) alloc)))))
 :qid |SnapshotableTreesdfy.342:29|
 :skolemid |912|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@20) alloc)))
))) (and (=> (= (ControlFlow 0 23) 20) anon30_Then_correct) (=> (= (ControlFlow 0 23) 22) anon30_Else_correct))))))))))
(let ((anon28_Else_correct  (=> (=> (= |n#0| null) (and (forall (($o@@21 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@21)) (or (not (= $o@@21 null)) (not true)))
 :qid |SnapshotableTreesdfy.341:29|
 :skolemid |909|
 :pattern (  (or (not (= $o@@21 null)) (not true)))
)) (forall (($o@@22 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@22)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@22) alloc)))))
 :qid |SnapshotableTreesdfy.341:29|
 :skolemid |910|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@22)))
)))) (and (=> (= (ControlFlow 0 29) 23) anon29_Then_correct) (=> (= (ControlFlow 0 29) 26) anon29_Else_correct)))))
(let ((anon28_Then_correct  (=> (= |n#0| null) (and (=> (= (ControlFlow 0 27) (- 0 28)) (or (not (= |r#0@0| null)) (not true))) (=> (or (not (= |r#0@0| null)) (not true)) (=> (and (forall (($o@@23 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@23)) (or (not (= $o@@23 null)) (not true)))
 :qid |SnapshotableTreesdfy.341:29|
 :skolemid |907|
 :pattern (  (or (not (= $o@@23 null)) (not true)))
)) (forall (($o@@24 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@24)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@24) alloc)))))
 :qid |SnapshotableTreesdfy.341:29|
 :skolemid |908|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@24)))
))) (and (=> (= (ControlFlow 0 27) 23) anon29_Then_correct) (=> (= (ControlFlow 0 27) 26) anon29_Else_correct))))))))
(let ((anon7_correct  (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (forall (($o@@25 T@U) ) (!  (=> (and (or (not (= $o@@25 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@25) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@25) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@25)))
 :qid |SnapshotableTreesdfy.338:19|
 :skolemid |906|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@25))
)) ($HeapSucc $Heap@@5 $Heap@0)) (and ($Is refType |r#0@0| Tclass.SnapTree.Node) ($IsAlloc refType |r#0@0| Tclass.SnapTree.Node $Heap@0))) (and (=> (= (ControlFlow 0 30) (- 0 31)) (or (not (= |r#0@0| null)) (not true))) (=> (or (not (= |r#0@0| null)) (not true)) (=> ($IsAllocBox ($Box refType |r#0@0|) Tclass.SnapTree.Node? $Heap@0) (=> (and (|SnapTree.Node.NodeValid#canCall| $Heap@0 |r#0@0|) (SnapTree.Node.NodeValid ($LS $LZ) reveal_SnapTree.Node.NodeValid $Heap@0 |r#0@0|)) (and (=> (= (ControlFlow 0 30) 27) anon28_Then_correct) (=> (= (ControlFlow 0 30) 29) anon28_Else_correct))))))))))
(let ((anon27_Else_correct  (=> (or (not (= |n#0| null)) (not true)) (and (=> (= (ControlFlow 0 33) (- 0 34)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (=> (= (ControlFlow 0 33) 30) anon7_correct))))))
(let ((anon27_Then_correct  (=> (and (= |n#0| null) (= (ControlFlow 0 32) 30)) anon7_correct)))
(let ((anon26_Else_correct  (=> (=> (or (not (= |n#0| null)) (not true)) (SnapTree.Node.NodeValid ($LS $LZ) reveal_SnapTree.Node.NodeValid $Heap@@5 |n#0|)) (and (=> (= (ControlFlow 0 37) 32) anon27_Then_correct) (=> (= (ControlFlow 0 37) 33) anon27_Else_correct)))))
(let ((anon26_Then_correct  (=> (or (not (= |n#0| null)) (not true)) (and (=> (= (ControlFlow 0 35) (- 0 36)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |n#0|) Tclass.SnapTree.Node? $Heap@@5) (=> (and (|SnapTree.Node.NodeValid#canCall| $Heap@@5 |n#0|) (SnapTree.Node.NodeValid ($LS $LZ) reveal_SnapTree.Node.NodeValid $Heap@@5 |n#0|)) (and (=> (= (ControlFlow 0 35) 32) anon27_Then_correct) (=> (= (ControlFlow 0 35) 33) anon27_Else_correct)))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@5 alloc false)) (and (=> (= (ControlFlow 0 38) 35) anon26_Then_correct) (=> (= (ControlFlow 0 38) 37) anon26_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@5) ($IsHeapAnchor $Heap@@5)) (and ($Is refType |n#0| Tclass.SnapTree.Node?) ($IsAlloc refType |n#0| Tclass.SnapTree.Node? $Heap@@5))) (and (and ($Is refType |r#0| Tclass.SnapTree.Node) ($IsAlloc refType |r#0| Tclass.SnapTree.Node $Heap@@5)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 39) 38)))) anon0_correct)))
