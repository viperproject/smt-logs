...
(set-info :boogie-vc-id CheckWellFormed$$SnapTree.Iterator.MoveNext_split7)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon11_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) ($IsAlloc refType this@@9 Tclass.SnapTree.Iterator $Heap@@11))))
