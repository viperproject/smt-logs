...
(assert (forall (($h0@@1 T@U) ($h1@@1 T@U) (|a#0@@3| T@U) (|lo#0@@2| Int) (|x#0@@2| Int) (|hi#0@@2| Int) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@1) ($IsGoodHeap $h1@@1)) (or (|_module.__default.RightmostMax#canCall| $h0@@1 |a#0@@3| |lo#0@@2| |x#0@@2| |hi#0@@2|) ($Is refType |a#0@@3| (Tclass._System.array TInt)))) (and ($IsHeapAnchor $h0@@1) ($HeapSucc $h0@@1 $h1@@1))) (=> (forall (($o@@8 T@U) ($f@@2 T@U) )  (=> (and (or (not (= $o@@8 null)) (not true)) (= $o@@8 |a#0@@3|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@1 $o@@8) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@1 $o@@8) $f@@2)))) (= (_module.__default.RightmostMax $h0@@1 |a#0@@3| |lo#0@@2| |x#0@@2| |hi#0@@2|) (_module.__default.RightmostMax $h1@@1 |a#0@@3| |lo#0@@2| |x#0@@2| |hi#0@@2|))))
