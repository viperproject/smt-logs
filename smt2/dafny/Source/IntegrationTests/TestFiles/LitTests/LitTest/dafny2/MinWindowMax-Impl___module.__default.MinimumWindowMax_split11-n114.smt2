...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split115)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon90_correct  (=> (and (= |n#0@4| (+ |n#0@3| 1)) ($Is intType (int_2_U |W#0|) Tclass._System.nat)) (=> (and (and (<= (LitInt 0) |k#0@2|) (<= |k#0@2| |$rhs#1_1@1|)) (and (<= |$rhs#1_1@1| (_System.array.Length $nw@0)) (= (ControlFlow 0 2) (- 0 1)))) (forall ((|i#1@@1| Int) ) (!  (and (=> (and (<= |k#0@2| |i#1@@1|) (< |i#1@@1| |$rhs#1_1@1|)) (<= (- |n#0@4| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $nw@0) (IndexField |i#1@@1|)))))) (=> (and (<= |k#0@2| |i#1@@1|) (< |i#1@@1| |$rhs#1_1@1|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $nw@0) (IndexField |i#1@@1|)))) |n#0@4|)))
