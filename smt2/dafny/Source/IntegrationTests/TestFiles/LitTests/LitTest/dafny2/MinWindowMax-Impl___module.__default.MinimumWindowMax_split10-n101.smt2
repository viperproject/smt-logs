...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split102)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon87_correct  (=> (and (and (and (= |lo##1_0@1| (+ (- |n#0@3| |W#0|) 1)) (or (not (= $nw@0 null)) (not true))) (and (<= 0 |k#0@2|) (< |k#0@2| (_System.array.Length $nw@0)))) (and (and (= |x##1_0@1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $nw@0) (IndexField |k#0@2|))))) (= |hi##1_0@1| (+ |n#0@3| 1))) (and (<= (LitInt 0) |lo##1_0@1|) (= (ControlFlow 0 2) (- 0 1))))) (<= |lo##1_0@1| |x##1_0@1|))))
