...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.IsPrefixDuplicate)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon13_correct  (=> (and (= (_module.__default.IsPrefixDuplicate $Heap@@0 |a#0@@0| |k#0@@0| |p#0@@0|) (exists ((|i#2| Int) (|j#2| Int) ) (!  (and (and (and (<= (LitInt 0) |i#2|) (< |i#2| |j#2|)) (< |j#2| |k#0@@0|)) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |a#0@@0|) (IndexField |i#2|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |a#0@@0|) (IndexField |j#2|))))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |a#0@@0|) (IndexField |j#2|)))) |p#0@@0|)))
 :qid |COSTverifcomp20113TwoDuplicatesdfy.71:10|
 :skolemid |594|
...
))) ($Is boolType (bool_2_U (_module.__default.IsPrefixDuplicate $Heap@@0 |a#0@@0| |k#0@@0| |p#0@@0|)) TBool)) (and (=> (= (ControlFlow 0 4) (- 0 6)) |b$reqreads#0@1|) (=> |b$reqreads#0@1| (and (=> (= (ControlFlow 0 4) (- 0 5)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (=> (= (ControlFlow 0 4) (- 0 3)) |b$reqreads#2@1|))))))))
(let ((anon21_Else_correct  (=> (or (not (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |a#0@@0|) (IndexField |i#1@0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |a#0@@0|) (IndexField |j#1@0|)))))) (not true)) (=> (and (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 11) 4))) anon13_correct))))
(let ((anon21_Then_correct  (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |a#0@@0|) (IndexField |i#1@0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |a#0@@0|) (IndexField |j#1@0|))))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (or (not (= |a#0@@0| null)) (not true))) (=> (or (not (= |a#0@@0| null)) (not true)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (and (<= 0 |j#1@0|) (< |j#1@0| (_System.array.Length |a#0@@0|)))) (=> (and (<= 0 |j#1@0|) (< |j#1@0| (_System.array.Length |a#0@@0|))) (=> (= |b$reqreads#2@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |a#0@@0| (IndexField |j#1@0|)))) (=> (and (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= (ControlFlow 0 8) 4))) anon13_correct)))))))))
(let ((anon20_Then_correct  (=> (and (and (<= (LitInt 0) |i#1@0|) (< |i#1@0| |j#1@0|)) (< |j#1@0| |k#0@@0|)) (and (=> (= (ControlFlow 0 12) (- 0 16)) (or (not (= |a#0@@0| null)) (not true))) (=> (or (not (= |a#0@@0| null)) (not true)) (and (=> (= (ControlFlow 0 12) (- 0 15)) (and (<= 0 |i#1@0|) (< |i#1@0| (_System.array.Length |a#0@@0|)))) (=> (and (<= 0 |i#1@0|) (< |i#1@0| (_System.array.Length |a#0@@0|))) (=> (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |a#0@@0| (IndexField |i#1@0|)))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (or (not (= |a#0@@0| null)) (not true))) (=> (or (not (= |a#0@@0| null)) (not true)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (and (<= 0 |j#1@0|) (< |j#1@0| (_System.array.Length |a#0@@0|)))) (=> (and (<= 0 |j#1@0|) (< |j#1@0| (_System.array.Length |a#0@@0|))) (=> (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |a#0@@0| (IndexField |j#1@0|)))) (and (=> (= (ControlFlow 0 12) 8) anon21_Then_correct) (=> (= (ControlFlow 0 12) 11) anon21_Else_correct)))))))))))))))
(let ((anon20_Else_correct  (=> (not (and (and (<= (LitInt 0) |i#1@0|) (< |i#1@0| |j#1@0|)) (< |j#1@0| |k#0@@0|))) (=> (and (and (= |b$reqreads#0@1| true) (= |b$reqreads#1@1| true)) (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 7) 4))) anon13_correct))))
(let ((anon19_Else_correct  (=> (not (and (<= (LitInt 0) |i#1@0|) (< |i#1@0| |j#1@0|))) (and (=> (= (ControlFlow 0 18) 12) anon20_Then_correct) (=> (= (ControlFlow 0 18) 7) anon20_Else_correct)))))
(let ((anon19_Then_correct  (=> (and (<= (LitInt 0) |i#1@0|) (< |i#1@0| |j#1@0|)) (and (=> (= (ControlFlow 0 17) 12) anon20_Then_correct) (=> (= (ControlFlow 0 17) 7) anon20_Else_correct)))))
(let ((anon18_Else_correct  (=> (< |i#1@0| (LitInt 0)) (and (=> (= (ControlFlow 0 20) 17) anon19_Then_correct) (=> (= (ControlFlow 0 20) 18) anon19_Else_correct)))))
(let ((anon18_Then_correct  (=> (<= (LitInt 0) |i#1@0|) (and (=> (= (ControlFlow 0 19) 17) anon19_Then_correct) (=> (= (ControlFlow 0 19) 18) anon19_Else_correct)))))
...
(let ((anon3_correct  (=> (and (<= (LitInt 0) |k#0@@0|) (<= |k#0@@0| (_System.array.Length |a#0@@0|))) (and (and (=> (= (ControlFlow 0 22) 1) anon16_Then_correct) (=> (= (ControlFlow 0 22) 21) anon17_Then_correct)) (=> (= (ControlFlow 0 22) 2) anon17_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (< |k#0@@0| (LitInt 0)) (= (ControlFlow 0 25) 22)) anon3_correct)))
(let ((anon15_Then_correct  (=> (<= (LitInt 0) |k#0@@0|) (and (=> (= (ControlFlow 0 23) (- 0 24)) (or (not (= |a#0@@0| null)) (not true))) (=> (or (not (= |a#0@@0| null)) (not true)) (=> (= (ControlFlow 0 23) 22) anon3_correct))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@0 alloc |a#0@@0|)) (and (=> (= (ControlFlow 0 26) 23) anon15_Then_correct) (=> (= (ControlFlow 0 26) 25) anon15_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) ($Is refType |a#0@@0| (Tclass._System.array TInt))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 27) 26))) anon0_correct)))
