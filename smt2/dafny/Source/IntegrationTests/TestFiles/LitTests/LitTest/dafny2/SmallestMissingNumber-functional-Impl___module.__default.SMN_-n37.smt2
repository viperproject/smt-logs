...
(declare-fun |n##1_1_0@0| () Int)
(declare-fun |len##1_1_0@0| () Int)
(set-info :boogie-vc-id Impl$$_module.__default.SMN_k_k__Correct_split17)
...
(_module.__default.NoDuplicates Tclass._System.nat ($LS ($LS $LZ)) |tail#0@@4|)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (and (and (|_module.__default.Split#canCall| |xs#0@@20| |b##1_0@0|) (let ((|r#0@@0| (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@20| |b##1_0@0|)))
...
(_module.__default.NoDuplicates call0formal@_module._default.Elements_Property$_T0@0 ($LS ($LS $LZ)) |tail#0@@6|)))))))) (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (|_module.__default.Elements#canCall| call0formal@_module._default.Elements_Property$_T0@0 |L#1_0@0|) (|_module.__default.Length#canCall| call0formal@_module._default.Elements_Property$_T0@0 |L#1_0@0|))) (and (and (= (|Set#Card| (_module.__default.Elements call0formal@_module._default.Elements_Property$_T0@0 ($LS ($LS $LZ)) |L#1_0@0|)) (_module.__default.Length call0formal@_module._default.Elements_Property$_T0@0 ($LS ($LS $LZ)) |L#1_0@0|)) (= $Heap@0 $Heap@1)) (and ($IsAlloc intType (int_2_U |n#0@@4|) Tclass._System.nat $Heap@1) ($Is intType (int_2_U |half#1_0@0|) Tclass._System.nat)))))) (and (and (and (and (and ($IsAlloc intType (int_2_U |half#1_0@0|) Tclass._System.nat $Heap@1) (|_module.__default.IntRange#canCall| |n#0@@4| |half#1_0@0|)) (and (|_module.__default.IntRange#canCall| |n#0@@4| |half#1_0@0|) (= |bound#1_0@0| (_module.__default.IntRange ($LS $LZ) reveal__module._default.IntRange |n#0@@4| |half#1_0@0|)))) (and (and ($IsAlloc DatatypeTypeType |L#1_0@0| (Tclass._module.List Tclass._System.nat) $Heap@1) (|_module.__default.Elements#canCall| Tclass._System.nat |L#1_0@0|)) (and (|_module.__default.Elements#canCall| Tclass._System.nat |L#1_0@0|) (= |A##1_0@0| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |L#1_0@0|))))) (and (and (and (= call0formal@_module._default.Cardinality$_T0@0 Tclass._System.nat) (|Set#Subset| |A##1_0@0| |bound#1_0@0|)) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2))) (and (and (<= (|Set#Card| |A##1_0@0|) (|Set#Card| |bound#1_0@0|)) (= $Heap@1 $Heap@2)) (and (<= |half#1_0@0| |llen#1_0@0|) ($IsAlloc DatatypeTypeType |R#1_0@0| (Tclass._module.List Tclass._System.nat) $Heap@2))))) (and (and (and (and ($Is intType (int_2_U (+ |n#0@@4| |llen#1_0@0|)) Tclass._System.nat) (= |##n#1_1_0@0| (+ |n#0@@4| |llen#1_0@0|))) (and ($IsAlloc intType (int_2_U |##n#1_1_0@0|) Tclass._System.nat $Heap@2) ($Is intType (int_2_U (- |len#0@@9| |llen#1_0@0|)) Tclass._System.nat))) (and (and (= |##len#1_1_0@0| (- |len#0@@9| |llen#1_0@0|)) ($IsAlloc intType (int_2_U |##len#1_1_0@0|) Tclass._System.nat $Heap@2)) (and (= |##len#1_1_0@0| (_module.__default.Length Tclass._System.nat ($LS $LZ) |R#1_0@0|)) (|_module.__default.SMN_k_k#canCall| |R#1_0@0| (+ |n#0@@4| |llen#1_0@0|) (- |len#0@@9| |llen#1_0@0|))))) (and (and (and (|_module.__default.SMN_k_k#canCall| |R#1_0@0| (+ |n#0@@4| |llen#1_0@0|) (- |len#0@@9| |llen#1_0@0|)) (= |s#1_1_0@0| (_module.__default.SMN_k_k ($LS $LZ) |R#1_0@0| (+ |n#0@@4| |llen#1_0@0|) (- |len#0@@9| |llen#1_0@0|)))) (and ($Is intType (int_2_U (+ |n#0@@4| |llen#1_0@0|)) Tclass._System.nat) (= |n##1_1_0@0| (+ |n#0@@4| |llen#1_0@0|)))) (and (and ($Is intType (int_2_U (- |len#0@@9| |llen#1_0@0|)) Tclass._System.nat) (= |len##1_1_0@0| (- |len#0@@9| |llen#1_0@0|))) (and (or (<= 0 |len#0@@9|) (= |len##1_1_0@0| |len#0@@9|)) (= (ControlFlow 0 2) (- 0 1))))))))) (< |len##1_1_0@0| |len#0@@9|))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
