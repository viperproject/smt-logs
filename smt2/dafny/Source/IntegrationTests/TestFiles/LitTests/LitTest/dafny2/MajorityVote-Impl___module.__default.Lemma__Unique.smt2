...
(set-info :boogie-vc-id Impl$$_module.__default.Lemma__Unique)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (and (forall ((|$ih#a0#0| T@U) (|$ih#s0#0| Int) (|$ih#t0#0| Int) ) (!  (=> (and (and ($Is SeqType |$ih#a0#0| (TSeq _module._default.Lemma_Unique$T)) (and (and (<= (LitInt 0) |$ih#s0#0|) (<= |$ih#s0#0| |$ih#t0#0|)) (<= |$ih#t0#0| (|Seq#Length| |$ih#a0#0|)))) (or (< (|Seq#Rank| |$ih#a0#0|) (|Seq#Rank| |a#0@@3|)) (and (= (|Seq#Rank| |$ih#a0#0|) (|Seq#Rank| |a#0@@3|)) (or (and (<= 0 |$ih#s0#0|) (< |$ih#s0#0| |s#0@@3|)) (and (= |$ih#s0#0| |s#0@@3|) (and (<= 0 |$ih#t0#0|) (< |$ih#t0#0| |t#0@@3|))))))) (=> (or (not (= |x#0@@3| |y#0|)) (not true)) (<= (+ (_module.__default.Count _module._default.Lemma_Unique$T ($LS $LZ) |$ih#a0#0| |$ih#s0#0| |$ih#t0#0| |x#0@@3|) (_module.__default.Count _module._default.Lemma_Unique$T ($LS $LZ) |$ih#a0#0| |$ih#s0#0| |$ih#t0#0| |y#0|)) (- |$ih#t0#0| |$ih#s0#0|))))
 :qid |MajorityVotedfy.183:23|
 :skolemid |585|
 :pattern ( (_module.__default.Count _module._default.Lemma_Unique$T ($LS $LZ) |$ih#a0#0| |$ih#s0#0| |$ih#t0#0| |y#0|))
 :pattern ( (_module.__default.Count _module._default.Lemma_Unique$T ($LS $LZ) |$ih#a0#0| |$ih#s0#0| |$ih#t0#0| |x#0@@3|))
)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |x#0@@3| |y#0|)) (not true)))) (<= (+ (_module.__default.Count _module._default.Lemma_Unique$T ($LS ($LS $LZ)) |a#0@@3| |s#0@@3| |t#0@@3| |x#0@@3|) (_module.__default.Count _module._default.Lemma_Unique$T ($LS ($LS $LZ)) |a#0@@3| |s#0@@3| |t#0@@3| |y#0|)) (- |t#0@@3| |s#0@@3|))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |a#0@@3| (TSeq _module._default.Lemma_Unique$T)) ($IsAlloc SeqType |a#0@@3| (TSeq _module._default.Lemma_Unique$T) $Heap)) (and ($IsBox |x#0@@3| _module._default.Lemma_Unique$T) ($IsAllocBox |x#0@@3| _module._default.Lemma_Unique$T $Heap))) (=> (and (and (and ($IsBox |y#0| _module._default.Lemma_Unique$T) ($IsAllocBox |y#0| _module._default.Lemma_Unique$T $Heap)) (= 1 $FunctionContextHeight)) (and (and (<= (LitInt 0) |s#0@@3|) (<= |s#0@@3| |t#0@@3|)) (and (<= |t#0@@3| (|Seq#Length| |a#0@@3|)) (= (ControlFlow 0 3) 2)))) anon0_correct)))))
