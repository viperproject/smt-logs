...
(declare-fun |n##1_1_0@0| () Int)
(declare-fun |len##1_1_0@0| () Int)
(set-info :boogie-vc-id Impl$$_module.__default.SMN_k_k__Correct_split28)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon7_correct  (=> (and (and (and (and (<= |n#0@@4| |x#1_1_0_0@0|) (< |x#1_1_0_0@0| |s#1_1_0@0|)) (< |x#1_1_0_0@0| (+ |n#0@@4| |llen#1_0@0|))) (and ($IsAlloc DatatypeTypeType |L#1_0@0| (Tclass._module.List Tclass._System.nat) $Heap@4) (|_module.__default.Elements#canCall| Tclass._System.nat |L#1_0@0|))) (and (and (|_module.__default.Elements#canCall| Tclass._System.nat |L#1_0@0|) (= |A##1_1_0_0_0@0| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |L#1_0@0|))) (and (= call0formal@_module._default.SetEquality$_T0@0 Tclass._System.nat) (= (ControlFlow 0 2) (- 0 1))))) (|Set#Subset| |A##1_1_0_0_0@0| |bound#1_0@0|))))
(let ((anon17_Else_correct  (=> (and (< |x#1_1_0_0@0| |n#0@@4|) (= (ControlFlow 0 4) 2)) anon7_correct)))
(let ((anon17_Then_correct  (=> (and (<= |n#0@@4| |x#1_1_0_0@0|) (= (ControlFlow 0 3) 2)) anon7_correct)))
...
))) (= $Heap@2 $Heap@4)))))))) (and (=> (= (ControlFlow 0 5) 3) anon17_Then_correct) (=> (= (ControlFlow 0 5) 4) anon17_Else_correct)))))))
anon0_correct)))))
))
(check-sat)
(get-info :rlimit)
