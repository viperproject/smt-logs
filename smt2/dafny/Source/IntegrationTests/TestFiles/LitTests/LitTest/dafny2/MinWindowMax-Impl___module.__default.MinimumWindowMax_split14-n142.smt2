...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split143)
...
)))) (and (and ($HeapSucc $Heap@5 $Heap@5) (forall (($o@@14 T@U) ($f@@5 T@U) ) (!  (=> (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@14) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@14) $f@@5) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@14) $f@@5)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@14 $f@@5))))
 :qid |MinWindowMaxdfy.74:5|
 :skolemid |714|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@14) $f@@5))
))) (and (<= (- (- |l#0@4| 1) |k#0@0|) |$decr_init$loop#1_00@1|) (=> (= (- (- |l#0@4| 1) |k#0@0|) |$decr_init$loop#1_00@1|) (<= (ite (<= |k#0@0| (- |l#0@4| 1)) (- (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField |n#0@3|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1)))))))))) (- 0 1)) |$decr_init$loop#1_01@1|))))) (and (and (and |$w$loop#1_0@1| (<= |k#0@0| (- |l#0@4| 1))) (and (or (not (= |a#0@@4| null)) (not true)) (or (not (= $nw@0 null)) (not true)))) (and (and (<= 0 (- |l#0@4| 1)) (< (- |l#0@4| 1) (_System.array.Length $nw@0))) (= (ControlFlow 0 2) (- 0 1))))))) (and (<= 0 (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1)))))) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1))))) (_System.array.Length |a#0@@4|))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
