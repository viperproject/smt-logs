...
(declare-fun |lambda#5| (T@U T@U T@U Int) T@U)
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Int) (|$y#0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#5| |l#0| |l#1| |l#2| |l#3|) |$y#0|))  (and ($IsBox |$y#0| |l#0|) (and (|Set#IsMember| |l#1| |$y#0|) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType |l#2| |$y#0|))) |l#3|))))
 :qid |unknown.0:0|
 :skolemid |1682|
 :pattern ( (MapType0Select BoxType boolType (|lambda#5| |l#0| |l#1| |l#2| |l#3|) |$y#0|))
)))
...
(assert (forall ((v@@5 T@U) (t0@@3 T@U) (t1@@0 T@U) (h@@5 T@U) ) (! (= ($IsAlloc MapType v@@5 (TMap t0@@3 t1@@0) h@@5) (forall ((bx@@9 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@5) bx@@9) (and ($IsAllocBox (MapType0Select BoxType BoxType (|Map#Elements| v@@5) bx@@9) t1@@0 h@@5) ($IsAllocBox bx@@9 t0@@3 h@@5)))
...
(assert (forall ((m@@3 T@U) ) (!  (or (= m@@3 |Map#Empty|) (exists ((v@@6 T@U) ) (! (|Set#IsMember| (|Map#Values| m@@3) v@@6)
...
(assert (forall ((m@@5 T@U) (v@@7 T@U) ) (! (= (|Set#IsMember| (|Map#Values| m@@5) v@@7) (exists ((u@@3 T@U) ) (!  (and (|Set#IsMember| (|Map#Domain| m@@5) u@@3) (= v@@7 (MapType0Select BoxType BoxType (|Map#Elements| m@@5) u@@3)))
 ...
 :skolemid |842|
 :pattern ( (|Set#IsMember| (|Map#Values| m@@5) v@@7))
)))
...
(assert (forall ((v@@8 T@U) (t0@@4 T@U) (t1@@1 T@U) ) (! (= ($Is MapType v@@8 (TMap t0@@4 t1@@1)) (forall ((bx@@14 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@8) bx@@14) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@8) bx@@14) t1@@1) ($IsBox bx@@14 t0@@4)))
...
(assert (forall ((m@@9 T@U) ) (!  (or (= m@@9 |Map#Empty|) (exists ((k@@3 T@U) (v@@12 T@U) ) (! (|Set#IsMember| (|Map#Items| m@@9) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| k@@3 v@@12)))
...
(declare-fun |today#0| () Int)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun $Heap@@1 () T@U)
(declare-fun |cards#0@0| () T@U)
(declare-fun |cards#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$Implementation.BirthdayBook.Remind)
...
(let ((anon9_Else_correct  (=> (and (not (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Implementation.BirthdayBook.known)) ($Box SeqType |n#0@0|)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Implementation.BirthdayBook.birthday))) ($Box SeqType |n#0@0|)))) |today#0|))) (= (ControlFlow 0 4) 1)) anon6_correct)))
(let ((anon9_Then_correct  (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Implementation.BirthdayBook.known)) ($Box SeqType |n#0@0|)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Implementation.BirthdayBook.birthday))) ($Box SeqType |n#0@0|)))) |today#0|)) (= (ControlFlow 0 3) 1)) anon6_correct)))
(let ((anon8_Else_correct  (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Implementation.BirthdayBook.known)) ($Box SeqType |n#0@0|))) (and (=> (= (ControlFlow 0 7) 3) anon9_Then_correct) (=> (= (ControlFlow 0 7) 4) anon9_Else_correct)))))
(let ((anon8_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Implementation.BirthdayBook.known)) ($Box SeqType |n#0@0|)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Implementation.BirthdayBook.birthday))) ($Box SeqType |n#0@0|))) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Implementation.BirthdayBook.birthday))) ($Box SeqType |n#0@0|)) (and (=> (= (ControlFlow 0 5) 3) anon9_Then_correct) (=> (= (ControlFlow 0 5) 4) anon9_Else_correct)))))))
(let ((anon7_Then_correct  (=> (and ($Is SeqType |n#0@0| (TSeq TChar)) ($IsAlloc SeqType |n#0@0| (TSeq TChar) $Heap@0)) (and (=> (= (ControlFlow 0 8) 5) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (not (and ($Is SeqType |n#0@0| (TSeq TChar)) ($IsAlloc SeqType |n#0@0| (TSeq TChar) $Heap@0))) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon0_correct  (=> (and (and (and (and (= $_ModifiesFrame@0 (|lambda#2| null $Heap@@1 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) Implementation.BirthdayBook.Repr)))) ($IsAllocBox ($Box refType this@@2) Tclass.Implementation.BirthdayBook? $Heap@@1)) (and (|Implementation.BirthdayBook.Valid#canCall| $Heap@@1 this@@2) (Implementation.BirthdayBook.Valid $Heap@@1 this@@2))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@11 T@U) ) (!  (=> (and (or (not (= $o@@11 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@11) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@11) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@11)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) Implementation.BirthdayBook.Repr)) ($Box refType $o@@11))))
 :qid |ZBirthdayBookdfy.185:12|
 :skolemid |1068|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@11))
)) ($HeapSucc $Heap@@1 $Heap@0)))) (and (and (and ($Is SetType |cards#0@0| (TSet (TSeq TChar))) ($IsAlloc SetType |cards#0@0| (TSet (TSeq TChar)) $Heap@0)) ($IsAllocBox ($Box refType this@@2) Tclass.Implementation.BirthdayBook? $Heap@0)) (and (|Implementation.BirthdayBook.Valid#canCall| $Heap@0 this@@2) (Implementation.BirthdayBook.Valid $Heap@0 this@@2)))) (and (=> (= (ControlFlow 0 9) (- 0 11)) ($IsAlloc refType this@@2 Tclass.Implementation.BirthdayBook $Heap@@1)) (=> ($IsAlloc refType this@@2 Tclass.Implementation.BirthdayBook $Heap@@1) (=> (and (forall (($o@@12 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Implementation.BirthdayBook.Repr)) ($Box refType $o@@12)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) Implementation.BirthdayBook.Repr)) ($Box refType $o@@12)))) (or (not (= $o@@12 null)) (not true)))
 :qid |ZBirthdayBookdfy.130:12|
 :skolemid |1069|
...
))) (and (=> (= (ControlFlow 0 9) (- 0 10)) ($IsAlloc refType this@@2 Tclass.Implementation.BirthdayBook $Heap@@1)) (=> ($IsAlloc refType this@@2 Tclass.Implementation.BirthdayBook $Heap@@1) (=> (forall (($o@@14 T@U) ($f@@1 T@U) ) (!  (=> (or (not (= $o@@14 null)) (not true)) (=> (= $o@@14 this@@2) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@14) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@14) $f@@1))))
 :qid |ZBirthdayBookdfy.131:15|
 :skolemid |1071|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass.Implementation.BirthdayBook) ($IsAlloc refType this@@2 Tclass.Implementation.BirthdayBook $Heap@@1)))) (and (and ($Is SetType |cards#0| (TSet (TSeq TChar))) ($IsAlloc SetType |cards#0| (TSet (TSeq TChar)) $Heap@@1)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 12) 9)))) anon0_correct)))
