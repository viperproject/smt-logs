...
(set-info :boogie-vc-id Impl$$SnapTree.Tree.CreateIterator)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@11 alloc false)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (= $Heap@@11 $Heap@0) reveal_SnapTree.Tree.Valid) (and (or (not (= call2formal@this null)) (not true)) (and ($Is refType call2formal@this Tclass.SnapTree.Iterator) ($IsAlloc refType call2formal@this Tclass.SnapTree.Iterator $Heap@@11)))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (SnapTree.Tree.Valid reveal_SnapTree.Tree.Valid $Heap@0 this@@9)) (=> (SnapTree.Tree.Valid reveal_SnapTree.Tree.Valid $Heap@0 this@@9) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (or (not (= call2formal@this@0 null)) (not true)) (and ($Is refType call2formal@this@0 Tclass.SnapTree.Iterator) ($IsAlloc refType call2formal@this@0 Tclass.SnapTree.Iterator $Heap@1))) (and (|SnapTree.Iterator.Valid#canCall| $Heap@1 call2formal@this@0) (SnapTree.Iterator.Valid reveal_SnapTree.Iterator.Valid $Heap@1 call2formal@this@0))) (=> (and (and (and (forall (($o@@48 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call2formal@this@0) SnapTree.Iterator.IterRepr)) ($Box refType $o@@48)) (or (not (= $o@@48 null)) (not true)))
 :qid |SnapshotableTreesdfy.530:26|
 :skolemid |1032|
 :pattern (  (or (not (= $o@@48 null)) (not true)))
)) (forall (($o@@49 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call2formal@this@0) SnapTree.Iterator.IterRepr)) ($Box refType $o@@49)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@49) alloc)))))
 :qid |SnapshotableTreesdfy.530:26|
 :skolemid |1033|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call2formal@this@0) SnapTree.Iterator.IterRepr)) ($Box refType $o@@49)))
))) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call2formal@this@0) SnapTree.Iterator.T)) this@@9) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call2formal@this@0) SnapTree.Iterator.Contents)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@9) SnapTree.Tree.Contents))))) (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call2formal@this@0) SnapTree.Iterator.N))) (LitInt (- 0 1))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) alloc))))) (and (forall (($o@@50 T@U) ) (!  (=> (and (or (not (= $o@@50 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@50) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@50) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@50)))
 :qid |SnapshotableTreesdfy.528:17|
 :skolemid |1034|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@50))
)) ($HeapSucc $Heap@0 $Heap@1)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) true) (and (=> (= (ControlFlow 0 2) (- 0 6)) (SnapTree.Iterator.Valid reveal_SnapTree.Iterator.Valid $Heap@1 call2formal@this@0)) (=> (SnapTree.Iterator.Valid reveal_SnapTree.Iterator.Valid $Heap@1 call2formal@this@0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (forall (($o@@51 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call2formal@this@0) SnapTree.Iterator.IterRepr)) ($Box refType $o@@51)) (or (not (= $o@@51 null)) (not true)))
 :qid |SnapshotableTreesdfy.220:31|
 :skolemid |792|
 :pattern (  (or (not (= $o@@51 null)) (not true)))
)) (forall (($o@@52 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call2formal@this@0) SnapTree.Iterator.IterRepr)) ($Box refType $o@@52)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 $o@@52) alloc)))))
 :qid |SnapshotableTreesdfy.220:31|
 :skolemid |793|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call2formal@this@0) SnapTree.Iterator.IterRepr)) ($Box refType $o@@52)))
)))) (=> (and (forall (($o@@53 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call2formal@this@0) SnapTree.Iterator.IterRepr)) ($Box refType $o@@53)) (or (not (= $o@@53 null)) (not true)))
 :qid |SnapshotableTreesdfy.220:31|
 :skolemid |792|
 :pattern (  (or (not (= $o@@53 null)) (not true)))
)) (forall (($o@@54 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call2formal@this@0) SnapTree.Iterator.IterRepr)) ($Box refType $o@@54)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 $o@@54) alloc)))))
 :qid |SnapshotableTreesdfy.220:31|
 :skolemid |793|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call2formal@this@0) SnapTree.Iterator.IterRepr)) ($Box refType $o@@54)))
))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call2formal@this@0) SnapTree.Iterator.T)) this@@9)) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call2formal@this@0) SnapTree.Iterator.T)) this@@9) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call2formal@this@0) SnapTree.Iterator.Contents)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@9) SnapTree.Tree.Contents)))) (=> (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call2formal@this@0) SnapTree.Iterator.Contents)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@9) SnapTree.Tree.Contents))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call2formal@this@0) SnapTree.Iterator.N))) (LitInt (- 0 1)))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@11) ($IsHeapAnchor $Heap@@11)) (and (or (not (= this@@9 null)) (not true)) (and ($Is refType this@@9 Tclass.SnapTree.Tree) ($IsAlloc refType this@@9 Tclass.SnapTree.Tree $Heap@@11)))) (and (and (=> |defass#iter#0| (and ($Is refType |iter#0| Tclass.SnapTree.Iterator) ($IsAlloc refType |iter#0| Tclass.SnapTree.Iterator $Heap@@11))) (= 8 $FunctionContextHeight)) (and (SnapTree.Tree.Valid reveal_SnapTree.Tree.Valid $Heap@@11 this@@9) (= (ControlFlow 0 9) 2)))) anon0_correct)))
