...
(declare-fun |xrest#Z#0@0| () T@U)
(declare-fun _module._default.ith$a@@4 () T@U)
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.ith)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon12_Else_correct  (=> (and (or (not (= |i#0@@4| (LitInt 0))) (not true)) ($IsAlloc DatatypeTypeType |xrest#Z#0@0| (Tclass._module.List _module._default.ith$a@@4) $Heap@@0)) (and (=> (= (ControlFlow 0 8) (- 0 11)) ($Is intType (int_2_U (- |i#0@@4| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |i#0@@4| 1)) Tclass._System.nat) (=> (and (= |##i#0@0| (- |i#0@@4| 1)) ($IsAlloc intType (int_2_U |##i#0@0|) Tclass._System.nat $Heap@@0)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (< |##i#0@0| (_module.__default.length _module._default.ith$a@@4 ($LS ($LS $LZ)) |xrest#Z#0@0|))) (=> (< |##i#0@0| (_module.__default.length _module._default.ith$a@@4 ($LS $LZ) |xrest#Z#0@0|)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (or (<= 0 |i#0@@4|) (< (DtRank |xrest#Z#0@0|) (DtRank |xs#0@@5|))) (= |##i#0@0| |i#0@@4|))) (=> (or (or (<= 0 |i#0@@4|) (< (DtRank |xrest#Z#0@0|) (DtRank |xs#0@@5|))) (= |##i#0@0| |i#0@@4|)) (=> (= (ControlFlow 0 8) (- 0 7)) (or (< (DtRank |xrest#Z#0@0|) (DtRank |xs#0@@5|)) (and (= (DtRank |xrest#Z#0@0|) (DtRank |xs#0@@5|)) (< |##i#0@0| |i#0@@4|))))))))))))))
(let ((anon12_Then_correct true))
(let ((anon11_Then_correct  (=> (= |xs#0@@5| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) (=> (and (and (and ($IsBox |_mcc#0#0| _module._default.ith$a@@4) ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List _module._default.ith$a@@4))) (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List _module._default.ith$a@@4)))) (and (and (= |xrest#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|)) (and ($IsBox |let#1#0#0| _module._default.ith$a@@4) (= |x#Z#0@0| |let#1#0#0|)))) (and (=> (= (ControlFlow 0 12) 6) anon12_Then_correct) (=> (= (ControlFlow 0 12) 8) anon12_Else_correct))))))
(let ((anon13_Else_correct true))
(let ((anon13_Then_correct  (=> (and (= |xs#0@@5| |#_module.List.Nil|) (= (ControlFlow 0 3) (- 0 2))) false)))
(let ((anon11_Else_correct  (=> (or (not (= |xs#0@@5| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|))) (not true)) (and (=> (= (ControlFlow 0 5) 3) anon13_Then_correct) (=> (= (ControlFlow 0 5) 4) anon13_Else_correct)))))
(let ((anon10_Then_correct true))
(let ((anon0_correct  (=> (and (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@0 alloc false)) ($IsAlloc DatatypeTypeType |xs#0@@5| (Tclass._module.List _module._default.ith$a@@4) $Heap@@0)) (and (|_module.__default.length#canCall| _module._default.ith$a@@4 |xs#0@@5|) (< |i#0@@4| (_module.__default.length _module._default.ith$a@@4 ($LS $LZ) |xs#0@@5|)))) (and (and (=> (= (ControlFlow 0 13) 1) anon10_Then_correct) (=> (= (ControlFlow 0 13) 12) anon11_Then_correct)) (=> (= (ControlFlow 0 13) 5) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is DatatypeTypeType |xs#0@@5| (Tclass._module.List _module._default.ith$a@@4)) (<= (LitInt 0) |i#0@@4|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct))))
