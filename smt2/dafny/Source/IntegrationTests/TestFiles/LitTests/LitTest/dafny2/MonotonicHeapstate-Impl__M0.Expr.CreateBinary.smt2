...
(assert (forall ((a@@13 T@U) (b@@10 T@U) ) (!  (=> (and (M0.Kind.Constant_q a@@13) (M0.Kind.Constant_q b@@10)) (|M0.Kind#Equal| a@@13 b@@10))
 :qid |unknown.0:0|
 :skolemid |489|
 :pattern ( (|M0.Kind#Equal| a@@13 b@@10) (M0.Kind.Constant_q a@@13))
 :pattern ( (|M0.Kind#Equal| a@@13 b@@10) (M0.Kind.Constant_q b@@10))
)))
(assert (forall ((a@@14 T@U) (b@@11 T@U) ) (!  (=> (and (M0.Kind.Ident_q a@@14) (M0.Kind.Ident_q b@@11)) (|M0.Kind#Equal| a@@14 b@@11))
 :qid |unknown.0:0|
 :skolemid |490|
 :pattern ( (|M0.Kind#Equal| a@@14 b@@11) (M0.Kind.Ident_q a@@14))
 :pattern ( (|M0.Kind#Equal| a@@14 b@@11) (M0.Kind.Ident_q b@@11))
)))
(assert (forall ((a@@15 T@U) (b@@12 T@U) ) (!  (=> (and (M0.Kind.Binary_q a@@15) (M0.Kind.Binary_q b@@12)) (|M0.Kind#Equal| a@@15 b@@12))
 :qid |unknown.0:0|
 :skolemid |491|
 :pattern ( (|M0.Kind#Equal| a@@15 b@@12) (M0.Kind.Binary_q a@@15))
 :pattern ( (|M0.Kind#Equal| a@@15 b@@12) (M0.Kind.Binary_q b@@12))
)))
...
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id Impl$$M0.Expr.CreateBinary)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@5) ($IsHeapAnchor $Heap@@5)) (and ($Is refType |left#0| Tclass.M0.Expr) ($IsAlloc refType |left#0| Tclass.M0.Expr $Heap@@5))) (=> (and (and (and (and ($Is refType |right#0| Tclass.M0.Expr) ($IsAlloc refType |right#0| Tclass.M0.Expr $Heap@@5)) (= 2 $FunctionContextHeight)) (and (|M0.Expr.Valid#canCall| $Heap@@5 |left#0|) (and (M0.Expr.Valid ($LS $LZ) $Heap@@5 |left#0|) (and (M0.Expr.Core ($LS $LZ) $Heap@@5 |left#0|) (M0.Expr.Valid_k ($LS $LZ) $Heap@@5 |left#0|))))) (and (and (|M0.Expr.Valid#canCall| $Heap@@5 |right#0|) (and (M0.Expr.Valid ($LS $LZ) $Heap@@5 |right#0|) (and (M0.Expr.Core ($LS $LZ) $Heap@@5 |right#0|) (M0.Expr.Valid_k ($LS $LZ) $Heap@@5 |right#0|)))) (and (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |left#0|) M0.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |right#0|) M0.Expr.Repr))) (= (ControlFlow 0 21) 2)))) anon0_correct))))
