...
(set-info :boogie-vc-id CheckWellFormed$$SnapTree.Tree.Print)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#9| null $Heap@@7 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@6) SnapTree.Tree.Repr)))) ($IsAllocBox ($Box refType this@@6) Tclass.SnapTree.Tree? $Heap@@7)) (and (|SnapTree.Tree.Valid#canCall| $Heap@@7 this@@6) (SnapTree.Tree.Valid reveal_SnapTree.Tree.Valid $Heap@@7 this@@6))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@32 T@U) ) (!  (=> (and (or (not (= $o@@32 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@32) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@32) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@32)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@6) SnapTree.Tree.Repr)) ($Box refType $o@@32))))
 :qid |SnapshotableTreesdfy.227:12|
 :skolemid |797|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@32))
))) (and (and ($HeapSucc $Heap@@7 $Heap@0) ($IsAllocBox ($Box refType this@@6) Tclass.SnapTree.Tree? $Heap@0)) (and (|SnapTree.Tree.Valid#canCall| $Heap@0 this@@6) (SnapTree.Tree.Valid reveal_SnapTree.Tree.Valid $Heap@0 this@@6)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@6 Tclass.SnapTree.Tree $Heap@@7)) (=> ($IsAlloc refType this@@6 Tclass.SnapTree.Tree $Heap@@7) (=> (and (forall (($o@@33 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) SnapTree.Tree.Repr)) ($Box refType $o@@33)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@6) SnapTree.Tree.Repr)) ($Box refType $o@@33)))) (or (not (= $o@@33 null)) (not true)))
...
))) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType this@@6 Tclass.SnapTree.Tree $Heap@@7)) (=> ($IsAlloc refType this@@6 Tclass.SnapTree.Tree $Heap@@7) (=> (and (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) SnapTree.Tree.Contents)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@6) SnapTree.Tree.Contents))) (= (ControlFlow 0 2) (- 0 1))) ($IsAlloc refType this@@6 Tclass.SnapTree.Tree $Heap@@7)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@7) ($IsHeapAnchor $Heap@@7)) (=> (and (and (or (not (= this@@6 null)) (not true)) (and ($Is refType this@@6 Tclass.SnapTree.Tree) ($IsAlloc refType this@@6 Tclass.SnapTree.Tree $Heap@@7))) (and (= 9 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct))))
