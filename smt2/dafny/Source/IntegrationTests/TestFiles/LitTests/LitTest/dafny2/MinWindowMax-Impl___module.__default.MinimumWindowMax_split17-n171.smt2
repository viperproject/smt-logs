...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split172)
...
))) (and (or (not (= $nw@0 null)) (not true)) (= (ControlFlow 0 2) (- 0 1)))) (and (<= 0 (- |l#0@3| 1)) (< (- |l#0@3| 1) (_System.array.Length $nw@0))))))
