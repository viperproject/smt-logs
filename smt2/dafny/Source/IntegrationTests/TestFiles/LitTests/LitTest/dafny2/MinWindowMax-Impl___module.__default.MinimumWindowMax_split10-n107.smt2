...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split108)
...
))))))) (and (and (and ($IsGoodHeap $Heap@7) ($IsHeapAnchor $Heap@7)) (|_module.__default.Max#canCall| $Heap@7 |a#0@@4| |lo##1_0@1| (- |hi##1_0@1| |lo##1_0@1|))) (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |a#0@@4|) (IndexField |x##1_0@1|)))) (_module.__default.Max ($LS ($LS $LZ)) $Heap@7 |a#0@@4| |lo##1_0@1| (- |hi##1_0@1| |lo##1_0@1|))) (= $Heap@6 $Heap@7)) (and (or (not (= |a#0@@4| null)) (not true)) (= (ControlFlow 0 2) (- 0 1)))))) (or (not (= $nw@0 null)) (not true))))))
