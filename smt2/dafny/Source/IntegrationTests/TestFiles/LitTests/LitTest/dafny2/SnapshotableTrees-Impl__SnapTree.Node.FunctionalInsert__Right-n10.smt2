...
(assert (forall ((a@@0 T@U) (b@@0 T@U) ) (! (= (|Set#Disjoint| a@@0 b@@0) (forall ((o@@2 T@U) ) (!  (or (not (|Set#IsMember| a@@0 o@@2)) (not (|Set#IsMember| b@@0 o@@2)))
 :qid |DafnyPreludebpl.794:19|
 :skolemid |151|
 :pattern ( (|Set#IsMember| a@@0 o@@2))
...
(declare-fun |defass#right#0| () Bool)
...
(declare-fun |L#1_0| () T@U)
(set-info :boogie-vc-id Impl$$SnapTree.Node.FunctionalInsert__Right)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 33) (let ((anon6_correct  (and (=> (= (ControlFlow 0 2) (- 0 10)) true) (and (=> (= (ControlFlow 0 2) (- 0 9)) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@3 |r#0@0|)) (=> (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@3 |r#0@0|) (and (=> (= (ControlFlow 0 2) (- 0 8)) (and (forall (($o@@17 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@17)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |n#0|) SnapTree.Node.Repr)) ($Box refType $o@@17)))) (or (not (= $o@@17 null)) (not true)))
 :qid |SnapshotableTreesdfy.386:15|
 :skolemid |947|
 :pattern (  (or (not (= $o@@17 null)) (not true)))
)) (forall (($o@@18 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@18)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |n#0|) SnapTree.Node.Repr)) ($Box refType $o@@18)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@18) alloc)))))
 :qid |SnapshotableTreesdfy.386:15|
 :skolemid |948|
...
)))) (=> (and (forall (($o@@19 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@19)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |n#0|) SnapTree.Node.Repr)) ($Box refType $o@@19)))) (or (not (= $o@@19 null)) (not true)))
 :qid |SnapshotableTreesdfy.386:15|
 :skolemid |947|
 :pattern (  (or (not (= $o@@19 null)) (not true)))
)) (forall (($o@@20 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@20)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |n#0|) SnapTree.Node.Repr)) ($Box refType $o@@20)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@20) alloc)))))
 :qid |SnapshotableTreesdfy.386:15|
 :skolemid |948|
...
))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))) (= |r#0@0| |n#0|))) (=> (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))) (= |r#0@0| |n#0|)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))) (< |pos#0@1| 0))) (=> (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))) (< |pos#0@1| 0)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (<= (LitInt 0) |pos#0@1|))) (=> (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (<= (LitInt 0) |pos#0@1|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (< |pos#0@1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |r#0@0|) SnapTree.Node.Contents)))))) (=> (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (< |pos#0@1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |r#0@0|) SnapTree.Node.Contents))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |r#0@0|) SnapTree.Node.Contents))) (+ (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |n#0|) SnapTree.Node.Contents))) 1)))) (=> (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |r#0@0|) SnapTree.Node.Contents))) (+ (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |n#0|) SnapTree.Node.Contents))) 1))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |r#0@0|) SnapTree.Node.Contents)) (|Seq#Append| (|Seq#Append| (|Seq#Take| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |n#0|) SnapTree.Node.Contents)) |pos#0@1|) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |x#0|)))) (|Seq#Drop| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |n#0|) SnapTree.Node.Contents)) |pos#0@1|))))))))))))))))))))))
(let ((anon5_correct  (=> (= |L#1_0@0| (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#0|) SnapTree.Node.left)) null) |Seq#Empty| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#0|) SnapTree.Node.left))) SnapTree.Node.Contents)))) (=> (and (= |Llen#1_0@0| (+ (|Seq#Length| |L#1_0@0|) 1)) (= |pos#0@0| (+ |Llen#1_0@0| |call4formal@pos#0@0|))) (and (=> (= (ControlFlow 0 12) (- 0 20)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (=> (= |left##1_0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#0|) SnapTree.Node.left))) (and (=> (= (ControlFlow 0 12) (- 0 19)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (=> (= |x##1_0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#0|) SnapTree.Node.data)))) (and (=> (= (ControlFlow 0 12) (- 0 18)) true) (=> (and (or (not (= call4formal@this null)) (not true)) (and ($Is refType call4formal@this Tclass.SnapTree.Node) ($IsAlloc refType call4formal@this Tclass.SnapTree.Node $Heap@@5))) (and (=> (= (ControlFlow 0 12) (- 0 17)) (=> (or (not (= |left##1_0@0| null)) (not true)) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@1 |left##1_0@0|))) (=> (=> (or (not (= |left##1_0@0| null)) (not true)) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@1 |left##1_0@0|)) (and (=> (= (ControlFlow 0 12) (- 0 16)) (=> (or (not (= |left##1_0@0| null)) (not true)) (=> (|SnapTree.Tree.AllBelow#canCall| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |left##1_0@0|) SnapTree.Node.Contents)) |x##1_0@0|) (or (SnapTree.Tree.AllBelow ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |left##1_0@0|) SnapTree.Node.Contents)) |x##1_0@0|) (forall ((|i#0@@2| Int) ) (!  (=> (and (<= (LitInt 0) |i#0@@2|) (< |i#0@@2| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |left##1_0@0|) SnapTree.Node.Contents))))) (< (U_2_int ($Unbox intType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |left##1_0@0|) SnapTree.Node.Contents)) |i#0@@2|))) |x##1_0@0|))
 :qid |SnapshotableTreesdfy.126:14|
 :skolemid |877|
 :pattern ( ($Unbox intType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |left##1_0@0|) SnapTree.Node.Contents)) |i#0@@2|)))
)))))) (=> (=> (or (not (= |left##1_0@0| null)) (not true)) (=> (|SnapTree.Tree.AllBelow#canCall| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |left##1_0@0|) SnapTree.Node.Contents)) |x##1_0@0|) (or (SnapTree.Tree.AllBelow ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |left##1_0@0|) SnapTree.Node.Contents)) |x##1_0@0|) (forall ((|i#0@@3| Int) ) (!  (=> (and (<= (LitInt 0) |i#0@@3|) (< |i#0@@3| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |left##1_0@0|) SnapTree.Node.Contents))))) (< (U_2_int ($Unbox intType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |left##1_0@0|) SnapTree.Node.Contents)) |i#0@@3|))) |x##1_0@0|))
 :qid |SnapshotableTreesdfy.126:14|
 :skolemid |877|
 :pattern ( ($Unbox intType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |left##1_0@0|) SnapTree.Node.Contents)) |i#0@@3|)))
))))) (and (=> (= (ControlFlow 0 12) (- 0 15)) (=> (or (not (= |call3formal@r#0@0| null)) (not true)) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@1 |call3formal@r#0@0|))) (=> (=> (or (not (= |call3formal@r#0@0| null)) (not true)) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@1 |call3formal@r#0@0|)) (and (=> (= (ControlFlow 0 12) (- 0 14)) (=> (or (not (= |call3formal@r#0@0| null)) (not true)) (=> (|SnapTree.Tree.AllAbove#canCall| |x##1_0@0| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0|) SnapTree.Node.Contents))) (or (SnapTree.Tree.AllAbove |x##1_0@0| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0|) SnapTree.Node.Contents))) (forall ((|i#1@@2| Int) ) (!  (=> (and (<= (LitInt 0) |i#1@@2|) (< |i#1@@2| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0|) SnapTree.Node.Contents))))) (< |x##1_0@0| (U_2_int ($Unbox intType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0|) SnapTree.Node.Contents)) |i#1@@2|)))))
 :qid |SnapshotableTreesdfy.130:14|
 :skolemid |879|
 :pattern ( ($Unbox intType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0|) SnapTree.Node.Contents)) |i#1@@2|)))
)))))) (=> (=> (or (not (= |call3formal@r#0@0| null)) (not true)) (=> (|SnapTree.Tree.AllAbove#canCall| |x##1_0@0| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0|) SnapTree.Node.Contents))) (or (SnapTree.Tree.AllAbove |x##1_0@0| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0|) SnapTree.Node.Contents))) (forall ((|i#1@@3| Int) ) (!  (=> (and (<= (LitInt 0) |i#1@@3|) (< |i#1@@3| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0|) SnapTree.Node.Contents))))) (< |x##1_0@0| (U_2_int ($Unbox intType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0|) SnapTree.Node.Contents)) |i#1@@3|)))))
 :qid |SnapshotableTreesdfy.130:14|
 :skolemid |879|
 :pattern ( ($Unbox intType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0|) SnapTree.Node.Contents)) |i#1@@3|)))
))))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (=> (and (or (not (= |left##1_0@0| null)) (not true)) (or (not (= |call3formal@r#0@0| null)) (not true))) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |left##1_0@0|) SnapTree.Node.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0|) SnapTree.Node.Repr))))) (=> (=> (and (or (not (= |left##1_0@0| null)) (not true)) (or (not (= |call3formal@r#0@0| null)) (not true))) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |left##1_0@0|) SnapTree.Node.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0|) SnapTree.Node.Repr)))) (=> (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (=> (and (and (and (and (and (or (not (= call4formal@this@0 null)) (not true)) (and ($Is refType call4formal@this@0 Tclass.SnapTree.Node) ($IsAlloc refType call4formal@this@0 Tclass.SnapTree.Node $Heap@2))) (|SnapTree.Node.NodeValid#canCall| $Heap@2 call4formal@this@0)) (and (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@2 call4formal@this@0) (|SnapTree.Node.CombineSplit#canCall| $Heap@2 |left##1_0@0| |x##1_0@0| |call3formal@r#0@0|))) (and (and (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) SnapTree.Node.Contents)) (SnapTree.Node.CombineSplit $Heap@2 |left##1_0@0| |x##1_0@0| |call3formal@r#0@0|)) (=> (and (= |left##1_0@0| null) (= |call3formal@r#0@0| null)) (and (forall (($o@@21 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@21)) (or (not (= $o@@21 null)) (not true)))
 :qid |SnapshotableTreesdfy.314:49|
 :skolemid |881|
 :pattern (  (or (not (= $o@@21 null)) (not true)))
)) (forall (($o@@22 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@22)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@22) alloc)))))
 :qid |SnapshotableTreesdfy.314:49|
 :skolemid |882|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@22)))
))))) (and (=> (and (or (not (= |left##1_0@0| null)) (not true)) (= |call3formal@r#0@0| null)) (and (forall (($o@@23 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@23)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |left##1_0@0|) SnapTree.Node.Repr)) ($Box refType $o@@23)))) (or (not (= $o@@23 null)) (not true)))
 :qid |SnapshotableTreesdfy.315:49|
 :skolemid |883|
 :pattern (  (or (not (= $o@@23 null)) (not true)))
)) (forall (($o@@24 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@24)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |left##1_0@0|) SnapTree.Node.Repr)) ($Box refType $o@@24)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@24) alloc)))))
 :qid |SnapshotableTreesdfy.315:49|
 :skolemid |884|
...
)))) (=> (and (= |left##1_0@0| null) (or (not (= |call3formal@r#0@0| null)) (not true))) (and (forall (($o@@25 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@25)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |call3formal@r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@25)))) (or (not (= $o@@25 null)) (not true)))
 :qid |SnapshotableTreesdfy.316:49|
 :skolemid |885|
 :pattern (  (or (not (= $o@@25 null)) (not true)))
)) (forall (($o@@26 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@26)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |call3formal@r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@26)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@26) alloc)))))
 :qid |SnapshotableTreesdfy.316:49|
 :skolemid |886|
...
))))))) (and (and (and (=> (and (or (not (= |left##1_0@0| null)) (not true)) (or (not (= |call3formal@r#0@0| null)) (not true))) (and (forall (($o@@27 T@U) ) (!  (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@27)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |left##1_0@0|) SnapTree.Node.Repr)) ($Box refType $o@@27)))) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |call3formal@r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@27)))) (or (not (= $o@@27 null)) (not true)))
 :qid |SnapshotableTreesdfy.317:49|
 :skolemid |887|
 :pattern (  (or (not (= $o@@27 null)) (not true)))
)) (forall (($o@@28 T@U) ) (!  (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@28)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |left##1_0@0|) SnapTree.Node.Repr)) ($Box refType $o@@28)))) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |call3formal@r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@28)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@28) alloc)))))
 :qid |SnapshotableTreesdfy.317:49|
 :skolemid |888|
...
)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call4formal@this@0) alloc))))) (and (forall (($o@@29 T@U) ) (!  (=> (and (or (not (= $o@@29 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@29) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@29) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@29)))
 :qid |SnapshotableTreesdfy.308:17|
 :skolemid |889|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@29))
)) ($HeapSucc $Heap@1 $Heap@2))) (and (and (= $Heap@3 $Heap@2) (= |pos#0@1| |pos#0@0|)) (and (= |r#0@0| call4formal@this@0) (= (ControlFlow 0 12) 2))))) anon6_correct))))))))))))))))))))))))
(let ((anon8_Else_correct  (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#0|) SnapTree.Node.left)) null)) (not true)) (and (=> (= (ControlFlow 0 22) (- 0 24)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#0|) SnapTree.Node.left)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#0|) SnapTree.Node.left)) null)) (not true)) (=> (= (ControlFlow 0 22) 12) anon5_correct))))))))
(let ((anon8_Then_correct  (=> (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#0|) SnapTree.Node.left)) null) (= (ControlFlow 0 21) 12)) anon5_correct)))
(let ((anon7_Else_correct  (=> (or (not (= |call3formal@r#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#0|) SnapTree.Node.right)))) (not true)) (and (=> (= (ControlFlow 0 25) (- 0 26)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (and (=> (= (ControlFlow 0 25) 21) anon8_Then_correct) (=> (= (ControlFlow 0 25) 22) anon8_Else_correct)))))))
(let ((anon7_Then_correct  (=> (and (= |call3formal@r#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#0|) SnapTree.Node.right))) (= |$rhs#0_1@0| (LitInt (- 0 1)))) (=> (and (and (= $Heap@3 $Heap@1) (= |pos#0@1| |$rhs#0_1@0|)) (and (= |r#0@0| |n#0|) (= (ControlFlow 0 11) 2))) anon6_correct))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@5 alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@5 $Heap@0)) (and reveal_SnapTree.Node.NodeValid (=> |defass#right#0| (and ($Is refType |right#0@0| Tclass.SnapTree.Node) ($IsAlloc refType |right#0@0| Tclass.SnapTree.Node $Heap@0))))) (and (=> (= (ControlFlow 0 27) (- 0 32)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (=> (= |n##0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0|) SnapTree.Node.right))) (and (=> (= (ControlFlow 0 27) (- 0 31)) (and (|Set#Subset| (ite (= |n##0@0| null) |Set#Empty| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n##0@0|) SnapTree.Node.Repr))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |n#0|) SnapTree.Node.Repr))) (not (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |n#0|) SnapTree.Node.Repr)) (ite (= |n##0@0| null) |Set#Empty| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n##0@0|) SnapTree.Node.Repr))))))) (=> (and (|Set#Subset| (ite (= |n##0@0| null) |Set#Empty| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n##0@0|) SnapTree.Node.Repr))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |n#0|) SnapTree.Node.Repr))) (not (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |n#0|) SnapTree.Node.Repr)) (ite (= |n##0@0| null) |Set#Empty| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n##0@0|) SnapTree.Node.Repr)))))) (=> (and ($Is refType |call3formal@r#0| Tclass.SnapTree.Node) ($IsAlloc refType |call3formal@r#0| Tclass.SnapTree.Node $Heap@@5)) (and (=> (= (ControlFlow 0 27) (- 0 30)) (=> (or (not (= |n##0@0| null)) (not true)) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@0 |n##0@0|))) (=> (=> (or (not (= |n##0@0| null)) (not true)) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@0 |n##0@0|)) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and (and ($Is refType |call3formal@r#0@0| Tclass.SnapTree.Node) ($IsAlloc refType |call3formal@r#0@0| Tclass.SnapTree.Node $Heap@1)) (and (|SnapTree.Node.NodeValid#canCall| $Heap@1 |call3formal@r#0@0|) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@1 |call3formal@r#0@0|))) (and (and (=> (= |n##0@0| null) (and (forall (($o@@30 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@30)) (or (not (= $o@@30 null)) (not true)))
 :qid |SnapshotableTreesdfy.341:29|
 :skolemid |915|
 :pattern (  (or (not (= $o@@30 null)) (not true)))
)) (forall (($o@@31 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@31)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@31) alloc)))))
 :qid |SnapshotableTreesdfy.341:29|
 :skolemid |916|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@31)))
)))) (=> (or (not (= |n##0@0| null)) (not true)) (and (forall (($o@@32 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@32)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n##0@0|) SnapTree.Node.Repr)) ($Box refType $o@@32)))) (or (not (= $o@@32 null)) (not true)))
 :qid |SnapshotableTreesdfy.342:29|
 :skolemid |917|
 :pattern (  (or (not (= $o@@32 null)) (not true)))
)) (forall (($o@@33 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@33)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n##0@0|) SnapTree.Node.Repr)) ($Box refType $o@@33)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@33) alloc)))))
 :qid |SnapshotableTreesdfy.342:29|
 :skolemid |918|
...
))))) (and (=> (= |n##0@0| null) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0|) SnapTree.Node.Contents)) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |x#0|))))) (=> (= |n##0@0| null) (= |call4formal@pos#0@0| (LitInt 0)))))) (and (and (and (=> (and (or (not (= |n##0@0| null)) (not true)) (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n##0@0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (= |call3formal@r#0@0| |n##0@0|)) (=> (and (or (not (= |n##0@0| null)) (not true)) (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n##0@0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (< |call4formal@pos#0@0| 0))) (and (=> (and (or (not (= |n##0@0| null)) (not true)) (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n##0@0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))))) (<= (LitInt 0) |call4formal@pos#0@0|)) (=> (and (or (not (= |n##0@0| null)) (not true)) (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n##0@0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))))) (< |call4formal@pos#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0|) SnapTree.Node.Contents))))))) (and (and (=> (and (or (not (= |n##0@0| null)) (not true)) (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n##0@0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))))) (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0|) SnapTree.Node.Contents))) (+ (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n##0@0|) SnapTree.Node.Contents))) 1))) (=> (and (or (not (= |n##0@0| null)) (not true)) (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n##0@0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))))) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0|) SnapTree.Node.Contents)) (|Seq#Append| (|Seq#Append| (|Seq#Take| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n##0@0|) SnapTree.Node.Contents)) |call4formal@pos#0@0|) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |x#0|)))) (|Seq#Drop| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n##0@0|) SnapTree.Node.Contents)) |call4formal@pos#0@0|))))) (and (forall (($o@@34 T@U) ) (!  (=> (and (or (not (= $o@@34 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@34) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@34) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@34)))
 :qid |SnapshotableTreesdfy.338:19|
 :skolemid |919|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@34))
)) ($HeapSucc $Heap@0 $Heap@1))))) (and (=> (= (ControlFlow 0 27) (- 0 29)) true) (and (=> (= (ControlFlow 0 27) (- 0 28)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (and (=> (= (ControlFlow 0 27) 11) anon7_Then_correct) (=> (= (ControlFlow 0 27) 25) anon7_Else_correct)))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@5) ($IsHeapAnchor $Heap@@5)) (=> (and (and (and (and ($Is refType |n#0| Tclass.SnapTree.Node) ($IsAlloc refType |n#0| Tclass.SnapTree.Node $Heap@@5)) (=> |defass#r#0| (and ($Is refType |r#0| Tclass.SnapTree.Node) ($IsAlloc refType |r#0| Tclass.SnapTree.Node $Heap@@5)))) (and (=> |defass#right#0| (and ($Is refType |right#0@@6| Tclass.SnapTree.Node) ($IsAlloc refType |right#0@@6| Tclass.SnapTree.Node $Heap@@5))) true)) (and (and (and ($Is SeqType |L#1_0| (TSeq TInt)) ($IsAlloc SeqType |L#1_0| (TSeq TInt) $Heap@@5)) true) (and (and (= 5 $FunctionContextHeight) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@@5 |n#0|)) (and (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |n#0|) SnapTree.Node.data))) |x#0|) (= (ControlFlow 0 33) 27))))) anon0_correct))))
