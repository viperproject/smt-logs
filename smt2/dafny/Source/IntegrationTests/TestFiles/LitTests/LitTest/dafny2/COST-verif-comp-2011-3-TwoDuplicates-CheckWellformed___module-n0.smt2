...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|a#0@@0| T@U) (|p#0@@0| Int) ) (!  (=> (or (|_module.__default.IsDuplicate#canCall| $Heap@@0 |a#0@@0| |p#0@@0|) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) ($Is refType |a#0@@0| (Tclass._System.array TInt))))) (and (|_module.__default.IsPrefixDuplicate#canCall| $Heap@@0 |a#0@@0| (_System.array.Length |a#0@@0|) |p#0@@0|) (= (_module.__default.IsDuplicate $Heap@@0 |a#0@@0| |p#0@@0|) (_module.__default.IsPrefixDuplicate $Heap@@0 |a#0@@0| (_System.array.Length |a#0@@0|) |p#0@@0|))))
 :qid |COSTverifcomp20113TwoDuplicatesdfy.61:17|
 :skolemid |585|
 :pattern ( (_module.__default.IsDuplicate $Heap@@0 |a#0@@0| |p#0@@0|) ($IsGoodHeap $Heap@@0))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.IsDuplicate)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_Else_correct  (=> ($IsAlloc refType |a#0@@1| (Tclass._System.array TInt) $Heap@@1) (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (not (= |a#0@@1| null)) (not true))) (=> (or (not (= |a#0@@1| null)) (not true)) (=> (= |##k#0@0| (_System.array.Length |a#0@@1|)) (=> (and ($IsAlloc intType (int_2_U |##k#0@0|) TInt $Heap@@1) ($IsAlloc intType (int_2_U |p#0@@1|) TInt $Heap@@1)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (<= (LitInt 0) |##k#0@0|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= |##k#0@0| (_System.array.Length |a#0@@1|))) (=> (and (and (and (<= (LitInt 0) |##k#0@0|) (<= |##k#0@0| (_System.array.Length |a#0@@1|))) (and (= |b$reqreads#0@0| (forall (($o@@6 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@6) alloc)))) (= $o@@6 |a#0@@1|)) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@6 $f@@0)))
 :qid |COSTverifcomp20113TwoDuplicatesdfy.64:3|
 :skolemid |586|
))) (|_module.__default.IsPrefixDuplicate#canCall| $Heap@@1 |a#0@@1| (_System.array.Length |a#0@@1|) |p#0@@1|))) (and (and (= (_module.__default.IsDuplicate $Heap@@1 |a#0@@1| |p#0@@1|) (_module.__default.IsPrefixDuplicate $Heap@@1 |a#0@@1| (_System.array.Length |a#0@@1|) |p#0@@1|)) (|_module.__default.IsPrefixDuplicate#canCall| $Heap@@1 |a#0@@1| (_System.array.Length |a#0@@1|) |p#0@@1|)) (and ($Is boolType (bool_2_U (_module.__default.IsDuplicate $Heap@@1 |a#0@@1| |p#0@@1|)) TBool) (= (ControlFlow 0 3) (- 0 2))))) |b$reqreads#0@0|))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@1 alloc |a#0@@1|)) (and (=> (= (ControlFlow 0 7) 1) anon5_Then_correct) (=> (= (ControlFlow 0 7) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) ($Is refType |a#0@@1| (Tclass._System.array TInt))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct)))
