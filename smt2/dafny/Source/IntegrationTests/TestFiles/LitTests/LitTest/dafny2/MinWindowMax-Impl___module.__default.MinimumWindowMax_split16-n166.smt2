...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split167)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon46_correct  (=> (and (and (and (and (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| |l#0@3|)) (<= |l#0@3| |n#0@3|)) (<= |n#0@3| (_System.array.Length |a#0@@4|))) ($IsAlloc refType $nw@0 (Tclass._System.array TInt) $Heap@5)) (and (and (and (and ($IsAlloc intType (int_2_U |k#0@0|) TInt $Heap@5) ($IsAlloc intType (int_2_U |l#0@3|) TInt $Heap@5)) (and (= |##lo#3@0| (- |n#0@3| |W#0|)) ($IsAlloc intType (int_2_U |##lo#3@0|) TInt $Heap@5))) (and (and ($IsAlloc intType (int_2_U |n#0@3|) TInt $Heap@5) (|_module.__default.StrictlyIncreasing#canCall| $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|)) (and (|_module.__default.StrictlyIncreasing#canCall| $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|) (_module.__default.StrictlyIncreasing $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|)))) (and (and (and ($IsAlloc refType |a#0@@4| (Tclass._System.array TInt) $Heap@5) (= |##lo#4@0| (- |n#0@3| |W#0|))) (and ($IsAlloc intType (int_2_U |##lo#4@0|) TInt $Heap@5) (or (not (= $nw@0 null)) (not true)))) (and (and (= |##x#2@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|))))) ($IsAlloc intType (int_2_U |##x#2@0|) TInt $Heap@5)) (and ($IsAlloc intType (int_2_U |n#0@3|) TInt $Heap@5) (= (ControlFlow 0 2) (- 0 1))))))) (<= (LitInt 0) |##lo#4@0|))))
