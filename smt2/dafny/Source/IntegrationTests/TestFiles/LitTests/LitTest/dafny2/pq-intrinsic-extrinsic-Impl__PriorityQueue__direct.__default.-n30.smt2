...
(set-info :boogie-vc-id Impl$$PriorityQueue__direct.__default.AboutMin)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#PriorityQueue__direct.T_k| |t#0@@8|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#t0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#t0#0| Tclass.PriorityQueue__direct.T) (not (|PriorityQueue__direct.T_k#Equal| |$ih#t0#0| |#PriorityQueue_direct.T'.Leaf|))) (< (DtRank |$ih#t0#0|) (DtRank |t#0@@8|))) (and (> (|MultiSet#Multiplicity| (PriorityQueue__direct.__default.Elements ($LS $LZ) |$ih#t0#0|) ($Box intType (int_2_U (PriorityQueue__direct.T_k.val |$ih#t0#0|)))) 0) (forall ((|x#2@@1| T@U) ) (!  (=> (> (|MultiSet#Multiplicity| (PriorityQueue__direct.__default.Elements ($LS $LZ) |$ih#t0#0|) ($Box intType |x#2@@1|)) 0) (<= (PriorityQueue__direct.T_k.val |$ih#t0#0|) (U_2_int |x#2@@1|)))
 :qid |pqintrinsicextrinsicdfy.306:20|
 :skolemid |2879|
 :pattern ( (|MultiSet#Multiplicity| (PriorityQueue__direct.__default.Elements ($LS $LZ) |$ih#t0#0|) ($Box intType |x#2@@1|)))
))))
 :qid |pqintrinsicextrinsicdfy.303:18|
 :skolemid |2880|
 :pattern ( (PriorityQueue__direct.__default.Elements ($LS $LZ) |$ih#t0#0|))
 :pattern ( (PriorityQueue__direct.T_k.val |$ih#t0#0|))
)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (> (|MultiSet#Multiplicity| (PriorityQueue__direct.__default.Elements ($LS ($LS $LZ)) |t#0@@8|) ($Box intType (int_2_U (PriorityQueue__direct.T_k.val |t#0@@8|)))) 0)) (=> (> (|MultiSet#Multiplicity| (PriorityQueue__direct.__default.Elements ($LS ($LS $LZ)) |t#0@@8|) ($Box intType (int_2_U (PriorityQueue__direct.T_k.val |t#0@@8|)))) 0) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|x#1@@0| Int) ) (!  (=> (> (|MultiSet#Multiplicity| (PriorityQueue__direct.__default.Elements ($LS ($LS $LZ)) |t#0@@8|) ($Box intType (int_2_U |x#1@@0|))) 0) (<= (PriorityQueue__direct.T_k.val |t#0@@8|) |x#1@@0|))
 :qid |pqintrinsicextrinsicdfy.306:20|
 :skolemid |2877|
 :pattern ( (|MultiSet#Multiplicity| (PriorityQueue__direct.__default.Elements ($LS ($LS $LZ)) |t#0@@8|) ($Box intType (int_2_U |x#1@@0|))))
)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |t#0@@8| Tclass.PriorityQueue__direct.T) ($IsAlloc DatatypeTypeType |t#0@@8| Tclass.PriorityQueue__direct.T $Heap)) (|$IsA#PriorityQueue__direct.T_k| |t#0@@8|)) (= 4 $FunctionContextHeight)) (and (not (|PriorityQueue__direct.T_k#Equal| |t#0@@8| |#PriorityQueue_direct.T'.Leaf|)) (= (ControlFlow 0 4) 2))) anon0_correct))))
