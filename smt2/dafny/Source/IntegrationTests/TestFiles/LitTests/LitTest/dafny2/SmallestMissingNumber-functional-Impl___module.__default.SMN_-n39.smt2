...
(declare-fun |n##1_1_0@0| () Int)
(declare-fun |len##1_1_0@0| () Int)
(set-info :boogie-vc-id Impl$$_module.__default.SMN_k_k__Correct_split19)
...
)))) (and (and (and (= |len#0@@9| (_module.__default.Length Tclass._System.nat ($LS ($LS $LZ)) |xs#0@@20|)) (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false))) (and (|$IsA#_module.List| |xs#0@@20|) (not (|_module.List#Equal| |xs#0@@20| |#_module.List.Nil|)))) (and (and (or (not (= (LitInt 2) 0)) (not true)) (= |half#1_0@0| (+ (Div |len#0@@9| (LitInt 2)) 1))) (and ($Is DatatypeTypeType |L#1_0@0| (Tclass._module.List Tclass._System.nat)) ($IsAlloc DatatypeTypeType |L#1_0@0| (Tclass._module.List Tclass._System.nat) $Heap@@0))))) (and (and (and (and (and ($Is DatatypeTypeType |R#1_0@0| (Tclass._module.List Tclass._System.nat)) ($IsAlloc DatatypeTypeType |R#1_0@0| (Tclass._module.List Tclass._System.nat) $Heap@@0)) ($IsAlloc DatatypeTypeType |xs#0@@20| (Tclass._module.List Tclass._System.nat) $Heap@@0)) (and ($Is intType (int_2_U (+ |n#0@@4| |half#1_0@0|)) Tclass._System.nat) (= |##b#1_0@0| (+ |n#0@@4| |half#1_0@0|)))) (and (and ($IsAlloc intType (int_2_U |##b#1_0@0|) Tclass._System.nat $Heap@@0) (|_module.__default.Split#canCall| |xs#0@@20| (+ |n#0@@4| |half#1_0@0|))) (and (_System.Tuple2.___hMake2_q (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@20| (+ |n#0@@4| |half#1_0@0|))) (= |let#1_0#0#0| (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@20| (+ |n#0@@4| |half#1_0@0|)))))) (and (and (and (|_module.__default.Split#canCall| |xs#0@@20| (+ |n#0@@4| |half#1_0@0|)) (|_module.__default.Split#canCall| |xs#0@@20| (+ |n#0@@4| |half#1_0@0|))) (and ($Is DatatypeTypeType |let#1_0#0#0| (Tclass._System.Tuple2 (Tclass._module.List Tclass._System.nat) (Tclass._module.List Tclass._System.nat))) (_System.Tuple2.___hMake2_q |let#1_0#0#0|))) (and (and (= (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |L#1_0@0|) ($Box DatatypeTypeType |R#1_0@0|)) |let#1_0#0#0|) ($Is intType (int_2_U (+ |n#0@@4| |half#1_0@0|)) Tclass._System.nat)) (and (= |b##1_0@0| (+ |n#0@@4| |half#1_0@0|)) (=> (|_module.__default.NoDuplicates#canCall| Tclass._System.nat |xs#0@@20|) (or (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |xs#0@@20|) (=> (_module.List.Nil_q |xs#0@@20|) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (and (and (and (and (and (and (=> (|_module.__default.NoDuplicates#canCall| Tclass._System.nat |xs#0@@20|) (or (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |xs#0@@20|) (=> (not (_module.List.Nil_q |xs#0@@20|)) (let ((|tail#0@@3| (_module.List.tail |xs#0@@20|)))
...
(_module.__default.NoDuplicates Tclass._System.nat ($LS ($LS $LZ)) |tail#0@@4|)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (|_module.__default.Split#canCall| |xs#0@@20| |b##1_0@0|) (let ((|r#0@@0| (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@20| |b##1_0@0|)))
...
(|Set#Equal| (_module.__default.Elements Tclass._System.nat ($LS ($LS $LZ)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |r#0@@1|))) (|Set#FromBoogieMap| (|lambda#14| TInt (_module.__default.Elements Tclass._System.nat ($LS ($LS $LZ)) |xs#0@@20|) |b##1_0@0|)))))) (and (and (and (let ((|r#0@@2| (_module.__default.Split ($LS ($LS $LZ)) reveal__module._default.Split |xs#0@@20| |b##1_0@0|)))
...
(let ((|x#7@@0| (U_2_int ($Unbox intType (_module.List.head ($Unbox DatatypeTypeType (_System.Tuple2._0 |r#0@@3|)))))))
 (and (not (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |tail#3@@4|) ($Box intType (int_2_U |x#7@@0|)))) (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |tail#3@@4|))))))))) (and (let ((|r#0@@4| (_module.__default.Split ($LS ($LS $LZ)) reveal__module._default.Split |xs#0@@20| |b##1_0@0|)))
...
(_module.__default.NoDuplicates call0formal@_module._default.Elements_Property$_T0@0 ($LS ($LS $LZ)) |tail#0@@6|))))))) (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (|_module.__default.Elements#canCall| call0formal@_module._default.Elements_Property$_T0@0 |L#1_0@0|) (|_module.__default.Length#canCall| call0formal@_module._default.Elements_Property$_T0@0 |L#1_0@0|)))) (and (and (and (= (|Set#Card| (_module.__default.Elements call0formal@_module._default.Elements_Property$_T0@0 ($LS ($LS $LZ)) |L#1_0@0|)) (_module.__default.Length call0formal@_module._default.Elements_Property$_T0@0 ($LS ($LS $LZ)) |L#1_0@0|)) (= $Heap@0 $Heap@1)) (and ($IsAlloc intType (int_2_U |n#0@@4|) Tclass._System.nat $Heap@1) ($Is intType (int_2_U |half#1_0@0|) Tclass._System.nat))) (and (and ($IsAlloc intType (int_2_U |half#1_0@0|) Tclass._System.nat $Heap@1) (|_module.__default.IntRange#canCall| |n#0@@4| |half#1_0@0|)) (and (|_module.__default.IntRange#canCall| |n#0@@4| |half#1_0@0|) (= |bound#1_0@0| (_module.__default.IntRange ($LS $LZ) reveal__module._default.IntRange |n#0@@4| |half#1_0@0|))))))) (and (and (and (and (and ($IsAlloc DatatypeTypeType |L#1_0@0| (Tclass._module.List Tclass._System.nat) $Heap@1) (|_module.__default.Elements#canCall| Tclass._System.nat |L#1_0@0|)) (and (|_module.__default.Elements#canCall| Tclass._System.nat |L#1_0@0|) (= |A##1_0@0| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |L#1_0@0|)))) (and (and (= call0formal@_module._default.Cardinality$_T0@0 Tclass._System.nat) (|Set#Subset| |A##1_0@0| |bound#1_0@0|)) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)))) (and (and (and (<= (|Set#Card| |A##1_0@0|) (|Set#Card| |bound#1_0@0|)) (= $Heap@1 $Heap@2)) (and (<= |half#1_0@0| |llen#1_0@0|) ($IsAlloc DatatypeTypeType |R#1_0@0| (Tclass._module.List Tclass._System.nat) $Heap@2))) (and (and ($Is intType (int_2_U (+ |n#0@@4| |llen#1_0@0|)) Tclass._System.nat) (= |##n#1_1_0@0| (+ |n#0@@4| |llen#1_0@0|))) (and ($IsAlloc intType (int_2_U |##n#1_1_0@0|) Tclass._System.nat $Heap@2) ($Is intType (int_2_U (- |len#0@@9| |llen#1_0@0|)) Tclass._System.nat))))) (and (and (and (and (= |##len#1_1_0@0| (- |len#0@@9| |llen#1_0@0|)) ($IsAlloc intType (int_2_U |##len#1_1_0@0|) Tclass._System.nat $Heap@2)) (and (= |##len#1_1_0@0| (_module.__default.Length Tclass._System.nat ($LS $LZ) |R#1_0@0|)) (|_module.__default.SMN_k_k#canCall| |R#1_0@0| (+ |n#0@@4| |llen#1_0@0|) (- |len#0@@9| |llen#1_0@0|)))) (and (and (|_module.__default.SMN_k_k#canCall| |R#1_0@0| (+ |n#0@@4| |llen#1_0@0|) (- |len#0@@9| |llen#1_0@0|)) (= |s#1_1_0@0| (_module.__default.SMN_k_k ($LS $LZ) |R#1_0@0| (+ |n#0@@4| |llen#1_0@0|) (- |len#0@@9| |llen#1_0@0|)))) (and ($Is intType (int_2_U (+ |n#0@@4| |llen#1_0@0|)) Tclass._System.nat) (= |n##1_1_0@0| (+ |n#0@@4| |llen#1_0@0|))))) (and (and (and ($Is intType (int_2_U (- |len#0@@9| |llen#1_0@0|)) Tclass._System.nat) (= |len##1_1_0@0| (- |len#0@@9| |llen#1_0@0|))) (and (or (<= 0 |len#0@@9|) (= |len##1_1_0@0| |len#0@@9|)) (< |len##1_1_0@0| |len#0@@9|))) (and (and (=> (|_module.__default.NoDuplicates#canCall| Tclass._System.nat |R#1_0@0|) (or (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |R#1_0@0|) (=> (_module.List.Nil_q |R#1_0@0|) (U_2_bool (Lit boolType (bool_2_U true)))))) (= (ControlFlow 0 2) (- 0 1))) (|_module.__default.NoDuplicates#canCall| Tclass._System.nat |R#1_0@0|))))))) (or (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |R#1_0@0|) (=> (not (_module.List.Nil_q |R#1_0@0|)) (let ((|tail#0@@7| (_module.List.tail |R#1_0@0|)))
(let ((|x#4| (U_2_int ($Unbox intType (_module.List.head |R#1_0@0|)))))
 (not (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS ($LS $LZ)) |tail#0@@7|) ($Box intType (int_2_U |x#4|)))))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
