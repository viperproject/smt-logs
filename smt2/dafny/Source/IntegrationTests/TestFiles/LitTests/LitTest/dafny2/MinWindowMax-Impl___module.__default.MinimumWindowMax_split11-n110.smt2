...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split111)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon90_correct  (=> (and (= |n#0@4| (+ |n#0@3| 1)) (= (ControlFlow 0 2) (- 0 1))) ($Is intType (int_2_U |W#0|) Tclass._System.nat))))
