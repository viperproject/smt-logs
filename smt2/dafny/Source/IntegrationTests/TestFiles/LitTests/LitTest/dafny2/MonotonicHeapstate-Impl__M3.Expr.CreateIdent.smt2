...
(assert (forall (($h0@@2 T@U) ($h1@@2 T@U) (this@@9 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@2) ($IsGoodHeap $h1@@2)) (and (or (not (= this@@9 null)) (not true)) ($Is refType this@@9 Tclass.M3.Expr))) (and ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2))) (=> (forall (($o@@22 T@U) ($f@@2 T@U) )  (=> (and (or (not (= $o@@22 null)) (not true)) (or (= $o@@22 this@@9) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 this@@9) M3.Expr.Repr)) ($Box refType $o@@22)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 $o@@22) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@2 $o@@22) $f@@2)))) (= (M3.Expr.Valid_k_k $h0@@2 this@@9) (M3.Expr.Valid_k_k $h1@@2 this@@9))))
