...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split75)
...
)) (<= (- |W#0| |n#0@1|) |$decr_init$loop#00@0|)) (and |$w$loop#0@0| (<= |W#0| |n#0@1|))) (and (and (or (not (= |a#0@@4| null)) (not true)) (or (not (= $nw@0 null)) (not true))) (and (<= 0 |$rhs#1@0|) (< |$rhs#1@0| (_System.array.Length $nw@0))))))) (and (and (and (and (and (and (<= 0 (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (IndexField |$rhs#1@0|))))) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (IndexField |$rhs#1@0|)))) (_System.array.Length |a#0@@4|))) (= |m#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |a#0@@4|) (IndexField (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (IndexField |$rhs#1@0|)))))))))) (and (= |lo##0@0| (LitInt 0)) (or (not (= $nw@0 null)) (not true)))) (and (and (<= 0 |$rhs#1@0|) (< |$rhs#1@0| (_System.array.Length $nw@0))) (= |x##0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (IndexField |$rhs#1@0|))))))) (and (and (and (<= (LitInt 0) |lo##0@0|) (<= |lo##0@0| |x##0@0|)) (and (< |x##0@0| |n#0@1|) (<= |n#0@1| (_System.array.Length |a#0@@4|)))) (and (and (=> (|_module.__default.RightmostMax#canCall| $Heap@2 |a#0@@4| |lo##0@0| |x##0@0| |n#0@1|) (or (_module.__default.RightmostMax $Heap@2 |a#0@@4| |lo##0@0| |x##0@0| |n#0@1|) (forall ((|i#0@@4| Int) ) (!  (=> (and (<= |lo##0@0| |i#0@@4|) (< |i#0@@4| |x##0@0|)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |a#0@@4|) (IndexField |i#0@@4|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |a#0@@4|) (IndexField |x##0@0|))))))
 :qid |MinWindowMaxdfy.127:11|
 :skolemid |760|
