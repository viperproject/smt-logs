...
(let ((anon10_correct  (=> (and (and (and (<= (LitInt 0) |p#0@0|) (<= |p#0@0| |f#0|)) (<= |f#0| |q#0@0|)) (< |q#0@0| |N#0|)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (or (not (= |A#0| null)) (not true))) (=> (or (not (= |A#0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (and (<= 0 |p#0@0|) (< |p#0@0| (_System.array.Length |A#0|)))) (=> (and (<= 0 |p#0@0|) (< |p#0@0| (_System.array.Length |A#0|))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= |A#0| null)) (not true))) (=> (or (not (= |A#0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 |q#0@0|) (< |q#0@0| (_System.array.Length |A#0|)))) (=> (and (<= 0 |q#0@0|) (< |q#0@0| (_System.array.Length |A#0|))) (=> (and (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |A#0|) (IndexField |p#0@0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |A#0|) (IndexField |q#0@0|))))) (= (ControlFlow 0 3) 1)) anon12_correct))))))))))))
(let ((anon17_Else_correct  (=> (and (not (and (and (<= (LitInt 0) |p#0@0|) (<= |p#0@0| |f#0|)) (<= |f#0| |q#0@0|))) (= (ControlFlow 0 9) 3)) anon10_correct)))
(let ((anon17_Then_correct  (=> (and (and (and (<= (LitInt 0) |p#0@0|) (<= |p#0@0| |f#0|)) (<= |f#0| |q#0@0|)) (= (ControlFlow 0 8) 3)) anon10_correct)))
(let ((anon16_Else_correct  (=> (not (and (<= (LitInt 0) |p#0@0|) (<= |p#0@0| |f#0|))) (and (=> (= (ControlFlow 0 11) 8) anon17_Then_correct) (=> (= (ControlFlow 0 11) 9) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (and (<= (LitInt 0) |p#0@0|) (<= |p#0@0| |f#0|)) (and (=> (= (ControlFlow 0 10) 8) anon17_Then_correct) (=> (= (ControlFlow 0 10) 9) anon17_Else_correct)))))
(let ((anon15_Else_correct  (=> (< |p#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 13) 10) anon16_Then_correct) (=> (= (ControlFlow 0 13) 11) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (<= (LitInt 0) |p#0@0|) (and (=> (= (ControlFlow 0 12) 10) anon16_Then_correct) (=> (= (ControlFlow 0 12) 11) anon16_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (=> (and (and (and (<= (LitInt 0) |p#0@0|) (<= |p#0@0| |f#0|)) (<= |f#0| |q#0@0|)) (< |q#0@0| |N#0|)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |A#0|) (IndexField |p#0@0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |A#0|) (IndexField |q#0@0|)))))) (= (ControlFlow 0 2) 1)) anon12_correct)))
(let ((anon3_correct  (=> (and (<= (LitInt 0) |f#0|) (< |f#0| |N#0|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6)) (= $o@@6 |A#0|)))
 :qid |Classicsdfy.47:8|
 :skolemid |493|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6))
)) ($HeapSucc $Heap $Heap@0))) (and (and (=> (= (ControlFlow 0 14) 2) anon14_Else_correct) (=> (= (ControlFlow 0 14) 12) anon15_Then_correct)) (=> (= (ControlFlow 0 14) 13) anon15_Else_correct))))))
(let ((anon13_Else_correct  (=> (and (< |f#0| (LitInt 0)) (= (ControlFlow 0 16) 14)) anon3_correct)))
(let ((anon13_Then_correct  (=> (and (<= (LitInt 0) |f#0|) (= (ControlFlow 0 15) 14)) anon3_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#2| null $Heap alloc |A#0|)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (or (not (= |A#0| null)) (not true))) (=> (or (not (= |A#0| null)) (not true)) (=> (= (_System.array.Length |A#0|) |N#0|) (and (=> (= (ControlFlow 0 17) 15) anon13_Then_correct) (=> (= (ControlFlow 0 17) 16) anon13_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |A#0| (Tclass._System.array TInt)) ($IsAlloc refType |A#0| (Tclass._System.array TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 19) 17))) anon0_correct))))
