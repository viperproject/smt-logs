...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split160)
...
))) (and (<= (- (_System.array.Length |a#0@@4|) |n#0@3|) |$decr_init$loop#10@0|) |$w$loop#1@0|))) (and (and (and (or (not (= |a#0@@4| null)) (not true)) (<= (_System.array.Length |a#0@@4|) |n#0@3|)) (and (= $Heap@9 $Heap@5) (= |m#0@3| |m#0@1|))) (and (and (= |start#0@3| |start#0@1|) (<= (LitInt 0) |start#0@3|)) (and (<= |start#0@3| (- (_System.array.Length |a#0@@4|) |W#0|)) (= (ControlFlow 0 2) (- 0 1)))))))) (= |m#0@3| (_module.__default.Max ($LS ($LS $LZ)) $Heap@9 |a#0@@4| |start#0@3| |W#0|)))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
