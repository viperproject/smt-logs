...
(declare-fun |Nonempty#0| () T@U)
(declare-fun |Empty#0| () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.TestMultiset)
...
(let ((anon14_Then_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (|MultiSet#Subset| |Nonempty#0| |MultiSet#Empty|))))
(let ((anon13_Then_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (|MultiSet#Subset| |Empty#0| |Nonempty#0|))))
(let ((anon12_Then_correct true))
(let ((anon11_Else_correct  (=> (|MultiSet#Subset| |Empty#0| |MultiSet#Empty|) (and (and (and (=> (= (ControlFlow 0 12) 6) anon12_Then_correct) (=> (= (ControlFlow 0 12) 8) anon13_Then_correct)) (=> (= (ControlFlow 0 12) 10) anon14_Then_correct)) (=> (= (ControlFlow 0 12) 11) anon14_Else_correct)))))
(let ((anon11_Then_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (|MultiSet#Subset| |Empty#0| |Nonempty#0|))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (|MultiSet#Subset| |Nonempty#0| |MultiSet#Empty|))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (and (=> (= (ControlFlow 0 13) 1) anon9_Then_correct) (=> (= (ControlFlow 0 13) 3) anon10_Then_correct)) (=> (= (ControlFlow 0 13) 5) anon11_Then_correct)) (=> (= (ControlFlow 0 13) 12) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MultiSetType |Empty#0| (TMultiSet TInt)) ($IsAlloc MultiSetType |Empty#0| (TMultiSet TInt) $Heap)) (and ($Is MultiSetType |Nonempty#0| (TMultiSet TInt)) ($IsAlloc MultiSetType |Nonempty#0| (TMultiSet TInt) $Heap))) (and (and (= 0 $FunctionContextHeight) (= (|MultiSet#Card| |Empty#0|) (LitInt 0))) (and (> (|MultiSet#Card| |Nonempty#0|) 0) (= (ControlFlow 0 14) 13)))) anon0_correct))))
