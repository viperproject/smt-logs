...
(set-info :boogie-vc-id Impl$$SnapTree.Iterator.MoveNext_split27)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@11) ($IsHeapAnchor $Heap@@11)) (and (or (not (= this@@6 null)) (not true)) (and ($Is refType this@@6 Tclass.SnapTree.Iterator) ($IsAlloc refType this@@6 Tclass.SnapTree.Iterator $Heap@@11)))) (and (and (= 6 $FunctionContextHeight) (SnapTree.Iterator.Valid reveal_SnapTree.Iterator.Valid $Heap@@11 this@@6)) (and (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@6) SnapTree.Iterator.N))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@6) SnapTree.Iterator.Contents)))) (= $_ModifiesFrame@0 (|lambda#9| null $Heap@@11 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@6) SnapTree.Iterator.IterRepr))))))) (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@11 $Heap@0)) (and (and reveal_SnapTree.Iterator.Valid (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) SnapTree.Iterator.initialized))))) (and (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@6 SnapTree.Iterator.initialized)) (= (ControlFlow 0 2) (- 0 1)))))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@6 SnapTree.Iterator.N)))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
