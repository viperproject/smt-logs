...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.MinimumWindowMax_split2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_correct  (=> (and (<= (LitInt 0) |start#0@0|) (<= |start#0@0| (- (_System.array.Length |a#0|) |W#0|))) (=> (and (and ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap@0) ($IsAlloc intType (int_2_U |start#0@0|) TInt $Heap@0)) (and ($IsAlloc intType (int_2_U |W#0|) TInt $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (<= (+ |start#0@0| |W#0|) (_System.array.Length |a#0|))))))
(let ((anon12_Else_correct  (=> (and (< |start#0@0| (LitInt 0)) (= (ControlFlow 0 4) 2)) anon5_correct)))
(let ((anon12_Then_correct  (=> (<= (LitInt 0) |start#0@0|) (=> (and (or (not (= |a#0| null)) (not true)) (= (ControlFlow 0 3) 2)) anon5_correct))))
(let ((anon3_correct  (=> (and (<= (LitInt 1) |W#0|) (<= |W#0| (_System.array.Length |a#0|))) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@4 T@U) ) (!  (=> (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@4) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@4)))
 :qid |MinWindowMaxdfy.28:56|
 :skolemid |657|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4))
)) ($HeapSucc $Heap $Heap@0))) (and (=> (= (ControlFlow 0 5) 3) anon12_Then_correct) (=> (= (ControlFlow 0 5) 4) anon12_Else_correct))))))
(let ((anon11_Else_correct  (=> (and (< |W#0| (LitInt 1)) (= (ControlFlow 0 7) 5)) anon3_correct)))
(let ((anon11_Then_correct  (=> (<= (LitInt 1) |W#0|) (=> (and (or (not (= |a#0| null)) (not true)) (= (ControlFlow 0 6) 5)) anon3_correct))))
(let ((anon0_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (and (= 3 $FunctionContextHeight) (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)))) (and (=> (= (ControlFlow 0 8) 6) anon11_Then_correct) (=> (= (ControlFlow 0 8) 7) anon11_Else_correct))))))
anon0_correct))))))))
))
(check-sat)
(get-info :rlimit)
