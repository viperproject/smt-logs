...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split158)
...
))) (=> |$w$loop#1@0| (<= (- |l#0@0| |$rhs#1@0|) |W#0|))) (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5))))))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (not false) (= |$rhs#0@0| 0)) (<= 0 |k#0@0|)) (<= 1 |l#0@3|)) (= |$rhs#1@0| 0)) (= |$rhs#2@0| 1)) (<= 1 |n#0@3|)) (<= 0 |$decr_init$loop#00@0|)) |$w$loop#0@0|) (= |lo##0@0| 0)) (<= 1 |n#0@1|)) (and (=> |$w$loop#1@0| (<= (LitInt 0) |k#0@0|)) (=> |$w$loop#1@0| (< |k#0@0| |l#0@3|)))) (and (and (and (and (and (=> |$w$loop#1@0| (<= |l#0@3| |n#0@3|)) (=> |$w$loop#1@0| (<= |n#0@3| (_System.array.Length |a#0@@4|)))) (and (=> |$w$loop#1@0| (|_module.__default.StrictlyIncreasing#canCall| $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|)) (=> |$w$loop#1@0| (=> (|_module.__default.StrictlyIncreasing#canCall| $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|) (or (_module.__default.StrictlyIncreasing $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|) (forall ((|i#4@@0| Int) ) (!  (and (=> (and (<= |k#0@0| |i#4@@0|) (< |i#4@@0| |l#0@3|)) (<= (- |n#0@3| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |i#4@@0|)))))) (=> (and (<= |k#0@0| |i#4@@0|) (< |i#4@@0| |l#0@3|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |i#4@@0|)))) |n#0@3|)))
 :qid |MinWindowMaxdfy.146:11|
 :skolemid |690|
...
))))) (and (and (=> |$w$loop#1@0| (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@3| 1))))) (- |n#0@3| 1))) (=> |$w$loop#1@0| (<= (LitInt 0) |start#0@1|))) (and (=> |$w$loop#1@0| (<= |start#0@1| (- (_System.array.Length |a#0@@4|) |W#0|))) (=> |$w$loop#1@0| (|_module.__default.Max#canCall| $Heap@5 |a#0@@4| |start#0@1| |W#0|)))))) (and (and (and (and (=> |$w$loop#1@0| (= |m#0@1| (_module.__default.Max ($LS ($LS $LZ)) $Heap@5 |a#0@@4| |start#0@1| |W#0|))) (=> |$w$loop#1@0| (forall ((|s#3@@0| Int) ) (!  (=> (and (<= (LitInt 0) |s#3@@0|) (<= |s#3@@0| (- |n#0@3| |W#0|))) (|_module.__default.Max#canCall| $Heap@5 |a#0@@4| |s#3@@0| |W#0|))
 :qid |MinWindowMaxdfy.70:22|
 :skolemid |705|
...
))))) (and (and (=> |$w$loop#1@0| (<= (- |l#0@3| |k#0@0|) |W#0|)) (forall (($o@@11 T@U) ) (!  (=> (and (or (not (= $o@@11 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@11) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@11) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@11)))
...
))))) (and (and (and (<= (- (_System.array.Length |a#0@@4|) |n#0@3|) |$decr_init$loop#10@0|) |$w$loop#1@0|) (and (or (not (= |a#0@@4| null)) (not true)) (<= (_System.array.Length |a#0@@4|) |n#0@3|))) (and (and (= $Heap@9 $Heap@5) (= |m#0@3| |m#0@1|)) (and (= |start#0@3| |start#0@1|) (= (ControlFlow 0 2) (- 0 1)))))))) (<= (LitInt 0) |start#0@3|))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
