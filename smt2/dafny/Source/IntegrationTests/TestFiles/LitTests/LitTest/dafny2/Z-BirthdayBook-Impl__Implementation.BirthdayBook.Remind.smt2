...
(assert (forall ((|l#0@@0| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3@@0| T@U) ($o@@9 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#2| |l#0@@0| |l#1@@0| |l#2@@0| |l#3@@0|) $o@@9 $f))  (=> (and (or (not (= $o@@9 |l#0@@0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1@@0| $o@@9) |l#2@@0|)))) (|Set#IsMember| |l#3@@0| ($Box refType $o@@9))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1679|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#2| |l#0@@0| |l#1@@0| |l#2@@0| |l#3@@0|) $o@@9 $f))
)))
...
(set-info :boogie-vc-id Impl$$Implementation.BirthdayBook.Remind)
...
)) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#Equal| |cards#0@0| (|Set#FromBoogieMap| (|lambda#5| (TSeq TChar) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) Implementation.BirthdayBook.known)) (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) Implementation.BirthdayBook.birthday))) |today#0|)))))))))))))))))
(let ((anon8_Else_correct  (=> (and (not (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) Implementation.BirthdayBook.known)) ($Box SeqType |n#2@0|)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) Implementation.BirthdayBook.birthday))) ($Box SeqType |n#2@0|)))) |today#0|))) (= (ControlFlow 0 10) 2)) anon5_correct)))
(let ((anon8_Then_correct  (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) Implementation.BirthdayBook.known)) ($Box SeqType |n#2@0|)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) Implementation.BirthdayBook.birthday))) ($Box SeqType |n#2@0|)))) |today#0|)) (= (ControlFlow 0 9) 2)) anon5_correct)))
(let ((anon7_Else_correct  (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) Implementation.BirthdayBook.known)) ($Box SeqType |n#2@0|))) (and (=> (= (ControlFlow 0 13) 9) anon8_Then_correct) (=> (= (ControlFlow 0 13) 10) anon8_Else_correct)))))
(let ((anon7_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) Implementation.BirthdayBook.known)) ($Box SeqType |n#2@0|)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) Implementation.BirthdayBook.birthday))) ($Box SeqType |n#2@0|))) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) Implementation.BirthdayBook.birthday))) ($Box SeqType |n#2@0|)) (and (=> (= (ControlFlow 0 11) 9) anon8_Then_correct) (=> (= (ControlFlow 0 11) 10) anon8_Else_correct)))))))
(let ((anon6_Then_correct  (=> (and ($Is SeqType |n#2@0| (TSeq TChar)) ($IsAlloc SeqType |n#2@0| (TSeq TChar) $Heap@@1)) (and (=> (= (ControlFlow 0 14) 11) anon7_Then_correct) (=> (= (ControlFlow 0 14) 13) anon7_Else_correct)))))
(let ((anon6_Else_correct  (=> (and (not (and ($Is SeqType |n#2@0| (TSeq TChar)) ($IsAlloc SeqType |n#2@0| (TSeq TChar) $Heap@@1))) (= (ControlFlow 0 8) 2)) anon5_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#2| null $Heap@@1 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) Implementation.BirthdayBook.Repr)))) (and (=> (= (ControlFlow 0 15) 14) anon6_Then_correct) (=> (= (ControlFlow 0 15) 8) anon6_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass.Implementation.BirthdayBook) ($IsAlloc refType this@@1 Tclass.Implementation.BirthdayBook $Heap@@1)))) (=> (and (and (and ($Is SetType |cards#0| (TSet (TSeq TChar))) ($IsAlloc SetType |cards#0| (TSet (TSeq TChar)) $Heap@@1)) (= 1 $FunctionContextHeight)) (and (and (|Implementation.BirthdayBook.Valid#canCall| $Heap@@1 this@@1) (and (Implementation.BirthdayBook.Valid $Heap@@1 this@@1) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) Implementation.BirthdayBook.Repr)) ($Box refType this@@1)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) Implementation.BirthdayBook.Repr)) ($Box refType null)))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) Implementation.BirthdayBook.known)) (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) Implementation.BirthdayBook.birthday))))))) (= (ControlFlow 0 16) 15))) anon0_correct))))
