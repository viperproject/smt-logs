...
(set-info :boogie-vc-id Impl$$A.StoreAndRetrieve.Store)
...
))) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) A.StoreAndRetrieve.Contents)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) A.StoreAndRetrieve.Contents)) (|Set#UnionOne| |Set#Empty| |t#0|))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 (Tclass.A.StoreAndRetrieve A.StoreAndRetrieve$Thing@@17)) ($IsAlloc refType this@@3 (Tclass.A.StoreAndRetrieve A.StoreAndRetrieve$Thing@@17) $Heap@@1)))) (=> (and (and (and ($IsBox |t#0| A.StoreAndRetrieve$Thing@@17) ($IsAllocBox |t#0| A.StoreAndRetrieve$Thing@@17 $Heap@@1)) (= 2 $FunctionContextHeight)) (and (and (|A.StoreAndRetrieve.Valid#canCall| A.StoreAndRetrieve$Thing@@17 $Heap@@1 this@@3) (and (A.StoreAndRetrieve.Valid A.StoreAndRetrieve$Thing@@17 $Heap@@1 this@@3) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) A.StoreAndRetrieve.Repr)) ($Box refType this@@3)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) A.StoreAndRetrieve.Repr)) ($Box refType null)))) (A.StoreAndRetrieve.Valid_k A.StoreAndRetrieve$Thing@@17 $Heap@@1 this@@3)))) (= (ControlFlow 0 8) 2))) anon0_correct))))
