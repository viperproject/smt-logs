...
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id CheckWellFormed$$SnapTree.Iterator.Push_split4)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_correct  (=> (and (and (and (and (<= (LitInt 0) |n#0|) (<= |n#0| (|Seq#Length| |C#0|))) (or (not (= |p#0| null)) (not true))) (and (<= 0 |n#0|) (<= |n#0| (|Seq#Length| |C#0|)))) (and (and (<= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |p#0|) SnapTree.Node.Contents))) (|Seq#Length| (|Seq#Drop| |C#0| |n#0|))) (|Seq#SameUntil| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |p#0|) SnapTree.Node.Contents)) (|Seq#Drop| |C#0| |n#0|) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |p#0|) SnapTree.Node.Contents))))) (and ($IsAlloc DatatypeTypeType |stIn#0| Tclass.SnapTree.List $Heap@@5) (= (ControlFlow 0 2) (- 0 1))))) (or (not (= |p#0| null)) (not true)))))
