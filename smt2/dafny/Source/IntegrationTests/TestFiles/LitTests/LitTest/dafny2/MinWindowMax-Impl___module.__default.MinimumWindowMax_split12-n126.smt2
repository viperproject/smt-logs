...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split127)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon90_correct  (=> (= |n#0@4| (+ |n#0@3| 1)) (=> (and (and (and ($Is intType (int_2_U |W#0|) Tclass._System.nat) (<= (LitInt 0) |k#0@2|)) (and (<= |k#0@2| |$rhs#1_1@1|) (<= |$rhs#1_1@1| (_System.array.Length $nw@0)))) (and (and (forall ((|i#1@@1| Int) ) (!  (and (=> (and (<= |k#0@2| |i#1@@1|) (< |i#1@@1| |$rhs#1_1@1|)) (<= (- |n#0@4| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $nw@0) (IndexField |i#1@@1|)))))) (=> (and (<= |k#0@2| |i#1@@1|) (< |i#1@@1| |$rhs#1_1@1|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $nw@0) (IndexField |i#1@@1|)))) |n#0@4|)))
...
))) (and ($IsGoodHeap $Heap@8) ($IsHeapAnchor $Heap@8)))) (=> (and (and (and (and (<= (- |$rhs#1_1@1| |k#0@2|) |W#0|) (= $Heap@7 $Heap@8)) (and (or (<= 0 |$decr$loop#10@1|) (= (- (_System.array.Length |a#0@@4|) |n#0@4|) |$decr$loop#10@1|)) (< (- (_System.array.Length |a#0@@4|) |n#0@4|) |$decr$loop#10@1|))) (and (and (=> (and (and (and (<= (LitInt 0) |k#0@2|) (< |k#0@2| |$rhs#1_1@1|)) (<= |$rhs#1_1@1| |n#0@4|)) (<= |n#0@4| (_System.array.Length |a#0@@4|))) (and (|_module.__default.StrictlyIncreasing#canCall| $Heap@8 $nw@0 |k#0@2| |$rhs#1_1@1| (- |n#0@4| |W#0|) |n#0@4|) (=> (_module.__default.StrictlyIncreasing $Heap@8 $nw@0 |k#0@2| |$rhs#1_1@1| (- |n#0@4| |W#0|) |n#0@4|) (and (|_module.__default.RightmostMax#canCall| $Heap@8 |a#0@@4| (- |n#0@4| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |k#0@2|)))) |n#0@4|) (=> (_module.__default.RightmostMax $Heap@8 |a#0@@4| (- |n#0@4| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |k#0@2|)))) |n#0@4|) (and (forall ((|u#3| Int) (|_t#0#1| Int) ) (!  (=> (= |_t#0#1| (- |u#3| 1)) (=> (< |k#0@2| |u#3|) (=> (< |u#3| |$rhs#1_1@1|) (|_module.__default.RightmostMax#canCall| $Heap@8 |a#0@@4| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |_t#0#1|)))) 1) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |u#3|)))) |n#0@4|))))
