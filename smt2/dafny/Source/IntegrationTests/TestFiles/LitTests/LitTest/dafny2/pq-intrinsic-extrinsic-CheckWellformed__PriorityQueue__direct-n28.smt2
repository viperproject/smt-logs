...
(declare-fun PriorityQueue__direct.__default.Min (T@U) Int)
(declare-fun |PriorityQueue__direct.__default.Min#canCall| (T@U) Bool)
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|t#0@@2| T@U) ) (!  (=> (or (|PriorityQueue__direct.__default.Min#canCall| (Lit DatatypeTypeType |t#0@@2|)) (and (< 5 $FunctionContextHeight) (and ($Is DatatypeTypeType |t#0@@2| Tclass.PriorityQueue__direct.T) (not (|MultiSet#Equal| (PriorityQueue__direct.__default.Elements ($LS $LZ) (Lit DatatypeTypeType |t#0@@2|)) |MultiSet#Empty|))))) (= (PriorityQueue__direct.__default.Min (Lit DatatypeTypeType |t#0@@2|)) (LitInt (PriorityQueue__direct.T_k.val (Lit DatatypeTypeType |t#0@@2|)))))
 :qid |pqintrinsicextrinsicdfy.294:16|
 :weight 3
 :skolemid |2868|
 :pattern ( (PriorityQueue__direct.__default.Min (Lit DatatypeTypeType |t#0@@2|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@2 T@U) (|t#0@@4| T@U) ) (!  (=> (or (|PriorityQueue__direct.__default.Elements#canCall| |t#0@@4|) (and (< 3 $FunctionContextHeight) ($Is DatatypeTypeType |t#0@@4| Tclass.PriorityQueue__direct.T))) (and (=> (not (PriorityQueue__direct.T_k.Leaf_q |t#0@@4|)) (let ((|right#1| (PriorityQueue__direct.T_k.right |t#0@@4|)))
(let ((|left#1| (PriorityQueue__direct.T_k.left |t#0@@4|)))
 (and (|PriorityQueue__direct.__default.Elements#canCall| |left#1|) (|PriorityQueue__direct.__default.Elements#canCall| |right#1|))))) (= (PriorityQueue__direct.__default.Elements ($LS $ly@@2) |t#0@@4|) (ite (PriorityQueue__direct.T_k.Leaf_q |t#0@@4|) |MultiSet#Empty| (let ((|right#0| (PriorityQueue__direct.T_k.right |t#0@@4|)))
(let ((|left#0| (PriorityQueue__direct.T_k.left |t#0@@4|)))
(let ((|x#0| (PriorityQueue__direct.T_k.val |t#0@@4|)))
(|MultiSet#Union| (|MultiSet#Union| (|MultiSet#UnionOne| |MultiSet#Empty| ($Box intType (int_2_U |x#0|))) (PriorityQueue__direct.__default.Elements $ly@@2 |left#0|)) (PriorityQueue__direct.__default.Elements $ly@@2 |right#0|)))))))))
 :qid |pqintrinsicextrinsicdfy.274:18|
 :skolemid |2852|
 :pattern ( (PriorityQueue__direct.__default.Elements ($LS $ly@@2) |t#0@@4|))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|t#0@@5| T@U) ) (!  (=> (or (|PriorityQueue__direct.__default.Min#canCall| |t#0@@5|) (and (< 5 $FunctionContextHeight) (and ($Is DatatypeTypeType |t#0@@5| Tclass.PriorityQueue__direct.T) (not (|MultiSet#Equal| (PriorityQueue__direct.__default.Elements ($LS $LZ) |t#0@@5|) |MultiSet#Empty|))))) (let ((|m#0| (PriorityQueue__direct.__default.Min |t#0@@5|)))
 (and (> (|MultiSet#Multiplicity| (PriorityQueue__direct.__default.Elements ($LS $LZ) |t#0@@5|) ($Box intType (int_2_U |m#0|))) 0) (forall ((|x#0@@0| T@U) ) (!  (=> (> (|MultiSet#Multiplicity| (PriorityQueue__direct.__default.Elements ($LS $LZ) |t#0@@5|) ($Box intType |x#0@@0|)) 0) (<= |m#0| (U_2_int |x#0@@0|)))
 :qid |pqintrinsicextrinsicdfy.298:14|
 :skolemid |2864|
 :pattern ( (|MultiSet#Multiplicity| (PriorityQueue__direct.__default.Elements ($LS $LZ) |t#0@@5|) ($Box intType |x#0@@0|)))
)))))
 :qid |pqintrinsicextrinsicdfy.294:16|
 :skolemid |2865|
 :pattern ( (PriorityQueue__direct.__default.Min |t#0@@5|))
))))
...
(assert (forall (($ly@@3 T@U) (|t#0@@6| T@U) ) (! (= (PriorityQueue__direct.__default.Valid ($LS $ly@@3) |t#0@@6|) (PriorityQueue__direct.__default.Valid $ly@@3 |t#0@@6|))
 :qid |pqintrinsicextrinsicdfy.263:19|
 :skolemid |2838|
 :pattern ( (PriorityQueue__direct.__default.Valid ($LS $ly@@3) |t#0@@6|))
)))
...
(assert (forall (($ly@@4 T@U) (|t#0@@7| T@U) ) (! (= (PriorityQueue__direct.__default.Elements ($LS $ly@@4) |t#0@@7|) (PriorityQueue__direct.__default.Elements $ly@@4 |t#0@@7|))
 :qid |pqintrinsicextrinsicdfy.274:18|
 :skolemid |2847|
 :pattern ( (PriorityQueue__direct.__default.Elements ($LS $ly@@4) |t#0@@7|))
)))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|t#0@@8| T@U) ) (!  (=> (or (|PriorityQueue__direct.__default.Min#canCall| |t#0@@8|) (and (< 5 $FunctionContextHeight) (and ($Is DatatypeTypeType |t#0@@8| Tclass.PriorityQueue__direct.T) (not (|MultiSet#Equal| (PriorityQueue__direct.__default.Elements ($LS $LZ) |t#0@@8|) |MultiSet#Empty|))))) (= (PriorityQueue__direct.__default.Min |t#0@@8|) (PriorityQueue__direct.T_k.val |t#0@@8|)))
 :qid |pqintrinsicextrinsicdfy.294:16|
 :skolemid |2867|
 :pattern ( (PriorityQueue__direct.__default.Min |t#0@@8|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@5 T@U) (|t#0@@9| T@U) ) (!  (=> (or (|PriorityQueue__direct.__default.Valid#canCall| |t#0@@9|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |t#0@@9| Tclass.PriorityQueue__direct.T_k))) (and (=> (not (PriorityQueue__direct.T_k.Leaf_q |t#0@@9|)) (let ((|right#1@@0| (PriorityQueue__direct.T_k.right |t#0@@9|)))
(let ((|left#1@@0| (PriorityQueue__direct.T_k.left |t#0@@9|)))
(let ((|x#1| (PriorityQueue__direct.T_k.val |t#0@@9|)))
 (and (|PriorityQueue__direct.__default.Valid#canCall| |left#1@@0|) (=> (PriorityQueue__direct.__default.Valid $ly@@5 |left#1@@0|) (and (|PriorityQueue__direct.__default.Valid#canCall| |right#1@@0|) (=> (PriorityQueue__direct.__default.Valid $ly@@5 |right#1@@0|) (and (|$IsA#PriorityQueue__direct.T_k| |left#1@@0|) (=> (or (|PriorityQueue__direct.T_k#Equal| |left#1@@0| |#PriorityQueue_direct.T'.Leaf|) (<= |x#1| (PriorityQueue__direct.T_k.val |left#1@@0|))) (|$IsA#PriorityQueue__direct.T_k| |right#1@@0|))))))))))) (= (PriorityQueue__direct.__default.Valid ($LS $ly@@5) |t#0@@9|) (ite (PriorityQueue__direct.T_k.Leaf_q |t#0@@9|) true (let ((|right#0@@0| (PriorityQueue__direct.T_k.right |t#0@@9|)))
(let ((|left#0@@0| (PriorityQueue__direct.T_k.left |t#0@@9|)))
(let ((|x#0@@1| (PriorityQueue__direct.T_k.val |t#0@@9|)))
 (and (and (and (PriorityQueue__direct.__default.Valid $ly@@5 |left#0@@0|) (PriorityQueue__direct.__default.Valid $ly@@5 |right#0@@0|)) (or (|PriorityQueue__direct.T_k#Equal| |left#0@@0| |#PriorityQueue_direct.T'.Leaf|) (<= |x#0@@1| (PriorityQueue__direct.T_k.val |left#0@@0|)))) (or (|PriorityQueue__direct.T_k#Equal| |right#0@@0| |#PriorityQueue_direct.T'.Leaf|) (<= |x#0@@1| (PriorityQueue__direct.T_k.val |right#0@@0|)))))))))))
 :qid |pqintrinsicextrinsicdfy.263:19|
 :skolemid |2843|
 :pattern ( (PriorityQueue__direct.__default.Valid ($LS $ly@@5) |t#0@@9|))
))))
...
(assert (forall ((|t#0@@10| T@U) ) (! (= ($Is DatatypeTypeType |t#0@@10| Tclass.PriorityQueue__direct.T)  (and ($Is DatatypeTypeType |t#0@@10| Tclass.PriorityQueue__direct.T_k) (PriorityQueue__direct.__default.Valid ($LS $LZ) |t#0@@10|)))
 :qid |unknown.0:0|
 :skolemid |2904|
 :pattern ( ($Is DatatypeTypeType |t#0@@10| Tclass.PriorityQueue__direct.T))
)))
...
(set-info :boogie-vc-id CheckWellformed$$PriorityQueue__direct.__default.Min)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon12_Else_correct true))
(let ((anon7_correct true))
(let ((anon13_Else_correct  (=> (and (>= 0 (|MultiSet#Multiplicity| (PriorityQueue__direct.__default.Elements ($LS $LZ) |t#0@@11|) ($Box intType (int_2_U |x#2@0|)))) (= (ControlFlow 0 11) 7)) anon7_correct)))
(let ((anon13_Then_correct  (=> (and (> (|MultiSet#Multiplicity| (PriorityQueue__direct.__default.Elements ($LS $LZ) |t#0@@11|) ($Box intType (int_2_U |x#2@0|))) 0) (= (ControlFlow 0 10) 7)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and ($IsAlloc DatatypeTypeType |t#0@@11| Tclass.PriorityQueue__direct.T $Heap) (|PriorityQueue__direct.__default.Elements#canCall| |t#0@@11|)) (and (=> (= (ControlFlow 0 12) 10) anon13_Then_correct) (=> (= (ControlFlow 0 12) 11) anon13_Else_correct)))))
(let ((anon11_Then_correct  (=> (> (|MultiSet#Multiplicity| (PriorityQueue__direct.__default.Elements ($LS $LZ) |t#0@@11|) ($Box intType (int_2_U |m#Z#0@0|))) 0) (and (=> (= (ControlFlow 0 13) 12) anon12_Then_correct) (=> (= (ControlFlow 0 13) 9) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (>= 0 (|MultiSet#Multiplicity| (PriorityQueue__direct.__default.Elements ($LS $LZ) |t#0@@11|) ($Box intType (int_2_U |m#Z#0@0|)))) (= (ControlFlow 0 8) 7)) anon7_correct)))
(let ((anon10_Then_correct  (=> ($IsAlloc DatatypeTypeType |t#0@@11| Tclass.PriorityQueue__direct.T $Heap) (and (=> (= (ControlFlow 0 14) (- 0 16)) (not (|MultiSet#Equal| (PriorityQueue__direct.__default.Elements ($LS ($LS $LZ)) |t#0@@11|) |MultiSet#Empty|))) (=> (not (|MultiSet#Equal| (PriorityQueue__direct.__default.Elements ($LS $LZ) |t#0@@11|) |MultiSet#Empty|)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (or (|PriorityQueue__direct.T_k#Equal| |t#0@@11| |t#0@@11|) (< (DtRank |t#0@@11|) (DtRank |t#0@@11|)))) (=> (or (|PriorityQueue__direct.T_k#Equal| |t#0@@11| |t#0@@11|) (< (DtRank |t#0@@11|) (DtRank |t#0@@11|))) (=> (or (|PriorityQueue__direct.T_k#Equal| |t#0@@11| |t#0@@11|) (|PriorityQueue__direct.__default.Min#canCall| |t#0@@11|)) (=> (and (= |let#0#0#0| (PriorityQueue__direct.__default.Min |t#0@@11|)) (|PriorityQueue__direct.__default.Min#canCall| |t#0@@11|)) (=> (and (and ($Is intType (int_2_U |let#0#0#0|) TInt) (= |m#Z#0@0| |let#0#0#0|)) (and ($IsAlloc DatatypeTypeType |t#0@@11| Tclass.PriorityQueue__direct.T $Heap) (|PriorityQueue__direct.__default.Elements#canCall| |t#0@@11|))) (and (=> (= (ControlFlow 0 14) 13) anon11_Then_correct) (=> (= (ControlFlow 0 14) 8) anon11_Else_correct))))))))))))
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (let ((|m#1| (PriorityQueue__direct.__default.Min |t#0@@11|)))
(> (|MultiSet#Multiplicity| (PriorityQueue__direct.__default.Elements ($LS ($LS $LZ)) |t#0@@11|) ($Box intType (int_2_U |m#1|))) 0))) (=> (let ((|m#1@@0| (PriorityQueue__direct.__default.Min |t#0@@11|)))
(> (|MultiSet#Multiplicity| (PriorityQueue__direct.__default.Elements ($LS ($LS $LZ)) |t#0@@11|) ($Box intType (int_2_U |m#1@@0|))) 0)) (=> (= (ControlFlow 0 2) (- 0 1)) (let ((|m#1@@1| (PriorityQueue__direct.__default.Min |t#0@@11|)))
(forall ((|x#1@@0| Int) ) (!  (=> (> (|MultiSet#Multiplicity| (PriorityQueue__direct.__default.Elements ($LS ($LS $LZ)) |t#0@@11|) ($Box intType (int_2_U |x#1@@0|))) 0) (<= |m#1@@1| |x#1@@0|))
 :qid |pqintrinsicextrinsicdfy.298:14|
 :skolemid |2869|
 :pattern ( (|MultiSet#Multiplicity| (PriorityQueue__direct.__default.Elements ($LS ($LS $LZ)) |t#0@@11|) ($Box intType (int_2_U |x#1@@0|))))
))))))))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 6)) (not (|PriorityQueue__direct.T_k#Equal| |t#0@@11| |#PriorityQueue_direct.T'.Leaf|))) (=> (not (|PriorityQueue__direct.T_k#Equal| |t#0@@11| |#PriorityQueue_direct.T'.Leaf|)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (|PriorityQueue__direct.__default.Elements#canCall| |t#0@@11|) (=> (> (|MultiSet#Multiplicity| (PriorityQueue__direct.__default.Elements ($LS $LZ) |t#0@@11|) ($Box intType (int_2_U (PriorityQueue__direct.T_k.val |t#0@@11|)))) 0) (|PriorityQueue__direct.__default.Elements#canCall| |t#0@@11|))) (> (|MultiSet#Multiplicity| (PriorityQueue__direct.__default.Elements ($LS ($LS $LZ)) |t#0@@11|) ($Box intType (int_2_U (PriorityQueue__direct.T_k.val |t#0@@11|)))) 0)) (and (forall ((|x#1@@1| T@U) ) (!  (=> (> (|MultiSet#Multiplicity| (PriorityQueue__direct.__default.Elements ($LS $LZ) |t#0@@11|) ($Box intType |x#1@@1|)) 0) (<= (PriorityQueue__direct.T_k.val |t#0@@11|) (U_2_int |x#1@@1|)))
 :qid |pqintrinsicextrinsicdfy.306:20|
 :skolemid |2876|
 :pattern ( (|MultiSet#Multiplicity| (PriorityQueue__direct.__default.Elements ($LS $LZ) |t#0@@11|) ($Box intType |x#1@@1|)))
)) (= $Heap $Heap@0))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (PriorityQueue__direct.T_k.Node_q |t#0@@11|)) (=> (PriorityQueue__direct.T_k.Node_q |t#0@@11|) (=> (= (PriorityQueue__direct.__default.Min |t#0@@11|) (PriorityQueue__direct.T_k.val |t#0@@11|)) (=> (and ($Is intType (int_2_U (PriorityQueue__direct.__default.Min |t#0@@11|)) TInt) (= (ControlFlow 0 4) 2)) GeneratedUnifiedExit_correct))))))))))
(let ((anon0_correct  (=> (and (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) ($IsAlloc DatatypeTypeType |t#0@@11| Tclass.PriorityQueue__direct.T $Heap)) (and (|PriorityQueue__direct.__default.Elements#canCall| |t#0@@11|) (not (|MultiSet#Equal| (PriorityQueue__direct.__default.Elements ($LS $LZ) |t#0@@11|) |MultiSet#Empty|)))) (and (=> (= (ControlFlow 0 17) 14) anon10_Then_correct) (=> (= (ControlFlow 0 17) 4) anon10_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |t#0@@11| Tclass.PriorityQueue__direct.T)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 18) 17))) anon0_correct)))
