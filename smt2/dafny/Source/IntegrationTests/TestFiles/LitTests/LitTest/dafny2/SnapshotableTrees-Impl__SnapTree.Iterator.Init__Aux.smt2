...
(set-info :boogie-vc-id Impl$$SnapTree.Iterator.Init__Aux)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 29) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (SnapTree.Tree.Valid reveal_SnapTree.Tree.Valid $Heap@10 |t#0|) (SnapTree.Iterator.Valid reveal_SnapTree.Iterator.Valid $Heap@10 this@@9))) (=> (=> (SnapTree.Tree.Valid reveal_SnapTree.Tree.Valid $Heap@10 |t#0|) (SnapTree.Iterator.Valid reveal_SnapTree.Iterator.Valid $Heap@10 this@@9)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (forall (($o@@48 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@9) SnapTree.Iterator.IterRepr)) ($Box refType $o@@48)) (or (not (= $o@@48 this@@9)) (not true))) (or (not (= $o@@48 null)) (not true)))
...
)))) (=> (and (forall (($o@@50 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@9) SnapTree.Iterator.IterRepr)) ($Box refType $o@@50)) (or (not (= $o@@50 this@@9)) (not true))) (or (not (= $o@@50 null)) (not true)))
 :qid |SnapshotableTreesdfy.547:15|
 :skolemid |1048|
 :pattern (  (or (not (= $o@@50 null)) (not true)))
)) (forall (($o@@51 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@9) SnapTree.Iterator.IterRepr)) ($Box refType $o@@51)) (or (not (= $o@@51 this@@9)) (not true))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 $o@@51) alloc)))))
 :qid |SnapshotableTreesdfy.547:15|
 :skolemid |1049|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 $o@@51) alloc)))
))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@9) SnapTree.Iterator.T)) |t#0|)) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@9) SnapTree.Iterator.T)) |t#0|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@9) SnapTree.Iterator.Contents)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |t#0|) SnapTree.Tree.Contents)))) (=> (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@9) SnapTree.Iterator.Contents)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |t#0|) SnapTree.Tree.Contents))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@9) SnapTree.Iterator.N))) (LitInt (- 0 1))))))))))))))
(let ((anon3_Else_correct  (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |t#0|) SnapTree.Tree.root)) null) (=> (and (= $Heap@10 $Heap@7) (= (ControlFlow 0 19) 2)) GeneratedUnifiedExit_correct))))
(let ((anon3_Then_correct  (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |t#0|) SnapTree.Tree.root)) null)) (not true)) (and (=> (= (ControlFlow 0 7) (- 0 18)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@9 SnapTree.Iterator.stack))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@9 SnapTree.Iterator.stack)) (=> (and (= |stIn##0_0@0| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@9) SnapTree.Iterator.stack))) (= |n##0_0@0| (LitInt 0))) (and (=> (= (ControlFlow 0 7) (- 0 17)) (or (not (= |t#0| null)) (not true))) (=> (or (not (= |t#0| null)) (not true)) (and (=> (= (ControlFlow 0 7) (- 0 16)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |t#0|) SnapTree.Tree.root)) Tclass.SnapTree.Node)) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |t#0|) SnapTree.Tree.root)) Tclass.SnapTree.Node) (=> (and (= |p##0_0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |t#0|) SnapTree.Tree.root))) (= |C##0_0@0| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@9) SnapTree.Iterator.Contents)))) (and (=> (= (ControlFlow 0 7) (- 0 15)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@9) SnapTree.Iterator.T)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@9) SnapTree.Iterator.T)) null)) (not true)) (=> (= |Nodes##0_0@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@9) SnapTree.Iterator.T))) SnapTree.Tree.Repr))) (=> (and ($Is DatatypeTypeType |call6formal@st#0| Tclass.SnapTree.List) ($IsAlloc DatatypeTypeType |call6formal@st#0| Tclass.SnapTree.List $Heap@@11)) (and (=> (= (ControlFlow 0 7) (- 0 14)) (|Set#IsMember| |Nodes##0_0@0| ($Box refType |p##0_0@0|))) (=> (|Set#IsMember| |Nodes##0_0@0| ($Box refType |p##0_0@0|)) (and (=> (= (ControlFlow 0 7) (- 0 13)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |p##0_0@0|) SnapTree.Node.Repr)) |Nodes##0_0@0|)) (=> (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |p##0_0@0|) SnapTree.Node.Repr)) |Nodes##0_0@0|) (and (=> (= (ControlFlow 0 7) (- 0 12)) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@7 |p##0_0@0|)) (=> (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@7 |p##0_0@0|) (and (=> (= (ControlFlow 0 7) (- 0 11)) (<= (LitInt 0) |n##0_0@0|)) (=> (<= (LitInt 0) |n##0_0@0|) (and (=> (= (ControlFlow 0 7) (- 0 10)) (<= |n##0_0@0| (|Seq#Length| |C##0_0@0|))) (=> (<= |n##0_0@0| (|Seq#Length| |C##0_0@0|)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (and (<= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |p##0_0@0|) SnapTree.Node.Contents))) (|Seq#Length| (|Seq#Drop| |C##0_0@0| |n##0_0@0|))) (|Seq#SameUntil| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |p##0_0@0|) SnapTree.Node.Contents)) (|Seq#Drop| |C##0_0@0| |n##0_0@0|) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |p##0_0@0|) SnapTree.Node.Contents)))))) (=> (and (<= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |p##0_0@0|) SnapTree.Node.Contents))) (|Seq#Length| (|Seq#Drop| |C##0_0@0| |n##0_0@0|))) (|Seq#SameUntil| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |p##0_0@0|) SnapTree.Node.Contents)) (|Seq#Drop| |C##0_0@0| |n##0_0@0|) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |p##0_0@0|) SnapTree.Node.Contents))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (SnapTree.Iterator.R ($LS ($LS $LZ)) reveal_SnapTree.Iterator.R $Heap@7 |stIn##0_0@0| (+ |n##0_0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |p##0_0@0|) SnapTree.Node.Contents)))) |C##0_0@0| |Nodes##0_0@0|)) (=> (SnapTree.Iterator.R ($LS ($LS $LZ)) reveal_SnapTree.Iterator.R $Heap@7 |stIn##0_0@0| (+ |n##0_0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |p##0_0@0|) SnapTree.Node.Contents)))) |C##0_0@0| |Nodes##0_0@0|) (=> (and (and ($IsGoodHeap $Heap@8) ($IsHeapAnchor $Heap@8)) (and ($Is DatatypeTypeType |call6formal@st#0@0| Tclass.SnapTree.List) ($IsAlloc DatatypeTypeType |call6formal@st#0@0| Tclass.SnapTree.List $Heap@8))) (=> (and (and (and (|SnapTree.Iterator.R#canCall| $Heap@8 |call6formal@st#0@0| |n##0_0@0| |C##0_0@0| |Nodes##0_0@0|) (SnapTree.Iterator.R ($LS ($LS $LZ)) reveal_SnapTree.Iterator.R $Heap@8 |call6formal@st#0@0| |n##0_0@0| |C##0_0@0| |Nodes##0_0@0|)) (and (forall (($o@@52 T@U) ) (!  (=> (and (or (not (= $o@@52 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@52) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@52) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@52)))
 :qid |SnapshotableTreesdfy.583:41|
 :skolemid |1071|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@52))
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#40| null $Heap@@11 alloc this@@9)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@11 $Heap@0) reveal_SnapTree.Iterator.Valid)) (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (= $Heap@0 $Heap@1) reveal_SnapTree.Iterator.R))) (and (=> (= (ControlFlow 0 20) (- 0 28)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@9 SnapTree.Iterator.T))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@9 SnapTree.Iterator.T)) (=> (and (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 this@@9 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@9) SnapTree.Iterator.T ($Box refType |t#0|)))) ($IsGoodHeap $Heap@2)) (and (=> (= (ControlFlow 0 20) (- 0 27)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@9 SnapTree.Iterator.IterRepr))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@9 SnapTree.Iterator.IterRepr)) (=> (= |$rhs#1@0| (|Set#UnionOne| |Set#Empty| ($Box refType this@@9))) (=> (and (= $Heap@3 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@2 this@@9 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@9) SnapTree.Iterator.IterRepr ($Box SetType |$rhs#1@0|)))) ($IsGoodHeap $Heap@3)) (and (=> (= (ControlFlow 0 20) (- 0 26)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@9 SnapTree.Iterator.Contents))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@9 SnapTree.Iterator.Contents)) (and (=> (= (ControlFlow 0 20) (- 0 25)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@9) SnapTree.Iterator.T)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@9) SnapTree.Iterator.T)) null)) (not true)) (=> (= |$rhs#2@0| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@9) SnapTree.Iterator.T))) SnapTree.Tree.Contents))) (=> (and (= $Heap@4 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@3 this@@9 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@9) SnapTree.Iterator.Contents ($Box SeqType |$rhs#2@0|)))) ($IsGoodHeap $Heap@4)) (and (=> (= (ControlFlow 0 20) (- 0 24)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@9 SnapTree.Iterator.initialized))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@9 SnapTree.Iterator.initialized)) (and (=> (= (ControlFlow 0 20) (- 0 23)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@9 SnapTree.Iterator.stack))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@9 SnapTree.Iterator.stack)) (and (=> (= (ControlFlow 0 20) (- 0 22)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@9 SnapTree.Iterator.N))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@9 SnapTree.Iterator.N)) (=> (= |$rhs#3@0| (U_2_bool (Lit boolType (bool_2_U false)))) (=> (and (and (and (= |$rhs#4@0| (Lit DatatypeTypeType |#SnapTree.List.Nil|)) (= |$rhs#5@0| (LitInt (- 0 1)))) (and (= $Heap@5 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@4 this@@9 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@9) SnapTree.Iterator.initialized ($Box boolType (bool_2_U |$rhs#3@0|))))) ($IsGoodHeap $Heap@5))) (and (and (= $Heap@6 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@5 this@@9 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@9) SnapTree.Iterator.stack ($Box DatatypeTypeType |$rhs#4@0|)))) ($IsGoodHeap $Heap@6)) (and (= $Heap@7 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@6 this@@9 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@9) SnapTree.Iterator.N ($Box intType (int_2_U |$rhs#5@0|))))) ($IsGoodHeap $Heap@7)))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (or (not (= |t#0| null)) (not true))) (=> (or (not (= |t#0| null)) (not true)) (and (=> (= (ControlFlow 0 20) 7) anon3_Then_correct) (=> (= (ControlFlow 0 20) 19) anon3_Else_correct)))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@11) ($IsHeapAnchor $Heap@@11)) (and (or (not (= this@@9 null)) (not true)) (and ($Is refType this@@9 Tclass.SnapTree.Iterator) ($IsAlloc refType this@@9 Tclass.SnapTree.Iterator $Heap@@11)))) (and (and ($Is refType |t#0| Tclass.SnapTree.Tree) ($IsAlloc refType |t#0| Tclass.SnapTree.Tree $Heap@@11)) (= 6 $FunctionContextHeight))) (and (and (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.Repr)) ($Box refType this@@9))) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root)) null) (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.Contents))) (LitInt 0)))) (and (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root)) null)) (not true)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root))) SnapTree.Node.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.Repr)))))) (and (and (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root)) null)) (not true)) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root)))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root)) null)) (not true)) (and (<= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root))) SnapTree.Node.Contents))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.Contents)))) (|Seq#SameUntil| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root))) SnapTree.Node.Contents)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.Contents)) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root))) SnapTree.Node.Contents))))))) (and (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root)) null)) (not true)) (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.Contents))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 |t#0|) SnapTree.Tree.root))) SnapTree.Node.Contents))))) (= (ControlFlow 0 29) 20))))) anon0_correct)))
