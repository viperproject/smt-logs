...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@5 T@U) (|xs#0@@5| T@U) (|n#0| Int) (|len#0| Int) ) (!  (=> (or (|_module.__default.SMN_k#canCall| |xs#0@@5| |n#0| (LitInt |len#0|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |xs#0@@5| (Tclass._module.List Tclass._System.nat)) (<= (LitInt 0) |n#0|)) (<= (LitInt 0) |len#0|)) (= (LitInt |len#0|) (_module.__default.Length Tclass._System.nat ($LS $LZ) |xs#0@@5|))))) (and (and (|$IsA#_module.List| |xs#0@@5|) (=> (not (|_module.List#Equal| |xs#0@@5| |#_module.List.Nil|)) (let ((|half#1| (LitInt (Div (+ |len#0| 1) (LitInt 2)))))
...
(let ((|L#1| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@5| (+ |n#0| |half#1|))))))
 ...
 (and (=> (< |llen#1| |half#1|) (|_module.__default.SMN_k#canCall| |L#1| |n#0| |llen#1|)) (=> (<= |half#1| |llen#1|) (|_module.__default.SMN_k#canCall| |R#1| (+ |n#0| |llen#1|) (- |len#0| |llen#1|)))))))))))) (= (_module.__default.SMN_k ($LS $ly@@5) |xs#0@@5| |n#0| (LitInt |len#0|)) (ite (|_module.List#Equal| |xs#0@@5| |#_module.List.Nil|) |n#0| (let ((|half#1@@0| (LitInt (Div (+ |len#0| 1) (LitInt 2)))))
...
(ite (< |llen#1@@0| |half#1@@0|) (_module.__default.SMN_k ($LS $ly@@5) |L#1@@0| |n#0| |llen#1@@0|) (_module.__default.SMN_k ($LS $ly@@5) |R#1@@0| (+ |n#0| |llen#1@@0|) (- |len#0| |llen#1@@0|)))))))))))
 :qid |SmallestMissingNumberfunctionaldfy.58:10|
 :weight 3
 :skolemid |617|
 :pattern ( (_module.__default.SMN_k ($LS $ly@@5) |xs#0@@5| |n#0| (LitInt |len#0|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.Elements$_T0@@1 T@U) ($ly@@6 T@U) (|xs#0@@6| T@U) ) (!  (=> (or (|_module.__default.Elements#canCall| _module._default.Elements$_T0@@1 (Lit DatatypeTypeType |xs#0@@6|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@6| (Tclass._module.List _module._default.Elements$_T0@@1)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@6|)))))) (let ((|tail#3@@0| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@6|)))))
(|_module.__default.Elements#canCall| _module._default.Elements$_T0@@1 |tail#3@@0|))) (= (_module.__default.Elements _module._default.Elements$_T0@@1 ($LS $ly@@6) (Lit DatatypeTypeType |xs#0@@6|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@6|)) |Set#Empty| (let ((|tail#2@@0| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@6|)))))
(let ((|x#2| (Lit BoxType (_module.List.head (Lit DatatypeTypeType |xs#0@@6|)))))
(|Set#Union| (|Set#UnionOne| |Set#Empty| |x#2|) (_module.__default.Elements _module._default.Elements$_T0@@1 ($LS $ly@@6) |tail#2@@0|))))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |659|
 :pattern ( (_module.__default.Elements _module._default.Elements$_T0@@1 ($LS $ly@@6) (Lit DatatypeTypeType |xs#0@@6|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@9 T@U) (|xs#0@@9| T@U) (|n#0@@0| Int) (|len#0@@0| Int) ) (!  (=> (or (|_module.__default.SMN_k#canCall| |xs#0@@9| |n#0@@0| |len#0@@0|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |xs#0@@9| (Tclass._module.List Tclass._System.nat)) (<= (LitInt 0) |n#0@@0|)) (<= (LitInt 0) |len#0@@0|)) (= |len#0@@0| (_module.__default.Length Tclass._System.nat ($LS $LZ) |xs#0@@9|))))) (and (and (|$IsA#_module.List| |xs#0@@9|) (=> (not (|_module.List#Equal| |xs#0@@9| |#_module.List.Nil|)) (let ((|half#0| (Div (+ |len#0@@0| 1) (LitInt 2))))
...
(let ((|L#0| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@9| (+ |n#0@@0| |half#0|))))))
 ...
 (and (=> (< |llen#0| |half#0|) (|_module.__default.SMN_k#canCall| |L#0| |n#0@@0| |llen#0|)) (=> (<= |half#0| |llen#0|) (|_module.__default.SMN_k#canCall| |R#0| (+ |n#0@@0| |llen#0|) (- |len#0@@0| |llen#0|)))))))))))) (= (_module.__default.SMN_k ($LS $ly@@9) |xs#0@@9| |n#0@@0| |len#0@@0|) (ite (|_module.List#Equal| |xs#0@@9| |#_module.List.Nil|) |n#0@@0| (let ((|half#0@@0| (Div (+ |len#0@@0| 1) (LitInt 2))))
...
(ite (< |llen#0@@0| |half#0@@0|) (_module.__default.SMN_k $ly@@9 |L#0@@0| |n#0@@0| |llen#0@@0|) (_module.__default.SMN_k $ly@@9 |R#0@@0| (+ |n#0@@0| |llen#0@@0|) (- |len#0@@0| |llen#0@@0|)))))))))))
 :qid |SmallestMissingNumberfunctionaldfy.58:10|
 :skolemid |616|
 :pattern ( (_module.__default.SMN_k ($LS $ly@@9) |xs#0@@9| |n#0@@0| |len#0@@0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@10 T@U) (|xs#0@@10| T@U) (|b#0@@0| Int) ) (!  (=> (or (|_module.__default.Split#canCall| (Lit DatatypeTypeType |xs#0@@10|) (LitInt |b#0@@0|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@10| (Tclass._module.List Tclass._System.nat)) (<= (LitInt 0) |b#0@@0|)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@10|)))))) (let ((|tail#3@@1| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@10|)))))
(|_module.__default.Split#canCall| |tail#3@@1| (LitInt |b#0@@0|)))) (= (_module.__default.Split ($LS $ly@@10) true (Lit DatatypeTypeType |xs#0@@10|) (LitInt |b#0@@0|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@10|)) (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.List.Nil|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.List.Nil|))) (let ((|tail#2@@1| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@10|)))))
...
(ite (< |x#2@@0| |b#0@@0|) (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U |x#2@@0|)) |L#2|)) ($Box DatatypeTypeType |R#2|)) (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |L#2|) ($Box DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U |x#2@@0|)) |R#2|))))))))))))
 ...
 :weight 3
 :skolemid |641|
 :pattern ( (_module.__default.Split ($LS $ly@@10) true (Lit DatatypeTypeType |xs#0@@10|) (LitInt |b#0@@0|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@11 T@U) (|xs#0@@11| T@U) (|b#0@@1| Int) ) (!  (=> (or (|_module.__default.Split#canCall| |xs#0@@11| |b#0@@1|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@11| (Tclass._module.List Tclass._System.nat)) (<= (LitInt 0) |b#0@@1|)))) (and (=> (not (_module.List.Nil_q |xs#0@@11|)) (let ((|tail#1@@2| (_module.List.tail |xs#0@@11|)))
(|_module.__default.Split#canCall| |tail#1@@2| |b#0@@1|))) (= (_module.__default.Split ($LS $ly@@11) true |xs#0@@11| |b#0@@1|) (ite (_module.List.Nil_q |xs#0@@11|) (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.List.Nil|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.List.Nil|))) (let ((|tail#0@@2| (_module.List.tail |xs#0@@11|)))
(let ((|x#0@@3| (U_2_int ($Unbox intType (_module.List.head |xs#0@@11|)))))
(let ((|R#0@@1| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split $ly@@11 reveal__module._default.Split |tail#0@@2| |b#0@@1|)))))
(let ((|L#0@@1| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split $ly@@11 reveal__module._default.Split |tail#0@@2| |b#0@@1|)))))
(ite (< |x#0@@3| |b#0@@1|) (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U |x#0@@3|)) |L#0@@1|)) ($Box DatatypeTypeType |R#0@@1|)) (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |L#0@@1|) ($Box DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U |x#0@@3|)) |R#0@@1|))))))))))))
 :qid |SmallestMissingNumberfunctionaldfy.93:17|
 :skolemid |640|
 :pattern ( (_module.__default.Split ($LS $ly@@11) true |xs#0@@11| |b#0@@1|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@12 T@U) (|xs#0@@12| T@U) (|n#0@@1| Int) (|len#0@@1| Int) ) (!  (=> (or (|_module.__default.SMN_k#canCall| |xs#0@@12| |n#0@@1| |len#0@@1|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |xs#0@@12| (Tclass._module.List Tclass._System.nat)) (<= (LitInt 0) |n#0@@1|)) (<= (LitInt 0) |len#0@@1|)) (= |len#0@@1| (_module.__default.Length Tclass._System.nat ($LS $LZ) |xs#0@@12|))))) (<= (LitInt 0) (_module.__default.SMN_k $ly@@12 |xs#0@@12| |n#0@@1| |len#0@@1|)))
 :qid |SmallestMissingNumberfunctionaldfy.58:10|
 :skolemid |614|
 :pattern ( (_module.__default.SMN_k $ly@@12 |xs#0@@12| |n#0@@1| |len#0@@1|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.Elements$_T0@@2 T@U) ($ly@@13 T@U) (|xs#0@@13| T@U) ) (!  (=> (and (or (|_module.__default.Elements#canCall| _module._default.Elements$_T0@@2 |xs#0@@13|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@13| (Tclass._module.List _module._default.Elements$_T0@@2)) ($IsAlloc DatatypeTypeType |xs#0@@13| (Tclass._module.List _module._default.Elements$_T0@@2) $Heap)))) ($IsGoodHeap $Heap)) ($IsAlloc SetType (_module.__default.Elements _module._default.Elements$_T0@@2 $ly@@13 |xs#0@@13|) (TSet _module._default.Elements$_T0@@2) $Heap))
 :qid |SmallestMissingNumberfunctionaldfy.117:16|
 :skolemid |656|
 :pattern ( ($IsAlloc SetType (_module.__default.Elements _module._default.Elements$_T0@@2 $ly@@13 |xs#0@@13|) (TSet _module._default.Elements$_T0@@2) $Heap))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.Elements$_T0@@3 T@U) ($ly@@14 T@U) (|xs#0@@14| T@U) ) (!  (=> (or (|_module.__default.Elements#canCall| _module._default.Elements$_T0@@3 |xs#0@@14|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@14| (Tclass._module.List _module._default.Elements$_T0@@3)))) ($Is SetType (_module.__default.Elements _module._default.Elements$_T0@@3 $ly@@14 |xs#0@@14|) (TSet _module._default.Elements$_T0@@3)))
 :qid |unknown.0:0|
 :skolemid |655|
 :pattern ( (_module.__default.Elements _module._default.Elements$_T0@@3 $ly@@14 |xs#0@@14|))
))))
...
(assert (forall (($ly@@15 T@U) (|xs#0@@15| T@U) (|n#0@@2| Int) (|len#0@@2| Int) ) (! (= (_module.__default.SMN_k ($LS $ly@@15) |xs#0@@15| |n#0@@2| |len#0@@2|) (_module.__default.SMN_k $ly@@15 |xs#0@@15| |n#0@@2| |len#0@@2|))
 :qid |SmallestMissingNumberfunctionaldfy.58:10|
 :skolemid |612|
 :pattern ( (_module.__default.SMN_k ($LS $ly@@15) |xs#0@@15| |n#0@@2| |len#0@@2|))
)))
(assert (forall (($ly@@16 T@U) ($reveal@@0 Bool) (|xs#0@@16| T@U) (|b#0@@2| Int) ) (! (= (_module.__default.Split ($LS $ly@@16) $reveal@@0 |xs#0@@16| |b#0@@2|) (_module.__default.Split $ly@@16 $reveal@@0 |xs#0@@16| |b#0@@2|))
 :qid |SmallestMissingNumberfunctionaldfy.93:17|
 :skolemid |636|
 :pattern ( (_module.__default.Split ($LS $ly@@16) $reveal@@0 |xs#0@@16| |b#0@@2|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@17 T@U) (|xs#0@@17| T@U) (|n#0@@3| Int) (|len#0@@3| Int) ) (!  (=> (or (|_module.__default.SMN_k#canCall| (Lit DatatypeTypeType |xs#0@@17|) (LitInt |n#0@@3|) (LitInt |len#0@@3|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |xs#0@@17| (Tclass._module.List Tclass._System.nat)) (<= (LitInt 0) |n#0@@3|)) (<= (LitInt 0) |len#0@@3|)) (= (LitInt |len#0@@3|) (LitInt (_module.__default.Length Tclass._System.nat ($LS $LZ) (Lit DatatypeTypeType |xs#0@@17|))))))) (and (and (|$IsA#_module.List| (Lit DatatypeTypeType |xs#0@@17|)) (=> (not (|_module.List#Equal| |xs#0@@17| |#_module.List.Nil|)) (let ((|half#2| (LitInt (Div (+ |len#0@@3| 1) (LitInt 2)))))
...
(let ((|L#2@@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $LZ) reveal__module._default.Split (Lit DatatypeTypeType |xs#0@@17|) (+ |n#0@@3| |half#2|))))))
 ...
 (and (=> (< |llen#2| |half#2|) (|_module.__default.SMN_k#canCall| |L#2@@0| (LitInt |n#0@@3|) |llen#2|)) (=> (<= |half#2| |llen#2|) (|_module.__default.SMN_k#canCall| |R#2@@0| (+ |n#0@@3| |llen#2|) (- |len#0@@3| |llen#2|)))))))))))) (= (_module.__default.SMN_k ($LS $ly@@17) (Lit DatatypeTypeType |xs#0@@17|) (LitInt |n#0@@3|) (LitInt |len#0@@3|)) (ite (|_module.List#Equal| |xs#0@@17| |#_module.List.Nil|) |n#0@@3| (let ((|half#2@@0| (LitInt (Div (+ |len#0@@3| 1) (LitInt 2)))))
...
(ite (< |llen#2@@0| |half#2@@0|) (_module.__default.SMN_k ($LS $ly@@17) |L#2@@1| (LitInt |n#0@@3|) |llen#2@@0|) (_module.__default.SMN_k ($LS $ly@@17) |R#2@@1| (+ |n#0@@3| |llen#2@@0|) (- |len#0@@3| |llen#2@@0|)))))))))))
 :qid |SmallestMissingNumberfunctionaldfy.58:10|
 :weight 3
 :skolemid |618|
 :pattern ( (_module.__default.SMN_k ($LS $ly@@17) (Lit DatatypeTypeType |xs#0@@17|) (LitInt |n#0@@3|) (LitInt |len#0@@3|)))
))))
...
(let ((|x#2@@1| (Lit BoxType (_module.List.head (Lit DatatypeTypeType |xs#0@@18|)))))
 ...
 :weight 3
 :skolemid |666|
 :pattern ( (_module.__default.NoDuplicates _module._default.NoDuplicates$_T0@@1 ($LS $ly@@18) (Lit DatatypeTypeType |xs#0@@18|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.Length$_T0@@2 T@U) ($ly@@19 T@U) (|xs#0@@19| T@U) ) (!  (=> (or (|_module.__default.Length#canCall| _module._default.Length$_T0@@2 |xs#0@@19|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@19| (Tclass._module.List _module._default.Length$_T0@@2)))) (<= (LitInt 0) (_module.__default.Length _module._default.Length$_T0@@2 $ly@@19 |xs#0@@19|)))
 :qid |unknown.0:0|
 :skolemid |589|
 :pattern ( (_module.__default.Length _module._default.Length$_T0@@2 $ly@@19 |xs#0@@19|))
))))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.SMN_k__Correct)
...
(let ((anon22_Else_correct  (=> (and (not (and (<= |n#0@@4| |x#2@0|) (< |x#2@0| |s#Z#0@0|))) (= (ControlFlow 0 5) 1)) anon15_correct)))
(let ((anon22_Then_correct  (=> (and (and (and (<= |n#0@@4| |x#2@0|) (< |x#2@0| |s#Z#0@0|)) ($IsAlloc DatatypeTypeType |xs#0@@20| (Tclass._module.List Tclass._System.nat) $Heap@0)) (and (|_module.__default.Elements#canCall| Tclass._System.nat |xs#0@@20|) (= (ControlFlow 0 4) 1))) anon15_correct)))
(let ((anon21_Else_correct  (=> (< |x#2@0| |n#0@@4|) (and (=> (= (ControlFlow 0 7) 4) anon22_Then_correct) (=> (= (ControlFlow 0 7) 5) anon22_Else_correct)))))
(let ((anon21_Then_correct  (=> (<= |n#0@@4| |x#2@0|) (and (=> (= (ControlFlow 0 6) 4) anon22_Then_correct) (=> (= (ControlFlow 0 6) 5) anon22_Else_correct)))))
(let ((anon20_Then_correct  (and (=> (= (ControlFlow 0 8) 6) anon21_Then_correct) (=> (= (ControlFlow 0 8) 7) anon21_Else_correct))))
(let ((anon19_Then_correct  (=> (and (and (<= |n#0@@4| |s#Z#0@0|) (<= |s#Z#0@0| (+ |n#0@@4| |len#0@@4|))) (not (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |xs#0@@20|) ($Box intType (int_2_U |s#Z#0@0|))))) (and (=> (= (ControlFlow 0 9) 8) anon20_Then_correct) (=> (= (ControlFlow 0 9) 3) anon20_Else_correct)))))
(let ((anon19_Else_correct  (=> (and (not (and (and (<= |n#0@@4| |s#Z#0@0|) (<= |s#Z#0@0| (+ |n#0@@4| |len#0@@4|))) (not (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |xs#0@@20|) ($Box intType (int_2_U |s#Z#0@0|)))))) (= (ControlFlow 0 2) 1)) anon15_correct)))
(let ((anon18_Else_correct  (=> (not (and (<= |n#0@@4| |s#Z#0@0|) (<= |s#Z#0@0| (+ |n#0@@4| |len#0@@4|)))) (and (=> (= (ControlFlow 0 11) 9) anon19_Then_correct) (=> (= (ControlFlow 0 11) 2) anon19_Else_correct)))))
(let ((anon18_Then_correct  (=> (and (and (<= |n#0@@4| |s#Z#0@0|) (<= |s#Z#0@0| (+ |n#0@@4| |len#0@@4|))) (and ($IsAlloc DatatypeTypeType |xs#0@@20| (Tclass._module.List Tclass._System.nat) $Heap@0) (|_module.__default.Elements#canCall| Tclass._System.nat |xs#0@@20|))) (and (=> (= (ControlFlow 0 10) 9) anon19_Then_correct) (=> (= (ControlFlow 0 10) 2) anon19_Else_correct)))))
(let ((anon17_Else_correct  (=> (< |s#Z#0@0| |n#0@@4|) (and (=> (= (ControlFlow 0 13) 10) anon18_Then_correct) (=> (= (ControlFlow 0 13) 11) anon18_Else_correct)))))
(let ((anon17_Then_correct  (=> (<= |n#0@@4| |s#Z#0@0|) (and (=> (= (ControlFlow 0 12) 10) anon18_Then_correct) (=> (= (ControlFlow 0 12) 11) anon18_Else_correct)))))
(let ((anon4_correct  (=> (and (forall ((|x#1@@0| T@U) ) (!  (=> (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |xs#0@@20|) ($Box intType |x#1@@0|)) (<= |n#0@@4| (U_2_int |x#1@@0|)))
...
)) ($IsAlloc DatatypeTypeType |xs#0@@20| (Tclass._module.List Tclass._System.nat) $Heap@@0)) (=> (and (and (and (|_module.__default.Length#canCall| Tclass._System.nat |xs#0@@20|) (= |len#0@@4| (_module.__default.Length Tclass._System.nat ($LS $LZ) |xs#0@@20|))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (= $Heap@@0 $Heap@0) ($IsAlloc DatatypeTypeType |xs#0@@20| (Tclass._module.List Tclass._System.nat) $Heap@0)) (and ($IsAlloc intType (int_2_U |n#0@@4|) Tclass._System.nat $Heap@0) ($IsAlloc intType (int_2_U |len#0@@4|) Tclass._System.nat $Heap@0)))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (= |len#0@@4| (_module.__default.Length Tclass._System.nat ($LS ($LS $LZ)) |xs#0@@20|))) (=> (and (= |len#0@@4| (_module.__default.Length Tclass._System.nat ($LS $LZ) |xs#0@@20|)) (|_module.__default.SMN_k#canCall| |xs#0@@20| |n#0@@4| |len#0@@4|)) (=> (and (and (= |let#0#0#0| (_module.__default.SMN_k ($LS $LZ) |xs#0@@20| |n#0@@4| |len#0@@4|)) (|_module.__default.SMN_k#canCall| |xs#0@@20| |n#0@@4| |len#0@@4|)) (and ($Is intType (int_2_U |let#0#0#0|) Tclass._System.nat) (= |s#Z#0@0| |let#0#0#0|))) (and (=> (= (ControlFlow 0 14) 12) anon17_Then_correct) (=> (= (ControlFlow 0 14) 13) anon17_Else_correct)))))))))
(let ((anon16_Else_correct  (=> (and (=> (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |xs#0@@20|) ($Box intType (int_2_U |x#0@0|))) (<= |n#0@@4| |x#0@0|)) (= (ControlFlow 0 17) 14)) anon4_correct)))
(let ((anon16_Then_correct  (=> ($IsAlloc DatatypeTypeType |xs#0@@20| (Tclass._module.List Tclass._System.nat) $Heap@@0) (=> (and (and (|_module.__default.Elements#canCall| Tclass._System.nat |xs#0@@20|) (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |xs#0@@20|) ($Box intType (int_2_U |x#0@0|)))) (and (<= |n#0@@4| |x#0@0|) (= (ControlFlow 0 16) 14))) anon4_correct))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) ($IsAlloc DatatypeTypeType |xs#0@@20| (Tclass._module.List Tclass._System.nat) $Heap@@0)) (and (|_module.__default.NoDuplicates#canCall| Tclass._System.nat |xs#0@@20|) (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |xs#0@@20|))) (and (=> (= (ControlFlow 0 18) 16) anon16_Then_correct) (=> (= (ControlFlow 0 18) 17) anon16_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and ($Is DatatypeTypeType |xs#0@@20| (Tclass._module.List Tclass._System.nat)) ($IsAlloc DatatypeTypeType |xs#0@@20| (Tclass._module.List Tclass._System.nat) $Heap@@0)) (|$IsA#_module.List| |xs#0@@20|)) (and (and (<= (LitInt 0) |n#0@@4|) (<= (LitInt 0) |len#0@@4|)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 19) 18)))) anon0_correct))))
