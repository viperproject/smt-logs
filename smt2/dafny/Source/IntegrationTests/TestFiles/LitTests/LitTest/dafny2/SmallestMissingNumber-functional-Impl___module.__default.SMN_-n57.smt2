...
(set-info :boogie-vc-id Impl$$_module.__default.SMN_k_k__Correct_split37)
...
(_module.__default.NoDuplicates Tclass._System.nat ($LS ($LS $LZ)) |tail#0@@4|)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))))) (=> (and (and (and (and (and (and (|_module.__default.Split#canCall| |xs#0@@15| |b##1_0@0|) (let ((|r#0@@0| (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@15| |b##1_0@0|)))
...
(let ((|x#7@@0| (U_2_int ($Unbox intType (_module.List.head ($Unbox DatatypeTypeType (_System.Tuple2._0 |r#0@@3|)))))))
 (and (not (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |tail#3@@4|) ($Box intType (int_2_U |x#7@@0|)))) (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |tail#3@@4|)))))))))) (and (and (let ((|r#0@@4| (_module.__default.Split ($LS ($LS $LZ)) reveal__module._default.Split |xs#0@@15| |b##1_0@0|)))
...
(_module.__default.NoDuplicates call0formal@_module._default.Elements_Property$_T0@0 ($LS ($LS $LZ)) |tail#0@@6|)))))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1))))) (and (and (and (and (and (|_module.__default.Elements#canCall| call0formal@_module._default.Elements_Property$_T0@0 |L#1_0@0|) (|_module.__default.Length#canCall| call0formal@_module._default.Elements_Property$_T0@0 |L#1_0@0|)) (and (= (|Set#Card| (_module.__default.Elements call0formal@_module._default.Elements_Property$_T0@0 ($LS ($LS $LZ)) |L#1_0@0|)) (_module.__default.Length call0formal@_module._default.Elements_Property$_T0@0 ($LS ($LS $LZ)) |L#1_0@0|)) (= $Heap@0 $Heap@1))) (and (and ($IsAlloc intType (int_2_U |n#0|) Tclass._System.nat $Heap@1) ($Is intType (int_2_U |half#1_0@0|) Tclass._System.nat)) (and ($IsAlloc intType (int_2_U |half#1_0@0|) Tclass._System.nat $Heap@1) (|_module.__default.IntRange#canCall| |n#0| |half#1_0@0|)))) (and (and (and (|_module.__default.IntRange#canCall| |n#0| |half#1_0@0|) (= |bound#1_0@0| (_module.__default.IntRange ($LS $LZ) reveal__module._default.IntRange |n#0| |half#1_0@0|))) (and ($IsAlloc DatatypeTypeType |L#1_0@0| (Tclass._module.List Tclass._System.nat) $Heap@1) (|_module.__default.Elements#canCall| Tclass._System.nat |L#1_0@0|))) (and (and (|_module.__default.Elements#canCall| Tclass._System.nat |L#1_0@0|) (= |A##1_0@0| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |L#1_0@0|))) (and (= call0formal@_module._default.Cardinality$_T0@0 Tclass._System.nat) (|Set#Subset| |A##1_0@0| |bound#1_0@0|))))) (and (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (<= (|Set#Card| |A##1_0@0|) (|Set#Card| |bound#1_0@0|))) (and (= $Heap@1 $Heap@2) (< |llen#1_0@0| |half#1_0@0|))) (and (and (and ($Is intType (int_2_U |llen#1_0@0|) Tclass._System.nat) (or (<= 0 |len#0@@4|) (= |llen#1_0@0| |len#0@@4|))) (and (< |llen#1_0@0| |len#0@@4|) (=> (|_module.__default.NoDuplicates#canCall| Tclass._System.nat |L#1_0@0|) (or (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |L#1_0@0|) (=> (_module.List.Nil_q |L#1_0@0|) (U_2_bool (Lit boolType (bool_2_U true)))))))) (and (and (=> (|_module.__default.NoDuplicates#canCall| Tclass._System.nat |L#1_0@0|) (or (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |L#1_0@0|) (=> (not (_module.List.Nil_q |L#1_0@0|)) (let ((|tail#0@@7| (_module.List.tail |L#1_0@0|)))
...
(_module.__default.NoDuplicates Tclass._System.nat ($LS ($LS $LZ)) |tail#0@@8|)))))) (and (forall ((|x#1@@1| T@U) ) (!  (=> (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS ($LS $LZ)) |L#1_0@0|) ($Box intType |x#1@@1|)) (<= |n#0| (U_2_int |x#1@@1|)))
 :qid |SmallestMissingNumberfunctionaldfy.274:19|
 :skolemid |739|
 :pattern ( (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS ($LS $LZ)) |L#1_0@0|) ($Box intType |x#1@@1|)))
)) (= (ControlFlow 0 2) (- 0 1)))))))) (= |llen#1_0@0| (_module.__default.Length Tclass._System.nat ($LS ($LS $LZ)) |L#1_0@0|)))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
