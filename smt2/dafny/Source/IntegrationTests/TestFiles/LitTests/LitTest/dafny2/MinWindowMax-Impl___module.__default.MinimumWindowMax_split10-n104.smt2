...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split105)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon87_correct  (=> (and (= |lo##1_0@1| (+ (- |n#0@3| |W#0|) 1)) (or (not (= $nw@0 null)) (not true))) (=> (and (and (<= 0 |k#0@2|) (< |k#0@2| (_System.array.Length $nw@0))) (= |x##1_0@1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $nw@0) (IndexField |k#0@2|)))))) (=> (and (and (and (= |hi##1_0@1| (+ |n#0@3| 1)) (<= (LitInt 0) |lo##1_0@1|)) (and (<= |lo##1_0@1| |x##1_0@1|) (< |x##1_0@1| |hi##1_0@1|))) (and (and (<= |hi##1_0@1| (_System.array.Length |a#0@@4|)) (= (ControlFlow 0 2) (- 0 1))) (|_module.__default.RightmostMax#canCall| $Heap@6 |a#0@@4| |lo##1_0@1| |x##1_0@1| |hi##1_0@1|))) (or (_module.__default.RightmostMax $Heap@6 |a#0@@4| |lo##1_0@1| |x##1_0@1| |hi##1_0@1|) (forall ((|i#0@@1| Int) ) (!  (=> (and (<= |lo##1_0@1| |i#0@@1|) (< |i#0@@1| |x##1_0@1|)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |a#0@@4|) (IndexField |i#0@@1|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |a#0@@4|) (IndexField |x##1_0@1|))))))
 :qid |MinWindowMaxdfy.127:11|
 :skolemid |760|
...
(let ((anon134_Else_correct  (=> (not (and (< |k#0@0| (- |$rhs#1_1@1| 1)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $nw@0) (IndexField |k#0@0|)))) (- |n#0@3| |W#0|)))) (=> (and (= |k#0@2| |k#0@0|) (= (ControlFlow 0 4) 2)) anon87_correct))))
(let ((anon134_Then_correct  (=> (and (and (and (< |k#0@0| (- |$rhs#1_1@1| 1)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $nw@0) (IndexField |k#0@0|)))) (- |n#0@3| |W#0|))) (= |k#0@1| (+ |k#0@0| 1))) (and (= |k#0@2| |k#0@1|) (= (ControlFlow 0 3) 2))) anon87_correct)))
(let ((anon84_correct  (and (=> (= (ControlFlow 0 5) 3) anon134_Then_correct) (=> (= (ControlFlow 0 5) 4) anon134_Else_correct))))
(let ((anon133_Else_correct  (=> (and (<= (- |$rhs#1_1@1| 1) |k#0@0|) (= (ControlFlow 0 7) 5)) anon84_correct)))
(let ((anon133_Then_correct  (=> (and (< |k#0@0| (- |$rhs#1_1@1| 1)) (or (not (= $nw@0 null)) (not true))) (=> (and (and (<= 0 |k#0@0|) (< |k#0@0| (_System.array.Length $nw@0))) (= (ControlFlow 0 6) 5)) anon84_correct))))
(let ((anon79_correct  (=> (and (not (and (<= |k#0@0| (- |l#0@4| 1)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1))))))))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField |n#0@3|))))))) (or (not (= $nw@0 null)) (not true))) (=> (and (and (and (<= 0 |l#0@4|) (< |l#0@4| (_System.array.Length $nw@0))) (= $index0@3 (IndexField |l#0@4|))) (and (and (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 $index0@3)) (= |$rhs#1_1@1| (+ |l#0@4| 1))) (and (= $Heap@6 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) $index0@3 ($Box intType (int_2_U |n#0@3|))))) ($IsGoodHeap $Heap@6)))) (and (=> (= (ControlFlow 0 8) 6) anon133_Then_correct) (=> (= (ControlFlow 0 8) 7) anon133_Else_correct))))))
(let ((anon131_Else_correct  (=> (and (< (- |l#0@4| 1) |k#0@0|) (= (ControlFlow 0 10) 8)) anon79_correct)))
(let ((anon131_Then_correct  (=> (<= |k#0@0| (- |l#0@4| 1)) (=> (and (and (or (not (= |a#0@@4| null)) (not true)) (or (not (= $nw@0 null)) (not true))) (and (<= 0 (- |l#0@4| 1)) (< (- |l#0@4| 1) (_System.array.Length $nw@0)))) (=> (and (and (and (<= 0 (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1)))))) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1))))) (_System.array.Length |a#0@@4|))) (or (not (= |a#0@@4| null)) (not true))) (and (and (<= 0 |n#0@3|) (< |n#0@3| (_System.array.Length |a#0@@4|))) (= (ControlFlow 0 9) 8))) anon79_correct)))))
