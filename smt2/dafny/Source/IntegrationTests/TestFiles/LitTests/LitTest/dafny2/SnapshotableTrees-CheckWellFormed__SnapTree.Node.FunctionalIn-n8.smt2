...
(declare-fun $LZ () T@U)
(declare-fun |r#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$SnapTree.Node.FunctionalInsert__Left)
...
(let ((anon13_Else_correct  (=> (< |pos#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 14) 8) anon14_Then_correct) (=> (= (ControlFlow 0 14) 11) anon14_Else_correct)))))
(let ((anon13_Then_correct  (=> (<= (LitInt 0) |pos#0@0|) (and (=> (= (ControlFlow 0 12) (- 0 13)) (or (not (= |r#0@0| null)) (not true))) (=> (or (not (= |r#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 12) 8) anon14_Then_correct) (=> (= (ControlFlow 0 12) 11) anon14_Else_correct)))))))
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (and (=> (= (ControlFlow 0 15) 12) anon13_Then_correct) (=> (= (ControlFlow 0 15) 14) anon13_Else_correct)))))))
(let ((anon12_Else_correct true))
(let ((anon11_Else_correct  (=> (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))) (and (= |r#0@0| |n#0|) (< |pos#0@0| 0))) (and (=> (= (ControlFlow 0 19) 15) anon12_Then_correct) (=> (= (ControlFlow 0 19) 1) anon12_Else_correct)))))
(let ((anon11_Then_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))) (=> (and (= |r#0@0| |n#0|) (< |pos#0@0| 0)) (and (=> (= (ControlFlow 0 17) 15) anon12_Then_correct) (=> (= (ControlFlow 0 17) 1) anon12_Else_correct))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@5 alloc false)) (and (=> (= (ControlFlow 0 20) (- 0 26)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |n#0|) Tclass.SnapTree.Node? $Heap@@5) (=> (and (|SnapTree.Node.NodeValid#canCall| $Heap@@5 |n#0|) (SnapTree.Node.NodeValid ($LS $LZ) reveal_SnapTree.Node.NodeValid $Heap@@5 |n#0|)) (and (=> (= (ControlFlow 0 20) (- 0 25)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (=> (< |x#0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |n#0|) SnapTree.Node.data)))) (and (=> (= (ControlFlow 0 20) (- 0 24)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (forall (($o@@17 T@U) ) (!  (=> (and (or (not (= $o@@17 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@17) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@17) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@17)))
 :qid |SnapshotableTreesdfy.363:19|
 :skolemid |929|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@17))
)) ($HeapSucc $Heap@@5 $Heap@0)) (and ($Is refType |r#0@0| Tclass.SnapTree.Node) ($IsAlloc refType |r#0@0| Tclass.SnapTree.Node $Heap@0))) (and (=> (= (ControlFlow 0 20) (- 0 23)) (or (not (= |r#0@0| null)) (not true))) (=> (or (not (= |r#0@0| null)) (not true)) (=> ($IsAllocBox ($Box refType |r#0@0|) Tclass.SnapTree.Node? $Heap@0) (=> (and (|SnapTree.Node.NodeValid#canCall| $Heap@0 |r#0@0|) (SnapTree.Node.NodeValid ($LS $LZ) reveal_SnapTree.Node.NodeValid $Heap@0 |r#0@0|)) (and (=> (= (ControlFlow 0 20) (- 0 22)) (or (not (= |r#0@0| null)) (not true))) (=> (or (not (= |r#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (=> (and (forall (($o@@18 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@18)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0|) SnapTree.Node.Repr)) ($Box refType $o@@18)))) (or (not (= $o@@18 null)) (not true)))
 :qid |SnapshotableTreesdfy.366:15|
 :skolemid |930|
 :pattern (  (or (not (= $o@@18 null)) (not true)))
)) (forall (($o@@19 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@19)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0|) SnapTree.Node.Repr)) ($Box refType $o@@19)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@19) alloc)))))
 :qid |SnapshotableTreesdfy.366:15|
 :skolemid |931|
...
))) (and (=> (= (ControlFlow 0 20) 17) anon11_Then_correct) (=> (= (ControlFlow 0 20) 19) anon11_Else_correct)))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@5) ($IsHeapAnchor $Heap@@5)) (and ($Is refType |n#0| Tclass.SnapTree.Node) ($IsAlloc refType |n#0| Tclass.SnapTree.Node $Heap@@5))) (and (and ($Is refType |r#0| Tclass.SnapTree.Node) ($IsAlloc refType |r#0| Tclass.SnapTree.Node $Heap@@5)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 27) 20)))) anon0_correct)))
