...
(set-info :boogie-vc-id CheckWellFormed$$SnapTree.Tree.Insert)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon9_correct  (=> (and (and (<= (LitInt 0) |pos#0@0|) (< |pos#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) SnapTree.Tree.Contents))))) (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) SnapTree.Tree.Contents))) (+ (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@6) SnapTree.Tree.Contents))) 1))) (and (=> (= (ControlFlow 0 3) (- 0 6)) ($IsAlloc refType this@@6 Tclass.SnapTree.Tree $Heap@@7)) (=> ($IsAlloc refType this@@6 Tclass.SnapTree.Tree $Heap@@7) (and (=> (= (ControlFlow 0 3) (- 0 5)) (and (<= 0 |pos#0@0|) (<= |pos#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@6) SnapTree.Tree.Contents)))))) (=> (and (<= 0 |pos#0@0|) (<= |pos#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@6) SnapTree.Tree.Contents))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) ($IsAlloc refType this@@6 Tclass.SnapTree.Tree $Heap@@7)) (=> ($IsAlloc refType this@@6 Tclass.SnapTree.Tree $Heap@@7) (=> (= (ControlFlow 0 3) (- 0 2)) (and (<= 0 |pos#0@0|) (<= |pos#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@6) SnapTree.Tree.Contents)))))))))))))))
(let ((anon14_Else_correct  (=> (and (not (and (<= (LitInt 0) |pos#0@0|) (< |pos#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) SnapTree.Tree.Contents)))))) (= (ControlFlow 0 9) 3)) anon9_correct)))
(let ((anon14_Then_correct  (=> (and (<= (LitInt 0) |pos#0@0|) (< |pos#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) SnapTree.Tree.Contents))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) ($IsAlloc refType this@@6 Tclass.SnapTree.Tree $Heap@@7)) (=> ($IsAlloc refType this@@6 Tclass.SnapTree.Tree $Heap@@7) (=> (= (ControlFlow 0 7) 3) anon9_correct))))))
...
))) (and (=> (= (ControlFlow 0 18) (- 0 20)) ($IsAlloc refType this@@6 Tclass.SnapTree.Tree $Heap@@7)) (=> ($IsAlloc refType this@@6 Tclass.SnapTree.Tree $Heap@@7) (=> (and (forall (($o@@35 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) SnapTree.Tree.MutableRepr)) ($Box refType $o@@35)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@6) SnapTree.Tree.MutableRepr)) ($Box refType $o@@35)))) (or (not (= $o@@35 null)) (not true)))
 :qid |SnapshotableTreesdfy.191:53|
 :skolemid |764|
 :pattern (  (or (not (= $o@@35 null)) (not true)))
)) (forall (($o@@36 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) SnapTree.Tree.MutableRepr)) ($Box refType $o@@36)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@6) SnapTree.Tree.MutableRepr)) ($Box refType $o@@36)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@36) alloc)))))
 :qid |SnapshotableTreesdfy.191:53|
 :skolemid |765|
...
))) (and (=> (= (ControlFlow 0 18) (- 0 19)) ($IsAlloc refType this@@6 Tclass.SnapTree.Tree $Heap@@7)) (=> ($IsAlloc refType this@@6 Tclass.SnapTree.Tree $Heap@@7) (=> (= (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) SnapTree.Tree.IsReadonly))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@6) SnapTree.Tree.IsReadonly)))) (and (=> (= (ControlFlow 0 18) 14) anon11_Then_correct) (=> (= (ControlFlow 0 18) 17) anon11_Else_correct))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@7) ($IsHeapAnchor $Heap@@7)) (=> (and (and (or (not (= this@@6 null)) (not true)) (and ($Is refType this@@6 Tclass.SnapTree.Tree) ($IsAlloc refType this@@6 Tclass.SnapTree.Tree $Heap@@7))) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 22) 18))) anon0_correct))))
