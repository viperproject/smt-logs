...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.lemma__extensionality)
...
(let ((anon5_Else_correct  (=> (and (=> (< |i#0@0| (_module.__default.length _module._default.lemma_extensionality$_T0 ($LS $LZ) |xs#0@@5|)) (= (_module.__default.ith _module._default.lemma_extensionality$_T0 ($LS $LZ) |xs#0@@5| |i#0@0|) (_module.__default.ith _module._default.lemma_extensionality$_T0 ($LS $LZ) |ys#0| |i#0@0|))) (= (ControlFlow 0 5) 1)) anon4_correct)))
(let ((anon5_Then_correct  (=> ($IsAlloc DatatypeTypeType |xs#0@@5| (Tclass._module.List _module._default.lemma_extensionality$_T0) $Heap@@0) (=> (and (and (|_module.__default.length#canCall| _module._default.lemma_extensionality$_T0 |xs#0@@5|) (< |i#0@0| (_module.__default.length _module._default.lemma_extensionality$_T0 ($LS $LZ) |xs#0@@5|))) (and ($IsAlloc DatatypeTypeType |xs#0@@5| (Tclass._module.List _module._default.lemma_extensionality$_T0) $Heap@@0) ($IsAlloc intType (int_2_U |i#0@0|) Tclass._System.nat $Heap@@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (< |i#0@0| (_module.__default.length _module._default.lemma_extensionality$_T0 ($LS ($LS $LZ)) |xs#0@@5|))) (=> (and (and (< |i#0@0| (_module.__default.length _module._default.lemma_extensionality$_T0 ($LS $LZ) |xs#0@@5|)) (|_module.__default.ith#canCall| _module._default.lemma_extensionality$_T0 |xs#0@@5| |i#0@0|)) (and ($IsAlloc DatatypeTypeType |ys#0| (Tclass._module.List _module._default.lemma_extensionality$_T0) $Heap@@0) ($IsAlloc intType (int_2_U |i#0@0|) Tclass._System.nat $Heap@@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< |i#0@0| (_module.__default.length _module._default.lemma_extensionality$_T0 ($LS ($LS $LZ)) |ys#0|))) (=> (and (and (< |i#0@0| (_module.__default.length _module._default.lemma_extensionality$_T0 ($LS $LZ) |ys#0|)) (|_module.__default.ith#canCall| _module._default.lemma_extensionality$_T0 |ys#0| |i#0@0|)) (and (= (_module.__default.ith _module._default.lemma_extensionality$_T0 ($LS $LZ) |xs#0@@5| |i#0@0|) (_module.__default.ith _module._default.lemma_extensionality$_T0 ($LS $LZ) |ys#0| |i#0@0|)) (= (ControlFlow 0 2) 1))) anon4_correct))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and ($IsAlloc DatatypeTypeType |xs#0@@5| (Tclass._module.List _module._default.lemma_extensionality$_T0) $Heap@@0) (|_module.__default.length#canCall| _module._default.lemma_extensionality$_T0 |xs#0@@5|)) (=> (and (and ($IsAlloc DatatypeTypeType |ys#0| (Tclass._module.List _module._default.lemma_extensionality$_T0) $Heap@@0) (|_module.__default.length#canCall| _module._default.lemma_extensionality$_T0 |ys#0|)) (and (= (_module.__default.length _module._default.lemma_extensionality$_T0 ($LS $LZ) |xs#0@@5|) (_module.__default.length _module._default.lemma_extensionality$_T0 ($LS $LZ) |ys#0|)) (<= (LitInt 0) |i#0@0|))) (and (=> (= (ControlFlow 0 6) 2) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is DatatypeTypeType |xs#0@@5| (Tclass._module.List _module._default.lemma_extensionality$_T0)) ($IsAlloc DatatypeTypeType |xs#0@@5| (Tclass._module.List _module._default.lemma_extensionality$_T0) $Heap@@0)) (|$IsA#_module.List| |xs#0@@5|)) (=> (and (and (and ($Is DatatypeTypeType |ys#0| (Tclass._module.List _module._default.lemma_extensionality$_T0)) ($IsAlloc DatatypeTypeType |ys#0| (Tclass._module.List _module._default.lemma_extensionality$_T0) $Heap@@0)) (|$IsA#_module.List| |ys#0|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct)))))
