...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split157)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon65_correct  (=> (and (and (and (<= |k#0@0| |l#0@4|) (<= |l#0@4| |n#0@3|)) (< |k#0@0| |l#0@4|)) (and (or (not (= $nw@0 null)) (not true)) (= (ControlFlow 0 2) (- 0 1)))) (and (<= 0 (- |l#0@4| 1)) (< (- |l#0@4| 1) (_System.array.Length $nw@0))))))
(let ((anon125_Else_correct  (=> (and (< |l#0@4| |k#0@0|) (= (ControlFlow 0 4) 2)) anon65_correct)))
(let ((anon125_Then_correct  (=> (and (<= |k#0@0| |l#0@4|) (= (ControlFlow 0 3) 2)) anon65_correct)))
