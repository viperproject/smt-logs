...
(assert (distinct TInt TagInt TagSet TagSeq alloc allocName Tagclass._System.object? Tagclass._System.object |##SnapTree.List.Nil| Tagclass.SnapTree.List |##SnapTree.List.Cons| Tagclass.SnapTree.Node Tagclass.SnapTree.Node? class.SnapTree.Node? tytagFamily$object tytagFamily$List tytagFamily$Node field$Repr)
)
(assert (= (FDim alloc) 0))
...
(assert (forall (($h@@5 T@U) ($o@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (or (not (= $o@@2 null)) (not true)) (= (dtype $o@@2) Tclass.SnapTree.Node?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@2) SnapTree.Node.Repr)) (TSet Tclass._System.object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |816|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@2) SnapTree.Node.Repr)))
)))
(assert (forall (($h@@6 T@U) ($o@@3 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@6) (and (or (not (= $o@@3 null)) (not true)) (= (dtype $o@@3) Tclass.SnapTree.Node?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@3) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@3) SnapTree.Node.Repr)) (TSet Tclass._System.object) $h@@6))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |817|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@3) SnapTree.Node.Repr)))
)))
...
(assert (forall ((d@@5 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (SnapTree.List.Cons_q d@@5) ($IsAlloc DatatypeTypeType d@@5 Tclass.SnapTree.List $h@@7))) ($IsAlloc refType (SnapTree.List._h0 d@@5) Tclass.SnapTree.Node $h@@7))
 :qid |unknown.0:0|
 :skolemid |649|
 :pattern ( ($IsAlloc refType (SnapTree.List._h0 d@@5) Tclass.SnapTree.Node $h@@7))
)))
(assert (forall ((d@@6 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (SnapTree.List.Cons_q d@@6) ($IsAlloc DatatypeTypeType d@@6 Tclass.SnapTree.List $h@@8))) ($IsAlloc DatatypeTypeType (SnapTree.List._h1 d@@6) Tclass.SnapTree.List $h@@8))
 :qid |unknown.0:0|
 :skolemid |650|
 :pattern ( ($IsAlloc DatatypeTypeType (SnapTree.List._h1 d@@6) Tclass.SnapTree.List $h@@8))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$SnapTree.Iterator.Push_split1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and (and ($Is DatatypeTypeType |stIn#0| Tclass.SnapTree.List) ($IsAlloc DatatypeTypeType |stIn#0| Tclass.SnapTree.List $Heap)) (|$IsA#SnapTree.List| |stIn#0|)) (and ($Is refType |p#0| Tclass.SnapTree.Node) ($IsAlloc refType |p#0| Tclass.SnapTree.Node $Heap))) (and (and ($Is SeqType |C#0| (TSeq TInt)) ($IsAlloc SeqType |C#0| (TSeq TInt) $Heap)) (and ($Is SetType |Nodes#0| (TSet Tclass._System.object)) ($IsAlloc SetType |Nodes#0| (TSet Tclass._System.object) $Heap)))) (and (and (and ($Is DatatypeTypeType |st#0| Tclass.SnapTree.List) ($IsAlloc DatatypeTypeType |st#0| Tclass.SnapTree.List $Heap)) (and (= 5 $FunctionContextHeight) (= $_ModifiesFrame@0 (|lambda#1| null $Heap alloc false)))) (and (and (|Set#IsMember| |Nodes#0| ($Box refType |p#0|)) (or (not (= |p#0| null)) (not true))) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |p#0|) SnapTree.Node.Repr)) |Nodes#0|) (= (ControlFlow 0 2) (- 0 1)))))) (or (not (= |p#0| null)) (not true))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
