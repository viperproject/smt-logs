...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split10)
...
))))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|) (|_module.__default.StrictlyIncreasing#canCall| $Heap@1 $nw@0 |$rhs#1@0| |$rhs#2@0| (LitInt 0) |n#0@0|)))) (or (_module.__default.StrictlyIncreasing $Heap@1 $nw@0 |$rhs#1@0| |$rhs#2@0| (LitInt 0) |n#0@0|) (forall ((|i#1@@0| Int) (|j#0@@0| Int) ) (!  (=> (and (and (<= |$rhs#1@0| |i#1@@0|) (< |i#1@@0| |j#0@@0|)) (< |j#0@@0| |$rhs#2@0|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |i#1@@0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |j#0@@0|))))))
 :qid |MinWindowMaxdfy.147:11|
 :skolemid |668|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |j#0@@0|))) ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |i#1@@0|))))
))))))))
anon0_correct))
))
(check-sat)
