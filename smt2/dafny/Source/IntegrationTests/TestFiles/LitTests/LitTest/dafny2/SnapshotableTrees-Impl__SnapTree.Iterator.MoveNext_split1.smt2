...
(set-info :boogie-vc-id Impl$$SnapTree.Iterator.MoveNext_split1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and (and ($IsGoodHeap $Heap@@11) ($IsHeapAnchor $Heap@@11)) (and (or (not (= this@@6 null)) (not true)) (and ($Is refType this@@6 Tclass.SnapTree.Iterator) ($IsAlloc refType this@@6 Tclass.SnapTree.Iterator $Heap@@11)))) (=> (and (and (and (and (= 6 $FunctionContextHeight) (SnapTree.Iterator.Valid reveal_SnapTree.Iterator.Valid $Heap@@11 this@@6)) (and (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@6) SnapTree.Iterator.N))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@6) SnapTree.Iterator.Contents)))) (= $_ModifiesFrame@0 (|lambda#9| null $Heap@@11 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@6) SnapTree.Iterator.IterRepr)))))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@11 $Heap@0))) (and (and (and reveal_SnapTree.Iterator.Valid (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) SnapTree.Iterator.initialized)))) (and (or (not (= ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) SnapTree.Iterator.stack)) |#SnapTree.List.Nil|)) (not true)) (= ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) SnapTree.Iterator.stack)) (|#SnapTree.List.Cons| |_mcc#0#1_0_0@0| |_mcc#1#1_0_0@0|)))) (and (and ($Is refType |_mcc#0#1_0_0@0| Tclass.SnapTree.Node) ($IsAlloc refType |_mcc#0#1_0_0@0| Tclass.SnapTree.Node $Heap@0)) (and ($Is DatatypeTypeType |_mcc#1#1_0_0@0| Tclass.SnapTree.List) ($IsAlloc DatatypeTypeType |_mcc#1#1_0_0@0| Tclass.SnapTree.List $Heap@0))))) (=> (and (and (and (and (and ($Is DatatypeTypeType |rest#1_0_0@0| Tclass.SnapTree.List) ($IsAlloc DatatypeTypeType |rest#1_0_0@0| Tclass.SnapTree.List $Heap@0)) (= |let#1_0_0#0#0| |_mcc#1#1_0_0@0|)) (and ($Is DatatypeTypeType |let#1_0_0#0#0| Tclass.SnapTree.List) (= |rest#1_0_0@0| |let#1_0_0#0#0|))) (and (and ($Is refType |p#1_0_0@0| Tclass.SnapTree.Node) ($IsAlloc refType |p#1_0_0@0| Tclass.SnapTree.Node $Heap@0)) (= |let#1_0_1#0#0| |_mcc#0#1_0_0@0|))) (and (and (and ($Is refType |let#1_0_1#0#0| Tclass.SnapTree.Node) (= |p#1_0_0@0| |let#1_0_1#0#0|)) (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3))) (and (and (= $Heap@0 $Heap@3) reveal_SnapTree.Node.NodeValid) (and (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@6 SnapTree.Iterator.stack)) (= (ControlFlow 0 2) (- 0 1)))))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@6 SnapTree.Iterator.N)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
