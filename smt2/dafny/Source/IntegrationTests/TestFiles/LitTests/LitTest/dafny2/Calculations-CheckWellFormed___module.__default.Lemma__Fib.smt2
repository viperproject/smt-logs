...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Lemma__Fib)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) ($Is intType (int_2_U (LitInt 5)) Tclass._System.nat)))))
