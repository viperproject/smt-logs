...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split118)
...
))) (and ($IsGoodHeap $Heap@8) ($IsHeapAnchor $Heap@8))) (and (and (<= (- |$rhs#1_1@1| |k#0@2|) |W#0|) (= $Heap@7 $Heap@8)) (and (or (<= 0 |$decr$loop#10@1|) (= (- (_System.array.Length |a#0@@4|) |n#0@4|) |$decr$loop#10@1|)) (= (ControlFlow 0 2) (- 0 1))))) (< (- (_System.array.Length |a#0@@4|) |n#0@4|) |$decr$loop#10@1|))))))
