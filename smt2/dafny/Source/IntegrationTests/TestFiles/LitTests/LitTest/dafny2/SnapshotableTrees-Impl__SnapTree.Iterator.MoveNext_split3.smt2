...
(set-info :boogie-vc-id Impl$$SnapTree.Iterator.MoveNext_split3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon10_correct  (=> (and (and (and ($IsGoodHeap $Heap@13) ($IsHeapAnchor $Heap@13)) (= $Heap@12 $Heap@13)) (and (and reveal_SnapTree.Iterator.R (= |hasCurrent#0@5| |hasCurrent#0@4|)) (and (= $Heap@14 $Heap@13) (= (ControlFlow 0 2) (- 0 1))))) (SnapTree.Iterator.Valid reveal_SnapTree.Iterator.Valid $Heap@14 this@@9))))
