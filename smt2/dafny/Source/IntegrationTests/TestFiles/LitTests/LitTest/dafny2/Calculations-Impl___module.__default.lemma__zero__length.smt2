...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.length$_T0@@0 T@U) ($ly@@0 T@U) (|l#0@@0| T@U) ) (!  (=> (or (|_module.__default.length#canCall| _module._default.length$_T0@@0 |l#0@@0|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |l#0@@0| (Tclass._module.List _module._default.length$_T0@@0)))) (and (=> (not (_module.List.Nil_q |l#0@@0|)) (let ((|xs#1| (_module.List._h1 |l#0@@0|)))
(|_module.__default.length#canCall| _module._default.length$_T0@@0 |xs#1|))) (= (_module.__default.length _module._default.length$_T0@@0 ($LS $ly@@0) |l#0@@0|) (ite (_module.List.Nil_q |l#0@@0|) 0 (let ((|xs#0| (_module.List._h1 |l#0@@0|)))
(+ 1 (_module.__default.length _module._default.length$_T0@@0 $ly@@0 |xs#0|)))))))
 :qid |unknown.0:0|
 :skolemid |535|
 :pattern ( (_module.__default.length _module._default.length$_T0@@0 ($LS $ly@@0) |l#0@@0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.length$_T0@@1 T@U) ($ly@@1 T@U) (|l#0@@2| T@U) ) (!  (=> (or (|_module.__default.length#canCall| _module._default.length$_T0@@1 |l#0@@2|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |l#0@@2| (Tclass._module.List _module._default.length$_T0@@1)))) (<= (LitInt 0) (_module.__default.length _module._default.length$_T0@@1 $ly@@1 |l#0@@2|)))
 :qid |unknown.0:0|
 :skolemid |533|
 :pattern ( (_module.__default.length _module._default.length$_T0@@1 $ly@@1 |l#0@@2|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.length$_T0@@2 T@U) ($ly@@2 T@U) (|l#0@@3| T@U) ) (!  (=> (or (|_module.__default.length#canCall| _module._default.length$_T0@@2 (Lit DatatypeTypeType |l#0@@3|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |l#0@@3| (Tclass._module.List _module._default.length$_T0@@2)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |l#0@@3|)))))) (let ((|xs#3| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |l#0@@3|)))))
(|_module.__default.length#canCall| _module._default.length$_T0@@2 |xs#3|))) (= (_module.__default.length _module._default.length$_T0@@2 ($LS $ly@@2) (Lit DatatypeTypeType |l#0@@3|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |l#0@@3|)) 0 (let ((|xs#2| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |l#0@@3|)))))
(LitInt (+ 1 (_module.__default.length _module._default.length$_T0@@2 ($LS $ly@@2) |xs#2|))))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |536|
 :pattern ( (_module.__default.length _module._default.length$_T0@@2 ($LS $ly@@2) (Lit DatatypeTypeType |l#0@@3|)))
))))
...
(declare-fun _module._default.lemma_zero_length$_T0 () T@U)
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.lemma__zero__length)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.List| |xs#0@@0|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (forall ((|$ih#xs0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#xs0#0| (Tclass._module.List _module._default.lemma_zero_length$_T0)) (U_2_bool (Lit boolType (bool_2_U true)))) (< (DtRank |$ih#xs0#0|) (DtRank |xs#0@@0|))) (= (= (_module.__default.length _module._default.lemma_zero_length$_T0 ($LS $LZ) |$ih#xs0#0|) (LitInt 0)) (_module.List.Nil_q |$ih#xs0#0|)))
 :qid |Calculationsdfy.232:25|
 :skolemid |616|
 :pattern ( (_module.List.Nil_q |$ih#xs0#0|))
 :pattern ( (_module.__default.length _module._default.lemma_zero_length$_T0 ($LS $LZ) |$ih#xs0#0|))
)) (= (ControlFlow 0 2) (- 0 1)))) (= (= (_module.__default.length _module._default.lemma_zero_length$_T0 ($LS ($LS $LZ)) |xs#0@@0|) (LitInt 0)) (_module.List.Nil_q |xs#0@@0|))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |xs#0@@0| (Tclass._module.List _module._default.lemma_zero_length$_T0)) ($IsAlloc DatatypeTypeType |xs#0@@0| (Tclass._module.List _module._default.lemma_zero_length$_T0) $Heap)) (|$IsA#_module.List| |xs#0@@0|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
