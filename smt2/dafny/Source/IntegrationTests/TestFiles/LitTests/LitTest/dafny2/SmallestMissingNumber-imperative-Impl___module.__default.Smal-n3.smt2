...
)) (forall ((|n#0_2@@0| Int) )  (=> (and (and (<= (LitInt 0) |n#0_2@@0|) (< |n#0_2@@0| |N#0@0|)) (< (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0@@1|) (IndexField |n#0_2@@0|)))) |N#0@0|)) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@0) (IndexField (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0@@1|) (IndexField |n#0_2@@0|)))))) ($Box boolType (Lit boolType (bool_2_U true)))))))) (and (=> (= (ControlFlow 0 36) (- 0 40)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (and (= |s#0@0| (LitInt 0)) (= |$decr_init$loop#00@0| (- |N#0@0| |s#0@0|))) (and (=> (= (ControlFlow 0 36) (- 0 39)) (=> |$w$loop#0@0| (<= (LitInt 0) |s#0@0|))) (=> (=> |$w$loop#0@0| (<= (LitInt 0) |s#0@0|)) (and (=> (= (ControlFlow 0 36) (- 0 38)) (=> |$w$loop#0@0| (<= |s#0@0| |N#0@0|))) (=> (=> |$w$loop#0@0| (<= |s#0@0| |N#0@0|)) (and (=> (= (ControlFlow 0 36) (- 0 37)) (=> |$w$loop#0@0| (forall ((|j#1@@3| Int) ) (!  (=> (and (<= (LitInt 0) |j#1@@3|) (< |j#1@@3| |s#0@0|)) (_module.__default.Has Tclass._System.nat $Heap@1 |a#0@@1| ($Box intType (int_2_U |j#1@@3|))))
