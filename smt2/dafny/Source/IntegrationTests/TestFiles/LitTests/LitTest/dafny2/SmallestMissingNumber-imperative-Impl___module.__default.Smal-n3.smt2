...
(declare-fun |s#0| () Int)
(declare-fun |e#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.SmallestMissing)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 64) (let ((anon3_correct true))
(let ((anon30_Else_correct  (=> (and (< |_v0#0@0| (LitInt 0)) (= (ControlFlow 0 59) 57)) anon3_correct)))
(let ((anon30_Then_correct  (=> (<= (LitInt 0) |_v0#0@0|) (=> (and (and (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (= |lambdaResult#0| (U_2_bool (Lit boolType (bool_2_U false))))) (and ($Is boolType (bool_2_U |lambdaResult#0|) TBool) (= (ControlFlow 0 58) 57))) anon3_correct))))
(let ((anon29_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@0 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@0 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 60) 58) anon30_Then_correct) (=> (= (ControlFlow 0 60) 59) anon30_Else_correct)))))
(let ((anon9_correct  (=> (and (and (<= (LitInt 0) |n#0_0@0|) (< |n#0_0@0| |N#0@0|)) (< (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0@@1|) (IndexField |n#0_0@0|)))) |N#0@0|)) (and (=> (= (ControlFlow 0 42) (- 0 47)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 42) (- 0 46)) (or (not (= |a#0@@1| null)) (not true))) (=> (or (not (= |a#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 42) (- 0 45)) (and (<= 0 |n#0_0@0|) (< |n#0_0@0| (_System.array.Length |a#0@@1|)))) (and (=> (= (ControlFlow 0 42) (- 0 44)) (and (<= 0 (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0@@1|) (IndexField |n#0_0@0|))))) (< (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0@@1|) (IndexField |n#0_0@0|)))) (_System.array.Length $nw@0)))) (and (=> (= (ControlFlow 0 42) (- 0 43)) (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0@@1|) (IndexField |n#0_0@0|)))))))) (=> (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0@@1|) (IndexField |n#0_0@0|))))))) (=> (and (and (and (<= (LitInt 0) |n#0_1@0|) (< |n#0_1@0| |N#0@0|)) (< (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0@@1|) (IndexField |n#0_1@0|)))) |N#0@0|)) (and (or (not (= |n#0_0@0| |n#0_1@0|)) (not true)) (= (ControlFlow 0 42) (- 0 41)))) (or (or (or (not (= $nw@0 $nw@0)) (not true)) (or (not (= (IndexField (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0@@1|) (IndexField |n#0_0@0|))))) (IndexField (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0@@1|) (IndexField |n#0_1@0|))))))) (not true))) (= (U_2_bool (Lit boolType (bool_2_U true))) (U_2_bool (Lit boolType (bool_2_U true)))))))))))))))))
(let ((anon33_Else_correct  (=> (and (not (and (<= (LitInt 0) |n#0_0@0|) (< |n#0_0@0| |N#0@0|))) (= (ControlFlow 0 51) 42)) anon9_correct)))
(let ((anon33_Then_correct  (=> (and (<= (LitInt 0) |n#0_0@0|) (< |n#0_0@0| |N#0@0|)) (and (=> (= (ControlFlow 0 48) (- 0 50)) (or (not (= |a#0@@1| null)) (not true))) (=> (or (not (= |a#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 48) (- 0 49)) (and (<= 0 |n#0_0@0|) (< |n#0_0@0| (_System.array.Length |a#0@@1|)))) (=> (= (ControlFlow 0 48) 42) anon9_correct)))))))
(let ((anon32_Else_correct  (=> (< |n#0_0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 53) 48) anon33_Then_correct) (=> (= (ControlFlow 0 53) 51) anon33_Else_correct)))))
(let ((anon32_Then_correct  (=> (<= (LitInt 0) |n#0_0@0|) (and (=> (= (ControlFlow 0 52) 48) anon33_Then_correct) (=> (= (ControlFlow 0 52) 51) anon33_Else_correct)))))
(let ((anon31_Then_correct  (and (=> (= (ControlFlow 0 54) 52) anon32_Then_correct) (=> (= (ControlFlow 0 54) 53) anon32_Else_correct))))
(let ((anon20_correct true))
(let ((anon39_Else_correct  (=> (and (not (and (<= (LitInt 0) |j#0@0|) (< |j#0@0| |s#0@1|))) (= (ControlFlow 0 26) 23)) anon20_correct)))
(let ((anon39_Then_correct  (=> (and (and (<= (LitInt 0) |j#0@0|) (< |j#0@0| |s#0@1|)) ($IsAlloc refType |a#0@@1| (Tclass._System.array Tclass._System.nat) $Heap@1)) (and (=> (= (ControlFlow 0 24) (- 0 25)) ($Is intType (int_2_U |j#0@0|) Tclass._System.nat)) (=> ($Is intType (int_2_U |j#0@0|) Tclass._System.nat) (=> ($IsAlloc intType (int_2_U |j#0@0|) Tclass._System.nat $Heap@1) (=> (and (|_module.__default.Has#canCall| Tclass._System.nat $Heap@1 |a#0@@1| ($Box intType (int_2_U |j#0@0|))) (= (ControlFlow 0 24) 23)) anon20_correct)))))))
(let ((anon38_Else_correct  (=> (< |j#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 28) 24) anon39_Then_correct) (=> (= (ControlFlow 0 28) 26) anon39_Else_correct)))))
(let ((anon38_Then_correct  (=> (<= (LitInt 0) |j#0@0|) (and (=> (= (ControlFlow 0 27) 24) anon39_Then_correct) (=> (= (ControlFlow 0 27) 26) anon39_Else_correct)))))
(let ((anon37_Then_correct  (and (=> (= (ControlFlow 0 29) 27) anon38_Then_correct) (=> (= (ControlFlow 0 29) 28) anon38_Else_correct))))
(let ((anon37_Else_correct true))
(let ((anon15_correct  (=> (and (<= (LitInt 0) |s#0@1|) (<= |s#0@1| |N#0@0|)) (and (=> (= (ControlFlow 0 30) 29) anon37_Then_correct) (=> (= (ControlFlow 0 30) 22) anon37_Else_correct)))))
(let ((anon36_Else_correct  (=> (and (< |s#0@1| (LitInt 0)) (= (ControlFlow 0 32) 30)) anon15_correct)))
(let ((anon36_Then_correct  (=> (and (<= (LitInt 0) |s#0@1|) (= (ControlFlow 0 31) 30)) anon15_correct)))
(let ((anon35_Then_correct  (=> (not |$w$loop#0@0|) (and (=> (= (ControlFlow 0 33) 31) anon36_Then_correct) (=> (= (ControlFlow 0 33) 32) anon36_Else_correct)))))
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (forall ((|i#1| Int) ) (!  (=> (and (<= (LitInt 0) |i#1|) (< |i#1| (_System.array.Length |a#0@@1|))) (or (not (= (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 |a#0@@1|) (IndexField |i#1|)))) |s#0@3|)) (not true)))
 :qid |SmallestMissingNumberimperativedfy.30:18|
 :skolemid |550|
 :pattern ( ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 |a#0@@1|) (IndexField |i#1|))))
))) (=> (forall ((|i#1@@0| Int) ) (!  (=> (and (<= (LitInt 0) |i#1@@0|) (< |i#1@@0| (_System.array.Length |a#0@@1|))) (or (not (= (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 |a#0@@1|) (IndexField |i#1@@0|)))) |s#0@3|)) (not true)))
 :qid |SmallestMissingNumberimperativedfy.30:18|
 :skolemid |550|
 :pattern ( ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 |a#0@@1|) (IndexField |i#1@@0|))))
)) (=> (= (ControlFlow 0 10) (- 0 9)) (forall ((|x#1| Int) ) (!  (=> (and (<= (LitInt 0) |x#1|) (< |x#1| |s#0@3|)) (_module.__default.Has Tclass._System.nat $Heap@3 |a#0@@1| ($Box intType (int_2_U |x#1|))))
 :qid |SmallestMissingNumberimperativedfy.31:18|
 :skolemid |552|
 :pattern ( (_module.__default.Has Tclass._System.nat $Heap@3 |a#0@@1| ($Box intType (int_2_U |x#1|))))
)))))))
(let ((anon42_Else_correct  (=> (and (and (or (not (= |s#0@1| |N#0@0|)) (not true)) (= |s#0@3| |s#0@1|)) (and (= $Heap@3 $Heap@1) (= (ControlFlow 0 14) 10))) GeneratedUnifiedExit_correct)))
(let ((anon42_Then_correct  (=> (= |s#0@1| |N#0@0|) (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((|x#1@@0| Int) ) (!  (=> (and (<= (LitInt 0) |x#1@@0|) (< |x#1@@0| (_System.array.Length |a#0@@1|))) (_module.__default.Has Tclass._System.nat $Heap@1 |a#0@@1| ($Box intType (int_2_U |x#1@@0|))))
...
)) (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (forall ((|i#1@@1| Int) ) (!  (=> (and (<= (LitInt 0) |i#1@@1|) (< |i#1@@1| (_System.array.Length |a#0@@1|))) (< (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 |a#0@@1|) (IndexField |i#1@@1|)))) (_System.array.Length |a#0@@1|)))
 :qid |SmallestMissingNumberimperativedfy.58:18|
 :skolemid |571|
 :pattern ( ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 |a#0@@1|) (IndexField |i#1@@1|))))
))) (and (and (= $Heap@1 $Heap@2) (= |s#0@3| |s#0@1|)) (and (= $Heap@3 $Heap@2) (= (ControlFlow 0 12) 10)))) GeneratedUnifiedExit_correct))))))
(let ((anon41_Then_correct  (=> (not (and (< |s#0@1| |N#0@0|) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |s#0@1|)))))) (and (=> (= (ControlFlow 0 15) 12) anon42_Then_correct) (=> (= (ControlFlow 0 15) 14) anon42_Else_correct)))))
(let ((anon41_Else_correct  (=> (and (and (< |s#0@1| |N#0@0|) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |s#0@1|))))) (= |$decr$loop#00@1| (- |N#0@0| |s#0@1|))) (and (=> (= (ControlFlow 0 3) (- 0 8)) ($Is intType (int_2_U (+ |s#0@1| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ |s#0@1| 1)) Tclass._System.nat) (=> (= |s#0@2| (+ |s#0@1| 1)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (or (<= 0 |$decr$loop#00@1|) (= (- |N#0@0| |s#0@2|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- |N#0@0| |s#0@2|) |$decr$loop#00@1|)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (< (- |N#0@0| |s#0@2|) |$decr$loop#00@1|)) (=> (< (- |N#0@0| |s#0@2|) |$decr$loop#00@1|) (=> (=> (and (<= (LitInt 0) |s#0@2|) (<= |s#0@2| |N#0@0|)) (forall ((|j#1| T@U) ) (!  (=> (and (<= (LitInt 0) (U_2_int |j#1|)) (< (U_2_int |j#1|) |s#0@2|)) (|_module.__default.Has#canCall| Tclass._System.nat $Heap@1 |a#0@@1| ($Box intType |j#1|)))
 :qid |SmallestMissingNumberimperativedfy.46:22|
 :skolemid |566|
 :pattern ( (_module.__default.Has Tclass._System.nat $Heap@1 |a#0@@1| ($Box intType |j#1|)))
))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (=> |$w$loop#0@0| (<= (LitInt 0) |s#0@2|))) (=> (=> |$w$loop#0@0| (<= (LitInt 0) |s#0@2|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> |$w$loop#0@0| (<= |s#0@2| |N#0@0|))) (=> (=> |$w$loop#0@0| (<= |s#0@2| |N#0@0|)) (=> (= (ControlFlow 0 3) (- 0 2)) (=> |$w$loop#0@0| (forall ((|j#1@@0| Int) ) (!  (=> (and (<= (LitInt 0) |j#1@@0|) (< |j#1@@0| |s#0@2|)) (_module.__default.Has Tclass._System.nat $Heap@1 |a#0@@1| ($Box intType (int_2_U |j#1@@0|))))
 :qid |SmallestMissingNumberimperativedfy.46:22|
 :skolemid |563|
 :pattern ( (_module.__default.Has Tclass._System.nat $Heap@1 |a#0@@1| ($Box intType (int_2_U |j#1@@0|))))
)))))))))))))))))))
(let ((anon23_correct  (and (=> (= (ControlFlow 0 16) 15) anon41_Then_correct) (=> (= (ControlFlow 0 16) 3) anon41_Else_correct))))
(let ((anon40_Else_correct  (=> (and (<= |N#0@0| |s#0@1|) (= (ControlFlow 0 20) 16)) anon23_correct)))
(let ((anon40_Then_correct  (=> (< |s#0@1| |N#0@0|) (and (=> (= (ControlFlow 0 17) (- 0 19)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (and (<= 0 |s#0@1|) (< |s#0@1| (_System.array.Length $nw@0)))) (=> (and (<= 0 |s#0@1|) (< |s#0@1| (_System.array.Length $nw@0))) (=> (= (ControlFlow 0 17) 16) anon23_correct))))))))
(let ((anon35_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 21) 17) anon40_Then_correct) (=> (= (ControlFlow 0 21) 20) anon40_Else_correct)))))
(let ((anon34_LoopBody_correct  (and (=> (= (ControlFlow 0 34) 33) anon35_Then_correct) (=> (= (ControlFlow 0 34) 21) anon35_Else_correct))))
(let ((anon34_LoopDone_correct true))
(let ((anon34_LoopHead_correct  (=> (<= (LitInt 0) |s#0@1|) (=> (and (and (and (and (<= 0 |s#0@1|) (not false)) (<= 0 |N#0@0|)) (<= 0 |$decr_init$loop#00@0|)) (and (and (and (=> |$w$loop#0@0| (<= (LitInt 0) |s#0@1|)) (=> |$w$loop#0@0| (<= |s#0@1| |N#0@0|))) (and (=> |$w$loop#0@0| (forall ((|j#1@@1| T@U) ) (!  (=> (and (<= (LitInt 0) (U_2_int |j#1@@1|)) (< (U_2_int |j#1@@1|) |s#0@1|)) (|_module.__default.Has#canCall| Tclass._System.nat $Heap@1 |a#0@@1| ($Box intType |j#1@@1|)))
 :qid |SmallestMissingNumberimperativedfy.46:22|
 :skolemid |561|
 :pattern ( (_module.__default.Has Tclass._System.nat $Heap@1 |a#0@@1| ($Box intType |j#1@@1|)))
))) (=> |$w$loop#0@0| (forall ((|j#1@@2| T@U) ) (!  (=> (and (<= (LitInt 0) (U_2_int |j#1@@2|)) (< (U_2_int |j#1@@2|) |s#0@1|)) (_module.__default.Has Tclass._System.nat $Heap@1 |a#0@@1| ($Box intType |j#1@@2|)))
 :qid |SmallestMissingNumberimperativedfy.46:22|
 :skolemid |563|
 :pattern ( (_module.__default.Has Tclass._System.nat $Heap@1 |a#0@@1| ($Box intType |j#1@@2|)))
 ...
 :qid |SmallestMissingNumberimperativedfy.44:3|
 :skolemid |564|
...
)) (<= (- |N#0@0| |s#0@1|) |$decr_init$loop#00@0|))))) (and (=> (= (ControlFlow 0 35) 1) anon34_LoopDone_correct) (=> (= (ControlFlow 0 35) 34) anon34_LoopBody_correct))))))
(let ((anon31_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) ($HeapSucc $Heap@0 $Heap@1)) (and (forall (($o@@11 T@U) ($f@@2 T@U) ) (!  (or (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $o@@11) $f@@2) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $o@@11) $f@@2)) (exists ((|n#0_2| Int) ) (!  (and (and (and (and (<= (LitInt 0) |n#0_2|) (< |n#0_2| |N#0@0|)) (< (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0@@1|) (IndexField |n#0_2|)))) |N#0@0|)) (= $o@@11 $nw@0)) (= $f@@2 (IndexField (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0@@1|) (IndexField |n#0_2|)))))))
 :qid |SmallestMissingNumberimperativedfy.40:10|
 :skolemid |556|
)))
 :qid |SmallestMissingNumberimperativedfy.40:3|
 :skolemid |557|
 :pattern ( (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $o@@11) $f@@2))
)) (forall ((|n#0_2@@0| Int) ) (!  (=> (and (and (<= (LitInt 0) |n#0_2@@0|) (< |n#0_2@@0| |N#0@0|)) (< (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0@@1|) (IndexField |n#0_2@@0|)))) |N#0@0|)) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@0) (IndexField (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0@@1|) (IndexField |n#0_2@@0|)))))) ($Box boolType (Lit boolType (bool_2_U true)))))
 :qid |SmallestMissingNumberimperativedfy.40:10|
 :skolemid |558|
)))) (and (=> (= (ControlFlow 0 36) (- 0 40)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (and (= |s#0@0| (LitInt 0)) (= |$decr_init$loop#00@0| (- |N#0@0| |s#0@0|))) (and (=> (= (ControlFlow 0 36) (- 0 39)) (=> |$w$loop#0@0| (<= (LitInt 0) |s#0@0|))) (=> (=> |$w$loop#0@0| (<= (LitInt 0) |s#0@0|)) (and (=> (= (ControlFlow 0 36) (- 0 38)) (=> |$w$loop#0@0| (<= |s#0@0| |N#0@0|))) (=> (=> |$w$loop#0@0| (<= |s#0@0| |N#0@0|)) (and (=> (= (ControlFlow 0 36) (- 0 37)) (=> |$w$loop#0@0| (forall ((|j#1@@3| Int) ) (!  (=> (and (<= (LitInt 0) |j#1@@3|) (< |j#1@@3| |s#0@0|)) (_module.__default.Has Tclass._System.nat $Heap@1 |a#0@@1| ($Box intType (int_2_U |j#1@@3|))))
 :qid |SmallestMissingNumberimperativedfy.46:22|
 :skolemid |563|
 :pattern ( (_module.__default.Has Tclass._System.nat $Heap@1 |a#0@@1| ($Box intType (int_2_U |j#1@@3|))))
)))) (=> (=> |$w$loop#0@0| (forall ((|j#1@@4| T@U) ) (!  (=> (and (<= (LitInt 0) (U_2_int |j#1@@4|)) (< (U_2_int |j#1@@4|) |s#0@0|)) (_module.__default.Has Tclass._System.nat $Heap@1 |a#0@@1| ($Box intType |j#1@@4|)))
 :qid |SmallestMissingNumberimperativedfy.46:22|
 :skolemid |563|
 :pattern ( (_module.__default.Has Tclass._System.nat $Heap@1 |a#0@@1| ($Box intType |j#1@@4|)))
))) (=> (= (ControlFlow 0 36) 35) anon34_LoopHead_correct)))))))))))))
(let ((anon29_Else_correct  (=> (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? TBool))) (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@0 $nw@0) alloc)))) (= (_System.array.Length $nw@0) |N#0@0|))) (and (=> (= (ControlFlow 0 55) (- 0 56)) (forall ((|arrayinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0|) (< |arrayinit#0#i0#0| |N#0@0|)) (Requires1 Tclass._System.nat TBool $Heap@@0 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#4| ($Box boolType (Lit boolType (bool_2_U false)))) (|lambda#5| Tclass._System.nat) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0|))))
 :qid |SmallestMissingNumberimperativedfy.39:12|
 :skolemid |554|
))) (=> (and (and (forall ((|arrayinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0@@0|) (< |arrayinit#0#i0#0@@0| |N#0@0|)) (= (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@0 $nw@0) (IndexField |arrayinit#0#i0#0@@0|)))) (U_2_bool ($Unbox boolType (Apply1 Tclass._System.nat TBool $Heap@@0 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#4| ($Box boolType (Lit boolType (bool_2_U false)))) (|lambda#5| Tclass._System.nat) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0@@0|)))))))
 :qid |SmallestMissingNumberimperativedfy.39:12|
 :skolemid |555|
...
)) (= $Heap@0 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap@@0 $nw@0 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@0 $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 55) 54) anon31_Then_correct) (=> (= (ControlFlow 0 55) 36) anon31_Else_correct)))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (and (=> (= (ControlFlow 0 61) (- 0 63)) (or (not (= |a#0@@1| null)) (not true))) (=> (or (not (= |a#0@@1| null)) (not true)) (=> (= |N#0@0| (_System.array.Length |a#0@@1|)) (and (=> (= (ControlFlow 0 61) (- 0 62)) (<= 0 |N#0@0|)) (=> (<= 0 |N#0@0|) (and (=> (= (ControlFlow 0 61) 60) anon29_Then_correct) (=> (= (ControlFlow 0 61) 55) anon29_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is refType |a#0@@1| (Tclass._System.array Tclass._System.nat)) ($IsAlloc refType |a#0@@1| (Tclass._System.array Tclass._System.nat) $Heap@@0)) (<= (LitInt 0) |s#0|)) (=> (and (and (and ($Is refType |e#0| (Tclass._System.array TBool)) ($IsAlloc refType |e#0| (Tclass._System.array TBool) $Heap@@0)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 64) 61))) anon0_correct)))))
