...
(declare-fun Tagclass._System.object () T@U)
(declare-fun class.M3.VarDecl? () T@U)
...
(declare-fun M3.VarDecl.val () T@U)
...
(assert (distinct TBool TInt TagBool TagInt TagSet alloc allocName Tagclass._System.object? Tagclass._System.object class.M3.VarDecl? Tagclass.M3.VarDecl? Tagclass.M3.VarDecl class.M3.Expr? Tagclass.M3.Expr? Tagclass.M3.Expr Tagclass.M3.Kind |##M3.Kind.Constant| |##M3.Kind.Ident| |##M3.Kind.Binary| tytagFamily$object tytagFamily$VarDecl tytagFamily$Expr tytagFamily$Kind field$val field$resolved field$kind field$left field$Repr field$right field$decl field$value)
)
(assert (= (FDim alloc) 0))
...
(assert (= (FDim M3.VarDecl.val) 0))
(assert (= (FieldOfDecl class.M3.VarDecl? field$val) M3.VarDecl.val))
(assert  (not ($IsGhostField M3.VarDecl.val)))
...
(assert (forall ((a T@U) (b T@U) ) (! (= (|M3.Kind#Equal| a b) (= a b))
 :qid |unknown.0:0|
 :skolemid |2325|
 :pattern ( (|M3.Kind#Equal| a b))
)))
...
(assert (forall (($h@@5 T@U) ($o@@7 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@5) (and (or (not (= $o@@7 null)) (not true)) (= (dtype $o@@7) Tclass.M3.VarDecl?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@7) alloc)))) ($IsAlloc intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@7) M3.VarDecl.val)) TInt $h@@5))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2213|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@7) M3.VarDecl.val)))
)))
(assert (forall (($h@@6 T@U) ($o@@8 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@6) (and (or (not (= $o@@8 null)) (not true)) (= (dtype $o@@8) Tclass.M3.Expr?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@8) alloc)))) ($IsAlloc boolType ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@8) M3.Expr.resolved)) TBool $h@@6))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2245|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@8) M3.Expr.resolved)))
)))
(assert (forall (($h@@7 T@U) ($o@@9 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@7) (and (or (not (= $o@@9 null)) (not true)) (= (dtype $o@@9) Tclass.M3.Expr?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@9) alloc)))) ($IsAlloc intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@9) M3.Expr.value)) TInt $h@@7))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2286|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@9) M3.Expr.value)))
)))
...
(assert (forall (($h@@8 T@U) ($o@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (or (not (= $o@@10 null)) (not true)) (= (dtype $o@@10) Tclass.M3.Expr?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@10) M3.Expr.decl)) Tclass.M3.VarDecl?))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2226|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@10) M3.Expr.decl)))
)))
(assert (forall (($h@@9 T@U) ($o@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) (and (or (not (= $o@@11 null)) (not true)) (= (dtype $o@@11) Tclass.M3.Expr?))) ($Is DatatypeTypeType ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@11) M3.Expr.kind)) Tclass.M3.Kind))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2283|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@11) M3.Expr.kind)))
)))
(assert (forall (($h@@10 T@U) ($o@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) (and (or (not (= $o@@12 null)) (not true)) (= (dtype $o@@12) Tclass.M3.Expr?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@12) M3.Expr.left)) Tclass.M3.Expr?))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2287|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@12) M3.Expr.left)))
)))
(assert (forall (($h@@11 T@U) ($o@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (or (not (= $o@@13 null)) (not true)) (= (dtype $o@@13) Tclass.M3.Expr?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@13) M3.Expr.right)) Tclass.M3.Expr?))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2289|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@13) M3.Expr.right)))
)))
...
(assert (forall (($h@@12 T@U) ($o@@14 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@12) (and (or (not (= $o@@14 null)) (not true)) (= (dtype $o@@14) Tclass.M3.Expr?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@14) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@14) M3.Expr.decl)) Tclass.M3.VarDecl? $h@@12))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2227|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@14) M3.Expr.decl)))
)))
(assert (forall (($h@@13 T@U) ($o@@15 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@13) (and (or (not (= $o@@15 null)) (not true)) (= (dtype $o@@15) Tclass.M3.Expr?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@15) alloc)))) ($IsAlloc DatatypeTypeType ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@15) M3.Expr.kind)) Tclass.M3.Kind $h@@13))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2284|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@15) M3.Expr.kind)))
)))
(assert (forall (($h@@14 T@U) ($o@@16 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@14) (and (or (not (= $o@@16 null)) (not true)) (= (dtype $o@@16) Tclass.M3.Expr?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@16) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@16) M3.Expr.left)) Tclass.M3.Expr? $h@@14))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2288|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@16) M3.Expr.left)))
)))
(assert (forall (($h@@15 T@U) ($o@@17 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@15) (and (or (not (= $o@@17 null)) (not true)) (= (dtype $o@@17) Tclass.M3.Expr?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@17) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@17) M3.Expr.right)) Tclass.M3.Expr? $h@@15))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2290|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@17) M3.Expr.right)))
)))
...
(assert (forall (($h@@16 T@U) ($o@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (or (not (= $o@@18 null)) (not true)) (= (dtype $o@@18) Tclass.M3.Expr?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@18) M3.Expr.Repr)) (TSet Tclass._System.object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2291|
...
(assert (forall (($h@@17 T@U) ($o@@19 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@17) (and (or (not (= $o@@19 null)) (not true)) (= (dtype $o@@19) Tclass.M3.Expr?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@19) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@19) M3.Expr.Repr)) (TSet Tclass._System.object) $h@@17))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2292|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@19) M3.Expr.Repr)))
)))
...
(assert (forall ((a@@3 T@U) (b@@3 T@U) ) (!  (=> (and (M3.Kind.Constant_q a@@3) (M3.Kind.Constant_q b@@3)) (|M3.Kind#Equal| a@@3 b@@3))
 :qid |unknown.0:0|
 :skolemid |2322|
 :pattern ( (|M3.Kind#Equal| a@@3 b@@3) (M3.Kind.Constant_q a@@3))
 :pattern ( (|M3.Kind#Equal| a@@3 b@@3) (M3.Kind.Constant_q b@@3))
)))
(assert (forall ((a@@4 T@U) (b@@4 T@U) ) (!  (=> (and (M3.Kind.Ident_q a@@4) (M3.Kind.Ident_q b@@4)) (|M3.Kind#Equal| a@@4 b@@4))
 :qid |unknown.0:0|
 :skolemid |2323|
 :pattern ( (|M3.Kind#Equal| a@@4 b@@4) (M3.Kind.Ident_q a@@4))
 :pattern ( (|M3.Kind#Equal| a@@4 b@@4) (M3.Kind.Ident_q b@@4))
)))
(assert (forall ((a@@5 T@U) (b@@5 T@U) ) (!  (=> (and (M3.Kind.Binary_q a@@5) (M3.Kind.Binary_q b@@5)) (|M3.Kind#Equal| a@@5 b@@5))
 :qid |unknown.0:0|
 :skolemid |2324|
 :pattern ( (|M3.Kind#Equal| a@@5 b@@5) (M3.Kind.Binary_q a@@5))
 :pattern ( (|M3.Kind#Equal| a@@5 b@@5) (M3.Kind.Binary_q b@@5))
)))
...
(assert (forall (($h@@18 T@U) ($o@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (or (not (= $o@@21 null)) (not true)) (= (dtype $o@@21) Tclass.M3.VarDecl?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@21) M3.VarDecl.val)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2212|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@21) M3.VarDecl.val)))
)))
(assert (forall (($h@@19 T@U) ($o@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (or (not (= $o@@22 null)) (not true)) (= (dtype $o@@22) Tclass.M3.Expr?))) ($Is boolType ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@22) M3.Expr.resolved)) TBool))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2244|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@22) M3.Expr.resolved)))
)))
(assert (forall (($h@@20 T@U) ($o@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (or (not (= $o@@23 null)) (not true)) (= (dtype $o@@23) Tclass.M3.Expr?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@20 $o@@23) M3.Expr.value)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2285|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@20 $o@@23) M3.Expr.value)))
)))
(assert (forall (($h0@@2 T@U) ($h1@@2 T@U) (this@@9 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@2) ($IsGoodHeap $h1@@2)) (and (or (not (= this@@9 null)) (not true)) ($Is refType this@@9 Tclass.M3.Expr))) (and ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2))) (=> (forall (($o@@24 T@U) ($f@@2 T@U) ) (!  (=> (and (or (not (= $o@@24 null)) (not true)) (or (= $o@@24 this@@9) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 this@@9) M3.Expr.Repr)) ($Box refType $o@@24)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 $o@@24) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@2 $o@@24) $f@@2)))
 :qid |unknown.0:0|
 :skolemid |2228|
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@25 T@U) ($f@@3 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@25 $f@@3))  (=> (and (or (not (= $o@@25 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@25) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |2329|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@25 $f@@3))
)))
...
(assert (forall ((d@@7 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) ($Is DatatypeTypeType d@@7 Tclass.M3.Kind)) ($IsAlloc DatatypeTypeType d@@7 Tclass.M3.Kind $h@@21))
 :qid |unknown.0:0|
 :skolemid |2319|
 :pattern ( ($IsAlloc DatatypeTypeType d@@7 Tclass.M3.Kind $h@@21))
)))
...
(set-info :boogie-vc-id Impl$$M3.Expr.Eval)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon7_Else_correct true))
(let ((anon7_Then_correct  (=> (= ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.kind)) |#M3.Kind.Binary|) (and (=> (= (ControlFlow 0 5) (- 0 14)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.left)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.left)) null)) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 13)) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.left))) M3.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.Repr))) (not (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.left))) M3.Expr.Repr)))))) (=> (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.left))) M3.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.Repr))) (not (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.left))) M3.Expr.Repr))))) (=> (= call0formal@this@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.left))) (and (=> (= (ControlFlow 0 5) (- 0 12)) (=> (|M3.Expr.Valid#canCall| $Heap@@8 call0formal@this@0) (or (M3.Expr.Valid ($LS $LZ) $Heap@@8 call0formal@this@0) (M3.Expr.Core ($LS ($LS $LZ)) $Heap@@8 call0formal@this@0)))) (=> (=> (|M3.Expr.Valid#canCall| $Heap@@8 call0formal@this@0) (or (M3.Expr.Valid ($LS $LZ) $Heap@@8 call0formal@this@0) (M3.Expr.Core ($LS ($LS $LZ)) $Heap@@8 call0formal@this@0))) (and (=> (= (ControlFlow 0 5) (- 0 11)) (=> (|M3.Expr.Valid#canCall| $Heap@@8 call0formal@this@0) (or (M3.Expr.Valid ($LS $LZ) $Heap@@8 call0formal@this@0) (M3.Expr.Valid_k ($LS ($LS $LZ)) $Heap@@8 call0formal@this@0)))) (=> (=> (|M3.Expr.Valid#canCall| $Heap@@8 call0formal@this@0) (or (M3.Expr.Valid ($LS $LZ) $Heap@@8 call0formal@this@0) (M3.Expr.Valid_k ($LS ($LS $LZ)) $Heap@@8 call0formal@this@0))) (and (=> (= (ControlFlow 0 5) (- 0 10)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 call0formal@this@0) M3.Expr.resolved)))) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 call0formal@this@0) M3.Expr.resolved))) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@26 T@U) ) (!  (=> (and (or (not (= $o@@26 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@26) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@26) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@26)))
 :qid |MonotonicHeapstatedfy.159:12|
 :skolemid |2222|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@26))
)) ($HeapSucc $Heap@@8 $Heap@0))) (and (=> (= (ControlFlow 0 5) (- 0 9)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M3.Expr.right)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M3.Expr.right)) null)) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 8)) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M3.Expr.right))) M3.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.Repr))) (not (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M3.Expr.right))) M3.Expr.Repr)))))) (=> (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M3.Expr.right))) M3.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.Repr))) (not (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M3.Expr.right))) M3.Expr.Repr))))) (=> (= call0formal@this@0@@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M3.Expr.right))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (=> (|M3.Expr.Valid#canCall| $Heap@0 call0formal@this@0@@0) (or (M3.Expr.Valid ($LS $LZ) $Heap@0 call0formal@this@0@@0) (M3.Expr.Core ($LS ($LS $LZ)) $Heap@0 call0formal@this@0@@0)))) (=> (=> (|M3.Expr.Valid#canCall| $Heap@0 call0formal@this@0@@0) (or (M3.Expr.Valid ($LS $LZ) $Heap@0 call0formal@this@0@@0) (M3.Expr.Core ($LS ($LS $LZ)) $Heap@0 call0formal@this@0@@0))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (=> (|M3.Expr.Valid#canCall| $Heap@0 call0formal@this@0@@0) (or (M3.Expr.Valid ($LS $LZ) $Heap@0 call0formal@this@0@@0) (M3.Expr.Valid_k ($LS ($LS $LZ)) $Heap@0 call0formal@this@0@@0)))) (=> (=> (|M3.Expr.Valid#canCall| $Heap@0 call0formal@this@0@@0) (or (M3.Expr.Valid ($LS $LZ) $Heap@0 call0formal@this@0@@0) (M3.Expr.Valid_k ($LS ($LS $LZ)) $Heap@0 call0formal@this@0@@0))) (=> (= (ControlFlow 0 5) (- 0 4)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call0formal@this@0@@0) M3.Expr.resolved))))))))))))))))))))))))))))
(let ((anon6_Else_correct  (=> (or (not (= ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.kind)) |#M3.Kind.Ident|)) (not true)) (and (=> (= (ControlFlow 0 16) 5) anon7_Then_correct) (=> (= (ControlFlow 0 16) 15) anon7_Else_correct)))))
(let ((anon6_Then_correct  (=> (and (= ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.kind)) |#M3.Kind.Ident|) (= (ControlFlow 0 3) (- 0 2))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.decl)) null)) (not true)))))
(let ((anon5_Else_correct  (=> (or (not (= ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.kind)) |#M3.Kind.Constant|)) (not true)) (and (=> (= (ControlFlow 0 17) 3) anon6_Then_correct) (=> (= (ControlFlow 0 17) 16) anon6_Else_correct)))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@8 alloc false)) (and (=> (= (ControlFlow 0 18) 1) anon5_Then_correct) (=> (= (ControlFlow 0 18) 17) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@8) ($IsHeapAnchor $Heap@@8)) (=> (and (and (and (or (not (= this@@12 null)) (not true)) (and ($Is refType this@@12 Tclass.M3.Expr) ($IsAlloc refType this@@12 Tclass.M3.Expr $Heap@@8))) (= 3 $FunctionContextHeight)) (and (and (|M3.Expr.Valid#canCall| $Heap@@8 this@@12) (and (M3.Expr.Valid ($LS $LZ) $Heap@@8 this@@12) (and (M3.Expr.Core ($LS $LZ) $Heap@@8 this@@12) (M3.Expr.Valid_k ($LS $LZ) $Heap@@8 this@@12)))) (and (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.resolved))) (= (ControlFlow 0 19) 18)))) anon0_correct))))
