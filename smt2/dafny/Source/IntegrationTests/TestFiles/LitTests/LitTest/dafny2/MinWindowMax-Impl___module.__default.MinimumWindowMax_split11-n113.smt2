...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split114)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon90_correct  (=> (= |n#0@4| (+ |n#0@3| 1)) (=> (and (and ($Is intType (int_2_U |W#0|) Tclass._System.nat) (<= (LitInt 0) |k#0@2|)) (and (<= |k#0@2| |$rhs#1_1@1|) (= (ControlFlow 0 2) (- 0 1)))) (<= |$rhs#1_1@1| (_System.array.Length $nw@0))))))
