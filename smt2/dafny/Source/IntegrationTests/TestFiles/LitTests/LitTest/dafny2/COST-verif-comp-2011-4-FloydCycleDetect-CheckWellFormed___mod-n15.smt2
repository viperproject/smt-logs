...
(set-info :boogie-vc-id CheckWellFormed$$_module.Node.Lemma__NullImpliesNoCycles)
...
))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= (LitInt 0) |k#0@0|)) (=> (and (and (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (<= (LitInt 0) |k#0@0|)) (and (|_module.Node.Nexxxt#canCall| $Heap@0 this@@4 |k#0@0| |S#0@@4|) (= (ControlFlow 0 3) 2))) anon10_correct)))))))))))))))))))))))))
(let ((anon14_Else_correct  (=> (not (and (and (<= (LitInt 0) |k#0@0|) (<= (LitInt 0) |l#0@0|)) (or (not (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |k#0@0| |S#0@@4|) null)) (not true)))) (and (=> (= (ControlFlow 0 25) 3) anon15_Then_correct) (=> (= (ControlFlow 0 25) 18) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (and (and (and (and (<= (LitInt 0) |k#0@0|) (<= (LitInt 0) |l#0@0|)) (or (not (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |k#0@0| |S#0@@4|) null)) (not true))) ($IsAllocBox ($Box refType this@@4) Tclass._module.Node? $Heap@0)) (and ($IsAlloc intType (int_2_U |k#0@0|) TInt $Heap@0) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Node?) $Heap@0))) (and (=> (= (ControlFlow 0 19) (- 0 24)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType this@@4))))) (and (=> (= (ControlFlow 0 19) (- 0 23)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType null))))) (and (=> (= (ControlFlow 0 19) (- 0 22)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (forall ((|n#3| T@U) ) (!  (=> ($Is refType |n#3| Tclass._module.Node?) (=> (and (and (|Set#IsMember| |S#0@@4| ($Box refType |n#3|)) (or (not (= |n#3| null)) (not true))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#3|) _module.Node.next)) null)) (not true))) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#3|) _module.Node.next))))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.133:12|
 :skolemid |839|
...
))))) (and (=> (= (ControlFlow 0 19) (- 0 21)) (<= (LitInt 0) |k#0@0|)) (=> (and (and (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (<= (LitInt 0) |k#0@0|)) (|_module.Node.Nexxxt#canCall| $Heap@0 this@@4 |k#0@0| |S#0@@4|)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (or (not (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |k#0@0| |S#0@@4|) null)) (not true))) (=> (or (not (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |k#0@0| |S#0@@4|) null)) (not true)) (and (=> (= (ControlFlow 0 19) 3) anon15_Then_correct) (=> (= (ControlFlow 0 19) 18) anon15_Else_correct))))))))))))
(let ((anon13_Else_correct  (=> (not (and (<= (LitInt 0) |k#0@0|) (<= (LitInt 0) |l#0@0|))) (and (=> (= (ControlFlow 0 31) 19) anon14_Then_correct) (=> (= (ControlFlow 0 31) 25) anon14_Else_correct)))))
(let ((anon13_Then_correct  (=> (and (and (and (<= (LitInt 0) |k#0@0|) (<= (LitInt 0) |l#0@0|)) ($IsAllocBox ($Box refType this@@4) Tclass._module.Node? $Heap@0)) (and ($IsAlloc intType (int_2_U |k#0@0|) TInt $Heap@0) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Node?) $Heap@0))) (and (=> (= (ControlFlow 0 26) (- 0 30)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType this@@4))))) (and (=> (= (ControlFlow 0 26) (- 0 29)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType null))))) (and (=> (= (ControlFlow 0 26) (- 0 28)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (forall ((|n#2| T@U) ) (!  (=> ($Is refType |n#2| Tclass._module.Node?) (=> (and (and (|Set#IsMember| |S#0@@4| ($Box refType |n#2|)) (or (not (= |n#2| null)) (not true))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#2|) _module.Node.next)) null)) (not true))) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#2|) _module.Node.next))))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.133:12|
 :skolemid |837|
...
))))) (and (=> (= (ControlFlow 0 26) (- 0 27)) (<= (LitInt 0) |k#0@0|)) (=> (and (and (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (<= (LitInt 0) |k#0@0|)) (|_module.Node.Nexxxt#canCall| $Heap@0 this@@4 |k#0@0| |S#0@@4|)) (and (=> (= (ControlFlow 0 26) 19) anon14_Then_correct) (=> (= (ControlFlow 0 26) 25) anon14_Else_correct))))))))))
(let ((anon12_Else_correct  (=> (< |k#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 33) 26) anon13_Then_correct) (=> (= (ControlFlow 0 33) 31) anon13_Else_correct)))))
(let ((anon12_Then_correct  (=> (<= (LitInt 0) |k#0@0|) (and (=> (= (ControlFlow 0 32) 26) anon13_Then_correct) (=> (= (ControlFlow 0 32) 31) anon13_Else_correct)))))
(let ((anon11_Then_correct  (and (=> (= (ControlFlow 0 34) 32) anon12_Then_correct) (=> (= (ControlFlow 0 34) 33) anon12_Else_correct))))
(let ((anon11_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#3| null $Heap@@4 alloc false)) (=> (and (and (and ($IsAllocBox ($Box refType this@@4) Tclass._module.Node? $Heap@@4) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Node?) $Heap@@4)) (and (|_module.Node.IsClosed#canCall| $Heap@@4 this@@4 |S#0@@4|) (_module.Node.IsClosed $Heap@@4 this@@4 |S#0@@4|))) (and (and (<= (LitInt 0) |n#0@@0|) ($IsAllocBox ($Box refType this@@4) Tclass._module.Node? $Heap@@4)) (and ($IsAlloc intType (int_2_U |n#0@@0|) TInt $Heap@@4) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Node?) $Heap@@4)))) (and (=> (= (ControlFlow 0 35) (- 0 39)) (=> (|_module.Node.IsClosed#canCall| $Heap@@4 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@@4 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType this@@4))))) (and (=> (= (ControlFlow 0 35) (- 0 38)) (=> (|_module.Node.IsClosed#canCall| $Heap@@4 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@@4 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType null))))) (and (=> (= (ControlFlow 0 35) (- 0 37)) (=> (|_module.Node.IsClosed#canCall| $Heap@@4 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@@4 this@@4 |S#0@@4|) (forall ((|n#1| T@U) ) (!  (=> ($Is refType |n#1| Tclass._module.Node?) (=> (and (and (|Set#IsMember| |S#0@@4| ($Box refType |n#1|)) (or (not (= |n#1| null)) (not true))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 |n#1|) _module.Node.next)) null)) (not true))) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 |n#1|) _module.Node.next))))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.133:12|
 :skolemid |835|
...
))))) (and (=> (= (ControlFlow 0 35) (- 0 36)) (<= (LitInt 0) |n#0@@0|)) (=> (and (and (and (_module.Node.IsClosed $Heap@@4 this@@4 |S#0@@4|) (<= (LitInt 0) |n#0@@0|)) (and (|_module.Node.Nexxxt#canCall| $Heap@@4 this@@4 |n#0@@0| |S#0@@4|) (= (_module.Node.Nexxxt ($LS $LZ) $Heap@@4 this@@4 |n#0@@0| |S#0@@4|) null))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@4 $Heap@0))) (and (=> (= (ControlFlow 0 35) 34) anon11_Then_correct) (=> (= (ControlFlow 0 35) 1) anon11_Else_correct)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.Node) ($IsAlloc refType this@@4 Tclass._module.Node $Heap@@4)))) (and (and ($Is SetType |S#0@@4| (TSet Tclass._module.Node?)) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Node?) $Heap@@4)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 40) 35)))) anon0_correct)))
