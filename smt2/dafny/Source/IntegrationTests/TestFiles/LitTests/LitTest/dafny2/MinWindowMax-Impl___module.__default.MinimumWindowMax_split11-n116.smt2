...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split117)
...
)))) (=> (and (and (and ($IsGoodHeap $Heap@8) ($IsHeapAnchor $Heap@8)) (<= (- |$rhs#1_1@1| |k#0@2|) |W#0|)) (and (= $Heap@7 $Heap@8) (= (ControlFlow 0 2) (- 0 1)))) (or (<= 0 |$decr$loop#10@1|) (= (- (_System.array.Length |a#0@@4|) |n#0@4|) |$decr$loop#10@1|))))))))
