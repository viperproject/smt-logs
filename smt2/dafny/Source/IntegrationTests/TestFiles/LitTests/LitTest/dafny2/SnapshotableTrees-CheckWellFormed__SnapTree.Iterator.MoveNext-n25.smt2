...
(set-info :boogie-vc-id CheckWellFormed$$SnapTree.Iterator.MoveNext_split4)
...
)))) (and (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@9) SnapTree.Iterator.T)) null)) (not true)) ($IsAlloc refType this@@9 Tclass.SnapTree.Iterator $Heap@@11)) (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@9) SnapTree.Iterator.T)) null)) (not true)) (= (ControlFlow 0 2) (- 0 1)))))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@9) SnapTree.Iterator.T)) Tclass.SnapTree.Tree? $Heap@@11)))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
