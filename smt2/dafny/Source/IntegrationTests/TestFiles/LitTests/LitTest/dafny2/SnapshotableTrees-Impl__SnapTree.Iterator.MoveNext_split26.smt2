...
(assert (forall ((a@@3 T@U) (b@@0 T@U) ) (! (= (|Set#Disjoint| a@@3 b@@0) (forall ((o@@2 T@U) ) (!  (or (not (|Set#IsMember| a@@3 o@@2)) (not (|Set#IsMember| b@@0 o@@2)))
...
(assert (forall (($h@@27 T@U) ($o@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (or (not (= $o@@24 null)) (not true)) (= (dtype $o@@24) Tclass.SnapTree.Tree?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@27 $o@@24) SnapTree.Tree.Repr)) (TSet Tclass._System.object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |667|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@27 $o@@24) SnapTree.Tree.Repr)))
)))
(assert (forall (($h@@28 T@U) ($o@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (or (not (= $o@@25 null)) (not true)) (= (dtype $o@@25) Tclass.SnapTree.Tree?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@28 $o@@25) SnapTree.Tree.MutableRepr)) (TSet Tclass._System.object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |669|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@28 $o@@25) SnapTree.Tree.MutableRepr)))
)))
(assert (forall (($h@@29 T@U) ($o@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@29) (and (or (not (= $o@@26 null)) (not true)) (= (dtype $o@@26) Tclass.SnapTree.Node?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@29 $o@@26) SnapTree.Node.Repr)) (TSet Tclass._System.object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |816|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@29 $o@@26) SnapTree.Node.Repr)))
)))
(assert (forall (($h@@30 T@U) ($o@@27 T@U) ) (!  (=> (and ($IsGoodHeap $h@@30) (and (or (not (= $o@@27 null)) (not true)) (= (dtype $o@@27) Tclass.SnapTree.Iterator?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@30 $o@@27) SnapTree.Iterator.IterRepr)) (TSet Tclass._System.object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |999|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@30 $o@@27) SnapTree.Iterator.IterRepr)))
)))
(assert (forall (($h@@31 T@U) ($o@@28 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@31) (and (or (not (= $o@@28 null)) (not true)) (= (dtype $o@@28) Tclass.SnapTree.Tree?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@31 $o@@28) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@31 $o@@28) SnapTree.Tree.Repr)) (TSet Tclass._System.object) $h@@31))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |668|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@31 $o@@28) SnapTree.Tree.Repr)))
)))
(assert (forall (($h@@32 T@U) ($o@@29 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@32) (and (or (not (= $o@@29 null)) (not true)) (= (dtype $o@@29) Tclass.SnapTree.Tree?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@32 $o@@29) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@32 $o@@29) SnapTree.Tree.MutableRepr)) (TSet Tclass._System.object) $h@@32))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |670|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@32 $o@@29) SnapTree.Tree.MutableRepr)))
)))
(assert (forall (($h@@33 T@U) ($o@@30 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@33) (and (or (not (= $o@@30 null)) (not true)) (= (dtype $o@@30) Tclass.SnapTree.Node?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@33 $o@@30) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@33 $o@@30) SnapTree.Node.Repr)) (TSet Tclass._System.object) $h@@33))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |817|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@33 $o@@30) SnapTree.Node.Repr)))
)))
(assert (forall (($h@@34 T@U) ($o@@31 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@34) (and (or (not (= $o@@31 null)) (not true)) (= (dtype $o@@31) Tclass.SnapTree.Iterator?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@34 $o@@31) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@34 $o@@31) SnapTree.Iterator.IterRepr)) (TSet Tclass._System.object) $h@@34))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1000|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@34 $o@@31) SnapTree.Iterator.IterRepr)))
)))
...
(assert (forall ((v@@5 T@U) (t0@@1 T@U) (h@@0 T@U) ) (! (= ($IsAlloc SetType v@@5 (TSet t0@@1) h@@0) (forall ((bx@@12 T@U) ) (!  (=> (|Set#IsMember| v@@5 bx@@12) ($IsAllocBox bx@@12 t0@@1 h@@0))
...
(assert (forall (($h@@35 T@U) ($o@@33 T@U) ) (!  (=> (and ($IsGoodHeap $h@@35) (and (or (not (= $o@@33 null)) (not true)) (= (dtype $o@@33) Tclass.SnapTree.Tree?))) ($Is boolType ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@35 $o@@33) SnapTree.Tree.IsReadonly)) TBool))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |665|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@35 $o@@33) SnapTree.Tree.IsReadonly)))
)))
(assert (forall (($h@@36 T@U) ($o@@34 T@U) ) (!  (=> (and ($IsGoodHeap $h@@36) (and (or (not (= $o@@34 null)) (not true)) (= (dtype $o@@34) Tclass.SnapTree.Tree?))) ($Is boolType ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@36 $o@@34) SnapTree.Tree.reprIsShared)) TBool))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |674|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@36 $o@@34) SnapTree.Tree.reprIsShared)))
)))
(assert (forall (($h@@37 T@U) ($o@@35 T@U) ) (!  (=> (and ($IsGoodHeap $h@@37) (and (or (not (= $o@@35 null)) (not true)) (= (dtype $o@@35) Tclass.SnapTree.Node?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@37 $o@@35) SnapTree.Node.data)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |818|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@37 $o@@35) SnapTree.Node.data)))
)))
(assert (forall (($h@@38 T@U) ($o@@36 T@U) ) (!  (=> (and ($IsGoodHeap $h@@38) (and (or (not (= $o@@36 null)) (not true)) (= (dtype $o@@36) Tclass.SnapTree.Iterator?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@38 $o@@36) SnapTree.Iterator.N)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1003|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@38 $o@@36) SnapTree.Iterator.N)))
)))
(assert (forall (($h@@39 T@U) ($o@@37 T@U) ) (!  (=> (and ($IsGoodHeap $h@@39) (and (or (not (= $o@@37 null)) (not true)) (= (dtype $o@@37) Tclass.SnapTree.Iterator?))) ($Is boolType ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@39 $o@@37) SnapTree.Iterator.initialized)) TBool))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1007|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@39 $o@@37) SnapTree.Iterator.initialized)))
)))
...
(assert (forall (($h@@40 T@U) ($o@@38 T@U) ) (!  (=> (and ($IsGoodHeap $h@@40) (and (or (not (= $o@@38 null)) (not true)) (= (dtype $o@@38) Tclass.SnapTree.Tree?))) ($Is SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@40 $o@@38) SnapTree.Tree.Contents)) (TSeq TInt)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |663|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@40 $o@@38) SnapTree.Tree.Contents)))
)))
(assert (forall (($h@@41 T@U) ($o@@39 T@U) ) (!  (=> (and ($IsGoodHeap $h@@41) (and (or (not (= $o@@39 null)) (not true)) (= (dtype $o@@39) Tclass.SnapTree.Node?))) ($Is SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@41 $o@@39) SnapTree.Node.Contents)) (TSeq TInt)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |814|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@41 $o@@39) SnapTree.Node.Contents)))
)))
(assert (forall (($h@@42 T@U) ($o@@40 T@U) ) (!  (=> (and ($IsGoodHeap $h@@42) (and (or (not (= $o@@40 null)) (not true)) (= (dtype $o@@40) Tclass.SnapTree.Iterator?))) ($Is SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@42 $o@@40) SnapTree.Iterator.Contents)) (TSeq TInt)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1001|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@42 $o@@40) SnapTree.Iterator.Contents)))
)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@41 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#9| |l#0| |l#1| |l#2| |l#3|) $o@@41 $f))  (=> (and (or (not (= $o@@41 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@41) |l#2|)))) (|Set#IsMember| |l#3| ($Box refType $o@@41))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1951|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#9| |l#0| |l#1| |l#2| |l#3|) $o@@41 $f))
)))
...
(set-info :boogie-vc-id Impl$$SnapTree.Iterator.MoveNext_split26)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap@@11) ($IsHeapAnchor $Heap@@11)) (=> (and (and (or (not (= this@@6 null)) (not true)) (and ($Is refType this@@6 Tclass.SnapTree.Iterator) ($IsAlloc refType this@@6 Tclass.SnapTree.Iterator $Heap@@11))) (and (= 6 $FunctionContextHeight) (SnapTree.Iterator.Valid reveal_SnapTree.Iterator.Valid $Heap@@11 this@@6))) (=> (and (and (and (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@6) SnapTree.Iterator.N))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@6) SnapTree.Iterator.Contents)))) (= $_ModifiesFrame@0 (|lambda#9| null $Heap@@11 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@6) SnapTree.Iterator.IterRepr))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (= $Heap@@11 $Heap@0) reveal_SnapTree.Iterator.Valid) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) SnapTree.Iterator.initialized)))) (= (ControlFlow 0 2) (- 0 1))))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@6 SnapTree.Iterator.initialized)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
