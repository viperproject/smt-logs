...
(assert (forall ((v@@5 T@U) (t0@@1 T@U) (h@@0 T@U) ) (! (= ($IsAlloc SetType v@@5 (TSet t0@@1) h@@0) (forall ((bx@@8 T@U) ) (!  (=> (|Set#IsMember| v@@5 bx@@8) ($IsAllocBox bx@@8 t0@@1 h@@0))
...
(assert (forall (($h@@14 T@U) ($o@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (or (not (= $o@@12 null)) (not true)) (= (dtype $o@@12) Tclass.SnapTree.Node?))) ($Is SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@12) SnapTree.Node.Contents)) (TSeq TInt)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |814|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@12) SnapTree.Node.Contents)))
)))
...
(assert (forall ((d@@4 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (SnapTree.List.Cons_q d@@4) ($IsAlloc DatatypeTypeType d@@4 Tclass.SnapTree.List $h@@15))) ($IsAlloc refType (SnapTree.List._h0 d@@4) Tclass.SnapTree.Node $h@@15))
 :qid |unknown.0:0|
 :skolemid |649|
 :pattern ( ($IsAlloc refType (SnapTree.List._h0 d@@4) Tclass.SnapTree.Node $h@@15))
)))
(assert (forall ((d@@5 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (SnapTree.List.Cons_q d@@5) ($IsAlloc DatatypeTypeType d@@5 Tclass.SnapTree.List $h@@16))) ($IsAlloc DatatypeTypeType (SnapTree.List._h1 d@@5) Tclass.SnapTree.List $h@@16))
 :qid |unknown.0:0|
 :skolemid |650|
 :pattern ( ($IsAlloc DatatypeTypeType (SnapTree.List._h1 d@@5) Tclass.SnapTree.List $h@@16))
)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@13 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#9| |l#0| |l#1| |l#2| |l#3|) $o@@13 $f))  (=> (and (or (not (= $o@@13 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@13) |l#2|)))) (|Set#IsMember| |l#3| ($Box refType $o@@13))))
...
(set-info :boogie-vc-id CheckWellformed$$SnapTree.Iterator.R)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 64) (let ((anon23_correct  (=> (= (SnapTree.Iterator.R ($LS $LZ) reveal_SnapTree.Iterator.R $Heap@1 |wlist#0@@1| |n#0@@1| |C#0@@1| |Nodes#0@@1|)  (and (and (and (and (and (|Set#IsMember| |Nodes#0@@1| ($Box refType |p#Z#0@0|)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |p#Z#0@0|) SnapTree.Node.Repr)) |Nodes#0@@1|)) (SnapTree.Node.NodeValid ($LS $LZ) reveal_SnapTree.Node.NodeValid $Heap@1 |p#Z#0@0|)) (and (<= (LitInt 0) |n#0@@1|) (< |n#0@@1| (|Seq#Length| |C#0@@1|)))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |p#Z#0@0|) SnapTree.Node.data))) (U_2_int ($Unbox intType (|Seq#Index| |C#0@@1| |n#0@@1|))))) (and (SnapTree.Iterator.R ($LS $LZ) reveal_SnapTree.Iterator.R $Heap@1 |rest#Z#0@0| (+ (+ |n#0@@1| 1) (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |p#Z#0@0|) SnapTree.Node.right)) null) 0 (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |p#Z#0@0|) SnapTree.Node.right))) SnapTree.Node.Contents))))) |C#0@@1| |Nodes#0@@1|) (and (<= (|Seq#Length| (|Seq#Drop| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |p#Z#0@0|) SnapTree.Node.Contents)) (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |p#Z#0@0|) SnapTree.Node.left)) null) 0 (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |p#Z#0@0|) SnapTree.Node.left))) SnapTree.Node.Contents)))))) (|Seq#Length| (|Seq#Drop| |C#0@@1| |n#0@@1|))) (|Seq#SameUntil| (|Seq#Drop| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |p#Z#0@0|) SnapTree.Node.Contents)) (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |p#Z#0@0|) SnapTree.Node.left)) null) 0 (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |p#Z#0@0|) SnapTree.Node.left))) SnapTree.Node.Contents))))) (|Seq#Drop| |C#0@@1| |n#0@@1|) (|Seq#Length| (|Seq#Drop| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |p#Z#0@0|) SnapTree.Node.Contents)) (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |p#Z#0@0|) SnapTree.Node.left)) null) 0 (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |p#Z#0@0|) SnapTree.Node.left))) SnapTree.Node.Contents))))))))))) (=> (and (=> (|Set#IsMember| |Nodes#0@@1| ($Box refType |p#Z#0@0|)) (=> (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |p#Z#0@0|) SnapTree.Node.Repr)) |Nodes#0@@1|) (and (|SnapTree.Node.NodeValid#canCall| $Heap@1 |p#Z#0@0|) (=> (SnapTree.Node.NodeValid ($LS $LZ) reveal_SnapTree.Node.NodeValid $Heap@1 |p#Z#0@0|) (=> (<= (LitInt 0) |n#0@@1|) (=> (< |n#0@@1| (|Seq#Length| |C#0@@1|)) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |p#Z#0@0|) SnapTree.Node.data))) (U_2_int ($Unbox intType (|Seq#Index| |C#0@@1| |n#0@@1|)))) (|SnapTree.Iterator.R#canCall| $Heap@1 |rest#Z#0@0| (+ (+ |n#0@@1| 1) (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |p#Z#0@0|) SnapTree.Node.right)) null) 0 (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |p#Z#0@0|) SnapTree.Node.right))) SnapTree.Node.Contents))))) |C#0@@1| |Nodes#0@@1|)))))))) ($Is boolType (bool_2_U (SnapTree.Iterator.R ($LS $LZ) reveal_SnapTree.Iterator.R $Heap@1 |wlist#0@@1| |n#0@@1| |C#0@@1| |Nodes#0@@1|)) TBool)) (and (=> (= (ControlFlow 0 16) (- 0 26)) |b$reqreads#0@1|) (=> |b$reqreads#0@1| (and (=> (= (ControlFlow 0 16) (- 0 25)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (and (=> (= (ControlFlow 0 16) (- 0 24)) |b$reqreads#2@1|) (=> |b$reqreads#2@1| (and (=> (= (ControlFlow 0 16) (- 0 23)) |b$reqreads#3@1|) (=> |b$reqreads#3@1| (and (=> (= (ControlFlow 0 16) (- 0 22)) |b$reqreads#4@2|) (=> |b$reqreads#4@2| (and (=> (= (ControlFlow 0 16) (- 0 21)) |b$reqreads#5@2|) (=> |b$reqreads#5@2| (and (=> (= (ControlFlow 0 16) (- 0 20)) |b$reqreads#6@1|) (=> |b$reqreads#6@1| (and (=> (= (ControlFlow 0 16) (- 0 19)) |b$reqreads#7@1|) (=> |b$reqreads#7@1| (and (=> (= (ControlFlow 0 16) (- 0 18)) |b$reqreads#8@1|) (=> |b$reqreads#8@1| (and (=> (= (ControlFlow 0 16) (- 0 17)) |b$reqreads#9@2|) (=> |b$reqreads#9@2| (=> (= (ControlFlow 0 16) (- 0 15)) |b$reqreads#10@2|)))))))))))))))))))))))))
(let ((anon22_correct  (and (=> (= (ControlFlow 0 29) (- 0 31)) (and (<= 0 (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.left)) null) 0 (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.left))) SnapTree.Node.Contents))))) (<= (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.left)) null) 0 (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.left))) SnapTree.Node.Contents)))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.Contents)))))) (=> (and (<= 0 (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.left)) null) 0 (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.left))) SnapTree.Node.Contents))))) (<= (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.left)) null) 0 (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.left))) SnapTree.Node.Contents)))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.Contents))))) (and (=> (= (ControlFlow 0 29) (- 0 30)) (and (<= 0 |n#0@@1|) (<= |n#0@@1| (|Seq#Length| |C#0@@1|)))) (=> (and (<= 0 |n#0@@1|) (<= |n#0@@1| (|Seq#Length| |C#0@@1|))) (=> (and (= |b$reqreads#3@1| |b$reqreads#3@0|) (= |b$reqreads#5@2| |b$reqreads#5@1|)) (=> (and (and (and (= |b$reqreads#4@2| |b$reqreads#4@1|) (= |b$reqreads#6@1| |b$reqreads#6@0|)) (and (= $Heap@1 $Heap@0) (= |b$reqreads#7@1| |b$reqreads#7@0|))) (and (and (= |b$reqreads#8@1| |b$reqreads#8@0|) (= |b$reqreads#10@2| |b$reqreads#10@1|)) (and (= |b$reqreads#9@2| |b$reqreads#9@1|) (= (ControlFlow 0 29) 16)))) anon23_correct))))))))
(let ((anon37_Else_correct  (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.left)) null)) (not true)) (and (=> (= (ControlFlow 0 33) (- 0 35)) (or (not (= |p#Z#0@0| null)) (not true))) (=> (or (not (= |p#Z#0@0| null)) (not true)) (=> (= |b$reqreads#9@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |p#Z#0@0| SnapTree.Node.left))) (and (=> (= (ControlFlow 0 33) (- 0 34)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.left)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.left)) null)) (not true)) (=> (and (and (= |b$reqreads#10@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.left)) SnapTree.Node.Contents))) (= |b$reqreads#9@1| |b$reqreads#9@0|)) (and (= |b$reqreads#10@1| |b$reqreads#10@0|) (= (ControlFlow 0 33) 29))) anon22_correct)))))))))
(let ((anon37_Then_correct  (=> (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.left)) null) (= |b$reqreads#9@1| true)) (and (= |b$reqreads#10@1| true) (= (ControlFlow 0 32) 29))) anon22_correct)))
(let ((anon36_Then_correct  (=> (SnapTree.Iterator.R ($LS $LZ) reveal_SnapTree.Iterator.R $Heap@0 |rest#Z#0@0| (+ (+ |n#0@@1| 1) (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.right)) null) 0 (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.right))) SnapTree.Node.Contents))))) |C#0@@1| |Nodes#0@@1|) (and (=> (= (ControlFlow 0 36) (- 0 38)) (or (not (= |p#Z#0@0| null)) (not true))) (=> (or (not (= |p#Z#0@0| null)) (not true)) (=> (= |b$reqreads#7@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |p#Z#0@0| SnapTree.Node.Contents))) (and (=> (= (ControlFlow 0 36) (- 0 37)) (or (not (= |p#Z#0@0| null)) (not true))) (=> (or (not (= |p#Z#0@0| null)) (not true)) (=> (= |b$reqreads#8@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |p#Z#0@0| SnapTree.Node.left))) (and (=> (= (ControlFlow 0 36) 32) anon37_Then_correct) (=> (= (ControlFlow 0 36) 33) anon37_Else_correct)))))))))))
(let ((anon36_Else_correct  (=> (not (SnapTree.Iterator.R ($LS $LZ) reveal_SnapTree.Iterator.R $Heap@0 |rest#Z#0@0| (+ (+ |n#0@@1| 1) (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.right)) null) 0 (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.right))) SnapTree.Node.Contents))))) |C#0@@1| |Nodes#0@@1|)) (=> (and (= |b$reqreads#3@1| |b$reqreads#3@0|) (= |b$reqreads#5@2| |b$reqreads#5@1|)) (=> (and (and (and (= |b$reqreads#4@2| |b$reqreads#4@1|) (= |b$reqreads#6@1| |b$reqreads#6@0|)) (and (= $Heap@1 $Heap@0) (= |b$reqreads#7@1| true))) (and (and (= |b$reqreads#8@1| true) (= |b$reqreads#10@2| true)) (and (= |b$reqreads#9@2| true) (= (ControlFlow 0 28) 16)))) anon23_correct)))))
(let ((anon18_correct  (=> (= |##n#0@0| (+ (+ |n#0@@1| 1) (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.right)) null) 0 (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.right))) SnapTree.Node.Contents)))))) (=> (and (and ($IsAlloc intType (int_2_U |##n#0@0|) TInt $Heap@0) ($IsAlloc SeqType |C#0@@1| (TSeq TInt) $Heap@0)) (and ($IsAlloc SetType |Nodes#0@@1| (TSet Tclass._System.object) $Heap@0) (= |b$reqreads#6@0| (forall (($o@@14 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@14) alloc)))) (|Set#IsMember| |Nodes#0@@1| ($Box refType $o@@14))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@14 $f@@0)))
 :qid |SnapshotableTreesdfy.524:10|
 :skolemid |1028|
))))) (and (=> (= (ControlFlow 0 39) (- 0 40)) (< (DtRank |rest#Z#0@0|) (DtRank |wlist#0@@1|))) (=> (< (DtRank |rest#Z#0@0|) (DtRank |wlist#0@@1|)) (=> (|SnapTree.Iterator.R#canCall| $Heap@0 |rest#Z#0@0| (+ (+ |n#0@@1| 1) (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.right)) null) 0 (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.right))) SnapTree.Node.Contents))))) |C#0@@1| |Nodes#0@@1|) (and (=> (= (ControlFlow 0 39) 36) anon36_Then_correct) (=> (= (ControlFlow 0 39) 28) anon36_Else_correct)))))))))
(let ((anon35_Else_correct  (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.right)) null)) (not true)) (and (=> (= (ControlFlow 0 42) (- 0 44)) (or (not (= |p#Z#0@0| null)) (not true))) (=> (or (not (= |p#Z#0@0| null)) (not true)) (=> (= |b$reqreads#4@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |p#Z#0@0| SnapTree.Node.right))) (and (=> (= (ControlFlow 0 42) (- 0 43)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.right)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.right)) null)) (not true)) (=> (and (and (= |b$reqreads#5@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.right)) SnapTree.Node.Contents))) (= |b$reqreads#4@1| |b$reqreads#4@0|)) (and (= |b$reqreads#5@1| |b$reqreads#5@0|) (= (ControlFlow 0 42) 39))) anon18_correct)))))))))
(let ((anon35_Then_correct  (=> (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#Z#0@0|) SnapTree.Node.right)) null) (= |b$reqreads#4@1| true)) (and (= |b$reqreads#5@1| true) (= (ControlFlow 0 41) 39))) anon18_correct)))
(let ((anon34_Then_correct  (=> (and (and (and (and (and (|Set#IsMember| |Nodes#0@@1| ($Box refType |p#Z#0@0|)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#Z#0@0|) SnapTree.Node.Repr)) |Nodes#0@@1|)) (SnapTree.Node.NodeValid ($LS $LZ) reveal_SnapTree.Node.NodeValid $Heap@@7 |p#Z#0@0|)) (and (<= (LitInt 0) |n#0@@1|) (< |n#0@@1| (|Seq#Length| |C#0@@1|)))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#Z#0@0|) SnapTree.Node.data))) (U_2_int ($Unbox intType (|Seq#Index| |C#0@@1| |n#0@@1|))))) (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@7 $Heap@0)) (and reveal_SnapTree.Node.NodeValid ($IsAlloc DatatypeTypeType |rest#Z#0@0| Tclass.SnapTree.List $Heap@0)))) (and (=> (= (ControlFlow 0 45) (- 0 46)) (or (not (= |p#Z#0@0| null)) (not true))) (=> (or (not (= |p#Z#0@0| null)) (not true)) (=> (= |b$reqreads#3@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |p#Z#0@0| SnapTree.Node.right))) (and (=> (= (ControlFlow 0 45) 41) anon35_Then_correct) (=> (= (ControlFlow 0 45) 42) anon35_Else_correct))))))))
(let ((anon34_Else_correct  (=> (not (and (and (and (and (|Set#IsMember| |Nodes#0@@1| ($Box refType |p#Z#0@0|)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#Z#0@0|) SnapTree.Node.Repr)) |Nodes#0@@1|)) (SnapTree.Node.NodeValid ($LS $LZ) reveal_SnapTree.Node.NodeValid $Heap@@7 |p#Z#0@0|)) (and (<= (LitInt 0) |n#0@@1|) (< |n#0@@1| (|Seq#Length| |C#0@@1|)))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#Z#0@0|) SnapTree.Node.data))) (U_2_int ($Unbox intType (|Seq#Index| |C#0@@1| |n#0@@1|)))))) (=> (and (= |b$reqreads#3@1| true) (= |b$reqreads#5@2| true)) (=> (and (and (and (= |b$reqreads#4@2| true) (= |b$reqreads#6@1| true)) (and (= $Heap@1 $Heap@@7) (= |b$reqreads#7@1| true))) (and (and (= |b$reqreads#8@1| true) (= |b$reqreads#10@2| true)) (and (= |b$reqreads#9@2| true) (= (ControlFlow 0 27) 16)))) anon23_correct)))))
(let ((anon33_Else_correct  (=> (and (not (and (and (and (|Set#IsMember| |Nodes#0@@1| ($Box refType |p#Z#0@0|)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#Z#0@0|) SnapTree.Node.Repr)) |Nodes#0@@1|)) (SnapTree.Node.NodeValid ($LS $LZ) reveal_SnapTree.Node.NodeValid $Heap@@7 |p#Z#0@0|)) (and (<= (LitInt 0) |n#0@@1|) (< |n#0@@1| (|Seq#Length| |C#0@@1|))))) (= |b$reqreads#2@1| true)) (and (=> (= (ControlFlow 0 50) 45) anon34_Then_correct) (=> (= (ControlFlow 0 50) 27) anon34_Else_correct)))))
(let ((anon33_Then_correct  (=> (and (and (and (|Set#IsMember| |Nodes#0@@1| ($Box refType |p#Z#0@0|)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#Z#0@0|) SnapTree.Node.Repr)) |Nodes#0@@1|)) (SnapTree.Node.NodeValid ($LS $LZ) reveal_SnapTree.Node.NodeValid $Heap@@7 |p#Z#0@0|)) (and (<= (LitInt 0) |n#0@@1|) (< |n#0@@1| (|Seq#Length| |C#0@@1|)))) (and (=> (= (ControlFlow 0 47) (- 0 49)) (or (not (= |p#Z#0@0| null)) (not true))) (=> (or (not (= |p#Z#0@0| null)) (not true)) (=> (= |b$reqreads#2@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |p#Z#0@0| SnapTree.Node.data))) (and (=> (= (ControlFlow 0 47) (- 0 48)) (and (<= 0 |n#0@@1|) (< |n#0@@1| (|Seq#Length| |C#0@@1|)))) (=> (and (<= 0 |n#0@@1|) (< |n#0@@1| (|Seq#Length| |C#0@@1|))) (=> (= |b$reqreads#2@1| |b$reqreads#2@0|) (and (=> (= (ControlFlow 0 47) 45) anon34_Then_correct) (=> (= (ControlFlow 0 47) 27) anon34_Else_correct)))))))))))
(let ((anon32_Else_correct  (=> (< |n#0@@1| (LitInt 0)) (and (=> (= (ControlFlow 0 53) 47) anon33_Then_correct) (=> (= (ControlFlow 0 53) 50) anon33_Else_correct)))))
(let ((anon32_Then_correct  (=> (<= (LitInt 0) |n#0@@1|) (and (=> (= (ControlFlow 0 52) 47) anon33_Then_correct) (=> (= (ControlFlow 0 52) 50) anon33_Else_correct)))))
(let ((anon31_Then_correct  (=> (and (and (|Set#IsMember| |Nodes#0@@1| ($Box refType |p#Z#0@0|)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#Z#0@0|) SnapTree.Node.Repr)) |Nodes#0@@1|)) (SnapTree.Node.NodeValid ($LS $LZ) reveal_SnapTree.Node.NodeValid $Heap@@7 |p#Z#0@0|)) (and (=> (= (ControlFlow 0 54) 52) anon32_Then_correct) (=> (= (ControlFlow 0 54) 53) anon32_Else_correct)))))
(let ((anon31_Else_correct  (=> (not (and (and (|Set#IsMember| |Nodes#0@@1| ($Box refType |p#Z#0@0|)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#Z#0@0|) SnapTree.Node.Repr)) |Nodes#0@@1|)) (SnapTree.Node.NodeValid ($LS $LZ) reveal_SnapTree.Node.NodeValid $Heap@@7 |p#Z#0@0|))) (and (=> (= (ControlFlow 0 51) 47) anon33_Then_correct) (=> (= (ControlFlow 0 51) 50) anon33_Else_correct)))))
(let ((anon30_Else_correct  (=> (and (not (and (|Set#IsMember| |Nodes#0@@1| ($Box refType |p#Z#0@0|)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#Z#0@0|) SnapTree.Node.Repr)) |Nodes#0@@1|))) (= |b$reqreads#1@1| true)) (and (=> (= (ControlFlow 0 57) 54) anon31_Then_correct) (=> (= (ControlFlow 0 57) 51) anon31_Else_correct)))))
(let ((anon30_Then_correct  (=> (and (|Set#IsMember| |Nodes#0@@1| ($Box refType |p#Z#0@0|)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#Z#0@0|) SnapTree.Node.Repr)) |Nodes#0@@1|)) (and (=> (= (ControlFlow 0 55) (- 0 56)) (or (not (= |p#Z#0@0| null)) (not true))) (=> (or (not (= |p#Z#0@0| null)) (not true)) (=> (and (and ($IsAllocBox ($Box refType |p#Z#0@0|) Tclass.SnapTree.Node? $Heap@@7) (= |b$reqreads#1@0| (forall (($o@@15 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@15 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@15) alloc)))) (or (= $o@@15 |p#Z#0@0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#Z#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@15)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@15 $f@@1)))
 :qid |SnapshotableTreesdfy.521:44|
 :skolemid |1026|
)))) (and (|SnapTree.Node.NodeValid#canCall| $Heap@@7 |p#Z#0@0|) (= |b$reqreads#1@1| |b$reqreads#1@0|))) (and (=> (= (ControlFlow 0 55) 54) anon31_Then_correct) (=> (= (ControlFlow 0 55) 51) anon31_Else_correct))))))))
(let ((anon29_Else_correct  (=> (and (not (|Set#IsMember| |Nodes#0@@1| ($Box refType |p#Z#0@0|))) (= |b$reqreads#0@1| true)) (and (=> (= (ControlFlow 0 60) 55) anon30_Then_correct) (=> (= (ControlFlow 0 60) 57) anon30_Else_correct)))))
(let ((anon29_Then_correct  (=> (|Set#IsMember| |Nodes#0@@1| ($Box refType |p#Z#0@0|)) (and (=> (= (ControlFlow 0 58) (- 0 59)) (or (not (= |p#Z#0@0| null)) (not true))) (=> (or (not (= |p#Z#0@0| null)) (not true)) (=> (and (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |p#Z#0@0| SnapTree.Node.Repr))) (= |b$reqreads#0@1| |b$reqreads#0@0|)) (and (=> (= (ControlFlow 0 58) 55) anon30_Then_correct) (=> (= (ControlFlow 0 58) 57) anon30_Else_correct))))))))
(let ((anon28_Then_correct  (=> (= |wlist#0@@1| (|#SnapTree.List.Cons| |_mcc#0#0| |_mcc#1#0|)) (=> (and (and (and ($Is refType |_mcc#0#0| Tclass.SnapTree.Node) ($Is DatatypeTypeType |_mcc#1#0| Tclass.SnapTree.List)) (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| Tclass.SnapTree.List))) (and (and (= |rest#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|)) (and ($Is refType |let#1#0#0| Tclass.SnapTree.Node) (= |p#Z#0@0| |let#1#0#0|)))) (and (=> (= (ControlFlow 0 61) 58) anon29_Then_correct) (=> (= (ControlFlow 0 61) 60) anon29_Else_correct))))))
(let ((anon28_Else_correct true))
(let ((anon27_Else_correct  (=> (or (not (= |wlist#0@@1| |#SnapTree.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 62) 61) anon28_Then_correct) (=> (= (ControlFlow 0 62) 14) anon28_Else_correct)))))
(let ((anon27_Then_correct  (=> (= |wlist#0@@1| |#SnapTree.List.Nil|) (=> (and (= (SnapTree.Iterator.R ($LS $LZ) reveal_SnapTree.Iterator.R $Heap@@7 |wlist#0@@1| |n#0@@1| |C#0@@1| |Nodes#0@@1|) (= |n#0@@1| (|Seq#Length| |C#0@@1|))) ($Is boolType (bool_2_U (SnapTree.Iterator.R ($LS $LZ) reveal_SnapTree.Iterator.R $Heap@@7 |wlist#0@@1| |n#0@@1| |C#0@@1| |Nodes#0@@1|)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 13)) true) (and (=> (= (ControlFlow 0 3) (- 0 12)) true) (and (=> (= (ControlFlow 0 3) (- 0 11)) true) (and (=> (= (ControlFlow 0 3) (- 0 10)) true) (and (=> (= (ControlFlow 0 3) (- 0 9)) true) (and (=> (= (ControlFlow 0 3) (- 0 8)) true) (and (=> (= (ControlFlow 0 3) (- 0 7)) true) (and (=> (= (ControlFlow 0 3) (- 0 6)) true) (and (=> (= (ControlFlow 0 3) (- 0 5)) true) (and (=> (= (ControlFlow 0 3) (- 0 4)) true) (=> (= (ControlFlow 0 3) (- 0 2)) true)))))))))))))))
(let ((anon26_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#9| null $Heap@@7 alloc |Nodes#0@@1|)) (and (and (=> (= (ControlFlow 0 63) 1) anon26_Then_correct) (=> (= (ControlFlow 0 63) 3) anon27_Then_correct)) (=> (= (ControlFlow 0 63) 62) anon27_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@7) ($IsHeapAnchor $Heap@@7)) ($Is DatatypeTypeType |wlist#0@@1| Tclass.SnapTree.List)) (and (and ($Is SeqType |C#0@@1| (TSeq TInt)) ($Is SetType |Nodes#0@@1| (TSet Tclass._System.object))) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 64) 63)))) anon0_correct)))
