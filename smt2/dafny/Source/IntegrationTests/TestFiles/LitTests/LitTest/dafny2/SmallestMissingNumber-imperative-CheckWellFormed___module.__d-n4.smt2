...
(let ((anon9_correct  (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (_System.array.Length |a#0@@0|))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (not (= |a#0@@0| null)) (not true))) (=> (or (not (= |a#0@@0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array.Length |a#0@@0|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array.Length |a#0@@0|))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= |a#0@@0| null)) (not true))) (=> (or (not (= |a#0@@0| null)) (not true)) (=> (and (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0@@0|) (IndexField |i#0@0|)))) (_System.array.Length |a#0@@0|)) (= (ControlFlow 0 3) 1)) anon11_correct))))))))))
(let ((anon15_Else_correct  (=> (and (< |i#0@0| (LitInt 0)) (= (ControlFlow 0 9) 3)) anon9_correct)))
(let ((anon15_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (not (= |a#0@@0| null)) (not true))) (=> (or (not (= |a#0@@0| null)) (not true)) (=> (= (ControlFlow 0 7) 3) anon9_correct))))))
(let ((anon14_Else_correct  (=> (and (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (_System.array.Length |a#0@@0|))) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0@@0|) (IndexField |i#0@0|)))) (_System.array.Length |a#0@@0|))) (= (ControlFlow 0 2) 1)) anon11_correct)))
(let ((anon6_correct  (=> (forall ((|x#1| T@U) ) (!  (=> (and (<= (LitInt 0) (U_2_int |x#1|)) (< (U_2_int |x#1|) (_System.array.Length |a#0@@0|))) (_module.__default.Has Tclass._System.nat $Heap@@0 |a#0@@0| ($Box intType |x#1|)))
...
)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@0 $Heap@0)) (and (and (=> (= (ControlFlow 0 10) 2) anon14_Else_correct) (=> (= (ControlFlow 0 10) 7) anon15_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon15_Else_correct))))))
(let ((anon4_correct  (=> (and (and (<= (LitInt 0) |x#0@0|) (< |x#0@0| (_System.array.Length |a#0@@0|))) ($IsAlloc refType |a#0@@0| (Tclass._System.array Tclass._System.nat) $Heap@@0)) (and (=> (= (ControlFlow 0 12) (- 0 13)) ($Is intType (int_2_U |x#0@0|) Tclass._System.nat)) (=> ($Is intType (int_2_U |x#0@0|) Tclass._System.nat) (=> (and (and ($IsAlloc intType (int_2_U |x#0@0|) Tclass._System.nat $Heap@@0) (|_module.__default.Has#canCall| Tclass._System.nat $Heap@@0 |a#0@@0| ($Box intType (int_2_U |x#0@0|)))) (and (_module.__default.Has Tclass._System.nat $Heap@@0 |a#0@@0| ($Box intType (int_2_U |x#0@0|))) (= (ControlFlow 0 12) 10))) anon6_correct))))))
(let ((anon13_Else_correct  (=> (and (< |x#0@0| (LitInt 0)) (= (ControlFlow 0 16) 12)) anon4_correct)))
(let ((anon13_Then_correct  (=> (<= (LitInt 0) |x#0@0|) (and (=> (= (ControlFlow 0 14) (- 0 15)) (or (not (= |a#0@@0| null)) (not true))) (=> (or (not (= |a#0@@0| null)) (not true)) (=> (= (ControlFlow 0 14) 12) anon4_correct))))))
(let ((anon12_Else_correct  (=> (and (=> (and (<= (LitInt 0) |x#0@0|) (< |x#0@0| (_System.array.Length |a#0@@0|))) (_module.__default.Has Tclass._System.nat $Heap@@0 |a#0@@0| ($Box intType (int_2_U |x#0@0|)))) (= (ControlFlow 0 11) 10)) anon6_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (and (and (=> (= (ControlFlow 0 17) 11) anon12_Else_correct) (=> (= (ControlFlow 0 17) 14) anon13_Then_correct)) (=> (= (ControlFlow 0 17) 16) anon13_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is refType |a#0@@0| (Tclass._System.array Tclass._System.nat)) ($IsAlloc refType |a#0@@0| (Tclass._System.array Tclass._System.nat) $Heap@@0)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 18) 17))) anon0_correct))))
