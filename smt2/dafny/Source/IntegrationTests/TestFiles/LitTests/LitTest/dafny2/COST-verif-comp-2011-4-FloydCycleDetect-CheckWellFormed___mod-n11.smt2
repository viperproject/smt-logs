...
(set-info :boogie-vc-id CheckWellFormed$$_module.Node.Lemma__NexxxtIsTransitive)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon4_Else_correct true))
(let ((anon4_Then_correct  (=> ($IsAllocBox ($Box refType this@@4) Tclass._module.Node? $Heap@0) (=> (and ($IsAlloc intType (int_2_U |x#0|) TInt $Heap@0) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Node?) $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 18)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType this@@4))))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType null))))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (forall ((|n#0@@0| T@U) ) (!  (=> ($Is refType |n#0@@0| Tclass._module.Node?) (=> (and (and (|Set#IsMember| |S#0@@4| ($Box refType |n#0@@0|)) (or (not (= |n#0@@0| null)) (not true))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0@@0|) _module.Node.next)) null)) (not true))) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0@@0|) _module.Node.next))))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.133:12|
 :skolemid |777|
...
))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (<= (LitInt 0) |x#0|)) (=> (and (and (and (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (<= (LitInt 0) |x#0|)) (|_module.Node.Nexxxt#canCall| $Heap@0 this@@4 |x#0| |S#0@@4|)) (and (and (or (not (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) null)) (not true)) ($IsAllocBox ($Box refType this@@4) Tclass._module.Node? $Heap@0)) (and ($IsAlloc intType (int_2_U |x#0|) TInt $Heap@0) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Node?) $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType this@@4))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType null))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (forall ((|n#1| T@U) ) (!  (=> ($Is refType |n#1| Tclass._module.Node?) (=> (and (and (|Set#IsMember| |S#0@@4| ($Box refType |n#1|)) (or (not (= |n#1| null)) (not true))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#1|) _module.Node.next)) null)) (not true))) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#1|) _module.Node.next))))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.133:12|
 :skolemid |779|
...
))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (<= (LitInt 0) |x#0|)) (=> (and (and (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (<= (LitInt 0) |x#0|)) (|_module.Node.Nexxxt#canCall| $Heap@0 this@@4 |x#0| |S#0@@4|)) (and (=> (= (ControlFlow 0 2) (- 0 10)) (or (not (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) null)) (not true))) (=> (or (not (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) null)) (not true)) (=> ($IsAllocBox ($Box refType (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|)) Tclass._module.Node? $Heap@0) (=> (and ($IsAlloc intType (int_2_U |y#0|) TInt $Heap@0) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Node?) $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 |x#0| |S#0@@4|)))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType null))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) |S#0@@4|) (forall ((|n#2| T@U) ) (!  (=> ($Is refType |n#2| Tclass._module.Node?) (=> (and (and (|Set#IsMember| |S#0@@4| ($Box refType |n#2|)) (or (not (= |n#2| null)) (not true))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#2|) _module.Node.next)) null)) (not true))) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#2|) _module.Node.next))))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.133:12|
 :skolemid |781|
...
))))) (=> (= (ControlFlow 0 2) (- 0 1)) (<= (LitInt 0) |##k#3@0|))))))))))))))))))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#3| null $Heap@@4 alloc false)) (=> (and ($IsAllocBox ($Box refType this@@4) Tclass._module.Node? $Heap@@4) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Node?) $Heap@@4)) (=> (and (and (and (|_module.Node.IsClosed#canCall| $Heap@@4 this@@4 |S#0@@4|) (_module.Node.IsClosed $Heap@@4 this@@4 |S#0@@4|)) (and (<= (LitInt 0) |x#0|) (<= (LitInt 0) |y#0|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@4 $Heap@0))) (and (=> (= (ControlFlow 0 20) 2) anon4_Then_correct) (=> (= (ControlFlow 0 20) 19) anon4_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.Node) ($IsAlloc refType this@@4 Tclass._module.Node $Heap@@4)))) (and (and ($Is SetType |S#0@@4| (TSet Tclass._module.Node?)) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Node?) $Heap@@4)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 21) 20)))) anon0_correct)))
