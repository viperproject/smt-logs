...
(declare-fun |SnapTree.List#Equal| (T@U T@U) Bool)
...
(assert (forall ((a@@2 T@U) (b T@U) ) (! (= (|SnapTree.List#Equal| a@@2 b) (= a@@2 b))
 :qid |unknown.0:0|
 :skolemid |659|
 :pattern ( (|SnapTree.List#Equal| a@@2 b))
)))
...
(assert (forall ((a@@3 T@U) (b@@0 T@U) ) (!  (=> (and (SnapTree.List.Cons_q a@@3) (SnapTree.List.Cons_q b@@0)) (= (|SnapTree.List#Equal| a@@3 b@@0)  (and (= (SnapTree.List._h0 a@@3) (SnapTree.List._h0 b@@0)) (|SnapTree.List#Equal| (SnapTree.List._h1 a@@3) (SnapTree.List._h1 b@@0)))))
 :qid |unknown.0:0|
 :skolemid |658|
 :pattern ( (|SnapTree.List#Equal| a@@3 b@@0) (SnapTree.List.Cons_q a@@3))
 :pattern ( (|SnapTree.List#Equal| a@@3 b@@0) (SnapTree.List.Cons_q b@@0))
)))
...
(assert (forall ((a@@5 T@U) (b@@2 T@U) ) (! (= (|Set#Disjoint| a@@5 b@@2) (forall ((o@@3 T@U) ) (!  (or (not (|Set#IsMember| a@@5 o@@3)) (not (|Set#IsMember| b@@2 o@@3)))
...
(assert (forall ((a@@7 T@U) (b@@4 T@U) ) (!  (=> (|Seq#Equal| a@@7 b@@4) (= a@@7 b@@4))
 :qid |DafnyPreludebpl.1225:15|
 :skolemid |241|
 :pattern ( (|Seq#Equal| a@@7 b@@4))
)))
...
(assert (forall ((a@@9 T@U) (b@@6 T@U) ) (!  (=> (and (SnapTree.List.Nil_q a@@9) (SnapTree.List.Nil_q b@@6)) (|SnapTree.List#Equal| a@@9 b@@6))
 :qid |unknown.0:0|
 :skolemid |657|
 :pattern ( (|SnapTree.List#Equal| a@@9 b@@6) (SnapTree.List.Nil_q a@@9))
 :pattern ( (|SnapTree.List#Equal| a@@9 b@@6) (SnapTree.List.Nil_q b@@6))
)))
...
(assert (forall ((d@@5 T@U) ($h@@43 T@U) ) (!  (=> (and ($IsGoodHeap $h@@43) (and (SnapTree.List.Cons_q d@@5) ($IsAlloc DatatypeTypeType d@@5 Tclass.SnapTree.List $h@@43))) ($IsAlloc refType (SnapTree.List._h0 d@@5) Tclass.SnapTree.Node $h@@43))
 :qid |unknown.0:0|
 :skolemid |649|
 :pattern ( ($IsAlloc refType (SnapTree.List._h0 d@@5) Tclass.SnapTree.Node $h@@43))
)))
(assert (forall ((d@@6 T@U) ($h@@44 T@U) ) (!  (=> (and ($IsGoodHeap $h@@44) (and (SnapTree.List.Cons_q d@@6) ($IsAlloc DatatypeTypeType d@@6 Tclass.SnapTree.List $h@@44))) ($IsAlloc DatatypeTypeType (SnapTree.List._h1 d@@6) Tclass.SnapTree.List $h@@44))
 :qid |unknown.0:0|
 :skolemid |650|
 :pattern ( ($IsAlloc DatatypeTypeType (SnapTree.List._h1 d@@6) Tclass.SnapTree.List $h@@44))
)))
...
(declare-fun |hasCurrent#0@5| () Bool)
(declare-fun |hasCurrent#0@4| () Bool)
(declare-fun $Heap@14 () T@U)
(declare-fun this@@9 () T@U)
(declare-fun $Heap@@11 () T@U)
(declare-fun $Heap@11 () T@U)
(declare-fun |hasCurrent#0@3| () Bool)
(declare-fun $Heap@10 () T@U)
(declare-fun |hasCurrent#0@2| () Bool)
...
(declare-fun |hasCurrent#0@1| () Bool)
(declare-fun |$rhs#0_0@0| () Bool)
(declare-fun |$rhs#0_1@0| () Int)
(declare-fun $Heap@1 () T@U)
(declare-fun $Heap@2 () T@U)
(declare-fun |hasCurrent#0@0| () Bool)
(set-info :boogie-vc-id Impl$$SnapTree.Iterator.MoveNext_split5)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon10_correct  (=> (and (and ($IsGoodHeap $Heap@13) ($IsHeapAnchor $Heap@13)) (= $Heap@12 $Heap@13)) (=> (and (and (and reveal_SnapTree.Iterator.R (= |hasCurrent#0@5| |hasCurrent#0@4|)) (and (= $Heap@14 $Heap@13) (SnapTree.Iterator.Valid reveal_SnapTree.Iterator.Valid $Heap@14 this@@9))) (and (and (forall (($o@@48 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 this@@9) SnapTree.Iterator.IterRepr)) ($Box refType $o@@48)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@9) SnapTree.Iterator.IterRepr)) ($Box refType $o@@48)))) (or (not (= $o@@48 null)) (not true)))
 :qid |SnapshotableTreesdfy.613:26|
 :skolemid |1091|
 :pattern (  (or (not (= $o@@48 null)) (not true)))
)) (forall (($o@@49 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 this@@9) SnapTree.Iterator.IterRepr)) ($Box refType $o@@49)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@9) SnapTree.Iterator.IterRepr)) ($Box refType $o@@49)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 $o@@49) alloc)))))
 :qid |SnapshotableTreesdfy.613:26|
 :skolemid |1092|
...
))) (= (ControlFlow 0 2) (- 0 1)))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 this@@9) SnapTree.Iterator.T))) SnapTree.Tree.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@9) SnapTree.Iterator.T))) SnapTree.Tree.Repr)))))))
(let ((anon9_correct  (=> (= $Heap@12 $Heap@11) (=> (and (= |hasCurrent#0@4| |hasCurrent#0@3|) (= (ControlFlow 0 4) 2)) anon10_correct))))
(let ((anon7_correct  (=> (|$IsA#SnapTree.List| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@9) SnapTree.Iterator.stack))) (=> (and (and (= |hasCurrent#0@2|  (not (|SnapTree.List#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@9) SnapTree.Iterator.stack)) |#SnapTree.List.Nil|))) (= $Heap@11 $Heap@10)) (and (= |hasCurrent#0@3| |hasCurrent#0@2|) (= (ControlFlow 0 6) 4))) anon9_correct))))
(let ((anon14_Else_correct  (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |p#1_0_0@0|) SnapTree.Node.right)) null) (=> (and (= $Heap@10 $Heap@5) (= (ControlFlow 0 8) 6)) anon7_correct))))
(let ((anon14_Then_correct  (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |p#1_0_0@0|) SnapTree.Node.right)) null)) (not true)) (=> (and (and ($IsGoodHeap $Heap@6) ($IsHeapAnchor $Heap@6)) (and (= $Heap@5 $Heap@6) reveal_SnapTree.Iterator.R)) (=> (and (and (and ($IsGoodHeap $Heap@7) ($IsHeapAnchor $Heap@7)) (and (= $Heap@6 $Heap@7) reveal_SnapTree.Node.NodeValid)) (and (and (<= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |p#1_0_0@0|) SnapTree.Node.right))) SnapTree.Node.Contents))) (|Seq#Length| (|Seq#Drop| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@9) SnapTree.Iterator.Contents)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@9) SnapTree.Iterator.N)))))) (|Seq#SameUntil| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |p#1_0_0@0|) SnapTree.Node.right))) SnapTree.Node.Contents)) (|Seq#Drop| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@9) SnapTree.Iterator.Contents)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@9) SnapTree.Iterator.N)))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |p#1_0_0@0|) SnapTree.Node.right))) SnapTree.Node.Contents))))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@9 SnapTree.Iterator.stack)))) (=> (and (and (and (and (and (= |stIn##1_0_0_0@0| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@9) SnapTree.Iterator.stack))) (= |n##1_0_0_0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@9) SnapTree.Iterator.N))))) (and (or (not (= |p#1_0_0@0| null)) (not true)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |p#1_0_0@0|) SnapTree.Node.right)) Tclass.SnapTree.Node))) (and (and (= |p##1_0_0_0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |p#1_0_0@0|) SnapTree.Node.right))) (= |C##1_0_0_0@0| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@9) SnapTree.Iterator.Contents)))) (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@9) SnapTree.Iterator.T)) null)) (not true)) (= |Nodes##1_0_0_0@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@9) SnapTree.Iterator.T))) SnapTree.Tree.Repr)))))) (and (and (and ($Is DatatypeTypeType |call6formal@st#0| Tclass.SnapTree.List) ($IsAlloc DatatypeTypeType |call6formal@st#0| Tclass.SnapTree.List $Heap@@11)) (|Set#IsMember| |Nodes##1_0_0_0@0| ($Box refType |p##1_0_0_0@0|))) (and (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |p##1_0_0_0@0|) SnapTree.Node.Repr)) |Nodes##1_0_0_0@0|) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@7 |p##1_0_0_0@0|)) (and (<= (LitInt 0) |n##1_0_0_0@0|) (<= |n##1_0_0_0@0| (|Seq#Length| |C##1_0_0_0@0|)))))) (and (and (and (and (<= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |p##1_0_0_0@0|) SnapTree.Node.Contents))) (|Seq#Length| (|Seq#Drop| |C##1_0_0_0@0| |n##1_0_0_0@0|))) (|Seq#SameUntil| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |p##1_0_0_0@0|) SnapTree.Node.Contents)) (|Seq#Drop| |C##1_0_0_0@0| |n##1_0_0_0@0|) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |p##1_0_0_0@0|) SnapTree.Node.Contents))))) (SnapTree.Iterator.R ($LS ($LS $LZ)) reveal_SnapTree.Iterator.R $Heap@7 |stIn##1_0_0_0@0| (+ |n##1_0_0_0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |p##1_0_0_0@0|) SnapTree.Node.Contents)))) |C##1_0_0_0@0| |Nodes##1_0_0_0@0|)) (and (and ($IsGoodHeap $Heap@8) ($IsHeapAnchor $Heap@8)) (and ($Is DatatypeTypeType |call6formal@st#0@0| Tclass.SnapTree.List) ($IsAlloc DatatypeTypeType |call6formal@st#0@0| Tclass.SnapTree.List $Heap@8)))) (and (and (and (|SnapTree.Iterator.R#canCall| $Heap@8 |call6formal@st#0@0| |n##1_0_0_0@0| |C##1_0_0_0@0| |Nodes##1_0_0_0@0|) (SnapTree.Iterator.R ($LS ($LS $LZ)) reveal_SnapTree.Iterator.R $Heap@8 |call6formal@st#0@0| |n##1_0_0_0@0| |C##1_0_0_0@0| |Nodes##1_0_0_0@0|)) (and (forall (($o@@50 T@U) ) (!  (=> (and (or (not (= $o@@50 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@50) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@50) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@50)))
 :qid |SnapshotableTreesdfy.583:41|
 :skolemid |1071|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@50))
)) ($HeapSucc $Heap@7 $Heap@8))) (and (and (= $Heap@9 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@8 this@@9 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@9) SnapTree.Iterator.stack ($Box DatatypeTypeType |call6formal@st#0@0|)))) ($IsGoodHeap $Heap@9)) (and (= $Heap@10 $Heap@9) (= (ControlFlow 0 7) 6)))))) anon7_correct))))))
(let ((anon12_Else_correct  (=> (and (or (not (= ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@9) SnapTree.Iterator.stack)) |#SnapTree.List.Nil|)) (not true)) (= ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@9) SnapTree.Iterator.stack)) (|#SnapTree.List.Cons| |_mcc#0#1_0_0@0| |_mcc#1#1_0_0@0|))) (=> (and (and ($Is refType |_mcc#0#1_0_0@0| Tclass.SnapTree.Node) ($IsAlloc refType |_mcc#0#1_0_0@0| Tclass.SnapTree.Node $Heap@0)) (and ($Is DatatypeTypeType |_mcc#1#1_0_0@0| Tclass.SnapTree.List) ($IsAlloc DatatypeTypeType |_mcc#1#1_0_0@0| Tclass.SnapTree.List $Heap@0))) (=> (and (and (and ($Is DatatypeTypeType |rest#1_0_0@0| Tclass.SnapTree.List) ($IsAlloc DatatypeTypeType |rest#1_0_0@0| Tclass.SnapTree.List $Heap@0)) (= |let#1_0_0#0#0| |_mcc#1#1_0_0@0|)) (and ($Is DatatypeTypeType |let#1_0_0#0#0| Tclass.SnapTree.List) (= |rest#1_0_0@0| |let#1_0_0#0#0|))) (=> (and (and (and (and (and ($Is refType |p#1_0_0@0| Tclass.SnapTree.Node) ($IsAlloc refType |p#1_0_0@0| Tclass.SnapTree.Node $Heap@0)) (= |let#1_0_1#0#0| |_mcc#0#1_0_0@0|)) (and ($Is refType |let#1_0_1#0#0| Tclass.SnapTree.Node) (= |p#1_0_0@0| |let#1_0_1#0#0|))) (and (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (and (= $Heap@0 $Heap@3) reveal_SnapTree.Node.NodeValid))) (and (and (and (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@9 SnapTree.Iterator.stack)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@9 SnapTree.Iterator.N))) (and (= |$rhs#1_0_1@0| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@9) SnapTree.Iterator.N))) 1)) (= $Heap@4 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@3 this@@9 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@9) SnapTree.Iterator.stack ($Box DatatypeTypeType |rest#1_0_0@0|)))))) (and (and ($IsGoodHeap $Heap@4) (= $Heap@5 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@4 this@@9 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@9) SnapTree.Iterator.N ($Box intType (int_2_U |$rhs#1_0_1@0|)))))) (and ($IsGoodHeap $Heap@5) (or (not (= |p#1_0_0@0| null)) (not true)))))) (and (=> (= (ControlFlow 0 9) 7) anon14_Then_correct) (=> (= (ControlFlow 0 9) 8) anon14_Else_correct))))))))
(let ((anon12_Then_correct  (=> (= ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@9) SnapTree.Iterator.stack)) |#SnapTree.List.Nil|) (=> (and (and (= |hasCurrent#0@1| (U_2_bool (Lit boolType (bool_2_U false)))) (= $Heap@11 $Heap@0)) (and (= |hasCurrent#0@3| |hasCurrent#0@1|) (= (ControlFlow 0 5) 4))) anon9_correct))))
(let ((anon11_Else_correct  (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@9) SnapTree.Iterator.initialized))) (and (=> (= (ControlFlow 0 10) 5) anon12_Then_correct) (=> (= (ControlFlow 0 10) 9) anon12_Else_correct)))))
(let ((anon11_Then_correct  (=> (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@9) SnapTree.Iterator.initialized)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@9 SnapTree.Iterator.initialized))) (=> (and (and (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@9 SnapTree.Iterator.N)) (= |$rhs#0_0@0| (U_2_bool (Lit boolType (bool_2_U true))))) (and (= |$rhs#0_1@0| (LitInt 0)) (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 this@@9 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@9) SnapTree.Iterator.initialized ($Box boolType (bool_2_U |$rhs#0_0@0|))))))) (=> (and (and (and ($IsGoodHeap $Heap@1) (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 this@@9 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@9) SnapTree.Iterator.N ($Box intType (int_2_U |$rhs#0_1@0|)))))) (and ($IsGoodHeap $Heap@2) (|$IsA#SnapTree.List| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@9) SnapTree.Iterator.stack))))) (and (and (= |hasCurrent#0@0|  (not (|SnapTree.List#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@9) SnapTree.Iterator.stack)) |#SnapTree.List.Nil|))) (= $Heap@12 $Heap@2)) (and (= |hasCurrent#0@4| |hasCurrent#0@0|) (= (ControlFlow 0 3) 2)))) anon10_correct)))))
(let ((anon0_correct  (=> (and (and ($IsGoodHeap $Heap@@11) ($IsHeapAnchor $Heap@@11)) (and (or (not (= this@@9 null)) (not true)) (and ($Is refType this@@9 Tclass.SnapTree.Iterator) ($IsAlloc refType this@@9 Tclass.SnapTree.Iterator $Heap@@11)))) (=> (and (and (and (= 6 $FunctionContextHeight) (SnapTree.Iterator.Valid reveal_SnapTree.Iterator.Valid $Heap@@11 this@@9)) (and (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@9) SnapTree.Iterator.N))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@9) SnapTree.Iterator.Contents)))) (= $_ModifiesFrame@0 (|lambda#9| null $Heap@@11 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@9) SnapTree.Iterator.IterRepr)))))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@11 $Heap@0) reveal_SnapTree.Iterator.Valid))) (and (=> (= (ControlFlow 0 11) 3) anon11_Then_correct) (=> (= (ControlFlow 0 11) 10) anon11_Else_correct))))))
anon0_correct)))))))))))
))
(check-sat)
(get-info :rlimit)
