...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split178)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon121_Then_correct  (=> (and (<= (LitInt 0) |s#2@0|) (<= |s#2@0| (- |n#0@3| |W#0|))) (=> (and (and ($IsAlloc refType |a#0@@4| (Tclass._System.array TInt) $Heap@5) ($IsAlloc intType (int_2_U |s#2@0|) TInt $Heap@5)) (and ($IsAlloc intType (int_2_U |W#0|) TInt $Heap@5) (= (ControlFlow 0 2) (- 0 1)))) (<= (LitInt 1) |W#0|)))))
