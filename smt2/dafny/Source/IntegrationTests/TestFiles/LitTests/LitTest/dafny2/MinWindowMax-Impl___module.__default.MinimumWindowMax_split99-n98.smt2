...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split99)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon87_correct  (=> (and (= |lo##1_0@1| (+ (- |n#0@3| |W#0|) 1)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= $nw@0 null)) (not true)))))
