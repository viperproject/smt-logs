...
(assert (forall ((AbstractClient.S.Abs.StoreAndRetrieve$Thing T@U) ($h0 T@U) ($h1 T@U) (this T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this null)) (not true)) ($Is refType this (Tclass.AbstractClient.S.Abs.StoreAndRetrieve AbstractClient.S.Abs.StoreAndRetrieve$Thing)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o T@U) ($f T@U) )  (=> (and (or (not (= $o null)) (not true)) (or (= $o this) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h0 this) AbstractClient.S.Abs.StoreAndRetrieve.Repr)) ($Box refType $o)))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h0 $o) $f) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h1 $o) $f)))) (= (AbstractClient.S.Abs.StoreAndRetrieve.Valid AbstractClient.S.Abs.StoreAndRetrieve$Thing $h0 this) (AbstractClient.S.Abs.StoreAndRetrieve.Valid AbstractClient.S.Abs.StoreAndRetrieve$Thing $h1 this))))
...
(assert (forall ((AbstractClient.S.Abs.StoreAndRetrieve$Thing@@0 T@U) ($h0@@0 T@U) ($h1@@0 T@U) (this@@0 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 (Tclass.AbstractClient.S.Abs.StoreAndRetrieve AbstractClient.S.Abs.StoreAndRetrieve$Thing@@0)))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@0 T@U) ($f@@0 T@U) )  (=> (and (or (not (= $o@@0 null)) (not true)) (or (= $o@@0 this@@0) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h0@@0 this@@0) AbstractClient.S.Abs.StoreAndRetrieve.Repr)) ($Box refType $o@@0)))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h0@@0 $o@@0) $f@@0) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h1@@0 $o@@0) $f@@0)))) (= (AbstractClient.S.Abs.StoreAndRetrieve.Valid_k AbstractClient.S.Abs.StoreAndRetrieve$Thing@@0 $h0@@0 this@@0) (AbstractClient.S.Abs.StoreAndRetrieve.Valid_k AbstractClient.S.Abs.StoreAndRetrieve$Thing@@0 $h1@@0 this@@0))))
