...
(set-info :boogie-vc-id CheckWellFormed$$Implementation.BirthdayBook.AddBirthday)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc this@@2)) (=> (and (and ($IsAllocBox ($Box refType this@@2) Tclass.Implementation.BirthdayBook? $Heap@@1) (|Implementation.BirthdayBook.Valid#canCall| $Heap@@1 this@@2)) (and (Implementation.BirthdayBook.Valid $Heap@@1 this@@2) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) Implementation.BirthdayBook.known)) ($Box SeqType |name#0|))))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@11 T@U) ) (!  (=> (and (or (not (= $o@@11 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@11) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@11) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@11)) (= $o@@11 this@@2)))
 :qid |ZBirthdayBookdfy.174:12|
 :skolemid |1047|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@11))
))) (and (and ($HeapSucc $Heap@@1 $Heap@0) ($IsAllocBox ($Box refType this@@2) Tclass.Implementation.BirthdayBook? $Heap@0)) (and (|Implementation.BirthdayBook.Valid#canCall| $Heap@0 this@@2) (Implementation.BirthdayBook.Valid $Heap@0 this@@2)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType this@@2 Tclass.Implementation.BirthdayBook $Heap@@1)) (=> ($IsAlloc refType this@@2 Tclass.Implementation.BirthdayBook $Heap@@1) (=> (and (and (forall (($o@@12 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Implementation.BirthdayBook.Repr)) ($Box refType $o@@12)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) Implementation.BirthdayBook.Repr)) ($Box refType $o@@12)))) (or (not (= $o@@12 null)) (not true)))
...
))) (= (ControlFlow 0 2) (- 0 1))) ($IsAlloc refType this@@2 Tclass.Implementation.BirthdayBook $Heap@@1)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass.Implementation.BirthdayBook) ($IsAlloc refType this@@2 Tclass.Implementation.BirthdayBook $Heap@@1)))) (and (and ($Is SeqType |name#0| (TSeq TChar)) ($IsAlloc SeqType |name#0| (TSeq TChar) $Heap@@1)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct)))
