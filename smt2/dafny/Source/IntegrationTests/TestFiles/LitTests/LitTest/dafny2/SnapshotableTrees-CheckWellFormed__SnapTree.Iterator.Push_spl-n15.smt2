...
(assert (distinct TInt TagInt TagSet TagSeq alloc Tagclass._System.object? Tagclass._System.object |##SnapTree.List.Nil| Tagclass.SnapTree.List |##SnapTree.List.Cons| Tagclass.SnapTree.Node Tagclass.SnapTree.Node? tytagFamily$object tytagFamily$List tytagFamily$Node)
)
...
(assert (forall ((|c#0@@0| T@U) ($h@@1 T@U) ) (! (= ($IsAlloc refType |c#0@@0| Tclass.SnapTree.Node $h@@1) ($IsAlloc refType |c#0@@0| Tclass.SnapTree.Node? $h@@1))
 :qid |unknown.0:0|
 :skolemid |996|
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass.SnapTree.Node $h@@1))
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass.SnapTree.Node? $h@@1))
)))
...
(assert (forall ((bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 Tclass.SnapTree.List) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@2)) bx@@2) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@2) Tclass.SnapTree.List)))
 :qid |unknown.0:0|
 :skolemid |640|
 :pattern ( ($IsBox bx@@2 Tclass.SnapTree.List))
)))
...
(assert (forall ((d@@5 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (SnapTree.List.Cons_q d@@5) ($IsAlloc DatatypeTypeType d@@5 Tclass.SnapTree.List $h@@5))) ($IsAlloc refType (SnapTree.List._h0 d@@5) Tclass.SnapTree.Node $h@@5))
 :qid |unknown.0:0|
 :skolemid |649|
 :pattern ( ($IsAlloc refType (SnapTree.List._h0 d@@5) Tclass.SnapTree.Node $h@@5))
)))
(assert (forall ((d@@6 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (SnapTree.List.Cons_q d@@6) ($IsAlloc DatatypeTypeType d@@6 Tclass.SnapTree.List $h@@6))) ($IsAlloc DatatypeTypeType (SnapTree.List._h1 d@@6) Tclass.SnapTree.List $h@@6))
 :qid |unknown.0:0|
 :skolemid |650|
 :pattern ( ($IsAlloc DatatypeTypeType (SnapTree.List._h1 d@@6) Tclass.SnapTree.List $h@@6))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$SnapTree.Iterator.Push_split0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |stIn#0| Tclass.SnapTree.List) ($IsAlloc DatatypeTypeType |stIn#0| Tclass.SnapTree.List $Heap)) (|$IsA#SnapTree.List| |stIn#0|)) (and (and ($Is refType |p#0| Tclass.SnapTree.Node) ($IsAlloc refType |p#0| Tclass.SnapTree.Node $Heap)) (and ($Is SeqType |C#0| (TSeq TInt)) ($IsAlloc SeqType |C#0| (TSeq TInt) $Heap)))) (and (and (and ($Is SetType |Nodes#0| (TSet Tclass._System.object)) ($IsAlloc SetType |Nodes#0| (TSet Tclass._System.object) $Heap)) (and ($Is DatatypeTypeType |st#0| Tclass.SnapTree.List) ($IsAlloc DatatypeTypeType |st#0| Tclass.SnapTree.List $Heap))) (and (and (= 5 $FunctionContextHeight) (= $_ModifiesFrame@0 (|lambda#1| null $Heap alloc false))) (and (|Set#IsMember| |Nodes#0| ($Box refType |p#0|)) (= (ControlFlow 0 2) (- 0 1)))))) (or (not (= |p#0| null)) (not true))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
