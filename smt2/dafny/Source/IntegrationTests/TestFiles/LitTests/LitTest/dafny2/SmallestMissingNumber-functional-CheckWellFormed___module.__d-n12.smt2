...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.Elements$_T0@@2 T@U) ($ly@@12 T@U) (|xs#0@@12| T@U) ) (!  (=> (and (or (|_module.__default.Elements#canCall| _module._default.Elements$_T0@@2 |xs#0@@12|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@12| (Tclass._module.List _module._default.Elements$_T0@@2)) ($IsAlloc DatatypeTypeType |xs#0@@12| (Tclass._module.List _module._default.Elements$_T0@@2) $Heap)))) ($IsGoodHeap $Heap)) ($IsAlloc SetType (_module.__default.Elements _module._default.Elements$_T0@@2 $ly@@12 |xs#0@@12|) (TSet _module._default.Elements$_T0@@2) $Heap))
 :qid |SmallestMissingNumberfunctionaldfy.117:16|
 :skolemid |656|
 :pattern ( ($IsAlloc SetType (_module.__default.Elements _module._default.Elements$_T0@@2 $ly@@12 |xs#0@@12|) (TSet _module._default.Elements$_T0@@2) $Heap))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.Elements$_T0@@3 T@U) ($ly@@13 T@U) (|xs#0@@13| T@U) ) (!  (=> (or (|_module.__default.Elements#canCall| _module._default.Elements$_T0@@3 |xs#0@@13|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@13| (Tclass._module.List _module._default.Elements$_T0@@3)))) ($Is SetType (_module.__default.Elements _module._default.Elements$_T0@@3 $ly@@13 |xs#0@@13|) (TSet _module._default.Elements$_T0@@3)))
 :qid |unknown.0:0|
 :skolemid |655|
 :pattern ( (_module.__default.Elements _module._default.Elements$_T0@@3 $ly@@13 |xs#0@@13|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@14 T@U) (|xs#0@@14| T@U) (|n#0@@1| Int) (|len#0@@1| Int) ) (!  (=> (or (|_module.__default.SMN#canCall| |xs#0@@14| |n#0@@1| (LitInt |len#0@@1|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |xs#0@@14| (Tclass._module.List Tclass._System.nat)) (<= (LitInt 0) |n#0@@1|)) (<= (LitInt 0) |len#0@@1|)) (= (LitInt |len#0@@1|) (_module.__default.Length Tclass._System.nat ($LS $LZ) |xs#0@@14|))))) (and (=> (<= (LitInt 2) (LitInt |len#0@@1|)) (and (|_module.__default.Split#canCall| |xs#0@@14| (+ |n#0@@1| (Div |len#0@@1| (LitInt 2)))) (let ((|R#1| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@14| (+ |n#0@@1| (Div |len#0@@1| (LitInt 2))))))))
(let ((|L#1| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@14| (+ |n#0@@1| (Div |len#0@@1| (LitInt 2))))))))
 ...
 (and (=> (< |llen#1| (Div |len#0@@1| (LitInt 2))) (|_module.__default.SMN#canCall| |L#1| |n#0@@1| |llen#1|)) (=> (<= (Div |len#0@@1| (LitInt 2)) |llen#1|) (|_module.__default.SMN#canCall| |R#1| (+ |n#0@@1| |llen#1|) (- |len#0@@1| |llen#1|)))))))))) (= (_module.__default.SMN ($LS $ly@@14) |xs#0@@14| |n#0@@1| (LitInt |len#0@@1|)) (ite (<= (LitInt 2) (LitInt |len#0@@1|)) (let ((|R#1@@0| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@14| (+ |n#0@@1| (Div |len#0@@1| (LitInt 2))))))))
(let ((|L#1@@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@14| (+ |n#0@@1| (Div |len#0@@1| (LitInt 2))))))))
(let ((|llen#1@@0| (_module.__default.Length Tclass._System.nat ($LS $LZ) |L#1@@0|)))
(ite (< |llen#1@@0| (Div |len#0@@1| (LitInt 2))) (_module.__default.SMN ($LS $ly@@14) |L#1@@0| |n#0@@1| |llen#1@@0|) (_module.__default.SMN ($LS $ly@@14) |R#1@@0| (+ |n#0@@1| |llen#1@@0|) (- |len#0@@1| |llen#1@@0|)))))) (ite (_module.List.Cons_q |xs#0@@14|) (ite (= (U_2_int ($Unbox intType (_module.List.head |xs#0@@14|))) |n#0@@1|) (+ |n#0@@1| 1) |n#0@@1|) |n#0@@1|)))))
 :qid |SmallestMissingNumberfunctionaldfy.38:10|
 :weight 3
 :skolemid |605|
 :pattern ( (_module.__default.SMN ($LS $ly@@14) |xs#0@@14| |n#0@@1| (LitInt |len#0@@1|)))
))))
(assert (forall (($ly@@15 T@U) (|xs#0@@15| T@U) (|n#0@@2| Int) (|len#0@@2| Int) ) (! (= (_module.__default.SMN ($LS $ly@@15) |xs#0@@15| |n#0@@2| |len#0@@2|) (_module.__default.SMN $ly@@15 |xs#0@@15| |n#0@@2| |len#0@@2|))
 :qid |SmallestMissingNumberfunctionaldfy.38:10|
 :skolemid |600|
 :pattern ( (_module.__default.SMN ($LS $ly@@15) |xs#0@@15| |n#0@@2| |len#0@@2|))
)))
...
(let ((|x#2@@1| (Lit BoxType (_module.List.head (Lit DatatypeTypeType |xs#0@@17|)))))
 ...
 :weight 3
 :skolemid |666|
 :pattern ( (_module.__default.NoDuplicates _module._default.NoDuplicates$_T0@@1 ($LS $ly@@17) (Lit DatatypeTypeType |xs#0@@17|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.Length$_T0@@2 T@U) ($ly@@18 T@U) (|xs#0@@18| T@U) ) (!  (=> (or (|_module.__default.Length#canCall| _module._default.Length$_T0@@2 |xs#0@@18|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@18| (Tclass._module.List _module._default.Length$_T0@@2)))) (<= (LitInt 0) (_module.__default.Length _module._default.Length$_T0@@2 $ly@@18 |xs#0@@18|)))
 :qid |unknown.0:0|
 :skolemid |589|
 :pattern ( (_module.__default.Length _module._default.Length$_T0@@2 $ly@@18 |xs#0@@18|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@19 T@U) (|xs#0@@19| T@U) (|n#0@@3| Int) (|len#0@@3| Int) ) (!  (=> (or (|_module.__default.SMN#canCall| |xs#0@@19| |n#0@@3| |len#0@@3|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |xs#0@@19| (Tclass._module.List Tclass._System.nat)) (<= (LitInt 0) |n#0@@3|)) (<= (LitInt 0) |len#0@@3|)) (= |len#0@@3| (_module.__default.Length Tclass._System.nat ($LS $LZ) |xs#0@@19|))))) (and (=> (<= (LitInt 2) |len#0@@3|) (and (|_module.__default.Split#canCall| |xs#0@@19| (+ |n#0@@3| (Div |len#0@@3| (LitInt 2)))) (let ((|R#0@@0| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@19| (+ |n#0@@3| (Div |len#0@@3| (LitInt 2))))))))
(let ((|L#0@@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@19| (+ |n#0@@3| (Div |len#0@@3| (LitInt 2))))))))
 ...
 (and (=> (< |llen#0| (Div |len#0@@3| (LitInt 2))) (|_module.__default.SMN#canCall| |L#0@@0| |n#0@@3| |llen#0|)) (=> (<= (Div |len#0@@3| (LitInt 2)) |llen#0|) (|_module.__default.SMN#canCall| |R#0@@0| (+ |n#0@@3| |llen#0|) (- |len#0@@3| |llen#0|)))))))))) (= (_module.__default.SMN ($LS $ly@@19) |xs#0@@19| |n#0@@3| |len#0@@3|) (ite (<= (LitInt 2) |len#0@@3|) (let ((|R#0@@1| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@19| (+ |n#0@@3| (Div |len#0@@3| (LitInt 2))))))))
(let ((|L#0@@1| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@19| (+ |n#0@@3| (Div |len#0@@3| (LitInt 2))))))))
(let ((|llen#0@@0| (_module.__default.Length Tclass._System.nat ($LS $LZ) |L#0@@1|)))
(ite (< |llen#0@@0| (Div |len#0@@3| (LitInt 2))) (_module.__default.SMN $ly@@19 |L#0@@1| |n#0@@3| |llen#0@@0|) (_module.__default.SMN $ly@@19 |R#0@@1| (+ |n#0@@3| |llen#0@@0|) (- |len#0@@3| |llen#0@@0|)))))) (ite (_module.List.Cons_q |xs#0@@19|) (ite (= (U_2_int ($Unbox intType (_module.List.head |xs#0@@19|))) |n#0@@3|) (+ |n#0@@3| 1) |n#0@@3|) |n#0@@3|)))))
 :qid |SmallestMissingNumberfunctionaldfy.38:10|
 :skolemid |604|
 :pattern ( (_module.__default.SMN ($LS $ly@@19) |xs#0@@19| |n#0@@3| |len#0@@3|))
))))
(push 1)
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.SMN__Correct)
