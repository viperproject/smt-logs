...
(declare-fun |n#8@1| () Int)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun |$decr_init$loop#00@0| () Int)
(declare-fun $Heap@@4 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id Impl$$_module.Node.Lemma__AboutCycles)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 35) (let ((anon4_correct  (=> (and (<= |a#0| |n#8@0|) (<= |n#8@0| |k#0@@3|)) (=> (and (and ($IsAllocBox ($Box refType this@@4) Tclass._module.Node? $Heap@0) (= |##k#6@0| (+ |n#8@0| |b#0|))) (and ($IsAlloc intType (int_2_U |##k#6@0|) TInt $Heap@0) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Node?) $Heap@0))) (and (=> (= (ControlFlow 0 13) (- 0 20)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType this@@4))))) (and (=> (= (ControlFlow 0 13) (- 0 19)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType null))))) (and (=> (= (ControlFlow 0 13) (- 0 18)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (forall ((|n#9| T@U) ) (!  (=> ($Is refType |n#9| Tclass._module.Node?) (=> (and (and (|Set#IsMember| |S#0@@4| ($Box refType |n#9|)) (or (not (= |n#9| null)) (not true))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#9|) _module.Node.next)) null)) (not true))) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#9|) _module.Node.next))))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.133:12|
 :skolemid |772|
...
))))) (and (=> (= (ControlFlow 0 13) (- 0 17)) (<= (LitInt 0) |##k#6@0|)) (=> (and (and (|_module.Node.Nexxxt#canCall| $Heap@0 this@@4 (+ |n#8@0| |b#0|) |S#0@@4|) ($IsAllocBox ($Box refType this@@4) Tclass._module.Node? $Heap@0)) (and ($IsAlloc intType (int_2_U |n#8@0|) TInt $Heap@0) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Node?) $Heap@0))) (and (=> (= (ControlFlow 0 13) (- 0 16)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType this@@4))))) (and (=> (= (ControlFlow 0 13) (- 0 15)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType null))))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (forall ((|n#10| T@U) ) (!  (=> ($Is refType |n#10| Tclass._module.Node?) (=> (and (and (|Set#IsMember| |S#0@@4| ($Box refType |n#10|)) (or (not (= |n#10| null)) (not true))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#10|) _module.Node.next)) null)) (not true))) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#10|) _module.Node.next))))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.133:12|
 :skolemid |774|
...
))))) (=> (= (ControlFlow 0 13) (- 0 12)) (<= (LitInt 0) |n#8@0|))))))))))))))
(let ((anon10_Else_correct  (=> (and (< |n#8@0| |a#0|) (= (ControlFlow 0 22) 13)) anon4_correct)))
(let ((anon10_Then_correct  (=> (and (<= |a#0| |n#8@0|) (= (ControlFlow 0 21) 13)) anon4_correct)))
(let ((anon9_Then_correct  (=> (not |$w$loop#0@0|) (and (=> (= (ControlFlow 0 23) 21) anon10_Then_correct) (=> (= (ControlFlow 0 23) 22) anon10_Else_correct)))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (= (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 (+ |k#0@@3| |b#0|) |S#0@@4|) (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 |k#0@@3| |S#0@@4|)))))
(let ((anon11_Then_correct  (=> (and (<= |k#0@@3| |n#8@0|) (= (ControlFlow 0 10) 9)) GeneratedUnifiedExit_correct)))
(let ((anon11_Else_correct  (=> (< |n#8@0| |k#0@@3|) (=> (and (= |$decr$loop#00@1| (- |k#0@@3| |n#8@0|)) (= |n#8@1| (+ |n#8@0| 1))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (or (<= 0 |$decr$loop#00@1|) (= (- |k#0@@3| |n#8@1|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- |k#0@@3| |n#8@1|) |$decr$loop#00@1|)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (< (- |k#0@@3| |n#8@1|) |$decr$loop#00@1|)) (=> (< (- |k#0@@3| |n#8@1|) |$decr$loop#00@1|) (=> (=> (and (<= |a#0| |n#8@1|) (<= |n#8@1| |k#0@@3|)) (and (|_module.Node.Nexxxt#canCall| $Heap@0 this@@4 (+ |n#8@1| |b#0|) |S#0@@4|) (|_module.Node.Nexxxt#canCall| $Heap@0 this@@4 |n#8@1| |S#0@@4|))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (=> |$w$loop#0@0| (<= |a#0| |n#8@1|))) (=> (=> |$w$loop#0@0| (<= |a#0| |n#8@1|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> |$w$loop#0@0| (<= |n#8@1| |k#0@@3|))) (=> (=> |$w$loop#0@0| (<= |n#8@1| |k#0@@3|)) (=> (= (ControlFlow 0 3) (- 0 2)) (=> |$w$loop#0@0| (= (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 (+ |n#8@1| |b#0|) |S#0@@4|) (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 |n#8@1| |S#0@@4|)))))))))))))))))
(let ((anon9_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 11) 10) anon11_Then_correct) (=> (= (ControlFlow 0 11) 3) anon11_Else_correct)))))
(let ((anon8_LoopBody_correct  (and (=> (= (ControlFlow 0 24) 23) anon9_Then_correct) (=> (= (ControlFlow 0 24) 11) anon9_Else_correct))))
(let ((anon8_LoopDone_correct true))
(let ((anon8_LoopHead_correct  (=> (and (and (and (and (and (and (not false) (<= 0 |a#0|)) (<= 1 |b#0|)) (<= 0 |n#8@0|)) (=> |$w$loop#0@0| (<= |a#0| |n#8@0|))) (and (=> |$w$loop#0@0| (<= |n#8@0| |k#0@@3|)) (=> |$w$loop#0@0| (and (|_module.Node.Nexxxt#canCall| $Heap@0 this@@4 (+ |n#8@0| |b#0|) |S#0@@4|) (|_module.Node.Nexxxt#canCall| $Heap@0 this@@4 |n#8@0| |S#0@@4|))))) (and (and (=> |$w$loop#0@0| (= (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 (+ |n#8@0| |b#0|) |S#0@@4|) (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 |n#8@0| |S#0@@4|))) (= $Heap@0 $Heap@0)) (and (forall (($o@@4 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4) $f@@0)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@4 $f@@0))))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.277:5|
 :skolemid |776|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4) $f@@0))
)) (<= (- |k#0@@3| |n#8@0|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 25) 1) anon8_LoopDone_correct) (=> (= (ControlFlow 0 25) 24) anon8_LoopBody_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#3| null $Heap@@4 alloc false)) (and (=> (= (ControlFlow 0 26) (- 0 34)) (=> (|_module.Node.IsClosed#canCall| $Heap@@4 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@@4 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType this@@4))))) (=> (=> (|_module.Node.IsClosed#canCall| $Heap@@4 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@@4 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType this@@4)))) (and (=> (= (ControlFlow 0 26) (- 0 33)) (=> (|_module.Node.IsClosed#canCall| $Heap@@4 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@@4 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType null))))) (=> (=> (|_module.Node.IsClosed#canCall| $Heap@@4 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@@4 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType null)))) (and (=> (= (ControlFlow 0 26) (- 0 32)) (=> (|_module.Node.IsClosed#canCall| $Heap@@4 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@@4 this@@4 |S#0@@4|) (forall ((|n#4| T@U) ) (!  (=> ($Is refType |n#4| Tclass._module.Node?) (=> (and (and (|Set#IsMember| |S#0@@4| ($Box refType |n#4|)) (or (not (= |n#4| null)) (not true))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 |n#4|) _module.Node.next)) null)) (not true))) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 |n#4|) _module.Node.next))))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.133:12|
 :skolemid |785|
...
)))) (and (=> (= (ControlFlow 0 26) (- 0 31)) (<= (LitInt 0) |a#0|)) (=> (<= (LitInt 0) |a#0|) (and (=> (= (ControlFlow 0 26) (- 0 30)) (<= (LitInt 0) |b#0|)) (=> (<= (LitInt 0) |b#0|) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (|_module.Node.Nexxxt#canCall| $Heap@0 this@@4 |a#0| |S#0@@4|) (=> (or (not (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |a#0| |S#0@@4|) null)) (not true)) (and (and (|_module.Node.Nexxxt#canCall| $Heap@0 this@@4 |a#0| |S#0@@4|) (|_module.Node.Nexxxt#canCall| $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |a#0| |S#0@@4|) |b#0| |S#0@@4|)) (|_module.Node.Nexxxt#canCall| $Heap@0 this@@4 (+ |a#0| |b#0|) |S#0@@4|)))) (=> (or (not (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |a#0| |S#0@@4|) null)) (not true)) (= (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 |a#0| |S#0@@4|) |b#0| |S#0@@4|) (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 (+ |a#0| |b#0|) |S#0@@4|)))) (and (= $Heap@@4 $Heap@0) (= |$decr_init$loop#00@0| (- |k#0@@3| |a#0|)))) (and (=> (= (ControlFlow 0 26) (- 0 29)) (=> |$w$loop#0@0| (<= |a#0| |a#0|))) (=> (=> |$w$loop#0@0| (<= |a#0| |a#0|)) (and (=> (= (ControlFlow 0 26) (- 0 28)) (=> |$w$loop#0@0| (<= |a#0| |k#0@@3|))) (=> (=> |$w$loop#0@0| (<= |a#0| |k#0@@3|)) (and (=> (= (ControlFlow 0 26) (- 0 27)) (=> |$w$loop#0@0| (= (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 (+ |a#0| |b#0|) |S#0@@4|) (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 |a#0| |S#0@@4|)))) (=> (=> |$w$loop#0@0| (= (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 (+ |a#0| |b#0|) |S#0@@4|) (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 |a#0| |S#0@@4|))) (=> (= (ControlFlow 0 26) 25) anon8_LoopHead_correct))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.Node) ($IsAlloc refType this@@4 Tclass._module.Node $Heap@@4)))) (and (and ($Is SetType |S#0@@4| (TSet Tclass._module.Node?)) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Node?) $Heap@@4)) (= 3 $FunctionContextHeight))) (and (and (and (|_module.Node.IsClosed#canCall| $Heap@@4 this@@4 |S#0@@4|) (and (_module.Node.IsClosed $Heap@@4 this@@4 |S#0@@4|) (and (and (|Set#IsMember| |S#0@@4| ($Box refType this@@4)) (|Set#IsMember| |S#0@@4| ($Box refType null))) (forall ((|n#7| T@U) ) (!  (=> ($Is refType |n#7| Tclass._module.Node?) (=> (and (and (|Set#IsMember| |S#0@@4| ($Box refType |n#7|)) (or (not (= |n#7| null)) (not true))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 |n#7|) _module.Node.next)) null)) (not true))) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 |n#7|) _module.Node.next))))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.133:12|
 :skolemid |770|
...
))))) (and (<= (LitInt 0) |a#0|) (<= |a#0| |k#0@@3|))) (and (and (<= (LitInt 1) |b#0|) (or (not (= (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@@4 this@@4 |a#0| |S#0@@4|) null)) (not true))) (and (= (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@@4 (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@@4 this@@4 |a#0| |S#0@@4|) |b#0| |S#0@@4|) (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@@4 this@@4 |a#0| |S#0@@4|)) (= (ControlFlow 0 35) 26))))) anon0_correct)))
