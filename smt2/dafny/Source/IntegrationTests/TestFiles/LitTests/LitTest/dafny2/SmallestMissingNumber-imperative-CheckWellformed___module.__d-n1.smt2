...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module._default.Has$T T@U) ($Heap T@U) (|a#0| T@U) (|x#0| T@U) ) (!  (=> (or (|_module.__default.Has#canCall| _module._default.Has$T $Heap |a#0| |x#0|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) ($Is refType |a#0| (Tclass._System.array _module._default.Has$T))) ($IsBox |x#0| _module._default.Has$T)))) (= (_module.__default.Has _module._default.Has$T $Heap |a#0| |x#0|) (exists ((|i#0| Int) ) (!  (and (and (<= (LitInt 0) |i#0|) (< |i#0| (_System.array.Length |a#0|))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#0|)) |x#0|))
 ...
 :qid |unknown.0:0|
 :skolemid |540|
 :pattern ( (_module.__default.Has _module._default.Has$T $Heap |a#0| |x#0|) ($IsGoodHeap $Heap))
))))
...
(declare-fun _module._default.Has$T@@0 () T@U)
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Has)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon8_correct  (=> (= (_module.__default.Has _module._default.Has$T@@0 $Heap@@0 |a#0@@0| |x#0@@0|) (exists ((|i#2| Int) ) (!  (and (and (<= (LitInt 0) |i#2|) (< |i#2| (_System.array.Length |a#0@@0|))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |a#0@@0|) (IndexField |i#2|)) |x#0@@0|))
 :qid |SmallestMissingNumberimperativedfy.26:10|
 :skolemid |542|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |a#0@@0|) (IndexField |i#2|)))
))) (=> (and ($Is boolType (bool_2_U (_module.__default.Has _module._default.Has$T@@0 $Heap@@0 |a#0@@0| |x#0@@0|)) TBool) (= (ControlFlow 0 4) (- 0 3))) |b$reqreads#0@1|))))
(let ((anon13_Else_correct  (=> (not (and (<= (LitInt 0) |i#1@0|) (< |i#1@0| (_System.array.Length |a#0@@0|)))) (=> (and (= |b$reqreads#0@1| true) (= (ControlFlow 0 8) 4)) anon8_correct))))
(let ((anon13_Then_correct  (=> (and (<= (LitInt 0) |i#1@0|) (< |i#1@0| (_System.array.Length |a#0@@0|))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (or (not (= |a#0@@0| null)) (not true))) (=> (or (not (= |a#0@@0| null)) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (and (<= 0 |i#1@0|) (< |i#1@0| (_System.array.Length |a#0@@0|)))) (=> (and (<= 0 |i#1@0|) (< |i#1@0| (_System.array.Length |a#0@@0|))) (=> (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |a#0@@0| (IndexField |i#1@0|)))) (=> (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= (ControlFlow 0 5) 4)) anon8_correct)))))))))
(let ((anon12_Else_correct  (=> (< |i#1@0| (LitInt 0)) (and (=> (= (ControlFlow 0 11) 5) anon13_Then_correct) (=> (= (ControlFlow 0 11) 8) anon13_Else_correct)))))
(let ((anon12_Then_correct  (=> (<= (LitInt 0) |i#1@0|) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (not (= |a#0@@0| null)) (not true))) (=> (or (not (= |a#0@@0| null)) (not true)) (and (=> (= (ControlFlow 0 9) 5) anon13_Then_correct) (=> (= (ControlFlow 0 9) 8) anon13_Else_correct)))))))
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#1| null $Heap@@0 alloc |a#0@@0|)) (and (and (=> (= (ControlFlow 0 13) 1) anon10_Then_correct) (=> (= (ControlFlow 0 13) 12) anon11_Then_correct)) (=> (= (ControlFlow 0 13) 2) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is refType |a#0@@0| (Tclass._System.array _module._default.Has$T@@0)) ($IsBox |x#0@@0| _module._default.Has$T@@0)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct))))
