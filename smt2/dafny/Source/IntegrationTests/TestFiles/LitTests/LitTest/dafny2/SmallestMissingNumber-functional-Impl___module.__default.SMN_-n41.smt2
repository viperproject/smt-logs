...
(declare-fun |n##1_1_0@0| () Int)
(declare-fun |len##1_1_0@0| () Int)
(set-info :boogie-vc-id Impl$$_module.__default.SMN_k_k__Correct_split21)
...
(_module.__default.NoDuplicates Tclass._System.nat ($LS ($LS $LZ)) |tail#0@@8|))))) (= (ControlFlow 0 2) (- 0 1))))))))) (forall ((|x#1@@1| Int) ) (!  (=> (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS ($LS $LZ)) |R#1_0@0|) ($Box intType (int_2_U |x#1@@1|))) (<= |n##1_1_0@0| |x#1@@1|))
 :qid |SmallestMissingNumberfunctionaldfy.274:19|
 :skolemid |739|
 :pattern ( (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS ($LS $LZ)) |R#1_0@0|) ($Box intType (int_2_U |x#1@@1|))))
)))))))
anon0_correct))
))
(check-sat)
