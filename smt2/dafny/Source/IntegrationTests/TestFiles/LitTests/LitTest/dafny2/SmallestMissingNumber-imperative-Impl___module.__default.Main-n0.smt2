...
(assert (forall ((_module._default.Has$T@@0 T@U) ($h0 T@U) ($h1 T@U) (|a#0@@0| T@U) (|x#0@@2| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|_module.__default.Has#canCall| _module._default.Has$T@@0 $h0 |a#0@@0| |x#0@@2|) (and ($Is refType |a#0@@0| (Tclass._System.array _module._default.Has$T@@0)) ($IsBox |x#0@@2| _module._default.Has$T@@0)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@6 T@U) ($f@@0 T@U) )  (=> (and (or (not (= $o@@6 null)) (not true)) (= $o@@6 |a#0@@0|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@6) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@6) $f@@0)))) (= (_module.__default.Has _module._default.Has$T@@0 $h0 |a#0@@0| |x#0@@2|) (_module.__default.Has _module._default.Has$T@@0 $h1 |a#0@@0| |x#0@@2|))))
