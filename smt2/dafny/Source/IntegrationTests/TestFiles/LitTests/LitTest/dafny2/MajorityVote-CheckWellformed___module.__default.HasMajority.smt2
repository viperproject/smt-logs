...
(declare-fun _module._default.HasMajority$T@@2 () T@U)
(declare-fun $Heap () T@U)
(declare-fun |s#0@@6| () Int)
(declare-fun |t#0@@6| () Int)
(declare-fun |x#0@@6| () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$_module.__default.HasMajority)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon11_Else_correct  (=> (and (and ($IsAlloc SeqType |a#0@@6| (TSeq _module._default.HasMajority$T@@2) $Heap) ($IsAlloc intType (int_2_U |s#0@@6|) TInt $Heap)) (and ($IsAlloc intType (int_2_U |t#0@@6|) TInt $Heap) ($IsAllocBox |x#0@@6| _module._default.HasMajority$T@@2 $Heap))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (<= (LitInt 0) |s#0@@6|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= |s#0@@6| |t#0@@6|)) (=> (= (ControlFlow 0 3) (- 0 2)) (<= |t#0@@6| (|Seq#Length| |a#0@@6|))))))))
(let ((anon11_Then_correct true))
(let ((anon5_correct  (=> (and (and (<= (LitInt 0) |s#0@@6|) (<= |s#0@@6| |t#0@@6|)) (<= |t#0@@6| (|Seq#Length| |a#0@@6|))) (and (=> (= (ControlFlow 0 6) 1) anon11_Then_correct) (=> (= (ControlFlow 0 6) 3) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (not (and (<= (LitInt 0) |s#0@@6|) (<= |s#0@@6| |t#0@@6|))) (= (ControlFlow 0 8) 6)) anon5_correct)))
(let ((anon10_Then_correct  (=> (and (and (<= (LitInt 0) |s#0@@6|) (<= |s#0@@6| |t#0@@6|)) (= (ControlFlow 0 7) 6)) anon5_correct)))
(let ((anon9_Else_correct  (=> (< |s#0@@6| (LitInt 0)) (and (=> (= (ControlFlow 0 10) 7) anon10_Then_correct) (=> (= (ControlFlow 0 10) 8) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> (<= (LitInt 0) |s#0@@6|) (and (=> (= (ControlFlow 0 9) 7) anon10_Then_correct) (=> (= (ControlFlow 0 9) 8) anon10_Else_correct)))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 11) 9) anon9_Then_correct) (=> (= (ControlFlow 0 11) 10) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |a#0@@6| (TSeq _module._default.HasMajority$T@@2)) ($IsBox |x#0@@6| _module._default.HasMajority$T@@2)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 12) 11))) anon0_correct))))
