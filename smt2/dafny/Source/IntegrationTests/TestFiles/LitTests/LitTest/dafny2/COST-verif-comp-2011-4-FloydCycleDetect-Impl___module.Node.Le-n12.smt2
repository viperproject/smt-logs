...
(declare-fun |##k#0_2@0| () Int)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun $Heap@@4 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id Impl$$_module.Node.Lemma__NexxxtIsTransitive)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 29) (let ((anon7_Else_correct true))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (or (not (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) null)) (not true)) (= (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 |x#0| |S#0@@4|) |y#0| |S#0@@4|) (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 (+ |x#0| |y#0|) |S#0@@4|))))))
(let ((anon4_correct  (=> (forall ((|j#0_1| Int) ) (!  (=> (<= (LitInt 0) |j#0_1|) (and (and (|_module.Node.Nexxxt#canCall| $Heap@0 this@@4 |x#0| |S#0@@4|) (|_module.Node.Nexxxt#canCall| $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) |j#0_1| |S#0@@4|)) (|_module.Node.Nexxxt#canCall| $Heap@0 this@@4 (+ |x#0| |j#0_1|) |S#0@@4|)))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.291:21|
 :skolemid |798|
 :pattern ( (_module.Node.Nexxxt ($LS $LZ) $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) |j#0_1| |S#0@@4|))
)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((|j#0_1@@0| Int) ) (!  (=> (and (forall ((|j$ih#0_0#0_0| Int) ) (!  (=> (and (<= 0 |j$ih#0_0#0_0|) (< |j$ih#0_0#0_0| |j#0_1@@0|)) (=> (<= (LitInt 0) |j$ih#0_0#0_0|) (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) |j$ih#0_0#0_0| |S#0@@4|) (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 (+ |x#0| |j$ih#0_0#0_0|) |S#0@@4|))))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.291:21|
 :skolemid |799|
 :pattern ( (_module.Node.Nexxxt ($LS $LZ) $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) |j$ih#0_0#0_0| |S#0@@4|))
)) true) (=> (<= (LitInt 0) |j#0_1@@0|) (= (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 |x#0| |S#0@@4|) |j#0_1@@0| |S#0@@4|) (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 (+ |x#0| |j#0_1@@0|) |S#0@@4|))))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.291:21|
 :skolemid |800|
 :pattern ( (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 |x#0| |S#0@@4|) |j#0_1@@0| |S#0@@4|))
))) (=> (and (forall ((|j#0_1@@1| Int) ) (!  (=> (<= (LitInt 0) |j#0_1@@1|) (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) |j#0_1@@1| |S#0@@4|) (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 (+ |x#0| |j#0_1@@1|) |S#0@@4|)))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.291:21|
 :skolemid |802|
 :pattern ( (_module.Node.Nexxxt ($LS $LZ) $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) |j#0_1@@1| |S#0@@4|))
)) (= (ControlFlow 0 5) 2)) GeneratedUnifiedExit_correct)))))
(let ((anon8_Else_correct  (=> (and (< |j#0_0@0| (LitInt 0)) (= (ControlFlow 0 21) 5)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (and (<= (LitInt 0) |j#0_0@0|) ($IsAllocBox ($Box refType this@@4) Tclass._module.Node? $Heap@0)) (and ($IsAlloc intType (int_2_U |x#0|) TInt $Heap@0) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Node?) $Heap@0))) (and (=> (= (ControlFlow 0 7) (- 0 20)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType this@@4))))) (and (=> (= (ControlFlow 0 7) (- 0 19)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType null))))) (and (=> (= (ControlFlow 0 7) (- 0 18)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (forall ((|n#0_0| T@U) ) (!  (=> ($Is refType |n#0_0| Tclass._module.Node?) (=> (and (and (|Set#IsMember| |S#0@@4| ($Box refType |n#0_0|)) (or (not (= |n#0_0| null)) (not true))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0_0|) _module.Node.next)) null)) (not true))) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0_0|) _module.Node.next))))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.133:12|
 :skolemid |792|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0_0|) _module.Node.next)))
))))) (and (=> (= (ControlFlow 0 7) (- 0 17)) (<= (LitInt 0) |x#0|)) (=> (|_module.Node.Nexxxt#canCall| $Heap@0 this@@4 |x#0| |S#0@@4|) (and (=> (= (ControlFlow 0 7) (- 0 16)) (or (not (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) null)) (not true))) (=> ($IsAllocBox ($Box refType (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|)) Tclass._module.Node? $Heap@0) (=> (and ($IsAlloc intType (int_2_U |j#0_0@0|) TInt $Heap@0) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Node?) $Heap@0)) (and (=> (= (ControlFlow 0 7) (- 0 15)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 |x#0| |S#0@@4|)))))) (and (=> (= (ControlFlow 0 7) (- 0 14)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType null))))) (and (=> (= (ControlFlow 0 7) (- 0 13)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) |S#0@@4|) (forall ((|n#0_1| T@U) ) (!  (=> ($Is refType |n#0_1| Tclass._module.Node?) (=> (and (and (|Set#IsMember| |S#0@@4| ($Box refType |n#0_1|)) (or (not (= |n#0_1| null)) (not true))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0_1|) _module.Node.next)) null)) (not true))) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0_1|) _module.Node.next))))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.133:12|
 :skolemid |794|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0_1|) _module.Node.next)))
))))) (and (=> (= (ControlFlow 0 7) (- 0 12)) (<= (LitInt 0) |j#0_0@0|)) (=> (|_module.Node.Nexxxt#canCall| $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) |j#0_0@0| |S#0@@4|) (=> (and (and ($IsAllocBox ($Box refType this@@4) Tclass._module.Node? $Heap@0) (= |##k#0_2@0| (+ |x#0| |j#0_0@0|))) (and ($IsAlloc intType (int_2_U |##k#0_2@0|) TInt $Heap@0) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Node?) $Heap@0))) (and (=> (= (ControlFlow 0 7) (- 0 11)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType this@@4))))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType null))))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (forall ((|n#0_2| T@U) ) (!  (=> ($Is refType |n#0_2| Tclass._module.Node?) (=> (and (and (|Set#IsMember| |S#0@@4| ($Box refType |n#0_2|)) (or (not (= |n#0_2| null)) (not true))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0_2|) _module.Node.next)) null)) (not true))) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0_2|) _module.Node.next))))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.133:12|
 :skolemid |796|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0_2|) _module.Node.next)))
))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= (LitInt 0) |##k#0_2@0|)) (=> (and (|_module.Node.Nexxxt#canCall| $Heap@0 this@@4 (+ |x#0| |j#0_0@0|) |S#0@@4|) (= (ControlFlow 0 7) 5)) anon4_correct))))))))))))))))))))))
(let ((anon7_Then_correct  (and (=> (= (ControlFlow 0 22) 7) anon8_Then_correct) (=> (= (ControlFlow 0 22) 21) anon8_Else_correct))))
(let ((anon6_Then_correct  (=> (or (not (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) null)) (not true)) (and (=> (= (ControlFlow 0 23) 22) anon7_Then_correct) (=> (= (ControlFlow 0 23) 4) anon7_Else_correct)))))
(let ((anon6_Else_correct  (=> (and (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |x#0| |S#0@@4|) null) (= (ControlFlow 0 3) 2)) GeneratedUnifiedExit_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#3| null $Heap@@4 alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@4 $Heap@0)) (and (and (forall ((|$ih#x0#0| Int) (|$ih#y0#0| Int) (|$ih#S0#0| T@U) ) (!  (=> (and (and ($Is SetType |$ih#S0#0| (TSet Tclass._module.Node?)) (and (and (_module.Node.IsClosed $Heap@@4 this@@4 |$ih#S0#0|) (<= (LitInt 0) |$ih#x0#0|)) (<= (LitInt 0) |$ih#y0#0|))) (or (and (<= 0 |$ih#x0#0|) (< |$ih#x0#0| |x#0|)) (and (= |$ih#x0#0| |x#0|) (or (and (<= 0 |$ih#y0#0|) (< |$ih#y0#0| |y#0|)) (and (= |$ih#y0#0| |y#0|) (and (|Set#Subset| |$ih#S0#0| |S#0@@4|) (not (|Set#Subset| |S#0@@4| |$ih#S0#0|)))))))) (=> (or (not (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |$ih#x0#0| |$ih#S0#0|) null)) (not true)) (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |$ih#x0#0| |$ih#S0#0|) |$ih#y0#0| |$ih#S0#0|) (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 (+ |$ih#x0#0| |$ih#y0#0|) |$ih#S0#0|))))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.285:34|
 :skolemid |789|
 :pattern ( (_module.Node.Nexxxt ($LS $LZ) $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |$ih#x0#0| |$ih#S0#0|) |$ih#y0#0| |$ih#S0#0|))
)) ($IsAllocBox ($Box refType this@@4) Tclass._module.Node? $Heap@0)) (and ($IsAlloc intType (int_2_U |x#0|) TInt $Heap@0) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Node?) $Heap@0)))) (and (=> (= (ControlFlow 0 24) (- 0 28)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType this@@4))))) (and (=> (= (ControlFlow 0 24) (- 0 27)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType null))))) (and (=> (= (ControlFlow 0 24) (- 0 26)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (forall ((|n#6| T@U) ) (!  (=> ($Is refType |n#6| Tclass._module.Node?) (=> (and (and (|Set#IsMember| |S#0@@4| ($Box refType |n#6|)) (or (not (= |n#6| null)) (not true))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#6|) _module.Node.next)) null)) (not true))) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#6|) _module.Node.next))))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.133:12|
 :skolemid |790|
...
))))) (and (=> (= (ControlFlow 0 24) (- 0 25)) (<= (LitInt 0) |x#0|)) (=> (and (and (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (<= (LitInt 0) |x#0|)) (and (|_module.Node.Nexxxt#canCall| $Heap@0 this@@4 |x#0| |S#0@@4|) (|_module.Node.Nexxxt#canCall| $Heap@0 this@@4 |x#0| |S#0@@4|))) (and (=> (= (ControlFlow 0 24) 23) anon6_Then_correct) (=> (= (ControlFlow 0 24) 3) anon6_Else_correct)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.Node) ($IsAlloc refType this@@4 Tclass._module.Node $Heap@@4)))) (and (and ($Is SetType |S#0@@4| (TSet Tclass._module.Node?)) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Node?) $Heap@@4)) (= 2 $FunctionContextHeight))) (and (and (and (|_module.Node.IsClosed#canCall| $Heap@@4 this@@4 |S#0@@4|) (and (_module.Node.IsClosed $Heap@@4 this@@4 |S#0@@4|) (and (and (|Set#IsMember| |S#0@@4| ($Box refType this@@4)) (|Set#IsMember| |S#0@@4| ($Box refType null))) (forall ((|n#5| T@U) ) (!  (=> ($Is refType |n#5| Tclass._module.Node?) (=> (and (and (|Set#IsMember| |S#0@@4| ($Box refType |n#5|)) (or (not (= |n#5| null)) (not true))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 |n#5|) _module.Node.next)) null)) (not true))) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 |n#5|) _module.Node.next))))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.133:12|
 :skolemid |788|
...
))))) (<= (LitInt 0) |x#0|)) (and (<= (LitInt 0) |y#0|) (= (ControlFlow 0 29) 24)))) anon0_correct)))
