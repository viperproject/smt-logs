...
(set-info :boogie-vc-id CheckWellFormed$$_module.Tree.Node)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#2| null $Heap@@2 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |lft#0| null)) (not true))) (=> (or (not (= |lft#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |lft#0|) Tclass._module.Tree? $Heap@@2) (=> (and (|_module.Tree.Valid#canCall| $Heap@@2 |lft#0|) (_module.Tree.Valid ($LS $LZ) $Heap@@2 |lft#0|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |rgt#0| null)) (not true))) (=> (or (not (= |rgt#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |rgt#0|) Tclass._module.Tree? $Heap@@2) (=> (and (|_module.Tree.Valid#canCall| $Heap@@2 |rgt#0|) (_module.Tree.Valid ($LS $LZ) $Heap@@2 |rgt#0|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@15 T@U) ) (!  (=> (and (or (not (= $o@@15 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@15) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@15) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@15)))
 :qid |COSTverifcomp20112MaxTreeclassdfy.109:15|
 :skolemid |511|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@15))
)) ($HeapSucc $Heap@@2 $Heap@0))) (=> (and (and (and (or (not (= this@0 null)) (not true)) (and ($Is refType this@0 Tclass._module.Tree) ($IsAlloc refType this@0 Tclass._module.Tree $Heap@0))) ($IsAllocBox ($Box refType this@0) Tclass._module.Tree? $Heap@0)) (and (|_module.Tree.Valid#canCall| $Heap@0 this@0) (_module.Tree.Valid ($LS $LZ) $Heap@0 this@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |lft#0| null)) (not true))) (=> (or (not (= |lft#0| null)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= |rgt#0| null)) (not true))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and ($Is refType |lft#0| Tclass._module.Tree) ($IsAlloc refType |lft#0| Tclass._module.Tree $Heap@@2))) (and (and ($Is refType |rgt#0| Tclass._module.Tree) ($IsAlloc refType |rgt#0| Tclass._module.Tree $Heap@@2)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 2)))) anon0_correct)))
