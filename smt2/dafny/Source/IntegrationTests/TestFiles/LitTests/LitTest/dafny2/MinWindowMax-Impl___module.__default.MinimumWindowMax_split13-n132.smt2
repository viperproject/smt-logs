...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split133)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon90_correct  (=> (= |n#0@4| (+ |n#0@3| 1)) (=> (and ($Is intType (int_2_U |W#0|) Tclass._System.nat) (<= (LitInt 0) |k#0@2|)) (=> (and (and (<= |k#0@2| |$rhs#1_1@1|) (<= |$rhs#1_1@1| (_System.array.Length $nw@0))) (and (forall ((|i#1@@1| Int) ) (!  (and (=> (and (<= |k#0@2| |i#1@@1|) (< |i#1@@1| |$rhs#1_1@1|)) (<= (- |n#0@4| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $nw@0) (IndexField |i#1@@1|)))))) (=> (and (<= |k#0@2| |i#1@@1|) (< |i#1@@1| |$rhs#1_1@1|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $nw@0) (IndexField |i#1@@1|)))) |n#0@4|)))
 :qid |MinWindowMaxdfy.152:19|
 :skolemid |786|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $nw@0) (IndexField |i#1@@1|))))
)) (forall ((|i#3| Int) (|j#1| Int) ) (!  (=> (and (and (<= |k#0@2| |i#3|) (< |i#3| |j#1|)) (< |j#1| |$rhs#1_1@1|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $nw@0) (IndexField |i#3|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $nw@0) (IndexField |j#1|))))))
 :qid |MinWindowMaxdfy.153:19|
 :skolemid |787|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $nw@0) (IndexField |j#1|))) ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $nw@0) (IndexField |i#3|))))
)))) (=> (and (and (and ($IsGoodHeap $Heap@8) ($IsHeapAnchor $Heap@8)) (and (<= (- |$rhs#1_1@1| |k#0@2|) |W#0|) (= $Heap@7 $Heap@8))) (and (and (or (<= 0 |$decr$loop#10@1|) (= (- (_System.array.Length |a#0@@4|) |n#0@4|) |$decr$loop#10@1|)) (< (- (_System.array.Length |a#0@@4|) |n#0@4|) |$decr$loop#10@1|)) (and (=> (and (and (and (<= (LitInt 0) |k#0@2|) (< |k#0@2| |$rhs#1_1@1|)) (<= |$rhs#1_1@1| |n#0@4|)) (<= |n#0@4| (_System.array.Length |a#0@@4|))) (and (|_module.__default.StrictlyIncreasing#canCall| $Heap@8 $nw@0 |k#0@2| |$rhs#1_1@1| (- |n#0@4| |W#0|) |n#0@4|) (=> (_module.__default.StrictlyIncreasing $Heap@8 $nw@0 |k#0@2| |$rhs#1_1@1| (- |n#0@4| |W#0|) |n#0@4|) (and (|_module.__default.RightmostMax#canCall| $Heap@8 |a#0@@4| (- |n#0@4| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |k#0@2|)))) |n#0@4|) (=> (_module.__default.RightmostMax $Heap@8 |a#0@@4| (- |n#0@4| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |k#0@2|)))) |n#0@4|) (and (forall ((|u#3| Int) (|_t#0#1| Int) ) (!  (=> (= |_t#0#1| (- |u#3| 1)) (=> (< |k#0@2| |u#3|) (=> (< |u#3| |$rhs#1_1@1|) (|_module.__default.RightmostMax#canCall| $Heap@8 |a#0@@4| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |_t#0#1|)))) 1) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |u#3|)))) |n#0@4|))))
 :qid |MinWindowMaxdfy.65:22|
 :skolemid |717|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |u#3|))) ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |_t#0#1|))))
)) (=> (forall ((|u#3@@0| Int) (|_t#0#1@@0| Int) ) (!  (=> (= |_t#0#1@@0| (- |u#3@@0| 1)) (=> (and (< |k#0@2| |u#3@@0|) (< |u#3@@0| |$rhs#1_1@1|)) (_module.__default.RightmostMax $Heap@8 |a#0@@4| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |_t#0#1@@0|)))) 1) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |u#3@@0|)))) |n#0@4|)))
 :qid |MinWindowMaxdfy.65:22|
 :skolemid |720|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |u#3@@0|))) ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |_t#0#1@@0|))))
)) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField (- |$rhs#1_1@1| 1))))) (- |n#0@4| 1)) (=> (and (<= (LitInt 0) |start#0@2|) (<= |start#0@2| (- (_System.array.Length |a#0@@4|) |W#0|))) (and (|_module.__default.Max#canCall| $Heap@8 |a#0@@4| |start#0@2| |W#0|) (=> (= |m#0@2| (_module.__default.Max ($LS $LZ) $Heap@8 |a#0@@4| |start#0@2| |W#0|)) (forall ((|s#3| Int) ) (!  (=> (and (<= (LitInt 0) |s#3|) (<= |s#3| (- |n#0@4| |W#0|))) (|_module.__default.Max#canCall| $Heap@8 |a#0@@4| |s#3| |W#0|))
 :qid |MinWindowMaxdfy.70:22|
 :skolemid |718|
 :pattern ( (_module.__default.Max ($LS $LZ) $Heap@8 |a#0@@4| |s#3| |W#0|))
))))))))))))) (=> |$w$loop#1@0| (<= (LitInt 0) |k#0@2|))))) (=> (and (and (and (and (=> |$w$loop#1@0| (< |k#0@2| |$rhs#1_1@1|)) (=> |$w$loop#1@0| (<= |$rhs#1_1@1| |n#0@4|))) (and (=> |$w$loop#1@0| (<= |n#0@4| (_System.array.Length |a#0@@4|))) (=> |$w$loop#1@0| (=> (|_module.__default.StrictlyIncreasing#canCall| $Heap@8 $nw@0 |k#0@2| |$rhs#1_1@1| (- |n#0@4| |W#0|) |n#0@4|) (or (_module.__default.StrictlyIncreasing $Heap@8 $nw@0 |k#0@2| |$rhs#1_1@1| (- |n#0@4| |W#0|) |n#0@4|) (forall ((|i#4| Int) ) (!  (and (=> (and (<= |k#0@2| |i#4|) (< |i#4| |$rhs#1_1@1|)) (<= (- |n#0@4| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |i#4|)))))) (=> (and (<= |k#0@2| |i#4|) (< |i#4| |$rhs#1_1@1|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |i#4|)))) |n#0@4|)))
 :qid |MinWindowMaxdfy.146:11|
 :skolemid |690|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |i#4|))))
))))))) (and (and (=> |$w$loop#1@0| (=> (|_module.__default.StrictlyIncreasing#canCall| $Heap@8 $nw@0 |k#0@2| |$rhs#1_1@1| (- |n#0@4| |W#0|) |n#0@4|) (or (_module.__default.StrictlyIncreasing $Heap@8 $nw@0 |k#0@2| |$rhs#1_1@1| (- |n#0@4| |W#0|) |n#0@4|) (forall ((|i#5| Int) (|j#1@@0| Int) ) (!  (=> (and (and (<= |k#0@2| |i#5|) (< |i#5| |j#1@@0|)) (< |j#1@@0| |$rhs#1_1@1|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |i#5|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |j#1@@0|))))))
 :qid |MinWindowMaxdfy.147:11|
 :skolemid |691|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |j#1@@0|))) ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |i#5|))))
))))) (=> |$w$loop#1@0| (=> (|_module.__default.RightmostMax#canCall| $Heap@8 |a#0@@4| (- |n#0@4| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |k#0@2|)))) |n#0@4|) (or (_module.__default.RightmostMax $Heap@8 |a#0@@4| (- |n#0@4| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |k#0@2|)))) |n#0@4|) (forall ((|i#6| Int) ) (!  (=> (and (<= (- |n#0@4| |W#0|) |i#6|) (< |i#6| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |k#0@2|)))))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |a#0@@4|) (IndexField |i#6|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |a#0@@4|) (IndexField (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |k#0@2|))))))))))
 :qid |MinWindowMaxdfy.127:11|
 :skolemid |694|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |a#0@@4|) (IndexField |i#6|))))
)))))) (and (=> |$w$loop#1@0| (=> (|_module.__default.RightmostMax#canCall| $Heap@8 |a#0@@4| (- |n#0@4| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |k#0@2|)))) |n#0@4|) (or (_module.__default.RightmostMax $Heap@8 |a#0@@4| (- |n#0@4| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |k#0@2|)))) |n#0@4|) (forall ((|i#7| Int) ) (!  (=> (and (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |k#0@2|)))) |i#7|) (< |i#7| |n#0@4|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |a#0@@4|) (IndexField |i#7|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |a#0@@4|) (IndexField (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |k#0@2|))))))))))
 :qid |MinWindowMaxdfy.128:11|
 :skolemid |695|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |a#0@@4|) (IndexField |i#7|))))
))))) (=> |$w$loop#1@0| (forall ((|u#3@@1| Int) (|_t#0#1@@1| Int) ) (!  (=> (= |_t#0#1@@1| (- |u#3@@1| 1)) (=> (and (< |k#0@2| |u#3@@1|) (< |u#3@@1| |$rhs#1_1@1|)) (_module.__default.RightmostMax $Heap@8 |a#0@@4| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |_t#0#1@@1|)))) 1) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |u#3@@1|)))) |n#0@4|)))
 :qid |MinWindowMaxdfy.65:22|
 :skolemid |702|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |u#3@@1|))) ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField |_t#0#1@@1|))))
)))))) (and (and (and (=> |$w$loop#1@0| (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $nw@0) (IndexField (- |$rhs#1_1@1| 1))))) (- |n#0@4| 1))) (=> |$w$loop#1@0| (<= (LitInt 0) |start#0@2|))) (and (=> |$w$loop#1@0| (<= |start#0@2| (- (_System.array.Length |a#0@@4|) |W#0|))) (=> |$w$loop#1@0| (= |m#0@2| (_module.__default.Max ($LS ($LS $LZ)) $Heap@8 |a#0@@4| |start#0@2| |W#0|))))) (and (and (=> |$w$loop#1@0| (forall ((|s#3@@0| Int) ) (!  (=> (and (<= (LitInt 0) |s#3@@0|) (<= |s#3@@0| (- |n#0@4| |W#0|))) (<= |m#0@2| (_module.__default.Max ($LS ($LS $LZ)) $Heap@8 |a#0@@4| |s#3@@0| |W#0|)))
 :qid |MinWindowMaxdfy.70:22|
 :skolemid |706|
 :pattern ( (_module.__default.Max ($LS ($LS $LZ)) $Heap@8 |a#0@@4| |s#3@@0| |W#0|))
))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#1@0|))) (<= (- |$rhs#1_1@1| |k#0@2|) |W#0|))))))))
...
)))) (=> (|_module.__default.RightmostMax#canCall| $Heap@6 |a#0@@4| |lo##1_0@1| |x##1_0@1| |hi##1_0@1|) (or (_module.__default.RightmostMax $Heap@6 |a#0@@4| |lo##1_0@1| |x##1_0@1| |hi##1_0@1|) (forall ((|i#1@@2| Int) ) (!  (=> (and (< |x##1_0@1| |i#1@@2|) (< |i#1@@2| |hi##1_0@1|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |a#0@@4|) (IndexField |i#1@@2|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |a#0@@4|) (IndexField |x##1_0@1|))))))
 :qid |MinWindowMaxdfy.128:11|
 :skolemid |761|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |a#0@@4|) (IndexField |i#1@@2|))))
...
)))))))) (and (and (and (=> |$w$loop#0@0| (=> (|_module.__default.StrictlyIncreasing#canCall| $Heap@1 $nw@0 |$rhs#1@0| |$rhs#2@0| (LitInt 0) |n#0@0|) (or (_module.__default.StrictlyIncreasing $Heap@1 $nw@0 |$rhs#1@0| |$rhs#2@0| (LitInt 0) |n#0@0|) (forall ((|i#1@@3| Int) (|j#0@@0| Int) ) (!  (=> (and (and (<= |$rhs#1@0| |i#1@@3|) (< |i#1@@3| |j#0@@0|)) (< |j#0@@0| |$rhs#2@0|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |i#1@@3|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |j#0@@0|))))))
 :qid |MinWindowMaxdfy.147:11|
 :skolemid |668|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |j#0@@0|))) ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |i#1@@3|))))
...
)))))) (and (=> |$w$loop#0@0| (=> (|_module.__default.RightmostMax#canCall| $Heap@1 |a#0@@4| (LitInt 0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |$rhs#1@0|)))) |n#0@0|) (or (_module.__default.RightmostMax $Heap@1 |a#0@@4| (LitInt 0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |$rhs#1@0|)))) |n#0@0|) (forall ((|i#3@@0| Int) ) (!  (=> (and (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |$rhs#1@0|)))) |i#3@@0|) (< |i#3@@0| |n#0@0|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |a#0@@4|) (IndexField |i#3@@0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |a#0@@4|) (IndexField (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |$rhs#1@0|))))))))))
 :qid |MinWindowMaxdfy.128:11|
 :skolemid |672|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |a#0@@4|) (IndexField |i#3@@0|))))
...
))))))) (and (and (=> |$w$loop#0@0| (=> (|_module.__default.StrictlyIncreasing#canCall| $Heap@2 $nw@0 |$rhs#1@0| |l#0@0| (LitInt 0) |n#0@1|) (or (_module.__default.StrictlyIncreasing $Heap@2 $nw@0 |$rhs#1@0| |l#0@0| (LitInt 0) |n#0@1|) (forall ((|i#1@@4| Int) (|j#0@@1| Int) ) (!  (=> (and (and (<= |$rhs#1@0| |i#1@@4|) (< |i#1@@4| |j#0@@1|)) (< |j#0@@1| |l#0@0|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (IndexField |i#1@@4|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (IndexField |j#0@@1|))))))
 :qid |MinWindowMaxdfy.147:11|
 :skolemid |668|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (IndexField |j#0@@1|))) ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (IndexField |i#1@@4|))))
...
)) (forall ((|i#1@@5| Int) (|j#0@@2| Int) ) (!  (=> (and (and (<= |$rhs#1@0| |i#1@@5|) (< |i#1@@5| |j#0@@2|)) (< |j#0@@2| |l#0@0|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (IndexField |i#1@@5|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (IndexField |j#0@@2|))))))
 :qid |MinWindowMaxdfy.147:11|
 :skolemid |670|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (IndexField |j#0@@2|))) ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (IndexField |i#1@@5|))))
...
)))))))) (and (and (and (=> |$w$loop#0@0| (=> (|_module.__default.RightmostMax#canCall| $Heap@2 |a#0@@4| (LitInt 0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (IndexField |$rhs#1@0|)))) |n#0@1|) (or (_module.__default.RightmostMax $Heap@2 |a#0@@4| (LitInt 0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (IndexField |$rhs#1@0|)))) |n#0@1|) (forall ((|i#3@@1| Int) ) (!  (=> (and (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (IndexField |$rhs#1@0|)))) |i#3@@1|) (< |i#3@@1| |n#0@1|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |a#0@@4|) (IndexField |i#3@@1|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |a#0@@4|) (IndexField (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (IndexField |$rhs#1@0|))))))))))
 :qid |MinWindowMaxdfy.128:11|
 :skolemid |672|
...
)) (forall ((|i#3@@2| Int) ) (!  (=> (and (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (IndexField |$rhs#1@0|)))) |i#3@@2|) (< |i#3@@2| |n#0@1|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |a#0@@4|) (IndexField |i#3@@2|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |a#0@@4|) (IndexField (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (IndexField |$rhs#1@0|))))))))))
 :qid |MinWindowMaxdfy.128:11|
 :skolemid |674|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |a#0@@4|) (IndexField |i#3@@2|))))
...
)))) (=> (|_module.__default.RightmostMax#canCall| $Heap@2 |a#0@@4| |lo##0@0| |x##0@0| |n#0@1|) (or (_module.__default.RightmostMax $Heap@2 |a#0@@4| |lo##0@0| |x##0@0| |n#0@1|) (forall ((|i#1@@6| Int) ) (!  (=> (and (< |x##0@0| |i#1@@6|) (< |i#1@@6| |n#0@1|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |a#0@@4|) (IndexField |i#1@@6|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |a#0@@4|) (IndexField |x##0@0|))))))
 :qid |MinWindowMaxdfy.128:11|
 :skolemid |761|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |a#0@@4|) (IndexField |i#1@@6|))))
))))))) (and (and (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (and (|_module.__default.Max#canCall| $Heap@3 |a#0@@4| |lo##0@0| (- |n#0@1| |lo##0@0|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |a#0@@4|) (IndexField |x##0@0|)))) (_module.__default.Max ($LS ($LS $LZ)) $Heap@3 |a#0@@4| |lo##0@0| (- |n#0@1| |lo##0@0|))))) (and (and (= $Heap@2 $Heap@3) (= |start#0@0| (LitInt 0))) (and (= |$decr_init$loop#10@0| (- (_System.array.Length |a#0@@4|) |n#0@1|)) (=> |$w$loop#1@0| (<= (LitInt 0) |$rhs#1@0|)))))) (and (and (and (and (=> |$w$loop#1@0| (< |$rhs#1@0| |l#0@0|)) (=> |$w$loop#1@0| (<= |l#0@0| |n#0@1|))) (and (=> |$w$loop#1@0| (<= |n#0@1| (_System.array.Length |a#0@@4|))) (=> |$w$loop#1@0| (=> (|_module.__default.StrictlyIncreasing#canCall| $Heap@3 $nw@0 |$rhs#1@0| |l#0@0| (- |n#0@1| |W#0|) |n#0@1|) (or (_module.__default.StrictlyIncreasing $Heap@3 $nw@0 |$rhs#1@0| |l#0@0| (- |n#0@1| |W#0|) |n#0@1|) (forall ((|i#4@@0| Int) ) (!  (and (=> (and (<= |$rhs#1@0| |i#4@@0|) (< |i#4@@0| |l#0@0|)) (<= (- |n#0@1| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |i#4@@0|)))))) (=> (and (<= |$rhs#1@0| |i#4@@0|) (< |i#4@@0| |l#0@0|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |i#4@@0|)))) |n#0@1|)))
 :qid |MinWindowMaxdfy.146:11|
 :skolemid |690|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |i#4@@0|))))
))))))) (and (and (=> |$w$loop#1@0| (=> (|_module.__default.StrictlyIncreasing#canCall| $Heap@3 $nw@0 |$rhs#1@0| |l#0@0| (- |n#0@1| |W#0|) |n#0@1|) (or (_module.__default.StrictlyIncreasing $Heap@3 $nw@0 |$rhs#1@0| |l#0@0| (- |n#0@1| |W#0|) |n#0@1|) (forall ((|i#5@@0| Int) (|j#1@@1| Int) ) (!  (=> (and (and (<= |$rhs#1@0| |i#5@@0|) (< |i#5@@0| |j#1@@1|)) (< |j#1@@1| |l#0@0|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |i#5@@0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |j#1@@1|))))))
 :qid |MinWindowMaxdfy.147:11|
 :skolemid |691|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |j#1@@1|))) ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |i#5@@0|))))
))))) (=> |$w$loop#1@0| (=> (|_module.__default.RightmostMax#canCall| $Heap@3 |a#0@@4| (- |n#0@1| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |$rhs#1@0|)))) |n#0@1|) (or (_module.__default.RightmostMax $Heap@3 |a#0@@4| (- |n#0@1| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |$rhs#1@0|)))) |n#0@1|) (forall ((|i#6@@0| Int) ) (!  (=> (and (<= (- |n#0@1| |W#0|) |i#6@@0|) (< |i#6@@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |$rhs#1@0|)))))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |a#0@@4|) (IndexField |i#6@@0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |a#0@@4|) (IndexField (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |$rhs#1@0|))))))))))
 :qid |MinWindowMaxdfy.127:11|
 :skolemid |694|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |a#0@@4|) (IndexField |i#6@@0|))))
)))))) (and (=> |$w$loop#1@0| (=> (|_module.__default.RightmostMax#canCall| $Heap@3 |a#0@@4| (- |n#0@1| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |$rhs#1@0|)))) |n#0@1|) (or (_module.__default.RightmostMax $Heap@3 |a#0@@4| (- |n#0@1| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |$rhs#1@0|)))) |n#0@1|) (forall ((|i#7@@0| Int) ) (!  (=> (and (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |$rhs#1@0|)))) |i#7@@0|) (< |i#7@@0| |n#0@1|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |a#0@@4|) (IndexField |i#7@@0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |a#0@@4|) (IndexField (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |$rhs#1@0|))))))))))
 :qid |MinWindowMaxdfy.128:11|
 :skolemid |695|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |a#0@@4|) (IndexField |i#7@@0|))))
))))) (=> |$w$loop#1@0| (forall ((|u#3@@2| Int) (|_t#0#1@@2| Int) ) (!  (=> (= |_t#0#1@@2| (- |u#3@@2| 1)) (=> (and (< |$rhs#1@0| |u#3@@2|) (< |u#3@@2| |l#0@0|)) (_module.__default.RightmostMax $Heap@3 |a#0@@4| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |_t#0#1@@2|)))) 1) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |u#3@@2|)))) |n#0@1|)))
 :qid |MinWindowMaxdfy.65:22|
 :skolemid |702|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |u#3@@2|))) ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |_t#0#1@@2|))))
)))))) (and (and (and (=> |$w$loop#1@0| (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField (- |l#0@0| 1))))) (- |n#0@1| 1))) (=> |$w$loop#1@0| (<= (LitInt 0) |start#0@0|))) (and (=> |$w$loop#1@0| (<= |start#0@0| (- (_System.array.Length |a#0@@4|) |W#0|))) (=> |$w$loop#1@0| (= |m#0@0| (_module.__default.Max ($LS ($LS $LZ)) $Heap@3 |a#0@@4| |start#0@0| |W#0|))))) (and (and (=> |$w$loop#1@0| (forall ((|s#3@@1| Int) ) (!  (=> (and (<= (LitInt 0) |s#3@@1|) (<= |s#3@@1| (- |n#0@1| |W#0|))) (<= |m#0@0| (_module.__default.Max ($LS ($LS $LZ)) $Heap@3 |a#0@@4| |s#3@@1| |W#0|)))
 :qid |MinWindowMaxdfy.70:22|
 :skolemid |706|
 :pattern ( (_module.__default.Max ($LS ($LS $LZ)) $Heap@3 |a#0@@4| |s#3@@1| |W#0|))
))) (=> |$w$loop#1@0| (<= (- |l#0@0| |$rhs#1@0|) |W#0|))) (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5))))))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (not false) (= |$rhs#0@0| 0)) (<= 0 |k#0@0|)) (<= 1 |l#0@3|)) (= |$rhs#1@0| 0)) (= |$rhs#2@0| 1)) (<= 1 |n#0@3|)) (<= 0 |$decr_init$loop#00@0|)) |$w$loop#0@0|) (= |lo##0@0| 0)) (<= 1 |n#0@1|)) (and (and (=> |$w$loop#1@0| (<= (LitInt 0) |k#0@0|)) (=> |$w$loop#1@0| (< |k#0@0| |l#0@3|))) (and (=> |$w$loop#1@0| (<= |l#0@3| |n#0@3|)) (=> |$w$loop#1@0| (<= |n#0@3| (_System.array.Length |a#0@@4|)))))) (and (and (and (and (and (=> |$w$loop#1@0| (|_module.__default.StrictlyIncreasing#canCall| $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|)) (=> |$w$loop#1@0| (=> (|_module.__default.StrictlyIncreasing#canCall| $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|) (or (_module.__default.StrictlyIncreasing $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|) (forall ((|i#4@@1| Int) ) (!  (and (=> (and (<= |k#0@0| |i#4@@1|) (< |i#4@@1| |l#0@3|)) (<= (- |n#0@3| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |i#4@@1|)))))) (=> (and (<= |k#0@0| |i#4@@1|) (< |i#4@@1| |l#0@3|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |i#4@@1|)))) |n#0@3|)))
 :qid |MinWindowMaxdfy.146:11|
 :skolemid |690|
...
)))))) (and (=> |$w$loop#1@0| (=> (|_module.__default.StrictlyIncreasing#canCall| $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|) (or (_module.__default.StrictlyIncreasing $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|) (forall ((|i#5@@1| Int) (|j#1@@2| Int) ) (!  (=> (and (and (<= |k#0@0| |i#5@@1|) (< |i#5@@1| |j#1@@2|)) (< |j#1@@2| |l#0@3|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |i#5@@1|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |j#1@@2|))))))
 :qid |MinWindowMaxdfy.147:11|
 :skolemid |691|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |j#1@@2|))) ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |i#5@@1|))))
))))) (=> |$w$loop#1@0| (and (|_module.__default.StrictlyIncreasing#canCall| $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|) (and (_module.__default.StrictlyIncreasing $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|) (and (forall ((|i#4@@2| Int) ) (!  (and (=> (and (<= |k#0@0| |i#4@@2|) (< |i#4@@2| |l#0@3|)) (<= (- |n#0@3| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |i#4@@2|)))))) (=> (and (<= |k#0@0| |i#4@@2|) (< |i#4@@2| |l#0@3|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |i#4@@2|)))) |n#0@3|)))
 :qid |MinWindowMaxdfy.146:11|
 :skolemid |692|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |i#4@@2|))))
)) (forall ((|i#5@@2| Int) (|j#1@@3| Int) ) (!  (=> (and (and (<= |k#0@0| |i#5@@2|) (< |i#5@@2| |j#1@@3|)) (< |j#1@@3| |l#0@3|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |i#5@@2|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |j#1@@3|))))))
 :qid |MinWindowMaxdfy.147:11|
 :skolemid |693|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |j#1@@3|))) ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |i#5@@2|))))
)))))))) (and (and (=> |$w$loop#1@0| (|_module.__default.RightmostMax#canCall| $Heap@5 |a#0@@4| (- |n#0@3| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|)))) |n#0@3|)) (=> |$w$loop#1@0| (=> (|_module.__default.RightmostMax#canCall| $Heap@5 |a#0@@4| (- |n#0@3| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|)))) |n#0@3|) (or (_module.__default.RightmostMax $Heap@5 |a#0@@4| (- |n#0@3| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|)))) |n#0@3|) (forall ((|i#6@@1| Int) ) (!  (=> (and (<= (- |n#0@3| |W#0|) |i#6@@1|) (< |i#6@@1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|)))))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField |i#6@@1|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|))))))))))
 :qid |MinWindowMaxdfy.127:11|
 :skolemid |694|
...
)))))) (and (=> |$w$loop#1@0| (=> (|_module.__default.RightmostMax#canCall| $Heap@5 |a#0@@4| (- |n#0@3| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|)))) |n#0@3|) (or (_module.__default.RightmostMax $Heap@5 |a#0@@4| (- |n#0@3| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|)))) |n#0@3|) (forall ((|i#7@@1| Int) ) (!  (=> (and (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|)))) |i#7@@1|) (< |i#7@@1| |n#0@3|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField |i#7@@1|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|))))))))))
 :qid |MinWindowMaxdfy.128:11|
 :skolemid |695|
...
))))) (=> |$w$loop#1@0| (and (|_module.__default.RightmostMax#canCall| $Heap@5 |a#0@@4| (- |n#0@3| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|)))) |n#0@3|) (and (_module.__default.RightmostMax $Heap@5 |a#0@@4| (- |n#0@3| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|)))) |n#0@3|) (and (forall ((|i#6@@2| Int) ) (!  (=> (and (<= (- |n#0@3| |W#0|) |i#6@@2|) (< |i#6@@2| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|)))))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField |i#6@@2|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|))))))))))
 :qid |MinWindowMaxdfy.127:11|
 :skolemid |696|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField |i#6@@2|))))
)) (forall ((|i#7@@2| Int) ) (!  (=> (and (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|)))) |i#7@@2|) (< |i#7@@2| |n#0@3|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField |i#7@@2|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|))))))))))
 :qid |MinWindowMaxdfy.128:11|
 :skolemid |697|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField |i#7@@2|))))
))))))))) (and (and (and (=> |$w$loop#1@0| (forall ((|u#3@@3| Int) (|_t#0#1@@3| Int) ) (!  (=> (= |_t#0#1@@3| (- |u#3@@3| 1)) (=> (< |k#0@0| |u#3@@3|) (=> (< |u#3@@3| |l#0@3|) (|_module.__default.RightmostMax#canCall| $Heap@5 |a#0@@4| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |_t#0#1@@3|)))) 1) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |u#3@@3|)))) |n#0@3|))))
 :qid |MinWindowMaxdfy.65:22|
 :skolemid |700|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |u#3@@3|))) ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |_t#0#1@@3|))))
))) (=> |$w$loop#1@0| (forall ((|u#3@@4| Int) (|_t#0#1@@4| Int) ) (!  (=> (= |_t#0#1@@4| (- |u#3@@4| 1)) (=> (and (< |k#0@0| |u#3@@4|) (< |u#3@@4| |l#0@3|)) (_module.__default.RightmostMax $Heap@5 |a#0@@4| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |_t#0#1@@4|)))) 1) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |u#3@@4|)))) |n#0@3|)))
 :qid |MinWindowMaxdfy.65:22|
 :skolemid |702|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |u#3@@4|))) ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |_t#0#1@@4|))))
)))) (and (=> |$w$loop#1@0| (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@3| 1))))) (- |n#0@3| 1))) (=> |$w$loop#1@0| (<= (LitInt 0) |start#0@1|)))) (and (and (=> |$w$loop#1@0| (<= |start#0@1| (- (_System.array.Length |a#0@@4|) |W#0|))) (=> |$w$loop#1@0| (|_module.__default.Max#canCall| $Heap@5 |a#0@@4| |start#0@1| |W#0|))) (and (=> |$w$loop#1@0| (= |m#0@1| (_module.__default.Max ($LS ($LS $LZ)) $Heap@5 |a#0@@4| |start#0@1| |W#0|))) (=> |$w$loop#1@0| (forall ((|s#3@@2| Int) ) (!  (=> (and (<= (LitInt 0) |s#3@@2|) (<= |s#3@@2| (- |n#0@3| |W#0|))) (|_module.__default.Max#canCall| $Heap@5 |a#0@@4| |s#3@@2| |W#0|))
 :qid |MinWindowMaxdfy.70:22|
 :skolemid |705|
 :pattern ( (_module.__default.Max ($LS $LZ) $Heap@5 |a#0@@4| |s#3@@2| |W#0|))
))))))) (and (and (and (and (=> |$w$loop#1@0| (forall ((|s#3@@3| Int) ) (!  (=> (and (<= (LitInt 0) |s#3@@3|) (<= |s#3@@3| (- |n#0@3| |W#0|))) (<= |m#0@1| (_module.__default.Max ($LS ($LS $LZ)) $Heap@5 |a#0@@4| |s#3@@3| |W#0|)))
 :qid |MinWindowMaxdfy.70:22|
 :skolemid |706|
 :pattern ( (_module.__default.Max ($LS ($LS $LZ)) $Heap@5 |a#0@@4| |s#3@@3| |W#0|))
))) (=> |$w$loop#1@0| (forall ((|s#3@@4| Int) ) (!  (=> (and (<= (LitInt 0) |s#3@@4|) (<= |s#3@@4| (- |n#0@3| |W#0|))) (<= |m#0@1| (_module.__default.Max ($LS $LZ) $Heap@5 |a#0@@4| |s#3@@4| |W#0|)))
 :qid |MinWindowMaxdfy.70:22|
 :skolemid |707|
 :pattern ( (_module.__default.Max ($LS $LZ) $Heap@5 |a#0@@4| |s#3@@4| |W#0|))
