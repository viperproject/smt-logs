...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((_module._default.reverse$_T0@@1 T@U) ($ly@@3 T@U) (|l#0@@3| T@U) ) (!  (=> (or (|_module.__default.reverse#canCall| _module._default.reverse$_T0@@1 (Lit DatatypeTypeType |l#0@@3|)) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |l#0@@3| (Tclass._module.List _module._default.reverse$_T0@@1)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |l#0@@3|)))))) (let ((|xs#3@@0| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |l#0@@3|)))))
(let ((|x#3| (Lit BoxType (_module.List._h0 (Lit DatatypeTypeType |l#0@@3|)))))
 (and (|_module.__default.reverse#canCall| _module._default.reverse$_T0@@1 |xs#3@@0|) (|_module.__default.concat#canCall| _module._default.reverse$_T0@@1 (_module.__default.reverse _module._default.reverse$_T0@@1 ($LS $ly@@3) |xs#3@@0|) (|#_module.List.Cons| |x#3| (Lit DatatypeTypeType |#_module.List.Nil|))))))) (= (_module.__default.reverse _module._default.reverse$_T0@@1 ($LS $ly@@3) (Lit DatatypeTypeType |l#0@@3|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |l#0@@3|)) |#_module.List.Nil| (let ((|xs#2@@0| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |l#0@@3|)))))
(let ((|x#2@@0| (Lit BoxType (_module.List._h0 (Lit DatatypeTypeType |l#0@@3|)))))
(Lit DatatypeTypeType (_module.__default.concat _module._default.reverse$_T0@@1 ($LS $LZ) (Lit DatatypeTypeType (_module.__default.reverse _module._default.reverse$_T0@@1 ($LS $ly@@3) |xs#2@@0|)) (Lit DatatypeTypeType (|#_module.List.Cons| |x#2@@0| (Lit DatatypeTypeType |#_module.List.Nil|)))))))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |552|
 :pattern ( (_module.__default.reverse _module._default.reverse$_T0@@1 ($LS $ly@@3) (Lit DatatypeTypeType |l#0@@3|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.concat$_T0@@1 T@U) ($ly@@4 T@U) (|l#0@@4| T@U) (|ys#0@@1| T@U) ) (!  (=> (or (|_module.__default.concat#canCall| _module._default.concat$_T0@@1 |l#0@@4| |ys#0@@1|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |l#0@@4| (Tclass._module.List _module._default.concat$_T0@@1)) ($Is DatatypeTypeType |ys#0@@1| (Tclass._module.List _module._default.concat$_T0@@1))))) ($Is DatatypeTypeType (_module.__default.concat _module._default.concat$_T0@@1 $ly@@4 |l#0@@4| |ys#0@@1|) (Tclass._module.List _module._default.concat$_T0@@1)))
 :qid |unknown.0:0|
 :skolemid |540|
 :pattern ( (_module.__default.concat _module._default.concat$_T0@@1 $ly@@4 |l#0@@4| |ys#0@@1|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.reverse$_T0@@2 T@U) ($ly@@5 T@U) (|l#0@@5| T@U) ) (!  (=> (and (or (|_module.__default.reverse#canCall| _module._default.reverse$_T0@@2 |l#0@@5|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |l#0@@5| (Tclass._module.List _module._default.reverse$_T0@@2)) ($IsAlloc DatatypeTypeType |l#0@@5| (Tclass._module.List _module._default.reverse$_T0@@2) $Heap)))) ($IsGoodHeap $Heap)) ($IsAlloc DatatypeTypeType (_module.__default.reverse _module._default.reverse$_T0@@2 $ly@@5 |l#0@@5|) (Tclass._module.List _module._default.reverse$_T0@@2) $Heap))
 :qid |Calculationsdfy.23:16|
 :skolemid |549|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.__default.reverse _module._default.reverse$_T0@@2 $ly@@5 |l#0@@5|) (Tclass._module.List _module._default.reverse$_T0@@2) $Heap))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((_module._default.reverse$_T0@@3 T@U) ($ly@@6 T@U) (|l#0@@6| T@U) ) (!  (=> (or (|_module.__default.reverse#canCall| _module._default.reverse$_T0@@3 |l#0@@6|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |l#0@@6| (Tclass._module.List _module._default.reverse$_T0@@3)))) ($Is DatatypeTypeType (_module.__default.reverse _module._default.reverse$_T0@@3 $ly@@6 |l#0@@6|) (Tclass._module.List _module._default.reverse$_T0@@3)))
 :qid |unknown.0:0|
 :skolemid |548|
 :pattern ( (_module.__default.reverse _module._default.reverse$_T0@@3 $ly@@6 |l#0@@6|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) (_module._default.concat$_T0@@2 T@U) ($ly@@7 T@U) (|l#0@@8| T@U) (|ys#0@@2| T@U) ) (!  (=> (and (or (|_module.__default.concat#canCall| _module._default.concat$_T0@@2 |l#0@@8| |ys#0@@2|) (and (< 1 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |l#0@@8| (Tclass._module.List _module._default.concat$_T0@@2)) ($IsAlloc DatatypeTypeType |l#0@@8| (Tclass._module.List _module._default.concat$_T0@@2) $Heap@@0)) (and ($Is DatatypeTypeType |ys#0@@2| (Tclass._module.List _module._default.concat$_T0@@2)) ($IsAlloc DatatypeTypeType |ys#0@@2| (Tclass._module.List _module._default.concat$_T0@@2) $Heap@@0))))) ($IsGoodHeap $Heap@@0)) ($IsAlloc DatatypeTypeType (_module.__default.concat _module._default.concat$_T0@@2 $ly@@7 |l#0@@8| |ys#0@@2|) (Tclass._module.List _module._default.concat$_T0@@2) $Heap@@0))
 :qid |Calculationsdfy.16:16|
 :skolemid |541|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.__default.concat _module._default.concat$_T0@@2 $ly@@7 |l#0@@8| |ys#0@@2|) (Tclass._module.List _module._default.concat$_T0@@2) $Heap@@0))
))))
...
(assert (forall ((_module._default.concat$_T0@@3 T@U) ($ly@@8 T@U) (|l#0@@9| T@U) (|ys#0@@3| T@U) ) (! (= (_module.__default.concat _module._default.concat$_T0@@3 ($LS $ly@@8) |l#0@@9| |ys#0@@3|) (_module.__default.concat _module._default.concat$_T0@@3 $ly@@8 |l#0@@9| |ys#0@@3|))
 :qid |unknown.0:0|
 :skolemid |538|
 :pattern ( (_module.__default.concat _module._default.concat$_T0@@3 ($LS $ly@@8) |l#0@@9| |ys#0@@3|))
)))
...
(declare-fun _module._default.reverse$_T0@@4 () T@U)
...
(let ((anon10_Then_correct  (=> (= |l#0@@10| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) (=> (and ($IsBox |_mcc#0#0| _module._default.reverse$_T0@@4) ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List _module._default.reverse$_T0@@4))) (=> (and (and (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List _module._default.reverse$_T0@@4))) (and (= |xs#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|))) (and (and ($IsBox |let#1#0#0| _module._default.reverse$_T0@@4) (= |x#Z#0@0| |let#1#0#0|)) (and ($IsAlloc DatatypeTypeType |xs#Z#0@0| (Tclass._module.List _module._default.reverse$_T0@@4) $Heap@@1) (= (ControlFlow 0 4) (- 0 3))))) (< (DtRank |xs#Z#0@0|) (DtRank |l#0@@10|)))))))
(let ((anon9_Else_correct  (=> (or (not (= |l#0@@10| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 6) 4) anon10_Then_correct) (=> (= (ControlFlow 0 6) 5) anon10_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) ($Is DatatypeTypeType |l#0@@10| (Tclass._module.List _module._default.reverse$_T0@@4))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct)))
