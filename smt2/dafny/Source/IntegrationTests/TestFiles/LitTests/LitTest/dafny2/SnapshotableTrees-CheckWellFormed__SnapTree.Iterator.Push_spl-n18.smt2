...
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id CheckWellFormed$$SnapTree.Iterator.Push_split3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_correct  (=> (and (and (<= (LitInt 0) |n#0|) (<= |n#0| (|Seq#Length| |C#0|))) (and (or (not (= |p#0| null)) (not true)) (= (ControlFlow 0 2) (- 0 1)))) (and (<= 0 |n#0|) (<= |n#0| (|Seq#Length| |C#0|))))))
