...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |xs#0@0| (Lit DatatypeTypeType |#_module.List.Nil|))) (=> (and (and ($IsAlloc DatatypeTypeType |xs#0@0| (Tclass._module.List Tclass._System.nat) $Heap) (|_module.__default.SmallestMissingNumber#canCall| |xs#0@0|)) (and (|_module.__default.SmallestMissingNumber#canCall| |xs#0@0|) (= |s#0@0| (_module.__default.SmallestMissingNumber |xs#0@0|)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= |s#0@0| (LitInt 0))) (=> (= |s#0@0| (LitInt 0)) (=> (= |a#0@0| (Lit DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 2))) (Lit DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 0))) (Lit DatatypeTypeType |#_module.List.Nil|)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($Is DatatypeTypeType |a#0@0| (Tclass._module.List Tclass._System.nat))) (=> ($Is DatatypeTypeType |a#0@0| (Tclass._module.List Tclass._System.nat)) (=> (and (and ($IsAlloc DatatypeTypeType |a#0@0| (Tclass._module.List Tclass._System.nat) $Heap) (|_module.__default.SmallestMissingNumber#canCall| |a#0@0|)) (and (|_module.__default.SmallestMissingNumber#canCall| |a#0@0|) (= |a#0@1| (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 3))) (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 1))) |a#0@0|))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($Is DatatypeTypeType |a#0@1| (Tclass._module.List Tclass._System.nat))) (=> ($Is DatatypeTypeType |a#0@1| (Tclass._module.List Tclass._System.nat)) (=> ($IsAlloc DatatypeTypeType |a#0@1| (Tclass._module.List Tclass._System.nat) $Heap) (=> (and (and (|_module.__default.SmallestMissingNumber#canCall| |a#0@1|) (|_module.__default.SmallestMissingNumber#canCall| |a#0@1|)) (and (= |a#0@2| (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 7))) (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 4))) (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 6))) |a#0@1|)))) (= (ControlFlow 0 2) (- 0 1)))) ($Is DatatypeTypeType |a#0@2| (Tclass._module.List Tclass._System.nat))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |xs#0@@15| (Tclass._module.List Tclass._System.nat)) ($IsAlloc DatatypeTypeType |xs#0@@15| (Tclass._module.List Tclass._System.nat) $Heap)) true) (and (<= (LitInt 0) |s#0|) true)) (and (and (and ($Is DatatypeTypeType |a#0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |a#0| (Tclass._module.List TInt) $Heap)) true) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 6) 2)))) anon0_correct))))
