...
(declare-fun |b##1_0@0| () Int)
(set-info :boogie-vc-id Impl$$_module.__default.SMN_k_k__Correct_split4)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (and ($Is DatatypeTypeType |xs#0@@15| (Tclass._module.List Tclass._System.nat)) ($IsAlloc DatatypeTypeType |xs#0@@15| (Tclass._module.List Tclass._System.nat) $Heap@@0)) (|$IsA#_module.List| |xs#0@@15|)) (and (<= (LitInt 0) |n#0|) (<= (LitInt 0) |len#0|))) (and (and (and ($Is SetType |bound#1_0| (TSet Tclass._System.nat)) ($IsAlloc SetType |bound#1_0| (TSet Tclass._System.nat) $Heap@@0)) true) (= 4 $FunctionContextHeight))) (=> (and (and (and (and (and (|_module.__default.NoDuplicates#canCall| Tclass._System.nat |xs#0@@15|) (and (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |xs#0@@15|) (ite (_module.List.Nil_q |xs#0@@15|) true (let ((|tail#3@@3| (_module.List.tail |xs#0@@15|)))
...
))) (and (and (= |len#0| (_module.__default.Length Tclass._System.nat ($LS ($LS $LZ)) |xs#0@@15|)) (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false))) (and (|$IsA#_module.List| |xs#0@@15|) (not (|_module.List#Equal| |xs#0@@15| |#_module.List.Nil|))))) (and (and (and (or (not (= (LitInt 2) 0)) (not true)) (= |half#1_0@0| (+ (Div |len#0| (LitInt 2)) 1))) (and ($Is DatatypeTypeType |L#1_0@0| (Tclass._module.List Tclass._System.nat)) ($IsAlloc DatatypeTypeType |L#1_0@0| (Tclass._module.List Tclass._System.nat) $Heap@@0))) (and (and ($Is DatatypeTypeType |R#1_0@0| (Tclass._module.List Tclass._System.nat)) ($IsAlloc DatatypeTypeType |R#1_0@0| (Tclass._module.List Tclass._System.nat) $Heap@@0)) (and ($IsAlloc DatatypeTypeType |xs#0@@15| (Tclass._module.List Tclass._System.nat) $Heap@@0) ($Is intType (int_2_U (+ |n#0| |half#1_0@0|)) Tclass._System.nat))))) (and (and (and (and (= |##b#1_0@0| (+ |n#0| |half#1_0@0|)) ($IsAlloc intType (int_2_U |##b#1_0@0|) Tclass._System.nat $Heap@@0)) (and (|_module.__default.Split#canCall| |xs#0@@15| (+ |n#0| |half#1_0@0|)) (_System.Tuple2.___hMake2_q (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@15| (+ |n#0| |half#1_0@0|))))) (and (and (= |let#1_0#0#0| (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@15| (+ |n#0| |half#1_0@0|))) (|_module.__default.Split#canCall| |xs#0@@15| (+ |n#0| |half#1_0@0|))) (and (|_module.__default.Split#canCall| |xs#0@@15| (+ |n#0| |half#1_0@0|)) ($Is DatatypeTypeType |let#1_0#0#0| (Tclass._System.Tuple2 (Tclass._module.List Tclass._System.nat) (Tclass._module.List Tclass._System.nat)))))) (and (and (and (_System.Tuple2.___hMake2_q |let#1_0#0#0|) (= (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |L#1_0@0|) ($Box DatatypeTypeType |R#1_0@0|)) |let#1_0#0#0|)) (and ($Is intType (int_2_U (+ |n#0| |half#1_0@0|)) Tclass._System.nat) (= |b##1_0@0| (+ |n#0| |half#1_0@0|)))) (and (and (=> (|_module.__default.NoDuplicates#canCall| Tclass._System.nat |xs#0@@15|) (or (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |xs#0@@15|) (=> (_module.List.Nil_q |xs#0@@15|) (U_2_bool (Lit boolType (bool_2_U true)))))) (= (ControlFlow 0 2) (- 0 1))) (|_module.__default.NoDuplicates#canCall| Tclass._System.nat |xs#0@@15|))))) (or (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |xs#0@@15|) (=> (not (_module.List.Nil_q |xs#0@@15|)) (let ((|tail#0@@3| (_module.List.tail |xs#0@@15|)))
(let ((|x#2@@2| (U_2_int ($Unbox intType (_module.List.head |xs#0@@15|)))))
 (not (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS ($LS $LZ)) |tail#0@@3|) ($Box intType (int_2_U |x#2@@2|)))))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
