...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split181)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon117_Then_correct  (=> (and (and (< |k#0@0| |u#2@0|) (< |u#2@0| |l#0@3|)) (and ($IsAlloc refType |a#0@@4| (Tclass._System.array TInt) $Heap@5) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= $nw@0 null)) (not true)))))
