...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@8 T@U) ($f@@0 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#10| |l#0| |l#1| |l#2| |l#3|) $o@@8 $f@@0))  (=> (and (or (not (= $o@@8 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@8) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1683|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#10| |l#0| |l#1| |l#2| |l#3|) $o@@8 $f@@0))
)))
...
(set-info :boogie-vc-id Impl$$Implementation.BirthdayBook.Init)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#10| null $Heap@@1 alloc false)) (= |$rhs#0@0| (Lit SetType |Set#Empty|))) (and (= |$rhs#1@0| (Lit MapType |Map#Empty|)) (= this.Repr@0 (|Set#UnionOne| |Set#Empty| ($Box refType this@@2))))) (=> (and (and (and (and (or (not (= this@@2 null)) (not true)) ($Is refType this@@2 Tclass.Implementation.BirthdayBook?)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) alloc))))) (and (= ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) Implementation.BirthdayBook.known)) |$rhs#0@0|) (= ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) Implementation.BirthdayBook.birthday)) |$rhs#1@0|))) (and (and (= ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) Implementation.BirthdayBook.Repr)) this.Repr@0) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|Implementation.BirthdayBook.Valid#canCall| $Heap@0 this@@2) (or (Implementation.BirthdayBook.Valid $Heap@0 this@@2) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Implementation.BirthdayBook.Repr)) ($Box refType this@@2))))) (=> (=> (|Implementation.BirthdayBook.Valid#canCall| $Heap@0 this@@2) (or (Implementation.BirthdayBook.Valid $Heap@0 this@@2) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Implementation.BirthdayBook.Repr)) ($Box refType this@@2)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|Implementation.BirthdayBook.Valid#canCall| $Heap@0 this@@2) (or (Implementation.BirthdayBook.Valid $Heap@0 this@@2) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Implementation.BirthdayBook.Repr)) ($Box refType null)))))) (=> (=> (|Implementation.BirthdayBook.Valid#canCall| $Heap@0 this@@2) (or (Implementation.BirthdayBook.Valid $Heap@0 this@@2) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Implementation.BirthdayBook.Repr)) ($Box refType null))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|Implementation.BirthdayBook.Valid#canCall| $Heap@0 this@@2) (or (Implementation.BirthdayBook.Valid $Heap@0 this@@2) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Implementation.BirthdayBook.known)) (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Implementation.BirthdayBook.birthday))))))) (=> (=> (|Implementation.BirthdayBook.Valid#canCall| $Heap@0 this@@2) (or (Implementation.BirthdayBook.Valid $Heap@0 this@@2) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Implementation.BirthdayBook.known)) (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Implementation.BirthdayBook.birthday)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (forall (($o@@11 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Implementation.BirthdayBook.Repr)) ($Box refType $o@@11)) (or (not (= $o@@11 null)) (not true)))
 :qid |ZBirthdayBookdfy.152:17|
 :skolemid |1086|
 :pattern (  (or (not (= $o@@11 null)) (not true)))
)) (forall (($o@@12 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Implementation.BirthdayBook.Repr)) ($Box refType $o@@12)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@12) alloc)))))
 :qid |ZBirthdayBookdfy.152:17|
 :skolemid |1087|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Implementation.BirthdayBook.Repr)) ($Box refType $o@@12)))
)))) (=> (and (forall (($o@@13 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Implementation.BirthdayBook.Repr)) ($Box refType $o@@13)) (or (not (= $o@@13 null)) (not true)))
 :qid |ZBirthdayBookdfy.152:17|
 :skolemid |1086|
 :pattern (  (or (not (= $o@@13 null)) (not true)))
)) (forall (($o@@14 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Implementation.BirthdayBook.Repr)) ($Box refType $o@@14)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@14) alloc)))))
 :qid |ZBirthdayBookdfy.152:17|
 :skolemid |1087|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Implementation.BirthdayBook.Repr)) ($Box refType $o@@14)))
))) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Implementation.BirthdayBook.known)) |Set#Empty|))))))))))))))
