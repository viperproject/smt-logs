...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split162)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon46_correct  (=> (and (and (and (and (and (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| |l#0@3|)) (<= |l#0@3| |n#0@3|)) (<= |n#0@3| (_System.array.Length |a#0@@4|))) ($IsAlloc refType $nw@0 (Tclass._System.array TInt) $Heap@5)) (and ($IsAlloc intType (int_2_U |k#0@0|) TInt $Heap@5) ($IsAlloc intType (int_2_U |l#0@3|) TInt $Heap@5))) (and (and (= |##lo#3@0| (- |n#0@3| |W#0|)) ($IsAlloc intType (int_2_U |##lo#3@0|) TInt $Heap@5)) (and ($IsAlloc intType (int_2_U |n#0@3|) TInt $Heap@5) (= (ControlFlow 0 2) (- 0 1))))) (<= (LitInt 0) |k#0@0|))))
