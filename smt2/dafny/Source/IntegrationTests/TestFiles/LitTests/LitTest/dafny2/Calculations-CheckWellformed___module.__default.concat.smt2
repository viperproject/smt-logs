...
(let ((anon10_Then_correct  (=> (and (and (= |l#0@@5| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) ($IsBox |_mcc#0#0| _module._default.concat$_T0@@4)) (and ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List _module._default.concat$_T0@@4)) (= |let#0#0#0| |_mcc#1#0|))) (=> (and (and (and ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List _module._default.concat$_T0@@4)) (= |xs#Z#0@0| |let#0#0#0|)) (and (= |let#1#0#0| |_mcc#0#0|) ($IsBox |let#1#0#0| _module._default.concat$_T0@@4))) (and (and (= |x#Z#0@0| |let#1#0#0|) ($IsAlloc DatatypeTypeType |xs#Z#0@0| (Tclass._module.List _module._default.concat$_T0@@4) $Heap@@0)) (and ($IsAlloc DatatypeTypeType |ys#0@@4| (Tclass._module.List _module._default.concat$_T0@@4) $Heap@@0) (= (ControlFlow 0 4) (- 0 3))))) (or (< (DtRank |xs#Z#0@0|) (DtRank |l#0@@5|)) (and (= (DtRank |xs#Z#0@0|) (DtRank |l#0@@5|)) (< (DtRank |ys#0@@4|) (DtRank |ys#0@@4|))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is DatatypeTypeType |l#0@@5| (Tclass._module.List _module._default.concat$_T0@@4)) ($Is DatatypeTypeType |ys#0@@4| (Tclass._module.List _module._default.concat$_T0@@4))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
