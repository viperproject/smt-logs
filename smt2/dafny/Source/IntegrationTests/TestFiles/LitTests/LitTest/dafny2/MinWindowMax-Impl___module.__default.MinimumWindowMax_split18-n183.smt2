...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split184)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon117_Then_correct  (=> (and (and (and (< |k#0@0| |u#2@0|) (< |u#2@0| |l#0@3|)) (and ($IsAlloc refType |a#0@@4| (Tclass._System.array TInt) $Heap@5) (or (not (= $nw@0 null)) (not true)))) (and (and (= |##lo#5@0| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |u#2@0| 1))))) 1)) ($IsAlloc intType (int_2_U |##lo#5@0|) TInt $Heap@5)) (and (or (not (= $nw@0 null)) (not true)) (= (ControlFlow 0 2) (- 0 1))))) (and (<= 0 |u#2@0|) (< |u#2@0| (_System.array.Length $nw@0))))))
