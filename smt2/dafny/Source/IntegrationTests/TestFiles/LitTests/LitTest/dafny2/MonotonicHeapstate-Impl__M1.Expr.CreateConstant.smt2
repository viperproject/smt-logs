...
(assert (forall ((a@@2 T@U) (b T@U) ) (! (= (|M1.Kind#Equal| a@@2 b) (= a@@2 b))
 :qid |unknown.0:0|
 :skolemid |1140|
 :pattern ( (|M1.Kind#Equal| a@@2 b))
)))
...
(assert (forall ((a@@6 T@U) (b@@3 T@U) ) (!  (=> (and (M1.Kind.Constant_q a@@6) (M1.Kind.Constant_q b@@3)) (|M1.Kind#Equal| a@@6 b@@3))
 :qid |unknown.0:0|
 :skolemid |1137|
 :pattern ( (|M1.Kind#Equal| a@@6 b@@3) (M1.Kind.Constant_q a@@6))
 :pattern ( (|M1.Kind#Equal| a@@6 b@@3) (M1.Kind.Constant_q b@@3))
)))
(assert (forall ((a@@7 T@U) (b@@4 T@U) ) (!  (=> (and (M1.Kind.Ident_q a@@7) (M1.Kind.Ident_q b@@4)) (|M1.Kind#Equal| a@@7 b@@4))
 :qid |unknown.0:0|
 :skolemid |1138|
 :pattern ( (|M1.Kind#Equal| a@@7 b@@4) (M1.Kind.Ident_q a@@7))
 :pattern ( (|M1.Kind#Equal| a@@7 b@@4) (M1.Kind.Ident_q b@@4))
)))
(assert (forall ((a@@8 T@U) (b@@5 T@U) ) (!  (=> (and (M1.Kind.Binary_q a@@8) (M1.Kind.Binary_q b@@5)) (|M1.Kind#Equal| a@@8 b@@5))
 :qid |unknown.0:0|
 :skolemid |1139|
 :pattern ( (|M1.Kind#Equal| a@@8 b@@5) (M1.Kind.Binary_q a@@8))
 :pattern ( (|M1.Kind#Equal| a@@8 b@@5) (M1.Kind.Binary_q b@@5))
)))
...
(set-info :boogie-vc-id Impl$$M1.Expr.CreateConstant)
