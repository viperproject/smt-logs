...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.MinimumWindowMax_split5)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon8_correct  (=> (and (<= (LitInt 0) |s#0@0|) (<= |s#0@0| (- (_System.array.Length |a#0@@2|) |W#0|))) (=> (and (and ($IsAlloc refType |a#0@@2| (Tclass._System.array TInt) $Heap@0) ($IsAlloc intType (int_2_U |s#0@0|) TInt $Heap@0)) (and ($IsAlloc intType (int_2_U |W#0|) TInt $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (<= (+ |s#0@0| |W#0|) (_System.array.Length |a#0@@2|))))))
(let ((anon14_Else_correct  (=> (and (< |s#0@0| (LitInt 0)) (= (ControlFlow 0 4) 2)) anon8_correct)))
(let ((anon14_Then_correct  (=> (<= (LitInt 0) |s#0@0|) (=> (and (or (not (= |a#0@@2| null)) (not true)) (= (ControlFlow 0 3) 2)) anon8_correct))))
(let ((anon5_correct  (=> (and (and (and (and (<= (LitInt 0) |start#0@0|) (<= |start#0@0| (- (_System.array.Length |a#0@@2|) |W#0|))) ($IsAlloc refType |a#0@@2| (Tclass._System.array TInt) $Heap@0)) (and ($IsAlloc intType (int_2_U |start#0@0|) TInt $Heap@0) ($IsAlloc intType (int_2_U |W#0|) TInt $Heap@0))) (and (and (and (<= (LitInt 0) |start#0@0|) (<= (LitInt 1) |W#0|)) (<= (+ |start#0@0| |W#0|) (_System.array.Length |a#0@@2|))) (and (|_module.__default.Max#canCall| $Heap@0 |a#0@@2| |start#0@0| |W#0|) (= |m#0@0| (_module.__default.Max ($LS $LZ) $Heap@0 |a#0@@2| |start#0@0| |W#0|))))) (and (=> (= (ControlFlow 0 5) 3) anon14_Then_correct) (=> (= (ControlFlow 0 5) 4) anon14_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (< |start#0@0| (LitInt 0)) (= (ControlFlow 0 7) 5)) anon5_correct)))
(let ((anon12_Then_correct  (=> (<= (LitInt 0) |start#0@0|) (=> (and (or (not (= |a#0@@2| null)) (not true)) (= (ControlFlow 0 6) 5)) anon5_correct))))
(let ((anon3_correct  (=> (and (<= (LitInt 1) |W#0|) (<= |W#0| (_System.array.Length |a#0@@2|))) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@7 T@U) ) (!  (=> (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@7) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@7)))
 :qid |MinWindowMaxdfy.28:56|
 :skolemid |657|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7))
)) ($HeapSucc $Heap@@1 $Heap@0))) (and (=> (= (ControlFlow 0 8) 6) anon12_Then_correct) (=> (= (ControlFlow 0 8) 7) anon12_Else_correct))))))
(let ((anon11_Else_correct  (=> (and (< |W#0| (LitInt 1)) (= (ControlFlow 0 10) 8)) anon3_correct)))
(let ((anon11_Then_correct  (=> (<= (LitInt 1) |W#0|) (=> (and (or (not (= |a#0@@2| null)) (not true)) (= (ControlFlow 0 9) 8)) anon3_correct))))
(let ((anon0_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and ($Is refType |a#0@@2| (Tclass._System.array TInt)) ($IsAlloc refType |a#0@@2| (Tclass._System.array TInt) $Heap@@1)) (and (= 3 $FunctionContextHeight) (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)))) (and (=> (= (ControlFlow 0 11) 9) anon11_Then_correct) (=> (= (ControlFlow 0 11) 10) anon11_Else_correct))))))
anon0_correct)))))))))))
))
(check-sat)
(get-info :rlimit)
