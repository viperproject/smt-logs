...
(assert (distinct TBool TagBool alloc Tagclass._System.___hFunc1 Tagclass._module.Tree? Tagclass._module.Tree |tytagFamily$_#Func1| tytagFamily$Tree)
)
...
(assert (forall ((|c#0| T@U) ($h T@U) ) (! (= ($IsAlloc refType |c#0| Tclass._module.Tree $h) ($IsAlloc refType |c#0| Tclass._module.Tree? $h))
 :qid |unknown.0:0|
 :skolemid |532|
 :pattern ( ($IsAlloc refType |c#0| Tclass._module.Tree $h))
 :pattern ( ($IsAlloc refType |c#0| Tclass._module.Tree? $h))
)))
...
(assert (forall (($o@@0 T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType $o@@0 Tclass._module.Tree? $h@@0)  (or (= $o@@0 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@0 $o@@0) alloc)))))
 :qid |unknown.0:0|
 :skolemid |481|
 :pattern ( ($IsAlloc refType $o@@0 Tclass._module.Tree? $h@@0))
)))
...
(assert (forall ((bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 Tclass._module.Tree?) (and (= ($Box refType ($Unbox refType bx@@1)) bx@@1) ($Is refType ($Unbox refType bx@@1) Tclass._module.Tree?)))
 :qid |unknown.0:0|
 :skolemid |479|
 :pattern ( ($IsBox bx@@1 Tclass._module.Tree?))
)))
(assert (forall ((bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 Tclass._module.Tree) (and (= ($Box refType ($Unbox refType bx@@2)) bx@@2) ($Is refType ($Unbox refType bx@@2) Tclass._module.Tree)))
 :qid |unknown.0:0|
 :skolemid |495|
 :pattern ( ($IsBox bx@@2 Tclass._module.Tree))
)))
(assert (forall ((|c#0@@0| T@U) ) (! (= ($Is refType |c#0@@0| Tclass._module.Tree)  (and ($Is refType |c#0@@0| Tclass._module.Tree?) (or (not (= |c#0@@0| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |531|
 :pattern ( ($Is refType |c#0@@0| Tclass._module.Tree))
 :pattern ( ($Is refType |c#0@@0| Tclass._module.Tree?))
)))
...
(declare-fun |P#0| () T@U)
(declare-fun _module.Tree.exists_intro$T () T@U)
(declare-fun |x#0| () T@U)
...
(set-info :boogie-vc-id CheckWellFormed$$_module.Tree.exists__intro)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#2| null $Heap alloc false)) ($IsAllocBox ($Box HandleTypeType |P#0|) (Tclass._System.___hFunc1 _module.Tree.exists_intro$T TBool) $Heap)) (and ($IsAllocBox |x#0| _module.Tree.exists_intro$T $Heap) (Requires1 _module.Tree.exists_intro$T TBool $Heap |P#0| |x#0|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (Requires1 _module.Tree.exists_intro$T TBool $Heap |P#0| |x#0|)) (=> (Requires1 _module.Tree.exists_intro$T TBool $Heap |P#0| |x#0|) (=> (U_2_bool ($Unbox boolType (Apply1 _module.Tree.exists_intro$T TBool $Heap |P#0| |x#0|))) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and ($IsBox |y#0@0| _module.Tree.exists_intro$T) ($IsAllocBox |y#0@0| _module.Tree.exists_intro$T $Heap@0))) (and (and ($IsAllocBox ($Box HandleTypeType |P#0|) (Tclass._System.___hFunc1 _module.Tree.exists_intro$T TBool) $Heap@0) ($IsAllocBox |y#0@0| _module.Tree.exists_intro$T $Heap@0)) (and (Requires1 _module.Tree.exists_intro$T TBool $Heap@0 |P#0| |y#0@0|) (= (ControlFlow 0 2) (- 0 1))))) (Requires1 _module.Tree.exists_intro$T TBool $Heap@0 |P#0| |y#0@0|))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.Tree) ($IsAlloc refType this Tclass._module.Tree $Heap))) (and ($Is HandleTypeType |P#0| (Tclass._System.___hFunc1 _module.Tree.exists_intro$T TBool)) ($IsAlloc HandleTypeType |P#0| (Tclass._System.___hFunc1 _module.Tree.exists_intro$T TBool) $Heap))) (and (and ($IsBox |x#0| _module.Tree.exists_intro$T) ($IsAllocBox |x#0| _module.Tree.exists_intro$T $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct))))
