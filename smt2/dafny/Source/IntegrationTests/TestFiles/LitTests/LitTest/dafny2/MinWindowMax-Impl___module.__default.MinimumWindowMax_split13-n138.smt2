...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split139)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon79_correct  (=> (and (and (not (and (<= |k#0@0| (- |l#0@4| 1)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1))))))))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField |n#0@3|))))))) (or (not (= $nw@0 null)) (not true))) (and (<= 0 |l#0@4|) (< |l#0@4| (_System.array.Length $nw@0)))) (=> (and (and (and (= $index0@3 (IndexField |l#0@4|)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 $index0@3))) (and (= |$rhs#1_1@1| (+ |l#0@4| 1)) (= $Heap@6 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) $index0@3 ($Box intType (int_2_U |n#0@3|))))))) (and (and ($IsGoodHeap $Heap@6) (< |k#0@0| (- |$rhs#1_1@1| 1))) (and (or (not (= $nw@0 null)) (not true)) (= (ControlFlow 0 2) (- 0 1))))) (and (<= 0 |k#0@0|) (< |k#0@0| (_System.array.Length $nw@0)))))))
