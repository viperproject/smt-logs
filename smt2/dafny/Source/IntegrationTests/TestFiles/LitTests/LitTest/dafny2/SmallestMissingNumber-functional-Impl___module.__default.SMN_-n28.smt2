...
(assert (forall ((a@@13 T@U) (b@@10 T@U) ) (!  (=> (and (_module.List.Nil_q a@@13) (_module.List.Nil_q b@@10)) (|_module.List#Equal| a@@13 b@@10))
 :qid |unknown.0:0|
 :skolemid |775|
 :pattern ( (|_module.List#Equal| a@@13 b@@10) (_module.List.Nil_q a@@13))
 :pattern ( (|_module.List#Equal| a@@13 b@@10) (_module.List.Nil_q b@@10))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.SMN_k_k__Correct_split8)
...
(_module.__default.NoDuplicates Tclass._System.nat ($LS ($LS $LZ)) |tail#0@@4|)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))))) (and (and (and (and (and (|_module.__default.Split#canCall| |xs#0@@15| |b##1_0@0|) (let ((|r#0@@0| (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@15| |b##1_0@0|)))
...
(let ((|x#0@@4| (_module.List.head |L#1_0@0|)))
 (not (|Set#IsMember| (_module.__default.Elements call0formal@_module._default.Elements_Property$_T0@0 ($LS ($LS $LZ)) |tail#0@@5|) |x#0@@4|))))))) (= (ControlFlow 0 2) (- 0 1))) (|_module.__default.NoDuplicates#canCall| call0formal@_module._default.Elements_Property$_T0@0 |L#1_0@0|))))) (or (_module.__default.NoDuplicates call0formal@_module._default.Elements_Property$_T0@0 ($LS $LZ) |L#1_0@0|) (=> (not (_module.List.Nil_q |L#1_0@0|)) (let ((|tail#0@@6| (_module.List.tail |L#1_0@0|)))
(_module.__default.NoDuplicates call0formal@_module._default.Elements_Property$_T0@0 ($LS ($LS $LZ)) |tail#0@@6|))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
