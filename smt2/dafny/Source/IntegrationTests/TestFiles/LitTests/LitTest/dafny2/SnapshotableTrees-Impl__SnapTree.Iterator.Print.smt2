...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 34) (let ((anon5_correct  (=> (and (=> |more#0@0| (and (<= (LitInt 0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@9) SnapTree.Iterator.N)))) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@9) SnapTree.Iterator.N))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@9) SnapTree.Iterator.Contents)))))) (= (ControlFlow 0 18) (- 0 17))) ($IsAlloc refType this@@9 Tclass.SnapTree.Iterator $Heap@@11))))
(let ((anon13_Else_correct  (=> (and (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@9) SnapTree.Iterator.N))) (LitInt 0)) (= (ControlFlow 0 21) 18)) anon5_correct)))
(let ((anon13_Then_correct  (=> (and (<= (LitInt 0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@9) SnapTree.Iterator.N)))) (= (ControlFlow 0 20) 18)) anon5_correct)))
(let ((anon12_Then_correct  (=> |more#0@0| (and (=> (= (ControlFlow 0 22) 20) anon13_Then_correct) (=> (= (ControlFlow 0 22) 21) anon13_Else_correct)))))
...
(let ((anon11_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 16) 2) anon14_Then_correct) (=> (= (ControlFlow 0 16) 4) anon14_Else_correct)))))
