...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@1 T@U) (|xs#0@@1| T@U) (|n#0| Int) (|len#0| Int) ) (!  (=> (or (|_module.__default.SMN_k#canCall| |xs#0@@1| |n#0| (LitInt |len#0|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |xs#0@@1| (Tclass._module.List Tclass._System.nat)) (<= (LitInt 0) |n#0|)) (<= (LitInt 0) |len#0|)) (= (LitInt |len#0|) (_module.__default.Length Tclass._System.nat ($LS $LZ) |xs#0@@1|))))) (and (and (|$IsA#_module.List| |xs#0@@1|) (=> (not (|_module.List#Equal| |xs#0@@1| |#_module.List.Nil|)) (let ((|half#1| (LitInt (Div (+ |len#0| 1) (LitInt 2)))))
 (and (|_module.__default.Split#canCall| |xs#0@@1| (+ |n#0| |half#1|)) (let ((|R#1| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@1| (+ |n#0| |half#1|))))))
(let ((|L#1| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@1| (+ |n#0| |half#1|))))))
 ...
 (and (=> (< |llen#1| |half#1|) (|_module.__default.SMN_k#canCall| |L#1| |n#0| |llen#1|)) (=> (<= |half#1| |llen#1|) (|_module.__default.SMN_k#canCall| |R#1| (+ |n#0| |llen#1|) (- |len#0| |llen#1|)))))))))))) (= (_module.__default.SMN_k ($LS $ly@@1) |xs#0@@1| |n#0| (LitInt |len#0|)) (ite (|_module.List#Equal| |xs#0@@1| |#_module.List.Nil|) |n#0| (let ((|half#1@@0| (LitInt (Div (+ |len#0| 1) (LitInt 2)))))
(let ((|R#1@@0| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@1| (+ |n#0| |half#1@@0|))))))
(let ((|L#1@@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@1| (+ |n#0| |half#1@@0|))))))
(let ((|llen#1@@0| (_module.__default.Length Tclass._System.nat ($LS $LZ) |L#1@@0|)))
(ite (< |llen#1@@0| |half#1@@0|) (_module.__default.SMN_k ($LS $ly@@1) |L#1@@0| |n#0| |llen#1@@0|) (_module.__default.SMN_k ($LS $ly@@1) |R#1@@0| (+ |n#0| |llen#1@@0|) (- |len#0| |llen#1@@0|)))))))))))
 :qid |SmallestMissingNumberfunctionaldfy.58:10|
 :weight 3
 :skolemid |617|
 :pattern ( (_module.__default.SMN_k ($LS $ly@@1) |xs#0@@1| |n#0| (LitInt |len#0|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@4 T@U) (|xs#0@@4| T@U) (|n#0@@0| Int) (|len#0@@0| Int) ) (!  (=> (or (|_module.__default.SMN_k#canCall| |xs#0@@4| |n#0@@0| |len#0@@0|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |xs#0@@4| (Tclass._module.List Tclass._System.nat)) (<= (LitInt 0) |n#0@@0|)) (<= (LitInt 0) |len#0@@0|)) (= |len#0@@0| (_module.__default.Length Tclass._System.nat ($LS $LZ) |xs#0@@4|))))) (and (and (|$IsA#_module.List| |xs#0@@4|) (=> (not (|_module.List#Equal| |xs#0@@4| |#_module.List.Nil|)) (let ((|half#0| (Div (+ |len#0@@0| 1) (LitInt 2))))
 (and (|_module.__default.Split#canCall| |xs#0@@4| (+ |n#0@@0| |half#0|)) (let ((|R#0| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@4| (+ |n#0@@0| |half#0|))))))
(let ((|L#0| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@4| (+ |n#0@@0| |half#0|))))))
 ...
 (and (=> (< |llen#0| |half#0|) (|_module.__default.SMN_k#canCall| |L#0| |n#0@@0| |llen#0|)) (=> (<= |half#0| |llen#0|) (|_module.__default.SMN_k#canCall| |R#0| (+ |n#0@@0| |llen#0|) (- |len#0@@0| |llen#0|)))))))))))) (= (_module.__default.SMN_k ($LS $ly@@4) |xs#0@@4| |n#0@@0| |len#0@@0|) (ite (|_module.List#Equal| |xs#0@@4| |#_module.List.Nil|) |n#0@@0| (let ((|half#0@@0| (Div (+ |len#0@@0| 1) (LitInt 2))))
(let ((|R#0@@0| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@4| (+ |n#0@@0| |half#0@@0|))))))
(let ((|L#0@@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@4| (+ |n#0@@0| |half#0@@0|))))))
(let ((|llen#0@@0| (_module.__default.Length Tclass._System.nat ($LS $LZ) |L#0@@0|)))
(ite (< |llen#0@@0| |half#0@@0|) (_module.__default.SMN_k $ly@@4 |L#0@@0| |n#0@@0| |llen#0@@0|) (_module.__default.SMN_k $ly@@4 |R#0@@0| (+ |n#0@@0| |llen#0@@0|) (- |len#0@@0| |llen#0@@0|)))))))))))
 :qid |SmallestMissingNumberfunctionaldfy.58:10|
 :skolemid |616|
 :pattern ( (_module.__default.SMN_k ($LS $ly@@4) |xs#0@@4| |n#0@@0| |len#0@@0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@5 T@U) (|xs#0@@5| T@U) (|b#0@@0| Int) ) (!  (=> (or (|_module.__default.Split#canCall| (Lit DatatypeTypeType |xs#0@@5|) (LitInt |b#0@@0|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@5| (Tclass._module.List Tclass._System.nat)) (<= (LitInt 0) |b#0@@0|)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@5|)))))) (let ((|tail#3@@0| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@5|)))))
(|_module.__default.Split#canCall| |tail#3@@0| (LitInt |b#0@@0|)))) (= (_module.__default.Split ($LS $ly@@5) true (Lit DatatypeTypeType |xs#0@@5|) (LitInt |b#0@@0|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@5|)) (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.List.Nil|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.List.Nil|))) (let ((|tail#2@@0| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@5|)))))
(let ((|x#2| (LitInt (U_2_int ($Unbox intType (_module.List.head (Lit DatatypeTypeType |xs#0@@5|)))))))
(let ((|R#2| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $ly@@5) reveal__module._default.Split |tail#2@@0| (LitInt |b#0@@0|))))))
(let ((|L#2| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $ly@@5) reveal__module._default.Split |tail#2@@0| (LitInt |b#0@@0|))))))
(ite (< |x#2| |b#0@@0|) (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U |x#2|)) |L#2|)) ($Box DatatypeTypeType |R#2|)) (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |L#2|) ($Box DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U |x#2|)) |R#2|))))))))))))
 :qid |SmallestMissingNumberfunctionaldfy.93:17|
 :weight 3
 :skolemid |641|
 :pattern ( (_module.__default.Split ($LS $ly@@5) true (Lit DatatypeTypeType |xs#0@@5|) (LitInt |b#0@@0|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@6 T@U) (|xs#0@@6| T@U) (|b#0@@1| Int) ) (!  (=> (or (|_module.__default.Split#canCall| |xs#0@@6| |b#0@@1|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@6| (Tclass._module.List Tclass._System.nat)) (<= (LitInt 0) |b#0@@1|)))) (and (=> (not (_module.List.Nil_q |xs#0@@6|)) (let ((|tail#1@@0| (_module.List.tail |xs#0@@6|)))
(|_module.__default.Split#canCall| |tail#1@@0| |b#0@@1|))) (= (_module.__default.Split ($LS $ly@@6) true |xs#0@@6| |b#0@@1|) (ite (_module.List.Nil_q |xs#0@@6|) (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.List.Nil|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.List.Nil|))) (let ((|tail#0@@0| (_module.List.tail |xs#0@@6|)))
(let ((|x#0@@1| (U_2_int ($Unbox intType (_module.List.head |xs#0@@6|)))))
(let ((|R#0@@1| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split $ly@@6 reveal__module._default.Split |tail#0@@0| |b#0@@1|)))))
(let ((|L#0@@1| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split $ly@@6 reveal__module._default.Split |tail#0@@0| |b#0@@1|)))))
(ite (< |x#0@@1| |b#0@@1|) (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U |x#0@@1|)) |L#0@@1|)) ($Box DatatypeTypeType |R#0@@1|)) (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |L#0@@1|) ($Box DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U |x#0@@1|)) |R#0@@1|))))))))))))
 :qid |SmallestMissingNumberfunctionaldfy.93:17|
 :skolemid |640|
 :pattern ( (_module.__default.Split ($LS $ly@@6) true |xs#0@@6| |b#0@@1|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@7 T@U) (|xs#0@@7| T@U) (|n#0@@1| Int) (|len#0@@1| Int) ) (!  (=> (or (|_module.__default.SMN_k#canCall| |xs#0@@7| |n#0@@1| |len#0@@1|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |xs#0@@7| (Tclass._module.List Tclass._System.nat)) (<= (LitInt 0) |n#0@@1|)) (<= (LitInt 0) |len#0@@1|)) (= |len#0@@1| (_module.__default.Length Tclass._System.nat ($LS $LZ) |xs#0@@7|))))) (<= (LitInt 0) (_module.__default.SMN_k $ly@@7 |xs#0@@7| |n#0@@1| |len#0@@1|)))
 :qid |SmallestMissingNumberfunctionaldfy.58:10|
 :skolemid |614|
 :pattern ( (_module.__default.SMN_k $ly@@7 |xs#0@@7| |n#0@@1| |len#0@@1|))
))))
...
(assert (forall (($ly@@8 T@U) (|xs#0@@8| T@U) (|n#0@@2| Int) (|len#0@@2| Int) ) (! (= (_module.__default.SMN_k ($LS $ly@@8) |xs#0@@8| |n#0@@2| |len#0@@2|) (_module.__default.SMN_k $ly@@8 |xs#0@@8| |n#0@@2| |len#0@@2|))
 :qid |SmallestMissingNumberfunctionaldfy.58:10|
 :skolemid |612|
 :pattern ( (_module.__default.SMN_k ($LS $ly@@8) |xs#0@@8| |n#0@@2| |len#0@@2|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@10 T@U) (|xs#0@@10| T@U) (|n#0@@3| Int) (|len#0@@3| Int) ) (!  (=> (or (|_module.__default.SMN_k#canCall| (Lit DatatypeTypeType |xs#0@@10|) (LitInt |n#0@@3|) (LitInt |len#0@@3|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |xs#0@@10| (Tclass._module.List Tclass._System.nat)) (<= (LitInt 0) |n#0@@3|)) (<= (LitInt 0) |len#0@@3|)) (= (LitInt |len#0@@3|) (LitInt (_module.__default.Length Tclass._System.nat ($LS $LZ) (Lit DatatypeTypeType |xs#0@@10|))))))) (and (and (|$IsA#_module.List| (Lit DatatypeTypeType |xs#0@@10|)) (=> (not (|_module.List#Equal| |xs#0@@10| |#_module.List.Nil|)) (let ((|half#2| (LitInt (Div (+ |len#0@@3| 1) (LitInt 2)))))
 (and (|_module.__default.Split#canCall| (Lit DatatypeTypeType |xs#0@@10|) (+ |n#0@@3| |half#2|)) (let ((|R#2@@0| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) reveal__module._default.Split (Lit DatatypeTypeType |xs#0@@10|) (+ |n#0@@3| |half#2|))))))
(let ((|L#2@@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $LZ) reveal__module._default.Split (Lit DatatypeTypeType |xs#0@@10|) (+ |n#0@@3| |half#2|))))))
 ...
 (and (=> (< |llen#2| |half#2|) (|_module.__default.SMN_k#canCall| |L#2@@0| (LitInt |n#0@@3|) |llen#2|)) (=> (<= |half#2| |llen#2|) (|_module.__default.SMN_k#canCall| |R#2@@0| (+ |n#0@@3| |llen#2|) (- |len#0@@3| |llen#2|)))))))))))) (= (_module.__default.SMN_k ($LS $ly@@10) (Lit DatatypeTypeType |xs#0@@10|) (LitInt |n#0@@3|) (LitInt |len#0@@3|)) (ite (|_module.List#Equal| |xs#0@@10| |#_module.List.Nil|) |n#0@@3| (let ((|half#2@@0| (LitInt (Div (+ |len#0@@3| 1) (LitInt 2)))))
(let ((|R#2@@1| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split ($LS $LZ) reveal__module._default.Split (Lit DatatypeTypeType |xs#0@@10|) (LitInt (+ |n#0@@3| |half#2@@0|)))))))
(let ((|L#2@@1| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split ($LS $LZ) reveal__module._default.Split (Lit DatatypeTypeType |xs#0@@10|) (LitInt (+ |n#0@@3| |half#2@@0|)))))))
(let ((|llen#2@@0| (_module.__default.Length Tclass._System.nat ($LS $LZ) |L#2@@1|)))
(ite (< |llen#2@@0| |half#2@@0|) (_module.__default.SMN_k ($LS $ly@@10) |L#2@@1| (LitInt |n#0@@3|) |llen#2@@0|) (_module.__default.SMN_k ($LS $ly@@10) |R#2@@1| (+ |n#0@@3| |llen#2@@0|) (- |len#0@@3| |llen#2@@0|)))))))))))
 :qid |SmallestMissingNumberfunctionaldfy.58:10|
 :weight 3
 :skolemid |618|
 :pattern ( (_module.__default.SMN_k ($LS $ly@@10) (Lit DatatypeTypeType |xs#0@@10|) (LitInt |n#0@@3|) (LitInt |len#0@@3|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.Length$_T0@@2 T@U) ($ly@@11 T@U) (|xs#0@@11| T@U) ) (!  (=> (or (|_module.__default.Length#canCall| _module._default.Length$_T0@@2 |xs#0@@11|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@11| (Tclass._module.List _module._default.Length$_T0@@2)))) (<= (LitInt 0) (_module.__default.Length _module._default.Length$_T0@@2 $ly@@11 |xs#0@@11|)))
 :qid |unknown.0:0|
 :skolemid |589|
 :pattern ( (_module.__default.Length _module._default.Length$_T0@@2 $ly@@11 |xs#0@@11|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.SMN_k)
