...
(set-info :boogie-vc-id CheckWellFormed$$_module.Node.Lemma__NullIsTerminal)
...
(let ((anon4_correct  (=> (and (and (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| |d#0|)) ($IsAllocBox ($Box refType this@@4) Tclass._module.Node? $Heap@0)) (and ($IsAlloc intType (int_2_U |d#0|) TInt $Heap@0) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Node?) $Heap@0))) (and (=> (= (ControlFlow 0 3) (- 0 11)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType this@@4))))) (and (=> (= (ControlFlow 0 3) (- 0 10)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType null))))) (and (=> (= (ControlFlow 0 3) (- 0 9)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (forall ((|n#0@@0| T@U) ) (!  (=> ($Is refType |n#0@@0| Tclass._module.Node?) (=> (and (and (|Set#IsMember| |S#0@@4| ($Box refType |n#0@@0|)) (or (not (= |n#0@@0| null)) (not true))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0@@0|) _module.Node.next)) null)) (not true))) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0@@0|) _module.Node.next))))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.133:12|
 :skolemid |803|
...
))))) (and (=> (= (ControlFlow 0 3) (- 0 8)) (<= (LitInt 0) |d#0|)) (=> (and (and (and (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (<= (LitInt 0) |d#0|)) (|_module.Node.Nexxxt#canCall| $Heap@0 this@@4 |d#0| |S#0@@4|)) (and (and (or (not (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |d#0| |S#0@@4|) null)) (not true)) ($IsAllocBox ($Box refType this@@4) Tclass._module.Node? $Heap@0)) (and ($IsAlloc intType (int_2_U |k#0@0|) TInt $Heap@0) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Node?) $Heap@0)))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType this@@4))))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType null))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (forall ((|n#1| T@U) ) (!  (=> ($Is refType |n#1| Tclass._module.Node?) (=> (and (and (|Set#IsMember| |S#0@@4| ($Box refType |n#1|)) (or (not (= |n#1| null)) (not true))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#1|) _module.Node.next)) null)) (not true))) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#1|) _module.Node.next))))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.133:12|
 :skolemid |805|
...
))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= (LitInt 0) |k#0@0|)) (=> (and (and (and (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (<= (LitInt 0) |k#0@0|)) (|_module.Node.Nexxxt#canCall| $Heap@0 this@@4 |k#0@0| |S#0@@4|)) (and (or (not (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |k#0@0| |S#0@@4|) null)) (not true)) (= (ControlFlow 0 3) 1))) anon6_correct)))))))))))))
(let ((anon8_Else_correct  (=> (and (< |k#0@0| (LitInt 0)) (= (ControlFlow 0 13) 3)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (<= (LitInt 0) |k#0@0|) (= (ControlFlow 0 12) 3)) anon4_correct)))
(let ((anon7_Else_correct  (=> (and (=> (and (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| |d#0|)) (or (not (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |d#0| |S#0@@4|) null)) (not true))) (or (not (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |k#0@0| |S#0@@4|) null)) (not true))) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#3| null $Heap@@4 alloc false)) ($IsAllocBox ($Box refType this@@4) Tclass._module.Node? $Heap@@4)) (=> (and (and (and ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Node?) $Heap@@4) (|_module.Node.IsClosed#canCall| $Heap@@4 this@@4 |S#0@@4|)) (and (_module.Node.IsClosed $Heap@@4 this@@4 |S#0@@4|) (<= (LitInt 0) |d#0|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@4 $Heap@0))) (and (and (=> (= (ControlFlow 0 14) 2) anon7_Else_correct) (=> (= (ControlFlow 0 14) 12) anon8_Then_correct)) (=> (= (ControlFlow 0 14) 13) anon8_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.Node) ($IsAlloc refType this@@4 Tclass._module.Node $Heap@@4)))) (and (and ($Is SetType |S#0@@4| (TSet Tclass._module.Node?)) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Node?) $Heap@@4)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 15) 14)))) anon0_correct)))
