...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@38 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#1| |l#0| |l#1| |l#2| |l#3|) $o@@38 $f))  (=> (and (or (not (= $o@@38 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@38) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1950|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#1| |l#0| |l#1| |l#2| |l#3|) $o@@38 $f))
)))
...
(set-info :boogie-vc-id Impl$$SnapTree.Iterator.Current)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (= |x#0@1| (U_2_int ($Unbox intType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@6) SnapTree.Iterator.Contents)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@6) SnapTree.Iterator.N))))))))))
(let ((anon4_Then_correct  (=> (= ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@6) SnapTree.Iterator.stack)) (|#SnapTree.List.Cons| |_mcc#0#0_0@0| |_mcc#1#0_0@0|)) (=> (and (and ($Is refType |_mcc#0#0_0@0| Tclass.SnapTree.Node) ($IsAlloc refType |_mcc#0#0_0@0| Tclass.SnapTree.Node $Heap@1)) (and ($Is DatatypeTypeType |_mcc#1#0_0@0| Tclass.SnapTree.List) ($IsAlloc DatatypeTypeType |_mcc#1#0_0@0| Tclass.SnapTree.List $Heap@1))) (=> (and (and (and (and ($Is DatatypeTypeType |rest#0_0@0| Tclass.SnapTree.List) ($IsAlloc DatatypeTypeType |rest#0_0@0| Tclass.SnapTree.List $Heap@1)) (= |let#0_0#0#0| |_mcc#1#0_0@0|)) (and ($Is DatatypeTypeType |let#0_0#0#0| Tclass.SnapTree.List) (= |rest#0_0@0| |let#0_0#0#0|))) (and (and (and ($Is refType |y#0_0@0| Tclass.SnapTree.Node) ($IsAlloc refType |y#0_0@0| Tclass.SnapTree.Node $Heap@1)) (= |let#0_1#0#0| |_mcc#0#0_0@0|)) (and ($Is refType |let#0_1#0#0| Tclass.SnapTree.Node) (= |y#0_0@0| |let#0_1#0#0|)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (not (= |y#0_0@0| null)) (not true))) (=> (or (not (= |y#0_0@0| null)) (not true)) (=> (= |x#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |y#0_0@0|) SnapTree.Node.data)))) (=> (and (= |x#0@1| |x#0@0|) (= (ControlFlow 0 7) 6)) GeneratedUnifiedExit_correct)))))))))
(let ((anon5_Else_correct true))
(let ((anon5_Then_correct  (=> (and (= ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@6) SnapTree.Iterator.stack)) |#SnapTree.List.Nil|) (= (ControlFlow 0 2) (- 0 1))) false)))
(let ((anon4_Else_correct  (=> (or (not (= ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@6) SnapTree.Iterator.stack)) (|#SnapTree.List.Cons| |_mcc#0#0_0@0| |_mcc#1#0_0@0|))) (not true)) (and (=> (= (ControlFlow 0 4) 2) anon5_Then_correct) (=> (= (ControlFlow 0 4) 3) anon5_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@11 alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@11 $Heap@0) reveal_SnapTree.Iterator.Valid)) (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (= $Heap@0 $Heap@1) reveal_SnapTree.Iterator.R))) (and (=> (= (ControlFlow 0 9) 7) anon4_Then_correct) (=> (= (ControlFlow 0 9) 4) anon4_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@11) ($IsHeapAnchor $Heap@@11)) (=> (and (and (and (or (not (= this@@6 null)) (not true)) (and ($Is refType this@@6 Tclass.SnapTree.Iterator) ($IsAlloc refType this@@6 Tclass.SnapTree.Iterator $Heap@@11))) (= 6 $FunctionContextHeight)) (and (and (SnapTree.Iterator.Valid reveal_SnapTree.Iterator.Valid $Heap@@11 this@@6) (<= (LitInt 0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@6) SnapTree.Iterator.N))))) (and (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@6) SnapTree.Iterator.N))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@6) SnapTree.Iterator.Contents)))) (= (ControlFlow 0 10) 9)))) anon0_correct))))
