...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split151)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon73_correct  (=> (forall ((|i#1_1| Int) ) (!  (=> (and (<= (ite (< |k#0@0| |l#0@4|) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1))))) 1) (- |n#0@3| |W#0|)) |i#1_1|) (< |i#1_1| |n#0@3|)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField |i#1_1|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField |n#0@3|))))))
...
)) (=> (and (<= |k#0@0| (- |l#0@4| 1)) (or (not (= |a#0@@4| null)) (not true))) (=> (and (and (and (<= 0 |n#0@3|) (< |n#0@3| (_System.array.Length |a#0@@4|))) (and (or (not (= |a#0@@4| null)) (not true)) (or (not (= $nw@0 null)) (not true)))) (and (and (<= 0 (- |l#0@4| 1)) (< (- |l#0@4| 1) (_System.array.Length $nw@0))) (= (ControlFlow 0 2) (- 0 1)))) (and (<= 0 (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1)))))) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1))))) (_System.array.Length |a#0@@4|))))))))
(let ((anon129_Else_correct  (=> (and (not (and (<= (ite (< |k#0@0| |l#0@4|) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1))))) 1) (- |n#0@3| |W#0|)) |i#1_0@0|) (< |i#1_0@0| |n#0@3|))) (= (ControlFlow 0 4) 2)) anon73_correct)))
(let ((anon129_Then_correct  (=> (and (and (and (<= (ite (< |k#0@0| |l#0@4|) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1))))) 1) (- |n#0@3| |W#0|)) |i#1_0@0|) (< |i#1_0@0| |n#0@3|)) (or (not (= |a#0@@4| null)) (not true))) (and (or (not (= |a#0@@4| null)) (not true)) (= (ControlFlow 0 3) 2))) anon73_correct)))
(let ((anon128_Else_correct  (=> (< |i#1_0@0| (ite (< |k#0@0| |l#0@4|) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1))))) 1) (- |n#0@3| |W#0|))) (and (=> (= (ControlFlow 0 6) 3) anon129_Then_correct) (=> (= (ControlFlow 0 6) 4) anon129_Else_correct)))))
(let ((anon128_Then_correct  (=> (<= (ite (< |k#0@0| |l#0@4|) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1))))) 1) (- |n#0@3| |W#0|)) |i#1_0@0|) (and (=> (= (ControlFlow 0 5) 3) anon129_Then_correct) (=> (= (ControlFlow 0 5) 4) anon129_Else_correct)))))
(let ((anon127_Else_correct  (=> (<= |l#0@4| |k#0@0|) (and (=> (= (ControlFlow 0 8) 5) anon128_Then_correct) (=> (= (ControlFlow 0 8) 6) anon128_Else_correct)))))
(let ((anon127_Then_correct  (=> (and (< |k#0@0| |l#0@4|) (or (not (= $nw@0 null)) (not true))) (and (=> (= (ControlFlow 0 7) 5) anon128_Then_correct) (=> (= (ControlFlow 0 7) 6) anon128_Else_correct)))))
(let ((anon65_correct  (=> (and (<= |k#0@0| |l#0@4|) (<= |l#0@4| |n#0@3|)) (and (=> (= (ControlFlow 0 9) 7) anon127_Then_correct) (=> (= (ControlFlow 0 9) 8) anon127_Else_correct)))))
(let ((anon125_Else_correct  (=> (and (< |l#0@4| |k#0@0|) (= (ControlFlow 0 11) 9)) anon65_correct)))
(let ((anon125_Then_correct  (=> (and (<= |k#0@0| |l#0@4|) (= (ControlFlow 0 10) 9)) anon65_correct)))
...
))) (and (<= (- (_System.array.Length |a#0@@4|) |n#0@3|) |$decr_init$loop#10@0|) |$w$loop#1@0|))) (and (and (and (or (not (= |a#0@@4| null)) (not true)) (< |n#0@3| (_System.array.Length |a#0@@4|))) (and (= |$decr$loop#10@1| (- (_System.array.Length |a#0@@4|) |n#0@3|)) (= |$decr_init$loop#1_00@1| (- (- |l#0@3| 1) |k#0@0|)))) (and (and (= |$decr_init$loop#1_01@1| (ite (<= |k#0@0| (- |l#0@3| 1)) (- (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField |n#0@3|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@3| 1)))))))))) (- 0 1))) (=> |$w$loop#1_0@1| (<= |k#0@0| |l#0@3|))) (and (=> |$w$loop#1_0@1| (<= |l#0@3| |n#0@3|)) (=> |$w$loop#1_0@1| (forall ((|i#1_1@@0| Int) ) (!  (=> (and (<= (ite (< |k#0@0| |l#0@3|) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@3| 1))))) 1) (- |n#0@3| |W#0|)) |i#1_1@@0|) (< |i#1_1@@0| |n#0@3|)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField |i#1_1@@0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField |n#0@3|))))))
 :qid |MinWindowMaxdfy.76:24|
 :skolemid |712|
...
))))))))) (and (and (and (and (and (and (and (and (and (and (and (and (not false) (= |$rhs#0@0| 0)) (<= 0 |k#0@0|)) (= |$rhs#1@0| 0)) (= |$rhs#2@0| 1)) (<= 1 |n#0@3|)) (<= 0 |$decr_init$loop#00@0|)) |$w$loop#0@0|) (= |lo##0@0| 0)) (<= 1 |n#0@1|)) |$w$loop#1@0|) (and (=> |$w$loop#1_0@1| (<= |k#0@0| |l#0@4|)) (=> |$w$loop#1_0@1| (<= |l#0@4| |n#0@3|)))) (and (and (and (=> |$w$loop#1_0@1| (forall ((|i#1_1@@1| Int) ) (!  (=> (and (<= (ite (< |k#0@0| |l#0@4|) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1))))) 1) (- |n#0@3| |W#0|)) |i#1_1@@1|) (< |i#1_1@@1| |n#0@3|)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField |i#1_1@@1|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField |n#0@3|))))))
 :qid |MinWindowMaxdfy.76:24|
 :skolemid |712|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField |i#1_1@@1|))))
