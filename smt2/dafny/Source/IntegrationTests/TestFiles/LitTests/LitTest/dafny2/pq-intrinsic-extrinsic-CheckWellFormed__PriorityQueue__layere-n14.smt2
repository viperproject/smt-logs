...
(assert (forall (($ly@@1 T@U) (|t#0@@1| T@U) ) (! (= (PriorityQueue__extrinsic.__default.Elements ($LS $ly@@1) |t#0@@1|) (PriorityQueue__extrinsic.__default.Elements $ly@@1 |t#0@@1|))
 :qid |pqintrinsicextrinsicdfy.199:18|
 :skolemid |1151|
...
(set-info :boogie-vc-id CheckWellFormed$$PriorityQueue__layered.T)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon6_Then_correct  (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and |PriorityQueue__extrinsic.__default.Empty#canCall| (let ((|t'#0| PriorityQueue__extrinsic.__default.Empty))
 (and (|PriorityQueue__extrinsic.__default.Valid#canCall| |t'#0|) (=> (PriorityQueue__extrinsic.__default.Valid ($LS $LZ) |t'#0|) (|PriorityQueue__extrinsic.__default.Elements#canCall| |t'#0|)))))) (=> (and (and (and (let ((|t'#0@@0| PriorityQueue__extrinsic.__default.Empty))
(PriorityQueue__extrinsic.__default.Valid ($LS ($LS $LZ)) |t'#0@@0|)) (let ((|t'#0@@1| PriorityQueue__extrinsic.__default.Empty))
(|MultiSet#Equal| (PriorityQueue__extrinsic.__default.Elements ($LS ($LS $LZ)) |t'#0@@1|) |MultiSet#Empty|))) (and (= $Heap@@0 $Heap@0) |PriorityQueue__extrinsic.__default.Empty#canCall|)) (and (and |PriorityQueue__extrinsic.__default.Empty#canCall| (|PriorityQueue__extrinsic.__default.Valid#canCall| PriorityQueue__extrinsic.__default.Empty)) (= (ControlFlow 0 3) (- 0 2)))) (PriorityQueue__extrinsic.__default.Valid ($LS ($LS $LZ)) PriorityQueue__extrinsic.__default.Empty)))))
