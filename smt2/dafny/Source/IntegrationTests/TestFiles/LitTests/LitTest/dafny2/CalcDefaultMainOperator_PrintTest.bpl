...
axiom {:id "id0"} 0 <= $FunctionContextHeight
   ==> 
  PrintTest.__default.Five#canCall() || 0 < $FunctionContextHeight
   ==> PrintTest.__default.Five() == LitInt(5);
...
procedure {:verboseName "PrintTest.Five (well-formedness)"} CheckWellformed$$PrintTest.__default.Five();
...
axiom {:id "id3"} 0 <= $FunctionContextHeight
   ==> 
  PrintTest.__default.Six#canCall() || 0 < $FunctionContextHeight
   ==> PrintTest.__default.Six() == LitInt(6);
...
procedure {:verboseName "PrintTest.Six (well-formedness)"} CheckWellformed$$PrintTest.__default.Six();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
axiom {:id "id6"} 1 <= $FunctionContextHeight
   ==> 
  PrintTest.__default.Ten#canCall() || 1 < $FunctionContextHeight
   ==> PrintTest.__default.Five#canCall()
     && PrintTest.__default.Six#canCall()
     && PrintTest.__default.Ten()
       == (var f#0 := LitInt(PrintTest.__default.Five()); 
        (var s#0 := LitInt(PrintTest.__default.Six()); LitInt(f#0 + f#0)));
...
axiom {:id "id7"} 1 <= $FunctionContextHeight
  ...
  PrintTest.__default.Ten#canCall() || 1 < $FunctionContextHeight
   ==> PrintTest.__default.Five#canCall()
     && PrintTest.__default.Six#canCall()
     && PrintTest.__default.Ten()
       == (var f#1 := LitInt(PrintTest.__default.Five()); 
        (var s#1 := LitInt(PrintTest.__default.Six()); LitInt(f#1 + f#1)));
}
...
procedure {:verboseName "PrintTest.Ten (well-formedness)"} CheckWellformed$$PrintTest.__default.Ten();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "PrintTest.Ten (well-formedness)"} CheckWellformed$$PrintTest.__default.Ten()
{
  ...
  var let#1#0#0: int;
    ...
    else
    {
        ...
        havoc f#Z#0;
        assume PrintTest.__default.Five#canCall();
        assume {:id "id8"} let#0#0#0 == LitInt(PrintTest.__default.Five());
        assume PrintTest.__default.Five#canCall();
        // CheckWellformedWithResult: any expression
        assume $Is(let#0#0#0, TInt);
        assume {:id "id9"} f#Z#0 == let#0#0#0;
        havoc s#Z#0;
        assume PrintTest.__default.Six#canCall();
        assume {:id "id10"} let#1#0#0 == LitInt(PrintTest.__default.Six());
        assume PrintTest.__default.Six#canCall();
        // CheckWellformedWithResult: any expression
        assume $Is(let#1#0#0, TInt);
        assume {:id "id11"} s#Z#0 == let#1#0#0;
        // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny2/CalcDefaultMainOperator.dfy(67,5)
        assume true;
        assert {:id "id12"} s#Z#0 == LitInt(6);
        assume {:id "id13"} PrintTest.__default.Ten() == f#Z#0 + f#Z#0;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(PrintTest.__default.Ten(), TInt);
        return;
...
axiom {:id "id14"} 1 <= $FunctionContextHeight
   ==> 
  PrintTest.__default.TenAgain#canCall() || 1 < $FunctionContextHeight
   ==> PrintTest.__default.Five#canCall()
     && PrintTest.__default.Six#canCall()
     && PrintTest.__default.TenAgain()
       == (var ten#0 := (var f#0 := LitInt(PrintTest.__default.Five()); 
            (var s#0 := LitInt(PrintTest.__default.Six()); LitInt(f#0 + f#0))); 
        ten#0);
...
axiom {:id "id15"} 1 <= $FunctionContextHeight
  ...
  PrintTest.__default.TenAgain#canCall() || 1 < $FunctionContextHeight
   ==> PrintTest.__default.Five#canCall()
     && PrintTest.__default.Six#canCall()
     && PrintTest.__default.TenAgain()
       == (var ten#1 := (var f#1 := LitInt(PrintTest.__default.Five()); 
            (var s#1 := LitInt(PrintTest.__default.Six()); LitInt(f#1 + f#1))); 
        ten#1);
}
...
procedure {:verboseName "PrintTest.TenAgain (well-formedness)"} CheckWellformed$$PrintTest.__default.TenAgain();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "PrintTest.TenAgain (well-formedness)"} CheckWellformed$$PrintTest.__default.TenAgain()
{
  var $_ReadsFrame: [ref,Field]bool;
  var ten#Z#0: int;
  var let#0#0#0: int;
  ...
  var let#2#0#0: int;
    ...
    else
    {
        ...
        havoc f#Z#0;
        assume PrintTest.__default.Five#canCall();
        assume {:id "id16"} let#1#0#0 == LitInt(PrintTest.__default.Five());
        assume PrintTest.__default.Five#canCall();
        // CheckWellformedWithResult: any expression
        assume $Is(let#1#0#0, TInt);
        assume {:id "id17"} f#Z#0 == let#1#0#0;
        havoc s#Z#0;
        assume PrintTest.__default.Six#canCall();
        assume {:id "id18"} let#2#0#0 == LitInt(PrintTest.__default.Six());
        assume PrintTest.__default.Six#canCall();
        // CheckWellformedWithResult: any expression
        assume $Is(let#2#0#0, TInt);
        assume {:id "id19"} s#Z#0 == let#2#0#0;
        // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny2/CalcDefaultMainOperator.dfy(75,7)
        assume true;
        assert {:id "id20"} s#Z#0 == LitInt(6);
        assume {:id "id21"} let#0#0#0 == f#Z#0 + f#Z#0;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(let#0#0#0, TInt);
        assume {:id "id22"} ten#Z#0 == let#0#0#0;
        assume {:id "id23"} PrintTest.__default.TenAgain() == ten#Z#0;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(PrintTest.__default.TenAgain(), TInt);
        return;
...
axiom {:id "id24"} 1 <= $FunctionContextHeight
   ==> 
  PrintTest.__default.TenOnceMore#canCall() || 1 < $FunctionContextHeight
   ==> PrintTest.__default.Five#canCall()
     && PrintTest.__default.Six#canCall()
...
procedure {:verboseName "PrintTest.TenOnceMore (well-formedness)"} CheckWellformed$$PrintTest.__default.TenOnceMore();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "PrintTest.TenOnceMore (well-formedness)"} CheckWellformed$$PrintTest.__default.TenOnceMore()
{
  var $_ReadsFrame: [ref,Field]bool;
  var ten#Z#0: int;
  var let#0#0#0: int;
  ...
  var let#2#0#0: int;
    ...
    else
    {
        ...
        havoc f#Z#0;
        assume PrintTest.__default.Five#canCall();
        assume {:id "id26"} let#1#0#0 == LitInt(PrintTest.__default.Five());
        assume PrintTest.__default.Five#canCall();
        // CheckWellformedWithResult: any expression
        assume $Is(let#1#0#0, TInt);
        assume {:id "id27"} f#Z#0 == let#1#0#0;
        havoc s#Z#0;
        assume PrintTest.__default.Six#canCall();
        assume {:id "id28"} let#2#0#0 == LitInt(PrintTest.__default.Six());
        assume PrintTest.__default.Six#canCall();
        // CheckWellformedWithResult: any expression
        assume $Is(let#2#0#0, TInt);
        assume {:id "id29"} s#Z#0 == let#2#0#0;
        // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny2/CalcDefaultMainOperator.dfy(84,7)
        assume true;
        assert {:id "id30"} s#Z#0 == LitInt(6);
        assume {:id "id31"} let#0#0#0 == f#Z#0 + f#Z#0;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(let#0#0#0, TInt);
        assume {:id "id32"} ten#Z#0 == let#0#0#0;
        assume {:id "id33"} PrintTest.__default.TenOnceMore() == ten#Z#0;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(PrintTest.__default.TenOnceMore(), TInt);
        return;
...
axiom {:id "id34"} 1 <= $FunctionContextHeight
   ==> 
  PrintTest.__default.Eleven#canCall() || 1 < $FunctionContextHeight
   ==> PrintTest.__default.Five#canCall()
     && PrintTest.__default.Six#canCall()
     && PrintTest.__default.Eleven()
       == (var f#0, s#0 := LitInt(PrintTest.__default.Five()), LitInt(PrintTest.__default.Six()); 
        f#0 + s#0);
...
axiom {:id "id35"} 1 <= $FunctionContextHeight
  ...
  PrintTest.__default.Eleven#canCall() || 1 < $FunctionContextHeight
   ==> PrintTest.__default.Five#canCall()
     && PrintTest.__default.Six#canCall()
     && PrintTest.__default.Eleven()
       == (var f#1, s#1 := LitInt(PrintTest.__default.Five()), LitInt(PrintTest.__default.Six()); 
        f#1 + s#1);
}
...
procedure {:verboseName "PrintTest.Eleven (well-formedness)"} CheckWellformed$$PrintTest.__default.Eleven();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
axiom {:id "id41"} 1 <= $FunctionContextHeight
   ==> 
  PrintTest.__default.Twelve#canCall() || 1 < $FunctionContextHeight
   ==> PrintTest.__default.Six#canCall()
     && PrintTest.__default.Six#canCall()
     && PrintTest.__default.Twelve()
       == (var s#0, t#0 := LitInt(PrintTest.__default.Six()), LitInt(PrintTest.__default.Six()); 
        s#0 + t#0);
...
axiom {:id "id42"} 1 <= $FunctionContextHeight
  ...
  PrintTest.__default.Twelve#canCall() || 1 < $FunctionContextHeight
   ==> PrintTest.__default.Six#canCall()
     && PrintTest.__default.Six#canCall()
     && PrintTest.__default.Twelve()
       == (var s#1, t#1 := LitInt(PrintTest.__default.Six()), LitInt(PrintTest.__default.Six()); 
        s#1 + t#1);
}
...
procedure {:verboseName "PrintTest.Twelve (well-formedness)"} CheckWellformed$$PrintTest.__default.Twelve();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
axiom {:id "id48"} 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap :: 
    ...
    PrintTest.__default.Twenty#canCall()
         || (0 < $FunctionContextHeight && $IsGoodHeap($Heap))
       ==> $let#0$canCall()
         && PrintTest.__default.Twenty() == (var x#0 := $let#0_x(); x#0 + x#0));
...
axiom {:id "id49"} 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap :: 
    ...
    PrintTest.__default.Twenty#canCall()
         || (0 < $FunctionContextHeight && $IsGoodHeap($Heap))
       ==> $let#0$canCall()
         && PrintTest.__default.Twenty() == (var x#1 := $let#0_x(); x#1 + x#1));
}
...
procedure {:verboseName "PrintTest.Twenty (well-formedness)"} CheckWellformed$$PrintTest.__default.Twenty();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "PrintTest.Twenty (well-formedness)"} CheckWellformed$$PrintTest.__default.Twenty()
{
  var $_ReadsFrame: [ref,Field]bool;
  var x#2: int;
  var x#4: int;
    ...
    else
    {
        ...
        assert {:id "id50"} ($Is(LitInt(10), TInt) && LitInt(10) == LitInt(10))
           || 
          ($Is(LitInt(0), TInt) && LitInt(0) == LitInt(10))
           || (exists x#3: int :: x#3 == LitInt(10));
        assume true;
        assume x#2 == LitInt(10);
        havoc x#4;
        assume true;
        assume true;
        assume {:id "id51"} x#4 == LitInt(10);
        assume true;
        assert {:id "id52"} x#2 + x#2 == x#4 + x#4;
        assume $let#0$canCall();
        assume {:id "id53"} PrintTest.__default.Twenty() == x#2 + x#2;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(PrintTest.__default.Twenty(), TInt);
        return;
...
axiom {:id "id54"} 1 <= $FunctionContextHeight
   ==> (forall $Heap: Heap :: 
    ...
    PrintTest.__default.TwentyOne#canCall()
         || (1 < $FunctionContextHeight && $IsGoodHeap($Heap))
       ==> $let#3$canCall()
         && PrintTest.__default.TwentyOne() == (var x#0 := $let#3_x(); LitInt(21)));
...
axiom {:id "id55"} 1 <= $FunctionContextHeight
   ==> (forall $Heap: Heap :: 
    ...
    PrintTest.__default.TwentyOne#canCall()
         || (1 < $FunctionContextHeight && $IsGoodHeap($Heap))
       ==> $let#3$canCall()
         && PrintTest.__default.TwentyOne() == (var x#1 := $let#3_x(); LitInt(21)));
}
...
procedure {:verboseName "PrintTest.TwentyOne (well-formedness)"} CheckWellformed$$PrintTest.__default.TwentyOne();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "PrintTest.TwentyOne (well-formedness)"} CheckWellformed$$PrintTest.__default.TwentyOne()
{
  var $_ReadsFrame: [ref,Field]bool;
  var x#2: int;
  var ##x#0: int;
    ...
    else
    {
        ...
        if (true)
        {
            if (x#2 == LitInt(10))
            {
                ...
                assume PrintTest.__default.Yes#canCall(x#2);
            }
        }

        assert {:id "id56"} ($Is(LitInt(10), TInt)
             && 
            LitInt(10) == LitInt(10)
             && PrintTest.__default.Yes(LitInt(10)))
           || 
          ($Is(LitInt(0), TInt)
             && 
            LitInt(0) == LitInt(10)
             && PrintTest.__default.Yes(LitInt(0)))
           || (exists x#3: int :: x#3 == LitInt(10) && PrintTest.__default.Yes(x#3));
        assume true;
        assume x#2 == LitInt(10) && PrintTest.__default.Yes(x#2);
        // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny2/CalcDefaultMainOperator.dfy(106,5)
        assume true;
        assert {:id "id57"} x#2 + x#2 + 1 == LitInt(21);
        havoc x#4;
        assume true;
        assume x#2 == LitInt(10) ==> PrintTest.__default.Yes#canCall(x#2);
        assume {:id "id58"} x#2 == LitInt(10) && PrintTest.__default.Yes(x#2);
        assume true;
        assert {:id "id59"} LitInt(21) == LitInt(21);
        assume $let#3$canCall();
        assume {:id "id60"} PrintTest.__default.TwentyOne() == LitInt(21);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(PrintTest.__default.TwentyOne(), TInt);
        return;
...
axiom {:id "id61"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    PrintTest.__default.Yes#canCall(x#0) || 0 < $FunctionContextHeight
...
axiom {:id "id62"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    PrintTest.__default.Yes#canCall(LitInt(x#0)) || 0 < $FunctionContextHeight
...
procedure {:verboseName "PrintTest.Yes (well-formedness)"} CheckWellformed$$PrintTest.__default.Yes(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "PrintTest.Odd (well-formedness)"} CheckWellFormed$$PrintTest.Odd(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "PrintTest.Odd (well-formedness)"} CheckWellFormed$$PrintTest.Odd(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var rr#Z#0: int;
  var let#0#0#0: int;
  ...
  var let#1#0#0: int;
    ...
    if (*)
    {
        ...
        havoc rr#Z#0;
        assume {:id "id64"} let#0#0#0 == LitInt(2);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(let#0#0#0, TInt);
        assume {:id "id65"} rr#Z#0 == let#0#0#0;
        assert {:id "id66"} rr#Z#0 != 0;
        assume {:id "id67"} (var rr#0 := LitInt(2); Mod(x#0, rr#0) == LitInt(1));
        assume false;
    }
    ...
    if (*)
    {
        ...
        havoc ww#Z#0;
        assume {:id "id68"} let#1#0#0 == LitInt(2);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(let#1#0#0, TInt);
        assume {:id "id69"} ww#Z#0 == let#1#0#0;
        assume true;
        assert {:id "id70"} (var rr#1 := LitInt(2); 
          Mod((var ww#0 := LitInt(2); LitInt(ww#0 + 7)), rr#1) == LitInt(1));
        assume false;
    }
}
...
axiom (forall x#0: int :: 
  ...
  $Is(x#0, Tclass.PrintTest.Odd())
     <==> (var rr#2 := LitInt(2); Mod(x#0, rr#2) == LitInt(1)));
...
procedure {:verboseName "PrintTest.NewOdd (well-formedness)"} CheckWellFormed$$PrintTest.NewOdd(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "PrintTest.NewOdd (well-formedness)"} CheckWellFormed$$PrintTest.NewOdd(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var rr#Z#0: int;
  var let#0#0#0: int;
  ...
  var let#1#0#0: int;
    ...
    // AddWellformednessCheck for newtype NewOdd
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    if (*)
    {
        ...
        havoc rr#Z#0;
        assume {:id "id71"} let#0#0#0 == LitInt(2);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(let#0#0#0, TInt);
        assume {:id "id72"} rr#Z#0 == let#0#0#0;
        assert {:id "id73"} rr#Z#0 != 0;
        assume {:id "id74"} (var rr#0 := LitInt(2); Mod(x#0, rr#0) == LitInt(1));
        assume false;
    }
    ...
    if (*)
    {
        ...
        havoc ww#Z#0;
        assume {:id "id75"} let#1#0#0 == LitInt(2);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(let#1#0#0, TInt);
        assume {:id "id76"} ww#Z#0 == let#1#0#0;
        assume true;
        assert {:id "id77"} (var rr#1 := LitInt(2); 
          Mod((var ww#0 := LitInt(2); LitInt(ww#0 + 7)), rr#1) == LitInt(1));
        assume false;
    }
}
...
procedure {:verboseName "PrintTest.Even (well-formedness)"} CheckWellFormed$$PrintTest.Even(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "PrintTest.Even (well-formedness)"} CheckWellFormed$$PrintTest.Even(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var rr#Z#0: int;
  var let#0#0#0: int;
  ...
  var let#1#0#0: int;
    ...
    if (*)
    {
        // check well-formedness of subset type constraint
        havoc rr#Z#0;
        assume {:id "id78"} let#0#0#0 == LitInt(2);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(let#0#0#0, TInt);
        assume {:id "id79"} rr#Z#0 == let#0#0#0;
        assert {:id "id80"} rr#Z#0 != 0;
        assume {:id "id81"} (var rr#0 := LitInt(2); Mod(x#0, rr#0) == LitInt(0));
        assume false;
    }
    ...
    if (*)
    {
        // check well-formedness of subset type witness, and that it satisfies the constraint
        havoc ww#Z#0;
        assume {:id "id82"} let#1#0#0 == LitInt(2);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(let#1#0#0, TInt);
        assume {:id "id83"} ww#Z#0 == let#1#0#0;
        assume true;
        assert {:id "id84"} (var rr#1 := LitInt(2); 
          Mod((var ww#0 := LitInt(2); LitInt(ww#0 + 8)), rr#1) == LitInt(0));
        assume false;
    }
}
...
axiom (forall x#0: int :: 
  ...
  $Is(x#0, Tclass.PrintTest.Even())
     <==> (var rr#2 := LitInt(2); Mod(x#0, rr#2) == LitInt(0)));
...
procedure {:verboseName "PrintTest.NewEven (well-formedness)"} CheckWellFormed$$PrintTest.NewEven(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "PrintTest.NewEven (well-formedness)"} CheckWellFormed$$PrintTest.NewEven(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var rr#Z#0: int;
  var let#0#0#0: int;
  ...
  var let#1#0#0: int;
    ...
    // AddWellformednessCheck for newtype NewEven
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    if (*)
    {
        // check well-formedness of newtype constraint
        havoc rr#Z#0;
        assume {:id "id85"} let#0#0#0 == LitInt(2);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(let#0#0#0, TInt);
        assume {:id "id86"} rr#Z#0 == let#0#0#0;
        assert {:id "id87"} rr#Z#0 != 0;
        assume {:id "id88"} (var rr#0 := LitInt(2); Mod(x#0, rr#0) == LitInt(0));
        assume false;
    }
    ...
    if (*)
    {
        // check well-formedness of newtype witness, and that it satisfies the constraint
        havoc ww#Z#0;
        assume {:id "id89"} let#1#0#0 == LitInt(2);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(let#1#0#0, TInt);
        assume {:id "id90"} ww#Z#0 == let#1#0#0;
        assume true;
        assert {:id "id91"} (var rr#1 := LitInt(2); 
          Mod((var ww#0 := LitInt(2); LitInt(ww#0 + 8)), rr#1) == LitInt(0));
        assume false;
    }
}
