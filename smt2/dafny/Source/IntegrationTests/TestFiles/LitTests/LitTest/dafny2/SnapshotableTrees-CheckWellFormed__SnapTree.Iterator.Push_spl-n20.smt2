...
(set-info :boogie-vc-id CheckWellFormed$$SnapTree.Iterator.Push_split5)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_correct  (=> (and (and (and (and (and (<= (LitInt 0) |n#0@@1|) (<= |n#0@@1| (|Seq#Length| |C#0@@1|))) (or (not (= |p#0@@0| null)) (not true))) (and (<= 0 |n#0@@1|) (<= |n#0@@1| (|Seq#Length| |C#0@@1|)))) (and (and (<= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#0@@0|) SnapTree.Node.Contents))) (|Seq#Length| (|Seq#Drop| |C#0@@1| |n#0@@1|))) (|Seq#SameUntil| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#0@@0|) SnapTree.Node.Contents)) (|Seq#Drop| |C#0@@1| |n#0@@1|) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#0@@0|) SnapTree.Node.Contents))))) ($IsAlloc DatatypeTypeType |stIn#0| Tclass.SnapTree.List $Heap@@7))) (and (and (and (or (not (= |p#0@@0| null)) (not true)) (= |##n#0@0| (+ |n#0@@1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#0@@0|) SnapTree.Node.Contents)))))) (and ($IsAlloc intType (int_2_U |##n#0@0|) TInt $Heap@@7) ($IsAlloc SeqType |C#0@@1| (TSeq TInt) $Heap@@7))) (and (and ($IsAlloc SetType |Nodes#0@@1| (TSet Tclass._System.object) $Heap@@7) (|SnapTree.Iterator.R#canCall| $Heap@@7 |stIn#0| (+ |n#0@@1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#0@@0|) SnapTree.Node.Contents)))) |C#0@@1| |Nodes#0@@1|)) (and (SnapTree.Iterator.R ($LS $LZ) reveal_SnapTree.Iterator.R $Heap@@7 |stIn#0| (+ |n#0@@1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#0@@0|) SnapTree.Node.Contents)))) |C#0@@1| |Nodes#0@@1|) (= (ControlFlow 0 2) (- 0 1)))))) (or (not (= |p#0@@0| null)) (not true)))))
(let ((anon4_Else_correct  (=> (and (< |n#0@@1| (LitInt 0)) (= (ControlFlow 0 4) 2)) anon3_correct)))
(let ((anon4_Then_correct  (=> (and (<= (LitInt 0) |n#0@@1|) (= (ControlFlow 0 3) 2)) anon3_correct)))
(let ((anon0_correct  (=> (and ($IsGoodHeap $Heap@@7) ($IsHeapAnchor $Heap@@7)) (=> (and (and (and ($Is DatatypeTypeType |stIn#0| Tclass.SnapTree.List) ($IsAlloc DatatypeTypeType |stIn#0| Tclass.SnapTree.List $Heap@@7)) (|$IsA#SnapTree.List| |stIn#0|)) (and ($Is refType |p#0@@0| Tclass.SnapTree.Node) ($IsAlloc refType |p#0@@0| Tclass.SnapTree.Node $Heap@@7))) (=> (and (and (and (and ($Is SeqType |C#0@@1| (TSeq TInt)) ($IsAlloc SeqType |C#0@@1| (TSeq TInt) $Heap@@7)) (and ($Is SetType |Nodes#0@@1| (TSet Tclass._System.object)) ($IsAlloc SetType |Nodes#0@@1| (TSet Tclass._System.object) $Heap@@7))) (and (and ($Is DatatypeTypeType |st#0| Tclass.SnapTree.List) ($IsAlloc DatatypeTypeType |st#0| Tclass.SnapTree.List $Heap@@7)) (= 5 $FunctionContextHeight))) (and (and (and (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@7 alloc false)) (|Set#IsMember| |Nodes#0@@1| ($Box refType |p#0@@0|))) (and (or (not (= |p#0@@0| null)) (not true)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |p#0@@0|) SnapTree.Node.Repr)) |Nodes#0@@1|))) (and (and (or (not (= |p#0@@0| null)) (not true)) ($IsAllocBox ($Box refType |p#0@@0|) Tclass.SnapTree.Node? $Heap@@7)) (and (|SnapTree.Node.NodeValid#canCall| $Heap@@7 |p#0@@0|) (SnapTree.Node.NodeValid ($LS $LZ) reveal_SnapTree.Node.NodeValid $Heap@@7 |p#0@@0|))))) (and (=> (= (ControlFlow 0 5) 3) anon4_Then_correct) (=> (= (ControlFlow 0 5) 4) anon4_Else_correct)))))))
anon0_correct)))))
))
(check-sat)
(get-info :rlimit)
