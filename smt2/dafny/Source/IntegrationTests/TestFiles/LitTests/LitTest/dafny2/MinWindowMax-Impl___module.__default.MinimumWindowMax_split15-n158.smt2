...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split159)
...
))) (=> |$w$loop#1@0| (<= (- |l#0@0| |$rhs#1@0|) |W#0|))) (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5))))))) (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (not false) (= |$rhs#0@0| 0)) (<= 0 |k#0@0|)) (<= 1 |l#0@3|)) (= |$rhs#1@0| 0)) (= |$rhs#2@0| 1)) (<= 1 |n#0@3|)) (<= 0 |$decr_init$loop#00@0|)) |$w$loop#0@0|) (= |lo##0@0| 0)) (<= 1 |n#0@1|)) (=> |$w$loop#1@0| (<= (LitInt 0) |k#0@0|))) (and (=> |$w$loop#1@0| (< |k#0@0| |l#0@3|)) (=> |$w$loop#1@0| (<= |l#0@3| |n#0@3|)))) (and (and (and (and (and (=> |$w$loop#1@0| (<= |n#0@3| (_System.array.Length |a#0@@4|))) (=> |$w$loop#1@0| (|_module.__default.StrictlyIncreasing#canCall| $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|))) (and (=> |$w$loop#1@0| (=> (|_module.__default.StrictlyIncreasing#canCall| $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|) (or (_module.__default.StrictlyIncreasing $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|) (forall ((|i#4@@0| Int) ) (!  (and (=> (and (<= |k#0@0| |i#4@@0|) (< |i#4@@0| |l#0@3|)) (<= (- |n#0@3| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |i#4@@0|)))))) (=> (and (<= |k#0@0| |i#4@@0|) (< |i#4@@0| |l#0@3|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |i#4@@0|)))) |n#0@3|)))
 :qid |MinWindowMaxdfy.146:11|
 :skolemid |690|
...
))))))) (and (and (=> |$w$loop#1@0| (and (|_module.__default.StrictlyIncreasing#canCall| $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|) (and (_module.__default.StrictlyIncreasing $Heap@5 $nw@0 |k#0@0| |l#0@3| (- |n#0@3| |W#0|) |n#0@3|) (and (forall ((|i#4@@1| Int) ) (!  (and (=> (and (<= |k#0@0| |i#4@@1|) (< |i#4@@1| |l#0@3|)) (<= (- |n#0@3| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |i#4@@1|)))))) (=> (and (<= |k#0@0| |i#4@@1|) (< |i#4@@1| |l#0@3|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |i#4@@1|)))) |n#0@3|)))
 :qid |MinWindowMaxdfy.146:11|
 :skolemid |692|
...
)))))))) (and (and (and (=> |$w$loop#1@0| (and (|_module.__default.RightmostMax#canCall| $Heap@5 |a#0@@4| (- |n#0@3| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|)))) |n#0@3|) (and (_module.__default.RightmostMax $Heap@5 |a#0@@4| (- |n#0@3| |W#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|)))) |n#0@3|) (and (forall ((|i#6@@1| Int) ) (!  (=> (and (<= (- |n#0@3| |W#0|) |i#6@@1|) (< |i#6@@1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|)))))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField |i#6@@1|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |a#0@@4|) (IndexField (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |k#0@0|))))))))))
 :qid |MinWindowMaxdfy.127:11|
 :skolemid |696|
...
))) (=> |$w$loop#1@0| (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@3| 1))))) (- |n#0@3| 1))))) (and (and (=> |$w$loop#1@0| (<= (LitInt 0) |start#0@1|)) (=> |$w$loop#1@0| (<= |start#0@1| (- (_System.array.Length |a#0@@4|) |W#0|)))) (and (=> |$w$loop#1@0| (|_module.__default.Max#canCall| $Heap@5 |a#0@@4| |start#0@1| |W#0|)) (=> |$w$loop#1@0| (= |m#0@1| (_module.__default.Max ($LS ($LS $LZ)) $Heap@5 |a#0@@4| |start#0@1| |W#0|))))))) (and (and (and (and (=> |$w$loop#1@0| (forall ((|s#3@@0| Int) ) (!  (=> (and (<= (LitInt 0) |s#3@@0|) (<= |s#3@@0| (- |n#0@3| |W#0|))) (|_module.__default.Max#canCall| $Heap@5 |a#0@@4| |s#3@@0| |W#0|))
 :qid |MinWindowMaxdfy.70:22|
 :skolemid |705|
...
)))) (and (=> |$w$loop#1@0| (forall ((|s#3@@2| Int) ) (!  (=> (and (<= (LitInt 0) |s#3@@2|) (<= |s#3@@2| (- |n#0@3| |W#0|))) (<= |m#0@1| (_module.__default.Max ($LS $LZ) $Heap@5 |a#0@@4| |s#3@@2| |W#0|)))
 :qid |MinWindowMaxdfy.70:22|
 :skolemid |707|
 :pattern ( (_module.__default.Max ($LS $LZ) $Heap@5 |a#0@@4| |s#3@@2| |W#0|))
))) (=> |$w$loop#1@0| (<= (- |l#0@3| |k#0@0|) |W#0|)))) (and (and (forall (($o@@11 T@U) ) (!  (=> (and (or (not (= $o@@11 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@11) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@11) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@11)))
 :qid |MinWindowMaxdfy.59:3|
 :skolemid |708|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@11))
)) ($HeapSucc $Heap@3 $Heap@5)) (and (forall (($o@@12 T@U) ($f@@4 T@U) ) (!  (=> (and (or (not (= $o@@12 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@12) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@12) $f@@4) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@12) $f@@4)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@12 $f@@4))))
 :qid |MinWindowMaxdfy.59:3|
 :skolemid |709|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@12) $f@@4))
)) (<= (- (_System.array.Length |a#0@@4|) |n#0@3|) |$decr_init$loop#10@0|)))) (and (and (and |$w$loop#1@0| (or (not (= |a#0@@4| null)) (not true))) (and (<= (_System.array.Length |a#0@@4|) |n#0@3|) (= $Heap@9 $Heap@5))) (and (and (= |m#0@3| |m#0@1|) (= |start#0@3| |start#0@1|)) (and (<= (LitInt 0) |start#0@3|) (= (ControlFlow 0 2) (- 0 1)))))))) (<= |start#0@3| (- (_System.array.Length |a#0@@4|) |W#0|)))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
