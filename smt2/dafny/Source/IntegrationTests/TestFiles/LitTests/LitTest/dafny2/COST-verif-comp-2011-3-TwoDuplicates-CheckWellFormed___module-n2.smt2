...
(let ((anon6_correct  (=> (and (and (<= (LitInt 0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |a#0@@3|) (IndexField |i#0@0|))))) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |a#0@@3|) (IndexField |i#0@0|)))) (- (_System.array.Length |a#0@@3|) 2))) (= (ControlFlow 0 3) 1)) anon8_correct)))
(let ((anon11_Else_correct  (=> (and (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |a#0@@3|) (IndexField |i#0@0|)))) (LitInt 0)) (= (ControlFlow 0 8) 3)) anon6_correct)))
(let ((anon11_Then_correct  (=> (<= (LitInt 0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |a#0@@3|) (IndexField |i#0@0|))))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (or (not (= |a#0@@3| null)) (not true))) (=> (or (not (= |a#0@@3| null)) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array.Length |a#0@@3|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array.Length |a#0@@3|))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (not (= |a#0@@3| null)) (not true))) (=> (or (not (= |a#0@@3| null)) (not true)) (=> (= (ControlFlow 0 4) 3) anon6_correct))))))))))
(let ((anon4_correct  (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (_System.array.Length |a#0@@3|))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (or (not (= |a#0@@3| null)) (not true))) (=> (or (not (= |a#0@@3| null)) (not true)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array.Length |a#0@@3|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array.Length |a#0@@3|))) (and (=> (= (ControlFlow 0 9) 4) anon11_Then_correct) (=> (= (ControlFlow 0 9) 8) anon11_Else_correct)))))))))
(let ((anon10_Else_correct  (=> (and (< |i#0@0| (LitInt 0)) (= (ControlFlow 0 14) 9)) anon4_correct)))
(let ((anon10_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 12) (- 0 13)) (or (not (= |a#0@@3| null)) (not true))) (=> (or (not (= |a#0@@3| null)) (not true)) (=> (= (ControlFlow 0 12) 9) anon4_correct))))))
(let ((anon9_Else_correct  (=> (and (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (_System.array.Length |a#0@@3|))) (and (<= (LitInt 0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |a#0@@3|) (IndexField |i#0@0|))))) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |a#0@@3|) (IndexField |i#0@0|)))) (- (_System.array.Length |a#0@@3|) 2)))) (= (ControlFlow 0 2) 1)) anon8_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#2| null $Heap@@1 alloc false)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (or (not (= |a#0@@3| null)) (not true))) (=> (or (not (= |a#0@@3| null)) (not true)) (=> (and (<= (LitInt 4) (_System.array.Length |a#0@@3|)) (or (not (= |p#1@0| |q#1@0|)) (not true))) (=> (and (and (and ($IsAlloc refType |a#0@@3| (Tclass._System.array TInt) $Heap@@1) ($IsAlloc intType (int_2_U |p#1@0|) TInt $Heap@@1)) (and (|_module.__default.IsDuplicate#canCall| $Heap@@1 |a#0@@3| |p#1@0|) (_module.__default.IsDuplicate $Heap@@1 |a#0@@3| |p#1@0|))) (and (and ($IsAlloc refType |a#0@@3| (Tclass._System.array TInt) $Heap@@1) ($IsAlloc intType (int_2_U |q#1@0|) TInt $Heap@@1)) (and (|_module.__default.IsDuplicate#canCall| $Heap@@1 |a#0@@3| |q#1@0|) (_module.__default.IsDuplicate $Heap@@1 |a#0@@3| |q#1@0|)))) (and (and (=> (= (ControlFlow 0 15) 2) anon9_Else_correct) (=> (= (ControlFlow 0 15) 12) anon10_Then_correct)) (=> (= (ControlFlow 0 15) 14) anon10_Else_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and ($Is refType |a#0@@3| (Tclass._System.array TInt)) ($IsAlloc refType |a#0@@3| (Tclass._System.array TInt) $Heap@@1)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 17) 15))) anon0_correct))))
