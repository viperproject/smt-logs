...
(declare-fun _module._default.Lemma_Unique$T () T@U)
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Lemma__Unique)
...
(let ((anon10_Then_correct  (=> (or (not (= |x#0@@3| |y#0|)) (not true)) (=> (and (and ($IsAlloc SeqType |a#0@@3| (TSeq _module._default.Lemma_Unique$T) $Heap@0) ($IsAlloc intType (int_2_U |s#0@@3|) TInt $Heap@0)) (and ($IsAlloc intType (int_2_U |t#0@@3|) TInt $Heap@0) ($IsAllocBox |x#0@@3| _module._default.Lemma_Unique$T $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (<= (LitInt 0) |s#0@@3|)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (<= |s#0@@3| |t#0@@3|)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (<= |t#0@@3| (|Seq#Length| |a#0@@3|))) (=> (and (and (and (and (<= (LitInt 0) |s#0@@3|) (<= |s#0@@3| |t#0@@3|)) (<= |t#0@@3| (|Seq#Length| |a#0@@3|))) (|_module.__default.Count#canCall| _module._default.Lemma_Unique$T |a#0@@3| |s#0@@3| |t#0@@3| |x#0@@3|)) (and (and ($IsAlloc SeqType |a#0@@3| (TSeq _module._default.Lemma_Unique$T) $Heap@0) ($IsAlloc intType (int_2_U |s#0@@3|) TInt $Heap@0)) (and ($IsAlloc intType (int_2_U |t#0@@3|) TInt $Heap@0) ($IsAllocBox |y#0| _module._default.Lemma_Unique$T $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= (LitInt 0) |s#0@@3|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= |s#0@@3| |t#0@@3|)) (=> (= (ControlFlow 0 2) (- 0 1)) (<= |t#0@@3| (|Seq#Length| |a#0@@3|)))))))))))))
(let ((anon5_correct  (=> (and (and (and (<= (LitInt 0) |s#0@@3|) (<= |s#0@@3| |t#0@@3|)) (<= |t#0@@3| (|Seq#Length| |a#0@@3|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0))) (and (=> (= (ControlFlow 0 9) 2) anon10_Then_correct) (=> (= (ControlFlow 0 9) 8) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (not (and (<= (LitInt 0) |s#0@@3|) (<= |s#0@@3| |t#0@@3|))) (= (ControlFlow 0 11) 9)) anon5_correct)))
(let ((anon9_Then_correct  (=> (and (and (<= (LitInt 0) |s#0@@3|) (<= |s#0@@3| |t#0@@3|)) (= (ControlFlow 0 10) 9)) anon5_correct)))
(let ((anon8_Else_correct  (=> (< |s#0@@3| (LitInt 0)) (and (=> (= (ControlFlow 0 13) 10) anon9_Then_correct) (=> (= (ControlFlow 0 13) 11) anon9_Else_correct)))))
(let ((anon8_Then_correct  (=> (<= (LitInt 0) |s#0@@3|) (and (=> (= (ControlFlow 0 12) 10) anon9_Then_correct) (=> (= (ControlFlow 0 12) 11) anon9_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 14) 12) anon8_Then_correct) (=> (= (ControlFlow 0 14) 13) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SeqType |a#0@@3| (TSeq _module._default.Lemma_Unique$T)) ($IsAlloc SeqType |a#0@@3| (TSeq _module._default.Lemma_Unique$T) $Heap)) (and ($IsBox |x#0@@3| _module._default.Lemma_Unique$T) ($IsAllocBox |x#0@@3| _module._default.Lemma_Unique$T $Heap))) (and (and ($IsBox |y#0| _module._default.Lemma_Unique$T) ($IsAllocBox |y#0| _module._default.Lemma_Unique$T $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 15) 14)))) anon0_correct))))
