...
(assert (forall ((a@@7 T@U) (b@@4 T@U) ) (! (= (|M3.Kind#Equal| a@@7 b@@4) (= a@@7 b@@4))
 :qid |unknown.0:0|
 :skolemid |2325|
 :pattern ( (|M3.Kind#Equal| a@@7 b@@4))
)))
...
(assert (forall ((a@@13 T@U) (b@@10 T@U) ) (!  (=> (and (M3.Kind.Constant_q a@@13) (M3.Kind.Constant_q b@@10)) (|M3.Kind#Equal| a@@13 b@@10))
 :qid |unknown.0:0|
 :skolemid |2322|
 :pattern ( (|M3.Kind#Equal| a@@13 b@@10) (M3.Kind.Constant_q a@@13))
 :pattern ( (|M3.Kind#Equal| a@@13 b@@10) (M3.Kind.Constant_q b@@10))
)))
(assert (forall ((a@@14 T@U) (b@@11 T@U) ) (!  (=> (and (M3.Kind.Ident_q a@@14) (M3.Kind.Ident_q b@@11)) (|M3.Kind#Equal| a@@14 b@@11))
 :qid |unknown.0:0|
 :skolemid |2323|
 :pattern ( (|M3.Kind#Equal| a@@14 b@@11) (M3.Kind.Ident_q a@@14))
 :pattern ( (|M3.Kind#Equal| a@@14 b@@11) (M3.Kind.Ident_q b@@11))
)))
(assert (forall ((a@@15 T@U) (b@@12 T@U) ) (!  (=> (and (M3.Kind.Binary_q a@@15) (M3.Kind.Binary_q b@@12)) (|M3.Kind#Equal| a@@15 b@@12))
 :qid |unknown.0:0|
 :skolemid |2324|
 :pattern ( (|M3.Kind#Equal| a@@15 b@@12) (M3.Kind.Binary_q a@@15))
 :pattern ( (|M3.Kind#Equal| a@@15 b@@12) (M3.Kind.Binary_q b@@12))
)))
...
(set-info :boogie-vc-id Impl$$M3.Expr.CreateBinary)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@8) ($IsHeapAnchor $Heap@@8)) (and ($Is refType |left#0| Tclass.M3.Expr) ($IsAlloc refType |left#0| Tclass.M3.Expr $Heap@@8))) (=> (and (and (and (and ($Is refType |right#0| Tclass.M3.Expr) ($IsAlloc refType |right#0| Tclass.M3.Expr $Heap@@8)) (= 3 $FunctionContextHeight)) (and (|M3.Expr.Valid#canCall| $Heap@@8 |left#0|) (and (M3.Expr.Valid ($LS $LZ) $Heap@@8 |left#0|) (and (M3.Expr.Core ($LS $LZ) $Heap@@8 |left#0|) (M3.Expr.Valid_k ($LS $LZ) $Heap@@8 |left#0|))))) (and (and (|M3.Expr.Valid#canCall| $Heap@@8 |right#0|) (and (M3.Expr.Valid ($LS $LZ) $Heap@@8 |right#0|) (and (M3.Expr.Core ($LS $LZ) $Heap@@8 |right#0|) (M3.Expr.Valid_k ($LS $LZ) $Heap@@8 |right#0|)))) (and (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |left#0|) M3.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |right#0|) M3.Expr.Repr))) (= (ControlFlow 0 5) 2)))) anon0_correct))))
