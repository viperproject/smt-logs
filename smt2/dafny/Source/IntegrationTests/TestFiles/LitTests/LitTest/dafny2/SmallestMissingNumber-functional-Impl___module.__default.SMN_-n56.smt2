...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.Length$_T0@@1 T@U) ($ly@@8 T@U) (|xs#0@@6| T@U) ) (!  (=> (or (|_module.__default.Length#canCall| _module._default.Length$_T0@@1 |xs#0@@6|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@6| (Tclass._module.List _module._default.Length$_T0@@1)))) (and (=> (not (_module.List.Nil_q |xs#0@@6|)) (let ((|tail#1@@1| (_module.List.tail |xs#0@@6|)))
(|_module.__default.Length#canCall| _module._default.Length$_T0@@1 |tail#1@@1|))) (= (_module.__default.Length _module._default.Length$_T0@@1 ($LS $ly@@8) |xs#0@@6|) (ite (_module.List.Nil_q |xs#0@@6|) 0 (let ((|tail#0@@1| (_module.List.tail |xs#0@@6|)))
(+ 1 (_module.__default.Length _module._default.Length$_T0@@1 $ly@@8 |tail#0@@1|)))))))
 :qid |unknown.0:0|
 :skolemid |591|
 :pattern ( (_module.__default.Length _module._default.Length$_T0@@1 ($LS $ly@@8) |xs#0@@6|))
))))
...
(ite (< |x#2@@0| |b#0@@0|) (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U |x#2@@0|)) |L#2|)) ($Box DatatypeTypeType |R#2|)) (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |L#2|) ($Box DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U |x#2@@0|)) |R#2|))))))))))))
 ...
 :weight 3
 :skolemid |641|
 :pattern ( (_module.__default.Split ($LS $ly@@10) true (Lit DatatypeTypeType |xs#0@@8|) (LitInt |b#0@@0|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@11 T@U) (|xs#0@@9| T@U) (|b#0@@1| Int) ) (!  (=> (or (|_module.__default.Split#canCall| |xs#0@@9| |b#0@@1|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@9| (Tclass._module.List Tclass._System.nat)) (<= (LitInt 0) |b#0@@1|)))) (and (=> (not (_module.List.Nil_q |xs#0@@9|)) (let ((|tail#1@@2| (_module.List.tail |xs#0@@9|)))
(|_module.__default.Split#canCall| |tail#1@@2| |b#0@@1|))) (= (_module.__default.Split ($LS $ly@@11) true |xs#0@@9| |b#0@@1|) (ite (_module.List.Nil_q |xs#0@@9|) (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.List.Nil|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.List.Nil|))) (let ((|tail#0@@2| (_module.List.tail |xs#0@@9|)))
(let ((|x#0@@4| (U_2_int ($Unbox intType (_module.List.head |xs#0@@9|)))))
(let ((|R#0| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.Split $ly@@11 reveal__module._default.Split |tail#0@@2| |b#0@@1|)))))
(let ((|L#0| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.Split $ly@@11 reveal__module._default.Split |tail#0@@2| |b#0@@1|)))))
(ite (< |x#0@@4| |b#0@@1|) (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U |x#0@@4|)) |L#0|)) ($Box DatatypeTypeType |R#0|)) (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |L#0|) ($Box DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U |x#0@@4|)) |R#0|))))))))))))
 :qid |SmallestMissingNumberfunctionaldfy.93:17|
 :skolemid |640|
 :pattern ( (_module.__default.Split ($LS $ly@@11) true |xs#0@@9| |b#0@@1|))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@12 T@U) (|lo#0@@1| Int) (|len#0@@1| Int) ) (!  (=> (or (|_module.__default.IntRange#canCall| |lo#0@@1| |len#0@@1|) (and (< 0 $FunctionContextHeight) (and (<= (LitInt 0) |lo#0@@1|) (<= (LitInt 0) |len#0@@1|)))) (and (=> (or (not (= |len#0@@1| (LitInt 0))) (not true)) (|_module.__default.IntRange#canCall| (+ |lo#0@@1| 1) (- |len#0@@1| 1))) (= (_module.__default.IntRange ($LS $ly@@12) true |lo#0@@1| |len#0@@1|) (ite (= |len#0@@1| (LitInt 0)) |Set#Empty| (|Set#Union| (_module.__default.IntRange $ly@@12 reveal__module._default.IntRange (+ |lo#0@@1| 1) (- |len#0@@1| 1)) (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U |lo#0@@1|))))))))
 :qid |SmallestMissingNumberfunctionaldfy.219:23|
 :skolemid |704|
 :pattern ( (_module.__default.IntRange ($LS $ly@@12) true |lo#0@@1| |len#0@@1|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.Elements$_T0@@2 T@U) ($ly@@13 T@U) (|xs#0@@10| T@U) ) (!  (=> (and (or (|_module.__default.Elements#canCall| _module._default.Elements$_T0@@2 |xs#0@@10|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@10| (Tclass._module.List _module._default.Elements$_T0@@2)) ($IsAlloc DatatypeTypeType |xs#0@@10| (Tclass._module.List _module._default.Elements$_T0@@2) $Heap)))) ($IsGoodHeap $Heap)) ($IsAlloc SetType (_module.__default.Elements _module._default.Elements$_T0@@2 $ly@@13 |xs#0@@10|) (TSet _module._default.Elements$_T0@@2) $Heap))
 :qid |SmallestMissingNumberfunctionaldfy.117:16|
 :skolemid |656|
 :pattern ( ($IsAlloc SetType (_module.__default.Elements _module._default.Elements$_T0@@2 $ly@@13 |xs#0@@10|) (TSet _module._default.Elements$_T0@@2) $Heap))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.Elements$_T0@@3 T@U) ($ly@@14 T@U) (|xs#0@@11| T@U) ) (!  (=> (or (|_module.__default.Elements#canCall| _module._default.Elements$_T0@@3 |xs#0@@11|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@11| (Tclass._module.List _module._default.Elements$_T0@@3)))) ($Is SetType (_module.__default.Elements _module._default.Elements$_T0@@3 $ly@@14 |xs#0@@11|) (TSet _module._default.Elements$_T0@@3)))
 :qid |unknown.0:0|
 :skolemid |655|
 :pattern ( (_module.__default.Elements _module._default.Elements$_T0@@3 $ly@@14 |xs#0@@11|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@15 T@U) (|lo#0@@2| Int) (|len#0@@2| Int) ) (!  (=> (or (|_module.__default.IntRange#canCall| (LitInt |lo#0@@2|) (LitInt |len#0@@2|)) (and (< 0 $FunctionContextHeight) (and (<= (LitInt 0) |lo#0@@2|) (<= (LitInt 0) |len#0@@2|)))) (and (=> (or (not (= (LitInt |len#0@@2|) (LitInt 0))) (not true)) (|_module.__default.IntRange#canCall| (LitInt (+ |lo#0@@2| 1)) (LitInt (- |len#0@@2| 1)))) (= (_module.__default.IntRange ($LS $ly@@15) true (LitInt |lo#0@@2|) (LitInt |len#0@@2|)) (ite (= (LitInt |len#0@@2|) (LitInt 0)) |Set#Empty| (|Set#Union| (_module.__default.IntRange ($LS $ly@@15) reveal__module._default.IntRange (LitInt (+ |lo#0@@2| 1)) (LitInt (- |len#0@@2| 1))) (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U (LitInt |lo#0@@2|)))))))))
 :qid |SmallestMissingNumberfunctionaldfy.219:23|
 :weight 3
 :skolemid |706|
 :pattern ( (_module.__default.IntRange ($LS $ly@@15) true (LitInt |lo#0@@2|) (LitInt |len#0@@2|)))
))))
(assert (forall (($ly@@16 T@U) ($reveal@@1 Bool) (|xs#0@@12| T@U) (|b#0@@2| Int) ) (! (= (_module.__default.Split ($LS $ly@@16) $reveal@@1 |xs#0@@12| |b#0@@2|) (_module.__default.Split $ly@@16 $reveal@@1 |xs#0@@12| |b#0@@2|))
 :qid |SmallestMissingNumberfunctionaldfy.93:17|
 :skolemid |636|
 :pattern ( (_module.__default.Split ($LS $ly@@16) $reveal@@1 |xs#0@@12| |b#0@@2|))
)))
(assert (forall (($ly@@17 T@U) ($reveal@@2 Bool) (|lo#0@@3| Int) (|len#0@@3| Int) ) (! (= (_module.__default.IntRange ($LS $ly@@17) $reveal@@2 |lo#0@@3| |len#0@@3|) (_module.__default.IntRange $ly@@17 $reveal@@2 |lo#0@@3| |len#0@@3|))
 :qid |SmallestMissingNumberfunctionaldfy.219:23|
 :skolemid |699|
 :pattern ( (_module.__default.IntRange ($LS $ly@@17) $reveal@@2 |lo#0@@3| |len#0@@3|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.Length$_T0@@2 T@U) ($ly@@19 T@U) (|xs#0@@14| T@U) ) (!  (=> (or (|_module.__default.Length#canCall| _module._default.Length$_T0@@2 |xs#0@@14|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@14| (Tclass._module.List _module._default.Length$_T0@@2)))) (<= (LitInt 0) (_module.__default.Length _module._default.Length$_T0@@2 $ly@@19 |xs#0@@14|)))
 :qid |unknown.0:0|
 :skolemid |589|
 :pattern ( (_module.__default.Length _module._default.Length$_T0@@2 $ly@@19 |xs#0@@14|))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.SMN_k_k__Correct_split36)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and ($Is DatatypeTypeType |xs#0@@15| (Tclass._module.List Tclass._System.nat)) ($IsAlloc DatatypeTypeType |xs#0@@15| (Tclass._module.List Tclass._System.nat) $Heap@@0)) (|$IsA#_module.List| |xs#0@@15|)) (and (<= (LitInt 0) |n#0|) (<= (LitInt 0) |len#0@@4|))) (=> (and (and (and (and (and ($Is SetType |bound#1_0| (TSet Tclass._System.nat)) ($IsAlloc SetType |bound#1_0| (TSet Tclass._System.nat) $Heap@@0)) true) (= 4 $FunctionContextHeight)) (and (and (|_module.__default.NoDuplicates#canCall| Tclass._System.nat |xs#0@@15|) (and (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |xs#0@@15|) (ite (_module.List.Nil_q |xs#0@@15|) true (let ((|tail#3@@3| (_module.List.tail |xs#0@@15|)))
(let ((|x#7| (U_2_int ($Unbox intType (_module.List.head |xs#0@@15|)))))
 (and (not (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |tail#3@@3|) ($Box intType (int_2_U |x#7|)))) (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |tail#3@@3|))))))) (forall ((|x#1@@0| T@U) ) (!  (=> (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |xs#0@@15|) ($Box intType |x#1@@0|)) (<= |n#0| (U_2_int |x#1@@0|)))
 :qid |SmallestMissingNumberfunctionaldfy.274:19|
 :skolemid |745|
 :pattern ( (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |xs#0@@15|) ($Box intType |x#1@@0|)))
)))) (and (and (and (and (= |len#0@@4| (_module.__default.Length Tclass._System.nat ($LS ($LS $LZ)) |xs#0@@15|)) (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false))) (and (|$IsA#_module.List| |xs#0@@15|) (not (|_module.List#Equal| |xs#0@@15| |#_module.List.Nil|)))) (and (and (or (not (= (LitInt 2) 0)) (not true)) (= |half#1_0@0| (+ (Div |len#0@@4| (LitInt 2)) 1))) (and ($Is DatatypeTypeType |L#1_0@0| (Tclass._module.List Tclass._System.nat)) ($IsAlloc DatatypeTypeType |L#1_0@0| (Tclass._module.List Tclass._System.nat) $Heap@@0)))) (and (and (and ($Is DatatypeTypeType |R#1_0@0| (Tclass._module.List Tclass._System.nat)) ($IsAlloc DatatypeTypeType |R#1_0@0| (Tclass._module.List Tclass._System.nat) $Heap@@0)) ($IsAlloc DatatypeTypeType |xs#0@@15| (Tclass._module.List Tclass._System.nat) $Heap@@0)) (and ($Is intType (int_2_U (+ |n#0| |half#1_0@0|)) Tclass._System.nat) (= |##b#1_0@0| (+ |n#0| |half#1_0@0|)))))) (=> (and (and (and (and (and (and ($IsAlloc intType (int_2_U |##b#1_0@0|) Tclass._System.nat $Heap@@0) (|_module.__default.Split#canCall| |xs#0@@15| (+ |n#0| |half#1_0@0|))) (and (_System.Tuple2.___hMake2_q (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@15| (+ |n#0| |half#1_0@0|))) (= |let#1_0#0#0| (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@15| (+ |n#0| |half#1_0@0|))))) (and (and (|_module.__default.Split#canCall| |xs#0@@15| (+ |n#0| |half#1_0@0|)) (|_module.__default.Split#canCall| |xs#0@@15| (+ |n#0| |half#1_0@0|))) (and ($Is DatatypeTypeType |let#1_0#0#0| (Tclass._System.Tuple2 (Tclass._module.List Tclass._System.nat) (Tclass._module.List Tclass._System.nat))) (_System.Tuple2.___hMake2_q |let#1_0#0#0|)))) (and (and (and (= (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |L#1_0@0|) ($Box DatatypeTypeType |R#1_0@0|)) |let#1_0#0#0|) ($Is intType (int_2_U (+ |n#0| |half#1_0@0|)) Tclass._System.nat)) (and (= |b##1_0@0| (+ |n#0| |half#1_0@0|)) (=> (|_module.__default.NoDuplicates#canCall| Tclass._System.nat |xs#0@@15|) (or (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |xs#0@@15|) (=> (_module.List.Nil_q |xs#0@@15|) (U_2_bool (Lit boolType (bool_2_U true)))))))) (and (and (=> (|_module.__default.NoDuplicates#canCall| Tclass._System.nat |xs#0@@15|) (or (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |xs#0@@15|) (=> (not (_module.List.Nil_q |xs#0@@15|)) (let ((|tail#0@@3| (_module.List.tail |xs#0@@15|)))
(let ((|x#2@@2| (U_2_int ($Unbox intType (_module.List.head |xs#0@@15|)))))
 (not (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS ($LS $LZ)) |tail#0@@3|) ($Box intType (int_2_U |x#2@@2|))))))))) (=> (|_module.__default.NoDuplicates#canCall| Tclass._System.nat |xs#0@@15|) (or (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |xs#0@@15|) (=> (not (_module.List.Nil_q |xs#0@@15|)) (let ((|tail#0@@4| (_module.List.tail |xs#0@@15|)))
(_module.__default.NoDuplicates Tclass._System.nat ($LS ($LS $LZ)) |tail#0@@4|)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))))) (and (and (and (and (|_module.__default.Split#canCall| |xs#0@@15| |b##1_0@0|) (let ((|r#0@@0| (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@15| |b##1_0@0|)))
 (and (and (and (_System.Tuple2.___hMake2_q |r#0@@0|) (|_module.__default.Elements#canCall| Tclass._System.nat ($Unbox DatatypeTypeType (_System.Tuple2._0 |r#0@@0|)))) (|_module.__default.Elements#canCall| Tclass._System.nat |xs#0@@15|)) (=> (|Set#Equal| (_module.__default.Elements Tclass._System.nat ($LS $LZ) ($Unbox DatatypeTypeType (_System.Tuple2._0 |r#0@@0|))) (|Set#FromBoogieMap| (|lambda#14| TInt (_module.__default.Elements Tclass._System.nat ($LS $LZ) |xs#0@@15|) |b##1_0@0|))) (and (and (and (_System.Tuple2.___hMake2_q |r#0@@0|) (|_module.__default.Elements#canCall| Tclass._System.nat ($Unbox DatatypeTypeType (_System.Tuple2._1 |r#0@@0|)))) (|_module.__default.Elements#canCall| Tclass._System.nat |xs#0@@15|)) (=> (|Set#Equal| (_module.__default.Elements Tclass._System.nat ($LS $LZ) ($Unbox DatatypeTypeType (_System.Tuple2._1 |r#0@@0|))) (|Set#FromBoogieMap| (|lambda#15| TInt (_module.__default.Elements Tclass._System.nat ($LS $LZ) |xs#0@@15|) |b##1_0@0|))) (and (and (_System.Tuple2.___hMake2_q |r#0@@0|) (|_module.__default.NoDuplicates#canCall| Tclass._System.nat ($Unbox DatatypeTypeType (_System.Tuple2._0 |r#0@@0|)))) (=> (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) ($Unbox DatatypeTypeType (_System.Tuple2._0 |r#0@@0|))) (and (_System.Tuple2.___hMake2_q |r#0@@0|) (|_module.__default.NoDuplicates#canCall| Tclass._System.nat ($Unbox DatatypeTypeType (_System.Tuple2._1 |r#0@@0|)))))))))))) (let ((|r#0@@1| (_module.__default.Split ($LS ($LS $LZ)) reveal__module._default.Split |xs#0@@15| |b##1_0@0|)))
(|Set#Equal| (_module.__default.Elements Tclass._System.nat ($LS ($LS $LZ)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |r#0@@1|))) (|Set#FromBoogieMap| (|lambda#14| TInt (_module.__default.Elements Tclass._System.nat ($LS ($LS $LZ)) |xs#0@@15|) |b##1_0@0|))))) (and (let ((|r#0@@2| (_module.__default.Split ($LS ($LS $LZ)) reveal__module._default.Split |xs#0@@15| |b##1_0@0|)))
(|Set#Equal| (_module.__default.Elements Tclass._System.nat ($LS ($LS $LZ)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |r#0@@2|))) (|Set#FromBoogieMap| (|lambda#15| TInt (_module.__default.Elements Tclass._System.nat ($LS ($LS $LZ)) |xs#0@@15|) |b##1_0@0|)))) (let ((|r#0@@3| (_module.__default.Split ($LS ($LS $LZ)) reveal__module._default.Split |xs#0@@15| |b##1_0@0|)))
...
(let ((|x#7@@0| (U_2_int ($Unbox intType (_module.List.head ($Unbox DatatypeTypeType (_System.Tuple2._0 |r#0@@3|)))))))
 (and (not (|Set#IsMember| (_module.__default.Elements Tclass._System.nat ($LS $LZ) |tail#3@@4|) ($Box intType (int_2_U |x#7@@0|)))) (_module.__default.NoDuplicates Tclass._System.nat ($LS $LZ) |tail#3@@4|)))))))))) (and (and (and (let ((|r#0@@4| (_module.__default.Split ($LS ($LS $LZ)) reveal__module._default.Split |xs#0@@15| |b##1_0@0|)))
