...
(declare-fun |call4formal@pos#0@0@@0| () Int)
...
(declare-fun |r#0| () T@U)
(set-info :boogie-vc-id Impl$$SnapTree.Node.FunctionalInsert)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 32) (let ((anon7_correct  (and (=> (= (ControlFlow 0 2) (- 0 13)) true) (and (=> (= (ControlFlow 0 2) (- 0 12)) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@4 |r#0@0|)) (=> (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@4 |r#0@0|) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (= |n#0| null) (and (forall (($o@@17 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@17)) (or (not (= $o@@17 null)) (not true)))
 :qid |SnapshotableTreesdfy.341:29|
 :skolemid |920|
 :pattern (  (or (not (= $o@@17 null)) (not true)))
)) (forall (($o@@18 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@18)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@18) alloc)))))
 :qid |SnapshotableTreesdfy.341:29|
 :skolemid |921|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@18)))
))))) (=> (=> (= |n#0| null) (and (forall (($o@@19 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@19)) (or (not (= $o@@19 null)) (not true)))
 :qid |SnapshotableTreesdfy.341:29|
 :skolemid |920|
 :pattern (  (or (not (= $o@@19 null)) (not true)))
)) (forall (($o@@20 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@20)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@20) alloc)))))
 :qid |SnapshotableTreesdfy.341:29|
 :skolemid |921|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@20)))
)))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (or (not (= |n#0| null)) (not true)) (and (forall (($o@@21 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@21)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |n#0|) SnapTree.Node.Repr)) ($Box refType $o@@21)))) (or (not (= $o@@21 null)) (not true)))
 :qid |SnapshotableTreesdfy.342:29|
 :skolemid |922|
 :pattern (  (or (not (= $o@@21 null)) (not true)))
)) (forall (($o@@22 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@22)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |n#0|) SnapTree.Node.Repr)) ($Box refType $o@@22)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@22) alloc)))))
 :qid |SnapshotableTreesdfy.342:29|
 :skolemid |923|
...
))))) (=> (=> (or (not (= |n#0| null)) (not true)) (and (forall (($o@@23 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@23)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |n#0|) SnapTree.Node.Repr)) ($Box refType $o@@23)))) (or (not (= $o@@23 null)) (not true)))
 :qid |SnapshotableTreesdfy.342:29|
 :skolemid |922|
 :pattern (  (or (not (= $o@@23 null)) (not true)))
)) (forall (($o@@24 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@24)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |n#0|) SnapTree.Node.Repr)) ($Box refType $o@@24)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@24) alloc)))))
 :qid |SnapshotableTreesdfy.342:29|
 :skolemid |923|
...
)))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (= |n#0| null) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |r#0@0|) SnapTree.Node.Contents)) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |x#0|)))))) (=> (=> (= |n#0| null) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |r#0@0|) SnapTree.Node.Contents)) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |x#0|))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (= |n#0| null) (= |pos#0@1| (LitInt 0)))) (=> (=> (= |n#0| null) (= |pos#0@1| (LitInt 0))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (and (or (not (= |n#0| null)) (not true)) (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (= |r#0@0| |n#0|))) (=> (=> (and (or (not (= |n#0| null)) (not true)) (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (= |r#0@0| |n#0|)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (and (or (not (= |n#0| null)) (not true)) (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (< |pos#0@1| 0))) (=> (=> (and (or (not (= |n#0| null)) (not true)) (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (< |pos#0@1| 0)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (and (or (not (= |n#0| null)) (not true)) (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))))) (<= (LitInt 0) |pos#0@1|))) (=> (=> (and (or (not (= |n#0| null)) (not true)) (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))))) (<= (LitInt 0) |pos#0@1|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (and (or (not (= |n#0| null)) (not true)) (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))))) (< |pos#0@1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |r#0@0|) SnapTree.Node.Contents)))))) (=> (=> (and (or (not (= |n#0| null)) (not true)) (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))))) (< |pos#0@1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |r#0@0|) SnapTree.Node.Contents))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (and (or (not (= |n#0| null)) (not true)) (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))))) (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |r#0@0|) SnapTree.Node.Contents))) (+ (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |n#0|) SnapTree.Node.Contents))) 1)))) (=> (=> (and (or (not (= |n#0| null)) (not true)) (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))))) (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |r#0@0|) SnapTree.Node.Contents))) (+ (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |n#0|) SnapTree.Node.Contents))) 1))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (and (or (not (= |n#0| null)) (not true)) (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))))) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |r#0@0|) SnapTree.Node.Contents)) (|Seq#Append| (|Seq#Append| (|Seq#Take| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |n#0|) SnapTree.Node.Contents)) |pos#0@1|) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |x#0|)))) (|Seq#Drop| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |n#0|) SnapTree.Node.Contents)) |pos#0@1|))))))))))))))))))))))))))))
(let ((anon10_Else_correct  (=> (<= |x#0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |n#0|) SnapTree.Node.data)))) (=> (and (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (and (= $Heap@@5 $Heap@3) reveal_SnapTree.Node.NodeValid)) (and (=> (= (ControlFlow 0 25) (- 0 26)) ($Is refType |n#0| Tclass.SnapTree.Node)) (=> ($Is refType |n#0| Tclass.SnapTree.Node) (=> (= |$rhs#1_1_1_1@0| (LitInt (- 0 1))) (=> (and (and (= |pos#0@1| |$rhs#1_1_1_1@0|) (= $Heap@4 $Heap@3)) (and (= |r#0@0| |n#0|) (= (ControlFlow 0 25) 2))) anon7_correct))))))))
(let ((anon10_Then_correct  (=> (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |n#0|) SnapTree.Node.data))) |x#0|) (and (=> (= (ControlFlow 0 20) (- 0 24)) ($Is refType |n#0| Tclass.SnapTree.Node)) (=> ($Is refType |n#0| Tclass.SnapTree.Node) (and (=> (= (ControlFlow 0 20) (- 0 23)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |n#0|) SnapTree.Node.Repr)) (ite (= |n#0| null) |Set#Empty| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |n#0|) SnapTree.Node.Repr))))) (=> (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |n#0|) SnapTree.Node.Repr)) (ite (= |n#0| null) |Set#Empty| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |n#0|) SnapTree.Node.Repr)))) (=> (and ($Is refType |call3formal@r#0| Tclass.SnapTree.Node) ($IsAlloc refType |call3formal@r#0| Tclass.SnapTree.Node $Heap@@5)) (and (=> (= (ControlFlow 0 20) (- 0 22)) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@@5 |n#0|)) (=> (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@@5 |n#0|) (and (=> (= (ControlFlow 0 20) (- 0 21)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |n#0|) SnapTree.Node.data))) |x#0|)) (=> (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |n#0|) SnapTree.Node.data))) |x#0|) (=> (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (and ($Is refType |call3formal@r#0@0| Tclass.SnapTree.Node) ($IsAlloc refType |call3formal@r#0@0| Tclass.SnapTree.Node $Heap@2))) (=> (and (and (and (and (|SnapTree.Node.NodeValid#canCall| $Heap@2 |call3formal@r#0@0|) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@2 |call3formal@r#0@0|)) (and (forall (($o@@25 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |call3formal@r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@25)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#0|) SnapTree.Node.Repr)) ($Box refType $o@@25)))) (or (not (= $o@@25 null)) (not true)))
 :qid |SnapshotableTreesdfy.386:15|
 :skolemid |944|
 :pattern (  (or (not (= $o@@25 null)) (not true)))
)) (forall (($o@@26 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |call3formal@r#0@0|) SnapTree.Node.Repr)) ($Box refType $o@@26)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#0|) SnapTree.Node.Repr)) ($Box refType $o@@26)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@26) alloc)))))
 :qid |SnapshotableTreesdfy.386:15|
 :skolemid |945|
...
)))) (and (and (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))) (= |call3formal@r#0@0| |n#0|)) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))) (< |call4formal@pos#0@0| 0))) (and (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (<= (LitInt 0) |call4formal@pos#0@0|)) (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (< |call4formal@pos#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |call3formal@r#0@0|) SnapTree.Node.Contents)))))))) (and (and (and (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |call3formal@r#0@0|) SnapTree.Node.Contents))) (+ (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#0|) SnapTree.Node.Contents))) 1))) (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |call3formal@r#0@0|) SnapTree.Node.Contents)) (|Seq#Append| (|Seq#Append| (|Seq#Take| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#0|) SnapTree.Node.Contents)) |call4formal@pos#0@0|) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |x#0|)))) (|Seq#Drop| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#0|) SnapTree.Node.Contents)) |call4formal@pos#0@0|))))) (and (forall (($o@@27 T@U) ) (!  (=> (and (or (not (= $o@@27 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@27) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@27) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@27)))
 :qid |SnapshotableTreesdfy.383:19|
 :skolemid |946|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@27))
)) ($HeapSucc $Heap@@5 $Heap@2))) (and (and (= |pos#0@1| |call4formal@pos#0@0|) (= $Heap@4 $Heap@2)) (and (= |r#0@0| |call3formal@r#0@0|) (= (ControlFlow 0 20) 2))))) anon7_correct))))))))))))))
(let ((anon9_Else_correct  (=> (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |n#0|) SnapTree.Node.data))) |x#0|) (and (=> (= (ControlFlow 0 27) (- 0 28)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (and (=> (= (ControlFlow 0 27) 20) anon10_Then_correct) (=> (= (ControlFlow 0 27) 25) anon10_Else_correct)))))))
(let ((anon9_Then_correct  (=> (< |x#0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |n#0|) SnapTree.Node.data)))) (and (=> (= (ControlFlow 0 15) (- 0 19)) ($Is refType |n#0| Tclass.SnapTree.Node)) (=> ($Is refType |n#0| Tclass.SnapTree.Node) (and (=> (= (ControlFlow 0 15) (- 0 18)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |n#0|) SnapTree.Node.Repr)) (ite (= |n#0| null) |Set#Empty| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |n#0|) SnapTree.Node.Repr))))) (=> (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |n#0|) SnapTree.Node.Repr)) (ite (= |n#0| null) |Set#Empty| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |n#0|) SnapTree.Node.Repr)))) (=> (and ($Is refType |call3formal@r#0@@0| Tclass.SnapTree.Node) ($IsAlloc refType |call3formal@r#0@@0| Tclass.SnapTree.Node $Heap@@5)) (and (=> (= (ControlFlow 0 15) (- 0 17)) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@@5 |n#0|)) (=> (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@@5 |n#0|) (and (=> (= (ControlFlow 0 15) (- 0 16)) (< |x#0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |n#0|) SnapTree.Node.data))))) (=> (< |x#0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |n#0|) SnapTree.Node.data)))) (=> (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and ($Is refType |call3formal@r#0@0@@0| Tclass.SnapTree.Node) ($IsAlloc refType |call3formal@r#0@0@@0| Tclass.SnapTree.Node $Heap@1))) (=> (and (and (and (and (|SnapTree.Node.NodeValid#canCall| $Heap@1 |call3formal@r#0@0@@0|) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@1 |call3formal@r#0@0@@0|)) (and (forall (($o@@28 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0@@0|) SnapTree.Node.Repr)) ($Box refType $o@@28)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#0|) SnapTree.Node.Repr)) ($Box refType $o@@28)))) (or (not (= $o@@28 null)) (not true)))
 :qid |SnapshotableTreesdfy.366:15|
 :skolemid |932|
 :pattern (  (or (not (= $o@@28 null)) (not true)))
)) (forall (($o@@29 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0@@0|) SnapTree.Node.Repr)) ($Box refType $o@@29)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#0|) SnapTree.Node.Repr)) ($Box refType $o@@29)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@29) alloc)))))
 :qid |SnapshotableTreesdfy.366:15|
 :skolemid |933|
...
)))) (and (and (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))) (= |call3formal@r#0@0@@0| |n#0|)) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|))) (< |call4formal@pos#0@0@@0| 0))) (and (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (<= (LitInt 0) |call4formal@pos#0@0@@0|)) (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (< |call4formal@pos#0@0@@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0@@0|) SnapTree.Node.Contents)))))))) (and (and (and (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0@@0|) SnapTree.Node.Contents))) (+ (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#0|) SnapTree.Node.Contents))) 1))) (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#0|) SnapTree.Node.Contents)) ($Box intType (int_2_U |x#0|)))) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |call3formal@r#0@0@@0|) SnapTree.Node.Contents)) (|Seq#Append| (|Seq#Append| (|Seq#Take| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#0|) SnapTree.Node.Contents)) |call4formal@pos#0@0@@0|) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |x#0|)))) (|Seq#Drop| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#0|) SnapTree.Node.Contents)) |call4formal@pos#0@0@@0|))))) (and (forall (($o@@30 T@U) ) (!  (=> (and (or (not (= $o@@30 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@30) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@30) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@30)))
 :qid |SnapshotableTreesdfy.363:19|
 :skolemid |934|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@30))
)) ($HeapSucc $Heap@@5 $Heap@1))) (and (and (= |pos#0@1| |call4formal@pos#0@0@@0|) (= $Heap@4 $Heap@1)) (and (= |r#0@0| |call3formal@r#0@0@@0|) (= (ControlFlow 0 15) 2))))) anon7_correct))))))))))))))
(let ((anon8_Else_correct  (=> (or (not (= |n#0| null)) (not true)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (and (=> (= (ControlFlow 0 29) 15) anon9_Then_correct) (=> (= (ControlFlow 0 29) 27) anon9_Else_correct)))))))
(let ((anon8_Then_correct  (=> (= |n#0| null) (=> (and (and (or (not (= call2formal@this null)) (not true)) (and ($Is refType call2formal@this Tclass.SnapTree.Node) ($IsAlloc refType call2formal@this Tclass.SnapTree.Node $Heap@@5))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (=> (and (and (and (and (or (not (= call2formal@this@0 null)) (not true)) (and ($Is refType call2formal@this@0 Tclass.SnapTree.Node) ($IsAlloc refType call2formal@this@0 Tclass.SnapTree.Node $Heap@0))) (and (|SnapTree.Node.NodeValid#canCall| $Heap@0 call2formal@this@0) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@0 call2formal@this@0))) (and (and (forall (($o@@31 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@31)) (or (not (= $o@@31 null)) (not true)))
 :qid |SnapshotableTreesdfy.296:30|
 :skolemid |851|
 :pattern (  (or (not (= $o@@31 null)) (not true)))
)) (forall (($o@@32 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@32)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@32) alloc)))))
 :qid |SnapshotableTreesdfy.296:30|
 :skolemid |852|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) SnapTree.Node.Repr)) ($Box refType $o@@32)))
))) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) SnapTree.Node.Contents)) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |x#0|)))))) (and (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 call2formal@this@0) alloc)))) (forall (($o@@33 T@U) ) (!  (=> (and (or (not (= $o@@33 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@33) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@33) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@33)))
 :qid |SnapshotableTreesdfy.295:17|
 :skolemid |853|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@33))
))) (and ($HeapSucc $Heap@@5 $Heap@0) (= |pos#0@0| (LitInt 0)))) (and (and (= |pos#0@1| |pos#0@0|) (= $Heap@4 $Heap@0)) (and (= |r#0@0| call2formal@this@0) (= (ControlFlow 0 14) 2))))) anon7_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@5 alloc false)) (and (=> (= (ControlFlow 0 31) 14) anon8_Then_correct) (=> (= (ControlFlow 0 31) 29) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@5) ($IsHeapAnchor $Heap@@5)) (and ($Is refType |n#0| Tclass.SnapTree.Node?) ($IsAlloc refType |n#0| Tclass.SnapTree.Node? $Heap@@5))) (and (and (=> |defass#r#0| (and ($Is refType |r#0| Tclass.SnapTree.Node) ($IsAlloc refType |r#0| Tclass.SnapTree.Node $Heap@@5))) (= 5 $FunctionContextHeight)) (and (=> (or (not (= |n#0| null)) (not true)) (SnapTree.Node.NodeValid ($LS ($LS $LZ)) reveal_SnapTree.Node.NodeValid $Heap@@5 |n#0|)) (= (ControlFlow 0 32) 31)))) anon0_correct)))
