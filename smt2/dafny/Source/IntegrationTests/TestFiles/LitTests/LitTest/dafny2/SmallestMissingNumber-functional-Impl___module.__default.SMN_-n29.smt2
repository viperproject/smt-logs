...
(assert (forall ((a@@17 T@U) (b@@14 T@U) ) (!  (=> (and (_module.List.Nil_q a@@17) (_module.List.Nil_q b@@14)) (|_module.List#Equal| a@@17 b@@14))
 :qid |unknown.0:0|
 :skolemid |775|
 :pattern ( (|_module.List#Equal| a@@17 b@@14) (_module.List.Nil_q a@@17))
 :pattern ( (|_module.List#Equal| a@@17 b@@14) (_module.List.Nil_q b@@14))
)))
...
(assert (forall ((a@@20 T@U) (x@@11 T@U) ) (!  (=> (|Set#IsMember| a@@20 x@@11) (= (|Set#Card| (|Set#UnionOne| a@@20 x@@11)) (|Set#Card| a@@20)))
 :qid |DafnyPreludebpl.694:15|
 :skolemid |131|
 :pattern ( (|Set#Card| (|Set#UnionOne| a@@20 x@@11)))
)))
...
(assert (forall ((a@@22 T@U) (x@@14 T@U) ) (!  (=> (not (|Set#IsMember| a@@22 x@@14)) (= (|Set#Card| (|Set#UnionOne| a@@22 x@@14)) (+ (|Set#Card| a@@22) 1)))
 :qid |DafnyPreludebpl.698:15|
 :skolemid |132|
 :pattern ( (|Set#Card| (|Set#UnionOne| a@@22 x@@14)))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.SMN_k_k__Correct_split9)
