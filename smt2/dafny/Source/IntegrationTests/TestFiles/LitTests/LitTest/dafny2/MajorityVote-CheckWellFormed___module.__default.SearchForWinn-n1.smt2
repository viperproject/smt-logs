...
(declare-fun |k#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.SearchForWinner)
...
)) ($HeapSucc $Heap $Heap@0)) (and ($IsBox |k#0@0| _module._default.SearchForWinner$Candidate) ($IsAllocBox |k#0@0| _module._default.SearchForWinner$Candidate $Heap@0))) (and (=> (= (ControlFlow 0 3) 1) anon8_Then_correct) (=> (= (ControlFlow 0 3) 2) anon8_Else_correct))))))
(let ((anon7_Else_correct  (=> (and (=> |hasWinner#0| (> (Mul (LitInt 2) (_module.__default.Count _module._default.SearchForWinner$Candidate ($LS $LZ) |a#0@@3| (LitInt 0) (|Seq#Length| |a#0@@3|) |K#0|)) (|Seq#Length| |a#0@@3|))) (= (ControlFlow 0 8) 3)) anon4_correct)))
(let ((anon7_Then_correct  (=> |hasWinner#0| (=> (and ($IsAlloc SeqType |a#0@@3| (TSeq _module._default.SearchForWinner$Candidate) $Heap) (= |##s#0@0| (LitInt 0))) (=> (and (and ($IsAlloc intType (int_2_U |##s#0@0|) TInt $Heap) (= |##t#0@0| (|Seq#Length| |a#0@@3|))) (and ($IsAlloc intType (int_2_U |##t#0@0|) TInt $Heap) ($IsAllocBox |K#0| _module._default.SearchForWinner$Candidate $Heap))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (<= (LitInt 0) |##s#0@0|)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (<= |##s#0@0| |##t#0@0|)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= |##t#0@0| (|Seq#Length| |a#0@@3|))) (=> (and (and (and (and (<= (LitInt 0) |##s#0@0|) (<= |##s#0@0| |##t#0@0|)) (<= |##t#0@0| (|Seq#Length| |a#0@@3|))) (|_module.__default.Count#canCall| _module._default.SearchForWinner$Candidate |a#0@@3| (LitInt 0) (|Seq#Length| |a#0@@3|) |K#0|)) (and (> (Mul (LitInt 2) (_module.__default.Count _module._default.SearchForWinner$Candidate ($LS $LZ) |a#0@@3| (LitInt 0) (|Seq#Length| |a#0@@3|) |K#0|)) (|Seq#Length| |a#0@@3|)) (= (ControlFlow 0 4) 3))) anon4_correct)))))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (or (not (= (|Seq#Length| |a#0@@3|) 0)) (not true))) (and (=> (= (ControlFlow 0 9) 4) anon7_Then_correct) (=> (= (ControlFlow 0 9) 8) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SeqType |a#0@@3| (TSeq _module._default.SearchForWinner$Candidate)) ($IsAlloc SeqType |a#0@@3| (TSeq _module._default.SearchForWinner$Candidate) $Heap)) (and ($IsBox |K#0| _module._default.SearchForWinner$Candidate) ($IsAllocBox |K#0| _module._default.SearchForWinner$Candidate $Heap))) (and (and ($IsBox |k#0| _module._default.SearchForWinner$Candidate) ($IsAllocBox |k#0| _module._default.SearchForWinner$Candidate $Heap)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 10) 9)))) anon0_correct))))
