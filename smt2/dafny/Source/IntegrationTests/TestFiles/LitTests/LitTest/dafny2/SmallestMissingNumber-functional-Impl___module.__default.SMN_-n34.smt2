...
(set-info :boogie-vc-id Impl$$_module.__default.SMN_k_k__Correct_split14)
...
(_module.__default.NoDuplicates Tclass._System.nat ($LS ($LS $LZ)) |tail#0@@4|)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))))) (=> (and (and (and (and (and (and (and (|_module.__default.Split#canCall| |xs#0@@20| |b##1_0@0|) (let ((|r#0@@0| (_module.__default.Split ($LS $LZ) reveal__module._default.Split |xs#0@@20| |b##1_0@0|)))
