...
(set-info :boogie-vc-id CheckWellformed$$SnapTree.Tree.IsSorted)
...
(let ((anon16_Else_correct  (=> (and (not (and (and (<= (LitInt 0) |i#2@0|) (< |i#2@0| |j#2@0|)) (< |j#2@0| (|Seq#Length| |c#0@@1|)))) (= (ControlFlow 0 7) 3)) anon10_correct)))
(let ((anon16_Then_correct  (=> (and (and (<= (LitInt 0) |i#2@0|) (< |i#2@0| |j#2@0|)) (< |j#2@0| (|Seq#Length| |c#0@@1|))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (and (<= 0 |i#2@0|) (< |i#2@0| (|Seq#Length| |c#0@@1|)))) (=> (and (<= 0 |i#2@0|) (< |i#2@0| (|Seq#Length| |c#0@@1|))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (and (<= 0 |j#2@0|) (< |j#2@0| (|Seq#Length| |c#0@@1|)))) (=> (and (<= 0 |j#2@0|) (< |j#2@0| (|Seq#Length| |c#0@@1|))) (=> (= (ControlFlow 0 4) 3) anon10_correct))))))))
(let ((anon15_Else_correct  (=> (not (and (<= (LitInt 0) |i#2@0|) (< |i#2@0| |j#2@0|))) (and (=> (= (ControlFlow 0 9) 4) anon16_Then_correct) (=> (= (ControlFlow 0 9) 7) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (and (<= (LitInt 0) |i#2@0|) (< |i#2@0| |j#2@0|)) (and (=> (= (ControlFlow 0 8) 4) anon16_Then_correct) (=> (= (ControlFlow 0 8) 7) anon16_Else_correct)))))
(let ((anon14_Else_correct  (=> (< |i#2@0| (LitInt 0)) (and (=> (= (ControlFlow 0 11) 8) anon15_Then_correct) (=> (= (ControlFlow 0 11) 9) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (<= (LitInt 0) |i#2@0|) (and (=> (= (ControlFlow 0 10) 8) anon15_Then_correct) (=> (= (ControlFlow 0 10) 9) anon15_Else_correct)))))
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#1| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 13) 1) anon12_Then_correct) (=> (= (ControlFlow 0 13) 12) anon13_Then_correct)) (=> (= (ControlFlow 0 13) 2) anon13_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is SeqType |c#0@@1| (TSeq TInt))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct)))
