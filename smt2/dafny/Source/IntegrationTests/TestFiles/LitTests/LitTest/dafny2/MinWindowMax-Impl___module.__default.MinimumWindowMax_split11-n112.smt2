...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split113)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon90_correct  (=> (and (and (= |n#0@4| (+ |n#0@3| 1)) ($Is intType (int_2_U |W#0|) Tclass._System.nat)) (and (<= (LitInt 0) |k#0@2|) (= (ControlFlow 0 2) (- 0 1)))) (<= |k#0@2| |$rhs#1_1@1|))))
