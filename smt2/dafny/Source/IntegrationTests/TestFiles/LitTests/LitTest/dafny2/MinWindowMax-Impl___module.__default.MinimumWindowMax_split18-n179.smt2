...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split180)
...
))) (=> (and (and (or (not (= $nw@0 null)) (not true)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@3| 1))))) (- |n#0@3| 1))) (and (<= (LitInt 0) |start#0@1|) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= |a#0@@4| null)) (not true))))))
