...
(set-info :boogie-vc-id CheckWellFormed$$SnapTree.Iterator.MoveNext_split6)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and (and ($IsGoodHeap $Heap@@11) ($IsHeapAnchor $Heap@@11)) (and (or (not (= this@@9 null)) (not true)) (and ($Is refType this@@9 Tclass.SnapTree.Iterator) ($IsAlloc refType this@@9 Tclass.SnapTree.Iterator $Heap@@11)))) (=> (and (and (and (= 6 $FunctionContextHeight) (= $_ModifiesFrame@0 (|lambda#9| null $Heap@@11 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@9) SnapTree.Iterator.IterRepr))))) (and ($IsAllocBox ($Box refType this@@9) Tclass.SnapTree.Iterator? $Heap@@11) (|SnapTree.Iterator.Valid#canCall| $Heap@@11 this@@9))) (and (and (SnapTree.Iterator.Valid reveal_SnapTree.Iterator.Valid $Heap@@11 this@@9) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@9) SnapTree.Iterator.N))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@9) SnapTree.Iterator.Contents))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (=> (and (and (and (and (forall (($o@@48 T@U) ) (!  (=> (and (or (not (= $o@@48 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 $o@@48) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@48) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 $o@@48)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@9) SnapTree.Iterator.IterRepr)) ($Box refType $o@@48))))
 :qid |SnapshotableTreesdfy.610:34|
 :skolemid |1081|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@48))
)) ($HeapSucc $Heap@@11 $Heap@0)) (and ($IsAllocBox ($Box refType this@@9) Tclass.SnapTree.Iterator? $Heap@0) (|SnapTree.Iterator.Valid#canCall| $Heap@0 this@@9))) (and (and (SnapTree.Iterator.Valid reveal_SnapTree.Iterator.Valid $Heap@0 this@@9) ($IsAlloc refType this@@9 Tclass.SnapTree.Iterator $Heap@@11)) (and (forall (($o@@49 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@9) SnapTree.Iterator.IterRepr)) ($Box refType $o@@49)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@9) SnapTree.Iterator.IterRepr)) ($Box refType $o@@49)))) (or (not (= $o@@49 null)) (not true)))
 :qid |SnapshotableTreesdfy.613:26|
 :skolemid |1082|
 :pattern (  (or (not (= $o@@49 null)) (not true)))
)) (forall (($o@@50 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@9) SnapTree.Iterator.IterRepr)) ($Box refType $o@@50)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@9) SnapTree.Iterator.IterRepr)) ($Box refType $o@@50)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 $o@@50) alloc)))))
 :qid |SnapshotableTreesdfy.613:26|
 :skolemid |1083|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 $o@@50) alloc)))
))))) (and (and (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@9) SnapTree.Iterator.T)) null)) (not true)) ($IsAlloc refType this@@9 Tclass.SnapTree.Iterator $Heap@@11)) (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@9) SnapTree.Iterator.T)) null)) (not true)) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@9) SnapTree.Iterator.T)) Tclass.SnapTree.Tree? $Heap@@11))) (and (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@9) SnapTree.Iterator.T))) SnapTree.Tree.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@9) SnapTree.Iterator.T))) SnapTree.Tree.Repr))) ($IsAlloc refType this@@9 Tclass.SnapTree.Iterator $Heap@@11)) (and (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@9) SnapTree.Iterator.Contents)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@9) SnapTree.Iterator.Contents))) (= (ControlFlow 0 2) (- 0 1)))))) ($IsAlloc refType this@@9 Tclass.SnapTree.Iterator $Heap@@11))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
