...
(let ((|left#3| (Lit DatatypeTypeType (PriorityQueue__direct.T_k.left (Lit DatatypeTypeType |t#0@@0|)))))
(let ((|x#3| (LitInt (PriorityQueue__direct.T_k.val (Lit DatatypeTypeType |t#0@@0|)))))
 (and (|PriorityQueue__direct.__default.Valid#canCall| |left#3|) (=> (PriorityQueue__direct.__default.Valid ($LS $ly@@0) |left#3|) (and (|PriorityQueue__direct.__default.Valid#canCall| |right#3|) (=> (PriorityQueue__direct.__default.Valid ($LS $ly@@0) |right#3|) (and (|$IsA#PriorityQueue__direct.T_k| |left#3|) (=> (or (|PriorityQueue__direct.T_k#Equal| |left#3| |#PriorityQueue_direct.T'.Leaf|) (<= |x#3| (PriorityQueue__direct.T_k.val |left#3|))) (|$IsA#PriorityQueue__direct.T_k| |right#3|))))))))))) (= (PriorityQueue__direct.__default.Valid ($LS $ly@@0) (Lit DatatypeTypeType |t#0@@0|)) (ite (PriorityQueue__direct.T_k.Leaf_q (Lit DatatypeTypeType |t#0@@0|)) true (let ((|right#2| (Lit DatatypeTypeType (PriorityQueue__direct.T_k.right (Lit DatatypeTypeType |t#0@@0|)))))
...
(let ((|left#3@@0| (Lit DatatypeTypeType (PriorityQueue__direct.T_k.left (Lit DatatypeTypeType |t#0@@1|)))))
 (and (|PriorityQueue__direct.__default.Elements#canCall| |left#3@@0|) (|PriorityQueue__direct.__default.Elements#canCall| |right#3@@0|))))) (= (PriorityQueue__direct.__default.Elements ($LS $ly@@1) (Lit DatatypeTypeType |t#0@@1|)) (ite (PriorityQueue__direct.T_k.Leaf_q (Lit DatatypeTypeType |t#0@@1|)) |MultiSet#Empty| (let ((|right#2@@0| (Lit DatatypeTypeType (PriorityQueue__direct.T_k.right (Lit DatatypeTypeType |t#0@@1|)))))
...
(let ((|left#1| (PriorityQueue__direct.T_k.left |t#0@@3|)))
 (and (|PriorityQueue__direct.__default.Elements#canCall| |left#1|) (|PriorityQueue__direct.__default.Elements#canCall| |right#1|))))) (= (PriorityQueue__direct.__default.Elements ($LS $ly@@2) |t#0@@3|) (ite (PriorityQueue__direct.T_k.Leaf_q |t#0@@3|) |MultiSet#Empty| (let ((|right#0| (PriorityQueue__direct.T_k.right |t#0@@3|)))
...
(assert (forall ((a@@4 T@U) (b@@2 T@U) ) (!  (=> (and (PriorityQueue__direct.T_k.Leaf_q a@@4) (PriorityQueue__direct.T_k.Leaf_q b@@2)) (|PriorityQueue__direct.T_k#Equal| a@@4 b@@2))
 :pattern ( (|PriorityQueue__direct.T_k#Equal| a@@4 b@@2) (PriorityQueue__direct.T_k.Leaf_q a@@4))
 :pattern ( (|PriorityQueue__direct.T_k#Equal| a@@4 b@@2) (PriorityQueue__direct.T_k.Leaf_q b@@2))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@5 T@U) (|t#0@@6| T@U) ) (!  (=> (or (|PriorityQueue__direct.__default.Valid#canCall| |t#0@@6|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |t#0@@6| Tclass.PriorityQueue__direct.T_k))) (and (=> (not (PriorityQueue__direct.T_k.Leaf_q |t#0@@6|)) (let ((|right#1@@0| (PriorityQueue__direct.T_k.right |t#0@@6|)))
(let ((|left#1@@0| (PriorityQueue__direct.T_k.left |t#0@@6|)))
(let ((|x#1| (PriorityQueue__direct.T_k.val |t#0@@6|)))
 (and (|PriorityQueue__direct.__default.Valid#canCall| |left#1@@0|) (=> (PriorityQueue__direct.__default.Valid $ly@@5 |left#1@@0|) (and (|PriorityQueue__direct.__default.Valid#canCall| |right#1@@0|) (=> (PriorityQueue__direct.__default.Valid $ly@@5 |right#1@@0|) (and (|$IsA#PriorityQueue__direct.T_k| |left#1@@0|) (=> (or (|PriorityQueue__direct.T_k#Equal| |left#1@@0| |#PriorityQueue_direct.T'.Leaf|) (<= |x#1| (PriorityQueue__direct.T_k.val |left#1@@0|))) (|$IsA#PriorityQueue__direct.T_k| |right#1@@0|))))))))))) (= (PriorityQueue__direct.__default.Valid ($LS $ly@@5) |t#0@@6|) (ite (PriorityQueue__direct.T_k.Leaf_q |t#0@@6|) true (let ((|right#0@@0| (PriorityQueue__direct.T_k.right |t#0@@6|)))
...
(let ((anon10_Then_correct  (=> (and (and (= |t#0@@8| (|#PriorityQueue_direct.T'.Node| |_mcc#0#0| |_mcc#1#0| |_mcc#2#0|)) ($Is DatatypeTypeType |_mcc#1#0| Tclass.PriorityQueue__direct.T_k)) (and ($Is DatatypeTypeType |_mcc#2#0| Tclass.PriorityQueue__direct.T_k) (= |let#0#0#0| |_mcc#2#0|))) (=> (and (and (and ($Is DatatypeTypeType |let#0#0#0| Tclass.PriorityQueue__direct.T_k) (= |right#Z#0@0| |let#0#0#0|)) (and (= |let#1#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#1#0#0| Tclass.PriorityQueue__direct.T_k))) (and (and (= |left#Z#0@0| |let#1#0#0|) (= |let#2#0#0| |_mcc#0#0|)) (and ($Is intType (int_2_U |let#2#0#0|) TInt) (= |x#Z#0@0| |let#2#0#0|)))) (and (=> (= (ControlFlow 0 4) (- 0 7)) ($Is DatatypeTypeType |left#Z#0@0| Tclass.PriorityQueue__direct.T)) (=> ($Is DatatypeTypeType |left#Z#0@0| Tclass.PriorityQueue__direct.T) (=> ($IsAlloc DatatypeTypeType |left#Z#0@0| Tclass.PriorityQueue__direct.T $Heap) (and (=> (= (ControlFlow 0 4) (- 0 6)) (< (DtRank |left#Z#0@0|) (DtRank |t#0@@8|))) (=> (< (DtRank |left#Z#0@0|) (DtRank |t#0@@8|)) (=> (|PriorityQueue__direct.__default.Elements#canCall| |left#Z#0@0|) (and (=> (= (ControlFlow 0 4) (- 0 5)) ($Is DatatypeTypeType |right#Z#0@0| Tclass.PriorityQueue__direct.T)) (=> ($Is DatatypeTypeType |right#Z#0@0| Tclass.PriorityQueue__direct.T) (=> (and ($IsAlloc DatatypeTypeType |right#Z#0@0| Tclass.PriorityQueue__direct.T $Heap) (= (ControlFlow 0 4) (- 0 3))) (< (DtRank |right#Z#0@0|) (DtRank |t#0@@8|)))))))))))))))
(let ((anon9_Else_correct  (=> (or (not (= |t#0@@8| |#PriorityQueue_direct.T'.Leaf|)) (not true)) (and (=> (= (ControlFlow 0 9) 4) anon10_Then_correct) (=> (= (ControlFlow 0 9) 8) anon10_Else_correct)))))
(let ((anon9_Then_correct true))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 10) 1) anon8_Then_correct) (=> (= (ControlFlow 0 10) 2) anon9_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |t#0@@8| Tclass.PriorityQueue__direct.T)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct)))
