...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Lemma__Split)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon7_correct  (=> (and (and (and (and (<= (LitInt 0) |s#0@@3|) (<= |s#0@@3| |t#0@@3|)) (<= |t#0@@3| |u#0|)) (<= |u#0| (|Seq#Length| |a#0@@3|))) (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (and ($IsAlloc SeqType |a#0@@3| (TSeq _module._default.Lemma_Split$T) $Heap@0) ($IsAlloc intType (int_2_U |s#0@@3|) TInt $Heap@0)) (and ($IsAlloc intType (int_2_U |t#0@@3|) TInt $Heap@0) ($IsAllocBox |x#0@@3| _module._default.Lemma_Split$T $Heap@0))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (<= (LitInt 0) |s#0@@3|)) (and (=> (= (ControlFlow 0 2) (- 0 9)) (<= |s#0@@3| |t#0@@3|)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (<= |t#0@@3| (|Seq#Length| |a#0@@3|))) (=> (and (and (and (and (<= (LitInt 0) |s#0@@3|) (<= |s#0@@3| |t#0@@3|)) (<= |t#0@@3| (|Seq#Length| |a#0@@3|))) (|_module.__default.Count#canCall| _module._default.Lemma_Split$T |a#0@@3| |s#0@@3| |t#0@@3| |x#0@@3|)) (and (and ($IsAlloc SeqType |a#0@@3| (TSeq _module._default.Lemma_Split$T) $Heap@0) ($IsAlloc intType (int_2_U |t#0@@3|) TInt $Heap@0)) (and ($IsAlloc intType (int_2_U |u#0|) TInt $Heap@0) ($IsAllocBox |x#0@@3| _module._default.Lemma_Split$T $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (<= (LitInt 0) |t#0@@3|)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (<= |t#0@@3| |u#0|)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (<= |u#0| (|Seq#Length| |a#0@@3|))) (=> (and (and (and (and (<= (LitInt 0) |t#0@@3|) (<= |t#0@@3| |u#0|)) (<= |u#0| (|Seq#Length| |a#0@@3|))) (|_module.__default.Count#canCall| _module._default.Lemma_Split$T |a#0@@3| |t#0@@3| |u#0| |x#0@@3|)) (and (and ($IsAlloc SeqType |a#0@@3| (TSeq _module._default.Lemma_Split$T) $Heap@0) ($IsAlloc intType (int_2_U |s#0@@3|) TInt $Heap@0)) (and ($IsAlloc intType (int_2_U |u#0|) TInt $Heap@0) ($IsAllocBox |x#0@@3| _module._default.Lemma_Split$T $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= (LitInt 0) |s#0@@3|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= |s#0@@3| |u#0|)) (=> (= (ControlFlow 0 2) (- 0 1)) (<= |u#0| (|Seq#Length| |a#0@@3|))))))))))))))))
(let ((anon10_Else_correct  (=> (and (not (and (and (<= (LitInt 0) |s#0@@3|) (<= |s#0@@3| |t#0@@3|)) (<= |t#0@@3| |u#0|))) (= (ControlFlow 0 12) 2)) anon7_correct)))
(let ((anon10_Then_correct  (=> (and (and (and (<= (LitInt 0) |s#0@@3|) (<= |s#0@@3| |t#0@@3|)) (<= |t#0@@3| |u#0|)) (= (ControlFlow 0 11) 2)) anon7_correct)))
(let ((anon9_Else_correct  (=> (not (and (<= (LitInt 0) |s#0@@3|) (<= |s#0@@3| |t#0@@3|))) (and (=> (= (ControlFlow 0 14) 11) anon10_Then_correct) (=> (= (ControlFlow 0 14) 12) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> (and (<= (LitInt 0) |s#0@@3|) (<= |s#0@@3| |t#0@@3|)) (and (=> (= (ControlFlow 0 13) 11) anon10_Then_correct) (=> (= (ControlFlow 0 13) 12) anon10_Else_correct)))))
(let ((anon8_Else_correct  (=> (< |s#0@@3| (LitInt 0)) (and (=> (= (ControlFlow 0 16) 13) anon9_Then_correct) (=> (= (ControlFlow 0 16) 14) anon9_Else_correct)))))
(let ((anon8_Then_correct  (=> (<= (LitInt 0) |s#0@@3|) (and (=> (= (ControlFlow 0 15) 13) anon9_Then_correct) (=> (= (ControlFlow 0 15) 14) anon9_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 17) 15) anon8_Then_correct) (=> (= (ControlFlow 0 17) 16) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SeqType |a#0@@3| (TSeq _module._default.Lemma_Split$T)) ($IsAlloc SeqType |a#0@@3| (TSeq _module._default.Lemma_Split$T) $Heap))) (and (and ($IsBox |x#0@@3| _module._default.Lemma_Split$T) ($IsAllocBox |x#0@@3| _module._default.Lemma_Split$T $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 18) 17)))) anon0_correct)))
