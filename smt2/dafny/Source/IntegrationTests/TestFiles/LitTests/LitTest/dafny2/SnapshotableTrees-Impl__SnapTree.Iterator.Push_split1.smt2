...
(assert (forall (($ly@@2 T@U) ($reveal@@0 Bool) ($h0@@1 T@U) ($h1@@1 T@U) (this@@0 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@1) ($IsGoodHeap $h1@@1)) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass.SnapTree.Node))) (and ($IsHeapAnchor $h0@@1) ($HeapSucc $h0@@1 $h1@@1))) (=> (forall (($o@@5 T@U) ($f@@1 T@U) ) (!  (=> (and (or (not (= $o@@5 null)) (not true)) (or (= $o@@5 this@@0) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@1 this@@0) SnapTree.Node.Repr)) ($Box refType $o@@5)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@1 $o@@5) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@1 $o@@5) $f@@1)))
 :qid |unknown.0:0|
 :skolemid |826|
)) (= (SnapTree.Node.NodeValid $ly@@2 $reveal@@0 $h0@@1 this@@0) (SnapTree.Node.NodeValid $ly@@2 $reveal@@0 $h1@@1 this@@0))))
 :qid |unknown.0:0|
 :skolemid |827|
...
(assert (forall (($ly@@3 T@U) ($reveal@@1 Bool) ($h0@@2 T@U) ($h1@@2 T@U) (|wlist#0@@1| T@U) (|n#0@@1| Int) (|C#0@@1| T@U) (|Nodes#0@@1| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@2) ($IsGoodHeap $h1@@2)) (or (|SnapTree.Iterator.R#canCall| $h0@@2 |wlist#0@@1| |n#0@@1| |C#0@@1| |Nodes#0@@1|) (and (and ($Is DatatypeTypeType |wlist#0@@1| Tclass.SnapTree.List) ($Is SeqType |C#0@@1| (TSeq TInt))) ($Is SetType |Nodes#0@@1| (TSet Tclass._System.object))))) (and ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2))) (=> (forall (($o@@11 T@U) ($f@@2 T@U) ) (!  (=> (and (or (not (= $o@@11 null)) (not true)) (|Set#IsMember| |Nodes#0@@1| ($Box refType $o@@11))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 $o@@11) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@2 $o@@11) $f@@2)))
 :qid |unknown.0:0|
 :skolemid |1021|
)) (= (SnapTree.Iterator.R $ly@@3 $reveal@@1 $h0@@2 |wlist#0@@1| |n#0@@1| |C#0@@1| |Nodes#0@@1|) (SnapTree.Iterator.R $ly@@3 $reveal@@1 $h1@@2 |wlist#0@@1| |n#0@@1| |C#0@@1| |Nodes#0@@1|))))
 :qid |unknown.0:0|
 :skolemid |1022|
...
(set-info :boogie-vc-id Impl$$SnapTree.Iterator.Push_split1)
