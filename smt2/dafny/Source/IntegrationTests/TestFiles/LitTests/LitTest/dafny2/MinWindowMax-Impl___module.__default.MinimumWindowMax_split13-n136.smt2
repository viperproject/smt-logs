...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split137)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon87_correct  (=> (and (and (= |lo##1_0@1| (+ (- |n#0@3| |W#0|) 1)) (or (not (= $nw@0 null)) (not true))) (and (<= 0 |k#0@2|) (< |k#0@2| (_System.array.Length $nw@0)))) (=> (and (and (and (= |x##1_0@1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $nw@0) (IndexField |k#0@2|))))) (= |hi##1_0@1| (+ |n#0@3| 1))) (and (<= (LitInt 0) |lo##1_0@1|) (<= |lo##1_0@1| |x##1_0@1|))) (and (and (< |x##1_0@1| |hi##1_0@1|) (<= |hi##1_0@1| (_System.array.Length |a#0@@4|))) (and (=> (|_module.__default.RightmostMax#canCall| $Heap@6 |a#0@@4| |lo##1_0@1| |x##1_0@1| |hi##1_0@1|) (or (_module.__default.RightmostMax $Heap@6 |a#0@@4| |lo##1_0@1| |x##1_0@1| |hi##1_0@1|) (forall ((|i#0@@1| Int) ) (!  (=> (and (<= |lo##1_0@1| |i#0@@1|) (< |i#0@@1| |x##1_0@1|)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |a#0@@4|) (IndexField |i#0@@1|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |a#0@@4|) (IndexField |x##1_0@1|))))))
 :qid |MinWindowMaxdfy.127:11|
 :skolemid |760|
...
))))))) (=> (and (and (and (and (and ($IsGoodHeap $Heap@7) ($IsHeapAnchor $Heap@7)) (|_module.__default.Max#canCall| $Heap@7 |a#0@@4| |lo##1_0@1| (- |hi##1_0@1| |lo##1_0@1|))) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |a#0@@4|) (IndexField |x##1_0@1|)))) (_module.__default.Max ($LS ($LS $LZ)) $Heap@7 |a#0@@4| |lo##1_0@1| (- |hi##1_0@1| |lo##1_0@1|))) (= $Heap@6 $Heap@7))) (and (and (or (not (= |a#0@@4| null)) (not true)) (or (not (= $nw@0 null)) (not true))) (and (<= 0 |k#0@2|) (< |k#0@2| (_System.array.Length $nw@0))))) (and (and (and (and (<= 0 (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $nw@0) (IndexField |k#0@2|))))) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $nw@0) (IndexField |k#0@2|)))) (_System.array.Length |a#0@@4|))) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |a#0@@4|) (IndexField (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $nw@0) (IndexField |k#0@2|)))))))) |m#0@1|)) (and (or (not (= |a#0@@4| null)) (not true)) (or (not (= $nw@0 null)) (not true)))) (and (and (<= 0 |k#0@2|) (< |k#0@2| (_System.array.Length $nw@0))) (= (ControlFlow 0 2) (- 0 1))))) (and (<= 0 (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $nw@0) (IndexField |k#0@2|))))) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $nw@0) (IndexField |k#0@2|)))) (_System.array.Length |a#0@@4|))))))))
