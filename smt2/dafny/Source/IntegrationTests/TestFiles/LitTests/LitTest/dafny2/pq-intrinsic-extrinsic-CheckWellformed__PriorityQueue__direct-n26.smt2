...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (|MultiSet#Equal| (PriorityQueue__direct.__default.Elements ($LS ($LS $LZ)) (Lit DatatypeTypeType PriorityQueue__direct.__default.Empty)) |MultiSet#Empty|))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) ($Is DatatypeTypeType (Lit DatatypeTypeType |#PriorityQueue_direct.T'.Leaf|) Tclass.PriorityQueue__direct.T)) (=> ($Is DatatypeTypeType (Lit DatatypeTypeType |#PriorityQueue_direct.T'.Leaf|) Tclass.PriorityQueue__direct.T) (=> (= PriorityQueue__direct.__default.Empty (Lit DatatypeTypeType |#PriorityQueue_direct.T'.Leaf|)) (=> (and ($Is DatatypeTypeType PriorityQueue__direct.__default.Empty Tclass.PriorityQueue__direct.T) (= (ControlFlow 0 5) 4)) GeneratedUnifiedExit_correct))))))
(let ((anon5_Then_correct  (=> (and ($Is DatatypeTypeType PriorityQueue__direct.__default.Empty Tclass.PriorityQueue__direct.T) (= (ControlFlow 0 2) (- 0 1))) (U_2_bool (Lit boolType (bool_2_U true))))))
