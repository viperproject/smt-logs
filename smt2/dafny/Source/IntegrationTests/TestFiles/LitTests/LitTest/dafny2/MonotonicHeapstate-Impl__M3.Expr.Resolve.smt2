...
(assert (distinct TBool TagBool TagSet alloc allocName Tagclass._System.object? Tagclass._System.object Tagclass.M3.VarDecl? Tagclass.M3.VarDecl class.M3.Expr? Tagclass.M3.Expr? Tagclass.M3.Expr Tagclass.M3.Kind |##M3.Kind.Constant| |##M3.Kind.Ident| |##M3.Kind.Binary| tytagFamily$object tytagFamily$VarDecl tytagFamily$Expr tytagFamily$Kind field$resolved field$kind field$left field$Repr field$right field$decl)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((a@@4 T@U) (b@@4 T@U) ) (! (= (|M3.Kind#Equal| a@@4 b@@4) (= a@@4 b@@4))
 :qid |unknown.0:0|
 :skolemid |2325|
 :pattern ( (|M3.Kind#Equal| a@@4 b@@4))
)))
...
(assert (forall (($h@@6 T@U) ($o@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (or (not (= $o@@8 null)) (not true)) (= (dtype $o@@8) Tclass.M3.Expr?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@8) M3.Expr.decl)) Tclass.M3.VarDecl?))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2226|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@8) M3.Expr.decl)))
)))
(assert (forall (($h@@7 T@U) ($o@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (or (not (= $o@@9 null)) (not true)) (= (dtype $o@@9) Tclass.M3.Expr?))) ($Is DatatypeTypeType ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@9) M3.Expr.kind)) Tclass.M3.Kind))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2283|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@9) M3.Expr.kind)))
)))
(assert (forall (($h@@8 T@U) ($o@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (or (not (= $o@@10 null)) (not true)) (= (dtype $o@@10) Tclass.M3.Expr?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@10) M3.Expr.left)) Tclass.M3.Expr?))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2287|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@10) M3.Expr.left)))
)))
(assert (forall (($h@@9 T@U) ($o@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) (and (or (not (= $o@@11 null)) (not true)) (= (dtype $o@@11) Tclass.M3.Expr?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@11) M3.Expr.right)) Tclass.M3.Expr?))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2289|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@11) M3.Expr.right)))
)))
...
(assert (forall (($h@@10 T@U) ($o@@12 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@10) (and (or (not (= $o@@12 null)) (not true)) (= (dtype $o@@12) Tclass.M3.Expr?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@12) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@12) M3.Expr.decl)) Tclass.M3.VarDecl? $h@@10))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2227|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@12) M3.Expr.decl)))
)))
(assert (forall (($h@@11 T@U) ($o@@13 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@11) (and (or (not (= $o@@13 null)) (not true)) (= (dtype $o@@13) Tclass.M3.Expr?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@13) alloc)))) ($IsAlloc DatatypeTypeType ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@13) M3.Expr.kind)) Tclass.M3.Kind $h@@11))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2284|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@13) M3.Expr.kind)))
)))
(assert (forall (($h@@12 T@U) ($o@@14 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@12) (and (or (not (= $o@@14 null)) (not true)) (= (dtype $o@@14) Tclass.M3.Expr?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@14) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@14) M3.Expr.left)) Tclass.M3.Expr? $h@@12))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2288|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@14) M3.Expr.left)))
)))
(assert (forall (($h@@13 T@U) ($o@@15 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@13) (and (or (not (= $o@@15 null)) (not true)) (= (dtype $o@@15) Tclass.M3.Expr?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@15) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@15) M3.Expr.right)) Tclass.M3.Expr? $h@@13))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2290|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@15) M3.Expr.right)))
)))
...
(assert (forall (($h@@14 T@U) ($o@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (or (not (= $o@@16 null)) (not true)) (= (dtype $o@@16) Tclass.M3.Expr?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@16) M3.Expr.Repr)) (TSet Tclass._System.object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2291|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@16) M3.Expr.Repr)))
)))
(assert (forall (($h@@15 T@U) ($o@@17 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@15) (and (or (not (= $o@@17 null)) (not true)) (= (dtype $o@@17) Tclass.M3.Expr?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@17) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@17) M3.Expr.Repr)) (TSet Tclass._System.object) $h@@15))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2292|
...
(assert (forall ((a@@10 T@U) (b@@10 T@U) ) (!  (=> (and (M3.Kind.Constant_q a@@10) (M3.Kind.Constant_q b@@10)) (|M3.Kind#Equal| a@@10 b@@10))
 :qid |unknown.0:0|
 :skolemid |2322|
 :pattern ( (|M3.Kind#Equal| a@@10 b@@10) (M3.Kind.Constant_q a@@10))
 :pattern ( (|M3.Kind#Equal| a@@10 b@@10) (M3.Kind.Constant_q b@@10))
)))
(assert (forall ((a@@11 T@U) (b@@11 T@U) ) (!  (=> (and (M3.Kind.Ident_q a@@11) (M3.Kind.Ident_q b@@11)) (|M3.Kind#Equal| a@@11 b@@11))
 :qid |unknown.0:0|
 :skolemid |2323|
 :pattern ( (|M3.Kind#Equal| a@@11 b@@11) (M3.Kind.Ident_q a@@11))
 :pattern ( (|M3.Kind#Equal| a@@11 b@@11) (M3.Kind.Ident_q b@@11))
)))
(assert (forall ((a@@12 T@U) (b@@12 T@U) ) (!  (=> (and (M3.Kind.Binary_q a@@12) (M3.Kind.Binary_q b@@12)) (|M3.Kind#Equal| a@@12 b@@12))
 :qid |unknown.0:0|
 :skolemid |2324|
 :pattern ( (|M3.Kind#Equal| a@@12 b@@12) (M3.Kind.Binary_q a@@12))
 :pattern ( (|M3.Kind#Equal| a@@12 b@@12) (M3.Kind.Binary_q b@@12))
)))
...
(assert (forall (($h@@16 T@U) ($o@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (or (not (= $o@@19 null)) (not true)) (= (dtype $o@@19) Tclass.M3.Expr?))) ($Is boolType ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@19) M3.Expr.resolved)) TBool))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2244|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@19) M3.Expr.resolved)))
)))
(assert (forall (($h0@@2 T@U) ($h1@@2 T@U) (this@@9 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@2) ($IsGoodHeap $h1@@2)) (and (or (not (= this@@9 null)) (not true)) ($Is refType this@@9 Tclass.M3.Expr))) (and ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2))) (=> (forall (($o@@20 T@U) ($f@@2 T@U) ) (!  (=> (and (or (not (= $o@@20 null)) (not true)) (or (= $o@@20 this@@9) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 this@@9) M3.Expr.Repr)) ($Box refType $o@@20)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 $o@@20) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@2 $o@@20) $f@@2)))
 :qid |unknown.0:0|
 :skolemid |2228|
...
(assert (forall ((d@@7 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) ($Is DatatypeTypeType d@@7 Tclass.M3.Kind)) ($IsAlloc DatatypeTypeType d@@7 Tclass.M3.Kind $h@@17))
 :qid |unknown.0:0|
 :skolemid |2319|
 :pattern ( ($IsAlloc DatatypeTypeType d@@7 Tclass.M3.Kind $h@@17))
)))
...
(set-info :boogie-vc-id Impl$$M3.Expr.Resolve)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon12_correct  (=> (= |$rhs#0@0| (|Set#Union| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@12) M3.Expr.Repr)) (ite  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@12) M3.Expr.left)) null)) (not true)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@12) M3.Expr.left))) M3.Expr.Repr)) |Set#Empty|)) (ite  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@12) M3.Expr.right)) null)) (not true)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@12) M3.Expr.right))) M3.Expr.Repr)) |Set#Empty|))) (=> (and (and (and (= $Heap@6 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@5 this@@12 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@12) M3.Expr.Repr ($Box SetType |$rhs#0@0|)))) ($IsGoodHeap $Heap@6)) (and (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@12 M3.Expr.resolved)) (= |$rhs#1@0| (U_2_bool (Lit boolType (bool_2_U true)))))) (and (and (= $Heap@7 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@6 this@@12 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@12) M3.Expr.resolved ($Box boolType (bool_2_U |$rhs#1@0|))))) ($IsGoodHeap $Heap@7)) (and ($IsAllocBox ($Box refType this@@12) Tclass.M3.Expr? $Heap@7) (=> (|M3.Expr.Core#canCall| $Heap@7 this@@12) (or (M3.Expr.Core ($LS $LZ) $Heap@7 this@@12) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.Repr)) ($Box refType this@@12))))))) (=> (and (and (and (and (=> (|M3.Expr.Core#canCall| $Heap@7 this@@12) (or (M3.Expr.Core ($LS $LZ) $Heap@7 this@@12) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.left)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.left))))) (=> (|M3.Expr.Core#canCall| $Heap@7 this@@12) (or (M3.Expr.Core ($LS $LZ) $Heap@7 this@@12) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.left)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.left))) M3.Expr.Repr)) ($Box refType this@@12))))))) (and (=> (|M3.Expr.Core#canCall| $Heap@7 this@@12) (or (M3.Expr.Core ($LS $LZ) $Heap@7 this@@12) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.left)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.left))) M3.Expr.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.right)))))) (=> (|M3.Expr.Core#canCall| $Heap@7 this@@12) (or (M3.Expr.Core ($LS $LZ) $Heap@7 this@@12) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.left)) null)) (not true)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.left))) M3.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.Repr)))))))) (and (and (=> (|M3.Expr.Core#canCall| $Heap@7 this@@12) (or (M3.Expr.Core ($LS $LZ) $Heap@7 this@@12) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.left)) null)) (not true)) (M3.Expr.Valid ($LS ($LS $LZ)) $Heap@7 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.left)))))) (=> (|M3.Expr.Core#canCall| $Heap@7 this@@12) (or (M3.Expr.Core ($LS $LZ) $Heap@7 this@@12) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.right)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.right)))))) (and (=> (|M3.Expr.Core#canCall| $Heap@7 this@@12) (or (M3.Expr.Core ($LS $LZ) $Heap@7 this@@12) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.right)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.right))) M3.Expr.Repr)) ($Box refType this@@12)))))) (=> (|M3.Expr.Core#canCall| $Heap@7 this@@12) (or (M3.Expr.Core ($LS $LZ) $Heap@7 this@@12) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.right)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.right))) M3.Expr.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.left))))))))) (and (and (and (=> (|M3.Expr.Core#canCall| $Heap@7 this@@12) (or (M3.Expr.Core ($LS $LZ) $Heap@7 this@@12) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.right)) null)) (not true)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.right))) M3.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.Repr)))))) (=> (|M3.Expr.Core#canCall| $Heap@7 this@@12) (or (M3.Expr.Core ($LS $LZ) $Heap@7 this@@12) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.right)) null)) (not true)) (M3.Expr.Valid ($LS ($LS $LZ)) $Heap@7 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.right))))))) (and (=> (|M3.Expr.Core#canCall| $Heap@7 this@@12) (or (M3.Expr.Core ($LS $LZ) $Heap@7 this@@12) (=> (|M3.Kind#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.kind)) |#M3.Kind.Binary|) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.left)) null)) (not true))))) (=> (|M3.Expr.Core#canCall| $Heap@7 this@@12) (or (M3.Expr.Core ($LS $LZ) $Heap@7 this@@12) (=> (|M3.Kind#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.kind)) |#M3.Kind.Binary|) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.right)) null)) (not true))))))) (and (and (=> (|M3.Expr.Core#canCall| $Heap@7 this@@12) (or (M3.Expr.Core ($LS $LZ) $Heap@7 this@@12) (=> (|M3.Kind#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.kind)) |#M3.Kind.Binary|) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.left))) M3.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.right))) M3.Expr.Repr)))))) (|M3.Expr.Valid_k#canCall| $Heap@7 this@@12)) (and (|M3.Expr.Valid_k#canCall| $Heap@7 this@@12) (M3.Expr.Valid_k ($LS $LZ) $Heap@7 this@@12))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> false (=> (|M3.Expr.Valid#canCall| $Heap@7 this@@12) (or (M3.Expr.Valid ($LS $LZ) $Heap@7 this@@12) (M3.Expr.Core ($LS ($LS $LZ)) $Heap@7 this@@12))))) (=> (=> false (=> (|M3.Expr.Valid#canCall| $Heap@7 this@@12) (or (M3.Expr.Valid ($LS $LZ) $Heap@7 this@@12) (M3.Expr.Core ($LS ($LS $LZ)) $Heap@7 this@@12)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> false (=> (|M3.Expr.Valid#canCall| $Heap@7 this@@12) (or (M3.Expr.Valid ($LS $LZ) $Heap@7 this@@12) (M3.Expr.Valid_k ($LS ($LS $LZ)) $Heap@7 this@@12))))) (=> (=> false (=> (|M3.Expr.Valid#canCall| $Heap@7 this@@12) (or (M3.Expr.Valid ($LS $LZ) $Heap@7 this@@12) (M3.Expr.Valid_k ($LS ($LS $LZ)) $Heap@7 this@@12)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> false (and (forall (($o@@22 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.Repr)) ($Box refType $o@@22)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.Repr)) ($Box refType $o@@22)))) (or (not (= $o@@22 null)) (not true)))
 :qid |MonotonicHeapstatedfy.112:26|
 :skolemid |2239|
 :pattern (  (or (not (= $o@@22 null)) (not true)))
)) (forall (($o@@23 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.Repr)) ($Box refType $o@@23)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.Repr)) ($Box refType $o@@23)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@23) alloc)))))
 :qid |MonotonicHeapstatedfy.112:26|
 :skolemid |2240|
...
))))) (=> (=> false (and (forall (($o@@24 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.Repr)) ($Box refType $o@@24)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.Repr)) ($Box refType $o@@24)))) (or (not (= $o@@24 null)) (not true)))
 :qid |MonotonicHeapstatedfy.112:26|
 :skolemid |2239|
 :pattern (  (or (not (= $o@@24 null)) (not true)))
)) (forall (($o@@25 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.Repr)) ($Box refType $o@@25)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.Repr)) ($Box refType $o@@25)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@25) alloc)))))
 :qid |MonotonicHeapstatedfy.112:26|
 :skolemid |2240|
...
)))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@12) M3.Expr.resolved))))))))))))))))
(let ((anon16_Else_correct  (=> (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@12) M3.Expr.right)) null) (= (ControlFlow 0 7) 2)) anon12_correct)))
(let ((anon16_Then_correct  (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@12) M3.Expr.right)) null)) (not true)) (=> (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@12) M3.Expr.right)) null)) (not true)) (= (ControlFlow 0 6) 2)) anon12_correct))))
(let ((anon15_Else_correct  (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@12) M3.Expr.left)) null) (and (=> (= (ControlFlow 0 9) 6) anon16_Then_correct) (=> (= (ControlFlow 0 9) 7) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@12) M3.Expr.left)) null)) (not true)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@12) M3.Expr.left)) null)) (not true))) (and (=> (= (ControlFlow 0 8) 6) anon16_Then_correct) (=> (= (ControlFlow 0 8) 7) anon16_Else_correct)))))
(let ((anon6_correct  (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@12 M3.Expr.Repr)) (and (=> (= (ControlFlow 0 10) 8) anon15_Then_correct) (=> (= (ControlFlow 0 10) 9) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (not (|M3.Kind#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@12) M3.Expr.kind)) |#M3.Kind.Binary|)) (=> (and (= $Heap@5 $Heap@2) (= (ControlFlow 0 16) 10)) anon6_correct))))
(let ((anon14_Then_correct  (=> (|M3.Kind#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@12) M3.Expr.kind)) |#M3.Kind.Binary|) (=> (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@12) M3.Expr.left)) null)) (not true)) (forall (($o@@26 T@U) ($f@@4 T@U) ) (!  (=> (and (and (or (not (= $o@@26 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@26) alloc)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@12) M3.Expr.left))) M3.Expr.Repr)) ($Box refType $o@@26))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@26 $f@@4)))
 :qid |MonotonicHeapstatedfy.117:21|
 :skolemid |2242|
))) (=> (and (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@12) M3.Expr.left))) M3.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.Repr))) (not (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@12) M3.Expr.left))) M3.Expr.Repr))))) (= call0formal@this@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@12) M3.Expr.left)))) (and (=> (= (ControlFlow 0 11) (- 0 15)) (=> (|M3.Expr.Valid#canCall| $Heap@2 call0formal@this@0) (or (M3.Expr.Valid ($LS $LZ) $Heap@2 call0formal@this@0) (M3.Expr.Core ($LS ($LS $LZ)) $Heap@2 call0formal@this@0)))) (=> (=> (|M3.Expr.Valid#canCall| $Heap@2 call0formal@this@0) (or (M3.Expr.Valid ($LS $LZ) $Heap@2 call0formal@this@0) (M3.Expr.Core ($LS ($LS $LZ)) $Heap@2 call0formal@this@0))) (and (=> (= (ControlFlow 0 11) (- 0 14)) (=> (|M3.Expr.Valid#canCall| $Heap@2 call0formal@this@0) (or (M3.Expr.Valid ($LS $LZ) $Heap@2 call0formal@this@0) (M3.Expr.Valid_k ($LS ($LS $LZ)) $Heap@2 call0formal@this@0)))) (=> (=> (|M3.Expr.Valid#canCall| $Heap@2 call0formal@this@0) (or (M3.Expr.Valid ($LS $LZ) $Heap@2 call0formal@this@0) (M3.Expr.Valid_k ($LS ($LS $LZ)) $Heap@2 call0formal@this@0))) (=> (and (and (and (and (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (|M3.Expr.Valid#canCall| $Heap@3 call0formal@this@0)) (and (|M3.Expr.Valid#canCall| $Heap@3 call0formal@this@0) (and (M3.Expr.Valid ($LS $LZ) $Heap@3 call0formal@this@0) (and (M3.Expr.Core ($LS $LZ) $Heap@3 call0formal@this@0) (M3.Expr.Valid_k ($LS $LZ) $Heap@3 call0formal@this@0))))) (and (and (forall (($o@@27 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0) M3.Expr.Repr)) ($Box refType $o@@27)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call0formal@this@0) M3.Expr.Repr)) ($Box refType $o@@27)))) (or (not (= $o@@27 null)) (not true)))
 :qid |MonotonicHeapstatedfy.112:26|
 :skolemid |2236|
 :pattern (  (or (not (= $o@@27 null)) (not true)))
)) (forall (($o@@28 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0) M3.Expr.Repr)) ($Box refType $o@@28)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call0formal@this@0) M3.Expr.Repr)) ($Box refType $o@@28)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@28) alloc)))))
 :qid |MonotonicHeapstatedfy.112:26|
 :skolemid |2237|
...
))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0) M3.Expr.resolved))))) (and (and (and (forall (($o@@29 T@U) ) (!  (=> (and (or (not (= $o@@29 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@29) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@29) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@29)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call0formal@this@0) M3.Expr.Repr)) ($Box refType $o@@29))))
 :qid |MonotonicHeapstatedfy.141:12|
 :skolemid |2238|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@29))
)) ($HeapSucc $Heap@2 $Heap@3)) (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@12) M3.Expr.right)) null)) (not true)) (forall (($o@@30 T@U) ($f@@5 T@U) ) (!  (=> (and (and (or (not (= $o@@30 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@30) alloc)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@12) M3.Expr.right))) M3.Expr.Repr)) ($Box refType $o@@30))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@30 $f@@5)))
 :qid |MonotonicHeapstatedfy.118:22|
 :skolemid |2243|
)))) (and (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@12) M3.Expr.right))) M3.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.Repr))) (not (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@12) M3.Expr.right))) M3.Expr.Repr))))) (= call0formal@this@0@@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@12) M3.Expr.right)))))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (=> (|M3.Expr.Valid#canCall| $Heap@3 call0formal@this@0@@0) (or (M3.Expr.Valid ($LS $LZ) $Heap@3 call0formal@this@0@@0) (M3.Expr.Core ($LS ($LS $LZ)) $Heap@3 call0formal@this@0@@0)))) (=> (=> (|M3.Expr.Valid#canCall| $Heap@3 call0formal@this@0@@0) (or (M3.Expr.Valid ($LS $LZ) $Heap@3 call0formal@this@0@@0) (M3.Expr.Core ($LS ($LS $LZ)) $Heap@3 call0formal@this@0@@0))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (=> (|M3.Expr.Valid#canCall| $Heap@3 call0formal@this@0@@0) (or (M3.Expr.Valid ($LS $LZ) $Heap@3 call0formal@this@0@@0) (M3.Expr.Valid_k ($LS ($LS $LZ)) $Heap@3 call0formal@this@0@@0)))) (=> (=> (|M3.Expr.Valid#canCall| $Heap@3 call0formal@this@0@@0) (or (M3.Expr.Valid ($LS $LZ) $Heap@3 call0formal@this@0@@0) (M3.Expr.Valid_k ($LS ($LS $LZ)) $Heap@3 call0formal@this@0@@0))) (=> (and (and (and (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (|M3.Expr.Valid#canCall| $Heap@4 call0formal@this@0@@0)) (and (|M3.Expr.Valid#canCall| $Heap@4 call0formal@this@0@@0) (and (M3.Expr.Valid ($LS $LZ) $Heap@4 call0formal@this@0@@0) (and (M3.Expr.Core ($LS $LZ) $Heap@4 call0formal@this@0@@0) (M3.Expr.Valid_k ($LS $LZ) $Heap@4 call0formal@this@0@@0))))) (and (and (and (forall (($o@@31 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call0formal@this@0@@0) M3.Expr.Repr)) ($Box refType $o@@31)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0@@0) M3.Expr.Repr)) ($Box refType $o@@31)))) (or (not (= $o@@31 null)) (not true)))
 :qid |MonotonicHeapstatedfy.112:26|
 :skolemid |2236|
 :pattern (  (or (not (= $o@@31 null)) (not true)))
)) (forall (($o@@32 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call0formal@this@0@@0) M3.Expr.Repr)) ($Box refType $o@@32)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0@@0) M3.Expr.Repr)) ($Box refType $o@@32)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@32) alloc)))))
 :qid |MonotonicHeapstatedfy.112:26|
 :skolemid |2237|
...
))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call0formal@this@0@@0) M3.Expr.resolved)))) (and (and (forall (($o@@33 T@U) ) (!  (=> (and (or (not (= $o@@33 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@33) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@33) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@33)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0@@0) M3.Expr.Repr)) ($Box refType $o@@33))))
 :qid |MonotonicHeapstatedfy.141:12|
 :skolemid |2238|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@33))
)) ($HeapSucc $Heap@3 $Heap@4)) (and (= $Heap@5 $Heap@4) (= (ControlFlow 0 11) 10))))) anon6_correct)))))))))))))))
(let ((anon3_correct  (=> (|$IsA#M3.Kind| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@12) M3.Expr.kind))) (and (=> (= (ControlFlow 0 17) 11) anon14_Then_correct) (=> (= (ControlFlow 0 17) 16) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (not (|M3.Kind#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.kind)) |#M3.Kind.Ident|)) (=> (and (= $Heap@2 $Heap@@8) (= (ControlFlow 0 19) 17)) anon3_correct))))
(let ((anon13_Then_correct  (=> (and (and (|M3.Kind#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.kind)) |#M3.Kind.Ident|) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@12 M3.Expr.decl))) (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 Tclass.M3.VarDecl?))) (=> (and (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $nw@0) alloc)))) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@8 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 this@@12 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@12) M3.Expr.decl ($Box refType $nw@0)))) ($IsGoodHeap $Heap@1)) (and (= $Heap@2 $Heap@1) (= (ControlFlow 0 18) 17)))) anon3_correct))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@8 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.Repr)))) (|$IsA#M3.Kind| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@12) M3.Expr.kind)))) (and (=> (= (ControlFlow 0 20) 18) anon13_Then_correct) (=> (= (ControlFlow 0 20) 19) anon13_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@8) ($IsHeapAnchor $Heap@@8)) (=> (and (and (and (or (not (= this@@12 null)) (not true)) (and ($Is refType this@@12 Tclass.M3.Expr) ($IsAlloc refType this@@12 Tclass.M3.Expr $Heap@@8))) (= 3 $FunctionContextHeight)) (and (and (|M3.Expr.Valid#canCall| $Heap@@8 this@@12) (and (M3.Expr.Valid ($LS $LZ) $Heap@@8 this@@12) (and (M3.Expr.Core ($LS $LZ) $Heap@@8 this@@12) (M3.Expr.Valid_k ($LS $LZ) $Heap@@8 this@@12)))) (= (ControlFlow 0 21) 20))) anon0_correct))))
