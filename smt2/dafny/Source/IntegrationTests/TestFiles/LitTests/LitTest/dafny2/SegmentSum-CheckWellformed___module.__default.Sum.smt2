...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon14_Else_correct  (=> (or (not (= |s#0@@2| |t#0@@2|)) (not true)) (=> (and (and ($IsAlloc SeqType |a#0@@2| (TSeq TInt) $Heap) ($IsAlloc intType (int_2_U |s#0@@2|) TInt $Heap)) (and (= |##t#0@0| (- |t#0@@2| 1)) ($IsAlloc intType (int_2_U |##t#0@0|) TInt $Heap))) (and (=> (= (ControlFlow 0 4) (- 0 10)) (<= (LitInt 0) |s#0@@2|)) (and (=> (= (ControlFlow 0 4) (- 0 9)) (<= |s#0@@2| |##t#0@0|)) (and (=> (= (ControlFlow 0 4) (- 0 8)) (<= |##t#0@0| (|Seq#Length| |a#0@@2|))) (=> (and (and (<= (LitInt 0) |s#0@@2|) (<= |s#0@@2| |##t#0@0|)) (<= |##t#0@0| (|Seq#Length| |a#0@@2|))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (or (or (<= 0 |s#0@@2|) (< (|Seq#Rank| |a#0@@2|) (|Seq#Rank| |a#0@@2|))) (= |s#0@@2| |s#0@@2|))) (=> (or (or (<= 0 |s#0@@2|) (< (|Seq#Rank| |a#0@@2|) (|Seq#Rank| |a#0@@2|))) (= |s#0@@2| |s#0@@2|)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (or (or (or (<= 0 |t#0@@2|) (< (|Seq#Rank| |a#0@@2|) (|Seq#Rank| |a#0@@2|))) (< |s#0@@2| |s#0@@2|)) (= |##t#0@0| |t#0@@2|))) (=> (or (or (or (<= 0 |t#0@@2|) (< (|Seq#Rank| |a#0@@2|) (|Seq#Rank| |a#0@@2|))) (< |s#0@@2| |s#0@@2|)) (= |##t#0@0| |t#0@@2|)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (< (|Seq#Rank| |a#0@@2|) (|Seq#Rank| |a#0@@2|)) (and (= (|Seq#Rank| |a#0@@2|) (|Seq#Rank| |a#0@@2|)) (or (< |s#0@@2| |s#0@@2|) (and (= |s#0@@2| |s#0@@2|) (< |##t#0@0| |t#0@@2|)))))) (=> (or (< (|Seq#Rank| |a#0@@2|) (|Seq#Rank| |a#0@@2|)) (and (= (|Seq#Rank| |a#0@@2|) (|Seq#Rank| |a#0@@2|)) (or (< |s#0@@2| |s#0@@2|) (and (= |s#0@@2| |s#0@@2|) (< |##t#0@0| |t#0@@2|))))) (=> (and (|_module.__default.Sum#canCall| |a#0@@2| |s#0@@2| (- |t#0@@2| 1)) (= (ControlFlow 0 4) (- 0 3))) (and (<= 0 (- |t#0@@2| 1)) (< (- |t#0@@2| 1) (|Seq#Length| |a#0@@2|))))))))))))))))))
(let ((anon14_Then_correct true))
(let ((anon13_Then_correct true))
(let ((anon5_correct  (=> (and (and (<= (LitInt 0) |s#0@@2|) (<= |s#0@@2| |t#0@@2|)) (<= |t#0@@2| (|Seq#Length| |a#0@@2|))) (and (and (=> (= (ControlFlow 0 11) 1) anon13_Then_correct) (=> (= (ControlFlow 0 11) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 11) 4) anon14_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (not (and (<= (LitInt 0) |s#0@@2|) (<= |s#0@@2| |t#0@@2|))) (= (ControlFlow 0 13) 11)) anon5_correct)))
(let ((anon12_Then_correct  (=> (and (and (<= (LitInt 0) |s#0@@2|) (<= |s#0@@2| |t#0@@2|)) (= (ControlFlow 0 12) 11)) anon5_correct)))
(let ((anon11_Else_correct  (=> (< |s#0@@2| (LitInt 0)) (and (=> (= (ControlFlow 0 15) 12) anon12_Then_correct) (=> (= (ControlFlow 0 15) 13) anon12_Else_correct)))))
(let ((anon11_Then_correct  (=> (<= (LitInt 0) |s#0@@2|) (and (=> (= (ControlFlow 0 14) 12) anon12_Then_correct) (=> (= (ControlFlow 0 14) 13) anon12_Else_correct)))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 16) 14) anon11_Then_correct) (=> (= (ControlFlow 0 16) 15) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is SeqType |a#0@@2| (TSeq TInt))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 17) 16))) anon0_correct)))
