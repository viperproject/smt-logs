...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split152)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon129_Then_correct  (=> (and (and (<= (ite (< |k#0@0| |l#0@4|) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (- |l#0@4| 1))))) 1) (- |n#0@3| |W#0|)) |i#1_0@0|) (< |i#1_0@0| |n#0@3|)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |a#0@@4| null)) (not true)))))
