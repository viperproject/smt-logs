...
(set-info :boogie-vc-id Impl$$_module.__default.MinimumWindowMax_split147)
...
)) (<= |k#0@0| (- |l#0@4| 1))) (and (or (not (= |a#0@@4| null)) (not true)) (= (ControlFlow 0 2) (- 0 1)))) (and (<= 0 |n#0@3|) (< |n#0@3| (_System.array.Length |a#0@@4|))))))
