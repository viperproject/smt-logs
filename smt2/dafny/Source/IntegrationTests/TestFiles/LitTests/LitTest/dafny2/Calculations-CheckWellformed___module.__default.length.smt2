...
(let ((anon10_Then_correct  (=> (and (= |l#0@@4| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) ($IsBox |_mcc#0#0| _module._default.length$_T0@@3)) (=> (and (and (and ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List _module._default.length$_T0@@3)) (= |let#0#0#0| |_mcc#1#0|)) (and ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List _module._default.length$_T0@@3)) (= |xs#Z#0@0| |let#0#0#0|))) (and (and (= |let#1#0#0| |_mcc#0#0|) ($IsBox |let#1#0#0| _module._default.length$_T0@@3)) (and (= |x#Z#0@0| |let#1#0#0|) ($IsAlloc DatatypeTypeType |xs#Z#0@0| (Tclass._module.List _module._default.length$_T0@@3) $Heap)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< (DtRank |xs#Z#0@0|) (DtRank |l#0@@4|))) (=> (< (DtRank |xs#Z#0@0|) (DtRank |l#0@@4|)) (=> (and (|_module.__default.length#canCall| _module._default.length$_T0@@3 |xs#Z#0@0|) (= (ControlFlow 0 5) (- 0 4))) ($Is intType (int_2_U (+ 1 (_module.__default.length _module._default.length$_T0@@3 ($LS $LZ) |xs#Z#0@0|))) Tclass._System.nat))))))))
(let ((anon9_Else_correct  (=> (or (not (= |l#0@@4| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 8) 5) anon10_Then_correct) (=> (= (ControlFlow 0 8) 7) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> (and (= |l#0@@4| |#_module.List.Nil|) (= (ControlFlow 0 3) (- 0 2))) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |l#0@@4| (Tclass._module.List _module._default.length$_T0@@3))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct)))
