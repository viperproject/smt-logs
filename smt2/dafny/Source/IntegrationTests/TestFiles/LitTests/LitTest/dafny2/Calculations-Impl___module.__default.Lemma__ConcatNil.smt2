...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.concat$_T0@@1 T@U) ($ly@@1 T@U) (|l#0@@1| T@U) (|ys#0@@1| T@U) ) (!  (=> (or (|_module.__default.concat#canCall| _module._default.concat$_T0@@1 |l#0@@1| |ys#0@@1|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |l#0@@1| (Tclass._module.List _module._default.concat$_T0@@1)) ($Is DatatypeTypeType |ys#0@@1| (Tclass._module.List _module._default.concat$_T0@@1))))) ($Is DatatypeTypeType (_module.__default.concat _module._default.concat$_T0@@1 $ly@@1 |l#0@@1| |ys#0@@1|) (Tclass._module.List _module._default.concat$_T0@@1)))
 :qid |unknown.0:0|
 :skolemid |540|
 :pattern ( (_module.__default.concat _module._default.concat$_T0@@1 $ly@@1 |l#0@@1| |ys#0@@1|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.concat$_T0@@2 T@U) ($ly@@2 T@U) (|l#0@@3| T@U) (|ys#0@@2| T@U) ) (!  (=> (and (or (|_module.__default.concat#canCall| _module._default.concat$_T0@@2 |l#0@@3| |ys#0@@2|) (and (< 1 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |l#0@@3| (Tclass._module.List _module._default.concat$_T0@@2)) ($IsAlloc DatatypeTypeType |l#0@@3| (Tclass._module.List _module._default.concat$_T0@@2) $Heap)) (and ($Is DatatypeTypeType |ys#0@@2| (Tclass._module.List _module._default.concat$_T0@@2)) ($IsAlloc DatatypeTypeType |ys#0@@2| (Tclass._module.List _module._default.concat$_T0@@2) $Heap))))) ($IsGoodHeap $Heap)) ($IsAlloc DatatypeTypeType (_module.__default.concat _module._default.concat$_T0@@2 $ly@@2 |l#0@@3| |ys#0@@2|) (Tclass._module.List _module._default.concat$_T0@@2) $Heap))
 :qid |Calculationsdfy.16:16|
 :skolemid |541|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.__default.concat _module._default.concat$_T0@@2 $ly@@2 |l#0@@3| |ys#0@@2|) (Tclass._module.List _module._default.concat$_T0@@2) $Heap))
))))
...
(assert (forall ((_module._default.concat$_T0@@3 T@U) ($ly@@3 T@U) (|l#0@@4| T@U) (|ys#0@@3| T@U) ) (! (= (_module.__default.concat _module._default.concat$_T0@@3 ($LS $ly@@3) |l#0@@4| |ys#0@@3|) (_module.__default.concat _module._default.concat$_T0@@3 $ly@@3 |l#0@@4| |ys#0@@3|))
 :qid |unknown.0:0|
 :skolemid |538|
 :pattern ( (_module.__default.concat _module._default.concat$_T0@@3 ($LS $ly@@3) |l#0@@4| |ys#0@@3|))
)))
...
(declare-fun _module._default.Lemma_ConcatNil$_T0 () T@U)
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.Lemma__ConcatNil)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (|$IsA#_module.List| |xs#0@@0|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@0 $Heap@0)) (and (forall ((|$ih#xs0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#xs0#0| (Tclass._module.List _module._default.Lemma_ConcatNil$_T0)) (U_2_bool (Lit boolType (bool_2_U true)))) (< (DtRank |$ih#xs0#0|) (DtRank |xs#0@@0|))) (|_module.List#Equal| (_module.__default.concat _module._default.Lemma_ConcatNil$_T0 ($LS $LZ) |$ih#xs0#0| (Lit DatatypeTypeType |#_module.List.Nil|)) |$ih#xs0#0|))
 :qid |Calculationsdfy.44:23|
 :skolemid |569|
 :pattern ( (_module.__default.concat _module._default.Lemma_ConcatNil$_T0 ($LS $LZ) |$ih#xs0#0| (Lit DatatypeTypeType |#_module.List.Nil|)))
)) (= (ControlFlow 0 2) (- 0 1)))) (|_module.List#Equal| (_module.__default.concat _module._default.Lemma_ConcatNil$_T0 ($LS ($LS $LZ)) |xs#0@@0| (Lit DatatypeTypeType |#_module.List.Nil|)) |xs#0@@0|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and ($Is DatatypeTypeType |xs#0@@0| (Tclass._module.List _module._default.Lemma_ConcatNil$_T0)) ($IsAlloc DatatypeTypeType |xs#0@@0| (Tclass._module.List _module._default.Lemma_ConcatNil$_T0) $Heap@@0)) (|$IsA#_module.List| |xs#0@@0|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
