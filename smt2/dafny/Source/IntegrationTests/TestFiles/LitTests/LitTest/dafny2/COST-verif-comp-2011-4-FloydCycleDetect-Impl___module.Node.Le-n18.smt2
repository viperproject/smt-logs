...
(set-info :boogie-vc-id Impl$$_module.Node.Lemma__NullImpliesNoCycles__part0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((|k#1| Int) (|l#1@@0| Int) ) (!  (=> (and (and (and (<= |n#0@@0| |k#1|) (<= (LitInt 0) |l#1@@0|)) (or (not (= (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 |k#1| |S#0@@4|) null)) (not true))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 |k#1| |S#0@@4|)) _module.Node.next)) null)) (not true))) (or (not (= (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 |k#1| |S#0@@4|)) _module.Node.next)) |l#1@@0| |S#0@@4|) (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 |k#1| |S#0@@4|))) (not true)))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.333:20|
 :skolemid |884|
 :pattern ( (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 |k#1| |S#0@@4|)) _module.Node.next)) |l#1@@0| |S#0@@4|))
)))))
(let ((anon3_correct  (=> (forall ((|k#4| Int) ) (!  (=> (<= |n#0@@0| |k#4|) (|_module.Node.Nexxxt#canCall| $Heap@0 this@@4 |k#4| |S#0@@4|))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.335:19|
 :skolemid |890|
 :pattern ( (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |k#4| |S#0@@4|))
)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((|k#4@@0| Int) ) (!  (=> (and (forall ((|k$ih#0#0| Int) ) (!  (=> (and (<= 0 |k$ih#0#0|) (< |k$ih#0#0| |k#4@@0|)) (=> (<= |n#0@@0| |k$ih#0#0|) (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |k$ih#0#0| |S#0@@4|) null)))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.335:19|
 :skolemid |891|
 :pattern ( (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |k$ih#0#0| |S#0@@4|))
)) true) (=> (<= |n#0@@0| |k#4@@0|) (= (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 |k#4@@0| |S#0@@4|) null)))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.335:19|
 :skolemid |892|
 :pattern ( (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this@@4 |k#4@@0| |S#0@@4|))
))) (=> (and (forall ((|k#4@@1| Int) ) (!  (=> (<= |n#0@@0| |k#4@@1|) (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |k#4@@1| |S#0@@4|) null))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.335:19|
 :skolemid |894|
 :pattern ( (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |k#4@@1| |S#0@@4|))
)) (= (ControlFlow 0 4) 3)) GeneratedUnifiedExit_correct)))))
(let ((anon5_Else_correct  (=> (and (< |k#3@0| |n#0@@0|) (= (ControlFlow 0 11) 4)) anon3_correct)))
(let ((anon5_Then_correct  (=> (and (and (<= |n#0@@0| |k#3@0|) ($IsAllocBox ($Box refType this@@4) Tclass._module.Node? $Heap@0)) (and ($IsAlloc intType (int_2_U |k#3@0|) TInt $Heap@0) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Node?) $Heap@0))) (and (=> (= (ControlFlow 0 6) (- 0 10)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType this@@4))))) (and (=> (= (ControlFlow 0 6) (- 0 9)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (|Set#IsMember| |S#0@@4| ($Box refType null))))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (=> (|_module.Node.IsClosed#canCall| $Heap@0 this@@4 |S#0@@4|) (or (_module.Node.IsClosed $Heap@0 this@@4 |S#0@@4|) (forall ((|n#9| T@U) ) (!  (=> ($Is refType |n#9| Tclass._module.Node?) (=> (and (and (|Set#IsMember| |S#0@@4| ($Box refType |n#9|)) (or (not (= |n#9| null)) (not true))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#9|) _module.Node.next)) null)) (not true))) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#9|) _module.Node.next))))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.133:12|
 :skolemid |888|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#9|) _module.Node.next)))
))))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= (LitInt 0) |k#3@0|)) (=> (and (|_module.Node.Nexxxt#canCall| $Heap@0 this@@4 |k#3@0| |S#0@@4|) (= (ControlFlow 0 6) 4)) anon3_correct))))))))
(let ((anon4_Then_correct  (and (=> (= (ControlFlow 0 12) 6) anon5_Then_correct) (=> (= (ControlFlow 0 12) 11) anon5_Else_correct))))
(let ((anon4_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#3| null $Heap@@4 alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@4 $Heap@0) (forall ((|$ih#n0#0| Int) (|$ih#S0#0| T@U) ) (!  (=> (and (and ($Is SetType |$ih#S0#0| (TSet Tclass._module.Node?)) (and (and (_module.Node.IsClosed $Heap@@4 this@@4 |$ih#S0#0|) (<= (LitInt 0) |$ih#n0#0|)) (= (_module.Node.Nexxxt ($LS $LZ) $Heap@@4 this@@4 |$ih#n0#0| |$ih#S0#0|) null))) (or (and (<= 0 |$ih#n0#0|) (< |$ih#n0#0| |n#0@@0|)) (and (= |$ih#n0#0| |n#0@@0|) (and (|Set#Subset| |$ih#S0#0| |S#0@@4|) (not (|Set#Subset| |S#0@@4| |$ih#S0#0|)))))) (forall ((|k#2| Int) (|l#2@@0| Int) ) (!  (=> (and (and (and (<= |$ih#n0#0| |k#2|) (<= (LitInt 0) |l#2@@0|)) (or (not (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |k#2| |$ih#S0#0|) null)) (not true))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |k#2| |$ih#S0#0|)) _module.Node.next)) null)) (not true))) (or (not (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |k#2| |$ih#S0#0|)) _module.Node.next)) |l#2@@0| |$ih#S0#0|) (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |k#2| |$ih#S0#0|))) (not true)))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.333:20|
 :skolemid |886|
 ...
 :qid |COSTverifcomp20114FloydCycleDetectdfy.331:41|
 :skolemid |887|
 :pattern ( (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this@@4 |$ih#n0#0| |$ih#S0#0|))
)))) (and (=> (= (ControlFlow 0 13) 12) anon4_Then_correct) (=> (= (ControlFlow 0 13) 1) anon4_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.Node) ($IsAlloc refType this@@4 Tclass._module.Node $Heap@@4)))) (and (and ($Is SetType |S#0@@4| (TSet Tclass._module.Node?)) ($IsAlloc SetType |S#0@@4| (TSet Tclass._module.Node?) $Heap@@4)) (= 2 $FunctionContextHeight))) (and (and (and (|_module.Node.IsClosed#canCall| $Heap@@4 this@@4 |S#0@@4|) (and (_module.Node.IsClosed $Heap@@4 this@@4 |S#0@@4|) (and (and (|Set#IsMember| |S#0@@4| ($Box refType this@@4)) (|Set#IsMember| |S#0@@4| ($Box refType null))) (forall ((|n#8| T@U) ) (!  (=> ($Is refType |n#8| Tclass._module.Node?) (=> (and (and (|Set#IsMember| |S#0@@4| ($Box refType |n#8|)) (or (not (= |n#8| null)) (not true))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 |n#8|) _module.Node.next)) null)) (not true))) (|Set#IsMember| |S#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 |n#8|) _module.Node.next))))
 :qid |COSTverifcomp20114FloydCycleDetectdfy.133:12|
 :skolemid |882|
...
))))) (<= (LitInt 0) |n#0@@0|)) (and (= (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@@4 this@@4 |n#0@@0| |S#0@@4|) null) (= (ControlFlow 0 14) 13)))) anon0_correct)))
