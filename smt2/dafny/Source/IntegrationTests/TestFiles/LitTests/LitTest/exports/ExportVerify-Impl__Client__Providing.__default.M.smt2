...
(set-info :boogie-vc-id Impl$$Client__Providing.__default.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (= Lib.__default.Ten (LitInt 10))) (=> (= Lib.__default.Ten (LitInt 10)) (=> (and |Lib.__default.Two#canCall| |Lib.__default.Two#canCall|) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< Lib.__default.Two 10)) (=> (< Lib.__default.Two 10) (=> (and |Lib.__default.Two#canCall| |Lib.__default.Two#canCall|) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= Lib.__default.Two (LitInt 2))) (=> (= Lib.__default.Two (LitInt 2)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= Lib.D.PI (LitReal 3.14))) (=> (= Lib.D.PI (LitReal 3.14)) (=> (= (ControlFlow 0 2) (- 0 1)) (= (Lib.D.n |d#0|) (LitInt 59))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($IsBox |d#0| Tclass.Lib.D) ($IsAllocBox |d#0| Tclass.Lib.D $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 7) 2))) anon0_correct))))
