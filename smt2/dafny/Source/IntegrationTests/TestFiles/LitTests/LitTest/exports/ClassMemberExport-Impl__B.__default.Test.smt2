...
(declare-fun A.AClass.f (T@U) T@U)
...
(assert (forall (($Heap T@U) (this T@U) ) (!  (=> (and (or (|A.AClass.f#canCall| this) (and (or (not (= this null)) (not true)) ($IsAlloc refType this Tclass.A.AClass $Heap))) ($IsGoodHeap $Heap)) ($IsAllocBox (A.AClass.f this) Tclass.A.T $Heap))
 :qid |ClassMemberExportdfy.10:15|
 :skolemid |985|
 :pattern ( ($IsAllocBox (A.AClass.f this) Tclass.A.T $Heap))
)))
...
(assert (forall ((this@@0 T@U) ) (!  (=> (or (|A.AClass.f#canCall| this@@0) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass.A.AClass))) ($IsBox (A.AClass.f this@@0) Tclass.A.T))
 :qid |ClassMemberExportdfy.10:15|
 :skolemid |984|
 :pattern ( (A.AClass.f this@@0))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and (and (or (not (= call1formal@this null)) (not true)) (and ($Is refType call1formal@this Tclass.A.AClass) ($IsAlloc refType call1formal@this Tclass.A.AClass $Heap@@0))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (=> (and (and (and (or (not (= call1formal@this@0 null)) (not true)) (and ($Is refType call1formal@this@0 Tclass.A.AClass) ($IsAlloc refType call1formal@this@0 Tclass.A.AClass $Heap@0))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 call1formal@this@0) alloc))))) (and (forall (($o@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@2) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@2) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@2)))
 :qid |ClassMemberExportdfy.12:18|
 :skolemid |987|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@2))
)) ($HeapSucc $Heap@@0 $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= call1formal@this@0 null)) (not true)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and (=> |defass#a#0| (and ($Is refType |a#0| Tclass.A.AClass) ($IsAlloc refType |a#0| Tclass.A.AClass $Heap@@0))) true)) (and (and (=> |defass#f#0| (and ($IsBox |f#0| Tclass.A.T) ($IsAllocBox |f#0| Tclass.A.T $Heap@@0))) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct)))
