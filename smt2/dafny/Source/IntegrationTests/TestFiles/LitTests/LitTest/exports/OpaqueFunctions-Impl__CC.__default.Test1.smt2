...
(declare-fun AA.__default.f (Bool) Int)
...
(assert (= (AA.__default.f true) (LitInt 0)))
(assert (= (AA.__default.f true) (LitInt 0)))
...
(declare-fun reveal_AA._default.f () Bool)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$CC.__default.Test1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (= (AA.__default.f reveal_AA._default.f) (LitInt 0)))))
