...
(set-info :boogie-vc-id Impl$$A.__default.G)
...
(let ((anon5_Then_correct  (=> (and (= |x#0| |#A.T2.N|) (= (ControlFlow 0 4) (- 0 3))) (U_2_bool (Lit boolType (bool_2_U true))))))
(let ((anon4_Else_correct  (=> (or (not (= |x#0| (|#A.T2.C| |_mcc#0#1_0@0|))) (not true)) (and (=> (= (ControlFlow 0 6) 4) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct)))))
(let ((anon4_Then_correct  (=> (= |x#0| (|#A.T2.C| |_mcc#0#1_0@0|)) (=> (and (and (and ($Is DatatypeTypeType |_mcc#0#1_0@0| Tclass.A.T2) ($IsAlloc DatatypeTypeType |_mcc#0#1_0@0| Tclass.A.T2 $Heap)) (and ($Is DatatypeTypeType |x'#1_0@0| Tclass.A.T2) ($IsAlloc DatatypeTypeType |x'#1_0@0| Tclass.A.T2 $Heap))) (and (and (= |let#1_0#0#0| |_mcc#0#1_0@0|) ($Is DatatypeTypeType |let#1_0#0#0| Tclass.A.T2)) (and (= |x'#1_0@0| |let#1_0#0#0|) (= (ControlFlow 0 2) (- 0 1))))) (< (DtRank |x'#1_0@0|) (DtRank |x#0|))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |x#0| Tclass.A.T2) ($IsAlloc DatatypeTypeType |x#0| Tclass.A.T2 $Heap)) (|$IsA#A.T2| |x#0|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
