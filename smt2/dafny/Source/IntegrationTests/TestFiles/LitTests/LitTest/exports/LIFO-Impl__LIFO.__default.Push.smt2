...
(declare-fun |item#0| () Int)
(declare-fun |q#0| () T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |q'#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$LIFO.__default.Push)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |q'#0@0| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |item#0|))) |q#0|)) (= (ControlFlow 0 2) (- 0 1))) (= (|Seq#Length| |q'#0@0|) (+ (|Seq#Length| |q#0|) 1))))))
