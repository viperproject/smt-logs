...
(assert (forall (($h T@U) ($o@@0 T@U) ) (!  (=> (and (and ($IsGoodHeap $h) ($IsBox $o@@0 Tclass.Lib.D)) ($IsAllocBox $o@@0 Tclass.Lib.D $h)) ($IsAlloc intType (int_2_U (Lib.D.n $o@@0)) TInt $h))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |994|
 :pattern ( (Lib.D.n $o@@0) ($IsAllocBox $o@@0 Tclass.Lib.D $h))
)))
...
(set-info :boogie-vc-id Impl$$Client__ProvideTypes.__default.M0)
