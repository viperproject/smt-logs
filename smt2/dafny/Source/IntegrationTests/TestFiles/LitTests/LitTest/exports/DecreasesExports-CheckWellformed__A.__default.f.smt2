...
(declare-fun A.__default.f (T@U T@U Int) T@U)
(declare-fun $LS (T@U) T@U)
(declare-fun |A.__default.f#canCall| (T@U Int) Bool)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon8_Else_correct  (=> (and (and (< (LitInt 0) |y#0@@3|) ($IsAlloc DatatypeTypeType |x#0@@3| Tclass.A.T2 $Heap)) (and (= |##y#0@0| (- |y#0@@3| 1)) ($IsAlloc intType (int_2_U |##y#0@0|) TInt $Heap))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (or (<= 0 |y#0@@3|) (< (DtRank |x#0@@3|) (DtRank |x#0@@3|))) (= |##y#0@0| |y#0@@3|))) (=> (or (or (<= 0 |y#0@@3|) (< (DtRank |x#0@@3|) (DtRank |x#0@@3|))) (= |##y#0@0| |y#0@@3|)) (=> (= (ControlFlow 0 4) (- 0 3)) (or (< (DtRank |x#0@@3|) (DtRank |x#0@@3|)) (and (= (DtRank |x#0@@3|) (DtRank |x#0@@3|)) (< |##y#0@0| |y#0@@3|)))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |x#0@@3| Tclass.A.T2)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct)))
