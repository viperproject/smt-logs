...
(set-info :boogie-vc-id Impl$$LIFO.__default.Init)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |q#0@0| (Lit SeqType |Seq#Empty|)) (= (ControlFlow 0 2) (- 0 1))) (= (|Seq#Length| |q#0@0|) (LitInt 0))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |q#0| (TSeq TInt)) ($IsAlloc SeqType |q#0| (TSeq TInt) $Heap)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
