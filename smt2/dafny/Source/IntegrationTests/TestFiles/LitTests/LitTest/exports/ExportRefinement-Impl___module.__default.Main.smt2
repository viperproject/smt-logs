...
(assert (distinct alloc Tagclass.A2.C Tagclass.A2.C? tytagFamily$C)
)
(assert (= (Ctor refType) 3))
(assert (forall (($o T@U) ) (! (= ($Is refType $o Tclass.A2.C?)  (or (= $o null) (= (dtype $o) Tclass.A2.C?)))
 :qid |unknown.0:0|
 :skolemid |6323|
 :pattern ( ($Is refType $o Tclass.A2.C?))
)))
(assert (forall ((|c#0| T@U) ($h T@U) ) (! (= ($IsAlloc refType |c#0| Tclass.A2.C $h) ($IsAlloc refType |c#0| Tclass.A2.C? $h))
 :qid |unknown.0:0|
 :skolemid |6328|
 :pattern ( ($IsAlloc refType |c#0| Tclass.A2.C $h))
 :pattern ( ($IsAlloc refType |c#0| Tclass.A2.C? $h))
)))
...
(assert (forall (($o@@0 T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType $o@@0 Tclass.A2.C? $h@@0)  (or (= $o@@0 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@0 $o@@0) alloc)))))
 :qid |unknown.0:0|
 :skolemid |6324|
 :pattern ( ($IsAlloc refType $o@@0 Tclass.A2.C? $h@@0))
)))
...
(assert (forall ((|c#0@@0| T@U) ) (! (= ($Is refType |c#0@@0| Tclass.A2.C)  (and ($Is refType |c#0@@0| Tclass.A2.C?) (or (not (= |c#0@@0| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |6327|
 :pattern ( ($Is refType |c#0@@0| Tclass.A2.C))
 :pattern ( ($Is refType |c#0@@0| Tclass.A2.C?))
)))
...
(assert (= (Tag Tclass.A2.C) Tagclass.A2.C))
(assert (= (TagFamily Tclass.A2.C) tytagFamily$C))
(assert (= (Tag Tclass.A2.C?) Tagclass.A2.C?))
(assert (= (TagFamily Tclass.A2.C?) tytagFamily$C))
(push 1)
...
(assert (not
 ...
 :qid |ExportRefinementdfy.86:10|
 :skolemid |6329|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@3))
)) ($HeapSucc $Heap@0 $Heap@1))) (and (and (or (not (= call1formal@this null)) (not true)) (and ($Is refType call1formal@this Tclass.A2.C) ($IsAlloc refType call1formal@this Tclass.A2.C $Heap))) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)))) (and (and (and (or (not (= call1formal@this@0 null)) (not true)) (and ($Is refType call1formal@this@0 Tclass.A2.C) ($IsAlloc refType call1formal@this@0 Tclass.A2.C $Heap@2))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0) alloc))))) (and (forall (($o@@4 T@U) ) (!  (=> (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@4) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@4) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@4)))
 :qid |ExportRefinementdfy.78:17|
 :skolemid |6326|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@4))
)) ($HeapSucc $Heap@1 $Heap@2)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= call1formal@this@0 null)) (not true)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (=> |defass#c#0| (and ($Is refType |c#0@@1| Tclass.A2.C) ($IsAlloc refType |c#0@@1| Tclass.A2.C $Heap))) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
