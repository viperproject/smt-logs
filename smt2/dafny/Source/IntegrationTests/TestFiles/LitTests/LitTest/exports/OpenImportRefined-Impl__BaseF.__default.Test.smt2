...
(declare-fun GiveF.__default.f (Bool) Bool)
...
(assert (= (GiveF.__default.f true) (U_2_bool (Lit boolType (bool_2_U true)))))
(assert (= (GiveF.__default.f true) (U_2_bool (Lit boolType (bool_2_U true)))))
...
(declare-fun reveal_GiveF._default.f () Bool)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$BaseF.__default.Test)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and reveal_GiveF._default.f (= (ControlFlow 0 2) (- 0 1)))) (= (GiveF.__default.f reveal_GiveF._default.f) (U_2_bool (Lit boolType (bool_2_U true))))))))
