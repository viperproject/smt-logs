...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |A.__default.f#canCall| (< 0 $FunctionContextHeight)) (= A.__default.f (LitInt 7)))))
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |A.__default.f#canCall| (< 0 $FunctionContextHeight)) (= A.__default.f (LitInt 7)))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |A.__default.f#canCall| (< 0 $FunctionContextHeight)) (<= (LitInt 0) A.__default.f))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) ($Is intType (int_2_U (LitInt 7)) Tclass._System.nat))))
