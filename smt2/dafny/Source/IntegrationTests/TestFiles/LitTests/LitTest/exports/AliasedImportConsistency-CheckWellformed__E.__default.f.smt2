...
(declare-fun |E.__default.f#canCall| () Bool)
(declare-fun E.__default.f () Int)
...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |E.__default.f#canCall| (< 0 $FunctionContextHeight)) (= E.__default.f (LitInt 0)))))
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |E.__default.f#canCall| (< 0 $FunctionContextHeight)) (= E.__default.f (LitInt 0)))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |E.__default.f#canCall| (< 0 $FunctionContextHeight)) (<= (LitInt 0) E.__default.f))))
...
(set-info :boogie-vc-id CheckWellformed$$E.__default.f)
