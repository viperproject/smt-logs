...
(set-info :boogie-vc-id Impl$$RefinedF.__default.Test)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) false) (= (U_2_bool (Lit boolType (bool_2_U RefinedF.__default.f))) (U_2_bool (Lit boolType (bool_2_U true)))))))
