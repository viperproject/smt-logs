...
(declare-fun |A.AClass.f#canCall| (T@U) Bool)
(declare-fun |f#0@0| () Int)
(declare-fun A.AClass.f (T@U) Int)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (or (not (= call1formal@this null)) (not true)) (and ($Is refType call1formal@this Tclass.A.AClass) ($IsAlloc refType call1formal@this Tclass.A.AClass $Heap))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (=> (and (and (and (or (not (= call1formal@this@0 null)) (not true)) (and ($Is refType call1formal@this@0 Tclass.A.AClass) ($IsAlloc refType call1formal@this@0 Tclass.A.AClass $Heap@0))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap call1formal@this@0) alloc))))) (and (forall (($o@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@2) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2)))
 :qid |ClassMemberExportdfy.12:18|
 :skolemid |1481|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@2))
)) ($HeapSucc $Heap $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= call1formal@this@0 null)) (not true))) (=> (or (not (= call1formal@this@0 null)) (not true)) (=> (and (and ($IsAllocBox ($Box refType call1formal@this@0) Tclass.A.AClass? $Heap@0) (|A.AClass.f#canCall| call1formal@this@0)) (and (|A.AClass.f#canCall| call1formal@this@0) (= |f#0@0| (A.AClass.f call1formal@this@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= call1formal@this@0 null)) (not true)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (=> |defass#a#0| (and ($Is refType |a#0| Tclass.A.AClass) ($IsAlloc refType |a#0| Tclass.A.AClass $Heap))) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 6) 2))) anon0_correct))))
