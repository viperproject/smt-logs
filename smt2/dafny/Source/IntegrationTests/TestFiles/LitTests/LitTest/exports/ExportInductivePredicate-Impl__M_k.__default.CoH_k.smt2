...
(set-info :boogie-vc-id Impl$$M_k.__default.CoH_k)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|M.__default.Q_h#canCall| (Lit BoxType (|ORD#FromNat| 3)) |x#0@@3|) (or (M.__default.Q_h (Lit BoxType (|ORD#FromNat| 3)) |x#0@@3|) (=> (U_2_bool (Lit boolType (bool_2_U (< 0 (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 3))))))) (< |x#0@@3| 100))))) (=> (=> (|M.__default.Q_h#canCall| (Lit BoxType (|ORD#FromNat| 3)) |x#0@@3|) (or (M.__default.Q_h (Lit BoxType (|ORD#FromNat| 3)) |x#0@@3|) (=> (U_2_bool (Lit boolType (bool_2_U (< 0 (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 3))))))) (< |x#0@@3| 100)))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|M.__default.Q_h#canCall| (Lit BoxType (|ORD#FromNat| 3)) |x#0@@3|) (or (M.__default.Q_h (Lit BoxType (|ORD#FromNat| 3)) |x#0@@3|) (=> (= (LitInt 0) (LitInt (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 3))))) (forall ((|_k'#1| T@U) ) (!  (=> (|ORD#Less| |_k'#1| (|ORD#FromNat| 3)) (M.__default.Q_h |_k'#1| |x#0@@3|))
 :qid |ExportInductivePredicatedfy.10:22|
 :skolemid |1107|
 :pattern ( (M.__default.Q_h |_k'#1| |x#0@@3|))
)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 0 $FunctionContextHeight)) (and (< |x#0@@3| 100) (= (ControlFlow 0 4) 2))) anon0_correct)))
