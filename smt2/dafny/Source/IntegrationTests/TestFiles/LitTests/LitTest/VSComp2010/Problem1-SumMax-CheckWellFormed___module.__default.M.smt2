...
(let ((anon9_Else_correct  (=> (and (not (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| |N#0|))) (= (ControlFlow 0 6) 2)) anon6_correct)))
(let ((anon9_Then_correct  (=> (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| |N#0|)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 |k#0@0|) (< |k#0@0| (_System.array.Length |a#0|)))) (=> (and (<= 0 |k#0@0|) (< |k#0@0| (_System.array.Length |a#0|))) (=> (= (ControlFlow 0 3) 2) anon6_correct))))))))
(let ((anon8_Else_correct  (=> (< |k#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 8) 3) anon9_Then_correct) (=> (= (ControlFlow 0 8) 6) anon9_Else_correct)))))
(let ((anon8_Then_correct  (=> (<= (LitInt 0) |k#0@0|) (and (=> (= (ControlFlow 0 7) 3) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))
(let ((anon7_Then_correct  (and (=> (= (ControlFlow 0 9) 7) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct))))
(let ((anon7_Else_correct true))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (<= (LitInt 0) |N#0|)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (= (_System.array.Length |a#0|) |N#0|) (and (=> (= (ControlFlow 0 10) 9) anon7_Then_correct) (=> (= (ControlFlow 0 10) 1) anon7_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 12) 10))) anon0_correct))))
