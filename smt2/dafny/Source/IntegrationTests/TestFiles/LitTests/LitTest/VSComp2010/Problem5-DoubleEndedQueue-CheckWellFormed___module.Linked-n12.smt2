...
(assert (forall ((_module.LinkedList$T@@7 T@U) ($ly@@1 T@U) ($h0 T@U) ($h1 T@U) (this@@1 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 (Tclass._module.LinkedList _module.LinkedList$T@@7)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@3 T@U) ($f T@U) ) (!  (=> (and (or (not (= $o@@3 null)) (not true)) (or (= $o@@3 this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 this@@1) _module.LinkedList.Repr)) ($Box refType $o@@3)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@3) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@3) $f)))
 :qid |unknown.0:0|
 :skolemid |548|
)) (= (_module.LinkedList.Valid _module.LinkedList$T@@7 $ly@@1 $h0 this@@1) (_module.LinkedList.Valid _module.LinkedList$T@@7 $ly@@1 $h1 this@@1))))
 :qid |unknown.0:0|
 :skolemid |549|
...
(declare-fun |r#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.LinkedList.Concat)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@2 alloc false)) ($IsAllocBox ($Box refType this@@3) (Tclass._module.LinkedList? _module.LinkedList$T@@23) $Heap@@2)) (and (|_module.LinkedList.Valid#canCall| _module.LinkedList$T@@23 $Heap@@2 this@@3) (_module.LinkedList.Valid _module.LinkedList$T@@23 ($LS $LZ) $Heap@@2 this@@3))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |end#0| null)) (not true))) (=> (or (not (= |end#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |end#0|) (Tclass._module.LinkedList? _module.LinkedList$T@@23) $Heap@@2) (=> (and (and (and (|_module.LinkedList.Valid#canCall| _module.LinkedList$T@@23 $Heap@@2 |end#0|) (_module.LinkedList.Valid _module.LinkedList$T@@23 ($LS $LZ) $Heap@@2 |end#0|)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (forall (($o@@13 T@U) ) (!  (=> (and (or (not (= $o@@13 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@13) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@13) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@13)))
 :qid |Problem5DoubleEndedQueuedfy.133:10|
 :skolemid |564|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@13))
)) ($HeapSucc $Heap@@2 $Heap@0)) (and ($Is refType |r#0@0| (Tclass._module.LinkedList _module.LinkedList$T@@23)) ($IsAlloc refType |r#0@0| (Tclass._module.LinkedList _module.LinkedList$T@@23) $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |r#0@0| null)) (not true))) (=> (or (not (= |r#0@0| null)) (not true)) (=> ($IsAllocBox ($Box refType |r#0@0|) (Tclass._module.LinkedList? _module.LinkedList$T@@23) $Heap@0) (=> (and (|_module.LinkedList.Valid#canCall| _module.LinkedList$T@@23 $Heap@0 |r#0@0|) (_module.LinkedList.Valid _module.LinkedList$T@@23 ($LS $LZ) $Heap@0 |r#0@0|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |r#0@0| null)) (not true))) (=> (or (not (= |r#0@0| null)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= |end#0| null)) (not true))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 (Tclass._module.LinkedList _module.LinkedList$T@@23)) ($IsAlloc refType this@@3 (Tclass._module.LinkedList _module.LinkedList$T@@23) $Heap@@2))) (and ($Is refType |end#0| (Tclass._module.LinkedList _module.LinkedList$T@@23)) ($IsAlloc refType |end#0| (Tclass._module.LinkedList _module.LinkedList$T@@23) $Heap@@2))) (and (and ($Is refType |r#0| (Tclass._module.LinkedList _module.LinkedList$T@@23)) ($IsAlloc refType |r#0| (Tclass._module.LinkedList _module.LinkedList$T@@23) $Heap@@2)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 6) 2)))) anon0_correct))))
