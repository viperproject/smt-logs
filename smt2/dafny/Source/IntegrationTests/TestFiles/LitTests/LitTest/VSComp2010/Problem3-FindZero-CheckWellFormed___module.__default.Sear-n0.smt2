...
(let ((anon20_Else_correct  (=> (and (or (not (= |r#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |ll#0|) _module.Node.List))))) (not true)) (= (ControlFlow 0 5) 2)) anon13_correct)))
(let ((anon20_Then_correct  (=> (= |r#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |ll#0|) _module.Node.List)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= |ll#0| null)) (not true))) (=> (or (not (= |ll#0| null)) (not true)) (=> (= (ControlFlow 0 3) 2) anon13_correct))))))
(let ((anon11_correct  (=> (=> (< |r#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |ll#0|) _module.Node.List)))) (and (= (U_2_int ($Unbox intType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |ll#0|) _module.Node.List)) |r#0@0|))) (LitInt 0)) (not (|Seq#Contains| (|Seq#Take| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |ll#0|) _module.Node.List)) |r#0@0|) ($Box intType (int_2_U 0)))))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (not (= |ll#0| null)) (not true))) (=> (or (not (= |ll#0| null)) (not true)) (and (=> (= (ControlFlow 0 6) 3) anon20_Then_correct) (=> (= (ControlFlow 0 6) 5) anon20_Else_correct)))))))
(let ((anon19_Else_correct  (=> (and (or (not (= (U_2_int ($Unbox intType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |ll#0|) _module.Node.List)) |r#0@0|))) (LitInt 0))) (not true)) (= (ControlFlow 0 12) 6)) anon11_correct)))
(let ((anon19_Then_correct  (=> (= (U_2_int ($Unbox intType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |ll#0|) _module.Node.List)) |r#0@0|))) (LitInt 0)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (or (not (= |ll#0| null)) (not true))) (=> (or (not (= |ll#0| null)) (not true)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (and (<= 0 |r#0@0|) (<= |r#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |ll#0|) _module.Node.List)))))) (=> (and (<= 0 |r#0@0|) (<= |r#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |ll#0|) _module.Node.List))))) (=> (= (ControlFlow 0 9) 6) anon11_correct))))))))
(let ((anon18_Then_correct  (=> (< |r#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |ll#0|) _module.Node.List)))) (and (=> (= (ControlFlow 0 13) (- 0 15)) (or (not (= |ll#0| null)) (not true))) (=> (or (not (= |ll#0| null)) (not true)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (and (<= 0 |r#0@0|) (< |r#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |ll#0|) _module.Node.List)))))) (=> (and (<= 0 |r#0@0|) (< |r#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |ll#0|) _module.Node.List))))) (and (=> (= (ControlFlow 0 13) 9) anon19_Then_correct) (=> (= (ControlFlow 0 13) 12) anon19_Else_correct)))))))))
(let ((anon18_Else_correct  (=> (and (<= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |ll#0|) _module.Node.List))) |r#0@0|) (= (ControlFlow 0 8) 6)) anon11_correct)))
(let ((anon17_Then_correct  (=> (and (or (not (= |ll#0| null)) (not true)) (<= (LitInt 0) |r#0@0|)) (and (=> (= (ControlFlow 0 16) (- 0 18)) (or (not (= |ll#0| null)) (not true))) (=> (or (not (= |ll#0| null)) (not true)) (=> (<= |r#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |ll#0|) _module.Node.List)))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (or (not (= |ll#0| null)) (not true))) (=> (or (not (= |ll#0| null)) (not true)) (and (=> (= (ControlFlow 0 16) 13) anon18_Then_correct) (=> (= (ControlFlow 0 16) 8) anon18_Else_correct))))))))))
(let ((anon17_Else_correct true))
(let ((anon16_Else_correct  (=> (=> (= |ll#0| null) (= |r#0@0| (LitInt 0))) (and (=> (= (ControlFlow 0 20) 16) anon17_Then_correct) (=> (= (ControlFlow 0 20) 1) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (and (= |ll#0| null) (= |r#0@0| (LitInt 0))) (and (=> (= (ControlFlow 0 19) 16) anon17_Then_correct) (=> (= (ControlFlow 0 19) 1) anon17_Else_correct)))))
(let ((anon4_correct  (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@11 T@U) ) (!  (=> (and (or (not (= $o@@11 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@11) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@11) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@11)))
 :qid |Problem3FindZerodfy.59:8|
 :skolemid |480|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@11))
)) ($HeapSucc $Heap@@2 $Heap@0))) (and (=> (= (ControlFlow 0 21) 19) anon16_Then_correct) (=> (= (ControlFlow 0 21) 20) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (or (not (= |ll#0| null)) (not true)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (or (not (= |ll#0| null)) (not true))) (=> (or (not (= |ll#0| null)) (not true)) (=> (and (and ($IsAllocBox ($Box refType |ll#0|) Tclass._module.Node? $Heap@@2) (|_module.Node.Valid#canCall| $Heap@@2 |ll#0|)) (and (_module.Node.Valid ($LS $LZ) $Heap@@2 |ll#0|) (= (ControlFlow 0 23) 21))) anon4_correct))))))
(let ((anon15_Then_correct  (=> (and (= |ll#0| null) (= (ControlFlow 0 22) 21)) anon4_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (and (=> (= (ControlFlow 0 25) 22) anon15_Then_correct) (=> (= (ControlFlow 0 25) 23) anon15_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and ($Is refType |ll#0| Tclass._module.Node?) ($IsAlloc refType |ll#0| Tclass._module.Node? $Heap@@2)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 26) 25))) anon0_correct))))
