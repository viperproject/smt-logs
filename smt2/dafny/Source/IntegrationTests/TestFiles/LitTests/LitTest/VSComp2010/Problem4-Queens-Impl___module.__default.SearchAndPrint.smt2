...
(assert (distinct TInt TagInt TagSeq alloc Tagclass._module.Option |##_module.Option.None| |##_module.Option.Some| tytagFamily$Option)
)
...
(assert (forall ((_module.Option$X T@U) ($h T@U) ) (!  (=> ($IsGoodHeap $h) ($IsAlloc DatatypeTypeType |#_module.Option.None| (Tclass._module.Option _module.Option$X) $h))
 :qid |unknown.0:0|
 :skolemid |661|
 :pattern ( ($IsAlloc DatatypeTypeType |#_module.Option.None| (Tclass._module.Option _module.Option$X) $h))
)))
...
(assert (forall ((_module.Option$X@@2 T@U) (|a#6#0#0| T@U) ($h@@0 T@U) ) (!  (=> ($IsGoodHeap $h@@0) (= ($IsAlloc DatatypeTypeType (|#_module.Option.Some| |a#6#0#0|) (Tclass._module.Option _module.Option$X@@2) $h@@0) ($IsAllocBox |a#6#0#0| _module.Option$X@@2 $h@@0)))
 :qid |unknown.0:0|
 :skolemid |667|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.Option.Some| |a#6#0#0|) (Tclass._module.Option _module.Option$X@@2) $h@@0))
)))
...
(assert (forall ((d@@5 T@U) (_module.Option$X@@6 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.Option.Some_q d@@5) ($IsAlloc DatatypeTypeType d@@5 (Tclass._module.Option _module.Option$X@@6) $h@@1))) ($IsAllocBox (_module.Option.value d@@5) _module.Option$X@@6 $h@@1))
 :qid |unknown.0:0|
 :skolemid |668|
 :pattern ( ($IsAllocBox (_module.Option.value d@@5) _module.Option$X@@6 $h@@1))
)))
...
(assert (forall ((_module.Option$X@@7 T@U) (bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 (Tclass._module.Option _module.Option$X@@7)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@2)) bx@@2) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@2) (Tclass._module.Option _module.Option$X@@7))))
 :qid |unknown.0:0|
 :skolemid |530|
 :pattern ( ($IsBox bx@@2 (Tclass._module.Option _module.Option$X@@7)))
)))
...
(declare-fun |N#0| () Int)
(declare-fun |r#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.SearchAndPrint)
...
(let ((anon3_Then_correct  (=> (and (_module.Option.Some_q |call2formal@r#0@0|) (= (ControlFlow 0 2) (- 0 1))) (_module.Option.Some_q |call2formal@r#0@0|))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($Is DatatypeTypeType |call2formal@r#0| (Tclass._module.Option (TSeq TInt))) ($IsAlloc DatatypeTypeType |call2formal@r#0| (Tclass._module.Option (TSeq TInt)) $Heap)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (=> (and (and (and (and ($Is DatatypeTypeType |call2formal@r#0@0| (Tclass._module.Option (TSeq TInt))) ($IsAlloc DatatypeTypeType |call2formal@r#0@0| (Tclass._module.Option (TSeq TInt)) $Heap@0)) (=> (_module.Option.Some_q |call2formal@r#0@0|) (let ((|board#0@@1| ($Unbox SeqType (_module.Option.value |call2formal@r#0@0|))))
 (=> (= (|Seq#Length| |board#0@@1|) |N#0|) (forall ((|p#1| Int) ) (!  (=> (and (<= (LitInt 0) |p#1|) (< |p#1| |N#0|)) (|_module.__default.IsConsistent#canCall| |board#0@@1| |p#1|))
 :qid |Problem4Queensdfy.31:28|
 :skolemid |543|
 :pattern ( (_module.__default.IsConsistent |board#0@@1| |p#1|))
)))))) (and (=> (_module.Option.Some_q |call2formal@r#0@0|) (let ((|board#0@@2| ($Unbox SeqType (_module.Option.value |call2formal@r#0@0|))))
(= (|Seq#Length| |board#0@@2|) |N#0|))) (=> (_module.Option.Some_q |call2formal@r#0@0|) (let ((|board#0@@3| ($Unbox SeqType (_module.Option.value |call2formal@r#0@0|))))
(forall ((|p#1@@0| Int) ) (!  (=> (and (<= (LitInt 0) |p#1@@0|) (< |p#1@@0| |N#0|)) (_module.__default.IsConsistent |board#0@@3| |p#1@@0|))
 :qid |Problem4Queensdfy.31:28|
 :skolemid |544|
 :pattern ( (_module.__default.IsConsistent |board#0@@3| |p#1@@0|))
)))))) (and (and (and (|$IsA#_module.Option| |call2formal@r#0@0|) (=> (|_module.Option#Equal| |call2formal@r#0@0| |#_module.Option.None|) (forall ((|B#1| T@U) ) (!  (=> ($Is SeqType |B#1| (TSeq TInt)) (=> (= (|Seq#Length| |B#1|) |N#0|) (=> (forall ((|i#2| Int) ) (!  (and (=> (and (<= (LitInt 0) |i#2|) (< |i#2| |N#0|)) (<= (LitInt 0) (U_2_int ($Unbox intType (|Seq#Index| |B#1| |i#2|))))) (=> (and (<= (LitInt 0) |i#2|) (< |i#2| |N#0|)) (< (U_2_int ($Unbox intType (|Seq#Index| |B#1| |i#2|))) |N#0|)))
 :qid |Problem4Queensdfy.34:27|
 :skolemid |546|
 :pattern ( ($Unbox intType (|Seq#Index| |B#1| |i#2|)))
)) (forall ((|p#4| Int) ) (!  (=> (and (<= (LitInt 0) |p#4|) (< |p#4| |N#0|)) (|_module.__default.IsConsistent#canCall| |B#1| |p#4|))
 :qid |Problem4Queensdfy.36:14|
 :skolemid |545|
 :pattern ( (_module.__default.IsConsistent |B#1| |p#4|))
)))))
 :qid |Problem4Queensdfy.33:12|
 :skolemid |547|
 :pattern ( (|Seq#Length| |B#1|))
)))) (=> (|_module.Option#Equal| |call2formal@r#0@0| |#_module.Option.None|) (forall ((|B#1@@0| T@U) ) (!  (=> ($Is SeqType |B#1@@0| (TSeq TInt)) (=> (and (= (|Seq#Length| |B#1@@0|) |N#0|) (forall ((|i#2@@0| Int) ) (!  (and (=> (and (<= (LitInt 0) |i#2@@0|) (< |i#2@@0| |N#0|)) (<= (LitInt 0) (U_2_int ($Unbox intType (|Seq#Index| |B#1@@0| |i#2@@0|))))) (=> (and (<= (LitInt 0) |i#2@@0|) (< |i#2@@0| |N#0|)) (< (U_2_int ($Unbox intType (|Seq#Index| |B#1@@0| |i#2@@0|))) |N#0|)))
 :qid |Problem4Queensdfy.34:27|
 :skolemid |548|
 :pattern ( ($Unbox intType (|Seq#Index| |B#1@@0| |i#2@@0|)))
))) (exists ((|p#4@@0| Int) ) (!  (and (and (<= (LitInt 0) |p#4@@0|) (< |p#4@@0| |N#0|)) (not (_module.__default.IsConsistent |B#1@@0| |p#4@@0|)))
 :qid |Problem4Queensdfy.36:14|
 :skolemid |549|
 ...
 :qid |Problem4Queensdfy.29:8|
 :skolemid |551|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0))
)) ($HeapSucc $Heap $Heap@0)))) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |N#0|)) (=> (and (and (and ($Is DatatypeTypeType |r#0| (Tclass._module.Option (TSeq TInt))) ($IsAlloc DatatypeTypeType |r#0| (Tclass._module.Option (TSeq TInt)) $Heap)) true) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct))))
