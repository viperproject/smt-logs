...
(let ((anon13_Else_correct  (=> (and (< |N#0| |i#0@1|) (= (ControlFlow 0 22) 20)) anon4_correct)))
(let ((anon13_Then_correct  (=> (and (<= |i#0@1| |N#0|) (= (ControlFlow 0 21) 20)) anon4_correct)))
(let ((anon12_Then_correct  (=> (not |$w$loop#0@0|) (and (=> (= (ControlFlow 0 23) 21) anon13_Then_correct) (=> (= (ControlFlow 0 23) 22) anon13_Else_correct)))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 17) (- 0 16)) (<= |sum#0@3| (Mul |N#0| |max#0@4|)))))
(let ((anon14_Then_correct  (=> (and (and (<= |N#0| |i#0@1|) (= |sum#0@3| |sum#0@1|)) (and (= |max#0@4| |max#0@1|) (= (ControlFlow 0 18) 17))) GeneratedUnifiedExit_correct)))
(let ((anon10_correct  (and (=> (= (ControlFlow 0 3) (- 0 8)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (and (<= 0 |i#0@1|) (< |i#0@1| (_System.array.Length |a#0|)))) (=> (and (<= 0 |i#0@1|) (< |i#0@1| (_System.array.Length |a#0|))) (=> (and (= |sum#0@2| (+ |sum#0@1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#0@1|)))))) (= |i#0@2| (+ |i#0@1| 1))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (<= 0 |$decr$loop#00@1|) (= (- |N#0| |i#0@2|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- |N#0| |i#0@2|) |$decr$loop#00@1|)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (< (- |N#0| |i#0@2|) |$decr$loop#00@1|)) (=> (< (- |N#0| |i#0@2|) |$decr$loop#00@1|) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> |$w$loop#0@0| (<= |i#0@2| |N#0|))) (=> (=> |$w$loop#0@0| (<= |i#0@2| |N#0|)) (=> (= (ControlFlow 0 3) (- 0 2)) (=> |$w$loop#0@0| (<= |sum#0@2| (Mul |i#0@2| |max#0@3|)))))))))))))))))
(let ((anon15_Else_correct  (=> (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#0@1|)))) |max#0@1|) (=> (and (= |max#0@3| |max#0@1|) (= (ControlFlow 0 12) 3)) anon10_correct))))
(let ((anon15_Then_correct  (=> (< |max#0@1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#0@1|))))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (and (<= 0 |i#0@1|) (< |i#0@1| (_System.array.Length |a#0|)))) (=> (and (<= 0 |i#0@1|) (< |i#0@1| (_System.array.Length |a#0|))) (=> (= |max#0@2| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#0@1|))))) (=> (and (= |max#0@3| |max#0@2|) (= (ControlFlow 0 9) 3)) anon10_correct)))))))))
(let ((anon14_Else_correct  (=> (and (< |i#0@1| |N#0|) (= |$decr$loop#00@1| (- |N#0| |i#0@1|))) (and (=> (= (ControlFlow 0 13) (- 0 15)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (and (<= 0 |i#0@1|) (< |i#0@1| (_System.array.Length |a#0|)))) (=> (and (<= 0 |i#0@1|) (< |i#0@1| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 13) 9) anon15_Then_correct) (=> (= (ControlFlow 0 13) 12) anon15_Else_correct)))))))))
(let ((anon12_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 19) 18) anon14_Then_correct) (=> (= (ControlFlow 0 19) 13) anon14_Else_correct)))))
(let ((anon11_LoopBody_correct  (and (=> (= (ControlFlow 0 24) 23) anon12_Then_correct) (=> (= (ControlFlow 0 24) 19) anon12_Else_correct))))
(let ((anon11_LoopDone_correct true))
(let ((anon11_LoopHead_correct  (=> (and (and (and (and (not false) (<= 0 |i#0@1|)) (<= 0 |$decr_init$loop#00@0|)) (and (=> |$w$loop#0@0| (<= |i#0@1| |N#0|)) (=> |$w$loop#0@0| (<= |sum#0@1| (Mul |i#0@1| |max#0@1|))))) (and (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6)))
 :qid |Problem1SumMaxdfy.19:3|
 :skolemid |485|
...
)) (<= (- |N#0| |i#0@1|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 25) 1) anon11_LoopDone_correct) (=> (= (ControlFlow 0 25) 24) anon11_LoopBody_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (= |sum#0@0| (LitInt 0)) (= |max#0@0| (LitInt 0))) (and (= |i#0@0| (LitInt 0)) (= |$decr_init$loop#00@0| (- |N#0| |i#0@0|)))) (and (=> (= (ControlFlow 0 26) (- 0 28)) (=> |$w$loop#0@0| (<= |i#0@0| |N#0|))) (=> (=> |$w$loop#0@0| (<= |i#0@0| |N#0|)) (and (=> (= (ControlFlow 0 26) (- 0 27)) (=> |$w$loop#0@0| (<= |sum#0@0| (Mul |i#0@0| |max#0@0|)))) (=> (=> |$w$loop#0@0| (<= |sum#0@0| (Mul |i#0@0| |max#0@0|))) (=> (= (ControlFlow 0 26) 25) anon11_LoopHead_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (= 0 $FunctionContextHeight)) (and (and (<= (LitInt 0) |N#0|) (= (_System.array.Length |a#0|) |N#0|)) (and (forall ((|k#1| Int) ) (!  (=> (and (<= (LitInt 0) |k#1|) (< |k#1| |N#0|)) (<= (LitInt 0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |k#1|))))))
 :qid |Problem1SumMaxdfy.13:47|
 :skolemid |483|
...
)) (= (ControlFlow 0 29) 26)))) anon0_correct))))
