...
(assert (forall ((_module.LinkedList$T T@U) ($ly T@U) (|s#0| T@U) ) (! (= (_module.LinkedList.ReverseSeq _module.LinkedList$T ($LS $ly) |s#0|) (_module.LinkedList.ReverseSeq _module.LinkedList$T $ly |s#0|))
 :qid |unknown.0:0|
 :skolemid |579|
 :pattern ( (_module.LinkedList.ReverseSeq _module.LinkedList$T ($LS $ly) |s#0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module.LinkedList$T@@0 T@U) ($ly@@0 T@U) (|s#0@@0| T@U) ) (!  (=> (or (|_module.LinkedList.ReverseSeq#canCall| _module.LinkedList$T@@0 |s#0@@0|) (and (< 0 $FunctionContextHeight) ($Is SeqType |s#0@@0| (TSeq _module.LinkedList$T@@0)))) (and (=> (not (|Seq#Equal| |s#0@@0| |Seq#Empty|)) (|_module.LinkedList.ReverseSeq#canCall| _module.LinkedList$T@@0 (|Seq#Drop| |s#0@@0| (LitInt 1)))) (= (_module.LinkedList.ReverseSeq _module.LinkedList$T@@0 ($LS $ly@@0) |s#0@@0|) (ite (|Seq#Equal| |s#0@@0| |Seq#Empty|) |Seq#Empty| (|Seq#Append| (_module.LinkedList.ReverseSeq _module.LinkedList$T@@0 $ly@@0 (|Seq#Drop| |s#0@@0| (LitInt 1))) (|Seq#Build| |Seq#Empty| (|Seq#Index| |s#0@@0| (LitInt 0))))))))
 :qid |unknown.0:0|
 :skolemid |584|
 :pattern ( (_module.LinkedList.ReverseSeq _module.LinkedList$T@@0 ($LS $ly@@0) |s#0@@0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (_module.LinkedList$T@@1 T@U) ($ly@@1 T@U) (|s#0@@1| T@U) ) (!  (=> (and (or (|_module.LinkedList.ReverseSeq#canCall| _module.LinkedList$T@@1 |s#0@@1|) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |s#0@@1| (TSeq _module.LinkedList$T@@1)) ($IsAlloc SeqType |s#0@@1| (TSeq _module.LinkedList$T@@1) $Heap)))) ($IsGoodHeap $Heap)) ($IsAlloc SeqType (_module.LinkedList.ReverseSeq _module.LinkedList$T@@1 $ly@@1 |s#0@@1|) (TSeq _module.LinkedList$T@@1) $Heap))
 :qid |Problem5DoubleEndedQueuedfy.163:25|
 :skolemid |582|
 :pattern ( ($IsAlloc SeqType (_module.LinkedList.ReverseSeq _module.LinkedList$T@@1 $ly@@1 |s#0@@1|) (TSeq _module.LinkedList$T@@1) $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module.LinkedList$T@@2 T@U) ($ly@@2 T@U) (|s#0@@2| T@U) ) (!  (=> (or (|_module.LinkedList.ReverseSeq#canCall| _module.LinkedList$T@@2 |s#0@@2|) (and (< 0 $FunctionContextHeight) ($Is SeqType |s#0@@2| (TSeq _module.LinkedList$T@@2)))) ($Is SeqType (_module.LinkedList.ReverseSeq _module.LinkedList$T@@2 $ly@@2 |s#0@@2|) (TSeq _module.LinkedList$T@@2)))
 :qid |unknown.0:0|
 :skolemid |581|
 :pattern ( (_module.LinkedList.ReverseSeq _module.LinkedList$T@@2 $ly@@2 |s#0@@2|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module.LinkedList$T@@3 T@U) ($ly@@3 T@U) (|s#0@@3| T@U) ) (!  (=> (or (|_module.LinkedList.ReverseSeq#canCall| _module.LinkedList$T@@3 (Lit SeqType |s#0@@3|)) (and (< 0 $FunctionContextHeight) ($Is SeqType |s#0@@3| (TSeq _module.LinkedList$T@@3)))) (and (=> (not (|Seq#Equal| |s#0@@3| |Seq#Empty|)) (|_module.LinkedList.ReverseSeq#canCall| _module.LinkedList$T@@3 (Lit SeqType (|Seq#Drop| (Lit SeqType |s#0@@3|) (LitInt 1))))) (= (_module.LinkedList.ReverseSeq _module.LinkedList$T@@3 ($LS $ly@@3) (Lit SeqType |s#0@@3|)) (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) |Seq#Empty| (|Seq#Append| (_module.LinkedList.ReverseSeq _module.LinkedList$T@@3 ($LS $ly@@3) (Lit SeqType (|Seq#Drop| (Lit SeqType |s#0@@3|) (LitInt 1)))) (|Seq#Build| |Seq#Empty| (|Seq#Index| (Lit SeqType |s#0@@3|) (LitInt 0))))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |585|
 :pattern ( (_module.LinkedList.ReverseSeq _module.LinkedList$T@@3 ($LS $ly@@3) (Lit SeqType |s#0@@3|)))
))))
...
(declare-fun _module.LinkedList$T@@4 () T@U)
(declare-fun $Heap@@0 () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$_module.LinkedList.ReverseSeq)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon8_Else_correct  (=> (not (|Seq#Equal| |s#0@@4| |Seq#Empty|)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |s#0@@4|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |s#0@@4|))) (=> (and (= |##s#0@0| (|Seq#Drop| |s#0@@4| (LitInt 1))) ($IsAlloc SeqType |##s#0@0| (TSeq _module.LinkedList$T@@4) $Heap@@0)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< (|Seq#Rank| |##s#0@0|) (|Seq#Rank| |s#0@@4|))) (=> (< (|Seq#Rank| |##s#0@0|) (|Seq#Rank| |s#0@@4|)) (=> (and (|_module.LinkedList.ReverseSeq#canCall| _module.LinkedList$T@@4 (|Seq#Drop| |s#0@@4| (LitInt 1))) (= (ControlFlow 0 4) (- 0 3))) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s#0@@4|))))))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) ($Is SeqType |s#0@@4| (TSeq _module.LinkedList$T@@4))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct)))
