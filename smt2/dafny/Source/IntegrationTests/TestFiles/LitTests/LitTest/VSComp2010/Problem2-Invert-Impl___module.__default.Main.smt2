...
(let ((anon26_correct  (=> (forall ((|m#1@@1| Int) ) (!  (=> (and (<= (LitInt 0) |m#1@@1|) (< |m#1@@1| 10)) (|_module.__default.inImage#canCall| |m#1@@1|))
 ...
 :qid |Problem2Invertdfy.66:4|
 :skolemid |534|
))) (=> (forall (($o@@7 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@7) alloc)))) (= $o@@7 $nw@1)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@7 $f@@1)))
 :qid |Problem2Invertdfy.66:4|
 :skolemid |534|
)) (and (=> (= (ControlFlow 0 3) (- 0 11)) (<= (LitInt 0) |N##0@0|)) (=> (<= (LitInt 0) |N##0@0|) (and (=> (= (ControlFlow 0 3) (- 0 10)) (= |N##0@0| (_System.array.Length $nw@0))) (=> (= |N##0@0| (_System.array.Length $nw@0)) (and (=> (= (ControlFlow 0 3) (- 0 9)) (= |N##0@0| (_System.array.Length $nw@1))) (=> (= |N##0@0| (_System.array.Length $nw@1)) (and (=> (= (ControlFlow 0 3) (- 0 8)) (or (not (= $nw@0 $nw@1)) (not true))) (=> (or (not (= $nw@0 $nw@1)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (forall ((|k#1@@1| Int) ) (!  (and (=> (and (<= (LitInt 0) |k#1@@1|) (< |k#1@@1| |N##0@0|)) (<= (LitInt 0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |k#1@@1|)))))) (=> (and (<= (LitInt 0) |k#1@@1|) (< |k#1@@1| |N##0@0|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |k#1@@1|)))) |N##0@0|)))
