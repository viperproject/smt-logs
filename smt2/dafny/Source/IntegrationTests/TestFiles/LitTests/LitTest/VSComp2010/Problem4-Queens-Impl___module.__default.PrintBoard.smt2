...
(set-info :boogie-vc-id Impl$$_module.__default.PrintBoard)
...
(let ((anon24_Else_correct  (and (=> (= (ControlFlow 0 27) (- 0 29)) (forall ((|seqinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| (|Seq#Length| |b#0|))) (Requires1 TInt TChar $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#12| (Handle1 (|lambda#8| ($Box charType (Lit charType (|char#FromInt| 45)))) (|lambda#9| TInt) (|lambda#11| (SetRef_to_SetBox (|lambda#10| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0|))))
 :qid |Problem4Queensdfy.140:17|
 :skolemid |652|
))) (=> (and (= |i#0#lo@0| (LitInt 0)) (= |i#0#hi@0| (|Seq#Length| |b#0|))) (and (=> (= (ControlFlow 0 27) (- 0 28)) (<= |i#0#lo@0| |i#0#hi@0|)) (=> (<= |i#0#lo@0| |i#0#hi@0|) (=> (= (ControlFlow 0 27) 26) anon26_LoopHead_correct)))))))
