...
(declare-fun |d#0| () T@U)
(declare-fun |r#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.LinkedList.Cons)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@2 alloc false)) ($IsAllocBox ($Box refType this@@3) (Tclass._module.LinkedList? _module.LinkedList$T@@23) $Heap@@2)) (=> (and (and (and (|_module.LinkedList.Valid#canCall| _module.LinkedList$T@@23 $Heap@@2 this@@3) (_module.LinkedList.Valid _module.LinkedList$T@@23 ($LS $LZ) $Heap@@2 this@@3)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (forall (($o@@13 T@U) ) (!  (=> (and (or (not (= $o@@13 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@13) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@13) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@13)))
 :qid |Problem5DoubleEndedQueuedfy.121:10|
 :skolemid |560|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@13))
)) ($HeapSucc $Heap@@2 $Heap@0)) (and ($Is refType |r#0@0| (Tclass._module.LinkedList _module.LinkedList$T@@23)) ($IsAlloc refType |r#0@0| (Tclass._module.LinkedList _module.LinkedList$T@@23) $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |r#0@0| null)) (not true))) (=> (or (not (= |r#0@0| null)) (not true)) (=> (and (and ($IsAllocBox ($Box refType |r#0@0|) (Tclass._module.LinkedList? _module.LinkedList$T@@23) $Heap@0) (|_module.LinkedList.Valid#canCall| _module.LinkedList$T@@23 $Heap@0 |r#0@0|)) (and (_module.LinkedList.Valid _module.LinkedList$T@@23 ($LS $LZ) $Heap@0 |r#0@0|) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= |r#0@0| null)) (not true)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 (Tclass._module.LinkedList _module.LinkedList$T@@23)) ($IsAlloc refType this@@3 (Tclass._module.LinkedList _module.LinkedList$T@@23) $Heap@@2))) (and ($IsBox |d#0| _module.LinkedList$T@@23) ($IsAllocBox |d#0| _module.LinkedList$T@@23 $Heap@@2))) (and (and ($Is refType |r#0| (Tclass._module.LinkedList _module.LinkedList$T@@23)) ($IsAlloc refType |r#0| (Tclass._module.LinkedList _module.LinkedList$T@@23) $Heap@@2)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct))))
