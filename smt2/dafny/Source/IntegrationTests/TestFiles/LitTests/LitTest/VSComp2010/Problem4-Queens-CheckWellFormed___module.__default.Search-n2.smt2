...
(declare-fun |newBoard#Z#0@0| () T@U)
...
(declare-fun |r#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.SearchAux)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 45) (let ((anon38_Else_correct true))
(let ((anon43_Else_correct true))
(let ((anon32_correct true))
(let ((anon30_correct  (=> (and (and (<= (LitInt 0) |p#2@0|) (< |p#2@0| |N#0|)) ($IsAlloc SeqType |B#0@0| (TSeq TInt) $Heap@0)) (and (=> (= (ControlFlow 0 5) (- 0 6)) ($Is intType (int_2_U |p#2@0|) Tclass._System.nat)) (=> ($Is intType (int_2_U |p#2@0|) Tclass._System.nat) (=> (and (and ($IsAlloc intType (int_2_U |p#2@0|) Tclass._System.nat $Heap@0) (|_module.__default.IsConsistent#canCall| |B#0@0| |p#2@0|)) (and (not (_module.__default.IsConsistent |B#0@0| |p#2@0|)) (= (ControlFlow 0 5) 2))) anon32_correct))))))
(let ((anon49_Else_correct  (=> (and (< |p#2@0| (LitInt 0)) (= (ControlFlow 0 8) 5)) anon30_correct)))
(let ((anon49_Then_correct  (=> (and (<= (LitInt 0) |p#2@0|) (= (ControlFlow 0 7) 5)) anon30_correct)))
(let ((anon28_correct  (=> (forall ((|i#1| Int) ) (!  (and (=> (and (<= (LitInt 0) |i#1|) (< |i#1| |N#0|)) (<= (LitInt 0) (U_2_int ($Unbox intType (|Seq#Index| |B#0@0| |i#1|))))) (=> (and (<= (LitInt 0) |i#1|) (< |i#1| |N#0|)) (< (U_2_int ($Unbox intType (|Seq#Index| |B#0@0| |i#1|))) |N#0|)))
 :qid |Problem4Queensdfy.64:27|
 :skolemid |574|
 :pattern ( ($Unbox intType (|Seq#Index| |B#0@0| |i#1|)))
)) (=> (and (<= (|Seq#Length| |boardSoFar#0|) (|Seq#Length| |B#0@0|)) (|Seq#SameUntil| |boardSoFar#0| |B#0@0| (|Seq#Length| |boardSoFar#0|))) (and (=> (= (ControlFlow 0 9) 7) anon49_Then_correct) (=> (= (ControlFlow 0 9) 8) anon49_Else_correct))))))
(let ((anon48_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |N#0|))) (= (ControlFlow 0 13) 9)) anon28_correct)))
(let ((anon48_Then_correct  (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |N#0|)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |B#0@0|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |B#0@0|))) (=> (= (ControlFlow 0 11) 9) anon28_correct))))))
(let ((anon47_Else_correct  (=> (< |i#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 15) 11) anon48_Then_correct) (=> (= (ControlFlow 0 15) 13) anon48_Else_correct)))))
(let ((anon47_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 14) 11) anon48_Then_correct) (=> (= (ControlFlow 0 14) 13) anon48_Else_correct)))))
(let ((anon46_Then_correct  (=> (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |N#0|)) (<= (LitInt 0) (U_2_int ($Unbox intType (|Seq#Index| |B#0@0| |i#0@0|))))) (and (=> (= (ControlFlow 0 16) 14) anon47_Then_correct) (=> (= (ControlFlow 0 16) 15) anon47_Else_correct)))))
(let ((anon46_Else_correct  (=> (and (not (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |N#0|)) (<= (LitInt 0) (U_2_int ($Unbox intType (|Seq#Index| |B#0@0| |i#0@0|)))))) (= (ControlFlow 0 10) 9)) anon28_correct)))
(let ((anon45_Else_correct  (=> (not (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |N#0|))) (and (=> (= (ControlFlow 0 19) 16) anon46_Then_correct) (=> (= (ControlFlow 0 19) 10) anon46_Else_correct)))))
(let ((anon45_Then_correct  (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |N#0|)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |B#0@0|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |B#0@0|))) (and (=> (= (ControlFlow 0 17) 16) anon46_Then_correct) (=> (= (ControlFlow 0 17) 10) anon46_Else_correct)))))))
(let ((anon44_Else_correct  (=> (< |i#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 21) 17) anon45_Then_correct) (=> (= (ControlFlow 0 21) 19) anon45_Else_correct)))))
(let ((anon44_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 20) 17) anon45_Then_correct) (=> (= (ControlFlow 0 20) 19) anon45_Else_correct)))))
(let ((anon43_Then_correct  (and (=> (= (ControlFlow 0 22) 20) anon44_Then_correct) (=> (= (ControlFlow 0 22) 21) anon44_Else_correct))))
(let ((anon42_Then_correct  (=> (= (|Seq#Length| |B#0@0|) |N#0|) (and (=> (= (ControlFlow 0 23) 22) anon43_Then_correct) (=> (= (ControlFlow 0 23) 4) anon43_Else_correct)))))
(let ((anon42_Else_correct  (=> (and (=> (and (and (= (|Seq#Length| |B#0@0|) |N#0|) (forall ((|i#1@@0| Int) ) (!  (and (=> (and (<= (LitInt 0) |i#1@@0|) (< |i#1@@0| |N#0|)) (<= (LitInt 0) (U_2_int ($Unbox intType (|Seq#Index| |B#0@0| |i#1@@0|))))) (=> (and (<= (LitInt 0) |i#1@@0|) (< |i#1@@0| |N#0|)) (< (U_2_int ($Unbox intType (|Seq#Index| |B#0@0| |i#1@@0|))) |N#0|)))
 :qid |Problem4Queensdfy.64:27|
 :skolemid |575|
 :pattern ( ($Unbox intType (|Seq#Index| |B#0@0| |i#1@@0|)))
))) (and (<= (|Seq#Length| |boardSoFar#0|) (|Seq#Length| |B#0@0|)) (|Seq#SameUntil| |boardSoFar#0| |B#0@0| (|Seq#Length| |boardSoFar#0|)))) (exists ((|p#3| Int) ) (!  (and (and (<= (LitInt 0) |p#3|) (< |p#3| |N#0|)) (not (_module.__default.IsConsistent |B#0@0| |p#3|)))
 :qid |Problem4Queensdfy.67:14|
 :skolemid |576|
 :pattern ( (_module.__default.IsConsistent |B#0@0| |p#3|))
))) (= (ControlFlow 0 3) 2)) anon32_correct)))
(let ((anon41_Then_correct  (=> (|_module.Option#Equal| |r#0@0| |#_module.Option.None|) (=> (and ($Is SeqType |B#0@0| (TSeq TInt)) ($IsAlloc SeqType |B#0@0| (TSeq TInt) $Heap@0)) (and (=> (= (ControlFlow 0 24) 23) anon42_Then_correct) (=> (= (ControlFlow 0 24) 3) anon42_Else_correct))))))
(let ((anon41_Else_correct true))
(let ((anon14_correct  (=> (let ((|newBoard#0| ($Unbox SeqType (_module.Option.value |r#0@0|))))
 (and (= (|Seq#Length| |newBoard#0|) |N#0|) (forall ((|p#1| Int) ) (!  (=> (and (<= (LitInt 0) |p#1|) (< |p#1| |N#0|)) (_module.__default.IsConsistent |newBoard#0| |p#1|))
 :qid |Problem4Queensdfy.61:31|
 :skolemid |572|
 :pattern ( (_module.__default.IsConsistent |newBoard#0| |p#1|))
)))) (and (=> (= (ControlFlow 0 26) 24) anon41_Then_correct) (=> (= (ControlFlow 0 26) 1) anon41_Else_correct)))))
(let ((anon40_Else_correct  (=> (and (not (and (<= (LitInt 0) |p#0@0|) (< |p#0@0| |N#0|))) (= (ControlFlow 0 31) 26)) anon14_correct)))
(let ((anon40_Then_correct  (=> (and (and (<= (LitInt 0) |p#0@0|) (< |p#0@0| |N#0|)) ($IsAlloc SeqType |newBoard#Z#0@0| (TSeq TInt) $Heap@0)) (and (=> (= (ControlFlow 0 29) (- 0 30)) ($Is intType (int_2_U |p#0@0|) Tclass._System.nat)) (=> ($Is intType (int_2_U |p#0@0|) Tclass._System.nat) (=> ($IsAlloc intType (int_2_U |p#0@0|) Tclass._System.nat $Heap@0) (=> (and (|_module.__default.IsConsistent#canCall| |newBoard#Z#0@0| |p#0@0|) (= (ControlFlow 0 29) 26)) anon14_correct)))))))
(let ((anon39_Else_correct  (=> (< |p#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 33) 29) anon40_Then_correct) (=> (= (ControlFlow 0 33) 31) anon40_Else_correct)))))
(let ((anon39_Then_correct  (=> (<= (LitInt 0) |p#0@0|) (and (=> (= (ControlFlow 0 32) 29) anon40_Then_correct) (=> (= (ControlFlow 0 32) 31) anon40_Else_correct)))))
(let ((anon38_Then_correct  (and (=> (= (ControlFlow 0 34) 32) anon39_Then_correct) (=> (= (ControlFlow 0 34) 33) anon39_Else_correct))))
(let ((anon37_Then_correct  (=> (= (|Seq#Length| |newBoard#Z#0@0|) |N#0|) (and (=> (= (ControlFlow 0 35) 34) anon38_Then_correct) (=> (= (ControlFlow 0 35) 28) anon38_Else_correct)))))
(let ((anon37_Else_correct  (=> (and (or (not (= (|Seq#Length| |newBoard#Z#0@0|) |N#0|)) (not true)) (= (ControlFlow 0 27) 26)) anon14_correct)))
(let ((anon36_Then_correct  (=> (_module.Option.Some_q |r#0@0|) (and (=> (= (ControlFlow 0 36) (- 0 37)) (_module.Option.Some_q |r#0@0|)) (=> (_module.Option.Some_q |r#0@0|) (=> (= |let#0#0#0| ($Unbox SeqType (_module.Option.value |r#0@0|))) (=> (and ($Is SeqType |let#0#0#0| (TSeq TInt)) (= |newBoard#Z#0@0| |let#0#0#0|)) (and (=> (= (ControlFlow 0 36) 35) anon37_Then_correct) (=> (= (ControlFlow 0 36) 27) anon37_Else_correct)))))))))
(let ((anon36_Else_correct  (=> (=> (_module.Option.Some_q |r#0@0|) (let ((|newBoard#0@@0| ($Unbox SeqType (_module.Option.value |r#0@0|))))
 (and (= (|Seq#Length| |newBoard#0@@0|) |N#0|) (forall ((|p#1@@0| Int) ) (!  (=> (and (<= (LitInt 0) |p#1@@0|) (< |p#1@@0| |N#0|)) (_module.__default.IsConsistent |newBoard#0@@0| |p#1@@0|))
 :qid |Problem4Queensdfy.61:31|
 :skolemid |573|
 :pattern ( (_module.__default.IsConsistent |newBoard#0@@0| |p#1@@0|))
))))) (and (=> (= (ControlFlow 0 25) 24) anon41_Then_correct) (=> (= (ControlFlow 0 25) 1) anon41_Else_correct)))))
(let ((anon6_correct  (=> (forall ((|k#1| Int) ) (!  (=> (and (<= (LitInt 0) |k#1|) (< |k#1| (|Seq#Length| |boardSoFar#0|))) (_module.__default.IsConsistent |boardSoFar#0| |k#1|))
 :qid |Problem4Queensdfy.59:19|
 :skolemid |570|
 :pattern ( (_module.__default.IsConsistent |boardSoFar#0| |k#1|))
 ...
 :qid |Problem4Queensdfy.56:8|
 :skolemid |571|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0))
)) ($HeapSucc $Heap $Heap@0)) (and ($Is DatatypeTypeType |r#0@0| (Tclass._module.Option (TSeq TInt))) ($IsAlloc DatatypeTypeType |r#0@0| (Tclass._module.Option (TSeq TInt)) $Heap@0))) (and (=> (= (ControlFlow 0 38) 36) anon36_Then_correct) (=> (= (ControlFlow 0 38) 25) anon36_Else_correct)))))))
(let ((anon4_correct  (=> (and (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| (|Seq#Length| |boardSoFar#0|))) ($IsAlloc SeqType |boardSoFar#0| (TSeq TInt) $Heap)) (and (=> (= (ControlFlow 0 40) (- 0 41)) ($Is intType (int_2_U |k#0@0|) Tclass._System.nat)) (=> ($Is intType (int_2_U |k#0@0|) Tclass._System.nat) (=> (and (and ($IsAlloc intType (int_2_U |k#0@0|) Tclass._System.nat $Heap) (|_module.__default.IsConsistent#canCall| |boardSoFar#0| |k#0@0|)) (and (_module.__default.IsConsistent |boardSoFar#0| |k#0@0|) (= (ControlFlow 0 40) 38))) anon6_correct))))))
(let ((anon35_Else_correct  (=> (and (< |k#0@0| (LitInt 0)) (= (ControlFlow 0 43) 40)) anon4_correct)))
(let ((anon35_Then_correct  (=> (and (<= (LitInt 0) |k#0@0|) (= (ControlFlow 0 42) 40)) anon4_correct)))
(let ((anon34_Else_correct  (=> (and (=> (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| (|Seq#Length| |boardSoFar#0|))) (_module.__default.IsConsistent |boardSoFar#0| |k#0@0|)) (= (ControlFlow 0 39) 38)) anon6_correct)))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (<= (|Seq#Length| |boardSoFar#0|) |N#0|)) (and (and (=> (= (ControlFlow 0 44) 39) anon34_Else_correct) (=> (= (ControlFlow 0 44) 42) anon35_Then_correct)) (=> (= (ControlFlow 0 44) 43) anon35_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |N#0|)) (and ($Is SeqType |boardSoFar#0| (TSeq TInt)) ($IsAlloc SeqType |boardSoFar#0| (TSeq TInt) $Heap))) (and (and ($Is DatatypeTypeType |r#0| (Tclass._module.Option (TSeq TInt))) ($IsAlloc DatatypeTypeType |r#0| (Tclass._module.Option (TSeq TInt)) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 45) 44)))) anon0_correct)))
