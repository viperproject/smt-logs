...
(set-info :boogie-vc-id Impl$$_module.__default.doFocus2_split1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (= 0 $FunctionContextHeight) (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)))) (=> (and (and (and (= |y#0@0| (LitInt 1)) (= |y#0@0| (LitInt 1))) (and |x#0| (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |focusdfy.29:5|
 :skolemid |485|
...
))) (and |$w$loop#0_0@0| (U_2_bool (Lit boolType (bool_2_U false)))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (>= |y#0@0| (LitInt 0))) (=> (>= |y#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= |y#0@0| (LitInt 2))) (=> (<= |y#0@0| (LitInt 2)) (=> (= |y#0@1| (LitInt 2)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= |y#0@1| (LitInt 2))) (=> (= |y#0@1| (LitInt 2)) (=> (= (ControlFlow 0 2) (- 0 1)) false))))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
