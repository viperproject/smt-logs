...
(set-info :boogie-vc-id Impl$$_module.__default.ByClause)
...
(let ((anon8_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (U_2_bool (Lit boolType (bool_2_U false))))))
(let ((anon7_Then_correct  (=> (U_2_bool (Lit boolType (bool_2_U false))) (and (=> (= (ControlFlow 0 6) 4) anon8_Then_correct) (=> (= (ControlFlow 0 6) 5) anon8_Else_correct)))))
(let ((anon9_Else_correct true))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 7) 6) anon7_Then_correct) (=> (= (ControlFlow 0 7) 1) anon9_Then_correct)) (=> (= (ControlFlow 0 7) 2) anon9_Else_correct)))))
