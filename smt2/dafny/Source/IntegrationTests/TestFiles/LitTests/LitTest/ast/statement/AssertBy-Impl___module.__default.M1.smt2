...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (and (= |x#0| (LitInt 6)) (= (ControlFlow 0 4) (- 0 3))) (= |y#0| (LitInt 8)))))
(let ((anon3_Then_correct  (=> (= |x#0| (LitInt 6)) (=> (and (= |y#0| (LitInt 8)) (= (ControlFlow 0 2) (- 0 1))) (= |x#0| (LitInt 6))))))
