...
(declare-fun |_module.__default.Natty#canCall| () Bool)
(declare-fun _module.__default.Natty () Int)
...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.Natty#canCall| (< 0 $FunctionContextHeight)) (= _module.__default.Natty (LitInt 3)))))
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.Natty#canCall| (< 0 $FunctionContextHeight)) (= _module.__default.Natty (LitInt 3)))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.Natty#canCall| (< 0 $FunctionContextHeight)) (<= (LitInt 0) _module.__default.Natty))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Natty)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) ($Is intType (int_2_U (LitInt 3)) Tclass._System.nat))))
