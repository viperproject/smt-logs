// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/ast/assume.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/ast/assume-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/ast/assume.dfy
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Foo (correctness)"} Impl$$_module.__default.Foo() returns ($_reverifyPost: bool)
{
  ...
  var xs#0: Set where $Is(xs#0, TSet(TInt)) && $IsAlloc(xs#0, TSet(TInt), $Heap);
  var x#0: int;
  var x#1: int;
  var ys#0: int;
  var valueOrError0#0: DatatypeType
     where $Is(valueOrError0#0, Tclass._module.Option(TInt))
       && $IsAlloc(valueOrError0#0, Tclass._module.Option(TInt), $Heap);

    // AddMethodImpl: Foo, Impl$$_module.__default.Foo
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assume statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/ast/assume.dfy(7,2)
    assume true;
    assume {:id "id0"} Lit(false);
    // ----- assume statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/ast/assume.dfy(8,2)
    assume true;
    assume {:id "id1"} Lit(false);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/ast/assume.dfy(10,9)
    assume true;
    assume true;
    xs#0 := Lit(Set#UnionOne(Set#UnionOne(Set#Empty(): Set, $Box(LitInt(1))), $Box(LitInt(2))));
    // ----- assign-such-that statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/ast/assume.dfy(11,8)
    havoc x#1;
    if (true)
    {
        assume true;
    ...
    havoc x#0;
    assume {:id "id3"} Set#IsMember(xs#0, $Box(x#0));
    // ----- assign-or-return statement (:-) ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/ast/assume.dfy(13,9)
    havoc valueOrError0#0 /* where $Is(valueOrError0#0, Tclass._module.Option(TInt))
       && $IsAlloc(valueOrError0#0, Tclass._module.Option(TInt), $Heap) */;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/ast/assume.dfy(13,19)
    assume true;
    assume true;
    valueOrError0#0 := Lit(#_module.Option.Some($Box(LitInt(3))));
    // ----- assume statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/ast/assume.dfy(13,12)
    // assume allocatedness for receiver argument to function
    assume $IsAllocBox($Box(valueOrError0#0), Tclass._module.Option(TInt), $Heap);
    assume _module.Option.IsFailure#canCall(TInt, valueOrError0#0);
    assume _module.Option.IsFailure#canCall(TInt, valueOrError0#0);
    assume {:id "id5"} !_module.Option.IsFailure(TInt, valueOrError0#0);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/ast/assume.dfy(13,9)
    assume true;
    // assume allocatedness for receiver argument to function
    assume $IsAllocBox($Box(valueOrError0#0), Tclass._module.Option(TInt), $Heap);
    assert {:id "id6"} {:subsumption 0} _module.Option.Some_q(valueOrError0#0);
    assume _module.Option.Some_q(valueOrError0#0);
    assume _module.Option.Extract#canCall(TInt, valueOrError0#0);
    assume _module.Option.Extract#canCall(TInt, valueOrError0#0);
    ys#0 := $Unbox(_module.Option.Extract(TInt, valueOrError0#0)): int;
}
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Option.Extract (well-formedness)"} CheckWellformed$$_module.Option.Extract(_module.Option$T: Ty, this: DatatypeType)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    assume {:id "id17"} _module.Option.Some_q(this);
    ...
    else
    {
        ...
        assert {:id "id18"} _module.Option.Some_q(this);
        assume {:id "id19"} _module.Option.Extract(_module.Option$T, this) == _module.Option.value(this);
        assume true;
...
// function declaration for _module.Option.GetOr
function _module.Option.GetOr(_module.Option$T: Ty, this: DatatypeType, default#0: Box) : Box
uses {
// consequence axiom for _module.Option.GetOr
axiom 0 <= $FunctionContextHeight
   ==> (forall _module.Option$T: Ty, this: DatatypeType, default#0: Box :: 
    { _module.Option.GetOr(_module.Option$T, this, default#0) } 
    _module.Option.GetOr#canCall(_module.Option$T, this, default#0)
         || (0 < $FunctionContextHeight
           && 
          $Is(this, Tclass._module.Option(_module.Option$T))
           && $IsBox(default#0, _module.Option$T))
       ==> $IsBox(_module.Option.GetOr(_module.Option$T, this, default#0), _module.Option$T));
// alloc consequence axiom for _module.Option.GetOr
axiom 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, _module.Option$T: Ty, this: DatatypeType, default#0: Box :: 
    { $IsAllocBox(_module.Option.GetOr(_module.Option$T, this, default#0), _module.Option$T, $Heap) } 
    (_module.Option.GetOr#canCall(_module.Option$T, this, default#0)
           || (0 < $FunctionContextHeight
             && 
            $IsAlloc(this, Tclass._module.Option(_module.Option$T), $Heap)
             && 
            $IsBox(default#0, _module.Option$T)
             && $IsAllocBox(default#0, _module.Option$T, $Heap)))
         && $IsGoodHeap($Heap)
       ==> $IsAllocBox(_module.Option.GetOr(_module.Option$T, this, default#0), _module.Option$T, $Heap));
// definition axiom for _module.Option.GetOr (revealed)
    ...
    _module.Option.GetOr#canCall(_module.Option$T, this, default#0)
         || (0 < $FunctionContextHeight
          ...
          $Is(this, Tclass._module.Option(_module.Option$T))
           && $IsBox(default#0, _module.Option$T))
       ==> _module.Option.GetOr(_module.Option$T, this, default#0)
         == (if _module.Option.None_q(this)
           then default#0
           else (var v#0 := _module.Option.value(this); v#0)));
// definition axiom for _module.Option.GetOr for decreasing-related literals (revealed)
axiom {:id "id21"} 0 <= $FunctionContextHeight
   ==> (forall _module.Option$T: Ty, this: DatatypeType, default#0: Box :: 
    {:weight 3} { _module.Option.GetOr(_module.Option$T, Lit(this), default#0) } 
    _module.Option.GetOr#canCall(_module.Option$T, Lit(this), default#0)
         || (0 < $FunctionContextHeight
           && 
          $Is(this, Tclass._module.Option(_module.Option$T))
           && $IsBox(default#0, _module.Option$T))
       ==> _module.Option.GetOr(_module.Option$T, Lit(this), default#0)
         == (if _module.Option.None_q(Lit(this))
           then default#0
           else (var v#2 := Lit(_module.Option.value(Lit(this))); v#2)));
// definition axiom for _module.Option.GetOr for all literals (revealed)
axiom {:id "id22"} 0 <= $FunctionContextHeight
   ==> (forall _module.Option$T: Ty, this: DatatypeType, default#0: Box :: 
    {:weight 3} { _module.Option.GetOr(_module.Option$T, Lit(this), Lit(default#0)) } 
    _module.Option.GetOr#canCall(_module.Option$T, Lit(this), Lit(default#0))
         || (0 < $FunctionContextHeight
           && 
          $Is(this, Tclass._module.Option(_module.Option$T))
           && $IsBox(default#0, _module.Option$T))
       ==> _module.Option.GetOr(_module.Option$T, Lit(this), Lit(default#0))
         == (if _module.Option.None_q(Lit(this))
           then default#0
           else (var v#4 := Lit(_module.Option.value(Lit(this))); v#4)));
}

function _module.Option.GetOr#canCall(_module.Option$T: Ty, this: DatatypeType, default#0: Box) : bool;

function _module.Option.GetOr#requires(Ty, DatatypeType, Box) : bool;

// #requires axiom for _module.Option.GetOr
axiom (forall _module.Option$T: Ty, this: DatatypeType, default#0: Box :: 
  { _module.Option.GetOr#requires(_module.Option$T, this, default#0) } 
  $Is(this, Tclass._module.Option(_module.Option$T))
       && $IsBox(default#0, _module.Option$T)
     ==> _module.Option.GetOr#requires(_module.Option$T, this, default#0) == true);

procedure {:verboseName "Option.GetOr (well-formedness)"} CheckWellformed$$_module.Option.GetOr(_module.Option$T: Ty, 
    this: DatatypeType
       where $Is(this, Tclass._module.Option(_module.Option$T))
         && $IsAlloc(this, Tclass._module.Option(_module.Option$T), $Heap), 
    default#0: Box where $IsBox(default#0, _module.Option$T));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



// function declaration for _module.Option.Map
function _module.Option.Map(_module.Option$T: Ty, 
    _module.Option.Map$FC: Ty, 
    this: DatatypeType, 
    rewrap#0: HandleType)
   : Box
uses {
// consequence axiom for _module.Option.Map
axiom 1 <= $FunctionContextHeight
   ==> (forall _module.Option$T: Ty, 
      _module.Option.Map$FC: Ty, 
      this: DatatypeType, 
      rewrap#0: HandleType :: 
    { _module.Option.Map(_module.Option$T, _module.Option.Map$FC, this, rewrap#0) } 
    _module.Option.Map#canCall(_module.Option$T, _module.Option.Map$FC, this, rewrap#0)
         || (1 < $FunctionContextHeight
           && 
          $Is(this, Tclass._module.Option(_module.Option$T))
           && $Is(rewrap#0, 
            Tclass._System.___hTotalFunc1(Tclass._module.Option(_module.Option$T), _module.Option.Map$FC)))
       ==> $IsBox(_module.Option.Map(_module.Option$T, _module.Option.Map$FC, this, rewrap#0), 
        _module.Option.Map$FC));
// alloc consequence axiom for _module.Option.Map
axiom 1 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, 
      _module.Option$T: Ty, 
      _module.Option.Map$FC: Ty, 
      this: DatatypeType, 
      rewrap#0: HandleType :: 
    { $IsAllocBox(_module.Option.Map(_module.Option$T, _module.Option.Map$FC, this, rewrap#0), 
        _module.Option.Map$FC, 
        $Heap) } 
    (_module.Option.Map#canCall(_module.Option$T, _module.Option.Map$FC, this, rewrap#0)
           || (1 < $FunctionContextHeight
       ...
       ==> $IsAllocBox(_module.Option.Map(_module.Option$T, _module.Option.Map$FC, this, rewrap#0), 
        _module.Option.Map$FC, 
        $Heap));
// definition axiom for _module.Option.Map (revealed)
axiom {:id "id27"} 1 <= $FunctionContextHeight
   ==> (forall _module.Option$T: Ty, 
      ...
      this: DatatypeType, 
      rewrap#0: HandleType :: 
    { _module.Option.Map(_module.Option$T, _module.Option.Map$FC, this, rewrap#0), $IsGoodHeap($Heap) } 
    _module.Option.Map#canCall(_module.Option$T, _module.Option.Map$FC, this, rewrap#0)
         || (1 < $FunctionContextHeight
           && 
          $IsGoodHeap($Heap)
          ...
          $Is(this, Tclass._module.Option(_module.Option$T))
           ...
           && $Is(rewrap#0, 
            Tclass._System.___hTotalFunc1(Tclass._module.Option(_module.Option$T), _module.Option.Map$FC)))
       ==> _module.Option.Map(_module.Option$T, _module.Option.Map$FC, this, rewrap#0)
         == Apply1(Tclass._module.Option(_module.Option$T), 
          _module.Option.Map$FC, 
          $Heap, 
          rewrap#0, 
          $Box(this)));
// definition axiom for _module.Option.Map for decreasing-related literals (revealed)
axiom {:id "id28"} 1 <= $FunctionContextHeight
   ==> (forall _module.Option$T: Ty, 
      ...
      this: DatatypeType, 
      rewrap#0: HandleType :: 
    {:weight 3} { _module.Option.Map(_module.Option$T, _module.Option.Map$FC, Lit(this), rewrap#0), $IsGoodHeap($Heap) } 
    _module.Option.Map#canCall(_module.Option$T, _module.Option.Map$FC, Lit(this), rewrap#0)
         || (1 < $FunctionContextHeight
           && 
          $IsGoodHeap($Heap)
           && 
          $Is(this, Tclass._module.Option(_module.Option$T))
           ...
           && $Is(rewrap#0, 
            Tclass._System.___hTotalFunc1(Tclass._module.Option(_module.Option$T), _module.Option.Map$FC)))
       ==> _module.Option.Map(_module.Option$T, _module.Option.Map$FC, Lit(this), rewrap#0)
         == Apply1(Tclass._module.Option(_module.Option$T), 
          _module.Option.Map$FC, 
          $Heap, 
          rewrap#0, 
          $Box(Lit(this))));
// definition axiom for _module.Option.Map for all literals (revealed)
axiom {:id "id29"} 1 <= $FunctionContextHeight
   ==> (forall _module.Option$T: Ty, 
      ...
      this: DatatypeType, 
      rewrap#0: HandleType :: 
    {:weight 3} { _module.Option.Map(_module.Option$T, _module.Option.Map$FC, Lit(this), Lit(rewrap#0)), $IsGoodHeap($Heap) } 
    _module.Option.Map#canCall(_module.Option$T, _module.Option.Map$FC, Lit(this), Lit(rewrap#0))
         || (1 < $FunctionContextHeight
           && 
          $IsGoodHeap($Heap)
           && 
          $Is(this, Tclass._module.Option(_module.Option$T))
           ...
           && $Is(rewrap#0, 
            Tclass._System.___hTotalFunc1(Tclass._module.Option(_module.Option$T), _module.Option.Map$FC)))
       ==> _module.Option.Map(_module.Option$T, _module.Option.Map$FC, Lit(this), Lit(rewrap#0))
         == Apply1(Tclass._module.Option(_module.Option$T), 
          _module.Option.Map$FC, 
          $Heap, 
          Lit(rewrap#0), 
...
function _module.Option.Map#canCall(_module.Option$T: Ty, 
    _module.Option.Map$FC: Ty, 
    this: DatatypeType, 
    rewrap#0: HandleType)
   : bool;

function _module.Option.Map#requires(Ty, Ty, DatatypeType, HandleType) : bool;

// #requires axiom for _module.Option.Map
axiom (forall _module.Option$T: Ty, 
    _module.Option.Map$FC: Ty, 
    $Heap: Heap, 
    this: DatatypeType, 
    rewrap#0: HandleType :: 
  { _module.Option.Map#requires(_module.Option$T, _module.Option.Map$FC, this, rewrap#0), $IsGoodHeap($Heap) } 
  $IsGoodHeap($Heap)
       && 
      $Is(this, Tclass._module.Option(_module.Option$T))
       && $IsAlloc(this, Tclass._module.Option(_module.Option$T), $Heap)
       && $Is(rewrap#0, 
        Tclass._System.___hTotalFunc1(Tclass._module.Option(_module.Option$T), _module.Option.Map$FC))
     ==> _module.Option.Map#requires(_module.Option$T, _module.Option.Map$FC, this, rewrap#0)
       == true);

procedure {:verboseName "Option.Map (well-formedness)"} CheckWellformed$$_module.Option.Map(_module.Option$T: Ty, 
    _module.Option.Map$FC: Ty, 
    this: DatatypeType
       where $Is(this, Tclass._module.Option(_module.Option$T))
         && $IsAlloc(this, Tclass._module.Option(_module.Option$T), $Heap), 
