...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon6_Then_correct  (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and reveal__module._default.f (= (ControlFlow 0 3) (- 0 2)))) (U_2_bool (Lit boolType (bool_2_U true))))))
