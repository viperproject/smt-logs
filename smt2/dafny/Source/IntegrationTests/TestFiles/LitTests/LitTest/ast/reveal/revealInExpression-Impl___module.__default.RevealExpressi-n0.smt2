...
(let ((anon13_Then_correct  (=> (and (and (= |##x#4@0| (LitInt 4)) ($IsAlloc intType (int_2_U |##x#4@0|) TInt $Heap)) (and (|_module.__default.P#canCall| (LitInt 4)) (|_module.__default.P#canCall| (LitInt 4)))) (and (=> (= (ControlFlow 0 18) (- 0 22)) (U_2_bool (Lit boolType (bool_2_U (_module.__default.P (LitInt 4)))))) (=> (U_2_bool (Lit boolType (bool_2_U (_module.__default.P (LitInt 4))))) (and (=> (= (ControlFlow 0 18) (- 0 21)) (or (and ($Is boolType (Lit boolType (bool_2_U true)) TBool) (U_2_bool (Lit boolType (bool_2_U true)))) (or (and ($Is boolType (Lit boolType (bool_2_U false)) TBool) (U_2_bool (Lit boolType (bool_2_U false)))) (exists ((|x#1| Bool) ) |x#1|)))) (=> (or (and ($Is boolType (Lit boolType (bool_2_U true)) TBool) (U_2_bool (Lit boolType (bool_2_U true)))) (or (and ($Is boolType (Lit boolType (bool_2_U false)) TBool) (U_2_bool (Lit boolType (bool_2_U false)))) (exists ((|x#1@@0| Bool) ) |x#1@@0|))) (=> |x#2@0| (=> (and (and (= |##x#5@0| (LitInt 5)) ($IsAlloc intType (int_2_U |##x#5@0|) TInt $Heap)) (and (|_module.__default.P#canCall| (LitInt 5)) (|_module.__default.P#canCall| (LitInt 5)))) (and (=> (= (ControlFlow 0 18) (- 0 20)) (U_2_bool (Lit boolType (bool_2_U (_module.__default.P (LitInt 5)))))) (=> (U_2_bool (Lit boolType (bool_2_U (_module.__default.P (LitInt 5))))) (=> |x#3@0| (and (=> (= (ControlFlow 0 18) (- 0 19)) (= |x#2@0| |x#3@0|)) (=> (= |x#2@0| |x#3@0|) (=> |$let#0$canCall| (=> (and |$let#0$canCall| (= |c#0@0| (let ((|x#1@@1| |$let#0_x|))
