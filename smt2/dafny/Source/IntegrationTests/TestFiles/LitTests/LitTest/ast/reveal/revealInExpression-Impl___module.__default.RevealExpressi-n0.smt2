...
(assert (forall ((|l#0@@1| T@U) (|$l#2#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#5| |l#0@@1|) |$l#2#ly#0|) |l#0@@1|)
 :qid |revealInExpressiondfy.24:13|
 :skolemid |509|
...
(assert (forall ((|$l#2#heap#0@@0| T@U) (|$l#2#x#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#1| |$l#2#heap#0@@0| |$l#2#x#0@@0|) ($Box boolType ($Unbox boolType |$l#2#x#0@@0|)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |505|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#1| |$l#2#heap#0@@0| |$l#2#x#0@@0|))
)))
...
(assert (forall ((|l#0@@3| T@U) (|$l#2#heap#0@@1| T@U) (|$l#2#x#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#4| |l#0@@3|) |$l#2#heap#0@@1| |$l#2#x#0@@1|) |l#0@@3|)
 :qid |revealInExpressiondfy.24:13|
 :skolemid |508|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#4| |l#0@@3|) |$l#2#heap#0@@1| |$l#2#x#0@@1|))
)))
...
(declare-fun |x#Z#0@0| () Bool)
(declare-fun |##x#3@0| () Int)
(declare-fun |b#0@0| () Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id Impl$$_module.__default.RevealExpressionScope)
...
(let ((anon17_Then_correct  (=> (and (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (= |##x#9@0| (LitInt 7))) (=> (and (and ($IsAlloc intType (int_2_U |##x#9@0|) TInt |$lambdaHeap#0@0|) (|_module.__default.P#canCall| (LitInt 7))) (and (|_module.__default.P#canCall| (LitInt 7)) (= (ControlFlow 0 8) (- 0 7)))) (U_2_bool (Lit boolType (bool_2_U (_module.__default.P (LitInt 7)))))))))
(let ((anon16_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 10) 8) anon17_Then_correct) (=> (= (ControlFlow 0 10) 9) anon17_Else_correct)))))
(let ((anon12_correct true))
(let ((anon18_Else_correct  (=> (and (U_2_bool ($Unbox boolType (Apply1 TBool TBool $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 |lambda#1| (|lambda#2| TBool) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))) ($Box boolType (Lit boolType (bool_2_U true)))))) (= (ControlFlow 0 6) 3)) anon12_correct)))
(let ((anon18_Then_correct  (=> (not (U_2_bool ($Unbox boolType (Apply1 TBool TBool $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 |lambda#1| (|lambda#2| TBool) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))) ($Box boolType (Lit boolType (bool_2_U true))))))) (=> (and (and (= |##x#10@0| (LitInt 8)) ($IsAlloc intType (int_2_U |##x#10@0|) TInt $Heap)) (and (|_module.__default.P#canCall| (LitInt 8)) (|_module.__default.P#canCall| (LitInt 8)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (U_2_bool (Lit boolType (bool_2_U (_module.__default.P (LitInt 8)))))) (=> (U_2_bool (Lit boolType (bool_2_U (_module.__default.P (LitInt 8))))) (=> (= (ControlFlow 0 4) 3) anon12_correct)))))))
(let ((anon6_correct  (=> (and (forall ((|x#4| Int) ) (! (|_module.__default.Q#canCall| |x#4|)
 :qid |revealInExpressiondfy.22:20|
 :skolemid |494|
 :pattern ( (_module.__default.Q |x#4|))
)) (= |d#0@0|  (or (forall ((|x#4@@0| Int) ) (! (_module.__default.Q |x#4@@0|)
 :qid |revealInExpressiondfy.22:20|
 :skolemid |492|
 :pattern ( (_module.__default.Q |x#4@@0|))
)) true))) (and (and (=> (= (ControlFlow 0 11) 10) anon16_Then_correct) (=> (= (ControlFlow 0 11) 4) anon18_Then_correct)) (=> (= (ControlFlow 0 11) 6) anon18_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (forall ((|x#4@@1| Int) ) (! (_module.__default.Q |x#4@@1|)
 :qid |revealInExpressiondfy.22:20|
 :skolemid |493|
 :pattern ( (_module.__default.Q |x#4@@1|))
)) (= (ControlFlow 0 14) 11)) anon6_correct)))
(let ((anon15_Then_correct  (=> (not (forall ((|x#4@@2| Int) ) (! (_module.__default.Q |x#4@@2|)
 :qid |revealInExpressiondfy.22:20|
 :skolemid |493|
 :pattern ( (_module.__default.Q |x#4@@2|))
))) (=> (and (and (= |##x#8@0| (LitInt 7)) ($IsAlloc intType (int_2_U |##x#8@0|) TInt $Heap)) (and (|_module.__default.P#canCall| (LitInt 7)) (|_module.__default.P#canCall| (LitInt 7)))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (U_2_bool (Lit boolType (bool_2_U (_module.__default.P (LitInt 7)))))) (=> (U_2_bool (Lit boolType (bool_2_U (_module.__default.P (LitInt 7))))) (=> (= (ControlFlow 0 12) 11) anon6_correct)))))))
(let ((anon14_Then_correct  (=> ($IsAlloc intType (int_2_U |x#5@0|) TInt $Heap) (=> (and (|_module.__default.P#canCall| |x#5@0|) (|_module.__default.P#canCall| |x#5@0|)) (and (=> (= (ControlFlow 0 15) (- 0 17)) (_module.__default.P |x#5@0|)) (=> (_module.__default.P |x#5@0|) (=> ($IsAlloc intType (int_2_U |x#5@0|) TInt $Heap) (and (=> (= (ControlFlow 0 15) (- 0 16)) (U_2_bool (Lit boolType (bool_2_U (_module.__default.P (LitInt 0)))))) (=> (and (U_2_bool (Lit boolType (bool_2_U (_module.__default.P (LitInt 0))))) (|_module.__default.Q#canCall| |x#5@0|)) (and (=> (= (ControlFlow 0 15) 12) anon15_Then_correct) (=> (= (ControlFlow 0 15) 14) anon15_Else_correct)))))))))))
(let ((anon14_Else_correct true))
(let ((anon13_Then_correct  (=> (and (and (= |##x#4@0| (LitInt 4)) ($IsAlloc intType (int_2_U |##x#4@0|) TInt $Heap)) (and (|_module.__default.P#canCall| (LitInt 4)) (|_module.__default.P#canCall| (LitInt 4)))) (and (=> (= (ControlFlow 0 18) (- 0 22)) (U_2_bool (Lit boolType (bool_2_U (_module.__default.P (LitInt 4)))))) (=> (U_2_bool (Lit boolType (bool_2_U (_module.__default.P (LitInt 4))))) (and (=> (= (ControlFlow 0 18) (- 0 21)) (or (and ($Is boolType (Lit boolType (bool_2_U true)) TBool) (U_2_bool (Lit boolType (bool_2_U true)))) (or (and ($Is boolType (Lit boolType (bool_2_U false)) TBool) (U_2_bool (Lit boolType (bool_2_U false)))) (exists ((|x#1| Bool) ) (! |x#1|
 :qid |revealInExpressiondfy.20:17|
 :skolemid |491|
))))) (=> (or (and ($Is boolType (Lit boolType (bool_2_U true)) TBool) (U_2_bool (Lit boolType (bool_2_U true)))) (or (and ($Is boolType (Lit boolType (bool_2_U false)) TBool) (U_2_bool (Lit boolType (bool_2_U false)))) (exists ((|x#1@@0| Bool) ) (! |x#1@@0|
 :qid |revealInExpressiondfy.20:17|
 :skolemid |491|
)))) (=> |x#2@0| (=> (and (and (= |##x#5@0| (LitInt 5)) ($IsAlloc intType (int_2_U |##x#5@0|) TInt $Heap)) (and (|_module.__default.P#canCall| (LitInt 5)) (|_module.__default.P#canCall| (LitInt 5)))) (and (=> (= (ControlFlow 0 18) (- 0 20)) (U_2_bool (Lit boolType (bool_2_U (_module.__default.P (LitInt 5)))))) (=> (U_2_bool (Lit boolType (bool_2_U (_module.__default.P (LitInt 5))))) (=> |x#3@0| (and (=> (= (ControlFlow 0 18) (- 0 19)) (= |x#2@0| |x#3@0|)) (=> (= |x#2@0| |x#3@0|) (=> |$let#0$canCall| (=> (and |$let#0$canCall| (= |c#0@0| (let ((|x#1@@1| |$let#0_x|))
|x#1@@1|))) (and (=> (= (ControlFlow 0 18) 15) anon14_Then_correct) (=> (= (ControlFlow 0 18) 2) anon14_Else_correct))))))))))))))))))
(let ((anon13_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (= |##x#0@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##x#0@0|) TInt $Heap)) (and (|_module.__default.P#canCall| (LitInt 0)) (|_module.__default.P#canCall| (LitInt 0)))) (and (=> (= (ControlFlow 0 23) (- 0 27)) (U_2_bool (Lit boolType (bool_2_U (_module.__default.P (LitInt 0)))))) (=> (U_2_bool (Lit boolType (bool_2_U (_module.__default.P (LitInt 0))))) (=> (= |a#0@0| (U_2_bool (Lit boolType (bool_2_U true)))) (=> (and (and (= |##x#1@0| (LitInt 1)) ($IsAlloc intType (int_2_U |##x#1@0|) TInt $Heap)) (and (|_module.__default.P#canCall| (LitInt 1)) (|_module.__default.P#canCall| (LitInt 1)))) (and (=> (= (ControlFlow 0 23) (- 0 26)) (U_2_bool (Lit boolType (bool_2_U (_module.__default.P (LitInt 1)))))) (=> (U_2_bool (Lit boolType (bool_2_U (_module.__default.P (LitInt 1))))) (=> (and (and (= |##x#2@0| (LitInt 2)) ($IsAlloc intType (int_2_U |##x#2@0|) TInt $Heap)) (and (|_module.__default.P#canCall| (LitInt 2)) (|_module.__default.P#canCall| (LitInt 2)))) (and (=> (= (ControlFlow 0 23) (- 0 25)) (U_2_bool (Lit boolType (bool_2_U (_module.__default.P (LitInt 2)))))) (=> (U_2_bool (Lit boolType (bool_2_U (_module.__default.P (LitInt 2))))) (=> (= |let#0#0#0| (U_2_bool (Lit boolType (bool_2_U true)))) (=> (and ($Is boolType (bool_2_U |let#0#0#0|) TBool) (= |x#Z#0@0| |let#0#0#0|)) (=> (and (and (= |##x#3@0| (LitInt 3)) ($IsAlloc intType (int_2_U |##x#3@0|) TInt $Heap)) (and (|_module.__default.P#canCall| (LitInt 3)) (|_module.__default.P#canCall| (LitInt 3)))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (U_2_bool (Lit boolType (bool_2_U (_module.__default.P (LitInt 3)))))) (=> (U_2_bool (Lit boolType (bool_2_U (_module.__default.P (LitInt 3))))) (=> (= |b#0@0| (let ((|x#0@@1| (U_2_bool (Lit boolType (bool_2_U true)))))
|x#0@@1|)) (and (=> (= (ControlFlow 0 23) 18) anon13_Then_correct) (=> (= (ControlFlow 0 23) 1) anon13_Else_correct)))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 28) 23))) anon0_correct)))
