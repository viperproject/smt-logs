...
(set-info :boogie-vc-id Impl$$_module.__default.Forall)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon3_correct  (=> (and (<= (LitInt 0) |i#0_0@0|) (< |i#0_0@0| (_System.array.Length $nw@0))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (and (<= 0 |i#0_0@0|) (< |i#0_0@0| (_System.array.Length $nw@0)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField |i#0_0@0|)))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField |i#0_0@0|))) (=> (and (and (<= (LitInt 0) |i#0_1@0|) (< |i#0_1@0| (_System.array.Length $nw@0))) (and (or (not (= |i#0_0@0| |i#0_1@0|)) (not true)) (= (ControlFlow 0 4) (- 0 3)))) (or (or (or (not (= $nw@0 $nw@0)) (not true)) (or (not (= (IndexField |i#0_0@0|) (IndexField |i#0_1@0|))) (not true))) (= (LitInt 0) (LitInt 0))))))))))))
(let ((anon7_Else_correct  (=> (and (< |i#0_0@0| (LitInt 0)) (= (ControlFlow 0 10) 4)) anon3_correct)))
(let ((anon7_Then_correct  (=> (<= (LitInt 0) |i#0_0@0|) (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (not (= $nw@0 null)) (not true))) (=> (= (ControlFlow 0 8) 4) anon3_correct)))))
(let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 11) 8) anon7_Then_correct) (=> (= (ControlFlow 0 11) 10) anon7_Else_correct))))
(let ((anon6_Else_correct  (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and ($HeapSucc $Heap@0 $Heap@1) (forall (($o@@6 T@U) ($f@@0 T@U) ) (!  (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@6) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) $f@@0)) (exists ((|i#0_2| Int) ) (!  (and (and (and (<= (LitInt 0) |i#0_2|) (< |i#0_2| (_System.array.Length $nw@0))) (= $o@@6 $nw@0)) (= $f@@0 (IndexField |i#0_2|)))
 :qid |revealInBlockdfy.49:10|
 :skolemid |496|
)))
 :qid |revealInBlockdfy.49:3|
 :skolemid |497|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@6) $f@@0))
))) (and (forall ((|i#inv#0_0| Int) ) (!  (=> (and (<= (LitInt 0) |i#inv#0_0|) (< |i#inv#0_0| (_System.array.Length $nw@0))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |i#inv#0_0|)) ($Box intType (int_2_U (LitInt 0)))))
 :qid |revealInBlockdfy.49:10|
 :skolemid |498|
...
)) (= |##x#0@0| (LitInt 1)))) (and (and ($IsAlloc intType (int_2_U |##x#0@0|) TInt $Heap@1) (|_module.__default.P#canCall| (LitInt 1))) (and (|_module.__default.P#canCall| (LitInt 1)) (= (ControlFlow 0 2) (- 0 1))))) (U_2_bool (Lit boolType (bool_2_U (_module.__default.P (LitInt 1)))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= 0 (LitInt 3))) (=> (<= 0 (LitInt 3)) (=> (and (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? TInt))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc))))) (and (and (= (_System.array.Length $nw@0) (LitInt 3)) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (=> (= (ControlFlow 0 12) 11) anon6_Then_correct) (=> (= (ControlFlow 0 12) 2) anon6_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |aa#0| (Tclass._System.array TInt)) ($IsAlloc refType |aa#0| (Tclass._System.array TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 14) 12))) anon0_correct))))
