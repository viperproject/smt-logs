...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= |x#0| (LitInt 6))) (=> (= |x#0| (LitInt 6)) (=> (= (ControlFlow 0 2) (- 0 1)) (= |y#0| (LitInt 8))))))))
