...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let (($generated@@99 true))
(let (($generated@@100  (=> (= $generated@@91 ($generated 3)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= $generated@@91 0)) (not true))) (=> (= (ControlFlow 0 2) (- 0 1)) (= ($generated@@24 3 $generated@@91) ($generated 1)))))))
(let (($generated@@101  (=> (= $generated@@92 ($generated@@32 $generated@@93 $generated@@94 $generated@@95 false)) (and (=> (= (ControlFlow 0 5) 2) $generated@@100) (=> (= (ControlFlow 0 5) 4) $generated@@99)))))
(let (($generated@@102  (=> (and (and ($generated@@96 $generated@@94) ($generated@@97 $generated@@94)) (and (= 0 $generated@@98) (= (ControlFlow 0 6) 5))) $generated@@101)))
$generated@@102)))))
))
(check-sat)
(get-info :rlimit)
