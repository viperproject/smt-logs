...
(set-info :boogie-vc-id Impl$$_module.__default.WellFormedness)
...
(let ((anon3_Then_correct  (=> (= |x#0| (LitInt 3)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |x#0| 0)) (not true))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (Div 3 |x#0|) (LitInt 1)))))))
