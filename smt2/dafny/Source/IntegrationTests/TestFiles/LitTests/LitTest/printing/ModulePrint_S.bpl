...
uses {
axiom FDim(S.C.g) == 0
   && FieldOfDecl(class.S.C?, field$g) == S.C.g
   && $IsGhostField(S.C.g);
}

// C.g: Type axiom
axiom (forall $h: Heap, $o: ref :: 
  { $Unbox(read($h, $o, S.C.g)): int } 
  $IsGoodHeap($h) && $o != null && dtype($o) == Tclass.S.C?()
     ==> $Is($Unbox(read($h, $o, S.C.g)): int, TInt));
...
axiom (forall $h: Heap, $o: ref :: 
  ...
  $IsGoodHeap($h)
      ...
      $o != null
       && dtype($o) == Tclass.S.C?()
       && $Unbox(read($h, $o, alloc)): bool
     ==> $IsAlloc($Unbox(read($h, $o, S.C.g)): int, TInt, $h));

const S.C.h: Field
uses {
axiom FDim(S.C.h) == 0
   && FieldOfDecl(class.S.C?, field$h) == S.C.h
   && !$IsGhostField(S.C.h);
}

// C.h: Type axiom
axiom (forall $h: Heap, $o: ref :: 
  { $Unbox(read($h, $o, S.C.h)): int } 
  $IsGoodHeap($h) && $o != null && dtype($o) == Tclass.S.C?()
     ==> $Is($Unbox(read($h, $o, S.C.h)): int, TInt));
...
axiom (forall $h: Heap, $o: ref :: 
  ...
  $IsGoodHeap($h)
      ...
      $o != null
       && dtype($o) == Tclass.S.C?()
       && $Unbox(read($h, $o, alloc)): bool
     ==> $IsAlloc($Unbox(read($h, $o, S.C.h)): int, TInt, $h));
...
procedure {:verboseName "S.C.m (well-formedness)"} CheckWellFormed$$S.C.m(this: ref
       where this != null && $Is(this, Tclass.S.C()) && $IsAlloc(this, Tclass.S.C(), $Heap));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "S.C.m (call)"} Call$$S.C.m(this: ref
       where this != null && $Is(this, Tclass.S.C()) && $IsAlloc(this, Tclass.S.C(), $Heap));
  modifies $Heap;
