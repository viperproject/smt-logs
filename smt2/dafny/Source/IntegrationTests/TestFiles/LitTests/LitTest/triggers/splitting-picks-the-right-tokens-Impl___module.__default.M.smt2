...
(assert  (=> (<= 0 $generated@@57) (forall (($generated@@60 Int) ) (!  (=> (or ($generated@@59 $generated@@60) (< 0 $generated@@57)) (= ($generated@@58 $generated@@60) $generated@@60))
 :pattern ( ($generated@@58 $generated@@60))
))))
(assert (forall (($generated@@61 T@U) ($generated@@62 T@T) ) (! (= ($generated@@7 $generated@@62 ($generated@@51 $generated@@62 $generated@@61)) $generated@@61)
...
(assert  (=> (<= 0 $generated@@57) (forall (($generated@@97 Int) ) (!  (=> (or ($generated@@59 ($generated@@46 $generated@@97)) (< 0 $generated@@57)) (= ($generated@@58 ($generated@@46 $generated@@97)) ($generated@@46 $generated@@97)))
 :weight 3
 :pattern ( ($generated@@58 ($generated@@46 $generated@@97)))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let (($generated@@106  (=> (= (ControlFlow 0 4) (- 0 3)) (forall (($generated@@107 Int) ) (!  (=> (> $generated@@107 0) (and (and (> ($generated@@58 $generated@@107) 1) (> $generated@@107 2)) (> $generated@@107 (- 0 1))))
 :pattern ( ($generated@@58 $generated@@107))
)))))
(let (($generated@@108  (=> (= (ControlFlow 0 2) (- 0 1)) (forall (($generated@@109 Int) ) (!  (and (and (=> (> $generated@@109 0) (> ($generated@@58 $generated@@109) 1)) (=> (> $generated@@109 0) (> $generated@@109 2))) (=> (> $generated@@109 0) (> $generated@@109 (- 0 1))))
 :pattern ( ($generated@@58 $generated@@109))
)))))
(let (($generated@@110  (=> (= $generated@@101 ($generated@@64 $generated@@102 $generated@@103 $generated@@5 false)) (and (=> (= (ControlFlow 0 5) 2) $generated@@108) (=> (= (ControlFlow 0 5) 4) $generated@@106)))))
(let (($generated@@111  (=> (and (and ($generated@@104 $generated@@103) ($generated@@105 $generated@@103)) (and (= 2 $generated@@57) (= (ControlFlow 0 6) 5))) $generated@@110)))
$generated@@111)))))
))
(check-sat)
