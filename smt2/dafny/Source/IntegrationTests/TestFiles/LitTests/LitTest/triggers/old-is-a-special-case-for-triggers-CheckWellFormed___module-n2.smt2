...
(assert (forall (($h0 T@U) ($h1 T@U) (|c#0@@1| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|_module.__default.ff#canCall| $h0 |c#0@@1|) ($Is refType |c#0@@1| Tclass._module.C))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@1 T@U) ($f T@U) )  (=> (and (or (not (= $o@@1 null)) (not true)) (= $o@@1 |c#0@@1|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@1) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@1) $f)))) (= (_module.__default.ff $h0 |c#0@@1|) (_module.__default.ff $h1 |c#0@@1|))))
