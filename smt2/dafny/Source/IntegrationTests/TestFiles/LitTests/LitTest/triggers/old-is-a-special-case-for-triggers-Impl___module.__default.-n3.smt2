...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|c#0@@3| T@U) ) (!  (=> (and (or (|_module.__default.g#canCall| |c#0@@3|) (and (< 1 $FunctionContextHeight) (and ($Is refType |c#0@@3| Tclass._module.C) ($IsAlloc refType |c#0@@3| Tclass._module.C $Heap@@0)))) ($IsGoodHeap $Heap@@0)) ($IsAlloc refType (_module.__default.g |c#0@@3|) Tclass._module.C $Heap@@0))
 :qid |oldisaspecialcasefortriggersdfy.10:16|
 :skolemid |533|
 :pattern ( ($IsAlloc refType (_module.__default.g |c#0@@3|) Tclass._module.C $Heap@@0))
))))
...
(assert (= (Tag Tclass._module.C?) Tagclass._module.C?))
(assert (= (TagFamily Tclass._module.C?) tytagFamily$C))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@1 T@U) (|c#0@@4| T@U) ) (!  (=> (or (|_module.__default.ff#canCall| $Heap@@1 |c#0@@4|) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@1) (and ($Is refType |c#0@@4| Tclass._module.C) ($IsAlloc refType |c#0@@4| Tclass._module.C $Heap@@1))))) ($IsAlloc refType (_module.__default.ff $Heap@@1 |c#0@@4|) Tclass._module.C $Heap@@1))
 :qid |oldisaspecialcasefortriggersdfy.34:16|
 :skolemid |569|
 :pattern ( ($IsAlloc refType (_module.__default.ff $Heap@@1 |c#0@@4|) Tclass._module.C $Heap@@1))
))))
(push 1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (forall ((|c#1| T@U) ) (!  (=> (and ($Is refType |c#1| Tclass._module.C) (|Set#IsMember| |sc#0| ($Box refType |c#1|))) (or true (= |c#1| (_module.__default.ff $Heap@@2 |c#1|))))
...
))) (=> (forall ((|c#1@@0| T@U) ) (!  (=> (and ($Is refType |c#1@@0| Tclass._module.C) (|Set#IsMember| |sc#0| ($Box refType |c#1@@0|))) (or true (= |c#1@@0| (_module.__default.ff $Heap@@2 |c#1@@0|))))
 :qid |oldisaspecialcasefortriggersdfy.38:18|
 :skolemid |589|
 :pattern ( (_module.__default.ff $Heap@@2 |c#1@@0|))
 :pattern ( (|Set#IsMember| |sc#0| ($Box refType |c#1@@0|)))
)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall ((|c#3| T@U) ) (!  (=> (and ($Is refType |c#3| Tclass._module.C) (|Set#IsMember| |sc#0| ($Box refType |c#3|))) (or true (= (_module.__default.ff $Heap@@2 |c#3|) (_module.__default.ff $Heap@@2 (_module.__default.ff $Heap@@2 |c#3|)))))
 :qid |oldisaspecialcasefortriggersdfy.43:18|
 :skolemid |591|
 :pattern ( (_module.__default.ff $Heap@@2 (_module.__default.ff $Heap@@2 |c#3|)))
 :pattern ( (_module.__default.ff $Heap@@2 |c#3|))
 :pattern ( (|Set#IsMember| |sc#0| ($Box refType |c#3|)))
))) (=> (forall ((|c#3@@0| T@U) ) (!  (=> (and ($Is refType |c#3@@0| Tclass._module.C) (|Set#IsMember| |sc#0| ($Box refType |c#3@@0|))) (or true (= (_module.__default.ff $Heap@@2 |c#3@@0|) (_module.__default.ff $Heap@@2 (_module.__default.ff $Heap@@2 |c#3@@0|)))))
 :qid |oldisaspecialcasefortriggersdfy.43:18|
 :skolemid |591|
 :pattern ( (_module.__default.ff $Heap@@2 (_module.__default.ff $Heap@@2 |c#3@@0|)))
 :pattern ( (_module.__default.ff $Heap@@2 |c#3@@0|))
 :pattern ( (|Set#IsMember| |sc#0| ($Box refType |c#3@@0|)))
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((|c#5| T@U) ) (!  (=> (and ($Is refType |c#5| Tclass._module.C) (|Set#IsMember| |sc#0| ($Box refType |c#5|))) (or (or (or true (= (_module.__default.ff $Heap@@2 (_module.__default.ff $Heap@@2 |c#5|)) (_module.__default.g (_module.__default.ff $Heap@@2 |c#5|)))) (= (_module.__default.ff $Heap@@2 (_module.__default.g |c#5|)) (_module.__default.g (_module.__default.ff $Heap@@2 |c#5|)))) (= (_module.__default.ff $Heap@@2 (_module.__default.g |c#5|)) (_module.__default.g (_module.__default.ff $Heap@@2 |c#5|)))))
...
))) (=> (forall ((|c#5@@0| T@U) ) (!  (=> (and ($Is refType |c#5@@0| Tclass._module.C) (|Set#IsMember| |sc#0| ($Box refType |c#5@@0|))) (or (or (or true (= (_module.__default.ff $Heap@@2 (_module.__default.ff $Heap@@2 |c#5@@0|)) (_module.__default.g (_module.__default.ff $Heap@@2 |c#5@@0|)))) (= (_module.__default.ff $Heap@@2 (_module.__default.g |c#5@@0|)) (_module.__default.g (_module.__default.ff $Heap@@2 |c#5@@0|)))) (= (_module.__default.ff $Heap@@2 (_module.__default.g |c#5@@0|)) (_module.__default.g (_module.__default.ff $Heap@@2 |c#5@@0|)))))
 :qid |oldisaspecialcasefortriggersdfy.44:18|
 :skolemid |593|
 :pattern ( (_module.__default.ff $Heap@@2 (_module.__default.g |c#5@@0|)))
 :pattern ( (_module.__default.g (_module.__default.ff $Heap@@2 |c#5@@0|)))
 :pattern ( (_module.__default.ff $Heap@@2 (_module.__default.g |c#5@@0|)))
 :pattern ( (_module.__default.g (_module.__default.ff $Heap@@2 |c#5@@0|)))
 :pattern ( (_module.__default.ff $Heap@@2 (_module.__default.ff $Heap@@2 |c#5@@0|)))
 :pattern ( (|Set#IsMember| |sc#0| ($Box refType |c#5@@0|)))
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((|c#7| T@U) ) (!  (=> (and ($Is refType |c#7| Tclass._module.C) (|Set#IsMember| |sc#0| ($Box refType |c#7|))) (or true (= (_module.__default.ff $Heap@@2 |c#7|) (_module.__default.g (_module.__default.ff $Heap@@2 |c#7|)))))
...
))) (=> (forall ((|c#7@@0| T@U) ) (!  (=> (and ($Is refType |c#7@@0| Tclass._module.C) (|Set#IsMember| |sc#0| ($Box refType |c#7@@0|))) (or true (= (_module.__default.ff $Heap@@2 |c#7@@0|) (_module.__default.g (_module.__default.ff $Heap@@2 |c#7@@0|)))))
 :qid |oldisaspecialcasefortriggersdfy.48:18|
 :skolemid |595|
 :pattern ( (_module.__default.ff $Heap@@2 |c#7@@0|))
 :pattern ( (_module.__default.ff $Heap@@2 |c#7@@0|))
 :pattern ( (|Set#IsMember| |sc#0| ($Box refType |c#7@@0|)))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|c#9| T@U) ) (!  (=> (and ($Is refType |c#9| Tclass._module.C) (|Set#IsMember| |sc#0| ($Box refType |c#9|))) (or (or true (= (_module.__default.ff $Heap@@2 |c#9|) (_module.__default.ff $Heap@@2 |c#9|))) (= (_module.__default.g (_module.__default.ff $Heap@@2 |c#9|)) (_module.__default.g (_module.__default.ff $Heap@@2 |c#9|)))))
 :qid |oldisaspecialcasefortriggersdfy.49:18|
 :skolemid |597|
 :pattern ( (_module.__default.ff $Heap@@2 |c#9|))
 :pattern ( (_module.__default.ff $Heap@@2 |c#9|))
 :pattern ( (|Set#IsMember| |sc#0| ($Box refType |c#9|)))
))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and ($Is SetType |sc#0| (TSet Tclass._module.C)) ($IsAlloc SetType |sc#0| (TSet Tclass._module.C) $Heap@@2)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 7) 2))) anon0_correct))))
