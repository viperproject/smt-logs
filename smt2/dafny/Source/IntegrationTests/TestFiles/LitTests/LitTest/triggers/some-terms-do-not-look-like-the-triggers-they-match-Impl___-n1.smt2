...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 90) (let ((anon50_correct  (=> (and (= |c1#3_0@0| (forall ((|x#3_2| Int) )  (=> (or (or (= |x#3_2| (LitInt 2)) (= |x#3_2| (LitInt 3))) (= |x#3_2| (LitInt 5))) (< |x#3_2| 200)))) (= (ControlFlow 0 47) (- 0 46))) (= |c0#3_0@0| |c1#3_0@0|))))
...
(let ((anon47_correct  (=> (= |c0#3_0@0| (forall ((|x#3_0| Int) )  (=> (or (or (= |x#3_0| (LitInt 2)) (= |x#3_0| (LitInt 3))) (= |x#3_0| (LitInt 5))) (< |x#3_0| 200)))) (and (=> (= (ControlFlow 0 51) 50) anon87_Then_correct) (=> (= (ControlFlow 0 51) 45) anon87_Else_correct)))))
