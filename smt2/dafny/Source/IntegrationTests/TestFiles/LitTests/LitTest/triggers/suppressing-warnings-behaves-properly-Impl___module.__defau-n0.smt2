...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 58) (let ((anon29_correct  (=> (and (forall ((|n#17| Int) )  (=> (<= (LitInt 0) |n#17|) (|_module.__default.f#canCall| |n#17|))) (= (ControlFlow 0 5) (- 0 4))) (forall ((|n#17@@0| Int) )  (=> (<= (LitInt 0) |n#17@@0|) (or (=  (or (not (= |n#17@@0| 0)) (not true)) (_module.__default.f |n#17@@0|)) true))))))
...
(let ((anon18_correct  (=> (forall ((|n#11| Int) )  (=> (<= (LitInt 0) |n#11|) (|_module.__default.f#canCall| |n#11|))) (and (=> (= (ControlFlow 0 24) (- 0 25)) (forall ((|n#11@@0| Int) )  (=> (<= (LitInt 0) |n#11@@0|) (or (=  (or (not (= |n#11@@0| 0)) (not true)) (_module.__default.f |n#11@@0|)) true)))) (=> (forall ((|n#11@@1| Int) )  (=> (<= (LitInt 0) |n#11@@1|) (or (=  (or (not (= |n#11@@1| 0)) (not true)) (_module.__default.f |n#11@@1|)) true))) (and (=> (= (ControlFlow 0 24) 23) anon42_Then_correct) (=> (= (ControlFlow 0 24) 18) anon42_Else_correct)))))))
...
(let ((anon9_correct  (and (=> (= (ControlFlow 0 42) (- 0 43)) (forall ((|n#5| Int) )  (or (>= |n#5| (LitInt 0)) (< |n#5| 0)))) (=> (forall ((|n#5@@0| Int) )  (or (>= |n#5@@0| (LitInt 0)) (< |n#5@@0| 0))) (and (=> (= (ControlFlow 0 42) 41) anon36_Then_correct) (=> (= (ControlFlow 0 42) 38) anon36_Else_correct))))))
...
(let ((anon6_correct  (and (=> (= (ControlFlow 0 47) (- 0 48)) (forall ((|n#3| Int) )  (or (>= |n#3| (LitInt 0)) (< |n#3| 0)))) (=> (forall ((|n#3@@0| Int) )  (or (>= |n#3@@0| (LitInt 0)) (< |n#3@@0| 0))) (and (=> (= (ControlFlow 0 47) 46) anon34_Then_correct) (=> (= (ControlFlow 0 47) 3) anon34_Else_correct))))))
...
(let ((anon3_correct  (and (=> (= (ControlFlow 0 52) (- 0 53)) (forall ((|n#1| Int) )  (or (>= |n#1| (LitInt 0)) (< |n#1| 0)))) (=> (forall ((|n#1@@0| Int) )  (or (>= |n#1@@0| (LitInt 0)) (< |n#1@@0| 0))) (and (=> (= (ControlFlow 0 52) 51) anon32_Then_correct) (=> (= (ControlFlow 0 52) 2) anon32_Else_correct))))))
