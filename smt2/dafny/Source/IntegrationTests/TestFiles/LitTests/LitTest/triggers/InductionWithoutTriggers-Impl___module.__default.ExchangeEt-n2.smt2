...
(assert (forall ((|l#0@@3| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|$l#9#heap#0| T@U) (|$l#9#x#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#28| |l#0@@3| |l#1@@0| |l#2@@0|) |$l#9#heap#0| |$l#9#x#0|) ($Box intType ($Unbox intType (Apply1 |l#0@@3| |l#1@@0| |$l#9#heap#0| |l#2@@0| ($Box intType ($Unbox intType |$l#9#x#0|))))))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |575|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#28| |l#0@@3| |l#1@@0| |l#2@@0|) |$l#9#heap#0| |$l#9#x#0|))
)))
...
(assert (forall ((|l#0@@4| T@U) (|$l#4#heap#0@@0| T@U) (|$l#4#x#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#5| |l#0@@4|) |$l#4#heap#0@@0| |$l#4#x#0@@0|) |l#0@@4|)
 :qid |InductionWithoutTriggersdfy.11:49|
 :skolemid |573|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#5| |l#0@@4|) |$l#4#heap#0@@0| |$l#4#x#0@@0|))
)))
...
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.ExchangeEtaWithInductionAttribute)
...
(assert (not
 ...
 :qid |InductionWithoutTriggersdfy.18:19|
 :skolemid |543|
...
))) (and (<= 0 |$ih#n0#0|) (< |$ih#n0#0| |n#0@@3|))) (= (_module.__default.Sum ($LS $LZ) |$ih#n0#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#28| TInt TInt |f#0@@7|) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ)))) (_module.__default.Sum ($LS $LZ) |$ih#n0#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#28| TInt TInt |g#0|) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))))))
 :qid |InductionWithoutTriggersdfy.17:56|
 :skolemid |544|
)) (= (ControlFlow 0 2) (- 0 1)))) (= (_module.__default.Sum ($LS ($LS $LZ)) |n#0@@3| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#28| TInt TInt |f#0@@7|) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ)))) (_module.__default.Sum ($LS ($LS $LZ)) |n#0@@3| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#28| TInt TInt |g#0|) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ)))))))))
