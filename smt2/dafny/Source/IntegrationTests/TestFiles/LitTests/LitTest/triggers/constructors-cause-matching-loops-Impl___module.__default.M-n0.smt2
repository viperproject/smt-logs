...
(declare-fun _module.Nat.x (T@U) T@U)
...
(assert (forall ((d@@2 T@U) ) (!  (=> (_module.Nat.Succ_q d@@2) (exists ((|a#5#0#0| T@U) ) (! (= d@@2 (|#_module.Nat.Succ| |a#5#0#0|))
 :qid |constructorscausematchingloopsdfy.6:28|
 :skolemid |492|
)))
 :qid |unknown.0:0|
 :skolemid |493|
...
(assert (forall ((a@@0 T@U) (b@@0 T@U) ) (!  (=> (and (_module.Nat.Succ_q a@@0) (_module.Nat.Succ_q b@@0)) (= (|_module.Nat#Equal| a@@0 b@@0) (|_module.Nat#Equal| (_module.Nat.x a@@0) (_module.Nat.x b@@0))))
 :qid |unknown.0:0|
 :skolemid |503|
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|n#0| T@U) ) (!  (=> (or (|_module.__default.f#canCall| |n#0|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |n#0| Tclass._module.Nat))) ($Is DatatypeTypeType (_module.__default.f |n#0|) Tclass._module.Nat))
 :qid |constructorscausematchingloopsdfy.7:18|
 :skolemid |480|
...
(assert (forall ((|a#8#0#0| T@U) ) (! (= (_module.Nat.x (|#_module.Nat.Succ| |a#8#0#0|)) |a#8#0#0|)
 :qid |constructorscausematchingloopsdfy.6:28|
 :skolemid |497|
...
(assert (forall ((d@@6 T@U) ($h@@0 T@U) ) (!  (=> (and ($IsGoodHeap $h@@0) (and (_module.Nat.Succ_q d@@6) ($IsAlloc DatatypeTypeType d@@6 Tclass._module.Nat $h@@0))) ($IsAlloc DatatypeTypeType (_module.Nat.x d@@6) Tclass._module.Nat $h@@0))
 :qid |unknown.0:0|
 :skolemid |495|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Nat.x d@@6) Tclass._module.Nat $h@@0))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_correct  (=> (and (forall ((|s#1| T@U) ) (!  (=> ($Is DatatypeTypeType |s#1| Tclass._module.Nat) (=> (not (U_2_bool (Lit boolType (bool_2_U true)))) (and (and (|$IsA#_module.Nat| (_module.__default.f (|#_module.Nat.Succ| |s#1|))) (|$IsA#_module.Nat| (_module.__default.f |s#1|))) (and (|_module.__default.f#canCall| (|#_module.Nat.Succ| |s#1|)) (|_module.__default.f#canCall| |s#1|)))))
 :qid |constructorscausematchingloopsdfy.10:17|
 :skolemid |485|
 :pattern ( (|#_module.Nat.Succ| |s#1|))
)) (= (ControlFlow 0 2) (- 0 1))) (forall ((|s#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |s#1@@0| Tclass._module.Nat) (or true (|_module.Nat#Equal| (_module.__default.f (|#_module.Nat.Succ| |s#1@@0|)) (_module.__default.f |s#1@@0|))))
 :qid |constructorscausematchingloopsdfy.10:17|
 :skolemid |487|
 :pattern ( (|#_module.Nat.Succ| |s#1@@0|))
)))))
(let ((anon5_Else_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) (= (ControlFlow 0 5) 2)) anon3_correct)))
(let ((anon5_Then_correct  (=> (not (U_2_bool (Lit boolType (bool_2_U true)))) (=> (and (= |##n#0@0| (|#_module.Nat.Succ| |s#0@0|)) ($IsAlloc DatatypeTypeType |##n#0@0| Tclass._module.Nat $Heap)) (=> (and (and (|_module.__default.f#canCall| (|#_module.Nat.Succ| |s#0@0|)) ($IsAlloc DatatypeTypeType |s#0@0| Tclass._module.Nat $Heap)) (and (|_module.__default.f#canCall| |s#0@0|) (= (ControlFlow 0 4) 2))) anon3_correct)))))
(let ((anon4_Then_correct  (=> (and ($Is DatatypeTypeType |s#0@0| Tclass._module.Nat) ($IsAlloc DatatypeTypeType |s#0@0| Tclass._module.Nat $Heap)) (and (=> (= (ControlFlow 0 6) 4) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct)))))
(let ((anon4_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |s#0@0| Tclass._module.Nat) ($IsAlloc DatatypeTypeType |s#0@0| Tclass._module.Nat $Heap))) (= (ControlFlow 0 3) 2)) anon3_correct)))
