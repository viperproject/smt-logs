...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((|x#1| Int) ) (!  (or true (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap |f#0@@3| ($Box intType (int_2_U |x#1|))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap |g#0| ($Box intType ($Unbox intType (Apply1 TInt TInt $Heap |f#0@@3| ($Box intType (int_2_U |x#1|))))))))))
 :qid |loopingishardtodecidemoduloequalitydfy.26:17|
 :skolemid |550|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap |f#0@@3| ($Box intType (int_2_U |x#1|)))))
)))))
(let ((anon5_Else_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) (= (ControlFlow 0 5) 3)) anon3_correct)))
(let ((anon5_Then_correct  (=> (and (not (U_2_bool (Lit boolType (bool_2_U true)))) (= (ControlFlow 0 4) 3)) anon3_correct)))
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 7) 6) anon4_Then_correct) (=> (= (ControlFlow 0 7) 1) anon4_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap))) (and (and ($Is HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 8) 7)))) anon0_correct)))
