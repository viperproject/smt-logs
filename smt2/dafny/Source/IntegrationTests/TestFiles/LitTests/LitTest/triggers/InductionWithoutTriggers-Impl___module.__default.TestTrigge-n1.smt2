...
(declare-fun |lambda#2| (Int T@U T@U T@U) T@U)
...
(assert (forall ((|l#0| T@U) (|$l#4#heap#0| T@U) (|$l#4#x#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#3| |l#0|) |$l#4#heap#0| |$l#4#x#0|)) ($IsBox |$l#4#x#0| |l#0|))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |571|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#3| |l#0|) |$l#4#heap#0| |$l#4#x#0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly T@U) ($Heap T@U) (|n#0| Int) (|f#0@@1| T@U) ) (!  (=> (or (|_module.__default.Sum#canCall| (LitInt |n#0|) |f#0@@1|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) (<= (LitInt 0) |n#0|)) ($Is HandleTypeType |f#0@@1| (Tclass._System.___hTotalFunc1 TInt TInt))))) (and (=> (or (not (= (LitInt |n#0|) (LitInt 0))) (not true)) (|_module.__default.Sum#canCall| (LitInt (- |n#0| 1)) |f#0@@1|)) (= (_module.__default.Sum ($LS $ly) (LitInt |n#0|) |f#0@@1|) (ite (= (LitInt |n#0|) (LitInt 0)) 0 (+ (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap |f#0@@1| ($Box intType (int_2_U (LitInt (- |n#0| 1))))))) (_module.__default.Sum ($LS $ly) (LitInt (- |n#0| 1)) |f#0@@1|))))))
 :qid |InductionWithoutTriggersdfy.3:16|
 :weight 3
 :skolemid |533|
...
(assert (forall ((|l#0@@0| Bool) (|$l#4#o#0| T@U) ) (! (= (U_2_bool (MapType1Select refType boolType (|lambda#4| |l#0@@0|) |$l#4#o#0|)) |l#0@@0|)
 :qid |unknown.0:0|
 :skolemid |572|
 :pattern ( (MapType1Select refType boolType (|lambda#4| |l#0@@0|) |$l#4#o#0|))
)))
(assert (forall ((|l#0@@1| T@U) (|$l#4#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#6| |l#0@@1|) |$l#4#ly#0|) |l#0@@1|)
 :qid |InductionWithoutTriggersdfy.11:49|
 :skolemid |574|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#6| |l#0@@1|) |$l#4#ly#0|))
)))
...
(assert (forall ((|l#0@@3| Int) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3@@0| T@U) (|$l#4#heap#0@@0| T@U) (|$l#4#x#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#2| |l#0@@3| |l#1@@0| |l#2@@0| |l#3@@0|) |$l#4#heap#0@@0| |$l#4#x#0@@0|) ($Box intType (int_2_U (+ |l#0@@3| (U_2_int ($Unbox intType (Apply1 |l#1@@0| |l#2@@0| |$l#4#heap#0@@0| |l#3@@0| ($Box intType ($Unbox intType |$l#4#x#0@@0|)))))))))
 :qid |unknown.0:0|
 :skolemid |570|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#2| |l#0@@3| |l#1@@0| |l#2@@0| |l#3@@0|) |$l#4#heap#0@@0| |$l#4#x#0@@0|))
)))
...
(assert (forall ((|l#0@@4| T@U) (|$l#4#heap#0@@1| T@U) (|$l#4#x#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#5| |l#0@@4|) |$l#4#heap#0@@1| |$l#4#x#0@@1|) |l#0@@4|)
 :qid |InductionWithoutTriggersdfy.11:49|
 :skolemid |573|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#5| |l#0@@4|) |$l#4#heap#0@@1| |$l#4#x#0@@1|))
)))
...
(declare-fun |g#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.TestTriggerWithLambdaExpression)
...
(let ((anon8_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@2 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@2 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 7) 5) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))
(let ((anon6_correct  (=> (and (forall ((|n#2| Int) (|f#2| T@U) (|_t#0#0| T@U) ) (!  (=> (and (and (<= (LitInt 0) |n#2|) ($Is HandleTypeType |f#2| (Tclass._System.___hTotalFunc1 TInt TInt))) ($Is HandleTypeType |_t#0#0| (Tclass._System.___hTotalFunc1 TInt TInt))) (=> (= |_t#0#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| 500 TInt TInt |f#2|) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ)))) (and (|_module.__default.Sum#canCall| |n#2| |_t#0#0|) (|_module.__default.Sum#canCall| |n#2| |f#2|))))
 :qid |InductionWithoutTriggersdfy.11:17|
 :skolemid |536|
 :pattern ( (_module.__default.Sum ($LS $LZ) |n#2| |f#2|) (_module.__default.Sum ($LS $LZ) |n#2| |_t#0#0|))
)) (= (ControlFlow 0 2) (- 0 1))) (forall ((|n#2@@0| Int) (|f#2@@0| T@U) (|_t#0#0@@0| T@U) ) (!  (=> (and (and (and (<= (LitInt 0) |n#2@@0|) ($Is HandleTypeType |f#2@@0| (Tclass._System.___hTotalFunc1 TInt TInt))) ($Is HandleTypeType |_t#0#0@@0| (Tclass._System.___hTotalFunc1 TInt TInt))) (= |_t#0#0@@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| 500 TInt TInt |f#2@@0|) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))))) (= (_module.__default.Sum ($LS ($LS $LZ)) |n#2@@0| |_t#0#0@@0|) (+ |n#2@@0| (_module.__default.Sum ($LS ($LS $LZ)) |n#2@@0| |f#2@@0|))))
 :qid |InductionWithoutTriggersdfy.11:17|
 :skolemid |537|
 :pattern ( (_module.__default.Sum ($LS ($LS $LZ)) |n#2@@0| |f#2@@0|) (_module.__default.Sum ($LS ($LS $LZ)) |n#2@@0| |_t#0#0@@0|))
)))))
(let ((anon8_Else_correct  (=> (= |##f#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| 500 TInt TInt |f#1@0|) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ)))) (=> (and ($IsAlloc HandleTypeType |##f#0@0| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap@@2) (|_module.__default.Sum#canCall| |n#1@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| 500 TInt TInt |f#1@0|) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))))) (=> (and (and ($IsAlloc intType (int_2_U |n#1@0|) Tclass._System.nat $Heap@@2) ($IsAlloc HandleTypeType |f#1@0| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap@@2)) (and (|_module.__default.Sum#canCall| |n#1@0| |f#1@0|) (= (ControlFlow 0 4) 2))) anon6_correct)))))
(let ((anon7_Then_correct  (=> (and (and (<= (LitInt 0) |n#1@0|) (and ($Is HandleTypeType |f#1@0| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |f#1@0| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap@@2))) ($IsAlloc intType (int_2_U |n#1@0|) Tclass._System.nat $Heap@@2)) (and (=> (= (ControlFlow 0 8) 7) anon8_Then_correct) (=> (= (ControlFlow 0 8) 4) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (not (and (<= (LitInt 0) |n#1@0|) (and ($Is HandleTypeType |f#1@0| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |f#1@0| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap@@2)))) (= (ControlFlow 0 3) 2)) anon6_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (and (=> (= (ControlFlow 0 9) 8) anon7_Then_correct) (=> (= (ControlFlow 0 9) 3) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (<= (LitInt 0) |n#0@@3|)) (and ($Is HandleTypeType |f#0@@7| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |f#0@@7| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap@@2))) (and (and ($Is HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap@@2)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 9)))) anon0_correct)))
