...
(declare-fun _module.__default.HashtableLookup (T@U T@U) T@U)
(declare-fun |_module.__default.HashtableLookup#canCall| (T@U T@U) Bool)
...
(assert  (and (= (Ctor MapType) 4) (= (Ctor SeqType) 5)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|h#0| T@U) (|k#0| T@U) ) (!  (=> (or (|_module.__default.HashtableLookup#canCall| |h#0| |k#0|) (and (< 2 $FunctionContextHeight) (and ($Is MapType |h#0| (TMap (TSeq TInt) (TSeq TInt))) ($Is SeqType |k#0| (TSeq TInt))))) ($Is SeqType (_module.__default.HashtableLookup |h#0| |k#0|) (TSeq TInt)))
 :qid |autotriggersfixanissuelistedintheironcladnotebookdfy.18:32|
 :skolemid |528|
 :pattern ( (_module.__default.HashtableLookup |h#0| |k#0|))
))))
...
(assert (forall ((v@@4 T@U) (t0@@3 T@U) (t1@@0 T@U) (h@@2 T@U) ) (! (= ($IsAlloc MapType v@@4 (TMap t0@@3 t1@@0) h@@2) (forall ((bx@@2 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@4) bx@@2) (and ($IsAllocBox (MapType0Select BoxType BoxType (|Map#Elements| v@@4) bx@@2) t1@@0 h@@2) ($IsAllocBox bx@@2 t0@@3 h@@2)))
...
(assert (forall ((bx@@3 T@U) (s@@0 T@U) (t@@8 T@U) ) (!  (=> ($IsBox bx@@3 (TMap s@@0 t@@8)) (and (= ($Box MapType ($Unbox MapType bx@@3)) bx@@3) ($Is MapType ($Unbox MapType bx@@3) (TMap s@@0 t@@8))))
 :qid |DafnyPreludebpl.207:15|
 :skolemid |36|
 :pattern ( ($IsBox bx@@3 (TMap s@@0 t@@8)))
)))
...
(assert (forall ((v@@7 T@U) (t0@@5 T@U) (t1@@2 T@U) ) (! (= ($Is MapType v@@7 (TMap t0@@5 t1@@2)) (forall ((bx@@7 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@7) bx@@7) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@7) bx@@7) t1@@2) ($IsBox bx@@7 t0@@5)))
...
(declare-fun |h1#0| () T@U)
(declare-fun |k#0@@0| () T@U)
(declare-fun |h2#0| () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $Heap () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id Impl$$_module.__default.HashtableAgreement)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon2_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or true (= (|Set#IsMember| (|Map#Domain| |h1#0|) ($Box SeqType |k#0@@0|)) (|Set#IsMember| (|Map#Domain| |h2#0|) ($Box SeqType |k#0@@0|)))))))
(let ((anon3_Else_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) (= (ControlFlow 0 4) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and (not (U_2_bool (Lit boolType (bool_2_U true)))) (= (ControlFlow 0 3) 2)) anon2_correct)))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is MapType |h1#0| (TMap (TSeq TInt) (TSeq TInt))) ($IsAlloc MapType |h1#0| (TMap (TSeq TInt) (TSeq TInt)) $Heap)) (and ($Is MapType |h2#0| (TMap (TSeq TInt) (TSeq TInt))) ($IsAlloc MapType |h2#0| (TMap (TSeq TInt) (TSeq TInt)) $Heap))) (=> (and (and (and ($Is SeqType |k#0@@0| (TSeq TInt)) ($IsAlloc SeqType |k#0@@0| (TSeq TInt) $Heap)) (= 3 $FunctionContextHeight)) (and (forall ((|k#2| T@U) ) (!  (=> ($Is SeqType |k#2| (TSeq TInt)) (|Seq#Equal| (_module.__default.HashtableLookup |h1#0| |k#2|) (_module.__default.HashtableLookup |h2#0| |k#2|)))
 :qid |autotriggersfixanissuelistedintheironcladnotebookdfy.21:19|
 :skolemid |532|
 :pattern ( (_module.__default.HashtableLookup |h2#0| |k#2|))
 :pattern ( (_module.__default.HashtableLookup |h1#0| |k#2|))
