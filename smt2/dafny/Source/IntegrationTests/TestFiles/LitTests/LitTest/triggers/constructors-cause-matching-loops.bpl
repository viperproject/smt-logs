// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/triggers/constructors-cause-matching-loops.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/triggers/constructors-cause-matching-loops-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/triggers/constructors-cause-matching-loops.dfy
...
function _module.__default.f(n#0: DatatypeType) : DatatypeType
uses {
...
axiom 1 <= $FunctionContextHeight
   ==> (forall n#0: DatatypeType :: 
    ...
    _module.__default.f#canCall(n#0)
       ...
       ==> $Is(_module.__default.f(n#0), Tclass._module.Nat()));
}

function _module.__default.f#canCall(n#0: DatatypeType) : bool;
...
axiom (forall n#0: DatatypeType :: 
  ...
  $Is(n#0, Tclass._module.Nat()) ==> _module.__default.f#requires(n#0) == true);

procedure {:verboseName "f (well-formedness)"} CheckWellformed$$_module.__default.f(n#0: DatatypeType where $Is(n#0, Tclass._module.Nat()));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "M (correctness)"} Impl$$_module.__default.M() returns ($_reverifyPost: bool)
{
  ...
  var ##n#1: DatatypeType;
    ...
    $_reverifyPost := false;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/triggers/constructors-cause-matching-loops.dfy(10,3)
    // Begin Comprehension WF check
    havoc s#0;
    if ($Is(s#0, Tclass._module.Nat()) && $IsAlloc(s#0, Tclass._module.Nat(), $Heap))
    {
        if (!Lit(true))
        {
            ##n#0 := #_module.Nat.Succ(s#0);
            // assume allocatedness for argument to function
            assume $IsAlloc(##n#0, Tclass._module.Nat(), $Heap);
            assume _module.__default.f#canCall(#_module.Nat.Succ(s#0));
            ##n#1 := s#0;
            // assume allocatedness for argument to function
    ...
    assume (forall s#1: DatatypeType :: 
      { #_module.Nat.Succ(s#1) } 
      $Is(s#1, Tclass._module.Nat())
         ==> 
        !Lit(true)
         ==> $IsA#_module.Nat(_module.__default.f(#_module.Nat.Succ(s#1)))
           && $IsA#_module.Nat(_module.__default.f(s#1))
           && 
          _module.__default.f#canCall(#_module.Nat.Succ(s#1))
           && _module.__default.f#canCall(s#1));
    assert {:id "id0"} (forall s#1: DatatypeType :: 
      { #_module.Nat.Succ(s#1) } 
      $Is(s#1, Tclass._module.Nat())
         ==> true
           || _module.Nat#Equal(_module.__default.f(#_module.Nat.Succ(s#1)), _module.__default.f(s#1)));
}
...
// Destructor $IsAlloc
axiom (forall d: DatatypeType, $h: Heap :: 
  { $IsAlloc(_module.Nat.x(d), Tclass._module.Nat(), $h) } 
  $IsGoodHeap($h)
       && 
      _module.Nat.Succ_q(d)
...
function _module.Nat.x(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#8#0#0: DatatypeType :: 
  { #_module.Nat.Succ(a#8#0#0) } 
  _module.Nat.x(#_module.Nat.Succ(a#8#0#0)) == a#8#0#0);
...
axiom (forall a: DatatypeType, b: DatatypeType :: 
  ...
  _module.Nat.Succ_q(a) && _module.Nat.Succ_q(b)
     ==> (_module.Nat#Equal(a, b)
       <==> _module.Nat#Equal(_module.Nat.x(a), _module.Nat.x(b))));
