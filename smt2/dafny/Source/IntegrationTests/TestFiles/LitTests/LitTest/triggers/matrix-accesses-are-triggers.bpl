// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/triggers/matrix-accesses-are-triggers.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/triggers/matrix-accesses-are-triggers-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/triggers/matrix-accesses-are-triggers.dfy
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "M (well-formedness)"} CheckWellFormed$$_module.__default.M(m#0: ref)
{
  ...
  var j#0: int;
    ...
    if (*)
    {
        ...
        assert {:id "id8"} 0 <= j#0 && j#0 < _System.array2.Length0(m#0);
        assert {:id "id9"} 0 <= i#0 + 1 && i#0 + 1 < _System.array2.Length1(m#0);
        assume {:id "id10"} $Unbox(read($Heap, m#0, MultiIndexField(IndexField(i#0), j#0))): int
           == $Unbox(read($Heap, m#0, MultiIndexField(IndexField(j#0), i#0 + 1))): int;
    }
    else
    {
        assume {:id "id11"} LitInt(0) <= i#0
    ...
    assume {:id "id12"} (forall i#1: int, j#1: int, _t#0#0: int :: 
      { $Unbox(read($Heap, m#0, MultiIndexField(IndexField(j#1), _t#0#0))): int, $Unbox(read($Heap, m#0, MultiIndexField(IndexField(i#1), j#1))): int } 
      _t#0#0 == i#1 + 1
           && 
          LitInt(0) <= i#1
         ...
         ==> $Unbox(read($Heap, m#0, MultiIndexField(IndexField(i#1), j#1))): int
           == $Unbox(read($Heap, m#0, MultiIndexField(IndexField(j#1), _t#0#0))): int);
    havoc $Heap;
    assume (forall $o: ref :: 
      { $Heap[$o] } 
...
procedure {:verboseName "M (call)"} Call$$_module.__default.M(m#0: ref
  ...
  requires {:id "id13"} (forall i#1: int, j#1: int, _t#0#0: int :: 
    { $Unbox(read($Heap, m#0, MultiIndexField(IndexField(j#1), _t#0#0))): int, $Unbox(read($Heap, m#0, MultiIndexField(IndexField(i#1), j#1))): int } 
    _t#0#0 == i#1 + 1
         && 
        LitInt(0) <= i#1
...
procedure {:verboseName "M (correctness)"} Impl$$_module.__default.M(m#0: ref
  ...
  free requires 0 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id14"} (forall i#1: int, j#1: int, _t#0#0: int :: 
    { $Unbox(read($Heap, m#0, MultiIndexField(IndexField(j#1), _t#0#0))): int, $Unbox(read($Heap, m#0, MultiIndexField(IndexField(i#1), j#1))): int } 
    _t#0#0 == i#1 + 1
         && 
        LitInt(0) <= i#1
