...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (forall ((|y#1| Int) ) (!  (and (> |y#1| 0) (< |y#1| 0))
 :qid |splittingtriggersyieldsbetterpreconditionrelatederrorsdfy.7:19|
 :skolemid |481|
)))))
