...
(let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (exists ((|z#3| Int) ) (<= |z#3| (LitInt 3)))) (=> (exists ((|z#3@@0| Int) ) (<= |z#3@@0| (LitInt 3))) (=> (= (ControlFlow 0 3) (- 0 2)) (U_2_bool (Lit boolType (bool_2_U true))))))))
(let ((anon5_Then_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (exists ((|z#1| Int) ) (<= |z#1| (LitInt 3)))) (=> (exists ((|z#1@@0| Int) ) (<= |z#1@@0| (LitInt 3))) (and (=> (= (ControlFlow 0 6) 3) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct))))))
