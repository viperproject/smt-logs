...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let (($generated@@88  (=> (and (= $generated@@80 ($generated@@24 $generated@@81 $generated@@82 $generated@@83 false)) (= (ControlFlow 0 2) (- 0 1))) (and (<= 0 $generated@@84) (< $generated@@84 256)))))
(let (($generated@@89  (=> (and (and (and ($generated@@85 $generated@@82) ($generated@@86 $generated@@82)) (= 1 $generated@@87)) (and (< $generated@@84 256) (= (ControlFlow 0 3) 2))) $generated@@88)))
$generated@@89)))
))
(check-sat)
