...
(set-info :boogie-vc-id Impl$$_module.__default.GcdSubtractAlt_split16)
...
(assert (not
 ...
 :qid |gcddfy.245:9|
 :skolemid |670|
)))) (<= (LitInt 1) |b#2_0@0|)) (and (= (Mul |q#2_0@0| |b#2_0@0|) (- |y#0@@3| |x#0@@10|)) ($IsAlloc intType (int_2_U |q#2_0@0|) Tclass._module.pos $Heap@4))) (and (and ($IsAlloc intType (int_2_U |y#0@@3|) Tclass._module.pos $Heap@4) (|_module.__default.IsFactor#canCall| |q#2_0@0| |y#0@@3|)) (and (|_module.__default.IsFactor#canCall| |q#2_0@0| |y#0@@3|) (_module.__default.IsFactor |q#2_0@0| |y#0@@3|)))) (and (and (and ($IsAlloc intType (int_2_U |x#0@@10|) Tclass._module.pos $Heap@4) (|_module.__default.Factors#canCall| |x#0@@10|)) (and ($IsAlloc intType (int_2_U |y#0@@3|) Tclass._module.pos $Heap@4) (|_module.__default.Factors#canCall| |y#0@@3|))) (and (and (|_module.__default.Factors#canCall| |x#0@@10|) (|_module.__default.Factors#canCall| |y#0@@3|)) (and (|Set#IsMember| (|Set#Intersection| (_module.__default.Factors |x#0@@10|) (_module.__default.Factors |y#0@@3|)) ($Box intType (int_2_U |q#2_0@0|))) (= (ControlFlow 0 2) (- 0 1)))))) (<= |q#2_0@0| |p#0@0|))))
