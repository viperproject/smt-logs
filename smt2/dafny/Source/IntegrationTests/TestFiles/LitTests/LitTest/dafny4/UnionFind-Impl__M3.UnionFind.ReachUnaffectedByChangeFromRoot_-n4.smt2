...
(set-info :boogie-vc-id Impl$$M3.UnionFind.ReachUnaffectedByChangeFromRoot_k)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#d0#0| Int) (|$ih#e0#0| T@U) (|$ih#r0#0| T@U) (|$ih#C0#0| T@U) ) (!  (=> (and (and (and (and (and (<= (LitInt 0) |$ih#d0#0|) ($Is refType |$ih#e0#0| Tclass.M3.Element)) ($Is refType |$ih#r0#0| Tclass.M3.Element)) ($Is MapType |$ih#C0#0| (TMap Tclass.M3.Element Tclass.M3.Contents))) (and (and (and (and (and (M3.__default.GoodCMap |$ih#C0#0|) (and (|Set#IsMember| (|Map#Domain| |$ih#C0#0|) ($Box refType |$ih#e0#0|)) (M3.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#d0#0| |$ih#e0#0| |$ih#r0#0| |$ih#C0#0|))) (and (and (and (and (and (|Set#IsMember| (|Map#Domain| |$ih#C0#0|) ($Box refType |r0#0|)) (|Set#IsMember| (|Map#Domain| |$ih#C0#0|) ($Box refType |r1#0|))) (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |$ih#C0#0|) ($Box refType |r0#0|))))) (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |$ih#C0#0|) ($Box refType |r1#0|))))) (= (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |$ih#C0#0|) ($Box refType |r0#0|)))) (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |$ih#C0#0|) ($Box refType |r1#0|)))))) (or (not (= |r0#0| |r1#0|)) (not true)))) (and (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |$ih#C0#0|) ($Box refType |r0#0|)))) (|Map#Equal| |C'#0| (|Map#Build| (|Map#Build| |$ih#C0#0| ($Box refType |r0#0|) ($Box DatatypeTypeType (|#M3.Contents.Link| |r1#0|))) ($Box refType |r1#0|) ($Box DatatypeTypeType (|#M3.Contents.Root| (+ (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |$ih#C0#0|) ($Box refType |r1#0|)))) 1))))))) (and (M3.UnionFind.Reaches ($LS $LZ) this@@3 |td#0| |r0#0| |r0#0| |$ih#C0#0|) (or (not (= |r0#0| |$ih#r0#0|)) (not true)))) (M3.__default.GoodCMap |C'#0|))) (or (and (<= 0 |$ih#d0#0|) (< |$ih#d0#0| |d#0@@3|)) (and (= |$ih#d0#0| |d#0@@3|) (or (and (= |$ih#e0#0| null) (or (not (= |e#0@@3| null)) (not true))) (and (=  (or (not (= |$ih#e0#0| null)) (not true))  (or (not (= |e#0@@3| null)) (not true))) (or (and (= |$ih#r0#0| null) (or (not (= |r#0@@3| null)) (not true))) (and (=  (or (not (= |$ih#r0#0| null)) (not true))  (or (not (= |r#0@@3| null)) (not true))) (or (and (|Set#Subset| (|Map#Domain| |$ih#C0#0|) (|Map#Domain| |C#0@@5|)) (not (|Set#Subset| (|Map#Domain| |C#0@@5|) (|Map#Domain| |$ih#C0#0|)))) (and (|Set#Equal| (|Map#Domain| |$ih#C0#0|) (|Map#Domain| |C#0@@5|)) (or (and (<= 0 |td#0|) (< |td#0| |td#0|)) (and (= |td#0| |td#0|) (or (and (= |r0#0| null) (or (not (= |r0#0| null)) (not true))) (and (=  (or (not (= |r0#0| null)) (not true))  (or (not (= |r0#0| null)) (not true))) (or (and (= |r1#0| null) (or (not (= |r1#0| null)) (not true))) (and (=  (or (not (= |r1#0| null)) (not true))  (or (not (= |r1#0| null)) (not true))) (and (|Set#Subset| (|Map#Domain| |C'#0|) (|Map#Domain| |C'#0|)) (not (|Set#Subset| (|Map#Domain| |C'#0|) (|Map#Domain| |C'#0|))))))))))))))))))) (M3.UnionFind.Reaches ($LS $LZ) this@@3 (+ |$ih#d0#0| 1) |$ih#e0#0| |$ih#r0#0| |C'#0|))
 :qid |UnionFinddfy.267:101|
 :skolemid |3074|
)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|M3.UnionFind.Reaches#canCall| this@@3 (+ |d#0@@3| 1) |e#0@@3| |r#0@@3| |C'#0|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 (+ |d#0@@3| 1) |e#0@@3| |r#0@@3| |C'#0|) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |e#0@@3|)))) (= |e#0@@3| |r#0@@3|))))) (=> (=> (|M3.UnionFind.Reaches#canCall| this@@3 (+ |d#0@@3| 1) |e#0@@3| |r#0@@3| |C'#0|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 (+ |d#0@@3| 1) |e#0@@3| |r#0@@3| |C'#0|) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |e#0@@3|)))) (= |e#0@@3| |r#0@@3|)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|M3.UnionFind.Reaches#canCall| this@@3 (+ |d#0@@3| 1) |e#0@@3| |r#0@@3| |C'#0|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 (+ |d#0@@3| 1) |e#0@@3| |r#0@@3| |C'#0|) (=> (not (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |e#0@@3|))))) (or (not (= (+ |d#0@@3| 1) 0)) (not true)))))) (=> (=> (|M3.UnionFind.Reaches#canCall| this@@3 (+ |d#0@@3| 1) |e#0@@3| |r#0@@3| |C'#0|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 (+ |d#0@@3| 1) |e#0@@3| |r#0@@3| |C'#0|) (=> (not (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |e#0@@3|))))) (or (not (= (+ |d#0@@3| 1) 0)) (not true))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|M3.UnionFind.Reaches#canCall| this@@3 (+ |d#0@@3| 1) |e#0@@3| |r#0@@3| |C'#0|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 (+ |d#0@@3| 1) |e#0@@3| |r#0@@3| |C'#0|) (=> (not (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |e#0@@3|))))) (let ((|next#10| (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |e#0@@3|))))))
(M3.UnionFind.Reaches ($LS ($LS $LZ)) this@@3 (- (+ |d#0@@3| 1) 1) |next#10| |r#0@@3| |C'#0|))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.M3.UnionFind) ($IsAlloc refType this@@3 Tclass.M3.UnionFind $Heap))) (<= (LitInt 0) |d#0@@3|)) (=> (and (and (and ($Is refType |e#0@@3| Tclass.M3.Element) ($IsAlloc refType |e#0@@3| Tclass.M3.Element $Heap)) (and ($Is refType |r#0@@3| Tclass.M3.Element) ($IsAlloc refType |r#0@@3| Tclass.M3.Element $Heap))) (and (and ($Is MapType |C#0@@5| (TMap Tclass.M3.Element Tclass.M3.Contents)) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap)) (<= (LitInt 0) |td#0|))) (=> (and (and (and (and (and ($Is refType |r0#0| Tclass.M3.Element) ($IsAlloc refType |r0#0| Tclass.M3.Element $Heap)) (and ($Is refType |r1#0| Tclass.M3.Element) ($IsAlloc refType |r1#0| Tclass.M3.Element $Heap))) (and (and ($Is MapType |C'#0| (TMap Tclass.M3.Element Tclass.M3.Contents)) ($IsAlloc MapType |C'#0| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap)) (= 5 $FunctionContextHeight))) (and (and (and (|M3.__default.GoodCMap#canCall| |C#0@@5|) (and (M3.__default.GoodCMap |C#0@@5|) (forall ((|f#5| T@U) ) (!  (=> ($Is refType |f#5| Tclass.M3.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |f#5|)) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#5|))))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#5|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |3071|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#5|))))
)))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|))) (and (|M3.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|) (and (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|) (ite (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|)))) (= |e#0@@3| |r#0@@3|) (let ((|next#7| (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|))))))
 (and (or (not (= |d#0@@3| 0)) (not true)) (M3.UnionFind.Reaches ($LS $LZ) this@@3 (- |d#0@@3| 1) |next#7| |r#0@@3| |C#0@@5|)))))))) (and (and (and (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r1#0|))) (and (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|)))) (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|)))))) (and (and (= (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|)))) (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|))))) (or (not (= |r0#0| |r1#0|)) (not true))) (and (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|)))) (|Map#Equal| |C'#0| (|Map#Build| (|Map#Build| |C#0@@5| ($Box refType |r0#0|) ($Box DatatypeTypeType (|#M3.Contents.Link| |r1#0|))) ($Box refType |r1#0|) ($Box DatatypeTypeType (|#M3.Contents.Root| (+ (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|)))) 1)))))))) (and (and (and (|M3.UnionFind.Reaches#canCall| this@@3 |td#0| |r0#0| |r0#0| |C#0@@5|) (and (M3.UnionFind.Reaches ($LS $LZ) this@@3 |td#0| |r0#0| |r0#0| |C#0@@5|) (ite (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|)))) (= |r0#0| |r0#0|) (let ((|next#9| (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|))))))
 (and (or (not (= |td#0| 0)) (not true)) (M3.UnionFind.Reaches ($LS $LZ) this@@3 (- |td#0| 1) |next#9| |r0#0| |C#0@@5|)))))) (or (not (= |r0#0| |r#0@@3|)) (not true))) (and (and (|M3.__default.GoodCMap#canCall| |C'#0|) (and (M3.__default.GoodCMap |C'#0|) (forall ((|f#6| T@U) ) (!  (=> ($Is refType |f#6| Tclass.M3.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |f#6|)) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#6|))))) (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#6|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |3073|
