...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@0 T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.__default.nats#canCall| (LitInt |n#0@@0|)) (and (< 1 $FunctionContextHeight) (<= (LitInt 0) |n#0@@0|))) (and (=> (or (not (= (LitInt |n#0@@0|) (LitInt 0))) (not true)) (|_module.__default.nats#canCall| (LitInt (- |n#0@@0| 1)))) (= (_module.__default.nats ($LS $ly@@0) (LitInt |n#0@@0|)) (ite (= (LitInt |n#0@@0|) (LitInt 0)) |#_module.List.Nil| (|#_module.List.Cons| ($Box intType (int_2_U (LitInt (- |n#0@@0| 1)))) (Lit DatatypeTypeType (_module.__default.nats ($LS $ly@@0) (LitInt (- |n#0@@0| 1)))))))))
 :qid |ACL2extractordfy.47:16|
 :weight 3
 :skolemid |577|
 :pattern ( (_module.__default.nats ($LS $ly@@0) (LitInt |n#0@@0|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@1 T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.__default.nats#canCall| |n#0@@1|) (and (< 1 $FunctionContextHeight) (<= (LitInt 0) |n#0@@1|))) ($Is DatatypeTypeType (_module.__default.nats $ly@@1 |n#0@@1|) (Tclass._module.List TInt)))
 :qid |ACL2extractordfy.47:16|
 :skolemid |574|
 :pattern ( (_module.__default.nats $ly@@1 |n#0@@1|))
))))
...
(assert (forall (($ly@@2 T@U) (|n#0@@2| Int) ) (! (= (_module.__default.nats ($LS $ly@@2) |n#0@@2|) (_module.__default.nats $ly@@2 |n#0@@2|))
 :qid |ACL2extractordfy.47:16|
 :skolemid |572|
 :pattern ( (_module.__default.nats ($LS $ly@@2) |n#0@@2|))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.nats)
