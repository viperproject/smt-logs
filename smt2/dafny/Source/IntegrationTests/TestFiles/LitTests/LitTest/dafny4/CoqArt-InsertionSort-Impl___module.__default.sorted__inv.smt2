...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@0 T@U) (|l#0@@0| T@U) ) (!  (=> (or (|_module.__default.sorted#canCall| (Lit DatatypeTypeType |l#0@@0|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |l#0@@0| (Tclass._module.List TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |l#0@@0|)))))) (let ((|rest#3| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |l#0@@0|)))))
(let ((|x#3| (LitInt (U_2_int ($Unbox intType (_module.List.head (Lit DatatypeTypeType |l#0@@0|)))))))
 (=> (not (_module.List.Nil_q |rest#3|)) (let ((|y#3| (U_2_int ($Unbox intType (_module.List.head |rest#3|)))))
 (=> (<= |x#3| |y#3|) (|_module.__default.sorted#canCall| |rest#3|))))))) (= (_module.__default.sorted ($LS $ly@@0) (Lit DatatypeTypeType |l#0@@0|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |l#0@@0|)) true (let ((|rest#2| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |l#0@@0|)))))
(let ((|x#2| (LitInt (U_2_int ($Unbox intType (_module.List.head (Lit DatatypeTypeType |l#0@@0|)))))))
(ite (_module.List.Nil_q |rest#2|) true (let ((|y#2| (LitInt (U_2_int ($Unbox intType (_module.List.head |rest#2|))))))
 ...
 :weight 3
 :skolemid |536|
 :pattern ( (_module.__default.sorted ($LS $ly@@0) (Lit DatatypeTypeType |l#0@@0|)))
))))
...
(assert (forall (($ly@@1 T@U) (|l#0@@1| T@U) ) (! (= (_module.__default.sorted ($LS $ly@@1) |l#0@@1|) (_module.__default.sorted $ly@@1 |l#0@@1|))
 :qid |CoqArtInsertionSortdfy.8:17|
 :skolemid |528|
 :pattern ( (_module.__default.sorted ($LS $ly@@1) |l#0@@1|))
)))
...
(declare-fun |z#0| () Int)
(set-info :boogie-vc-id Impl$$_module.__default.sorted__inv)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (=> (|_module.__default.sorted#canCall| |l#0@@3|) (or (_module.__default.sorted ($LS $LZ) |l#0@@3|) (=> (_module.List.Nil_q |l#0@@3|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (|_module.__default.sorted#canCall| |l#0@@3|) (or (_module.__default.sorted ($LS $LZ) |l#0@@3|) (=> (_module.List.Nil_q |l#0@@3|) (U_2_bool (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (=> (|_module.__default.sorted#canCall| |l#0@@3|) (or (_module.__default.sorted ($LS $LZ) |l#0@@3|) (=> (not (_module.List.Nil_q |l#0@@3|)) (let ((|rest#6| (_module.List.tail |l#0@@3|)))
 (=> (_module.List.Nil_q |rest#6|) (U_2_bool (Lit boolType (bool_2_U true))))))))) (=> (=> (|_module.__default.sorted#canCall| |l#0@@3|) (or (_module.__default.sorted ($LS $LZ) |l#0@@3|) (=> (not (_module.List.Nil_q |l#0@@3|)) (let ((|rest#6@@0| (_module.List.tail |l#0@@3|)))
 (=> (_module.List.Nil_q |rest#6@@0|) (U_2_bool (Lit boolType (bool_2_U true)))))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> (|_module.__default.sorted#canCall| |l#0@@3|) (or (_module.__default.sorted ($LS $LZ) |l#0@@3|) (=> (not (_module.List.Nil_q |l#0@@3|)) (let ((|rest#6@@1| (_module.List.tail |l#0@@3|)))
(let ((|x#6| (U_2_int ($Unbox intType (_module.List.head |l#0@@3|)))))
 (=> (not (_module.List.Nil_q |rest#6@@1|)) (let ((|y#6| (U_2_int ($Unbox intType (_module.List.head |rest#6@@1|)))))
(<= |x#6| |y#6|))))))))) (=> (=> (|_module.__default.sorted#canCall| |l#0@@3|) (or (_module.__default.sorted ($LS $LZ) |l#0@@3|) (=> (not (_module.List.Nil_q |l#0@@3|)) (let ((|rest#6@@2| (_module.List.tail |l#0@@3|)))
(let ((|x#6@@0| (U_2_int ($Unbox intType (_module.List.head |l#0@@3|)))))
 (=> (not (_module.List.Nil_q |rest#6@@2|)) (let ((|y#6@@0| (U_2_int ($Unbox intType (_module.List.head |rest#6@@2|)))))
(<= |x#6@@0| |y#6@@0|)))))))) (=> (= (ControlFlow 0 3) (- 0 2)) (=> (|_module.__default.sorted#canCall| |l#0@@3|) (or (_module.__default.sorted ($LS $LZ) |l#0@@3|) (=> (not (_module.List.Nil_q |l#0@@3|)) (let ((|rest#6@@3| (_module.List.tail |l#0@@3|)))
 (=> (not (_module.List.Nil_q |rest#6@@3|)) (_module.__default.sorted ($LS ($LS $LZ)) |rest#6@@3|)))))))))))))))
(let ((anon5_Then_correct  (=> (= |l#0@@3| (|#_module.List.Cons| ($Box intType (int_2_U |_mcc#0#0_0@0|)) |_mcc#1#0_0@0|)) (=> (and ($Is DatatypeTypeType |_mcc#1#0_0@0| (Tclass._module.List TInt)) (= (ControlFlow 0 8) 3)) GeneratedUnifiedExit_correct))))
(let ((anon4_Then_correct  (=> (and (= |l#0@@3| |#_module.List.Nil|) (= (ControlFlow 0 7) 3)) GeneratedUnifiedExit_correct)))
(let ((anon5_Else_correct true))
(let ((anon4_Else_correct  (=> (or (not (= |l#0@@3| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 9) 8) anon5_Then_correct) (=> (= (ControlFlow 0 9) 1) anon5_Else_correct)))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.List| |l#0@@3|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#l0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#l0#0| (Tclass._module.List TInt)) (_module.__default.sorted ($LS $LZ) (|#_module.List.Cons| ($Box intType (int_2_U |z#0|)) |$ih#l0#0|))) (or (and (<= 0 |z#0|) (< |z#0| |z#0|)) (and (= |z#0| |z#0|) (< (DtRank |$ih#l0#0|) (DtRank |l#0@@3|))))) (_module.__default.sorted ($LS $LZ) |$ih#l0#0|))
 :qid |CoqArtInsertionSortdfy.23:26|
 :skolemid |538|
 :pattern ( (|#_module.List.Cons| ($Box intType (int_2_U |z#0|)) |$ih#l0#0|))
)))) (and (=> (= (ControlFlow 0 10) 7) anon4_Then_correct) (=> (= (ControlFlow 0 10) 9) anon4_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |l#0@@3| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |l#0@@3| (Tclass._module.List TInt) $Heap)) (|$IsA#_module.List| |l#0@@3|)) (= 2 $FunctionContextHeight)) (and (and (|_module.__default.sorted#canCall| (|#_module.List.Cons| ($Box intType (int_2_U |z#0|)) |l#0@@3|)) (and (_module.__default.sorted ($LS $LZ) (|#_module.List.Cons| ($Box intType (int_2_U |z#0|)) |l#0@@3|)) (ite (_module.List.Nil_q (|#_module.List.Cons| ($Box intType (int_2_U |z#0|)) |l#0@@3|)) true (let ((|rest#5| (_module.List.tail (|#_module.List.Cons| ($Box intType (int_2_U |z#0|)) |l#0@@3|))))
(let ((|x#5| (U_2_int ($Unbox intType (_module.List.head (|#_module.List.Cons| ($Box intType (int_2_U |z#0|)) |l#0@@3|))))))
(ite (_module.List.Nil_q |rest#5|) true (let ((|y#5| (U_2_int ($Unbox intType (_module.List.head |rest#5|)))))
 (and (<= |x#5| |y#5|) (_module.__default.sorted ($LS $LZ) |rest#5|))))))))) (= (ControlFlow 0 11) 10))) anon0_correct))))
