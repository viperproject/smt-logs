...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.TestPre)
...
(let ((anon6_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@0 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@0 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 5) 3) anon7_Then_correct) (=> (= (ControlFlow 0 5) 4) anon7_Else_correct)))))
(let ((anon6_Else_correct  (=> (= |##f#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| 1) (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))) (=> (and (and ($IsAlloc HandleTypeType |##f#0@0| (Tclass._System.___hFunc1 TInt TInt) $Heap@@0) (= |##a#0@0| (LitInt 5))) (and ($IsAlloc intType (int_2_U |##a#0@0|) TInt $Heap@@0) (= (ControlFlow 0 2) (- 0 1)))) (Requires1 TInt TInt $Heap@@0 |##f#0@0| ($Box intType (int_2_U |##a#0@0|)))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (and (=> (= (ControlFlow 0 6) 5) anon6_Then_correct) (=> (= (ControlFlow 0 6) 2) anon6_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct)))
