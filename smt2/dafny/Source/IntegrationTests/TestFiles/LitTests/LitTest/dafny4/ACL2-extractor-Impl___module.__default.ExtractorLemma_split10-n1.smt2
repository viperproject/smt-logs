...
(declare-fun |##n#0_2_5@0| () Int)
(declare-fun |##xs#0_2_4@0| () T@U)
(declare-fun |##n#0_2_3@0| () Int)
(set-info :boogie-vc-id Impl$$_module.__default.ExtractorLemma_split10)
