...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#17| |l#0| |l#1| |l#2| |l#3|) $o $f))  (=> (and (or (not (= $o |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o) |l#2|)))) (|Set#IsMember| |l#3| ($Box refType $o))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |554|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#17| |l#0| |l#1| |l#2| |l#3|) $o $f))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (Requires1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U |a#0@@0|)))) (=> (Requires1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U |a#0@@0|))) (=> (and (and (= |b$reqreads#2@0| (forall (($o@@0 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@0) alloc)))) (|Set#IsMember| (Reads1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U |a#0@@0|))) ($Box refType $o@@0))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@0 $f@@0)))
 :qid |Bug49dfy.18:3|
 :skolemid |538|
))) (= (_module.__default.apply $Heap@@0 |f#0@@0| |a#0@@0|) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U |a#0@@0|))))))) (and ($Is intType (int_2_U (_module.__default.apply $Heap@@0 |f#0@@0| |a#0@@0|)) TInt) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#2@0|)))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#17| null $Heap@@0 alloc (Reads1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U |a#0@@0|))))) (=> (and (and ($IsAllocBox ($Box HandleTypeType |f#0@@0|) (Tclass._System.___hFunc1 TInt TInt) $Heap@@0) ($IsAlloc intType (int_2_U |a#0@@0|) TInt $Heap@@0)) (and (= |b$reqreads#0@0| (forall (($o@@1 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@1 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@1) alloc)))) (|Set#IsMember| (Reads1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U |a#0@@0|))) ($Box refType $o@@1))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@1 $f@@1)))
 :qid |Bug49dfy.16:14|
 :skolemid |536|
))) (Requires1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U |a#0@@0|))))) (and (=> (= (ControlFlow 0 5) (- 0 9)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (=> (and ($IsAllocBox ($Box HandleTypeType |f#0@@0|) (Tclass._System.___hFunc1 TInt TInt) $Heap@@0) ($IsAlloc intType (int_2_U |a#0@@0|) TInt $Heap@@0)) (and (=> (= (ControlFlow 0 5) (- 0 8)) (Requires1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U |a#0@@0|)))) (=> (Requires1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U |a#0@@0|))) (=> (= |b$reqreads#1@0| (forall (($o@@2 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@2) alloc)))) (|Set#IsMember| (Reads1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U |a#0@@0|))) ($Box refType $o@@2))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@2 $f@@2)))
 :qid |Bug49dfy.15:11|
 :skolemid |537|
))) (and (=> (= (ControlFlow 0 5) (- 0 7)) |b$reqreads#1@0|) (=> |b$reqreads#1@0| (=> (and ($IsAllocBox ($Box HandleTypeType |f#0@@0|) (Tclass._System.___hFunc1 TInt TInt) $Heap@@0) ($IsAlloc intType (int_2_U |a#0@@0|) TInt $Heap@@0)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (Requires1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U |a#0@@0|)))) (=> (Requires1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U |a#0@@0|))) (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 3) anon5_Else_correct)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) ($Is HandleTypeType |f#0@@0| (Tclass._System.___hFunc1 TInt TInt))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 10) 5))) anon0_correct)))
