...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@0 T@U) ($Heap@@1 T@U) (|f#0@@1| T@U) (|n#0| Int) ) (!  (=> (or (|_module.__default.Iter#canCall| (Lit HandleTypeType |f#0@@1|) (LitInt |n#0|)) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@1) ($Is HandleTypeType |f#0@@1| (Tclass._System.___hTotalFunc1 TInt TInt))))) (and (=> (< (LitInt 0) (LitInt |n#0|)) (|_module.__default.Iter#canCall| (Lit HandleTypeType |f#0@@1|) (LitInt (- |n#0| 1)))) (= (_module.__default.Iter ($LS $ly@@0) (Lit HandleTypeType |f#0@@1|) (LitInt |n#0|)) (ite (<= (LitInt |n#0|) (LitInt 0)) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@1 (Lit HandleTypeType |f#0@@1|) ($Box intType (int_2_U (LitInt 1)))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@1 (Lit HandleTypeType |f#0@@1|) ($Box intType (int_2_U (LitInt (_module.__default.Iter ($LS $ly@@0) (Lit HandleTypeType |f#0@@1|) (LitInt (- |n#0| 1)))))))))))))
 :qid |Ackermanndfy.59:16|
 :weight 3
 :skolemid |566|
 :pattern ( (_module.__default.Iter ($LS $ly@@0) (Lit HandleTypeType |f#0@@1|) (LitInt |n#0|)) ($IsGoodHeap $Heap@@1))
))))
...
(assert (forall ((|#$T0| T@U) (|#$R| T@U) (|f#0@@2| T@U) ($h@@1 T@U) ) (! (= ($IsAlloc HandleTypeType |f#0@@2| (Tclass._System.___hPartialFunc1 |#$T0| |#$R|) $h@@1) ($IsAlloc HandleTypeType |f#0@@2| (Tclass._System.___hFunc1 |#$T0| |#$R|) $h@@1))
 :qid |unknown.0:0|
 :skolemid |403|
 :pattern ( ($IsAlloc HandleTypeType |f#0@@2| (Tclass._System.___hPartialFunc1 |#$T0| |#$R|) $h@@1))
)))
(assert (forall ((|#$T0@@0| T@U) (|#$R@@0| T@U) (|f#0@@3| T@U) ($h@@2 T@U) ) (! (= ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 |#$T0@@0| |#$R@@0|) $h@@2) ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hPartialFunc1 |#$T0@@0| |#$R@@0|) $h@@2))
 :qid |unknown.0:0|
 :skolemid |410|
 :pattern ( ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 |#$T0@@0| |#$R@@0|) $h@@2))
)))
...
(assert (forall (($ly@@1 T@U) (|f#0@@4| T@U) (|n#0@@0| Int) ) (! (= (_module.__default.Iter ($LS $ly@@1) |f#0@@4| |n#0@@0|) (_module.__default.Iter $ly@@1 |f#0@@4| |n#0@@0|))
 :qid |Ackermanndfy.59:16|
 :skolemid |560|
 :pattern ( (_module.__default.Iter ($LS $ly@@1) |f#0@@4| |n#0@@0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@5 T@U) ($Heap@@3 T@U) (|f#0@@8| T@U) (|n#0@@2| Int) ) (!  (=> (or (|_module.__default.Iter#canCall| |f#0@@8| |n#0@@2|) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@3) ($Is HandleTypeType |f#0@@8| (Tclass._System.___hTotalFunc1 TInt TInt))))) (and (=> (< (LitInt 0) |n#0@@2|) (|_module.__default.Iter#canCall| |f#0@@8| (- |n#0@@2| 1))) (= (_module.__default.Iter ($LS $ly@@5) |f#0@@8| |n#0@@2|) (ite (<= |n#0@@2| (LitInt 0)) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@3 |f#0@@8| ($Box intType (int_2_U (LitInt 1)))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@3 |f#0@@8| ($Box intType (int_2_U (_module.__default.Iter $ly@@5 |f#0@@8| (- |n#0@@2| 1)))))))))))
 :qid |Ackermanndfy.59:16|
 :skolemid |564|
 :pattern ( (_module.__default.Iter ($LS $ly@@5) |f#0@@8| |n#0@@2|) ($IsGoodHeap $Heap@@3))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@4 T@U) (|f#0@@9| T@U) ) (!  (=> (or (|_module.__default.FunctionMonotonic#canCall| |f#0@@9|) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@4) ($Is HandleTypeType |f#0@@9| (Tclass._System.___hTotalFunc1 TInt TInt))))) (= (_module.__default.FunctionMonotonic |f#0@@9|) (forall ((|n#0@@3| Int) (|n'#0| Int) ) (!  (=> (<= |n#0@@3| |n'#0|) (<= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@4 |f#0@@9| ($Box intType (int_2_U |n#0@@3|))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@4 |f#0@@9| ($Box intType (int_2_U |n'#0|)))))))
 :qid |Ackermanndfy.113:10|
 :skolemid |583|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@4 |f#0@@9| ($Box intType (int_2_U |n'#0|)))) ($Unbox intType (Apply1 TInt TInt $Heap@@4 |f#0@@9| ($Box intType (int_2_U |n#0@@3|)))))
))))
 :qid |Ackermanndfy.111:17|
 :skolemid |584|
 :pattern ( (_module.__default.FunctionMonotonic |f#0@@9|) ($IsGoodHeap $Heap@@4))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@5 T@U) (|f#0@@10| T@U) ) (!  (=> (or (|_module.__default.Expanding#canCall| |f#0@@10|) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@5) ($Is HandleTypeType |f#0@@10| (Tclass._System.___hTotalFunc1 TInt TInt))))) (= (_module.__default.Expanding |f#0@@10|) (forall ((|n#0@@4| Int) ) (! (< |n#0@@4| (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@5 |f#0@@10| ($Box intType (int_2_U |n#0@@4|))))))
 :qid |Ackermanndfy.119:10|
 :skolemid |591|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@5 |f#0@@10| ($Box intType (int_2_U |n#0@@4|)))))
))))
 :qid |Ackermanndfy.117:17|
 :skolemid |592|
 :pattern ( (_module.__default.Expanding |f#0@@10|) ($IsGoodHeap $Heap@@5))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.Am)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (=> (|_module.__default.FunctionMonotonic#canCall| (_module.__default.A ($LS $LZ) |m#0@@3|)) (or (_module.__default.FunctionMonotonic (_module.__default.A ($LS $LZ) |m#0@@3|)) (forall ((|n#1@@1| Int) (|n'#1@@0| Int) ) (!  (=> (<= |n#1@@1| |n'#1@@0|) (<= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@4 (_module.__default.A ($LS ($LS $LZ)) |m#0@@3|) ($Box intType (int_2_U |n#1@@1|))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@4 (_module.__default.A ($LS ($LS $LZ)) |m#0@@3|) ($Box intType (int_2_U |n'#1@@0|)))))))
 :qid |Ackermanndfy.113:10|
 :skolemid |632|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@4 (_module.__default.A ($LS ($LS $LZ)) |m#0@@3|) ($Box intType (int_2_U |n'#1@@0|)))) ($Unbox intType (Apply1 TInt TInt $Heap@4 (_module.__default.A ($LS ($LS $LZ)) |m#0@@3|) ($Box intType (int_2_U |n#1@@1|)))))
)))))))
(let ((anon6_Else_correct  (=> (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (=> (and (and (= $Heap@1 $Heap@3) (forall ((|n#1_0_1| Int) (|n'#1_0_1| Int) ) (!  (=> (<= |n#1_0_1| |n'#1_0_1|) (<= (_module.__default.Iter ($LS $LZ) (_module.__default.A ($LS $LZ) (- |m#0@@3| 1)) |n#1_0_1|) (_module.__default.Iter ($LS $LZ) (_module.__default.A ($LS $LZ) (- |m#0@@3| 1)) |n'#1_0_1|)))
 :qid |Ackermanndfy.180:12|
 :skolemid |638|
))) (and (= $Heap@4 $Heap@3) (= (ControlFlow 0 8) 6))) GeneratedUnifiedExit_correct))))
(let ((anon5_Then_correct  (=> (<= |m#0@@3| (LitInt 0)) (=> (and (= $Heap@4 $Heap@0) (= (ControlFlow 0 7) 6)) GeneratedUnifiedExit_correct))))
(let ((anon6_Then_correct  (=> (and (<= |n#1_0_0@0| |n'#1_0_0@0|) (= |##m#1_0_0@0| (- |m#0@@3| 1))) (=> (and (and ($IsAlloc intType (int_2_U |##m#1_0_0@0|) TInt $Heap@1) (|_module.__default.A#canCall| (- |m#0@@3| 1))) (and (|_module.__default.A#canCall| (- |m#0@@3| 1)) (= |f##1_0_0@0| (_module.__default.A ($LS $LZ) (- |m#0@@3| 1))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.__default.Expanding#canCall| |f##1_0_0@0|) (or (_module.__default.Expanding |f##1_0_0@0|) (forall ((|n#1@@2| Int) ) (! (< |n#1@@2| (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@1 |f##1_0_0@0| ($Box intType (int_2_U |n#1@@2|))))))
 :qid |Ackermanndfy.119:10|
 :skolemid |597|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@1 |f##1_0_0@0| ($Box intType (int_2_U |n#1@@2|)))))
))))) (=> (=> (|_module.__default.Expanding#canCall| |f##1_0_0@0|) (or (_module.__default.Expanding |f##1_0_0@0|) (forall ((|n#1@@3| T@U) ) (! (< (U_2_int |n#1@@3|) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@1 |f##1_0_0@0| ($Box intType |n#1@@3|)))))
 :qid |Ackermanndfy.119:10|
 :skolemid |597|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@1 |f##1_0_0@0| ($Box intType |n#1@@3|))))
)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.__default.FunctionMonotonic#canCall| |f##1_0_0@0|) (or (_module.__default.FunctionMonotonic |f##1_0_0@0|) (forall ((|n#2| Int) (|n'#1@@1| Int) ) (!  (=> (<= |n#2| |n'#1@@1|) (<= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@1 |f##1_0_0@0| ($Box intType (int_2_U |n#2|))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@1 |f##1_0_0@0| ($Box intType (int_2_U |n'#1@@1|)))))))
 :qid |Ackermanndfy.113:10|
 :skolemid |599|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@1 |f##1_0_0@0| ($Box intType (int_2_U |n'#1@@1|)))) ($Unbox intType (Apply1 TInt TInt $Heap@1 |f##1_0_0@0| ($Box intType (int_2_U |n#2|)))))
))))) (=> (=> (|_module.__default.FunctionMonotonic#canCall| |f##1_0_0@0|) (or (_module.__default.FunctionMonotonic |f##1_0_0@0|) (forall ((|n#2@@0| T@U) (|n'#1@@2| T@U) ) (!  (=> (<= (U_2_int |n#2@@0|) (U_2_int |n'#1@@2|)) (<= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@1 |f##1_0_0@0| ($Box intType |n#2@@0|)))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@1 |f##1_0_0@0| ($Box intType |n'#1@@2|))))))
 :qid |Ackermanndfy.113:10|
 :skolemid |599|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@1 |f##1_0_0@0| ($Box intType |n'#1@@2|))) ($Unbox intType (Apply1 TInt TInt $Heap@1 |f##1_0_0@0| ($Box intType |n#2@@0|))))
)))) (=> (= (ControlFlow 0 2) (- 0 1)) (<= |n#1_0_0@0| |n'#1_0_0@0|))))))))))
(let ((anon5_Else_correct  (=> (and (< (LitInt 0) |m#0@@3|) (= |m##1_0@0| (- |m#0@@3| 1))) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (|_module.__default.A#canCall| |m##1_0@0|) (|_module.__default.Expanding#canCall| (_module.__default.A ($LS $LZ) |m##1_0@0|)))) (and (and (|_module.__default.Expanding#canCall| (_module.__default.A ($LS $LZ) |m##1_0@0|)) (and (_module.__default.Expanding (_module.__default.A ($LS $LZ) |m##1_0@0|)) (forall ((|n#0@@5| T@U) ) (! (< (U_2_int |n#0@@5|) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@1 (_module.__default.A ($LS $LZ) |m##1_0@0|) ($Box intType |n#0@@5|)))))
 :qid |Ackermanndfy.119:10|
 :skolemid |622|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@1 (_module.__default.A ($LS $LZ) |m##1_0@0|) ($Box intType |n#0@@5|))))
)))) (= $Heap@0 $Heap@1))) (and (=> (= (ControlFlow 0 9) 2) anon6_Then_correct) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@6 $Heap@0) (forall ((|$ih#m0#0| Int) ) (!  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) (and (<= 0 |$ih#m0#0|) (< |$ih#m0#0| |m#0@@3|))) (_module.__default.FunctionMonotonic (_module.__default.A ($LS $LZ) |$ih#m0#0|)))
 :qid |Ackermanndfy.171:10|
 :skolemid |635|
 :pattern ( (_module.__default.A ($LS $LZ) |$ih#m0#0|))
)))) (and (=> (= (ControlFlow 0 10) 7) anon5_Then_correct) (=> (= (ControlFlow 0 10) 9) anon5_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct)))
