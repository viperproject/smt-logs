...
(declare-fun M1._default.MapsEqual$D () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id CheckWellFormed$$M1.__default.MapsEqual)
...
(let ((anon5_Else_correct  (=> (and (=> (|Set#IsMember| (|Map#Domain| |m#0|) |d#2@0|) (= (MapType0Select BoxType BoxType (|Map#Elements| |m#0|) |d#2@0|) (MapType0Select BoxType BoxType (|Map#Elements| |n#0|) |d#2@0|))) (= (ControlFlow 0 5) 1)) anon4_correct)))
(let ((anon5_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |m#0|) |d#2@0|) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Set#IsMember| (|Map#Domain| |m#0|) |d#2@0|)) (=> (|Set#IsMember| (|Map#Domain| |m#0|) |d#2@0|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#IsMember| (|Map#Domain| |n#0|) |d#2@0|)) (=> (|Set#IsMember| (|Map#Domain| |n#0|) |d#2@0|) (=> (and (= (MapType0Select BoxType BoxType (|Map#Elements| |m#0|) |d#2@0|) (MapType0Select BoxType BoxType (|Map#Elements| |n#0|) |d#2@0|)) (= (ControlFlow 0 2) 1)) anon4_correct))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and ($IsBox |d#0@0| M1._default.MapsEqual$D) ($IsAllocBox |d#0@0| M1._default.MapsEqual$D $Heap)) (=> (and (and (= (|Set#IsMember| (|Map#Domain| |m#0|) |d#0@0|) (|Set#IsMember| (|Map#Domain| |n#0|) |d#0@0|)) (forall ((|d#1| T@U) ) (!  (=> (and ($IsBox |d#1| M1._default.MapsEqual$D) ($IsAllocBox |d#1| M1._default.MapsEqual$D $Heap)) (= (|Set#IsMember| (|Map#Domain| |m#0|) |d#1|) (|Set#IsMember| (|Map#Domain| |n#0|) |d#1|)))
 :qid |UnionFinddfy.117:21|
 :skolemid |1138|
 :pattern ( (|Set#IsMember| (|Map#Domain| |n#0|) |d#1|))
 :pattern ( (|Set#IsMember| (|Map#Domain| |m#0|) |d#1|))
))) (and ($IsBox |d#2@0| M1._default.MapsEqual$D) ($IsAllocBox |d#2@0| M1._default.MapsEqual$D $Heap))) (and (=> (= (ControlFlow 0 6) 2) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is MapType |m#0| (TMap M1._default.MapsEqual$D M1._default.MapsEqual$D)) ($IsAlloc MapType |m#0| (TMap M1._default.MapsEqual$D M1._default.MapsEqual$D) $Heap))) (and (and ($Is MapType |n#0| (TMap M1._default.MapsEqual$D M1._default.MapsEqual$D)) ($IsAlloc MapType |n#0| (TMap M1._default.MapsEqual$D M1._default.MapsEqual$D) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 7) 6)))) anon0_correct)))
