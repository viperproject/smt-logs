...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.multiset_of$T@@2 T@U) ($ly@@2 T@U) (|xs#0@@2| T@U) ) (!  (=> (and (or (|_module.__default.multiset__of#canCall| _module._default.multiset_of$T@@2 |xs#0@@2|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@2| (Tclass._module.List _module._default.multiset_of$T@@2)) ($IsAlloc DatatypeTypeType |xs#0@@2| (Tclass._module.List _module._default.multiset_of$T@@2) $Heap)))) ($IsGoodHeap $Heap)) ($IsAlloc MultiSetType (_module.__default.multiset__of _module._default.multiset_of$T@@2 $ly@@2 |xs#0@@2|) (TMultiSet _module._default.multiset_of$T@@2) $Heap))
 :qid |GHCMergeSortdfy.31:16|
 :skolemid |602|
 :pattern ( ($IsAlloc MultiSetType (_module.__default.multiset__of _module._default.multiset_of$T@@2 $ly@@2 |xs#0@@2|) (TMultiSet _module._default.multiset_of$T@@2) $Heap))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.multiset_of$T@@3 T@U) ($ly@@3 T@U) (|xs#0@@3| T@U) ) (!  (=> (or (|_module.__default.multiset__of#canCall| _module._default.multiset_of$T@@3 |xs#0@@3|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@3| (Tclass._module.List _module._default.multiset_of$T@@3)))) ($Is MultiSetType (_module.__default.multiset__of _module._default.multiset_of$T@@3 $ly@@3 |xs#0@@3|) (TMultiSet _module._default.multiset_of$T@@3)))
 :qid |unknown.0:0|
 :skolemid |601|
 :pattern ( (_module.__default.multiset__of _module._default.multiset_of$T@@3 $ly@@3 |xs#0@@3|))
))))
...
(declare-fun _module._default.multiset_of$T@@4 () T@U)
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.multiset__of)
...
(let ((anon10_Then_correct  (=> (= |xs#0@@4| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) (=> (and ($IsBox |_mcc#0#0| _module._default.multiset_of$T@@4) ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List _module._default.multiset_of$T@@4))) (=> (and (and (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List _module._default.multiset_of$T@@4))) (and (= |ys#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|))) (and (and ($IsBox |let#1#0#0| _module._default.multiset_of$T@@4) (= |a#Z#0@0| |let#1#0#0|)) (and ($IsAlloc DatatypeTypeType |ys#Z#0@0| (Tclass._module.List _module._default.multiset_of$T@@4) $Heap@@0) (= (ControlFlow 0 4) (- 0 3))))) (< (DtRank |ys#Z#0@0|) (DtRank |xs#0@@4|)))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) ($Is DatatypeTypeType |xs#0@@4| (Tclass._module.List _module._default.multiset_of$T@@4))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct)))
