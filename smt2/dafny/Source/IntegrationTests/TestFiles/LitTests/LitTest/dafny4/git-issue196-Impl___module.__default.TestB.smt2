...
(assert (forall ((_System.array2$arg@@2 T@U) ($o@@2 T@U) ($h@@4 T@U) ) (! (= ($IsAlloc refType $o@@2 (Tclass._System.array2? _System.array2$arg@@2) $h@@4)  (or (= $o@@2 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@2) alloc)))))
 :qid |unknown.0:0|
 :skolemid |487|
 :pattern ( ($IsAlloc refType $o@@2 (Tclass._System.array2? _System.array2$arg@@2) $h@@4))
)))
(assert (forall ((_System.array3$arg@@0 T@U) ($o@@3 T@U) ($h@@5 T@U) ) (! (= ($IsAlloc refType $o@@3 (Tclass._System.array3? _System.array3$arg@@0) $h@@5)  (or (= $o@@3 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@3) alloc)))))
 :qid |unknown.0:0|
 :skolemid |555|
 :pattern ( ($IsAlloc refType $o@@3 (Tclass._System.array3? _System.array3$arg@@0) $h@@5))
)))
(assert (forall ((_System.array4$arg@@0 T@U) ($o@@4 T@U) ($h@@6 T@U) ) (! (= ($IsAlloc refType $o@@4 (Tclass._System.array4? _System.array4$arg@@0) $h@@6)  (or (= $o@@4 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@4) alloc)))))
 :qid |unknown.0:0|
 :skolemid |630|
 :pattern ( ($IsAlloc refType $o@@4 (Tclass._System.array4? _System.array4$arg@@0) $h@@6))
)))
...
(assert (forall ((_System.array3$arg@@4 T@U) ($o@@7 T@U) ) (! (= ($Is refType $o@@7 (Tclass._System.array3? _System.array3$arg@@4))  (or (= $o@@7 null) (= (dtype $o@@7) (Tclass._System.array3? _System.array3$arg@@4))))
 :qid |unknown.0:0|
 :skolemid |554|
 :pattern ( ($Is refType $o@@7 (Tclass._System.array3? _System.array3$arg@@4)))
)))
(assert (forall ((_System.array4$arg@@4 T@U) ($o@@8 T@U) ) (! (= ($Is refType $o@@8 (Tclass._System.array4? _System.array4$arg@@4))  (or (= $o@@8 null) (= (dtype $o@@8) (Tclass._System.array4? _System.array4$arg@@4))))
 :qid |unknown.0:0|
 :skolemid |629|
 :pattern ( ($Is refType $o@@8 (Tclass._System.array4? _System.array4$arg@@4)))
)))
...
(assert (forall ((_System.array2$arg@@9 T@U) ($h@@7 T@U) ($o@@9 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@7) (and (or (not (= $o@@9 null)) (not true)) (= (dtype $o@@9) (Tclass._System.array2? _System.array2$arg@@9)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@9) alloc)))) ($IsAlloc intType (int_2_U (_System.array2.Length0 $o@@9)) TInt $h@@7))
 :qid |unknown.0:0|
 :skolemid |489|
 :pattern ( (_System.array2.Length0 $o@@9) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@9) alloc)) (Tclass._System.array2? _System.array2$arg@@9))
)))
(assert (forall ((_System.array2$arg@@10 T@U) ($h@@8 T@U) ($o@@10 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@8) (and (or (not (= $o@@10 null)) (not true)) (= (dtype $o@@10) (Tclass._System.array2? _System.array2$arg@@10)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@10) alloc)))) ($IsAlloc intType (int_2_U (_System.array2.Length1 $o@@10)) TInt $h@@8))
 :qid |unknown.0:0|
 :skolemid |491|
 :pattern ( (_System.array2.Length1 $o@@10) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@10) alloc)) (Tclass._System.array2? _System.array2$arg@@10))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.TestB)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 11)) (<= 0 (LitInt 2))) (=> (<= 0 (LitInt 2)) (and (=> (= (ControlFlow 0 2) (- 0 10)) (<= 0 (LitInt 3))) (=> (<= 0 (LitInt 3)) (=> (and (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array2? TInt))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc)))) (= (_System.array2.Length0 $nw@0) (LitInt 2)))) (and (and (= (_System.array2.Length1 $nw@0) (LitInt 3)) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (<= 0 (LitInt 2))) (=> (<= 0 (LitInt 2)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (<= 0 (LitInt 3))) (=> (<= 0 (LitInt 3)) (=> (and (and (and (or (not (= $nw@1 null)) (not true)) ($Is refType $nw@1 (Tclass._System.array2? (Tclass._System.array TInt)))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1) alloc)))) (= (_System.array2.Length0 $nw@1) (LitInt 2)))) (and (and (= (_System.array2.Length1 $nw@1) (LitInt 3)) (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (<= 0 (LitInt 2))) (=> (<= 0 (LitInt 2)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (<= 0 (LitInt 3))) (=> (<= 0 (LitInt 3)) (=> (and (and (and (or (not (= $nw@2 null)) (not true)) ($Is refType $nw@2 (Tclass._System.array2? (Tclass._System.array (Tclass._System.array2 TInt))))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@2) alloc)))) (= (_System.array2.Length0 $nw@2) (LitInt 2)))) (and (and (= (_System.array2.Length1 $nw@2) (LitInt 3)) (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 $nw@2 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@2) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (<= 0 (LitInt 2))) (=> (<= 0 (LitInt 2)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= 0 (LitInt 3))) (=> (<= 0 (LitInt 3)) (=> (and (and (and (or (not (= $nw@3 null)) (not true)) ($Is refType $nw@3 (Tclass._System.array2? (Tclass._System.array2 (Tclass._System.array TInt))))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@3) alloc)))) (= (_System.array2.Length0 $nw@3) (LitInt 2)))) (and (and (= (_System.array2.Length1 $nw@3) (LitInt 3)) (= $Heap@3 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@2 $nw@3 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@3) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= 0 (LitInt 2))) (=> (<= 0 (LitInt 2)) (=> (= (ControlFlow 0 2) (- 0 1)) (<= 0 (LitInt 3))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array2 TInt)) ($IsAlloc refType |a#0| (Tclass._System.array2 TInt) $Heap)) true) (and (and ($Is refType |b#0| (Tclass._System.array2 (Tclass._System.array TInt))) ($IsAlloc refType |b#0| (Tclass._System.array2 (Tclass._System.array TInt)) $Heap)) true)) (=> (and (and (and (and ($Is refType |c#0@@7| (Tclass._System.array2 (Tclass._System.array (Tclass._System.array2 TInt)))) ($IsAlloc refType |c#0@@7| (Tclass._System.array2 (Tclass._System.array (Tclass._System.array2 TInt))) $Heap)) true) (and (and ($Is refType |d#0| (Tclass._System.array2 (Tclass._System.array2 (Tclass._System.array TInt)))) ($IsAlloc refType |d#0| (Tclass._System.array2 (Tclass._System.array2 (Tclass._System.array TInt))) $Heap)) true)) (and (and (and ($Is refType |e#0| (Tclass._System.array2 (Tclass._System.array4 (Tclass._System.array3 TInt)))) ($IsAlloc refType |e#0| (Tclass._System.array2 (Tclass._System.array4 (Tclass._System.array3 TInt))) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 12) 2)))) anon0_correct)))))
