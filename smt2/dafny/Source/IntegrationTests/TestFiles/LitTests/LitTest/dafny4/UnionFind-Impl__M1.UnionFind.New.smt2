...
(assert (forall ((a@@4 T@U) (b@@1 T@U) ) (!  (=> (and (M1.Contents.Root_q a@@4) (M1.Contents.Root_q b@@1)) (= (|M1.Contents#Equal| a@@4 b@@1) (= (M1.Contents.depth a@@4) (M1.Contents.depth b@@1))))
 :qid |unknown.0:0|
 :skolemid |1164|
 :pattern ( (|M1.Contents#Equal| a@@4 b@@1) (M1.Contents.Root_q a@@4))
 :pattern ( (|M1.Contents#Equal| a@@4 b@@1) (M1.Contents.Root_q b@@1))
)))
(assert (forall ((a@@5 T@U) (b@@2 T@U) ) (!  (=> (and (M1.Contents.Link_q a@@5) (M1.Contents.Link_q b@@2)) (= (|M1.Contents#Equal| a@@5 b@@2) (= (M1.Contents.next a@@5) (M1.Contents.next b@@2))))
 :qid |unknown.0:0|
 :skolemid |1165|
 :pattern ( (|M1.Contents#Equal| a@@5 b@@2) (M1.Contents.Link_q a@@5))
 :pattern ( (|M1.Contents#Equal| a@@5 b@@2) (M1.Contents.Link_q b@@2))
)))
...
(assert (forall ((a@@11 T@U) (b@@8 T@U) ) (! (= (|M1.Contents#Equal| a@@11 b@@8) (= a@@11 b@@8))
 :qid |unknown.0:0|
 :skolemid |1166|
 :pattern ( (|M1.Contents#Equal| a@@11 b@@8))
)))
...
(assert (forall ((|l#0@@0| T@U) (|l#1@@0| T@U) (|$w#0@@0| T@U) ) (! (= (MapType0Select BoxType BoxType (|lambda#5| |l#0@@0| |l#1@@0|) |$w#0@@0|) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#0@@0| ($Unbox refType |$w#0@@0|)) |l#1@@0|))
 :qid |UnionFinddfy.63:43|
 :skolemid |4519|
 :pattern ( (MapType0Select BoxType BoxType (|lambda#5| |l#0@@0| |l#1@@0|) |$w#0@@0|))
)))
...
(assert (forall ((|l#0@@1| T@U) (|l#1@@1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@14 T@U) ($f@@2 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#14| |l#0@@1| |l#1@@1| |l#2| |l#3|) $o@@14 $f@@2))  (=> (and (or (not (= $o@@14 |l#0@@1|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1@@1| $o@@14) |l#2|)))) (|Set#IsMember| |l#3| ($Box refType $o@@14))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |4521|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#14| |l#0@@1| |l#1@@1| |l#2| |l#3|) $o@@14 $f@@2))
)))
...
(set-info :boogie-vc-id Impl$$M1.UnionFind.New)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 67) (let ((anon4_correct true))
(let ((anon13_Else_correct  (=> (and (not (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) M1.Element.c)))) (= (ControlFlow 0 43) 34)) anon4_correct)))
(let ((anon13_Then_correct  (=> (and (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) M1.Element.c))) ($IsAllocBox ($Box refType this@@13) Tclass.M1.UnionFind? $Heap@3)) (and (=> (= (ControlFlow 0 35) (- 0 42)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|))) (and (=> (= (ControlFlow 0 35) (- 0 41)) (or (not (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|))) null)) (not true))) (and (=> (= (ControlFlow 0 35) (- 0 40)) (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) M1.Element.c)))) (=> (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) M1.Element.c))) (=> (= |##d#0_0@0| (M1.Contents.depth ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) M1.Element.c)))) (=> (and ($IsAlloc intType (int_2_U |##d#0_0@0|) Tclass._System.nat $Heap@3) ($IsAlloc refType |f#0_0@0| Tclass.M1.Element $Heap@3)) (and (=> (= (ControlFlow 0 35) (- 0 39)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|))) (=> (= |##r#0_0@0| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) (=> (and ($IsAlloc refType |##r#0_0@0| Tclass.M1.Element $Heap@3) ($IsAllocBox ($Box refType this@@13) Tclass.M1.UnionFind? $Heap@3)) (and (=> (= (ControlFlow 0 35) (- 0 38)) (forall ((|f#0_1| T@U) ) (!  (=> ($Is refType |f#0_1| Tclass.M1.Element) (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_1|)) (M1.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |f#0_1|) M1.Element.c)))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType (M1.Contents.next ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |f#0_1|) M1.Element.c)))))))
 :qid |UnionFinddfy.64:23|
 :skolemid |1270|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |f#0_1|) M1.Element.c)))
))) (=> (|M1.UnionFind.Collect#canCall| $Heap@3 this@@13) (=> (and (= |##C#0_0@0| (M1.UnionFind.Collect $Heap@3 this@@13)) ($IsAlloc MapType |##C#0_0@0| (TMap Tclass.M1.Element Tclass.M1.Contents) $Heap@3)) (and (=> (= (ControlFlow 0 35) (- 0 37)) (=> (|M1.__default.GoodCMap#canCall| |##C#0_0@0|) (or (M1.__default.GoodCMap |##C#0_0@0|) (forall ((|f#0_2| T@U) ) (!  (=> ($Is refType |f#0_2| Tclass.M1.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |##C#0_0@0|) ($Box refType |f#0_2|)) (M1.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |##C#0_0@0|) ($Box refType |f#0_2|))))) (|Set#IsMember| (|Map#Domain| |##C#0_0@0|) ($Box refType (M1.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |##C#0_0@0|) ($Box refType |f#0_2|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |1271|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |##C#0_0@0|) ($Box refType |f#0_2|))))
))))) (and (=> (= (ControlFlow 0 35) (- 0 36)) (|Set#IsMember| (|Map#Domain| |##C#0_0@0|) ($Box refType |f#0_0@0|))) (=> (and (|M1.UnionFind.Reaches#canCall| this@@13 (M1.Contents.depth ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) M1.Element.c))) |f#0_0@0| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|))) (M1.UnionFind.Collect $Heap@3 this@@13)) (= (ControlFlow 0 35) 34)) anon4_correct))))))))))))))))))
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 44) (- 0 46)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|))) (and (=> (= (ControlFlow 0 44) (- 0 45)) (or (not (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|))) null)) (not true))) (and (=> (= (ControlFlow 0 44) 35) anon13_Then_correct) (=> (= (ControlFlow 0 44) 43) anon13_Else_correct))))))
(let ((anon8_correct  (and (=> (= (ControlFlow 0 12) (- 0 15)) (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) M1.Element.c)))) (=> (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) M1.Element.c))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (=> (|M1.UnionFind.Reaches#canCall| this@@13 (M1.Contents.depth ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) M1.Element.c))) |f#0_0@0| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|))) (M1.UnionFind.Collect $Heap@5 this@@13)) (or (M1.UnionFind.Reaches ($LS $LZ) this@@13 (M1.Contents.depth ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) M1.Element.c))) |f#0_0@0| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|))) (M1.UnionFind.Collect $Heap@5 this@@13)) (=> (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (M1.UnionFind.Collect $Heap@5 this@@13)) ($Box refType |f#0_0@0|)))) (= |f#0_0@0| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))))))) (=> (=> (|M1.UnionFind.Reaches#canCall| this@@13 (M1.Contents.depth ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) M1.Element.c))) |f#0_0@0| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|))) (M1.UnionFind.Collect $Heap@5 this@@13)) (or (M1.UnionFind.Reaches ($LS $LZ) this@@13 (M1.Contents.depth ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) M1.Element.c))) |f#0_0@0| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|))) (M1.UnionFind.Collect $Heap@5 this@@13)) (=> (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (M1.UnionFind.Collect $Heap@5 this@@13)) ($Box refType |f#0_0@0|)))) (= |f#0_0@0| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|))))))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (=> (|M1.UnionFind.Reaches#canCall| this@@13 (M1.Contents.depth ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) M1.Element.c))) |f#0_0@0| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|))) (M1.UnionFind.Collect $Heap@5 this@@13)) (or (M1.UnionFind.Reaches ($LS $LZ) this@@13 (M1.Contents.depth ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) M1.Element.c))) |f#0_0@0| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|))) (M1.UnionFind.Collect $Heap@5 this@@13)) (=> (not (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (M1.UnionFind.Collect $Heap@5 this@@13)) ($Box refType |f#0_0@0|))))) (or (not (= (M1.Contents.depth ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) M1.Element.c))) 0)) (not true)))))) (=> (=> (|M1.UnionFind.Reaches#canCall| this@@13 (M1.Contents.depth ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) M1.Element.c))) |f#0_0@0| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|))) (M1.UnionFind.Collect $Heap@5 this@@13)) (or (M1.UnionFind.Reaches ($LS $LZ) this@@13 (M1.Contents.depth ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) M1.Element.c))) |f#0_0@0| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|))) (M1.UnionFind.Collect $Heap@5 this@@13)) (=> (not (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (M1.UnionFind.Collect $Heap@5 this@@13)) ($Box refType |f#0_0@0|))))) (or (not (= (M1.Contents.depth ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) M1.Element.c))) 0)) (not true))))) (=> (= (ControlFlow 0 12) (- 0 11)) (=> (|M1.UnionFind.Reaches#canCall| this@@13 (M1.Contents.depth ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) M1.Element.c))) |f#0_0@0| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|))) (M1.UnionFind.Collect $Heap@5 this@@13)) (or (M1.UnionFind.Reaches ($LS $LZ) this@@13 (M1.Contents.depth ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) M1.Element.c))) |f#0_0@0| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|))) (M1.UnionFind.Collect $Heap@5 this@@13)) (=> (not (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (M1.UnionFind.Collect $Heap@5 this@@13)) ($Box refType |f#0_0@0|))))) (let ((|next#0_0| (M1.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (M1.UnionFind.Collect $Heap@5 this@@13)) ($Box refType |f#0_0@0|))))))
(M1.UnionFind.Reaches ($LS ($LS $LZ)) this@@13 (- (M1.Contents.depth ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) M1.Element.c))) 1) |next#0_0| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|))) (M1.UnionFind.Collect $Heap@5 this@@13)))))))))))))))
(let ((anon14_Else_correct  (=> (= |f#0_0@0| $nw@0) (=> (and (= $Heap@5 $Heap@3) (= (ControlFlow 0 31) 12)) anon8_correct))))
(let ((anon14_Then_correct  (=> (or (not (= |f#0_0@0| $nw@0)) (not true)) (and (=> (= (ControlFlow 0 16) (- 0 30)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|))) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)) (and (=> (= (ControlFlow 0 16) (- 0 29)) (or (not (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|))) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|))) null)) (not true)) (and (=> (= (ControlFlow 0 16) (- 0 28)) (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) M1.Element.c)))) (=> (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) M1.Element.c))) (=> (= |d##0_0_0@0| (M1.Contents.depth ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) M1.Element.c)))) (and (=> (= (ControlFlow 0 16) (- 0 27)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|))) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)) (=> (= |r##0_0_0@0| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|)))) (and (=> (= (ControlFlow 0 16) (- 0 26)) ($IsAlloc refType this@@13 Tclass.M1.UnionFind $Heap@@6)) (=> ($IsAlloc refType this@@13 Tclass.M1.UnionFind $Heap@@6) (and (=> (= (ControlFlow 0 16) (- 0 25)) (forall ((|f#0_0_0| T@U) ) (!  (=> ($Is refType |f#0_0_0| Tclass.M1.Element) (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0_0|)) (M1.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |f#0_0_0|) M1.Element.c)))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.M))) ($Box refType (M1.Contents.next ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |f#0_0_0|) M1.Element.c)))))))
 :qid |UnionFinddfy.64:23|
 :skolemid |1273|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |f#0_0_0|) M1.Element.c)))
))) (=> (forall ((|f#0_0_0@@0| T@U) ) (!  (=> ($Is refType |f#0_0_0@@0| Tclass.M1.Element) (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0_0@@0|)) (M1.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |f#0_0_0@@0|) M1.Element.c)))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.M))) ($Box refType (M1.Contents.next ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |f#0_0_0@@0|) M1.Element.c)))))))
 :qid |UnionFinddfy.64:23|
 :skolemid |1274|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |f#0_0_0@@0|) M1.Element.c)))
)) (=> (and (and (|M1.UnionFind.Collect#canCall| $Heap@@6 this@@13) (|M1.UnionFind.Collect#canCall| $Heap@@6 this@@13)) (and (= |C##0_0_0@0| (M1.UnionFind.Collect $Heap@@6 this@@13)) ($IsAllocBox ($Box refType this@@13) Tclass.M1.UnionFind? $Heap@3))) (and (=> (= (ControlFlow 0 16) (- 0 24)) (forall ((|f#0_0_1| T@U) ) (!  (=> ($Is refType |f#0_0_1| Tclass.M1.Element) (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0_1|)) (M1.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |f#0_0_1|) M1.Element.c)))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType (M1.Contents.next ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |f#0_0_1|) M1.Element.c)))))))
 :qid |UnionFinddfy.64:23|
 :skolemid |1275|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |f#0_0_1|) M1.Element.c)))
))) (=> (and (and (forall ((|f#0_0_1@@0| T@U) ) (!  (=> ($Is refType |f#0_0_1@@0| Tclass.M1.Element) (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0_1@@0|)) (M1.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |f#0_0_1@@0|) M1.Element.c)))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType (M1.Contents.next ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |f#0_0_1@@0|) M1.Element.c)))))))
 :qid |UnionFinddfy.64:23|
 :skolemid |1276|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |f#0_0_1@@0|) M1.Element.c)))
)) (|M1.UnionFind.Collect#canCall| $Heap@3 this@@13)) (and (|M1.UnionFind.Collect#canCall| $Heap@3 this@@13) (= |C'##0_0_0@0| (M1.UnionFind.Collect $Heap@3 this@@13)))) (and (=> (= (ControlFlow 0 16) (- 0 23)) (=> (|M1.__default.GoodCMap#canCall| |C##0_0_0@0|) (or (M1.__default.GoodCMap |C##0_0_0@0|) (forall ((|f#4| T@U) ) (!  (=> ($Is refType |f#4| Tclass.M1.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C##0_0_0@0|) ($Box refType |f#4|)) (M1.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#4|))))) (|Set#IsMember| (|Map#Domain| |C##0_0_0@0|) ($Box refType (M1.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#4|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |1243|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#4|))))
))))) (=> (=> (|M1.__default.GoodCMap#canCall| |C##0_0_0@0|) (or (M1.__default.GoodCMap |C##0_0_0@0|) (forall ((|f#4@@0| T@U) ) (!  (=> ($Is refType |f#4@@0| Tclass.M1.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C##0_0_0@0|) ($Box refType |f#4@@0|)) (M1.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#4@@0|))))) (|Set#IsMember| (|Map#Domain| |C##0_0_0@0|) ($Box refType (M1.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#4@@0|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |1243|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#4@@0|))))
)))) (and (=> (= (ControlFlow 0 16) (- 0 22)) (=> (|M1.__default.GoodCMap#canCall| |C'##0_0_0@0|) (or (M1.__default.GoodCMap |C'##0_0_0@0|) (forall ((|f#5| T@U) ) (!  (=> ($Is refType |f#5| Tclass.M1.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C'##0_0_0@0|) ($Box refType |f#5|)) (M1.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'##0_0_0@0|) ($Box refType |f#5|))))) (|Set#IsMember| (|Map#Domain| |C'##0_0_0@0|) ($Box refType (M1.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'##0_0_0@0|) ($Box refType |f#5|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |1245|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'##0_0_0@0|) ($Box refType |f#5|))))
))))) (=> (=> (|M1.__default.GoodCMap#canCall| |C'##0_0_0@0|) (or (M1.__default.GoodCMap |C'##0_0_0@0|) (forall ((|f#5@@0| T@U) ) (!  (=> ($Is refType |f#5@@0| Tclass.M1.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C'##0_0_0@0|) ($Box refType |f#5@@0|)) (M1.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'##0_0_0@0|) ($Box refType |f#5@@0|))))) (|Set#IsMember| (|Map#Domain| |C'##0_0_0@0|) ($Box refType (M1.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'##0_0_0@0|) ($Box refType |f#5@@0|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |1245|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'##0_0_0@0|) ($Box refType |f#5@@0|))))
)))) (and (=> (= (ControlFlow 0 16) (- 0 21)) (|Set#IsMember| (|Map#Domain| |C##0_0_0@0|) ($Box refType |f#0_0@0|))) (=> (|Set#IsMember| (|Map#Domain| |C##0_0_0@0|) ($Box refType |f#0_0@0|)) (and (=> (= (ControlFlow 0 16) (- 0 20)) (=> (|M1.UnionFind.Reaches#canCall| this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C##0_0_0@0|) (or (M1.UnionFind.Reaches ($LS $LZ) this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C##0_0_0@0|) (=> (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#0_0@0|)))) (= |f#0_0@0| |r##0_0_0@0|))))) (=> (=> (|M1.UnionFind.Reaches#canCall| this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C##0_0_0@0|) (or (M1.UnionFind.Reaches ($LS $LZ) this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C##0_0_0@0|) (=> (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#0_0@0|)))) (= |f#0_0@0| |r##0_0_0@0|)))) (and (=> (= (ControlFlow 0 16) (- 0 19)) (=> (|M1.UnionFind.Reaches#canCall| this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C##0_0_0@0|) (or (M1.UnionFind.Reaches ($LS $LZ) this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C##0_0_0@0|) (=> (not (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#0_0@0|))))) (or (not (= |d##0_0_0@0| 0)) (not true)))))) (=> (=> (|M1.UnionFind.Reaches#canCall| this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C##0_0_0@0|) (or (M1.UnionFind.Reaches ($LS $LZ) this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C##0_0_0@0|) (=> (not (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#0_0@0|))))) (or (not (= |d##0_0_0@0| 0)) (not true))))) (and (=> (= (ControlFlow 0 16) (- 0 18)) (=> (|M1.UnionFind.Reaches#canCall| this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C##0_0_0@0|) (or (M1.UnionFind.Reaches ($LS $LZ) this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C##0_0_0@0|) (=> (not (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#0_0@0|))))) (let ((|next#0@@0| (M1.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#0_0@0|))))))
(M1.UnionFind.Reaches ($LS ($LS $LZ)) this@@13 (- |d##0_0_0@0| 1) |next#0@@0| |r##0_0_0@0| |C##0_0_0@0|)))))) (=> (=> (|M1.UnionFind.Reaches#canCall| this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C##0_0_0@0|) (or (M1.UnionFind.Reaches ($LS $LZ) this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C##0_0_0@0|) (=> (not (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#0_0@0|))))) (let ((|next#0@@1| (M1.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#0_0@0|))))))
(M1.UnionFind.Reaches ($LS ($LS $LZ)) this@@13 (- |d##0_0_0@0| 1) |next#0@@1| |r##0_0_0@0| |C##0_0_0@0|))))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (forall ((|f#2| T@U) ) (!  (=> ($Is refType |f#2| Tclass.M1.Element?) (and (=> (|Set#IsMember| (|Map#Domain| |C##0_0_0@0|) ($Box refType |f#2|)) (|Set#IsMember| (|Map#Domain| |C'##0_0_0@0|) ($Box refType |f#2|))) (=> (|Set#IsMember| (|Map#Domain| |C##0_0_0@0|) ($Box refType |f#2|)) (|M1.Contents#Equal| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#2|))) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'##0_0_0@0|) ($Box refType |f#2|)))))))
 ...
 :pattern ( (|Set#IsMember| (|Map#Domain| |C##0_0_0@0|) ($Box refType |f#2|)))
))) (=> (forall ((|f#2@@0| T@U) ) (!  (=> ($Is refType |f#2@@0| Tclass.M1.Element?) (and (=> (|Set#IsMember| (|Map#Domain| |C##0_0_0@0|) ($Box refType |f#2@@0|)) (|Set#IsMember| (|Map#Domain| |C'##0_0_0@0|) ($Box refType |f#2@@0|))) (=> (|Set#IsMember| (|Map#Domain| |C##0_0_0@0|) ($Box refType |f#2@@0|)) (|M1.Contents#Equal| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#2@@0|))) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'##0_0_0@0|) ($Box refType |f#2@@0|)))))))
 :qid |UnionFinddfy.81:46|
 :skolemid |1247|
 ...
 :pattern ( (|Set#IsMember| (|Map#Domain| |C##0_0_0@0|) ($Box refType |f#2@@0|)))
)) (=> (and (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (|M1.UnionFind.Reaches#canCall| this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C'##0_0_0@0|)) (=> (and (and (and (|M1.UnionFind.Reaches#canCall| this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C'##0_0_0@0|) (and (M1.UnionFind.Reaches ($LS $LZ) this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C'##0_0_0@0|) (ite (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'##0_0_0@0|) ($Box refType |f#0_0@0|)))) (= |f#0_0@0| |r##0_0_0@0|) (let ((|next#3@@0| (M1.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'##0_0_0@0|) ($Box refType |f#0_0@0|))))))
 (and (or (not (= |d##0_0_0@0| 0)) (not true)) (M1.UnionFind.Reaches ($LS $LZ) this@@13 (- |d##0_0_0@0| 1) |next#3@@0| |r##0_0_0@0| |C'##0_0_0@0|)))))) (= $Heap@3 $Heap@4)) (and (= $Heap@5 $Heap@4) (= (ControlFlow 0 16) 12))) anon8_correct))))))))))))))))))))))))))))))))))))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 32) (- 0 33)) true) (and (=> (= (ControlFlow 0 32) 16) anon14_Then_correct) (=> (= (ControlFlow 0 32) 31) anon14_Else_correct)))))
(let ((anon11_Then_correct  (=> (and ($Is refType |f#0_0@0| Tclass.M1.Element) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_0@0|))) (and (=> (= (ControlFlow 0 47) 44) anon12_Then_correct) (=> (= (ControlFlow 0 47) 32) anon12_Else_correct)))))
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|M1.UnionFind.Valid#canCall| $Heap@6 this@@13) (or (M1.UnionFind.Valid $Heap@6 this@@13) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M1.UnionFind.Repr)) ($Box refType this@@13))))) (=> (=> (|M1.UnionFind.Valid#canCall| $Heap@6 this@@13) (or (M1.UnionFind.Valid $Heap@6 this@@13) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M1.UnionFind.Repr)) ($Box refType this@@13)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|M1.UnionFind.Valid#canCall| $Heap@6 this@@13) (or (M1.UnionFind.Valid $Heap@6 this@@13) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M1.UnionFind.Repr)) ($Box refType null)))))) (=> (=> (|M1.UnionFind.Valid#canCall| $Heap@6 this@@13) (or (M1.UnionFind.Valid $Heap@6 this@@13) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M1.UnionFind.Repr)) ($Box refType null))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|M1.UnionFind.Valid#canCall| $Heap@6 this@@13) (or (M1.UnionFind.Valid $Heap@6 this@@13) (M1.UnionFind.ValidM1 $Heap@6 this@@13)))) (=> (=> (|M1.UnionFind.Valid#canCall| $Heap@6 this@@13) (or (M1.UnionFind.Valid $Heap@6 this@@13) (M1.UnionFind.ValidM1 $Heap@6 this@@13))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (forall (($o@@15 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M1.UnionFind.Repr)) ($Box refType $o@@15)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.Repr)) ($Box refType $o@@15)))) (or (not (= $o@@15 null)) (not true)))
 :qid |UnionFinddfy.23:12|
 :skolemid |1263|
 :pattern (  (or (not (= $o@@15 null)) (not true)))
)) (forall (($o@@16 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M1.UnionFind.Repr)) ($Box refType $o@@16)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.Repr)) ($Box refType $o@@16)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 $o@@16) alloc)))))
 :qid |UnionFinddfy.23:12|
 :skolemid |1264|
...
)))) (=> (and (forall (($o@@17 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M1.UnionFind.Repr)) ($Box refType $o@@17)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.Repr)) ($Box refType $o@@17)))) (or (not (= $o@@17 null)) (not true)))
 :qid |UnionFinddfy.23:12|
 :skolemid |1263|
 :pattern (  (or (not (= $o@@17 null)) (not true)))
)) (forall (($o@@18 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M1.UnionFind.Repr)) ($Box refType $o@@18)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.Repr)) ($Box refType $o@@18)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 $o@@18) alloc)))))
 :qid |UnionFinddfy.23:12|
 :skolemid |1264|
...
))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (not (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.M))) ($Box refType $nw@0)))) (=> (not (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.M))) ($Box refType $nw@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((|e'#1| T@U) ) (!  (=> ($Is refType |e'#1| Tclass.M1.Element?) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.M))) ($Box refType |e'#1|)) (or (not (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.M))) ($Box refType |e'#1|))) $nw@0)) (not true))))
 :qid |UnionFinddfy.24:37|
 :skolemid |1265|
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.M))) ($Box refType |e'#1|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.M))) ($Box refType |e'#1|)))
))) (=> (forall ((|e'#1@@0| T@U) ) (!  (=> ($Is refType |e'#1@@0| Tclass.M1.Element?) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.M))) ($Box refType |e'#1@@0|)) (or (not (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.M))) ($Box refType |e'#1@@0|))) $nw@0)) (not true))))
 :qid |UnionFinddfy.24:37|
 :skolemid |1265|
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.M))) ($Box refType |e'#1@@0|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.M))) ($Box refType |e'#1@@0|)))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (|Map#Equal| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M1.UnionFind.M)) (|Map#Build| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.M)) ($Box refType $nw@0) ($Box refType $nw@0))))))))))))))))))
(let ((anon11_Else_correct  (=> (forall ((|f#0_3| T@U) ) (!  (=> (and ($Is refType |f#0_3| Tclass.M1.Element) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_3|))) (and (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_3|)))) M1.Element.c))) (M1.UnionFind.Reaches ($LS $LZ) this@@13 (M1.Contents.depth ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_3|)))) M1.Element.c))) |f#0_3| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_3|))) (M1.UnionFind.Collect $Heap@3 this@@13))))
 :qid |UnionFinddfy.93:14|
 :skolemid |1278|
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_3|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0_3|)))
)) (and (=> (= (ControlFlow 0 9) (- 0 10)) true) (=> (and (= $Heap@6 $Heap@3) (= (ControlFlow 0 9) 2)) GeneratedUnifiedExit_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#14| null $Heap@@6 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.Repr)))) (=> (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 Tclass.M1.Element?)) (=> (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 $nw@0) alloc)))) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@6 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 48) (- 0 66)) true) (and (=> (= (ControlFlow 0 48) (- 0 65)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 48) (- 0 64)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 M1.Element.c))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 M1.Element.c)) (and (=> (= (ControlFlow 0 48) (- 0 63)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (= |$rhs#0@0| (Lit DatatypeTypeType (|#M1.Contents.Root| (LitInt 0)))) (=> (and (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0) M1.Element.c ($Box DatatypeTypeType |$rhs#0@0|)))) ($IsGoodHeap $Heap@1)) (and (=> (= (ControlFlow 0 48) (- 0 62)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@13 M1.UnionFind.Repr))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@13 M1.UnionFind.Repr)) (and (=> (= (ControlFlow 0 48) (- 0 61)) true) (=> (= |$rhs#1@0| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@13) M1.UnionFind.Repr)) (|Set#UnionOne| |Set#Empty| ($Box refType $nw@0)))) (=> (and (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 this@@13 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@13) M1.UnionFind.Repr ($Box SetType |$rhs#1@0|)))) ($IsGoodHeap $Heap@2)) (and (=> (= (ControlFlow 0 48) (- 0 60)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@13 M1.UnionFind.M))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@13 M1.UnionFind.M)) (and (=> (= (ControlFlow 0 48) (- 0 59)) true) (and (=> (= (ControlFlow 0 48) (- 0 58)) true) (=> (and (and (= |$rhs#2@0| (|Map#Build| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@13) M1.UnionFind.M)) ($Box refType $nw@0) ($Box refType $nw@0))) (= $Heap@3 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@2 this@@13 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@13) M1.UnionFind.M ($Box MapType |$rhs#2@0|))))) (and ($IsGoodHeap $Heap@3) ($IsAllocBox ($Box refType this@@13) Tclass.M1.UnionFind? $Heap@3))) (and (=> (= (ControlFlow 0 48) (- 0 57)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (and (= |##d#0@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##d#0@0|) Tclass._System.nat $Heap@3)) (and (=> (= (ControlFlow 0 48) (- 0 56)) true) (=> ($IsAlloc refType $nw@0 Tclass.M1.Element $Heap@3) (and (=> (= (ControlFlow 0 48) (- 0 55)) true) (=> (and ($IsAlloc refType $nw@0 Tclass.M1.Element $Heap@3) ($IsAllocBox ($Box refType this@@13) Tclass.M1.UnionFind? $Heap@3)) (and (=> (= (ControlFlow 0 48) (- 0 54)) (forall ((|f#0@@2| T@U) ) (!  (=> ($Is refType |f#0@@2| Tclass.M1.Element) (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType |f#0@@2|)) (M1.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |f#0@@2|) M1.Element.c)))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M1.UnionFind.M))) ($Box refType (M1.Contents.next ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |f#0@@2|) M1.Element.c)))))))
 :qid |UnionFinddfy.64:23|
 :skolemid |1267|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |f#0@@2|) M1.Element.c)))
))) (=> (|M1.UnionFind.Collect#canCall| $Heap@3 this@@13) (=> (and (= |##C#0@0| (M1.UnionFind.Collect $Heap@3 this@@13)) ($IsAlloc MapType |##C#0@0| (TMap Tclass.M1.Element Tclass.M1.Contents) $Heap@3)) (and (=> (= (ControlFlow 0 48) (- 0 53)) (=> (|M1.__default.GoodCMap#canCall| |##C#0@0|) (or (M1.__default.GoodCMap |##C#0@0|) (forall ((|f#1@@1| T@U) ) (!  (=> ($Is refType |f#1@@1| Tclass.M1.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |##C#0@0|) ($Box refType |f#1@@1|)) (M1.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |##C#0@0|) ($Box refType |f#1@@1|))))) (|Set#IsMember| (|Map#Domain| |##C#0@0|) ($Box refType (M1.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |##C#0@0|) ($Box refType |f#1@@1|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |1268|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |##C#0@0|) ($Box refType |f#1@@1|))))
))))) (and (=> (= (ControlFlow 0 48) (- 0 52)) (|Set#IsMember| (|Map#Domain| |##C#0@0|) ($Box refType $nw@0))) (=> (|M1.UnionFind.Reaches#canCall| this@@13 (LitInt 0) $nw@0 $nw@0 (M1.UnionFind.Collect $Heap@3 this@@13)) (=> (and (|M1.UnionFind.Collect#canCall| $Heap@3 this@@13) (|M1.UnionFind.Reaches#canCall| this@@13 (LitInt 0) $nw@0 $nw@0 (M1.UnionFind.Collect $Heap@3 this@@13))) (and (=> (= (ControlFlow 0 48) (- 0 51)) (=> (|M1.UnionFind.Reaches#canCall| this@@13 (LitInt 0) $nw@0 $nw@0 (M1.UnionFind.Collect $Heap@3 this@@13)) (or (M1.UnionFind.Reaches ($LS $LZ) this@@13 (LitInt 0) $nw@0 $nw@0 (M1.UnionFind.Collect $Heap@3 this@@13)) (=> (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (M1.UnionFind.Collect $Heap@3 this@@13)) ($Box refType $nw@0)))) (= $nw@0 $nw@0))))) (and (=> (= (ControlFlow 0 48) (- 0 50)) (=> (|M1.UnionFind.Reaches#canCall| this@@13 (LitInt 0) $nw@0 $nw@0 (M1.UnionFind.Collect $Heap@3 this@@13)) (or (M1.UnionFind.Reaches ($LS $LZ) this@@13 (LitInt 0) $nw@0 $nw@0 (M1.UnionFind.Collect $Heap@3 this@@13)) (=> (not (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (M1.UnionFind.Collect $Heap@3 this@@13)) ($Box refType $nw@0))))) (U_2_bool (Lit boolType (bool_2_U  (or (not (= 0 0)) (not true))))))))) (and (=> (= (ControlFlow 0 48) (- 0 49)) (=> (|M1.UnionFind.Reaches#canCall| this@@13 (LitInt 0) $nw@0 $nw@0 (M1.UnionFind.Collect $Heap@3 this@@13)) (or (M1.UnionFind.Reaches ($LS $LZ) this@@13 (LitInt 0) $nw@0 $nw@0 (M1.UnionFind.Collect $Heap@3 this@@13)) (=> (not (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (M1.UnionFind.Collect $Heap@3 this@@13)) ($Box refType $nw@0))))) (let ((|next#0@@2| (M1.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (M1.UnionFind.Collect $Heap@3 this@@13)) ($Box refType $nw@0))))))
(M1.UnionFind.Reaches ($LS ($LS $LZ)) this@@13 (LitInt (- 0 1)) |next#0@@2| $nw@0 (M1.UnionFind.Collect $Heap@3 this@@13))))))) (=> (M1.UnionFind.Reaches ($LS $LZ) this@@13 (LitInt 0) $nw@0 $nw@0 (M1.UnionFind.Collect $Heap@3 this@@13)) (and (=> (= (ControlFlow 0 48) 47) anon11_Then_correct) (=> (= (ControlFlow 0 48) 9) anon11_Else_correct))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and (or (not (= this@@13 null)) (not true)) (and ($Is refType this@@13 Tclass.M1.UnionFind) ($IsAlloc refType this@@13 Tclass.M1.UnionFind $Heap@@6))) (and (=> |defass#e#0| (and ($Is refType |e#0@@5| Tclass.M1.Element) ($IsAlloc refType |e#0@@5| Tclass.M1.Element $Heap@@6))) (= 7 $FunctionContextHeight))) (and (and (|M1.UnionFind.Valid#canCall| $Heap@@6 this@@13) (and (M1.UnionFind.Valid $Heap@@6 this@@13) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.Repr)) ($Box refType this@@13)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.Repr)) ($Box refType null)))) (M1.UnionFind.ValidM1 $Heap@@6 this@@13)))) (= (ControlFlow 0 67) 48))) anon0_correct))))
