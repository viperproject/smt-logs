...
(declare-fun |b#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.dec)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon4_correct  (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (=> (and (and (and (and ($Is SeqType |b#0@0| (TSeq TInt)) ($IsAlloc SeqType |b#0@0| (TSeq TInt) $Heap@0)) ($IsAlloc SeqType |b#0@0| (TSeq TInt) $Heap@0)) (and ($IsAlloc intType (int_2_U |lowDigit#0@@1|) TInt $Heap@0) ($IsAlloc intType (int_2_U |base#0@@5|) TInt $Heap@0))) (and (and (|_module.__default.IsSkewNumber#canCall| |b#0@0| |lowDigit#0@@1| |base#0@@5|) (_module.__default.IsSkewNumber |b#0@0| |lowDigit#0@@1| |base#0@@5|)) (and ($IsAlloc SeqType |b#0@0| (TSeq TInt) $Heap@0) ($IsAlloc intType (int_2_U |base#0@@5|) TInt $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 2) |base#0@@5|)) (=> (<= (LitInt 2) |base#0@@5|) (=> (and (and (|_module.__default.eval#canCall| |b#0@0| |base#0@@5|) ($IsAlloc SeqType |a#0| (TSeq TInt) $Heap@0)) (and ($IsAlloc intType (int_2_U |base#0@@5|) TInt $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (<= (LitInt 2) |base#0@@5|))))))))
(let ((anon5_Else_correct  (=> (and (=> (= (_module.__default.eval ($LS $LZ) |a#0| |base#0@@5|) (LitInt 0)) (< |lowDigit#0@@1| 0)) (= (ControlFlow 0 6) 2)) anon4_correct)))
(let ((anon5_Then_correct  (=> (and ($IsAlloc SeqType |a#0| (TSeq TInt) $Heap) ($IsAlloc intType (int_2_U |base#0@@5|) TInt $Heap)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= (LitInt 2) |base#0@@5|)) (=> (<= (LitInt 2) |base#0@@5|) (=> (and (and (|_module.__default.eval#canCall| |a#0| |base#0@@5|) (= (_module.__default.eval ($LS $LZ) |a#0| |base#0@@5|) (LitInt 0))) (and (< |lowDigit#0@@1| 0) (= (ControlFlow 0 4) 2))) anon4_correct))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) ($IsAlloc SeqType |a#0| (TSeq TInt) $Heap)) (=> (and (and ($IsAlloc intType (int_2_U |lowDigit#0@@1|) TInt $Heap) ($IsAlloc intType (int_2_U |base#0@@5|) TInt $Heap)) (and (|_module.__default.IsSkewNumber#canCall| |a#0| |lowDigit#0@@1| |base#0@@5|) (_module.__default.IsSkewNumber |a#0| |lowDigit#0@@1| |base#0@@5|))) (and (=> (= (ControlFlow 0 7) 4) anon5_Then_correct) (=> (= (ControlFlow 0 7) 6) anon5_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SeqType |a#0| (TSeq TInt)) ($IsAlloc SeqType |a#0| (TSeq TInt) $Heap))) (and (and ($Is SeqType |b#0| (TSeq TInt)) ($IsAlloc SeqType |b#0| (TSeq TInt) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7)))) anon0_correct)))
