...
(assert (distinct TBool TagBool TagSet TagMap alloc Tagclass._System.nat |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass.M1.Element Tagclass.M1.Contents Tagclass.M1.Element? |##M1.Contents.Root| |##M1.Contents.Link| Tagclass.M1.UnionFind? Tagclass.M1.UnionFind tytagFamily$nat |tytagFamily$_tuple#2| tytagFamily$Element tytagFamily$Contents tytagFamily$UnionFind)
)
...
(assert (forall ((v@@3 T@U) (t0@@2 T@U) (t1@@0 T@U) (h@@1 T@U) ) (! (= ($IsAlloc MapType v@@3 (TMap t0@@2 t1@@0) h@@1) (forall ((bx@@8 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@3) bx@@8) (and ($IsAllocBox (MapType0Select BoxType BoxType (|Map#Elements| v@@3) bx@@8) t1@@0 h@@1) ($IsAllocBox bx@@8 t0@@2 h@@1)))
...
(set-info :boogie-vc-id CheckWellformed$$M1.UnionFind.Reaches)
...
(let ((anon13_Else_correct  (=> (and (= |d#0@@3| 0) (= (ControlFlow 0 11) 4)) anon7_correct)))
(let ((anon13_Then_correct  (=> (and (or (not (= |d#0@@3| 0)) (not true)) ($IsAllocBox ($Box refType this@@3) Tclass.M1.UnionFind? $Heap)) (and (=> (= (ControlFlow 0 5) (- 0 10)) ($Is intType (int_2_U (- |d#0@@3| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |d#0@@3| 1)) Tclass._System.nat) (=> (= |##d#0@0| (- |d#0@@3| 1)) (=> (and (and ($IsAlloc intType (int_2_U |##d#0@0|) Tclass._System.nat $Heap) ($IsAlloc refType |next#Z#0@0| Tclass.M1.Element $Heap)) (and ($IsAlloc refType |r#0@@3| Tclass.M1.Element $Heap) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M1.Element Tclass.M1.Contents) $Heap))) (and (=> (= (ControlFlow 0 5) (- 0 9)) (=> (|M1.__default.GoodCMap#canCall| |C#0@@5|) (or (M1.__default.GoodCMap |C#0@@5|) (forall ((|f#0@@0| T@U) ) (!  (=> ($Is refType |f#0@@0| Tclass.M1.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |f#0@@0|)) (M1.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#0@@0|))))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType (M1.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#0@@0|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |1235|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#0@@0|))))
))))) (=> (M1.__default.GoodCMap |C#0@@5|) (and (=> (= (ControlFlow 0 5) (- 0 8)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |next#Z#0@0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |next#Z#0@0|)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (or (<= 0 |d#0@@3|) (= |##d#0@0| |d#0@@3|))) (=> (or (<= 0 |d#0@@3|) (= |##d#0@0| |d#0@@3|)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (< |##d#0@0| |d#0@@3|) (and (= |##d#0@0| |d#0@@3|) (or (and (= |next#Z#0@0| null) (or (not (= |e#0@@3| null)) (not true))) (and (=  (or (not (= |next#Z#0@0| null)) (not true))  (or (not (= |e#0@@3| null)) (not true))) (or (and (= |r#0@@3| null) (or (not (= |r#0@@3| null)) (not true))) (and (=  (or (not (= |r#0@@3| null)) (not true))  (or (not (= |r#0@@3| null)) (not true))) (and (|Set#Subset| (|Map#Domain| |C#0@@5|) (|Map#Domain| |C#0@@5|)) (not (|Set#Subset| (|Map#Domain| |C#0@@5|) (|Map#Domain| |C#0@@5|))))))))))) (=> (or (< |##d#0@0| |d#0@@3|) (and (= |##d#0@0| |d#0@@3|) (or (and (= |next#Z#0@0| null) (or (not (= |e#0@@3| null)) (not true))) (and (=  (or (not (= |next#Z#0@0| null)) (not true))  (or (not (= |e#0@@3| null)) (not true))) (or (and (= |r#0@@3| null) (or (not (= |r#0@@3| null)) (not true))) (and (=  (or (not (= |r#0@@3| null)) (not true))  (or (not (= |r#0@@3| null)) (not true))) (and (|Set#Subset| (|Map#Domain| |C#0@@5|) (|Map#Domain| |C#0@@5|)) (not (|Set#Subset| (|Map#Domain| |C#0@@5|) (|Map#Domain| |C#0@@5|)))))))))) (=> (and (|M1.UnionFind.Reaches#canCall| this@@3 (- |d#0@@3| 1) |next#Z#0@0| |r#0@@3| |C#0@@5|) (= (ControlFlow 0 5) 4)) anon7_correct))))))))))))))))
(let ((anon12_Then_correct  (=> (= ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|))) (|#M1.Contents.Link| |_mcc#1#0|)) (=> (and (and ($Is refType |_mcc#1#0| Tclass.M1.Element) (= |let#0#0#0| |_mcc#1#0|)) (and ($Is refType |let#0#0#0| Tclass.M1.Element) (= |next#Z#0@0| |let#0#0#0|))) (and (=> (= (ControlFlow 0 12) 5) anon13_Then_correct) (=> (= (ControlFlow 0 12) 11) anon13_Else_correct))))))
(let ((anon12_Else_correct true))
(let ((anon11_Else_correct  (=> (or (not (= ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|))) (|#M1.Contents.Root| |_mcc#0#0|))) (not true)) (and (=> (= (ControlFlow 0 13) 12) anon12_Then_correct) (=> (= (ControlFlow 0 13) 3) anon12_Else_correct)))))
(let ((anon11_Then_correct true))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|)) (and (=> (= (ControlFlow 0 14) 2) anon11_Then_correct) (=> (= (ControlFlow 0 14) 13) anon11_Else_correct))))))
(let ((anon10_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsAlloc MapType |C#0@@5| (TMap Tclass.M1.Element Tclass.M1.Contents) $Heap) (|M1.__default.GoodCMap#canCall| |C#0@@5|)) (and (M1.__default.GoodCMap |C#0@@5|) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|)))) (and (=> (= (ControlFlow 0 16) 1) anon10_Then_correct) (=> (= (ControlFlow 0 16) 14) anon10_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.M1.UnionFind) ($IsAlloc refType this@@3 Tclass.M1.UnionFind $Heap))) (and (<= (LitInt 0) |d#0@@3|) ($Is refType |e#0@@3| Tclass.M1.Element))) (and (and ($Is refType |r#0@@3| Tclass.M1.Element) ($Is MapType |C#0@@5| (TMap Tclass.M1.Element Tclass.M1.Contents))) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 17) 16)))) anon0_correct))))
