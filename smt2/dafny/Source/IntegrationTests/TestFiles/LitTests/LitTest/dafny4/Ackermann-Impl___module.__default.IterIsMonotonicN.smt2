...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@2 T@U) ($Heap@@3 T@U) (|f#0@@8| T@U) (|n#0@@2| Int) ) (!  (=> (or (|_module.__default.Iter#canCall| |f#0@@8| |n#0@@2|) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@3) ($Is HandleTypeType |f#0@@8| (Tclass._System.___hTotalFunc1 TInt TInt))))) (and (=> (< (LitInt 0) |n#0@@2|) (|_module.__default.Iter#canCall| |f#0@@8| (- |n#0@@2| 1))) (= (_module.__default.Iter ($LS $ly@@2) |f#0@@8| |n#0@@2|) (ite (<= |n#0@@2| (LitInt 0)) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@3 |f#0@@8| ($Box intType (int_2_U (LitInt 1)))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@3 |f#0@@8| ($Box intType (int_2_U (_module.__default.Iter $ly@@2 |f#0@@8| (- |n#0@@2| 1)))))))))))
 :qid |Ackermanndfy.59:16|
 :skolemid |564|
 :pattern ( (_module.__default.Iter ($LS $ly@@2) |f#0@@8| |n#0@@2|) ($IsGoodHeap $Heap@@3))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.IterIsMonotonicN)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@6 $Heap@0)) (and (forall ((|$ih#n0#0| Int) (|$ih#n'0#0| Int) ) (!  (=> (and (and (and (_module.__default.Expanding |f#0@@11|) (_module.__default.FunctionMonotonic |f#0@@11|)) (<= |$ih#n0#0| |$ih#n'0#0|)) (or (and (<= 0 |$ih#n0#0|) (< |$ih#n0#0| |n#0@@5|)) (and (= |$ih#n0#0| |n#0@@5|) (and (<= 0 |$ih#n'0#0|) (< |$ih#n'0#0| |n'#0@@0|))))) (<= (_module.__default.Iter ($LS $LZ) |f#0@@11| |$ih#n0#0|) (_module.__default.Iter ($LS $LZ) |f#0@@11| |$ih#n'0#0|)))
 :qid |Ackermanndfy.126:39|
 :skolemid |605|
 :pattern ( (_module.__default.Iter ($LS $LZ) |f#0@@11| |$ih#n'0#0|) (_module.__default.Iter ($LS $LZ) |f#0@@11| |$ih#n0#0|))
)) (= (ControlFlow 0 2) (- 0 1)))) (<= (_module.__default.Iter ($LS ($LS $LZ)) |f#0@@11| |n#0@@5|) (_module.__default.Iter ($LS ($LS $LZ)) |f#0@@11| |n'#0@@0|))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and (and ($Is HandleTypeType |f#0@@11| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |f#0@@11| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap@@6)) (= 1 $FunctionContextHeight)) (and (|_module.__default.Expanding#canCall| |f#0@@11|) (and (_module.__default.Expanding |f#0@@11|) (forall ((|n#3| T@U) ) (! (< (U_2_int |n#3|) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@6 |f#0@@11| ($Box intType |n#3|)))))
 :qid |Ackermanndfy.119:10|
 :skolemid |602|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@6 |f#0@@11| ($Box intType |n#3|))))
))))) (and (and (|_module.__default.FunctionMonotonic#canCall| |f#0@@11|) (and (_module.__default.FunctionMonotonic |f#0@@11|) (forall ((|n#4| T@U) (|n'#2| T@U) ) (!  (=> (<= (U_2_int |n#4|) (U_2_int |n'#2|)) (<= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@6 |f#0@@11| ($Box intType |n#4|)))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@6 |f#0@@11| ($Box intType |n'#2|))))))
 :qid |Ackermanndfy.113:10|
 :skolemid |604|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@6 |f#0@@11| ($Box intType |n'#2|))) ($Unbox intType (Apply1 TInt TInt $Heap@@6 |f#0@@11| ($Box intType |n#4|))))
)))) (and (<= |n#0@@5| |n'#0@@0|) (= (ControlFlow 0 3) 2)))) anon0_correct))))
