...
(set-info :boogie-vc-id Impl$$_module.__default.GcdSubtractAlt_split0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (and (<= (LitInt 1) |x#0@@10|) (<= (LitInt 1) |y#0@@3|)) (and (<= (LitInt 1) |p#0@@2|) true)) (and (and (<= (LitInt 1) |a#0_0|) true) (and (<= (LitInt 1) |b#0_0|) true))) (=> (and (and (and (and (and (and ($Is SetType |common#0@@1| (TSet Tclass._module.pos)) ($IsAlloc SetType |common#0@@1| (TSet Tclass._module.pos) $Heap@@1)) true) (and (<= (LitInt 1) |a#2_0|) true)) (and (and (<= (LitInt 1) |b#2_0|) true) (= 6 $FunctionContextHeight))) (and (and (and (< |x#0@@10| |y#0@@3|) (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (|_module.__default.Gcd#canCall| |x#0@@10| |y#0@@3|) (|_module.__default.Gcd#canCall| |y#0@@3| |x#0@@10|)) (= (_module.__default.Gcd reveal__module._default.Gcd |x#0@@10| |y#0@@3|) (_module.__default.Gcd reveal__module._default.Gcd |y#0@@3| |x#0@@10|))))) (and (and (and (and (= $Heap@@1 $Heap@0) ($IsAlloc intType (int_2_U |x#0@@10|) Tclass._module.pos $Heap@0)) (and ($IsAlloc intType (int_2_U |y#0@@3|) Tclass._module.pos $Heap@0) (|_module.__default.Gcd#canCall| |x#0@@10| |y#0@@3|))) (and (and (|_module.__default.Gcd#canCall| |x#0@@10| |y#0@@3|) (= |p#0@0| (_module.__default.Gcd reveal__module._default.Gcd |x#0@@10| |y#0@@3|))) (and ($IsAlloc intType (int_2_U |p#0@0|) Tclass._module.pos $Heap@0) ($Is intType (int_2_U (- |y#0@@3| |x#0@@10|)) Tclass._module.pos)))) (and (and (and (= |##x#4@0| (- |y#0@@3| |x#0@@10|)) ($IsAlloc intType (int_2_U |##x#4@0|) Tclass._module.pos $Heap@0)) (and (|_module.__default.IsFactor#canCall| |p#0@0| (- |y#0@@3| |x#0@@10|)) (|_module.__default.IsFactor#canCall| |p#0@0| (- |y#0@@3| |x#0@@10|)))) (and (and (_module.__default.IsFactor |p#0@0| (- |y#0@@3| |x#0@@10|)) ($IsAlloc intType (int_2_U |x#0@@10|) Tclass._module.pos $Heap@0)) (and (|_module.__default.Factors#canCall| |x#0@@10|) (= (ControlFlow 0 2) (- 0 1))))))) ($Is intType (int_2_U (- |y#0@@3| |x#0@@10|)) Tclass._module.pos))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
