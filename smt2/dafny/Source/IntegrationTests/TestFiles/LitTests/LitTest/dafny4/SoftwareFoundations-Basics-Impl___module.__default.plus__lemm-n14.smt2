...
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.plus__lemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.Nat| |a#0|)) (and (|$IsA#_module.Nat| |b#0|) (|$IsA#_module.Nat| |c#0|))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (forall ((|$ih#a0#0| T@U) (|$ih#b0#0| T@U) (|$ih#c0#0| T@U) ) (!  (=> (and (and (and (and ($Is DatatypeTypeType |$ih#a0#0| Tclass._module.Nat) ($Is DatatypeTypeType |$ih#b0#0| Tclass._module.Nat)) ($Is DatatypeTypeType |$ih#c0#0| Tclass._module.Nat)) (U_2_bool (Lit boolType (bool_2_U true)))) (or (< (DtRank |$ih#a0#0|) (DtRank |a#0|)) (and (= (DtRank |$ih#a0#0|) (DtRank |a#0|)) (or (< (DtRank |$ih#b0#0|) (DtRank |b#0|)) (and (= (DtRank |$ih#b0#0|) (DtRank |b#0|)) (< (DtRank |$ih#c0#0|) (DtRank |c#0|))))))) (|_module.Nat#Equal| (_module.__default.plus ($LS $LZ) (_module.__default.plus ($LS $LZ) |$ih#a0#0| |$ih#b0#0|) |$ih#c0#0|) (_module.__default.plus ($LS $LZ) |$ih#a0#0| (_module.__default.plus ($LS $LZ) |$ih#b0#0| |$ih#c0#0|))))
 :qid |SoftwareFoundationsBasicsdfy.267:18|
 :skolemid |700|
 :pattern ( (_module.__default.plus ($LS $LZ) |$ih#a0#0| (_module.__default.plus ($LS $LZ) |$ih#b0#0| |$ih#c0#0|)))
 :pattern ( (_module.__default.plus ($LS $LZ) (_module.__default.plus ($LS $LZ) |$ih#a0#0| |$ih#b0#0|) |$ih#c0#0|))
)) (= (ControlFlow 0 2) (- 0 1)))) (|_module.Nat#Equal| (_module.__default.plus ($LS ($LS $LZ)) (_module.__default.plus ($LS ($LS $LZ)) |a#0| |b#0|) |c#0|) (_module.__default.plus ($LS ($LS $LZ)) |a#0| (_module.__default.plus ($LS ($LS $LZ)) |b#0| |c#0|)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |a#0| Tclass._module.Nat) ($IsAlloc DatatypeTypeType |a#0| Tclass._module.Nat $Heap)) (|$IsA#_module.Nat| |a#0|)) (and (and ($Is DatatypeTypeType |b#0| Tclass._module.Nat) ($IsAlloc DatatypeTypeType |b#0| Tclass._module.Nat $Heap)) (|$IsA#_module.Nat| |b#0|))) (and (and (and ($Is DatatypeTypeType |c#0| Tclass._module.Nat) ($IsAlloc DatatypeTypeType |c#0| Tclass._module.Nat $Heap)) (|$IsA#_module.Nat| |c#0|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct))))
