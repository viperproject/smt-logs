...
(declare-fun |_module.__default.foo2#canCall| () Bool)
(declare-fun _module.__default.foo2 () T@U)
...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.foo2#canCall| (< 0 $FunctionContextHeight)) ($Is DatatypeTypeType _module.__default.foo2 (Tclass._System.Tuple2 TInt TInt)))))
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.foo2#canCall| (< 0 $FunctionContextHeight)) (= _module.__default.foo2 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 5))) ($Box intType (int_2_U (LitInt 10)))))))))
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.foo2#canCall| (< 0 $FunctionContextHeight)) (= _module.__default.foo2 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 5))) ($Box intType (int_2_U (LitInt 10)))))))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) |_module.__default.foo2#canCall|) (=> (and (and (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType _module.__default.foo2)) (= |let#0#0#0| (Lit DatatypeTypeType _module.__default.foo2))) (and |_module.__default.foo2#canCall| |_module.__default.foo2#canCall|)) (and (and ($Is DatatypeTypeType |let#0#0#0| (Tclass._System.Tuple2 TInt TInt)) (_System.Tuple2.___hMake2_q |let#0#0#0|)) (and (= (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |x#0@0|)) ($Box intType (int_2_U |y#0@0|))) |let#0#0#0|) (= (ControlFlow 0 2) (- 0 1))))) (= (+ |x#0@0| |y#0@0|) (LitInt 15))))))
