...
(let ((anon40_Then_correct  (and (=> (= (ControlFlow 0 31) (- 0 32)) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (|Set#IsMember| |s'#0@0| ($Box intType (int_2_U (LitInt 0))))) (exists ((|$as#x0_0#0_0| T@U) ) (|Set#IsMember| |s'#0@0| ($Box intType |$as#x0_0#0_0|))))) (=> (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (|Set#IsMember| |s'#0@0| ($Box intType (int_2_U (LitInt 0))))) (exists ((|$as#x0_0#0_0@@0| Int) ) (|Set#IsMember| |s'#0@0| ($Box intType (int_2_U |$as#x0_0#0_0@@0|))))) (=> (|Set#IsMember| |s'#0@0| ($Box intType (int_2_U |x#0_0@1|))) (and (=> (= (ControlFlow 0 31) 30) anon41_Then_correct) (=> (= (ControlFlow 0 31) 3) anon41_Else_correct)))))))
