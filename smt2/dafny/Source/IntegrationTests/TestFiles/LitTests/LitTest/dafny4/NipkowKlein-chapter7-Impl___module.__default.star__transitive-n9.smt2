...
(declare-fun _module.__default.small__step__star (T@U T@U T@U T@U T@U) Bool)
...
(declare-fun |_module.__default.small__step__star#canCall| (T@U T@U T@U T@U) Bool)
...
(assert (forall (($ly@@0 T@U) (|c#0@@0| T@U) (|s#0@@0| T@U) (|c'#0@@0| T@U) (|s'#0@@0| T@U) ) (! (= (_module.__default.small__step__star ($LS $ly@@0) |c#0@@0| |s#0@@0| |c'#0@@0| |s'#0@@0|) (_module.__default.small__step__star $ly@@0 |c#0@@0| |s#0@@0| |c'#0@@0| |s'#0@@0|))
 :qid |NipkowKleinchapter7dfy.226:17|
 :skolemid |1089|
 :pattern ( (_module.__default.small__step__star ($LS $ly@@0) |c#0@@0| |s#0@@0| |c'#0@@0| |s'#0@@0|))
)))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@1 T@U) (|c#0@@1| T@U) (|s#0@@1| T@U) (|c'#0@@1| T@U) (|s'#0@@1| T@U) ) (!  (=> (and (and (and (and ($Is DatatypeTypeType |c#0@@1| Tclass._module.com) ($Is MapType |s#0@@1| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c'#0@@1| Tclass._module.com)) ($Is MapType |s'#0@@1| (TMap (TSeq TChar) TInt))) (_module.__default.small__step ($LS $ly@@1) |c#0@@1| |s#0@@1| |c'#0@@1| |s'#0@@1|)) (exists ((|_k#0| T@U) ) (! (_module.__default.small__step_h ($LS $ly@@1) |_k#0| |c#0@@1| |s#0@@1| |c'#0@@1| |s'#0@@1|)
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |997|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@1) |_k#0| |c#0@@1| |s#0@@1| |c'#0@@1| |s'#0@@1|))
)))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |998|
 :pattern ( (_module.__default.small__step ($LS $ly@@1) |c#0@@1| |s#0@@1| |c'#0@@1| |s'#0@@1|))
))))
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@2 T@U) (|c#0@@2| T@U) (|s#0@@2| T@U) (|c'#0@@2| T@U) (|s'#0@@2| T@U) ) (!  (=> (and (and (and (and ($Is DatatypeTypeType |c#0@@2| Tclass._module.com) ($Is MapType |s#0@@2| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c'#0@@2| Tclass._module.com)) ($Is MapType |s'#0@@2| (TMap (TSeq TChar) TInt))) (_module.__default.small__step__star ($LS $ly@@2) |c#0@@2| |s#0@@2| |c'#0@@2| |s'#0@@2|)) (exists ((|_k#0@@0| T@U) ) (! (_module.__default.small__step__star_h ($LS $ly@@2) |_k#0@@0| |c#0@@2| |s#0@@2| |c'#0@@2| |s'#0@@2|)
 :qid |NipkowKleinchapter7dfy.226:17|
 :skolemid |1096|
 :pattern ( (_module.__default.small__step__star_h ($LS $ly@@2) |_k#0@@0| |c#0@@2| |s#0@@2| |c'#0@@2| |s'#0@@2|))
)))
 :qid |NipkowKleinchapter7dfy.226:17|
 :skolemid |1097|
 :pattern ( (_module.__default.small__step__star ($LS $ly@@2) |c#0@@2| |s#0@@2| |c'#0@@2| |s'#0@@2|))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@3 T@U) (|_k#0@@1| T@U) (|c#0@@3| T@U) (|s#0@@3| T@U) (|c'#0@@3| T@U) (|s'#0@@3| T@U) ) (!  (=> (or (|_module.__default.small__step_h#canCall| (Lit BoxType |_k#0@@1|) |c#0@@3| |s#0@@3| |c'#0@@3| |s'#0@@3|) (and (< 5 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |c#0@@3| Tclass._module.com) ($Is MapType |s#0@@3| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c'#0@@3| Tclass._module.com)) ($Is MapType |s'#0@@3| (TMap (TSeq TChar) TInt))))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@1|)) (=> (not (_module.com.SKIP_q |c#0@@3|)) (and (=> (_module.com.Assign_q |c#0@@3|) (let ((|a#6| (_module.com._h1 |c#0@@3|)))
 (and (|$IsA#_module.com| |c'#0@@3|) (=> (|_module.com#Equal| |c'#0@@3| |#_module.com.SKIP|) (|_module.__default.aval#canCall| |a#6| |s#0@@3|))))) (=> (not (_module.com.Assign_q |c#0@@3|)) (and (=> (_module.com.Seq_q |c#0@@3|) (let ((|c1#6| (_module.com._h3 |c#0@@3|)))
(let ((|c0#6| (_module.com._h2 |c#0@@3|)))
 (and (and (|$IsA#_module.com| |c0#6|) (=> (|_module.com#Equal| |c0#6| |#_module.com.SKIP|) (and (|$IsA#_module.com| |c'#0@@3|) (|$IsA#_module.com| |c1#6|)))) (=> (not (and (and (|_module.com#Equal| |c0#6| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@3| |c1#6|)) (|Map#Equal| |s'#0@@3| |s#0@@3|))) (forall ((|c0'#8| T@U) ) (!  (=> ($Is DatatypeTypeType |c0'#8| Tclass._module.com) (and (|$IsA#_module.com| |c'#0@@3|) (=> (|_module.com#Equal| |c'#0@@3| (|#_module.com.Seq| |c0'#8| |c1#6|)) (|_module.__default.small__step_h#canCall| (|ORD#Minus| |_k#0@@1| (|ORD#FromNat| 1)) |c0#6| |s#0@@3| |c0'#8| |s'#0@@3|))))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1020|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@3) (|ORD#Minus| |_k#0@@1| (|ORD#FromNat| 1)) |c0#6| |s#0@@3| |c0'#8| |s'#0@@3|))
...
(let ((|b#12| (_module.com._h4 |c#0@@3|)))
 (and (and (|$IsA#_module.com| |c'#0@@3|) (|$IsA#_module.com| (ite (_module.__default.bval ($LS $LZ) |b#12| |s#0@@3|) |thn#6| |els#6|))) (|_module.__default.bval#canCall| |b#12| |s#0@@3|)))))) (=> (not (_module.com.If_q |c#0@@3|)) (|$IsA#_module.com| |c'#0@@3|))))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@1|)) (ite (_module.com.SKIP_q |c#0@@3|) false (ite (_module.com.Assign_q |c#0@@3|) (let ((|a#7| (_module.com._h1 |c#0@@3|)))
(let ((|x#7| (_module.com._h0 |c#0@@3|)))
 (and (|_module.com#Equal| |c'#0@@3| |#_module.com.SKIP|) (|Map#Equal| |s'#0@@3| (|Map#Build| |s#0@@3| ($Box SeqType |x#7|) ($Box intType (int_2_U (_module.__default.aval ($LS $LZ) |a#7| |s#0@@3|)))))))) (ite (_module.com.Seq_q |c#0@@3|) (let ((|c1#7| (_module.com._h3 |c#0@@3|)))
(let ((|c0#7| (_module.com._h2 |c#0@@3|)))
 (or (and (and (|_module.com#Equal| |c0#7| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@3| |c1#7|)) (|Map#Equal| |s'#0@@3| |s#0@@3|)) (exists ((|c0'#9| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#9| Tclass._module.com) (and (|_module.com#Equal| |c'#0@@3| (|#_module.com.Seq| |c0'#9| |c1#7|)) (_module.__default.small__step_h ($LS $ly@@3) (|ORD#Minus| |_k#0@@1| (|ORD#FromNat| 1)) |c0#7| |s#0@@3| |c0'#9| |s'#0@@3|)))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1022|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@3) (|ORD#Minus| |_k#0@@1| (|ORD#FromNat| 1)) |c0#7| |s#0@@3| |c0'#9| |s'#0@@3|))
...
(let ((|b#14| (_module.com._h4 |c#0@@3|)))
 (and (|_module.com#Equal| |c'#0@@3| (ite (_module.__default.bval ($LS $LZ) |b#14| |s#0@@3|) |thn#7| |els#7|)) (|Map#Equal| |s'#0@@3| |s#0@@3|))))) (let ((|body#7| (_module.com._h8 |c#0@@3|)))
(let ((|b#15| (_module.com._h7 |c#0@@3|)))
 (and (|_module.com#Equal| |c'#0@@3| (|#_module.com.If| |b#15| (|#_module.com.Seq| |body#7| (|#_module.com.While| |b#15| |body#7|)) (Lit DatatypeTypeType |#_module.com.SKIP|))) (|Map#Equal| |s'#0@@3| |s#0@@3|))))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@1|)) (forall ((|_k'#1| T@U) ) (!  (=> (|ORD#LessThanLimit| |_k'#1| |_k#0@@1|) (|_module.__default.small__step_h#canCall| |_k'#1| |c#0@@3| |s#0@@3| |c'#0@@3| |s'#0@@3|))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1021|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@3) |_k'#1| |c#0@@3| |s#0@@3| |c'#0@@3| |s'#0@@3|))
))))) (= (_module.__default.small__step_h ($LS $ly@@3) (Lit BoxType |_k#0@@1|) |c#0@@3| |s#0@@3| |c'#0@@3| |s'#0@@3|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@1|)) (ite (_module.com.SKIP_q |c#0@@3|) false (ite (_module.com.Assign_q |c#0@@3|) (let ((|a#5| (_module.com._h1 |c#0@@3|)))
(let ((|x#5| (_module.com._h0 |c#0@@3|)))
 (and (|_module.com#Equal| |c'#0@@3| |#_module.com.SKIP|) (|Map#Equal| |s'#0@@3| (|Map#Build| |s#0@@3| ($Box SeqType |x#5|) ($Box intType (int_2_U (_module.__default.aval ($LS $LZ) |a#5| |s#0@@3|)))))))) (ite (_module.com.Seq_q |c#0@@3|) (let ((|c1#5| (_module.com._h3 |c#0@@3|)))
(let ((|c0#5| (_module.com._h2 |c#0@@3|)))
 (or (and (and (|_module.com#Equal| |c0#5| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@3| |c1#5|)) (|Map#Equal| |s'#0@@3| |s#0@@3|)) (exists ((|c0'#7| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#7| Tclass._module.com) (and (|_module.com#Equal| |c'#0@@3| (|#_module.com.Seq| |c0'#7| |c1#5|)) (_module.__default.small__step_h ($LS $ly@@3) (|ORD#Minus| |_k#0@@1| (|ORD#FromNat| 1)) |c0#5| |s#0@@3| |c0'#7| |s'#0@@3|)))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1018|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@3) (|ORD#Minus| |_k#0@@1| (|ORD#FromNat| 1)) |c0#5| |s#0@@3| |c0'#7| |s'#0@@3|))
...
(let ((|b#10| (_module.com._h4 |c#0@@3|)))
 (and (|_module.com#Equal| |c'#0@@3| (ite (_module.__default.bval ($LS $LZ) |b#10| |s#0@@3|) |thn#5| |els#5|)) (|Map#Equal| |s'#0@@3| |s#0@@3|))))) (let ((|body#5| (_module.com._h8 |c#0@@3|)))
(let ((|b#11| (_module.com._h7 |c#0@@3|)))
 (and (|_module.com#Equal| |c'#0@@3| (|#_module.com.If| |b#11| (|#_module.com.Seq| |body#5| (|#_module.com.While| |b#11| |body#5|)) (Lit DatatypeTypeType |#_module.com.SKIP|))) (|Map#Equal| |s'#0@@3| |s#0@@3|))))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@1|)) (exists ((|_k'#1@@0| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#1@@0| |_k#0@@1|) (_module.__default.small__step_h ($LS $ly@@3) |_k'#1@@0| |c#0@@3| |s#0@@3| |c'#0@@3| |s'#0@@3|))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1019|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@3) |_k'#1@@0| |c#0@@3| |s#0@@3| |c'#0@@3| |s'#0@@3|))
)))))))
 :qid |NipkowKleinchapter7dfy.154:17|
 :weight 3
 :skolemid |1023|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@3) (Lit BoxType |_k#0@@1|) |c#0@@3| |s#0@@3| |c'#0@@3| |s'#0@@3|))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@4 T@U) (|c#0@@4| T@U) (|s#0@@4| T@U) (|c'#0@@4| T@U) (|s'#0@@4| T@U) ) (!  (=> (and (and (and (and ($Is DatatypeTypeType |c#0@@4| Tclass._module.com) ($Is MapType |s#0@@4| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c'#0@@4| Tclass._module.com)) ($Is MapType |s'#0@@4| (TMap (TSeq TChar) TInt))) (exists ((|_k#0@@2| T@U) ) (! (_module.__default.small__step_h ($LS $ly@@4) |_k#0@@2| |c#0@@4| |s#0@@4| |c'#0@@4| |s'#0@@4|)
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |997|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@4) |_k#0@@2| |c#0@@4| |s#0@@4| |c'#0@@4| |s'#0@@4|))
))) (_module.__default.small__step ($LS $ly@@4) |c#0@@4| |s#0@@4| |c'#0@@4| |s'#0@@4|))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |999|
 :pattern ( (_module.__default.small__step ($LS $ly@@4) |c#0@@4| |s#0@@4| |c'#0@@4| |s'#0@@4|))
))))
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@5 T@U) (|c#0@@5| T@U) (|s#0@@5| T@U) (|c'#0@@5| T@U) (|s'#0@@5| T@U) ) (!  (=> (and (and (and (and ($Is DatatypeTypeType |c#0@@5| Tclass._module.com) ($Is MapType |s#0@@5| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c'#0@@5| Tclass._module.com)) ($Is MapType |s'#0@@5| (TMap (TSeq TChar) TInt))) (exists ((|_k#0@@3| T@U) ) (! (_module.__default.small__step__star_h ($LS $ly@@5) |_k#0@@3| |c#0@@5| |s#0@@5| |c'#0@@5| |s'#0@@5|)
 :qid |NipkowKleinchapter7dfy.226:17|
 :skolemid |1096|
 :pattern ( (_module.__default.small__step__star_h ($LS $ly@@5) |_k#0@@3| |c#0@@5| |s#0@@5| |c'#0@@5| |s'#0@@5|))
))) (_module.__default.small__step__star ($LS $ly@@5) |c#0@@5| |s#0@@5| |c'#0@@5| |s'#0@@5|))
 :qid |NipkowKleinchapter7dfy.226:17|
 :skolemid |1098|
 :pattern ( (_module.__default.small__step__star ($LS $ly@@5) |c#0@@5| |s#0@@5| |c'#0@@5| |s'#0@@5|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@8 T@U) (|c#0@@6| T@U) (|s#0@@8| T@U) (|c'#0@@6| T@U) (|s'#0@@6| T@U) ) (!  (=> (or (|_module.__default.small__step#canCall| |c#0@@6| |s#0@@8| |c'#0@@6| |s'#0@@6|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |c#0@@6| Tclass._module.com) ($Is MapType |s#0@@8| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c'#0@@6| Tclass._module.com)) ($Is MapType |s'#0@@6| (TMap (TSeq TChar) TInt))))) (and (=> (not (_module.com.SKIP_q |c#0@@6|)) (and (=> (_module.com.Assign_q |c#0@@6|) (let ((|a#1| (_module.com._h1 |c#0@@6|)))
 (and (|$IsA#_module.com| |c'#0@@6|) (=> (|_module.com#Equal| |c'#0@@6| |#_module.com.SKIP|) (|_module.__default.aval#canCall| |a#1| |s#0@@8|))))) (=> (not (_module.com.Assign_q |c#0@@6|)) (and (=> (_module.com.Seq_q |c#0@@6|) (let ((|c1#1| (_module.com._h3 |c#0@@6|)))
(let ((|c0#1| (_module.com._h2 |c#0@@6|)))
 (and (and (|$IsA#_module.com| |c0#1|) (=> (|_module.com#Equal| |c0#1| |#_module.com.SKIP|) (and (|$IsA#_module.com| |c'#0@@6|) (|$IsA#_module.com| |c1#1|)))) (=> (not (and (and (|_module.com#Equal| |c0#1| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@6| |c1#1|)) (|Map#Equal| |s'#0@@6| |s#0@@8|))) (forall ((|c0'#1| T@U) ) (!  (=> ($Is DatatypeTypeType |c0'#1| Tclass._module.com) (and (|$IsA#_module.com| |c'#0@@6|) (=> (|_module.com#Equal| |c'#0@@6| (|#_module.com.Seq| |c0'#1| |c1#1|)) (|_module.__default.small__step#canCall| |c0#1| |s#0@@8| |c0'#1| |s'#0@@6|))))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |995|
 :pattern ( (_module.__default.small__step $ly@@8 |c0#1| |s#0@@8| |c0'#1| |s'#0@@6|))
 :pattern ( (|#_module.com.Seq| |c0'#1| |c1#1|))
))))))) (=> (not (_module.com.Seq_q |c#0@@6|)) (and (=> (_module.com.If_q |c#0@@6|) (let ((|els#1| (_module.com._h6 |c#0@@6|)))
(let ((|thn#1| (_module.com._h5 |c#0@@6|)))
(let ((|b#2| (_module.com._h4 |c#0@@6|)))
 (and (and (|$IsA#_module.com| |c'#0@@6|) (|$IsA#_module.com| (ite (_module.__default.bval ($LS $LZ) |b#2| |s#0@@8|) |thn#1| |els#1|))) (|_module.__default.bval#canCall| |b#2| |s#0@@8|)))))) (=> (not (_module.com.If_q |c#0@@6|)) (|$IsA#_module.com| |c'#0@@6|)))))))) (= (_module.__default.small__step ($LS $ly@@8) |c#0@@6| |s#0@@8| |c'#0@@6| |s'#0@@6|) (ite (_module.com.SKIP_q |c#0@@6|) false (ite (_module.com.Assign_q |c#0@@6|) (let ((|a#0@@0| (_module.com._h1 |c#0@@6|)))
(let ((|x#0| (_module.com._h0 |c#0@@6|)))
 (and (|_module.com#Equal| |c'#0@@6| |#_module.com.SKIP|) (|Map#Equal| |s'#0@@6| (|Map#Build| |s#0@@8| ($Box SeqType |x#0|) ($Box intType (int_2_U (_module.__default.aval ($LS $LZ) |a#0@@0| |s#0@@8|)))))))) (ite (_module.com.Seq_q |c#0@@6|) (let ((|c1#0| (_module.com._h3 |c#0@@6|)))
(let ((|c0#0| (_module.com._h2 |c#0@@6|)))
 (or (and (and (|_module.com#Equal| |c0#0| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@6| |c1#0|)) (|Map#Equal| |s'#0@@6| |s#0@@8|)) (exists ((|c0'#0| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#0| Tclass._module.com) (and (|_module.com#Equal| |c'#0@@6| (|#_module.com.Seq| |c0'#0| |c1#0|)) (_module.__default.small__step $ly@@8 |c0#0| |s#0@@8| |c0'#0| |s'#0@@6|)))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |994|
 :pattern ( (_module.__default.small__step $ly@@8 |c0#0| |s#0@@8| |c0'#0| |s'#0@@6|))
 :pattern ( (|#_module.com.Seq| |c0'#0| |c1#0|))
))))) (ite (_module.com.If_q |c#0@@6|) (let ((|els#0| (_module.com._h6 |c#0@@6|)))
(let ((|thn#0| (_module.com._h5 |c#0@@6|)))
(let ((|b#0@@0| (_module.com._h4 |c#0@@6|)))
 (and (|_module.com#Equal| |c'#0@@6| (ite (_module.__default.bval ($LS $LZ) |b#0@@0| |s#0@@8|) |thn#0| |els#0|)) (|Map#Equal| |s'#0@@6| |s#0@@8|))))) (let ((|body#0| (_module.com._h8 |c#0@@6|)))
(let ((|b#1| (_module.com._h7 |c#0@@6|)))
 (and (|_module.com#Equal| |c'#0@@6| (|#_module.com.If| |b#1| (|#_module.com.Seq| |body#0| (|#_module.com.While| |b#1| |body#0|)) (Lit DatatypeTypeType |#_module.com.SKIP|))) (|Map#Equal| |s'#0@@6| |s#0@@8|)))))))))))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |996|
 :pattern ( (_module.__default.small__step ($LS $ly@@8) |c#0@@6| |s#0@@8| |c'#0@@6| |s'#0@@6|))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@9 T@U) (|_k#0@@4| T@U) (|c#0@@7| T@U) (|s#0@@9| T@U) (|c'#0@@7| T@U) (|s'#0@@7| T@U) ) (!  (=> (or (|_module.__default.small__step__star_h#canCall| |_k#0@@4| |c#0@@7| |s#0@@9| |c'#0@@7| |s'#0@@7|) (and (< 6 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |c#0@@7| Tclass._module.com) ($Is MapType |s#0@@9| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c'#0@@7| Tclass._module.com)) ($Is MapType |s'#0@@7| (TMap (TSeq TChar) TInt))))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (and (and (|$IsA#_module.com| |c#0@@7|) (|$IsA#_module.com| |c'#0@@7|)) (=> (not (and (|_module.com#Equal| |c#0@@7| |c'#0@@7|) (|Map#Equal| |s#0@@9| |s'#0@@7|))) (forall ((|c''#3| T@U) (|s''#3| T@U) ) (!  (=> (and ($Is DatatypeTypeType |c''#3| Tclass._module.com) ($Is MapType |s''#3| (TMap (TSeq TChar) TInt))) (and (|_module.__default.small__step#canCall| |c#0@@7| |s#0@@9| |c''#3| |s''#3|) (=> (_module.__default.small__step ($LS $LZ) |c#0@@7| |s#0@@9| |c''#3| |s''#3|) (|_module.__default.small__step__star_h#canCall| (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) |c''#3| |s''#3| |c'#0@@7| |s'#0@@7|))))
 :qid |NipkowKleinchapter7dfy.229:10|
 :skolemid |1112|
 :pattern ( (_module.__default.small__step__star_h $ly@@9 (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) |c''#3| |s''#3| |c'#0@@7| |s'#0@@7|))
 :pattern ( (_module.__default.small__step ($LS $LZ) |c#0@@7| |s#0@@9| |c''#3| |s''#3|))
))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (or (and (|_module.com#Equal| |c#0@@7| |c'#0@@7|) (|Map#Equal| |s#0@@9| |s'#0@@7|)) (exists ((|c''#3@@0| T@U) (|s''#3@@0| T@U) ) (!  (and (and ($Is DatatypeTypeType |c''#3@@0| Tclass._module.com) ($Is MapType |s''#3@@0| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS $LZ) |c#0@@7| |s#0@@9| |c''#3@@0| |s''#3@@0|) (_module.__default.small__step__star_h $ly@@9 (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) |c''#3@@0| |s''#3@@0| |c'#0@@7| |s'#0@@7|)))
 :qid |NipkowKleinchapter7dfy.229:10|
 :skolemid |1114|
 :pattern ( (_module.__default.small__step__star_h $ly@@9 (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) |c''#3@@0| |s''#3@@0| |c'#0@@7| |s'#0@@7|))
 :pattern ( (_module.__default.small__step ($LS $LZ) |c#0@@7| |s#0@@9| |c''#3@@0| |s''#3@@0|))
)))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@4|)) (forall ((|_k'#0| T@U) ) (!  (=> (|ORD#LessThanLimit| |_k'#0| |_k#0@@4|) (|_module.__default.small__step__star_h#canCall| |_k'#0| |c#0@@7| |s#0@@9| |c'#0@@7| |s'#0@@7|))
 :qid |NipkowKleinchapter7dfy.226:17|
 :skolemid |1113|
 :pattern ( (_module.__default.small__step__star_h $ly@@9 |_k'#0| |c#0@@7| |s#0@@9| |c'#0@@7| |s'#0@@7|))
))))) (= (_module.__default.small__step__star_h ($LS $ly@@9) |_k#0@@4| |c#0@@7| |s#0@@9| |c'#0@@7| |s'#0@@7|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (or (and (|_module.com#Equal| |c#0@@7| |c'#0@@7|) (|Map#Equal| |s#0@@9| |s'#0@@7|)) (exists ((|c''#3@@1| T@U) (|s''#3@@1| T@U) ) (!  (and (and ($Is DatatypeTypeType |c''#3@@1| Tclass._module.com) ($Is MapType |s''#3@@1| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS $LZ) |c#0@@7| |s#0@@9| |c''#3@@1| |s''#3@@1|) (_module.__default.small__step__star_h $ly@@9 (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) |c''#3@@1| |s''#3@@1| |c'#0@@7| |s'#0@@7|)))
 :qid |NipkowKleinchapter7dfy.229:10|
 :skolemid |1110|
 :pattern ( (_module.__default.small__step__star_h $ly@@9 (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) |c''#3@@1| |s''#3@@1| |c'#0@@7| |s'#0@@7|))
 :pattern ( (_module.__default.small__step ($LS $LZ) |c#0@@7| |s#0@@9| |c''#3@@1| |s''#3@@1|))
)))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@4|)) (exists ((|_k'#0@@0| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#0@@0| |_k#0@@4|) (_module.__default.small__step__star_h $ly@@9 |_k'#0@@0| |c#0@@7| |s#0@@9| |c'#0@@7| |s'#0@@7|))
 :qid |NipkowKleinchapter7dfy.226:17|
 :skolemid |1111|
 :pattern ( (_module.__default.small__step__star_h $ly@@9 |_k'#0@@0| |c#0@@7| |s#0@@9| |c'#0@@7| |s'#0@@7|))
)))))))
 :qid |NipkowKleinchapter7dfy.226:17|
 :skolemid |1115|
 :pattern ( (_module.__default.small__step__star_h ($LS $ly@@9) |_k#0@@4| |c#0@@7| |s#0@@9| |c'#0@@7| |s'#0@@7|))
))))
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@10 T@U) (|_k#0@@5| T@U) (|c#0@@8| T@U) (|s#0@@10| T@U) (|c'#0@@8| T@U) (|s'#0@@8| T@U) ) (!  (=> (or (|_module.__default.small__step__star_h#canCall| (Lit BoxType |_k#0@@5|) (Lit DatatypeTypeType |c#0@@8|) (Lit MapType |s#0@@10|) (Lit DatatypeTypeType |c'#0@@8|) (Lit MapType |s'#0@@8|)) (and (< 6 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |c#0@@8| Tclass._module.com) ($Is MapType |s#0@@10| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c'#0@@8| Tclass._module.com)) ($Is MapType |s'#0@@8| (TMap (TSeq TChar) TInt))))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@5|)) (and (and (|$IsA#_module.com| (Lit DatatypeTypeType |c#0@@8|)) (|$IsA#_module.com| (Lit DatatypeTypeType |c'#0@@8|))) (=> (not (and (|_module.com#Equal| |c#0@@8| |c'#0@@8|) (|Map#Equal| |s#0@@10| |s'#0@@8|))) (forall ((|c''#5| T@U) (|s''#5| T@U) ) (!  (=> (and ($Is DatatypeTypeType |c''#5| Tclass._module.com) ($Is MapType |s''#5| (TMap (TSeq TChar) TInt))) (and (|_module.__default.small__step#canCall| (Lit DatatypeTypeType |c#0@@8|) (Lit MapType |s#0@@10|) |c''#5| |s''#5|) (=> (_module.__default.small__step ($LS $LZ) (Lit DatatypeTypeType |c#0@@8|) (Lit MapType |s#0@@10|) |c''#5| |s''#5|) (|_module.__default.small__step__star_h#canCall| (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |c''#5| |s''#5| (Lit DatatypeTypeType |c'#0@@8|) (Lit MapType |s'#0@@8|)))))
 :qid |NipkowKleinchapter7dfy.229:10|
 :skolemid |1124|
 :pattern ( (_module.__default.small__step__star_h ($LS $ly@@10) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |c''#5| |s''#5| |c'#0@@8| |s'#0@@8|))
 :pattern ( (_module.__default.small__step ($LS $LZ) |c#0@@8| |s#0@@10| |c''#5| |s''#5|))
))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@5|)) (or (and (|_module.com#Equal| |c#0@@8| |c'#0@@8|) (|Map#Equal| |s#0@@10| |s'#0@@8|)) (exists ((|c''#5@@0| T@U) (|s''#5@@0| T@U) ) (!  (and (and ($Is DatatypeTypeType |c''#5@@0| Tclass._module.com) ($Is MapType |s''#5@@0| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS $LZ) (Lit DatatypeTypeType |c#0@@8|) (Lit MapType |s#0@@10|) |c''#5@@0| |s''#5@@0|) (_module.__default.small__step__star_h ($LS $ly@@10) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |c''#5@@0| |s''#5@@0| (Lit DatatypeTypeType |c'#0@@8|) (Lit MapType |s'#0@@8|))))
 :qid |NipkowKleinchapter7dfy.229:10|
 :skolemid |1126|
 :pattern ( (_module.__default.small__step__star_h ($LS $ly@@10) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |c''#5@@0| |s''#5@@0| |c'#0@@8| |s'#0@@8|))
 :pattern ( (_module.__default.small__step ($LS $LZ) |c#0@@8| |s#0@@10| |c''#5@@0| |s''#5@@0|))
)))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@5|)) (forall ((|_k'#2| T@U) ) (!  (=> (|ORD#LessThanLimit| |_k'#2| |_k#0@@5|) (|_module.__default.small__step__star_h#canCall| |_k'#2| |c#0@@8| |s#0@@10| |c'#0@@8| |s'#0@@8|))
 :qid |NipkowKleinchapter7dfy.226:17|
 :skolemid |1125|
 :pattern ( (_module.__default.small__step__star_h ($LS $ly@@10) |_k'#2| |c#0@@8| |s#0@@10| |c'#0@@8| |s'#0@@8|))
))))) (= (_module.__default.small__step__star_h ($LS $ly@@10) (Lit BoxType |_k#0@@5|) (Lit DatatypeTypeType |c#0@@8|) (Lit MapType |s#0@@10|) (Lit DatatypeTypeType |c'#0@@8|) (Lit MapType |s'#0@@8|))  (and (=> (< 0 (|ORD#Offset| |_k#0@@5|)) (or (and (|_module.com#Equal| |c#0@@8| |c'#0@@8|) (|Map#Equal| |s#0@@10| |s'#0@@8|)) (exists ((|c''#5@@1| T@U) (|s''#5@@1| T@U) ) (!  (and (and ($Is DatatypeTypeType |c''#5@@1| Tclass._module.com) ($Is MapType |s''#5@@1| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS $LZ) (Lit DatatypeTypeType |c#0@@8|) (Lit MapType |s#0@@10|) |c''#5@@1| |s''#5@@1|) (_module.__default.small__step__star_h ($LS $ly@@10) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |c''#5@@1| |s''#5@@1| (Lit DatatypeTypeType |c'#0@@8|) (Lit MapType |s'#0@@8|))))
 :qid |NipkowKleinchapter7dfy.229:10|
 :skolemid |1122|
 :pattern ( (_module.__default.small__step__star_h ($LS $ly@@10) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |c''#5@@1| |s''#5@@1| |c'#0@@8| |s'#0@@8|))
 :pattern ( (_module.__default.small__step ($LS $LZ) |c#0@@8| |s#0@@10| |c''#5@@1| |s''#5@@1|))
)))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@5|)) (exists ((|_k'#2@@0| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#2@@0| |_k#0@@5|) (_module.__default.small__step__star_h ($LS $ly@@10) |_k'#2@@0| |c#0@@8| |s#0@@10| |c'#0@@8| |s'#0@@8|))
 :qid |NipkowKleinchapter7dfy.226:17|
 :skolemid |1123|
 :pattern ( (_module.__default.small__step__star_h ($LS $ly@@10) |_k'#2@@0| |c#0@@8| |s#0@@10| |c'#0@@8| |s'#0@@8|))
)))))))
 :qid |NipkowKleinchapter7dfy.226:17|
 :weight 3
 :skolemid |1127|
 :pattern ( (_module.__default.small__step__star_h ($LS $ly@@10) (Lit BoxType |_k#0@@5|) (Lit DatatypeTypeType |c#0@@8|) (Lit MapType |s#0@@10|) (Lit DatatypeTypeType |c'#0@@8|) (Lit MapType |s'#0@@8|)))
))))
(assert (forall (($ly@@11 T@U) (|b#0@@1| T@U) (|s#0@@11| T@U) ) (! (= (_module.__default.bval ($LS $ly@@11) |b#0@@1| |s#0@@11|) (_module.__default.bval $ly@@11 |b#0@@1| |s#0@@11|))
 :qid |NipkowKleinchapter7dfy.25:16|
 :skolemid |708|
 :pattern ( (_module.__default.bval ($LS $ly@@11) |b#0@@1| |s#0@@11|))
)))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@12 T@U) (|c#0@@9| T@U) (|s#0@@12| T@U) (|c'#0@@9| T@U) (|s'#0@@9| T@U) (|_k#0@@6| T@U) ) (!  (=> (and (and (and (and ($Is DatatypeTypeType |c#0@@9| Tclass._module.com) ($Is MapType |s#0@@12| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c'#0@@9| Tclass._module.com)) ($Is MapType |s'#0@@9| (TMap (TSeq TChar) TInt))) (= |_k#0@@6| (|ORD#FromNat| 0))) (not (_module.__default.small__step_h $ly@@12 |_k#0@@6| |c#0@@9| |s#0@@12| |c'#0@@9| |s'#0@@9|)))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1000|
 :pattern ( (_module.__default.small__step_h $ly@@12 |_k#0@@6| |c#0@@9| |s#0@@12| |c'#0@@9| |s'#0@@9|))
))))
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@13 T@U) (|c#0@@10| T@U) (|s#0@@13| T@U) (|c'#0@@10| T@U) (|s'#0@@10| T@U) (|_k#0@@7| T@U) ) (!  (=> (and (and (and (and ($Is DatatypeTypeType |c#0@@10| Tclass._module.com) ($Is MapType |s#0@@13| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c'#0@@10| Tclass._module.com)) ($Is MapType |s'#0@@10| (TMap (TSeq TChar) TInt))) (= |_k#0@@7| (|ORD#FromNat| 0))) (not (_module.__default.small__step__star_h $ly@@13 |_k#0@@7| |c#0@@10| |s#0@@13| |c'#0@@10| |s'#0@@10|)))
 :qid |NipkowKleinchapter7dfy.226:17|
 :skolemid |1099|
 :pattern ( (_module.__default.small__step__star_h $ly@@13 |_k#0@@7| |c#0@@10| |s#0@@13| |c'#0@@10| |s'#0@@10|))
))))
...
(assert (forall (($ly@@14 T@U) (|a#0@@1| T@U) (|s#0@@14| T@U) ) (! (= (_module.__default.aval ($LS $ly@@14) |a#0@@1| |s#0@@14|) (_module.__default.aval $ly@@14 |a#0@@1| |s#0@@14|))
 :qid |NipkowKleinchapter7dfy.16:16|
 :skolemid |699|
 :pattern ( (_module.__default.aval ($LS $ly@@14) |a#0@@1| |s#0@@14|))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@15 T@U) (|b#0@@2| T@U) (|s#0@@15| T@U) ) (!  (=> (or (|_module.__default.bval#canCall| |b#0@@2| |s#0@@15|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |b#0@@2| Tclass._module.bexp) ($Is MapType |s#0@@15| (TMap (TSeq TChar) TInt))))) (and (=> (not (_module.bexp.Bc_q |b#0@@2|)) (and (=> (_module.bexp.Not_q |b#0@@2|) (let ((|b#2@@0| (_module.bexp.op |b#0@@2|)))
(|_module.__default.bval#canCall| |b#2@@0| |s#0@@15|))) (=> (not (_module.bexp.Not_q |b#0@@2|)) (and (=> (_module.bexp.And_q |b#0@@2|) (let ((|b1#1| (_module.bexp._1 |b#0@@2|)))
(let ((|b0#1| (_module.bexp._0 |b#0@@2|)))
 (and (|_module.__default.bval#canCall| |b0#1| |s#0@@15|) (=> (_module.__default.bval $ly@@15 |b0#1| |s#0@@15|) (|_module.__default.bval#canCall| |b1#1| |s#0@@15|)))))) (=> (not (_module.bexp.And_q |b#0@@2|)) (let ((|a1#1| (_module.bexp.a1 |b#0@@2|)))
(let ((|a0#1| (_module.bexp.a0 |b#0@@2|)))
 (and (|_module.__default.aval#canCall| |a0#1| |s#0@@15|) (|_module.__default.aval#canCall| |a1#1| |s#0@@15|))))))))) (= (_module.__default.bval ($LS $ly@@15) |b#0@@2| |s#0@@15|) (ite (_module.bexp.Bc_q |b#0@@2|) (let ((|v#0| (_module.bexp.v |b#0@@2|)))
|v#0|) (ite (_module.bexp.Not_q |b#0@@2|) (let ((|b#1@@0| (_module.bexp.op |b#0@@2|)))
 (not (_module.__default.bval $ly@@15 |b#1@@0| |s#0@@15|))) (ite (_module.bexp.And_q |b#0@@2|) (let ((|b1#0| (_module.bexp._1 |b#0@@2|)))
(let ((|b0#0| (_module.bexp._0 |b#0@@2|)))
 (and (_module.__default.bval $ly@@15 |b0#0| |s#0@@15|) (_module.__default.bval $ly@@15 |b1#0| |s#0@@15|)))) (let ((|a1#0| (_module.bexp.a1 |b#0@@2|)))
(let ((|a0#0| (_module.bexp.a0 |b#0@@2|)))
(< (_module.__default.aval ($LS $LZ) |a0#0| |s#0@@15|) (_module.__default.aval ($LS $LZ) |a1#0| |s#0@@15|))))))))))
 :qid |NipkowKleinchapter7dfy.25:16|
 :skolemid |713|
 :pattern ( (_module.__default.bval ($LS $ly@@15) |b#0@@2| |s#0@@15|))
))))
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@16 T@U) (|_k#0@@8| T@U) (|c#0@@11| T@U) (|s#0@@16| T@U) (|c'#0@@11| T@U) (|s'#0@@11| T@U) ) (!  (=> (or (|_module.__default.small__step__star_h#canCall| (Lit BoxType |_k#0@@8|) |c#0@@11| |s#0@@16| |c'#0@@11| |s'#0@@11|) (and (< 6 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |c#0@@11| Tclass._module.com) ($Is MapType |s#0@@16| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c'#0@@11| Tclass._module.com)) ($Is MapType |s'#0@@11| (TMap (TSeq TChar) TInt))))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@8|)) (and (and (|$IsA#_module.com| |c#0@@11|) (|$IsA#_module.com| |c'#0@@11|)) (=> (not (and (|_module.com#Equal| |c#0@@11| |c'#0@@11|) (|Map#Equal| |s#0@@16| |s'#0@@11|))) (forall ((|c''#4| T@U) (|s''#4| T@U) ) (!  (=> (and ($Is DatatypeTypeType |c''#4| Tclass._module.com) ($Is MapType |s''#4| (TMap (TSeq TChar) TInt))) (and (|_module.__default.small__step#canCall| |c#0@@11| |s#0@@16| |c''#4| |s''#4|) (=> (_module.__default.small__step ($LS $LZ) |c#0@@11| |s#0@@16| |c''#4| |s''#4|) (|_module.__default.small__step__star_h#canCall| (|ORD#Minus| |_k#0@@8| (|ORD#FromNat| 1)) |c''#4| |s''#4| |c'#0@@11| |s'#0@@11|))))
 :qid |NipkowKleinchapter7dfy.229:10|
 :skolemid |1118|
 :pattern ( (_module.__default.small__step__star_h ($LS $ly@@16) (|ORD#Minus| |_k#0@@8| (|ORD#FromNat| 1)) |c''#4| |s''#4| |c'#0@@11| |s'#0@@11|))
 :pattern ( (_module.__default.small__step ($LS $LZ) |c#0@@11| |s#0@@16| |c''#4| |s''#4|))
))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@8|)) (or (and (|_module.com#Equal| |c#0@@11| |c'#0@@11|) (|Map#Equal| |s#0@@16| |s'#0@@11|)) (exists ((|c''#4@@0| T@U) (|s''#4@@0| T@U) ) (!  (and (and ($Is DatatypeTypeType |c''#4@@0| Tclass._module.com) ($Is MapType |s''#4@@0| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS $LZ) |c#0@@11| |s#0@@16| |c''#4@@0| |s''#4@@0|) (_module.__default.small__step__star_h ($LS $ly@@16) (|ORD#Minus| |_k#0@@8| (|ORD#FromNat| 1)) |c''#4@@0| |s''#4@@0| |c'#0@@11| |s'#0@@11|)))
 :qid |NipkowKleinchapter7dfy.229:10|
 :skolemid |1120|
 :pattern ( (_module.__default.small__step__star_h ($LS $ly@@16) (|ORD#Minus| |_k#0@@8| (|ORD#FromNat| 1)) |c''#4@@0| |s''#4@@0| |c'#0@@11| |s'#0@@11|))
 :pattern ( (_module.__default.small__step ($LS $LZ) |c#0@@11| |s#0@@16| |c''#4@@0| |s''#4@@0|))
)))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@8|)) (forall ((|_k'#1@@1| T@U) ) (!  (=> (|ORD#LessThanLimit| |_k'#1@@1| |_k#0@@8|) (|_module.__default.small__step__star_h#canCall| |_k'#1@@1| |c#0@@11| |s#0@@16| |c'#0@@11| |s'#0@@11|))
 :qid |NipkowKleinchapter7dfy.226:17|
 :skolemid |1119|
 :pattern ( (_module.__default.small__step__star_h ($LS $ly@@16) |_k'#1@@1| |c#0@@11| |s#0@@16| |c'#0@@11| |s'#0@@11|))
))))) (= (_module.__default.small__step__star_h ($LS $ly@@16) (Lit BoxType |_k#0@@8|) |c#0@@11| |s#0@@16| |c'#0@@11| |s'#0@@11|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@8|)) (or (and (|_module.com#Equal| |c#0@@11| |c'#0@@11|) (|Map#Equal| |s#0@@16| |s'#0@@11|)) (exists ((|c''#4@@1| T@U) (|s''#4@@1| T@U) ) (!  (and (and ($Is DatatypeTypeType |c''#4@@1| Tclass._module.com) ($Is MapType |s''#4@@1| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS $LZ) |c#0@@11| |s#0@@16| |c''#4@@1| |s''#4@@1|) (_module.__default.small__step__star_h ($LS $ly@@16) (|ORD#Minus| |_k#0@@8| (|ORD#FromNat| 1)) |c''#4@@1| |s''#4@@1| |c'#0@@11| |s'#0@@11|)))
 :qid |NipkowKleinchapter7dfy.229:10|
 :skolemid |1116|
 :pattern ( (_module.__default.small__step__star_h ($LS $ly@@16) (|ORD#Minus| |_k#0@@8| (|ORD#FromNat| 1)) |c''#4@@1| |s''#4@@1| |c'#0@@11| |s'#0@@11|))
 :pattern ( (_module.__default.small__step ($LS $LZ) |c#0@@11| |s#0@@16| |c''#4@@1| |s''#4@@1|))
)))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@8|)) (exists ((|_k'#1@@2| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#1@@2| |_k#0@@8|) (_module.__default.small__step__star_h ($LS $ly@@16) |_k'#1@@2| |c#0@@11| |s#0@@16| |c'#0@@11| |s'#0@@11|))
 :qid |NipkowKleinchapter7dfy.226:17|
 :skolemid |1117|
 :pattern ( (_module.__default.small__step__star_h ($LS $ly@@16) |_k'#1@@2| |c#0@@11| |s#0@@16| |c'#0@@11| |s'#0@@11|))
)))))))
 :qid |NipkowKleinchapter7dfy.226:17|
 :weight 3
 :skolemid |1121|
 :pattern ( (_module.__default.small__step__star_h ($LS $ly@@16) (Lit BoxType |_k#0@@8|) |c#0@@11| |s#0@@16| |c'#0@@11| |s'#0@@11|))
))))
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@17 T@U) (|c#0@@12| T@U) (|s#0@@17| T@U) (|c'#0@@12| T@U) (|s'#0@@12| T@U) ) (!  (=> (or (|_module.__default.small__step__star#canCall| |c#0@@12| |s#0@@17| |c'#0@@12| |s'#0@@12|) (and (< 5 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |c#0@@12| Tclass._module.com) ($Is MapType |s#0@@17| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c'#0@@12| Tclass._module.com)) ($Is MapType |s'#0@@12| (TMap (TSeq TChar) TInt))))) (and (and (and (|$IsA#_module.com| |c#0@@12|) (|$IsA#_module.com| |c'#0@@12|)) (=> (not (and (|_module.com#Equal| |c#0@@12| |c'#0@@12|) (|Map#Equal| |s#0@@17| |s'#0@@12|))) (forall ((|c''#0| T@U) (|s''#0| T@U) ) (!  (=> (and ($Is DatatypeTypeType |c''#0| Tclass._module.com) ($Is MapType |s''#0| (TMap (TSeq TChar) TInt))) (and (|_module.__default.small__step#canCall| |c#0@@12| |s#0@@17| |c''#0| |s''#0|) (=> (_module.__default.small__step ($LS $LZ) |c#0@@12| |s#0@@17| |c''#0| |s''#0|) (|_module.__default.small__step__star#canCall| |c''#0| |s''#0| |c'#0@@12| |s'#0@@12|))))
 :qid |NipkowKleinchapter7dfy.229:10|
 :skolemid |1094|
 :pattern ( (_module.__default.small__step__star $ly@@17 |c''#0| |s''#0| |c'#0@@12| |s'#0@@12|))
 :pattern ( (_module.__default.small__step ($LS $LZ) |c#0@@12| |s#0@@17| |c''#0| |s''#0|))
)))) (= (_module.__default.small__step__star ($LS $ly@@17) |c#0@@12| |s#0@@17| |c'#0@@12| |s'#0@@12|)  (or (and (|_module.com#Equal| |c#0@@12| |c'#0@@12|) (|Map#Equal| |s#0@@17| |s'#0@@12|)) (exists ((|c''#0@@0| T@U) (|s''#0@@0| T@U) ) (!  (and (and ($Is DatatypeTypeType |c''#0@@0| Tclass._module.com) ($Is MapType |s''#0@@0| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS $LZ) |c#0@@12| |s#0@@17| |c''#0@@0| |s''#0@@0|) (_module.__default.small__step__star $ly@@17 |c''#0@@0| |s''#0@@0| |c'#0@@12| |s'#0@@12|)))
 :qid |NipkowKleinchapter7dfy.229:10|
 :skolemid |1093|
 :pattern ( (_module.__default.small__step__star $ly@@17 |c''#0@@0| |s''#0@@0| |c'#0@@12| |s'#0@@12|))
 :pattern ( (_module.__default.small__step ($LS $LZ) |c#0@@12| |s#0@@17| |c''#0@@0| |s''#0@@0|))
))))))
 :qid |NipkowKleinchapter7dfy.226:17|
 :skolemid |1095|
 :pattern ( (_module.__default.small__step__star ($LS $ly@@17) |c#0@@12| |s#0@@17| |c'#0@@12| |s'#0@@12|))
))))
...
(assert (forall (($ly@@18 T@U) (|_k#0@@9| T@U) (|c#0@@13| T@U) (|s#0@@18| T@U) (|c'#0@@13| T@U) (|s'#0@@13| T@U) ) (! (= (_module.__default.small__step_h ($LS $ly@@18) |_k#0@@9| |c#0@@13| |s#0@@18| |c'#0@@13| |s'#0@@13|) (_module.__default.small__step_h $ly@@18 |_k#0@@9| |c#0@@13| |s#0@@18| |c'#0@@13| |s'#0@@13|))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1008|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@18) |_k#0@@9| |c#0@@13| |s#0@@18| |c'#0@@13| |s'#0@@13|))
)))
(assert (forall (($ly@@19 T@U) (|_k#0@@10| T@U) (|c#0@@14| T@U) (|s#0@@19| T@U) (|c'#0@@14| T@U) (|s'#0@@14| T@U) ) (! (= (_module.__default.small__step__star_h ($LS $ly@@19) |_k#0@@10| |c#0@@14| |s#0@@19| |c'#0@@14| |s'#0@@14|) (_module.__default.small__step__star_h $ly@@19 |_k#0@@10| |c#0@@14| |s#0@@19| |c'#0@@14| |s'#0@@14|))
 :qid |NipkowKleinchapter7dfy.226:17|
 :skolemid |1106|
 :pattern ( (_module.__default.small__step__star_h ($LS $ly@@19) |_k#0@@10| |c#0@@14| |s#0@@19| |c'#0@@14| |s'#0@@14|))
)))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@20 T@U) (|_k#0@@11| T@U) (|c#0@@15| T@U) (|s#0@@20| T@U) (|c'#0@@15| T@U) (|s'#0@@15| T@U) ) (!  (=> (or (|_module.__default.small__step_h#canCall| |_k#0@@11| |c#0@@15| |s#0@@20| |c'#0@@15| |s'#0@@15|) (and (< 5 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |c#0@@15| Tclass._module.com) ($Is MapType |s#0@@20| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c'#0@@15| Tclass._module.com)) ($Is MapType |s'#0@@15| (TMap (TSeq TChar) TInt))))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@11|)) (=> (not (_module.com.SKIP_q |c#0@@15|)) (and (=> (_module.com.Assign_q |c#0@@15|) (let ((|a#3| (_module.com._h1 |c#0@@15|)))
 (and (|$IsA#_module.com| |c'#0@@15|) (=> (|_module.com#Equal| |c'#0@@15| |#_module.com.SKIP|) (|_module.__default.aval#canCall| |a#3| |s#0@@20|))))) (=> (not (_module.com.Assign_q |c#0@@15|)) (and (=> (_module.com.Seq_q |c#0@@15|) (let ((|c1#3| (_module.com._h3 |c#0@@15|)))
(let ((|c0#3| (_module.com._h2 |c#0@@15|)))
 (and (and (|$IsA#_module.com| |c0#3|) (=> (|_module.com#Equal| |c0#3| |#_module.com.SKIP|) (and (|$IsA#_module.com| |c'#0@@15|) (|$IsA#_module.com| |c1#3|)))) (=> (not (and (and (|_module.com#Equal| |c0#3| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@15| |c1#3|)) (|Map#Equal| |s'#0@@15| |s#0@@20|))) (forall ((|c0'#5| T@U) ) (!  (=> ($Is DatatypeTypeType |c0'#5| Tclass._module.com) (and (|$IsA#_module.com| |c'#0@@15|) (=> (|_module.com#Equal| |c'#0@@15| (|#_module.com.Seq| |c0'#5| |c1#3|)) (|_module.__default.small__step_h#canCall| (|ORD#Minus| |_k#0@@11| (|ORD#FromNat| 1)) |c0#3| |s#0@@20| |c0'#5| |s'#0@@15|))))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1014|
 :pattern ( (_module.__default.small__step_h $ly@@20 (|ORD#Minus| |_k#0@@11| (|ORD#FromNat| 1)) |c0#3| |s#0@@20| |c0'#5| |s'#0@@15|))
 :pattern ( (|#_module.com.Seq| |c0'#5| |c1#3|))
))))))) (=> (not (_module.com.Seq_q |c#0@@15|)) (and (=> (_module.com.If_q |c#0@@15|) (let ((|els#3| (_module.com._h6 |c#0@@15|)))
(let ((|thn#3| (_module.com._h5 |c#0@@15|)))
(let ((|b#6| (_module.com._h4 |c#0@@15|)))
 (and (and (|$IsA#_module.com| |c'#0@@15|) (|$IsA#_module.com| (ite (_module.__default.bval ($LS $LZ) |b#6| |s#0@@20|) |thn#3| |els#3|))) (|_module.__default.bval#canCall| |b#6| |s#0@@20|)))))) (=> (not (_module.com.If_q |c#0@@15|)) (|$IsA#_module.com| |c'#0@@15|))))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@11|)) (ite (_module.com.SKIP_q |c#0@@15|) false (ite (_module.com.Assign_q |c#0@@15|) (let ((|a#4| (_module.com._h1 |c#0@@15|)))
(let ((|x#4| (_module.com._h0 |c#0@@15|)))
 (and (|_module.com#Equal| |c'#0@@15| |#_module.com.SKIP|) (|Map#Equal| |s'#0@@15| (|Map#Build| |s#0@@20| ($Box SeqType |x#4|) ($Box intType (int_2_U (_module.__default.aval ($LS $LZ) |a#4| |s#0@@20|)))))))) (ite (_module.com.Seq_q |c#0@@15|) (let ((|c1#4| (_module.com._h3 |c#0@@15|)))
(let ((|c0#4| (_module.com._h2 |c#0@@15|)))
 (or (and (and (|_module.com#Equal| |c0#4| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@15| |c1#4|)) (|Map#Equal| |s'#0@@15| |s#0@@20|)) (exists ((|c0'#6| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#6| Tclass._module.com) (and (|_module.com#Equal| |c'#0@@15| (|#_module.com.Seq| |c0'#6| |c1#4|)) (_module.__default.small__step_h $ly@@20 (|ORD#Minus| |_k#0@@11| (|ORD#FromNat| 1)) |c0#4| |s#0@@20| |c0'#6| |s'#0@@15|)))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1016|
 :pattern ( (_module.__default.small__step_h $ly@@20 (|ORD#Minus| |_k#0@@11| (|ORD#FromNat| 1)) |c0#4| |s#0@@20| |c0'#6| |s'#0@@15|))
 :pattern ( (|#_module.com.Seq| |c0'#6| |c1#4|))
))))) (ite (_module.com.If_q |c#0@@15|) (let ((|els#4| (_module.com._h6 |c#0@@15|)))
(let ((|thn#4| (_module.com._h5 |c#0@@15|)))
(let ((|b#8| (_module.com._h4 |c#0@@15|)))
 (and (|_module.com#Equal| |c'#0@@15| (ite (_module.__default.bval ($LS $LZ) |b#8| |s#0@@20|) |thn#4| |els#4|)) (|Map#Equal| |s'#0@@15| |s#0@@20|))))) (let ((|body#4| (_module.com._h8 |c#0@@15|)))
(let ((|b#9| (_module.com._h7 |c#0@@15|)))
 (and (|_module.com#Equal| |c'#0@@15| (|#_module.com.If| |b#9| (|#_module.com.Seq| |body#4| (|#_module.com.While| |b#9| |body#4|)) (Lit DatatypeTypeType |#_module.com.SKIP|))) (|Map#Equal| |s'#0@@15| |s#0@@20|))))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@11|)) (forall ((|_k'#0@@1| T@U) ) (!  (=> (|ORD#LessThanLimit| |_k'#0@@1| |_k#0@@11|) (|_module.__default.small__step_h#canCall| |_k'#0@@1| |c#0@@15| |s#0@@20| |c'#0@@15| |s'#0@@15|))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1015|
 :pattern ( (_module.__default.small__step_h $ly@@20 |_k'#0@@1| |c#0@@15| |s#0@@20| |c'#0@@15| |s'#0@@15|))
))))) (= (_module.__default.small__step_h ($LS $ly@@20) |_k#0@@11| |c#0@@15| |s#0@@20| |c'#0@@15| |s'#0@@15|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@11|)) (ite (_module.com.SKIP_q |c#0@@15|) false (ite (_module.com.Assign_q |c#0@@15|) (let ((|a#2| (_module.com._h1 |c#0@@15|)))
(let ((|x#2@@0| (_module.com._h0 |c#0@@15|)))
 (and (|_module.com#Equal| |c'#0@@15| |#_module.com.SKIP|) (|Map#Equal| |s'#0@@15| (|Map#Build| |s#0@@20| ($Box SeqType |x#2@@0|) ($Box intType (int_2_U (_module.__default.aval ($LS $LZ) |a#2| |s#0@@20|)))))))) (ite (_module.com.Seq_q |c#0@@15|) (let ((|c1#2| (_module.com._h3 |c#0@@15|)))
(let ((|c0#2| (_module.com._h2 |c#0@@15|)))
 (or (and (and (|_module.com#Equal| |c0#2| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@15| |c1#2|)) (|Map#Equal| |s'#0@@15| |s#0@@20|)) (exists ((|c0'#4| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#4| Tclass._module.com) (and (|_module.com#Equal| |c'#0@@15| (|#_module.com.Seq| |c0'#4| |c1#2|)) (_module.__default.small__step_h $ly@@20 (|ORD#Minus| |_k#0@@11| (|ORD#FromNat| 1)) |c0#2| |s#0@@20| |c0'#4| |s'#0@@15|)))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1012|
 :pattern ( (_module.__default.small__step_h $ly@@20 (|ORD#Minus| |_k#0@@11| (|ORD#FromNat| 1)) |c0#2| |s#0@@20| |c0'#4| |s'#0@@15|))
 :pattern ( (|#_module.com.Seq| |c0'#4| |c1#2|))
))))) (ite (_module.com.If_q |c#0@@15|) (let ((|els#2| (_module.com._h6 |c#0@@15|)))
(let ((|thn#2| (_module.com._h5 |c#0@@15|)))
(let ((|b#4@@0| (_module.com._h4 |c#0@@15|)))
 (and (|_module.com#Equal| |c'#0@@15| (ite (_module.__default.bval ($LS $LZ) |b#4@@0| |s#0@@20|) |thn#2| |els#2|)) (|Map#Equal| |s'#0@@15| |s#0@@20|))))) (let ((|body#2| (_module.com._h8 |c#0@@15|)))
(let ((|b#5| (_module.com._h7 |c#0@@15|)))
 (and (|_module.com#Equal| |c'#0@@15| (|#_module.com.If| |b#5| (|#_module.com.Seq| |body#2| (|#_module.com.While| |b#5| |body#2|)) (Lit DatatypeTypeType |#_module.com.SKIP|))) (|Map#Equal| |s'#0@@15| |s#0@@20|))))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@11|)) (exists ((|_k'#0@@2| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#0@@2| |_k#0@@11|) (_module.__default.small__step_h $ly@@20 |_k'#0@@2| |c#0@@15| |s#0@@20| |c'#0@@15| |s'#0@@15|))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1013|
 :pattern ( (_module.__default.small__step_h $ly@@20 |_k'#0@@2| |c#0@@15| |s#0@@20| |c'#0@@15| |s'#0@@15|))
)))))))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1017|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@20) |_k#0@@11| |c#0@@15| |s#0@@20| |c'#0@@15| |s'#0@@15|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@21 T@U) (|a#0@@2| T@U) (|s#0@@21| T@U) ) (!  (=> (or (|_module.__default.aval#canCall| |a#0@@2| |s#0@@21|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |a#0@@2| Tclass._module.aexp) ($Is MapType |s#0@@21| (TMap (TSeq TChar) TInt))))) (and (=> (not (_module.aexp.N_q |a#0@@2|)) (=> (not (_module.aexp.V_q |a#0@@2|)) (let ((|a1#1@@0| (_module.aexp._1 |a#0@@2|)))
(let ((|a0#1@@0| (_module.aexp._0 |a#0@@2|)))
 (and (|_module.__default.aval#canCall| |a0#1@@0| |s#0@@21|) (|_module.__default.aval#canCall| |a1#1@@0| |s#0@@21|)))))) (= (_module.__default.aval ($LS $ly@@21) |a#0@@2| |s#0@@21|) (ite (_module.aexp.N_q |a#0@@2|) (let ((|n#0| (_module.aexp.n |a#0@@2|)))
|n#0|) (ite (_module.aexp.V_q |a#0@@2|) (let ((|x#0@@0| (_module.aexp.x |a#0@@2|)))
(ite (|Set#IsMember| (|Map#Domain| |s#0@@21|) ($Box SeqType |x#0@@0|)) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |s#0@@21|) ($Box SeqType |x#0@@0|)))) 0)) (let ((|a1#0@@0| (_module.aexp._1 |a#0@@2|)))
(let ((|a0#0@@0| (_module.aexp._0 |a#0@@2|)))
(+ (_module.__default.aval $ly@@21 |a0#0@@0| |s#0@@21|) (_module.__default.aval $ly@@21 |a1#0@@0| |s#0@@21|)))))))))
 :qid |NipkowKleinchapter7dfy.16:16|
 :skolemid |704|
 :pattern ( (_module.__default.aval ($LS $ly@@21) |a#0@@2| |s#0@@21|))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@22 T@U) (|_k#0@@12| T@U) (|c#0@@16| T@U) (|s#0@@22| T@U) (|c'#0@@16| T@U) (|s'#0@@16| T@U) ) (!  (=> (or (|_module.__default.small__step_h#canCall| (Lit BoxType |_k#0@@12|) (Lit DatatypeTypeType |c#0@@16|) (Lit MapType |s#0@@22|) (Lit DatatypeTypeType |c'#0@@16|) (Lit MapType |s'#0@@16|)) (and (< 5 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |c#0@@16| Tclass._module.com) ($Is MapType |s#0@@22| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c'#0@@16| Tclass._module.com)) ($Is MapType |s'#0@@16| (TMap (TSeq TChar) TInt))))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@12|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.com.SKIP_q (Lit DatatypeTypeType |c#0@@16|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (_module.com.Assign_q (Lit DatatypeTypeType |c#0@@16|))))) (let ((|a#9| (Lit DatatypeTypeType (_module.com._h1 (Lit DatatypeTypeType |c#0@@16|)))))
 (and (|$IsA#_module.com| (Lit DatatypeTypeType |c'#0@@16|)) (=> (|_module.com#Equal| |c'#0@@16| |#_module.com.SKIP|) (|_module.__default.aval#canCall| |a#9| (Lit MapType |s#0@@22|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.com.Assign_q (Lit DatatypeTypeType |c#0@@16|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (_module.com.Seq_q (Lit DatatypeTypeType |c#0@@16|))))) (let ((|c1#9| (Lit DatatypeTypeType (_module.com._h3 (Lit DatatypeTypeType |c#0@@16|)))))
(let ((|c0#9| (Lit DatatypeTypeType (_module.com._h2 (Lit DatatypeTypeType |c#0@@16|)))))
 (and (and (|$IsA#_module.com| |c0#9|) (=> (|_module.com#Equal| |c0#9| |#_module.com.SKIP|) (and (|$IsA#_module.com| (Lit DatatypeTypeType |c'#0@@16|)) (|$IsA#_module.com| |c1#9|)))) (=> (not (and (and (|_module.com#Equal| |c0#9| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@16| |c1#9|)) (|Map#Equal| |s'#0@@16| |s#0@@22|))) (forall ((|c0'#11| T@U) ) (!  (=> ($Is DatatypeTypeType |c0'#11| Tclass._module.com) (and (|$IsA#_module.com| (Lit DatatypeTypeType |c'#0@@16|)) (=> (|_module.com#Equal| |c'#0@@16| (|#_module.com.Seq| |c0'#11| |c1#9|)) (|_module.__default.small__step_h#canCall| (|ORD#Minus| |_k#0@@12| (|ORD#FromNat| 1)) |c0#9| (Lit MapType |s#0@@22|) |c0'#11| (Lit MapType |s'#0@@16|)))))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1026|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@22) (|ORD#Minus| |_k#0@@12| (|ORD#FromNat| 1)) |c0#9| |s#0@@22| |c0'#11| |s'#0@@16|))
...
(let ((|b#18| (Lit DatatypeTypeType (_module.com._h4 (Lit DatatypeTypeType |c#0@@16|)))))
 (and (and (|$IsA#_module.com| (Lit DatatypeTypeType |c'#0@@16|)) (|$IsA#_module.com| (ite (_module.__default.bval ($LS $LZ) |b#18| (Lit MapType |s#0@@22|)) |thn#9| |els#9|))) (|_module.__default.bval#canCall| |b#18| (Lit MapType |s#0@@22|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.com.If_q (Lit DatatypeTypeType |c#0@@16|)))))) (|$IsA#_module.com| (Lit DatatypeTypeType |c'#0@@16|)))))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@12|)) (ite (_module.com.SKIP_q (Lit DatatypeTypeType |c#0@@16|)) false (ite (_module.com.Assign_q (Lit DatatypeTypeType |c#0@@16|)) (let ((|a#10| (Lit DatatypeTypeType (_module.com._h1 (Lit DatatypeTypeType |c#0@@16|)))))
(let ((|x#10| (Lit SeqType (_module.com._h0 (Lit DatatypeTypeType |c#0@@16|)))))
 (and (|_module.com#Equal| |c'#0@@16| |#_module.com.SKIP|) (|Map#Equal| |s'#0@@16| (|Map#Build| (Lit MapType |s#0@@22|) ($Box SeqType |x#10|) ($Box intType (int_2_U (LitInt (_module.__default.aval ($LS $LZ) |a#10| (Lit MapType |s#0@@22|)))))))))) (ite (_module.com.Seq_q (Lit DatatypeTypeType |c#0@@16|)) (let ((|c1#10| (Lit DatatypeTypeType (_module.com._h3 (Lit DatatypeTypeType |c#0@@16|)))))
(let ((|c0#10| (Lit DatatypeTypeType (_module.com._h2 (Lit DatatypeTypeType |c#0@@16|)))))
 (or (and (and (|_module.com#Equal| |c0#10| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@16| |c1#10|)) (|Map#Equal| |s'#0@@16| |s#0@@22|)) (exists ((|c0'#12| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#12| Tclass._module.com) (and (|_module.com#Equal| |c'#0@@16| (|#_module.com.Seq| |c0'#12| |c1#10|)) (_module.__default.small__step_h ($LS $ly@@22) (|ORD#Minus| |_k#0@@12| (|ORD#FromNat| 1)) |c0#10| (Lit MapType |s#0@@22|) |c0'#12| (Lit MapType |s'#0@@16|))))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1028|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@22) (|ORD#Minus| |_k#0@@12| (|ORD#FromNat| 1)) |c0#10| |s#0@@22| |c0'#12| |s'#0@@16|))
...
(let ((|b#20| (Lit DatatypeTypeType (_module.com._h4 (Lit DatatypeTypeType |c#0@@16|)))))
 (and (|_module.com#Equal| |c'#0@@16| (ite (_module.__default.bval ($LS $LZ) |b#20| (Lit MapType |s#0@@22|)) |thn#10| |els#10|)) (|Map#Equal| |s'#0@@16| |s#0@@22|))))) (let ((|body#10| (Lit DatatypeTypeType (_module.com._h8 (Lit DatatypeTypeType |c#0@@16|)))))
(let ((|b#21| (Lit DatatypeTypeType (_module.com._h7 (Lit DatatypeTypeType |c#0@@16|)))))
 (and (|_module.com#Equal| |c'#0@@16| (|#_module.com.If| |b#21| (Lit DatatypeTypeType (|#_module.com.Seq| |body#10| (Lit DatatypeTypeType (|#_module.com.While| |b#21| |body#10|)))) (Lit DatatypeTypeType |#_module.com.SKIP|))) (|Map#Equal| |s'#0@@16| |s#0@@22|))))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@12|)) (forall ((|_k'#2@@1| T@U) ) (!  (=> (|ORD#LessThanLimit| |_k'#2@@1| |_k#0@@12|) (|_module.__default.small__step_h#canCall| |_k'#2@@1| |c#0@@16| |s#0@@22| |c'#0@@16| |s'#0@@16|))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1027|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@22) |_k'#2@@1| |c#0@@16| |s#0@@22| |c'#0@@16| |s'#0@@16|))
))))) (= (_module.__default.small__step_h ($LS $ly@@22) (Lit BoxType |_k#0@@12|) (Lit DatatypeTypeType |c#0@@16|) (Lit MapType |s#0@@22|) (Lit DatatypeTypeType |c'#0@@16|) (Lit MapType |s'#0@@16|))  (and (=> (< 0 (|ORD#Offset| |_k#0@@12|)) (ite (_module.com.SKIP_q (Lit DatatypeTypeType |c#0@@16|)) false (ite (_module.com.Assign_q (Lit DatatypeTypeType |c#0@@16|)) (let ((|a#8| (Lit DatatypeTypeType (_module.com._h1 (Lit DatatypeTypeType |c#0@@16|)))))
(let ((|x#8| (Lit SeqType (_module.com._h0 (Lit DatatypeTypeType |c#0@@16|)))))
 (and (|_module.com#Equal| |c'#0@@16| |#_module.com.SKIP|) (|Map#Equal| |s'#0@@16| (|Map#Build| (Lit MapType |s#0@@22|) ($Box SeqType |x#8|) ($Box intType (int_2_U (LitInt (_module.__default.aval ($LS $LZ) |a#8| (Lit MapType |s#0@@22|)))))))))) (ite (_module.com.Seq_q (Lit DatatypeTypeType |c#0@@16|)) (let ((|c1#8| (Lit DatatypeTypeType (_module.com._h3 (Lit DatatypeTypeType |c#0@@16|)))))
(let ((|c0#8| (Lit DatatypeTypeType (_module.com._h2 (Lit DatatypeTypeType |c#0@@16|)))))
 (or (and (and (|_module.com#Equal| |c0#8| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@16| |c1#8|)) (|Map#Equal| |s'#0@@16| |s#0@@22|)) (exists ((|c0'#10| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#10| Tclass._module.com) (and (|_module.com#Equal| |c'#0@@16| (|#_module.com.Seq| |c0'#10| |c1#8|)) (_module.__default.small__step_h ($LS $ly@@22) (|ORD#Minus| |_k#0@@12| (|ORD#FromNat| 1)) |c0#8| (Lit MapType |s#0@@22|) |c0'#10| (Lit MapType |s'#0@@16|))))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1024|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@22) (|ORD#Minus| |_k#0@@12| (|ORD#FromNat| 1)) |c0#8| |s#0@@22| |c0'#10| |s'#0@@16|))
...
(let ((|b#16| (Lit DatatypeTypeType (_module.com._h4 (Lit DatatypeTypeType |c#0@@16|)))))
 (and (|_module.com#Equal| |c'#0@@16| (ite (_module.__default.bval ($LS $LZ) |b#16| (Lit MapType |s#0@@22|)) |thn#8| |els#8|)) (|Map#Equal| |s'#0@@16| |s#0@@22|))))) (let ((|body#8| (Lit DatatypeTypeType (_module.com._h8 (Lit DatatypeTypeType |c#0@@16|)))))
(let ((|b#17| (Lit DatatypeTypeType (_module.com._h7 (Lit DatatypeTypeType |c#0@@16|)))))
 (and (|_module.com#Equal| |c'#0@@16| (|#_module.com.If| |b#17| (Lit DatatypeTypeType (|#_module.com.Seq| |body#8| (Lit DatatypeTypeType (|#_module.com.While| |b#17| |body#8|)))) (Lit DatatypeTypeType |#_module.com.SKIP|))) (|Map#Equal| |s'#0@@16| |s#0@@22|))))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@12|)) (exists ((|_k'#2@@2| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#2@@2| |_k#0@@12|) (_module.__default.small__step_h ($LS $ly@@22) |_k'#2@@2| |c#0@@16| |s#0@@22| |c'#0@@16| |s'#0@@16|))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1025|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@22) |_k'#2@@2| |c#0@@16| |s#0@@22| |c'#0@@16| |s'#0@@16|))
)))))))
 :qid |NipkowKleinchapter7dfy.154:17|
 :weight 3
 :skolemid |1029|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@22) (Lit BoxType |_k#0@@12|) (Lit DatatypeTypeType |c#0@@16|) (Lit MapType |s#0@@22|) (Lit DatatypeTypeType |c'#0@@16|) (Lit MapType |s'#0@@16|)))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@23 T@U) (|c#0@@17| T@U) (|s#0@@23| T@U) (|c'#0@@17| T@U) (|s'#0@@17| T@U) (|_k#0@@13| T@U) (_m T@U) (_limit T@U) ) (!  (=> (|ORD#Less| |_k#0@@13| _m) (=> (_module.__default.small__step_h $ly@@23 |_k#0@@13| |c#0@@17| |s#0@@23| |c'#0@@17| |s'#0@@17|) (_module.__default.small__step_h $ly@@23 _m |c#0@@17| |s#0@@23| |c'#0@@17| |s'#0@@17|)))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1001|
 :pattern ( (_module.__default.small__step_h $ly@@23 |_k#0@@13| |c#0@@17| |s#0@@23| |c'#0@@17| |s'#0@@17|) (|ORD#LessThanLimit| |_k#0@@13| _limit) (|ORD#LessThanLimit| _m _limit))
))))
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@24 T@U) (|c#0@@18| T@U) (|s#0@@24| T@U) (|c'#0@@18| T@U) (|s'#0@@18| T@U) (|_k#0@@14| T@U) (_m@@0 T@U) (_limit@@0 T@U) ) (!  (=> (|ORD#Less| |_k#0@@14| _m@@0) (=> (_module.__default.small__step__star_h $ly@@24 |_k#0@@14| |c#0@@18| |s#0@@24| |c'#0@@18| |s'#0@@18|) (_module.__default.small__step__star_h $ly@@24 _m@@0 |c#0@@18| |s#0@@24| |c'#0@@18| |s'#0@@18|)))
 :qid |NipkowKleinchapter7dfy.226:17|
 :skolemid |1100|
 :pattern ( (_module.__default.small__step__star_h $ly@@24 |_k#0@@14| |c#0@@18| |s#0@@24| |c'#0@@18| |s'#0@@18|) (|ORD#LessThanLimit| |_k#0@@14| _limit@@0) (|ORD#LessThanLimit| _m@@0 _limit@@0))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.star__transitive)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.com| |c0#0@@0|)) (and (|$IsA#_module.com| |c1#0@@0|) (|$IsA#_module.com| |c2#0|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#c00#0| T@U) (|$ih#s00#0| T@U) (|$ih#c10#0| T@U) (|$ih#s10#0| T@U) (|$ih#c20#0| T@U) (|$ih#s20#0| T@U) ) (!  (=> (and (and (and (and (and (and (and ($Is DatatypeTypeType |$ih#c00#0| Tclass._module.com) ($Is MapType |$ih#s00#0| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |$ih#c10#0| Tclass._module.com)) ($Is MapType |$ih#s10#0| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |$ih#c20#0| Tclass._module.com)) ($Is MapType |$ih#s20#0| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step__star ($LS $LZ) |$ih#c00#0| |$ih#s00#0| |$ih#c10#0| |$ih#s10#0|) (_module.__default.small__step__star ($LS $LZ) |$ih#c10#0| |$ih#s10#0| |$ih#c20#0| |$ih#s20#0|))) (or (< (DtRank |$ih#c00#0|) (DtRank |c0#0@@0|)) (and (= (DtRank |$ih#c00#0|) (DtRank |c0#0@@0|)) (or (and (|Set#Subset| (|Map#Domain| |$ih#s00#0|) (|Map#Domain| |s0#0|)) (not (|Set#Subset| (|Map#Domain| |s0#0|) (|Map#Domain| |$ih#s00#0|)))) (and (|Set#Equal| (|Map#Domain| |$ih#s00#0|) (|Map#Domain| |s0#0|)) (or (< (DtRank |$ih#c10#0|) (DtRank |c1#0@@0|)) (and (= (DtRank |$ih#c10#0|) (DtRank |c1#0@@0|)) (or (and (|Set#Subset| (|Map#Domain| |$ih#s10#0|) (|Map#Domain| |s1#0|)) (not (|Set#Subset| (|Map#Domain| |s1#0|) (|Map#Domain| |$ih#s10#0|)))) (and (|Set#Equal| (|Map#Domain| |$ih#s10#0|) (|Map#Domain| |s1#0|)) (or (< (DtRank |$ih#c20#0|) (DtRank |c2#0|)) (and (= (DtRank |$ih#c20#0|) (DtRank |c2#0|)) (and (|Set#Subset| (|Map#Domain| |$ih#s20#0|) (|Map#Domain| |s2#0|)) (not (|Set#Subset| (|Map#Domain| |s2#0|) (|Map#Domain| |$ih#s20#0|))))))))))))))) (_module.__default.small__step__star ($LS $LZ) |$ih#c00#0| |$ih#s00#0| |$ih#c20#0| |$ih#s20#0|))
 :qid |NipkowKleinchapter7dfy.233:23|
 :skolemid |1140|
 :pattern ( (_module.__default.small__step__star ($LS $LZ) |$ih#c00#0| |$ih#s00#0| |$ih#c20#0| |$ih#s20#0|) (_module.__default.small__step__star ($LS $LZ) |$ih#c10#0| |$ih#s10#0| |$ih#c20#0| |$ih#s20#0|))
 :pattern ( (_module.__default.small__step__star ($LS $LZ) |$ih#c10#0| |$ih#s10#0| |$ih#c20#0| |$ih#s20#0|) (_module.__default.small__step__star ($LS $LZ) |$ih#c00#0| |$ih#s00#0| |$ih#c10#0| |$ih#s10#0|))
))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.__default.small__step__star#canCall| |c0#0@@0| |s0#0| |c1#0@@0| |s1#0|) (or (_module.__default.small__step__star ($LS $LZ) |c0#0@@0| |s0#0| |c1#0@@0| |s1#0|) (or (and (|_module.com#Equal| |c0#0@@0| |c1#0@@0|) (|Map#Equal| |s0#0| |s1#0|)) (exists ((|c''#0@@1| T@U) (|s''#0@@1| T@U) ) (!  (and (and ($Is DatatypeTypeType |c''#0@@1| Tclass._module.com) ($Is MapType |s''#0@@1| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS ($LS $LZ)) |c0#0@@0| |s0#0| |c''#0@@1| |s''#0@@1|) (_module.__default.small__step__star ($LS ($LS $LZ)) |c''#0@@1| |s''#0@@1| |c1#0@@0| |s1#0|)))
 :qid |NipkowKleinchapter7dfy.229:10|
 :skolemid |1142|
 :pattern ( (_module.__default.small__step__star ($LS ($LS $LZ)) |c''#0@@1| |s''#0@@1| |c1#0@@0| |s1#0|))
 :pattern ( (_module.__default.small__step ($LS ($LS $LZ)) |c0#0@@0| |s0#0| |c''#0@@1| |s''#0@@1|))
)))))) (=> (=> (|_module.__default.small__step__star#canCall| |c0#0@@0| |s0#0| |c1#0@@0| |s1#0|) (or (_module.__default.small__step__star ($LS $LZ) |c0#0@@0| |s0#0| |c1#0@@0| |s1#0|) (or (and (|_module.com#Equal| |c0#0@@0| |c1#0@@0|) (|Map#Equal| |s0#0| |s1#0|)) (exists ((|c''#0@@2| T@U) (|s''#0@@2| T@U) ) (!  (and (and ($Is DatatypeTypeType |c''#0@@2| Tclass._module.com) ($Is MapType |s''#0@@2| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS ($LS $LZ)) |c0#0@@0| |s0#0| |c''#0@@2| |s''#0@@2|) (_module.__default.small__step__star ($LS ($LS $LZ)) |c''#0@@2| |s''#0@@2| |c1#0@@0| |s1#0|)))
 :qid |NipkowKleinchapter7dfy.229:10|
 :skolemid |1142|
 :pattern ( (_module.__default.small__step__star ($LS ($LS $LZ)) |c''#0@@2| |s''#0@@2| |c1#0@@0| |s1#0|))
 :pattern ( (_module.__default.small__step ($LS ($LS $LZ)) |c0#0@@0| |s0#0| |c''#0@@2| |s''#0@@2|))
))))) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and (|_module.__default.small__step__star#canCall| |c1#0@@0| |s1#0| |c2#0| |s2#0|) (=> (_module.__default.small__step__star ($LS $LZ) |c1#0@@0| |s1#0| |c2#0| |s2#0|) (|_module.__default.small__step__star#canCall| |c0#0@@0| |s0#0| |c2#0| |s2#0|))) (=> (_module.__default.small__step__star ($LS $LZ) |c1#0@@0| |s1#0| |c2#0| |s2#0|) (and (|_module.__default.small__step__star#canCall| |c0#0@@0| |s0#0| |c2#0| |s2#0|) (and (_module.__default.small__step__star ($LS $LZ) |c0#0@@0| |s0#0| |c2#0| |s2#0|) (or (and (|_module.com#Equal| |c0#0@@0| |c2#0|) (|Map#Equal| |s0#0| |s2#0|)) (exists ((|c''#1| T@U) (|s''#1| T@U) ) (!  (and (and ($Is DatatypeTypeType |c''#1| Tclass._module.com) ($Is MapType |s''#1| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS $LZ) |c0#0@@0| |s0#0| |c''#1| |s''#1|) (_module.__default.small__step__star ($LS $LZ) |c''#1| |s''#1| |c2#0| |s2#0|)))
 :qid |NipkowKleinchapter7dfy.229:10|
 :skolemid |1145|
 :pattern ( (_module.__default.small__step__star ($LS $LZ) |c''#1| |s''#1| |c2#0| |s2#0|))
 :pattern ( (_module.__default.small__step ($LS $LZ) |c0#0@@0| |s0#0| |c''#1| |s''#1|))
))))))) (and (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 2) (- 0 1))) (|_module.__default.small__step__star#canCall| |c0#0@@0| |s0#0| |c2#0| |s2#0|))) (or (_module.__default.small__step__star ($LS $LZ) |c0#0@@0| |s0#0| |c2#0| |s2#0|) (or (and (|_module.com#Equal| |c0#0@@0| |c2#0|) (|Map#Equal| |s0#0| |s2#0|)) (exists ((|c''#5@@2| T@U) (|s''#5@@2| T@U) ) (!  (and (and ($Is DatatypeTypeType |c''#5@@2| Tclass._module.com) ($Is MapType |s''#5@@2| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS ($LS $LZ)) |c0#0@@0| |s0#0| |c''#5@@2| |s''#5@@2|) (_module.__default.small__step__star ($LS ($LS $LZ)) |c''#5@@2| |s''#5@@2| |c2#0| |s2#0|)))
 :qid |NipkowKleinchapter7dfy.229:10|
 :skolemid |1138|
 :pattern ( (_module.__default.small__step__star ($LS ($LS $LZ)) |c''#5@@2| |s''#5@@2| |c2#0| |s2#0|))
 :pattern ( (_module.__default.small__step ($LS ($LS $LZ)) |c0#0@@0| |s0#0| |c''#5@@2| |s''#5@@2|))
)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |c0#0@@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |c0#0@@0| Tclass._module.com $Heap)) (|$IsA#_module.com| |c0#0@@0|)) (and ($Is MapType |s0#0| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |s0#0| (TMap (TSeq TChar) TInt) $Heap))) (=> (and (and (and (and (and ($Is DatatypeTypeType |c1#0@@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |c1#0@@0| Tclass._module.com $Heap)) (|$IsA#_module.com| |c1#0@@0|)) (and ($Is MapType |s1#0| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |s1#0| (TMap (TSeq TChar) TInt) $Heap))) (and (and ($Is DatatypeTypeType |c2#0| Tclass._module.com) ($IsAlloc DatatypeTypeType |c2#0| Tclass._module.com $Heap)) (|$IsA#_module.com| |c2#0|))) (and (and (and (and ($Is MapType |s2#0| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |s2#0| (TMap (TSeq TChar) TInt) $Heap)) (= 7 $FunctionContextHeight)) (and (|_module.__default.small__step__star#canCall| |c0#0@@0| |s0#0| |c1#0@@0| |s1#0|) (and (_module.__default.small__step__star ($LS $LZ) |c0#0@@0| |s0#0| |c1#0@@0| |s1#0|) (or (and (|_module.com#Equal| |c0#0@@0| |c1#0@@0|) (|Map#Equal| |s0#0| |s1#0|)) (exists ((|c''#3@@2| T@U) (|s''#3@@2| T@U) ) (!  (and (and ($Is DatatypeTypeType |c''#3@@2| Tclass._module.com) ($Is MapType |s''#3@@2| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS $LZ) |c0#0@@0| |s0#0| |c''#3@@2| |s''#3@@2|) (_module.__default.small__step__star ($LS $LZ) |c''#3@@2| |s''#3@@2| |c1#0@@0| |s1#0|)))
 :qid |NipkowKleinchapter7dfy.229:10|
 :skolemid |1135|
 :pattern ( (_module.__default.small__step__star ($LS $LZ) |c''#3@@2| |s''#3@@2| |c1#0@@0| |s1#0|))
 :pattern ( (_module.__default.small__step ($LS $LZ) |c0#0@@0| |s0#0| |c''#3@@2| |s''#3@@2|))
)))))) (and (and (|_module.__default.small__step__star#canCall| |c1#0@@0| |s1#0| |c2#0| |s2#0|) (and (_module.__default.small__step__star ($LS $LZ) |c1#0@@0| |s1#0| |c2#0| |s2#0|) (or (and (|_module.com#Equal| |c1#0@@0| |c2#0|) (|Map#Equal| |s1#0| |s2#0|)) (exists ((|c''#4@@2| T@U) (|s''#4@@2| T@U) ) (!  (and (and ($Is DatatypeTypeType |c''#4@@2| Tclass._module.com) ($Is MapType |s''#4@@2| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS $LZ) |c1#0@@0| |s1#0| |c''#4@@2| |s''#4@@2|) (_module.__default.small__step__star ($LS $LZ) |c''#4@@2| |s''#4@@2| |c2#0| |s2#0|)))
 :qid |NipkowKleinchapter7dfy.229:10|
 :skolemid |1137|
 :pattern ( (_module.__default.small__step__star ($LS $LZ) |c''#4@@2| |s''#4@@2| |c2#0| |s2#0|))
 :pattern ( (_module.__default.small__step ($LS $LZ) |c1#0@@0| |s1#0| |c''#4@@2| |s''#4@@2|))
