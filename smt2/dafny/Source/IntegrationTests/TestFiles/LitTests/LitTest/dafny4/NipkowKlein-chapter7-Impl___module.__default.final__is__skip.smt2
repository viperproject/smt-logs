...
(declare-fun _module.__default.final (T@U T@U) Bool)
(declare-fun |_module.__default.final#canCall| (T@U T@U) Bool)
...
(assert (forall ((a@@5 T@U) (b@@5 T@U) ) (!  (=> (and (_module.aexp.V_q a@@5) (_module.aexp.V_q b@@5)) (= (|_module.aexp#Equal| a@@5 b@@5) (|Seq#Equal| (_module.aexp.x a@@5) (_module.aexp.x b@@5))))
 :qid |unknown.0:0|
 :skolemid |1464|
 :pattern ( (|_module.aexp#Equal| a@@5 b@@5) (_module.aexp.V_q a@@5))
 :pattern ( (|_module.aexp#Equal| a@@5 b@@5) (_module.aexp.V_q b@@5))
)))
(assert (forall ((a@@6 T@U) (b@@6 T@U) ) (!  (=> (and (_module.bexp.Not_q a@@6) (_module.bexp.Not_q b@@6)) (= (|_module.bexp#Equal| a@@6 b@@6) (|_module.bexp#Equal| (_module.bexp.op a@@6) (_module.bexp.op b@@6))))
 :qid |unknown.0:0|
 :skolemid |1512|
 :pattern ( (|_module.bexp#Equal| a@@6 b@@6) (_module.bexp.Not_q a@@6))
 :pattern ( (|_module.bexp#Equal| a@@6 b@@6) (_module.bexp.Not_q b@@6))
)))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|c#0@@5| T@U) (|s#0@@10| T@U) ) (!  (=> (or (|_module.__default.final#canCall| (Lit DatatypeTypeType |c#0@@5|) (Lit MapType |s#0@@10|)) (and (< 5 $FunctionContextHeight) (and ($Is DatatypeTypeType |c#0@@5| Tclass._module.com) ($Is MapType |s#0@@10| (TMap (TSeq TChar) TInt))))) (and (forall ((|c'#1| T@U) (|s'#1| T@U) ) (!  (=> (and ($Is DatatypeTypeType |c'#1| Tclass._module.com) ($Is MapType |s'#1| (TMap (TSeq TChar) TInt))) (|_module.__default.small__step#canCall| (Lit DatatypeTypeType |c#0@@5|) (Lit MapType |s#0@@10|) |c'#1| |s'#1|))
 :qid |NipkowKleinchapter7dfy.362:11|
 :skolemid |1355|
 :pattern ( (_module.__default.small__step ($LS $LZ) |c#0@@5| |s#0@@10| |c'#1| |s'#1|))
)) (= (_module.__default.final (Lit DatatypeTypeType |c#0@@5|) (Lit MapType |s#0@@10|))  (not (exists ((|c'#1@@0| T@U) (|s'#1@@0| T@U) ) (!  (and (and ($Is DatatypeTypeType |c'#1@@0| Tclass._module.com) ($Is MapType |s'#1@@0| (TMap (TSeq TChar) TInt))) (_module.__default.small__step ($LS $LZ) (Lit DatatypeTypeType |c#0@@5|) (Lit MapType |s#0@@10|) |c'#1@@0| |s'#1@@0|))
 :qid |NipkowKleinchapter7dfy.362:11|
 :skolemid |1354|
 :pattern ( (_module.__default.small__step ($LS $LZ) |c#0@@5| |s#0@@10| |c'#1@@0| |s'#1@@0|))
))))))
 :qid |NipkowKleinchapter7dfy.360:23|
 :weight 3
 :skolemid |1356|
 :pattern ( (_module.__default.final (Lit DatatypeTypeType |c#0@@5|) (Lit MapType |s#0@@10|)))
))))
...
(assert (forall ((a@@7 T@U) (b@@7 T@U) ) (!  (=> (|Seq#Equal| a@@7 b@@7) (= a@@7 b@@7))
 :qid |DafnyPreludebpl.1225:15|
 :skolemid |241|
 :pattern ( (|Seq#Equal| a@@7 b@@7))
)))
...
(assert (forall (($ly@@10 T@U) (|_k#0@@3| T@U) (|c#0@@6| T@U) (|s#0@@11| T@U) (|c'#0@@5| T@U) (|s'#0@@5| T@U) ) (! (= (_module.__default.small__step_h ($LS $ly@@10) |_k#0@@3| |c#0@@6| |s#0@@11| |c'#0@@5| |s'#0@@5|) (_module.__default.small__step_h $ly@@10 |_k#0@@3| |c#0@@6| |s#0@@11| |c'#0@@5| |s'#0@@5|))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1008|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@10) |_k#0@@3| |c#0@@6| |s#0@@11| |c'#0@@5| |s'#0@@5|))
)))
...
(assert (forall ((a@@8 T@U) (b@@8 T@U) ) (!  (=> (and (_module.aexp.Plus_q a@@8) (_module.aexp.Plus_q b@@8)) (= (|_module.aexp#Equal| a@@8 b@@8)  (and (|_module.aexp#Equal| (_module.aexp._0 a@@8) (_module.aexp._0 b@@8)) (|_module.aexp#Equal| (_module.aexp._1 a@@8) (_module.aexp._1 b@@8)))))
 :qid |unknown.0:0|
 :skolemid |1465|
 :pattern ( (|_module.aexp#Equal| a@@8 b@@8) (_module.aexp.Plus_q a@@8))
 :pattern ( (|_module.aexp#Equal| a@@8 b@@8) (_module.aexp.Plus_q b@@8))
)))
(assert (forall ((a@@9 T@U) (b@@9 T@U) ) (!  (=> (and (_module.bexp.And_q a@@9) (_module.bexp.And_q b@@9)) (= (|_module.bexp#Equal| a@@9 b@@9)  (and (|_module.bexp#Equal| (_module.bexp._0 a@@9) (_module.bexp._0 b@@9)) (|_module.bexp#Equal| (_module.bexp._1 a@@9) (_module.bexp._1 b@@9)))))
 :qid |unknown.0:0|
 :skolemid |1513|
 :pattern ( (|_module.bexp#Equal| a@@9 b@@9) (_module.bexp.And_q a@@9))
 :pattern ( (|_module.bexp#Equal| a@@9 b@@9) (_module.bexp.And_q b@@9))
)))
(assert (forall ((a@@10 T@U) (b@@10 T@U) ) (!  (=> (and (_module.bexp.Less_q a@@10) (_module.bexp.Less_q b@@10)) (= (|_module.bexp#Equal| a@@10 b@@10)  (and (|_module.aexp#Equal| (_module.bexp.a0 a@@10) (_module.bexp.a0 b@@10)) (|_module.aexp#Equal| (_module.bexp.a1 a@@10) (_module.bexp.a1 b@@10)))))
 :qid |unknown.0:0|
 :skolemid |1514|
 :pattern ( (|_module.bexp#Equal| a@@10 b@@10) (_module.bexp.Less_q a@@10))
 :pattern ( (|_module.bexp#Equal| a@@10 b@@10) (_module.bexp.Less_q b@@10))
)))
(assert (forall ((a@@11 T@U) (b@@11 T@U) ) (!  (=> (and (_module.com.Assign_q a@@11) (_module.com.Assign_q b@@11)) (= (|_module.com#Equal| a@@11 b@@11)  (and (|Seq#Equal| (_module.com._h0 a@@11) (_module.com._h0 b@@11)) (|_module.aexp#Equal| (_module.com._h1 a@@11) (_module.com._h1 b@@11)))))
 :qid |unknown.0:0|
 :skolemid |1574|
 :pattern ( (|_module.com#Equal| a@@11 b@@11) (_module.com.Assign_q a@@11))
 :pattern ( (|_module.com#Equal| a@@11 b@@11) (_module.com.Assign_q b@@11))
)))
(assert (forall ((a@@12 T@U) (b@@12 T@U) ) (!  (=> (and (_module.com.Seq_q a@@12) (_module.com.Seq_q b@@12)) (= (|_module.com#Equal| a@@12 b@@12)  (and (|_module.com#Equal| (_module.com._h2 a@@12) (_module.com._h2 b@@12)) (|_module.com#Equal| (_module.com._h3 a@@12) (_module.com._h3 b@@12)))))
 :qid |unknown.0:0|
 :skolemid |1575|
 :pattern ( (|_module.com#Equal| a@@12 b@@12) (_module.com.Seq_q a@@12))
 :pattern ( (|_module.com#Equal| a@@12 b@@12) (_module.com.Seq_q b@@12))
)))
(assert (forall ((a@@13 T@U) (b@@13 T@U) ) (!  (=> (and (_module.com.While_q a@@13) (_module.com.While_q b@@13)) (= (|_module.com#Equal| a@@13 b@@13)  (and (|_module.bexp#Equal| (_module.com._h7 a@@13) (_module.com._h7 b@@13)) (|_module.com#Equal| (_module.com._h8 a@@13) (_module.com._h8 b@@13)))))
 :qid |unknown.0:0|
 :skolemid |1577|
 :pattern ( (|_module.com#Equal| a@@13 b@@13) (_module.com.While_q a@@13))
 :pattern ( (|_module.com#Equal| a@@13 b@@13) (_module.com.While_q b@@13))
)))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|c#0@@7| T@U) (|s#0@@12| T@U) ) (!  (=> (or (|_module.__default.final#canCall| |c#0@@7| |s#0@@12|) (and (< 5 $FunctionContextHeight) (and ($Is DatatypeTypeType |c#0@@7| Tclass._module.com) ($Is MapType |s#0@@12| (TMap (TSeq TChar) TInt))))) (and (forall ((|c'#0@@6| T@U) (|s'#0@@6| T@U) ) (!  (=> (and ($Is DatatypeTypeType |c'#0@@6| Tclass._module.com) ($Is MapType |s'#0@@6| (TMap (TSeq TChar) TInt))) (|_module.__default.small__step#canCall| |c#0@@7| |s#0@@12| |c'#0@@6| |s'#0@@6|))
 :qid |NipkowKleinchapter7dfy.362:11|
 :skolemid |1352|
 :pattern ( (_module.__default.small__step ($LS $LZ) |c#0@@7| |s#0@@12| |c'#0@@6| |s'#0@@6|))
)) (= (_module.__default.final |c#0@@7| |s#0@@12|)  (not (exists ((|c'#0@@7| T@U) (|s'#0@@7| T@U) ) (!  (and (and ($Is DatatypeTypeType |c'#0@@7| Tclass._module.com) ($Is MapType |s'#0@@7| (TMap (TSeq TChar) TInt))) (_module.__default.small__step ($LS $LZ) |c#0@@7| |s#0@@12| |c'#0@@7| |s'#0@@7|))
 :qid |NipkowKleinchapter7dfy.362:11|
 :skolemid |1351|
 :pattern ( (_module.__default.small__step ($LS $LZ) |c#0@@7| |s#0@@12| |c'#0@@7| |s'#0@@7|))
))))))
 :qid |NipkowKleinchapter7dfy.360:23|
 :skolemid |1353|
 :pattern ( (_module.__default.final |c#0@@7| |s#0@@12|))
))))
(assert (forall ((a@@14 T@U) (b@@14 T@U) ) (!  (=> (and (_module.com.SKIP_q a@@14) (_module.com.SKIP_q b@@14)) (|_module.com#Equal| a@@14 b@@14))
 :qid |unknown.0:0|
 :skolemid |1573|
 :pattern ( (|_module.com#Equal| a@@14 b@@14) (_module.com.SKIP_q a@@14))
 :pattern ( (|_module.com#Equal| a@@14 b@@14) (_module.com.SKIP_q b@@14))
)))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@11 T@U) (|_k#0@@4| T@U) (|c#0@@8| T@U) (|s#0@@13| T@U) (|c'#0@@8| T@U) (|s'#0@@8| T@U) ) (!  (=> (or (|_module.__default.small__step_h#canCall| |_k#0@@4| |c#0@@8| |s#0@@13| |c'#0@@8| |s'#0@@8|) (and (< 5 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |c#0@@8| Tclass._module.com) ($Is MapType |s#0@@13| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c'#0@@8| Tclass._module.com)) ($Is MapType |s'#0@@8| (TMap (TSeq TChar) TInt))))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (=> (not (_module.com.SKIP_q |c#0@@8|)) (and (=> (_module.com.Assign_q |c#0@@8|) (let ((|a#3| (_module.com._h1 |c#0@@8|)))
 (and (|$IsA#_module.com| |c'#0@@8|) (=> (|_module.com#Equal| |c'#0@@8| |#_module.com.SKIP|) (|_module.__default.aval#canCall| |a#3| |s#0@@13|))))) (=> (not (_module.com.Assign_q |c#0@@8|)) (and (=> (_module.com.Seq_q |c#0@@8|) (let ((|c1#3| (_module.com._h3 |c#0@@8|)))
(let ((|c0#3| (_module.com._h2 |c#0@@8|)))
 (and (and (|$IsA#_module.com| |c0#3|) (=> (|_module.com#Equal| |c0#3| |#_module.com.SKIP|) (and (|$IsA#_module.com| |c'#0@@8|) (|$IsA#_module.com| |c1#3|)))) (=> (not (and (and (|_module.com#Equal| |c0#3| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@8| |c1#3|)) (|Map#Equal| |s'#0@@8| |s#0@@13|))) (forall ((|c0'#5| T@U) ) (!  (=> ($Is DatatypeTypeType |c0'#5| Tclass._module.com) (and (|$IsA#_module.com| |c'#0@@8|) (=> (|_module.com#Equal| |c'#0@@8| (|#_module.com.Seq| |c0'#5| |c1#3|)) (|_module.__default.small__step_h#canCall| (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) |c0#3| |s#0@@13| |c0'#5| |s'#0@@8|))))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1014|
 :pattern ( (_module.__default.small__step_h $ly@@11 (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) |c0#3| |s#0@@13| |c0'#5| |s'#0@@8|))
 :pattern ( (|#_module.com.Seq| |c0'#5| |c1#3|))
))))))) (=> (not (_module.com.Seq_q |c#0@@8|)) (and (=> (_module.com.If_q |c#0@@8|) (let ((|els#3| (_module.com._h6 |c#0@@8|)))
(let ((|thn#3| (_module.com._h5 |c#0@@8|)))
(let ((|b#6| (_module.com._h4 |c#0@@8|)))
 (and (and (|$IsA#_module.com| |c'#0@@8|) (|$IsA#_module.com| (ite (_module.__default.bval ($LS $LZ) |b#6| |s#0@@13|) |thn#3| |els#3|))) (|_module.__default.bval#canCall| |b#6| |s#0@@13|)))))) (=> (not (_module.com.If_q |c#0@@8|)) (|$IsA#_module.com| |c'#0@@8|))))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (ite (_module.com.SKIP_q |c#0@@8|) false (ite (_module.com.Assign_q |c#0@@8|) (let ((|a#4| (_module.com._h1 |c#0@@8|)))
(let ((|x#4| (_module.com._h0 |c#0@@8|)))
 (and (|_module.com#Equal| |c'#0@@8| |#_module.com.SKIP|) (|Map#Equal| |s'#0@@8| (|Map#Build| |s#0@@13| ($Box SeqType |x#4|) ($Box intType (int_2_U (_module.__default.aval ($LS $LZ) |a#4| |s#0@@13|)))))))) (ite (_module.com.Seq_q |c#0@@8|) (let ((|c1#4| (_module.com._h3 |c#0@@8|)))
(let ((|c0#4| (_module.com._h2 |c#0@@8|)))
 (or (and (and (|_module.com#Equal| |c0#4| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@8| |c1#4|)) (|Map#Equal| |s'#0@@8| |s#0@@13|)) (exists ((|c0'#6| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#6| Tclass._module.com) (and (|_module.com#Equal| |c'#0@@8| (|#_module.com.Seq| |c0'#6| |c1#4|)) (_module.__default.small__step_h $ly@@11 (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) |c0#4| |s#0@@13| |c0'#6| |s'#0@@8|)))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1016|
 :pattern ( (_module.__default.small__step_h $ly@@11 (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) |c0#4| |s#0@@13| |c0'#6| |s'#0@@8|))
 :pattern ( (|#_module.com.Seq| |c0'#6| |c1#4|))
))))) (ite (_module.com.If_q |c#0@@8|) (let ((|els#4| (_module.com._h6 |c#0@@8|)))
(let ((|thn#4| (_module.com._h5 |c#0@@8|)))
(let ((|b#8| (_module.com._h4 |c#0@@8|)))
 (and (|_module.com#Equal| |c'#0@@8| (ite (_module.__default.bval ($LS $LZ) |b#8| |s#0@@13|) |thn#4| |els#4|)) (|Map#Equal| |s'#0@@8| |s#0@@13|))))) (let ((|body#4| (_module.com._h8 |c#0@@8|)))
(let ((|b#9| (_module.com._h7 |c#0@@8|)))
 (and (|_module.com#Equal| |c'#0@@8| (|#_module.com.If| |b#9| (|#_module.com.Seq| |body#4| (|#_module.com.While| |b#9| |body#4|)) (Lit DatatypeTypeType |#_module.com.SKIP|))) (|Map#Equal| |s'#0@@8| |s#0@@13|))))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@4|)) (forall ((|_k'#0| T@U) ) (!  (=> (|ORD#LessThanLimit| |_k'#0| |_k#0@@4|) (|_module.__default.small__step_h#canCall| |_k'#0| |c#0@@8| |s#0@@13| |c'#0@@8| |s'#0@@8|))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1015|
 :pattern ( (_module.__default.small__step_h $ly@@11 |_k'#0| |c#0@@8| |s#0@@13| |c'#0@@8| |s'#0@@8|))
))))) (= (_module.__default.small__step_h ($LS $ly@@11) |_k#0@@4| |c#0@@8| |s#0@@13| |c'#0@@8| |s'#0@@8|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (ite (_module.com.SKIP_q |c#0@@8|) false (ite (_module.com.Assign_q |c#0@@8|) (let ((|a#2| (_module.com._h1 |c#0@@8|)))
(let ((|x#2@@0| (_module.com._h0 |c#0@@8|)))
 (and (|_module.com#Equal| |c'#0@@8| |#_module.com.SKIP|) (|Map#Equal| |s'#0@@8| (|Map#Build| |s#0@@13| ($Box SeqType |x#2@@0|) ($Box intType (int_2_U (_module.__default.aval ($LS $LZ) |a#2| |s#0@@13|)))))))) (ite (_module.com.Seq_q |c#0@@8|) (let ((|c1#2| (_module.com._h3 |c#0@@8|)))
(let ((|c0#2| (_module.com._h2 |c#0@@8|)))
 (or (and (and (|_module.com#Equal| |c0#2| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@8| |c1#2|)) (|Map#Equal| |s'#0@@8| |s#0@@13|)) (exists ((|c0'#4| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#4| Tclass._module.com) (and (|_module.com#Equal| |c'#0@@8| (|#_module.com.Seq| |c0'#4| |c1#2|)) (_module.__default.small__step_h $ly@@11 (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) |c0#2| |s#0@@13| |c0'#4| |s'#0@@8|)))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1012|
 :pattern ( (_module.__default.small__step_h $ly@@11 (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) |c0#2| |s#0@@13| |c0'#4| |s'#0@@8|))
 :pattern ( (|#_module.com.Seq| |c0'#4| |c1#2|))
))))) (ite (_module.com.If_q |c#0@@8|) (let ((|els#2| (_module.com._h6 |c#0@@8|)))
(let ((|thn#2| (_module.com._h5 |c#0@@8|)))
(let ((|b#4@@0| (_module.com._h4 |c#0@@8|)))
 (and (|_module.com#Equal| |c'#0@@8| (ite (_module.__default.bval ($LS $LZ) |b#4@@0| |s#0@@13|) |thn#2| |els#2|)) (|Map#Equal| |s'#0@@8| |s#0@@13|))))) (let ((|body#2| (_module.com._h8 |c#0@@8|)))
(let ((|b#5| (_module.com._h7 |c#0@@8|)))
 (and (|_module.com#Equal| |c'#0@@8| (|#_module.com.If| |b#5| (|#_module.com.Seq| |body#2| (|#_module.com.While| |b#5| |body#2|)) (Lit DatatypeTypeType |#_module.com.SKIP|))) (|Map#Equal| |s'#0@@8| |s#0@@13|))))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@4|)) (exists ((|_k'#0@@0| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#0@@0| |_k#0@@4|) (_module.__default.small__step_h $ly@@11 |_k'#0@@0| |c#0@@8| |s#0@@13| |c'#0@@8| |s'#0@@8|))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1013|
 :pattern ( (_module.__default.small__step_h $ly@@11 |_k'#0@@0| |c#0@@8| |s#0@@13| |c'#0@@8| |s'#0@@8|))
)))))))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1017|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@11) |_k#0@@4| |c#0@@8| |s#0@@13| |c'#0@@8| |s'#0@@8|))
))))
...
(+ (_module.__default.aval $ly@@12 |a0#0@@0| |s#0@@14|) (_module.__default.aval $ly@@12 |a1#0@@0| |s#0@@14|)))))))))
 :qid |NipkowKleinchapter7dfy.16:16|
 :skolemid |704|
 :pattern ( (_module.__default.aval ($LS $ly@@12) |a#0@@2| |s#0@@14|))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@13 T@U) (|_k#0@@5| T@U) (|c#0@@9| T@U) (|s#0@@15| T@U) (|c'#0@@9| T@U) (|s'#0@@9| T@U) ) (!  (=> (or (|_module.__default.small__step_h#canCall| (Lit BoxType |_k#0@@5|) (Lit DatatypeTypeType |c#0@@9|) (Lit MapType |s#0@@15|) (Lit DatatypeTypeType |c'#0@@9|) (Lit MapType |s'#0@@9|)) (and (< 5 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |c#0@@9| Tclass._module.com) ($Is MapType |s#0@@15| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c'#0@@9| Tclass._module.com)) ($Is MapType |s'#0@@9| (TMap (TSeq TChar) TInt))))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@5|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.com.SKIP_q (Lit DatatypeTypeType |c#0@@9|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (_module.com.Assign_q (Lit DatatypeTypeType |c#0@@9|))))) (let ((|a#9| (Lit DatatypeTypeType (_module.com._h1 (Lit DatatypeTypeType |c#0@@9|)))))
 (and (|$IsA#_module.com| (Lit DatatypeTypeType |c'#0@@9|)) (=> (|_module.com#Equal| |c'#0@@9| |#_module.com.SKIP|) (|_module.__default.aval#canCall| |a#9| (Lit MapType |s#0@@15|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.com.Assign_q (Lit DatatypeTypeType |c#0@@9|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (_module.com.Seq_q (Lit DatatypeTypeType |c#0@@9|))))) (let ((|c1#9| (Lit DatatypeTypeType (_module.com._h3 (Lit DatatypeTypeType |c#0@@9|)))))
(let ((|c0#9| (Lit DatatypeTypeType (_module.com._h2 (Lit DatatypeTypeType |c#0@@9|)))))
 (and (and (|$IsA#_module.com| |c0#9|) (=> (|_module.com#Equal| |c0#9| |#_module.com.SKIP|) (and (|$IsA#_module.com| (Lit DatatypeTypeType |c'#0@@9|)) (|$IsA#_module.com| |c1#9|)))) (=> (not (and (and (|_module.com#Equal| |c0#9| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@9| |c1#9|)) (|Map#Equal| |s'#0@@9| |s#0@@15|))) (forall ((|c0'#11| T@U) ) (!  (=> ($Is DatatypeTypeType |c0'#11| Tclass._module.com) (and (|$IsA#_module.com| (Lit DatatypeTypeType |c'#0@@9|)) (=> (|_module.com#Equal| |c'#0@@9| (|#_module.com.Seq| |c0'#11| |c1#9|)) (|_module.__default.small__step_h#canCall| (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |c0#9| (Lit MapType |s#0@@15|) |c0'#11| (Lit MapType |s'#0@@9|)))))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1026|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@13) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |c0#9| |s#0@@15| |c0'#11| |s'#0@@9|))
 :pattern ( (|#_module.com.Seq| |c0'#11| |c1#9|))
))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.com.Seq_q (Lit DatatypeTypeType |c#0@@9|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (_module.com.If_q (Lit DatatypeTypeType |c#0@@9|))))) (let ((|els#9| (Lit DatatypeTypeType (_module.com._h6 (Lit DatatypeTypeType |c#0@@9|)))))
(let ((|thn#9| (Lit DatatypeTypeType (_module.com._h5 (Lit DatatypeTypeType |c#0@@9|)))))
(let ((|b#18| (Lit DatatypeTypeType (_module.com._h4 (Lit DatatypeTypeType |c#0@@9|)))))
 (and (and (|$IsA#_module.com| (Lit DatatypeTypeType |c'#0@@9|)) (|$IsA#_module.com| (ite (_module.__default.bval ($LS $LZ) |b#18| (Lit MapType |s#0@@15|)) |thn#9| |els#9|))) (|_module.__default.bval#canCall| |b#18| (Lit MapType |s#0@@15|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.com.If_q (Lit DatatypeTypeType |c#0@@9|)))))) (|$IsA#_module.com| (Lit DatatypeTypeType |c'#0@@9|)))))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@5|)) (ite (_module.com.SKIP_q (Lit DatatypeTypeType |c#0@@9|)) false (ite (_module.com.Assign_q (Lit DatatypeTypeType |c#0@@9|)) (let ((|a#10| (Lit DatatypeTypeType (_module.com._h1 (Lit DatatypeTypeType |c#0@@9|)))))
(let ((|x#10| (Lit SeqType (_module.com._h0 (Lit DatatypeTypeType |c#0@@9|)))))
 (and (|_module.com#Equal| |c'#0@@9| |#_module.com.SKIP|) (|Map#Equal| |s'#0@@9| (|Map#Build| (Lit MapType |s#0@@15|) ($Box SeqType |x#10|) ($Box intType (int_2_U (LitInt (_module.__default.aval ($LS $LZ) |a#10| (Lit MapType |s#0@@15|)))))))))) (ite (_module.com.Seq_q (Lit DatatypeTypeType |c#0@@9|)) (let ((|c1#10| (Lit DatatypeTypeType (_module.com._h3 (Lit DatatypeTypeType |c#0@@9|)))))
(let ((|c0#10| (Lit DatatypeTypeType (_module.com._h2 (Lit DatatypeTypeType |c#0@@9|)))))
 (or (and (and (|_module.com#Equal| |c0#10| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@9| |c1#10|)) (|Map#Equal| |s'#0@@9| |s#0@@15|)) (exists ((|c0'#12| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#12| Tclass._module.com) (and (|_module.com#Equal| |c'#0@@9| (|#_module.com.Seq| |c0'#12| |c1#10|)) (_module.__default.small__step_h ($LS $ly@@13) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |c0#10| (Lit MapType |s#0@@15|) |c0'#12| (Lit MapType |s'#0@@9|))))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1028|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@13) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |c0#10| |s#0@@15| |c0'#12| |s'#0@@9|))
 :pattern ( (|#_module.com.Seq| |c0'#12| |c1#10|))
))))) (ite (_module.com.If_q (Lit DatatypeTypeType |c#0@@9|)) (let ((|els#10| (Lit DatatypeTypeType (_module.com._h6 (Lit DatatypeTypeType |c#0@@9|)))))
(let ((|thn#10| (Lit DatatypeTypeType (_module.com._h5 (Lit DatatypeTypeType |c#0@@9|)))))
(let ((|b#20| (Lit DatatypeTypeType (_module.com._h4 (Lit DatatypeTypeType |c#0@@9|)))))
 (and (|_module.com#Equal| |c'#0@@9| (ite (_module.__default.bval ($LS $LZ) |b#20| (Lit MapType |s#0@@15|)) |thn#10| |els#10|)) (|Map#Equal| |s'#0@@9| |s#0@@15|))))) (let ((|body#10| (Lit DatatypeTypeType (_module.com._h8 (Lit DatatypeTypeType |c#0@@9|)))))
(let ((|b#21| (Lit DatatypeTypeType (_module.com._h7 (Lit DatatypeTypeType |c#0@@9|)))))
 (and (|_module.com#Equal| |c'#0@@9| (|#_module.com.If| |b#21| (Lit DatatypeTypeType (|#_module.com.Seq| |body#10| (Lit DatatypeTypeType (|#_module.com.While| |b#21| |body#10|)))) (Lit DatatypeTypeType |#_module.com.SKIP|))) (|Map#Equal| |s'#0@@9| |s#0@@15|))))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@5|)) (forall ((|_k'#2| T@U) ) (!  (=> (|ORD#LessThanLimit| |_k'#2| |_k#0@@5|) (|_module.__default.small__step_h#canCall| |_k'#2| |c#0@@9| |s#0@@15| |c'#0@@9| |s'#0@@9|))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1027|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@13) |_k'#2| |c#0@@9| |s#0@@15| |c'#0@@9| |s'#0@@9|))
))))) (= (_module.__default.small__step_h ($LS $ly@@13) (Lit BoxType |_k#0@@5|) (Lit DatatypeTypeType |c#0@@9|) (Lit MapType |s#0@@15|) (Lit DatatypeTypeType |c'#0@@9|) (Lit MapType |s'#0@@9|))  (and (=> (< 0 (|ORD#Offset| |_k#0@@5|)) (ite (_module.com.SKIP_q (Lit DatatypeTypeType |c#0@@9|)) false (ite (_module.com.Assign_q (Lit DatatypeTypeType |c#0@@9|)) (let ((|a#8| (Lit DatatypeTypeType (_module.com._h1 (Lit DatatypeTypeType |c#0@@9|)))))
(let ((|x#8| (Lit SeqType (_module.com._h0 (Lit DatatypeTypeType |c#0@@9|)))))
 (and (|_module.com#Equal| |c'#0@@9| |#_module.com.SKIP|) (|Map#Equal| |s'#0@@9| (|Map#Build| (Lit MapType |s#0@@15|) ($Box SeqType |x#8|) ($Box intType (int_2_U (LitInt (_module.__default.aval ($LS $LZ) |a#8| (Lit MapType |s#0@@15|)))))))))) (ite (_module.com.Seq_q (Lit DatatypeTypeType |c#0@@9|)) (let ((|c1#8| (Lit DatatypeTypeType (_module.com._h3 (Lit DatatypeTypeType |c#0@@9|)))))
(let ((|c0#8| (Lit DatatypeTypeType (_module.com._h2 (Lit DatatypeTypeType |c#0@@9|)))))
 (or (and (and (|_module.com#Equal| |c0#8| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@9| |c1#8|)) (|Map#Equal| |s'#0@@9| |s#0@@15|)) (exists ((|c0'#10| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#10| Tclass._module.com) (and (|_module.com#Equal| |c'#0@@9| (|#_module.com.Seq| |c0'#10| |c1#8|)) (_module.__default.small__step_h ($LS $ly@@13) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |c0#8| (Lit MapType |s#0@@15|) |c0'#10| (Lit MapType |s'#0@@9|))))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1024|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@13) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |c0#8| |s#0@@15| |c0'#10| |s'#0@@9|))
 :pattern ( (|#_module.com.Seq| |c0'#10| |c1#8|))
))))) (ite (_module.com.If_q (Lit DatatypeTypeType |c#0@@9|)) (let ((|els#8| (Lit DatatypeTypeType (_module.com._h6 (Lit DatatypeTypeType |c#0@@9|)))))
(let ((|thn#8| (Lit DatatypeTypeType (_module.com._h5 (Lit DatatypeTypeType |c#0@@9|)))))
(let ((|b#16| (Lit DatatypeTypeType (_module.com._h4 (Lit DatatypeTypeType |c#0@@9|)))))
 (and (|_module.com#Equal| |c'#0@@9| (ite (_module.__default.bval ($LS $LZ) |b#16| (Lit MapType |s#0@@15|)) |thn#8| |els#8|)) (|Map#Equal| |s'#0@@9| |s#0@@15|))))) (let ((|body#8| (Lit DatatypeTypeType (_module.com._h8 (Lit DatatypeTypeType |c#0@@9|)))))
(let ((|b#17| (Lit DatatypeTypeType (_module.com._h7 (Lit DatatypeTypeType |c#0@@9|)))))
 (and (|_module.com#Equal| |c'#0@@9| (|#_module.com.If| |b#17| (Lit DatatypeTypeType (|#_module.com.Seq| |body#8| (Lit DatatypeTypeType (|#_module.com.While| |b#17| |body#8|)))) (Lit DatatypeTypeType |#_module.com.SKIP|))) (|Map#Equal| |s'#0@@9| |s#0@@15|))))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@5|)) (exists ((|_k'#2@@0| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#2@@0| |_k#0@@5|) (_module.__default.small__step_h ($LS $ly@@13) |_k'#2@@0| |c#0@@9| |s#0@@15| |c'#0@@9| |s'#0@@9|))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1025|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@13) |_k'#2@@0| |c#0@@9| |s#0@@15| |c'#0@@9| |s'#0@@9|))
)))))))
 :qid |NipkowKleinchapter7dfy.154:17|
 :weight 3
 :skolemid |1029|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@13) (Lit BoxType |_k#0@@5|) (Lit DatatypeTypeType |c#0@@9|) (Lit MapType |s#0@@15|) (Lit DatatypeTypeType |c'#0@@9|) (Lit MapType |s'#0@@9|)))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@14 T@U) (|c#0@@10| T@U) (|s#0@@16| T@U) (|c'#0@@10| T@U) (|s'#0@@10| T@U) (|_k#0@@6| T@U) (_m T@U) (_limit T@U) ) (!  (=> (|ORD#Less| |_k#0@@6| _m) (=> (_module.__default.small__step_h $ly@@14 |_k#0@@6| |c#0@@10| |s#0@@16| |c'#0@@10| |s'#0@@10|) (_module.__default.small__step_h $ly@@14 _m |c#0@@10| |s#0@@16| |c'#0@@10| |s'#0@@10|)))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1001|
 :pattern ( (_module.__default.small__step_h $ly@@14 |_k#0@@6| |c#0@@10| |s#0@@16| |c'#0@@10| |s'#0@@10|) (|ORD#LessThanLimit| |_k#0@@6| _limit) (|ORD#LessThanLimit| _m _limit))
))))
...
(declare-fun |_v9#1_0| () T@U)
(declare-fun |_v10#1_0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.final__is__skip)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (= (_module.__default.final |c#0@@11| |s#0@@17|) (|_module.com#Equal| |c#0@@11| |#_module.com.SKIP|)))))
(let ((anon3_Else_correct  (=> (not (|_module.com#Equal| |c#0@@11| |#_module.com.SKIP|)) (=> (and (and ($Is DatatypeTypeType |call3formal@c'#0| Tclass._module.com) ($IsAlloc DatatypeTypeType |call3formal@c'#0| Tclass._module.com $Heap)) (and ($Is MapType |call4formal@s'#0| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |call4formal@s'#0| (TMap (TSeq TChar) TInt) $Heap))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (not (|_module.com#Equal| |c#0@@11| |#_module.com.SKIP|))) (=> (not (|_module.com#Equal| |c#0@@11| |#_module.com.SKIP|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and ($Is DatatypeTypeType |call3formal@c'#0@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |call3formal@c'#0@0| Tclass._module.com $Heap@0))) (=> (and (and (and ($Is MapType |call4formal@s'#0@0| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |call4formal@s'#0@0| (TMap (TSeq TChar) TInt) $Heap@0)) (|_module.__default.small__step#canCall| |c#0@@11| |s#0@@17| |call3formal@c'#0@0| |call4formal@s'#0@0|)) (and (and (|_module.__default.small__step#canCall| |c#0@@11| |s#0@@17| |call3formal@c'#0@0| |call4formal@s'#0@0|) (and (_module.__default.small__step ($LS $LZ) |c#0@@11| |s#0@@17| |call3formal@c'#0@0| |call4formal@s'#0@0|) (ite (_module.com.SKIP_q |c#0@@11|) false (ite (_module.com.Assign_q |c#0@@11|) (let ((|a#1@@0| (_module.com._h1 |c#0@@11|)))
(let ((|x#1| (_module.com._h0 |c#0@@11|)))
 (and (|_module.com#Equal| |call3formal@c'#0@0| |#_module.com.SKIP|) (|Map#Equal| |call4formal@s'#0@0| (|Map#Build| |s#0@@17| ($Box SeqType |x#1|) ($Box intType (int_2_U (_module.__default.aval ($LS $LZ) |a#1@@0| |s#0@@17|)))))))) (ite (_module.com.Seq_q |c#0@@11|) (let ((|c1#1@@0| (_module.com._h3 |c#0@@11|)))
(let ((|c0#1@@0| (_module.com._h2 |c#0@@11|)))
 (or (and (and (|_module.com#Equal| |c0#1@@0| |#_module.com.SKIP|) (|_module.com#Equal| |call3formal@c'#0@0| |c1#1@@0|)) (|Map#Equal| |call4formal@s'#0@0| |s#0@@17|)) (exists ((|c0'#1@@0| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#1@@0| Tclass._module.com) (and (|_module.com#Equal| |call3formal@c'#0@0| (|#_module.com.Seq| |c0'#1@@0| |c1#1@@0|)) (_module.__default.small__step ($LS $LZ) |c0#1@@0| |s#0@@17| |c0'#1@@0| |call4formal@s'#0@0|)))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1366|
 :pattern ( (_module.__default.small__step ($LS $LZ) |c0#1@@0| |s#0@@17| |c0'#1@@0| |call4formal@s'#0@0|))
 :pattern ( (|#_module.com.Seq| |c0'#1@@0| |c1#1@@0|))
))))) (ite (_module.com.If_q |c#0@@11|) (let ((|els#1@@0| (_module.com._h6 |c#0@@11|)))
(let ((|thn#1@@0| (_module.com._h5 |c#0@@11|)))
(let ((|b#2@@1| (_module.com._h4 |c#0@@11|)))
 (and (|_module.com#Equal| |call3formal@c'#0@0| (ite (_module.__default.bval ($LS $LZ) |b#2@@1| |s#0@@17|) |thn#1@@0| |els#1@@0|)) (|Map#Equal| |call4formal@s'#0@0| |s#0@@17|))))) (let ((|body#1| (_module.com._h8 |c#0@@11|)))
(let ((|b#3@@0| (_module.com._h7 |c#0@@11|)))
 (and (|_module.com#Equal| |call3formal@c'#0@0| (|#_module.com.If| |b#3@@0| (|#_module.com.Seq| |body#1| (|#_module.com.While| |b#3@@0| |body#1|)) (Lit DatatypeTypeType |#_module.com.SKIP|))) (|Map#Equal| |call4formal@s'#0@0| |s#0@@17|)))))))))) (and (= $Heap $Heap@0) (= (ControlFlow 0 5) 2)))) GeneratedUnifiedExit_correct))))))))
(let ((anon3_Then_correct  (=> (|_module.com#Equal| |c#0@@11| |#_module.com.SKIP|) (=> (and (and ($IsAlloc DatatypeTypeType |c#0@@11| Tclass._module.com $Heap) ($IsAlloc MapType |s#0@@17| (TMap (TSeq TChar) TInt) $Heap)) (and (|_module.__default.final#canCall| |c#0@@11| |s#0@@17|) (|_module.__default.final#canCall| |c#0@@11| |s#0@@17|))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> (|_module.__default.final#canCall| |c#0@@11| |s#0@@17|) (or (_module.__default.final |c#0@@11| |s#0@@17|) (not (exists ((|c'#0_0| T@U) (|s'#0_0| T@U) ) (!  (and (and ($Is DatatypeTypeType |c'#0_0| Tclass._module.com) ($Is MapType |s'#0_0| (TMap (TSeq TChar) TInt))) (_module.__default.small__step ($LS ($LS $LZ)) |c#0@@11| |s#0@@17| |c'#0_0| |s'#0_0|))
 :qid |NipkowKleinchapter7dfy.362:11|
 :skolemid |1362|
 :pattern ( (_module.__default.small__step ($LS ($LS $LZ)) |c#0@@11| |s#0@@17| |c'#0_0| |s'#0_0|))
)))))) (=> (and (_module.__default.final |c#0@@11| |s#0@@17|) (= (ControlFlow 0 3) 2)) GeneratedUnifiedExit_correct))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.com| |c#0@@11|)) (and (=> (= (ControlFlow 0 7) 3) anon3_Then_correct) (=> (= (ControlFlow 0 7) 5) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and (and ($Is DatatypeTypeType |c#0@@11| Tclass._module.com) ($IsAlloc DatatypeTypeType |c#0@@11| Tclass._module.com $Heap)) (|$IsA#_module.com| |c#0@@11|)) (and ($Is MapType |s#0@@17| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |s#0@@17| (TMap (TSeq TChar) TInt) $Heap))) (and (and ($Is DatatypeTypeType |_v9#1_0| Tclass._module.com) ($IsAlloc DatatypeTypeType |_v9#1_0| Tclass._module.com $Heap)) true)) (and (and (and ($Is MapType |_v10#1_0| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |_v10#1_0| (TMap (TSeq TChar) TInt) $Heap)) true) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 8) 7)))) anon0_correct))))
