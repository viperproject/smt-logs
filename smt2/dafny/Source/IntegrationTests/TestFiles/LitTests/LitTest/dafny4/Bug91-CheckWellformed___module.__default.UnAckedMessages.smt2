...
(declare-fun _module.__default.UnAckedMessages (T@U) T@U)
(declare-fun |_module.__default.UnAckedMessages#canCall| (T@U) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|s#0| T@U) ) (!  (=> (or (|_module.__default.UnAckedMessages#canCall| |s#0|) (and (< 1 $FunctionContextHeight) ($Is MapType |s#0| (TMap TInt (TSeq TInt))))) ($Is SetType (_module.__default.UnAckedMessages |s#0|) (TSet TInt)))
 :qid |Bug91dfy.6:32|
 :skolemid |528|
 :pattern ( (_module.__default.UnAckedMessages |s#0|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|s#0@@0| T@U) ) (!  (=> (or (|_module.__default.UnAckedMessages#canCall| (Lit MapType |s#0@@0|)) (and (< 1 $FunctionContextHeight) ($Is MapType |s#0@@0| (TMap TInt (TSeq TInt))))) (= (_module.__default.UnAckedMessages (Lit MapType |s#0@@0|)) (|Set#FromBoogieMap| (|lambda#0| (|Map#Domain| |s#0@@0|) (|Map#Elements| (Lit MapType |s#0@@0|)) (|Map#Elements| |s#0@@0|)))))
 :qid |Bug91dfy.6:32|
 :weight 3
 :skolemid |533|
 :pattern ( (_module.__default.UnAckedMessages (Lit MapType |s#0@@0|)))
))))
...
(assert (forall ((|l#0@@0| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|$y#0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#0| |l#0@@0| |l#1@@0| |l#2@@0|) |$y#0|)) (exists ((|dst#0| Int) (|m#0| Int) ) (!  (and (and (|Set#IsMember| |l#0@@0| ($Box intType (int_2_U |dst#0|))) (|Seq#Contains| ($Unbox SeqType (MapType0Select BoxType BoxType |l#1@@0| ($Box intType (int_2_U |dst#0|)))) ($Box intType (int_2_U |m#0|)))) (= |$y#0| ($Box intType (int_2_U |m#0|))))
 :qid |Bug91dfy.8:11|
 :skolemid |530|
 :pattern ( (|Seq#Contains| ($Unbox SeqType (MapType0Select BoxType BoxType |l#2@@0| ($Box intType (int_2_U |dst#0|)))) ($Box intType (int_2_U |m#0|))))
)))
 :qid |Bug91dfy.8:21|
 :skolemid |590|
 :pattern ( (MapType0Select BoxType boolType (|lambda#0| |l#0@@0| |l#1@@0| |l#2@@0|) |$y#0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|s#0@@1| T@U) ) (!  (=> (or (|_module.__default.UnAckedMessages#canCall| |s#0@@1|) (and (< 1 $FunctionContextHeight) ($Is MapType |s#0@@1| (TMap TInt (TSeq TInt))))) (= (_module.__default.UnAckedMessages |s#0@@1|) (|Set#FromBoogieMap| (|lambda#0| (|Map#Domain| |s#0@@1|) (|Map#Elements| |s#0@@1|) (|Map#Elements| |s#0@@1|)))))
 :qid |Bug91dfy.6:32|
 :skolemid |531|
 :pattern ( (_module.__default.UnAckedMessages |s#0@@1|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.UnAckedMessages)
...
(let ((anon13_Else_correct  (=> (and (not (and (|Set#IsMember| (|Map#Domain| |s#0@@2|) ($Box intType (int_2_U |dst#2@0|))) (|Seq#Contains| ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| |s#0@@2|) ($Box intType (int_2_U |dst#2@0|)))) ($Box intType (int_2_U |m#2@0|))))) (= (ControlFlow 0 5) 3)) anon8_correct)))
(let ((anon13_Then_correct  (=> (and (and (|Set#IsMember| (|Map#Domain| |s#0@@2|) ($Box intType (int_2_U |dst#2@0|))) (|Seq#Contains| ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| |s#0@@2|) ($Box intType (int_2_U |dst#2@0|)))) ($Box intType (int_2_U |m#2@0|)))) (= (ControlFlow 0 4) 3)) anon8_correct)))
(let ((anon12_Else_correct  (=> (not (|Set#IsMember| (|Map#Domain| |s#0@@2|) ($Box intType (int_2_U |dst#2@0|)))) (and (=> (= (ControlFlow 0 8) 4) anon13_Then_correct) (=> (= (ControlFlow 0 8) 5) anon13_Else_correct)))))
(let ((anon12_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |s#0@@2|) ($Box intType (int_2_U |dst#2@0|))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (|Set#IsMember| (|Map#Domain| |s#0@@2|) ($Box intType (int_2_U |dst#2@0|)))) (=> (|Set#IsMember| (|Map#Domain| |s#0@@2|) ($Box intType (int_2_U |dst#2@0|))) (and (=> (= (ControlFlow 0 6) 4) anon13_Then_correct) (=> (= (ControlFlow 0 6) 5) anon13_Else_correct)))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is MapType |s#0@@2| (TMap TInt (TSeq TInt)))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct)))
