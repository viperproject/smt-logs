...
(assert (forall ((a T@U) (b T@U) ) (!  (=> (and (M3.Contents.Root_q a) (M3.Contents.Root_q b)) (= (|M3.Contents#Equal| a b) (= (M3.Contents.depth a) (M3.Contents.depth b))))
 :qid |unknown.0:0|
 :skolemid |3609|
 :pattern ( (|M3.Contents#Equal| a b) (M3.Contents.Root_q a))
 :pattern ( (|M3.Contents#Equal| a b) (M3.Contents.Root_q b))
)))
(assert (forall ((a@@0 T@U) (b@@0 T@U) ) (!  (=> (and (M3.Contents.Link_q a@@0) (M3.Contents.Link_q b@@0)) (= (|M3.Contents#Equal| a@@0 b@@0) (= (M3.Contents.next a@@0) (M3.Contents.next b@@0))))
 :qid |unknown.0:0|
 :skolemid |3610|
 :pattern ( (|M3.Contents#Equal| a@@0 b@@0) (M3.Contents.Link_q a@@0))
 :pattern ( (|M3.Contents#Equal| a@@0 b@@0) (M3.Contents.Link_q b@@0))
)))
...
(assert (forall ((a@@1 T@U) (b@@1 T@U) ) (! (= (|M3.Contents#Equal| a@@1 b@@1) (= a@@1 b@@1))
 :qid |unknown.0:0|
 :skolemid |3611|
 :pattern ( (|M3.Contents#Equal| a@@1 b@@1))
)))
...
(declare-fun |C'#0| () T@U)
(set-info :boogie-vc-id Impl$$M3.UnionFind.Reaches__Monotonic)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#d0#0| Int) (|$ih#e0#0| T@U) (|$ih#r0#0| T@U) (|$ih#C0#0| T@U) (|$ih#C'0#0| T@U) ) (!  (=> (and (and (and (and (and (and (<= (LitInt 0) |$ih#d0#0|) ($Is refType |$ih#e0#0| Tclass.M3.Element)) ($Is refType |$ih#r0#0| Tclass.M3.Element)) ($Is MapType |$ih#C0#0| (TMap Tclass.M3.Element Tclass.M3.Contents))) ($Is MapType |$ih#C'0#0| (TMap Tclass.M3.Element Tclass.M3.Contents))) (and (and (and (M3.__default.GoodCMap |$ih#C0#0|) (M3.__default.GoodCMap |$ih#C'0#0|)) (|Set#IsMember| (|Map#Domain| |$ih#C0#0|) ($Box refType |$ih#e0#0|))) (and (M3.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#d0#0| |$ih#e0#0| |$ih#r0#0| |$ih#C0#0|) (forall ((|f#8| T@U) ) (!  (=> ($Is refType |f#8| Tclass.M3.Element?) (and (=> (|Set#IsMember| (|Map#Domain| |$ih#C0#0|) ($Box refType |f#8|)) (|Set#IsMember| (|Map#Domain| |$ih#C'0#0|) ($Box refType |f#8|))) (=> (|Set#IsMember| (|Map#Domain| |$ih#C0#0|) ($Box refType |f#8|)) (|M3.Contents#Equal| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |$ih#C0#0|) ($Box refType |f#8|))) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |$ih#C'0#0|) ($Box refType |f#8|)))))))
...
))))) (or (and (<= 0 |$ih#d0#0|) (< |$ih#d0#0| |d#0@@3|)) (and (= |$ih#d0#0| |d#0@@3|) (or (and (= |$ih#e0#0| null) (or (not (= |e#0@@3| null)) (not true))) (and (=  (or (not (= |$ih#e0#0| null)) (not true))  (or (not (= |e#0@@3| null)) (not true))) (or (and (= |$ih#r0#0| null) (or (not (= |r#0@@3| null)) (not true))) (and (=  (or (not (= |$ih#r0#0| null)) (not true))  (or (not (= |r#0@@3| null)) (not true))) (or (and (|Set#Subset| (|Map#Domain| |$ih#C0#0|) (|Map#Domain| |C#0@@5|)) (not (|Set#Subset| (|Map#Domain| |C#0@@5|) (|Map#Domain| |$ih#C0#0|)))) (and (|Set#Equal| (|Map#Domain| |$ih#C0#0|) (|Map#Domain| |C#0@@5|)) (and (|Set#Subset| (|Map#Domain| |$ih#C'0#0|) (|Map#Domain| |C'#0|)) (not (|Set#Subset| (|Map#Domain| |C'#0|) (|Map#Domain| |$ih#C'0#0|))))))))))))) (M3.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#d0#0| |$ih#e0#0| |$ih#r0#0| |$ih#C'0#0|))
 :qid |UnionFinddfy.78:52|
 :skolemid |3441|
 :pattern ( (M3.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#d0#0| |$ih#e0#0| |$ih#r0#0| |$ih#C'0#0|) (M3.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#d0#0| |$ih#e0#0| |$ih#r0#0| |$ih#C0#0|))
 :pattern ( (M3.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#d0#0| |$ih#e0#0| |$ih#r0#0| |$ih#C'0#0|) (M3.__default.GoodCMap |$ih#C0#0|))
 :pattern ( (M3.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#d0#0| |$ih#e0#0| |$ih#r0#0| |$ih#C0#0|) (M3.__default.GoodCMap |$ih#C'0#0|))
)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> false (=> (|M3.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |e#0@@3|)))) (= |e#0@@3| |r#0@@3|)))))) (=> (=> false (=> (|M3.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |e#0@@3|)))) (= |e#0@@3| |r#0@@3|))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> false (=> (|M3.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (=> (not (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |e#0@@3|))))) (or (not (= |d#0@@3| 0)) (not true))))))) (=> (=> false (=> (|M3.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (=> (not (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |e#0@@3|))))) (or (not (= |d#0@@3| 0)) (not true)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (=> (|M3.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (=> (not (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |e#0@@3|))))) (let ((|next#6| (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |e#0@@3|))))))
(M3.UnionFind.Reaches ($LS ($LS $LZ)) this@@3 (- |d#0@@3| 1) |next#6| |r#0@@3| |C'#0|)))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.M3.UnionFind) ($IsAlloc refType this@@3 Tclass.M3.UnionFind $Heap))) (<= (LitInt 0) |d#0@@3|)) (and ($Is refType |e#0@@3| Tclass.M3.Element) ($IsAlloc refType |e#0@@3| Tclass.M3.Element $Heap))) (and (and ($Is refType |r#0@@3| Tclass.M3.Element) ($IsAlloc refType |r#0@@3| Tclass.M3.Element $Heap)) (and ($Is MapType |C#0@@5| (TMap Tclass.M3.Element Tclass.M3.Contents)) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap)))) (and (and (and (and ($Is MapType |C'#0| (TMap Tclass.M3.Element Tclass.M3.Contents)) ($IsAlloc MapType |C'#0| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap)) (= 5 $FunctionContextHeight)) (and (|M3.__default.GoodCMap#canCall| |C#0@@5|) (and (M3.__default.GoodCMap |C#0@@5|) (forall ((|f#6| T@U) ) (!  (=> ($Is refType |f#6| Tclass.M3.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |f#6|)) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#6|))))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#6|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |3436|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#6|))))
))))) (and (and (and (|M3.__default.GoodCMap#canCall| |C'#0|) (and (M3.__default.GoodCMap |C'#0|) (forall ((|f#7| T@U) ) (!  (=> ($Is refType |f#7| Tclass.M3.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |f#7|)) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#7|))))) (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#7|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |3438|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#7|))))
)))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|))) (and (and (|M3.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|) (and (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|) (ite (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|)))) (= |e#0@@3| |r#0@@3|) (let ((|next#5@@0| (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|))))))
 (and (or (not (= |d#0@@3| 0)) (not true)) (M3.UnionFind.Reaches ($LS $LZ) this@@3 (- |d#0@@3| 1) |next#5@@0| |r#0@@3| |C#0@@5|)))))) (and (forall ((|f#2| T@U) ) (!  (=> ($Is refType |f#2| Tclass.M3.Element?) (and (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |f#2|)) (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |f#2|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |f#2|)) (|M3.Contents#Equal| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#2|))) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#2|)))))))
 :qid |UnionFinddfy.81:46|
 :skolemid |3439|
