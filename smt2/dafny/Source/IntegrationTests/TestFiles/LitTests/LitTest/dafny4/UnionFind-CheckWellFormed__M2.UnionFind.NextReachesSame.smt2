...
(set-info :boogie-vc-id CheckWellFormed$$M2.UnionFind.NextReachesSame)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (=> (and (and ($IsAllocBox ($Box refType this@@10) Tclass.M2.UnionFind? $Heap@@6) (|M2.UnionFind.Valid#canCall| $Heap@@6 this@@10)) (and (M2.UnionFind.Valid $Heap@@6 this@@10) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@10) M2.UnionFind.M))) ($Box refType |e#0@@5|)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= |e#0@@5| null)) (not true))) (=> (or (not (= |e#0@@5| null)) (not true)) (=> (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |e#0@@5|) M2.Element.c))) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@6 $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@10) M2.UnionFind.M))) ($Box refType |e#0@@5|))) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@10) M2.UnionFind.M))) ($Box refType |e#0@@5|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |e#0@@5| null)) (not true))) (=> (or (not (= |e#0@@5| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |e#0@@5|) M2.Element.c)))) (=> (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |e#0@@5|) M2.Element.c))) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@10) M2.UnionFind.M))) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |e#0@@5|) M2.Element.c))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (and (or (not (= this@@10 null)) (not true)) (and ($Is refType this@@10 Tclass.M2.UnionFind) ($IsAlloc refType this@@10 Tclass.M2.UnionFind $Heap@@6)))) (and (and ($Is refType |e#0@@5| Tclass.M2.Element) ($IsAlloc refType |e#0@@5| Tclass.M2.Element $Heap@@6)) (and (= 7 $FunctionContextHeight) (= (ControlFlow 0 7) 2)))) anon0_correct)))
