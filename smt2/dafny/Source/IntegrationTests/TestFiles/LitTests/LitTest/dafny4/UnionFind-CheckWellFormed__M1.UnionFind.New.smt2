...
(set-info :boogie-vc-id CheckWellFormed$$M1.UnionFind.New)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon6_correct  (=> (and (and (not (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.M))) ($Box refType |e#0@0|))) (forall ((|e'#1| T@U) ) (!  (=> ($Is refType |e'#1| Tclass.M1.Element?) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.M))) ($Box refType |e'#1|)) (or (not (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.M))) ($Box refType |e'#1|))) |e#0@0|)) (not true))))
...
))) (= (ControlFlow 0 2) (- 0 1))) ($IsAlloc refType this@@13 Tclass.M1.UnionFind $Heap@@6))))
(let ((anon9_Else_correct  (=> (and (not (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.M))) ($Box refType |e'#0@0|))) (= (ControlFlow 0 8) 2)) anon6_correct)))
(let ((anon9_Then_correct  (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.M))) ($Box refType |e'#0@0|)) (and (=> (= (ControlFlow 0 5) (- 0 7)) ($IsAlloc refType this@@13 Tclass.M1.UnionFind $Heap@@6)) (=> ($IsAlloc refType this@@13 Tclass.M1.UnionFind $Heap@@6) (and (=> (= (ControlFlow 0 5) (- 0 6)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.M))) ($Box refType |e'#0@0|))) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.M))) ($Box refType |e'#0@0|)) (=> (= (ControlFlow 0 5) 2) anon6_correct))))))))
(let ((anon8_Then_correct  (=> (and ($Is refType |e'#0@0| Tclass.M1.Element?) ($IsAlloc refType |e'#0@0| Tclass.M1.Element? $Heap@@6)) (and (=> (= (ControlFlow 0 9) (- 0 10)) ($IsAlloc refType this@@13 Tclass.M1.UnionFind $Heap@@6)) (=> ($IsAlloc refType this@@13 Tclass.M1.UnionFind $Heap@@6) (and (=> (= (ControlFlow 0 9) 5) anon9_Then_correct) (=> (= (ControlFlow 0 9) 8) anon9_Else_correct)))))))
(let ((anon8_Else_correct  (=> (and (not (and ($Is refType |e'#0@0| Tclass.M1.Element?) ($IsAlloc refType |e'#0@0| Tclass.M1.Element? $Heap@@6))) (= (ControlFlow 0 4) 2)) anon6_correct)))
(let ((anon7_Then_correct  (=> (not (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.M))) ($Box refType |e#0@0|))) (and (=> (= (ControlFlow 0 11) 9) anon8_Then_correct) (=> (= (ControlFlow 0 11) 4) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.M))) ($Box refType |e#0@0|)) (= (ControlFlow 0 3) 2)) anon6_correct)))
(let ((anon0_correct  (=> (and (and (and (and (= $_ModifiesFrame@0 (|lambda#14| null $Heap@@6 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.Repr)))) ($IsAllocBox ($Box refType this@@13) Tclass.M1.UnionFind? $Heap@@6)) (and (|M1.UnionFind.Valid#canCall| $Heap@@6 this@@13) (M1.UnionFind.Valid $Heap@@6 this@@13))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@15 T@U) ) (!  (=> (and (or (not (= $o@@15 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 $o@@15) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@15) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 $o@@15)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.Repr)) ($Box refType $o@@15))))
 :qid |UnionFinddfy.86:12|
 :skolemid |1255|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@15))
)) ($HeapSucc $Heap@@6 $Heap@0)))) (and (and (and ($Is refType |e#0@0| Tclass.M1.Element) ($IsAlloc refType |e#0@0| Tclass.M1.Element $Heap@0)) ($IsAllocBox ($Box refType this@@13) Tclass.M1.UnionFind? $Heap@0)) (and (|M1.UnionFind.Valid#canCall| $Heap@0 this@@13) (M1.UnionFind.Valid $Heap@0 this@@13)))) (and (=> (= (ControlFlow 0 12) (- 0 14)) ($IsAlloc refType this@@13 Tclass.M1.UnionFind $Heap@@6)) (=> ($IsAlloc refType this@@13 Tclass.M1.UnionFind $Heap@@6) (=> (and (forall (($o@@16 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@13) M1.UnionFind.Repr)) ($Box refType $o@@16)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.Repr)) ($Box refType $o@@16)))) (or (not (= $o@@16 null)) (not true)))
...
))) (and (=> (= (ControlFlow 0 12) (- 0 13)) ($IsAlloc refType this@@13 Tclass.M1.UnionFind $Heap@@6)) (=> ($IsAlloc refType this@@13 Tclass.M1.UnionFind $Heap@@6) (and (=> (= (ControlFlow 0 12) 11) anon7_Then_correct) (=> (= (ControlFlow 0 12) 3) anon7_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (and (or (not (= this@@13 null)) (not true)) (and ($Is refType this@@13 Tclass.M1.UnionFind) ($IsAlloc refType this@@13 Tclass.M1.UnionFind $Heap@@6)))) (and (and ($Is refType |e#0@@5| Tclass.M1.Element) ($IsAlloc refType |e#0@@5| Tclass.M1.Element $Heap@@6)) (and (= 7 $FunctionContextHeight) (= (ControlFlow 0 15) 12)))) anon0_correct)))
