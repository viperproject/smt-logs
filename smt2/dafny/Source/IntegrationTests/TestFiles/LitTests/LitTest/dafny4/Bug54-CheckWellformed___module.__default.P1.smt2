...
(assert (distinct TBool TagBool TagSet TagMap alloc |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 |tytagFamily$_tuple#2|)
)
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#21| |l#0| |l#1| |l#2| |l#3|) $o $f))  (=> (and (or (not (= $o |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |528|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#21| |l#0| |l#1| |l#2| |l#3|) $o $f))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module._default.P1$X@@0 T@U) (|m#0@@0| T@U) ) (!  (=> (or (|_module.__default.P1#canCall| _module._default.P1$X@@0 |m#0@@0|) (and (< 0 $FunctionContextHeight) (and ($Is MapType |m#0@@0| (TMap _module._default.P1$X@@0 TBool)) (forall ((|x#1| T@U) ) (!  (=> ($IsBox |x#1| _module._default.P1$X@@0) (=> (|Set#IsMember| (|Map#Domain| |m#0@@0|) |x#1|) (U_2_bool ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@0|) |x#1|)))))
 :qid |Bug54dfy.17:19|
 :skolemid |505|
 :pattern ( ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@0|) |x#1|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| |m#0@@0|) |x#1|))
))))) (= (_module.__default.P1 _module._default.P1$X@@0 |m#0@@0|) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |unknown.0:0|
 :skolemid |507|
 :pattern ( (_module.__default.P1 _module._default.P1$X@@0 |m#0@@0|))
))))
...
(declare-fun _module._default.P1$X@@1 () T@U)
(declare-fun |x#3@0| () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $Heap () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$_module.__default.P1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon9_Else_correct true))
(let ((anon9_Then_correct true))
(let ((anon4_correct  (=> (forall ((|x#0| T@U) ) (!  (=> ($IsBox |x#0| _module._default.P1$X@@1) (=> (|Set#IsMember| (|Map#Domain| |m#0@@1|) |x#0|) (U_2_bool ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@1|) |x#0|)))))
 :qid |Bug54dfy.17:19|
 :skolemid |510|
 :pattern ( ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@1|) |x#0|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| |m#0@@1|) |x#0|))
)) (and (=> (= (ControlFlow 0 3) 1) anon9_Then_correct) (=> (= (ControlFlow 0 3) 2) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (=> (|Set#IsMember| (|Map#Domain| |m#0@@1|) |x#3@0|) (U_2_bool ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@1|) |x#3@0|)))) (= (ControlFlow 0 6) 3)) anon4_correct)))
(let ((anon8_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |m#0@@1|) |x#3@0|) (and (=> (= (ControlFlow 0 4) (- 0 5)) (|Set#IsMember| (|Map#Domain| |m#0@@1|) |x#3@0|)) (=> (|Set#IsMember| (|Map#Domain| |m#0@@1|) |x#3@0|) (=> (and (U_2_bool ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@1|) |x#3@0|))) (= (ControlFlow 0 4) 3)) anon4_correct))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#21| null $Heap alloc false)) (=> (and ($IsBox |x#3@0| _module._default.P1$X@@1) ($IsAllocBox |x#3@0| _module._default.P1$X@@1 $Heap)) (and (=> (= (ControlFlow 0 7) 4) anon8_Then_correct) (=> (= (ControlFlow 0 7) 6) anon8_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is MapType |m#0@@1| (TMap _module._default.P1$X@@1 TBool))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct)))
