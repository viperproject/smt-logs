...
(let ((anon5_Then_correct  (=> (and ($IsAlloc BoxType |k#1@0| TORDINAL $Heap@0) ($IsAlloc DatatypeTypeType |c#0@@9| Tclass._module.com $Heap@0)) (=> (and (and ($IsAlloc MapType |s#0@@15| (TMap (TSeq TChar) TInt) $Heap@0) ($IsAlloc MapType |t#0@@9| (TMap (TSeq TChar) TInt) $Heap@0)) (and (|_module.__default.big__step_h#canCall| |k#1@0| |c#0@@9| |s#0@@15| |t#0@@9|) (|_module.__default.big__step_h#canCall| |k#1@0| |c#0@@9| |s#0@@15| |t#0@@9|))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (exists ((|$as#k0#0| T@U) ) (_module.__default.big__step_h ($LS $LZ) |$as#k0#0| |c#0@@9| |s#0@@15| |t#0@@9|))) (=> (exists ((|$as#k0#0@@0| T@U) ) (_module.__default.big__step_h ($LS $LZ) |$as#k0#0@@0| |c#0@@9| |s#0@@15| |t#0@@9|)) (=> (_module.__default.big__step_h ($LS $LZ) |k#0@0| |c#0@@9| |s#0@@15| |t#0@@9|) (and (=> (= (ControlFlow 0 19) 5) anon6_Then_correct) (=> (= (ControlFlow 0 19) 2) anon6_Else_correct)))))))))
