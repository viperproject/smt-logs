...
(set-info :boogie-vc-id Impl$$_module.__default.GcdSymmetric)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@1 $Heap@0) reveal__module._default.Gcd)) (and (and ($IsAlloc intType (int_2_U |x#0@@10|) Tclass._module.pos $Heap@0) (|_module.__default.Factors#canCall| |x#0@@10|)) (and ($IsAlloc intType (int_2_U |y#0@@3|) Tclass._module.pos $Heap@0) (|_module.__default.Factors#canCall| |y#0@@3|)))) (and (and (and ($IsAlloc intType (int_2_U |y#0@@3|) Tclass._module.pos $Heap@0) (|_module.__default.Factors#canCall| |y#0@@3|)) (and ($IsAlloc intType (int_2_U |x#0@@10|) Tclass._module.pos $Heap@0) (|_module.__default.Factors#canCall| |x#0@@10|))) (and (and (|_module.__default.Factors#canCall| |x#0@@10|) (|_module.__default.Factors#canCall| |y#0@@3|)) (and (|_module.__default.Factors#canCall| |y#0@@3|) (|_module.__default.Factors#canCall| |x#0@@10|))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Equal| (|Set#Intersection| (_module.__default.Factors |x#0@@10|) (_module.__default.Factors |y#0@@3|)) (|Set#Intersection| (_module.__default.Factors |y#0@@3|) (_module.__default.Factors |x#0@@10|)))) (=> (|Set#Equal| (|Set#Intersection| (_module.__default.Factors |x#0@@10|) (_module.__default.Factors |y#0@@3|)) (|Set#Intersection| (_module.__default.Factors |y#0@@3|) (_module.__default.Factors |x#0@@10|))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (_module.__default.Gcd reveal__module._default.Gcd |x#0@@10| |y#0@@3|) (_module.__default.Gcd reveal__module._default.Gcd |y#0@@3| |x#0@@10|)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (<= (LitInt 1) |x#0@@10|) (<= (LitInt 1) |y#0@@3|)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
