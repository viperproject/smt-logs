...
(let ((anon10_Else_correct  (=> (and (not (|Set#IsMember| (|Map#Domain| |f#0@@1|) ($Box intType (int_2_U |j#1@0|)))) (= (ControlFlow 0 6) 3)) anon6_correct)))
(let ((anon10_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |f#0@@1|) ($Box intType (int_2_U |j#1@0|))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (|Set#IsMember| (|Map#Domain| |f#0@@1|) ($Box intType (int_2_U |j#1@0|)))) (=> (|Set#IsMember| (|Map#Domain| |f#0@@1|) ($Box intType (int_2_U |j#1@0|))) (=> (= (ControlFlow 0 4) 3) anon6_correct))))))
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#8| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 8) 1) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Then_correct)) (=> (= (ControlFlow 0 8) 2) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is MapType |f#0@@1| (TMap TInt TBool))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct)))
