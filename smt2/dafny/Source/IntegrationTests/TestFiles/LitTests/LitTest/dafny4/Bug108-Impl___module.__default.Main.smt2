...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|$w#0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#1| |l#0| |l#1|) |$w#0|))  (and ($IsBox |$w#0| |l#0|) (|Set#IsMember| |l#1| |$w#0|)))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |483|
 :pattern ( (MapType0Select BoxType boolType (|lambda#1| |l#0| |l#1|) |$w#0|))
)))
...
(assert (forall ((|l#0@@0| T@U) (|$w#0@@0| T@U) ) (! (= (MapType0Select BoxType BoxType (|lambda#2| |l#0@@0|) |$w#0@@0|) (MapType0Select BoxType BoxType |l#0@@0| |$w#0@@0|))
 :qid |Bug108dfy.5:46|
 :skolemid |484|
...
(assert (forall ((v@@7 T@U) (t0@@5 T@U) (t1@@3 T@U) ) (! (= ($Is MapType v@@7 (TMap t0@@5 t1@@3)) (forall ((bx@@8 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@7) bx@@8) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@7) bx@@8) t1@@3) ($IsBox bx@@8 t0@@5)))
...
(let ((anon10_Else_correct  (=> (and (not (|Set#IsMember| (|Map#Domain| |A#0@0|) ($Box intType (int_2_U |x#0@0|)))) (= (ControlFlow 0 6) 3)) anon6_correct)))
(let ((anon10_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |A#0@0|) ($Box intType (int_2_U |x#0@0|))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (|Set#IsMember| (|Map#Domain| |A#0@0|) ($Box intType (int_2_U |x#0@0|)))) (=> (|Set#IsMember| (|Map#Domain| |A#0@0|) ($Box intType (int_2_U |x#0@0|))) (=> (= (ControlFlow 0 4) 3) anon6_correct))))))
(let ((anon9_Else_correct  (=> (not (|Set#IsMember| (|Map#Domain| |A#0@0|) ($Box intType (int_2_U |y#0@0|)))) (and (=> (= (ControlFlow 0 8) 4) anon10_Then_correct) (=> (= (ControlFlow 0 8) 6) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |A#0@0|) ($Box intType (int_2_U |y#0@0|))) (and (=> (= (ControlFlow 0 7) 4) anon10_Then_correct) (=> (= (ControlFlow 0 7) 6) anon10_Else_correct)))))
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 9) 7) anon9_Then_correct) (=> (= (ControlFlow 0 9) 8) anon9_Else_correct))))
(let ((anon8_Else_correct true))
(let ((anon7_Then_correct  (and (=> (= (ControlFlow 0 10) 9) anon8_Then_correct) (=> (= (ControlFlow 0 10) 2) anon8_Else_correct))))
(let ((anon7_Else_correct true))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |A#0@0| (Lit MapType (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 0))) ($Box intType (int_2_U (LitInt 1))))))) (and (=> (= (ControlFlow 0 11) 10) anon7_Then_correct) (=> (= (ControlFlow 0 11) 1) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is MapType |A#0| (TMap TInt TInt)) ($IsAlloc MapType |A#0| (TMap TInt TInt) $Heap)) true) (=> (and (and (and ($Is MapType |B#0| (TMap TInt TInt)) ($IsAlloc MapType |B#0| (TMap TInt TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 12) 11))) anon0_correct)))))
