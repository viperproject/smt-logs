...
(set-info :boogie-vc-id Impl$$_module.__default.MapValues)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |m#0@0| (Lit MapType (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 0))) ($Box boolType (Lit boolType (bool_2_U false))))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (|Set#Equal| (|Map#Domain| |m#0@0|) (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U (LitInt 0)))))) (=> (|Set#Equal| (|Map#Domain| |m#0@0|) (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U (LitInt 0))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (|Set#Equal| (|Map#Values| |m#0@0|) (|Set#UnionOne| |Set#Empty| ($Box boolType (Lit boolType (bool_2_U false)))))) (=> (|Set#Equal| (|Map#Values| |m#0@0|) (|Set#UnionOne| |Set#Empty| ($Box boolType (Lit boolType (bool_2_U false))))) (=> (= |m'#0@0| (|Map#Build| |m#0@0| ($Box intType (int_2_U (LitInt 0))) ($Box boolType (Lit boolType (bool_2_U true))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Set#Equal| (|Map#Values| |m'#0@0|) (|Set#Union| (|Map#Values| |m#0@0|) (|Set#UnionOne| |Set#Empty| ($Box boolType (Lit boolType (bool_2_U true))))))) (=> (|Set#Equal| (|Map#Values| |m'#0@0|) (|Set#Union| (|Map#Values| |m#0@0|) (|Set#UnionOne| |Set#Empty| ($Box boolType (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Set#Equal| (|Map#Values| |m'#0@0|) (|Set#UnionOne| |Set#Empty| ($Box boolType (Lit boolType (bool_2_U true)))))) (=> (|Set#Equal| (|Map#Values| |m'#0@0|) (|Set#UnionOne| |Set#Empty| ($Box boolType (Lit boolType (bool_2_U true))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (U_2_bool (Lit boolType (bool_2_U false)))) (=> (U_2_bool (Lit boolType (bool_2_U false))) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (Lit boolType (bool_2_U false))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is MapType |m#0| (TMap TInt TBool)) ($IsAlloc MapType |m#0| (TMap TInt TBool) $Heap)) true) (=> (and (and (and ($Is MapType |m'#0| (TMap TInt TBool)) ($IsAlloc MapType |m'#0| (TMap TInt TBool) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 8) 2))) anon0_correct)))))
