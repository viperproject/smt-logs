...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.descending)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (not (|_module.List#Equal| (_module.__default.descending ($LS ($LS $LZ)) |a#0@@13| |xs#0@@18| |ys#0@@11|) |#_module.List.Nil|)))))
(let ((anon11_Else_correct  (=> (and (not (and (_module.List.Cons_q |ys#0@@11|) (not (_module.__default.Below |a#0@@13| (_module.List.head |ys#0@@11|))))) ($IsAlloc DatatypeTypeType |ys#0@@11| (Tclass._module.List Tclass._module.G) $Heap@@0)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= (DtRank |ys#0@@11|) (DtRank |ys#0@@11|))) (=> (<= (DtRank |ys#0@@11|) (DtRank |ys#0@@11|)) (=> (|_module.__default.sequences#canCall| |ys#0@@11|) (=> (and (and (= (_module.__default.descending ($LS $LZ) |a#0@@13| |xs#0@@18| |ys#0@@11|) (|#_module.List.Cons| ($Box DatatypeTypeType (|#_module.List.Cons| |a#0@@13| |xs#0@@18|)) (_module.__default.sequences ($LS $LZ) |ys#0@@11|))) (|_module.__default.sequences#canCall| |ys#0@@11|)) (and ($Is DatatypeTypeType (_module.__default.descending ($LS $LZ) |a#0@@13| |xs#0@@18| |ys#0@@11|) (Tclass._module.List (Tclass._module.List Tclass._module.G))) (= (ControlFlow 0 9) 4))) GeneratedUnifiedExit_correct)))))))
(let ((anon11_Then_correct  (=> (and (_module.List.Cons_q |ys#0@@11|) (not (_module.__default.Below |a#0@@13| (_module.List.head |ys#0@@11|)))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (_module.List.Cons_q |ys#0@@11|)) (=> (_module.List.Cons_q |ys#0@@11|) (=> (and (and (= |##a#2@0| (_module.List.head |ys#0@@11|)) ($IsAllocBox |##a#2@0| Tclass._module.G $Heap@@0)) (and (= |##xs#1@0| (|#_module.List.Cons| |a#0@@13| |xs#0@@18|)) ($IsAlloc DatatypeTypeType |##xs#1@0| (Tclass._module.List Tclass._module.G) $Heap@@0))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (_module.List.Cons_q |ys#0@@11|)) (=> (_module.List.Cons_q |ys#0@@11|) (=> (and (= |##ys#1@0| (_module.List.tail |ys#0@@11|)) ($IsAlloc DatatypeTypeType |##ys#1@0| (Tclass._module.List Tclass._module.G) $Heap@@0)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< (DtRank |##ys#1@0|) (DtRank |ys#0@@11|))) (=> (< (DtRank |##ys#1@0|) (DtRank |ys#0@@11|)) (=> (|_module.__default.descending#canCall| (_module.List.head |ys#0@@11|) (|#_module.List.Cons| |a#0@@13| |xs#0@@18|) (_module.List.tail |ys#0@@11|)) (=> (and (and (= (_module.__default.descending ($LS $LZ) |a#0@@13| |xs#0@@18| |ys#0@@11|) (_module.__default.descending ($LS $LZ) (_module.List.head |ys#0@@11|) (|#_module.List.Cons| |a#0@@13| |xs#0@@18|) (_module.List.tail |ys#0@@11|))) (|_module.__default.descending#canCall| (_module.List.head |ys#0@@11|) (|#_module.List.Cons| |a#0@@13| |xs#0@@18|) (_module.List.tail |ys#0@@11|))) (and ($Is DatatypeTypeType (_module.__default.descending ($LS $LZ) |a#0@@13| |xs#0@@18| |ys#0@@11|) (Tclass._module.List (Tclass._module.List Tclass._module.G))) (= (ControlFlow 0 5) 4))) GeneratedUnifiedExit_correct)))))))))))))
