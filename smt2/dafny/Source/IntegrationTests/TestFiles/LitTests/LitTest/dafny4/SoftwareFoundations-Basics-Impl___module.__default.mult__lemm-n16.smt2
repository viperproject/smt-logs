...
(set-info :boogie-vc-id Impl$$_module.__default.mult__lemma_split1)
...
))) (and (and true (= |#_module.Nat.O| |a#0_0_0_1@@0|)) (= |#_module.Nat.O| |b#0_0_0_1@@0|))) (|_module.Nat#Equal| (|#_module.Nat.S| (_module.__default.plus ($LS ($LS $LZ)) |a#0_0_0_1@@0| |b#0_0_0_1@@0|)) (_module.__default.plus ($LS ($LS $LZ)) |a#0_0_0_1@@0| (|#_module.Nat.S| |b#0_0_0_1@@0|))))
 :qid |SoftwareFoundationsBasicsdfy.290:27|
 :skolemid |706|
