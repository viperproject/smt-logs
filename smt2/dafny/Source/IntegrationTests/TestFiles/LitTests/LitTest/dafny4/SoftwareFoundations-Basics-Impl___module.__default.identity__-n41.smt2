...
(set-info :boogie-vc-id Impl$$_module.__default.identity__fn__applied__twice)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|_module.Bool#Equal| (_module.__default.f (_module.__default.f |b#0|)) |b#0|))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |b#0| Tclass._module.Bool) ($IsAlloc DatatypeTypeType |b#0| Tclass._module.Bool $Heap)) (|$IsA#_module.Bool| |b#0|)) (= 2 $FunctionContextHeight)) (and (forall ((|x#1| T@U) ) (!  (=> ($Is DatatypeTypeType |x#1| Tclass._module.Bool) (|_module.Bool#Equal| (_module.__default.f |x#1|) |x#1|))
 :qid |SoftwareFoundationsBasicsdfy.427:19|
 :skolemid |755|
