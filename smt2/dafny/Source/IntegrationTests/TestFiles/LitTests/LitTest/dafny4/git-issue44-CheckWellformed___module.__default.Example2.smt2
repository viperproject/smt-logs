...
(declare-fun _module.__default.Example2 (Int) T@U)
(declare-fun LitInt (Int) Int)
(declare-fun |_module.__default.Example2#canCall| (Int) Bool)
(declare-fun |_module.__default.RepeatMapValue#canCall| (T@U T@U Int) Bool)
(declare-fun $Box (T@T T@U) T@U)
(declare-fun _module.__default.RepeatMapValue (T@U T@U Int) T@U)
...
(assert (distinct TagSet TagMap alloc Tagclass._System.nat |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass._module.uint32 tytagFamily$nat |tytagFamily$_tuple#2| tytagFamily$uint32)
)
...
(assert (forall ((|i#0| T@U) ($h@@0 T@U) ) (! ($IsAlloc intType |i#0| Tclass._module.uint32 $h@@0)
 :qid |unknown.0:0|
 :skolemid |555|
 :pattern ( ($IsAlloc intType |i#0| Tclass._module.uint32 $h@@0))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|len#0| Int) ) (!  (=> (or (|_module.__default.Example2#canCall| (LitInt |len#0|)) (and (< 1 $FunctionContextHeight) (<= (LitInt 0) |len#0|))) (and (|_module.__default.RepeatMapValue#canCall| Tclass._module.uint32 ($Box intType (int_2_U (LitInt 5))) (LitInt |len#0|)) (= (_module.__default.Example2 (LitInt |len#0|)) (_module.__default.RepeatMapValue Tclass._module.uint32 ($Box intType (int_2_U (LitInt 5))) (LitInt |len#0|)))))
 :qid |gitissue44dfy.18:25|
 :weight 3
 :skolemid |546|
 :pattern ( (_module.__default.Example2 (LitInt |len#0|)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module._default.RepeatMapValue$T T@U) (|n#0| T@U) (|count#0| Int) ) (!  (=> (or (|_module.__default.RepeatMapValue#canCall| _module._default.RepeatMapValue$T |n#0| |count#0|) (and (< 0 $FunctionContextHeight) (and ($IsBox |n#0| _module._default.RepeatMapValue$T) (<= (LitInt 0) |count#0|)))) ($Is MapType (_module.__default.RepeatMapValue _module._default.RepeatMapValue$T |n#0| |count#0|) (TMap _module._default.RepeatMapValue$T _module._default.RepeatMapValue$T)))
 :qid |unknown.0:0|
 :skolemid |531|
 :pattern ( (_module.__default.RepeatMapValue _module._default.RepeatMapValue$T |n#0| |count#0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|len#0@@0| Int) ) (!  (=> (or (|_module.__default.Example2#canCall| |len#0@@0|) (and (< 1 $FunctionContextHeight) (<= (LitInt 0) |len#0@@0|))) ($Is MapType (_module.__default.Example2 |len#0@@0|) (TMap Tclass._module.uint32 Tclass._module.uint32)))
 :qid |gitissue44dfy.18:25|
 :skolemid |543|
 :pattern ( (_module.__default.Example2 |len#0@@0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.RepeatMapValue$T@@0 T@U) (|n#0@@0| T@U) (|count#0@@0| Int) ) (!  (=> (and (or (|_module.__default.RepeatMapValue#canCall| _module._default.RepeatMapValue$T@@0 |n#0@@0| |count#0@@0|) (and (< 0 $FunctionContextHeight) (and (and ($IsBox |n#0@@0| _module._default.RepeatMapValue$T@@0) ($IsAllocBox |n#0@@0| _module._default.RepeatMapValue$T@@0 $Heap)) (<= (LitInt 0) |count#0@@0|)))) ($IsGoodHeap $Heap)) ($IsAlloc MapType (_module.__default.RepeatMapValue _module._default.RepeatMapValue$T@@0 |n#0@@0| |count#0@@0|) (TMap _module._default.RepeatMapValue$T@@0 _module._default.RepeatMapValue$T@@0) $Heap))
 :qid |gitissue44dfy.8:16|
 :skolemid |532|
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|len#0@@1| Int) ) (!  (=> (or (|_module.__default.Example2#canCall| |len#0@@1|) (and (< 1 $FunctionContextHeight) (<= (LitInt 0) |len#0@@1|))) (and (|_module.__default.RepeatMapValue#canCall| Tclass._module.uint32 ($Box intType (int_2_U (LitInt 5))) |len#0@@1|) (= (_module.__default.Example2 |len#0@@1|) (_module.__default.RepeatMapValue Tclass._module.uint32 ($Box intType (int_2_U (LitInt 5))) |len#0@@1|))))
 :qid |gitissue44dfy.18:25|
 :skolemid |545|
 :pattern ( (_module.__default.Example2 |len#0@@1|))
))))
...
(declare-fun |len#0@@2| () Int)
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Example2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct  (=> (= |newtype$check#0@0| (LitInt 5)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 4294967296))) (=> (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 4294967296)) (=> (and (= |newtype$check#1@0| (LitInt 5)) (= (ControlFlow 0 3) (- 0 2))) (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 4294967296))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (<= (LitInt 0) |len#0@@2|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 5))) anon0_correct)))
