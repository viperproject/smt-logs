...
(|#_module.List.Cons| |x#0| (_module.__default.append _module._default.append$_T0@@0 $ly@@7 |rest#0@@0| |ys#0@@0|))))))))
 :qid |unknown.0:0|
 :skolemid |560|
...
(_module.__default.append _module._default.rev$_T0@@0 ($LS $LZ) (_module.__default.rev _module._default.rev$_T0@@0 $ly@@8 |rest#0@@1|) (|#_module.List.Cons| |x#0@@0| (Lit DatatypeTypeType |#_module.List.Nil|)))))))))
 :qid |unknown.0:0|
 :skolemid |568|
...
(set-info :boogie-vc-id Impl$$_module.__default.ExtractorLemma_split3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and (and (and (and ($Is DatatypeTypeType |xs#0@@22| (Tclass._module.List _module._default.ExtractorLemma$T)) ($IsAlloc DatatypeTypeType |xs#0@@22| (Tclass._module.List _module._default.ExtractorLemma$T) $Heap@@6)) (|$IsA#_module.List| |xs#0@@22|)) (= 7 $FunctionContextHeight)) (and (<= (LitInt 0) |i#0|) (< |i#0| (_module.__default.length _module._default.ExtractorLemma$T ($LS ($LS $LZ)) |xs#0@@22|)))) (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (|$IsA#_module.List| |xs#0@@22|)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (and (and (and (and (= $Heap@@6 $Heap@0) (forall ((|$ih#xs0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#xs0#0| (Tclass._module.List _module._default.ExtractorLemma$T)) (and (<= (LitInt 0) |i#0|) (< |i#0| (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |$ih#xs0#0|)))) (or (and (<= 0 |i#0|) (< |i#0| |i#0|)) (and (= |i#0| |i#0|) (< (DtRank |$ih#xs0#0|) (DtRank |xs#0@@22|))))) (= (_module.__default.nth _module._default.ExtractorLemma$T reveal__module._default.nth |i#0| (_module.__default.xtr _module._default.ExtractorLemma$T ($LS $LZ) (_module.__default.nats ($LS $LZ) (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |$ih#xs0#0|)) |$ih#xs0#0|)) (_module.__default.nth _module._default.ExtractorLemma$T reveal__module._default.nth |i#0| (_module.__default.rev _module._default.ExtractorLemma$T ($LS $LZ) |$ih#xs0#0|))))
...
))) (and ($IsAlloc DatatypeTypeType |xs#0@@22| (Tclass._module.List _module._default.ExtractorLemma$T) $Heap@0) (|_module.__default.length#canCall| _module._default.ExtractorLemma$T |xs#0@@22|))) (and (and (= |##n#0_0_0@0| (- (- (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|) 1) |i#0|)) ($IsAlloc intType (int_2_U |##n#0_0_0@0|) TInt $Heap@0)) (and ($IsAlloc DatatypeTypeType |xs#0@@22| (Tclass._module.List _module._default.ExtractorLemma$T) $Heap@0) (|_module.__default.nth#canCall| _module._default.ExtractorLemma$T (- (- (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|) 1) |i#0|) |xs#0@@22|)))) (and (and (and (|_module.__default.length#canCall| _module._default.ExtractorLemma$T |xs#0@@22|) (|_module.__default.nth#canCall| _module._default.ExtractorLemma$T (- (- (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|) 1) |i#0|) |xs#0@@22|)) (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4))) (and (and (= $Heap@0 $Heap@4) reveal__module._default.nth) (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5))))) (and (and (and (and (|_module.__default.rev#canCall| _module._default.ExtractorLemma$T |xs#0@@22|) (|_module.__default.length#canCall| _module._default.ExtractorLemma$T (_module.__default.rev _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|))) (|_module.__default.length#canCall| _module._default.ExtractorLemma$T |xs#0@@22|)) (= (_module.__default.length _module._default.ExtractorLemma$T ($LS ($LS $LZ)) (_module.__default.rev _module._default.ExtractorLemma$T ($LS ($LS $LZ)) |xs#0@@22|)) (_module.__default.length _module._default.ExtractorLemma$T ($LS ($LS $LZ)) |xs#0@@22|))) (and (and (= $Heap@4 $Heap@5) (<= (LitInt 0) |i#0|)) (and (< |i#0| (_module.__default.length _module._default.ExtractorLemma$T ($LS ($LS $LZ)) |xs#0@@22|)) (= (ControlFlow 0 2) (- 0 1))))))) (= (_module.__default.length _module._default.ExtractorLemma$T ($LS ($LS $LZ)) |xs#0@@22|) (_module.__default.length _module._default.ExtractorLemma$T ($LS ($LS $LZ)) (_module.__default.rev _module._default.ExtractorLemma$T ($LS ($LS $LZ)) |xs#0@@22|)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
