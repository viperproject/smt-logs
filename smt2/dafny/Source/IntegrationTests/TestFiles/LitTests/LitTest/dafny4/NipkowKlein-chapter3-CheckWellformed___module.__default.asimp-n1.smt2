...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly T@U) (|a#0| T@U) ) (!  (=> (or (|_module.__default.asimp__const#canCall| |a#0|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |a#0| Tclass._module.aexp))) (and (=> (not (_module.aexp.N_q |a#0|)) (=> (not (_module.aexp.V_q |a#0|)) (let ((|a1#1| (_module.aexp._h2 |a#0|)))
(let ((|a0#1| (_module.aexp._h1 |a#0|)))
 (and (|_module.__default.asimp__const#canCall| |a0#1|) (|_module.__default.asimp__const#canCall| |a1#1|)))))) (= (_module.__default.asimp__const ($LS $ly) |a#0|) (ite (_module.aexp.N_q |a#0|) |a#0| (ite (_module.aexp.V_q |a#0|) |a#0| (let ((|a1#0| (_module.aexp._h2 |a#0|)))
(let ((|a0#0| (_module.aexp._h1 |a#0|)))
(let ((|as1#0| (_module.__default.asimp__const $ly |a1#0|)))
(let ((|as0#0| (_module.__default.asimp__const $ly |a0#0|)))
(ite  (and (_module.aexp.N_q |as0#0|) (_module.aexp.N_q |as1#0|)) (|#_module.aexp.N| (+ (_module.aexp.n |as0#0|) (_module.aexp.n |as1#0|))) (|#_module.aexp.Plus| |as0#0| |as1#0|)))))))))))
 ...
 :skolemid |606|
 :pattern ( (_module.__default.asimp__const ($LS $ly) |a#0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@0 T@U) (|a#0@@0| T@U) ) (!  (=> (or (|_module.__default.asimp__const#canCall| |a#0@@0|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |a#0@@0| Tclass._module.aexp))) ($Is DatatypeTypeType (_module.__default.asimp__const $ly@@0 |a#0@@0|) Tclass._module.aexp))
 :qid |NipkowKleinchapter3dfy.52:16|
 :skolemid |604|
 :pattern ( (_module.__default.asimp__const $ly@@0 |a#0@@0|))
))))
...
(assert (forall (($ly@@1 T@U) (|a#0@@1| T@U) ) (! (= (_module.__default.asimp__const ($LS $ly@@1) |a#0@@1|) (_module.__default.asimp__const $ly@@1 |a#0@@1|))
 :qid |NipkowKleinchapter3dfy.52:16|
 :skolemid |602|
 :pattern ( (_module.__default.asimp__const ($LS $ly@@1) |a#0@@1|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@2 T@U) (|a#0@@2| T@U) ) (!  (=> (or (|_module.__default.asimp__const#canCall| (Lit DatatypeTypeType |a#0@@2|)) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |a#0@@2| Tclass._module.aexp))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.aexp.N_q (Lit DatatypeTypeType |a#0@@2|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.aexp.V_q (Lit DatatypeTypeType |a#0@@2|)))))) (let ((|a1#3| (Lit DatatypeTypeType (_module.aexp._h2 (Lit DatatypeTypeType |a#0@@2|)))))
(let ((|a0#3| (Lit DatatypeTypeType (_module.aexp._h1 (Lit DatatypeTypeType |a#0@@2|)))))
 (and (|_module.__default.asimp__const#canCall| |a0#3|) (|_module.__default.asimp__const#canCall| |a1#3|)))))) (= (_module.__default.asimp__const ($LS $ly@@2) (Lit DatatypeTypeType |a#0@@2|)) (ite (_module.aexp.N_q (Lit DatatypeTypeType |a#0@@2|)) (Lit DatatypeTypeType |a#0@@2|) (ite (_module.aexp.V_q (Lit DatatypeTypeType |a#0@@2|)) (Lit DatatypeTypeType |a#0@@2|) (let ((|a1#2| (Lit DatatypeTypeType (_module.aexp._h2 (Lit DatatypeTypeType |a#0@@2|)))))
(let ((|a0#2| (Lit DatatypeTypeType (_module.aexp._h1 (Lit DatatypeTypeType |a#0@@2|)))))
(let ((|as1#2| (Lit DatatypeTypeType (_module.__default.asimp__const ($LS $ly@@2) |a1#2|))))
(let ((|as0#2| (Lit DatatypeTypeType (_module.__default.asimp__const ($LS $ly@@2) |a0#2|))))
(ite  (and (_module.aexp.N_q |as0#2|) (_module.aexp.N_q |as1#2|)) (|#_module.aexp.N| (+ (_module.aexp.n |as0#2|) (_module.aexp.n |as1#2|))) (|#_module.aexp.Plus| |as0#2| |as1#2|)))))))))))
 ...
 :weight 3
 :skolemid |607|
 :pattern ( (_module.__default.asimp__const ($LS $ly@@2) (Lit DatatypeTypeType |a#0@@2|)))
))))
...
(declare-fun |as0#Z#0@0| () T@U)
(declare-fun |as1#Z#0@0| () T@U)
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.asimp__const)
...
(let ((anon18_Then_correct  (=> (and (_module.aexp.N_q |as0#Z#0@0|) (_module.aexp.N_q |as1#Z#0@0|)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (_module.aexp.N_q |as0#Z#0@0|)) (=> (_module.aexp.N_q |as0#Z#0@0|) (=> (= (ControlFlow 0 6) (- 0 5)) (_module.aexp.N_q |as1#Z#0@0|)))))))
(let ((anon17_Else_correct  (=> (not (_module.aexp.N_q |as0#Z#0@0|)) (and (=> (= (ControlFlow 0 10) 6) anon18_Then_correct) (=> (= (ControlFlow 0 10) 8) anon18_Else_correct)))))
(let ((anon17_Then_correct  (=> (_module.aexp.N_q |as0#Z#0@0|) (and (=> (= (ControlFlow 0 9) 6) anon18_Then_correct) (=> (= (ControlFlow 0 9) 8) anon18_Else_correct)))))
(let ((anon16_Then_correct  (=> (and (= |a#0@@3| (|#_module.aexp.Plus| |_mcc#2#0| |_mcc#3#0|)) ($Is DatatypeTypeType |_mcc#2#0| Tclass._module.aexp)) (=> (and (and (and ($Is DatatypeTypeType |_mcc#3#0| Tclass._module.aexp) (= |let#0#0#0| |_mcc#3#0|)) (and ($Is DatatypeTypeType |let#0#0#0| Tclass._module.aexp) (= |a1#Z#0@0| |let#0#0#0|))) (and (and (= |let#1#0#0| |_mcc#2#0|) ($Is DatatypeTypeType |let#1#0#0| Tclass._module.aexp)) (and (= |a0#Z#0@0| |let#1#0#0|) ($IsAlloc DatatypeTypeType |a0#Z#0@0| Tclass._module.aexp $Heap)))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (< (DtRank |a0#Z#0@0|) (DtRank |a#0@@3|))) (=> (< (DtRank |a0#Z#0@0|) (DtRank |a#0@@3|)) (=> (and (|_module.__default.asimp__const#canCall| |a0#Z#0@0|) (= |let#2#0#0| (_module.__default.asimp__const ($LS $LZ) |a0#Z#0@0|))) (=> (and (and (|_module.__default.asimp__const#canCall| |a0#Z#0@0|) ($Is DatatypeTypeType |let#2#0#0| Tclass._module.aexp)) (and (= |as0#Z#0@0| |let#2#0#0|) ($IsAlloc DatatypeTypeType |a1#Z#0@0| Tclass._module.aexp $Heap))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< (DtRank |a1#Z#0@0|) (DtRank |a#0@@3|))) (=> (< (DtRank |a1#Z#0@0|) (DtRank |a#0@@3|)) (=> (|_module.__default.asimp__const#canCall| |a1#Z#0@0|) (=> (and (and (= |let#2#1#0| (_module.__default.asimp__const ($LS $LZ) |a1#Z#0@0|)) (|_module.__default.asimp__const#canCall| |a1#Z#0@0|)) (and ($Is DatatypeTypeType |let#2#1#0| Tclass._module.aexp) (= |as1#Z#0@0| |let#2#1#0|))) (and (=> (= (ControlFlow 0 11) 9) anon17_Then_correct) (=> (= (ControlFlow 0 11) 10) anon17_Else_correct))))))))))))))
(let ((anon16_Else_correct true))
(let ((anon15_Else_correct  (=> (or (not (= |a#0@@3| (|#_module.aexp.V| |_mcc#1#0|))) (not true)) (and (=> (= (ControlFlow 0 14) 11) anon16_Then_correct) (=> (= (ControlFlow 0 14) 4) anon16_Else_correct)))))
(let ((anon15_Then_correct true))
(let ((anon14_Else_correct  (=> (or (not (= |a#0@@3| (|#_module.aexp.N| |_mcc#0#0|))) (not true)) (and (=> (= (ControlFlow 0 15) 3) anon15_Then_correct) (=> (= (ControlFlow 0 15) 14) anon15_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |a#0@@3| Tclass._module.aexp)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 17) 16))) anon0_correct)))
