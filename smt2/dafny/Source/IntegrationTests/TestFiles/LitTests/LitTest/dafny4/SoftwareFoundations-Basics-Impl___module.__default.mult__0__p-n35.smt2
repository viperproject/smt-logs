...
(set-info :boogie-vc-id Impl$$_module.__default.mult__0__plus)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (|$IsA#_module.Nat| |n#0@@7|) (|$IsA#_module.Nat| |m#0@@7|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (forall ((|$ih#n0#0| T@U) (|$ih#m0#0| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |$ih#n0#0| Tclass._module.Nat) ($Is DatatypeTypeType |$ih#m0#0| Tclass._module.Nat)) (U_2_bool (Lit boolType (bool_2_U true)))) (or (< (DtRank |$ih#n0#0|) (DtRank |n#0@@7|)) (and (= (DtRank |$ih#n0#0|) (DtRank |n#0@@7|)) (< (DtRank |$ih#m0#0|) (DtRank |m#0@@7|))))) (|_module.Nat#Equal| (_module.__default.mult ($LS $LZ) (_module.__default.plus ($LS $LZ) (Lit DatatypeTypeType |#_module.Nat.O|) |$ih#n0#0|) |$ih#m0#0|) (_module.__default.mult ($LS $LZ) |$ih#n0#0| |$ih#m0#0|)))
 :qid |SoftwareFoundationsBasicsdfy.376:20|
 :skolemid |746|
 :pattern ( (_module.__default.mult ($LS $LZ) (_module.__default.plus ($LS $LZ) (Lit DatatypeTypeType |#_module.Nat.O|) |$ih#n0#0|) |$ih#m0#0|))
)) (= (ControlFlow 0 2) (- 0 1)))) (|_module.Nat#Equal| (_module.__default.mult ($LS ($LS $LZ)) (_module.__default.plus ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Nat.O|) |n#0@@7|) |m#0@@7|) (_module.__default.mult ($LS ($LS $LZ)) |n#0@@7| |m#0@@7|)))))))
