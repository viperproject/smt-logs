...
(set-info :boogie-vc-id Impl$$_module.__default.equiv__refl)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|_module.__default.equiv#canCall| |l#0@@6| |l#0@@6|)) (or (_module.__default.equiv |l#0@@6| |l#0@@6|) (forall ((|z#1@@1| Int) ) (! (= (_module.__default.nb__occ ($LS ($LS $LZ)) |z#1@@1| |l#0@@6|) (_module.__default.nb__occ ($LS ($LS $LZ)) |z#1@@1| |l#0@@6|))
 :qid |CoqArtInsertionSortdfy.55:10|
 :skolemid |562|
 :pattern ( (_module.__default.nb__occ ($LS ($LS $LZ)) |z#1@@1| |l#0@@6|))
 :pattern ( (_module.__default.nb__occ ($LS ($LS $LZ)) |z#1@@1| |l#0@@6|))
))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |l#0@@6| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |l#0@@6| (Tclass._module.List TInt) $Heap)) (|$IsA#_module.List| |l#0@@6|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
