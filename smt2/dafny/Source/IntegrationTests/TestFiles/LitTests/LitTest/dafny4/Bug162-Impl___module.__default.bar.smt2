...
(assert (distinct TInt TagInt TagISet TagIMap alloc |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass._module.A Tagclass._module.B Tagclass._module.C Tagclass._module.D |tytagFamily$_tuple#2| tytagFamily$A tytagFamily$B tytagFamily$C tytagFamily$D)
)
...
(assert (forall ((bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 Tclass._module.A) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@1)) bx@@1) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@1) Tclass._module.A)))
 :qid |unknown.0:0|
 :skolemid |484|
 :pattern ( ($IsBox bx@@1 Tclass._module.A))
)))
(assert (forall ((bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 Tclass._module.B) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@2)) bx@@2) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@2) Tclass._module.B)))
 :qid |unknown.0:0|
 :skolemid |486|
 :pattern ( ($IsBox bx@@2 Tclass._module.B))
)))
(assert (forall ((bx@@3 T@U) ) (!  (=> ($IsBox bx@@3 Tclass._module.C) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@3)) bx@@3) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@3) Tclass._module.C)))
 :qid |unknown.0:0|
 :skolemid |488|
 :pattern ( ($IsBox bx@@3 Tclass._module.C))
)))
(assert (forall ((bx@@4 T@U) ) (!  (=> ($IsBox bx@@4 Tclass._module.D) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@4)) bx@@4) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@4) Tclass._module.D)))
 :qid |unknown.0:0|
 :skolemid |490|
 :pattern ( ($IsBox bx@@4 Tclass._module.D))
)))
...
(assert (forall ((v@@3 T@U) (t0@@1 T@U) (h@@3 T@U) ) (! (= ($IsAlloc (MapType0Type BoxType boolType) v@@3 (TISet t0@@1) h@@3) (forall ((bx@@5 T@U) ) (!  (=> (U_2_bool (MapType0Select BoxType boolType v@@3 bx@@5)) ($IsAllocBox bx@@5 t0@@1 h@@3))
 :qid |DafnyPreludebpl.303:11|
 :skolemid |69|
 :pattern ( (MapType0Select BoxType boolType v@@3 bx@@5))
)))
...
(assert (forall ((v@@5 T@U) (t0@@2 T@U) (t1@@0 T@U) (h@@4 T@U) ) (! (= ($IsAlloc IMapType v@@5 (TIMap t0@@2 t1@@0) h@@4) (forall ((bx@@6 T@U) ) (!  (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| v@@5) bx@@6)) (and ($IsAllocBox (MapType0Select BoxType BoxType (|IMap#Elements| v@@5) bx@@6) t1@@0 h@@4) ($IsAllocBox bx@@6 t0@@2 h@@4)))
 :qid |DafnyPreludebpl.327:19|
 :skolemid |77|
 :pattern ( (MapType0Select BoxType BoxType (|IMap#Elements| v@@5) bx@@6))
 :pattern ( (MapType0Select BoxType boolType (|IMap#Domain| v@@5) bx@@6))
)))
...
(assert (forall ((v@@8 T@U) (t0@@3 T@U) (t1@@1 T@U) ) (! (= ($Is IMapType v@@8 (TIMap t0@@3 t1@@1)) (forall ((bx@@8 T@U) ) (!  (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| v@@8) bx@@8)) (and ($IsBox (MapType0Select BoxType BoxType (|IMap#Elements| v@@8) bx@@8) t1@@1) ($IsBox bx@@8 t0@@3)))
 :qid |DafnyPreludebpl.276:19|
 :skolemid |58|
 :pattern ( (MapType0Select BoxType BoxType (|IMap#Elements| v@@8) bx@@8))
 :pattern ( (MapType0Select BoxType boolType (|IMap#Domain| v@@8) bx@@8))
)))
...
(assert (forall ((bx@@9 T@U) (s T@U) (t@@8 T@U) ) (!  (=> ($IsBox bx@@9 (TIMap s t@@8)) (and (= ($Box IMapType ($Unbox IMapType bx@@9)) bx@@9) ($Is IMapType ($Unbox IMapType bx@@9) (TIMap s t@@8))))
 :qid |DafnyPreludebpl.210:15|
 :skolemid |37|
 :pattern ( ($IsBox bx@@9 (TIMap s t@@8)))
)))
...
(assert (forall ((d@@3 T@U) ($h@@0 T@U) ) (!  (=> (and ($IsGoodHeap $h@@0) ($Is DatatypeTypeType d@@3 Tclass._module.A)) ($IsAlloc DatatypeTypeType d@@3 Tclass._module.A $h@@0))
 :qid |unknown.0:0|
 :skolemid |503|
 :pattern ( ($IsAlloc DatatypeTypeType d@@3 Tclass._module.A $h@@0))
)))
(assert (forall ((d@@4 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) ($Is DatatypeTypeType d@@4 Tclass._module.B)) ($IsAlloc DatatypeTypeType d@@4 Tclass._module.B $h@@1))
 :qid |unknown.0:0|
 :skolemid |517|
 :pattern ( ($IsAlloc DatatypeTypeType d@@4 Tclass._module.B $h@@1))
)))
(assert (forall ((d@@5 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) ($Is DatatypeTypeType d@@5 Tclass._module.C)) ($IsAlloc DatatypeTypeType d@@5 Tclass._module.C $h@@2))
 :qid |unknown.0:0|
 :skolemid |532|
 :pattern ( ($IsAlloc DatatypeTypeType d@@5 Tclass._module.C $h@@2))
)))
(assert (forall ((d@@6 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) ($Is DatatypeTypeType d@@6 Tclass._module.D)) ($IsAlloc DatatypeTypeType d@@6 Tclass._module.D $h@@3))
 :qid |unknown.0:0|
 :skolemid |547|
 :pattern ( ($IsAlloc DatatypeTypeType d@@6 Tclass._module.D $h@@3))
)))
...
(assert (forall ((d@@7 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (_System.Tuple2.___hMake2_q d@@7) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@7 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@4)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@7 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@4))
)))) ($IsAllocBox (_System.Tuple2._0 d@@7) |_System._tuple#2$T0@@6| $h@@4))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@7) |_System._tuple#2$T0@@6| $h@@4))
)))
(assert (forall ((d@@8 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (_System.Tuple2.___hMake2_q d@@8) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@8 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@5)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@8 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@5))
)))) ($IsAllocBox (_System.Tuple2._1 d@@8) |_System._tuple#2$T1@@7| $h@@5))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@8) |_System._tuple#2$T1@@7| $h@@5))
)))
