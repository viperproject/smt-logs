...
(declare-fun _module.__default.Crash2 (T@U) Int)
(declare-fun |_module.__default.Crash2#canCall| (T@U) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|xs#0| T@U) ) (!  (=> (or (|_module.__default.Crash2#canCall| (Lit DatatypeTypeType |xs#0|)) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0| Tclass._module.List) (U_2_bool (Lit boolType (bool_2_U (_module.List.Cons_q (Lit DatatypeTypeType |xs#0|)))))))) (= (_module.__default.Crash2 (Lit DatatypeTypeType |xs#0|)) (let ((|h#1| (_module.List.head (Lit DatatypeTypeType |xs#0|))))
|h#1|)))
 :qid |Bug168dfy.13:23|
 :weight 3
 :skolemid |487|
 :pattern ( (_module.__default.Crash2 (Lit DatatypeTypeType |xs#0|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|xs#0@@0| T@U) ) (!  (=> (or (|_module.__default.Crash2#canCall| |xs#0@@0|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@0| Tclass._module.List) (_module.List.Cons_q |xs#0@@0|)))) (= (_module.__default.Crash2 |xs#0@@0|) (_module.List.head |xs#0@@0|)))
 :qid |Bug168dfy.13:23|
 :skolemid |484|
 :pattern ( (_module.__default.Crash2 |xs#0@@0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|xs#0@@1| T@U) ) (!  (=> (or (|_module.__default.Crash2#canCall| |xs#0@@1|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@1| Tclass._module.List) (_module.List.Cons_q |xs#0@@1|)))) (= (_module.__default.Crash2 |xs#0@@1|) (let ((|h#0| (_module.List.head |xs#0@@1|)))
|h#0|)))
 :qid |Bug168dfy.13:23|
 :skolemid |486|
 :pattern ( (_module.__default.Crash2 |xs#0@@1|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Crash2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (= (_module.__default.Crash2 |xs#0@@2|) (_module.List.head |xs#0@@2|)))))
(let ((anon5_Else_correct  (=> (and (= |let#0#0#0| |xs#0@@2|) ($Is DatatypeTypeType |let#0#0#0| Tclass._module.List)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (_module.List.Cons_q |let#0#0#0|)) (=> (_module.List.Cons_q |let#0#0#0|) (=> (and (and (= (|#_module.List.Cons| |h#Z#0@0| |_v0#Z#0@0|) |let#0#0#0|) (= (_module.__default.Crash2 |xs#0@@2|) |h#Z#0@0|)) (and ($Is intType (int_2_U (_module.__default.Crash2 |xs#0@@2|)) TInt) (= (ControlFlow 0 7) 6))) GeneratedUnifiedExit_correct))))))
(let ((anon5_Then_correct  (=> ($IsAlloc DatatypeTypeType |xs#0@@2| Tclass._module.List $Heap) (and (=> (= (ControlFlow 0 2) (- 0 4)) (_module.List.Cons_q |xs#0@@2|)) (=> (_module.List.Cons_q |xs#0@@2|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (|_module.List#Equal| |xs#0@@2| |xs#0@@2|) (< (DtRank |xs#0@@2|) (DtRank |xs#0@@2|)))) (=> (or (|_module.List#Equal| |xs#0@@2| |xs#0@@2|) (< (DtRank |xs#0@@2|) (DtRank |xs#0@@2|))) (=> (and (or (|_module.List#Equal| |xs#0@@2| |xs#0@@2|) (|_module.__default.Crash2#canCall| |xs#0@@2|)) (= (ControlFlow 0 2) (- 0 1))) (_module.List.Cons_q |xs#0@@2|)))))))))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (_module.List.Cons_q |xs#0@@2|)) (and (=> (= (ControlFlow 0 9) 2) anon5_Then_correct) (=> (= (ControlFlow 0 9) 7) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |xs#0@@2| Tclass._module.List)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct)))
