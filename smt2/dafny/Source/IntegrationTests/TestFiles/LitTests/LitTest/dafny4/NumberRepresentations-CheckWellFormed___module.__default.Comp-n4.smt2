...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Complete)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon12_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and ($Is SeqType |digits#0@0| (TSeq TInt)) ($IsAlloc SeqType |digits#0@0| (TSeq TInt) $Heap@0))) (and (and (and ($IsAlloc SeqType |digits#0@0| (TSeq TInt) $Heap@0) ($IsAlloc intType (int_2_U |lowDigit#0@@1|) TInt $Heap@0)) (and ($IsAlloc intType (int_2_U |base#0@@5|) TInt $Heap@0) (|_module.__default.IsSkewNumber#canCall| |digits#0@0| |lowDigit#0@@1| |base#0@@5|))) (and (and (_module.__default.IsSkewNumber |digits#0@0| |lowDigit#0@@1| |base#0@@5|) ($IsAlloc SeqType |digits#0@0| (TSeq TInt) $Heap@0)) (and ($IsAlloc intType (int_2_U |base#0@@5|) TInt $Heap@0) (= (ControlFlow 0 2) (- 0 1)))))) (<= (LitInt 2) |base#0@@5|))))
(let ((anon16_Else_correct  (=> (and (< |n#0| (LitInt 0)) (= (ControlFlow 0 4) 2)) anon12_correct)))
(let ((anon16_Then_correct  (=> (and (<= (LitInt 0) |n#0|) (= (ControlFlow 0 3) 2)) anon12_correct)))
(let ((anon15_Else_correct  (=> (=> (<= (+ |lowDigit#0@@1| |base#0@@5|) (LitInt 1)) (<= |n#0| (LitInt 0))) (and (=> (= (ControlFlow 0 6) 3) anon16_Then_correct) (=> (= (ControlFlow 0 6) 4) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (and (<= (+ |lowDigit#0@@1| |base#0@@5|) (LitInt 1)) (<= |n#0| (LitInt 0))) (and (=> (= (ControlFlow 0 5) 3) anon16_Then_correct) (=> (= (ControlFlow 0 5) 4) anon16_Else_correct)))))
(let ((anon14_Else_correct  (=> (=> (<= (LitInt 0) |lowDigit#0@@1|) (<= (LitInt 0) |n#0|)) (and (=> (= (ControlFlow 0 8) 5) anon15_Then_correct) (=> (= (ControlFlow 0 8) 6) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (and (<= (LitInt 0) |lowDigit#0@@1|) (<= (LitInt 0) |n#0|)) (and (=> (= (ControlFlow 0 7) 5) anon15_Then_correct) (=> (= (ControlFlow 0 7) 6) anon15_Else_correct)))))
(let ((anon3_correct  (=> (and (<= |lowDigit#0@@1| (LitInt 0)) (< 0 (+ |lowDigit#0@@1| |base#0@@5|))) (and (=> (= (ControlFlow 0 9) 7) anon14_Then_correct) (=> (= (ControlFlow 0 9) 8) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (< (LitInt 0) |lowDigit#0@@1|) (= (ControlFlow 0 11) 9)) anon3_correct)))
(let ((anon13_Then_correct  (=> (and (<= |lowDigit#0@@1| (LitInt 0)) (= (ControlFlow 0 10) 9)) anon3_correct)))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (<= (LitInt 2) |base#0@@5|)) (and (=> (= (ControlFlow 0 12) 10) anon13_Then_correct) (=> (= (ControlFlow 0 12) 11) anon13_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |digits#0@@5| (TSeq TInt)) ($IsAlloc SeqType |digits#0@@5| (TSeq TInt) $Heap)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 13) 12))) anon0_correct))))
