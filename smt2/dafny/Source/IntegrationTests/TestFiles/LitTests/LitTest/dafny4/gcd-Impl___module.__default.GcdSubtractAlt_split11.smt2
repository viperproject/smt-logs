...
(set-info :boogie-vc-id Impl$$_module.__default.GcdSubtractAlt_split11)
...
(assert (not
 ...
 :qid |gcddfy.245:9|
 :skolemid |670|
)))) (=> (and (<= (LitInt 1) |b#2_0@0|) (= (Mul |q#2_0@0| |b#2_0@0|) (- |y#0@@3| |x#0@@10|))) (=> (and (and (= |newtype$check#2_0_0_1_0@0| (Mul |q#2_0@0| |a#2_0@0|)) (<= (LitInt 1) |newtype$check#2_0_0_1_0@0|)) (and (= |newtype$check#2_0_0_1_1@0| (Mul |q#2_0@0| |b#2_0@0|)) (= (ControlFlow 0 2) (- 0 1)))) (<= (LitInt 1) |newtype$check#2_0_0_1_1@0|))))))
