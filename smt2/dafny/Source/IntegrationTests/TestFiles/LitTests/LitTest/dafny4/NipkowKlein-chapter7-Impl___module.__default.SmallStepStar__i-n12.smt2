...
(declare-fun |s'#12@@0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.SmallStepStar__implies__BigStep_h)
...
(let ((anon9_correct  (and (=> (= (ControlFlow 0 9) (- 0 18)) (or (exists ((|$as#s'0_1_0#0| T@U) ) (!  (and ($Is MapType |$as#s'0_1_0#0| (TMap (TSeq TChar) TInt)) (and ($Is DatatypeTypeType (Lit DatatypeTypeType |#_module.com.SKIP|) Tclass._module.com) (and (_module.__default.small__step ($LS $LZ) |c#1| |s#1| (Lit DatatypeTypeType |#_module.com.SKIP|) |$as#s'0_1_0#0|) (_module.__default.small__step__star_h ($LS $LZ) (|ORD#Minus| |_k#0@@21| (|ORD#FromNat| 1)) (Lit DatatypeTypeType |#_module.com.SKIP|) |$as#s'0_1_0#0| (Lit DatatypeTypeType |#_module.com.SKIP|) |t#1|))))
 :qid |NipkowKleinchapter7dfy.321:13|
 :skolemid |1307|
)) (exists ((|$as#c'0_1_0#0| T@U) (|$as#s'0_1_0#0@@0| T@U) ) (!  (and (and ($Is DatatypeTypeType |$as#c'0_1_0#0| Tclass._module.com) ($Is MapType |$as#s'0_1_0#0@@0| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS $LZ) |c#1| |s#1| |$as#c'0_1_0#0| |$as#s'0_1_0#0@@0|) (_module.__default.small__step__star_h ($LS $LZ) (|ORD#Minus| |_k#0@@21| (|ORD#FromNat| 1)) |$as#c'0_1_0#0| |$as#s'0_1_0#0@@0| (Lit DatatypeTypeType |#_module.com.SKIP|) |t#1|)))
 :qid |NipkowKleinchapter7dfy.321:9|
 :skolemid |1306|
)))) (=> (or (exists ((|$as#s'0_1_0#0@@1| T@U) ) (!  (and ($Is MapType |$as#s'0_1_0#0@@1| (TMap (TSeq TChar) TInt)) (and ($Is DatatypeTypeType (Lit DatatypeTypeType |#_module.com.SKIP|) Tclass._module.com) (and (_module.__default.small__step ($LS $LZ) |c#1| |s#1| (Lit DatatypeTypeType |#_module.com.SKIP|) |$as#s'0_1_0#0@@1|) (_module.__default.small__step__star_h ($LS $LZ) (|ORD#Minus| |_k#0@@21| (|ORD#FromNat| 1)) (Lit DatatypeTypeType |#_module.com.SKIP|) |$as#s'0_1_0#0@@1| (Lit DatatypeTypeType |#_module.com.SKIP|) |t#1|))))
 :qid |NipkowKleinchapter7dfy.321:13|
 :skolemid |1307|
)) (exists ((|$as#c'0_1_0#0@@0| T@U) (|$as#s'0_1_0#0@@2| T@U) ) (!  (and (and ($Is DatatypeTypeType |$as#c'0_1_0#0@@0| Tclass._module.com) ($Is MapType |$as#s'0_1_0#0@@2| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS $LZ) |c#1| |s#1| |$as#c'0_1_0#0@@0| |$as#s'0_1_0#0@@2|) (_module.__default.small__step__star_h ($LS $LZ) (|ORD#Minus| |_k#0@@21| (|ORD#FromNat| 1)) |$as#c'0_1_0#0@@0| |$as#s'0_1_0#0@@2| (Lit DatatypeTypeType |#_module.com.SKIP|) |t#1|)))
 :qid |NipkowKleinchapter7dfy.321:9|
 :skolemid |1306|
))) (=> (and ($Is DatatypeTypeType |c'#0@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |c'#0@0| Tclass._module.com $Heap@0)) (=> (and (and ($Is MapType |s'#12@0| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |s'#12@0| (TMap (TSeq TChar) TInt) $Heap@0)) (and (_module.__default.small__step ($LS $LZ) |c#1| |s#1| |c'#0@0| |s'#12@0|) (_module.__default.small__step__star_h ($LS $LZ) (|ORD#Minus| |_k#0@@21| (|ORD#FromNat| 1)) |c'#0@0| |s'#12@0| (Lit DatatypeTypeType |#_module.com.SKIP|) |t#1|))) (and (=> (= (ControlFlow 0 9) (- 0 17)) (=> (|_module.__default.small__step#canCall| |c#1| |s#1| |c'#0@0| |s'#12@0|) (or (_module.__default.small__step ($LS $LZ) |c#1| |s#1| |c'#0@0| |s'#12@0|) (=> (_module.com.SKIP_q |c#1|) (U_2_bool (Lit boolType (bool_2_U false))))))) (=> (=> (|_module.__default.small__step#canCall| |c#1| |s#1| |c'#0@0| |s'#12@0|) (or (_module.__default.small__step ($LS $LZ) |c#1| |s#1| |c'#0@0| |s'#12@0|) (=> (_module.com.SKIP_q |c#1|) (U_2_bool (Lit boolType (bool_2_U false)))))) (and (=> (= (ControlFlow 0 9) (- 0 16)) (=> (|_module.__default.small__step#canCall| |c#1| |s#1| |c'#0@0| |s'#12@0|) (or (_module.__default.small__step ($LS $LZ) |c#1| |s#1| |c'#0@0| |s'#12@0|) (=> (not (_module.com.SKIP_q |c#1|)) (=> (_module.com.Assign_q |c#1|) (|_module.com#Equal| |c'#0@0| |#_module.com.SKIP|)))))) (=> (=> (|_module.__default.small__step#canCall| |c#1| |s#1| |c'#0@0| |s'#12@0|) (or (_module.__default.small__step ($LS $LZ) |c#1| |s#1| |c'#0@0| |s'#12@0|) (=> (not (_module.com.SKIP_q |c#1|)) (=> (_module.com.Assign_q |c#1|) (|_module.com#Equal| |c'#0@0| |#_module.com.SKIP|))))) (and (=> (= (ControlFlow 0 9) (- 0 15)) (=> (|_module.__default.small__step#canCall| |c#1| |s#1| |c'#0@0| |s'#12@0|) (or (_module.__default.small__step ($LS $LZ) |c#1| |s#1| |c'#0@0| |s'#12@0|) (=> (not (_module.com.SKIP_q |c#1|)) (=> (_module.com.Assign_q |c#1|) (let ((|a#0@@4| (_module.com._h1 |c#1|)))
...
(let ((anon11_Else_correct  (=> (<= (|ORD#Offset| |_k#0@@21|) 0) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1)) (and (forall ((|_k'#2@@5| T@U) (|c#2| T@U) (|s#2| T@U) (|t#2| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |c#2| Tclass._module.com) ($Is MapType |s#2| (TMap (TSeq TChar) TInt))) ($Is MapType |t#2| (TMap (TSeq TChar) TInt))) (and (|ORD#Less| |_k'#2@@5| |_k#0@@21|) (_module.__default.small__step__star_h ($LS $LZ) |_k'#2@@5| |c#2| |s#2| (Lit DatatypeTypeType |#_module.com.SKIP|) |t#2|))) (_module.__default.big__step ($LS $LZ) |c#2| |s#2| |t#2|))
 :qid |NipkowKleinchapter7dfy.315:13|
 :skolemid |1309|
