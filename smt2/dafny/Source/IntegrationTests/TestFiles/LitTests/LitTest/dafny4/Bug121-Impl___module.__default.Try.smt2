...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon6_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (= (Mul |a#0| |c#0|) (Mul |a#0| |c#0|))) (=> (= (Mul |a#0| |c#0|) (Mul |a#0| |c#0|)) (=> (= (ControlFlow 0 4) (- 0 3)) (= (Mul |b#0| |c#0|) (Mul |b#0| |c#0|)))))))
(let ((anon6_Then_correct true))
(let ((anon5_Then_correct  (and (=> (= (ControlFlow 0 6) 2) anon6_Then_correct) (=> (= (ControlFlow 0 6) 4) anon6_Else_correct))))
