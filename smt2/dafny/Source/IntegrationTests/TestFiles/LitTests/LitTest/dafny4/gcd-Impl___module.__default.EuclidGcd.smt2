...
(declare-fun |##y#0_0_0_0@0| () Int)
(declare-fun |y##0_0_0_0@0| () Int)
(declare-fun $Heap@5 () T@U)
(declare-fun |##x#0_0_0_1@0| () Int)
(declare-fun $Heap@4 () T@U)
(declare-fun |##y#0_0_1_1@0| () Int)
...
(set-info :boogie-vc-id Impl$$_module.__default.EuclidGcd)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 35) (let ((anon14_correct  (and (=> (= (ControlFlow 0 20) (- 0 22)) (or (<= 0 |$decr$loop#00@1|) (= (+ |x#0@2| |y#0@2|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (+ |x#0@2| |y#0@2|) |$decr$loop#00@1|)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (< (+ |x#0@2| |y#0@2|) |$decr$loop#00@1|)) (=> (< (+ |x#0@2| |y#0@2|) |$decr$loop#00@1|) (=> (and (and (and (|_module.__default.Gcd#canCall| |x#0@2| |y#0@2|) (|_module.__default.Gcd#canCall| |X#0| |Y#0|)) (= (ControlFlow 0 20) (- 0 19))) |$w$loop#0@0|) (= (_module.__default.Gcd reveal__module._default.Gcd |x#0@2| |y#0@2|) (_module.__default.Gcd reveal__module._default.Gcd |X#0| |Y#0|)))))))))
(let ((anon24_Else_correct  (=> (= (_module.__default.Gcd reveal__module._default.Gcd |x#0@0| |y#0@0|) (_module.__default.Gcd reveal__module._default.Gcd (- |x#0@0| |y#0@0|) |y#0@0|)) (and (=> (= (ControlFlow 0 26) (- 0 27)) ($Is intType (int_2_U (- |x#0@0| |y#0@0|)) Tclass._module.pos)) (=> ($Is intType (int_2_U (- |x#0@0| |y#0@0|)) Tclass._module.pos) (=> (and (and (= |x#0@1| (- |x#0@0| |y#0@0|)) (= |x#0@2| |x#0@1|)) (and (= |y#0@2| |y#0@0|) (= (ControlFlow 0 26) 20))) anon14_correct))))))
(let ((anon19_Then_correct  (=> (< |x#0@0| |y#0@0|) (and (=> (= (ControlFlow 0 23) (- 0 25)) (< |x#0@0| |y#0@0|)) (=> (< |x#0@0| |y#0@0|) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (|_module.__default.Gcd#canCall| |x#0@0| |y#0@0|) (|_module.__default.Gcd#canCall| |x#0@0| (- |y#0@0| |x#0@0|))) (and (= (_module.__default.Gcd reveal__module._default.Gcd |x#0@0| |y#0@0|) (_module.__default.Gcd reveal__module._default.Gcd |x#0@0| (- |y#0@0| |x#0@0|))) (= $Heap@0 $Heap@1))) (and (=> (= (ControlFlow 0 23) (- 0 24)) ($Is intType (int_2_U (- |y#0@0| |x#0@0|)) Tclass._module.pos)) (=> ($Is intType (int_2_U (- |y#0@0| |x#0@0|)) Tclass._module.pos) (=> (and (and (= |y#0@1| (- |y#0@0| |x#0@0|)) (= |x#0@2| |x#0@0|)) (and (= |y#0@2| |y#0@1|) (= (ControlFlow 0 23) 20))) anon14_correct))))))))))
(let ((anon24_Then_correct  (=> (and ($IsAlloc intType (int_2_U |y#0@0|) Tclass._module.pos $Heap@0) ($Is intType (int_2_U (- |x#0@0| |y#0@0|)) Tclass._module.pos)) (=> (and (and (= |##y#0_0_0_0@0| (- |x#0@0| |y#0@0|)) ($IsAlloc intType (int_2_U |##y#0_0_0_0@0|) Tclass._module.pos $Heap@0)) (and (|_module.__default.Gcd#canCall| |y#0@0| (- |x#0@0| |y#0@0|)) (|_module.__default.Gcd#canCall| |y#0@0| (- |x#0@0| |y#0@0|)))) (and (=> (= (ControlFlow 0 16) (- 0 18)) ($Is intType (int_2_U (- |x#0@0| |y#0@0|)) Tclass._module.pos)) (=> ($Is intType (int_2_U (- |x#0@0| |y#0@0|)) Tclass._module.pos) (=> (= |y##0_0_0_0@0| (- |x#0@0| |y#0@0|)) (=> (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5)) (=> (and (and (|_module.__default.Gcd#canCall| |y#0@0| |y##0_0_0_0@0|) (|_module.__default.Gcd#canCall| |y##0_0_0_0@0| |y#0@0|)) (and (= (_module.__default.Gcd reveal__module._default.Gcd |y#0@0| |y##0_0_0_0@0|) (_module.__default.Gcd reveal__module._default.Gcd |y##0_0_0_0@0| |y#0@0|)) (= $Heap@0 $Heap@5))) (and (=> (= (ControlFlow 0 16) (- 0 17)) ($Is intType (int_2_U (- |x#0@0| |y#0@0|)) Tclass._module.pos)) (=> ($Is intType (int_2_U (- |x#0@0| |y#0@0|)) Tclass._module.pos) (=> (and (= |##x#0_0_0_1@0| (- |x#0@0| |y#0@0|)) ($IsAlloc intType (int_2_U |##x#0_0_0_1@0|) Tclass._module.pos $Heap@5)) (=> (and (and ($IsAlloc intType (int_2_U |y#0@0|) Tclass._module.pos $Heap@5) (|_module.__default.Gcd#canCall| (- |x#0@0| |y#0@0|) |y#0@0|)) (and (|_module.__default.Gcd#canCall| (- |x#0@0| |y#0@0|) |y#0@0|) (= (ControlFlow 0 16) (- 0 15)))) (= (_module.__default.Gcd reveal__module._default.Gcd |y#0@0| (- |x#0@0| |y#0@0|)) (_module.__default.Gcd reveal__module._default.Gcd (- |x#0@0| |y#0@0|) |y#0@0|)))))))))))))))
(let ((anon23_Then_correct  (=> (and (and ($IsAlloc intType (int_2_U |y#0@0|) Tclass._module.pos $Heap@0) ($IsAlloc intType (int_2_U |x#0@0|) Tclass._module.pos $Heap@0)) (and (|_module.__default.Gcd#canCall| |y#0@0| |x#0@0|) (|_module.__default.Gcd#canCall| |y#0@0| |x#0@0|))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (< |y#0@0| |x#0@0|)) (=> (< |y#0@0| |x#0@0|) (=> (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (=> (and (and (and (|_module.__default.Gcd#canCall| |y#0@0| |x#0@0|) (|_module.__default.Gcd#canCall| |y#0@0| (- |x#0@0| |y#0@0|))) (= (_module.__default.Gcd reveal__module._default.Gcd |y#0@0| |x#0@0|) (_module.__default.Gcd reveal__module._default.Gcd |y#0@0| (- |x#0@0| |y#0@0|)))) (and (= $Heap@0 $Heap@4) ($IsAlloc intType (int_2_U |y#0@0|) Tclass._module.pos $Heap@4))) (and (=> (= (ControlFlow 0 12) (- 0 13)) ($Is intType (int_2_U (- |x#0@0| |y#0@0|)) Tclass._module.pos)) (=> ($Is intType (int_2_U (- |x#0@0| |y#0@0|)) Tclass._module.pos) (=> (= |##y#0_0_1_1@0| (- |x#0@0| |y#0@0|)) (=> (and (and ($IsAlloc intType (int_2_U |##y#0_0_1_1@0|) Tclass._module.pos $Heap@4) (|_module.__default.Gcd#canCall| |y#0@0| (- |x#0@0| |y#0@0|))) (and (|_module.__default.Gcd#canCall| |y#0@0| (- |x#0@0| |y#0@0|)) (= (ControlFlow 0 12) (- 0 11)))) (= (_module.__default.Gcd reveal__module._default.Gcd |y#0@0| |x#0@0|) (_module.__default.Gcd reveal__module._default.Gcd |y#0@0| (- |x#0@0| |y#0@0|))))))))))))))
(let ((anon22_Then_correct  (=> (and ($IsAlloc intType (int_2_U |x#0@0|) Tclass._module.pos $Heap@0) ($IsAlloc intType (int_2_U |y#0@0|) Tclass._module.pos $Heap@0)) (=> (and (and (|_module.__default.Gcd#canCall| |x#0@0| |y#0@0|) (|_module.__default.Gcd#canCall| |x#0@0| |y#0@0|)) (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3))) (=> (and (and (and (and (|_module.__default.Gcd#canCall| |x#0@0| |y#0@0|) (|_module.__default.Gcd#canCall| |y#0@0| |x#0@0|)) (= (_module.__default.Gcd reveal__module._default.Gcd |x#0@0| |y#0@0|) (_module.__default.Gcd reveal__module._default.Gcd |y#0@0| |x#0@0|))) (and (= $Heap@0 $Heap@3) ($IsAlloc intType (int_2_U |y#0@0|) Tclass._module.pos $Heap@3))) (and (and ($IsAlloc intType (int_2_U |x#0@0|) Tclass._module.pos $Heap@3) (|_module.__default.Gcd#canCall| |y#0@0| |x#0@0|)) (and (|_module.__default.Gcd#canCall| |y#0@0| |x#0@0|) (= (ControlFlow 0 10) (- 0 9))))) (= (_module.__default.Gcd reveal__module._default.Gcd |x#0@0| |y#0@0|) (_module.__default.Gcd reveal__module._default.Gcd |y#0@0| |x#0@0|)))))))
(let ((anon21_Then_correct true))
(let ((anon20_Then_correct  (=> (< |y#0@0| |x#0@0|) (and (and (and (and (=> (= (ControlFlow 0 28) 8) anon21_Then_correct) (=> (= (ControlFlow 0 28) 10) anon22_Then_correct)) (=> (= (ControlFlow 0 28) 12) anon23_Then_correct)) (=> (= (ControlFlow 0 28) 16) anon24_Then_correct)) (=> (= (ControlFlow 0 28) 26) anon24_Else_correct)))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (= |gcd#0@0| (_module.__default.Gcd reveal__module._default.Gcd |X#0| |Y#0|)))))
(let ((anon15_correct  (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (|_module.__default.Gcd#canCall| |x#0@0| |x#0@0|)) (and (and (= (_module.__default.Gcd reveal__module._default.Gcd |x#0@0| |x#0@0|) |x#0@0|) (= $Heap@0 $Heap@2)) (and (= |gcd#0@0| |x#0@0|) (= (ControlFlow 0 5) 4)))) GeneratedUnifiedExit_correct)))
(let ((anon20_Else_correct  (=> (and (and (<= |y#0@0| |x#0@0|) (<= |x#0@0| |y#0@0|)) (= (ControlFlow 0 7) 5)) anon15_correct)))
(let ((anon18_Else_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) (= |$decr$loop#00@1| (+ |x#0@0| |y#0@0|))) (and (and (=> (= (ControlFlow 0 29) 23) anon19_Then_correct) (=> (= (ControlFlow 0 29) 28) anon20_Then_correct)) (=> (= (ControlFlow 0 29) 7) anon20_Else_correct)))))
(let ((anon18_Then_correct  (=> (and (not (U_2_bool (Lit boolType (bool_2_U true)))) (= (ControlFlow 0 6) 5)) anon15_correct)))
(let ((anon17_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 30) 6) anon18_Then_correct) (=> (= (ControlFlow 0 30) 29) anon18_Else_correct)))))
(let ((anon17_Then_correct true))
(let ((anon16_LoopBody_correct  (and (=> (= (ControlFlow 0 31) 2) anon17_Then_correct) (=> (= (ControlFlow 0 31) 30) anon17_Else_correct))))
(let ((anon16_LoopDone_correct true))
(let ((anon16_LoopHead_correct  (=> (<= (LitInt 1) |x#0@0|) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (<= (LitInt 1) |y#0@0|) (not false)) (and (=> |$w$loop#0@0| (and (|_module.__default.Gcd#canCall| |x#0@0| |y#0@0|) (|_module.__default.Gcd#canCall| |X#0| |Y#0|))) (=> |$w$loop#0@0| (= (_module.__default.Gcd reveal__module._default.Gcd |x#0@0| |y#0@0|) (_module.__default.Gcd reveal__module._default.Gcd |X#0| |Y#0|))))) (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@0)))
 :qid |gcddfy.192:3|
 :skolemid |652|
...
)) (<= (+ |x#0@0| |y#0@0|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 32) 1) anon16_LoopDone_correct) (=> (= (ControlFlow 0 32) 31) anon16_LoopBody_correct)))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (= |$decr_init$loop#00@0| (+ |X#0| |Y#0|))) (and (=> (= (ControlFlow 0 33) (- 0 34)) (=> |$w$loop#0@0| (= (_module.__default.Gcd reveal__module._default.Gcd |X#0| |Y#0|) (_module.__default.Gcd reveal__module._default.Gcd |X#0| |Y#0|)))) (=> (=> |$w$loop#0@0| (= (_module.__default.Gcd reveal__module._default.Gcd |X#0| |Y#0|) (_module.__default.Gcd reveal__module._default.Gcd |X#0| |Y#0|))) (=> (= (ControlFlow 0 33) 32) anon16_LoopHead_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (<= (LitInt 1) |X#0|)) (=> (and (and (and (<= (LitInt 1) |Y#0|) (<= (LitInt 1) |gcd#0|)) (and (<= (LitInt 1) |x#0@@10|) true)) (and (and (<= (LitInt 1) |y#0@@3|) true) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 35) 33)))) anon0_correct))))
