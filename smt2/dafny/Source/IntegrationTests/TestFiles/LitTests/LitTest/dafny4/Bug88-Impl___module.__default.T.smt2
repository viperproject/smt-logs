...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let (($generated@@89  (=> (= (ControlFlow 0 3) (- 0 2)) (= $generated@@80 $generated@@81))))
(let (($generated@@90 true))
(let (($generated@@91  (=> (= $generated@@82 ($generated@@24 $generated@@83 $generated@@84 $generated@@85 false)) (and (=> (= (ControlFlow 0 4) 1) $generated@@90) (=> (= (ControlFlow 0 4) 3) $generated@@89)))))
(let (($generated@@92  (=> (and (and ($generated@@86 $generated@@84) ($generated@@87 $generated@@84)) (and (= 0 $generated@@88) (= (ControlFlow 0 5) 4))) $generated@@91)))
$generated@@92)))))
))
(check-sat)
