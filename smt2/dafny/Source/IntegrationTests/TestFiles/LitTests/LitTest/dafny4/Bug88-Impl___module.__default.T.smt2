...
(set-info :boogie-vc-id Impl$$_module.__default.T)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon2_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (= |a#0| |b#0|))))
(let ((anon2_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 4) 1) anon2_Then_correct) (=> (= (ControlFlow 0 4) 3) anon2_Else_correct)))))
