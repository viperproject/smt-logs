...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |i#0|))))) (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= |i#0| |r#0|)) (not true))))))
(let ((anon3_Else_correct  (=> (and (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |i#0|))) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and (not (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |i#0|)))) (= (ControlFlow 0 4) 2)) anon2_correct)))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |m#0| (TMap TInt TInt)) ($IsAlloc MapType |m#0| (TMap TInt TInt) $Heap)) (= 0 $FunctionContextHeight)) (and (or (not (= |i#0| |r#0|)) (not true)) (= (ControlFlow 0 7) 6))) anon0_correct))))
