...
(declare-fun _module.__default.G (T@U T@U T@U) Bool)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.__default.G#canCall| (T@U T@U T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module._default.G$X T@U) ($Heap T@U) (|f#0| T@U) ) (!  (=> (or (|_module.__default.G#canCall| _module._default.G$X $Heap |f#0|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) ($Is HandleTypeType |f#0| (Tclass._System.___hFunc1 _module._default.G$X TBool))) (forall ((|x#1| T@U) ) (!  (=> ($IsBox |x#1| _module._default.G$X) (and (Requires1 _module._default.G$X TBool $Heap |f#0| |x#1|) (U_2_bool ($Unbox boolType (Apply1 _module._default.G$X TBool $Heap |f#0| |x#1|)))))
 :qid |Bug54dfy.6:19|
 :skolemid |484|
 :pattern ( ($Unbox boolType (Apply1 _module._default.G$X TBool $Heap |f#0| |x#1|)))
 :pattern ( (Requires1 _module._default.G$X TBool $Heap |f#0| |x#1|))
))))) (= (_module.__default.G _module._default.G$X $Heap |f#0|) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |unknown.0:0|
 :skolemid |486|
 :pattern ( (_module.__default.G _module._default.G$X $Heap |f#0|) ($IsGoodHeap $Heap))
))))
...
(declare-fun _module._default.G$X@@0 () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon15_Else_correct true))
(let ((anon15_Then_correct true))
(let ((anon14_Else_correct  (=> (not (|Set#IsMember| (Reads1 _module._default.G$X@@0 TBool $Heap@@0 |f#0@@0| |_x0#2@0|) ($Box refType |_obj#2@0|))) (and (=> (= (ControlFlow 0 5) 1) anon15_Then_correct) (=> (= (ControlFlow 0 5) 2) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (|Set#IsMember| (Reads1 _module._default.G$X@@0 TBool $Heap@@0 |f#0@@0| |_x0#2@0|) ($Box refType |_obj#2@0|)) (and (=> (= (ControlFlow 0 4) 1) anon15_Then_correct) (=> (= (ControlFlow 0 4) 2) anon15_Else_correct)))))
(let ((anon13_Then_correct  (=> (and (and ($IsBox |_x0#2@0| _module._default.G$X@@0) ($IsAllocBox |_x0#2@0| _module._default.G$X@@0 $Heap@@0)) (and ($Is refType |_obj#2@0| Tclass._System.object?) ($IsAlloc refType |_obj#2@0| Tclass._System.object? $Heap@@0))) (and (=> (= (ControlFlow 0 6) (- 0 8)) true) (and (=> (= (ControlFlow 0 6) (- 0 7)) (Requires1 _module._default.G$X@@0 (TSet Tclass._System.object?) $Heap@@0 (|Reads1#Handle| _module._default.G$X@@0 TBool |f#0@@0|) |_x0#2@0|)) (=> (Requires1 _module._default.G$X@@0 (TSet Tclass._System.object?) $Heap@@0 (|Reads1#Handle| _module._default.G$X@@0 TBool |f#0@@0|) |_x0#2@0|) (and (=> (= (ControlFlow 0 6) 4) anon14_Then_correct) (=> (= (ControlFlow 0 6) 5) anon14_Else_correct))))))))
(let ((anon13_Else_correct  (=> (not (and (and ($IsBox |_x0#2@0| _module._default.G$X@@0) ($IsAllocBox |_x0#2@0| _module._default.G$X@@0 $Heap@@0)) (and ($Is refType |_obj#2@0| Tclass._System.object?) ($IsAlloc refType |_obj#2@0| Tclass._System.object? $Heap@@0)))) (and (=> (= (ControlFlow 0 3) 1) anon15_Then_correct) (=> (= (ControlFlow 0 3) 2) anon15_Else_correct)))))
(let ((anon4_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) |b$reqreads#2@1|) (=> |b$reqreads#2@1| (and (=> (= (ControlFlow 0 9) 6) anon13_Then_correct) (=> (= (ControlFlow 0 9) 3) anon13_Else_correct))))))
(let ((anon12_Else_correct  (=> (not (|Set#IsMember| (Reads1 _module._default.G$X@@0 TBool $Heap@@0 |f#0@@0| |_x0#1@0|) ($Box refType |_obj#1@0|))) (=> (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= (ControlFlow 0 13) 9)) anon4_correct))))
(let ((anon12_Then_correct  (=> (|Set#IsMember| (Reads1 _module._default.G$X@@0 TBool $Heap@@0 |f#0@@0| |_x0#1@0|) ($Box refType |_obj#1@0|)) (=> (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= (ControlFlow 0 12) 9)) anon4_correct))))
(let ((anon11_Then_correct  (=> (and (and ($IsBox |_x0#1@0| _module._default.G$X@@0) ($IsAllocBox |_x0#1@0| _module._default.G$X@@0 $Heap@@0)) (and ($Is refType |_obj#1@0| Tclass._System.object?) ($IsAlloc refType |_obj#1@0| Tclass._System.object? $Heap@@0))) (and (=> (= (ControlFlow 0 14) (- 0 16)) true) (and (=> (= (ControlFlow 0 14) (- 0 15)) (Requires1 _module._default.G$X@@0 (TSet Tclass._System.object?) $Heap@@0 (|Reads1#Handle| _module._default.G$X@@0 TBool |f#0@@0|) |_x0#1@0|)) (=> (Requires1 _module._default.G$X@@0 (TSet Tclass._System.object?) $Heap@@0 (|Reads1#Handle| _module._default.G$X@@0 TBool |f#0@@0|) |_x0#1@0|) (=> (= |b$reqreads#2@0| (forall (($o@@2 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@2) alloc)))) (|Set#IsMember| (Reads1 _module._default.G$X@@0 (TSet Tclass._System.object?) $Heap@@0 (|Reads1#Handle| _module._default.G$X@@0 TBool |f#0@@0|) |_x0#1@0|) ($Box refType $o@@2))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@2 $f@@0)))
 :qid |Bug54dfy.5:11|
 :skolemid |495|
))) (and (=> (= (ControlFlow 0 14) 12) anon12_Then_correct) (=> (= (ControlFlow 0 14) 13) anon12_Else_correct)))))))))
(let ((anon11_Else_correct  (=> (not (and (and ($IsBox |_x0#1@0| _module._default.G$X@@0) ($IsAllocBox |_x0#1@0| _module._default.G$X@@0 $Heap@@0)) (and ($Is refType |_obj#1@0| Tclass._System.object?) ($IsAlloc refType |_obj#1@0| Tclass._System.object? $Heap@@0)))) (=> (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 11) 9)) anon4_correct))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@0 alloc _module._default.G$X@@0 Tclass._System.object? _module._default.G$X@@0 TBool $Heap@@0 |f#0@@0| _module._default.G$X@@0 TBool $Heap@@0 |f#0@@0|)) (=> (and ($IsBox |x#2@0| _module._default.G$X@@0) ($IsAllocBox |x#2@0| _module._default.G$X@@0 $Heap@@0)) (=> (and (and ($IsAllocBox ($Box HandleTypeType |f#0@@0|) (Tclass._System.___hFunc1 _module._default.G$X@@0 TBool) $Heap@@0) ($IsAllocBox |x#2@0| _module._default.G$X@@0 $Heap@@0)) (and (= |b$reqreads#0@0| (forall (($o@@3 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@3 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@3) alloc)))) (|Set#IsMember| (Reads1 _module._default.G$X@@0 TBool $Heap@@0 |f#0@@0| |x#2@0|) ($Box refType $o@@3))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@3 $f@@1)))
 :qid |Bug54dfy.6:26|
 :skolemid |488|
))) (Requires1 _module._default.G$X@@0 TBool $Heap@@0 |f#0@@0| |x#2@0|))) (and (=> (= (ControlFlow 0 17) (- 0 20)) (Requires1 _module._default.G$X@@0 TBool $Heap@@0 |f#0@@0| |x#2@0|)) (=> (Requires1 _module._default.G$X@@0 TBool $Heap@@0 |f#0@@0| |x#2@0|) (=> (= |b$reqreads#1@0| (forall (($o@@4 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@4) alloc)))) (|Set#IsMember| (Reads1 _module._default.G$X@@0 TBool $Heap@@0 |f#0@@0| |x#2@0|) ($Box refType $o@@4))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@4 $f@@2)))
 :qid |Bug54dfy.6:41|
 :skolemid |489|
))) (=> (and (U_2_bool ($Unbox boolType (Apply1 _module._default.G$X@@0 TBool $Heap@@0 |f#0@@0| |x#2@0|))) (forall ((|x#0| T@U) ) (!  (=> ($IsBox |x#0| _module._default.G$X@@0) (and (Requires1 _module._default.G$X@@0 TBool $Heap@@0 |f#0@@0| |x#0|) (U_2_bool ($Unbox boolType (Apply1 _module._default.G$X@@0 TBool $Heap@@0 |f#0@@0| |x#0|)))))
 :qid |Bug54dfy.6:19|
 :skolemid |490|
 :pattern ( ($Unbox boolType (Apply1 _module._default.G$X@@0 TBool $Heap@@0 |f#0@@0| |x#0|)))
 :pattern ( (Requires1 _module._default.G$X@@0 TBool $Heap@@0 |f#0@@0| |x#0|))
))) (and (=> (= (ControlFlow 0 17) (- 0 19)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 17) (- 0 18)) |b$reqreads#1@0|) (=> |b$reqreads#1@0| (and (=> (= (ControlFlow 0 17) 14) anon11_Then_correct) (=> (= (ControlFlow 0 17) 11) anon11_Else_correct)))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($AlwaysAllocated _module._default.G$X@@0) ($Is HandleTypeType |f#0@@0| (Tclass._System.___hFunc1 _module._default.G$X@@0 TBool))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 21) 17))) anon0_correct))))
