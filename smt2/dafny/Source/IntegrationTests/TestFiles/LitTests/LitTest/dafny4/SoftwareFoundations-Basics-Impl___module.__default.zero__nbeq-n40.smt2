...
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.zero__nbeq__plus__1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.Nat| |n#0@@7|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (forall ((|$ih#n0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#n0#0| Tclass._module.Nat) (U_2_bool (Lit boolType (bool_2_U true)))) (< (DtRank |$ih#n0#0|) (DtRank |n#0@@7|))) (|_module.Bool#Equal| (_module.__default.beq__nat ($LS $LZ) (Lit DatatypeTypeType |#_module.Nat.O|) (_module.__default.plus ($LS $LZ) |$ih#n0#0| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType |#_module.Nat.O|))))) |#_module.Bool.False|))
 :qid |SoftwareFoundationsBasicsdfy.408:25|
 :skolemid |750|
 :pattern ( (_module.__default.plus ($LS $LZ) |$ih#n0#0| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType |#_module.Nat.O|)))))
)) (= (ControlFlow 0 2) (- 0 1)))) (|_module.Bool#Equal| (_module.__default.beq__nat ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Nat.O|) (_module.__default.plus ($LS ($LS $LZ)) |n#0@@7| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType |#_module.Nat.O|))))) |#_module.Bool.False|)))))
