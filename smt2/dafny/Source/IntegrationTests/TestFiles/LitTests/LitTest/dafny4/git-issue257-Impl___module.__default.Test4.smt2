...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |c#0@@3| null)) (not true))) (=> ($IsAllocBox ($Box refType |c#0@@3|) Tclass.M.C? $Heap) (=> (and (|M.C.f#canCall| |c#0@@3|) (|M.C.f#canCall| |c#0@@3|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (M.C.f |c#0@@3|) (LitInt 0))) (=> (= (M.C.f |c#0@@3|) (LitInt 0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |g#0| null)) (not true))) (=> (and (and ($IsAllocBox ($Box refType |g#0|) Tclass.M.T? $Heap) (|M.T.f#canCall| |g#0|)) (and (|M.T.f#canCall| |g#0|) (= (ControlFlow 0 2) (- 0 1)))) (= (M.T.f |g#0|) (LitInt 0))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |c#0@@3| Tclass.M.C) ($IsAlloc refType |c#0@@3| Tclass.M.C $Heap))) (=> (and (and (and ($Is refType |g#0| Tclass.M.T) ($IsAlloc refType |g#0| Tclass.M.T $Heap)) (= 1 $FunctionContextHeight)) (and (= |c#0@@3| |g#0|) (= (ControlFlow 0 6) 2))) anon0_correct))))
