...
(set-info :boogie-vc-id Impl$$_module.__default.Try)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon6_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (= |a#0| |a#0|))))
(let ((anon6_Then_correct true))
(let ((anon5_Then_correct  (and (=> (= (ControlFlow 0 5) 2) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct))))
