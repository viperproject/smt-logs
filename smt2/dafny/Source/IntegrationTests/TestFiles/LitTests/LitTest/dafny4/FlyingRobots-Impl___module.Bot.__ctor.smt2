...
(assert (forall (($h0@@0 T@U) ($h1@@0 T@U) (this@@2 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (and (or (not (= this@@2 null)) (not true)) ($Is refType this@@2 Tclass._module.Point))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@35 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@35 null)) (not true)) (or (= $o@@35 this@@2) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 this@@2) _module.Point.Repr)) ($Box refType $o@@35)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@35) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@0 $o@@35) $f@@0)))
 :qid |unknown.0:0|
 :skolemid |720|
...
(declare-fun |polar_in##0@0| () Int)
(declare-fun |azim_in##0@0| () Int)
(declare-fun call3formal@this () T@U)
(declare-fun $Heap@1 () T@U)
(declare-fun call3formal@this@0 () T@U)
(declare-fun |polar_in##1@0| () Int)
(declare-fun |azim_in##1@0| () Int)
(declare-fun call3formal@this@@0 () T@U)
...
(declare-fun $Heap@5 () T@U)
(set-info :boogie-vc-id Impl$$_module.Bot.__ctor)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#14| null $Heap@@5 alloc false)) (= |a##0@0| (LitInt 0))) (and (= |b##0@0| (LitInt 0)) (= |c##0@0| (LitInt 0)))) (and (and (or (not (= call4formal@this null)) (not true)) (and ($Is refType call4formal@this Tclass._module.Point) ($IsAlloc refType call4formal@this Tclass._module.Point $Heap@@5))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (=> (and (and (and (and (and (and (or (not (= call4formal@this@0 null)) (not true)) (and ($Is refType call4formal@this@0 Tclass._module.Point) ($IsAlloc refType call4formal@this@0 Tclass._module.Point $Heap@0))) (|_module.Point.Valid#canCall| $Heap@0 call4formal@this@0)) (and (|_module.Point.Valid#canCall| $Heap@0 call4formal@this@0) (and (_module.Point.Valid $Heap@0 call4formal@this@0) (and (and (and (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call4formal@this@0) _module.Point.Repr)) ($Box refType call4formal@this@0)) (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call4formal@this@0) _module.Point.x)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call4formal@this@0) _module.Point.y)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call4formal@this@0) _module.Point.z)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call4formal@this@0) _module.Point.Repr)))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call4formal@this@0) _module.Point.x)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call4formal@this@0) _module.Point.y)))) (not true))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call4formal@this@0) _module.Point.y)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call4formal@this@0) _module.Point.z)))) (not true))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call4formal@this@0) _module.Point.z)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call4formal@this@0) _module.Point.x)))) (not true))) (|_System.Tuple3#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call4formal@this@0) _module.Point.Value)) (|#_System._tuple#3._#Make3| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call4formal@this@0) _module.Point.x))) _module.Cell.val) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call4formal@this@0) _module.Point.y))) _module.Cell.val) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call4formal@this@0) _module.Point.z))) _module.Cell.val))))))) (and (and (and (forall (($o@@41 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call4formal@this@0) _module.Point.Repr)) ($Box refType $o@@41)) (or (not (= $o@@41 null)) (not true)))
 :qid |FlyingRobotsdfy.32:24|
 :skolemid |735|
 :pattern (  (or (not (= $o@@41 null)) (not true)))
)) (forall (($o@@42 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call4formal@this@0) _module.Point.Repr)) ($Box refType $o@@42)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@42) alloc)))))
 :qid |FlyingRobotsdfy.32:24|
 :skolemid |736|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call4formal@this@0) _module.Point.Repr)) ($Box refType $o@@42)))
))) (|$IsA#_System.Tuple3| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call4formal@this@0) _module.Point.Value)))) (and (|_System.Tuple3#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call4formal@this@0) _module.Point.Value)) (|#_System._tuple#3._#Make3| ($Box intType (int_2_U |a##0@0|)) ($Box intType (int_2_U |b##0@0|)) ($Box intType (int_2_U |c##0@0|)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 call4formal@this@0) alloc))))))) (and (and (and (and (forall (($o@@43 T@U) ) (!  (=> (and (or (not (= $o@@43 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@43) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@43) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@43)))
 :qid |FlyingRobotsdfy.31:3|
 :skolemid |737|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@43))
)) ($HeapSucc $Heap@@5 $Heap@0)) (and (= |polar_in##0@0| (LitInt 0)) (= |azim_in##0@0| (LitInt 0)))) (and (and (or (not (= call3formal@this null)) (not true)) (and ($Is refType call3formal@this Tclass._module.Arm) ($IsAlloc refType call3formal@this Tclass._module.Arm $Heap@@5))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)))) (and (and (and (or (not (= call3formal@this@0 null)) (not true)) (and ($Is refType call3formal@this@0 Tclass._module.Arm) ($IsAlloc refType call3formal@this@0 Tclass._module.Arm $Heap@1))) (|_module.Arm.Valid#canCall| $Heap@1 call3formal@this@0)) (and (|_module.Arm.Valid#canCall| $Heap@1 call3formal@this@0) (and (_module.Arm.Valid $Heap@1 call3formal@this@0) (and (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call3formal@this@0) _module.Arm.Repr)) ($Box refType call3formal@this@0)) (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call3formal@this@0) _module.Arm.polar)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call3formal@this@0) _module.Arm.azim)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call3formal@this@0) _module.Arm.Repr)))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call3formal@this@0) _module.Arm.polar)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call3formal@this@0) _module.Arm.azim)))) (not true))) (|_System.Tuple2#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call3formal@this@0) _module.Arm.Value)) (|#_System._tuple#2._#Make2| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call3formal@this@0) _module.Arm.polar))) _module.Cell.val) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call3formal@this@0) _module.Arm.azim))) _module.Cell.val))))))))) (and (and (and (and (and (forall (($o@@44 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call3formal@this@0) _module.Arm.Repr)) ($Box refType $o@@44)) (or (not (= $o@@44 null)) (not true)))
 :qid |FlyingRobotsdfy.71:24|
 :skolemid |775|
 ...
 :qid |FlyingRobotsdfy.71:24|
 :skolemid |776|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call3formal@this@0) _module.Arm.Repr)) ($Box refType $o@@45)))
))) (|$IsA#_System.Tuple2| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call3formal@this@0) _module.Arm.Value)))) (and (|_System.Tuple2#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call3formal@this@0) _module.Arm.Value)) (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |polar_in##0@0|)) ($Box intType (int_2_U |azim_in##0@0|)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call3formal@this@0) alloc)))))) (and (and (and (forall (($o@@46 T@U) ) (!  (=> (and (or (not (= $o@@46 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@46) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@46) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@46)))
 :qid |FlyingRobotsdfy.70:3|
 :skolemid |777|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@46))
)) ($HeapSucc $Heap@0 $Heap@1)) (and (= |polar_in##1@0| (LitInt 0)) (= |azim_in##1@0| (LitInt 0)))) (and (and (or (not (= call3formal@this@@0 null)) (not true)) (and ($Is refType call3formal@this@@0 Tclass._module.Arm) ($IsAlloc refType call3formal@this@@0 Tclass._module.Arm $Heap@@5))) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2))))) (and (and (and (and (or (not (= call3formal@this@0@@0 null)) (not true)) (and ($Is refType call3formal@this@0@@0 Tclass._module.Arm) ($IsAlloc refType call3formal@this@0@@0 Tclass._module.Arm $Heap@2))) (|_module.Arm.Valid#canCall| $Heap@2 call3formal@this@0@@0)) (and (|_module.Arm.Valid#canCall| $Heap@2 call3formal@this@0@@0) (and (_module.Arm.Valid $Heap@2 call3formal@this@0@@0) (and (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call3formal@this@0@@0) _module.Arm.Repr)) ($Box refType call3formal@this@0@@0)) (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call3formal@this@0@@0) _module.Arm.polar)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call3formal@this@0@@0) _module.Arm.azim)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call3formal@this@0@@0) _module.Arm.Repr)))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call3formal@this@0@@0) _module.Arm.polar)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call3formal@this@0@@0) _module.Arm.azim)))) (not true))) (|_System.Tuple2#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call3formal@this@0@@0) _module.Arm.Value)) (|#_System._tuple#2._#Make2| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call3formal@this@0@@0) _module.Arm.polar))) _module.Cell.val) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call3formal@this@0@@0) _module.Arm.azim))) _module.Cell.val))))))) (and (and (and (forall (($o@@47 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call3formal@this@0@@0) _module.Arm.Repr)) ($Box refType $o@@47)) (or (not (= $o@@47 null)) (not true)))
 :qid |FlyingRobotsdfy.71:24|
 :skolemid |775|
 :pattern (  (or (not (= $o@@47 null)) (not true)))
)) (forall (($o@@48 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call3formal@this@0@@0) _module.Arm.Repr)) ($Box refType $o@@48)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@48) alloc)))))
 :qid |FlyingRobotsdfy.71:24|
 :skolemid |776|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call3formal@this@0@@0) _module.Arm.Repr)) ($Box refType $o@@48)))
))) (|$IsA#_System.Tuple2| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call3formal@this@0@@0) _module.Arm.Value)))) (and (and (|_System.Tuple2#Equal| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call3formal@this@0@@0) _module.Arm.Value)) (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |polar_in##1@0|)) ($Box intType (int_2_U |azim_in##1@0|)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call3formal@this@0@@0) alloc))))) (and (forall (($o@@49 T@U) ) (!  (=> (and (or (not (= $o@@49 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@49) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@49) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@49)))
 :qid |FlyingRobotsdfy.70:3|
 :skolemid |777|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@49))
)) ($HeapSucc $Heap@1 $Heap@2))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) true) (and (=> (= (ControlFlow 0 2) (- 0 9)) true) (and (=> (= (ControlFlow 0 2) (- 0 8)) true) (=> (and (or (not (= this@@8 null)) (not true)) ($Is refType this@@8 Tclass._module.Bot?)) (=> (and (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) alloc)))) (= ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Bot.Repr)) this.Repr)) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Bot.pos)) call4formal@this@0) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Bot.left)) call3formal@this@0))) (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Bot.right)) call3formal@this@0@@0) (= $Heap@3 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@2 this@@8 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@8 _module.Bot.Repr))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@8 _module.Bot.Repr)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@8) _module.Bot.pos)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@8) _module.Bot.pos)) null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@8) _module.Bot.left)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@8) _module.Bot.left)) null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@8) _module.Bot.right)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@8) _module.Bot.right)) null)) (not true)) (=> (= |$rhs#0@0| (|Set#Union| (|Set#Union| (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box refType this@@8)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@8) _module.Bot.pos))) _module.Point.Repr))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@8) _module.Bot.left))) _module.Arm.Repr))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@8) _module.Bot.right))) _module.Arm.Repr)))) (=> (and (= $Heap@4 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@3 this@@8 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@8) _module.Bot.Repr ($Box SetType |$rhs#0@0|)))) ($IsGoodHeap $Heap@4)) (=> (and (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5)) (and (= $Heap@4 $Heap@5) reveal__module.Bot.Valid)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@5 this@@8)) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@5 this@@8) (=> (= (ControlFlow 0 2) (- 0 1)) (and (forall (($o@@50 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@8) _module.Bot.Repr)) ($Box refType $o@@50)) (or (not (= $o@@50 null)) (not true)))
 :qid |FlyingRobotsdfy.110:24|
 :skolemid |818|
 :pattern (  (or (not (= $o@@50 null)) (not true)))
)) (forall (($o@@51 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@8) _module.Bot.Repr)) ($Box refType $o@@51)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@51) alloc)))))
 :qid |FlyingRobotsdfy.110:24|
 :skolemid |819|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@8) _module.Bot.Repr)) ($Box refType $o@@51)))
))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@5) ($IsHeapAnchor $Heap@@5)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 11) 2))) anon0_correct)))
