...
(declare-fun |globals#0@@1| () T@U)
(declare-fun |g#2@0| () T@U)
(declare-fun $Heap () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$_module.__default.ValidGlobalStateOpaque)
...
(let ((anon10_Else_correct  (=> (and (not (|Set#IsMember| (|Map#Domain| |globals#0@@1|) ($Box SeqType |g#2@0|))) (= (ControlFlow 0 6) 2)) anon6_correct)))
(let ((anon10_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |globals#0@@1|) ($Box SeqType |g#2@0|)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (|Set#IsMember| (|Map#Domain| |globals#0@@1|) ($Box SeqType |g#2@0|))) (=> (|Set#IsMember| (|Map#Domain| |globals#0@@1|) ($Box SeqType |g#2@0|)) (=> (= (ControlFlow 0 4) 2) anon6_correct))))))
(let ((anon9_Then_correct  (=> (and (and ($Is SeqType |g#2@0| (TSeq TChar)) ($IsAlloc SeqType |g#2@0| (TSeq TChar) $Heap)) (and ($IsAlloc SeqType |g#2@0| (TSeq TChar) $Heap) (|_module.__default.ValidGlobal#canCall| |g#2@0|))) (and (=> (= (ControlFlow 0 7) 4) anon10_Then_correct) (=> (= (ControlFlow 0 7) 6) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (not (and ($Is SeqType |g#2@0| (TSeq TChar)) ($IsAlloc SeqType |g#2@0| (TSeq TChar) $Heap))) (= (ControlFlow 0 3) 2)) anon6_correct)))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 8) 1) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Then_correct)) (=> (= (ControlFlow 0 8) 3) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is MapType |globals#0@@1| (TMap (TSeq TChar) (TSeq TInt)))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct)))
