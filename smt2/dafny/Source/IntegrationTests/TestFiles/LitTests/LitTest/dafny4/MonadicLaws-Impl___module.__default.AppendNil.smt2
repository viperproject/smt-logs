...
(|#_module.List.Cons| |x#0| (_module.__default.append _module._default.append$_T0@@0 $ly@@0 |xs'#0| |ys#0@@0|))))))))
 :qid |unknown.0:0|
 :skolemid |536|
...
(declare-fun _module._default.AppendNil$_T0 () T@U)
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.AppendNil)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (|$IsA#_module.List| |xs#0@@4|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@0 $Heap@0)) (and (forall ((|$ih#xs0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#xs0#0| (Tclass._module.List _module._default.AppendNil$_T0)) (U_2_bool (Lit boolType (bool_2_U true)))) (< (DtRank |$ih#xs0#0|) (DtRank |xs#0@@4|))) (|_module.List#Equal| (_module.__default.append _module._default.AppendNil$_T0 ($LS $LZ) |$ih#xs0#0| (Lit DatatypeTypeType |#_module.List.Nil|)) |$ih#xs0#0|))
 :qid |MonadicLawsdfy.17:17|
 :skolemid |539|
 :pattern ( (_module.__default.append _module._default.AppendNil$_T0 ($LS $LZ) |$ih#xs0#0| (Lit DatatypeTypeType |#_module.List.Nil|)))
)) (= (ControlFlow 0 2) (- 0 1)))) (|_module.List#Equal| (_module.__default.append _module._default.AppendNil$_T0 ($LS ($LS $LZ)) |xs#0@@4| (Lit DatatypeTypeType |#_module.List.Nil|)) |xs#0@@4|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and ($Is DatatypeTypeType |xs#0@@4| (Tclass._module.List _module._default.AppendNil$_T0)) ($IsAlloc DatatypeTypeType |xs#0@@4| (Tclass._module.List _module._default.AppendNil$_T0) $Heap@@0)) (|$IsA#_module.List| |xs#0@@4|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
