...
(declare-fun _module._default.lemma_ReverseConcatenateSeqs$T () T@U)
(declare-fun |##ss#1@0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.lemma__ReverseConcatenateSeqs)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (> (|Seq#Length| |ss#0@@4|) 0)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (= $Heap@@2 $Heap@0) ($IsAlloc SeqType |ss#0@@4| (TSeq (TSeq _module._default.lemma_ReverseConcatenateSeqs$T)) $Heap@0)) (and (|_module.__default.ConcatenateSeqs#canCall| _module._default.lemma_ReverseConcatenateSeqs$T |ss#0@@4|) ($IsAlloc SeqType |ss#0@@4| (TSeq (TSeq _module._default.lemma_ReverseConcatenateSeqs$T)) $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (> (|Seq#Length| |ss#0@@4|) 0)) (=> (> (|Seq#Length| |ss#0@@4|) 0) (=> (and (|_module.__default.all__but__last#canCall| (TSeq _module._default.lemma_ReverseConcatenateSeqs$T) |ss#0@@4|) (= |##ss#1@0| (_module.__default.all__but__last (TSeq _module._default.lemma_ReverseConcatenateSeqs$T) |ss#0@@4|))) (=> (and (and ($IsAlloc SeqType |##ss#1@0| (TSeq (TSeq _module._default.lemma_ReverseConcatenateSeqs$T)) $Heap@0) (|_module.__default.ConcatenateSeqs#canCall| _module._default.lemma_ReverseConcatenateSeqs$T (_module.__default.all__but__last (TSeq _module._default.lemma_ReverseConcatenateSeqs$T) |ss#0@@4|))) (and ($IsAlloc SeqType |ss#0@@4| (TSeq (TSeq _module._default.lemma_ReverseConcatenateSeqs$T)) $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (> (|Seq#Length| |ss#0@@4|) 0))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and ($Is SeqType |ss#0@@4| (TSeq (TSeq _module._default.lemma_ReverseConcatenateSeqs$T))) ($IsAlloc SeqType |ss#0@@4| (TSeq (TSeq _module._default.lemma_ReverseConcatenateSeqs$T)) $Heap@@2)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
