...
(assert (forall ((a T@U) (b T@U) ) (!  (=> (and (_module.aexp.N_q a) (_module.aexp.N_q b)) (= (|_module.aexp#Equal| a b) (= (_module.aexp.n a) (_module.aexp.n b))))
 :qid |unknown.0:0|
 :skolemid |762|
 :pattern ( (|_module.aexp#Equal| a b) (_module.aexp.N_q a))
 :pattern ( (|_module.aexp#Equal| a b) (_module.aexp.N_q b))
)))
...
(assert (forall ((a@@0 T@U) (b@@0 T@U) ) (! (= (|_module.aexp#Equal| a@@0 b@@0) (= a@@0 b@@0))
 :qid |unknown.0:0|
 :skolemid |765|
 :pattern ( (|_module.aexp#Equal| a@@0 b@@0))
)))
...
(assert (forall ((a@@1 T@U) (b@@1 T@U) ) (!  (=> (and (_module.aexp.V_q a@@1) (_module.aexp.V_q b@@1)) (= (|_module.aexp#Equal| a@@1 b@@1) (|Seq#Equal| (_module.aexp._h0 a@@1) (_module.aexp._h0 b@@1))))
 :qid |unknown.0:0|
 :skolemid |763|
 :pattern ( (|_module.aexp#Equal| a@@1 b@@1) (_module.aexp.V_q a@@1))
 :pattern ( (|_module.aexp#Equal| a@@1 b@@1) (_module.aexp.V_q b@@1))
)))
...
(assert (forall ((a@@3 T@U) (b@@3 T@U) ) (!  (=> (and (_module.aexp.Plus_q a@@3) (_module.aexp.Plus_q b@@3)) (= (|_module.aexp#Equal| a@@3 b@@3)  (and (|_module.aexp#Equal| (_module.aexp._h1 a@@3) (_module.aexp._h1 b@@3)) (|_module.aexp#Equal| (_module.aexp._h2 a@@3) (_module.aexp._h2 b@@3)))))
 :qid |unknown.0:0|
 :skolemid |764|
 :pattern ( (|_module.aexp#Equal| a@@3 b@@3) (_module.aexp.Plus_q a@@3))
 :pattern ( (|_module.aexp#Equal| a@@3 b@@3) (_module.aexp.Plus_q b@@3))
)))
...
(assert (forall ((d@@6 T@U) ($h T@U) ) (!  (=> (and ($IsGoodHeap $h) (and (_module.aexp.N_q d@@6) ($IsAlloc DatatypeTypeType d@@6 Tclass._module.aexp $h))) ($IsAlloc intType (int_2_U (_module.aexp.n d@@6)) TInt $h))
 :qid |unknown.0:0|
 :skolemid |734|
 :pattern ( ($IsAlloc intType (int_2_U (_module.aexp.n d@@6)) TInt $h))
)))
...
(assert (forall ((d@@8 T@U) ($h@@0 T@U) ) (!  (=> (and ($IsGoodHeap $h@@0) ($Is DatatypeTypeType d@@8 Tclass._module.aexp)) ($IsAlloc DatatypeTypeType d@@8 Tclass._module.aexp $h@@0))
 :qid |unknown.0:0|
 :skolemid |759|
 :pattern ( ($IsAlloc DatatypeTypeType d@@8 Tclass._module.aexp $h@@0))
)))
...
(assert (forall ((d@@9 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.aexp.V_q d@@9) ($IsAlloc DatatypeTypeType d@@9 Tclass._module.aexp $h@@1))) ($IsAlloc SeqType (_module.aexp._h0 d@@9) (TSeq TChar) $h@@1))
 :qid |unknown.0:0|
 :skolemid |742|
 :pattern ( ($IsAlloc SeqType (_module.aexp._h0 d@@9) (TSeq TChar) $h@@1))
)))
...
(assert (forall ((d@@10 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (_module.aexp.Plus_q d@@10) ($IsAlloc DatatypeTypeType d@@10 Tclass._module.aexp $h@@2))) ($IsAlloc DatatypeTypeType (_module.aexp._h1 d@@10) Tclass._module.aexp $h@@2))
 :qid |unknown.0:0|
 :skolemid |752|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.aexp._h1 d@@10) Tclass._module.aexp $h@@2))
)))
(assert (forall ((d@@11 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (_module.aexp.Plus_q d@@11) ($IsAlloc DatatypeTypeType d@@11 Tclass._module.aexp $h@@3))) ($IsAlloc DatatypeTypeType (_module.aexp._h2 d@@11) Tclass._module.aexp $h@@3))
 :qid |unknown.0:0|
 :skolemid |753|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.aexp._h2 d@@11) Tclass._module.aexp $h@@3))
)))
...
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.ASimplInvolutive)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.aexp| |a#0@@3|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (forall ((|$ih#a0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#a0#0| Tclass._module.aexp) (U_2_bool (Lit boolType (bool_2_U true)))) (< (DtRank |$ih#a0#0|) (DtRank |a#0@@3|))) (|_module.aexp#Equal| (_module.__default.asimp ($LS $LZ) (_module.__default.asimp ($LS $LZ) |$ih#a0#0|)) (_module.__default.asimp ($LS $LZ) |$ih#a0#0|)))
 :qid |NipkowKleinchapter3dfy.119:24|
 :skolemid |630|
 :pattern ( (_module.__default.asimp ($LS $LZ) (_module.__default.asimp ($LS $LZ) |$ih#a0#0|)))
)) (= (ControlFlow 0 2) (- 0 1)))) (|_module.aexp#Equal| (_module.__default.asimp ($LS ($LS $LZ)) (_module.__default.asimp ($LS ($LS $LZ)) |a#0@@3|)) (_module.__default.asimp ($LS ($LS $LZ)) |a#0@@3|))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |a#0@@3| Tclass._module.aexp) ($IsAlloc DatatypeTypeType |a#0@@3| Tclass._module.aexp $Heap)) (|$IsA#_module.aexp| |a#0@@3|)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
