...
(assert (distinct TBool TagBool TagSet TagMap alloc allocName Tagclass._System.object? Tagclass._System.object |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass.M0.Element? Tagclass.M0.Element class.M0.UnionFind? Tagclass.M0.UnionFind? Tagclass.M0.UnionFind tytagFamily$object |tytagFamily$_tuple#2| tytagFamily$Element tytagFamily$UnionFind field$M field$Repr)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((bx@@9 T@U) (s T@U) (t@@6 T@U) ) (!  (=> ($IsBox bx@@9 (TMap s t@@6)) (and (= ($Box MapType ($Unbox MapType bx@@9)) bx@@9) ($Is MapType ($Unbox MapType bx@@9) (TMap s t@@6))))
 :qid |DafnyPreludebpl.207:15|
 :skolemid |36|
 :pattern ( ($IsBox bx@@9 (TMap s t@@6)))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@1 T@U) ) (!  (=> (or (|M0.UnionFind.Valid#canCall| $Heap@@1 this@@1) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass.M0.UnionFind) ($IsAlloc refType this@@1 Tclass.M0.UnionFind $Heap@@1)))))) (=> (M0.UnionFind.Valid $Heap@@1 this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) M0.UnionFind.Repr)) ($Box refType this@@1))))
 :qid |UnionFinddfy.10:21|
 :skolemid |550|
 :pattern ( (M0.UnionFind.Valid $Heap@@1 this@@1))
))))
...
(set-info :boogie-vc-id CheckWellformed$$M0.UnionFind.Valid)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (=> (M0.UnionFind.Valid $Heap@@2 this@@2) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) M0.UnionFind.Repr)) ($Box refType this@@2))))))
(let ((anon10_correct  (=> (= (M0.UnionFind.Valid $Heap@@2 this@@2)  (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) M0.UnionFind.Repr)) ($Box refType this@@2)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) M0.UnionFind.Repr)) ($Box refType null)))) (M0.UnionFind.ValidM1 $Heap@@2 this@@2))) (=> (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) M0.UnionFind.Repr)) ($Box refType this@@2)) (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) M0.UnionFind.Repr)) ($Box refType null))) (|M0.UnionFind.ValidM1#canCall| $Heap@@2 this@@2))) ($Is boolType (bool_2_U (M0.UnionFind.Valid $Heap@@2 this@@2)) TBool)) (and (=> (= (ControlFlow 0 7) (- 0 10)) |b$reqreads#1@0|) (=> |b$reqreads#1@0| (and (=> (= (ControlFlow 0 7) (- 0 9)) |b$reqreads#2@1|) (=> |b$reqreads#2@1| (and (=> (= (ControlFlow 0 7) (- 0 8)) |b$reqreads#3@1|) (=> |b$reqreads#3@1| (=> (= (ControlFlow 0 7) 6) GeneratedUnifiedExit_correct)))))))))))
(let ((anon15_Else_correct  (=> (not (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) M0.UnionFind.Repr)) ($Box refType this@@2)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) M0.UnionFind.Repr)) ($Box refType null))))) (=> (and (= |b$reqreads#3@1| true) (= (ControlFlow 0 12) 7)) anon10_correct))))
(let ((anon15_Then_correct  (=> (and (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) M0.UnionFind.Repr)) ($Box refType this@@2)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) M0.UnionFind.Repr)) ($Box refType null)))) ($IsAllocBox ($Box refType this@@2) Tclass.M0.UnionFind? $Heap@@2)) (and (and (= |b$reqreads#3@0| (forall (($o@@10 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@10) alloc)))) (or (= $o@@10 this@@2) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) M0.UnionFind.Repr)) ($Box refType $o@@10)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@10 $f@@0)))
 :qid |UnionFinddfy.11:7|
 :skolemid |553|
))) (|M0.UnionFind.ValidM1#canCall| $Heap@@2 this@@2)) (and (= |b$reqreads#3@1| |b$reqreads#3@0|) (= (ControlFlow 0 11) 7)))) anon10_correct)))
(let ((anon14_Else_correct  (=> (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) M0.UnionFind.Repr)) ($Box refType this@@2))) (= |b$reqreads#2@1| true)) (and (=> (= (ControlFlow 0 14) 11) anon15_Then_correct) (=> (= (ControlFlow 0 14) 12) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) M0.UnionFind.Repr)) ($Box refType this@@2)) (=> (and (= |b$reqreads#2@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@2 M0.UnionFind.Repr))) (= |b$reqreads#2@1| |b$reqreads#2@0|)) (and (=> (= (ControlFlow 0 13) 11) anon15_Then_correct) (=> (= (ControlFlow 0 13) 12) anon15_Else_correct))))))
(let ((anon12_Else_correct  (=> (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@2 M0.UnionFind.Repr))) (and (=> (= (ControlFlow 0 15) 13) anon14_Then_correct) (=> (= (ControlFlow 0 15) 14) anon14_Else_correct)))))
(let ((anon5_correct true))
(let ((anon13_Else_correct  (=> (and (=> (M0.UnionFind.Valid $Heap@@2 this@@2) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) M0.UnionFind.Repr)) ($Box refType this@@2))) (= (ControlFlow 0 4) 1)) anon5_correct)))
(let ((anon13_Then_correct  (=> ($IsAllocBox ($Box refType this@@2) Tclass.M0.UnionFind? $Heap@@2) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (= this@@2 this@@2) (and (|Set#Subset| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) M0.UnionFind.Repr)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@2))) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) M0.UnionFind.Repr)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@2)))) (not (|Set#Subset| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) M0.UnionFind.Repr)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@2))) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) M0.UnionFind.Repr)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@2)))))))) (=> (or (= this@@2 this@@2) (and (|Set#Subset| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) M0.UnionFind.Repr)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@2))) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) M0.UnionFind.Repr)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@2)))) (not (|Set#Subset| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) M0.UnionFind.Repr)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@2))) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) M0.UnionFind.Repr)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@2))))))) (=> (and (and (or (= this@@2 this@@2) (|M0.UnionFind.Valid#canCall| $Heap@@2 this@@2)) (M0.UnionFind.Valid $Heap@@2 this@@2)) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) M0.UnionFind.Repr)) ($Box refType this@@2)) (= (ControlFlow 0 2) 1))) anon5_correct))))))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc this@@2 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) M0.UnionFind.Repr)))) (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@2 M0.UnionFind.Repr)))) (and (=> (= (ControlFlow 0 16) (- 0 17)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (and (=> (= (ControlFlow 0 16) 15) anon12_Else_correct) (=> (= (ControlFlow 0 16) 2) anon13_Then_correct)) (=> (= (ControlFlow 0 16) 4) anon13_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass.M0.UnionFind) ($IsAlloc refType this@@2 Tclass.M0.UnionFind $Heap@@2))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 18) 16))) anon0_correct))))
