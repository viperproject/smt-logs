// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/Bug107.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/Bug107-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/Bug107.dfy
...
axiom {:id "id2"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    _module.__default.Inc#canCall(x#0) || 0 < $FunctionContextHeight
       ==> _module.__default.Inc(x#0) == x#0 + 2);
...
axiom {:id "id3"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    _module.__default.Inc#canCall(LitInt(x#0)) || 0 < $FunctionContextHeight
       ==> _module.__default.Inc(LitInt(x#0)) == LitInt(x#0 + 2));
}
...
axiom (forall $bx: Box, $heap: Heap, $fh$0x#0: Box :: 
  { Set#IsMember(Reads1(TInt, TInt, $heap, _module.__default.Inc#Handle(), $fh$0x#0), $bx) } 
  Set#IsMember(Reads1(TInt, TInt, $heap, _module.__default.Inc#Handle(), $fh$0x#0), $bx)
     == false);
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Main (correctness)"} Impl$$_module.__default.Main() returns ($_reverifyPost: bool)
{
  ...
  var f#0: HandleType
    ...
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/Bug107.dfy(5,9)
    assume true;
    assert {:id "id0"} 0 != $FunctionContextHeight;
    assume true;
    f#0 := _module.__default.Inc#Handle();
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/Bug107.dfy(6,2)
    assume true;
}
...
procedure {:verboseName "Inc (well-formedness)"} CheckWellformed$$_module.__default.Inc(x#0: int);
