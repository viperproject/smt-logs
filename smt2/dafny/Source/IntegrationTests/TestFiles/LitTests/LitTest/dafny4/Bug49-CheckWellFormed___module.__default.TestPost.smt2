...
(declare-fun $Heap@@0 () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.TestPost)
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@0 $Heap@0)) (and (=> (= (ControlFlow 0 6) 5) anon6_Then_correct) (=> (= (ControlFlow 0 6) 2) anon6_Else_correct))))))
