...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.nb__occ)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon8_correct  (=> (and ($IsAlloc intType (int_2_U |z#0@@3|) TInt $Heap) ($IsAlloc DatatypeTypeType |l'#Z#0@0| (Tclass._module.List TInt) $Heap)) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (<= 0 |z#0@@3|) (= |z#0@@3| |z#0@@3|))) (=> (or (<= 0 |z#0@@3|) (= |z#0@@3| |z#0@@3|)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (< |z#0@@3| |z#0@@3|) (and (= |z#0@@3| |z#0@@3|) (< (DtRank |l'#Z#0@0|) (DtRank |l#0@@4|))))) (=> (or (< |z#0@@3| |z#0@@3|) (and (= |z#0@@3| |z#0@@3|) (< (DtRank |l'#Z#0@0|) (DtRank |l#0@@4|)))) (=> (and (|_module.__default.nb__occ#canCall| |z#0@@3| |l'#Z#0@0|) (= (ControlFlow 0 6) (- 0 5))) ($Is intType (int_2_U (+ (ite (= |z#0@@3| |z'#Z#0@0|) 1 0) (_module.__default.nb__occ ($LS $LZ) |z#0@@3| |l'#Z#0@0|))) Tclass._System.nat)))))))))
(let ((anon14_Else_correct  (=> (and (or (not (= |z#0@@3| |z'#Z#0@0|)) (not true)) (= (ControlFlow 0 10) 6)) anon8_correct)))
(let ((anon14_Then_correct  (=> (and (= |z#0@@3| |z'#Z#0@0|) (= (ControlFlow 0 9) 6)) anon8_correct)))
(let ((anon13_Then_correct  (=> (and (and (and (= |l#0@@4| (|#_module.List.Cons| ($Box intType (int_2_U |_mcc#0#0|)) |_mcc#1#0|)) ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List TInt))) (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List TInt)))) (and (and (= |l'#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|)) (and ($Is intType (int_2_U |let#1#0#0|) TInt) (= |z'#Z#0@0| |let#1#0#0|)))) (and (=> (= (ControlFlow 0 11) 9) anon14_Then_correct) (=> (= (ControlFlow 0 11) 10) anon14_Else_correct)))))
(let ((anon13_Else_correct true))
(let ((anon12_Else_correct  (=> (or (not (= |l#0@@4| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 12) 11) anon13_Then_correct) (=> (= (ControlFlow 0 12) 4) anon13_Else_correct)))))
(let ((anon12_Then_correct  (=> (and (= |l#0@@4| |#_module.List.Nil|) (= (ControlFlow 0 3) (- 0 2))) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |l#0@@4| (Tclass._module.List TInt))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct)))
