...
(declare-fun |a0#0@@3| () T@U)
(declare-fun |a1#0@@3| () T@U)
(declare-fun $Heap@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $LZ () T@U)
(declare-fun |s#0@@3| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.AvalPlus)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (=> (and (|$IsA#_module.aexp| |a0#0@@3|) (|$IsA#_module.aexp| |a1#0@@3|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@2 $Heap@0)) (and (forall ((|$ih#a00#0| T@U) (|$ih#a10#0| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |$ih#a00#0| Tclass._module.aexp) ($Is DatatypeTypeType |$ih#a10#0| Tclass._module.aexp)) (U_2_bool (Lit boolType (bool_2_U true)))) (or (< (DtRank |$ih#a00#0|) (DtRank |a0#0@@3|)) (and (= (DtRank |$ih#a00#0|) (DtRank |a0#0@@3|)) (< (DtRank |$ih#a10#0|) (DtRank |a1#0@@3|))))) (= (_module.__default.aval ($LS $LZ) (_module.__default.plus |$ih#a00#0| |$ih#a10#0|) |s#0@@3|) (+ (_module.__default.aval ($LS $LZ) |$ih#a00#0| |s#0@@3|) (_module.__default.aval ($LS $LZ) |$ih#a10#0| |s#0@@3|))))
 :qid |NipkowKleinchapter3dfy.97:16|
 :skolemid |617|
 :pattern ( (_module.__default.plus |$ih#a00#0| |$ih#a10#0|))
)) (= (ControlFlow 0 2) (- 0 1)))) (= (_module.__default.aval ($LS ($LS $LZ)) (_module.__default.plus |a0#0@@3| |a1#0@@3|) |s#0@@3|) (+ (_module.__default.aval ($LS ($LS $LZ)) |a0#0@@3| |s#0@@3|) (_module.__default.aval ($LS ($LS $LZ)) |a1#0@@3| |s#0@@3|))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and ($Is DatatypeTypeType |a0#0@@3| Tclass._module.aexp) ($IsAlloc DatatypeTypeType |a0#0@@3| Tclass._module.aexp $Heap@@2)) (|$IsA#_module.aexp| |a0#0@@3|)) (=> (and (and (and ($Is DatatypeTypeType |a1#0@@3| Tclass._module.aexp) ($IsAlloc DatatypeTypeType |a1#0@@3| Tclass._module.aexp $Heap@@2)) (|$IsA#_module.aexp| |a1#0@@3|)) (and (and ($Is HandleTypeType |s#0@@3| (Tclass._System.___hTotalFunc1 (TSeq TChar) TInt)) ($IsAlloc HandleTypeType |s#0@@3| (Tclass._System.___hTotalFunc1 (TSeq TChar) TInt) $Heap@@2)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))))
