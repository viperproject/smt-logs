...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.length$_T0@@1 T@U) ($ly@@1 T@U) (|xs#0@@1| T@U) ) (!  (=> (or (|_module.__default.length#canCall| _module._default.length$_T0@@1 |xs#0@@1|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@1| (Tclass._module.List _module._default.length$_T0@@1)))) (and (=> (not (_module.List.Nil_q |xs#0@@1|)) (let ((|ys#1| (_module.List.tail |xs#0@@1|)))
(|_module.__default.length#canCall| _module._default.length$_T0@@1 |ys#1|))) (= (_module.__default.length _module._default.length$_T0@@1 ($LS $ly@@1) |xs#0@@1|) (ite (_module.List.Nil_q |xs#0@@1|) 0 (let ((|ys#0| (_module.List.tail |xs#0@@1|)))
(+ 1 (_module.__default.length _module._default.length$_T0@@1 $ly@@1 |ys#0|)))))))
 :qid |unknown.0:0|
 :skolemid |588|
...
(let ((anon10_Then_correct  (=> (= |xs#0@@3| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) (=> (and ($IsBox |_mcc#0#0| _module._default.length$_T0@@3) ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List _module._default.length$_T0@@3))) (=> (and (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List _module._default.length$_T0@@3))) (and (= |ys#Z#0@0| |let#0#0#0|) ($IsAlloc DatatypeTypeType |ys#Z#0@0| (Tclass._module.List _module._default.length$_T0@@3) $Heap))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< (DtRank |ys#Z#0@0|) (DtRank |xs#0@@3|))) (=> (< (DtRank |ys#Z#0@0|) (DtRank |xs#0@@3|)) (=> (and (|_module.__default.length#canCall| _module._default.length$_T0@@3 |ys#Z#0@0|) (= (ControlFlow 0 5) (- 0 4))) ($Is intType (int_2_U (+ 1 (_module.__default.length _module._default.length$_T0@@3 ($LS $LZ) |ys#Z#0@0|))) Tclass._System.nat)))))))))
