...
(set-info :boogie-vc-id Impl$$_module.__default.InsertBalanced__B)
...
(assert (not
 ...
 (and (|MultiSet#Equal| (_module.__default.Elements ($LS $LZ) |t'#1|) (|MultiSet#Union| (_module.__default.Elements ($LS $LZ) |$ih#t0#0|) (|MultiSet#UnionOne| |MultiSet#Empty| ($Box intType (int_2_U |$ih#y0#0|))))) (_module.__default.IsBalanced ($LS $LZ) |t'#1|))))
 :qid |Regression16dfy.44:24|
 :skolemid |556|
...
)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (let ((|t'#0| (_module.__default.Insert ($LS ($LS $LZ)) |t#0@@10| |y#0@@3|)))
(|MultiSet#Equal| (_module.__default.Elements ($LS ($LS $LZ)) |t'#0|) (|MultiSet#Union| (_module.__default.Elements ($LS ($LS $LZ)) |t#0@@10|) (|MultiSet#UnionOne| |MultiSet#Empty| ($Box intType (int_2_U |y#0@@3|))))))) (=> (let ((|t'#0@@0| (_module.__default.Insert ($LS ($LS $LZ)) |t#0@@10| |y#0@@3|)))
(|MultiSet#Equal| (_module.__default.Elements ($LS ($LS $LZ)) |t'#0@@0|) (|MultiSet#Union| (_module.__default.Elements ($LS ($LS $LZ)) |t#0@@10|) (|MultiSet#UnionOne| |MultiSet#Empty| ($Box intType (int_2_U |y#0@@3|)))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (let ((|t'#0@@1| (_module.__default.Insert ($LS ($LS $LZ)) |t#0@@10| |y#0@@3|)))
 (=> (|_module.__default.IsBalanced#canCall| |t'#0@@1|) (or (_module.__default.IsBalanced ($LS $LZ) |t'#0@@1|) (=> (_module.Tree.Leaf_q |t'#0@@1|) (U_2_bool (Lit boolType (bool_2_U true)))))))) (=> (let ((|t'#0@@2| (_module.__default.Insert ($LS ($LS $LZ)) |t#0@@10| |y#0@@3|)))
 (=> (|_module.__default.IsBalanced#canCall| |t'#0@@2|) (or (_module.__default.IsBalanced ($LS $LZ) |t'#0@@2|) (=> (_module.Tree.Leaf_q |t'#0@@2|) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (let ((|t'#0@@3| (_module.__default.Insert ($LS ($LS $LZ)) |t#0@@10| |y#0@@3|)))
 (=> (|_module.__default.IsBalanced#canCall| |t'#0@@3|) (or (_module.__default.IsBalanced ($LS $LZ) |t'#0@@3|) (=> (not (_module.Tree.Leaf_q |t'#0@@3|)) (let ((|left#6| (_module.Tree.left |t'#0@@3|)))
(_module.__default.IsBalanced ($LS ($LS $LZ)) |left#6|))))))) (=> (let ((|t'#0@@4| (_module.__default.Insert ($LS ($LS $LZ)) |t#0@@10| |y#0@@3|)))
 (=> (|_module.__default.IsBalanced#canCall| |t'#0@@4|) (or (_module.__default.IsBalanced ($LS $LZ) |t'#0@@4|) (=> (not (_module.Tree.Leaf_q |t'#0@@4|)) (let ((|left#6@@0| (_module.Tree.left |t'#0@@4|)))
(_module.__default.IsBalanced ($LS ($LS $LZ)) |left#6@@0|)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (let ((|t'#0@@5| (_module.__default.Insert ($LS ($LS $LZ)) |t#0@@10| |y#0@@3|)))
 (=> (|_module.__default.IsBalanced#canCall| |t'#0@@5|) (or (_module.__default.IsBalanced ($LS $LZ) |t'#0@@5|) (=> (not (_module.Tree.Leaf_q |t'#0@@5|)) (let ((|right#6| (_module.Tree.right |t'#0@@5|)))
(_module.__default.IsBalanced ($LS ($LS $LZ)) |right#6|))))))) (=> (let ((|t'#0@@6| (_module.__default.Insert ($LS ($LS $LZ)) |t#0@@10| |y#0@@3|)))
 (=> (|_module.__default.IsBalanced#canCall| |t'#0@@6|) (or (_module.__default.IsBalanced ($LS $LZ) |t'#0@@6|) (=> (not (_module.Tree.Leaf_q |t'#0@@6|)) (let ((|right#6@@0| (_module.Tree.right |t'#0@@6|)))
(_module.__default.IsBalanced ($LS ($LS $LZ)) |right#6@@0|)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (let ((|t'#0@@7| (_module.__default.Insert ($LS ($LS $LZ)) |t#0@@10| |y#0@@3|)))
 (=> (|_module.__default.IsBalanced#canCall| |t'#0@@7|) (or (_module.__default.IsBalanced ($LS $LZ) |t'#0@@7|) (=> (not (_module.Tree.Leaf_q |t'#0@@7|)) (let ((|right#6@@1| (_module.Tree.right |t'#0@@7|)))
(let ((|left#6@@1| (_module.Tree.left |t'#0@@7|)))
