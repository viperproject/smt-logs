...
(declare-fun _module.__default.equiv__c (T@U T@U) Bool)
(declare-fun |_module.__default.equiv__c#canCall| (T@U T@U) Bool)
...
(assert (distinct TBool TChar TInt TagBool TagChar TagInt TagSet TagSeq TagMap alloc |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass._module.aexp Tagclass._module.bexp Tagclass._module.com |##_module.aexp.N| |##_module.aexp.V| |##_module.aexp.Plus| |##_module.bexp.Bc| |##_module.bexp.Not| |##_module.bexp.And| |##_module.bexp.Less| |##_module.com.SKIP| |##_module.com.Assign| |##_module.com.Seq| |##_module.com.If| |##_module.com.While| |tytagFamily$_tuple#2| tytagFamily$aexp tytagFamily$bexp tytagFamily$com)
)
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|c#0@@5| T@U) (|c'#0| T@U) ) (!  (=> (or (|_module.__default.equiv__c#canCall| (Lit DatatypeTypeType |c#0@@5|) (Lit DatatypeTypeType |c'#0|)) (and (< 5 $FunctionContextHeight) (and ($Is DatatypeTypeType |c#0@@5| Tclass._module.com) ($Is DatatypeTypeType |c'#0| Tclass._module.com)))) (and (forall ((|s#1| T@U) (|t#1| T@U) ) (!  (=> (and ($Is MapType |s#1| (TMap (TSeq TChar) TInt)) ($Is MapType |t#1| (TMap (TSeq TChar) TInt))) (and (|_module.__default.big__step#canCall| (Lit DatatypeTypeType |c#0@@5|) |s#1| |t#1|) (|_module.__default.big__step#canCall| (Lit DatatypeTypeType |c'#0|) |s#1| |t#1|)))
 :qid |NipkowKleinchapter7dfy.84:10|
 :skolemid |834|
 :pattern ( (_module.__default.big__step ($LS $LZ) |c'#0| |s#1| |t#1|))
 :pattern ( (_module.__default.big__step ($LS $LZ) |c#0@@5| |s#1| |t#1|))
)) (= (_module.__default.equiv__c (Lit DatatypeTypeType |c#0@@5|) (Lit DatatypeTypeType |c'#0|)) (forall ((|s#1@@0| T@U) (|t#1@@0| T@U) ) (!  (=> (and ($Is MapType |s#1@@0| (TMap (TSeq TChar) TInt)) ($Is MapType |t#1@@0| (TMap (TSeq TChar) TInt))) (= (_module.__default.big__step ($LS $LZ) (Lit DatatypeTypeType |c#0@@5|) |s#1@@0| |t#1@@0|) (_module.__default.big__step ($LS $LZ) (Lit DatatypeTypeType |c'#0|) |s#1@@0| |t#1@@0|)))
 :qid |NipkowKleinchapter7dfy.84:10|
 :skolemid |833|
 :pattern ( (_module.__default.big__step ($LS $LZ) |c'#0| |s#1@@0| |t#1@@0|))
 :pattern ( (_module.__default.big__step ($LS $LZ) |c#0@@5| |s#1@@0| |t#1@@0|))
)))))
 :qid |NipkowKleinchapter7dfy.82:25|
 :weight 3
 :skolemid |835|
 :pattern ( (_module.__default.equiv__c (Lit DatatypeTypeType |c#0@@5|) (Lit DatatypeTypeType |c'#0|)))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@9 T@U) (|_k#0@@5| T@U) (|c#0@@6| T@U) (|s#0@@9| T@U) (|t#0@@5| T@U) ) (!  (=> (or (|_module.__default.big__step_h#canCall| |_k#0@@5| |c#0@@6| |s#0@@9| |t#0@@5|) (and (< 5 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |c#0@@6| Tclass._module.com) ($Is MapType |s#0@@9| (TMap (TSeq TChar) TInt))) ($Is MapType |t#0@@5| (TMap (TSeq TChar) TInt))))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@5|)) (=> (not (_module.com.SKIP_q |c#0@@6|)) (and (=> (_module.com.Assign_q |c#0@@6|) (let ((|a#3| (_module.com._h1 |c#0@@6|)))
(|_module.__default.aval#canCall| |a#3| |s#0@@9|))) (=> (not (_module.com.Assign_q |c#0@@6|)) (and (=> (_module.com.Seq_q |c#0@@6|) (let ((|c1#3| (_module.com._h3 |c#0@@6|)))
...
(let ((|b#6| (_module.com._h4 |c#0@@6|)))
 (and (|_module.__default.bval#canCall| |b#6| |s#0@@9|) (|_module.__default.big__step_h#canCall| (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) (ite (_module.__default.bval ($LS $LZ) |b#6| |s#0@@9|) |thn#3| |els#3|) |s#0@@9| |t#0@@5|)))))) (=> (not (_module.com.If_q |c#0@@6|)) (let ((|body#3| (_module.com._h8 |c#0@@6|)))
(let ((|b#7| (_module.com._h7 |c#0@@6|)))
...
)))))))))))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@5|)) (ite (_module.com.SKIP_q |c#0@@6|) (|Map#Equal| |s#0@@9| |t#0@@5|) (ite (_module.com.Assign_q |c#0@@6|) (let ((|a#4| (_module.com._h1 |c#0@@6|)))
(let ((|x#4| (_module.com._h0 |c#0@@6|)))
(|Map#Equal| |t#0@@5| (|Map#Build| |s#0@@9| ($Box SeqType |x#4|) ($Box intType (int_2_U (_module.__default.aval ($LS $LZ) |a#4| |s#0@@9|))))))) (ite (_module.com.Seq_q |c#0@@6|) (let ((|c1#4| (_module.com._h3 |c#0@@6|)))
...
(_module.__default.big__step_h $ly@@9 (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) (ite (_module.__default.bval ($LS $LZ) |b#8| |s#0@@9|) |thn#4| |els#4|) |s#0@@9| |t#0@@5|)))) (let ((|body#4| (_module.com._h8 |c#0@@6|)))
...
))))))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@5|)) (forall ((|_k'#0| T@U) ) (!  (=> (|ORD#LessThanLimit| |_k'#0| |_k#0@@5|) (|_module.__default.big__step_h#canCall| |_k'#0| |c#0@@6| |s#0@@9| |t#0@@5|))
 :qid |NipkowKleinchapter7dfy.40:17|
 :skolemid |759|
 :pattern ( (_module.__default.big__step_h $ly@@9 |_k'#0| |c#0@@6| |s#0@@9| |t#0@@5|))
))))) (= (_module.__default.big__step_h ($LS $ly@@9) |_k#0@@5| |c#0@@6| |s#0@@9| |t#0@@5|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@5|)) (ite (_module.com.SKIP_q |c#0@@6|) (|Map#Equal| |s#0@@9| |t#0@@5|) (ite (_module.com.Assign_q |c#0@@6|) (let ((|a#2| (_module.com._h1 |c#0@@6|)))
(let ((|x#2@@0| (_module.com._h0 |c#0@@6|)))
(|Map#Equal| |t#0@@5| (|Map#Build| |s#0@@9| ($Box SeqType |x#2@@0|) ($Box intType (int_2_U (_module.__default.aval ($LS $LZ) |a#2| |s#0@@9|))))))) (ite (_module.com.Seq_q |c#0@@6|) (let ((|c1#2| (_module.com._h3 |c#0@@6|)))
...
(_module.__default.big__step_h $ly@@9 (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) (ite (_module.__default.bval ($LS $LZ) |b#4@@0| |s#0@@9|) |thn#2| |els#2|) |s#0@@9| |t#0@@5|)))) (let ((|body#2| (_module.com._h8 |c#0@@6|)))
...
))))))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@5|)) (exists ((|_k'#0@@0| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#0@@0| |_k#0@@5|) (_module.__default.big__step_h $ly@@9 |_k'#0@@0| |c#0@@6| |s#0@@9| |t#0@@5|))
 :qid |NipkowKleinchapter7dfy.40:17|
 :skolemid |756|
 :pattern ( (_module.__default.big__step_h $ly@@9 |_k'#0@@0| |c#0@@6| |s#0@@9| |t#0@@5|))
)))))))
 :qid |NipkowKleinchapter7dfy.40:17|
 :skolemid |762|
 :pattern ( (_module.__default.big__step_h ($LS $ly@@9) |_k#0@@5| |c#0@@6| |s#0@@9| |t#0@@5|))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@11 T@U) (|_k#0@@6| T@U) (|c#0@@7| T@U) (|s#0@@11| T@U) (|t#0@@6| T@U) ) (!  (=> (or (|_module.__default.big__step_h#canCall| (Lit BoxType |_k#0@@6|) (Lit DatatypeTypeType |c#0@@7|) (Lit MapType |s#0@@11|) (Lit MapType |t#0@@6|)) (and (< 5 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |c#0@@7| Tclass._module.com) ($Is MapType |s#0@@11| (TMap (TSeq TChar) TInt))) ($Is MapType |t#0@@6| (TMap (TSeq TChar) TInt))))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@6|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.com.SKIP_q (Lit DatatypeTypeType |c#0@@7|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (_module.com.Assign_q (Lit DatatypeTypeType |c#0@@7|))))) (let ((|a#9| (Lit DatatypeTypeType (_module.com._h1 (Lit DatatypeTypeType |c#0@@7|)))))
(|_module.__default.aval#canCall| |a#9| (Lit MapType |s#0@@11|)))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.com.Assign_q (Lit DatatypeTypeType |c#0@@7|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (_module.com.Seq_q (Lit DatatypeTypeType |c#0@@7|))))) (let ((|c1#9| (Lit DatatypeTypeType (_module.com._h3 (Lit DatatypeTypeType |c#0@@7|)))))
...
(let ((|b#18| (Lit DatatypeTypeType (_module.com._h4 (Lit DatatypeTypeType |c#0@@7|)))))
 (and (|_module.__default.bval#canCall| |b#18| (Lit MapType |s#0@@11|)) (|_module.__default.big__step_h#canCall| (|ORD#Minus| |_k#0@@6| (|ORD#FromNat| 1)) (ite (_module.__default.bval ($LS $LZ) |b#18| (Lit MapType |s#0@@11|)) |thn#9| |els#9|) (Lit MapType |s#0@@11|) (Lit MapType |t#0@@6|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.com.If_q (Lit DatatypeTypeType |c#0@@7|)))))) (let ((|body#9| (Lit DatatypeTypeType (_module.com._h8 (Lit DatatypeTypeType |c#0@@7|)))))
(let ((|b#19| (Lit DatatypeTypeType (_module.com._h7 (Lit DatatypeTypeType |c#0@@7|)))))
...
)))))))))))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@6|)) (ite (_module.com.SKIP_q (Lit DatatypeTypeType |c#0@@7|)) (|Map#Equal| |s#0@@11| |t#0@@6|) (ite (_module.com.Assign_q (Lit DatatypeTypeType |c#0@@7|)) (let ((|a#10| (Lit DatatypeTypeType (_module.com._h1 (Lit DatatypeTypeType |c#0@@7|)))))
(let ((|x#10| (Lit SeqType (_module.com._h0 (Lit DatatypeTypeType |c#0@@7|)))))
(|Map#Equal| |t#0@@6| (|Map#Build| (Lit MapType |s#0@@11|) ($Box SeqType |x#10|) ($Box intType (int_2_U (LitInt (_module.__default.aval ($LS $LZ) |a#10| (Lit MapType |s#0@@11|))))))))) (ite (_module.com.Seq_q (Lit DatatypeTypeType |c#0@@7|)) (let ((|c1#10| (Lit DatatypeTypeType (_module.com._h3 (Lit DatatypeTypeType |c#0@@7|)))))
...
(_module.__default.big__step_h ($LS $ly@@11) (|ORD#Minus| |_k#0@@6| (|ORD#FromNat| 1)) (ite (_module.__default.bval ($LS $LZ) |b#20| (Lit MapType |s#0@@11|)) |thn#10| |els#10|) (Lit MapType |s#0@@11|) (Lit MapType |t#0@@6|))))) (let ((|body#10| (Lit DatatypeTypeType (_module.com._h8 (Lit DatatypeTypeType |c#0@@7|)))))
...
))))))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@6|)) (forall ((|_k'#2| T@U) ) (!  (=> (|ORD#LessThanLimit| |_k'#2| |_k#0@@6|) (|_module.__default.big__step_h#canCall| |_k'#2| |c#0@@7| |s#0@@11| |t#0@@6|))
 :qid |NipkowKleinchapter7dfy.40:17|
 :skolemid |777|
 :pattern ( (_module.__default.big__step_h ($LS $ly@@11) |_k'#2| |c#0@@7| |s#0@@11| |t#0@@6|))
))))) (= (_module.__default.big__step_h ($LS $ly@@11) (Lit BoxType |_k#0@@6|) (Lit DatatypeTypeType |c#0@@7|) (Lit MapType |s#0@@11|) (Lit MapType |t#0@@6|))  (and (=> (< 0 (|ORD#Offset| |_k#0@@6|)) (ite (_module.com.SKIP_q (Lit DatatypeTypeType |c#0@@7|)) (|Map#Equal| |s#0@@11| |t#0@@6|) (ite (_module.com.Assign_q (Lit DatatypeTypeType |c#0@@7|)) (let ((|a#8| (Lit DatatypeTypeType (_module.com._h1 (Lit DatatypeTypeType |c#0@@7|)))))
(let ((|x#8| (Lit SeqType (_module.com._h0 (Lit DatatypeTypeType |c#0@@7|)))))
(|Map#Equal| |t#0@@6| (|Map#Build| (Lit MapType |s#0@@11|) ($Box SeqType |x#8|) ($Box intType (int_2_U (LitInt (_module.__default.aval ($LS $LZ) |a#8| (Lit MapType |s#0@@11|))))))))) (ite (_module.com.Seq_q (Lit DatatypeTypeType |c#0@@7|)) (let ((|c1#8| (Lit DatatypeTypeType (_module.com._h3 (Lit DatatypeTypeType |c#0@@7|)))))
...
(_module.__default.big__step_h ($LS $ly@@11) (|ORD#Minus| |_k#0@@6| (|ORD#FromNat| 1)) (ite (_module.__default.bval ($LS $LZ) |b#16| (Lit MapType |s#0@@11|)) |thn#8| |els#8|) (Lit MapType |s#0@@11|) (Lit MapType |t#0@@6|))))) (let ((|body#8| (Lit DatatypeTypeType (_module.com._h8 (Lit DatatypeTypeType |c#0@@7|)))))
...
))))))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@6|)) (exists ((|_k'#2@@0| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#2@@0| |_k#0@@6|) (_module.__default.big__step_h ($LS $ly@@11) |_k'#2@@0| |c#0@@7| |s#0@@11| |t#0@@6|))
 :qid |NipkowKleinchapter7dfy.40:17|
 :skolemid |774|
 :pattern ( (_module.__default.big__step_h ($LS $ly@@11) |_k'#2@@0| |c#0@@7| |s#0@@11| |t#0@@6|))
)))))))
 :qid |NipkowKleinchapter7dfy.40:17|
 :weight 3
 :skolemid |780|
 :pattern ( (_module.__default.big__step_h ($LS $ly@@11) (Lit BoxType |_k#0@@6|) (Lit DatatypeTypeType |c#0@@7|) (Lit MapType |s#0@@11|) (Lit MapType |t#0@@6|)))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|c#0@@8| T@U) (|c'#0@@0| T@U) ) (!  (=> (or (|_module.__default.equiv__c#canCall| |c#0@@8| |c'#0@@0|) (and (< 5 $FunctionContextHeight) (and ($Is DatatypeTypeType |c#0@@8| Tclass._module.com) ($Is DatatypeTypeType |c'#0@@0| Tclass._module.com)))) (and (forall ((|s#0@@12| T@U) (|t#0@@7| T@U) ) (!  (=> (and ($Is MapType |s#0@@12| (TMap (TSeq TChar) TInt)) ($Is MapType |t#0@@7| (TMap (TSeq TChar) TInt))) (and (|_module.__default.big__step#canCall| |c#0@@8| |s#0@@12| |t#0@@7|) (|_module.__default.big__step#canCall| |c'#0@@0| |s#0@@12| |t#0@@7|)))
 :qid |NipkowKleinchapter7dfy.84:10|
 :skolemid |831|
 :pattern ( (_module.__default.big__step ($LS $LZ) |c'#0@@0| |s#0@@12| |t#0@@7|))
 :pattern ( (_module.__default.big__step ($LS $LZ) |c#0@@8| |s#0@@12| |t#0@@7|))
)) (= (_module.__default.equiv__c |c#0@@8| |c'#0@@0|) (forall ((|s#0@@13| T@U) (|t#0@@8| T@U) ) (!  (=> (and ($Is MapType |s#0@@13| (TMap (TSeq TChar) TInt)) ($Is MapType |t#0@@8| (TMap (TSeq TChar) TInt))) (= (_module.__default.big__step ($LS $LZ) |c#0@@8| |s#0@@13| |t#0@@8|) (_module.__default.big__step ($LS $LZ) |c'#0@@0| |s#0@@13| |t#0@@8|)))
 :qid |NipkowKleinchapter7dfy.84:10|
 :skolemid |830|
 :pattern ( (_module.__default.big__step ($LS $LZ) |c'#0@@0| |s#0@@13| |t#0@@8|))
 :pattern ( (_module.__default.big__step ($LS $LZ) |c#0@@8| |s#0@@13| |t#0@@8|))
)))))
 :qid |NipkowKleinchapter7dfy.82:25|
 :skolemid |832|
 :pattern ( (_module.__default.equiv__c |c#0@@8| |c'#0@@0|))
))))
...
(assert (forall (($ly@@12 T@U) (|c#0@@9| T@U) (|s#0@@14| T@U) (|t#0@@9| T@U) ) (! (= (_module.__default.big__step ($LS $ly@@12) |c#0@@9| |s#0@@14| |t#0@@9|) (_module.__default.big__step $ly@@12 |c#0@@9| |s#0@@14| |t#0@@9|))
 :qid |NipkowKleinchapter7dfy.40:17|
 :skolemid |720|
 :pattern ( (_module.__default.big__step ($LS $ly@@12) |c#0@@9| |s#0@@14| |t#0@@9|))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@13 T@U) (|c#0@@10| T@U) (|s#0@@15| T@U) (|t#0@@10| T@U) ) (!  (=> (or (|_module.__default.big__step#canCall| |c#0@@10| |s#0@@15| |t#0@@10|) (and (< 4 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |c#0@@10| Tclass._module.com) ($Is MapType |s#0@@15| (TMap (TSeq TChar) TInt))) ($Is MapType |t#0@@10| (TMap (TSeq TChar) TInt))))) (and (=> (not (_module.com.SKIP_q |c#0@@10|)) (and (=> (_module.com.Assign_q |c#0@@10|) (let ((|a#1| (_module.com._h1 |c#0@@10|)))
(|_module.__default.aval#canCall| |a#1| |s#0@@15|))) (=> (not (_module.com.Assign_q |c#0@@10|)) (and (=> (_module.com.Seq_q |c#0@@10|) (let ((|c1#1| (_module.com._h3 |c#0@@10|)))
(let ((|c0#1| (_module.com._h2 |c#0@@10|)))
(forall ((|s'#2| T@U) ) (!  (=> ($Is MapType |s'#2| (TMap (TSeq TChar) TInt)) (and (|_module.__default.big__step#canCall| |c0#1| |s#0@@15| |s'#2|) (=> (_module.__default.big__step $ly@@13 |c0#1| |s#0@@15| |s'#2|) (|_module.__default.big__step#canCall| |c1#1| |s'#2| |t#0@@10|))))
 :qid |NipkowKleinchapter7dfy.48:12|
 :skolemid |727|
 :pattern ( (_module.__default.big__step $ly@@13 |c1#1| |s'#2| |t#0@@10|))
 :pattern ( (_module.__default.big__step $ly@@13 |c0#1| |s#0@@15| |s'#2|))
))))) (=> (not (_module.com.Seq_q |c#0@@10|)) (and (=> (_module.com.If_q |c#0@@10|) (let ((|els#1| (_module.com._h6 |c#0@@10|)))
(let ((|thn#1| (_module.com._h5 |c#0@@10|)))
(let ((|b#2@@0| (_module.com._h4 |c#0@@10|)))
 (and (|_module.__default.bval#canCall| |b#2@@0| |s#0@@15|) (|_module.__default.big__step#canCall| (ite (_module.__default.bval ($LS $LZ) |b#2@@0| |s#0@@15|) |thn#1| |els#1|) |s#0@@15| |t#0@@10|)))))) (=> (not (_module.com.If_q |c#0@@10|)) (let ((|body#1| (_module.com._h8 |c#0@@10|)))
(let ((|b#3@@0| (_module.com._h7 |c#0@@10|)))
 (and (|_module.__default.bval#canCall| |b#3@@0| |s#0@@15|) (=> (not (and (not (_module.__default.bval ($LS $LZ) |b#3@@0| |s#0@@15|)) (|Map#Equal| |s#0@@15| |t#0@@10|))) (and (|_module.__default.bval#canCall| |b#3@@0| |s#0@@15|) (=> (_module.__default.bval ($LS $LZ) |b#3@@0| |s#0@@15|) (forall ((|s'#3| T@U) ) (!  (=> ($Is MapType |s'#3| (TMap (TSeq TChar) TInt)) (and (|_module.__default.big__step#canCall| |body#1| |s#0@@15| |s'#3|) (=> (_module.__default.big__step $ly@@13 |body#1| |s#0@@15| |s'#3|) (|_module.__default.big__step#canCall| (|#_module.com.While| |b#3@@0| |body#1|) |s'#3| |t#0@@10|))))
 :qid |NipkowKleinchapter7dfy.55:27|
 :skolemid |728|
 :pattern ( (_module.__default.big__step $ly@@13 (|#_module.com.While| |b#3@@0| |body#1|) |s'#3| |t#0@@10|))
 :pattern ( (_module.__default.big__step $ly@@13 |body#1| |s#0@@15| |s'#3|))
))))))))))))))) (= (_module.__default.big__step ($LS $ly@@13) |c#0@@10| |s#0@@15| |t#0@@10|) (ite (_module.com.SKIP_q |c#0@@10|) (|Map#Equal| |s#0@@15| |t#0@@10|) (ite (_module.com.Assign_q |c#0@@10|) (let ((|a#0@@1| (_module.com._h1 |c#0@@10|)))
(let ((|x#0| (_module.com._h0 |c#0@@10|)))
(|Map#Equal| |t#0@@10| (|Map#Build| |s#0@@15| ($Box SeqType |x#0|) ($Box intType (int_2_U (_module.__default.aval ($LS $LZ) |a#0@@1| |s#0@@15|))))))) (ite (_module.com.Seq_q |c#0@@10|) (let ((|c1#0| (_module.com._h3 |c#0@@10|)))
(let ((|c0#0| (_module.com._h2 |c#0@@10|)))
(exists ((|s'#0| T@U) ) (!  (and ($Is MapType |s'#0| (TMap (TSeq TChar) TInt)) (and (_module.__default.big__step $ly@@13 |c0#0| |s#0@@15| |s'#0|) (_module.__default.big__step $ly@@13 |c1#0| |s'#0| |t#0@@10|)))
 :qid |NipkowKleinchapter7dfy.48:12|
 :skolemid |725|
 :pattern ( (_module.__default.big__step $ly@@13 |c1#0| |s'#0| |t#0@@10|))
 :pattern ( (_module.__default.big__step $ly@@13 |c0#0| |s#0@@15| |s'#0|))
)))) (ite (_module.com.If_q |c#0@@10|) (let ((|els#0| (_module.com._h6 |c#0@@10|)))
(let ((|thn#0| (_module.com._h5 |c#0@@10|)))
(let ((|b#0@@2| (_module.com._h4 |c#0@@10|)))
(_module.__default.big__step $ly@@13 (ite (_module.__default.bval ($LS $LZ) |b#0@@2| |s#0@@15|) |thn#0| |els#0|) |s#0@@15| |t#0@@10|)))) (let ((|body#0| (_module.com._h8 |c#0@@10|)))
(let ((|b#1@@0| (_module.com._h7 |c#0@@10|)))
 (or (and (not (_module.__default.bval ($LS $LZ) |b#1@@0| |s#0@@15|)) (|Map#Equal| |s#0@@15| |t#0@@10|)) (and (_module.__default.bval ($LS $LZ) |b#1@@0| |s#0@@15|) (exists ((|s'#1| T@U) ) (!  (and ($Is MapType |s'#1| (TMap (TSeq TChar) TInt)) (and (_module.__default.big__step $ly@@13 |body#0| |s#0@@15| |s'#1|) (_module.__default.big__step $ly@@13 (|#_module.com.While| |b#1@@0| |body#0|) |s'#1| |t#0@@10|)))
 :qid |NipkowKleinchapter7dfy.55:27|
 :skolemid |726|
 :pattern ( (_module.__default.big__step $ly@@13 (|#_module.com.While| |b#1@@0| |body#0|) |s'#1| |t#0@@10|))
 :pattern ( (_module.__default.big__step $ly@@13 |body#0| |s#0@@15| |s'#1|))
)))))))))))))
 :qid |NipkowKleinchapter7dfy.40:17|
 :skolemid |729|
 :pattern ( (_module.__default.big__step ($LS $ly@@13) |c#0@@10| |s#0@@15| |t#0@@10|))
))))
...
(assert (forall ((d@@37 T@U) ) (!  (=> (|$IsA#_module.bexp| d@@37) (or (or (or (_module.bexp.Bc_q d@@37) (_module.bexp.Not_q d@@37)) (_module.bexp.And_q d@@37)) (_module.bexp.Less_q d@@37)))
 :qid |unknown.0:0|
 :skolemid |1509|
 :pattern ( (|$IsA#_module.bexp| d@@37))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@14 T@U) (|a#0@@2| T@U) (|s#0@@16| T@U) ) (!  (=> (or (|_module.__default.aval#canCall| |a#0@@2| |s#0@@16|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |a#0@@2| Tclass._module.aexp) ($Is MapType |s#0@@16| (TMap (TSeq TChar) TInt))))) (and (=> (not (_module.aexp.N_q |a#0@@2|)) (=> (not (_module.aexp.V_q |a#0@@2|)) (let ((|a1#1@@0| (_module.aexp._1 |a#0@@2|)))
(let ((|a0#1@@0| (_module.aexp._0 |a#0@@2|)))
 (and (|_module.__default.aval#canCall| |a0#1@@0| |s#0@@16|) (|_module.__default.aval#canCall| |a1#1@@0| |s#0@@16|)))))) (= (_module.__default.aval ($LS $ly@@14) |a#0@@2| |s#0@@16|) (ite (_module.aexp.N_q |a#0@@2|) (let ((|n#0| (_module.aexp.n |a#0@@2|)))
|n#0|) (ite (_module.aexp.V_q |a#0@@2|) (let ((|x#0@@0| (_module.aexp.x |a#0@@2|)))
(ite (|Set#IsMember| (|Map#Domain| |s#0@@16|) ($Box SeqType |x#0@@0|)) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |s#0@@16|) ($Box SeqType |x#0@@0|)))) 0)) (let ((|a1#0@@0| (_module.aexp._1 |a#0@@2|)))
(let ((|a0#0@@0| (_module.aexp._0 |a#0@@2|)))
(+ (_module.__default.aval $ly@@14 |a0#0@@0| |s#0@@16|) (_module.__default.aval $ly@@14 |a1#0@@0| |s#0@@16|)))))))))
 :qid |NipkowKleinchapter7dfy.16:16|
 :skolemid |704|
 :pattern ( (_module.__default.aval ($LS $ly@@14) |a#0@@2| |s#0@@16|))
))))
...
(assert (forall ((v@@12 T@U) (t0@@6 T@U) ) (! (= ($Is SeqType v@@12 (TSeq t0@@6)) (forall ((i@@2 Int) ) (!  (=> (and (<= 0 i@@2) (< i@@2 (|Seq#Length| v@@12))) ($IsBox (|Seq#Index| v@@12 i@@2) t0@@6))
...
(assert (forall ((m@@12 T@U) ) (!  (or (= m@@12 |Map#Empty|) (exists ((k@@0 T@U) (v@@13 T@U) ) (! (|Set#IsMember| (|Map#Items| m@@12) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| k@@0 v@@13)))
...
(declare-fun |c#1| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.lemma__7__6_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#9@@0| |c'#1|) |s#2| |t#2|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#9@@0| |c'#1|) |s#2| |t#2|) (=> (_module.com.SKIP_q (|#_module.com.While| |b#9@@0| |c'#1|)) (|Map#Equal| |s#2| |t#2|))))) (=> (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#9@@0| |c'#1|) |s#2| |t#2|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#9@@0| |c'#1|) |s#2| |t#2|) (=> (_module.com.SKIP_q (|#_module.com.While| |b#9@@0| |c'#1|)) (|Map#Equal| |s#2| |t#2|)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#9@@0| |c'#1|) |s#2| |t#2|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#9@@0| |c'#1|) |s#2| |t#2|) (=> (not (_module.com.SKIP_q (|#_module.com.While| |b#9@@0| |c'#1|))) (=> (_module.com.Assign_q (|#_module.com.While| |b#9@@0| |c'#1|)) (let ((|a#10@@0| (_module.com._h1 (|#_module.com.While| |b#9@@0| |c'#1|))))
(let ((|x#10@@0| (_module.com._h0 (|#_module.com.While| |b#9@@0| |c'#1|))))
(|Map#Equal| |t#2| (|Map#Build| |s#2| ($Box SeqType |x#10@@0|) ($Box intType (int_2_U (_module.__default.aval ($LS ($LS $LZ)) |a#10@@0| |s#2|)))))))))))) (=> (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#9@@0| |c'#1|) |s#2| |t#2|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#9@@0| |c'#1|) |s#2| |t#2|) (=> (not (_module.com.SKIP_q (|#_module.com.While| |b#9@@0| |c'#1|))) (=> (_module.com.Assign_q (|#_module.com.While| |b#9@@0| |c'#1|)) (let ((|a#10@@1| (_module.com._h1 (|#_module.com.While| |b#9@@0| |c'#1|))))
(let ((|x#10@@1| (_module.com._h0 (|#_module.com.While| |b#9@@0| |c'#1|))))
(|Map#Equal| |t#2| (|Map#Build| |s#2| ($Box SeqType |x#10@@1|) ($Box intType (int_2_U (_module.__default.aval ($LS ($LS $LZ)) |a#10@@1| |s#2|))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#9@@0| |c'#1|) |s#2| |t#2|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#9@@0| |c'#1|) |s#2| |t#2|) (=> (not (_module.com.SKIP_q (|#_module.com.While| |b#9@@0| |c'#1|))) (=> (not (_module.com.Assign_q (|#_module.com.While| |b#9@@0| |c'#1|))) (=> (_module.com.Seq_q (|#_module.com.While| |b#9@@0| |c'#1|)) (let ((|c1#10@@0| (_module.com._h3 (|#_module.com.While| |b#9@@0| |c'#1|))))
(let ((|c0#10@@0| (_module.com._h2 (|#_module.com.While| |b#9@@0| |c'#1|))))
(exists ((|s'#20@@0| T@U) ) (!  (and ($Is MapType |s'#20@@0| (TMap (TSeq TChar) TInt)) (and (_module.__default.big__step ($LS $LZ) |c0#10@@0| |s#2| |s'#20@@0|) (_module.__default.big__step ($LS $LZ) |c1#10@@0| |s'#20@@0| |t#2|)))
 :qid |NipkowKleinchapter7dfy.48:12|
 :skolemid |908|
 :pattern ( (_module.__default.big__step ($LS $LZ) |c1#10@@0| |s'#20@@0| |t#2|))
 :pattern ( (_module.__default.big__step ($LS $LZ) |c0#10@@0| |s#2| |s'#20@@0|))
)))))))))) (=> (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#9@@0| |c'#1|) |s#2| |t#2|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#9@@0| |c'#1|) |s#2| |t#2|) (=> (not (_module.com.SKIP_q (|#_module.com.While| |b#9@@0| |c'#1|))) (=> (not (_module.com.Assign_q (|#_module.com.While| |b#9@@0| |c'#1|))) (=> (_module.com.Seq_q (|#_module.com.While| |b#9@@0| |c'#1|)) (let ((|c1#10@@1| (_module.com._h3 (|#_module.com.While| |b#9@@0| |c'#1|))))
(let ((|c0#10@@1| (_module.com._h2 (|#_module.com.While| |b#9@@0| |c'#1|))))
(exists ((|s'#20@@1| T@U) ) (!  (and ($Is MapType |s'#20@@1| (TMap (TSeq TChar) TInt)) (and (_module.__default.big__step ($LS $LZ) |c0#10@@1| |s#2| |s'#20@@1|) (_module.__default.big__step ($LS $LZ) |c1#10@@1| |s'#20@@1| |t#2|)))
 :qid |NipkowKleinchapter7dfy.48:12|
 :skolemid |908|
 :pattern ( (_module.__default.big__step ($LS $LZ) |c1#10@@1| |s'#20@@1| |t#2|))
 :pattern ( (_module.__default.big__step ($LS $LZ) |c0#10@@1| |s#2| |s'#20@@1|))
))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#9@@0| |c'#1|) |s#2| |t#2|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#9@@0| |c'#1|) |s#2| |t#2|) (=> (not (_module.com.SKIP_q (|#_module.com.While| |b#9@@0| |c'#1|))) (=> (not (_module.com.Assign_q (|#_module.com.While| |b#9@@0| |c'#1|))) (=> (not (_module.com.Seq_q (|#_module.com.While| |b#9@@0| |c'#1|))) (=> (_module.com.If_q (|#_module.com.While| |b#9@@0| |c'#1|)) (let ((|els#10@@0| (_module.com._h6 (|#_module.com.While| |b#9@@0| |c'#1|))))
(let ((|thn#10@@0| (_module.com._h5 (|#_module.com.While| |b#9@@0| |c'#1|))))
(let ((|b#22| (_module.com._h4 (|#_module.com.While| |b#9@@0| |c'#1|))))
(_module.__default.big__step ($LS ($LS $LZ)) (ite (_module.__default.bval ($LS ($LS $LZ)) |b#22| |s#2|) |thn#10@@0| |els#10@@0|) |s#2| |t#2|))))))))))) (=> (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#9@@0| |c'#1|) |s#2| |t#2|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#9@@0| |c'#1|) |s#2| |t#2|) (=> (not (_module.com.SKIP_q (|#_module.com.While| |b#9@@0| |c'#1|))) (=> (not (_module.com.Assign_q (|#_module.com.While| |b#9@@0| |c'#1|))) (=> (not (_module.com.Seq_q (|#_module.com.While| |b#9@@0| |c'#1|))) (=> (_module.com.If_q (|#_module.com.While| |b#9@@0| |c'#1|)) (let ((|els#10@@1| (_module.com._h6 (|#_module.com.While| |b#9@@0| |c'#1|))))
(let ((|thn#10@@1| (_module.com._h5 (|#_module.com.While| |b#9@@0| |c'#1|))))
(let ((|b#22@@0| (_module.com._h4 (|#_module.com.While| |b#9@@0| |c'#1|))))
(_module.__default.big__step ($LS ($LS $LZ)) (ite (_module.__default.bval ($LS ($LS $LZ)) |b#22@@0| |s#2|) |thn#10@@1| |els#10@@1|) |s#2| |t#2|)))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#9@@0| |c'#1|) |s#2| |t#2|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#9@@0| |c'#1|) |s#2| |t#2|) (=> (not (_module.com.SKIP_q (|#_module.com.While| |b#9@@0| |c'#1|))) (=> (not (_module.com.Assign_q (|#_module.com.While| |b#9@@0| |c'#1|))) (=> (not (_module.com.Seq_q (|#_module.com.While| |b#9@@0| |c'#1|))) (=> (not (_module.com.If_q (|#_module.com.While| |b#9@@0| |c'#1|))) (let ((|body#10@@0| (_module.com._h8 (|#_module.com.While| |b#9@@0| |c'#1|))))
(let ((|b#23| (_module.com._h7 (|#_module.com.While| |b#9@@0| |c'#1|))))
 (or (and (not (_module.__default.bval ($LS ($LS $LZ)) |b#23| |s#2|)) (|Map#Equal| |s#2| |t#2|)) (and (_module.__default.bval ($LS ($LS $LZ)) |b#23| |s#2|) (exists ((|s'#21@@0| T@U) ) (!  (and ($Is MapType |s'#21@@0| (TMap (TSeq TChar) TInt)) (and (_module.__default.big__step ($LS ($LS $LZ)) |body#10@@0| |s#2| |s'#21@@0|) (_module.__default.big__step ($LS ($LS $LZ)) (|#_module.com.While| |b#23| |body#10@@0|) |s'#21@@0| |t#2|)))
 :qid |NipkowKleinchapter7dfy.55:27|
 :skolemid |910|
 :pattern ( (_module.__default.big__step ($LS ($LS $LZ)) (|#_module.com.While| |b#23| |body#10@@0|) |s'#21@@0| |t#2|))
 :pattern ( (_module.__default.big__step ($LS ($LS $LZ)) |body#10@@0| |s#2| |s'#21@@0|))
)))))))))))))))))))))))
(let ((anon3_Else_correct  (=> (<= (|ORD#Offset| |_k#0@@7|) 0) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1)) (and (forall ((|_k'#2@@1| T@U) (|b#26| T@U) (|c#2| T@U) (|c'#2| T@U) (|s#5| T@U) (|t#5| T@U) ) (!  (=> (and (and (and (and (and ($Is DatatypeTypeType |b#26| Tclass._module.bexp) ($Is DatatypeTypeType |c#2| Tclass._module.com)) ($Is DatatypeTypeType |c'#2| Tclass._module.com)) ($Is MapType |s#5| (TMap (TSeq TChar) TInt))) ($Is MapType |t#5| (TMap (TSeq TChar) TInt))) (and (|ORD#Less| |_k'#2@@1| |_k#0@@7|) (and (_module.__default.big__step_h ($LS $LZ) |_k'#2@@1| (|#_module.com.While| |b#26| |c#2|) |s#5| |t#5|) (_module.__default.equiv__c |c#2| |c'#2|)))) (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#26| |c'#2|) |s#5| |t#5|))
 :qid |NipkowKleinchapter7dfy.113:13|
 :skolemid |914|
 :pattern ( (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#26| |c'#2|) |s#5| |t#5|) (_module.__default.equiv__c |c#2| |c'#2|) (|ORD#Less| |_k'#2@@1| |_k#0@@7|))
 :pattern ( (_module.__default.equiv__c |c#2| |c'#2|) (_module.__default.big__step_h ($LS $LZ) |_k'#2@@1| (|#_module.com.While| |b#26| |c#2|) |s#5| |t#5|))
)) (= (ControlFlow 0 8) 2))) GeneratedUnifiedExit_correct))))
(let ((anon3_Then_correct  (=> (and (< 0 (|ORD#Offset| |_k#0@@7|)) (= (ControlFlow 0 7) 2)) GeneratedUnifiedExit_correct)))
(let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.bexp| |b#9@@0|)) (and (|$IsA#_module.com| |c#1|) (|$IsA#_module.com| |c'#1|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#_k0#0| T@U) (|$ih#b0#0| T@U) (|$ih#c0#0| T@U) (|$ih#c'0#0| T@U) (|$ih#s0#0| T@U) (|$ih#t0#0| T@U) ) (!  (=> (and (and (and (and (and (and ($Is DatatypeTypeType |$ih#b0#0| Tclass._module.bexp) ($Is DatatypeTypeType |$ih#c0#0| Tclass._module.com)) ($Is DatatypeTypeType |$ih#c'0#0| Tclass._module.com)) ($Is MapType |$ih#s0#0| (TMap (TSeq TChar) TInt))) ($Is MapType |$ih#t0#0| (TMap (TSeq TChar) TInt))) (and (_module.__default.big__step_h ($LS $LZ) |$ih#_k0#0| (|#_module.com.While| |$ih#b0#0| |$ih#c0#0|) |$ih#s0#0| |$ih#t0#0|) (_module.__default.equiv__c |$ih#c0#0| |$ih#c'0#0|))) (or (|ORD#Less| |$ih#_k0#0| |_k#0@@7|) (and (= |$ih#_k0#0| |_k#0@@7|) (or (< (DtRank |$ih#b0#0|) (DtRank |b#9@@0|)) (and (= (DtRank |$ih#b0#0|) (DtRank |b#9@@0|)) (or (< (DtRank |$ih#c0#0|) (DtRank |c#1|)) (and (= (DtRank |$ih#c0#0|) (DtRank |c#1|)) (or (< (DtRank |$ih#c'0#0|) (DtRank |c'#1|)) (and (= (DtRank |$ih#c'0#0|) (DtRank |c'#1|)) (or (and (|Set#Subset| (|Map#Domain| |$ih#s0#0|) (|Map#Domain| |s#2|)) (not (|Set#Subset| (|Map#Domain| |s#2|) (|Map#Domain| |$ih#s0#0|)))) (and (|Set#Equal| (|Map#Domain| |$ih#s0#0|) (|Map#Domain| |s#2|)) (and (|Set#Subset| (|Map#Domain| |$ih#t0#0|) (|Map#Domain| |t#2|)) (not (|Set#Subset| (|Map#Domain| |t#2|) (|Map#Domain| |$ih#t0#0|))))))))))))))) (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |$ih#b0#0| |$ih#c'0#0|) |$ih#s0#0| |$ih#t0#0|))
 :qid |NipkowKleinchapter7dfy.113:13|
 :skolemid |913|
 :pattern ( (_module.__default.equiv__c |$ih#c0#0| |$ih#c'0#0|) (_module.__default.big__step_h ($LS $LZ) |$ih#_k0#0| (|#_module.com.While| |$ih#b0#0| |$ih#c0#0|) |$ih#s0#0| |$ih#t0#0|))
))))) (and (=> (= (ControlFlow 0 9) 7) anon3_Then_correct) (=> (= (ControlFlow 0 9) 8) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and (and ($Is DatatypeTypeType |b#9@@0| Tclass._module.bexp) ($IsAlloc DatatypeTypeType |b#9@@0| Tclass._module.bexp $Heap)) (|$IsA#_module.bexp| |b#9@@0|)) (and (and ($Is DatatypeTypeType |c#1| Tclass._module.com) ($IsAlloc DatatypeTypeType |c#1| Tclass._module.com $Heap)) (|$IsA#_module.com| |c#1|))) (and (and (and ($Is DatatypeTypeType |c'#1| Tclass._module.com) ($IsAlloc DatatypeTypeType |c'#1| Tclass._module.com $Heap)) (|$IsA#_module.com| |c'#1|)) (and ($Is MapType |s#2| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |s#2| (TMap (TSeq TChar) TInt) $Heap)))) (and (and (and (and ($Is MapType |t#2| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |t#2| (TMap (TSeq TChar) TInt) $Heap)) (= 7 $FunctionContextHeight)) (and (|_module.__default.big__step_h#canCall| |_k#0@@7| (|#_module.com.While| |b#9@@0| |c#1|) |s#2| |t#2|) (and (_module.__default.big__step_h ($LS $LZ) |_k#0@@7| (|#_module.com.While| |b#9@@0| |c#1|) |s#2| |t#2|) (and (=> (< 0 (|ORD#Offset| |_k#0@@7|)) (ite (_module.com.SKIP_q (|#_module.com.While| |b#9@@0| |c#1|)) (|Map#Equal| |s#2| |t#2|) (ite (_module.com.Assign_q (|#_module.com.While| |b#9@@0| |c#1|)) (let ((|a#9@@0| (_module.com._h1 (|#_module.com.While| |b#9@@0| |c#1|))))
(let ((|x#9| (_module.com._h0 (|#_module.com.While| |b#9@@0| |c#1|))))
(|Map#Equal| |t#2| (|Map#Build| |s#2| ($Box SeqType |x#9|) ($Box intType (int_2_U (_module.__default.aval ($LS $LZ) |a#9@@0| |s#2|))))))) (ite (_module.com.Seq_q (|#_module.com.While| |b#9@@0| |c#1|)) (let ((|c1#9@@0| (_module.com._h3 (|#_module.com.While| |b#9@@0| |c#1|))))
(let ((|c0#9@@0| (_module.com._h2 (|#_module.com.While| |b#9@@0| |c#1|))))
(exists ((|s'#18@@0| T@U) ) (!  (and ($Is MapType |s'#18@@0| (TMap (TSeq TChar) TInt)) (and (_module.__default.big__step_h ($LS $LZ) (|ORD#Minus| |_k#0@@7| (|ORD#FromNat| 1)) |c0#9@@0| |s#2| |s'#18@@0|) (_module.__default.big__step_h ($LS $LZ) (|ORD#Minus| |_k#0@@7| (|ORD#FromNat| 1)) |c1#9@@0| |s'#18@@0| |t#2|)))
 :qid |NipkowKleinchapter7dfy.48:12|
 :skolemid |902|
 :pattern ( (_module.__default.big__step_h ($LS $LZ) (|ORD#Minus| |_k#0@@7| (|ORD#FromNat| 1)) |c1#9@@0| |s'#18@@0| |t#2|))
 :pattern ( (_module.__default.big__step_h ($LS $LZ) (|ORD#Minus| |_k#0@@7| (|ORD#FromNat| 1)) |c0#9@@0| |s#2| |s'#18@@0|))
)))) (ite (_module.com.If_q (|#_module.com.While| |b#9@@0| |c#1|)) (let ((|els#9@@0| (_module.com._h6 (|#_module.com.While| |b#9@@0| |c#1|))))
(let ((|thn#9@@0| (_module.com._h5 (|#_module.com.While| |b#9@@0| |c#1|))))
(let ((|b#20@@0| (_module.com._h4 (|#_module.com.While| |b#9@@0| |c#1|))))
(_module.__default.big__step_h ($LS $LZ) (|ORD#Minus| |_k#0@@7| (|ORD#FromNat| 1)) (ite (_module.__default.bval ($LS $LZ) |b#20@@0| |s#2|) |thn#9@@0| |els#9@@0|) |s#2| |t#2|)))) (let ((|body#9@@0| (_module.com._h8 (|#_module.com.While| |b#9@@0| |c#1|))))
(let ((|b#21@@0| (_module.com._h7 (|#_module.com.While| |b#9@@0| |c#1|))))
 (or (and (not (_module.__default.bval ($LS $LZ) |b#21@@0| |s#2|)) (|Map#Equal| |s#2| |t#2|)) (and (_module.__default.bval ($LS $LZ) |b#21@@0| |s#2|) (exists ((|s'#19@@0| T@U) ) (!  (and ($Is MapType |s'#19@@0| (TMap (TSeq TChar) TInt)) (and (_module.__default.big__step_h ($LS $LZ) (|ORD#Minus| |_k#0@@7| (|ORD#FromNat| 1)) |body#9@@0| |s#2| |s'#19@@0|) (_module.__default.big__step_h ($LS $LZ) (|ORD#Minus| |_k#0@@7| (|ORD#FromNat| 1)) (|#_module.com.While| |b#21@@0| |body#9@@0|) |s'#19@@0| |t#2|)))
 :qid |NipkowKleinchapter7dfy.55:27|
 :skolemid |903|
 :pattern ( (_module.__default.big__step_h ($LS $LZ) (|ORD#Minus| |_k#0@@7| (|ORD#FromNat| 1)) (|#_module.com.While| |b#21@@0| |body#9@@0|) |s'#19@@0| |t#2|))
 :pattern ( (_module.__default.big__step_h ($LS $LZ) (|ORD#Minus| |_k#0@@7| (|ORD#FromNat| 1)) |body#9@@0| |s#2| |s'#19@@0|))
))))))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@7|)) (exists ((|_k'#1@@1| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#1@@1| |_k#0@@7|) (_module.__default.big__step_h ($LS $LZ) |_k'#1@@1| (|#_module.com.While| |b#9@@0| |c#1|) |s#2| |t#2|))
 :qid |NipkowKleinchapter7dfy.40:17|
 :skolemid |904|
 :pattern ( (_module.__default.big__step_h ($LS $LZ) |_k'#1@@1| (|#_module.com.While| |b#9@@0| |c#1|) |s#2| |t#2|))
))))))) (and (and (|_module.__default.equiv__c#canCall| |c#1| |c'#1|) (and (_module.__default.equiv__c |c#1| |c'#1|) (forall ((|s#4| T@U) (|t#4| T@U) ) (!  (=> (and ($Is MapType |s#4| (TMap (TSeq TChar) TInt)) ($Is MapType |t#4| (TMap (TSeq TChar) TInt))) (= (_module.__default.big__step ($LS $LZ) |c#1| |s#4| |t#4|) (_module.__default.big__step ($LS $LZ) |c'#1| |s#4| |t#4|)))
 :qid |NipkowKleinchapter7dfy.84:10|
 :skolemid |907|
 :pattern ( (_module.__default.big__step ($LS $LZ) |c'#1| |s#4| |t#4|))
 :pattern ( (_module.__default.big__step ($LS $LZ) |c#1| |s#4| |t#4|))
)))) (= (ControlFlow 0 10) 9)))) anon0_correct))))
