...
(set-info :boogie-vc-id CheckWellFormed$$M3.UnionFind.ExtendedReach_k)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsAlloc MapType |C#0@@5| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap) (|M3.__default.GoodCMap#canCall| |C#0@@5|)) (and (M3.__default.GoodCMap |C#0@@5|) ($IsAlloc MapType |C'#0| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap))) (and (and (|M3.__default.GoodCMap#canCall| |C'#0|) (M3.__default.GoodCMap |C'#0|)) (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r1#0|))))) (and (=> (= (ControlFlow 0 2) (- 0 20)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|)) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 19)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r1#0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r1#0|)) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 18)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|)) (and (=> (= (ControlFlow 0 2) (- 0 17)) (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|))))) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r1#0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r1#0|)) (and (=> (= (ControlFlow 0 2) (- 0 15)) (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|))))) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|)))) (=> (and (= (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|)))) (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|))))) (or (not (= |r0#0| |r1#0|)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r1#0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r1#0|)) (and (=> (= (ControlFlow 0 2) (- 0 13)) (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|))))) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 12)) ($Is intType (int_2_U (+ (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|)))) 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|)))) 1)) Tclass._System.nat) (=> (|Map#Equal| |C'#0| (|Map#Build| (|Map#Build| |C#0@@5| ($Box refType |r0#0|) ($Box DatatypeTypeType (|#M3.Contents.Link| |r1#0|))) ($Box refType |r1#0|) ($Box DatatypeTypeType (|#M3.Contents.Root| (+ (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|)))) 1))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|)) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|)) (and (=> (= (ControlFlow 0 2) (- 0 9)) (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|))))) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|)))) (=> (<= |d0#0| (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r1#0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r1#0|)) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |r1#0|))) (=> (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |r1#0|)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |r1#0|))))) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |r1#0|)))) (=> (and (and (and (<= |d1#0| (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |r1#0|))))) (< |d0#0| |d1#0|)) (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|)) ($IsAllocBox ($Box refType this@@3) Tclass.M3.UnionFind? $Heap))) (and (and ($IsAlloc intType (int_2_U |d0#0|) Tclass._System.nat $Heap) ($IsAlloc refType |e#0@@3| Tclass.M3.Element $Heap)) (and ($IsAlloc refType |r0#0| Tclass.M3.Element $Heap) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|M3.__default.GoodCMap#canCall| |C#0@@5|) (or (M3.__default.GoodCMap |C#0@@5|) (forall ((|f#0@@0| T@U) ) (!  (=> ($Is refType |f#0@@0| Tclass.M3.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |f#0@@0|)) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#0@@0|))))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#0@@0|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |3075|
