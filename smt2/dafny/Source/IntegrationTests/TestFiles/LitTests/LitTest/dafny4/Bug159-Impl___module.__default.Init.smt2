...
(set-info :boogie-vc-id Impl$$_module.__default.Init)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon6_correct  (=> (and (and (<= (LitInt 0) |i#0_0@0|) (< |i#0_0@0| (_System.array2.Length0 |m#0|))) (and (<= (LitInt 0) |j#0_0@0|) (< |j#0_0@0| (_System.array2.Length1 |m#0|)))) (and (=> (= (ControlFlow 0 5) (- 0 9)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 8)) (and (<= 0 |i#0_0@0|) (< |i#0_0@0| (_System.array2.Length0 |m#0|)))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (and (<= 0 |j#0_0@0|) (< |j#0_0@0| (_System.array2.Length1 |m#0|)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |m#0| (MultiIndexField (IndexField |i#0_0@0|) |j#0_0@0|)))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |m#0| (MultiIndexField (IndexField |i#0_0@0|) |j#0_0@0|))) (=> (and (and (and (<= (LitInt 0) |i#0_1@0|) (< |i#0_1@0| (_System.array2.Length0 |m#0|))) (and (<= (LitInt 0) |j#0_1@0|) (< |j#0_1@0| (_System.array2.Length1 |m#0|)))) (and (not (and (= |i#0_0@0| |i#0_1@0|) (= |j#0_0@0| |j#0_1@0|))) (= (ControlFlow 0 5) (- 0 4)))) (or (or (or (not (= |m#0| |m#0|)) (not true)) (or (not (= (MultiIndexField (IndexField |i#0_0@0|) |j#0_0@0|) (MultiIndexField (IndexField |i#0_1@0|) |j#0_1@0|))) (not true))) (= (LitInt 0) (LitInt 0)))))))))))))
(let ((anon11_Else_correct  (=> (and (< |j#0_0@0| (LitInt 0)) (= (ControlFlow 0 13) 5)) anon6_correct)))
(let ((anon11_Then_correct  (=> (<= (LitInt 0) |j#0_0@0|) (and (=> (= (ControlFlow 0 11) (- 0 12)) (or (not (= |m#0| null)) (not true))) (=> (= (ControlFlow 0 11) 5) anon6_correct)))))
(let ((anon10_Then_correct  (=> (and (<= (LitInt 0) |i#0_0@0|) (< |i#0_0@0| (_System.array2.Length0 |m#0|))) (and (=> (= (ControlFlow 0 14) 11) anon11_Then_correct) (=> (= (ControlFlow 0 14) 13) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#0_0@0|) (< |i#0_0@0| (_System.array2.Length0 |m#0|)))) (= (ControlFlow 0 10) 5)) anon6_correct)))
(let ((anon9_Else_correct  (=> (< |i#0_0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 17) 14) anon10_Then_correct) (=> (= (ControlFlow 0 17) 10) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> (<= (LitInt 0) |i#0_0@0|) (and (=> (= (ControlFlow 0 15) (- 0 16)) (or (not (= |m#0| null)) (not true))) (and (=> (= (ControlFlow 0 15) 14) anon10_Then_correct) (=> (= (ControlFlow 0 15) 10) anon10_Else_correct))))))
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 18) 15) anon9_Then_correct) (=> (= (ControlFlow 0 18) 17) anon9_Else_correct))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|i#1| Int) (|j#1| Int) ) (!  (=> (and (and (<= (LitInt 0) |i#1|) (< |i#1| (_System.array2.Length0 |m#0|))) (and (<= (LitInt 0) |j#1|) (< |j#1| (_System.array2.Length1 |m#0|)))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |m#0|) (MultiIndexField (IndexField |i#1|) |j#1|)))) (LitInt 0)))
 :qid |Bug159dfy.16:18|
 :skolemid |633|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |m#0|) (MultiIndexField (IndexField |i#1|) |j#1|))))
)))))
(let ((anon8_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) ($HeapSucc $Heap $Heap@0)) (and (and (forall (($o@@8 T@U) ($f@@0 T@U) ) (!  (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@8) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@8) $f@@0)) (exists ((|i#0_2| Int) (|j#0_2| Int) ) (!  (and (and (and (and (<= (LitInt 0) |i#0_2|) (< |i#0_2| (_System.array2.Length0 |m#0|))) (and (<= (LitInt 0) |j#0_2|) (< |j#0_2| (_System.array2.Length1 |m#0|)))) (= $o@@8 |m#0|)) (= $f@@0 (MultiIndexField (IndexField |i#0_2|) |j#0_2|)))
 :qid |Bug159dfy.18:10|
 :skolemid |635|
)))
 :qid |Bug159dfy.18:3|
...
)) (forall ((|i#0_2@@0| Int) (|j#0_2@@0| Int) ) (!  (=> (and (and (<= (LitInt 0) |i#0_2@@0|) (< |i#0_2@@0| (_System.array2.Length0 |m#0|))) (and (<= (LitInt 0) |j#0_2@@0|) (< |j#0_2@@0| (_System.array2.Length1 |m#0|)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |m#0|) (MultiIndexField (IndexField |i#0_2@@0|) |j#0_2@@0|)) ($Box intType (int_2_U (LitInt 0)))))
 :qid |Bug159dfy.18:10|
 :skolemid |637|
))) (and (= $Heap@1 $Heap@0) (= (ControlFlow 0 3) 2)))) GeneratedUnifiedExit_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#2| null $Heap alloc |m#0|)) (and (=> (= (ControlFlow 0 19) 18) anon8_Then_correct) (=> (= (ControlFlow 0 19) 3) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |m#0| (Tclass._System.array2 TInt)) ($IsAlloc refType |m#0| (Tclass._System.array2 TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 20) 19))) anon0_correct))))
