...
(declare-fun _module.__default.asimp__const (T@U T@U) T@U)
(declare-fun |_module.__default.asimp__const#canCall| (T@U) Bool)
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@0 T@U) (|a#0@@0| T@U) ) (!  (=> (or (|_module.__default.asimp__const#canCall| |a#0@@0|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |a#0@@0| Tclass._module.aexp))) (and (=> (not (_module.aexp.N_q |a#0@@0|)) (=> (not (_module.aexp.V_q |a#0@@0|)) (let ((|a1#1@@0| (_module.aexp._h2 |a#0@@0|)))
(let ((|a0#1@@0| (_module.aexp._h1 |a#0@@0|)))
 (and (|_module.__default.asimp__const#canCall| |a0#1@@0|) (|_module.__default.asimp__const#canCall| |a1#1@@0|)))))) (= (_module.__default.asimp__const ($LS $ly@@0) |a#0@@0|) (ite (_module.aexp.N_q |a#0@@0|) |a#0@@0| (ite (_module.aexp.V_q |a#0@@0|) |a#0@@0| (let ((|a1#0@@0| (_module.aexp._h2 |a#0@@0|)))
(let ((|a0#0@@0| (_module.aexp._h1 |a#0@@0|)))
(let ((|as1#0| (_module.__default.asimp__const $ly@@0 |a1#0@@0|)))
(let ((|as0#0| (_module.__default.asimp__const $ly@@0 |a0#0@@0|)))
(ite  (and (_module.aexp.N_q |as0#0|) (_module.aexp.N_q |as1#0|)) (|#_module.aexp.N| (+ (_module.aexp.n |as0#0|) (_module.aexp.n |as1#0|))) (|#_module.aexp.Plus| |as0#0| |as1#0|)))))))))))
 :qid |NipkowKleinchapter3dfy.52:16|
 :skolemid |606|
 :pattern ( (_module.__default.asimp__const ($LS $ly@@0) |a#0@@0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@3 T@U) ($Heap@@1 T@U) (|a#0@@3| T@U) (|s#0@@2| T@U) ) (!  (=> (or (|_module.__default.aval#canCall| (Lit DatatypeTypeType |a#0@@3|) |s#0@@2|) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@1) ($Is DatatypeTypeType |a#0@@3| Tclass._module.aexp)) ($Is HandleTypeType |s#0@@2| (Tclass._System.___hTotalFunc1 (TSeq TChar) TInt))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.aexp.N_q (Lit DatatypeTypeType |a#0@@3|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.aexp.V_q (Lit DatatypeTypeType |a#0@@3|)))))) (let ((|a1#3| (Lit DatatypeTypeType (_module.aexp._h2 (Lit DatatypeTypeType |a#0@@3|)))))
(let ((|a0#3| (Lit DatatypeTypeType (_module.aexp._h1 (Lit DatatypeTypeType |a#0@@3|)))))
 (and (|_module.__default.aval#canCall| |a0#3| |s#0@@2|) (|_module.__default.aval#canCall| |a1#3| |s#0@@2|)))))) (= (_module.__default.aval ($LS $ly@@3) (Lit DatatypeTypeType |a#0@@3|) |s#0@@2|) (ite (_module.aexp.N_q (Lit DatatypeTypeType |a#0@@3|)) (let ((|n#2| (LitInt (_module.aexp.n (Lit DatatypeTypeType |a#0@@3|)))))
|n#2|) (ite (_module.aexp.V_q (Lit DatatypeTypeType |a#0@@3|)) (U_2_int (let ((|x#2| (Lit SeqType (_module.aexp._h0 (Lit DatatypeTypeType |a#0@@3|)))))
($Unbox intType (Apply1 (TSeq TChar) TInt $Heap@@1 |s#0@@2| ($Box SeqType |x#2|))))) (let ((|a1#2| (Lit DatatypeTypeType (_module.aexp._h2 (Lit DatatypeTypeType |a#0@@3|)))))
(let ((|a0#2| (Lit DatatypeTypeType (_module.aexp._h1 (Lit DatatypeTypeType |a#0@@3|)))))
(+ (_module.__default.aval ($LS $ly@@3) |a0#2| |s#0@@2|) (_module.__default.aval ($LS $ly@@3) |a1#2| |s#0@@2|)))))))))
 :qid |NipkowKleinchapter3dfy.26:16|
 :weight 3
 :skolemid |598|
 :pattern ( (_module.__default.aval ($LS $ly@@3) (Lit DatatypeTypeType |a#0@@3|) |s#0@@2|) ($IsGoodHeap $Heap@@1))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@4 T@U) (|a#0@@4| T@U) ) (!  (=> (or (|_module.__default.asimp__const#canCall| |a#0@@4|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |a#0@@4| Tclass._module.aexp))) ($Is DatatypeTypeType (_module.__default.asimp__const $ly@@4 |a#0@@4|) Tclass._module.aexp))
 :qid |NipkowKleinchapter3dfy.52:16|
 :skolemid |604|
 :pattern ( (_module.__default.asimp__const $ly@@4 |a#0@@4|))
))))
...
(assert (forall (($ly@@5 T@U) (|a#0@@5| T@U) ) (! (= (_module.__default.asimp__const ($LS $ly@@5) |a#0@@5|) (_module.__default.asimp__const $ly@@5 |a#0@@5|))
 :qid |NipkowKleinchapter3dfy.52:16|
 :skolemid |602|
 :pattern ( (_module.__default.asimp__const ($LS $ly@@5) |a#0@@5|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@6 T@U) (|a#0@@6| T@U) ) (!  (=> (or (|_module.__default.asimp__const#canCall| (Lit DatatypeTypeType |a#0@@6|)) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |a#0@@6| Tclass._module.aexp))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.aexp.N_q (Lit DatatypeTypeType |a#0@@6|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.aexp.V_q (Lit DatatypeTypeType |a#0@@6|)))))) (let ((|a1#3@@0| (Lit DatatypeTypeType (_module.aexp._h2 (Lit DatatypeTypeType |a#0@@6|)))))
(let ((|a0#3@@0| (Lit DatatypeTypeType (_module.aexp._h1 (Lit DatatypeTypeType |a#0@@6|)))))
 (and (|_module.__default.asimp__const#canCall| |a0#3@@0|) (|_module.__default.asimp__const#canCall| |a1#3@@0|)))))) (= (_module.__default.asimp__const ($LS $ly@@6) (Lit DatatypeTypeType |a#0@@6|)) (ite (_module.aexp.N_q (Lit DatatypeTypeType |a#0@@6|)) (Lit DatatypeTypeType |a#0@@6|) (ite (_module.aexp.V_q (Lit DatatypeTypeType |a#0@@6|)) (Lit DatatypeTypeType |a#0@@6|) (let ((|a1#2@@0| (Lit DatatypeTypeType (_module.aexp._h2 (Lit DatatypeTypeType |a#0@@6|)))))
(let ((|a0#2@@0| (Lit DatatypeTypeType (_module.aexp._h1 (Lit DatatypeTypeType |a#0@@6|)))))
(let ((|as1#2| (Lit DatatypeTypeType (_module.__default.asimp__const ($LS $ly@@6) |a1#2@@0|))))
(let ((|as0#2| (Lit DatatypeTypeType (_module.__default.asimp__const ($LS $ly@@6) |a0#2@@0|))))
(ite  (and (_module.aexp.N_q |as0#2|) (_module.aexp.N_q |as1#2|)) (|#_module.aexp.N| (+ (_module.aexp.n |as0#2|) (_module.aexp.n |as1#2|))) (|#_module.aexp.Plus| |as0#2| |as1#2|)))))))))))
 :qid |NipkowKleinchapter3dfy.52:16|
 :weight 3
 :skolemid |607|
 :pattern ( (_module.__default.asimp__const ($LS $ly@@6) (Lit DatatypeTypeType |a#0@@6|)))
))))
...
(declare-fun $Heap@@2 () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.AsimpConst)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (= (_module.__default.aval ($LS ($LS $LZ)) (_module.__default.asimp__const ($LS ($LS $LZ)) |a#0@@7|) |s#0@@3|) (_module.__default.aval ($LS ($LS $LZ)) |a#0@@7| |s#0@@3|)))))
(let ((anon3_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (= $Heap@0 $Heap@2)) (and (forall ((|a'#0_1| T@U) ) (!  (=> (and ($Is DatatypeTypeType |a'#0_1| Tclass._module.aexp) (< (DtRank |a'#0_1|) (DtRank |a#0@@7|))) (= (_module.__default.aval ($LS $LZ) (_module.__default.asimp__const ($LS $LZ) |a'#0_1|) |s#0@@3|) (_module.__default.aval ($LS $LZ) |a'#0_1| |s#0@@3|)))
 :qid |NipkowKleinchapter3dfy.69:10|
 :skolemid |612|
 :pattern ( (_module.__default.asimp__const ($LS $LZ) |a'#0_1|))
