...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Init)
...
(let ((anon6_correct  (=> (and (<= (LitInt 0) |j#0@0|) (< |j#0@0| (_System.array2.Length1 |m#0|))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array2.Length0 |m#0|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array2.Length0 |m#0|))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 |j#0@0|) (< |j#0@0| (_System.array2.Length1 |m#0|)))) (=> (and (<= 0 |j#0@0|) (< |j#0@0| (_System.array2.Length1 |m#0|))) (=> (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |m#0|) (MultiIndexField (IndexField |i#0@0|) |j#0@0|)))) (LitInt 0)) (= (ControlFlow 0 3) 1)) anon8_correct))))))))))
(let ((anon11_Else_correct  (=> (and (< |j#0@0| (LitInt 0)) (= (ControlFlow 0 9) 3)) anon6_correct)))
(let ((anon11_Then_correct  (=> (<= (LitInt 0) |j#0@0|) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (=> (= (ControlFlow 0 7) 3) anon6_correct))))))
(let ((anon4_correct  (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (_System.array2.Length0 |m#0|))) (and (=> (= (ControlFlow 0 10) 7) anon11_Then_correct) (=> (= (ControlFlow 0 10) 9) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (< |i#0@0| (LitInt 0)) (= (ControlFlow 0 13) 10)) anon4_correct)))
(let ((anon10_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 11) (- 0 12)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (=> (= (ControlFlow 0 11) 10) anon4_correct))))))
(let ((anon9_Else_correct  (=> (and (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (_System.array2.Length0 |m#0|))) (and (<= (LitInt 0) |j#0@0|) (< |j#0@0| (_System.array2.Length1 |m#0|)))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |m#0|) (MultiIndexField (IndexField |i#0@0|) |j#0@0|)))) (LitInt 0))) (= (ControlFlow 0 2) 1)) anon8_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#2| null $Heap alloc |m#0|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@8 T@U) ) (!  (=> (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@8) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@8) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@8)) (= $o@@8 |m#0|)))
 :qid |Bug159dfy.14:8|
 :skolemid |629|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@8))
)) ($HeapSucc $Heap $Heap@0))) (and (and (=> (= (ControlFlow 0 14) 2) anon9_Else_correct) (=> (= (ControlFlow 0 14) 11) anon10_Then_correct)) (=> (= (ControlFlow 0 14) 13) anon10_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |m#0| (Tclass._System.array2 TInt)) ($IsAlloc refType |m#0| (Tclass._System.array2 TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 15) 14))) anon0_correct))))
