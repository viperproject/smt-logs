...
(assert (forall ((m@@13 T@U) (|m'@@0| T@U) ) (! (= (|IMap#Equal| m@@13 |m'@@0|)  (and (forall ((u@@4 T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| m@@13) u@@4)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m'@@0|) u@@4)))
 :qid |DafnyPreludebpl.1606:36|
 :skolemid |321|
)) (forall ((u@@5 T@U) ) (!  (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| m@@13) u@@5)) (= (MapType0Select BoxType BoxType (|IMap#Elements| m@@13) u@@5) (MapType0Select BoxType BoxType (|IMap#Elements| |m'@@0|) u@@5)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.idomain)
