...
(declare-fun $Heap@1 () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.GcdSubtractAlt_split21)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (and ($Is intType (int_2_U (LitInt 1)) Tclass._module.pos) (= (Mul |p#0@0| (LitInt 1)) |y#0@@3|)) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._module.pos) (= (Mul |p#0@0| (LitInt 0)) |y#0@@3|)) (exists ((|$as#b0_0#0_0| Int) ) (!  (and (<= (LitInt 1) |$as#b0_0#0_0|) (= (Mul |p#0@0| |$as#b0_0#0_0|) |y#0@@3|))
 :qid |gcddfy.228:9|
 :skolemid |662|
)))))))
