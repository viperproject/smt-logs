...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|a#0@@0| T@U) (|b#0@@0| T@U) ) (!  (=> (or (|_module.__default.Below#canCall| |a#0@@0| |b#0@@0|) (and (< 1 $FunctionContextHeight) (and ($IsBox |a#0@@0| Tclass._module.G) ($IsBox |b#0@@0| Tclass._module.G)))) (and (and (|_module.__default.key#canCall| |a#0@@0|) (|_module.__default.key#canCall| |b#0@@0|)) (= (_module.__default.Below |a#0@@0| |b#0@@0|) (<= (_module.__default.key |a#0@@0|) (_module.__default.key |b#0@@0|)))))
 :qid |GHCMergeSortdfy.75:17|
 :skolemid |639|
 :pattern ( (_module.__default.Below |a#0@@0| |b#0@@0|))
))))
...
(let ((|b#0@@1| (_module.List.head |xs#0@@2|)))
(ite (= (_module.__default.key |g#0@@2|) (_module.__default.key |b#0@@1|)) (|#_module.List.Cons| |b#0@@1| (_module.__default.filter $ly@@2 |g#0@@2| |ys#0|)) (_module.__default.filter $ly@@2 |g#0@@2| |ys#0|))))))))
 :qid |GHCMergeSortdfy.160:16|
 :skolemid |728|
...
(set-info :boogie-vc-id Impl$$_module.__default.filter__Cons__notBelow)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.List| |ys#0@@0|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (forall ((|$ih#ys0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#ys0#0| (Tclass._module.List Tclass._module.G)) (not (_module.__default.Below |a#0@@1| |b#0@@2|))) (< (DtRank |$ih#ys0#0|) (DtRank |ys#0@@0|))) (|_module.List#Equal| (_module.__default.filter ($LS $LZ) |g#0@@4| (|#_module.List.Cons| |b#0@@2| (|#_module.List.Cons| |a#0@@1| |$ih#ys0#0|))) (_module.__default.filter ($LS $LZ) |g#0@@4| (|#_module.List.Cons| |a#0@@1| (|#_module.List.Cons| |b#0@@2| |$ih#ys0#0|)))))
 :qid |GHCMergeSortdfy.675:46|
 :skolemid |1085|
 :pattern ( (|#_module.List.Cons| |a#0@@1| (|#_module.List.Cons| |b#0@@2| |$ih#ys0#0|)))
 :pattern ( (|#_module.List.Cons| |b#0@@2| (|#_module.List.Cons| |a#0@@1| |$ih#ys0#0|)))
)) (= (ControlFlow 0 2) (- 0 1)))) (|_module.List#Equal| (_module.__default.filter ($LS ($LS $LZ)) |g#0@@4| (|#_module.List.Cons| |b#0@@2| (|#_module.List.Cons| |a#0@@1| |ys#0@@0|))) (_module.__default.filter ($LS ($LS $LZ)) |g#0@@4| (|#_module.List.Cons| |a#0@@1| (|#_module.List.Cons| |b#0@@2| |ys#0@@0|))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($IsBox |g#0@@4| Tclass._module.G) ($IsAllocBox |g#0@@4| Tclass._module.G $Heap))) (and (and ($IsBox |b#0@@2| Tclass._module.G) ($IsAllocBox |b#0@@2| Tclass._module.G $Heap)) (and ($IsBox |a#0@@1| Tclass._module.G) ($IsAllocBox |a#0@@1| Tclass._module.G $Heap)))) (=> (and (and (and (and ($Is DatatypeTypeType |ys#0@@0| (Tclass._module.List Tclass._module.G)) ($IsAlloc DatatypeTypeType |ys#0@@0| (Tclass._module.List Tclass._module.G) $Heap)) (|$IsA#_module.List| |ys#0@@0|)) (= 2 $FunctionContextHeight)) (and (not (_module.__default.Below |a#0@@1| |b#0@@2|)) (= (ControlFlow 0 3) 2))) anon0_correct))))
