...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.reverse$_T0 T@U) ($ly T@U) (|xs#0| T@U) (|acc#0| T@U) ) (!  (=> (or (|_module.__default.reverse#canCall| _module._default.reverse$_T0 |xs#0| |acc#0|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0| (Tclass._module.List _module._default.reverse$_T0)) ($Is DatatypeTypeType |acc#0| (Tclass._module.List _module._default.reverse$_T0))))) (and (=> (not (_module.List.Nil_q |xs#0|)) (let ((|ys#1| (_module.List.tail |xs#0|)))
(let ((|a#1| (_module.List.head |xs#0|)))
(|_module.__default.reverse#canCall| _module._default.reverse$_T0 |ys#1| (|#_module.List.Cons| |a#1| |acc#0|))))) (= (_module.__default.reverse _module._default.reverse$_T0 ($LS $ly) |xs#0| |acc#0|) (ite (_module.List.Nil_q |xs#0|) |acc#0| (let ((|ys#0| (_module.List.tail |xs#0|)))
(let ((|a#0| (_module.List.head |xs#0|)))
(_module.__default.reverse _module._default.reverse$_T0 $ly |ys#0| (|#_module.List.Cons| |a#0| |acc#0|))))))))
 :qid |unknown.0:0|
 :skolemid |596|
 :pattern ( (_module.__default.reverse _module._default.reverse$_T0 ($LS $ly) |xs#0| |acc#0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.reverse$_T0@@0 T@U) ($ly@@0 T@U) (|xs#0@@0| T@U) (|acc#0@@0| T@U) ) (!  (=> (or (|_module.__default.reverse#canCall| _module._default.reverse$_T0@@0 |xs#0@@0| |acc#0@@0|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@0| (Tclass._module.List _module._default.reverse$_T0@@0)) ($Is DatatypeTypeType |acc#0@@0| (Tclass._module.List _module._default.reverse$_T0@@0))))) ($Is DatatypeTypeType (_module.__default.reverse _module._default.reverse$_T0@@0 $ly@@0 |xs#0@@0| |acc#0@@0|) (Tclass._module.List _module._default.reverse$_T0@@0)))
 :qid |unknown.0:0|
 :skolemid |593|
 :pattern ( (_module.__default.reverse _module._default.reverse$_T0@@0 $ly@@0 |xs#0@@0| |acc#0@@0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.reverse$_T0@@1 T@U) ($ly@@1 T@U) (|xs#0@@1| T@U) (|acc#0@@1| T@U) ) (!  (=> (or (|_module.__default.reverse#canCall| _module._default.reverse$_T0@@1 (Lit DatatypeTypeType |xs#0@@1|) (Lit DatatypeTypeType |acc#0@@1|)) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@1| (Tclass._module.List _module._default.reverse$_T0@@1)) ($Is DatatypeTypeType |acc#0@@1| (Tclass._module.List _module._default.reverse$_T0@@1))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@1|)))))) (let ((|ys#3| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@1|)))))
(let ((|a#3| (Lit BoxType (_module.List.head (Lit DatatypeTypeType |xs#0@@1|)))))
(|_module.__default.reverse#canCall| _module._default.reverse$_T0@@1 |ys#3| (|#_module.List.Cons| |a#3| (Lit DatatypeTypeType |acc#0@@1|)))))) (= (_module.__default.reverse _module._default.reverse$_T0@@1 ($LS $ly@@1) (Lit DatatypeTypeType |xs#0@@1|) (Lit DatatypeTypeType |acc#0@@1|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@1|)) |acc#0@@1| (let ((|ys#2| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@1|)))))
(let ((|a#2| (Lit BoxType (_module.List.head (Lit DatatypeTypeType |xs#0@@1|)))))
(Lit DatatypeTypeType (_module.__default.reverse _module._default.reverse$_T0@@1 ($LS $ly@@1) |ys#2| (Lit DatatypeTypeType (|#_module.List.Cons| |a#2| (Lit DatatypeTypeType |acc#0@@1|)))))))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |597|
 :pattern ( (_module.__default.reverse _module._default.reverse$_T0@@1 ($LS $ly@@1) (Lit DatatypeTypeType |xs#0@@1|) (Lit DatatypeTypeType |acc#0@@1|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.reverse$_T0@@2 T@U) ($ly@@2 T@U) (|xs#0@@2| T@U) (|acc#0@@2| T@U) ) (!  (=> (and (or (|_module.__default.reverse#canCall| _module._default.reverse$_T0@@2 |xs#0@@2| |acc#0@@2|) (and (< 1 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |xs#0@@2| (Tclass._module.List _module._default.reverse$_T0@@2)) ($IsAlloc DatatypeTypeType |xs#0@@2| (Tclass._module.List _module._default.reverse$_T0@@2) $Heap)) (and ($Is DatatypeTypeType |acc#0@@2| (Tclass._module.List _module._default.reverse$_T0@@2)) ($IsAlloc DatatypeTypeType |acc#0@@2| (Tclass._module.List _module._default.reverse$_T0@@2) $Heap))))) ($IsGoodHeap $Heap)) ($IsAlloc DatatypeTypeType (_module.__default.reverse _module._default.reverse$_T0@@2 $ly@@2 |xs#0@@2| |acc#0@@2|) (Tclass._module.List _module._default.reverse$_T0@@2) $Heap))
 :qid |GHCMergeSortdfy.24:10|
 :skolemid |594|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.__default.reverse _module._default.reverse$_T0@@2 $ly@@2 |xs#0@@2| |acc#0@@2|) (Tclass._module.List _module._default.reverse$_T0@@2) $Heap))
))))
...
(assert (forall ((_module._default.reverse$_T0@@3 T@U) ($ly@@3 T@U) (|xs#0@@3| T@U) (|acc#0@@3| T@U) ) (! (= (_module.__default.reverse _module._default.reverse$_T0@@3 ($LS $ly@@3) |xs#0@@3| |acc#0@@3|) (_module.__default.reverse _module._default.reverse$_T0@@3 $ly@@3 |xs#0@@3| |acc#0@@3|))
 :qid |unknown.0:0|
 :skolemid |591|
 :pattern ( (_module.__default.reverse _module._default.reverse$_T0@@3 ($LS $ly@@3) |xs#0@@3| |acc#0@@3|))
)))
...
(let ((anon10_Then_correct  (=> (= |xs#0@@4| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) (=> (and (and ($IsBox |_mcc#0#0| _module._default.reverse$_T0@@4) ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List _module._default.reverse$_T0@@4))) (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List _module._default.reverse$_T0@@4)))) (=> (and (and (and (= |ys#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|)) (and ($IsBox |let#1#0#0| _module._default.reverse$_T0@@4) (= |a#Z#0@0| |let#1#0#0|))) (and (and ($IsAlloc DatatypeTypeType |ys#Z#0@0| (Tclass._module.List _module._default.reverse$_T0@@4) $Heap@@0) (= |##acc#0@0| (|#_module.List.Cons| |a#Z#0@0| |acc#0@@4|))) (and ($IsAlloc DatatypeTypeType |##acc#0@0| (Tclass._module.List _module._default.reverse$_T0@@4) $Heap@@0) (= (ControlFlow 0 4) (- 0 3))))) (or (< (DtRank |ys#Z#0@0|) (DtRank |xs#0@@4|)) (and (= (DtRank |ys#Z#0@0|) (DtRank |xs#0@@4|)) (< (DtRank |##acc#0@0|) (DtRank |acc#0@@4|)))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is DatatypeTypeType |xs#0@@4| (Tclass._module.List _module._default.reverse$_T0@@4)) ($Is DatatypeTypeType |acc#0@@4| (Tclass._module.List _module._default.reverse$_T0@@4))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
