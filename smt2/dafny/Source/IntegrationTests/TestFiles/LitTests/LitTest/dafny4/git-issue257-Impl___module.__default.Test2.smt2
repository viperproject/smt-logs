...
)) ($HeapSucc $Heap $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= call1formal@this@0 null)) (not true))) (=> (and (and ($IsAllocBox ($Box refType call1formal@this@0) Tclass.M.C? $Heap@0) (|M.C.f#canCall| call1formal@this@0)) (and (|M.C.f#canCall| call1formal@this@0) (= (ControlFlow 0 2) (- 0 1)))) (= (M.C.f call1formal@this@0) (LitInt 0))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (=> |defass#c#0| (and ($Is refType |c#0@@3| Tclass.M.C) ($IsAlloc refType |c#0@@3| Tclass.M.C $Heap))) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct))))
