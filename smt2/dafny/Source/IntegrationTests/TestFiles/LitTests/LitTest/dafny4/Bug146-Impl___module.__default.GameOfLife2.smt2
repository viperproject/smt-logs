...
(assert (forall (($h0 T@U) ($h1 T@U) (|world#0| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|_module.__default.inhabited2#canCall| $h0 |world#0|) ($Is refType |world#0| (Tclass._System.array2 TBool)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@1 T@U) ($f T@U) ) (!  (=> (and (or (not (= $o@@1 null)) (not true)) (= $o@@1 |world#0|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@1) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@1) $f)))
 :qid |unknown.0:0|
 :skolemid |564|
)) (= (_module.__default.inhabited2 $h0 |world#0|) (_module.__default.inhabited2 $h1 |world#0|))))
...
(set-info :boogie-vc-id Impl$$_module.__default.GameOfLife2)
