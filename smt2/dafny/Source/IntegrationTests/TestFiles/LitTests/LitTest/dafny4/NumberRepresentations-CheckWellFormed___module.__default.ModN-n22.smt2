...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.ModNoop)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_correct  (=> (and (<= (LitInt 0) |a#0|) (< |a#0| |b#0|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= |b#0| 0)) (not true))))))
(let ((anon4_Else_correct  (=> (and (< |a#0| (LitInt 0)) (= (ControlFlow 0 4) 2)) anon3_correct)))
(let ((anon4_Then_correct  (=> (and (<= (LitInt 0) |a#0|) (= (ControlFlow 0 3) 2)) anon3_correct)))
