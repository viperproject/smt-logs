...
(declare-fun _module.__default.F (Int Int) T@U)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0| Int) (|w#0| Int) ) (!  (=> (or (|_module.__default.F#canCall| |x#0| |w#0|) (and (< 0 $FunctionContextHeight) (< |x#0| 100))) ($Is DatatypeTypeType (_module.__default.F |x#0| |w#0|) (Tclass._System.Tuple2 TInt TInt)))
 :qid |Regression8dfy.4:12|
 :skolemid |528|
 :pattern ( (_module.__default.F |x#0| |w#0|))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and ($IsAlloc intType (int_2_U |y#0|) TInt $Heap) ($IsAlloc intType (int_2_U |n#0|) TInt $Heap)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) |n#0|)) (=> (and (and (|_module.__default.G#canCall| |n#0|) (= |##w#0@0| (_module.__default.G |n#0|))) (and ($IsAlloc intType (int_2_U |##w#0@0|) TInt $Heap) (= (ControlFlow 0 2) (- 0 1)))) (< |y#0| 100)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |n#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct)))
