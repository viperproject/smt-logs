...
(declare-fun |q#0@@0| () Int)
(set-info :boogie-vc-id Impl$$_module.__default.GetOtherFactor)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (and ($Is intType (int_2_U (LitInt 1)) Tclass._module.pos) (= (Mul |p#0@@1| (LitInt 1)) |x#0@@2|)) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._module.pos) (= (Mul |p#0@@1| (LitInt 0)) |x#0@@2|)) (exists ((|$as#q0#0| Int) ) (!  (and (<= (LitInt 1) |$as#q0#0|) (= (Mul |p#0@@1| |$as#q0#0|) |x#0@@2|))
 :qid |gcddfy.15:3|
 :skolemid |541|
))))) (=> (or (and ($Is intType (int_2_U (LitInt 1)) Tclass._module.pos) (= (Mul |p#0@@1| (LitInt 1)) |x#0@@2|)) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._module.pos) (= (Mul |p#0@@1| (LitInt 0)) |x#0@@2|)) (exists ((|$as#q0#0@@0| Int) ) (!  (and (<= (LitInt 1) |$as#q0#0@@0|) (= (Mul |p#0@@1| |$as#q0#0@@0|) |x#0@@2|))
 :qid |gcddfy.15:3|
 :skolemid |541|
)))) (=> (<= (LitInt 1) |q#0@0|) (=> (and (= (Mul |p#0@@1| |q#0@0|) |x#0@@2|) (= (ControlFlow 0 2) (- 0 1))) (= (Mul |p#0@@1| |q#0@0|) |x#0@@2|)))))))
