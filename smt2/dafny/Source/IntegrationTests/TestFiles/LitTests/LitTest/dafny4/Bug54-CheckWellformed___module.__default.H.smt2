...
(declare-fun _module.__default.H () Bool)
(declare-fun |_module.__default.H#canCall| () Bool)
...
(assert (forall ((|l#0| T@U) (|$l#2#heap#0| T@U) (|$l#2#x#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#2| |l#0|) |$l#2#heap#0| |$l#2#x#0|)) ($IsBox |$l#2#x#0| |l#0|))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |524|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#2| |l#0|) |$l#2#heap#0| |$l#2#x#0|))
)))
...
(assert (forall ((_module._default.G$X@@0 T@U) ($h0 T@U) ($h1 T@U) (|f#0@@0| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|_module.__default.G#canCall| _module._default.G$X@@0 $h0 |f#0@@0|) ($Is HandleTypeType |f#0@@0| (Tclass._System.___hFunc1 _module._default.G$X@@0 TBool)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@0 T@U) ($f T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (exists ((|_x0#0| T@U) (|_obj#0| T@U) ) (!  (and (and (and ($IsBox |_x0#0| _module._default.G$X@@0) ($Is refType |_obj#0| Tclass._System.object?)) (|Set#IsMember| (Reads1 _module._default.G$X@@0 TBool $h0 |f#0@@0| |_x0#0|) ($Box refType |_obj#0|))) (= ($Box refType $o@@0) ($Box refType |_obj#0|)))
 :qid |Bug54dfy.5:11|
 :skolemid |479|
 :pattern ( (|Set#IsMember| (Reads1 _module._default.G$X@@0 TBool $h0 |f#0@@0| |_x0#0|) ($Box refType |_obj#0|)))
))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h0 $o@@0) $f) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h1 $o@@0) $f)))
 :qid |unknown.0:0|
 :skolemid |480|
)) (= (_module.__default.G _module._default.G$X@@0 $h0 |f#0@@0|) (_module.__default.G _module._default.G$X@@0 $h1 |f#0@@0|))))
 :qid |unknown.0:0|
 :skolemid |481|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (_module.__default.G _module._default.G$X@@0 $h1 |f#0@@0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) ) (!  (=> (or |_module.__default.H#canCall| (and (< 1 $FunctionContextHeight) ($IsGoodHeap $Heap@@0))) (and (|_module.__default.G#canCall| TInt $Heap@@0 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| ($Box boolType (Lit boolType (bool_2_U true)))) (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))) (= _module.__default.H (_module.__default.G TInt $Heap@@0 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| ($Box boolType (Lit boolType (bool_2_U true)))) (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))))))
 :qid |Bug54dfy.11:17|
 :skolemid |497|
 :pattern ( _module.__default.H ($IsGoodHeap $Heap@@0))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@1 T@U) ) (!  (=> (or |_module.__default.H#canCall| (and (< 1 $FunctionContextHeight) ($IsGoodHeap $Heap@@1))) (and (|_module.__default.G#canCall| TInt $Heap@@1 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| ($Box boolType (Lit boolType (bool_2_U true)))) (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))) (= _module.__default.H (_module.__default.G TInt $Heap@@1 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| ($Box boolType (Lit boolType (bool_2_U true)))) (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))))))
 :qid |Bug54dfy.11:17|
 :weight 3
 :skolemid |498|
 :pattern ( _module.__default.H ($IsGoodHeap $Heap@@1))
))))
...
(assert (forall ((|#$T0@@4| T@U) (|#$R@@4| T@U) (bx@@10 T@U) ) (!  (=> ($IsBox bx@@10 (Tclass._System.___hFunc1 |#$T0@@4| |#$R@@4|)) (and (= ($Box HandleTypeType ($Unbox HandleTypeType bx@@10)) bx@@10) ($Is HandleTypeType ($Unbox HandleTypeType bx@@10) (Tclass._System.___hFunc1 |#$T0@@4| |#$R@@4|))))
 :qid |unknown.0:0|
 :skolemid |369|
 :pattern ( ($IsBox bx@@10 (Tclass._System.___hFunc1 |#$T0@@4| |#$R@@4|)))
)))
(assert (forall ((|l#0@@2| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@2 T@U) ($f@@0 T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#21| |l#0@@2| |l#1| |l#2| |l#3|) $o@@2 $f@@0))  (=> (and (or (not (= $o@@2 |l#0@@2|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1| $o@@2) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |528|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#21| |l#0@@2| |l#1| |l#2| |l#3|) $o@@2 $f@@0))
)))
...
(assert (forall ((|l#0@@3| T@U) (|$l#2#heap#0@@0| T@U) (|$l#2#x#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#1| |l#0@@3|) |$l#2#heap#0@@0| |$l#2#x#0@@0|) |l#0@@3|)
 :qid |Bug54dfy.13:16|
 :skolemid |523|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#1| |l#0@@3|) |$l#2#heap#0@@0| |$l#2#x#0@@0|))
)))
(assert (forall ((|l#0@@4| T@U) (|$l#2#heap#0@@1| T@U) (|$l#2#x#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#4| |l#0@@4|) |$l#2#heap#0@@1| |$l#2#x#0@@1|) |l#0@@4|)
 :qid |Bug54dfy.13:5|
 :skolemid |526|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#4| |l#0@@4|) |$l#2#heap#0@@1| |$l#2#x#0@@1|))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.H)
...
(let ((anon10_Else_correct  (=> (and (= |##f#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| ($Box boolType (Lit boolType (bool_2_U true)))) (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))) ($IsAlloc HandleTypeType |##f#0@0| (Tclass._System.___hFunc1 TInt TBool) $Heap@@2)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((|x#1@@0| Int) ) (!  (and (Requires1 TInt TBool $Heap@@2 |##f#0@0| ($Box intType (int_2_U |x#1@@0|))) (U_2_bool ($Unbox boolType (Apply1 TInt TBool $Heap@@2 |##f#0@0| ($Box intType (int_2_U |x#1@@0|))))))
 :qid |Bug54dfy.6:19|
 :skolemid |499|
 :pattern ( ($Unbox boolType (Apply1 TInt TBool $Heap@@2 |##f#0@0| ($Box intType (int_2_U |x#1@@0|)))))
 :pattern ( (Requires1 TInt TBool $Heap@@2 |##f#0@0| ($Box intType (int_2_U |x#1@@0|))))
))) (=> (forall ((|x#1@@1| T@U) ) (!  (and (Requires1 TInt TBool $Heap@@2 |##f#0@0| ($Box intType |x#1@@1|)) (U_2_bool ($Unbox boolType (Apply1 TInt TBool $Heap@@2 |##f#0@0| ($Box intType |x#1@@1|)))))
 :qid |Bug54dfy.6:19|
 :skolemid |500|
 :pattern ( ($Unbox boolType (Apply1 TInt TBool $Heap@@2 |##f#0@0| ($Box intType |x#1@@1|))))
 :pattern ( (Requires1 TInt TBool $Heap@@2 |##f#0@0| ($Box intType |x#1@@1|)))
)) (=> (and (= |b$reqreads#0@0| (forall (($o@@3 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@3 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@2 $o@@3) alloc)))) (exists ((|_x0#0@@0| Int) (|_obj#0@@0| T@U) ) (!  (and (and ($Is refType |_obj#0@@0| Tclass._System.object?) (|Set#IsMember| (Reads1 TInt TBool $Heap@@2 |##f#0@0| ($Box intType (int_2_U |_x0#0@@0|))) ($Box refType |_obj#0@@0|))) (= ($Box refType $o@@3) ($Box refType |_obj#0@@0|)))
 :qid |Bug54dfy.5:11|
 :skolemid |501|
 :pattern ( (|Set#IsMember| (Reads1 TInt TBool $Heap@@2 |##f#0@0| ($Box intType (int_2_U |_x0#0@@0|))) ($Box refType |_obj#0@@0|)))
))) (U_2_bool (MapType0Select refType FieldType boolType $_ReadsFrame@0 $o@@3 $f@@1)))
 :qid |Bug54dfy.13:3|
 :skolemid |502|
))) (|_module.__default.G#canCall| TInt $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| ($Box boolType (Lit boolType (bool_2_U true)))) (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))))) (=> (and (and (= _module.__default.H (_module.__default.G TInt $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| ($Box boolType (Lit boolType (bool_2_U true)))) (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))))) (|_module.__default.G#canCall| TInt $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| ($Box boolType (Lit boolType (bool_2_U true)))) (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))))) (and ($Is boolType (bool_2_U _module.__default.H) TBool) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|)))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#21| null $Heap@@2 alloc false)) (and (and (=> (= (ControlFlow 0 8) 1) anon9_Then_correct) (=> (= (ControlFlow 0 8) 7) anon10_Then_correct)) (=> (= (ControlFlow 0 8) 3) anon10_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct)))
