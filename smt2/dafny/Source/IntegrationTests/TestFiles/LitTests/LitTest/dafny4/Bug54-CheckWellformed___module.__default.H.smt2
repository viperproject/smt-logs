...
))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h0 $o@@0) $f) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h1 $o@@0) $f)))) (= (_module.__default.G _module._default.G$X@@0 $h0 |f#0@@0|) (_module.__default.G _module._default.G$X@@0 $h1 |f#0@@0|))))
