...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|$y#1| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#2| |l#0| |l#1|) |$y#1|))  (and ($IsBox |$y#1| |l#0|) (|Set#IsMember| |l#1| |$y#1|)))
...
(assert (forall ((|l#0@@0| T@U) (|l#1@@0| T@U) (|l#2| T@U) (|l#3| T@U) (|$y#3| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#3| |l#0@@0| |l#1@@0| |l#2| |l#3|) |$y#3|)) (exists ((|x#3| Int) ) (!  (and (|Set#IsMember| |l#0@@0| ($Box intType (int_2_U |x#3|))) (= |$y#3| (MapType0Select BoxType BoxType |l#1@@0| ($Box intType (int_2_U |x#3|)))))
 :qid |gitissue70dfy.15:15|
 :skolemid |488|
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType |l#3| ($Box intType (int_2_U |x#3|)))))
 :pattern ( (|Set#IsMember| |l#2| ($Box intType (int_2_U |x#3|))))
)))
 :qid |gitissue70dfy.15:21|
 :skolemid |496|
 :pattern ( (MapType0Select BoxType boolType (|lambda#3| |l#0@@0| |l#1@@0| |l#2| |l#3|) |$y#3|))
)))
...
(assert (forall ((m@@10 T@U) ) (!  (or (= m@@10 |Map#Empty|) (exists ((k@@0 T@U) (v@@9 T@U) ) (! (|Set#IsMember| (|Map#Items| m@@10) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| k@@0 v@@9)))
...
(set-info :boogie-vc-id Impl$$_module.__default.mapTest)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon6_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (|Set#Equal| (|Set#FromBoogieMap| (|lambda#3| (|Map#Domain| |m#0@0|) (|Map#Elements| |m#0@0|) (|Map#Domain| |m#0@0|) (|Map#Elements| |m#0@0|))) (|Map#Values| |m#0@0|))) (=> (|Set#Equal| (|Set#FromBoogieMap| (|lambda#3| (|Map#Domain| |m#0@0|) (|Map#Elements| |m#0@0|) (|Map#Domain| |m#0@0|) (|Map#Elements| |m#0@0|))) (|Map#Values| |m#0@0|)) (=> (= (ControlFlow 0 4) (- 0 3)) (|Set#IsMember| (|Map#Items| |m#0@0|) ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 4))) ($Box intType (int_2_U (LitInt 5))))))))))))
(let ((anon10_Else_correct  (=> (and (not (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U |x#2@0|)))) (= (ControlFlow 0 8) 4)) anon6_correct)))
(let ((anon10_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U |x#2@0|))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U |x#2@0|)))) (=> (= (ControlFlow 0 6) 4) anon6_correct)))))
...
(let ((anon3_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (|Set#Equal| (|Set#FromBoogieMap| (|lambda#2| TInt (|Map#Domain| |m#0@0|))) (|Map#Domain| |m#0@0|))) (=> (|Set#Equal| (|Set#FromBoogieMap| (|lambda#2| TInt (|Map#Domain| |m#0@0|))) (|Map#Domain| |m#0@0|)) (and (=> (= (ControlFlow 0 10) 9) anon9_Then_correct) (=> (= (ControlFlow 0 10) 2) anon9_Else_correct))))))
(let ((anon8_Else_correct  (=> (and (not (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U |x#0@0|)))) (= (ControlFlow 0 13) 10)) anon3_correct)))
(let ((anon8_Then_correct  (=> (and (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U |x#0@0|))) (= (ControlFlow 0 12) 10)) anon3_correct)))
(let ((anon7_Then_correct  (and (=> (= (ControlFlow 0 14) 12) anon8_Then_correct) (=> (= (ControlFlow 0 14) 13) anon8_Else_correct))))
(let ((anon7_Else_correct true))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |m#0@0| (Lit MapType (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 4))) ($Box intType (int_2_U (LitInt 5)))) ($Box intType (int_2_U (LitInt 6))) ($Box intType (int_2_U (LitInt 7))))))) (and (=> (= (ControlFlow 0 15) 14) anon7_Then_correct) (=> (= (ControlFlow 0 15) 1) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |m#0| (TMap TInt TInt)) ($IsAlloc MapType |m#0| (TMap TInt TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 16) 15))) anon0_correct))))
