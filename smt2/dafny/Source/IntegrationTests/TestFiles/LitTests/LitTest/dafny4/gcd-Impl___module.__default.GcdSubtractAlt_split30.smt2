...
(declare-fun $Heap@1 () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.GcdSubtractAlt_split30)
...
(assert (not
 ...
 :qid |gcddfy.228:9|
 :skolemid |662|
)))) (<= (LitInt 1) |b#0_0@0|)) (=> (and (and (and (= (Mul |p#0@0| |b#0_0@0|) |y#0@@3|) (= |newtype$check#0_0_1_0@0| (Mul |p#0@0| |b#0_0@0|))) (and (<= (LitInt 1) |newtype$check#0_0_1_0@0|) (= |newtype$check#0_0_1_1@0| (Mul |p#0@0| |a#0_0@0|)))) (and (and (<= (LitInt 1) |newtype$check#0_0_1_1@0|) (= |newtype$check#0_0_1_2@0| (- (Mul |p#0@0| |b#0_0@0|) (Mul |p#0@0| |a#0_0@0|)))) (and (<= (LitInt 1) |newtype$check#0_0_1_2@0|) (= (ControlFlow 0 2) (- 0 1))))) (= (- |y#0@@3| |x#0@@10|) (- (Mul |p#0@0| |b#0_0@0|) (Mul |p#0@0| |a#0_0@0|)))))))
