...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|w#0| Int) ) (!  (=> (or (|_module.__default.G#canCall| (LitInt |w#0|)) (< 0 $FunctionContextHeight)) (= (_module.__default.G (LitInt |w#0|)) (let ((|g#1| (LitInt (+ |w#0| |w#0|))))
(LitInt (- |g#1| |w#0|)))))
 :qid |gitissue167dfy.27:12|
 :weight 3
 :skolemid |1112|
 :pattern ( (_module.__default.G (LitInt |w#0|)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|u#0| Int) ) (!  (=> (or (|_module.__default.F#canCall| |u#0|) (and (< 0 $FunctionContextHeight) (< |u#0| 2400))) (= (_module.__default.F |u#0|) |u#0|))
 :qid |gitissue167dfy.21:12|
 :skolemid |1107|
 :pattern ( (_module.__default.F |u#0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|w#0@@0| Int) ) (!  (=> (or (|_module.__default.G#canCall| |w#0@@0|) (< 0 $FunctionContextHeight)) (= (_module.__default.G |w#0@@0|) (let ((|g#0| (+ |w#0@@0| |w#0@@0|)))
(- |g#0| |w#0@@0|))))
 :qid |gitissue167dfy.27:12|
 :skolemid |1111|
 :pattern ( (_module.__default.G |w#0@@0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|u#0@@0| Int) ) (!  (=> (or (|_module.__default.F#canCall| (LitInt |u#0@@0|)) (and (< 0 $FunctionContextHeight) (U_2_bool (Lit boolType (bool_2_U (< |u#0@@0| 2400)))))) (= (_module.__default.F (LitInt |u#0@@0|)) (LitInt |u#0@@0|)))
 :qid |gitissue167dfy.21:12|
 :weight 3
 :skolemid |1108|
 :pattern ( (_module.__default.F (LitInt |u#0@@0|)))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |let#0#0#0| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 117))) ($Box charType (|char#FromInt| 110))) ($Box charType (|char#FromInt| 117))) ($Box charType (|char#FromInt| 115))) ($Box charType (|char#FromInt| 101))) ($Box charType (|char#FromInt| 100))))) ($Is SeqType |let#0#0#0| (TSeq TChar))) (=> (and (and (and (= |y#Z#0@0| |let#0#0#0|) (= |let#1#0#0| (LitInt 10))) (and ($Is intType (int_2_U |let#1#0#0|) TInt) (= |y#Z#1@0| |let#1#0#0|))) (and (and (= |let#1#1#0| (LitInt 20)) ($Is intType (int_2_U |let#1#1#0|) TInt)) (and (= |z#Z#0@0| |let#1#1#0|) ($IsAlloc intType (int_2_U |y#Z#1@0|) TInt $Heap)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< |y#Z#1@0| 2400)) (=> (and (and (< |y#Z#1@0| 2400) (|_module.__default.F#canCall| |y#Z#1@0|)) (and (= |##w#0@0| (_module.__default.F |y#Z#1@0|)) ($IsAlloc intType (int_2_U |##w#0@0|) TInt $Heap))) (=> (and (and (and (|_module.__default.G#canCall| (_module.__default.F |y#Z#1@0|)) (let ((|y#1| (LitInt 10)))
 (and (|_module.__default.F#canCall| |y#1|) (|_module.__default.G#canCall| (_module.__default.F |y#1|))))) (and (= |x#0@0| (let ((|z#0| (LitInt 20)))
(let ((|y#1@@0| (LitInt 10)))
(+ (_module.__default.G (LitInt (_module.__default.F |y#1@@0|))) |z#0|)))) (= |##w#1@0| (LitInt 30)))) (and (and ($IsAlloc intType (int_2_U |##w#1@0|) TInt $Heap) (|_module.__default.G#canCall| (LitInt 30))) (and (|_module.__default.G#canCall| (LitInt 30)) (= (ControlFlow 0 2) (- 0 1))))) (= |x#0@0| (LitInt (_module.__default.G (LitInt 30))))))))))))
