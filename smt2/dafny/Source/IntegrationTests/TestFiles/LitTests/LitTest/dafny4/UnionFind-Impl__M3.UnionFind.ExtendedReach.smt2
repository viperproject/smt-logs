...
(set-info :boogie-vc-id Impl$$M3.UnionFind.ExtendedReach)
...
)))) (and (=> (= (ControlFlow 0 7) (- 0 21)) (=> (|M3.__default.GoodCMap#canCall| |C'#0|) (or (M3.__default.GoodCMap |C'#0|) (forall ((|f#3| T@U) ) (!  (=> ($Is refType |f#3| Tclass.M3.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |f#3|)) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#3|))))) (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#3|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |3155|
...
)))) (and (=> (= (ControlFlow 0 29) (- 0 30)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|)) (and (=> (= (ControlFlow 0 29) 6) anon4_Then_correct) (=> (= (ControlFlow 0 29) 28) anon4_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.M3.UnionFind) ($IsAlloc refType this@@3 Tclass.M3.UnionFind $Heap))) (and ($Is refType |e#0@@3| Tclass.M3.Element) ($IsAlloc refType |e#0@@3| Tclass.M3.Element $Heap))) (=> (and (and (and (and (and ($Is MapType |C#0@@5| (TMap Tclass.M3.Element Tclass.M3.Contents)) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap)) (and (<= (LitInt 0) |d0#0|) (<= (LitInt 0) |d1#0|))) (and (and ($Is refType |r0#0| Tclass.M3.Element) ($IsAlloc refType |r0#0| Tclass.M3.Element $Heap)) (and ($Is refType |r1#0| Tclass.M3.Element) ($IsAlloc refType |r1#0| Tclass.M3.Element $Heap)))) (and (and (and ($Is MapType |C'#0| (TMap Tclass.M3.Element Tclass.M3.Contents)) ($IsAlloc MapType |C'#0| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap)) (= 5 $FunctionContextHeight)) (and (|M3.__default.GoodCMap#canCall| |C#0@@5|) (and (M3.__default.GoodCMap |C#0@@5|) (forall ((|f#4| T@U) ) (!  (=> ($Is refType |f#4| Tclass.M3.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |f#4|)) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#4|))))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#4|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |3158|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#4|))))
)))))) (and (and (and (and (|M3.__default.GoodCMap#canCall| |C'#0|) (and (M3.__default.GoodCMap |C'#0|) (forall ((|f#5| T@U) ) (!  (=> ($Is refType |f#5| Tclass.M3.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |f#5|)) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#5|))))) (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#5|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |3160|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#5|))))
)))) (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r1#0|)))) (and (and (or (not (= |r0#0| |r1#0|)) (not true)) (|Map#Equal| |C'#0| (|Map#Build| |C#0@@5| ($Box refType |r0#0|) ($Box DatatypeTypeType (|#M3.Contents.Link| |r1#0|))))) (and (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|)))) (<= |d0#0| (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|)))))))) (and (and (and (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|)))) (<= |d1#0| (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|)))))) (and (< |d0#0| |d1#0|) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|)))) (and (and (|M3.UnionFind.Reaches#canCall| this@@3 |d0#0| |e#0@@3| |r0#0| |C#0@@5|) (and (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d0#0| |e#0@@3| |r0#0| |C#0@@5|) (ite (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|)))) (= |e#0@@3| |r0#0|) (let ((|next#5@@0| (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|))))))
 (and (or (not (= |d0#0| 0)) (not true)) (M3.UnionFind.Reaches ($LS $LZ) this@@3 (- |d0#0| 1) |next#5@@0| |r0#0| |C#0@@5|)))))) (= (ControlFlow 0 31) 29))))) anon0_correct)))))
