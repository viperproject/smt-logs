...
(set-info :boogie-vc-id Impl$$_module.__default.EqualityOfStrings0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (not (|Seq#Equal| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 97))) (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 98))))))))
