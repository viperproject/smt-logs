...
(declare-fun _module.__default.Reverse (Bool Int) Int)
(declare-fun $Unbox (T@T T@U) T@U)
(declare-fun Apply1 (T@U T@U T@U T@U T@U) T@U)
(declare-fun |_module.__default.Reverse#Handle| (Bool) T@U)
(declare-fun $Box (T@T T@U) T@U)
(declare-fun Requires1 (T@U T@U T@U T@U T@U) Bool)
(declare-fun |_module.__default.Reverse#requires| (Int) Bool)
...
(declare-fun _module.__default.RefineToMapOfSeqNums () Bool)
(declare-fun |_module.__default.RefineToMapOfSeqNums#canCall| () Bool)
(declare-fun |_module.__default.RefineToMap#canCall| (T@U) Bool)
(declare-fun reveal__module._default.Reverse () Bool)
(declare-fun _module.__default.RefineToMap (T@U) Bool)
...
(assert (forall (($reveal Bool) ($heap T@U) (|$fh$0x#0| Int) ) (! (= (_module.__default.Reverse $reveal |$fh$0x#0|) (U_2_int ($Unbox intType (Apply1 TInt TInt $heap (|_module.__default.Reverse#Handle| $reveal) ($Box intType (int_2_U |$fh$0x#0|))))))
 :qid |unknown.0:0|
 :skolemid |487|
 :pattern ( (_module.__default.Reverse $reveal |$fh$0x#0|) ($IsGoodHeap $heap))
)))
...
(assert (forall (($reveal@@0 Bool) ($heap@@0 T@U) (|$fh$0x#0@@0| T@U) ) (! (= (Requires1 TInt TInt $heap@@0 (|_module.__default.Reverse#Handle| $reveal@@0) |$fh$0x#0@@0|) (|_module.__default.Reverse#requires| (U_2_int ($Unbox intType |$fh$0x#0@@0|))))
 :qid |unknown.0:0|
 :skolemid |485|
 :pattern ( (Requires1 TInt TInt $heap@@0 (|_module.__default.Reverse#Handle| $reveal@@0) |$fh$0x#0@@0|))
)))
...
(assert (forall (($reveal@@1 Bool) ($heap@@1 T@U) (|$fh$0x#0@@1| T@U) ) (! (= (Apply1 TInt TInt $heap@@1 (|_module.__default.Reverse#Handle| $reveal@@1) |$fh$0x#0@@1|) ($Box intType (int_2_U (_module.__default.Reverse $reveal@@1 (U_2_int ($Unbox intType |$fh$0x#0@@1|))))))
 :qid |unknown.0:0|
 :skolemid |484|
 :pattern ( (Apply1 TInt TInt $heap@@1 (|_module.__default.Reverse#Handle| $reveal@@1) |$fh$0x#0@@1|))
)))
...
(assert (forall ((|id#0| Int) ) (! (= (|_module.__default.Reverse#requires| |id#0|) true)
 :qid |Bug82dfy.4:34|
 :skolemid |480|
 :pattern ( (|_module.__default.Reverse#requires| |id#0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) ) (!  (=> (or |_module.__default.RefineToMapOfSeqNums#canCall| (and (< 1 $FunctionContextHeight) ($IsGoodHeap $Heap))) (and (|_module.__default.RefineToMap#canCall| (|_module.__default.Reverse#Handle| reveal__module._default.Reverse)) (= _module.__default.RefineToMapOfSeqNums (_module.__default.RefineToMap (|_module.__default.Reverse#Handle| reveal__module._default.Reverse)))))
 :qid |Bug82dfy.8:16|
 :skolemid |488|
 :pattern ( _module.__default.RefineToMapOfSeqNums ($IsGoodHeap $Heap))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) ) (!  (=> (or |_module.__default.RefineToMapOfSeqNums#canCall| (and (< 1 $FunctionContextHeight) ($IsGoodHeap $Heap@@0))) (and (|_module.__default.RefineToMap#canCall| (|_module.__default.Reverse#Handle| reveal__module._default.Reverse)) (= _module.__default.RefineToMapOfSeqNums (_module.__default.RefineToMap (|_module.__default.Reverse#Handle| reveal__module._default.Reverse)))))
 :qid |Bug82dfy.8:16|
 :weight 3
 :skolemid |489|
 :pattern ( _module.__default.RefineToMapOfSeqNums ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall (($bx T@U) ($reveal@@2 Bool) ($heap@@2 T@U) (|$fh$0x#0@@2| T@U) ) (! (= (|Set#IsMember| (Reads1 TInt TInt $heap@@2 (|_module.__default.Reverse#Handle| $reveal@@2) |$fh$0x#0@@2|) $bx) false)
 :qid |unknown.0:0|
 :skolemid |486|
 :pattern ( (|Set#IsMember| (Reads1 TInt TInt $heap@@2 (|_module.__default.Reverse#Handle| $reveal@@2) |$fh$0x#0@@2|) $bx))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.RefineToMapOfSeqNums)
