...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.BinarySearch)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon18_Else_correct true))
(let ((anon18_Then_correct  (=> (and (< |r#0@0| 0) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |a#0| null)) (not true)))))
(let ((anon17_Else_correct  (=> (=> (<= (LitInt 0) |r#0@0|) (and (< |r#0@0| (_System.array.Length |a#0|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField |r#0@0|)))) |key#0|))) (and (=> (= (ControlFlow 0 8) 2) anon18_Then_correct) (=> (= (ControlFlow 0 8) 3) anon18_Else_correct)))))
(let ((anon17_Then_correct  (=> (<= (LitInt 0) |r#0@0|) (and (=> (= (ControlFlow 0 4) (- 0 7)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (< |r#0@0| (_System.array.Length |a#0|)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (and (<= 0 |r#0@0|) (< |r#0@0| (_System.array.Length |a#0|)))) (=> (and (<= 0 |r#0@0|) (< |r#0@0| (_System.array.Length |a#0|))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField |r#0@0|)))) |key#0|) (and (=> (= (ControlFlow 0 4) 2) anon18_Then_correct) (=> (= (ControlFlow 0 4) 3) anon18_Else_correct)))))))))))))
(let ((anon8_correct  (=> (forall ((|i#1| Int) (|j#1| Int) ) (!  (=> (and (and (<= (LitInt 0) |i#1|) (< |i#1| |j#1|)) (< |j#1| (_System.array.Length |a#0|))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#1|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |j#1|))))))
 ...
 :qid |BinarySearchdfy.6:8|
 :skolemid |480|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6))
)) ($HeapSucc $Heap $Heap@0))) (and (=> (= (ControlFlow 0 9) 4) anon17_Then_correct) (=> (= (ControlFlow 0 9) 8) anon17_Else_correct))))))
(let ((anon6_correct  (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |j#0@0|)) (< |j#0@0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 11) (- 0 15)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 11) (- 0 14)) (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array.Length |a#0|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (and (<= 0 |j#0@0|) (< |j#0@0| (_System.array.Length |a#0|)))) (=> (and (<= 0 |j#0@0|) (< |j#0@0| (_System.array.Length |a#0|))) (=> (and (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#0@0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |j#0@0|))))) (= (ControlFlow 0 11) 9)) anon8_correct))))))))))))
(let ((anon16_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |j#0@0|))) (= (ControlFlow 0 18) 11)) anon6_correct)))
(let ((anon16_Then_correct  (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |j#0@0|)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (= (ControlFlow 0 16) 11) anon6_correct))))))
(let ((anon15_Else_correct  (=> (< |i#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 20) 16) anon16_Then_correct) (=> (= (ControlFlow 0 20) 18) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 19) 16) anon16_Then_correct) (=> (= (ControlFlow 0 19) 18) anon16_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |j#0@0|)) (< |j#0@0| (_System.array.Length |a#0|))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#0@0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |j#0@0|)))))) (= (ControlFlow 0 10) 9)) anon8_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 21) 10) anon14_Else_correct) (=> (= (ControlFlow 0 21) 19) anon15_Then_correct)) (=> (= (ControlFlow 0 21) 20) anon15_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 22) 21))) anon0_correct))))
