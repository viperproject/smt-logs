...
(set-info :boogie-vc-id Impl$$_module.__default.M2_k)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |m#0@0| (Lit MapType (|Map#Build| |Map#Empty| ($Box MapType (Lit MapType (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 1))) ($Box intType (int_2_U (LitInt 10)))) ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 20)))))) ($Box intType (int_2_U (LitInt 33))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Map#Equal| (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 1))) ($Box intType (int_2_U (LitInt 10)))) ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 20)))) (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 20)))) ($Box intType (int_2_U (LitInt 1))) ($Box intType (int_2_U (LitInt 10)))))) (=> (|Map#Equal| (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 1))) ($Box intType (int_2_U (LitInt 10)))) ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 20)))) (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 20)))) ($Box intType (int_2_U (LitInt 1))) ($Box intType (int_2_U (LitInt 10))))) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box MapType (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 20)))) ($Box intType (int_2_U (LitInt 1))) ($Box intType (int_2_U (LitInt 10))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |m#0| (TMap (TMap TInt TInt) TInt)) ($IsAlloc MapType |m#0| (TMap (TMap TInt TInt) TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
