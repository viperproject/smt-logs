...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@0 T@U) (|b#0| T@U) (|s#0@@0| T@U) ) (!  (=> (or (|_module.__default.bval#canCall| (Lit DatatypeTypeType |b#0|) (Lit HandleTypeType |s#0@@0|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |b#0| Tclass._module.bexp) ($Is HandleTypeType |s#0@@0| (Tclass._System.___hTotalFunc1 (TSeq TChar) TInt))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.bexp.Bc_q (Lit DatatypeTypeType |b#0|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (_module.bexp.Not_q (Lit DatatypeTypeType |b#0|))))) (let ((|b#6| (Lit DatatypeTypeType (_module.bexp._h3 (Lit DatatypeTypeType |b#0|)))))
(|_module.__default.bval#canCall| |b#6| (Lit HandleTypeType |s#0@@0|)))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.bexp.Not_q (Lit DatatypeTypeType |b#0|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (_module.bexp.And_q (Lit DatatypeTypeType |b#0|))))) (let ((|b1#5| (Lit DatatypeTypeType (_module.bexp._h5 (Lit DatatypeTypeType |b#0|)))))
(let ((|b0#5| (Lit DatatypeTypeType (_module.bexp._h4 (Lit DatatypeTypeType |b#0|)))))
 (and (|_module.__default.bval#canCall| |b0#5| (Lit HandleTypeType |s#0@@0|)) (=> (_module.__default.bval ($LS $ly@@0) |b0#5| (Lit HandleTypeType |s#0@@0|)) (|_module.__default.bval#canCall| |b1#5| (Lit HandleTypeType |s#0@@0|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.bexp.And_q (Lit DatatypeTypeType |b#0|)))))) (let ((|a1#5| (Lit DatatypeTypeType (_module.bexp._h7 (Lit DatatypeTypeType |b#0|)))))
(let ((|a0#5| (Lit DatatypeTypeType (_module.bexp._h6 (Lit DatatypeTypeType |b#0|)))))
 (and (|_module.__default.aval#canCall| |a0#5| (Lit HandleTypeType |s#0@@0|)) (|_module.__default.aval#canCall| |a1#5| (Lit HandleTypeType |s#0@@0|)))))))))) (= (_module.__default.bval ($LS $ly@@0) (Lit DatatypeTypeType |b#0|) (Lit HandleTypeType |s#0@@0|)) (ite (_module.bexp.Bc_q (Lit DatatypeTypeType |b#0|)) (let ((|v#4| (U_2_bool (Lit boolType (bool_2_U (_module.bexp.v (Lit DatatypeTypeType |b#0|)))))))
|v#4|) (ite (_module.bexp.Not_q (Lit DatatypeTypeType |b#0|)) (let ((|b#5| (Lit DatatypeTypeType (_module.bexp._h3 (Lit DatatypeTypeType |b#0|)))))
 (not (U_2_bool (Lit boolType (bool_2_U (_module.__default.bval ($LS $ly@@0) |b#5| (Lit HandleTypeType |s#0@@0|))))))) (ite (_module.bexp.And_q (Lit DatatypeTypeType |b#0|)) (U_2_bool (let ((|b1#4| (Lit DatatypeTypeType (_module.bexp._h5 (Lit DatatypeTypeType |b#0|)))))
(let ((|b0#4| (Lit DatatypeTypeType (_module.bexp._h4 (Lit DatatypeTypeType |b#0|)))))
(Lit boolType (bool_2_U  (and (_module.__default.bval ($LS $ly@@0) |b0#4| (Lit HandleTypeType |s#0@@0|)) (_module.__default.bval ($LS $ly@@0) |b1#4| (Lit HandleTypeType |s#0@@0|)))))))) (U_2_bool (let ((|a1#4| (Lit DatatypeTypeType (_module.bexp._h7 (Lit DatatypeTypeType |b#0|)))))
(let ((|a0#4| (Lit DatatypeTypeType (_module.bexp._h6 (Lit DatatypeTypeType |b#0|)))))
(Lit boolType (bool_2_U (< (_module.__default.aval ($LS $LZ) |a0#4| (Lit HandleTypeType |s#0@@0|)) (_module.__default.aval ($LS $LZ) |a1#4| (Lit HandleTypeType |s#0@@0|))))))))))))))
 ...
 :weight 3
 :skolemid |638|
 :pattern ( (_module.__default.bval ($LS $ly@@0) (Lit DatatypeTypeType |b#0|) (Lit HandleTypeType |s#0@@0|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@2 T@U) ($Heap@@0 T@U) (|a#0@@0| T@U) (|s#0@@2| T@U) ) (!  (=> (or (|_module.__default.aval#canCall| (Lit DatatypeTypeType |a#0@@0|) (Lit HandleTypeType |s#0@@2|)) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) ($Is DatatypeTypeType |a#0@@0| Tclass._module.aexp)) ($Is HandleTypeType |s#0@@2| (Tclass._System.___hTotalFunc1 (TSeq TChar) TInt))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.aexp.N_q (Lit DatatypeTypeType |a#0@@0|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.aexp.V_q (Lit DatatypeTypeType |a#0@@0|)))))) (let ((|a1#5@@0| (Lit DatatypeTypeType (_module.aexp._h2 (Lit DatatypeTypeType |a#0@@0|)))))
(let ((|a0#5@@0| (Lit DatatypeTypeType (_module.aexp._h1 (Lit DatatypeTypeType |a#0@@0|)))))
 (and (|_module.__default.aval#canCall| |a0#5@@0| (Lit HandleTypeType |s#0@@2|)) (|_module.__default.aval#canCall| |a1#5@@0| (Lit HandleTypeType |s#0@@2|))))))) (= (_module.__default.aval ($LS $ly@@2) (Lit DatatypeTypeType |a#0@@0|) (Lit HandleTypeType |s#0@@2|)) (ite (_module.aexp.N_q (Lit DatatypeTypeType |a#0@@0|)) (let ((|n#4| (LitInt (_module.aexp.n (Lit DatatypeTypeType |a#0@@0|)))))
...
($Unbox intType (Apply1 (TSeq TChar) TInt $Heap@@0 (Lit HandleTypeType |s#0@@2|) ($Box SeqType |x#4|))))) (let ((|a1#4@@0| (Lit DatatypeTypeType (_module.aexp._h2 (Lit DatatypeTypeType |a#0@@0|)))))
(let ((|a0#4@@0| (Lit DatatypeTypeType (_module.aexp._h1 (Lit DatatypeTypeType |a#0@@0|)))))
(LitInt (+ (_module.__default.aval ($LS $ly@@2) |a0#4@@0| (Lit HandleTypeType |s#0@@2|)) (_module.__default.aval ($LS $ly@@2) |a1#4@@0| (Lit HandleTypeType |s#0@@2|)))))))))))
 :qid |NipkowKleinchapter3dfy.26:16|
 :weight 3
 :skolemid |599|
 :pattern ( (_module.__default.aval ($LS $ly@@2) (Lit DatatypeTypeType |a#0@@0|) (Lit HandleTypeType |s#0@@2|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall (($ly@@3 T@U) (|a#0@@1| T@U) (|s#0@@3| T@U) ) (! (= (_module.__default.aval ($LS $ly@@3) |a#0@@1| |s#0@@3|) (_module.__default.aval $ly@@3 |a#0@@1| |s#0@@3|))
 :qid |NipkowKleinchapter3dfy.26:16|
 :skolemid |592|
 :pattern ( (_module.__default.aval ($LS $ly@@3) |a#0@@1| |s#0@@3|))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@4 T@U) (|b#0@@1| T@U) (|s#0@@4| T@U) ) (!  (=> (or (|_module.__default.bval#canCall| (Lit DatatypeTypeType |b#0@@1|) |s#0@@4|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |b#0@@1| Tclass._module.bexp) ($Is HandleTypeType |s#0@@4| (Tclass._System.___hTotalFunc1 (TSeq TChar) TInt))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.bexp.Bc_q (Lit DatatypeTypeType |b#0@@1|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (_module.bexp.Not_q (Lit DatatypeTypeType |b#0@@1|))))) (let ((|b#4| (Lit DatatypeTypeType (_module.bexp._h3 (Lit DatatypeTypeType |b#0@@1|)))))
(|_module.__default.bval#canCall| |b#4| |s#0@@4|))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.bexp.Not_q (Lit DatatypeTypeType |b#0@@1|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (_module.bexp.And_q (Lit DatatypeTypeType |b#0@@1|))))) (let ((|b1#3| (Lit DatatypeTypeType (_module.bexp._h5 (Lit DatatypeTypeType |b#0@@1|)))))
(let ((|b0#3| (Lit DatatypeTypeType (_module.bexp._h4 (Lit DatatypeTypeType |b#0@@1|)))))
 (and (|_module.__default.bval#canCall| |b0#3| |s#0@@4|) (=> (_module.__default.bval ($LS $ly@@4) |b0#3| |s#0@@4|) (|_module.__default.bval#canCall| |b1#3| |s#0@@4|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.bexp.And_q (Lit DatatypeTypeType |b#0@@1|)))))) (let ((|a1#3| (Lit DatatypeTypeType (_module.bexp._h7 (Lit DatatypeTypeType |b#0@@1|)))))
(let ((|a0#3| (Lit DatatypeTypeType (_module.bexp._h6 (Lit DatatypeTypeType |b#0@@1|)))))
 (and (|_module.__default.aval#canCall| |a0#3| |s#0@@4|) (|_module.__default.aval#canCall| |a1#3| |s#0@@4|))))))))) (= (_module.__default.bval ($LS $ly@@4) (Lit DatatypeTypeType |b#0@@1|) |s#0@@4|) (ite (_module.bexp.Bc_q (Lit DatatypeTypeType |b#0@@1|)) (let ((|v#2| (U_2_bool (Lit boolType (bool_2_U (_module.bexp.v (Lit DatatypeTypeType |b#0@@1|)))))))
|v#2|) (ite (_module.bexp.Not_q (Lit DatatypeTypeType |b#0@@1|)) (let ((|b#3| (Lit DatatypeTypeType (_module.bexp._h3 (Lit DatatypeTypeType |b#0@@1|)))))
 (not (_module.__default.bval ($LS $ly@@4) |b#3| |s#0@@4|))) (ite (_module.bexp.And_q (Lit DatatypeTypeType |b#0@@1|)) (let ((|b1#2| (Lit DatatypeTypeType (_module.bexp._h5 (Lit DatatypeTypeType |b#0@@1|)))))
(let ((|b0#2| (Lit DatatypeTypeType (_module.bexp._h4 (Lit DatatypeTypeType |b#0@@1|)))))
 (and (_module.__default.bval ($LS $ly@@4) |b0#2| |s#0@@4|) (_module.__default.bval ($LS $ly@@4) |b1#2| |s#0@@4|)))) (let ((|a1#2| (Lit DatatypeTypeType (_module.bexp._h7 (Lit DatatypeTypeType |b#0@@1|)))))
(let ((|a0#2| (Lit DatatypeTypeType (_module.bexp._h6 (Lit DatatypeTypeType |b#0@@1|)))))
(< (_module.__default.aval ($LS $LZ) |a0#2| |s#0@@4|) (_module.__default.aval ($LS $LZ) |a1#2| |s#0@@4|))))))))))
 :qid |NipkowKleinchapter3dfy.128:16|
 :weight 3
 :skolemid |637|
 :pattern ( (_module.__default.bval ($LS $ly@@4) (Lit DatatypeTypeType |b#0@@1|) |s#0@@4|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@5 T@U) (|b#0@@2| T@U) (|s#0@@5| T@U) ) (!  (=> (or (|_module.__default.bval#canCall| |b#0@@2| |s#0@@5|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |b#0@@2| Tclass._module.bexp) ($Is HandleTypeType |s#0@@5| (Tclass._System.___hTotalFunc1 (TSeq TChar) TInt))))) (and (=> (not (_module.bexp.Bc_q |b#0@@2|)) (and (=> (_module.bexp.Not_q |b#0@@2|) (let ((|b#2| (_module.bexp._h3 |b#0@@2|)))
(|_module.__default.bval#canCall| |b#2| |s#0@@5|))) (=> (not (_module.bexp.Not_q |b#0@@2|)) (and (=> (_module.bexp.And_q |b#0@@2|) (let ((|b1#1| (_module.bexp._h5 |b#0@@2|)))
(let ((|b0#1| (_module.bexp._h4 |b#0@@2|)))
 (and (|_module.__default.bval#canCall| |b0#1| |s#0@@5|) (=> (_module.__default.bval $ly@@5 |b0#1| |s#0@@5|) (|_module.__default.bval#canCall| |b1#1| |s#0@@5|)))))) (=> (not (_module.bexp.And_q |b#0@@2|)) (let ((|a1#1@@0| (_module.bexp._h7 |b#0@@2|)))
(let ((|a0#1@@0| (_module.bexp._h6 |b#0@@2|)))
 (and (|_module.__default.aval#canCall| |a0#1@@0| |s#0@@5|) (|_module.__default.aval#canCall| |a1#1@@0| |s#0@@5|))))))))) (= (_module.__default.bval ($LS $ly@@5) |b#0@@2| |s#0@@5|) (ite (_module.bexp.Bc_q |b#0@@2|) (let ((|v#0| (_module.bexp.v |b#0@@2|)))
|v#0|) (ite (_module.bexp.Not_q |b#0@@2|) (let ((|b#1| (_module.bexp._h3 |b#0@@2|)))
 (not (_module.__default.bval $ly@@5 |b#1| |s#0@@5|))) (ite (_module.bexp.And_q |b#0@@2|) (let ((|b1#0| (_module.bexp._h5 |b#0@@2|)))
(let ((|b0#0| (_module.bexp._h4 |b#0@@2|)))
 (and (_module.__default.bval $ly@@5 |b0#0| |s#0@@5|) (_module.__default.bval $ly@@5 |b1#0| |s#0@@5|)))) (let ((|a1#0@@0| (_module.bexp._h7 |b#0@@2|)))
(let ((|a0#0@@0| (_module.bexp._h6 |b#0@@2|)))
(< (_module.__default.aval ($LS $LZ) |a0#0@@0| |s#0@@5|) (_module.__default.aval ($LS $LZ) |a1#0@@0| |s#0@@5|))))))))))
 :qid |NipkowKleinchapter3dfy.128:16|
 :skolemid |636|
 :pattern ( (_module.__default.bval ($LS $ly@@5) |b#0@@2| |s#0@@5|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@6 T@U) ($Heap@@1 T@U) (|a#0@@2| T@U) (|s#0@@6| T@U) ) (!  (=> (or (|_module.__default.aval#canCall| (Lit DatatypeTypeType |a#0@@2|) |s#0@@6|) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@1) ($Is DatatypeTypeType |a#0@@2| Tclass._module.aexp)) ($Is HandleTypeType |s#0@@6| (Tclass._System.___hTotalFunc1 (TSeq TChar) TInt))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.aexp.N_q (Lit DatatypeTypeType |a#0@@2|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.aexp.V_q (Lit DatatypeTypeType |a#0@@2|)))))) (let ((|a1#3@@0| (Lit DatatypeTypeType (_module.aexp._h2 (Lit DatatypeTypeType |a#0@@2|)))))
(let ((|a0#3@@0| (Lit DatatypeTypeType (_module.aexp._h1 (Lit DatatypeTypeType |a#0@@2|)))))
 (and (|_module.__default.aval#canCall| |a0#3@@0| |s#0@@6|) (|_module.__default.aval#canCall| |a1#3@@0| |s#0@@6|)))))) (= (_module.__default.aval ($LS $ly@@6) (Lit DatatypeTypeType |a#0@@2|) |s#0@@6|) (ite (_module.aexp.N_q (Lit DatatypeTypeType |a#0@@2|)) (let ((|n#2| (LitInt (_module.aexp.n (Lit DatatypeTypeType |a#0@@2|)))))
...
($Unbox intType (Apply1 (TSeq TChar) TInt $Heap@@1 |s#0@@6| ($Box SeqType |x#2|))))) (let ((|a1#2@@0| (Lit DatatypeTypeType (_module.aexp._h2 (Lit DatatypeTypeType |a#0@@2|)))))
(let ((|a0#2@@0| (Lit DatatypeTypeType (_module.aexp._h1 (Lit DatatypeTypeType |a#0@@2|)))))
(+ (_module.__default.aval ($LS $ly@@6) |a0#2@@0| |s#0@@6|) (_module.__default.aval ($LS $ly@@6) |a1#2@@0| |s#0@@6|)))))))))
 :qid |NipkowKleinchapter3dfy.26:16|
 :weight 3
 :skolemid |598|
 :pattern ( (_module.__default.aval ($LS $ly@@6) (Lit DatatypeTypeType |a#0@@2|) |s#0@@6|) ($IsGoodHeap $Heap@@1))
))))
...
(assert (forall ((d@@19 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (_module.aexp.Plus_q d@@19) ($IsAlloc DatatypeTypeType d@@19 Tclass._module.aexp $h@@6))) ($IsAlloc DatatypeTypeType (_module.aexp._h1 d@@19) Tclass._module.aexp $h@@6))
 :qid |unknown.0:0|
 :skolemid |752|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.aexp._h1 d@@19) Tclass._module.aexp $h@@6))
)))
(assert (forall ((d@@20 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (_module.aexp.Plus_q d@@20) ($IsAlloc DatatypeTypeType d@@20 Tclass._module.aexp $h@@7))) ($IsAlloc DatatypeTypeType (_module.aexp._h2 d@@20) Tclass._module.aexp $h@@7))
 :qid |unknown.0:0|
 :skolemid |753|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.aexp._h2 d@@20) Tclass._module.aexp $h@@7))
)))
(assert (forall ((d@@21 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (_module.bexp.Not_q d@@21) ($IsAlloc DatatypeTypeType d@@21 Tclass._module.bexp $h@@8))) ($IsAlloc DatatypeTypeType (_module.bexp._h3 d@@21) Tclass._module.bexp $h@@8))
 :qid |unknown.0:0|
 :skolemid |779|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.bexp._h3 d@@21) Tclass._module.bexp $h@@8))
)))
(assert (forall ((d@@22 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) (and (_module.bexp.And_q d@@22) ($IsAlloc DatatypeTypeType d@@22 Tclass._module.bexp $h@@9))) ($IsAlloc DatatypeTypeType (_module.bexp._h4 d@@22) Tclass._module.bexp $h@@9))
 :qid |unknown.0:0|
 :skolemid |788|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.bexp._h4 d@@22) Tclass._module.bexp $h@@9))
)))
(assert (forall ((d@@23 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) (and (_module.bexp.And_q d@@23) ($IsAlloc DatatypeTypeType d@@23 Tclass._module.bexp $h@@10))) ($IsAlloc DatatypeTypeType (_module.bexp._h5 d@@23) Tclass._module.bexp $h@@10))
 :qid |unknown.0:0|
 :skolemid |789|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.bexp._h5 d@@23) Tclass._module.bexp $h@@10))
)))
(assert (forall ((d@@24 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (_module.bexp.Less_q d@@24) ($IsAlloc DatatypeTypeType d@@24 Tclass._module.bexp $h@@11))) ($IsAlloc DatatypeTypeType (_module.bexp._h6 d@@24) Tclass._module.aexp $h@@11))
 :qid |unknown.0:0|
 :skolemid |800|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.bexp._h6 d@@24) Tclass._module.aexp $h@@11))
)))
(assert (forall ((d@@25 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (_module.bexp.Less_q d@@25) ($IsAlloc DatatypeTypeType d@@25 Tclass._module.bexp $h@@12))) ($IsAlloc DatatypeTypeType (_module.bexp._h7 d@@25) Tclass._module.aexp $h@@12))
 :qid |unknown.0:0|
 :skolemid |801|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.bexp._h7 d@@25) Tclass._module.aexp $h@@12))
)))
...
(let ((anon16_Else_correct  (=> (and (not (_module.__default.bval ($LS $LZ) |b0#Z#0@0| |s#0@@7|)) (= (ControlFlow 0 11) 8)) anon8_correct)))
(let ((anon16_Then_correct  (=> (_module.__default.bval ($LS $LZ) |b0#Z#0@0| |s#0@@7|) (=> (and ($IsAlloc DatatypeTypeType |b1#Z#0@0| Tclass._module.bexp $Heap@@2) ($IsAlloc HandleTypeType |s#0@@7| (Tclass._System.___hTotalFunc1 (TSeq TChar) TInt) $Heap@@2)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< (DtRank |b1#Z#0@0|) (DtRank |b#0@@3|))) (=> (< (DtRank |b1#Z#0@0|) (DtRank |b#0@@3|)) (=> (and (|_module.__default.bval#canCall| |b1#Z#0@0| |s#0@@7|) (= (ControlFlow 0 9) 8)) anon8_correct)))))))
(let ((anon15_Then_correct  (=> (= |b#0@@3| (|#_module.bexp.And| |_mcc#2#0| |_mcc#3#0|)) (=> (and ($Is DatatypeTypeType |_mcc#2#0| Tclass._module.bexp) ($Is DatatypeTypeType |_mcc#3#0| Tclass._module.bexp)) (=> (and (and (and (= |let#2#0#0| |_mcc#3#0|) ($Is DatatypeTypeType |let#2#0#0| Tclass._module.bexp)) (and (= |b1#Z#0@0| |let#2#0#0|) (= |let#3#0#0| |_mcc#2#0|))) (and (and ($Is DatatypeTypeType |let#3#0#0| Tclass._module.bexp) (= |b0#Z#0@0| |let#3#0#0|)) (and ($IsAlloc DatatypeTypeType |b0#Z#0@0| Tclass._module.bexp $Heap@@2) ($IsAlloc HandleTypeType |s#0@@7| (Tclass._System.___hTotalFunc1 (TSeq TChar) TInt) $Heap@@2)))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (< (DtRank |b0#Z#0@0|) (DtRank |b#0@@3|))) (=> (< (DtRank |b0#Z#0@0|) (DtRank |b#0@@3|)) (=> (|_module.__default.bval#canCall| |b0#Z#0@0| |s#0@@7|) (and (=> (= (ControlFlow 0 12) 9) anon16_Then_correct) (=> (= (ControlFlow 0 12) 11) anon16_Else_correct))))))))))
(let ((anon17_Else_correct true))
(let ((anon17_Then_correct true))
(let ((anon15_Else_correct  (=> (or (not (= |b#0@@3| (|#_module.bexp.And| |_mcc#2#0| |_mcc#3#0|))) (not true)) (and (=> (= (ControlFlow 0 7) 5) anon17_Then_correct) (=> (= (ControlFlow 0 7) 6) anon17_Else_correct)))))
(let ((anon14_Else_correct  (=> (or (not (= |b#0@@3| (|#_module.bexp.Not| |_mcc#1#0|))) (not true)) (and (=> (= (ControlFlow 0 14) 12) anon15_Then_correct) (=> (= (ControlFlow 0 14) 7) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (and (and (and (= |b#0@@3| (|#_module.bexp.Not| |_mcc#1#0|)) ($Is DatatypeTypeType |_mcc#1#0| Tclass._module.bexp)) (and (= |let#4#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#4#0#0| Tclass._module.bexp))) (and (and (= |b#Z#0@0| |let#4#0#0|) ($IsAlloc DatatypeTypeType |b#Z#0@0| Tclass._module.bexp $Heap@@2)) (and ($IsAlloc HandleTypeType |s#0@@7| (Tclass._System.___hTotalFunc1 (TSeq TChar) TInt) $Heap@@2) (= (ControlFlow 0 4) (- 0 3))))) (< (DtRank |b#Z#0@0|) (DtRank |b#0@@3|)))))
(let ((anon13_Else_correct  (=> (or (not (= |b#0@@3| (|#_module.bexp.Bc| |_mcc#0#0|))) (not true)) (and (=> (= (ControlFlow 0 15) 4) anon14_Then_correct) (=> (= (ControlFlow 0 15) 14) anon14_Else_correct)))))
(let ((anon13_Then_correct true))
(let ((anon12_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (and (and (=> (= (ControlFlow 0 16) 1) anon12_Then_correct) (=> (= (ControlFlow 0 16) 2) anon13_Then_correct)) (=> (= (ControlFlow 0 16) 15) anon13_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and ($Is DatatypeTypeType |b#0@@3| Tclass._module.bexp) ($Is HandleTypeType |s#0@@7| (Tclass._System.___hTotalFunc1 (TSeq TChar) TInt))) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 17) 16))) anon0_correct))))
