...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly T@U) (|n#0| Int) ) (!  (=> (or (|_module.__default.UpIf#canCall| |n#0|) (< 1 $FunctionContextHeight)) ($Is DatatypeTypeType (_module.__default.UpIf $ly |n#0|) (Tclass._module.Stream TInt)))
 :qid |ExpandedGuardednessdfy.74:10|
 :skolemid |579|
 :pattern ( (_module.__default.UpIf $ly |n#0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@0 T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.__default.UpIf#canCall| |n#0@@0|) (< 1 $FunctionContextHeight)) (and (and (=> (= (Mod |n#0@@0| (LitInt 2)) (LitInt 1)) (|_module.__default.UpIf#canCall| (+ |n#0@@0| 1))) (=> (or (not (= (Mod |n#0@@0| (LitInt 2)) (LitInt 1))) (not true)) (|_module.__default.UpIf#canCall| (+ |n#0@@0| 2)))) (= (_module.__default.UpIf ($LS $ly@@0) |n#0@@0|) (ite (= (Mod |n#0@@0| (LitInt 2)) (LitInt 1)) (|#_module.Stream.ICons| ($Box intType (int_2_U |n#0@@0|)) (_module.__default.UpIf $ly@@0 (+ |n#0@@0| 1))) (|#_module.Stream.ICons| ($Box intType (int_2_U |n#0@@0|)) (_module.__default.UpIf $ly@@0 (+ |n#0@@0| 2)))))))
 :qid |ExpandedGuardednessdfy.74:10|
 :skolemid |581|
 :pattern ( (_module.__default.UpIf ($LS $ly@@0) |n#0@@0|))
))))
...
(assert (forall (($ly@@1 T@U) (|n#0@@1| Int) ) (! (= (_module.__default.UpIf ($LS $ly@@1) |n#0@@1|) (_module.__default.UpIf $ly@@1 |n#0@@1|))
 :qid |ExpandedGuardednessdfy.74:10|
 :skolemid |577|
 :pattern ( (_module.__default.UpIf ($LS $ly@@1) |n#0@@1|))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.UpIf)
...
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (not (= (LitInt 2) 0)) (not true))) (=> (or (not (= (LitInt 2) 0)) (not true)) (and (=> (= (ControlFlow 0 4) 2) anon8_Then_correct) (=> (= (ControlFlow 0 4) 3) anon8_Else_correct))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 6) 1) anon7_Then_correct) (=> (= (ControlFlow 0 6) 4) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct)))
