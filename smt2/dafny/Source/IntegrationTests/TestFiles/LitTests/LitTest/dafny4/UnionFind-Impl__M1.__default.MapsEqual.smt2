...
(set-info :boogie-vc-id Impl$$M1.__default.MapsEqual)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|Map#Equal| |m#0| |n#0|))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |m#0| (TMap M1._default.MapsEqual$D M1._default.MapsEqual$D)) ($IsAlloc MapType |m#0| (TMap M1._default.MapsEqual$D M1._default.MapsEqual$D) $Heap)) (and ($Is MapType |n#0| (TMap M1._default.MapsEqual$D M1._default.MapsEqual$D)) ($IsAlloc MapType |n#0| (TMap M1._default.MapsEqual$D M1._default.MapsEqual$D) $Heap))) (and (and (= 0 $FunctionContextHeight) (forall ((|d#1| T@U) ) (!  (=> (and ($IsBox |d#1| M1._default.MapsEqual$D) ($IsAllocBox |d#1| M1._default.MapsEqual$D $Heap)) (= (|Set#IsMember| (|Map#Domain| |m#0|) |d#1|) (|Set#IsMember| (|Map#Domain| |n#0|) |d#1|)))
 :qid |UnionFinddfy.117:21|
 :skolemid |1142|
 :pattern ( (|Set#IsMember| (|Map#Domain| |n#0|) |d#1|))
 :pattern ( (|Set#IsMember| (|Map#Domain| |m#0|) |d#1|))
))) (and (forall ((|d#3| T@U) ) (!  (=> ($IsBox |d#3| M1._default.MapsEqual$D) (=> (|Set#IsMember| (|Map#Domain| |m#0|) |d#3|) (= (MapType0Select BoxType BoxType (|Map#Elements| |m#0|) |d#3|) (MapType0Select BoxType BoxType (|Map#Elements| |n#0|) |d#3|))))
