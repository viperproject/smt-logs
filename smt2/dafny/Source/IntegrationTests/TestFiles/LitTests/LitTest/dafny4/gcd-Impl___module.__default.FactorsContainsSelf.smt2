...
(set-info :boogie-vc-id Impl$$_module.__default.FactorsContainsSelf)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (Mul |x#0@@5| (LitInt 1)) |x#0@@5|)) (=> (= (Mul |x#0@@5| (LitInt 1)) |x#0@@5|) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#IsMember| (_module.__default.Factors |x#0@@5|) ($Box intType (int_2_U |x#0@@5|)))))))))
