...
(set-info :boogie-vc-id Impl$$_module.__default.lemma__7__3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|_module.__default.equiv__c#canCall| (|#_module.com.While| |b#0@@3| |c#0@@11|) (|#_module.com.If| |b#0@@3| (|#_module.com.Seq| |c#0@@11| (|#_module.com.While| |b#0@@3| |c#0@@11|)) (Lit DatatypeTypeType |#_module.com.SKIP|)))) (or (_module.__default.equiv__c (|#_module.com.While| |b#0@@3| |c#0@@11|) (|#_module.com.If| |b#0@@3| (|#_module.com.Seq| |c#0@@11| (|#_module.com.While| |b#0@@3| |c#0@@11|)) (Lit DatatypeTypeType |#_module.com.SKIP|))) (forall ((|s#1@@1| T@U) (|t#1@@1| T@U) ) (!  (=> (and ($Is MapType |s#1@@1| (TMap (TSeq TChar) TInt)) ($Is MapType |t#1@@1| (TMap (TSeq TChar) TInt))) (= (_module.__default.big__step ($LS ($LS $LZ)) (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#1@@1| |t#1@@1|) (_module.__default.big__step ($LS ($LS $LZ)) (|#_module.com.If| |b#0@@3| (|#_module.com.Seq| |c#0@@11| (|#_module.com.While| |b#0@@3| |c#0@@11|)) (Lit DatatypeTypeType |#_module.com.SKIP|)) |s#1@@1| |t#1@@1|)))
 :qid |NipkowKleinchapter7dfy.84:10|
 :skolemid |844|
 :pattern ( (_module.__default.big__step ($LS ($LS $LZ)) (|#_module.com.If| |b#0@@3| (|#_module.com.Seq| |c#0@@11| (|#_module.com.While| |b#0@@3| |c#0@@11|)) |#_module.com.SKIP|) |s#1@@1| |t#1@@1|))
 :pattern ( (_module.__default.big__step ($LS ($LS $LZ)) (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#1@@1| |t#1@@1|))
))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |b#0@@3| Tclass._module.bexp) ($IsAlloc DatatypeTypeType |b#0@@3| Tclass._module.bexp $Heap)) (|$IsA#_module.bexp| |b#0@@3|)) (=> (and (and (and ($Is DatatypeTypeType |c#0@@11| Tclass._module.com) ($IsAlloc DatatypeTypeType |c#0@@11| Tclass._module.com $Heap)) (|$IsA#_module.com| |c#0@@11|)) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct)))))
