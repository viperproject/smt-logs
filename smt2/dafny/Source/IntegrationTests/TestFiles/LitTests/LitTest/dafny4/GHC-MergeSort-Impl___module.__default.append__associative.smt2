...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.append$_T0@@1 T@U) ($ly@@1 T@U) (|xs#0@@1| T@U) (|ys#0@@1| T@U) ) (!  (=> (or (|_module.__default.append#canCall| _module._default.append$_T0@@1 |xs#0@@1| |ys#0@@1|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@1| (Tclass._module.List _module._default.append$_T0@@1)) ($Is DatatypeTypeType |ys#0@@1| (Tclass._module.List _module._default.append$_T0@@1))))) ($Is DatatypeTypeType (_module.__default.append _module._default.append$_T0@@1 $ly@@1 |xs#0@@1| |ys#0@@1|) (Tclass._module.List _module._default.append$_T0@@1)))
 :qid |unknown.0:0|
 :skolemid |618|
 :pattern ( (_module.__default.append _module._default.append$_T0@@1 $ly@@1 |xs#0@@1| |ys#0@@1|))
))))
...
(assert (forall ((_module._default.append$_T0@@3 T@U) ($ly@@3 T@U) (|xs#0@@3| T@U) (|ys#0@@3| T@U) ) (! (= (_module.__default.append _module._default.append$_T0@@3 ($LS $ly@@3) |xs#0@@3| |ys#0@@3|) (_module.__default.append _module._default.append$_T0@@3 $ly@@3 |xs#0@@3| |ys#0@@3|))
 :qid |unknown.0:0|
 :skolemid |616|
 :pattern ( (_module.__default.append _module._default.append$_T0@@3 ($LS $ly@@3) |xs#0@@3| |ys#0@@3|))
)))
...
(declare-fun _module._default.append_associative$_T0 () T@U)
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.append__associative)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (|$IsA#_module.List| |xs#0@@4|)) (and (|$IsA#_module.List| |ys#0@@4|) (|$IsA#_module.List| |zs#0|))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@0 $Heap@0)) (and (forall ((|$ih#xs0#0| T@U) (|$ih#ys0#0| T@U) (|$ih#zs0#0| T@U) ) (!  (=> (and (and (and (and ($Is DatatypeTypeType |$ih#xs0#0| (Tclass._module.List _module._default.append_associative$_T0)) ($Is DatatypeTypeType |$ih#ys0#0| (Tclass._module.List _module._default.append_associative$_T0))) ($Is DatatypeTypeType |$ih#zs0#0| (Tclass._module.List _module._default.append_associative$_T0))) (U_2_bool (Lit boolType (bool_2_U true)))) (or (< (DtRank |$ih#xs0#0|) (DtRank |xs#0@@4|)) (and (= (DtRank |$ih#xs0#0|) (DtRank |xs#0@@4|)) (or (< (DtRank |$ih#ys0#0|) (DtRank |ys#0@@4|)) (and (= (DtRank |$ih#ys0#0|) (DtRank |ys#0@@4|)) (< (DtRank |$ih#zs0#0|) (DtRank |zs#0|))))))) (|_module.List#Equal| (_module.__default.append _module._default.append_associative$_T0 ($LS $LZ) |$ih#xs0#0| (_module.__default.append _module._default.append_associative$_T0 ($LS $LZ) |$ih#ys0#0| |$ih#zs0#0|)) (_module.__default.append _module._default.append_associative$_T0 ($LS $LZ) (_module.__default.append _module._default.append_associative$_T0 ($LS $LZ) |$ih#xs0#0| |$ih#ys0#0|) |$ih#zs0#0|)))
 :qid |GHCMergeSortdfy.52:26|
 :skolemid |624|
 :pattern ( (_module.__default.append _module._default.append_associative$_T0 ($LS $LZ) (_module.__default.append _module._default.append_associative$_T0 ($LS $LZ) |$ih#xs0#0| |$ih#ys0#0|) |$ih#zs0#0|))
 :pattern ( (_module.__default.append _module._default.append_associative$_T0 ($LS $LZ) |$ih#xs0#0| (_module.__default.append _module._default.append_associative$_T0 ($LS $LZ) |$ih#ys0#0| |$ih#zs0#0|)))
)) (= (ControlFlow 0 2) (- 0 1)))) (|_module.List#Equal| (_module.__default.append _module._default.append_associative$_T0 ($LS ($LS $LZ)) |xs#0@@4| (_module.__default.append _module._default.append_associative$_T0 ($LS ($LS $LZ)) |ys#0@@4| |zs#0|)) (_module.__default.append _module._default.append_associative$_T0 ($LS ($LS $LZ)) (_module.__default.append _module._default.append_associative$_T0 ($LS ($LS $LZ)) |xs#0@@4| |ys#0@@4|) |zs#0|))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (and ($Is DatatypeTypeType |xs#0@@4| (Tclass._module.List _module._default.append_associative$_T0)) ($IsAlloc DatatypeTypeType |xs#0@@4| (Tclass._module.List _module._default.append_associative$_T0) $Heap@@0)) (|$IsA#_module.List| |xs#0@@4|)) (and (and ($Is DatatypeTypeType |ys#0@@4| (Tclass._module.List _module._default.append_associative$_T0)) ($IsAlloc DatatypeTypeType |ys#0@@4| (Tclass._module.List _module._default.append_associative$_T0) $Heap@@0)) (|$IsA#_module.List| |ys#0@@4|))) (and (and (and ($Is DatatypeTypeType |zs#0| (Tclass._module.List _module._default.append_associative$_T0)) ($IsAlloc DatatypeTypeType |zs#0| (Tclass._module.List _module._default.append_associative$_T0) $Heap@@0)) (|$IsA#_module.List| |zs#0|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct))))
