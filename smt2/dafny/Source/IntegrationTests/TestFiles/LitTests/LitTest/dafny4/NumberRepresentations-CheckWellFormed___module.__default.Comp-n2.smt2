...
(declare-fun |##lowDigit#0@0| () Int)
(declare-fun |n#0| () Int)
(declare-fun |digits#0@@5| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.CompleteNat)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (<= (LitInt 2) |base#0@@5|)) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (and ($Is SeqType |digits#0@0| (TSeq TInt)) ($IsAlloc SeqType |digits#0@0| (TSeq TInt) $Heap@0)) ($IsAlloc SeqType |digits#0@0| (TSeq TInt) $Heap@0))) (and (and (and (= |##lowDigit#0@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##lowDigit#0@0|) TInt $Heap@0)) (and ($IsAlloc intType (int_2_U |base#0@@5|) TInt $Heap@0) (|_module.__default.IsSkewNumber#canCall| |digits#0@0| (LitInt 0) |base#0@@5|))) (and (and (_module.__default.IsSkewNumber |digits#0@0| (LitInt 0) |base#0@@5|) ($IsAlloc SeqType |digits#0@0| (TSeq TInt) $Heap@0)) (and ($IsAlloc intType (int_2_U |base#0@@5|) TInt $Heap@0) (= (ControlFlow 0 2) (- 0 1)))))) (<= (LitInt 2) |base#0@@5|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |n#0|)) (and (and ($Is SeqType |digits#0@@5| (TSeq TInt)) ($IsAlloc SeqType |digits#0@@5| (TSeq TInt) $Heap)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
