...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.lemma__Foo)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (and ($Is HandleTypeType |g#0@0| (Tclass._System.___hTotalFunc0 Tclass._System.Tuple0)) ($IsAlloc HandleTypeType |g#0@0| (Tclass._System.___hTotalFunc0 Tclass._System.Tuple0) $Heap@0)) (and ($IsAlloc HandleTypeType |g#0@0| (Tclass._System.___hTotalFunc0 Tclass._System.Tuple0) $Heap@0) (= (ControlFlow 0 2) (- 0 1))))) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)))))
