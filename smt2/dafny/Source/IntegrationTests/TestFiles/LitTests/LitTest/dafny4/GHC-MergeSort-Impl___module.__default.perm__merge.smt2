...
(assert  (and (= (Ctor DatatypeTypeType) 4) (= (Ctor BoxType) 5)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@0 T@U) (|xs#0@@0| T@U) (|ys#0| T@U) ) (!  (=> (or (|_module.__default.merge#canCall| (Lit DatatypeTypeType |xs#0@@0|) (Lit DatatypeTypeType |ys#0|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@0| (Tclass._module.List Tclass._module.G)) ($Is DatatypeTypeType |ys#0| (Tclass._module.List Tclass._module.G))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@0|)))))) (let ((|xs'#3| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@0|)))))
(let ((|a#3| (Lit BoxType (_module.List.head (Lit DatatypeTypeType |xs#0@@0|)))))
...
(let ((|b#3| (Lit BoxType (_module.List.head (Lit DatatypeTypeType |ys#0|)))))
 (and (and (|_module.__default.Below#canCall| |a#3| |b#3|) (=> (_module.__default.Below |a#3| |b#3|) (|_module.__default.merge#canCall| |xs'#3| (Lit DatatypeTypeType |ys#0|)))) (=> (not (_module.__default.Below |a#3| |b#3|)) (|_module.__default.merge#canCall| (Lit DatatypeTypeType |xs#0@@0|) |ys'#3|))))))))) (= (_module.__default.merge ($LS $ly@@0) (Lit DatatypeTypeType |xs#0@@0|) (Lit DatatypeTypeType |ys#0|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@0|)) |ys#0| (let ((|xs'#2| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@0|)))))
(let ((|a#2| (Lit BoxType (_module.List.head (Lit DatatypeTypeType |xs#0@@0|)))))
(ite (_module.List.Nil_q (Lit DatatypeTypeType |ys#0|)) |xs#0@@0| (let ((|ys'#2| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |ys#0|)))))
(let ((|b#2| (Lit BoxType (_module.List.head (Lit DatatypeTypeType |ys#0|)))))
(ite (_module.__default.Below |a#2| |b#2|) (|#_module.List.Cons| |a#2| (Lit DatatypeTypeType (_module.__default.merge ($LS $ly@@0) |xs'#2| (Lit DatatypeTypeType |ys#0|)))) (|#_module.List.Cons| |b#2| (Lit DatatypeTypeType (_module.__default.merge ($LS $ly@@0) (Lit DatatypeTypeType |xs#0@@0|) |ys'#2|)))))))))))))
 :qid |GHCMergeSortdfy.138:10|
 :weight 3
 :skolemid |700|
 :pattern ( (_module.__default.merge ($LS $ly@@0) (Lit DatatypeTypeType |xs#0@@0|) (Lit DatatypeTypeType |ys#0|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.multiset_of$T@@1 T@U) ($ly@@2 T@U) (|xs#0@@2| T@U) ) (!  (=> (or (|_module.__default.multiset__of#canCall| _module._default.multiset_of$T@@1 (Lit DatatypeTypeType |xs#0@@2|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@2| (Tclass._module.List _module._default.multiset_of$T@@1)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@2|)))))) (let ((|ys#3| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@2|)))))
(|_module.__default.multiset__of#canCall| _module._default.multiset_of$T@@1 |ys#3|))) (= (_module.__default.multiset__of _module._default.multiset_of$T@@1 ($LS $ly@@2) (Lit DatatypeTypeType |xs#0@@2|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@2|)) |MultiSet#Empty| (let ((|ys#2| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@2|)))))
(let ((|a#2@@0| (Lit BoxType (_module.List.head (Lit DatatypeTypeType |xs#0@@2|)))))
(|MultiSet#Union| (|MultiSet#UnionOne| |MultiSet#Empty| |a#2@@0|) (_module.__default.multiset__of _module._default.multiset_of$T@@1 ($LS $ly@@2) |ys#2|))))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |605|
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@3 T@U) (|xs#0@@3| T@U) (|ys#0@@1| T@U) ) (!  (=> (or (|_module.__default.merge#canCall| |xs#0@@3| |ys#0@@1|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@3| (Tclass._module.List Tclass._module.G)) ($Is DatatypeTypeType |ys#0@@1| (Tclass._module.List Tclass._module.G))))) (and (=> (not (_module.List.Nil_q |xs#0@@3|)) (let ((|xs'#1| (_module.List.tail |xs#0@@3|)))
...
(let ((|b#1| (_module.List.head |ys#0@@1|)))
 (and (and (|_module.__default.Below#canCall| |a#1| |b#1|) (=> (_module.__default.Below |a#1| |b#1|) (|_module.__default.merge#canCall| |xs'#1| |ys#0@@1|))) (=> (not (_module.__default.Below |a#1| |b#1|)) (|_module.__default.merge#canCall| |xs#0@@3| |ys'#1|))))))))) (= (_module.__default.merge ($LS $ly@@3) |xs#0@@3| |ys#0@@1|) (ite (_module.List.Nil_q |xs#0@@3|) |ys#0@@1| (let ((|xs'#0| (_module.List.tail |xs#0@@3|)))
(let ((|a#0@@1| (_module.List.head |xs#0@@3|)))
(ite (_module.List.Nil_q |ys#0@@1|) |xs#0@@3| (let ((|ys'#0| (_module.List.tail |ys#0@@1|)))
(let ((|b#0@@0| (_module.List.head |ys#0@@1|)))
(ite (_module.__default.Below |a#0@@1| |b#0@@0|) (|#_module.List.Cons| |a#0@@1| (_module.__default.merge $ly@@3 |xs'#0| |ys#0@@1|)) (|#_module.List.Cons| |b#0@@0| (_module.__default.merge $ly@@3 |xs#0@@3| |ys'#0|))))))))))))
 :qid |GHCMergeSortdfy.138:10|
 :skolemid |699|
 :pattern ( (_module.__default.merge ($LS $ly@@3) |xs#0@@3| |ys#0@@1|))
))))
...
(assert (forall (($ly@@4 T@U) (|xs#0@@4| T@U) (|ys#0@@2| T@U) ) (! (= (_module.__default.merge ($LS $ly@@4) |xs#0@@4| |ys#0@@2|) (_module.__default.merge $ly@@4 |xs#0@@4| |ys#0@@2|))
 :qid |GHCMergeSortdfy.138:10|
 :skolemid |695|
 :pattern ( (_module.__default.merge ($LS $ly@@4) |xs#0@@4| |ys#0@@2|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@5 T@U) (|xs#0@@5| T@U) (|ys#0@@3| T@U) ) (!  (=> (or (|_module.__default.merge#canCall| |xs#0@@5| |ys#0@@3|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@5| (Tclass._module.List Tclass._module.G)) ($Is DatatypeTypeType |ys#0@@3| (Tclass._module.List Tclass._module.G))))) ($Is DatatypeTypeType (_module.__default.merge $ly@@5 |xs#0@@5| |ys#0@@3|) (Tclass._module.List Tclass._module.G)))
 :qid |GHCMergeSortdfy.138:10|
 :skolemid |697|
 :pattern ( (_module.__default.merge $ly@@5 |xs#0@@5| |ys#0@@3|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.multiset_of$T@@2 T@U) ($ly@@6 T@U) (|xs#0@@6| T@U) ) (!  (=> (and (or (|_module.__default.multiset__of#canCall| _module._default.multiset_of$T@@2 |xs#0@@6|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@6| (Tclass._module.List _module._default.multiset_of$T@@2)) ($IsAlloc DatatypeTypeType |xs#0@@6| (Tclass._module.List _module._default.multiset_of$T@@2) $Heap)))) ($IsGoodHeap $Heap)) ($IsAlloc MultiSetType (_module.__default.multiset__of _module._default.multiset_of$T@@2 $ly@@6 |xs#0@@6|) (TMultiSet _module._default.multiset_of$T@@2) $Heap))
 :qid |GHCMergeSortdfy.31:16|
 :skolemid |602|
 :pattern ( ($IsAlloc MultiSetType (_module.__default.multiset__of _module._default.multiset_of$T@@2 $ly@@6 |xs#0@@6|) (TMultiSet _module._default.multiset_of$T@@2) $Heap))
))))
...
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.perm__merge)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and (|$IsA#_module.List| |xs#0@@8|) (|$IsA#_module.List| |ys#0@@4|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@0 $Heap@0)) (and (forall ((|$ih#xs0#0| T@U) (|$ih#ys0#0| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |$ih#xs0#0| (Tclass._module.List Tclass._module.G)) ($Is DatatypeTypeType |$ih#ys0#0| (Tclass._module.List Tclass._module.G))) (U_2_bool (Lit boolType (bool_2_U true)))) (or (< (DtRank |$ih#xs0#0|) (DtRank |xs#0@@8|)) (and (= (DtRank |$ih#xs0#0|) (DtRank |xs#0@@8|)) (< (DtRank |$ih#ys0#0|) (DtRank |ys#0@@4|))))) (|MultiSet#Equal| (_module.__default.multiset__of Tclass._module.G ($LS $LZ) (_module.__default.merge ($LS $LZ) |$ih#xs0#0| |$ih#ys0#0|)) (|MultiSet#Union| (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |$ih#xs0#0|) (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |$ih#ys0#0|))))
 :qid |GHCMergeSortdfy.301:18|
 :skolemid |783|
 :pattern ( (|MultiSet#Union| (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |$ih#xs0#0|) (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |$ih#ys0#0|)))
 :pattern ( (_module.__default.merge ($LS $LZ) |$ih#xs0#0| |$ih#ys0#0|))
)) (= (ControlFlow 0 2) (- 0 1)))) (|MultiSet#Equal| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) (_module.__default.merge ($LS ($LS $LZ)) |xs#0@@8| |ys#0@@4|)) (|MultiSet#Union| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |xs#0@@8|) (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |ys#0@@4|))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is DatatypeTypeType |xs#0@@8| (Tclass._module.List Tclass._module.G)) ($IsAlloc DatatypeTypeType |xs#0@@8| (Tclass._module.List Tclass._module.G) $Heap@@0)) (|$IsA#_module.List| |xs#0@@8|)) (=> (and (and (and ($Is DatatypeTypeType |ys#0@@4| (Tclass._module.List Tclass._module.G)) ($IsAlloc DatatypeTypeType |ys#0@@4| (Tclass._module.List Tclass._module.G) $Heap@@0)) (|$IsA#_module.List| |ys#0@@4|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct)))))
