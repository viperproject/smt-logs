...
(assert (distinct TChar TInt TagChar TagInt TagSeq alloc Tagclass._module.Stream |##_module.Stream.ICons| tytagFamily$Stream)
)
(assert (= (Tag TChar) TagChar))
(assert (= (Tag TInt) TagInt))
(assert (forall ((d T@U) ) (!  (=> (|$IsA#_module.Stream| d) (_module.Stream.ICons_q d))
 :qid |unknown.0:0|
 :skolemid |807|
...
(assert (forall ((_module.Stream$T T@U) (d@@0 T@U) ) (!  (=> ($Is DatatypeTypeType d@@0 (Tclass._module.Stream _module.Stream$T)) (_module.Stream.ICons_q d@@0))
 :qid |unknown.0:0|
 :skolemid |808|
 :pattern ( (_module.Stream.ICons_q d@@0) ($Is DatatypeTypeType d@@0 (Tclass._module.Stream _module.Stream$T)))
)))
...
(assert (forall ((d@@1 T@U) ) (! (= (_module.Stream.ICons_q d@@1) (= (DatatypeCtorId d@@1) |##_module.Stream.ICons|))
 :qid |unknown.0:0|
 :skolemid |798|
...
(assert (forall ((d@@2 T@U) ) (!  (=> (_module.Stream.ICons_q d@@2) (exists ((|a#1#0#0| T@U) (|a#1#1#0| T@U) ) (! (= d@@2 (|#_module.Stream.ICons| |a#1#0#0| |a#1#1#0|))
 :qid |ExpandedGuardednessdfy.62:30|
 :skolemid |799|
)))
 :qid |unknown.0:0|
 :skolemid |800|
 :pattern ( (_module.Stream.ICons_q d@@2))
)))
...
(assert (forall ((d@@3 T@U) (_module.Stream$T@@3 T@U) ($h T@U) ) (!  (=> (and ($IsGoodHeap $h) (and (_module.Stream.ICons_q d@@3) ($IsAlloc DatatypeTypeType d@@3 (Tclass._module.Stream _module.Stream$T@@3) $h))) ($IsAllocBox (_module.Stream.head d@@3) _module.Stream$T@@3 $h))
 :qid |unknown.0:0|
 :skolemid |803|
...
(assert (forall ((_module.Stream$T@@4 T@U) (bx@@3 T@U) ) (!  (=> ($IsBox bx@@3 (Tclass._module.Stream _module.Stream$T@@4)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@3)) bx@@3) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@3) (Tclass._module.Stream _module.Stream$T@@4))))
 :qid |unknown.0:0|
 :skolemid |551|
 :pattern ( ($IsBox bx@@3 (Tclass._module.Stream _module.Stream$T@@4)))
)))
(assert (forall ((d@@4 T@U) (_module.Stream$T@@5 T@U) ($h@@0 T@U) ) (!  (=> (and ($IsGoodHeap $h@@0) (and (_module.Stream.ICons_q d@@4) ($IsAlloc DatatypeTypeType d@@4 (Tclass._module.Stream _module.Stream$T@@5) $h@@0))) ($IsAlloc DatatypeTypeType (_module.Stream.tail d@@4) (Tclass._module.Stream _module.Stream$T@@5) $h@@0))
 :qid |unknown.0:0|
 :skolemid |804|
...
(set-info :boogie-vc-id Impl$$_module.__default.PrintStream)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon9_Else_correct  (=> (and (and (and (< |n#0@0| 5) (= |$decr$loop#00@1| (- 5 |n#0@0|))) (and (_module.Stream.ICons_q |s#1@0|) (_module.Stream.ICons_q |s#1@0|))) (and (and (_module.Stream.ICons_q |s#1@0|) (_module.Stream.ICons_q |s#1@0|)) (and (= |$rhs#0_0@1| (_module.Stream.tail |s#1@0|)) (= |$rhs#0_1@1| (+ |n#0@0| 1))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (<= 0 |$decr$loop#00@1|) (= (- 5 |$rhs#0_1@1|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- 5 |$rhs#0_1@1|) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 5) (- 0 4)) (< (- 5 |$rhs#0_1@1|) |$decr$loop#00@1|)))))))
...
(let ((anon7_LoopHead_correct  (=> (and ($Is DatatypeTypeType |s#1@0| (Tclass._module.Stream TInt)) ($IsAlloc DatatypeTypeType |s#1@0| (Tclass._module.Stream TInt) $Heap)) (=> (and (and (and (and (not false) (and (<= 0 |n#0@0|) (< |n#0@0| 6))) (= |$rhs#0@0| 0)) (= |$decr_init$loop#00@0| 5)) (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |ExpandedGuardednessdfy.40:3|
 :skolemid |555|
...
)) (<= (- 5 |n#0@0|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 9) 1) anon7_LoopDone_correct) (=> (= (ControlFlow 0 9) 8) anon7_LoopBody_correct))))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |$rhs#0@0| (LitInt 0))) (and (= |$decr_init$loop#00@0| (- 5 |$rhs#0@0|)) (= (ControlFlow 0 10) 9))) anon7_LoopHead_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SeqType |tag#0| (TSeq TChar)) ($IsAlloc SeqType |tag#0| (TSeq TChar) $Heap))) (and (and ($Is DatatypeTypeType |s#0| (Tclass._module.Stream TInt)) ($IsAlloc DatatypeTypeType |s#0| (Tclass._module.Stream TInt) $Heap)) (|$IsA#_module.Stream| |s#0|))) (and (and (and ($Is DatatypeTypeType |s#1| (Tclass._module.Stream TInt)) ($IsAlloc DatatypeTypeType |s#1| (Tclass._module.Stream TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 11) 10)))) anon0_correct)))
