...
(assert (forall (($ly@@2 T@U) (|z#0@@0| Int) (|l#0@@2| T@U) ) (! (= (_module.__default.aux ($LS $ly@@2) |z#0@@0| |l#0@@2|) (_module.__default.aux $ly@@2 |z#0@@0| |l#0@@2|))
 :qid |CoqArtInsertionSortdfy.98:10|
 :skolemid |620|
 :pattern ( (_module.__default.aux ($LS $ly@@2) |z#0@@0| |l#0@@2|))
)))
...
(assert (forall (($ly@@3 T@U) (|l#0@@3| T@U) ) (! (= (_module.__default.sorted ($LS $ly@@3) |l#0@@3|) (_module.__default.sorted $ly@@3 |l#0@@3|))
 :qid |CoqArtInsertionSortdfy.8:17|
 :skolemid |528|
 :pattern ( (_module.__default.sorted ($LS $ly@@3) |l#0@@3|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@4 T@U) (|z#0@@1| Int) (|l#0@@4| T@U) ) (!  (=> (or (|_module.__default.aux#canCall| |z#0@@1| |l#0@@4|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |l#0@@4| (Tclass._module.List TInt)))) ($Is DatatypeTypeType (_module.__default.aux $ly@@4 |z#0@@1| |l#0@@4|) (Tclass._module.List TInt)))
 :qid |CoqArtInsertionSortdfy.98:10|
 :skolemid |622|
 :pattern ( (_module.__default.aux $ly@@4 |z#0@@1| |l#0@@4|))
))))
...
(assert (forall ((|l#0@@5| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@5| |l#1| |l#2| |l#3|) $o $f))  (=> (and (or (not (= $o |l#0@@5|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1| $o) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |719|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@5| |l#1| |l#2| |l#3|) $o $f))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@5 T@U) (|z#0@@2| Int) (|l#0@@6| T@U) ) (!  (=> (or (|_module.__default.aux#canCall| |z#0@@2| |l#0@@6|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |l#0@@6| (Tclass._module.List TInt)))) (and (=> (not (_module.List.Nil_q |l#0@@6|)) (let ((|l'#1| (_module.List.tail |l#0@@6|)))
(let ((|a#1| (U_2_int ($Unbox intType (_module.List.head |l#0@@6|)))))
 (=> (< |a#1| |z#0@@2|) (|_module.__default.aux#canCall| |z#0@@2| |l'#1|))))) (= (_module.__default.aux ($LS $ly@@5) |z#0@@2| |l#0@@6|) (ite (_module.List.Nil_q |l#0@@6|) (|#_module.List.Cons| ($Box intType (int_2_U |z#0@@2|)) (Lit DatatypeTypeType |#_module.List.Nil|)) (let ((|l'#0| (_module.List.tail |l#0@@6|)))
(let ((|a#0| (U_2_int ($Unbox intType (_module.List.head |l#0@@6|)))))
(ite (<= |z#0@@2| |a#0|) (|#_module.List.Cons| ($Box intType (int_2_U |z#0@@2|)) |l#0@@6|) (|#_module.List.Cons| ($Box intType (int_2_U |a#0|)) (_module.__default.aux $ly@@5 |z#0@@2| |l'#0|)))))))))
 :qid |CoqArtInsertionSortdfy.98:10|
 :skolemid |624|
 :pattern ( (_module.__default.aux ($LS $ly@@5) |z#0@@2| |l#0@@6|))
))))
(push 1)
...
(set-info :boogie-vc-id Impl$$_module.__default.aux__sorted)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 4) (- 0 7)) (=> (|_module.__default.sorted#canCall| (_module.__default.aux ($LS $LZ) |x#0@@0| |l#0@@7|)) (or (_module.__default.sorted ($LS $LZ) (_module.__default.aux ($LS $LZ) |x#0@@0| |l#0@@7|)) (=> (_module.List.Nil_q (_module.__default.aux ($LS $LZ) |x#0@@0| |l#0@@7|)) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (|_module.__default.sorted#canCall| (_module.__default.aux ($LS $LZ) |x#0@@0| |l#0@@7|)) (or (_module.__default.sorted ($LS $LZ) (_module.__default.aux ($LS $LZ) |x#0@@0| |l#0@@7|)) (=> (_module.List.Nil_q (_module.__default.aux ($LS $LZ) |x#0@@0| |l#0@@7|)) (U_2_bool (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (=> (|_module.__default.sorted#canCall| (_module.__default.aux ($LS $LZ) |x#0@@0| |l#0@@7|)) (or (_module.__default.sorted ($LS $LZ) (_module.__default.aux ($LS $LZ) |x#0@@0| |l#0@@7|)) (=> (not (_module.List.Nil_q (_module.__default.aux ($LS $LZ) |x#0@@0| |l#0@@7|))) (let ((|rest#6| (_module.List.tail (_module.__default.aux ($LS ($LS $LZ)) |x#0@@0| |l#0@@7|))))
 (=> (_module.List.Nil_q |rest#6|) (U_2_bool (Lit boolType (bool_2_U true))))))))) (=> (=> (|_module.__default.sorted#canCall| (_module.__default.aux ($LS $LZ) |x#0@@0| |l#0@@7|)) (or (_module.__default.sorted ($LS $LZ) (_module.__default.aux ($LS $LZ) |x#0@@0| |l#0@@7|)) (=> (not (_module.List.Nil_q (_module.__default.aux ($LS $LZ) |x#0@@0| |l#0@@7|))) (let ((|rest#6@@0| (_module.List.tail (_module.__default.aux ($LS ($LS $LZ)) |x#0@@0| |l#0@@7|))))
 (=> (_module.List.Nil_q |rest#6@@0|) (U_2_bool (Lit boolType (bool_2_U true)))))))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (=> (|_module.__default.sorted#canCall| (_module.__default.aux ($LS $LZ) |x#0@@0| |l#0@@7|)) (or (_module.__default.sorted ($LS $LZ) (_module.__default.aux ($LS $LZ) |x#0@@0| |l#0@@7|)) (=> (not (_module.List.Nil_q (_module.__default.aux ($LS $LZ) |x#0@@0| |l#0@@7|))) (let ((|rest#6@@1| (_module.List.tail (_module.__default.aux ($LS ($LS $LZ)) |x#0@@0| |l#0@@7|))))
(let ((|x#7| (U_2_int ($Unbox intType (_module.List.head (_module.__default.aux ($LS ($LS $LZ)) |x#0@@0| |l#0@@7|))))))
 (=> (not (_module.List.Nil_q |rest#6@@1|)) (let ((|y#6| (U_2_int ($Unbox intType (_module.List.head |rest#6@@1|)))))
(<= |x#7| |y#6|))))))))) (=> (=> (|_module.__default.sorted#canCall| (_module.__default.aux ($LS $LZ) |x#0@@0| |l#0@@7|)) (or (_module.__default.sorted ($LS $LZ) (_module.__default.aux ($LS $LZ) |x#0@@0| |l#0@@7|)) (=> (not (_module.List.Nil_q (_module.__default.aux ($LS $LZ) |x#0@@0| |l#0@@7|))) (let ((|rest#6@@2| (_module.List.tail (_module.__default.aux ($LS ($LS $LZ)) |x#0@@0| |l#0@@7|))))
(let ((|x#7@@0| (U_2_int ($Unbox intType (_module.List.head (_module.__default.aux ($LS ($LS $LZ)) |x#0@@0| |l#0@@7|))))))
 (=> (not (_module.List.Nil_q |rest#6@@2|)) (let ((|y#6@@0| (U_2_int ($Unbox intType (_module.List.head |rest#6@@2|)))))
(<= |x#7@@0| |y#6@@0|)))))))) (=> (= (ControlFlow 0 4) (- 0 3)) (=> (|_module.__default.sorted#canCall| (_module.__default.aux ($LS $LZ) |x#0@@0| |l#0@@7|)) (or (_module.__default.sorted ($LS $LZ) (_module.__default.aux ($LS $LZ) |x#0@@0| |l#0@@7|)) (=> (not (_module.List.Nil_q (_module.__default.aux ($LS $LZ) |x#0@@0| |l#0@@7|))) (let ((|rest#6@@3| (_module.List.tail (_module.__default.aux ($LS ($LS $LZ)) |x#0@@0| |l#0@@7|))))
 (=> (not (_module.List.Nil_q |rest#6@@3|)) (_module.__default.sorted ($LS ($LS $LZ)) |rest#6@@3|)))))))))))))))
(let ((anon10_Then_correct  (=> (= |l'#0_0@0| (|#_module.List.Cons| ($Box intType (int_2_U |_mcc#2#0_0_0@0|)) |_mcc#3#0_0_0@0|)) (=> (and ($Is DatatypeTypeType |_mcc#3#0_0_0@0| (Tclass._module.List TInt)) (= (ControlFlow 0 10) 4)) GeneratedUnifiedExit_correct))))
(let ((anon9_Then_correct  (=> (and (= |l'#0_0@0| |#_module.List.Nil|) (= (ControlFlow 0 9) 4)) GeneratedUnifiedExit_correct)))
(let ((anon7_Then_correct  (=> (and (= |l#0@@7| |#_module.List.Nil|) (= (ControlFlow 0 8) 4)) GeneratedUnifiedExit_correct)))
(let ((anon10_Else_correct true))
(let ((anon9_Else_correct  (=> (or (not (= |l'#0_0@0| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 11) 10) anon10_Then_correct) (=> (= (ControlFlow 0 11) 2) anon10_Else_correct)))))
(let ((anon8_Then_correct  (=> (and (= |l#0@@7| (|#_module.List.Cons| ($Box intType (int_2_U |_mcc#0#0_0@0|)) |_mcc#1#0_0@0|)) ($Is DatatypeTypeType |_mcc#1#0_0@0| (Tclass._module.List TInt))) (=> (and (and (and ($Is DatatypeTypeType |l'#0_0@0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |l'#0_0@0| (Tclass._module.List TInt) $Heap@0)) (= |let#0_0#0#0| |_mcc#1#0_0@0|)) (and ($Is DatatypeTypeType |let#0_0#0#0| (Tclass._module.List TInt)) (= |l'#0_0@0| |let#0_0#0#0|))) (and (=> (= (ControlFlow 0 12) 9) anon9_Then_correct) (=> (= (ControlFlow 0 12) 11) anon9_Else_correct))))))
(let ((anon8_Else_correct true))
(let ((anon7_Else_correct  (=> (or (not (= |l#0@@7| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 13) 12) anon8_Then_correct) (=> (= (ControlFlow 0 13) 1) anon8_Else_correct)))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.List| |l#0@@7|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#l0#0| T@U) (|$ih#x0#0| Int) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#l0#0| (Tclass._module.List TInt)) (_module.__default.sorted ($LS $LZ) |$ih#l0#0|)) (or (< (DtRank |$ih#l0#0|) (DtRank |l#0@@7|)) (and (= (DtRank |$ih#l0#0|) (DtRank |l#0@@7|)) (and (<= 0 |$ih#x0#0|) (< |$ih#x0#0| |x#0@@0|))))) (_module.__default.sorted ($LS $LZ) (_module.__default.aux ($LS $LZ) |$ih#x0#0| |$ih#l0#0|)))
 :qid |CoqArtInsertionSortdfy.127:18|
 :skolemid |634|
 :pattern ( (_module.__default.aux ($LS $LZ) |$ih#x0#0| |$ih#l0#0|))
)))) (and (=> (= (ControlFlow 0 14) 8) anon7_Then_correct) (=> (= (ControlFlow 0 14) 13) anon7_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |l#0@@7| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |l#0@@7| (Tclass._module.List TInt) $Heap)) (|$IsA#_module.List| |l#0@@7|)) (= 2 $FunctionContextHeight)) (and (and (|_module.__default.sorted#canCall| |l#0@@7|) (and (_module.__default.sorted ($LS $LZ) |l#0@@7|) (ite (_module.List.Nil_q |l#0@@7|) true (let ((|rest#5| (_module.List.tail |l#0@@7|)))
(let ((|x#6| (U_2_int ($Unbox intType (_module.List.head |l#0@@7|)))))
(ite (_module.List.Nil_q |rest#5|) true (let ((|y#5| (U_2_int ($Unbox intType (_module.List.head |rest#5|)))))
 (and (<= |x#6| |y#5|) (_module.__default.sorted ($LS $LZ) |rest#5|))))))))) (= (ControlFlow 0 15) 14))) anon0_correct))))
