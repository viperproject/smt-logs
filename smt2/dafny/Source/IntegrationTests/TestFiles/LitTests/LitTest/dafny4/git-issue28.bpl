// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue28.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue28-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue28.dfy
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "mylemma (correctness)"} Impl$$_module.__default.mylemma() returns ($_reverifyPost: bool)
{
  ...
  var newtype$check#3: int;
    ...
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue28.dfy(6,19)
    assume true;
    assume true;
    shift#0 := LitInt(1);
    // ----- assume statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue28.dfy(7,5)
    newtype$check#0 := LitInt(1);
    assert {:id "id1"} 0 <= newtype$check#0 && newtype$check#0 < 4294967296;
    newtype$check#1 := shift#0;
    assert {:id "id2"} 0 <= newtype$check#1 && newtype$check#1 < 64;
    assert {:id "id3"} {:subsumption 0} le_bv6(nat_to_bv6(shift#0), 32bv6);
    assume true;
    assume {:id "id4"} nat_from_bv32(LeftShift_bv32(1bv32, (0bv26 ++ nat_to_bv6(shift#0)): bv32))
       == LitInt(2);
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue28.dfy(8,5)
    newtype$check#2 := LitInt(1);
    assert {:id "id5"} 0 <= newtype$check#2 && newtype$check#2 < 4294967296;
    newtype$check#3 := LitInt(1);
    assert {:id "id6"} 0 <= newtype$check#3 && newtype$check#3 < 64;
    assert {:id "id7"} {:subsumption 0} le_bv6(1bv6, 32bv6);
    assume true;
    assert {:id "id8"} nat_from_bv32(LeftShift_bv32(1bv32, (0bv26 ++ 1bv6): bv32)) == LitInt(2);
}
