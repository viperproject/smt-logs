...
(set-info :boogie-vc-id Impl$$_module.__default.Conversion__Nat2Int)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|_module.List#Equal| |ns#0| |ns#0|))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |ns#0| (Tclass._module.List Tclass._System.nat)) ($IsAlloc DatatypeTypeType |ns#0| (Tclass._module.List Tclass._System.nat) $Heap)) (|$IsA#_module.List| |ns#0|)) (and (and ($Is DatatypeTypeType |xs#0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |xs#0| (Tclass._module.List TInt) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct))))
