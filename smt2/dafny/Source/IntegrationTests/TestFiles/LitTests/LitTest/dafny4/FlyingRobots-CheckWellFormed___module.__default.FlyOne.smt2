...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.FlyOne)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 75) (let ((anon35_correct true))
(let ((anon33_correct  (=> (and (<= (LitInt 0) |j#10@0|) (< |j#10@0| |n#0|)) (and (=> (= (ControlFlow 0 3) (- 0 9)) (and (<= 0 |j#10@0|) (< |j#10@0| (|Seq#Length| |bots#0|)))) (=> (and (<= 0 |j#10@0|) (< |j#10@0| (|Seq#Length| |bots#0|))) (and (=> (= (ControlFlow 0 3) (- 0 8)) (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |j#10@0|)) null)) (not true))) (=> (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |j#10@0|)) null)) (not true)) (=> ($IsAllocBox (|Seq#Index| |bots#0| |j#10@0|) Tclass._module.Bot? $Heap@0) (and (=> (= (ControlFlow 0 3) (- 0 7)) (=> (U_2_bool (Lit boolType (bool_2_U true))) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |j#10@0|))))) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |j#10@0|))) (=> (and (|_module.Bot.robot__inv#canCall| $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |j#10@0|))) (_module.Bot.robot__inv $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |j#10@0|)))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (and (<= 0 |j#10@0|) (< |j#10@0| (|Seq#Length| |bots#0|)))) (=> (and (<= 0 |j#10@0|) (< |j#10@0| (|Seq#Length| |bots#0|))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |j#10@0|)) null)) (not true))) (=> (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |j#10@0|)) null)) (not true)) (=> ($IsAllocBox (|Seq#Index| |bots#0| |j#10@0|) Tclass._module.Bot? $Heap@0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> (U_2_bool (Lit boolType (bool_2_U true))) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |j#10@0|))))) (=> (and (and (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |j#10@0|))) (|_module.Bot.flying#canCall| $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |j#10@0|)))) (and (_module.Bot.flying $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |j#10@0|))) (= (ControlFlow 0 3) 1))) anon35_correct))))))))))))))))))
(let ((anon49_Else_correct  (=> (and (< |j#10@0| (LitInt 0)) (= (ControlFlow 0 11) 3)) anon33_correct)))
(let ((anon49_Then_correct  (=> (and (<= (LitInt 0) |j#10@0|) (= (ControlFlow 0 10) 3)) anon33_correct)))
(let ((anon48_Else_correct  (=> (and (=> (and (<= (LitInt 0) |j#10@0|) (< |j#10@0| |n#0|)) (and (_module.Bot.robot__inv $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |j#10@0|))) (_module.Bot.flying $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |j#10@0|))))) (= (ControlFlow 0 2) 1)) anon35_correct)))
(let ((anon30_correct  (=> (forall ((|j#9| Int) ) (!  (=> (and (and (<= (LitInt 0) |j#9|) (< |j#9| (|Seq#Length| |bots#0|))) (or (not (= |j#9| |n#0|)) (not true))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |j#9|))) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |j#9|))) _module.Bot.Repr))))
 :qid |FlyingRobotsdfy.238:18|
 :skolemid |653|
 :pattern ( ($Unbox refType (|Seq#Index| |bots#0| |j#9|)))
 :pattern ( ($Unbox refType (|Seq#Index| |bots#0| |j#9|)))
)) (and (and (=> (= (ControlFlow 0 12) 2) anon48_Else_correct) (=> (= (ControlFlow 0 12) 10) anon49_Then_correct)) (=> (= (ControlFlow 0 12) 11) anon49_Else_correct)))))
(let ((anon28_correct  (=> (and (and (<= (LitInt 0) |j#8@0|) (< |j#8@0| (|Seq#Length| |bots#0|))) (or (not (= |j#8@0| |n#0|)) (not true))) (and (=> (= (ControlFlow 0 14) (- 0 19)) (and (<= 0 |j#8@0|) (< |j#8@0| (|Seq#Length| |bots#0|)))) (=> (and (<= 0 |j#8@0|) (< |j#8@0| (|Seq#Length| |bots#0|))) (and (=> (= (ControlFlow 0 14) (- 0 18)) (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |j#8@0|)) null)) (not true))) (=> (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |j#8@0|)) null)) (not true)) (and (=> (= (ControlFlow 0 14) (- 0 17)) (and (<= 0 |j#8@0|) (< |j#8@0| (|Seq#Length| |bots#0|)))) (=> (and (<= 0 |j#8@0|) (< |j#8@0| (|Seq#Length| |bots#0|))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |j#8@0|)) null)) (not true))) (=> (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |j#8@0|)) null)) (not true)) (and (=> (= (ControlFlow 0 14) (- 0 15)) ($IsAlloc refType ($Unbox refType (|Seq#Index| |bots#0| |j#8@0|)) Tclass._module.Bot $Heap@@8)) (=> ($IsAlloc refType ($Unbox refType (|Seq#Index| |bots#0| |j#8@0|)) Tclass._module.Bot $Heap@@8) (=> (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |j#8@0|))) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |j#8@0|))) _module.Bot.Repr))) (= (ControlFlow 0 14) 12)) anon30_correct))))))))))))))
(let ((anon47_Else_correct  (=> (and (< |j#8@0| (LitInt 0)) (= (ControlFlow 0 21) 14)) anon28_correct)))
(let ((anon47_Then_correct  (=> (and (<= (LitInt 0) |j#8@0|) (= (ControlFlow 0 20) 14)) anon28_correct)))
(let ((anon46_Else_correct  (=> (and (=> (and (and (<= (LitInt 0) |j#8@0|) (< |j#8@0| (|Seq#Length| |bots#0|))) (or (not (= |j#8@0| |n#0|)) (not true))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |j#8@0|))) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |j#8@0|))) _module.Bot.Repr)))) (= (ControlFlow 0 13) 12)) anon30_correct)))
(let ((anon25_correct  (=> (forall ((|j#7| Int) ) (!  (=> (and (<= (LitInt 0) |j#7|) (< |j#7| (|Seq#Length| |bots#0|))) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |j#7|))))
 :qid |FlyingRobotsdfy.235:18|
 :skolemid |650|
 :pattern ( ($Unbox refType (|Seq#Index| |bots#0| |j#7|)))
)) (and (=> (= (ControlFlow 0 22) (- 0 33)) (and (<= 0 |n#0|) (< |n#0| (|Seq#Length| |bots#0|)))) (=> (and (<= 0 |n#0|) (< |n#0| (|Seq#Length| |bots#0|))) (and (=> (= (ControlFlow 0 22) (- 0 32)) (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |n#0|)) null)) (not true))) (=> (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |n#0|)) null)) (not true)) (and (=> (= (ControlFlow 0 22) (- 0 31)) (and (<= 0 |n#0|) (< |n#0| (|Seq#Length| |bots#0|)))) (=> (and (<= 0 |n#0|) (< |n#0| (|Seq#Length| |bots#0|))) (and (=> (= (ControlFlow 0 22) (- 0 30)) (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |n#0|)) null)) (not true))) (=> (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |n#0|)) null)) (not true)) (and (=> (= (ControlFlow 0 22) (- 0 29)) ($IsAlloc refType ($Unbox refType (|Seq#Index| |bots#0| |n#0|)) Tclass._module.Bot $Heap@@8)) (=> ($IsAlloc refType ($Unbox refType (|Seq#Index| |bots#0| |n#0|)) Tclass._module.Bot $Heap@@8) (=> (and (forall (($o@@44 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |n#0|))) _module.Bot.Repr)) ($Box refType $o@@44)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |n#0|))) _module.Bot.Repr)) ($Box refType $o@@44)))) (or (not (= $o@@44 null)) (not true)))
 :qid |FlyingRobotsdfy.236:11|
 :skolemid |651|
 :pattern (  (or (not (= $o@@44 null)) (not true)))
)) (forall (($o@@45 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |n#0|))) _module.Bot.Repr)) ($Box refType $o@@45)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |n#0|))) _module.Bot.Repr)) ($Box refType $o@@45)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@45) alloc)))))
 :qid |FlyingRobotsdfy.236:11|
 :skolemid |652|
...
))) (and (=> (= (ControlFlow 0 22) (- 0 28)) (and (<= 0 |n#0|) (< |n#0| (|Seq#Length| |bots#0|)))) (=> (and (<= 0 |n#0|) (< |n#0| (|Seq#Length| |bots#0|))) (and (=> (= (ControlFlow 0 22) (- 0 27)) (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |n#0|)) null)) (not true))) (=> (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |n#0|)) null)) (not true)) (=> ($IsAllocBox (|Seq#Index| |bots#0| |n#0|) Tclass._module.Bot? $Heap@0) (and (=> (= (ControlFlow 0 22) (- 0 26)) (=> (U_2_bool (Lit boolType (bool_2_U true))) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |n#0|))))) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |n#0|))) (=> (and (|_module.Bot.robot__inv#canCall| $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |n#0|))) (_module.Bot.robot__inv $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |n#0|)))) (and (=> (= (ControlFlow 0 22) (- 0 25)) (and (<= 0 |n#0|) (< |n#0| (|Seq#Length| |bots#0|)))) (=> (and (<= 0 |n#0|) (< |n#0| (|Seq#Length| |bots#0|))) (and (=> (= (ControlFlow 0 22) (- 0 24)) (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |n#0|)) null)) (not true))) (=> (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |n#0|)) null)) (not true)) (=> ($IsAllocBox (|Seq#Index| |bots#0| |n#0|) Tclass._module.Bot? $Heap@0) (and (=> (= (ControlFlow 0 22) (- 0 23)) (=> (U_2_bool (Lit boolType (bool_2_U true))) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |n#0|))))) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |n#0|))) (=> (and (|_module.Bot.flying#canCall| $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |n#0|))) (_module.Bot.flying $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |n#0|)))) (and (and (=> (= (ControlFlow 0 22) 13) anon46_Else_correct) (=> (= (ControlFlow 0 22) 20) anon47_Then_correct)) (=> (= (ControlFlow 0 22) 21) anon47_Else_correct))))))))))))))))))))))))))))))))
(let ((anon23_correct  (=> (and (<= (LitInt 0) |j#6@0|) (< |j#6@0| (|Seq#Length| |bots#0|))) (and (=> (= (ControlFlow 0 35) (- 0 37)) (and (<= 0 |j#6@0|) (< |j#6@0| (|Seq#Length| |bots#0|)))) (=> (and (<= 0 |j#6@0|) (< |j#6@0| (|Seq#Length| |bots#0|))) (and (=> (= (ControlFlow 0 35) (- 0 36)) (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |j#6@0|)) null)) (not true))) (=> (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |j#6@0|)) null)) (not true)) (=> (and (and ($IsAllocBox (|Seq#Index| |bots#0| |j#6@0|) Tclass._module.Bot? $Heap@0) (|_module.Bot.Valid#canCall| $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |j#6@0|)))) (and (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |j#6@0|))) (= (ControlFlow 0 35) 22))) anon25_correct))))))))
(let ((anon45_Else_correct  (=> (and (< |j#6@0| (LitInt 0)) (= (ControlFlow 0 39) 35)) anon23_correct)))
(let ((anon45_Then_correct  (=> (and (<= (LitInt 0) |j#6@0|) (= (ControlFlow 0 38) 35)) anon23_correct)))
(let ((anon44_Else_correct  (=> (and (=> (and (<= (LitInt 0) |j#6@0|) (< |j#6@0| (|Seq#Length| |bots#0|))) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 ($Unbox refType (|Seq#Index| |bots#0| |j#6@0|)))) (= (ControlFlow 0 34) 22)) anon25_correct)))
(let ((anon20_correct  (=> (forall ((|j#5| Int) ) (!  (and (=> (and (<= (LitInt 0) |j#5|) (< |j#5| |n#0|)) (_module.Bot.robot__inv $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |j#5|)))) (=> (and (<= (LitInt 0) |j#5|) (< |j#5| |n#0|)) (_module.Bot.flying $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |j#5|)))))
 :qid |FlyingRobotsdfy.233:19|
 :skolemid |648|
 :pattern ( ($Unbox refType (|Seq#Index| |bots#0| |j#5|)))
)) (and (=> (= (ControlFlow 0 40) (- 0 42)) (and (<= 0 |n#0|) (< |n#0| (|Seq#Length| |bots#0|)))) (=> (and (<= 0 |n#0|) (< |n#0| (|Seq#Length| |bots#0|))) (and (=> (= (ControlFlow 0 40) (- 0 41)) (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |n#0|)) null)) (not true))) (=> (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |n#0|)) null)) (not true)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@46 T@U) ) (!  (=> (and (or (not (= $o@@46 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@46) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@46) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@46)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |n#0|))) _module.Bot.Repr)) ($Box refType $o@@46))))
 :qid |FlyingRobotsdfy.229:8|
 :skolemid |649|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@46))
)) ($HeapSucc $Heap@@8 $Heap@0))) (and (and (=> (= (ControlFlow 0 40) 34) anon44_Else_correct) (=> (= (ControlFlow 0 40) 38) anon45_Then_correct)) (=> (= (ControlFlow 0 40) 39) anon45_Else_correct))))))))))
(let ((anon18_correct  (=> (and (<= (LitInt 0) |j#4@0|) (< |j#4@0| |n#0|)) (and (=> (= (ControlFlow 0 44) (- 0 50)) (and (<= 0 |j#4@0|) (< |j#4@0| (|Seq#Length| |bots#0|)))) (=> (and (<= 0 |j#4@0|) (< |j#4@0| (|Seq#Length| |bots#0|))) (and (=> (= (ControlFlow 0 44) (- 0 49)) (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |j#4@0|)) null)) (not true))) (=> (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |j#4@0|)) null)) (not true)) (=> ($IsAllocBox (|Seq#Index| |bots#0| |j#4@0|) Tclass._module.Bot? $Heap@@8) (and (=> (= (ControlFlow 0 44) (- 0 48)) (=> (U_2_bool (Lit boolType (bool_2_U true))) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |j#4@0|))))) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |j#4@0|))) (=> (and (|_module.Bot.robot__inv#canCall| $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |j#4@0|))) (_module.Bot.robot__inv $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |j#4@0|)))) (and (=> (= (ControlFlow 0 44) (- 0 47)) (and (<= 0 |j#4@0|) (< |j#4@0| (|Seq#Length| |bots#0|)))) (=> (and (<= 0 |j#4@0|) (< |j#4@0| (|Seq#Length| |bots#0|))) (and (=> (= (ControlFlow 0 44) (- 0 46)) (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |j#4@0|)) null)) (not true))) (=> (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |j#4@0|)) null)) (not true)) (=> ($IsAllocBox (|Seq#Index| |bots#0| |j#4@0|) Tclass._module.Bot? $Heap@@8) (and (=> (= (ControlFlow 0 44) (- 0 45)) (=> (U_2_bool (Lit boolType (bool_2_U true))) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |j#4@0|))))) (=> (and (and (_module.Bot.Valid reveal__module.Bot.Valid $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |j#4@0|))) (|_module.Bot.flying#canCall| $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |j#4@0|)))) (and (_module.Bot.flying $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |j#4@0|))) (= (ControlFlow 0 44) 40))) anon20_correct))))))))))))))))))
(let ((anon43_Else_correct  (=> (and (< |j#4@0| (LitInt 0)) (= (ControlFlow 0 52) 44)) anon18_correct)))
(let ((anon43_Then_correct  (=> (and (<= (LitInt 0) |j#4@0|) (= (ControlFlow 0 51) 44)) anon18_correct)))
(let ((anon42_Else_correct  (=> (and (=> (and (<= (LitInt 0) |j#4@0|) (< |j#4@0| |n#0|)) (and (_module.Bot.robot__inv $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |j#4@0|))) (_module.Bot.flying $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |j#4@0|))))) (= (ControlFlow 0 43) 40)) anon20_correct)))
(let ((anon15_correct  (=> (forall ((|i#1| Int) (|j#3| Int) ) (!  (=> (and (and (<= (LitInt 0) |i#1|) (< |i#1| |j#3|)) (< |j#3| (|Seq#Length| |bots#0|))) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |i#1|))) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |j#3|))) _module.Bot.Repr))))
 :qid |FlyingRobotsdfy.232:19|
 :skolemid |647|
 :pattern ( ($Unbox refType (|Seq#Index| |bots#0| |j#3|)) ($Unbox refType (|Seq#Index| |bots#0| |i#1|)))
)) (and (and (=> (= (ControlFlow 0 53) 43) anon42_Else_correct) (=> (= (ControlFlow 0 53) 51) anon43_Then_correct)) (=> (= (ControlFlow 0 53) 52) anon43_Else_correct)))))
(let ((anon13_correct  (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |j#2@0|)) (< |j#2@0| (|Seq#Length| |bots#0|))) (and (=> (= (ControlFlow 0 55) (- 0 59)) (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |bots#0|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |bots#0|))) (and (=> (= (ControlFlow 0 55) (- 0 58)) (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |i#0@0|)) null)) (not true))) (=> (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |i#0@0|)) null)) (not true)) (and (=> (= (ControlFlow 0 55) (- 0 57)) (and (<= 0 |j#2@0|) (< |j#2@0| (|Seq#Length| |bots#0|)))) (=> (and (<= 0 |j#2@0|) (< |j#2@0| (|Seq#Length| |bots#0|))) (and (=> (= (ControlFlow 0 55) (- 0 56)) (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |j#2@0|)) null)) (not true))) (=> (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |j#2@0|)) null)) (not true)) (=> (and (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |i#0@0|))) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |j#2@0|))) _module.Bot.Repr))) (= (ControlFlow 0 55) 53)) anon15_correct))))))))))))
(let ((anon41_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |j#2@0|))) (= (ControlFlow 0 61) 55)) anon13_correct)))
(let ((anon41_Then_correct  (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |j#2@0|)) (= (ControlFlow 0 60) 55)) anon13_correct)))
(let ((anon40_Else_correct  (=> (< |i#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 63) 60) anon41_Then_correct) (=> (= (ControlFlow 0 63) 61) anon41_Else_correct)))))
(let ((anon40_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 62) 60) anon41_Then_correct) (=> (= (ControlFlow 0 62) 61) anon41_Else_correct)))))
(let ((anon39_Else_correct  (=> (and (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |j#2@0|)) (< |j#2@0| (|Seq#Length| |bots#0|))) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |i#0@0|))) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |j#2@0|))) _module.Bot.Repr)))) (= (ControlFlow 0 54) 53)) anon15_correct)))
(let ((anon8_correct  (=> (forall ((|j#1| Int) ) (!  (=> (and (<= (LitInt 0) |j#1|) (< |j#1| (|Seq#Length| |bots#0|))) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |j#1|))))
 :qid |FlyingRobotsdfy.231:19|
 :skolemid |646|
 :pattern ( ($Unbox refType (|Seq#Index| |bots#0| |j#1|)))
)) (and (and (=> (= (ControlFlow 0 64) 54) anon39_Else_correct) (=> (= (ControlFlow 0 64) 62) anon40_Then_correct)) (=> (= (ControlFlow 0 64) 63) anon40_Else_correct)))))
(let ((anon6_correct  (=> (and (<= (LitInt 0) |j#0@0|) (< |j#0@0| (|Seq#Length| |bots#0|))) (and (=> (= (ControlFlow 0 66) (- 0 68)) (and (<= 0 |j#0@0|) (< |j#0@0| (|Seq#Length| |bots#0|)))) (=> (and (<= 0 |j#0@0|) (< |j#0@0| (|Seq#Length| |bots#0|))) (and (=> (= (ControlFlow 0 66) (- 0 67)) (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |j#0@0|)) null)) (not true))) (=> (or (not (= ($Unbox refType (|Seq#Index| |bots#0| |j#0@0|)) null)) (not true)) (=> (and (and ($IsAllocBox (|Seq#Index| |bots#0| |j#0@0|) Tclass._module.Bot? $Heap@@8) (|_module.Bot.Valid#canCall| $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |j#0@0|)))) (and (_module.Bot.Valid reveal__module.Bot.Valid $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |j#0@0|))) (= (ControlFlow 0 66) 64))) anon8_correct))))))))
(let ((anon38_Else_correct  (=> (and (< |j#0@0| (LitInt 0)) (= (ControlFlow 0 70) 66)) anon6_correct)))
(let ((anon38_Then_correct  (=> (and (<= (LitInt 0) |j#0@0|) (= (ControlFlow 0 69) 66)) anon6_correct)))
(let ((anon37_Else_correct  (=> (and (=> (and (<= (LitInt 0) |j#0@0|) (< |j#0@0| (|Seq#Length| |bots#0|))) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |j#0@0|)))) (= (ControlFlow 0 65) 64)) anon8_correct)))
(let ((anon3_correct  (=> (and (<= (LitInt 0) |n#0|) (< |n#0| (|Seq#Length| |bots#0|))) (and (and (=> (= (ControlFlow 0 71) 65) anon37_Else_correct) (=> (= (ControlFlow 0 71) 69) anon38_Then_correct)) (=> (= (ControlFlow 0 71) 70) anon38_Else_correct)))))
(let ((anon36_Else_correct  (=> (and (< |n#0| (LitInt 0)) (= (ControlFlow 0 73) 71)) anon3_correct)))
(let ((anon36_Then_correct  (=> (and (<= (LitInt 0) |n#0|) (= (ControlFlow 0 72) 71)) anon3_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#6| null $Heap@@8 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 ($Unbox refType (|Seq#Index| |bots#0| |n#0|))) _module.Bot.Repr)))) (and (=> (= (ControlFlow 0 74) 72) anon36_Then_correct) (=> (= (ControlFlow 0 74) 73) anon36_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@8) ($IsHeapAnchor $Heap@@8)) (=> (and (and ($Is SeqType |bots#0| (TSeq Tclass._module.Bot)) ($IsAlloc SeqType |bots#0| (TSeq Tclass._module.Bot) $Heap@@8)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 75) 74))) anon0_correct))))
