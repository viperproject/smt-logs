...
(set-info :boogie-vc-id Impl$$_module.__default.LeastSignificantDigitIsAlmostMod)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (let ((|mod#0| (Mod (_module.__default.eval ($LS ($LS $LZ)) |a#0| |base#0@@5|) |base#0@@5|)))
 (or (= (U_2_int ($Unbox intType (|Seq#Index| |a#0| (LitInt 0)))) |mod#0|) (= (U_2_int ($Unbox intType (|Seq#Index| |a#0| (LitInt 0)))) (- |mod#0| |base#0@@5|)))))))
(let ((anon3_Else_correct  (=> (< (U_2_int ($Unbox intType (|Seq#Index| |a#0| (LitInt 0)))) (LitInt 0)) (and (=> (= (ControlFlow 0 10) (- 0 16)) (=> (|_module.__default.IsSkewNumber#canCall| |a#0| |lowDigit#0@@1| |base#0@@5|) (or (_module.__default.IsSkewNumber |a#0| |lowDigit#0@@1| |base#0@@5|) (<= (LitInt 2) |base#0@@5|)))) (=> (=> (|_module.__default.IsSkewNumber#canCall| |a#0| |lowDigit#0@@1| |base#0@@5|) (or (_module.__default.IsSkewNumber |a#0| |lowDigit#0@@1| |base#0@@5|) (<= (LitInt 2) |base#0@@5|))) (and (=> (= (ControlFlow 0 10) (- 0 15)) (=> (|_module.__default.IsSkewNumber#canCall| |a#0| |lowDigit#0@@1| |base#0@@5|) (or (_module.__default.IsSkewNumber |a#0| |lowDigit#0@@1| |base#0@@5|) (<= |lowDigit#0@@1| (LitInt 0))))) (=> (=> (|_module.__default.IsSkewNumber#canCall| |a#0| |lowDigit#0@@1| |base#0@@5|) (or (_module.__default.IsSkewNumber |a#0| |lowDigit#0@@1| |base#0@@5|) (<= |lowDigit#0@@1| (LitInt 0)))) (and (=> (= (ControlFlow 0 10) (- 0 14)) (=> (|_module.__default.IsSkewNumber#canCall| |a#0| |lowDigit#0@@1| |base#0@@5|) (or (_module.__default.IsSkewNumber |a#0| |lowDigit#0@@1| |base#0@@5|) (< 0 (+ |lowDigit#0@@1| |base#0@@5|))))) (=> (=> (|_module.__default.IsSkewNumber#canCall| |a#0| |lowDigit#0@@1| |base#0@@5|) (or (_module.__default.IsSkewNumber |a#0| |lowDigit#0@@1| |base#0@@5|) (< 0 (+ |lowDigit#0@@1| |base#0@@5|)))) (and (=> (= (ControlFlow 0 10) (- 0 13)) (=> (|_module.__default.IsSkewNumber#canCall| |a#0| |lowDigit#0@@1| |base#0@@5|) (or (_module.__default.IsSkewNumber |a#0| |lowDigit#0@@1| |base#0@@5|) (forall ((|i#0@@0| Int) ) (!  (and (=> (and (<= (LitInt 0) |i#0@@0|) (< |i#0@@0| (|Seq#Length| |a#0|))) (<= |lowDigit#0@@1| (U_2_int ($Unbox intType (|Seq#Index| |a#0| |i#0@@0|))))) (=> (and (<= (LitInt 0) |i#0@@0|) (< |i#0@@0| (|Seq#Length| |a#0|))) (< (U_2_int ($Unbox intType (|Seq#Index| |a#0| |i#0@@0|))) (+ |lowDigit#0@@1| |base#0@@5|))))
 :qid |NumberRepresentationsdfy.45:10|
 :skolemid |708|
 :pattern ( ($Unbox intType (|Seq#Index| |a#0| |i#0@@0|)))
))))) (=> (=> (|_module.__default.IsSkewNumber#canCall| |a#0| |lowDigit#0@@1| |base#0@@5|) (or (_module.__default.IsSkewNumber |a#0| |lowDigit#0@@1| |base#0@@5|) (forall ((|i#0@@1| Int) ) (!  (and (=> (and (<= (LitInt 0) |i#0@@1|) (< |i#0@@1| (|Seq#Length| |a#0|))) (<= |lowDigit#0@@1| (U_2_int ($Unbox intType (|Seq#Index| |a#0| |i#0@@1|))))) (=> (and (<= (LitInt 0) |i#0@@1|) (< |i#0@@1| (|Seq#Length| |a#0|))) (< (U_2_int ($Unbox intType (|Seq#Index| |a#0| |i#0@@1|))) (+ |lowDigit#0@@1| |base#0@@5|))))
 :qid |NumberRepresentationsdfy.45:10|
 :skolemid |708|
 :pattern ( ($Unbox intType (|Seq#Index| |a#0| |i#0@@1|)))
)))) (and (=> (= (ControlFlow 0 10) (- 0 12)) (not (|Seq#Equal| |a#0| |Seq#Empty|))) (=> (not (|Seq#Equal| |a#0| |Seq#Empty|)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (< (U_2_int ($Unbox intType (|Seq#Index| |a#0| (LitInt 0)))) 0)) (=> (< (U_2_int ($Unbox intType (|Seq#Index| |a#0| (LitInt 0)))) 0) (=> (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (=> (and (and (|_module.__default.eval#canCall| |a#0| |base#0@@5|) (= (Mod (_module.__default.eval ($LS ($LS $LZ)) |a#0| |base#0@@5|) |base#0@@5|) (+ (U_2_int ($Unbox intType (|Seq#Index| |a#0| (LitInt 0)))) |base#0@@5|))) (and (= $Heap@0 $Heap@2) (= (ControlFlow 0 10) 2))) GeneratedUnifiedExit_correct)))))))))))))))))
(let ((anon3_Then_correct  (=> (<= (LitInt 0) (U_2_int ($Unbox intType (|Seq#Index| |a#0| (LitInt 0))))) (and (=> (= (ControlFlow 0 3) (- 0 9)) (=> (|_module.__default.IsSkewNumber#canCall| |a#0| |lowDigit#0@@1| |base#0@@5|) (or (_module.__default.IsSkewNumber |a#0| |lowDigit#0@@1| |base#0@@5|) (<= (LitInt 2) |base#0@@5|)))) (=> (=> (|_module.__default.IsSkewNumber#canCall| |a#0| |lowDigit#0@@1| |base#0@@5|) (or (_module.__default.IsSkewNumber |a#0| |lowDigit#0@@1| |base#0@@5|) (<= (LitInt 2) |base#0@@5|))) (and (=> (= (ControlFlow 0 3) (- 0 8)) (=> (|_module.__default.IsSkewNumber#canCall| |a#0| |lowDigit#0@@1| |base#0@@5|) (or (_module.__default.IsSkewNumber |a#0| |lowDigit#0@@1| |base#0@@5|) (<= |lowDigit#0@@1| (LitInt 0))))) (=> (=> (|_module.__default.IsSkewNumber#canCall| |a#0| |lowDigit#0@@1| |base#0@@5|) (or (_module.__default.IsSkewNumber |a#0| |lowDigit#0@@1| |base#0@@5|) (<= |lowDigit#0@@1| (LitInt 0)))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (=> (|_module.__default.IsSkewNumber#canCall| |a#0| |lowDigit#0@@1| |base#0@@5|) (or (_module.__default.IsSkewNumber |a#0| |lowDigit#0@@1| |base#0@@5|) (< 0 (+ |lowDigit#0@@1| |base#0@@5|))))) (=> (=> (|_module.__default.IsSkewNumber#canCall| |a#0| |lowDigit#0@@1| |base#0@@5|) (or (_module.__default.IsSkewNumber |a#0| |lowDigit#0@@1| |base#0@@5|) (< 0 (+ |lowDigit#0@@1| |base#0@@5|)))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (=> (|_module.__default.IsSkewNumber#canCall| |a#0| |lowDigit#0@@1| |base#0@@5|) (or (_module.__default.IsSkewNumber |a#0| |lowDigit#0@@1| |base#0@@5|) (forall ((|i#0@@2| Int) ) (!  (and (=> (and (<= (LitInt 0) |i#0@@2|) (< |i#0@@2| (|Seq#Length| |a#0|))) (<= |lowDigit#0@@1| (U_2_int ($Unbox intType (|Seq#Index| |a#0| |i#0@@2|))))) (=> (and (<= (LitInt 0) |i#0@@2|) (< |i#0@@2| (|Seq#Length| |a#0|))) (< (U_2_int ($Unbox intType (|Seq#Index| |a#0| |i#0@@2|))) (+ |lowDigit#0@@1| |base#0@@5|))))
 :qid |NumberRepresentationsdfy.45:10|
 :skolemid |701|
...
)))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (not (|Seq#Equal| |a#0| |Seq#Empty|))) (=> (not (|Seq#Equal| |a#0| |Seq#Empty|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= (LitInt 0) (U_2_int ($Unbox intType (|Seq#Index| |a#0| (LitInt 0)))))) (=> (<= (LitInt 0) (U_2_int ($Unbox intType (|Seq#Index| |a#0| (LitInt 0))))) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (|_module.__default.eval#canCall| |a#0| |base#0@@5|) (= (Mod (_module.__default.eval ($LS ($LS $LZ)) |a#0| |base#0@@5|) |base#0@@5|) (U_2_int ($Unbox intType (|Seq#Index| |a#0| (LitInt 0)))))) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct)))))))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#a0#0| T@U) (|$ih#base0#0| Int) ) (!  (=> (and (and ($Is SeqType |$ih#a0#0| (TSeq TInt)) (and (_module.__default.IsSkewNumber |$ih#a0#0| |lowDigit#0@@1| |$ih#base0#0|) (not (|Seq#Equal| |$ih#a0#0| |Seq#Empty|)))) (or (< (|Seq#Rank| |$ih#a0#0|) (|Seq#Rank| |a#0|)) (and (= (|Seq#Rank| |$ih#a0#0|) (|Seq#Rank| |a#0|)) (or (and (<= 0 |lowDigit#0@@1|) (< |lowDigit#0@@1| |lowDigit#0@@1|)) (and (= |lowDigit#0@@1| |lowDigit#0@@1|) (and (<= 0 |$ih#base0#0|) (< |$ih#base0#0| |base#0@@5|))))))) (let ((|mod#1| (Mod (_module.__default.eval ($LS $LZ) |$ih#a0#0| |$ih#base0#0|) |$ih#base0#0|)))
 (or (= (U_2_int ($Unbox intType (|Seq#Index| |$ih#a0#0| (LitInt 0)))) |mod#1|) (= (U_2_int ($Unbox intType (|Seq#Index| |$ih#a0#0| (LitInt 0)))) (- |mod#1| |$ih#base0#0|)))))
 :qid |NumberRepresentationsdfy.360:40|
 :skolemid |698|
...
)))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |a#0|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |a#0|))) (and (=> (= (ControlFlow 0 17) 3) anon3_Then_correct) (=> (= (ControlFlow 0 17) 10) anon3_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SeqType |a#0| (TSeq TInt)) ($IsAlloc SeqType |a#0| (TSeq TInt) $Heap)) (= 3 $FunctionContextHeight)) (and (and (|_module.__default.IsSkewNumber#canCall| |a#0| |lowDigit#0@@1| |base#0@@5|) (and (_module.__default.IsSkewNumber |a#0| |lowDigit#0@@1| |base#0@@5|) (and (and (<= (LitInt 2) |base#0@@5|) (and (<= |lowDigit#0@@1| (LitInt 0)) (< 0 (+ |lowDigit#0@@1| |base#0@@5|)))) (forall ((|i#1@@0| Int) ) (!  (and (=> (and (<= (LitInt 0) |i#1@@0|) (< |i#1@@0| (|Seq#Length| |a#0|))) (<= |lowDigit#0@@1| (U_2_int ($Unbox intType (|Seq#Index| |a#0| |i#1@@0|))))) (=> (and (<= (LitInt 0) |i#1@@0|) (< |i#1@@0| (|Seq#Length| |a#0|))) (< (U_2_int ($Unbox intType (|Seq#Index| |a#0| |i#1@@0|))) (+ |lowDigit#0@@1| |base#0@@5|))))
 :qid |NumberRepresentationsdfy.45:10|
 :skolemid |697|
 :pattern ( ($Unbox intType (|Seq#Index| |a#0| |i#1@@0|)))
))))) (and (not (|Seq#Equal| |a#0| |Seq#Empty|)) (= (ControlFlow 0 19) 17)))) anon0_correct))))
