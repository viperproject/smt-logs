...
(declare-fun |n9#0@0| () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |n3#0| () T@U)
(declare-fun |n9#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.test__mult)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |n3#0@0| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType |#_module.Nat.O|))))))))) (=> (and (and (= |n9#0@0| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType |#_module.Nat.O|)))))))))))))))))))) ($IsAlloc DatatypeTypeType |n3#0@0| Tclass._module.Nat $Heap)) (and ($IsAlloc DatatypeTypeType |n3#0@0| Tclass._module.Nat $Heap) (|_module.__default.mult#canCall| |n3#0@0| |n3#0@0|))) (=> (and (and (and (|$IsA#_module.Nat| (_module.__default.mult ($LS $LZ) |n3#0@0| |n3#0@0|)) (|$IsA#_module.Nat| |n9#0@0|)) (|_module.__default.mult#canCall| |n3#0@0| |n3#0@0|)) (= (ControlFlow 0 2) (- 0 1))) (|_module.Nat#Equal| (_module.__default.mult ($LS ($LS $LZ)) |n3#0@0| |n3#0@0|) |n9#0@0|))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |n3#0| Tclass._module.Nat) ($IsAlloc DatatypeTypeType |n3#0| Tclass._module.Nat $Heap)) true) (=> (and (and (and ($Is DatatypeTypeType |n9#0| Tclass._module.Nat) ($IsAlloc DatatypeTypeType |n9#0| Tclass._module.Nat $Heap)) true) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct)))))
