...
(set-info :boogie-vc-id Impl$$_module.__default.negb__involutive)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|_module.Bool#Equal| (_module.__default.negb (_module.__default.negb |b#0@@2|)) |b#0@@2|))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |b#0@@2| Tclass._module.Bool) ($IsAlloc DatatypeTypeType |b#0@@2| Tclass._module.Bool $Heap)) (|$IsA#_module.Bool| |b#0@@2|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
