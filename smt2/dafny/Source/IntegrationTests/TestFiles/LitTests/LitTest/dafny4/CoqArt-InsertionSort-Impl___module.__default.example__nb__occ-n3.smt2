...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@1 T@U) (|z#0@@1| Int) (|l#0@@2| T@U) ) (!  (=> (or (|_module.__default.nb__occ#canCall| (LitInt |z#0@@1|) (Lit DatatypeTypeType |l#0@@2|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |l#0@@2| (Tclass._module.List TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |l#0@@2|)))))) (let ((|l'#3| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |l#0@@2|)))))
(|_module.__default.nb__occ#canCall| (LitInt |z#0@@1|) |l'#3|))) (= (_module.__default.nb__occ ($LS $ly@@1) (LitInt |z#0@@1|) (Lit DatatypeTypeType |l#0@@2|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |l#0@@2|)) 0 (let ((|l'#2| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |l#0@@2|)))))
(let ((|z'#2| (LitInt (U_2_int ($Unbox intType (_module.List.head (Lit DatatypeTypeType |l#0@@2|)))))))
(+ (ite (= (LitInt |z#0@@1|) |z'#2|) 1 0) (_module.__default.nb__occ ($LS $ly@@1) (LitInt |z#0@@1|) |l'#2|))))))))
 :qid |CoqArtInsertionSortdfy.34:16|
 :weight 3
 :skolemid |544|
 :pattern ( (_module.__default.nb__occ ($LS $ly@@1) (LitInt |z#0@@1|) (Lit DatatypeTypeType |l#0@@2|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) (|z#0@@2| Int) (|l#0@@3| T@U) ) (!  (=> (or (|_module.__default.nb__occ#canCall| |z#0@@2| |l#0@@3|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |l#0@@3| (Tclass._module.List TInt)))) (<= (LitInt 0) (_module.__default.nb__occ $ly@@2 |z#0@@2| |l#0@@3|)))
 :qid |CoqArtInsertionSortdfy.34:16|
 :skolemid |541|
 :pattern ( (_module.__default.nb__occ $ly@@2 |z#0@@2| |l#0@@3|))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.example__nb__occ__0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (= (LitInt (_module.__default.nb__occ ($LS ($LS $LZ)) (LitInt 3) (Lit DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 3))) (Lit DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 7))) (Lit DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 3))) (Lit DatatypeTypeType |#_module.List.Nil|))))))))) (LitInt 2)))))
