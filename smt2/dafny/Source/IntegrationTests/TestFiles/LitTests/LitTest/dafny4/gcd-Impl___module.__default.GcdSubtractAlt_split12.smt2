...
(declare-fun |b#2_0@0| () Int)
(declare-fun |newtype$check#2_0_0_1_0@0| () Int)
(declare-fun |a#2_0@0| () Int)
(declare-fun |newtype$check#2_0_0_1_1@0| () Int)
(declare-fun |newtype$check#2_0_0_1_2@0| () Int)
(declare-fun |b#2_1@0| () Int)
...
(set-info :boogie-vc-id Impl$$_module.__default.GcdSubtractAlt_split12)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon19_correct  (=> (or (and ($Is intType (int_2_U (LitInt 1)) Tclass._module.pos) (= (Mul |q#2_0@0| (LitInt 1)) (- |y#0@@3| |x#0@@10|))) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._module.pos) (= (Mul |q#2_0@0| (LitInt 0)) (- |y#0@@3| |x#0@@10|))) (exists ((|$as#b2_0#2_0| Int) ) (!  (and (<= (LitInt 1) |$as#b2_0#2_0|) (= (Mul |q#2_0@0| |$as#b2_0#2_0|) (- |y#0@@3| |x#0@@10|)))
 :qid |gcddfy.245:9|
 :skolemid |670|
)))) (=> (and (and (and (<= (LitInt 1) |b#2_0@0|) (= (Mul |q#2_0@0| |b#2_0@0|) (- |y#0@@3| |x#0@@10|))) (and (= |newtype$check#2_0_0_1_0@0| (Mul |q#2_0@0| |a#2_0@0|)) (<= (LitInt 1) |newtype$check#2_0_0_1_0@0|))) (and (and (= |newtype$check#2_0_0_1_1@0| (Mul |q#2_0@0| |b#2_0@0|)) (<= (LitInt 1) |newtype$check#2_0_0_1_1@0|)) (and (= |newtype$check#2_0_0_1_2@0| (+ (Mul |q#2_0@0| |a#2_0@0|) (Mul |q#2_0@0| |b#2_0@0|))) (= (ControlFlow 0 2) (- 0 1))))) (<= (LitInt 1) |newtype$check#2_0_0_1_2@0|)))))
