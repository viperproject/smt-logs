...
procedure {:verboseName "R (well-formedness)"} CheckWellFormed$$_module.__default.R(xs#0: DatatypeType
...
procedure {:verboseName "R (call)"} Call$$_module.__default.R(xs#0: DatatypeType
       where $Is(xs#0, Tclass._module.List())
         && $IsAlloc(xs#0, Tclass._module.List(), $Heap)
         && $IsA#_module.List(xs#0));
  modifies $Heap;
...
procedure {:verboseName "R (correctness)"} Impl$$_module.__default.R(xs#0: DatatypeType
       where $Is(xs#0, Tclass._module.List())
         && $IsAlloc(xs#0, Tclass._module.List(), $Heap)
         && $IsA#_module.List(xs#0))
    ...
    _module.__default.F#canCall(xs#0)
       ...
       ==> _module.__default.F(xs#0)
         == (if _module.List.Nil_q(xs#0)
           then 0
           else (if _module.List.Nil_q(_module.List._h1(xs#0))
             then (var x#0 := _module.List._h0(xs#0); LitInt(1))
             else (var tail#0 := _module.List._h1(_module.List._h1(xs#0)); 
              (var y#0 := _module.List._h0(_module.List._h1(xs#0)); 
                (var x#1 := _module.List._h0(xs#0); LitInt(2)))))));
    ...
    _module.__default.F#canCall(Lit(xs#0))
       ...
       ==> _module.__default.F(Lit(xs#0))
         == (if _module.List.Nil_q(Lit(xs#0))
           then 0
           else (if _module.List.Nil_q(Lit(_module.List._h1(Lit(xs#0))))
             then (var x#4 := LitInt(_module.List._h0(Lit(xs#0))); LitInt(1))
             else (var tail#2 := Lit(_module.List._h1(Lit(_module.List._h1(Lit(xs#0))))); 
              (var y#2 := LitInt(_module.List._h0(Lit(_module.List._h1(Lit(xs#0))))); 
                (var x#5 := LitInt(_module.List._h0(Lit(xs#0))); LitInt(2)))))));
}
...
axiom (forall xs#0: DatatypeType :: 
  ...
  $Is(xs#0, Tclass._module.List()) ==> _module.__default.F#requires(xs#0) == true);

procedure {:verboseName "F (well-formedness)"} CheckWellformed$$_module.__default.F(xs#0: DatatypeType where $Is(xs#0, Tclass._module.List()));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
