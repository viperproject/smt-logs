...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($Is intType (int_2_U (LitInt 3)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 3)) Tclass._System.nat) (=> (= |##m#0@0| (LitInt 3)) (=> (and ($IsAlloc intType (int_2_U |##m#0@0|) Tclass._System.nat $Heap) (= (ControlFlow 0 2) (- 0 1))) ($Is intType (int_2_U (LitInt 4)) Tclass._System.nat))))))))
