...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.IsPrime)
...
(let ((anon16_Else_correct  (=> (and (not (and (<= (LitInt 2) |m#2@0|) (< |m#2@0| |n#0@@1|))) (= (ControlFlow 0 7) 2)) anon10_correct)))
(let ((anon16_Then_correct  (=> (and (<= (LitInt 2) |m#2@0|) (< |m#2@0| |n#0@@1|)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= |m#2@0| 0)) (not true))) (=> (or (not (= |m#2@0| 0)) (not true)) (=> (= (ControlFlow 0 5) 2) anon10_correct))))))
(let ((anon15_Else_correct  (=> (< |m#2@0| (LitInt 2)) (and (=> (= (ControlFlow 0 9) 5) anon16_Then_correct) (=> (= (ControlFlow 0 9) 7) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (<= (LitInt 2) |m#2@0|) (and (=> (= (ControlFlow 0 8) 5) anon16_Then_correct) (=> (= (ControlFlow 0 8) 7) anon16_Else_correct)))))
(let ((anon14_Then_correct  (and (=> (= (ControlFlow 0 10) 8) anon15_Then_correct) (=> (= (ControlFlow 0 10) 9) anon15_Else_correct))))
(let ((anon13_Then_correct  (=> (<= (LitInt 2) |n#0@@1|) (and (=> (= (ControlFlow 0 11) 10) anon14_Then_correct) (=> (= (ControlFlow 0 11) 4) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (< |n#0@@1| (LitInt 2)) (= (ControlFlow 0 3) 2)) anon10_correct)))
(let ((anon12_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 12) 1) anon12_Then_correct) (=> (= (ControlFlow 0 12) 11) anon13_Then_correct)) (=> (= (ControlFlow 0 12) 3) anon13_Else_correct)))))
