...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (|mat#0| T@U) ) (!  (=> (or (|_module.__default.existential#canCall| $Heap |mat#0|) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap) ($Is refType |mat#0| (Tclass._System.array2 TBool))))) (= (_module.__default.existential $Heap |mat#0|) (exists ((|i#0| Int) (|j#0| Int) ) (!  (and (and (and (<= (LitInt 0) |i#0|) (< |i#0| (_System.array2.Length0 |mat#0|))) (and (<= (LitInt 0) |j#0|) (< |j#0| (_System.array2.Length1 |mat#0|)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |mat#0|) (MultiIndexField (IndexField |i#0|) |j#0|)))))
 :qid |Bug145dfy.7:12|
 :skolemid |550|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |mat#0|) (MultiIndexField (IndexField |i#0|) |j#0|))))
))))
 :qid |Bug145dfy.4:16|
 :skolemid |551|
 :pattern ( (_module.__default.existential $Heap |mat#0|) ($IsGoodHeap $Heap))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.existential)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon11_correct  (=> (= (_module.__default.existential $Heap@@0 |mat#0@@0|) (exists ((|i#2| Int) (|j#2| Int) ) (!  (and (and (and (<= (LitInt 0) |i#2|) (< |i#2| (_System.array2.Length0 |mat#0@@0|))) (and (<= (LitInt 0) |j#2|) (< |j#2| (_System.array2.Length1 |mat#0@@0|)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |mat#0@@0|) (MultiIndexField (IndexField |i#2|) |j#2|)))))
 :qid |Bug145dfy.7:12|
 :skolemid |553|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |mat#0@@0|) (MultiIndexField (IndexField |i#2|) |j#2|))))
))) (=> (and ($Is boolType (bool_2_U (_module.__default.existential $Heap@@0 |mat#0@@0|)) TBool) (= (ControlFlow 0 4) (- 0 3))) |b$reqreads#0@1|))))
(let ((anon18_Else_correct  (=> (not (and (and (<= (LitInt 0) |i#1@0|) (< |i#1@0| (_System.array2.Length0 |mat#0@@0|))) (and (<= (LitInt 0) |j#1@0|) (< |j#1@0| (_System.array2.Length1 |mat#0@@0|))))) (=> (and (= |b$reqreads#0@1| true) (= (ControlFlow 0 9) 4)) anon11_correct))))
(let ((anon18_Then_correct  (=> (and (and (<= (LitInt 0) |i#1@0|) (< |i#1@0| (_System.array2.Length0 |mat#0@@0|))) (and (<= (LitInt 0) |j#1@0|) (< |j#1@0| (_System.array2.Length1 |mat#0@@0|)))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (or (not (= |mat#0@@0| null)) (not true))) (=> (or (not (= |mat#0@@0| null)) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (and (<= 0 |i#1@0|) (< |i#1@0| (_System.array2.Length0 |mat#0@@0|)))) (=> (and (<= 0 |i#1@0|) (< |i#1@0| (_System.array2.Length0 |mat#0@@0|))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (and (<= 0 |j#1@0|) (< |j#1@0| (_System.array2.Length1 |mat#0@@0|)))) (=> (and (<= 0 |j#1@0|) (< |j#1@0| (_System.array2.Length1 |mat#0@@0|))) (=> (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |mat#0@@0| (MultiIndexField (IndexField |i#1@0|) |j#1@0|)))) (=> (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= (ControlFlow 0 5) 4)) anon11_correct)))))))))))
(let ((anon17_Else_correct  (=> (< |j#1@0| (LitInt 0)) (and (=> (= (ControlFlow 0 13) 5) anon18_Then_correct) (=> (= (ControlFlow 0 13) 9) anon18_Else_correct)))))
(let ((anon17_Then_correct  (=> (<= (LitInt 0) |j#1@0|) (and (=> (= (ControlFlow 0 11) (- 0 12)) (or (not (= |mat#0@@0| null)) (not true))) (=> (or (not (= |mat#0@@0| null)) (not true)) (and (=> (= (ControlFlow 0 11) 5) anon18_Then_correct) (=> (= (ControlFlow 0 11) 9) anon18_Else_correct)))))))
(let ((anon16_Then_correct  (=> (and (<= (LitInt 0) |i#1@0|) (< |i#1@0| (_System.array2.Length0 |mat#0@@0|))) (and (=> (= (ControlFlow 0 14) 11) anon17_Then_correct) (=> (= (ControlFlow 0 14) 13) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (not (and (<= (LitInt 0) |i#1@0|) (< |i#1@0| (_System.array2.Length0 |mat#0@@0|)))) (and (=> (= (ControlFlow 0 10) 5) anon18_Then_correct) (=> (= (ControlFlow 0 10) 9) anon18_Else_correct)))))
(let ((anon15_Else_correct  (=> (< |i#1@0| (LitInt 0)) (and (=> (= (ControlFlow 0 17) 14) anon16_Then_correct) (=> (= (ControlFlow 0 17) 10) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (<= (LitInt 0) |i#1@0|) (and (=> (= (ControlFlow 0 15) (- 0 16)) (or (not (= |mat#0@@0| null)) (not true))) (=> (or (not (= |mat#0@@0| null)) (not true)) (and (=> (= (ControlFlow 0 15) 14) anon16_Then_correct) (=> (= (ControlFlow 0 15) 10) anon16_Else_correct)))))))
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@0 alloc |mat#0@@0|)) (and (and (=> (= (ControlFlow 0 19) 1) anon13_Then_correct) (=> (= (ControlFlow 0 19) 18) anon14_Then_correct)) (=> (= (ControlFlow 0 19) 2) anon14_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) ($Is refType |mat#0@@0| (Tclass._System.array2 TBool))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 20) 19))) anon0_correct)))
