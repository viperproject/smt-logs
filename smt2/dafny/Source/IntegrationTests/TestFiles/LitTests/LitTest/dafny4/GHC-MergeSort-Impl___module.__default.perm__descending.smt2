...
(declare-fun $Heap@@2 () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.perm__descending)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 38) (let ((anon21_Then_correct  (=> (and (and (_module.List.Cons_q |ys#0@@13|) (= |##xs#0_0_0_0@0| (|#_module.List.Cons| |a#0@@15| |xs#0@@28|))) (and ($IsAlloc DatatypeTypeType |##xs#0_0_0_0@0| (Tclass._module.List Tclass._module.G) $Heap@0) (|_module.__default.multiset__of#canCall| Tclass._module.G (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)))) (=> (and (and (and (_module.List.Cons_q |ys#0@@13|) (= |##xs#0_0_0_1@0| (_module.List.tail |ys#0@@13|))) (and ($IsAlloc DatatypeTypeType |##xs#0_0_0_1@0| (Tclass._module.List Tclass._module.G) $Heap@0) (|_module.__default.multiset__of#canCall| Tclass._module.G (_module.List.tail |ys#0@@13|)))) (and (and (|_module.__default.multiset__of#canCall| Tclass._module.G (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)) (|_module.__default.multiset__of#canCall| Tclass._module.G (_module.List.tail |ys#0@@13|))) (and ($IsAlloc DatatypeTypeType |xs#0@@28| (Tclass._module.List Tclass._module.G) $Heap@0) (|_module.__default.multiset__of#canCall| Tclass._module.G |xs#0@@28|)))) (and (=> (= (ControlFlow 0 28) (- 0 30)) (_module.List.Cons_q |ys#0@@13|)) (=> (_module.List.Cons_q |ys#0@@13|) (and (=> (= (ControlFlow 0 28) (- 0 29)) (_module.List.Cons_q |ys#0@@13|)) (=> (_module.List.Cons_q |ys#0@@13|) (=> (= |##xs#0_0_0_3@0| (|#_module.List.Cons| (_module.List.head |ys#0@@13|) (_module.List.tail |ys#0@@13|))) (=> (and ($IsAlloc DatatypeTypeType |##xs#0_0_0_3@0| (Tclass._module.List Tclass._module.G) $Heap@0) (|_module.__default.multiset__of#canCall| Tclass._module.G (|#_module.List.Cons| (_module.List.head |ys#0@@13|) (_module.List.tail |ys#0@@13|)))) (=> (and (and (|_module.__default.multiset__of#canCall| Tclass._module.G |xs#0@@28|) (|_module.__default.multiset__of#canCall| Tclass._module.G (|#_module.List.Cons| (_module.List.head |ys#0@@13|) (_module.List.tail |ys#0@@13|)))) (= (ControlFlow 0 28) (- 0 27))) (|MultiSet#Equal| (|MultiSet#Union| (|MultiSet#Union| (|MultiSet#UnionOne| |MultiSet#Empty| (_module.List.head |ys#0@@13|)) (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) (|#_module.List.Cons| |a#0@@15| |xs#0@@28|))) (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) (_module.List.tail |ys#0@@13|))) (|MultiSet#Union| (|MultiSet#Union| (|MultiSet#UnionOne| |MultiSet#Empty| |a#0@@15|) (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |xs#0@@28|)) (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) (|#_module.List.Cons| (_module.List.head |ys#0@@13|) (_module.List.tail |ys#0@@13|))))))))))))))))
(let ((anon20_Then_correct  (=> (and (_module.List.Cons_q |ys#0@@13|) (= |##a#0_0_1_0@0| (_module.List.head |ys#0@@13|))) (=> (and (and ($IsAllocBox |##a#0_0_1_0@0| Tclass._module.G $Heap@0) (= |##xs#0_0_1_1@0| (|#_module.List.Cons| |a#0@@15| |xs#0@@28|))) (and ($IsAlloc DatatypeTypeType |##xs#0_0_1_1@0| (Tclass._module.List Tclass._module.G) $Heap@0) (_module.List.Cons_q |ys#0@@13|))) (=> (and (and (and (= |##ys#0_0_1_0@0| (_module.List.tail |ys#0@@13|)) ($IsAlloc DatatypeTypeType |##ys#0_0_1_0@0| (Tclass._module.List Tclass._module.G) $Heap@0)) (and (|_module.__default.descending#canCall| (_module.List.head |ys#0@@13|) (|#_module.List.Cons| |a#0@@15| |xs#0@@28|) (_module.List.tail |ys#0@@13|)) (= |##xs#0_0_1_0@0| (_module.__default.descending ($LS $LZ) (_module.List.head |ys#0@@13|) (|#_module.List.Cons| |a#0@@15| |xs#0@@28|) (_module.List.tail |ys#0@@13|))))) (and (and ($IsAlloc DatatypeTypeType |##xs#0_0_1_0@0| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@0) (|_module.__default.MultisetUnion#canCall| Tclass._module.G (_module.__default.descending ($LS $LZ) (_module.List.head |ys#0@@13|) (|#_module.List.Cons| |a#0@@15| |xs#0@@28|) (_module.List.tail |ys#0@@13|)))) (and (|_module.__default.descending#canCall| (_module.List.head |ys#0@@13|) (|#_module.List.Cons| |a#0@@15| |xs#0@@28|) (_module.List.tail |ys#0@@13|)) (|_module.__default.MultisetUnion#canCall| Tclass._module.G (_module.__default.descending ($LS $LZ) (_module.List.head |ys#0@@13|) (|#_module.List.Cons| |a#0@@15| |xs#0@@28|) (_module.List.tail |ys#0@@13|)))))) (and (=> (= (ControlFlow 0 21) (- 0 26)) (_module.List.Cons_q |ys#0@@13|)) (=> (_module.List.Cons_q |ys#0@@13|) (=> (and (= |a##0_0_1_0@0| (_module.List.head |ys#0@@13|)) (= |xs##0_0_1_0@0| (|#_module.List.Cons| |a#0@@15| |xs#0@@28|))) (and (=> (= (ControlFlow 0 21) (- 0 25)) (_module.List.Cons_q |ys#0@@13|)) (=> (_module.List.Cons_q |ys#0@@13|) (=> (= |ys##0_0_1_0@0| (_module.List.tail |ys#0@@13|)) (and (=> (= (ControlFlow 0 21) (- 0 24)) (< (DtRank |ys##0_0_1_0@0|) (DtRank |ys#0@@13|))) (=> (< (DtRank |ys##0_0_1_0@0|) (DtRank |ys#0@@13|)) (=> (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (=> (and (and (and (|_module.__default.descending#canCall| |a##0_0_1_0@0| |xs##0_0_1_0@0| |ys##0_0_1_0@0|) (|_module.__default.MultisetUnion#canCall| Tclass._module.G (_module.__default.descending ($LS $LZ) |a##0_0_1_0@0| |xs##0_0_1_0@0| |ys##0_0_1_0@0|))) (and (|_module.__default.multiset__of#canCall| Tclass._module.G |xs##0_0_1_0@0|) (|_module.__default.multiset__of#canCall| Tclass._module.G |ys##0_0_1_0@0|))) (and (|MultiSet#Equal| (_module.__default.MultisetUnion Tclass._module.G ($LS ($LS $LZ)) (_module.__default.descending ($LS ($LS $LZ)) |a##0_0_1_0@0| |xs##0_0_1_0@0| |ys##0_0_1_0@0|)) (|MultiSet#Union| (|MultiSet#Union| (|MultiSet#UnionOne| |MultiSet#Empty| |a##0_0_1_0@0|) (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |xs##0_0_1_0@0|)) (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |ys##0_0_1_0@0|))) (= $Heap@0 $Heap@2))) (and (=> (= (ControlFlow 0 21) (- 0 23)) (_module.List.Cons_q |ys#0@@13|)) (=> (_module.List.Cons_q |ys#0@@13|) (=> (= |##xs#0_0_1_2@0| (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)) (=> (and ($IsAlloc DatatypeTypeType |##xs#0_0_1_2@0| (Tclass._module.List Tclass._module.G) $Heap@2) (|_module.__default.multiset__of#canCall| Tclass._module.G (|#_module.List.Cons| |a#0@@15| |xs#0@@28|))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (_module.List.Cons_q |ys#0@@13|)) (=> (_module.List.Cons_q |ys#0@@13|) (=> (= |##xs#0_0_1_3@0| (_module.List.tail |ys#0@@13|)) (=> (and ($IsAlloc DatatypeTypeType |##xs#0_0_1_3@0| (Tclass._module.List Tclass._module.G) $Heap@2) (|_module.__default.multiset__of#canCall| Tclass._module.G (_module.List.tail |ys#0@@13|))) (=> (and (and (|_module.__default.multiset__of#canCall| Tclass._module.G (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)) (|_module.__default.multiset__of#canCall| Tclass._module.G (_module.List.tail |ys#0@@13|))) (= (ControlFlow 0 21) (- 0 20))) (|MultiSet#Equal| (_module.__default.MultisetUnion Tclass._module.G ($LS ($LS $LZ)) (_module.__default.descending ($LS ($LS $LZ)) (_module.List.head |ys#0@@13|) (|#_module.List.Cons| |a#0@@15| |xs#0@@28|) (_module.List.tail |ys#0@@13|))) (|MultiSet#Union| (|MultiSet#Union| (|MultiSet#UnionOne| |MultiSet#Empty| (_module.List.head |ys#0@@13|)) (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) (|#_module.List.Cons| |a#0@@15| |xs#0@@28|))) (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) (_module.List.tail |ys#0@@13|))))))))))))))))))))))))))))
(let ((anon19_Then_correct  (=> ($IsAllocBox |a#0@@15| Tclass._module.G $Heap@0) (=> (and (and (and ($IsAlloc DatatypeTypeType |xs#0@@28| (Tclass._module.List Tclass._module.G) $Heap@0) ($IsAlloc DatatypeTypeType |ys#0@@13| (Tclass._module.List Tclass._module.G) $Heap@0)) (and (|_module.__default.descending#canCall| |a#0@@15| |xs#0@@28| |ys#0@@13|) (= |##xs#0_0_2_0@0| (_module.__default.descending ($LS $LZ) |a#0@@15| |xs#0@@28| |ys#0@@13|)))) (and (and ($IsAlloc DatatypeTypeType |##xs#0_0_2_0@0| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@0) (|_module.__default.MultisetUnion#canCall| Tclass._module.G (_module.__default.descending ($LS $LZ) |a#0@@15| |xs#0@@28| |ys#0@@13|))) (and (|_module.__default.descending#canCall| |a#0@@15| |xs#0@@28| |ys#0@@13|) (|_module.__default.MultisetUnion#canCall| Tclass._module.G (_module.__default.descending ($LS $LZ) |a#0@@15| |xs#0@@28| |ys#0@@13|))))) (and (=> (= (ControlFlow 0 17) (- 0 19)) (_module.List.Cons_q |ys#0@@13|)) (=> (_module.List.Cons_q |ys#0@@13|) (=> (and (and (= |##a#0_0_2_1@0| (_module.List.head |ys#0@@13|)) ($IsAllocBox |##a#0_0_2_1@0| Tclass._module.G $Heap@0)) (and (= |##xs#0_0_2_3@0| (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)) ($IsAlloc DatatypeTypeType |##xs#0_0_2_3@0| (Tclass._module.List Tclass._module.G) $Heap@0))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (_module.List.Cons_q |ys#0@@13|)) (=> (_module.List.Cons_q |ys#0@@13|) (=> (and (= |##ys#0_0_2_1@0| (_module.List.tail |ys#0@@13|)) ($IsAlloc DatatypeTypeType |##ys#0_0_2_1@0| (Tclass._module.List Tclass._module.G) $Heap@0)) (=> (and (and (and (|_module.__default.descending#canCall| (_module.List.head |ys#0@@13|) (|#_module.List.Cons| |a#0@@15| |xs#0@@28|) (_module.List.tail |ys#0@@13|)) (= |##xs#0_0_2_2@0| (_module.__default.descending ($LS $LZ) (_module.List.head |ys#0@@13|) (|#_module.List.Cons| |a#0@@15| |xs#0@@28|) (_module.List.tail |ys#0@@13|)))) (and ($IsAlloc DatatypeTypeType |##xs#0_0_2_2@0| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@0) (|_module.__default.MultisetUnion#canCall| Tclass._module.G (_module.__default.descending ($LS $LZ) (_module.List.head |ys#0@@13|) (|#_module.List.Cons| |a#0@@15| |xs#0@@28|) (_module.List.tail |ys#0@@13|))))) (and (and (|_module.__default.descending#canCall| (_module.List.head |ys#0@@13|) (|#_module.List.Cons| |a#0@@15| |xs#0@@28|) (_module.List.tail |ys#0@@13|)) (|_module.__default.MultisetUnion#canCall| Tclass._module.G (_module.__default.descending ($LS $LZ) (_module.List.head |ys#0@@13|) (|#_module.List.Cons| |a#0@@15| |xs#0@@28|) (_module.List.tail |ys#0@@13|)))) (= (ControlFlow 0 17) (- 0 16)))) (|MultiSet#Equal| (_module.__default.MultisetUnion Tclass._module.G ($LS ($LS $LZ)) (_module.__default.descending ($LS ($LS $LZ)) |a#0@@15| |xs#0@@28| |ys#0@@13|)) (_module.__default.MultisetUnion Tclass._module.G ($LS ($LS $LZ)) (_module.__default.descending ($LS ($LS $LZ)) (_module.List.head |ys#0@@13|) (|#_module.List.Cons| |a#0@@15| |xs#0@@28|) (_module.List.tail |ys#0@@13|)))))))))))))))
(let ((anon18_Then_correct true))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 12) (- 0 11)) (|MultiSet#Equal| (_module.__default.MultisetUnion Tclass._module.G ($LS ($LS $LZ)) (_module.__default.descending ($LS ($LS $LZ)) |a#0@@15| |xs#0@@28| |ys#0@@13|)) (|MultiSet#Union| (|MultiSet#Union| (|MultiSet#UnionOne| |MultiSet#Empty| |a#0@@15|) (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |xs#0@@28|)) (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |ys#0@@13|))))))
(let ((anon21_Else_correct  (=> (and (|MultiSet#Equal| (_module.__default.MultisetUnion Tclass._module.G ($LS $LZ) (_module.__default.descending ($LS $LZ) |a#0@@15| |xs#0@@28| |ys#0@@13|)) (|MultiSet#Union| (|MultiSet#Union| (|MultiSet#UnionOne| |MultiSet#Empty| |a#0@@15|) (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |xs#0@@28|)) (_module.__default.multiset__of Tclass._module.G ($LS $LZ) (|#_module.List.Cons| (_module.List.head |ys#0@@13|) (_module.List.tail |ys#0@@13|))))) (= (ControlFlow 0 31) 12)) GeneratedUnifiedExit_correct)))
(let ((anon17_Then_correct  (=> (and (_module.List.Cons_q |ys#0@@13|) (not (_module.__default.Below |a#0@@15| (_module.List.head |ys#0@@13|)))) (and (and (and (and (=> (= (ControlFlow 0 32) 15) anon18_Then_correct) (=> (= (ControlFlow 0 32) 17) anon19_Then_correct)) (=> (= (ControlFlow 0 32) 21) anon20_Then_correct)) (=> (= (ControlFlow 0 32) 28) anon21_Then_correct)) (=> (= (ControlFlow 0 32) 31) anon21_Else_correct)))))
(let ((anon26_Else_correct  (=> (and (|MultiSet#Equal| (_module.__default.MultisetUnion Tclass._module.G ($LS $LZ) (_module.__default.descending ($LS $LZ) |a#0@@15| |xs#0@@28| |ys#0@@13|)) (|MultiSet#Union| (|MultiSet#Union| (|MultiSet#UnionOne| |MultiSet#Empty| |a#0@@15|) (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |xs#0@@28|)) (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |ys#0@@13|))) (= (ControlFlow 0 13) 12)) GeneratedUnifiedExit_correct)))
(let ((anon26_Then_correct  (=> (= |##xs#1_0_0_0@0| (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)) (=> (and ($IsAlloc DatatypeTypeType |##xs#1_0_0_0@0| (Tclass._module.List Tclass._module.G) $Heap@0) (|_module.__default.multiset__of#canCall| Tclass._module.G (|#_module.List.Cons| |a#0@@15| |xs#0@@28|))) (=> (and (and ($IsAlloc DatatypeTypeType |ys#0@@13| (Tclass._module.List Tclass._module.G) $Heap@0) (|_module.__default.multiset__of#canCall| Tclass._module.G |ys#0@@13|)) (and (|_module.__default.multiset__of#canCall| Tclass._module.G (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)) (|_module.__default.multiset__of#canCall| Tclass._module.G |ys#0@@13|))) (=> (and (and (and ($IsAlloc DatatypeTypeType |xs#0@@28| (Tclass._module.List Tclass._module.G) $Heap@0) (|_module.__default.multiset__of#canCall| Tclass._module.G |xs#0@@28|)) (and ($IsAlloc DatatypeTypeType |ys#0@@13| (Tclass._module.List Tclass._module.G) $Heap@0) (|_module.__default.multiset__of#canCall| Tclass._module.G |ys#0@@13|))) (and (and (|_module.__default.multiset__of#canCall| Tclass._module.G |xs#0@@28|) (|_module.__default.multiset__of#canCall| Tclass._module.G |ys#0@@13|)) (= (ControlFlow 0 10) (- 0 9)))) (|MultiSet#Equal| (|MultiSet#Union| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)) (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |ys#0@@13|)) (|MultiSet#Union| (|MultiSet#Union| (|MultiSet#UnionOne| |MultiSet#Empty| |a#0@@15|) (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |xs#0@@28|)) (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |ys#0@@13|)))))))))
(let ((anon25_Then_correct  (=> (and (= |##xs#1_0_1_0@0| (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)) ($IsAlloc DatatypeTypeType |##xs#1_0_1_0@0| (Tclass._module.List Tclass._module.G) $Heap@0)) (=> (and (and (and (|_module.__default.multiset__of#canCall| Tclass._module.G (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)) ($IsAlloc DatatypeTypeType |ys#0@@13| (Tclass._module.List Tclass._module.G) $Heap@0)) (and (|_module.__default.sequences#canCall| |ys#0@@13|) (= |##xs#1_0_1_1@0| (_module.__default.sequences ($LS $LZ) |ys#0@@13|)))) (and (and ($IsAlloc DatatypeTypeType |##xs#1_0_1_1@0| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@0) (|_module.__default.MultisetUnion#canCall| Tclass._module.G (_module.__default.sequences ($LS $LZ) |ys#0@@13|))) (and (|_module.__default.multiset__of#canCall| Tclass._module.G (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)) (and (|_module.__default.sequences#canCall| |ys#0@@13|) (|_module.__default.MultisetUnion#canCall| Tclass._module.G (_module.__default.sequences ($LS $LZ) |ys#0@@13|)))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= (DtRank |ys#0@@13|) (DtRank |ys#0@@13|))) (=> (<= (DtRank |ys#0@@13|) (DtRank |ys#0@@13|)) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and (and (and (|_module.__default.sequences#canCall| |ys#0@@13|) (|_module.__default.MultisetUnion#canCall| Tclass._module.G (_module.__default.sequences ($LS $LZ) |ys#0@@13|))) (|_module.__default.multiset__of#canCall| Tclass._module.G |ys#0@@13|)) (|MultiSet#Equal| (_module.__default.MultisetUnion Tclass._module.G ($LS ($LS $LZ)) (_module.__default.sequences ($LS ($LS $LZ)) |ys#0@@13|)) (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |ys#0@@13|))) (and (= $Heap@0 $Heap@1) (= |##xs#1_0_1_3@0| (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)))) (and (and (and ($IsAlloc DatatypeTypeType |##xs#1_0_1_3@0| (Tclass._module.List Tclass._module.G) $Heap@1) (|_module.__default.multiset__of#canCall| Tclass._module.G (|#_module.List.Cons| |a#0@@15| |xs#0@@28|))) (and ($IsAlloc DatatypeTypeType |ys#0@@13| (Tclass._module.List Tclass._module.G) $Heap@1) (|_module.__default.multiset__of#canCall| Tclass._module.G |ys#0@@13|))) (and (and (|_module.__default.multiset__of#canCall| Tclass._module.G (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)) (|_module.__default.multiset__of#canCall| Tclass._module.G |ys#0@@13|)) (= (ControlFlow 0 7) (- 0 6))))) (|MultiSet#Equal| (|MultiSet#Union| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)) (_module.__default.MultisetUnion Tclass._module.G ($LS ($LS $LZ)) (_module.__default.sequences ($LS ($LS $LZ)) |ys#0@@13|))) (|MultiSet#Union| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)) (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |ys#0@@13|)))))))))))
(let ((anon24_Then_correct  (=> ($IsAlloc DatatypeTypeType |ys#0@@13| (Tclass._module.List Tclass._module.G) $Heap@0) (=> (and (|_module.__default.sequences#canCall| |ys#0@@13|) (= |##xs#1_0_2_0@0| (|#_module.List.Cons| ($Box DatatypeTypeType (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)) (_module.__default.sequences ($LS $LZ) |ys#0@@13|)))) (=> (and (and (and (and ($IsAlloc DatatypeTypeType |##xs#1_0_2_0@0| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@0) (|_module.__default.MultisetUnion#canCall| Tclass._module.G (|#_module.List.Cons| ($Box DatatypeTypeType (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)) (_module.__default.sequences ($LS $LZ) |ys#0@@13|)))) (and (|_module.__default.sequences#canCall| |ys#0@@13|) (|_module.__default.MultisetUnion#canCall| Tclass._module.G (|#_module.List.Cons| ($Box DatatypeTypeType (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)) (_module.__default.sequences ($LS $LZ) |ys#0@@13|))))) (and (and (= |##xs#1_0_2_2@0| (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)) ($IsAlloc DatatypeTypeType |##xs#1_0_2_2@0| (Tclass._module.List Tclass._module.G) $Heap@0)) (and (|_module.__default.multiset__of#canCall| Tclass._module.G (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)) ($IsAlloc DatatypeTypeType |ys#0@@13| (Tclass._module.List Tclass._module.G) $Heap@0)))) (and (and (and (|_module.__default.sequences#canCall| |ys#0@@13|) (= |##xs#1_0_2_3@0| (_module.__default.sequences ($LS $LZ) |ys#0@@13|))) (and ($IsAlloc DatatypeTypeType |##xs#1_0_2_3@0| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@0) (|_module.__default.MultisetUnion#canCall| Tclass._module.G (_module.__default.sequences ($LS $LZ) |ys#0@@13|)))) (and (and (|_module.__default.multiset__of#canCall| Tclass._module.G (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)) (and (|_module.__default.sequences#canCall| |ys#0@@13|) (|_module.__default.MultisetUnion#canCall| Tclass._module.G (_module.__default.sequences ($LS $LZ) |ys#0@@13|)))) (= (ControlFlow 0 5) (- 0 4))))) (|MultiSet#Equal| (_module.__default.MultisetUnion Tclass._module.G ($LS ($LS $LZ)) (|#_module.List.Cons| ($Box DatatypeTypeType (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)) (_module.__default.sequences ($LS ($LS $LZ)) |ys#0@@13|))) (|MultiSet#Union| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)) (_module.__default.MultisetUnion Tclass._module.G ($LS ($LS $LZ)) (_module.__default.sequences ($LS ($LS $LZ)) |ys#0@@13|)))))))))
(let ((anon23_Then_correct  (=> ($IsAllocBox |a#0@@15| Tclass._module.G $Heap@0) (=> (and ($IsAlloc DatatypeTypeType |xs#0@@28| (Tclass._module.List Tclass._module.G) $Heap@0) ($IsAlloc DatatypeTypeType |ys#0@@13| (Tclass._module.List Tclass._module.G) $Heap@0)) (=> (and (and (and (and (|_module.__default.descending#canCall| |a#0@@15| |xs#0@@28| |ys#0@@13|) (= |##xs#1_0_3_0@0| (_module.__default.descending ($LS $LZ) |a#0@@15| |xs#0@@28| |ys#0@@13|))) (and ($IsAlloc DatatypeTypeType |##xs#1_0_3_0@0| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@0) (|_module.__default.MultisetUnion#canCall| Tclass._module.G (_module.__default.descending ($LS $LZ) |a#0@@15| |xs#0@@28| |ys#0@@13|)))) (and (and (|_module.__default.descending#canCall| |a#0@@15| |xs#0@@28| |ys#0@@13|) (|_module.__default.MultisetUnion#canCall| Tclass._module.G (_module.__default.descending ($LS $LZ) |a#0@@15| |xs#0@@28| |ys#0@@13|))) ($IsAlloc DatatypeTypeType |ys#0@@13| (Tclass._module.List Tclass._module.G) $Heap@0))) (and (and (and (|_module.__default.sequences#canCall| |ys#0@@13|) (= |##xs#1_0_3_2@0| (|#_module.List.Cons| ($Box DatatypeTypeType (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)) (_module.__default.sequences ($LS $LZ) |ys#0@@13|)))) (and ($IsAlloc DatatypeTypeType |##xs#1_0_3_2@0| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@0) (|_module.__default.MultisetUnion#canCall| Tclass._module.G (|#_module.List.Cons| ($Box DatatypeTypeType (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)) (_module.__default.sequences ($LS $LZ) |ys#0@@13|))))) (and (and (|_module.__default.sequences#canCall| |ys#0@@13|) (|_module.__default.MultisetUnion#canCall| Tclass._module.G (|#_module.List.Cons| ($Box DatatypeTypeType (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)) (_module.__default.sequences ($LS $LZ) |ys#0@@13|)))) (= (ControlFlow 0 3) (- 0 2))))) (|MultiSet#Equal| (_module.__default.MultisetUnion Tclass._module.G ($LS ($LS $LZ)) (_module.__default.descending ($LS ($LS $LZ)) |a#0@@15| |xs#0@@28| |ys#0@@13|)) (_module.__default.MultisetUnion Tclass._module.G ($LS ($LS $LZ)) (|#_module.List.Cons| ($Box DatatypeTypeType (|#_module.List.Cons| |a#0@@15| |xs#0@@28|)) (_module.__default.sequences ($LS ($LS $LZ)) |ys#0@@13|)))))))))
(let ((anon22_Then_correct true))
(let ((anon17_Else_correct  (=> (not (and (_module.List.Cons_q |ys#0@@13|) (not (_module.__default.Below |a#0@@15| (_module.List.head |ys#0@@13|))))) (and (and (and (and (and (=> (= (ControlFlow 0 14) 1) anon22_Then_correct) (=> (= (ControlFlow 0 14) 3) anon23_Then_correct)) (=> (= (ControlFlow 0 14) 5) anon24_Then_correct)) (=> (= (ControlFlow 0 14) 7) anon25_Then_correct)) (=> (= (ControlFlow 0 14) 10) anon26_Then_correct)) (=> (= (ControlFlow 0 14) 13) anon26_Else_correct)))))
(let ((anon2_correct  (=> (=> (_module.List.Cons_q |ys#0@@13|) (|_module.__default.Below#canCall| |a#0@@15| (_module.List.head |ys#0@@13|))) (and (=> (= (ControlFlow 0 33) 32) anon17_Then_correct) (=> (= (ControlFlow 0 33) 14) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (and (not (_module.List.Cons_q |ys#0@@13|)) (= (ControlFlow 0 36) 33)) anon2_correct)))
(let ((anon16_Then_correct  (=> (and (_module.List.Cons_q |ys#0@@13|) ($IsAllocBox |a#0@@15| Tclass._module.G $Heap@0)) (and (=> (= (ControlFlow 0 34) (- 0 35)) (_module.List.Cons_q |ys#0@@13|)) (=> (_module.List.Cons_q |ys#0@@13|) (=> (and (and (= |##b#0@0| (_module.List.head |ys#0@@13|)) ($IsAllocBox |##b#0@0| Tclass._module.G $Heap@0)) (and (|_module.__default.Below#canCall| |a#0@@15| (_module.List.head |ys#0@@13|)) (= (ControlFlow 0 34) 33))) anon2_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (=> (and (|$IsA#_module.List| |xs#0@@28|) (|$IsA#_module.List| |ys#0@@13|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@2 $Heap@0) (forall ((|$ih#xs0#0| T@U) (|$ih#ys0#0| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |$ih#xs0#0| (Tclass._module.List Tclass._module.G)) ($Is DatatypeTypeType |$ih#ys0#0| (Tclass._module.List Tclass._module.G))) (U_2_bool (Lit boolType (bool_2_U true)))) (< (DtRank |$ih#ys0#0|) (DtRank |ys#0@@13|))) (|MultiSet#Equal| (_module.__default.MultisetUnion Tclass._module.G ($LS $LZ) (_module.__default.descending ($LS $LZ) |a#0@@15| |$ih#xs0#0| |$ih#ys0#0|)) (|MultiSet#Union| (|MultiSet#Union| (|MultiSet#UnionOne| |MultiSet#Empty| |a#0@@15|) (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |$ih#xs0#0|)) (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |$ih#ys0#0|))))
 :qid |GHCMergeSortdfy.207:29|
 :skolemid |769|
