...
(Lit DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U |n#2|)) (Lit DatatypeTypeType |stk#0@@0|)))) (ite (_module.instr.LOAD_q (Lit DatatypeTypeType |i#0|)) (let ((|x#2| (Lit SeqType (_module.instr._h13 (Lit DatatypeTypeType |i#0|)))))
(|#_module.List.Cons| (Apply1 (TSeq TChar) TInt $Heap |s#0@@0| ($Box SeqType |x#2|)) (Lit DatatypeTypeType |stk#0@@0|))) (ite  (and (_module.List.Cons_q (Lit DatatypeTypeType |stk#0@@0|)) (_module.List.Cons_q (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |stk#0@@0|))))) (let ((|tail#2| (_module.List.tail (_module.List.tail (Lit DatatypeTypeType |stk#0@@0|)))))
...
(assert (forall ((_module.List$T@@3 T@U) (d@@9 T@U) ) (!  (=> ($Is DatatypeTypeType d@@9 (Tclass._module.List _module.List$T@@3)) (or (_module.List.Nil_q d@@9) (_module.List.Cons_q d@@9)))
 :qid |unknown.0:0|
 :skolemid |725|
 :pattern ( (_module.List.Cons_q d@@9) ($Is DatatypeTypeType d@@9 (Tclass._module.List _module.List$T@@3)))
...
(|#_module.List.Cons| ($Box intType (int_2_U |n#0|)) |stk#0@@1|)) (ite (_module.instr.LOAD_q |i#0@@0|) (let ((|x#0| (_module.instr._h13 |i#0@@0|)))
(|#_module.List.Cons| (Apply1 (TSeq TChar) TInt $Heap@@0 |s#0@@1| ($Box SeqType |x#0|)) |stk#0@@1|)) (ite  (and (_module.List.Cons_q |stk#0@@1|) (_module.List.Cons_q (_module.List.tail |stk#0@@1|))) (let ((|tail#0| (_module.List.tail (_module.List.tail |stk#0@@1|))))
...
(assert (forall (($ly@@1 T@U) (|ii#0@@1| T@U) (|s#0@@4| T@U) (|stk#0@@4| T@U) ) (! (= (_module.__default.exec ($LS $ly@@1) |ii#0@@1| |s#0@@4| |stk#0@@4|) (_module.__default.exec $ly@@1 |ii#0@@1| |s#0@@4| |stk#0@@4|))
 :qid |NipkowKleinchapter3dfy.216:16|
 :skolemid |682|
 :pattern ( (_module.__default.exec ($LS $ly@@1) |ii#0@@1| |s#0@@4| |stk#0@@4|))
)))
...
(assert (forall ((d@@10 T@U) (_module.List$T@@5 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (_module.List.Cons_q d@@10) ($IsAlloc DatatypeTypeType d@@10 (Tclass._module.List _module.List$T@@5) $h@@2))) ($IsAllocBox (_module.List.head d@@10) _module.List$T@@5 $h@@2))
 :qid |unknown.0:0|
 :skolemid |717|
 :pattern ( ($IsAllocBox (_module.List.head d@@10) _module.List$T@@5 $h@@2))
)))
...
(assert (forall ((d@@11 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (_module.instr.LOADI_q d@@11) ($IsAlloc DatatypeTypeType d@@11 Tclass._module.instr $h@@3))) ($IsAlloc intType (int_2_U (_module.instr._h12 d@@11)) TInt $h@@3))
 :qid |unknown.0:0|
 :skolemid |820|
 :pattern ( ($IsAlloc intType (int_2_U (_module.instr._h12 d@@11)) TInt $h@@3))
)))
(assert (forall ((d@@12 T@U) ) (!  (=> ($Is DatatypeTypeType d@@12 Tclass._module.instr) (or (or (_module.instr.LOADI_q d@@12) (_module.instr.LOAD_q d@@12)) (_module.instr.ADD_q d@@12)))
 :qid |unknown.0:0|
 :skolemid |837|
 :pattern ( (_module.instr.ADD_q d@@12) ($Is DatatypeTypeType d@@12 Tclass._module.instr))
 :pattern ( (_module.instr.LOAD_q d@@12) ($Is DatatypeTypeType d@@12 Tclass._module.instr))
 :pattern ( (_module.instr.LOADI_q d@@12) ($Is DatatypeTypeType d@@12 Tclass._module.instr))
)))
...
(assert (forall ((d@@14 T@U) (_module.List$T@@7 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (_module.List.Cons_q d@@14) ($IsAlloc DatatypeTypeType d@@14 (Tclass._module.List _module.List$T@@7) $h@@4))) ($IsAlloc DatatypeTypeType (_module.List.tail d@@14) (Tclass._module.List _module.List$T@@7) $h@@4))
 :qid |unknown.0:0|
 :skolemid |718|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.List.tail d@@14) (Tclass._module.List _module.List$T@@7) $h@@4))
)))
(assert (forall ((d@@15 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) ($Is DatatypeTypeType d@@15 Tclass._module.instr)) ($IsAlloc DatatypeTypeType d@@15 Tclass._module.instr $h@@5))
 :qid |unknown.0:0|
 :skolemid |835|
 :pattern ( ($IsAlloc DatatypeTypeType d@@15 Tclass._module.instr $h@@5))
)))
...
(assert (forall ((d@@16 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (_module.instr.LOAD_q d@@16) ($IsAlloc DatatypeTypeType d@@16 Tclass._module.instr $h@@6))) ($IsAlloc SeqType (_module.instr._h13 d@@16) (TSeq TChar) $h@@6))
 :qid |unknown.0:0|
 :skolemid |828|
 :pattern ( ($IsAlloc SeqType (_module.instr._h13 d@@16) (TSeq TChar) $h@@6))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@2 T@U) (|ii#0@@2| T@U) (|s#0@@5| T@U) (|stk#0@@5| T@U) ) (!  (=> (or (|_module.__default.exec#canCall| |ii#0@@2| |s#0@@5| |stk#0@@5|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |ii#0@@2| (Tclass._module.List Tclass._module.instr)) ($Is HandleTypeType |s#0@@5| (Tclass._System.___hTotalFunc1 (TSeq TChar) TInt))) ($Is DatatypeTypeType |stk#0@@5| (Tclass._module.List TInt))))) (and (=> (not (_module.List.Nil_q |ii#0@@2|)) (let ((|rest#1| (_module.List.tail |ii#0@@2|)))
(let ((|i#1| ($Unbox DatatypeTypeType (_module.List.head |ii#0@@2|))))
 (and (|_module.__default.exec1#canCall| |i#1| |s#0@@5| |stk#0@@5|) (|_module.__default.exec#canCall| |rest#1| |s#0@@5| (_module.__default.exec1 |i#1| |s#0@@5| |stk#0@@5|)))))) (= (_module.__default.exec ($LS $ly@@2) |ii#0@@2| |s#0@@5| |stk#0@@5|) (ite (_module.List.Nil_q |ii#0@@2|) |stk#0@@5| (let ((|rest#0| (_module.List.tail |ii#0@@2|)))
(let ((|i#0@@2| ($Unbox DatatypeTypeType (_module.List.head |ii#0@@2|))))
(_module.__default.exec $ly@@2 |rest#0| |s#0@@5| (_module.__default.exec1 |i#0@@2| |s#0@@5| |stk#0@@5|))))))))
 :qid |NipkowKleinchapter3dfy.216:16|
 :skolemid |686|
 :pattern ( (_module.__default.exec ($LS $ly@@2) |ii#0@@2| |s#0@@5| |stk#0@@5|))
))))
...
(|#_module.List.Cons| ($Box intType (int_2_U (+ |a0#4| |a1#4|))) |tail#4|)))) |#_module.List.Nil|)))))
 ...
 :weight 3
 :skolemid |681|
 :pattern ( (_module.__default.exec1 (Lit DatatypeTypeType |i#0@@3|) (Lit HandleTypeType |s#0@@7|) (Lit DatatypeTypeType |stk#0@@7|)) ($IsGoodHeap $Heap@@1))
))))
...
(declare-fun |ii#0@@4| () T@U)
(declare-fun |_mcc#0#0| () T@U)
(declare-fun |_mcc#1#0| () T@U)
(declare-fun |let#0#0#0| () T@U)
(declare-fun |rest#Z#0@0| () T@U)
(declare-fun |let#1#0#0| () T@U)
(declare-fun |i#Z#0@0| () T@U)
(declare-fun $Heap@@2 () T@U)
(declare-fun |s#0@@8| () T@U)
(declare-fun |stk#0@@8| () T@U)
(declare-fun |##stk#0@0| () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$_module.__default.exec)
...
(let ((anon10_Then_correct  (=> (and (= |ii#0@@4| (|#_module.List.Cons| ($Box DatatypeTypeType |_mcc#0#0|) |_mcc#1#0|)) ($Is DatatypeTypeType |_mcc#0#0| Tclass._module.instr)) (=> (and (and (and (and ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List Tclass._module.instr)) (= |let#0#0#0| |_mcc#1#0|)) (and ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List Tclass._module.instr)) (= |rest#Z#0@0| |let#0#0#0|))) (and (and (= |let#1#0#0| |_mcc#0#0|) ($Is DatatypeTypeType |let#1#0#0| Tclass._module.instr)) (and (= |i#Z#0@0| |let#1#0#0|) ($IsAlloc DatatypeTypeType |rest#Z#0@0| (Tclass._module.List Tclass._module.instr) $Heap@@2)))) (and (and (and ($IsAlloc HandleTypeType |s#0@@8| (Tclass._System.___hTotalFunc1 (TSeq TChar) TInt) $Heap@@2) ($IsAlloc DatatypeTypeType |i#Z#0@0| Tclass._module.instr $Heap@@2)) (and ($IsAlloc HandleTypeType |s#0@@8| (Tclass._System.___hTotalFunc1 (TSeq TChar) TInt) $Heap@@2) ($IsAlloc DatatypeTypeType |stk#0@@8| (Tclass._module.List TInt) $Heap@@2))) (and (and (|_module.__default.exec1#canCall| |i#Z#0@0| |s#0@@8| |stk#0@@8|) (= |##stk#0@0| (_module.__default.exec1 |i#Z#0@0| |s#0@@8| |stk#0@@8|))) (and ($IsAlloc DatatypeTypeType |##stk#0@0| (Tclass._module.List TInt) $Heap@@2) (= (ControlFlow 0 4) (- 0 3)))))) (or (< (DtRank |rest#Z#0@0|) (DtRank |ii#0@@4|)) (and (= (DtRank |rest#Z#0@0|) (DtRank |ii#0@@4|)) (< (DtRank |##stk#0@0|) (DtRank |stk#0@@8|))))))))
(let ((anon9_Else_correct  (=> (or (not (= |ii#0@@4| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 6) 4) anon10_Then_correct) (=> (= (ControlFlow 0 6) 5) anon10_Else_correct)))))
(let ((anon9_Then_correct true))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (and (and (=> (= (ControlFlow 0 7) 1) anon8_Then_correct) (=> (= (ControlFlow 0 7) 2) anon9_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) ($Is DatatypeTypeType |ii#0@@4| (Tclass._module.List Tclass._module.instr))) (and (and ($Is HandleTypeType |s#0@@8| (Tclass._System.___hTotalFunc1 (TSeq TChar) TInt)) ($Is DatatypeTypeType |stk#0@@8| (Tclass._module.List TInt))) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 8) 7)))) anon0_correct)))
