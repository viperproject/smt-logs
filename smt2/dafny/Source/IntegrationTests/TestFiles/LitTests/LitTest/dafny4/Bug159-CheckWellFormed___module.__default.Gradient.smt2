...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Gradient)
...
(let ((anon8_correct  (=> (and (<= (LitInt 0) |j#0@0|) (< |j#0@0| |n#0|)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (not (= |m#0@0| null)) (not true))) (=> (or (not (= |m#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array2.Length0 |m#0@0|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array2.Length0 |m#0@0|))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 |j#0@0|) (< |j#0@0| (_System.array2.Length1 |m#0@0|)))) (=> (and (<= 0 |j#0@0|) (< |j#0@0| (_System.array2.Length1 |m#0@0|))) (=> (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |m#0@0|) (MultiIndexField (IndexField |i#0@0|) |j#0@0|)))) (+ |j#0@0| |i#0@0|)) (= (ControlFlow 0 3) 1)) anon10_correct))))))))))
(let ((anon14_Else_correct  (=> (and (< |j#0@0| (LitInt 0)) (= (ControlFlow 0 8) 3)) anon8_correct)))
(let ((anon14_Then_correct  (=> (and (<= (LitInt 0) |j#0@0|) (= (ControlFlow 0 7) 3)) anon8_correct)))
(let ((anon6_correct  (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |n#0|)) (and (=> (= (ControlFlow 0 9) 7) anon14_Then_correct) (=> (= (ControlFlow 0 9) 8) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (< |i#0@0| (LitInt 0)) (= (ControlFlow 0 11) 9)) anon6_correct)))
(let ((anon13_Then_correct  (=> (and (<= (LitInt 0) |i#0@0|) (= (ControlFlow 0 10) 9)) anon6_correct)))
(let ((anon12_Else_correct  (=> (and (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |n#0|)) (and (<= (LitInt 0) |j#0@0|) (< |j#0@0| |n#0|))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |m#0@0|) (MultiIndexField (IndexField |i#0@0|) |j#0@0|)))) (+ |j#0@0| |i#0@0|))) (= (ControlFlow 0 2) 1)) anon10_correct)))
(let ((anon3_correct  (=> (and (= (_System.array2.Length0 |m#0@0|) (_System.array2.Length1 |m#0@0|)) (= (_System.array2.Length1 |m#0@0|) |n#0|)) (and (and (=> (= (ControlFlow 0 12) 2) anon12_Else_correct) (=> (= (ControlFlow 0 12) 10) anon13_Then_correct)) (=> (= (ControlFlow 0 12) 11) anon13_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (or (not (= (_System.array2.Length0 |m#0@0|) (_System.array2.Length1 |m#0@0|))) (not true)) (= (ControlFlow 0 15) 12)) anon3_correct)))
(let ((anon11_Then_correct  (=> (= (_System.array2.Length0 |m#0@0|) (_System.array2.Length1 |m#0@0|)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (or (not (= |m#0@0| null)) (not true))) (=> (or (not (= |m#0@0| null)) (not true)) (=> (= (ControlFlow 0 13) 12) anon3_correct))))))
...
)) ($HeapSucc $Heap $Heap@0)) (and ($Is refType |m#0@0| (Tclass._System.array2 TInt)) ($IsAlloc refType |m#0@0| (Tclass._System.array2 TInt) $Heap@0))) (and (=> (= (ControlFlow 0 16) (- 0 18)) (or (not (= |m#0@0| null)) (not true))) (=> (or (not (= |m#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (or (not (= |m#0@0| null)) (not true))) (=> (or (not (= |m#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 16) 13) anon11_Then_correct) (=> (= (ControlFlow 0 16) 15) anon11_Else_correct)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |n#0|)) (and (and ($Is refType |m#0| (Tclass._System.array2 TInt)) ($IsAlloc refType |m#0| (Tclass._System.array2 TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 19) 16)))) anon0_correct)))
