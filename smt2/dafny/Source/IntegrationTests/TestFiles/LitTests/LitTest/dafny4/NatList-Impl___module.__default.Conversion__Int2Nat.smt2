...
(assert (forall (($ly@@0 T@U) (|xs#0@@0| T@U) ) (! (= (_module.__default.ElementsAreNat ($LS $ly@@0) |xs#0@@0|) (_module.__default.ElementsAreNat $ly@@0 |xs#0@@0|))
 :qid |NatListdfy.81:17|
 :skolemid |564|
 :pattern ( (_module.__default.ElementsAreNat ($LS $ly@@0) |xs#0@@0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@1 T@U) (|xs#0@@1| T@U) ) (!  (=> (or (|_module.__default.ElementsAreNat#canCall| |xs#0@@1|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@1| (Tclass._module.List TInt)))) (and (=> (not (_module.List.Nil_q |xs#0@@1|)) (let ((|tail#1| (_module.List.tail |xs#0@@1|)))
(let ((|x#1| (U_2_int ($Unbox intType (_module.List.head |xs#0@@1|)))))
 (=> (<= (LitInt 0) |x#1|) (|_module.__default.ElementsAreNat#canCall| |tail#1|))))) (= (_module.__default.ElementsAreNat ($LS $ly@@1) |xs#0@@1|) (ite (_module.List.Nil_q |xs#0@@1|) true (let ((|tail#0| (_module.List.tail |xs#0@@1|)))
(let ((|x#0@@1| (U_2_int ($Unbox intType (_module.List.head |xs#0@@1|)))))
 (and (<= (LitInt 0) |x#0@@1|) (_module.__default.ElementsAreNat $ly@@1 |tail#0|))))))))
 :qid |NatListdfy.81:17|
 :skolemid |568|
 :pattern ( (_module.__default.ElementsAreNat ($LS $ly@@1) |xs#0@@1|))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.Conversion__Int2Nat)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (|_module.List#Equal| |xs#0@@2| |ns#0@1|))))
(let ((anon5_Then_correct  (=> (and (= |xs#0@@2| (|#_module.List.Cons| ($Box intType (int_2_U |_mcc#0#0_0@0|)) |_mcc#1#0_0@0|)) ($Is DatatypeTypeType |_mcc#1#0_0@0| (Tclass._module.List TInt))) (=> (and (and (and ($Is DatatypeTypeType |tail#0_0@0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |tail#0_0@0| (Tclass._module.List TInt) $Heap)) (and (= |let#0_0#0#0| |_mcc#1#0_0@0|) ($Is DatatypeTypeType |let#0_0#0#0| (Tclass._module.List TInt)))) (and (and (= |tail#0_0@0| |let#0_0#0#0|) (= |let#0_1#0#0| |_mcc#0#0_0@0|)) (and ($Is intType (int_2_U |let#0_1#0#0|) TInt) (= |x#0_0@0| |let#0_1#0#0|)))) (and (=> (= (ControlFlow 0 6) (- 0 11)) (< (DtRank |tail#0_0@0|) (DtRank |xs#0@@2|))) (=> (< (DtRank |tail#0_0@0|) (DtRank |xs#0@@2|)) (=> (and ($Is DatatypeTypeType |call2formal@ns#0| (Tclass._module.List Tclass._System.nat)) ($IsAlloc DatatypeTypeType |call2formal@ns#0| (Tclass._module.List Tclass._System.nat) $Heap)) (and (=> (= (ControlFlow 0 6) (- 0 10)) (=> (|_module.__default.ElementsAreNat#canCall| |tail#0_0@0|) (or (_module.__default.ElementsAreNat ($LS $LZ) |tail#0_0@0|) (=> (_module.List.Nil_q |tail#0_0@0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (|_module.__default.ElementsAreNat#canCall| |tail#0_0@0|) (or (_module.__default.ElementsAreNat ($LS $LZ) |tail#0_0@0|) (=> (_module.List.Nil_q |tail#0_0@0|) (U_2_bool (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 6) (- 0 9)) (=> (|_module.__default.ElementsAreNat#canCall| |tail#0_0@0|) (or (_module.__default.ElementsAreNat ($LS $LZ) |tail#0_0@0|) (=> (not (_module.List.Nil_q |tail#0_0@0|)) (let ((|x#0@@2| (U_2_int ($Unbox intType (_module.List.head |tail#0_0@0|)))))
(<= (LitInt 0) |x#0@@2|)))))) (=> (=> (|_module.__default.ElementsAreNat#canCall| |tail#0_0@0|) (or (_module.__default.ElementsAreNat ($LS $LZ) |tail#0_0@0|) (=> (not (_module.List.Nil_q |tail#0_0@0|)) (let ((|x#0@@3| (U_2_int ($Unbox intType (_module.List.head |tail#0_0@0|)))))
(<= (LitInt 0) |x#0@@3|))))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (=> (|_module.__default.ElementsAreNat#canCall| |tail#0_0@0|) (or (_module.__default.ElementsAreNat ($LS $LZ) |tail#0_0@0|) (=> (not (_module.List.Nil_q |tail#0_0@0|)) (let ((|tail#0@@0| (_module.List.tail |tail#0_0@0|)))
(_module.__default.ElementsAreNat ($LS ($LS $LZ)) |tail#0@@0|)))))) (=> (=> (|_module.__default.ElementsAreNat#canCall| |tail#0_0@0|) (or (_module.__default.ElementsAreNat ($LS $LZ) |tail#0_0@0|) (=> (not (_module.List.Nil_q |tail#0_0@0|)) (let ((|tail#0@@1| (_module.List.tail |tail#0_0@0|)))
(_module.__default.ElementsAreNat ($LS ($LS $LZ)) |tail#0@@1|))))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and ($Is DatatypeTypeType |call2formal@ns#0@0| (Tclass._module.List Tclass._System.nat)) ($IsAlloc DatatypeTypeType |call2formal@ns#0@0| (Tclass._module.List Tclass._System.nat) $Heap@0))) (and (and (|$IsA#_module.List| |tail#0_0@0|) (|$IsA#_module.List| |call2formal@ns#0@0|)) (and (|_module.List#Equal| |tail#0_0@0| |call2formal@ns#0@0|) (= $Heap $Heap@0)))) (and (=> (= (ControlFlow 0 6) (- 0 7)) ($Is DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U |x#0_0@0|)) |call2formal@ns#0@0|) (Tclass._module.List Tclass._System.nat))) (=> ($Is DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U |x#0_0@0|)) |call2formal@ns#0@0|) (Tclass._module.List Tclass._System.nat)) (=> (= |ns#0@0| (|#_module.List.Cons| ($Box intType (int_2_U |x#0_0@0|)) |call2formal@ns#0@0|)) (=> (and (= |ns#0@1| |ns#0@0|) (= (ControlFlow 0 6) 3)) GeneratedUnifiedExit_correct))))))))))))))))))
(let ((anon4_Then_correct  (=> (= |xs#0@@2| |#_module.List.Nil|) (and (=> (= (ControlFlow 0 4) (- 0 5)) ($Is DatatypeTypeType |xs#0@@2| (Tclass._module.List Tclass._System.nat))) (=> ($Is DatatypeTypeType |xs#0@@2| (Tclass._module.List Tclass._System.nat)) (=> (and (= |ns#0@1| |xs#0@@2|) (= (ControlFlow 0 4) 3)) GeneratedUnifiedExit_correct))))))
(let ((anon5_Else_correct true))
(let ((anon4_Else_correct  (=> (or (not (= |xs#0@@2| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 12) 6) anon5_Then_correct) (=> (= (ControlFlow 0 12) 1) anon5_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 13) 4) anon4_Then_correct) (=> (= (ControlFlow 0 13) 12) anon4_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |xs#0@@2| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |xs#0@@2| (Tclass._module.List TInt) $Heap)) (|$IsA#_module.List| |xs#0@@2|)) (=> (and (and (and ($Is DatatypeTypeType |ns#0| (Tclass._module.List Tclass._System.nat)) ($IsAlloc DatatypeTypeType |ns#0| (Tclass._module.List Tclass._System.nat) $Heap)) (= 2 $FunctionContextHeight)) (and (and (|_module.__default.ElementsAreNat#canCall| |xs#0@@2|) (and (_module.__default.ElementsAreNat ($LS $LZ) |xs#0@@2|) (ite (_module.List.Nil_q |xs#0@@2|) true (let ((|tail#3@@0| (_module.List.tail |xs#0@@2|)))
(let ((|x#3@@0| (U_2_int ($Unbox intType (_module.List.head |xs#0@@2|)))))
 (and (<= (LitInt 0) |x#3@@0|) (_module.__default.ElementsAreNat ($LS $LZ) |tail#3@@0|))))))) (= (ControlFlow 0 14) 13))) anon0_correct)))))
