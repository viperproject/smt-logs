...
(declare-fun _module._default.LeftIdentity$T () T@U)
(declare-fun |f#0@@9| () T@U)
(declare-fun |a#0@@4| () T@U)
(declare-fun $Heap@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id Impl$$_module.__default.LeftIdentity)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@5 alloc false)) (= |xs##0@0| ($Unbox DatatypeTypeType (Apply1 _module._default.LeftIdentity$T (Tclass._module.List _module._default.LeftIdentity$T) $Heap@@5 |f#0@@9| |a#0@@4|)))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (=> (and (and (and (and (|$IsA#_module.List| (_module.__default.append _module._default.LeftIdentity$T ($LS $LZ) |xs##0@0| (Lit DatatypeTypeType |#_module.List.Nil|))) (|$IsA#_module.List| |xs##0@0|)) (|_module.__default.append#canCall| _module._default.LeftIdentity$T |xs##0@0| (Lit DatatypeTypeType |#_module.List.Nil|))) (|_module.List#Equal| (_module.__default.append _module._default.LeftIdentity$T ($LS ($LS $LZ)) |xs##0@0| (Lit DatatypeTypeType |#_module.List.Nil|)) |xs##0@0|)) (and (= $Heap@@5 $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (|_module.List#Equal| (_module.__default.Bind _module._default.LeftIdentity$T _module._default.LeftIdentity$T ($LS ($LS $LZ)) (_module.__default.Return _module._default.LeftIdentity$T |a#0@@4|) |f#0@@9|) ($Unbox DatatypeTypeType (Apply1 _module._default.LeftIdentity$T (Tclass._module.List _module._default.LeftIdentity$T) $Heap@0 |f#0@@9| |a#0@@4|)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@5) ($IsHeapAnchor $Heap@@5)) (and ($IsBox |a#0@@4| _module._default.LeftIdentity$T) ($IsAllocBox |a#0@@4| _module._default.LeftIdentity$T $Heap@@5))) (and (and ($Is HandleTypeType |f#0@@9| (Tclass._System.___hTotalFunc1 _module._default.LeftIdentity$T (Tclass._module.List _module._default.LeftIdentity$T))) ($IsAlloc HandleTypeType |f#0@@9| (Tclass._System.___hTotalFunc1 _module._default.LeftIdentity$T (Tclass._module.List _module._default.LeftIdentity$T)) $Heap@@5)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
