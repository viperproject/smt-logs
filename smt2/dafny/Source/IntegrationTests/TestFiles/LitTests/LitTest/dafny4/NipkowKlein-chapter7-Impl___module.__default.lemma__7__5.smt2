...
(declare-fun |##c#0_3@0| () T@U)
(declare-fun $Heap () T@U)
(declare-fun $Heap@0 () T@U)
(declare-fun |##c#0_2@0| () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun null () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.lemma__7__5)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon9_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (= (_module.__default.big__step ($LS ($LS $LZ)) (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|) (_module.__default.big__step ($LS ($LS $LZ)) (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|)))))
(let ((anon14_Else_correct  (=> (and (not (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|)) (= (ControlFlow 0 14) 6)) anon9_correct)))
(let ((anon14_Then_correct  (=> (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|) (and (=> (= (ControlFlow 0 7) (- 0 13)) (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|) (=> (_module.com.SKIP_q (|#_module.com.While| |b#0@@3| |c'#0@@1|)) (|Map#Equal| |s#0_0@0| |t#0_0@0|))))) (=> (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|) (=> (_module.com.SKIP_q (|#_module.com.While| |b#0@@3| |c'#0@@1|)) (|Map#Equal| |s#0_0@0| |t#0_0@0|)))) (and (=> (= (ControlFlow 0 7) (- 0 12)) (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|) (=> (not (_module.com.SKIP_q (|#_module.com.While| |b#0@@3| |c'#0@@1|))) (=> (_module.com.Assign_q (|#_module.com.While| |b#0@@3| |c'#0@@1|)) (let ((|a#0@@3| (_module.com._h1 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
(let ((|x#0@@1| (_module.com._h0 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
(|Map#Equal| |t#0_0@0| (|Map#Build| |s#0_0@0| ($Box SeqType |x#0@@1|) ($Box intType (int_2_U (_module.__default.aval ($LS ($LS $LZ)) |a#0@@3| |s#0_0@0|)))))))))))) (=> (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|) (=> (not (_module.com.SKIP_q (|#_module.com.While| |b#0@@3| |c'#0@@1|))) (=> (_module.com.Assign_q (|#_module.com.While| |b#0@@3| |c'#0@@1|)) (let ((|a#0@@4| (_module.com._h1 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
(let ((|x#0@@2| (_module.com._h0 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
(|Map#Equal| |t#0_0@0| (|Map#Build| |s#0_0@0| ($Box SeqType |x#0@@2|) ($Box intType (int_2_U (_module.__default.aval ($LS ($LS $LZ)) |a#0@@4| |s#0_0@0|))))))))))) (and (=> (= (ControlFlow 0 7) (- 0 11)) (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|) (=> (not (_module.com.SKIP_q (|#_module.com.While| |b#0@@3| |c'#0@@1|))) (=> (not (_module.com.Assign_q (|#_module.com.While| |b#0@@3| |c'#0@@1|))) (=> (_module.com.Seq_q (|#_module.com.While| |b#0@@3| |c'#0@@1|)) (let ((|c1#0@@0| (_module.com._h3 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
(let ((|c0#0@@0| (_module.com._h2 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
(exists ((|s'#0@@0| T@U) ) (!  (and ($Is MapType |s'#0@@0| (TMap (TSeq TChar) TInt)) (and (_module.__default.big__step ($LS $LZ) |c0#0@@0| |s#0_0@0| |s'#0@@0|) (_module.__default.big__step ($LS $LZ) |c1#0@@0| |s'#0@@0| |t#0_0@0|)))
 :qid |NipkowKleinchapter7dfy.48:12|
 :skolemid |868|
 :pattern ( (_module.__default.big__step ($LS $LZ) |c1#0@@0| |s'#0@@0| |t#0_0@0|))
 :pattern ( (_module.__default.big__step ($LS $LZ) |c0#0@@0| |s#0_0@0| |s'#0@@0|))
)))))))))) (=> (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|) (=> (not (_module.com.SKIP_q (|#_module.com.While| |b#0@@3| |c'#0@@1|))) (=> (not (_module.com.Assign_q (|#_module.com.While| |b#0@@3| |c'#0@@1|))) (=> (_module.com.Seq_q (|#_module.com.While| |b#0@@3| |c'#0@@1|)) (let ((|c1#0@@1| (_module.com._h3 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
(let ((|c0#0@@1| (_module.com._h2 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
(exists ((|s'#0@@1| T@U) ) (!  (and ($Is MapType |s'#0@@1| (TMap (TSeq TChar) TInt)) (and (_module.__default.big__step ($LS $LZ) |c0#0@@1| |s#0_0@0| |s'#0@@1|) (_module.__default.big__step ($LS $LZ) |c1#0@@1| |s'#0@@1| |t#0_0@0|)))
 :qid |NipkowKleinchapter7dfy.48:12|
 :skolemid |868|
 :pattern ( (_module.__default.big__step ($LS $LZ) |c1#0@@1| |s'#0@@1| |t#0_0@0|))
 :pattern ( (_module.__default.big__step ($LS $LZ) |c0#0@@1| |s#0_0@0| |s'#0@@1|))
))))))))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|) (=> (not (_module.com.SKIP_q (|#_module.com.While| |b#0@@3| |c'#0@@1|))) (=> (not (_module.com.Assign_q (|#_module.com.While| |b#0@@3| |c'#0@@1|))) (=> (not (_module.com.Seq_q (|#_module.com.While| |b#0@@3| |c'#0@@1|))) (=> (_module.com.If_q (|#_module.com.While| |b#0@@3| |c'#0@@1|)) (let ((|els#0@@0| (_module.com._h6 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
(let ((|thn#0@@0| (_module.com._h5 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
(let ((|b#1@@1| (_module.com._h4 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
(_module.__default.big__step ($LS ($LS $LZ)) (ite (_module.__default.bval ($LS ($LS $LZ)) |b#1@@1| |s#0_0@0|) |thn#0@@0| |els#0@@0|) |s#0_0@0| |t#0_0@0|))))))))))) (=> (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|) (=> (not (_module.com.SKIP_q (|#_module.com.While| |b#0@@3| |c'#0@@1|))) (=> (not (_module.com.Assign_q (|#_module.com.While| |b#0@@3| |c'#0@@1|))) (=> (not (_module.com.Seq_q (|#_module.com.While| |b#0@@3| |c'#0@@1|))) (=> (_module.com.If_q (|#_module.com.While| |b#0@@3| |c'#0@@1|)) (let ((|els#0@@1| (_module.com._h6 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
(let ((|thn#0@@1| (_module.com._h5 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
(let ((|b#1@@2| (_module.com._h4 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
(_module.__default.big__step ($LS ($LS $LZ)) (ite (_module.__default.bval ($LS ($LS $LZ)) |b#1@@2| |s#0_0@0|) |thn#0@@1| |els#0@@1|) |s#0_0@0| |t#0_0@0|)))))))))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|) (=> (not (_module.com.SKIP_q (|#_module.com.While| |b#0@@3| |c'#0@@1|))) (=> (not (_module.com.Assign_q (|#_module.com.While| |b#0@@3| |c'#0@@1|))) (=> (not (_module.com.Seq_q (|#_module.com.While| |b#0@@3| |c'#0@@1|))) (=> (not (_module.com.If_q (|#_module.com.While| |b#0@@3| |c'#0@@1|))) (let ((|body#0@@0| (_module.com._h8 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
(let ((|b#2@@1| (_module.com._h7 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
 (or (and (not (_module.__default.bval ($LS ($LS $LZ)) |b#2@@1| |s#0_0@0|)) (|Map#Equal| |s#0_0@0| |t#0_0@0|)) (and (_module.__default.bval ($LS ($LS $LZ)) |b#2@@1| |s#0_0@0|) (exists ((|s'#1@@0| T@U) ) (!  (and ($Is MapType |s'#1@@0| (TMap (TSeq TChar) TInt)) (and (_module.__default.big__step ($LS ($LS $LZ)) |body#0@@0| |s#0_0@0| |s'#1@@0|) (_module.__default.big__step ($LS ($LS $LZ)) (|#_module.com.While| |b#2@@1| |body#0@@0|) |s'#1@@0| |t#0_0@0|)))
 :qid |NipkowKleinchapter7dfy.55:27|
 :skolemid |870|
 :pattern ( (_module.__default.big__step ($LS ($LS $LZ)) (|#_module.com.While| |b#2@@1| |body#0@@0|) |s'#1@@0| |t#0_0@0|))
 :pattern ( (_module.__default.big__step ($LS ($LS $LZ)) |body#0@@0| |s#0_0@0| |s'#1@@0|))
))))))))))))) (=> (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|) (=> (not (_module.com.SKIP_q (|#_module.com.While| |b#0@@3| |c'#0@@1|))) (=> (not (_module.com.Assign_q (|#_module.com.While| |b#0@@3| |c'#0@@1|))) (=> (not (_module.com.Seq_q (|#_module.com.While| |b#0@@3| |c'#0@@1|))) (=> (not (_module.com.If_q (|#_module.com.While| |b#0@@3| |c'#0@@1|))) (let ((|body#0@@1| (_module.com._h8 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
(let ((|b#2@@2| (_module.com._h7 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
 (or (and (not (_module.__default.bval ($LS ($LS $LZ)) |b#2@@2| |s#0_0@0|)) (|Map#Equal| |s#0_0@0| |t#0_0@0|)) (and (_module.__default.bval ($LS ($LS $LZ)) |b#2@@2| |s#0_0@0|) (exists ((|s'#1@@1| T@U) ) (!  (and ($Is MapType |s'#1@@1| (TMap (TSeq TChar) TInt)) (and (_module.__default.big__step ($LS ($LS $LZ)) |body#0@@1| |s#0_0@0| |s'#1@@1|) (_module.__default.big__step ($LS ($LS $LZ)) (|#_module.com.While| |b#2@@2| |body#0@@1|) |s'#1@@1| |t#0_0@0|)))
 :qid |NipkowKleinchapter7dfy.55:27|
 :skolemid |870|
 :pattern ( (_module.__default.big__step ($LS ($LS $LZ)) (|#_module.com.While| |b#2@@2| |body#0@@1|) |s'#1@@1| |t#0_0@0|))
 :pattern ( (_module.__default.big__step ($LS ($LS $LZ)) |body#0@@1| |s#0_0@0| |s'#1@@1|))
)))))))))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (=> (|_module.__default.equiv__c#canCall| |c'#0@@1| |c#0@@11|) (or (_module.__default.equiv__c |c'#0@@1| |c#0@@11|) (forall ((|s#1@@1| T@U) (|t#1@@1| T@U) ) (!  (=> (and ($Is MapType |s#1@@1| (TMap (TSeq TChar) TInt)) ($Is MapType |t#1@@1| (TMap (TSeq TChar) TInt))) (= (_module.__default.big__step ($LS ($LS $LZ)) |c'#0@@1| |s#1@@1| |t#1@@1|) (_module.__default.big__step ($LS ($LS $LZ)) |c#0@@11| |s#1@@1| |t#1@@1|)))
 :qid |NipkowKleinchapter7dfy.84:10|
 :skolemid |873|
...
))))) (=> (=> (|_module.__default.equiv__c#canCall| |c'#0@@1| |c#0@@11|) (or (_module.__default.equiv__c |c'#0@@1| |c#0@@11|) (forall ((|s#1@@2| T@U) (|t#1@@2| T@U) ) (!  (=> (and ($Is MapType |s#1@@2| (TMap (TSeq TChar) TInt)) ($Is MapType |t#1@@2| (TMap (TSeq TChar) TInt))) (= (_module.__default.big__step ($LS ($LS $LZ)) |c'#0@@1| |s#1@@2| |t#1@@2|) (_module.__default.big__step ($LS ($LS $LZ)) |c#0@@11| |s#1@@2| |t#1@@2|)))
 :qid |NipkowKleinchapter7dfy.84:10|
 :skolemid |873|
 :pattern ( (_module.__default.big__step ($LS ($LS $LZ)) |c#0@@11| |s#1@@2| |t#1@@2|))
 :pattern ( (_module.__default.big__step ($LS ($LS $LZ)) |c'#0@@1| |s#1@@2| |t#1@@2|))
)))) (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|)) (and (and (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|) (and (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|) (ite (_module.com.SKIP_q (|#_module.com.While| |b#0@@3| |c#0@@11|)) (|Map#Equal| |s#0_0@0| |t#0_0@0|) (ite (_module.com.Assign_q (|#_module.com.While| |b#0@@3| |c#0@@11|)) (let ((|a#3@@0| (_module.com._h1 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
(let ((|x#3| (_module.com._h0 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
(|Map#Equal| |t#0_0@0| (|Map#Build| |s#0_0@0| ($Box SeqType |x#3|) ($Box intType (int_2_U (_module.__default.aval ($LS $LZ) |a#3@@0| |s#0_0@0|))))))) (ite (_module.com.Seq_q (|#_module.com.While| |b#0@@3| |c#0@@11|)) (let ((|c1#3@@0| (_module.com._h3 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
(let ((|c0#3@@0| (_module.com._h2 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
(exists ((|s'#6| T@U) ) (!  (and ($Is MapType |s'#6| (TMap (TSeq TChar) TInt)) (and (_module.__default.big__step ($LS $LZ) |c0#3@@0| |s#0_0@0| |s'#6|) (_module.__default.big__step ($LS $LZ) |c1#3@@0| |s'#6| |t#0_0@0|)))
 :qid |NipkowKleinchapter7dfy.48:12|
 :skolemid |879|
 :pattern ( (_module.__default.big__step ($LS $LZ) |c1#3@@0| |s'#6| |t#0_0@0|))
 :pattern ( (_module.__default.big__step ($LS $LZ) |c0#3@@0| |s#0_0@0| |s'#6|))
)))) (ite (_module.com.If_q (|#_module.com.While| |b#0@@3| |c#0@@11|)) (let ((|els#3@@0| (_module.com._h6 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
(let ((|thn#3@@0| (_module.com._h5 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
(let ((|b#7@@0| (_module.com._h4 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
(_module.__default.big__step ($LS $LZ) (ite (_module.__default.bval ($LS $LZ) |b#7@@0| |s#0_0@0|) |thn#3@@0| |els#3@@0|) |s#0_0@0| |t#0_0@0|)))) (let ((|body#3@@0| (_module.com._h8 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
(let ((|b#8@@0| (_module.com._h7 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
 (or (and (not (_module.__default.bval ($LS $LZ) |b#8@@0| |s#0_0@0|)) (|Map#Equal| |s#0_0@0| |t#0_0@0|)) (and (_module.__default.bval ($LS $LZ) |b#8@@0| |s#0_0@0|) (exists ((|s'#7| T@U) ) (!  (and ($Is MapType |s'#7| (TMap (TSeq TChar) TInt)) (and (_module.__default.big__step ($LS $LZ) |body#3@@0| |s#0_0@0| |s'#7|) (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#8@@0| |body#3@@0|) |s'#7| |t#0_0@0|)))
 :qid |NipkowKleinchapter7dfy.55:27|
 :skolemid |880|
 :pattern ( (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#8@@0| |body#3@@0|) |s'#7| |t#0_0@0|))
 :pattern ( (_module.__default.big__step ($LS $LZ) |body#3@@0| |s#0_0@0| |s'#7|))
)))))))))))) (and (= $Heap@1 $Heap@2) (= (ControlFlow 0 7) 6)))) anon9_correct))))))))))))))))
(let ((anon6_correct  (=> (and (= |##c#0_3@0| (|#_module.com.While| |b#0@@3| |c'#0@@1|)) ($IsAlloc DatatypeTypeType |##c#0_3@0| Tclass._module.com $Heap@1)) (=> (and (and ($IsAlloc MapType |s#0_0@0| (TMap (TSeq TChar) TInt) $Heap@1) ($IsAlloc MapType |t#0_0@0| (TMap (TSeq TChar) TInt) $Heap@1)) (and (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|) (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|))) (and (=> (= (ControlFlow 0 15) 7) anon14_Then_correct) (=> (= (ControlFlow 0 15) 14) anon14_Else_correct))))))
(let ((anon13_Else_correct  (=> (not (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|)) (=> (and (= $Heap@1 $Heap) (= (ControlFlow 0 23) 15)) anon6_correct))))
(let ((anon13_Then_correct  (=> (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|) (and (=> (= (ControlFlow 0 16) (- 0 22)) (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|) (=> (_module.com.SKIP_q (|#_module.com.While| |b#0@@3| |c#0@@11|)) (|Map#Equal| |s#0_0@0| |t#0_0@0|))))) (=> (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|) (=> (_module.com.SKIP_q (|#_module.com.While| |b#0@@3| |c#0@@11|)) (|Map#Equal| |s#0_0@0| |t#0_0@0|)))) (and (=> (= (ControlFlow 0 16) (- 0 21)) (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|) (=> (not (_module.com.SKIP_q (|#_module.com.While| |b#0@@3| |c#0@@11|))) (=> (_module.com.Assign_q (|#_module.com.While| |b#0@@3| |c#0@@11|)) (let ((|a#0@@5| (_module.com._h1 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
(let ((|x#0@@3| (_module.com._h0 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
(|Map#Equal| |t#0_0@0| (|Map#Build| |s#0_0@0| ($Box SeqType |x#0@@3|) ($Box intType (int_2_U (_module.__default.aval ($LS ($LS $LZ)) |a#0@@5| |s#0_0@0|)))))))))))) (=> (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|) (=> (not (_module.com.SKIP_q (|#_module.com.While| |b#0@@3| |c#0@@11|))) (=> (_module.com.Assign_q (|#_module.com.While| |b#0@@3| |c#0@@11|)) (let ((|a#0@@6| (_module.com._h1 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
(let ((|x#0@@4| (_module.com._h0 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
(|Map#Equal| |t#0_0@0| (|Map#Build| |s#0_0@0| ($Box SeqType |x#0@@4|) ($Box intType (int_2_U (_module.__default.aval ($LS ($LS $LZ)) |a#0@@6| |s#0_0@0|))))))))))) (and (=> (= (ControlFlow 0 16) (- 0 20)) (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|) (=> (not (_module.com.SKIP_q (|#_module.com.While| |b#0@@3| |c#0@@11|))) (=> (not (_module.com.Assign_q (|#_module.com.While| |b#0@@3| |c#0@@11|))) (=> (_module.com.Seq_q (|#_module.com.While| |b#0@@3| |c#0@@11|)) (let ((|c1#0@@2| (_module.com._h3 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
(let ((|c0#0@@2| (_module.com._h2 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
(exists ((|s'#0@@2| T@U) ) (!  (and ($Is MapType |s'#0@@2| (TMap (TSeq TChar) TInt)) (and (_module.__default.big__step ($LS $LZ) |c0#0@@2| |s#0_0@0| |s'#0@@2|) (_module.__default.big__step ($LS $LZ) |c1#0@@2| |s'#0@@2| |t#0_0@0|)))
 :qid |NipkowKleinchapter7dfy.48:12|
 :skolemid |868|
 :pattern ( (_module.__default.big__step ($LS $LZ) |c1#0@@2| |s'#0@@2| |t#0_0@0|))
 :pattern ( (_module.__default.big__step ($LS $LZ) |c0#0@@2| |s#0_0@0| |s'#0@@2|))
)))))))))) (=> (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|) (=> (not (_module.com.SKIP_q (|#_module.com.While| |b#0@@3| |c#0@@11|))) (=> (not (_module.com.Assign_q (|#_module.com.While| |b#0@@3| |c#0@@11|))) (=> (_module.com.Seq_q (|#_module.com.While| |b#0@@3| |c#0@@11|)) (let ((|c1#0@@3| (_module.com._h3 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
(let ((|c0#0@@3| (_module.com._h2 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
(exists ((|s'#0@@3| T@U) ) (!  (and ($Is MapType |s'#0@@3| (TMap (TSeq TChar) TInt)) (and (_module.__default.big__step ($LS $LZ) |c0#0@@3| |s#0_0@0| |s'#0@@3|) (_module.__default.big__step ($LS $LZ) |c1#0@@3| |s'#0@@3| |t#0_0@0|)))
 :qid |NipkowKleinchapter7dfy.48:12|
 :skolemid |868|
 :pattern ( (_module.__default.big__step ($LS $LZ) |c1#0@@3| |s'#0@@3| |t#0_0@0|))
 :pattern ( (_module.__default.big__step ($LS $LZ) |c0#0@@3| |s#0_0@0| |s'#0@@3|))
))))))))) (and (=> (= (ControlFlow 0 16) (- 0 19)) (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|) (=> (not (_module.com.SKIP_q (|#_module.com.While| |b#0@@3| |c#0@@11|))) (=> (not (_module.com.Assign_q (|#_module.com.While| |b#0@@3| |c#0@@11|))) (=> (not (_module.com.Seq_q (|#_module.com.While| |b#0@@3| |c#0@@11|))) (=> (_module.com.If_q (|#_module.com.While| |b#0@@3| |c#0@@11|)) (let ((|els#0@@2| (_module.com._h6 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
(let ((|thn#0@@2| (_module.com._h5 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
(let ((|b#1@@3| (_module.com._h4 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
(_module.__default.big__step ($LS ($LS $LZ)) (ite (_module.__default.bval ($LS ($LS $LZ)) |b#1@@3| |s#0_0@0|) |thn#0@@2| |els#0@@2|) |s#0_0@0| |t#0_0@0|))))))))))) (=> (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|) (=> (not (_module.com.SKIP_q (|#_module.com.While| |b#0@@3| |c#0@@11|))) (=> (not (_module.com.Assign_q (|#_module.com.While| |b#0@@3| |c#0@@11|))) (=> (not (_module.com.Seq_q (|#_module.com.While| |b#0@@3| |c#0@@11|))) (=> (_module.com.If_q (|#_module.com.While| |b#0@@3| |c#0@@11|)) (let ((|els#0@@3| (_module.com._h6 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
(let ((|thn#0@@3| (_module.com._h5 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
(let ((|b#1@@4| (_module.com._h4 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
(_module.__default.big__step ($LS ($LS $LZ)) (ite (_module.__default.bval ($LS ($LS $LZ)) |b#1@@4| |s#0_0@0|) |thn#0@@3| |els#0@@3|) |s#0_0@0| |t#0_0@0|)))))))))) (and (=> (= (ControlFlow 0 16) (- 0 18)) (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|) (=> (not (_module.com.SKIP_q (|#_module.com.While| |b#0@@3| |c#0@@11|))) (=> (not (_module.com.Assign_q (|#_module.com.While| |b#0@@3| |c#0@@11|))) (=> (not (_module.com.Seq_q (|#_module.com.While| |b#0@@3| |c#0@@11|))) (=> (not (_module.com.If_q (|#_module.com.While| |b#0@@3| |c#0@@11|))) (let ((|body#0@@2| (_module.com._h8 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
(let ((|b#2@@3| (_module.com._h7 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
 (or (and (not (_module.__default.bval ($LS ($LS $LZ)) |b#2@@3| |s#0_0@0|)) (|Map#Equal| |s#0_0@0| |t#0_0@0|)) (and (_module.__default.bval ($LS ($LS $LZ)) |b#2@@3| |s#0_0@0|) (exists ((|s'#1@@2| T@U) ) (!  (and ($Is MapType |s'#1@@2| (TMap (TSeq TChar) TInt)) (and (_module.__default.big__step ($LS ($LS $LZ)) |body#0@@2| |s#0_0@0| |s'#1@@2|) (_module.__default.big__step ($LS ($LS $LZ)) (|#_module.com.While| |b#2@@3| |body#0@@2|) |s'#1@@2| |t#0_0@0|)))
 :qid |NipkowKleinchapter7dfy.55:27|
 :skolemid |870|
 :pattern ( (_module.__default.big__step ($LS ($LS $LZ)) (|#_module.com.While| |b#2@@3| |body#0@@2|) |s'#1@@2| |t#0_0@0|))
 :pattern ( (_module.__default.big__step ($LS ($LS $LZ)) |body#0@@2| |s#0_0@0| |s'#1@@2|))
))))))))))))) (=> (=> (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|) (or (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|) (=> (not (_module.com.SKIP_q (|#_module.com.While| |b#0@@3| |c#0@@11|))) (=> (not (_module.com.Assign_q (|#_module.com.While| |b#0@@3| |c#0@@11|))) (=> (not (_module.com.Seq_q (|#_module.com.While| |b#0@@3| |c#0@@11|))) (=> (not (_module.com.If_q (|#_module.com.While| |b#0@@3| |c#0@@11|))) (let ((|body#0@@3| (_module.com._h8 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
(let ((|b#2@@4| (_module.com._h7 (|#_module.com.While| |b#0@@3| |c#0@@11|))))
 (or (and (not (_module.__default.bval ($LS ($LS $LZ)) |b#2@@4| |s#0_0@0|)) (|Map#Equal| |s#0_0@0| |t#0_0@0|)) (and (_module.__default.bval ($LS ($LS $LZ)) |b#2@@4| |s#0_0@0|) (exists ((|s'#1@@3| T@U) ) (!  (and ($Is MapType |s'#1@@3| (TMap (TSeq TChar) TInt)) (and (_module.__default.big__step ($LS ($LS $LZ)) |body#0@@3| |s#0_0@0| |s'#1@@3|) (_module.__default.big__step ($LS ($LS $LZ)) (|#_module.com.While| |b#2@@4| |body#0@@3|) |s'#1@@3| |t#0_0@0|)))
 :qid |NipkowKleinchapter7dfy.55:27|
 :skolemid |870|
 :pattern ( (_module.__default.big__step ($LS ($LS $LZ)) (|#_module.com.While| |b#2@@4| |body#0@@3|) |s'#1@@3| |t#0_0@0|))
 :pattern ( (_module.__default.big__step ($LS ($LS $LZ)) |body#0@@3| |s#0_0@0| |s'#1@@3|))
)))))))))))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (=> (|_module.__default.equiv__c#canCall| |c#0@@11| |c'#0@@1|) (or (_module.__default.equiv__c |c#0@@11| |c'#0@@1|) (forall ((|s#1@@3| T@U) (|t#1@@3| T@U) ) (!  (=> (and ($Is MapType |s#1@@3| (TMap (TSeq TChar) TInt)) ($Is MapType |t#1@@3| (TMap (TSeq TChar) TInt))) (= (_module.__default.big__step ($LS ($LS $LZ)) |c#0@@11| |s#1@@3| |t#1@@3|) (_module.__default.big__step ($LS ($LS $LZ)) |c'#0@@1| |s#1@@3| |t#1@@3|)))
 :qid |NipkowKleinchapter7dfy.84:10|
 :skolemid |873|
 :pattern ( (_module.__default.big__step ($LS ($LS $LZ)) |c'#0@@1| |s#1@@3| |t#1@@3|))
 :pattern ( (_module.__default.big__step ($LS ($LS $LZ)) |c#0@@11| |s#1@@3| |t#1@@3|))
))))) (=> (=> (|_module.__default.equiv__c#canCall| |c#0@@11| |c'#0@@1|) (or (_module.__default.equiv__c |c#0@@11| |c'#0@@1|) (forall ((|s#1@@4| T@U) (|t#1@@4| T@U) ) (!  (=> (and ($Is MapType |s#1@@4| (TMap (TSeq TChar) TInt)) ($Is MapType |t#1@@4| (TMap (TSeq TChar) TInt))) (= (_module.__default.big__step ($LS ($LS $LZ)) |c#0@@11| |s#1@@4| |t#1@@4|) (_module.__default.big__step ($LS ($LS $LZ)) |c'#0@@1| |s#1@@4| |t#1@@4|)))
 :qid |NipkowKleinchapter7dfy.84:10|
 :skolemid |873|
 :pattern ( (_module.__default.big__step ($LS ($LS $LZ)) |c'#0@@1| |s#1@@4| |t#1@@4|))
 :pattern ( (_module.__default.big__step ($LS ($LS $LZ)) |c#0@@11| |s#1@@4| |t#1@@4|))
)))) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|)) (=> (and (and (and (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|) (and (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_0@0| |t#0_0@0|) (ite (_module.com.SKIP_q (|#_module.com.While| |b#0@@3| |c'#0@@1|)) (|Map#Equal| |s#0_0@0| |t#0_0@0|) (ite (_module.com.Assign_q (|#_module.com.While| |b#0@@3| |c'#0@@1|)) (let ((|a#3@@1| (_module.com._h1 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
(let ((|x#3@@0| (_module.com._h0 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
(|Map#Equal| |t#0_0@0| (|Map#Build| |s#0_0@0| ($Box SeqType |x#3@@0|) ($Box intType (int_2_U (_module.__default.aval ($LS $LZ) |a#3@@1| |s#0_0@0|))))))) (ite (_module.com.Seq_q (|#_module.com.While| |b#0@@3| |c'#0@@1|)) (let ((|c1#3@@1| (_module.com._h3 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
(let ((|c0#3@@1| (_module.com._h2 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
(exists ((|s'#6@@0| T@U) ) (!  (and ($Is MapType |s'#6@@0| (TMap (TSeq TChar) TInt)) (and (_module.__default.big__step ($LS $LZ) |c0#3@@1| |s#0_0@0| |s'#6@@0|) (_module.__default.big__step ($LS $LZ) |c1#3@@1| |s'#6@@0| |t#0_0@0|)))
 :qid |NipkowKleinchapter7dfy.48:12|
 :skolemid |879|
 :pattern ( (_module.__default.big__step ($LS $LZ) |c1#3@@1| |s'#6@@0| |t#0_0@0|))
 :pattern ( (_module.__default.big__step ($LS $LZ) |c0#3@@1| |s#0_0@0| |s'#6@@0|))
)))) (ite (_module.com.If_q (|#_module.com.While| |b#0@@3| |c'#0@@1|)) (let ((|els#3@@1| (_module.com._h6 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
(let ((|thn#3@@1| (_module.com._h5 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
(let ((|b#7@@1| (_module.com._h4 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
(_module.__default.big__step ($LS $LZ) (ite (_module.__default.bval ($LS $LZ) |b#7@@1| |s#0_0@0|) |thn#3@@1| |els#3@@1|) |s#0_0@0| |t#0_0@0|)))) (let ((|body#3@@1| (_module.com._h8 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
(let ((|b#8@@1| (_module.com._h7 (|#_module.com.While| |b#0@@3| |c'#0@@1|))))
 (or (and (not (_module.__default.bval ($LS $LZ) |b#8@@1| |s#0_0@0|)) (|Map#Equal| |s#0_0@0| |t#0_0@0|)) (and (_module.__default.bval ($LS $LZ) |b#8@@1| |s#0_0@0|) (exists ((|s'#7@@0| T@U) ) (!  (and ($Is MapType |s'#7@@0| (TMap (TSeq TChar) TInt)) (and (_module.__default.big__step ($LS $LZ) |body#3@@1| |s#0_0@0| |s'#7@@0|) (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#8@@1| |body#3@@1|) |s'#7@@0| |t#0_0@0|)))
 :qid |NipkowKleinchapter7dfy.55:27|
 :skolemid |880|
 :pattern ( (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#8@@1| |body#3@@1|) |s'#7@@0| |t#0_0@0|))
 :pattern ( (_module.__default.big__step ($LS $LZ) |body#3@@1| |s#0_0@0| |s'#7@@0|))
)))))))))))) (= $Heap $Heap@0)) (and (= $Heap@1 $Heap@0) (= (ControlFlow 0 16) 15))) anon6_correct)))))))))))))))))
(let ((anon12_Else_correct  (=> (and (= |##c#0_2@0| (|#_module.com.While| |b#0@@3| |c#0@@11|)) ($IsAlloc DatatypeTypeType |##c#0_2@0| Tclass._module.com $Heap)) (=> (and (and ($IsAlloc MapType |s#0_0@0| (TMap (TSeq TChar) TInt) $Heap) ($IsAlloc MapType |t#0_0@0| (TMap (TSeq TChar) TInt) $Heap)) (and (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|) (|_module.__default.big__step#canCall| (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_0@0| |t#0_0@0|))) (and (=> (= (ControlFlow 0 24) 16) anon13_Then_correct) (=> (= (ControlFlow 0 24) 23) anon13_Else_correct))))))
(let ((anon12_Then_correct true))
(let ((anon11_Then_correct  (=> (and ($Is MapType |s#0_0@0| (TMap (TSeq TChar) TInt)) ($Is MapType |t#0_0@0| (TMap (TSeq TChar) TInt))) (and (=> (= (ControlFlow 0 25) 4) anon12_Then_correct) (=> (= (ControlFlow 0 25) 24) anon12_Else_correct)))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.__default.equiv__c#canCall| (|#_module.com.While| |b#0@@3| |c#0@@11|) (|#_module.com.While| |b#0@@3| |c'#0@@1|)) (or (_module.__default.equiv__c (|#_module.com.While| |b#0@@3| |c#0@@11|) (|#_module.com.While| |b#0@@3| |c'#0@@1|)) (forall ((|s#3| T@U) (|t#3| T@U) ) (!  (=> (and ($Is MapType |s#3| (TMap (TSeq TChar) TInt)) ($Is MapType |t#3| (TMap (TSeq TChar) TInt))) (= (_module.__default.big__step ($LS ($LS $LZ)) (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#3| |t#3|) (_module.__default.big__step ($LS ($LS $LZ)) (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#3| |t#3|)))
 :qid |NipkowKleinchapter7dfy.84:10|
 :skolemid |862|
 :pattern ( (_module.__default.big__step ($LS ($LS $LZ)) (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#3| |t#3|))
 :pattern ( (_module.__default.big__step ($LS ($LS $LZ)) (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#3| |t#3|))
)))))))
(let ((anon11_Else_correct  (=> (and (forall ((|s#0_1| T@U) (|t#0_1| T@U) ) (!  (=> (and (and ($Is MapType |s#0_1| (TMap (TSeq TChar) TInt)) ($Is MapType |t#0_1| (TMap (TSeq TChar) TInt))) (U_2_bool (Lit boolType (bool_2_U true)))) (= (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_1| |t#0_1|) (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_1| |t#0_1|)))
 :qid |NipkowKleinchapter7dfy.101:10|
 :skolemid |867|
 :pattern ( (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c'#0@@1|) |s#0_1| |t#0_1|))
 :pattern ( (_module.__default.big__step ($LS $LZ) (|#_module.com.While| |b#0@@3| |c#0@@11|) |s#0_1| |t#0_1|))
)) (= (ControlFlow 0 3) 2)) GeneratedUnifiedExit_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 26) 25) anon11_Then_correct) (=> (= (ControlFlow 0 26) 3) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |b#0@@3| Tclass._module.bexp) ($IsAlloc DatatypeTypeType |b#0@@3| Tclass._module.bexp $Heap)) (|$IsA#_module.bexp| |b#0@@3|)) (and (and ($Is DatatypeTypeType |c#0@@11| Tclass._module.com) ($IsAlloc DatatypeTypeType |c#0@@11| Tclass._module.com $Heap)) (|$IsA#_module.com| |c#0@@11|))) (=> (and (and (and (and ($Is DatatypeTypeType |c'#0@@1| Tclass._module.com) ($IsAlloc DatatypeTypeType |c'#0@@1| Tclass._module.com $Heap)) (|$IsA#_module.com| |c'#0@@1|)) (= 7 $FunctionContextHeight)) (and (and (|_module.__default.equiv__c#canCall| |c#0@@11| |c'#0@@1|) (and (_module.__default.equiv__c |c#0@@11| |c'#0@@1|) (forall ((|s#2| T@U) (|t#2| T@U) ) (!  (=> (and ($Is MapType |s#2| (TMap (TSeq TChar) TInt)) ($Is MapType |t#2| (TMap (TSeq TChar) TInt))) (= (_module.__default.big__step ($LS $LZ) |c#0@@11| |s#2| |t#2|) (_module.__default.big__step ($LS $LZ) |c'#0@@1| |s#2| |t#2|)))
 :qid |NipkowKleinchapter7dfy.84:10|
 :skolemid |861|
 :pattern ( (_module.__default.big__step ($LS $LZ) |c'#0@@1| |s#2| |t#2|))
 :pattern ( (_module.__default.big__step ($LS $LZ) |c#0@@11| |s#2| |t#2|))
