...
(set-info :boogie-vc-id Impl$$_module.__default.Theorem1__LexLess__Is__Transitive_h)
...
(let ((anon6_Else_correct  (=> (and (or (not (= (U_2_int ($Unbox intType (_module.Stream.hd |s#1|))) (U_2_int ($Unbox intType (_module.Stream.hd |u#1|))))) (not true)) (= (ControlFlow 0 11) 2)) GeneratedUnifiedExit_correct)))
(let ((anon6_Then_correct  (=> (= (U_2_int ($Unbox intType (_module.Stream.hd |s#1|))) (U_2_int ($Unbox intType (_module.Stream.hd |u#1|)))) (and (=> (= (ControlFlow 0 5) (- 0 10)) ($Is intType (int_2_U (- |_k#0@@6| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |_k#0@@6| 1)) Tclass._System.nat) (=> (and (= |_k##0@0| (- |_k#0@@6| 1)) (_module.Stream.Cons_q |s#1|)) (=> (and (and (and (_module.Stream.Cons_q |s#1|) (= |s##0@0| (_module.Stream.tl |s#1|))) (and (_module.Stream.Cons_q |t#1|) (_module.Stream.Cons_q |t#1|))) (and (and (= |t##0@0| (_module.Stream.tl |t#1|)) (_module.Stream.Cons_q |u#1|)) (and (_module.Stream.Cons_q |u#1|) (= |u##0@0| (_module.Stream.tl |u#1|))))) (and (=> (= (ControlFlow 0 5) (- 0 9)) (=> (|_module.__default.LexLess#canCall| |s##0@0| |t##0@0|) (or (_module.__default.LexLess ($LS $LZ) |s##0@0| |t##0@0|) (<= (U_2_int ($Unbox intType (_module.Stream.hd |s##0@0|))) (U_2_int ($Unbox intType (_module.Stream.hd |t##0@0|))))))) (=> (=> (|_module.__default.LexLess#canCall| |s##0@0| |t##0@0|) (or (_module.__default.LexLess ($LS $LZ) |s##0@0| |t##0@0|) (<= (U_2_int ($Unbox intType (_module.Stream.hd |s##0@0|))) (U_2_int ($Unbox intType (_module.Stream.hd |t##0@0|)))))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (=> (|_module.__default.LexLess#canCall| |s##0@0| |t##0@0|) (or (_module.__default.LexLess ($LS $LZ) |s##0@0| |t##0@0|) (=> (= (U_2_int ($Unbox intType (_module.Stream.hd |s##0@0|))) (U_2_int ($Unbox intType (_module.Stream.hd |t##0@0|)))) (_module.__default.LexLess ($LS ($LS $LZ)) (_module.Stream.tl |s##0@0|) (_module.Stream.tl |t##0@0|)))))) (=> (=> (|_module.__default.LexLess#canCall| |s##0@0| |t##0@0|) (or (_module.__default.LexLess ($LS $LZ) |s##0@0| |t##0@0|) (=> (= (U_2_int ($Unbox intType (_module.Stream.hd |s##0@0|))) (U_2_int ($Unbox intType (_module.Stream.hd |t##0@0|)))) (_module.__default.LexLess ($LS ($LS $LZ)) (_module.Stream.tl |s##0@0|) (_module.Stream.tl |t##0@0|))))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (=> (|_module.__default.LexLess#canCall| |t##0@0| |u##0@0|) (or (_module.__default.LexLess ($LS $LZ) |t##0@0| |u##0@0|) (<= (U_2_int ($Unbox intType (_module.Stream.hd |t##0@0|))) (U_2_int ($Unbox intType (_module.Stream.hd |u##0@0|))))))) (=> (=> (|_module.__default.LexLess#canCall| |t##0@0| |u##0@0|) (or (_module.__default.LexLess ($LS $LZ) |t##0@0| |u##0@0|) (<= (U_2_int ($Unbox intType (_module.Stream.hd |t##0@0|))) (U_2_int ($Unbox intType (_module.Stream.hd |u##0@0|)))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (=> (|_module.__default.LexLess#canCall| |t##0@0| |u##0@0|) (or (_module.__default.LexLess ($LS $LZ) |t##0@0| |u##0@0|) (=> (= (U_2_int ($Unbox intType (_module.Stream.hd |t##0@0|))) (U_2_int ($Unbox intType (_module.Stream.hd |u##0@0|)))) (_module.__default.LexLess ($LS ($LS $LZ)) (_module.Stream.tl |t##0@0|) (_module.Stream.tl |u##0@0|)))))) (=> (=> (|_module.__default.LexLess#canCall| |t##0@0| |u##0@0|) (or (_module.__default.LexLess ($LS $LZ) |t##0@0| |u##0@0|) (=> (= (U_2_int ($Unbox intType (_module.Stream.hd |t##0@0|))) (U_2_int ($Unbox intType (_module.Stream.hd |u##0@0|)))) (_module.__default.LexLess ($LS ($LS $LZ)) (_module.Stream.tl |t##0@0|) (_module.Stream.tl |u##0@0|))))) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (|_module.__default.LexLess_h#canCall| |_k##0@0| |s##0@0| |u##0@0|)) (and (and (|_module.__default.LexLess_h#canCall| |_k##0@0| |s##0@0| |u##0@0|) (and (_module.__default.LexLess_h ($LS $LZ) |_k##0@0| |s##0@0| |u##0@0|) (=> (< 0 |_k##0@0|) (and (<= (U_2_int ($Unbox intType (_module.Stream.hd |s##0@0|))) (U_2_int ($Unbox intType (_module.Stream.hd |u##0@0|)))) (=> (= (U_2_int ($Unbox intType (_module.Stream.hd |s##0@0|))) (U_2_int ($Unbox intType (_module.Stream.hd |u##0@0|)))) (_module.__default.LexLess_h ($LS $LZ) (- |_k##0@0| 1) (_module.Stream.tl |s##0@0|) (_module.Stream.tl |u##0@0|))))))) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 5) 2)))) GeneratedUnifiedExit_correct))))))))))))))))
(let ((anon5_Then_correct  (=> (< 0 |_k#0@@6|) (=> (and (and (_module.Stream.Cons_q |s#1|) (_module.Stream.Cons_q |u#1|)) (and (_module.Stream.Cons_q |s#1|) (_module.Stream.Cons_q |u#1|))) (and (=> (= (ControlFlow 0 12) 5) anon6_Then_correct) (=> (= (ControlFlow 0 12) 11) anon6_Else_correct))))))
(let ((anon5_Else_correct  (=> (and (<= |_k#0@@6| 0) (= (ControlFlow 0 4) 2)) GeneratedUnifiedExit_correct)))
...
))))) (and (=> (= (ControlFlow 0 13) 12) anon5_Then_correct) (=> (= (ControlFlow 0 13) 4) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |_k#0@@6|)) (=> (and (and (and ($Is DatatypeTypeType |s#1| (Tclass._module.Stream TInt)) ($IsAlloc DatatypeTypeType |s#1| (Tclass._module.Stream TInt) $Heap)) (|$IsA#_module.Stream| |s#1|)) (and (and ($Is DatatypeTypeType |t#1| (Tclass._module.Stream TInt)) ($IsAlloc DatatypeTypeType |t#1| (Tclass._module.Stream TInt) $Heap)) (|$IsA#_module.Stream| |t#1|))) (=> (and (and (and (and (and ($Is DatatypeTypeType |u#1| (Tclass._module.Stream TInt)) ($IsAlloc DatatypeTypeType |u#1| (Tclass._module.Stream TInt) $Heap)) (|$IsA#_module.Stream| |u#1|)) (= 3 $FunctionContextHeight)) (and (|_module.__default.LexLess#canCall| |s#1| |t#1|) (and (_module.__default.LexLess ($LS $LZ) |s#1| |t#1|) (and (<= (U_2_int ($Unbox intType (_module.Stream.hd |s#1|))) (U_2_int ($Unbox intType (_module.Stream.hd |t#1|)))) (=> (= (U_2_int ($Unbox intType (_module.Stream.hd |s#1|))) (U_2_int ($Unbox intType (_module.Stream.hd |t#1|)))) (_module.__default.LexLess ($LS $LZ) (_module.Stream.tl |s#1|) (_module.Stream.tl |t#1|))))))) (and (and (|_module.__default.LexLess#canCall| |t#1| |u#1|) (and (_module.__default.LexLess ($LS $LZ) |t#1| |u#1|) (and (<= (U_2_int ($Unbox intType (_module.Stream.hd |t#1|))) (U_2_int ($Unbox intType (_module.Stream.hd |u#1|)))) (=> (= (U_2_int ($Unbox intType (_module.Stream.hd |t#1|))) (U_2_int ($Unbox intType (_module.Stream.hd |u#1|)))) (_module.__default.LexLess ($LS $LZ) (_module.Stream.tl |t#1|) (_module.Stream.tl |u#1|)))))) (= (ControlFlow 0 14) 13))) anon0_correct)))))
