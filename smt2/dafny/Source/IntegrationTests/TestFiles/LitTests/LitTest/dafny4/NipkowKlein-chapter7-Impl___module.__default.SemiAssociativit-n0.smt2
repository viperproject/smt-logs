...
(set-info :boogie-vc-id Impl$$_module.__default.SemiAssociativity)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.com| |c0#0@@0|)) (and (|$IsA#_module.com| |c1#0@@0|) (|$IsA#_module.com| |c2#0|))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (forall ((|$ih#c00#0| T@U) (|$ih#c10#0| T@U) (|$ih#c20#0| T@U) (|$ih#s0#0| T@U) (|$ih#t0#0| T@U) ) (!  (=> (and (and (and (and (and (and ($Is DatatypeTypeType |$ih#c00#0| Tclass._module.com) ($Is DatatypeTypeType |$ih#c10#0| Tclass._module.com)) ($Is DatatypeTypeType |$ih#c20#0| Tclass._module.com)) ($Is MapType |$ih#s0#0| (TMap (TSeq TChar) TInt))) ($Is MapType |$ih#t0#0| (TMap (TSeq TChar) TInt))) (U_2_bool (Lit boolType (bool_2_U true)))) (or (< (DtRank |$ih#c00#0|) (DtRank |c0#0@@0|)) (and (= (DtRank |$ih#c00#0|) (DtRank |c0#0@@0|)) (or (< (DtRank |$ih#c10#0|) (DtRank |c1#0@@0|)) (and (= (DtRank |$ih#c10#0|) (DtRank |c1#0@@0|)) (or (< (DtRank |$ih#c20#0|) (DtRank |c2#0|)) (and (= (DtRank |$ih#c20#0|) (DtRank |c2#0|)) (or (and (|Set#Subset| (|Map#Domain| |$ih#s0#0|) (|Map#Domain| |s#0@@15|)) (not (|Set#Subset| (|Map#Domain| |s#0@@15|) (|Map#Domain| |$ih#s0#0|)))) (and (|Set#Equal| (|Map#Domain| |$ih#s0#0|) (|Map#Domain| |s#0@@15|)) (and (|Set#Subset| (|Map#Domain| |$ih#t0#0|) (|Map#Domain| |t#0@@9|)) (not (|Set#Subset| (|Map#Domain| |t#0@@9|) (|Map#Domain| |$ih#t0#0|))))))))))))) (= (_module.__default.big__step ($LS $LZ) (|#_module.com.Seq| (|#_module.com.Seq| |$ih#c00#0| |$ih#c10#0|) |$ih#c20#0|) |$ih#s0#0| |$ih#t0#0|) (_module.__default.big__step ($LS $LZ) (|#_module.com.Seq| |$ih#c00#0| (|#_module.com.Seq| |$ih#c10#0| |$ih#c20#0|)) |$ih#s0#0| |$ih#t0#0|)))
 :qid |NipkowKleinchapter7dfy.77:25|
 :skolemid |827|
 :pattern ( (_module.__default.big__step ($LS $LZ) (|#_module.com.Seq| |$ih#c00#0| (|#_module.com.Seq| |$ih#c10#0| |$ih#c20#0|)) |$ih#s0#0| |$ih#t0#0|))
 :pattern ( (_module.__default.big__step ($LS $LZ) (|#_module.com.Seq| (|#_module.com.Seq| |$ih#c00#0| |$ih#c10#0|) |$ih#c20#0|) |$ih#s0#0| |$ih#t0#0|))
)) (= (ControlFlow 0 2) (- 0 1)))) (= (_module.__default.big__step ($LS ($LS $LZ)) (|#_module.com.Seq| (|#_module.com.Seq| |c0#0@@0| |c1#0@@0|) |c2#0|) |s#0@@15| |t#0@@9|) (_module.__default.big__step ($LS ($LS $LZ)) (|#_module.com.Seq| |c0#0@@0| (|#_module.com.Seq| |c1#0@@0| |c2#0|)) |s#0@@15| |t#0@@9|))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |c0#0@@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |c0#0@@0| Tclass._module.com $Heap)) (|$IsA#_module.com| |c0#0@@0|)) (and (and ($Is DatatypeTypeType |c1#0@@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |c1#0@@0| Tclass._module.com $Heap)) (|$IsA#_module.com| |c1#0@@0|))) (=> (and (and (and (and ($Is DatatypeTypeType |c2#0| Tclass._module.com) ($IsAlloc DatatypeTypeType |c2#0| Tclass._module.com $Heap)) (|$IsA#_module.com| |c2#0|)) (and ($Is MapType |s#0@@15| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |s#0@@15| (TMap (TSeq TChar) TInt) $Heap))) (and (and ($Is MapType |t#0@@9| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |t#0@@9| (TMap (TSeq TChar) TInt) $Heap)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))))
