...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.INDUCTION__EVEN__ODD)
...
(let ((anon17_Else_correct  (=> (and (=> (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U |a#6@0|)) ($Box intType (int_2_U |b#6@0|))))) (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U (+ (Mul (LitInt 2) |a#6@0|) 1))) ($Box intType (int_2_U (+ (Mul (LitInt 2) |b#6@0|) 1))))))) (= (ControlFlow 0 5) 1)) anon13_correct)))
(let ((anon17_Then_correct  (=> (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U |a#6@0|)) ($Box intType (int_2_U |b#6@0|))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($Is intType (int_2_U (+ (Mul (LitInt 2) |a#6@0|) 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ (Mul (LitInt 2) |a#6@0|) 1)) Tclass._System.nat) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($Is intType (int_2_U (+ (Mul (LitInt 2) |b#6@0|) 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ (Mul (LitInt 2) |b#6@0|) 1)) Tclass._System.nat) (=> (and (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U (+ (Mul (LitInt 2) |a#6@0|) 1))) ($Box intType (int_2_U (+ (Mul (LitInt 2) |b#6@0|) 1)))))) (= (ControlFlow 0 2) 1)) anon13_correct))))))))
(let ((anon10_correct  (=> (forall ((|a#5| Int) (|b#5| Int) (|_t#0#1| T@U) ) (!  (=> (and (and (<= (LitInt 0) |a#5|) (<= (LitInt 0) |b#5|)) (= (U_2_int |_t#0#1|) (+ (Mul (LitInt 2) |a#5|) 1))) (=> (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U |a#5|)) ($Box intType (int_2_U |b#5|))))) (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType |_t#0#1|) ($Box intType (int_2_U (Mul (LitInt 2) |b#5|))))))))
 :qid |Lucasupdfy.302:19|
 :skolemid |609|
 :pattern ( ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType |_t#0#1|) ($Box intType (int_2_U (Mul 2 |b#5|))))) ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U |a#5|)) ($Box intType (int_2_U |b#5|)))))
 :pattern ( ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType |_t#0#1|) ($Box intType (int_2_U (Mul 2 |b#5|))))) (Mul 2 |a#5|))
)) (=> (and (<= (LitInt 0) |a#6@0|) (<= (LitInt 0) |b#6@0|)) (and (=> (= (ControlFlow 0 6) 2) anon17_Then_correct) (=> (= (ControlFlow 0 6) 5) anon17_Else_correct))))))
(let ((anon16_Else_correct  (=> (and (=> (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U |a#4@0|)) ($Box intType (int_2_U |b#4@0|))))) (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U (+ (Mul (LitInt 2) |a#4@0|) 1))) ($Box intType (int_2_U (Mul (LitInt 2) |b#4@0|))))))) (= (ControlFlow 0 10) 6)) anon10_correct)))
(let ((anon16_Then_correct  (=> (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U |a#4@0|)) ($Box intType (int_2_U |b#4@0|))))) (and (=> (= (ControlFlow 0 7) (- 0 9)) ($Is intType (int_2_U (+ (Mul (LitInt 2) |a#4@0|) 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ (Mul (LitInt 2) |a#4@0|) 1)) Tclass._System.nat) (and (=> (= (ControlFlow 0 7) (- 0 8)) ($Is intType (int_2_U (Mul (LitInt 2) |b#4@0|)) Tclass._System.nat)) (=> ($Is intType (int_2_U (Mul (LitInt 2) |b#4@0|)) Tclass._System.nat) (=> (and (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U (+ (Mul (LitInt 2) |a#4@0|) 1))) ($Box intType (int_2_U (Mul (LitInt 2) |b#4@0|)))))) (= (ControlFlow 0 7) 6)) anon10_correct))))))))
(let ((anon7_correct  (=> (forall ((|a#3| Int) (|b#3| Int) (|_t#0#0| T@U) ) (!  (=> (and (and (<= (LitInt 0) |a#3|) (<= (LitInt 0) |b#3|)) (= (U_2_int |_t#0#0|) (+ (Mul (LitInt 2) |b#3|) 1))) (=> (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U |a#3|)) ($Box intType (int_2_U |b#3|))))) (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U (Mul (LitInt 2) |a#3|))) ($Box intType |_t#0#0|))))))
 :qid |Lucasupdfy.301:19|
 :skolemid |608|
 :pattern ( ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U (Mul 2 |a#3|))) ($Box intType |_t#0#0|))) ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U |a#3|)) ($Box intType (int_2_U |b#3|)))))
 :pattern ( ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U (Mul 2 |a#3|))) ($Box intType |_t#0#0|))) (Mul 2 |b#3|))
)) (=> (and (<= (LitInt 0) |a#4@0|) (<= (LitInt 0) |b#4@0|)) (and (=> (= (ControlFlow 0 11) 7) anon16_Then_correct) (=> (= (ControlFlow 0 11) 10) anon16_Else_correct))))))
(let ((anon15_Else_correct  (=> (and (=> (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U |a#2@0|)) ($Box intType (int_2_U |b#2@0|))))) (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U (Mul (LitInt 2) |a#2@0|))) ($Box intType (int_2_U (+ (Mul (LitInt 2) |b#2@0|) 1))))))) (= (ControlFlow 0 15) 11)) anon7_correct)))
(let ((anon15_Then_correct  (=> (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U |a#2@0|)) ($Box intType (int_2_U |b#2@0|))))) (and (=> (= (ControlFlow 0 12) (- 0 14)) ($Is intType (int_2_U (Mul (LitInt 2) |a#2@0|)) Tclass._System.nat)) (=> ($Is intType (int_2_U (Mul (LitInt 2) |a#2@0|)) Tclass._System.nat) (and (=> (= (ControlFlow 0 12) (- 0 13)) ($Is intType (int_2_U (+ (Mul (LitInt 2) |b#2@0|) 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ (Mul (LitInt 2) |b#2@0|) 1)) Tclass._System.nat) (=> (and (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U (Mul (LitInt 2) |a#2@0|))) ($Box intType (int_2_U (+ (Mul (LitInt 2) |b#2@0|) 1)))))) (= (ControlFlow 0 12) 11)) anon7_correct))))))))
(let ((anon4_correct  (=> (forall ((|a#1| Int) (|b#1| Int) ) (!  (=> (and (<= (LitInt 0) |a#1|) (<= (LitInt 0) |b#1|)) (=> (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U |a#1|)) ($Box intType (int_2_U |b#1|))))) (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U (Mul (LitInt 2) |a#1|))) ($Box intType (int_2_U (Mul (LitInt 2) |b#1|))))))))
 :qid |Lucasupdfy.300:19|
 :skolemid |607|
 :pattern ( (Mul 2 |b#1|) (Mul 2 |a#1|))
)) (=> (and (<= (LitInt 0) |a#2@0|) (<= (LitInt 0) |b#2@0|)) (and (=> (= (ControlFlow 0 16) 12) anon15_Then_correct) (=> (= (ControlFlow 0 16) 15) anon15_Else_correct))))))
(let ((anon14_Else_correct  (=> (and (=> (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U |a#0@0|)) ($Box intType (int_2_U |b#0@0|))))) (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U (Mul (LitInt 2) |a#0@0|))) ($Box intType (int_2_U (Mul (LitInt 2) |b#0@0|))))))) (= (ControlFlow 0 20) 16)) anon4_correct)))
(let ((anon14_Then_correct  (=> (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U |a#0@0|)) ($Box intType (int_2_U |b#0@0|))))) (and (=> (= (ControlFlow 0 17) (- 0 19)) ($Is intType (int_2_U (Mul (LitInt 2) |a#0@0|)) Tclass._System.nat)) (=> ($Is intType (int_2_U (Mul (LitInt 2) |a#0@0|)) Tclass._System.nat) (and (=> (= (ControlFlow 0 17) (- 0 18)) ($Is intType (int_2_U (Mul (LitInt 2) |b#0@0|)) Tclass._System.nat)) (=> ($Is intType (int_2_U (Mul (LitInt 2) |b#0@0|)) Tclass._System.nat) (=> (and (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U (Mul (LitInt 2) |a#0@0|))) ($Box intType (int_2_U (Mul (LitInt 2) |b#0@0|)))))) (= (ControlFlow 0 17) 16)) anon4_correct))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 21) (- 0 23)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (and (=> (= (ControlFlow 0 21) (- 0 22)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat Tclass._System.nat TBool $Heap |P#0| ($Box intType (int_2_U (LitInt 0))) ($Box intType (int_2_U (LitInt 0)))))) (=> (and (<= (LitInt 0) |a#0@0|) (<= (LitInt 0) |b#0@0|)) (and (=> (= (ControlFlow 0 21) 17) anon14_Then_correct) (=> (= (ControlFlow 0 21) 20) anon14_Else_correct)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is HandleTypeType |P#0| (Tclass._System.___hTotalFunc2 Tclass._System.nat Tclass._System.nat TBool)) ($IsAlloc HandleTypeType |P#0| (Tclass._System.___hTotalFunc2 Tclass._System.nat Tclass._System.nat TBool) $Heap))) (and (and (<= (LitInt 0) |A#0|) (<= (LitInt 0) |B#0|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 24) 21)))) anon0_correct)))
