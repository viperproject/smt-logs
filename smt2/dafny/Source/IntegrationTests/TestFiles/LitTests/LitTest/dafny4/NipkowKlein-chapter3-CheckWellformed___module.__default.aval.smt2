...
(assert (forall ((d@@5 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.aexp.N_q d@@5) ($IsAlloc DatatypeTypeType d@@5 Tclass._module.aexp $h@@1))) ($IsAlloc intType (int_2_U (_module.aexp.n d@@5)) TInt $h@@1))
 :qid |unknown.0:0|
 :skolemid |734|
 :pattern ( ($IsAlloc intType (int_2_U (_module.aexp.n d@@5)) TInt $h@@1))
)))
...
(assert (forall ((d@@7 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) ($Is DatatypeTypeType d@@7 Tclass._module.aexp)) ($IsAlloc DatatypeTypeType d@@7 Tclass._module.aexp $h@@2))
 :qid |unknown.0:0|
 :skolemid |759|
 :pattern ( ($IsAlloc DatatypeTypeType d@@7 Tclass._module.aexp $h@@2))
)))
...
(assert (forall ((d@@8 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (_module.aexp.V_q d@@8) ($IsAlloc DatatypeTypeType d@@8 Tclass._module.aexp $h@@3))) ($IsAlloc SeqType (_module.aexp._h0 d@@8) (TSeq TChar) $h@@3))
 :qid |unknown.0:0|
 :skolemid |742|
 :pattern ( ($IsAlloc SeqType (_module.aexp._h0 d@@8) (TSeq TChar) $h@@3))
)))
...
(assert (forall ((d@@9 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (_module.aexp.Plus_q d@@9) ($IsAlloc DatatypeTypeType d@@9 Tclass._module.aexp $h@@4))) ($IsAlloc DatatypeTypeType (_module.aexp._h1 d@@9) Tclass._module.aexp $h@@4))
 :qid |unknown.0:0|
 :skolemid |752|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.aexp._h1 d@@9) Tclass._module.aexp $h@@4))
)))
(assert (forall ((d@@10 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (_module.aexp.Plus_q d@@10) ($IsAlloc DatatypeTypeType d@@10 Tclass._module.aexp $h@@5))) ($IsAlloc DatatypeTypeType (_module.aexp._h2 d@@10) Tclass._module.aexp $h@@5))
 :qid |unknown.0:0|
 :skolemid |753|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.aexp._h2 d@@10) Tclass._module.aexp $h@@5))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.aval)
...
(let ((anon12_Then_correct  (=> (= |a#0@@3| (|#_module.aexp.Plus| |_mcc#2#0| |_mcc#3#0|)) (=> (and ($Is DatatypeTypeType |_mcc#2#0| Tclass._module.aexp) ($Is DatatypeTypeType |_mcc#3#0| Tclass._module.aexp)) (=> (and (and (and (= |let#0#0#0| |_mcc#3#0|) ($Is DatatypeTypeType |let#0#0#0| Tclass._module.aexp)) (and (= |a1#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#2#0|))) (and (and ($Is DatatypeTypeType |let#1#0#0| Tclass._module.aexp) (= |a0#Z#0@0| |let#1#0#0|)) (and ($IsAlloc DatatypeTypeType |a0#Z#0@0| Tclass._module.aexp $Heap@@2) ($IsAlloc HandleTypeType |s#0@@3| (Tclass._System.___hTotalFunc1 (TSeq TChar) TInt) $Heap@@2)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< (DtRank |a0#Z#0@0|) (DtRank |a#0@@3|))) (=> (< (DtRank |a0#Z#0@0|) (DtRank |a#0@@3|)) (=> (and (and (|_module.__default.aval#canCall| |a0#Z#0@0| |s#0@@3|) ($IsAlloc DatatypeTypeType |a1#Z#0@0| Tclass._module.aexp $Heap@@2)) (and ($IsAlloc HandleTypeType |s#0@@3| (Tclass._System.___hTotalFunc1 (TSeq TChar) TInt) $Heap@@2) (= (ControlFlow 0 5) (- 0 4)))) (< (DtRank |a1#Z#0@0|) (DtRank |a#0@@3|))))))))))
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (and (and (=> (= (ControlFlow 0 10) 1) anon9_Then_correct) (=> (= (ControlFlow 0 10) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon10_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and ($Is DatatypeTypeType |a#0@@3| Tclass._module.aexp) ($Is HandleTypeType |s#0@@3| (Tclass._System.___hTotalFunc1 (TSeq TChar) TInt))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct))))
