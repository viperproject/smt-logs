...
(set-info :boogie-vc-id Impl$$_module.__default.equiv__trans)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|_module.__default.equiv#canCall| |l#0@@6| |l''#0|)) (or (_module.__default.equiv |l#0@@6| |l''#0|) (forall ((|z#5| Int) ) (! (= (_module.__default.nb__occ ($LS ($LS $LZ)) |z#5| |l#0@@6|) (_module.__default.nb__occ ($LS ($LS $LZ)) |z#5| |l''#0|))
 :qid |CoqArtInsertionSortdfy.55:10|
 :skolemid |592|
 :pattern ( (_module.__default.nb__occ ($LS ($LS $LZ)) |z#5| |l''#0|))
 :pattern ( (_module.__default.nb__occ ($LS ($LS $LZ)) |z#5| |l#0@@6|))
))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |l#0@@6| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |l#0@@6| (Tclass._module.List TInt) $Heap)) (|$IsA#_module.List| |l#0@@6|)) (and (and ($Is DatatypeTypeType |l'#0@@2| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |l'#0@@2| (Tclass._module.List TInt) $Heap)) (|$IsA#_module.List| |l'#0@@2|))) (=> (and (and (and (and (and ($Is DatatypeTypeType |l''#0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |l''#0| (Tclass._module.List TInt) $Heap)) (|$IsA#_module.List| |l''#0|)) (= 3 $FunctionContextHeight)) (and (|_module.__default.equiv#canCall| |l#0@@6| |l'#0@@2|) (and (_module.__default.equiv |l#0@@6| |l'#0@@2|) (forall ((|z#3| Int) ) (! (= (_module.__default.nb__occ ($LS $LZ) |z#3| |l#0@@6|) (_module.__default.nb__occ ($LS $LZ) |z#3| |l'#0@@2|))
 :qid |CoqArtInsertionSortdfy.55:10|
 :skolemid |588|
 :pattern ( (_module.__default.nb__occ ($LS $LZ) |z#3| |l'#0@@2|))
 :pattern ( (_module.__default.nb__occ ($LS $LZ) |z#3| |l#0@@6|))
))))) (and (and (|_module.__default.equiv#canCall| |l'#0@@2| |l''#0|) (and (_module.__default.equiv |l'#0@@2| |l''#0|) (forall ((|z#4| Int) ) (! (= (_module.__default.nb__occ ($LS $LZ) |z#4| |l'#0@@2|) (_module.__default.nb__occ ($LS $LZ) |z#4| |l''#0|))
 :qid |CoqArtInsertionSortdfy.55:10|
 :skolemid |591|
 :pattern ( (_module.__default.nb__occ ($LS $LZ) |z#4| |l''#0|))
 :pattern ( (_module.__default.nb__occ ($LS $LZ) |z#4| |l'#0@@2|))
