...
(assert (forall ((a@@9 T@U) (b@@9 T@U) ) (!  (=> (and (_module.aexp.Plus_q a@@9) (_module.aexp.Plus_q b@@9)) (= (|_module.aexp#Equal| a@@9 b@@9)  (and (|_module.aexp#Equal| (_module.aexp._0 a@@9) (_module.aexp._0 b@@9)) (|_module.aexp#Equal| (_module.aexp._1 a@@9) (_module.aexp._1 b@@9)))))
 :qid |unknown.0:0|
 :skolemid |1465|
 :pattern ( (|_module.aexp#Equal| a@@9 b@@9) (_module.aexp.Plus_q a@@9))
 :pattern ( (|_module.aexp#Equal| a@@9 b@@9) (_module.aexp.Plus_q b@@9))
)))
(assert (forall ((a@@10 T@U) (b@@10 T@U) ) (!  (=> (and (_module.bexp.And_q a@@10) (_module.bexp.And_q b@@10)) (= (|_module.bexp#Equal| a@@10 b@@10)  (and (|_module.bexp#Equal| (_module.bexp._0 a@@10) (_module.bexp._0 b@@10)) (|_module.bexp#Equal| (_module.bexp._1 a@@10) (_module.bexp._1 b@@10)))))
 :qid |unknown.0:0|
 :skolemid |1513|
 :pattern ( (|_module.bexp#Equal| a@@10 b@@10) (_module.bexp.And_q a@@10))
 :pattern ( (|_module.bexp#Equal| a@@10 b@@10) (_module.bexp.And_q b@@10))
)))
(assert (forall ((a@@11 T@U) (b@@11 T@U) ) (!  (=> (and (_module.bexp.Less_q a@@11) (_module.bexp.Less_q b@@11)) (= (|_module.bexp#Equal| a@@11 b@@11)  (and (|_module.aexp#Equal| (_module.bexp.a0 a@@11) (_module.bexp.a0 b@@11)) (|_module.aexp#Equal| (_module.bexp.a1 a@@11) (_module.bexp.a1 b@@11)))))
 :qid |unknown.0:0|
 :skolemid |1514|
 :pattern ( (|_module.bexp#Equal| a@@11 b@@11) (_module.bexp.Less_q a@@11))
 :pattern ( (|_module.bexp#Equal| a@@11 b@@11) (_module.bexp.Less_q b@@11))
)))
(assert (forall ((a@@12 T@U) (b@@12 T@U) ) (!  (=> (and (_module.com.Assign_q a@@12) (_module.com.Assign_q b@@12)) (= (|_module.com#Equal| a@@12 b@@12)  (and (|Seq#Equal| (_module.com._h0 a@@12) (_module.com._h0 b@@12)) (|_module.aexp#Equal| (_module.com._h1 a@@12) (_module.com._h1 b@@12)))))
 :qid |unknown.0:0|
 :skolemid |1574|
 :pattern ( (|_module.com#Equal| a@@12 b@@12) (_module.com.Assign_q a@@12))
 :pattern ( (|_module.com#Equal| a@@12 b@@12) (_module.com.Assign_q b@@12))
)))
(assert (forall ((a@@13 T@U) (b@@13 T@U) ) (!  (=> (and (_module.com.Seq_q a@@13) (_module.com.Seq_q b@@13)) (= (|_module.com#Equal| a@@13 b@@13)  (and (|_module.com#Equal| (_module.com._h2 a@@13) (_module.com._h2 b@@13)) (|_module.com#Equal| (_module.com._h3 a@@13) (_module.com._h3 b@@13)))))
 :qid |unknown.0:0|
 :skolemid |1575|
 :pattern ( (|_module.com#Equal| a@@13 b@@13) (_module.com.Seq_q a@@13))
 :pattern ( (|_module.com#Equal| a@@13 b@@13) (_module.com.Seq_q b@@13))
)))
(assert (forall ((a@@14 T@U) (b@@14 T@U) ) (!  (=> (and (_module.com.While_q a@@14) (_module.com.While_q b@@14)) (= (|_module.com#Equal| a@@14 b@@14)  (and (|_module.bexp#Equal| (_module.com._h7 a@@14) (_module.com._h7 b@@14)) (|_module.com#Equal| (_module.com._h8 a@@14) (_module.com._h8 b@@14)))))
 :qid |unknown.0:0|
 :skolemid |1577|
 :pattern ( (|_module.com#Equal| a@@14 b@@14) (_module.com.While_q a@@14))
 :pattern ( (|_module.com#Equal| a@@14 b@@14) (_module.com.While_q b@@14))
)))
...
(assert (forall ((a@@15 T@U) (b@@15 T@U) ) (!  (=> (and (_module.com.SKIP_q a@@15) (_module.com.SKIP_q b@@15)) (|_module.com#Equal| a@@15 b@@15))
 :qid |unknown.0:0|
 :skolemid |1573|
 :pattern ( (|_module.com#Equal| a@@15 b@@15) (_module.com.SKIP_q a@@15))
 :pattern ( (|_module.com#Equal| a@@15 b@@15) (_module.com.SKIP_q b@@15))
)))
...
(declare-fun |c1#2_0@0| () T@U)
(declare-fun |_mcc#2#2_0@0| () T@U)
(declare-fun |_mcc#3#2_0@0| () T@U)
(declare-fun |let#2_0#0#0| () T@U)
(declare-fun |let#2_1#0#0| () T@U)
(declare-fun |b#1_0@0| () T@U)
(declare-fun |$rhs#1_0@0| () T@U)
(declare-fun |thn#1_0@0| () T@U)
(declare-fun |els#1_0@0| () T@U)
(declare-fun |_mcc#4#1_0@0| () T@U)
(declare-fun |_mcc#5#1_0@0| () T@U)
(declare-fun |_mcc#6#1_0@0| () T@U)
(declare-fun |let#1_0#0#0| () T@U)
(declare-fun |let#1_1#0#0| () T@U)
(declare-fun |let#1_2#0#0| () T@U)
(declare-fun |_mcc#7#0_0@0| () T@U)
(declare-fun |_mcc#8#0_0@0| () T@U)
...
(declare-fun |_mcc#0#3_0@0| () T@U)
(declare-fun |_mcc#1#3_0@0| () T@U)
(declare-fun |a#3_0@0| () T@U)
(declare-fun |let#3_0#0#0| () T@U)
(declare-fun |x#3_0@0| () T@U)
(declare-fun |let#3_1#0#0| () T@U)
(declare-fun |$rhs#3_0@0| () T@U)
(declare-fun |$rhs#3_1@0| () T@U)
(declare-fun |c'#0@@9| () T@U)
(declare-fun |s'#0@@9| () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun null () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.only__skip__has__no__next__state)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 3) (- 0 10)) (=> (|_module.__default.small__step#canCall| |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (or (_module.__default.small__step ($LS $LZ) |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (=> (_module.com.SKIP_q |c#0@@9|) (U_2_bool (Lit boolType (bool_2_U false))))))) (=> (=> (|_module.__default.small__step#canCall| |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (or (_module.__default.small__step ($LS $LZ) |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (=> (_module.com.SKIP_q |c#0@@9|) (U_2_bool (Lit boolType (bool_2_U false)))))) (and (=> (= (ControlFlow 0 3) (- 0 9)) (=> (|_module.__default.small__step#canCall| |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (or (_module.__default.small__step ($LS $LZ) |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (=> (not (_module.com.SKIP_q |c#0@@9|)) (=> (_module.com.Assign_q |c#0@@9|) (|_module.com#Equal| |c'#0@1| |#_module.com.SKIP|)))))) (=> (=> (|_module.__default.small__step#canCall| |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (or (_module.__default.small__step ($LS $LZ) |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (=> (not (_module.com.SKIP_q |c#0@@9|)) (=> (_module.com.Assign_q |c#0@@9|) (|_module.com#Equal| |c'#0@1| |#_module.com.SKIP|))))) (and (=> (= (ControlFlow 0 3) (- 0 8)) (=> (|_module.__default.small__step#canCall| |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (or (_module.__default.small__step ($LS $LZ) |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (=> (not (_module.com.SKIP_q |c#0@@9|)) (=> (_module.com.Assign_q |c#0@@9|) (let ((|a#2@@0| (_module.com._h1 |c#0@@9|)))
(let ((|x#2@@1| (_module.com._h0 |c#0@@9|)))
(|Map#Equal| |s'#0@0| (|Map#Build| |s#0@@15| ($Box SeqType |x#2@@1|) ($Box intType (int_2_U (_module.__default.aval ($LS ($LS $LZ)) |a#2@@0| |s#0@@15|)))))))))))) (=> (=> (|_module.__default.small__step#canCall| |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (or (_module.__default.small__step ($LS $LZ) |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (=> (not (_module.com.SKIP_q |c#0@@9|)) (=> (_module.com.Assign_q |c#0@@9|) (let ((|a#2@@1| (_module.com._h1 |c#0@@9|)))
(let ((|x#2@@2| (_module.com._h0 |c#0@@9|)))
(|Map#Equal| |s'#0@0| (|Map#Build| |s#0@@15| ($Box SeqType |x#2@@2|) ($Box intType (int_2_U (_module.__default.aval ($LS ($LS $LZ)) |a#2@@1| |s#0@@15|))))))))))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (=> (|_module.__default.small__step#canCall| |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (or (_module.__default.small__step ($LS $LZ) |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (=> (not (_module.com.SKIP_q |c#0@@9|)) (=> (not (_module.com.Assign_q |c#0@@9|)) (=> (_module.com.Seq_q |c#0@@9|) (let ((|c1#2@@0| (_module.com._h3 |c#0@@9|)))
(let ((|c0#2@@0| (_module.com._h2 |c#0@@9|)))
 (or (and (and (|_module.com#Equal| |c0#2@@0| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@1| |c1#2@@0|)) (|Map#Equal| |s'#0@0| |s#0@@15|)) (exists ((|c0'#2| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#2| Tclass._module.com) (and (|_module.com#Equal| |c'#0@1| (|#_module.com.Seq| |c0'#2| |c1#2@@0|)) (_module.__default.small__step ($LS ($LS $LZ)) |c0#2@@0| |s#0@@15| |c0'#2| |s'#0@0|)))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1367|
 :pattern ( (_module.__default.small__step ($LS ($LS $LZ)) |c0#2@@0| |s#0@@15| |c0'#2| |s'#0@0|))
 :pattern ( (|#_module.com.Seq| |c0'#2| |c1#2@@0|))
))))))))))) (=> (=> (|_module.__default.small__step#canCall| |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (or (_module.__default.small__step ($LS $LZ) |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (=> (not (_module.com.SKIP_q |c#0@@9|)) (=> (not (_module.com.Assign_q |c#0@@9|)) (=> (_module.com.Seq_q |c#0@@9|) (let ((|c1#2@@1| (_module.com._h3 |c#0@@9|)))
(let ((|c0#2@@1| (_module.com._h2 |c#0@@9|)))
 (or (and (and (|_module.com#Equal| |c0#2@@1| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@1| |c1#2@@1|)) (|Map#Equal| |s'#0@0| |s#0@@15|)) (exists ((|c0'#2@@0| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#2@@0| Tclass._module.com) (and (|_module.com#Equal| |c'#0@1| (|#_module.com.Seq| |c0'#2@@0| |c1#2@@1|)) (_module.__default.small__step ($LS ($LS $LZ)) |c0#2@@1| |s#0@@15| |c0'#2@@0| |s'#0@0|)))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1367|
 :pattern ( (_module.__default.small__step ($LS ($LS $LZ)) |c0#2@@1| |s#0@@15| |c0'#2@@0| |s'#0@0|))
 :pattern ( (|#_module.com.Seq| |c0'#2@@0| |c1#2@@1|))
)))))))))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (=> (|_module.__default.small__step#canCall| |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (or (_module.__default.small__step ($LS $LZ) |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (=> (not (_module.com.SKIP_q |c#0@@9|)) (=> (not (_module.com.Assign_q |c#0@@9|)) (=> (not (_module.com.Seq_q |c#0@@9|)) (=> (_module.com.If_q |c#0@@9|) (let ((|els#2@@0| (_module.com._h6 |c#0@@9|)))
(let ((|thn#2@@0| (_module.com._h5 |c#0@@9|)))
(let ((|b#4@@1| (_module.com._h4 |c#0@@9|)))
(|_module.com#Equal| |c'#0@1| (ite (_module.__default.bval ($LS ($LS $LZ)) |b#4@@1| |s#0@@15|) |thn#2@@0| |els#2@@0|)))))))))))) (=> (=> (|_module.__default.small__step#canCall| |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (or (_module.__default.small__step ($LS $LZ) |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (=> (not (_module.com.SKIP_q |c#0@@9|)) (=> (not (_module.com.Assign_q |c#0@@9|)) (=> (not (_module.com.Seq_q |c#0@@9|)) (=> (_module.com.If_q |c#0@@9|) (let ((|els#2@@1| (_module.com._h6 |c#0@@9|)))
(let ((|thn#2@@1| (_module.com._h5 |c#0@@9|)))
(let ((|b#4@@2| (_module.com._h4 |c#0@@9|)))
(|_module.com#Equal| |c'#0@1| (ite (_module.__default.bval ($LS ($LS $LZ)) |b#4@@2| |s#0@@15|) |thn#2@@1| |els#2@@1|))))))))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (=> (|_module.__default.small__step#canCall| |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (or (_module.__default.small__step ($LS $LZ) |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (=> (not (_module.com.SKIP_q |c#0@@9|)) (=> (not (_module.com.Assign_q |c#0@@9|)) (=> (not (_module.com.Seq_q |c#0@@9|)) (=> (_module.com.If_q |c#0@@9|) (|Map#Equal| |s'#0@0| |s#0@@15|)))))))) (=> (=> (|_module.__default.small__step#canCall| |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (or (_module.__default.small__step ($LS $LZ) |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (=> (not (_module.com.SKIP_q |c#0@@9|)) (=> (not (_module.com.Assign_q |c#0@@9|)) (=> (not (_module.com.Seq_q |c#0@@9|)) (=> (_module.com.If_q |c#0@@9|) (|Map#Equal| |s'#0@0| |s#0@@15|))))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> (|_module.__default.small__step#canCall| |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (or (_module.__default.small__step ($LS $LZ) |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (=> (not (_module.com.SKIP_q |c#0@@9|)) (=> (not (_module.com.Assign_q |c#0@@9|)) (=> (not (_module.com.Seq_q |c#0@@9|)) (=> (not (_module.com.If_q |c#0@@9|)) (let ((|body#2@@0| (_module.com._h8 |c#0@@9|)))
(let ((|b#5@@0| (_module.com._h7 |c#0@@9|)))
(|_module.com#Equal| |c'#0@1| (|#_module.com.If| |b#5@@0| (|#_module.com.Seq| |body#2@@0| (|#_module.com.While| |b#5@@0| |body#2@@0|)) (Lit DatatypeTypeType |#_module.com.SKIP|)))))))))))) (=> (=> (|_module.__default.small__step#canCall| |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (or (_module.__default.small__step ($LS $LZ) |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (=> (not (_module.com.SKIP_q |c#0@@9|)) (=> (not (_module.com.Assign_q |c#0@@9|)) (=> (not (_module.com.Seq_q |c#0@@9|)) (=> (not (_module.com.If_q |c#0@@9|)) (let ((|body#2@@1| (_module.com._h8 |c#0@@9|)))
(let ((|b#5@@1| (_module.com._h7 |c#0@@9|)))
(|_module.com#Equal| |c'#0@1| (|#_module.com.If| |b#5@@1| (|#_module.com.Seq| |body#2@@1| (|#_module.com.While| |b#5@@1| |body#2@@1|)) (Lit DatatypeTypeType |#_module.com.SKIP|))))))))))) (=> (= (ControlFlow 0 3) (- 0 2)) (=> (|_module.__default.small__step#canCall| |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (or (_module.__default.small__step ($LS $LZ) |c#0@@9| |s#0@@15| |c'#0@1| |s'#0@0|) (=> (not (_module.com.SKIP_q |c#0@@9|)) (=> (not (_module.com.Assign_q |c#0@@9|)) (=> (not (_module.com.Seq_q |c#0@@9|)) (=> (not (_module.com.If_q |c#0@@9|)) (|Map#Equal| |s'#0@0| |s#0@@15|))))))))))))))))))))))))
(let ((anon15_Else_correct  (=> (not (|_module.com#Equal| |c0#2_0@0| |#_module.com.SKIP|)) (and (=> (= (ControlFlow 0 21) (- 0 23)) (or (< (DtRank |c0#2_0@0|) (DtRank |c#0@@9|)) (and (= (DtRank |c0#2_0@0|) (DtRank |c#0@@9|)) (and (|Set#Subset| (|Map#Domain| |s#0@@15|) (|Map#Domain| |s#0@@15|)) (not (|Set#Subset| (|Map#Domain| |s#0@@15|) (|Map#Domain| |s#0@@15|))))))) (=> (or (< (DtRank |c0#2_0@0|) (DtRank |c#0@@9|)) (and (= (DtRank |c0#2_0@0|) (DtRank |c#0@@9|)) (and (|Set#Subset| (|Map#Domain| |s#0@@15|) (|Map#Domain| |s#0@@15|)) (not (|Set#Subset| (|Map#Domain| |s#0@@15|) (|Map#Domain| |s#0@@15|)))))) (=> (and (and ($Is DatatypeTypeType |call3formal@c'#0| Tclass._module.com) ($IsAlloc DatatypeTypeType |call3formal@c'#0| Tclass._module.com $Heap)) (and ($Is MapType |call4formal@s'#0| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |call4formal@s'#0| (TMap (TSeq TChar) TInt) $Heap))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (not (|_module.com#Equal| |c0#2_0@0| |#_module.com.SKIP|))) (=> (not (|_module.com#Equal| |c0#2_0@0| |#_module.com.SKIP|)) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and ($Is DatatypeTypeType |call3formal@c'#0@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |call3formal@c'#0@0| Tclass._module.com $Heap@0))) (and (and ($Is MapType |call4formal@s'#0@0| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |call4formal@s'#0@0| (TMap (TSeq TChar) TInt) $Heap@0)) (|_module.__default.small__step#canCall| |c0#2_0@0| |s#0@@15| |call3formal@c'#0@0| |call4formal@s'#0@0|))) (and (and (and (|_module.__default.small__step#canCall| |c0#2_0@0| |s#0@@15| |call3formal@c'#0@0| |call4formal@s'#0@0|) (and (_module.__default.small__step ($LS $LZ) |c0#2_0@0| |s#0@@15| |call3formal@c'#0@0| |call4formal@s'#0@0|) (ite (_module.com.SKIP_q |c0#2_0@0|) false (ite (_module.com.Assign_q |c0#2_0@0|) (let ((|a#1@@0| (_module.com._h1 |c0#2_0@0|)))
(let ((|x#1| (_module.com._h0 |c0#2_0@0|)))
 (and (|_module.com#Equal| |call3formal@c'#0@0| |#_module.com.SKIP|) (|Map#Equal| |call4formal@s'#0@0| (|Map#Build| |s#0@@15| ($Box SeqType |x#1|) ($Box intType (int_2_U (_module.__default.aval ($LS $LZ) |a#1@@0| |s#0@@15|)))))))) (ite (_module.com.Seq_q |c0#2_0@0|) (let ((|c1#1@@0| (_module.com._h3 |c0#2_0@0|)))
(let ((|c0#1@@0| (_module.com._h2 |c0#2_0@0|)))
 (or (and (and (|_module.com#Equal| |c0#1@@0| |#_module.com.SKIP|) (|_module.com#Equal| |call3formal@c'#0@0| |c1#1@@0|)) (|Map#Equal| |call4formal@s'#0@0| |s#0@@15|)) (exists ((|c0'#1@@0| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#1@@0| Tclass._module.com) (and (|_module.com#Equal| |call3formal@c'#0@0| (|#_module.com.Seq| |c0'#1@@0| |c1#1@@0|)) (_module.__default.small__step ($LS $LZ) |c0#1@@0| |s#0@@15| |c0'#1@@0| |call4formal@s'#0@0|)))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1366|
 :pattern ( (_module.__default.small__step ($LS $LZ) |c0#1@@0| |s#0@@15| |c0'#1@@0| |call4formal@s'#0@0|))
 :pattern ( (|#_module.com.Seq| |c0'#1@@0| |c1#1@@0|))
))))) (ite (_module.com.If_q |c0#2_0@0|) (let ((|els#1@@0| (_module.com._h6 |c0#2_0@0|)))
(let ((|thn#1@@0| (_module.com._h5 |c0#2_0@0|)))
(let ((|b#2@@1| (_module.com._h4 |c0#2_0@0|)))
 (and (|_module.com#Equal| |call3formal@c'#0@0| (ite (_module.__default.bval ($LS $LZ) |b#2@@1| |s#0@@15|) |thn#1@@0| |els#1@@0|)) (|Map#Equal| |call4formal@s'#0@0| |s#0@@15|))))) (let ((|body#1| (_module.com._h8 |c0#2_0@0|)))
(let ((|b#3@@0| (_module.com._h7 |c0#2_0@0|)))
 (and (|_module.com#Equal| |call3formal@c'#0@0| (|#_module.com.If| |b#3@@0| (|#_module.com.Seq| |body#1| (|#_module.com.While| |b#3@@0| |body#1|)) (Lit DatatypeTypeType |#_module.com.SKIP|))) (|Map#Equal| |call4formal@s'#0@0| |s#0@@15|)))))))))) (= $Heap $Heap@0)) (and (and (= |c'#0@0| (|#_module.com.Seq| |call3formal@c'#0@0| |c1#2_0@0|)) (= |c'#0@1| |c'#0@0|)) (and (= |s'#0@0| |call4formal@s'#0@0|) (= (ControlFlow 0 21) 3))))) GeneratedUnifiedExit_correct)))))))))
(let ((anon15_Then_correct  (=> (and (and (|_module.com#Equal| |c0#2_0@0| |#_module.com.SKIP|) (= |c'#0@1| |c1#2_0@0|)) (and (= |s'#0@0| |s#0@@15|) (= (ControlFlow 0 20) 3))) GeneratedUnifiedExit_correct)))
(let ((anon14_Then_correct  (=> (= |c#0@@9| (|#_module.com.Seq| |_mcc#2#2_0@0| |_mcc#3#2_0@0|)) (=> (and ($Is DatatypeTypeType |_mcc#2#2_0@0| Tclass._module.com) ($Is DatatypeTypeType |_mcc#3#2_0@0| Tclass._module.com)) (=> (and (and ($Is DatatypeTypeType |c1#2_0@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |c1#2_0@0| Tclass._module.com $Heap)) (= |let#2_0#0#0| |_mcc#3#2_0@0|)) (=> (and (and (and ($Is DatatypeTypeType |let#2_0#0#0| Tclass._module.com) (= |c1#2_0@0| |let#2_0#0#0|)) (and ($Is DatatypeTypeType |c0#2_0@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |c0#2_0@0| Tclass._module.com $Heap))) (and (and (= |let#2_1#0#0| |_mcc#2#2_0@0|) ($Is DatatypeTypeType |let#2_1#0#0| Tclass._module.com)) (and (= |c0#2_0@0| |let#2_1#0#0|) (|$IsA#_module.com| |c0#2_0@0|)))) (and (=> (= (ControlFlow 0 24) 20) anon15_Then_correct) (=> (= (ControlFlow 0 24) 21) anon15_Else_correct))))))))
(let ((anon9_correct  (=> (|_module.__default.bval#canCall| |b#1_0@0| |s#0@@15|) (=> (and (and (= |$rhs#1_0@0| (ite (_module.__default.bval ($LS $LZ) |b#1_0@0| |s#0@@15|) |thn#1_0@0| |els#1_0@0|)) (= |c'#0@1| |$rhs#1_0@0|)) (and (= |s'#0@0| |s#0@@15|) (= (ControlFlow 0 15) 3))) GeneratedUnifiedExit_correct))))
(let ((anon17_Else_correct  (=> (and (not (_module.__default.bval ($LS $LZ) |b#1_0@0| |s#0@@15|)) (= (ControlFlow 0 17) 15)) anon9_correct)))
(let ((anon17_Then_correct  (=> (and (_module.__default.bval ($LS $LZ) |b#1_0@0| |s#0@@15|) (= (ControlFlow 0 16) 15)) anon9_correct)))
(let ((anon16_Then_correct  (=> (and (and (= |c#0@@9| (|#_module.com.If| |_mcc#4#1_0@0| |_mcc#5#1_0@0| |_mcc#6#1_0@0|)) ($Is DatatypeTypeType |_mcc#4#1_0@0| Tclass._module.bexp)) (and ($Is DatatypeTypeType |_mcc#5#1_0@0| Tclass._module.com) ($Is DatatypeTypeType |_mcc#6#1_0@0| Tclass._module.com))) (=> (and (and (and ($Is DatatypeTypeType |els#1_0@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |els#1_0@0| Tclass._module.com $Heap)) (= |let#1_0#0#0| |_mcc#6#1_0@0|)) (and ($Is DatatypeTypeType |let#1_0#0#0| Tclass._module.com) (= |els#1_0@0| |let#1_0#0#0|))) (=> (and (and (and (and ($Is DatatypeTypeType |thn#1_0@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |thn#1_0@0| Tclass._module.com $Heap)) (= |let#1_1#0#0| |_mcc#5#1_0@0|)) (and ($Is DatatypeTypeType |let#1_1#0#0| Tclass._module.com) (= |thn#1_0@0| |let#1_1#0#0|))) (and (and (and ($Is DatatypeTypeType |b#1_0@0| Tclass._module.bexp) ($IsAlloc DatatypeTypeType |b#1_0@0| Tclass._module.bexp $Heap)) (and (= |let#1_2#0#0| |_mcc#4#1_0@0|) ($Is DatatypeTypeType |let#1_2#0#0| Tclass._module.bexp))) (and (and (= |b#1_0@0| |let#1_2#0#0|) ($IsAlloc DatatypeTypeType |b#1_0@0| Tclass._module.bexp $Heap)) (and ($IsAlloc MapType |s#0@@15| (TMap (TSeq TChar) TInt) $Heap) (|_module.__default.bval#canCall| |b#1_0@0| |s#0@@15|))))) (and (=> (= (ControlFlow 0 18) 16) anon17_Then_correct) (=> (= (ControlFlow 0 18) 17) anon17_Else_correct)))))))
(let ((anon18_Then_correct  (=> (= |c#0@@9| (|#_module.com.While| |_mcc#7#0_0@0| |_mcc#8#0_0@0|)) (=> (and ($Is DatatypeTypeType |_mcc#7#0_0@0| Tclass._module.bexp) ($Is DatatypeTypeType |_mcc#8#0_0@0| Tclass._module.com)) (=> (and (and (and ($Is DatatypeTypeType |body#0_0@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |body#0_0@0| Tclass._module.com $Heap)) (= |let#0_0#0#0| |_mcc#8#0_0@0|)) (and ($Is DatatypeTypeType |let#0_0#0#0| Tclass._module.com) (= |body#0_0@0| |let#0_0#0#0|))) (=> (and (and (and (and ($Is DatatypeTypeType |b#0_0@0| Tclass._module.bexp) ($IsAlloc DatatypeTypeType |b#0_0@0| Tclass._module.bexp $Heap)) (= |let#0_1#0#0| |_mcc#7#0_0@0|)) (and ($Is DatatypeTypeType |let#0_1#0#0| Tclass._module.bexp) (= |b#0_0@0| |let#0_1#0#0|))) (and (and (= |$rhs#0_0@0| (|#_module.com.If| |b#0_0@0| (|#_module.com.Seq| |body#0_0@0| (|#_module.com.While| |b#0_0@0| |body#0_0@0|)) (Lit DatatypeTypeType |#_module.com.SKIP|))) (= |c'#0@1| |$rhs#0_0@0|)) (and (= |s'#0@0| |s#0@@15|) (= (ControlFlow 0 13) 3)))) GeneratedUnifiedExit_correct))))))
(let ((anon13_Then_correct  (=> (= |c#0@@9| (|#_module.com.Assign| |_mcc#0#3_0@0| |_mcc#1#3_0@0|)) (=> (and ($Is SeqType |_mcc#0#3_0@0| (TSeq TChar)) ($Is DatatypeTypeType |_mcc#1#3_0@0| Tclass._module.aexp)) (=> (and (and ($Is DatatypeTypeType |a#3_0@0| Tclass._module.aexp) ($IsAlloc DatatypeTypeType |a#3_0@0| Tclass._module.aexp $Heap)) (= |let#3_0#0#0| |_mcc#1#3_0@0|)) (=> (and (and (and (and ($Is DatatypeTypeType |let#3_0#0#0| Tclass._module.aexp) (= |a#3_0@0| |let#3_0#0#0|)) (and ($Is SeqType |x#3_0@0| (TSeq TChar)) ($IsAlloc SeqType |x#3_0@0| (TSeq TChar) $Heap))) (and (and (= |let#3_1#0#0| |_mcc#0#3_0@0|) ($Is SeqType |let#3_1#0#0| (TSeq TChar))) (and (= |x#3_0@0| |let#3_1#0#0|) (= |$rhs#3_0@0| (Lit DatatypeTypeType |#_module.com.SKIP|))))) (and (and (and ($IsAlloc DatatypeTypeType |a#3_0@0| Tclass._module.aexp $Heap) ($IsAlloc MapType |s#0@@15| (TMap (TSeq TChar) TInt) $Heap)) (and (|_module.__default.aval#canCall| |a#3_0@0| |s#0@@15|) (|_module.__default.aval#canCall| |a#3_0@0| |s#0@@15|))) (and (and (= |$rhs#3_1@0| (|Map#Build| |s#0@@15| ($Box SeqType |x#3_0@0|) ($Box intType (int_2_U (_module.__default.aval ($LS $LZ) |a#3_0@0| |s#0@@15|))))) (= |c'#0@1| |$rhs#3_0@0|)) (and (= |s'#0@0| |$rhs#3_1@0|) (= (ControlFlow 0 12) 3))))) GeneratedUnifiedExit_correct))))))
(let ((anon12_Then_correct  (=> (and (and (= |c#0@@9| |#_module.com.SKIP|) (= |c'#0@1| |c'#0@@9|)) (and (= |s'#0@0| |s'#0@@9|) (= (ControlFlow 0 11) 3))) GeneratedUnifiedExit_correct)))
(let ((anon18_Else_correct true))
(let ((anon16_Else_correct  (=> (or (not (= |c#0@@9| (|#_module.com.If| |_mcc#4#1_0@0| |_mcc#5#1_0@0| |_mcc#6#1_0@0|))) (not true)) (and (=> (= (ControlFlow 0 14) 13) anon18_Then_correct) (=> (= (ControlFlow 0 14) 1) anon18_Else_correct)))))
(let ((anon14_Else_correct  (=> (or (not (= |c#0@@9| (|#_module.com.Seq| |_mcc#2#2_0@0| |_mcc#3#2_0@0|))) (not true)) (and (=> (= (ControlFlow 0 19) 18) anon16_Then_correct) (=> (= (ControlFlow 0 19) 14) anon16_Else_correct)))))
(let ((anon13_Else_correct  (=> (or (not (= |c#0@@9| (|#_module.com.Assign| |_mcc#0#3_0@0| |_mcc#1#3_0@0|))) (not true)) (and (=> (= (ControlFlow 0 25) 24) anon14_Then_correct) (=> (= (ControlFlow 0 25) 19) anon14_Else_correct)))))
(let ((anon12_Else_correct  (=> (or (not (= |c#0@@9| |#_module.com.SKIP|)) (not true)) (and (=> (= (ControlFlow 0 26) 12) anon13_Then_correct) (=> (= (ControlFlow 0 26) 25) anon13_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 27) 11) anon12_Then_correct) (=> (= (ControlFlow 0 27) 26) anon12_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |c#0@@9| Tclass._module.com) ($IsAlloc DatatypeTypeType |c#0@@9| Tclass._module.com $Heap)) (|$IsA#_module.com| |c#0@@9|)) (and (and ($Is MapType |s#0@@15| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |s#0@@15| (TMap (TSeq TChar) TInt) $Heap)) (and ($Is DatatypeTypeType |c'#0@@9| Tclass._module.com) ($IsAlloc DatatypeTypeType |c'#0@@9| Tclass._module.com $Heap)))) (and (and (and ($Is MapType |s'#0@@9| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |s'#0@@9| (TMap (TSeq TChar) TInt) $Heap)) (= 5 $FunctionContextHeight)) (and (not (|_module.com#Equal| |c#0@@9| |#_module.com.SKIP|)) (= (ControlFlow 0 28) 27)))) anon0_correct))))
