...
(set-info :boogie-vc-id CheckWellFormed$$_module.Bot.Fly)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#6| null $Heap@@8 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@14) _module.Bot.Repr)))) ($IsAllocBox ($Box refType this@@14) Tclass._module.Bot? $Heap@@8)) (and (|_module.Bot.Valid#canCall| $Heap@@8 this@@14) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@@8 this@@14))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@44 T@U) ) (!  (=> (and (or (not (= $o@@44 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@44) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@44) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@44)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@14) _module.Bot.Repr)) ($Box refType $o@@44))))
 :qid |FlyingRobotsdfy.141:10|
 :skolemid |848|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@44))
))) (and (and ($HeapSucc $Heap@@8 $Heap@0) ($IsAllocBox ($Box refType this@@14) Tclass._module.Bot? $Heap@0)) (and (|_module.Bot.Valid#canCall| $Heap@0 this@@14) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 this@@14)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@14 Tclass._module.Bot $Heap@@8)) (=> ($IsAlloc refType this@@14 Tclass._module.Bot $Heap@@8) (=> (and (and (forall (($o@@45 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@14) _module.Bot.Repr)) ($Box refType $o@@45)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@14) _module.Bot.Repr)) ($Box refType $o@@45)))) (or (not (= $o@@45 null)) (not true)))
 :qid |FlyingRobotsdfy.144:24|
 :skolemid |849|
 :pattern (  (or (not (= $o@@45 null)) (not true)))
)) (forall (($o@@46 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@14) _module.Bot.Repr)) ($Box refType $o@@46)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@14) _module.Bot.Repr)) ($Box refType $o@@46)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@46) alloc)))))
 :qid |FlyingRobotsdfy.144:24|
 :skolemid |850|
...
))) ($IsAllocBox ($Box refType this@@14) Tclass._module.Bot? $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (U_2_bool (Lit boolType (bool_2_U true))) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 this@@14))) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 this@@14) (=> (and (|_module.Bot.robot__inv#canCall| $Heap@0 this@@14) (_module.Bot.robot__inv $Heap@0 this@@14)) (=> (and (and ($IsAllocBox ($Box refType this@@14) Tclass._module.Bot? $Heap@0) (= (ControlFlow 0 2) (- 0 1))) (U_2_bool (Lit boolType (bool_2_U true)))) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 this@@14))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@8) ($IsHeapAnchor $Heap@@8)) (=> (and (and (or (not (= this@@14 null)) (not true)) (and ($Is refType this@@14 Tclass._module.Bot) ($IsAlloc refType this@@14 Tclass._module.Bot $Heap@@8))) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct))))
