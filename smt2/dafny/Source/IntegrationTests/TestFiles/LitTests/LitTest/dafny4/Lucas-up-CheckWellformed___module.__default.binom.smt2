...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.binom)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon11_Else_correct  (=> (or (not (= |a#0@@3| (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 7) (- 0 16)) ($Is intType (int_2_U (- |a#0@@3| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |a#0@@3| 1)) Tclass._System.nat) (=> (= |##a#0@0| (- |a#0@@3| 1)) (=> (and ($IsAlloc intType (int_2_U |##a#0@0|) Tclass._System.nat $Heap) ($IsAlloc intType (int_2_U |b#0@@3|) Tclass._System.nat $Heap)) (and (=> (= (ControlFlow 0 7) (- 0 15)) (or (<= 0 |a#0@@3|) (= |##a#0@0| |a#0@@3|))) (=> (or (<= 0 |a#0@@3|) (= |##a#0@0| |a#0@@3|)) (and (=> (= (ControlFlow 0 7) (- 0 14)) (or (or (<= 0 |b#0@@3|) (< |##a#0@0| |a#0@@3|)) (= |b#0@@3| |b#0@@3|))) (=> (or (or (<= 0 |b#0@@3|) (< |##a#0@0| |a#0@@3|)) (= |b#0@@3| |b#0@@3|)) (and (=> (= (ControlFlow 0 7) (- 0 13)) (or (< |##a#0@0| |a#0@@3|) (and (= |##a#0@0| |a#0@@3|) (< |b#0@@3| |b#0@@3|)))) (=> (or (< |##a#0@0| |a#0@@3|) (and (= |##a#0@0| |a#0@@3|) (< |b#0@@3| |b#0@@3|))) (=> (|_module.__default.binom#canCall| (- |a#0@@3| 1) |b#0@@3|) (and (=> (= (ControlFlow 0 7) (- 0 12)) ($Is intType (int_2_U (- |a#0@@3| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |a#0@@3| 1)) Tclass._System.nat) (=> (and (= |##a#1@0| (- |a#0@@3| 1)) ($IsAlloc intType (int_2_U |##a#1@0|) Tclass._System.nat $Heap)) (and (=> (= (ControlFlow 0 7) (- 0 11)) ($Is intType (int_2_U (- |b#0@@3| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |b#0@@3| 1)) Tclass._System.nat) (=> (and (= |##b#1@0| (- |b#0@@3| 1)) ($IsAlloc intType (int_2_U |##b#1@0|) Tclass._System.nat $Heap)) (and (=> (= (ControlFlow 0 7) (- 0 10)) (or (<= 0 |a#0@@3|) (= |##a#1@0| |a#0@@3|))) (=> (or (<= 0 |a#0@@3|) (= |##a#1@0| |a#0@@3|)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (or (or (<= 0 |b#0@@3|) (< |##a#1@0| |a#0@@3|)) (= |##b#1@0| |b#0@@3|))) (=> (or (or (<= 0 |b#0@@3|) (< |##a#1@0| |a#0@@3|)) (= |##b#1@0| |b#0@@3|)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (< |##a#1@0| |a#0@@3|) (and (= |##a#1@0| |a#0@@3|) (< |##b#1@0| |b#0@@3|)))) (=> (or (< |##a#1@0| |a#0@@3|) (and (= |##a#1@0| |a#0@@3|) (< |##b#1@0| |b#0@@3|))) (=> (and (|_module.__default.binom#canCall| (- |a#0@@3| 1) (- |b#0@@3| 1)) (= (ControlFlow 0 7) (- 0 6))) ($Is intType (int_2_U (+ (_module.__default.binom ($LS $LZ) reveal__module._default.binom (- |a#0@@3| 1) |b#0@@3|) (_module.__default.binom ($LS $LZ) reveal__module._default.binom (- |a#0@@3| 1) (- |b#0@@3| 1)))) Tclass._System.nat))))))))))))))))))))))))))))
(let ((anon11_Then_correct  (=> (and (= |a#0@@3| (LitInt 0)) (= (ControlFlow 0 5) (- 0 4))) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat))))
(let ((anon10_Else_correct  (=> (or (not (= |b#0@@3| (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 17) 5) anon11_Then_correct) (=> (= (ControlFlow 0 17) 7) anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (and (= |b#0@@3| (LitInt 0)) (= (ControlFlow 0 3) (- 0 2))) ($Is intType (int_2_U (LitInt 1)) Tclass._System.nat))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 18) 1) anon9_Then_correct) (=> (= (ControlFlow 0 18) 3) anon10_Then_correct)) (=> (= (ControlFlow 0 18) 17) anon10_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (<= (LitInt 0) |a#0@@3|) (<= (LitInt 0) |b#0@@3|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 19) 18))) anon0_correct))))
