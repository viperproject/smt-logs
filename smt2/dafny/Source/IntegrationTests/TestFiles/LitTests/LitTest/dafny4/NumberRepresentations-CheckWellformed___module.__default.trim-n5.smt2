...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@0 T@U) (|digits#0@@0| T@U) ) (!  (=> (or (|_module.__default.trim#canCall| |digits#0@@0|) (and (< 0 $FunctionContextHeight) ($Is SeqType |digits#0@@0| (TSeq TInt)))) (and (=> (and (or (not (= (|Seq#Length| |digits#0@@0|) 0)) (not true)) (= (U_2_int ($Unbox intType (|Seq#Index| |digits#0@@0| (- (|Seq#Length| |digits#0@@0|) 1)))) (LitInt 0))) (|_module.__default.trim#canCall| (|Seq#Take| |digits#0@@0| (- (|Seq#Length| |digits#0@@0|) 1)))) (= (_module.__default.trim ($LS $ly@@0) |digits#0@@0|) (ite  (and (or (not (= (|Seq#Length| |digits#0@@0|) 0)) (not true)) (= (U_2_int ($Unbox intType (|Seq#Index| |digits#0@@0| (- (|Seq#Length| |digits#0@@0|) 1)))) (LitInt 0))) (_module.__default.trim $ly@@0 (|Seq#Take| |digits#0@@0| (- (|Seq#Length| |digits#0@@0|) 1))) |digits#0@@0|))))
 :qid |NumberRepresentationsdfy.180:16|
 :skolemid |649|
 :pattern ( (_module.__default.trim ($LS $ly@@0) |digits#0@@0|))
))))
...
(assert (forall (($ly@@1 T@U) (|digits#0@@1| T@U) ) (! (= (_module.__default.trim ($LS $ly@@1) |digits#0@@1|) (_module.__default.trim $ly@@1 |digits#0@@1|))
 :qid |NumberRepresentationsdfy.180:16|
 :skolemid |645|
 :pattern ( (_module.__default.trim ($LS $ly@@1) |digits#0@@1|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@2 T@U) (|digits#0@@2| T@U) ) (!  (=> (or (|_module.__default.trim#canCall| |digits#0@@2|) (and (< 0 $FunctionContextHeight) ($Is SeqType |digits#0@@2| (TSeq TInt)))) ($Is SeqType (_module.__default.trim $ly@@2 |digits#0@@2|) (TSeq TInt)))
 :qid |NumberRepresentationsdfy.180:16|
 :skolemid |647|
 :pattern ( (_module.__default.trim $ly@@2 |digits#0@@2|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.trim)
...
(let ((anon11_Then_correct  (=> (and (or (not (= (|Seq#Length| |digits#0@@3|) 0)) (not true)) (= (U_2_int ($Unbox intType (|Seq#Index| |digits#0@@3| (- (|Seq#Length| |digits#0@@3|) 1)))) (LitInt 0))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 (- (|Seq#Length| |digits#0@@3|) 1)) (<= (- (|Seq#Length| |digits#0@@3|) 1) (|Seq#Length| |digits#0@@3|)))) (=> (and (<= 0 (- (|Seq#Length| |digits#0@@3|) 1)) (<= (- (|Seq#Length| |digits#0@@3|) 1) (|Seq#Length| |digits#0@@3|))) (=> (= |##digits#0@0| (|Seq#Take| |digits#0@@3| (- (|Seq#Length| |digits#0@@3|) 1))) (=> (and ($IsAlloc SeqType |##digits#0@0| (TSeq TInt) $Heap) (= (ControlFlow 0 3) (- 0 2))) (< (|Seq#Rank| |##digits#0@0|) (|Seq#Rank| |digits#0@@3|)))))))))
(let ((anon10_Else_correct  (=> (= (|Seq#Length| |digits#0@@3|) 0) (and (=> (= (ControlFlow 0 8) 3) anon11_Then_correct) (=> (= (ControlFlow 0 8) 5) anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (or (not (= (|Seq#Length| |digits#0@@3|) 0)) (not true)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (and (<= 0 (- (|Seq#Length| |digits#0@@3|) 1)) (< (- (|Seq#Length| |digits#0@@3|) 1) (|Seq#Length| |digits#0@@3|)))) (=> (and (<= 0 (- (|Seq#Length| |digits#0@@3|) 1)) (< (- (|Seq#Length| |digits#0@@3|) 1) (|Seq#Length| |digits#0@@3|))) (and (=> (= (ControlFlow 0 6) 3) anon11_Then_correct) (=> (= (ControlFlow 0 6) 5) anon11_Else_correct)))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 9) 1) anon9_Then_correct) (=> (= (ControlFlow 0 9) 6) anon10_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon10_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is SeqType |digits#0@@3| (TSeq TInt))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct)))
