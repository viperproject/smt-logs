...
(let ((anon9_correct  (and (=> (= (ControlFlow 0 5) (- 0 10)) (or (exists ((|$as#s'0_1_0#0| T@U) )  (and ($Is MapType |$as#s'0_1_0#0| (TMap (TSeq TChar) TInt)) (and ($Is DatatypeTypeType (Lit DatatypeTypeType |#_module.com.SKIP|) Tclass._module.com) (and (_module.__default.small__step ($LS $LZ) |c0#1@@0| |s0#1| (Lit DatatypeTypeType |#_module.com.SKIP|) |$as#s'0_1_0#0|) (_module.__default.small__step__star_h ($LS $LZ) (|ORD#Minus| |_k#0@@15| (|ORD#FromNat| 1)) (Lit DatatypeTypeType |#_module.com.SKIP|) |$as#s'0_1_0#0| |c#1| |t#1|))))) (exists ((|$as#c'0_1_0#0| T@U) (|$as#s'0_1_0#0@@0| T@U) )  (and (and ($Is DatatypeTypeType |$as#c'0_1_0#0| Tclass._module.com) ($Is MapType |$as#s'0_1_0#0@@0| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS $LZ) |c0#1@@0| |s0#1| |$as#c'0_1_0#0| |$as#s'0_1_0#0@@0|) (_module.__default.small__step__star_h ($LS $LZ) (|ORD#Minus| |_k#0@@15| (|ORD#FromNat| 1)) |$as#c'0_1_0#0| |$as#s'0_1_0#0@@0| |c#1| |t#1|)))))) (=> (or (exists ((|$as#s'0_1_0#0@@1| T@U) )  (and ($Is MapType |$as#s'0_1_0#0@@1| (TMap (TSeq TChar) TInt)) (and ($Is DatatypeTypeType (Lit DatatypeTypeType |#_module.com.SKIP|) Tclass._module.com) (and (_module.__default.small__step ($LS $LZ) |c0#1@@0| |s0#1| (Lit DatatypeTypeType |#_module.com.SKIP|) |$as#s'0_1_0#0@@1|) (_module.__default.small__step__star_h ($LS $LZ) (|ORD#Minus| |_k#0@@15| (|ORD#FromNat| 1)) (Lit DatatypeTypeType |#_module.com.SKIP|) |$as#s'0_1_0#0@@1| |c#1| |t#1|))))) (exists ((|$as#c'0_1_0#0@@0| T@U) (|$as#s'0_1_0#0@@2| T@U) )  (and (and ($Is DatatypeTypeType |$as#c'0_1_0#0@@0| Tclass._module.com) ($Is MapType |$as#s'0_1_0#0@@2| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS $LZ) |c0#1@@0| |s0#1| |$as#c'0_1_0#0@@0| |$as#s'0_1_0#0@@2|) (_module.__default.small__step__star_h ($LS $LZ) (|ORD#Minus| |_k#0@@15| (|ORD#FromNat| 1)) |$as#c'0_1_0#0@@0| |$as#s'0_1_0#0@@2| |c#1| |t#1|))))) (=> (and ($Is DatatypeTypeType |c'#0@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |c'#0@0| Tclass._module.com $Heap@0)) (=> (and (and ($Is MapType |s'#0@0| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |s'#0@0| (TMap (TSeq TChar) TInt) $Heap@0)) (and (_module.__default.small__step ($LS $LZ) |c0#1@@0| |s0#1| |c'#0@0| |s'#0@0|) (_module.__default.small__step__star_h ($LS $LZ) (|ORD#Minus| |_k#0@@15| (|ORD#FromNat| 1)) |c'#0@0| |s'#0@0| |c#1| |t#1|))) (and (=> (= (ControlFlow 0 5) (- 0 9)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@15|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@15|)) (=> (= |_k##0@0| (|ORD#Minus| |_k#0@@15| (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (=> (|_module.__default.small__step__star_h#canCall| |_k##0@0| |c'#0@0| |s'#0@0| |c#1| |t#1|) (or (_module.__default.small__step__star_h ($LS $LZ) |_k##0@0| |c'#0@0| |s'#0@0| |c#1| |t#1|) (=> (< 0 (|ORD#Offset| |_k##0@0|)) (or (and (|_module.com#Equal| |c'#0@0| |c#1|) (|Map#Equal| |s'#0@0| |t#1|)) (exists ((|c''#2| T@U) (|s''#2| T@U) ) (!  (and (and ($Is DatatypeTypeType |c''#2| Tclass._module.com) ($Is MapType |s''#2| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS ($LS $LZ)) |c'#0@0| |s'#0@0| |c''#2| |s''#2|) (_module.__default.small__step__star_h ($LS ($LS $LZ)) (|ORD#Minus| |_k##0@0| (|ORD#FromNat| 1)) |c''#2| |s''#2| |c#1| |t#1|)))
