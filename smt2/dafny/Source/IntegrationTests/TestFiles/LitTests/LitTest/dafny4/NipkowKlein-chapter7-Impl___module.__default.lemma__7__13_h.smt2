...
(declare-fun |s0#1| () T@U)
(declare-fun |c#1| () T@U)
(declare-fun |t#1| () T@U)
(declare-fun |_k#0@@15| () T@U)
...
(declare-fun |s'#0@@19| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.lemma__7__13_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.__default.small__step__star#canCall| (|#_module.com.Seq| |c0#1@@0| |c1#1@@0|) |s0#1| (|#_module.com.Seq| |c#1| |c1#1@@0|) |t#1|) (or (_module.__default.small__step__star ($LS $LZ) (|#_module.com.Seq| |c0#1@@0| |c1#1@@0|) |s0#1| (|#_module.com.Seq| |c#1| |c1#1@@0|) |t#1|) (or (and (|_module.com#Equal| (|#_module.com.Seq| |c0#1@@0| |c1#1@@0|) (|#_module.com.Seq| |c#1| |c1#1@@0|)) (|Map#Equal| |s0#1| |t#1|)) (exists ((|c''#5@@2| T@U) (|s''#5@@2| T@U) ) (!  (and (and ($Is DatatypeTypeType |c''#5@@2| Tclass._module.com) ($Is MapType |s''#5@@2| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS ($LS $LZ)) (|#_module.com.Seq| |c0#1@@0| |c1#1@@0|) |s0#1| |c''#5@@2| |s''#5@@2|) (_module.__default.small__step__star ($LS ($LS $LZ)) |c''#5@@2| |s''#5@@2| (|#_module.com.Seq| |c#1| |c1#1@@0|) |t#1|)))
 :qid |NipkowKleinchapter7dfy.229:10|
 :skolemid |1271|
 :pattern ( (_module.__default.small__step__star ($LS ($LS $LZ)) |c''#5@@2| |s''#5@@2| (|#_module.com.Seq| |c#1| |c1#1@@0|) |t#1|))
 :pattern ( (_module.__default.small__step ($LS ($LS $LZ)) (|#_module.com.Seq| |c0#1@@0| |c1#1@@0|) |s0#1| |c''#5@@2| |s''#5@@2|))
))))))))
(let ((anon9_correct  (and (=> (= (ControlFlow 0 5) (- 0 10)) (or (exists ((|$as#s'0_1_0#0| T@U) ) (!  (and ($Is MapType |$as#s'0_1_0#0| (TMap (TSeq TChar) TInt)) (and ($Is DatatypeTypeType (Lit DatatypeTypeType |#_module.com.SKIP|) Tclass._module.com) (and (_module.__default.small__step ($LS $LZ) |c0#1@@0| |s0#1| (Lit DatatypeTypeType |#_module.com.SKIP|) |$as#s'0_1_0#0|) (_module.__default.small__step__star_h ($LS $LZ) (|ORD#Minus| |_k#0@@15| (|ORD#FromNat| 1)) (Lit DatatypeTypeType |#_module.com.SKIP|) |$as#s'0_1_0#0| |c#1| |t#1|))))
 :qid |NipkowKleinchapter7dfy.310:13|
 :skolemid |1275|
)) (exists ((|$as#c'0_1_0#0| T@U) (|$as#s'0_1_0#0@@0| T@U) ) (!  (and (and ($Is DatatypeTypeType |$as#c'0_1_0#0| Tclass._module.com) ($Is MapType |$as#s'0_1_0#0@@0| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS $LZ) |c0#1@@0| |s0#1| |$as#c'0_1_0#0| |$as#s'0_1_0#0@@0|) (_module.__default.small__step__star_h ($LS $LZ) (|ORD#Minus| |_k#0@@15| (|ORD#FromNat| 1)) |$as#c'0_1_0#0| |$as#s'0_1_0#0@@0| |c#1| |t#1|)))
 :qid |NipkowKleinchapter7dfy.310:9|
 :skolemid |1274|
)))) (=> (or (exists ((|$as#s'0_1_0#0@@1| T@U) ) (!  (and ($Is MapType |$as#s'0_1_0#0@@1| (TMap (TSeq TChar) TInt)) (and ($Is DatatypeTypeType (Lit DatatypeTypeType |#_module.com.SKIP|) Tclass._module.com) (and (_module.__default.small__step ($LS $LZ) |c0#1@@0| |s0#1| (Lit DatatypeTypeType |#_module.com.SKIP|) |$as#s'0_1_0#0@@1|) (_module.__default.small__step__star_h ($LS $LZ) (|ORD#Minus| |_k#0@@15| (|ORD#FromNat| 1)) (Lit DatatypeTypeType |#_module.com.SKIP|) |$as#s'0_1_0#0@@1| |c#1| |t#1|))))
 :qid |NipkowKleinchapter7dfy.310:13|
 :skolemid |1275|
)) (exists ((|$as#c'0_1_0#0@@0| T@U) (|$as#s'0_1_0#0@@2| T@U) ) (!  (and (and ($Is DatatypeTypeType |$as#c'0_1_0#0@@0| Tclass._module.com) ($Is MapType |$as#s'0_1_0#0@@2| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS $LZ) |c0#1@@0| |s0#1| |$as#c'0_1_0#0@@0| |$as#s'0_1_0#0@@2|) (_module.__default.small__step__star_h ($LS $LZ) (|ORD#Minus| |_k#0@@15| (|ORD#FromNat| 1)) |$as#c'0_1_0#0@@0| |$as#s'0_1_0#0@@2| |c#1| |t#1|)))
 :qid |NipkowKleinchapter7dfy.310:9|
 :skolemid |1274|
))) (=> (and ($Is DatatypeTypeType |c'#0@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |c'#0@0| Tclass._module.com $Heap@0)) (=> (and (and ($Is MapType |s'#0@0| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |s'#0@0| (TMap (TSeq TChar) TInt) $Heap@0)) (and (_module.__default.small__step ($LS $LZ) |c0#1@@0| |s0#1| |c'#0@0| |s'#0@0|) (_module.__default.small__step__star_h ($LS $LZ) (|ORD#Minus| |_k#0@@15| (|ORD#FromNat| 1)) |c'#0@0| |s'#0@0| |c#1| |t#1|))) (and (=> (= (ControlFlow 0 5) (- 0 9)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@15|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@15|)) (=> (= |_k##0@0| (|ORD#Minus| |_k#0@@15| (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (=> (|_module.__default.small__step__star_h#canCall| |_k##0@0| |c'#0@0| |s'#0@0| |c#1| |t#1|) (or (_module.__default.small__step__star_h ($LS $LZ) |_k##0@0| |c'#0@0| |s'#0@0| |c#1| |t#1|) (=> (< 0 (|ORD#Offset| |_k##0@0|)) (or (and (|_module.com#Equal| |c'#0@0| |c#1|) (|Map#Equal| |s'#0@0| |t#1|)) (exists ((|c''#2| T@U) (|s''#2| T@U) ) (!  (and (and ($Is DatatypeTypeType |c''#2| Tclass._module.com) ($Is MapType |s''#2| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS ($LS $LZ)) |c'#0@0| |s'#0@0| |c''#2| |s''#2|) (_module.__default.small__step__star_h ($LS ($LS $LZ)) (|ORD#Minus| |_k##0@0| (|ORD#FromNat| 1)) |c''#2| |s''#2| |c#1| |t#1|)))
 :qid |NipkowKleinchapter7dfy.229:10|
 :skolemid |1259|
 :pattern ( (_module.__default.small__step__star_h ($LS ($LS $LZ)) (|ORD#Minus| |_k##0@0| (|ORD#FromNat| 1)) |c''#2| |s''#2| |c#1| |t#1|))
 :pattern ( (_module.__default.small__step ($LS ($LS $LZ)) |c'#0@0| |s'#0@0| |c''#2| |s''#2|))
))))))) (=> (=> (|_module.__default.small__step__star_h#canCall| |_k##0@0| |c'#0@0| |s'#0@0| |c#1| |t#1|) (or (_module.__default.small__step__star_h ($LS $LZ) |_k##0@0| |c'#0@0| |s'#0@0| |c#1| |t#1|) (=> (< 0 (|ORD#Offset| |_k##0@0|)) (or (and (|_module.com#Equal| |c'#0@0| |c#1|) (|Map#Equal| |s'#0@0| |t#1|)) (exists ((|c''#2@@0| T@U) (|s''#2@@0| T@U) ) (!  (and (and ($Is DatatypeTypeType |c''#2@@0| Tclass._module.com) ($Is MapType |s''#2@@0| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS ($LS $LZ)) |c'#0@0| |s'#0@0| |c''#2@@0| |s''#2@@0|) (_module.__default.small__step__star_h ($LS ($LS $LZ)) (|ORD#Minus| |_k##0@0| (|ORD#FromNat| 1)) |c''#2@@0| |s''#2@@0| |c#1| |t#1|)))
 :qid |NipkowKleinchapter7dfy.229:10|
 :skolemid |1259|
 :pattern ( (_module.__default.small__step__star_h ($LS ($LS $LZ)) (|ORD#Minus| |_k##0@0| (|ORD#FromNat| 1)) |c''#2@@0| |s''#2@@0| |c#1| |t#1|))
 :pattern ( (_module.__default.small__step ($LS ($LS $LZ)) |c'#0@0| |s'#0@0| |c''#2@@0| |s''#2@@0|))
)))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (=> (|_module.__default.small__step__star_h#canCall| |_k##0@0| |c'#0@0| |s'#0@0| |c#1| |t#1|) (or (_module.__default.small__step__star_h ($LS $LZ) |_k##0@0| |c'#0@0| |s'#0@0| |c#1| |t#1|) (=> (= (LitInt 0) (|ORD#Offset| |_k##0@0|)) (exists ((|_k'#0@@3| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#0@@3| |_k##0@0|) (_module.__default.small__step__star_h ($LS $LZ) |_k'#0@@3| |c'#0@0| |s'#0@0| |c#1| |t#1|))
 :qid |NipkowKleinchapter7dfy.226:17|
 :skolemid |1260|
 :pattern ( (_module.__default.small__step__star_h ($LS $LZ) |_k'#0@@3| |c'#0@0| |s'#0@0| |c#1| |t#1|))
)))))) (=> (=> (|_module.__default.small__step__star_h#canCall| |_k##0@0| |c'#0@0| |s'#0@0| |c#1| |t#1|) (or (_module.__default.small__step__star_h ($LS $LZ) |_k##0@0| |c'#0@0| |s'#0@0| |c#1| |t#1|) (=> (= (LitInt 0) (|ORD#Offset| |_k##0@0|)) (exists ((|_k'#0@@4| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#0@@4| |_k##0@0|) (_module.__default.small__step__star_h ($LS $LZ) |_k'#0@@4| |c'#0@0| |s'#0@0| |c#1| |t#1|))
 :qid |NipkowKleinchapter7dfy.226:17|
 :skolemid |1260|
 :pattern ( (_module.__default.small__step__star_h ($LS $LZ) |_k'#0@@4| |c'#0@0| |s'#0@0| |c#1| |t#1|))
))))) (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (|_module.__default.small__step__star#canCall| (|#_module.com.Seq| |c'#0@0| |c1#1@@0|) |s'#0@0| (|#_module.com.Seq| |c#1| |c1#1@@0|) |t#1|)) (and (and (|_module.__default.small__step__star#canCall| (|#_module.com.Seq| |c'#0@0| |c1#1@@0|) |s'#0@0| (|#_module.com.Seq| |c#1| |c1#1@@0|) |t#1|) (and (_module.__default.small__step__star ($LS $LZ) (|#_module.com.Seq| |c'#0@0| |c1#1@@0|) |s'#0@0| (|#_module.com.Seq| |c#1| |c1#1@@0|) |t#1|) (or (and (|_module.com#Equal| (|#_module.com.Seq| |c'#0@0| |c1#1@@0|) (|#_module.com.Seq| |c#1| |c1#1@@0|)) (|Map#Equal| |s'#0@0| |t#1|)) (exists ((|c''#3@@2| T@U) (|s''#3@@2| T@U) ) (!  (and (and ($Is DatatypeTypeType |c''#3@@2| Tclass._module.com) ($Is MapType |s''#3@@2| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS $LZ) (|#_module.com.Seq| |c'#0@0| |c1#1@@0|) |s'#0@0| |c''#3@@2| |s''#3@@2|) (_module.__default.small__step__star ($LS $LZ) |c''#3@@2| |s''#3@@2| (|#_module.com.Seq| |c#1| |c1#1@@0|) |t#1|)))
 :qid |NipkowKleinchapter7dfy.229:10|
 :skolemid |1265|
 :pattern ( (_module.__default.small__step__star ($LS $LZ) |c''#3@@2| |s''#3@@2| (|#_module.com.Seq| |c#1| |c1#1@@0|) |t#1|))
 :pattern ( (_module.__default.small__step ($LS $LZ) (|#_module.com.Seq| |c'#0@0| |c1#1@@0|) |s'#0@0| |c''#3@@2| |s''#3@@2|))
))))) (and (= $Heap@0 $Heap@2) (= (ControlFlow 0 5) 2)))) GeneratedUnifiedExit_correct))))))))))))))))
(let ((anon8_correct  (=> (and (and (|_module.__default.small__step#canCall| |c0#1@@0| |s0#1| |c'#1@0| |s'#1@0|) (=> (_module.__default.small__step ($LS $LZ) |c0#1@@0| |s0#1| |c'#1@0| |s'#1@0|) (|_module.__default.small__step__star_h#canCall| (|ORD#Minus| |_k#0@@15| (|ORD#FromNat| 1)) |c'#1@0| |s'#1@0| |c#1| |t#1|))) (= (ControlFlow 0 12) 5)) anon9_correct)))
(let ((anon15_Else_correct  (=> (and (not (_module.__default.small__step ($LS $LZ) |c0#1@@0| |s0#1| |c'#1@0| |s'#1@0|)) (= (ControlFlow 0 16) 12)) anon8_correct)))
(let ((anon15_Then_correct  (=> (_module.__default.small__step ($LS $LZ) |c0#1@@0| |s0#1| |c'#1@0| |s'#1@0|) (and (=> (= (ControlFlow 0 13) (- 0 15)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@15|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@15|)) (=> (and (and (and (= |##_k#0@0| (|ORD#Minus| |_k#0@@15| (|ORD#FromNat| 1))) ($IsAlloc BoxType |##_k#0@0| TORDINAL $Heap@0)) (and ($IsAlloc DatatypeTypeType |c'#1@0| Tclass._module.com $Heap@0) ($IsAlloc MapType |s'#1@0| (TMap (TSeq TChar) TInt) $Heap@0))) (and (and ($IsAlloc DatatypeTypeType |c#1| Tclass._module.com $Heap@0) ($IsAlloc MapType |t#1| (TMap (TSeq TChar) TInt) $Heap@0)) (and (|_module.__default.small__step__star_h#canCall| (|ORD#Minus| |_k#0@@15| (|ORD#FromNat| 1)) |c'#1@0| |s'#1@0| |c#1| |t#1|) (= (ControlFlow 0 13) 12)))) anon8_correct))))))))
(let ((anon14_Then_correct  (=> (and (and (and (and ($Is DatatypeTypeType |c'#1@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |c'#1@0| Tclass._module.com $Heap@0)) (and ($Is MapType |s'#1@0| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |s'#1@0| (TMap (TSeq TChar) TInt) $Heap@0))) ($IsAlloc DatatypeTypeType |c0#1@@0| Tclass._module.com $Heap@0)) (and (and ($IsAlloc MapType |s0#1| (TMap (TSeq TChar) TInt) $Heap@0) ($IsAlloc DatatypeTypeType |c'#1@0| Tclass._module.com $Heap@0)) (and ($IsAlloc MapType |s'#1@0| (TMap (TSeq TChar) TInt) $Heap@0) (|_module.__default.small__step#canCall| |c0#1@@0| |s0#1| |c'#1@0| |s'#1@0|)))) (and (=> (= (ControlFlow 0 17) 13) anon15_Then_correct) (=> (= (ControlFlow 0 17) 16) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (not (and (and ($Is DatatypeTypeType |c'#1@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |c'#1@0| Tclass._module.com $Heap@0)) (and ($Is MapType |s'#1@0| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |s'#1@0| (TMap (TSeq TChar) TInt) $Heap@0)))) (= (ControlFlow 0 11) 5)) anon9_correct)))
(let ((anon13_Else_correct  (=> (not (and (|_module.com#Equal| |c0#1@@0| |c#1|) (|Map#Equal| |s0#1| |t#1|))) (and (=> (= (ControlFlow 0 18) 17) anon14_Then_correct) (=> (= (ControlFlow 0 18) 11) anon14_Else_correct)))))
(let ((anon13_Then_correct  (=> (and (and (|_module.com#Equal| |c0#1@@0| |c#1|) (|Map#Equal| |s0#1| |t#1|)) (= (ControlFlow 0 4) 2)) GeneratedUnifiedExit_correct)))
(let ((anon3_correct  (=> (and (|$IsA#_module.com| |c0#1@@0|) (|$IsA#_module.com| |c#1|)) (and (=> (= (ControlFlow 0 19) 4) anon13_Then_correct) (=> (= (ControlFlow 0 19) 18) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (not (|_module.com#Equal| |c0#1@@0| |c#1|)) (= (ControlFlow 0 21) 19)) anon3_correct)))
(let ((anon12_Then_correct  (=> (and (|_module.com#Equal| |c0#1@@0| |c#1|) (= (ControlFlow 0 20) 19)) anon3_correct)))
(let ((anon11_Then_correct  (=> (< 0 (|ORD#Offset| |_k#0@@15|)) (and (=> (= (ControlFlow 0 22) 20) anon12_Then_correct) (=> (= (ControlFlow 0 22) 21) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (<= (|ORD#Offset| |_k#0@@15|) 0) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1)) (and (forall ((|_k'#2@@3| T@U) (|c0#2@@0| T@U) (|s0#2| T@U) (|c#2| T@U) (|t#2| T@U) (|c1#2@@0| T@U) ) (!  (=> (and (and (and (and (and ($Is DatatypeTypeType |c0#2@@0| Tclass._module.com) ($Is MapType |s0#2| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c#2| Tclass._module.com)) ($Is MapType |t#2| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c1#2@@0| Tclass._module.com)) (and (|ORD#Less| |_k'#2@@3| |_k#0@@15|) (_module.__default.small__step__star_h ($LS $LZ) |_k'#2@@3| |c0#2@@0| |s0#2| |c#2| |t#2|))) (_module.__default.small__step__star ($LS $LZ) (|#_module.com.Seq| |c0#2@@0| |c1#2@@0|) |s0#2| (|#_module.com.Seq| |c#2| |c1#2@@0|) |t#2|))
 :qid |NipkowKleinchapter7dfy.304:13|
 :skolemid |1277|
 :pattern ( (_module.__default.small__step__star ($LS $LZ) (|#_module.com.Seq| |c0#2@@0| |c1#2@@0|) |s0#2| (|#_module.com.Seq| |c#2| |c1#2@@0|) |t#2|) (|ORD#Less| |_k'#2@@3| |_k#0@@15|))
 :pattern ( (|#_module.com.Seq| |c0#2@@0| |c1#2@@0|) (_module.__default.small__step__star_h ($LS $LZ) |_k'#2@@3| |c0#2@@0| |s0#2| |c#2| |t#2|))
)) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct))))
(let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.com| |c0#1@@0|)) (and (|$IsA#_module.com| |c#1|) (|$IsA#_module.com| |c1#1@@0|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#_k0#0| T@U) (|$ih#c00#0| T@U) (|$ih#s00#0| T@U) (|$ih#c0#0| T@U) (|$ih#t0#0| T@U) (|$ih#c10#0| T@U) ) (!  (=> (and (and (and (and (and (and ($Is DatatypeTypeType |$ih#c00#0| Tclass._module.com) ($Is MapType |$ih#s00#0| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |$ih#c0#0| Tclass._module.com)) ($Is MapType |$ih#t0#0| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |$ih#c10#0| Tclass._module.com)) (_module.__default.small__step__star_h ($LS $LZ) |$ih#_k0#0| |$ih#c00#0| |$ih#s00#0| |$ih#c0#0| |$ih#t0#0|)) (or (|ORD#Less| |$ih#_k0#0| |_k#0@@15|) (and (= |$ih#_k0#0| |_k#0@@15|) (or (< (DtRank |$ih#c00#0|) (DtRank |c0#1@@0|)) (and (= (DtRank |$ih#c00#0|) (DtRank |c0#1@@0|)) (or (and (|Set#Subset| (|Map#Domain| |$ih#s00#0|) (|Map#Domain| |s0#1|)) (not (|Set#Subset| (|Map#Domain| |s0#1|) (|Map#Domain| |$ih#s00#0|)))) (and (|Set#Equal| (|Map#Domain| |$ih#s00#0|) (|Map#Domain| |s0#1|)) (or (< (DtRank |$ih#c0#0|) (DtRank |c#1|)) (and (= (DtRank |$ih#c0#0|) (DtRank |c#1|)) (or (and (|Set#Subset| (|Map#Domain| |$ih#t0#0|) (|Map#Domain| |t#1|)) (not (|Set#Subset| (|Map#Domain| |t#1|) (|Map#Domain| |$ih#t0#0|)))) (and (|Set#Equal| (|Map#Domain| |$ih#t0#0|) (|Map#Domain| |t#1|)) (< (DtRank |$ih#c10#0|) (DtRank |c1#1@@0|))))))))))))) (_module.__default.small__step__star ($LS $LZ) (|#_module.com.Seq| |$ih#c00#0| |$ih#c10#0|) |$ih#s00#0| (|#_module.com.Seq| |$ih#c0#0| |$ih#c10#0|) |$ih#t0#0|))
 :qid |NipkowKleinchapter7dfy.304:13|
 :skolemid |1273|
 :pattern ( (|#_module.com.Seq| |$ih#c00#0| |$ih#c10#0|) (_module.__default.small__step__star_h ($LS $LZ) |$ih#_k0#0| |$ih#c00#0| |$ih#s00#0| |$ih#c0#0| |$ih#t0#0|))
))))) (and (=> (= (ControlFlow 0 23) 22) anon11_Then_correct) (=> (= (ControlFlow 0 23) 3) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |c0#1@@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |c0#1@@0| Tclass._module.com $Heap)) (|$IsA#_module.com| |c0#1@@0|)) (and ($Is MapType |s0#1| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |s0#1| (TMap (TSeq TChar) TInt) $Heap))) (=> (and (and (and (and (and ($Is DatatypeTypeType |c#1| Tclass._module.com) ($IsAlloc DatatypeTypeType |c#1| Tclass._module.com $Heap)) (|$IsA#_module.com| |c#1|)) (and ($Is MapType |t#1| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |t#1| (TMap (TSeq TChar) TInt) $Heap))) (and (and (and ($Is DatatypeTypeType |c1#1@@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |c1#1@@0| Tclass._module.com $Heap)) (|$IsA#_module.com| |c1#1@@0|)) (and (and ($Is DatatypeTypeType |c'#0@@19| Tclass._module.com) ($IsAlloc DatatypeTypeType |c'#0@@19| Tclass._module.com $Heap)) true))) (and (and (and (and ($Is MapType |s'#0@@19| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |s'#0@@19| (TMap (TSeq TChar) TInt) $Heap)) true) (= 7 $FunctionContextHeight)) (and (and (|_module.__default.small__step__star_h#canCall| |_k#0@@15| |c0#1@@0| |s0#1| |c#1| |t#1|) (and (_module.__default.small__step__star_h ($LS $LZ) |_k#0@@15| |c0#1@@0| |s0#1| |c#1| |t#1|) (and (=> (< 0 (|ORD#Offset| |_k#0@@15|)) (or (and (|_module.com#Equal| |c0#1@@0| |c#1|) (|Map#Equal| |s0#1| |t#1|)) (exists ((|c''#4@@2| T@U) (|s''#4@@2| T@U) ) (!  (and (and ($Is DatatypeTypeType |c''#4@@2| Tclass._module.com) ($Is MapType |s''#4@@2| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS $LZ) |c0#1@@0| |s0#1| |c''#4@@2| |s''#4@@2|) (_module.__default.small__step__star_h ($LS $LZ) (|ORD#Minus| |_k#0@@15| (|ORD#FromNat| 1)) |c''#4@@2| |s''#4@@2| |c#1| |t#1|)))
 :qid |NipkowKleinchapter7dfy.229:10|
 :skolemid |1269|
 :pattern ( (_module.__default.small__step__star_h ($LS $LZ) (|ORD#Minus| |_k#0@@15| (|ORD#FromNat| 1)) |c''#4@@2| |s''#4@@2| |c#1| |t#1|))
 :pattern ( (_module.__default.small__step ($LS $LZ) |c0#1@@0| |s0#1| |c''#4@@2| |s''#4@@2|))
)))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@15|)) (exists ((|_k'#1@@3| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#1@@3| |_k#0@@15|) (_module.__default.small__step__star_h ($LS $LZ) |_k'#1@@3| |c0#1@@0| |s0#1| |c#1| |t#1|))
 :qid |NipkowKleinchapter7dfy.226:17|
 :skolemid |1270|
 :pattern ( (_module.__default.small__step__star_h ($LS $LZ) |_k'#1@@3| |c0#1@@0| |s0#1| |c#1| |t#1|))
