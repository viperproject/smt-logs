...
(assert (forall (($h0 T@U) ($h1 T@U) (|f#0| T@U) (|a#0| Int) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|_module.__default.apply#canCall| $h0 |f#0| |a#0|) ($Is HandleTypeType |f#0| (Tclass._System.___hFunc1 TInt TInt)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@0 T@U) ($f T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (|Set#IsMember| (Reads1 TInt TInt $h0 |f#0| ($Box intType (int_2_U |a#0|))) ($Box refType $o@@0))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h0 $o@@0) $f) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h1 $o@@0) $f)))
 :qid |unknown.0:0|
 :skolemid |531|
)) (= (_module.__default.apply $h0 |f#0| |a#0|) (_module.__default.apply $h1 |f#0| |a#0|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |532|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (_module.__default.apply $h1 |f#0| |a#0|))
)))
...
(assert (forall ((|l#0@@3| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@2 T@U) ($f@@0 T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@3| |l#1| |l#2| |l#3|) $o@@2 $f@@0))  (=> (and (or (not (= $o@@2 |l#0@@3|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1| $o@@2) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |548|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@3| |l#1| |l#2| |l#3|) $o@@2 $f@@0))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (|f#0@@0| T@U) (|a#0@@0| Int) ) (!  (=> (or (|_module.__default.apply#canCall| $Heap |f#0@@0| |a#0@@0|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) ($Is HandleTypeType |f#0@@0| (Tclass._System.___hFunc1 TInt TInt))) (Requires1 TInt TInt $Heap |f#0@@0| ($Box intType (int_2_U |a#0@@0|)))))) (= (_module.__default.apply $Heap |f#0@@0| |a#0@@0|) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap |f#0@@0| ($Box intType (int_2_U |a#0@@0|)))))))
 :qid |Bug49dfy.14:10|
 :skolemid |535|
 :pattern ( (_module.__default.apply $Heap |f#0@@0| |a#0@@0|) ($IsGoodHeap $Heap))
))))
...
(let ((anon5_Else_correct  (=> (and (and (= |##f#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| 1) (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))) ($IsAlloc HandleTypeType |##f#0@0| (Tclass._System.___hFunc1 TInt TInt) $Heap@@0)) (and (= |##a#0@0| (LitInt 5)) ($IsAlloc intType (int_2_U |##a#0@0|) TInt $Heap@@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (Requires1 TInt TInt $Heap@@0 |##f#0@0| ($Box intType (int_2_U |##a#0@0|)))) (=> (|_module.__default.apply#canCall| $Heap@@0 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| 1) (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))) (LitInt 5)) (=> (and (|_module.__default.apply#canCall| $Heap@@0 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| 1) (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))) (LitInt 5)) (= (ControlFlow 0 2) (- 0 1))) (= (_module.__default.apply $Heap@@0 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| 1) (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))) (LitInt 5)) (LitInt 6))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (and (=> (= (ControlFlow 0 7) 6) anon5_Then_correct) (=> (= (ControlFlow 0 7) 2) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct)))
