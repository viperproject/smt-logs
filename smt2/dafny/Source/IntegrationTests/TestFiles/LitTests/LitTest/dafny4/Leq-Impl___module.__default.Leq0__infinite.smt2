...
(declare-fun |m#0| () Int)
(set-info :boogie-vc-id Impl$$_module.__default.Leq0__infinite)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.Nat| |b#0@@9|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (and (forall ((|$ih#m0#0| Int) (|$ih#b0#0| T@U) ) (!  (=> (and (and (and (<= (LitInt 0) |$ih#m0#0|) ($Is DatatypeTypeType |$ih#b0#0| Tclass._module.Nat)) (_module.__default.IsInfinity ($LS $LZ) |$ih#b0#0|)) (and (<= 0 |$ih#m0#0|) (< |$ih#m0#0| |m#0|))) (_module.__default.Leq ($LS $LZ) (_module.__default.Num ($LS $LZ) |$ih#m0#0|) |$ih#b0#0|))
 :qid |Leqdfy.82:21|
 :skolemid |691|
 :pattern ( (_module.__default.Num ($LS $LZ) |$ih#m0#0|) (_module.__default.IsInfinity ($LS $LZ) |$ih#b0#0|))
)) (= (ControlFlow 0 2) (- 0 1))) (|_module.__default.Leq#canCall| (_module.__default.Num ($LS $LZ) |m#0|) |b#0@@9|))) (or (_module.__default.Leq ($LS $LZ) (_module.__default.Num ($LS $LZ) |m#0|) |b#0@@9|) (or (|$Eq#_module.Nat| ($LS ($LS $LZ)) (_module.__default.Num ($LS ($LS $LZ)) |m#0|) |#_module.Nat.Z|) (and (and (_module.Nat.S_q (_module.__default.Num ($LS ($LS $LZ)) |m#0|)) (_module.Nat.S_q |b#0@@9|)) (_module.__default.Leq ($LS ($LS $LZ)) (_module.Nat.pred (_module.__default.Num ($LS ($LS $LZ)) |m#0|)) (_module.Nat.pred |b#0@@9|)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |m#0|)) (=> (and (and (and (and ($Is DatatypeTypeType |b#0@@9| Tclass._module.Nat) ($IsAlloc DatatypeTypeType |b#0@@9| Tclass._module.Nat $Heap)) (|$IsA#_module.Nat| |b#0@@9|)) (= 2 $FunctionContextHeight)) (and (and (|_module.__default.IsInfinity#canCall| |b#0@@9|) (and (_module.__default.IsInfinity ($LS $LZ) |b#0@@9|) (and (_module.Nat.S_q |b#0@@9|) (_module.__default.IsInfinity ($LS $LZ) (_module.Nat.pred |b#0@@9|))))) (= (ControlFlow 0 3) 2))) anon0_correct))))
