...
(assert (forall ((a@@4 T@U) (b@@1 T@U) ) (!  (=> (and (M2.Contents.Root_q a@@4) (M2.Contents.Root_q b@@1)) (= (|M2.Contents#Equal| a@@4 b@@1) (= (M2.Contents.depth a@@4) (M2.Contents.depth b@@1))))
 :qid |unknown.0:0|
 :skolemid |2351|
 :pattern ( (|M2.Contents#Equal| a@@4 b@@1) (M2.Contents.Root_q a@@4))
 :pattern ( (|M2.Contents#Equal| a@@4 b@@1) (M2.Contents.Root_q b@@1))
)))
(assert (forall ((a@@5 T@U) (b@@2 T@U) ) (!  (=> (and (M2.Contents.Link_q a@@5) (M2.Contents.Link_q b@@2)) (= (|M2.Contents#Equal| a@@5 b@@2) (= (M2.Contents.next a@@5) (M2.Contents.next b@@2))))
 :qid |unknown.0:0|
 :skolemid |2352|
 :pattern ( (|M2.Contents#Equal| a@@5 b@@2) (M2.Contents.Link_q a@@5))
 :pattern ( (|M2.Contents#Equal| a@@5 b@@2) (M2.Contents.Link_q b@@2))
)))
...
(assert (forall ((a@@6 T@U) (b@@3 T@U) (t T@U) ) (! (= (|Map#Domain| (|Map#Glue| a@@6 b@@3 t)) a@@6)
 :qid |DafnyPreludebpl.1443:15|
 :skolemid |1610|
 :pattern ( (|Map#Domain| (|Map#Glue| a@@6 b@@3 t)))
)))
(assert (forall ((a@@7 T@U) (b@@4 T@U) (t@@0 T@U) ) (! (= (|Map#Elements| (|Map#Glue| a@@7 b@@4 t@@0)) b@@4)
 :qid |DafnyPreludebpl.1446:15|
 :skolemid |1611|
 :pattern ( (|Map#Elements| (|Map#Glue| a@@7 b@@4 t@@0)))
)))
(assert (forall ((a@@8 T@U) (b@@5 T@U) (y@@2 T@U) ) (!  (=> (|Set#IsMember| b@@5 y@@2) (not (|Set#IsMember| (|Set#Difference| a@@8 b@@5) y@@2)))
 :qid |DafnyPreludebpl.757:15|
 :skolemid |1468|
 :pattern ( (|Set#Difference| a@@8 b@@5) (|Set#IsMember| b@@5 y@@2))
)))
...
(assert (forall ((a@@11 T@U) (b@@8 T@U) ) (! (= (|M2.Contents#Equal| a@@11 b@@8) (= a@@11 b@@8))
 :qid |unknown.0:0|
 :skolemid |2353|
 :pattern ( (|M2.Contents#Equal| a@@11 b@@8))
)))
...
(assert (forall ((a@@13 T@U) (b@@10 T@U) ) (! (= (|Set#Subset| a@@13 b@@10) (forall ((o@@3 T@U) ) (!  (=> (|Set#IsMember| a@@13 o@@3) (|Set#IsMember| b@@10 o@@3))
...
(assert (forall ((a@@14 T@U) (b@@11 T@U) ) (! (= (|Set#Disjoint| a@@14 b@@11) (forall ((o@@4 T@U) ) (!  (or (not (|Set#IsMember| a@@14 o@@4)) (not (|Set#IsMember| b@@11 o@@4)))
...
(assert (forall ((a@@15 T@U) (b@@12 T@U) (o@@5 T@U) ) (! (= (|Set#IsMember| (|Set#Union| a@@15 b@@12) o@@5)  (or (|Set#IsMember| a@@15 o@@5) (|Set#IsMember| b@@12 o@@5)))
 :qid |DafnyPreludebpl.704:15|
 :skolemid |1457|
 :pattern ( (|Set#IsMember| (|Set#Union| a@@15 b@@12) o@@5))
)))
(assert (forall ((a@@16 T@U) (b@@13 T@U) ) (!  (=> (|Set#Disjoint| a@@16 b@@13) (and (= (|Set#Difference| (|Set#Union| a@@16 b@@13) a@@16) b@@13) (= (|Set#Difference| (|Set#Union| a@@16 b@@13) b@@13) a@@16)))
 :qid |DafnyPreludebpl.716:15|
 :skolemid |1460|
 :pattern ( (|Set#Union| a@@16 b@@13))
)))
...
(assert (forall ((a@@17 T@U) (b@@14 T@U) (c T@U) ) (!  (=> (or (not (= a@@17 c)) (not true)) (=> (and ($HeapSucc a@@17 b@@14) ($HeapSucc b@@14 c)) ($HeapSucc a@@17 c)))
 :qid |DafnyPreludebpl.606:15|
 :skolemid |1441|
 :pattern ( ($HeapSucc a@@17 b@@14) ($HeapSucc b@@14 c))
)))
...
(set-info :boogie-vc-id Impl$$M2.UnionFind.New)
...
(let ((anon13_Else_correct  (=> (and (not (M2.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_0@0|)))) M2.Element.c)))) (= (ControlFlow 0 28) 26)) anon4_correct)))
(let ((anon13_Then_correct  (=> (and (and (M2.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_0@0|)))) M2.Element.c))) ($IsAllocBox ($Box refType this@@13) Tclass.M2.UnionFind? $Heap@3)) (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_0@0|)) (or (not (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_0@0|))) null)) (not true)))) (=> (and (and (and (and (M2.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_0@0|)))) M2.Element.c))) (= |##d#0_0@0| (M2.Contents.depth ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_0@0|)))) M2.Element.c))))) (and ($IsAlloc intType (int_2_U |##d#0_0@0|) Tclass._System.nat $Heap@3) ($IsAlloc refType |f#0_0@0| Tclass.M2.Element $Heap@3))) (and (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_0@0|)) (= |##r#0_0@0| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_0@0|))))) (and ($IsAlloc refType |##r#0_0@0| Tclass.M2.Element $Heap@3) ($IsAllocBox ($Box refType this@@13) Tclass.M2.UnionFind? $Heap@3)))) (and (and (and (forall ((|f#0_1| T@U) ) (!  (=> ($Is refType |f#0_1| Tclass.M2.Element) (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_1|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |f#0_1|) M2.Element.c)))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |f#0_1|) M2.Element.c)))))))
 :qid |UnionFinddfy.64:23|
 :skolemid |2211|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |f#0_1|) M2.Element.c)))
)) (|M2.UnionFind.Collect#canCall| $Heap@3 this@@13)) (and (= |##C#0_0@0| (M2.UnionFind.Collect $Heap@3 this@@13)) ($IsAlloc MapType |##C#0_0@0| (TMap Tclass.M2.Element Tclass.M2.Contents) $Heap@3))) (and (and (=> (|M2.__default.GoodCMap#canCall| |##C#0_0@0|) (or (M2.__default.GoodCMap |##C#0_0@0|) (forall ((|f#0_2| T@U) ) (!  (=> ($Is refType |f#0_2| Tclass.M2.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |##C#0_0@0|) ($Box refType |f#0_2|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |##C#0_0@0|) ($Box refType |f#0_2|))))) (|Set#IsMember| (|Map#Domain| |##C#0_0@0|) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |##C#0_0@0|) ($Box refType |f#0_2|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |2212|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |##C#0_0@0|) ($Box refType |f#0_2|))))
)))) (|Set#IsMember| (|Map#Domain| |##C#0_0@0|) ($Box refType |f#0_0@0|))) (and (|M2.UnionFind.Reaches#canCall| this@@13 (M2.Contents.depth ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_0@0|)))) M2.Element.c))) |f#0_0@0| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_0@0|))) (M2.UnionFind.Collect $Heap@3 this@@13)) (= (ControlFlow 0 27) 26))))) anon4_correct))))
(let ((anon12_Then_correct  (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_0@0|)) (or (not (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_0@0|))) null)) (not true))) (and (=> (= (ControlFlow 0 29) 27) anon13_Then_correct) (=> (= (ControlFlow 0 29) 28) anon13_Else_correct)))))
(let ((anon8_correct true))
(let ((anon14_Else_correct  (=> (= |f#0_0@0| $nw@0) (=> (and (= $Heap@5 $Heap@3) (= (ControlFlow 0 24) 15)) anon8_correct))))
(let ((anon14_Then_correct  (=> (or (not (= |f#0_0@0| $nw@0)) (not true)) (=> (and (and (and (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_0@0|)) (or (not (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_0@0|))) null)) (not true))) (and (M2.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_0@0|)))) M2.Element.c))) (= |d##0_0_0@0| (M2.Contents.depth ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_0@0|)))) M2.Element.c)))))) (and (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_0@0|)) (= |r##0_0_0@0| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_0@0|))))) (and ($IsAlloc refType this@@13 Tclass.M2.UnionFind $Heap@@6) (forall ((|f#0_0_0| T@U) ) (!  (=> ($Is refType |f#0_0_0| Tclass.M2.Element) (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType |f#0_0_0|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |f#0_0_0|) M2.Element.c)))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |f#0_0_0|) M2.Element.c)))))))
 :qid |UnionFinddfy.64:23|
 :skolemid |2215|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |f#0_0_0|) M2.Element.c)))
))))) (and (and (and (|M2.UnionFind.Collect#canCall| $Heap@@6 this@@13) (|M2.UnionFind.Collect#canCall| $Heap@@6 this@@13)) (and (= |C##0_0_0@0| (M2.UnionFind.Collect $Heap@@6 this@@13)) ($IsAllocBox ($Box refType this@@13) Tclass.M2.UnionFind? $Heap@3))) (and (and (forall ((|f#0_0_1| T@U) ) (!  (=> ($Is refType |f#0_0_1| Tclass.M2.Element) (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_0_1|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |f#0_0_1|) M2.Element.c)))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |f#0_0_1|) M2.Element.c)))))))
 :qid |UnionFinddfy.64:23|
 :skolemid |2217|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |f#0_0_1|) M2.Element.c)))
)) (|M2.UnionFind.Collect#canCall| $Heap@3 this@@13)) (and (|M2.UnionFind.Collect#canCall| $Heap@3 this@@13) (= |C'##0_0_0@0| (M2.UnionFind.Collect $Heap@3 this@@13)))))) (and (=> (= (ControlFlow 0 16) (- 0 23)) (=> (|M2.__default.GoodCMap#canCall| |C##0_0_0@0|) (or (M2.__default.GoodCMap |C##0_0_0@0|) (forall ((|f#4| T@U) ) (!  (=> ($Is refType |f#4| Tclass.M2.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C##0_0_0@0|) ($Box refType |f#4|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#4|))))) (|Set#IsMember| (|Map#Domain| |C##0_0_0@0|) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#4|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |2148|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#4|))))
))))) (=> (=> (|M2.__default.GoodCMap#canCall| |C##0_0_0@0|) (or (M2.__default.GoodCMap |C##0_0_0@0|) (forall ((|f#4@@0| T@U) ) (!  (=> ($Is refType |f#4@@0| Tclass.M2.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C##0_0_0@0|) ($Box refType |f#4@@0|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#4@@0|))))) (|Set#IsMember| (|Map#Domain| |C##0_0_0@0|) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#4@@0|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |2148|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#4@@0|))))
)))) (and (=> (= (ControlFlow 0 16) (- 0 22)) (=> (|M2.__default.GoodCMap#canCall| |C'##0_0_0@0|) (or (M2.__default.GoodCMap |C'##0_0_0@0|) (forall ((|f#5| T@U) ) (!  (=> ($Is refType |f#5| Tclass.M2.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C'##0_0_0@0|) ($Box refType |f#5|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'##0_0_0@0|) ($Box refType |f#5|))))) (|Set#IsMember| (|Map#Domain| |C'##0_0_0@0|) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'##0_0_0@0|) ($Box refType |f#5|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |2150|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'##0_0_0@0|) ($Box refType |f#5|))))
))))) (=> (=> (|M2.__default.GoodCMap#canCall| |C'##0_0_0@0|) (or (M2.__default.GoodCMap |C'##0_0_0@0|) (forall ((|f#5@@0| T@U) ) (!  (=> ($Is refType |f#5@@0| Tclass.M2.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C'##0_0_0@0|) ($Box refType |f#5@@0|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'##0_0_0@0|) ($Box refType |f#5@@0|))))) (|Set#IsMember| (|Map#Domain| |C'##0_0_0@0|) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'##0_0_0@0|) ($Box refType |f#5@@0|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |2150|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'##0_0_0@0|) ($Box refType |f#5@@0|))))
)))) (and (=> (= (ControlFlow 0 16) (- 0 21)) (|Set#IsMember| (|Map#Domain| |C##0_0_0@0|) ($Box refType |f#0_0@0|))) (=> (|Set#IsMember| (|Map#Domain| |C##0_0_0@0|) ($Box refType |f#0_0@0|)) (and (=> (= (ControlFlow 0 16) (- 0 20)) (=> (|M2.UnionFind.Reaches#canCall| this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C##0_0_0@0|) (or (M2.UnionFind.Reaches ($LS $LZ) this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C##0_0_0@0|) (=> (M2.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#0_0@0|)))) (= |f#0_0@0| |r##0_0_0@0|))))) (=> (=> (|M2.UnionFind.Reaches#canCall| this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C##0_0_0@0|) (or (M2.UnionFind.Reaches ($LS $LZ) this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C##0_0_0@0|) (=> (M2.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#0_0@0|)))) (= |f#0_0@0| |r##0_0_0@0|)))) (and (=> (= (ControlFlow 0 16) (- 0 19)) (=> (|M2.UnionFind.Reaches#canCall| this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C##0_0_0@0|) (or (M2.UnionFind.Reaches ($LS $LZ) this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C##0_0_0@0|) (=> (not (M2.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#0_0@0|))))) (or (not (= |d##0_0_0@0| 0)) (not true)))))) (=> (=> (|M2.UnionFind.Reaches#canCall| this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C##0_0_0@0|) (or (M2.UnionFind.Reaches ($LS $LZ) this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C##0_0_0@0|) (=> (not (M2.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#0_0@0|))))) (or (not (= |d##0_0_0@0| 0)) (not true))))) (and (=> (= (ControlFlow 0 16) (- 0 18)) (=> (|M2.UnionFind.Reaches#canCall| this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C##0_0_0@0|) (or (M2.UnionFind.Reaches ($LS $LZ) this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C##0_0_0@0|) (=> (not (M2.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#0_0@0|))))) (let ((|next#0@@0| (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#0_0@0|))))))
(M2.UnionFind.Reaches ($LS ($LS $LZ)) this@@13 (- |d##0_0_0@0| 1) |next#0@@0| |r##0_0_0@0| |C##0_0_0@0|)))))) (=> (=> (|M2.UnionFind.Reaches#canCall| this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C##0_0_0@0|) (or (M2.UnionFind.Reaches ($LS $LZ) this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C##0_0_0@0|) (=> (not (M2.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#0_0@0|))))) (let ((|next#0@@1| (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#0_0@0|))))))
(M2.UnionFind.Reaches ($LS ($LS $LZ)) this@@13 (- |d##0_0_0@0| 1) |next#0@@1| |r##0_0_0@0| |C##0_0_0@0|))))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (forall ((|f#2| T@U) ) (!  (=> ($Is refType |f#2| Tclass.M2.Element?) (and (=> (|Set#IsMember| (|Map#Domain| |C##0_0_0@0|) ($Box refType |f#2|)) (|Set#IsMember| (|Map#Domain| |C'##0_0_0@0|) ($Box refType |f#2|))) (=> (|Set#IsMember| (|Map#Domain| |C##0_0_0@0|) ($Box refType |f#2|)) (|M2.Contents#Equal| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#2|))) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'##0_0_0@0|) ($Box refType |f#2|)))))))
 :qid |UnionFinddfy.81:46|
 :skolemid |2152|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'##0_0_0@0|) ($Box refType |f#2|))))
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#2|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| |C'##0_0_0@0|) ($Box refType |f#2|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| |C##0_0_0@0|) ($Box refType |f#2|)))
))) (=> (forall ((|f#2@@0| T@U) ) (!  (=> ($Is refType |f#2@@0| Tclass.M2.Element?) (and (=> (|Set#IsMember| (|Map#Domain| |C##0_0_0@0|) ($Box refType |f#2@@0|)) (|Set#IsMember| (|Map#Domain| |C'##0_0_0@0|) ($Box refType |f#2@@0|))) (=> (|Set#IsMember| (|Map#Domain| |C##0_0_0@0|) ($Box refType |f#2@@0|)) (|M2.Contents#Equal| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#2@@0|))) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'##0_0_0@0|) ($Box refType |f#2@@0|)))))))
 :qid |UnionFinddfy.81:46|
 :skolemid |2152|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'##0_0_0@0|) ($Box refType |f#2@@0|))))
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C##0_0_0@0|) ($Box refType |f#2@@0|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| |C'##0_0_0@0|) ($Box refType |f#2@@0|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| |C##0_0_0@0|) ($Box refType |f#2@@0|)))
)) (=> (and (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (|M2.UnionFind.Reaches#canCall| this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C'##0_0_0@0|)) (=> (and (and (and (|M2.UnionFind.Reaches#canCall| this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C'##0_0_0@0|) (and (M2.UnionFind.Reaches ($LS $LZ) this@@13 |d##0_0_0@0| |f#0_0@0| |r##0_0_0@0| |C'##0_0_0@0|) (ite (M2.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'##0_0_0@0|) ($Box refType |f#0_0@0|)))) (= |f#0_0@0| |r##0_0_0@0|) (let ((|next#3@@0| (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'##0_0_0@0|) ($Box refType |f#0_0@0|))))))
 (and (or (not (= |d##0_0_0@0| 0)) (not true)) (M2.UnionFind.Reaches ($LS $LZ) this@@13 (- |d##0_0_0@0| 1) |next#3@@0| |r##0_0_0@0| |C'##0_0_0@0|)))))) (= $Heap@3 $Heap@4)) (and (= $Heap@5 $Heap@4) (= (ControlFlow 0 16) 15))) anon8_correct))))))))))))))))))))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 25) 16) anon14_Then_correct) (=> (= (ControlFlow 0 25) 24) anon14_Else_correct))))
(let ((anon11_Then_correct  (=> (and ($Is refType |f#0_0@0| Tclass.M2.Element) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_0@0|))) (and (=> (= (ControlFlow 0 30) 29) anon12_Then_correct) (=> (= (ControlFlow 0 30) 25) anon12_Else_correct)))))
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> false (=> (|M2.UnionFind.Valid#canCall| $Heap@6 this@@13) (or (M2.UnionFind.Valid $Heap@6 this@@13) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.Repr)) ($Box refType this@@13)))))) (=> (=> false (=> (|M2.UnionFind.Valid#canCall| $Heap@6 this@@13) (or (M2.UnionFind.Valid $Heap@6 this@@13) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.Repr)) ($Box refType this@@13))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> false (=> (|M2.UnionFind.Valid#canCall| $Heap@6 this@@13) (or (M2.UnionFind.Valid $Heap@6 this@@13) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.Repr)) ($Box refType null))))))) (=> (=> false (=> (|M2.UnionFind.Valid#canCall| $Heap@6 this@@13) (or (M2.UnionFind.Valid $Heap@6 this@@13) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.Repr)) ($Box refType null)))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> false (=> (|M2.UnionFind.Valid#canCall| $Heap@6 this@@13) (or (M2.UnionFind.Valid $Heap@6 this@@13) (=> (|M2.UnionFind.ValidM1#canCall| $Heap@6 this@@13) (or (M2.UnionFind.ValidM1 $Heap@6 this@@13) (|Set#Subset| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.Repr))))))))) (=> (=> false (=> (|M2.UnionFind.Valid#canCall| $Heap@6 this@@13) (or (M2.UnionFind.Valid $Heap@6 this@@13) (=> (|M2.UnionFind.ValidM1#canCall| $Heap@6 this@@13) (or (M2.UnionFind.ValidM1 $Heap@6 this@@13) (|Set#Subset| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.Repr)))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> false (=> (|M2.UnionFind.Valid#canCall| $Heap@6 this@@13) (or (M2.UnionFind.Valid $Heap@6 this@@13) (=> (|M2.UnionFind.ValidM1#canCall| $Heap@6 this@@13) (or (M2.UnionFind.ValidM1 $Heap@6 this@@13) (forall ((|e#13| T@U) ) (!  (=> ($Is refType |e#13| Tclass.M2.Element?) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#13|)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#13|)))))
 :qid |UnionFinddfy.57:15|
 :skolemid |2195|
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#13|))))
)))))))) (=> (=> false (=> (|M2.UnionFind.Valid#canCall| $Heap@6 this@@13) (or (M2.UnionFind.Valid $Heap@6 this@@13) (=> (|M2.UnionFind.ValidM1#canCall| $Heap@6 this@@13) (or (M2.UnionFind.ValidM1 $Heap@6 this@@13) (forall ((|e#13@@0| T@U) ) (!  (=> ($Is refType |e#13@@0| Tclass.M2.Element?) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#13@@0|)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#13@@0|)))))
 :qid |UnionFinddfy.57:15|
 :skolemid |2195|
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#13@@0|))))
))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> false (=> (|M2.UnionFind.Valid#canCall| $Heap@6 this@@13) (or (M2.UnionFind.Valid $Heap@6 this@@13) (=> (|M2.UnionFind.ValidM1#canCall| $Heap@6 this@@13) (or (M2.UnionFind.ValidM1 $Heap@6 this@@13) (forall ((|e#14| T@U) ) (!  (=> ($Is refType |e#14| Tclass.M2.Element?) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#14|)) (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#14|)))) ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#14|))))))
 :qid |UnionFinddfy.57:15|
 :skolemid |2196|
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#14|)))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#14|)))
)))))))) (=> (=> false (=> (|M2.UnionFind.Valid#canCall| $Heap@6 this@@13) (or (M2.UnionFind.Valid $Heap@6 this@@13) (=> (|M2.UnionFind.ValidM1#canCall| $Heap@6 this@@13) (or (M2.UnionFind.ValidM1 $Heap@6 this@@13) (forall ((|e#14@@0| T@U) ) (!  (=> ($Is refType |e#14@@0| Tclass.M2.Element?) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#14@@0|)) (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#14@@0|)))) ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#14@@0|))))))
 :qid |UnionFinddfy.57:15|
 :skolemid |2196|
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#14@@0|)))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#14@@0|)))
))))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> false (=> (|M2.UnionFind.Valid#canCall| $Heap@6 this@@13) (or (M2.UnionFind.Valid $Heap@6 this@@13) (=> (|M2.UnionFind.ValidM1#canCall| $Heap@6 this@@13) (or (M2.UnionFind.ValidM1 $Heap@6 this@@13) (forall ((|e#15| T@U) ) (!  (=> ($Is refType |e#15| Tclass.M2.Element) (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#15|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |e#15|) M2.Element.c)))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |e#15|) M2.Element.c)))))))
 :qid |UnionFinddfy.58:15|
 :skolemid |2197|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |e#15|) M2.Element.c)))
)))))))) (=> (=> false (=> (|M2.UnionFind.Valid#canCall| $Heap@6 this@@13) (or (M2.UnionFind.Valid $Heap@6 this@@13) (=> (|M2.UnionFind.ValidM1#canCall| $Heap@6 this@@13) (or (M2.UnionFind.ValidM1 $Heap@6 this@@13) (forall ((|e#15@@0| T@U) ) (!  (=> ($Is refType |e#15@@0| Tclass.M2.Element) (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#15@@0|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |e#15@@0|) M2.Element.c)))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |e#15@@0|) M2.Element.c)))))))
 :qid |UnionFinddfy.58:15|
 :skolemid |2197|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |e#15@@0|) M2.Element.c)))
))))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> false (=> (|M2.UnionFind.Valid#canCall| $Heap@6 this@@13) (or (M2.UnionFind.Valid $Heap@6 this@@13) (=> (|M2.UnionFind.ValidM1#canCall| $Heap@6 this@@13) (or (M2.UnionFind.ValidM1 $Heap@6 this@@13) (forall ((|e#16| T@U) ) (!  (=> ($Is refType |e#16| Tclass.M2.Element) (and (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#16|)) (M2.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#16|)))) M2.Element.c)))) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#16|)) (M2.UnionFind.Reaches ($LS ($LS $LZ)) this@@13 (M2.Contents.depth ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#16|)))) M2.Element.c))) |e#16| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#16|))) (M2.UnionFind.Collect $Heap@6 this@@13)))))
 :qid |UnionFinddfy.59:15|
 :skolemid |2198|
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#16|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#16|)))
)))))))) (=> (=> false (=> (|M2.UnionFind.Valid#canCall| $Heap@6 this@@13) (or (M2.UnionFind.Valid $Heap@6 this@@13) (=> (|M2.UnionFind.ValidM1#canCall| $Heap@6 this@@13) (or (M2.UnionFind.ValidM1 $Heap@6 this@@13) (forall ((|e#16@@0| T@U) ) (!  (=> ($Is refType |e#16@@0| Tclass.M2.Element) (and (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#16@@0|)) (M2.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#16@@0|)))) M2.Element.c)))) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#16@@0|)) (M2.UnionFind.Reaches ($LS ($LS $LZ)) this@@13 (M2.Contents.depth ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#16@@0|)))) M2.Element.c))) |e#16@@0| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#16@@0|))) (M2.UnionFind.Collect $Heap@6 this@@13)))))
 :qid |UnionFinddfy.59:15|
 :skolemid |2198|
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#16@@0|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M))) ($Box refType |e#16@@0|)))
))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> false (and (forall (($o@@15 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.Repr)) ($Box refType $o@@15)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.Repr)) ($Box refType $o@@15)))) (or (not (= $o@@15 null)) (not true)))
 :qid |UnionFinddfy.23:12|
 :skolemid |2204|
 :pattern (  (or (not (= $o@@15 null)) (not true)))
)) (forall (($o@@16 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.Repr)) ($Box refType $o@@16)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.Repr)) ($Box refType $o@@16)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 $o@@16) alloc)))))
 :qid |UnionFinddfy.23:12|
 :skolemid |2205|
...
)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> false (not (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType $nw@0))))) (=> (=> false (not (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType $nw@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> false (forall ((|e'#1| T@U) ) (!  (=> ($Is refType |e'#1| Tclass.M2.Element?) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType |e'#1|)) (or (not (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType |e'#1|))) $nw@0)) (not true))))
 :qid |UnionFinddfy.24:37|
 :skolemid |2206|
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType |e'#1|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType |e'#1|)))
)))) (=> (=> false (forall ((|e'#1@@0| T@U) ) (!  (=> ($Is refType |e'#1@@0| Tclass.M2.Element?) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType |e'#1@@0|)) (or (not (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType |e'#1@@0|))) $nw@0)) (not true))))
 :qid |UnionFinddfy.24:37|
 :skolemid |2206|
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType |e'#1@@0|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType |e'#1@@0|)))
))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (|Map#Equal| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@13) M2.UnionFind.M)) (|Map#Build| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M)) ($Box refType $nw@0) ($Box refType $nw@0)))))))))))))))))))))))))))
(let ((anon11_Else_correct  (=> (forall ((|f#0_3| T@U) ) (!  (=> (and ($Is refType |f#0_3| Tclass.M2.Element) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_3|))) (and (M2.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_3|)))) M2.Element.c))) (M2.UnionFind.Reaches ($LS $LZ) this@@13 (M2.Contents.depth ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_3|)))) M2.Element.c))) |f#0_3| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_3|))) (M2.UnionFind.Collect $Heap@3 this@@13))))
 :qid |UnionFinddfy.93:14|
 :skolemid |2219|
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_3|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0_3|)))
)) (and (=> (= (ControlFlow 0 13) (- 0 14)) true) (=> (and (= $Heap@6 $Heap@3) (= (ControlFlow 0 13) 2)) GeneratedUnifiedExit_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@6 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.Repr)))) (=> (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 Tclass.M2.Element?)) (=> (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 $nw@0) alloc)))) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@6 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (=> (and (and (and (and (and (or (not (= $nw@0 null)) (not true)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 M2.Element.c))) (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (= |$rhs#0@0| (Lit DatatypeTypeType (|#M2.Contents.Root| (LitInt 0)))))) (and (and (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0) M2.Element.c ($Box DatatypeTypeType |$rhs#0@0|)))) ($IsGoodHeap $Heap@1)) (and (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@13 M2.UnionFind.Repr)) (= |$rhs#1@0| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@13) M2.UnionFind.Repr)) (|Set#UnionOne| |Set#Empty| ($Box refType $nw@0))))))) (and (and (and (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 this@@13 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@13) M2.UnionFind.Repr ($Box SetType |$rhs#1@0|)))) ($IsGoodHeap $Heap@2)) (and (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@13 M2.UnionFind.M)) (= |$rhs#2@0| (|Map#Build| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@13) M2.UnionFind.M)) ($Box refType $nw@0) ($Box refType $nw@0))))) (and (and (= $Heap@3 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@2 this@@13 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@13) M2.UnionFind.M ($Box MapType |$rhs#2@0|)))) ($IsGoodHeap $Heap@3)) (and ($IsAllocBox ($Box refType this@@13) Tclass.M2.UnionFind? $Heap@3) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat))))) (and (and (and (and (= |##d#0@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##d#0@0|) Tclass._System.nat $Heap@3)) (and ($IsAlloc refType $nw@0 Tclass.M2.Element $Heap@3) ($IsAlloc refType $nw@0 Tclass.M2.Element $Heap@3))) (and (and ($IsAllocBox ($Box refType this@@13) Tclass.M2.UnionFind? $Heap@3) (forall ((|f#0@@2| T@U) ) (!  (=> ($Is refType |f#0@@2| Tclass.M2.Element) (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType |f#0@@2|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |f#0@@2|) M2.Element.c)))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@13) M2.UnionFind.M))) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |f#0@@2|) M2.Element.c)))))))
 :qid |UnionFinddfy.64:23|
 :skolemid |2208|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |f#0@@2|) M2.Element.c)))
))) (and (|M2.UnionFind.Collect#canCall| $Heap@3 this@@13) (= |##C#0@0| (M2.UnionFind.Collect $Heap@3 this@@13))))) (and (and (and ($IsAlloc MapType |##C#0@0| (TMap Tclass.M2.Element Tclass.M2.Contents) $Heap@3) (=> (|M2.__default.GoodCMap#canCall| |##C#0@0|) (or (M2.__default.GoodCMap |##C#0@0|) (forall ((|f#1@@1| T@U) ) (!  (=> ($Is refType |f#1@@1| Tclass.M2.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |##C#0@0|) ($Box refType |f#1@@1|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |##C#0@0|) ($Box refType |f#1@@1|))))) (|Set#IsMember| (|Map#Domain| |##C#0@0|) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |##C#0@0|) ($Box refType |f#1@@1|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |2209|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |##C#0@0|) ($Box refType |f#1@@1|))))
))))) (and (|Set#IsMember| (|Map#Domain| |##C#0@0|) ($Box refType $nw@0)) (|M2.UnionFind.Reaches#canCall| this@@13 (LitInt 0) $nw@0 $nw@0 (M2.UnionFind.Collect $Heap@3 this@@13)))) (and (and (|M2.UnionFind.Collect#canCall| $Heap@3 this@@13) (|M2.UnionFind.Reaches#canCall| this@@13 (LitInt 0) $nw@0 $nw@0 (M2.UnionFind.Collect $Heap@3 this@@13))) (M2.UnionFind.Reaches ($LS $LZ) this@@13 (LitInt 0) $nw@0 $nw@0 (M2.UnionFind.Collect $Heap@3 this@@13)))))) (and (=> (= (ControlFlow 0 31) 30) anon11_Then_correct) (=> (= (ControlFlow 0 31) 13) anon11_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and (or (not (= this@@13 null)) (not true)) (and ($Is refType this@@13 Tclass.M2.UnionFind) ($IsAlloc refType this@@13 Tclass.M2.UnionFind $Heap@@6))) (and (=> |defass#e#0| (and ($Is refType |e#0@@5| Tclass.M2.Element) ($IsAlloc refType |e#0@@5| Tclass.M2.Element $Heap@@6))) (= 7 $FunctionContextHeight))) (and (and (|M2.UnionFind.Valid#canCall| $Heap@@6 this@@13) (and (M2.UnionFind.Valid $Heap@@6 this@@13) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.Repr)) ($Box refType this@@13)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.Repr)) ($Box refType null)))) (M2.UnionFind.ValidM1 $Heap@@6 this@@13)))) (= (ControlFlow 0 32) 31))) anon0_correct))))
