...
(assert (forall ((bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 Tclass.M0.Counter?) (and (= ($Box refType ($Unbox refType bx@@2)) bx@@2) ($Is refType ($Unbox refType bx@@2) Tclass.M0.Counter?)))
 :qid |unknown.0:0|
 :skolemid |479|
 :pattern ( ($IsBox bx@@2 Tclass.M0.Counter?))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) ) (!  (=> (or (|M0.Counter.Valid#canCall| $Heap this) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass.M0.Counter) ($IsAlloc refType this Tclass.M0.Counter $Heap)))))) (=> (M0.Counter.Valid $Heap this) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) M0.Counter.Repr)) ($Box refType this))))
 :qid |ClassRefinementdfy.7:21|
 :skolemid |489|
 :pattern ( (M0.Counter.Valid $Heap this))
))))
...
(set-info :boogie-vc-id Impl$$M0.Counter.Get)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (= |n#0@1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) M0.Counter.N)))))))
(let ((anon3_Then_correct  (=> (= |n#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) M0.Counter.N)))) (=> (and (= |n#0@1| |n#0@0|) (= (ControlFlow 0 4) 3)) GeneratedUnifiedExit_correct))))
(let ((anon3_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@0 alloc false)) (and (=> (= (ControlFlow 0 5) 4) anon3_Then_correct) (=> (= (ControlFlow 0 5) 1) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass.M0.Counter) ($IsAlloc refType this@@0 Tclass.M0.Counter $Heap@@0))) (= 1 $FunctionContextHeight)) (and (M0.Counter.Valid $Heap@@0 this@@0) (= (ControlFlow 0 6) 5))) anon0_correct))))
