...
(set-info :boogie-vc-id Impl$$M2.UnionFind.Reaches__SinkIsFunctionOfStart)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (forall ((|$ih#d00#0| Int) (|$ih#d10#0| Int) (|$ih#e0#0| T@U) (|$ih#r00#0| T@U) (|$ih#r10#0| T@U) (|$ih#C0#0| T@U) ) (!  (=> (and (and (and (and (and (and (and (<= (LitInt 0) |$ih#d00#0|) (<= (LitInt 0) |$ih#d10#0|)) ($Is refType |$ih#e0#0| Tclass.M2.Element)) ($Is refType |$ih#r00#0| Tclass.M2.Element)) ($Is refType |$ih#r10#0| Tclass.M2.Element)) ($Is MapType |$ih#C0#0| (TMap Tclass.M2.Element Tclass.M2.Contents))) (and (and (M2.__default.GoodCMap |$ih#C0#0|) (|Set#IsMember| (|Map#Domain| |$ih#C0#0|) ($Box refType |$ih#e0#0|))) (and (M2.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#d00#0| |$ih#e0#0| |$ih#r00#0| |$ih#C0#0|) (M2.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#d10#0| |$ih#e0#0| |$ih#r10#0| |$ih#C0#0|)))) (or (and (<= 0 |$ih#d00#0|) (< |$ih#d00#0| |d0#0|)) (and (= |$ih#d00#0| |d0#0|) (or (and (<= 0 |$ih#d10#0|) (< |$ih#d10#0| |d1#0|)) (and (= |$ih#d10#0| |d1#0|) (or (and (= |$ih#e0#0| null) (or (not (= |e#0@@3| null)) (not true))) (and (=  (or (not (= |$ih#e0#0| null)) (not true))  (or (not (= |e#0@@3| null)) (not true))) (or (and (= |$ih#r00#0| null) (or (not (= |r0#0| null)) (not true))) (and (=  (or (not (= |$ih#r00#0| null)) (not true))  (or (not (= |r0#0| null)) (not true))) (or (and (= |$ih#r10#0| null) (or (not (= |r1#0| null)) (not true))) (and (=  (or (not (= |$ih#r10#0| null)) (not true))  (or (not (= |r1#0| null)) (not true))) (and (|Set#Subset| (|Map#Domain| |$ih#C0#0|) (|Map#Domain| |C#0@@5|)) (not (|Set#Subset| (|Map#Domain| |C#0@@5|) (|Map#Domain| |$ih#C0#0|))))))))))))))) (= |$ih#r00#0| |$ih#r10#0|))
 :qid |UnionFinddfy.143:64|
 :skolemid |1962|
 :pattern ( (M2.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#d10#0| |$ih#e0#0| |$ih#r10#0| |$ih#C0#0|) (M2.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#d00#0| |$ih#e0#0| |$ih#r00#0| |$ih#C0#0|))
)) (= (ControlFlow 0 2) (- 0 1)))) (= |r0#0| |r1#0|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.M2.UnionFind) ($IsAlloc refType this@@3 Tclass.M2.UnionFind $Heap)))) (and (and (<= (LitInt 0) |d0#0|) (<= (LitInt 0) |d1#0|)) (and ($Is refType |e#0@@3| Tclass.M2.Element) ($IsAlloc refType |e#0@@3| Tclass.M2.Element $Heap)))) (and (and (and ($Is refType |r0#0| Tclass.M2.Element) ($IsAlloc refType |r0#0| Tclass.M2.Element $Heap)) (and ($Is refType |r1#0| Tclass.M2.Element) ($IsAlloc refType |r1#0| Tclass.M2.Element $Heap))) (and (and ($Is MapType |C#0@@5| (TMap Tclass.M2.Element Tclass.M2.Contents)) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M2.Element Tclass.M2.Contents) $Heap)) (= 5 $FunctionContextHeight)))) (and (and (and (and (|M2.__default.GoodCMap#canCall| |C#0@@5|) (and (M2.__default.GoodCMap |C#0@@5|) (forall ((|f#3| T@U) ) (!  (=> ($Is refType |f#3| Tclass.M2.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |f#3|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#3|))))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#3|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |1961|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#3|))))
)))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|))) (and (|M2.UnionFind.Reaches#canCall| this@@3 |d0#0| |e#0@@3| |r0#0| |C#0@@5|) (and (M2.UnionFind.Reaches ($LS $LZ) this@@3 |d0#0| |e#0@@3| |r0#0| |C#0@@5|) (ite (M2.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|)))) (= |e#0@@3| |r0#0|) (let ((|next#5@@0| (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|))))))
 (and (or (not (= |d0#0| 0)) (not true)) (M2.UnionFind.Reaches ($LS $LZ) this@@3 (- |d0#0| 1) |next#5@@0| |r0#0| |C#0@@5|))))))) (and (and (|M2.UnionFind.Reaches#canCall| this@@3 |d1#0| |e#0@@3| |r1#0| |C#0@@5|) (and (M2.UnionFind.Reaches ($LS $LZ) this@@3 |d1#0| |e#0@@3| |r1#0| |C#0@@5|) (ite (M2.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|)))) (= |e#0@@3| |r1#0|) (let ((|next#7| (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|))))))
 (and (or (not (= |d1#0| 0)) (not true)) (M2.UnionFind.Reaches ($LS $LZ) this@@3 (- |d1#0| 1) |next#7| |r1#0| |C#0@@5|)))))) (= (ControlFlow 0 3) 2)))) anon0_correct)))
