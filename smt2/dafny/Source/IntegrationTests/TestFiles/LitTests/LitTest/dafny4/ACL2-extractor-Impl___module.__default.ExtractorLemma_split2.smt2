...
(set-info :boogie-vc-id Impl$$_module.__default.ExtractorLemma_split2)
...
))) (and ($IsAlloc DatatypeTypeType |xs#0@@22| (Tclass._module.List _module._default.ExtractorLemma$T) $Heap@0) (|_module.__default.length#canCall| _module._default.ExtractorLemma$T |xs#0@@22|))) (and (and (= |##n#0_0_0@0| (- (- (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|) 1) |i#0|)) ($IsAlloc intType (int_2_U |##n#0_0_0@0|) TInt $Heap@0)) (and ($IsAlloc DatatypeTypeType |xs#0@@22| (Tclass._module.List _module._default.ExtractorLemma$T) $Heap@0) (|_module.__default.nth#canCall| _module._default.ExtractorLemma$T (- (- (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|) 1) |i#0|) |xs#0@@22|))))) (and (and (and (and (|_module.__default.length#canCall| _module._default.ExtractorLemma$T |xs#0@@22|) (|_module.__default.nth#canCall| _module._default.ExtractorLemma$T (- (- (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|) 1) |i#0|) |xs#0@@22|)) (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4))) (and (and (= $Heap@0 $Heap@4) reveal__module._default.nth) (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5)))) (and (and (and (|_module.__default.rev#canCall| _module._default.ExtractorLemma$T |xs#0@@22|) (|_module.__default.length#canCall| _module._default.ExtractorLemma$T (_module.__default.rev _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|))) (|_module.__default.length#canCall| _module._default.ExtractorLemma$T |xs#0@@22|)) (and (and (= (_module.__default.length _module._default.ExtractorLemma$T ($LS ($LS $LZ)) (_module.__default.rev _module._default.ExtractorLemma$T ($LS ($LS $LZ)) |xs#0@@22|)) (_module.__default.length _module._default.ExtractorLemma$T ($LS ($LS $LZ)) |xs#0@@22|)) (= $Heap@4 $Heap@5)) (and (<= (LitInt 0) |i#0|) (= (ControlFlow 0 2) (- 0 1))))))) (< |i#0| (_module.__default.length _module._default.ExtractorLemma$T ($LS ($LS $LZ)) |xs#0@@22|))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
