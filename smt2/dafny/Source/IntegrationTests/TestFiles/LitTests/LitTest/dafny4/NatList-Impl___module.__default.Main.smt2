...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (= |ns#0@0| (Lit DatatypeTypeType |#_module.List.Nil|))) (and (=> (= (ControlFlow 0 2) (- 0 5)) ($Is intType (int_2_U (LitInt 4)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 4)) Tclass._System.nat) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($Is DatatypeTypeType (Lit DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 10))) (Lit DatatypeTypeType |#_module.List.Nil|))) (Tclass._module.List Tclass._System.nat))) (=> ($Is DatatypeTypeType (Lit DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 10))) (Lit DatatypeTypeType |#_module.List.Nil|))) (Tclass._module.List Tclass._System.nat)) (=> (and (= |ns#0@1| (Lit DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 4))) (Lit DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 10))) (Lit DatatypeTypeType |#_module.List.Nil|)))))) ($IsAlloc DatatypeTypeType |ns#0@1| (Tclass._module.List Tclass._System.nat) $Heap@@0)) (=> (and (and (|_module.__default.Sum#canCall| |ns#0@1|) (|_module.__default.Sum#canCall| |ns#0@1|)) (and (= |ns'#0@0| (Lit DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 20))) (Lit DatatypeTypeType |#_module.List.Nil|)))) ($IsAlloc DatatypeTypeType |ns#0@1| (Tclass._module.List Tclass._System.nat) $Heap@@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($Is DatatypeTypeType |ns'#0@0| (Tclass._module.List Tclass._System.nat))) (=> ($Is DatatypeTypeType |ns'#0@0| (Tclass._module.List Tclass._System.nat)) (=> ($IsAlloc DatatypeTypeType |ns'#0@0| (Tclass._module.List Tclass._System.nat) $Heap@@0) (=> (and (and (and (|_module.__default.Append#canCall| Tclass._System.nat |ns#0@1| |ns'#0@0|) (|_module.__default.Append#canCall| Tclass._System.nat |ns#0@1| |ns'#0@0|)) (and (= |ns''#0@0| (_module.__default.Append Tclass._System.nat ($LS $LZ) |ns#0@1| |ns'#0@0|)) ($IsAlloc DatatypeTypeType |ns''#0@0| (Tclass._module.List Tclass._System.nat) $Heap@@0))) (and (and (|_module.__default.Sum#canCall| |ns''#0@0|) (|_module.__default.Sum#canCall| |ns''#0@0|)) (and (= |nn##0@0| (LitInt (- 0 12))) (= (ControlFlow 0 2) (- 0 1))))) (<= |nn##0@0| (LitInt 0)))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (and ($Is DatatypeTypeType |ns#0| (Tclass._module.List Tclass._System.nat)) ($IsAlloc DatatypeTypeType |ns#0| (Tclass._module.List Tclass._System.nat) $Heap@@0)) true) (and (and ($Is DatatypeTypeType |ns'#0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |ns'#0| (Tclass._module.List TInt) $Heap@@0)) true)) (and (and (and ($Is DatatypeTypeType |ns''#0| (Tclass._module.List Tclass._System.nat)) ($IsAlloc DatatypeTypeType |ns''#0| (Tclass._module.List Tclass._System.nat) $Heap@@0)) true) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 6) 2)))) anon0_correct))))
