...
(set-info :boogie-vc-id Impl$$_module.__default.FlyRobots)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@8 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b0#0|) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b1#0|) _module.Bot.Repr)))) (and (=> (= (ControlFlow 0 2) (- 0 18)) (or (not (= |b0#0| null)) (not true))) (=> (or (not (= |b0#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 17)) (forall (($o@@44 T@U) ($f@@6 T@U) ) (!  (=> (and (and (or (not (= $o@@44 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@44) alloc)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b0#0|) _module.Bot.Repr)) ($Box refType $o@@44))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@44 $f@@6)))
 :qid |FlyingRobotsdfy.169:9|
 :skolemid |524|
 ...
 :qid |FlyingRobotsdfy.169:9|
 :skolemid |524|
)) (and (=> (= (ControlFlow 0 2) (- 0 16)) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@@8 |b0#0|)) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@@8 |b0#0|) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (|_module.Bot.Valid#canCall| $Heap@0 |b0#0|) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 |b0#0|)) (and (forall (($o@@46 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |b0#0|) _module.Bot.Repr)) ($Box refType $o@@46)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b0#0|) _module.Bot.Repr)) ($Box refType $o@@46)))) (or (not (= $o@@46 null)) (not true)))
 :qid |FlyingRobotsdfy.144:24|
 :skolemid |851|
 :pattern (  (or (not (= $o@@46 null)) (not true)))
)) (forall (($o@@47 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |b0#0|) _module.Bot.Repr)) ($Box refType $o@@47)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b0#0|) _module.Bot.Repr)) ($Box refType $o@@47)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@47) alloc)))))
 :qid |FlyingRobotsdfy.144:24|
 :skolemid |852|
...
)))) (=> (and (and (and (|_module.Bot.robot__inv#canCall| $Heap@0 |b0#0|) (=> (_module.Bot.robot__inv $Heap@0 |b0#0|) (|_module.Bot.flying#canCall| $Heap@0 |b0#0|))) (and (|_module.Bot.robot__inv#canCall| $Heap@0 |b0#0|) (and (_module.Bot.robot__inv $Heap@0 |b0#0|) (=> (_module.Bot.flying $Heap@0 |b0#0|) (_module.Bot.arms__up $Heap@0 |b0#0|))))) (and (and (|_module.Bot.flying#canCall| $Heap@0 |b0#0|) (and (_module.Bot.flying $Heap@0 |b0#0|) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |b0#0|) _module.Bot.pos))) _module.Point.z))) _module.Cell.val))) 0))) (and (forall (($o@@48 T@U) ) (!  (=> (and (or (not (= $o@@48 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@48) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@48) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@48)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b0#0|) _module.Bot.Repr)) ($Box refType $o@@48))))
 :qid |FlyingRobotsdfy.141:10|
 :skolemid |853|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@48))
)) ($HeapSucc $Heap@@8 $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (or (not (= |b1#0| null)) (not true))) (=> (or (not (= |b1#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 14)) (forall (($o@@49 T@U) ($f@@8 T@U) ) (!  (=> (and (and (or (not (= $o@@49 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@49) alloc)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |b1#0|) _module.Bot.Repr)) ($Box refType $o@@49))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@49 $f@@8)))
 :qid |FlyingRobotsdfy.170:9|
 :skolemid |525|
))) (=> (forall (($o@@50 T@U) ($f@@9 T@U) ) (!  (=> (and (and (or (not (= $o@@50 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@50) alloc)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |b1#0|) _module.Bot.Repr)) ($Box refType $o@@50))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@50 $f@@9)))
 :qid |FlyingRobotsdfy.170:9|
 :skolemid |525|
)) (and (=> (= (ControlFlow 0 2) (- 0 13)) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 |b1#0|)) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 |b1#0|) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (|_module.Bot.Valid#canCall| $Heap@1 |b1#0|) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@1 |b1#0|)) (and (forall (($o@@51 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b1#0|) _module.Bot.Repr)) ($Box refType $o@@51)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |b1#0|) _module.Bot.Repr)) ($Box refType $o@@51)))) (or (not (= $o@@51 null)) (not true)))
 :qid |FlyingRobotsdfy.144:24|
 :skolemid |851|
 :pattern (  (or (not (= $o@@51 null)) (not true)))
)) (forall (($o@@52 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b1#0|) _module.Bot.Repr)) ($Box refType $o@@52)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |b1#0|) _module.Bot.Repr)) ($Box refType $o@@52)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@52) alloc)))))
 :qid |FlyingRobotsdfy.144:24|
 :skolemid |852|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@52) alloc)))
)))) (=> (and (and (and (|_module.Bot.robot__inv#canCall| $Heap@1 |b1#0|) (=> (_module.Bot.robot__inv $Heap@1 |b1#0|) (|_module.Bot.flying#canCall| $Heap@1 |b1#0|))) (and (|_module.Bot.robot__inv#canCall| $Heap@1 |b1#0|) (and (_module.Bot.robot__inv $Heap@1 |b1#0|) (=> (_module.Bot.flying $Heap@1 |b1#0|) (_module.Bot.arms__up $Heap@1 |b1#0|))))) (and (and (|_module.Bot.flying#canCall| $Heap@1 |b1#0|) (and (_module.Bot.flying $Heap@1 |b1#0|) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b1#0|) _module.Bot.pos))) _module.Point.z))) _module.Cell.val))) 0))) (and (forall (($o@@53 T@U) ) (!  (=> (and (or (not (= $o@@53 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@53) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@53) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@53)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |b1#0|) _module.Bot.Repr)) ($Box refType $o@@53))))
 :qid |FlyingRobotsdfy.141:10|
 :skolemid |853|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@53))
)) ($HeapSucc $Heap@0 $Heap@1)))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@1 |b0#0|)) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@1 |b0#0|) (and (=> (= (ControlFlow 0 2) (- 0 11)) (and (forall (($o@@54 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b0#0|) _module.Bot.Repr)) ($Box refType $o@@54)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b0#0|) _module.Bot.Repr)) ($Box refType $o@@54)))) (or (not (= $o@@54 null)) (not true)))
 :qid |FlyingRobotsdfy.163:25|
 :skolemid |519|
 :pattern (  (or (not (= $o@@54 null)) (not true)))
)) (forall (($o@@55 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b0#0|) _module.Bot.Repr)) ($Box refType $o@@55)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b0#0|) _module.Bot.Repr)) ($Box refType $o@@55)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@55) alloc)))))
 :qid |FlyingRobotsdfy.163:25|
 :skolemid |520|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@55) alloc)))
)))) (=> (and (forall (($o@@56 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b0#0|) _module.Bot.Repr)) ($Box refType $o@@56)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b0#0|) _module.Bot.Repr)) ($Box refType $o@@56)))) (or (not (= $o@@56 null)) (not true)))
 :qid |FlyingRobotsdfy.163:25|
 :skolemid |519|
 :pattern (  (or (not (= $o@@56 null)) (not true)))
)) (forall (($o@@57 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b0#0|) _module.Bot.Repr)) ($Box refType $o@@57)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b0#0|) _module.Bot.Repr)) ($Box refType $o@@57)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@57) alloc)))))
 :qid |FlyingRobotsdfy.163:25|
 :skolemid |520|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@57) alloc)))
))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@1 |b1#0|)) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@1 |b1#0|) (and (=> (= (ControlFlow 0 2) (- 0 9)) (and (forall (($o@@58 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b1#0|) _module.Bot.Repr)) ($Box refType $o@@58)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b1#0|) _module.Bot.Repr)) ($Box refType $o@@58)))) (or (not (= $o@@58 null)) (not true)))
 :qid |FlyingRobotsdfy.164:25|
 :skolemid |521|
 :pattern (  (or (not (= $o@@58 null)) (not true)))
)) (forall (($o@@59 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b1#0|) _module.Bot.Repr)) ($Box refType $o@@59)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b1#0|) _module.Bot.Repr)) ($Box refType $o@@59)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@59) alloc)))))
 :qid |FlyingRobotsdfy.164:25|
 :skolemid |522|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@59) alloc)))
)))) (=> (and (forall (($o@@60 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b1#0|) _module.Bot.Repr)) ($Box refType $o@@60)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b1#0|) _module.Bot.Repr)) ($Box refType $o@@60)))) (or (not (= $o@@60 null)) (not true)))
 :qid |FlyingRobotsdfy.164:25|
 :skolemid |521|
 :pattern (  (or (not (= $o@@60 null)) (not true)))
)) (forall (($o@@61 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b1#0|) _module.Bot.Repr)) ($Box refType $o@@61)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b1#0|) _module.Bot.Repr)) ($Box refType $o@@61)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@61) alloc)))))
 :qid |FlyingRobotsdfy.164:25|
 :skolemid |522|
...
))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (or (not (= |b0#0| |b1#0|)) (not true)) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b0#0|) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b1#0|) _module.Bot.Repr))))) (=> (=> (or (not (= |b0#0| |b1#0|)) (not true)) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b0#0|) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b1#0|) _module.Bot.Repr)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.Bot.robot__inv#canCall| $Heap@1 |b0#0|) (or (_module.Bot.robot__inv $Heap@1 |b0#0|) (=> (_module.Bot.flying $Heap@1 |b0#0|) (=> (|_module.Bot.arms__up#canCall| $Heap@1 |b0#0|) (or (_module.Bot.arms__up $Heap@1 |b0#0|) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b0#0|) _module.Bot.left))) _module.Arm.polar))) _module.Cell.val))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b0#0|) _module.Bot.right))) _module.Arm.polar))) _module.Cell.val)))))))))) (=> (=> (|_module.Bot.robot__inv#canCall| $Heap@1 |b0#0|) (or (_module.Bot.robot__inv $Heap@1 |b0#0|) (=> (_module.Bot.flying $Heap@1 |b0#0|) (=> (|_module.Bot.arms__up#canCall| $Heap@1 |b0#0|) (or (_module.Bot.arms__up $Heap@1 |b0#0|) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b0#0|) _module.Bot.left))) _module.Arm.polar))) _module.Cell.val))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b0#0|) _module.Bot.right))) _module.Arm.polar))) _module.Cell.val))))))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.Bot.robot__inv#canCall| $Heap@1 |b0#0|) (or (_module.Bot.robot__inv $Heap@1 |b0#0|) (=> (_module.Bot.flying $Heap@1 |b0#0|) (=> (|_module.Bot.arms__up#canCall| $Heap@1 |b0#0|) (or (_module.Bot.arms__up $Heap@1 |b0#0|) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b0#0|) _module.Bot.right))) _module.Arm.polar))) _module.Cell.val))) (LitInt 0)))))))) (=> (=> (|_module.Bot.robot__inv#canCall| $Heap@1 |b0#0|) (or (_module.Bot.robot__inv $Heap@1 |b0#0|) (=> (_module.Bot.flying $Heap@1 |b0#0|) (=> (|_module.Bot.arms__up#canCall| $Heap@1 |b0#0|) (or (_module.Bot.arms__up $Heap@1 |b0#0|) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b0#0|) _module.Bot.right))) _module.Arm.polar))) _module.Cell.val))) (LitInt 0))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.Bot.robot__inv#canCall| $Heap@1 |b1#0|) (or (_module.Bot.robot__inv $Heap@1 |b1#0|) (=> (_module.Bot.flying $Heap@1 |b1#0|) (=> (|_module.Bot.arms__up#canCall| $Heap@1 |b1#0|) (or (_module.Bot.arms__up $Heap@1 |b1#0|) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b1#0|) _module.Bot.left))) _module.Arm.polar))) _module.Cell.val))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b1#0|) _module.Bot.right))) _module.Arm.polar))) _module.Cell.val)))))))))) (=> (=> (|_module.Bot.robot__inv#canCall| $Heap@1 |b1#0|) (or (_module.Bot.robot__inv $Heap@1 |b1#0|) (=> (_module.Bot.flying $Heap@1 |b1#0|) (=> (|_module.Bot.arms__up#canCall| $Heap@1 |b1#0|) (or (_module.Bot.arms__up $Heap@1 |b1#0|) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b1#0|) _module.Bot.left))) _module.Arm.polar))) _module.Cell.val))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b1#0|) _module.Bot.right))) _module.Arm.polar))) _module.Cell.val))))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.Bot.robot__inv#canCall| $Heap@1 |b1#0|) (or (_module.Bot.robot__inv $Heap@1 |b1#0|) (=> (_module.Bot.flying $Heap@1 |b1#0|) (=> (|_module.Bot.arms__up#canCall| $Heap@1 |b1#0|) (or (_module.Bot.arms__up $Heap@1 |b1#0|) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b1#0|) _module.Bot.right))) _module.Arm.polar))) _module.Cell.val))) (LitInt 0)))))))) (=> (=> (|_module.Bot.robot__inv#canCall| $Heap@1 |b1#0|) (or (_module.Bot.robot__inv $Heap@1 |b1#0|) (=> (_module.Bot.flying $Heap@1 |b1#0|) (=> (|_module.Bot.arms__up#canCall| $Heap@1 |b1#0|) (or (_module.Bot.arms__up $Heap@1 |b1#0|) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b1#0|) _module.Bot.right))) _module.Arm.polar))) _module.Cell.val))) (LitInt 0))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.Bot.flying#canCall| $Heap@1 |b0#0|) (or (_module.Bot.flying $Heap@1 |b0#0|) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b0#0|) _module.Bot.pos))) _module.Point.z))) _module.Cell.val))) 0)))) (=> (=> (|_module.Bot.flying#canCall| $Heap@1 |b0#0|) (or (_module.Bot.flying $Heap@1 |b0#0|) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b0#0|) _module.Bot.pos))) _module.Point.z))) _module.Cell.val))) 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.Bot.flying#canCall| $Heap@1 |b1#0|) (or (_module.Bot.flying $Heap@1 |b1#0|) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b1#0|) _module.Bot.pos))) _module.Point.z))) _module.Cell.val))) 0)))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@8) ($IsHeapAnchor $Heap@@8)) (and ($Is refType |b0#0| Tclass._module.Bot) ($IsAlloc refType |b0#0| Tclass._module.Bot $Heap@@8))) (=> (and (and (and ($Is refType |b1#0| Tclass._module.Bot) ($IsAlloc refType |b1#0| Tclass._module.Bot $Heap@@8)) (= 5 $FunctionContextHeight)) (and (and (_module.Bot.Valid reveal__module.Bot.Valid $Heap@@8 |b0#0|) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@@8 |b1#0|)) (and (=> (or (not (= |b0#0| |b1#0|)) (not true)) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b0#0|) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b1#0|) _module.Bot.Repr)))) (= (ControlFlow 0 19) 2)))) anon0_correct))))
