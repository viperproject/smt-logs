...
(declare-fun |$IsA#_module.ClEnv| (T@U) Bool)
...
(assert (distinct TagSet TagMap alloc Tagclass._System.nat |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass._module.ClEnv Tagclass._module.Val Tagclass._module.Cl Tagclass._module.Term Tagclass._module.LambdaAbs |##_module.LambdaAbs.Fun| |##_module.Val.ValConst| |##_module.Val.ValCl| |##_module.Cl.Closure| |##_module.ClEnv.ClEnvironment| tytagFamily$nat |tytagFamily$_tuple#2| tytagFamily$ClEnv tytagFamily$Val tytagFamily$Cl tytagFamily$Term tytagFamily$LambdaAbs)
)
...
(assert (forall ((d@@1 T@U) ) (!  (=> (|$IsA#_module.ClEnv| d@@1) (_module.ClEnv.ClEnvironment_q d@@1))
 :qid |unknown.0:0|
 :skolemid |1033|
 :pattern ( (|$IsA#_module.ClEnv| d@@1))
)))
...
(assert (forall ((d@@3 T@U) ) (!  (=> ($Is DatatypeTypeType d@@3 Tclass._module.LambdaAbs) (_module.LambdaAbs.Fun_q d@@3))
 :qid |unknown.0:0|
 :skolemid |971|
 :pattern ( (_module.LambdaAbs.Fun_q d@@3) ($Is DatatypeTypeType d@@3 Tclass._module.LambdaAbs))
)))
(assert (forall ((d@@4 T@U) ) (!  (=> ($Is DatatypeTypeType d@@4 Tclass._module.Cl) (_module.Cl.Closure_q d@@4))
 :qid |unknown.0:0|
 :skolemid |1013|
 :pattern ( (_module.Cl.Closure_q d@@4) ($Is DatatypeTypeType d@@4 Tclass._module.Cl))
)))
(assert (forall ((d@@5 T@U) ) (!  (=> ($Is DatatypeTypeType d@@5 Tclass._module.ClEnv) (_module.ClEnv.ClEnvironment_q d@@5))
 :qid |unknown.0:0|
 :skolemid |1034|
 :pattern ( (_module.ClEnv.ClEnvironment_q d@@5) ($Is DatatypeTypeType d@@5 Tclass._module.ClEnv))
)))
...
(assert (forall ((d@@7 T@U) ) (! (= (_module.LambdaAbs.Fun_q d@@7) (= (DatatypeCtorId d@@7) |##_module.LambdaAbs.Fun|))
 :qid |unknown.0:0|
 :skolemid |959|
 :pattern ( (_module.LambdaAbs.Fun_q d@@7))
)))
(assert (forall ((d@@8 T@U) ) (! (= (_module.Val.ValConst_q d@@8) (= (DatatypeCtorId d@@8) |##_module.Val.ValConst|))
 :qid |unknown.0:0|
 :skolemid |975|
 :pattern ( (_module.Val.ValConst_q d@@8))
)))
(assert (forall ((d@@9 T@U) ) (! (= (_module.Val.ValCl_q d@@9) (= (DatatypeCtorId d@@9) |##_module.Val.ValCl|))
 :qid |unknown.0:0|
 :skolemid |982|
 :pattern ( (_module.Val.ValCl_q d@@9))
)))
(assert (forall ((d@@10 T@U) ) (! (= (_module.Cl.Closure_q d@@10) (= (DatatypeCtorId d@@10) |##_module.Cl.Closure|))
 :qid |unknown.0:0|
 :skolemid |1003|
 :pattern ( (_module.Cl.Closure_q d@@10))
)))
(assert (forall ((d@@11 T@U) ) (! (= (_module.ClEnv.ClEnvironment_q d@@11) (= (DatatypeCtorId d@@11) |##_module.ClEnv.ClEnvironment|))
 :qid |unknown.0:0|
 :skolemid |1026|
 :pattern ( (_module.ClEnv.ClEnvironment_q d@@11))
)))
...
(assert (forall ((d@@13 T@U) ) (!  (=> (_module.LambdaAbs.Fun_q d@@13) (exists ((|a#33#0#0| T@U) (|a#33#1#0| T@U) ) (! (= d@@13 (|#_module.LambdaAbs.Fun| |a#33#0#0| |a#33#1#0|))
 :qid |KozenSilvadfy.171:26|
 :skolemid |960|
)))
 :qid |unknown.0:0|
 :skolemid |961|
 :pattern ( (_module.LambdaAbs.Fun_q d@@13))
)))
(assert (forall ((d@@14 T@U) ) (!  (=> (_module.Cl.Closure_q d@@14) (exists ((|a#48#0#0| T@U) (|a#48#1#0| T@U) ) (! (= d@@14 (|#_module.Cl.Closure| |a#48#0#0| |a#48#1#0|))
 :qid |KozenSilvadfy.173:25|
 :skolemid |1004|
)))
 :qid |unknown.0:0|
 :skolemid |1005|
 :pattern ( (_module.Cl.Closure_q d@@14))
)))
...
(assert (forall ((d@@15 T@U) ) (!  (=> (_module.Val.ValConst_q d@@15) (exists ((|a#40#0#0| T@U) ) (! (= d@@15 (|#_module.Val.ValConst| |a#40#0#0|))
 :qid |KozenSilvadfy.172:27|
 :skolemid |976|
)))
 :qid |unknown.0:0|
 :skolemid |977|
 :pattern ( (_module.Val.ValConst_q d@@15))
)))
(assert (forall ((d@@16 T@U) ) (!  (=> (_module.Val.ValCl_q d@@16) (exists ((|a#44#0#0| T@U) ) (! (= d@@16 (|#_module.Val.ValCl| |a#44#0#0|))
 :qid |KozenSilvadfy.172:42|
 :skolemid |983|
)))
 :qid |unknown.0:0|
 :skolemid |984|
 :pattern ( (_module.Val.ValCl_q d@@16))
)))
(assert (forall ((d@@17 T@U) ) (!  (=> (_module.ClEnv.ClEnvironment_q d@@17) (exists ((|a#53#0#0| T@U) ) (! (= d@@17 (|#_module.ClEnv.ClEnvironment| |a#53#0#0|))
 :qid |KozenSilvadfy.174:34|
 :skolemid |1027|
)))
 :qid |unknown.0:0|
 :skolemid |1028|
 :pattern ( (_module.ClEnv.ClEnvironment_q d@@17))
)))
...
(assert (forall ((bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 Tclass._module.ClEnv) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@1)) bx@@1) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@1) Tclass._module.ClEnv)))
 :qid |unknown.0:0|
 :skolemid |685|
 :pattern ( ($IsBox bx@@1 Tclass._module.ClEnv))
)))
(assert (forall ((bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 Tclass._module.Val) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@2)) bx@@2) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@2) Tclass._module.Val)))
 :qid |unknown.0:0|
 :skolemid |695|
 :pattern ( ($IsBox bx@@2 Tclass._module.Val))
)))
(assert (forall ((bx@@3 T@U) ) (!  (=> ($IsBox bx@@3 Tclass._module.Cl) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@3)) bx@@3) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@3) Tclass._module.Cl)))
 :qid |unknown.0:0|
 :skolemid |767|
 :pattern ( ($IsBox bx@@3 Tclass._module.Cl))
)))
(assert (forall ((bx@@4 T@U) ) (!  (=> ($IsBox bx@@4 Tclass._module.Term) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@4)) bx@@4) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@4) Tclass._module.Term)))
 :qid |unknown.0:0|
 :skolemid |928|
 :pattern ( ($IsBox bx@@4 Tclass._module.Term))
)))
(assert (forall ((bx@@5 T@U) ) (!  (=> ($IsBox bx@@5 Tclass._module.LambdaAbs) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@5)) bx@@5) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@5) Tclass._module.LambdaAbs)))
 :qid |unknown.0:0|
 :skolemid |945|
 :pattern ( ($IsBox bx@@5 Tclass._module.LambdaAbs))
)))
...
(assert (forall ((d@@18 T@U) ) (!  (=> (|$IsA#_module.Val| d@@18) (or (_module.Val.ValConst_q d@@18) (_module.Val.ValCl_q d@@18)))
 :qid |unknown.0:0|
 :skolemid |989|
 :pattern ( (|$IsA#_module.Val| d@@18))
)))
...
(assert (forall ((d@@19 T@U) ) (!  (=> ($Is DatatypeTypeType d@@19 Tclass._module.Val) (or (_module.Val.ValConst_q d@@19) (_module.Val.ValCl_q d@@19)))
 :qid |unknown.0:0|
 :skolemid |990|
 :pattern ( (_module.Val.ValCl_q d@@19) ($Is DatatypeTypeType d@@19 Tclass._module.Val))
 :pattern ( (_module.Val.ValConst_q d@@19) ($Is DatatypeTypeType d@@19 Tclass._module.Val))
)))
...
(assert (forall ((d@@20 T@U) ) (! (= (BoxRank ($Box DatatypeTypeType d@@20)) (DtRank d@@20))
 :qid |DafnyPreludebpl.391:15|
 :skolemid |84|
 :pattern ( (BoxRank ($Box DatatypeTypeType d@@20)))
)))
...
(assert (forall ((d@@21 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) ($Is DatatypeTypeType d@@21 Tclass._module.Term)) ($IsAlloc DatatypeTypeType d@@21 Tclass._module.Term $h@@2))
 :qid |unknown.0:0|
 :skolemid |951|
 :pattern ( ($IsAlloc DatatypeTypeType d@@21 Tclass._module.Term $h@@2))
)))
(assert (forall ((d@@22 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) ($Is DatatypeTypeType d@@22 Tclass._module.LambdaAbs)) ($IsAlloc DatatypeTypeType d@@22 Tclass._module.LambdaAbs $h@@3))
 :qid |unknown.0:0|
 :skolemid |969|
 :pattern ( ($IsAlloc DatatypeTypeType d@@22 Tclass._module.LambdaAbs $h@@3))
)))
(assert (forall ((d@@23 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) ($Is DatatypeTypeType d@@23 Tclass._module.Val)) ($IsAlloc DatatypeTypeType d@@23 Tclass._module.Val $h@@4))
 :qid |unknown.0:0|
 :skolemid |988|
 :pattern ( ($IsAlloc DatatypeTypeType d@@23 Tclass._module.Val $h@@4))
)))
(assert (forall ((d@@24 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) ($Is DatatypeTypeType d@@24 Tclass._module.Cl)) ($IsAlloc DatatypeTypeType d@@24 Tclass._module.Cl $h@@5))
 :qid |unknown.0:0|
 :skolemid |1011|
 :pattern ( ($IsAlloc DatatypeTypeType d@@24 Tclass._module.Cl $h@@5))
)))
(assert (forall ((d@@25 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) ($Is DatatypeTypeType d@@25 Tclass._module.ClEnv)) ($IsAlloc DatatypeTypeType d@@25 Tclass._module.ClEnv $h@@6))
 :qid |unknown.0:0|
 :skolemid |1032|
 :pattern ( ($IsAlloc DatatypeTypeType d@@25 Tclass._module.ClEnv $h@@6))
)))
...
(assert (forall ((d@@26 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (_System.Tuple2.___hMake2_q d@@26) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@26 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@7)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@26 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@7))
)))) ($IsAllocBox (_System.Tuple2._0 d@@26) |_System._tuple#2$T0@@6| $h@@7))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@26) |_System._tuple#2$T0@@6| $h@@7))
)))
(assert (forall ((d@@27 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (_System.Tuple2.___hMake2_q d@@27) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@27 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@8)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@27 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@8))
)))) ($IsAllocBox (_System.Tuple2._1 d@@27) |_System._tuple#2$T1@@7| $h@@8))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@27) |_System._tuple#2$T1@@7| $h@@8))
)))
(assert (forall ((d@@28 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) (and (_module.LambdaAbs.Fun_q d@@28) ($IsAlloc DatatypeTypeType d@@28 Tclass._module.LambdaAbs $h@@9))) ($IsAllocBox (_module.LambdaAbs.v d@@28) Tclass._module.Var $h@@9))
 :qid |unknown.0:0|
 :skolemid |963|
 :pattern ( ($IsAllocBox (_module.LambdaAbs.v d@@28) Tclass._module.Var $h@@9))
)))
(assert (forall ((d@@29 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) (and (_module.LambdaAbs.Fun_q d@@29) ($IsAlloc DatatypeTypeType d@@29 Tclass._module.LambdaAbs $h@@10))) ($IsAlloc DatatypeTypeType (_module.LambdaAbs.body d@@29) Tclass._module.Term $h@@10))
 :qid |unknown.0:0|
 :skolemid |964|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.LambdaAbs.body d@@29) Tclass._module.Term $h@@10))
)))
(assert (forall ((d@@30 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (_module.Val.ValConst_q d@@30) ($IsAlloc DatatypeTypeType d@@30 Tclass._module.Val $h@@11))) ($IsAllocBox (_module.Val._h2 d@@30) Tclass._module.Const $h@@11))
 :qid |unknown.0:0|
 :skolemid |979|
 :pattern ( ($IsAllocBox (_module.Val._h2 d@@30) Tclass._module.Const $h@@11))
)))
(assert (forall ((d@@31 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (_module.Val.ValCl_q d@@31) ($IsAlloc DatatypeTypeType d@@31 Tclass._module.Val $h@@12))) ($IsAlloc DatatypeTypeType (_module.Val.cl d@@31) Tclass._module.Cl $h@@12))
 :qid |unknown.0:0|
 :skolemid |986|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Val.cl d@@31) Tclass._module.Cl $h@@12))
)))
(assert (forall ((d@@32 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (_module.Cl.Closure_q d@@32) ($IsAlloc DatatypeTypeType d@@32 Tclass._module.Cl $h@@13))) ($IsAlloc DatatypeTypeType (_module.Cl.abs d@@32) Tclass._module.LambdaAbs $h@@13))
 :qid |unknown.0:0|
 :skolemid |1007|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Cl.abs d@@32) Tclass._module.LambdaAbs $h@@13))
)))
(assert (forall ((d@@33 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (_module.Cl.Closure_q d@@33) ($IsAlloc DatatypeTypeType d@@33 Tclass._module.Cl $h@@14))) ($IsAlloc DatatypeTypeType (_module.Cl.env d@@33) Tclass._module.ClEnv $h@@14))
 :qid |unknown.0:0|
 :skolemid |1008|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Cl.env d@@33) Tclass._module.ClEnv $h@@14))
)))
...
(assert (forall ((m@@13 T@U) ) (!  (or (= m@@13 |Map#Empty|) (exists ((k@@15 T@U) (v@@8 T@U) ) (! (|Set#IsMember| (|Map#Items| m@@13) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| k@@15 v@@8)))
...
(declare-fun |y#9@0| () T@U)
(declare-fun |c#1| () T@U)
(declare-fun |_k#0@@13| () Int)
...
(set-info :boogie-vc-id Impl$$_module.__default.Theorem4a__ClEnvBelow__Is__Transitive_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon6_Then_correct  (=> (and (and ($IsBox |y#9@0| Tclass._module.Var) (_module.ClEnv.ClEnvironment_q |c#1|)) (and (_module.ClEnv.ClEnvironment_q |c#1|) (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |c#1|)) |y#9@0|))) (and (=> (= (ControlFlow 0 5) (- 0 12)) ($Is intType (int_2_U (- |_k#0@@13| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |_k#0@@13| 1)) Tclass._System.nat) (=> (and (= |_k##0@0| (- |_k#0@@13| 1)) (_module.ClEnv.ClEnvironment_q |c#1|)) (and (=> (= (ControlFlow 0 5) (- 0 11)) (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |c#1|)) |y#9@0|)) (=> (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |c#1|)) |y#9@0|) (=> (_module.ClEnv.ClEnvironment_q |c#1|) (=> (and (= |u##0@0| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |c#1|)) |y#9@0|))) (_module.ClEnv.ClEnvironment_q |d#1|)) (and (=> (= (ControlFlow 0 5) (- 0 10)) (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |d#1|)) |y#9@0|)) (=> (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |d#1|)) |y#9@0|) (=> (_module.ClEnv.ClEnvironment_q |d#1|) (=> (and (= |v##0@0| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |d#1|)) |y#9@0|))) (_module.ClEnv.ClEnvironment_q |e#1|)) (and (=> (= (ControlFlow 0 5) (- 0 9)) (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |e#1|)) |y#9@0|)) (=> (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |e#1|)) |y#9@0|) (=> (and (_module.ClEnv.ClEnvironment_q |e#1|) (= |w##0@0| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |e#1|)) |y#9@0|)))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (or (<= 0 |_k#0@@13|) (= |_k##0@0| |_k#0@@13|))) (=> (or (<= 0 |_k#0@@13|) (= |_k##0@0| |_k#0@@13|)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (< |_k##0@0| |_k#0@@13|)) (=> (< |_k##0@0| |_k#0@@13|) (and (=> (= (ControlFlow 0 5) (- 0 6)) (=> (|_module.__default.ValBelow#canCall| |u##0@0| |v##0@0|) (or (_module.__default.ValBelow ($LS $LZ) |u##0@0| |v##0@0|) (or (and (and (_module.Val.ValConst_q |u##0@0|) (_module.Val.ValConst_q |v##0@0|)) (|$Eq#_module.Val| ($LS ($LS $LZ)) |u##0@0| |v##0@0|)) (and (and (and (_module.Val.ValCl_q |u##0@0|) (_module.Val.ValCl_q |v##0@0|)) (|_module.LambdaAbs#Equal| (_module.Cl.abs (_module.Val.cl |u##0@0|)) (_module.Cl.abs (_module.Val.cl |v##0@0|)))) (_module.__default.ClEnvBelow ($LS ($LS $LZ)) (_module.Cl.env (_module.Val.cl |u##0@0|)) (_module.Cl.env (_module.Val.cl |v##0@0|)))))))) (=> (=> (|_module.__default.ValBelow#canCall| |u##0@0| |v##0@0|) (or (_module.__default.ValBelow ($LS $LZ) |u##0@0| |v##0@0|) (or (and (and (_module.Val.ValConst_q |u##0@0|) (_module.Val.ValConst_q |v##0@0|)) (|$Eq#_module.Val| ($LS ($LS $LZ)) |u##0@0| |v##0@0|)) (and (and (and (_module.Val.ValCl_q |u##0@0|) (_module.Val.ValCl_q |v##0@0|)) (|_module.LambdaAbs#Equal| (_module.Cl.abs (_module.Val.cl |u##0@0|)) (_module.Cl.abs (_module.Val.cl |v##0@0|)))) (_module.__default.ClEnvBelow ($LS ($LS $LZ)) (_module.Cl.env (_module.Val.cl |u##0@0|)) (_module.Cl.env (_module.Val.cl |v##0@0|))))))) (=> (= (ControlFlow 0 5) (- 0 4)) (=> (|_module.__default.ValBelow#canCall| |v##0@0| |w##0@0|) (or (_module.__default.ValBelow ($LS $LZ) |v##0@0| |w##0@0|) (or (and (and (_module.Val.ValConst_q |v##0@0|) (_module.Val.ValConst_q |w##0@0|)) (|$Eq#_module.Val| ($LS ($LS $LZ)) |v##0@0| |w##0@0|)) (and (and (and (_module.Val.ValCl_q |v##0@0|) (_module.Val.ValCl_q |w##0@0|)) (|_module.LambdaAbs#Equal| (_module.Cl.abs (_module.Val.cl |v##0@0|)) (_module.Cl.abs (_module.Val.cl |w##0@0|)))) (_module.__default.ClEnvBelow ($LS ($LS $LZ)) (_module.Cl.env (_module.Val.cl |v##0@0|)) (_module.Cl.env (_module.Val.cl |w##0@0|)))))))))))))))))))))))))))))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.__default.ClEnvBelow_h#canCall| |_k#0@@13| |c#1| |e#1|) (or (_module.__default.ClEnvBelow_h ($LS $LZ) |_k#0@@13| |c#1| |e#1|) (=> (< 0 |_k#0@@13|) (forall ((|y#8| T@U) ) (!  (=> ($IsBox |y#8| Tclass._module.Var) (=> (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |c#1|)) |y#8|) (and (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |e#1|)) |y#8|) (_module.__default.ValBelow_h ($LS ($LS $LZ)) (- |_k#0@@13| 1) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |c#1|)) |y#8|)) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |e#1|)) |y#8|))))))
 :qid |KozenSilvadfy.180:10|
 :skolemid |754|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |e#1|)) |y#8|)))
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |c#1|)) |y#8|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |e#1|)) |y#8|))
 :pattern ( (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |c#1|)) |y#8|))
))))))))
(let ((anon6_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (= $Heap@0 $Heap@2)) (and (forall ((|y#10| T@U) ) (!  (=> (and ($IsBox |y#10| Tclass._module.Var) (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |c#1|)) |y#10|)) (_module.__default.ValBelow_h ($LS $LZ) (- |_k#0@@13| 1) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |c#1|)) |y#10|)) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |e#1|)) |y#10|))))
 :qid |KozenSilvadfy.192:10|
 :skolemid |759|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |e#1|)) |y#10|)))
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |c#1|)) |y#10|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |c#1|)) |y#10|))
)) (= (ControlFlow 0 13) 2))) GeneratedUnifiedExit_correct)))
(let ((anon5_Then_correct  (=> (< 0 |_k#0@@13|) (and (=> (= (ControlFlow 0 14) 5) anon6_Then_correct) (=> (= (ControlFlow 0 14) 13) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (<= |_k#0@@13| 0) (= (ControlFlow 0 3) 2)) GeneratedUnifiedExit_correct)))
(let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.ClEnv| |c#1|)) (and (|$IsA#_module.ClEnv| |d#1|) (|$IsA#_module.ClEnv| |e#1|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#_k0#0| Int) (|$ih#c0#0| T@U) (|$ih#d0#0| T@U) (|$ih#e0#0| T@U) ) (!  (=> (and (and (and (and (and (<= (LitInt 0) |$ih#_k0#0|) ($Is DatatypeTypeType |$ih#c0#0| Tclass._module.ClEnv)) ($Is DatatypeTypeType |$ih#d0#0| Tclass._module.ClEnv)) ($Is DatatypeTypeType |$ih#e0#0| Tclass._module.ClEnv)) (and (_module.__default.ClEnvBelow ($LS $LZ) |$ih#c0#0| |$ih#d0#0|) (_module.__default.ClEnvBelow ($LS $LZ) |$ih#d0#0| |$ih#e0#0|))) (and (<= 0 |$ih#_k0#0|) (< |$ih#_k0#0| |_k#0@@13|))) (_module.__default.ClEnvBelow_h ($LS $LZ) |$ih#_k0#0| |$ih#c0#0| |$ih#e0#0|))
 :qid |KozenSilvadfy.188:16|
 :skolemid |757|
 :pattern ( (_module.__default.ClEnvBelow_h ($LS $LZ) |$ih#_k0#0| |$ih#c0#0| |$ih#e0#0|) (_module.__default.ClEnvBelow ($LS $LZ) |$ih#d0#0| |$ih#e0#0|))
 :pattern ( (_module.__default.ClEnvBelow_h ($LS $LZ) |$ih#_k0#0| |$ih#c0#0| |$ih#e0#0|) (_module.__default.ClEnvBelow ($LS $LZ) |$ih#c0#0| |$ih#d0#0|))
))))) (and (=> (= (ControlFlow 0 15) 14) anon5_Then_correct) (=> (= (ControlFlow 0 15) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |_k#0@@13|)) (=> (and (and (and ($Is DatatypeTypeType |c#1| Tclass._module.ClEnv) ($IsAlloc DatatypeTypeType |c#1| Tclass._module.ClEnv $Heap)) (|$IsA#_module.ClEnv| |c#1|)) (and (and ($Is DatatypeTypeType |d#1| Tclass._module.ClEnv) ($IsAlloc DatatypeTypeType |d#1| Tclass._module.ClEnv $Heap)) (|$IsA#_module.ClEnv| |d#1|))) (=> (and (and (and (and (and ($Is DatatypeTypeType |e#1| Tclass._module.ClEnv) ($IsAlloc DatatypeTypeType |e#1| Tclass._module.ClEnv $Heap)) (|$IsA#_module.ClEnv| |e#1|)) (= 4 $FunctionContextHeight)) (and (|_module.__default.ClEnvBelow#canCall| |c#1| |d#1|) (and (_module.__default.ClEnvBelow ($LS $LZ) |c#1| |d#1|) (forall ((|y#6| T@U) ) (!  (=> ($IsBox |y#6| Tclass._module.Var) (and (=> (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |c#1|)) |y#6|) (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |d#1|)) |y#6|)) (=> (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |c#1|)) |y#6|) (_module.__default.ValBelow ($LS $LZ) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |c#1|)) |y#6|)) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |d#1|)) |y#6|))))))
 :qid |KozenSilvadfy.180:10|
 :skolemid |750|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |d#1|)) |y#6|)))
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |c#1|)) |y#6|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |d#1|)) |y#6|))
 :pattern ( (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |c#1|)) |y#6|))
))))) (and (and (|_module.__default.ClEnvBelow#canCall| |d#1| |e#1|) (and (_module.__default.ClEnvBelow ($LS $LZ) |d#1| |e#1|) (forall ((|y#7| T@U) ) (!  (=> ($IsBox |y#7| Tclass._module.Var) (and (=> (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |d#1|)) |y#7|) (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |e#1|)) |y#7|)) (=> (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |d#1|)) |y#7|) (_module.__default.ValBelow ($LS $LZ) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |d#1|)) |y#7|)) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |e#1|)) |y#7|))))))
 :qid |KozenSilvadfy.180:10|
 :skolemid |753|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |e#1|)) |y#7|)))
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |d#1|)) |y#7|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |e#1|)) |y#7|))
 :pattern ( (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |d#1|)) |y#7|))
