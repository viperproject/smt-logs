...
(assert  (and (and (and (= (Ctor MapType) 5) (forall ((t0@@1 T@T) (t1 T@T) (val T@U) (m@@1 T@U) (x0 T@U) ) (! (= (MapType0Select t0@@1 t1 (MapType0Store t0@@1 t1 m@@1 x0 val) x0) val)
 :qid |mapAx0:MapType0Select|
 :weight 0
))) (forall ((u0 T@T) (u1 T@T) (val@@0 T@U) (m@@2 T@U) (x0@@0 T@U) (y0 T@U) ) (!  (or (= x0@@0 y0) (= (MapType0Select u0 u1 (MapType0Store u0 u1 m@@2 x0@@0 val@@0) y0) (MapType0Select u0 u1 m@@2 y0)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#16| |l#0| |l#1| |l#2| |l#3|) $o $f))  (=> (and (or (not (= $o |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |548|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#16| |l#0| |l#1| |l#2| |l#3|) $o $f))
)))
...
(declare-fun |x#0| () Int)
(set-info :boogie-vc-id Impl$$_module.__default.NonemptyMap)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#16| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= (|Map#Card| |s#0|) 0)) (not true)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |s#0| (TMap TInt TBool)) ($IsAlloc MapType |s#0| (TMap TInt TBool) $Heap)) (= 0 $FunctionContextHeight)) (and (|Set#IsMember| (|Map#Domain| |s#0|) ($Box intType (int_2_U |x#0|))) (= (ControlFlow 0 3) 2))) anon0_correct))))
