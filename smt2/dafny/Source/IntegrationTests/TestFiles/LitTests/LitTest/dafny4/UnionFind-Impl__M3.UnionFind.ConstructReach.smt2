...
(declare-fun |next#1_0_0@0| () T@U)
(declare-fun $Heap@0 () T@U)
(declare-fun |let#1_0_0#0#0| () T@U)
(declare-fun |d##1_0_0@0| () Int)
(declare-fun |td#0| () Int)
(declare-fun |tt#0| () T@U)
(declare-fun |tm#0| () T@U)
(declare-fun $Heap@2 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |_mcc#0#1_1_0@0| () Int)
(declare-fun $Heap@1 () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun $Heap () T@U)
(set-info :boogie-vc-id Impl$$M3.UnionFind.ConstructReach)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 34) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (=> false (=> (|M3.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |e#0@@3|)))) (= |e#0@@3| |r#0@@3|)))))) (=> (=> false (=> (|M3.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |e#0@@3|)))) (= |e#0@@3| |r#0@@3|))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> false (=> (|M3.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (=> (not (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |e#0@@3|))))) (or (not (= |d#0@@3| 0)) (not true))))))) (=> (=> false (=> (|M3.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (=> (not (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |e#0@@3|))))) (or (not (= |d#0@@3| 0)) (not true)))))) (=> (= (ControlFlow 0 3) (- 0 2)) (=> false (=> (|M3.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (=> (not (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |e#0@@3|))))) (let ((|next#10| (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |e#0@@3|))))))
(M3.UnionFind.Reaches ($LS ($LS $LZ)) this@@3 (- |d#0@@3| 1) |next#10| |r#0@@3| |C'#0|)))))))))))))
(let ((anon8_Then_correct  (=> (and (and (= ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|))) (|#M3.Contents.Link| |_mcc#1#1_0_0@0|)) ($Is refType |_mcc#1#1_0_0@0| Tclass.M3.Element)) (and ($Is refType |next#1_0_0@0| Tclass.M3.Element) ($IsAlloc refType |next#1_0_0@0| Tclass.M3.Element $Heap@0))) (=> (and (and (and (= |let#1_0_0#0#0| |_mcc#1#1_0_0@0|) ($Is refType |let#1_0_0#0#0| Tclass.M3.Element)) (and (= |next#1_0_0@0| |let#1_0_0#0#0|) ($Is intType (int_2_U (- |d#0@@3| 1)) Tclass._System.nat))) (and (and (= |d##1_0_0@0| (- |d#0@@3| 1)) (or (<= 0 |d#0@@3|) (= |d##1_0_0@0| |d#0@@3|))) (and (or (or (or (or (or (<= 0 |td#0|) (< |d##1_0_0@0| |d#0@@3|)) (and (= |next#1_0_0@0| null) (or (not (= |e#0@@3| null)) (not true)))) (and (= |r#0@@3| null) (or (not (= |r#0@@3| null)) (not true)))) (and (|Set#Subset| (|Map#Domain| |C#0@@5|) (|Map#Domain| |C#0@@5|)) (not (|Set#Subset| (|Map#Domain| |C#0@@5|) (|Map#Domain| |C#0@@5|))))) (= |td#0| |td#0|)) (or (< |d##1_0_0@0| |d#0@@3|) (and (= |d##1_0_0@0| |d#0@@3|) (or (and (= |next#1_0_0@0| null) (or (not (= |e#0@@3| null)) (not true))) (and (=  (or (not (= |next#1_0_0@0| null)) (not true))  (or (not (= |e#0@@3| null)) (not true))) (or (and (= |r#0@@3| null) (or (not (= |r#0@@3| null)) (not true))) (and (=  (or (not (= |r#0@@3| null)) (not true))  (or (not (= |r#0@@3| null)) (not true))) (or (and (|Set#Subset| (|Map#Domain| |C#0@@5|) (|Map#Domain| |C#0@@5|)) (not (|Set#Subset| (|Map#Domain| |C#0@@5|) (|Map#Domain| |C#0@@5|)))) (and (|Set#Equal| (|Map#Domain| |C#0@@5|) (|Map#Domain| |C#0@@5|)) (or (< |td#0| |td#0|) (and (= |td#0| |td#0|) (or (and (= |tt#0| null) (or (not (= |tt#0| null)) (not true))) (and (=  (or (not (= |tt#0| null)) (not true))  (or (not (= |tt#0| null)) (not true))) (or (and (= |tm#0| null) (or (not (= |tm#0| null)) (not true))) (and (=  (or (not (= |tm#0| null)) (not true))  (or (not (= |tm#0| null)) (not true))) (and (|Set#Subset| (|Map#Domain| |C'#0|) (|Map#Domain| |C'#0|)) (not (|Set#Subset| (|Map#Domain| |C'#0|) (|Map#Domain| |C'#0|))))))))))))))))))))) (and (=> (= (ControlFlow 0 16) (- 0 30)) (=> (|M3.__default.GoodCMap#canCall| |C#0@@5|) (or (M3.__default.GoodCMap |C#0@@5|) (forall ((|f#3| T@U) ) (!  (=> ($Is refType |f#3| Tclass.M3.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |f#3|)) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#3|))))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#3|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |3353|
...
)))) (and (=> (= (ControlFlow 0 16) (- 0 29)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |next#1_0_0@0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |next#1_0_0@0|)) (and (=> (= (ControlFlow 0 16) (- 0 28)) (=> (|M3.UnionFind.Reaches#canCall| this@@3 |d##1_0_0@0| |next#1_0_0@0| |r#0@@3| |C#0@@5|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d##1_0_0@0| |next#1_0_0@0| |r#0@@3| |C#0@@5|) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |next#1_0_0@0|)))) (= |next#1_0_0@0| |r#0@@3|))))) (=> (=> (|M3.UnionFind.Reaches#canCall| this@@3 |d##1_0_0@0| |next#1_0_0@0| |r#0@@3| |C#0@@5|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d##1_0_0@0| |next#1_0_0@0| |r#0@@3| |C#0@@5|) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |next#1_0_0@0|)))) (= |next#1_0_0@0| |r#0@@3|)))) (and (=> (= (ControlFlow 0 16) (- 0 27)) (=> (|M3.UnionFind.Reaches#canCall| this@@3 |d##1_0_0@0| |next#1_0_0@0| |r#0@@3| |C#0@@5|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d##1_0_0@0| |next#1_0_0@0| |r#0@@3| |C#0@@5|) (=> (not (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |next#1_0_0@0|))))) (or (not (= |d##1_0_0@0| 0)) (not true)))))) (=> (=> (|M3.UnionFind.Reaches#canCall| this@@3 |d##1_0_0@0| |next#1_0_0@0| |r#0@@3| |C#0@@5|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d##1_0_0@0| |next#1_0_0@0| |r#0@@3| |C#0@@5|) (=> (not (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |next#1_0_0@0|))))) (or (not (= |d##1_0_0@0| 0)) (not true))))) (and (=> (= (ControlFlow 0 16) (- 0 26)) (=> (|M3.UnionFind.Reaches#canCall| this@@3 |d##1_0_0@0| |next#1_0_0@0| |r#0@@3| |C#0@@5|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d##1_0_0@0| |next#1_0_0@0| |r#0@@3| |C#0@@5|) (=> (not (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |next#1_0_0@0|))))) (let ((|next#0@@0| (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |next#1_0_0@0|))))))
(M3.UnionFind.Reaches ($LS ($LS $LZ)) this@@3 (- |d##1_0_0@0| 1) |next#0@@0| |r#0@@3| |C#0@@5|)))))) (=> (=> (|M3.UnionFind.Reaches#canCall| this@@3 |d##1_0_0@0| |next#1_0_0@0| |r#0@@3| |C#0@@5|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d##1_0_0@0| |next#1_0_0@0| |r#0@@3| |C#0@@5|) (=> (not (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |next#1_0_0@0|))))) (let ((|next#0@@1| (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |next#1_0_0@0|))))))
(M3.UnionFind.Reaches ($LS ($LS $LZ)) this@@3 (- |d##1_0_0@0| 1) |next#0@@1| |r#0@@3| |C#0@@5|))))) (and (=> (= (ControlFlow 0 16) (- 0 25)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |tt#0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |tt#0|)) (and (=> (= (ControlFlow 0 16) (- 0 24)) (=> (|M3.UnionFind.Reaches#canCall| this@@3 |td#0| |tt#0| |tm#0| |C#0@@5|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |td#0| |tt#0| |tm#0| |C#0@@5|) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |tt#0|)))) (= |tt#0| |tm#0|))))) (=> (=> (|M3.UnionFind.Reaches#canCall| this@@3 |td#0| |tt#0| |tm#0| |C#0@@5|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |td#0| |tt#0| |tm#0| |C#0@@5|) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |tt#0|)))) (= |tt#0| |tm#0|)))) (and (=> (= (ControlFlow 0 16) (- 0 23)) (=> (|M3.UnionFind.Reaches#canCall| this@@3 |td#0| |tt#0| |tm#0| |C#0@@5|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |td#0| |tt#0| |tm#0| |C#0@@5|) (=> (not (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |tt#0|))))) (or (not (= |td#0| 0)) (not true)))))) (=> (=> (|M3.UnionFind.Reaches#canCall| this@@3 |td#0| |tt#0| |tm#0| |C#0@@5|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |td#0| |tt#0| |tm#0| |C#0@@5|) (=> (not (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |tt#0|))))) (or (not (= |td#0| 0)) (not true))))) (and (=> (= (ControlFlow 0 16) (- 0 22)) (=> (|M3.UnionFind.Reaches#canCall| this@@3 |td#0| |tt#0| |tm#0| |C#0@@5|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |td#0| |tt#0| |tm#0| |C#0@@5|) (=> (not (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |tt#0|))))) (let ((|next#2@@0| (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |tt#0|))))))
...
(M3.UnionFind.Reaches ($LS ($LS $LZ)) this@@3 (- |td#0| 1) |next#2@@1| |tm#0| |C#0@@5|))))) (and (=> (= (ControlFlow 0 16) (- 0 21)) (|Map#Equal| |C'#0| (|Map#Build| |C#0@@5| ($Box refType |tt#0|) ($Box DatatypeTypeType (|#M3.Contents.Link| |tm#0|))))) (=> (|Map#Equal| |C'#0| (|Map#Build| |C#0@@5| ($Box refType |tt#0|) ($Box DatatypeTypeType (|#M3.Contents.Link| |tm#0|)))) (and (=> (= (ControlFlow 0 16) (- 0 20)) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |tt#0|))))) (=> (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |tt#0|)))) (and (=> (= (ControlFlow 0 16) (- 0 19)) (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |tm#0|))) (=> (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |tm#0|)) (and (=> (= (ControlFlow 0 16) (- 0 18)) (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |tm#0|))))) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |tm#0|)))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (=> (|M3.__default.GoodCMap#canCall| |C'#0|) (or (M3.__default.GoodCMap |C'#0|) (forall ((|f#4| T@U) ) (!  (=> ($Is refType |f#4| Tclass.M3.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |f#4|)) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#4|))))) (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#4|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |3355|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#4|))))
))))) (=> (=> (|M3.__default.GoodCMap#canCall| |C'#0|) (or (M3.__default.GoodCMap |C'#0|) (forall ((|f#4@@0| T@U) ) (!  (=> ($Is refType |f#4@@0| Tclass.M3.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |f#4@@0|)) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#4@@0|))))) (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#4@@0|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |3355|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#4@@0|))))
)))) (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (|M3.UnionFind.Reaches#canCall| this@@3 |d##1_0_0@0| |next#1_0_0@0| |r#0@@3| |C'#0|)) (and (and (|M3.UnionFind.Reaches#canCall| this@@3 |d##1_0_0@0| |next#1_0_0@0| |r#0@@3| |C'#0|) (and (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d##1_0_0@0| |next#1_0_0@0| |r#0@@3| |C'#0|) (ite (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |next#1_0_0@0|)))) (= |next#1_0_0@0| |r#0@@3|) (let ((|next#5@@0| (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |next#1_0_0@0|))))))
 (and (or (not (= |d##1_0_0@0| 0)) (not true)) (M3.UnionFind.Reaches ($LS $LZ) this@@3 (- |d##1_0_0@0| 1) |next#5@@0| |r#0@@3| |C'#0|)))))) (and (= $Heap@0 $Heap@2) (= (ControlFlow 0 16) 3)))) GeneratedUnifiedExit_correct)))))))))))))))))))))))))))))))))
(let ((anon7_Then_correct  (=> (= ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|))) (|#M3.Contents.Root| |_mcc#0#1_1_0@0|)) (=> (and (<= (LitInt 0) |_mcc#0#1_1_0@0|) (= (ControlFlow 0 15) 3)) GeneratedUnifiedExit_correct))))
(let ((anon6_Then_correct  (=> (= |e#0@@3| |tt#0|) (and (=> (= (ControlFlow 0 6) (- 0 14)) (=> (|M3.__default.GoodCMap#canCall| |C#0@@5|) (or (M3.__default.GoodCMap |C#0@@5|) (forall ((|f#2| T@U) ) (!  (=> ($Is refType |f#2| Tclass.M3.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |f#2|)) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#2|))))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#2|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |3240|
...
)))) (and (=> (= (ControlFlow 0 6) (- 0 13)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|)) (and (=> (= (ControlFlow 0 6) (- 0 12)) (=> (|M3.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|)))) (= |e#0@@3| |r#0@@3|))))) (=> (=> (|M3.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|)))) (= |e#0@@3| |r#0@@3|)))) (and (=> (= (ControlFlow 0 6) (- 0 11)) (=> (|M3.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|) (=> (not (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|))))) (or (not (= |d#0@@3| 0)) (not true)))))) (=> (=> (|M3.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|) (=> (not (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|))))) (or (not (= |d#0@@3| 0)) (not true))))) (and (=> (= (ControlFlow 0 6) (- 0 10)) (=> (|M3.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|) (=> (not (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|))))) (let ((|next#0@@2| (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|))))))
(M3.UnionFind.Reaches ($LS ($LS $LZ)) this@@3 (- |d#0@@3| 1) |next#0@@2| |r#0@@3| |C#0@@5|)))))) (=> (=> (|M3.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|) (=> (not (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|))))) (let ((|next#0@@3| (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|))))))
(M3.UnionFind.Reaches ($LS ($LS $LZ)) this@@3 (- |d#0@@3| 1) |next#0@@3| |r#0@@3| |C#0@@5|))))) (and (=> (= (ControlFlow 0 6) (- 0 9)) (=> (|M3.UnionFind.Reaches#canCall| this@@3 |td#0| |e#0@@3| |tm#0| |C#0@@5|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |td#0| |e#0@@3| |tm#0| |C#0@@5|) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|)))) (= |e#0@@3| |tm#0|))))) (=> (=> (|M3.UnionFind.Reaches#canCall| this@@3 |td#0| |e#0@@3| |tm#0| |C#0@@5|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |td#0| |e#0@@3| |tm#0| |C#0@@5|) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|)))) (= |e#0@@3| |tm#0|)))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (=> (|M3.UnionFind.Reaches#canCall| this@@3 |td#0| |e#0@@3| |tm#0| |C#0@@5|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |td#0| |e#0@@3| |tm#0| |C#0@@5|) (=> (not (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|))))) (or (not (= |td#0| 0)) (not true)))))) (=> (=> (|M3.UnionFind.Reaches#canCall| this@@3 |td#0| |e#0@@3| |tm#0| |C#0@@5|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |td#0| |e#0@@3| |tm#0| |C#0@@5|) (=> (not (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|))))) (or (not (= |td#0| 0)) (not true))))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (=> (|M3.UnionFind.Reaches#canCall| this@@3 |td#0| |e#0@@3| |tm#0| |C#0@@5|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |td#0| |e#0@@3| |tm#0| |C#0@@5|) (=> (not (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|))))) (let ((|next#2@@2| (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|))))))
(M3.UnionFind.Reaches ($LS ($LS $LZ)) this@@3 (- |td#0| 1) |next#2@@2| |tm#0| |C#0@@5|)))))) (=> (=> (|M3.UnionFind.Reaches#canCall| this@@3 |td#0| |e#0@@3| |tm#0| |C#0@@5|) (or (M3.UnionFind.Reaches ($LS $LZ) this@@3 |td#0| |e#0@@3| |tm#0| |C#0@@5|) (=> (not (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|))))) (let ((|next#2@@3| (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|))))))
(M3.UnionFind.Reaches ($LS ($LS $LZ)) this@@3 (- |td#0| 1) |next#2@@3| |tm#0| |C#0@@5|))))) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= |r#0@@3| |tm#0|)) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 6) 3))) GeneratedUnifiedExit_correct))))))))))))))))))))
(let ((anon8_Else_correct true))
(let ((anon7_Else_correct  (=> (or (not (= ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|))) (|#M3.Contents.Root| |_mcc#0#1_1_0@0|))) (not true)) (and (=> (= (ControlFlow 0 31) 16) anon8_Then_correct) (=> (= (ControlFlow 0 31) 1) anon8_Else_correct)))))
(let ((anon6_Else_correct  (=> (and (or (not (= |e#0@@3| |tt#0|)) (not true)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|))) (and (=> (= (ControlFlow 0 32) 15) anon7_Then_correct) (=> (= (ControlFlow 0 32) 31) anon7_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#d0#0| Int) (|$ih#e0#0| T@U) (|$ih#r0#0| T@U) (|$ih#C0#0| T@U) (|$ih#td0#0| Int) (|$ih#tt0#0| T@U) (|$ih#tm0#0| T@U) (|$ih#C'0#0| T@U) ) (!  (=> (and (and (and (and (and (and (and (and (and (<= (LitInt 0) |$ih#d0#0|) ($Is refType |$ih#e0#0| Tclass.M3.Element)) ($Is refType |$ih#r0#0| Tclass.M3.Element)) ($Is MapType |$ih#C0#0| (TMap Tclass.M3.Element Tclass.M3.Contents))) (<= (LitInt 0) |$ih#td0#0|)) ($Is refType |$ih#tt0#0| Tclass.M3.Element)) ($Is refType |$ih#tm0#0| Tclass.M3.Element)) ($Is MapType |$ih#C'0#0| (TMap Tclass.M3.Element Tclass.M3.Contents))) (and (and (and (and (and (M3.__default.GoodCMap |$ih#C0#0|) (|Set#IsMember| (|Map#Domain| |$ih#C0#0|) ($Box refType |$ih#e0#0|))) (M3.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#d0#0| |$ih#e0#0| |$ih#r0#0| |$ih#C0#0|)) (and (|Set#IsMember| (|Map#Domain| |$ih#C0#0|) ($Box refType |$ih#tt0#0|)) (M3.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#td0#0| |$ih#tt0#0| |$ih#tm0#0| |$ih#C0#0|))) (and (and (and (|Map#Equal| |$ih#C'0#0| (|Map#Build| |$ih#C0#0| ($Box refType |$ih#tt0#0|) ($Box DatatypeTypeType (|#M3.Contents.Link| |$ih#tm0#0|)))) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |$ih#C'0#0|) ($Box refType |$ih#tt0#0|))))) (|Set#IsMember| (|Map#Domain| |$ih#C'0#0|) ($Box refType |$ih#tm0#0|))) (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |$ih#C'0#0|) ($Box refType |$ih#tm0#0|)))))) (M3.__default.GoodCMap |$ih#C'0#0|))) (or (and (<= 0 |$ih#d0#0|) (< |$ih#d0#0| |d#0@@3|)) (and (= |$ih#d0#0| |d#0@@3|) (or (and (= |$ih#e0#0| null) (or (not (= |e#0@@3| null)) (not true))) (and (=  (or (not (= |$ih#e0#0| null)) (not true))  (or (not (= |e#0@@3| null)) (not true))) (or (and (= |$ih#r0#0| null) (or (not (= |r#0@@3| null)) (not true))) (and (=  (or (not (= |$ih#r0#0| null)) (not true))  (or (not (= |r#0@@3| null)) (not true))) (or (and (|Set#Subset| (|Map#Domain| |$ih#C0#0|) (|Map#Domain| |C#0@@5|)) (not (|Set#Subset| (|Map#Domain| |C#0@@5|) (|Map#Domain| |$ih#C0#0|)))) (and (|Set#Equal| (|Map#Domain| |$ih#C0#0|) (|Map#Domain| |C#0@@5|)) (or (and (<= 0 |$ih#td0#0|) (< |$ih#td0#0| |td#0|)) (and (= |$ih#td0#0| |td#0|) (or (and (= |$ih#tt0#0| null) (or (not (= |tt#0| null)) (not true))) (and (=  (or (not (= |$ih#tt0#0| null)) (not true))  (or (not (= |tt#0| null)) (not true))) (or (and (= |$ih#tm0#0| null) (or (not (= |tm#0| null)) (not true))) (and (=  (or (not (= |$ih#tm0#0| null)) (not true))  (or (not (= |tm#0| null)) (not true))) (and (|Set#Subset| (|Map#Domain| |$ih#C'0#0|) (|Map#Domain| |C'#0|)) (not (|Set#Subset| (|Map#Domain| |C'#0|) (|Map#Domain| |$ih#C'0#0|))))))))))))))))))) (M3.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#d0#0| |$ih#e0#0| |$ih#r0#0| |$ih#C'0#0|))
 :qid |UnionFinddfy.181:49|
 :skolemid |3361|
 :pattern ( (M3.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#d0#0| |$ih#e0#0| |$ih#r0#0| |$ih#C'0#0|) (M3.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#td0#0| |$ih#tt0#0| |$ih#tm0#0| |$ih#C0#0|))
 :pattern ( (M3.__default.GoodCMap |$ih#C'0#0|) (M3.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#td0#0| |$ih#tt0#0| |$ih#tm0#0| |$ih#C0#0|) (M3.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#d0#0| |$ih#e0#0| |$ih#r0#0| |$ih#C0#0|))
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |$ih#C'0#0|) ($Box refType |$ih#tt0#0|))) (M3.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#td0#0| |$ih#tt0#0| |$ih#tm0#0| |$ih#C0#0|) (M3.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#d0#0| |$ih#e0#0| |$ih#r0#0| |$ih#C0#0|))
)))) (and (=> (= (ControlFlow 0 33) 6) anon6_Then_correct) (=> (= (ControlFlow 0 33) 32) anon6_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.M3.UnionFind) ($IsAlloc refType this@@3 Tclass.M3.UnionFind $Heap))) (<= (LitInt 0) |d#0@@3|)) (and (and ($Is refType |e#0@@3| Tclass.M3.Element) ($IsAlloc refType |e#0@@3| Tclass.M3.Element $Heap)) (and ($Is refType |r#0@@3| Tclass.M3.Element) ($IsAlloc refType |r#0@@3| Tclass.M3.Element $Heap)))) (=> (and (and (and (and (and ($Is MapType |C#0@@5| (TMap Tclass.M3.Element Tclass.M3.Contents)) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap)) (<= (LitInt 0) |td#0|)) (and (and ($Is refType |tt#0| Tclass.M3.Element) ($IsAlloc refType |tt#0| Tclass.M3.Element $Heap)) (and ($Is refType |tm#0| Tclass.M3.Element) ($IsAlloc refType |tm#0| Tclass.M3.Element $Heap)))) (and (and (and ($Is MapType |C'#0| (TMap Tclass.M3.Element Tclass.M3.Contents)) ($IsAlloc MapType |C'#0| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap)) (= 6 $FunctionContextHeight)) (and (and (|M3.__default.GoodCMap#canCall| |C#0@@5|) (and (M3.__default.GoodCMap |C#0@@5|) (forall ((|f#5| T@U) ) (!  (=> ($Is refType |f#5| Tclass.M3.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |f#5|)) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#5|))))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#5|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |3358|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#5|))))
)))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|))))) (and (and (and (and (|M3.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|) (and (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|) (ite (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|)))) (= |e#0@@3| |r#0@@3|) (let ((|next#7| (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|))))))
 (and (or (not (= |d#0@@3| 0)) (not true)) (M3.UnionFind.Reaches ($LS $LZ) this@@3 (- |d#0@@3| 1) |next#7| |r#0@@3| |C#0@@5|)))))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |tt#0|))) (and (|M3.UnionFind.Reaches#canCall| this@@3 |td#0| |tt#0| |tm#0| |C#0@@5|) (and (M3.UnionFind.Reaches ($LS $LZ) this@@3 |td#0| |tt#0| |tm#0| |C#0@@5|) (ite (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |tt#0|)))) (= |tt#0| |tm#0|) (let ((|next#9| (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |tt#0|))))))
 (and (or (not (= |td#0| 0)) (not true)) (M3.UnionFind.Reaches ($LS $LZ) this@@3 (- |td#0| 1) |next#9| |tm#0| |C#0@@5|))))))) (and (and (and (|Map#Equal| |C'#0| (|Map#Build| |C#0@@5| ($Box refType |tt#0|) ($Box DatatypeTypeType (|#M3.Contents.Link| |tm#0|)))) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |tt#0|))))) (and (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |tm#0|)) (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |tm#0|)))))) (and (and (|M3.__default.GoodCMap#canCall| |C'#0|) (and (M3.__default.GoodCMap |C'#0|) (forall ((|f#6| T@U) ) (!  (=> ($Is refType |f#6| Tclass.M3.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |f#6|)) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#6|))))) (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#6|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |3360|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#6|))))
