...
(assert (forall (($ly@@2 T@U) (|t#0@@2| T@U) ) (! (= (_module.__default.Elements ($LS $ly@@2) |t#0@@2|) (_module.__default.Elements $ly@@2 |t#0@@2|))
 :qid |Regression16dfy.17:16|
 :skolemid |537|
...
(let ((anon10_Then_correct  (=> (= |t#0@@3| (|#_module.Tree.Node| |_mcc#0#0| |_mcc#1#0| |_mcc#2#0|)) (=> (and (and ($Is DatatypeTypeType |_mcc#1#0| Tclass._module.Tree) ($Is DatatypeTypeType |_mcc#2#0| Tclass._module.Tree)) (and (= |let#0#0#0| |_mcc#2#0|) ($Is DatatypeTypeType |let#0#0#0| Tclass._module.Tree))) (=> (and (and (and (= |right#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#1#0|)) (and ($Is DatatypeTypeType |let#1#0#0| Tclass._module.Tree) (= |left#Z#0@0| |let#1#0#0|))) (and (and (= |let#2#0#0| |_mcc#0#0|) ($Is intType (int_2_U |let#2#0#0|) TInt)) (and (= |x#Z#0@0| |let#2#0#0|) ($IsAlloc DatatypeTypeType |left#Z#0@0| Tclass._module.Tree $Heap)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< (DtRank |left#Z#0@0|) (DtRank |t#0@@3|))) (=> (< (DtRank |left#Z#0@0|) (DtRank |t#0@@3|)) (=> (|_module.__default.Elements#canCall| |left#Z#0@0|) (=> (and ($IsAlloc DatatypeTypeType |right#Z#0@0| Tclass._module.Tree $Heap) (= (ControlFlow 0 4) (- 0 3))) (< (DtRank |right#Z#0@0|) (DtRank |t#0@@3|)))))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |t#0@@3| Tclass._module.Tree)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct)))
