...
(set-info :boogie-vc-id Impl$$_module.__default.mult__lemma_split3)
...
))) (and (and true (= |#_module.Nat.O| |a#0_0_0_1@@0|)) (exists ((|a#0_0_0_5#0#0| T@U) ) (!  (and ($Is DatatypeTypeType |a#0_0_0_5#0#0| Tclass._module.Nat) (= (|#_module.Nat.S| |a#0_0_0_5#0#0|) |b#0_0_0_1@@0|))
 :qid |SoftwareFoundationsBasicsdfy.138:7|
 :skolemid |705|
