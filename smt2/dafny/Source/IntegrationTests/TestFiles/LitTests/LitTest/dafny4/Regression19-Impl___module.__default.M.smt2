...
(assert (forall ((a@@6 T@U) (b@@3 T@U) (t0@@1 T@U) (t1@@1 T@U) ) (!  (=> (forall ((bx T@U) )  (=> (|Set#IsMember| a@@6 bx) (and ($IsBox bx t0@@1) ($IsBox (MapType1Select BoxType BoxType b@@3 bx) t1@@1)))) ($Is MapType (|Map#Glue| a@@6 b@@3 (TMap t0@@1 t1@@1)) (TMap t0@@1 t1@@1)))
