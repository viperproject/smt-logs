...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.LeastSignificantDigitIsAlmostMod__Neg)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and ($IsAlloc SeqType |a#0| (TSeq TInt) $Heap) ($IsAlloc intType (int_2_U |lowDigit#0@@1|) TInt $Heap)) (=> (and (and ($IsAlloc intType (int_2_U |base#0@@5|) TInt $Heap) (|_module.__default.IsSkewNumber#canCall| |a#0| |lowDigit#0@@1| |base#0@@5|)) (and (_module.__default.IsSkewNumber |a#0| |lowDigit#0@@1| |base#0@@5|) (not (|Seq#Equal| |a#0| |Seq#Empty|)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |a#0|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |a#0|))) (=> (< (U_2_int ($Unbox intType (|Seq#Index| |a#0| (LitInt 0)))) 0) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and ($IsAlloc SeqType |a#0| (TSeq TInt) $Heap@0) ($IsAlloc intType (int_2_U |base#0@@5|) TInt $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= (LitInt 2) |base#0@@5|)) (=> (and (<= (LitInt 2) |base#0@@5|) (|_module.__default.eval#canCall| |a#0| |base#0@@5|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |base#0@@5| 0)) (not true))) (=> (or (not (= |base#0@@5| 0)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |a#0|)))))))))))))))))
