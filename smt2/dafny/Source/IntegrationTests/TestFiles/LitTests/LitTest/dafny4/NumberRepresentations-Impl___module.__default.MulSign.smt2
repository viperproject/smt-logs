...
(set-info :boogie-vc-id Impl$$_module.__default.MulSign)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (or (<= |x#0| (LitInt 0)) (<= |y#0| (LitInt 0))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 0 $FunctionContextHeight)) (and (<= (Mul |x#0| |y#0|) (LitInt 0)) (= (ControlFlow 0 3) 2))) anon0_correct)))
