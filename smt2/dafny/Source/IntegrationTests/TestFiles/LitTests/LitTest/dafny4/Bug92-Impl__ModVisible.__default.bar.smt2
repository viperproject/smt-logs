...
(set-info :boogie-vc-id Impl$$ModVisible.__default.bar)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) ($IsAlloc intType (int_2_U |x#0@@5|) TInt $Heap)) (and (|ModVisible.__default.Visible#canCall| |x#0@@5|) (_System.Tuple2.___hMake2_q (ModVisible.__default.Visible |x#0@@5|)))) (and (and (|$IsA#_System.Tuple2| (ModVisible.__default.Visible |x#0@@5|)) (|ModVisible.__default.Visible#canCall| |x#0@@5|)) (= (ControlFlow 0 2) (- 0 1)))) (|_System.Tuple2#Equal| (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |y#0|)) ($Box intType (int_2_U |z#0|))) (ModVisible.__default.Visible |x#0@@5|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (= 2 $FunctionContextHeight) (= |y#0| (U_2_int ($Unbox intType (_System.Tuple2._0 (ModVisible.__default.Visible |x#0@@5|)))))) (and (= |z#0| (U_2_int ($Unbox intType (_System.Tuple2._1 (ModVisible.__default.Visible |x#0@@5|))))) (= (ControlFlow 0 3) 2))) anon0_correct))))
