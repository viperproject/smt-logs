...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|s#0@@0| T@U) (|bound#0@@0| Int) ) (!  (=> (or (|_module.__default.AllPrimes#canCall| |s#0@@0| |bound#0@@0|) (and (< 1 $FunctionContextHeight) ($Is SetType |s#0@@0| (TSet TInt)))) (and (and (forall ((|x#0@@0| Int) ) (!  (=> (|Set#IsMember| |s#0@@0| ($Box intType (int_2_U |x#0@@0|))) (|_module.__default.IsPrime#canCall| |x#0@@0|))
 :qid |Primesdfy.36:11|
 :skolemid |556|
 :pattern ( (_module.__default.IsPrime |x#0@@0|))
 :pattern ( (|Set#IsMember| |s#0@@0| ($Box intType (int_2_U |x#0@@0|))))
)) (=> (forall ((|x#0@@1| Int) ) (!  (=> (|Set#IsMember| |s#0@@0| ($Box intType (int_2_U |x#0@@1|))) (_module.__default.IsPrime |x#0@@1|))
 :qid |Primesdfy.36:11|
 :skolemid |558|
...
)))) (= (_module.__default.AllPrimes |s#0@@0| |bound#0@@0|)  (and (forall ((|x#0@@2| Int) ) (!  (=> (|Set#IsMember| |s#0@@0| ($Box intType (int_2_U |x#0@@2|))) (_module.__default.IsPrime |x#0@@2|))
 :qid |Primesdfy.36:11|
 :skolemid |554|
 :pattern ( (_module.__default.IsPrime |x#0@@2|))
 :pattern ( (|Set#IsMember| |s#0@@0| ($Box intType (int_2_U |x#0@@2|))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (|s#0@@1| T@U) ) (!  (=> (or (|_module.__default.PickLargest#canCall| |s#0@@1|) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) ($Is SetType |s#0@@1| (TSet TInt))) (not (|Set#Equal| |s#0@@1| |Set#Empty|))))) (and (|$let#0$canCall| |s#0@@1|) (= (_module.__default.PickLargest true |s#0@@1|) (let ((|x#0@@3| (|$let#0_x| |s#0@@1|)))
|x#0@@3|))))
...
(declare-fun $Heap@@1 () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.ProductPlusOneIsPrime)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 33) (let ((anon18_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 24)) (|Set#IsMember| |s#0@@7| ($Box intType (int_2_U |m#1_0@0|)))) (=> (|Set#IsMember| |s#0@@7| ($Box intType (int_2_U |m#1_0@0|))) (and (=> (= (ControlFlow 0 15) (- 0 23)) (|Set#IsMember| |s#0@@7| ($Box intType (int_2_U |m#1_0@0|)))) (=> (|Set#IsMember| |s#0@@7| ($Box intType (int_2_U |m#1_0@0|))) (=> (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (=> (and (and (and (and (|_module.__default.product#canCall| |s#0@@7|) (|_module.__default.product#canCall| (|Set#Difference| |s#0@@7| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U |m#1_0@0|)))))) (= (_module.__default.product ($LS ($LS $LZ)) reveal__module._default.product |s#0@@7|) (Mul |m#1_0@0| (_module.__default.product ($LS ($LS $LZ)) reveal__module._default.product (|Set#Difference| |s#0@@7| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U |m#1_0@0|)))))))) (and (= $Heap@0 $Heap@3) (= |##s#1_0@0| (|Set#Difference| |s#0@@7| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U |m#1_0@0|))))))) (and (and ($IsAlloc SetType |##s#1_0@0| (TSet TInt) $Heap@3) (|_module.__default.product#canCall| (|Set#Difference| |s#0@@7| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U |m#1_0@0|)))))) (and (|_module.__default.product#canCall| (|Set#Difference| |s#0@@7| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U |m#1_0@0|))))) (= |l#1_0@0| (_module.__default.product ($LS $LZ) reveal__module._default.product (|Set#Difference| |s#0@@7| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U |m#1_0@0|))))))))) (and (=> (= (ControlFlow 0 15) (- 0 22)) (= (Mul |m#1_0@0| |l#1_0@0|) |q#0|)) (=> (= (Mul |m#1_0@0| |l#1_0@0|) |q#0|) (and (=> (= (ControlFlow 0 15) (- 0 21)) ($Is intType (int_2_U |m#1_0@0|) Tclass._System.nat)) (=> ($Is intType (int_2_U |m#1_0@0|) Tclass._System.nat) (and (=> (= (ControlFlow 0 15) (- 0 20)) ($Is intType (int_2_U |l#1_0@0|) Tclass._System.nat)) (=> ($Is intType (int_2_U |l#1_0@0|) Tclass._System.nat) (and (=> (= (ControlFlow 0 15) (- 0 19)) ($Is intType (int_2_U |q#0|) Tclass._System.nat)) (=> ($Is intType (int_2_U |q#0|) Tclass._System.nat) (and (=> (= (ControlFlow 0 15) (- 0 18)) ($Is intType (int_2_U (LitInt 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 1)) Tclass._System.nat) (=> (= |j##1_0@0| (LitInt 1)) (and (=> (= (ControlFlow 0 15) (- 0 17)) (= (Mul |m#1_0@0| |l#1_0@0|) |q#0|)) (=> (= (Mul |m#1_0@0| |l#1_0@0|) |q#0|) (and (=> (= (ControlFlow 0 15) (- 0 16)) (< |j##1_0@0| |m#1_0@0|)) (=> (< |j##1_0@0| |m#1_0@0|) (=> (and (and (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (= (Mod (+ |q#0| |j##1_0@0|) |m#1_0@0|) |j##1_0@0|)) (and (= $Heap@3 $Heap@4) (= (ControlFlow 0 15) (- 0 14)))) (or (not (= (Mod |p#2@0| |m#1_0@0|) 0)) (not true))))))))))))))))))))))))))
(let ((anon18_Then_correct  (=> (= (ControlFlow 0 13) (- 0 12)) (or (not (= |m#1_0@0| 0)) (not true)))))
(let ((anon8_correct  (=> (=> (and (<= (LitInt 2) |m#1_0@0|) (<= |m#1_0@0| |q#0|)) (|_module.__default.IsPrime#canCall| |m#1_0@0|)) (=> (and (and (<= (LitInt 2) |m#1_0@0|) (<= |m#1_0@0| |q#0|)) (_module.__default.IsPrime |m#1_0@0|)) (and (=> (= (ControlFlow 0 25) 13) anon18_Then_correct) (=> (= (ControlFlow 0 25) 15) anon18_Else_correct))))))
(let ((anon17_Else_correct  (=> (and (not (and (<= (LitInt 2) |m#1_0@0|) (<= |m#1_0@0| |q#0|))) (= (ControlFlow 0 27) 25)) anon8_correct)))
(let ((anon17_Then_correct  (=> (and (and (and (<= (LitInt 2) |m#1_0@0|) (<= |m#1_0@0| |q#0|)) ($IsAlloc intType (int_2_U |m#1_0@0|) TInt $Heap@0)) (and (|_module.__default.IsPrime#canCall| |m#1_0@0|) (= (ControlFlow 0 26) 25))) anon8_correct)))
(let ((anon16_Else_correct  (=> (< |m#1_0@0| (LitInt 2)) (and (=> (= (ControlFlow 0 29) 26) anon17_Then_correct) (=> (= (ControlFlow 0 29) 27) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (<= (LitInt 2) |m#1_0@0|) (and (=> (= (ControlFlow 0 28) 26) anon17_Then_correct) (=> (= (ControlFlow 0 28) 27) anon17_Else_correct)))))
(let ((anon15_Then_correct  (and (=> (= (ControlFlow 0 30) 28) anon16_Then_correct) (=> (= (ControlFlow 0 30) 29) anon16_Else_correct))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (=> (|_module.__default.IsPrime#canCall| (+ |q#0| 1)) (_module.__default.IsPrime (+ |q#0| 1))))))
(let ((anon15_Else_correct  (=> (forall ((|m#1_1| Int) ) (!  (=> (and (and (<= (LitInt 2) |m#1_1|) (<= |m#1_1| |q#0|)) (_module.__default.IsPrime |m#1_1|)) (or (not (= (Mod |p#2@0| |m#1_1|) 0)) (not true)))
 :qid |Primesdfy.90:10|
 :skolemid |629|
 :pattern ( (_module.__default.IsPrime |m#1_1|))
)) (=> (and (and (= |##n#1@0| (+ |q#0| 1)) ($IsAlloc intType (int_2_U |##n#1@0|) TInt $Heap@0)) (and (|_module.__default.IsPrime__Alt#canCall| (+ |q#0| 1)) (|_module.__default.IsPrime__Alt#canCall| (+ |q#0| 1)))) (and (=> (= (ControlFlow 0 7) (- 0 11)) (=> (|_module.__default.IsPrime__Alt#canCall| (+ |q#0| 1)) (or (_module.__default.IsPrime__Alt (+ |q#0| 1)) (<= (LitInt 2) (+ |q#0| 1))))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (=> (|_module.__default.IsPrime__Alt#canCall| (+ |q#0| 1)) (or (_module.__default.IsPrime__Alt (+ |q#0| 1)) (forall ((|m#0@@2| Int) ) (!  (=> (and (and (<= (LitInt 2) |m#0@@2|) (< |m#0@@2| (+ |q#0| 1))) (_module.__default.IsPrime |m#0@@2|)) (or (not (= (Mod (+ |q#0| 1) |m#0@@2|) 0)) (not true)))
 :qid |Primesdfy.137:20|
 :skolemid |630|
 :pattern ( (_module.__default.IsPrime |m#0@@2|))
))))) (=> (and (_module.__default.IsPrime__Alt (+ |q#0| 1)) (= |n##0@0| (+ |q#0| 1))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (=> (|_module.__default.IsPrime__Alt#canCall| |n##0@0|) (or (_module.__default.IsPrime__Alt |n##0@0|) (<= (LitInt 2) |n##0@0|)))) (=> (=> (|_module.__default.IsPrime__Alt#canCall| |n##0@0|) (or (_module.__default.IsPrime__Alt |n##0@0|) (<= (LitInt 2) |n##0@0|))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (=> (|_module.__default.IsPrime__Alt#canCall| |n##0@0|) (or (_module.__default.IsPrime__Alt |n##0@0|) (forall ((|m#0@@3| Int) ) (!  (=> (and (and (<= (LitInt 2) |m#0@@3|) (< |m#0@@3| |n##0@0|)) (_module.__default.IsPrime |m#0@@3|)) (or (not (= (Mod |n##0@0| |m#0@@3|) 0)) (not true)))
 :qid |Primesdfy.137:20|
 :skolemid |650|
 :pattern ( (_module.__default.IsPrime |m#0@@3|))
))))) (=> (=> (|_module.__default.IsPrime__Alt#canCall| |n##0@0|) (or (_module.__default.IsPrime__Alt |n##0@0|) (forall ((|m#0@@4| Int) ) (!  (=> (and (and (<= (LitInt 2) |m#0@@4|) (< |m#0@@4| |n##0@0|)) (_module.__default.IsPrime |m#0@@4|)) (or (not (= (Mod |n##0@0| |m#0@@4|) 0)) (not true)))
 :qid |Primesdfy.137:20|
 :skolemid |650|
 :pattern ( (_module.__default.IsPrime |m#0@@4|))
)))) (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (|_module.__default.IsPrime#canCall| |n##0@0|)) (and (and (|_module.__default.IsPrime#canCall| |n##0@0|) (and (_module.__default.IsPrime |n##0@0|) (and (<= (LitInt 2) |n##0@0|) (forall ((|m#1@@2| Int) ) (!  (=> (and (<= (LitInt 2) |m#1@@2|) (< |m#1@@2| |n##0@0|)) (or (not (= (Mod |n##0@0| |m#1@@2|) 0)) (not true)))
 :qid |Primesdfy.6:20|
 :skolemid |653|
 :pattern ( (Mod |n##0@0| |m#1@@2|))
))))) (and (= $Heap@0 $Heap@2) (= (ControlFlow 0 7) 6)))) GeneratedUnifiedExit_correct))))))))))))
(let ((anon14_Else_correct  (=> (=> true (<= (LitInt 2) |p#2@0|)) (and (=> (= (ControlFlow 0 31) 30) anon15_Then_correct) (=> (= (ControlFlow 0 31) 7) anon15_Else_correct)))))
(let ((anon14_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((|x#1@@3| Int) ) (!  (=> (|Set#IsMember| |s#0@@7| ($Box intType (int_2_U |x#1@@3|))) (<= (LitInt 1) |x#1@@3|))
 :qid |Primesdfy.66:19|
 :skolemid |603|
...
)))) (and (<= (LitInt 1) (_module.__default.product ($LS ($LS $LZ)) reveal__module._default.product |s#0@@7|)) (forall ((|x#3@@0| T@U) ) (!  (=> (|Set#IsMember| |s#0@@7| ($Box intType |x#3@@0|)) (<= (U_2_int |x#3@@0|) (_module.__default.product ($LS $LZ) reveal__module._default.product |s#0@@7|)))
 :qid |Primesdfy.67:37|
 :skolemid |606|
 :pattern ( (|Set#IsMember| |s#0@@7| ($Box intType |x#3@@0|)))
)))) (and (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 3) (- 0 2))) (U_2_bool (Lit boolType (bool_2_U true))))) (<= (LitInt 2) |p#2@0|)))))))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@1 $Heap@0)) (and (forall ((|$ih#s0#0| T@U) ) (!  (=> (and (and ($Is SetType |$ih#s0#0| (TSet TInt)) (and (_module.__default.AllPrimes |$ih#s0#0| |q#0|) (= |q#0| (_module.__default.product ($LS $LZ) reveal__module._default.product |$ih#s0#0|)))) (or (and (|Set#Subset| |$ih#s0#0| |s#0@@7|) (not (|Set#Subset| |s#0@@7| |$ih#s0#0|))) (and (|Set#Equal| |$ih#s0#0| |s#0@@7|) (and (<= 0 |q#0|) (< |q#0| |q#0|))))) (_module.__default.IsPrime (+ |q#0| 1)))
 :qid |Primesdfy.79:29|
 :skolemid |625|
 :pattern ( (_module.__default.product ($LS $LZ) reveal__module._default.product |$ih#s0#0|))
 :pattern ( (_module.__default.AllPrimes |$ih#s0#0| |q#0|))
)) (= |p#2@0| (+ |q#0| 1)))) (and (and (=> (= (ControlFlow 0 32) 1) anon13_Then_correct) (=> (= (ControlFlow 0 32) 3) anon14_Then_correct)) (=> (= (ControlFlow 0 32) 31) anon14_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (and ($Is SetType |s#0@@7| (TSet TInt)) ($IsAlloc SetType |s#0@@7| (TSet TInt) $Heap@@1)) (= 4 $FunctionContextHeight)) (and (and (|_module.__default.AllPrimes#canCall| |s#0@@7| |q#0|) (and (_module.__default.AllPrimes |s#0@@7| |q#0|) (and (forall ((|x#1@@5| Int) ) (!  (=> (|Set#IsMember| |s#0@@7| ($Box intType (int_2_U |x#1@@5|))) (_module.__default.IsPrime |x#1@@5|))
 :qid |Primesdfy.36:11|
 :skolemid |623|
 :pattern ( (_module.__default.IsPrime |x#1@@5|))
 :pattern ( (|Set#IsMember| |s#0@@7| ($Box intType (int_2_U |x#1@@5|))))
)) (forall ((|p#1@@1| Int) ) (!  (=> (and (_module.__default.IsPrime |p#1@@1|) (<= |p#1@@1| |q#0|)) (|Set#IsMember| |s#0@@7| ($Box intType (int_2_U |p#1@@1|))))
 :qid |Primesdfy.38:11|
 :skolemid |624|
 :pattern ( (|Set#IsMember| |s#0@@7| ($Box intType (int_2_U |p#1@@1|))))
 :pattern ( (_module.__default.IsPrime |p#1@@1|))
))))) (and (= |q#0| (_module.__default.product ($LS ($LS $LZ)) reveal__module._default.product |s#0@@7|)) (= (ControlFlow 0 33) 32)))) anon0_correct))))
