...
(set-info :boogie-vc-id Impl$$_module.__default.GcdSubtractAlt_split15)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon19_correct  (=> (and (and (and (and (or (and ($Is intType (int_2_U (LitInt 1)) Tclass._module.pos) (= (Mul |q#2_0@0| (LitInt 1)) (- |y#0@@3| |x#0@@10|))) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._module.pos) (= (Mul |q#2_0@0| (LitInt 0)) (- |y#0@@3| |x#0@@10|))) (exists ((|$as#b2_0#2_0| Int) ) (!  (and (<= (LitInt 1) |$as#b2_0#2_0|) (= (Mul |q#2_0@0| |$as#b2_0#2_0|) (- |y#0@@3| |x#0@@10|)))
 :qid |gcddfy.245:9|
 :skolemid |670|
)))) (<= (LitInt 1) |b#2_0@0|)) (and (= (Mul |q#2_0@0| |b#2_0@0|) (- |y#0@@3| |x#0@@10|)) ($IsAlloc intType (int_2_U |q#2_0@0|) Tclass._module.pos $Heap@4))) (and (and ($IsAlloc intType (int_2_U |y#0@@3|) Tclass._module.pos $Heap@4) (|_module.__default.IsFactor#canCall| |q#2_0@0| |y#0@@3|)) (and (|_module.__default.IsFactor#canCall| |q#2_0@0| |y#0@@3|) (_module.__default.IsFactor |q#2_0@0| |y#0@@3|)))) (and (and (and ($IsAlloc intType (int_2_U |x#0@@10|) Tclass._module.pos $Heap@4) (|_module.__default.Factors#canCall| |x#0@@10|)) (and ($IsAlloc intType (int_2_U |y#0@@3|) Tclass._module.pos $Heap@4) (|_module.__default.Factors#canCall| |y#0@@3|))) (and (and (|_module.__default.Factors#canCall| |x#0@@10|) (|_module.__default.Factors#canCall| |y#0@@3|)) (= (ControlFlow 0 2) (- 0 1))))) (|Set#IsMember| (|Set#Intersection| (_module.__default.Factors |x#0@@10|) (_module.__default.Factors |y#0@@3|)) ($Box intType (int_2_U |q#2_0@0|))))))
