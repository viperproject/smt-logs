...
(set-info :boogie-vc-id Impl$$_module.__default.CallFoo)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon3_correct  (=> (and (<= (LitInt 0) |i#0_0@0|) (< |i#0_0@0| (- (|Seq#Length| |s#0|) 1))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= (LitInt 0) |i#0_0@0|)) (=> (<= (LitInt 0) |i#0_0@0|) (=> (= (ControlFlow 0 3) (- 0 2)) (< |i#0_0@0| (- (|Seq#Length| |s#0|) 1))))))))
(let ((anon6_Else_correct  (=> (and (< |i#0_0@0| (LitInt 0)) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (<= (LitInt 0) |i#0_0@0|) (= (ControlFlow 0 5) 3)) anon3_correct)))
(let ((anon5_Then_correct  (and (=> (= (ControlFlow 0 7) 5) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 8) 7) anon5_Then_correct) (=> (= (ControlFlow 0 8) 1) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |s#0| (TSeq TInt)) ($IsAlloc SeqType |s#0| (TSeq TInt) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct))))
