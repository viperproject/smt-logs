...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let (($generated@@135  (=> (and (<= ($generated@@22 0) $generated@@127) (< $generated@@127 (- ($generated@@20 $generated@@128) 1))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= ($generated@@22 0) $generated@@127)) (=> (<= ($generated@@22 0) $generated@@127) (=> (= (ControlFlow 0 3) (- 0 2)) (< $generated@@127 (- ($generated@@20 $generated@@128) 1))))))))
(let (($generated@@136  (=> (and (< $generated@@127 ($generated@@22 0)) (= (ControlFlow 0 6) 3)) $generated@@135)))
(let (($generated@@137  (=> (and (<= ($generated@@22 0) $generated@@127) (= (ControlFlow 0 5) 3)) $generated@@135)))
(let (($generated@@138  (and (=> (= (ControlFlow 0 7) 5) $generated@@137) (=> (= (ControlFlow 0 7) 6) $generated@@136))))
(let (($generated@@139 true))
(let (($generated@@140  (=> (= $generated@@129 ($generated@@59 $generated@@130 $generated@@131 $generated@@2 false)) (and (=> (= (ControlFlow 0 8) 7) $generated@@138) (=> (= (ControlFlow 0 8) 1) $generated@@139)))))
(let (($generated@@141  (=> (and ($generated@@132 $generated@@131) ($generated@@133 $generated@@131)) (=> (and (and ($generated@@38 $generated@@44 $generated@@128 ($generated@@45 $generated)) ($generated@@32 $generated@@44 $generated@@128 ($generated@@45 $generated) $generated@@131)) (and (= 1 $generated@@134) (= (ControlFlow 0 9) 8))) $generated@@140))))
$generated@@141))))))))
))
(check-sat)
(get-info :rlimit)
