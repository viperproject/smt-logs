...
(declare-fun $Heap@6 () T@U)
(declare-fun |##xs#0_0_2@0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.ExtractorLemma_split4)
...
))) (and ($IsAlloc DatatypeTypeType |xs#0@@22| (Tclass._module.List _module._default.ExtractorLemma$T) $Heap@0) (|_module.__default.length#canCall| _module._default.ExtractorLemma$T |xs#0@@22|))) (and (and (= |##n#0_0_0@0| (- (- (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|) 1) |i#0|)) ($IsAlloc intType (int_2_U |##n#0_0_0@0|) TInt $Heap@0)) (and ($IsAlloc DatatypeTypeType |xs#0@@22| (Tclass._module.List _module._default.ExtractorLemma$T) $Heap@0) (|_module.__default.nth#canCall| _module._default.ExtractorLemma$T (- (- (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|) 1) |i#0|) |xs#0@@22|)))) (and (and (and (|_module.__default.length#canCall| _module._default.ExtractorLemma$T |xs#0@@22|) (|_module.__default.nth#canCall| _module._default.ExtractorLemma$T (- (- (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|) 1) |i#0|) |xs#0@@22|)) (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4))) (and (and (= $Heap@0 $Heap@4) reveal__module._default.nth) (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5)))))) (and (and (and (and (and (and (|_module.__default.rev#canCall| _module._default.ExtractorLemma$T |xs#0@@22|) (|_module.__default.length#canCall| _module._default.ExtractorLemma$T (_module.__default.rev _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|))) (|_module.__default.length#canCall| _module._default.ExtractorLemma$T |xs#0@@22|)) (= (_module.__default.length _module._default.ExtractorLemma$T ($LS ($LS $LZ)) (_module.__default.rev _module._default.ExtractorLemma$T ($LS ($LS $LZ)) |xs#0@@22|)) (_module.__default.length _module._default.ExtractorLemma$T ($LS ($LS $LZ)) |xs#0@@22|))) (and (= $Heap@4 $Heap@5) (<= (LitInt 0) |i#0|))) (and (and (< |i#0| (_module.__default.length _module._default.ExtractorLemma$T ($LS ($LS $LZ)) |xs#0@@22|)) (= (_module.__default.length _module._default.ExtractorLemma$T ($LS ($LS $LZ)) |xs#0@@22|) (_module.__default.length _module._default.ExtractorLemma$T ($LS ($LS $LZ)) (_module.__default.rev _module._default.ExtractorLemma$T ($LS ($LS $LZ)) |xs#0@@22|)))) (and ($IsGoodHeap $Heap@6) ($IsHeapAnchor $Heap@6)))) (and (and (and (and (|_module.__default.rev#canCall| _module._default.ExtractorLemma$T |xs#0@@22|) (|_module.__default.nthWorker#canCall| _module._default.ExtractorLemma$T |i#0| (_module.__default.rev _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|))) (and (|_module.__default.length#canCall| _module._default.ExtractorLemma$T |xs#0@@22|) (|_module.__default.nthWorker#canCall| _module._default.ExtractorLemma$T (- (- (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|) 1) |i#0|) |xs#0@@22|))) (and (and (= (_module.__default.nthWorker _module._default.ExtractorLemma$T ($LS ($LS $LZ)) |i#0| (_module.__default.rev _module._default.ExtractorLemma$T ($LS ($LS $LZ)) |xs#0@@22|)) (_module.__default.nthWorker _module._default.ExtractorLemma$T ($LS ($LS $LZ)) (- (- (_module.__default.length _module._default.ExtractorLemma$T ($LS ($LS $LZ)) |xs#0@@22|) 1) |i#0|) |xs#0@@22|)) (= $Heap@5 $Heap@6)) (and ($IsAlloc intType (int_2_U |i#0|) TInt $Heap@6) ($IsAlloc DatatypeTypeType |xs#0@@22| (Tclass._module.List _module._default.ExtractorLemma$T) $Heap@6)))) (and (and (and (|_module.__default.rev#canCall| _module._default.ExtractorLemma$T |xs#0@@22|) (= |##xs#0_0_2@0| (_module.__default.rev _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|))) (and ($IsAlloc DatatypeTypeType |##xs#0_0_2@0| (Tclass._module.List _module._default.ExtractorLemma$T) $Heap@6) (|_module.__default.nth#canCall| _module._default.ExtractorLemma$T |i#0| (_module.__default.rev _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|)))) (and (and (|_module.__default.rev#canCall| _module._default.ExtractorLemma$T |xs#0@@22|) (|_module.__default.nth#canCall| _module._default.ExtractorLemma$T |i#0| (_module.__default.rev _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|))) (= (ControlFlow 0 2) (- 0 1))))))) (= (_module.__default.nth _module._default.ExtractorLemma$T reveal__module._default.nth (- (- (_module.__default.length _module._default.ExtractorLemma$T ($LS ($LS $LZ)) |xs#0@@22|) 1) |i#0|) |xs#0@@22|) (_module.__default.nth _module._default.ExtractorLemma$T reveal__module._default.nth |i#0| (_module.__default.rev _module._default.ExtractorLemma$T ($LS ($LS $LZ)) |xs#0@@22|)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
