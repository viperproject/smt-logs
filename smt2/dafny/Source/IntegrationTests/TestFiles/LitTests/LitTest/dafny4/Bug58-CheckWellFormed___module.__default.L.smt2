...
(let ((anon4_Else_correct  (=> (and (not (|Set#IsMember| (|Map#Domain| |f#1@0|) ($Box intType (int_2_U |j#0@0|)))) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon4_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |f#1@0|) ($Box intType (int_2_U |j#0@0|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#IsMember| (|Map#Domain| |f#1@0|) ($Box intType (int_2_U |j#0@0|)))) (=> (|Set#IsMember| (|Map#Domain| |f#1@0|) ($Box intType (int_2_U |j#0@0|))) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#8| null $Heap alloc false)) (|Set#IsMember| (|Map#Domain| |f#0@@1|) ($Box intType (int_2_U |i#0@@1|)))) (=> (and (and ($IsAlloc MapType |f#0@@1| (TMap TInt TBool) $Heap) ($IsAlloc intType (int_2_U |i#0@@1|) TInt $Heap)) (and (|_module.__default.M2#canCall| |f#0@@1| |i#0@@1|) (_module.__default.M2 |f#0@@1| |i#0@@1|))) (=> (and (and (and ($Is MapType |f#1@0| (TMap TInt TBool)) ($IsAlloc MapType |f#1@0| (TMap TInt TBool) $Heap)) ($IsAlloc MapType |f#1@0| (TMap TInt TBool) $Heap)) (and ($IsAlloc intType (int_2_U |j#0@0|) TInt $Heap) (|_module.__default.M1#canCall| |f#1@0| |j#0@0|))) (and (=> (= (ControlFlow 0 5) 2) anon4_Then_correct) (=> (= (ControlFlow 0 5) 4) anon4_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is MapType |f#0@@1| (TMap TInt TBool)) ($IsAlloc MapType |f#0@@1| (TMap TInt TBool) $Heap)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 6) 5))) anon0_correct))))
