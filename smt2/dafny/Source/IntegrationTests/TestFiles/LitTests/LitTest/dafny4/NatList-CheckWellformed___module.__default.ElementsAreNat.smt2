...
(let ((|x#0| (U_2_int ($Unbox intType (_module.List.head |xs#0@@1|)))))
 (and (<= (LitInt 0) |x#0|) (_module.__default.ElementsAreNat $ly@@1 |tail#0|))))))))
 :qid |NatListdfy.81:17|
 :skolemid |568|
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.ElementsAreNat)
...
(let ((anon13_Else_correct  (=> (and (< |x#Z#0@0| (LitInt 0)) (= (ControlFlow 0 7) 4)) anon7_correct)))
(let ((anon13_Then_correct  (=> (and (<= (LitInt 0) |x#Z#0@0|) ($IsAlloc DatatypeTypeType |tail#Z#0@0| (Tclass._module.List TInt) $Heap)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< (DtRank |tail#Z#0@0|) (DtRank |xs#0@@2|))) (=> (< (DtRank |tail#Z#0@0|) (DtRank |xs#0@@2|)) (=> (and (|_module.__default.ElementsAreNat#canCall| |tail#Z#0@0|) (= (ControlFlow 0 5) 4)) anon7_correct))))))
