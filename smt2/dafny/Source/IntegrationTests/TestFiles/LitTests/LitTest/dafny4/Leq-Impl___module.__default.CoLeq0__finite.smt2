...
(set-info :boogie-vc-id Impl$$_module.__default.CoLeq0__finite)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (and (forall ((|$ih#m0#0| Int) (|$ih#n0#0| Int) ) (!  (=> (and (and (and (<= (LitInt 0) |$ih#m0#0|) (<= (LitInt 0) |$ih#n0#0|)) (<= |$ih#m0#0| |$ih#n0#0|)) (or (and (<= 0 |$ih#m0#0|) (< |$ih#m0#0| |m#0|)) (and (= |$ih#m0#0| |m#0|) (and (<= 0 |$ih#n0#0|) (< |$ih#n0#0| |n#0@@2|))))) (_module.__default.CoLeq ($LS $LZ) (_module.__default.Num ($LS $LZ) |$ih#m0#0|) (_module.__default.Num ($LS $LZ) |$ih#n0#0|)))
 :qid |Leqdfy.135:21|
 :skolemid |745|
 :pattern ( (_module.__default.Num ($LS $LZ) |$ih#n0#0|) (_module.__default.Num ($LS $LZ) |$ih#m0#0|))
)) (= (ControlFlow 0 2) (- 0 1))) (|_module.__default.CoLeq#canCall| (_module.__default.Num ($LS $LZ) |m#0|) (_module.__default.Num ($LS $LZ) |n#0@@2|)))) (or (_module.__default.CoLeq ($LS $LZ) (_module.__default.Num ($LS $LZ) |m#0|) (_module.__default.Num ($LS $LZ) |n#0@@2|)) (or (|$Eq#_module.Nat| ($LS ($LS $LZ)) (_module.__default.Num ($LS ($LS $LZ)) |m#0|) |#_module.Nat.Z|) (and (and (_module.Nat.S_q (_module.__default.Num ($LS ($LS $LZ)) |m#0|)) (_module.Nat.S_q (_module.__default.Num ($LS ($LS $LZ)) |n#0@@2|))) (_module.__default.CoLeq ($LS ($LS $LZ)) (_module.Nat.pred (_module.__default.Num ($LS ($LS $LZ)) |m#0|)) (_module.Nat.pred (_module.__default.Num ($LS ($LS $LZ)) |n#0@@2|))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |m#0|)) (and (and (<= (LitInt 0) |n#0@@2|) (= 2 $FunctionContextHeight)) (and (<= |m#0| |n#0@@2|) (= (ControlFlow 0 3) 2)))) anon0_correct)))
