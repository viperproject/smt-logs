...
(declare-fun _module.__default.G (Bool T@U T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (|f#0| T@U) ) (!  (=> (or (|_module.__default.G#canCall| $Heap |f#0|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) ($Is HandleTypeType |f#0| (Tclass._System.___hFunc1 TInt TBool))) (Requires1 TInt TBool $Heap |f#0| ($Box intType (int_2_U (LitInt 0))))))) (= (_module.__default.G true $Heap |f#0|) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |Bug55dfy.4:27|
 :skolemid |483|
 :pattern ( (_module.__default.G true $Heap |f#0|) ($IsGoodHeap $Heap))
))))
...
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@0 alloc (Reads1 TInt TBool $Heap@@0 |f#0@@0| ($Box intType (int_2_U (LitInt 0)))))) ($IsAllocBox ($Box HandleTypeType |f#0@@0|) (Tclass._System.___hFunc1 TInt TBool) $Heap@@0)) (=> (and (and (= |##x0#0@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##x0#0@0|) TInt $Heap@@0)) (and (= |b$reqreads#0@0| (forall (($o@@0 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@0) alloc)))) (|Set#IsMember| (Reads1 TInt TBool $Heap@@0 |f#0@@0| ($Box intType (int_2_U |##x0#0@0|))) ($Box refType $o@@0))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@0 $f@@0)))
 :qid |Bug55dfy.6:14|
 :skolemid |484|
))) (Requires1 TInt TBool $Heap@@0 |f#0@@0| ($Box intType (int_2_U (LitInt 0)))))) (and (=> (= (ControlFlow 0 3) (- 0 7)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (=> ($IsAllocBox ($Box HandleTypeType |f#0@@0|) (Tclass._System.___hFunc1 TInt TBool) $Heap@@0) (=> (and (= |##x0#1@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##x0#1@0|) TInt $Heap@@0)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (Requires1 TInt TBool $Heap@@0 |f#0@@0| ($Box intType (int_2_U (LitInt 0))))) (=> (Requires1 TInt TBool $Heap@@0 |f#0@@0| ($Box intType (int_2_U (LitInt 0)))) (=> (= |b$reqreads#1@0| (forall (($o@@1 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@1 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@1) alloc)))) (|Set#IsMember| (Reads1 TInt TBool $Heap@@0 |f#0@@0| ($Box intType (int_2_U (LitInt 0)))) ($Box refType $o@@1))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@1 $f@@1)))
 :qid |Bug55dfy.5:11|
 :skolemid |485|
))) (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#1@0|) (=> |b$reqreads#1@0| (=> ($IsAllocBox ($Box HandleTypeType |f#0@@0|) (Tclass._System.___hFunc1 TInt TBool) $Heap@@0) (=> (and (= |##x0#2@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##x0#2@0|) TInt $Heap@@0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (Requires1 TInt TBool $Heap@@0 |f#0@@0| ($Box intType (int_2_U (LitInt 0))))) (=> (Requires1 TInt TBool $Heap@@0 |f#0@@0| ($Box intType (int_2_U (LitInt 0)))) (and (=> (= (ControlFlow 0 3) 1) anon5_Then_correct) (=> (= (ControlFlow 0 3) 2) anon5_Else_correct)))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) ($Is HandleTypeType |f#0@@0| (Tclass._System.___hFunc1 TInt TBool))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 8) 3))) anon0_correct)))
