...
(assert (distinct alloc Tagclass.M.Dt tytagFamily$Dt)
)
...
(assert (= (Tag Tclass.M.Dt) Tagclass.M.Dt))
(assert (= (TagFamily Tclass.M.Dt) tytagFamily$Dt))
...
(set-info :boogie-vc-id CheckWellFormed$$M.T)
