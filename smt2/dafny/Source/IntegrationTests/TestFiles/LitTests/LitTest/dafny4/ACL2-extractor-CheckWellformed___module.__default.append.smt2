...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.append$_T0@@0 T@U) ($ly@@0 T@U) (|xs#0@@0| T@U) (|ys#0@@0| T@U) ) (!  (=> (or (|_module.__default.append#canCall| _module._default.append$_T0@@0 |xs#0@@0| |ys#0@@0|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@0| (Tclass._module.List _module._default.append$_T0@@0)) ($Is DatatypeTypeType |ys#0@@0| (Tclass._module.List _module._default.append$_T0@@0))))) (and (=> (not (_module.List.Nil_q |xs#0@@0|)) (let ((|rest#1| (_module.List.tail |xs#0@@0|)))
(|_module.__default.append#canCall| _module._default.append$_T0@@0 |rest#1| |ys#0@@0|))) (= (_module.__default.append _module._default.append$_T0@@0 ($LS $ly@@0) |xs#0@@0| |ys#0@@0|) (ite (_module.List.Nil_q |xs#0@@0|) |ys#0@@0| (let ((|rest#0| (_module.List.tail |xs#0@@0|)))
(let ((|x#0| (_module.List.head |xs#0@@0|)))
(|#_module.List.Cons| |x#0| (_module.__default.append _module._default.append$_T0@@0 $ly@@0 |rest#0| |ys#0@@0|))))))))
 :qid |unknown.0:0|
 :skolemid |560|
...
(declare-fun _module._default.append$_T0@@4 () T@U)
...
(let ((anon10_Then_correct  (=> (and (and (= |xs#0@@4| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) ($IsBox |_mcc#0#0| _module._default.append$_T0@@4)) (and ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List _module._default.append$_T0@@4)) (= |let#0#0#0| |_mcc#1#0|))) (=> (and (and (and ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List _module._default.append$_T0@@4)) (= |rest#Z#0@0| |let#0#0#0|)) (and (= |let#1#0#0| |_mcc#0#0|) ($IsBox |let#1#0#0| _module._default.append$_T0@@4))) (and (and (= |x#Z#0@0| |let#1#0#0|) ($IsAlloc DatatypeTypeType |rest#Z#0@0| (Tclass._module.List _module._default.append$_T0@@4) $Heap@@0)) (and ($IsAlloc DatatypeTypeType |ys#0@@4| (Tclass._module.List _module._default.append$_T0@@4) $Heap@@0) (= (ControlFlow 0 4) (- 0 3))))) (or (< (DtRank |rest#Z#0@0|) (DtRank |xs#0@@4|)) (and (= (DtRank |rest#Z#0@0|) (DtRank |xs#0@@4|)) (< (DtRank |ys#0@@4|) (DtRank |ys#0@@4|))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is DatatypeTypeType |xs#0@@4| (Tclass._module.List _module._default.append$_T0@@4)) ($Is DatatypeTypeType |ys#0@@4| (Tclass._module.List _module._default.append$_T0@@4))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
