...
(assert (forall ((|l#0| Int) (|l#1| T@U) (|l#2| Int) (|l#3| T@U) (|$y#0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#25| |l#0| |l#1| |l#2| |l#3|) |$y#0|)) (exists ((|x#0@@0| Int) ) (!  (and (and (<= |l#0| |x#0@@0|) (|Set#IsMember| |l#1| ($Box intType (int_2_U |x#0@@0|)))) (= |$y#0| ($Box intType (int_2_U (+ |x#0@@0| |l#2|)))))
