...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.sub)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (> (_System.array.Length |a#0|) 0) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |a#0|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |a#0|))) (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField (LitInt 0)))) null)) (not true)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |a#0| (Tclass._System.array (Tclass._System.array TInt))) ($IsAlloc refType |a#0| (Tclass._System.array (Tclass._System.array TInt)) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 6) 2))) anon0_correct))))
