...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@37 T@U) ($f@@2 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#14| |l#0| |l#1| |l#2| |l#3|) $o@@37 $f@@2))  (=> (and (or (not (= $o@@37 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@37) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |867|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#14| |l#0| |l#1| |l#2| |l#3|) $o@@37 $f@@2))
)))
...
(assert (forall (($h0@@2 T@U) ($h1@@2 T@U) (this@@9 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@2) ($IsGoodHeap $h1@@2)) (and (or (not (= this@@9 null)) (not true)) ($Is refType this@@9 Tclass._module.Bot))) (and ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2))) (=> (forall (($o@@41 T@U) ($f@@3 T@U) ) (!  (=> (and (or (not (= $o@@41 null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 this@@9) _module.Bot.Repr)) ($Box refType $o@@41))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 $o@@41) $f@@3) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@2 $o@@41) $f@@3)))
 :qid |unknown.0:0|
 :skolemid |825|
...
(assert (forall (($h0@@3 T@U) ($h1@@3 T@U) (this@@10 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@3) ($IsGoodHeap $h1@@3)) (and (or (not (= this@@10 null)) (not true)) ($Is refType this@@10 Tclass._module.Bot))) (and ($IsHeapAnchor $h0@@3) ($HeapSucc $h0@@3 $h1@@3))) (=> (forall (($o@@42 T@U) ($f@@4 T@U) ) (!  (=> (and (or (not (= $o@@42 null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@3 this@@10) _module.Bot.Repr)) ($Box refType $o@@42))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@3 $o@@42) $f@@4) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@3 $o@@42) $f@@4)))
 :qid |unknown.0:0|
 :skolemid |832|
...
(assert (forall (($h0@@4 T@U) ($h1@@4 T@U) (this@@11 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@4) ($IsGoodHeap $h1@@4)) (and (or (not (= this@@11 null)) (not true)) ($Is refType this@@11 Tclass._module.Bot))) (and ($IsHeapAnchor $h0@@4) ($HeapSucc $h0@@4 $h1@@4))) (=> (forall (($o@@43 T@U) ($f@@5 T@U) ) (!  (=> (and (or (not (= $o@@43 null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 this@@11) _module.Bot.Repr)) ($Box refType $o@@43))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 $o@@43) $f@@5) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@4 $o@@43) $f@@5)))
 :qid |unknown.0:0|
 :skolemid |839|
...
(declare-fun |defass#b1#0| () Bool)
(declare-fun |b1#0| () T@U)
(declare-fun |defass#b2#0| () Bool)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 40) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#14| null $Heap@@8 alloc false)) (=> (and (and (and (and (and (or (not (= call1formal@this null)) (not true)) (and ($Is refType call1formal@this Tclass._module.Bot) ($IsAlloc refType call1formal@this Tclass._module.Bot $Heap@@8))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (or (not (= call1formal@this@0 null)) (not true)) (and ($Is refType call1formal@this@0 Tclass._module.Bot) ($IsAlloc refType call1formal@this@0 Tclass._module.Bot $Heap@0))) (and (|_module.Bot.Valid#canCall| $Heap@0 call1formal@this@0) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 call1formal@this@0)))) (and (and (and (forall (($o@@44 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@44)) (or (not (= $o@@44 null)) (not true)))
 :qid |FlyingRobotsdfy.110:24|
 :skolemid |815|
 :pattern (  (or (not (= $o@@44 null)) (not true)))
)) (forall (($o@@45 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@45)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@45) alloc)))))
 :qid |FlyingRobotsdfy.110:24|
 :skolemid |816|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@45)))
))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 call1formal@this@0) alloc))))) (and (forall (($o@@46 T@U) ) (!  (=> (and (or (not (= $o@@46 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@46) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@46) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@46)))
 :qid |FlyingRobotsdfy.109:3|
 :skolemid |817|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@46))
)) ($HeapSucc $Heap@@8 $Heap@0)))) (and (and (and (and (or (not (= call1formal@this@@0 null)) (not true)) (and ($Is refType call1formal@this@@0 Tclass._module.Bot) ($IsAlloc refType call1formal@this@@0 Tclass._module.Bot $Heap@@8))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1))) (and (and (or (not (= call1formal@this@0@@0 null)) (not true)) (and ($Is refType call1formal@this@0@@0 Tclass._module.Bot) ($IsAlloc refType call1formal@this@0@@0 Tclass._module.Bot $Heap@1))) (and (|_module.Bot.Valid#canCall| $Heap@1 call1formal@this@0@@0) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@1 call1formal@this@0@@0)))) (and (and (and (forall (($o@@47 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@47)) (or (not (= $o@@47 null)) (not true)))
 :qid |FlyingRobotsdfy.110:24|
 :skolemid |815|
 :pattern (  (or (not (= $o@@47 null)) (not true)))
)) (forall (($o@@48 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@48)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@48) alloc)))))
 :qid |FlyingRobotsdfy.110:24|
 :skolemid |816|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@48)))
))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call1formal@this@0@@0) alloc))))) (and (forall (($o@@49 T@U) ) (!  (=> (and (or (not (= $o@@49 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@49) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@49) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@49)))
 :qid |FlyingRobotsdfy.109:3|
 :skolemid |817|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@49))
)) ($HeapSucc $Heap@0 $Heap@1))))) (and (=> (= (ControlFlow 0 2) (- 0 39)) true) (and (=> (= (ControlFlow 0 2) (- 0 38)) true) (and (=> (= (ControlFlow 0 2) (- 0 37)) (forall (($o@@50 T@U) ($f@@6 T@U) ) (!  (=> (and (and (or (not (= $o@@50 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@50) alloc)))) (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@50)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@50)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@50 $f@@6)))
 :qid |FlyingRobotsdfy.272:12|
 :skolemid |696|
))) (=> (forall (($o@@51 T@U) ($f@@7 T@U) ) (!  (=> (and (and (or (not (= $o@@51 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@51) alloc)))) (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@51)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@51)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@51 $f@@7)))
 :qid |FlyingRobotsdfy.272:12|
 :skolemid |696|
)) (and (=> (= (ControlFlow 0 2) (- 0 36)) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@1 call1formal@this@0)) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@1 call1formal@this@0) (and (=> (= (ControlFlow 0 2) (- 0 35)) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@1 call1formal@this@0@@0)) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@1 call1formal@this@0@@0) (and (=> (= (ControlFlow 0 2) (- 0 34)) (=> (or (not (= call1formal@this@0 call1formal@this@0@@0)) (not true)) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0@@0) _module.Bot.Repr))))) (=> (=> (or (not (= call1formal@this@0 call1formal@this@0@@0)) (not true)) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0@@0) _module.Bot.Repr)))) (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (and (|_module.Bot.Valid#canCall| $Heap@2 call1formal@this@0) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@2 call1formal@this@0))) (and (and (forall (($o@@52 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@52)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@52)))) (or (not (= $o@@52 null)) (not true)))
 :qid |FlyingRobotsdfy.163:25|
 :skolemid |514|
 :pattern (  (or (not (= $o@@52 null)) (not true)))
)) (forall (($o@@53 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@53)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@53)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@53) alloc)))))
 :qid |FlyingRobotsdfy.163:25|
 :skolemid |515|
...
))) (and (|_module.Bot.Valid#canCall| $Heap@2 call1formal@this@0@@0) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@2 call1formal@this@0@@0)))) (=> (and (and (and (and (and (forall (($o@@54 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@54)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@54)))) (or (not (= $o@@54 null)) (not true)))
 :qid |FlyingRobotsdfy.164:25|
 :skolemid |516|
 :pattern (  (or (not (= $o@@54 null)) (not true)))
)) (forall (($o@@55 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@55)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@55)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@55) alloc)))))
 :qid |FlyingRobotsdfy.164:25|
 :skolemid |517|
...
))) (=> (or (not (= call1formal@this@0 call1formal@this@0@@0)) (not true)) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call1formal@this@0) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call1formal@this@0@@0) _module.Bot.Repr))))) (and (|_module.Bot.robot__inv#canCall| $Heap@2 call1formal@this@0) (=> (_module.Bot.robot__inv $Heap@2 call1formal@this@0) (|_module.Bot.robot__inv#canCall| $Heap@2 call1formal@this@0@@0)))) (and (and (|_module.Bot.robot__inv#canCall| $Heap@2 call1formal@this@0) (and (_module.Bot.robot__inv $Heap@2 call1formal@this@0) (=> (_module.Bot.flying $Heap@2 call1formal@this@0) (_module.Bot.arms__up $Heap@2 call1formal@this@0)))) (and (|_module.Bot.robot__inv#canCall| $Heap@2 call1formal@this@0@@0) (and (_module.Bot.robot__inv $Heap@2 call1formal@this@0@@0) (=> (_module.Bot.flying $Heap@2 call1formal@this@0@@0) (_module.Bot.arms__up $Heap@2 call1formal@this@0@@0)))))) (and (and (and (|_module.Bot.flying#canCall| $Heap@2 call1formal@this@0) (=> (_module.Bot.flying $Heap@2 call1formal@this@0) (|_module.Bot.flying#canCall| $Heap@2 call1formal@this@0@@0))) (and (|_module.Bot.flying#canCall| $Heap@2 call1formal@this@0) (and (_module.Bot.flying $Heap@2 call1formal@this@0) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call1formal@this@0) _module.Bot.pos))) _module.Point.z))) _module.Cell.val))) 0)))) (and (and (|_module.Bot.flying#canCall| $Heap@2 call1formal@this@0@@0) (and (_module.Bot.flying $Heap@2 call1formal@this@0@@0) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call1formal@this@0@@0) _module.Bot.pos))) _module.Point.z))) _module.Cell.val))) 0))) (and (forall (($o@@56 T@U) ) (!  (=> (and (or (not (= $o@@56 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@56) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@56) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@56)) (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@56)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@56)))))
 :qid |FlyingRobotsdfy.158:8|
 :skolemid |518|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@56))
)) ($HeapSucc $Heap@1 $Heap@2))))) (and (=> (= (ControlFlow 0 2) (- 0 33)) true) (and (=> (= (ControlFlow 0 2) (- 0 32)) true) (and (=> (= (ControlFlow 0 2) (- 0 31)) (forall (($o@@57 T@U) ($f@@8 T@U) ) (!  (=> (and (and (or (not (= $o@@57 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@57) alloc)))) (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@57)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@57)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@57 $f@@8)))
 :qid |FlyingRobotsdfy.273:12|
 :skolemid |697|
))) (=> (forall (($o@@58 T@U) ($f@@9 T@U) ) (!  (=> (and (and (or (not (= $o@@58 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@58) alloc)))) (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@58)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@58)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@58 $f@@9)))
 :qid |FlyingRobotsdfy.273:12|
 :skolemid |697|
)) (and (=> (= (ControlFlow 0 2) (- 0 30)) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@2 call1formal@this@0)) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@2 call1formal@this@0) (and (=> (= (ControlFlow 0 2) (- 0 29)) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@2 call1formal@this@0@@0)) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@2 call1formal@this@0@@0) (and (=> (= (ControlFlow 0 2) (- 0 28)) (=> (or (not (= call1formal@this@0 call1formal@this@0@@0)) (not true)) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call1formal@this@0) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call1formal@this@0@@0) _module.Bot.Repr))))) (=> (=> (or (not (= call1formal@this@0 call1formal@this@0@@0)) (not true)) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call1formal@this@0) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call1formal@this@0@@0) _module.Bot.Repr)))) (=> (and (and (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (and (|_module.Bot.Valid#canCall| $Heap@3 call1formal@this@0) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@3 call1formal@this@0))) (and (and (forall (($o@@59 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@59)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@59)))) (or (not (= $o@@59 null)) (not true)))
 :qid |FlyingRobotsdfy.163:25|
 :skolemid |514|
 :pattern (  (or (not (= $o@@59 null)) (not true)))
)) (forall (($o@@60 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@60)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@60)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@60) alloc)))))
 :qid |FlyingRobotsdfy.163:25|
 :skolemid |515|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@60) alloc)))
))) (and (|_module.Bot.Valid#canCall| $Heap@3 call1formal@this@0@@0) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@3 call1formal@this@0@@0)))) (=> (and (and (and (and (and (forall (($o@@61 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@61)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@61)))) (or (not (= $o@@61 null)) (not true)))
 :qid |FlyingRobotsdfy.164:25|
 :skolemid |516|
 :pattern (  (or (not (= $o@@61 null)) (not true)))
)) (forall (($o@@62 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@62)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@62)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@62) alloc)))))
 :qid |FlyingRobotsdfy.164:25|
 :skolemid |517|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@62) alloc)))
))) (=> (or (not (= call1formal@this@0 call1formal@this@0@@0)) (not true)) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call1formal@this@0) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call1formal@this@0@@0) _module.Bot.Repr))))) (and (|_module.Bot.robot__inv#canCall| $Heap@3 call1formal@this@0) (=> (_module.Bot.robot__inv $Heap@3 call1formal@this@0) (|_module.Bot.robot__inv#canCall| $Heap@3 call1formal@this@0@@0)))) (and (and (|_module.Bot.robot__inv#canCall| $Heap@3 call1formal@this@0) (and (_module.Bot.robot__inv $Heap@3 call1formal@this@0) (=> (_module.Bot.flying $Heap@3 call1formal@this@0) (_module.Bot.arms__up $Heap@3 call1formal@this@0)))) (and (|_module.Bot.robot__inv#canCall| $Heap@3 call1formal@this@0@@0) (and (_module.Bot.robot__inv $Heap@3 call1formal@this@0@@0) (=> (_module.Bot.flying $Heap@3 call1formal@this@0@@0) (_module.Bot.arms__up $Heap@3 call1formal@this@0@@0)))))) (and (and (and (|_module.Bot.flying#canCall| $Heap@3 call1formal@this@0) (=> (_module.Bot.flying $Heap@3 call1formal@this@0) (|_module.Bot.flying#canCall| $Heap@3 call1formal@this@0@@0))) (and (|_module.Bot.flying#canCall| $Heap@3 call1formal@this@0) (and (_module.Bot.flying $Heap@3 call1formal@this@0) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call1formal@this@0) _module.Bot.pos))) _module.Point.z))) _module.Cell.val))) 0)))) (and (and (|_module.Bot.flying#canCall| $Heap@3 call1formal@this@0@@0) (and (_module.Bot.flying $Heap@3 call1formal@this@0@@0) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call1formal@this@0@@0) _module.Bot.pos))) _module.Point.z))) _module.Cell.val))) 0))) (and (forall (($o@@63 T@U) ) (!  (=> (and (or (not (= $o@@63 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@63) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@63) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@63)) (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@63)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@63)))))
 :qid |FlyingRobotsdfy.158:8|
 :skolemid |518|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@63))
)) ($HeapSucc $Heap@2 $Heap@3))))) (and (=> (= (ControlFlow 0 2) (- 0 27)) true) (and (=> (= (ControlFlow 0 2) (- 0 26)) true) (and (=> (= (ControlFlow 0 2) (- 0 25)) (forall (($o@@64 T@U) ($f@@10 T@U) ) (!  (=> (and (and (or (not (= $o@@64 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@64) alloc)))) (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@64)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@64)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@64 $f@@10)))
 :qid |FlyingRobotsdfy.274:12|
 :skolemid |698|
))) (=> (forall (($o@@65 T@U) ($f@@11 T@U) ) (!  (=> (and (and (or (not (= $o@@65 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@65) alloc)))) (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@65)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@65)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@65 $f@@11)))
 :qid |FlyingRobotsdfy.274:12|
 :skolemid |698|
)) (and (=> (= (ControlFlow 0 2) (- 0 24)) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@3 call1formal@this@0@@0)) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@3 call1formal@this@0@@0) (and (=> (= (ControlFlow 0 2) (- 0 23)) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@3 call1formal@this@0)) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@3 call1formal@this@0) (and (=> (= (ControlFlow 0 2) (- 0 22)) (=> (or (not (= call1formal@this@0@@0 call1formal@this@0)) (not true)) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call1formal@this@0@@0) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call1formal@this@0) _module.Bot.Repr))))) (=> (=> (or (not (= call1formal@this@0@@0 call1formal@this@0)) (not true)) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call1formal@this@0@@0) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call1formal@this@0) _module.Bot.Repr)))) (=> (and (and (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (and (|_module.Bot.Valid#canCall| $Heap@4 call1formal@this@0@@0) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@4 call1formal@this@0@@0))) (and (and (forall (($o@@66 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@66)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@66)))) (or (not (= $o@@66 null)) (not true)))
 :qid |FlyingRobotsdfy.163:25|
 :skolemid |514|
 :pattern (  (or (not (= $o@@66 null)) (not true)))
)) (forall (($o@@67 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@67)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@67)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@67) alloc)))))
 :qid |FlyingRobotsdfy.163:25|
 :skolemid |515|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@67) alloc)))
))) (and (|_module.Bot.Valid#canCall| $Heap@4 call1formal@this@0) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@4 call1formal@this@0)))) (=> (and (and (and (and (and (and (forall (($o@@68 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@68)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@68)))) (or (not (= $o@@68 null)) (not true)))
 :qid |FlyingRobotsdfy.164:25|
 :skolemid |516|
 :pattern (  (or (not (= $o@@68 null)) (not true)))
)) (forall (($o@@69 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@69)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@69)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@69) alloc)))))
 :qid |FlyingRobotsdfy.164:25|
 :skolemid |517|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@69) alloc)))
))) (=> (or (not (= call1formal@this@0@@0 call1formal@this@0)) (not true)) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call1formal@this@0@@0) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call1formal@this@0) _module.Bot.Repr))))) (and (|_module.Bot.robot__inv#canCall| $Heap@4 call1formal@this@0@@0) (=> (_module.Bot.robot__inv $Heap@4 call1formal@this@0@@0) (|_module.Bot.robot__inv#canCall| $Heap@4 call1formal@this@0)))) (and (and (|_module.Bot.robot__inv#canCall| $Heap@4 call1formal@this@0@@0) (and (_module.Bot.robot__inv $Heap@4 call1formal@this@0@@0) (=> (_module.Bot.flying $Heap@4 call1formal@this@0@@0) (_module.Bot.arms__up $Heap@4 call1formal@this@0@@0)))) (and (|_module.Bot.robot__inv#canCall| $Heap@4 call1formal@this@0) (and (_module.Bot.robot__inv $Heap@4 call1formal@this@0) (=> (_module.Bot.flying $Heap@4 call1formal@this@0) (_module.Bot.arms__up $Heap@4 call1formal@this@0)))))) (and (and (and (|_module.Bot.flying#canCall| $Heap@4 call1formal@this@0@@0) (=> (_module.Bot.flying $Heap@4 call1formal@this@0@@0) (|_module.Bot.flying#canCall| $Heap@4 call1formal@this@0))) (and (|_module.Bot.flying#canCall| $Heap@4 call1formal@this@0@@0) (and (_module.Bot.flying $Heap@4 call1formal@this@0@@0) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call1formal@this@0@@0) _module.Bot.pos))) _module.Point.z))) _module.Cell.val))) 0)))) (and (and (|_module.Bot.flying#canCall| $Heap@4 call1formal@this@0) (and (_module.Bot.flying $Heap@4 call1formal@this@0) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call1formal@this@0) _module.Bot.pos))) _module.Point.z))) _module.Cell.val))) 0))) (and (forall (($o@@70 T@U) ) (!  (=> (and (or (not (= $o@@70 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@70) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@70) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@70)) (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@70)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@70)))))
 :qid |FlyingRobotsdfy.158:8|
 :skolemid |518|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@70))
)) ($HeapSucc $Heap@3 $Heap@4))))) (and (and (and (and (or (not (= call1formal@this@@1 null)) (not true)) (and ($Is refType call1formal@this@@1 Tclass._module.Bot) ($IsAlloc refType call1formal@this@@1 Tclass._module.Bot $Heap@@8))) (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5))) (and (and (or (not (= call1formal@this@0@@1 null)) (not true)) (and ($Is refType call1formal@this@0@@1 Tclass._module.Bot) ($IsAlloc refType call1formal@this@0@@1 Tclass._module.Bot $Heap@5))) (and (|_module.Bot.Valid#canCall| $Heap@5 call1formal@this@0@@1) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@5 call1formal@this@0@@1)))) (and (and (and (forall (($o@@71 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0@@1) _module.Bot.Repr)) ($Box refType $o@@71)) (or (not (= $o@@71 null)) (not true)))
 :qid |FlyingRobotsdfy.110:24|
 :skolemid |815|
 :pattern (  (or (not (= $o@@71 null)) (not true)))
)) (forall (($o@@72 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0@@1) _module.Bot.Repr)) ($Box refType $o@@72)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@72) alloc)))))
 :qid |FlyingRobotsdfy.110:24|
 :skolemid |816|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0@@1) _module.Bot.Repr)) ($Box refType $o@@72)))
))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call1formal@this@0@@1) alloc))))) (and (forall (($o@@73 T@U) ) (!  (=> (and (or (not (= $o@@73 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@73) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@73) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@73)))
 :qid |FlyingRobotsdfy.109:3|
 :skolemid |817|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@73))
)) ($HeapSucc $Heap@4 $Heap@5))))) (and (=> (= (ControlFlow 0 2) (- 0 21)) true) (and (=> (= (ControlFlow 0 2) (- 0 20)) true) (and (=> (= (ControlFlow 0 2) (- 0 19)) true) (and (=> (= (ControlFlow 0 2) (- 0 18)) (forall (($o@@74 T@U) ($f@@12 T@U) ) (!  (=> (and (and (or (not (= $o@@74 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@74) alloc)))) (or (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@74)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@74))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0@@1) _module.Bot.Repr)) ($Box refType $o@@74)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@74 $f@@12)))
 :qid |FlyingRobotsdfy.277:11|
 :skolemid |700|
))) (=> (forall (($o@@75 T@U) ($f@@13 T@U) ) (!  (=> (and (and (or (not (= $o@@75 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@75) alloc)))) (or (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@75)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@75))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0@@1) _module.Bot.Repr)) ($Box refType $o@@75)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@75 $f@@13)))
 :qid |FlyingRobotsdfy.277:11|
 :skolemid |700|
)) (and (=> (= (ControlFlow 0 2) (- 0 17)) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@5 call1formal@this@0)) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@5 call1formal@this@0) (and (=> (= (ControlFlow 0 2) (- 0 16)) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@5 call1formal@this@0@@0)) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@5 call1formal@this@0@@0) (and (=> (= (ControlFlow 0 2) (- 0 15)) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@5 call1formal@this@0@@1)) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@5 call1formal@this@0@@1) (and (=> (= (ControlFlow 0 2) (- 0 14)) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0@@0) _module.Bot.Repr)))) (=> (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0@@0) _module.Bot.Repr))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0@@0) _module.Bot.Repr)))) (=> (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0@@0) _module.Bot.Repr))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (|Set#Disjoint| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0@@0) _module.Bot.Repr))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0@@1) _module.Bot.Repr)))) (=> (|Set#Disjoint| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0@@0) _module.Bot.Repr))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0@@1) _module.Bot.Repr))) (=> (and ($IsGoodHeap $Heap@6) ($IsHeapAnchor $Heap@6)) (=> (and (and (|_module.Bot.Valid#canCall| $Heap@6 call1formal@this@0) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@6 call1formal@this@0) (and (|_module.Bot.Valid#canCall| $Heap@6 call1formal@this@0@@0) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@6 call1formal@this@0@@0) (|_module.Bot.Valid#canCall| $Heap@6 call1formal@this@0@@1))))) (and (_module.Bot.Valid reveal__module.Bot.Valid $Heap@6 call1formal@this@0) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@6 call1formal@this@0@@0))) (=> (and (and (and (_module.Bot.Valid reveal__module.Bot.Valid $Heap@6 call1formal@this@0@@1) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0@@0) _module.Bot.Repr)))) (and (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0@@0) _module.Bot.Repr))) (|Set#Disjoint| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0@@0) _module.Bot.Repr))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0@@1) _module.Bot.Repr))))) (and (and (forall (($o@@76 T@U) ) (!  (=> (and (or (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@76)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@76))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0@@1) _module.Bot.Repr)) ($Box refType $o@@76))) (not (|Set#IsMember| (|Set#Union| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0@@0) _module.Bot.Repr))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0@@1) _module.Bot.Repr))) ($Box refType $o@@76)))) (or (not (= $o@@76 null)) (not true)))
 :qid |FlyingRobotsdfy.251:11|
 :skolemid |681|
 :pattern (  (or (not (= $o@@76 null)) (not true)))
)) (forall (($o@@77 T@U) ) (!  (=> (and (or (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@77)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@77))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0@@1) _module.Bot.Repr)) ($Box refType $o@@77))) (not (|Set#IsMember| (|Set#Union| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0@@0) _module.Bot.Repr))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0@@1) _module.Bot.Repr))) ($Box refType $o@@77)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@77) alloc)))))
 :qid |FlyingRobotsdfy.251:11|
 :skolemid |682|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@77) alloc)))
))) (and (forall (($o@@78 T@U) ) (!  (=> (and (or (not (= $o@@78 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@78) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@78) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@78)) (or (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@78)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@78))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0@@1) _module.Bot.Repr)) ($Box refType $o@@78)))))
 :qid |FlyingRobotsdfy.245:8|
 :skolemid |683|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@78))
)) ($HeapSucc $Heap@5 $Heap@6)))) (and (=> (= (ControlFlow 0 2) (- 0 11)) true) (and (=> (= (ControlFlow 0 2) (- 0 10)) true) (and (=> (= (ControlFlow 0 2) (- 0 9)) true) (and (=> (= (ControlFlow 0 2) (- 0 8)) (forall (($o@@79 T@U) ($f@@14 T@U) ) (!  (=> (and (and (or (not (= $o@@79 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@79) alloc)))) (or (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0@@1) _module.Bot.Repr)) ($Box refType $o@@79)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@79))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@79)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@79 $f@@14)))
 :qid |FlyingRobotsdfy.278:11|
 :skolemid |701|
))) (=> (forall (($o@@80 T@U) ($f@@15 T@U) ) (!  (=> (and (and (or (not (= $o@@80 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@80) alloc)))) (or (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0@@1) _module.Bot.Repr)) ($Box refType $o@@80)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0) _module.Bot.Repr)) ($Box refType $o@@80))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0@@0) _module.Bot.Repr)) ($Box refType $o@@80)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@80 $f@@15)))
 :qid |FlyingRobotsdfy.278:11|
 :skolemid |701|
)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@6 call1formal@this@0@@1)) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@6 call1formal@this@0@@1) (and (=> (= (ControlFlow 0 2) (- 0 6)) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@6 call1formal@this@0)) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@6 call1formal@this@0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@6 call1formal@this@0@@0)) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@6 call1formal@this@0@@0) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0@@1) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0) _module.Bot.Repr)))) (=> (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0@@1) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0) _module.Bot.Repr))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0@@1) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0) _module.Bot.Repr)))) (=> (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0@@1) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0) _module.Bot.Repr))) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#Disjoint| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0@@1) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0) _module.Bot.Repr))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0@@0) _module.Bot.Repr)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@8) ($IsHeapAnchor $Heap@@8)) (=> (and (and (and (=> |defass#b0#0| (and ($Is refType |b0#0| Tclass._module.Bot) ($IsAlloc refType |b0#0| Tclass._module.Bot $Heap@@8))) true) (and (=> |defass#b1#0| (and ($Is refType |b1#0| Tclass._module.Bot) ($IsAlloc refType |b1#0| Tclass._module.Bot $Heap@@8))) true)) (and (and (=> |defass#b2#0| (and ($Is refType |b2#0| Tclass._module.Bot) ($IsAlloc refType |b2#0| Tclass._module.Bot $Heap@@8))) true) (and (= 9 $FunctionContextHeight) (= (ControlFlow 0 40) 2)))) anon0_correct))))
