...
(declare-fun _module.__default.five (T@U) Int)
(declare-fun |_module.__default.five#canCall| (T@U) Bool)
...
(assert (distinct TInt TReal TagInt TagReal alloc Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 Tagclass._System.___hTotalFunc1 |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1| |tytagFamily$_#TotalFunc1|)
)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|f#0@@1| T@U) ) (!  (=> (or (|_module.__default.five#canCall| |f#0@@1|) (and (< 0 $FunctionContextHeight) ($Is HandleTypeType |f#0@@1| (Tclass._System.___hTotalFunc1 TInt TInt)))) (= (_module.__default.five |f#0@@1|) (LitInt 5)))
 :qid |Bug49dfy.61:15|
 :skolemid |546|
 :pattern ( (_module.__default.five |f#0@@1|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|f#0@@2| T@U) ) (!  (=> (or (|_module.__default.five#canCall| (Lit HandleTypeType |f#0@@2|)) (and (< 0 $FunctionContextHeight) ($Is HandleTypeType |f#0@@2| (Tclass._System.___hTotalFunc1 TInt TInt)))) (= (_module.__default.five (Lit HandleTypeType |f#0@@2|)) (LitInt 5)))
 :qid |Bug49dfy.61:15|
 :weight 3
 :skolemid |547|
 :pattern ( (_module.__default.five (Lit HandleTypeType |f#0@@2|)))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |f#0@0| ($Unbox HandleTypeType (Apply1 TReal (Tclass._System.___hTotalFunc1 TInt TInt) $Heap |g#0| ($Box realType (real_2_U (LitReal 0.0))))))) (=> (and (and ($IsAlloc HandleTypeType |f#0@0| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap) (|_module.__default.five#canCall| |f#0@0|)) (and (|_module.__default.five#canCall| |f#0@0|) (= (ControlFlow 0 2) (- 0 1)))) (= (_module.__default.five |f#0@0|) (LitInt 5))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 TReal (Tclass._System.___hTotalFunc1 TInt TInt))) ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 TReal (Tclass._System.___hTotalFunc1 TInt TInt)) $Heap))) (=> (and (and (and (and ($Is HandleTypeType |f#0@@5| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |f#0@@5| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap)) true) (= 1 $FunctionContextHeight)) (and (Requires1 TReal (Tclass._System.___hTotalFunc1 TInt TInt) $Heap |g#0| ($Box realType (real_2_U (LitReal 0.0)))) (= (ControlFlow 0 3) 2))) anon0_correct))))
