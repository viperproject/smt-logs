...
(declare-fun _module.__default.UpFunction_k (T@U Int) T@U)
(declare-fun |_module.__default.UpFunction_k#canCall| (Int) Bool)
(declare-fun Tclass._System.___hTotalFunc1 (T@U T@U) T@U)
(declare-fun $HeapSucc (T@U T@U) Bool)
(declare-fun LitInt (Int) Int)
(declare-fun Lit (T@T T@U) T@U)
(declare-fun LayerTypeType () T@T)
(declare-fun |lambda#21| (T@U T@U Int T@U T@U) T@U)
(declare-fun $OneHeap () T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |Set#Equal| (T@U T@U) Bool)
(declare-fun |lambda#26| (T@U T@U Int T@U T@U) T@U)
...
))) (= (Ctor refType) 4)) (= (Ctor FieldType) 5)) (= (Ctor BoxType) 6)) (= (Ctor DatatypeTypeType) 7)))
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|$l#0#heap#0| T@U) (|$l#0#k#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#17| |l#0| |l#1| |l#2|) |$l#0#heap#0| |$l#0#k#0|) ($Box DatatypeTypeType (|#_module.Stream.ICons| |$l#0#k#0| ($Unbox DatatypeTypeType (Apply1 |l#0| |l#1| |$l#0#heap#0| |l#2| ($Box intType ($Unbox intType |$l#0#k#0|)))))))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |528|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#17| |l#0| |l#1| |l#2|) |$l#0#heap#0| |$l#0#k#0|))
)))
...
(assert (forall ((|l#0@@0| T@U) (|$l#0#heap#0@@0| T@U) (|$l#0#k#0@@0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#1| |l#0@@0|) |$l#0#heap#0@@0| |$l#0#k#0@@0|)) ($IsBox |$l#0#k#0@@0| |l#0@@0|))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |523|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#1| |l#0@@0|) |$l#0#heap#0@@0| |$l#0#k#0@@0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly T@U) (|n#0| Int) ) (!  (=> (or (|_module.__default.UpFunction_k#canCall| |n#0|) (< 1 $FunctionContextHeight)) ($Is HandleTypeType (_module.__default.UpFunction_k $ly |n#0|) (Tclass._System.___hTotalFunc1 TInt (Tclass._module.Stream TInt))))
 :qid |ExpandedGuardednessNegdfy.11:16|
 :skolemid |494|
 :pattern ( (_module.__default.UpFunction_k $ly |n#0|))
))))
...
(assert (forall ((|l#0@@1| T@U) (|l#1@@0| T@U) (|l#2@@0| Int) (|l#3| T@U) (|l#4| T@U) (|$l#0#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#21| |l#0@@1| |l#1@@0| |l#2@@0| |l#3| |l#4|) |$l#0#ly#0|) (Handle1 (|lambda#17| |l#0@@1| |l#1@@0| (_module.__default.UpFunction_k |$l#0#ly#0| |l#2@@0|)) |l#3| |l#4|))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |529|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#21| |l#0@@1| |l#1@@0| |l#2@@0| |l#3| |l#4|) |$l#0#ly#0|))
)))
...
(assert (forall ((|l#0@@2| T@U) (|l#1@@1| T@U) (|l#2@@1| Int) (|l#3@@0| T@U) (|l#4@@0| T@U) (|$l#2#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#26| |l#0@@2| |l#1@@1| |l#2@@1| |l#3@@0| |l#4@@0|) |$l#2#ly#0|) (Handle1 (|lambda#17| |l#0@@2| |l#1@@1| (Lit HandleTypeType (_module.__default.UpFunction_k |$l#2#ly#0| |l#2@@1|))) |l#3@@0| |l#4@@0|))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |530|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#26| |l#0@@2| |l#1@@1| |l#2@@1| |l#3@@0| |l#4@@0|) |$l#2#ly#0|))
)))
...
(assert (forall ((d@@1 T@U) ) (!  (=> (_module.Stream.ICons_q d@@1) (exists ((|a#1#0#0| T@U) (|a#1#1#0| T@U) ) (! (= d@@1 (|#_module.Stream.ICons| |a#1#0#0| |a#1#1#0|))
 :qid |ExpandedGuardednessNegdfy.4:30|
 :skolemid |501|
)))
 :qid |unknown.0:0|
 :skolemid |502|
 :pattern ( (_module.Stream.ICons_q d@@1))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@0 T@U) ($Heap T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.__default.UpFunction_k#canCall| (LitInt |n#0@@0|)) (and (< 1 $FunctionContextHeight) ($IsGoodHeap $Heap))) (and (|_module.__default.UpFunction_k#canCall| (LitInt (+ |n#0@@0| 1))) (= (_module.__default.UpFunction_k ($LS $ly@@0) (LitInt |n#0@@0|)) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#26| TInt (Tclass._module.Stream TInt) (LitInt (+ |n#0@@0| 1)) (|lambda#1| TInt) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false)))) ($LS $ly@@0))))))
 :qid |ExpandedGuardednessNegdfy.11:16|
 :weight 3
 :skolemid |497|
 :pattern ( (_module.__default.UpFunction_k ($LS $ly@@0) (LitInt |n#0@@0|)) ($IsGoodHeap $Heap))
))))
...
(assert (forall (($ly@@1 T@U) (|n#0@@1| Int) ) (! (= (_module.__default.UpFunction_k ($LS $ly@@1) |n#0@@1|) (_module.__default.UpFunction_k $ly@@1 |n#0@@1|))
 :qid |ExpandedGuardednessNegdfy.11:16|
 :skolemid |492|
 :pattern ( (_module.__default.UpFunction_k ($LS $ly@@1) |n#0@@1|))
)))
...
(assert (forall ((d@@2 T@U) (_module.Stream$T@@3 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (_module.Stream.ICons_q d@@2) ($IsAlloc DatatypeTypeType d@@2 (Tclass._module.Stream _module.Stream$T@@3) $h@@3))) ($IsAllocBox (_module.Stream.head d@@2) _module.Stream$T@@3 $h@@3))
 :qid |unknown.0:0|
 :skolemid |505|
 :pattern ( ($IsAllocBox (_module.Stream.head d@@2) _module.Stream$T@@3 $h@@3))
)))
(assert (forall ((|l#0@@4| T@U) (|l#1@@2| T@U) (|l#2@@2| T@U) (|l#3@@1| Bool) ($o@@1 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#10| |l#0@@4| |l#1@@2| |l#2@@2| |l#3@@1|) $o@@1 $f))  (=> (and (or (not (= $o@@1 |l#0@@4|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@2| $o@@1) |l#2@@2|)))) |l#3@@1|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |527|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#10| |l#0@@4| |l#1@@2| |l#2@@2| |l#3@@1|) $o@@1 $f))
)))
...
(assert (forall ((_module.Stream$T@@4 T@U) (bx@@13 T@U) ) (!  (=> ($IsBox bx@@13 (Tclass._module.Stream _module.Stream$T@@4)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@13)) bx@@13) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@13) (Tclass._module.Stream _module.Stream$T@@4))))
 :qid |unknown.0:0|
 :skolemid |483|
 :pattern ( ($IsBox bx@@13 (Tclass._module.Stream _module.Stream$T@@4)))
)))
(assert (forall ((d@@3 T@U) (_module.Stream$T@@5 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (_module.Stream.ICons_q d@@3) ($IsAlloc DatatypeTypeType d@@3 (Tclass._module.Stream _module.Stream$T@@5) $h@@4))) ($IsAlloc DatatypeTypeType (_module.Stream.tail d@@3) (Tclass._module.Stream _module.Stream$T@@5) $h@@4))
 :qid |unknown.0:0|
 :skolemid |506|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Stream.tail d@@3) (Tclass._module.Stream _module.Stream$T@@5) $h@@4))
)))
...
(assert (forall ((_module.Stream$T@@6 T@U) (|a#2#0#0@@0| T@U) (|a#2#1#0@@0| T@U) ($h@@5 T@U) ) (!  (=> ($IsGoodHeap $h@@5) (= ($IsAlloc DatatypeTypeType (|#_module.Stream.ICons| |a#2#0#0@@0| |a#2#1#0@@0|) (Tclass._module.Stream _module.Stream$T@@6) $h@@5)  (and ($IsAllocBox |a#2#0#0@@0| _module.Stream$T@@6 $h@@5) ($IsAlloc DatatypeTypeType |a#2#1#0@@0| (Tclass._module.Stream _module.Stream$T@@6) $h@@5))))
 :qid |unknown.0:0|
 :skolemid |504|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.Stream.ICons| |a#2#0#0@@0| |a#2#1#0@@0|) (Tclass._module.Stream _module.Stream$T@@6) $h@@5))
)))
(assert (forall ((|l#0@@5| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#k#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#3| |l#0@@5|) |$l#0#heap#0@@1| |$l#0#k#0@@1|) |l#0@@5|)
 :qid |ExpandedGuardednessNegdfy.8:4|
 :skolemid |525|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#3| |l#0@@5|) |$l#0#heap#0@@1| |$l#0#k#0@@1|))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) ($Heap@@0 T@U) (|n#0@@2| Int) ) (!  (=> (or (|_module.__default.UpFunction_k#canCall| |n#0@@2|) (and (< 1 $FunctionContextHeight) ($IsGoodHeap $Heap@@0))) (and (|_module.__default.UpFunction_k#canCall| (+ |n#0@@2| 1)) (= (_module.__default.UpFunction_k ($LS $ly@@2) |n#0@@2|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#21| TInt (Tclass._module.Stream TInt) (+ |n#0@@2| 1) (|lambda#1| TInt) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false)))) $ly@@2)))))
 :qid |ExpandedGuardednessNegdfy.11:16|
 :skolemid |496|
 :pattern ( (_module.__default.UpFunction_k ($LS $ly@@2) |n#0@@2|) ($IsGoodHeap $Heap@@0))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.UpFunction_k)
...
(let ((anon11_Then_correct  (=> (= |$_Frame#l0@0| (|lambda#10| null |$lambdaHeap#0@0| alloc false)) (=> (and (= |##n#0@0| (+ |n#0@@3| 1)) ($IsAlloc intType (int_2_U |##n#0@0|) TInt |$lambdaHeap#0@0|)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (<= 0 |n#0@@3|) (= |##n#0@0| |n#0@@3|))) (=> (or (<= 0 |n#0@@3|) (= |##n#0@0| |n#0@@3|)) (=> (= (ControlFlow 0 4) (- 0 3)) (< |##n#0@0| |n#0@@3|))))))))
(let ((anon10_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@1 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@1 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 7) 4) anon11_Then_correct) (=> (= (ControlFlow 0 7) 6) anon11_Else_correct)))))
(let ((anon10_Else_correct true))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#10| null $Heap@@1 alloc false)) (and (and (=> (= (ControlFlow 0 8) 1) anon9_Then_correct) (=> (= (ControlFlow 0 8) 7) anon10_Then_correct)) (=> (= (ControlFlow 0 8) 2) anon10_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct)))
