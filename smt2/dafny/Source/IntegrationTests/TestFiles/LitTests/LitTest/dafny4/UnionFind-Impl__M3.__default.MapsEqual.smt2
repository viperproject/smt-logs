...
(declare-fun M3._default.MapsEqual$D () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$M3.__default.MapsEqual)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |m#0| (TMap M3._default.MapsEqual$D M3._default.MapsEqual$D)) ($IsAlloc MapType |m#0| (TMap M3._default.MapsEqual$D M3._default.MapsEqual$D) $Heap)) (and ($Is MapType |n#0| (TMap M3._default.MapsEqual$D M3._default.MapsEqual$D)) ($IsAlloc MapType |n#0| (TMap M3._default.MapsEqual$D M3._default.MapsEqual$D) $Heap))) (and (and (= 0 $FunctionContextHeight) (forall ((|d#1| T@U) ) (!  (=> (and ($IsBox |d#1| M3._default.MapsEqual$D) ($IsAllocBox |d#1| M3._default.MapsEqual$D $Heap)) (= (|Set#IsMember| (|Map#Domain| |m#0|) |d#1|) (|Set#IsMember| (|Map#Domain| |n#0|) |d#1|)))
 :qid |UnionFinddfy.117:21|
 :skolemid |2911|
 :pattern ( (|Set#IsMember| (|Map#Domain| |n#0|) |d#1|))
 :pattern ( (|Set#IsMember| (|Map#Domain| |m#0|) |d#1|))
))) (and (forall ((|d#3| T@U) ) (!  (=> ($IsBox |d#3| M3._default.MapsEqual$D) (=> (|Set#IsMember| (|Map#Domain| |m#0|) |d#3|) (= (MapType0Select BoxType BoxType (|Map#Elements| |m#0|) |d#3|) (MapType0Select BoxType BoxType (|Map#Elements| |n#0|) |d#3|))))
