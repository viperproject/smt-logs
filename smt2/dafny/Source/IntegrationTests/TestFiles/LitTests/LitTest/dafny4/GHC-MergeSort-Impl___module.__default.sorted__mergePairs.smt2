...
(assert (forall (($ly@@14 T@U) (|xs#0@@11| T@U) ) (! (= (_module.__default.sorted ($LS $ly@@14) |xs#0@@11|) (_module.__default.sorted $ly@@14 |xs#0@@11|))
 :qid |GHCMergeSortdfy.151:17|
 :skolemid |704|
 :pattern ( (_module.__default.sorted ($LS $ly@@14) |xs#0@@11|))
)))
(assert (forall (($ly@@15 T@U) (|x#0@@3| T@U) ) (! (= (_module.__default.AllSorted ($LS $ly@@15) |x#0@@3|) (_module.__default.AllSorted $ly@@15 |x#0@@3|))
 :qid |GHCMergeSortdfy.315:17|
 :skolemid |792|
 :pattern ( (_module.__default.AllSorted ($LS $ly@@15) |x#0@@3|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@16 T@U) (|xs#0@@12| T@U) (|ys#0@@5| T@U) ) (!  (=> (or (|_module.__default.merge#canCall| |xs#0@@12| |ys#0@@5|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@12| (Tclass._module.List Tclass._module.G)) ($Is DatatypeTypeType |ys#0@@5| (Tclass._module.List Tclass._module.G))))) ($Is DatatypeTypeType (_module.__default.merge $ly@@16 |xs#0@@12| |ys#0@@5|) (Tclass._module.List Tclass._module.G)))
 :qid |GHCMergeSortdfy.138:10|
 :skolemid |697|
 :pattern ( (_module.__default.merge $ly@@16 |xs#0@@12| |ys#0@@5|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.multiset_of$T@@2 T@U) ($ly@@17 T@U) (|xs#0@@13| T@U) ) (!  (=> (and (or (|_module.__default.multiset__of#canCall| _module._default.multiset_of$T@@2 |xs#0@@13|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@13| (Tclass._module.List _module._default.multiset_of$T@@2)) ($IsAlloc DatatypeTypeType |xs#0@@13| (Tclass._module.List _module._default.multiset_of$T@@2) $Heap)))) ($IsGoodHeap $Heap)) ($IsAlloc MultiSetType (_module.__default.multiset__of _module._default.multiset_of$T@@2 $ly@@17 |xs#0@@13|) (TMultiSet _module._default.multiset_of$T@@2) $Heap))
 :qid |GHCMergeSortdfy.31:16|
 :skolemid |602|
 :pattern ( ($IsAlloc MultiSetType (_module.__default.multiset__of _module._default.multiset_of$T@@2 $ly@@17 |xs#0@@13|) (TMultiSet _module._default.multiset_of$T@@2) $Heap))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.length$_T0@@2 T@U) ($ly@@21 T@U) (|xs#0@@15| T@U) ) (!  (=> (or (|_module.__default.length#canCall| _module._default.length$_T0@@2 |xs#0@@15|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@15| (Tclass._module.List _module._default.length$_T0@@2)))) (<= (LitInt 0) (_module.__default.length _module._default.length$_T0@@2 $ly@@21 |xs#0@@15|)))
 :qid |unknown.0:0|
 :skolemid |586|
 :pattern ( (_module.__default.length _module._default.length$_T0@@2 $ly@@21 |xs#0@@15|))
))))
...
(declare-fun $Heap@@0 () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.sorted__mergePairs)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.__default.AllSorted#canCall| (_module.__default.mergePairs ($LS $LZ) |x#0@@6|)) (or (_module.__default.AllSorted ($LS $LZ) (_module.__default.mergePairs ($LS $LZ) |x#0@@6|)) (=> (_module.List.Nil_q (_module.__default.mergePairs ($LS $LZ) |x#0@@6|)) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (|_module.__default.AllSorted#canCall| (_module.__default.mergePairs ($LS $LZ) |x#0@@6|)) (or (_module.__default.AllSorted ($LS $LZ) (_module.__default.mergePairs ($LS $LZ) |x#0@@6|)) (=> (_module.List.Nil_q (_module.__default.mergePairs ($LS $LZ) |x#0@@6|)) (U_2_bool (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.__default.AllSorted#canCall| (_module.__default.mergePairs ($LS $LZ) |x#0@@6|)) (or (_module.__default.AllSorted ($LS $LZ) (_module.__default.mergePairs ($LS $LZ) |x#0@@6|)) (=> (not (_module.List.Nil_q (_module.__default.mergePairs ($LS $LZ) |x#0@@6|))) (let ((|xs#6| ($Unbox DatatypeTypeType (_module.List.head (_module.__default.mergePairs ($LS ($LS $LZ)) |x#0@@6|)))))
 (=> (|_module.__default.sorted#canCall| |xs#6|) (or (_module.__default.sorted ($LS $LZ) |xs#6|) (=> (_module.List.Nil_q |xs#6|) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (=> (=> (|_module.__default.AllSorted#canCall| (_module.__default.mergePairs ($LS $LZ) |x#0@@6|)) (or (_module.__default.AllSorted ($LS $LZ) (_module.__default.mergePairs ($LS $LZ) |x#0@@6|)) (=> (not (_module.List.Nil_q (_module.__default.mergePairs ($LS $LZ) |x#0@@6|))) (let ((|xs#6@@0| ($Unbox DatatypeTypeType (_module.List.head (_module.__default.mergePairs ($LS ($LS $LZ)) |x#0@@6|)))))
 (=> (|_module.__default.sorted#canCall| |xs#6@@0|) (or (_module.__default.sorted ($LS $LZ) |xs#6@@0|) (=> (_module.List.Nil_q |xs#6@@0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.__default.AllSorted#canCall| (_module.__default.mergePairs ($LS $LZ) |x#0@@6|)) (or (_module.__default.AllSorted ($LS $LZ) (_module.__default.mergePairs ($LS $LZ) |x#0@@6|)) (=> (not (_module.List.Nil_q (_module.__default.mergePairs ($LS $LZ) |x#0@@6|))) (let ((|xs#6@@1| ($Unbox DatatypeTypeType (_module.List.head (_module.__default.mergePairs ($LS ($LS $LZ)) |x#0@@6|)))))
 (=> (|_module.__default.sorted#canCall| |xs#6@@1|) (or (_module.__default.sorted ($LS $LZ) |xs#6@@1|) (=> (not (_module.List.Nil_q |xs#6@@1|)) (let ((|ys#6| (_module.List.tail |xs#6@@1|)))
(let ((|a#6| (_module.List.head |xs#6@@1|)))
(forall ((|y#12| T@U) ) (!  (=> ($IsBox |y#12| Tclass._module.G) (=> (> (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |ys#6|) |y#12|) 0) (_module.__default.Below |a#6| |y#12|)))
 :qid |GHCMergeSortdfy.156:13|
 :skolemid |990|
 :pattern ( (_module.__default.Below |a#6| |y#12|))
 :pattern ( (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |ys#6|) |y#12|))
)))))))))))) (=> (=> (|_module.__default.AllSorted#canCall| (_module.__default.mergePairs ($LS $LZ) |x#0@@6|)) (or (_module.__default.AllSorted ($LS $LZ) (_module.__default.mergePairs ($LS $LZ) |x#0@@6|)) (=> (not (_module.List.Nil_q (_module.__default.mergePairs ($LS $LZ) |x#0@@6|))) (let ((|xs#6@@2| ($Unbox DatatypeTypeType (_module.List.head (_module.__default.mergePairs ($LS ($LS $LZ)) |x#0@@6|)))))
 (=> (|_module.__default.sorted#canCall| |xs#6@@2|) (or (_module.__default.sorted ($LS $LZ) |xs#6@@2|) (=> (not (_module.List.Nil_q |xs#6@@2|)) (let ((|ys#6@@0| (_module.List.tail |xs#6@@2|)))
(let ((|a#6@@0| (_module.List.head |xs#6@@2|)))
(forall ((|y#12@@0| T@U) ) (!  (=> ($IsBox |y#12@@0| Tclass._module.G) (=> (> (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |ys#6@@0|) |y#12@@0|) 0) (_module.__default.Below |a#6@@0| |y#12@@0|)))
 :qid |GHCMergeSortdfy.156:13|
 :skolemid |990|
 :pattern ( (_module.__default.Below |a#6@@0| |y#12@@0|))
 :pattern ( (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |ys#6@@0|) |y#12@@0|))
))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.__default.AllSorted#canCall| (_module.__default.mergePairs ($LS $LZ) |x#0@@6|)) (or (_module.__default.AllSorted ($LS $LZ) (_module.__default.mergePairs ($LS $LZ) |x#0@@6|)) (=> (not (_module.List.Nil_q (_module.__default.mergePairs ($LS $LZ) |x#0@@6|))) (let ((|xs#6@@3| ($Unbox DatatypeTypeType (_module.List.head (_module.__default.mergePairs ($LS ($LS $LZ)) |x#0@@6|)))))
 (=> (|_module.__default.sorted#canCall| |xs#6@@3|) (or (_module.__default.sorted ($LS $LZ) |xs#6@@3|) (=> (not (_module.List.Nil_q |xs#6@@3|)) (let ((|ys#6@@1| (_module.List.tail |xs#6@@3|)))
(_module.__default.sorted ($LS ($LS $LZ)) |ys#6@@1|)))))))))) (=> (=> (|_module.__default.AllSorted#canCall| (_module.__default.mergePairs ($LS $LZ) |x#0@@6|)) (or (_module.__default.AllSorted ($LS $LZ) (_module.__default.mergePairs ($LS $LZ) |x#0@@6|)) (=> (not (_module.List.Nil_q (_module.__default.mergePairs ($LS $LZ) |x#0@@6|))) (let ((|xs#6@@4| ($Unbox DatatypeTypeType (_module.List.head (_module.__default.mergePairs ($LS ($LS $LZ)) |x#0@@6|)))))
 (=> (|_module.__default.sorted#canCall| |xs#6@@4|) (or (_module.__default.sorted ($LS $LZ) |xs#6@@4|) (=> (not (_module.List.Nil_q |xs#6@@4|)) (let ((|ys#6@@2| (_module.List.tail |xs#6@@4|)))
(_module.__default.sorted ($LS ($LS $LZ)) |ys#6@@2|))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.__default.AllSorted#canCall| (_module.__default.mergePairs ($LS $LZ) |x#0@@6|)) (or (_module.__default.AllSorted ($LS $LZ) (_module.__default.mergePairs ($LS $LZ) |x#0@@6|)) (=> (not (_module.List.Nil_q (_module.__default.mergePairs ($LS $LZ) |x#0@@6|))) (let ((|y#14| (_module.List.tail (_module.__default.mergePairs ($LS ($LS $LZ)) |x#0@@6|))))
(_module.__default.AllSorted ($LS ($LS $LZ)) |y#14|))))))))))))))))
(let ((anon6_Else_correct  (=> (and (not (and (_module.List.Cons_q |x#0@@6|) (_module.List.Cons_q (_module.List.tail |x#0@@6|)))) (= (ControlFlow 0 17) 2)) GeneratedUnifiedExit_correct)))
(let ((anon6_Then_correct  (=> (and (_module.List.Cons_q |x#0@@6|) (_module.List.Cons_q (_module.List.tail |x#0@@6|))) (and (=> (= (ControlFlow 0 7) (- 0 16)) (_module.List.Cons_q |x#0@@6|)) (=> (_module.List.Cons_q |x#0@@6|) (=> (= |xs##0_0@0| ($Unbox DatatypeTypeType (_module.List.head |x#0@@6|))) (and (=> (= (ControlFlow 0 7) (- 0 15)) (_module.List.Cons_q |x#0@@6|)) (=> (_module.List.Cons_q |x#0@@6|) (and (=> (= (ControlFlow 0 7) (- 0 14)) (_module.List.Cons_q (_module.List.tail |x#0@@6|))) (=> (_module.List.Cons_q (_module.List.tail |x#0@@6|)) (=> (= |ys##0_0@0| ($Unbox DatatypeTypeType (_module.List.head (_module.List.tail |x#0@@6|)))) (and (=> (= (ControlFlow 0 7) (- 0 13)) (=> (|_module.__default.sorted#canCall| |xs##0_0@0|) (or (_module.__default.sorted ($LS $LZ) |xs##0_0@0|) (=> (_module.List.Nil_q |xs##0_0@0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (|_module.__default.sorted#canCall| |xs##0_0@0|) (or (_module.__default.sorted ($LS $LZ) |xs##0_0@0|) (=> (_module.List.Nil_q |xs##0_0@0|) (U_2_bool (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 7) (- 0 12)) (=> (|_module.__default.sorted#canCall| |xs##0_0@0|) (or (_module.__default.sorted ($LS $LZ) |xs##0_0@0|) (=> (not (_module.List.Nil_q |xs##0_0@0|)) (let ((|ys#1@@2| (_module.List.tail |xs##0_0@0|)))
(let ((|a#0@@4| (_module.List.head |xs##0_0@0|)))
(forall ((|y#0@@1| T@U) ) (!  (=> ($IsBox |y#0@@1| Tclass._module.G) (=> (> (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |ys#1@@2|) |y#0@@1|) 0) (_module.__default.Below |a#0@@4| |y#0@@1|)))
 :qid |GHCMergeSortdfy.156:13|
 :skolemid |995|
 :pattern ( (_module.__default.Below |a#0@@4| |y#0@@1|))
 :pattern ( (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |ys#1@@2|) |y#0@@1|))
)))))))) (=> (=> (|_module.__default.sorted#canCall| |xs##0_0@0|) (or (_module.__default.sorted ($LS $LZ) |xs##0_0@0|) (=> (not (_module.List.Nil_q |xs##0_0@0|)) (let ((|ys#1@@3| (_module.List.tail |xs##0_0@0|)))
(let ((|a#0@@5| (_module.List.head |xs##0_0@0|)))
...
))))))) (and (=> (= (ControlFlow 0 7) (- 0 11)) (=> (|_module.__default.sorted#canCall| |xs##0_0@0|) (or (_module.__default.sorted ($LS $LZ) |xs##0_0@0|) (=> (not (_module.List.Nil_q |xs##0_0@0|)) (let ((|ys#1@@4| (_module.List.tail |xs##0_0@0|)))
(_module.__default.sorted ($LS ($LS $LZ)) |ys#1@@4|)))))) (=> (=> (|_module.__default.sorted#canCall| |xs##0_0@0|) (or (_module.__default.sorted ($LS $LZ) |xs##0_0@0|) (=> (not (_module.List.Nil_q |xs##0_0@0|)) (let ((|ys#1@@5| (_module.List.tail |xs##0_0@0|)))
(_module.__default.sorted ($LS ($LS $LZ)) |ys#1@@5|))))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (=> (|_module.__default.sorted#canCall| |ys##0_0@0|) (or (_module.__default.sorted ($LS $LZ) |ys##0_0@0|) (=> (_module.List.Nil_q |ys##0_0@0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (|_module.__default.sorted#canCall| |ys##0_0@0|) (or (_module.__default.sorted ($LS $LZ) |ys##0_0@0|) (=> (_module.List.Nil_q |ys##0_0@0|) (U_2_bool (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (=> (|_module.__default.sorted#canCall| |ys##0_0@0|) (or (_module.__default.sorted ($LS $LZ) |ys##0_0@0|) (=> (not (_module.List.Nil_q |ys##0_0@0|)) (let ((|ys#3@@2| (_module.List.tail |ys##0_0@0|)))
(let ((|a#2@@2| (_module.List.head |ys##0_0@0|)))
(forall ((|y#2@@1| T@U) ) (!  (=> ($IsBox |y#2@@1| Tclass._module.G) (=> (> (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |ys#3@@2|) |y#2@@1|) 0) (_module.__default.Below |a#2@@2| |y#2@@1|)))
 :qid |GHCMergeSortdfy.156:13|
 :skolemid |998|
 :pattern ( (_module.__default.Below |a#2@@2| |y#2@@1|))
 :pattern ( (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |ys#3@@2|) |y#2@@1|))
)))))))) (=> (=> (|_module.__default.sorted#canCall| |ys##0_0@0|) (or (_module.__default.sorted ($LS $LZ) |ys##0_0@0|) (=> (not (_module.List.Nil_q |ys##0_0@0|)) (let ((|ys#3@@3| (_module.List.tail |ys##0_0@0|)))
(let ((|a#2@@3| (_module.List.head |ys##0_0@0|)))
(forall ((|y#2@@2| T@U) ) (!  (=> ($IsBox |y#2@@2| Tclass._module.G) (=> (> (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |ys#3@@3|) |y#2@@2|) 0) (_module.__default.Below |a#2@@3| |y#2@@2|)))
 :qid |GHCMergeSortdfy.156:13|
 :skolemid |998|
 :pattern ( (_module.__default.Below |a#2@@3| |y#2@@2|))
 :pattern ( (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |ys#3@@3|) |y#2@@2|))
))))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (=> (|_module.__default.sorted#canCall| |ys##0_0@0|) (or (_module.__default.sorted ($LS $LZ) |ys##0_0@0|) (=> (not (_module.List.Nil_q |ys##0_0@0|)) (let ((|ys#3@@4| (_module.List.tail |ys##0_0@0|)))
(_module.__default.sorted ($LS ($LS $LZ)) |ys#3@@4|)))))) (=> (=> (|_module.__default.sorted#canCall| |ys##0_0@0|) (or (_module.__default.sorted ($LS $LZ) |ys##0_0@0|) (=> (not (_module.List.Nil_q |ys##0_0@0|)) (let ((|ys#3@@5| (_module.List.tail |ys##0_0@0|)))
(_module.__default.sorted ($LS ($LS $LZ)) |ys#3@@5|))))) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (|_module.__default.merge#canCall| |xs##0_0@0| |ys##0_0@0|) (|_module.__default.sorted#canCall| (_module.__default.merge ($LS $LZ) |xs##0_0@0| |ys##0_0@0|)))) (and (and (|_module.__default.sorted#canCall| (_module.__default.merge ($LS $LZ) |xs##0_0@0| |ys##0_0@0|)) (and (_module.__default.sorted ($LS $LZ) (_module.__default.merge ($LS $LZ) |xs##0_0@0| |ys##0_0@0|)) (ite (_module.List.Nil_q (_module.__default.merge ($LS $LZ) |xs##0_0@0| |ys##0_0@0|)) true (let ((|ys#6@@3| (_module.List.tail (_module.__default.merge ($LS $LZ) |xs##0_0@0| |ys##0_0@0|))))
(let ((|a#5| (_module.List.head (_module.__default.merge ($LS $LZ) |xs##0_0@0| |ys##0_0@0|))))
 (and (forall ((|y#5| T@U) ) (!  (=> ($IsBox |y#5| Tclass._module.G) (=> (> (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |ys#6@@3|) |y#5|) 0) (_module.__default.Below |a#5| |y#5|)))
 :qid |GHCMergeSortdfy.156:13|
 :skolemid |1003|
 :pattern ( (_module.__default.Below |a#5| |y#5|))
 :pattern ( (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |ys#6@@3|) |y#5|))
)) (_module.__default.sorted ($LS $LZ) |ys#6@@3|))))))) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 7) 2)))) GeneratedUnifiedExit_correct))))))))))))))))))))))))
(let ((anon2_correct  (and (=> (= (ControlFlow 0 18) 7) anon6_Then_correct) (=> (= (ControlFlow 0 18) 17) anon6_Else_correct))))
(let ((anon5_Else_correct  (=> (and (not (_module.List.Cons_q |x#0@@6|)) (= (ControlFlow 0 21) 18)) anon2_correct)))
(let ((anon5_Then_correct  (=> (_module.List.Cons_q |x#0@@6|) (and (=> (= (ControlFlow 0 19) (- 0 20)) (_module.List.Cons_q |x#0@@6|)) (=> (_module.List.Cons_q |x#0@@6|) (=> (= (ControlFlow 0 19) 18) anon2_correct))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (|$IsA#_module.List| |x#0@@6|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@0 $Heap@0) (forall ((|$ih#x0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#x0#0| (Tclass._module.List (Tclass._module.List Tclass._module.G))) (_module.__default.AllSorted ($LS $LZ) |$ih#x0#0|)) (< (DtRank |$ih#x0#0|) (DtRank |x#0@@6|))) (_module.__default.AllSorted ($LS $LZ) (_module.__default.mergePairs ($LS $LZ) |$ih#x0#0|)))
 :qid |GHCMergeSortdfy.435:25|
 :skolemid |993|
 :pattern ( (_module.__default.mergePairs ($LS $LZ) |$ih#x0#0|))
)))) (and (=> (= (ControlFlow 0 22) 19) anon5_Then_correct) (=> (= (ControlFlow 0 22) 21) anon5_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (and ($Is DatatypeTypeType |x#0@@6| (Tclass._module.List (Tclass._module.List Tclass._module.G))) ($IsAlloc DatatypeTypeType |x#0@@6| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@@0)) (|$IsA#_module.List| |x#0@@6|)) (= 4 $FunctionContextHeight)) (and (and (|_module.__default.AllSorted#canCall| |x#0@@6|) (and (_module.__default.AllSorted ($LS $LZ) |x#0@@6|) (ite (_module.List.Nil_q |x#0@@6|) true (let ((|y#11| (_module.List.tail |x#0@@6|)))
(let ((|xs#5| ($Unbox DatatypeTypeType (_module.List.head |x#0@@6|))))
 (and (_module.__default.sorted ($LS $LZ) |xs#5|) (_module.__default.AllSorted ($LS $LZ) |y#11|))))))) (= (ControlFlow 0 23) 22))) anon0_correct))))
