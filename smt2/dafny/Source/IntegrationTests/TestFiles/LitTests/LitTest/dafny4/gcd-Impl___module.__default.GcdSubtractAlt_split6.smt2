...
(set-info :boogie-vc-id Impl$$_module.__default.GcdSubtractAlt_split6)
...
(assert (not
 ...
 :qid |gcddfy.245:9|
 :skolemid |670|
)))) (=> (and (<= (LitInt 1) |b#2_0@0|) (= (Mul |q#2_0@0| |b#2_0@0|) (- |y#0@@3| |x#0@@10|))) (=> (and (and (and (= |y#0@@3| (Mul |q#2_0@0| (+ |a#2_0@0| |b#2_0@0|))) ($IsAlloc intType (int_2_U |q#2_0@0|) Tclass._module.pos $Heap@4)) (and ($IsAlloc intType (int_2_U |y#0@@3|) Tclass._module.pos $Heap@4) (|_module.__default.IsFactor#canCall| |q#2_0@0| |y#0@@3|))) (and (and (|_module.__default.IsFactor#canCall| |q#2_0@0| |y#0@@3|) (= (ControlFlow 0 2) (- 0 1))) (|_module.__default.IsFactor#canCall| |q#2_0@0| |y#0@@3|))) (or (_module.__default.IsFactor |q#2_0@0| |y#0@@3|) (exists ((|q#2_1| Int) ) (! (= (Mul |q#2_0@0| |q#2_1|) |y#0@@3|)
 :qid |gcddfy.8:10|
 :skolemid |671|
