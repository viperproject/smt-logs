...
(assert (forall ((a@@1 T@U) (x@@7 T@U) ) (! (= (|MultiSet#Multiplicity| (|MultiSet#UnionOne| a@@1 x@@7) x@@7) (+ (|MultiSet#Multiplicity| a@@1 x@@7) 1))
 :qid |DafnyPreludebpl.968:15|
 :skolemid |193|
 :pattern ( (|MultiSet#UnionOne| a@@1 x@@7))
)))
...
(assert (forall ((a@@2 T@U) (x@@12 T@U) (y@@0 T@U) ) (!  (=> (< 0 (|MultiSet#Multiplicity| a@@2 y@@0)) (< 0 (|MultiSet#Multiplicity| (|MultiSet#UnionOne| a@@2 x@@12) y@@0)))
 :qid |DafnyPreludebpl.973:15|
 :skolemid |194|
 :pattern ( (|MultiSet#UnionOne| a@@2 x@@12) (|MultiSet#Multiplicity| a@@2 y@@0))
)))
(assert (forall ((a@@3 T@U) (x@@13 T@U) (o@@0 T@U) ) (! (= (< 0 (|MultiSet#Multiplicity| (|MultiSet#UnionOne| a@@3 x@@13) o@@0))  (or (= o@@0 x@@13) (< 0 (|MultiSet#Multiplicity| a@@3 o@@0))))
 :qid |DafnyPreludebpl.963:15|
 :skolemid |192|
 :pattern ( (|MultiSet#Multiplicity| (|MultiSet#UnionOne| a@@3 x@@13) o@@0))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |m#0@0| (Lit MapType (|Map#Build| |Map#Empty| ($Box MultiSetType (Lit MultiSetType (|MultiSet#UnionOne| (|MultiSet#UnionOne| |MultiSet#Empty| ($Box intType (int_2_U (LitInt 10)))) ($Box intType (int_2_U (LitInt 20)))))) ($Box intType (int_2_U (LitInt 33)))))) (= (ControlFlow 0 2) (- 0 1))) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box MultiSetType (|MultiSet#UnionOne| (|MultiSet#UnionOne| |MultiSet#Empty| ($Box intType (int_2_U (LitInt 10)))) ($Box intType (int_2_U (LitInt 20))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |m#0| (TMap (TMultiSet TInt) TInt)) ($IsAlloc MapType |m#0| (TMap (TMultiSet TInt) TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
