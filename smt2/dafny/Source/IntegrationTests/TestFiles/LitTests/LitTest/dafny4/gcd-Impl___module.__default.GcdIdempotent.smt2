...
(set-info :boogie-vc-id Impl$$_module.__default.GcdIdempotent)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (|_module.__default.Factors#canCall| |x#0@@10|)) (and (and (|Set#IsMember| (_module.__default.Factors |x#0@@10|) ($Box intType (int_2_U |x#0@@10|))) (= $Heap@@1 $Heap@0)) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)))) (and (and (and (= $Heap@0 $Heap@1) reveal__module._default.Gcd) (and ($IsAlloc intType (int_2_U |x#0@@10|) Tclass._module.pos $Heap@1) (|_module.__default.Factors#canCall| |x#0@@10|))) (and (and ($IsAlloc intType (int_2_U |x#0@@10|) Tclass._module.pos $Heap@1) (|_module.__default.Factors#canCall| |x#0@@10|)) (and (|_module.__default.Factors#canCall| |x#0@@10|) (|_module.__default.Factors#canCall| |x#0@@10|))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#IsMember| (|Set#Intersection| (_module.__default.Factors |x#0@@10|) (_module.__default.Factors |x#0@@10|)) ($Box intType (int_2_U |x#0@@10|)))) (=> (|Set#IsMember| (|Set#Intersection| (_module.__default.Factors |x#0@@10|) (_module.__default.Factors |x#0@@10|)) ($Box intType (int_2_U |x#0@@10|))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (_module.__default.Gcd reveal__module._default.Gcd |x#0@@10| |x#0@@10|) |x#0@@10|))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (<= (LitInt 1) |x#0@@10|)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct)))
