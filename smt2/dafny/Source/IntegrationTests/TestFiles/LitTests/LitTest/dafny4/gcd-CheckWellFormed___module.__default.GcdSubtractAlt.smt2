...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.GcdSubtractAlt)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 1) |x#0@@1|)) (and (and (<= (LitInt 1) |y#0|) (= 6 $FunctionContextHeight)) (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (< |x#0@@1| |y#0|)))) (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) ($IsAlloc intType (int_2_U |y#0|) Tclass._module.pos $Heap@0))) (and (and ($IsAlloc intType (int_2_U |x#0@@1|) Tclass._module.pos $Heap@0) (|_module.__default.Gcd#canCall| |y#0| |x#0@@1|)) (and ($IsAlloc intType (int_2_U |x#0@@1|) Tclass._module.pos $Heap@0) (= (ControlFlow 0 2) (- 0 1)))))) ($Is intType (int_2_U (- |y#0| |x#0@@1|)) Tclass._module.pos))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
