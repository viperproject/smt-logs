...
(assert (forall ((a@@9 T@U) (b@@6 T@U) (t0@@1 T@U) (t1@@1 T@U) ) (!  (=> (forall ((bx T@U) )  (=> (|Set#IsMember| a@@9 bx) (and ($IsBox bx t0@@1) ($IsBox (MapType0Select BoxType BoxType b@@6 bx) t1@@1)))) ($Is MapType (|Map#Glue| a@@9 b@@6 (TMap t0@@1 t1@@1)) (TMap t0@@1 t1@@1)))
