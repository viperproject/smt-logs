...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@0 T@U) (|n#0@@0| T@U) (|m#0@@0| T@U) ) (!  (=> (or (|_module.__default.beq__nat#canCall| |n#0@@0| |m#0@@0|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |n#0@@0| Tclass._module.Nat) ($Is DatatypeTypeType |m#0@@0| Tclass._module.Nat)))) ($Is DatatypeTypeType (_module.__default.beq__nat $ly@@0 |n#0@@0| |m#0@@0|) Tclass._module.Bool))
 :qid |SoftwareFoundationsBasicsdfy.296:16|
 :skolemid |715|
 :pattern ( (_module.__default.beq__nat $ly@@0 |n#0@@0| |m#0@@0|))
))))
(assert (forall (($ly@@1 T@U) (|n#0@@1| T@U) (|m#0@@1| T@U) ) (! (= (_module.__default.beq__nat ($LS $ly@@1) |n#0@@1| |m#0@@1|) (_module.__default.beq__nat $ly@@1 |n#0@@1| |m#0@@1|))
 :qid |SoftwareFoundationsBasicsdfy.296:16|
 :skolemid |713|
 :pattern ( (_module.__default.beq__nat ($LS $ly@@1) |n#0@@1| |m#0@@1|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) (|n#0@@2| T@U) (|m#0@@2| T@U) ) (!  (=> (or (|_module.__default.beq__nat#canCall| (Lit DatatypeTypeType |n#0@@2|) (Lit DatatypeTypeType |m#0@@2|)) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |n#0@@2| Tclass._module.Nat) ($Is DatatypeTypeType |m#0@@2| Tclass._module.Nat)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Nat.O_q (Lit DatatypeTypeType |n#0@@2|)))))) (let ((|n'#3| (Lit DatatypeTypeType (_module.Nat._h0 (Lit DatatypeTypeType |n#0@@2|)))))
 (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Nat.O_q (Lit DatatypeTypeType |m#0@@2|)))))) (let ((|m'#7| (Lit DatatypeTypeType (_module.Nat._h0 (Lit DatatypeTypeType |m#0@@2|)))))
(|_module.__default.beq__nat#canCall| |n'#3| |m'#7|))))) (= (_module.__default.beq__nat ($LS $ly@@2) (Lit DatatypeTypeType |n#0@@2|) (Lit DatatypeTypeType |m#0@@2|)) (ite (_module.Nat.O_q (Lit DatatypeTypeType |n#0@@2|)) (ite (_module.Nat.O_q (Lit DatatypeTypeType |m#0@@2|)) |#_module.Bool.True| (Lit DatatypeTypeType |#_module.Bool.False|)) (let ((|n'#2| (Lit DatatypeTypeType (_module.Nat._h0 (Lit DatatypeTypeType |n#0@@2|)))))
(ite (_module.Nat.O_q (Lit DatatypeTypeType |m#0@@2|)) |#_module.Bool.False| (let ((|m'#5| (Lit DatatypeTypeType (_module.Nat._h0 (Lit DatatypeTypeType |m#0@@2|)))))
(Lit DatatypeTypeType (_module.__default.beq__nat ($LS $ly@@2) |n'#2| |m'#5|)))))))))
 :qid |SoftwareFoundationsBasicsdfy.296:16|
 :weight 3
 :skolemid |718|
 :pattern ( (_module.__default.beq__nat ($LS $ly@@2) (Lit DatatypeTypeType |n#0@@2|) (Lit DatatypeTypeType |m#0@@2|)))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.beq__nat)
...
(let ((anon16_Else_correct  (=> (or (not (= |m#0@@3| |#_module.Nat.O|)) (not true)) (and (=> (= (ControlFlow 0 13) 11) anon17_Then_correct) (=> (= (ControlFlow 0 13) 12) anon17_Else_correct)))))
(let ((anon16_Then_correct true))
(let ((anon15_Then_correct  (=> (= |n#0@@3| |#_module.Nat.O|) (and (=> (= (ControlFlow 0 14) 10) anon16_Then_correct) (=> (= (ControlFlow 0 14) 13) anon16_Else_correct)))))
(let ((anon20_Else_correct true))
(let ((anon20_Then_correct  (=> (and (and (and (= |m#0@@3| (|#_module.Nat.S| |_mcc#2#0|)) ($Is DatatypeTypeType |_mcc#2#0| Tclass._module.Nat)) (and (= |let#1#0#0| |_mcc#2#0|) ($Is DatatypeTypeType |let#1#0#0| Tclass._module.Nat))) (and (and (= |m'#Z#0@0| |let#1#0#0|) ($IsAlloc DatatypeTypeType |n'#Z#0@0| Tclass._module.Nat $Heap)) (and ($IsAlloc DatatypeTypeType |m'#Z#0@0| Tclass._module.Nat $Heap) (= (ControlFlow 0 5) (- 0 4))))) (or (< (DtRank |n'#Z#0@0|) (DtRank |n#0@@3|)) (and (= (DtRank |n'#Z#0@0|) (DtRank |n#0@@3|)) (< (DtRank |m'#Z#0@0|) (DtRank |m#0@@3|)))))))
(let ((anon19_Else_correct  (=> (or (not (= |m#0@@3| |#_module.Nat.O|)) (not true)) (and (=> (= (ControlFlow 0 7) 5) anon20_Then_correct) (=> (= (ControlFlow 0 7) 6) anon20_Else_correct)))))
(let ((anon19_Then_correct true))
(let ((anon18_Then_correct  (=> (= |n#0@@3| (|#_module.Nat.S| |_mcc#0#0|)) (=> (and (and ($Is DatatypeTypeType |_mcc#0#0| Tclass._module.Nat) (= |let#0#0#0| |_mcc#0#0|)) (and ($Is DatatypeTypeType |let#0#0#0| Tclass._module.Nat) (= |n'#Z#0@0| |let#0#0#0|))) (and (=> (= (ControlFlow 0 8) 3) anon19_Then_correct) (=> (= (ControlFlow 0 8) 7) anon19_Else_correct))))))
(let ((anon18_Else_correct true))
(let ((anon15_Else_correct  (=> (or (not (= |n#0@@3| |#_module.Nat.O|)) (not true)) (and (=> (= (ControlFlow 0 9) 8) anon18_Then_correct) (=> (= (ControlFlow 0 9) 2) anon18_Else_correct)))))
(let ((anon14_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 15) 1) anon14_Then_correct) (=> (= (ControlFlow 0 15) 14) anon15_Then_correct)) (=> (= (ControlFlow 0 15) 9) anon15_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |n#0@@3| Tclass._module.Nat) ($Is DatatypeTypeType |m#0@@3| Tclass._module.Nat)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 16) 15))) anon0_correct))))
