...
(declare-fun _module.T.h (T@U Int) Int)
(declare-fun |_module.T.h#canCall| (T@U Int) Bool)
...
(assert (distinct alloc Tagclass._module.T? Tagclass._module.T tytagFamily$T)
)
...
(assert (forall (($o T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType $o Tclass._module.T? $h@@0)  (or (= $o null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@0 $o) alloc)))))
 :qid |unknown.0:0|
 :skolemid |481|
 :pattern ( ($IsAlloc refType $o Tclass._module.T? $h@@0))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this T@U) (|x#0| Int) ) (!  (=> (or (|_module.T.h#canCall| this |x#0|) (and (< 1 $FunctionContextHeight) (and (and (or (not (= this null)) (not true)) ($Is refType this Tclass._module.T)) (<= (LitInt 0) |x#0|)))) (and (< (_module.T.h this |x#0|) (+ 10 |x#0|)) (<= (LitInt 0) (_module.T.h this |x#0|))))
 :qid |gitissue245dfy.17:12|
 :skolemid |489|
 :pattern ( (_module.T.h this |x#0|))
))))
...
(assert (= (Tag Tclass._module.T) Tagclass._module.T))
(assert (= (TagFamily Tclass._module.T) tytagFamily$T))
(assert (forall (($o@@1 T@U) ) (! (= ($Is refType $o@@1 Tclass._module.T?)  (or (= $o@@1 null) (implements$_module.T (dtype $o@@1))))
 :qid |unknown.0:0|
 :skolemid |480|
 :pattern ( ($Is refType $o@@1 Tclass._module.T?))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.T.h)
