...
(let ((anon18_Else_correct  (=> (and (< |y#Z#0@0| |x#Z#0@0|) (= (ControlFlow 0 9) 6)) anon9_correct)))
(let ((anon18_Then_correct  (=> (and (<= |x#Z#0@0| |y#Z#0@0|) ($IsAlloc DatatypeTypeType |rest#Z#0@0| (Tclass._module.List TInt) $Heap)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (< (DtRank |rest#Z#0@0|) (DtRank |l#0@@3|))) (=> (< (DtRank |rest#Z#0@0|) (DtRank |l#0@@3|)) (=> (and (|_module.__default.sorted#canCall| |rest#Z#0@0|) (= (ControlFlow 0 7) 6)) anon9_correct))))))
(let ((anon17_Then_correct  (=> (= |rest#Z#0@0| (|#_module.List.Cons| ($Box intType (int_2_U |_mcc#2#0|)) |_mcc#3#0|)) (=> (and (and ($Is DatatypeTypeType |_mcc#3#0| (Tclass._module.List TInt)) (= |let#2#0#0| |_mcc#2#0|)) (and ($Is intType (int_2_U |let#2#0#0|) TInt) (= |y#Z#0@0| |let#2#0#0|))) (and (=> (= (ControlFlow 0 10) 7) anon18_Then_correct) (=> (= (ControlFlow 0 10) 9) anon18_Else_correct))))))
(let ((anon17_Else_correct true))
(let ((anon16_Else_correct  (=> (or (not (= |rest#Z#0@0| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 11) 10) anon17_Then_correct) (=> (= (ControlFlow 0 11) 5) anon17_Else_correct)))))
(let ((anon16_Then_correct true))
(let ((anon15_Then_correct  (=> (and (and (and (= |l#0@@3| (|#_module.List.Cons| ($Box intType (int_2_U |_mcc#0#0|)) |_mcc#1#0|)) ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List TInt))) (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List TInt)))) (and (and (= |rest#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|)) (and ($Is intType (int_2_U |let#1#0#0|) TInt) (= |x#Z#0@0| |let#1#0#0|)))) (and (=> (= (ControlFlow 0 12) 4) anon16_Then_correct) (=> (= (ControlFlow 0 12) 11) anon16_Else_correct)))))
(let ((anon15_Else_correct true))
(let ((anon14_Else_correct  (=> (or (not (= |l#0@@3| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 13) 12) anon15_Then_correct) (=> (= (ControlFlow 0 13) 3) anon15_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |l#0@@3| (Tclass._module.List TInt))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 15) 14))) anon0_correct)))
