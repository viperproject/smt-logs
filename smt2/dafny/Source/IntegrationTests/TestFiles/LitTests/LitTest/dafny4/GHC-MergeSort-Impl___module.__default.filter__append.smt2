...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@1 T@U) (|g#0| T@U) (|xs#0@@1| T@U) ) (!  (=> (or (|_module.__default.filter#canCall| |g#0| (Lit DatatypeTypeType |xs#0@@1|)) (and (< 1 $FunctionContextHeight) (and ($IsBox |g#0| Tclass._module.G) ($Is DatatypeTypeType |xs#0@@1| (Tclass._module.List Tclass._module.G))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@1|)))))) (let ((|ys#3| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@1|)))))
(let ((|b#3| (Lit BoxType (_module.List.head (Lit DatatypeTypeType |xs#0@@1|)))))
 (and (and (and (|_module.__default.key#canCall| |g#0|) (|_module.__default.key#canCall| |b#3|)) (=> (= (_module.__default.key |g#0|) (_module.__default.key |b#3|)) (|_module.__default.filter#canCall| |g#0| |ys#3|))) (=> (or (not (= (_module.__default.key |g#0|) (_module.__default.key |b#3|))) (not true)) (|_module.__default.filter#canCall| |g#0| |ys#3|)))))) (= (_module.__default.filter ($LS $ly@@1) |g#0| (Lit DatatypeTypeType |xs#0@@1|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@1|)) |#_module.List.Nil| (let ((|ys#2| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@1|)))))
(let ((|b#2| (Lit BoxType (_module.List.head (Lit DatatypeTypeType |xs#0@@1|)))))
(ite (= (_module.__default.key |g#0|) (_module.__default.key |b#2|)) (|#_module.List.Cons| |b#2| (_module.__default.filter ($LS $ly@@1) |g#0| |ys#2|)) (_module.__default.filter ($LS $ly@@1) |g#0| |ys#2|))))))))
 :qid |GHCMergeSortdfy.160:16|
 :weight 3
 :skolemid |729|
 :pattern ( (_module.__default.filter ($LS $ly@@1) |g#0| (Lit DatatypeTypeType |xs#0@@1|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) (|g#0@@0| T@U) (|xs#0@@2| T@U) ) (!  (=> (or (|_module.__default.filter#canCall| (Lit BoxType |g#0@@0|) (Lit DatatypeTypeType |xs#0@@2|)) (and (< 1 $FunctionContextHeight) (and ($IsBox |g#0@@0| Tclass._module.G) ($Is DatatypeTypeType |xs#0@@2| (Tclass._module.List Tclass._module.G))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@2|)))))) (let ((|ys#5| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@2|)))))
(let ((|b#5| (Lit BoxType (_module.List.head (Lit DatatypeTypeType |xs#0@@2|)))))
 (and (and (and (|_module.__default.key#canCall| (Lit BoxType |g#0@@0|)) (|_module.__default.key#canCall| |b#5|)) (=> (= (_module.__default.key (Lit BoxType |g#0@@0|)) (_module.__default.key |b#5|)) (|_module.__default.filter#canCall| (Lit BoxType |g#0@@0|) |ys#5|))) (=> (or (not (= (_module.__default.key (Lit BoxType |g#0@@0|)) (_module.__default.key |b#5|))) (not true)) (|_module.__default.filter#canCall| (Lit BoxType |g#0@@0|) |ys#5|)))))) (= (_module.__default.filter ($LS $ly@@2) (Lit BoxType |g#0@@0|) (Lit DatatypeTypeType |xs#0@@2|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@2|)) |#_module.List.Nil| (let ((|ys#4| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@2|)))))
(let ((|b#4| (Lit BoxType (_module.List.head (Lit DatatypeTypeType |xs#0@@2|)))))
(ite (= (_module.__default.key (Lit BoxType |g#0@@0|)) (_module.__default.key |b#4|)) (|#_module.List.Cons| |b#4| (Lit DatatypeTypeType (_module.__default.filter ($LS $ly@@2) (Lit BoxType |g#0@@0|) |ys#4|))) (_module.__default.filter ($LS $ly@@2) (Lit BoxType |g#0@@0|) |ys#4|))))))))
 :qid |GHCMergeSortdfy.160:16|
 :weight 3
 :skolemid |730|
 :pattern ( (_module.__default.filter ($LS $ly@@2) (Lit BoxType |g#0@@0|) (Lit DatatypeTypeType |xs#0@@2|)))
))))
(assert (forall (($ly@@3 T@U) (|g#0@@1| T@U) (|xs#0@@3| T@U) ) (! (= (_module.__default.filter ($LS $ly@@3) |g#0@@1| |xs#0@@3|) (_module.__default.filter $ly@@3 |g#0@@1| |xs#0@@3|))
 :qid |GHCMergeSortdfy.160:16|
 :skolemid |724|
 :pattern ( (_module.__default.filter ($LS $ly@@3) |g#0@@1| |xs#0@@3|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@4 T@U) (|g#0@@2| T@U) (|xs#0@@4| T@U) ) (!  (=> (or (|_module.__default.filter#canCall| |g#0@@2| |xs#0@@4|) (and (< 1 $FunctionContextHeight) (and ($IsBox |g#0@@2| Tclass._module.G) ($Is DatatypeTypeType |xs#0@@4| (Tclass._module.List Tclass._module.G))))) (and (=> (not (_module.List.Nil_q |xs#0@@4|)) (let ((|ys#1| (_module.List.tail |xs#0@@4|)))
(let ((|b#1| (_module.List.head |xs#0@@4|)))
 (and (and (and (|_module.__default.key#canCall| |g#0@@2|) (|_module.__default.key#canCall| |b#1|)) (=> (= (_module.__default.key |g#0@@2|) (_module.__default.key |b#1|)) (|_module.__default.filter#canCall| |g#0@@2| |ys#1|))) (=> (or (not (= (_module.__default.key |g#0@@2|) (_module.__default.key |b#1|))) (not true)) (|_module.__default.filter#canCall| |g#0@@2| |ys#1|)))))) (= (_module.__default.filter ($LS $ly@@4) |g#0@@2| |xs#0@@4|) (ite (_module.List.Nil_q |xs#0@@4|) |#_module.List.Nil| (let ((|ys#0@@1| (_module.List.tail |xs#0@@4|)))
(let ((|b#0| (_module.List.head |xs#0@@4|)))
(ite (= (_module.__default.key |g#0@@2|) (_module.__default.key |b#0|)) (|#_module.List.Cons| |b#0| (_module.__default.filter $ly@@4 |g#0@@2| |ys#0@@1|)) (_module.__default.filter $ly@@4 |g#0@@2| |ys#0@@1|))))))))
 :qid |GHCMergeSortdfy.160:16|
 :skolemid |728|
 :pattern ( (_module.__default.filter ($LS $ly@@4) |g#0@@2| |xs#0@@4|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@5 T@U) (|g#0@@3| T@U) (|xs#0@@5| T@U) ) (!  (=> (or (|_module.__default.filter#canCall| |g#0@@3| |xs#0@@5|) (and (< 1 $FunctionContextHeight) (and ($IsBox |g#0@@3| Tclass._module.G) ($Is DatatypeTypeType |xs#0@@5| (Tclass._module.List Tclass._module.G))))) ($Is DatatypeTypeType (_module.__default.filter $ly@@5 |g#0@@3| |xs#0@@5|) (Tclass._module.List Tclass._module.G)))
 :qid |GHCMergeSortdfy.160:16|
 :skolemid |726|
 :pattern ( (_module.__default.filter $ly@@5 |g#0@@3| |xs#0@@5|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.append$_T0@@1 T@U) ($ly@@6 T@U) (|xs#0@@6| T@U) (|ys#0@@2| T@U) ) (!  (=> (or (|_module.__default.append#canCall| _module._default.append$_T0@@1 |xs#0@@6| |ys#0@@2|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@6| (Tclass._module.List _module._default.append$_T0@@1)) ($Is DatatypeTypeType |ys#0@@2| (Tclass._module.List _module._default.append$_T0@@1))))) ($Is DatatypeTypeType (_module.__default.append _module._default.append$_T0@@1 $ly@@6 |xs#0@@6| |ys#0@@2|) (Tclass._module.List _module._default.append$_T0@@1)))
 :qid |unknown.0:0|
 :skolemid |618|
 :pattern ( (_module.__default.append _module._default.append$_T0@@1 $ly@@6 |xs#0@@6| |ys#0@@2|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.append$_T0@@2 T@U) ($ly@@7 T@U) (|xs#0@@7| T@U) (|ys#0@@3| T@U) ) (!  (=> (and (or (|_module.__default.append#canCall| _module._default.append$_T0@@2 |xs#0@@7| |ys#0@@3|) (and (< 1 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |xs#0@@7| (Tclass._module.List _module._default.append$_T0@@2)) ($IsAlloc DatatypeTypeType |xs#0@@7| (Tclass._module.List _module._default.append$_T0@@2) $Heap)) (and ($Is DatatypeTypeType |ys#0@@3| (Tclass._module.List _module._default.append$_T0@@2)) ($IsAlloc DatatypeTypeType |ys#0@@3| (Tclass._module.List _module._default.append$_T0@@2) $Heap))))) ($IsGoodHeap $Heap)) ($IsAlloc DatatypeTypeType (_module.__default.append _module._default.append$_T0@@2 $ly@@7 |xs#0@@7| |ys#0@@3|) (Tclass._module.List _module._default.append$_T0@@2) $Heap))
 :qid |GHCMergeSortdfy.45:16|
 :skolemid |619|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.__default.append _module._default.append$_T0@@2 $ly@@7 |xs#0@@7| |ys#0@@3|) (Tclass._module.List _module._default.append$_T0@@2) $Heap))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.filter__append)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and (|$IsA#_module.List| |xs#0@@9|) (|$IsA#_module.List| |ys#0@@5|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@0 $Heap@0)) (and (forall ((|$ih#xs0#0| T@U) (|$ih#ys0#0| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |$ih#xs0#0| (Tclass._module.List Tclass._module.G)) ($Is DatatypeTypeType |$ih#ys0#0| (Tclass._module.List Tclass._module.G))) (U_2_bool (Lit boolType (bool_2_U true)))) (or (< (DtRank |$ih#xs0#0|) (DtRank |xs#0@@9|)) (and (= (DtRank |$ih#xs0#0|) (DtRank |xs#0@@9|)) (< (DtRank |$ih#ys0#0|) (DtRank |ys#0@@5|))))) (|_module.List#Equal| (_module.__default.filter ($LS $LZ) |g#0@@4| (_module.__default.append Tclass._module.G ($LS $LZ) |$ih#xs0#0| |$ih#ys0#0|)) (_module.__default.append Tclass._module.G ($LS $LZ) (_module.__default.filter ($LS $LZ) |g#0@@4| |$ih#xs0#0|) (_module.__default.filter ($LS $LZ) |g#0@@4| |$ih#ys0#0|))))
 :qid |GHCMergeSortdfy.663:27|
 :skolemid |1077|
 :pattern ( (_module.__default.append Tclass._module.G ($LS $LZ) (_module.__default.filter ($LS $LZ) |g#0@@4| |$ih#xs0#0|) (_module.__default.filter ($LS $LZ) |g#0@@4| |$ih#ys0#0|)))
 :pattern ( (_module.__default.filter ($LS $LZ) |g#0@@4| (_module.__default.append Tclass._module.G ($LS $LZ) |$ih#xs0#0| |$ih#ys0#0|)))
)) (= (ControlFlow 0 2) (- 0 1)))) (|_module.List#Equal| (_module.__default.filter ($LS ($LS $LZ)) |g#0@@4| (_module.__default.append Tclass._module.G ($LS ($LS $LZ)) |xs#0@@9| |ys#0@@5|)) (_module.__default.append Tclass._module.G ($LS ($LS $LZ)) (_module.__default.filter ($LS ($LS $LZ)) |g#0@@4| |xs#0@@9|) (_module.__default.filter ($LS ($LS $LZ)) |g#0@@4| |ys#0@@5|))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and ($IsBox |g#0@@4| Tclass._module.G) ($IsAllocBox |g#0@@4| Tclass._module.G $Heap@@0))) (and (and ($Is DatatypeTypeType |xs#0@@9| (Tclass._module.List Tclass._module.G)) ($IsAlloc DatatypeTypeType |xs#0@@9| (Tclass._module.List Tclass._module.G) $Heap@@0)) (|$IsA#_module.List| |xs#0@@9|))) (and (and (and ($Is DatatypeTypeType |ys#0@@5| (Tclass._module.List Tclass._module.G)) ($IsAlloc DatatypeTypeType |ys#0@@5| (Tclass._module.List Tclass._module.G) $Heap@@0)) (|$IsA#_module.List| |ys#0@@5|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
