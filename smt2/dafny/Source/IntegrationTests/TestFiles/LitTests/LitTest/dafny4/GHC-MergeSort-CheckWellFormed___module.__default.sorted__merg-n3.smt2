...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.sorted__mergeAll)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and (not (|_module.List#Equal| |x#0@@10| |#_module.List.Nil|)) ($IsAlloc DatatypeTypeType |x#0@@10| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@@0)) (=> (and (and (|_module.__default.AllSorted#canCall| |x#0@@10|) (_module.__default.AllSorted ($LS $LZ) |x#0@@10|)) (and ($IsAlloc DatatypeTypeType |x#0@@10| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@@0) (|_module.__default.length#canCall| (Tclass._module.List Tclass._module.G) |x#0@@10|))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@0 $Heap@0)) (and ($IsAlloc DatatypeTypeType |x#0@@10| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (not (|_module.List#Equal| |x#0@@10| |#_module.List.Nil|))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and ($Is DatatypeTypeType |x#0@@10| (Tclass._module.List (Tclass._module.List Tclass._module.G))) ($IsAlloc DatatypeTypeType |x#0@@10| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@@0)) (|$IsA#_module.List| |x#0@@10|)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
