...
(set-info :boogie-vc-id Impl$$_module.__default.Lucas__Binary_k)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (|_module.__default.binom#canCall| (Mul (LitInt 2) |a#0@@3|) (+ (Mul (LitInt 2) |b#0@@3|) 1)) (|_module.__default.EVEN#canCall| (_module.__default.binom ($LS $LZ) reveal__module._default.binom (Mul (LitInt 2) |a#0@@3|) (+ (Mul (LitInt 2) |b#0@@3|) 1)))) (_module.__default.EVEN reveal__module._default.EVEN (_module.__default.binom ($LS ($LS $LZ)) reveal__module._default.binom (Mul (LitInt 2) |a#0@@3|) (+ (Mul (LitInt 2) |b#0@@3|) 1)))) (=> (and (and (and (and (and (|_module.__default.binom#canCall| (Mul (LitInt 2) |a#0@@3|) (Mul (LitInt 2) |b#0@@3|)) (|_module.__default.EVEN#canCall| (_module.__default.binom ($LS $LZ) reveal__module._default.binom (Mul (LitInt 2) |a#0@@3|) (Mul (LitInt 2) |b#0@@3|)))) (and (|_module.__default.binom#canCall| |a#0@@3| |b#0@@3|) (|_module.__default.EVEN#canCall| (_module.__default.binom ($LS $LZ) reveal__module._default.binom |a#0@@3| |b#0@@3|)))) (= (_module.__default.EVEN reveal__module._default.EVEN (_module.__default.binom ($LS ($LS $LZ)) reveal__module._default.binom (Mul (LitInt 2) |a#0@@3|) (Mul (LitInt 2) |b#0@@3|))) (_module.__default.EVEN reveal__module._default.EVEN (_module.__default.binom ($LS ($LS $LZ)) reveal__module._default.binom |a#0@@3| |b#0@@3|)))) (and (and (and (|_module.__default.binom#canCall| (+ (Mul (LitInt 2) |a#0@@3|) 1) (+ (Mul (LitInt 2) |b#0@@3|) 1)) (|_module.__default.EVEN#canCall| (_module.__default.binom ($LS $LZ) reveal__module._default.binom (+ (Mul (LitInt 2) |a#0@@3|) 1) (+ (Mul (LitInt 2) |b#0@@3|) 1)))) (and (|_module.__default.binom#canCall| |a#0@@3| |b#0@@3|) (|_module.__default.EVEN#canCall| (_module.__default.binom ($LS $LZ) reveal__module._default.binom |a#0@@3| |b#0@@3|)))) (= (_module.__default.EVEN reveal__module._default.EVEN (_module.__default.binom ($LS ($LS $LZ)) reveal__module._default.binom (+ (Mul (LitInt 2) |a#0@@3|) 1) (+ (Mul (LitInt 2) |b#0@@3|) 1))) (_module.__default.EVEN reveal__module._default.EVEN (_module.__default.binom ($LS ($LS $LZ)) reveal__module._default.binom |a#0@@3| |b#0@@3|))))) (and (and (and (and (|_module.__default.binom#canCall| (+ (Mul (LitInt 2) |a#0@@3|) 1) (Mul (LitInt 2) |b#0@@3|)) (|_module.__default.EVEN#canCall| (_module.__default.binom ($LS $LZ) reveal__module._default.binom (+ (Mul (LitInt 2) |a#0@@3|) 1) (Mul (LitInt 2) |b#0@@3|)))) (and (|_module.__default.binom#canCall| |a#0@@3| |b#0@@3|) (|_module.__default.EVEN#canCall| (_module.__default.binom ($LS $LZ) reveal__module._default.binom |a#0@@3| |b#0@@3|)))) (and (= (_module.__default.EVEN reveal__module._default.EVEN (_module.__default.binom ($LS ($LS $LZ)) reveal__module._default.binom (+ (Mul (LitInt 2) |a#0@@3|) 1) (Mul (LitInt 2) |b#0@@3|))) (_module.__default.EVEN reveal__module._default.EVEN (_module.__default.binom ($LS ($LS $LZ)) reveal__module._default.binom |a#0@@3| |b#0@@3|))) (= $Heap $Heap@0))) (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (= $Heap@0 $Heap@1) reveal__module._default.EVEN)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= (Mod (_module.__default.binom ($LS ($LS $LZ)) reveal__module._default.binom (Mul (LitInt 2) |a#0@@3|) (Mul (LitInt 2) |b#0@@3|)) (LitInt 2)) (Mod (_module.__default.binom ($LS ($LS $LZ)) reveal__module._default.binom |a#0@@3| |b#0@@3|) (LitInt 2)))) (=> (= (Mod (_module.__default.binom ($LS ($LS $LZ)) reveal__module._default.binom (Mul (LitInt 2) |a#0@@3|) (Mul (LitInt 2) |b#0@@3|)) (LitInt 2)) (Mod (_module.__default.binom ($LS ($LS $LZ)) reveal__module._default.binom |a#0@@3| |b#0@@3|) (LitInt 2))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (Mod (_module.__default.binom ($LS ($LS $LZ)) reveal__module._default.binom (Mul (LitInt 2) |a#0@@3|) (+ (Mul (LitInt 2) |b#0@@3|) 1)) (LitInt 2)) (LitInt 0))) (=> (= (Mod (_module.__default.binom ($LS ($LS $LZ)) reveal__module._default.binom (Mul (LitInt 2) |a#0@@3|) (+ (Mul (LitInt 2) |b#0@@3|) 1)) (LitInt 2)) (LitInt 0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (Mod (_module.__default.binom ($LS ($LS $LZ)) reveal__module._default.binom (+ (Mul (LitInt 2) |a#0@@3|) 1) (Mul (LitInt 2) |b#0@@3|)) (LitInt 2)) (Mod (_module.__default.binom ($LS ($LS $LZ)) reveal__module._default.binom |a#0@@3| |b#0@@3|) (LitInt 2)))) (=> (= (Mod (_module.__default.binom ($LS ($LS $LZ)) reveal__module._default.binom (+ (Mul (LitInt 2) |a#0@@3|) 1) (Mul (LitInt 2) |b#0@@3|)) (LitInt 2)) (Mod (_module.__default.binom ($LS ($LS $LZ)) reveal__module._default.binom |a#0@@3| |b#0@@3|) (LitInt 2))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (Mod (_module.__default.binom ($LS ($LS $LZ)) reveal__module._default.binom (+ (Mul (LitInt 2) |a#0@@3|) 1) (+ (Mul (LitInt 2) |b#0@@3|) 1)) (LitInt 2)) (Mod (_module.__default.binom ($LS ($LS $LZ)) reveal__module._default.binom |a#0@@3| |b#0@@3|) (LitInt 2))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (<= (LitInt 0) |a#0@@3|) (<= (LitInt 0) |b#0@@3|)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 6) 2))) anon0_correct))))
