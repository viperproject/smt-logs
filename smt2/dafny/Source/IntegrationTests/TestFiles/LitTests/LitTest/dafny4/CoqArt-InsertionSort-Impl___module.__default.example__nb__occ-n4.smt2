...
(set-info :boogie-vc-id Impl$$_module.__default.example__nb__occ__1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (= (LitInt (_module.__default.nb__occ ($LS ($LS $LZ)) (LitInt 36725) (Lit DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 3))) (Lit DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 7))) (Lit DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 3))) (Lit DatatypeTypeType |#_module.List.Nil|))))))))) (LitInt 0)))))
