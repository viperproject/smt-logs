...
(declare-fun _module._default.BindOverAppend$T () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.BindOverAppend)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (|_module.List#Equal| (_module.__default.Bind _module._default.BindOverAppend$T _module._default.BindOverAppend$T ($LS ($LS $LZ)) (_module.__default.append _module._default.BindOverAppend$T ($LS ($LS $LZ)) |xs#0@@10| |ys#0@@4|) |g#0|) (_module.__default.append _module._default.BindOverAppend$T ($LS ($LS $LZ)) (_module.__default.Bind _module._default.BindOverAppend$T _module._default.BindOverAppend$T ($LS ($LS $LZ)) |xs#0@@10| |g#0|) (_module.__default.Bind _module._default.BindOverAppend$T _module._default.BindOverAppend$T ($LS ($LS $LZ)) |ys#0@@4| |g#0|))))))
(let ((anon5_Then_correct  (=> (= |xs#0@@10| (|#_module.List.Cons| |_mcc#0#0_0@0| |_mcc#1#0_0@0|)) (=> (and ($IsBox |_mcc#0#0_0@0| _module._default.BindOverAppend$T) ($Is DatatypeTypeType |_mcc#1#0_0@0| (Tclass._module.List _module._default.BindOverAppend$T))) (=> (and (and (and ($Is DatatypeTypeType |xs'#0_0@0| (Tclass._module.List _module._default.BindOverAppend$T)) ($IsAlloc DatatypeTypeType |xs'#0_0@0| (Tclass._module.List _module._default.BindOverAppend$T) $Heap@0)) (= |let#0_0#0#0| |_mcc#1#0_0@0|)) (and (and ($Is DatatypeTypeType |let#0_0#0#0| (Tclass._module.List _module._default.BindOverAppend$T)) (= |xs'#0_0@0| |let#0_0#0#0|)) (and ($IsBox |x#0_0@0| _module._default.BindOverAppend$T) ($IsAllocBox |x#0_0@0| _module._default.BindOverAppend$T $Heap@0)))) (=> (and (and (and (and (and (= |let#0_1#0#0| |_mcc#0#0_0@0|) ($IsBox |let#0_1#0#0| _module._default.BindOverAppend$T)) (and (= |x#0_0@0| |let#0_1#0#0|) (= |xs##0_0@0| ($Unbox DatatypeTypeType (Apply1 _module._default.BindOverAppend$T (Tclass._module.List _module._default.BindOverAppend$T) $Heap@0 |g#0| |x#0_0@0|))))) (and (and ($IsAlloc DatatypeTypeType |xs'#0_0@0| (Tclass._module.List _module._default.BindOverAppend$T) $Heap@0) ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 _module._default.BindOverAppend$T (Tclass._module.List _module._default.BindOverAppend$T)) $Heap@0)) (and (|_module.__default.Bind#canCall| _module._default.BindOverAppend$T _module._default.BindOverAppend$T |xs'#0_0@0| |g#0|) (|_module.__default.Bind#canCall| _module._default.BindOverAppend$T _module._default.BindOverAppend$T |xs'#0_0@0| |g#0|)))) (and (and (and (= |ys##0_0@0| (_module.__default.Bind _module._default.BindOverAppend$T _module._default.BindOverAppend$T ($LS $LZ) |xs'#0_0@0| |g#0|)) ($IsAlloc DatatypeTypeType |ys#0@@4| (Tclass._module.List _module._default.BindOverAppend$T) $Heap@0)) (and ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 _module._default.BindOverAppend$T (Tclass._module.List _module._default.BindOverAppend$T)) $Heap@0) (|_module.__default.Bind#canCall| _module._default.BindOverAppend$T _module._default.BindOverAppend$T |ys#0@@4| |g#0|))) (and (and (|_module.__default.Bind#canCall| _module._default.BindOverAppend$T _module._default.BindOverAppend$T |ys#0@@4| |g#0|) (= |zs##0_0@0| (_module.__default.Bind _module._default.BindOverAppend$T _module._default.BindOverAppend$T ($LS $LZ) |ys#0@@4| |g#0|))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1))))) (and (and (and (and (|$IsA#_module.List| (_module.__default.append _module._default.BindOverAppend$T ($LS $LZ) (_module.__default.append _module._default.BindOverAppend$T ($LS $LZ) |xs##0_0@0| |ys##0_0@0|) |zs##0_0@0|)) (|$IsA#_module.List| (_module.__default.append _module._default.BindOverAppend$T ($LS $LZ) |xs##0_0@0| (_module.__default.append _module._default.BindOverAppend$T ($LS $LZ) |ys##0_0@0| |zs##0_0@0|)))) (and (and (|_module.__default.append#canCall| _module._default.BindOverAppend$T |xs##0_0@0| |ys##0_0@0|) (|_module.__default.append#canCall| _module._default.BindOverAppend$T (_module.__default.append _module._default.BindOverAppend$T ($LS $LZ) |xs##0_0@0| |ys##0_0@0|) |zs##0_0@0|)) (and (|_module.__default.append#canCall| _module._default.BindOverAppend$T |ys##0_0@0| |zs##0_0@0|) (|_module.__default.append#canCall| _module._default.BindOverAppend$T |xs##0_0@0| (_module.__default.append _module._default.BindOverAppend$T ($LS $LZ) |ys##0_0@0| |zs##0_0@0|))))) (|_module.List#Equal| (_module.__default.append _module._default.BindOverAppend$T ($LS ($LS $LZ)) (_module.__default.append _module._default.BindOverAppend$T ($LS ($LS $LZ)) |xs##0_0@0| |ys##0_0@0|) |zs##0_0@0|) (_module.__default.append _module._default.BindOverAppend$T ($LS ($LS $LZ)) |xs##0_0@0| (_module.__default.append _module._default.BindOverAppend$T ($LS ($LS $LZ)) |ys##0_0@0| |zs##0_0@0|)))) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 5) 3)))) GeneratedUnifiedExit_correct))))))
(let ((anon4_Then_correct  (=> (and (= |xs#0@@10| |#_module.List.Nil|) (= (ControlFlow 0 4) 3)) GeneratedUnifiedExit_correct)))
(let ((anon5_Else_correct true))
(let ((anon4_Else_correct  (=> (or (not (= |xs#0@@10| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 6) 5) anon5_Then_correct) (=> (= (ControlFlow 0 6) 1) anon5_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (=> (and (|$IsA#_module.List| |xs#0@@10|) (|$IsA#_module.List| |ys#0@@4|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@4 $Heap@0) (forall ((|$ih#xs0#0| T@U) (|$ih#ys0#0| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |$ih#xs0#0| (Tclass._module.List _module._default.BindOverAppend$T)) ($Is DatatypeTypeType |$ih#ys0#0| (Tclass._module.List _module._default.BindOverAppend$T))) (U_2_bool (Lit boolType (bool_2_U true)))) (or (< (DtRank |$ih#xs0#0|) (DtRank |xs#0@@10|)) (and (= (DtRank |$ih#xs0#0|) (DtRank |xs#0@@10|)) (< (DtRank |$ih#ys0#0|) (DtRank |ys#0@@4|))))) (|_module.List#Equal| (_module.__default.Bind _module._default.BindOverAppend$T _module._default.BindOverAppend$T ($LS $LZ) (_module.__default.append _module._default.BindOverAppend$T ($LS $LZ) |$ih#xs0#0| |$ih#ys0#0|) |g#0|) (_module.__default.append _module._default.BindOverAppend$T ($LS $LZ) (_module.__default.Bind _module._default.BindOverAppend$T _module._default.BindOverAppend$T ($LS $LZ) |$ih#xs0#0| |g#0|) (_module.__default.Bind _module._default.BindOverAppend$T _module._default.BindOverAppend$T ($LS $LZ) |$ih#ys0#0| |g#0|))))
 :qid |MonadicLawsdfy.83:25|
 :skolemid |578|
 :pattern ( (_module.__default.append _module._default.BindOverAppend$T ($LS $LZ) (_module.__default.Bind _module._default.BindOverAppend$T _module._default.BindOverAppend$T ($LS $LZ) |$ih#xs0#0| |g#0|) (_module.__default.Bind _module._default.BindOverAppend$T _module._default.BindOverAppend$T ($LS $LZ) |$ih#ys0#0| |g#0|)))
 :pattern ( (_module.__default.Bind _module._default.BindOverAppend$T _module._default.BindOverAppend$T ($LS $LZ) (_module.__default.append _module._default.BindOverAppend$T ($LS $LZ) |$ih#xs0#0| |$ih#ys0#0|) |g#0|))
)))) (and (=> (= (ControlFlow 0 7) 4) anon4_Then_correct) (=> (= (ControlFlow 0 7) 6) anon4_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (=> (and (and ($Is DatatypeTypeType |xs#0@@10| (Tclass._module.List _module._default.BindOverAppend$T)) ($IsAlloc DatatypeTypeType |xs#0@@10| (Tclass._module.List _module._default.BindOverAppend$T) $Heap@@4)) (|$IsA#_module.List| |xs#0@@10|)) (=> (and (and (and ($Is DatatypeTypeType |ys#0@@4| (Tclass._module.List _module._default.BindOverAppend$T)) ($IsAlloc DatatypeTypeType |ys#0@@4| (Tclass._module.List _module._default.BindOverAppend$T) $Heap@@4)) (|$IsA#_module.List| |ys#0@@4|)) (and (and ($Is HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 _module._default.BindOverAppend$T (Tclass._module.List _module._default.BindOverAppend$T))) ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 _module._default.BindOverAppend$T (Tclass._module.List _module._default.BindOverAppend$T)) $Heap@@4)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 8) 7)))) anon0_correct)))))
