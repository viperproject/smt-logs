...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (|f#0| T@U) ) (!  (=> (or (|_module.__default.FunctionMonotonic#canCall| (Lit HandleTypeType |f#0|)) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap) ($Is HandleTypeType |f#0| (Tclass._System.___hTotalFunc1 TInt TInt))))) (= (_module.__default.FunctionMonotonic (Lit HandleTypeType |f#0|)) (forall ((|n#1| Int) (|n'#1| Int) ) (!  (=> (<= |n#1| |n'#1|) (<= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap (Lit HandleTypeType |f#0|) ($Box intType (int_2_U |n#1|))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap (Lit HandleTypeType |f#0|) ($Box intType (int_2_U |n'#1|)))))))
 :qid |Ackermanndfy.113:10|
 :skolemid |585|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap |f#0| ($Box intType (int_2_U |n'#1|)))) ($Unbox intType (Apply1 TInt TInt $Heap |f#0| ($Box intType (int_2_U |n#1|)))))
))))
 :qid |Ackermanndfy.111:17|
 :weight 3
 :skolemid |586|
 :pattern ( (_module.__default.FunctionMonotonic (Lit HandleTypeType |f#0|)) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|f#0@@0| T@U) (|g#0| T@U) ) (!  (=> (or (|_module.__default.FunctionBelow#canCall| (Lit HandleTypeType |f#0@@0|) (Lit HandleTypeType |g#0|)) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) ($Is HandleTypeType |f#0@@0| (Tclass._System.___hTotalFunc1 TInt TInt))) ($Is HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 TInt TInt))))) (= (_module.__default.FunctionBelow (Lit HandleTypeType |f#0@@0|) (Lit HandleTypeType |g#0|)) (forall ((|n#1@@0| Int) ) (! (<= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@0 (Lit HandleTypeType |f#0@@0|) ($Box intType (int_2_U |n#1@@0|))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@0 (Lit HandleTypeType |g#0|) ($Box intType (int_2_U |n#1@@0|))))))
 :qid |Ackermanndfy.107:10|
 :skolemid |577|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@0 |g#0| ($Box intType (int_2_U |n#1@@0|)))))
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U |n#1@@0|)))))
))))
 :qid |Ackermanndfy.105:17|
 :weight 3
 :skolemid |578|
 :pattern ( (_module.__default.FunctionBelow (Lit HandleTypeType |f#0@@0|) (Lit HandleTypeType |g#0|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly T@U) ($Heap@@1 T@U) (|f#0@@1| T@U) (|n#0| Int) ) (!  (=> (or (|_module.__default.Iter#canCall| (Lit HandleTypeType |f#0@@1|) (LitInt |n#0|)) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@1) ($Is HandleTypeType |f#0@@1| (Tclass._System.___hTotalFunc1 TInt TInt))))) (and (=> (< (LitInt 0) (LitInt |n#0|)) (|_module.__default.Iter#canCall| (Lit HandleTypeType |f#0@@1|) (LitInt (- |n#0| 1)))) (= (_module.__default.Iter ($LS $ly) (Lit HandleTypeType |f#0@@1|) (LitInt |n#0|)) (ite (<= (LitInt |n#0|) (LitInt 0)) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@1 (Lit HandleTypeType |f#0@@1|) ($Box intType (int_2_U (LitInt 1)))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@1 (Lit HandleTypeType |f#0@@1|) ($Box intType (int_2_U (LitInt (_module.__default.Iter ($LS $ly) (Lit HandleTypeType |f#0@@1|) (LitInt (- |n#0| 1)))))))))))))
 :qid |Ackermanndfy.59:16|
 :weight 3
 :skolemid |566|
 :pattern ( (_module.__default.Iter ($LS $ly) (Lit HandleTypeType |f#0@@1|) (LitInt |n#0|)) ($IsGoodHeap $Heap@@1))
))))
...
(assert (forall (($ly@@0 T@U) (|f#0@@4| T@U) (|n#0@@0| Int) ) (! (= (_module.__default.Iter ($LS $ly@@0) |f#0@@4| |n#0@@0|) (_module.__default.Iter $ly@@0 |f#0@@4| |n#0@@0|))
 :qid |Ackermanndfy.59:16|
 :skolemid |560|
 :pattern ( (_module.__default.Iter ($LS $ly@@0) |f#0@@4| |n#0@@0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@1 T@U) ($Heap@@2 T@U) (|f#0@@5| T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.__default.Iter#canCall| |f#0@@5| (LitInt |n#0@@1|)) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@2) ($Is HandleTypeType |f#0@@5| (Tclass._System.___hTotalFunc1 TInt TInt))))) (and (=> (< (LitInt 0) (LitInt |n#0@@1|)) (|_module.__default.Iter#canCall| |f#0@@5| (LitInt (- |n#0@@1| 1)))) (= (_module.__default.Iter ($LS $ly@@1) |f#0@@5| (LitInt |n#0@@1|)) (ite (<= (LitInt |n#0@@1|) (LitInt 0)) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@2 |f#0@@5| ($Box intType (int_2_U (LitInt 1)))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@2 |f#0@@5| ($Box intType (int_2_U (_module.__default.Iter ($LS $ly@@1) |f#0@@5| (LitInt (- |n#0@@1| 1))))))))))))
 :qid |Ackermanndfy.59:16|
 :weight 3
 :skolemid |565|
 :pattern ( (_module.__default.Iter ($LS $ly@@1) |f#0@@5| (LitInt |n#0@@1|)) ($IsGoodHeap $Heap@@2))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@3 T@U) (|f#0@@6| T@U) (|g#0@@0| T@U) ) (!  (=> (or (|_module.__default.FunctionBelow#canCall| |f#0@@6| |g#0@@0|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@3) ($Is HandleTypeType |f#0@@6| (Tclass._System.___hTotalFunc1 TInt TInt))) ($Is HandleTypeType |g#0@@0| (Tclass._System.___hTotalFunc1 TInt TInt))))) (= (_module.__default.FunctionBelow |f#0@@6| |g#0@@0|) (forall ((|n#0@@2| Int) ) (! (<= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@3 |f#0@@6| ($Box intType (int_2_U |n#0@@2|))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@3 |g#0@@0| ($Box intType (int_2_U |n#0@@2|))))))
 :qid |Ackermanndfy.107:10|
 :skolemid |575|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@3 |g#0@@0| ($Box intType (int_2_U |n#0@@2|)))))
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@3 |f#0@@6| ($Box intType (int_2_U |n#0@@2|)))))
))))
 :qid |Ackermanndfy.105:17|
 :skolemid |576|
 :pattern ( (_module.__default.FunctionBelow |f#0@@6| |g#0@@0|) ($IsGoodHeap $Heap@@3))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@2 T@U) ($Heap@@4 T@U) (|f#0@@9| T@U) (|n#0@@3| Int) ) (!  (=> (or (|_module.__default.Iter#canCall| |f#0@@9| |n#0@@3|) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@4) ($Is HandleTypeType |f#0@@9| (Tclass._System.___hTotalFunc1 TInt TInt))))) (and (=> (< (LitInt 0) |n#0@@3|) (|_module.__default.Iter#canCall| |f#0@@9| (- |n#0@@3| 1))) (= (_module.__default.Iter ($LS $ly@@2) |f#0@@9| |n#0@@3|) (ite (<= |n#0@@3| (LitInt 0)) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@4 |f#0@@9| ($Box intType (int_2_U (LitInt 1)))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@4 |f#0@@9| ($Box intType (int_2_U (_module.__default.Iter $ly@@2 |f#0@@9| (- |n#0@@3| 1)))))))))))
 :qid |Ackermanndfy.59:16|
 :skolemid |564|
 :pattern ( (_module.__default.Iter ($LS $ly@@2) |f#0@@9| |n#0@@3|) ($IsGoodHeap $Heap@@4))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@5 T@U) (|f#0@@10| T@U) ) (!  (=> (or (|_module.__default.FunctionMonotonic#canCall| |f#0@@10|) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@5) ($Is HandleTypeType |f#0@@10| (Tclass._System.___hTotalFunc1 TInt TInt))))) (= (_module.__default.FunctionMonotonic |f#0@@10|) (forall ((|n#0@@4| Int) (|n'#0| Int) ) (!  (=> (<= |n#0@@4| |n'#0|) (<= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@5 |f#0@@10| ($Box intType (int_2_U |n#0@@4|))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@5 |f#0@@10| ($Box intType (int_2_U |n'#0|)))))))
 :qid |Ackermanndfy.113:10|
 :skolemid |583|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@5 |f#0@@10| ($Box intType (int_2_U |n'#0|)))) ($Unbox intType (Apply1 TInt TInt $Heap@@5 |f#0@@10| ($Box intType (int_2_U |n#0@@4|)))))
))))
 :qid |Ackermanndfy.111:17|
 :skolemid |584|
 :pattern ( (_module.__default.FunctionMonotonic |f#0@@10|) ($IsGoodHeap $Heap@@5))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.IterIsMonotonicF)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@6 $Heap@0)) (and (forall ((|$ih#n0#0| Int) ) (!  (=> (and (and (_module.__default.FunctionMonotonic |f#0@@11|) (_module.__default.FunctionBelow |f#0@@11| |g#0@@1|)) (and (<= 0 |$ih#n0#0|) (< |$ih#n0#0| |n#0@@5|))) (<= (_module.__default.Iter ($LS $LZ) |f#0@@11| |$ih#n0#0|) (_module.__default.Iter ($LS $LZ) |g#0@@1| |$ih#n0#0|)))
 :qid |Ackermanndfy.136:54|
 :skolemid |614|
 :pattern ( (_module.__default.Iter ($LS $LZ) |g#0@@1| |$ih#n0#0|))
 :pattern ( (_module.__default.Iter ($LS $LZ) |f#0@@11| |$ih#n0#0|))
)) (= (ControlFlow 0 2) (- 0 1)))) (<= (_module.__default.Iter ($LS ($LS $LZ)) |f#0@@11| |n#0@@5|) (_module.__default.Iter ($LS ($LS $LZ)) |g#0@@1| |n#0@@5|))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (and ($Is HandleTypeType |f#0@@11| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |f#0@@11| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap@@6))) (=> (and (and (and (and ($Is HandleTypeType |g#0@@1| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |g#0@@1| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap@@6)) (= 1 $FunctionContextHeight)) (and (|_module.__default.FunctionMonotonic#canCall| |f#0@@11|) (and (_module.__default.FunctionMonotonic |f#0@@11|) (forall ((|n#3| T@U) (|n'#1@@0| T@U) ) (!  (=> (<= (U_2_int |n#3|) (U_2_int |n'#1@@0|)) (<= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@6 |f#0@@11| ($Box intType |n#3|)))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@6 |f#0@@11| ($Box intType |n'#1@@0|))))))
 :qid |Ackermanndfy.113:10|
 :skolemid |611|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@6 |f#0@@11| ($Box intType |n'#1@@0|))) ($Unbox intType (Apply1 TInt TInt $Heap@@6 |f#0@@11| ($Box intType |n#3|))))
))))) (and (and (|_module.__default.FunctionBelow#canCall| |f#0@@11| |g#0@@1|) (and (_module.__default.FunctionBelow |f#0@@11| |g#0@@1|) (forall ((|n#4| T@U) ) (! (<= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@6 |f#0@@11| ($Box intType |n#4|)))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@6 |g#0@@1| ($Box intType |n#4|)))))
 :qid |Ackermanndfy.107:10|
 :skolemid |613|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@6 |g#0@@1| ($Box intType |n#4|))))
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@6 |f#0@@11| ($Box intType |n#4|))))
