...
(declare-fun |elt#0@@1| () T@U)
(declare-fun _module._default.SeqRepeat$T@@1 () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$_module.__default.SeqRepeat)
...
(let ((anon5_correct  (=> (and (and (<= (LitInt 0) |i#2@0|) (< |i#2@0| |count#0@@1|)) (and ($IsAlloc intType (int_2_U |count#0@@1|) Tclass._System.nat $Heap@@0) ($IsAllocBox |elt#0@@1| _module._default.SeqRepeat$T@@1 $Heap@@0))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (or (<= 0 |count#0@@1|) (= |count#0@@1| |count#0@@1|))) (=> (or (<= 0 |count#0@@1|) (= |count#0@@1| |count#0@@1|)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (or (and (= |count#0@@1| |count#0@@1|) (= |elt#0@@1| |elt#0@@1|)) (< |count#0@@1| |count#0@@1|))) (=> (or (and (= |count#0@@1| |count#0@@1|) (= |elt#0@@1| |elt#0@@1|)) (< |count#0@@1| |count#0@@1|)) (=> (or (and (= |count#0@@1| |count#0@@1|) (= |elt#0@@1| |elt#0@@1|)) (|_module.__default.SeqRepeat#canCall| _module._default.SeqRepeat$T@@1 |count#0@@1| |elt#0@@1|)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (and (<= 0 |i#2@0|) (< |i#2@0| (|Seq#Length| (_module.__default.SeqRepeat _module._default.SeqRepeat$T@@1 |count#0@@1| |elt#0@@1|))))) (=> (and (<= 0 |i#2@0|) (< |i#2@0| (|Seq#Length| (_module.__default.SeqRepeat _module._default.SeqRepeat$T@@1 |count#0@@1| |elt#0@@1|)))) (=> (and (= (|Seq#Index| (_module.__default.SeqRepeat _module._default.SeqRepeat$T@@1 |count#0@@1| |elt#0@@1|) |i#2@0|) |elt#0@@1|) (= (ControlFlow 0 4) 2)) anon7_correct)))))))))))
(let ((anon11_Else_correct  (=> (and (< |i#2@0| (LitInt 0)) (= (ControlFlow 0 9) 4)) anon5_correct)))
(let ((anon11_Then_correct  (=> (and (<= (LitInt 0) |i#2@0|) (= (ControlFlow 0 8) 4)) anon5_correct)))
(let ((anon10_Else_correct  (=> (and (=> (and (<= (LitInt 0) |i#2@0|) (< |i#2@0| |count#0@@1|)) (= (|Seq#Index| (_module.__default.SeqRepeat _module._default.SeqRepeat$T@@1 |count#0@@1| |elt#0@@1|) |i#2@0|) |elt#0@@1|)) (= (ControlFlow 0 3) 2)) anon7_correct)))
(let ((anon9_Then_correct  (=> ($Is SeqType (_module.__default.SeqRepeat _module._default.SeqRepeat$T@@1 |count#0@@1| |elt#0@@1|) (TSeq _module._default.SeqRepeat$T@@1)) (=> (and ($IsAlloc intType (int_2_U |count#0@@1|) Tclass._System.nat $Heap@@0) ($IsAllocBox |elt#0@@1| _module._default.SeqRepeat$T@@1 $Heap@@0)) (and (=> (= (ControlFlow 0 10) (- 0 12)) (or (<= 0 |count#0@@1|) (= |count#0@@1| |count#0@@1|))) (=> (or (<= 0 |count#0@@1|) (= |count#0@@1| |count#0@@1|)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (or (and (= |count#0@@1| |count#0@@1|) (= |elt#0@@1| |elt#0@@1|)) (< |count#0@@1| |count#0@@1|))) (=> (or (and (= |count#0@@1| |count#0@@1|) (= |elt#0@@1| |elt#0@@1|)) (< |count#0@@1| |count#0@@1|)) (=> (and (or (and (= |count#0@@1| |count#0@@1|) (= |elt#0@@1| |elt#0@@1|)) (|_module.__default.SeqRepeat#canCall| _module._default.SeqRepeat$T@@1 |count#0@@1| |elt#0@@1|)) (= (|Seq#Length| (_module.__default.SeqRepeat _module._default.SeqRepeat$T@@1 |count#0@@1| |elt#0@@1|)) |count#0@@1|)) (and (and (=> (= (ControlFlow 0 10) 3) anon10_Else_correct) (=> (= (ControlFlow 0 10) 8) anon11_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon11_Else_correct)))))))))))
(let ((anon9_Else_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (and (=> (= (ControlFlow 0 13) 10) anon9_Then_correct) (=> (= (ControlFlow 0 13) 1) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (<= (LitInt 0) |count#0@@1|) ($IsBox |elt#0@@1| _module._default.SeqRepeat$T@@1)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct))))
