...
(|_module.__default.length#canCall| _module._default.length$_T0 |tl#3|))) (= (_module.__default.length _module._default.length$_T0 ($LS $ly) (Lit DatatypeTypeType |list#0|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |list#0|)) 0 (let ((|tl#2| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |list#0|)))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.length$_T0@@1 T@U) ($ly@@1 T@U) (|list#0@@1| T@U) ) (!  (=> (or (|_module.__default.length#canCall| _module._default.length$_T0@@1 |list#0@@1|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |list#0@@1| (Tclass._module.List _module._default.length$_T0@@1)))) (and (=> (not (_module.List.Nil_q |list#0@@1|)) (let ((|tl#1| (_module.List._h1 |list#0@@1|)))
(|_module.__default.length#canCall| _module._default.length$_T0@@1 |tl#1|))) (= (_module.__default.length _module._default.length$_T0@@1 ($LS $ly@@1) |list#0@@1|) (ite (_module.List.Nil_q |list#0@@1|) 0 (let ((|tl#0| (_module.List._h1 |list#0@@1|)))
(+ 1 (_module.__default.length _module._default.length$_T0@@1 $ly@@1 |tl#0|)))))))
 :qid |unknown.0:0|
 :skolemid |653|
...
(let ((anon10_Then_correct  (=> (= |list#0@@3| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) (=> (and ($IsBox |_mcc#0#0| _module._default.length$_T0@@3) ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List _module._default.length$_T0@@3))) (=> (and (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List _module._default.length$_T0@@3))) (and (= |tl#Z#0@0| |let#0#0#0|) ($IsAlloc DatatypeTypeType |tl#Z#0@0| (Tclass._module.List _module._default.length$_T0@@3) $Heap))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< (DtRank |tl#Z#0@0|) (DtRank |list#0@@3|))) (=> (< (DtRank |tl#Z#0@0|) (DtRank |list#0@@3|)) (=> (and (|_module.__default.length#canCall| _module._default.length$_T0@@3 |tl#Z#0@0|) (= (ControlFlow 0 5) (- 0 4))) ($Is intType (int_2_U (+ 1 (_module.__default.length _module._default.length$_T0@@3 ($LS $LZ) |tl#Z#0@0|))) Tclass._System.nat)))))))))
