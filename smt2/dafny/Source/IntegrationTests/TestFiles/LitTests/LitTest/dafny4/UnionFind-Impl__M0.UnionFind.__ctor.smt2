...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@11 T@U) ($f@@1 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#2| |l#0| |l#1| |l#2| |l#3|) $o@@11 $f@@1))  (=> (and (or (not (= $o@@11 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@11) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |4512|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#2| |l#0| |l#1| |l#2| |l#3|) $o@@11 $f@@1))
)))
...
(set-info :boogie-vc-id Impl$$M0.UnionFind.__ctor)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#2| null $Heap@@2 alloc false)) (=> (and (= |$rhs#0@0| (|Set#UnionOne| |Set#Empty| ($Box refType this@@4))) (= |$rhs#1@0| (Lit MapType |Map#Empty|))) (=> (and (and (and (or (not (= this@@4 null)) (not true)) ($Is refType this@@4 Tclass.M0.UnionFind?)) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) alloc)))) (= ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) M0.UnionFind.M)) |$rhs#1@0|))) (and (and (= ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) M0.UnionFind.Repr)) |$rhs#0@0|) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@4 M0.UnionFind.Repr))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@4 M0.UnionFind.Repr)) (=> (= |$rhs#2@0| (|Set#UnionOne| |Set#Empty| ($Box refType this@@4))) (=> (and (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 this@@4 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) M0.UnionFind.Repr ($Box SetType |$rhs#2@0|)))) ($IsGoodHeap $Heap@1)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|M0.UnionFind.Valid#canCall| $Heap@1 this@@4) (or (M0.UnionFind.Valid $Heap@1 this@@4) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@4) M0.UnionFind.Repr)) ($Box refType this@@4))))) (=> (=> (|M0.UnionFind.Valid#canCall| $Heap@1 this@@4) (or (M0.UnionFind.Valid $Heap@1 this@@4) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@4) M0.UnionFind.Repr)) ($Box refType this@@4)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|M0.UnionFind.Valid#canCall| $Heap@1 this@@4) (or (M0.UnionFind.Valid $Heap@1 this@@4) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@4) M0.UnionFind.Repr)) ($Box refType null)))))) (=> (=> (|M0.UnionFind.Valid#canCall| $Heap@1 this@@4) (or (M0.UnionFind.Valid $Heap@1 this@@4) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@4) M0.UnionFind.Repr)) ($Box refType null))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|M0.UnionFind.Valid#canCall| $Heap@1 this@@4) (or (M0.UnionFind.Valid $Heap@1 this@@4) (M0.UnionFind.ValidM1 $Heap@1 this@@4)))) (=> (=> (|M0.UnionFind.Valid#canCall| $Heap@1 this@@4) (or (M0.UnionFind.Valid $Heap@1 this@@4) (M0.UnionFind.ValidM1 $Heap@1 this@@4))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (forall (($o@@12 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@4) M0.UnionFind.Repr)) ($Box refType $o@@12)) (or (not (= $o@@12 null)) (not true)))
 :qid |UnionFinddfy.17:5|
 :skolemid |564|
 :pattern (  (or (not (= $o@@12 null)) (not true)))
)) (forall (($o@@13 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@4) M0.UnionFind.Repr)) ($Box refType $o@@13)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@13) alloc)))))
 :qid |UnionFinddfy.17:5|
 :skolemid |565|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@4) M0.UnionFind.Repr)) ($Box refType $o@@13)))
)))) (=> (and (forall (($o@@14 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@4) M0.UnionFind.Repr)) ($Box refType $o@@14)) (or (not (= $o@@14 null)) (not true)))
 :qid |UnionFinddfy.17:5|
 :skolemid |564|
 :pattern (  (or (not (= $o@@14 null)) (not true)))
)) (forall (($o@@15 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@4) M0.UnionFind.Repr)) ($Box refType $o@@15)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@15) alloc)))))
 :qid |UnionFinddfy.17:5|
 :skolemid |565|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@4) M0.UnionFind.Repr)) ($Box refType $o@@15)))
))) (=> (= (ControlFlow 0 2) (- 0 1)) (|Map#Equal| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@4) M0.UnionFind.M)) |Map#Empty|)))))))))))))))))))
