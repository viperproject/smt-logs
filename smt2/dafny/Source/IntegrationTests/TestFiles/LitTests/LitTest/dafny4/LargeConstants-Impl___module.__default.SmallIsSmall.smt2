...
(set-info :boogie-vc-id Impl$$_module.__default.SmallIsSmall)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (U_2_bool (Lit boolType (bool_2_U (< (- 0 9223372036854775808) 0)))))))
