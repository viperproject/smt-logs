...
(declare-fun |##n#0_0_0_5@0| () T@U)
(declare-fun |m'#0_0@0| () T@U)
(declare-fun $Heap@0 () T@U)
(declare-fun |##m#0_0_0_4@0| () T@U)
(declare-fun |##n#0_0_0_4@0| () T@U)
(declare-fun |n#0@@7| () T@U)
(declare-fun |a#0_0_0_0@0| () T@U)
...
(declare-fun |##n#0_0_0_1@0| () T@U)
(declare-fun |##n#0_0_0_0@0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.mult__lemma_split5)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon11_correct  (=> (forall ((|a#0_0_0_1| T@U) (|b#0_0_0_1| T@U) ) (!  (=> (and ($Is DatatypeTypeType |a#0_0_0_1| Tclass._module.Nat) ($Is DatatypeTypeType |b#0_0_0_1| Tclass._module.Nat)) (and (|$IsA#_module.Nat| (_module.__default.plus ($LS $LZ) |a#0_0_0_1| (|#_module.Nat.S| |b#0_0_0_1|))) (and (|_module.__default.plus#canCall| |a#0_0_0_1| |b#0_0_0_1|) (|_module.__default.plus#canCall| |a#0_0_0_1| (|#_module.Nat.S| |b#0_0_0_1|)))))
 :qid |SoftwareFoundationsBasicsdfy.290:27|
 :skolemid |702|
 :pattern ( (_module.__default.plus ($LS $LZ) |a#0_0_0_1| (|#_module.Nat.S| |b#0_0_0_1|)))
 :pattern ( (|#_module.Nat.S| (_module.__default.plus ($LS $LZ) |a#0_0_0_1| |b#0_0_0_1|)))
)) (=> (and (forall ((|a#0_0_0_1@@0| T@U) (|b#0_0_0_1@@0| T@U) ) (!  (=> (and ($Is DatatypeTypeType |a#0_0_0_1@@0| Tclass._module.Nat) ($Is DatatypeTypeType |b#0_0_0_1@@0| Tclass._module.Nat)) (|_module.Nat#Equal| (|#_module.Nat.S| (_module.__default.plus ($LS $LZ) |a#0_0_0_1@@0| |b#0_0_0_1@@0|)) (_module.__default.plus ($LS $LZ) |a#0_0_0_1@@0| (|#_module.Nat.S| |b#0_0_0_1@@0|))))
 :qid |SoftwareFoundationsBasicsdfy.290:27|
 :skolemid |711|
 :pattern ( (_module.__default.plus ($LS $LZ) |a#0_0_0_1@@0| (|#_module.Nat.S| |b#0_0_0_1@@0|)))
 :pattern ( (|#_module.Nat.S| (_module.__default.plus ($LS $LZ) |a#0_0_0_1@@0| |b#0_0_0_1@@0|)))
)) (= |##n#0_0_0_5@0| (|#_module.Nat.S| |m'#0_0@0|))) (=> (and (and ($IsAlloc DatatypeTypeType |##n#0_0_0_5@0| Tclass._module.Nat $Heap@0) (= |##m#0_0_0_4@0| (|#_module.Nat.S| |m'#0_0@0|))) (and ($IsAlloc DatatypeTypeType |##m#0_0_0_4@0| Tclass._module.Nat $Heap@0) (|_module.__default.plus#canCall| (|#_module.Nat.S| |m'#0_0@0|) (|#_module.Nat.S| |m'#0_0@0|)))) (=> (and (and (and (= |##n#0_0_0_4@0| (_module.__default.plus ($LS $LZ) (|#_module.Nat.S| |m'#0_0@0|) (|#_module.Nat.S| |m'#0_0@0|))) ($IsAlloc DatatypeTypeType |##n#0_0_0_4@0| Tclass._module.Nat $Heap@0)) (and ($IsAlloc DatatypeTypeType |n#0@@7| Tclass._module.Nat $Heap@0) (|_module.__default.mult#canCall| (_module.__default.plus ($LS $LZ) (|#_module.Nat.S| |m'#0_0@0|) (|#_module.Nat.S| |m'#0_0@0|)) |n#0@@7|))) (and (and (|_module.__default.plus#canCall| (|#_module.Nat.S| |m'#0_0@0|) (|#_module.Nat.S| |m'#0_0@0|)) (|_module.__default.mult#canCall| (_module.__default.plus ($LS $LZ) (|#_module.Nat.S| |m'#0_0@0|) (|#_module.Nat.S| |m'#0_0@0|)) |n#0@@7|)) (= (ControlFlow 0 2) (- 0 1)))) (|_module.Nat#Equal| (_module.__default.mult ($LS ($LS $LZ)) (|#_module.Nat.S| (_module.__default.plus ($LS ($LS $LZ)) (|#_module.Nat.S| |m'#0_0@0|) |m'#0_0@0|)) |n#0@@7|) (_module.__default.mult ($LS ($LS $LZ)) (_module.__default.plus ($LS ($LS $LZ)) (|#_module.Nat.S| |m'#0_0@0|) (|#_module.Nat.S| |m'#0_0@0|)) |n#0@@7|))))))))
(let ((anon23_Else_correct  (=> (and (not (and (and ($Is DatatypeTypeType |a#0_0_0_0@0| Tclass._module.Nat) ($IsAlloc DatatypeTypeType |a#0_0_0_0@0| Tclass._module.Nat $Heap@0)) (and ($Is DatatypeTypeType |b#0_0_0_0@0| Tclass._module.Nat) ($IsAlloc DatatypeTypeType |b#0_0_0_0@0| Tclass._module.Nat $Heap@0)))) (= (ControlFlow 0 4) 2)) anon11_correct)))
(let ((anon23_Then_correct  (=> (and (and ($Is DatatypeTypeType |a#0_0_0_0@0| Tclass._module.Nat) ($IsAlloc DatatypeTypeType |a#0_0_0_0@0| Tclass._module.Nat $Heap@0)) (and ($Is DatatypeTypeType |b#0_0_0_0@0| Tclass._module.Nat) ($IsAlloc DatatypeTypeType |b#0_0_0_0@0| Tclass._module.Nat $Heap@0))) (=> (and (and (and ($IsAlloc DatatypeTypeType |a#0_0_0_0@0| Tclass._module.Nat $Heap@0) ($IsAlloc DatatypeTypeType |b#0_0_0_0@0| Tclass._module.Nat $Heap@0)) (and (|_module.__default.plus#canCall| |a#0_0_0_0@0| |b#0_0_0_0@0|) ($IsAlloc DatatypeTypeType |a#0_0_0_0@0| Tclass._module.Nat $Heap@0))) (and (and (= |##m#0_0_0_3@0| (|#_module.Nat.S| |b#0_0_0_0@0|)) ($IsAlloc DatatypeTypeType |##m#0_0_0_3@0| Tclass._module.Nat $Heap@0)) (and (|_module.__default.plus#canCall| |a#0_0_0_0@0| (|#_module.Nat.S| |b#0_0_0_0@0|)) (= (ControlFlow 0 3) 2)))) anon11_correct))))
(let ((anon0_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |m#0@@7| Tclass._module.Nat) ($IsAlloc DatatypeTypeType |m#0@@7| Tclass._module.Nat $Heap)) (|$IsA#_module.Nat| |m#0@@7|)) (=> (and (and (and (and (and ($Is DatatypeTypeType |n#0@@7| Tclass._module.Nat) ($IsAlloc DatatypeTypeType |n#0@@7| Tclass._module.Nat $Heap)) (|$IsA#_module.Nat| |n#0@@7|)) (and (and (= 3 $FunctionContextHeight) (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false))) (and (|$IsA#_module.Nat| |m#0@@7|) (|$IsA#_module.Nat| |n#0@@7|)))) (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (and (forall ((|$ih#m0#0| T@U) (|$ih#n0#0| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |$ih#m0#0| Tclass._module.Nat) ($Is DatatypeTypeType |$ih#n0#0| Tclass._module.Nat)) (U_2_bool (Lit boolType (bool_2_U true)))) (or (< (DtRank |$ih#m0#0|) (DtRank |m#0@@7|)) (and (= (DtRank |$ih#m0#0|) (DtRank |m#0@@7|)) (< (DtRank |$ih#n0#0|) (DtRank |n#0@@7|))))) (|_module.Nat#Equal| (_module.__default.mult ($LS $LZ) |$ih#m0#0| (_module.__default.plus ($LS $LZ) |$ih#n0#0| |$ih#n0#0|)) (_module.__default.mult ($LS $LZ) (_module.__default.plus ($LS $LZ) |$ih#m0#0| |$ih#m0#0|) |$ih#n0#0|)))
...
)) (or (not (= |m#0@@7| |#_module.Nat.O|)) (not true))) (and (= |m#0@@7| (|#_module.Nat.S| |_mcc#0#0_0@0|)) ($Is DatatypeTypeType |_mcc#0#0_0@0| Tclass._module.Nat))))) (and (and (and (and ($Is DatatypeTypeType |m'#0_0@0| Tclass._module.Nat) ($IsAlloc DatatypeTypeType |m'#0_0@0| Tclass._module.Nat $Heap@0)) (= |let#0_0#0#0| |_mcc#0#0_0@0|)) (and (and ($Is DatatypeTypeType |let#0_0#0#0| Tclass._module.Nat) (= |m'#0_0@0| |let#0_0#0#0|)) (and (= |##n#0_0_0_1@0| (|#_module.Nat.S| |m'#0_0@0|)) ($IsAlloc DatatypeTypeType |##n#0_0_0_1@0| Tclass._module.Nat $Heap@0)))) (and (and (and ($IsAlloc DatatypeTypeType |m'#0_0@0| Tclass._module.Nat $Heap@0) (|_module.__default.plus#canCall| (|#_module.Nat.S| |m'#0_0@0|) |m'#0_0@0|)) (and (= |##n#0_0_0_0@0| (|#_module.Nat.S| (_module.__default.plus ($LS $LZ) (|#_module.Nat.S| |m'#0_0@0|) |m'#0_0@0|))) ($IsAlloc DatatypeTypeType |##n#0_0_0_0@0| Tclass._module.Nat $Heap@0))) (and (and ($IsAlloc DatatypeTypeType |n#0@@7| Tclass._module.Nat $Heap@0) (|_module.__default.mult#canCall| (|#_module.Nat.S| (_module.__default.plus ($LS $LZ) (|#_module.Nat.S| |m'#0_0@0|) |m'#0_0@0|)) |n#0@@7|)) (and (|_module.__default.plus#canCall| (|#_module.Nat.S| |m'#0_0@0|) |m'#0_0@0|) (|_module.__default.mult#canCall| (|#_module.Nat.S| (_module.__default.plus ($LS $LZ) (|#_module.Nat.S| |m'#0_0@0|) |m'#0_0@0|)) |n#0@@7|)))))) (and (=> (= (ControlFlow 0 5) 3) anon23_Then_correct) (=> (= (ControlFlow 0 5) 4) anon23_Else_correct)))))))
anon0_correct)))))
))
(check-sat)
(get-info :rlimit)
