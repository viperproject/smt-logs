...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module._default.last$T T@U) (|s#0| T@U) ) (!  (=> (or (|_module.__default.last#canCall| _module._default.last$T (Lit SeqType |s#0|)) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |s#0| (TSeq _module._default.last$T)) (> (|Seq#Length| (Lit SeqType |s#0|)) 0)))) (= (_module.__default.last _module._default.last$T (Lit SeqType |s#0|)) (|Seq#Index| (Lit SeqType |s#0|) (- (|Seq#Length| (Lit SeqType |s#0|)) 1))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |483|
 :pattern ( (_module.__default.last _module._default.last$T (Lit SeqType |s#0|)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module._default.last$T@@0 T@U) (|s#0@@0| T@U) ) (!  (=> (or (|_module.__default.last#canCall| _module._default.last$T@@0 |s#0@@0|) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |s#0@@0| (TSeq _module._default.last$T@@0)) (> (|Seq#Length| |s#0@@0|) 0)))) ($IsBox (_module.__default.last _module._default.last$T@@0 |s#0@@0|) _module._default.last$T@@0))
 :qid |unknown.0:0|
 :skolemid |479|
 :pattern ( (_module.__default.last _module._default.last$T@@0 |s#0@@0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (_module._default.last$T@@1 T@U) (|s#0@@1| T@U) ) (!  (=> (and (or (|_module.__default.last#canCall| _module._default.last$T@@1 |s#0@@1|) (and (< 0 $FunctionContextHeight) (and (and ($Is SeqType |s#0@@1| (TSeq _module._default.last$T@@1)) ($IsAlloc SeqType |s#0@@1| (TSeq _module._default.last$T@@1) $Heap@@0)) (> (|Seq#Length| |s#0@@1|) 0)))) ($IsGoodHeap $Heap@@0)) ($IsAllocBox (_module.__default.last _module._default.last$T@@1 |s#0@@1|) _module._default.last$T@@1 $Heap@@0))
 :qid |gitissue41dfy.6:16|
 :skolemid |480|
 :pattern ( ($IsAllocBox (_module.__default.last _module._default.last$T@@1 |s#0@@1|) _module._default.last$T@@1 $Heap@@0))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module._default.last$T@@2 T@U) (|s#0@@2| T@U) ) (!  (=> (or (|_module.__default.last#canCall| _module._default.last$T@@2 |s#0@@2|) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |s#0@@2| (TSeq _module._default.last$T@@2)) (> (|Seq#Length| |s#0@@2|) 0)))) (= (_module.__default.last _module._default.last$T@@2 |s#0@@2|) (|Seq#Index| |s#0@@2| (- (|Seq#Length| |s#0@@2|) 1))))
 :qid |unknown.0:0|
 :skolemid |482|
 :pattern ( (_module.__default.last _module._default.last$T@@2 |s#0@@2|))
))))
...
(declare-fun |word_seqs'#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.AltTest)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (= |word_seqs'#0@0| (|Seq#Append| |word_seqs#0| (|Seq#Build| |Seq#Empty| ($Box SeqType |words#0|)))) ($IsAlloc SeqType |word_seqs'#0@0| (TSeq (TSeq Tclass._module.uint32)) $Heap@@1)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (> (|Seq#Length| |word_seqs'#0@0|) 0)) (=> (and (|_module.__default.last#canCall| (TSeq Tclass._module.uint32) |word_seqs'#0@0|) (|_module.__default.last#canCall| (TSeq Tclass._module.uint32) |word_seqs'#0@0|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Seq#Equal| ($Unbox SeqType (_module.__default.last (TSeq Tclass._module.uint32) |word_seqs'#0@0|)) |words#0|)) (=> (|Seq#Equal| ($Unbox SeqType (_module.__default.last (TSeq Tclass._module.uint32) |word_seqs'#0@0|)) |words#0|) (=> ($IsAlloc SeqType |word_seqs#0| (TSeq (TSeq Tclass._module.uint32)) $Heap@@1) (=> (and (|_module.__default.ConcatenateSeqs#canCall| Tclass._module.uint32 |word_seqs#0|) ($IsAlloc SeqType |word_seqs'#0@0| (TSeq (TSeq Tclass._module.uint32)) $Heap@@1)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (> (|Seq#Length| |word_seqs'#0@0|) 0)) (=> (|_module.__default.last#canCall| (TSeq Tclass._module.uint32) |word_seqs'#0@0|) (=> (and ($IsAlloc SeqType |word_seqs#0| (TSeq (TSeq Tclass._module.uint32)) $Heap@@1) (|_module.__default.ConcatenateSeqs#canCall| Tclass._module.uint32 |word_seqs#0|)) (=> (and (and (and (|_module.__default.ConcatenateSeqs#canCall| Tclass._module.uint32 |word_seqs#0|) (|_module.__default.last#canCall| (TSeq Tclass._module.uint32) |word_seqs'#0@0|)) (|_module.__default.ConcatenateSeqs#canCall| Tclass._module.uint32 |word_seqs#0|)) (= (ControlFlow 0 2) (- 0 1))) (|Seq#Equal| (|Seq#Append| (_module.__default.ConcatenateSeqs Tclass._module.uint32 ($LS ($LS $LZ)) |word_seqs#0|) ($Unbox SeqType (_module.__default.last (TSeq Tclass._module.uint32) |word_seqs'#0@0|))) (|Seq#Append| (_module.__default.ConcatenateSeqs Tclass._module.uint32 ($LS ($LS $LZ)) |word_seqs#0|) |words#0|))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and ($Is SeqType |word_seqs#0| (TSeq (TSeq Tclass._module.uint32))) ($IsAlloc SeqType |word_seqs#0| (TSeq (TSeq Tclass._module.uint32)) $Heap@@1)) (and ($Is SeqType |words#0| (TSeq Tclass._module.uint32)) ($IsAlloc SeqType |words#0| (TSeq Tclass._module.uint32) $Heap@@1))) (=> (and (and (and ($Is SeqType |word_seqs'#0| (TSeq (TSeq Tclass._module.uint32))) ($IsAlloc SeqType |word_seqs'#0| (TSeq (TSeq Tclass._module.uint32)) $Heap@@1)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 2))) anon0_correct)))))
