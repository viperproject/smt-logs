...
(set-info :boogie-vc-id Impl$$_module.__default.TrimPreservesValue)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (= (_module.__default.eval ($LS ($LS $LZ)) |digits#0@@7| |base#0@@3|) (_module.__default.eval ($LS ($LS $LZ)) (_module.__default.trim ($LS ($LS $LZ)) |digits#0@@7|) |base#0@@3|)))))
(let ((anon6_Else_correct  (=> (and (not (and (or (not (= (|Seq#Length| |digits#0@@7|) 0)) (not true)) (= (U_2_int ($Unbox intType (|Seq#Index| |digits#0@@7| |last#0@0|))) (LitInt 0)))) (= (ControlFlow 0 8) 2)) GeneratedUnifiedExit_correct)))
(let ((anon6_Then_correct  (=> (and (or (not (= (|Seq#Length| |digits#0@@7|) 0)) (not true)) (= (U_2_int ($Unbox intType (|Seq#Index| |digits#0@@7| |last#0@0|))) (LitInt 0))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (and (<= 0 |last#0@0|) (<= |last#0@0| (|Seq#Length| |digits#0@@7|)))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (|Seq#Equal| |digits#0@@7| (|Seq#Append| (|Seq#Take| |digits#0@@7| |last#0@0|) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 0))))))) (=> (|Seq#Equal| |digits#0@@7| (|Seq#Append| (|Seq#Take| |digits#0@@7| |last#0@0|) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 0)))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (and (<= 0 |last#0@0|) (<= |last#0@0| (|Seq#Length| |digits#0@@7|)))) (=> (and (<= 0 |last#0@0|) (<= |last#0@0| (|Seq#Length| |digits#0@@7|))) (=> (= |digits##0_0@0| (|Seq#Take| |digits#0@@7| |last#0@0|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= (LitInt 2) |base#0@@3|)) (=> (<= (LitInt 2) |base#0@@3|) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and (|_module.__default.eval#canCall| |digits##0_0@0| |base#0@@3|) (|_module.__default.eval#canCall| (|Seq#Append| |digits##0_0@0| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 0))))) |base#0@@3|)) (= (_module.__default.eval ($LS ($LS $LZ)) |digits##0_0@0| |base#0@@3|) (_module.__default.eval ($LS ($LS $LZ)) (|Seq#Append| |digits##0_0@0| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 0))))) |base#0@@3|))) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct)))))))))))))
(let ((anon2_correct  (and (=> (= (ControlFlow 0 9) 3) anon6_Then_correct) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct))))
(let ((anon5_Else_correct  (=> (and (= (|Seq#Length| |digits#0@@7|) 0) (= (ControlFlow 0 12) 9)) anon2_correct)))
(let ((anon5_Then_correct  (=> (or (not (= (|Seq#Length| |digits#0@@7|) 0)) (not true)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (and (<= 0 |last#0@0|) (< |last#0@0| (|Seq#Length| |digits#0@@7|)))) (=> (and (<= 0 |last#0@0|) (< |last#0@0| (|Seq#Length| |digits#0@@7|))) (=> (= (ControlFlow 0 10) 9) anon2_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (forall ((|$ih#digits0#0| T@U) (|$ih#base0#0| Int) ) (!  (=> (and (and ($Is SeqType |$ih#digits0#0| (TSeq TInt)) (<= (LitInt 2) |$ih#base0#0|)) (or (< (|Seq#Rank| |$ih#digits0#0|) (|Seq#Rank| |digits#0@@7|)) (and (= (|Seq#Rank| |$ih#digits0#0|) (|Seq#Rank| |digits#0@@7|)) (and (<= 0 |$ih#base0#0|) (< |$ih#base0#0| |base#0@@3|))))) (= (_module.__default.eval ($LS $LZ) |$ih#digits0#0| |$ih#base0#0|) (_module.__default.eval ($LS $LZ) (_module.__default.trim ($LS $LZ) |$ih#digits0#0|) |$ih#base0#0|)))
 :qid |NumberRepresentationsdfy.200:26|
 :skolemid |659|
 :pattern ( (_module.__default.eval ($LS $LZ) (_module.__default.trim ($LS $LZ) |$ih#digits0#0|) |$ih#base0#0|))
)) (= |last#0@0| (- (|Seq#Length| |digits#0@@7|) 1)))) (and (=> (= (ControlFlow 0 13) 10) anon5_Then_correct) (=> (= (ControlFlow 0 13) 12) anon5_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SeqType |digits#0@@7| (TSeq TInt)) ($IsAlloc SeqType |digits#0@@7| (TSeq TInt) $Heap)) (= 2 $FunctionContextHeight)) (and (<= (LitInt 2) |base#0@@3|) (= (ControlFlow 0 14) 13))) anon0_correct))))
