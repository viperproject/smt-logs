...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.Foo#canCall| (< 0 $FunctionContextHeight)) ($Is DatatypeTypeType _module.__default.Foo (Tclass._System.Tuple2 TInt TInt)))))
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.Foo#canCall| (< 0 $FunctionContextHeight)) (= _module.__default.Foo (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 1))) ($Box intType (int_2_U (LitInt 2)))))))))
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.Foo#canCall| (< 0 $FunctionContextHeight)) (= _module.__default.Foo (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 1))) ($Box intType (int_2_U (LitInt 2)))))))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) |_module.__default.Foo#canCall|) (=> (and (and (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType _module.__default.Foo)) (= |let#1#0#0| (Lit DatatypeTypeType _module.__default.Foo))) (and |_module.__default.Foo#canCall| |_module.__default.Foo#canCall|)) (and (and ($Is DatatypeTypeType |let#1#0#0| (Tclass._System.Tuple2 TInt TInt)) (_System.Tuple2.___hMake2_q |let#1#0#0|)) (and (= (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |x#1@0|)) ($Box intType (int_2_U |y#1@0|))) |let#1#0#0|) (= (ControlFlow 0 2) (- 0 1))))) (let ((|y#0| (U_2_int ($Unbox intType (_System.Tuple2._1 (Lit DatatypeTypeType _module.__default.Foo))))))
(let ((|x#0| (U_2_int ($Unbox intType (_System.Tuple2._0 (Lit DatatypeTypeType _module.__default.Foo))))))
(< |x#0| |y#0|)))))))
