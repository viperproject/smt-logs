...
(declare-fun |C'#0| () T@U)
(set-info :boogie-vc-id Impl$$M1.UnionFind.Reaches__Monotonic)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#d0#0| Int) (|$ih#e0#0| T@U) (|$ih#r0#0| T@U) (|$ih#C0#0| T@U) (|$ih#C'0#0| T@U) ) (!  (=> (and (and (and (and (and (and (<= (LitInt 0) |$ih#d0#0|) ($Is refType |$ih#e0#0| Tclass.M1.Element)) ($Is refType |$ih#r0#0| Tclass.M1.Element)) ($Is MapType |$ih#C0#0| (TMap Tclass.M1.Element Tclass.M1.Contents))) ($Is MapType |$ih#C'0#0| (TMap Tclass.M1.Element Tclass.M1.Contents))) (and (and (and (M1.__default.GoodCMap |$ih#C0#0|) (M1.__default.GoodCMap |$ih#C'0#0|)) (|Set#IsMember| (|Map#Domain| |$ih#C0#0|) ($Box refType |$ih#e0#0|))) (and (M1.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#d0#0| |$ih#e0#0| |$ih#r0#0| |$ih#C0#0|) (forall ((|f#8| T@U) ) (!  (=> ($Is refType |f#8| Tclass.M1.Element?) (and (=> (|Set#IsMember| (|Map#Domain| |$ih#C0#0|) ($Box refType |f#8|)) (|Set#IsMember| (|Map#Domain| |$ih#C'0#0|) ($Box refType |f#8|))) (=> (|Set#IsMember| (|Map#Domain| |$ih#C0#0|) ($Box refType |f#8|)) (|M1.Contents#Equal| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |$ih#C0#0|) ($Box refType |f#8|))) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |$ih#C'0#0|) ($Box refType |f#8|)))))))
...
))))) (or (and (<= 0 |$ih#d0#0|) (< |$ih#d0#0| |d#0@@3|)) (and (= |$ih#d0#0| |d#0@@3|) (or (and (= |$ih#e0#0| null) (or (not (= |e#0@@3| null)) (not true))) (and (=  (or (not (= |$ih#e0#0| null)) (not true))  (or (not (= |e#0@@3| null)) (not true))) (or (and (= |$ih#r0#0| null) (or (not (= |r#0@@3| null)) (not true))) (and (=  (or (not (= |$ih#r0#0| null)) (not true))  (or (not (= |r#0@@3| null)) (not true))) (or (and (|Set#Subset| (|Map#Domain| |$ih#C0#0|) (|Map#Domain| |C#0@@5|)) (not (|Set#Subset| (|Map#Domain| |C#0@@5|) (|Map#Domain| |$ih#C0#0|)))) (and (|Set#Equal| (|Map#Domain| |$ih#C0#0|) (|Map#Domain| |C#0@@5|)) (and (|Set#Subset| (|Map#Domain| |$ih#C'0#0|) (|Map#Domain| |C'#0|)) (not (|Set#Subset| (|Map#Domain| |C'#0|) (|Map#Domain| |$ih#C'0#0|))))))))))))) (M1.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#d0#0| |$ih#e0#0| |$ih#r0#0| |$ih#C'0#0|))
 :qid |UnionFinddfy.78:52|
 :skolemid |1254|
 :pattern ( (M1.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#d0#0| |$ih#e0#0| |$ih#r0#0| |$ih#C'0#0|) (M1.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#d0#0| |$ih#e0#0| |$ih#r0#0| |$ih#C0#0|))
 :pattern ( (M1.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#d0#0| |$ih#e0#0| |$ih#r0#0| |$ih#C'0#0|) (M1.__default.GoodCMap |$ih#C0#0|))
 :pattern ( (M1.UnionFind.Reaches ($LS $LZ) this@@3 |$ih#d0#0| |$ih#e0#0| |$ih#r0#0| |$ih#C0#0|) (M1.__default.GoodCMap |$ih#C'0#0|))
)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|M1.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (or (M1.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (=> (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |e#0@@3|)))) (= |e#0@@3| |r#0@@3|))))) (=> (=> (|M1.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (or (M1.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (=> (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |e#0@@3|)))) (= |e#0@@3| |r#0@@3|)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|M1.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (or (M1.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (=> (not (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |e#0@@3|))))) (or (not (= |d#0@@3| 0)) (not true)))))) (=> (=> (|M1.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (or (M1.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (=> (not (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |e#0@@3|))))) (or (not (= |d#0@@3| 0)) (not true))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|M1.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (or (M1.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C'#0|) (=> (not (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |e#0@@3|))))) (let ((|next#6| (M1.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |e#0@@3|))))))
(M1.UnionFind.Reaches ($LS ($LS $LZ)) this@@3 (- |d#0@@3| 1) |next#6| |r#0@@3| |C'#0|))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.M1.UnionFind) ($IsAlloc refType this@@3 Tclass.M1.UnionFind $Heap))) (<= (LitInt 0) |d#0@@3|)) (and ($Is refType |e#0@@3| Tclass.M1.Element) ($IsAlloc refType |e#0@@3| Tclass.M1.Element $Heap))) (and (and ($Is refType |r#0@@3| Tclass.M1.Element) ($IsAlloc refType |r#0@@3| Tclass.M1.Element $Heap)) (and ($Is MapType |C#0@@5| (TMap Tclass.M1.Element Tclass.M1.Contents)) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M1.Element Tclass.M1.Contents) $Heap)))) (and (and (and (and ($Is MapType |C'#0| (TMap Tclass.M1.Element Tclass.M1.Contents)) ($IsAlloc MapType |C'#0| (TMap Tclass.M1.Element Tclass.M1.Contents) $Heap)) (= 5 $FunctionContextHeight)) (and (|M1.__default.GoodCMap#canCall| |C#0@@5|) (and (M1.__default.GoodCMap |C#0@@5|) (forall ((|f#6| T@U) ) (!  (=> ($Is refType |f#6| Tclass.M1.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |f#6|)) (M1.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#6|))))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType (M1.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#6|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |1249|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#6|))))
))))) (and (and (and (|M1.__default.GoodCMap#canCall| |C'#0|) (and (M1.__default.GoodCMap |C'#0|) (forall ((|f#7| T@U) ) (!  (=> ($Is refType |f#7| Tclass.M1.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |f#7|)) (M1.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#7|))))) (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType (M1.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#7|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |1251|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#7|))))
)))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|))) (and (and (|M1.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|) (and (M1.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|) (ite (M1.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|)))) (= |e#0@@3| |r#0@@3|) (let ((|next#5@@0| (M1.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |e#0@@3|))))))
 (and (or (not (= |d#0@@3| 0)) (not true)) (M1.UnionFind.Reaches ($LS $LZ) this@@3 (- |d#0@@3| 1) |next#5@@0| |r#0@@3| |C#0@@5|)))))) (and (forall ((|f#2| T@U) ) (!  (=> ($Is refType |f#2| Tclass.M1.Element?) (and (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |f#2|)) (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |f#2|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |f#2|)) (|M1.Contents#Equal| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#2|))) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#2|)))))))
 :qid |UnionFinddfy.81:46|
 :skolemid |1252|
