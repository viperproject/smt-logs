...
(assert (forall (($ly@@0 T@U) (|z#0@@0| Int) (|l#0@@0| T@U) ) (! (= (_module.__default.aux ($LS $ly@@0) |z#0@@0| |l#0@@0|) (_module.__default.aux $ly@@0 |z#0@@0| |l#0@@0|))
 :qid |CoqArtInsertionSortdfy.98:10|
 :skolemid |620|
 :pattern ( (_module.__default.aux ($LS $ly@@0) |z#0@@0| |l#0@@0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@1 T@U) (|z#0@@1| Int) (|l#0@@1| T@U) ) (!  (=> (or (|_module.__default.aux#canCall| |z#0@@1| |l#0@@1|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |l#0@@1| (Tclass._module.List TInt)))) ($Is DatatypeTypeType (_module.__default.aux $ly@@1 |z#0@@1| |l#0@@1|) (Tclass._module.List TInt)))
 :qid |CoqArtInsertionSortdfy.98:10|
 :skolemid |622|
 :pattern ( (_module.__default.aux $ly@@1 |z#0@@1| |l#0@@1|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) (|z#0@@2| Int) (|l#0@@3| T@U) ) (!  (=> (or (|_module.__default.aux#canCall| |z#0@@2| |l#0@@3|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |l#0@@3| (Tclass._module.List TInt)))) (and (=> (not (_module.List.Nil_q |l#0@@3|)) (let ((|l'#1| (_module.List.tail |l#0@@3|)))
(let ((|a#1| (U_2_int ($Unbox intType (_module.List.head |l#0@@3|)))))
 (=> (< |a#1| |z#0@@2|) (|_module.__default.aux#canCall| |z#0@@2| |l'#1|))))) (= (_module.__default.aux ($LS $ly@@2) |z#0@@2| |l#0@@3|) (ite (_module.List.Nil_q |l#0@@3|) (|#_module.List.Cons| ($Box intType (int_2_U |z#0@@2|)) (Lit DatatypeTypeType |#_module.List.Nil|)) (let ((|l'#0| (_module.List.tail |l#0@@3|)))
(let ((|a#0| (U_2_int ($Unbox intType (_module.List.head |l#0@@3|)))))
(ite (<= |z#0@@2| |a#0|) (|#_module.List.Cons| ($Box intType (int_2_U |z#0@@2|)) |l#0@@3|) (|#_module.List.Cons| ($Box intType (int_2_U |a#0|)) (_module.__default.aux $ly@@2 |z#0@@2| |l'#0|)))))))))
 :qid |CoqArtInsertionSortdfy.98:10|
 :skolemid |624|
 :pattern ( (_module.__default.aux ($LS $ly@@2) |z#0@@2| |l#0@@3|))
))))
(push 1)
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.aux)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon13_Else_correct  (=> (< |a#Z#0@0| |z#0@@3|) (=> (and ($IsAlloc intType (int_2_U |z#0@@3|) TInt $Heap) ($IsAlloc DatatypeTypeType |l'#Z#0@0| (Tclass._module.List TInt) $Heap)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (<= 0 |z#0@@3|) (= |z#0@@3| |z#0@@3|))) (=> (or (<= 0 |z#0@@3|) (= |z#0@@3| |z#0@@3|)) (=> (= (ControlFlow 0 6) (- 0 5)) (or (< |z#0@@3| |z#0@@3|) (and (= |z#0@@3| |z#0@@3|) (< (DtRank |l'#Z#0@0|) (DtRank |l#0@@4|)))))))))))
(let ((anon13_Then_correct true))
(let ((anon12_Then_correct  (=> (and (and (and (= |l#0@@4| (|#_module.List.Cons| ($Box intType (int_2_U |_mcc#0#0|)) |_mcc#1#0|)) ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List TInt))) (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List TInt)))) (and (and (= |l'#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|)) (and ($Is intType (int_2_U |let#1#0#0|) TInt) (= |a#Z#0@0| |let#1#0#0|)))) (and (=> (= (ControlFlow 0 8) 4) anon13_Then_correct) (=> (= (ControlFlow 0 8) 6) anon13_Else_correct)))))
(let ((anon12_Else_correct true))
(let ((anon11_Else_correct  (=> (or (not (= |l#0@@4| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 9) 8) anon12_Then_correct) (=> (= (ControlFlow 0 9) 3) anon12_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |l#0@@4| (Tclass._module.List TInt))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct)))
