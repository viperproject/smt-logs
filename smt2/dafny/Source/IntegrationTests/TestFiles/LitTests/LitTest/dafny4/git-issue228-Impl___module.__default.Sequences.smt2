...
(declare-fun _module._default.Sequences$_T0 () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|Seq#Equal| (|Seq#Append| (|Seq#Append| |s#0| |t#0|) |u#0|) (|Seq#Append| |s#0| (|Seq#Append| |t#0| |u#0|))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SeqType |s#0| (TSeq _module._default.Sequences$_T0)) ($IsAlloc SeqType |s#0| (TSeq _module._default.Sequences$_T0) $Heap)) (and ($Is SeqType |t#0| (TSeq _module._default.Sequences$_T0)) ($IsAlloc SeqType |t#0| (TSeq _module._default.Sequences$_T0) $Heap))) (and (and ($Is SeqType |u#0| (TSeq _module._default.Sequences$_T0)) ($IsAlloc SeqType |u#0| (TSeq _module._default.Sequences$_T0) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct))))
