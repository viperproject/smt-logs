...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.GcdSubtract)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (< |x#0@@10| |y#0@@3|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@1 $Heap@0) ($IsAlloc intType (int_2_U |x#0@@10|) Tclass._module.pos $Heap@0))) (and (and ($IsAlloc intType (int_2_U |y#0@@3|) Tclass._module.pos $Heap@0) (|_module.__default.Gcd#canCall| |x#0@@10| |y#0@@3|)) (and ($IsAlloc intType (int_2_U |x#0@@10|) Tclass._module.pos $Heap@0) (= (ControlFlow 0 2) (- 0 1))))) ($Is intType (int_2_U (- |y#0@@3| |x#0@@10|)) Tclass._module.pos)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (<= (LitInt 1) |x#0@@10|) (<= (LitInt 1) |y#0@@3|)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
