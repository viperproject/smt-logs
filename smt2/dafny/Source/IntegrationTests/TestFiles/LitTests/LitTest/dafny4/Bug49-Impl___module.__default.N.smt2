...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (= |##m#0@0| (Lit MapType (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 5))) ($Box intType (int_2_U (LitInt 6)))))) ($IsAlloc MapType |##m#0@0| (TMap TInt TInt) $Heap)) (and (= |##a#0@0| (LitInt 5)) ($IsAlloc intType (int_2_U |##a#0@0|) TInt $Heap))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#IsMember| (|Map#Domain| |##m#0@0|) ($Box intType (int_2_U |##a#0@0|)))) (=> (|_module.__default.mapply#canCall| (Lit MapType (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 5))) ($Box intType (int_2_U (LitInt 6))))) (LitInt 5)) (=> (and (|_module.__default.mapply#canCall| (Lit MapType (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 5))) ($Box intType (int_2_U (LitInt 6))))) (LitInt 5)) (= (ControlFlow 0 2) (- 0 1))) (= (LitInt (_module.__default.mapply (Lit MapType (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 5))) ($Box intType (int_2_U (LitInt 6))))) (LitInt 5))) (LitInt 6)))))))))
