...
(declare-fun _module.__default.UnAckedMessages3 (T@U) T@U)
(declare-fun |_module.__default.UnAckedMessages3#canCall| (T@U) Bool)
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|s#0@@0| T@U) ) (!  (=> (or (|_module.__default.UnAckedMessages3#canCall| |s#0@@0|) (and (< 2 $FunctionContextHeight) ($Is MapType |s#0@@0| (TMap TInt (TSeq TInt))))) ($Is SetType (_module.__default.UnAckedMessages3 |s#0@@0|) (TSet TInt)))
 :qid |Bug91dfy.17:33|
 :skolemid |544|
 :pattern ( (_module.__default.UnAckedMessages3 |s#0@@0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|s#0@@1| T@U) ) (!  (=> (or (|_module.__default.UnAckedMessages3#canCall| (Lit MapType |s#0@@1|)) (and (< 2 $FunctionContextHeight) ($Is MapType |s#0@@1| (TMap TInt (TSeq TInt))))) (and (forall ((|dst#1| Int) (|m#1| T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |s#0@@1|) ($Box intType (int_2_U |dst#1|))) (|_module.__default.UnAckedMessagesForDst#canCall| (Lit MapType |s#0@@1|) |dst#1|))
 :qid |Bug91dfy.19:11|
 :skolemid |550|
 :pattern ( (|Set#IsMember| (_module.__default.UnAckedMessagesForDst |s#0@@1| |dst#1|) ($Box intType |m#1|)))
)) (= (_module.__default.UnAckedMessages3 (Lit MapType |s#0@@1|)) (|Set#FromBoogieMap| (|lambda#8| (|Map#Domain| |s#0@@1|) (Lit MapType |s#0@@1|) |s#0@@1|)))))
 :qid |Bug91dfy.17:33|
 :weight 3
 :skolemid |551|
 :pattern ( (_module.__default.UnAckedMessages3 (Lit MapType |s#0@@1|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|s#0@@2| T@U) (|dst#0@@0| Int) ) (!  (=> (or (|_module.__default.UnAckedMessagesForDst#canCall| |s#0@@2| |dst#0@@0|) (and (< 1 $FunctionContextHeight) (and ($Is MapType |s#0@@2| (TMap TInt (TSeq TInt))) (|Set#IsMember| (|Map#Domain| |s#0@@2|) ($Box intType (int_2_U |dst#0@@0|)))))) (= (_module.__default.UnAckedMessagesForDst |s#0@@2| |dst#0@@0|) (|Set#FromBoogieMap| (|lambda#4| ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| |s#0@@2|) ($Box intType (int_2_U |dst#0@@0|)))) ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| |s#0@@2|) ($Box intType (int_2_U |dst#0@@0|))))))))
 :qid |Bug91dfy.11:38|
 :skolemid |539|
 :pattern ( (_module.__default.UnAckedMessagesForDst |s#0@@2| |dst#0@@0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|s#0@@3| T@U) (|dst#0@@1| Int) ) (!  (=> (or (|_module.__default.UnAckedMessagesForDst#canCall| |s#0@@3| |dst#0@@1|) (and (< 1 $FunctionContextHeight) (and ($Is MapType |s#0@@3| (TMap TInt (TSeq TInt))) (|Set#IsMember| (|Map#Domain| |s#0@@3|) ($Box intType (int_2_U |dst#0@@1|)))))) ($Is SetType (_module.__default.UnAckedMessagesForDst |s#0@@3| |dst#0@@1|) (TSet TInt)))
 :qid |Bug91dfy.11:38|
 :skolemid |536|
 :pattern ( (_module.__default.UnAckedMessagesForDst |s#0@@3| |dst#0@@1|))
))))
...
(assert (forall ((|l#0@@1| T@U) (|l#1@@1| T@U) (|l#2@@0| T@U) (|$y#0@@0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#8| |l#0@@1| |l#1@@1| |l#2@@0|) |$y#0@@0|)) (exists ((|dst#0@@2| Int) (|m#0@@0| Int) ) (!  (and (and (|Set#IsMember| |l#0@@1| ($Box intType (int_2_U |dst#0@@2|))) (|Set#IsMember| (_module.__default.UnAckedMessagesForDst |l#1@@1| |dst#0@@2|) ($Box intType (int_2_U |m#0@@0|)))) (= |$y#0@@0| ($Box intType (int_2_U |m#0@@0|))))
 :qid |Bug91dfy.19:11|
 :skolemid |546|
 :pattern ( (|Set#IsMember| (_module.__default.UnAckedMessagesForDst |l#2@@0| |dst#0@@2|) ($Box intType (int_2_U |m#0@@0|))))
)))
 :qid |Bug91dfy.19:21|
 :skolemid |593|
 :pattern ( (MapType0Select BoxType boolType (|lambda#8| |l#0@@1| |l#1@@1| |l#2@@0|) |$y#0@@0|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|s#0@@4| T@U) ) (!  (=> (or (|_module.__default.UnAckedMessages3#canCall| |s#0@@4|) (and (< 2 $FunctionContextHeight) ($Is MapType |s#0@@4| (TMap TInt (TSeq TInt))))) (and (forall ((|dst#0@@3| Int) (|m#0@@1| T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |s#0@@4|) ($Box intType (int_2_U |dst#0@@3|))) (|_module.__default.UnAckedMessagesForDst#canCall| |s#0@@4| |dst#0@@3|))
 :qid |Bug91dfy.19:11|
 :skolemid |547|
 :pattern ( (|Set#IsMember| (_module.__default.UnAckedMessagesForDst |s#0@@4| |dst#0@@3|) ($Box intType |m#0@@1|)))
)) (= (_module.__default.UnAckedMessages3 |s#0@@4|) (|Set#FromBoogieMap| (|lambda#8| (|Map#Domain| |s#0@@4|) |s#0@@4| |s#0@@4|)))))
 :qid |Bug91dfy.17:33|
 :skolemid |548|
 :pattern ( (_module.__default.UnAckedMessages3 |s#0@@4|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.UnAckedMessages3)
...
(let ((anon13_Else_correct  (=> (and (not (and (|Set#IsMember| (|Map#Domain| |s#0@@5|) ($Box intType (int_2_U |dst#2@0|))) (|Set#IsMember| (_module.__default.UnAckedMessagesForDst |s#0@@5| |dst#2@0|) ($Box intType (int_2_U |m#2@0|))))) (= (ControlFlow 0 5) 3)) anon8_correct)))
(let ((anon13_Then_correct  (=> (and (and (|Set#IsMember| (|Map#Domain| |s#0@@5|) ($Box intType (int_2_U |dst#2@0|))) (|Set#IsMember| (_module.__default.UnAckedMessagesForDst |s#0@@5| |dst#2@0|) ($Box intType (int_2_U |m#2@0|)))) (= (ControlFlow 0 4) 3)) anon8_correct)))
(let ((anon12_Else_correct  (=> (not (|Set#IsMember| (|Map#Domain| |s#0@@5|) ($Box intType (int_2_U |dst#2@0|)))) (and (=> (= (ControlFlow 0 8) 4) anon13_Then_correct) (=> (= (ControlFlow 0 8) 5) anon13_Else_correct)))))
(let ((anon12_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |s#0@@5|) ($Box intType (int_2_U |dst#2@0|))) (=> (and ($IsAlloc MapType |s#0@@5| (TMap TInt (TSeq TInt)) $Heap) ($IsAlloc intType (int_2_U |dst#2@0|) TInt $Heap)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (|Set#IsMember| (|Map#Domain| |s#0@@5|) ($Box intType (int_2_U |dst#2@0|)))) (=> (and (|Set#IsMember| (|Map#Domain| |s#0@@5|) ($Box intType (int_2_U |dst#2@0|))) (|_module.__default.UnAckedMessagesForDst#canCall| |s#0@@5| |dst#2@0|)) (and (=> (= (ControlFlow 0 6) 4) anon13_Then_correct) (=> (= (ControlFlow 0 6) 5) anon13_Else_correct))))))))
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#2| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 10) 1) anon10_Then_correct) (=> (= (ControlFlow 0 10) 9) anon11_Then_correct)) (=> (= (ControlFlow 0 10) 2) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is MapType |s#0@@5| (TMap TInt (TSeq TInt)))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct)))
