...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly T@U) ($Heap@@0 T@U) (|f#0@@0| T@U) (|n#0| Int) ) (!  (=> (or (|_module.__default.Iter#canCall| (Lit HandleTypeType |f#0@@0|) (LitInt |n#0|)) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) ($Is HandleTypeType |f#0@@0| (Tclass._System.___hTotalFunc1 TInt TInt))))) (and (=> (< (LitInt 0) (LitInt |n#0|)) (|_module.__default.Iter#canCall| (Lit HandleTypeType |f#0@@0|) (LitInt (- |n#0| 1)))) (= (_module.__default.Iter ($LS $ly) (Lit HandleTypeType |f#0@@0|) (LitInt |n#0|)) (ite (<= (LitInt |n#0|) (LitInt 0)) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@0 (Lit HandleTypeType |f#0@@0|) ($Box intType (int_2_U (LitInt 1)))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@0 (Lit HandleTypeType |f#0@@0|) ($Box intType (int_2_U (LitInt (_module.__default.Iter ($LS $ly) (Lit HandleTypeType |f#0@@0|) (LitInt (- |n#0| 1)))))))))))))
 :qid |Ackermanndfy.59:16|
 :weight 3
 :skolemid |566|
 :pattern ( (_module.__default.Iter ($LS $ly) (Lit HandleTypeType |f#0@@0|) (LitInt |n#0|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall (($ly@@0 T@U) (|f#0@@3| T@U) (|n#0@@0| Int) ) (! (= (_module.__default.Iter ($LS $ly@@0) |f#0@@3| |n#0@@0|) (_module.__default.Iter $ly@@0 |f#0@@3| |n#0@@0|))
 :qid |Ackermanndfy.59:16|
 :skolemid |560|
 :pattern ( (_module.__default.Iter ($LS $ly@@0) |f#0@@3| |n#0@@0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@1 T@U) ($Heap@@1 T@U) (|f#0@@4| T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.__default.Iter#canCall| |f#0@@4| (LitInt |n#0@@1|)) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@1) ($Is HandleTypeType |f#0@@4| (Tclass._System.___hTotalFunc1 TInt TInt))))) (and (=> (< (LitInt 0) (LitInt |n#0@@1|)) (|_module.__default.Iter#canCall| |f#0@@4| (LitInt (- |n#0@@1| 1)))) (= (_module.__default.Iter ($LS $ly@@1) |f#0@@4| (LitInt |n#0@@1|)) (ite (<= (LitInt |n#0@@1|) (LitInt 0)) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@1 |f#0@@4| ($Box intType (int_2_U (LitInt 1)))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@1 |f#0@@4| ($Box intType (int_2_U (_module.__default.Iter ($LS $ly@@1) |f#0@@4| (LitInt (- |n#0@@1| 1))))))))))))
 :qid |Ackermanndfy.59:16|
 :weight 3
 :skolemid |565|
 :pattern ( (_module.__default.Iter ($LS $ly@@1) |f#0@@4| (LitInt |n#0@@1|)) ($IsGoodHeap $Heap@@1))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.IterExpanding)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@4 $Heap@0)) (and (forall ((|$ih#n0#0| Int) ) (!  (=> (and (_module.__default.Expanding |f#0@@9|) (and (<= 0 |$ih#n0#0|) (< |$ih#n0#0| |n#0@@4|))) (< |$ih#n0#0| (_module.__default.Iter ($LS $LZ) |f#0@@9| |$ih#n0#0|)))
 :qid |Ackermanndfy.144:36|
 :skolemid |619|
 :pattern ( (_module.__default.Iter ($LS $LZ) |f#0@@9| |$ih#n0#0|))
)) (= (ControlFlow 0 2) (- 0 1)))) (< |n#0@@4| (_module.__default.Iter ($LS ($LS $LZ)) |f#0@@9| |n#0@@4|))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (=> (and (and (and ($Is HandleTypeType |f#0@@9| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |f#0@@9| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap@@4)) (= 1 $FunctionContextHeight)) (and (and (|_module.__default.Expanding#canCall| |f#0@@9|) (and (_module.__default.Expanding |f#0@@9|) (forall ((|n#2| T@U) ) (! (< (U_2_int |n#2|) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@4 |f#0@@9| ($Box intType |n#2|)))))
 :qid |Ackermanndfy.119:10|
 :skolemid |618|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@4 |f#0@@9| ($Box intType |n#2|))))
