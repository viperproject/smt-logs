...
(assert (distinct alloc Tagclass._System.nat Tagclass._System.___hFunc0 Tagclass._System.___hPartialFunc0 Tagclass._System.___hTotalFunc0 Tagclass._System.Tuple0 tytagFamily$nat |tytagFamily$_#Func0| |tytagFamily$_#PartialFunc0| |tytagFamily$_#TotalFunc0| |tytagFamily$_tuple#0|)
)
...
(assert (forall (($ly T@U) (|f#0@@1| T@U) (|n#0| Int) ) (! (= (_module.__default.Foo ($LS $ly) |f#0@@1| |n#0|) (_module.__default.Foo $ly |f#0@@1| |n#0|))
 :qid |gitissue148dfy.4:16|
 :skolemid |528|
 :pattern ( (_module.__default.Foo ($LS $ly) |f#0@@1| |n#0|))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@0 T@U) (|f#0@@2| T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.__default.Foo#canCall| (Lit HandleTypeType |f#0@@2|) (LitInt |n#0@@0|)) (and (< 0 $FunctionContextHeight) (and ($Is HandleTypeType |f#0@@2| (Tclass._System.___hTotalFunc0 Tclass._System.Tuple0)) (<= (LitInt 0) |n#0@@0|)))) (and (=> (or (not (= (LitInt |n#0@@0|) (LitInt 0))) (not true)) (|_module.__default.Foo#canCall| (Lit HandleTypeType |f#0@@2|) (LitInt (- |n#0@@0| 1)))) (= (_module.__default.Foo ($LS $ly@@0) (Lit HandleTypeType |f#0@@2|) (LitInt |n#0@@0|)) (ite (= (LitInt |n#0@@0|) (LitInt 0)) |n#0@@0| (_module.__default.Foo ($LS $ly@@0) (Lit HandleTypeType |f#0@@2|) (LitInt (- |n#0@@0| 1)))))))
 :qid |gitissue148dfy.4:16|
 :weight 3
 :skolemid |534|
 :pattern ( (_module.__default.Foo ($LS $ly@@0) (Lit HandleTypeType |f#0@@2|) (LitInt |n#0@@0|)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@1 T@U) (|f#0@@3| T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.__default.Foo#canCall| |f#0@@3| |n#0@@1|) (and (< 0 $FunctionContextHeight) (and ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc0 Tclass._System.Tuple0)) (<= (LitInt 0) |n#0@@1|)))) (<= (LitInt 0) (_module.__default.Foo $ly@@1 |f#0@@3| |n#0@@1|)))
 :qid |gitissue148dfy.4:16|
 :skolemid |530|
 :pattern ( (_module.__default.Foo $ly@@1 |f#0@@3| |n#0@@1|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@2 T@U) (|f#0@@4| T@U) (|n#0@@2| Int) ) (!  (=> (or (|_module.__default.Foo#canCall| |f#0@@4| |n#0@@2|) (and (< 0 $FunctionContextHeight) (and ($Is HandleTypeType |f#0@@4| (Tclass._System.___hTotalFunc0 Tclass._System.Tuple0)) (<= (LitInt 0) |n#0@@2|)))) (and (=> (or (not (= |n#0@@2| (LitInt 0))) (not true)) (|_module.__default.Foo#canCall| |f#0@@4| (- |n#0@@2| 1))) (= (_module.__default.Foo ($LS $ly@@2) |f#0@@4| |n#0@@2|) (ite (= |n#0@@2| (LitInt 0)) |n#0@@2| (_module.__default.Foo $ly@@2 |f#0@@4| (- |n#0@@2| 1))))))
 :qid |gitissue148dfy.4:16|
 :skolemid |532|
 :pattern ( (_module.__default.Foo ($LS $ly@@2) |f#0@@4| |n#0@@2|))
))))
...
(assert (forall ((|#$R@@7| T@U) (|f#0@@5| T@U) ) (! (= ($Is HandleTypeType |f#0@@5| (Tclass._System.___hTotalFunc0 |#$R@@7|))  (and ($Is HandleTypeType |f#0@@5| (Tclass._System.___hPartialFunc0 |#$R@@7|)) (Requires0 |#$R@@7| $OneHeap |f#0@@5|)))
 :qid |unknown.0:0|
 :skolemid |446|
 :pattern ( ($Is HandleTypeType |f#0@@5| (Tclass._System.___hTotalFunc0 |#$R@@7|)))
)))
...
(assert (forall ((d T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) ($Is DatatypeTypeType d Tclass._System.Tuple0)) ($IsAlloc DatatypeTypeType d Tclass._System.Tuple0 $h@@2))
 :qid |unknown.0:0|
 :skolemid |474|
 :pattern ( ($IsAlloc DatatypeTypeType d Tclass._System.Tuple0 $h@@2))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@3 T@U) (|f#0@@6| T@U) (|n#0@@3| Int) ) (!  (=> (or (|_module.__default.Foo#canCall| |f#0@@6| (LitInt |n#0@@3|)) (and (< 0 $FunctionContextHeight) (and ($Is HandleTypeType |f#0@@6| (Tclass._System.___hTotalFunc0 Tclass._System.Tuple0)) (<= (LitInt 0) |n#0@@3|)))) (and (=> (or (not (= (LitInt |n#0@@3|) (LitInt 0))) (not true)) (|_module.__default.Foo#canCall| |f#0@@6| (LitInt (- |n#0@@3| 1)))) (= (_module.__default.Foo ($LS $ly@@3) |f#0@@6| (LitInt |n#0@@3|)) (ite (= (LitInt |n#0@@3|) (LitInt 0)) |n#0@@3| (_module.__default.Foo ($LS $ly@@3) |f#0@@6| (LitInt (- |n#0@@3| 1)))))))
 :qid |gitissue148dfy.4:16|
 :weight 3
 :skolemid |533|
 :pattern ( (_module.__default.Foo ($LS $ly@@3) |f#0@@6| (LitInt |n#0@@3|)))
))))
(assert (forall ((|#$R@@11| T@U) (|f#0@@7| T@U) ) (! (= ($Is HandleTypeType |f#0@@7| (Tclass._System.___hPartialFunc0 |#$R@@11|))  (and ($Is HandleTypeType |f#0@@7| (Tclass._System.___hFunc0 |#$R@@11|)) (|Set#Equal| (Reads0 |#$R@@11| $OneHeap |f#0@@7|) |Set#Empty|)))
 :qid |unknown.0:0|
 :skolemid |441|
 :pattern ( ($Is HandleTypeType |f#0@@7| (Tclass._System.___hPartialFunc0 |#$R@@11|)))
)))
(push 1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon8_Else_correct  (=> (and (or (not (= |n#0@@4| (LitInt 0))) (not true)) ($IsAlloc HandleTypeType |f#0@@8| (Tclass._System.___hTotalFunc0 Tclass._System.Tuple0) $Heap)) (and (=> (= (ControlFlow 0 4) (- 0 6)) ($Is intType (int_2_U (- |n#0@@4| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0@@4| 1)) Tclass._System.nat) (=> (and (= |##n#0@0| (- |n#0@@4| 1)) ($IsAlloc intType (int_2_U |##n#0@0|) Tclass._System.nat $Heap)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (<= 0 |n#0@@4|) (= |##n#0@0| |n#0@@4|))) (=> (or (<= 0 |n#0@@4|) (= |##n#0@0| |n#0@@4|)) (=> (= (ControlFlow 0 4) (- 0 3)) (< |##n#0@0| |n#0@@4|))))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is HandleTypeType |f#0@@8| (Tclass._System.___hTotalFunc0 Tclass._System.Tuple0)) (<= (LitInt 0) |n#0@@4|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
