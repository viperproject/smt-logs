...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@4 T@U) (|m#0@@3| Int) ) (!  (=> (or (|_module.__default.A#canCall| (LitInt |m#0@@3|)) (< 1 $FunctionContextHeight)) (and (=> (< (LitInt 0) (LitInt |m#0@@3|)) (forall ((|$l#7#n#0| Int) )  (and (|_module.__default.A#canCall| (LitInt (- |m#0@@3| 1))) (|_module.__default.Iter#canCall| (Lit HandleTypeType (_module.__default.A ($LS $ly@@4) (LitInt (- |m#0@@3| 1)))) |$l#7#n#0|)))) (= (_module.__default.A ($LS $ly@@4) (LitInt |m#0@@3|)) (ite (<= (LitInt |m#0@@3|) (LitInt 0)) (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#4| 1) (|lambda#5| TInt) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $ly@@4)) (AtLayer HandleTypeType (|lambda#23| (LitInt (- |m#0@@3| 1)) (|lambda#5| TInt) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false)))) ($LS $ly@@4))))))
 :weight 3
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@9 T@U) (|m#0@@7| Int) ) (!  (=> (or (|_module.__default.A#canCall| |m#0@@7|) (< 1 $FunctionContextHeight)) (and (=> (< (LitInt 0) |m#0@@7|) (forall ((|$l#3#n#0| Int) )  (and (|_module.__default.A#canCall| (- |m#0@@7| 1)) (|_module.__default.Iter#canCall| (_module.__default.A $ly@@9 (- |m#0@@7| 1)) |$l#3#n#0|)))) (= (_module.__default.A ($LS $ly@@9) |m#0@@7|) (ite (<= |m#0@@7| (LitInt 0)) (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#4| 1) (|lambda#5| TInt) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) $ly@@9) (AtLayer HandleTypeType (|lambda#13| (- |m#0@@7| 1) (|lambda#5| TInt) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false)))) $ly@@9)))))
