...
(declare-fun _module._default.Bind$T@@5 () T@U)
(declare-fun |let#0#0#0| () T@U)
(declare-fun |xs'#Z#0@0| () T@U)
(declare-fun |let#1#0#0| () T@U)
(declare-fun |x#Z#0@0| () T@U)
(declare-fun |##xs#0@0| () T@U)
(declare-fun _module._default.Bind$U@@5 () T@U)
(declare-fun $Heap@@4 () T@U)
(declare-fun |f#0@@9| () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Bind)
...
(let ((anon10_Then_correct  (=> (and (= |xs#0@@10| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) ($IsBox |_mcc#0#0| _module._default.Bind$T@@5)) (=> (and (and ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List _module._default.Bind$T@@5)) (= |let#0#0#0| |_mcc#1#0|)) (and ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List _module._default.Bind$T@@5)) (= |xs'#Z#0@0| |let#0#0#0|))) (=> (and (and (and (= |let#1#0#0| |_mcc#0#0|) ($IsBox |let#1#0#0| _module._default.Bind$T@@5)) (and (= |x#Z#0@0| |let#1#0#0|) (= |##xs#0@0| ($Unbox DatatypeTypeType (Apply1 _module._default.Bind$T@@5 (Tclass._module.List _module._default.Bind$U@@5) $Heap@@4 |f#0@@9| |x#Z#0@0|))))) (and (and ($IsAlloc DatatypeTypeType |##xs#0@0| (Tclass._module.List _module._default.Bind$U@@5) $Heap@@4) ($IsAlloc DatatypeTypeType |xs'#Z#0@0| (Tclass._module.List _module._default.Bind$T@@5) $Heap@@4)) (and ($IsAlloc HandleTypeType |f#0@@9| (Tclass._System.___hTotalFunc1 _module._default.Bind$T@@5 (Tclass._module.List _module._default.Bind$U@@5)) $Heap@@4) (= (ControlFlow 0 4) (- 0 3))))) (< (DtRank |xs'#Z#0@0|) (DtRank |xs#0@@10|)))))))
(let ((anon9_Else_correct  (=> (or (not (= |xs#0@@10| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 6) 4) anon10_Then_correct) (=> (= (ControlFlow 0 6) 5) anon10_Else_correct)))))
(let ((anon9_Then_correct true))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (and (and (=> (= (ControlFlow 0 7) 1) anon8_Then_correct) (=> (= (ControlFlow 0 7) 2) anon9_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (=> (and (and ($Is DatatypeTypeType |xs#0@@10| (Tclass._module.List _module._default.Bind$T@@5)) ($Is HandleTypeType |f#0@@9| (Tclass._System.___hTotalFunc1 _module._default.Bind$T@@5 (Tclass._module.List _module._default.Bind$U@@5)))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
