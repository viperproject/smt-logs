...
(declare-fun $Heap@@1 () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.sorted__reverse)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (=> (|_module.__default.sorted#canCall| |ys#0@@2|) (or (_module.__default.sorted ($LS $LZ) |ys#0@@2|) (=> (_module.List.Nil_q |ys#0@@2|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (|_module.__default.sorted#canCall| |ys#0@@2|) (or (_module.__default.sorted ($LS $LZ) |ys#0@@2|) (=> (_module.List.Nil_q |ys#0@@2|) (U_2_bool (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (=> (|_module.__default.sorted#canCall| |ys#0@@2|) (or (_module.__default.sorted ($LS $LZ) |ys#0@@2|) (=> (not (_module.List.Nil_q |ys#0@@2|)) (let ((|ys#7| (_module.List.tail |ys#0@@2|)))
(let ((|a#8| (_module.List.head |ys#0@@2|)))
(forall ((|y#6| T@U) ) (!  (=> ($IsBox |y#6| Tclass._module.G) (=> (> (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |ys#7|) |y#6|) 0) (_module.__default.Below |a#8| |y#6|)))
 :qid |GHCMergeSortdfy.156:13|
 :skolemid |889|
 :pattern ( (_module.__default.Below |a#8| |y#6|))
 :pattern ( (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |ys#7|) |y#6|))
)))))))) (=> (=> (|_module.__default.sorted#canCall| |ys#0@@2|) (or (_module.__default.sorted ($LS $LZ) |ys#0@@2|) (=> (not (_module.List.Nil_q |ys#0@@2|)) (let ((|ys#7@@0| (_module.List.tail |ys#0@@2|)))
(let ((|a#8@@0| (_module.List.head |ys#0@@2|)))
(forall ((|y#6@@0| T@U) ) (!  (=> ($IsBox |y#6@@0| Tclass._module.G) (=> (> (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |ys#7@@0|) |y#6@@0|) 0) (_module.__default.Below |a#8@@0| |y#6@@0|)))
 :qid |GHCMergeSortdfy.156:13|
 :skolemid |889|
 :pattern ( (_module.__default.Below |a#8@@0| |y#6@@0|))
 :pattern ( (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |ys#7@@0|) |y#6@@0|))
))))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> (|_module.__default.sorted#canCall| |ys#0@@2|) (or (_module.__default.sorted ($LS $LZ) |ys#0@@2|) (=> (not (_module.List.Nil_q |ys#0@@2|)) (let ((|ys#7@@1| (_module.List.tail |ys#0@@2|)))
(_module.__default.sorted ($LS ($LS $LZ)) |ys#7@@1|)))))) (=> (=> (|_module.__default.sorted#canCall| |ys#0@@2|) (or (_module.__default.sorted ($LS $LZ) |ys#0@@2|) (=> (not (_module.List.Nil_q |ys#0@@2|)) (let ((|ys#7@@2| (_module.List.tail |ys#0@@2|)))
(_module.__default.sorted ($LS ($LS $LZ)) |ys#7@@2|))))) (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((|a#1@@1| T@U) (|b#1| T@U) ) (!  (=> (and ($IsBox |a#1@@1| Tclass._module.G) ($IsBox |b#1| Tclass._module.G)) (=> (and (> (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |xs#0@@12|) |a#1@@1|) 0) (> (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |ys#0@@2|) |b#1|) 0)) (_module.__default.Below |a#1@@1| |b#1|)))
 :qid |GHCMergeSortdfy.381:18|
 :skolemid |893|
 :pattern ( (_module.__default.Below |a#1@@1| |b#1|))
 :pattern ( (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |ys#0@@2|) |b#1|) (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |xs#0@@12|) |a#1@@1|))
)))))))))))
(let ((anon5_Then_correct  (=> (= |xs#0@@12| (|#_module.List.Cons| |_mcc#0#0_0@0| |_mcc#1#0_0@0|)) (=> (and ($IsBox |_mcc#0#0_0@0| Tclass._module.G) ($Is DatatypeTypeType |_mcc#1#0_0@0| (Tclass._module.List Tclass._module.G))) (=> (and (and ($Is DatatypeTypeType |rest#0_0@0| (Tclass._module.List Tclass._module.G)) ($IsAlloc DatatypeTypeType |rest#0_0@0| (Tclass._module.List Tclass._module.G) $Heap@0)) (= |let#0_0#0#0| |_mcc#1#0_0@0|)) (=> (and (and (and ($Is DatatypeTypeType |let#0_0#0#0| (Tclass._module.List Tclass._module.G)) (= |rest#0_0@0| |let#0_0#0#0|)) (and ($IsBox |x#0_0@0| Tclass._module.G) ($IsAllocBox |x#0_0@0| Tclass._module.G $Heap@0))) (and (and (= |let#0_1#0#0| |_mcc#0#0_0@0|) ($IsBox |let#0_1#0#0| Tclass._module.G)) (and (= |x#0_0@0| |let#0_1#0#0|) (= |ys##0_0@0| (|#_module.List.Cons| |x#0_0@0| |ys#0@@2|))))) (and (=> (= (ControlFlow 0 8) (- 0 12)) (or (< (DtRank |rest#0_0@0|) (DtRank |xs#0@@12|)) (and (= (DtRank |rest#0_0@0|) (DtRank |xs#0@@12|)) (< (DtRank |ys##0_0@0|) (DtRank |ys#0@@2|))))) (=> (or (< (DtRank |rest#0_0@0|) (DtRank |xs#0@@12|)) (and (= (DtRank |rest#0_0@0|) (DtRank |xs#0@@12|)) (< (DtRank |ys##0_0@0|) (DtRank |ys#0@@2|)))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (=> (|_module.__default.sorted#canCall| (_module.__default.reverse Tclass._module.G ($LS $LZ) |rest#0_0@0| |ys##0_0@0|)) (or (_module.__default.sorted ($LS $LZ) (_module.__default.reverse Tclass._module.G ($LS $LZ) |rest#0_0@0| |ys##0_0@0|)) (=> (_module.List.Nil_q (_module.__default.reverse Tclass._module.G ($LS $LZ) |rest#0_0@0| |ys##0_0@0|)) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (|_module.__default.sorted#canCall| (_module.__default.reverse Tclass._module.G ($LS $LZ) |rest#0_0@0| |ys##0_0@0|)) (or (_module.__default.sorted ($LS $LZ) (_module.__default.reverse Tclass._module.G ($LS $LZ) |rest#0_0@0| |ys##0_0@0|)) (=> (_module.List.Nil_q (_module.__default.reverse Tclass._module.G ($LS $LZ) |rest#0_0@0| |ys##0_0@0|)) (U_2_bool (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (=> (|_module.__default.sorted#canCall| (_module.__default.reverse Tclass._module.G ($LS $LZ) |rest#0_0@0| |ys##0_0@0|)) (or (_module.__default.sorted ($LS $LZ) (_module.__default.reverse Tclass._module.G ($LS $LZ) |rest#0_0@0| |ys##0_0@0|)) (=> (not (_module.List.Nil_q (_module.__default.reverse Tclass._module.G ($LS $LZ) |rest#0_0@0| |ys##0_0@0|))) (let ((|ys#1@@2| (_module.List.tail (_module.__default.reverse Tclass._module.G ($LS ($LS $LZ)) |rest#0_0@0| |ys##0_0@0|))))
(let ((|a#2@@2| (_module.List.head (_module.__default.reverse Tclass._module.G ($LS ($LS $LZ)) |rest#0_0@0| |ys##0_0@0|))))
...
)))))))) (=> (=> (|_module.__default.sorted#canCall| (_module.__default.reverse Tclass._module.G ($LS $LZ) |rest#0_0@0| |ys##0_0@0|)) (or (_module.__default.sorted ($LS $LZ) (_module.__default.reverse Tclass._module.G ($LS $LZ) |rest#0_0@0| |ys##0_0@0|)) (=> (not (_module.List.Nil_q (_module.__default.reverse Tclass._module.G ($LS $LZ) |rest#0_0@0| |ys##0_0@0|))) (let ((|ys#1@@3| (_module.List.tail (_module.__default.reverse Tclass._module.G ($LS ($LS $LZ)) |rest#0_0@0| |ys##0_0@0|))))
(let ((|a#2@@3| (_module.List.head (_module.__default.reverse Tclass._module.G ($LS ($LS $LZ)) |rest#0_0@0| |ys##0_0@0|))))
...
))))))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (=> (|_module.__default.sorted#canCall| (_module.__default.reverse Tclass._module.G ($LS $LZ) |rest#0_0@0| |ys##0_0@0|)) (or (_module.__default.sorted ($LS $LZ) (_module.__default.reverse Tclass._module.G ($LS $LZ) |rest#0_0@0| |ys##0_0@0|)) (=> (not (_module.List.Nil_q (_module.__default.reverse Tclass._module.G ($LS $LZ) |rest#0_0@0| |ys##0_0@0|))) (let ((|ys#1@@4| (_module.List.tail (_module.__default.reverse Tclass._module.G ($LS ($LS $LZ)) |rest#0_0@0| |ys##0_0@0|))))
(_module.__default.sorted ($LS ($LS $LZ)) |ys#1@@4|)))))) (=> (=> (|_module.__default.sorted#canCall| (_module.__default.reverse Tclass._module.G ($LS $LZ) |rest#0_0@0| |ys##0_0@0|)) (or (_module.__default.sorted ($LS $LZ) (_module.__default.reverse Tclass._module.G ($LS $LZ) |rest#0_0@0| |ys##0_0@0|)) (=> (not (_module.List.Nil_q (_module.__default.reverse Tclass._module.G ($LS $LZ) |rest#0_0@0| |ys##0_0@0|))) (let ((|ys#1@@5| (_module.List.tail (_module.__default.reverse Tclass._module.G ($LS ($LS $LZ)) |rest#0_0@0| |ys##0_0@0|))))
(_module.__default.sorted ($LS ($LS $LZ)) |ys#1@@5|))))) (=> (and (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (|_module.__default.sorted#canCall| |ys##0_0@0|)) (and (|_module.__default.sorted#canCall| |ys##0_0@0|) (and (_module.__default.sorted ($LS $LZ) |ys##0_0@0|) (ite (_module.List.Nil_q |ys##0_0@0|) true (let ((|ys#4| (_module.List.tail |ys##0_0@0|)))
(let ((|a#5| (_module.List.head |ys##0_0@0|)))
...
)) (_module.__default.sorted ($LS $LZ) |ys#4|)))))))) (and (and (forall ((|a#1@@2| T@U) (|b#1@@0| T@U) ) (!  (=> (and ($IsBox |a#1@@2| Tclass._module.G) ($IsBox |b#1@@0| Tclass._module.G)) (and (|_module.__default.multiset__of#canCall| Tclass._module.G |rest#0_0@0|) (=> (> (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |rest#0_0@0|) |a#1@@2|) 0) (and (|_module.__default.multiset__of#canCall| Tclass._module.G |ys##0_0@0|) (=> (> (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |ys##0_0@0|) |b#1@@0|) 0) (|_module.__default.Below#canCall| |a#1@@2| |b#1@@0|))))))
 :qid |GHCMergeSortdfy.381:18|
 :skolemid |883|
 :pattern ( (_module.__default.Below |a#1@@2| |b#1@@0|))
 :pattern ( (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |ys##0_0@0|) |b#1@@0|) (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |rest#0_0@0|) |a#1@@2|))
)) (forall ((|a#1@@3| T@U) (|b#1@@1| T@U) ) (!  (=> (and ($IsBox |a#1@@3| Tclass._module.G) ($IsBox |b#1@@1| Tclass._module.G)) (=> (and (> (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |rest#0_0@0|) |a#1@@3|) 0) (> (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |ys##0_0@0|) |b#1@@1|) 0)) (_module.__default.Below |a#1@@3| |b#1@@1|)))
 :qid |GHCMergeSortdfy.381:18|
 :skolemid |885|
 :pattern ( (_module.__default.Below |a#1@@3| |b#1@@1|))
 :pattern ( (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |ys##0_0@0|) |b#1@@1|) (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |rest#0_0@0|) |a#1@@3|))
))) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 8) 3)))) GeneratedUnifiedExit_correct)))))))))))))))
(let ((anon4_Then_correct  (=> (and (= |xs#0@@12| |#_module.List.Nil|) (= (ControlFlow 0 7) 3)) GeneratedUnifiedExit_correct)))
(let ((anon5_Else_correct true))
(let ((anon4_Else_correct  (=> (or (not (= |xs#0@@12| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 13) 8) anon5_Then_correct) (=> (= (ControlFlow 0 13) 1) anon5_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (|$IsA#_module.List| |xs#0@@12|) (|$IsA#_module.List| |ys#0@@2|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@1 $Heap@0) (forall ((|$ih#xs0#0| T@U) (|$ih#ys0#0| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |$ih#xs0#0| (Tclass._module.List Tclass._module.G)) ($Is DatatypeTypeType |$ih#ys0#0| (Tclass._module.List Tclass._module.G))) (_module.__default.sorted ($LS $LZ) (_module.__default.reverse Tclass._module.G ($LS $LZ) |$ih#xs0#0| |$ih#ys0#0|))) (or (< (DtRank |$ih#xs0#0|) (DtRank |xs#0@@12|)) (and (= (DtRank |$ih#xs0#0|) (DtRank |xs#0@@12|)) (< (DtRank |$ih#ys0#0|) (DtRank |ys#0@@2|))))) (and (_module.__default.sorted ($LS $LZ) |$ih#ys0#0|) (forall ((|a#10| T@U) (|b#2| T@U) ) (!  (=> (and ($IsBox |a#10| Tclass._module.G) ($IsBox |b#2| Tclass._module.G)) (=> (and (> (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |$ih#xs0#0|) |a#10|) 0) (> (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |$ih#ys0#0|) |b#2|) 0)) (_module.__default.Below |a#10| |b#2|)))
 :qid |GHCMergeSortdfy.381:18|
 :skolemid |895|
 :pattern ( (_module.__default.Below |a#10| |b#2|))
 :pattern ( (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |$ih#ys0#0|) |b#2|) (|MultiSet#Multiplicity| (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |$ih#xs0#0|) |a#10|))
))))
 :qid |GHCMergeSortdfy.378:22|
 :skolemid |896|
 :pattern ( (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |$ih#xs0#0|) (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |$ih#ys0#0|))
 :pattern ( (_module.__default.reverse Tclass._module.G ($LS $LZ) |$ih#xs0#0| |$ih#ys0#0|))
)))) (and (=> (= (ControlFlow 0 14) 7) anon4_Then_correct) (=> (= (ControlFlow 0 14) 13) anon4_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and ($Is DatatypeTypeType |xs#0@@12| (Tclass._module.List Tclass._module.G)) ($IsAlloc DatatypeTypeType |xs#0@@12| (Tclass._module.List Tclass._module.G) $Heap@@1)) (|$IsA#_module.List| |xs#0@@12|)) (=> (and (and (and (and ($Is DatatypeTypeType |ys#0@@2| (Tclass._module.List Tclass._module.G)) ($IsAlloc DatatypeTypeType |ys#0@@2| (Tclass._module.List Tclass._module.G) $Heap@@1)) (|$IsA#_module.List| |ys#0@@2|)) (= 3 $FunctionContextHeight)) (and (and (|_module.__default.sorted#canCall| (_module.__default.reverse Tclass._module.G ($LS $LZ) |xs#0@@12| |ys#0@@2|)) (and (_module.__default.sorted ($LS $LZ) (_module.__default.reverse Tclass._module.G ($LS $LZ) |xs#0@@12| |ys#0@@2|)) (ite (_module.List.Nil_q (_module.__default.reverse Tclass._module.G ($LS $LZ) |xs#0@@12| |ys#0@@2|)) true (let ((|ys#6| (_module.List.tail (_module.__default.reverse Tclass._module.G ($LS $LZ) |xs#0@@12| |ys#0@@2|))))
(let ((|a#7| (_module.List.head (_module.__default.reverse Tclass._module.G ($LS $LZ) |xs#0@@12| |ys#0@@2|))))
...
)) (_module.__default.sorted ($LS $LZ) |ys#6|))))))) (= (ControlFlow 0 15) 14))) anon0_correct)))))
