...
(assert (forall ((a@@2 T@U) (b@@2 T@U) (t0@@0 T@U) (t1@@0 T@U) ) (!  (=> (forall ((bx T@U) ) (!  (=> (|Set#IsMember| a@@2 bx) (and ($IsBox bx t0@@0) ($IsBox (MapType0Select BoxType BoxType b@@2 bx) t1@@0)))
 :qid |DafnyPreludebpl.1452:11|
 :skolemid |288|
)) ($Is MapType (|Map#Glue| a@@2 b@@2 (TMap t0@@0 t1@@0)) (TMap t0@@0 t1@@0)))
...
(set-info :boogie-vc-id CheckWellformed$$Test.__default.ConvertMap__AB)
