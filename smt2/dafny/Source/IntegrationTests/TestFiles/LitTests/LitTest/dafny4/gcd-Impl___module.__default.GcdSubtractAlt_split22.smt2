...
(set-info :boogie-vc-id Impl$$_module.__default.GcdSubtractAlt_split22)
...
(assert (not
 ...
 :qid |gcddfy.228:9|
 :skolemid |662|
)))) (<= (LitInt 1) |b#0_0@0|)) (=> (and (and (= (Mul |p#0@0| |b#0_0@0|) |y#0@@3|) (= (- |y#0@@3| |x#0@@10|) (Mul |p#0@0| (- |b#0_0@0| |a#0_0@0|)))) (and ($IsAlloc intType (int_2_U |p#0@0|) Tclass._module.pos $Heap@1) (= (ControlFlow 0 2) (- 0 1)))) ($Is intType (int_2_U (- |y#0@@3| |x#0@@10|)) Tclass._module.pos)))))
