...
(set-info :boogie-vc-id Impl$$_module.__default.LeastSignificantDigitIsAlmostMod__Pos)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 30) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 22) (- 0 21)) (= (Mod (_module.__default.eval ($LS ($LS $LZ)) |a#0| |base#0@@5|) |base#0@@5|) (U_2_int ($Unbox intType (|Seq#Index| |a#0| (LitInt 0))))))))
(let ((anon9_Else_correct  (=> (and (= (Mod |n#0@0| |base#0@@5|) (U_2_int ($Unbox intType (|Seq#Index| |a#0| (LitInt 0))))) (= (ControlFlow 0 23) 22)) GeneratedUnifiedExit_correct)))
(let ((anon9_Then_correct  (=> (and (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |a#0|))) (or (not (= |base#0@@5| 0)) (not true))) (and (=> (= (ControlFlow 0 14) (- 0 20)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |a#0|)))) (and (=> (= (ControlFlow 0 14) (- 0 19)) (|Seq#Contains| |a#0| (|Seq#Index| |a#0| (LitInt 0)))) (=> (|Seq#Contains| |a#0| (|Seq#Index| |a#0| (LitInt 0))) (and (=> (= (ControlFlow 0 14) (- 0 18)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |a#0|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |a#0|))) (=> (= |a##0_0_0@0| (U_2_int ($Unbox intType (|Seq#Index| |a#0| (LitInt 0))))) (and (=> (= (ControlFlow 0 14) (- 0 17)) (<= (LitInt 0) |a##0_0_0@0|)) (=> (<= (LitInt 0) |a##0_0_0@0|) (and (=> (= (ControlFlow 0 14) (- 0 16)) (< |a##0_0_0@0| |base#0@@5|)) (=> (< |a##0_0_0@0| |base#0@@5|) (=> (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (and (= (Mod |a##0_0_0@0| |base#0@@5|) |a##0_0_0@0|) (= $Heap@0 $Heap@2))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |a#0|)))) (=> (= (ControlFlow 0 14) (- 0 13)) (= (Mod (U_2_int ($Unbox intType (|Seq#Index| |a#0| (LitInt 0)))) |base#0@@5|) (U_2_int ($Unbox intType (|Seq#Index| |a#0| (LitInt 0)))))))))))))))))))))
(let ((anon8_Then_correct  (=> (and (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |a#0|))) (or (not (= |base#0@@5| 0)) (not true))) (and (=> (= (ControlFlow 0 8) (- 0 12)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |a#0|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |a#0|))) (=> (= |n##0_1_0@0| (U_2_int ($Unbox intType (|Seq#Index| |a#0| (LitInt 0))))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (<= (LitInt 2) |base#0@@5|)) (=> (<= (LitInt 2) |base#0@@5|) (=> (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (= (Mod (+ |n##0_1_0@0| (Mul |base#0@@5| |a1#0@0|)) |base#0@@5|) (Mod |n##0_1_0@0| |base#0@@5|)) (= $Heap@0 $Heap@1))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |a#0|)))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (not (= |base#0@@5| 0)) (not true))) (=> (= (ControlFlow 0 8) (- 0 7)) (= (Mod (+ (U_2_int ($Unbox intType (|Seq#Index| |a#0| (LitInt 0)))) (Mul |base#0@@5| |a1#0@0|)) |base#0@@5|) (Mod (U_2_int ($Unbox intType (|Seq#Index| |a#0| (LitInt 0)))) |base#0@@5|))))))))))))))
(let ((anon7_Then_correct  (=> (or (not (= |base#0@@5| 0)) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |a#0|)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (not (= |base#0@@5| 0)) (not true))) (=> (= (ControlFlow 0 4) (- 0 3)) (= (Mod |n#0@0| |base#0@@5|) (Mod (+ (U_2_int ($Unbox intType (|Seq#Index| |a#0| (LitInt 0)))) (Mul |base#0@@5| |a1#0@0|)) |base#0@@5|))))))))
(let ((anon6_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= |base#0@@5| 0)) (not true)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (= $Heap $Heap@0) (forall ((|$ih#a0#0| T@U) (|$ih#base0#0| Int) ) (!  (=> (and (and ($Is SeqType |$ih#a0#0| (TSeq TInt)) (and (_module.__default.IsSkewNumber |$ih#a0#0| |lowDigit#0@@1| |$ih#base0#0|) (and (not (|Seq#Equal| |$ih#a0#0| |Seq#Empty|)) (<= (LitInt 0) (U_2_int ($Unbox intType (|Seq#Index| |$ih#a0#0| (LitInt 0)))))))) (or (< (|Seq#Rank| |$ih#a0#0|) (|Seq#Rank| |a#0|)) (and (= (|Seq#Rank| |$ih#a0#0|) (|Seq#Rank| |a#0|)) (or (and (<= 0 |lowDigit#0@@1|) (< |lowDigit#0@@1| |lowDigit#0@@1|)) (and (= |lowDigit#0@@1| |lowDigit#0@@1|) (and (<= 0 |$ih#base0#0|) (< |$ih#base0#0| |base#0@@5|))))))) (= (Mod (_module.__default.eval ($LS $LZ) |$ih#a0#0| |$ih#base0#0|) |$ih#base0#0|) (U_2_int ($Unbox intType (|Seq#Index| |$ih#a0#0| (LitInt 0))))))
 :qid |NumberRepresentationsdfy.373:44|
 :skolemid |705|
...
))) (and ($IsAlloc SeqType |a#0| (TSeq TInt) $Heap@0) ($IsAlloc intType (int_2_U |base#0@@5|) TInt $Heap@0))) (and (=> (= (ControlFlow 0 24) (- 0 29)) (<= (LitInt 2) |base#0@@5|)) (=> (and (and (<= (LitInt 2) |base#0@@5|) (|_module.__default.eval#canCall| |a#0| |base#0@@5|)) (and (|_module.__default.eval#canCall| |a#0| |base#0@@5|) (= |n#0@0| (_module.__default.eval ($LS $LZ) |a#0| |base#0@@5|)))) (and (=> (= (ControlFlow 0 24) (- 0 28)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |a#0|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |a#0|))) (=> (= |##digits#3@0| (|Seq#Drop| |a#0| (LitInt 1))) (=> (and ($IsAlloc SeqType |##digits#3@0| (TSeq TInt) $Heap@0) ($IsAlloc intType (int_2_U |base#0@@5|) TInt $Heap@0)) (and (=> (= (ControlFlow 0 24) (- 0 27)) (<= (LitInt 2) |base#0@@5|)) (=> (<= (LitInt 2) |base#0@@5|) (=> (and (and (|_module.__default.eval#canCall| (|Seq#Drop| |a#0| (LitInt 1)) |base#0@@5|) (|_module.__default.eval#canCall| (|Seq#Drop| |a#0| (LitInt 1)) |base#0@@5|)) (and (= |a1#0@0| (_module.__default.eval ($LS $LZ) (|Seq#Drop| |a#0| (LitInt 1)) |base#0@@5|)) (= |b#0@0| (Mul |base#0@@5| |a1#0@0|)))) (and (=> (= (ControlFlow 0 24) (- 0 26)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |a#0|)))) (and (=> (= (ControlFlow 0 24) (- 0 25)) (= (+ (U_2_int ($Unbox intType (|Seq#Index| |a#0| (LitInt 0)))) |b#0@0|) |n#0@0|)) (=> (= (+ (U_2_int ($Unbox intType (|Seq#Index| |a#0| (LitInt 0)))) |b#0@0|) |n#0@0|) (and (and (and (and (=> (= (ControlFlow 0 24) 2) anon6_Then_correct) (=> (= (ControlFlow 0 24) 4) anon7_Then_correct)) (=> (= (ControlFlow 0 24) 8) anon8_Then_correct)) (=> (= (ControlFlow 0 24) 14) anon9_Then_correct)) (=> (= (ControlFlow 0 24) 23) anon9_Else_correct)))))))))))))))))))
...
))))) (not (|Seq#Equal| |a#0| |Seq#Empty|))) (and (<= (LitInt 0) (U_2_int ($Unbox intType (|Seq#Index| |a#0| (LitInt 0))))) (= (ControlFlow 0 30) 24))) anon0_correct)))))
