...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly T@U) ($Heap T@U) (|f#0| T@U) (|n#0| Int) ) (!  (=> (or (|_module.__default.Iter#canCall| (Lit HandleTypeType |f#0|) (LitInt |n#0|)) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap) ($Is HandleTypeType |f#0| (Tclass._System.___hTotalFunc1 TInt TInt))))) (and (=> (< (LitInt 0) (LitInt |n#0|)) (|_module.__default.Iter#canCall| (Lit HandleTypeType |f#0|) (LitInt (- |n#0| 1)))) (= (_module.__default.Iter ($LS $ly) (Lit HandleTypeType |f#0|) (LitInt |n#0|)) (ite (<= (LitInt |n#0|) (LitInt 0)) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap (Lit HandleTypeType |f#0|) ($Box intType (int_2_U (LitInt 1)))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap (Lit HandleTypeType |f#0|) ($Box intType (int_2_U (LitInt (_module.__default.Iter ($LS $ly) (Lit HandleTypeType |f#0|) (LitInt (- |n#0| 1)))))))))))))
 :qid |Ackermanndfy.59:16|
 :weight 3
 :skolemid |566|
 :pattern ( (_module.__default.Iter ($LS $ly) (Lit HandleTypeType |f#0|) (LitInt |n#0|)) ($IsGoodHeap $Heap))
))))
...
(assert (forall ((|#$T0| T@U) (|#$R| T@U) (|f#0@@0| T@U) ($h T@U) ) (! (= ($IsAlloc HandleTypeType |f#0@@0| (Tclass._System.___hPartialFunc1 |#$T0| |#$R|) $h) ($IsAlloc HandleTypeType |f#0@@0| (Tclass._System.___hFunc1 |#$T0| |#$R|) $h))
 :qid |unknown.0:0|
 :skolemid |403|
 :pattern ( ($IsAlloc HandleTypeType |f#0@@0| (Tclass._System.___hPartialFunc1 |#$T0| |#$R|) $h))
)))
(assert (forall ((|#$T0@@0| T@U) (|#$R@@0| T@U) (|f#0@@1| T@U) ($h@@0 T@U) ) (! (= ($IsAlloc HandleTypeType |f#0@@1| (Tclass._System.___hTotalFunc1 |#$T0@@0| |#$R@@0|) $h@@0) ($IsAlloc HandleTypeType |f#0@@1| (Tclass._System.___hPartialFunc1 |#$T0@@0| |#$R@@0|) $h@@0))
 :qid |unknown.0:0|
 :skolemid |410|
 :pattern ( ($IsAlloc HandleTypeType |f#0@@1| (Tclass._System.___hTotalFunc1 |#$T0@@0| |#$R@@0|) $h@@0))
)))
(assert (forall (($ly@@0 T@U) (|f#0@@2| T@U) (|n#0@@0| Int) ) (! (= (_module.__default.Iter ($LS $ly@@0) |f#0@@2| |n#0@@0|) (_module.__default.Iter $ly@@0 |f#0@@2| |n#0@@0|))
 :qid |Ackermanndfy.59:16|
 :skolemid |560|
 :pattern ( (_module.__default.Iter ($LS $ly@@0) |f#0@@2| |n#0@@0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@1 T@U) ($Heap@@0 T@U) (|f#0@@3| T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.__default.Iter#canCall| |f#0@@3| (LitInt |n#0@@1|)) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 TInt TInt))))) (and (=> (< (LitInt 0) (LitInt |n#0@@1|)) (|_module.__default.Iter#canCall| |f#0@@3| (LitInt (- |n#0@@1| 1)))) (= (_module.__default.Iter ($LS $ly@@1) |f#0@@3| (LitInt |n#0@@1|)) (ite (<= (LitInt |n#0@@1|) (LitInt 0)) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@0 |f#0@@3| ($Box intType (int_2_U (LitInt 1)))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@0 |f#0@@3| ($Box intType (int_2_U (_module.__default.Iter ($LS $ly@@1) |f#0@@3| (LitInt (- |n#0@@1| 1))))))))))))
 :qid |Ackermanndfy.59:16|
 :weight 3
 :skolemid |565|
 :pattern ( (_module.__default.Iter ($LS $ly@@1) |f#0@@3| (LitInt |n#0@@1|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@2 T@U) ($Heap@@1 T@U) (|f#0@@6| T@U) (|n#0@@2| Int) ) (!  (=> (or (|_module.__default.Iter#canCall| |f#0@@6| |n#0@@2|) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@1) ($Is HandleTypeType |f#0@@6| (Tclass._System.___hTotalFunc1 TInt TInt))))) (and (=> (< (LitInt 0) |n#0@@2|) (|_module.__default.Iter#canCall| |f#0@@6| (- |n#0@@2| 1))) (= (_module.__default.Iter ($LS $ly@@2) |f#0@@6| |n#0@@2|) (ite (<= |n#0@@2| (LitInt 0)) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@1 |f#0@@6| ($Box intType (int_2_U (LitInt 1)))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@1 |f#0@@6| ($Box intType (int_2_U (_module.__default.Iter $ly@@2 |f#0@@6| (- |n#0@@2| 1)))))))))))
 :qid |Ackermanndfy.59:16|
 :skolemid |564|
 :pattern ( (_module.__default.Iter ($LS $ly@@2) |f#0@@6| |n#0@@2|) ($IsGoodHeap $Heap@@1))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon8_Else_correct  (=> (and (and (< (LitInt 0) |n#0@@3|) ($IsAlloc HandleTypeType |f#0@@7| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap@@2)) (and (= |##n#0@0| (- |n#0@@3| 1)) ($IsAlloc intType (int_2_U |##n#0@0|) TInt $Heap@@2))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (<= 0 |n#0@@3|) (= |##n#0@0| |n#0@@3|))) (=> (or (<= 0 |n#0@@3|) (= |##n#0@0| |n#0@@3|)) (=> (= (ControlFlow 0 4) (- 0 3)) (< |##n#0@0| |n#0@@3|)))))))
(let ((anon8_Then_correct true))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (and (and (=> (= (ControlFlow 0 6) 1) anon7_Then_correct) (=> (= (ControlFlow 0 6) 2) anon8_Then_correct)) (=> (= (ControlFlow 0 6) 4) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) ($Is HandleTypeType |f#0@@7| (Tclass._System.___hTotalFunc1 TInt TInt))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct)))
