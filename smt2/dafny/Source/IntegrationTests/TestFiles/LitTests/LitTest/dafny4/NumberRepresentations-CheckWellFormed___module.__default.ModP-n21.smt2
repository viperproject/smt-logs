...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.ModProperty)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (<= (LitInt 2) |base#0|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |base#0| 0)) (not true))) (=> (or (not (= |base#0| 0)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= |base#0| 0)) (not true)))))))))
