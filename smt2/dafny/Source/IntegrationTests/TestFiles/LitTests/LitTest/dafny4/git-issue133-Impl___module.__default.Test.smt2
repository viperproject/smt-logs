...
(declare-fun |dt_update#m#1#Z#0@0| () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |let#2#0#0| |s#0|)) (=> (and (and ($Is DatatypeTypeType |let#2#0#0| Tclass._module.State) (= |dt_update_tmp#1#Z#0@0| |let#2#0#0|)) (and (_module.State.State_q |s#0|) (_module.State.State_q |s#0|))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Set#IsMember| (|Map#Domain| (_module.State.m |s#0|)) ($Box intType (int_2_U (LitInt 42))))) (=> (|Set#IsMember| (|Map#Domain| (_module.State.m |s#0|)) ($Box intType (int_2_U (LitInt 42)))) (=> (= |let#3#0#0| (|Map#Build| (_module.State.m |s#0|) ($Box intType (int_2_U (LitInt 42))) (MapType0Select BoxType BoxType (|Map#Elements| (_module.State.m |s#0|)) ($Box intType (int_2_U (LitInt 42)))))) (=> (and (and (_module.State.State_q |s#0|) (_module.State.State_q |s#0|)) (and ($Is MapType |let#3#0#0| (TMap TInt TBool)) (= |dt_update#m#1#Z#0@0| |let#3#0#0|))) (=> (and (and (and (_module.State.State_q |s#0|) (_module.State.State_q |s#0|)) (= |s'#0@0| (let ((|dt_update#m#1#0| (|Map#Build| (_module.State.m |s#0|) ($Box intType (int_2_U (LitInt 42))) (MapType0Select BoxType BoxType (|Map#Elements| (_module.State.m |s#0|)) ($Box intType (int_2_U (LitInt 42)))))))
(|#_module.State.State| |dt_update#m#1#0|)))) (and (and (_module.State.State_q |s'#0@0|) (_module.State.State_q |s#0|)) (and (_module.State.State_q |s'#0@0|) (_module.State.State_q |s#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Map#Equal| (_module.State.m |s'#0@0|) (_module.State.m |s#0|))) (=> (|Map#Equal| (_module.State.m |s'#0@0|) (_module.State.m |s#0|)) (=> (= (ControlFlow 0 2) (- 0 1)) (|_module.State#Equal| (let ((|dt_update#m#0#0| (|Map#Build| (_module.State.m |s#0|) ($Box intType (int_2_U (LitInt 42))) (MapType0Select BoxType BoxType (|Map#Elements| (_module.State.m |s#0|)) ($Box intType (int_2_U (LitInt 42)))))))
(|#_module.State.State| |dt_update#m#0#0|)) |s#0|)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |s#0| Tclass._module.State) ($IsAlloc DatatypeTypeType |s#0| Tclass._module.State $Heap)) (|$IsA#_module.State| |s#0|)) (=> (and (and (and (and ($Is DatatypeTypeType |s'#0| Tclass._module.State) ($IsAlloc DatatypeTypeType |s'#0| Tclass._module.State $Heap)) true) (= 1 $FunctionContextHeight)) (and (|Set#IsMember| (|Map#Domain| (_module.State.m |s#0|)) ($Box intType (int_2_U 42))) (= (ControlFlow 0 5) 2))) anon0_correct)))))
