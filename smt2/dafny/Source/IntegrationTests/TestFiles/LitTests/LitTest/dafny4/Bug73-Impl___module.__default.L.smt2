...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |i#0|)))) (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= |i#0| |r#0|)) (not true))))))
(let ((anon3_Else_correct  (=> (and (not (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |i#0|)))) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |i#0|))) (= (ControlFlow 0 4) 2)) anon2_correct)))
