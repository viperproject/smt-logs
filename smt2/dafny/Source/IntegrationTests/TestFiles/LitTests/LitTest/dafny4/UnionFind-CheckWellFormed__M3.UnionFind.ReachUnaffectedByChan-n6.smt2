...
(set-info :boogie-vc-id CheckWellFormed$$M3.UnionFind.ReachUnaffectedByChangeFromRoot)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap)) (=> (and (and (and (|M3.__default.GoodCMap#canCall| |C#0@@5|) (M3.__default.GoodCMap |C#0@@5|)) (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|)) ($IsAllocBox ($Box refType this@@3) Tclass.M3.UnionFind? $Heap))) (and (and ($IsAlloc intType (int_2_U |d#0@@3|) Tclass._System.nat $Heap) ($IsAlloc refType |e#0@@3| Tclass.M3.Element $Heap)) (and ($IsAlloc refType |r#0@@3| Tclass.M3.Element $Heap) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap)))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|M3.__default.GoodCMap#canCall| |C#0@@5|) (or (M3.__default.GoodCMap |C#0@@5|) (forall ((|f#0@@0| T@U) ) (!  (=> ($Is refType |f#0@@0| Tclass.M3.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |f#0@@0|)) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#0@@0|))))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#0@@0|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |3134|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#0@@0|))))
))))) (=> (M3.__default.GoodCMap |C#0@@5|) (and (=> (= (ControlFlow 0 2) (- 0 7)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|)) (=> (and (and (and (|M3.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|) (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|)) (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |tt#0|)) ($IsAllocBox ($Box refType this@@3) Tclass.M3.UnionFind? $Heap))) (and (and ($IsAlloc intType (int_2_U |td#0|) Tclass._System.nat $Heap) ($IsAlloc refType |tt#0| Tclass.M3.Element $Heap)) (and ($IsAlloc refType |tt#0| Tclass.M3.Element $Heap) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|M3.__default.GoodCMap#canCall| |C#0@@5|) (or (M3.__default.GoodCMap |C#0@@5|) (forall ((|f#1@@0| T@U) ) (!  (=> ($Is refType |f#1@@0| Tclass.M3.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |f#1@@0|)) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#1@@0|))))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#1@@0|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |3136|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#1@@0|))))
))))) (=> (M3.__default.GoodCMap |C#0@@5|) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |tt#0|))) (=> (and (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |tt#0|)) (|M3.UnionFind.Reaches#canCall| this@@3 |td#0| |tt#0| |tt#0| |C#0@@5|)) (and (M3.UnionFind.Reaches ($LS $LZ) this@@3 |td#0| |tt#0| |tt#0| |C#0@@5|) (or (not (= |tt#0| |r#0@@3|)) (not true)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |tt#0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |tt#0|)) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |tt#0|)))) (=> (and (and (|Map#Equal| |C'#0| (|Map#Build| |C#0@@5| ($Box refType |tt#0|) ($Box DatatypeTypeType (|#M3.Contents.Link| |tm#0|)))) ($IsAlloc MapType |C'#0| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap)) (and (|M3.__default.GoodCMap#canCall| |C'#0|) (M3.__default.GoodCMap |C'#0|))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) ($IsAllocBox ($Box refType this@@3) Tclass.M3.UnionFind? $Heap@0))) (and (and ($IsAlloc intType (int_2_U |d#0@@3|) Tclass._System.nat $Heap@0) ($IsAlloc refType |e#0@@3| Tclass.M3.Element $Heap@0)) (and ($IsAlloc refType |r#0@@3| Tclass.M3.Element $Heap@0) ($IsAlloc MapType |C'#0| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|M3.__default.GoodCMap#canCall| |C'#0|) (or (M3.__default.GoodCMap |C'#0|) (forall ((|f#2| T@U) ) (!  (=> ($Is refType |f#2| Tclass.M3.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |f#2|)) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#2|))))) (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#2|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |3138|
