...
(assert (forall (($h0@@0 T@U) ($h1@@0 T@U) (this@@8 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (and (or (not (= this@@8 null)) (not true)) ($Is refType this@@8 Tclass.M3.UnionFind))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@12 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@12 null)) (not true)) (or (= $o@@12 this@@8) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 this@@8) M3.UnionFind.Repr)) ($Box refType $o@@12)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@12) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@0 $o@@12) $f@@0)))
 :qid |unknown.0:0|
 :skolemid |4388|
)) (= (M3.UnionFind.ValidM1 $h0@@0 this@@8) (M3.UnionFind.ValidM1 $h1@@0 this@@8))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |4389|
 :pattern ( ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0) (M3.UnionFind.ValidM1 $h1@@0 this@@8))
)))
(assert (forall (($h0@@1 T@U) ($h1@@1 T@U) (this@@9 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@1) ($IsGoodHeap $h1@@1)) (and (or (not (= this@@9 null)) (not true)) ($Is refType this@@9 Tclass.M3.UnionFind))) (and ($IsHeapAnchor $h0@@1) ($HeapSucc $h0@@1 $h1@@1))) (=> (forall (($o@@13 T@U) ($f@@1 T@U) ) (!  (=> (and (or (not (= $o@@13 null)) (not true)) (or (= $o@@13 this@@9) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@1 this@@9) M3.UnionFind.Repr)) ($Box refType $o@@13)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@1 $o@@13) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@1 $o@@13) $f@@1)))
 :qid |unknown.0:0|
 :skolemid |4461|
)) (= (M3.UnionFind.Valid $h0@@1 this@@9) (M3.UnionFind.Valid $h1@@1 this@@9))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |4462|
...
(assert (not
 ...
 :qid |UnionFinddfy.345:20|
 :skolemid |4163|
))) (=> (forall (($o@@34 T@U) ($f@@10 T@U) ) (!  (=> (and (and (or (not (= $o@@34 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@34) alloc)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call1formal@this@0) M3.UnionFind.Repr)) ($Box refType $o@@34))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@34 $f@@10)))
 :qid |UnionFinddfy.345:20|
 :skolemid |4163|
