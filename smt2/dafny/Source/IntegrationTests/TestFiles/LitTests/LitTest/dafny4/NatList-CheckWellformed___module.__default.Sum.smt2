...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly T@U) (|ns#0| T@U) ) (!  (=> (or (|_module.__default.Sum#canCall| |ns#0|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |ns#0| (Tclass._module.List Tclass._System.nat)))) (and (=> (not (_module.List.Nil_q |ns#0|)) (let ((|tail#1| (_module.List.tail |ns#0|)))
(|_module.__default.Sum#canCall| |tail#1|))) (= (_module.__default.Sum ($LS $ly) |ns#0|) (ite (_module.List.Nil_q |ns#0|) 0 (let ((|tail#0| (_module.List.tail |ns#0|)))
(let ((|n#0| (U_2_int ($Unbox intType (_module.List.head |ns#0|)))))
(+ |n#0| (_module.__default.Sum $ly |tail#0|))))))))
 :qid |NatListdfy.23:10|
 :skolemid |539|
 :pattern ( (_module.__default.Sum ($LS $ly) |ns#0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@0 T@U) (|ns#0@@0| T@U) ) (!  (=> (or (|_module.__default.Sum#canCall| (Lit DatatypeTypeType |ns#0@@0|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |ns#0@@0| (Tclass._module.List Tclass._System.nat)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |ns#0@@0|)))))) (let ((|tail#3| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |ns#0@@0|)))))
(|_module.__default.Sum#canCall| |tail#3|))) (= (_module.__default.Sum ($LS $ly@@0) (Lit DatatypeTypeType |ns#0@@0|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |ns#0@@0|)) 0 (let ((|tail#2| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |ns#0@@0|)))))
(let ((|n#2| (LitInt (U_2_int ($Unbox intType (_module.List.head (Lit DatatypeTypeType |ns#0@@0|)))))))
(LitInt (+ |n#2| (_module.__default.Sum ($LS $ly@@0) |tail#2|)))))))))
 :qid |NatListdfy.23:10|
 :weight 3
 :skolemid |540|
 :pattern ( (_module.__default.Sum ($LS $ly@@0) (Lit DatatypeTypeType |ns#0@@0|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@1 T@U) (|ns#0@@1| T@U) ) (!  (=> (or (|_module.__default.Sum#canCall| |ns#0@@1|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |ns#0@@1| (Tclass._module.List Tclass._System.nat)))) (<= (LitInt 0) (_module.__default.Sum $ly@@1 |ns#0@@1|)))
 :qid |NatListdfy.23:10|
 :skolemid |537|
 :pattern ( (_module.__default.Sum $ly@@1 |ns#0@@1|))
))))
...
(assert (forall (($ly@@2 T@U) (|ns#0@@2| T@U) ) (! (= (_module.__default.Sum ($LS $ly@@2) |ns#0@@2|) (_module.__default.Sum $ly@@2 |ns#0@@2|))
 :qid |NatListdfy.23:10|
 :skolemid |535|
 :pattern ( (_module.__default.Sum ($LS $ly@@2) |ns#0@@2|))
)))
...
(let ((anon10_Then_correct  (=> (and (= |ns#0@@3| (|#_module.List.Cons| ($Box intType (int_2_U |_mcc#0#0|)) |_mcc#1#0|)) (<= (LitInt 0) |_mcc#0#0|)) (=> (and (and (and ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List Tclass._System.nat)) (= |let#0#0#0| |_mcc#1#0|)) (and ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List Tclass._System.nat)) (= |tail#Z#0@0| |let#0#0#0|))) (and (and (= |let#1#0#0| |_mcc#0#0|) ($Is intType (int_2_U |let#1#0#0|) Tclass._System.nat)) (and (= |n#Z#0@0| |let#1#0#0|) ($IsAlloc DatatypeTypeType |tail#Z#0@0| (Tclass._module.List Tclass._System.nat) $Heap)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< (DtRank |tail#Z#0@0|) (DtRank |ns#0@@3|))) (=> (< (DtRank |tail#Z#0@0|) (DtRank |ns#0@@3|)) (=> (and (|_module.__default.Sum#canCall| |tail#Z#0@0|) (= (ControlFlow 0 5) (- 0 4))) ($Is intType (int_2_U (+ |n#Z#0@0| (_module.__default.Sum ($LS $LZ) |tail#Z#0@0|))) Tclass._System.nat))))))))
(let ((anon9_Else_correct  (=> (or (not (= |ns#0@@3| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 8) 5) anon10_Then_correct) (=> (= (ControlFlow 0 8) 7) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> (and (= |ns#0@@3| |#_module.List.Nil|) (= (ControlFlow 0 3) (- 0 2))) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |ns#0@@3| (Tclass._module.List Tclass._System.nat))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct)))
