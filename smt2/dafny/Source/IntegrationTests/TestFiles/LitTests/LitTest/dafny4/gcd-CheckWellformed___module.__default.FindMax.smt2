...
(let ((anon17_Then_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (|Set#IsMember| |s#0@@3| ($Box intType (int_2_U (LitInt 0))))) (exists ((|x#3| T@U) ) (|Set#IsMember| |s#0@@3| ($Box intType |x#3|))))) (=> (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (|Set#IsMember| |s#0@@3| ($Box intType (int_2_U (LitInt 0))))) (exists ((|x#3@@0| Int) ) (|Set#IsMember| |s#0@@3| ($Box intType (int_2_U |x#3@@0|))))) (=> (|Set#IsMember| |s#0@@3| ($Box intType (int_2_U |x#2@0|))) (and (=> (= (ControlFlow 0 15) 7) anon18_Then_correct) (=> (= (ControlFlow 0 15) 10) anon18_Else_correct)))))))
