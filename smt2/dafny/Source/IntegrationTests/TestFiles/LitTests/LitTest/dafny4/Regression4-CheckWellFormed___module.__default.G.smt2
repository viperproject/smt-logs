...
(assert (forall ((bx@@0 T@U) ) (!  (=> ($IsBox bx@@0 Tclass._module.AbsPTE) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@0)) bx@@0) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@0) Tclass._module.AbsPTE)))
 :qid |unknown.0:0|
 :skolemid |490|
 :pattern ( ($IsBox bx@@0 Tclass._module.AbsPTE))
)))
...
(assert (forall ((_module.Maybe$T@@7 T@U) (bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 (Tclass._module.Maybe _module.Maybe$T@@7)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@2)) bx@@2) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@2) (Tclass._module.Maybe _module.Maybe$T@@7))))
 :qid |unknown.0:0|
 :skolemid |484|
 :pattern ( ($IsBox bx@@2 (Tclass._module.Maybe _module.Maybe$T@@7)))
)))
...
(let ((anon7_Else_correct  (=> (and (< |j#0| (LitInt 0)) (= (ControlFlow 0 5) 1)) anon5_correct)))
(let ((anon7_Then_correct  (=> (<= (LitInt 0) |j#0|) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= 0 |i#0|) (< |i#0| (|Seq#Length| |pt#0|)))) (=> (and (<= 0 |i#0|) (< |i#0| (|Seq#Length| |pt#0|))) (=> (and (= |##x#0@0| ($Unbox DatatypeTypeType (|Seq#Index| |pt#0| |i#0|))) ($IsAlloc DatatypeTypeType |##x#0@0| (Tclass._module.Maybe (TSeq (Tclass._module.Maybe Tclass._module.AbsPTE))) $Heap@@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (_module.Maybe.Just_q |##x#0@0|)) (=> (_module.Maybe.Just_q |##x#0@0|) (=> (and (|_module.__default.fromJust#canCall| (TSeq (Tclass._module.Maybe Tclass._module.AbsPTE)) ($Unbox DatatypeTypeType (|Seq#Index| |pt#0| |i#0|))) (= (ControlFlow 0 2) 1)) anon5_correct)))))))))
(let ((anon3_correct  (=> (and (<= (LitInt 0) |i#0|) (< |i#0| (|Seq#Length| |pt#0|))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (and (<= 0 |i#0|) (< |i#0| (|Seq#Length| |pt#0|)))) (=> (and (<= 0 |i#0|) (< |i#0| (|Seq#Length| |pt#0|))) (=> (_module.Maybe.Just_q ($Unbox DatatypeTypeType (|Seq#Index| |pt#0| |i#0|))) (and (=> (= (ControlFlow 0 6) 2) anon7_Then_correct) (=> (= (ControlFlow 0 6) 5) anon7_Else_correct))))))))
(let ((anon6_Else_correct  (=> (and (< |i#0| (LitInt 0)) (= (ControlFlow 0 9) 6)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (<= (LitInt 0) |i#0|) (= (ControlFlow 0 8) 6)) anon3_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (and (=> (= (ControlFlow 0 10) 8) anon6_Then_correct) (=> (= (ControlFlow 0 10) 9) anon6_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is SeqType |pt#0| (TSeq (Tclass._module.Maybe (TSeq (Tclass._module.Maybe Tclass._module.AbsPTE))))) ($IsAlloc SeqType |pt#0| (TSeq (Tclass._module.Maybe (TSeq (Tclass._module.Maybe Tclass._module.AbsPTE)))) $Heap@@0)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct))))
