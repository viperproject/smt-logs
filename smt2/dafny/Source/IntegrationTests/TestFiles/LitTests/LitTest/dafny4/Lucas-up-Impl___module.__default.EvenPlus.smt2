...
(declare-fun |a#0| () Int)
(declare-fun |b#0| () Int)
(set-info :boogie-vc-id Impl$$_module.__default.EvenPlus)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and reveal__module._default.EVEN (= (ControlFlow 0 2) (- 0 1)))) (= (_module.__default.EVEN reveal__module._default.EVEN (+ |a#0| |b#0|)) (= (_module.__default.EVEN reveal__module._default.EVEN |a#0|) (_module.__default.EVEN reveal__module._default.EVEN |b#0|)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (<= (LitInt 0) |a#0|) (<= (LitInt 0) |b#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
