...
(set-info :boogie-vc-id CheckWellFormed$$M3.UnionFind.ReachUnaffectedByChangeFromRoot_k)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap)) (=> (and (and (and (|M3.__default.GoodCMap#canCall| |C#0@@5|) (M3.__default.GoodCMap |C#0@@5|)) (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|)) ($IsAllocBox ($Box refType this@@3) Tclass.M3.UnionFind? $Heap))) (and (and ($IsAlloc intType (int_2_U |d#0@@3|) Tclass._System.nat $Heap) ($IsAlloc refType |e#0@@3| Tclass.M3.Element $Heap)) (and ($IsAlloc refType |r#0@@3| Tclass.M3.Element $Heap) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap)))) (and (=> (= (ControlFlow 0 2) (- 0 18)) (=> (|M3.__default.GoodCMap#canCall| |C#0@@5|) (or (M3.__default.GoodCMap |C#0@@5|) (forall ((|f#0@@0| T@U) ) (!  (=> ($Is refType |f#0@@0| Tclass.M3.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |f#0@@0|)) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#0@@0|))))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#0@@0|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |3060|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#0@@0|))))
))))) (=> (M3.__default.GoodCMap |C#0@@5|) (and (=> (= (ControlFlow 0 2) (- 0 17)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|)) (=> (and (and (|M3.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|) (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|)) (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r1#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|)) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r1#0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r1#0|)) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|)) (and (=> (= (ControlFlow 0 2) (- 0 13)) (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|))))) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r1#0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r1#0|)) (and (=> (= (ControlFlow 0 2) (- 0 11)) (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|))))) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|)))) (=> (and (= (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|)))) (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|))))) (or (not (= |r0#0| |r1#0|)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|)) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r1#0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r1#0|)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|))))) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) ($Is intType (int_2_U (+ (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|)))) 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|)))) 1)) Tclass._System.nat) (=> (and (|Map#Equal| |C'#0| (|Map#Build| (|Map#Build| |C#0@@5| ($Box refType |r0#0|) ($Box DatatypeTypeType (|#M3.Contents.Link| |r1#0|))) ($Box refType |r1#0|) ($Box DatatypeTypeType (|#M3.Contents.Root| (+ (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|)))) 1))))) ($IsAllocBox ($Box refType this@@3) Tclass.M3.UnionFind? $Heap)) (=> (and (and ($IsAlloc intType (int_2_U |td#0|) Tclass._System.nat $Heap) ($IsAlloc refType |r0#0| Tclass.M3.Element $Heap)) (and ($IsAlloc refType |r0#0| Tclass.M3.Element $Heap) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|M3.__default.GoodCMap#canCall| |C#0@@5|) (or (M3.__default.GoodCMap |C#0@@5|) (forall ((|f#1@@0| T@U) ) (!  (=> ($Is refType |f#1@@0| Tclass.M3.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |f#1@@0|)) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#1@@0|))))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#1@@0|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |3062|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#1@@0|))))
))))) (=> (M3.__default.GoodCMap |C#0@@5|) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|)) (=> (and (|M3.UnionFind.Reaches#canCall| this@@3 |td#0| |r0#0| |r0#0| |C#0@@5|) (M3.UnionFind.Reaches ($LS $LZ) this@@3 |td#0| |r0#0| |r0#0| |C#0@@5|)) (=> (and (and (and (or (not (= |r0#0| |r#0@@3|)) (not true)) ($IsAlloc MapType |C'#0| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap)) (and (|M3.__default.GoodCMap#canCall| |C'#0|) (M3.__default.GoodCMap |C'#0|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) ($IsAllocBox ($Box refType this@@3) Tclass.M3.UnionFind? $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($Is intType (int_2_U (+ |d#0@@3| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ |d#0@@3| 1)) Tclass._System.nat) (=> (= |##d#2@0| (+ |d#0@@3| 1)) (=> (and (and ($IsAlloc intType (int_2_U |##d#2@0|) Tclass._System.nat $Heap@0) ($IsAlloc refType |e#0@@3| Tclass.M3.Element $Heap@0)) (and ($IsAlloc refType |r#0@@3| Tclass.M3.Element $Heap@0) ($IsAlloc MapType |C'#0| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|M3.__default.GoodCMap#canCall| |C'#0|) (or (M3.__default.GoodCMap |C'#0|) (forall ((|f#2| T@U) ) (!  (=> ($Is refType |f#2| Tclass.M3.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |f#2|)) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#2|))))) (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#2|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |3064|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.M3.UnionFind) ($IsAlloc refType this@@3 Tclass.M3.UnionFind $Heap))) (<= (LitInt 0) |d#0@@3|)) (=> (and (and (and (and ($Is refType |e#0@@3| Tclass.M3.Element) ($IsAlloc refType |e#0@@3| Tclass.M3.Element $Heap)) (and ($Is refType |r#0@@3| Tclass.M3.Element) ($IsAlloc refType |r#0@@3| Tclass.M3.Element $Heap))) (and (and ($Is MapType |C#0@@5| (TMap Tclass.M3.Element Tclass.M3.Contents)) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap)) (<= (LitInt 0) |td#0|))) (and (and (and ($Is refType |r0#0| Tclass.M3.Element) ($IsAlloc refType |r0#0| Tclass.M3.Element $Heap)) (and ($Is refType |r1#0| Tclass.M3.Element) ($IsAlloc refType |r1#0| Tclass.M3.Element $Heap))) (and (and ($Is MapType |C'#0| (TMap Tclass.M3.Element Tclass.M3.Contents)) ($IsAlloc MapType |C'#0| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 19) 2))))) anon0_correct)))))
