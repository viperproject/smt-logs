...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|b1#0@@0| T@U) (|b2#0@@0| T@U) ) (!  (=> (or (|_module.__default.andb#canCall| |b1#0@@0| |b2#0@@0|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |b1#0@@0| Tclass._module.Bool) ($Is DatatypeTypeType |b2#0@@0| Tclass._module.Bool)))) (= (_module.__default.andb |b1#0@@0| |b2#0@@0|) (ite (_module.Bool.True_q |b1#0@@0|) |b2#0@@0| |#_module.Bool.False|)))
 :qid |SoftwareFoundationsBasicsdfy.80:22|
 :skolemid |596|
 :pattern ( (_module.__default.andb |b1#0@@0| |b2#0@@0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|b1#0@@1| T@U) (|b2#0@@1| T@U) ) (!  (=> (or (|_module.__default.andb#canCall| (Lit DatatypeTypeType |b1#0@@1|) (Lit DatatypeTypeType |b2#0@@1|)) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |b1#0@@1| Tclass._module.Bool) ($Is DatatypeTypeType |b2#0@@1| Tclass._module.Bool)))) (= (_module.__default.andb (Lit DatatypeTypeType |b1#0@@1|) (Lit DatatypeTypeType |b2#0@@1|)) (ite (_module.Bool.True_q (Lit DatatypeTypeType |b1#0@@1|)) |b2#0@@1| |#_module.Bool.False|)))
 :qid |SoftwareFoundationsBasicsdfy.80:22|
 :weight 3
 :skolemid |597|
 :pattern ( (_module.__default.andb (Lit DatatypeTypeType |b1#0@@1|) (Lit DatatypeTypeType |b2#0@@1|)))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.andb__true)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|_module.Bool#Equal| (_module.__default.andb (Lit DatatypeTypeType |#_module.Bool.True|) |b#0|) |b#0|))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |b#0| Tclass._module.Bool) ($IsAlloc DatatypeTypeType |b#0| Tclass._module.Bool $Heap)) (|$IsA#_module.Bool| |b#0|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
