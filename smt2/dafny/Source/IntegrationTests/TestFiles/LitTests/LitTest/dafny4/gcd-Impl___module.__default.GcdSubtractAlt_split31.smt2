...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_correct  (=> (and (or (and ($Is intType (int_2_U (LitInt 1)) Tclass._module.pos) (= (Mul |p#0@0| (LitInt 1)) |x#0@@10|)) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._module.pos) (= (Mul |p#0@0| (LitInt 0)) |x#0@@10|)) (exists ((|$as#a0_0#0_0| Int) )  (and (<= (LitInt 1) |$as#a0_0#0_0|) (= (Mul |p#0@0| |$as#a0_0#0_0|) |x#0@@10|))))) (<= (LitInt 1) |a#0_0@0|)) (=> (and (and (= (Mul |p#0@0| |a#0_0@0|) |x#0@@10|) (<= (LitInt 1) |b#0_1@0|)) (and (= |newtype$check#0_1@0| (Mul |p#0@0| |b#0_1@0|)) (= (ControlFlow 0 2) (- 0 1)))) (<= (LitInt 1) |newtype$check#0_1@0|)))))
