...
(declare-fun CoThings.__default.A_h (T@U T@U Int) Bool)
(declare-fun $LS (T@U) T@U)
(declare-fun |CoThings.__default.A_h#canCall| (T@U Int) Bool)
(declare-fun |CoThings.__default.B_h#canCall| (T@U Int) Bool)
(declare-fun CoThings.__default.B_h (T@U T@U Int) Bool)
(declare-fun $LZ () T@U)
...
(set-info :boogie-vc-id Impl$$CoThings.__default.AA_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|CoThings.__default.A_h#canCall| |_k#0@@9| |x#1|) (or (CoThings.__default.A_h ($LS $LZ) |_k#0@@9| |x#1|) (=> (< 0 (|ORD#Offset| |_k#0@@9|)) (CoThings.__default.B_h ($LS ($LS $LZ)) (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) (+ |x#1| 1)))))) (=> (=> (|CoThings.__default.A_h#canCall| |_k#0@@9| |x#1|) (or (CoThings.__default.A_h ($LS $LZ) |_k#0@@9| |x#1|) (=> (< 0 (|ORD#Offset| |_k#0@@9|)) (CoThings.__default.B_h ($LS ($LS $LZ)) (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) (+ |x#1| 1))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|CoThings.__default.A_h#canCall| |_k#0@@9| |x#1|) (or (CoThings.__default.A_h ($LS $LZ) |_k#0@@9| |x#1|) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@9|)) (forall ((|_k'#1@@3| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@3| |_k#0@@9|) (CoThings.__default.A_h ($LS ($LS $LZ)) |_k'#1@@3| |x#1|))
 :qid |Bug170dfy.36:22|
 :skolemid |1175|
 :pattern ( (CoThings.__default.A_h ($LS ($LS $LZ)) |_k'#1@@3| |x#1|))
))))))))))
(let ((anon3_Else_correct  (=> (<= (|ORD#Offset| |_k#0@@9|) 0) (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (= $Heap@0 $Heap@2)) (and (forall ((|_k'#2@@3| T@U) (|x#2| Int) ) (!  (=> (|ORD#Less| |_k'#2@@3| |_k#0@@9|) (CoThings.__default.A_h ($LS $LZ) |_k'#2@@3| |x#2|))
 :qid |Bug170dfy.46:18|
 :skolemid |1180|
 :pattern ( (CoThings.__default.A_h ($LS $LZ) |_k'#2@@3| |x#2|))
)) (= (ControlFlow 0 10) 2))) GeneratedUnifiedExit_correct))))
(let ((anon3_Then_correct  (=> (< 0 (|ORD#Offset| |_k#0@@9|)) (and (=> (= (ControlFlow 0 4) (- 0 9)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 4) (- 0 8)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@9|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@9|)) (=> (and (= |_k##0@0| (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1))) (= |x##0@0| (+ |x#1| 1))) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (|CoThings.__default.B_h#canCall| |_k##0@0| |x##0@0|)) (and (and (|CoThings.__default.B_h#canCall| |_k##0@0| |x##0@0|) (and (CoThings.__default.B_h ($LS $LZ) |_k##0@0| |x##0@0|) (and (=> (< 0 (|ORD#Offset| |_k##0@0|)) (CoThings.__default.A_h ($LS $LZ) (|ORD#Minus| |_k##0@0| (|ORD#FromNat| 1)) (+ |x##0@0| 1))) (=> (= (LitInt 0) (|ORD#Offset| |_k##0@0|)) (forall ((|_k'#0@@3| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@3| |_k##0@0|) (CoThings.__default.B_h ($LS $LZ) |_k'#0@@3| |x##0@0|))
 :qid |Bug170dfy.41:22|
 :skolemid |1183|
 :pattern ( (CoThings.__default.B_h ($LS $LZ) |_k'#0@@3| |x##0@0|))
)))))) (= $Heap@0 $Heap@1))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@9|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@9|)) (=> (and (= |##_k#0@0| (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1))) ($IsAlloc BoxType |##_k#0@0| TORDINAL $Heap@1)) (=> (and (and (= |##x#1@0| (+ |x#1| 1)) ($IsAlloc intType (int_2_U |##x#1@0|) TInt $Heap@1)) (and (|CoThings.__default.B_h#canCall| (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) (+ |x#1| 1)) (|CoThings.__default.B_h#canCall| (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) (+ |x#1| 1)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (=> (|CoThings.__default.B_h#canCall| (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) (+ |x#1| 1)) (CoThings.__default.B_h ($LS $LZ) (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) (+ |x#1| 1)))) (=> (and (CoThings.__default.B_h ($LS $LZ) (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) (+ |x#1| 1)) (= (ControlFlow 0 4) 2)) GeneratedUnifiedExit_correct)))))))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#_k0#0| T@U) (|$ih#x0#0| Int) ) (!  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) (or (|ORD#Less| |$ih#_k0#0| |_k#0@@9|) (and (= |$ih#_k0#0| |_k#0@@9|) (and (<= 0 |$ih#x0#0|) (< |$ih#x0#0| |x#1|))))) (CoThings.__default.A_h ($LS $LZ) |$ih#_k0#0| |$ih#x0#0|))
 :qid |Bug170dfy.46:18|
 :skolemid |1178|
 :pattern ( (CoThings.__default.A_h ($LS $LZ) |$ih#_k0#0| |$ih#x0#0|))
