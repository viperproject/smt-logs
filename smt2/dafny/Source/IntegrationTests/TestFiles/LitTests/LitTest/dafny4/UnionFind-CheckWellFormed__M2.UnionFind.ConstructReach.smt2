...
(set-info :boogie-vc-id CheckWellFormed$$M2.UnionFind.ConstructReach)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M2.Element Tclass.M2.Contents) $Heap)) (=> (and (and (and (|M2.__default.GoodCMap#canCall| |C#0@@5|) (M2.__default.GoodCMap |C#0@@5|)) (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|)) ($IsAllocBox ($Box refType this@@3) Tclass.M2.UnionFind? $Heap))) (and (and ($IsAlloc intType (int_2_U |d#0@@3|) Tclass._System.nat $Heap) ($IsAlloc refType |e#0@@3| Tclass.M2.Element $Heap)) (and ($IsAlloc refType |r#0@@3| Tclass.M2.Element $Heap) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M2.Element Tclass.M2.Contents) $Heap)))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|M2.__default.GoodCMap#canCall| |C#0@@5|) (or (M2.__default.GoodCMap |C#0@@5|) (forall ((|f#0@@0| T@U) ) (!  (=> ($Is refType |f#0@@0| Tclass.M2.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |f#0@@0|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#0@@0|))))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#0@@0|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |2065|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#0@@0|))))
))))) (=> (M2.__default.GoodCMap |C#0@@5|) (and (=> (= (ControlFlow 0 2) (- 0 8)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|)) (=> (and (and (and (|M2.UnionFind.Reaches#canCall| this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|) (M2.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@@3| |e#0@@3| |r#0@@3| |C#0@@5|)) (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |tt#0|)) ($IsAllocBox ($Box refType this@@3) Tclass.M2.UnionFind? $Heap))) (and (and ($IsAlloc intType (int_2_U |td#0|) Tclass._System.nat $Heap) ($IsAlloc refType |tt#0| Tclass.M2.Element $Heap)) (and ($IsAlloc refType |tm#0| Tclass.M2.Element $Heap) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M2.Element Tclass.M2.Contents) $Heap)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|M2.__default.GoodCMap#canCall| |C#0@@5|) (or (M2.__default.GoodCMap |C#0@@5|) (forall ((|f#1@@0| T@U) ) (!  (=> ($Is refType |f#1@@0| Tclass.M2.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |f#1@@0|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#1@@0|))))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#1@@0|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |2067|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#1@@0|))))
))))) (=> (M2.__default.GoodCMap |C#0@@5|) (and (=> (= (ControlFlow 0 2) (- 0 6)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |tt#0|))) (=> (and (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |tt#0|)) (|M2.UnionFind.Reaches#canCall| this@@3 |td#0| |tt#0| |tm#0| |C#0@@5|)) (and (M2.UnionFind.Reaches ($LS $LZ) this@@3 |td#0| |tt#0| |tm#0| |C#0@@5|) (|Map#Equal| |C'#0| (|Map#Build| |C#0@@5| ($Box refType |tt#0|) ($Box DatatypeTypeType (|#M2.Contents.Link| |tm#0|)))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |tt#0|))) (=> (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |tt#0|)) (=> (and (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |tt#0|)))) (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |tm#0|))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |tm#0|))) (=> (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |tm#0|)) (=> (and (and (M2.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |tm#0|)))) ($IsAlloc MapType |C'#0| (TMap Tclass.M2.Element Tclass.M2.Contents) $Heap)) (and (|M2.__default.GoodCMap#canCall| |C'#0|) (M2.__default.GoodCMap |C'#0|))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) ($IsAllocBox ($Box refType this@@3) Tclass.M2.UnionFind? $Heap@0))) (and (and ($IsAlloc intType (int_2_U |d#0@@3|) Tclass._System.nat $Heap@0) ($IsAlloc refType |e#0@@3| Tclass.M2.Element $Heap@0)) (and ($IsAlloc refType |r#0@@3| Tclass.M2.Element $Heap@0) ($IsAlloc MapType |C'#0| (TMap Tclass.M2.Element Tclass.M2.Contents) $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|M2.__default.GoodCMap#canCall| |C'#0|) (or (M2.__default.GoodCMap |C'#0|) (forall ((|f#2| T@U) ) (!  (=> ($Is refType |f#2| Tclass.M2.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |f#2|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#2|))))) (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#2|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |2069|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#2|))))
))))) (=> (and (M2.__default.GoodCMap |C'#0|) (= (ControlFlow 0 2) (- 0 1))) (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |e#0@@3|))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.M2.UnionFind) ($IsAlloc refType this@@3 Tclass.M2.UnionFind $Heap))) (<= (LitInt 0) |d#0@@3|)) (=> (and (and (and (and ($Is refType |e#0@@3| Tclass.M2.Element) ($IsAlloc refType |e#0@@3| Tclass.M2.Element $Heap)) (and ($Is refType |r#0@@3| Tclass.M2.Element) ($IsAlloc refType |r#0@@3| Tclass.M2.Element $Heap))) (and (and ($Is MapType |C#0@@5| (TMap Tclass.M2.Element Tclass.M2.Contents)) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M2.Element Tclass.M2.Contents) $Heap)) (<= (LitInt 0) |td#0|))) (and (and (and ($Is refType |tt#0| Tclass.M2.Element) ($IsAlloc refType |tt#0| Tclass.M2.Element $Heap)) (and ($Is refType |tm#0| Tclass.M2.Element) ($IsAlloc refType |tm#0| Tclass.M2.Element $Heap))) (and (and ($Is MapType |C'#0| (TMap Tclass.M2.Element Tclass.M2.Contents)) ($IsAlloc MapType |C'#0| (TMap Tclass.M2.Element Tclass.M2.Contents) $Heap)) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 10) 2))))) anon0_correct)))))
