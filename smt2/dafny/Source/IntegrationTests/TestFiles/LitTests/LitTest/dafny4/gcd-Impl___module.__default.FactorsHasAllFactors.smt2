...
(set-info :boogie-vc-id Impl$$_module.__default.FactorsHasAllFactors)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (forall ((|n#1| Int) ) (! (= (|Set#IsMember| (_module.__default.Factors |x#0@@5|) ($Box intType (int_2_U |n#1|)))  (and (<= (LitInt 1) |n#1|) (_module.__default.IsFactor |n#1| |x#0@@5|)))
 :qid |gcddfy.25:18|
 :skolemid |554|
 :pattern ( (|Set#IsMember| (_module.__default.Factors |x#0@@5|) ($Box intType (int_2_U |n#1|))))
)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 1) |x#0@@5|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct)))
