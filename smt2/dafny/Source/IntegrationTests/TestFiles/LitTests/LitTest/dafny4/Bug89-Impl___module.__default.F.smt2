...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |x#0@0| (LitInt 5)) (= |let#0#0#0| (LitInt 1))) (=> (and (and ($Is intType (int_2_U |let#0#0#0|) TInt) (= |y#Z#0@0| |let#0#0#0|)) (and (= |x#0@1| (let ((|y#0| (LitInt 1)))
(+ |y#0| |x#0@0|))) (= (ControlFlow 0 2) (- 0 1)))) (= |x#0@1| (LitInt 6)))))))
