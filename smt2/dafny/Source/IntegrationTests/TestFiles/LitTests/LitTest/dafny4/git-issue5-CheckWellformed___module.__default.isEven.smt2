...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0| Int) ) (!  (=> (or (|_module.__default.isEven#canCall| |x#0|) (< 0 $FunctionContextHeight)) (= (_module.__default.isEven |x#0|) (= (Mod |x#0| (LitInt 2)) (LitInt 0))))
 :qid |gitissue5dfy.4:24|
 :skolemid |1592|
 :pattern ( (_module.__default.isEven |x#0|))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@0| Int) ) (!  (=> (or (|_module.__default.isEven#canCall| (LitInt |x#0@@0|)) (< 0 $FunctionContextHeight)) (= (_module.__default.isEven (LitInt |x#0@@0|)) (= (LitInt (Mod |x#0@@0| (LitInt 2))) (LitInt 0))))
 :qid |gitissue5dfy.4:24|
 :weight 3
 :skolemid |1593|
 :pattern ( (_module.__default.isEven (LitInt |x#0@@0|)))
))))
