...
(assert (forall ((|l#0| Int) (|l#1| T@U) (|l#2| Int) (|l#3| T@U) (|$y#0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#11| |l#0| |l#1| |l#2| |l#3|) |$y#0|)) (exists ((|x#0@@1| Int) ) (!  (and (and (<= |l#0| |x#0@@1|) (|Set#IsMember| |l#1| ($Box intType (int_2_U |x#0@@1|)))) (= |$y#0| ($Box intType (int_2_U (+ |x#0@@1| |l#2|)))))
 ...
 :qid |unknown.0:0|
 :skolemid |583|
 :pattern ( (MapType0Select BoxType boolType (|lambda#11| |l#0| |l#1| |l#2| |l#3|) |$y#0|))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.SucElements)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (forall ((|x#1| Int) ) (! (= (|Set#IsMember| |S#0@@2| ($Box intType (int_2_U |x#1|))) (|Set#IsMember| (_module.__default.Suc |S#0@@2|) ($Box intType (int_2_U (+ |x#1| 1)))))
 :qid |Lucasdowndfy.84:18|
 :skolemid |569|
 :pattern ( (|Set#IsMember| |S#0@@2| ($Box intType (int_2_U |x#1|))))
)))))
