...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.BitSet)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon10_correct  (=> (= (ControlFlow 0 4) (- 0 3)) ($Is SetType (|Set#FromBoogieMap| (|lambda#3| TInt (LitInt 0) |n#0@@5| ($LS $LZ) |n#0@@5|)) (TSet Tclass._System.nat)))))
