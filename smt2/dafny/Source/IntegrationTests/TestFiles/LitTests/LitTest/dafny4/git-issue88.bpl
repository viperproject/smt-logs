// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue88.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue88-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue88.dfy
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "M2 (correctness)"} Impl$$_module.__default.M2() returns ($_reverifyPost: bool)
{
  ...
  var g#0: ref
     where $Is(g#0, Tclass._System.array2(TInt))
       && $IsAlloc(g#0, Tclass._System.array2(TInt), $Heap);
  var $nw: ref;
  var $rhs#0: int;
    ...
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue88.dfy(6,15)
    assume true;
    assert {:id "id0"} 0 <= LitInt(9);
    assert {:id "id1"} 0 <= LitInt(9);
    havoc $nw;
    ...
    g#0 := $nw;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue88.dfy(7,10)
    assert {:id "id3"} g#0 != null;
    assert {:id "id4"} 0 <= LitInt(0) && LitInt(0) < _System.array2.Length0(g#0);
    assert {:id "id5"} 0 <= LitInt(0) && LitInt(0) < _System.array2.Length1(g#0);
    assume true;
    assert {:id "id6"} $_ModifiesFrame[g#0, MultiIndexField(IndexField(LitInt(0)), LitInt(0))];
    assume true;
    $rhs#0 := LitInt(1);
    $Heap := update($Heap, g#0, MultiIndexField(IndexField(LitInt(0)), LitInt(0)), $Box($rhs#0));
    assume $IsGoodHeap($Heap);
}
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "M1 (correctness)"} Impl$$_module.__default.M1() returns ($_reverifyPost: bool)
{
  ...
  var $rhs#0: int;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue88.dfy(13,15)
    assume true;
    assert {:id "id9"} 0 <= LitInt(9);
    havoc $nw;
    ...
    assume $IsHeapAnchor($Heap);
    g#0 := $nw;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue88.dfy(14,8)
    assert {:id "id11"} g#0 != null;
    assert {:id "id12"} 0 <= LitInt(0) && LitInt(0) < _System.array.Length(g#0);
    assume true;
    assert {:id "id13"} $_ModifiesFrame[g#0, IndexField(LitInt(0))];
    assume true;
    $rhs#0 := LitInt(1);
    $Heap := update($Heap, g#0, IndexField(LitInt(0)), $Box($rhs#0));
    assume $IsGoodHeap($Heap);
}
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Main (correctness)"} Impl$$_module.__default.Main() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue88.dfy(19,5)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id16"} Call$$_module.__default.M2();
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue88.dfy(20,5)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id17"} Call$$_module.__default.M1();
    // TrCallStmt: After ProcessCallStmt
}
