...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@6 T@U) (|digits#0@@6| T@U) ) (!  (=> (or (|_module.__default.trim#canCall| |digits#0@@6|) (and (< 0 $FunctionContextHeight) ($Is SeqType |digits#0@@6| (TSeq TInt)))) ($Is SeqType (_module.__default.trim $ly@@6 |digits#0@@6|) (TSeq TInt)))
 :qid |NumberRepresentationsdfy.180:16|
 :skolemid |647|
 :pattern ( (_module.__default.trim $ly@@6 |digits#0@@6|))
))))
...
(declare-fun |digits#0@@7| () T@U)
(declare-fun |##digits#1@0| () T@U)
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.TrimPreservesValue)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (<= (LitInt 2) |base#0@@3|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and ($IsAlloc SeqType |digits#0@@7| (TSeq TInt) $Heap@0) ($IsAlloc intType (int_2_U |base#0@@3|) TInt $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 2) |base#0@@3|)) (=> (and (and (and (<= (LitInt 2) |base#0@@3|) (|_module.__default.eval#canCall| |digits#0@@7| |base#0@@3|)) (and ($IsAlloc SeqType |digits#0@@7| (TSeq TInt) $Heap@0) (|_module.__default.trim#canCall| |digits#0@@7|))) (and (and (= |##digits#1@0| (_module.__default.trim ($LS $LZ) |digits#0@@7|)) ($IsAlloc SeqType |##digits#1@0| (TSeq TInt) $Heap@0)) (and ($IsAlloc intType (int_2_U |base#0@@3|) TInt $Heap@0) (= (ControlFlow 0 2) (- 0 1))))) (<= (LitInt 2) |base#0@@3|)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |digits#0@@7| (TSeq TInt)) ($IsAlloc SeqType |digits#0@@7| (TSeq TInt) $Heap)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
