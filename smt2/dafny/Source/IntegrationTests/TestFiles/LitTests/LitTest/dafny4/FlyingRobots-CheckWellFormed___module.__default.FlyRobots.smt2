...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) ($o@@40 T@U) ($f@@2 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@40 $f@@2))  (=> (and (or (not (= $o@@40 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@40) |l#2|)))) (or (|Set#IsMember| |l#3| ($Box refType $o@@40)) (|Set#IsMember| |l#4| ($Box refType $o@@40)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |861|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@40 $f@@2))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.FlyRobots)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 32) (let ((anon7_correct  (and (=> (= (ControlFlow 0 2) (- 0 9)) (or (not (= |b0#0| null)) (not true))) (=> (or (not (= |b0#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |b0#0|) Tclass._module.Bot? $Heap@0) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (U_2_bool (Lit boolType (bool_2_U true))) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 |b0#0|))) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 |b0#0|) (=> (and (|_module.Bot.robot__inv#canCall| $Heap@0 |b0#0|) (_module.Bot.robot__inv $Heap@0 |b0#0|)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= |b1#0| null)) (not true))) (=> (or (not (= |b1#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |b1#0|) Tclass._module.Bot? $Heap@0) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (U_2_bool (Lit boolType (bool_2_U true))) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 |b1#0|))) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 |b1#0|) (=> (and (|_module.Bot.robot__inv#canCall| $Heap@0 |b1#0|) (_module.Bot.robot__inv $Heap@0 |b1#0|)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |b0#0| null)) (not true))) (=> (or (not (= |b0#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |b0#0|) Tclass._module.Bot? $Heap@0) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (U_2_bool (Lit boolType (bool_2_U true))) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 |b0#0|))) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 |b0#0|) (=> (and (|_module.Bot.flying#canCall| $Heap@0 |b0#0|) (_module.Bot.flying $Heap@0 |b0#0|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |b1#0| null)) (not true))) (=> (or (not (= |b1#0| null)) (not true)) (=> (and (and ($IsAllocBox ($Box refType |b1#0|) Tclass._module.Bot? $Heap@0) (= (ControlFlow 0 2) (- 0 1))) (U_2_bool (Lit boolType (bool_2_U true)))) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 |b1#0|))))))))))))))))))))))))
(let ((anon9_Else_correct  (=> (and (=> (or (not (= |b0#0| |b1#0|)) (not true)) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |b0#0|) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |b1#0|) _module.Bot.Repr)))) (= (ControlFlow 0 13) 2)) anon7_correct)))
(let ((anon9_Then_correct  (=> (or (not (= |b0#0| |b1#0|)) (not true)) (and (=> (= (ControlFlow 0 10) (- 0 12)) (or (not (= |b0#0| null)) (not true))) (=> (or (not (= |b0#0| null)) (not true)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (or (not (= |b1#0| null)) (not true))) (=> (or (not (= |b1#0| null)) (not true)) (=> (and (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |b0#0|) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |b1#0|) _module.Bot.Repr))) (= (ControlFlow 0 10) 2)) anon7_correct))))))))
(let ((anon4_correct  (and (=> (= (ControlFlow 0 14) (- 0 24)) (or (not (= |b0#0| null)) (not true))) (=> (or (not (= |b0#0| null)) (not true)) (and (=> (= (ControlFlow 0 14) (- 0 23)) (or (not (= |b1#0| null)) (not true))) (=> (or (not (= |b1#0| null)) (not true)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@44 T@U) ) (!  (=> (and (or (not (= $o@@44 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@44) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@44) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@44)) (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b0#0|) _module.Bot.Repr)) ($Box refType $o@@44)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b1#0|) _module.Bot.Repr)) ($Box refType $o@@44)))))
 :qid |FlyingRobotsdfy.158:8|
 :skolemid |509|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@44))
)) ($HeapSucc $Heap@@8 $Heap@0))) (and (=> (= (ControlFlow 0 14) (- 0 22)) (or (not (= |b0#0| null)) (not true))) (=> (or (not (= |b0#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |b0#0|) Tclass._module.Bot? $Heap@0) (=> (and (|_module.Bot.Valid#canCall| $Heap@0 |b0#0|) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 |b0#0|)) (and (=> (= (ControlFlow 0 14) (- 0 21)) (or (not (= |b0#0| null)) (not true))) (=> (or (not (= |b0#0| null)) (not true)) (and (=> (= (ControlFlow 0 14) (- 0 20)) (or (not (= |b0#0| null)) (not true))) (=> (or (not (= |b0#0| null)) (not true)) (and (=> (= (ControlFlow 0 14) (- 0 19)) ($IsAlloc refType |b0#0| Tclass._module.Bot $Heap@@8)) (=> ($IsAlloc refType |b0#0| Tclass._module.Bot $Heap@@8) (=> (and (forall (($o@@45 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |b0#0|) _module.Bot.Repr)) ($Box refType $o@@45)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b0#0|) _module.Bot.Repr)) ($Box refType $o@@45)))) (or (not (= $o@@45 null)) (not true)))
 :qid |FlyingRobotsdfy.163:25|
 :skolemid |510|
 :pattern (  (or (not (= $o@@45 null)) (not true)))
)) (forall (($o@@46 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |b0#0|) _module.Bot.Repr)) ($Box refType $o@@46)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b0#0|) _module.Bot.Repr)) ($Box refType $o@@46)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@46) alloc)))))
 :qid |FlyingRobotsdfy.163:25|
 :skolemid |511|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@46) alloc)))
))) (and (=> (= (ControlFlow 0 14) (- 0 18)) (or (not (= |b1#0| null)) (not true))) (=> (or (not (= |b1#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |b1#0|) Tclass._module.Bot? $Heap@0) (=> (and (|_module.Bot.Valid#canCall| $Heap@0 |b1#0|) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 |b1#0|)) (and (=> (= (ControlFlow 0 14) (- 0 17)) (or (not (= |b1#0| null)) (not true))) (=> (or (not (= |b1#0| null)) (not true)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (or (not (= |b1#0| null)) (not true))) (=> (or (not (= |b1#0| null)) (not true)) (and (=> (= (ControlFlow 0 14) (- 0 15)) ($IsAlloc refType |b1#0| Tclass._module.Bot $Heap@@8)) (=> ($IsAlloc refType |b1#0| Tclass._module.Bot $Heap@@8) (=> (and (forall (($o@@47 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |b1#0|) _module.Bot.Repr)) ($Box refType $o@@47)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b1#0|) _module.Bot.Repr)) ($Box refType $o@@47)))) (or (not (= $o@@47 null)) (not true)))
 :qid |FlyingRobotsdfy.164:25|
 :skolemid |512|
 :pattern (  (or (not (= $o@@47 null)) (not true)))
)) (forall (($o@@48 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |b1#0|) _module.Bot.Repr)) ($Box refType $o@@48)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b1#0|) _module.Bot.Repr)) ($Box refType $o@@48)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@48) alloc)))))
 :qid |FlyingRobotsdfy.164:25|
 :skolemid |513|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 $o@@48) alloc)))
))) (and (=> (= (ControlFlow 0 14) 10) anon9_Then_correct) (=> (= (ControlFlow 0 14) 13) anon9_Else_correct)))))))))))))))))))))))))))))))
(let ((anon8_Else_correct  (=> (and (=> (or (not (= |b0#0| |b1#0|)) (not true)) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b0#0|) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b1#0|) _module.Bot.Repr)))) (= (ControlFlow 0 28) 14)) anon4_correct)))
(let ((anon8_Then_correct  (=> (or (not (= |b0#0| |b1#0|)) (not true)) (and (=> (= (ControlFlow 0 25) (- 0 27)) (or (not (= |b0#0| null)) (not true))) (=> (or (not (= |b0#0| null)) (not true)) (and (=> (= (ControlFlow 0 25) (- 0 26)) (or (not (= |b1#0| null)) (not true))) (=> (or (not (= |b1#0| null)) (not true)) (=> (and (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b0#0|) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b1#0|) _module.Bot.Repr))) (= (ControlFlow 0 25) 14)) anon4_correct))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@8 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b0#0|) _module.Bot.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |b1#0|) _module.Bot.Repr)))) (and (=> (= (ControlFlow 0 29) (- 0 31)) (or (not (= |b0#0| null)) (not true))) (=> (or (not (= |b0#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |b0#0|) Tclass._module.Bot? $Heap@@8) (=> (and (|_module.Bot.Valid#canCall| $Heap@@8 |b0#0|) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@@8 |b0#0|)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (or (not (= |b1#0| null)) (not true))) (=> (or (not (= |b1#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |b1#0|) Tclass._module.Bot? $Heap@@8) (=> (and (|_module.Bot.Valid#canCall| $Heap@@8 |b1#0|) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@@8 |b1#0|)) (and (=> (= (ControlFlow 0 29) 25) anon8_Then_correct) (=> (= (ControlFlow 0 29) 28) anon8_Else_correct)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@8) ($IsHeapAnchor $Heap@@8)) (and ($Is refType |b0#0| Tclass._module.Bot) ($IsAlloc refType |b0#0| Tclass._module.Bot $Heap@@8))) (and (and ($Is refType |b1#0| Tclass._module.Bot) ($IsAlloc refType |b1#0| Tclass._module.Bot $Heap@@8)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 32) 29)))) anon0_correct)))
