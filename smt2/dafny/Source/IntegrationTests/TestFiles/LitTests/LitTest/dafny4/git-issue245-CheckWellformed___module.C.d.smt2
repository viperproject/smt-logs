...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let (($generated@@151  (=> (= (ControlFlow 0 5) (- 0 4)) (< ($generated@@25 $generated@@146 $generated@@147) (+ 8 $generated@@147)))))
