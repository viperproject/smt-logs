...
(assert (forall (($h0 T@U) ($h1 T@U) (this@@4 T@U) (|x#0@@4| Int) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@4 null)) (not true)) ($Is refType this@@4 Tclass._module.VariousArrows))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@0 T@U) ($f T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (= $o@@0 this@@4)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@0) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@0) $f)))
 :qid |unknown.0:0|
 :skolemid |549|
)) (= (_module.VariousArrows.G_k $h0 this@@4 |x#0@@4|) (_module.VariousArrows.G_k $h1 this@@4 |x#0@@4|))))
...
(assert (forall (($h0@@0 T@U) ($h1@@0 T@U) (this@@18 T@U) (|x#0@@18| Int) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (and (or (not (= this@@18 null)) (not true)) ($Is refType this@@18 Tclass._module.VariousArrows))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@3 T@U) ($f@@1 T@U) ) (! true
 :qid |unknown.0:0|
 :skolemid |539|
)) (= (_module.VariousArrows.F_k_k $h0@@0 this@@18 |x#0@@18|) (_module.VariousArrows.F_k_k $h1@@0 this@@18 |x#0@@18|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |540|
...
(set-info :boogie-vc-id Impl$$_module.VariousArrows.Tests)
