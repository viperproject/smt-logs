...
(declare-fun _module.__default.Inc (Int) Int)
...
(declare-fun |_module.__default.Inc#Handle| () T@U)
(declare-fun Requires1 (T@U T@U T@U T@U T@U) Bool)
(declare-fun |_module.__default.Inc#requires| (Int) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0| Int) ) (!  (=> (or (|_module.__default.Inc#canCall| |x#0|) (< 0 $FunctionContextHeight)) (= (_module.__default.Inc |x#0|) (+ |x#0| 2)))
 :qid |Bug107dfy.9:14|
 :skolemid |488|
 :pattern ( (_module.__default.Inc |x#0|))
))))
...
(assert (forall (($heap T@U) (|$fh$0x#0| Int) ) (! (= (_module.__default.Inc |$fh$0x#0|) (U_2_int ($Unbox intType (Apply1 TInt TInt $heap |_module.__default.Inc#Handle| ($Box intType (int_2_U |$fh$0x#0|))))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |485|
 :pattern ( (_module.__default.Inc |$fh$0x#0|) ($IsGoodHeap $heap))
)))
(assert (forall (($heap@@0 T@U) (|$fh$0x#0@@0| T@U) ) (! (= (Requires1 TInt TInt $heap@@0 |_module.__default.Inc#Handle| |$fh$0x#0@@0|) (|_module.__default.Inc#requires| (U_2_int ($Unbox intType |$fh$0x#0@@0|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |483|
 :pattern ( (Requires1 TInt TInt $heap@@0 |_module.__default.Inc#Handle| |$fh$0x#0@@0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@0| Int) ) (!  (=> (or (|_module.__default.Inc#canCall| (LitInt |x#0@@0|)) (< 0 $FunctionContextHeight)) (= (_module.__default.Inc (LitInt |x#0@@0|)) (LitInt (+ |x#0@@0| 2))))
 :qid |Bug107dfy.9:14|
 :weight 3
 :skolemid |489|
 :pattern ( (_module.__default.Inc (LitInt |x#0@@0|)))
))))
(assert (forall (($bx T@U) ($heap@@1 T@U) (|$fh$0x#0@@1| T@U) ) (! (= (|Set#IsMember| (Reads1 TInt TInt $heap@@1 |_module.__default.Inc#Handle| |$fh$0x#0@@1|) $bx) false)
 :qid |unknown.0:0|
 :skolemid |484|
 :pattern ( (|Set#IsMember| (Reads1 TInt TInt $heap@@1 |_module.__default.Inc#Handle| |$fh$0x#0@@1|) $bx))
)))
...
(assert (forall (($heap@@2 T@U) (|$fh$0x#0@@2| T@U) ) (! (= (Apply1 TInt TInt $heap@@2 |_module.__default.Inc#Handle| |$fh$0x#0@@2|) ($Box intType (int_2_U (_module.__default.Inc (U_2_int ($Unbox intType |$fh$0x#0@@2|))))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |482|
 :pattern ( (Apply1 TInt TInt $heap@@2 |_module.__default.Inc#Handle| |$fh$0x#0@@2|))
)))
(assert (forall ((|x#0@@1| Int) ) (! (= (|_module.__default.Inc#requires| |x#0@@1|) true)
 :qid |Bug107dfy.9:14|
 :skolemid |487|
 :pattern ( (|_module.__default.Inc#requires| |x#0@@1|))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= 0 $FunctionContextHeight)) (not true)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
