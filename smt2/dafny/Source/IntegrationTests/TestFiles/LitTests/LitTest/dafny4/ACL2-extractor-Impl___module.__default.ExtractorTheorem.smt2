...
(declare-fun _module._default.ExtractorTheorem$T () T@U)
...
(declare-fun |mp##0_1_0@0| () T@U)
(declare-fun $Heap@1 () T@U)
(declare-fun |##n#0_1_1@0| () Int)
(declare-fun |##xs#0_1_2@0| () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $Heap@@6 () T@U)
(declare-fun |##n#1@0| () Int)
(declare-fun |##mp#1@0| () T@U)
(declare-fun |a#0| () T@U)
(declare-fun |b#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.ExtractorTheorem)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 26) (let ((anon22_Else_correct  (=> (and (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5)) (and (= $Heap@0 $Heap@5) reveal__module._default.nth)) (and (=> (= (ControlFlow 0 16) (- 0 18)) (<= (LitInt 0) |i#2_0@0|)) (=> (<= (LitInt 0) |i#2_0@0|) (and (=> (= (ControlFlow 0 16) (- 0 17)) (< |i#2_0@0| (_module.__default.length _module._default.ExtractorTheorem$T ($LS ($LS $LZ)) |xs#0@@22|))) (=> (< |i#2_0@0| (_module.__default.length _module._default.ExtractorTheorem$T ($LS ($LS $LZ)) |xs#0@@22|)) (=> (and ($IsGoodHeap $Heap@6) ($IsHeapAnchor $Heap@6)) (=> (and (and (and (and (and (and (|_module.__default.length#canCall| _module._default.ExtractorTheorem$T |xs#0@@22|) (|_module.__default.nats#canCall| (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|))) (|_module.__default.xtr#canCall| _module._default.ExtractorTheorem$T (_module.__default.nats ($LS $LZ) (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|)) |xs#0@@22|)) (|_module.__default.nth#canCall| _module._default.ExtractorTheorem$T |i#2_0@0| (_module.__default.xtr _module._default.ExtractorTheorem$T ($LS $LZ) (_module.__default.nats ($LS $LZ) (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|)) |xs#0@@22|))) (and (|_module.__default.rev#canCall| _module._default.ExtractorTheorem$T |xs#0@@22|) (|_module.__default.nth#canCall| _module._default.ExtractorTheorem$T |i#2_0@0| (_module.__default.rev _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|)))) (= (_module.__default.nth _module._default.ExtractorTheorem$T reveal__module._default.nth |i#2_0@0| (_module.__default.xtr _module._default.ExtractorTheorem$T ($LS ($LS $LZ)) (_module.__default.nats ($LS ($LS $LZ)) (_module.__default.length _module._default.ExtractorTheorem$T ($LS ($LS $LZ)) |xs#0@@22|)) |xs#0@@22|)) (_module.__default.nth _module._default.ExtractorTheorem$T reveal__module._default.nth |i#2_0@0| (_module.__default.rev _module._default.ExtractorTheorem$T ($LS ($LS $LZ)) |xs#0@@22|)))) (and (= $Heap@5 $Heap@6) (= (ControlFlow 0 16) (- 0 15)))) (= (_module.__default.nth _module._default.ExtractorTheorem$T reveal__module._default.nth |i#2_0@0| |$rhs#0@0|) (_module.__default.nth _module._default.ExtractorTheorem$T reveal__module._default.nth |i#2_0@0| |$rhs#1@0|)))))))))))
(let ((anon22_Then_correct true))
(let ((anon10_correct  (=> (=> (<= (LitInt 0) |i#2_0@0|) (|_module.__default.length#canCall| _module._default.ExtractorTheorem$T |xs#0@@22|)) (=> (and (<= (LitInt 0) |i#2_0@0|) (< |i#2_0@0| (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|))) (and (=> (= (ControlFlow 0 19) 14) anon22_Then_correct) (=> (= (ControlFlow 0 19) 16) anon22_Else_correct))))))
(let ((anon21_Else_correct  (=> (and (< |i#2_0@0| (LitInt 0)) (= (ControlFlow 0 21) 19)) anon10_correct)))
(let ((anon21_Then_correct  (=> (and (and (<= (LitInt 0) |i#2_0@0|) ($IsAlloc DatatypeTypeType |xs#0@@22| (Tclass._module.List _module._default.ExtractorTheorem$T) $Heap@0)) (and (|_module.__default.length#canCall| _module._default.ExtractorTheorem$T |xs#0@@22|) (= (ControlFlow 0 20) 19))) anon10_correct)))
(let ((anon20_Then_correct  (and (=> (= (ControlFlow 0 22) 20) anon21_Then_correct) (=> (= (ControlFlow 0 22) 21) anon21_Else_correct))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 10) (- 0 9)) (|_module.List#Equal| (_module.__default.xtr _module._default.ExtractorTheorem$T ($LS ($LS $LZ)) (_module.__default.nats ($LS ($LS $LZ)) (_module.__default.length _module._default.ExtractorTheorem$T ($LS ($LS $LZ)) |xs#0@@22|)) |xs#0@@22|) (_module.__default.rev _module._default.ExtractorTheorem$T ($LS ($LS $LZ)) |xs#0@@22|)))))
(let ((anon20_Else_correct  (=> (forall ((|i#2_1| Int) ) (!  (=> (and (<= (LitInt 0) |i#2_1|) (< |i#2_1| (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|))) (= (_module.__default.nth _module._default.ExtractorTheorem$T reveal__module._default.nth |i#2_1| |$rhs#0@0|) (_module.__default.nth _module._default.ExtractorTheorem$T reveal__module._default.nth |i#2_1| |$rhs#1@0|)))
 :qid |ACL2extractordfy.75:10|
 :skolemid |594|
 :pattern ( (_module.__default.nth _module._default.ExtractorTheorem$T reveal__module._default.nth |i#2_1| |$rhs#1@0|))
 :pattern ( (_module.__default.nth _module._default.ExtractorTheorem$T reveal__module._default.nth |i#2_1| |$rhs#0@0|))
)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (= (_module.__default.length _module._default.ExtractorTheorem$T ($LS ($LS $LZ)) |$rhs#0@0|) (_module.__default.length _module._default.ExtractorTheorem$T ($LS ($LS $LZ)) |$rhs#1@0|))) (=> (= (_module.__default.length _module._default.ExtractorTheorem$T ($LS ($LS $LZ)) |$rhs#0@0|) (_module.__default.length _module._default.ExtractorTheorem$T ($LS ($LS $LZ)) |$rhs#1@0|)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((|i#1| Int) ) (!  (=> (and (<= (LitInt 0) |i#1|) (< |i#1| (_module.__default.length _module._default.ExtractorTheorem$T ($LS ($LS $LZ)) |$rhs#0@0|))) (= (_module.__default.nth _module._default.ExtractorTheorem$T reveal__module._default.nth |i#1| |$rhs#0@0|) (_module.__default.nth _module._default.ExtractorTheorem$T reveal__module._default.nth |i#1| |$rhs#1@0|)))
 :qid |ACL2extractordfy.122:19|
 :skolemid |602|
 :pattern ( (_module.__default.nth _module._default.ExtractorTheorem$T reveal__module._default.nth |i#1| |$rhs#1@0|))
 :pattern ( (_module.__default.nth _module._default.ExtractorTheorem$T reveal__module._default.nth |i#1| |$rhs#0@0|))
))) (=> (forall ((|i#1@@0| Int) ) (!  (=> (and (<= (LitInt 0) |i#1@@0|) (< |i#1@@0| (_module.__default.length _module._default.ExtractorTheorem$T ($LS ($LS $LZ)) |$rhs#0@0|))) (= (_module.__default.nth _module._default.ExtractorTheorem$T reveal__module._default.nth |i#1@@0| |$rhs#0@0|) (_module.__default.nth _module._default.ExtractorTheorem$T reveal__module._default.nth |i#1@@0| |$rhs#1@0|)))
 :qid |ACL2extractordfy.122:19|
 :skolemid |602|
 :pattern ( (_module.__default.nth _module._default.ExtractorTheorem$T reveal__module._default.nth |i#1@@0| |$rhs#1@0|))
 :pattern ( (_module.__default.nth _module._default.ExtractorTheorem$T reveal__module._default.nth |i#1@@0| |$rhs#0@0|))
)) (=> (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (=> (and (and (and (|$IsA#_module.List| |$rhs#0@0|) (|$IsA#_module.List| |$rhs#1@0|)) (|_module.List#Equal| |$rhs#0@0| |$rhs#1@0|)) (and (= $Heap@0 $Heap@4) (= (ControlFlow 0 11) 10))) GeneratedUnifiedExit_correct)))))))))
(let ((anon19_Else_correct  (=> (= (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|) (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |$rhs#1@0|)) (and (=> (= (ControlFlow 0 23) 22) anon20_Then_correct) (=> (= (ControlFlow 0 23) 11) anon20_Else_correct)))))
(let ((anon19_Then_correct  (=> ($IsAlloc DatatypeTypeType |xs#0@@22| (Tclass._module.List _module._default.ExtractorTheorem$T) $Heap@0) (=> (and (and (|_module.__default.length#canCall| _module._default.ExtractorTheorem$T |xs#0@@22|) (|_module.__default.length#canCall| _module._default.ExtractorTheorem$T |xs#0@@22|)) (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3))) (=> (and (and (and (and (|_module.__default.rev#canCall| _module._default.ExtractorTheorem$T |xs#0@@22|) (|_module.__default.length#canCall| _module._default.ExtractorTheorem$T (_module.__default.rev _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|))) (|_module.__default.length#canCall| _module._default.ExtractorTheorem$T |xs#0@@22|)) (and (= (_module.__default.length _module._default.ExtractorTheorem$T ($LS ($LS $LZ)) (_module.__default.rev _module._default.ExtractorTheorem$T ($LS ($LS $LZ)) |xs#0@@22|)) (_module.__default.length _module._default.ExtractorTheorem$T ($LS ($LS $LZ)) |xs#0@@22|)) (= $Heap@0 $Heap@3))) (and (and ($IsAlloc DatatypeTypeType |$rhs#1@0| (Tclass._module.List _module._default.ExtractorTheorem$T) $Heap@3) (|_module.__default.length#canCall| _module._default.ExtractorTheorem$T |$rhs#1@0|)) (and (|_module.__default.length#canCall| _module._default.ExtractorTheorem$T |$rhs#1@0|) (= (ControlFlow 0 8) (- 0 7))))) (= (_module.__default.length _module._default.ExtractorTheorem$T ($LS ($LS $LZ)) |xs#0@@22|) (_module.__default.length _module._default.ExtractorTheorem$T ($LS ($LS $LZ)) |$rhs#1@0|)))))))
(let ((anon18_Then_correct true))
(let ((anon17_Else_correct  (=> (= (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |$rhs#0@0|) (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|)) (and (and (=> (= (ControlFlow 0 24) 6) anon18_Then_correct) (=> (= (ControlFlow 0 24) 8) anon19_Then_correct)) (=> (= (ControlFlow 0 24) 23) anon19_Else_correct)))))
(let ((anon17_Then_correct  (=> (and (and (and ($IsAlloc DatatypeTypeType |xs#0@@22| (Tclass._module.List _module._default.ExtractorTheorem$T) $Heap@0) (|_module.__default.length#canCall| _module._default.ExtractorTheorem$T |xs#0@@22|)) (and (= |##n#0_0_0@0| (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|)) ($IsAlloc intType (int_2_U |##n#0_0_0@0|) Tclass._System.nat $Heap@0))) (and (and (|_module.__default.nats#canCall| (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|)) (= |##xs#0_0_0@0| (_module.__default.nats ($LS $LZ) (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|)))) (and ($IsAlloc DatatypeTypeType |##xs#0_0_0@0| (Tclass._module.List TInt) $Heap@0) (|_module.__default.length#canCall| TInt (_module.__default.nats ($LS $LZ) (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|)))))) (=> (and (and (and (and (and (|_module.__default.length#canCall| _module._default.ExtractorTheorem$T |xs#0@@22|) (|_module.__default.nats#canCall| (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|))) (|_module.__default.length#canCall| TInt (_module.__default.nats ($LS $LZ) (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|)))) (and ($IsAlloc DatatypeTypeType |xs#0@@22| (Tclass._module.List _module._default.ExtractorTheorem$T) $Heap@0) (|_module.__default.length#canCall| _module._default.ExtractorTheorem$T |xs#0@@22|))) (and (and (|_module.__default.length#canCall| _module._default.ExtractorTheorem$T |xs#0@@22|) (= |n##0_0_0@0| (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|))) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)))) (and (and (and (|_module.__default.nats#canCall| |n##0_0_0@0|) (|_module.__default.length#canCall| TInt (_module.__default.nats ($LS $LZ) |n##0_0_0@0|))) (and (= (_module.__default.length TInt ($LS ($LS $LZ)) (_module.__default.nats ($LS ($LS $LZ)) |n##0_0_0@0|)) |n##0_0_0@0|) (= $Heap@0 $Heap@2))) (and (and ($IsAlloc DatatypeTypeType |xs#0@@22| (Tclass._module.List _module._default.ExtractorTheorem$T) $Heap@2) (|_module.__default.length#canCall| _module._default.ExtractorTheorem$T |xs#0@@22|)) (and (|_module.__default.length#canCall| _module._default.ExtractorTheorem$T |xs#0@@22|) (= (ControlFlow 0 5) (- 0 4)))))) (= (_module.__default.length TInt ($LS ($LS $LZ)) (_module.__default.nats ($LS ($LS $LZ)) (_module.__default.length _module._default.ExtractorTheorem$T ($LS ($LS $LZ)) |xs#0@@22|))) (_module.__default.length _module._default.ExtractorTheorem$T ($LS ($LS $LZ)) |xs#0@@22|))))))
(let ((anon16_Then_correct  (=> (and (and (and ($IsAlloc DatatypeTypeType |$rhs#0@0| (Tclass._module.List _module._default.ExtractorTheorem$T) $Heap@0) (|_module.__default.length#canCall| _module._default.ExtractorTheorem$T |$rhs#0@0|)) (and (|_module.__default.length#canCall| _module._default.ExtractorTheorem$T |$rhs#0@0|) ($IsAlloc DatatypeTypeType |xs#0@@22| (Tclass._module.List _module._default.ExtractorTheorem$T) $Heap@0))) (and (and (|_module.__default.length#canCall| _module._default.ExtractorTheorem$T |xs#0@@22|) (= |##n#0_1_0@0| (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|))) (and ($IsAlloc intType (int_2_U |##n#0_1_0@0|) Tclass._System.nat $Heap@0) (|_module.__default.nats#canCall| (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|))))) (=> (and (and (and (and (and (|_module.__default.length#canCall| _module._default.ExtractorTheorem$T |xs#0@@22|) (|_module.__default.nats#canCall| (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|))) (= |mp##0_1_0@0| (_module.__default.nats ($LS $LZ) (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|)))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1))) (and (and (and (|_module.__default.xtr#canCall| _module._default.ExtractorTheorem$T |mp##0_1_0@0| |xs#0@@22|) (|_module.__default.length#canCall| _module._default.ExtractorTheorem$T (_module.__default.xtr _module._default.ExtractorTheorem$T ($LS $LZ) |mp##0_1_0@0| |xs#0@@22|))) (|_module.__default.length#canCall| TInt |mp##0_1_0@0|)) (and (= (_module.__default.length _module._default.ExtractorTheorem$T ($LS ($LS $LZ)) (_module.__default.xtr _module._default.ExtractorTheorem$T ($LS ($LS $LZ)) |mp##0_1_0@0| |xs#0@@22|)) (_module.__default.length TInt ($LS ($LS $LZ)) |mp##0_1_0@0|)) (= $Heap@0 $Heap@1)))) (and (and (and (and ($IsAlloc DatatypeTypeType |xs#0@@22| (Tclass._module.List _module._default.ExtractorTheorem$T) $Heap@1) (|_module.__default.length#canCall| _module._default.ExtractorTheorem$T |xs#0@@22|)) (and (= |##n#0_1_1@0| (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|)) ($IsAlloc intType (int_2_U |##n#0_1_1@0|) Tclass._System.nat $Heap@1))) (and (and (|_module.__default.nats#canCall| (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|)) (= |##xs#0_1_2@0| (_module.__default.nats ($LS $LZ) (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|)))) (and ($IsAlloc DatatypeTypeType |##xs#0_1_2@0| (Tclass._module.List TInt) $Heap@1) (|_module.__default.length#canCall| TInt (_module.__default.nats ($LS $LZ) (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|)))))) (and (and (and (|_module.__default.length#canCall| _module._default.ExtractorTheorem$T |xs#0@@22|) (|_module.__default.nats#canCall| (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|))) (|_module.__default.length#canCall| TInt (_module.__default.nats ($LS $LZ) (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|)))) (= (ControlFlow 0 3) (- 0 2))))) (= (_module.__default.length _module._default.ExtractorTheorem$T ($LS ($LS $LZ)) |$rhs#0@0|) (_module.__default.length TInt ($LS ($LS $LZ)) (_module.__default.nats ($LS ($LS $LZ)) (_module.__default.length _module._default.ExtractorTheorem$T ($LS ($LS $LZ)) |xs#0@@22|))))))))
(let ((anon15_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (|$IsA#_module.List| |xs#0@@22|)) (=> (and (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@6 $Heap@0)) (and (forall ((|$ih#xs0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#xs0#0| (Tclass._module.List _module._default.ExtractorTheorem$T)) (U_2_bool (Lit boolType (bool_2_U true)))) (< (DtRank |$ih#xs0#0|) (DtRank |xs#0@@22|))) (|_module.List#Equal| (_module.__default.xtr _module._default.ExtractorTheorem$T ($LS $LZ) (_module.__default.nats ($LS $LZ) (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |$ih#xs0#0|)) |$ih#xs0#0|) (_module.__default.rev _module._default.ExtractorTheorem$T ($LS $LZ) |$ih#xs0#0|)))
 :qid |ACL2extractordfy.59:31|
 :skolemid |588|
 :pattern ( (_module.__default.rev _module._default.ExtractorTheorem$T ($LS $LZ) |$ih#xs0#0|))
 :pattern ( (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |$ih#xs0#0|))
)) ($IsAlloc DatatypeTypeType |xs#0@@22| (Tclass._module.List _module._default.ExtractorTheorem$T) $Heap@0))) (and (and (and (|_module.__default.length#canCall| _module._default.ExtractorTheorem$T |xs#0@@22|) (= |##n#1@0| (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|))) (and ($IsAlloc intType (int_2_U |##n#1@0|) Tclass._System.nat $Heap@0) (|_module.__default.nats#canCall| (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|)))) (and (and (= |##mp#1@0| (_module.__default.nats ($LS $LZ) (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|))) ($IsAlloc DatatypeTypeType |##mp#1@0| (Tclass._module.List TInt) $Heap@0)) (and ($IsAlloc DatatypeTypeType |xs#0@@22| (Tclass._module.List _module._default.ExtractorTheorem$T) $Heap@0) (|_module.__default.xtr#canCall| _module._default.ExtractorTheorem$T (_module.__default.nats ($LS $LZ) (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|)) |xs#0@@22|))))) (and (and (and (and (|_module.__default.length#canCall| _module._default.ExtractorTheorem$T |xs#0@@22|) (|_module.__default.nats#canCall| (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|))) (|_module.__default.xtr#canCall| _module._default.ExtractorTheorem$T (_module.__default.nats ($LS $LZ) (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|)) |xs#0@@22|)) (= |$rhs#0@0| (_module.__default.xtr _module._default.ExtractorTheorem$T ($LS $LZ) (_module.__default.nats ($LS $LZ) (_module.__default.length _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|)) |xs#0@@22|))) (and (and ($IsAlloc DatatypeTypeType |xs#0@@22| (Tclass._module.List _module._default.ExtractorTheorem$T) $Heap@0) (|_module.__default.rev#canCall| _module._default.ExtractorTheorem$T |xs#0@@22|)) (and (|_module.__default.rev#canCall| _module._default.ExtractorTheorem$T |xs#0@@22|) (= |$rhs#1@0| (_module.__default.rev _module._default.ExtractorTheorem$T ($LS $LZ) |xs#0@@22|)))))) (and (and (and (=> (= (ControlFlow 0 25) 1) anon15_Then_correct) (=> (= (ControlFlow 0 25) 3) anon16_Then_correct)) (=> (= (ControlFlow 0 25) 5) anon17_Then_correct)) (=> (= (ControlFlow 0 25) 24) anon17_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and (and ($Is DatatypeTypeType |xs#0@@22| (Tclass._module.List _module._default.ExtractorTheorem$T)) ($IsAlloc DatatypeTypeType |xs#0@@22| (Tclass._module.List _module._default.ExtractorTheorem$T) $Heap@@6)) (|$IsA#_module.List| |xs#0@@22|)) (and (and ($Is DatatypeTypeType |a#0| (Tclass._module.List _module._default.ExtractorTheorem$T)) ($IsAlloc DatatypeTypeType |a#0| (Tclass._module.List _module._default.ExtractorTheorem$T) $Heap@@6)) true)) (and (and (and ($Is DatatypeTypeType |b#0| (Tclass._module.List _module._default.ExtractorTheorem$T)) ($IsAlloc DatatypeTypeType |b#0| (Tclass._module.List _module._default.ExtractorTheorem$T) $Heap@@6)) true) (and (= 8 $FunctionContextHeight) (= (ControlFlow 0 26) 25)))) anon0_correct))))
