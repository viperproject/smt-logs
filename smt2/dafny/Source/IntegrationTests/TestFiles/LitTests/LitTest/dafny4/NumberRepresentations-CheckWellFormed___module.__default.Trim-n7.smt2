...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.TrimProperty)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon4_Else_correct  (=> (not (|Seq#Equal| |a#0| |Seq#Empty|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |a#0|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |a#0|))) (=> (= (ControlFlow 0 3) (- 0 2)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |a#0|)))))))))
(let ((anon4_Then_correct true))
(let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) ($IsAlloc SeqType |a#0| (TSeq TInt) $Heap)) (and (|_module.__default.trim#canCall| |a#0|) (|Seq#Equal| |a#0| (_module.__default.trim ($LS $LZ) |a#0|)))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0))) (and (=> (= (ControlFlow 0 5) 1) anon4_Then_correct) (=> (= (ControlFlow 0 5) 3) anon4_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |a#0| (TSeq TInt)) ($IsAlloc SeqType |a#0| (TSeq TInt) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 5))) anon0_correct))))
