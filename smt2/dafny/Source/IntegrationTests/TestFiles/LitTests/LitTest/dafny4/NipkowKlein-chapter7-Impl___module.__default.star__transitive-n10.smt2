...
(declare-fun |s1#1| () T@U)
(declare-fun |c2#1| () T@U)
(declare-fun |s2#1| () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.star__transitive__aux_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (_module.__default.small__step__star ($LS $LZ) |c1#1@@0| |s1#1| |c2#1| |s2#1|) (=> (|_module.__default.small__step__star#canCall| |c0#1@@0| |s0#1| |c2#1| |s2#1|) (or (_module.__default.small__step__star ($LS $LZ) |c0#1@@0| |s0#1| |c2#1| |s2#1|) (or (and (|_module.com#Equal| |c0#1@@0| |c2#1|) (|Map#Equal| |s0#1| |s2#1|)) (exists ((|c''#5@@2| T@U) (|s''#5@@2| T@U) ) (!  (and (and ($Is DatatypeTypeType |c''#5@@2| Tclass._module.com) ($Is MapType |s''#5@@2| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS ($LS $LZ)) |c0#1@@0| |s0#1| |c''#5@@2| |s''#5@@2|) (_module.__default.small__step__star ($LS ($LS $LZ)) |c''#5@@2| |s''#5@@2| |c2#1| |s2#1|)))
 :qid |NipkowKleinchapter7dfy.229:10|
 :skolemid |1158|
 :pattern ( (_module.__default.small__step__star ($LS ($LS $LZ)) |c''#5@@2| |s''#5@@2| |c2#1| |s2#1|))
 :pattern ( (_module.__default.small__step ($LS ($LS $LZ)) |c0#1@@0| |s0#1| |c''#5@@2| |s''#5@@2|))
)))))))))
(let ((anon6_Else_correct  (=> (and (not (_module.__default.small__step__star_h ($LS $LZ) (|ORD#Minus| |_k#0@@15| (|ORD#FromNat| 1)) |c1#1@@0| |s1#1| |c2#1| |s2#1|)) (= (ControlFlow 0 5) 2)) GeneratedUnifiedExit_correct)))
(let ((anon6_Then_correct  (=> (and (_module.__default.small__step__star_h ($LS $LZ) (|ORD#Minus| |_k#0@@15| (|ORD#FromNat| 1)) |c1#1@@0| |s1#1| |c2#1| |s2#1|) (= (ControlFlow 0 4) 2)) GeneratedUnifiedExit_correct)))
(let ((anon5_Then_correct  (=> (< 0 (|ORD#Offset| |_k#0@@15|)) (and (=> (= (ControlFlow 0 6) (- 0 8)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@15|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@15|)) (=> (and (and (and (= |##_k#0@0| (|ORD#Minus| |_k#0@@15| (|ORD#FromNat| 1))) ($IsAlloc BoxType |##_k#0@0| TORDINAL $Heap@0)) (and ($IsAlloc DatatypeTypeType |c1#1@@0| Tclass._module.com $Heap@0) ($IsAlloc MapType |s1#1| (TMap (TSeq TChar) TInt) $Heap@0))) (and (and ($IsAlloc DatatypeTypeType |c2#1| Tclass._module.com $Heap@0) ($IsAlloc MapType |s2#1| (TMap (TSeq TChar) TInt) $Heap@0)) (and (|_module.__default.small__step__star_h#canCall| (|ORD#Minus| |_k#0@@15| (|ORD#FromNat| 1)) |c1#1@@0| |s1#1| |c2#1| |s2#1|) (|_module.__default.small__step__star_h#canCall| (|ORD#Minus| |_k#0@@15| (|ORD#FromNat| 1)) |c1#1@@0| |s1#1| |c2#1| |s2#1|)))) (and (=> (= (ControlFlow 0 6) 4) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct))))))))))
(let ((anon5_Else_correct  (=> (<= (|ORD#Offset| |_k#0@@15|) 0) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1)) (and (forall ((|_k'#2@@3| T@U) (|c0#2@@0| T@U) (|s0#2| T@U) (|c1#2@@0| T@U) (|s1#2| T@U) (|c2#2| T@U) (|s2#2| T@U) ) (!  (=> (and (and (and (and (and (and ($Is DatatypeTypeType |c0#2@@0| Tclass._module.com) ($Is MapType |s0#2| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c1#2@@0| Tclass._module.com)) ($Is MapType |s1#2| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c2#2| Tclass._module.com)) ($Is MapType |s2#2| (TMap (TSeq TChar) TInt))) (and (|ORD#Less| |_k'#2@@3| |_k#0@@15|) (_module.__default.small__step__star_h ($LS $LZ) |_k'#2@@3| |c0#2@@0| |s0#2| |c1#2@@0| |s1#2|))) (=> (_module.__default.small__step__star ($LS $LZ) |c1#2@@0| |s1#2| |c2#2| |s2#2|) (_module.__default.small__step__star ($LS $LZ) |c0#2@@0| |s0#2| |c2#2| |s2#2|)))
 :qid |NipkowKleinchapter7dfy.239:13|
 :skolemid |1161|
 :pattern ( (_module.__default.small__step__star ($LS $LZ) |c0#2@@0| |s0#2| |c2#2| |s2#2|) (_module.__default.small__step__star ($LS $LZ) |c1#2@@0| |s1#2| |c2#2| |s2#2|) (|ORD#Less| |_k'#2@@3| |_k#0@@15|))
 :pattern ( (_module.__default.small__step__star ($LS $LZ) |c1#2@@0| |s1#2| |c2#2| |s2#2|) (_module.__default.small__step__star_h ($LS $LZ) |_k'#2@@3| |c0#2@@0| |s0#2| |c1#2@@0| |s1#2|))
)) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct))))
(let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.com| |c0#1@@0|)) (and (|$IsA#_module.com| |c1#1@@0|) (|$IsA#_module.com| |c2#1|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#_k0#0| T@U) (|$ih#c00#0| T@U) (|$ih#s00#0| T@U) (|$ih#c10#0| T@U) (|$ih#s10#0| T@U) (|$ih#c20#0| T@U) (|$ih#s20#0| T@U) ) (!  (=> (and (and (and (and (and (and (and ($Is DatatypeTypeType |$ih#c00#0| Tclass._module.com) ($Is MapType |$ih#s00#0| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |$ih#c10#0| Tclass._module.com)) ($Is MapType |$ih#s10#0| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |$ih#c20#0| Tclass._module.com)) ($Is MapType |$ih#s20#0| (TMap (TSeq TChar) TInt))) (_module.__default.small__step__star_h ($LS $LZ) |$ih#_k0#0| |$ih#c00#0| |$ih#s00#0| |$ih#c10#0| |$ih#s10#0|)) (or (|ORD#Less| |$ih#_k0#0| |_k#0@@15|) (and (= |$ih#_k0#0| |_k#0@@15|) (or (< (DtRank |$ih#c00#0|) (DtRank |c0#1@@0|)) (and (= (DtRank |$ih#c00#0|) (DtRank |c0#1@@0|)) (or (and (|Set#Subset| (|Map#Domain| |$ih#s00#0|) (|Map#Domain| |s0#1|)) (not (|Set#Subset| (|Map#Domain| |s0#1|) (|Map#Domain| |$ih#s00#0|)))) (and (|Set#Equal| (|Map#Domain| |$ih#s00#0|) (|Map#Domain| |s0#1|)) (or (< (DtRank |$ih#c10#0|) (DtRank |c1#1@@0|)) (and (= (DtRank |$ih#c10#0|) (DtRank |c1#1@@0|)) (or (and (|Set#Subset| (|Map#Domain| |$ih#s10#0|) (|Map#Domain| |s1#1|)) (not (|Set#Subset| (|Map#Domain| |s1#1|) (|Map#Domain| |$ih#s10#0|)))) (and (|Set#Equal| (|Map#Domain| |$ih#s10#0|) (|Map#Domain| |s1#1|)) (or (< (DtRank |$ih#c20#0|) (DtRank |c2#1|)) (and (= (DtRank |$ih#c20#0|) (DtRank |c2#1|)) (and (|Set#Subset| (|Map#Domain| |$ih#s20#0|) (|Map#Domain| |s2#1|)) (not (|Set#Subset| (|Map#Domain| |s2#1|) (|Map#Domain| |$ih#s20#0|))))))))))))))))) (=> (_module.__default.small__step__star ($LS $LZ) |$ih#c10#0| |$ih#s10#0| |$ih#c20#0| |$ih#s20#0|) (_module.__default.small__step__star ($LS $LZ) |$ih#c00#0| |$ih#s00#0| |$ih#c20#0| |$ih#s20#0|)))
 :qid |NipkowKleinchapter7dfy.239:13|
 :skolemid |1160|
 :pattern ( (_module.__default.small__step__star ($LS $LZ) |$ih#c10#0| |$ih#s10#0| |$ih#c20#0| |$ih#s20#0|) (_module.__default.small__step__star_h ($LS $LZ) |$ih#_k0#0| |$ih#c00#0| |$ih#s00#0| |$ih#c10#0| |$ih#s10#0|))
))))) (and (=> (= (ControlFlow 0 9) 6) anon5_Then_correct) (=> (= (ControlFlow 0 9) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |c0#1@@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |c0#1@@0| Tclass._module.com $Heap)) (|$IsA#_module.com| |c0#1@@0|)) (and ($Is MapType |s0#1| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |s0#1| (TMap (TSeq TChar) TInt) $Heap))) (=> (and (and (and (and (and ($Is DatatypeTypeType |c1#1@@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |c1#1@@0| Tclass._module.com $Heap)) (|$IsA#_module.com| |c1#1@@0|)) (and ($Is MapType |s1#1| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |s1#1| (TMap (TSeq TChar) TInt) $Heap))) (and (and ($Is DatatypeTypeType |c2#1| Tclass._module.com) ($IsAlloc DatatypeTypeType |c2#1| Tclass._module.com $Heap)) (|$IsA#_module.com| |c2#1|))) (and (and (and ($Is MapType |s2#1| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |s2#1| (TMap (TSeq TChar) TInt) $Heap)) (= 7 $FunctionContextHeight)) (and (and (|_module.__default.small__step__star_h#canCall| |_k#0@@15| |c0#1@@0| |s0#1| |c1#1@@0| |s1#1|) (and (_module.__default.small__step__star_h ($LS $LZ) |_k#0@@15| |c0#1@@0| |s0#1| |c1#1@@0| |s1#1|) (and (=> (< 0 (|ORD#Offset| |_k#0@@15|)) (or (and (|_module.com#Equal| |c0#1@@0| |c1#1@@0|) (|Map#Equal| |s0#1| |s1#1|)) (exists ((|c''#4@@2| T@U) (|s''#4@@2| T@U) ) (!  (and (and ($Is DatatypeTypeType |c''#4@@2| Tclass._module.com) ($Is MapType |s''#4@@2| (TMap (TSeq TChar) TInt))) (and (_module.__default.small__step ($LS $LZ) |c0#1@@0| |s0#1| |c''#4@@2| |s''#4@@2|) (_module.__default.small__step__star_h ($LS $LZ) (|ORD#Minus| |_k#0@@15| (|ORD#FromNat| 1)) |c''#4@@2| |s''#4@@2| |c1#1@@0| |s1#1|)))
 :qid |NipkowKleinchapter7dfy.229:10|
 :skolemid |1156|
 :pattern ( (_module.__default.small__step__star_h ($LS $LZ) (|ORD#Minus| |_k#0@@15| (|ORD#FromNat| 1)) |c''#4@@2| |s''#4@@2| |c1#1@@0| |s1#1|))
 :pattern ( (_module.__default.small__step ($LS $LZ) |c0#1@@0| |s0#1| |c''#4@@2| |s''#4@@2|))
)))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@15|)) (exists ((|_k'#1@@3| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#1@@3| |_k#0@@15|) (_module.__default.small__step__star_h ($LS $LZ) |_k'#1@@3| |c0#1@@0| |s0#1| |c1#1@@0| |s1#1|))
 :qid |NipkowKleinchapter7dfy.226:17|
 :skolemid |1157|
 :pattern ( (_module.__default.small__step__star_h ($LS $LZ) |_k'#1@@3| |c0#1@@0| |s0#1| |c1#1@@0| |s1#1|))
