...
(set-info :boogie-vc-id Impl$$_module.__default.GcdSubtractAlt_split2)
...
))))) (and (and (and (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (= $Heap@0 $Heap@3)) (and reveal__module._default.Gcd ($IsAlloc intType (int_2_U |y#0@@3|) Tclass._module.pos $Heap@3))) (and (and ($IsAlloc intType (int_2_U |x#0@@10|) Tclass._module.pos $Heap@3) (|_module.__default.Gcd#canCall| |y#0@@3| |x#0@@10|)) (and ($IsAlloc intType (int_2_U |x#0@@10|) Tclass._module.pos $Heap@3) (= (ControlFlow 0 2) (- 0 1))))))) ($Is intType (int_2_U (- |y#0@@3| |x#0@@10|)) Tclass._module.pos))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
