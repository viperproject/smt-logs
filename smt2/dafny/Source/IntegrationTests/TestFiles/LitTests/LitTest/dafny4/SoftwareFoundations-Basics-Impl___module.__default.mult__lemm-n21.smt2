...
(declare-fun |##n#0_0_1_0@0| () T@U)
(declare-fun |##n#0_0_1_3@0| () T@U)
(declare-fun |##n#0_0_1_2@0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.mult__lemma_split6)
...
)) (or (not (= |m#0@@7| |#_module.Nat.O|)) (not true)))) (and (and (= |m#0@@7| (|#_module.Nat.S| |_mcc#0#0_0@0|)) ($Is DatatypeTypeType |_mcc#0#0_0@0| Tclass._module.Nat)) (and ($Is DatatypeTypeType |m'#0_0@0| Tclass._module.Nat) ($IsAlloc DatatypeTypeType |m'#0_0@0| Tclass._module.Nat $Heap@0)))) (and (and (and (= |let#0_0#0#0| |_mcc#0#0_0@0|) ($Is DatatypeTypeType |let#0_0#0#0| Tclass._module.Nat)) (and (= |m'#0_0@0| |let#0_0#0#0|) ($IsAlloc DatatypeTypeType |m'#0_0@0| Tclass._module.Nat $Heap@0))) (and (and ($IsAlloc DatatypeTypeType |m'#0_0@0| Tclass._module.Nat $Heap@0) (|_module.__default.plus#canCall| |m'#0_0@0| |m'#0_0@0|)) (and (= |##n#0_0_1_0@0| (|#_module.Nat.S| (|#_module.Nat.S| (_module.__default.plus ($LS $LZ) |m'#0_0@0| |m'#0_0@0|)))) ($IsAlloc DatatypeTypeType |##n#0_0_1_0@0| Tclass._module.Nat $Heap@0))))) (and (and (and (and ($IsAlloc DatatypeTypeType |n#0@@7| Tclass._module.Nat $Heap@0) (|_module.__default.mult#canCall| (|#_module.Nat.S| (|#_module.Nat.S| (_module.__default.plus ($LS $LZ) |m'#0_0@0| |m'#0_0@0|))) |n#0@@7|)) (and (|_module.__default.plus#canCall| |m'#0_0@0| |m'#0_0@0|) (|_module.__default.mult#canCall| (|#_module.Nat.S| (|#_module.Nat.S| (_module.__default.plus ($LS $LZ) |m'#0_0@0| |m'#0_0@0|))) |n#0@@7|))) (and (and (= |##n#0_0_1_3@0| (|#_module.Nat.S| |m'#0_0@0|)) ($IsAlloc DatatypeTypeType |##n#0_0_1_3@0| Tclass._module.Nat $Heap@0)) (and ($IsAlloc DatatypeTypeType |m'#0_0@0| Tclass._module.Nat $Heap@0) (|_module.__default.plus#canCall| (|#_module.Nat.S| |m'#0_0@0|) |m'#0_0@0|)))) (and (and (and (= |##n#0_0_1_2@0| (|#_module.Nat.S| (_module.__default.plus ($LS $LZ) (|#_module.Nat.S| |m'#0_0@0|) |m'#0_0@0|))) ($IsAlloc DatatypeTypeType |##n#0_0_1_2@0| Tclass._module.Nat $Heap@0)) (and ($IsAlloc DatatypeTypeType |n#0@@7| Tclass._module.Nat $Heap@0) (|_module.__default.mult#canCall| (|#_module.Nat.S| (_module.__default.plus ($LS $LZ) (|#_module.Nat.S| |m'#0_0@0|) |m'#0_0@0|)) |n#0@@7|))) (and (and (|_module.__default.plus#canCall| (|#_module.Nat.S| |m'#0_0@0|) |m'#0_0@0|) (|_module.__default.mult#canCall| (|#_module.Nat.S| (_module.__default.plus ($LS $LZ) (|#_module.Nat.S| |m'#0_0@0|) |m'#0_0@0|)) |n#0@@7|)) (= (ControlFlow 0 2) (- 0 1)))))) (|_module.Nat#Equal| (_module.__default.mult ($LS ($LS $LZ)) (|#_module.Nat.S| (|#_module.Nat.S| (_module.__default.plus ($LS ($LS $LZ)) |m'#0_0@0| |m'#0_0@0|))) |n#0@@7|) (_module.__default.mult ($LS ($LS $LZ)) (|#_module.Nat.S| (_module.__default.plus ($LS ($LS $LZ)) (|#_module.Nat.S| |m'#0_0@0|) |m'#0_0@0|)) |n#0@@7|))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
