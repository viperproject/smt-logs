...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon8_Else_correct  (=> (or (not (= (|Seq#Length| |digits#0@@3|) (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 7)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |digits#0@@3|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |digits#0@@3|))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |digits#0@@3|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |digits#0@@3|))) (=> (= |##digits#0@0| (|Seq#Drop| |digits#0@@3| (LitInt 1))) (=> (and ($IsAlloc SeqType |##digits#0@0| (TSeq TInt) $Heap) ($IsAlloc intType (int_2_U |base#0@@3|) TInt $Heap)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= (LitInt 2) |base#0@@3|)) (=> (and (<= (LitInt 2) |base#0@@3|) (= (ControlFlow 0 4) (- 0 3))) (< (|Seq#Rank| |##digits#0@0|) (|Seq#Rank| |digits#0@@3|)))))))))))))
(let ((anon8_Then_correct true))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (<= (LitInt 2) |base#0@@3|)) (and (and (=> (= (ControlFlow 0 8) 1) anon7_Then_correct) (=> (= (ControlFlow 0 8) 2) anon8_Then_correct)) (=> (= (ControlFlow 0 8) 4) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is SeqType |digits#0@@3| (TSeq TInt))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct)))
