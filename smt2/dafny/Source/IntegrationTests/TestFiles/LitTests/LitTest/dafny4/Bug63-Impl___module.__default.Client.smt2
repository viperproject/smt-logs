...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon2_correct  (=> (and (forall ((|o#1| T@U) )  (=> (and ($Is refType |o#1| Tclass._System.object) ($IsAlloc refType |o#1| Tclass._System.object $Heap)) (U_2_bool (Lit boolType (bool_2_U false))))) (= (ControlFlow 0 2) (- 0 1))) (forall (($o@@2 T@U) ($f@@0 T@U) )  (=> (and (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) alloc)))) (and ($Is refType $o@@2 Tclass._System.object) (U_2_bool (Lit boolType (bool_2_U true))))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@2 $f@@0)))))))
