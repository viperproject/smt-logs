...
(declare-fun $Heap@0 () T@U)
(set-info :boogie-vc-id CheckWellFormed$$M0.Counter.Inc)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#2| null $Heap@@0 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) M0.Counter.Repr)))) ($IsAllocBox ($Box refType this@@1) Tclass.M0.Counter? $Heap@@0)) (and (|M0.Counter.Valid#canCall| $Heap@@0 this@@1) (M0.Counter.Valid $Heap@@0 this@@1))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@9 T@U) ) (!  (=> (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@9) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@9) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@9)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) M0.Counter.Repr)) ($Box refType $o@@9))))
 :qid |ClassRefinementdfy.22:12|
 :skolemid |509|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@9))
)) ($HeapSucc $Heap@@0 $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType this@@1 Tclass.M0.Counter $Heap@@0)) (=> ($IsAlloc refType this@@1 Tclass.M0.Counter $Heap@@0) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@1) M0.Counter.N))) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) M0.Counter.N))) 1)) (=> (and (and ($IsAllocBox ($Box refType this@@1) Tclass.M0.Counter? $Heap@0) (|M0.Counter.Valid#canCall| $Heap@0 this@@1)) (and (M0.Counter.Valid $Heap@0 this@@1) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this@@1 Tclass.M0.Counter $Heap@@0))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass.M0.Counter) ($IsAlloc refType this@@1 Tclass.M0.Counter $Heap@@0))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
