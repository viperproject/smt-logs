...
(declare-fun _module.__default.P1 (T@U T@U) Bool)
(declare-fun Lit (T@T T@U) T@U)
(declare-fun MapType () T@T)
(declare-fun |_module.__default.P1#canCall| (T@U T@U) Bool)
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|$w#1| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#44| |l#0| |l#1|) |$w#1|))  (and ($IsBox |$w#1| |l#0|) (|Set#IsMember| |l#1| |$w#1|)))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |529|
 :pattern ( (MapType0Select BoxType boolType (|lambda#44| |l#0| |l#1|) |$w#1|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module._default.P1$X T@U) (|m#0| T@U) ) (!  (=> (or (|_module.__default.P1#canCall| _module._default.P1$X (Lit MapType |m#0|)) (and (< 0 $FunctionContextHeight) (and ($Is MapType |m#0| (TMap _module._default.P1$X TBool)) (forall ((|x#2| T@U) ) (!  (=> ($IsBox |x#2| _module._default.P1$X) (=> (|Set#IsMember| (|Map#Domain| |m#0|) |x#2|) (U_2_bool ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType |m#0|)) |x#2|)))))
 :qid |Bug54dfy.17:19|
 :skolemid |508|
 :pattern ( ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |m#0|) |x#2|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| |m#0|) |x#2|))
))))) (= (_module.__default.P1 _module._default.P1$X (Lit MapType |m#0|)) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |509|
 :pattern ( (_module.__default.P1 _module._default.P1$X (Lit MapType |m#0|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|m#0@@0| T@U) ) (!  (=> (or (|_module.__default.P2#canCall| |m#0@@0|) (and (< 1 $FunctionContextHeight) (and ($Is MapType |m#0@@0| (TMap TInt TBool)) (forall ((|x#1| Int) ) (!  (=> (|Set#IsMember| (|Map#Domain| |m#0@@0|) ($Box intType (int_2_U |x#1|))) (U_2_bool ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@0|) ($Box intType (int_2_U |x#1|))))))
 :qid |Bug54dfy.23:19|
 :skolemid |513|
 :pattern ( ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@0|) ($Box intType (int_2_U |x#1|)))))
 :pattern ( (|Set#IsMember| (|Map#Domain| |m#0@@0|) ($Box intType (int_2_U |x#1|))))
))))) (and (|_module.__default.P1#canCall| TInt (|Map#Glue| (|Set#FromBoogieMap| (|lambda#44| TInt (|Map#Domain| |m#0@@0|))) (|lambda#45| ($Box boolType (Lit boolType (bool_2_U true)))) (TMap TInt TBool))) (= (_module.__default.P2 |m#0@@0|) (_module.__default.P1 TInt (|Map#Glue| (|Set#FromBoogieMap| (|lambda#44| TInt (|Map#Domain| |m#0@@0|))) (|lambda#45| ($Box boolType (Lit boolType (bool_2_U true)))) (TMap TInt TBool))))))
 :qid |Bug54dfy.22:20|
 :skolemid |515|
 :pattern ( (_module.__default.P2 |m#0@@0|))
))))
(assert (forall ((|l#0@@0| T@U) (|$w#1@@0| T@U) ) (! (= (MapType0Select BoxType BoxType (|lambda#45| |l#0@@0|) |$w#1@@0|) |l#0@@0|)
 :qid |Bug54dfy.25:6|
 :skolemid |530|
 :pattern ( (MapType0Select BoxType BoxType (|lambda#45| |l#0@@0|) |$w#1@@0|))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|m#0@@1| T@U) ) (!  (=> (or (|_module.__default.P2#canCall| (Lit MapType |m#0@@1|)) (and (< 1 $FunctionContextHeight) (and ($Is MapType |m#0@@1| (TMap TInt TBool)) (forall ((|x#3| Int) ) (!  (=> (|Set#IsMember| (|Map#Domain| |m#0@@1|) ($Box intType (int_2_U |x#3|))) (U_2_bool ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType |m#0@@1|)) ($Box intType (int_2_U |x#3|))))))
 :qid |Bug54dfy.23:19|
 :skolemid |516|
 :pattern ( ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@1|) ($Box intType (int_2_U |x#3|)))))
 :pattern ( (|Set#IsMember| (|Map#Domain| |m#0@@1|) ($Box intType (int_2_U |x#3|))))
))))) (and (|_module.__default.P1#canCall| TInt (|Map#Glue| (|Set#FromBoogieMap| (|lambda#44| TInt (|Map#Domain| |m#0@@1|))) (|lambda#45| ($Box boolType (Lit boolType (bool_2_U true)))) (TMap TInt TBool))) (= (_module.__default.P2 (Lit MapType |m#0@@1|)) (_module.__default.P1 TInt (|Map#Glue| (|Set#FromBoogieMap| (|lambda#44| TInt (|Map#Domain| |m#0@@1|))) (|lambda#45| ($Box boolType (Lit boolType (bool_2_U true)))) (TMap TInt TBool))))))
 :qid |Bug54dfy.22:20|
 :weight 3
 :skolemid |517|
 :pattern ( (_module.__default.P2 (Lit MapType |m#0@@1|)))
))))
...
(assert (forall ((|l#0@@1| T@U) (|l#1@@0| T@U) (|l#2| T@U) (|l#3| Bool) ($o T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#21| |l#0@@1| |l#1@@0| |l#2| |l#3|) $o $f))  (=> (and (or (not (= $o |l#0@@1|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1@@0| $o) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |528|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#21| |l#0@@1| |l#1@@0| |l#2| |l#3|) $o $f))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module._default.P1$X@@0 T@U) (|m#0@@2| T@U) ) (!  (=> (or (|_module.__default.P1#canCall| _module._default.P1$X@@0 |m#0@@2|) (and (< 0 $FunctionContextHeight) (and ($Is MapType |m#0@@2| (TMap _module._default.P1$X@@0 TBool)) (forall ((|x#1@@0| T@U) ) (!  (=> ($IsBox |x#1@@0| _module._default.P1$X@@0) (=> (|Set#IsMember| (|Map#Domain| |m#0@@2|) |x#1@@0|) (U_2_bool ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@2|) |x#1@@0|)))))
 :qid |Bug54dfy.17:19|
 :skolemid |505|
 :pattern ( ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@2|) |x#1@@0|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| |m#0@@2|) |x#1@@0|))
))))) (= (_module.__default.P1 _module._default.P1$X@@0 |m#0@@2|) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |unknown.0:0|
 :skolemid |507|
 :pattern ( (_module.__default.P1 _module._default.P1$X@@0 |m#0@@2|))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon9_correct  (=> (= |##m#0@0| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#44| TInt (|Map#Domain| |m#0@@3|))) (|lambda#45| ($Box boolType (Lit boolType (bool_2_U true)))) (TMap TInt TBool))) (=> (and ($IsAlloc MapType |##m#0@0| (TMap TInt TBool) $Heap) (= (ControlFlow 0 4) (- 0 3))) (forall ((|x#6| Int) ) (!  (=> (|Set#IsMember| (|Map#Domain| |##m#0@0|) ($Box intType (int_2_U |x#6|))) (U_2_bool ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |##m#0@0|) ($Box intType (int_2_U |x#6|))))))
 :qid |Bug54dfy.17:19|
 :skolemid |519|
 :pattern ( ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |##m#0@0|) ($Box intType (int_2_U |x#6|)))))
 :pattern ( (|Set#IsMember| (|Map#Domain| |##m#0@0|) ($Box intType (int_2_U |x#6|))))
))))))
(let ((anon14_Else_correct  (=> (and (not (|Set#IsMember| (|Map#Domain| |m#0@@3|) ($Box intType (int_2_U |x#5@0|)))) (= (ControlFlow 0 6) 4)) anon9_correct)))
(let ((anon14_Then_correct  (=> (and (|Set#IsMember| (|Map#Domain| |m#0@@3|) ($Box intType (int_2_U |x#5@0|))) (= (ControlFlow 0 5) 4)) anon9_correct)))
(let ((anon13_Then_correct  (and (=> (= (ControlFlow 0 7) 5) anon14_Then_correct) (=> (= (ControlFlow 0 7) 6) anon14_Else_correct))))
(let ((anon13_Else_correct true))
(let ((anon12_Then_correct true))
(let ((anon4_correct  (=> (forall ((|x#0| T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |m#0@@3|) ($Box intType |x#0|)) (U_2_bool ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@3|) ($Box intType |x#0|)))))
 :qid |Bug54dfy.23:19|
 :skolemid |518|
 :pattern ( ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@3|) ($Box intType |x#0|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| |m#0@@3|) ($Box intType |x#0|)))
)) (and (and (=> (= (ControlFlow 0 8) 1) anon12_Then_correct) (=> (= (ControlFlow 0 8) 7) anon13_Then_correct)) (=> (= (ControlFlow 0 8) 2) anon13_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (=> (|Set#IsMember| (|Map#Domain| |m#0@@3|) ($Box intType (int_2_U |x#4@0|))) (U_2_bool ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@3|) ($Box intType (int_2_U |x#4@0|)))))) (= (ControlFlow 0 11) 8)) anon4_correct)))
(let ((anon11_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |m#0@@3|) ($Box intType (int_2_U |x#4@0|))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (|Set#IsMember| (|Map#Domain| |m#0@@3|) ($Box intType (int_2_U |x#4@0|)))) (=> (|Set#IsMember| (|Map#Domain| |m#0@@3|) ($Box intType (int_2_U |x#4@0|))) (=> (and (U_2_bool ($Unbox boolType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@3|) ($Box intType (int_2_U |x#4@0|))))) (= (ControlFlow 0 9) 8)) anon4_correct))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#21| null $Heap alloc false)) (and (=> (= (ControlFlow 0 12) 9) anon11_Then_correct) (=> (= (ControlFlow 0 12) 11) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is MapType |m#0@@3| (TMap TInt TBool))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 13) 12))) anon0_correct)))
