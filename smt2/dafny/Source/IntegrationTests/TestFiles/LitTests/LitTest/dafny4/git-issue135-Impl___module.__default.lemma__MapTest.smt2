...
(assert (forall ((a@@4 T@U) (b@@0 T@U) ) (! (= (|Set#Equal| a@@4 b@@0) (forall ((o@@1 T@U) ) (! (= (|Set#IsMember| a@@4 o@@1) (|Set#IsMember| b@@0 o@@1))
...
(set-info :boogie-vc-id Impl$$_module.__default.lemma__MapTest)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon4_correct  (and (=> (= (ControlFlow 0 2) (- 0 6)) (= (|Map#Card| |m#0@0|) (|Set#Card| (|Map#Values| |m#0@0|)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= (|Set#Card| (|Map#Values| |m#0@0|)) (LitInt 1))) (=> (and (= (|Map#Card| |m#0@0|) (|Set#Card| (|Map#Values| |m#0@0|))) (= (|Set#Card| (|Map#Values| |m#0@0|)) (LitInt 1))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (LitInt 1) (LitInt 2))) (=> (= (LitInt 1) (LitInt 2)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (U_2_bool (Lit boolType (bool_2_U false)))) (=> (U_2_bool (Lit boolType (bool_2_U false))) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (Lit boolType (bool_2_U false)))))))))))))
(let ((anon6_Else_correct  (=> (and (or (not (= (|Map#Card| |m#0@0|) (|Set#Card| (|Map#Values| |m#0@0|)))) (not true)) (= (ControlFlow 0 8) 2)) anon4_correct)))
(let ((anon6_Then_correct  (=> (and (= (|Map#Card| |m#0@0|) (|Set#Card| (|Map#Values| |m#0@0|))) (= (ControlFlow 0 7) 2)) anon4_correct)))
(let ((anon2_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (= (|Map#Card| |m#0@0|) (|Set#Card| (|Map#Domain| |m#0@0|)))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (= (|Set#Card| (|Map#Domain| |m#0@0|)) (LitInt 2))) (=> (and (= (|Map#Card| |m#0@0|) (|Set#Card| (|Map#Domain| |m#0@0|))) (= (|Set#Card| (|Map#Domain| |m#0@0|)) (LitInt 2))) (and (=> (= (ControlFlow 0 9) 7) anon6_Then_correct) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct)))))))
(let ((anon5_Else_correct  (=> (and (or (not (= (|Map#Card| |m#0@0|) (|Set#Card| (|Map#Domain| |m#0@0|)))) (not true)) (= (ControlFlow 0 13) 9)) anon2_correct)))
(let ((anon5_Then_correct  (=> (and (= (|Map#Card| |m#0@0|) (|Set#Card| (|Map#Domain| |m#0@0|))) (= (ControlFlow 0 12) 9)) anon2_correct)))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |m#0@0| (Lit MapType (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 1))) ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 1))))))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (|Set#Equal| (|Map#Domain| |m#0@0|) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 2)))))) (=> (|Set#Equal| (|Map#Domain| |m#0@0|) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 2))))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (|Set#Equal| (|Map#Values| |m#0@0|) (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U (LitInt 1)))))) (=> (|Set#Equal| (|Map#Values| |m#0@0|) (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U (LitInt 1))))) (and (=> (= (ControlFlow 0 14) 12) anon5_Then_correct) (=> (= (ControlFlow 0 14) 13) anon5_Else_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |m#0| (TMap TInt TInt)) ($IsAlloc MapType |m#0| (TMap TInt TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 17) 14))) anon0_correct))))
