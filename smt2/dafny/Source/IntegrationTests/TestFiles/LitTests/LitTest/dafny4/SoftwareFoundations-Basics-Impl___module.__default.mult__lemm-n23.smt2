...
(declare-fun |##n#0_0_3_0@0| () T@U)
(declare-fun |##n#0_0_3_2@0| () T@U)
(declare-fun |##m#0_0_3_1@0| () T@U)
(declare-fun |##n#0_0_3_4@0| () T@U)
(declare-fun |c##0_0_3_0@0| () T@U)
(declare-fun $Heap@1 () T@U)
(declare-fun |##n#0_0_3_8@0| () T@U)
(declare-fun |##m#0_0_3_7@0| () T@U)
(declare-fun |##m#0_0_3_6@0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.mult__lemma_split8)
...
)) (or (not (= |m#0@@7| |#_module.Nat.O|)) (not true))) (and (= |m#0@@7| (|#_module.Nat.S| |_mcc#0#0_0@0|)) ($Is DatatypeTypeType |_mcc#0#0_0@0| Tclass._module.Nat))) (and (and ($Is DatatypeTypeType |m'#0_0@0| Tclass._module.Nat) ($IsAlloc DatatypeTypeType |m'#0_0@0| Tclass._module.Nat $Heap@0)) (and (= |let#0_0#0#0| |_mcc#0#0_0@0|) ($Is DatatypeTypeType |let#0_0#0#0| Tclass._module.Nat))))) (and (and (and (and (= |m'#0_0@0| |let#0_0#0#0|) ($IsAlloc DatatypeTypeType |n#0@@7| Tclass._module.Nat $Heap@0)) (and ($IsAlloc DatatypeTypeType |n#0@@7| Tclass._module.Nat $Heap@0) (|_module.__default.plus#canCall| |n#0@@7| |n#0@@7|))) (and (and (= |##n#0_0_3_0@0| (_module.__default.plus ($LS $LZ) |n#0@@7| |n#0@@7|)) ($IsAlloc DatatypeTypeType |##n#0_0_3_0@0| Tclass._module.Nat $Heap@0)) (and ($IsAlloc DatatypeTypeType |m'#0_0@0| Tclass._module.Nat $Heap@0) ($IsAlloc DatatypeTypeType |m'#0_0@0| Tclass._module.Nat $Heap@0)))) (and (and (and (|_module.__default.plus#canCall| |m'#0_0@0| |m'#0_0@0|) (= |##n#0_0_3_2@0| (_module.__default.plus ($LS $LZ) |m'#0_0@0| |m'#0_0@0|))) (and ($IsAlloc DatatypeTypeType |##n#0_0_3_2@0| Tclass._module.Nat $Heap@0) ($IsAlloc DatatypeTypeType |n#0@@7| Tclass._module.Nat $Heap@0))) (and (and (|_module.__default.mult#canCall| (_module.__default.plus ($LS $LZ) |m'#0_0@0| |m'#0_0@0|) |n#0@@7|) (= |##m#0_0_3_1@0| (_module.__default.mult ($LS $LZ) (_module.__default.plus ($LS $LZ) |m'#0_0@0| |m'#0_0@0|) |n#0@@7|))) (and ($IsAlloc DatatypeTypeType |##m#0_0_3_1@0| Tclass._module.Nat $Heap@0) (|_module.__default.plus#canCall| (_module.__default.plus ($LS $LZ) |n#0@@7| |n#0@@7|) (_module.__default.mult ($LS $LZ) (_module.__default.plus ($LS $LZ) |m'#0_0@0| |m'#0_0@0|) |n#0@@7|))))))) (=> (and (and (and (and (and (and (and (|_module.__default.plus#canCall| |n#0@@7| |n#0@@7|) (and (|_module.__default.plus#canCall| |m'#0_0@0| |m'#0_0@0|) (|_module.__default.mult#canCall| (_module.__default.plus ($LS $LZ) |m'#0_0@0| |m'#0_0@0|) |n#0@@7|))) (|_module.__default.plus#canCall| (_module.__default.plus ($LS $LZ) |n#0@@7| |n#0@@7|) (_module.__default.mult ($LS $LZ) (_module.__default.plus ($LS $LZ) |m'#0_0@0| |m'#0_0@0|) |n#0@@7|))) ($IsAlloc DatatypeTypeType |m'#0_0@0| Tclass._module.Nat $Heap@0)) (and ($IsAlloc DatatypeTypeType |m'#0_0@0| Tclass._module.Nat $Heap@0) (|_module.__default.plus#canCall| |m'#0_0@0| |m'#0_0@0|))) (and (and (= |##n#0_0_3_4@0| (_module.__default.plus ($LS $LZ) |m'#0_0@0| |m'#0_0@0|)) ($IsAlloc DatatypeTypeType |##n#0_0_3_4@0| Tclass._module.Nat $Heap@0)) (and ($IsAlloc DatatypeTypeType |n#0@@7| Tclass._module.Nat $Heap@0) (|_module.__default.mult#canCall| (_module.__default.plus ($LS $LZ) |m'#0_0@0| |m'#0_0@0|) |n#0@@7|)))) (and (and (and (and (|_module.__default.plus#canCall| |m'#0_0@0| |m'#0_0@0|) (|_module.__default.mult#canCall| (_module.__default.plus ($LS $LZ) |m'#0_0@0| |m'#0_0@0|) |n#0@@7|)) (= |c##0_0_3_0@0| (_module.__default.mult ($LS $LZ) (_module.__default.plus ($LS $LZ) |m'#0_0@0| |m'#0_0@0|) |n#0@@7|))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1))) (and (and (and (|$IsA#_module.Nat| (_module.__default.plus ($LS $LZ) (_module.__default.plus ($LS $LZ) |n#0@@7| |n#0@@7|) |c##0_0_3_0@0|)) (|$IsA#_module.Nat| (_module.__default.plus ($LS $LZ) |n#0@@7| (_module.__default.plus ($LS $LZ) |n#0@@7| |c##0_0_3_0@0|)))) (and (and (|_module.__default.plus#canCall| |n#0@@7| |n#0@@7|) (|_module.__default.plus#canCall| (_module.__default.plus ($LS $LZ) |n#0@@7| |n#0@@7|) |c##0_0_3_0@0|)) (and (|_module.__default.plus#canCall| |n#0@@7| |c##0_0_3_0@0|) (|_module.__default.plus#canCall| |n#0@@7| (_module.__default.plus ($LS $LZ) |n#0@@7| |c##0_0_3_0@0|))))) (|_module.Nat#Equal| (_module.__default.plus ($LS ($LS $LZ)) (_module.__default.plus ($LS ($LS $LZ)) |n#0@@7| |n#0@@7|) |c##0_0_3_0@0|) (_module.__default.plus ($LS ($LS $LZ)) |n#0@@7| (_module.__default.plus ($LS ($LS $LZ)) |n#0@@7| |c##0_0_3_0@0|)))))) (and (and (and (and (and (= $Heap@0 $Heap@1) ($IsAlloc DatatypeTypeType |n#0@@7| Tclass._module.Nat $Heap@1)) (and ($IsAlloc DatatypeTypeType |n#0@@7| Tclass._module.Nat $Heap@1) ($IsAlloc DatatypeTypeType |m'#0_0@0| Tclass._module.Nat $Heap@1))) (and (and ($IsAlloc DatatypeTypeType |m'#0_0@0| Tclass._module.Nat $Heap@1) (|_module.__default.plus#canCall| |m'#0_0@0| |m'#0_0@0|)) (and (= |##n#0_0_3_8@0| (_module.__default.plus ($LS $LZ) |m'#0_0@0| |m'#0_0@0|)) ($IsAlloc DatatypeTypeType |##n#0_0_3_8@0| Tclass._module.Nat $Heap@1)))) (and (and (and ($IsAlloc DatatypeTypeType |n#0@@7| Tclass._module.Nat $Heap@1) (|_module.__default.mult#canCall| (_module.__default.plus ($LS $LZ) |m'#0_0@0| |m'#0_0@0|) |n#0@@7|)) (and (= |##m#0_0_3_7@0| (_module.__default.mult ($LS $LZ) (_module.__default.plus ($LS $LZ) |m'#0_0@0| |m'#0_0@0|) |n#0@@7|)) ($IsAlloc DatatypeTypeType |##m#0_0_3_7@0| Tclass._module.Nat $Heap@1))) (and (and (|_module.__default.plus#canCall| |n#0@@7| (_module.__default.mult ($LS $LZ) (_module.__default.plus ($LS $LZ) |m'#0_0@0| |m'#0_0@0|) |n#0@@7|)) (= |##m#0_0_3_6@0| (_module.__default.plus ($LS $LZ) |n#0@@7| (_module.__default.mult ($LS $LZ) (_module.__default.plus ($LS $LZ) |m'#0_0@0| |m'#0_0@0|) |n#0@@7|)))) (and ($IsAlloc DatatypeTypeType |##m#0_0_3_6@0| Tclass._module.Nat $Heap@1) (|_module.__default.plus#canCall| |n#0@@7| (_module.__default.plus ($LS $LZ) |n#0@@7| (_module.__default.mult ($LS $LZ) (_module.__default.plus ($LS $LZ) |m'#0_0@0| |m'#0_0@0|) |n#0@@7|))))))) (and (and (and (and (|_module.__default.plus#canCall| |m'#0_0@0| |m'#0_0@0|) (|_module.__default.mult#canCall| (_module.__default.plus ($LS $LZ) |m'#0_0@0| |m'#0_0@0|) |n#0@@7|)) (|_module.__default.plus#canCall| |n#0@@7| (_module.__default.mult ($LS $LZ) (_module.__default.plus ($LS $LZ) |m'#0_0@0| |m'#0_0@0|) |n#0@@7|))) (|_module.__default.plus#canCall| |n#0@@7| (_module.__default.plus ($LS $LZ) |n#0@@7| (_module.__default.mult ($LS $LZ) (_module.__default.plus ($LS $LZ) |m'#0_0@0| |m'#0_0@0|) |n#0@@7|)))) (= (ControlFlow 0 2) (- 0 1))))) (|_module.Nat#Equal| (_module.__default.plus ($LS ($LS $LZ)) (_module.__default.plus ($LS ($LS $LZ)) |n#0@@7| |n#0@@7|) (_module.__default.mult ($LS ($LS $LZ)) (_module.__default.plus ($LS ($LS $LZ)) |m'#0_0@0| |m'#0_0@0|) |n#0@@7|)) (_module.__default.plus ($LS ($LS $LZ)) |n#0@@7| (_module.__default.plus ($LS ($LS $LZ)) |n#0@@7| (_module.__default.mult ($LS ($LS $LZ)) (_module.__default.plus ($LS ($LS $LZ)) |m'#0_0@0| |m'#0_0@0|) |n#0@@7|))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
