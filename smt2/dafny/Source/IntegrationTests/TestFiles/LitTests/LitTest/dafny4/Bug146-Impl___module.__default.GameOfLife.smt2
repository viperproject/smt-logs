...
)))) (and (and (forall ((|i#0_0_2@@0| Int) (|j#0_0_2@@0| Int) )  (=> (and (and (<= (LitInt 0) |i#0_0_2@@0|) (< |i#0_0_2@@0| |size#0|)) (and (<= (LitInt 0) |j#0_0_2@@0|) (< |j#0_0_2@@0| |size#0|))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (MultiIndexField (IndexField |i#0_0_2@@0|) |j#0_0_2@@0|)) ($Box boolType (Lit boolType (bool_2_U false)))))) ($IsAlloc refType $nw@0 (Tclass._System.array2 TBool) $Heap@2)) (and (|_module.__default.inhabited#canCall| $nw@0) (|_module.__default.inhabited#canCall| $nw@0)))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (=> (|_module.__default.inhabited#canCall| $nw@0) (or (_module.__default.inhabited $nw@0) (exists ((|i#0_0| Int) (|j#0_0| Int) ) (!  (and (and (and (<= (LitInt 0) |i#0_0|) (< |i#0_0| (_System.array2.Length0 $nw@0))) (and (<= (LitInt 0) |j#0_0|) (< |j#0_0| (_System.array2.Length1 $nw@0)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (MultiIndexField (IndexField |i#0_0|) |j#0_0|)))))
