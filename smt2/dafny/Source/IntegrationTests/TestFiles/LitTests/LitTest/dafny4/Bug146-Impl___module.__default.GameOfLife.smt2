...
(set-info :boogie-vc-id Impl$$_module.__default.GameOfLife)
...
(let ((anon21_Else_correct  (=> (and (not (_module.__default.inhabited $nw@0)) (= (ControlFlow 0 27) 25)) anon5_correct)))
(let ((anon21_Then_correct  (=> (and (_module.__default.inhabited $nw@0) (= (ControlFlow 0 26) 25)) anon5_correct)))
(let ((anon20_Then_correct  (=> (not |$w$loop#0@0|) (=> (and ($IsAlloc refType $nw@0 (Tclass._System.array2 TBool) $Heap@1) (|_module.__default.inhabited#canCall| $nw@0)) (and (=> (= (ControlFlow 0 28) 26) anon21_Then_correct) (=> (= (ControlFlow 0 28) 27) anon21_Else_correct))))))
...
(let ((anon24_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (and ($HeapSucc $Heap@1 $Heap@2) (forall (($o@@8 T@U) ($f@@0 T@U) ) (!  (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@8) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@8) $f@@0)) (exists ((|i#0_0_2| Int) (|j#0_0_2| Int) ) (!  (and (and (and (and (<= (LitInt 0) |i#0_0_2|) (< |i#0_0_2| |size#0|)) (and (<= (LitInt 0) |j#0_0_2|) (< |j#0_0_2| |size#0|))) (= $o@@8 $nw@0)) (= $f@@0 (MultiIndexField (IndexField |i#0_0_2|) |j#0_0_2|)))
 :qid |Bug146dfy.14:16|
 :skolemid |559|
)))
 :qid |Bug146dfy.14:9|
 :skolemid |560|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@8) $f@@0))
)))) (and (and (forall ((|i#0_0_2@@0| Int) (|j#0_0_2@@0| Int) ) (!  (=> (and (and (<= (LitInt 0) |i#0_0_2@@0|) (< |i#0_0_2@@0| |size#0|)) (and (<= (LitInt 0) |j#0_0_2@@0|) (< |j#0_0_2@@0| |size#0|))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (MultiIndexField (IndexField |i#0_0_2@@0|) |j#0_0_2@@0|)) ($Box boolType (Lit boolType (bool_2_U false)))))
 :qid |Bug146dfy.14:16|
 :skolemid |561|
)) ($IsAlloc refType $nw@0 (Tclass._System.array2 TBool) $Heap@2)) (and (|_module.__default.inhabited#canCall| $nw@0) (|_module.__default.inhabited#canCall| $nw@0)))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (=> (|_module.__default.inhabited#canCall| $nw@0) (or (_module.__default.inhabited $nw@0) (exists ((|i#0_0| Int) (|j#0_0| Int) ) (!  (and (and (and (<= (LitInt 0) |i#0_0|) (< |i#0_0| (_System.array2.Length0 $nw@0))) (and (<= (LitInt 0) |j#0_0|) (< |j#0_0| (_System.array2.Length1 $nw@0)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (MultiIndexField (IndexField |i#0_0|) |j#0_0|)))))
 :qid |Bug146dfy.6:12|
 :skolemid |562|
...
))))) (=> (and (_module.__default.inhabited $nw@0) (= |n#0@2| (+ |n#0@1| 1))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (<= 0 |$decr$loop#00@1|) (= (ite (_module.__default.inhabited $nw@0) (- |N#0| |n#0@2|) (- 0 1)) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (ite (_module.__default.inhabited $nw@0) (- |N#0| |n#0@2|) (- 0 1)) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 4) (- 0 3)) (< (ite (_module.__default.inhabited $nw@0) (- |N#0| |n#0@2|) (- 0 1)) |$decr$loop#00@1|)))))))))
(let ((anon23_Else_correct  (=> (and (and (_module.__default.inhabited $nw@0) (< |n#0@1| |N#0|)) (= |$decr$loop#00@1| (ite (_module.__default.inhabited $nw@0) (- |N#0| |n#0@1|) (- 0 1)))) (and (=> (= (ControlFlow 0 20) 19) anon24_Then_correct) (=> (= (ControlFlow 0 20) 4) anon24_Else_correct)))))
(let ((anon23_Then_correct true))
(let ((anon8_correct  (=> (|_module.__default.inhabited#canCall| $nw@0) (and (=> (= (ControlFlow 0 21) 2) anon23_Then_correct) (=> (= (ControlFlow 0 21) 20) anon23_Else_correct)))))
(let ((anon22_Else_correct  (=> (and (not (_module.__default.inhabited $nw@0)) (= (ControlFlow 0 23) 21)) anon8_correct)))
(let ((anon22_Then_correct  (=> (and (_module.__default.inhabited $nw@0) (= (ControlFlow 0 22) 21)) anon8_correct)))
(let ((anon20_Else_correct  (=> |$w$loop#0@0| (=> (and ($IsAlloc refType $nw@0 (Tclass._System.array2 TBool) $Heap@1) (|_module.__default.inhabited#canCall| $nw@0)) (and (=> (= (ControlFlow 0 24) 22) anon22_Then_correct) (=> (= (ControlFlow 0 24) 23) anon22_Else_correct))))))
...
(let ((anon19_LoopHead_correct  (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (not false) (<= 0 |n#0@1|))) (and (and (forall (($o@@9 T@U) ) (!  (=> (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@9) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@9) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@9)))
 :qid |Bug146dfy.13:5|
 :skolemid |557|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@9))
)) ($HeapSucc $Heap@0 $Heap@1)) (and (forall (($o@@10 T@U) ($f@@1 T@U) ) (!  (=> (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@10) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@10) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@10) $f@@1)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@10 $f@@1))))
 :qid |Bug146dfy.13:5|
 :skolemid |558|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@10) $f@@1))
)) (<= (ite (_module.__default.inhabited $nw@0) (- |N#0| |n#0@1|) (- 0 1)) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 30) 1) anon19_LoopDone_correct) (=> (= (ControlFlow 0 30) 29) anon19_LoopBody_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (and (=> (= (ControlFlow 0 31) (- 0 33)) (<= 0 |size#0|)) (=> (<= 0 |size#0|) (and (=> (= (ControlFlow 0 31) (- 0 32)) (<= 0 |size#0|)) (=> (<= 0 |size#0|) (=> (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array2? TBool))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0) alloc))))) (=> (and (and (and (= (_System.array2.Length0 $nw@0) |size#0|) (= (_System.array2.Length1 $nw@0) |size#0|)) (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0) alloc ($Box boolType (bool_2_U true))))) ($IsGoodHeap $Heap@0))) (and (and ($IsHeapAnchor $Heap@0) (= |n#0@0| (LitInt 0))) (and (= |$decr_init$loop#00@0| (ite (_module.__default.inhabited $nw@0) (- |N#0| |n#0@0|) (- 0 1))) (= (ControlFlow 0 31) 30)))) anon19_LoopHead_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (<= (LitInt 0) |size#0|) (<= (LitInt 0) |N#0|))) (=> (and (and (and (and ($Is refType |world#0@@1| (Tclass._System.array2 TBool)) ($IsAlloc refType |world#0@@1| (Tclass._System.array2 TBool) $Heap@@1)) true) (= 1 $FunctionContextHeight)) (and (< 0 |size#0|) (= (ControlFlow 0 34) 31))) anon0_correct))))
