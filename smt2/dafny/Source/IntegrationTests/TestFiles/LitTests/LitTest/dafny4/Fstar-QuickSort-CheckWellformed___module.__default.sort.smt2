...
(declare-fun _module.__default.sort (T@U Int Int T@U) T@U)
(declare-fun $LS (T@U) T@U)
(declare-fun |_module.__default.sort#canCall| (Int Int T@U) Bool)
...
(let ((|hd#1| (U_2_int ($Unbox intType (_module.List._h0 |i#0|)))))
 (and (|_module.__default.partition#canCall| |hd#1| |tl#1|) (let ((|hi#1| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.partition ($LS $LZ) |hd#1| |tl#1|)))))
(let ((|lo#1| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.partition ($LS $LZ) |hd#1| |tl#1|)))))
 (and (|_module.__default.sort#canCall| |min#0| |hd#1| |lo#1|) (let ((|i'#1| (_module.__default.sort $ly |min#0| |hd#1| |lo#1|)))
 (and (|_module.__default.sort#canCall| |hd#1| |max#0| |hi#1|) (let ((|j'#1| (_module.__default.sort $ly |hd#1| |max#0| |hi#1|)))
(|_module.__default.append#canCall| |min#0| |hd#1| |hd#1| |max#0| |i'#1| (|#_module.List.Cons| ($Box intType (int_2_U |hd#1|)) |j'#1|)))))))))))) (= (_module.__default.sort ($LS $ly) |min#0| |max#0| |i#0|) (ite (_module.List.Nil_q |i#0|) |#_module.List.Nil| (let ((|tl#0| (_module.List._h1 |i#0|)))
(let ((|hd#0| (U_2_int ($Unbox intType (_module.List._h0 |i#0|)))))
(let ((|hi#0| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.partition ($LS $LZ) |hd#0| |tl#0|)))))
(let ((|lo#0| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.partition ($LS $LZ) |hd#0| |tl#0|)))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@0 T@U) (|n0#0| Int) (|n1#0| Int) (|n2#0| Int) (|n3#0| Int) (|i#0@@0| T@U) (|j#0| T@U) ) (!  (=> (or (|_module.__default.append#canCall| (LitInt |n0#0|) (LitInt |n1#0|) (LitInt |n2#0|) (LitInt |n3#0|) (Lit DatatypeTypeType |i#0@@0|) (Lit DatatypeTypeType |j#0|)) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |i#0@@0| (Tclass._module.List TInt)) ($Is DatatypeTypeType |j#0| (Tclass._module.List TInt))) (and (and (and (<= (LitInt |n0#0|) (LitInt |n1#0|)) (<= (LitInt |n1#0|) (LitInt |n2#0|))) (<= (LitInt |n2#0|) (LitInt |n3#0|))) (U_2_bool (Lit boolType (bool_2_U  (and (_module.__default.SortedRange ($LS $LZ) (LitInt |n0#0|) (LitInt |n1#0|) (Lit DatatypeTypeType |i#0@@0|)) (_module.__default.SortedRange ($LS $LZ) (LitInt |n2#0|) (LitInt |n3#0|) (Lit DatatypeTypeType |j#0|)))))))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |i#0@@0|)))))) (let ((|tl#5| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |i#0@@0|)))))
(let ((|hd#5| (LitInt (U_2_int ($Unbox intType (_module.List._h0 (Lit DatatypeTypeType |i#0@@0|)))))))
...
(let ((|hd#3| (LitInt (U_2_int ($Unbox intType (_module.List._h0 (Lit DatatypeTypeType |list#0@@1|)))))))
...
(|_module.__default.partition#canCall| |x#0| |tl#1@@0|))) (= (_module.__default.partition ($LS $ly@@4) |x#0| |l#0|) (ite (_module.List.Nil_q |l#0|) (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.List.Nil|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.List.Nil|))) (let ((|tl#0@@0| (_module.List._h1 |l#0|)))
(let ((|hd#0@@0| (U_2_int ($Unbox intType (_module.List._h0 |l#0|)))))
...
(let ((|hd#5@@0| (LitInt (U_2_int ($Unbox intType (_module.List._h0 (Lit DatatypeTypeType |i#0@@1|)))))))
 (and (|_module.__default.partition#canCall| |hd#5@@0| |tl#5@@0|) (let ((|hi#5| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.partition ($LS $LZ) |hd#5@@0| |tl#5@@0|)))))
(let ((|lo#5| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.partition ($LS $LZ) |hd#5@@0| |tl#5@@0|)))))
 (and (|_module.__default.sort#canCall| (LitInt |min#0@@0|) |hd#5@@0| |lo#5|) (let ((|i'#5| (_module.__default.sort ($LS $ly@@5) (LitInt |min#0@@0|) |hd#5@@0| |lo#5|)))
 (and (|_module.__default.sort#canCall| |hd#5@@0| (LitInt |max#0@@0|) |hi#5|) (let ((|j'#5| (_module.__default.sort ($LS $ly@@5) |hd#5@@0| (LitInt |max#0@@0|) |hi#5|)))
(|_module.__default.append#canCall| (LitInt |min#0@@0|) |hd#5@@0| |hd#5@@0| (LitInt |max#0@@0|) |i'#5| (|#_module.List.Cons| ($Box intType (int_2_U |hd#5@@0|)) |j'#5|)))))))))))) (= (_module.__default.sort ($LS $ly@@5) (LitInt |min#0@@0|) (LitInt |max#0@@0|) (Lit DatatypeTypeType |i#0@@1|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |i#0@@1|)) |#_module.List.Nil| (let ((|tl#4@@0| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |i#0@@1|)))))
(let ((|hd#4@@0| (LitInt (U_2_int ($Unbox intType (_module.List._h0 (Lit DatatypeTypeType |i#0@@1|)))))))
(let ((|hi#4| ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (_module.__default.partition ($LS $LZ) |hd#4@@0| |tl#4@@0|))))))
(let ((|lo#4| ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (_module.__default.partition ($LS $LZ) |hd#4@@0| |tl#4@@0|))))))
...
(let ((|hd#3@@0| (LitInt (U_2_int ($Unbox intType (_module.List._h0 (Lit DatatypeTypeType |i#0@@2|)))))))
 (and (|_module.__default.partition#canCall| |hd#3@@0| |tl#3@@1|) (let ((|hi#3| ($Unbox DatatypeTypeType (_System.Tuple2._1 (_module.__default.partition ($LS $LZ) |hd#3@@0| |tl#3@@1|)))))
(let ((|lo#3| ($Unbox DatatypeTypeType (_System.Tuple2._0 (_module.__default.partition ($LS $LZ) |hd#3@@0| |tl#3@@1|)))))
 (and (|_module.__default.sort#canCall| |min#0@@1| |hd#3@@0| |lo#3|) (let ((|i'#3| (_module.__default.sort ($LS $ly@@6) |min#0@@1| |hd#3@@0| |lo#3|)))
 (and (|_module.__default.sort#canCall| |hd#3@@0| |max#0@@1| |hi#3|) (let ((|j'#3| (_module.__default.sort ($LS $ly@@6) |hd#3@@0| |max#0@@1| |hi#3|)))
(|_module.__default.append#canCall| |min#0@@1| |hd#3@@0| |hd#3@@0| |max#0@@1| |i'#3| (|#_module.List.Cons| ($Box intType (int_2_U |hd#3@@0|)) |j'#3|)))))))))))) (= (_module.__default.sort ($LS $ly@@6) |min#0@@1| |max#0@@1| (Lit DatatypeTypeType |i#0@@2|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |i#0@@2|)) |#_module.List.Nil| (let ((|tl#2@@1| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |i#0@@2|)))))
(let ((|hd#2@@0| (LitInt (U_2_int ($Unbox intType (_module.List._h0 (Lit DatatypeTypeType |i#0@@2|)))))))
(let ((|hi#2| ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (_module.__default.partition ($LS $LZ) |hd#2@@0| |tl#2@@1|))))))
(let ((|lo#2| ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (_module.__default.partition ($LS $LZ) |hd#2@@0| |tl#2@@1|))))))
...
(let ((|hd#5@@1| (LitInt (U_2_int ($Unbox intType (_module.List._h0 (Lit DatatypeTypeType |list#0@@2|)))))))
...
(|_module.__default.partition#canCall| (LitInt |x#0@@4|) |tl#3@@2|))) (= (_module.__default.partition ($LS $ly@@16) (LitInt |x#0@@4|) (Lit DatatypeTypeType |l#0@@2|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |l#0@@2|)) (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.List.Nil|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.List.Nil|))) (let ((|tl#2@@2| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |l#0@@2|)))))
(let ((|hd#2@@1| (LitInt (U_2_int ($Unbox intType (_module.List._h0 (Lit DatatypeTypeType |l#0@@2|)))))))
...
(let ((|hd#1@@0| (U_2_int ($Unbox intType (_module.List._h0 |list#0@@8|)))))
...
(let ((|hd#1@@1| (U_2_int ($Unbox intType (_module.List._h0 |i#0@@7|)))))
...
(let ((|hd#3@@1| (LitInt (U_2_int ($Unbox intType (_module.List._h0 (Lit DatatypeTypeType |i#0@@8|)))))))
...
(declare-fun |min#0@@4| () Int)
(declare-fun |max#0@@4| () Int)
(declare-fun |i#0@@9| () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 50) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 13) (- 0 17)) (=> (|_module.__default.SortedRange#canCall| |min#0@@4| |max#0@@4| (_module.__default.sort ($LS $LZ) |min#0@@4| |max#0@@4| |i#0@@9|)) (or (_module.__default.SortedRange ($LS $LZ) |min#0@@4| |max#0@@4| (_module.__default.sort ($LS $LZ) |min#0@@4| |max#0@@4| |i#0@@9|)) (=> (_module.List.Nil_q (_module.__default.sort ($LS $LZ) |min#0@@4| |max#0@@4| |i#0@@9|)) (<= |min#0@@4| |max#0@@4|))))) (=> (=> (|_module.__default.SortedRange#canCall| |min#0@@4| |max#0@@4| (_module.__default.sort ($LS $LZ) |min#0@@4| |max#0@@4| |i#0@@9|)) (or (_module.__default.SortedRange ($LS $LZ) |min#0@@4| |max#0@@4| (_module.__default.sort ($LS $LZ) |min#0@@4| |max#0@@4| |i#0@@9|)) (=> (_module.List.Nil_q (_module.__default.sort ($LS $LZ) |min#0@@4| |max#0@@4| |i#0@@9|)) (<= |min#0@@4| |max#0@@4|)))) (and (=> (= (ControlFlow 0 13) (- 0 16)) (=> (|_module.__default.SortedRange#canCall| |min#0@@4| |max#0@@4| (_module.__default.sort ($LS $LZ) |min#0@@4| |max#0@@4| |i#0@@9|)) (or (_module.__default.SortedRange ($LS $LZ) |min#0@@4| |max#0@@4| (_module.__default.sort ($LS $LZ) |min#0@@4| |max#0@@4| |i#0@@9|)) (=> (not (_module.List.Nil_q (_module.__default.sort ($LS $LZ) |min#0@@4| |max#0@@4| |i#0@@9|))) (let ((|hd#6| (U_2_int ($Unbox intType (_module.List._h0 (_module.__default.sort ($LS ($LS $LZ)) |min#0@@4| |max#0@@4| |i#0@@9|))))))
(<= |min#0@@4| |hd#6|)))))) (=> (=> (|_module.__default.SortedRange#canCall| |min#0@@4| |max#0@@4| (_module.__default.sort ($LS $LZ) |min#0@@4| |max#0@@4| |i#0@@9|)) (or (_module.__default.SortedRange ($LS $LZ) |min#0@@4| |max#0@@4| (_module.__default.sort ($LS $LZ) |min#0@@4| |max#0@@4| |i#0@@9|)) (=> (not (_module.List.Nil_q (_module.__default.sort ($LS $LZ) |min#0@@4| |max#0@@4| |i#0@@9|))) (let ((|hd#6@@0| (U_2_int ($Unbox intType (_module.List._h0 (_module.__default.sort ($LS ($LS $LZ)) |min#0@@4| |max#0@@4| |i#0@@9|))))))
(<= |min#0@@4| |hd#6@@0|))))) (and (=> (= (ControlFlow 0 13) (- 0 15)) (=> (|_module.__default.SortedRange#canCall| |min#0@@4| |max#0@@4| (_module.__default.sort ($LS $LZ) |min#0@@4| |max#0@@4| |i#0@@9|)) (or (_module.__default.SortedRange ($LS $LZ) |min#0@@4| |max#0@@4| (_module.__default.sort ($LS $LZ) |min#0@@4| |max#0@@4| |i#0@@9|)) (=> (not (_module.List.Nil_q (_module.__default.sort ($LS $LZ) |min#0@@4| |max#0@@4| |i#0@@9|))) (let ((|hd#6@@1| (U_2_int ($Unbox intType (_module.List._h0 (_module.__default.sort ($LS ($LS $LZ)) |min#0@@4| |max#0@@4| |i#0@@9|))))))
(<= |hd#6@@1| |max#0@@4|)))))) (=> (=> (|_module.__default.SortedRange#canCall| |min#0@@4| |max#0@@4| (_module.__default.sort ($LS $LZ) |min#0@@4| |max#0@@4| |i#0@@9|)) (or (_module.__default.SortedRange ($LS $LZ) |min#0@@4| |max#0@@4| (_module.__default.sort ($LS $LZ) |min#0@@4| |max#0@@4| |i#0@@9|)) (=> (not (_module.List.Nil_q (_module.__default.sort ($LS $LZ) |min#0@@4| |max#0@@4| |i#0@@9|))) (let ((|hd#6@@2| (U_2_int ($Unbox intType (_module.List._h0 (_module.__default.sort ($LS ($LS $LZ)) |min#0@@4| |max#0@@4| |i#0@@9|))))))
(<= |hd#6@@2| |max#0@@4|))))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (=> (|_module.__default.SortedRange#canCall| |min#0@@4| |max#0@@4| (_module.__default.sort ($LS $LZ) |min#0@@4| |max#0@@4| |i#0@@9|)) (or (_module.__default.SortedRange ($LS $LZ) |min#0@@4| |max#0@@4| (_module.__default.sort ($LS $LZ) |min#0@@4| |max#0@@4| |i#0@@9|)) (=> (not (_module.List.Nil_q (_module.__default.sort ($LS $LZ) |min#0@@4| |max#0@@4| |i#0@@9|))) (let ((|tl#6| (_module.List._h1 (_module.__default.sort ($LS ($LS $LZ)) |min#0@@4| |max#0@@4| |i#0@@9|))))
(let ((|hd#6@@3| (U_2_int ($Unbox intType (_module.List._h0 (_module.__default.sort ($LS ($LS $LZ)) |min#0@@4| |max#0@@4| |i#0@@9|))))))
...
(<= |hd#8@@0| |hd#Z#0@0|)))))) (and (=> (= (ControlFlow 0 19) (- 0 24)) (=> (|_module.__default.SortedRange#canCall| |min#0@@4| |hd#Z#0@0| |i'#Z#0@0|) (or (_module.__default.SortedRange ($LS $LZ) |min#0@@4| |hd#Z#0@0| |i'#Z#0@0|) (=> (not (_module.List.Nil_q |i'#Z#0@0|)) (let ((|tl#8| (_module.List._h1 |i'#Z#0@0|)))
(let ((|hd#8@@1| (U_2_int ($Unbox intType (_module.List._h0 |i'#Z#0@0|)))))
(_module.__default.SortedRange ($LS ($LS $LZ)) |hd#8@@1| |hd#Z#0@0| |tl#8|))))))) (and (=> (= (ControlFlow 0 19) (- 0 23)) (=> (|_module.__default.SortedRange#canCall| |hd#Z#0@0| |max#0@@4| |##j#0@0|) (or (_module.__default.SortedRange ($LS $LZ) |hd#Z#0@0| |max#0@@4| |##j#0@0|) (=> (_module.List.Nil_q |##j#0@0|) (<= |hd#Z#0@0| |max#0@@4|))))) (and (=> (= (ControlFlow 0 19) (- 0 22)) (=> (|_module.__default.SortedRange#canCall| |hd#Z#0@0| |max#0@@4| |##j#0@0|) (or (_module.__default.SortedRange ($LS $LZ) |hd#Z#0@0| |max#0@@4| |##j#0@0|) (=> (not (_module.List.Nil_q |##j#0@0|)) (let ((|hd#10| (U_2_int ($Unbox intType (_module.List._h0 |##j#0@0|)))))
(<= |hd#Z#0@0| |hd#10|)))))) (and (=> (= (ControlFlow 0 19) (- 0 21)) (=> (|_module.__default.SortedRange#canCall| |hd#Z#0@0| |max#0@@4| |##j#0@0|) (or (_module.__default.SortedRange ($LS $LZ) |hd#Z#0@0| |max#0@@4| |##j#0@0|) (=> (not (_module.List.Nil_q |##j#0@0|)) (let ((|hd#10@@0| (U_2_int ($Unbox intType (_module.List._h0 |##j#0@0|)))))
(<= |hd#10@@0| |max#0@@4|)))))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (=> (|_module.__default.SortedRange#canCall| |hd#Z#0@0| |max#0@@4| |##j#0@0|) (or (_module.__default.SortedRange ($LS $LZ) |hd#Z#0@0| |max#0@@4| |##j#0@0|) (=> (not (_module.List.Nil_q |##j#0@0|)) (let ((|tl#10| (_module.List._h1 |##j#0@0|)))
(let ((|hd#10@@1| (U_2_int ($Unbox intType (_module.List._h0 |##j#0@0|)))))
(_module.__default.SortedRange ($LS ($LS $LZ)) |hd#10@@1| |max#0@@4| |tl#10|))))))) (=> (and (and (and (_module.__default.SortedRange ($LS $LZ) |min#0@@4| |hd#Z#0@0| |i'#Z#0@0|) (_module.__default.SortedRange ($LS $LZ) |hd#Z#0@0| |max#0@@4| |##j#0@0|)) (|_module.__default.append#canCall| |min#0@@4| |hd#Z#0@0| |hd#Z#0@0| |max#0@@4| |i'#Z#0@0| (|#_module.List.Cons| ($Box intType (int_2_U |hd#Z#0@0|)) |j'#Z#0@0|))) (and (and (= (_module.__default.sort ($LS $LZ) |min#0@@4| |max#0@@4| |i#0@@9|) (_module.__default.append ($LS $LZ) |min#0@@4| |hd#Z#0@0| |hd#Z#0@0| |max#0@@4| |i'#Z#0@0| (|#_module.List.Cons| ($Box intType (int_2_U |hd#Z#0@0|)) |j'#Z#0@0|))) (|_module.__default.append#canCall| |min#0@@4| |hd#Z#0@0| |hd#Z#0@0| |max#0@@4| |i'#Z#0@0| (|#_module.List.Cons| ($Box intType (int_2_U |hd#Z#0@0|)) |j'#Z#0@0|))) (and ($Is DatatypeTypeType (_module.__default.sort ($LS $LZ) |min#0@@4| |max#0@@4| |i#0@@9|) (Tclass._module.List TInt)) (= (ControlFlow 0 19) 13)))) GeneratedUnifiedExit_correct)))))))))))))))))))))))))))))))))))))))
(let ((anon18_Then_correct  (=> (and (and (= |i#0@@9| |#_module.List.Nil|) (= (_module.__default.sort ($LS $LZ) |min#0@@4| |max#0@@4| |i#0@@9|) (Lit DatatypeTypeType |#_module.List.Nil|))) (and ($Is DatatypeTypeType (_module.__default.sort ($LS $LZ) |min#0@@4| |max#0@@4| |i#0@@9|) (Tclass._module.List TInt)) (= (ControlFlow 0 18) 13))) GeneratedUnifiedExit_correct)))
(let ((anon20_Else_correct true))
(let ((anon19_Then_correct  (=> (and (and (= |i#0@@9| (|#_module.List.Cons| ($Box intType (int_2_U |_mcc#0#0|)) |_mcc#1#0|)) ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List TInt))) (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List TInt)))) (=> (and (and (and (= |tl#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|)) (and ($Is intType (int_2_U |let#1#0#0|) TInt) (= |hd#Z#0@0| |let#1#0#0|))) (and (and ($IsAlloc intType (int_2_U |hd#Z#0@0|) TInt $Heap) ($IsAlloc DatatypeTypeType |i#0@@9| (Tclass._module.List TInt) $Heap)) (and (|_module.__default.In#canCall| |hd#Z#0@0| |i#0@@9|) (|_module.__default.In#canCall| |hd#Z#0@0| |i#0@@9|)))) (and (=> (= (ControlFlow 0 40) (- 0 41)) (or (not (= (_module.__default.In ($LS ($LS $LZ)) |hd#Z#0@0| |i#0@@9|) 0)) (not true))) (=> (and (or (not (= (_module.__default.In ($LS $LZ) |hd#Z#0@0| |i#0@@9|) 0)) (not true)) ($IsAlloc intType (int_2_U |hd#Z#0@0|) TInt $Heap)) (=> (and (and (and ($IsAlloc DatatypeTypeType |tl#Z#0@0| (Tclass._module.List TInt) $Heap) (|_module.__default.partition#canCall| |hd#Z#0@0| |tl#Z#0@0|)) (and (_System.Tuple2.___hMake2_q (_module.__default.partition ($LS $LZ) |hd#Z#0@0| |tl#Z#0@0|)) (= |let#2#0#0| (_module.__default.partition ($LS $LZ) |hd#Z#0@0| |tl#Z#0@0|)))) (and (and (|_module.__default.partition#canCall| |hd#Z#0@0| |tl#Z#0@0|) ($Is DatatypeTypeType |let#2#0#0| (Tclass._System.Tuple2 (Tclass._module.List TInt) (Tclass._module.List TInt)))) (and (_System.Tuple2.___hMake2_q |let#2#0#0|) (= (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |lo#Z#0@0|) ($Box DatatypeTypeType |hi#Z#0@0|)) |let#2#0#0|)))) (and (=> (= (ControlFlow 0 40) 19) anon20_Then_correct) (=> (= (ControlFlow 0 40) 11) anon20_Else_correct)))))))))
...
(let ((anon16_Else_correct  (=> (and (< |x#6@0| |min#0@@4|) (= (ControlFlow 0 47) 45)) anon4_correct)))
(let ((anon16_Then_correct  (=> (and (<= |min#0@@4| |x#6@0|) (= (ControlFlow 0 46) 45)) anon4_correct)))
(let ((anon15_Then_correct  (=> (and (and ($IsAlloc intType (int_2_U |x#6@0|) TInt $Heap) ($IsAlloc DatatypeTypeType |i#0@@9| (Tclass._module.List TInt) $Heap)) (and (|_module.__default.In#canCall| |x#6@0| |i#0@@9|) (or (not (= (_module.__default.In ($LS $LZ) |x#6@0| |i#0@@9|) 0)) (not true)))) (and (=> (= (ControlFlow 0 48) 46) anon16_Then_correct) (=> (= (ControlFlow 0 48) 47) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (=> (or (not (= (_module.__default.In ($LS $LZ) |x#6@0| |i#0@@9|) 0)) (not true)) (and (<= |min#0@@4| |x#6@0|) (<= |x#6@0| |max#0@@4|))) (= (ControlFlow 0 44) 43)) anon6_correct)))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (<= |min#0@@4| |max#0@@4|)) (and (=> (= (ControlFlow 0 49) 48) anon15_Then_correct) (=> (= (ControlFlow 0 49) 44) anon15_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |i#0@@9| (Tclass._module.List TInt))) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 50) 49))) anon0_correct)))
