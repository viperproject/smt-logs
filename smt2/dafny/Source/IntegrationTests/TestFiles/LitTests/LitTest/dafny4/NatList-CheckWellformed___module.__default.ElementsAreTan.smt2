...
(assert (forall (($ly T@U) (|xs#0| T@U) ) (! (= (_module.__default.ElementsAreTan ($LS $ly) |xs#0|) (_module.__default.ElementsAreTan $ly |xs#0|))
 :qid |NatListdfy.88:17|
 :skolemid |571|
 :pattern ( (_module.__default.ElementsAreTan ($LS $ly) |xs#0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@0 T@U) (|xs#0@@0| T@U) ) (!  (=> (or (|_module.__default.ElementsAreTan#canCall| |xs#0@@0|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@0| (Tclass._module.List TInt)))) (and (=> (not (_module.List.Nil_q |xs#0@@0|)) (let ((|tail#1| (_module.List.tail |xs#0@@0|)))
(let ((|x#1| (U_2_int ($Unbox intType (_module.List.head |xs#0@@0|)))))
 (=> (<= |x#1| (LitInt 0)) (|_module.__default.ElementsAreTan#canCall| |tail#1|))))) (= (_module.__default.ElementsAreTan ($LS $ly@@0) |xs#0@@0|) (ite (_module.List.Nil_q |xs#0@@0|) true (let ((|tail#0| (_module.List.tail |xs#0@@0|)))
(let ((|x#0| (U_2_int ($Unbox intType (_module.List.head |xs#0@@0|)))))
 (and (<= |x#0| (LitInt 0)) (_module.__default.ElementsAreTan $ly@@0 |tail#0|))))))))
 :qid |NatListdfy.88:17|
 :skolemid |575|
 :pattern ( (_module.__default.ElementsAreTan ($LS $ly@@0) |xs#0@@0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@1 T@U) (|xs#0@@1| T@U) ) (!  (=> (or (|_module.__default.ElementsAreTan#canCall| (Lit DatatypeTypeType |xs#0@@1|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@1| (Tclass._module.List TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@1|)))))) (let ((|tail#3| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@1|)))))
(let ((|x#3| (LitInt (U_2_int ($Unbox intType (_module.List.head (Lit DatatypeTypeType |xs#0@@1|)))))))
 (=> (<= |x#3| (LitInt 0)) (|_module.__default.ElementsAreTan#canCall| |tail#3|))))) (= (_module.__default.ElementsAreTan ($LS $ly@@1) (Lit DatatypeTypeType |xs#0@@1|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@1|)) true (let ((|tail#2| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@1|)))))
(let ((|x#2| (LitInt (U_2_int ($Unbox intType (_module.List.head (Lit DatatypeTypeType |xs#0@@1|)))))))
 (and (<= |x#2| (LitInt 0)) (_module.__default.ElementsAreTan ($LS $ly@@1) |tail#2|))))))))
 :qid |NatListdfy.88:17|
 :weight 3
 :skolemid |576|
 :pattern ( (_module.__default.ElementsAreTan ($LS $ly@@1) (Lit DatatypeTypeType |xs#0@@1|)))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.ElementsAreTan)
...
(let ((anon13_Else_correct  (=> (and (< (LitInt 0) |x#Z#0@0|) (= (ControlFlow 0 7) 4)) anon7_correct)))
(let ((anon13_Then_correct  (=> (and (<= |x#Z#0@0| (LitInt 0)) ($IsAlloc DatatypeTypeType |tail#Z#0@0| (Tclass._module.List TInt) $Heap)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< (DtRank |tail#Z#0@0|) (DtRank |xs#0@@2|))) (=> (< (DtRank |tail#Z#0@0|) (DtRank |xs#0@@2|)) (=> (and (|_module.__default.ElementsAreTan#canCall| |tail#Z#0@0|) (= (ControlFlow 0 5) 4)) anon7_correct))))))
(let ((anon12_Then_correct  (=> (and (and (and (= |xs#0@@2| (|#_module.List.Cons| ($Box intType (int_2_U |_mcc#0#0|)) |_mcc#1#0|)) ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List TInt))) (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List TInt)))) (and (and (= |tail#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|)) (and ($Is intType (int_2_U |let#1#0#0|) TInt) (= |x#Z#0@0| |let#1#0#0|)))) (and (=> (= (ControlFlow 0 8) 5) anon13_Then_correct) (=> (= (ControlFlow 0 8) 7) anon13_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |xs#0@@2| (Tclass._module.List TInt))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct)))
