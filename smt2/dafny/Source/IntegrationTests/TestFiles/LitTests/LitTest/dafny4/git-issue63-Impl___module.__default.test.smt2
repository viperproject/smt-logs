...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|gm#0@@1| T@U) (|g#0@@3| T@U) (|v#0| Int) ) (!  (=> (or (|_module.__default.GlobalUpdate#canCall| |gm#0@@1| |g#0@@3| |v#0|) (and (< 2 $FunctionContextHeight) (and (and ($Is MapType |gm#0@@1| (TMap (TSeq TChar) (TSeq TInt))) ($Is SeqType |g#0@@3| (TSeq TChar))) (and (_module.__default.ValidGlobalStateOpaque reveal__module._default.ValidGlobalStateOpaque |gm#0@@1|) (_module.__default.ValidGlobal |g#0@@3|))))) (and (_module.__default.ValidGlobalStateOpaque reveal__module._default.ValidGlobalStateOpaque (_module.__default.GlobalUpdate |gm#0@@1| |g#0@@3| |v#0|)) ($Is MapType (_module.__default.GlobalUpdate |gm#0@@1| |g#0@@3| |v#0|) (TMap (TSeq TChar) (TSeq TInt)))))
 :qid |gitissue63dfy.20:29|
 :skolemid |602|
 :pattern ( (_module.__default.GlobalUpdate |gm#0@@1| |g#0@@3| |v#0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|gm#0@@2| T@U) (|g#0@@4| T@U) (|v#0@@0| Int) ) (!  (=> (or (|_module.__default.GlobalUpdate#canCall| |gm#0@@2| |g#0@@4| |v#0@@0|) (and (< 2 $FunctionContextHeight) (and (and ($Is MapType |gm#0@@2| (TMap (TSeq TChar) (TSeq TInt))) ($Is SeqType |g#0@@4| (TSeq TChar))) (and (_module.__default.ValidGlobalStateOpaque reveal__module._default.ValidGlobalStateOpaque |gm#0@@2|) (_module.__default.ValidGlobal |g#0@@4|))))) (= (_module.__default.GlobalUpdate |gm#0@@2| |g#0@@4| |v#0@@0|) (|Map#Build| |gm#0@@2| ($Box SeqType |g#0@@4|) ($Box SeqType (|Seq#Update| ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| |gm#0@@2|) ($Box SeqType |g#0@@4|))) (LitInt 0) ($Box intType (int_2_U |v#0@@0|)))))))
 :qid |gitissue63dfy.20:29|
 :skolemid |604|
 :pattern ( (_module.__default.GlobalUpdate |gm#0@@2| |g#0@@4| |v#0@@0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|gm#0@@3| T@U) (|g#0@@5| T@U) (|v#0@@1| Int) ) (!  (=> (or (|_module.__default.GlobalUpdate#canCall| (Lit MapType |gm#0@@3|) (Lit SeqType |g#0@@5|) (LitInt |v#0@@1|)) (and (< 2 $FunctionContextHeight) (and (and ($Is MapType |gm#0@@3| (TMap (TSeq TChar) (TSeq TInt))) ($Is SeqType |g#0@@5| (TSeq TChar))) (and (_module.__default.ValidGlobalStateOpaque reveal__module._default.ValidGlobalStateOpaque (Lit MapType |gm#0@@3|)) (_module.__default.ValidGlobal (Lit SeqType |g#0@@5|)))))) (= (_module.__default.GlobalUpdate (Lit MapType |gm#0@@3|) (Lit SeqType |g#0@@5|) (LitInt |v#0@@1|)) (|Map#Build| (Lit MapType |gm#0@@3|) ($Box SeqType (Lit SeqType |g#0@@5|)) ($Box SeqType (|Seq#Update| ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType |gm#0@@3|)) ($Box SeqType (Lit SeqType |g#0@@5|)))) (LitInt 0) ($Box intType (int_2_U (LitInt |v#0@@1|))))))))
 :qid |gitissue63dfy.20:29|
 :weight 3
 :skolemid |605|
 :pattern ( (_module.__default.GlobalUpdate (Lit MapType |gm#0@@3|) (Lit SeqType |g#0@@5|) (LitInt |v#0@@1|)))
))))
...
(declare-fun |gm1#0@0| () T@U)
(declare-fun |g#0@0| () T@U)
(declare-fun |gm2#0@0| () T@U)
(declare-fun |v#0@0| () Int)
(declare-fun $Heap () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |gm1#0| () T@U)
(declare-fun |g#0@@6| () T@U)
(declare-fun |gm2#0| () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon6_correct  (=> (and (and (=> (|Set#IsMember| (|Map#Domain| |gm1#0@0|) ($Box SeqType |g#0@0|)) (=> (= (|Seq#Length| ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| |gm1#0@0|) ($Box SeqType |g#0@0|)))) (LitInt 1)) (|_module.__default.GlobalWord#canCall| |gm2#0@0| |g#0@0|))) (= (ControlFlow 0 2) (- 0 1))) (and (|Set#IsMember| (|Map#Domain| |gm1#0@0|) ($Box SeqType |g#0@0|)) (= (|Seq#Length| ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| |gm1#0@0|) ($Box SeqType |g#0@0|)))) (LitInt 1)))) (= (_module.__default.GlobalWord |gm2#0@0| |g#0@0|) |v#0@0|))))
(let ((anon9_Else_correct  (=> (and (not (and (|Set#IsMember| (|Map#Domain| |gm1#0@0|) ($Box SeqType |g#0@0|)) (= (|Seq#Length| ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| |gm1#0@0|) ($Box SeqType |g#0@0|)))) (LitInt 1)))) (= (ControlFlow 0 6) 2)) anon6_correct)))
(let ((anon9_Then_correct  (=> (and (and (|Set#IsMember| (|Map#Domain| |gm1#0@0|) ($Box SeqType |g#0@0|)) (= (|Seq#Length| ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| |gm1#0@0|) ($Box SeqType |g#0@0|)))) (LitInt 1))) (and ($IsAlloc MapType |gm2#0@0| (TMap (TSeq TChar) (TSeq TInt)) $Heap) ($IsAlloc SeqType |g#0@0| (TSeq TChar) $Heap))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (_module.__default.ValidGlobalStateOpaque reveal__module._default.ValidGlobalStateOpaque |gm2#0@0|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (_module.__default.ValidGlobal |g#0@0|)) (=> (and (|_module.__default.GlobalWord#canCall| |gm2#0@0| |g#0@0|) (= (ControlFlow 0 3) 2)) anon6_correct))))))
(let ((anon8_Else_correct  (=> (not (|Set#IsMember| (|Map#Domain| |gm1#0@0|) ($Box SeqType |g#0@0|))) (and (=> (= (ControlFlow 0 9) 3) anon9_Then_correct) (=> (= (ControlFlow 0 9) 6) anon9_Else_correct)))))
(let ((anon8_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |gm1#0@0|) ($Box SeqType |g#0@0|)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (|Set#IsMember| (|Map#Domain| |gm1#0@0|) ($Box SeqType |g#0@0|))) (and (=> (= (ControlFlow 0 7) 3) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct))))))
(let ((anon2_correct  (=> (and (|_module.__default.ValidGlobal#canCall| |g#0@0|) (=> (_module.__default.ValidGlobal |g#0@0|) (|_module.__default.ValidGlobalStateOpaque#canCall| |gm1#0@0|))) (=> (and (and (and (_module.__default.ValidGlobal |g#0@0|) (_module.__default.ValidGlobalStateOpaque reveal__module._default.ValidGlobalStateOpaque |gm1#0@0|)) ($IsAlloc MapType |gm1#0@0| (TMap (TSeq TChar) (TSeq TInt)) $Heap)) (and ($IsAlloc SeqType |g#0@0| (TSeq TChar) $Heap) ($IsAlloc intType (int_2_U |v#0@0|) TInt $Heap))) (and (=> (= (ControlFlow 0 10) (- 0 12)) (_module.__default.ValidGlobalStateOpaque reveal__module._default.ValidGlobalStateOpaque |gm1#0@0|)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (_module.__default.ValidGlobal |g#0@0|)) (=> (and (and (and (_module.__default.ValidGlobalStateOpaque reveal__module._default.ValidGlobalStateOpaque |gm1#0@0|) (_module.__default.ValidGlobal |g#0@0|)) (|_module.__default.GlobalUpdate#canCall| |gm1#0@0| |g#0@0| |v#0@0|)) (and (|_module.__default.GlobalUpdate#canCall| |gm1#0@0| |g#0@0| |v#0@0|) (= |gm2#0@0| (_module.__default.GlobalUpdate |gm1#0@0| |g#0@0| |v#0@0|)))) (and (=> (= (ControlFlow 0 10) 7) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct)))))))))
(let ((anon7_Else_correct  (=> (and (not (_module.__default.ValidGlobal |g#0@0|)) (= (ControlFlow 0 14) 10)) anon2_correct)))
(let ((anon7_Then_correct  (=> (and (and (_module.__default.ValidGlobal |g#0@0|) ($IsAlloc MapType |gm1#0@0| (TMap (TSeq TChar) (TSeq TInt)) $Heap)) (and (|_module.__default.ValidGlobalStateOpaque#canCall| |gm1#0@0|) (= (ControlFlow 0 13) 10))) anon2_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and ($Is MapType |gm1#0@0| (TMap (TSeq TChar) (TSeq TInt))) ($IsAlloc MapType |gm1#0@0| (TMap (TSeq TChar) (TSeq TInt)) $Heap)) (=> (and (and ($Is SeqType |g#0@0| (TSeq TChar)) ($IsAlloc SeqType |g#0@0| (TSeq TChar) $Heap)) (and ($IsAlloc SeqType |g#0@0| (TSeq TChar) $Heap) (|_module.__default.ValidGlobal#canCall| |g#0@0|))) (and (=> (= (ControlFlow 0 15) 13) anon7_Then_correct) (=> (= (ControlFlow 0 15) 14) anon7_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is MapType |gm1#0| (TMap (TSeq TChar) (TSeq TInt))) ($IsAlloc MapType |gm1#0| (TMap (TSeq TChar) (TSeq TInt)) $Heap)) true) (and (and ($Is SeqType |g#0@@6| (TSeq TChar)) ($IsAlloc SeqType |g#0@@6| (TSeq TChar) $Heap)) true)) (and (and (and ($Is MapType |gm2#0| (TMap (TSeq TChar) (TSeq TInt))) ($IsAlloc MapType |gm2#0| (TMap (TSeq TChar) (TSeq TInt)) $Heap)) true) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 16) 15)))) anon0_correct))))
