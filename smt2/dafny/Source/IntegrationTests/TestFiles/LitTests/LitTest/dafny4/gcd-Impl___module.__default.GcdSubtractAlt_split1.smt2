...
(set-info :boogie-vc-id Impl$$_module.__default.GcdSubtractAlt_split1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (and (and (<= (LitInt 1) |x#0@@10|) (<= (LitInt 1) |y#0@@3|)) (and (<= (LitInt 1) |p#0@@2|) true)) (and (and (<= (LitInt 1) |a#0_0|) true) (and (<= (LitInt 1) |b#0_0|) true))) (and (and (and ($Is SetType |common#0@@1| (TSet Tclass._module.pos)) ($IsAlloc SetType |common#0@@1| (TSet Tclass._module.pos) $Heap@@1)) true) (and (<= (LitInt 1) |a#2_0|) true))) (=> (and (and (and (and (and (and (<= (LitInt 1) |b#2_0|) true) (= 6 $FunctionContextHeight)) (and (< |x#0@@10| |y#0@@3|) (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)))) (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (|_module.__default.Gcd#canCall| |x#0@@10| |y#0@@3|) (|_module.__default.Gcd#canCall| |y#0@@3| |x#0@@10|))) (and (and (= (_module.__default.Gcd reveal__module._default.Gcd |x#0@@10| |y#0@@3|) (_module.__default.Gcd reveal__module._default.Gcd |y#0@@3| |x#0@@10|)) (= $Heap@@1 $Heap@0)) (and ($IsAlloc intType (int_2_U |x#0@@10|) Tclass._module.pos $Heap@0) ($IsAlloc intType (int_2_U |y#0@@3|) Tclass._module.pos $Heap@0))))) (and (and (and (and (|_module.__default.Gcd#canCall| |x#0@@10| |y#0@@3|) (|_module.__default.Gcd#canCall| |x#0@@10| |y#0@@3|)) (and (= |p#0@0| (_module.__default.Gcd reveal__module._default.Gcd |x#0@@10| |y#0@@3|)) ($IsAlloc intType (int_2_U |p#0@0|) Tclass._module.pos $Heap@0))) (and (and ($Is intType (int_2_U (- |y#0@@3| |x#0@@10|)) Tclass._module.pos) (= |##x#4@0| (- |y#0@@3| |x#0@@10|))) (and ($IsAlloc intType (int_2_U |##x#4@0|) Tclass._module.pos $Heap@0) (|_module.__default.IsFactor#canCall| |p#0@0| (- |y#0@@3| |x#0@@10|))))) (and (and (and (|_module.__default.IsFactor#canCall| |p#0@0| (- |y#0@@3| |x#0@@10|)) (_module.__default.IsFactor |p#0@0| (- |y#0@@3| |x#0@@10|))) (and ($IsAlloc intType (int_2_U |x#0@@10|) Tclass._module.pos $Heap@0) (|_module.__default.Factors#canCall| |x#0@@10|))) (and (and ($Is intType (int_2_U (- |y#0@@3| |x#0@@10|)) Tclass._module.pos) (= |##x#6@0| (- |y#0@@3| |x#0@@10|))) (and ($IsAlloc intType (int_2_U |##x#6@0|) Tclass._module.pos $Heap@0) (|_module.__default.Factors#canCall| (- |y#0@@3| |x#0@@10|))))))) (and (and (and (and (and (|_module.__default.Factors#canCall| |x#0@@10|) (|_module.__default.Factors#canCall| (- |y#0@@3| |x#0@@10|))) (= |common#0@0| (|Set#Intersection| (_module.__default.Factors |x#0@@10|) (_module.__default.Factors (- |y#0@@3| |x#0@@10|))))) (and (|Set#IsMember| |common#0@0| ($Box intType (int_2_U |p#0@0|))) (forall ((|q#2_3| T@U) ) (!  (=> (and (<= (LitInt 1) (U_2_int |q#2_3|)) (|Set#IsMember| |common#0@0| ($Box intType |q#2_3|))) (<= (U_2_int |q#2_3|) |p#0@0|))
 :qid |gcddfy.240:10|
 :skolemid |675|
 :pattern ( (|Set#IsMember| |common#0@0| ($Box intType |q#2_3|)))
)))) (and (and ($IsAlloc intType (int_2_U |y#0@@3|) Tclass._module.pos $Heap@0) ($IsAlloc intType (int_2_U |x#0@@10|) Tclass._module.pos $Heap@0)) (and (|_module.__default.Gcd#canCall| |y#0@@3| |x#0@@10|) ($IsAlloc intType (int_2_U |x#0@@10|) Tclass._module.pos $Heap@0)))) (and (and (and ($Is intType (int_2_U (- |y#0@@3| |x#0@@10|)) Tclass._module.pos) (= |##y#6@0| (- |y#0@@3| |x#0@@10|))) (and ($IsAlloc intType (int_2_U |##y#6@0|) Tclass._module.pos $Heap@0) (|_module.__default.Gcd#canCall| |x#0@@10| (- |y#0@@3| |x#0@@10|)))) (and (and (|_module.__default.Gcd#canCall| |y#0@@3| |x#0@@10|) (|_module.__default.Gcd#canCall| |x#0@@10| (- |y#0@@3| |x#0@@10|))) (and (= (_module.__default.Gcd reveal__module._default.Gcd |y#0@@3| |x#0@@10|) (_module.__default.Gcd reveal__module._default.Gcd |x#0@@10| (- |y#0@@3| |x#0@@10|))) (= (ControlFlow 0 2) (- 0 1))))))) (= (_module.__default.Gcd reveal__module._default.Gcd |y#0@@3| |x#0@@10|) (_module.__default.Gcd reveal__module._default.Gcd |x#0@@10| (- |y#0@@3| |x#0@@10|))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
