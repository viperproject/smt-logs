...
(assert (distinct TInt TagInt TagSet TagMap alloc |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass._module.t |tytagFamily$_tuple#2| tytagFamily$t)
)
(assert (= (Tag TInt) TagInt))
(assert (forall ((|i#0| T@U) ($h T@U) ) (! ($IsAlloc intType |i#0| Tclass._module.t $h)
 :qid |unknown.0:0|
 :skolemid |483|
 :pattern ( ($IsAlloc intType |i#0| Tclass._module.t $h))
)))
...
(assert (forall ((bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 Tclass._module.t) (and (= ($Box intType ($Unbox intType bx@@2)) bx@@2) ($Is intType ($Unbox intType bx@@2) Tclass._module.t)))
 :qid |unknown.0:0|
 :skolemid |479|
 :pattern ( ($IsBox bx@@2 Tclass._module.t))
)))
(assert (forall ((s@@0 T@U) (i Int) (v@@2 T@U) ) (!  (and (=> (= i (|Seq#Length| s@@0)) (= (|Seq#Index| (|Seq#Build| s@@0 v@@2) i) v@@2)) (=> (or (not (= i (|Seq#Length| s@@0))) (not true)) (= (|Seq#Index| (|Seq#Build| s@@0 v@@2) i) (|Seq#Index| s@@0 i))))
 :qid |DafnyPreludebpl.1148:15|
 :skolemid |225|
 :pattern ( (|Seq#Index| (|Seq#Build| s@@0 v@@2) i))
)))
(assert (forall ((|l#0| T@U) (|l#1| Int) (|l#2| Int) (|$w#0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#1| |l#0| |l#1| |l#2|) |$w#0|))  (and ($IsBox |$w#0| |l#0|) (and (<= |l#1| (U_2_int ($Unbox intType |$w#0|))) (< (U_2_int ($Unbox intType |$w#0|)) |l#2|))))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |485|
 :pattern ( (MapType0Select BoxType boolType (|lambda#1| |l#0| |l#1| |l#2|) |$w#0|))
)))
(assert (forall ((|l#0@@0| T@U) (|$w#0@@0| T@U) ) (! (= (MapType0Select BoxType BoxType (|lambda#2| |l#0@@0|) |$w#0@@0|) |l#0@@0|)
 :qid |gitissue75dfy.17:35|
 :skolemid |486|
 :pattern ( (MapType0Select BoxType BoxType (|lambda#2| |l#0@@0|) |$w#0@@0|))
)))
...
(assert (forall ((v@@5 T@U) (t0@@3 T@U) (t1@@1 T@U) (h@@1 T@U) ) (! (= ($IsAlloc MapType v@@5 (TMap t0@@3 t1@@1) h@@1) (forall ((bx@@5 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@5) bx@@5) (and ($IsAllocBox (MapType0Select BoxType BoxType (|Map#Elements| v@@5) bx@@5) t1@@1 h@@1) ($IsAllocBox bx@@5 t0@@3 h@@1)))
 ...
 :skolemid |76|
 :pattern ( ($IsAlloc MapType v@@5 (TMap t0@@3 t1@@1) h@@1))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (=> (or |_module.__default.f#canCall| (< 1 $FunctionContextHeight)) (and (<= (LitInt 0) _module.__default.f) (< _module.__default.f 10)))))
...
(assert (forall ((v@@8 T@U) (t0@@5 T@U) (t1@@3 T@U) ) (! (= ($Is MapType v@@8 (TMap t0@@5 t1@@3)) (forall ((bx@@9 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@8) bx@@9) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@8) bx@@9) t1@@3) ($IsBox bx@@9 t0@@5)))
...
(assert (forall ((|i#0@@0| T@U) ) (! (= ($Is intType |i#0@@0| Tclass._module.t)  (and (<= (LitInt 0) (U_2_int |i#0@@0|)) (< (U_2_int |i#0@@0|) 10)))
 :qid |unknown.0:0|
 :skolemid |482|
 :pattern ( ($Is intType |i#0@@0| Tclass._module.t))
)))
...
(assert (forall ((s@@5 T@U) (i@@0 Int) ) (!  (=> (and (<= 0 i@@0) (< i@@0 (|Seq#Length| s@@5))) (< (DtRank ($Unbox DatatypeTypeType (|Seq#Index| s@@5 i@@0))) (|Seq#Rank| s@@5)))
 :qid |DafnyPreludebpl.1353:15|
 :skolemid |267|
 :pattern ( (DtRank ($Unbox DatatypeTypeType (|Seq#Index| s@@5 i@@0))))
)))
...
(declare-fun |m#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.L2)
...
(let ((anon8_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 5))) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon8_Then_correct  (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 5)) |_module.__default.f#canCall|) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U _module.__default.f))))))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U _module.__default.f)))))) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon7_Else_correct  (=> (< |i#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 7) 3) anon8_Then_correct) (=> (= (ControlFlow 0 7) 5) anon8_Else_correct)))))
(let ((anon7_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 6) 3) anon8_Then_correct) (=> (= (ControlFlow 0 6) 5) anon8_Else_correct)))))
(let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 8) 6) anon7_Then_correct) (=> (= (ControlFlow 0 8) 7) anon7_Else_correct))))
(let ((anon6_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 9) 8) anon6_Then_correct) (=> (= (ControlFlow 0 9) 1) anon6_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is MapType |m#0| (TMap TInt Tclass._module.t)) ($IsAlloc MapType |m#0| (TMap TInt Tclass._module.t) $Heap)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct))))
