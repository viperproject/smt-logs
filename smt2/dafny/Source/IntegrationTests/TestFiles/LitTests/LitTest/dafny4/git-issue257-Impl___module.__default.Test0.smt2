...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (or (not (= call1formal@this null)) (not true)) (and ($Is refType call1formal@this Tclass.M.C) ($IsAlloc refType call1formal@this Tclass.M.C $Heap))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (=> (and (and (and (or (not (= call1formal@this@0 null)) (not true)) (and ($Is refType call1formal@this@0 Tclass.M.C) ($IsAlloc refType call1formal@this@0 Tclass.M.C $Heap@0))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap call1formal@this@0) alloc))))) (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6)))
 :qid |gitissue257dfy.9:5|
 :skolemid |1016|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6))
)) ($HeapSucc $Heap $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 8)) true) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= call1formal@this@0 null)) (not true))) (=> ($IsAllocBox ($Box refType call1formal@this@0) Tclass.M.C? $Heap@0) (=> (and (|M.C.f#canCall| call1formal@this@0) (|M.C.f#canCall| call1formal@this@0)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (= (M.C.f call1formal@this@0) (LitInt 0))) (=> (= (M.C.f call1formal@this@0) (LitInt 0)) (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= call1formal@this@0 null)) (not true))) (=> (and (and ($IsAllocBox ($Box refType call1formal@this@0) Tclass.M.T? $Heap@0) (|M.T.f#canCall| call1formal@this@0)) (and (|M.T.f#canCall| call1formal@this@0) (= (ControlFlow 0 2) (- 0 1)))) (= (M.T.f call1formal@this@0) (LitInt 0)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (=> |defass#c#0| (and ($Is refType |c#0@@3| Tclass.M.C) ($IsAlloc refType |c#0@@3| Tclass.M.C $Heap))) true)) (and (and (=> |defass#g#0| (and ($Is refType |g#0| Tclass.M.T) ($IsAlloc refType |g#0| Tclass.M.T $Heap))) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 9) 2)))) anon0_correct)))
