...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@0 T@U) ($Heap T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.__default.UpFunction#canCall| |n#0@@0|) (and (< 1 $FunctionContextHeight) ($IsGoodHeap $Heap))) (and (forall ((|$l#1#k#0| Int) ) (|_module.__default.UpFunction#canCall| |$l#1#k#0|)) (= (_module.__default.UpFunction ($LS $ly@@0) |n#0@@0|) ($Unbox DatatypeTypeType (Apply1 TInt (Tclass._module.Stream TInt) $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (|lambda#1| TInt) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false)))) $ly@@0)) ($Box intType (int_2_U |n#0@@0|)))))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@1 T@U) ($Heap@@0 T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.__default.UpFunction#canCall| (LitInt |n#0@@1|)) (and (< 1 $FunctionContextHeight) ($IsGoodHeap $Heap@@0))) (and (forall ((|$l#3#k#0| Int) ) (|_module.__default.UpFunction#canCall| |$l#3#k#0|)) (= (_module.__default.UpFunction ($LS $ly@@1) (LitInt |n#0@@1|)) ($Unbox DatatypeTypeType (Apply1 TInt (Tclass._module.Stream TInt) $Heap@@0 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (|lambda#1| TInt) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false)))) ($LS $ly@@1))) ($Box intType (int_2_U (LitInt |n#0@@1|))))))))
 :weight 3
