...
(declare-fun _module.__default.UpFunction (T@U Int) T@U)
(declare-fun |_module.__default.UpFunction#canCall| (Int) Bool)
...
(assert (distinct TInt TagInt TagSet alloc Tagclass._System.object? Tagclass._System.object Tagclass._System.___hFunc1 Tagclass._module.Stream |##_module.Stream.ICons| tytagFamily$object |tytagFamily$_#Func1| tytagFamily$Stream)
)
...
(assert (forall ((|l#0| T@U) (|$l#0#heap#0| T@U) (|$l#0#k#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#1| |l#0|) |$l#0#heap#0| |$l#0#k#0|)) ($IsBox |$l#0#k#0| |l#0|))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |523|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#1| |l#0|) |$l#0#heap#0| |$l#0#k#0|))
)))
(assert  (and (= (Ctor LayerTypeType) 8) (= (Ctor HandleTypeType) 9)))
(assert (forall ((|l#0@@0| T@U) (|l#1| T@U) (|$l#0#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#4| |l#0@@0| |l#1|) |$l#0#ly#0|) (Handle1 (|lambda#0| |$l#0#ly#0|) |l#0@@0| |l#1|))
 :qid |nofile.1:7|
 :skolemid |526|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#4| |l#0@@0| |l#1|) |$l#0#ly#0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly T@U) (|n#0| Int) ) (!  (=> (or (|_module.__default.UpFunction#canCall| |n#0|) (< 1 $FunctionContextHeight)) ($Is DatatypeTypeType (_module.__default.UpFunction $ly |n#0|) (Tclass._module.Stream TInt)))
 :qid |ExpandedGuardednessNegdfy.6:10|
 :skolemid |484|
 :pattern ( (_module.__default.UpFunction $ly |n#0|))
))))
...
(assert (forall ((|l#0@@1| T@U) (|$l#0#heap#0@@0| T@U) (|$l#0#k#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#0| |l#0@@1|) |$l#0#heap#0@@0| |$l#0#k#0@@0|) ($Box DatatypeTypeType (|#_module.Stream.ICons| |$l#0#k#0@@0| (_module.__default.UpFunction |l#0@@1| (U_2_int ($Unbox intType |$l#0#k#0@@0|))))))
 :qid |unknown.0:0|
 :skolemid |522|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#0| |l#0@@1|) |$l#0#heap#0@@0| |$l#0#k#0@@0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@0 T@U) ($Heap T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.__default.UpFunction#canCall| |n#0@@0|) (and (< 1 $FunctionContextHeight) ($IsGoodHeap $Heap))) (and (forall ((|$l#1#k#0| Int) ) (! (|_module.__default.UpFunction#canCall| |$l#1#k#0|)
 :qid |unknown.0:0|
 :skolemid |486|
)) (= (_module.__default.UpFunction ($LS $ly@@0) |n#0@@0|) ($Unbox DatatypeTypeType (Apply1 TInt (Tclass._module.Stream TInt) $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (|lambda#1| TInt) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false)))) $ly@@0)) ($Box intType (int_2_U |n#0@@0|)))))))
 :qid |ExpandedGuardednessNegdfy.6:10|
 :skolemid |487|
 :pattern ( (_module.__default.UpFunction ($LS $ly@@0) |n#0@@0|) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@1 T@U) ($Heap@@0 T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.__default.UpFunction#canCall| (LitInt |n#0@@1|)) (and (< 1 $FunctionContextHeight) ($IsGoodHeap $Heap@@0))) (and (forall ((|$l#3#k#0| Int) ) (! (|_module.__default.UpFunction#canCall| |$l#3#k#0|)
 :qid |unknown.0:0|
 :skolemid |488|
)) (= (_module.__default.UpFunction ($LS $ly@@1) (LitInt |n#0@@1|)) ($Unbox DatatypeTypeType (Apply1 TInt (Tclass._module.Stream TInt) $Heap@@0 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (|lambda#1| TInt) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false)))) ($LS $ly@@1))) ($Box intType (int_2_U (LitInt |n#0@@1|))))))))
 :qid |ExpandedGuardednessNegdfy.6:10|
 :weight 3
 :skolemid |489|
 :pattern ( (_module.__default.UpFunction ($LS $ly@@1) (LitInt |n#0@@1|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall (($ly@@2 T@U) (|n#0@@2| Int) ) (! (= (_module.__default.UpFunction ($LS $ly@@2) |n#0@@2|) (_module.__default.UpFunction $ly@@2 |n#0@@2|))
 :qid |ExpandedGuardednessNegdfy.6:10|
 :skolemid |479|
 :pattern ( (_module.__default.UpFunction ($LS $ly@@2) |n#0@@2|))
)))
...
(assert (forall ((d@@2 T@U) (_module.Stream$T@@3 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.Stream.ICons_q d@@2) ($IsAlloc DatatypeTypeType d@@2 (Tclass._module.Stream _module.Stream$T@@3) $h@@1))) ($IsAllocBox (_module.Stream.head d@@2) _module.Stream$T@@3 $h@@1))
 :qid |unknown.0:0|
 :skolemid |505|
 :pattern ( ($IsAllocBox (_module.Stream.head d@@2) _module.Stream$T@@3 $h@@1))
)))
(assert (forall ((|l#0@@3| T@U) (|l#1@@0| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@1 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#10| |l#0@@3| |l#1@@0| |l#2| |l#3|) $o@@1 $f))  (=> (and (or (not (= $o@@1 |l#0@@3|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@0| $o@@1) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |527|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#10| |l#0@@3| |l#1@@0| |l#2| |l#3|) $o@@1 $f))
)))
...
(assert (forall ((_module.Stream$T@@4 T@U) (bx@@11 T@U) ) (!  (=> ($IsBox bx@@11 (Tclass._module.Stream _module.Stream$T@@4)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@11)) bx@@11) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@11) (Tclass._module.Stream _module.Stream$T@@4))))
 :qid |unknown.0:0|
 :skolemid |483|
 :pattern ( ($IsBox bx@@11 (Tclass._module.Stream _module.Stream$T@@4)))
)))
(assert (forall ((d@@3 T@U) (_module.Stream$T@@5 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (_module.Stream.ICons_q d@@3) ($IsAlloc DatatypeTypeType d@@3 (Tclass._module.Stream _module.Stream$T@@5) $h@@2))) ($IsAlloc DatatypeTypeType (_module.Stream.tail d@@3) (Tclass._module.Stream _module.Stream$T@@5) $h@@2))
 :qid |unknown.0:0|
 :skolemid |506|
...
(assert (forall ((_module.Stream$T@@6 T@U) (|a#2#0#0@@0| T@U) (|a#2#1#0@@0| T@U) ($h@@3 T@U) ) (!  (=> ($IsGoodHeap $h@@3) (= ($IsAlloc DatatypeTypeType (|#_module.Stream.ICons| |a#2#0#0@@0| |a#2#1#0@@0|) (Tclass._module.Stream _module.Stream$T@@6) $h@@3)  (and ($IsAllocBox |a#2#0#0@@0| _module.Stream$T@@6 $h@@3) ($IsAlloc DatatypeTypeType |a#2#1#0@@0| (Tclass._module.Stream _module.Stream$T@@6) $h@@3))))
 :qid |unknown.0:0|
 :skolemid |504|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.Stream.ICons| |a#2#0#0@@0| |a#2#1#0@@0|) (Tclass._module.Stream _module.Stream$T@@6) $h@@3))
)))
(assert (forall ((|l#0@@4| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#k#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#3| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#k#0@@1|) |l#0@@4|)
 :qid |ExpandedGuardednessNegdfy.8:4|
 :skolemid |525|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#3| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#k#0@@1|))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.UpFunction)
...
(let ((anon11_Then_correct  (=> (and (= |$_Frame#l0@0| (|lambda#10| null |$lambdaHeap#0@0| alloc false)) ($IsAlloc intType (int_2_U |k#0@0|) TInt |$lambdaHeap#0@0|)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (<= 0 |n#0@@3|) (= |k#0@0| |n#0@@3|))) (=> (or (<= 0 |n#0@@3|) (= |k#0@0| |n#0@@3|)) (=> (= (ControlFlow 0 4) (- 0 3)) (< |k#0@0| |n#0@@3|)))))))
