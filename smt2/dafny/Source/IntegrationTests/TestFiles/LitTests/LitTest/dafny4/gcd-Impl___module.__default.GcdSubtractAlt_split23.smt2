...
(set-info :boogie-vc-id Impl$$_module.__default.GcdSubtractAlt_split23)
...
(assert (not
 ...
 :qid |gcddfy.228:9|
 :skolemid |662|
)))) (=> (and (and (<= (LitInt 1) |b#0_0@0|) (= (Mul |p#0@0| |b#0_0@0|) |y#0@@3|)) (and (= (- |y#0@@3| |x#0@@10|) (Mul |p#0@0| (- |b#0_0@0| |a#0_0@0|))) ($IsAlloc intType (int_2_U |p#0@0|) Tclass._module.pos $Heap@1))) (=> (and (and (and ($Is intType (int_2_U (- |y#0@@3| |x#0@@10|)) Tclass._module.pos) (= |##x#3@0| (- |y#0@@3| |x#0@@10|))) (and ($IsAlloc intType (int_2_U |##x#3@0|) Tclass._module.pos $Heap@1) (|_module.__default.IsFactor#canCall| |p#0@0| (- |y#0@@3| |x#0@@10|)))) (and (and (|_module.__default.IsFactor#canCall| |p#0@0| (- |y#0@@3| |x#0@@10|)) (= (ControlFlow 0 2) (- 0 1))) (|_module.__default.IsFactor#canCall| |p#0@0| (- |y#0@@3| |x#0@@10|)))) (or (_module.__default.IsFactor |p#0@0| (- |y#0@@3| |x#0@@10|)) (exists ((|q#0@@0| Int) ) (! (= (Mul |p#0@0| |q#0@@0|) (- |y#0@@3| |x#0@@10|))
 :qid |gcddfy.8:10|
 :skolemid |663|
 :pattern ( (Mul |p#0@0| |q#0@@0|))
))))))))
