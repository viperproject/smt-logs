...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (|b#0| Int) (|c#0| Int) ) (!  (=> (or (|_module.__default.sum__is__sum#canCall| |b#0| |c#0|) (and (< 1 $FunctionContextHeight) ($IsGoodHeap $Heap))) (and (forall ((|$l#1#a#0| Int) ) (! (|_module.__default.sum#canCall| |$l#1#a#0| |b#0|)
 :qid |unknown.0:0|
 :skolemid |1135|
)) (= (_module.__default.sum__is__sum |b#0| |c#0|) (let ((|s#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#26| (Handle1 (|lambda#22| |b#0|) (|lambda#23| TInt) (|lambda#25| (SetRef_to_SetBox (|lambda#24| false))))) ($LS $LZ)))))
(forall ((|a#0| Int) ) (! (= (+ (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap |s#0| ($Box intType (int_2_U |a#0|))))) |c#0|) (+ (+ |a#0| |b#0|) |c#0|))
 :qid |gitissue167dfy.63:10|
 :skolemid |1134|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap |s#0| ($Box intType (int_2_U |a#0|)))))
))))))
 :qid |gitissue167dfy.61:17|
 :skolemid |1136|
 :pattern ( (_module.__default.sum__is__sum |b#0| |c#0|) ($IsGoodHeap $Heap))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|b#0@@0| Int) (|c#0@@0| Int) ) (!  (=> (or (|_module.__default.sum__is__sum#canCall| (LitInt |b#0@@0|) (LitInt |c#0@@0|)) (and (< 1 $FunctionContextHeight) ($IsGoodHeap $Heap@@0))) (and (forall ((|$l#4#a#0| Int) ) (! (|_module.__default.sum#canCall| |$l#4#a#0| (LitInt |b#0@@0|))
 :qid |unknown.0:0|
 :skolemid |1138|
)) (= (_module.__default.sum__is__sum (LitInt |b#0@@0|) (LitInt |c#0@@0|)) (let ((|s#1| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#26| (Handle1 (|lambda#22| (LitInt |b#0@@0|)) (|lambda#23| TInt) (|lambda#25| (SetRef_to_SetBox (|lambda#24| false))))) ($LS $LZ)))))
...
(set-info :boogie-vc-id Impl$$_module.__default.TestApply)
