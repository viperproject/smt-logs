...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@0 T@U) ($Heap@@0 T@U) (|a#0@@0| T@U) (|lo#0@@0| Int) (|hi#0@@0| Int) ) (!  (=> (or (|_module.__default.Sum#canCall| $Heap@@0 |a#0@@0| |lo#0@@0| |hi#0@@0|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) ($Is refType |a#0@@0| (Tclass._System.array TInt))) (and (and (<= (LitInt 0) |lo#0@@0|) (<= |lo#0@@0| |hi#0@@0|)) (<= |hi#0@@0| (_System.array.Length |a#0@@0|)))))) (and (=> (or (not (= |lo#0@@0| |hi#0@@0|)) (not true)) (|_module.__default.Sum#canCall| $Heap@@0 |a#0@@0| (+ |lo#0@@0| 1) |hi#0@@0|)) (= (_module.__default.Sum ($LS $ly@@0) $Heap@@0 |a#0@@0| |lo#0@@0| |hi#0@@0|) (ite (= |lo#0@@0| |hi#0@@0|) 0 (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |a#0@@0|) (IndexField |lo#0@@0|)))) (_module.__default.Sum $ly@@0 $Heap@@0 |a#0@@0| (+ |lo#0@@0| 1) |hi#0@@0|))))))
 :qid |Regression6dfy.3:10|
 :skolemid |538|
 :pattern ( (_module.__default.Sum ($LS $ly@@0) $Heap@@0 |a#0@@0| |lo#0@@0| |hi#0@@0|) ($IsGoodHeap $Heap@@0))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon14_Else_correct  (=> (or (not (= |lo#0@@1| |hi#0@@1|)) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 12)) (or (not (= |a#0@@1| null)) (not true))) (=> (or (not (= |a#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 11)) (and (<= 0 |lo#0@@1|) (< |lo#0@@1| (_System.array.Length |a#0@@1|)))) (=> (and (<= 0 |lo#0@@1|) (< |lo#0@@1| (_System.array.Length |a#0@@1|))) (=> (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |a#0@@1| (IndexField |lo#0@@1|)))) (=> (and (and ($IsAlloc refType |a#0@@1| (Tclass._System.array TInt) $Heap@@1) (= |##lo#0@0| (+ |lo#0@@1| 1))) (and ($IsAlloc intType (int_2_U |##lo#0@0|) TInt $Heap@@1) ($IsAlloc intType (int_2_U |hi#0@@1|) TInt $Heap@@1))) (and (=> (= (ControlFlow 0 4) (- 0 10)) (<= (LitInt 0) |##lo#0@0|)) (and (=> (= (ControlFlow 0 4) (- 0 9)) (<= |##lo#0@0| |hi#0@@1|)) (and (=> (= (ControlFlow 0 4) (- 0 8)) (<= |hi#0@@1| (_System.array.Length |a#0@@1|))) (=> (and (and (and (<= (LitInt 0) |##lo#0@0|) (<= |##lo#0@0| |hi#0@@1|)) (<= |hi#0@@1| (_System.array.Length |a#0@@1|))) (= |b$reqreads#1@0| (forall (($o@@6 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@6) alloc)))) (= $o@@6 |a#0@@1|)) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@6 $f@@0)))
 :qid |Regression6dfy.8:35|
 :skolemid |539|
)))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (or (<= 0 (- |hi#0@@1| |lo#0@@1|)) (= (- |hi#0@@1| |##lo#0@0|) (- |hi#0@@1| |lo#0@@1|)))) (=> (or (<= 0 (- |hi#0@@1| |lo#0@@1|)) (= (- |hi#0@@1| |##lo#0@0|) (- |hi#0@@1| |lo#0@@1|))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (< (- |hi#0@@1| |##lo#0@0|) (- |hi#0@@1| |lo#0@@1|))) (=> (< (- |hi#0@@1| |##lo#0@0|) (- |hi#0@@1| |lo#0@@1|)) (=> (and (and (|_module.__default.Sum#canCall| $Heap@@1 |a#0@@1| (+ |lo#0@@1| 1) |hi#0@@1|) (= (_module.__default.Sum ($LS $LZ) $Heap@@1 |a#0@@1| |lo#0@@1| |hi#0@@1|) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |a#0@@1|) (IndexField |lo#0@@1|)))) (_module.__default.Sum ($LS $LZ) $Heap@@1 |a#0@@1| (+ |lo#0@@1| 1) |hi#0@@1|)))) (and (|_module.__default.Sum#canCall| $Heap@@1 |a#0@@1| (+ |lo#0@@1| 1) |hi#0@@1|) ($Is intType (int_2_U (_module.__default.Sum ($LS $LZ) $Heap@@1 |a#0@@1| |lo#0@@1| |hi#0@@1|)) TInt))) (and (=> (= (ControlFlow 0 4) (- 0 5)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (=> (= (ControlFlow 0 4) (- 0 3)) |b$reqreads#1@0|)))))))))))))))))))))
(let ((anon14_Then_correct true))
(let ((anon13_Then_correct true))
(let ((anon5_correct  (=> (and (and (<= (LitInt 0) |lo#0@@1|) (<= |lo#0@@1| |hi#0@@1|)) (<= |hi#0@@1| (_System.array.Length |a#0@@1|))) (and (and (=> (= (ControlFlow 0 13) 1) anon13_Then_correct) (=> (= (ControlFlow 0 13) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 13) 4) anon14_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (not (and (<= (LitInt 0) |lo#0@@1|) (<= |lo#0@@1| |hi#0@@1|))) (= (ControlFlow 0 16) 13)) anon5_correct)))
(let ((anon12_Then_correct  (=> (and (<= (LitInt 0) |lo#0@@1|) (<= |lo#0@@1| |hi#0@@1|)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (or (not (= |a#0@@1| null)) (not true))) (=> (or (not (= |a#0@@1| null)) (not true)) (=> (= (ControlFlow 0 14) 13) anon5_correct))))))
(let ((anon11_Else_correct  (=> (< |lo#0@@1| (LitInt 0)) (and (=> (= (ControlFlow 0 18) 14) anon12_Then_correct) (=> (= (ControlFlow 0 18) 16) anon12_Else_correct)))))
(let ((anon11_Then_correct  (=> (<= (LitInt 0) |lo#0@@1|) (and (=> (= (ControlFlow 0 17) 14) anon12_Then_correct) (=> (= (ControlFlow 0 17) 16) anon12_Else_correct)))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@1 alloc |a#0@@1|)) (and (=> (= (ControlFlow 0 19) 17) anon11_Then_correct) (=> (= (ControlFlow 0 19) 18) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) ($Is refType |a#0@@1| (Tclass._System.array TInt))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 20) 19))) anon0_correct)))
