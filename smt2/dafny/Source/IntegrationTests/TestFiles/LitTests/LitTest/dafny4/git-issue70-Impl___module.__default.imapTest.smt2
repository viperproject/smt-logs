...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|$y#3| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#6| |l#0| |l#1| |l#2| |l#3|) |$y#3|)) (exists ((|x#3| Int) ) (!  (and (U_2_bool (MapType0Select BoxType boolType |l#0| ($Box intType (int_2_U |x#3|)))) (= |$y#3| (MapType0Select BoxType BoxType |l#1| ($Box intType (int_2_U |x#3|)))))
 :qid |gitissue70dfy.26:16|
 :skolemid |493|
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType |l#3| ($Box intType (int_2_U |x#3|)))))
 :pattern ( (MapType0Select BoxType boolType |l#2| ($Box intType (int_2_U |x#3|))))
)))
 :qid |gitissue70dfy.26:22|
 :skolemid |498|
 :pattern ( (MapType0Select BoxType boolType (|lambda#6| |l#0| |l#1| |l#2| |l#3|) |$y#3|))
)))
...
(assert (forall ((|l#0@@0| T@U) (|l#1@@0| T@U) (|$y#1| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#5| |l#0@@0| |l#1@@0|) |$y#1|))  (and ($IsBox |$y#1| |l#0@@0|) (U_2_bool (MapType0Select BoxType boolType |l#1@@0| |$y#1|))))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |497|
 :pattern ( (MapType0Select BoxType boolType (|lambda#5| |l#0@@0| |l#1@@0|) |$y#1|))
)))
(assert (forall ((m@@9 T@U) (u@@4 T@U) (|u'| T@U) (v@@8 T@U) ) (!  (and (=> (= |u'| u@@4) (and (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| (|IMap#Build| m@@9 u@@4 v@@8)) |u'|)) (= (MapType0Select BoxType BoxType (|IMap#Elements| (|IMap#Build| m@@9 u@@4 v@@8)) |u'|) v@@8))) (=> (or (not (= |u'| u@@4)) (not true)) (and (= (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| (|IMap#Build| m@@9 u@@4 v@@8)) |u'|)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| m@@9) |u'|))) (= (MapType0Select BoxType BoxType (|IMap#Elements| (|IMap#Build| m@@9 u@@4 v@@8)) |u'|) (MapType0Select BoxType BoxType (|IMap#Elements| m@@9) |u'|)))))
 :qid |DafnyPreludebpl.1595:15|
 :skolemid |320|
 :pattern ( (MapType0Select BoxType boolType (|IMap#Domain| (|IMap#Build| m@@9 u@@4 v@@8)) |u'|))
 :pattern ( (MapType0Select BoxType BoxType (|IMap#Elements| (|IMap#Build| m@@9 u@@4 v@@8)) |u'|))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.imapTest)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon6_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (|ISet#Equal| (|lambda#6| (|IMap#Domain| |m#0@0|) (|IMap#Elements| |m#0@0|) (|IMap#Domain| |m#0@0|) (|IMap#Elements| |m#0@0|)) (|IMap#Values| |m#0@0|))) (=> (|ISet#Equal| (|lambda#6| (|IMap#Domain| |m#0@0|) (|IMap#Elements| |m#0@0|) (|IMap#Domain| |m#0@0|) (|IMap#Elements| |m#0@0|)) (|IMap#Values| |m#0@0|)) (=> (= (ControlFlow 0 4) (- 0 3)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Items| |m#0@0|) ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 4))) ($Box intType (int_2_U (LitInt 5)))))))))))))
(let ((anon10_Else_correct  (=> (and (not (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m#0@0|) ($Box intType (int_2_U |x#2@0|))))) (= (ControlFlow 0 8) 4)) anon6_correct)))
(let ((anon10_Then_correct  (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m#0@0|) ($Box intType (int_2_U |x#2@0|)))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m#0@0|) ($Box intType (int_2_U |x#2@0|))))) (=> (= (ControlFlow 0 6) 4) anon6_correct)))))
...
(let ((anon3_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (|ISet#Equal| (|lambda#5| TInt (|IMap#Domain| |m#0@0|)) (|IMap#Domain| |m#0@0|))) (=> (|ISet#Equal| (|lambda#5| TInt (|IMap#Domain| |m#0@0|)) (|IMap#Domain| |m#0@0|)) (and (=> (= (ControlFlow 0 10) 9) anon9_Then_correct) (=> (= (ControlFlow 0 10) 2) anon9_Else_correct))))))
(let ((anon8_Else_correct  (=> (and (not (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m#0@0|) ($Box intType (int_2_U |x#0@0|))))) (= (ControlFlow 0 13) 10)) anon3_correct)))
(let ((anon8_Then_correct  (=> (and (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m#0@0|) ($Box intType (int_2_U |x#0@0|)))) (= (ControlFlow 0 12) 10)) anon3_correct)))
...
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |m#0@0| (Lit IMapType (|IMap#Build| (|IMap#Build| |IMap#Empty| ($Box intType (int_2_U (LitInt 4))) ($Box intType (int_2_U (LitInt 5)))) ($Box intType (int_2_U (LitInt 6))) ($Box intType (int_2_U (LitInt 7))))))) (and (=> (= (ControlFlow 0 15) 14) anon7_Then_correct) (=> (= (ControlFlow 0 15) 1) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is IMapType |m#0| (TIMap TInt TInt)) ($IsAlloc IMapType |m#0| (TIMap TInt TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 16) 15))) anon0_correct))))
