...
(declare-fun _module.__default.foo (Int Int) T@U)
(declare-fun LitInt (Int) Int)
(declare-fun |_module.__default.foo#canCall| (Int Int) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0| Int) (|y#0| Int) ) (!  (=> (or (|_module.__default.foo#canCall| (LitInt |x#0|) (LitInt |y#0|)) (< 0 $FunctionContextHeight)) (= (_module.__default.foo (LitInt |x#0|) (LitInt |y#0|)) (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt |x#0|))) ($Box intType (int_2_U (LitInt |y#0|)))))))
 :qid |gitissue5dfy.41:20|
 :weight 3
 :skolemid |1607|
 :pattern ( (_module.__default.foo (LitInt |x#0|) (LitInt |y#0|)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@0| Int) (|y#0@@0| Int) ) (!  (=> (or (|_module.__default.foo#canCall| |x#0@@0| |y#0@@0|) (< 0 $FunctionContextHeight)) (and (|_System.Tuple2#Equal| (_module.__default.foo |x#0@@0| |y#0@@0|) (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |x#0@@0|)) ($Box intType (int_2_U |y#0@@0|)))) ($Is DatatypeTypeType (_module.__default.foo |x#0@@0| |y#0@@0|) (Tclass._System.Tuple2 TInt TInt))))
 :qid |gitissue5dfy.41:20|
 :skolemid |1604|
 :pattern ( (_module.__default.foo |x#0@@0| |y#0@@0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@1| Int) (|y#0@@1| Int) ) (!  (=> (or (|_module.__default.foo#canCall| |x#0@@1| |y#0@@1|) (< 0 $FunctionContextHeight)) (= (_module.__default.foo |x#0@@1| |y#0@@1|) (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |x#0@@1|)) ($Box intType (int_2_U |y#0@@1|)))))
 :qid |gitissue5dfy.41:20|
 :skolemid |1606|
 :pattern ( (_module.__default.foo |x#0@@1| |y#0@@1|))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (|_System.Tuple2#Equal| |v#0| (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |x#0@@2|)) ($Box intType (int_2_U |y#0@@2|)))))))
(let ((anon5_Else_correct  (=> (and (and (= (_module.__default.foo |x#0@@2| |y#0@@2|) (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |x#0@@2|)) ($Box intType (int_2_U |y#0@@2|)))) ($Is DatatypeTypeType (_module.__default.foo |x#0@@2| |y#0@@2|) (Tclass._System.Tuple2 TInt TInt))) (and (= (_module.__default.foo |x#0@@2| |y#0@@2|) |v#0|) (= (ControlFlow 0 4) 3))) GeneratedUnifiedExit_correct)))
