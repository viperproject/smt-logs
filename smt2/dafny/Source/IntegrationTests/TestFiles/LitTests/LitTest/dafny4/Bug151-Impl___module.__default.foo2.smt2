...
(declare-fun _module._default.foo2$_T0 () T@U)
(declare-fun _module._default.foo2$_T1 () T@U)
(declare-fun $Heap@@0 () T@U)
(declare-fun |x#0@0| () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id Impl$$_module.__default.foo2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_correct  (=> (and (and ($IsAlloc MapType |xs#0| (TMap _module._default.foo2$_T0 _module._default.foo2$_T1) $Heap@@0) (|_module.__default.domain#canCall| _module._default.foo2$_T0 _module._default.foo2$_T1 |xs#0|)) (and (|_module.__default.domain#canCall| _module._default.foo2$_T0 _module._default.foo2$_T1 |xs#0|) (= (ControlFlow 0 2) (- 0 1)))) (|Set#Equal| (|Set#FromBoogieMap| (|lambda#1| _module._default.foo2$_T0 (|Map#Domain| |xs#0|))) (_module.__default.domain _module._default.foo2$_T0 _module._default.foo2$_T1 |xs#0|)))))
(let ((anon5_Else_correct  (=> (and (not (|Set#IsMember| (|Map#Domain| |xs#0|) |x#0@0|)) (= (ControlFlow 0 5) 2)) anon3_correct)))
(let ((anon5_Then_correct  (=> (and (|Set#IsMember| (|Map#Domain| |xs#0|) |x#0@0|) (= (ControlFlow 0 4) 2)) anon3_correct)))
(let ((anon4_Then_correct  (=> (and ($IsBox |x#0@0| _module._default.foo2$_T0) ($IsAllocBox |x#0@0| _module._default.foo2$_T0 $Heap@@0)) (and (=> (= (ControlFlow 0 6) 4) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct)))))
(let ((anon4_Else_correct  (=> (and (not (and ($IsBox |x#0@0| _module._default.foo2$_T0) ($IsAllocBox |x#0@0| _module._default.foo2$_T0 $Heap@@0))) (= (ControlFlow 0 3) 2)) anon3_correct)))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is MapType |xs#0| (TMap _module._default.foo2$_T0 _module._default.foo2$_T1)) ($IsAlloc MapType |xs#0| (TMap _module._default.foo2$_T0 _module._default.foo2$_T1) $Heap@@0)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
