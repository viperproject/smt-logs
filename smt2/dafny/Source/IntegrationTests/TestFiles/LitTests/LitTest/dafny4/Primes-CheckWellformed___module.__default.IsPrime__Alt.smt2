...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.IsPrime__Alt)
...
(let ((anon19_Else_correct  (=> (and (not (and (and (<= (LitInt 2) |m#2@0|) (< |m#2@0| |n#0@@3|)) (_module.__default.IsPrime |m#2@0|))) (= (ControlFlow 0 7) 2)) anon12_correct)))
(let ((anon19_Then_correct  (=> (and (and (<= (LitInt 2) |m#2@0|) (< |m#2@0| |n#0@@3|)) (_module.__default.IsPrime |m#2@0|)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= |m#2@0| 0)) (not true))) (=> (or (not (= |m#2@0| 0)) (not true)) (=> (= (ControlFlow 0 5) 2) anon12_correct))))))
(let ((anon18_Else_correct  (=> (not (and (<= (LitInt 2) |m#2@0|) (< |m#2@0| |n#0@@3|))) (and (=> (= (ControlFlow 0 9) 5) anon19_Then_correct) (=> (= (ControlFlow 0 9) 7) anon19_Else_correct)))))
(let ((anon18_Then_correct  (=> (and (and (<= (LitInt 2) |m#2@0|) (< |m#2@0| |n#0@@3|)) (and ($IsAlloc intType (int_2_U |m#2@0|) TInt $Heap) (|_module.__default.IsPrime#canCall| |m#2@0|))) (and (=> (= (ControlFlow 0 8) 5) anon19_Then_correct) (=> (= (ControlFlow 0 8) 7) anon19_Else_correct)))))
(let ((anon17_Else_correct  (=> (< |m#2@0| (LitInt 2)) (and (=> (= (ControlFlow 0 11) 8) anon18_Then_correct) (=> (= (ControlFlow 0 11) 9) anon18_Else_correct)))))
(let ((anon17_Then_correct  (=> (<= (LitInt 2) |m#2@0|) (and (=> (= (ControlFlow 0 10) 8) anon18_Then_correct) (=> (= (ControlFlow 0 10) 9) anon18_Else_correct)))))
(let ((anon16_Then_correct  (and (=> (= (ControlFlow 0 12) 10) anon17_Then_correct) (=> (= (ControlFlow 0 12) 11) anon17_Else_correct))))
(let ((anon15_Then_correct  (=> (<= (LitInt 2) |n#0@@3|) (and (=> (= (ControlFlow 0 13) 12) anon16_Then_correct) (=> (= (ControlFlow 0 13) 4) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (< |n#0@@3| (LitInt 2)) (= (ControlFlow 0 3) 2)) anon12_correct)))
(let ((anon14_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 14) 1) anon14_Then_correct) (=> (= (ControlFlow 0 14) 13) anon15_Then_correct)) (=> (= (ControlFlow 0 14) 3) anon15_Else_correct)))))
