...
(assert (distinct TBool TagBool alloc Tagclass._module.RecType |##_module.RecType.Bottom| |##_module.RecType.Top| |##_module.RecType.Arrow| tytagFamily$RecType)
)
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Subtype)
...
(let ((anon19_Else_correct  (=> (and (not (and (and (_module.RecType.Arrow_q |a#0@@8|) (_module.RecType.Arrow_q |b#0@@8|)) (_module.__default.Subtype ($LS $LZ) (_module.RecType.dom |b#0@@8|) (_module.RecType.dom |a#0@@8|)))) (= (ControlFlow 0 7) 2)) anon12_correct)))
(let ((anon19_Then_correct  (=> (and (and (_module.RecType.Arrow_q |a#0@@8|) (_module.RecType.Arrow_q |b#0@@8|)) (_module.__default.Subtype ($LS $LZ) (_module.RecType.dom |b#0@@8|) (_module.RecType.dom |a#0@@8|))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (_module.RecType.Arrow_q |a#0@@8|)) (=> (_module.RecType.Arrow_q |a#0@@8|) (=> (and (= |##a#1@0| (_module.RecType.ran |a#0@@8|)) ($IsAlloc DatatypeTypeType |##a#1@0| Tclass._module.RecType $Heap)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (_module.RecType.Arrow_q |b#0@@8|)) (=> (_module.RecType.Arrow_q |b#0@@8|) (=> (and (and (= |##b#1@0| (_module.RecType.ran |b#0@@8|)) ($IsAlloc DatatypeTypeType |##b#1@0| Tclass._module.RecType $Heap)) (and (|_module.__default.Subtype#canCall| (_module.RecType.ran |a#0@@8|) (_module.RecType.ran |b#0@@8|)) (= (ControlFlow 0 4) 2))) anon12_correct)))))))))
(let ((anon18_Else_correct  (=> (not (and (_module.RecType.Arrow_q |a#0@@8|) (_module.RecType.Arrow_q |b#0@@8|))) (and (=> (= (ControlFlow 0 11) 4) anon19_Then_correct) (=> (= (ControlFlow 0 11) 7) anon19_Else_correct)))))
(let ((anon18_Then_correct  (=> (and (_module.RecType.Arrow_q |a#0@@8|) (_module.RecType.Arrow_q |b#0@@8|)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (_module.RecType.Arrow_q |b#0@@8|)) (=> (_module.RecType.Arrow_q |b#0@@8|) (=> (and (= |##a#0@0| (_module.RecType.dom |b#0@@8|)) ($IsAlloc DatatypeTypeType |##a#0@0| Tclass._module.RecType $Heap)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (_module.RecType.Arrow_q |a#0@@8|)) (=> (_module.RecType.Arrow_q |a#0@@8|) (=> (= |##b#0@0| (_module.RecType.dom |a#0@@8|)) (=> (and ($IsAlloc DatatypeTypeType |##b#0@0| Tclass._module.RecType $Heap) (|_module.__default.Subtype#canCall| (_module.RecType.dom |b#0@@8|) (_module.RecType.dom |a#0@@8|))) (and (=> (= (ControlFlow 0 8) 4) anon19_Then_correct) (=> (= (ControlFlow 0 8) 7) anon19_Else_correct))))))))))))
(let ((anon17_Else_correct  (=> (not (_module.RecType.Arrow_q |a#0@@8|)) (and (=> (= (ControlFlow 0 13) 8) anon18_Then_correct) (=> (= (ControlFlow 0 13) 11) anon18_Else_correct)))))
(let ((anon17_Then_correct  (=> (_module.RecType.Arrow_q |a#0@@8|) (and (=> (= (ControlFlow 0 12) 8) anon18_Then_correct) (=> (= (ControlFlow 0 12) 11) anon18_Else_correct)))))
(let ((anon16_Then_correct  (=> (not (or (|$Eq#_module.RecType| ($LS ($LS $LZ)) |a#0@@8| |#_module.RecType.Bottom|) (|$Eq#_module.RecType| ($LS ($LS $LZ)) |b#0@@8| |#_module.RecType.Top|))) (and (=> (= (ControlFlow 0 14) 12) anon17_Then_correct) (=> (= (ControlFlow 0 14) 13) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (and (or (|$Eq#_module.RecType| ($LS ($LS $LZ)) |a#0@@8| |#_module.RecType.Bottom|) (|$Eq#_module.RecType| ($LS ($LS $LZ)) |b#0@@8| |#_module.RecType.Top|)) (= (ControlFlow 0 3) 2)) anon12_correct)))
(let ((anon15_Else_correct  (=> (|$Eq#_module.RecType| ($LS ($LS $LZ)) |a#0@@8| |#_module.RecType.Bottom|) (and (=> (= (ControlFlow 0 16) 14) anon16_Then_correct) (=> (= (ControlFlow 0 16) 3) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (not (|$Eq#_module.RecType| ($LS ($LS $LZ)) |a#0@@8| |#_module.RecType.Bottom|)) (and (=> (= (ControlFlow 0 15) 14) anon16_Then_correct) (=> (= (ControlFlow 0 15) 3) anon16_Else_correct)))))
(let ((anon14_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 17) 1) anon14_Then_correct) (=> (= (ControlFlow 0 17) 15) anon15_Then_correct)) (=> (= (ControlFlow 0 17) 16) anon15_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |a#0@@8| Tclass._module.RecType) ($Is DatatypeTypeType |b#0@@8| Tclass._module.RecType)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 18) 17))) anon0_correct))))
