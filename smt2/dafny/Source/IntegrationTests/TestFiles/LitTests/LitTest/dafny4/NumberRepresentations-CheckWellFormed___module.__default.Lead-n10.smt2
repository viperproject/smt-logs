...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.LeadingZeroInsignificant)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (<= (LitInt 2) |base#0@@3|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and ($IsAlloc SeqType |digits#0@@3| (TSeq TInt) $Heap@0) ($IsAlloc intType (int_2_U |base#0@@3|) TInt $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 2) |base#0@@3|)) (=> (and (<= (LitInt 2) |base#0@@3|) (|_module.__default.eval#canCall| |digits#0@@3| |base#0@@3|)) (=> (and (and (= |##digits#1@0| (|Seq#Append| |digits#0@@3| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 0)))))) ($IsAlloc SeqType |##digits#1@0| (TSeq TInt) $Heap@0)) (and ($IsAlloc intType (int_2_U |base#0@@3|) TInt $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (<= (LitInt 2) |base#0@@3|))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |digits#0@@3| (TSeq TInt)) ($IsAlloc SeqType |digits#0@@3| (TSeq TInt) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
