...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly T@U) (|m#0| Int) (|n#0| Int) (|list#0| T@U) ) (!  (=> (or (|_module.__default.SortedRange#canCall| |m#0| |n#0| (Lit DatatypeTypeType |list#0|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |list#0| (Tclass._module.List TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |list#0|)))))) (let ((|tl#3| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |list#0|)))))
(let ((|hd#3| (LitInt (U_2_int ($Unbox intType (_module.List._h0 (Lit DatatypeTypeType |list#0|)))))))
 (=> (<= |m#0| |hd#3|) (=> (<= |hd#3| |n#0|) (|_module.__default.SortedRange#canCall| |hd#3| |n#0| |tl#3|)))))) (= (_module.__default.SortedRange ($LS $ly) |m#0| |n#0| (Lit DatatypeTypeType |list#0|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |list#0|)) (<= |m#0| |n#0|) (let ((|tl#2| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |list#0|)))))
(let ((|hd#2| (LitInt (U_2_int ($Unbox intType (_module.List._h0 (Lit DatatypeTypeType |list#0|)))))))
 (and (and (<= |m#0| |hd#2|) (<= |hd#2| |n#0|)) (_module.__default.SortedRange ($LS $ly) |hd#2| |n#0| |tl#2|))))))))
 :qid |FstarQuickSortdfy.26:17|
 :weight 3
 :skolemid |668|
 :pattern ( (_module.__default.SortedRange ($LS $ly) |m#0| |n#0| (Lit DatatypeTypeType |list#0|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@0 T@U) (|m#0@@0| Int) (|n#0@@0| Int) (|list#0@@0| T@U) ) (!  (=> (or (|_module.__default.SortedRange#canCall| (LitInt |m#0@@0|) (LitInt |n#0@@0|) (Lit DatatypeTypeType |list#0@@0|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |list#0@@0| (Tclass._module.List TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |list#0@@0|)))))) (let ((|tl#5| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |list#0@@0|)))))
(let ((|hd#5| (LitInt (U_2_int ($Unbox intType (_module.List._h0 (Lit DatatypeTypeType |list#0@@0|)))))))
 (=> (<= (LitInt |m#0@@0|) |hd#5|) (=> (<= |hd#5| (LitInt |n#0@@0|)) (|_module.__default.SortedRange#canCall| |hd#5| (LitInt |n#0@@0|) |tl#5|)))))) (= (_module.__default.SortedRange ($LS $ly@@0) (LitInt |m#0@@0|) (LitInt |n#0@@0|) (Lit DatatypeTypeType |list#0@@0|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |list#0@@0|)) (<= (LitInt |m#0@@0|) (LitInt |n#0@@0|)) (let ((|tl#4| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |list#0@@0|)))))
(let ((|hd#4| (LitInt (U_2_int ($Unbox intType (_module.List._h0 (Lit DatatypeTypeType |list#0@@0|)))))))
 (and (and (<= (LitInt |m#0@@0|) |hd#4|) (<= |hd#4| (LitInt |n#0@@0|))) (_module.__default.SortedRange ($LS $ly@@0) |hd#4| (LitInt |n#0@@0|) |tl#4|))))))))
 :qid |FstarQuickSortdfy.26:17|
 :weight 3
 :skolemid |669|
 :pattern ( (_module.__default.SortedRange ($LS $ly@@0) (LitInt |m#0@@0|) (LitInt |n#0@@0|) (Lit DatatypeTypeType |list#0@@0|)))
))))
...
(assert (forall (($ly@@1 T@U) (|m#0@@1| Int) (|n#0@@1| Int) (|list#0@@1| T@U) ) (! (= (_module.__default.SortedRange ($LS $ly@@1) |m#0@@1| |n#0@@1| |list#0@@1|) (_module.__default.SortedRange $ly@@1 |m#0@@1| |n#0@@1| |list#0@@1|))
 :qid |FstarQuickSortdfy.26:17|
 :skolemid |663|
 :pattern ( (_module.__default.SortedRange ($LS $ly@@1) |m#0@@1| |n#0@@1| |list#0@@1|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) (|m#0@@2| Int) (|n#0@@2| Int) (|list#0@@2| T@U) ) (!  (=> (or (|_module.__default.SortedRange#canCall| |m#0@@2| |n#0@@2| |list#0@@2|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |list#0@@2| (Tclass._module.List TInt)))) (and (=> (not (_module.List.Nil_q |list#0@@2|)) (let ((|tl#1| (_module.List._h1 |list#0@@2|)))
(let ((|hd#1| (U_2_int ($Unbox intType (_module.List._h0 |list#0@@2|)))))
 (=> (<= |m#0@@2| |hd#1|) (=> (<= |hd#1| |n#0@@2|) (|_module.__default.SortedRange#canCall| |hd#1| |n#0@@2| |tl#1|)))))) (= (_module.__default.SortedRange ($LS $ly@@2) |m#0@@2| |n#0@@2| |list#0@@2|) (ite (_module.List.Nil_q |list#0@@2|) (<= |m#0@@2| |n#0@@2|) (let ((|tl#0| (_module.List._h1 |list#0@@2|)))
(let ((|hd#0| (U_2_int ($Unbox intType (_module.List._h0 |list#0@@2|)))))
 (and (and (<= |m#0@@2| |hd#0|) (<= |hd#0| |n#0@@2|)) (_module.__default.SortedRange $ly@@2 |hd#0| |n#0@@2| |tl#0|))))))))
 :qid |FstarQuickSortdfy.26:17|
 :skolemid |667|
 :pattern ( (_module.__default.SortedRange ($LS $ly@@2) |m#0@@2| |n#0@@2| |list#0@@2|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.SortedRange)
...
(let ((anon16_Else_correct  (=> (and (not (and (<= |m#0@@3| |hd#Z#0@0|) (<= |hd#Z#0@0| |n#0@@3|))) (= (ControlFlow 0 7) 4)) anon9_correct)))
(let ((anon16_Then_correct  (=> (and (and (and (<= |m#0@@3| |hd#Z#0@0|) (<= |hd#Z#0@0| |n#0@@3|)) ($IsAlloc intType (int_2_U |hd#Z#0@0|) TInt $Heap)) (and ($IsAlloc intType (int_2_U |n#0@@3|) TInt $Heap) ($IsAlloc DatatypeTypeType |tl#Z#0@0| (Tclass._module.List TInt) $Heap))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< (DtRank |tl#Z#0@0|) (DtRank |list#0@@3|))) (=> (< (DtRank |tl#Z#0@0|) (DtRank |list#0@@3|)) (=> (and (|_module.__default.SortedRange#canCall| |hd#Z#0@0| |n#0@@3| |tl#Z#0@0|) (= (ControlFlow 0 5) 4)) anon9_correct))))))
(let ((anon15_Else_correct  (=> (< |hd#Z#0@0| |m#0@@3|) (and (=> (= (ControlFlow 0 9) 5) anon16_Then_correct) (=> (= (ControlFlow 0 9) 7) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (<= |m#0@@3| |hd#Z#0@0|) (and (=> (= (ControlFlow 0 8) 5) anon16_Then_correct) (=> (= (ControlFlow 0 8) 7) anon16_Else_correct)))))
(let ((anon14_Then_correct  (=> (and (and (and (= |list#0@@3| (|#_module.List.Cons| ($Box intType (int_2_U |_mcc#0#0|)) |_mcc#1#0|)) ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List TInt))) (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List TInt)))) (and (and (= |tl#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|)) (and ($Is intType (int_2_U |let#1#0#0|) TInt) (= |hd#Z#0@0| |let#1#0#0|)))) (and (=> (= (ControlFlow 0 10) 8) anon15_Then_correct) (=> (= (ControlFlow 0 10) 9) anon15_Else_correct)))))
(let ((anon14_Else_correct true))
(let ((anon13_Else_correct  (=> (or (not (= |list#0@@3| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 11) 10) anon14_Then_correct) (=> (= (ControlFlow 0 11) 3) anon14_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |list#0@@3| (Tclass._module.List TInt))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 13) 12))) anon0_correct)))
