// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy
...
axiom 1 <= $FunctionContextHeight
   ==> 
  _module.__default.GenesisBlock#canCall() || 1 < $FunctionContextHeight
...
axiom {:id "id0"} 1 <= $FunctionContextHeight
  ...
  _module.__default.GenesisBlock#canCall() || 1 < $FunctionContextHeight
   ==> _module.__default.GenesisBlock()
     == Lit(#_module.Block.Block($Box(LitInt(0)), Lit(Seq#Empty(): Seq), $Box(LitInt(0))));
...
procedure {:verboseName "GenesisBlock (well-formedness)"} CheckWellformed$$_module.__default.GenesisBlock();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "IsGenesisBlock (well-formedness)"} CheckWellFormed$$_module.__default.IsGenesisBlock(b#0: DatatypeType
...
procedure {:verboseName "IsGenesisBlock (call)"} Call$$_module.__default.IsGenesisBlock(b#0: DatatypeType
       where $Is(b#0, Tclass._module.Block(TInt, TInt, TInt))
         && $IsAlloc(b#0, Tclass._module.Block(TInt, TInt, TInt), $Heap)
         && $IsA#_module.Block(b#0))
   returns (eq#0: bool);
  ...
  ensures {:id "id4"} eq#0 <==> _module.Block#Equal(b#0, _module.__default.GenesisBlock());
...
procedure {:verboseName "IsGenesisBlock (correctness)"} Impl$$_module.__default.IsGenesisBlock(b#0: DatatypeType
       where $Is(b#0, Tclass._module.Block(TInt, TInt, TInt))
         && $IsAlloc(b#0, Tclass._module.Block(TInt, TInt, TInt), $Heap)
         && $IsA#_module.Block(b#0))
  ...
  free ensures $IsA#_module.Block(b#0)
     && $IsA#_module.Block(Lit(_module.__default.GenesisBlock()))
     && _module.__default.GenesisBlock#canCall();
  ensures {:id "id5"} eq#0 <==> _module.Block#Equal(b#0, _module.__default.GenesisBlock());
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
    $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "IsGenesisBlock (correctness)"} Impl$$_module.__default.IsGenesisBlock(b#0: DatatypeType) returns (eq#0: bool, $_reverifyPost: bool)
{
  ...
  var gb#0: DatatypeType
    ...
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(13,10)
    assume true;
    ...
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(14,6)
    assume true;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Main (correctness)"} Impl$$_module.__default.Main() returns ($_reverifyPost: bool)
{
  ...
  var b##0: DatatypeType;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(18,9)
    assume true;
    assume _module.__default.GenesisBlock#canCall();
    assume _module.Block.Block_q(Lit(_module.__default.GenesisBlock()));
    assume _module.__default.GenesisBlock#canCall();
    b#0 := Lit(_module.__default.GenesisBlock());
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(19,27)
    assume true;
    ...
    b##0 := b#0;
    call {:id "id9"} $rhs##0 := Call$$_module.__default.IsGenesisBlock(b##0);
    // TrCallStmt: After ProcessCallStmt
    eq#0 := $rhs##0;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(20,3)
    assume true;
    assert {:id "id11"} eq#0;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(21,3)
    assume true;
    assume true;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(22,9)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id12"} Call$$_module.__default.TestEq();
    // TrCallStmt: After ProcessCallStmt
}
...
procedure {:verboseName "TestAny (well-formedness)"} CheckWellformed$$_module.__default.TestAny(_module._default.TestAny$G: Ty, 
...
procedure {:verboseName "TestEq (well-formedness)"} CheckWellFormed$$_module.__default.TestEq();
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "TestEq (call)"} Call$$_module.__default.TestEq();
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "TestEq (correctness)"} Impl$$_module.__default.TestEq() returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestEq (correctness)"} Impl$$_module.__default.TestEq() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var ##a#0: bool;
  var ##b#0: bool;
  ...
  var $rhs#8: Box;
  var $rhs#9: Box;
  var defass#obj#0: bool;
  var obj#0: ref
     where defass#obj#0
       ==> $Is(obj#0, Tclass._module.MyClass())
         && $IsAlloc(obj#0, Tclass._module.MyClass(), $Heap);
  var $nw: ref;
  var ##a#8: ref;
  var ##b#8: ref;
  var defass#x0#0: bool;
  var x0#0: DatatypeType
     where defass#x0#0
       ==> $Is(x0#0, Tclass._module.X()) && $IsAlloc(x0#0, Tclass._module.X(), $Heap);
  var newtype$check#4: int;
  var newtype$check#5: int;
  var defass#x1#0: bool;
  var x1#0: DatatypeType
     where defass#x1#0
       ==> $Is(x1#0, Tclass._module.X()) && $IsAlloc(x1#0, Tclass._module.X(), $Heap);
  ...
  var ##b#12: Map;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(38,3)
    assume true;
    assume true;
    ##a#0 := Lit(true);
    ...
    assert {:id "id17"} {:subsumption 0} ##a#0 == ##b#0;
    assume _module.__default.TestAny#canCall(TBool, $Box(Lit(true)), $Box(Lit(true)));
    assume _module.__default.TestAny#canCall(TBool, $Box(Lit(true)), $Box(Lit(true)));
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(39,3)
    assume true;
    assume true;
    ...
    assert {:id "id18"} {:subsumption 0} ##a#1 == ##b#1;
    assume _module.__default.TestAny#canCall(TChar, $Box(Lit(char#FromInt(101))), $Box(Lit(char#FromInt(101))));
    assume _module.__default.TestAny#canCall(TChar, $Box(Lit(char#FromInt(101))), $Box(Lit(char#FromInt(101))));
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(40,3)
    assume true;
    assume true;
    ##a#2 := LitInt(12);
    // assume allocatedness for argument to function
    ...
    assert {:id "id19"} {:subsumption 0} ##a#2 == ##b#2;
    assume _module.__default.TestAny#canCall(TInt, $Box(LitInt(12)), $Box(LitInt(12)));
    assume _module.__default.TestAny#canCall(TInt, $Box(LitInt(12)), $Box(LitInt(12)));
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(41,3)
    assume true;
    assume true;
    ##a#3 := LitReal(375e-1);
    // assume allocatedness for argument to function
    ...
    assert {:id "id20"} {:subsumption 0} ##a#3 == ##b#3;
    assume _module.__default.TestAny#canCall(TReal, $Box(LitReal(375e-1)), $Box(LitReal(375e-1)));
    assume _module.__default.TestAny#canCall(TReal, $Box(LitReal(375e-1)), $Box(LitReal(375e-1)));
    assume true;
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(42,22)
    assume true;
    assume true;
    ...
    m0#0 := $rhs#0;
    m1#0 := $rhs#1;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(43,3)
    assume true;
    assume true;
    ##a#4 := m0#0;
    // assume allocatedness for argument to function
    ...
    assert {:id "id25"} {:subsumption 0} ##a#4 == ##b#4;
    assume _module.__default.TestAny#canCall(Tclass._module.nt(), $Box(m0#0), $Box(m1#0));
    assume _module.__default.TestAny#canCall(Tclass._module.nt(), $Box(m0#0), $Box(m1#0));
    assume true;
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(44,34)
    assume true;
    assume true;
    newtype$check#2 := LitInt(12);
    assert {:id "id26"} LitInt(-100) <= newtype$check#2 && newtype$check#2 < 100;
    assume true;
    $rhs#2 := LitInt(12);
    newtype$check#3 := LitInt(12);
    assert {:id "id28"} LitInt(-100) <= newtype$check#3 && newtype$check#3 < 100;
    assume true;
    $rhs#3 := LitInt(12);
    n0#0 := $rhs#2;
    n1#0 := $rhs#3;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(45,3)
    assume true;
    assume true;
    ##a#5 := n0#0;
    // assume allocatedness for argument to function
    ...
    assert {:id "id32"} {:subsumption 0} ##a#5 == ##b#5;
    assume _module.__default.TestAny#canCall(Tclass._module.ntNative(), $Box(n0#0), $Box(n1#0));
    assume _module.__default.TestAny#canCall(Tclass._module.ntNative(), $Box(n0#0), $Box(n1#0));
    assume true;
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(46,24)
    assume true;
    assume true;
    assume true;
    $rhs#4 := Lit(12bv8);
    ...
    b0#0 := $rhs#4;
    b1#0 := $rhs#5;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(47,3)
    assume true;
    assume true;
    ##a#6 := b0#0;
    // assume allocatedness for argument to function
    ...
    assert {:id "id37"} {:subsumption 0} ##a#6 == ##b#6;
    assume _module.__default.TestAny#canCall(TBitvector(8), $Box(b0#0), $Box(b1#0));
    assume _module.__default.TestAny#canCall(TBitvector(8), $Box(b0#0), $Box(b1#0));
    assume true;
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(48,28)
    assume true;
    assume true;
    assume true;
    $rhs#6 := Lit(12bv167);
    ...
    c0#0 := $rhs#6;
    c1#0 := $rhs#7;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(49,3)
    assume true;
    assume true;
    ##a#7 := c0#0;
    // assume allocatedness for argument to function
    ...
    assert {:id "id42"} {:subsumption 0} ##a#7 == ##b#7;
    assume _module.__default.TestAny#canCall(TBitvector(167), $Box(c0#0), $Box(c1#0));
    assume _module.__default.TestAny#canCall(TBitvector(167), $Box(c0#0), $Box(c1#0));
    assume true;
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(50,32)
    assume true;
    assume true;
    assume true;
    ...
    o0#0 := $rhs#8;
    o1#0 := $rhs#9;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(51,3)
    assume true;
    assume true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(52,11)
    assume true;
    havoc $nw;
    ...
    obj#0 := $nw;
    defass#obj#0 := true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(53,3)
    assert {:id "id48"} defass#obj#0;
    assert {:id "id49"} defass#obj#0;
    assume true;
    assume true;
    assert {:id "id50"} defass#obj#0;
    ##a#8 := obj#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##a#8, Tclass._module.MyClass(), $Heap);
    assert {:id "id51"} defass#obj#0;
    ##b#8 := obj#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##b#8, Tclass._module.MyClass(), $Heap);
    assert {:id "id52"} {:subsumption 0} ##a#8 == ##b#8;
    assume _module.__default.TestAny#canCall(Tclass._module.MyClass(), $Box(obj#0), $Box(obj#0));
    assume _module.__default.TestAny#canCall(Tclass._module.MyClass(), $Box(obj#0), $Box(obj#0));
    assume true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(55,10)
    assume true;
    newtype$check#4 := LitInt(12);
    newtype$check#5 := LitInt(12);
    assert {:id "id53"} LitInt(-100) <= newtype$check#5 && newtype$check#5 < 100;
    assert {:id "id54"} defass#obj#0;
    assume true;
    x0#0 := #_module.X.X(Lit(true), 
      ...
      obj#0);
    defass#x0#0 := true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(56,10)
    assume true;
    newtype$check#6 := LitInt(12);
    newtype$check#7 := LitInt(12);
    assert {:id "id56"} LitInt(-100) <= newtype$check#7 && newtype$check#7 < 100;
    assert {:id "id57"} defass#obj#0;
    assume true;
    x1#0 := #_module.X.X(Lit(true), 
      ...
      obj#0);
    defass#x1#0 := true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(57,3)
    assert {:id "id59"} defass#x0#0;
    assert {:id "id60"} defass#x1#0;
    assume true;
    assume true;
    assert {:id "id61"} defass#x0#0;
    ##a#9 := Seq#Build(Seq#Empty(): Seq, $Box(x0#0));
    // assume allocatedness for argument to function
    assume $IsAlloc(##a#9, TSeq(Tclass._module.X()), $Heap);
    assert {:id "id62"} defass#x1#0;
    ##b#9 := Seq#Build(Seq#Empty(): Seq, $Box(x1#0));
    // assume allocatedness for argument to function
    assume $IsAlloc(##b#9, TSeq(Tclass._module.X()), $Heap);
    assert {:id "id63"} {:subsumption 0} ##a#9 == ##b#9;
    assume _module.__default.TestAny#canCall(TSeq(Tclass._module.X()), 
      $Box(Seq#Build(Seq#Empty(): Seq, $Box(x0#0))), 
      $Box(Seq#Build(Seq#Empty(): Seq, $Box(x1#0))));
    assume _module.__default.TestAny#canCall(TSeq(Tclass._module.X()), 
      $Box(Seq#Build(Seq#Empty(): Seq, $Box(x0#0))), 
      $Box(Seq#Build(Seq#Empty(): Seq, $Box(x1#0))));
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(58,3)
    assert {:id "id64"} defass#x0#0;
    assert {:id "id65"} defass#x1#0;
    assume true;
    assume true;
    assert {:id "id66"} defass#x0#0;
    ##a#10 := Set#UnionOne(Set#Empty(): Set, $Box(x0#0));
    // assume allocatedness for argument to function
    assume $IsAlloc(##a#10, TSet(Tclass._module.X()), $Heap);
    assert {:id "id67"} defass#x1#0;
    ##b#10 := Set#UnionOne(Set#Empty(): Set, $Box(x1#0));
    // assume allocatedness for argument to function
    assume $IsAlloc(##b#10, TSet(Tclass._module.X()), $Heap);
    assert {:id "id68"} {:subsumption 0} ##a#10 == ##b#10;
    assume _module.__default.TestAny#canCall(TSet(Tclass._module.X()), 
      $Box(Set#UnionOne(Set#Empty(): Set, $Box(x0#0))), 
      $Box(Set#UnionOne(Set#Empty(): Set, $Box(x1#0))));
    assume _module.__default.TestAny#canCall(TSet(Tclass._module.X()), 
      $Box(Set#UnionOne(Set#Empty(): Set, $Box(x0#0))), 
      $Box(Set#UnionOne(Set#Empty(): Set, $Box(x1#0))));
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(59,3)
    assert {:id "id69"} defass#x0#0;
    assert {:id "id70"} defass#x1#0;
    assume true;
    assume true;
    assert {:id "id71"} defass#x0#0;
    ##a#11 := MultiSet#UnionOne(MultiSet#Empty(): MultiSet, $Box(x0#0));
    // assume allocatedness for argument to function
    assume $IsAlloc(##a#11, TMultiSet(Tclass._module.X()), $Heap);
    assert {:id "id72"} defass#x1#0;
    ##b#11 := MultiSet#UnionOne(MultiSet#Empty(): MultiSet, $Box(x1#0));
    // assume allocatedness for argument to function
    assume $IsAlloc(##b#11, TMultiSet(Tclass._module.X()), $Heap);
    assert {:id "id73"} {:subsumption 0} ##a#11 == ##b#11;
    assume _module.__default.TestAny#canCall(TMultiSet(Tclass._module.X()), 
      $Box(MultiSet#UnionOne(MultiSet#Empty(): MultiSet, $Box(x0#0))), 
      $Box(MultiSet#UnionOne(MultiSet#Empty(): MultiSet, $Box(x1#0))));
    assume _module.__default.TestAny#canCall(TMultiSet(Tclass._module.X()), 
      $Box(MultiSet#UnionOne(MultiSet#Empty(): MultiSet, $Box(x0#0))), 
      $Box(MultiSet#UnionOne(MultiSet#Empty(): MultiSet, $Box(x1#0))));
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue195.dfy(60,3)
    assert {:id "id74"} defass#x0#0;
    assert {:id "id75"} defass#x0#0;
    assume true;
    assume true;
    assert {:id "id76"} defass#x0#0;
    ##a#12 := Map#Build(Map#Empty(): Map, $Box(x0#0), $Box(n0#0));
    // assume allocatedness for argument to function
    assume $IsAlloc(##a#12, TMap(Tclass._module.X(), Tclass._module.ntNative()), $Heap);
    assert {:id "id77"} defass#x0#0;
    ##b#12 := Map#Build(Map#Empty(): Map, $Box(x0#0), $Box(n1#0));
    // assume allocatedness for argument to function
    assume $IsAlloc(##b#12, TMap(Tclass._module.X(), Tclass._module.ntNative()), $Heap);
    assert {:id "id78"} {:subsumption 0} ##a#12 == ##b#12;
    assume _module.__default.TestAny#canCall(TMap(Tclass._module.X(), Tclass._module.ntNative()), 
      $Box(Map#Build(Map#Empty(): Map, $Box(x0#0), $Box(n0#0))), 
      $Box(Map#Build(Map#Empty(): Map, $Box(x0#0), $Box(n1#0))));
    assume _module.__default.TestAny#canCall(TMap(Tclass._module.X(), Tclass._module.ntNative()), 
      $Box(Map#Build(Map#Empty(): Map, $Box(x0#0), $Box(n0#0))), 
      $Box(Map#Build(Map#Empty(): Map, $Box(x0#0), $Box(n1#0))));
    assume true;
...
// Constructor function declaration
function #_module.Block.Block(Box, Seq, Box) : DatatypeType;

const unique ##_module.Block.Block: DtCtorId
uses {
// Constructor identifier
axiom (forall a#0#0#0: Box, a#0#1#0: Seq, a#0#2#0: Box :: 
  { #_module.Block.Block(a#0#0#0, a#0#1#0, a#0#2#0) } 
  DatatypeCtorId(#_module.Block.Block(a#0#0#0, a#0#1#0, a#0#2#0))
     == ##_module.Block.Block);
}
...
axiom (forall d: DatatypeType :: 
  { _module.Block.Block_q(d) } 
  _module.Block.Block_q(d)
     ==> (exists a#1#0#0: Box, a#1#1#0: Seq, a#1#2#0: Box :: 
      d == #_module.Block.Block(a#1#0#0, a#1#1#0, a#1#2#0)));
...
axiom (forall _module.Block$Hash: Ty, 
    ...
    a#2#1#0: Seq, 
    a#2#2#0: Box :: 
  { $Is(#_module.Block.Block(a#2#0#0, a#2#1#0, a#2#2#0), 
      Tclass._module.Block(_module.Block$Hash, _module.Block$Transaction, _module.Block$VProof)) } 
  $Is(#_module.Block.Block(a#2#0#0, a#2#1#0, a#2#2#0), 
      Tclass._module.Block(_module.Block$Hash, _module.Block$Transaction, _module.Block$VProof))
     <==> $IsBox(a#2#0#0, _module.Block$Hash)
       && $Is(a#2#1#0, TSeq(_module.Block$Transaction))
       && $IsBox(a#2#2#0, _module.Block$VProof));
...
axiom (forall _module.Block$Hash: Ty, 
    ...
    a#2#2#0: Box, 
    $h: Heap :: 
  { $IsAlloc(#_module.Block.Block(a#2#0#0, a#2#1#0, a#2#2#0), 
      Tclass._module.Block(_module.Block$Hash, _module.Block$Transaction, _module.Block$VProof), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_module.Block.Block(a#2#0#0, a#2#1#0, a#2#2#0), 
        Tclass._module.Block(_module.Block$Hash, _module.Block$Transaction, _module.Block$VProof), 
        $h)
       <==> $IsAllocBox(a#2#0#0, _module.Block$Hash, $h)
         && $IsAlloc(a#2#1#0, TSeq(_module.Block$Transaction), $h)
         && $IsAllocBox(a#2#2#0, _module.Block$VProof, $h)));
...
// Constructor literal
axiom (forall a#3#0#0: Box, a#3#1#0: Seq, a#3#2#0: Box :: 
  { #_module.Block.Block(Lit(a#3#0#0), Lit(a#3#1#0), Lit(a#3#2#0)) } 
  #_module.Block.Block(Lit(a#3#0#0), Lit(a#3#1#0), Lit(a#3#2#0))
     == Lit(#_module.Block.Block(a#3#0#0, a#3#1#0, a#3#2#0)));

function _module.Block.prevBlockHash(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#4#0#0: Box, a#4#1#0: Seq, a#4#2#0: Box :: 
  { #_module.Block.Block(a#4#0#0, a#4#1#0, a#4#2#0) } 
  _module.Block.prevBlockHash(#_module.Block.Block(a#4#0#0, a#4#1#0, a#4#2#0))
     == a#4#0#0);

// Inductive rank
axiom (forall a#5#0#0: Box, a#5#1#0: Seq, a#5#2#0: Box :: 
  { #_module.Block.Block(a#5#0#0, a#5#1#0, a#5#2#0) } 
  BoxRank(a#5#0#0) < DtRank(#_module.Block.Block(a#5#0#0, a#5#1#0, a#5#2#0)));

function _module.Block.txs(DatatypeType) : Seq;

// Constructor injectivity
axiom (forall a#6#0#0: Box, a#6#1#0: Seq, a#6#2#0: Box :: 
  { #_module.Block.Block(a#6#0#0, a#6#1#0, a#6#2#0) } 
  _module.Block.txs(#_module.Block.Block(a#6#0#0, a#6#1#0, a#6#2#0)) == a#6#1#0);

// Inductive seq element rank
axiom (forall a#7#0#0: Box, a#7#1#0: Seq, a#7#2#0: Box, i: int :: 
  { Seq#Index(a#7#1#0, i), #_module.Block.Block(a#7#0#0, a#7#1#0, a#7#2#0) } 
  0 <= i && i < Seq#Length(a#7#1#0)
     ==> DtRank($Unbox(Seq#Index(a#7#1#0, i)): DatatypeType)
       < DtRank(#_module.Block.Block(a#7#0#0, a#7#1#0, a#7#2#0)));

// Inductive seq rank
axiom (forall a#8#0#0: Box, a#8#1#0: Seq, a#8#2#0: Box :: 
  { #_module.Block.Block(a#8#0#0, a#8#1#0, a#8#2#0) } 
  Seq#Rank(a#8#1#0) < DtRank(#_module.Block.Block(a#8#0#0, a#8#1#0, a#8#2#0)));

function _module.Block.proof(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#9#0#0: Box, a#9#1#0: Seq, a#9#2#0: Box :: 
  { #_module.Block.Block(a#9#0#0, a#9#1#0, a#9#2#0) } 
  _module.Block.proof(#_module.Block.Block(a#9#0#0, a#9#1#0, a#9#2#0)) == a#9#2#0);

// Inductive rank
axiom (forall a#10#0#0: Box, a#10#1#0: Seq, a#10#2#0: Box :: 
  { #_module.Block.Block(a#10#0#0, a#10#1#0, a#10#2#0) } 
  BoxRank(a#10#2#0) < DtRank(#_module.Block.Block(a#10#0#0, a#10#1#0, a#10#2#0)));
...
procedure {:verboseName "nt (well-formedness)"} CheckWellFormed$$_module.nt();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
axiom (forall c0#0: int :: 
  { $Is(c0#0, Tclass._module.nt()) } 
  $Is(c0#0, Tclass._module.nt()) <==> Lit(true));

// $IsAlloc axiom for newtype _module.nt
axiom (forall c1#0: int, $h: Heap :: 
  { $IsAlloc(c1#0, Tclass._module.nt(), $h) } 
  $IsAlloc(c1#0, Tclass._module.nt(), $h));

const unique class._module.nt: ClassName;

procedure {:verboseName "ntNative (well-formedness)"} CheckWellFormed$$_module.ntNative(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ntNative (well-formedness)"} CheckWellFormed$$_module.ntNative(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assume {:id "id79"} LitInt(-100) <= x#0 && x#0 < 100;
        assume false;
    }
    ...
    if (*)
    {
        ...
        assume true;
        assert {:id "id80"} {:subsumption 0} LitInt(-100) <= LitInt(0);
        assert {:id "id81"} {:subsumption 0} Lit(0 < 100);
        assume false;
    }
}
...
axiom (forall $h: Heap, $o: ref :: 
  { $Unbox(read($h, $o, _module.MyClass.u)): int } 
  $IsGoodHeap($h) && $o != null && dtype($o) == Tclass._module.MyClass?()
     ==> $Is($Unbox(read($h, $o, _module.MyClass.u)): int, TInt));
...
axiom (forall $h: Heap, $o: ref :: 
  ...
  $IsGoodHeap($h)
      ...
      $o != null
       ...
       && $Unbox(read($h, $o, alloc)): bool
     ==> $IsAlloc($Unbox(read($h, $o, _module.MyClass.u)): int, TInt, $h));
  ...
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_module.X.X(a#2#0#0, 
       ...
       <==> $IsAlloc(a#2#0#0, TBool, $h)
         && $IsAlloc(a#2#1#0, TChar, $h)
         && $IsAlloc(a#2#2#0, TInt, $h)
         && $IsAlloc(a#2#3#0, TReal, $h)
         && $IsAlloc(a#2#4#0, Tclass._module.nt(), $h)
         && $IsAlloc(a#2#5#0, Tclass._module.ntNative(), $h)
         && $IsAlloc(a#2#6#0, TBitvector(8), $h)
         && $IsAlloc(a#2#7#0, TBitvector(167), $h)
         && $IsAlloc(a#2#8#0, TORDINAL, $h)
         && $IsAlloc(a#2#9#0, Tclass._module.MyClass(), $h)));
...
axiom (forall a#4#0#0: bool, 
  ...
  { #_module.X.X(a#4#0#0, 
      ...
      a#4#8#0, 
      a#4#9#0) } 
  _module.X._h0(#_module.X.X(a#4#0#0, 
        a#4#1#0, 
        a#4#2#0, 
        a#4#3#0, 
        a#4#4#0, 
...
axiom (forall a#5#0#0: bool, 
  ...
  { #_module.X.X(a#5#0#0, 
      ...
      a#5#8#0, 
      a#5#9#0) } 
  _module.X._h1(#_module.X.X(a#5#0#0, 
        a#5#1#0, 
        a#5#2#0, 
        a#5#3#0, 
        a#5#4#0, 
...
axiom (forall a#6#0#0: bool, 
  ...
  { #_module.X.X(a#6#0#0, 
      ...
      a#6#8#0, 
      a#6#9#0) } 
  _module.X._h2(#_module.X.X(a#6#0#0, 
        a#6#1#0, 
        a#6#2#0, 
        a#6#3#0, 
        a#6#4#0, 
...
axiom (forall a#7#0#0: bool, 
  ...
  { #_module.X.X(a#7#0#0, 
      ...
      a#7#8#0, 
      a#7#9#0) } 
  _module.X._h3(#_module.X.X(a#7#0#0, 
        a#7#1#0, 
        a#7#2#0, 
        a#7#3#0, 
        a#7#4#0, 
...
axiom (forall a#8#0#0: bool, 
  ...
  { #_module.X.X(a#8#0#0, 
      ...
      a#8#8#0, 
      a#8#9#0) } 
  _module.X._h4(#_module.X.X(a#8#0#0, 
        a#8#1#0, 
        a#8#2#0, 
        a#8#3#0, 
        a#8#4#0, 
...
axiom (forall a#9#0#0: bool, 
  ...
  { #_module.X.X(a#9#0#0, 
      ...
      a#9#8#0, 
      a#9#9#0) } 
  _module.X._h5(#_module.X.X(a#9#0#0, 
        a#9#1#0, 
        a#9#2#0, 
        a#9#3#0, 
        a#9#4#0, 
...
axiom (forall a#10#0#0: bool, 
  ...
  { #_module.X.X(a#10#0#0, 
      ...
      a#10#8#0, 
      a#10#9#0) } 
  _module.X._h6(#_module.X.X(a#10#0#0, 
        a#10#1#0, 
        a#10#2#0, 
        a#10#3#0, 
        a#10#4#0, 
...
axiom (forall a#11#0#0: bool, 
  ...
  { #_module.X.X(a#11#0#0, 
      ...
      a#11#8#0, 
      a#11#9#0) } 
  _module.X._h7(#_module.X.X(a#11#0#0, 
        a#11#1#0, 
        a#11#2#0, 
        a#11#3#0, 
        a#11#4#0, 
...
axiom (forall a#12#0#0: bool, 
  ...
  { #_module.X.X(a#12#0#0, 
      ...
      a#12#8#0, 
      a#12#9#0) } 
  _module.X._h8(#_module.X.X(a#12#0#0, 
        a#12#1#0, 
        a#12#2#0, 
        a#12#3#0, 
        a#12#4#0, 
...
axiom (forall a#13#0#0: bool, 
  ...
  { #_module.X.X(a#13#0#0, 
      ...
      a#13#8#0, 
      a#13#9#0) } 
  _module.X._h9(#_module.X.X(a#13#0#0, 
        a#13#1#0, 
        a#13#2#0, 
        a#13#3#0, 
        a#13#4#0, 
