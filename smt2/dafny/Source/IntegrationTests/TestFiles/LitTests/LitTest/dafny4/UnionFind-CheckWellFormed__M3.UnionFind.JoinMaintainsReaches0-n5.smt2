...
(set-info :boogie-vc-id CheckWellFormed$$M3.UnionFind.JoinMaintainsReaches0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 26) (let ((anon7_correct true))
(let ((anon9_Else_correct  (=> (and (=> (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#2@0|)) (M3.UnionFind.Reaches ($LS $LZ) this@@3 (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|)))) |e#2@0| |r0#0| |C#0@@5|)) (M3.UnionFind.Reaches ($LS $LZ) this@@3 (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|)))) |e#2@0| |r1#0| |C'#0|)) (= (ControlFlow 0 11) 1)) anon7_correct)))
(let ((anon9_Then_correct  (=> (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#2@0|)) ($IsAllocBox ($Box refType this@@3) Tclass.M3.UnionFind? $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 10)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|)) (and (=> (= (ControlFlow 0 2) (- 0 9)) (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|))))) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|)))) (=> (= |##d#2@0| (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|))))) (=> (and (and ($IsAlloc intType (int_2_U |##d#2@0|) Tclass._System.nat $Heap@0) ($IsAlloc refType |e#2@0| Tclass.M3.Element $Heap@0)) (and ($IsAlloc refType |r0#0| Tclass.M3.Element $Heap@0) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|M3.__default.GoodCMap#canCall| |C#0@@5|) (or (M3.__default.GoodCMap |C#0@@5|) (forall ((|f#2| T@U) ) (!  (=> ($Is refType |f#2| Tclass.M3.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |f#2|)) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#2|))))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#2|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |3094|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#2|))))
))))) (=> (M3.__default.GoodCMap |C#0@@5|) (and (=> (= (ControlFlow 0 2) (- 0 7)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#2@0|))) (=> (and (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#2@0|)) (|M3.UnionFind.Reaches#canCall| this@@3 (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|)))) |e#2@0| |r0#0| |C#0@@5|)) (and (M3.UnionFind.Reaches ($LS $LZ) this@@3 (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|)))) |e#2@0| |r0#0| |C#0@@5|) ($IsAllocBox ($Box refType this@@3) Tclass.M3.UnionFind? $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r1#0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r1#0|)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|))))) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|)))) (=> (= |##d#3@0| (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|))))) (=> (and (and ($IsAlloc intType (int_2_U |##d#3@0|) Tclass._System.nat $Heap@0) ($IsAlloc refType |e#2@0| Tclass.M3.Element $Heap@0)) (and ($IsAlloc refType |r1#0| Tclass.M3.Element $Heap@0) ($IsAlloc MapType |C'#0| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|M3.__default.GoodCMap#canCall| |C'#0|) (or (M3.__default.GoodCMap |C'#0|) (forall ((|f#3| T@U) ) (!  (=> ($Is refType |f#3| Tclass.M3.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |f#3|)) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#3|))))) (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#3|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |3096|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#3|))))
))))) (=> (M3.__default.GoodCMap |C'#0|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |e#2@0|))) (=> (and (and (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |e#2@0|)) (|M3.UnionFind.Reaches#canCall| this@@3 (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|)))) |e#2@0| |r1#0| |C'#0|)) (and (M3.UnionFind.Reaches ($LS $LZ) this@@3 (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|)))) |e#2@0| |r1#0| |C'#0|) (= (ControlFlow 0 2) 1))) anon7_correct)))))))))))))))))))))))
(let ((anon4_correct  (=> (forall ((|d#1| Int) (|e#1| T@U) (|r#1| T@U) ) (!  (=> (and (and (<= (LitInt 0) |d#1|) ($Is refType |e#1| Tclass.M3.Element)) (and ($Is refType |r#1| Tclass.M3.Element) ($IsAlloc refType |r#1| Tclass.M3.Element $Heap@0))) (=> (and (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#1|)) (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#1| |e#1| |r#1| |C#0@@5|)) (or (not (= |r#1| |r0#0|)) (not true))) (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#1| |e#1| |r#1| |C'#0|)))
 :qid |UnionFinddfy.297:22|
 :skolemid |3093|
 :pattern ( (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#1| |e#1| |r#1| |C'#0|))
 :pattern ( (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#1| |e#1| |r#1| |C#0@@5|))
)) (=> (and ($Is refType |e#2@0| Tclass.M3.Element) ($IsAlloc refType |e#2@0| Tclass.M3.Element $Heap@0)) (and (=> (= (ControlFlow 0 12) 2) anon9_Then_correct) (=> (= (ControlFlow 0 12) 11) anon9_Else_correct))))))
(let ((anon8_Else_correct  (=> (and (=> (and (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@0|)) (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@0| |e#0@0| |r#0@0| |C#0@@5|)) (or (not (= |r#0@0| |r0#0|)) (not true))) (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@0| |e#0@0| |r#0@0| |C'#0|)) (= (ControlFlow 0 18) 12)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@0|)) ($IsAllocBox ($Box refType this@@3) Tclass.M3.UnionFind? $Heap@0)) (=> (and (and ($IsAlloc intType (int_2_U |d#0@0|) Tclass._System.nat $Heap@0) ($IsAlloc refType |e#0@0| Tclass.M3.Element $Heap@0)) (and ($IsAlloc refType |r#0@0| Tclass.M3.Element $Heap@0) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap@0))) (and (=> (= (ControlFlow 0 13) (- 0 17)) (=> (|M3.__default.GoodCMap#canCall| |C#0@@5|) (or (M3.__default.GoodCMap |C#0@@5|) (forall ((|f#0@@0| T@U) ) (!  (=> ($Is refType |f#0@@0| Tclass.M3.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |f#0@@0|)) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#0@@0|))))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#0@@0|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |3089|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#0@@0|))))
))))) (=> (M3.__default.GoodCMap |C#0@@5|) (and (=> (= (ControlFlow 0 13) (- 0 16)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@0|)) (=> (and (and (and (|M3.UnionFind.Reaches#canCall| this@@3 |d#0@0| |e#0@0| |r#0@0| |C#0@@5|) (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@0| |e#0@0| |r#0@0| |C#0@@5|)) (and (or (not (= |r#0@0| |r0#0|)) (not true)) ($IsAllocBox ($Box refType this@@3) Tclass.M3.UnionFind? $Heap@0))) (and (and ($IsAlloc intType (int_2_U |d#0@0|) Tclass._System.nat $Heap@0) ($IsAlloc refType |e#0@0| Tclass.M3.Element $Heap@0)) (and ($IsAlloc refType |r#0@0| Tclass.M3.Element $Heap@0) ($IsAlloc MapType |C'#0| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap@0)))) (and (=> (= (ControlFlow 0 13) (- 0 15)) (=> (|M3.__default.GoodCMap#canCall| |C'#0|) (or (M3.__default.GoodCMap |C'#0|) (forall ((|f#1@@0| T@U) ) (!  (=> ($Is refType |f#1@@0| Tclass.M3.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |f#1@@0|)) (M3.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#1@@0|))))) (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType (M3.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#1@@0|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |3091|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C'#0|) ($Box refType |f#1@@0|))))
))))) (=> (M3.__default.GoodCMap |C'#0|) (and (=> (= (ControlFlow 0 13) (- 0 14)) (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |e#0@0|))) (=> (and (and (|Set#IsMember| (|Map#Domain| |C'#0|) ($Box refType |e#0@0|)) (|M3.UnionFind.Reaches#canCall| this@@3 |d#0@0| |e#0@0| |r#0@0| |C'#0|)) (and (M3.UnionFind.Reaches ($LS $LZ) this@@3 |d#0@0| |e#0@0| |r#0@0| |C'#0|) (= (ControlFlow 0 13) 12))) anon4_correct)))))))))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap)) (=> (and (and (|M3.__default.GoodCMap#canCall| |C#0@@5|) (M3.__default.GoodCMap |C#0@@5|)) (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r1#0|)))) (and (=> (= (ControlFlow 0 19) (- 0 25)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|)) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|)))) (and (=> (= (ControlFlow 0 19) (- 0 24)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r1#0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r1#0|)) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|)))) (and (=> (= (ControlFlow 0 19) (- 0 23)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r0#0|)) (and (=> (= (ControlFlow 0 19) (- 0 22)) (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|))))) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|)))) (and (=> (= (ControlFlow 0 19) (- 0 21)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r1#0|))) (=> (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |r1#0|)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|))))) (=> (M3.Contents.Root_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|)))) (=> (< (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r0#0|)))) (M3.Contents.depth ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |r1#0|))))) (=> (and (and (|Map#Equal| |C'#0| (|Map#Build| |C#0@@5| ($Box refType |r0#0|) ($Box DatatypeTypeType (|#M3.Contents.Link| |r1#0|)))) ($IsAlloc MapType |C'#0| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap)) (and (|M3.__default.GoodCMap#canCall| |C'#0|) (M3.__default.GoodCMap |C'#0|))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (and (<= (LitInt 0) |d#0@0|) (and ($Is refType |e#0@0| Tclass.M3.Element) ($IsAlloc refType |e#0@0| Tclass.M3.Element $Heap@0))) (and ($Is refType |r#0@0| Tclass.M3.Element) ($IsAlloc refType |r#0@0| Tclass.M3.Element $Heap@0)))) (and (=> (= (ControlFlow 0 19) 13) anon8_Then_correct) (=> (= (ControlFlow 0 19) 18) anon8_Else_correct)))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.M3.UnionFind) ($IsAlloc refType this@@3 Tclass.M3.UnionFind $Heap))) (and ($Is refType |r0#0| Tclass.M3.Element) ($IsAlloc refType |r0#0| Tclass.M3.Element $Heap))) (=> (and (and (and ($Is refType |r1#0| Tclass.M3.Element) ($IsAlloc refType |r1#0| Tclass.M3.Element $Heap)) (and ($Is MapType |C#0@@5| (TMap Tclass.M3.Element Tclass.M3.Contents)) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap))) (and (and ($Is MapType |C'#0| (TMap Tclass.M3.Element Tclass.M3.Contents)) ($IsAlloc MapType |C'#0| (TMap Tclass.M3.Element Tclass.M3.Contents) $Heap)) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 26) 19)))) anon0_correct)))))
