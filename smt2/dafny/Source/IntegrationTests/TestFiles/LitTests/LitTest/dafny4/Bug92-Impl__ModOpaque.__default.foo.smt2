...
(declare-fun ModOpaque.__default.Visible (Int) T@U)
(declare-fun LitInt (Int) Int)
(declare-fun |ModOpaque.__default.Visible#canCall| (Int) Bool)
(declare-fun |ModOpaque.__default.Hidden#canCall| (Int) Bool)
(declare-fun ModOpaque.__default.Hidden (Bool Int) T@U)
(declare-fun reveal_ModOpaque._default.Hidden () Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|x#0| Int) ) (!  (=> (or (|ModOpaque.__default.Visible#canCall| (LitInt |x#0|)) (< 1 $FunctionContextHeight)) (and (|ModOpaque.__default.Hidden#canCall| (LitInt |x#0|)) (= (ModOpaque.__default.Visible (LitInt |x#0|)) (ModOpaque.__default.Hidden reveal_ModOpaque._default.Hidden (LitInt |x#0|)))))
 :qid |Bug92dfy.9:28|
 :weight 3
 :skolemid |486|
 :pattern ( (ModOpaque.__default.Visible (LitInt |x#0|)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($reveal Bool) (|x#0@@0| Int) ) (!  (=> (or (|ModOpaque.__default.Hidden#canCall| |x#0@@0|) (< 0 $FunctionContextHeight)) ($Is DatatypeTypeType (ModOpaque.__default.Hidden $reveal |x#0@@0|) (Tclass._System.Tuple2 TInt TInt)))
 :qid |Bug92dfy.4:30|
 :skolemid |479|
 :pattern ( (ModOpaque.__default.Hidden $reveal |x#0@@0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|x#0@@1| Int) ) (!  (=> (or (|ModOpaque.__default.Visible#canCall| |x#0@@1|) (< 1 $FunctionContextHeight)) ($Is DatatypeTypeType (ModOpaque.__default.Visible |x#0@@1|) (Tclass._System.Tuple2 TInt TInt)))
 :qid |Bug92dfy.9:28|
 :skolemid |483|
 :pattern ( (ModOpaque.__default.Visible |x#0@@1|))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@2| Int) ) (!  (=> (or (|ModOpaque.__default.Hidden#canCall| |x#0@@2|) (< 0 $FunctionContextHeight)) (= (ModOpaque.__default.Hidden true |x#0@@2|) (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 5))) ($Box intType (int_2_U (LitInt 7)))))))
 :qid |Bug92dfy.4:37|
 :skolemid |481|
 :pattern ( (ModOpaque.__default.Hidden true |x#0@@2|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@3| Int) ) (!  (=> (or (|ModOpaque.__default.Hidden#canCall| (LitInt |x#0@@3|)) (< 0 $FunctionContextHeight)) (= (ModOpaque.__default.Hidden true (LitInt |x#0@@3|)) (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 5))) ($Box intType (int_2_U (LitInt 7)))))))
 :qid |Bug92dfy.4:37|
 :weight 3
 :skolemid |482|
 :pattern ( (ModOpaque.__default.Hidden true (LitInt |x#0@@3|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|x#0@@4| Int) ) (!  (=> (or (|ModOpaque.__default.Visible#canCall| |x#0@@4|) (< 1 $FunctionContextHeight)) (and (|ModOpaque.__default.Hidden#canCall| |x#0@@4|) (= (ModOpaque.__default.Visible |x#0@@4|) (ModOpaque.__default.Hidden reveal_ModOpaque._default.Hidden |x#0@@4|))))
 :qid |Bug92dfy.9:28|
 :skolemid |485|
 :pattern ( (ModOpaque.__default.Visible |x#0@@4|))
))))
...
(set-info :boogie-vc-id Impl$$ModOpaque.__default.foo)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) ($IsAlloc intType (int_2_U |x#0@@5|) TInt $Heap)) (and (|ModOpaque.__default.Hidden#canCall| |x#0@@5|) (_System.Tuple2.___hMake2_q (ModOpaque.__default.Hidden reveal_ModOpaque._default.Hidden |x#0@@5|)))) (and (and (|$IsA#_System.Tuple2| (ModOpaque.__default.Hidden reveal_ModOpaque._default.Hidden |x#0@@5|)) (|ModOpaque.__default.Hidden#canCall| |x#0@@5|)) (= (ControlFlow 0 2) (- 0 1)))) (|_System.Tuple2#Equal| (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |y#0|)) ($Box intType (int_2_U |z#0|))) (ModOpaque.__default.Hidden reveal_ModOpaque._default.Hidden |x#0@@5|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 2 $FunctionContextHeight)) (and (|_System.Tuple2#Equal| (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |y#0|)) ($Box intType (int_2_U |z#0|))) (ModOpaque.__default.Visible |x#0@@5|)) (= (ControlFlow 0 3) 2))) anon0_correct)))
