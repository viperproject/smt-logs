...
(assert (forall ((s@@10 T@U) (i@@1 Int) (v@@3 T@U) ) (!  (and (=> (= i@@1 (|Seq#Length| s@@10)) (= (|Seq#Index| (|Seq#Build| s@@10 v@@3) i@@1) v@@3)) (=> (or (not (= i@@1 (|Seq#Length| s@@10))) (not true)) (= (|Seq#Index| (|Seq#Build| s@@10 v@@3) i@@1) (|Seq#Index| s@@10 i@@1))))
 :qid |DafnyPreludebpl.1148:15|
 :skolemid |225|
 :pattern ( (|Seq#Index| (|Seq#Build| s@@10 v@@3) i@@1))
)))
...
(assert (forall ((v@@5 T@U) (t0 T@U) (h@@0 T@U) ) (! (= ($IsAlloc SeqType v@@5 (TSeq t0) h@@0) (forall ((i@@5 Int) ) (!  (=> (and (<= 0 i@@5) (< i@@5 (|Seq#Length| v@@5))) ($IsAllocBox (|Seq#Index| v@@5 i@@5) t0 h@@0))
...
(set-info :boogie-vc-id Impl$$_module.__default.proof)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (= $Heap $Heap@0) (forall ((|$ih#s10#0| T@U) (|$ih#s20#0| T@U) ) (!  (=> (and (and (and ($Is SeqType |$ih#s10#0| (TSeq TInt)) ($Is SeqType |$ih#s20#0| (TSeq TInt))) (|Seq#Equal| (_module.__default.Looper ($LS $LZ) reveal__module._default.Looper |$ih#s10#0|) (_module.__default.Looper ($LS $LZ) reveal__module._default.Looper |$ih#s20#0|))) (or (< (|Seq#Rank| |$ih#s10#0|) (|Seq#Rank| |s1#0|)) (and (= (|Seq#Rank| |$ih#s10#0|) (|Seq#Rank| |s1#0|)) (< (|Seq#Rank| |$ih#s20#0|) (|Seq#Rank| |s2#0|))))) (forall ((|i#2| T@U) ) (! (= (|Seq#Contains| |$ih#s10#0| ($Box intType |i#2|)) (|Seq#Contains| |$ih#s20#0| ($Box intType |i#2|)))
 :qid |Issue09dfy.19:20|
 :skolemid |499|
 :pattern ( (|Seq#Contains| |$ih#s20#0| ($Box intType |i#2|)))
 :pattern ( (|Seq#Contains| |$ih#s10#0| ($Box intType |i#2|)))
)))
 :qid |Issue09dfy.17:13|
 :skolemid |500|
 :pattern ( (_module.__default.Looper ($LS $LZ) reveal__module._default.Looper |$ih#s20#0|) (_module.__default.Looper ($LS $LZ) reveal__module._default.Looper |$ih#s10#0|))
))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1))) (=> (and (and (and (= $Heap@0 $Heap@1) reveal__module._default.Looper) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2))) (and (and (forall ((|x1#1| Int) (|x2#1| Int) ) (!  (and (|_module.__default.Transform#canCall| |x1#1|) (|_module.__default.Transform#canCall| |x2#1|))
 :qid |Issue09dfy.7:20|
 :skolemid |482|
 :pattern ( (_module.__default.Transform |x1#1|) (_module.__default.Transform |x2#1|))
)) (forall ((|x1#1@@0| Int) (|x2#1@@0| Int) ) (!  (=> (= (_module.__default.Transform |x1#1@@0|) (_module.__default.Transform |x2#1@@0|)) (= |x1#1@@0| |x2#1@@0|))
 :qid |Issue09dfy.7:20|
 :skolemid |483|
 :pattern ( (_module.__default.Transform |x1#1@@0|) (_module.__default.Transform |x2#1@@0|))
))) (and (= $Heap@1 $Heap@2) (= (ControlFlow 0 2) (- 0 1))))) (forall ((|i#1| Int) ) (! (= (|Seq#Contains| |s1#0| ($Box intType (int_2_U |i#1|))) (|Seq#Contains| |s2#0| ($Box intType (int_2_U |i#1|))))
 :qid |Issue09dfy.19:20|
 :skolemid |498|
 :pattern ( (|Seq#Contains| |s2#0| ($Box intType (int_2_U |i#1|))))
 :pattern ( (|Seq#Contains| |s1#0| ($Box intType (int_2_U |i#1|))))
))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SeqType |s1#0| (TSeq TInt)) ($IsAlloc SeqType |s1#0| (TSeq TInt) $Heap))) (=> (and (and (and ($Is SeqType |s2#0| (TSeq TInt)) ($IsAlloc SeqType |s2#0| (TSeq TInt) $Heap)) (= 2 $FunctionContextHeight)) (and (|Seq#Equal| (_module.__default.Looper ($LS ($LS $LZ)) reveal__module._default.Looper |s1#0|) (_module.__default.Looper ($LS ($LS $LZ)) reveal__module._default.Looper |s2#0|)) (= (ControlFlow 0 3) 2))) anon0_correct))))
