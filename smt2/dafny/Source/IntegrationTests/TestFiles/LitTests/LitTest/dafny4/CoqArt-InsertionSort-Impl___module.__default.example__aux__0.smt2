...
(set-info :boogie-vc-id Impl$$_module.__default.example__aux__0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|_module.List#Equal| (_module.__default.aux ($LS ($LS $LZ)) (LitInt 4) (Lit DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 2))) (Lit DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 5))) (Lit DatatypeTypeType |#_module.List.Nil|)))))) (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 2))) (Lit DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 4))) (Lit DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 5))) (Lit DatatypeTypeType |#_module.List.Nil|))))))))))
