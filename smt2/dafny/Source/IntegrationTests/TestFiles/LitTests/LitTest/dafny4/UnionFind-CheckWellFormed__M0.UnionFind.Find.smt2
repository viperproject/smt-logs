...
(declare-fun |r#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$M0.UnionFind.Find)
...
))) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType this@@4 Tclass.M0.UnionFind $Heap@@2)) (=> ($IsAlloc refType this@@4 Tclass.M0.UnionFind $Heap@@2) (=> (and (|Map#Equal| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) M0.UnionFind.M)) ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) M0.UnionFind.M))) (= (ControlFlow 0 2) (- 0 1))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@4) M0.UnionFind.M))) ($Box refType |e#0|))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass.M0.UnionFind) ($IsAlloc refType this@@4 Tclass.M0.UnionFind $Heap@@2))) (and ($Is refType |e#0| Tclass.M0.Element) ($IsAlloc refType |e#0| Tclass.M0.Element $Heap@@2))) (and (and ($Is refType |r#0| Tclass.M0.Element) ($IsAlloc refType |r#0| Tclass.M0.Element $Heap@@2)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 5) 2)))) anon0_correct))))
