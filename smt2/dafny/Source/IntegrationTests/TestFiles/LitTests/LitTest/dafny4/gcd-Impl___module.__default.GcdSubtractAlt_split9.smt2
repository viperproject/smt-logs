...
(set-info :boogie-vc-id Impl$$_module.__default.GcdSubtractAlt_split9)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon19_correct  (=> (and (or (and ($Is intType (int_2_U (LitInt 1)) Tclass._module.pos) (= (Mul |q#2_0@0| (LitInt 1)) (- |y#0@@3| |x#0@@10|))) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._module.pos) (= (Mul |q#2_0@0| (LitInt 0)) (- |y#0@@3| |x#0@@10|))) (exists ((|$as#b2_0#2_0| Int) ) (!  (and (<= (LitInt 1) |$as#b2_0#2_0|) (= (Mul |q#2_0@0| |$as#b2_0#2_0|) (- |y#0@@3| |x#0@@10|)))
 :qid |gcddfy.245:9|
 :skolemid |670|
)))) (<= (LitInt 1) |b#2_0@0|)) (=> (and (and (= (Mul |q#2_0@0| |b#2_0@0|) (- |y#0@@3| |x#0@@10|)) (= |newtype$check#2_0_0_0_0@0| (Mul |q#2_0@0| |a#2_0@0|))) (and (<= (LitInt 1) |newtype$check#2_0_0_0_0@0|) (= |newtype$check#2_0_0_0_1@0| (Mul |q#2_0@0| |b#2_0@0|)))) (=> (and (and (and (<= (LitInt 1) |newtype$check#2_0_0_0_1@0|) (= |newtype$check#2_0_0_0_2@0| (+ (Mul |q#2_0@0| |a#2_0@0|) (Mul |q#2_0@0| |b#2_0@0|)))) (and (<= (LitInt 1) |newtype$check#2_0_0_0_2@0|) (= |newtype$check#2_0_0_0_3@0| (+ |a#2_0@0| |b#2_0@0|)))) (and (and (<= (LitInt 1) |newtype$check#2_0_0_0_3@0|) (= |newtype$check#2_0_0_0_4@0| (Mul |q#2_0@0| (+ |a#2_0@0| |b#2_0@0|)))) (and (<= (LitInt 1) |newtype$check#2_0_0_0_4@0|) (= (ControlFlow 0 2) (- 0 1))))) (= (+ (Mul |q#2_0@0| |a#2_0@0|) (Mul |q#2_0@0| |b#2_0@0|)) (Mul |q#2_0@0| (+ |a#2_0@0| |b#2_0@0|))))))))
