...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.ArmyRepr3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#14| null $Heap@@2 alloc false)) (= (|Seq#Length| |army#0|) (LitInt 3))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@2 $Heap@0)) (and ($IsAlloc SeqType |army#0| (TSeq Tclass._module.Bot) $Heap@0) (|_module.__default.ArmyRepr#canCall| $Heap@0 |army#0|))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |army#0|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |army#0|))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= ($Unbox refType (|Seq#Index| |army#0| (LitInt 0))) null)) (not true))) (=> (or (not (= ($Unbox refType (|Seq#Index| |army#0| (LitInt 0))) null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |army#0|)))) (=> (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |army#0|))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= ($Unbox refType (|Seq#Index| |army#0| (LitInt 1))) null)) (not true))) (=> (or (not (= ($Unbox refType (|Seq#Index| |army#0| (LitInt 1))) null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 (LitInt 2)) (< (LitInt 2) (|Seq#Length| |army#0|)))) (=> (and (<= 0 (LitInt 2)) (< (LitInt 2) (|Seq#Length| |army#0|))) (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= ($Unbox refType (|Seq#Index| |army#0| (LitInt 2))) null)) (not true)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and ($Is SeqType |army#0| (TSeq Tclass._module.Bot)) ($IsAlloc SeqType |army#0| (TSeq Tclass._module.Bot) $Heap@@2)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 8) 2))) anon0_correct))))
