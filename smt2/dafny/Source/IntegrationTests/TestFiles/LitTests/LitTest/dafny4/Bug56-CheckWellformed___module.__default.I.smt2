...
(let ((anon4_Then_correct  (=> ($Is HandleTypeType (_module.__default.I |f#0@@4|) (Tclass._System.___hTotalFunc1 TInt TBool)) (=> (and ($IsAlloc HandleTypeType |f#0@@4| (Tclass._System.___hTotalFunc1 TInt TBool) $Heap) (= (ControlFlow 0 2) (- 0 1))) (= |f#0@@4| |f#0@@4|)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is HandleTypeType |f#0@@4| (Tclass._System.___hTotalFunc1 TInt TBool))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct)))
