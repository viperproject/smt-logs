...
(assert (forall ((|l#0@@0| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3@@0| T@U) (|l#4@@0| T@U) ($o@@2 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#3| |l#0@@0| |l#1@@0| |l#2@@0| |l#3@@0| |l#4@@0|) $o@@2 $f))  (=> (and (or (not (= $o@@2 |l#0@@0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1@@0| $o@@2) |l#2@@0|)))) (and ($Is refType $o@@2 |l#3@@0|) (|Seq#Contains| |l#4@@0| ($Box refType $o@@2)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |863|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#3| |l#0@@0| |l#1@@0| |l#2@@0| |l#3@@0| |l#4@@0|) $o@@2 $f))
)))
...
(assert (forall (($h@@3 T@U) ($o@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (or (not (= $o@@3 null)) (not true)) (= (dtype $o@@3) Tclass._module.Bot?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@3) _module.Bot.Repr)) (TSet Tclass._System.object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |796|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@3) _module.Bot.Repr)))
)))
(assert (forall (($h@@4 T@U) ($o@@4 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@4) (and (or (not (= $o@@4 null)) (not true)) (= (dtype $o@@4) Tclass._module.Bot?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@4) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@4) _module.Bot.Repr)) (TSet Tclass._System.object) $h@@4))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |797|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@4) _module.Bot.Repr)))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.ArmyRepr)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon14_correct  (=> (= (_module.__default.ArmyRepr $Heap@@2 |bots#0@@2|) (|Set#FromBoogieMap| (|lambda#2| Tclass._module.Bot Tclass._System.object |bots#0@@2| $Heap@@2 _module.Bot.Repr $Heap@@2 _module.Bot.Repr))) (=> (and ($Is SetType (_module.__default.ArmyRepr $Heap@@2 |bots#0@@2|) (TSet Tclass._System.object)) (= (ControlFlow 0 3) (- 0 2))) |b$reqreads#0@2|))))
(let ((anon23_Else_correct  (=> (not (and (|Seq#Contains| |bots#0@@2| ($Box refType |b#3@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |b#3@0|) _module.Bot.Repr)) ($Box refType |o#1@0|)))) (=> (and (= |b$reqreads#0@2| |b$reqreads#0@1|) (= (ControlFlow 0 6) 3)) anon14_correct))))
(let ((anon23_Then_correct  (=> (and (and (|Seq#Contains| |bots#0@@2| ($Box refType |b#3@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |b#3@0|) _module.Bot.Repr)) ($Box refType |o#1@0|))) (and (= |b$reqreads#0@2| |b$reqreads#0@1|) (= (ControlFlow 0 5) 3))) anon14_correct)))
(let ((anon22_Else_correct  (=> (and (not (|Seq#Contains| |bots#0@@2| ($Box refType |b#3@0|))) (= |b$reqreads#0@1| true)) (and (=> (= (ControlFlow 0 9) 5) anon23_Then_correct) (=> (= (ControlFlow 0 9) 6) anon23_Else_correct)))))
(let ((anon22_Then_correct  (=> (|Seq#Contains| |bots#0@@2| ($Box refType |b#3@0|)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (not (= |b#3@0| null)) (not true))) (=> (or (not (= |b#3@0| null)) (not true)) (=> (and (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |b#3@0| _module.Bot.Repr))) (= |b$reqreads#0@1| |b$reqreads#0@0|)) (and (=> (= (ControlFlow 0 7) 5) anon23_Then_correct) (=> (= (ControlFlow 0 7) 6) anon23_Else_correct))))))))
(let ((anon21_Then_correct  (=> (and (and ($Is refType |b#3@0| Tclass._module.Bot) ($IsAlloc refType |b#3@0| Tclass._module.Bot $Heap@@2)) (and ($Is refType |o#1@0| Tclass._System.object) ($IsAlloc refType |o#1@0| Tclass._System.object $Heap@@2))) (and (=> (= (ControlFlow 0 10) 7) anon22_Then_correct) (=> (= (ControlFlow 0 10) 9) anon22_Else_correct)))))
(let ((anon21_Else_correct  (=> (not (and (and ($Is refType |b#3@0| Tclass._module.Bot) ($IsAlloc refType |b#3@0| Tclass._module.Bot $Heap@@2)) (and ($Is refType |o#1@0| Tclass._System.object) ($IsAlloc refType |o#1@0| Tclass._System.object $Heap@@2)))) (=> (and (= |b$reqreads#0@2| true) (= (ControlFlow 0 4) 3)) anon14_correct))))
(let ((anon20_Then_correct true))
(let ((anon19_Else_correct  (=> (not (|Seq#Contains| |bots#0@@2| ($Box refType |b#2@0|))) (and (and (=> (= (ControlFlow 0 13) 1) anon20_Then_correct) (=> (= (ControlFlow 0 13) 10) anon21_Then_correct)) (=> (= (ControlFlow 0 13) 4) anon21_Else_correct)))))
(let ((anon19_Then_correct  (=> (|Seq#Contains| |bots#0@@2| ($Box refType |b#2@0|)) (and (and (=> (= (ControlFlow 0 12) 1) anon20_Then_correct) (=> (= (ControlFlow 0 12) 10) anon21_Then_correct)) (=> (= (ControlFlow 0 12) 4) anon21_Else_correct)))))
(let ((anon18_Then_correct  (=> (and ($Is refType |b#2@0| Tclass._module.Bot) ($IsAlloc refType |b#2@0| Tclass._module.Bot $Heap@@2)) (and (=> (= (ControlFlow 0 14) 12) anon19_Then_correct) (=> (= (ControlFlow 0 14) 13) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (not (and ($Is refType |b#2@0| Tclass._module.Bot) ($IsAlloc refType |b#2@0| Tclass._module.Bot $Heap@@2))) (and (and (=> (= (ControlFlow 0 11) 1) anon20_Then_correct) (=> (= (ControlFlow 0 11) 10) anon21_Then_correct)) (=> (= (ControlFlow 0 11) 4) anon21_Else_correct)))))
(let ((anon17_Else_correct  (=> (not (|Seq#Contains| |bots#0@@2| ($Box refType |b#1@0|))) (and (=> (= (ControlFlow 0 17) 14) anon18_Then_correct) (=> (= (ControlFlow 0 17) 11) anon18_Else_correct)))))
(let ((anon17_Then_correct  (=> (|Seq#Contains| |bots#0@@2| ($Box refType |b#1@0|)) (and (=> (= (ControlFlow 0 16) 14) anon18_Then_correct) (=> (= (ControlFlow 0 16) 11) anon18_Else_correct)))))
(let ((anon16_Then_correct  (=> (and ($Is refType |b#1@0| Tclass._module.Bot) ($IsAlloc refType |b#1@0| Tclass._module.Bot $Heap@@2)) (and (=> (= (ControlFlow 0 18) 16) anon17_Then_correct) (=> (= (ControlFlow 0 18) 17) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (not (and ($Is refType |b#1@0| Tclass._module.Bot) ($IsAlloc refType |b#1@0| Tclass._module.Bot $Heap@@2))) (and (=> (= (ControlFlow 0 15) 14) anon18_Then_correct) (=> (= (ControlFlow 0 15) 11) anon18_Else_correct)))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#3| null $Heap@@2 alloc Tclass._module.Bot |bots#0@@2|)) (and (=> (= (ControlFlow 0 19) 18) anon16_Then_correct) (=> (= (ControlFlow 0 19) 15) anon16_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) ($Is SeqType |bots#0@@2| (TSeq Tclass._module.Bot))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 20) 19))) anon0_correct)))
