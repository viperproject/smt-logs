...
(assert (forall (($h0 T@U) ($h1 T@U) (|x#0@@9| Int) ) (!  (=> (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@0 T@U) ($f@@0 T@U) ) (! true
 :qid |unknown.0:0|
 :skolemid |505|
)) (= (_module.__default.F_k_k $h0 |x#0@@9|) (_module.__default.F_k_k $h1 |x#0@@9|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |506|
