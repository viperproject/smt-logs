...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@0 T@U) ) (!  (=> (or |_module.__default.zeros#canCall| (< 1 $FunctionContextHeight)) ($Is DatatypeTypeType (_module.__default.zeros $ly@@0) (Tclass._module.Stream TInt)))
 :qid |Circdfy.11:16|
 :skolemid |533|
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) ) (!  (=> (or |_module.__default.blink#canCall| (< 1 $FunctionContextHeight)) ($Is DatatypeTypeType (_module.__default.blink $ly@@2) (Tclass._module.Stream TInt)))
 :qid |Circdfy.13:16|
 :skolemid |545|
 :pattern ( (_module.__default.blink $ly@@2))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@3 T@U) ) (!  (=> (or |_module.__default.zeros#canCall| (< 1 $FunctionContextHeight)) (and |_module.__default.zeros#canCall| (= (_module.__default.zeros ($LS $ly@@3)) (Lit DatatypeTypeType (|#_module.Stream.Cons| ($Box intType (int_2_U (LitInt 0))) (Lit DatatypeTypeType (_module.__default.zeros $ly@@3)))))))
 :qid |Circdfy.11:16|
 :skolemid |535|
 :pattern ( (_module.__default.zeros ($LS $ly@@3)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@4 T@U) ) (!  (=> (or |_module.__default.ones#canCall| (< 1 $FunctionContextHeight)) (and |_module.__default.ones#canCall| (= (_module.__default.ones ($LS $ly@@4)) (Lit DatatypeTypeType (|#_module.Stream.Cons| ($Box intType (int_2_U (LitInt 1))) (Lit DatatypeTypeType (_module.__default.ones $ly@@4)))))))
 :qid |Circdfy.12:16|
 :skolemid |541|
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@5 T@U) ) (!  (=> (or |_module.__default.blink#canCall| (< 1 $FunctionContextHeight)) (and |_module.__default.blink#canCall| (= (_module.__default.blink ($LS $ly@@5)) (Lit DatatypeTypeType (|#_module.Stream.Cons| ($Box intType (int_2_U (LitInt 0))) (Lit DatatypeTypeType (|#_module.Stream.Cons| ($Box intType (int_2_U (LitInt 1))) (Lit DatatypeTypeType (_module.__default.blink $ly@@5)))))))))
 :qid |Circdfy.13:16|
 :skolemid |547|
 :pattern ( (_module.__default.blink ($LS $ly@@5)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.zip$_T0@@0 T@U) ($ly@@6 T@U) (|a#0@@0| T@U) (|b#0@@0| T@U) ) (!  (=> (or (|_module.__default.zip#canCall| _module._default.zip$_T0@@0 |a#0@@0| |b#0@@0|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |a#0@@0| (Tclass._module.Stream _module._default.zip$_T0@@0)) ($Is DatatypeTypeType |b#0@@0| (Tclass._module.Stream _module._default.zip$_T0@@0))))) ($Is DatatypeTypeType (_module.__default.zip _module._default.zip$_T0@@0 $ly@@6 |a#0@@0| |b#0@@0|) (Tclass._module.Stream _module._default.zip$_T0@@0)))
 :qid |unknown.0:0|
 :skolemid |551|
 :pattern ( (_module.__default.zip _module._default.zip$_T0@@0 $ly@@6 |a#0@@0| |b#0@@0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.zip$_T0@@1 T@U) ($ly@@7 T@U) (|a#0@@1| T@U) (|b#0@@1| T@U) ) (!  (=> (and (or (|_module.__default.zip#canCall| _module._default.zip$_T0@@1 |a#0@@1| |b#0@@1|) (and (< 1 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |a#0@@1| (Tclass._module.Stream _module._default.zip$_T0@@1)) ($IsAlloc DatatypeTypeType |a#0@@1| (Tclass._module.Stream _module._default.zip$_T0@@1) $Heap)) (and ($Is DatatypeTypeType |b#0@@1| (Tclass._module.Stream _module._default.zip$_T0@@1)) ($IsAlloc DatatypeTypeType |b#0@@1| (Tclass._module.Stream _module._default.zip$_T0@@1) $Heap))))) ($IsGoodHeap $Heap)) ($IsAlloc DatatypeTypeType (_module.__default.zip _module._default.zip$_T0@@1 $ly@@7 |a#0@@1| |b#0@@1|) (Tclass._module.Stream _module._default.zip$_T0@@1) $Heap))
 :qid |Circdfy.14:16|
 :skolemid |552|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.__default.zip _module._default.zip$_T0@@1 $ly@@7 |a#0@@1| |b#0@@1|) (Tclass._module.Stream _module._default.zip$_T0@@1) $Heap))
))))
...
(assert (forall (($ly@@10 T@U) ) (! (= (_module.__default.blink ($LS $ly@@10)) (_module.__default.blink $ly@@10))
 :qid |Circdfy.13:16|
 :skolemid |543|
 :pattern ( (_module.__default.blink ($LS $ly@@10)))
)))
(assert (forall ((_module._default.zip$_T0@@2 T@U) ($ly@@11 T@U) (|a#0@@2| T@U) (|b#0@@2| T@U) ) (! (= (_module.__default.zip _module._default.zip$_T0@@2 ($LS $ly@@11) |a#0@@2| |b#0@@2|) (_module.__default.zip _module._default.zip$_T0@@2 $ly@@11 |a#0@@2| |b#0@@2|))
 :qid |unknown.0:0|
 :skolemid |549|
 :pattern ( (_module.__default.zip _module._default.zip$_T0@@2 ($LS $ly@@11) |a#0@@2| |b#0@@2|))
)))
...
(declare-fun $Heap@@0 () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.BlinkZipProperty_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (|$PrefixEq#_module.Stream| TInt TInt |_k#0| ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.__default.zip TInt ($LS $LZ) (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ))))) (Lit DatatypeTypeType (_module.__default.blink ($LS $LZ)))) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (Lit DatatypeTypeType (_module.__default.zip TInt ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.__default.zeros ($LS ($LS $LZ)))) (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ))))))) (and (_module.Stream.Cons_q (Lit DatatypeTypeType (_module.__default.blink ($LS ($LS $LZ))))) (and (= (U_2_int ($Unbox intType (_module.Stream.head (Lit DatatypeTypeType (_module.__default.zip TInt ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.__default.zeros ($LS ($LS $LZ)))) (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ))))))))) (U_2_int ($Unbox intType (_module.Stream.head (Lit DatatypeTypeType (_module.__default.blink ($LS ($LS $LZ)))))))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.zip TInt ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.__default.zeros ($LS ($LS $LZ)))) (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ))))))) (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.blink ($LS ($LS $LZ)))))))))))) (=> (or (|$PrefixEq#_module.Stream| TInt TInt |_k#0| ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.__default.zip TInt ($LS $LZ) (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ))))) (Lit DatatypeTypeType (_module.__default.blink ($LS $LZ)))) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (Lit DatatypeTypeType (_module.__default.zip TInt ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.__default.zeros ($LS ($LS $LZ)))) (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ))))))) (and (_module.Stream.Cons_q (Lit DatatypeTypeType (_module.__default.blink ($LS ($LS $LZ))))) (and (= (U_2_int ($Unbox intType (_module.Stream.head (Lit DatatypeTypeType (_module.__default.zip TInt ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.__default.zeros ($LS ($LS $LZ)))) (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ))))))))) (U_2_int ($Unbox intType (_module.Stream.head (Lit DatatypeTypeType (_module.__default.blink ($LS ($LS $LZ)))))))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.zip TInt ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.__default.zeros ($LS ($LS $LZ)))) (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ))))))) (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.blink ($LS ($LS $LZ))))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (or (|$PrefixEq#_module.Stream| TInt TInt |_k#0| ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.__default.zip TInt ($LS $LZ) (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ))))) (Lit DatatypeTypeType (_module.__default.blink ($LS $LZ)))) (or (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (Lit DatatypeTypeType (_module.__default.zip TInt ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.__default.zeros ($LS ($LS $LZ)))) (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ))))))) (and (_module.Stream.Cons_q (Lit DatatypeTypeType (_module.__default.blink ($LS ($LS $LZ))))) (and (= (U_2_int ($Unbox intType (_module.Stream.head (Lit DatatypeTypeType (_module.__default.zip TInt ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.__default.zeros ($LS ($LS $LZ)))) (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ))))))))) (U_2_int ($Unbox intType (_module.Stream.head (Lit DatatypeTypeType (_module.__default.blink ($LS ($LS $LZ)))))))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.zip TInt ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.__default.zeros ($LS ($LS $LZ)))) (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ))))))) (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.blink ($LS ($LS $LZ)))))))))) (=> (and (or (not (= |_k#0| (|ORD#FromNat| 0))) (not true)) (= (|ORD#Offset| |_k#0|) 0)) (|$Eq#_module.Stream| TInt TInt ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.__default.zip TInt ($LS $LZ) (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ))))) (Lit DatatypeTypeType (_module.__default.blink ($LS $LZ))))))))))))
(let ((anon3_Else_correct  (=> (<= (|ORD#Offset| |_k#0|) 0) (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (= $Heap@0 $Heap@2)) (and (forall ((|_k'#0| T@U) ) (!  (=> (|ORD#Less| |_k'#0| |_k#0|) (|$PrefixEq#_module.Stream| TInt TInt |_k'#0| ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.__default.zip TInt ($LS $LZ) (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ))))) (Lit DatatypeTypeType (_module.__default.blink ($LS $LZ)))))
 :qid |Circdfy.16:16|
 :skolemid |558|
 :pattern ( (|$PrefixEq#_module.Stream| TInt TInt |_k'#0| ($LS ($LS $LZ)) (_module.__default.zip TInt ($LS $LZ) (_module.__default.zeros ($LS $LZ)) (_module.__default.ones ($LS $LZ))) (_module.__default.blink ($LS $LZ))))
 :pattern ( (|ORD#Less| |_k'#0| |_k#0|))
)) (= (ControlFlow 0 7) 2))) GeneratedUnifiedExit_correct))))
(let ((anon3_Then_correct  (=> (< 0 (|ORD#Offset| |_k#0|)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0|)) (=> (= |_k##0@0| (|ORD#Minus| |_k#0| (|ORD#FromNat| 1))) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and (and (and |_module.__default.zeros#canCall| |_module.__default.ones#canCall|) (|_module.__default.zip#canCall| TInt (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ))))) |_module.__default.blink#canCall|) (|$PrefixEq#_module.Stream| TInt TInt |_k##0@0| ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.__default.zip TInt ($LS $LZ) (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ))))) (Lit DatatypeTypeType (_module.__default.blink ($LS $LZ))))) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 4) 2))) GeneratedUnifiedExit_correct))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@0 $Heap@0) (forall ((|$ih#_k0#0| T@U) ) (!  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) (|ORD#Less| |$ih#_k0#0| |_k#0|)) (|$PrefixEq#_module.Stream| TInt TInt |$ih#_k0#0| ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.__default.zip TInt ($LS $LZ) (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ))))) (Lit DatatypeTypeType (_module.__default.blink ($LS $LZ)))))
 :qid |Circdfy.16:16|
 :skolemid |556|
 :pattern ( (|$PrefixEq#_module.Stream| TInt TInt |$ih#_k0#0| ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.__default.zip TInt ($LS $LZ) (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ))))) (Lit DatatypeTypeType (_module.__default.blink ($LS $LZ)))))
