...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.FlyRobotArmy)
...
(let ((anon5_Else_correct  (=> (and (=> (|Seq#Contains| |bots#0@@5| ($Box refType |b#0@0|)) (and (and (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 |b#0@0|) (_module.Bot.robot__inv $Heap@0 |b#0@0|)) (_module.Bot.flying $Heap@0 |b#0@0|))) (= (ControlFlow 0 8) 1)) anon4_correct)))
(let ((anon5_Then_correct  (=> (|Seq#Contains| |bots#0@@5| ($Box refType |b#0@0|)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= |b#0@0| null)) (not true))) (=> (or (not (= |b#0@0| null)) (not true)) (=> ($IsAllocBox ($Box refType |b#0@0|) Tclass._module.Bot? $Heap@0) (=> (and (|_module.Bot.Valid#canCall| $Heap@0 |b#0@0|) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 |b#0@0|)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= |b#0@0| null)) (not true))) (=> (or (not (= |b#0@0| null)) (not true)) (=> ($IsAllocBox ($Box refType |b#0@0|) Tclass._module.Bot? $Heap@0) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (U_2_bool (Lit boolType (bool_2_U true))) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 |b#0@0|))) (=> (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 |b#0@0|) (=> (and (|_module.Bot.robot__inv#canCall| $Heap@0 |b#0@0|) (_module.Bot.robot__inv $Heap@0 |b#0@0|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |b#0@0| null)) (not true))) (=> (or (not (= |b#0@0| null)) (not true)) (=> ($IsAllocBox ($Box refType |b#0@0|) Tclass._module.Bot? $Heap@0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (U_2_bool (Lit boolType (bool_2_U true))) (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 |b#0@0|))) (=> (and (and (_module.Bot.Valid reveal__module.Bot.Valid $Heap@0 |b#0@0|) (|_module.Bot.flying#canCall| $Heap@0 |b#0@0|)) (and (_module.Bot.flying $Heap@0 |b#0@0|) (= (ControlFlow 0 2) 1))) anon4_correct))))))))))))))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#6| null $Heap@@12 alloc (_module.__default.ArmyRepr $Heap@@12 |bots#0@@5|))) ($IsAlloc SeqType |bots#0@@5| (TSeq Tclass._module.Bot) $Heap@@12)) (=> (and (and (|_module.__default.ValidArmy#canCall| $Heap@@12 |bots#0@@5|) (_module.__default.ValidArmy $Heap@@12 |bots#0@@5|)) (and ($IsAlloc SeqType |bots#0@@5| (TSeq Tclass._module.Bot) $Heap@@12) (|_module.__default.ArmyRepr#canCall| $Heap@@12 |bots#0@@5|))) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@46 T@U) ) (!  (=> (and (or (not (= $o@@46 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@46) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@46) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@46)) (|Set#IsMember| (_module.__default.ArmyRepr $Heap@@12 |bots#0@@5|) ($Box refType $o@@46))))
 :qid |FlyingRobotsdfy.191:8|
 :skolemid |553|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@46))
))) (and ($HeapSucc $Heap@@12 $Heap@0) ($IsAlloc SeqType |bots#0@@5| (TSeq Tclass._module.Bot) $Heap@0))) (and (and (|_module.__default.ValidArmy#canCall| $Heap@0 |bots#0@@5|) (_module.__default.ValidArmy $Heap@0 |bots#0@@5|)) (and ($IsAlloc SeqType |bots#0@@5| (TSeq Tclass._module.Bot) $Heap@0) (|_module.__default.ArmyRepr#canCall| $Heap@0 |bots#0@@5|)))) (and (=> (= (ControlFlow 0 9) (- 0 10)) ($IsAlloc SeqType |bots#0@@5| (TSeq Tclass._module.Bot) $Heap@@12)) (=> ($IsAlloc SeqType |bots#0@@5| (TSeq Tclass._module.Bot) $Heap@@12) (=> (|_module.__default.ArmyRepr#canCall| $Heap@@12 |bots#0@@5|) (=> (and (and (forall (($o@@47 T@U) ) (!  (=> (and (|Set#IsMember| (_module.__default.ArmyRepr $Heap@0 |bots#0@@5|) ($Box refType $o@@47)) (not (|Set#IsMember| (_module.__default.ArmyRepr $Heap@@12 |bots#0@@5|) ($Box refType $o@@47)))) (or (not (= $o@@47 null)) (not true)))
 :qid |FlyingRobotsdfy.194:30|
 :skolemid |554|
 :pattern (  (or (not (= $o@@47 null)) (not true)))
)) (forall (($o@@48 T@U) ) (!  (=> (and (|Set#IsMember| (_module.__default.ArmyRepr $Heap@0 |bots#0@@5|) ($Box refType $o@@48)) (not (|Set#IsMember| (_module.__default.ArmyRepr $Heap@@12 |bots#0@@5|) ($Box refType $o@@48)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@48) alloc)))))
 :qid |FlyingRobotsdfy.194:30|
 :skolemid |555|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@48) alloc)))
))) (and ($Is refType |b#0@0| Tclass._module.Bot) ($IsAlloc refType |b#0@0| Tclass._module.Bot $Heap@0))) (and (=> (= (ControlFlow 0 9) 2) anon5_Then_correct) (=> (= (ControlFlow 0 9) 8) anon5_Else_correct)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@12) ($IsHeapAnchor $Heap@@12)) (=> (and (and ($Is SeqType |bots#0@@5| (TSeq Tclass._module.Bot)) ($IsAlloc SeqType |bots#0@@5| (TSeq Tclass._module.Bot) $Heap@@12)) (and (= 7 $FunctionContextHeight) (= (ControlFlow 0 11) 9))) anon0_correct))))
