...
(assert  (and (and (and (and (= (Ctor FieldType) 7) (= (Ctor refType) 8)) (forall ((arg0@@2 T@T) (arg1 T@T) ) (= (Ctor (MapType0Type arg0@@2 arg1)) 9))) (forall ((arg0@@3 T@T) (arg1@@0 T@T) ) (! (= (MapType0TypeInv0 (MapType0Type arg0@@3 arg1@@0)) arg0@@3)
...
(assert (forall ((a@@2 T@U) (b@@2 T@U) (t0@@6 T@U) (t1@@3 T@U) ) (!  (=> (forall ((bx@@9 T@U) )  (=> (U_2_bool (MapType0Select BoxType boolType a@@2 bx@@9)) (and ($IsBox bx@@9 t0@@6) ($IsBox (MapType0Select BoxType BoxType b@@2 bx@@9) t1@@3)))) ($Is IMapType (|IMap#Glue| a@@2 b@@2 (TIMap t0@@6 t1@@3)) (TIMap t0@@6 t1@@3)))
