// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/Bug129.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/Bug129-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/Bug129.dfy
...
axiom (forall a#12#0#0: Box :: 
  { #_module.Maybe.Some(a#12#0#0) } 
  DatatypeCtorId(#_module.Maybe.Some(a#12#0#0)) == ##_module.Maybe.Some);
}
...
axiom (forall d: DatatypeType :: 
  { _module.Maybe.Some_q(d) } 
  _module.Maybe.Some_q(d)
     ==> (exists a#13#0#0: Box :: d == #_module.Maybe.Some(a#13#0#0)));
...
// Constructor $Is
axiom (forall _module.Maybe$T: Ty, a#14#0#0: Box :: 
  { $Is(#_module.Maybe.Some(a#14#0#0), Tclass._module.Maybe(_module.Maybe$T)) } 
  $Is(#_module.Maybe.Some(a#14#0#0), Tclass._module.Maybe(_module.Maybe$T))
     <==> $IsBox(a#14#0#0, _module.Maybe$T));

// Constructor $IsAlloc
axiom (forall _module.Maybe$T: Ty, a#14#0#0: Box, $h: Heap :: 
  { $IsAlloc(#_module.Maybe.Some(a#14#0#0), Tclass._module.Maybe(_module.Maybe$T), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_module.Maybe.Some(a#14#0#0), Tclass._module.Maybe(_module.Maybe$T), $h)
       <==> $IsAllocBox(a#14#0#0, _module.Maybe$T, $h)));
...
axiom (forall a#15#0#0: Box :: 
  { #_module.Maybe.Some(Lit(a#15#0#0)) } 
  #_module.Maybe.Some(Lit(a#15#0#0)) == Lit(#_module.Maybe.Some(a#15#0#0)));
...
axiom (forall a#16#0#0: Box :: 
  ...
  _module.Maybe.v(#_module.Maybe.Some(a#16#0#0)) == a#16#0#0);

// Inductive rank
axiom (forall a#17#0#0: Box :: 
  { #_module.Maybe.Some(a#17#0#0) } 
  BoxRank(a#17#0#0) < DtRank(#_module.Maybe.Some(a#17#0#0)));
...
axiom (forall a#22#0#0: DatatypeType :: 
  { #_module.B.B(a#22#0#0) } 
  DatatypeCtorId(#_module.B.B(a#22#0#0)) == ##_module.B.B);
}
...
axiom (forall d: DatatypeType :: 
  { _module.B.B_q(d) } 
  _module.B.B_q(d)
     ==> (exists a#23#0#0: DatatypeType :: d == #_module.B.B(a#23#0#0)));
...
axiom (forall a#24#0#0: DatatypeType :: 
  { $Is(#_module.B.B(a#24#0#0), Tclass._module.B()) } 
  $Is(#_module.B.B(a#24#0#0), Tclass._module.B())
     <==> $Is(a#24#0#0, Tclass._module.Maybe(Tclass._module.B())));
...
axiom (forall a#26#0#0: DatatypeType :: 
  ...
  _module.B.b(#_module.B.B(a#26#0#0)) == a#26#0#0);

// Inductive rank
axiom (forall a#27#0#0: DatatypeType :: 
  { #_module.B.B(a#27#0#0) } 
  DtRank(a#27#0#0) < DtRank(#_module.B.B(a#27#0#0)));

// Datatype $IsAlloc
axiom (forall d: DatatypeType, $h: Heap :: 
  { $IsAlloc(d, Tclass._module.B(), $h) } 
  $IsGoodHeap($h) && $Is(d, Tclass._module.B())
     ==> $IsAlloc(d, Tclass._module.B(), $h));
...
axiom (forall a#36#0#0: Box, a#36#1#0: DatatypeType :: 
  ...
  _module.List._h0(#_module.List.Cons(a#36#0#0, a#36#1#0)) == a#36#0#0);
...
axiom (forall a#38#0#0: Box, a#38#1#0: DatatypeType :: 
  ...
  _module.List._h1(#_module.List.Cons(a#38#0#0, a#38#1#0)) == a#38#1#0);
...
axiom (forall a#40#0#0: DatatypeType :: 
  { #_module.Tree.Nodes(a#40#0#0) } 
  DatatypeCtorId(#_module.Tree.Nodes(a#40#0#0)) == ##_module.Tree.Nodes);
}
...
axiom (forall d: DatatypeType :: 
  { _module.Tree.Nodes_q(d) } 
  _module.Tree.Nodes_q(d)
     ==> (exists a#41#0#0: DatatypeType :: d == #_module.Tree.Nodes(a#41#0#0)));
...
// Constructor $Is
axiom (forall _module.Tree$T: Ty, a#42#0#0: DatatypeType :: 
  { $Is(#_module.Tree.Nodes(a#42#0#0), Tclass._module.Tree(_module.Tree$T)) } 
  $Is(#_module.Tree.Nodes(a#42#0#0), Tclass._module.Tree(_module.Tree$T))
     <==> $Is(a#42#0#0, Tclass._module.List(Tclass._module.Tree(_module.Tree$T))));

// Constructor $IsAlloc
axiom (forall _module.Tree$T: Ty, a#42#0#0: DatatypeType, $h: Heap :: 
  { $IsAlloc(#_module.Tree.Nodes(a#42#0#0), Tclass._module.Tree(_module.Tree$T), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_module.Tree.Nodes(a#42#0#0), Tclass._module.Tree(_module.Tree$T), $h)
       <==> $IsAlloc(a#42#0#0, Tclass._module.List(Tclass._module.Tree(_module.Tree$T)), $h)));
...
axiom (forall a#43#0#0: DatatypeType :: 
  { #_module.Tree.Nodes(Lit(a#43#0#0)) } 
  #_module.Tree.Nodes(Lit(a#43#0#0)) == Lit(#_module.Tree.Nodes(a#43#0#0)));

function _module.Tree.children(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#44#0#0: DatatypeType :: 
  { #_module.Tree.Nodes(a#44#0#0) } 
  _module.Tree.children(#_module.Tree.Nodes(a#44#0#0)) == a#44#0#0);

// Inductive rank
axiom (forall a#45#0#0: DatatypeType :: 
  { #_module.Tree.Nodes(a#45#0#0) } 
  DtRank(a#45#0#0) < DtRank(#_module.Tree.Nodes(a#45#0#0)));
