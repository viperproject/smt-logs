...
(declare-fun _module.__default.f1 (Int) T@U)
(declare-fun |_module.__default.f1#canCall| (Int) Bool)
...
(declare-fun _module.__default.f2 (Int Int) Int)
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|$w#1| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#1| |l#0| |l#1|) |$w#1|))  (and ($IsBox |$w#1| |l#0|) (|Set#IsMember| |l#1| |$w#1|)))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |540|
 :pattern ( (MapType0Select BoxType boolType (|lambda#1| |l#0| |l#1|) |$w#1|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|d#0| Int) ) (!  (=> (or (|_module.__default.f1#canCall| |d#0|) (< 0 $FunctionContextHeight)) ($Is MapType (_module.__default.f1 |d#0|) (TMap TInt TInt)))
 :qid |Bug114dfy.4:19|
 :skolemid |528|
 :pattern ( (_module.__default.f1 |d#0|))
))))
...
(assert (forall ((|l#0@@0| Int) (|$w#1@@0| T@U) ) (! (= (MapType0Select BoxType BoxType (|lambda#2| |l#0@@0|) |$w#1@@0|) ($Box intType (int_2_U (_module.__default.f2 (U_2_int ($Unbox intType |$w#1@@0|)) |l#0@@0|))))
 :qid |Bug114dfy.9:17|
 :skolemid |541|
 :pattern ( (MapType0Select BoxType BoxType (|lambda#2| |l#0@@0|) |$w#1@@0|))
)))
...
(declare-fun |m#0| () T@U)
(declare-fun |_module.__default.f2#canCall| (Int Int) Bool)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon4_correct  (=> (and (forall ((|d#2| Int) ) (!  (and (|_module.__default.f1#canCall| |d#2|) (forall ((|x#1| Int) ) (!  (=> (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |x#1|))) (|_module.__default.f2#canCall| |x#1| |d#2|))
 :qid |Bug114dfy.9:36|
 :skolemid |535|
 :pattern ( (_module.__default.f2 |x#1| |d#2|))
 :pattern ( (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |x#1|))))
)))
 :qid |Bug114dfy.9:17|
 :skolemid |536|
 :pattern ( (_module.__default.f1 |d#2|))
)) (= (ControlFlow 0 4) (- 0 3))) (forall ((|d#2@@0| Int) ) (! (|Map#Equal| (_module.__default.f1 |d#2@@0|) (|Map#Glue| (|Set#FromBoogieMap| (|lambda#1| TInt (|Map#Domain| |m#0|))) (|lambda#2| |d#2@@0|) (TMap TInt TInt)))
 :qid |Bug114dfy.9:17|
 :skolemid |538|
 :pattern ( (_module.__default.f1 |d#2@@0|))
)))))
(let ((anon8_Else_correct  (=> (and (not (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |x#0@0|)))) (= (ControlFlow 0 6) 4)) anon4_correct)))
(let ((anon8_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |x#0@0|))) (=> (and (and ($IsAlloc intType (int_2_U |x#0@0|) TInt $Heap) ($IsAlloc intType (int_2_U |d#1@0|) TInt $Heap)) (and (|_module.__default.f2#canCall| |x#0@0| |d#1@0|) (= (ControlFlow 0 5) 4))) anon4_correct))))
(let ((anon7_Then_correct  (and (=> (= (ControlFlow 0 7) 5) anon8_Then_correct) (=> (= (ControlFlow 0 7) 6) anon8_Else_correct))))
(let ((anon7_Else_correct true))
(let ((anon6_Then_correct  (=> (and ($IsAlloc intType (int_2_U |d#1@0|) TInt $Heap) (|_module.__default.f1#canCall| |d#1@0|)) (and (=> (= (ControlFlow 0 8) 7) anon7_Then_correct) (=> (= (ControlFlow 0 8) 2) anon7_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is MapType |m#0| (TMap TInt TInt)) ($IsAlloc MapType |m#0| (TMap TInt TInt) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct))))
