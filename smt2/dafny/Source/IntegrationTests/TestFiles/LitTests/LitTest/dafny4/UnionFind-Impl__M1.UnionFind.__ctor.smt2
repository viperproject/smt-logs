...
(set-info :boogie-vc-id Impl$$M1.UnionFind.__ctor)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (=> (and (= |$rhs#0@0| (|Set#UnionOne| |Set#Empty| ($Box refType this@@13))) (= |$rhs#1@0| (Lit MapType |Map#Empty|))) (=> (and (and (or (not (= this@@13 null)) (not true)) ($Is refType this@@13 Tclass.M1.UnionFind?)) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) alloc)))) (= ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.M)) |$rhs#1@0|))) (=> (and (and (and (= ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M1.UnionFind.Repr)) |$rhs#0@0|) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@13 M1.UnionFind.Repr)) (= |$rhs#2@0| (|Set#UnionOne| |Set#Empty| ($Box refType this@@13)))) (and (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 this@@13 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@13) M1.UnionFind.Repr ($Box SetType |$rhs#2@0|)))) ($IsGoodHeap $Heap@1)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> false (=> (|M1.UnionFind.Valid#canCall| $Heap@1 this@@13) (or (M1.UnionFind.Valid $Heap@1 this@@13) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@13) M1.UnionFind.Repr)) ($Box refType this@@13)))))) (=> (=> false (=> (|M1.UnionFind.Valid#canCall| $Heap@1 this@@13) (or (M1.UnionFind.Valid $Heap@1 this@@13) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@13) M1.UnionFind.Repr)) ($Box refType this@@13))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> false (=> (|M1.UnionFind.Valid#canCall| $Heap@1 this@@13) (or (M1.UnionFind.Valid $Heap@1 this@@13) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@13) M1.UnionFind.Repr)) ($Box refType null))))))) (=> (=> false (=> (|M1.UnionFind.Valid#canCall| $Heap@1 this@@13) (or (M1.UnionFind.Valid $Heap@1 this@@13) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@13) M1.UnionFind.Repr)) ($Box refType null)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> false (=> (|M1.UnionFind.Valid#canCall| $Heap@1 this@@13) (or (M1.UnionFind.Valid $Heap@1 this@@13) (M1.UnionFind.ValidM1 $Heap@1 this@@13))))) (=> (=> false (=> (|M1.UnionFind.Valid#canCall| $Heap@1 this@@13) (or (M1.UnionFind.Valid $Heap@1 this@@13) (M1.UnionFind.ValidM1 $Heap@1 this@@13)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> false (and (forall (($o@@15 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@13) M1.UnionFind.Repr)) ($Box refType $o@@15)) (or (not (= $o@@15 null)) (not true)))
 :qid |UnionFinddfy.17:5|
 :skolemid |1311|
 :pattern (  (or (not (= $o@@15 null)) (not true)))
)) (forall (($o@@16 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@13) M1.UnionFind.Repr)) ($Box refType $o@@16)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 $o@@16) alloc)))))
 :qid |UnionFinddfy.17:5|
 :skolemid |1312|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@13) M1.UnionFind.Repr)) ($Box refType $o@@16)))
))))) (=> (=> false (and (forall (($o@@17 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@13) M1.UnionFind.Repr)) ($Box refType $o@@17)) (or (not (= $o@@17 null)) (not true)))
 :qid |UnionFinddfy.17:5|
 :skolemid |1311|
 :pattern (  (or (not (= $o@@17 null)) (not true)))
)) (forall (($o@@18 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@13) M1.UnionFind.Repr)) ($Box refType $o@@18)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 $o@@18) alloc)))))
 :qid |UnionFinddfy.17:5|
 :skolemid |1312|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@13) M1.UnionFind.Repr)) ($Box refType $o@@18)))
)))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (|Map#Equal| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@13) M1.UnionFind.M)) |Map#Empty|)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (and (= 7 $FunctionContextHeight) (= (ControlFlow 0 7) 2))) anon0_correct)))
