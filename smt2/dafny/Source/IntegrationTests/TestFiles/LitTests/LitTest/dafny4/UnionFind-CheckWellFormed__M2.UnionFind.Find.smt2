...
(set-info :boogie-vc-id CheckWellFormed$$M2.UnionFind.Find)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@6 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.Repr)))) (=> (and (and (and (and ($IsAllocBox ($Box refType this@@13) Tclass.M2.UnionFind? $Heap@@6) (|M2.UnionFind.Valid#canCall| $Heap@@6 this@@13)) (and (M2.UnionFind.Valid $Heap@@6 this@@13) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType |e#0@@5|)))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@15 T@U) ) (!  (=> (and (or (not (= $o@@15 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 $o@@15) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@15) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 $o@@15)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.Repr)) ($Box refType $o@@15))))
 :qid |UnionFinddfy.127:12|
 :skolemid |1881|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@15))
)) ($HeapSucc $Heap@@6 $Heap@0)))) (and (and (and ($Is refType |r#0@0| Tclass.M2.Element) ($IsAlloc refType |r#0@0| Tclass.M2.Element $Heap@0)) ($IsAllocBox ($Box refType this@@13) Tclass.M2.UnionFind? $Heap@0)) (and (|M2.UnionFind.Valid#canCall| $Heap@0 this@@13) (M2.UnionFind.Valid $Heap@0 this@@13)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@13 Tclass.M2.UnionFind $Heap@@6)) (=> ($IsAlloc refType this@@13 Tclass.M2.UnionFind $Heap@@6) (=> (and (forall (($o@@16 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@13) M2.UnionFind.Repr)) ($Box refType $o@@16)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.Repr)) ($Box refType $o@@16)))) (or (not (= $o@@16 null)) (not true)))
 :qid |UnionFinddfy.27:12|
 :skolemid |1882|
 :pattern (  (or (not (= $o@@16 null)) (not true)))
)) (forall (($o@@17 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@13) M2.UnionFind.Repr)) ($Box refType $o@@17)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.Repr)) ($Box refType $o@@17)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 $o@@17) alloc)))))
 :qid |UnionFinddfy.27:12|
 :skolemid |1883|
...
))) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType this@@13 Tclass.M2.UnionFind $Heap@@6)) (=> ($IsAlloc refType this@@13 Tclass.M2.UnionFind $Heap@@6) (=> (and (|Map#Equal| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@13) M2.UnionFind.M)) ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) (= (ControlFlow 0 2) (- 0 1))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@13) M2.UnionFind.M))) ($Box refType |e#0@@5|))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and (or (not (= this@@13 null)) (not true)) (and ($Is refType this@@13 Tclass.M2.UnionFind) ($IsAlloc refType this@@13 Tclass.M2.UnionFind $Heap@@6))) (and ($Is refType |e#0@@5| Tclass.M2.Element) ($IsAlloc refType |e#0@@5| Tclass.M2.Element $Heap@@6))) (and (and ($Is refType |r#0@@3| Tclass.M2.Element) ($IsAlloc refType |r#0@@3| Tclass.M2.Element $Heap@@6)) (and (= 9 $FunctionContextHeight) (= (ControlFlow 0 5) 2)))) anon0_correct))))
