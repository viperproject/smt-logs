...
(set-info :boogie-vc-id Impl$$_module.__default.orb__false)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|_module.Bool#Equal| (_module.__default.orb (Lit DatatypeTypeType |#_module.Bool.False|) |b#0|) |b#0|))))
