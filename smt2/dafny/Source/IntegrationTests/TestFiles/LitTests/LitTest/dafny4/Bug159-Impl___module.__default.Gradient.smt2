...
)) (forall ((|i#0_2@@0| Int) (|j#0_2@@0| Int) )  (=> (and (and (<= (LitInt 0) |i#0_2@@0|) (< |i#0_2@@0| |n#0|)) (and (<= (LitInt 0) |j#0_2@@0|) (< |j#0_2@@0| |n#0|))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (MultiIndexField (IndexField |i#0_2@@0|) |j#0_2@@0|)) ($Box intType (int_2_U (+ |i#0_2@@0| |j#0_2@@0|))))))) (and (= $Heap@2 $Heap@1) (= (ControlFlow 0 5) 2)))) GeneratedUnifiedExit_correct)))
