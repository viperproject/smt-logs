...
(set-info :boogie-vc-id Impl$$_module.__default.Gradient)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon6_correct  (=> (and (and (<= (LitInt 0) |i#0_0@0|) (< |i#0_0@0| |n#0|)) (and (<= (LitInt 0) |j#0_0@0|) (< |j#0_0@0| |n#0|))) (and (=> (= (ControlFlow 0 7) (- 0 11)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 7) (- 0 10)) (and (<= 0 |i#0_0@0|) (< |i#0_0@0| (_System.array2.Length0 $nw@0)))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (and (<= 0 |j#0_0@0|) (< |j#0_0@0| (_System.array2.Length1 $nw@0)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (MultiIndexField (IndexField |i#0_0@0|) |j#0_0@0|)))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (MultiIndexField (IndexField |i#0_0@0|) |j#0_0@0|))) (=> (and (and (and (<= (LitInt 0) |i#0_1@0|) (< |i#0_1@0| |n#0|)) (and (<= (LitInt 0) |j#0_1@0|) (< |j#0_1@0| |n#0|))) (and (not (and (= |i#0_0@0| |i#0_1@0|) (= |j#0_0@0| |j#0_1@0|))) (= (ControlFlow 0 7) (- 0 6)))) (or (or (or (not (= $nw@0 $nw@0)) (not true)) (or (not (= (MultiIndexField (IndexField |i#0_0@0|) |j#0_0@0|) (MultiIndexField (IndexField |i#0_1@0|) |j#0_1@0|))) (not true))) (= (+ |i#0_0@0| |j#0_0@0|) (+ |i#0_1@0| |j#0_1@0|)))))))))))))
(let ((anon11_Else_correct  (=> (and (< |j#0_0@0| (LitInt 0)) (= (ControlFlow 0 14) 7)) anon6_correct)))
(let ((anon11_Then_correct  (=> (and (<= (LitInt 0) |j#0_0@0|) (= (ControlFlow 0 13) 7)) anon6_correct)))
(let ((anon10_Then_correct  (=> (and (<= (LitInt 0) |i#0_0@0|) (< |i#0_0@0| |n#0|)) (and (=> (= (ControlFlow 0 15) 13) anon11_Then_correct) (=> (= (ControlFlow 0 15) 14) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#0_0@0|) (< |i#0_0@0| |n#0|))) (= (ControlFlow 0 12) 7)) anon6_correct)))
(let ((anon9_Else_correct  (=> (< |i#0_0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 17) 15) anon10_Then_correct) (=> (= (ControlFlow 0 17) 12) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> (<= (LitInt 0) |i#0_0@0|) (and (=> (= (ControlFlow 0 16) 15) anon10_Then_correct) (=> (= (ControlFlow 0 16) 12) anon10_Else_correct)))))
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 18) 16) anon9_Then_correct) (=> (= (ControlFlow 0 18) 17) anon9_Else_correct))))
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (_System.array2.Length0 $nw@0) (_System.array2.Length1 $nw@0))) (=> (= (_System.array2.Length0 $nw@0) (_System.array2.Length1 $nw@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (_System.array2.Length1 $nw@0) |n#0|)) (=> (= (_System.array2.Length1 $nw@0) |n#0|) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|i#1| Int) (|j#1| Int) ) (!  (=> (and (and (<= (LitInt 0) |i#1|) (< |i#1| |n#0|)) (and (<= (LitInt 0) |j#1|) (< |j#1| |n#0|))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (MultiIndexField (IndexField |i#1|) |j#1|)))) (+ |j#1| |i#1|)))
 :qid |Bug159dfy.25:18|
 :skolemid |642|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (MultiIndexField (IndexField |i#1|) |j#1|))))
)))))))))
(let ((anon8_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) ($HeapSucc $Heap@0 $Heap@1)) (and (and (forall (($o@@8 T@U) ($f@@0 T@U) ) (!  (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@8) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@8) $f@@0)) (exists ((|i#0_2| Int) (|j#0_2| Int) ) (!  (and (and (and (and (<= (LitInt 0) |i#0_2|) (< |i#0_2| |n#0|)) (and (<= (LitInt 0) |j#0_2|) (< |j#0_2| |n#0|))) (= $o@@8 $nw@0)) (= $f@@0 (MultiIndexField (IndexField |i#0_2|) |j#0_2|)))
 :qid |Bug159dfy.28:10|
 :skolemid |644|
)))
 :qid |Bug159dfy.28:3|
...
)) (forall ((|i#0_2@@0| Int) (|j#0_2@@0| Int) ) (!  (=> (and (and (<= (LitInt 0) |i#0_2@@0|) (< |i#0_2@@0| |n#0|)) (and (<= (LitInt 0) |j#0_2@@0|) (< |j#0_2@@0| |n#0|))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (MultiIndexField (IndexField |i#0_2@@0|) |j#0_2@@0|)) ($Box intType (int_2_U (+ |i#0_2@@0| |j#0_2@@0|)))))
 :qid |Bug159dfy.28:10|
 :skolemid |646|
))) (and (= $Heap@2 $Heap@1) (= (ControlFlow 0 5) 2)))) GeneratedUnifiedExit_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 19) (- 0 21)) (<= 0 |n#0|)) (=> (<= 0 |n#0|) (and (=> (= (ControlFlow 0 19) (- 0 20)) (<= 0 |n#0|)) (=> (<= 0 |n#0|) (=> (and (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array2? TInt))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc)))) (= (_System.array2.Length0 $nw@0) |n#0|))) (and (and (= (_System.array2.Length1 $nw@0) |n#0|) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (=> (= (ControlFlow 0 19) 18) anon8_Then_correct) (=> (= (ControlFlow 0 19) 5) anon8_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |n#0|)) (and (and ($Is refType |m#0| (Tclass._System.array2 TInt)) ($IsAlloc refType |m#0| (Tclass._System.array2 TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 22) 19)))) anon0_correct)))
