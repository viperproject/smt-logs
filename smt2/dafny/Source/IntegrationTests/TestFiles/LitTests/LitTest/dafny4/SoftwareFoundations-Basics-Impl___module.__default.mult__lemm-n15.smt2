...
(set-info :boogie-vc-id Impl$$_module.__default.mult__lemma_split0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (|_module.Nat#Equal| (_module.__default.mult ($LS ($LS $LZ)) |m#0@@7| (_module.__default.plus ($LS ($LS $LZ)) |n#0@@7| |n#0@@7|)) (_module.__default.mult ($LS ($LS $LZ)) (_module.__default.plus ($LS ($LS $LZ)) |m#0@@7| |m#0@@7|) |n#0@@7|)))))
(let ((anon14_Else_correct  (=> (or (not (= |m#0@@7| |#_module.Nat.O|)) (not true)) (=> (and (= |m#0@@7| (|#_module.Nat.S| |_mcc#0#0_0@0|)) ($Is DatatypeTypeType |_mcc#0#0_0@0| Tclass._module.Nat)) (=> (and (and (and ($Is DatatypeTypeType |m'#0_0@0| Tclass._module.Nat) ($IsAlloc DatatypeTypeType |m'#0_0@0| Tclass._module.Nat $Heap@0)) (= |let#0_0#0#0| |_mcc#0#0_0@0|)) (and (and ($Is DatatypeTypeType |let#0_0#0#0| Tclass._module.Nat) (= |m'#0_0@0| |let#0_0#0#0|)) (and (|_module.Nat#Equal| (_module.__default.mult ($LS $LZ) |m#0@@7| (_module.__default.plus ($LS $LZ) |n#0@@7| |n#0@@7|)) (_module.__default.mult ($LS $LZ) (_module.__default.plus ($LS $LZ) (|#_module.Nat.S| |m'#0_0@0|) (|#_module.Nat.S| |m'#0_0@0|)) |n#0@@7|)) (= (ControlFlow 0 4) 2)))) GeneratedUnifiedExit_correct)))))
(let ((anon14_Then_correct  (=> (and (= |m#0@@7| |#_module.Nat.O|) (= (ControlFlow 0 3) 2)) GeneratedUnifiedExit_correct)))
(let ((anon0_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |m#0@@7| Tclass._module.Nat) ($IsAlloc DatatypeTypeType |m#0@@7| Tclass._module.Nat $Heap)) (|$IsA#_module.Nat| |m#0@@7|)) (and (and ($Is DatatypeTypeType |n#0@@7| Tclass._module.Nat) ($IsAlloc DatatypeTypeType |n#0@@7| Tclass._module.Nat $Heap)) (|$IsA#_module.Nat| |n#0@@7|))) (and (and (and (= 3 $FunctionContextHeight) (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false))) (and (|$IsA#_module.Nat| |m#0@@7|) (|$IsA#_module.Nat| |n#0@@7|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#m0#0| T@U) (|$ih#n0#0| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |$ih#m0#0| Tclass._module.Nat) ($Is DatatypeTypeType |$ih#n0#0| Tclass._module.Nat)) (U_2_bool (Lit boolType (bool_2_U true)))) (or (< (DtRank |$ih#m0#0|) (DtRank |m#0@@7|)) (and (= (DtRank |$ih#m0#0|) (DtRank |m#0@@7|)) (< (DtRank |$ih#n0#0|) (DtRank |n#0@@7|))))) (|_module.Nat#Equal| (_module.__default.mult ($LS $LZ) |$ih#m0#0| (_module.__default.plus ($LS $LZ) |$ih#n0#0| |$ih#n0#0|)) (_module.__default.mult ($LS $LZ) (_module.__default.plus ($LS $LZ) |$ih#m0#0| |$ih#m0#0|) |$ih#n0#0|)))
...
)))))) (and (=> (= (ControlFlow 0 5) 3) anon14_Then_correct) (=> (= (ControlFlow 0 5) 4) anon14_Else_correct))))))
anon0_correct)))))
))
(check-sat)
(get-info :rlimit)
