...
(declare-fun |##xs#1_1_0_0_0@0| () T@U)
(declare-fun $Heap@2 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |##x#1_1_0_1_0@0| () T@U)
(declare-fun |##xs#1_1_0_1_0@0| () T@U)
(declare-fun |x##1_1_0_1_0@0| () T@U)
(declare-fun $Heap@1 () T@U)
(declare-fun |##xs#1_1_0_1_1@0| () T@U)
(declare-fun |##xs#1_1_0_2_0@0| () T@U)
(declare-fun |##x#1_1_0_2_1@0| () T@U)
(declare-fun |##xs#1_1_0_2_1@0| () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $Heap@@1 () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.perm__mergeAll)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 14) (- 0 13)) (|MultiSet#Equal| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) (_module.__default.mergeAll ($LS ($LS $LZ)) |x#0@@7|)) (_module.__default.MultisetUnion Tclass._module.G ($LS ($LS $LZ)) |x#0@@7|)))))
(let ((anon15_Else_correct  (=> (and (|MultiSet#Equal| (_module.__default.multiset__of Tclass._module.G ($LS $LZ) (_module.__default.mergeAll ($LS $LZ) |x#0@@7|)) (_module.__default.MultisetUnion Tclass._module.G ($LS $LZ) |x#0@@7|)) (= (ControlFlow 0 17) 14)) GeneratedUnifiedExit_correct)))
(let ((anon11_Then_correct  (=> (and (|_module.List#Equal| (_module.List.tail |x#0@@7|) |#_module.List.Nil|) (= (ControlFlow 0 16) 14)) GeneratedUnifiedExit_correct)))
(let ((anon10_Then_correct  (=> (and (|_module.List#Equal| |x#0@@7| |#_module.List.Nil|) (= (ControlFlow 0 15) 14)) GeneratedUnifiedExit_correct)))
(let ((anon15_Then_correct  (=> ($IsAlloc DatatypeTypeType |x#0@@7| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@0) (=> (and (and (and (|_module.__default.mergePairs#canCall| |x#0@@7|) (= |##xs#1_1_0_0_0@0| (_module.__default.mergePairs ($LS $LZ) |x#0@@7|))) (and ($IsAlloc DatatypeTypeType |##xs#1_1_0_0_0@0| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@0) (|_module.__default.MultisetUnion#canCall| Tclass._module.G (_module.__default.mergePairs ($LS $LZ) |x#0@@7|)))) (and (and (|_module.__default.mergePairs#canCall| |x#0@@7|) (|_module.__default.MultisetUnion#canCall| Tclass._module.G (_module.__default.mergePairs ($LS $LZ) |x#0@@7|))) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)))) (=> (and (and (and (and (|_module.__default.mergePairs#canCall| |x#0@@7|) (|_module.__default.MultisetUnion#canCall| Tclass._module.G (_module.__default.mergePairs ($LS $LZ) |x#0@@7|))) (|_module.__default.MultisetUnion#canCall| Tclass._module.G |x#0@@7|)) (and (|MultiSet#Equal| (_module.__default.MultisetUnion Tclass._module.G ($LS ($LS $LZ)) (_module.__default.mergePairs ($LS ($LS $LZ)) |x#0@@7|)) (_module.__default.MultisetUnion Tclass._module.G ($LS ($LS $LZ)) |x#0@@7|)) (= $Heap@0 $Heap@2))) (and (and ($IsAlloc DatatypeTypeType |x#0@@7| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@2) (|_module.__default.MultisetUnion#canCall| Tclass._module.G |x#0@@7|)) (and (|_module.__default.MultisetUnion#canCall| Tclass._module.G |x#0@@7|) (= (ControlFlow 0 12) (- 0 11))))) (|MultiSet#Equal| (_module.__default.MultisetUnion Tclass._module.G ($LS ($LS $LZ)) (_module.__default.mergePairs ($LS ($LS $LZ)) |x#0@@7|)) (_module.__default.MultisetUnion Tclass._module.G ($LS ($LS $LZ)) |x#0@@7|)))))))
(let ((anon14_Then_correct  (=> ($IsAlloc DatatypeTypeType |x#0@@7| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@0) (=> (and (and (and (and (|_module.__default.mergePairs#canCall| |x#0@@7|) (= |##x#1_1_0_1_0@0| (_module.__default.mergePairs ($LS $LZ) |x#0@@7|))) (and ($IsAlloc DatatypeTypeType |##x#1_1_0_1_0@0| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@0) (not (|_module.List#Equal| |##x#1_1_0_1_0@0| |#_module.List.Nil|)))) (and (and (|_module.__default.mergeAll#canCall| (_module.__default.mergePairs ($LS $LZ) |x#0@@7|)) (= |##xs#1_1_0_1_0@0| (_module.__default.mergeAll ($LS $LZ) (_module.__default.mergePairs ($LS $LZ) |x#0@@7|)))) (and ($IsAlloc DatatypeTypeType |##xs#1_1_0_1_0@0| (Tclass._module.List Tclass._module.G) $Heap@0) (|_module.__default.multiset__of#canCall| Tclass._module.G (_module.__default.mergeAll ($LS $LZ) (_module.__default.mergePairs ($LS $LZ) |x#0@@7|)))))) (and (and (and (|_module.__default.mergePairs#canCall| |x#0@@7|) (|_module.__default.mergeAll#canCall| (_module.__default.mergePairs ($LS $LZ) |x#0@@7|))) (|_module.__default.multiset__of#canCall| Tclass._module.G (_module.__default.mergeAll ($LS $LZ) (_module.__default.mergePairs ($LS $LZ) |x#0@@7|)))) (and (and ($IsAlloc DatatypeTypeType |x#0@@7| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@0) (|_module.__default.mergePairs#canCall| |x#0@@7|)) (and (|_module.__default.mergePairs#canCall| |x#0@@7|) (= |x##1_1_0_1_0@0| (_module.__default.mergePairs ($LS $LZ) |x#0@@7|)))))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (or (<= 0 (_module.__default.length (Tclass._module.List Tclass._module.G) ($LS $LZ) |x#0@@7|)) (= (_module.__default.length (Tclass._module.List Tclass._module.G) ($LS $LZ) |x##1_1_0_1_0@0|) (_module.__default.length (Tclass._module.List Tclass._module.G) ($LS $LZ) |x#0@@7|)))) (=> (or (<= 0 (_module.__default.length (Tclass._module.List Tclass._module.G) ($LS $LZ) |x#0@@7|)) (= (_module.__default.length (Tclass._module.List Tclass._module.G) ($LS $LZ) |x##1_1_0_1_0@0|) (_module.__default.length (Tclass._module.List Tclass._module.G) ($LS $LZ) |x#0@@7|))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (< (_module.__default.length (Tclass._module.List Tclass._module.G) ($LS $LZ) |x##1_1_0_1_0@0|) (_module.__default.length (Tclass._module.List Tclass._module.G) ($LS $LZ) |x#0@@7|))) (=> (< (_module.__default.length (Tclass._module.List Tclass._module.G) ($LS $LZ) |x##1_1_0_1_0@0|) (_module.__default.length (Tclass._module.List Tclass._module.G) ($LS $LZ) |x#0@@7|)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (not (|_module.List#Equal| |x##1_1_0_1_0@0| |#_module.List.Nil|))) (=> (not (|_module.List#Equal| |x##1_1_0_1_0@0| |#_module.List.Nil|)) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and (and (and (|_module.__default.mergeAll#canCall| |x##1_1_0_1_0@0|) (|_module.__default.multiset__of#canCall| Tclass._module.G (_module.__default.mergeAll ($LS $LZ) |x##1_1_0_1_0@0|))) (|_module.__default.MultisetUnion#canCall| Tclass._module.G |x##1_1_0_1_0@0|)) (|MultiSet#Equal| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) (_module.__default.mergeAll ($LS ($LS $LZ)) |x##1_1_0_1_0@0|)) (_module.__default.MultisetUnion Tclass._module.G ($LS ($LS $LZ)) |x##1_1_0_1_0@0|))) (and (= $Heap@0 $Heap@1) ($IsAlloc DatatypeTypeType |x#0@@7| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@1))) (and (and (and (|_module.__default.mergePairs#canCall| |x#0@@7|) (= |##xs#1_1_0_1_1@0| (_module.__default.mergePairs ($LS $LZ) |x#0@@7|))) (and ($IsAlloc DatatypeTypeType |##xs#1_1_0_1_1@0| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@1) (|_module.__default.MultisetUnion#canCall| Tclass._module.G (_module.__default.mergePairs ($LS $LZ) |x#0@@7|)))) (and (and (|_module.__default.mergePairs#canCall| |x#0@@7|) (|_module.__default.MultisetUnion#canCall| Tclass._module.G (_module.__default.mergePairs ($LS $LZ) |x#0@@7|))) (= (ControlFlow 0 7) (- 0 6))))) (|MultiSet#Equal| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) (_module.__default.mergeAll ($LS ($LS $LZ)) (_module.__default.mergePairs ($LS ($LS $LZ)) |x#0@@7|))) (_module.__default.MultisetUnion Tclass._module.G ($LS ($LS $LZ)) (_module.__default.mergePairs ($LS ($LS $LZ)) |x#0@@7|)))))))))))))))
(let ((anon13_Then_correct  (=> (and (and ($IsAlloc DatatypeTypeType |x#0@@7| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@0) (not (|_module.List#Equal| |x#0@@7| |#_module.List.Nil|))) (and (|_module.__default.mergeAll#canCall| |x#0@@7|) (= |##xs#1_1_0_2_0@0| (_module.__default.mergeAll ($LS $LZ) |x#0@@7|)))) (=> (and (and (and ($IsAlloc DatatypeTypeType |##xs#1_1_0_2_0@0| (Tclass._module.List Tclass._module.G) $Heap@0) (|_module.__default.multiset__of#canCall| Tclass._module.G (_module.__default.mergeAll ($LS $LZ) |x#0@@7|))) (and (|_module.__default.mergeAll#canCall| |x#0@@7|) (|_module.__default.multiset__of#canCall| Tclass._module.G (_module.__default.mergeAll ($LS $LZ) |x#0@@7|)))) (and (and ($IsAlloc DatatypeTypeType |x#0@@7| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@0) (|_module.__default.mergePairs#canCall| |x#0@@7|)) (and (= |##x#1_1_0_2_1@0| (_module.__default.mergePairs ($LS $LZ) |x#0@@7|)) ($IsAlloc DatatypeTypeType |##x#1_1_0_2_1@0| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@0)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (|_module.List#Equal| |##x#1_1_0_2_1@0| |#_module.List.Nil|))) (=> (and (and (|_module.__default.mergeAll#canCall| (_module.__default.mergePairs ($LS $LZ) |x#0@@7|)) (= |##xs#1_1_0_2_1@0| (_module.__default.mergeAll ($LS $LZ) (_module.__default.mergePairs ($LS $LZ) |x#0@@7|)))) (and ($IsAlloc DatatypeTypeType |##xs#1_1_0_2_1@0| (Tclass._module.List Tclass._module.G) $Heap@0) (|_module.__default.multiset__of#canCall| Tclass._module.G (_module.__default.mergeAll ($LS $LZ) (_module.__default.mergePairs ($LS $LZ) |x#0@@7|))))) (=> (and (and (and (|_module.__default.mergePairs#canCall| |x#0@@7|) (|_module.__default.mergeAll#canCall| (_module.__default.mergePairs ($LS $LZ) |x#0@@7|))) (|_module.__default.multiset__of#canCall| Tclass._module.G (_module.__default.mergeAll ($LS $LZ) (_module.__default.mergePairs ($LS $LZ) |x#0@@7|)))) (= (ControlFlow 0 4) (- 0 3))) (|MultiSet#Equal| (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) (_module.__default.mergeAll ($LS ($LS $LZ)) |x#0@@7|)) (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) (_module.__default.mergeAll ($LS ($LS $LZ)) (_module.__default.mergePairs ($LS ($LS $LZ)) |x#0@@7|)))))))))))
(let ((anon12_Then_correct  (=> (and ($IsAlloc DatatypeTypeType |x#0@@7| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@0) (= (ControlFlow 0 2) (- 0 1))) (not (|_module.List#Equal| |x#0@@7| |#_module.List.Nil|)))))
(let ((anon11_Else_correct  (=> (not (|_module.List#Equal| (_module.List.tail |x#0@@7|) |#_module.List.Nil|)) (and (and (and (and (=> (= (ControlFlow 0 18) 2) anon12_Then_correct) (=> (= (ControlFlow 0 18) 4) anon13_Then_correct)) (=> (= (ControlFlow 0 18) 7) anon14_Then_correct)) (=> (= (ControlFlow 0 18) 12) anon15_Then_correct)) (=> (= (ControlFlow 0 18) 17) anon15_Else_correct)))))
(let ((anon10_Else_correct  (=> (not (|_module.List#Equal| |x#0@@7| |#_module.List.Nil|)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (_module.List.Cons_q |x#0@@7|)) (=> (_module.List.Cons_q |x#0@@7|) (=> (|$IsA#_module.List| (_module.List.tail |x#0@@7|)) (and (=> (= (ControlFlow 0 19) 16) anon11_Then_correct) (=> (= (ControlFlow 0 19) 18) anon11_Else_correct))))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (|$IsA#_module.List| |x#0@@7|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@1 $Heap@0)) (and (forall ((|$ih#x0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#x0#0| (Tclass._module.List (Tclass._module.List Tclass._module.G))) (not (|_module.List#Equal| |$ih#x0#0| |#_module.List.Nil|))) (and (<= 0 (_module.__default.length (Tclass._module.List Tclass._module.G) ($LS $LZ) |$ih#x0#0|)) (< (_module.__default.length (Tclass._module.List Tclass._module.G) ($LS $LZ) |$ih#x0#0|) (_module.__default.length (Tclass._module.List Tclass._module.G) ($LS $LZ) |x#0@@7|)))) (|MultiSet#Equal| (_module.__default.multiset__of Tclass._module.G ($LS $LZ) (_module.__default.mergeAll ($LS $LZ) |$ih#x0#0|)) (_module.__default.MultisetUnion Tclass._module.G ($LS $LZ) |$ih#x0#0|)))
 :qid |GHCMergeSortdfy.262:21|
 :skolemid |777|
 :pattern ( (_module.__default.MultisetUnion Tclass._module.G ($LS $LZ) |$ih#x0#0|))
 :pattern ( (_module.__default.mergeAll ($LS $LZ) |$ih#x0#0|))
)) (|$IsA#_module.List| |x#0@@7|))) (and (=> (= (ControlFlow 0 21) 15) anon10_Then_correct) (=> (= (ControlFlow 0 21) 19) anon10_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (and (and ($Is DatatypeTypeType |x#0@@7| (Tclass._module.List (Tclass._module.List Tclass._module.G))) ($IsAlloc DatatypeTypeType |x#0@@7| (Tclass._module.List (Tclass._module.List Tclass._module.G)) $Heap@@1)) (|$IsA#_module.List| |x#0@@7|)) (= 5 $FunctionContextHeight)) (and (not (|_module.List#Equal| |x#0@@7| |#_module.List.Nil|)) (= (ControlFlow 0 22) 21))) anon0_correct))))
