...
(assert (forall (($ly@@0 T@U) ($h0 T@U) ($h1 T@U) (|a#0@@0| T@U) (|lo#0@@0| Int) (|hi#0@@0| Int) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|_module.__default.Sum#canCall| $h0 |a#0@@0| |lo#0@@0| |hi#0@@0|) ($Is refType |a#0@@0| (Tclass._System.array TInt)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@3 T@U) ($f T@U) )  (=> (and (or (not (= $o@@3 null)) (not true)) (= $o@@3 |a#0@@0|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@3) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@3) $f)))) (= (_module.__default.Sum $ly@@0 $h0 |a#0@@0| |lo#0@@0| |hi#0@@0|) (_module.__default.Sum $ly@@0 $h1 |a#0@@0| |lo#0@@0| |hi#0@@0|))))
