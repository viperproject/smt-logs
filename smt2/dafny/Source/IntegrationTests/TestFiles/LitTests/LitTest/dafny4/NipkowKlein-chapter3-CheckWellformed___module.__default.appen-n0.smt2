...
(let ((anon10_Then_correct  (=> (and (and (= |xs#0@@4| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) ($IsBox |_mcc#0#0| _module._default.append$_T0@@4)) (and ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List _module._default.append$_T0@@4)) (= |let#0#0#0| |_mcc#1#0|))) (=> (and (and (and ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List _module._default.append$_T0@@4)) (= |tail#Z#0@0| |let#0#0#0|)) (and (= |let#1#0#0| |_mcc#0#0|) ($IsBox |let#1#0#0| _module._default.append$_T0@@4))) (and (and (= |x#Z#0@0| |let#1#0#0|) ($IsAlloc DatatypeTypeType |tail#Z#0@0| (Tclass._module.List _module._default.append$_T0@@4) $Heap@@0)) (and ($IsAlloc DatatypeTypeType |ys#0@@4| (Tclass._module.List _module._default.append$_T0@@4) $Heap@@0) (= (ControlFlow 0 4) (- 0 3))))) (or (< (DtRank |tail#Z#0@0|) (DtRank |xs#0@@4|)) (and (= (DtRank |tail#Z#0@0|) (DtRank |xs#0@@4|)) (< (DtRank |ys#0@@4|) (DtRank |ys#0@@4|))))))))
