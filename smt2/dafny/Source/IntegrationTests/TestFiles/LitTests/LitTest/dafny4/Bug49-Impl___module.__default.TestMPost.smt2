...
(assert (forall ((v@@4 T@U) (t0@@2 T@U) (t1@@1 T@U) ) (! (= ($Is MapType v@@4 (TMap t0@@2 t1@@1)) (forall ((bx@@4 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@4) bx@@4) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@4) bx@@4) t1@@1) ($IsBox bx@@4 t0@@2)))
...
(set-info :boogie-vc-id Impl$$_module.__default.TestMPost)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (= (LitInt (_module.__default.mapply (Lit MapType (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 5))) ($Box intType (int_2_U (LitInt 6))))) (LitInt 5))) (LitInt 6)))))
