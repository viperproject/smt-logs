...
(declare-fun $Heap@1 () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.GcdSubtractAlt_split25)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_correct  (=> (or (and ($Is intType (int_2_U (LitInt 1)) Tclass._module.pos) (= (Mul |p#0@0| (LitInt 1)) |y#0@@3|)) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._module.pos) (= (Mul |p#0@0| (LitInt 0)) |y#0@@3|)) (exists ((|$as#b0_0#0_0| Int) ) (!  (and (<= (LitInt 1) |$as#b0_0#0_0|) (= (Mul |p#0@0| |$as#b0_0#0_0|) |y#0@@3|))
 :qid |gcddfy.228:9|
 :skolemid |662|
)))) (=> (and (and (<= (LitInt 1) |b#0_0@0|) (= (Mul |p#0@0| |b#0_0@0|) |y#0@@3|)) (and (= |newtype$check#0_0_0_0@0| (Mul |p#0@0| |b#0_0@0|)) (<= (LitInt 1) |newtype$check#0_0_0_0@0|))) (=> (and (and (and (= |newtype$check#0_0_0_1@0| (Mul |p#0@0| |a#0_0@0|)) (<= (LitInt 1) |newtype$check#0_0_0_1@0|)) (and (= |newtype$check#0_0_0_2@0| (- (Mul |p#0@0| |b#0_0@0|) (Mul |p#0@0| |a#0_0@0|))) (<= (LitInt 1) |newtype$check#0_0_0_2@0|))) (and (and (= |newtype$check#0_0_0_3@0| (- |b#0_0@0| |a#0_0@0|)) (<= (LitInt 1) |newtype$check#0_0_0_3@0|)) (and (= |newtype$check#0_0_0_4@0| (Mul |p#0@0| (- |b#0_0@0| |a#0_0@0|))) (= (ControlFlow 0 2) (- 0 1))))) (<= (LitInt 1) |newtype$check#0_0_0_4@0|))))))
