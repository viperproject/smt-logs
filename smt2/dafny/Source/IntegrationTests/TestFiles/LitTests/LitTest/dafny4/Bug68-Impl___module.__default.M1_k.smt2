...
(set-info :boogie-vc-id Impl$$_module.__default.M1_k)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |m#0@0| (Lit MapType (|Map#Build| |Map#Empty| ($Box SetType (Lit SetType (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U (LitInt 10)))) ($Box intType (int_2_U (LitInt 20)))))) ($Box intType (int_2_U (LitInt 33))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Equal| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U (LitInt 10)))) ($Box intType (int_2_U (LitInt 20)))) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U (LitInt 20)))) ($Box intType (int_2_U (LitInt 10)))))) (=> (|Set#Equal| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U (LitInt 10)))) ($Box intType (int_2_U (LitInt 20)))) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U (LitInt 20)))) ($Box intType (int_2_U (LitInt 10))))) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box SetType (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U (LitInt 20)))) ($Box intType (int_2_U (LitInt 10))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |m#0| (TMap (TSet TInt) TInt)) ($IsAlloc MapType |m#0| (TMap (TSet TInt) TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
