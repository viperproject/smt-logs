...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@0 T@U) ($Heap T@U) (|f#0| T@U) (|n#0| Int) ) (!  (=> (or (|_module.__default.Iter#canCall| (Lit HandleTypeType |f#0|) (LitInt |n#0|)) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap) ($Is HandleTypeType |f#0| (Tclass._System.___hTotalFunc1 TInt TInt))))) (and (=> (< (LitInt 0) (LitInt |n#0|)) (|_module.__default.Iter#canCall| (Lit HandleTypeType |f#0|) (LitInt (- |n#0| 1)))) (= (_module.__default.Iter ($LS $ly@@0) (Lit HandleTypeType |f#0|) (LitInt |n#0|)) (ite (<= (LitInt |n#0|) (LitInt 0)) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap (Lit HandleTypeType |f#0|) ($Box intType (int_2_U (LitInt 1)))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap (Lit HandleTypeType |f#0|) ($Box intType (int_2_U (LitInt (_module.__default.Iter ($LS $ly@@0) (Lit HandleTypeType |f#0|) (LitInt (- |n#0| 1)))))))))))))
 :qid |Ackermanndfy.59:16|
 :weight 3
 :skolemid |566|
 :pattern ( (_module.__default.Iter ($LS $ly@@0) (Lit HandleTypeType |f#0|) (LitInt |n#0|)) ($IsGoodHeap $Heap))
))))
...
(assert (forall (($ly@@1 T@U) (|f#0@@2| T@U) (|n#0@@0| Int) ) (! (= (_module.__default.Iter ($LS $ly@@1) |f#0@@2| |n#0@@0|) (_module.__default.Iter $ly@@1 |f#0@@2| |n#0@@0|))
 :qid |Ackermanndfy.59:16|
 :skolemid |560|
 :pattern ( (_module.__default.Iter ($LS $ly@@1) |f#0@@2| |n#0@@0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@3 T@U) ($Heap@@0 T@U) (|f#0@@3| T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.__default.Iter#canCall| |f#0@@3| (LitInt |n#0@@1|)) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 TInt TInt))))) (and (=> (< (LitInt 0) (LitInt |n#0@@1|)) (|_module.__default.Iter#canCall| |f#0@@3| (LitInt (- |n#0@@1| 1)))) (= (_module.__default.Iter ($LS $ly@@3) |f#0@@3| (LitInt |n#0@@1|)) (ite (<= (LitInt |n#0@@1|) (LitInt 0)) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@0 |f#0@@3| ($Box intType (int_2_U (LitInt 1)))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@0 |f#0@@3| ($Box intType (int_2_U (_module.__default.Iter ($LS $ly@@3) |f#0@@3| (LitInt (- |n#0@@1| 1))))))))))))
 :qid |Ackermanndfy.59:16|
 :weight 3
 :skolemid |565|
 :pattern ( (_module.__default.Iter ($LS $ly@@3) |f#0@@3| (LitInt |n#0@@1|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@5 T@U) ($Heap@@1 T@U) (|f#0@@6| T@U) (|n#0@@2| Int) ) (!  (=> (or (|_module.__default.Iter#canCall| |f#0@@6| |n#0@@2|) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@1) ($Is HandleTypeType |f#0@@6| (Tclass._System.___hTotalFunc1 TInt TInt))))) (and (=> (< (LitInt 0) |n#0@@2|) (|_module.__default.Iter#canCall| |f#0@@6| (- |n#0@@2| 1))) (= (_module.__default.Iter ($LS $ly@@5) |f#0@@6| |n#0@@2|) (ite (<= |n#0@@2| (LitInt 0)) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@1 |f#0@@6| ($Box intType (int_2_U (LitInt 1)))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@1 |f#0@@6| ($Box intType (int_2_U (_module.__default.Iter $ly@@5 |f#0@@6| (- |n#0@@2| 1)))))))))))
 :qid |Ackermanndfy.59:16|
 :skolemid |564|
 :pattern ( (_module.__default.Iter ($LS $ly@@5) |f#0@@6| |n#0@@2|) ($IsGoodHeap $Heap@@1))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.A)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon18_Else_correct true))
(let ((anon18_Then_correct true))
(let ((anon17_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@2 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@2 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 12) 10) anon18_Then_correct) (=> (= (ControlFlow 0 12) 11) anon18_Else_correct)))))
(let ((anon17_Else_correct true))
(let ((anon16_Then_correct  (=> (<= |m#0@@3| (LitInt 0)) (and (=> (= (ControlFlow 0 13) 12) anon17_Then_correct) (=> (= (ControlFlow 0 13) 9) anon17_Else_correct)))))
(let ((anon20_Else_correct true))
(let ((anon20_Then_correct  (=> (= |$_Frame#l1@0| (|lambda#0| null |$lambdaHeap#1@0| alloc false)) (=> (and (= |##m#0@0| (- |m#0@@3| 1)) ($IsAlloc intType (int_2_U |##m#0@0|) TInt |$lambdaHeap#1@0|)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (<= 0 |m#0@@3|) (= |##m#0@0| |m#0@@3|))) (=> (or (<= 0 |m#0@@3|) (= |##m#0@0| |m#0@@3|)) (=> (= (ControlFlow 0 4) (- 0 3)) (< |##m#0@0| |m#0@@3|))))))))
(let ((anon19_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#1@0|) (or (= $Heap@@2 |$lambdaHeap#1@0|) ($HeapSucc $Heap@@2 |$lambdaHeap#1@0|))) (and (=> (= (ControlFlow 0 7) 4) anon20_Then_correct) (=> (= (ControlFlow 0 7) 6) anon20_Else_correct)))))
(let ((anon19_Else_correct true))
(let ((anon16_Else_correct  (=> (< (LitInt 0) |m#0@@3|) (and (=> (= (ControlFlow 0 8) 7) anon19_Then_correct) (=> (= (ControlFlow 0 8) 2) anon19_Else_correct)))))
(let ((anon15_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (and (and (=> (= (ControlFlow 0 14) 1) anon15_Then_correct) (=> (= (ControlFlow 0 14) 13) anon16_Then_correct)) (=> (= (ControlFlow 0 14) 8) anon16_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 15) 14))) anon0_correct)))
