...
(declare-fun |##mp#0_2_0@0| () T@U)
(declare-fun |##xs#0_2_0@0| () T@U)
(declare-fun |n##0_2_0@0| () Int)
(declare-fun $Heap@1 () T@U)
(declare-fun |##n#0_2_2@0| () Int)
(declare-fun |mp##0_2_0@0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.ExtractorLemma_split9)
...
)) ($IsAlloc intType (int_2_U |i#0|) TInt $Heap@0))) (and (and ($IsAlloc DatatypeTypeType |xs#0@@22| (Tclass._module.List _module._default.ExtractorLemma$T) $Heap@0) (|_module.__default.length#canCall| _module._default.ExtractorLemma$T |xs#0@@22|)) (and (= |##n#0_2_1@0| (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|)) ($IsAlloc intType (int_2_U |##n#0_2_1@0|) Tclass._System.nat $Heap@0)))) (and (and (and (|_module.__default.nats#canCall| (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|)) (= |##mp#0_2_0@0| (_module.__default.nats ($LS $LZ) (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|)))) (and ($IsAlloc DatatypeTypeType |##mp#0_2_0@0| (Tclass._module.List TInt) $Heap@0) ($IsAlloc DatatypeTypeType |xs#0@@22| (Tclass._module.List _module._default.ExtractorLemma$T) $Heap@0))) (and (and (|_module.__default.xtr#canCall| _module._default.ExtractorLemma$T (_module.__default.nats ($LS $LZ) (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|)) |xs#0@@22|) (= |##xs#0_2_0@0| (_module.__default.xtr _module._default.ExtractorLemma$T ($LS $LZ) (_module.__default.nats ($LS $LZ) (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|)) |xs#0@@22|))) (and ($IsAlloc DatatypeTypeType |##xs#0_2_0@0| (Tclass._module.List _module._default.ExtractorLemma$T) $Heap@0) (|_module.__default.nth#canCall| _module._default.ExtractorLemma$T |i#0| (_module.__default.xtr _module._default.ExtractorLemma$T ($LS $LZ) (_module.__default.nats ($LS $LZ) (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|)) |xs#0@@22|)))))) (=> (and (and (and (and (and (and (|_module.__default.length#canCall| _module._default.ExtractorLemma$T |xs#0@@22|) (|_module.__default.nats#canCall| (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|))) (|_module.__default.xtr#canCall| _module._default.ExtractorLemma$T (_module.__default.nats ($LS $LZ) (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|)) |xs#0@@22|)) (|_module.__default.nth#canCall| _module._default.ExtractorLemma$T |i#0| (_module.__default.xtr _module._default.ExtractorLemma$T ($LS $LZ) (_module.__default.nats ($LS $LZ) (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|)) |xs#0@@22|))) (and ($IsAlloc DatatypeTypeType |xs#0@@22| (Tclass._module.List _module._default.ExtractorLemma$T) $Heap@0) (|_module.__default.length#canCall| _module._default.ExtractorLemma$T |xs#0@@22|))) (and (and (|_module.__default.length#canCall| _module._default.ExtractorLemma$T |xs#0@@22|) (= |n##0_2_0@0| (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)))) (and (and (and (and (and (|_module.__default.nats#canCall| |n##0_2_0@0|) (|_module.__default.length#canCall| TInt (_module.__default.nats ($LS $LZ) |n##0_2_0@0|))) (= (_module.__default.length TInt ($LS ($LS $LZ)) (_module.__default.nats ($LS ($LS $LZ)) |n##0_2_0@0|)) |n##0_2_0@0|)) (and (= $Heap@0 $Heap@1) ($IsAlloc DatatypeTypeType |xs#0@@22| (Tclass._module.List _module._default.ExtractorLemma$T) $Heap@1))) (and (and (|_module.__default.length#canCall| _module._default.ExtractorLemma$T |xs#0@@22|) (= |##n#0_2_2@0| (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|))) (and ($IsAlloc intType (int_2_U |##n#0_2_2@0|) Tclass._System.nat $Heap@1) (|_module.__default.nats#canCall| (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|))))) (and (and (and (|_module.__default.length#canCall| _module._default.ExtractorLemma$T |xs#0@@22|) (|_module.__default.nats#canCall| (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|))) (= |mp##0_2_0@0| (_module.__default.nats ($LS $LZ) (_module.__default.length _module._default.ExtractorLemma$T ($LS $LZ) |xs#0@@22|)))) (and (<= (LitInt 0) |i#0|) (= (ControlFlow 0 2) (- 0 1)))))) (< |i#0| (_module.__default.length TInt ($LS ($LS $LZ)) |mp##0_2_0@0|))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
