...
(|_module.__default.plus#canCall| |n'#3| (Lit DatatypeTypeType |m#0|)))) (= (_module.__default.plus ($LS $ly) (Lit DatatypeTypeType |n#0|) (Lit DatatypeTypeType |m#0|)) (ite (_module.Nat.O_q (Lit DatatypeTypeType |n#0|)) |m#0| (let ((|n'#2| (Lit DatatypeTypeType (_module.Nat._h0 (Lit DatatypeTypeType |n#0|)))))
(Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (_module.__default.plus ($LS $ly) |n'#2| (Lit DatatypeTypeType |m#0|))))))))))
 :qid |SoftwareFoundationsBasicsdfy.180:16|
 :weight 3
 :skolemid |653|
 :pattern ( (_module.__default.plus ($LS $ly) (Lit DatatypeTypeType |n#0|) (Lit DatatypeTypeType |m#0|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@0 T@U) (|n#0@@0| T@U) (|m#0@@0| T@U) ) (!  (=> (or (|_module.__default.plus#canCall| |n#0@@0| |m#0@@0|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |n#0@@0| Tclass._module.Nat) ($Is DatatypeTypeType |m#0@@0| Tclass._module.Nat)))) ($Is DatatypeTypeType (_module.__default.plus $ly@@0 |n#0@@0| |m#0@@0|) Tclass._module.Nat))
 :qid |SoftwareFoundationsBasicsdfy.180:16|
 :skolemid |650|
 :pattern ( (_module.__default.plus $ly@@0 |n#0@@0| |m#0@@0|))
))))
(assert (forall (($ly@@1 T@U) (|n#0@@1| T@U) (|m#0@@1| T@U) ) (! (= (_module.__default.plus ($LS $ly@@1) |n#0@@1| |m#0@@1|) (_module.__default.plus $ly@@1 |n#0@@1| |m#0@@1|))
 :qid |SoftwareFoundationsBasicsdfy.180:16|
 :skolemid |648|
 :pattern ( (_module.__default.plus ($LS $ly@@1) |n#0@@1| |m#0@@1|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) (|n#0@@2| T@U) (|m#0@@2| T@U) ) (!  (=> (or (|_module.__default.plus#canCall| |n#0@@2| |m#0@@2|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |n#0@@2| Tclass._module.Nat) ($Is DatatypeTypeType |m#0@@2| Tclass._module.Nat)))) (and (=> (not (_module.Nat.O_q |n#0@@2|)) (let ((|n'#1| (_module.Nat._h0 |n#0@@2|)))
(|_module.__default.plus#canCall| |n'#1| |m#0@@2|))) (= (_module.__default.plus ($LS $ly@@2) |n#0@@2| |m#0@@2|) (ite (_module.Nat.O_q |n#0@@2|) |m#0@@2| (let ((|n'#0| (_module.Nat._h0 |n#0@@2|)))
(|#_module.Nat.S| (_module.__default.plus $ly@@2 |n'#0| |m#0@@2|)))))))
 :qid |SoftwareFoundationsBasicsdfy.180:16|
 :skolemid |652|
 :pattern ( (_module.__default.plus ($LS $ly@@2) |n#0@@2| |m#0@@2|))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.test__plus)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |##n#0@0| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType |#_module.Nat.O|))))))))) (=> (and (and (and ($IsAlloc DatatypeTypeType |##n#0@0| Tclass._module.Nat $Heap) (= |##m#0@0| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType |#_module.Nat.O|))))))) (and ($IsAlloc DatatypeTypeType |##m#0@0| Tclass._module.Nat $Heap) (|_module.__default.plus#canCall| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType |#_module.Nat.O|))))))) (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType |#_module.Nat.O|)))))))) (and (and (|$IsA#_module.Nat| (Lit DatatypeTypeType (_module.__default.plus ($LS $LZ) (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType |#_module.Nat.O|))))))) (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType |#_module.Nat.O|)))))))) (|_module.__default.plus#canCall| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType |#_module.Nat.O|))))))) (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType |#_module.Nat.O|))))))) (= (ControlFlow 0 2) (- 0 1)))) (|_module.Nat#Equal| (_module.__default.plus ($LS ($LS $LZ)) (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType |#_module.Nat.O|))))))) (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType |#_module.Nat.O|)))))) (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType (|#_module.Nat.S| (Lit DatatypeTypeType |#_module.Nat.O|)))))))))))))))
