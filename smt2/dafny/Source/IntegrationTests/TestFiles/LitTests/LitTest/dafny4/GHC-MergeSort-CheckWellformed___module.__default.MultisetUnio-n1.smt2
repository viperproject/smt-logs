...
(assert (forall ((_module._default.MultisetUnion$T T@U) ($ly@@0 T@U) (|xs#0@@0| T@U) ) (! (= (_module.__default.MultisetUnion _module._default.MultisetUnion$T ($LS $ly@@0) |xs#0@@0|) (_module.__default.MultisetUnion _module._default.MultisetUnion$T $ly@@0 |xs#0@@0|))
 :qid |unknown.0:0|
 :skolemid |607|
 :pattern ( (_module.__default.MultisetUnion _module._default.MultisetUnion$T ($LS $ly@@0) |xs#0@@0|))
)))
...
(|MultiSet#Union| (|MultiSet#UnionOne| |MultiSet#Empty| |a#2|) (_module.__default.multiset__of _module._default.multiset_of$T@@1 ($LS $ly@@2) |ys#2|))))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |605|
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.MultisetUnion$T@@0 T@U) ($ly@@3 T@U) (|xs#0@@3| T@U) ) (!  (=> (and (or (|_module.__default.MultisetUnion#canCall| _module._default.MultisetUnion$T@@0 |xs#0@@3|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@3| (Tclass._module.List (Tclass._module.List _module._default.MultisetUnion$T@@0))) ($IsAlloc DatatypeTypeType |xs#0@@3| (Tclass._module.List (Tclass._module.List _module._default.MultisetUnion$T@@0)) $Heap)))) ($IsGoodHeap $Heap)) ($IsAlloc MultiSetType (_module.__default.MultisetUnion _module._default.MultisetUnion$T@@0 $ly@@3 |xs#0@@3|) (TMultiSet _module._default.MultisetUnion$T@@0) $Heap))
 :qid |GHCMergeSortdfy.38:16|
 :skolemid |610|
 :pattern ( ($IsAlloc MultiSetType (_module.__default.MultisetUnion _module._default.MultisetUnion$T@@0 $ly@@3 |xs#0@@3|) (TMultiSet _module._default.MultisetUnion$T@@0) $Heap))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((_module._default.MultisetUnion$T@@1 T@U) ($ly@@4 T@U) (|xs#0@@4| T@U) ) (!  (=> (or (|_module.__default.MultisetUnion#canCall| _module._default.MultisetUnion$T@@1 |xs#0@@4|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@4| (Tclass._module.List (Tclass._module.List _module._default.MultisetUnion$T@@1))))) (and (=> (not (_module.List.Nil_q |xs#0@@4|)) (let ((|ys#1@@0| (_module.List.tail |xs#0@@4|)))
(let ((|a#1| ($Unbox DatatypeTypeType (_module.List.head |xs#0@@4|))))
 (and (|_module.__default.multiset__of#canCall| _module._default.MultisetUnion$T@@1 |a#1|) (|_module.__default.MultisetUnion#canCall| _module._default.MultisetUnion$T@@1 |ys#1@@0|))))) (= (_module.__default.MultisetUnion _module._default.MultisetUnion$T@@1 ($LS $ly@@4) |xs#0@@4|) (ite (_module.List.Nil_q |xs#0@@4|) |MultiSet#Empty| (let ((|ys#0@@0| (_module.List.tail |xs#0@@4|)))
(let ((|a#0@@0| ($Unbox DatatypeTypeType (_module.List.head |xs#0@@4|))))
(|MultiSet#Union| (_module.__default.multiset__of _module._default.MultisetUnion$T@@1 ($LS $LZ) |a#0@@0|) (_module.__default.MultisetUnion _module._default.MultisetUnion$T@@1 $ly@@4 |ys#0@@0|))))))))
 :qid |unknown.0:0|
 :skolemid |612|
 :pattern ( (_module.__default.MultisetUnion _module._default.MultisetUnion$T@@1 ($LS $ly@@4) |xs#0@@4|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) (_module._default.multiset_of$T@@2 T@U) ($ly@@5 T@U) (|xs#0@@5| T@U) ) (!  (=> (and (or (|_module.__default.multiset__of#canCall| _module._default.multiset_of$T@@2 |xs#0@@5|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@5| (Tclass._module.List _module._default.multiset_of$T@@2)) ($IsAlloc DatatypeTypeType |xs#0@@5| (Tclass._module.List _module._default.multiset_of$T@@2) $Heap@@0)))) ($IsGoodHeap $Heap@@0)) ($IsAlloc MultiSetType (_module.__default.multiset__of _module._default.multiset_of$T@@2 $ly@@5 |xs#0@@5|) (TMultiSet _module._default.multiset_of$T@@2) $Heap@@0))
 :qid |GHCMergeSortdfy.31:16|
 :skolemid |602|
 :pattern ( ($IsAlloc MultiSetType (_module.__default.multiset__of _module._default.multiset_of$T@@2 $ly@@5 |xs#0@@5|) (TMultiSet _module._default.multiset_of$T@@2) $Heap@@0))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((_module._default.MultisetUnion$T@@3 T@U) ($ly@@8 T@U) (|xs#0@@8| T@U) ) (!  (=> (or (|_module.__default.MultisetUnion#canCall| _module._default.MultisetUnion$T@@3 (Lit DatatypeTypeType |xs#0@@8|)) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@8| (Tclass._module.List (Tclass._module.List _module._default.MultisetUnion$T@@3))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@8|)))))) (let ((|ys#3@@0| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@8|)))))
(let ((|a#3| (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.List.head (Lit DatatypeTypeType |xs#0@@8|))))))
 (and (|_module.__default.multiset__of#canCall| _module._default.MultisetUnion$T@@3 |a#3|) (|_module.__default.MultisetUnion#canCall| _module._default.MultisetUnion$T@@3 |ys#3@@0|))))) (= (_module.__default.MultisetUnion _module._default.MultisetUnion$T@@3 ($LS $ly@@8) (Lit DatatypeTypeType |xs#0@@8|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@8|)) |MultiSet#Empty| (let ((|ys#2@@0| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@8|)))))
(let ((|a#2@@0| (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.List.head (Lit DatatypeTypeType |xs#0@@8|))))))
(|MultiSet#Union| (_module.__default.multiset__of _module._default.MultisetUnion$T@@3 ($LS $LZ) |a#2@@0|) (_module.__default.MultisetUnion _module._default.MultisetUnion$T@@3 ($LS $ly@@8) |ys#2@@0|))))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |613|
 :pattern ( (_module.__default.MultisetUnion _module._default.MultisetUnion$T@@3 ($LS $ly@@8) (Lit DatatypeTypeType |xs#0@@8|)))
))))
...
(declare-fun _module._default.MultisetUnion$T@@4 () T@U)
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.MultisetUnion)
...
(let ((anon10_Then_correct  (=> (= |xs#0@@9| (|#_module.List.Cons| ($Box DatatypeTypeType |_mcc#0#0|) |_mcc#1#0|)) (=> (and (and ($Is DatatypeTypeType |_mcc#0#0| (Tclass._module.List _module._default.MultisetUnion$T@@4)) ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List (Tclass._module.List _module._default.MultisetUnion$T@@4)))) (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List (Tclass._module.List _module._default.MultisetUnion$T@@4))))) (=> (and (and (and (= |ys#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|)) (and ($Is DatatypeTypeType |let#1#0#0| (Tclass._module.List _module._default.MultisetUnion$T@@4)) (= |a#Z#0@0| |let#1#0#0|))) (and (and ($IsAlloc DatatypeTypeType |a#Z#0@0| (Tclass._module.List _module._default.MultisetUnion$T@@4) $Heap@@1) (|_module.__default.multiset__of#canCall| _module._default.MultisetUnion$T@@4 |a#Z#0@0|)) (and ($IsAlloc DatatypeTypeType |ys#Z#0@0| (Tclass._module.List (Tclass._module.List _module._default.MultisetUnion$T@@4)) $Heap@@1) (= (ControlFlow 0 4) (- 0 3))))) (< (DtRank |ys#Z#0@0|) (DtRank |xs#0@@9|)))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) ($Is DatatypeTypeType |xs#0@@9| (Tclass._module.List (Tclass._module.List _module._default.MultisetUnion$T@@4)))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct)))
