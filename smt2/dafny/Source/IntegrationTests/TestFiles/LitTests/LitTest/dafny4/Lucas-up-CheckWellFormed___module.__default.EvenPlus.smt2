...
(declare-fun |a#0| () Int)
(declare-fun |b#0| () Int)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.EvenPlus)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) ($Is intType (int_2_U (+ |a#0| |b#0|)) Tclass._System.nat)))))
