...
(declare-fun _module.__default.UnAckedLists (T@U) T@U)
(declare-fun |_module.__default.UnAckedLists#canCall| (T@U) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|s#0| T@U) ) (!  (=> (or (|_module.__default.UnAckedLists#canCall| |s#0|) (and (< 1 $FunctionContextHeight) ($Is MapType |s#0| (TMap TInt (TSeq TInt))))) ($Is SetType (_module.__default.UnAckedLists |s#0|) (TSet (TSeq TInt))))
 :qid |Bug91dfy.32:29|
 :skolemid |573|
 :pattern ( (_module.__default.UnAckedLists |s#0|))
))))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|$y#0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#18| |l#0| |l#1| |l#2| |l#3|) |$y#0|)) (exists ((|dst#0| Int) ) (!  (and (|Set#IsMember| |l#0| ($Box intType (int_2_U |dst#0|))) (= |$y#0| (MapType0Select BoxType BoxType |l#1| ($Box intType (int_2_U |dst#0|)))))
 :qid |Bug91dfy.34:9|
 :skolemid |575|
 :pattern ( ($Unbox SeqType (MapType0Select BoxType BoxType |l#3| ($Box intType (int_2_U |dst#0|)))))
 :pattern ( (|Set#IsMember| |l#2| ($Box intType (int_2_U |dst#0|))))
)))
 :qid |Bug91dfy.34:19|
 :skolemid |596|
 :pattern ( (MapType0Select BoxType boolType (|lambda#18| |l#0| |l#1| |l#2| |l#3|) |$y#0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|s#0@@0| T@U) ) (!  (=> (or (|_module.__default.UnAckedLists#canCall| |s#0@@0|) (and (< 1 $FunctionContextHeight) ($Is MapType |s#0@@0| (TMap TInt (TSeq TInt))))) (= (_module.__default.UnAckedLists |s#0@@0|) (|Set#FromBoogieMap| (|lambda#18| (|Map#Domain| |s#0@@0|) (|Map#Elements| |s#0@@0|) (|Map#Domain| |s#0@@0|) (|Map#Elements| |s#0@@0|)))))
 :qid |Bug91dfy.32:29|
 :skolemid |576|
 :pattern ( (_module.__default.UnAckedLists |s#0@@0|))
))))
...
(assert (forall ((bx@@2 T@U) (s@@0 T@U) (t@@7 T@U) ) (!  (=> ($IsBox bx@@2 (TMap s@@0 t@@7)) (and (= ($Box MapType ($Unbox MapType bx@@2)) bx@@2) ($Is MapType ($Unbox MapType bx@@2) (TMap s@@0 t@@7))))
 :qid |DafnyPreludebpl.207:15|
 :skolemid |36|
 :pattern ( ($IsBox bx@@2 (TMap s@@0 t@@7)))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|s#0@@1| T@U) ) (!  (=> (or (|_module.__default.UnAckedLists#canCall| (Lit MapType |s#0@@1|)) (and (< 1 $FunctionContextHeight) ($Is MapType |s#0@@1| (TMap TInt (TSeq TInt))))) (= (_module.__default.UnAckedLists (Lit MapType |s#0@@1|)) (|Set#FromBoogieMap| (|lambda#18| (|Map#Domain| |s#0@@1|) (|Map#Elements| (Lit MapType |s#0@@1|)) (|Map#Domain| |s#0@@1|) (|Map#Elements| |s#0@@1|)))))
 :qid |Bug91dfy.32:29|
 :weight 3
 :skolemid |578|
 :pattern ( (_module.__default.UnAckedLists (Lit MapType |s#0@@1|)))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.UnAckedLists)
...
(let ((anon10_Else_correct  (=> (and (not (|Set#IsMember| (|Map#Domain| |s#0@@2|) ($Box intType (int_2_U |dst#2@0|)))) (= (ControlFlow 0 6) 3)) anon6_correct)))
(let ((anon10_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |s#0@@2|) ($Box intType (int_2_U |dst#2@0|))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (|Set#IsMember| (|Map#Domain| |s#0@@2|) ($Box intType (int_2_U |dst#2@0|)))) (=> (|Set#IsMember| (|Map#Domain| |s#0@@2|) ($Box intType (int_2_U |dst#2@0|))) (=> (= (ControlFlow 0 4) 3) anon6_correct))))))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 7) 4) anon10_Then_correct) (=> (= (ControlFlow 0 7) 6) anon10_Else_correct))))
(let ((anon9_Else_correct true))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#2| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 8) 1) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Then_correct)) (=> (= (ControlFlow 0 8) 2) anon9_Else_correct)))))
