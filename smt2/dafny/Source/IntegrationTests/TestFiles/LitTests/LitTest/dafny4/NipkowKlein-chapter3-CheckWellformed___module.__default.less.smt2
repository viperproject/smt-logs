...
(assert (distinct TBool TChar TInt TagBool TagChar TagInt TagSeq alloc Tagclass._module.aexp Tagclass._module.bexp |##_module.aexp.N| |##_module.aexp.V| |##_module.aexp.Plus| |##_module.bexp.Bc| |##_module.bexp.Less| tytagFamily$aexp tytagFamily$bexp)
)
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|a0#0| T@U) (|a1#0| T@U) ) (!  (=> (or (|_module.__default.less#canCall| |a0#0| |a1#0|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |a0#0| Tclass._module.aexp) ($Is DatatypeTypeType |a1#0| Tclass._module.aexp)))) ($Is DatatypeTypeType (_module.__default.less |a0#0| |a1#0|) Tclass._module.bexp))
 :qid |NipkowKleinchapter3dfy.158:21|
 :skolemid |652|
 :pattern ( (_module.__default.less |a0#0| |a1#0|))
))))
(assert (= (|Seq#Length| |Seq#Empty|) 0))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|a0#0@@0| T@U) (|a1#0@@0| T@U) ) (!  (=> (or (|_module.__default.less#canCall| |a0#0@@0| |a1#0@@0|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |a0#0@@0| Tclass._module.aexp) ($Is DatatypeTypeType |a1#0@@0| Tclass._module.aexp)))) (= (_module.__default.less |a0#0@@0| |a1#0@@0|) (ite  (and (_module.aexp.N_q |a0#0@@0|) (_module.aexp.N_q |a1#0@@0|)) (|#_module.bexp.Bc| (< (_module.aexp.n |a0#0@@0|) (_module.aexp.n |a1#0@@0|))) (|#_module.bexp.Less| |a0#0@@0| |a1#0@@0|))))
 :qid |NipkowKleinchapter3dfy.158:21|
 :skolemid |654|
 :pattern ( (_module.__default.less |a0#0@@0| |a1#0@@0|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|a0#0@@1| T@U) (|a1#0@@1| T@U) ) (!  (=> (or (|_module.__default.less#canCall| (Lit DatatypeTypeType |a0#0@@1|) (Lit DatatypeTypeType |a1#0@@1|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |a0#0@@1| Tclass._module.aexp) ($Is DatatypeTypeType |a1#0@@1| Tclass._module.aexp)))) (= (_module.__default.less (Lit DatatypeTypeType |a0#0@@1|) (Lit DatatypeTypeType |a1#0@@1|)) (ite  (and (_module.aexp.N_q (Lit DatatypeTypeType |a0#0@@1|)) (_module.aexp.N_q (Lit DatatypeTypeType |a1#0@@1|))) (|#_module.bexp.Bc| (U_2_bool (Lit boolType (bool_2_U (< (_module.aexp.n (Lit DatatypeTypeType |a0#0@@1|)) (_module.aexp.n (Lit DatatypeTypeType |a1#0@@1|))))))) (|#_module.bexp.Less| (Lit DatatypeTypeType |a0#0@@1|) (Lit DatatypeTypeType |a1#0@@1|)))))
 :qid |NipkowKleinchapter3dfy.158:21|
 :weight 3
 :skolemid |655|
 :pattern ( (_module.__default.less (Lit DatatypeTypeType |a0#0@@1|) (Lit DatatypeTypeType |a1#0@@1|)))
))))
...
(assert (forall ((bx@@4 T@U) (t@@2 T@U) ) (!  (=> ($IsBox bx@@4 (TSeq t@@2)) (and (= ($Box SeqType ($Unbox SeqType bx@@4)) bx@@4) ($Is SeqType ($Unbox SeqType bx@@4) (TSeq t@@2))))
 :qid |DafnyPreludebpl.204:15|
 :skolemid |35|
 :pattern ( ($IsBox bx@@4 (TSeq t@@2)))
)))
...
(let ((anon11_Then_correct  (=> (and (_module.aexp.N_q |a0#0@@2|) (_module.aexp.N_q |a1#0@@2|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (_module.aexp.N_q |a0#0@@2|)) (=> (_module.aexp.N_q |a0#0@@2|) (=> (= (ControlFlow 0 3) (- 0 2)) (_module.aexp.N_q |a1#0@@2|)))))))
(let ((anon10_Else_correct  (=> (not (_module.aexp.N_q |a0#0@@2|)) (and (=> (= (ControlFlow 0 7) 3) anon11_Then_correct) (=> (= (ControlFlow 0 7) 5) anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (_module.aexp.N_q |a0#0@@2|) (and (=> (= (ControlFlow 0 6) 3) anon11_Then_correct) (=> (= (ControlFlow 0 6) 5) anon11_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |a0#0@@2| Tclass._module.aexp) ($Is DatatypeTypeType |a1#0@@2| Tclass._module.aexp)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct))))
