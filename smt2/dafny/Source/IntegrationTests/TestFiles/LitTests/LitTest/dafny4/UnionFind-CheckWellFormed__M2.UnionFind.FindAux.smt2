...
(set-info :boogie-vc-id CheckWellFormed$$M2.UnionFind.FindAux)
...
(let ((anon5_Else_correct  (=> (and (=> (and (|Set#IsMember| (|Map#Domain| (M2.UnionFind.Collect $Heap@@6 this@@13)) ($Box refType |e#1@0|)) (M2.UnionFind.Reaches ($LS $LZ) this@@13 |d#1@0| |e#1@0| |r#1@0| (M2.UnionFind.Collect $Heap@@6 this@@13))) (M2.UnionFind.Reaches ($LS $LZ) this@@13 |d#1@0| |e#1@0| |r#1@0| (M2.UnionFind.Collect $Heap@0 this@@13))) (= (ControlFlow 0 12) 1)) anon4_correct)))
(let ((anon5_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 11)) ($IsAlloc refType this@@13 Tclass.M2.UnionFind $Heap@@6)) (=> ($IsAlloc refType this@@13 Tclass.M2.UnionFind $Heap@@6) (and (=> (= (ControlFlow 0 2) (- 0 10)) (forall ((|f#2| T@U) ) (!  (=> ($Is refType |f#2| Tclass.M2.Element) (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType |f#2|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |f#2|) M2.Element.c)))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |f#2|) M2.Element.c)))))))
 :qid |UnionFinddfy.64:23|
 :skolemid |1970|
...
))) (=> (forall ((|f#2@@0| T@U) ) (!  (=> ($Is refType |f#2@@0| Tclass.M2.Element) (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType |f#2@@0|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |f#2@@0|) M2.Element.c)))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |f#2@@0|) M2.Element.c)))))))
 :qid |UnionFinddfy.64:23|
 :skolemid |1971|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |f#2@@0|) M2.Element.c)))
)) (=> (and (|M2.UnionFind.Collect#canCall| $Heap@@6 this@@13) (|Set#IsMember| (|Map#Domain| (M2.UnionFind.Collect $Heap@@6 this@@13)) ($Box refType |e#1@0|))) (=> (and (and ($IsAllocBox ($Box refType this@@13) Tclass.M2.UnionFind? $Heap@0) ($IsAlloc intType (int_2_U |d#1@0|) Tclass._System.nat $Heap@0)) (and ($IsAlloc refType |e#1@0| Tclass.M2.Element $Heap@0) ($IsAlloc refType |r#1@0| Tclass.M2.Element $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 9)) ($IsAlloc refType this@@13 Tclass.M2.UnionFind $Heap@@6)) (=> ($IsAlloc refType this@@13 Tclass.M2.UnionFind $Heap@@6) (and (=> (= (ControlFlow 0 2) (- 0 8)) (forall ((|f#3| T@U) ) (!  (=> ($Is refType |f#3| Tclass.M2.Element) (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType |f#3|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |f#3|) M2.Element.c)))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |f#3|) M2.Element.c)))))))
 :qid |UnionFinddfy.64:23|
 :skolemid |1972|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |f#3|) M2.Element.c)))
))) (=> (and (and (forall ((|f#3@@0| T@U) ) (!  (=> ($Is refType |f#3@@0| Tclass.M2.Element) (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType |f#3@@0|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |f#3@@0|) M2.Element.c)))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |f#3@@0|) M2.Element.c)))))))
 :qid |UnionFinddfy.64:23|
 :skolemid |1973|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |f#3@@0|) M2.Element.c)))
)) (|M2.UnionFind.Collect#canCall| $Heap@@6 this@@13)) (and (= |##C#1@0| (M2.UnionFind.Collect $Heap@@6 this@@13)) ($IsAlloc MapType |##C#1@0| (TMap Tclass.M2.Element Tclass.M2.Contents) $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|M2.__default.GoodCMap#canCall| |##C#1@0|) (or (M2.__default.GoodCMap |##C#1@0|) (forall ((|f#4| T@U) ) (!  (=> ($Is refType |f#4| Tclass.M2.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |##C#1@0|) ($Box refType |f#4|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |##C#1@0|) ($Box refType |f#4|))))) (|Set#IsMember| (|Map#Domain| |##C#1@0|) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |##C#1@0|) ($Box refType |f#4|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |1974|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |##C#1@0|) ($Box refType |f#4|))))
))))) (=> (M2.__default.GoodCMap |##C#1@0|) (and (=> (= (ControlFlow 0 2) (- 0 6)) (|Set#IsMember| (|Map#Domain| |##C#1@0|) ($Box refType |e#1@0|))) (=> (and (and (and (|Set#IsMember| (|Map#Domain| |##C#1@0|) ($Box refType |e#1@0|)) (|M2.UnionFind.Reaches#canCall| this@@13 |d#1@0| |e#1@0| |r#1@0| (M2.UnionFind.Collect $Heap@@6 this@@13))) (and (M2.UnionFind.Reaches ($LS $LZ) this@@13 |d#1@0| |e#1@0| |r#1@0| (M2.UnionFind.Collect $Heap@@6 this@@13)) ($IsAllocBox ($Box refType this@@13) Tclass.M2.UnionFind? $Heap@0))) (and (and ($IsAlloc intType (int_2_U |d#1@0|) Tclass._System.nat $Heap@0) ($IsAlloc refType |e#1@0| Tclass.M2.Element $Heap@0)) (and ($IsAlloc refType |r#1@0| Tclass.M2.Element $Heap@0) ($IsAllocBox ($Box refType this@@13) Tclass.M2.UnionFind? $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall ((|f#5| T@U) ) (!  (=> ($Is refType |f#5| Tclass.M2.Element) (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@13) M2.UnionFind.M))) ($Box refType |f#5|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |f#5|) M2.Element.c)))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@13) M2.UnionFind.M))) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |f#5|) M2.Element.c)))))))
 :qid |UnionFinddfy.64:23|
 :skolemid |1976|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |f#5|) M2.Element.c)))
))) (=> (and (and (forall ((|f#5@@0| T@U) ) (!  (=> ($Is refType |f#5@@0| Tclass.M2.Element) (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@13) M2.UnionFind.M))) ($Box refType |f#5@@0|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |f#5@@0|) M2.Element.c)))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@13) M2.UnionFind.M))) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |f#5@@0|) M2.Element.c)))))))
 :qid |UnionFinddfy.64:23|
 :skolemid |1977|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |f#5@@0|) M2.Element.c)))
)) (|M2.UnionFind.Collect#canCall| $Heap@0 this@@13)) (and (= |##C#2@0| (M2.UnionFind.Collect $Heap@0 this@@13)) ($IsAlloc MapType |##C#2@0| (TMap Tclass.M2.Element Tclass.M2.Contents) $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|M2.__default.GoodCMap#canCall| |##C#2@0|) (or (M2.__default.GoodCMap |##C#2@0|) (forall ((|f#6| T@U) ) (!  (=> ($Is refType |f#6| Tclass.M2.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |##C#2@0|) ($Box refType |f#6|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |##C#2@0|) ($Box refType |f#6|))))) (|Set#IsMember| (|Map#Domain| |##C#2@0|) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |##C#2@0|) ($Box refType |f#6|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |1978|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |##C#2@0|) ($Box refType |f#6|))))
))))) (=> (M2.__default.GoodCMap |##C#2@0|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#IsMember| (|Map#Domain| |##C#2@0|) ($Box refType |e#1@0|))) (=> (and (and (|Set#IsMember| (|Map#Domain| |##C#2@0|) ($Box refType |e#1@0|)) (|M2.UnionFind.Reaches#canCall| this@@13 |d#1@0| |e#1@0| |r#1@0| (M2.UnionFind.Collect $Heap@0 this@@13))) (and (M2.UnionFind.Reaches ($LS $LZ) this@@13 |d#1@0| |e#1@0| |r#1@0| (M2.UnionFind.Collect $Heap@0 this@@13)) (= (ControlFlow 0 2) 1))) anon4_correct))))))))))))))))))))))
(let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@6 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.Repr)))) ($IsAllocBox ($Box refType this@@13) Tclass.M2.UnionFind? $Heap@@6)) (and (|M2.UnionFind.Valid#canCall| $Heap@@6 this@@13) (M2.UnionFind.Valid $Heap@@6 this@@13))) (and (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType |e#0@@5|)) ($IsAllocBox ($Box refType this@@13) Tclass.M2.UnionFind? $Heap@@6)) (and ($IsAlloc intType (int_2_U |d#0@@3|) Tclass._System.nat $Heap@@6) ($IsAlloc refType |e#0@@5| Tclass.M2.Element $Heap@@6)))) (and (=> (= (ControlFlow 0 13) (- 0 20)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType |e#0@@5|))) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType |e#0@@5|)) (=> (= |##r#0@0| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType |e#0@@5|)))) (=> (and ($IsAlloc refType |##r#0@0| Tclass.M2.Element $Heap@@6) ($IsAllocBox ($Box refType this@@13) Tclass.M2.UnionFind? $Heap@@6)) (and (=> (= (ControlFlow 0 13) (- 0 19)) (forall ((|f#0@@2| T@U) ) (!  (=> ($Is refType |f#0@@2| Tclass.M2.Element) (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType |f#0@@2|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |f#0@@2|) M2.Element.c)))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |f#0@@2|) M2.Element.c)))))))
 :qid |UnionFinddfy.64:23|
 :skolemid |1963|
...
))) (=> (and (and (forall ((|f#0@@3| T@U) ) (!  (=> ($Is refType |f#0@@3| Tclass.M2.Element) (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType |f#0@@3|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |f#0@@3|) M2.Element.c)))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |f#0@@3|) M2.Element.c)))))))
 :qid |UnionFinddfy.64:23|
 :skolemid |1964|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 |f#0@@3|) M2.Element.c)))
)) (|M2.UnionFind.Collect#canCall| $Heap@@6 this@@13)) (and (= |##C#0@0| (M2.UnionFind.Collect $Heap@@6 this@@13)) ($IsAlloc MapType |##C#0@0| (TMap Tclass.M2.Element Tclass.M2.Contents) $Heap@@6))) (and (=> (= (ControlFlow 0 13) (- 0 18)) (=> (|M2.__default.GoodCMap#canCall| |##C#0@0|) (or (M2.__default.GoodCMap |##C#0@0|) (forall ((|f#1@@1| T@U) ) (!  (=> ($Is refType |f#1@@1| Tclass.M2.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |##C#0@0|) ($Box refType |f#1@@1|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |##C#0@0|) ($Box refType |f#1@@1|))))) (|Set#IsMember| (|Map#Domain| |##C#0@0|) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |##C#0@0|) ($Box refType |f#1@@1|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |1965|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |##C#0@0|) ($Box refType |f#1@@1|))))
))))) (=> (M2.__default.GoodCMap |##C#0@0|) (and (=> (= (ControlFlow 0 13) (- 0 17)) (|Set#IsMember| (|Map#Domain| |##C#0@0|) ($Box refType |e#0@@5|))) (=> (|Set#IsMember| (|Map#Domain| |##C#0@0|) ($Box refType |e#0@@5|)) (=> (and (|M2.UnionFind.Reaches#canCall| this@@13 |d#0@@3| |e#0@@5| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType |e#0@@5|))) (M2.UnionFind.Collect $Heap@@6 this@@13)) (M2.UnionFind.Reaches ($LS $LZ) this@@13 |d#0@@3| |e#0@@5| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) ($Box refType |e#0@@5|))) (M2.UnionFind.Collect $Heap@@6 this@@13))) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@15 T@U) ) (!  (=> (and (or (not (= $o@@15 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 $o@@15) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@15) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 $o@@15)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.Repr)) ($Box refType $o@@15))))
 :qid |UnionFinddfy.151:12|
 :skolemid |1967|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@15))
)) ($HeapSucc $Heap@@6 $Heap@0))) (=> (and (and (and ($Is refType |r#0@0| Tclass.M2.Element) ($IsAlloc refType |r#0@0| Tclass.M2.Element $Heap@0)) ($IsAllocBox ($Box refType this@@13) Tclass.M2.UnionFind? $Heap@0)) (and (|M2.UnionFind.Valid#canCall| $Heap@0 this@@13) (M2.UnionFind.Valid $Heap@0 this@@13))) (and (=> (= (ControlFlow 0 13) (- 0 16)) ($IsAlloc refType this@@13 Tclass.M2.UnionFind $Heap@@6)) (=> ($IsAlloc refType this@@13 Tclass.M2.UnionFind $Heap@@6) (=> (and (forall (($o@@16 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@13) M2.UnionFind.Repr)) ($Box refType $o@@16)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.Repr)) ($Box refType $o@@16)))) (or (not (= $o@@16 null)) (not true)))
 :qid |UnionFinddfy.151:12|
 :skolemid |1968|
...
))) (and (=> (= (ControlFlow 0 13) (- 0 15)) ($IsAlloc refType this@@13 Tclass.M2.UnionFind $Heap@@6)) (=> ($IsAlloc refType this@@13 Tclass.M2.UnionFind $Heap@@6) (=> (|Map#Equal| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@13) M2.UnionFind.M)) ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@13) M2.UnionFind.M))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@13) M2.UnionFind.M))) ($Box refType |e#0@@5|))) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@13) M2.UnionFind.M))) ($Box refType |e#0@@5|)) (=> (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@13) M2.UnionFind.M))) ($Box refType |e#0@@5|))) |r#0@0|) (=> (and (and (<= (LitInt 0) |d#1@0|) (and ($Is refType |e#1@0| Tclass.M2.Element) ($IsAlloc refType |e#1@0| Tclass.M2.Element $Heap@0))) (and ($Is refType |r#1@0| Tclass.M2.Element) ($IsAlloc refType |r#1@0| Tclass.M2.Element $Heap@0))) (and (=> (= (ControlFlow 0 13) 2) anon5_Then_correct) (=> (= (ControlFlow 0 13) 12) anon5_Else_correct))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and (and (or (not (= this@@13 null)) (not true)) (and ($Is refType this@@13 Tclass.M2.UnionFind) ($IsAlloc refType this@@13 Tclass.M2.UnionFind $Heap@@6))) (<= (LitInt 0) |d#0@@3|)) (and ($Is refType |e#0@@5| Tclass.M2.Element) ($IsAlloc refType |e#0@@5| Tclass.M2.Element $Heap@@6))) (and (and ($Is refType |r#0@@3| Tclass.M2.Element) ($IsAlloc refType |r#0@@3| Tclass.M2.Element $Heap@@6)) (and (= 8 $FunctionContextHeight) (= (ControlFlow 0 21) 13)))) anon0_correct))))
