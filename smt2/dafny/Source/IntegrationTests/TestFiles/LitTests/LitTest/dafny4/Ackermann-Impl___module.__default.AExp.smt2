...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) (|m#0@@0| Int) ) (!  (=> (or (|_module.__default.A#canCall| (LitInt |m#0@@0|)) (< 1 $FunctionContextHeight)) (and (=> (< (LitInt 0) (LitInt |m#0@@0|)) (forall ((|$l#7#n#0| Int) )  (and (|_module.__default.A#canCall| (LitInt (- |m#0@@0| 1))) (|_module.__default.Iter#canCall| (Lit HandleTypeType (_module.__default.A ($LS $ly@@2) (LitInt (- |m#0@@0| 1)))) |$l#7#n#0|)))) (= (_module.__default.A ($LS $ly@@2) (LitInt |m#0@@0|)) (ite (<= (LitInt |m#0@@0|) (LitInt 0)) (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#4| 1) (|lambda#5| TInt) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $ly@@2)) (AtLayer HandleTypeType (|lambda#23| (LitInt (- |m#0@@0| 1)) (|lambda#5| TInt) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false)))) ($LS $ly@@2))))))
 :weight 3
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@6 T@U) (|m#0@@2| Int) ) (!  (=> (or (|_module.__default.A#canCall| |m#0@@2|) (< 1 $FunctionContextHeight)) (and (=> (< (LitInt 0) |m#0@@2|) (forall ((|$l#3#n#0| Int) )  (and (|_module.__default.A#canCall| (- |m#0@@2| 1)) (|_module.__default.Iter#canCall| (_module.__default.A $ly@@6 (- |m#0@@2| 1)) |$l#3#n#0|)))) (= (_module.__default.A ($LS $ly@@6) |m#0@@2|) (ite (<= |m#0@@2| (LitInt 0)) (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#4| 1) (|lambda#5| TInt) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) $ly@@6) (AtLayer HandleTypeType (|lambda#13| (- |m#0@@2| 1) (|lambda#5| TInt) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false)))) $ly@@6)))))
...
(let ((anon6_Else_correct  (=> (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (=> (and (and (= $Heap@0 $Heap@2) (forall ((|n#1_0_1| Int) )  (=> (U_2_bool (Lit boolType (bool_2_U true))) (< |n#1_0_1| (_module.__default.Iter ($LS $LZ) (_module.__default.A ($LS $LZ) (- |m#0@@3| 1)) |n#1_0_1|))))) (and (= $Heap@3 $Heap@2) (= (ControlFlow 0 6) 4))) GeneratedUnifiedExit_correct))))
