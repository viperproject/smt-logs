...
(declare-fun |lambda#7| (Int Int Int Int) T@U)
...
(assert (forall (($h0 T@U) ($h1 T@U) (|a#0| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|_module.__default.bug#canCall| $h0 |a#0|) ($Is refType |a#0| (Tclass._System.array TInt)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@0 T@U) ($f T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (= $o@@0 |a#0|)) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h0 $o@@0) $f) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h1 $o@@0) $f)))
 :qid |unknown.0:0|
 :skolemid |479|
)) (= (_module.__default.bug $h0 |a#0|) (_module.__default.bug $h1 |a#0|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |480|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (_module.__default.bug $h1 |a#0|))
)))
...
(assert (forall ((|l#0@@0| Int) (|l#1| Int) (|$l#0#heap#0@@0| T@U) (|$l#0#i#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#2| |l#0@@0| |l#1|) |$l#0#heap#0@@0| |$l#0#i#0@@0|) ($Box intType (int_2_U (+ (Mul |l#0@@0| (U_2_int ($Unbox intType |$l#0#i#0@@0|))) |l#1|))))
 :qid |unknown.0:0|
 :skolemid |496|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#2| |l#0@@0| |l#1|) |$l#0#heap#0@@0| |$l#0#i#0@@0|))
)))
(assert (forall ((|l#0@@1| Int) (|l#1@@0| Int) (|l#2| Int) (|l#3| Int) (|$l#1#heap#0| T@U) (|$l#1#i#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#7| |l#0@@1| |l#1@@0| |l#2| |l#3|) |$l#1#heap#0| |$l#1#i#0|) ($Box intType (int_2_U (let ((|u#0| (+ (Mul |l#0@@1| (U_2_int ($Unbox intType |$l#1#i#0|))) |l#1@@0|)))
(ite (= (U_2_int ($Unbox intType |$l#1#i#0|)) |l#2|) |l#3| |u#0|)))))
 :qid |unknown.0:0|
 :skolemid |501|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#7| |l#0@@1| |l#1@@0| |l#2| |l#3|) |$l#1#heap#0| |$l#1#i#0|))
)))
...
(assert (forall ((_System.array$arg@@9 T@U) ($h@@5 T@U) ($o@@6 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@5) (and (or (not (= $o@@6 null)) (not true)) (= (dtype $o@@6) (Tclass._System.array? _System.array$arg@@9)))) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@5 $o@@6) alloc)))) ($IsAlloc intType (int_2_U (_System.array.Length $o@@6)) TInt $h@@5))
 :qid |unknown.0:0|
 :skolemid |360|
 :pattern ( (_System.array.Length $o@@6) ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@5 $o@@6) alloc)) (Tclass._System.array? _System.array$arg@@9))
)))
(assert (forall ((_System.array$arg@@10 T@U) ($h@@6 T@U) ($o@@7 T@U) ($i0@@0 Int) ) (!  (=> (and (and ($IsGoodHeap $h@@6) (and (or (not (= $o@@7 null)) (not true)) (= (dtype $o@@7) (Tclass._System.array? _System.array$arg@@10)))) (and (<= 0 $i0@@0) (< $i0@@0 (_System.array.Length $o@@7)))) ($IsBox (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@6 $o@@7) (IndexField $i0@@0)) _System.array$arg@@10))
 :qid |unknown.0:0|
 :skolemid |355|
 :pattern ( (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@6 $o@@7) (IndexField $i0@@0)) (Tclass._System.array? _System.array$arg@@10))
)))
...
(assert (forall ((|l#0@@4| T@U) (|l#1@@1| T@U) (|l#2@@0| T@U) (|l#3@@0| Bool) ($o@@8 T@U) ($f@@0 T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#1| |l#0@@4| |l#1@@1| |l#2@@0| |l#3@@0|) $o@@8 $f@@0))  (=> (and (or (not (= $o@@8 |l#0@@4|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@1| $o@@8) |l#2@@0|)))) |l#3@@0|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |495|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#1| |l#0@@4| |l#1@@1| |l#2@@0| |l#3@@0|) $o@@8 $f@@0))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (|a#0@@0| T@U) ) (!  (=> (or (|_module.__default.bug#canCall| $Heap |a#0@@0|) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap) ($Is refType |a#0@@0| (Tclass._System.array TInt))))) (= (_module.__default.bug $Heap |a#0@@0|) (forall ((|i#0| Int) (|j#0| Int) ) (!  (=> (and (and (<= (LitInt 0) |i#0|) (<= |i#0| |j#0|)) (< |j#0| (_System.array.Length |a#0@@0|))) (<= (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap |a#0@@0|) (IndexField |i#0|)))) (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap |a#0@@0|) (IndexField |j#0|))))))
 :qid |gitissue104dfy.6:10|
 :skolemid |483|
 :pattern ( ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap |a#0@@0|) (IndexField |j#0|))) ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap |a#0@@0|) (IndexField |i#0|))))
))))
 :qid |gitissue104dfy.3:11|
 :skolemid |484|
 :pattern ( (_module.__default.bug $Heap |a#0@@0|) ($IsGoodHeap $Heap))
))))
...
(let ((anon12_Else_correct  (=> (and (< |i#0@0| (LitInt 0)) (= (ControlFlow 0 19) 15)) anon3_correct)))
(let ((anon12_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (=> (and (= |$_Frame#l0@0| (|lambda#1| null |$lambdaHeap#0@0| alloc false)) (= |newtype$check#0@0| (Mul (LitInt 2) |i#0@0|))) (and (=> (= (ControlFlow 0 16) (- 0 18)) (<= (LitInt 0) |newtype$check#0@0|)) (=> (<= (LitInt 0) |newtype$check#0@0|) (=> (= |newtype$check#1@0| (+ (Mul (LitInt 2) |i#0@0|) 3)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= (LitInt 0) |newtype$check#1@0|)) (=> (<= (LitInt 0) |newtype$check#1@0|) (=> (= |lambdaResult#0| (+ (Mul (LitInt 2) |i#0@0|) 3)) (=> (and ($Is intType (int_2_U |lambdaResult#0|) Tclass._System.nat) (= (ControlFlow 0 16) 15)) anon3_correct)))))))))))
(let ((anon11_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@0 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@0 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 20) 16) anon12_Then_correct) (=> (= (ControlFlow 0 20) 19) anon12_Else_correct)))))
(let ((anon9_correct true))
(let ((anon15_Else_correct  (=> (and (and (or (not (= |i#1@0| (LitInt 7))) (not true)) (= |lambdaResult#1| |u#Z#0@0|)) (and ($Is intType (int_2_U |lambdaResult#1|) Tclass._System.nat) (= (ControlFlow 0 7) 3))) anon9_correct)))
(let ((anon15_Then_correct  (=> (= |i#1@0| (LitInt 7)) (and (=> (= (ControlFlow 0 5) (- 0 6)) ($Is intType (int_2_U (LitInt 2)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 2)) Tclass._System.nat) (=> (= |lambdaResult#1| (LitInt 2)) (=> (and ($Is intType (int_2_U |lambdaResult#1|) Tclass._System.nat) (= (ControlFlow 0 5) 3)) anon9_correct)))))))
(let ((anon14_Then_correct  (=> (<= (LitInt 0) |i#1@0|) (=> (and (= |$_Frame#l1@0| (|lambda#1| null |$lambdaHeap#1@0| alloc false)) (= |newtype$check#2@0| (Mul (LitInt 2) |i#1@0|))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (<= (LitInt 0) |newtype$check#2@0|)) (=> (<= (LitInt 0) |newtype$check#2@0|) (=> (= |newtype$check#3@0| (+ (Mul (LitInt 2) |i#1@0|) 3)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= (LitInt 0) |newtype$check#3@0|)) (=> (<= (LitInt 0) |newtype$check#3@0|) (=> (= |let#0#0#0| (+ (Mul (LitInt 2) |i#1@0|) 3)) (=> (and ($Is intType (int_2_U |let#0#0#0|) Tclass._System.nat) (= |u#Z#0@0| |let#0#0#0|)) (and (=> (= (ControlFlow 0 8) 5) anon15_Then_correct) (=> (= (ControlFlow 0 8) 7) anon15_Else_correct)))))))))))))
(let ((anon14_Else_correct  (=> (and (< |i#1@0| (LitInt 0)) (= (ControlFlow 0 4) 3)) anon9_correct)))
(let ((anon13_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#1@0|) (or (= $Heap@0 |$lambdaHeap#1@0|) ($HeapSucc $Heap@0 |$lambdaHeap#1@0|))) (and (=> (= (ControlFlow 0 11) 8) anon14_Then_correct) (=> (= (ControlFlow 0 11) 4) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (and (and (or (not (= $nw@1 null)) (not true)) ($Is refType $nw@1 (Tclass._System.array? TInt))) (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $nw@1) alloc))))) (and (= (_System.array.Length $nw@1) (LitInt 25)) (= (ControlFlow 0 2) (- 0 1)))) (forall ((|arrayinit#1#i0#0| Int) ) (!  (=> (and (<= 0 |arrayinit#1#i0#0|) (< |arrayinit#1#i0#0| (LitInt 25))) (Requires1 Tclass._System.nat Tclass._System.nat $Heap@0 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#7| (LitInt 2) 3 (LitInt 7) 2) (|lambda#3| Tclass._System.nat) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#1#i0#0|))))
 :qid |gitissue104dfy.11:12|
 :skolemid |492|
)))))
(let ((anon11_Else_correct  (=> (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? TInt))) (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@0 $nw@0) alloc)))) (= (_System.array.Length $nw@0) (LitInt 25)))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (forall ((|arrayinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0|) (< |arrayinit#0#i0#0| (LitInt 25))) (Requires1 Tclass._System.nat Tclass._System.nat $Heap@@0 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| (LitInt 2) 3) (|lambda#3| Tclass._System.nat) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0|))))
 :qid |gitissue104dfy.10:12|
 :skolemid |490|
))) (=> (and (and (forall ((|arrayinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0@@0|) (< |arrayinit#0#i0#0@@0| (LitInt 25))) (= (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@0 $nw@0) (IndexField |arrayinit#0#i0#0@@0|)))) (U_2_int ($Unbox intType (Apply1 Tclass._System.nat Tclass._System.nat $Heap@@0 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| (LitInt 2) 3) (|lambda#3| Tclass._System.nat) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0@@0|)))))))
 :qid |gitissue104dfy.10:12|
 :skolemid |491|
...
)) (= $Heap@0 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap@@0 $nw@0 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@0 $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= 0 (LitInt 25))) (=> (<= 0 (LitInt 25)) (and (=> (= (ControlFlow 0 12) 11) anon13_Then_correct) (=> (= (ControlFlow 0 12) 2) anon13_Else_correct)))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@0 alloc false)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (<= 0 (LitInt 25))) (=> (<= 0 (LitInt 25)) (and (=> (= (ControlFlow 0 21) 20) anon11_Then_correct) (=> (= (ControlFlow 0 21) 12) anon11_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is refType |a#0@@1| (Tclass._System.array TInt)) ($IsAlloc refType |a#0@@1| (Tclass._System.array TInt) $Heap@@0)) true) (=> (and (and (and ($Is refType |b#0| (Tclass._System.array TInt)) ($IsAlloc refType |b#0| (Tclass._System.array TInt) $Heap@@0)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 23) 21))) anon0_correct)))))
