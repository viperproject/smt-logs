...
(assert (forall (($h0 T@U) ($h1 T@U) (|a#0| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|_module.__default.bug#canCall| $h0 |a#0|) ($Is refType |a#0| (Tclass._System.array TInt)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@0 T@U) ($f T@U) )  (=> (and (or (not (= $o@@0 null)) (not true)) (= $o@@0 |a#0|)) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h0 $o@@0) $f) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h1 $o@@0) $f)))) (= (_module.__default.bug $h0 |a#0|) (_module.__default.bug $h1 |a#0|))))
