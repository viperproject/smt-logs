// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue141.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue141-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny4/git-issue141.dfy
...
const _module.List.spine: Field
uses {
...
axiom (forall _module.List$T: Ty, $h: Heap, $o: ref :: 
  { $Unbox(read($h, $o, _module.List.spine)): Seq, Tclass._module.List?(_module.List$T) } 
  $IsGoodHeap($h)
       && 
      $o != null
       && dtype($o) == Tclass._module.List?(_module.List$T)
     ==> $Is($Unbox(read($h, $o, _module.List.spine)): Seq, 
      TSeq(Tclass._module.Node(_module.List$T))));
...
axiom (forall _module.List$T: Ty, $h: Heap, $o: ref :: 
  ...
  $IsGoodHeap($h)
      ...
      $o != null
       && dtype($o) == Tclass._module.List?(_module.List$T)
       && $Unbox(read($h, $o, alloc)): bool
     ==> $IsAlloc($Unbox(read($h, $o, _module.List.spine)): Seq, 
      TSeq(Tclass._module.Node(_module.List$T)), 
      $h));
    ...
    _module.List.Valid#canCall(_module.List$T, $Heap, this)
       ...
       ==> _module.List.Valid(_module.List$T, $Heap, this)
         == (true
           && 
          (forall i#0: int :: 
            { $Unbox(Seq#Index($Unbox(read($Heap, this, _module.List.spine)): Seq, i#0)): ref } 
            LitInt(0) <= i#0
                 && i#0 < Seq#Length($Unbox(read($Heap, this, _module.List.spine)): Seq)
               ==> Set#IsMember($Unbox(read($Heap, this, _module.List.repr)): Set, 
                Seq#Index($Unbox(read($Heap, this, _module.List.spine)): Seq, i#0)))
           && (forall i#1: int, _t#0#0: int :: 
            { $Unbox(Seq#Index($Unbox(read($Heap, this, _module.List.spine)): Seq, _t#0#0)): ref, $Unbox(Seq#Index($Unbox(read($Heap, this, _module.List.spine)): Seq, i#1)): ref } 
            _t#0#0 == i#1 + 1
                 && 
                LitInt(0) <= i#1
                 && i#1 < Seq#Length($Unbox(read($Heap, this, _module.List.spine)): Seq)
               ==> $Unbox(read($Heap, 
                    $Unbox(Seq#Index($Unbox(read($Heap, this, _module.List.spine)): Seq, i#1)): ref, 
                    _module.Node.next)): ref
                 == (if i#1 < Seq#Length($Unbox(read($Heap, this, _module.List.spine)): Seq) - 1
                   then $Unbox(Seq#Index($Unbox(read($Heap, this, _module.List.spine)): Seq, _t#0#0)): ref
                   else null))));
}
    ...
    else
    {
        ...
        if (Lit(true))
        {
            ...
            if (true)
            {
                if (LitInt(0) <= i#2)
                {
                    b$reqreads#1 := $_ReadsFrame[this, _module.List.spine];
                }

                if (LitInt(0) <= i#2
                   && i#2 < Seq#Length($Unbox(read($Heap, this, _module.List.spine)): Seq))
                {
                    b$reqreads#2 := $_ReadsFrame[this, _module.List.spine];
                    assert {:id "id2"} 0 <= i#2 && i#2 < Seq#Length($Unbox(read($Heap, this, _module.List.spine)): Seq);
                    b$reqreads#3 := $_ReadsFrame[this, _module.List.repr];
                    if (Set#IsMember($Unbox(read($Heap, this, _module.List.repr)): Set, 
                      Seq#Index($Unbox(read($Heap, this, _module.List.spine)): Seq, i#2)))
                    {
                        b$reqreads#4 := $_ReadsFrame[this, _module.List.spine];
                        assert {:id "id3"} 0 <= i#2 && i#2 < Seq#Length($Unbox(read($Heap, this, _module.List.spine)): Seq);
                        assert {:id "id4"} $Unbox(Seq#Index($Unbox(read($Heap, this, _module.List.spine)): Seq, i#2)): ref
                           != null;
                        b$reqreads#5 := $_ReadsFrame[$Unbox(Seq#Index($Unbox(read($Heap, this, _module.List.spine)): Seq, i#2)): ref, _module.Node.next];
                        b$reqreads#6 := $_ReadsFrame[this, _module.List.spine];
                        if (i#2 < Seq#Length($Unbox(read($Heap, this, _module.List.spine)): Seq) - 1)
                        {
                            b$reqreads#7 := $_ReadsFrame[this, _module.List.spine];
                            assert {:id "id5"} 0 <= i#2 + 1
                               && i#2 + 1 < Seq#Length($Unbox(read($Heap, this, _module.List.spine)): Seq);
                        }
                        else
                        {
        ...
        assume {:id "id6"} _module.List.Valid(_module.List$T, $Heap, this)
           == (true
             && 
            (forall i#3: int :: 
              { $Unbox(Seq#Index($Unbox(read($Heap, this, _module.List.spine)): Seq, i#3)): ref } 
              LitInt(0) <= i#3
                   && i#3 < Seq#Length($Unbox(read($Heap, this, _module.List.spine)): Seq)
                 ==> Set#IsMember($Unbox(read($Heap, this, _module.List.repr)): Set, 
                  Seq#Index($Unbox(read($Heap, this, _module.List.spine)): Seq, i#3)))
             && (forall i#3: int, _t#0#1: int :: 
              { $Unbox(Seq#Index($Unbox(read($Heap, this, _module.List.spine)): Seq, _t#0#1)): ref, $Unbox(Seq#Index($Unbox(read($Heap, this, _module.List.spine)): Seq, i#3)): ref } 
              _t#0#1 == i#3 + 1
                   && 
                  LitInt(0) <= i#3
                   && i#3 < Seq#Length($Unbox(read($Heap, this, _module.List.spine)): Seq)
                 ==> $Unbox(read($Heap, 
                      $Unbox(Seq#Index($Unbox(read($Heap, this, _module.List.spine)): Seq, i#3)): ref, 
                      _module.Node.next)): ref
                   == (if i#3 < Seq#Length($Unbox(read($Heap, this, _module.List.spine)): Seq) - 1
                     then $Unbox(Seq#Index($Unbox(read($Heap, this, _module.List.spine)): Seq, _t#0#1)): ref
                     else null)));
        assume true;
