...
(assert (forall ((d@@20 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) ($Is DatatypeTypeType d@@20 Tclass._module.Term)) ($IsAlloc DatatypeTypeType d@@20 Tclass._module.Term $h@@2))
 :qid |unknown.0:0|
 :skolemid |951|
 :pattern ( ($IsAlloc DatatypeTypeType d@@20 Tclass._module.Term $h@@2))
)))
(assert (forall ((d@@21 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) ($Is DatatypeTypeType d@@21 Tclass._module.LambdaAbs)) ($IsAlloc DatatypeTypeType d@@21 Tclass._module.LambdaAbs $h@@3))
 :qid |unknown.0:0|
 :skolemid |969|
 :pattern ( ($IsAlloc DatatypeTypeType d@@21 Tclass._module.LambdaAbs $h@@3))
)))
(assert (forall ((d@@22 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) ($Is DatatypeTypeType d@@22 Tclass._module.Val)) ($IsAlloc DatatypeTypeType d@@22 Tclass._module.Val $h@@4))
 :qid |unknown.0:0|
 :skolemid |988|
 :pattern ( ($IsAlloc DatatypeTypeType d@@22 Tclass._module.Val $h@@4))
)))
(assert (forall ((d@@23 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) ($Is DatatypeTypeType d@@23 Tclass._module.Cl)) ($IsAlloc DatatypeTypeType d@@23 Tclass._module.Cl $h@@5))
 :qid |unknown.0:0|
 :skolemid |1011|
 :pattern ( ($IsAlloc DatatypeTypeType d@@23 Tclass._module.Cl $h@@5))
)))
(assert (forall ((d@@24 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) ($Is DatatypeTypeType d@@24 Tclass._module.ClEnv)) ($IsAlloc DatatypeTypeType d@@24 Tclass._module.ClEnv $h@@6))
 :qid |unknown.0:0|
 :skolemid |1032|
 :pattern ( ($IsAlloc DatatypeTypeType d@@24 Tclass._module.ClEnv $h@@6))
)))
...
(assert (forall ((d@@25 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (_System.Tuple2.___hMake2_q d@@25) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@25 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@7)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@25 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@7))
)))) ($IsAllocBox (_System.Tuple2._0 d@@25) |_System._tuple#2$T0@@6| $h@@7))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@25) |_System._tuple#2$T0@@6| $h@@7))
)))
(assert (forall ((d@@26 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (_System.Tuple2.___hMake2_q d@@26) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@26 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@8)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@26 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@8))
)))) ($IsAllocBox (_System.Tuple2._1 d@@26) |_System._tuple#2$T1@@7| $h@@8))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@26) |_System._tuple#2$T1@@7| $h@@8))
)))
(assert (forall ((d@@27 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) (and (_module.LambdaAbs.Fun_q d@@27) ($IsAlloc DatatypeTypeType d@@27 Tclass._module.LambdaAbs $h@@9))) ($IsAllocBox (_module.LambdaAbs.v d@@27) Tclass._module.Var $h@@9))
 :qid |unknown.0:0|
 :skolemid |963|
 :pattern ( ($IsAllocBox (_module.LambdaAbs.v d@@27) Tclass._module.Var $h@@9))
)))
(assert (forall ((d@@28 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) (and (_module.LambdaAbs.Fun_q d@@28) ($IsAlloc DatatypeTypeType d@@28 Tclass._module.LambdaAbs $h@@10))) ($IsAlloc DatatypeTypeType (_module.LambdaAbs.body d@@28) Tclass._module.Term $h@@10))
 :qid |unknown.0:0|
 :skolemid |964|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.LambdaAbs.body d@@28) Tclass._module.Term $h@@10))
)))
(assert (forall ((d@@29 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (_module.Val.ValConst_q d@@29) ($IsAlloc DatatypeTypeType d@@29 Tclass._module.Val $h@@11))) ($IsAllocBox (_module.Val._h2 d@@29) Tclass._module.Const $h@@11))
 :qid |unknown.0:0|
 :skolemid |979|
 :pattern ( ($IsAllocBox (_module.Val._h2 d@@29) Tclass._module.Const $h@@11))
)))
(assert (forall ((d@@30 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (_module.Val.ValCl_q d@@30) ($IsAlloc DatatypeTypeType d@@30 Tclass._module.Val $h@@12))) ($IsAlloc DatatypeTypeType (_module.Val.cl d@@30) Tclass._module.Cl $h@@12))
 :qid |unknown.0:0|
 :skolemid |986|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Val.cl d@@30) Tclass._module.Cl $h@@12))
)))
(assert (forall ((d@@31 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (_module.Cl.Closure_q d@@31) ($IsAlloc DatatypeTypeType d@@31 Tclass._module.Cl $h@@13))) ($IsAlloc DatatypeTypeType (_module.Cl.abs d@@31) Tclass._module.LambdaAbs $h@@13))
 :qid |unknown.0:0|
 :skolemid |1007|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Cl.abs d@@31) Tclass._module.LambdaAbs $h@@13))
)))
(assert (forall ((d@@32 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (_module.Cl.Closure_q d@@32) ($IsAlloc DatatypeTypeType d@@32 Tclass._module.Cl $h@@14))) ($IsAlloc DatatypeTypeType (_module.Cl.env d@@32) Tclass._module.ClEnv $h@@14))
 :qid |unknown.0:0|
 :skolemid |1008|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Cl.env d@@32) Tclass._module.ClEnv $h@@14))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.Theorem4b__ValBelow__Is__Transitive_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.__default.ValBelow_h#canCall| |_k#0@@13| |u#1| |w#1|) (or (_module.__default.ValBelow_h ($LS $LZ) |_k#0@@13| |u#1| |w#1|) (=> (< 0 |_k#0@@13|) (or (and (and (_module.Val.ValConst_q |u#1|) (_module.Val.ValConst_q |w#1|)) (|$Eq#_module.Val| ($LS ($LS $LZ)) |u#1| |w#1|)) (and (and (and (_module.Val.ValCl_q |u#1|) (_module.Val.ValCl_q |w#1|)) (|_module.LambdaAbs#Equal| (_module.Cl.abs (_module.Val.cl |u#1|)) (_module.Cl.abs (_module.Val.cl |w#1|)))) (_module.__default.ClEnvBelow_h ($LS ($LS $LZ)) (- |_k#0@@13| 1) (_module.Cl.env (_module.Val.cl |u#1|)) (_module.Cl.env (_module.Val.cl |w#1|)))))))))))
(let ((anon6_Else_correct  (=> (and (not (_module.Val.ValCl_q |u#1|)) (= (ControlFlow 0 13) 2)) GeneratedUnifiedExit_correct)))
(let ((anon6_Then_correct  (=> (_module.Val.ValCl_q |u#1|) (and (=> (= (ControlFlow 0 4) (- 0 12)) ($Is intType (int_2_U (- |_k#0@@13| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |_k#0@@13| 1)) Tclass._System.nat) (=> (= |_k##0@0| (- |_k#0@@13| 1)) (and (=> (= (ControlFlow 0 4) (- 0 11)) (_module.Val.ValCl_q |u#1|)) (=> (_module.Val.ValCl_q |u#1|) (=> (_module.Cl.Closure_q (_module.Val.cl |u#1|)) (=> (and (_module.Cl.Closure_q (_module.Val.cl |u#1|)) (= |c##0@0| (_module.Cl.env (_module.Val.cl |u#1|)))) (and (=> (= (ControlFlow 0 4) (- 0 10)) (_module.Val.ValCl_q |v#1|)) (=> (_module.Val.ValCl_q |v#1|) (=> (_module.Cl.Closure_q (_module.Val.cl |v#1|)) (=> (and (_module.Cl.Closure_q (_module.Val.cl |v#1|)) (= |d##0@0| (_module.Cl.env (_module.Val.cl |v#1|)))) (and (=> (= (ControlFlow 0 4) (- 0 9)) (_module.Val.ValCl_q |w#1|)) (=> (_module.Val.ValCl_q |w#1|) (=> (_module.Cl.Closure_q (_module.Val.cl |w#1|)) (=> (and (_module.Cl.Closure_q (_module.Val.cl |w#1|)) (= |e##0@0| (_module.Cl.env (_module.Val.cl |w#1|)))) (and (=> (= (ControlFlow 0 4) (- 0 8)) (or (<= 0 |_k#0@@13|) (= |_k##0@0| |_k#0@@13|))) (=> (or (<= 0 |_k#0@@13|) (= |_k##0@0| |_k#0@@13|)) (and (=> (= (ControlFlow 0 4) (- 0 7)) (< |_k##0@0| |_k#0@@13|)) (=> (< |_k##0@0| |_k#0@@13|) (and (=> (= (ControlFlow 0 4) (- 0 6)) (=> (|_module.__default.ClEnvBelow#canCall| |c##0@0| |d##0@0|) (or (_module.__default.ClEnvBelow ($LS $LZ) |c##0@0| |d##0@0|) (forall ((|y#3@@1| T@U) ) (!  (=> ($IsBox |y#3@@1| Tclass._module.Var) (and (=> (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |c##0@0|)) |y#3@@1|) (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |d##0@0|)) |y#3@@1|)) (=> (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |c##0@0|)) |y#3@@1|) (_module.__default.ValBelow ($LS ($LS $LZ)) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |c##0@0|)) |y#3@@1|)) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |d##0@0|)) |y#3@@1|))))))
 :qid |KozenSilvadfy.180:10|
 :skolemid |739|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |d##0@0|)) |y#3@@1|)))
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |c##0@0|)) |y#3@@1|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |d##0@0|)) |y#3@@1|))
 :pattern ( (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |c##0@0|)) |y#3@@1|))
))))) (=> (=> (|_module.__default.ClEnvBelow#canCall| |c##0@0| |d##0@0|) (or (_module.__default.ClEnvBelow ($LS $LZ) |c##0@0| |d##0@0|) (forall ((|y#3@@2| T@U) ) (!  (=> ($IsBox |y#3@@2| Tclass._module.Var) (and (=> (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |c##0@0|)) |y#3@@2|) (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |d##0@0|)) |y#3@@2|)) (=> (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |c##0@0|)) |y#3@@2|) (_module.__default.ValBelow ($LS ($LS $LZ)) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |c##0@0|)) |y#3@@2|)) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |d##0@0|)) |y#3@@2|))))))
 :qid |KozenSilvadfy.180:10|
 :skolemid |739|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |d##0@0|)) |y#3@@2|)))
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |c##0@0|)) |y#3@@2|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |d##0@0|)) |y#3@@2|))
 :pattern ( (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |c##0@0|)) |y#3@@2|))
)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (=> (|_module.__default.ClEnvBelow#canCall| |d##0@0| |e##0@0|) (or (_module.__default.ClEnvBelow ($LS $LZ) |d##0@0| |e##0@0|) (forall ((|y#4@@1| T@U) ) (!  (=> ($IsBox |y#4@@1| Tclass._module.Var) (and (=> (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |d##0@0|)) |y#4@@1|) (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |e##0@0|)) |y#4@@1|)) (=> (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |d##0@0|)) |y#4@@1|) (_module.__default.ValBelow ($LS ($LS $LZ)) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |d##0@0|)) |y#4@@1|)) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |e##0@0|)) |y#4@@1|))))))
 :qid |KozenSilvadfy.180:10|
 :skolemid |742|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |e##0@0|)) |y#4@@1|)))
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |d##0@0|)) |y#4@@1|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |e##0@0|)) |y#4@@1|))
 :pattern ( (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |d##0@0|)) |y#4@@1|))
))))) (=> (=> (|_module.__default.ClEnvBelow#canCall| |d##0@0| |e##0@0|) (or (_module.__default.ClEnvBelow ($LS $LZ) |d##0@0| |e##0@0|) (forall ((|y#4@@2| T@U) ) (!  (=> ($IsBox |y#4@@2| Tclass._module.Var) (and (=> (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |d##0@0|)) |y#4@@2|) (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |e##0@0|)) |y#4@@2|)) (=> (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |d##0@0|)) |y#4@@2|) (_module.__default.ValBelow ($LS ($LS $LZ)) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |d##0@0|)) |y#4@@2|)) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |e##0@0|)) |y#4@@2|))))))
 :qid |KozenSilvadfy.180:10|
 :skolemid |742|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |e##0@0|)) |y#4@@2|)))
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |d##0@0|)) |y#4@@2|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |e##0@0|)) |y#4@@2|))
 :pattern ( (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |d##0@0|)) |y#4@@2|))
)))) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (|_module.__default.ClEnvBelow_h#canCall| |_k##0@0| |c##0@0| |e##0@0|)) (and (and (|_module.__default.ClEnvBelow_h#canCall| |_k##0@0| |c##0@0| |e##0@0|) (and (_module.__default.ClEnvBelow_h ($LS $LZ) |_k##0@0| |c##0@0| |e##0@0|) (=> (< 0 |_k##0@0|) (forall ((|y#5@@1| T@U) ) (!  (=> ($IsBox |y#5@@1| Tclass._module.Var) (=> (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |c##0@0|)) |y#5@@1|) (and (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |e##0@0|)) |y#5@@1|) (_module.__default.ValBelow_h ($LS $LZ) (- |_k##0@0| 1) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |c##0@0|)) |y#5@@1|)) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |e##0@0|)) |y#5@@1|))))))
 :qid |KozenSilvadfy.180:10|
 :skolemid |747|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |e##0@0|)) |y#5@@1|)))
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.ClEnv.m |c##0@0|)) |y#5@@1|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |e##0@0|)) |y#5@@1|))
 :pattern ( (|Set#IsMember| (|Map#Domain| (_module.ClEnv.m |c##0@0|)) |y#5@@1|))
))))) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 4) 2)))) GeneratedUnifiedExit_correct)))))))))))))))))))))))))))
(let ((anon5_Then_correct  (=> (< 0 |_k#0@@13|) (and (=> (= (ControlFlow 0 14) 4) anon6_Then_correct) (=> (= (ControlFlow 0 14) 13) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (<= |_k#0@@13| 0) (= (ControlFlow 0 3) 2)) GeneratedUnifiedExit_correct)))
(let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.Val| |u#1|)) (and (|$IsA#_module.Val| |v#1|) (|$IsA#_module.Val| |w#1|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#_k0#0| Int) (|$ih#u0#0| T@U) (|$ih#v0#0| T@U) (|$ih#w0#0| T@U) ) (!  (=> (and (and (and (and (and (<= (LitInt 0) |$ih#_k0#0|) ($Is DatatypeTypeType |$ih#u0#0| Tclass._module.Val)) ($Is DatatypeTypeType |$ih#v0#0| Tclass._module.Val)) ($Is DatatypeTypeType |$ih#w0#0| Tclass._module.Val)) (and (_module.__default.ValBelow ($LS $LZ) |$ih#u0#0| |$ih#v0#0|) (_module.__default.ValBelow ($LS $LZ) |$ih#v0#0| |$ih#w0#0|))) (and (<= 0 |$ih#_k0#0|) (< |$ih#_k0#0| |_k#0@@13|))) (_module.__default.ValBelow_h ($LS $LZ) |$ih#_k0#0| |$ih#u0#0| |$ih#w0#0|))
 :qid |KozenSilvadfy.196:16|
 :skolemid |760|
 :pattern ( (_module.__default.ValBelow_h ($LS $LZ) |$ih#_k0#0| |$ih#u0#0| |$ih#w0#0|) (_module.__default.ValBelow ($LS $LZ) |$ih#v0#0| |$ih#w0#0|))
 :pattern ( (_module.__default.ValBelow_h ($LS $LZ) |$ih#_k0#0| |$ih#u0#0| |$ih#w0#0|) (_module.__default.ValBelow ($LS $LZ) |$ih#u0#0| |$ih#v0#0|))
))))) (and (=> (= (ControlFlow 0 15) 14) anon5_Then_correct) (=> (= (ControlFlow 0 15) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |_k#0@@13|)) (=> (and (and (and ($Is DatatypeTypeType |u#1| Tclass._module.Val) ($IsAlloc DatatypeTypeType |u#1| Tclass._module.Val $Heap)) (|$IsA#_module.Val| |u#1|)) (and (and ($Is DatatypeTypeType |v#1| Tclass._module.Val) ($IsAlloc DatatypeTypeType |v#1| Tclass._module.Val $Heap)) (|$IsA#_module.Val| |v#1|))) (=> (and (and (and (and (and ($Is DatatypeTypeType |w#1| Tclass._module.Val) ($IsAlloc DatatypeTypeType |w#1| Tclass._module.Val $Heap)) (|$IsA#_module.Val| |w#1|)) (= 4 $FunctionContextHeight)) (and (|_module.__default.ValBelow#canCall| |u#1| |v#1|) (and (_module.__default.ValBelow ($LS $LZ) |u#1| |v#1|) (or (and (and (_module.Val.ValConst_q |u#1|) (_module.Val.ValConst_q |v#1|)) (|$Eq#_module.Val| ($LS ($LS $LZ)) |u#1| |v#1|)) (and (and (and (_module.Val.ValCl_q |u#1|) (_module.Val.ValCl_q |v#1|)) (|_module.LambdaAbs#Equal| (_module.Cl.abs (_module.Val.cl |u#1|)) (_module.Cl.abs (_module.Val.cl |v#1|)))) (_module.__default.ClEnvBelow ($LS $LZ) (_module.Cl.env (_module.Val.cl |u#1|)) (_module.Cl.env (_module.Val.cl |v#1|)))))))) (and (and (|_module.__default.ValBelow#canCall| |v#1| |w#1|) (and (_module.__default.ValBelow ($LS $LZ) |v#1| |w#1|) (or (and (and (_module.Val.ValConst_q |v#1|) (_module.Val.ValConst_q |w#1|)) (|$Eq#_module.Val| ($LS ($LS $LZ)) |v#1| |w#1|)) (and (and (and (_module.Val.ValCl_q |v#1|) (_module.Val.ValCl_q |w#1|)) (|_module.LambdaAbs#Equal| (_module.Cl.abs (_module.Val.cl |v#1|)) (_module.Cl.abs (_module.Val.cl |w#1|)))) (_module.__default.ClEnvBelow ($LS $LZ) (_module.Cl.env (_module.Val.cl |v#1|)) (_module.Cl.env (_module.Val.cl |w#1|))))))) (= (ControlFlow 0 16) 15))) anon0_correct)))))
