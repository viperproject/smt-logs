...
(assert (forall ((bx@@0 T@U) (t@@2 T@U) ) (!  (=> ($IsBox bx@@0 (TSet t@@2)) (and (= ($Box SetType ($Unbox SetType bx@@0)) bx@@0) ($Is SetType ($Unbox SetType bx@@0) (TSet t@@2))))
 :qid |DafnyPreludebpl.195:15|
 :skolemid |32|
 :pattern ( ($IsBox bx@@0 (TSet t@@2)))
)))
...
(declare-fun |s#0| () T@U)
(declare-fun _module.EvenSet$A () T@U)
...
(set-info :boogie-vc-id CheckWellFormed$$_module.EvenSet)
...
(let ((anon9_Else_correct  (=> (or (not (= (|Set#Card| |s#0|) (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= (LitInt 2) 0)) (not true))) (=> (or (not (= (LitInt 2) 0)) (not true)) (=> (and (= (Mod (|Set#Card| |s#0|) (LitInt 2)) (LitInt 0)) (= (ControlFlow 0 5) 3)) anon5_correct))))))
(let ((anon9_Then_correct  (=> (and (= (|Set#Card| |s#0|) (LitInt 0)) (= (ControlFlow 0 4) 3)) anon5_correct)))
(let ((anon8_Then_correct  (=> ($Is SetType |s#0| (TSet _module.EvenSet$A)) (and (=> (= (ControlFlow 0 7) 4) anon9_Then_correct) (=> (= (ControlFlow 0 7) 5) anon9_Else_correct)))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (= (|Set#Card| (Lit SetType |Set#Empty|)) (LitInt 0)) (= (Mod (|Set#Card| (Lit SetType |Set#Empty|)) (LitInt 2)) (LitInt 0))))))
