...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let (($generated@@101  (=> (= $generated@@90 ($generated@@31 $generated@@91 $generated@@92 $generated@@93 false)) (=> (and (= $generated@@94 ($generated 1)) (= $generated@@95 ($generated 1))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (and (<= 0 $generated@@95) (< $generated@@95 4294967296))) (=> (and (<= 0 $generated@@95) (< $generated@@95 4294967296)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (and (<= 0 $generated@@94) (< $generated@@94 64))) (=> (and (<= 0 $generated@@94) (< $generated@@94 64)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (bvule ((_ int2bv 6) $generated@@94) #b100000)) (=> (and (= ($generated@@24 (bvshl #x00000001 (concat #b00000000000000000000000000 ((_ int2bv 6) $generated@@94)))) ($generated 2)) (= $generated@@96 ($generated 1))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 $generated@@96) (< $generated@@96 4294967296))) (=> (and (<= 0 $generated@@96) (< $generated@@96 4294967296)) (=> (= $generated@@97 ($generated 1)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= 0 $generated@@97) (< $generated@@97 64))) (=> (and (<= 0 $generated@@97) (< $generated@@97 64)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (bvule #b000001 #b100000)) (=> (= (ControlFlow 0 2) (- 0 1)) (= ($generated@@24 (bvshl #x00000001 (concat #b00000000000000000000000000 #b000001))) ($generated 2)))))))))))))))))))
(let (($generated@@102  (=> (and (and ($generated@@98 $generated@@92) ($generated@@99 $generated@@92)) (and (= 0 $generated@@100) (= (ControlFlow 0 9) 2))) $generated@@101)))
$generated@@102)))
))
(check-sat)
(get-info :rlimit)
