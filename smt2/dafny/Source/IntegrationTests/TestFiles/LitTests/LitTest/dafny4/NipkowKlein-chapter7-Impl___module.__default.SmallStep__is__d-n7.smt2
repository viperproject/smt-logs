...
(assert (forall (($ly T@U) (|c#0| T@U) (|s#0| T@U) (|c'#0| T@U) (|s'#0| T@U) ) (! (= (_module.__default.small__step ($LS $ly) |c#0| |s#0| |c'#0| |s'#0|) (_module.__default.small__step $ly |c#0| |s#0| |c'#0| |s'#0|))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |990|
 :pattern ( (_module.__default.small__step ($LS $ly) |c#0| |s#0| |c'#0| |s'#0|))
)))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@0 T@U) (|c#0@@0| T@U) (|s#0@@0| T@U) (|c'#0@@0| T@U) (|s'#0@@0| T@U) ) (!  (=> (and (and (and (and ($Is DatatypeTypeType |c#0@@0| Tclass._module.com) ($Is MapType |s#0@@0| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c'#0@@0| Tclass._module.com)) ($Is MapType |s'#0@@0| (TMap (TSeq TChar) TInt))) (_module.__default.small__step ($LS $ly@@0) |c#0@@0| |s#0@@0| |c'#0@@0| |s'#0@@0|)) (exists ((|_k#0| T@U) ) (! (_module.__default.small__step_h ($LS $ly@@0) |_k#0| |c#0@@0| |s#0@@0| |c'#0@@0| |s'#0@@0|)
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |997|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@0) |_k#0| |c#0@@0| |s#0@@0| |c'#0@@0| |s'#0@@0|))
)))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |998|
 :pattern ( (_module.__default.small__step ($LS $ly@@0) |c#0@@0| |s#0@@0| |c'#0@@0| |s'#0@@0|))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@1 T@U) (|_k#0@@0| T@U) (|c#0@@1| T@U) (|s#0@@1| T@U) (|c'#0@@1| T@U) (|s'#0@@1| T@U) ) (!  (=> (or (|_module.__default.small__step_h#canCall| (Lit BoxType |_k#0@@0|) |c#0@@1| |s#0@@1| |c'#0@@1| |s'#0@@1|) (and (< 5 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |c#0@@1| Tclass._module.com) ($Is MapType |s#0@@1| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c'#0@@1| Tclass._module.com)) ($Is MapType |s'#0@@1| (TMap (TSeq TChar) TInt))))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@0|)) (=> (not (_module.com.SKIP_q |c#0@@1|)) (and (=> (_module.com.Assign_q |c#0@@1|) (let ((|a#6| (_module.com._h1 |c#0@@1|)))
 (and (|$IsA#_module.com| |c'#0@@1|) (=> (|_module.com#Equal| |c'#0@@1| |#_module.com.SKIP|) (|_module.__default.aval#canCall| |a#6| |s#0@@1|))))) (=> (not (_module.com.Assign_q |c#0@@1|)) (and (=> (_module.com.Seq_q |c#0@@1|) (let ((|c1#6| (_module.com._h3 |c#0@@1|)))
(let ((|c0#6| (_module.com._h2 |c#0@@1|)))
 (and (and (|$IsA#_module.com| |c0#6|) (=> (|_module.com#Equal| |c0#6| |#_module.com.SKIP|) (and (|$IsA#_module.com| |c'#0@@1|) (|$IsA#_module.com| |c1#6|)))) (=> (not (and (and (|_module.com#Equal| |c0#6| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@1| |c1#6|)) (|Map#Equal| |s'#0@@1| |s#0@@1|))) (forall ((|c0'#8| T@U) ) (!  (=> ($Is DatatypeTypeType |c0'#8| Tclass._module.com) (and (|$IsA#_module.com| |c'#0@@1|) (=> (|_module.com#Equal| |c'#0@@1| (|#_module.com.Seq| |c0'#8| |c1#6|)) (|_module.__default.small__step_h#canCall| (|ORD#Minus| |_k#0@@0| (|ORD#FromNat| 1)) |c0#6| |s#0@@1| |c0'#8| |s'#0@@1|))))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1020|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@1) (|ORD#Minus| |_k#0@@0| (|ORD#FromNat| 1)) |c0#6| |s#0@@1| |c0'#8| |s'#0@@1|))
...
(let ((|b#12| (_module.com._h4 |c#0@@1|)))
 (and (and (|$IsA#_module.com| |c'#0@@1|) (|$IsA#_module.com| (ite (_module.__default.bval ($LS $LZ) |b#12| |s#0@@1|) |thn#6| |els#6|))) (|_module.__default.bval#canCall| |b#12| |s#0@@1|)))))) (=> (not (_module.com.If_q |c#0@@1|)) (|$IsA#_module.com| |c'#0@@1|))))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@0|)) (ite (_module.com.SKIP_q |c#0@@1|) false (ite (_module.com.Assign_q |c#0@@1|) (let ((|a#7| (_module.com._h1 |c#0@@1|)))
(let ((|x#7| (_module.com._h0 |c#0@@1|)))
 (and (|_module.com#Equal| |c'#0@@1| |#_module.com.SKIP|) (|Map#Equal| |s'#0@@1| (|Map#Build| |s#0@@1| ($Box SeqType |x#7|) ($Box intType (int_2_U (_module.__default.aval ($LS $LZ) |a#7| |s#0@@1|)))))))) (ite (_module.com.Seq_q |c#0@@1|) (let ((|c1#7| (_module.com._h3 |c#0@@1|)))
(let ((|c0#7| (_module.com._h2 |c#0@@1|)))
 (or (and (and (|_module.com#Equal| |c0#7| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@1| |c1#7|)) (|Map#Equal| |s'#0@@1| |s#0@@1|)) (exists ((|c0'#9| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#9| Tclass._module.com) (and (|_module.com#Equal| |c'#0@@1| (|#_module.com.Seq| |c0'#9| |c1#7|)) (_module.__default.small__step_h ($LS $ly@@1) (|ORD#Minus| |_k#0@@0| (|ORD#FromNat| 1)) |c0#7| |s#0@@1| |c0'#9| |s'#0@@1|)))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1022|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@1) (|ORD#Minus| |_k#0@@0| (|ORD#FromNat| 1)) |c0#7| |s#0@@1| |c0'#9| |s'#0@@1|))
...
(let ((|b#14| (_module.com._h4 |c#0@@1|)))
 (and (|_module.com#Equal| |c'#0@@1| (ite (_module.__default.bval ($LS $LZ) |b#14| |s#0@@1|) |thn#7| |els#7|)) (|Map#Equal| |s'#0@@1| |s#0@@1|))))) (let ((|body#7| (_module.com._h8 |c#0@@1|)))
(let ((|b#15| (_module.com._h7 |c#0@@1|)))
 (and (|_module.com#Equal| |c'#0@@1| (|#_module.com.If| |b#15| (|#_module.com.Seq| |body#7| (|#_module.com.While| |b#15| |body#7|)) (Lit DatatypeTypeType |#_module.com.SKIP|))) (|Map#Equal| |s'#0@@1| |s#0@@1|))))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@0|)) (forall ((|_k'#1| T@U) ) (!  (=> (|ORD#LessThanLimit| |_k'#1| |_k#0@@0|) (|_module.__default.small__step_h#canCall| |_k'#1| |c#0@@1| |s#0@@1| |c'#0@@1| |s'#0@@1|))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1021|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@1) |_k'#1| |c#0@@1| |s#0@@1| |c'#0@@1| |s'#0@@1|))
))))) (= (_module.__default.small__step_h ($LS $ly@@1) (Lit BoxType |_k#0@@0|) |c#0@@1| |s#0@@1| |c'#0@@1| |s'#0@@1|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@0|)) (ite (_module.com.SKIP_q |c#0@@1|) false (ite (_module.com.Assign_q |c#0@@1|) (let ((|a#5| (_module.com._h1 |c#0@@1|)))
(let ((|x#5| (_module.com._h0 |c#0@@1|)))
 (and (|_module.com#Equal| |c'#0@@1| |#_module.com.SKIP|) (|Map#Equal| |s'#0@@1| (|Map#Build| |s#0@@1| ($Box SeqType |x#5|) ($Box intType (int_2_U (_module.__default.aval ($LS $LZ) |a#5| |s#0@@1|)))))))) (ite (_module.com.Seq_q |c#0@@1|) (let ((|c1#5| (_module.com._h3 |c#0@@1|)))
(let ((|c0#5| (_module.com._h2 |c#0@@1|)))
 (or (and (and (|_module.com#Equal| |c0#5| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@1| |c1#5|)) (|Map#Equal| |s'#0@@1| |s#0@@1|)) (exists ((|c0'#7| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#7| Tclass._module.com) (and (|_module.com#Equal| |c'#0@@1| (|#_module.com.Seq| |c0'#7| |c1#5|)) (_module.__default.small__step_h ($LS $ly@@1) (|ORD#Minus| |_k#0@@0| (|ORD#FromNat| 1)) |c0#5| |s#0@@1| |c0'#7| |s'#0@@1|)))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1018|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@1) (|ORD#Minus| |_k#0@@0| (|ORD#FromNat| 1)) |c0#5| |s#0@@1| |c0'#7| |s'#0@@1|))
...
(let ((|b#10| (_module.com._h4 |c#0@@1|)))
 (and (|_module.com#Equal| |c'#0@@1| (ite (_module.__default.bval ($LS $LZ) |b#10| |s#0@@1|) |thn#5| |els#5|)) (|Map#Equal| |s'#0@@1| |s#0@@1|))))) (let ((|body#5| (_module.com._h8 |c#0@@1|)))
(let ((|b#11| (_module.com._h7 |c#0@@1|)))
 (and (|_module.com#Equal| |c'#0@@1| (|#_module.com.If| |b#11| (|#_module.com.Seq| |body#5| (|#_module.com.While| |b#11| |body#5|)) (Lit DatatypeTypeType |#_module.com.SKIP|))) (|Map#Equal| |s'#0@@1| |s#0@@1|))))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@0|)) (exists ((|_k'#1@@0| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#1@@0| |_k#0@@0|) (_module.__default.small__step_h ($LS $ly@@1) |_k'#1@@0| |c#0@@1| |s#0@@1| |c'#0@@1| |s'#0@@1|))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1019|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@1) |_k'#1@@0| |c#0@@1| |s#0@@1| |c'#0@@1| |s'#0@@1|))
)))))))
 :qid |NipkowKleinchapter7dfy.154:17|
 :weight 3
 :skolemid |1023|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@1) (Lit BoxType |_k#0@@0|) |c#0@@1| |s#0@@1| |c'#0@@1| |s'#0@@1|))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@2 T@U) (|c#0@@2| T@U) (|s#0@@2| T@U) (|c'#0@@2| T@U) (|s'#0@@2| T@U) ) (!  (=> (and (and (and (and ($Is DatatypeTypeType |c#0@@2| Tclass._module.com) ($Is MapType |s#0@@2| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c'#0@@2| Tclass._module.com)) ($Is MapType |s'#0@@2| (TMap (TSeq TChar) TInt))) (exists ((|_k#0@@1| T@U) ) (! (_module.__default.small__step_h ($LS $ly@@2) |_k#0@@1| |c#0@@2| |s#0@@2| |c'#0@@2| |s'#0@@2|)
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |997|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@2) |_k#0@@1| |c#0@@2| |s#0@@2| |c'#0@@2| |s'#0@@2|))
))) (_module.__default.small__step ($LS $ly@@2) |c#0@@2| |s#0@@2| |c'#0@@2| |s'#0@@2|))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |999|
 :pattern ( (_module.__default.small__step ($LS $ly@@2) |c#0@@2| |s#0@@2| |c'#0@@2| |s'#0@@2|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@3 T@U) (|a#0| T@U) (|s#0@@3| T@U) ) (!  (=> (or (|_module.__default.aval#canCall| (Lit DatatypeTypeType |a#0|) (Lit MapType |s#0@@3|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |a#0| Tclass._module.aexp) ($Is MapType |s#0@@3| (TMap (TSeq TChar) TInt))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.aexp.N_q (Lit DatatypeTypeType |a#0|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.aexp.V_q (Lit DatatypeTypeType |a#0|)))))) (let ((|a1#3| (Lit DatatypeTypeType (_module.aexp._1 (Lit DatatypeTypeType |a#0|)))))
(let ((|a0#3| (Lit DatatypeTypeType (_module.aexp._0 (Lit DatatypeTypeType |a#0|)))))
 (and (|_module.__default.aval#canCall| |a0#3| (Lit MapType |s#0@@3|)) (|_module.__default.aval#canCall| |a1#3| (Lit MapType |s#0@@3|))))))) (= (_module.__default.aval ($LS $ly@@3) (Lit DatatypeTypeType |a#0|) (Lit MapType |s#0@@3|)) (ite (_module.aexp.N_q (Lit DatatypeTypeType |a#0|)) (let ((|n#2| (LitInt (_module.aexp.n (Lit DatatypeTypeType |a#0|)))))
|n#2|) (ite (_module.aexp.V_q (Lit DatatypeTypeType |a#0|)) (let ((|x#2| (Lit SeqType (_module.aexp.x (Lit DatatypeTypeType |a#0|)))))
(ite (|Set#IsMember| (|Map#Domain| |s#0@@3|) ($Box SeqType |x#2|)) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType |s#0@@3|)) ($Box SeqType |x#2|)))) 0)) (let ((|a1#2| (Lit DatatypeTypeType (_module.aexp._1 (Lit DatatypeTypeType |a#0|)))))
(let ((|a0#2| (Lit DatatypeTypeType (_module.aexp._0 (Lit DatatypeTypeType |a#0|)))))
(LitInt (+ (_module.__default.aval ($LS $ly@@3) |a0#2| (Lit MapType |s#0@@3|)) (_module.__default.aval ($LS $ly@@3) |a1#2| (Lit MapType |s#0@@3|)))))))))))
 :qid |NipkowKleinchapter7dfy.16:16|
 :weight 3
 :skolemid |705|
 :pattern ( (_module.__default.aval ($LS $ly@@3) (Lit DatatypeTypeType |a#0|) (Lit MapType |s#0@@3|)))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@4 T@U) (|b#0| T@U) (|s#0@@4| T@U) ) (!  (=> (or (|_module.__default.bval#canCall| (Lit DatatypeTypeType |b#0|) (Lit MapType |s#0@@4|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |b#0| Tclass._module.bexp) ($Is MapType |s#0@@4| (TMap (TSeq TChar) TInt))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.bexp.Bc_q (Lit DatatypeTypeType |b#0|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (_module.bexp.Not_q (Lit DatatypeTypeType |b#0|))))) (let ((|b#4| (Lit DatatypeTypeType (_module.bexp.op (Lit DatatypeTypeType |b#0|)))))
(|_module.__default.bval#canCall| |b#4| (Lit MapType |s#0@@4|)))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.bexp.Not_q (Lit DatatypeTypeType |b#0|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (_module.bexp.And_q (Lit DatatypeTypeType |b#0|))))) (let ((|b1#3| (Lit DatatypeTypeType (_module.bexp._1 (Lit DatatypeTypeType |b#0|)))))
(let ((|b0#3| (Lit DatatypeTypeType (_module.bexp._0 (Lit DatatypeTypeType |b#0|)))))
 (and (|_module.__default.bval#canCall| |b0#3| (Lit MapType |s#0@@4|)) (=> (_module.__default.bval ($LS $ly@@4) |b0#3| (Lit MapType |s#0@@4|)) (|_module.__default.bval#canCall| |b1#3| (Lit MapType |s#0@@4|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.bexp.And_q (Lit DatatypeTypeType |b#0|)))))) (let ((|a1#3@@0| (Lit DatatypeTypeType (_module.bexp.a1 (Lit DatatypeTypeType |b#0|)))))
(let ((|a0#3@@0| (Lit DatatypeTypeType (_module.bexp.a0 (Lit DatatypeTypeType |b#0|)))))
 (and (|_module.__default.aval#canCall| |a0#3@@0| (Lit MapType |s#0@@4|)) (|_module.__default.aval#canCall| |a1#3@@0| (Lit MapType |s#0@@4|)))))))))) (= (_module.__default.bval ($LS $ly@@4) (Lit DatatypeTypeType |b#0|) (Lit MapType |s#0@@4|)) (ite (_module.bexp.Bc_q (Lit DatatypeTypeType |b#0|)) (let ((|v#2| (U_2_bool (Lit boolType (bool_2_U (_module.bexp.v (Lit DatatypeTypeType |b#0|)))))))
|v#2|) (ite (_module.bexp.Not_q (Lit DatatypeTypeType |b#0|)) (let ((|b#3| (Lit DatatypeTypeType (_module.bexp.op (Lit DatatypeTypeType |b#0|)))))
 (not (U_2_bool (Lit boolType (bool_2_U (_module.__default.bval ($LS $ly@@4) |b#3| (Lit MapType |s#0@@4|))))))) (ite (_module.bexp.And_q (Lit DatatypeTypeType |b#0|)) (U_2_bool (let ((|b1#2| (Lit DatatypeTypeType (_module.bexp._1 (Lit DatatypeTypeType |b#0|)))))
(let ((|b0#2| (Lit DatatypeTypeType (_module.bexp._0 (Lit DatatypeTypeType |b#0|)))))
(Lit boolType (bool_2_U  (and (_module.__default.bval ($LS $ly@@4) |b0#2| (Lit MapType |s#0@@4|)) (_module.__default.bval ($LS $ly@@4) |b1#2| (Lit MapType |s#0@@4|)))))))) (U_2_bool (let ((|a1#2@@0| (Lit DatatypeTypeType (_module.bexp.a1 (Lit DatatypeTypeType |b#0|)))))
(let ((|a0#2@@0| (Lit DatatypeTypeType (_module.bexp.a0 (Lit DatatypeTypeType |b#0|)))))
(Lit boolType (bool_2_U (< (_module.__default.aval ($LS $LZ) |a0#2@@0| (Lit MapType |s#0@@4|)) (_module.__default.aval ($LS $LZ) |a1#2@@0| (Lit MapType |s#0@@4|))))))))))))))
 :qid |NipkowKleinchapter7dfy.25:16|
 :weight 3
 :skolemid |714|
 :pattern ( (_module.__default.bval ($LS $ly@@4) (Lit DatatypeTypeType |b#0|) (Lit MapType |s#0@@4|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@5 T@U) (|c#0@@3| T@U) (|s#0@@5| T@U) (|c'#0@@3| T@U) (|s'#0@@3| T@U) ) (!  (=> (or (|_module.__default.small__step#canCall| |c#0@@3| |s#0@@5| |c'#0@@3| |s'#0@@3|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |c#0@@3| Tclass._module.com) ($Is MapType |s#0@@5| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c'#0@@3| Tclass._module.com)) ($Is MapType |s'#0@@3| (TMap (TSeq TChar) TInt))))) (and (=> (not (_module.com.SKIP_q |c#0@@3|)) (and (=> (_module.com.Assign_q |c#0@@3|) (let ((|a#1| (_module.com._h1 |c#0@@3|)))
 (and (|$IsA#_module.com| |c'#0@@3|) (=> (|_module.com#Equal| |c'#0@@3| |#_module.com.SKIP|) (|_module.__default.aval#canCall| |a#1| |s#0@@5|))))) (=> (not (_module.com.Assign_q |c#0@@3|)) (and (=> (_module.com.Seq_q |c#0@@3|) (let ((|c1#1| (_module.com._h3 |c#0@@3|)))
(let ((|c0#1| (_module.com._h2 |c#0@@3|)))
 (and (and (|$IsA#_module.com| |c0#1|) (=> (|_module.com#Equal| |c0#1| |#_module.com.SKIP|) (and (|$IsA#_module.com| |c'#0@@3|) (|$IsA#_module.com| |c1#1|)))) (=> (not (and (and (|_module.com#Equal| |c0#1| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@3| |c1#1|)) (|Map#Equal| |s'#0@@3| |s#0@@5|))) (forall ((|c0'#1| T@U) ) (!  (=> ($Is DatatypeTypeType |c0'#1| Tclass._module.com) (and (|$IsA#_module.com| |c'#0@@3|) (=> (|_module.com#Equal| |c'#0@@3| (|#_module.com.Seq| |c0'#1| |c1#1|)) (|_module.__default.small__step#canCall| |c0#1| |s#0@@5| |c0'#1| |s'#0@@3|))))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |995|
 :pattern ( (_module.__default.small__step $ly@@5 |c0#1| |s#0@@5| |c0'#1| |s'#0@@3|))
 :pattern ( (|#_module.com.Seq| |c0'#1| |c1#1|))
))))))) (=> (not (_module.com.Seq_q |c#0@@3|)) (and (=> (_module.com.If_q |c#0@@3|) (let ((|els#1| (_module.com._h6 |c#0@@3|)))
(let ((|thn#1| (_module.com._h5 |c#0@@3|)))
(let ((|b#2| (_module.com._h4 |c#0@@3|)))
 (and (and (|$IsA#_module.com| |c'#0@@3|) (|$IsA#_module.com| (ite (_module.__default.bval ($LS $LZ) |b#2| |s#0@@5|) |thn#1| |els#1|))) (|_module.__default.bval#canCall| |b#2| |s#0@@5|)))))) (=> (not (_module.com.If_q |c#0@@3|)) (|$IsA#_module.com| |c'#0@@3|)))))))) (= (_module.__default.small__step ($LS $ly@@5) |c#0@@3| |s#0@@5| |c'#0@@3| |s'#0@@3|) (ite (_module.com.SKIP_q |c#0@@3|) false (ite (_module.com.Assign_q |c#0@@3|) (let ((|a#0@@0| (_module.com._h1 |c#0@@3|)))
(let ((|x#0| (_module.com._h0 |c#0@@3|)))
 (and (|_module.com#Equal| |c'#0@@3| |#_module.com.SKIP|) (|Map#Equal| |s'#0@@3| (|Map#Build| |s#0@@5| ($Box SeqType |x#0|) ($Box intType (int_2_U (_module.__default.aval ($LS $LZ) |a#0@@0| |s#0@@5|)))))))) (ite (_module.com.Seq_q |c#0@@3|) (let ((|c1#0| (_module.com._h3 |c#0@@3|)))
(let ((|c0#0| (_module.com._h2 |c#0@@3|)))
 (or (and (and (|_module.com#Equal| |c0#0| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@3| |c1#0|)) (|Map#Equal| |s'#0@@3| |s#0@@5|)) (exists ((|c0'#0| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#0| Tclass._module.com) (and (|_module.com#Equal| |c'#0@@3| (|#_module.com.Seq| |c0'#0| |c1#0|)) (_module.__default.small__step $ly@@5 |c0#0| |s#0@@5| |c0'#0| |s'#0@@3|)))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |994|
 :pattern ( (_module.__default.small__step $ly@@5 |c0#0| |s#0@@5| |c0'#0| |s'#0@@3|))
 :pattern ( (|#_module.com.Seq| |c0'#0| |c1#0|))
))))) (ite (_module.com.If_q |c#0@@3|) (let ((|els#0| (_module.com._h6 |c#0@@3|)))
(let ((|thn#0| (_module.com._h5 |c#0@@3|)))
(let ((|b#0@@0| (_module.com._h4 |c#0@@3|)))
 (and (|_module.com#Equal| |c'#0@@3| (ite (_module.__default.bval ($LS $LZ) |b#0@@0| |s#0@@5|) |thn#0| |els#0|)) (|Map#Equal| |s'#0@@3| |s#0@@5|))))) (let ((|body#0| (_module.com._h8 |c#0@@3|)))
(let ((|b#1| (_module.com._h7 |c#0@@3|)))
 (and (|_module.com#Equal| |c'#0@@3| (|#_module.com.If| |b#1| (|#_module.com.Seq| |body#0| (|#_module.com.While| |b#1| |body#0|)) (Lit DatatypeTypeType |#_module.com.SKIP|))) (|Map#Equal| |s'#0@@3| |s#0@@5|)))))))))))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |996|
 :pattern ( (_module.__default.small__step ($LS $ly@@5) |c#0@@3| |s#0@@5| |c'#0@@3| |s'#0@@3|))
))))
...
(assert (forall (($ly@@6 T@U) (|b#0@@1| T@U) (|s#0@@6| T@U) ) (! (= (_module.__default.bval ($LS $ly@@6) |b#0@@1| |s#0@@6|) (_module.__default.bval $ly@@6 |b#0@@1| |s#0@@6|))
 :qid |NipkowKleinchapter7dfy.25:16|
 :skolemid |708|
 :pattern ( (_module.__default.bval ($LS $ly@@6) |b#0@@1| |s#0@@6|))
)))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@7 T@U) (|c#0@@4| T@U) (|s#0@@7| T@U) (|c'#0@@4| T@U) (|s'#0@@4| T@U) (|_k#0@@2| T@U) ) (!  (=> (and (and (and (and ($Is DatatypeTypeType |c#0@@4| Tclass._module.com) ($Is MapType |s#0@@7| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c'#0@@4| Tclass._module.com)) ($Is MapType |s'#0@@4| (TMap (TSeq TChar) TInt))) (= |_k#0@@2| (|ORD#FromNat| 0))) (not (_module.__default.small__step_h $ly@@7 |_k#0@@2| |c#0@@4| |s#0@@7| |c'#0@@4| |s'#0@@4|)))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1000|
 :pattern ( (_module.__default.small__step_h $ly@@7 |_k#0@@2| |c#0@@4| |s#0@@7| |c'#0@@4| |s'#0@@4|))
))))
...
(assert (forall (($ly@@8 T@U) (|a#0@@1| T@U) (|s#0@@8| T@U) ) (! (= (_module.__default.aval ($LS $ly@@8) |a#0@@1| |s#0@@8|) (_module.__default.aval $ly@@8 |a#0@@1| |s#0@@8|))
 :qid |NipkowKleinchapter7dfy.16:16|
 :skolemid |699|
 :pattern ( (_module.__default.aval ($LS $ly@@8) |a#0@@1| |s#0@@8|))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@9 T@U) (|b#0@@2| T@U) (|s#0@@9| T@U) ) (!  (=> (or (|_module.__default.bval#canCall| |b#0@@2| |s#0@@9|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |b#0@@2| Tclass._module.bexp) ($Is MapType |s#0@@9| (TMap (TSeq TChar) TInt))))) (and (=> (not (_module.bexp.Bc_q |b#0@@2|)) (and (=> (_module.bexp.Not_q |b#0@@2|) (let ((|b#2@@0| (_module.bexp.op |b#0@@2|)))
(|_module.__default.bval#canCall| |b#2@@0| |s#0@@9|))) (=> (not (_module.bexp.Not_q |b#0@@2|)) (and (=> (_module.bexp.And_q |b#0@@2|) (let ((|b1#1| (_module.bexp._1 |b#0@@2|)))
(let ((|b0#1| (_module.bexp._0 |b#0@@2|)))
 (and (|_module.__default.bval#canCall| |b0#1| |s#0@@9|) (=> (_module.__default.bval $ly@@9 |b0#1| |s#0@@9|) (|_module.__default.bval#canCall| |b1#1| |s#0@@9|)))))) (=> (not (_module.bexp.And_q |b#0@@2|)) (let ((|a1#1| (_module.bexp.a1 |b#0@@2|)))
(let ((|a0#1| (_module.bexp.a0 |b#0@@2|)))
 (and (|_module.__default.aval#canCall| |a0#1| |s#0@@9|) (|_module.__default.aval#canCall| |a1#1| |s#0@@9|))))))))) (= (_module.__default.bval ($LS $ly@@9) |b#0@@2| |s#0@@9|) (ite (_module.bexp.Bc_q |b#0@@2|) (let ((|v#0| (_module.bexp.v |b#0@@2|)))
|v#0|) (ite (_module.bexp.Not_q |b#0@@2|) (let ((|b#1@@0| (_module.bexp.op |b#0@@2|)))
 (not (_module.__default.bval $ly@@9 |b#1@@0| |s#0@@9|))) (ite (_module.bexp.And_q |b#0@@2|) (let ((|b1#0| (_module.bexp._1 |b#0@@2|)))
(let ((|b0#0| (_module.bexp._0 |b#0@@2|)))
 (and (_module.__default.bval $ly@@9 |b0#0| |s#0@@9|) (_module.__default.bval $ly@@9 |b1#0| |s#0@@9|)))) (let ((|a1#0| (_module.bexp.a1 |b#0@@2|)))
(let ((|a0#0| (_module.bexp.a0 |b#0@@2|)))
(< (_module.__default.aval ($LS $LZ) |a0#0| |s#0@@9|) (_module.__default.aval ($LS $LZ) |a1#0| |s#0@@9|))))))))))
 :qid |NipkowKleinchapter7dfy.25:16|
 :skolemid |713|
 :pattern ( (_module.__default.bval ($LS $ly@@9) |b#0@@2| |s#0@@9|))
))))
...
(assert (forall (($ly@@10 T@U) (|_k#0@@3| T@U) (|c#0@@5| T@U) (|s#0@@10| T@U) (|c'#0@@5| T@U) (|s'#0@@5| T@U) ) (! (= (_module.__default.small__step_h ($LS $ly@@10) |_k#0@@3| |c#0@@5| |s#0@@10| |c'#0@@5| |s'#0@@5|) (_module.__default.small__step_h $ly@@10 |_k#0@@3| |c#0@@5| |s#0@@10| |c'#0@@5| |s'#0@@5|))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1008|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@10) |_k#0@@3| |c#0@@5| |s#0@@10| |c'#0@@5| |s'#0@@5|))
)))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@11 T@U) (|_k#0@@4| T@U) (|c#0@@6| T@U) (|s#0@@11| T@U) (|c'#0@@6| T@U) (|s'#0@@6| T@U) ) (!  (=> (or (|_module.__default.small__step_h#canCall| |_k#0@@4| |c#0@@6| |s#0@@11| |c'#0@@6| |s'#0@@6|) (and (< 5 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |c#0@@6| Tclass._module.com) ($Is MapType |s#0@@11| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c'#0@@6| Tclass._module.com)) ($Is MapType |s'#0@@6| (TMap (TSeq TChar) TInt))))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (=> (not (_module.com.SKIP_q |c#0@@6|)) (and (=> (_module.com.Assign_q |c#0@@6|) (let ((|a#3| (_module.com._h1 |c#0@@6|)))
 (and (|$IsA#_module.com| |c'#0@@6|) (=> (|_module.com#Equal| |c'#0@@6| |#_module.com.SKIP|) (|_module.__default.aval#canCall| |a#3| |s#0@@11|))))) (=> (not (_module.com.Assign_q |c#0@@6|)) (and (=> (_module.com.Seq_q |c#0@@6|) (let ((|c1#3| (_module.com._h3 |c#0@@6|)))
(let ((|c0#3| (_module.com._h2 |c#0@@6|)))
 (and (and (|$IsA#_module.com| |c0#3|) (=> (|_module.com#Equal| |c0#3| |#_module.com.SKIP|) (and (|$IsA#_module.com| |c'#0@@6|) (|$IsA#_module.com| |c1#3|)))) (=> (not (and (and (|_module.com#Equal| |c0#3| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@6| |c1#3|)) (|Map#Equal| |s'#0@@6| |s#0@@11|))) (forall ((|c0'#5| T@U) ) (!  (=> ($Is DatatypeTypeType |c0'#5| Tclass._module.com) (and (|$IsA#_module.com| |c'#0@@6|) (=> (|_module.com#Equal| |c'#0@@6| (|#_module.com.Seq| |c0'#5| |c1#3|)) (|_module.__default.small__step_h#canCall| (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) |c0#3| |s#0@@11| |c0'#5| |s'#0@@6|))))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1014|
 :pattern ( (_module.__default.small__step_h $ly@@11 (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) |c0#3| |s#0@@11| |c0'#5| |s'#0@@6|))
 :pattern ( (|#_module.com.Seq| |c0'#5| |c1#3|))
))))))) (=> (not (_module.com.Seq_q |c#0@@6|)) (and (=> (_module.com.If_q |c#0@@6|) (let ((|els#3| (_module.com._h6 |c#0@@6|)))
(let ((|thn#3| (_module.com._h5 |c#0@@6|)))
(let ((|b#6| (_module.com._h4 |c#0@@6|)))
 (and (and (|$IsA#_module.com| |c'#0@@6|) (|$IsA#_module.com| (ite (_module.__default.bval ($LS $LZ) |b#6| |s#0@@11|) |thn#3| |els#3|))) (|_module.__default.bval#canCall| |b#6| |s#0@@11|)))))) (=> (not (_module.com.If_q |c#0@@6|)) (|$IsA#_module.com| |c'#0@@6|))))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (ite (_module.com.SKIP_q |c#0@@6|) false (ite (_module.com.Assign_q |c#0@@6|) (let ((|a#4| (_module.com._h1 |c#0@@6|)))
(let ((|x#4| (_module.com._h0 |c#0@@6|)))
 (and (|_module.com#Equal| |c'#0@@6| |#_module.com.SKIP|) (|Map#Equal| |s'#0@@6| (|Map#Build| |s#0@@11| ($Box SeqType |x#4|) ($Box intType (int_2_U (_module.__default.aval ($LS $LZ) |a#4| |s#0@@11|)))))))) (ite (_module.com.Seq_q |c#0@@6|) (let ((|c1#4| (_module.com._h3 |c#0@@6|)))
(let ((|c0#4| (_module.com._h2 |c#0@@6|)))
 (or (and (and (|_module.com#Equal| |c0#4| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@6| |c1#4|)) (|Map#Equal| |s'#0@@6| |s#0@@11|)) (exists ((|c0'#6| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#6| Tclass._module.com) (and (|_module.com#Equal| |c'#0@@6| (|#_module.com.Seq| |c0'#6| |c1#4|)) (_module.__default.small__step_h $ly@@11 (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) |c0#4| |s#0@@11| |c0'#6| |s'#0@@6|)))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1016|
 :pattern ( (_module.__default.small__step_h $ly@@11 (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) |c0#4| |s#0@@11| |c0'#6| |s'#0@@6|))
 :pattern ( (|#_module.com.Seq| |c0'#6| |c1#4|))
))))) (ite (_module.com.If_q |c#0@@6|) (let ((|els#4| (_module.com._h6 |c#0@@6|)))
(let ((|thn#4| (_module.com._h5 |c#0@@6|)))
(let ((|b#8| (_module.com._h4 |c#0@@6|)))
 (and (|_module.com#Equal| |c'#0@@6| (ite (_module.__default.bval ($LS $LZ) |b#8| |s#0@@11|) |thn#4| |els#4|)) (|Map#Equal| |s'#0@@6| |s#0@@11|))))) (let ((|body#4| (_module.com._h8 |c#0@@6|)))
(let ((|b#9| (_module.com._h7 |c#0@@6|)))
 (and (|_module.com#Equal| |c'#0@@6| (|#_module.com.If| |b#9| (|#_module.com.Seq| |body#4| (|#_module.com.While| |b#9| |body#4|)) (Lit DatatypeTypeType |#_module.com.SKIP|))) (|Map#Equal| |s'#0@@6| |s#0@@11|))))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@4|)) (forall ((|_k'#0| T@U) ) (!  (=> (|ORD#LessThanLimit| |_k'#0| |_k#0@@4|) (|_module.__default.small__step_h#canCall| |_k'#0| |c#0@@6| |s#0@@11| |c'#0@@6| |s'#0@@6|))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1015|
 :pattern ( (_module.__default.small__step_h $ly@@11 |_k'#0| |c#0@@6| |s#0@@11| |c'#0@@6| |s'#0@@6|))
))))) (= (_module.__default.small__step_h ($LS $ly@@11) |_k#0@@4| |c#0@@6| |s#0@@11| |c'#0@@6| |s'#0@@6|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (ite (_module.com.SKIP_q |c#0@@6|) false (ite (_module.com.Assign_q |c#0@@6|) (let ((|a#2| (_module.com._h1 |c#0@@6|)))
(let ((|x#2@@0| (_module.com._h0 |c#0@@6|)))
 (and (|_module.com#Equal| |c'#0@@6| |#_module.com.SKIP|) (|Map#Equal| |s'#0@@6| (|Map#Build| |s#0@@11| ($Box SeqType |x#2@@0|) ($Box intType (int_2_U (_module.__default.aval ($LS $LZ) |a#2| |s#0@@11|)))))))) (ite (_module.com.Seq_q |c#0@@6|) (let ((|c1#2| (_module.com._h3 |c#0@@6|)))
(let ((|c0#2| (_module.com._h2 |c#0@@6|)))
 (or (and (and (|_module.com#Equal| |c0#2| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@6| |c1#2|)) (|Map#Equal| |s'#0@@6| |s#0@@11|)) (exists ((|c0'#4| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#4| Tclass._module.com) (and (|_module.com#Equal| |c'#0@@6| (|#_module.com.Seq| |c0'#4| |c1#2|)) (_module.__default.small__step_h $ly@@11 (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) |c0#2| |s#0@@11| |c0'#4| |s'#0@@6|)))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1012|
 :pattern ( (_module.__default.small__step_h $ly@@11 (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) |c0#2| |s#0@@11| |c0'#4| |s'#0@@6|))
 :pattern ( (|#_module.com.Seq| |c0'#4| |c1#2|))
))))) (ite (_module.com.If_q |c#0@@6|) (let ((|els#2| (_module.com._h6 |c#0@@6|)))
(let ((|thn#2| (_module.com._h5 |c#0@@6|)))
(let ((|b#4@@0| (_module.com._h4 |c#0@@6|)))
 (and (|_module.com#Equal| |c'#0@@6| (ite (_module.__default.bval ($LS $LZ) |b#4@@0| |s#0@@11|) |thn#2| |els#2|)) (|Map#Equal| |s'#0@@6| |s#0@@11|))))) (let ((|body#2| (_module.com._h8 |c#0@@6|)))
(let ((|b#5| (_module.com._h7 |c#0@@6|)))
 (and (|_module.com#Equal| |c'#0@@6| (|#_module.com.If| |b#5| (|#_module.com.Seq| |body#2| (|#_module.com.While| |b#5| |body#2|)) (Lit DatatypeTypeType |#_module.com.SKIP|))) (|Map#Equal| |s'#0@@6| |s#0@@11|))))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@4|)) (exists ((|_k'#0@@0| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#0@@0| |_k#0@@4|) (_module.__default.small__step_h $ly@@11 |_k'#0@@0| |c#0@@6| |s#0@@11| |c'#0@@6| |s'#0@@6|))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1013|
 :pattern ( (_module.__default.small__step_h $ly@@11 |_k'#0@@0| |c#0@@6| |s#0@@11| |c'#0@@6| |s'#0@@6|))
)))))))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1017|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@11) |_k#0@@4| |c#0@@6| |s#0@@11| |c'#0@@6| |s'#0@@6|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@12 T@U) (|a#0@@2| T@U) (|s#0@@12| T@U) ) (!  (=> (or (|_module.__default.aval#canCall| |a#0@@2| |s#0@@12|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |a#0@@2| Tclass._module.aexp) ($Is MapType |s#0@@12| (TMap (TSeq TChar) TInt))))) (and (=> (not (_module.aexp.N_q |a#0@@2|)) (=> (not (_module.aexp.V_q |a#0@@2|)) (let ((|a1#1@@0| (_module.aexp._1 |a#0@@2|)))
(let ((|a0#1@@0| (_module.aexp._0 |a#0@@2|)))
 (and (|_module.__default.aval#canCall| |a0#1@@0| |s#0@@12|) (|_module.__default.aval#canCall| |a1#1@@0| |s#0@@12|)))))) (= (_module.__default.aval ($LS $ly@@12) |a#0@@2| |s#0@@12|) (ite (_module.aexp.N_q |a#0@@2|) (let ((|n#0| (_module.aexp.n |a#0@@2|)))
|n#0|) (ite (_module.aexp.V_q |a#0@@2|) (let ((|x#0@@0| (_module.aexp.x |a#0@@2|)))
(ite (|Set#IsMember| (|Map#Domain| |s#0@@12|) ($Box SeqType |x#0@@0|)) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |s#0@@12|) ($Box SeqType |x#0@@0|)))) 0)) (let ((|a1#0@@0| (_module.aexp._1 |a#0@@2|)))
(let ((|a0#0@@0| (_module.aexp._0 |a#0@@2|)))
(+ (_module.__default.aval $ly@@12 |a0#0@@0| |s#0@@12|) (_module.__default.aval $ly@@12 |a1#0@@0| |s#0@@12|)))))))))
 :qid |NipkowKleinchapter7dfy.16:16|
 :skolemid |704|
 :pattern ( (_module.__default.aval ($LS $ly@@12) |a#0@@2| |s#0@@12|))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@13 T@U) (|_k#0@@5| T@U) (|c#0@@7| T@U) (|s#0@@13| T@U) (|c'#0@@7| T@U) (|s'#0@@7| T@U) ) (!  (=> (or (|_module.__default.small__step_h#canCall| (Lit BoxType |_k#0@@5|) (Lit DatatypeTypeType |c#0@@7|) (Lit MapType |s#0@@13|) (Lit DatatypeTypeType |c'#0@@7|) (Lit MapType |s'#0@@7|)) (and (< 5 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |c#0@@7| Tclass._module.com) ($Is MapType |s#0@@13| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |c'#0@@7| Tclass._module.com)) ($Is MapType |s'#0@@7| (TMap (TSeq TChar) TInt))))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@5|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.com.SKIP_q (Lit DatatypeTypeType |c#0@@7|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (_module.com.Assign_q (Lit DatatypeTypeType |c#0@@7|))))) (let ((|a#9| (Lit DatatypeTypeType (_module.com._h1 (Lit DatatypeTypeType |c#0@@7|)))))
 (and (|$IsA#_module.com| (Lit DatatypeTypeType |c'#0@@7|)) (=> (|_module.com#Equal| |c'#0@@7| |#_module.com.SKIP|) (|_module.__default.aval#canCall| |a#9| (Lit MapType |s#0@@13|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.com.Assign_q (Lit DatatypeTypeType |c#0@@7|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (_module.com.Seq_q (Lit DatatypeTypeType |c#0@@7|))))) (let ((|c1#9| (Lit DatatypeTypeType (_module.com._h3 (Lit DatatypeTypeType |c#0@@7|)))))
(let ((|c0#9| (Lit DatatypeTypeType (_module.com._h2 (Lit DatatypeTypeType |c#0@@7|)))))
 (and (and (|$IsA#_module.com| |c0#9|) (=> (|_module.com#Equal| |c0#9| |#_module.com.SKIP|) (and (|$IsA#_module.com| (Lit DatatypeTypeType |c'#0@@7|)) (|$IsA#_module.com| |c1#9|)))) (=> (not (and (and (|_module.com#Equal| |c0#9| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@7| |c1#9|)) (|Map#Equal| |s'#0@@7| |s#0@@13|))) (forall ((|c0'#11| T@U) ) (!  (=> ($Is DatatypeTypeType |c0'#11| Tclass._module.com) (and (|$IsA#_module.com| (Lit DatatypeTypeType |c'#0@@7|)) (=> (|_module.com#Equal| |c'#0@@7| (|#_module.com.Seq| |c0'#11| |c1#9|)) (|_module.__default.small__step_h#canCall| (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |c0#9| (Lit MapType |s#0@@13|) |c0'#11| (Lit MapType |s'#0@@7|)))))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1026|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@13) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |c0#9| |s#0@@13| |c0'#11| |s'#0@@7|))
 :pattern ( (|#_module.com.Seq| |c0'#11| |c1#9|))
))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.com.Seq_q (Lit DatatypeTypeType |c#0@@7|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (_module.com.If_q (Lit DatatypeTypeType |c#0@@7|))))) (let ((|els#9| (Lit DatatypeTypeType (_module.com._h6 (Lit DatatypeTypeType |c#0@@7|)))))
(let ((|thn#9| (Lit DatatypeTypeType (_module.com._h5 (Lit DatatypeTypeType |c#0@@7|)))))
(let ((|b#18| (Lit DatatypeTypeType (_module.com._h4 (Lit DatatypeTypeType |c#0@@7|)))))
 (and (and (|$IsA#_module.com| (Lit DatatypeTypeType |c'#0@@7|)) (|$IsA#_module.com| (ite (_module.__default.bval ($LS $LZ) |b#18| (Lit MapType |s#0@@13|)) |thn#9| |els#9|))) (|_module.__default.bval#canCall| |b#18| (Lit MapType |s#0@@13|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.com.If_q (Lit DatatypeTypeType |c#0@@7|)))))) (|$IsA#_module.com| (Lit DatatypeTypeType |c'#0@@7|)))))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@5|)) (ite (_module.com.SKIP_q (Lit DatatypeTypeType |c#0@@7|)) false (ite (_module.com.Assign_q (Lit DatatypeTypeType |c#0@@7|)) (let ((|a#10| (Lit DatatypeTypeType (_module.com._h1 (Lit DatatypeTypeType |c#0@@7|)))))
(let ((|x#10| (Lit SeqType (_module.com._h0 (Lit DatatypeTypeType |c#0@@7|)))))
 (and (|_module.com#Equal| |c'#0@@7| |#_module.com.SKIP|) (|Map#Equal| |s'#0@@7| (|Map#Build| (Lit MapType |s#0@@13|) ($Box SeqType |x#10|) ($Box intType (int_2_U (LitInt (_module.__default.aval ($LS $LZ) |a#10| (Lit MapType |s#0@@13|)))))))))) (ite (_module.com.Seq_q (Lit DatatypeTypeType |c#0@@7|)) (let ((|c1#10| (Lit DatatypeTypeType (_module.com._h3 (Lit DatatypeTypeType |c#0@@7|)))))
(let ((|c0#10| (Lit DatatypeTypeType (_module.com._h2 (Lit DatatypeTypeType |c#0@@7|)))))
 (or (and (and (|_module.com#Equal| |c0#10| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@7| |c1#10|)) (|Map#Equal| |s'#0@@7| |s#0@@13|)) (exists ((|c0'#12| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#12| Tclass._module.com) (and (|_module.com#Equal| |c'#0@@7| (|#_module.com.Seq| |c0'#12| |c1#10|)) (_module.__default.small__step_h ($LS $ly@@13) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |c0#10| (Lit MapType |s#0@@13|) |c0'#12| (Lit MapType |s'#0@@7|))))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1028|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@13) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |c0#10| |s#0@@13| |c0'#12| |s'#0@@7|))
 :pattern ( (|#_module.com.Seq| |c0'#12| |c1#10|))
))))) (ite (_module.com.If_q (Lit DatatypeTypeType |c#0@@7|)) (let ((|els#10| (Lit DatatypeTypeType (_module.com._h6 (Lit DatatypeTypeType |c#0@@7|)))))
(let ((|thn#10| (Lit DatatypeTypeType (_module.com._h5 (Lit DatatypeTypeType |c#0@@7|)))))
(let ((|b#20| (Lit DatatypeTypeType (_module.com._h4 (Lit DatatypeTypeType |c#0@@7|)))))
 (and (|_module.com#Equal| |c'#0@@7| (ite (_module.__default.bval ($LS $LZ) |b#20| (Lit MapType |s#0@@13|)) |thn#10| |els#10|)) (|Map#Equal| |s'#0@@7| |s#0@@13|))))) (let ((|body#10| (Lit DatatypeTypeType (_module.com._h8 (Lit DatatypeTypeType |c#0@@7|)))))
(let ((|b#21| (Lit DatatypeTypeType (_module.com._h7 (Lit DatatypeTypeType |c#0@@7|)))))
 (and (|_module.com#Equal| |c'#0@@7| (|#_module.com.If| |b#21| (Lit DatatypeTypeType (|#_module.com.Seq| |body#10| (Lit DatatypeTypeType (|#_module.com.While| |b#21| |body#10|)))) (Lit DatatypeTypeType |#_module.com.SKIP|))) (|Map#Equal| |s'#0@@7| |s#0@@13|))))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@5|)) (forall ((|_k'#2| T@U) ) (!  (=> (|ORD#LessThanLimit| |_k'#2| |_k#0@@5|) (|_module.__default.small__step_h#canCall| |_k'#2| |c#0@@7| |s#0@@13| |c'#0@@7| |s'#0@@7|))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1027|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@13) |_k'#2| |c#0@@7| |s#0@@13| |c'#0@@7| |s'#0@@7|))
))))) (= (_module.__default.small__step_h ($LS $ly@@13) (Lit BoxType |_k#0@@5|) (Lit DatatypeTypeType |c#0@@7|) (Lit MapType |s#0@@13|) (Lit DatatypeTypeType |c'#0@@7|) (Lit MapType |s'#0@@7|))  (and (=> (< 0 (|ORD#Offset| |_k#0@@5|)) (ite (_module.com.SKIP_q (Lit DatatypeTypeType |c#0@@7|)) false (ite (_module.com.Assign_q (Lit DatatypeTypeType |c#0@@7|)) (let ((|a#8| (Lit DatatypeTypeType (_module.com._h1 (Lit DatatypeTypeType |c#0@@7|)))))
(let ((|x#8| (Lit SeqType (_module.com._h0 (Lit DatatypeTypeType |c#0@@7|)))))
 (and (|_module.com#Equal| |c'#0@@7| |#_module.com.SKIP|) (|Map#Equal| |s'#0@@7| (|Map#Build| (Lit MapType |s#0@@13|) ($Box SeqType |x#8|) ($Box intType (int_2_U (LitInt (_module.__default.aval ($LS $LZ) |a#8| (Lit MapType |s#0@@13|)))))))))) (ite (_module.com.Seq_q (Lit DatatypeTypeType |c#0@@7|)) (let ((|c1#8| (Lit DatatypeTypeType (_module.com._h3 (Lit DatatypeTypeType |c#0@@7|)))))
(let ((|c0#8| (Lit DatatypeTypeType (_module.com._h2 (Lit DatatypeTypeType |c#0@@7|)))))
 (or (and (and (|_module.com#Equal| |c0#8| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@7| |c1#8|)) (|Map#Equal| |s'#0@@7| |s#0@@13|)) (exists ((|c0'#10| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#10| Tclass._module.com) (and (|_module.com#Equal| |c'#0@@7| (|#_module.com.Seq| |c0'#10| |c1#8|)) (_module.__default.small__step_h ($LS $ly@@13) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |c0#8| (Lit MapType |s#0@@13|) |c0'#10| (Lit MapType |s'#0@@7|))))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1024|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@13) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |c0#8| |s#0@@13| |c0'#10| |s'#0@@7|))
 :pattern ( (|#_module.com.Seq| |c0'#10| |c1#8|))
))))) (ite (_module.com.If_q (Lit DatatypeTypeType |c#0@@7|)) (let ((|els#8| (Lit DatatypeTypeType (_module.com._h6 (Lit DatatypeTypeType |c#0@@7|)))))
(let ((|thn#8| (Lit DatatypeTypeType (_module.com._h5 (Lit DatatypeTypeType |c#0@@7|)))))
(let ((|b#16| (Lit DatatypeTypeType (_module.com._h4 (Lit DatatypeTypeType |c#0@@7|)))))
 (and (|_module.com#Equal| |c'#0@@7| (ite (_module.__default.bval ($LS $LZ) |b#16| (Lit MapType |s#0@@13|)) |thn#8| |els#8|)) (|Map#Equal| |s'#0@@7| |s#0@@13|))))) (let ((|body#8| (Lit DatatypeTypeType (_module.com._h8 (Lit DatatypeTypeType |c#0@@7|)))))
(let ((|b#17| (Lit DatatypeTypeType (_module.com._h7 (Lit DatatypeTypeType |c#0@@7|)))))
 (and (|_module.com#Equal| |c'#0@@7| (|#_module.com.If| |b#17| (Lit DatatypeTypeType (|#_module.com.Seq| |body#8| (Lit DatatypeTypeType (|#_module.com.While| |b#17| |body#8|)))) (Lit DatatypeTypeType |#_module.com.SKIP|))) (|Map#Equal| |s'#0@@7| |s#0@@13|))))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@5|)) (exists ((|_k'#2@@0| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#2@@0| |_k#0@@5|) (_module.__default.small__step_h ($LS $ly@@13) |_k'#2@@0| |c#0@@7| |s#0@@13| |c'#0@@7| |s'#0@@7|))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1025|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@13) |_k'#2@@0| |c#0@@7| |s#0@@13| |c'#0@@7| |s'#0@@7|))
)))))))
 :qid |NipkowKleinchapter7dfy.154:17|
 :weight 3
 :skolemid |1029|
 :pattern ( (_module.__default.small__step_h ($LS $ly@@13) (Lit BoxType |_k#0@@5|) (Lit DatatypeTypeType |c#0@@7|) (Lit MapType |s#0@@13|) (Lit DatatypeTypeType |c'#0@@7|) (Lit MapType |s'#0@@7|)))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@14 T@U) (|c#0@@8| T@U) (|s#0@@14| T@U) (|c'#0@@8| T@U) (|s'#0@@8| T@U) (|_k#0@@6| T@U) (_m T@U) (_limit T@U) ) (!  (=> (|ORD#Less| |_k#0@@6| _m) (=> (_module.__default.small__step_h $ly@@14 |_k#0@@6| |c#0@@8| |s#0@@14| |c'#0@@8| |s'#0@@8|) (_module.__default.small__step_h $ly@@14 _m |c#0@@8| |s#0@@14| |c'#0@@8| |s'#0@@8|)))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1001|
 :pattern ( (_module.__default.small__step_h $ly@@14 |_k#0@@6| |c#0@@8| |s#0@@14| |c'#0@@8| |s'#0@@8|) (|ORD#LessThanLimit| |_k#0@@6| _limit) (|ORD#LessThanLimit| _m _limit))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.SmallStep__is__deterministic)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (|_System.Tuple2#Equal| |cs'#0| |cs''#0|))))
(let ((anon6_Then_correct  (=> (and ($IsAlloc BoxType |k'#1@0| TORDINAL $Heap) (_System.Tuple2.___hMake2_q |cs#0|)) (=> (and (and (= |##c#3@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|))) ($IsAlloc DatatypeTypeType |##c#3@0| Tclass._module.com $Heap)) (and (_System.Tuple2.___hMake2_q |cs#0|) (= |##s#3@0| ($Unbox MapType (_System.Tuple2._1 |cs#0|))))) (=> (and (and (and ($IsAlloc MapType |##s#3@0| (TMap (TSeq TChar) TInt) $Heap) (_System.Tuple2.___hMake2_q |cs''#0|)) (and (= |##c'#3@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|))) ($IsAlloc DatatypeTypeType |##c'#3@0| Tclass._module.com $Heap))) (and (and (_System.Tuple2.___hMake2_q |cs''#0|) (= |##s'#3@0| ($Unbox MapType (_System.Tuple2._1 |cs''#0|)))) (and ($IsAlloc MapType |##s'#3@0| (TMap (TSeq TChar) TInt) $Heap) (|_module.__default.small__step_h#canCall| |k'#1@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|)))))) (=> (and (and (and (and (_System.Tuple2.___hMake2_q |cs#0|) (_System.Tuple2.___hMake2_q |cs#0|)) (_System.Tuple2.___hMake2_q |cs''#0|)) (_System.Tuple2.___hMake2_q |cs''#0|)) (|_module.__default.small__step_h#canCall| |k'#1@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|)))) (and (=> (= (ControlFlow 0 5) (- 0 24)) (exists ((|$as#k'0#0| T@U) ) (! (_module.__default.small__step_h ($LS $LZ) |$as#k'0#0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|)))
 :qid |NipkowKleinchapter7dfy.194:7|
 :skolemid |1057|
))) (=> (exists ((|$as#k'0#0@@0| T@U) ) (! (_module.__default.small__step_h ($LS $LZ) |$as#k'0#0@@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|)))
 :qid |NipkowKleinchapter7dfy.194:7|
 :skolemid |1057|
)) (=> (_module.__default.small__step_h ($LS $LZ) |k'#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|))) (and (=> (= (ControlFlow 0 5) (- 0 23)) (=> (|_module.__default.small__step_h#canCall| |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (=> (< 0 (|ORD#Offset| |k#0@0|)) (=> (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|))) (U_2_bool (Lit boolType (bool_2_U false)))))))) (=> (=> (|_module.__default.small__step_h#canCall| |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (=> (< 0 (|ORD#Offset| |k#0@0|)) (=> (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|))) (U_2_bool (Lit boolType (bool_2_U false))))))) (and (=> (= (ControlFlow 0 5) (- 0 22)) (=> (|_module.__default.small__step_h#canCall| |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (=> (< 0 (|ORD#Offset| |k#0@0|)) (=> (not (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (_module.com.Assign_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|))) (|_module.com#Equal| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) |#_module.com.SKIP|))))))) (=> (=> (|_module.__default.small__step_h#canCall| |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (=> (< 0 (|ORD#Offset| |k#0@0|)) (=> (not (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (_module.com.Assign_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|))) (|_module.com#Equal| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) |#_module.com.SKIP|)))))) (and (=> (= (ControlFlow 0 5) (- 0 21)) (=> (|_module.__default.small__step_h#canCall| |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (=> (< 0 (|ORD#Offset| |k#0@0|)) (=> (not (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (_module.com.Assign_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|))) (let ((|a#0@@3| (_module.com._h1 ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))))
(let ((|x#0@@1| (_module.com._h0 ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))))
(|Map#Equal| ($Unbox MapType (_System.Tuple2._1 |cs'#0|)) (|Map#Build| ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Box SeqType |x#0@@1|) ($Box intType (int_2_U (_module.__default.aval ($LS ($LS $LZ)) |a#0@@3| ($Unbox MapType (_System.Tuple2._1 |cs#0|))))))))))))))) (=> (=> (|_module.__default.small__step_h#canCall| |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (=> (< 0 (|ORD#Offset| |k#0@0|)) (=> (not (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (_module.com.Assign_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|))) (let ((|a#0@@4| (_module.com._h1 ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))))
(let ((|x#0@@2| (_module.com._h0 ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))))
(|Map#Equal| ($Unbox MapType (_System.Tuple2._1 |cs'#0|)) (|Map#Build| ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Box SeqType |x#0@@2|) ($Box intType (int_2_U (_module.__default.aval ($LS ($LS $LZ)) |a#0@@4| ($Unbox MapType (_System.Tuple2._1 |cs#0|)))))))))))))) (and (=> (= (ControlFlow 0 5) (- 0 20)) (=> (|_module.__default.small__step_h#canCall| |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (=> (< 0 (|ORD#Offset| |k#0@0|)) (=> (not (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Assign_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (_module.com.Seq_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|))) (let ((|c1#0@@0| (_module.com._h3 ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))))
(let ((|c0#0@@0| (_module.com._h2 ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))))
 (or (and (and (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|) (|_module.com#Equal| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) |c1#0@@0|)) (|Map#Equal| ($Unbox MapType (_System.Tuple2._1 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)))) (exists ((|c0'#0@@0| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#0@@0| Tclass._module.com) (and (|_module.com#Equal| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) (|#_module.com.Seq| |c0'#0@@0| |c1#0@@0|)) (_module.__default.small__step_h ($LS ($LS $LZ)) (|ORD#Minus| |k#0@0| (|ORD#FromNat| 1)) |c0#0@@0| ($Unbox MapType (_System.Tuple2._1 |cs#0|)) |c0'#0@@0| ($Unbox MapType (_System.Tuple2._1 |cs'#0|)))))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1059|
 :pattern ( (_module.__default.small__step_h ($LS ($LS $LZ)) (|ORD#Minus| |k#0@0| (|ORD#FromNat| 1)) |c0#0@@0| ($Unbox MapType (_System.Tuple2._1 |cs#0|)) |c0'#0@@0| ($Unbox MapType (_System.Tuple2._1 |cs'#0|))))
 :pattern ( (|#_module.com.Seq| |c0'#0@@0| |c1#0@@0|))
)))))))))))) (=> (=> (|_module.__default.small__step_h#canCall| |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (=> (< 0 (|ORD#Offset| |k#0@0|)) (=> (not (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Assign_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (_module.com.Seq_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|))) (let ((|c1#0@@1| (_module.com._h3 ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))))
(let ((|c0#0@@1| (_module.com._h2 ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))))
 (or (and (and (|_module.com#Equal| |c0#0@@1| |#_module.com.SKIP|) (|_module.com#Equal| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) |c1#0@@1|)) (|Map#Equal| ($Unbox MapType (_System.Tuple2._1 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)))) (exists ((|c0'#0@@1| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#0@@1| Tclass._module.com) (and (|_module.com#Equal| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) (|#_module.com.Seq| |c0'#0@@1| |c1#0@@1|)) (_module.__default.small__step_h ($LS ($LS $LZ)) (|ORD#Minus| |k#0@0| (|ORD#FromNat| 1)) |c0#0@@1| ($Unbox MapType (_System.Tuple2._1 |cs#0|)) |c0'#0@@1| ($Unbox MapType (_System.Tuple2._1 |cs'#0|)))))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1059|
 :pattern ( (_module.__default.small__step_h ($LS ($LS $LZ)) (|ORD#Minus| |k#0@0| (|ORD#FromNat| 1)) |c0#0@@1| ($Unbox MapType (_System.Tuple2._1 |cs#0|)) |c0'#0@@1| ($Unbox MapType (_System.Tuple2._1 |cs'#0|))))
 :pattern ( (|#_module.com.Seq| |c0'#0@@1| |c1#0@@1|))
))))))))))) (and (=> (= (ControlFlow 0 5) (- 0 19)) (=> (|_module.__default.small__step_h#canCall| |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (=> (< 0 (|ORD#Offset| |k#0@0|)) (=> (not (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Assign_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Seq_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (_module.com.If_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|))) (let ((|els#0@@0| (_module.com._h6 ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))))
...
(|_module.com#Equal| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) (ite (_module.__default.bval ($LS ($LS $LZ)) |b#0@@3| ($Unbox MapType (_System.Tuple2._1 |cs#0|))) |thn#0@@0| |els#0@@0|))))))))))))) (=> (=> (|_module.__default.small__step_h#canCall| |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (=> (< 0 (|ORD#Offset| |k#0@0|)) (=> (not (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Assign_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Seq_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (_module.com.If_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|))) (let ((|els#0@@1| (_module.com._h6 ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))))
...
(|_module.com#Equal| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) (ite (_module.__default.bval ($LS ($LS $LZ)) |b#0@@4| ($Unbox MapType (_System.Tuple2._1 |cs#0|))) |thn#0@@1| |els#0@@1|)))))))))))) (and (=> (= (ControlFlow 0 5) (- 0 18)) (=> (|_module.__default.small__step_h#canCall| |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (=> (< 0 (|ORD#Offset| |k#0@0|)) (=> (not (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Assign_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Seq_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (_module.com.If_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|))) (|Map#Equal| ($Unbox MapType (_System.Tuple2._1 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|))))))))))) (=> (=> (|_module.__default.small__step_h#canCall| |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (=> (< 0 (|ORD#Offset| |k#0@0|)) (=> (not (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Assign_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Seq_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (_module.com.If_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|))) (|Map#Equal| ($Unbox MapType (_System.Tuple2._1 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)))))))))) (and (=> (= (ControlFlow 0 5) (- 0 17)) (=> (|_module.__default.small__step_h#canCall| |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (=> (< 0 (|ORD#Offset| |k#0@0|)) (=> (not (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Assign_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Seq_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.If_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (let ((|body#0@@0| (_module.com._h8 ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))))
(let ((|b#1@@1| (_module.com._h7 ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))))
(|_module.com#Equal| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) (|#_module.com.If| |b#1@@1| (|#_module.com.Seq| |body#0@@0| (|#_module.com.While| |b#1@@1| |body#0@@0|)) (Lit DatatypeTypeType |#_module.com.SKIP|))))))))))))) (=> (=> (|_module.__default.small__step_h#canCall| |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (=> (< 0 (|ORD#Offset| |k#0@0|)) (=> (not (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Assign_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Seq_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.If_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (let ((|body#0@@1| (_module.com._h8 ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))))
(let ((|b#1@@2| (_module.com._h7 ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))))
(|_module.com#Equal| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) (|#_module.com.If| |b#1@@2| (|#_module.com.Seq| |body#0@@1| (|#_module.com.While| |b#1@@2| |body#0@@1|)) (Lit DatatypeTypeType |#_module.com.SKIP|)))))))))))) (and (=> (= (ControlFlow 0 5) (- 0 16)) (=> (|_module.__default.small__step_h#canCall| |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (=> (< 0 (|ORD#Offset| |k#0@0|)) (=> (not (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Assign_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Seq_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.If_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (|Map#Equal| ($Unbox MapType (_System.Tuple2._1 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|))))))))))) (=> (=> (|_module.__default.small__step_h#canCall| |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (=> (< 0 (|ORD#Offset| |k#0@0|)) (=> (not (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Assign_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Seq_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.If_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (|Map#Equal| ($Unbox MapType (_System.Tuple2._1 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)))))))))) (and (=> (= (ControlFlow 0 5) (- 0 15)) (=> (|_module.__default.small__step_h#canCall| |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (=> (= (LitInt 0) (|ORD#Offset| |k#0@0|)) (exists ((|_k'#0@@1| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#0@@1| |k#0@0|) (_module.__default.small__step_h ($LS $LZ) |_k'#0@@1| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1060|
...
)))))) (=> (=> (|_module.__default.small__step_h#canCall| |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (=> (= (LitInt 0) (|ORD#Offset| |k#0@0|)) (exists ((|_k'#0@@2| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#0@@2| |k#0@0|) (_module.__default.small__step_h ($LS $LZ) |_k'#0@@2| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1060|
...
(let ((|c0#2@@1| (_module.com._h2 ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))))
 (or (and (and (|_module.com#Equal| |c0#2@@1| |#_module.com.SKIP|) (|_module.com#Equal| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) |c1#2@@1|)) (|Map#Equal| ($Unbox MapType (_System.Tuple2._1 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)))) (exists ((|c0'#2@@0| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#2@@0| Tclass._module.com) (and (|_module.com#Equal| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) (|#_module.com.Seq| |c0'#2@@0| |c1#2@@1|)) (_module.__default.small__step_h ($LS ($LS $LZ)) (|ORD#Minus| |k'#0@0| (|ORD#FromNat| 1)) |c0#2@@1| ($Unbox MapType (_System.Tuple2._1 |cs#0|)) |c0'#2@@0| ($Unbox MapType (_System.Tuple2._1 |cs''#0|)))))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1064|
 :pattern ( (_module.__default.small__step_h ($LS ($LS $LZ)) (|ORD#Minus| |k'#0@0| (|ORD#FromNat| 1)) |c0#2@@1| ($Unbox MapType (_System.Tuple2._1 |cs#0|)) |c0'#2@@0| ($Unbox MapType (_System.Tuple2._1 |cs''#0|))))
 :pattern ( (|#_module.com.Seq| |c0'#2@@0| |c1#2@@1|))
))))))))))) (and (=> (= (ControlFlow 0 5) (- 0 10)) (=> (|_module.__default.small__step_h#canCall| |k'#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k'#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|))) (=> (< 0 (|ORD#Offset| |k'#0@0|)) (=> (not (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Assign_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Seq_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (_module.com.If_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|))) (let ((|els#2@@0| (_module.com._h6 ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))))
...
(|_module.com#Equal| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) (ite (_module.__default.bval ($LS ($LS $LZ)) |b#4@@1| ($Unbox MapType (_System.Tuple2._1 |cs#0|))) |thn#2@@0| |els#2@@0|))))))))))))) (=> (=> (|_module.__default.small__step_h#canCall| |k'#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k'#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|))) (=> (< 0 (|ORD#Offset| |k'#0@0|)) (=> (not (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Assign_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Seq_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (_module.com.If_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|))) (let ((|els#2@@1| (_module.com._h6 ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))))
...
(|_module.com#Equal| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) (ite (_module.__default.bval ($LS ($LS $LZ)) |b#4@@2| ($Unbox MapType (_System.Tuple2._1 |cs#0|))) |thn#2@@1| |els#2@@1|)))))))))))) (and (=> (= (ControlFlow 0 5) (- 0 9)) (=> (|_module.__default.small__step_h#canCall| |k'#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k'#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|))) (=> (< 0 (|ORD#Offset| |k'#0@0|)) (=> (not (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Assign_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Seq_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (_module.com.If_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|))) (|Map#Equal| ($Unbox MapType (_System.Tuple2._1 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|))))))))))) (=> (=> (|_module.__default.small__step_h#canCall| |k'#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k'#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|))) (=> (< 0 (|ORD#Offset| |k'#0@0|)) (=> (not (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Assign_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Seq_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (_module.com.If_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|))) (|Map#Equal| ($Unbox MapType (_System.Tuple2._1 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)))))))))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (=> (|_module.__default.small__step_h#canCall| |k'#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k'#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|))) (=> (< 0 (|ORD#Offset| |k'#0@0|)) (=> (not (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Assign_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Seq_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.If_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (let ((|body#2@@0| (_module.com._h8 ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))))
(let ((|b#5@@0| (_module.com._h7 ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))))
(|_module.com#Equal| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) (|#_module.com.If| |b#5@@0| (|#_module.com.Seq| |body#2@@0| (|#_module.com.While| |b#5@@0| |body#2@@0|)) (Lit DatatypeTypeType |#_module.com.SKIP|))))))))))))) (=> (=> (|_module.__default.small__step_h#canCall| |k'#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k'#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|))) (=> (< 0 (|ORD#Offset| |k'#0@0|)) (=> (not (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Assign_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Seq_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.If_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (let ((|body#2@@1| (_module.com._h8 ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))))
(let ((|b#5@@1| (_module.com._h7 ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))))
(|_module.com#Equal| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) (|#_module.com.If| |b#5@@1| (|#_module.com.Seq| |body#2@@1| (|#_module.com.While| |b#5@@1| |body#2@@1|)) (Lit DatatypeTypeType |#_module.com.SKIP|)))))))))))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (=> (|_module.__default.small__step_h#canCall| |k'#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k'#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|))) (=> (< 0 (|ORD#Offset| |k'#0@0|)) (=> (not (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Assign_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Seq_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.If_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (|Map#Equal| ($Unbox MapType (_System.Tuple2._1 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|))))))))))) (=> (=> (|_module.__default.small__step_h#canCall| |k'#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k'#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|))) (=> (< 0 (|ORD#Offset| |k'#0@0|)) (=> (not (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Assign_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.Seq_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (=> (not (_module.com.If_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))) (|Map#Equal| ($Unbox MapType (_System.Tuple2._1 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)))))))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (=> (|_module.__default.small__step_h#canCall| |k'#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k'#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|))) (=> (= (LitInt 0) (|ORD#Offset| |k'#0@0|)) (exists ((|_k'#1@@1| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#1@@1| |k'#0@0|) (_module.__default.small__step_h ($LS $LZ) |_k'#1@@1| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|))))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1065|
...
)))))) (=> (=> (|_module.__default.small__step_h#canCall| |k'#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|))) (or (_module.__default.small__step_h ($LS $LZ) |k'#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|))) (=> (= (LitInt 0) (|ORD#Offset| |k'#0@0|)) (exists ((|_k'#1@@2| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#1@@2| |k'#0@0|) (_module.__default.small__step_h ($LS $LZ) |_k'#1@@2| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|))))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1065|
...
))))) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (|$IsA#_System.Tuple2| |cs'#0|) (|$IsA#_System.Tuple2| |cs''#0|)) (|_System.Tuple2#Equal| |cs'#0| |cs''#0|)) (and (= $Heap $Heap@0) (= (ControlFlow 0 5) 4))) GeneratedUnifiedExit_correct)))))))))))))))))))))))))))))))))))))))))))))))
(let ((anon6_Else_correct true))
(let ((anon5_Then_correct  (=> (and ($IsAlloc BoxType |k#1@0| TORDINAL $Heap) (_System.Tuple2.___hMake2_q |cs#0|)) (=> (and (and (= |##c#2@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|))) ($IsAlloc DatatypeTypeType |##c#2@0| Tclass._module.com $Heap)) (and (_System.Tuple2.___hMake2_q |cs#0|) (= |##s#2@0| ($Unbox MapType (_System.Tuple2._1 |cs#0|))))) (=> (and (and (and ($IsAlloc MapType |##s#2@0| (TMap (TSeq TChar) TInt) $Heap) (_System.Tuple2.___hMake2_q |cs'#0|)) (and (= |##c'#2@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|))) ($IsAlloc DatatypeTypeType |##c'#2@0| Tclass._module.com $Heap))) (and (and (_System.Tuple2.___hMake2_q |cs'#0|) (= |##s'#2@0| ($Unbox MapType (_System.Tuple2._1 |cs'#0|)))) (and ($IsAlloc MapType |##s'#2@0| (TMap (TSeq TChar) TInt) $Heap) (|_module.__default.small__step_h#canCall| |k#1@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|)))))) (=> (and (and (and (and (_System.Tuple2.___hMake2_q |cs#0|) (_System.Tuple2.___hMake2_q |cs#0|)) (_System.Tuple2.___hMake2_q |cs'#0|)) (_System.Tuple2.___hMake2_q |cs'#0|)) (|_module.__default.small__step_h#canCall| |k#1@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|)))) (and (=> (= (ControlFlow 0 25) (- 0 26)) (exists ((|$as#k0#0| T@U) ) (! (_module.__default.small__step_h ($LS $LZ) |$as#k0#0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|)))
 :qid |NipkowKleinchapter7dfy.193:7|
 :skolemid |1056|
))) (=> (exists ((|$as#k0#0@@0| T@U) ) (! (_module.__default.small__step_h ($LS $LZ) |$as#k0#0@@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|)))
 :qid |NipkowKleinchapter7dfy.193:7|
 :skolemid |1056|
)) (=> (_module.__default.small__step_h ($LS $LZ) |k#0@0| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (and (=> (= (ControlFlow 0 25) 5) anon6_Then_correct) (=> (= (ControlFlow 0 25) 2) anon6_Else_correct)))))))))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 27) 25) anon5_Then_correct) (=> (= (ControlFlow 0 27) 1) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |cs#0| (Tclass._System.Tuple2 Tclass._module.com (TMap (TSeq TChar) TInt))) ($IsAlloc DatatypeTypeType |cs#0| (Tclass._System.Tuple2 Tclass._module.com (TMap (TSeq TChar) TInt)) $Heap)) (|$IsA#_System.Tuple2| |cs#0|)) (and (and ($Is DatatypeTypeType |cs'#0| (Tclass._System.Tuple2 Tclass._module.com (TMap (TSeq TChar) TInt))) ($IsAlloc DatatypeTypeType |cs'#0| (Tclass._System.Tuple2 Tclass._module.com (TMap (TSeq TChar) TInt)) $Heap)) (|$IsA#_System.Tuple2| |cs'#0|))) (=> (and (and (and (and (and ($Is DatatypeTypeType |cs''#0| (Tclass._System.Tuple2 Tclass._module.com (TMap (TSeq TChar) TInt))) ($IsAlloc DatatypeTypeType |cs''#0| (Tclass._System.Tuple2 Tclass._module.com (TMap (TSeq TChar) TInt)) $Heap)) (|$IsA#_System.Tuple2| |cs''#0|)) (= 8 $FunctionContextHeight)) (and (|_module.__default.small__step#canCall| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (and (_module.__default.small__step ($LS $LZ) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs'#0|))) (ite (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|))) false (ite (_module.com.Assign_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|))) (let ((|a#5@@0| (_module.com._h1 ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))))
...
(let ((|b#11@@0| (_module.com._h7 ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))))
 (and (|_module.com#Equal| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs'#0|)) (|#_module.com.If| |b#11@@0| (|#_module.com.Seq| |body#5@@0| (|#_module.com.While| |b#11@@0| |body#5@@0|)) (Lit DatatypeTypeType |#_module.com.SKIP|))) (|Map#Equal| ($Unbox MapType (_System.Tuple2._1 |cs'#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|))))))))))))) (and (and (|_module.__default.small__step#canCall| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|))) (and (_module.__default.small__step ($LS $LZ) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)) ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs''#0|))) (ite (_module.com.SKIP_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|))) false (ite (_module.com.Assign_q ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|))) (let ((|a#7@@0| (_module.com._h1 ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))))
...
(let ((|b#15@@0| (_module.com._h7 ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs#0|)))))
 (and (|_module.com#Equal| ($Unbox DatatypeTypeType (_System.Tuple2._0 |cs''#0|)) (|#_module.com.If| |b#15@@0| (|#_module.com.Seq| |body#7@@0| (|#_module.com.While| |b#15@@0| |body#7@@0|)) (Lit DatatypeTypeType |#_module.com.SKIP|))) (|Map#Equal| ($Unbox MapType (_System.Tuple2._1 |cs''#0|)) ($Unbox MapType (_System.Tuple2._1 |cs#0|)))))))))))) (= (ControlFlow 0 28) 27))) anon0_correct)))))
