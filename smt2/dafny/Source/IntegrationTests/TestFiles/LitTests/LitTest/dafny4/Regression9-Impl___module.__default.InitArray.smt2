...
(declare-fun _module._default.InitArray$D () T@U)
(declare-fun |f#0@@3| () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |defass#a#0| () Bool)
(declare-fun |a#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.InitArray)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |a#0@0| (Apply1 TInt _module._default.InitArray$D $Heap |f#0@@3| ($Box intType (int_2_U (LitInt 44))))) (= (ControlFlow 0 2) (- 0 1))) true))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 TInt _module._default.InitArray$D)) ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 TInt _module._default.InitArray$D) $Heap)) (=> |defass#a#0| (and ($IsBox |a#0| _module._default.InitArray$D) ($IsAllocBox |a#0| _module._default.InitArray$D $Heap)))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
