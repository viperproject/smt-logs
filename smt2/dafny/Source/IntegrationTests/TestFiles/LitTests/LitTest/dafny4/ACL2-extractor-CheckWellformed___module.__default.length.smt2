...
(|_module.__default.length#canCall| _module._default.length$_T0 |rest#3|))) (= (_module.__default.length _module._default.length$_T0 ($LS $ly) (Lit DatatypeTypeType |xs#0|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0|)) 0 (let ((|rest#2| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0|)))))
...
(|_module.__default.length#canCall| _module._default.length$_T0@@1 |rest#1|))) (= (_module.__default.length _module._default.length$_T0@@1 ($LS $ly@@1) |xs#0@@1|) (ite (_module.List.Nil_q |xs#0@@1|) 0 (let ((|rest#0| (_module.List.tail |xs#0@@1|)))
(+ 1 (_module.__default.length _module._default.length$_T0@@1 $ly@@1 |rest#0|)))))))
 :qid |unknown.0:0|
 :skolemid |535|
...
(let ((anon10_Then_correct  (=> (= |xs#0@@3| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) (=> (and ($IsBox |_mcc#0#0| _module._default.length$_T0@@3) ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List _module._default.length$_T0@@3))) (=> (and (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List _module._default.length$_T0@@3))) (and (= |rest#Z#0@0| |let#0#0#0|) ($IsAlloc DatatypeTypeType |rest#Z#0@0| (Tclass._module.List _module._default.length$_T0@@3) $Heap))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< (DtRank |rest#Z#0@0|) (DtRank |xs#0@@3|))) (=> (< (DtRank |rest#Z#0@0|) (DtRank |xs#0@@3|)) (=> (and (|_module.__default.length#canCall| _module._default.length$_T0@@3 |rest#Z#0@0|) (= (ControlFlow 0 5) (- 0 4))) ($Is intType (int_2_U (+ 1 (_module.__default.length _module._default.length$_T0@@3 ($LS $LZ) |rest#Z#0@0|))) Tclass._System.nat)))))))))
(let ((anon9_Else_correct  (=> (or (not (= |xs#0@@3| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 8) 5) anon10_Then_correct) (=> (= (ControlFlow 0 8) 7) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> (and (= |xs#0@@3| |#_module.List.Nil|) (= (ControlFlow 0 3) (- 0 2))) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |xs#0@@3| (Tclass._module.List _module._default.length$_T0@@3))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct)))
