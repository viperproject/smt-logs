...
(set-info :boogie-vc-id CheckWellFormed$$M2.UnionFind.Reaches__SinkIsFunctionOfStart)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M2.Element Tclass.M2.Contents) $Heap)) (=> (and (and (and (|M2.__default.GoodCMap#canCall| |C#0@@5|) (M2.__default.GoodCMap |C#0@@5|)) (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|)) ($IsAllocBox ($Box refType this@@3) Tclass.M2.UnionFind? $Heap))) (and (and ($IsAlloc intType (int_2_U |d0#0|) Tclass._System.nat $Heap) ($IsAlloc refType |e#0@@3| Tclass.M2.Element $Heap)) (and ($IsAlloc refType |r0#0| Tclass.M2.Element $Heap) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M2.Element Tclass.M2.Contents) $Heap)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|M2.__default.GoodCMap#canCall| |C#0@@5|) (or (M2.__default.GoodCMap |C#0@@5|) (forall ((|f#0@@0| T@U) ) (!  (=> ($Is refType |f#0@@0| Tclass.M2.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |f#0@@0|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#0@@0|))))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#0@@0|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |1954|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#0@@0|))))
))))) (=> (M2.__default.GoodCMap |C#0@@5|) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|))) (=> (and (and (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|)) (|M2.UnionFind.Reaches#canCall| this@@3 |d0#0| |e#0@@3| |r0#0| |C#0@@5|)) (and (M2.UnionFind.Reaches ($LS $LZ) this@@3 |d0#0| |e#0@@3| |r0#0| |C#0@@5|) ($IsAllocBox ($Box refType this@@3) Tclass.M2.UnionFind? $Heap))) (and (and ($IsAlloc intType (int_2_U |d1#0|) Tclass._System.nat $Heap) ($IsAlloc refType |e#0@@3| Tclass.M2.Element $Heap)) (and ($IsAlloc refType |r1#0| Tclass.M2.Element $Heap) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M2.Element Tclass.M2.Contents) $Heap)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|M2.__default.GoodCMap#canCall| |C#0@@5|) (or (M2.__default.GoodCMap |C#0@@5|) (forall ((|f#1@@0| T@U) ) (!  (=> ($Is refType |f#1@@0| Tclass.M2.Element?) (=> (and (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |f#1@@0|)) (M2.Contents.Link_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#1@@0|))))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType (M2.Contents.next ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#1@@0|))))))))
 :qid |UnionFinddfy.50:12|
 :skolemid |1956|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |C#0@@5|) ($Box refType |f#1@@0|))))
))))) (=> (and (M2.__default.GoodCMap |C#0@@5|) (= (ControlFlow 0 2) (- 0 1))) (|Set#IsMember| (|Map#Domain| |C#0@@5|) ($Box refType |e#0@@3|))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.M2.UnionFind) ($IsAlloc refType this@@3 Tclass.M2.UnionFind $Heap)))) (and (and (<= (LitInt 0) |d0#0|) (<= (LitInt 0) |d1#0|)) (and ($Is refType |e#0@@3| Tclass.M2.Element) ($IsAlloc refType |e#0@@3| Tclass.M2.Element $Heap)))) (and (and (and ($Is refType |r0#0| Tclass.M2.Element) ($IsAlloc refType |r0#0| Tclass.M2.Element $Heap)) (and ($Is refType |r1#0| Tclass.M2.Element) ($IsAlloc refType |r1#0| Tclass.M2.Element $Heap))) (and (and ($Is MapType |C#0@@5| (TMap Tclass.M2.Element Tclass.M2.Contents)) ($IsAlloc MapType |C#0@@5| (TMap Tclass.M2.Element Tclass.M2.Contents) $Heap)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 6) 2))))) anon0_correct)))
