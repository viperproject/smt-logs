...
(declare-fun reveal__module._default.Gcd () Bool)
...
(set-info :boogie-vc-id Impl$$_module.__default.EuclidGcdAlt)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 25) (let ((anon9_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (or (<= 0 |$decr$loop#00@1|) (= (+ |x#0@2| |y#0@2|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (+ |x#0@2| |y#0@2|) |$decr$loop#00@1|)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< (+ |x#0@2| |y#0@2|) |$decr$loop#00@1|)) (=> (< (+ |x#0@2| |y#0@2|) |$decr$loop#00@1|) (=> (and (and (and (|_module.__default.Gcd#canCall| |x#0@2| |y#0@2|) (|_module.__default.Gcd#canCall| |X#0| |Y#0|)) (= (ControlFlow 0 9) (- 0 8))) |$w$loop#0@0|) (= (_module.__default.Gcd reveal__module._default.Gcd |x#0@2| |y#0@2|) (_module.__default.Gcd reveal__module._default.Gcd |X#0| |Y#0|)))))))))
(let ((anon15_Then_correct  (=> (< |y#0@0| |x#0@0|) (and (=> (= (ControlFlow 0 15) (- 0 18)) ($Is intType (int_2_U (- |x#0@0| |y#0@0|)) Tclass._module.pos)) (=> ($Is intType (int_2_U (- |x#0@0| |y#0@0|)) Tclass._module.pos) (=> (= |x##0_0@1| (- |x#0@0| |y#0@0|)) (=> (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (=> (and (and (|_module.__default.Gcd#canCall| |x##0_0@1| |y#0@0|) (|_module.__default.Gcd#canCall| |y#0@0| |x##0_0@1|)) (and (= (_module.__default.Gcd reveal__module._default.Gcd |x##0_0@1| |y#0@0|) (_module.__default.Gcd reveal__module._default.Gcd |y#0@0| |x##0_0@1|)) (= $Heap@0 $Heap@3))) (and (=> (= (ControlFlow 0 15) (- 0 17)) (< |y#0@0| |x#0@0|)) (=> (< |y#0@0| |x#0@0|) (=> (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (=> (and (and (|_module.__default.Gcd#canCall| |x#0@0| |y#0@0|) (|_module.__default.Gcd#canCall| |y#0@0| (- |x#0@0| |y#0@0|))) (and (= (_module.__default.Gcd reveal__module._default.Gcd |x#0@0| |y#0@0|) (_module.__default.Gcd reveal__module._default.Gcd |y#0@0| (- |x#0@0| |y#0@0|))) (= $Heap@3 $Heap@4))) (and (=> (= (ControlFlow 0 15) (- 0 16)) ($Is intType (int_2_U (- |x#0@0| |y#0@0|)) Tclass._module.pos)) (=> ($Is intType (int_2_U (- |x#0@0| |y#0@0|)) Tclass._module.pos) (=> (and (and (= |x#0@1| (- |x#0@0| |y#0@0|)) (= |x#0@2| |x#0@1|)) (and (= |y#0@2| |y#0@0|) (= (ControlFlow 0 15) 9))) anon9_correct)))))))))))))))
(let ((anon14_Then_correct  (=> (< |x#0@0| |y#0@0|) (and (=> (= (ControlFlow 0 12) (- 0 14)) (< |x#0@0| |y#0@0|)) (=> (< |x#0@0| |y#0@0|) (=> (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (|_module.__default.Gcd#canCall| |y#0@0| |x#0@0|) (|_module.__default.Gcd#canCall| |x#0@0| (- |y#0@0| |x#0@0|)))) (=> (and (and (and (= (_module.__default.Gcd reveal__module._default.Gcd |y#0@0| |x#0@0|) (_module.__default.Gcd reveal__module._default.Gcd |x#0@0| (- |y#0@0| |x#0@0|))) (= $Heap@0 $Heap@1)) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2))) (and (and (|_module.__default.Gcd#canCall| |y#0@0| |x#0@0|) (|_module.__default.Gcd#canCall| |x#0@0| |y#0@0|)) (and (= (_module.__default.Gcd reveal__module._default.Gcd |y#0@0| |x#0@0|) (_module.__default.Gcd reveal__module._default.Gcd |x#0@0| |y#0@0|)) (= $Heap@1 $Heap@2)))) (and (=> (= (ControlFlow 0 12) (- 0 13)) ($Is intType (int_2_U (- |y#0@0| |x#0@0|)) Tclass._module.pos)) (=> ($Is intType (int_2_U (- |y#0@0| |x#0@0|)) Tclass._module.pos) (=> (and (and (= |y#0@1| (- |y#0@0| |x#0@0|)) (= |x#0@2| |x#0@0|)) (and (= |y#0@2| |y#0@1|) (= (ControlFlow 0 12) 9))) anon9_correct))))))))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (= |gcd#0@0| (_module.__default.Gcd reveal__module._default.Gcd |X#0| |Y#0|)))))
(let ((anon10_correct  (=> (and (and (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5)) (|_module.__default.Gcd#canCall| |x#0@0| |x#0@0|)) (and (and (= (_module.__default.Gcd reveal__module._default.Gcd |x#0@0| |x#0@0|) |x#0@0|) (= $Heap@0 $Heap@5)) (and (= |gcd#0@0| |x#0@0|) (= (ControlFlow 0 5) 4)))) GeneratedUnifiedExit_correct)))
(let ((anon15_Else_correct  (=> (and (and (<= |y#0@0| |x#0@0|) (<= |x#0@0| |y#0@0|)) (= (ControlFlow 0 7) 5)) anon10_correct)))
(let ((anon13_Else_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) (= |$decr$loop#00@1| (+ |x#0@0| |y#0@0|))) (and (and (=> (= (ControlFlow 0 19) 12) anon14_Then_correct) (=> (= (ControlFlow 0 19) 15) anon15_Then_correct)) (=> (= (ControlFlow 0 19) 7) anon15_Else_correct)))))
(let ((anon13_Then_correct  (=> (and (not (U_2_bool (Lit boolType (bool_2_U true)))) (= (ControlFlow 0 6) 5)) anon10_correct)))
(let ((anon12_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 20) 6) anon13_Then_correct) (=> (= (ControlFlow 0 20) 19) anon13_Else_correct)))))
(let ((anon12_Then_correct true))
(let ((anon11_LoopBody_correct  (and (=> (= (ControlFlow 0 21) 2) anon12_Then_correct) (=> (= (ControlFlow 0 21) 20) anon12_Else_correct))))
(let ((anon11_LoopDone_correct true))
(let ((anon11_LoopHead_correct  (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (<= (LitInt 1) |x#0@0|)) (=> (and (and (and (<= (LitInt 1) |y#0@0|) (not false)) (and (=> |$w$loop#0@0| (and (|_module.__default.Gcd#canCall| |x#0@0| |y#0@0|) (|_module.__default.Gcd#canCall| |X#0| |Y#0|))) (=> |$w$loop#0@0| (= (_module.__default.Gcd reveal__module._default.Gcd |x#0@0| |y#0@0|) (_module.__default.Gcd reveal__module._default.Gcd |X#0| |Y#0|))))) (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@0)))
 :qid |gcddfy.266:3|
 :skolemid |680|
...
)) (<= (+ |x#0@0| |y#0@0|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 22) 1) anon11_LoopDone_correct) (=> (= (ControlFlow 0 22) 21) anon11_LoopBody_correct))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (= |$decr_init$loop#00@0| (+ |X#0| |Y#0|))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (=> |$w$loop#0@0| (= (_module.__default.Gcd reveal__module._default.Gcd |X#0| |Y#0|) (_module.__default.Gcd reveal__module._default.Gcd |X#0| |Y#0|)))) (=> (=> |$w$loop#0@0| (= (_module.__default.Gcd reveal__module._default.Gcd |X#0| |Y#0|) (_module.__default.Gcd reveal__module._default.Gcd |X#0| |Y#0|))) (=> (= (ControlFlow 0 23) 22) anon11_LoopHead_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (<= (LitInt 1) |X#0|)) (=> (and (and (and (<= (LitInt 1) |Y#0|) (<= (LitInt 1) |gcd#0|)) (and (<= (LitInt 1) |x#0@@10|) true)) (and (and (<= (LitInt 1) |y#0@@3|) true) (and (= 7 $FunctionContextHeight) (= (ControlFlow 0 25) 23)))) anon0_correct))))
