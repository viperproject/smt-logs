...
(set-info :boogie-vc-id Impl$$_module.__default.NoFiniteSetContainsAllPrimes)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_correct  (=> (and (and (and (=> (not (|Set#Equal| |s#0@@2| |Set#Empty|)) (|_module.__default.PickLargest#canCall| |s#0@@2|)) (= |k##0@0| (ite (|Set#Equal| |s#0@@2| |Set#Empty|) 0 (+ (_module.__default.PickLargest reveal__module._default.PickLargest |s#0@@2|) 1)))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (forall ((|p#1| Int) ) (!  (=> (<= |k##0@0| |p#1|) (|_module.__default.IsPrime#canCall| |p#1|))
 :qid |Primesdfy.11:18|
 :skolemid |536|
 :pattern ( (_module.__default.IsPrime |p#1|))
)) (exists ((|p#1@@0| Int) ) (!  (and (<= |k##0@0| |p#1@@0|) (_module.__default.IsPrime |p#1@@0|))
 :qid |Primesdfy.11:18|
 :skolemid |537|
 :pattern ( (_module.__default.IsPrime |p#1@@0|))
))) (and (= $Heap@@1 $Heap@0) (= (ControlFlow 0 2) (- 0 1))))) (exists ((|p#1@@1| Int) ) (!  (and (_module.__default.IsPrime |p#1@@1|) (not (|Set#IsMember| |s#0@@2| ($Box intType (int_2_U |p#1@@1|)))))
 :qid |Primesdfy.26:18|
 :skolemid |550|
 :pattern ( (|Set#IsMember| |s#0@@2| ($Box intType (int_2_U |p#1@@1|))))
 :pattern ( (_module.__default.IsPrime |p#1@@1|))
)))))
(let ((anon4_Else_correct  (=> (and (not (|Set#Equal| |s#0@@2| |Set#Empty|)) ($IsAlloc SetType |s#0@@2| (TSet TInt) $Heap@@1)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (|Set#Equal| |s#0@@2| |Set#Empty|))) (=> (not (|Set#Equal| |s#0@@2| |Set#Empty|)) (=> (and (|_module.__default.PickLargest#canCall| |s#0@@2|) (= (ControlFlow 0 4) 2)) anon3_correct))))))
(let ((anon4_Then_correct  (=> (and (|Set#Equal| |s#0@@2| |Set#Empty|) (= (ControlFlow 0 3) 2)) anon3_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (and (=> (= (ControlFlow 0 6) 3) anon4_Then_correct) (=> (= (ControlFlow 0 6) 4) anon4_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and ($Is SetType |s#0@@2| (TSet TInt)) ($IsAlloc SetType |s#0@@2| (TSet TInt) $Heap@@1)) (and (= 7 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct))))
