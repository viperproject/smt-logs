...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.RightIdentity)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@5 alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@5 $Heap@0)) (and ($IsAlloc DatatypeTypeType |m#0| (Tclass._module.List _module._default.RightIdentity$T) $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= 1 $FunctionContextHeight)) (not true))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@5) ($IsHeapAnchor $Heap@@5)) (=> (and (and (and ($Is DatatypeTypeType |m#0| (Tclass._module.List _module._default.RightIdentity$T)) ($IsAlloc DatatypeTypeType |m#0| (Tclass._module.List _module._default.RightIdentity$T) $Heap@@5)) (|$IsA#_module.List| |m#0|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
