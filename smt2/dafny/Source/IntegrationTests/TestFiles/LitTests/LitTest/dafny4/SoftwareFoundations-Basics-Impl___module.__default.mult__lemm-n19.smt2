...
(set-info :boogie-vc-id Impl$$_module.__default.mult__lemma_split4)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon11_correct  (=> (and (forall ((|a#0_0_0_1| T@U) (|b#0_0_0_1| T@U) ) (!  (=> (and ($Is DatatypeTypeType |a#0_0_0_1| Tclass._module.Nat) ($Is DatatypeTypeType |b#0_0_0_1| Tclass._module.Nat)) (and (|$IsA#_module.Nat| (_module.__default.plus ($LS $LZ) |a#0_0_0_1| (|#_module.Nat.S| |b#0_0_0_1|))) (and (|_module.__default.plus#canCall| |a#0_0_0_1| |b#0_0_0_1|) (|_module.__default.plus#canCall| |a#0_0_0_1| (|#_module.Nat.S| |b#0_0_0_1|)))))
...
)) (= (ControlFlow 0 2) (- 0 1))) (forall ((|a#0_0_0_1@@0| T@U) (|b#0_0_0_1@@0| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |a#0_0_0_1@@0| Tclass._module.Nat) ($Is DatatypeTypeType |b#0_0_0_1@@0| Tclass._module.Nat)) (forall ((|a$ih#0_0_0_0#0_0_0_0| T@U) (|b$ih#0_0_0_0#0_0_0_0| T@U) ) (!  (=> (and ($Is DatatypeTypeType |a$ih#0_0_0_0#0_0_0_0| Tclass._module.Nat) ($Is DatatypeTypeType |b$ih#0_0_0_0#0_0_0_0| Tclass._module.Nat)) (=> (or (< (DtRank |a$ih#0_0_0_0#0_0_0_0|) (DtRank |a#0_0_0_1@@0|)) (and (= (DtRank |a$ih#0_0_0_0#0_0_0_0|) (DtRank |a#0_0_0_1@@0|)) (< (DtRank |b$ih#0_0_0_0#0_0_0_0|) (DtRank |b#0_0_0_1@@0|)))) (|_module.Nat#Equal| (|#_module.Nat.S| (_module.__default.plus ($LS $LZ) |a$ih#0_0_0_0#0_0_0_0| |b$ih#0_0_0_0#0_0_0_0|)) (_module.__default.plus ($LS $LZ) |a$ih#0_0_0_0#0_0_0_0| (|#_module.Nat.S| |b$ih#0_0_0_0#0_0_0_0|)))))
 :qid |SoftwareFoundationsBasicsdfy.290:27|
 :skolemid |703|
 :pattern ( (_module.__default.plus ($LS $LZ) |a$ih#0_0_0_0#0_0_0_0| (|#_module.Nat.S| |b$ih#0_0_0_0#0_0_0_0|)))
 :pattern ( (|#_module.Nat.S| (_module.__default.plus ($LS $LZ) |a$ih#0_0_0_0#0_0_0_0| |b$ih#0_0_0_0#0_0_0_0|)))
))) (and (and true (exists ((|a#0_0_0_3#0#0| T@U) ) (!  (and ($Is DatatypeTypeType |a#0_0_0_3#0#0| Tclass._module.Nat) (= (|#_module.Nat.S| |a#0_0_0_3#0#0|) |a#0_0_0_1@@0|))
 :qid |SoftwareFoundationsBasicsdfy.138:7|
 :skolemid |704|
 :pattern ( (|#_module.Nat.S| |a#0_0_0_3#0#0|))
))) (exists ((|a#0_0_0_5#0#0| T@U) ) (!  (and ($Is DatatypeTypeType |a#0_0_0_5#0#0| Tclass._module.Nat) (= (|#_module.Nat.S| |a#0_0_0_5#0#0|) |b#0_0_0_1@@0|))
 :qid |SoftwareFoundationsBasicsdfy.138:7|
 :skolemid |705|
 :pattern ( (|#_module.Nat.S| |a#0_0_0_5#0#0|))
)))) (|_module.Nat#Equal| (|#_module.Nat.S| (_module.__default.plus ($LS ($LS $LZ)) |a#0_0_0_1@@0| |b#0_0_0_1@@0|)) (_module.__default.plus ($LS ($LS $LZ)) |a#0_0_0_1@@0| (|#_module.Nat.S| |b#0_0_0_1@@0|))))
 :qid |SoftwareFoundationsBasicsdfy.290:27|
 :skolemid |709|
 :pattern ( (_module.__default.plus ($LS ($LS $LZ)) |a#0_0_0_1@@0| (|#_module.Nat.S| |b#0_0_0_1@@0|)))
 :pattern ( (|#_module.Nat.S| (_module.__default.plus ($LS ($LS $LZ)) |a#0_0_0_1@@0| |b#0_0_0_1@@0|)))
)))))
