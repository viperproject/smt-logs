...
(declare-fun |c0'#0_0_0@0| () T@U)
(declare-fun $Heap@0 () T@U)
(declare-fun |c0'#0_0@0| () T@U)
(declare-fun |k#0| () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $Heap () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id Impl$$_module.__default.SeqCasesAreExclusive)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 36) (let ((anon34_Else_correct  (=> (and (and (and (|$IsA#_module.com| |c0#0@@0|) (=> (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|) (and (|$IsA#_module.com| |c'#0@@9|) (|$IsA#_module.com| |c1#0@@0|)))) (forall ((|c0'#0_2| T@U) ) (!  (=> ($Is DatatypeTypeType |c0'#0_2| Tclass._module.com) (and (|$IsA#_module.com| |c'#0@@9|) (=> (|_module.com#Equal| |c'#0@@9| (|#_module.com.Seq| |c0'#0_2| |c1#0@@0|)) (|_module.__default.small__step#canCall| |c0#0@@0| |s#0@@15| |c0'#0_2| |s'#0@@9|))))
 :qid |NipkowKleinchapter7dfy.182:19|
 :skolemid |1044|
 :pattern ( (_module.__default.small__step ($LS $LZ) |c0#0@@0| |s#0@@15| |c0'#0_2| |s'#0@@9|))
 :pattern ( (|#_module.com.Seq| |c0'#0_2| |c1#0@@0|))
))) (and (and (not (and (and (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@9| |c1#0@@0|)) (|Map#Equal| |s'#0@@9| |s#0@@15|))) (not (exists ((|c0'#0_2@@0| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#0_2@@0| Tclass._module.com) (and (|_module.com#Equal| |c'#0@@9| (|#_module.com.Seq| |c0'#0_2@@0| |c1#0@@0|)) (_module.__default.small__step ($LS $LZ) |c0#0@@0| |s#0@@15| |c0'#0_2@@0| |s'#0@@9|)))
 :qid |NipkowKleinchapter7dfy.182:19|
 :skolemid |1045|
 :pattern ( (_module.__default.small__step ($LS $LZ) |c0#0@@0| |s#0@@15| |c0'#0_2@@0| |s'#0@@9|))
 :pattern ( (|#_module.com.Seq| |c0'#0_2@@0| |c1#0@@0|))
)))) (= (ControlFlow 0 6) (- 0 5)))) false)))
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@9| |c1#0@@0|))) (=> (=> (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@9| |c1#0@@0|)) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|) (|Map#Equal| |s'#0@@9| |s#0@@15|)))))))
(let ((anon21_correct  (=> (and (forall ((|c0'#0_2@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |c0'#0_2@@1| Tclass._module.com) (and (|$IsA#_module.com| |c'#0@@9|) (=> (|_module.com#Equal| |c'#0@@9| (|#_module.com.Seq| |c0'#0_2@@1| |c1#0@@0|)) (|_module.__default.small__step#canCall| |c0#0@@0| |s#0@@15| |c0'#0_2@@1| |s'#0@@9|))))
 :qid |NipkowKleinchapter7dfy.182:19|
 :skolemid |1046|
 :pattern ( (_module.__default.small__step ($LS $LZ) |c0#0@@0| |s#0@@15| |c0'#0_2@@1| |s'#0@@9|))
 :pattern ( (|#_module.com.Seq| |c0'#0_2@@1| |c1#0@@0|))
)) (exists ((|c0'#0_2@@2| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#0_2@@2| Tclass._module.com) (and (|_module.com#Equal| |c'#0@@9| (|#_module.com.Seq| |c0'#0_2@@2| |c1#0@@0|)) (_module.__default.small__step ($LS $LZ) |c0#0@@0| |s#0@@15| |c0'#0_2@@2| |s'#0@@9|)))
 :qid |NipkowKleinchapter7dfy.182:19|
 :skolemid |1047|
 :pattern ( (_module.__default.small__step ($LS $LZ) |c0#0@@0| |s#0@@15| |c0'#0_2@@2| |s'#0@@9|))
 :pattern ( (|#_module.com.Seq| |c0'#0_2@@2| |c1#0@@0|))
))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (U_2_bool (Lit boolType (bool_2_U false)))) (=> (U_2_bool (Lit boolType (bool_2_U false))) (=> (= (ControlFlow 0 12) 2) GeneratedUnifiedExit_correct))))))
(let ((anon36_Else_correct  (=> (and (not (|_module.com#Equal| |c'#0@@9| (|#_module.com.Seq| |c0'#0_0_0@0| |c1#0@@0|))) (= (ControlFlow 0 16) 12)) anon21_correct)))
(let ((anon36_Then_correct  (=> (|_module.com#Equal| |c'#0@@9| (|#_module.com.Seq| |c0'#0_0_0@0| |c1#0@@0|)) (=> (and ($IsAlloc DatatypeTypeType |c0#0@@0| Tclass._module.com $Heap@0) ($IsAlloc MapType |s#0@@15| (TMap (TSeq TChar) TInt) $Heap@0)) (=> (and (and ($IsAlloc DatatypeTypeType |c0'#0_0_0@0| Tclass._module.com $Heap@0) ($IsAlloc MapType |s'#0@@9| (TMap (TSeq TChar) TInt) $Heap@0)) (and (|_module.__default.small__step#canCall| |c0#0@@0| |s#0@@15| |c0'#0_0_0@0| |s'#0@@9|) (= (ControlFlow 0 15) 12))) anon21_correct)))))
(let ((anon35_Then_correct  (=> (and ($Is DatatypeTypeType |c0'#0_0_0@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |c0'#0_0_0@0| Tclass._module.com $Heap@0)) (and (=> (= (ControlFlow 0 17) 15) anon36_Then_correct) (=> (= (ControlFlow 0 17) 16) anon36_Else_correct)))))
(let ((anon35_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |c0'#0_0_0@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |c0'#0_0_0@0| Tclass._module.com $Heap@0))) (= (ControlFlow 0 14) 12)) anon21_correct)))
(let ((anon17_correct  (=> (and (|$IsA#_module.com| |c0#0@@0|) (=> (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|) (and (|$IsA#_module.com| |c'#0@@9|) (|$IsA#_module.com| |c1#0@@0|)))) (=> (and (and (and (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@9| |c1#0@@0|)) (|Map#Equal| |s'#0@@9| |s#0@@15|)) (= (ControlFlow 0 7) 2)) GeneratedUnifiedExit_correct))))
(let ((anon33_Else_correct  (=> (and (not (and (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@9| |c1#0@@0|))) (= (ControlFlow 0 9) 7)) anon17_correct)))
(let ((anon33_Then_correct  (=> (and (and (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@9| |c1#0@@0|)) (= (ControlFlow 0 8) 7)) anon17_correct)))
(let ((anon32_Else_correct  (=> (not (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|)) (and (=> (= (ControlFlow 0 11) 8) anon33_Then_correct) (=> (= (ControlFlow 0 11) 9) anon33_Else_correct)))))
(let ((anon32_Then_correct  (=> (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|) (and (=> (= (ControlFlow 0 10) 8) anon33_Then_correct) (=> (= (ControlFlow 0 10) 9) anon33_Else_correct)))))
(let ((anon12_correct  (=> (and (and (|$IsA#_module.com| |c0#0@@0|) (=> (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|) (and (|$IsA#_module.com| |c'#0@@9|) (|$IsA#_module.com| |c1#0@@0|)))) (=> (not (and (and (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@9| |c1#0@@0|)) (|Map#Equal| |s'#0@@9| |s#0@@15|))) (forall ((|c0'#0_1| T@U) ) (!  (=> ($Is DatatypeTypeType |c0'#0_1| Tclass._module.com) (and (|$IsA#_module.com| |c'#0@@9|) (=> (|_module.com#Equal| |c'#0@@9| (|#_module.com.Seq| |c0'#0_1| |c1#0@@0|)) (|_module.__default.small__step#canCall| |c0#0@@0| |s#0@@15| |c0'#0_1| |s'#0@@9|))))
 :qid |NipkowKleinchapter7dfy.178:58|
 :skolemid |1041|
 :pattern ( (_module.__default.small__step ($LS $LZ) |c0#0@@0| |s#0@@15| |c0'#0_1| |s'#0@@9|))
 :pattern ( (|#_module.com.Seq| |c0'#0_1| |c1#0@@0|))
)))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (or (and (and (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@9| |c1#0@@0|)) (|Map#Equal| |s'#0@@9| |s#0@@15|)) (exists ((|c0'#0_1@@0| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#0_1@@0| Tclass._module.com) (and (|_module.com#Equal| |c'#0@@9| (|#_module.com.Seq| |c0'#0_1@@0| |c1#0@@0|)) (_module.__default.small__step ($LS $LZ) |c0#0@@0| |s#0@@15| |c0'#0_1@@0| |s'#0@@9|)))
 :qid |NipkowKleinchapter7dfy.178:58|
 :skolemid |1043|
 :pattern ( (_module.__default.small__step ($LS $LZ) |c0#0@@0| |s#0@@15| |c0'#0_1@@0| |s'#0@@9|))
 :pattern ( (|#_module.com.Seq| |c0'#0_1@@0| |c1#0@@0|))
)))) (=> (or (and (and (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@9| |c1#0@@0|)) (|Map#Equal| |s'#0@@9| |s#0@@15|)) (exists ((|c0'#0_1@@1| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#0_1@@1| Tclass._module.com) (and (|_module.com#Equal| |c'#0@@9| (|#_module.com.Seq| |c0'#0_1@@1| |c1#0@@0|)) (_module.__default.small__step ($LS $LZ) |c0#0@@0| |s#0@@15| |c0'#0_1@@1| |s'#0@@9|)))
 :qid |NipkowKleinchapter7dfy.178:58|
 :skolemid |1043|
 :pattern ( (_module.__default.small__step ($LS $LZ) |c0#0@@0| |s#0@@15| |c0'#0_1@@1| |s'#0@@9|))
 :pattern ( (|#_module.com.Seq| |c0'#0_1@@1| |c1#0@@0|))
))) (and (and (and (and (=> (= (ControlFlow 0 18) 6) anon34_Else_correct) (=> (= (ControlFlow 0 18) 17) anon35_Then_correct)) (=> (= (ControlFlow 0 18) 14) anon35_Else_correct)) (=> (= (ControlFlow 0 18) 10) anon32_Then_correct)) (=> (= (ControlFlow 0 18) 11) anon32_Else_correct)))))))
(let ((anon30_Else_correct  (=> (and (not (|_module.com#Equal| |c'#0@@9| (|#_module.com.Seq| |c0'#0_0@0| |c1#0@@0|))) (= (ControlFlow 0 23) 18)) anon12_correct)))
(let ((anon30_Then_correct  (=> (|_module.com#Equal| |c'#0@@9| (|#_module.com.Seq| |c0'#0_0@0| |c1#0@@0|)) (=> (and ($IsAlloc DatatypeTypeType |c0#0@@0| Tclass._module.com $Heap@0) ($IsAlloc MapType |s#0@@15| (TMap (TSeq TChar) TInt) $Heap@0)) (=> (and (and ($IsAlloc DatatypeTypeType |c0'#0_0@0| Tclass._module.com $Heap@0) ($IsAlloc MapType |s'#0@@9| (TMap (TSeq TChar) TInt) $Heap@0)) (and (|_module.__default.small__step#canCall| |c0#0@@0| |s#0@@15| |c0'#0_0@0| |s'#0@@9|) (= (ControlFlow 0 22) 18))) anon12_correct)))))
(let ((anon29_Then_correct  (=> (and ($Is DatatypeTypeType |c0'#0_0@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |c0'#0_0@0| Tclass._module.com $Heap@0)) (and (=> (= (ControlFlow 0 24) 22) anon30_Then_correct) (=> (= (ControlFlow 0 24) 23) anon30_Else_correct)))))
(let ((anon29_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |c0'#0_0@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |c0'#0_0@0| Tclass._module.com $Heap@0))) (= (ControlFlow 0 21) 18)) anon12_correct)))
(let ((anon28_Then_correct  (=> (not (and (and (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@9| |c1#0@@0|)) (|Map#Equal| |s'#0@@9| |s#0@@15|))) (and (=> (= (ControlFlow 0 25) 24) anon29_Then_correct) (=> (= (ControlFlow 0 25) 21) anon29_Else_correct)))))
(let ((anon28_Else_correct  (=> (and (and (and (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@9| |c1#0@@0|)) (|Map#Equal| |s'#0@@9| |s#0@@15|)) (= (ControlFlow 0 20) 18)) anon12_correct)))
(let ((anon27_Else_correct  (=> (not (and (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@9| |c1#0@@0|))) (and (=> (= (ControlFlow 0 27) 25) anon28_Then_correct) (=> (= (ControlFlow 0 27) 20) anon28_Else_correct)))))
(let ((anon27_Then_correct  (=> (and (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@9| |c1#0@@0|)) (and (=> (= (ControlFlow 0 26) 25) anon28_Then_correct) (=> (= (ControlFlow 0 26) 20) anon28_Else_correct)))))
(let ((anon26_Else_correct  (=> (not (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|)) (and (=> (= (ControlFlow 0 29) 26) anon27_Then_correct) (=> (= (ControlFlow 0 29) 27) anon27_Else_correct)))))
(let ((anon26_Then_correct  (=> (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|) (and (=> (= (ControlFlow 0 28) 26) anon27_Then_correct) (=> (= (ControlFlow 0 28) 27) anon27_Else_correct)))))
(let ((anon25_Then_correct  (=> (and (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|) (= (|ORD#Offset| |k#0|) (LitInt 1))) (and (=> (= (ControlFlow 0 30) 28) anon26_Then_correct) (=> (= (ControlFlow 0 30) 29) anon26_Else_correct)))))
(let ((anon25_Else_correct  (=> (and (not (and (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|) (= (|ORD#Offset| |k#0|) (LitInt 1)))) (= (ControlFlow 0 4) 2)) GeneratedUnifiedExit_correct)))
(let ((anon2_correct  (=> (|$IsA#_module.com| |c0#0@@0|) (and (=> (= (ControlFlow 0 31) 30) anon25_Then_correct) (=> (= (ControlFlow 0 31) 4) anon25_Else_correct)))))
(let ((anon24_Else_correct  (=> (and (not (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|)) (= (ControlFlow 0 33) 31)) anon2_correct)))
(let ((anon24_Then_correct  (=> (and (|_module.com#Equal| |c0#0@@0| |#_module.com.SKIP|) (= (ControlFlow 0 32) 31)) anon2_correct)))
(let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.com| |c0#0@@0|)) (and (|$IsA#_module.com| |c1#0@@0|) (|$IsA#_module.com| |c'#0@@9|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#k0#0| T@U) (|$ih#c00#0| T@U) (|$ih#c10#0| T@U) (|$ih#s0#0| T@U) (|$ih#c'0#0| T@U) (|$ih#s'0#0| T@U) ) (!  (=> (and (and (and (and (and (and ($Is DatatypeTypeType |$ih#c00#0| Tclass._module.com) ($Is DatatypeTypeType |$ih#c10#0| Tclass._module.com)) ($Is MapType |$ih#s0#0| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |$ih#c'0#0| Tclass._module.com)) ($Is MapType |$ih#s'0#0| (TMap (TSeq TChar) TInt))) (and (> (|ORD#Offset| |$ih#k0#0|) 0) (_module.__default.small__step_h ($LS $LZ) |$ih#k0#0| (|#_module.com.Seq| |$ih#c00#0| |$ih#c10#0|) |$ih#s0#0| |$ih#c'0#0| |$ih#s'0#0|))) (or (|ORD#Less| |$ih#k0#0| |k#0|) (and (= |$ih#k0#0| |k#0|) (or (< (DtRank |$ih#c00#0|) (DtRank |c0#0@@0|)) (and (= (DtRank |$ih#c00#0|) (DtRank |c0#0@@0|)) (or (< (DtRank |$ih#c10#0|) (DtRank |c1#0@@0|)) (and (= (DtRank |$ih#c10#0|) (DtRank |c1#0@@0|)) (or (and (|Set#Subset| (|Map#Domain| |$ih#s0#0|) (|Map#Domain| |s#0@@15|)) (not (|Set#Subset| (|Map#Domain| |s#0@@15|) (|Map#Domain| |$ih#s0#0|)))) (and (|Set#Equal| (|Map#Domain| |$ih#s0#0|) (|Map#Domain| |s#0@@15|)) (or (< (DtRank |$ih#c'0#0|) (DtRank |c'#0@@9|)) (and (= (DtRank |$ih#c'0#0|) (DtRank |c'#0@@9|)) (and (|Set#Subset| (|Map#Domain| |$ih#s'0#0|) (|Map#Domain| |s'#0@@9|)) (not (|Set#Subset| (|Map#Domain| |s'#0@@9|) (|Map#Domain| |$ih#s'0#0|))))))))))))))) (=> (|_module.com#Equal| |$ih#c00#0| |#_module.com.SKIP|) (and (|_module.com#Equal| |$ih#c'0#0| |$ih#c10#0|) (|Map#Equal| |$ih#s'0#0| |$ih#s0#0|))))
 :qid |NipkowKleinchapter7dfy.172:28|
 :skolemid |1040|
 :pattern ( (_module.__default.small__step_h ($LS $LZ) |$ih#k0#0| (|#_module.com.Seq| |$ih#c00#0| |$ih#c10#0|) |$ih#s0#0| |$ih#c'0#0| |$ih#s'0#0|))
))))) (and (=> (= (ControlFlow 0 34) (- 0 35)) (or (not (= (|ORD#Offset| |k#0|) 0)) (not true))) (=> (or (not (= (|ORD#Offset| |k#0|) 0)) (not true)) (and (=> (= (ControlFlow 0 34) 32) anon24_Then_correct) (=> (= (ControlFlow 0 34) 33) anon24_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |c0#0@@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |c0#0@@0| Tclass._module.com $Heap)) (|$IsA#_module.com| |c0#0@@0|)) (=> (and (and (and (and (and ($Is DatatypeTypeType |c1#0@@0| Tclass._module.com) ($IsAlloc DatatypeTypeType |c1#0@@0| Tclass._module.com $Heap)) (|$IsA#_module.com| |c1#0@@0|)) (and ($Is MapType |s#0@@15| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |s#0@@15| (TMap (TSeq TChar) TInt) $Heap))) (and (and ($Is DatatypeTypeType |c'#0@@9| Tclass._module.com) ($IsAlloc DatatypeTypeType |c'#0@@9| Tclass._module.com $Heap)) (|$IsA#_module.com| |c'#0@@9|))) (and (and (and ($Is MapType |s'#0@@9| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |s'#0@@9| (TMap (TSeq TChar) TInt) $Heap)) (and (= 6 $FunctionContextHeight) (> (|ORD#Offset| |k#0|) 0))) (and (and (|_module.__default.small__step_h#canCall| |k#0| (|#_module.com.Seq| |c0#0@@0| |c1#0@@0|) |s#0@@15| |c'#0@@9| |s'#0@@9|) (and (_module.__default.small__step_h ($LS $LZ) |k#0| (|#_module.com.Seq| |c0#0@@0| |c1#0@@0|) |s#0@@15| |c'#0@@9| |s'#0@@9|) (and (=> (< 0 (|ORD#Offset| |k#0|)) (ite (_module.com.SKIP_q (|#_module.com.Seq| |c0#0@@0| |c1#0@@0|)) false (ite (_module.com.Assign_q (|#_module.com.Seq| |c0#0@@0| |c1#0@@0|)) (let ((|a#3@@0| (_module.com._h1 (|#_module.com.Seq| |c0#0@@0| |c1#0@@0|))))
(let ((|x#3| (_module.com._h0 (|#_module.com.Seq| |c0#0@@0| |c1#0@@0|))))
 (and (|_module.com#Equal| |c'#0@@9| |#_module.com.SKIP|) (|Map#Equal| |s'#0@@9| (|Map#Build| |s#0@@15| ($Box SeqType |x#3|) ($Box intType (int_2_U (_module.__default.aval ($LS $LZ) |a#3@@0| |s#0@@15|)))))))) (ite (_module.com.Seq_q (|#_module.com.Seq| |c0#0@@0| |c1#0@@0|)) (let ((|c1#4@@0| (_module.com._h3 (|#_module.com.Seq| |c0#0@@0| |c1#0@@0|))))
(let ((|c0#4@@0| (_module.com._h2 (|#_module.com.Seq| |c0#0@@0| |c1#0@@0|))))
 (or (and (and (|_module.com#Equal| |c0#4@@0| |#_module.com.SKIP|) (|_module.com#Equal| |c'#0@@9| |c1#4@@0|)) (|Map#Equal| |s'#0@@9| |s#0@@15|)) (exists ((|c0'#3| T@U) ) (!  (and ($Is DatatypeTypeType |c0'#3| Tclass._module.com) (and (|_module.com#Equal| |c'#0@@9| (|#_module.com.Seq| |c0'#3| |c1#4@@0|)) (_module.__default.small__step_h ($LS $LZ) (|ORD#Minus| |k#0| (|ORD#FromNat| 1)) |c0#4@@0| |s#0@@15| |c0'#3| |s'#0@@9|)))
 :qid |NipkowKleinchapter7dfy.162:12|
 :skolemid |1038|
 :pattern ( (_module.__default.small__step_h ($LS $LZ) (|ORD#Minus| |k#0| (|ORD#FromNat| 1)) |c0#4@@0| |s#0@@15| |c0'#3| |s'#0@@9|))
 :pattern ( (|#_module.com.Seq| |c0'#3| |c1#4@@0|))
))))) (ite (_module.com.If_q (|#_module.com.Seq| |c0#0@@0| |c1#0@@0|)) (let ((|els#3@@0| (_module.com._h6 (|#_module.com.Seq| |c0#0@@0| |c1#0@@0|))))
(let ((|thn#3@@0| (_module.com._h5 (|#_module.com.Seq| |c0#0@@0| |c1#0@@0|))))
(let ((|b#6@@0| (_module.com._h4 (|#_module.com.Seq| |c0#0@@0| |c1#0@@0|))))
 (and (|_module.com#Equal| |c'#0@@9| (ite (_module.__default.bval ($LS $LZ) |b#6@@0| |s#0@@15|) |thn#3@@0| |els#3@@0|)) (|Map#Equal| |s'#0@@9| |s#0@@15|))))) (let ((|body#3| (_module.com._h8 (|#_module.com.Seq| |c0#0@@0| |c1#0@@0|))))
(let ((|b#7| (_module.com._h7 (|#_module.com.Seq| |c0#0@@0| |c1#0@@0|))))
 (and (|_module.com#Equal| |c'#0@@9| (|#_module.com.If| |b#7| (|#_module.com.Seq| |body#3| (|#_module.com.While| |b#7| |body#3|)) (Lit DatatypeTypeType |#_module.com.SKIP|))) (|Map#Equal| |s'#0@@9| |s#0@@15|))))))))) (=> (= (LitInt 0) (|ORD#Offset| |k#0|)) (exists ((|_k'#1@@1| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#1@@1| |k#0|) (_module.__default.small__step_h ($LS $LZ) |_k'#1@@1| (|#_module.com.Seq| |c0#0@@0| |c1#0@@0|) |s#0@@15| |c'#0@@9| |s'#0@@9|))
 :qid |NipkowKleinchapter7dfy.154:17|
 :skolemid |1039|
 :pattern ( (_module.__default.small__step_h ($LS $LZ) |_k'#1@@1| (|#_module.com.Seq| |c0#0@@0| |c1#0@@0|) |s#0@@15| |c'#0@@9| |s'#0@@9|))
)))))) (= (ControlFlow 0 36) 34)))) anon0_correct)))))
