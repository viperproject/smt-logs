...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.ValBelow)
...
(let ((anon22_Else_correct  (=> (and (not (and (and (_module.Val.ValCl_q |u#0@@8|) (_module.Val.ValCl_q |v#0@@8|)) (|_module.LambdaAbs#Equal| (_module.Cl.abs (_module.Val.cl |u#0@@8|)) (_module.Cl.abs (_module.Val.cl |v#0@@8|))))) (= (ControlFlow 0 7) 2)) anon14_correct)))
(let ((anon22_Then_correct  (=> (and (and (_module.Val.ValCl_q |u#0@@8|) (_module.Val.ValCl_q |v#0@@8|)) (|_module.LambdaAbs#Equal| (_module.Cl.abs (_module.Val.cl |u#0@@8|)) (_module.Cl.abs (_module.Val.cl |v#0@@8|)))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (_module.Val.ValCl_q |u#0@@8|)) (=> (_module.Val.ValCl_q |u#0@@8|) (=> (_module.Cl.Closure_q (_module.Val.cl |u#0@@8|)) (=> (and (= |##c#0@0| (_module.Cl.env (_module.Val.cl |u#0@@8|))) ($IsAlloc DatatypeTypeType |##c#0@0| Tclass._module.ClEnv $Heap)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (_module.Val.ValCl_q |v#0@@8|)) (=> (_module.Val.ValCl_q |v#0@@8|) (=> (_module.Cl.Closure_q (_module.Val.cl |v#0@@8|)) (=> (and (and (= |##d#0@0| (_module.Cl.env (_module.Val.cl |v#0@@8|))) ($IsAlloc DatatypeTypeType |##d#0@0| Tclass._module.ClEnv $Heap)) (and (|_module.__default.ClEnvBelow#canCall| (_module.Cl.env (_module.Val.cl |u#0@@8|)) (_module.Cl.env (_module.Val.cl |v#0@@8|))) (= (ControlFlow 0 4) 2))) anon14_correct)))))))))))
(let ((anon21_Else_correct  (=> (not (and (_module.Val.ValCl_q |u#0@@8|) (_module.Val.ValCl_q |v#0@@8|))) (and (=> (= (ControlFlow 0 11) 4) anon22_Then_correct) (=> (= (ControlFlow 0 11) 7) anon22_Else_correct)))))
(let ((anon21_Then_correct  (=> (and (_module.Val.ValCl_q |u#0@@8|) (_module.Val.ValCl_q |v#0@@8|)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (_module.Val.ValCl_q |u#0@@8|)) (=> (_module.Val.ValCl_q |u#0@@8|) (=> (_module.Cl.Closure_q (_module.Val.cl |u#0@@8|)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (_module.Val.ValCl_q |v#0@@8|)) (=> (_module.Val.ValCl_q |v#0@@8|) (=> (_module.Cl.Closure_q (_module.Val.cl |v#0@@8|)) (and (=> (= (ControlFlow 0 8) 4) anon22_Then_correct) (=> (= (ControlFlow 0 8) 7) anon22_Else_correct)))))))))))
(let ((anon20_Else_correct  (=> (not (_module.Val.ValCl_q |u#0@@8|)) (and (=> (= (ControlFlow 0 13) 8) anon21_Then_correct) (=> (= (ControlFlow 0 13) 11) anon21_Else_correct)))))
(let ((anon20_Then_correct  (=> (_module.Val.ValCl_q |u#0@@8|) (and (=> (= (ControlFlow 0 12) 8) anon21_Then_correct) (=> (= (ControlFlow 0 12) 11) anon21_Else_correct)))))
(let ((anon19_Then_correct  (=> (not (and (and (_module.Val.ValConst_q |u#0@@8|) (_module.Val.ValConst_q |v#0@@8|)) (|$Eq#_module.Val| ($LS ($LS $LZ)) |u#0@@8| |v#0@@8|))) (and (=> (= (ControlFlow 0 14) 12) anon20_Then_correct) (=> (= (ControlFlow 0 14) 13) anon20_Else_correct)))))
(let ((anon19_Else_correct  (=> (and (and (and (_module.Val.ValConst_q |u#0@@8|) (_module.Val.ValConst_q |v#0@@8|)) (|$Eq#_module.Val| ($LS ($LS $LZ)) |u#0@@8| |v#0@@8|)) (= (ControlFlow 0 3) 2)) anon14_correct)))
(let ((anon18_Else_correct  (=> (not (and (_module.Val.ValConst_q |u#0@@8|) (_module.Val.ValConst_q |v#0@@8|))) (and (=> (= (ControlFlow 0 16) 14) anon19_Then_correct) (=> (= (ControlFlow 0 16) 3) anon19_Else_correct)))))
(let ((anon18_Then_correct  (=> (and (_module.Val.ValConst_q |u#0@@8|) (_module.Val.ValConst_q |v#0@@8|)) (and (=> (= (ControlFlow 0 15) 14) anon19_Then_correct) (=> (= (ControlFlow 0 15) 3) anon19_Else_correct)))))
(let ((anon17_Else_correct  (=> (not (_module.Val.ValConst_q |u#0@@8|)) (and (=> (= (ControlFlow 0 18) 15) anon18_Then_correct) (=> (= (ControlFlow 0 18) 16) anon18_Else_correct)))))
(let ((anon17_Then_correct  (=> (_module.Val.ValConst_q |u#0@@8|) (and (=> (= (ControlFlow 0 17) 15) anon18_Then_correct) (=> (= (ControlFlow 0 17) 16) anon18_Else_correct)))))
(let ((anon16_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 19) 1) anon16_Then_correct) (=> (= (ControlFlow 0 19) 17) anon17_Then_correct)) (=> (= (ControlFlow 0 19) 18) anon17_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |u#0@@8| Tclass._module.Val) ($Is DatatypeTypeType |v#0@@8| Tclass._module.Val)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 20) 19))) anon0_correct))))
