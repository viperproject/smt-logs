...
(declare-fun _module.T.f (T@U Int) Int)
(declare-fun |_module.T.f#canCall| (T@U Int) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this T@U) (|x#0| Int) ) (!  (=> (or (|_module.T.f#canCall| this |x#0|) (and (< 1 $FunctionContextHeight) (and (and (or (not (= this null)) (not true)) ($Is refType this Tclass._module.T)) (<= (LitInt 0) |x#0|)))) (and (< (_module.T.f this |x#0|) (+ 10 |x#0|)) (<= (LitInt 0) (_module.T.f this |x#0|))))
 :qid |gitissue245dfy.11:12|
 :skolemid |485|
 :pattern ( (_module.T.f this |x#0|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.T.f)
