...
(assert (distinct TagSet alloc Tagclass._module.Node? Tagclass._module.Node tytagFamily$Node)
)
...
(set-info :boogie-vc-id Impl$$_module.__default.DisplayCorrected)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |a#0@0| (|Set#UnionOne| |Set#Empty| ($Box refType |p#0|)))) (and (= |b#0@0| (|Set#Union| |s#0| |a#0@0|)) (= (ControlFlow 0 2) (- 0 1)))) ($Is SetType |b#0@0| (TSet Tclass._module.Node)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |p#0| Tclass._module.Node?) ($IsAlloc refType |p#0| Tclass._module.Node? $Heap)) (and ($Is SetType |s#0| (TSet Tclass._module.Node)) ($IsAlloc SetType |s#0| (TSet Tclass._module.Node) $Heap))) (and (and ($Is SetType |a#0| (TSet Tclass._module.Node?)) ($IsAlloc SetType |a#0| (TSet Tclass._module.Node?) $Heap)) true)) (=> (and (and (and (and ($Is SetType |b#0| (TSet Tclass._module.Node?)) ($IsAlloc SetType |b#0| (TSet Tclass._module.Node?) $Heap)) true) (= 1 $FunctionContextHeight)) (and (or (not (= |p#0| null)) (not true)) (= (ControlFlow 0 3) 2))) anon0_correct)))))
