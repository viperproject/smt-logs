...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |r#0@0| (LitReal (- 0.0 3.0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (q@Real (q@Int |r#0@0|)) |r#0@0|)) (=> (= (q@Real (q@Int |r#0@0|)) |r#0@0|) (=> (= (ControlFlow 0 2) (- 0 1)) (and (<= 0 (q@Int |r#0@0|)) (< (q@Int |r#0@0|) 256))))))))
