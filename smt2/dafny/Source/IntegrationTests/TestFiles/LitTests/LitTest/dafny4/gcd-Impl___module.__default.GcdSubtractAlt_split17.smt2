...
(set-info :boogie-vc-id Impl$$_module.__default.GcdSubtractAlt_split17)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon17_correct  (=> (and (or (and ($Is intType (int_2_U (LitInt 1)) Tclass._module.pos) (= (Mul |q#2_0@0| (LitInt 1)) |x#0@@10|)) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._module.pos) (= (Mul |q#2_0@0| (LitInt 0)) |x#0@@10|)) (exists ((|$as#a2_0#2_0| Int) ) (!  (and (<= (LitInt 1) |$as#a2_0#2_0|) (= (Mul |q#2_0@0| |$as#a2_0#2_0|) |x#0@@10|))
 :qid |gcddfy.244:9|
 :skolemid |669|
)))) (<= (LitInt 1) |a#2_0@0|)) (=> (and (and (= (Mul |q#2_0@0| |a#2_0@0|) |x#0@@10|) (<= (LitInt 1) |b#2_1@0|)) (and (= |newtype$check#2_1@0| (Mul |q#2_0@0| |b#2_1@0|)) (= (ControlFlow 0 2) (- 0 1)))) (<= (LitInt 1) |newtype$check#2_1@0|)))))
