...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|p#0@@0| Int) (|x#0@@4| Int) ) (!  (=> (or (|_module.__default.IsFactor#canCall| |p#0@@0| |x#0@@4|) (and (< 1 $FunctionContextHeight) (and (<= (LitInt 1) |p#0@@0|) (<= (LitInt 1) |x#0@@4|)))) (= (_module.__default.IsFactor |p#0@@0| |x#0@@4|) (exists ((|q#0| Int) ) (! (= (Mul |p#0@@0| |q#0|) |x#0@@4|)
 :qid |gcddfy.8:10|
 :skolemid |530|
 ...
 :qid |gcddfy.7:26|
 :skolemid |531|
 :pattern ( (_module.__default.IsFactor |p#0@@0| |x#0@@4|))
))))
(assert (forall ((|x#0@@5| T@U) ) (! (= ($Is intType |x#0@@5| Tclass._module.pos) (<= (LitInt 1) (U_2_int |x#0@@5|)))
 :qid |unknown.0:0|
 :skolemid |701|
 :pattern ( ($Is intType |x#0@@5| Tclass._module.pos))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap T@U) (|s#0| T@U) ) (!  (=> (or (|_module.__default.Max#canCall| |s#0|) (and (< 3 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) ($Is SetType |s#0| (TSet Tclass._module.pos))) (not (|Set#Equal| |s#0| |Set#Empty|))))) (and (|$let#0$canCall| |s#0|) (= (_module.__default.Max |s#0|) (let ((|x#0@@6| (|$let#0_x| |s#0|)))
|x#0@@6|))))
 :qid |gcddfy.42:16|
 :skolemid |559|
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|x#0@@7| Int) (|y#0@@1| Int) ) (!  (=> (or (|_module.__default.Gcd#canCall| (LitInt |x#0@@7|) (LitInt |y#0@@1|)) (and (< 4 $FunctionContextHeight) (and (<= (LitInt 1) |x#0@@7|) (<= (LitInt 1) |y#0@@1|)))) (and (and (and (|_module.__default.Factors#canCall| (LitInt |x#0@@7|)) (|_module.__default.Factors#canCall| (LitInt |y#0@@1|))) (let ((|common#1| (|Set#Intersection| (_module.__default.Factors (LitInt |x#0@@7|)) (_module.__default.Factors (LitInt |y#0@@1|)))))
(|_module.__default.Max#canCall| |common#1|))) (= (_module.__default.Gcd true (LitInt |x#0@@7|) (LitInt |y#0@@1|)) (let ((|common#1@@0| (|Set#Intersection| (_module.__default.Factors (LitInt |x#0@@7|)) (_module.__default.Factors (LitInt |y#0@@1|)))))
(_module.__default.Max |common#1@@0|)))))
 :qid |gcddfy.74:27|
 :weight 3
 :skolemid |586|
 :pattern ( (_module.__default.Gcd true (LitInt |x#0@@7|) (LitInt |y#0@@1|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|x#0@@8| Int) ) (!  (=> (or (|_module.__default.Factors#canCall| |x#0@@8|) (and (< 2 $FunctionContextHeight) (<= (LitInt 1) |x#0@@8|))) (and (forall ((|p#0@@1| Int) ) (!  (=> (<= (LitInt 1) |p#0@@1|) (=> (<= |p#0@@1| |x#0@@8|) (|_module.__default.IsFactor#canCall| |p#0@@1| |x#0@@8|)))
 :qid |gcddfy.19:7|
 :skolemid |544|
 :pattern ( (_module.__default.IsFactor |p#0@@1| |x#0@@8|))
)) (= (_module.__default.Factors |x#0@@8|) (|Set#FromBoogieMap| (|lambda#1| Tclass._module.pos |x#0@@8| |x#0@@8|)))))
 :qid |gcddfy.18:24|
 :skolemid |545|
 :pattern ( (_module.__default.Factors |x#0@@8|))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.IsFactorGcdFirst)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@1 $Heap@0)) (and (and reveal__module._default.Gcd (= (ControlFlow 0 2) (- 0 1))) (|_module.__default.IsFactor#canCall| (_module.__default.Gcd reveal__module._default.Gcd |x#0@@9| |y#0@@3|) |x#0@@9|))) (or (_module.__default.IsFactor (_module.__default.Gcd reveal__module._default.Gcd |x#0@@9| |y#0@@3|) |x#0@@9|) (exists ((|q#1@@0| Int) ) (! (= (Mul (_module.__default.Gcd reveal__module._default.Gcd |x#0@@9| |y#0@@3|) |q#1@@0|) |x#0@@9|)
 :qid |gcddfy.8:10|
 :skolemid |594|
 :pattern ( (Mul (_module.__default.Gcd reveal__module._default.Gcd |x#0@@9| |y#0@@3|) |q#1@@0|))
)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (<= (LitInt 1) |x#0@@9|) (<= (LitInt 1) |y#0@@3|)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
