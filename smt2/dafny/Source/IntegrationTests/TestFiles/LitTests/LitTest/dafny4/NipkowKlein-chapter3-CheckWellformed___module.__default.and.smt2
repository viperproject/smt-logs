...
(declare-fun |b0#0@@2| () T@U)
(declare-fun |b1#0@@2| () T@U)
...
(let ((anon14_Then_correct  (=> (_module.bexp.Bc_q |b0#0@@2|) (and (=> (= (ControlFlow 0 10) (- 0 11)) (_module.bexp.Bc_q |b0#0@@2|)) (=> (_module.bexp.Bc_q |b0#0@@2|) (and (=> (= (ControlFlow 0 10) 8) anon15_Then_correct) (=> (= (ControlFlow 0 10) 9) anon15_Else_correct)))))))
(let ((anon17_Else_correct true))
(let ((anon17_Then_correct true))
(let ((anon16_Then_correct  (=> (_module.bexp.Bc_q |b1#0@@2|) (and (=> (= (ControlFlow 0 5) (- 0 6)) (_module.bexp.Bc_q |b1#0@@2|)) (=> (_module.bexp.Bc_q |b1#0@@2|) (and (=> (= (ControlFlow 0 5) 3) anon17_Then_correct) (=> (= (ControlFlow 0 5) 4) anon17_Else_correct)))))))
(let ((anon16_Else_correct true))
(let ((anon14_Else_correct  (=> (not (_module.bexp.Bc_q |b0#0@@2|)) (and (=> (= (ControlFlow 0 7) 5) anon16_Then_correct) (=> (= (ControlFlow 0 7) 2) anon16_Else_correct)))))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 12) 1) anon13_Then_correct) (=> (= (ControlFlow 0 12) 10) anon14_Then_correct)) (=> (= (ControlFlow 0 12) 7) anon14_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |b0#0@@2| Tclass._module.bexp) ($Is DatatypeTypeType |b1#0@@2| Tclass._module.bexp)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 13) 12))) anon0_correct))))
