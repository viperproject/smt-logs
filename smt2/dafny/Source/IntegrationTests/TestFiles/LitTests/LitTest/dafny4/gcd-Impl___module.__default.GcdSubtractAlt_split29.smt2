...
(declare-fun |newtype$check#0_0_1_0@0| () Int)
(declare-fun |newtype$check#0_0_1_1@0| () Int)
(declare-fun |a#0_0@0| () Int)
(declare-fun |newtype$check#0_0_1_2@0| () Int)
...
(declare-fun $Heap@1 () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.GcdSubtractAlt_split29)
...
(assert (not
 ...
 :qid |gcddfy.228:9|
 :skolemid |662|
)))) (=> (and (and (and (<= (LitInt 1) |b#0_0@0|) (= (Mul |p#0@0| |b#0_0@0|) |y#0@@3|)) (and (= |newtype$check#0_0_1_0@0| (Mul |p#0@0| |b#0_0@0|)) (<= (LitInt 1) |newtype$check#0_0_1_0@0|))) (and (and (= |newtype$check#0_0_1_1@0| (Mul |p#0@0| |a#0_0@0|)) (<= (LitInt 1) |newtype$check#0_0_1_1@0|)) (and (= |newtype$check#0_0_1_2@0| (- (Mul |p#0@0| |b#0_0@0|) (Mul |p#0@0| |a#0_0@0|))) (= (ControlFlow 0 2) (- 0 1))))) (<= (LitInt 1) |newtype$check#0_0_1_2@0|)))))
