...
(assert  (and (and (and (= (Ctor MapType) 4) (forall ((t0 T@T) (t1 T@T) (val T@U) (m T@U) (x0 T@U) ) (! (= (MapType0Select t0 t1 (MapType0Store t0 t1 m x0 val) x0) val)
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.TestMPost)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (= |##m#0@0| (Lit MapType (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 5))) ($Box intType (int_2_U (LitInt 6)))))))) (and (and ($IsAlloc MapType |##m#0@0| (TMap TInt TInt) $Heap@0) (= |##a#0@0| (LitInt 5))) (and ($IsAlloc intType (int_2_U |##a#0@0|) TInt $Heap@0) (= (ControlFlow 0 2) (- 0 1))))) (|Set#IsMember| (|Map#Domain| |##m#0@0|) ($Box intType (int_2_U |##a#0@0|)))))))
