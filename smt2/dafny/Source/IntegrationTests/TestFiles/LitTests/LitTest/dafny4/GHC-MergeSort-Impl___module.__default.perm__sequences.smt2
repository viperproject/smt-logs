...
(declare-fun $Heap@@2 () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.perm__sequences)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (|MultiSet#Equal| (_module.__default.MultisetUnion Tclass._module.G ($LS ($LS $LZ)) (_module.__default.sequences ($LS ($LS $LZ)) |xs#0@@28|)) (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |xs#0@@28|)))))
(let ((anon10_Then_correct  (=> (= |ys#0_0@0| (|#_module.List.Cons| |_mcc#2#0_0_0@0| |_mcc#3#0_0_0@0|)) (=> (and ($IsBox |_mcc#2#0_0_0@0| Tclass._module.G) ($Is DatatypeTypeType |_mcc#3#0_0_0@0| (Tclass._module.List Tclass._module.G))) (=> (and (and ($Is DatatypeTypeType |zs#0_0_0@0| (Tclass._module.List Tclass._module.G)) ($IsAlloc DatatypeTypeType |zs#0_0_0@0| (Tclass._module.List Tclass._module.G) $Heap@0)) (= |let#0_0_0#0#0| |_mcc#3#0_0_0@0|)) (=> (and (and (and ($Is DatatypeTypeType |let#0_0_0#0#0| (Tclass._module.List Tclass._module.G)) (= |zs#0_0_0@0| |let#0_0_0#0#0|)) (and ($IsBox |b#0_0_0@0| Tclass._module.G) ($IsAllocBox |b#0_0_0@0| Tclass._module.G $Heap@0))) (and (and (= |let#0_0_1#0#0| |_mcc#2#0_0_0@0|) ($IsBox |let#0_0_1#0#0| Tclass._module.G)) (and (= |b#0_0_0@0| |let#0_0_1#0#0|) (= |xs##0_0_0@0| (|#_module.List.Cons| |a#0_0@0| (Lit DatatypeTypeType |#_module.List.Nil|)))))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (< (DtRank |zs#0_0_0@0|) (DtRank |xs#0@@28|))) (=> (< (DtRank |zs#0_0_0@0|) (DtRank |xs#0@@28|)) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and (and (|_module.__default.descending#canCall| |b#0_0_0@0| |xs##0_0_0@0| |zs#0_0_0@0|) (|_module.__default.MultisetUnion#canCall| Tclass._module.G (_module.__default.descending ($LS $LZ) |b#0_0_0@0| |xs##0_0_0@0| |zs#0_0_0@0|))) (and (|_module.__default.multiset__of#canCall| Tclass._module.G |xs##0_0_0@0|) (|_module.__default.multiset__of#canCall| Tclass._module.G |zs#0_0_0@0|))) (|MultiSet#Equal| (_module.__default.MultisetUnion Tclass._module.G ($LS ($LS $LZ)) (_module.__default.descending ($LS ($LS $LZ)) |b#0_0_0@0| |xs##0_0_0@0| |zs#0_0_0@0|)) (|MultiSet#Union| (|MultiSet#Union| (|MultiSet#UnionOne| |MultiSet#Empty| |b#0_0_0@0|) (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |xs##0_0_0@0|)) (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |zs#0_0_0@0|)))) (and (= $Heap@0 $Heap@1) (= |xs##0_0_1@0| (|#_module.List.Cons| |a#0_0@0| (Lit DatatypeTypeType |#_module.List.Nil|))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (< (DtRank |zs#0_0_0@0|) (DtRank |xs#0@@28|))) (=> (< (DtRank |zs#0_0_0@0|) (DtRank |xs#0@@28|)) (=> (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (=> (and (and (and (and (|_module.__default.ascending#canCall| |b#0_0_0@0| |xs##0_0_1@0| |zs#0_0_0@0|) (|_module.__default.MultisetUnion#canCall| Tclass._module.G (_module.__default.ascending ($LS $LZ) |b#0_0_0@0| |xs##0_0_1@0| |zs#0_0_0@0|))) (and (|_module.__default.multiset__of#canCall| Tclass._module.G |xs##0_0_1@0|) (|_module.__default.multiset__of#canCall| Tclass._module.G |zs#0_0_0@0|))) (|MultiSet#Equal| (_module.__default.MultisetUnion Tclass._module.G ($LS ($LS $LZ)) (_module.__default.ascending ($LS ($LS $LZ)) |b#0_0_0@0| |xs##0_0_1@0| |zs#0_0_0@0|)) (|MultiSet#Union| (|MultiSet#Union| (|MultiSet#UnionOne| |MultiSet#Empty| |b#0_0_0@0|) (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |xs##0_0_1@0|)) (_module.__default.multiset__of Tclass._module.G ($LS ($LS $LZ)) |zs#0_0_0@0|)))) (and (= $Heap@1 $Heap@2) (= (ControlFlow 0 7) 4))) GeneratedUnifiedExit_correct))))))))))))))
(let ((anon9_Then_correct  (=> (and (= |ys#0_0@0| |#_module.List.Nil|) (= (ControlFlow 0 6) 4)) GeneratedUnifiedExit_correct)))
(let ((anon7_Then_correct  (=> (and (= |xs#0@@28| |#_module.List.Nil|) (= (ControlFlow 0 5) 4)) GeneratedUnifiedExit_correct)))
(let ((anon10_Else_correct true))
(let ((anon9_Else_correct  (=> (or (not (= |ys#0_0@0| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 10) 7) anon10_Then_correct) (=> (= (ControlFlow 0 10) 2) anon10_Else_correct)))))
(let ((anon8_Then_correct  (=> (= |xs#0@@28| (|#_module.List.Cons| |_mcc#0#0_0@0| |_mcc#1#0_0@0|)) (=> (and ($IsBox |_mcc#0#0_0@0| Tclass._module.G) ($Is DatatypeTypeType |_mcc#1#0_0@0| (Tclass._module.List Tclass._module.G))) (=> (and (and (and (and ($Is DatatypeTypeType |ys#0_0@0| (Tclass._module.List Tclass._module.G)) ($IsAlloc DatatypeTypeType |ys#0_0@0| (Tclass._module.List Tclass._module.G) $Heap@0)) (= |let#0_0#0#0| |_mcc#1#0_0@0|)) (and ($Is DatatypeTypeType |let#0_0#0#0| (Tclass._module.List Tclass._module.G)) (= |ys#0_0@0| |let#0_0#0#0|))) (and (and (and ($IsBox |a#0_0@0| Tclass._module.G) ($IsAllocBox |a#0_0@0| Tclass._module.G $Heap@0)) (= |let#0_1#0#0| |_mcc#0#0_0@0|)) (and ($IsBox |let#0_1#0#0| Tclass._module.G) (= |a#0_0@0| |let#0_1#0#0|)))) (and (=> (= (ControlFlow 0 11) 6) anon9_Then_correct) (=> (= (ControlFlow 0 11) 10) anon9_Else_correct)))))))
(let ((anon8_Else_correct true))
(let ((anon7_Else_correct  (=> (or (not (= |xs#0@@28| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 12) 11) anon8_Then_correct) (=> (= (ControlFlow 0 12) 1) anon8_Else_correct)))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (|$IsA#_module.List| |xs#0@@28|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@2 $Heap@0) (forall ((|$ih#xs0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#xs0#0| (Tclass._module.List Tclass._module.G)) (U_2_bool (Lit boolType (bool_2_U true)))) (or (< (DtRank |$ih#xs0#0|) (DtRank |xs#0@@28|)) (and (= (DtRank |$ih#xs0#0|) (DtRank |xs#0@@28|)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (LitInt 0)))))) (|MultiSet#Equal| (_module.__default.MultisetUnion Tclass._module.G ($LS $LZ) (_module.__default.sequences ($LS $LZ) |$ih#xs0#0|)) (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |$ih#xs0#0|)))
 :qid |GHCMergeSortdfy.191:22|
 :skolemid |766|
 :pattern ( (_module.__default.multiset__of Tclass._module.G ($LS $LZ) |$ih#xs0#0|))
 :pattern ( (_module.__default.sequences ($LS $LZ) |$ih#xs0#0|))
)))) (and (=> (= (ControlFlow 0 13) 5) anon7_Then_correct) (=> (= (ControlFlow 0 13) 12) anon7_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (and ($Is DatatypeTypeType |xs#0@@28| (Tclass._module.List Tclass._module.G)) ($IsAlloc DatatypeTypeType |xs#0@@28| (Tclass._module.List Tclass._module.G) $Heap@@2)) (|$IsA#_module.List| |xs#0@@28|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct))))
