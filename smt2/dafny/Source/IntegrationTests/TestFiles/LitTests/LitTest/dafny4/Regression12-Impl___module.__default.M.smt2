...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (not (|Set#IsMember| (|Map#Domain| |m#0|) ($Box refType null)))) (=> (not (|Set#IsMember| (|Map#Domain| |m#0|) ($Box refType null))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (not (|Set#IsMember| |s#0| ($Box refType null)))) (=> (not (|Set#IsMember| |s#0| ($Box refType null))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (|Set#IsMember| (|Map#Domain| |m#0|) ($Box refType null)))) (=> (not (|Set#IsMember| (|Map#Domain| |m#0|) ($Box refType null))) (=> (= (ControlFlow 0 2) (- 0 1)) (not (|Set#IsMember| (|Map#Values| |m#0|) ($Box refType null)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is MapType |m#0| (TMap Tclass._module.MyClass Tclass._module.MyClass)) ($IsAlloc MapType |m#0| (TMap Tclass._module.MyClass Tclass._module.MyClass) $Heap))) (and (and ($Is SetType |s#0| (TSet Tclass._module.MyClass)) ($IsAlloc SetType |s#0| (TSet Tclass._module.MyClass) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 2)))) anon0_correct)))
