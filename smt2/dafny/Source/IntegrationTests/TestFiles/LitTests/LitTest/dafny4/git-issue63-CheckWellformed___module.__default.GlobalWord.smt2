...
(declare-fun _module.__default.GlobalWord (T@U T@U) Int)
(declare-fun Lit (T@T T@U) T@U)
(declare-fun MapType () T@T)
(declare-fun SeqType () T@T)
(declare-fun |_module.__default.GlobalWord#canCall| (T@U T@U) Bool)
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|gm#0| T@U) (|g#0| T@U) ) (!  (=> (or (|_module.__default.GlobalWord#canCall| (Lit MapType |gm#0|) (Lit SeqType |g#0|)) (and (< 2 $FunctionContextHeight) (and (and ($Is MapType |gm#0| (TMap (TSeq TChar) (TSeq TInt))) ($Is SeqType |g#0| (TSeq TChar))) (and (_module.__default.ValidGlobalStateOpaque reveal__module._default.ValidGlobalStateOpaque (Lit MapType |gm#0|)) (_module.__default.ValidGlobal (Lit SeqType |g#0|)))))) (= (_module.__default.GlobalWord (Lit MapType |gm#0|) (Lit SeqType |g#0|)) (U_2_int ($Unbox intType (|Seq#Index| ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType |gm#0|)) ($Box SeqType (Lit SeqType |g#0|)))) (LitInt 0))))))
 :qid |gitissue63dfy.13:27|
 :weight 3
 :skolemid |598|
 :pattern ( (_module.__default.GlobalWord (Lit MapType |gm#0|) (Lit SeqType |g#0|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|gm#0@@0| T@U) (|g#0@@0| T@U) ) (!  (=> (or (|_module.__default.GlobalWord#canCall| |gm#0@@0| |g#0@@0|) (and (< 2 $FunctionContextHeight) (and (and ($Is MapType |gm#0@@0| (TMap (TSeq TChar) (TSeq TInt))) ($Is SeqType |g#0@@0| (TSeq TChar))) (and (_module.__default.ValidGlobalStateOpaque reveal__module._default.ValidGlobalStateOpaque |gm#0@@0|) (_module.__default.ValidGlobal |g#0@@0|))))) (= (_module.__default.GlobalWord |gm#0@@0| |g#0@@0|) (U_2_int ($Unbox intType (|Seq#Index| ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| |gm#0@@0|) ($Box SeqType |g#0@@0|))) (LitInt 0))))))
 :qid |gitissue63dfy.13:27|
 :skolemid |597|
 :pattern ( (_module.__default.GlobalWord |gm#0@@0| |g#0@@0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|globals#0| T@U) ) (!  (=> (or (|_module.__default.ValidGlobalStateOpaque#canCall| |globals#0|) (and (< 1 $FunctionContextHeight) ($Is MapType |globals#0| (TMap (TSeq TChar) (TSeq TInt))))) (and (forall ((|g#0@@1| T@U) ) (!  (=> ($Is SeqType |g#0@@1| (TSeq TChar)) (|_module.__default.ValidGlobal#canCall| |g#0@@1|))
 :qid |gitissue63dfy.10:12|
 :skolemid |586|
 :pattern ( ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| |globals#0|) ($Box SeqType |g#0@@1|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| |globals#0|) ($Box SeqType |g#0@@1|)))
 :pattern ( (_module.__default.ValidGlobal |g#0@@1|))
)) (= (_module.__default.ValidGlobalStateOpaque true |globals#0|) (forall ((|g#0@@2| T@U) ) (!  (=> ($Is SeqType |g#0@@2| (TSeq TChar)) (= (_module.__default.ValidGlobal |g#0@@2|)  (and (|Set#IsMember| (|Map#Domain| |globals#0|) ($Box SeqType |g#0@@2|)) (= (|Seq#Length| ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| |globals#0|) ($Box SeqType |g#0@@2|)))) (LitInt 1)))))
 :qid |gitissue63dfy.10:12|
 :skolemid |585|
 :pattern ( ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| |globals#0|) ($Box SeqType |g#0@@2|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| |globals#0|) ($Box SeqType |g#0@@2|)))
 :pattern ( (_module.__default.ValidGlobal |g#0@@2|))
)))))
 :qid |gitissue63dfy.8:50|
 :skolemid |587|
...
(assert (forall ((bx@@4 T@U) (s@@0 T@U) (t@@8 T@U) ) (!  (=> ($IsBox bx@@4 (TMap s@@0 t@@8)) (and (= ($Box MapType ($Unbox MapType bx@@4)) bx@@4) ($Is MapType ($Unbox MapType bx@@4) (TMap s@@0 t@@8))))
 :qid |DafnyPreludebpl.207:15|
 :skolemid |36|
 :pattern ( ($IsBox bx@@4 (TMap s@@0 t@@8)))
)))
...
(declare-fun |gm#0@@1| () T@U)
(declare-fun |g#0@@3| () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun null () T@U)
(set-info :boogie-vc-id CheckWellformed$$_module.__default.GlobalWord)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct  (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) reveal__module._default.ValidGlobalStateOpaque)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (|Set#IsMember| (|Map#Domain| |gm#0@@1|) ($Box SeqType |g#0@@3|))) (=> (|Set#IsMember| (|Map#Domain| |gm#0@@1|) ($Box SeqType |g#0@@3|)) (=> (= (ControlFlow 0 3) (- 0 2)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| |gm#0@@1|) ($Box SeqType |g#0@@3|))))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and ($IsAlloc MapType |gm#0@@1| (TMap (TSeq TChar) (TSeq TInt)) $Heap) (|_module.__default.ValidGlobalStateOpaque#canCall| |gm#0@@1|)) (=> (and (and (_module.__default.ValidGlobalStateOpaque reveal__module._default.ValidGlobalStateOpaque |gm#0@@1|) ($IsAlloc SeqType |g#0@@3| (TSeq TChar) $Heap)) (and (|_module.__default.ValidGlobal#canCall| |g#0@@3|) (_module.__default.ValidGlobal |g#0@@3|))) (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 3) anon5_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is MapType |gm#0@@1| (TMap (TSeq TChar) (TSeq TInt))) ($Is SeqType |g#0@@3| (TSeq TChar))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 6) 5))) anon0_correct))))
