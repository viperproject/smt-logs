...
(declare-fun A.__default.F (Int) Bool)
...
(assert (forall ((|x#0| Int) ) (! (= (A.__default.F |x#0|) (U_2_bool (Lit boolType (bool_2_U true))))
 :qid |gitissue235dfy.5:21|
 :skolemid |966|
 :pattern ( (A.__default.F |x#0|))
)))
...
(declare-fun |A.__default.F#canCall| (Int) Bool)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|A.__default.F#canCall| |x#0@@0|)) (or (A.__default.F |x#0@@0|) (U_2_bool (Lit boolType (bool_2_U true)))))))
