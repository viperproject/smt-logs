...
(declare-fun |newtype$check#0_0_0_0@0| () Int)
(declare-fun |newtype$check#0_0_0_1@0| () Int)
(declare-fun |a#0_0@0| () Int)
(declare-fun |newtype$check#0_0_0_2@0| () Int)
(declare-fun |newtype$check#0_0_0_3@0| () Int)
(declare-fun |newtype$check#0_0_0_4@0| () Int)
(declare-fun |b#0_1@0| () Int)
(declare-fun |newtype$check#0_1@0| () Int)
(declare-fun |x#0@@10| () Int)
(declare-fun |a#0_1@0| () Int)
...
(declare-fun |common#0@@1| () T@U)
(declare-fun |a#2_0| () Int)
(declare-fun |b#2_0| () Int)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $Heap@0 () T@U)
(declare-fun reveal__module._default.Gcd () Bool)
(declare-fun $Heap@1 () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.GcdSubtractAlt_split26)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_correct  (=> (and (or (and ($Is intType (int_2_U (LitInt 1)) Tclass._module.pos) (= (Mul |p#0@0| (LitInt 1)) |y#0@@3|)) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._module.pos) (= (Mul |p#0@0| (LitInt 0)) |y#0@@3|)) (exists ((|$as#b0_0#0_0| Int) ) (!  (and (<= (LitInt 1) |$as#b0_0#0_0|) (= (Mul |p#0@0| |$as#b0_0#0_0|) |y#0@@3|))
 :qid |gcddfy.228:9|
 :skolemid |662|
)))) (<= (LitInt 1) |b#0_0@0|)) (=> (and (and (= (Mul |p#0@0| |b#0_0@0|) |y#0@@3|) (= |newtype$check#0_0_0_0@0| (Mul |p#0@0| |b#0_0@0|))) (and (<= (LitInt 1) |newtype$check#0_0_0_0@0|) (= |newtype$check#0_0_0_1@0| (Mul |p#0@0| |a#0_0@0|)))) (=> (and (and (and (<= (LitInt 1) |newtype$check#0_0_0_1@0|) (= |newtype$check#0_0_0_2@0| (- (Mul |p#0@0| |b#0_0@0|) (Mul |p#0@0| |a#0_0@0|)))) (and (<= (LitInt 1) |newtype$check#0_0_0_2@0|) (= |newtype$check#0_0_0_3@0| (- |b#0_0@0| |a#0_0@0|)))) (and (and (<= (LitInt 1) |newtype$check#0_0_0_3@0|) (= |newtype$check#0_0_0_4@0| (Mul |p#0@0| (- |b#0_0@0| |a#0_0@0|)))) (and (<= (LitInt 1) |newtype$check#0_0_0_4@0|) (= (ControlFlow 0 2) (- 0 1))))) (= (- (Mul |p#0@0| |b#0_0@0|) (Mul |p#0@0| |a#0_0@0|)) (Mul |p#0@0| (- |b#0_0@0| |a#0_0@0|))))))))
(let ((anon33_Else_correct  (=> (and (< |b#0_1@0| (LitInt 1)) (= (ControlFlow 0 4) 2)) anon5_correct)))
(let ((anon33_Then_correct  (=> (and (and (<= (LitInt 1) |b#0_1@0|) (= |newtype$check#0_1@0| (Mul |p#0@0| |b#0_1@0|))) (and (<= (LitInt 1) |newtype$check#0_1@0|) (= (ControlFlow 0 3) 2))) anon5_correct)))
(let ((anon3_correct  (=> (or (and ($Is intType (int_2_U (LitInt 1)) Tclass._module.pos) (= (Mul |p#0@0| (LitInt 1)) |x#0@@10|)) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._module.pos) (= (Mul |p#0@0| (LitInt 0)) |x#0@@10|)) (exists ((|$as#a0_0#0_0| Int) ) (!  (and (<= (LitInt 1) |$as#a0_0#0_0|) (= (Mul |p#0@0| |$as#a0_0#0_0|) |x#0@@10|))
 :qid |gcddfy.227:9|
 :skolemid |661|
)))) (=> (and (<= (LitInt 1) |a#0_0@0|) (= (Mul |p#0@0| |a#0_0@0|) |x#0@@10|)) (and (=> (= (ControlFlow 0 5) 3) anon33_Then_correct) (=> (= (ControlFlow 0 5) 4) anon33_Else_correct))))))
(let ((anon32_Else_correct  (=> (and (< |a#0_1@0| (LitInt 1)) (= (ControlFlow 0 7) 5)) anon3_correct)))
(let ((anon32_Then_correct  (=> (and (and (<= (LitInt 1) |a#0_1@0|) (= |newtype$check#0_0@0| (Mul |p#0@0| |a#0_1@0|))) (and (<= (LitInt 1) |newtype$check#0_0@0|) (= (ControlFlow 0 6) 5))) anon3_correct)))
(let ((anon0_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (and (<= (LitInt 1) |x#0@@10|) (<= (LitInt 1) |y#0@@3|)) (and (<= (LitInt 1) |p#0@@2|) true)) (and (and (<= (LitInt 1) |a#0_0|) true) (and (<= (LitInt 1) |b#0_0|) true))) (=> (and (and (and (and (and ($Is SetType |common#0@@1| (TSet Tclass._module.pos)) ($IsAlloc SetType |common#0@@1| (TSet Tclass._module.pos) $Heap@@1)) true) (and (<= (LitInt 1) |a#2_0|) true)) (and (and (and (<= (LitInt 1) |b#2_0|) true) (= 6 $FunctionContextHeight)) (and (and (< |x#0@@10| |y#0@@3|) (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))))) (and (and (and (and (|_module.__default.Gcd#canCall| |x#0@@10| |y#0@@3|) (|_module.__default.Gcd#canCall| |y#0@@3| |x#0@@10|)) (= (_module.__default.Gcd reveal__module._default.Gcd |x#0@@10| |y#0@@3|) (_module.__default.Gcd reveal__module._default.Gcd |y#0@@3| |x#0@@10|))) (and (= $Heap@@1 $Heap@0) ($IsAlloc intType (int_2_U |x#0@@10|) Tclass._module.pos $Heap@0))) (and (and (and ($IsAlloc intType (int_2_U |y#0@@3|) Tclass._module.pos $Heap@0) (|_module.__default.Gcd#canCall| |x#0@@10| |y#0@@3|)) (and (|_module.__default.Gcd#canCall| |x#0@@10| |y#0@@3|) (= |p#0@0| (_module.__default.Gcd reveal__module._default.Gcd |x#0@@10| |y#0@@3|)))) (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (= $Heap@0 $Heap@1) reveal__module._default.Gcd))))) (and (=> (= (ControlFlow 0 8) 6) anon32_Then_correct) (=> (= (ControlFlow 0 8) 7) anon32_Else_correct)))))))
anon0_correct))))))))
))
(check-sat)
(get-info :rlimit)
