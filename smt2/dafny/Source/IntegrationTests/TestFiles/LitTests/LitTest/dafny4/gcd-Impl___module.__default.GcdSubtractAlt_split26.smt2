...
(let ((anon3_correct  (=> (or (and ($Is intType (int_2_U (LitInt 1)) Tclass._module.pos) (= (Mul |p#0@0| (LitInt 1)) |x#0@@10|)) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._module.pos) (= (Mul |p#0@0| (LitInt 0)) |x#0@@10|)) (exists ((|$as#a0_0#0_0| Int) )  (and (<= (LitInt 1) |$as#a0_0#0_0|) (= (Mul |p#0@0| |$as#a0_0#0_0|) |x#0@@10|))))) (=> (and (<= (LitInt 1) |a#0_0@0|) (= (Mul |p#0@0| |a#0_0@0|) |x#0@@10|)) (and (=> (= (ControlFlow 0 5) 3) anon33_Then_correct) (=> (= (ControlFlow 0 5) 4) anon33_Else_correct))))))
