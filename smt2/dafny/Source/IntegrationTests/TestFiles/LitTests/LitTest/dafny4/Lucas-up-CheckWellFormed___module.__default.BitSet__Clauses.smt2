...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.BitSet__Clauses)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($Is intType (int_2_U (Mul (LitInt 2) |n#0@@5|)) Tclass._System.nat)) (=> ($Is intType (int_2_U (Mul (LitInt 2) |n#0@@5|)) Tclass._System.nat) (=> (= |##n#0@0| (Mul (LitInt 2) |n#0@@5|)) (=> (and (and (and ($IsAlloc intType (int_2_U |##n#0@0|) Tclass._System.nat $Heap@0) (|_module.__default.BitSet#canCall| (Mul (LitInt 2) |n#0@@5|))) (and ($IsAlloc intType (int_2_U |n#0@@5|) Tclass._System.nat $Heap@0) (|_module.__default.BitSet#canCall| |n#0@@5|))) (and (and (= |##S#0@0| (_module.__default.BitSet |n#0@@5|)) ($IsAlloc SetType |##S#0@0| (TSet Tclass._System.nat) $Heap@0)) (and (|_module.__default.Suc#canCall| (_module.__default.BitSet |n#0@@5|)) (|Set#Equal| (_module.__default.BitSet (Mul (LitInt 2) |n#0@@5|)) (_module.__default.Suc (_module.__default.BitSet |n#0@@5|)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($Is intType (int_2_U (+ (Mul (LitInt 2) |n#0@@5|) 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ (Mul (LitInt 2) |n#0@@5|) 1)) Tclass._System.nat) (=> (and (and (= |##n#2@0| (+ (Mul (LitInt 2) |n#0@@5|) 1)) ($IsAlloc intType (int_2_U |##n#2@0|) Tclass._System.nat $Heap@0)) (and (|_module.__default.BitSet#canCall| (+ (Mul (LitInt 2) |n#0@@5|) 1)) (= (ControlFlow 0 2) (- 0 1)))) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat))))))))))))
