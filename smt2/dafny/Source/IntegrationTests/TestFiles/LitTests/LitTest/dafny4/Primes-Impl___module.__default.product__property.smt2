...
(set-info :boogie-vc-id Impl$$_module.__default.product__property)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 1) (_module.__default.product ($LS ($LS $LZ)) reveal__module._default.product |s#0@@5|))) (=> (<= (LitInt 1) (_module.__default.product ($LS ($LS $LZ)) reveal__module._default.product |s#0@@5|)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|x#3| Int) ) (!  (=> (|Set#IsMember| |s#0@@5| ($Box intType (int_2_U |x#3|))) (<= |x#3| (_module.__default.product ($LS ($LS $LZ)) reveal__module._default.product |s#0@@5|)))
 :qid |Primesdfy.67:37|
 :skolemid |609|
 :pattern ( (|Set#IsMember| |s#0@@5| ($Box intType (int_2_U |x#3|))))
)))))))
(let ((anon3_Else_correct  (=> (and (|Set#Equal| |s#0@@5| |Set#Empty|) (= (ControlFlow 0 11) 2)) GeneratedUnifiedExit_correct)))
(let ((anon3_Then_correct  (=> (and (not (|Set#Equal| |s#0@@5| |Set#Empty|)) ($IsAlloc SetType |s#0@@5| (TSet TInt) $Heap@1)) (and (=> (= (ControlFlow 0 4) (- 0 10)) (not (|Set#Equal| |s#0@@5| |Set#Empty|))) (=> (not (|Set#Equal| |s#0@@5| |Set#Empty|)) (=> (and (and (|_module.__default.PickLargest#canCall| |s#0@@5|) (|_module.__default.PickLargest#canCall| |s#0@@5|)) (and (= |a#0_0@0| (_module.__default.PickLargest reveal__module._default.PickLargest |s#0@@5|)) (= |s'#0_0@0| (|Set#Difference| |s#0@@5| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U |a#0_0@0|))))))) (and (=> (= (ControlFlow 0 4) (- 0 9)) (|Set#Equal| |s#0@@5| (|Set#Union| |s'#0_0@0| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U |a#0_0@0|)))))) (=> (|Set#Equal| |s#0@@5| (|Set#Union| |s'#0_0@0| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U |a#0_0@0|))))) (and (=> (= (ControlFlow 0 4) (- 0 8)) (and (|Set#Subset| |s'#0_0@0| |s#0@@5|) (not (|Set#Subset| |s#0@@5| |s'#0_0@0|)))) (=> (and (|Set#Subset| |s'#0_0@0| |s#0@@5|) (not (|Set#Subset| |s#0@@5| |s'#0_0@0|))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (forall ((|x#1@@0| Int) ) (!  (=> (|Set#IsMember| |s'#0_0@0| ($Box intType (int_2_U |x#1@@0|))) (<= (LitInt 1) |x#1@@0|))
 :qid |Primesdfy.66:19|
 :skolemid |603|
 :pattern ( (|Set#IsMember| |s'#0_0@0| ($Box intType (int_2_U |x#1@@0|))))
))) (=> (forall ((|x#1@@1| T@U) ) (!  (=> (|Set#IsMember| |s'#0_0@0| ($Box intType |x#1@@1|)) (<= (LitInt 1) (U_2_int |x#1@@1|)))
 :qid |Primesdfy.66:19|
 :skolemid |603|
 :pattern ( (|Set#IsMember| |s'#0_0@0| ($Box intType |x#1@@1|)))
)) (=> (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (=> (and (and (and (and (|_module.__default.product#canCall| |s'#0_0@0|) (=> (<= (LitInt 1) (_module.__default.product ($LS $LZ) reveal__module._default.product |s'#0_0@0|)) (forall ((|x#3@@0| T@U) ) (!  (=> (|Set#IsMember| |s'#0_0@0| ($Box intType |x#3@@0|)) (|_module.__default.product#canCall| |s'#0_0@0|))
 :qid |Primesdfy.67:37|
 :skolemid |604|
 :pattern ( (|Set#IsMember| |s'#0_0@0| ($Box intType |x#3@@0|)))
)))) (<= (LitInt 1) (_module.__default.product ($LS ($LS $LZ)) reveal__module._default.product |s'#0_0@0|))) (and (forall ((|x#3@@1| T@U) ) (!  (=> (|Set#IsMember| |s'#0_0@0| ($Box intType |x#3@@1|)) (<= (U_2_int |x#3@@1|) (_module.__default.product ($LS $LZ) reveal__module._default.product |s'#0_0@0|)))
 :qid |Primesdfy.67:37|
 :skolemid |606|
 :pattern ( (|Set#IsMember| |s'#0_0@0| ($Box intType |x#3@@1|)))
)) (= $Heap@1 $Heap@2))) (and (and ($IsAlloc SetType |s'#0_0@0| (TSet TInt) $Heap@2) (|_module.__default.product#canCall| |s'#0_0@0|)) (and (|_module.__default.product#canCall| |s'#0_0@0|) (= |b##0_0@0| (_module.__default.product ($LS $LZ) reveal__module._default.product |s'#0_0@0|))))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (<= (LitInt 1) |a#0_0@0|)) (=> (<= (LitInt 1) |a#0_0@0|) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= (LitInt 1) |b##0_0@0|)) (=> (<= (LitInt 1) |b##0_0@0|) (=> (and (and (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (<= |a#0_0@0| (Mul |a#0_0@0| |b##0_0@0|))) (and (= $Heap@2 $Heap@3) (= (ControlFlow 0 4) 2))) GeneratedUnifiedExit_correct)))))))))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@1 $Heap@0) (forall ((|$ih#s0#0| T@U) ) (!  (=> (and (and ($Is SetType |$ih#s0#0| (TSet TInt)) (forall ((|x#4| Int) ) (!  (=> (|Set#IsMember| |$ih#s0#0| ($Box intType (int_2_U |x#4|))) (<= (LitInt 1) |x#4|))
 :qid |Primesdfy.66:19|
 :skolemid |611|
 :pattern ( (|Set#IsMember| |$ih#s0#0| ($Box intType (int_2_U |x#4|))))
))) (and (|Set#Subset| |$ih#s0#0| |s#0@@5|) (not (|Set#Subset| |s#0@@5| |$ih#s0#0|)))) (and (<= (LitInt 1) (_module.__default.product ($LS $LZ) reveal__module._default.product |$ih#s0#0|)) (forall ((|x#5| T@U) ) (!  (=> (|Set#IsMember| |$ih#s0#0| ($Box intType |x#5|)) (<= (U_2_int |x#5|) (_module.__default.product ($LS $LZ) reveal__module._default.product |$ih#s0#0|)))
 :qid |Primesdfy.67:37|
 :skolemid |612|
 :pattern ( (|Set#IsMember| |$ih#s0#0| ($Box intType |x#5|)))
))))
 :qid |Primesdfy.65:24|
 :skolemid |613|
 :pattern ( (_module.__default.product ($LS $LZ) reveal__module._default.product |$ih#s0#0|))
)))) (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (= $Heap@0 $Heap@1) reveal__module._default.product))) (and (=> (= (ControlFlow 0 12) 4) anon3_Then_correct) (=> (= (ControlFlow 0 12) 11) anon3_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and ($Is SetType |s#0@@5| (TSet TInt)) ($IsAlloc SetType |s#0@@5| (TSet TInt) $Heap@@1))) (=> (and (and (and (and ($Is SetType |s'#0_0| (TSet TInt)) ($IsAlloc SetType |s'#0_0| (TSet TInt) $Heap@@1)) true) (= 3 $FunctionContextHeight)) (and (forall ((|x#1@@2| T@U) ) (!  (=> (|Set#IsMember| |s#0@@5| ($Box intType |x#1@@2|)) (<= (LitInt 1) (U_2_int |x#1@@2|)))
 :qid |Primesdfy.66:19|
 :skolemid |607|
 :pattern ( (|Set#IsMember| |s#0@@5| ($Box intType |x#1@@2|)))
