...
(let ((anon29_correct  (and (=> (= (ControlFlow 0 47) (- 0 49)) (or (and ($Is intType (int_2_U (- |c#0| 1)) TInt) (and (and (<= (LitInt 2) (- |c#0| 1)) (< (- |c#0| 1) |c#0|)) (= (Mod |c#0| (- |c#0| 1)) (LitInt 0)))) (or (and ($Is intType (int_2_U (LitInt 2)) TInt) (and (and (<= (LitInt 2) (LitInt 2)) (< 2 |c#0|)) (= (Mod |c#0| (LitInt 2)) (LitInt 0)))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (and (and (<= (LitInt 2) (LitInt 0)) (< 0 |c#0|)) (= (Mod |c#0| (LitInt 0)) (LitInt 0)))) (exists ((|$as#a0#0| Int) )  (and (and (<= (LitInt 2) |$as#a0#0|) (< |$as#a0#0| |c#0|)) (= (Mod |c#0| |$as#a0#0|) (LitInt 0)))))))) (=> (or (and ($Is intType (int_2_U (- |c#0| 1)) TInt) (and (and (<= (LitInt 2) (- |c#0| 1)) (< (- |c#0| 1) |c#0|)) (= (Mod |c#0| (- |c#0| 1)) (LitInt 0)))) (or (and ($Is intType (int_2_U (LitInt 2)) TInt) (and (and (<= (LitInt 2) (LitInt 2)) (< 2 |c#0|)) (= (Mod |c#0| (LitInt 2)) (LitInt 0)))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (and (and (<= (LitInt 2) (LitInt 0)) (< 0 |c#0|)) (= (Mod |c#0| (LitInt 0)) (LitInt 0)))) (exists ((|$as#a0#0@@0| Int) )  (and (and (<= (LitInt 2) |$as#a0#0@@0|) (< |$as#a0#0@@0| |c#0|)) (= (Mod |c#0| |$as#a0#0@@0|) (LitInt 0))))))) (=> (and (and (<= (LitInt 2) |a#0@0|) (< |a#0@0| |c#0|)) (= (Mod |c#0| |a#0@0|) (LitInt 0))) (and (=> (= (ControlFlow 0 47) (- 0 48)) (or (not (= |a#0@0| 0)) (not true))) (=> (or (not (= |a#0@0| 0)) (not true)) (=> (= |b#0@0| (Div |c#0| |a#0@0|)) (and (=> (= (ControlFlow 0 47) 45) anon57_Then_correct) (=> (= (ControlFlow 0 47) 46) anon57_Else_correct))))))))))
