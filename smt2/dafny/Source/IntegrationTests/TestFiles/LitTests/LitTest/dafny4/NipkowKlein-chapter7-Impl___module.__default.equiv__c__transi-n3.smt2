...
(set-info :boogie-vc-id Impl$$_module.__default.equiv__c__transitive)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (and (_module.__default.equiv__c |c#0@@11| |c'#0@@1|) (_module.__default.equiv__c |c'#0@@1| |c''#0|))) (|_module.__default.equiv__c#canCall| |c#0@@11| |c''#0|)) (or (_module.__default.equiv__c |c#0@@11| |c''#0|) (forall ((|s#1@@1| T@U) (|t#1@@1| T@U) ) (!  (=> (and ($Is MapType |s#1@@1| (TMap (TSeq TChar) TInt)) ($Is MapType |t#1@@1| (TMap (TSeq TChar) TInt))) (= (_module.__default.big__step ($LS ($LS $LZ)) |c#0@@11| |s#1@@1| |t#1@@1|) (_module.__default.big__step ($LS ($LS $LZ)) |c''#0| |s#1@@1| |t#1@@1|)))
 :qid |NipkowKleinchapter7dfy.84:10|
 :skolemid |930|
 :pattern ( (_module.__default.big__step ($LS ($LS $LZ)) |c''#0| |s#1@@1| |t#1@@1|))
 :pattern ( (_module.__default.big__step ($LS ($LS $LZ)) |c#0@@11| |s#1@@1| |t#1@@1|))
))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |c#0@@11| Tclass._module.com) ($IsAlloc DatatypeTypeType |c#0@@11| Tclass._module.com $Heap)) (|$IsA#_module.com| |c#0@@11|)) (and (and ($Is DatatypeTypeType |c'#0@@1| Tclass._module.com) ($IsAlloc DatatypeTypeType |c'#0@@1| Tclass._module.com $Heap)) (|$IsA#_module.com| |c'#0@@1|))) (and (and (and ($Is DatatypeTypeType |c''#0| Tclass._module.com) ($IsAlloc DatatypeTypeType |c''#0| Tclass._module.com $Heap)) (|$IsA#_module.com| |c''#0|)) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct))))
