...
(assert (forall ((this T@U) ) (!  (=> (or (|M.C.f#canCall| this) (and (or (not (= this null)) (not true)) ($Is refType this Tclass.M.C))) (= (M.C.f this) (LitInt 0)))
 :qid |gitissue257dfy.10:20|
 :skolemid |1019|
 :pattern ( (M.C.f this))
)))
(assert (forall ((this@@0 T@U) ) (!  (=> (or (|M.C.f#canCall| this@@0) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass.M.C))) (<= (LitInt 0) (M.C.f this@@0)))
 :qid |gitissue257dfy.10:20|
 :skolemid |1017|
...
(assert (forall ((this@@1 T@U) ) (!  (=> (or (|M.C.f#canCall| (Lit refType this@@1)) (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 Tclass.M.C))) (= (M.C.f (Lit refType this@@1)) (LitInt 0)))
 :qid |gitissue257dfy.10:20|
 :weight 3
 :skolemid |1020|
 :pattern ( (M.C.f (Lit refType this@@1)))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.Test3)
...
)) ($HeapSucc $Heap $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= call1formal@this@0 null)) (not true))) (=> (and (and ($IsAllocBox ($Box refType call1formal@this@0) Tclass.M.C? $Heap@0) (|M.C.f#canCall| call1formal@this@0)) (and (|M.C.f#canCall| call1formal@this@0) (= (ControlFlow 0 2) (- 0 1)))) (= (M.C.f call1formal@this@0) (LitInt 0)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (=> |defass#c#0| (and ($Is refType |c#0@@3| Tclass.M.C) ($IsAlloc refType |c#0@@3| Tclass.M.C $Heap))) true)) (and (and (=> |defass#g#0| (and ($Is refType |g#0| Tclass.M.T) ($IsAlloc refType |g#0| Tclass.M.T $Heap))) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 6) 2)))) anon0_correct)))
