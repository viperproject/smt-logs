...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Symmetry)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (> |a#0@@7| 0) (> |b#0@@3| 0)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@1 $Heap@0)) (and ($IsAlloc intType (int_2_U |a#0@@7|) TInt $Heap@0) ($IsAlloc intType (int_2_U |b#0@@3|) TInt $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (> |a#0@@7| 0)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (> |b#0@@3| 0)) (=> (and (and (and (> |a#0@@7| 0) (> |b#0@@3| 0)) (|_module.__default.Gcd#canCall| |a#0@@7| |b#0@@3|)) (and ($IsAlloc intType (int_2_U |b#0@@3|) TInt $Heap@0) ($IsAlloc intType (int_2_U |a#0@@7|) TInt $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (> |b#0@@3| 0)) (=> (= (ControlFlow 0 2) (- 0 1)) (> |a#0@@7| 0)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 6) 2))) anon0_correct)))
