...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.DividesBoth)
...
(let ((anon11_Else_correct  (=> (and (not (and (> |d#0@@5| 0) (_module.__default.Divides reveal__module._default.Divides |d#0@@5| |a#0@@5|))) (= (ControlFlow 0 6) 2)) anon7_correct)))
(let ((anon11_Then_correct  (=> (and (and (> |d#0@@5| 0) (_module.__default.Divides reveal__module._default.Divides |d#0@@5| |a#0@@5|)) (and ($IsAlloc intType (int_2_U |d#0@@5|) TInt $Heap) ($IsAlloc intType (int_2_U |b#0@@1|) TInt $Heap))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (> |d#0@@5| 0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (> |b#0@@1| 0)) (=> (and (and (> |d#0@@5| 0) (> |b#0@@1| 0)) (and (|_module.__default.Divides#canCall| |d#0@@5| |b#0@@1|) (= (ControlFlow 0 3) 2))) anon7_correct))))))
(let ((anon10_Else_correct  (=> (>= 0 |d#0@@5|) (and (=> (= (ControlFlow 0 10) 3) anon11_Then_correct) (=> (= (ControlFlow 0 10) 6) anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (> |d#0@@5| 0) (=> (and ($IsAlloc intType (int_2_U |d#0@@5|) TInt $Heap) ($IsAlloc intType (int_2_U |a#0@@5|) TInt $Heap)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (> |d#0@@5| 0)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (> |a#0@@5| 0)) (=> (and (and (> |d#0@@5| 0) (> |a#0@@5| 0)) (|_module.__default.Divides#canCall| |d#0@@5| |a#0@@5|)) (and (=> (= (ControlFlow 0 7) 3) anon11_Then_correct) (=> (= (ControlFlow 0 7) 6) anon11_Else_correct)))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (> |a#0@@5| 0) (> |b#0@@1| 0)) (and (and (=> (= (ControlFlow 0 11) 1) anon9_Then_correct) (=> (= (ControlFlow 0 11) 7) anon10_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon10_Else_correct))))))
