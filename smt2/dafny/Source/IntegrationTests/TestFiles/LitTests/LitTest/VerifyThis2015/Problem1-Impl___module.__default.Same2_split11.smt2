...
(set-info :boogie-vc-id Impl$$_module.__default.Same2_split11)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon38_Then_correct  (=> (and (and (<= (LitInt 0) (LitInt 0)) (< 0 (|Seq#Length| |pat#0@@4|))) (= (ControlFlow 0 2) (- 0 1))) (and (<= 0 (LitInt 0)) (<= (LitInt 0) (|Seq#Length| |pat#0@@4|))))))
