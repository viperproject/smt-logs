...
(set-info :boogie-vc-id Impl$$_module.__default.Same2_split15)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon4_correct  (=> (and (and (and (not (|Seq#Equal| |a#0@@4| |Seq#Empty|)) (= (|Seq#Index| |pat#0@@4| (LitInt 0)) (|Seq#Index| |a#0@@4| (LitInt 0)))) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |pat#0@@4|)))) (and (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |a#0@@4|))) (and (not (and (<= (|Seq#Length| (|Seq#Drop| |pat#0@@4| (LitInt 1))) (|Seq#Length| (|Seq#Drop| |a#0@@4| (LitInt 1)))) (|Seq#SameUntil| (|Seq#Drop| |pat#0@@4| (LitInt 1)) (|Seq#Drop| |a#0@@4| (LitInt 1)) (|Seq#Length| (|Seq#Drop| |pat#0@@4| (LitInt 1)))))) (= (ControlFlow 0 2) (- 0 1))))) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |a#0@@4|))))))
