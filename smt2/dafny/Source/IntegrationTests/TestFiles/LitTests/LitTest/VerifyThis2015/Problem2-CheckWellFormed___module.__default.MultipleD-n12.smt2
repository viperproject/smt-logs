...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.MultipleDivides)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (> |n#0@@3| 0)) (and (> |d#0@@3| 0) (= (Mul |n#0@@3| |d#0@@3|) |a#0@@3|))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and ($IsAlloc intType (int_2_U |d#0@@3|) TInt $Heap@0) ($IsAlloc intType (int_2_U |a#0@@3|) TInt $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (> |d#0@@3| 0)) (=> (= (ControlFlow 0 2) (- 0 1)) (> |a#0@@3| 0)))))))
