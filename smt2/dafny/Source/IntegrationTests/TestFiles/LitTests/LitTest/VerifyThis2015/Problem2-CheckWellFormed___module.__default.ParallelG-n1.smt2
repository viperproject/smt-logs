...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.ParallelGcd__ReadAB__WithoutTermination)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (and (and (> |A#0| 0) (> |B#0| 0)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@0)))
 :qid |Problem2dfy.37:8|
 :skolemid |652|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0))
)) ($HeapSucc $Heap@@1 $Heap@0)) (and ($IsAlloc intType (int_2_U |A#0|) TInt $Heap@0) ($IsAlloc intType (int_2_U |B#0|) TInt $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (> |A#0| 0)) (=> (= (ControlFlow 0 2) (- 0 1)) (> |B#0| 0)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (= 7 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct)))
