...
(declare-fun |pat#0| () T@U)
(declare-fun _module._default.Same2$T () T@U)
(declare-fun |a#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun null () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Same2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SeqType |pat#0| (TSeq _module._default.Same2$T)) ($IsAlloc SeqType |pat#0| (TSeq _module._default.Same2$T) $Heap))) (=> (and (and (and ($Is SeqType |a#0| (TSeq _module._default.Same2$T)) ($IsAlloc SeqType |a#0| (TSeq _module._default.Same2$T) $Heap)) (= 2 $FunctionContextHeight)) (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) ($IsAlloc SeqType |pat#0| (TSeq _module._default.Same2$T) $Heap)) (and ($IsAlloc SeqType |a#0| (TSeq _module._default.Same2$T) $Heap) (= (ControlFlow 0 2) (- 0 1))))) ($Is intType (int_2_U (LitInt 1)) Tclass._System.nat)))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
