...
(set-info :boogie-vc-id Impl$$_module.__default.Same2_split57)
...
)) (not (|Seq#Equal| |pat#0@@4| |Seq#Empty|))) (and (not (|Seq#Equal| |a#0@@4| |Seq#Empty|)) (= (ControlFlow 0 2) (- 0 1)))))) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |pat#0@@4|))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
