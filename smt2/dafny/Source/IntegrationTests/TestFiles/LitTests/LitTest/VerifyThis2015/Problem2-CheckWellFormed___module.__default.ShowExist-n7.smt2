...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.ShowExists)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 9) 6))) anon0_correct)))
