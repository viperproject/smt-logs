...
(declare-fun _module._default.Prefix$T () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and (<= (|Seq#Length| |pat#0@@2|) (|Seq#Length| |a#0@@2|)) (|Seq#SameUntil| |pat#0@@2| |a#0@@2| (|Seq#Length| |pat#0@@2|))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (= $Heap $Heap@0) ($IsAlloc SeqType |pat#0@@2| (TSeq _module._default.Prefix$T) $Heap@0)) (and ($IsAlloc SeqType |a#0@@2| (TSeq _module._default.Prefix$T) $Heap@0) (= (ControlFlow 0 2) (- 0 1))))) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SeqType |pat#0@@2| (TSeq _module._default.Prefix$T)) ($IsAlloc SeqType |pat#0@@2| (TSeq _module._default.Prefix$T) $Heap))) (and (and ($Is SeqType |a#0@@2| (TSeq _module._default.Prefix$T)) ($IsAlloc SeqType |a#0@@2| (TSeq _module._default.Prefix$T) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
