...
(set-info :boogie-vc-id Impl$$_module.__default.Prefix)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#pat0#0| T@U) (|$ih#a0#0| T@U) ) (!  (=> (and (and (and ($Is SeqType |$ih#pat0#0| (TSeq _module._default.Prefix$T)) ($Is SeqType |$ih#a0#0| (TSeq _module._default.Prefix$T))) (and (<= (|Seq#Length| |$ih#pat0#0|) (|Seq#Length| |$ih#a0#0|)) (|Seq#SameUntil| |$ih#pat0#0| |$ih#a0#0| (|Seq#Length| |$ih#pat0#0|)))) (or (< (|Seq#Rank| |$ih#pat0#0|) (|Seq#Rank| |pat#0@@2|)) (and (= (|Seq#Rank| |$ih#pat0#0|) (|Seq#Rank| |pat#0@@2|)) (< (|Seq#Rank| |$ih#a0#0|) (|Seq#Rank| |a#0@@2|))))) (_module.__default.IsRelaxedPrefixAux _module._default.Prefix$T ($LS $LZ) |$ih#pat0#0| |$ih#a0#0| (LitInt 0)))
 :qid |Problem1dfy.154:17|
 :skolemid |628|
 :pattern ( (_module.__default.IsRelaxedPrefixAux _module._default.Prefix$T ($LS $LZ) |$ih#pat0#0| |$ih#a0#0| (LitInt 0)))
)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.__default.IsRelaxedPrefixAux#canCall| _module._default.Prefix$T |pat#0@@2| |a#0@@2| (LitInt 0)) (or (_module.__default.IsRelaxedPrefixAux _module._default.Prefix$T ($LS $LZ) |pat#0@@2| |a#0@@2| (LitInt 0)) (=> (|Seq#Equal| |pat#0@@2| |Seq#Empty|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (|_module.__default.IsRelaxedPrefixAux#canCall| _module._default.Prefix$T |pat#0@@2| |a#0@@2| (LitInt 0)) (or (_module.__default.IsRelaxedPrefixAux _module._default.Prefix$T ($LS $LZ) |pat#0@@2| |a#0@@2| (LitInt 0)) (=> (|Seq#Equal| |pat#0@@2| |Seq#Empty|) (U_2_bool (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.__default.IsRelaxedPrefixAux#canCall| _module._default.Prefix$T |pat#0@@2| |a#0@@2| (LitInt 0)) (or (_module.__default.IsRelaxedPrefixAux _module._default.Prefix$T ($LS $LZ) |pat#0@@2| |a#0@@2| (LitInt 0)) (=> (not (|Seq#Equal| |pat#0@@2| |Seq#Empty|)) (=> (and (not (|Seq#Equal| |a#0@@2| |Seq#Empty|)) (= (|Seq#Index| |pat#0@@2| (LitInt 0)) (|Seq#Index| |a#0@@2| (LitInt 0)))) (_module.__default.IsRelaxedPrefixAux _module._default.Prefix$T ($LS ($LS $LZ)) (|Seq#Drop| |pat#0@@2| (LitInt 1)) (|Seq#Drop| |a#0@@2| (LitInt 1)) (LitInt 0))))))) (=> (=> (|_module.__default.IsRelaxedPrefixAux#canCall| _module._default.Prefix$T |pat#0@@2| |a#0@@2| (LitInt 0)) (or (_module.__default.IsRelaxedPrefixAux _module._default.Prefix$T ($LS $LZ) |pat#0@@2| |a#0@@2| (LitInt 0)) (=> (not (|Seq#Equal| |pat#0@@2| |Seq#Empty|)) (=> (and (not (|Seq#Equal| |a#0@@2| |Seq#Empty|)) (= (|Seq#Index| |pat#0@@2| (LitInt 0)) (|Seq#Index| |a#0@@2| (LitInt 0)))) (_module.__default.IsRelaxedPrefixAux _module._default.Prefix$T ($LS ($LS $LZ)) (|Seq#Drop| |pat#0@@2| (LitInt 1)) (|Seq#Drop| |a#0@@2| (LitInt 1)) (LitInt 0)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.__default.IsRelaxedPrefixAux#canCall| _module._default.Prefix$T |pat#0@@2| |a#0@@2| (LitInt 0)) (or (_module.__default.IsRelaxedPrefixAux _module._default.Prefix$T ($LS $LZ) |pat#0@@2| |a#0@@2| (LitInt 0)) (=> (not (|Seq#Equal| |pat#0@@2| |Seq#Empty|)) (=> (not (and (not (|Seq#Equal| |a#0@@2| |Seq#Empty|)) (= (|Seq#Index| |pat#0@@2| (LitInt 0)) (|Seq#Index| |a#0@@2| (LitInt 0))))) (U_2_bool (Lit boolType (bool_2_U (> 0 0))))))))) (=> (=> (|_module.__default.IsRelaxedPrefixAux#canCall| _module._default.Prefix$T |pat#0@@2| |a#0@@2| (LitInt 0)) (or (_module.__default.IsRelaxedPrefixAux _module._default.Prefix$T ($LS $LZ) |pat#0@@2| |a#0@@2| (LitInt 0)) (=> (not (|Seq#Equal| |pat#0@@2| |Seq#Empty|)) (=> (not (and (not (|Seq#Equal| |a#0@@2| |Seq#Empty|)) (= (|Seq#Index| |pat#0@@2| (LitInt 0)) (|Seq#Index| |a#0@@2| (LitInt 0))))) (U_2_bool (Lit boolType (bool_2_U (> 0 0)))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.__default.IsRelaxedPrefixAux#canCall| _module._default.Prefix$T |pat#0@@2| |a#0@@2| (LitInt 0)) (or (_module.__default.IsRelaxedPrefixAux _module._default.Prefix$T ($LS $LZ) |pat#0@@2| |a#0@@2| (LitInt 0)) (=> (not (|Seq#Equal| |pat#0@@2| |Seq#Empty|)) (=> (not (and (not (|Seq#Equal| |a#0@@2| |Seq#Empty|)) (= (|Seq#Index| |pat#0@@2| (LitInt 0)) (|Seq#Index| |a#0@@2| (LitInt 0))))) (_module.__default.IsRelaxedPrefixAux _module._default.Prefix$T ($LS ($LS $LZ)) (|Seq#Drop| |pat#0@@2| (LitInt 1)) |a#0@@2| (LitInt (- 0 1))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SeqType |pat#0@@2| (TSeq _module._default.Prefix$T)) ($IsAlloc SeqType |pat#0@@2| (TSeq _module._default.Prefix$T) $Heap))) (=> (and (and (and ($Is SeqType |a#0@@2| (TSeq _module._default.Prefix$T)) ($IsAlloc SeqType |a#0@@2| (TSeq _module._default.Prefix$T) $Heap)) (= 1 $FunctionContextHeight)) (and (and (<= (|Seq#Length| |pat#0@@2|) (|Seq#Length| |a#0@@2|)) (|Seq#SameUntil| |pat#0@@2| |a#0@@2| (|Seq#Length| |pat#0@@2|))) (= (ControlFlow 0 6) 2))) anon0_correct))))
