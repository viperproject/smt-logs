...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Divides)
...
(let ((anon10_Else_correct  (=> (and (>= 0 |n#2@0|) (= (ControlFlow 0 7) 3)) anon6_correct)))
(let ((anon10_Then_correct  (=> (and (and (> |n#2@0| 0) ($IsAlloc intType (int_2_U |n#2@0|) TInt $Heap)) (and ($IsAlloc intType (int_2_U |d#0@@3|) TInt $Heap) ($IsAlloc intType (int_2_U |a#0@@3|) TInt $Heap))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (> |n#2@0| 0)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (> |d#0@@3| 0)) (=> (and (and (> |n#2@0| 0) (> |d#0@@3| 0)) (and (|_module.__default.MulTriple#canCall| |n#2@0| |d#0@@3| |a#0@@3|) (= (ControlFlow 0 4) 3))) anon6_correct))))))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 8) 4) anon10_Then_correct) (=> (= (ControlFlow 0 8) 7) anon10_Else_correct))))
(let ((anon9_Else_correct true))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (> |d#0@@3| 0) (> |a#0@@3| 0)) (and (and (=> (= (ControlFlow 0 9) 1) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon9_Then_correct)) (=> (= (ControlFlow 0 9) 2) anon9_Else_correct))))))
