...
(set-info :boogie-vc-id Impl$$_module.__default.DividesIdempotent)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) reveal__module._default.Divides)) (and (and (= |##n#0@0| (LitInt 1)) ($IsAlloc intType (int_2_U |##n#0@0|) TInt $Heap@0)) (and ($IsAlloc intType (int_2_U |a#0@@3|) TInt $Heap@0) ($IsAlloc intType (int_2_U |a#0@@3|) TInt $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (> |##n#0@0| 0)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (> |a#0@@3| 0)) (=> (and (|_module.__default.MulTriple#canCall| (LitInt 1) |a#0@@3| |a#0@@3|) (|_module.__default.MulTriple#canCall| (LitInt 1) |a#0@@3| |a#0@@3|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.__default.MulTriple#canCall| (LitInt 1) |a#0@@3| |a#0@@3|) (or (_module.__default.MulTriple (LitInt 1) |a#0@@3| |a#0@@3|) (= (Mul (LitInt 1) |a#0@@3|) |a#0@@3|)))) (=> (and (_module.__default.MulTriple (LitInt 1) |a#0@@3| |a#0@@3|) (= (ControlFlow 0 2) (- 0 1))) (_module.__default.Divides reveal__module._default.Divides |a#0@@3| |a#0@@3|))))))))))
