...
(assert (distinct TBool TagBool TagSeq alloc Tagclass._System.nat tytagFamily$nat)
)
...
(declare-fun _module._default.IsRelaxedPrefix$T@@1 () T@U)
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.IsRelaxedPrefix)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct  (=> ($IsAlloc SeqType |pat#0@@4| (TSeq _module._default.IsRelaxedPrefix$T@@1) $Heap) (=> (and ($IsAlloc SeqType |a#0@@4| (TSeq _module._default.IsRelaxedPrefix$T@@1) $Heap) (= (ControlFlow 0 3) (- 0 2))) ($Is intType (int_2_U (LitInt 1)) Tclass._System.nat)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |pat#0@@4| (TSeq _module._default.IsRelaxedPrefix$T@@1)) ($Is SeqType |a#0@@4| (TSeq _module._default.IsRelaxedPrefix$T@@1))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct))))
