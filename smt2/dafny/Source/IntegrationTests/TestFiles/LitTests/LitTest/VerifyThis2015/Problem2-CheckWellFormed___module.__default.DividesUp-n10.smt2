...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.DividesUpperBound)
...
(let ((anon4_Then_correct  (=> (and ($IsAlloc intType (int_2_U |d#0@@3|) TInt $Heap@0) ($IsAlloc intType (int_2_U |a#0@@3|) TInt $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (> |d#0@@3| 0)) (=> (= (ControlFlow 0 2) (- 0 1)) (> |a#0@@3| 0))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (> |d#0@@3| 0) (> |a#0@@3| 0)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (=> (= (ControlFlow 0 5) 2) anon4_Then_correct) (=> (= (ControlFlow 0 5) 4) anon4_Else_correct)))))))
