...
(set-info :boogie-vc-id Impl$$_module.__default.Same2_split2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon4_correct  (=> (not (and (not (|Seq#Equal| |a#0@@4| |Seq#Empty|)) (= (|Seq#Index| |pat#0@@4| (LitInt 0)) (|Seq#Index| |a#0@@4| (LitInt 0))))) (=> (and (and (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |pat#0@@4|))) (= |pat##1_1_0@0| (|Seq#Drop| |pat#0@@4| (LitInt 1)))) (and (and (=> (|_module.__default.IsRelaxedPrefixAux#canCall| _module._default.Same2$T |pat##1_1_0@0| |a#0@@4| (LitInt 0)) (or (_module.__default.IsRelaxedPrefixAux _module._default.Same2$T ($LS $LZ) |pat##1_1_0@0| |a#0@@4| (LitInt 0)) (=> (|Seq#Equal| |pat##1_1_0@0| |Seq#Empty|) (U_2_bool (Lit boolType (bool_2_U true)))))) (= (ControlFlow 0 2) (- 0 1))) (|_module.__default.IsRelaxedPrefixAux#canCall| _module._default.Same2$T |pat##1_1_0@0| |a#0@@4| (LitInt 0)))) (or (_module.__default.IsRelaxedPrefixAux _module._default.Same2$T ($LS $LZ) |pat##1_1_0@0| |a#0@@4| (LitInt 0)) (=> (not (|Seq#Equal| |pat##1_1_0@0| |Seq#Empty|)) (=> (and (not (|Seq#Equal| |a#0@@4| |Seq#Empty|)) (= (|Seq#Index| |pat##1_1_0@0| (LitInt 0)) (|Seq#Index| |a#0@@4| (LitInt 0)))) (_module.__default.IsRelaxedPrefixAux _module._default.Same2$T ($LS ($LS $LZ)) (|Seq#Drop| |pat##1_1_0@0| (LitInt 1)) (|Seq#Drop| |a#0@@4| (LitInt 1)) (LitInt 0)))))))))
(let ((anon26_Else_correct  (=> (and (|Seq#Equal| |a#0@@4| |Seq#Empty|) (= (ControlFlow 0 4) 2)) anon4_correct)))
(let ((anon26_Then_correct  (=> (not (|Seq#Equal| |a#0@@4| |Seq#Empty|)) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |pat#0@@4|))) (=> (and (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |a#0@@4|))) (= (ControlFlow 0 3) 2)) anon4_correct)))))
...
)) (not (|Seq#Equal| |pat#0@@4| |Seq#Empty|))))) (and (=> (= (ControlFlow 0 5) 3) anon26_Then_correct) (=> (= (ControlFlow 0 5) 4) anon26_Else_correct)))))))
anon0_correct)))))
))
(check-sat)
(get-info :rlimit)
