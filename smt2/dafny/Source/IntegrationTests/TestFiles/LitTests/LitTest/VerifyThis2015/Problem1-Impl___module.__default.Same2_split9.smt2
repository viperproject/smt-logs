...
(set-info :boogie-vc-id Impl$$_module.__default.Same2_split9)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon24_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (and (<= (|Seq#Length| (|Seq#Append| (|Seq#Take| |pat#0@@4| (LitInt 0)) (|Seq#Drop| |pat#0@@4| (LitInt (+ 0 1))))) (|Seq#Length| |a#0@@4|)) (|Seq#SameUntil| (|Seq#Append| (|Seq#Take| |pat#0@@4| (LitInt 0)) (|Seq#Drop| |pat#0@@4| (LitInt (+ 0 1)))) |a#0@@4| (|Seq#Length| (|Seq#Append| (|Seq#Take| |pat#0@@4| (LitInt 0)) (|Seq#Drop| |pat#0@@4| (LitInt (+ 0 1))))))))))
