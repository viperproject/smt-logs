...
(set-info :boogie-vc-id Impl$$_module.__default.Same2_split18)
...
(assert (not
 ...
 :skolemid |634|
))))) (=> (and (and (<= (LitInt 0) |k#1_0_1_0@0|) (< |k#1_0_1_0@0| (|Seq#Length| (|Seq#Drop| |pat#0@@4| (LitInt 1))))) (and (<= (|Seq#Length| (|Seq#Append| (|Seq#Take| (|Seq#Drop| |pat#0@@4| (LitInt 1)) |k#1_0_1_0@0|) (|Seq#Drop| (|Seq#Drop| |pat#0@@4| (LitInt 1)) (+ |k#1_0_1_0@0| 1)))) (|Seq#Length| (|Seq#Drop| |a#0@@4| (LitInt 1)))) (|Seq#SameUntil| (|Seq#Append| (|Seq#Take| (|Seq#Drop| |pat#0@@4| (LitInt 1)) |k#1_0_1_0@0|) (|Seq#Drop| (|Seq#Drop| |pat#0@@4| (LitInt 1)) (+ |k#1_0_1_0@0| 1))) (|Seq#Drop| |a#0@@4| (LitInt 1)) (|Seq#Length| (|Seq#Append| (|Seq#Take| (|Seq#Drop| |pat#0@@4| (LitInt 1)) |k#1_0_1_0@0|) (|Seq#Drop| (|Seq#Drop| |pat#0@@4| (LitInt 1)) (+ |k#1_0_1_0@0| 1))))))) (=> (and (and (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |pat#0@@4|))) (and (<= 0 |k#1_0_1_0@0|) (<= |k#1_0_1_0@0| (|Seq#Length| (|Seq#Drop| |pat#0@@4| (LitInt 1)))))) (and (and (<= 0 (+ |k#1_0_1_0@0| 2)) (<= (+ |k#1_0_1_0@0| 2) (|Seq#Length| |pat#0@@4|))) (= (ControlFlow 0 2) (- 0 1)))) (and (<= 0 |k#1_0_1_0@0|) (<= |k#1_0_1_0@0| (|Seq#Length| (|Seq#Drop| |pat#0@@4| (LitInt 1))))))))))
