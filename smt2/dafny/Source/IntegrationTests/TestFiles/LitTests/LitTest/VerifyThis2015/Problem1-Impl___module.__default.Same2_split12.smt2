...
(set-info :boogie-vc-id Impl$$_module.__default.Same2_split12)
...
)) (not (|Seq#Equal| |pat#0@@4| |Seq#Empty|))))) (and (=> (= (ControlFlow 0 8) 6) anon26_Then_correct) (=> (= (ControlFlow 0 8) 7) anon26_Else_correct)))))))
anon0_correct))))))))
))
(check-sat)
(get-info :rlimit)
