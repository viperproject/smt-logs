...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Gcd)
...
(let ((anon9_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (and (_module.__default.DividesBoth (LitInt 0) |a#0@@7| |b#0@@3|) (forall ((|m#3| Int) ) (!  (=> (_module.__default.DividesBoth |m#3| |a#0@@7| |b#0@@3|) (<= |m#3| (LitInt 0)))
 :qid |Problem2dfy.196:43|
 :skolemid |712|
 :pattern ( (_module.__default.DividesBoth |m#3| |a#0@@7| |b#0@@3|))
)))) (exists ((|d#3| Int) ) (!  (and (_module.__default.DividesBoth |d#3| |a#0@@7| |b#0@@3|) (forall ((|m#2| Int) ) (!  (=> (_module.__default.DividesBoth |m#2| |a#0@@7| |b#0@@3|) (<= |m#2| |d#3|))
 :qid |Problem2dfy.196:43|
 :skolemid |710|
 :pattern ( (_module.__default.DividesBoth |m#2| |a#0@@7| |b#0@@3|))
)))
 :qid |Problem2dfy.196:7|
 :skolemid |711|
))))))
(let ((anon15_Else_correct  (=> (and (not (_module.__default.DividesBoth |m#1@0| |a#0@@7| |b#0@@3|)) (= (ControlFlow 0 8) 4)) anon9_correct)))
(let ((anon15_Then_correct  (=> (and (_module.__default.DividesBoth |m#1@0| |a#0@@7| |b#0@@3|) (= (ControlFlow 0 7) 4)) anon9_correct)))
(let ((anon14_Then_correct  (=> ($IsAlloc intType (int_2_U |m#1@0|) TInt $Heap@0) (=> (and ($IsAlloc intType (int_2_U |a#0@@7|) TInt $Heap@0) ($IsAlloc intType (int_2_U |b#0@@3|) TInt $Heap@0)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (> |a#0@@7| 0)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (> |b#0@@3| 0)) (=> (and (and (> |a#0@@7| 0) (> |b#0@@3| 0)) (|_module.__default.DividesBoth#canCall| |m#1@0| |a#0@@7| |b#0@@3|)) (and (=> (= (ControlFlow 0 9) 7) anon15_Then_correct) (=> (= (ControlFlow 0 9) 8) anon15_Else_correct)))))))))
(let ((anon13_Then_correct  (=> (_module.__default.DividesBoth |d#2@0| |a#0@@7| |b#0@@3|) (and (=> (= (ControlFlow 0 12) 9) anon14_Then_correct) (=> (= (ControlFlow 0 12) 6) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (not (_module.__default.DividesBoth |d#2@0| |a#0@@7| |b#0@@3|)) (= (ControlFlow 0 5) 4)) anon9_correct)))
(let ((anon12_Then_correct  (=> ($IsAlloc intType (int_2_U |d#2@0|) TInt $Heap@0) (=> (and ($IsAlloc intType (int_2_U |a#0@@7|) TInt $Heap@0) ($IsAlloc intType (int_2_U |b#0@@3|) TInt $Heap@0)) (and (=> (= (ControlFlow 0 13) (- 0 15)) (> |a#0@@7| 0)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (> |b#0@@3| 0)) (=> (and (and (> |a#0@@7| 0) (> |b#0@@3| 0)) (|_module.__default.DividesBoth#canCall| |d#2@0| |a#0@@7| |b#0@@3|)) (and (=> (= (ControlFlow 0 13) 12) anon13_Then_correct) (=> (= (ControlFlow 0 13) 5) anon13_Else_correct)))))))))
(let ((anon12_Else_correct true))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 16) (- 0 18)) (> |a#0@@7| 0)) (=> (> |a#0@@7| 0) (and (=> (= (ControlFlow 0 16) (- 0 17)) (> |b#0@@3| 0)) (=> (> |b#0@@3| 0) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall ((|d#1@@0| Int) ) (!  (and (|_module.__default.DividesBoth#canCall| |d#1@@0| |a#0@@7| |b#0@@3|) (=> (_module.__default.DividesBoth |d#1@@0| |a#0@@7| |b#0@@3|) (forall ((|m#2@@0| Int) ) (! (|_module.__default.DividesBoth#canCall| |m#2@@0| |a#0@@7| |b#0@@3|)
 :qid |Problem2dfy.221:54|
 :skolemid |737|
 :pattern ( (_module.__default.DividesBoth |m#2@@0| |a#0@@7| |b#0@@3|))
))))
 :qid |Problem2dfy.221:18|
 :skolemid |738|
 :pattern ( (_module.__default.DividesBoth |d#1@@0| |a#0@@7| |b#0@@3|))
))) (and (exists ((|d#1@@1| Int) ) (!  (and (_module.__default.DividesBoth |d#1@@1| |a#0@@7| |b#0@@3|) (forall ((|m#2@@1| Int) ) (!  (=> (_module.__default.DividesBoth |m#2@@1| |a#0@@7| |b#0@@3|) (<= |m#2@@1| |d#1@@1|))
 :qid |Problem2dfy.221:54|
 :skolemid |739|
 :pattern ( (_module.__default.DividesBoth |m#2@@1| |a#0@@7| |b#0@@3|))
)))
 :qid |Problem2dfy.221:18|
 :skolemid |740|
 :pattern ( (_module.__default.DividesBoth |d#1@@1| |a#0@@7| |b#0@@3|))
)) (= $Heap@@1 $Heap@0))) (and (=> (= (ControlFlow 0 16) 13) anon12_Then_correct) (=> (= (ControlFlow 0 16) 2) anon12_Else_correct)))))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (> |a#0@@7| 0) (> |b#0@@3| 0)) (and (=> (= (ControlFlow 0 19) 1) anon11_Then_correct) (=> (= (ControlFlow 0 19) 16) anon11_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 20) 19))) anon0_correct)))
