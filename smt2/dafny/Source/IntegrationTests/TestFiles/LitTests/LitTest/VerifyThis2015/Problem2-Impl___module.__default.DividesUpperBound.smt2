...
(set-info :boogie-vc-id Impl$$_module.__default.DividesUpperBound)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (and reveal__module._default.Divides (= (ControlFlow 0 2) (- 0 1))) (_module.__default.Divides reveal__module._default.Divides |d#0@@3| |a#0@@3|))) (<= |d#0@@3| |a#0@@3|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (= 2 $FunctionContextHeight) (> |d#0@@3| 0)) (and (> |a#0@@3| 0) (= (ControlFlow 0 3) 2))) anon0_correct))))
