...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.GcdEqual)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (> |a#0@@7| 0)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@1 $Heap@0)) (and ($IsAlloc intType (int_2_U |a#0@@7|) TInt $Heap@0) ($IsAlloc intType (int_2_U |a#0@@7|) TInt $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (> |a#0@@7| 0)) (=> (= (ControlFlow 0 2) (- 0 1)) (> |a#0@@7| 0)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct)))
