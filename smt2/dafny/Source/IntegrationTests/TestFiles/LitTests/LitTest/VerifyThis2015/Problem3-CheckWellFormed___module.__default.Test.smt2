...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and ($Is refType |dd#0| Tclass._module.DoublyLinkedList) ($IsAlloc refType |dd#0| Tclass._module.DoublyLinkedList $Heap@@0))) (and (and ($Is refType |x#0| Tclass._module.Node) ($IsAlloc refType |x#0| Tclass._module.Node $Heap@@0)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 14) 2)))) anon0_correct)))
