...
(set-info :boogie-vc-id Impl$$_module.DoublyLinkedList.InjectiveAfterPop)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#4| null $Heap@@0 alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|_module.DoublyLinkedList.Injective#canCall| _module.DoublyLinkedList.InjectiveAfterPop$T this@@7 (_module.DoublyLinkedList.PopMiddle _module.DoublyLinkedList.InjectiveAfterPop$T this@@7 |s#0@@7| |k#0@@5|))) (or (_module.DoublyLinkedList.Injective _module.DoublyLinkedList.InjectiveAfterPop$T this@@7 (_module.DoublyLinkedList.PopMiddle _module.DoublyLinkedList.InjectiveAfterPop$T this@@7 |s#0@@7| |k#0@@5|)) (forall ((|j#3| Int) (|k#4| Int) ) (!  (=> (and (and (<= (LitInt 0) |j#3|) (< |j#3| |k#4|)) (< |k#4| (|Seq#Length| (_module.DoublyLinkedList.PopMiddle _module.DoublyLinkedList.InjectiveAfterPop$T this@@7 |s#0@@7| |k#0@@5|)))) (or (not (= (|Seq#Index| (_module.DoublyLinkedList.PopMiddle _module.DoublyLinkedList.InjectiveAfterPop$T this@@7 |s#0@@7| |k#0@@5|) |j#3|) (|Seq#Index| (_module.DoublyLinkedList.PopMiddle _module.DoublyLinkedList.InjectiveAfterPop$T this@@7 |s#0@@7| |k#0@@5|) |k#4|))) (not true)))
 :qid |Problem3dfy.105:12|
 :skolemid |726|
 :pattern ( (|Seq#Index| (_module.DoublyLinkedList.PopMiddle _module.DoublyLinkedList.InjectiveAfterPop$T this@@7 |s#0@@7| |k#0@@5|) |k#4|) (|Seq#Index| (_module.DoublyLinkedList.PopMiddle _module.DoublyLinkedList.InjectiveAfterPop$T this@@7 |s#0@@7| |k#0@@5|) |j#3|))
))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and (or (not (= this@@7 null)) (not true)) (and ($Is refType this@@7 Tclass._module.DoublyLinkedList) ($IsAlloc refType this@@7 Tclass._module.DoublyLinkedList $Heap@@0)))) (=> (and (and (and (and ($Is SeqType |s#0@@7| (TSeq _module.DoublyLinkedList.InjectiveAfterPop$T)) ($IsAlloc SeqType |s#0@@7| (TSeq _module.DoublyLinkedList.InjectiveAfterPop$T) $Heap@@0)) (<= (LitInt 0) |k#0@@5|)) (and (= 1 $FunctionContextHeight) (< |k#0@@5| (|Seq#Length| |s#0@@7|)))) (and (and (|_module.DoublyLinkedList.Injective#canCall| _module.DoublyLinkedList.InjectiveAfterPop$T this@@7 |s#0@@7|) (and (_module.DoublyLinkedList.Injective _module.DoublyLinkedList.InjectiveAfterPop$T this@@7 |s#0@@7|) (forall ((|j#2@@0| Int) (|k#3| Int) ) (!  (=> (and (and (<= (LitInt 0) |j#2@@0|) (< |j#2@@0| |k#3|)) (< |k#3| (|Seq#Length| |s#0@@7|))) (or (not (= (|Seq#Index| |s#0@@7| |j#2@@0|) (|Seq#Index| |s#0@@7| |k#3|))) (not true)))
 :qid |Problem3dfy.105:12|
 :skolemid |725|
 :pattern ( (|Seq#Index| |s#0@@7| |k#3|) (|Seq#Index| |s#0@@7| |j#2@@0|))
