...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Exists)
...
(let ((anon5_Else_correct  (=> (and (=> (_module.__default.DividesBoth |m#0@0| |a#0@@5| |b#0@@1|) (<= |m#0@0| |d#0@0|)) (= (ControlFlow 0 5) 1)) anon4_correct)))
(let ((anon5_Then_correct  (=> ($IsAlloc intType (int_2_U |m#0@0|) TInt $Heap@0) (=> (and ($IsAlloc intType (int_2_U |a#0@@5|) TInt $Heap@0) ($IsAlloc intType (int_2_U |b#0@@1|) TInt $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (> |a#0@@5| 0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (> |b#0@@1| 0)) (=> (and (> |a#0@@5| 0) (> |b#0@@1| 0)) (=> (and (and (|_module.__default.DividesBoth#canCall| |m#0@0| |a#0@@5| |b#0@@1|) (_module.__default.DividesBoth |m#0@0| |a#0@@5| |b#0@@1|)) (and (<= |m#0@0| |d#0@0|) (= (ControlFlow 0 2) 1))) anon4_correct))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and (> |a#0@@5| 0) (> |b#0@@1| 0)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (= $Heap $Heap@0) ($IsAlloc intType (int_2_U |d#0@0|) TInt $Heap@0)) (and ($IsAlloc intType (int_2_U |a#0@@5|) TInt $Heap@0) ($IsAlloc intType (int_2_U |b#0@@1|) TInt $Heap@0)))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (> |a#0@@5| 0)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (> |b#0@@1| 0)) (=> (and (and (> |a#0@@5| 0) (> |b#0@@1| 0)) (and (|_module.__default.DividesBoth#canCall| |d#0@0| |a#0@@5| |b#0@@1|) (_module.__default.DividesBoth |d#0@0| |a#0@@5| |b#0@@1|))) (and (=> (= (ControlFlow 0 6) 2) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 9) 6))) anon0_correct)))
