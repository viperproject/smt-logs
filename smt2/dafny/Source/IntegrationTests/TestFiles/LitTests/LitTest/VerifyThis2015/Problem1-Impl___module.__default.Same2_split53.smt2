...
(set-info :boogie-vc-id Impl$$_module.__default.Same2_split53)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon31_Then_correct  (=> (and (and (<= (LitInt 0) |k#1_0_1_1@0|) (< |k#1_0_1_1@0| (|Seq#Length| (|Seq#Drop| |pat#0@@4| (LitInt 1))))) (= (ControlFlow 0 2) (- 0 1))) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |pat#0@@4|))))))
