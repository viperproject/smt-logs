...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|n#0@@1| Int) (|d#0@@1| Int) (|a#0@@1| Int) ) (!  (=> (or (|_module.__default.MulTriple#canCall| (LitInt |n#0@@1|) (LitInt |d#0@@1|) (LitInt |a#0@@1|)) (and (< 0 $FunctionContextHeight) (U_2_bool (Lit boolType (bool_2_U  (and (> |n#0@@1| 0) (> |d#0@@1| 0))))))) (= (_module.__default.MulTriple (LitInt |n#0@@1|) (LitInt |d#0@@1|) (LitInt |a#0@@1|)) (= (LitInt (Mul (LitInt |n#0@@1|) (LitInt |d#0@@1|))) (LitInt |a#0@@1|))))
 :qid |Problem2dfy.211:27|
 :weight 3
 :skolemid |735|
 :pattern ( (_module.__default.MulTriple (LitInt |n#0@@1|) (LitInt |d#0@@1|) (LitInt |a#0@@1|)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|n#0@@2| Int) (|d#0@@2| Int) (|a#0@@2| Int) ) (!  (=> (or (|_module.__default.MulTriple#canCall| |n#0@@2| |d#0@@2| |a#0@@2|) (and (< 0 $FunctionContextHeight) (and (> |n#0@@2| 0) (> |d#0@@2| 0)))) (= (_module.__default.MulTriple |n#0@@2| |d#0@@2| |a#0@@2|) (= (Mul |n#0@@2| |d#0@@2|) |a#0@@2|)))
 :qid |Problem2dfy.211:27|
 :skolemid |734|
 :pattern ( (_module.__default.MulTriple |n#0@@2| |d#0@@2| |a#0@@2|))
))))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.DividesProperty)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (> |d#0@@3| 0) (> |a#0@@3| 0)) (and ($IsAlloc intType (int_2_U |d#0@@3|) TInt $Heap) ($IsAlloc intType (int_2_U |a#0@@3|) TInt $Heap))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (> |d#0@@3| 0)) (=> (= (ControlFlow 0 2) (- 0 1)) (> |a#0@@3| 0)))))))
