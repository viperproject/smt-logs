...
(set-info :boogie-vc-id Impl$$_module.__default.MultipleDivides)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (and reveal__module._default.Divides ($IsAlloc intType (int_2_U |n#0@@3|) TInt $Heap@0)) (and ($IsAlloc intType (int_2_U |d#0@@3|) TInt $Heap@0) ($IsAlloc intType (int_2_U |a#0@@3|) TInt $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (> |n#0@@3| 0)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (> |d#0@@3| 0)) (=> (and (|_module.__default.MulTriple#canCall| |n#0@@3| |d#0@@3| |a#0@@3|) (|_module.__default.MulTriple#canCall| |n#0@@3| |d#0@@3| |a#0@@3|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.__default.MulTriple#canCall| |n#0@@3| |d#0@@3| |a#0@@3|) (or (_module.__default.MulTriple |n#0@@3| |d#0@@3| |a#0@@3|) (= (Mul |n#0@@3| |d#0@@3|) |a#0@@3|)))) (=> (and (_module.__default.MulTriple |n#0@@3| |d#0@@3| |a#0@@3|) (= (ControlFlow 0 2) (- 0 1))) (_module.__default.Divides reveal__module._default.Divides |d#0@@3| |a#0@@3|))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 2 $FunctionContextHeight)) (and (and (> |n#0@@3| 0) (> |d#0@@3| 0)) (and (= (Mul |n#0@@3| |d#0@@3|) |a#0@@3|) (= (ControlFlow 0 6) 2)))) anon0_correct)))
