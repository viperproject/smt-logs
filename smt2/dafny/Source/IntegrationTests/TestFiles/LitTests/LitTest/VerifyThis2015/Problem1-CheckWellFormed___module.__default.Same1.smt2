...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Same1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_correct  (=> (and (<= (LitInt 0) |k#0|) (< |k#0| (|Seq#Length| |pat#0@@2|))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= 0 |k#0|) (<= |k#0| (|Seq#Length| |pat#0@@2|)))) (=> (and (<= 0 |k#0|) (<= |k#0| (|Seq#Length| |pat#0@@2|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 (+ |k#0| 1)) (<= (+ |k#0| 1) (|Seq#Length| |pat#0@@2|)))) (=> (and (<= 0 (+ |k#0| 1)) (<= (+ |k#0| 1) (|Seq#Length| |pat#0@@2|))) (=> (and (and (and (<= (|Seq#Length| (|Seq#Append| (|Seq#Take| |pat#0@@2| |k#0|) (|Seq#Drop| |pat#0@@2| (+ |k#0| 1)))) (|Seq#Length| |a#0@@2|)) (|Seq#SameUntil| (|Seq#Append| (|Seq#Take| |pat#0@@2| |k#0|) (|Seq#Drop| |pat#0@@2| (+ |k#0| 1))) |a#0@@2| (|Seq#Length| (|Seq#Append| (|Seq#Take| |pat#0@@2| |k#0|) (|Seq#Drop| |pat#0@@2| (+ |k#0| 1)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (= $Heap $Heap@0) ($IsAlloc SeqType |pat#0@@2| (TSeq _module._default.Same1$T) $Heap@0)) (and ($IsAlloc SeqType |a#0@@2| (TSeq _module._default.Same1$T) $Heap@0) (= (ControlFlow 0 2) (- 0 1))))) ($Is intType (int_2_U (LitInt 1)) Tclass._System.nat)))))))))
(let ((anon4_Else_correct  (=> (and (< |k#0| (LitInt 0)) (= (ControlFlow 0 6) 2)) anon3_correct)))
(let ((anon4_Then_correct  (=> (and (<= (LitInt 0) |k#0|) (= (ControlFlow 0 5) 2)) anon3_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 7) 5) anon4_Then_correct) (=> (= (ControlFlow 0 7) 6) anon4_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SeqType |pat#0@@2| (TSeq _module._default.Same1$T)) ($IsAlloc SeqType |pat#0@@2| (TSeq _module._default.Same1$T) $Heap))) (=> (and (and (and ($Is SeqType |a#0@@2| (TSeq _module._default.Same1$T)) ($IsAlloc SeqType |a#0@@2| (TSeq _module._default.Same1$T) $Heap)) (<= (LitInt 0) |k#0|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
