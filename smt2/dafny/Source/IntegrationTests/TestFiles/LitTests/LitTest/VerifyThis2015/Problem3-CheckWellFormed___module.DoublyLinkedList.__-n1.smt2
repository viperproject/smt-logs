...
(set-info :boogie-vc-id CheckWellFormed$$_module.DoublyLinkedList.__ctor)
...
(let ((anon6_correct  (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |j#0@0|)) (< |j#0@0| (|Seq#Length| |nodes#0|))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |nodes#0|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |nodes#0|))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 |j#0@0|) (< |j#0@0| (|Seq#Length| |nodes#0|)))) (=> (and (<= 0 |j#0@0|) (< |j#0@0| (|Seq#Length| |nodes#0|))) (=> (and (or (not (= ($Unbox refType (|Seq#Index| |nodes#0| |i#0@0|)) ($Unbox refType (|Seq#Index| |nodes#0| |j#0@0|)))) (not true)) (= (ControlFlow 0 3) 1)) anon8_correct))))))))
(let ((anon11_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |j#0@0|))) (= (ControlFlow 0 7) 3)) anon6_correct)))
(let ((anon11_Then_correct  (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |j#0@0|)) (= (ControlFlow 0 6) 3)) anon6_correct)))
(let ((anon10_Else_correct  (=> (< |i#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 9) 6) anon11_Then_correct) (=> (= (ControlFlow 0 9) 7) anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 8) 6) anon11_Then_correct) (=> (= (ControlFlow 0 8) 7) anon11_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |j#0@0|)) (< |j#0@0| (|Seq#Length| |nodes#0|))) (or (not (= ($Unbox refType (|Seq#Index| |nodes#0| |i#0@0|)) ($Unbox refType (|Seq#Index| |nodes#0| |j#0@0|)))) (not true))) (= (ControlFlow 0 2) 1)) anon8_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#8| null $Heap@@0 alloc 0 (|Seq#Length| |nodes#0|) |nodes#0|)) (and (and (=> (= (ControlFlow 0 10) 2) anon9_Else_correct) (=> (= (ControlFlow 0 10) 8) anon10_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon10_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is SeqType |nodes#0| (TSeq Tclass._module.Node)) ($IsAlloc SeqType |nodes#0| (TSeq Tclass._module.Node) $Heap@@0)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct))))
