...
(set-info :boogie-vc-id Impl$$_module.__default.OneDividesAnything)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) reveal__module._default.Divides)) (and (and ($IsAlloc intType (int_2_U |a#0@@3|) TInt $Heap@0) (= |##d#1@0| (LitInt 1))) (and ($IsAlloc intType (int_2_U |##d#1@0|) TInt $Heap@0) ($IsAlloc intType (int_2_U |a#0@@3|) TInt $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (> |a#0@@3| 0)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (> |##d#1@0| 0)) (=> (and (|_module.__default.MulTriple#canCall| |a#0@@3| (LitInt 1) |a#0@@3|) (|_module.__default.MulTriple#canCall| |a#0@@3| (LitInt 1) |a#0@@3|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.__default.MulTriple#canCall| |a#0@@3| (LitInt 1) |a#0@@3|) (or (_module.__default.MulTriple |a#0@@3| (LitInt 1) |a#0@@3|) (= (Mul |a#0@@3| (LitInt 1)) |a#0@@3|)))) (=> (and (_module.__default.MulTriple |a#0@@3| (LitInt 1) |a#0@@3|) (= (ControlFlow 0 2) (- 0 1))) (_module.__default.Divides reveal__module._default.Divides (LitInt 1) |a#0@@3|))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 2 $FunctionContextHeight)) (and (> |a#0@@3| 0) (= (ControlFlow 0 6) 2))) anon0_correct)))
