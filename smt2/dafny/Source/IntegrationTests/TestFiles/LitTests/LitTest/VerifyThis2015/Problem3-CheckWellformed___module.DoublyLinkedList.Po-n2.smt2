...
(assert (distinct TagSeq alloc Tagclass._module.DoublyLinkedList Tagclass._module.DoublyLinkedList? tytagFamily$DoublyLinkedList)
)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module.DoublyLinkedList.PopMiddle$T@@0 T@U) (this@@0 T@U) (|s#0@@0| T@U) (|k#0@@0| Int) ) (!  (=> (or (|_module.DoublyLinkedList.PopMiddle#canCall| _module.DoublyLinkedList.PopMiddle$T@@0 this@@0 |s#0@@0| |k#0@@0|) (and (< 0 $FunctionContextHeight) (and (and (and (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass._module.DoublyLinkedList)) ($Is SeqType |s#0@@0| (TSeq _module.DoublyLinkedList.PopMiddle$T@@0))) (<= (LitInt 0) |k#0@@0|)) (< |k#0@@0| (|Seq#Length| |s#0@@0|))))) (= (_module.DoublyLinkedList.PopMiddle _module.DoublyLinkedList.PopMiddle$T@@0 this@@0 |s#0@@0| |k#0@@0|) (|Seq#Append| (|Seq#Take| |s#0@@0| |k#0@@0|) (|Seq#Drop| |s#0@@0| (+ |k#0@@0| 1)))))
 :qid |unknown.0:0|
 :skolemid |707|
 :pattern ( (_module.DoublyLinkedList.PopMiddle _module.DoublyLinkedList.PopMiddle$T@@0 this@@0 |s#0@@0| |k#0@@0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (_module.DoublyLinkedList.PopMiddle$T@@1 T@U) (this@@1 T@U) (|s#0@@1| T@U) (|k#0@@1| Int) ) (!  (=> (and (or (|_module.DoublyLinkedList.PopMiddle#canCall| _module.DoublyLinkedList.PopMiddle$T@@1 this@@1 |s#0@@1| |k#0@@1|) (and (< 0 $FunctionContextHeight) (and (and (and (and (or (not (= this@@1 null)) (not true)) ($IsAlloc refType this@@1 Tclass._module.DoublyLinkedList $Heap)) (and ($Is SeqType |s#0@@1| (TSeq _module.DoublyLinkedList.PopMiddle$T@@1)) ($IsAlloc SeqType |s#0@@1| (TSeq _module.DoublyLinkedList.PopMiddle$T@@1) $Heap))) (<= (LitInt 0) |k#0@@1|)) (< |k#0@@1| (|Seq#Length| |s#0@@1|))))) ($IsGoodHeap $Heap)) ($IsAlloc SeqType (_module.DoublyLinkedList.PopMiddle _module.DoublyLinkedList.PopMiddle$T@@1 this@@1 |s#0@@1| |k#0@@1|) (TSeq _module.DoublyLinkedList.PopMiddle$T@@1) $Heap))
 :qid |Problem3dfy.99:18|
 :skolemid |705|
 :pattern ( ($IsAlloc SeqType (_module.DoublyLinkedList.PopMiddle _module.DoublyLinkedList.PopMiddle$T@@1 this@@1 |s#0@@1| |k#0@@1|) (TSeq _module.DoublyLinkedList.PopMiddle$T@@1) $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module.DoublyLinkedList.PopMiddle$T@@2 T@U) (this@@2 T@U) (|s#0@@2| T@U) (|k#0@@2| Int) ) (!  (=> (or (|_module.DoublyLinkedList.PopMiddle#canCall| _module.DoublyLinkedList.PopMiddle$T@@2 this@@2 |s#0@@2| |k#0@@2|) (and (< 0 $FunctionContextHeight) (and (and (and (and (or (not (= this@@2 null)) (not true)) ($Is refType this@@2 Tclass._module.DoublyLinkedList)) ($Is SeqType |s#0@@2| (TSeq _module.DoublyLinkedList.PopMiddle$T@@2))) (<= (LitInt 0) |k#0@@2|)) (< |k#0@@2| (|Seq#Length| |s#0@@2|))))) ($Is SeqType (_module.DoublyLinkedList.PopMiddle _module.DoublyLinkedList.PopMiddle$T@@2 this@@2 |s#0@@2| |k#0@@2|) (TSeq _module.DoublyLinkedList.PopMiddle$T@@2)))
 :qid |unknown.0:0|
 :skolemid |704|
 :pattern ( (_module.DoublyLinkedList.PopMiddle _module.DoublyLinkedList.PopMiddle$T@@2 this@@2 |s#0@@2| |k#0@@2|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module.DoublyLinkedList.PopMiddle$T@@3 T@U) (this@@3 T@U) (|s#0@@3| T@U) (|k#0@@3| Int) ) (!  (=> (or (|_module.DoublyLinkedList.PopMiddle#canCall| _module.DoublyLinkedList.PopMiddle$T@@3 (Lit refType this@@3) (Lit SeqType |s#0@@3|) (LitInt |k#0@@3|)) (and (< 0 $FunctionContextHeight) (and (and (and (and (or (not (= this@@3 null)) (not true)) ($Is refType this@@3 Tclass._module.DoublyLinkedList)) ($Is SeqType |s#0@@3| (TSeq _module.DoublyLinkedList.PopMiddle$T@@3))) (<= (LitInt 0) |k#0@@3|)) (< |k#0@@3| (|Seq#Length| (Lit SeqType |s#0@@3|)))))) (= (_module.DoublyLinkedList.PopMiddle _module.DoublyLinkedList.PopMiddle$T@@3 (Lit refType this@@3) (Lit SeqType |s#0@@3|) (LitInt |k#0@@3|)) (|Seq#Append| (|Seq#Take| (Lit SeqType |s#0@@3|) (LitInt |k#0@@3|)) (|Seq#Drop| (Lit SeqType |s#0@@3|) (LitInt (+ |k#0@@3| 1))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |709|
 :pattern ( (_module.DoublyLinkedList.PopMiddle _module.DoublyLinkedList.PopMiddle$T@@3 (Lit refType this@@3) (Lit SeqType |s#0@@3|) (LitInt |k#0@@3|)))
))))
...
(declare-fun _module.DoublyLinkedList.PopMiddle$T@@4 () T@U)
(set-info :boogie-vc-id CheckWellformed$$_module.DoublyLinkedList.PopMiddle)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 |k#0@@4|) (<= |k#0@@4| (|Seq#Length| |s#0@@4|)))) (=> (and (<= 0 |k#0@@4|) (<= |k#0@@4| (|Seq#Length| |s#0@@4|))) (=> (= (ControlFlow 0 3) (- 0 2)) (and (<= 0 (+ |k#0@@4| 1)) (<= (+ |k#0@@4| 1) (|Seq#Length| |s#0@@4|))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#4| null $Heap@@0 alloc false)) (< |k#0@@4| (|Seq#Length| |s#0@@4|))) (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.DoublyLinkedList) ($IsAlloc refType this@@4 Tclass._module.DoublyLinkedList $Heap@@0)))) (and (and ($Is SeqType |s#0@@4| (TSeq _module.DoublyLinkedList.PopMiddle$T@@4)) (<= (LitInt 0) |k#0@@4|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 6) 5)))) anon0_correct)))
