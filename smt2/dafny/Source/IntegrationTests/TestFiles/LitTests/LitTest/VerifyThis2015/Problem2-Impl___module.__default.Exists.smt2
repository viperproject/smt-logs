...
(set-info :boogie-vc-id Impl$$_module.__default.Exists)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (> |a#0@@5| 0)) (=> (> |a#0@@5| 0) (and (=> (= (ControlFlow 0 2) (- 0 3)) (> |b#0@@1| 0)) (=> (> |b#0@@1| 0) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (|_module.__default.DividesBoth#canCall| |call3formal@d#0@0| |a#0@@5| |b#0@@1|) (=> (_module.__default.DividesBoth |call3formal@d#0@0| |a#0@@5| |b#0@@1|) (forall ((|m#1| Int) ) (! (|_module.__default.DividesBoth#canCall| |m#1| |a#0@@5| |b#0@@1|)
 :qid |Problem2dfy.228:42|
 :skolemid |747|
 :pattern ( (_module.__default.DividesBoth |m#1| |a#0@@5| |b#0@@1|))
))))) (=> (and (and (and (|_module.__default.DividesBoth#canCall| |call3formal@d#0@0| |a#0@@5| |b#0@@1|) (and (_module.__default.DividesBoth |call3formal@d#0@0| |a#0@@5| |b#0@@1|) (and (and (> |call3formal@d#0@0| 0) (_module.__default.Divides reveal__module._default.Divides |call3formal@d#0@0| |a#0@@5|)) (_module.__default.Divides reveal__module._default.Divides |call3formal@d#0@0| |b#0@@1|)))) (forall ((|m#1@@0| Int) ) (!  (=> (_module.__default.DividesBoth |m#1@@0| |a#0@@5| |b#0@@1|) (<= |m#1@@0| |call3formal@d#0@0|))
 :qid |Problem2dfy.228:42|
 :skolemid |748|
 :pattern ( (_module.__default.DividesBoth |m#1@@0| |a#0@@5| |b#0@@1|))
))) (and (= $Heap $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (exists ((|d#1| Int) ) (!  (and (_module.__default.DividesBoth |d#1| |a#0@@5| |b#0@@1|) (forall ((|m#2| Int) ) (!  (=> (_module.__default.DividesBoth |m#2| |a#0@@5| |b#0@@1|) (<= |m#2| |d#1|))
 :qid |Problem2dfy.221:54|
 :skolemid |743|
 :pattern ( (_module.__default.DividesBoth |m#2| |a#0@@5| |b#0@@1|))
)))
 :qid |Problem2dfy.221:18|
 :skolemid |744|
 :pattern ( (_module.__default.DividesBoth |d#1| |a#0@@5| |b#0@@1|))
)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (= 4 $FunctionContextHeight) (> |a#0@@5| 0)) (and (> |b#0@@1| 0) (= (ControlFlow 0 5) 2))) anon0_correct))))
