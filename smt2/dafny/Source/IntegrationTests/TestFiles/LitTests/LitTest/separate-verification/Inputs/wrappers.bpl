// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/separate-verification/Inputs/wrappers.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/separate-verification/Inputs/wrappers-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/separate-verification/Inputs/wrappers.dfy
...
axiom (forall a#12#0#0: Box :: 
  { #Wrappers.Option.Some(a#12#0#0) } 
  DatatypeCtorId(#Wrappers.Option.Some(a#12#0#0)) == ##Wrappers.Option.Some);
}
...
axiom (forall d: DatatypeType :: 
  { Wrappers.Option.Some_q(d) } 
  Wrappers.Option.Some_q(d)
     ==> (exists a#13#0#0: Box :: d == #Wrappers.Option.Some(a#13#0#0)));
...
// Constructor $Is
axiom (forall Wrappers.Option$T: Ty, a#14#0#0: Box :: 
  { $Is(#Wrappers.Option.Some(a#14#0#0), Tclass.Wrappers.Option(Wrappers.Option$T)) } 
  $Is(#Wrappers.Option.Some(a#14#0#0), Tclass.Wrappers.Option(Wrappers.Option$T))
     <==> $IsBox(a#14#0#0, Wrappers.Option$T));

// Constructor $IsAlloc
axiom (forall Wrappers.Option$T: Ty, a#14#0#0: Box, $h: Heap :: 
  { $IsAlloc(#Wrappers.Option.Some(a#14#0#0), Tclass.Wrappers.Option(Wrappers.Option$T), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#Wrappers.Option.Some(a#14#0#0), Tclass.Wrappers.Option(Wrappers.Option$T), $h)
       <==> $IsAllocBox(a#14#0#0, Wrappers.Option$T, $h)));
...
axiom (forall a#15#0#0: Box :: 
  { #Wrappers.Option.Some(Lit(a#15#0#0)) } 
  #Wrappers.Option.Some(Lit(a#15#0#0)) == Lit(#Wrappers.Option.Some(a#15#0#0)));

function Wrappers.Option.value(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#16#0#0: Box :: 
  { #Wrappers.Option.Some(a#16#0#0) } 
  Wrappers.Option.value(#Wrappers.Option.Some(a#16#0#0)) == a#16#0#0);

// Inductive rank
axiom (forall a#17#0#0: Box :: 
  { #Wrappers.Option.Some(a#17#0#0) } 
  BoxRank(a#17#0#0) < DtRank(#Wrappers.Option.Some(a#17#0#0)));
...
// alloc consequence axiom for Wrappers.Option.UnwrapOr
axiom 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, Wrappers.Option$T: Ty, this: DatatypeType, default#0: Box :: 
    { $IsAllocBox(Wrappers.Option.UnwrapOr(Wrappers.Option$T, this, default#0), 
        Wrappers.Option$T, 
        $Heap) } 
    (Wrappers.Option.UnwrapOr#canCall(Wrappers.Option$T, this, default#0)
           || (0 < $FunctionContextHeight
             && 
            $IsAlloc(this, Tclass.Wrappers.Option(Wrappers.Option$T), $Heap)
             && 
            $IsBox(default#0, Wrappers.Option$T)
             && $IsAllocBox(default#0, Wrappers.Option$T, $Heap)))
         && $IsGoodHeap($Heap)
       ==> $IsAllocBox(Wrappers.Option.UnwrapOr(Wrappers.Option$T, this, default#0), 
        Wrappers.Option$T, 
        $Heap));
    ...
    Wrappers.Option.UnwrapOr#canCall(Wrappers.Option$T, this, default#0)
         || (0 < $FunctionContextHeight
          ...
          $Is(this, Tclass.Wrappers.Option(Wrappers.Option$T))
           && $IsBox(default#0, Wrappers.Option$T))
       ==> Wrappers.Option.UnwrapOr(Wrappers.Option$T, this, default#0)
         == (if Wrappers.Option.Some_q(this)
           then (var v#0 := Wrappers.Option.value(this); v#0)
           else default#0));
   ...
   ==> (forall Wrappers.Option$T: Ty, this: DatatypeType, default#0: Box :: 
    ...
    Wrappers.Option.UnwrapOr#canCall(Wrappers.Option$T, Lit(this), default#0)
       ...
       ==> Wrappers.Option.UnwrapOr(Wrappers.Option$T, Lit(this), default#0)
         == (if Wrappers.Option.Some_q(Lit(this))
           then (var v#2 := Lit(Wrappers.Option.value(Lit(this))); v#2)
           else default#0));
   ...
   ==> (forall Wrappers.Option$T: Ty, this: DatatypeType, default#0: Box :: 
    ...
    Wrappers.Option.UnwrapOr#canCall(Wrappers.Option$T, Lit(this), Lit(default#0))
       ...
       ==> Wrappers.Option.UnwrapOr(Wrappers.Option$T, Lit(this), Lit(default#0))
         == (if Wrappers.Option.Some_q(Lit(this))
           then (var v#4 := Lit(Wrappers.Option.value(Lit(this))); v#4)
           else default#0));
}
...
procedure {:verboseName "Wrappers.Option.UnwrapOr (well-formedness)"} CheckWellformed$$Wrappers.Option.UnwrapOr(Wrappers.Option$T: Ty, 
    this: DatatypeType
       where $Is(this, Tclass.Wrappers.Option(Wrappers.Option$T))
         && $IsAlloc(this, Tclass.Wrappers.Option(Wrappers.Option$T), $Heap), 
    default#0: Box where $IsBox(default#0, Wrappers.Option$T));
