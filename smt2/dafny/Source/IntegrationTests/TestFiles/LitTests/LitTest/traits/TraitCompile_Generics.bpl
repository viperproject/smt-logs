...
procedure {:verboseName "Generics.Test (correctness)"} Impl$$Generics.__default.Test() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Generics.Test (correctness)"} Impl$$Generics.__default.Test() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var defass#tripler#0: bool;
  var tripler#0: ref
     where defass#tripler#0
       ==> $Is(tripler#0, Tclass.Generics.Triple())
         && $IsAlloc(tripler#0, Tclass.Generics.Triple(), $Heap);
  var $nw: ref;
  var x#0: int;
  var $rhs##0: int;
  var t##0: int;

    // AddMethodImpl: Test, Impl$$Generics.__default.Test
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(377,17)
    assume true;
    // ----- init call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(377,20)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id333"} $nw := Call$$Generics.Triple.__ctor();
    // TrCallStmt: After ProcessCallStmt
    tripler#0 := $nw;
    defass#tripler#0 := true;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(378,26)
    assume true;
    // TrCallStmt: Adding lhs with type int
    // TrCallStmt: Before ProcessCallStmt
    assert {:id "id335"} defass#tripler#0;
    assume true;
    assert {:id "id336"} tripler#0 != null;
    assume true;
    // ProcessCallStmt: CheckSubrange
    t##0 := LitInt(42);
    call {:id "id337"} $rhs##0 := Call$$Generics.Triple.Call(tripler#0, t##0);
    // TrCallStmt: After ProcessCallStmt
    x#0 := $rhs##0;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(379,5)
    assume true;
    assume true;
    assume true;
}
...
procedure {:verboseName "Generics.Identity.Call (well-formedness)"} CheckWellFormed$$Generics.Identity.Call(Generics.Identity.Call$T: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass.Generics.Identity())
         && $IsAlloc(this, Tclass.Generics.Identity(), $Heap), 
    x#0: Box
       where $IsBox(x#0, Generics.Identity.Call$T)
         && $IsAllocBox(x#0, Generics.Identity.Call$T, $Heap))
   returns (r#0: Box
       where $IsBox(r#0, Generics.Identity.Call$T)
         && $IsAllocBox(r#0, Generics.Identity.Call$T, $Heap));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Generics.Identity.Call (call)"} Call$$Generics.Identity.Call(Generics.Identity.Call$T: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass.Generics.Identity())
...
procedure {:verboseName "Generics.IdentityImpl.Call (well-formedness)"} CheckWellFormed$$Generics.IdentityImpl.Call(Generics.IdentityImpl.Call$T: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass.Generics.IdentityImpl())
         && $IsAlloc(this, Tclass.Generics.IdentityImpl(), $Heap), 
    x#0: Box
       where $IsBox(x#0, Generics.IdentityImpl.Call$T)
         && $IsAllocBox(x#0, Generics.IdentityImpl.Call$T, $Heap))
   returns (r#0: Box
       where $IsBox(r#0, Generics.IdentityImpl.Call$T)
         && $IsAllocBox(r#0, Generics.IdentityImpl.Call$T, $Heap));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Generics.IdentityImpl.Call (override check)"} OverrideCheck$$Generics.IdentityImpl.Call(Generics.IdentityImpl.Call$T: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass.Generics.IdentityImpl())
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Generics.IdentityImpl.Call (override check)"} OverrideCheck$$Generics.IdentityImpl.Call(Generics.IdentityImpl.Call$T: Ty, this: ref, x#0: Box) returns (r#0: Box)
{
  var Generics.Identity.Call$T: Ty;

    assume Generics.Identity.Call$T == Generics.IdentityImpl.Call$T;
    assert {:id "id339"} true;
    assert {:id "id340"} (forall $o: ref, $f: Field :: true);
...
procedure {:verboseName "Generics.IdentityImpl.Call (call)"} Call$$Generics.IdentityImpl.Call(Generics.IdentityImpl.Call$T: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass.Generics.IdentityImpl())
...
procedure {:verboseName "Generics.IdentityImpl.Call (correctness)"} Impl$$Generics.IdentityImpl.Call(Generics.IdentityImpl.Call$T: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass.Generics.IdentityImpl())
   ...
   returns (defass#r#0: bool, 
    r#0: Box
       where defass#r#0
         ==> $IsBox(r#0, Generics.IdentityImpl.Call$T)
           && $IsAllocBox(r#0, Generics.IdentityImpl.Call$T, $Heap), 
    $_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Generics.IdentityImpl.Call (correctness)"} Impl$$Generics.IdentityImpl.Call(Generics.IdentityImpl.Call$T: Ty, this: ref, x#0: Box)
   returns (defass#r#0: bool, r#0: Box, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;

    // AddMethodImpl: Call, Impl$$Generics.IdentityImpl.Call
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(340,9)
    assume true;
    assume true;
    r#0 := x#0;
    defass#r#0 := true;
    assert {:id "id343"} defass#r#0;
}
...
procedure {:verboseName "Generics.Function.Call (well-formedness)"} CheckWellFormed$$Generics.Function.Call(Generics.Function$T: Ty, 
    Generics.Function$R: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass.Generics.Function(Generics.Function$T, Generics.Function$R))
         && $IsAlloc(this, Tclass.Generics.Function(Generics.Function$T, Generics.Function$R), $Heap), 
    t#0: Box
       where $IsBox(t#0, Generics.Function$T) && $IsAllocBox(t#0, Generics.Function$T, $Heap))
   returns (r#0: Box
       where $IsBox(r#0, Generics.Function$R) && $IsAllocBox(r#0, Generics.Function$R, $Heap));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Generics.Function.Call (call)"} Call$$Generics.Function.Call(Generics.Function$T: Ty, 
    Generics.Function$R: Ty, 
    this: ref
       where this != null
         && 
...
procedure {:verboseName "Generics.Function.Compose (well-formedness)"} CheckWellFormed$$Generics.Function.Compose(Generics.Function$T: Ty, 
    Generics.Function$R: Ty, 
    Generics.Function.Compose$S: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass.Generics.Function(Generics.Function$T, Generics.Function$R))
         && $IsAlloc(this, Tclass.Generics.Function(Generics.Function$T, Generics.Function$R), $Heap), 
    f#0: ref
       where $Is(f#0, Tclass.Generics.Function(Generics.Function.Compose$S, Generics.Function$T))
         && $IsAlloc(f#0, 
          Tclass.Generics.Function(Generics.Function.Compose$S, Generics.Function$T), 
          $Heap))
   returns (res#0: ref
       where $Is(res#0, 
          Tclass.Generics.Function(Generics.Function.Compose$S, Generics.Function$R))
         && $IsAlloc(res#0, 
          Tclass.Generics.Function(Generics.Function.Compose$S, Generics.Function$R), 
          $Heap));
...
procedure {:verboseName "Generics.Function.Compose (call)"} Call$$Generics.Function.Compose(Generics.Function$T: Ty, 
    Generics.Function$R: Ty, 
    Generics.Function.Compose$S: Ty, 
    this: ref
       where this != null
...
procedure {:verboseName "Generics.Function.Compose (correctness)"} Impl$$Generics.Function.Compose(Generics.Function$T: Ty, 
    Generics.Function$R: Ty, 
    Generics.Function.Compose$S: Ty, 
    this: ref
       where this != null
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Generics.Function.Compose (correctness)"} Impl$$Generics.Function.Compose(Generics.Function$T: Ty, 
    Generics.Function$R: Ty, 
    Generics.Function.Compose$S: Ty, 
    this: ref, 
    f#0: ref)
   returns (defass#res#0: bool, res#0: ref, $_reverifyPost: bool)
{
  ...
  var second##0: ref;
    ...
    // AddMethodImpl: Compose, Impl$$Generics.Function.Compose
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(348,11)
    assume true;
    // ----- init call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(348,14)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    first##0 := f#0;
    ...
    // ProcessCallStmt: CheckSubrange
    second##0 := this;
    call {:id "id344"} $nw := Call$$Generics.ComposedFunction.__ctor(Generics.Function.Compose$S, Generics.Function$T, Generics.Function$R, first##0, second##0);
    // TrCallStmt: After ProcessCallStmt
    res#0 := $nw;
    defass#res#0 := true;
    assert {:id "id346"} defass#res#0;
}
...
axiom 1 < $FunctionContextHeight
   ==> (forall Generics.ComposedFunction$S: Ty, 
      Generics.ComposedFunction$T: Ty, 
      Generics.ComposedFunction$RR: Ty, 
      $o: ref :: 
...
procedure {:verboseName "Generics.ComposedFunction._ctor (well-formedness)"} CheckWellFormed$$Generics.ComposedFunction.__ctor(Generics.ComposedFunction$S: Ty, 
    Generics.ComposedFunction$T: Ty, 
    Generics.ComposedFunction$RR: Ty, 
    first#0: ref
       where $Is(first#0, 
...
procedure {:verboseName "Generics.ComposedFunction._ctor (call)"} Call$$Generics.ComposedFunction.__ctor(Generics.ComposedFunction$S: Ty, 
    Generics.ComposedFunction$T: Ty, 
    Generics.ComposedFunction$RR: Ty, 
    first#0: ref
       where $Is(first#0, 
...
procedure {:verboseName "Generics.ComposedFunction._ctor (correctness)"} Impl$$Generics.ComposedFunction.__ctor(Generics.ComposedFunction$S: Ty, 
    Generics.ComposedFunction$T: Ty, 
    Generics.ComposedFunction$RR: Ty, 
    first#0: ref
       where $Is(first#0, 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Generics.ComposedFunction._ctor (correctness)"} Impl$$Generics.ComposedFunction.__ctor(Generics.ComposedFunction$S: Ty, 
    Generics.ComposedFunction$T: Ty, 
    Generics.ComposedFunction$RR: Ty, 
    first#0: ref, 
    second#0: ref)
   returns (this: ref, $_reverifyPost: bool)
{
  ...
  var this.first: ref;
  var this.second: ref;
  var defass#this.first: bool;
  var defass#this.second: bool;

    // AddMethodImpl: _ctor, Impl$$Generics.ComposedFunction.__ctor
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- divided block before new; ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(358,65)
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(359,18)
    assume true;
    assume true;
    this.first := first#0;
    defass#this.first := true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(360,19)
    assume true;
    assume true;
    this.second := second#0;
    defass#this.second := true;
    // ----- new; ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(358,65)
    assert {:id "id349"} defass#this.first;
    assert {:id "id350"} defass#this.second;
    assume this != null
       && $Is(this, 
        Tclass.Generics.ComposedFunction?(Generics.ComposedFunction$S, 
          Generics.ComposedFunction$T, 
    ...
    assume Generics.ComposedFunction.first(Generics.ComposedFunction$S, 
        Generics.ComposedFunction$T, 
        Generics.ComposedFunction$RR, 
        this)
       == this.first;
    assume Generics.ComposedFunction.second(Generics.ComposedFunction$S, 
        Generics.ComposedFunction$T, 
        Generics.ComposedFunction$RR, 
        this)
       == this.second;
    ...
    // ----- divided block after new; ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(358,65)
}



procedure {:verboseName "Generics.ComposedFunction.Call (well-formedness)"} CheckWellFormed$$Generics.ComposedFunction.Call(Generics.ComposedFunction$S: Ty, 
    Generics.ComposedFunction$T: Ty, 
    Generics.ComposedFunction$RR: Ty, 
    this: ref
       where this != null
        ...
        $Is(this, 
         ...
         && $IsAlloc(this, 
          ...
          $Heap), 
    s#0: Box
       where $IsBox(s#0, Generics.ComposedFunction$S)
         && $IsAllocBox(s#0, Generics.ComposedFunction$S, $Heap))
   returns (r#0: Box
       where $IsBox(r#0, Generics.ComposedFunction$RR)
         && $IsAllocBox(r#0, Generics.ComposedFunction$RR, $Heap));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Generics.ComposedFunction.Call (override check)"} OverrideCheck$$Generics.ComposedFunction.Call(Generics.ComposedFunction$S: Ty, 
    Generics.ComposedFunction$T: Ty, 
    Generics.ComposedFunction$RR: Ty, 
    this: ref
       where this != null
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Generics.ComposedFunction.Call (override check)"} OverrideCheck$$Generics.ComposedFunction.Call(Generics.ComposedFunction$S: Ty, 
    Generics.ComposedFunction$T: Ty, 
    Generics.ComposedFunction$RR: Ty, 
    this: ref, 
    s#0: Box)
   returns (r#0: Box)
{
  var Generics.Function$T: Ty;
  var Generics.Function$R: Ty;

    assume Generics.Function$T == Generics.ComposedFunction$S;
    assume Generics.Function$R == Generics.ComposedFunction$RR;
    assert {:id "id351"} (forall $o: ref, $f: Field :: true);
    assert {:id "id352"} (forall $o: ref, $f: Field :: true);
    havoc $Heap;
    assume (forall $o: ref :: 
      { $Heap[$o] } 
      $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
...
procedure {:verboseName "Generics.ComposedFunction.Call (call)"} Call$$Generics.ComposedFunction.Call(Generics.ComposedFunction$S: Ty, 
    Generics.ComposedFunction$T: Ty, 
    Generics.ComposedFunction$RR: Ty, 
    this: ref
       where this != null
...
procedure {:verboseName "Generics.ComposedFunction.Call (correctness)"} Impl$$Generics.ComposedFunction.Call(Generics.ComposedFunction$S: Ty, 
    Generics.ComposedFunction$T: Ty, 
    Generics.ComposedFunction$RR: Ty, 
    this: ref
       where this != null
   ...
   returns (defass#r#0: bool, 
    r#0: Box
       where defass#r#0
         ==> $IsBox(r#0, Generics.ComposedFunction$RR)
           && $IsAllocBox(r#0, Generics.ComposedFunction$RR, $Heap), 
    $_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Generics.ComposedFunction.Call (correctness)"} Impl$$Generics.ComposedFunction.Call(Generics.ComposedFunction$S: Ty, 
    Generics.ComposedFunction$T: Ty, 
    Generics.ComposedFunction$RR: Ty, 
    this: ref, 
    s#0: Box)
   returns (defass#r#0: bool, r#0: Box, $_reverifyPost: bool)
{
  ...
  var t#0: Box
     where defass#t#0
       ==> $IsBox(t#0, Generics.ComposedFunction$T)
         && $IsAllocBox(t#0, Generics.ComposedFunction$T, $Heap);
  var $rhs##0: Box;
  var t##0: Box;
  var $rhs##1: Box;
  var t##1: Box;

    // AddMethodImpl: Call, Impl$$Generics.ComposedFunction.Call
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(364,26)
    assume true;
    // TrCallStmt: Adding lhs with type T
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    assert {:id "id353"} Generics.ComposedFunction.first(Generics.ComposedFunction$S, 
        Generics.ComposedFunction$T, 
        Generics.ComposedFunction$RR, 
        this)
       != null;
    ...
    // ProcessCallStmt: CheckSubrange
    t##0 := s#0;
    call {:id "id354"} $rhs##0 := Call$$Generics.Function.Call(Generics.ComposedFunction$S, Generics.ComposedFunction$T, Generics.ComposedFunction.first(Generics.ComposedFunction$S, 
      Generics.ComposedFunction$T, 
      Generics.ComposedFunction$RR, 
      this), t##0);
    // TrCallStmt: After ProcessCallStmt
    t#0 := $rhs##0;
    defass#t#0 := true;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(365,23)
    assume true;
    // TrCallStmt: Adding lhs with type RR
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    assert {:id "id356"} Generics.ComposedFunction.second(Generics.ComposedFunction$S, 
        Generics.ComposedFunction$T, 
        Generics.ComposedFunction$RR, 
        this)
       != null;
    assert {:id "id357"} defass#t#0;
    assume true;
    // ProcessCallStmt: CheckSubrange
    t##1 := t#0;
    call {:id "id358"} $rhs##1 := Call$$Generics.Function.Call(Generics.ComposedFunction$T, Generics.ComposedFunction$RR, Generics.ComposedFunction.second(Generics.ComposedFunction$S, 
      Generics.ComposedFunction$T, 
      Generics.ComposedFunction$RR, 
      this), t##1);
    // TrCallStmt: After ProcessCallStmt
...
procedure {:verboseName "Generics.Triple._ctor (well-formedness)"} CheckWellFormed$$Generics.Triple.__ctor() returns (this: ref);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Generics.Triple._ctor (call)"} Call$$Generics.Triple.__ctor()
   returns (this: ref
       where this != null
         && 
        $Is(this, Tclass.Generics.Triple())
         && $IsAlloc(this, Tclass.Generics.Triple(), $Heap));
  modifies $Heap;
  // constructor allocates the object
  ensures !$Unbox(read(old($Heap), this, alloc)): bool;
  // frame condition: object granularity
...
procedure {:verboseName "Generics.Triple._ctor (correctness)"} Impl$$Generics.Triple.__ctor() returns (this: ref, $_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
procedure {:verboseName "Generics.Triple.Call (well-formedness)"} CheckWellFormed$$Generics.Triple.Call(this: ref
       where this != null
         && 
        $Is(this, Tclass.Generics.Triple())
         && $IsAlloc(this, Tclass.Generics.Triple(), $Heap), 
...
procedure {:verboseName "Generics.Triple.Call (override check)"} OverrideCheck$$Generics.Triple.Call(this: ref
       where this != null
         && 
        $Is(this, Tclass.Generics.Triple())
         && $IsAlloc(this, Tclass.Generics.Triple(), $Heap), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Generics.Triple.Call (override check)"} OverrideCheck$$Generics.Triple.Call(this: ref, t#0: int) returns (r#0: int)
{
  var Generics.Function$T: Ty;
  var Generics.Function$R: Ty;

    assume Generics.Function$T == TInt;
    assume Generics.Function$R == TInt;
    assert {:id "id361"} (forall $o: ref, $f: Field :: true);
    assert {:id "id362"} (forall $o: ref, $f: Field :: true);
    havoc $Heap;
    assume (forall $o: ref :: 
      { $Heap[$o] } 
      $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
...
procedure {:verboseName "Generics.Triple.Call (call)"} Call$$Generics.Triple.Call(this: ref
       where this != null
         && 
        $Is(this, Tclass.Generics.Triple())
         && $IsAlloc(this, Tclass.Generics.Triple(), $Heap), 
...
procedure {:verboseName "Generics.Triple.Call (correctness)"} Impl$$Generics.Triple.Call(this: ref
       where this != null
         && 
        $Is(this, Tclass.Generics.Triple())
         && $IsAlloc(this, Tclass.Generics.Triple(), $Heap), 
