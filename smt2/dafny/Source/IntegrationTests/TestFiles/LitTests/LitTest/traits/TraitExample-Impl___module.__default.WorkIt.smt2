...
(declare-fun |_module.Automobile.Brand#canCall| (T@U) Bool)
(set-info :boogie-vc-id Impl$$_module.__default.WorkIt)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@0 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |auto#0|) _module.Automobile.Repr)))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (or (not (= |auto#0| null)) (not true))) (=> (or (not (= |auto#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 14)) (forall (($o@@9 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@9) alloc)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |auto#0|) _module.Automobile.Repr)) ($Box refType $o@@9))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@9 $f@@1)))
 :qid |TraitExampledfy.142:13|
 :skolemid |493|
))) (=> (forall (($o@@10 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@10) alloc)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |auto#0|) _module.Automobile.Repr)) ($Box refType $o@@10))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@10 $f@@2)))
 :qid |TraitExampledfy.142:13|
 :skolemid |493|
)) (and (=> (= (ControlFlow 0 2) (- 0 13)) (_module.Automobile.Valid $Heap@@0 |auto#0|)) (=> (_module.Automobile.Valid $Heap@@0 |auto#0|) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (|_module.Automobile.Valid#canCall| $Heap@0 |auto#0|) (_module.Automobile.Valid $Heap@0 |auto#0|))) (=> (and (and (and (forall (($o@@11 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |auto#0|) _module.Automobile.Repr)) ($Box refType $o@@11)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |auto#0|) _module.Automobile.Repr)) ($Box refType $o@@11)))) (or (not (= $o@@11 null)) (not true)))
 :qid |TraitExampledfy.13:24|
 :skolemid |510|
 :pattern (  (or (not (= $o@@11 null)) (not true)))
)) (forall (($o@@12 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |auto#0|) _module.Automobile.Repr)) ($Box refType $o@@12)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |auto#0|) _module.Automobile.Repr)) ($Box refType $o@@12)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@12) alloc)))))
 :qid |TraitExampledfy.13:24|
 :skolemid |511|
...
))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |auto#0|) _module.Automobile.position))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |auto#0|) _module.Automobile.position))))) (and (forall (($o@@13 T@U) ) (!  (=> (and (or (not (= $o@@13 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@13) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@13) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@13)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |auto#0|) _module.Automobile.Repr)) ($Box refType $o@@13))))
 :qid |TraitExampledfy.10:10|
 :skolemid |512|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@13))
)) ($HeapSucc $Heap@@0 $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (or (not (= |auto#0| null)) (not true))) (=> (or (not (= |auto#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 11)) (forall (($o@@14 T@U) ($f@@3 T@U) ) (!  (=> (and (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@14) alloc)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |auto#0|) _module.Automobile.Repr)) ($Box refType $o@@14))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@14 $f@@3)))
 :qid |TraitExampledfy.143:13|
 :skolemid |494|
))) (=> (forall (($o@@15 T@U) ($f@@4 T@U) ) (!  (=> (and (and (or (not (= $o@@15 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@15) alloc)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |auto#0|) _module.Automobile.Repr)) ($Box refType $o@@15))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@15 $f@@4)))
 :qid |TraitExampledfy.143:13|
 :skolemid |494|
)) (and (=> (= (ControlFlow 0 2) (- 0 10)) (_module.Automobile.Valid $Heap@0 |auto#0|)) (=> (_module.Automobile.Valid $Heap@0 |auto#0|) (=> (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (|_module.Automobile.Valid#canCall| $Heap@1 |auto#0|) (_module.Automobile.Valid $Heap@1 |auto#0|))) (=> (and (and (and (forall (($o@@16 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |auto#0|) _module.Automobile.Repr)) ($Box refType $o@@16)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |auto#0|) _module.Automobile.Repr)) ($Box refType $o@@16)))) (or (not (= $o@@16 null)) (not true)))
 :qid |TraitExampledfy.13:24|
 :skolemid |510|
 :pattern (  (or (not (= $o@@16 null)) (not true)))
)) (forall (($o@@17 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |auto#0|) _module.Automobile.Repr)) ($Box refType $o@@17)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |auto#0|) _module.Automobile.Repr)) ($Box refType $o@@17)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@17) alloc)))))
 :qid |TraitExampledfy.13:24|
 :skolemid |511|
...
))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |auto#0|) _module.Automobile.position))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |auto#0|) _module.Automobile.position))))) (and (forall (($o@@18 T@U) ) (!  (=> (and (or (not (= $o@@18 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@18) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@18) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@18)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |auto#0|) _module.Automobile.Repr)) ($Box refType $o@@18))))
 :qid |TraitExampledfy.10:10|
 :skolemid |512|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@18))
)) ($HeapSucc $Heap@0 $Heap@1))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (or (not (= |auto#0| null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 8)) ($IsAlloc refType |auto#0| Tclass._module.Automobile $Heap@@0)) (=> ($IsAlloc refType |auto#0| Tclass._module.Automobile $Heap@@0) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= |auto#0| null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |auto#0|) _module.Automobile.position))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |auto#0|) _module.Automobile.position))))) (=> (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |auto#0|) _module.Automobile.position))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |auto#0|) _module.Automobile.position)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |auto#0| null)) (not true))) (=> ($IsAllocBox ($Box refType |auto#0|) Tclass._module.Automobile? $Heap@1) (=> (and (|_module.Automobile.Brand#canCall| |auto#0|) (|_module.Automobile.Brand#canCall| |auto#0|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |auto#0| null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |auto#0| null)) (not true))) (=> (or (not (= |auto#0| null)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |auto#0| _module.Automobile.position))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and ($Is refType |auto#0| Tclass._module.Automobile) ($IsAlloc refType |auto#0| Tclass._module.Automobile $Heap@@0)) (= 4 $FunctionContextHeight)) (and (_module.Automobile.Valid $Heap@@0 |auto#0|) (= (ControlFlow 0 16) 2))) anon0_correct))))
