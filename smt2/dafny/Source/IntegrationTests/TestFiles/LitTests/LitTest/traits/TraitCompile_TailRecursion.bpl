...
procedure {:verboseName "TailRecursion.Test (correctness)"} Impl$$TailRecursion.__default.Test() returns ($_reverifyPost: bool);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TailRecursion.Test (correctness)"} Impl$$TailRecursion.__default.Test() returns ($_reverifyPost: bool)
{
  ...
  var c#0: ref
     where defass#c#0
       ==> $Is(c#0, Tclass.TailRecursion.Class())
         && $IsAlloc(c#0, Tclass.TailRecursion.Class(), $Heap);
  var $nw: ref;
  var u##0: int;
  var v##0: int;
  var x#0: int;
  ...
  var $tmp##1: Box;
    ...
    // AddMethodImpl: Test, Impl$$TailRecursion.__default.Test
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(734,11)
    assume true;
    // ----- init call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(734,14)
    ...
    // ProcessCallStmt: CheckSubrange
    v##0 := LitInt(2);
    call {:id "id851"} $nw := Call$$TailRecursion.Class.__ctor(u##0, v##0);
    // TrCallStmt: After ProcessCallStmt
    c#0 := $nw;
    defass#c#0 := true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(736,11)
    assume true;
    assert {:id "id853"} defass#c#0;
    assert {:id "id854"} c#0 != null;
    // assume allocatedness for receiver argument to function
    assume $IsAllocBox($Box(c#0), Tclass.TailRecursion.Trait?(TInt), $Heap);
    ##g#0 := LitInt(15);
    // assume allocatedness for argument to function
    assume $IsAlloc(##g#0, TInt, $Heap);
    assert {:id "id855"} $Is(LitInt(1000000), Tclass._System.nat());
    ##n#0 := LitInt(1000000);
    // assume allocatedness for argument to function
    assume $IsAlloc(##n#0, Tclass._System.nat(), $Heap);
    assume TailRecursion.Trait.Daisy#canCall(TInt, $Heap, c#0, $Box(LitInt(15)), LitInt(1000000));
    assert {:id "id856"} defass#c#0;
    assert {:id "id857"} c#0 != null;
    // assume allocatedness for receiver argument to function
    assume $IsAllocBox($Box(c#0), Tclass.TailRecursion.Trait?(TInt), $Heap);
    ##g#1 := LitInt(15);
    // assume allocatedness for argument to function
    assume $IsAlloc(##g#1, TInt, $Heap);
    assert {:id "id858"} $Is(LitInt(999999), Tclass._System.nat());
    ##n#1 := LitInt(999999);
    // assume allocatedness for argument to function
    assume $IsAlloc(##n#1, Tclass._System.nat(), $Heap);
    assume TailRecursion.Trait.Daisy#canCall(TInt, $Heap, c#0, $Box(LitInt(15)), LitInt(999999));
    assume TailRecursion.Trait.Daisy#canCall(TInt, $Heap, c#0, $Box(LitInt(15)), LitInt(1000000))
       && TailRecursion.Trait.Daisy#canCall(TInt, $Heap, c#0, $Box(LitInt(15)), LitInt(999999));
    x#0 := $Unbox(TailRecursion.Trait.Daisy(TInt, $LS($LZ), $Heap, c#0, $Box(LitInt(15)), LitInt(1000000))): int
       + $Unbox(TailRecursion.Trait.Daisy(TInt, $LS($LZ), $Heap, c#0, $Box(LitInt(15)), LitInt(999999))): int;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(737,23)
    assume true;
    // TrCallStmt: Adding lhs with type int
    // TrCallStmt: Before ProcessCallStmt
    assert {:id "id860"} defass#c#0;
    assume true;
    assert {:id "id861"} c#0 != null;
    assume true;
    // ProcessCallStmt: CheckSubrange
    g##0 := LitInt(15);
    assume true;
    // ProcessCallStmt: CheckSubrange
    assert {:id "id862"} $Is(LitInt(1000000), Tclass._System.nat());
    n##0 := LitInt(1000000);
    call {:id "id863"} $tmp##0 := Call$$TailRecursion.Trait.Compute(TInt, c#0, $Box(g##0), n##0);
    havoc $rhs##0;
    assume $rhs##0 == $Unbox($tmp##0): int;
    // TrCallStmt: After ProcessCallStmt
    y#0 := $rhs##0;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(738,23)
    assume true;
    // TrCallStmt: Adding lhs with type int
    // TrCallStmt: Before ProcessCallStmt
    assert {:id "id865"} defass#c#0;
    assume true;
    assert {:id "id866"} c#0 != null;
    assume true;
    // ProcessCallStmt: CheckSubrange
    g##1 := LitInt(15);
    assume true;
    // ProcessCallStmt: CheckSubrange
    assert {:id "id867"} $Is(LitInt(999999), Tclass._System.nat());
    n##1 := LitInt(999999);
    call {:id "id868"} $tmp##1 := Call$$TailRecursion.Trait.Compute(TInt, c#0, $Box(g##1), n##1);
    havoc $rhs##1;
    assume $rhs##1 == $Unbox($tmp##1): int;
    // TrCallStmt: After ProcessCallStmt
    z#0 := $rhs##1;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(739,5)
    assume true;
    assume true;
    assume true;
    assume true;
...
axiom 0 <= $FunctionContextHeight
   ==> (forall TailRecursion.Trait$G: Ty, this: ref, g#0: Box :: 
...
axiom 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, TailRecursion.Trait$G: Ty, this: ref, g#0: Box :: 
...
axiom {:id "id870"} 0 <= $FunctionContextHeight
   ==> (forall TailRecursion.Trait$G: Ty, this: ref, g#0: Box :: 
    { TailRecursion.Trait.Id(TailRecursion.Trait$G, this, g#0) } 
    TailRecursion.Trait.Id#canCall(TailRecursion.Trait$G, this, g#0)
         || (0 < $FunctionContextHeight
...
axiom {:id "id871"} 0 <= $FunctionContextHeight
   ==> (forall TailRecursion.Trait$G: Ty, this: ref, g#0: Box :: 
...
procedure {:verboseName "TailRecursion.Trait.Id (well-formedness)"} CheckWellformed$$TailRecursion.Trait.Id(TailRecursion.Trait$G: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass.TailRecursion.Trait(TailRecursion.Trait$G))
         && $IsAlloc(this, Tclass.TailRecursion.Trait(TailRecursion.Trait$G), $Heap), 
    g#0: Box where $IsBox(g#0, TailRecursion.Trait$G));
...
axiom 1 <= $FunctionContextHeight
   ==> (forall TailRecursion.Trait$G: Ty, this: ref, g0#0: Box, g1#0: Box :: 
...
axiom 1 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, TailRecursion.Trait$G: Ty, this: ref, g0#0: Box, g1#0: Box :: 
...
procedure {:verboseName "TailRecursion.Trait.Combine (well-formedness)"} CheckWellformed$$TailRecursion.Trait.Combine(TailRecursion.Trait$G: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass.TailRecursion.Trait(TailRecursion.Trait$G))
         && $IsAlloc(this, Tclass.TailRecursion.Trait(TailRecursion.Trait$G), $Heap), 
    g0#0: Box where $IsBox(g0#0, TailRecursion.Trait$G), 
    g1#0: Box where $IsBox(g1#0, TailRecursion.Trait$G));
...
axiom 2 <= $FunctionContextHeight
   ==> (forall TailRecursion.Trait$G: Ty, 
      $ly: LayerType, 
      $Heap: Heap, 
      this: ref, 
      g#0: Box, 
...
axiom {:id "id873"} 2 <= $FunctionContextHeight
   ==> (forall TailRecursion.Trait$G: Ty, 
      $ly: LayerType, 
      $Heap: Heap, 
      this: ref, 
    ...
    TailRecursion.Trait.Daisy#canCall(TailRecursion.Trait$G, $Heap, this, g#0, n#0)
       ...
       ==> (n#0 != LitInt(0)
           ==> (n#0 == LitInt(1)
               ==> (var f#0 := TailRecursion.Trait.Id#Handle(TailRecursion.Trait$G, this); 
         ...
         && TailRecursion.Trait.Daisy(TailRecursion.Trait$G, $LS($ly), $Heap, this, g#0, n#0)
           == (if n#0 == LitInt(0)
             then g#0
               ...
               then (var f#0 := TailRecursion.Trait.Id#Handle(TailRecursion.Trait$G, this); 
...
axiom (forall TailRecursion.Trait$G: Ty, $self: ref, $heap: Heap, $fh$0x#0: Box :: 
  { Apply1(TailRecursion.Trait$G, 
      TailRecursion.Trait$G, 
      $heap, 
  ...
  Apply1(TailRecursion.Trait$G, 
      ...
      TailRecursion.Trait.Id#Handle(TailRecursion.Trait$G, $self), 
      $fh$0x#0)
     == TailRecursion.Trait.Id(TailRecursion.Trait$G, $self, $fh$0x#0));
...
axiom (forall TailRecursion.Trait$G: Ty, $self: ref, $heap: Heap, $fh$0x#0: Box :: 
  ...
  Requires1(TailRecursion.Trait$G, 
      ...
      TailRecursion.Trait.Id#Handle(TailRecursion.Trait$G, $self), 
      $fh$0x#0)
     == TailRecursion.Trait.Id#requires(TailRecursion.Trait$G, $self, $fh$0x#0));

axiom (forall $bx: Box, TailRecursion.Trait$G: Ty, $self: ref, $heap: Heap, $fh$0x#0: Box :: 
...
axiom (forall TailRecursion.Trait$G: Ty, $self: ref, $heap: Heap, $fh$0x#0: Box :: 
  { TailRecursion.Trait.Id(TailRecursion.Trait$G, $self, $fh$0x#0), $IsGoodHeap($heap) } 
  TailRecursion.Trait.Id(TailRecursion.Trait$G, $self, $fh$0x#0)
     == Apply1(TailRecursion.Trait$G, 
      TailRecursion.Trait$G, 
      $heap, 
...
procedure {:verboseName "TailRecursion.Trait.Daisy (well-formedness)"} CheckWellformed$$TailRecursion.Trait.Daisy(TailRecursion.Trait$G: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass.TailRecursion.Trait(TailRecursion.Trait$G))
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TailRecursion.Trait.Daisy (well-formedness)"} CheckWellformed$$TailRecursion.Trait.Daisy(TailRecursion.Trait$G: Ty, this: ref, g#0: Box, n#0: int)
{
  ...
  var b$reqreads#2: bool;
    ...
    if (*)
    {
        ...
        assume $IsBox(TailRecursion.Trait.Daisy(TailRecursion.Trait$G, $LS($LZ), $Heap, this, g#0, n#0), 
          TailRecursion.Trait$G);
        assume false;
    }
    else
    {
        ...
        if (n#0 == LitInt(0))
        {
            assume {:id "id874"} TailRecursion.Trait.Daisy(TailRecursion.Trait$G, $LS($LZ), $Heap, this, g#0, n#0)
               == g#0;
            assume true;
        ...
        else
        {
            ...
            {
                havoc f#Z#0;
                assert {:id "id875"} 0 != $FunctionContextHeight;
                assume {:id "id876"} let#0#0#0 == TailRecursion.Trait.Id#Handle(TailRecursion.Trait$G, this);
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#0#0#0, 
                  Tclass._System.___hTotalFunc1(TailRecursion.Trait$G, TailRecursion.Trait$G));
                assume {:id "id877"} f#Z#0 == let#0#0#0;
                // assume allocatedness for receiver argument to function
                assume $IsAllocBox($Box(this), Tclass.TailRecursion.Trait?(TailRecursion.Trait$G), $Heap);
                b$reqreads#0 := $_ReadsFrame[this, TailRecursion.Trait.h];
                ##g0#0 := Apply1(TailRecursion.Trait$G, 
                  TailRecursion.Trait$G, 
                  $Heap, 
                  f#Z#0, 
                  read($Heap, this, TailRecursion.Trait.h));
                // assume allocatedness for argument to function
                assume $IsAllocBox(##g0#0, TailRecursion.Trait$G, $Heap);
                b$reqreads#1 := $_ReadsFrame[this, TailRecursion.Trait.K];
                ##g1#0 := Apply1(TailRecursion.Trait$G, 
                  TailRecursion.Trait$G, 
                  $Heap, 
                  f#Z#0, 
                  read($Heap, this, TailRecursion.Trait.K));
                // assume allocatedness for argument to function
                assume $IsAllocBox(##g1#0, TailRecursion.Trait$G, $Heap);
                assume TailRecursion.Trait.Combine#canCall(TailRecursion.Trait$G, 
                  this, 
                  Apply1(TailRecursion.Trait$G, 
                    TailRecursion.Trait$G, 
                    $Heap, 
                  ...
                  Apply1(TailRecursion.Trait$G, 
                    ...
                    f#Z#0, 
                    read($Heap, this, TailRecursion.Trait.K)));
                assume {:id "id878"} TailRecursion.Trait.Daisy(TailRecursion.Trait$G, $LS($LZ), $Heap, this, g#0, n#0)
                   == TailRecursion.Trait.Combine(TailRecursion.Trait$G, 
                    this, 
                    Apply1(TailRecursion.Trait$G, 
                      TailRecursion.Trait$G, 
                ...
                assume $IsBox(TailRecursion.Trait.Daisy(TailRecursion.Trait$G, $LS($LZ), $Heap, this, g#0, n#0), 
                  TailRecursion.Trait$G);
                assert {:id "id879"} b$reqreads#0;
                assert {:id "id880"} b$reqreads#1;
                return;
            }
            else
            {
                ...
                ##g#0 := g#0;
                // assume allocatedness for argument to function
                assume $IsAllocBox(##g#0, TailRecursion.Trait$G, $Heap);
                assert {:id "id881"} $Is(n#0 - 2, Tclass._System.nat());
                ##n#0 := n#0 - 2;
                // assume allocatedness for argument to function
                assume $IsAlloc(##n#0, Tclass._System.nat(), $Heap);
                b$reqreads#2 := (forall $o: ref, $f: Field :: 
                  $o != null && $Unbox(read($Heap, $o, alloc)): bool && $o == this
                     ==> $_ReadsFrame[$o, $f]);
                assert {:id "id882"} 0 <= n#0
                   || (Set#Subset(Set#UnionOne(Set#Empty(): Set, $Box(this)), 
                      Set#UnionOne(Set#Empty(): Set, $Box(this)))
                     && !Set#Subset(Set#UnionOne(Set#Empty(): Set, $Box(this)), 
                      Set#UnionOne(Set#Empty(): Set, $Box(this))))
                   || ##n#0 == n#0;
                assert {:id "id883"} (Set#Subset(Set#UnionOne(Set#Empty(): Set, $Box(this)), 
                      Set#UnionOne(Set#Empty(): Set, $Box(this)))
                     && !Set#Subset(Set#UnionOne(Set#Empty(): Set, $Box(this)), 
                      Set#UnionOne(Set#Empty(): Set, $Box(this))))
                   || (Set#Equal(Set#UnionOne(Set#Empty(): Set, $Box(this)), 
                      Set#UnionOne(Set#Empty(): Set, $Box(this)))
                     && ##n#0 < n#0);
                assume TailRecursion.Trait.Daisy#canCall(TailRecursion.Trait$G, $Heap, this, g#0, n#0 - 2);
                assume {:id "id884"} TailRecursion.Trait.Daisy(TailRecursion.Trait$G, $LS($LZ), $Heap, this, g#0, n#0)
                   == TailRecursion.Trait.Daisy(TailRecursion.Trait$G, $LS($LZ), $Heap, this, g#0, n#0 - 2);
                assume TailRecursion.Trait.Daisy#canCall(TailRecursion.Trait$G, $Heap, this, g#0, n#0 - 2);
                // CheckWellformedWithResult: any expression
                assume $IsBox(TailRecursion.Trait.Daisy(TailRecursion.Trait$G, $LS($LZ), $Heap, this, g#0, n#0), 
                  TailRecursion.Trait$G);
                assert {:id "id885"} b$reqreads#0;
                assert {:id "id886"} b$reqreads#1;
                assert {:id "id887"} b$reqreads#2;
                return;
            }
        }
...
procedure {:verboseName "TailRecursion.Trait.Compute (well-formedness)"} CheckWellFormed$$TailRecursion.Trait.Compute(TailRecursion.Trait$G: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass.TailRecursion.Trait(TailRecursion.Trait$G))
         && $IsAlloc(this, Tclass.TailRecursion.Trait(TailRecursion.Trait$G), $Heap), 
    g#0: Box
       where $IsBox(g#0, TailRecursion.Trait$G)
         && $IsAllocBox(g#0, TailRecursion.Trait$G, $Heap), 
    n#0: int where LitInt(0) <= n#0)
   returns (r#0: Box
       where $IsBox(r#0, TailRecursion.Trait$G)
         && $IsAllocBox(r#0, TailRecursion.Trait$G, $Heap));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "TailRecursion.Trait.Compute (call)"} Call$$TailRecursion.Trait.Compute(TailRecursion.Trait$G: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass.TailRecursion.Trait(TailRecursion.Trait$G))
...
procedure {:verboseName "TailRecursion.Trait.Compute (correctness)"} Impl$$TailRecursion.Trait.Compute(TailRecursion.Trait$G: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass.TailRecursion.Trait(TailRecursion.Trait$G))
   ...
   returns (defass#r#0: bool, 
    r#0: Box
       where defass#r#0
         ==> $IsBox(r#0, TailRecursion.Trait$G)
           && $IsAllocBox(r#0, TailRecursion.Trait$G, $Heap), 
    $_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TailRecursion.Trait.Compute (correctness)"} Impl$$TailRecursion.Trait.Compute(TailRecursion.Trait$G: Ty, this: ref, g#0: Box, n#0: int)
   returns (defass#r#0: bool, r#0: Box, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var defass#f#1_0_0: bool;
  var f#1_0_0: HandleType
     where defass#f#1_0_0
       ==> $Is(f#1_0_0, 
          Tclass._System.___hTotalFunc1(TailRecursion.Trait$G, TailRecursion.Trait$G))
         && $IsAlloc(f#1_0_0, 
          Tclass._System.___hTotalFunc1(TailRecursion.Trait$G, TailRecursion.Trait$G), 
  ...
  var n##1_1_0: int;
    ...
    // AddMethodImpl: Compute, Impl$$TailRecursion.Trait.Compute
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(713,7)
    assume true;
    if (n#0 == LitInt(0))
    {
        // ----- return statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(714,9)
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(714,9)
        assume true;
        assume true;
        r#0 := g#0;
        defass#r#0 := true;
        assert {:id "id889"} defass#r#0;
        return;
    }
    else
    {
        // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(715,14)
        assume true;
        if (n#0 == LitInt(1))
        {
            // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(716,15)
            assume true;
            assert {:id "id890"} 0 != $FunctionContextHeight;
            assume true;
            f#1_0_0 := TailRecursion.Trait.Id#Handle(TailRecursion.Trait$G, this);
            defass#f#1_0_0 := true;
            // ----- return statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(717,9)
            // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(717,9)
            assume true;
            // assume allocatedness for receiver argument to function
            assume $IsAllocBox($Box(this), Tclass.TailRecursion.Trait?(TailRecursion.Trait$G), $Heap);
            assert {:id "id892"} defass#f#1_0_0;
            ##g0#1_0_0 := Apply1(TailRecursion.Trait$G, 
              TailRecursion.Trait$G, 
              $Heap, 
              f#1_0_0, 
              read($Heap, this, TailRecursion.Trait.h));
            // assume allocatedness for argument to function
            assume $IsAllocBox(##g0#1_0_0, TailRecursion.Trait$G, $Heap);
            assert {:id "id893"} defass#f#1_0_0;
            ##g1#1_0_0 := Apply1(TailRecursion.Trait$G, 
              TailRecursion.Trait$G, 
              $Heap, 
              f#1_0_0, 
              read($Heap, this, TailRecursion.Trait.K));
            // assume allocatedness for argument to function
            assume $IsAllocBox(##g1#1_0_0, TailRecursion.Trait$G, $Heap);
            assume TailRecursion.Trait.Combine#canCall(TailRecursion.Trait$G, 
              this, 
              Apply1(TailRecursion.Trait$G, 
                TailRecursion.Trait$G, 
            ...
            assume TailRecursion.Trait.Combine#canCall(TailRecursion.Trait$G, 
              ...
              Apply1(TailRecursion.Trait$G, 
                ...
                f#1_0_0, 
                read($Heap, this, TailRecursion.Trait.K)));
            r#0 := TailRecursion.Trait.Combine(TailRecursion.Trait$G, 
              this, 
              Apply1(TailRecursion.Trait$G, 
                TailRecursion.Trait$G, 
                $Heap, 
              ...
              Apply1(TailRecursion.Trait$G, 
                ...
                read($Heap, this, TailRecursion.Trait.K)));
            defass#r#0 := true;
            assert {:id "id895"} defass#r#0;
            return;
        }
        else
        {
            // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(719,21)
            assume true;
            ...
            assume true;
            // ProcessCallStmt: CheckSubrange
            assert {:id "id896"} $Is(n#0 - 2, Tclass._System.nat());
            n##1_1_0 := n#0 - 2;
            assert {:id "id897"} 0 <= n#0 || n##1_1_0 == n#0;
            assert {:id "id898"} n##1_1_0 < n#0;
            call {:id "id899"} $rhs##1_1_0 := Call$$TailRecursion.Trait.Compute(TailRecursion.Trait$G, this, g##1_1_0, n##1_1_0);
            // TrCallStmt: After ProcessCallStmt
            r#0 := $rhs##1_1_0;
            defass#r#0 := true;
        }
...
axiom {:id "id902"} 0 <= $FunctionContextHeight
   ==> (forall this: ref, g0#0: int, g1#0: int :: 
    { TailRecursion.Class.Combine(this, g0#0, g1#0) } 
    TailRecursion.Class.Combine#canCall(this, g0#0, g1#0)
         || (0 < $FunctionContextHeight
           && 
          this != null
           && $Is(this, Tclass.TailRecursion.Class()))
...
axiom {:id "id903"} 0 <= $FunctionContextHeight
   ==> (forall this: ref, g0#0: int, g1#0: int :: 
...
axiom {:id "id904"} 0 <= $FunctionContextHeight
   ==> (forall this: ref, g0#0: int, g1#0: int :: 
...
procedure {:verboseName "TailRecursion.Class.Combine (well-formedness)"} CheckWellformed$$TailRecursion.Class.Combine(this: ref
       where this != null
         && 
        $Is(this, Tclass.TailRecursion.Class())
         && $IsAlloc(this, Tclass.TailRecursion.Class(), $Heap), 
    g0#0: int, 
    g1#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "TailRecursion.Class.Combine (override check)"} OverrideCheck$$TailRecursion.Class.Combine(this: ref
       where this != null
         && 
        $Is(this, Tclass.TailRecursion.Class())
         && $IsAlloc(this, Tclass.TailRecursion.Class(), $Heap), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TailRecursion.Class.Combine (override check)"} OverrideCheck$$TailRecursion.Class.Combine(this: ref, g0#0: int, g1#0: int)
{
  var TailRecursion.Trait$G: Ty;
  var Class_$_ReadsFrame: [ref,Field]bool;

    assume TailRecursion.Trait$G == TInt;
    assert {:id "id906"} true;
    Class_$_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    assert {:id "id907"} (forall $o: ref, $f: Field :: true);
}



procedure {:verboseName "TailRecursion.Class._ctor (well-formedness)"} CheckWellFormed$$TailRecursion.Class.__ctor(u#0: int, v#0: int) returns (this: ref);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "TailRecursion.Class._ctor (call)"} Call$$TailRecursion.Class.__ctor(u#0: int, v#0: int)
   returns (this: ref
       where this != null
         && 
        $Is(this, Tclass.TailRecursion.Class())
...
procedure {:verboseName "TailRecursion.Class._ctor (correctness)"} Impl$$TailRecursion.Class.__ctor(u#0: int, v#0: int) returns (this: ref, $_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
