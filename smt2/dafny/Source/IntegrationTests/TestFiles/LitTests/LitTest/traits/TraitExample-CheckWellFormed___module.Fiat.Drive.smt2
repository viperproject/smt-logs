...
(set-info :boogie-vc-id CheckWellFormed$$_module.Fiat.Drive)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@1 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.Automobile.Repr)))) ($IsAllocBox ($Box refType this@@2) Tclass._module.Fiat? $Heap@@1)) (and (|_module.Fiat.Valid#canCall| $Heap@@1 this@@2) (_module.Fiat.Valid $Heap@@1 this@@2))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@13 T@U) ) (!  (=> (and (or (not (= $o@@13 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@13) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@13) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@13)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.Automobile.Repr)) ($Box refType $o@@13))))
 :qid |TraitExampledfy.33:10|
 :skolemid |545|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@13))
))) (and (and ($HeapSucc $Heap@@1 $Heap@0) ($IsAllocBox ($Box refType this@@2) Tclass._module.Fiat? $Heap@0)) (and (|_module.Fiat.Valid#canCall| $Heap@0 this@@2) (_module.Fiat.Valid $Heap@0 this@@2)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType this@@2 Tclass._module.Fiat $Heap@@1)) (=> ($IsAlloc refType this@@2 Tclass._module.Fiat $Heap@@1) (=> (and (and (forall (($o@@14 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Automobile.Repr)) ($Box refType $o@@14)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.Automobile.Repr)) ($Box refType $o@@14)))) (or (not (= $o@@14 null)) (not true)))
 :qid |TraitExampledfy.36:24|
 :skolemid |546|
 :pattern (  (or (not (= $o@@14 null)) (not true)))
)) (forall (($o@@15 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Automobile.Repr)) ($Box refType $o@@15)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.Automobile.Repr)) ($Box refType $o@@15)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@15) alloc)))))
 :qid |TraitExampledfy.36:24|
 :skolemid |547|
...
))) (= (ControlFlow 0 2) (- 0 1))) ($IsAlloc refType this@@2 Tclass._module.Fiat $Heap@@1))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.Fiat) ($IsAlloc refType this@@2 Tclass._module.Fiat $Heap@@1))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
