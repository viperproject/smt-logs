...
(assert (forall (($o@@4 T@U) ) (!  (=> ($Is refType $o@@4 Tclass.ChildIsNonRefTrait.ErrorChild?) ($Is refType $o@@4 Tclass.ChildIsNonRefTrait.Parent?))
 :qid |unknown.0:0|
 :skolemid |558|
 :pattern ( ($Is refType $o@@4 Tclass.ChildIsNonRefTrait.ErrorChild?))
)))
...
(assert (forall (($o@@6 T@U) ) (! (= ($Is refType $o@@6 Tclass.ChildIsNonRefTrait.ErrorChild?)  (or (= $o@@6 null) (implements$ChildIsNonRefTrait.ErrorChild (dtype $o@@6))))
 :qid |unknown.0:0|
 :skolemid |515|
 :pattern ( ($Is refType $o@@6 Tclass.ChildIsNonRefTrait.ErrorChild?))
)))
...
(declare-fun |p#0| () Int)
(set-info :boogie-vc-id OverrideCheck$$ChildIsNonRefTrait.ErrorChild.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (< (ChildIsNonRefTrait.Parent.yy this@@3) 100) (and (=> (= (ControlFlow 0 2) (- 0 6)) (< (ChildIsNonRefTrait.Parent.yy this@@3) 800)) (=> (< (ChildIsNonRefTrait.Parent.yy this@@3) 800) (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@7 T@U) ($f T@U) ) (! true
...
)) ($HeapSucc $Heap $Heap@0)) (and (< |p#0| (+ (+ (ChildIsNonRefTrait.Parent.yy this@@3) (ChildIsNonRefTrait.ErrorChild.F this@@3 (LitInt 5))) 100)) (= (ControlFlow 0 2) (- 0 1)))) (< |p#0| (+ (+ (ChildIsNonRefTrait.Parent.yy this@@3) (ChildIsNonRefTrait.ErrorChild.F this@@3 (LitInt 5))) 900))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.ChildIsNonRefTrait.ErrorChild) ($IsAlloc refType this@@3 Tclass.ChildIsNonRefTrait.ErrorChild $Heap))) (<= (LitInt 0) |p#0|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 7) 2))) anon0_correct))))
