...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (< (ChildIsRefTrait.Trait.yy this@@3) 300) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< (ChildIsRefTrait.Trait.yy this@@3) 800)) (=> (< (ChildIsRefTrait.Trait.yy this@@3) 800) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= |umpa#0@@3| |umpa#0@@3|)) (=> (<= |umpa#0@@3| |umpa#0@@3|) (=> (= ChildTrait_$_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@12 T@U) ($f@@0 T@U) ) true)) (=> (forall (($o@@13 T@U) ($f@@1 T@U) ) true) (=> (and (< (ChildIsRefTrait.ChildTrait.F this@@3 |umpa#0@@3|) (+ (ChildIsRefTrait.Trait.yy this@@3) 100)) (= (ControlFlow 0 2) (- 0 1))) (< (ChildIsRefTrait.ChildTrait.F this@@3 |umpa#0@@3|) (+ (ChildIsRefTrait.Trait.yy this@@3) 900)))))))))))))
