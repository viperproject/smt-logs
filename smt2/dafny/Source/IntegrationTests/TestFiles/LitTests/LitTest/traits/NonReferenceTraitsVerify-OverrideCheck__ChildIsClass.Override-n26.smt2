...
(set-info :boogie-vc-id OverrideCheck$$ChildIsClass.OverrideErrors.F)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (< (ChildIsClass.Trait.yy this@@3) 300) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< (ChildIsClass.Trait.yy this@@3) 200)) (=> (< (ChildIsClass.Trait.yy this@@3) 200) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= |umpa#0@@3| |umpa#0@@3|)) (=> (<= |umpa#0@@3| |umpa#0@@3|) (=> (= OverrideErrors_$_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@8 T@U) ($f@@0 T@U) ) (! true
 :qid |NonReferenceTraitsVerifydfy.189:14|
 :skolemid |1675|
))) (=> (forall (($o@@9 T@U) ($f@@1 T@U) ) (! true
 :qid |NonReferenceTraitsVerifydfy.189:14|
 :skolemid |1675|
)) (=> (and (< (ChildIsClass.OverrideErrors.F this@@3 |umpa#0@@3|) (+ (ChildIsClass.Trait.yy this@@3) 100)) (= (ControlFlow 0 2) (- 0 1))) (< (ChildIsClass.OverrideErrors.F this@@3 |umpa#0@@3|) (+ (ChildIsClass.Trait.yy this@@3) 900)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.ChildIsClass.OverrideErrors) ($IsAlloc refType this@@3 Tclass.ChildIsClass.OverrideErrors $Heap))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 2))) anon0_correct))))
