...
(declare-fun GenericBasics.Cl.Teen (T@U T@U T@U T@U) Int)
(declare-fun |GenericBasics.Cl.Teen#canCall| (T@U T@U T@U T@U) Bool)
...
(declare-fun GenericBasics.Cl$Q@@18 () T@U)
