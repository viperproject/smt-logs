...
(declare-fun NonCapturingFunctionCoercions._default.Identity$X () T@U)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 NonCapturingFunctionCoercions._default.Identity$X NonCapturingFunctionCoercions._default.Identity$X)) ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 NonCapturingFunctionCoercions._default.Identity$X NonCapturingFunctionCoercions._default.Identity$X) $Heap)) (=> |defass#g#0| (and ($Is HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 NonCapturingFunctionCoercions._default.Identity$X NonCapturingFunctionCoercions._default.Identity$X)) ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 NonCapturingFunctionCoercions._default.Identity$X NonCapturingFunctionCoercions._default.Identity$X) $Heap)))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
