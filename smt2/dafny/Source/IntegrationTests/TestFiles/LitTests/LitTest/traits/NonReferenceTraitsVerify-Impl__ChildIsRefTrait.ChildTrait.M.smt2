...
(declare-fun |p#0| () Int)
(set-info :boogie-vc-id Impl$$ChildIsRefTrait.ChildTrait.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($Is intType (int_2_U (+ (ChildIsRefTrait.Trait.yy this@@3) 101)) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ (ChildIsRefTrait.Trait.yy this@@3) 101)) Tclass._System.nat) (=> (and (= |p#0@0| (+ (ChildIsRefTrait.Trait.yy this@@3) 101)) (= (ControlFlow 0 2) (- 0 1))) (< |p#0@0| (+ (+ (ChildIsRefTrait.Trait.yy this@@3) (ChildIsRefTrait.ChildTrait.F this@@3 (LitInt 5))) 100))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.ChildIsRefTrait.ChildTrait) ($IsAlloc refType this@@3 Tclass.ChildIsRefTrait.ChildTrait $Heap)))) (and (and (<= (LitInt 0) |p#0|) (= 2 $FunctionContextHeight)) (and (< (ChildIsRefTrait.Trait.yy this@@3) 800) (= (ControlFlow 0 4) 2)))) anon0_correct)))
