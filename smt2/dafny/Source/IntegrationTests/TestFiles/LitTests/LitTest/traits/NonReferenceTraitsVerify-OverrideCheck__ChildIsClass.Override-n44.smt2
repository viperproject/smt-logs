...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (< (ChildIsClass.Trait.yy this@@3) 100) (and (=> (= (ControlFlow 0 2) (- 0 6)) (< (ChildIsClass.Trait.yy this@@3) 150)) (=> (< (ChildIsClass.Trait.yy this@@3) 150) (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@7 T@U) ($f T@U) ) true)) (=> (forall (($o@@8 T@U) ($f@@0 T@U) ) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@9 T@U) ($f@@1 T@U) ) true)) (=> (forall (($o@@10 T@U) ($f@@2 T@U) ) true) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (forall (($o@@11 T@U) ) (!  (=> (and (or (not (= $o@@11 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@11) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@11) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@11)))
