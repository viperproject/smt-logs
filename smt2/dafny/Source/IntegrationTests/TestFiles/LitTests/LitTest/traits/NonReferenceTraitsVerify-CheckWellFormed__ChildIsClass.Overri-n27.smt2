...
(assert (distinct TInt TagInt alloc Tagclass._System.nat Tagclass.ChildIsClass.Trait Tagclass.ChildIsClass.Trait? Tagclass.ChildIsClass.OverrideErrors? Tagclass.ChildIsClass.OverrideErrors tytagFamily$nat tytagFamily$Trait tytagFamily$OverrideErrors)
)
...
(assert (forall ((bx T@U) ($h@@0 T@U) ) (!  (=> (and ($IsAllocBox bx Tclass.ChildIsClass.OverrideErrors? $h@@0) ($IsGoodHeap $h@@0)) ($IsAllocBox bx Tclass.ChildIsClass.Trait? $h@@0))
 :qid |unknown.0:0|
 :skolemid |1693|
 :pattern ( ($IsAllocBox bx Tclass.ChildIsClass.OverrideErrors? $h@@0))
)))
...
(assert (forall ((|c#0@@0| T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType |c#0@@0| Tclass.ChildIsClass.OverrideErrors $h@@2) ($IsAlloc refType |c#0@@0| Tclass.ChildIsClass.OverrideErrors? $h@@2))
 :qid |unknown.0:0|
 :skolemid |1683|
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass.ChildIsClass.OverrideErrors $h@@2))
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass.ChildIsClass.OverrideErrors? $h@@2))
)))
...
(assert (forall (($o T@U) ($h@@3 T@U) ) (! (= ($IsAlloc refType $o Tclass.ChildIsClass.Trait? $h@@3)  (or (= $o null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1620|
 :pattern ( ($IsAlloc refType $o Tclass.ChildIsClass.Trait? $h@@3))
)))
(assert (forall (($o@@0 T@U) ($h@@4 T@U) ) (! (= ($IsAlloc refType $o@@0 Tclass.ChildIsClass.OverrideErrors? $h@@4)  (or (= $o@@0 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@0) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1667|
 :pattern ( ($IsAlloc refType $o@@0 Tclass.ChildIsClass.OverrideErrors? $h@@4))
)))
...
(assert  (=> (< 0 $FunctionContextHeight) (forall (($h@@5 T@U) ($o@@1 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@5) (and (or (not (= $o@@1 null)) (not true)) ($Is refType $o@@1 Tclass.ChildIsClass.Trait?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@1) alloc)))) ($IsAlloc intType (int_2_U (ChildIsClass.Trait.yy $o@@1)) Tclass._System.nat $h@@5))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1622|
 :pattern ( (ChildIsClass.Trait.yy $o@@1) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@1) alloc)))
))))
...
(assert (forall (($o@@5 T@U) ) (!  (=> ($Is refType $o@@5 Tclass.ChildIsClass.OverrideErrors?) ($Is refType $o@@5 Tclass.ChildIsClass.Trait?))
 :qid |unknown.0:0|
 :skolemid |1694|
 :pattern ( ($Is refType $o@@5 Tclass.ChildIsClass.OverrideErrors?))
)))
...
(assert (= (Tag Tclass.ChildIsClass.OverrideErrors) Tagclass.ChildIsClass.OverrideErrors))
(assert (= (TagFamily Tclass.ChildIsClass.OverrideErrors) tytagFamily$OverrideErrors))
(assert (forall (($o@@6 T@U) ) (! (= ($Is refType $o@@6 Tclass.ChildIsClass.Trait?)  (or (= $o@@6 null) (implements$ChildIsClass.Trait (dtype $o@@6))))
 :qid |unknown.0:0|
 :skolemid |1619|
 :pattern ( ($Is refType $o@@6 Tclass.ChildIsClass.Trait?))
)))
(assert (forall (($o@@7 T@U) ) (! (= ($Is refType $o@@7 Tclass.ChildIsClass.OverrideErrors?)  (or (= $o@@7 null) (implements$ChildIsClass.OverrideErrors (dtype $o@@7))))
 :qid |unknown.0:0|
 :skolemid |1666|
 :pattern ( ($Is refType $o@@7 Tclass.ChildIsClass.OverrideErrors?))
)))
...
(declare-fun |p#0| () Int)
(set-info :boogie-vc-id CheckWellFormed$$ChildIsClass.OverrideErrors.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (< (ChildIsClass.Trait.yy this@@3) 150)) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@8 T@U) ) (!  (=> (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@8) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@8) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@8)))
 :qid |NonReferenceTraitsVerifydfy.196:12|
 :skolemid |1676|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@8))
))) (and ($HeapSucc $Heap $Heap@0) (<= (LitInt 0) |p#0@0|))) (and (and ($IsAllocBox ($Box refType this@@3) Tclass.ChildIsClass.OverrideErrors? $Heap@0) (= |##umpa#0@0| (LitInt 5))) (and ($IsAlloc intType (int_2_U |##umpa#0@0|) TInt $Heap@0) (= (ControlFlow 0 2) (- 0 1))))) (< (ChildIsClass.Trait.yy this@@3) 200)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.ChildIsClass.OverrideErrors) ($IsAlloc refType this@@3 Tclass.ChildIsClass.OverrideErrors $Heap))) (<= (LitInt 0) |p#0|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
