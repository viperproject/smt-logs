...
(assert (forall ((_module.AnotherImpl$T@@8 T@U) ($h0 T@U) ($h1 T@U) (this@@0 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 (Tclass._module.AnotherImpl _module.AnotherImpl$T@@8)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@3 T@U) ($f T@U) )  (=> (and (or (not (= $o@@3 null)) (not true)) (or (= $o@@3 this@@0) (|Set#IsMember| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@8) this@@0) ($Box refType $o@@3)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@3) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@3) $f)))) (= (_module.AnotherImpl.Valid _module.AnotherImpl$T@@8 $h0 this@@0) (_module.AnotherImpl.Valid _module.AnotherImpl$T@@8 $h1 this@@0))))
