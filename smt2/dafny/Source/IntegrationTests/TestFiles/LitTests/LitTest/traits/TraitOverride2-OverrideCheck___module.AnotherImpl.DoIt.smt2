...
(assert (distinct TagSet TagSeq alloc Tagclass._System.object? Tagclass._System.object Tagclass._module.Spec? Tagclass._module.Spec Tagclass._module.AnotherImpl? Tagclass._module.AnotherImpl tytagFamily$object tytagFamily$Spec tytagFamily$AnotherImpl)
)
...
(assert (forall ((_module.AnotherImpl$T@@8 T@U) ($h0 T@U) ($h1 T@U) (this@@0 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 (Tclass._module.AnotherImpl _module.AnotherImpl$T@@8)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@3 T@U) ($f T@U) ) (!  (=> (and (or (not (= $o@@3 null)) (not true)) (or (= $o@@3 this@@0) (|Set#IsMember| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@8) this@@0) ($Box refType $o@@3)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@3) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@3) $f)))
 :qid |unknown.0:0|
 :skolemid |544|
...
(assert (forall ((_module.AnotherImpl$T@@9 T@U) ($o@@4 T@U) ) (! (= ($Is refType $o@@4 (Tclass._module.AnotherImpl? _module.AnotherImpl$T@@9))  (or (= $o@@4 null) (= (dtype $o@@4) (Tclass._module.AnotherImpl? _module.AnotherImpl$T@@9))))
 :qid |unknown.0:0|
 :skolemid |535|
 :pattern ( ($Is refType $o@@4 (Tclass._module.AnotherImpl? _module.AnotherImpl$T@@9)))
)))
...
(assert (forall ((_module.AnotherImpl$T@@10 T@U) (bx@@4 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsAllocBox bx@@4 (Tclass._module.AnotherImpl? _module.AnotherImpl$T@@10) $h@@5) ($IsGoodHeap $h@@5)) ($IsAllocBox bx@@4 (Tclass._module.Spec? (TSeq _module.AnotherImpl$T@@10)) $h@@5))
 :qid |unknown.0:0|
 :skolemid |585|
 :pattern ( ($IsAllocBox bx@@4 (Tclass._module.AnotherImpl? _module.AnotherImpl$T@@10) $h@@5))
)))
(assert (forall ((_module.AnotherImpl$T@@11 T@U) ($o@@6 T@U) ($heap T@U) ) (!  (=> ($IsAlloc refType $o@@6 (Tclass._module.AnotherImpl? _module.AnotherImpl$T@@11) $heap) ($IsAlloc refType $o@@6 (Tclass._module.Spec? (TSeq _module.AnotherImpl$T@@11)) $heap))
 :qid |unknown.0:0|
 :skolemid |587|
 :pattern ( ($IsAlloc refType $o@@6 (Tclass._module.AnotherImpl? _module.AnotherImpl$T@@11) $heap))
)))
...
(assert (forall ((_module.AnotherImpl$T@@15 T@U) (bx@@10 T@U) ) (!  (=> ($IsBox bx@@10 (Tclass._module.AnotherImpl? _module.AnotherImpl$T@@15)) (and (= ($Box refType ($Unbox refType bx@@10)) bx@@10) ($Is refType ($Unbox refType bx@@10) (Tclass._module.AnotherImpl? _module.AnotherImpl$T@@15))))
 :qid |unknown.0:0|
 :skolemid |534|
 :pattern ( ($IsBox bx@@10 (Tclass._module.AnotherImpl? _module.AnotherImpl$T@@15)))
)))
(assert (forall ((_module.AnotherImpl$T@@16 T@U) (bx@@11 T@U) ) (!  (=> ($IsBox bx@@11 (Tclass._module.AnotherImpl _module.AnotherImpl$T@@16)) (and (= ($Box refType ($Unbox refType bx@@11)) bx@@11) ($Is refType ($Unbox refType bx@@11) (Tclass._module.AnotherImpl _module.AnotherImpl$T@@16))))
 :qid |unknown.0:0|
 :skolemid |541|
 :pattern ( ($IsBox bx@@11 (Tclass._module.AnotherImpl _module.AnotherImpl$T@@16)))
)))
...
(assert (forall ((v@@5 T@U) (t0@@3 T@U) ) (! (= ($Is SeqType v@@5 (TSeq t0@@3)) (forall ((i@@0 Int) ) (!  (=> (and (<= 0 i@@0) (< i@@0 (|Seq#Length| v@@5))) ($IsBox (|Seq#Index| v@@5 i@@0) t0@@3))
 ...
 :skolemid |54|
 :pattern ( ($Is SeqType v@@5 (TSeq t0@@3)))
)))
(push 1)
...
(declare-fun |u#0| () T@U)
(set-info :boogie-vc-id OverrideCheck$$_module.AnotherImpl.DoIt)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (and (= _module.Spec$U@@11 (TSeq _module.AnotherImpl$T@@17)) (_module.AnotherImpl.Valid _module.AnotherImpl$T@@17 $Heap@@1 this@@2)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.AnotherImpl.Valid#canCall| _module.AnotherImpl$T@@17 $Heap@@1 this@@2) (or (_module.AnotherImpl.Valid _module.AnotherImpl$T@@17 $Heap@@1 this@@2) (|Set#IsMember| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@17) this@@2) ($Box refType this@@2))))) (=> (=> (|_module.AnotherImpl.Valid#canCall| _module.AnotherImpl$T@@17 $Heap@@1 this@@2) (or (_module.AnotherImpl.Valid _module.AnotherImpl$T@@17 $Heap@@1 this@@2) (|Set#IsMember| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@17) this@@2) ($Box refType this@@2)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Set#Subset| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@17) this@@2) (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@17) this@@2))) (=> (|Set#Subset| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@17) this@@2) (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@17) this@@2)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@10 T@U) ($f@@0 T@U) ) (! true
 :qid |TraitOverride2dfy.79:10|
 :skolemid |552|
))) (=> (forall (($o@@11 T@U) ($f@@1 T@U) ) (! true
 :qid |TraitOverride2dfy.79:10|
 :skolemid |552|
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@12 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@12 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@12) alloc)))) (|Set#IsMember| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@17) this@@2) ($Box refType $o@@12))) (|Set#IsMember| (_module.Spec.Repr _module.Spec$U@@11 this@@2) ($Box refType $o@@12)))
 :qid |TraitOverride2dfy.79:10|
 :skolemid |553|
))) (=> (forall (($o@@13 T@U) ($f@@3 T@U) ) (!  (=> (and (and (or (not (= $o@@13 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@13) alloc)))) (|Set#IsMember| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@17) this@@2) ($Box refType $o@@13))) (|Set#IsMember| (_module.Spec.Repr _module.Spec$U@@11 this@@2) ($Box refType $o@@13)))
 :qid |TraitOverride2dfy.79:10|
 :skolemid |553|
)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@14 T@U) ) (!  (=> (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@14) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@14) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@14)) (|Set#IsMember| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@17) this@@2) ($Box refType $o@@14))))
 :qid |TraitOverride2dfy.79:10|
 :skolemid |554|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@14))
)) ($HeapSucc $Heap@@1 $Heap@0))) (and (and (_module.AnotherImpl.Valid _module.AnotherImpl$T@@17 $Heap@0 this@@2) (= (ControlFlow 0 2) (- 0 1))) (|_module.AnotherImpl.Valid#canCall| _module.AnotherImpl$T@@17 $Heap@0 this@@2))) (or (_module.AnotherImpl.Valid _module.AnotherImpl$T@@17 $Heap@0 this@@2) (|Set#IsMember| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@17) this@@2) ($Box refType this@@2)))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 (Tclass._module.AnotherImpl _module.AnotherImpl$T@@17)) ($IsAlloc refType this@@2 (Tclass._module.AnotherImpl _module.AnotherImpl$T@@17) $Heap@@1)))) (and (and ($Is SeqType |u#0| (TSeq _module.AnotherImpl$T@@17)) ($IsAlloc SeqType |u#0| (TSeq _module.AnotherImpl$T@@17) $Heap@@1)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 7) 2)))) anon0_correct)))
