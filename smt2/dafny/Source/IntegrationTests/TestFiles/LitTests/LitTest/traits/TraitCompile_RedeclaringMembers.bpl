...
procedure {:verboseName "RedeclaringMembers.A.Valid (well-formedness)"} CheckWellformed$$RedeclaringMembers.A.Valid(this: ref
       where this != null
         && 
        $Is(this, Tclass.RedeclaringMembers.A())
         && $IsAlloc(this, Tclass.RedeclaringMembers.A(), $Heap));
   ...
   ==> (forall this: ref :: 
    ...
    RedeclaringMembers.B.Valid#canCall(this)
         || (1 < $FunctionContextHeight
           && 
          this != null
           && $Is(this, Tclass.RedeclaringMembers.B()))
       ==> RedeclaringMembers.A.Valid(this) == RedeclaringMembers.B.Valid(this));

procedure {:verboseName "RedeclaringMembers.B.Valid (well-formedness)"} CheckWellformed$$RedeclaringMembers.B.Valid(this: ref
       where this != null
         && 
        $Is(this, Tclass.RedeclaringMembers.B())
         && $IsAlloc(this, Tclass.RedeclaringMembers.B(), $Heap));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "RedeclaringMembers.B.Valid (override check)"} OverrideCheck$$RedeclaringMembers.B.Valid(this: ref
       where this != null
         && 
        $Is(this, Tclass.RedeclaringMembers.B())
         && $IsAlloc(this, Tclass.RedeclaringMembers.B(), $Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "RedeclaringMembers.B.Valid (override check)"} OverrideCheck$$RedeclaringMembers.B.Valid(this: ref)
{
  var B_$_ReadsFrame: [ref,Field]bool;

    assert {:id "id969"} true;
    B_$_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    assert {:id "id970"} (forall $o: ref, $f: Field :: true);
}
...
axiom {:id "id971"} 0 <= $FunctionContextHeight
   ==> (forall this: ref :: 
...
procedure {:verboseName "RedeclaringMembers.C.Valid (well-formedness)"} CheckWellformed$$RedeclaringMembers.C.Valid(this: ref
       where this != null
         && 
        $Is(this, Tclass.RedeclaringMembers.C())
         && $IsAlloc(this, Tclass.RedeclaringMembers.C(), $Heap));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "RedeclaringMembers.C.Valid (override check)"} OverrideCheck$$RedeclaringMembers.C.Valid(this: ref
       where this != null
         && 
        $Is(this, Tclass.RedeclaringMembers.C())
         && $IsAlloc(this, Tclass.RedeclaringMembers.C(), $Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "RedeclaringMembers.C.Valid (override check)"} OverrideCheck$$RedeclaringMembers.C.Valid(this: ref)
{
  var C_$_ReadsFrame: [ref,Field]bool;

    assert {:id "id974"} true;
