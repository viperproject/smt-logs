...
(assert (forall (($o@@7 T@U) ) (!  (=> ($Is refType $o@@7 Tclass.ChildIsRefTrait.ChildTrait?) ($Is refType $o@@7 Tclass.ChildIsRefTrait.Trait?))
 :pattern ( ($Is refType $o@@7 Tclass.ChildIsRefTrait.ChildTrait?))
)))
(assert (forall (($o@@8 T@U) ) (!  (=> ($Is refType $o@@8 Tclass.ChildIsRefTrait.ChildTrait?) ($Is refType $o@@8 Tclass._System.object?))
...
(assert (= (Tag Tclass.ChildIsRefTrait.Trait?) Tagclass.ChildIsRefTrait.Trait?))
(assert (= (TagFamily Tclass.ChildIsRefTrait.Trait?) tytagFamily$Trait))
(assert (forall (($o@@9 T@U) ) (! (= ($Is refType $o@@9 Tclass.ChildIsRefTrait.Trait?)  (or (= $o@@9 null) (implements$ChildIsRefTrait.Trait (dtype $o@@9))))
 :pattern ( ($Is refType $o@@9 Tclass.ChildIsRefTrait.Trait?))
)))
(assert (forall (($o@@10 T@U) ) (! (= ($Is refType $o@@10 Tclass.ChildIsRefTrait.ChildTrait?)  (or (= $o@@10 null) (implements$ChildIsRefTrait.ChildTrait (dtype $o@@10))))
 :pattern ( ($Is refType $o@@10 Tclass.ChildIsRefTrait.ChildTrait?))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (< (ChildIsRefTrait.Trait.yy this@@3) 100) (and (=> (= (ControlFlow 0 2) (- 0 6)) (< (ChildIsRefTrait.Trait.yy this@@3) 800)) (=> (< (ChildIsRefTrait.Trait.yy this@@3) 800) (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@11 T@U) ($f T@U) ) true)) (=> (forall (($o@@12 T@U) ($f@@0 T@U) ) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@13 T@U) ($f@@1 T@U) ) true)) (=> (forall (($o@@14 T@U) ($f@@2 T@U) ) true) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (forall (($o@@15 T@U) ) (!  (=> (and (or (not (= $o@@15 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@15) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@15) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@15)))
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@15))
)) ($HeapSucc $Heap $Heap@0)) (and (< |p#0| (+ (+ (ChildIsRefTrait.Trait.yy this@@3) (ChildIsRefTrait.ChildTrait.F this@@3 (LitInt 5))) 100)) (= (ControlFlow 0 2) (- 0 1)))) (< |p#0| (+ (+ (ChildIsRefTrait.Trait.yy this@@3) (ChildIsRefTrait.ChildTrait.F this@@3 (LitInt 5))) 900))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.ChildIsRefTrait.ChildTrait) ($IsAlloc refType this@@3 Tclass.ChildIsRefTrait.ChildTrait $Heap))) (<= (LitInt 0) |p#0|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 7) 2))) anon0_correct))))
