...
(declare-fun GenericBasics.Cl.RValue3 (T@U T@U T@U T@U) Int)
(declare-fun |GenericBasics.Cl.RValue3#canCall| (T@U T@U T@U T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((GenericBasics.Cl$Q@@3 T@U) (GenericBasics.Cl.RValue3$XX T@U) (this T@U) (|x#0| T@U) ) (!  (=> (or (|GenericBasics.Cl.RValue3#canCall| GenericBasics.Cl$Q@@3 GenericBasics.Cl.RValue3$XX this |x#0|) (and (< 0 $FunctionContextHeight) (and (and (or (not (= this null)) (not true)) ($Is refType this (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@3))) ($IsBox |x#0| GenericBasics.Cl.RValue3$XX)))) (= (GenericBasics.Cl.RValue3 GenericBasics.Cl$Q@@3 GenericBasics.Cl.RValue3$XX this |x#0|) (LitInt 5)))
 :qid |unknown.0:0|
 :skolemid |1805|
 :pattern ( (GenericBasics.Cl.RValue3 GenericBasics.Cl$Q@@3 GenericBasics.Cl.RValue3$XX this |x#0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((GenericBasics.Cl$Q@@12 T@U) (GenericBasics.Cl.RValue3$XX@@0 T@U) (this@@0 T@U) (|x#0@@0| T@U) ) (!  (=> (or (|GenericBasics.Cl.RValue3#canCall| GenericBasics.Cl$Q@@12 GenericBasics.Cl.RValue3$XX@@0 (Lit refType this@@0) (Lit BoxType |x#0@@0|)) (and (< 0 $FunctionContextHeight) (and (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@12))) ($IsBox |x#0@@0| GenericBasics.Cl.RValue3$XX@@0)))) (= (GenericBasics.Cl.RValue3 GenericBasics.Cl$Q@@12 GenericBasics.Cl.RValue3$XX@@0 (Lit refType this@@0) (Lit BoxType |x#0@@0|)) (LitInt 5)))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |1806|
 :pattern ( (GenericBasics.Cl.RValue3 GenericBasics.Cl$Q@@12 GenericBasics.Cl.RValue3$XX@@0 (Lit refType this@@0) (Lit BoxType |x#0@@0|)))
))))
...
(declare-fun GenericBasics.Tr.RValue3$X () T@U)
(declare-fun GenericBasics.Cl.RValue3$XX@@1 () T@U)
...
(set-info :boogie-vc-id OverrideCheck$$GenericBasics.Cl.RValue3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= GenericBasics.Tr$A@@11 GenericBasics.Cl$Q@@15) (=> (and (= GenericBasics.Tr$B@@11 TInt) (= GenericBasics.Tr.RValue3$X GenericBasics.Cl.RValue3$XX@@1)) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (and (= Cl_$_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (forall (($o@@6 T@U) ($f@@0 T@U) ) (! true
 :qid |TraitCompiledfy.230:14|
 :skolemid |1808|
))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@15)) ($IsAlloc refType this@@1 (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@15) $Heap))) ($IsBox |x#0@@1| GenericBasics.Cl.RValue3$XX@@1)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
