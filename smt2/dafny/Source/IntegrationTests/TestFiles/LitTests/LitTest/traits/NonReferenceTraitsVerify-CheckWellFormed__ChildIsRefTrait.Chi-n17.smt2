...
(declare-fun |p#0| () Int)
(set-info :boogie-vc-id CheckWellFormed$$ChildIsRefTrait.ChildTrait.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (< (ChildIsRefTrait.Trait.yy this@@3) 800)) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@12 T@U) ) (!  (=> (and (or (not (= $o@@12 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@12) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@12) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@12)))
 :qid |NonReferenceTraitsVerifydfy.94:12|
 :skolemid |1070|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@12))
))) (and ($HeapSucc $Heap $Heap@0) (<= (LitInt 0) |p#0@0|))) (and (and ($IsAllocBox ($Box refType this@@3) Tclass.ChildIsRefTrait.ChildTrait? $Heap@0) (= |##umpa#0@0| (LitInt 5))) (and ($IsAlloc intType (int_2_U |##umpa#0@0|) TInt $Heap@0) (= (ControlFlow 0 2) (- 0 1))))) (< (ChildIsRefTrait.Trait.yy this@@3) 800)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.ChildIsRefTrait.ChildTrait) ($IsAlloc refType this@@3 Tclass.ChildIsRefTrait.ChildTrait $Heap))) (<= (LitInt 0) |p#0|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
