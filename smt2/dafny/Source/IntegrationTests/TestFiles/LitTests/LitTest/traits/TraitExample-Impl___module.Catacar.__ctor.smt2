...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@26 T@U) ($f@@2 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@26 $f@@2))  (=> (and (or (not (= $o@@26 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@26) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |692|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@26 $f@@2))
)))
...
(assert (forall (($o@@27 T@U) ) (!  (=> ($Is refType $o@@27 Tclass._module.Fiat?) ($Is refType $o@@27 Tclass._module.Automobile?))
 :qid |unknown.0:0|
 :skolemid |682|
 :pattern ( ($Is refType $o@@27 Tclass._module.Fiat?))
)))
...
(assert (forall (($o@@28 T@U) ) (!  (=> ($Is refType $o@@28 Tclass._module.Volvo?) ($Is refType $o@@28 Tclass._module.Automobile?))
 :qid |unknown.0:0|
 :skolemid |686|
 :pattern ( ($Is refType $o@@28 Tclass._module.Volvo?))
)))
...
(assert (forall (($o@@29 T@U) ) (!  (=> ($Is refType $o@@29 Tclass._module.Catacar?) ($Is refType $o@@29 Tclass._module.Automobile?))
 :qid |unknown.0:0|
 :skolemid |690|
 :pattern ( ($Is refType $o@@29 Tclass._module.Catacar?))
)))
...
(assert (forall (($o@@30 T@U) ) (! (= ($Is refType $o@@30 Tclass._module.Automobile?)  (or (= $o@@30 null) (implements$_module.Automobile (dtype $o@@30))))
 :qid |unknown.0:0|
 :skolemid |495|
 :pattern ( ($Is refType $o@@30 Tclass._module.Automobile?))
)))
(assert (forall (($h@@24 T@U) ($o@@31 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@24) (and (or (not (= $o@@31 null)) (not true)) ($Is refType $o@@31 Tclass._module.Automobile?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@24 $o@@31) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@24 $o@@31) _module.Automobile.Repr)) (TSet Tclass._System.object) $h@@24))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |498|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@24 $o@@31) _module.Automobile.Repr)))
)))
...
(declare-fun this.position@0 () Int)
(declare-fun $Heap@2 () T@U)
(declare-fun |defass#fiat#0| () Bool)
(declare-fun |fiat#0| () T@U)
(declare-fun |defass#volvo#0| () Bool)
(declare-fun |volvo#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.Catacar.__ctor)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 29) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@5 alloc false)) (= |pos##0@0| (LitInt 0))) (and (or (not (= call2formal@this null)) (not true)) (and ($Is refType call2formal@this Tclass._module.Fiat) ($IsAlloc refType call2formal@this Tclass._module.Fiat $Heap@@5)))) (and (=> (= (ControlFlow 0 2) (- 0 28)) (<= |pos##0@0| (LitInt 100))) (=> (<= |pos##0@0| (LitInt 100)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (and (and (or (not (= call2formal@this@0 null)) (not true)) (and ($Is refType call2formal@this@0 Tclass._module.Fiat) ($IsAlloc refType call2formal@this@0 Tclass._module.Fiat $Heap@0))) (|_module.Fiat.Valid#canCall| $Heap@0 call2formal@this@0)) (and (and (|_module.Fiat.Valid#canCall| $Heap@0 call2formal@this@0) (and (_module.Fiat.Valid $Heap@0 call2formal@this@0) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) _module.Automobile.Repr)) ($Box refType call2formal@this@0)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) _module.Automobile.position))) (LitInt 100))))) (and (forall (($o@@33 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) _module.Automobile.Repr)) ($Box refType $o@@33)) (or (not (= $o@@33 null)) (not true)))
...
))))) (and (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) _module.Automobile.position))) |pos##0@0|) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 call2formal@this@0) alloc))))) (and (forall (($o@@35 T@U) ) (!  (=> (and (or (not (= $o@@35 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@35) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@35) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@35)))
 :qid |TraitExampledfy.24:3|
 :skolemid |533|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@35))
)) ($HeapSucc $Heap@@5 $Heap@0))) (and (and (or (not (= call1formal@this null)) (not true)) (and ($Is refType call1formal@this Tclass._module.Volvo) ($IsAlloc refType call1formal@this Tclass._module.Volvo $Heap@@5))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1))))) (and (and (and (and (or (not (= call1formal@this@0 null)) (not true)) (and ($Is refType call1formal@this@0 Tclass._module.Volvo) ($IsAlloc refType call1formal@this@0 Tclass._module.Volvo $Heap@1))) (|_module.Volvo.Valid#canCall| $Heap@1 call1formal@this@0)) (and (|_module.Volvo.Valid#canCall| $Heap@1 call1formal@this@0) (and (_module.Volvo.Valid $Heap@1 call1formal@this@0) (and (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0) _module.Automobile.Repr)) ($Box refType call1formal@this@0)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0) _module.Automobile.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0) _module.Volvo.odometer))) (= (Mod (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0) _module.Automobile.position))) (LitInt 10)) (LitInt 0))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0) _module.Volvo.odometer))) _module.Odometer.value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0) _module.Automobile.position)))))))) (and (and (and (forall (($o@@36 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0) _module.Automobile.Repr)) ($Box refType $o@@36)) (or (not (= $o@@36 null)) (not true)))
 :qid |TraitExampledfy.54:24|
 :skolemid |580|
 :pattern (  (or (not (= $o@@36 null)) (not true)))
)) (forall (($o@@37 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0) _module.Automobile.Repr)) ($Box refType $o@@37)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@37) alloc)))))
 :qid |TraitExampledfy.54:24|
 :skolemid |581|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0) _module.Automobile.Repr)) ($Box refType $o@@37)))
))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call1formal@this@0) alloc))))) (and (forall (($o@@38 T@U) ) (!  (=> (and (or (not (= $o@@38 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@38) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@38) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@38)))
 :qid |TraitExampledfy.53:3|
 :skolemid |582|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@38))
)) ($HeapSucc $Heap@0 $Heap@1))))) (and (=> (= (ControlFlow 0 2) (- 0 27)) true) (and (=> (= (ControlFlow 0 2) (- 0 26)) true) (and (=> (= (ControlFlow 0 2) (- 0 25)) true) (and (=> (= (ControlFlow 0 2) (- 0 24)) (or (not (= call2formal@this@0 null)) (not true))) (=> (or (not (= call2formal@this@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 23)) true) (and (=> (= (ControlFlow 0 2) (- 0 22)) (or (not (= call1formal@this@0 null)) (not true))) (=> (or (not (= call1formal@this@0 null)) (not true)) (=> (= this.Repr@0 (|Set#Union| (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box refType this@@8)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call2formal@this@0) _module.Automobile.Repr))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0) _module.Automobile.Repr)))) (and (=> (= (ControlFlow 0 2) (- 0 21)) true) (and (=> (= (ControlFlow 0 2) (- 0 20)) (or (not (= call1formal@this@0 null)) (not true))) (=> (or (not (= call1formal@this@0 null)) (not true)) (=> (= this.position@0 (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0) _module.Automobile.position)))) (and (=> (= (ControlFlow 0 2) (- 0 19)) true) (and (=> (= (ControlFlow 0 2) (- 0 18)) true) (=> (and (or (not (= this@@8 null)) (not true)) ($Is refType this@@8 Tclass._module.Catacar?)) (=> (and (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@8) alloc)))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@8) _module.Automobile.position))) this.position@0)) (and (= ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@8) _module.Automobile.Repr)) this.Repr@0) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@8) _module.Catacar.f)) call2formal@this@0))) (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@8) _module.Catacar.v)) call1formal@this@0) (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 this@@8 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@8) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Automobile.Repr)) ($Box refType this@@8))))) (=> (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Automobile.Repr)) ($Box refType this@@8)))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Automobile.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.f))))) (=> (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Automobile.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.f)))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.f))) _module.Automobile.Repr)) ($Box refType this@@8)))))) (=> (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.f))) _module.Automobile.Repr)) ($Box refType this@@8))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.f))) _module.Automobile.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Automobile.Repr)))))) (=> (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.f))) _module.Automobile.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Automobile.Repr))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (=> (|_module.Fiat.Valid#canCall| $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.f))) (or (_module.Fiat.Valid $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.f))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.f))) _module.Automobile.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.f))))))) (=> (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (=> (|_module.Fiat.Valid#canCall| $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.f))) (or (_module.Fiat.Valid $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.f))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.f))) _module.Automobile.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.f)))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (=> (|_module.Fiat.Valid#canCall| $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.f))) (or (_module.Fiat.Valid $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.f))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.f))) _module.Automobile.position))) (LitInt 100))))))) (=> (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (=> (|_module.Fiat.Valid#canCall| $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.f))) (or (_module.Fiat.Valid $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.f))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.f))) _module.Automobile.position))) (LitInt 100)))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Automobile.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))))) (=> (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Automobile.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v)))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) _module.Automobile.Repr)) ($Box refType this@@8)))))) (=> (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) _module.Automobile.Repr)) ($Box refType this@@8))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) _module.Automobile.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Automobile.Repr)))))) (=> (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) _module.Automobile.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Automobile.Repr))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (=> (|_module.Volvo.Valid#canCall| $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) (or (_module.Volvo.Valid $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) _module.Automobile.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))))))) (=> (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (=> (|_module.Volvo.Valid#canCall| $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) (or (_module.Volvo.Valid $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) _module.Automobile.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v)))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (=> (|_module.Volvo.Valid#canCall| $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) (or (_module.Volvo.Valid $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) _module.Automobile.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) _module.Volvo.odometer))))))) (=> (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (=> (|_module.Volvo.Valid#canCall| $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) (or (_module.Volvo.Valid $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) _module.Automobile.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) _module.Volvo.odometer)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (=> (|_module.Volvo.Valid#canCall| $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) (or (_module.Volvo.Valid $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) (= (Mod (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) _module.Automobile.position))) (LitInt 10)) (LitInt 0))))))) (=> (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (=> (|_module.Volvo.Valid#canCall| $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) (or (_module.Volvo.Valid $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) (= (Mod (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) _module.Automobile.position))) (LitInt 10)) (LitInt 0)))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (=> (|_module.Volvo.Valid#canCall| $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) (or (_module.Volvo.Valid $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) _module.Volvo.odometer))) _module.Odometer.value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) _module.Automobile.position))))))))) (=> (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (=> (|_module.Volvo.Valid#canCall| $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) (or (_module.Volvo.Valid $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) _module.Volvo.odometer))) _module.Odometer.value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) _module.Automobile.position)))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.f))) _module.Automobile.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) _module.Automobile.Repr)))))) (=> (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.f))) _module.Automobile.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) _module.Automobile.Repr))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Automobile.position))) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.f))) _module.Automobile.position))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) _module.Automobile.position)))))))) (=> (=> (|_module.Catacar.Valid#canCall| $Heap@2 this@@8) (or (_module.Catacar.Valid $Heap@2 this@@8) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Automobile.position))) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.f))) _module.Automobile.position))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Catacar.v))) _module.Automobile.position))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (and (forall (($o@@39 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Automobile.Repr)) ($Box refType $o@@39)) (or (not (= $o@@39 null)) (not true)))
 :qid |TraitExampledfy.104:24|
 :skolemid |648|
 :pattern (  (or (not (= $o@@39 null)) (not true)))
)) (forall (($o@@40 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Automobile.Repr)) ($Box refType $o@@40)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@40) alloc)))))
 :qid |TraitExampledfy.104:24|
 :skolemid |649|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@8) _module.Automobile.Repr)) ($Box refType $o@@40)))
))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@5) ($IsHeapAnchor $Heap@@5)) (and (=> |defass#fiat#0| (and ($Is refType |fiat#0| Tclass._module.Fiat) ($IsAlloc refType |fiat#0| Tclass._module.Fiat $Heap@@5))) true)) (and (and (=> |defass#volvo#0| (and ($Is refType |volvo#0| Tclass._module.Volvo) ($IsAlloc refType |volvo#0| Tclass._module.Volvo $Heap@@5))) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 29) 2)))) anon0_correct)))
