...
(set-info :boogie-vc-id OverrideCheck$$GenericBasics.Cl.MValue1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= GenericBasics.Tr$A@@11 GenericBasics.Cl$Q@@14) (=> (and (= GenericBasics.Tr$B@@11 TInt) (= GenericBasics.Tr.MValue1$X GenericBasics.Cl.MValue1$XX)) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@5 T@U) ($f T@U) ) (! true
 :qid |TraitCompiledfy.235:12|
 :skolemid |1823|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@14)) ($IsAlloc refType this (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@14) $Heap))) (and ($IsBox |x#0| GenericBasics.Cl.MValue1$XX) ($IsAllocBox |x#0| GenericBasics.Cl.MValue1$XX $Heap))) (and (and ($IsBox |y#0| GenericBasics.Cl.MValue1$XX) ($IsAllocBox |y#0| GenericBasics.Cl.MValue1$XX $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 2)))) anon0_correct))))
