...
(assert (forall (($o@@7 T@U) ) (!  (=> ($Is refType $o@@7 Tclass.TraitsExtendingTraits.C?) ($Is refType $o@@7 Tclass._System.object?))
 :qid |unknown.0:0|
 :skolemid |3229|
 :pattern ( ($Is refType $o@@7 Tclass.TraitsExtendingTraits.C?))
)))
(assert (forall (($o@@8 T@U) ) (!  (=> ($Is refType $o@@8 Tclass.TraitsExtendingTraits.N?) ($Is refType $o@@8 Tclass.TraitsExtendingTraits.B?))
 :qid |unknown.0:0|
 :skolemid |3245|
 :pattern ( ($Is refType $o@@8 Tclass.TraitsExtendingTraits.N?))
)))
(assert (forall (($o@@9 T@U) ) (!  (=> ($Is refType $o@@9 Tclass.TraitsExtendingTraits.N?) ($Is refType $o@@9 Tclass.TraitsExtendingTraits.C?))
 :qid |unknown.0:0|
 :skolemid |3249|
...
(assert (= (Tag Tclass.TraitsExtendingTraits.N?) Tagclass.TraitsExtendingTraits.N?))
(assert (= (TagFamily Tclass.TraitsExtendingTraits.N?) tytagFamily$N))
(assert (forall (($o@@10 T@U) ) (! (= ($Is refType $o@@10 Tclass.TraitsExtendingTraits.B?)  (or (= $o@@10 null) (implements$TraitsExtendingTraits.B (dtype $o@@10))))
 :qid |unknown.0:0|
 :skolemid |3154|
 :pattern ( ($Is refType $o@@10 Tclass.TraitsExtendingTraits.B?))
)))
(assert (forall (($o@@11 T@U) ) (! (= ($Is refType $o@@11 Tclass.TraitsExtendingTraits.C?)  (or (= $o@@11 null) (implements$TraitsExtendingTraits.C (dtype $o@@11))))
 :qid |unknown.0:0|
 :skolemid |3165|
 :pattern ( ($Is refType $o@@11 Tclass.TraitsExtendingTraits.C?))
)))
(assert (forall (($o@@12 T@U) ) (! (= ($Is refType $o@@12 Tclass.TraitsExtendingTraits.N?)  (or (= $o@@12 null) (implements$TraitsExtendingTraits.N (dtype $o@@12))))
 :qid |unknown.0:0|
 :skolemid |3200|
 :pattern ( ($Is refType $o@@12 Tclass.TraitsExtendingTraits.N?))
)))
(push 1)
...
(set-info :boogie-vc-id OverrideCheck$$TraitsExtendingTraits.N.Twice)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass.TraitsExtendingTraits.N) ($IsAlloc refType this Tclass.TraitsExtendingTraits.N $Heap))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct))))
