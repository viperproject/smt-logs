...
(declare-fun GenericBasics.Mega.MValue0$XX () T@U)
...
(set-info :boogie-vc-id OverrideCheck$$GenericBasics.Mega.MValue0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= GenericBasics.Tr$A@@11 GenericBasics.Mega$Q@@18) (=> (and (= GenericBasics.Tr$B@@11 TInt) (= GenericBasics.Tr.MValue0$X GenericBasics.Mega.MValue0$XX)) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@5 T@U) ($f T@U) ) (! true
 :qid |TraitCompiledfy.290:12|
 :skolemid |1891|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@18 GenericBasics.Mega$Q@@18 GenericBasics.Mega$L@@18)) ($IsAlloc refType this (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@18 GenericBasics.Mega$Q@@18 GenericBasics.Mega$L@@18) $Heap)))) (and (and ($IsBox |x#0| GenericBasics.Mega.MValue0$XX) ($IsAllocBox |x#0| GenericBasics.Mega.MValue0$XX $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 2)))) anon0_correct)))
