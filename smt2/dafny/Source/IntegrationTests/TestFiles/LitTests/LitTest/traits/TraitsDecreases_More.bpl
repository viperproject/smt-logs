...
procedure {:verboseName "More.A0.P (well-formedness)"} CheckWellformed$$More.A0.P(this: ref
       where this != null
         && 
        $Is(this, Tclass.More.A0())
         && $IsAlloc(this, Tclass.More.A0(), $Heap));
...
axiom 0 <= $FunctionContextHeight
   ==> (forall this: ref :: 
    ...
    More.B0.P#canCall(this)
         || (0 < $FunctionContextHeight && this != null && $Is(this, Tclass.More.B0()))
       ==> More.A0.P(this) == More.B0.P(this));

procedure {:verboseName "More.B0.P (well-formedness)"} CheckWellformed$$More.B0.P(this: ref
       where this != null
         && 
        $Is(this, Tclass.More.B0())
         && $IsAlloc(this, Tclass.More.B0(), $Heap));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "More.B0.P (override check)"} OverrideCheck$$More.B0.P(this: ref
       where this != null
         && 
        $Is(this, Tclass.More.B0())
         && $IsAlloc(this, Tclass.More.B0(), $Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "More.B0.P (override check)"} OverrideCheck$$More.B0.P(this: ref)
{
  var B0_$_ReadsFrame: [ref,Field]bool;

    assert {:id "id0"} false;
    B0_$_ReadsFrame := (lambda $o: ref, $f: Field :: 
...
procedure {:verboseName "More.A1.P (well-formedness)"} CheckWellformed$$More.A1.P(this: ref
       where this != null
         && 
        $Is(this, Tclass.More.A1())
         && $IsAlloc(this, Tclass.More.A1(), $Heap));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
axiom 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, this: ref :: 
    ...
    More.B1.P#canCall($Heap, this)
         || (0 < $FunctionContextHeight && this != null && $Is(this, Tclass.More.B1()))
       ==> More.A1.P(this) == More.B1.P($Heap, this));

procedure {:verboseName "More.B1.P (well-formedness)"} CheckWellformed$$More.B1.P(this: ref
       where this != null
         && 
        $Is(this, Tclass.More.B1())
         && $IsAlloc(this, Tclass.More.B1(), $Heap));
...
procedure {:verboseName "More.B1.P (override check)"} OverrideCheck$$More.B1.P(this: ref
       where this != null
         && 
        $Is(this, Tclass.More.B1())
         && $IsAlloc(this, Tclass.More.B1(), $Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "More.B1.P (override check)"} OverrideCheck$$More.B1.P(this: ref)
{
  var B1_$_ReadsFrame: [ref,Field]bool;

    assert {:id "id2"} false;
    B1_$_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    assert {:id "id3"} (forall $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool && $o == this ==> false);
}
...
procedure {:verboseName "More.A2.P (well-formedness)"} CheckWellformed$$More.A2.P(this: ref
       where this != null
         && 
        $Is(this, Tclass.More.A2())
         && $IsAlloc(this, Tclass.More.A2(), $Heap), 
    x#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
axiom 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, this: ref, x#0: int :: 
    ...
    More.B2.P#canCall($Heap, this, x#0)
         || (0 < $FunctionContextHeight && this != null && $Is(this, Tclass.More.B2()))
       ==> More.A2.P(this, x#0) == More.B2.P($Heap, this, x#0));

procedure {:verboseName "More.B2.P (well-formedness)"} CheckWellformed$$More.B2.P(this: ref
       where this != null
         && 
        $Is(this, Tclass.More.B2())
         && $IsAlloc(this, Tclass.More.B2(), $Heap), 
...
procedure {:verboseName "More.B2.P (override check)"} OverrideCheck$$More.B2.P(this: ref
       where this != null
         && 
        $Is(this, Tclass.More.B2())
         && $IsAlloc(this, Tclass.More.B2(), $Heap), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "More.B2.P (override check)"} OverrideCheck$$More.B2.P(this: ref, x#0: int)
{
  var B2_$_ReadsFrame: [ref,Field]bool;

    assert {:id "id4"} false;
    B2_$_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
...
procedure {:verboseName "More.A3.P (well-formedness)"} CheckWellformed$$More.A3.P(this: ref
       where this != null
         && 
        $Is(this, Tclass.More.A3())
         && $IsAlloc(this, Tclass.More.A3(), $Heap));
...
axiom 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, this: ref :: 
    ...
    More.B3.P#canCall(this)
         || (0 < $FunctionContextHeight && this != null && $Is(this, Tclass.More.B3()))
       ==> More.A3.P($Heap, this) == More.B3.P(this));

procedure {:verboseName "More.B3.P (well-formedness)"} CheckWellformed$$More.B3.P(this: ref
       where this != null
         && 
        $Is(this, Tclass.More.B3())
         && $IsAlloc(this, Tclass.More.B3(), $Heap));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "More.B3.P (override check)"} OverrideCheck$$More.B3.P(this: ref
       where this != null
         && 
        $Is(this, Tclass.More.B3())
         && $IsAlloc(this, Tclass.More.B3(), $Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "More.B3.P (override check)"} OverrideCheck$$More.B3.P(this: ref)
{
  var B3_$_ReadsFrame: [ref,Field]bool;

    assert {:id "id6"} false;
    B3_$_ReadsFrame := (lambda $o: ref, $f: Field :: 
...
procedure {:verboseName "More.A4.P (well-formedness)"} CheckWellformed$$More.A4.P(this: ref
       where this != null
         && 
        $Is(this, Tclass.More.A4())
         && $IsAlloc(this, Tclass.More.A4(), $Heap), 
    x#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
axiom 0 <= $FunctionContextHeight
   ==> (forall this: ref, x#0: int :: 
    ...
    More.B4.P#canCall(this, x#0)
         || (0 < $FunctionContextHeight && this != null && $Is(this, Tclass.More.B4()))
       ==> More.A4.P(this, x#0) == More.B4.P(this, x#0));

procedure {:verboseName "More.B4.P (well-formedness)"} CheckWellformed$$More.B4.P(this: ref
       where this != null
         && 
        $Is(this, Tclass.More.B4())
         && $IsAlloc(this, Tclass.More.B4(), $Heap), 
    x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "More.B4.P (override check)"} OverrideCheck$$More.B4.P(this: ref
       where this != null
         && 
        $Is(this, Tclass.More.B4())
         && $IsAlloc(this, Tclass.More.B4(), $Heap), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "More.B4.P (override check)"} OverrideCheck$$More.B4.P(this: ref, x#0: int)
{
  var B4_$_ReadsFrame: [ref,Field]bool;

    assert {:id "id8"} x#0 <= LitInt(5);
    B4_$_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
...
procedure {:verboseName "More.A5.M (well-formedness)"} CheckWellFormed$$More.A5.M(this: ref
       where this != null
         && 
        $Is(this, Tclass.More.A5())
         && $IsAlloc(this, Tclass.More.A5(), $Heap), 
    x#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "More.A5.M (call)"} Call$$More.A5.M(this: ref
       where this != null
         && 
        $Is(this, Tclass.More.A5())
         && $IsAlloc(this, Tclass.More.A5(), $Heap), 
...
procedure {:verboseName "More.B5.M (well-formedness)"} CheckWellFormed$$More.B5.M(this: ref
       where this != null
         && 
        $Is(this, Tclass.More.B5())
         && $IsAlloc(this, Tclass.More.B5(), $Heap), 
    x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "More.B5.M (override check)"} OverrideCheck$$More.B5.M(this: ref
       where this != null
         && 
        $Is(this, Tclass.More.B5())
         && $IsAlloc(this, Tclass.More.B5(), $Heap), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "More.B5.M (override check)"} OverrideCheck$$More.B5.M(this: ref, x#0: int)
{
    assert {:id "id10"} x#0 <= LitInt(5);
...
procedure {:verboseName "More.B5.M (call)"} Call$$More.B5.M(this: ref
       where this != null
         && 
        $Is(this, Tclass.More.B5())
         && $IsAlloc(this, Tclass.More.B5(), $Heap), 
