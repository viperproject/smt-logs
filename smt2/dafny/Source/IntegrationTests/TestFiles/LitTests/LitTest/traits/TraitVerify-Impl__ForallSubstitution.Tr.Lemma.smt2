...
(assert (distinct alloc Tagclass.ForallSubstitution.Tr? Tagclass.ForallSubstitution.Tr tytagFamily$Tr)
)
...
(assert (forall ((ForallSubstitution.Tr$X@@0 T@U) ($o T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType $o (Tclass.ForallSubstitution.Tr? ForallSubstitution.Tr$X@@0) $h@@0)  (or (= $o null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@0 $o) alloc)))))
 :qid |unknown.0:0|
 :skolemid |535|
 :pattern ( ($IsAlloc refType $o (Tclass.ForallSubstitution.Tr? ForallSubstitution.Tr$X@@0) $h@@0))
)))
...
(assert (forall ((ForallSubstitution.Tr$X@@2 T@U) (|c#0@@0| T@U) ) (! (= ($Is refType |c#0@@0| (Tclass.ForallSubstitution.Tr ForallSubstitution.Tr$X@@2))  (and ($Is refType |c#0@@0| (Tclass.ForallSubstitution.Tr? ForallSubstitution.Tr$X@@2)) (or (not (= |c#0@@0| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |543|
 :pattern ( ($Is refType |c#0@@0| (Tclass.ForallSubstitution.Tr ForallSubstitution.Tr$X@@2)))
 :pattern ( ($Is refType |c#0@@0| (Tclass.ForallSubstitution.Tr? ForallSubstitution.Tr$X@@2)))
)))
...
(assert (forall ((ForallSubstitution.Tr$X@@8 T@U) ($o@@0 T@U) ) (! (= ($Is refType $o@@0 (Tclass.ForallSubstitution.Tr? ForallSubstitution.Tr$X@@8))  (or (= $o@@0 null) (implements$ForallSubstitution.Tr (dtype $o@@0) ForallSubstitution.Tr$X@@8)))
 :qid |unknown.0:0|
 :skolemid |534|
 :pattern ( ($Is refType $o@@0 (Tclass.ForallSubstitution.Tr? ForallSubstitution.Tr$X@@8)))
)))
...
(assert (forall ((ForallSubstitution.Tr$X@@9 T@U) (bx T@U) ) (!  (=> ($IsBox bx (Tclass.ForallSubstitution.Tr? ForallSubstitution.Tr$X@@9)) (and (= ($Box refType ($Unbox refType bx)) bx) ($Is refType ($Unbox refType bx) (Tclass.ForallSubstitution.Tr? ForallSubstitution.Tr$X@@9))))
 :qid |unknown.0:0|
 :skolemid |533|
 :pattern ( ($IsBox bx (Tclass.ForallSubstitution.Tr? ForallSubstitution.Tr$X@@9)))
)))
(assert (forall ((ForallSubstitution.Tr$X@@10 T@U) (bx@@0 T@U) ) (!  (=> ($IsBox bx@@0 (Tclass.ForallSubstitution.Tr ForallSubstitution.Tr$X@@10)) (and (= ($Box refType ($Unbox refType bx@@0)) bx@@0) ($Is refType ($Unbox refType bx@@0) (Tclass.ForallSubstitution.Tr ForallSubstitution.Tr$X@@10))))
 :qid |unknown.0:0|
 :skolemid |538|
 :pattern ( ($IsBox bx@@0 (Tclass.ForallSubstitution.Tr ForallSubstitution.Tr$X@@10)))
)))
...
(declare-fun ForallSubstitution.Tr$X@@11 () T@U)
(declare-fun ForallSubstitution.Tr.Lemma$Y () T@U)
(declare-fun this@@1 () T@U)
(declare-fun |x#0@@1| () T@U)
(declare-fun |y#0@@1| () T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id Impl$$ForallSubstitution.Tr.Lemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|ForallSubstitution.Tr.P#canCall| ForallSubstitution.Tr$X@@11 ForallSubstitution.Tr.Lemma$Y this@@1 |x#0@@1| |y#0@@1|)) (or (ForallSubstitution.Tr.P ForallSubstitution.Tr$X@@11 ForallSubstitution.Tr.Lemma$Y this@@1 |x#0@@1| |y#0@@1|) (U_2_bool (Lit boolType (bool_2_U true)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 (Tclass.ForallSubstitution.Tr ForallSubstitution.Tr$X@@11)) ($IsAlloc refType this@@1 (Tclass.ForallSubstitution.Tr ForallSubstitution.Tr$X@@11) $Heap))) (and ($IsBox |x#0@@1| ForallSubstitution.Tr$X@@11) ($IsAllocBox |x#0@@1| ForallSubstitution.Tr$X@@11 $Heap))) (and (and ($IsBox |y#0@@1| ForallSubstitution.Tr.Lemma$Y) ($IsAllocBox |y#0@@1| ForallSubstitution.Tr.Lemma$Y $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct))))
