...
(assert (forall ((GenericBasics.Cl$Q@@7 T@U) ($o@@1 T@U) ) (! (= ($Is refType $o@@1 (Tclass.GenericBasics.Cl? GenericBasics.Cl$Q@@7))  (or (= $o@@1 null) (= (dtype $o@@1) (Tclass.GenericBasics.Cl? GenericBasics.Cl$Q@@7))))
 :qid |unknown.0:0|
 :skolemid |1761|
 :pattern ( ($Is refType $o@@1 (Tclass.GenericBasics.Cl? GenericBasics.Cl$Q@@7)))
)))
(assert (forall ((GenericBasics.Cl$Q@@8 T@U) ($o@@2 T@U) ($heap T@U) ) (!  (=> ($IsAlloc refType $o@@2 (Tclass.GenericBasics.Cl? GenericBasics.Cl$Q@@8) $heap) ($IsAlloc refType $o@@2 (Tclass.GenericBasics.Tr? GenericBasics.Cl$Q@@8 TInt) $heap))
 :qid |unknown.0:0|
 :skolemid |1907|
 :pattern ( ($IsAlloc refType $o@@2 (Tclass.GenericBasics.Cl? GenericBasics.Cl$Q@@8) $heap))
)))
...
(assert (forall ((GenericBasics.Cl$Q@@9 T@U) ) (! (= (Tclass.GenericBasics.Cl_0 (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@9)) GenericBasics.Cl$Q@@9)
 :qid |unknown.0:0|
 :skolemid |1680|
 :pattern ( (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@9))
)))
(assert (forall ((GenericBasics.Cl$Q@@10 T@U) ) (! (= (Tclass.GenericBasics.Cl?_0 (Tclass.GenericBasics.Cl? GenericBasics.Cl$Q@@10)) GenericBasics.Cl$Q@@10)
 :qid |unknown.0:0|
 :skolemid |1759|
...
(assert (forall ((GenericBasics.Cl$Q@@11 T@U) (bx@@3 T@U) ) (!  (=> ($IsBox bx@@3 (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@11)) (and (= ($Box refType ($Unbox refType bx@@3)) bx@@3) ($Is refType ($Unbox refType bx@@3) (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@11))))
 :qid |unknown.0:0|
 :skolemid |1681|
 :pattern ( ($IsBox bx@@3 (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@11)))
)))
(assert (forall ((GenericBasics.Cl$Q@@12 T@U) (bx@@4 T@U) ) (!  (=> ($IsBox bx@@4 (Tclass.GenericBasics.Cl? GenericBasics.Cl$Q@@12)) (and (= ($Box refType ($Unbox refType bx@@4)) bx@@4) ($Is refType ($Unbox refType bx@@4) (Tclass.GenericBasics.Cl? GenericBasics.Cl$Q@@12))))
 :qid |unknown.0:0|
 :skolemid |1760|
 :pattern ( ($IsBox bx@@4 (Tclass.GenericBasics.Cl? GenericBasics.Cl$Q@@12)))
)))
...
(declare-fun GenericBasics.Cl$Q@@13 () T@U)
(declare-fun GenericBasics.Tr$B@@11 () T@U)
(declare-fun GenericBasics.Tr.RValue0$X () T@U)
(declare-fun GenericBasics.Cl.RValue0$XX () T@U)
...
(set-info :boogie-vc-id OverrideCheck$$GenericBasics.Cl.RValue0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= GenericBasics.Tr$A@@11 GenericBasics.Cl$Q@@13) (=> (and (= GenericBasics.Tr$B@@11 TInt) (= GenericBasics.Tr.RValue0$X GenericBasics.Cl.RValue0$XX)) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (and (= Cl_$_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (forall (($o@@6 T@U) ($f@@0 T@U) ) (! true
 :qid |TraitCompiledfy.227:14|
 :skolemid |1790|
))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@13)) ($IsAlloc refType this (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@13) $Heap))) ($IsBox |x#0| GenericBasics.Cl.RValue0$XX)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
