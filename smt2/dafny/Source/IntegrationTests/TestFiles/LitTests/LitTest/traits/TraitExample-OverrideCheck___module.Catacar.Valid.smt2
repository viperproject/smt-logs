...
(assert (forall ((bx@@18 T@U) ) (!  (=> ($IsBox bx@@18 Tclass._module.Fiat?) ($IsBox bx@@18 Tclass._module.Automobile?))
 :qid |unknown.0:0|
 :skolemid |680|
 :pattern ( ($IsBox bx@@18 Tclass._module.Fiat?))
)))
...
(assert (forall ((bx@@19 T@U) ) (!  (=> ($IsBox bx@@19 Tclass._module.Volvo?) ($IsBox bx@@19 Tclass._module.Automobile?))
 :qid |unknown.0:0|
 :skolemid |684|
 :pattern ( ($IsBox bx@@19 Tclass._module.Volvo?))
)))
...
(assert (forall ((bx@@20 T@U) ) (!  (=> ($IsBox bx@@20 Tclass._module.Catacar?) ($IsBox bx@@20 Tclass._module.Automobile?))
 :qid |unknown.0:0|
 :skolemid |688|
 :pattern ( ($IsBox bx@@20 Tclass._module.Catacar?))
)))
...
(declare-fun Catacar_$_ReadsFrame@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id OverrideCheck$$_module.Catacar.Valid)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Set#Subset| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@5) _module.Automobile.Repr)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@5))) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@5) _module.Automobile.Repr)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@5))))) (=> (|Set#Subset| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@5) _module.Automobile.Repr)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@5))) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@5) _module.Automobile.Repr)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@5)))) (=> (= Catacar_$_ReadsFrame@0 (|lambda#3| null $Heap@@5 alloc this@@5 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@5) _module.Automobile.Repr)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@30 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@30 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@30) alloc)))) (or (= $o@@30 this@@5) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@5) _module.Automobile.Repr)) ($Box refType $o@@30)))) (or (= $o@@30 this@@5) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@5) _module.Automobile.Repr)) ($Box refType $o@@30))))
 :qid |TraitExampledfy.93:19|
 :skolemid |641|
))) (=> (forall (($o@@31 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@31 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@31) alloc)))) (or (= $o@@31 this@@5) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@5) _module.Automobile.Repr)) ($Box refType $o@@31)))) (or (= $o@@31 this@@5) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@5) _module.Automobile.Repr)) ($Box refType $o@@31))))
 :qid |TraitExampledfy.93:19|
 :skolemid |641|
)) (=> (and (and (=> (_module.Catacar.Valid $Heap@@5 this@@5) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@5) _module.Automobile.Repr)) ($Box refType this@@5))) (= (ControlFlow 0 2) (- 0 1))) (_module.Catacar.Valid $Heap@@5 this@@5)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@5) _module.Automobile.Repr)) ($Box refType this@@5))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@5) ($IsHeapAnchor $Heap@@5)) (=> (and (and (or (not (= this@@5 null)) (not true)) (and ($Is refType this@@5 Tclass._module.Catacar) ($IsAlloc refType this@@5 Tclass._module.Catacar $Heap@@5))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct))))
