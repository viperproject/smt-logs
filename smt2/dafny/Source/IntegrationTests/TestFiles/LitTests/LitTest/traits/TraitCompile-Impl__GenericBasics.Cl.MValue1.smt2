...
(assert (forall ((GenericBasics.Cl$Q@@8 T@U) (bx@@0 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsAllocBox bx@@0 (Tclass.GenericBasics.Cl? GenericBasics.Cl$Q@@8) $h@@2) ($IsGoodHeap $h@@2)) ($IsAllocBox bx@@0 (Tclass.GenericBasics.Tr? GenericBasics.Cl$Q@@8 TInt) $h@@2))
 :qid |unknown.0:0|
 :skolemid |1905|
 :pattern ( ($IsAllocBox bx@@0 (Tclass.GenericBasics.Cl? GenericBasics.Cl$Q@@8) $h@@2))
)))
...
(assert (forall ((GenericBasics.Tr$A@@1 T@U) (GenericBasics.Tr$B@@1 T@U) ($o@@3 T@U) ($h@@3 T@U) ) (! (= ($IsAlloc refType $o@@3 (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@1 GenericBasics.Tr$B@@1) $h@@3)  (or (= $o@@3 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@3) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1704|
 :pattern ( ($IsAlloc refType $o@@3 (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@1 GenericBasics.Tr$B@@1) $h@@3))
)))
...
(assert (forall ((GenericBasics.Tr$A@@7 T@U) (GenericBasics.Tr$B@@7 T@U) (bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 (Tclass.GenericBasics.Tr GenericBasics.Tr$A@@7 GenericBasics.Tr$B@@7)) (and (= ($Box refType ($Unbox refType bx@@2)) bx@@2) ($Is refType ($Unbox refType bx@@2) (Tclass.GenericBasics.Tr GenericBasics.Tr$A@@7 GenericBasics.Tr$B@@7))))
 :qid |unknown.0:0|
 :skolemid |1692|
 :pattern ( ($IsBox bx@@2 (Tclass.GenericBasics.Tr GenericBasics.Tr$A@@7 GenericBasics.Tr$B@@7)))
)))
(assert (forall ((GenericBasics.Tr$A@@8 T@U) (GenericBasics.Tr$B@@8 T@U) (bx@@3 T@U) ) (!  (=> ($IsBox bx@@3 (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@8 GenericBasics.Tr$B@@8)) (and (= ($Box refType ($Unbox refType bx@@3)) bx@@3) ($Is refType ($Unbox refType bx@@3) (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@8 GenericBasics.Tr$B@@8))))
 :qid |unknown.0:0|
 :skolemid |1700|
 :pattern ( ($IsBox bx@@3 (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@8 GenericBasics.Tr$B@@8)))
)))
...
(assert (forall ((GenericBasics.Cl$Q@@13 T@U) (bx@@5 T@U) ) (!  (=> ($IsBox bx@@5 (Tclass.GenericBasics.Cl? GenericBasics.Cl$Q@@13)) (and (= ($Box refType ($Unbox refType bx@@5)) bx@@5) ($Is refType ($Unbox refType bx@@5) (Tclass.GenericBasics.Cl? GenericBasics.Cl$Q@@13))))
 :qid |unknown.0:0|
 :skolemid |1760|
 :pattern ( ($IsBox bx@@5 (Tclass.GenericBasics.Cl? GenericBasics.Cl$Q@@13)))
)))
...
(declare-fun |x#0| () T@U)
(declare-fun GenericBasics.Cl.MValue1$XX () T@U)
(declare-fun |defass#y#0| () Bool)
(declare-fun |y#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$GenericBasics.Cl.MValue1)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@14)) ($IsAlloc refType this (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@14) $Heap)))) (=> (and (and (and ($IsBox |x#0| GenericBasics.Cl.MValue1$XX) ($IsAllocBox |x#0| GenericBasics.Cl.MValue1$XX $Heap)) (=> |defass#y#0| (and ($IsBox |y#0| GenericBasics.Cl.MValue1$XX) ($IsAllocBox |y#0| GenericBasics.Cl.MValue1$XX $Heap)))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
