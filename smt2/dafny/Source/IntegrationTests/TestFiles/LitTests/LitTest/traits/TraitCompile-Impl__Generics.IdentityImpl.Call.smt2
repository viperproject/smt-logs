...
(assert (forall ((bx@@0 T@U) ) (!  (=> ($IsBox bx@@0 Tclass.Generics.Identity?) (and (= ($Box refType ($Unbox refType bx@@0)) bx@@0) ($Is refType ($Unbox refType bx@@0) Tclass.Generics.Identity?)))
 :qid |unknown.0:0|
 :skolemid |2462|
 :pattern ( ($IsBox bx@@0 Tclass.Generics.Identity?))
)))
...
(assert (forall ((bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 Tclass.Generics.IdentityImpl?) (and (= ($Box refType ($Unbox refType bx@@2)) bx@@2) ($Is refType ($Unbox refType bx@@2) Tclass.Generics.IdentityImpl?)))
 :qid |unknown.0:0|
 :skolemid |2470|
 :pattern ( ($IsBox bx@@2 Tclass.Generics.IdentityImpl?))
)))
...
(assert (forall (($o@@4 T@U) ) (!  (=> ($Is refType $o@@4 Tclass.Generics.IdentityImpl?) ($Is refType $o@@4 Tclass.Generics.Identity?))
 :qid |unknown.0:0|
 :skolemid |2546|
 :pattern ( ($Is refType $o@@4 Tclass.Generics.IdentityImpl?))
)))
(assert (forall ((bx@@4 T@U) ) (!  (=> ($IsBox bx@@4 Tclass.Generics.IdentityImpl?) ($IsBox bx@@4 Tclass.Generics.Identity?))
 :qid |unknown.0:0|
 :skolemid |2544|
...
(assert (= (Tag Tclass.Generics.IdentityImpl) Tagclass.Generics.IdentityImpl))
(assert (= (TagFamily Tclass.Generics.IdentityImpl) tytagFamily$IdentityImpl))
(assert (forall (($o@@5 T@U) ) (! (= ($Is refType $o@@5 Tclass.Generics.Identity?)  (or (= $o@@5 null) (implements$Generics.Identity (dtype $o@@5))))
 :qid |unknown.0:0|
 :skolemid |2463|
 :pattern ( ($Is refType $o@@5 Tclass.Generics.Identity?))
)))
(push 1)
...
(set-info :boogie-vc-id Impl$$Generics.IdentityImpl.Call)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass.Generics.IdentityImpl) ($IsAlloc refType this Tclass.Generics.IdentityImpl $Heap)))) (=> (and (and (and ($IsBox |x#0| Generics.IdentityImpl.Call$T) ($IsAllocBox |x#0| Generics.IdentityImpl.Call$T $Heap)) (=> |defass#r#0| (and ($IsBox |r#0| Generics.IdentityImpl.Call$T) ($IsAllocBox |r#0| Generics.IdentityImpl.Call$T $Heap)))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
