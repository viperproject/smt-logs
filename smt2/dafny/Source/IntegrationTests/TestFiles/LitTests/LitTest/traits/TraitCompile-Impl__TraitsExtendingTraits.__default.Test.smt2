...
(assert (forall ((TraitsExtendingTraits.K$Y@@0 T@U) ($h0 T@U) ($h1 T@U) (this@@1 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 (Tclass.TraitsExtendingTraits.K TraitsExtendingTraits.K$Y@@0)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@0 T@U) ($f T@U) )  (=> (and (or (not (= $o@@0 null)) (not true)) (= $o@@0 this@@1)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@0) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@0) $f)))) (= (TraitsExtendingTraits.K.GetY_k TraitsExtendingTraits.K$Y@@0 $h0 this@@1) (TraitsExtendingTraits.K.GetY_k TraitsExtendingTraits.K$Y@@0 $h1 this@@1))))
...
(assert (forall ((TraitsExtendingTraits.A$Y0@@16 T@U) (TraitsExtendingTraits.A$Y1@@16 T@U) ($h0@@0 T@U) ($h1@@0 T@U) (this@@6 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (and (or (not (= this@@6 null)) (not true)) ($Is refType this@@6 (Tclass.TraitsExtendingTraits.A TraitsExtendingTraits.A$Y0@@16 TraitsExtendingTraits.A$Y1@@16)))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@41 T@U) ($f@@1 T@U) )  (=> (and (or (not (= $o@@41 null)) (not true)) (= $o@@41 this@@6)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@41) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@0 $o@@41) $f@@1)))) (= (TraitsExtendingTraits.A.GetY TraitsExtendingTraits.A$Y0@@16 TraitsExtendingTraits.A$Y1@@16 $h0@@0 this@@6) (TraitsExtendingTraits.A.GetY TraitsExtendingTraits.A$Y0@@16 TraitsExtendingTraits.A$Y1@@16 $h1@@0 this@@6))))
...
(assert (forall ((TraitsExtendingTraits.A$Y0@@17 T@U) (TraitsExtendingTraits.A$Y1@@17 T@U) ($h0@@1 T@U) ($h1@@1 T@U) (this@@7 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@1) ($IsGoodHeap $h1@@1)) (and (or (not (= this@@7 null)) (not true)) ($Is refType this@@7 (Tclass.TraitsExtendingTraits.A TraitsExtendingTraits.A$Y0@@17 TraitsExtendingTraits.A$Y1@@17)))) (and ($IsHeapAnchor $h0@@1) ($HeapSucc $h0@@1 $h1@@1))) (=> (forall (($o@@42 T@U) ($f@@2 T@U) )  (=> (and (or (not (= $o@@42 null)) (not true)) (= $o@@42 this@@7)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@1 $o@@42) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@1 $o@@42) $f@@2)))) (= (TraitsExtendingTraits.A.GetY_k TraitsExtendingTraits.A$Y0@@17 TraitsExtendingTraits.A$Y1@@17 $h0@@1 this@@7) (TraitsExtendingTraits.A.GetY_k TraitsExtendingTraits.A$Y0@@17 TraitsExtendingTraits.A$Y1@@17 $h1@@1 this@@7))))
