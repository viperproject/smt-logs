...
(assert (distinct TInt TagInt alloc Tagclass._System.Tuple2 Tagclass.GenericBasics.Cl Tagclass.GenericBasics.Tr Tagclass.GenericBasics.Tr? Tagclass.GenericBasics.Cl? |tytagFamily$_tuple#2| tytagFamily$Cl tytagFamily$Tr)
)
...
(assert (forall ((GenericBasics.Cl$Q@@2 T@U) ($o@@0 T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType $o@@0 (Tclass.GenericBasics.Cl? GenericBasics.Cl$Q@@2) $h@@0)  (or (= $o@@0 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@0 $o@@0) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1762|
 :pattern ( ($IsAlloc refType $o@@0 (Tclass.GenericBasics.Cl? GenericBasics.Cl$Q@@2) $h@@0))
)))
...
(assert (forall ((GenericBasics.Cl$Q@@3 T@U) (|c#0@@1| T@U) ) (! (= ($Is refType |c#0@@1| (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@3))  (and ($Is refType |c#0@@1| (Tclass.GenericBasics.Cl? GenericBasics.Cl$Q@@3)) (or (not (= |c#0@@1| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |1828|
 :pattern ( ($Is refType |c#0@@1| (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@3)))
 :pattern ( ($Is refType |c#0@@1| (Tclass.GenericBasics.Cl? GenericBasics.Cl$Q@@3)))
)))
(assert (forall ((GenericBasics.Cl$Q@@4 T@U) ) (!  (and (= (Tag (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@4)) Tagclass.GenericBasics.Cl) (= (TagFamily (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@4)) tytagFamily$Cl))
 :qid |unknown.0:0|
 :skolemid |1679|
 :pattern ( (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@4))
)))
...
(assert (forall ((GenericBasics.Cl$Q@@6 T@U) ($o@@1 T@U) ) (! (= ($Is refType $o@@1 (Tclass.GenericBasics.Cl? GenericBasics.Cl$Q@@6))  (or (= $o@@1 null) (= (dtype $o@@1) (Tclass.GenericBasics.Cl? GenericBasics.Cl$Q@@6))))
 :qid |unknown.0:0|
 :skolemid |1761|
 :pattern ( ($Is refType $o@@1 (Tclass.GenericBasics.Cl? GenericBasics.Cl$Q@@6)))
)))
(assert (forall ((GenericBasics.Cl$Q@@7 T@U) ($o@@2 T@U) ($heap T@U) ) (!  (=> ($IsAlloc refType $o@@2 (Tclass.GenericBasics.Cl? GenericBasics.Cl$Q@@7) $heap) ($IsAlloc refType $o@@2 (Tclass.GenericBasics.Tr? GenericBasics.Cl$Q@@7 TInt) $heap))
 :qid |unknown.0:0|
 :skolemid |1907|
 :pattern ( ($IsAlloc refType $o@@2 (Tclass.GenericBasics.Cl? GenericBasics.Cl$Q@@7) $heap))
)))
...
(assert (forall ((GenericBasics.Cl$Q@@8 T@U) ) (! (= (Tclass.GenericBasics.Cl_0 (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@8)) GenericBasics.Cl$Q@@8)
 :qid |unknown.0:0|
 :skolemid |1680|
 :pattern ( (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@8))
)))
(assert (forall ((GenericBasics.Cl$Q@@9 T@U) ) (! (= (Tclass.GenericBasics.Cl?_0 (Tclass.GenericBasics.Cl? GenericBasics.Cl$Q@@9)) GenericBasics.Cl$Q@@9)
 :qid |unknown.0:0|
 :skolemid |1759|
...
(declare-fun GenericBasics.Cl$Q@@10 () T@U)
(declare-fun GenericBasics.Tr$B@@9 () T@U)
(declare-fun GenericBasics.Tr.Teen$R () T@U)
(declare-fun GenericBasics.Cl.Teen$S () T@U)
...
(set-info :boogie-vc-id OverrideCheck$$GenericBasics.Cl.Teen)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= GenericBasics.Tr$A@@9 GenericBasics.Cl$Q@@10) (=> (and (= GenericBasics.Tr$B@@9 TInt) (= GenericBasics.Tr.Teen$R GenericBasics.Cl.Teen$S)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (DtRank |a#0|) (DtRank |a#0|))) (=> (<= (DtRank |a#0|) (DtRank |a#0|)) (=> (and (= Cl_$_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (forall (($o@@6 T@U) ($f@@0 T@U) ) (! true
 :qid |TraitCompiledfy.225:14|
 :skolemid |1784|
)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@10)) ($IsAlloc refType this (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@10) $Heap))) ($Is DatatypeTypeType |a#0| (Tclass._System.Tuple2 GenericBasics.Cl$Q@@10 GenericBasics.Cl.Teen$S))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
