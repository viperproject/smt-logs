...
(set-info :boogie-vc-id CheckWellFormed$$_module.Catacar.Drive)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@5 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@8) _module.Automobile.Repr)))) ($IsAllocBox ($Box refType this@@8) Tclass._module.Catacar? $Heap@@5)) (and (|_module.Catacar.Valid#canCall| $Heap@@5 this@@8) (_module.Catacar.Valid $Heap@@5 this@@8))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@33 T@U) ) (!  (=> (and (or (not (= $o@@33 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@33) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@33) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@33)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@8) _module.Automobile.Repr)) ($Box refType $o@@33))))
 :qid |TraitExampledfy.115:10|
 :skolemid |659|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@33))
))) (and (and ($HeapSucc $Heap@@5 $Heap@0) ($IsAllocBox ($Box refType this@@8) Tclass._module.Catacar? $Heap@0)) (and (|_module.Catacar.Valid#canCall| $Heap@0 this@@8) (_module.Catacar.Valid $Heap@0 this@@8)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType this@@8 Tclass._module.Catacar $Heap@@5)) (=> ($IsAlloc refType this@@8 Tclass._module.Catacar $Heap@@5) (=> (and (and (forall (($o@@34 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@8) _module.Automobile.Repr)) ($Box refType $o@@34)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@8) _module.Automobile.Repr)) ($Box refType $o@@34)))) (or (not (= $o@@34 null)) (not true)))
 :qid |TraitExampledfy.118:24|
 :skolemid |660|
 :pattern (  (or (not (= $o@@34 null)) (not true)))
)) (forall (($o@@35 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@8) _module.Automobile.Repr)) ($Box refType $o@@35)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@8) _module.Automobile.Repr)) ($Box refType $o@@35)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@35) alloc)))))
 :qid |TraitExampledfy.118:24|
 :skolemid |661|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@35) alloc)))
))) (= (ControlFlow 0 2) (- 0 1))) ($IsAlloc refType this@@8 Tclass._module.Catacar $Heap@@5))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@5) ($IsHeapAnchor $Heap@@5)) (=> (and (and (or (not (= this@@8 null)) (not true)) (and ($Is refType this@@8 Tclass._module.Catacar) ($IsAlloc refType this@@8 Tclass._module.Catacar $Heap@@5))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
