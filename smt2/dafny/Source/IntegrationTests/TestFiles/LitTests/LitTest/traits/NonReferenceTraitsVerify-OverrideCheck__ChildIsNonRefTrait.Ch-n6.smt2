...
(assert (forall (($o@@4 T@U) ) (!  (=> ($Is refType $o@@4 Tclass.ChildIsNonRefTrait.Child?) ($Is refType $o@@4 Tclass.ChildIsNonRefTrait.Parent?))
 :qid |unknown.0:0|
 :skolemid |554|
 :pattern ( ($Is refType $o@@4 Tclass.ChildIsNonRefTrait.Child?))
)))
...
(assert (forall (($o@@6 T@U) ) (! (= ($Is refType $o@@6 Tclass.ChildIsNonRefTrait.Child?)  (or (= $o@@6 null) (implements$ChildIsNonRefTrait.Child (dtype $o@@6))))
 :qid |unknown.0:0|
 :skolemid |497|
 :pattern ( ($Is refType $o@@6 Tclass.ChildIsNonRefTrait.Child?))
)))
...
(declare-fun |p#0| () Int)
(set-info :boogie-vc-id OverrideCheck$$ChildIsNonRefTrait.Child.M)
...
)) ($HeapSucc $Heap $Heap@0)) (and (< |p#0| (+ (+ (ChildIsNonRefTrait.Parent.yy this@@3) (ChildIsNonRefTrait.Child.F this@@3 (LitInt 5))) 100)) (= (ControlFlow 0 2) (- 0 1)))) (< |p#0| (+ (+ (ChildIsNonRefTrait.Parent.yy this@@3) (ChildIsNonRefTrait.Child.F this@@3 (LitInt 5))) 900))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.ChildIsNonRefTrait.Child) ($IsAlloc refType this@@3 Tclass.ChildIsNonRefTrait.Child $Heap))) (<= (LitInt 0) |p#0|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 7) 2))) anon0_correct))))
