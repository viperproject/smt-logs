...
(assert (forall ((t0@@11 T@U) (t1@@11 T@U) (heap@@0 T@U) (f@@10 T@U) (bx0@@9 T@U) ) (!  (=> (and (and ($IsGoodHeap heap@@0) (and ($IsBox bx0@@9 t0@@11) ($Is HandleTypeType f@@10 (Tclass._System.___hFunc1 t0@@11 t1@@11)))) (|Set#Equal| (Reads1 t0@@11 t1@@11 $OneHeap f@@10 bx0@@9) |Set#Empty|)) (= (Requires1 t0@@11 t1@@11 $OneHeap f@@10 bx0@@9) (Requires1 t0@@11 t1@@11 heap@@0 f@@10 bx0@@9)))
 :qid |unknown.0:0|
 :skolemid |3677|
 :pattern ( (Requires1 t0@@11 t1@@11 $OneHeap f@@10 bx0@@9) ($IsGoodHeap heap@@0))
 :pattern ( (Requires1 t0@@11 t1@@11 heap@@0 f@@10 bx0@@9))
)))
...
(assert (forall (($o@@4 T@U) ($heap T@U) ) (!  (=> ($IsAlloc refType $o@@4 Tclass.TypeDescriptorTests.YT? $heap) ($IsAlloc refType $o@@4 (Tclass.TypeDescriptorTests.XT? (Tclass._System.___hTotalFunc1 TInt TInt) TInt) $heap))
 :qid |unknown.0:0|
 :skolemid |4016|
 :pattern ( ($IsAlloc refType $o@@4 Tclass.TypeDescriptorTests.YT? $heap))
)))
...
(set-info :boogie-vc-id OverrideCheck$$TypeDescriptorTests.YT.N_k)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (= TypeDescriptorTests.XT$U@@11 (Tclass._System.___hTotalFunc1 TInt TInt)) (= TypeDescriptorTests.XT$W@@11 TInt)) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@5 T@U) ($f T@U) ) (! true
 :qid |TraitCompiledfy.548:12|
 :skolemid |3972|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass.TypeDescriptorTests.YT) ($IsAlloc refType this Tclass.TypeDescriptorTests.YT $Heap))) (and ($Is HandleTypeType |uu#0| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |uu#0| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap))) (and (and ($Is HandleTypeType |rr#0| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |rr#0| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 2)))) anon0_correct))))
