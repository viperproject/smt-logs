...
(assert (forall ((_module.AnotherImpl$T@@8 T@U) ($o@@3 T@U) ) (! (= ($Is refType $o@@3 (Tclass._module.AnotherImpl? _module.AnotherImpl$T@@8))  (or (= $o@@3 null) (= (dtype $o@@3) (Tclass._module.AnotherImpl? _module.AnotherImpl$T@@8))))
 :qid |unknown.0:0|
 :skolemid |535|
 :pattern ( ($Is refType $o@@3 (Tclass._module.AnotherImpl? _module.AnotherImpl$T@@8)))
)))
...
(assert (forall ((_module.AnotherImpl$T@@10 T@U) ($o@@5 T@U) ($heap T@U) ) (!  (=> ($IsAlloc refType $o@@5 (Tclass._module.AnotherImpl? _module.AnotherImpl$T@@10) $heap) ($IsAlloc refType $o@@5 (Tclass._module.Spec? (TSeq _module.AnotherImpl$T@@10)) $heap))
 :qid |unknown.0:0|
 :skolemid |587|
 :pattern ( ($IsAlloc refType $o@@5 (Tclass._module.AnotherImpl? _module.AnotherImpl$T@@10) $heap))
)))
...
(assert (forall ((_module.Spec$U@@7 T@U) ($o@@7 T@U) ) (! (= ($Is refType $o@@7 (Tclass._module.Spec? _module.Spec$U@@7))  (or (= $o@@7 null) (implements$_module.Spec (dtype $o@@7) _module.Spec$U@@7)))
 :qid |unknown.0:0|
 :skolemid |482|
 :pattern ( ($Is refType $o@@7 (Tclass._module.Spec? _module.Spec$U@@7)))
)))
...
(assert (forall ((_module.Spec$U@@8 T@U) (bx@@7 T@U) ) (!  (=> ($IsBox bx@@7 (Tclass._module.Spec? _module.Spec$U@@8)) (and (= ($Box refType ($Unbox refType bx@@7)) bx@@7) ($Is refType ($Unbox refType bx@@7) (Tclass._module.Spec? _module.Spec$U@@8))))
 :qid |unknown.0:0|
 :skolemid |481|
 :pattern ( ($IsBox bx@@7 (Tclass._module.Spec? _module.Spec$U@@8)))
)))
(assert (forall ((_module.Spec$U@@9 T@U) (bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 (Tclass._module.Spec _module.Spec$U@@9)) (and (= ($Box refType ($Unbox refType bx@@8)) bx@@8) ($Is refType ($Unbox refType bx@@8) (Tclass._module.Spec _module.Spec$U@@9))))
 :qid |unknown.0:0|
 :skolemid |493|
 :pattern ( ($IsBox bx@@8 (Tclass._module.Spec _module.Spec$U@@9)))
)))
(assert (forall ((_module.AnotherImpl$T@@14 T@U) (bx@@9 T@U) ) (!  (=> ($IsBox bx@@9 (Tclass._module.AnotherImpl? _module.AnotherImpl$T@@14)) (and (= ($Box refType ($Unbox refType bx@@9)) bx@@9) ($Is refType ($Unbox refType bx@@9) (Tclass._module.AnotherImpl? _module.AnotherImpl$T@@14))))
 :qid |unknown.0:0|
 :skolemid |534|
 :pattern ( ($IsBox bx@@9 (Tclass._module.AnotherImpl? _module.AnotherImpl$T@@14)))
)))
...
(assert (= (Tag Tclass._System.object) Tagclass._System.object))
(assert (= (TagFamily Tclass._System.object) tytagFamily$object))
(assert  (=> (< 0 $FunctionContextHeight) (forall ((_module.Spec$U@@10 T@U) ($h@@6 T@U) ($o@@8 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@6) (and (or (not (= $o@@8 null)) (not true)) ($Is refType $o@@8 (Tclass._module.Spec? _module.Spec$U@@10)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@8) alloc)))) ($IsAlloc SetType (_module.Spec.Repr _module.Spec$U@@10 $o@@8) (TSet Tclass._System.object) $h@@6))
 :qid |unknown.0:0|
 :skolemid |489|
 :pattern ( (_module.Spec.Repr _module.Spec$U@@10 $o@@8) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@8) alloc)))
))))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@9 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#1| |l#0| |l#1| |l#2| |l#3|) $o@@9 $f))  (=> (and (or (not (= $o@@9 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@9) |l#2|)))) (|Set#IsMember| |l#3| ($Box refType $o@@9))))
...
(declare-fun |u#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.AnotherImpl.DoIt)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@1 alloc (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@16) this@@1))) (= (ControlFlow 0 2) (- 0 1))) (|_module.AnotherImpl.Valid#canCall| _module.AnotherImpl$T@@16 $Heap@@1 this@@1)) (or (_module.AnotherImpl.Valid _module.AnotherImpl$T@@16 $Heap@@1 this@@1) (|Set#IsMember| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@16) this@@1) ($Box refType this@@1))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 (Tclass._module.AnotherImpl _module.AnotherImpl$T@@16)) ($IsAlloc refType this@@1 (Tclass._module.AnotherImpl _module.AnotherImpl$T@@16) $Heap@@1)))) (=> (and (and (and ($Is SeqType |u#0| (TSeq _module.AnotherImpl$T@@16)) ($IsAlloc SeqType |u#0| (TSeq _module.AnotherImpl$T@@16) $Heap@@1)) (= 2 $FunctionContextHeight)) (and (and (|_module.AnotherImpl.Valid#canCall| _module.AnotherImpl$T@@16 $Heap@@1 this@@1) (and (_module.AnotherImpl.Valid _module.AnotherImpl$T@@16 $Heap@@1 this@@1) (|Set#IsMember| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@16) this@@1) ($Box refType this@@1)))) (= (ControlFlow 0 3) 2))) anon0_correct))))
