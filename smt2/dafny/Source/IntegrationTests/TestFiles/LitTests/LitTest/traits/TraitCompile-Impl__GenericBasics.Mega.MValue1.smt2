...
(assert (forall ((GenericBasics.Mega$P@@14 T@U) (GenericBasics.Mega$Q@@14 T@U) (GenericBasics.Mega$L@@14 T@U) (bx@@2 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsAllocBox bx@@2 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@14 GenericBasics.Mega$Q@@14 GenericBasics.Mega$L@@14) $h@@2) ($IsGoodHeap $h@@2)) ($IsAllocBox bx@@2 (Tclass.GenericBasics.Tr? GenericBasics.Mega$Q@@14 TInt) $h@@2))
 :qid |unknown.0:0|
 :skolemid |1909|
 :pattern ( ($IsAllocBox bx@@2 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@14 GenericBasics.Mega$Q@@14 GenericBasics.Mega$L@@14) $h@@2))
)))
...
(assert (forall ((GenericBasics.Tr$A@@7 T@U) (GenericBasics.Tr$B@@7 T@U) (bx@@4 T@U) ) (!  (=> ($IsBox bx@@4 (Tclass.GenericBasics.Tr GenericBasics.Tr$A@@7 GenericBasics.Tr$B@@7)) (and (= ($Box refType ($Unbox refType bx@@4)) bx@@4) ($Is refType ($Unbox refType bx@@4) (Tclass.GenericBasics.Tr GenericBasics.Tr$A@@7 GenericBasics.Tr$B@@7))))
 :qid |unknown.0:0|
 :skolemid |1692|
 :pattern ( ($IsBox bx@@4 (Tclass.GenericBasics.Tr GenericBasics.Tr$A@@7 GenericBasics.Tr$B@@7)))
)))
(assert (forall ((GenericBasics.Tr$A@@8 T@U) (GenericBasics.Tr$B@@8 T@U) (bx@@5 T@U) ) (!  (=> ($IsBox bx@@5 (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@8 GenericBasics.Tr$B@@8)) (and (= ($Box refType ($Unbox refType bx@@5)) bx@@5) ($Is refType ($Unbox refType bx@@5) (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@8 GenericBasics.Tr$B@@8))))
 :qid |unknown.0:0|
 :skolemid |1700|
 :pattern ( ($IsBox bx@@5 (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@8 GenericBasics.Tr$B@@8)))
)))
...
(assert (forall ((GenericBasics.Mega$P@@15 T@U) (GenericBasics.Mega$Q@@15 T@U) (GenericBasics.Mega$L@@15 T@U) ($o@@4 T@U) ) (! (= ($Is refType $o@@4 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@15 GenericBasics.Mega$Q@@15 GenericBasics.Mega$L@@15))  (or (= $o@@4 null) (= (dtype $o@@4) (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@15 GenericBasics.Mega$Q@@15 GenericBasics.Mega$L@@15))))
 :qid |unknown.0:0|
 :skolemid |1835|
 :pattern ( ($Is refType $o@@4 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@15 GenericBasics.Mega$Q@@15 GenericBasics.Mega$L@@15)))
)))
...
(assert (forall ((GenericBasics.Mega$P@@17 T@U) (GenericBasics.Mega$Q@@17 T@U) (GenericBasics.Mega$L@@17 T@U) ($o@@5 T@U) ($heap T@U) ) (!  (=> ($IsAlloc refType $o@@5 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@17 GenericBasics.Mega$Q@@17 GenericBasics.Mega$L@@17) $heap) ($IsAlloc refType $o@@5 (Tclass.GenericBasics.Tr? GenericBasics.Mega$Q@@17 TInt) $heap))
 :qid |unknown.0:0|
 :skolemid |1911|
 :pattern ( ($IsAlloc refType $o@@5 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@17 GenericBasics.Mega$Q@@17 GenericBasics.Mega$L@@17) $heap))
)))
...
(set-info :boogie-vc-id Impl$$GenericBasics.Mega.MValue1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |$rhs#0@0| (+ |b#0| 4)) (= (ControlFlow 0 2) (- 0 1))) true))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@18 GenericBasics.Mega$Q@@18 GenericBasics.Mega$L@@18)) ($IsAlloc refType this (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@18 GenericBasics.Mega$Q@@18 GenericBasics.Mega$L@@18) $Heap)))) (=> (and (and (and ($IsBox |x#0| GenericBasics.Mega.MValue1$XX) ($IsAllocBox |x#0| GenericBasics.Mega.MValue1$XX $Heap)) (=> |defass#y#0| (and ($IsBox |y#0| GenericBasics.Mega.MValue1$XX) ($IsAllocBox |y#0| GenericBasics.Mega.MValue1$XX $Heap)))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
