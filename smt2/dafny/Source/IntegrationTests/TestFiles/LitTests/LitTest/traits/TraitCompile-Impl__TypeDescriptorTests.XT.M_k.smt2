...
(assert (distinct alloc Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 Tagclass._System.___hTotalFunc1 Tagclass.TypeDescriptorTests.XT? Tagclass.TypeDescriptorTests.XT |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1| |tytagFamily$_#TotalFunc1| tytagFamily$XT)
)
...
(assert (forall ((TypeDescriptorTests.XT$U@@0 T@U) (TypeDescriptorTests.XT$W@@0 T@U) (|c#0@@0| T@U) ($h@@1 T@U) ) (! (= ($IsAlloc refType |c#0@@0| (Tclass.TypeDescriptorTests.XT TypeDescriptorTests.XT$U@@0 TypeDescriptorTests.XT$W@@0) $h@@1) ($IsAlloc refType |c#0@@0| (Tclass.TypeDescriptorTests.XT? TypeDescriptorTests.XT$U@@0 TypeDescriptorTests.XT$W@@0) $h@@1))
 :qid |unknown.0:0|
 :skolemid |3942|
 :pattern ( ($IsAlloc refType |c#0@@0| (Tclass.TypeDescriptorTests.XT TypeDescriptorTests.XT$U@@0 TypeDescriptorTests.XT$W@@0) $h@@1))
 :pattern ( ($IsAlloc refType |c#0@@0| (Tclass.TypeDescriptorTests.XT? TypeDescriptorTests.XT$U@@0 TypeDescriptorTests.XT$W@@0) $h@@1))
)))
...
(assert  (and (and (and (and (and (and (forall ((t0@@2 T@T) (t1@@2 T@T) (val T@U) (m T@U) (x0 T@U) ) (! (= (MapType0Select t0@@2 t1@@2 (MapType0Store t0@@2 t1@@2 m x0 val) x0) val)
...
(assert (forall ((TypeDescriptorTests.XT$U@@1 T@U) (TypeDescriptorTests.XT$W@@1 T@U) ($o T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType $o (Tclass.TypeDescriptorTests.XT? TypeDescriptorTests.XT$U@@1 TypeDescriptorTests.XT$W@@1) $h@@2)  (or (= $o null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o) alloc)))))
 :qid |unknown.0:0|
 :skolemid |3910|
 :pattern ( ($IsAlloc refType $o (Tclass.TypeDescriptorTests.XT? TypeDescriptorTests.XT$U@@1 TypeDescriptorTests.XT$W@@1) $h@@2))
)))
...
(assert (forall ((TypeDescriptorTests.XT$U@@7 T@U) (TypeDescriptorTests.XT$W@@7 T@U) (bx@@4 T@U) ) (!  (=> ($IsBox bx@@4 (Tclass.TypeDescriptorTests.XT? TypeDescriptorTests.XT$U@@7 TypeDescriptorTests.XT$W@@7)) (and (= ($Box refType ($Unbox refType bx@@4)) bx@@4) ($Is refType ($Unbox refType bx@@4) (Tclass.TypeDescriptorTests.XT? TypeDescriptorTests.XT$U@@7 TypeDescriptorTests.XT$W@@7))))
 :qid |unknown.0:0|
 :skolemid |3842|
 :pattern ( ($IsBox bx@@4 (Tclass.TypeDescriptorTests.XT? TypeDescriptorTests.XT$U@@7 TypeDescriptorTests.XT$W@@7)))
)))
(assert (forall ((TypeDescriptorTests.XT$U@@8 T@U) (TypeDescriptorTests.XT$W@@8 T@U) (bx@@5 T@U) ) (!  (=> ($IsBox bx@@5 (Tclass.TypeDescriptorTests.XT TypeDescriptorTests.XT$U@@8 TypeDescriptorTests.XT$W@@8)) (and (= ($Box refType ($Unbox refType bx@@5)) bx@@5) ($Is refType ($Unbox refType bx@@5) (Tclass.TypeDescriptorTests.XT TypeDescriptorTests.XT$U@@8 TypeDescriptorTests.XT$W@@8))))
 :qid |unknown.0:0|
 :skolemid |3847|
 :pattern ( ($IsBox bx@@5 (Tclass.TypeDescriptorTests.XT TypeDescriptorTests.XT$U@@8 TypeDescriptorTests.XT$W@@8)))
)))
...
(set-info :boogie-vc-id Impl$$TypeDescriptorTests.XT.M_k)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass.TypeDescriptorTests.XT TypeDescriptorTests.XT$U@@11 TypeDescriptorTests.XT$W@@11)) ($IsAlloc refType this (Tclass.TypeDescriptorTests.XT TypeDescriptorTests.XT$U@@11 TypeDescriptorTests.XT$W@@11) $Heap)))) (=> (and (and (and ($Is HandleTypeType |u#0| (Tclass._System.___hTotalFunc1 TypeDescriptorTests.XT$W@@11 TypeDescriptorTests.XT$W@@11)) ($IsAlloc HandleTypeType |u#0| (Tclass._System.___hTotalFunc1 TypeDescriptorTests.XT$W@@11 TypeDescriptorTests.XT$W@@11) $Heap)) (=> |defass#r#0| (and ($Is HandleTypeType |r#0| (Tclass._System.___hTotalFunc1 TypeDescriptorTests.XT$W@@11 TypeDescriptorTests.XT$W@@11)) ($IsAlloc HandleTypeType |r#0| (Tclass._System.___hTotalFunc1 TypeDescriptorTests.XT$W@@11 TypeDescriptorTests.XT$W@@11) $Heap)))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
