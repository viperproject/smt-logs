...
(assert (forall ((_module.AnotherImpl$T@@8 T@U) ($o@@6 T@U) ) (! (= ($Is refType $o@@6 (Tclass._module.AnotherImpl? _module.AnotherImpl$T@@8))  (or (= $o@@6 null) (= (dtype $o@@6) (Tclass._module.AnotherImpl? _module.AnotherImpl$T@@8))))
 :qid |unknown.0:0|
 :skolemid |535|
 :pattern ( ($Is refType $o@@6 (Tclass._module.AnotherImpl? _module.AnotherImpl$T@@8)))
)))
...
(assert (forall ((_module.AnotherImpl$T@@9 T@U) (bx@@3 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsAllocBox bx@@3 (Tclass._module.AnotherImpl? _module.AnotherImpl$T@@9) $h@@7) ($IsGoodHeap $h@@7)) ($IsAllocBox bx@@3 (Tclass._module.Spec? (TSeq _module.AnotherImpl$T@@9)) $h@@7))
 :qid |unknown.0:0|
 :skolemid |585|
 :pattern ( ($IsAllocBox bx@@3 (Tclass._module.AnotherImpl? _module.AnotherImpl$T@@9) $h@@7))
)))
(assert (forall ((_module.AnotherImpl$T@@10 T@U) ($o@@8 T@U) ($heap T@U) ) (!  (=> ($IsAlloc refType $o@@8 (Tclass._module.AnotherImpl? _module.AnotherImpl$T@@10) $heap) ($IsAlloc refType $o@@8 (Tclass._module.Spec? (TSeq _module.AnotherImpl$T@@10)) $heap))
 :qid |unknown.0:0|
 :skolemid |587|
 :pattern ( ($IsAlloc refType $o@@8 (Tclass._module.AnotherImpl? _module.AnotherImpl$T@@10) $heap))
)))
...
(declare-fun AnotherImpl_$_ReadsFrame@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id OverrideCheck$$_module.AnotherImpl.Valid)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (= _module.Spec$U@@15 (TSeq _module.AnotherImpl$T@@16)) (or (or (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Spec.done))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Spec.hasFailed)))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Spec.done)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Spec.hasFailed))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Set#Subset| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@16) this@@1) (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@16) this@@1))) (=> (|Set#Subset| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@16) this@@1) (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@16) this@@1)) (=> (= AnotherImpl_$_ReadsFrame@0 (|lambda#0| null $Heap@@1 alloc this@@1 (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@16) this@@1))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@14 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@14) alloc)))) (or (= $o@@14 this@@1) (|Set#IsMember| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@16) this@@1) ($Box refType $o@@14)))) (or (= $o@@14 this@@1) (|Set#IsMember| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@16) this@@1) ($Box refType $o@@14))))
 :qid |TraitOverride2dfy.73:19|
 :skolemid |550|
))) (=> (forall (($o@@15 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@15 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@15) alloc)))) (or (= $o@@15 this@@1) (|Set#IsMember| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@16) this@@1) ($Box refType $o@@15)))) (or (= $o@@15 this@@1) (|Set#IsMember| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@16) this@@1) ($Box refType $o@@15))))
 :qid |TraitOverride2dfy.73:19|
 :skolemid |550|
)) (=> (and (and (=> (_module.AnotherImpl.Valid _module.AnotherImpl$T@@16 $Heap@@1 this@@1) (|Set#IsMember| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@16) this@@1) ($Box refType this@@1))) (= (ControlFlow 0 2) (- 0 1))) (_module.AnotherImpl.Valid _module.AnotherImpl$T@@16 $Heap@@1 this@@1)) (|Set#IsMember| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@16) this@@1) ($Box refType this@@1)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 (Tclass._module.AnotherImpl _module.AnotherImpl$T@@16)) ($IsAlloc refType this@@1 (Tclass._module.AnotherImpl _module.AnotherImpl$T@@16) $Heap@@1))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct))))
