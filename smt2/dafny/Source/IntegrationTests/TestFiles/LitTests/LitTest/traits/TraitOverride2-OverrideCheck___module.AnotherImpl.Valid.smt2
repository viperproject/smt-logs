...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (= _module.Spec$U@@15 (TSeq _module.AnotherImpl$T@@16)) (or (or (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Spec.done))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Spec.hasFailed)))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Spec.done)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Spec.hasFailed))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Set#Subset| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@16) this@@1) (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@16) this@@1))) (=> (|Set#Subset| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@16) this@@1) (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@16) this@@1)) (=> (= AnotherImpl_$_ReadsFrame@0 (|lambda#0| null $Heap@@1 alloc this@@1 (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@16) this@@1))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@14 T@U) ($f@@0 T@U) )  (=> (and (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@14) alloc)))) (or (= $o@@14 this@@1) (|Set#IsMember| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@16) this@@1) ($Box refType $o@@14)))) (or (= $o@@14 this@@1) (|Set#IsMember| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@16) this@@1) ($Box refType $o@@14)))))) (=> (forall (($o@@15 T@U) ($f@@1 T@U) )  (=> (and (and (or (not (= $o@@15 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@15) alloc)))) (or (= $o@@15 this@@1) (|Set#IsMember| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@16) this@@1) ($Box refType $o@@15)))) (or (= $o@@15 this@@1) (|Set#IsMember| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@16) this@@1) ($Box refType $o@@15))))) (=> (and (and (=> (_module.AnotherImpl.Valid _module.AnotherImpl$T@@16 $Heap@@1 this@@1) (|Set#IsMember| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@16) this@@1) ($Box refType this@@1))) (= (ControlFlow 0 2) (- 0 1))) (_module.AnotherImpl.Valid _module.AnotherImpl$T@@16 $Heap@@1 this@@1)) (|Set#IsMember| (_module.Spec.Repr (TSeq _module.AnotherImpl$T@@16) this@@1) ($Box refType this@@1)))))))))))
