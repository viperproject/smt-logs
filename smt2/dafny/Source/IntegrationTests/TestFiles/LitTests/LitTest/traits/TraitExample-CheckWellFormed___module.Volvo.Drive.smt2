...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@17 T@U) ($f@@0 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#1| |l#0| |l#1| |l#2| |l#3|) $o@@17 $f@@0))  (=> (and (or (not (= $o@@17 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@17) |l#2|)))) (|Set#IsMember| |l#3| ($Box refType $o@@17))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |693|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#1| |l#0| |l#1| |l#2| |l#3|) $o@@17 $f@@0))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.Volvo.Drive)
...
))) (= (ControlFlow 0 2) (- 0 1))) ($IsAlloc refType this@@2 Tclass._module.Volvo $Heap@@1))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.Volvo) ($IsAlloc refType this@@2 Tclass._module.Volvo $Heap@@1))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
