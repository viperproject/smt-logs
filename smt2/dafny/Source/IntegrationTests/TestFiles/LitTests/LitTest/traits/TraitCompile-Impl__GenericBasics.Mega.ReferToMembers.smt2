...
(declare-fun GenericBasics.Mega.Teen (T@U T@U T@U T@U T@U T@U) Int)
(declare-fun |GenericBasics.Mega.Teen#canCall| (T@U T@U T@U T@U T@U T@U) Bool)
...
(assert (distinct TBool TInt TagBool TagInt TagSet TagSeq alloc allocName |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass.GenericBasics.Mega Tagclass.GenericBasics.Tr Tagclass.GenericBasics.Tr? class.GenericBasics.Tr? Tagclass.GenericBasics.Mega? |tytagFamily$_tuple#2| tytagFamily$Mega tytagFamily$Tr field$xyz)
)
(assert (= (FDim alloc) 0))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((GenericBasics.Mega$P@@10 T@U) (GenericBasics.Mega$Q@@10 T@U) (GenericBasics.Mega$L@@10 T@U) (GenericBasics.Mega.Teen$S T@U) (this T@U) (|a#0@@1| T@U) ) (!  (=> (or (|GenericBasics.Mega.Teen#canCall| GenericBasics.Mega$P@@10 GenericBasics.Mega$Q@@10 GenericBasics.Mega$L@@10 GenericBasics.Mega.Teen$S (Lit refType this) (Lit DatatypeTypeType |a#0@@1|)) (and (< 0 $FunctionContextHeight) (and (and (or (not (= this null)) (not true)) ($Is refType this (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@10 GenericBasics.Mega$Q@@10 GenericBasics.Mega$L@@10))) ($Is DatatypeTypeType |a#0@@1| (Tclass._System.Tuple2 GenericBasics.Mega$Q@@10 GenericBasics.Mega.Teen$S))))) (= (GenericBasics.Mega.Teen GenericBasics.Mega$P@@10 GenericBasics.Mega$Q@@10 GenericBasics.Mega$L@@10 GenericBasics.Mega.Teen$S (Lit refType this) (Lit DatatypeTypeType |a#0@@1|)) (LitInt 12)))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |1856|
 :pattern ( (GenericBasics.Mega.Teen GenericBasics.Mega$P@@10 GenericBasics.Mega$Q@@10 GenericBasics.Mega$L@@10 GenericBasics.Mega.Teen$S (Lit refType this) (Lit DatatypeTypeType |a#0@@1|)))
))))
...
(assert (forall ((v@@9 T@U) (t0@@0 T@U) ) (! (= ($Is SetType v@@9 (TSet t0@@0)) (forall ((bx@@2 T@U) ) (!  (=> (|Set#IsMember| v@@9 bx@@2) ($IsBox bx@@2 t0@@0))
 :qid |DafnyPreludebpl.240:11|
 :skolemid |1178|
 :pattern ( (|Set#IsMember| v@@9 bx@@2))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((GenericBasics.Tr$A@@2 T@U) (GenericBasics.Tr$B@@2 T@U) (GenericBasics.Tr.Teen$R T@U) (this@@0 T@U) (|a#0@@2| T@U) ) (!  (=> (or (|GenericBasics.Tr.Teen#canCall| GenericBasics.Tr$A@@2 GenericBasics.Tr$B@@2 GenericBasics.Tr.Teen$R this@@0 |a#0@@2|) (and (< 1 $FunctionContextHeight) (and (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 (Tclass.GenericBasics.Tr GenericBasics.Tr$A@@2 GenericBasics.Tr$B@@2))) ($Is DatatypeTypeType |a#0@@2| (Tclass._System.Tuple2 GenericBasics.Tr$A@@2 GenericBasics.Tr.Teen$R))))) ($IsBox (GenericBasics.Tr.Teen GenericBasics.Tr$A@@2 GenericBasics.Tr$B@@2 GenericBasics.Tr.Teen$R this@@0 |a#0@@2|) GenericBasics.Tr$B@@2))
 :qid |unknown.0:0|
 :skolemid |1717|
 :pattern ( (GenericBasics.Tr.Teen GenericBasics.Tr$A@@2 GenericBasics.Tr$B@@2 GenericBasics.Tr.Teen$R this@@0 |a#0@@2|))
))))
...
(assert (forall ((GenericBasics.Tr$A@@4 T@U) (GenericBasics.Tr$B@@4 T@U) (|c#0@@1| T@U) ($h@@1 T@U) ) (! (= ($IsAlloc refType |c#0@@1| (Tclass.GenericBasics.Tr GenericBasics.Tr$A@@4 GenericBasics.Tr$B@@4) $h@@1) ($IsAlloc refType |c#0@@1| (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@4 GenericBasics.Tr$B@@4) $h@@1))
 :qid |unknown.0:0|
 :skolemid |1757|
 :pattern ( ($IsAlloc refType |c#0@@1| (Tclass.GenericBasics.Tr GenericBasics.Tr$A@@4 GenericBasics.Tr$B@@4) $h@@1))
 :pattern ( ($IsAlloc refType |c#0@@1| (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@4 GenericBasics.Tr$B@@4) $h@@1))
)))
...
(assert (forall ((GenericBasics.Mega$P@@12 T@U) (GenericBasics.Mega$Q@@12 T@U) (GenericBasics.Mega$L@@12 T@U) ($o@@1 T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType $o@@1 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@12 GenericBasics.Mega$Q@@12 GenericBasics.Mega$L@@12) $h@@2)  (or (= $o@@1 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@1) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1836|
 :pattern ( ($IsAlloc refType $o@@1 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@12 GenericBasics.Mega$Q@@12 GenericBasics.Mega$L@@12) $h@@2))
)))
(assert (forall ((GenericBasics.Mega$P@@13 T@U) (GenericBasics.Mega$Q@@13 T@U) (GenericBasics.Mega$L@@13 T@U) ($o@@2 T@U) ) (!  (=> ($Is refType $o@@2 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@13 GenericBasics.Mega$Q@@13 GenericBasics.Mega$L@@13)) ($Is refType $o@@2 (Tclass.GenericBasics.Tr? GenericBasics.Mega$Q@@13 TInt)))
 :qid |unknown.0:0|
 :skolemid |1910|
 :pattern ( ($Is refType $o@@2 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@13 GenericBasics.Mega$Q@@13 GenericBasics.Mega$L@@13)))
)))
(assert (forall ((GenericBasics.Mega$P@@14 T@U) (GenericBasics.Mega$Q@@14 T@U) (GenericBasics.Mega$L@@14 T@U) (bx@@4 T@U) ) (!  (=> ($IsBox bx@@4 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@14 GenericBasics.Mega$Q@@14 GenericBasics.Mega$L@@14)) ($IsBox bx@@4 (Tclass.GenericBasics.Tr? GenericBasics.Mega$Q@@14 TInt)))
 :qid |unknown.0:0|
 :skolemid |1908|
 :pattern ( ($IsBox bx@@4 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@14 GenericBasics.Mega$Q@@14 GenericBasics.Mega$L@@14)))
)))
(assert (forall ((GenericBasics.Tr$A@@5 T@U) (GenericBasics.Tr$B@@5 T@U) ($o@@3 T@U) ($h@@3 T@U) ) (! (= ($IsAlloc refType $o@@3 (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@5 GenericBasics.Tr$B@@5) $h@@3)  (or (= $o@@3 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@3) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1704|
 :pattern ( ($IsAlloc refType $o@@3 (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@5 GenericBasics.Tr$B@@5) $h@@3))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((GenericBasics.Mega$P@@15 T@U) (GenericBasics.Mega$Q@@15 T@U) (GenericBasics.Mega$L@@15 T@U) (GenericBasics.Mega.Teen$S@@0 T@U) (this@@1 T@U) (|a#0@@3| T@U) ) (!  (=> (or (|GenericBasics.Mega.Teen#canCall| GenericBasics.Mega$P@@15 GenericBasics.Mega$Q@@15 GenericBasics.Mega$L@@15 GenericBasics.Mega.Teen$S@@0 this@@1 |a#0@@3|) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@15 GenericBasics.Mega$Q@@15 GenericBasics.Mega$L@@15))))) (= (GenericBasics.Tr.Teen GenericBasics.Mega$Q@@15 TInt GenericBasics.Mega.Teen$S@@0 this@@1 |a#0@@3|) ($Box intType (int_2_U (GenericBasics.Mega.Teen GenericBasics.Mega$P@@15 GenericBasics.Mega$Q@@15 GenericBasics.Mega$L@@15 GenericBasics.Mega.Teen$S@@0 this@@1 |a#0@@3|)))))
 :qid |unknown.0:0|
 :skolemid |1857|
 :pattern ( (GenericBasics.Tr.Teen GenericBasics.Mega$Q@@15 TInt GenericBasics.Mega.Teen$S@@0 this@@1 |a#0@@3|) ($Is refType this@@1 (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@15 GenericBasics.Mega$Q@@15 GenericBasics.Mega$L@@15)))
 :pattern ( (GenericBasics.Tr.Teen GenericBasics.Mega$Q@@15 TInt GenericBasics.Mega.Teen$S@@0 this@@1 |a#0@@3|) (GenericBasics.Mega.Teen GenericBasics.Mega$P@@15 GenericBasics.Mega$Q@@15 GenericBasics.Mega$L@@15 GenericBasics.Mega.Teen$S@@0 this@@1 |a#0@@3|))
))))
(assert (forall ((GenericBasics.Mega$P@@16 T@U) (GenericBasics.Mega$Q@@16 T@U) (GenericBasics.Mega$L@@16 T@U) (bx@@5 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsAllocBox bx@@5 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@16 GenericBasics.Mega$Q@@16 GenericBasics.Mega$L@@16) $h@@4) ($IsGoodHeap $h@@4)) ($IsAllocBox bx@@5 (Tclass.GenericBasics.Tr? GenericBasics.Mega$Q@@16 TInt) $h@@4))
 :qid |unknown.0:0|
 :skolemid |1909|
 :pattern ( ($IsAllocBox bx@@5 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@16 GenericBasics.Mega$Q@@16 GenericBasics.Mega$L@@16) $h@@4))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((GenericBasics.Tr$A@@6 T@U) (GenericBasics.Tr$B@@6 T@U) (GenericBasics.Tr.STeen$R@@1 T@U) (|a#0@@4| T@U) (|b#0@@1| T@U) ) (!  (=> (or (|GenericBasics.Tr.STeen#canCall| GenericBasics.Tr$A@@6 GenericBasics.Tr$B@@6 GenericBasics.Tr.STeen$R@@1 |a#0@@4| |b#0@@1|) (and (< 0 $FunctionContextHeight) (and ($Is DatatypeTypeType |a#0@@4| (Tclass._System.Tuple2 GenericBasics.Tr$A@@6 GenericBasics.Tr.STeen$R@@1)) ($IsBox |b#0@@1| GenericBasics.Tr$B@@6)))) ($IsBox (GenericBasics.Tr.STeen GenericBasics.Tr$A@@6 GenericBasics.Tr$B@@6 GenericBasics.Tr.STeen$R@@1 |a#0@@4| |b#0@@1|) GenericBasics.Tr$B@@6))
 :qid |unknown.0:0|
 :skolemid |1720|
 :pattern ( (GenericBasics.Tr.STeen GenericBasics.Tr$A@@6 GenericBasics.Tr$B@@6 GenericBasics.Tr.STeen$R@@1 |a#0@@4| |b#0@@1|))
))))
...
(assert (forall ((v@@15 T@U) (t0@@2 T@U) (h@@4 T@U) ) (! (= ($IsAlloc SetType v@@15 (TSet t0@@2) h@@4) (forall ((bx@@8 T@U) ) (!  (=> (|Set#IsMember| v@@15 bx@@8) ($IsAllocBox bx@@8 t0@@2 h@@4))
 :qid |DafnyPreludebpl.299:11|
 :skolemid |1199|
 :pattern ( (|Set#IsMember| v@@15 bx@@8))
)))
...
(assert (forall ((GenericBasics.Tr$A@@11 T@U) (GenericBasics.Tr$B@@11 T@U) ($o@@4 T@U) ) (! (= ($Is refType $o@@4 (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@11 GenericBasics.Tr$B@@11))  (or (= $o@@4 null) (implements$GenericBasics.Tr (dtype $o@@4) GenericBasics.Tr$A@@11 GenericBasics.Tr$B@@11)))
 :qid |unknown.0:0|
 :skolemid |1703|
 :pattern ( ($Is refType $o@@4 (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@11 GenericBasics.Tr$B@@11)))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((GenericBasics.Tr$A@@12 T@U) (GenericBasics.Tr$B@@12 T@U) (GenericBasics.Tr.STeen$R@@2 T@U) (|a#0@@5| T@U) (|b#0@@2| T@U) ) (!  (=> (or (|GenericBasics.Tr.STeen#canCall| GenericBasics.Tr$A@@12 GenericBasics.Tr$B@@12 GenericBasics.Tr.STeen$R@@2 (Lit DatatypeTypeType |a#0@@5|) |b#0@@2|) (and (< 0 $FunctionContextHeight) (and ($Is DatatypeTypeType |a#0@@5| (Tclass._System.Tuple2 GenericBasics.Tr$A@@12 GenericBasics.Tr.STeen$R@@2)) ($IsBox |b#0@@2| GenericBasics.Tr$B@@12)))) (= (GenericBasics.Tr.STeen GenericBasics.Tr$A@@12 GenericBasics.Tr$B@@12 GenericBasics.Tr.STeen$R@@2 (Lit DatatypeTypeType |a#0@@5|) |b#0@@2|) |b#0@@2|))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |1724|
 :pattern ( (GenericBasics.Tr.STeen GenericBasics.Tr$A@@12 GenericBasics.Tr$B@@12 GenericBasics.Tr.STeen$R@@2 (Lit DatatypeTypeType |a#0@@5|) |b#0@@2|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((GenericBasics.Mega$P@@17 T@U) (GenericBasics.Mega$Q@@17 T@U) (GenericBasics.Mega$L@@17 T@U) (GenericBasics.Mega.Teen$S@@1 T@U) (this@@2 T@U) (|a#0@@6| T@U) ) (!  (=> (or (|GenericBasics.Mega.Teen#canCall| GenericBasics.Mega$P@@17 GenericBasics.Mega$Q@@17 GenericBasics.Mega$L@@17 GenericBasics.Mega.Teen$S@@1 this@@2 |a#0@@6|) (and (< 0 $FunctionContextHeight) (and (and (or (not (= this@@2 null)) (not true)) ($Is refType this@@2 (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@17 GenericBasics.Mega$Q@@17 GenericBasics.Mega$L@@17))) ($Is DatatypeTypeType |a#0@@6| (Tclass._System.Tuple2 GenericBasics.Mega$Q@@17 GenericBasics.Mega.Teen$S@@1))))) (= (GenericBasics.Mega.Teen GenericBasics.Mega$P@@17 GenericBasics.Mega$Q@@17 GenericBasics.Mega$L@@17 GenericBasics.Mega.Teen$S@@1 this@@2 |a#0@@6|) (LitInt 12)))
 :qid |unknown.0:0|
 :skolemid |1854|
 :pattern ( (GenericBasics.Mega.Teen GenericBasics.Mega$P@@17 GenericBasics.Mega$Q@@17 GenericBasics.Mega$L@@17 GenericBasics.Mega.Teen$S@@1 this@@2 |a#0@@6|))
))))
(assert (forall ((GenericBasics.Tr$A@@13 T@U) (GenericBasics.Tr$B@@13 T@U) ($h@@5 T@U) ($o@@5 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@5) (and (or (not (= $o@@5 null)) (not true)) ($Is refType $o@@5 (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@13 GenericBasics.Tr$B@@13)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@5) alloc)))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@5) GenericBasics.Tr.xyz) GenericBasics.Tr$B@@13 $h@@5))
 :qid |unknown.0:0|
 :skolemid |1706|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@5) GenericBasics.Tr.xyz) (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@13 GenericBasics.Tr$B@@13))
)))
...
(assert (forall ((GenericBasics.Tr$A@@14 T@U) (GenericBasics.Tr$B@@14 T@U) (bx@@10 T@U) ) (!  (=> ($IsBox bx@@10 (Tclass.GenericBasics.Tr GenericBasics.Tr$A@@14 GenericBasics.Tr$B@@14)) (and (= ($Box refType ($Unbox refType bx@@10)) bx@@10) ($Is refType ($Unbox refType bx@@10) (Tclass.GenericBasics.Tr GenericBasics.Tr$A@@14 GenericBasics.Tr$B@@14))))
 :qid |unknown.0:0|
 :skolemid |1692|
 :pattern ( ($IsBox bx@@10 (Tclass.GenericBasics.Tr GenericBasics.Tr$A@@14 GenericBasics.Tr$B@@14)))
)))
(assert (forall ((GenericBasics.Tr$A@@15 T@U) (GenericBasics.Tr$B@@15 T@U) (bx@@11 T@U) ) (!  (=> ($IsBox bx@@11 (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@15 GenericBasics.Tr$B@@15)) (and (= ($Box refType ($Unbox refType bx@@11)) bx@@11) ($Is refType ($Unbox refType bx@@11) (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@15 GenericBasics.Tr$B@@15))))
 :qid |unknown.0:0|
 :skolemid |1700|
 :pattern ( ($IsBox bx@@11 (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@15 GenericBasics.Tr$B@@15)))
)))
...
(assert (forall ((GenericBasics.Mega$P@@18 T@U) (GenericBasics.Mega$Q@@18 T@U) (GenericBasics.Mega$L@@18 T@U) ($o@@6 T@U) ) (! (= ($Is refType $o@@6 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@18 GenericBasics.Mega$Q@@18 GenericBasics.Mega$L@@18))  (or (= $o@@6 null) (= (dtype $o@@6) (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@18 GenericBasics.Mega$Q@@18 GenericBasics.Mega$L@@18))))
 :qid |unknown.0:0|
 :skolemid |1835|
 :pattern ( ($Is refType $o@@6 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@18 GenericBasics.Mega$Q@@18 GenericBasics.Mega$L@@18)))
)))
(assert (forall ((GenericBasics.Mega$P@@19 T@U) (GenericBasics.Mega$Q@@19 T@U) (GenericBasics.Mega$L@@19 T@U) (|c#0@@2| T@U) ($h@@6 T@U) ) (! (= ($IsAlloc refType |c#0@@2| (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@19 GenericBasics.Mega$Q@@19 GenericBasics.Mega$L@@19) $h@@6) ($IsAlloc refType |c#0@@2| (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@19 GenericBasics.Mega$Q@@19 GenericBasics.Mega$L@@19) $h@@6))
 :qid |unknown.0:0|
 :skolemid |1903|
 :pattern ( ($IsAlloc refType |c#0@@2| (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@19 GenericBasics.Mega$Q@@19 GenericBasics.Mega$L@@19) $h@@6))
 :pattern ( ($IsAlloc refType |c#0@@2| (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@19 GenericBasics.Mega$Q@@19 GenericBasics.Mega$L@@19) $h@@6))
)))
...
(assert (forall ((GenericBasics.Mega$P@@20 T@U) (GenericBasics.Mega$Q@@20 T@U) (GenericBasics.Mega$L@@20 T@U) ($o@@7 T@U) ($heap T@U) ) (!  (=> ($IsAlloc refType $o@@7 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@20 GenericBasics.Mega$Q@@20 GenericBasics.Mega$L@@20) $heap) ($IsAlloc refType $o@@7 (Tclass.GenericBasics.Tr? GenericBasics.Mega$Q@@20 TInt) $heap))
 :qid |unknown.0:0|
 :skolemid |1911|
 :pattern ( ($IsAlloc refType $o@@7 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@20 GenericBasics.Mega$Q@@20 GenericBasics.Mega$L@@20) $heap))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((GenericBasics.Mega$P@@21 T@U) (GenericBasics.Mega$Q@@21 T@U) (GenericBasics.Mega$L@@21 T@U) (GenericBasics.Mega.Teen$S@@2 T@U) (this@@4 T@U) (|a#0@@8| T@U) ) (!  (=> (or (|GenericBasics.Mega.Teen#canCall| GenericBasics.Mega$P@@21 GenericBasics.Mega$Q@@21 GenericBasics.Mega$L@@21 GenericBasics.Mega.Teen$S@@2 this@@4 (Lit DatatypeTypeType |a#0@@8|)) (and (< 0 $FunctionContextHeight) (and (and (or (not (= this@@4 null)) (not true)) ($Is refType this@@4 (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@21 GenericBasics.Mega$Q@@21 GenericBasics.Mega$L@@21))) ($Is DatatypeTypeType |a#0@@8| (Tclass._System.Tuple2 GenericBasics.Mega$Q@@21 GenericBasics.Mega.Teen$S@@2))))) (= (GenericBasics.Mega.Teen GenericBasics.Mega$P@@21 GenericBasics.Mega$Q@@21 GenericBasics.Mega$L@@21 GenericBasics.Mega.Teen$S@@2 this@@4 (Lit DatatypeTypeType |a#0@@8|)) (LitInt 12)))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |1855|
 :pattern ( (GenericBasics.Mega.Teen GenericBasics.Mega$P@@21 GenericBasics.Mega$Q@@21 GenericBasics.Mega$L@@21 GenericBasics.Mega.Teen$S@@2 this@@4 (Lit DatatypeTypeType |a#0@@8|)))
))))
...
(declare-fun |call4formal@b#0@0@@1| () T@U)
...
(declare-fun |call4formal@b#0@0@@2| () T@U)
...
(declare-fun |call4formal@b#0@0@@3| () T@U)
(declare-fun $Heap@9 () T@U)
(declare-fun |call6formal@bb#0@0@@3| () T@U)
(declare-fun |$rhs##10@0| () T@U)
(declare-fun GenericBasics.Mega$P@@22 () T@U)
(declare-fun GenericBasics.Mega$Q@@22 () T@U)
(declare-fun GenericBasics.Mega$L@@22 () T@U)
(declare-fun |##a#0@0| () T@U)
(declare-fun |a#0@@10| () T@U)
(declare-fun |bb#0@0| () Int)
(declare-fun |##a#1@0| () T@U)
(declare-fun |bb#0@1| () Int)
(declare-fun |##a#2@0| () T@U)
(declare-fun |rr#0@0| () Int)
(declare-fun |##a#3@0| () T@U)
(declare-fun |bb#0@2| () Int)
(declare-fun |##a#4@0| () T@U)
(declare-fun |bb#0@3| () Int)
(declare-fun |defass#tt#0| () Bool)
(declare-fun |tt#0| () T@U)
(declare-fun |sq#0| () T@U)
(declare-fun |ss#0| () T@U)
(set-info :boogie-vc-id Impl$$GenericBasics.Mega.ReferToMembers)
...
))) (and ($HeapSucc $Heap@8 $Heap@9) (= |$rhs##10@0| ($Unbox SetType |call6formal@bb#0@0@@3|)))) (and (and ($IsAllocBox ($Box refType this@@5) (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@22 GenericBasics.Mega$Q@@22 GenericBasics.Mega$L@@22) $Heap@9) (= |##a#0@0| (|#_System._tuple#2._#Make2| |a#0@@10| ($Box bv7Type (Lit bv7Type (bv7_2_U #b1000110)))))) (and ($IsAlloc DatatypeTypeType |##a#0@0| (Tclass._System.Tuple2 GenericBasics.Mega$Q@@22 (TBitvector 7)) $Heap@9) (|GenericBasics.Mega.Teen#canCall| GenericBasics.Mega$P@@22 GenericBasics.Mega$Q@@22 GenericBasics.Mega$L@@22 (TBitvector 7) this@@5 (|#_System._tuple#2._#Make2| |a#0@@10| ($Box bv7Type (Lit bv7Type (bv7_2_U #b1000110)))))))) (and (and (and (|GenericBasics.Mega.Teen#canCall| GenericBasics.Mega$P@@22 GenericBasics.Mega$Q@@22 GenericBasics.Mega$L@@22 (TBitvector 7) this@@5 (|#_System._tuple#2._#Make2| |a#0@@10| ($Box bv7Type (Lit bv7Type (bv7_2_U #b1000110))))) (= |bb#0@0| (GenericBasics.Mega.Teen GenericBasics.Mega$P@@22 GenericBasics.Mega$Q@@22 GenericBasics.Mega$L@@22 (TBitvector 7) this@@5 (|#_System._tuple#2._#Make2| |a#0@@10| ($Box bv7Type (Lit bv7Type (bv7_2_U #b1000110))))))) (and ($IsAllocBox ($Box refType this@@5) (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@22 GenericBasics.Mega$Q@@22 GenericBasics.Mega$L@@22) $Heap@9) (= |##a#1@0| (|#_System._tuple#2._#Make2| |a#0@@10| ($Box bv7Type (Lit bv7Type (bv7_2_U #b1000110))))))) (and (and ($IsAlloc DatatypeTypeType |##a#1@0| (Tclass._System.Tuple2 GenericBasics.Mega$Q@@22 (TBitvector 7)) $Heap@9) (|GenericBasics.Mega.Teen#canCall| GenericBasics.Mega$P@@22 GenericBasics.Mega$Q@@22 GenericBasics.Mega$L@@22 (TBitvector 7) this@@5 (|#_System._tuple#2._#Make2| |a#0@@10| ($Box bv7Type (Lit bv7Type (bv7_2_U #b1000110)))))) (and (|GenericBasics.Mega.Teen#canCall| GenericBasics.Mega$P@@22 GenericBasics.Mega$Q@@22 GenericBasics.Mega$L@@22 (TBitvector 7) this@@5 (|#_System._tuple#2._#Make2| |a#0@@10| ($Box bv7Type (Lit bv7Type (bv7_2_U #b1000110))))) (= |bb#0@1| (GenericBasics.Mega.Teen GenericBasics.Mega$P@@22 GenericBasics.Mega$Q@@22 GenericBasics.Mega$L@@22 (TBitvector 7) this@@5 (|#_System._tuple#2._#Make2| |a#0@@10| ($Box bv7Type (Lit bv7Type (bv7_2_U #b1000110))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= this@@5 null)) (not true))) (=> (or (not (= this@@5 null)) (not true)) (=> ($IsAllocBox ($Box refType this@@5) (Tclass.GenericBasics.Tr? GenericBasics.Mega$Q@@22 TInt) $Heap@9) (=> (and (= |##a#2@0| (|#_System._tuple#2._#Make2| |a#0@@10| ($Box bv7Type (Lit bv7Type (bv7_2_U #b1000110))))) ($IsAlloc DatatypeTypeType |##a#2@0| (Tclass._System.Tuple2 GenericBasics.Mega$Q@@22 (TBitvector 7)) $Heap@9)) (=> (and (and (and (and (|GenericBasics.Tr.Teen#canCall| GenericBasics.Mega$Q@@22 TInt (TBitvector 7) this@@5 (|#_System._tuple#2._#Make2| |a#0@@10| ($Box bv7Type (Lit bv7Type (bv7_2_U #b1000110))))) (|GenericBasics.Tr.Teen#canCall| GenericBasics.Mega$Q@@22 TInt (TBitvector 7) this@@5 (|#_System._tuple#2._#Make2| |a#0@@10| ($Box bv7Type (Lit bv7Type (bv7_2_U #b1000110)))))) (and (= |rr#0@0| (U_2_int ($Unbox intType (GenericBasics.Tr.Teen GenericBasics.Mega$Q@@22 TInt (TBitvector 7) this@@5 (|#_System._tuple#2._#Make2| |a#0@@10| ($Box bv7Type (Lit bv7Type (bv7_2_U #b1000110)))))))) (= |##a#3@0| (|#_System._tuple#2._#Make2| |a#0@@10| ($Box bv7Type (Lit bv7Type (bv7_2_U #b1000110))))))) (and (and ($IsAlloc DatatypeTypeType |##a#3@0| (Tclass._System.Tuple2 GenericBasics.Mega$Q@@22 (TBitvector 7)) $Heap@9) ($IsAlloc intType (int_2_U |b#0@@4|) TInt $Heap@9)) (and (|GenericBasics.Tr.STeen#canCall| GenericBasics.Mega$Q@@22 TInt (TBitvector 7) (|#_System._tuple#2._#Make2| |a#0@@10| ($Box bv7Type (Lit bv7Type (bv7_2_U #b1000110)))) ($Box intType (int_2_U |b#0@@4|))) (|GenericBasics.Tr.STeen#canCall| GenericBasics.Mega$Q@@22 TInt (TBitvector 7) (|#_System._tuple#2._#Make2| |a#0@@10| ($Box bv7Type (Lit bv7Type (bv7_2_U #b1000110)))) ($Box intType (int_2_U |b#0@@4|)))))) (and (and (and (= |bb#0@2| (U_2_int ($Unbox intType (GenericBasics.Tr.STeen GenericBasics.Mega$Q@@22 TInt (TBitvector 7) (|#_System._tuple#2._#Make2| |a#0@@10| ($Box bv7Type (Lit bv7Type (bv7_2_U #b1000110)))) ($Box intType (int_2_U |b#0@@4|)))))) (= |##a#4@0| (|#_System._tuple#2._#Make2| |a#0@@10| ($Box bv7Type (Lit bv7Type (bv7_2_U #b1000110)))))) (and ($IsAlloc DatatypeTypeType |##a#4@0| (Tclass._System.Tuple2 GenericBasics.Mega$Q@@22 (TBitvector 7)) $Heap@9) ($IsAlloc intType (int_2_U |b#0@@4|) TInt $Heap@9))) (and (and (|GenericBasics.Tr.STeen#canCall| GenericBasics.Mega$Q@@22 TInt (TBitvector 7) (|#_System._tuple#2._#Make2| |a#0@@10| ($Box bv7Type (Lit bv7Type (bv7_2_U #b1000110)))) ($Box intType (int_2_U |b#0@@4|))) (|GenericBasics.Tr.STeen#canCall| GenericBasics.Mega$Q@@22 TInt (TBitvector 7) (|#_System._tuple#2._#Make2| |a#0@@10| ($Box bv7Type (Lit bv7Type (bv7_2_U #b1000110)))) ($Box intType (int_2_U |b#0@@4|)))) (and (= |bb#0@3| (U_2_int ($Unbox intType (GenericBasics.Tr.STeen GenericBasics.Mega$Q@@22 TInt (TBitvector 7) (|#_System._tuple#2._#Make2| |a#0@@10| ($Box bv7Type (Lit bv7Type (bv7_2_U #b1000110)))) ($Box intType (int_2_U |b#0@@4|)))))) (= (ControlFlow 0 2) (- 0 1)))))) true)))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (or (not (= this@@5 null)) (not true)) (and ($Is refType this@@5 (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@22 GenericBasics.Mega$Q@@22 GenericBasics.Mega$L@@22)) ($IsAlloc refType this@@5 (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@22 GenericBasics.Mega$Q@@22 GenericBasics.Mega$L@@22) $Heap@@1)))) (=> (and (and (and (and ($IsBox |a#0@@10| GenericBasics.Mega$Q@@22) ($IsAllocBox |a#0@@10| GenericBasics.Mega$Q@@22 $Heap@@1)) (and (=> |defass#tt#0| (and ($Is refType |tt#0| (Tclass.GenericBasics.Tr GenericBasics.Mega$Q@@22 TInt)) ($IsAlloc refType |tt#0| (Tclass.GenericBasics.Tr GenericBasics.Mega$Q@@22 TInt) $Heap@@1))) true)) (and (and ($Is SeqType |sq#0| (TSeq TInt)) ($IsAlloc SeqType |sq#0| (TSeq TInt) $Heap@@1)) true)) (and (and (and ($Is SetType |ss#0| (TSet TInt)) ($IsAlloc SetType |ss#0| (TSet TInt) $Heap@@1)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 10) 2)))) anon0_correct))))
