...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0| Int) ) (!  (=> (or (|OtherModule.Y.F#canCall| (LitInt |x#0|)) (< 0 $FunctionContextHeight)) (= (OtherModule.Y.F (LitInt |x#0|)) (LitInt (Div |x#0| (LitInt 2)))))
 :qid |TraitCompiledfy.96:23|
 :weight 3
 :skolemid |550|
 :pattern ( (OtherModule.Y.F (LitInt |x#0|)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@0| Int) ) (!  (=> (or (|OtherModule.Y.F#canCall| |x#0@@0|) (< 0 $FunctionContextHeight)) (= (OtherModule.Y.F |x#0@@0|) (Div |x#0@@0| (LitInt 2))))
 :qid |TraitCompiledfy.96:23|
 :skolemid |549|
 :pattern ( (OtherModule.Y.F |x#0@@0|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$OtherModule.Y.F)
