...
(declare-fun |p#0| () Int)
(set-info :boogie-vc-id OverrideCheck$$ChildIsRefTrait.ChildTrait.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (< (ChildIsRefTrait.Trait.yy this@@3) 100) (and (=> (= (ControlFlow 0 2) (- 0 6)) (< (ChildIsRefTrait.Trait.yy this@@3) 800)) (=> (< (ChildIsRefTrait.Trait.yy this@@3) 800) (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@11 T@U) ($f T@U) ) (! true
 :qid |NonReferenceTraitsVerifydfy.94:12|
 :skolemid |1071|
))) (=> (forall (($o@@12 T@U) ($f@@0 T@U) ) (! true
 :qid |NonReferenceTraitsVerifydfy.94:12|
 :skolemid |1071|
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@13 T@U) ($f@@1 T@U) ) (! true
 :qid |NonReferenceTraitsVerifydfy.94:12|
 :skolemid |1072|
))) (=> (forall (($o@@14 T@U) ($f@@2 T@U) ) (! true
 :qid |NonReferenceTraitsVerifydfy.94:12|
 :skolemid |1072|
