...
(assert (distinct TInt TagInt alloc Tagclass._System.array? Tagclass._System.array Tagclass._module.P1? Tagclass._module.P1 tytagFamily$array tytagFamily$P1)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((|c#0@@0| T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType |c#0@@0| Tclass._module.P1 $h@@0) ($IsAlloc refType |c#0@@0| Tclass._module.P1? $h@@0))
 :qid |unknown.0:0|
 :skolemid |489|
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass._module.P1 $h@@0))
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass._module.P1? $h@@0))
)))
...
(assert (forall (($o@@1 T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType $o@@1 Tclass._module.P1? $h@@2)  (or (= $o@@1 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@1) alloc)))))
 :qid |unknown.0:0|
 :skolemid |481|
 :pattern ( ($IsAlloc refType $o@@1 Tclass._module.P1? $h@@2))
)))
...
(assert (forall ((bx@@0 T@U) ) (!  (=> ($IsBox bx@@0 Tclass._module.P1?) (and (= ($Box refType ($Unbox refType bx@@0)) bx@@0) ($Is refType ($Unbox refType bx@@0) Tclass._module.P1?)))
 :qid |unknown.0:0|
 :skolemid |479|
 :pattern ( ($IsBox bx@@0 Tclass._module.P1?))
)))
...
(assert (forall ((|c#0@@2| T@U) ) (! (= ($Is refType |c#0@@2| Tclass._module.P1)  (and ($Is refType |c#0@@2| Tclass._module.P1?) (or (not (= |c#0@@2| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |488|
 :pattern ( ($Is refType |c#0@@2| Tclass._module.P1))
 :pattern ( ($Is refType |c#0@@2| Tclass._module.P1?))
)))
...
(assert (= (Tag Tclass._module.P1) Tagclass._module.P1))
(assert (= (TagFamily Tclass._module.P1) tytagFamily$P1))
(assert (forall (($o@@7 T@U) ) (! (= ($Is refType $o@@7 Tclass._module.P1?)  (or (= $o@@7 null) (implements$_module.P1 (dtype $o@@7))))
 :qid |unknown.0:0|
 :skolemid |480|
 :pattern ( ($Is refType $o@@7 Tclass._module.P1?))
)))
...
(set-info :boogie-vc-id Impl$$_module.P1.N0)
...
(let ((anon3_Then_correct  (=> (< 5 (_System.array.Length |a#0@0|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |a#0@0| null)) (not true))) (=> (or (not (= |a#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 (LitInt 5)) (< (LitInt 5) (_System.array.Length |a#0@0|)))) (=> (and (<= 0 (LitInt 5)) (< (LitInt 5) (_System.array.Length |a#0@0|))) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0@0| (IndexField (LitInt 5))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and ($Is refType |a#0@0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0@0| (Tclass._System.array TInt) $Heap)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (not (= |a#0@0| null)) (not true))) (=> (or (not (= |a#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.P1) ($IsAlloc refType this Tclass._module.P1 $Heap)))) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 8) 6))) anon0_correct))))
