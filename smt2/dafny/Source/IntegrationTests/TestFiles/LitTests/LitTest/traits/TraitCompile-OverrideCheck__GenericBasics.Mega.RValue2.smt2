...
(declare-fun GenericBasics.Mega.RValue2 (T@U T@U T@U T@U T@U T@U) Int)
(declare-fun BoxType () T@T)
(declare-fun |GenericBasics.Mega.RValue2#canCall| (T@U T@U T@U T@U T@U T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((GenericBasics.Mega$P@@10 T@U) (GenericBasics.Mega$Q@@10 T@U) (GenericBasics.Mega$L@@10 T@U) (GenericBasics.Mega.RValue2$XX T@U) (this T@U) (|x#0| T@U) ) (!  (=> (or (|GenericBasics.Mega.RValue2#canCall| GenericBasics.Mega$P@@10 GenericBasics.Mega$Q@@10 GenericBasics.Mega$L@@10 GenericBasics.Mega.RValue2$XX (Lit refType this) (Lit BoxType |x#0|)) (and (< 0 $FunctionContextHeight) (and (and (or (not (= this null)) (not true)) ($Is refType this (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@10 GenericBasics.Mega$Q@@10 GenericBasics.Mega$L@@10))) ($IsBox |x#0| GenericBasics.Mega.RValue2$XX)))) (= (GenericBasics.Mega.RValue2 GenericBasics.Mega$P@@10 GenericBasics.Mega$Q@@10 GenericBasics.Mega$L@@10 GenericBasics.Mega.RValue2$XX (Lit refType this) (Lit BoxType |x#0|)) (LitInt 5)))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |1874|
 :pattern ( (GenericBasics.Mega.RValue2 GenericBasics.Mega$P@@10 GenericBasics.Mega$Q@@10 GenericBasics.Mega$L@@10 GenericBasics.Mega.RValue2$XX (Lit refType this) (Lit BoxType |x#0|)))
))))
...
(assert (forall ((GenericBasics.Mega$P@@12 T@U) (GenericBasics.Mega$Q@@12 T@U) (GenericBasics.Mega$L@@12 T@U) ($o T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType $o (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@12 GenericBasics.Mega$Q@@12 GenericBasics.Mega$L@@12) $h@@0)  (or (= $o null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@0 $o) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1836|
 :pattern ( ($IsAlloc refType $o (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@12 GenericBasics.Mega$Q@@12 GenericBasics.Mega$L@@12) $h@@0))
)))
(assert (forall ((GenericBasics.Mega$P@@13 T@U) (GenericBasics.Mega$Q@@13 T@U) (GenericBasics.Mega$L@@13 T@U) ($o@@0 T@U) ) (!  (=> ($Is refType $o@@0 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@13 GenericBasics.Mega$Q@@13 GenericBasics.Mega$L@@13)) ($Is refType $o@@0 (Tclass.GenericBasics.Tr? GenericBasics.Mega$Q@@13 TInt)))
 :qid |unknown.0:0|
 :skolemid |1910|
 :pattern ( ($Is refType $o@@0 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@13 GenericBasics.Mega$Q@@13 GenericBasics.Mega$L@@13)))
)))
(assert (forall ((GenericBasics.Mega$P@@14 T@U) (GenericBasics.Mega$Q@@14 T@U) (GenericBasics.Mega$L@@14 T@U) (bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@14 GenericBasics.Mega$Q@@14 GenericBasics.Mega$L@@14)) ($IsBox bx@@1 (Tclass.GenericBasics.Tr? GenericBasics.Mega$Q@@14 TInt)))
 :qid |unknown.0:0|
 :skolemid |1908|
 :pattern ( ($IsBox bx@@1 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@14 GenericBasics.Mega$Q@@14 GenericBasics.Mega$L@@14)))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((GenericBasics.Mega$P@@15 T@U) (GenericBasics.Mega$Q@@15 T@U) (GenericBasics.Mega$L@@15 T@U) (GenericBasics.Mega.RValue2$XX@@0 T@U) (this@@0 T@U) (|x#0@@0| T@U) ) (!  (=> (or (|GenericBasics.Mega.RValue2#canCall| GenericBasics.Mega$P@@15 GenericBasics.Mega$Q@@15 GenericBasics.Mega$L@@15 GenericBasics.Mega.RValue2$XX@@0 this@@0 |x#0@@0|) (and (< 0 $FunctionContextHeight) (and (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@15 GenericBasics.Mega$Q@@15 GenericBasics.Mega$L@@15))) ($IsBox |x#0@@0| GenericBasics.Mega.RValue2$XX@@0)))) (= (GenericBasics.Mega.RValue2 GenericBasics.Mega$P@@15 GenericBasics.Mega$Q@@15 GenericBasics.Mega$L@@15 GenericBasics.Mega.RValue2$XX@@0 this@@0 |x#0@@0|) (LitInt 5)))
 :qid |unknown.0:0|
 :skolemid |1873|
 :pattern ( (GenericBasics.Mega.RValue2 GenericBasics.Mega$P@@15 GenericBasics.Mega$Q@@15 GenericBasics.Mega$L@@15 GenericBasics.Mega.RValue2$XX@@0 this@@0 |x#0@@0|))
))))
...
(assert (forall ((GenericBasics.Mega$P@@16 T@U) (GenericBasics.Mega$Q@@16 T@U) (GenericBasics.Mega$L@@16 T@U) ($o@@4 T@U) ) (! (= ($Is refType $o@@4 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@16 GenericBasics.Mega$Q@@16 GenericBasics.Mega$L@@16))  (or (= $o@@4 null) (= (dtype $o@@4) (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@16 GenericBasics.Mega$Q@@16 GenericBasics.Mega$L@@16))))
 :qid |unknown.0:0|
 :skolemid |1835|
 :pattern ( ($Is refType $o@@4 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@16 GenericBasics.Mega$Q@@16 GenericBasics.Mega$L@@16)))
)))
(assert (forall ((GenericBasics.Mega$P@@17 T@U) (GenericBasics.Mega$Q@@17 T@U) (GenericBasics.Mega$L@@17 T@U) (|c#0@@2| T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType |c#0@@2| (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@17 GenericBasics.Mega$Q@@17 GenericBasics.Mega$L@@17) $h@@2) ($IsAlloc refType |c#0@@2| (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@17 GenericBasics.Mega$Q@@17 GenericBasics.Mega$L@@17) $h@@2))
 :qid |unknown.0:0|
 :skolemid |1903|
 :pattern ( ($IsAlloc refType |c#0@@2| (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@17 GenericBasics.Mega$Q@@17 GenericBasics.Mega$L@@17) $h@@2))
 :pattern ( ($IsAlloc refType |c#0@@2| (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@17 GenericBasics.Mega$Q@@17 GenericBasics.Mega$L@@17) $h@@2))
)))
...
(assert (forall ((GenericBasics.Mega$P@@18 T@U) (GenericBasics.Mega$Q@@18 T@U) (GenericBasics.Mega$L@@18 T@U) ($o@@5 T@U) ($heap T@U) ) (!  (=> ($IsAlloc refType $o@@5 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@18 GenericBasics.Mega$Q@@18 GenericBasics.Mega$L@@18) $heap) ($IsAlloc refType $o@@5 (Tclass.GenericBasics.Tr? GenericBasics.Mega$Q@@18 TInt) $heap))
 :qid |unknown.0:0|
 :skolemid |1911|
 :pattern ( ($IsAlloc refType $o@@5 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@18 GenericBasics.Mega$Q@@18 GenericBasics.Mega$L@@18) $heap))
)))
...
(declare-fun GenericBasics.Mega$Q@@19 () T@U)
(declare-fun GenericBasics.Tr$B@@11 () T@U)
(declare-fun GenericBasics.Tr.RValue2$X () T@U)
(declare-fun GenericBasics.Mega.RValue2$XX@@1 () T@U)
(declare-fun Mega_$_ReadsFrame@0 () T@U)
(declare-fun $Heap () T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun this@@1 () T@U)
(declare-fun GenericBasics.Mega$P@@19 () T@U)
(declare-fun GenericBasics.Mega$L@@19 () T@U)
(declare-fun |x#0@@1| () T@U)
(set-info :boogie-vc-id OverrideCheck$$GenericBasics.Mega.RValue2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= GenericBasics.Tr$A@@11 GenericBasics.Mega$Q@@19) (=> (and (= GenericBasics.Tr$B@@11 TInt) (= GenericBasics.Tr.RValue2$X GenericBasics.Mega.RValue2$XX@@1)) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (and (= Mega_$_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (forall (($o@@6 T@U) ($f@@0 T@U) ) (! true
 :qid |TraitCompiledfy.287:14|
 :skolemid |1876|
))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@19 GenericBasics.Mega$Q@@19 GenericBasics.Mega$L@@19)) ($IsAlloc refType this@@1 (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@19 GenericBasics.Mega$Q@@19 GenericBasics.Mega$L@@19) $Heap))) ($IsBox |x#0@@1| GenericBasics.Mega.RValue2$XX@@1)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
