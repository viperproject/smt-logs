...
(set-info :boogie-vc-id CheckWellformed$$ChildIsNonRefTrait.Parent.F)
...
(let ((anon4_Then_correct  (=> (<= (LitInt 0) (ChildIsNonRefTrait.Parent.F this@@0 |umpa#0@@0|)) (=> (and ($IsAllocBox ($Box refType this@@0) Tclass.ChildIsNonRefTrait.Parent? $Heap) ($IsAlloc intType (int_2_U |umpa#0@@0|) TInt $Heap)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (< (ChildIsNonRefTrait.Parent.yy this@@0) 300)) (=> (< (ChildIsNonRefTrait.Parent.yy this@@0) 300) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (<= 0 |umpa#0@@0|) (= |umpa#0@@0| |umpa#0@@0|))) (=> (or (<= 0 |umpa#0@@0|) (= |umpa#0@@0| |umpa#0@@0|)) (=> (= (ControlFlow 0 2) (- 0 1)) (or (and (= this@@0 this@@0) (= |umpa#0@@0| |umpa#0@@0|)) (< |umpa#0@@0| |umpa#0@@0|)))))))))))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (< (ChildIsNonRefTrait.Parent.yy this@@0) 300)) (and (=> (= (ControlFlow 0 6) 2) anon4_Then_correct) (=> (= (ControlFlow 0 6) 5) anon4_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass.ChildIsNonRefTrait.Parent) ($IsAlloc refType this@@0 Tclass.ChildIsNonRefTrait.Parent $Heap))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct))))
