...
procedure {:verboseName "TestFields.Test (correctness)"} Impl$$TestFields.__default.Test() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestFields.Test (correctness)"} Impl$$TestFields.__default.Test() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var defass#c#0: bool;
  var c#0: ref
     where defass#c#0
       ==> $Is(c#0, Tclass.TestFields.C()) && $IsAlloc(c#0, Tclass.TestFields.C(), $Heap);
  var $nw: ref;
  var defass#j#0: bool;
  var j#0: ref
     where defass#j#0
       ==> $Is(j#0, Tclass.TestFields.J()) && $IsAlloc(j#0, Tclass.TestFields.J(), $Heap);
  var $rhs#0: int;
  var $rhs#1: int;

    // AddMethodImpl: Test, Impl$$TestFields.__default.Test
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(118,11)
    assume true;
    havoc $nw;
    assume $nw != null && $Is($nw, Tclass.TestFields.C?());
    ...
    c#0 := $nw;
    defass#c#0 := true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(119,14)
    assume true;
    assert {:id "id6"} defass#c#0;
    assume true;
    j#0 := c#0;
    defass#j#0 := true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(121,9)
    assert {:id "id8"} defass#c#0;
    assert {:id "id9"} c#0 != null;
    assume true;
    assert {:id "id10"} $_ModifiesFrame[c#0, TestFields.J.f];
    assume true;
    $rhs#0 := LitInt(15);
    $Heap := update($Heap, c#0, TestFields.J.f, $Box($rhs#0));
    assume $IsGoodHeap($Heap);
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(122,5)
    assert {:id "id13"} defass#j#0;
    assert {:id "id14"} {:subsumption 0} j#0 != null;
    assume true;
    assert {:id "id15"} $Unbox(read($Heap, j#0, TestFields.J.f)): int == LitInt(15);
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(123,5)
    assume true;
    assert {:id "id16"} defass#c#0;
    assert {:id "id17"} {:subsumption 0} c#0 != null;
    assume true;
    assume true;
    assert {:id "id18"} defass#j#0;
    assert {:id "id19"} {:subsumption 0} j#0 != null;
    assume true;
    assume true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(124,9)
    assert {:id "id20"} defass#j#0;
    assert {:id "id21"} j#0 != null;
    assume true;
    assert {:id "id22"} $_ModifiesFrame[j#0, TestFields.J.f];
    assume true;
    $rhs#1 := LitInt(18);
    $Heap := update($Heap, j#0, TestFields.J.f, $Box($rhs#1));
    assume $IsGoodHeap($Heap);
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(125,5)
    assert {:id "id25"} defass#c#0;
    assert {:id "id26"} {:subsumption 0} c#0 != null;
    assume true;
    assert {:id "id27"} $Unbox(read($Heap, c#0, TestFields.J.f)): int == LitInt(18);
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(126,5)
    assume true;
    assert {:id "id28"} defass#c#0;
    assert {:id "id29"} {:subsumption 0} c#0 != null;
    assume true;
    assume true;
    assert {:id "id30"} defass#j#0;
    assert {:id "id31"} {:subsumption 0} j#0 != null;
    assume true;
    assume true;
}
