...
(assert (distinct TInt TagInt alloc allocName Tagclass.GenericBasics.Mega Tagclass.GenericBasics.Tr Tagclass.GenericBasics.Tr? class.GenericBasics.Tr? Tagclass.GenericBasics.Mega? tytagFamily$Mega tytagFamily$Tr field$xyz)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((GenericBasics.Tr$A@@2 T@U) (GenericBasics.Tr$B@@2 T@U) ($h@@0 T@U) ($o@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@0) (and (or (not (= $o@@1 null)) (not true)) ($Is refType $o@@1 (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@2 GenericBasics.Tr$B@@2)))) ($IsBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@0 $o@@1) GenericBasics.Tr.xyz) GenericBasics.Tr$B@@2))
 :qid |unknown.0:0|
 :skolemid |1705|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@0 $o@@1) GenericBasics.Tr.xyz) (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@2 GenericBasics.Tr$B@@2))
)))
(assert (forall ((GenericBasics.Tr$A@@3 T@U) (GenericBasics.Tr$B@@3 T@U) (|c#0@@1| T@U) ($h@@1 T@U) ) (! (= ($IsAlloc refType |c#0@@1| (Tclass.GenericBasics.Tr GenericBasics.Tr$A@@3 GenericBasics.Tr$B@@3) $h@@1) ($IsAlloc refType |c#0@@1| (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@3 GenericBasics.Tr$B@@3) $h@@1))
 :qid |unknown.0:0|
 :skolemid |1757|
 :pattern ( ($IsAlloc refType |c#0@@1| (Tclass.GenericBasics.Tr GenericBasics.Tr$A@@3 GenericBasics.Tr$B@@3) $h@@1))
 :pattern ( ($IsAlloc refType |c#0@@1| (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@3 GenericBasics.Tr$B@@3) $h@@1))
)))
(assert (forall ((GenericBasics.Mega$P@@11 T@U) (GenericBasics.Mega$Q@@11 T@U) (GenericBasics.Mega$L@@11 T@U) ($o@@2 T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType $o@@2 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@11 GenericBasics.Mega$Q@@11 GenericBasics.Mega$L@@11) $h@@2)  (or (= $o@@2 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@2) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1836|
 :pattern ( ($IsAlloc refType $o@@2 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@11 GenericBasics.Mega$Q@@11 GenericBasics.Mega$L@@11) $h@@2))
)))
(assert (forall ((GenericBasics.Mega$P@@12 T@U) (GenericBasics.Mega$Q@@12 T@U) (GenericBasics.Mega$L@@12 T@U) ($o@@3 T@U) ) (!  (=> ($Is refType $o@@3 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@12 GenericBasics.Mega$Q@@12 GenericBasics.Mega$L@@12)) ($Is refType $o@@3 (Tclass.GenericBasics.Tr? GenericBasics.Mega$Q@@12 TInt)))
 :qid |unknown.0:0|
 :skolemid |1910|
 :pattern ( ($Is refType $o@@3 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@12 GenericBasics.Mega$Q@@12 GenericBasics.Mega$L@@12)))
)))
...
(assert (forall ((GenericBasics.Tr$A@@4 T@U) (GenericBasics.Tr$B@@4 T@U) ($o@@4 T@U) ($h@@3 T@U) ) (! (= ($IsAlloc refType $o@@4 (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@4 GenericBasics.Tr$B@@4) $h@@3)  (or (= $o@@4 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@4) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1704|
 :pattern ( ($IsAlloc refType $o@@4 (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@4 GenericBasics.Tr$B@@4) $h@@3))
)))
(assert (forall ((GenericBasics.Mega$P@@14 T@U) (GenericBasics.Mega$Q@@14 T@U) (GenericBasics.Mega$L@@14 T@U) (bx@@3 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsAllocBox bx@@3 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@14 GenericBasics.Mega$Q@@14 GenericBasics.Mega$L@@14) $h@@4) ($IsGoodHeap $h@@4)) ($IsAllocBox bx@@3 (Tclass.GenericBasics.Tr? GenericBasics.Mega$Q@@14 TInt) $h@@4))
 :qid |unknown.0:0|
 :skolemid |1909|
 :pattern ( ($IsAllocBox bx@@3 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@14 GenericBasics.Mega$Q@@14 GenericBasics.Mega$L@@14) $h@@4))
)))
...
(assert (forall ((GenericBasics.Tr$A@@9 T@U) (GenericBasics.Tr$B@@9 T@U) ($o@@5 T@U) ) (! (= ($Is refType $o@@5 (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@9 GenericBasics.Tr$B@@9))  (or (= $o@@5 null) (implements$GenericBasics.Tr (dtype $o@@5) GenericBasics.Tr$A@@9 GenericBasics.Tr$B@@9)))
 :qid |unknown.0:0|
 :skolemid |1703|
 :pattern ( ($Is refType $o@@5 (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@9 GenericBasics.Tr$B@@9)))
)))
...
(assert (forall ((GenericBasics.Tr$A@@10 T@U) (GenericBasics.Tr$B@@10 T@U) ($h@@5 T@U) ($o@@6 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@5) (and (or (not (= $o@@6 null)) (not true)) ($Is refType $o@@6 (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@10 GenericBasics.Tr$B@@10)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@6) alloc)))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@6) GenericBasics.Tr.xyz) GenericBasics.Tr$B@@10 $h@@5))
 :qid |unknown.0:0|
 :skolemid |1706|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@6) GenericBasics.Tr.xyz) (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@10 GenericBasics.Tr$B@@10))
)))
(assert (forall ((GenericBasics.Tr$A@@11 T@U) (GenericBasics.Tr$B@@11 T@U) (bx@@5 T@U) ) (!  (=> ($IsBox bx@@5 (Tclass.GenericBasics.Tr GenericBasics.Tr$A@@11 GenericBasics.Tr$B@@11)) (and (= ($Box refType ($Unbox refType bx@@5)) bx@@5) ($Is refType ($Unbox refType bx@@5) (Tclass.GenericBasics.Tr GenericBasics.Tr$A@@11 GenericBasics.Tr$B@@11))))
 :qid |unknown.0:0|
 :skolemid |1692|
 :pattern ( ($IsBox bx@@5 (Tclass.GenericBasics.Tr GenericBasics.Tr$A@@11 GenericBasics.Tr$B@@11)))
)))
(assert (forall ((GenericBasics.Tr$A@@12 T@U) (GenericBasics.Tr$B@@12 T@U) (bx@@6 T@U) ) (!  (=> ($IsBox bx@@6 (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@12 GenericBasics.Tr$B@@12)) (and (= ($Box refType ($Unbox refType bx@@6)) bx@@6) ($Is refType ($Unbox refType bx@@6) (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@12 GenericBasics.Tr$B@@12))))
 :qid |unknown.0:0|
 :skolemid |1700|
 :pattern ( ($IsBox bx@@6 (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@12 GenericBasics.Tr$B@@12)))
)))
...
(assert (forall ((GenericBasics.Mega$P@@15 T@U) (GenericBasics.Mega$Q@@15 T@U) (GenericBasics.Mega$L@@15 T@U) ($o@@8 T@U) ) (! (= ($Is refType $o@@8 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@15 GenericBasics.Mega$Q@@15 GenericBasics.Mega$L@@15))  (or (= $o@@8 null) (= (dtype $o@@8) (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@15 GenericBasics.Mega$Q@@15 GenericBasics.Mega$L@@15))))
 :qid |unknown.0:0|
 :skolemid |1835|
 :pattern ( ($Is refType $o@@8 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@15 GenericBasics.Mega$Q@@15 GenericBasics.Mega$L@@15)))
)))
(assert (forall ((GenericBasics.Mega$P@@16 T@U) (GenericBasics.Mega$Q@@16 T@U) (GenericBasics.Mega$L@@16 T@U) (|c#0@@2| T@U) ($h@@6 T@U) ) (! (= ($IsAlloc refType |c#0@@2| (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@16 GenericBasics.Mega$Q@@16 GenericBasics.Mega$L@@16) $h@@6) ($IsAlloc refType |c#0@@2| (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@16 GenericBasics.Mega$Q@@16 GenericBasics.Mega$L@@16) $h@@6))
 :qid |unknown.0:0|
 :skolemid |1903|
 :pattern ( ($IsAlloc refType |c#0@@2| (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@16 GenericBasics.Mega$Q@@16 GenericBasics.Mega$L@@16) $h@@6))
 :pattern ( ($IsAlloc refType |c#0@@2| (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@16 GenericBasics.Mega$Q@@16 GenericBasics.Mega$L@@16) $h@@6))
)))
...
(assert (forall ((GenericBasics.Mega$P@@17 T@U) (GenericBasics.Mega$Q@@17 T@U) (GenericBasics.Mega$L@@17 T@U) ($o@@9 T@U) ($heap T@U) ) (!  (=> ($IsAlloc refType $o@@9 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@17 GenericBasics.Mega$Q@@17 GenericBasics.Mega$L@@17) $heap) ($IsAlloc refType $o@@9 (Tclass.GenericBasics.Tr? GenericBasics.Mega$Q@@17 TInt) $heap))
 :qid |unknown.0:0|
 :skolemid |1911|
 :pattern ( ($IsAlloc refType $o@@9 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@17 GenericBasics.Mega$Q@@17 GenericBasics.Mega$L@@17) $heap))
)))
...
(set-info :boogie-vc-id Impl$$GenericBasics.Mega.__ctor)
