...
(declare-fun GenericBasics.Cl.RBValue$XX () T@U)
...
(set-info :boogie-vc-id OverrideCheck$$GenericBasics.Cl.RBValue)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= GenericBasics.Tr$A@@11 GenericBasics.Cl$Q@@13) (=> (and (= GenericBasics.Tr$B@@11 TInt) (= GenericBasics.Tr.RBValue$X GenericBasics.Cl.RBValue$XX)) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (and (= Cl_$_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (forall (($o@@6 T@U) ($f@@0 T@U) ) (! true
 :qid |TraitCompiledfy.231:14|
 :skolemid |1815|
))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@13)) ($IsAlloc refType this (Tclass.GenericBasics.Cl GenericBasics.Cl$Q@@13) $Heap))) ($IsBox |x#0| GenericBasics.Cl.RBValue$XX)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
