...
(declare-fun GenericBasics.Mega.RValue3 (T@U T@U T@U T@U T@U T@U) Int)
(declare-fun BoxType () T@T)
(declare-fun |GenericBasics.Mega.RValue3#canCall| (T@U T@U T@U T@U T@U T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((GenericBasics.Mega$P@@10 T@U) (GenericBasics.Mega$Q@@10 T@U) (GenericBasics.Mega$L@@10 T@U) (GenericBasics.Mega.RValue3$XX T@U) (this T@U) (|x#0| T@U) ) (!  (=> (or (|GenericBasics.Mega.RValue3#canCall| GenericBasics.Mega$P@@10 GenericBasics.Mega$Q@@10 GenericBasics.Mega$L@@10 GenericBasics.Mega.RValue3$XX (Lit refType this) (Lit BoxType |x#0|)) (and (< 0 $FunctionContextHeight) (and (and (or (not (= this null)) (not true)) ($Is refType this (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@10 GenericBasics.Mega$Q@@10 GenericBasics.Mega$L@@10))) ($IsBox |x#0| GenericBasics.Mega.RValue3$XX)))) (= (GenericBasics.Mega.RValue3 GenericBasics.Mega$P@@10 GenericBasics.Mega$Q@@10 GenericBasics.Mega$L@@10 GenericBasics.Mega.RValue3$XX (Lit refType this) (Lit BoxType |x#0|)) (LitInt 5)))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |1880|
 :pattern ( (GenericBasics.Mega.RValue3 GenericBasics.Mega$P@@10 GenericBasics.Mega$Q@@10 GenericBasics.Mega$L@@10 GenericBasics.Mega.RValue3$XX (Lit refType this) (Lit BoxType |x#0|)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((GenericBasics.Mega$P@@15 T@U) (GenericBasics.Mega$Q@@15 T@U) (GenericBasics.Mega$L@@15 T@U) (GenericBasics.Mega.RValue3$XX@@0 T@U) (this@@0 T@U) (|x#0@@0| T@U) ) (!  (=> (or (|GenericBasics.Mega.RValue3#canCall| GenericBasics.Mega$P@@15 GenericBasics.Mega$Q@@15 GenericBasics.Mega$L@@15 GenericBasics.Mega.RValue3$XX@@0 this@@0 |x#0@@0|) (and (< 0 $FunctionContextHeight) (and (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@15 GenericBasics.Mega$Q@@15 GenericBasics.Mega$L@@15))) ($IsBox |x#0@@0| GenericBasics.Mega.RValue3$XX@@0)))) (= (GenericBasics.Mega.RValue3 GenericBasics.Mega$P@@15 GenericBasics.Mega$Q@@15 GenericBasics.Mega$L@@15 GenericBasics.Mega.RValue3$XX@@0 this@@0 |x#0@@0|) (LitInt 5)))
 :qid |unknown.0:0|
 :skolemid |1879|
 :pattern ( (GenericBasics.Mega.RValue3 GenericBasics.Mega$P@@15 GenericBasics.Mega$Q@@15 GenericBasics.Mega$L@@15 GenericBasics.Mega.RValue3$XX@@0 this@@0 |x#0@@0|))
))))
...
(declare-fun GenericBasics.Mega.RValue3$XX@@1 () T@U)
...
(set-info :boogie-vc-id OverrideCheck$$GenericBasics.Mega.RValue3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= GenericBasics.Tr$A@@11 GenericBasics.Mega$Q@@19) (=> (and (= GenericBasics.Tr$B@@11 TInt) (= GenericBasics.Tr.RValue3$X GenericBasics.Mega.RValue3$XX@@1)) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (and (= Mega_$_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (forall (($o@@6 T@U) ($f@@0 T@U) ) (! true
 :qid |TraitCompiledfy.288:14|
 :skolemid |1882|
))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@19 GenericBasics.Mega$Q@@19 GenericBasics.Mega$L@@19)) ($IsAlloc refType this@@1 (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@19 GenericBasics.Mega$Q@@19 GenericBasics.Mega$L@@19) $Heap))) ($IsBox |x#0@@1| GenericBasics.Mega.RValue3$XX@@1)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
