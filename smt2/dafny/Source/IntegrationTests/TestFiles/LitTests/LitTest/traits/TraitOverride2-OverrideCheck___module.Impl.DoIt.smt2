...
(declare-fun |t#0| () T@U)
(set-info :boogie-vc-id OverrideCheck$$_module.Impl.DoIt)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (and (= _module.Spec$U@@15 _module.Impl$T@@17) (_module.Impl.Valid _module.Impl$T@@17 $Heap@@1 this@@2)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.Impl.Valid#canCall| _module.Impl$T@@17 $Heap@@1 this@@2) (or (_module.Impl.Valid _module.Impl$T@@17 $Heap@@1 this@@2) (|Set#IsMember| (_module.Spec.Repr _module.Impl$T@@17 this@@2) ($Box refType this@@2))))) (=> (=> (|_module.Impl.Valid#canCall| _module.Impl$T@@17 $Heap@@1 this@@2) (or (_module.Impl.Valid _module.Impl$T@@17 $Heap@@1 this@@2) (|Set#IsMember| (_module.Spec.Repr _module.Impl$T@@17 this@@2) ($Box refType this@@2)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Set#Subset| (_module.Spec.Repr _module.Impl$T@@17 this@@2) (_module.Spec.Repr _module.Impl$T@@17 this@@2))) (=> (|Set#Subset| (_module.Spec.Repr _module.Impl$T@@17 this@@2) (_module.Spec.Repr _module.Impl$T@@17 this@@2)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@14 T@U) ($f@@0 T@U) ) (! true
 :qid |TraitOverride2dfy.44:10|
 :skolemid |525|
))) (=> (forall (($o@@15 T@U) ($f@@1 T@U) ) (! true
 :qid |TraitOverride2dfy.44:10|
 :skolemid |525|
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@16 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@16 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@16) alloc)))) (|Set#IsMember| (_module.Spec.Repr _module.Impl$T@@17 this@@2) ($Box refType $o@@16))) (|Set#IsMember| (_module.Spec.Repr _module.Spec$U@@15 this@@2) ($Box refType $o@@16)))
 :qid |TraitOverride2dfy.44:10|
 :skolemid |526|
))) (=> (forall (($o@@17 T@U) ($f@@3 T@U) ) (!  (=> (and (and (or (not (= $o@@17 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@17) alloc)))) (|Set#IsMember| (_module.Spec.Repr _module.Impl$T@@17 this@@2) ($Box refType $o@@17))) (|Set#IsMember| (_module.Spec.Repr _module.Spec$U@@15 this@@2) ($Box refType $o@@17)))
 :qid |TraitOverride2dfy.44:10|
 :skolemid |526|
)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@18 T@U) ) (!  (=> (and (or (not (= $o@@18 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@18) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@18) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@18)) (|Set#IsMember| (_module.Spec.Repr _module.Impl$T@@17 this@@2) ($Box refType $o@@18))))
 :qid |TraitOverride2dfy.44:10|
 :skolemid |527|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@18))
)) ($HeapSucc $Heap@@1 $Heap@0))) (and (and (_module.Impl.Valid _module.Impl$T@@17 $Heap@0 this@@2) (= (ControlFlow 0 2) (- 0 1))) (|_module.Impl.Valid#canCall| _module.Impl$T@@17 $Heap@0 this@@2))) (or (_module.Impl.Valid _module.Impl$T@@17 $Heap@0 this@@2) (|Set#IsMember| (_module.Spec.Repr _module.Impl$T@@17 this@@2) ($Box refType this@@2)))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 (Tclass._module.Impl _module.Impl$T@@17)) ($IsAlloc refType this@@2 (Tclass._module.Impl _module.Impl$T@@17) $Heap@@1)))) (and (and ($IsBox |t#0| _module.Impl$T@@17) ($IsAllocBox |t#0| _module.Impl$T@@17 $Heap@@1)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 7) 2)))) anon0_correct)))
