...
procedure {:verboseName "ObjectEquality.Test (correctness)"} Impl$$ObjectEquality.__default.Test() returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ObjectEquality.Test (correctness)"} Impl$$ObjectEquality.__default.Test() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;

    // AddMethodImpl: Test, Impl$$ObjectEquality.__default.Test
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(745,26)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id912"} Call$$ObjectEquality.__default.TestReferenceEquality();
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(746,15)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id913"} Call$$ObjectEquality.__default.NotTheSame();
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(747,18)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id914"} Call$$ObjectEquality.__default.TestSequences();
    // TrCallStmt: After ProcessCallStmt
}



procedure {:verboseName "ObjectEquality.TestReferenceEquality (well-formedness)"} CheckWellFormed$$ObjectEquality.__default.TestReferenceEquality();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "ObjectEquality.TestReferenceEquality (call)"} Call$$ObjectEquality.__default.TestReferenceEquality();
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "ObjectEquality.TestReferenceEquality (correctness)"} Impl$$ObjectEquality.__default.TestReferenceEquality() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ObjectEquality.TestReferenceEquality (correctness)"} Impl$$ObjectEquality.__default.TestReferenceEquality() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var defass#c#0: bool;
  var c#0: ref
     where defass#c#0
       ==> $Is(c#0, Tclass.ObjectEquality.C())
         && $IsAlloc(c#0, Tclass.ObjectEquality.C(), $Heap);
  var $nw: ref;
  var defass#b#0: bool;
  var b#0: ref
     where defass#b#0
       ==> $Is(b#0, Tclass.ObjectEquality.B())
         && $IsAlloc(b#0, Tclass.ObjectEquality.B(), $Heap);
  var defass#a0#0: bool;
  var a0#0: ref
     where defass#a0#0
       ==> $Is(a0#0, Tclass.ObjectEquality.A())
         && $IsAlloc(a0#0, Tclass.ObjectEquality.A(), $Heap);
  var defass#a1#0: bool;
  var a1#0: ref
     where defass#a1#0
       ==> $Is(a1#0, Tclass.ObjectEquality.A())
         && $IsAlloc(a1#0, Tclass.ObjectEquality.A(), $Heap);
  var ##u#0: ref;
  var ##v#0: ref;
  var ##u#1: ref;
  var ##v#1: ref;
  ...
  var ##v#3: ref;
    ...
    // AddMethodImpl: TestReferenceEquality, Impl$$ObjectEquality.__default.TestReferenceEquality
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(758,14)
    assume true;
    havoc $nw;
    assume $nw != null && $Is($nw, Tclass.ObjectEquality.C?());
    ...
    c#0 := $nw;
    defass#c#0 := true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(759,14)
    assume true;
    assert {:id "id916"} defass#c#0;
    assume true;
    b#0 := c#0;
    defass#b#0 := true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(760,15)
    assume true;
    assert {:id "id918"} defass#c#0;
    assume true;
    a0#0 := c#0;
    defass#a0#0 := true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(761,15)
    assume true;
    assert {:id "id920"} defass#c#0;
    assume true;
    a1#0 := c#0;
    defass#a1#0 := true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(763,5)
    assert {:id "id922"} defass#a0#0;
    assert {:id "id923"} defass#a1#0;
    assume true;
    assume true;
    assert {:id "id924"} defass#a0#0;
    ##u#0 := a0#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##u#0, Tclass.ObjectEquality.A(), $Heap);
    assert {:id "id925"} defass#a1#0;
    ##v#0 := a1#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##v#0, Tclass.ObjectEquality.A(), $Heap);
    assume ObjectEquality.__default.Eq#canCall(Tclass.ObjectEquality.A(), $Box(a0#0), $Box(a1#0));
    assume ObjectEquality.__default.Eq#canCall(Tclass.ObjectEquality.A(), $Box(a0#0), $Box(a1#0));
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(764,5)
    assert {:id "id926"} defass#a0#0;
    assert {:id "id927"} defass#c#0;
    assume true;
    assume true;
    assert {:id "id928"} defass#a0#0;
    ##u#1 := a0#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##u#1, Tclass.ObjectEquality.A(), $Heap);
    assert {:id "id929"} defass#c#0;
    ##v#1 := c#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##v#1, Tclass.ObjectEquality.A(), $Heap);
    assume ObjectEquality.__default.Eq#canCall(Tclass.ObjectEquality.A(), $Box(a0#0), $Box(c#0));
    assume ObjectEquality.__default.Eq#canCall(Tclass.ObjectEquality.A(), $Box(a0#0), $Box(c#0));
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(765,5)
    assert {:id "id930"} defass#b#0;
    assert {:id "id931"} defass#c#0;
    assume true;
    assume true;
    assert {:id "id932"} defass#b#0;
    ##u#2 := b#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##u#2, Tclass.ObjectEquality.B(), $Heap);
    assert {:id "id933"} defass#c#0;
    ##v#2 := c#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##v#2, Tclass.ObjectEquality.B(), $Heap);
    assume ObjectEquality.__default.Eq#canCall(Tclass.ObjectEquality.B(), $Box(b#0), $Box(c#0));
    assume ObjectEquality.__default.Eq#canCall(Tclass.ObjectEquality.B(), $Box(b#0), $Box(c#0));
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(766,5)
    assert {:id "id934"} defass#b#0;
    assert {:id "id935"} defass#a0#0;
    assume true;
    assume true;
    assert {:id "id936"} defass#b#0;
    ##u#3 := b#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##u#3, Tclass.ObjectEquality.A(), $Heap);
    assert {:id "id937"} defass#a0#0;
    ##v#3 := a0#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##v#3, Tclass.ObjectEquality.A(), $Heap);
    assume ObjectEquality.__default.Eq#canCall(Tclass.ObjectEquality.A(), $Box(b#0), $Box(a0#0));
    assume ObjectEquality.__default.Eq#canCall(Tclass.ObjectEquality.A(), $Box(b#0), $Box(a0#0));
    assume true;
}
...
axiom {:id "id938"} 0 <= $FunctionContextHeight
   ==> (forall ObjectEquality._default.Eq$U: Ty, u#0: Box, v#0: Box :: 
...
axiom {:id "id939"} 0 <= $FunctionContextHeight
   ==> (forall ObjectEquality._default.Eq$U: Ty, u#0: Box, v#0: Box :: 
...
procedure {:verboseName "ObjectEquality.Eq (well-formedness)"} CheckWellformed$$ObjectEquality.__default.Eq(ObjectEquality._default.Eq$U: Ty, 
    u#0: Box where $IsBox(u#0, ObjectEquality._default.Eq$U), 
    v#0: Box where $IsBox(v#0, ObjectEquality._default.Eq$U));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "ObjectEquality.NotTheSame (well-formedness)"} CheckWellFormed$$ObjectEquality.__default.NotTheSame();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "ObjectEquality.NotTheSame (call)"} Call$$ObjectEquality.__default.NotTheSame();
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "ObjectEquality.NotTheSame (correctness)"} Impl$$ObjectEquality.__default.NotTheSame() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ObjectEquality.NotTheSame (correctness)"} Impl$$ObjectEquality.__default.NotTheSame() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var defass#c#0: bool;
  var c#0: ref
  ...
  var d#0: ref
     where defass#d#0
       ==> $Is(d#0, Tclass.ObjectEquality.D())
         && $IsAlloc(d#0, Tclass.ObjectEquality.D(), $Heap);
  var $rhs#0: ref;
  var $nw: ref;
  var $rhs#1: ref;
  var defass#oc#0: bool;
  var oc#0: ref
     where defass#oc#0
       ==> $Is(oc#0, Tclass._System.object())
         && $IsAlloc(oc#0, Tclass._System.object(), $Heap);
  var defass#od#0: bool;
  var od#0: ref
     where defass#od#0
       ==> $Is(od#0, Tclass._System.object())
         && $IsAlloc(od#0, Tclass._System.object(), $Heap);
  var $rhs#2: ref;
  var $rhs#3: ref;
  var ##u#0: ref;
  var ##v#0: ref;
  var ##u#1: ref;
  var ##v#1: ref;
  var defass#ac#0: bool;
  var ac#0: ref
     where defass#ac#0
       ==> $Is(ac#0, Tclass.ObjectEquality.A())
         && $IsAlloc(ac#0, Tclass.ObjectEquality.A(), $Heap);
  var defass#ad#0: bool;
  var ad#0: ref
     where defass#ad#0
       ==> $Is(ad#0, Tclass.ObjectEquality.A())
         && $IsAlloc(ad#0, Tclass.ObjectEquality.A(), $Heap);
  var $rhs#4: ref;
  var $rhs#5: ref;
  var ##u#2: ref;
  var ##v#2: ref;
  ...
  var ##v#3: ref;
    ...
    // AddMethodImpl: NotTheSame, Impl$$ObjectEquality.__default.NotTheSame
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(774,20)
    assume true;
    assume true;
    havoc $nw;
    assume $nw != null && $Is($nw, Tclass.ObjectEquality.C?());
    ...
    $rhs#0 := $nw;
    havoc $nw;
    assume $nw != null && $Is($nw, Tclass.ObjectEquality.D?());
    assume !$Unbox(read($Heap, $nw, alloc)): bool;
    $Heap := update($Heap, $nw, alloc, $Box(true));
    assume $IsGoodHeap($Heap);
    assume $IsHeapAnchor($Heap);
    ...
    d#0 := $rhs#1;
    defass#d#0 := true;
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(775,32)
    assume true;
    assume true;
    assert {:id "id945"} defass#c#0;
    assume true;
    $rhs#2 := c#0;
    assert {:id "id947"} defass#d#0;
    assume true;
    $rhs#3 := d#0;
    oc#0 := $rhs#2;
    defass#oc#0 := true;
    od#0 := $rhs#3;
    defass#od#0 := true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(777,5)
    assert {:id "id951"} defass#oc#0;
    assert {:id "id952"} defass#od#0;
    assume true;
    assume true;
    assert {:id "id953"} defass#oc#0;
    ##u#0 := oc#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##u#0, Tclass._System.object(), $Heap);
    assert {:id "id954"} defass#od#0;
    ##v#0 := od#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##v#0, Tclass._System.object(), $Heap);
    assume ObjectEquality.__default.Eq#canCall(Tclass._System.object(), $Box(oc#0), $Box(od#0));
    assume ObjectEquality.__default.Eq#canCall(Tclass._System.object(), $Box(oc#0), $Box(od#0));
    assume true;
    assert {:id "id955"} defass#c#0;
    ##u#1 := c#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##u#1, Tclass._System.object(), $Heap);
    assert {:id "id956"} defass#d#0;
    ##v#1 := d#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##v#1, Tclass._System.object(), $Heap);
    assume ObjectEquality.__default.Eq#canCall(Tclass._System.object(), $Box(c#0), $Box(d#0));
    assume ObjectEquality.__default.Eq#canCall(Tclass._System.object(), $Box(c#0), $Box(d#0));
    assume true;
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(779,22)
    assume true;
    assume true;
    assert {:id "id957"} defass#c#0;
    assume true;
    $rhs#4 := c#0;
    assert {:id "id959"} defass#d#0;
    assume true;
    $rhs#5 := d#0;
    ac#0 := $rhs#4;
    defass#ac#0 := true;
    ad#0 := $rhs#5;
    defass#ad#0 := true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(780,5)
    assert {:id "id963"} defass#ac#0;
    assert {:id "id964"} defass#ad#0;
    assume true;
    assume true;
    assert {:id "id965"} defass#ac#0;
    ##u#2 := ac#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##u#2, Tclass.ObjectEquality.A(), $Heap);
    assert {:id "id966"} defass#ad#0;
    ##v#2 := ad#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##v#2, Tclass.ObjectEquality.A(), $Heap);
    assume ObjectEquality.__default.Eq#canCall(Tclass.ObjectEquality.A(), $Box(ac#0), $Box(ad#0));
    assume ObjectEquality.__default.Eq#canCall(Tclass.ObjectEquality.A(), $Box(ac#0), $Box(ad#0));
    assume true;
    assert {:id "id967"} defass#ac#0;
    ##u#3 := ac#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##u#3, Tclass.ObjectEquality.A(), $Heap);
    assert {:id "id968"} defass#ad#0;
    ##v#3 := ad#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##v#3, Tclass.ObjectEquality.A(), $Heap);
    assume ObjectEquality.__default.Eq#canCall(Tclass.ObjectEquality.A(), $Box(ac#0), $Box(ad#0));
...
procedure {:verboseName "ObjectEquality.TestSequences (well-formedness)"} CheckWellFormed$$ObjectEquality.__default.TestSequences();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "ObjectEquality.TestSequences (call)"} Call$$ObjectEquality.__default.TestSequences();
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "ObjectEquality.TestSequences (correctness)"} Impl$$ObjectEquality.__default.TestSequences() returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
