...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (< (ChildIsClass.Trait.yy this@@3) 300) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< (ChildIsClass.Trait.yy this@@3) 200)) (=> (< (ChildIsClass.Trait.yy this@@3) 200) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= |umpa#0@@3| |umpa#0@@3|)) (=> (<= |umpa#0@@3| |umpa#0@@3|) (=> (= OverrideErrors_$_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@8 T@U) ($f@@0 T@U) ) true)) (=> (forall (($o@@9 T@U) ($f@@1 T@U) ) true) (=> (and (< (ChildIsClass.OverrideErrors.F this@@3 |umpa#0@@3|) (+ (ChildIsClass.Trait.yy this@@3) 100)) (= (ControlFlow 0 2) (- 0 1))) (< (ChildIsClass.OverrideErrors.F this@@3 |umpa#0@@3|) (+ (ChildIsClass.Trait.yy this@@3) 900)))))))))))))
