...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (< (ChildIsClass.OverrideErrors.F this@@3 |umpa#0@@3|) (+ (ChildIsClass.Trait.yy this@@3) 100)))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) ($Is intType (int_2_U (LitInt 2)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 2)) Tclass._System.nat) (=> (= (ChildIsClass.OverrideErrors.F this@@3 |umpa#0@@3|) (LitInt 2)) (=> (and ($Is intType (int_2_U (ChildIsClass.OverrideErrors.F this@@3 |umpa#0@@3|)) Tclass._System.nat) (= (ControlFlow 0 7) 6)) GeneratedUnifiedExit_correct))))))
(let ((anon5_Then_correct  (=> (<= (LitInt 0) (ChildIsClass.OverrideErrors.F this@@3 |umpa#0@@3|)) (=> (and ($IsAllocBox ($Box refType this@@3) Tclass.ChildIsClass.OverrideErrors? $Heap) ($IsAlloc intType (int_2_U |umpa#0@@3|) TInt $Heap)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (< (ChildIsClass.Trait.yy this@@3) 200)) (=> (< (ChildIsClass.Trait.yy this@@3) 200) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (<= 0 |umpa#0@@3|) (= |umpa#0@@3| |umpa#0@@3|))) (=> (or (<= 0 |umpa#0@@3|) (= |umpa#0@@3| |umpa#0@@3|)) (=> (= (ControlFlow 0 2) (- 0 1)) (or (and (= this@@3 this@@3) (= |umpa#0@@3| |umpa#0@@3|)) (< |umpa#0@@3| |umpa#0@@3|)))))))))))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (< (ChildIsClass.Trait.yy this@@3) 200)) (and (=> (= (ControlFlow 0 9) 2) anon5_Then_correct) (=> (= (ControlFlow 0 9) 7) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.ChildIsClass.OverrideErrors) ($IsAlloc refType this@@3 Tclass.ChildIsClass.OverrideErrors $Heap))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct))))
