...
procedure {:verboseName "NonCapturingFunctionCoercions.Identity (well-formedness)"} CheckWellFormed$$NonCapturingFunctionCoercions.__default.Identity(NonCapturingFunctionCoercions._default.Identity$X: Ty, 
    f#0: HandleType
       where $Is(f#0, 
          Tclass._System.___hTotalFunc1(NonCapturingFunctionCoercions._default.Identity$X, 
            NonCapturingFunctionCoercions._default.Identity$X))
         && $IsAlloc(f#0, 
          Tclass._System.___hTotalFunc1(NonCapturingFunctionCoercions._default.Identity$X, 
            NonCapturingFunctionCoercions._default.Identity$X), 
          $Heap))
...
procedure {:verboseName "NonCapturingFunctionCoercions.Identity (call)"} Call$$NonCapturingFunctionCoercions.__default.Identity(NonCapturingFunctionCoercions._default.Identity$X: Ty, 
    f#0: HandleType
       where $Is(f#0, 
          Tclass._System.___hTotalFunc1(NonCapturingFunctionCoercions._default.Identity$X, 
            NonCapturingFunctionCoercions._default.Identity$X))
...
procedure {:verboseName "NonCapturingFunctionCoercions.Identity (correctness)"} Impl$$NonCapturingFunctionCoercions.__default.Identity(NonCapturingFunctionCoercions._default.Identity$X: Ty, 
    f#0: HandleType
       where $Is(f#0, 
          Tclass._System.___hTotalFunc1(NonCapturingFunctionCoercions._default.Identity$X, 
            NonCapturingFunctionCoercions._default.Identity$X))
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NonCapturingFunctionCoercions.Identity (correctness)"} Impl$$NonCapturingFunctionCoercions.__default.Identity(NonCapturingFunctionCoercions._default.Identity$X: Ty, f#0: HandleType)
   returns (defass#g#0: bool, g#0: HandleType, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;

    // AddMethodImpl: Identity, Impl$$NonCapturingFunctionCoercions.__default.Identity
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(675,57)
    assume true;
    assume true;
    g#0 := f#0;
    defass#g#0 := true;
    assert {:id "id842"} defass#g#0;
}
...
procedure {:verboseName "NonCapturingFunctionCoercions.Test (correctness)"} Impl$$NonCapturingFunctionCoercions.__default.Test() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NonCapturingFunctionCoercions.Test (correctness)"} Impl$$NonCapturingFunctionCoercions.__default.Test() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var x#0: int;
  var f#0: HandleType
  ...
  var lambdaResult#1: int;
    ...
    // AddMethodImpl: Test, Impl$$NonCapturingFunctionCoercions.__default.Test
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(678,11)
    assume true;
    assume true;
    x#0 := LitInt(3);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(679,11)
    assume true;
    ...
    if (*)
    {
        ...
        if (true)
        {
            ...
            assume {:id "id844"} lambdaResult#0 == y#0 + x#0;
            assume true;
    ...
    f#0 := Lit(AtLayer((lambda $l#0#ly#0: LayerType :: 
          Handle1((lambda $l#0#heap#0: Heap, $l#0#y#0: Box :: $Box($Unbox($l#0#y#0): int + x#0)), 
        ...
        $LS($LZ)));
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(680,5)
    assume true;
    assume true;
    assume true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(681,7)
    assume true;
    assume true;
    x#0 := LitInt(100);
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(682,5)
    assume true;
    assume true;
    assume true;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(687,22)
    assume true;
    ...
    f##0 := f#0;
    call {:id "id847"} $rhs##0 := Call$$NonCapturingFunctionCoercions.__default.Identity(TInt, f##0);
    // TrCallStmt: After ProcessCallStmt
    g#0 := $rhs##0;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(688,5)
    assume true;
    assume true;
    assume true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(689,7)
    assume true;
    // Begin Comprehension WF check
    if (*)
    {
        ...
        if (true)
        {
            ...
            assume {:id "id849"} lambdaResult#1 == y#1 + x#0;
            assume true;
            // CheckWellformedWithResult: any expression
    ...
    f#0 := Lit(AtLayer((lambda $l#2#ly#0: LayerType :: 
          Handle1((lambda $l#2#heap#0: Heap, $l#2#y#0: Box :: $Box($Unbox($l#2#y#0): int + x#0)), 
        ...
        $LS($LZ)));
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/traits/TraitCompile.dfy(690,5)
    assume true;
    assume true;
    assume true;
}
