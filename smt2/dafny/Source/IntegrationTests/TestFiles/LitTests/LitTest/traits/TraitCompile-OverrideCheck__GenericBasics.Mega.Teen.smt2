...
(assert (distinct TInt TagInt alloc Tagclass._System.Tuple2 Tagclass.GenericBasics.Mega Tagclass.GenericBasics.Tr Tagclass.GenericBasics.Tr? Tagclass.GenericBasics.Mega? |tytagFamily$_tuple#2| tytagFamily$Mega tytagFamily$Tr)
)
...
(assert (forall ((GenericBasics.Mega$P@@7 T@U) (GenericBasics.Mega$Q@@7 T@U) (GenericBasics.Mega$L@@7 T@U) (|c#0| T@U) ) (! (= ($Is refType |c#0| (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@7 GenericBasics.Mega$Q@@7 GenericBasics.Mega$L@@7))  (and ($Is refType |c#0| (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@7 GenericBasics.Mega$Q@@7 GenericBasics.Mega$L@@7)) (or (not (= |c#0| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |1902|
 :pattern ( ($Is refType |c#0| (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@7 GenericBasics.Mega$Q@@7 GenericBasics.Mega$L@@7)))
 :pattern ( ($Is refType |c#0| (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@7 GenericBasics.Mega$Q@@7 GenericBasics.Mega$L@@7)))
)))
...
(assert (forall ((GenericBasics.Mega$P@@8 T@U) (GenericBasics.Mega$Q@@8 T@U) (GenericBasics.Mega$L@@8 T@U) ) (! (implements$GenericBasics.Tr (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@8 GenericBasics.Mega$Q@@8 GenericBasics.Mega$L@@8) GenericBasics.Mega$Q@@8 TInt)
 :qid |unknown.0:0|
 :skolemid |1837|
)))
...
(assert (forall ((GenericBasics.Mega$P@@9 T@U) (GenericBasics.Mega$Q@@9 T@U) (GenericBasics.Mega$L@@9 T@U) ($o T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType $o (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@9 GenericBasics.Mega$Q@@9 GenericBasics.Mega$L@@9) $h@@0)  (or (= $o null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@0 $o) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1836|
 :pattern ( ($IsAlloc refType $o (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@9 GenericBasics.Mega$Q@@9 GenericBasics.Mega$L@@9) $h@@0))
)))
(assert (forall ((GenericBasics.Mega$P@@10 T@U) (GenericBasics.Mega$Q@@10 T@U) (GenericBasics.Mega$L@@10 T@U) ($o@@0 T@U) ) (!  (=> ($Is refType $o@@0 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@10 GenericBasics.Mega$Q@@10 GenericBasics.Mega$L@@10)) ($Is refType $o@@0 (Tclass.GenericBasics.Tr? GenericBasics.Mega$Q@@10 TInt)))
 :qid |unknown.0:0|
 :skolemid |1910|
 :pattern ( ($Is refType $o@@0 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@10 GenericBasics.Mega$Q@@10 GenericBasics.Mega$L@@10)))
)))
...
(assert (forall ((GenericBasics.Mega$P@@11 T@U) (GenericBasics.Mega$Q@@11 T@U) (GenericBasics.Mega$L@@11 T@U) ($o@@4 T@U) ) (! (= ($Is refType $o@@4 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@11 GenericBasics.Mega$Q@@11 GenericBasics.Mega$L@@11))  (or (= $o@@4 null) (= (dtype $o@@4) (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@11 GenericBasics.Mega$Q@@11 GenericBasics.Mega$L@@11))))
 :qid |unknown.0:0|
 :skolemid |1835|
 :pattern ( ($Is refType $o@@4 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@11 GenericBasics.Mega$Q@@11 GenericBasics.Mega$L@@11)))
)))
(assert (forall ((GenericBasics.Mega$P@@12 T@U) (GenericBasics.Mega$Q@@12 T@U) (GenericBasics.Mega$L@@12 T@U) (|c#0@@2| T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType |c#0@@2| (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@12 GenericBasics.Mega$Q@@12 GenericBasics.Mega$L@@12) $h@@2) ($IsAlloc refType |c#0@@2| (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@12 GenericBasics.Mega$Q@@12 GenericBasics.Mega$L@@12) $h@@2))
 :qid |unknown.0:0|
 :skolemid |1903|
 :pattern ( ($IsAlloc refType |c#0@@2| (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@12 GenericBasics.Mega$Q@@12 GenericBasics.Mega$L@@12) $h@@2))
 :pattern ( ($IsAlloc refType |c#0@@2| (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@12 GenericBasics.Mega$Q@@12 GenericBasics.Mega$L@@12) $h@@2))
)))
...
(assert (forall ((GenericBasics.Tr$A@@7 T@U) (GenericBasics.Tr$B@@7 T@U) ) (!  (and (= (Tag (Tclass.GenericBasics.Tr GenericBasics.Tr$A@@7 GenericBasics.Tr$B@@7)) Tagclass.GenericBasics.Tr) (= (TagFamily (Tclass.GenericBasics.Tr GenericBasics.Tr$A@@7 GenericBasics.Tr$B@@7)) tytagFamily$Tr))
 :qid |unknown.0:0|
 :skolemid |1689|
 :pattern ( (Tclass.GenericBasics.Tr GenericBasics.Tr$A@@7 GenericBasics.Tr$B@@7))
)))
(assert (forall ((GenericBasics.Tr$A@@8 T@U) (GenericBasics.Tr$B@@8 T@U) ) (!  (and (= (Tag (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@8 GenericBasics.Tr$B@@8)) Tagclass.GenericBasics.Tr?) (= (TagFamily (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@8 GenericBasics.Tr$B@@8)) tytagFamily$Tr))
 :qid |unknown.0:0|
 :skolemid |1697|
 :pattern ( (Tclass.GenericBasics.Tr? GenericBasics.Tr$A@@8 GenericBasics.Tr$B@@8))
)))
(assert (forall ((GenericBasics.Mega$P@@13 T@U) (GenericBasics.Mega$Q@@13 T@U) (GenericBasics.Mega$L@@13 T@U) ($o@@5 T@U) ($heap T@U) ) (!  (=> ($IsAlloc refType $o@@5 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@13 GenericBasics.Mega$Q@@13 GenericBasics.Mega$L@@13) $heap) ($IsAlloc refType $o@@5 (Tclass.GenericBasics.Tr? GenericBasics.Mega$Q@@13 TInt) $heap))
 :qid |unknown.0:0|
 :skolemid |1911|
 :pattern ( ($IsAlloc refType $o@@5 (Tclass.GenericBasics.Mega? GenericBasics.Mega$P@@13 GenericBasics.Mega$Q@@13 GenericBasics.Mega$L@@13) $heap))
)))
...
(declare-fun GenericBasics.Tr$A@@9 () T@U)
(declare-fun GenericBasics.Mega$Q@@14 () T@U)
(declare-fun GenericBasics.Tr$B@@9 () T@U)
(declare-fun GenericBasics.Tr.Teen$R () T@U)
(declare-fun GenericBasics.Mega.Teen$S () T@U)
...
(declare-fun GenericBasics.Mega$P@@14 () T@U)
(declare-fun GenericBasics.Mega$L@@14 () T@U)
(declare-fun DatatypeTypeType () T@T)
(declare-fun $FunctionContextHeight () Int)
(assert (= (Ctor DatatypeTypeType) 7))
(set-info :boogie-vc-id OverrideCheck$$GenericBasics.Mega.Teen)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= GenericBasics.Tr$A@@9 GenericBasics.Mega$Q@@14) (=> (and (= GenericBasics.Tr$B@@9 TInt) (= GenericBasics.Tr.Teen$R GenericBasics.Mega.Teen$S)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (DtRank |a#0|) (DtRank |a#0|))) (=> (<= (DtRank |a#0|) (DtRank |a#0|)) (=> (and (= Mega_$_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (forall (($o@@6 T@U) ($f@@0 T@U) ) (! true
 :qid |TraitCompiledfy.283:14|
 :skolemid |1858|
)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@14 GenericBasics.Mega$Q@@14 GenericBasics.Mega$L@@14)) ($IsAlloc refType this (Tclass.GenericBasics.Mega GenericBasics.Mega$P@@14 GenericBasics.Mega$Q@@14 GenericBasics.Mega$L@@14) $Heap))) ($Is DatatypeTypeType |a#0| (Tclass._System.Tuple2 GenericBasics.Mega$Q@@14 GenericBasics.Mega.Teen$S))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
