...
(declare-fun |p#0| () Int)
(set-info :boogie-vc-id CheckWellFormed$$ChildIsNonRefTrait.Child.M)
...
(assert (not
 ...
 :qid |NonReferenceTraitsVerifydfy.24:12|
 :skolemid |506|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@8))
))) (and ($HeapSucc $Heap $Heap@0) (<= (LitInt 0) |p#0@0|))) (and (and ($IsAllocBox ($Box refType this@@3) Tclass.ChildIsNonRefTrait.Child? $Heap@0) (= |##umpa#0@0| (LitInt 5))) (and ($IsAlloc intType (int_2_U |##umpa#0@0|) TInt $Heap@0) (= (ControlFlow 0 2) (- 0 1))))) (< (ChildIsNonRefTrait.Parent.yy this@@3) 800)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.ChildIsNonRefTrait.Child) ($IsAlloc refType this@@3 Tclass.ChildIsNonRefTrait.Child $Heap))) (<= (LitInt 0) |p#0|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
