...
(assert (forall (($o@@4 T@U) ) (!  (=> ($Is refType $o@@4 Tclass.ChildIsRefTrait.OverrideErrors?) ($Is refType $o@@4 Tclass.ChildIsRefTrait.Trait?))
 :qid |unknown.0:0|
 :skolemid |1130|
 :pattern ( ($Is refType $o@@4 Tclass.ChildIsRefTrait.OverrideErrors?))
)))
...
(assert (forall (($o@@6 T@U) ) (! (= ($Is refType $o@@6 Tclass.ChildIsRefTrait.OverrideErrors?)  (or (= $o@@6 null) (implements$ChildIsRefTrait.OverrideErrors (dtype $o@@6))))
 :qid |unknown.0:0|
 :skolemid |1098|
 :pattern ( ($Is refType $o@@6 Tclass.ChildIsRefTrait.OverrideErrors?))
)))
...
(declare-fun |p#0| () Int)
(set-info :boogie-vc-id OverrideCheck$$ChildIsRefTrait.OverrideErrors.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (< (ChildIsRefTrait.Trait.yy this@@3) 100) (and (=> (= (ControlFlow 0 2) (- 0 6)) (< (ChildIsRefTrait.Trait.yy this@@3) 150)) (=> (< (ChildIsRefTrait.Trait.yy this@@3) 150) (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@7 T@U) ($f T@U) ) (! true
 :qid |NonReferenceTraitsVerifydfy.126:12|
 :skolemid |1109|
...
)) ($HeapSucc $Heap $Heap@0)) (and (< |p#0| (+ (+ (ChildIsRefTrait.Trait.yy this@@3) (ChildIsRefTrait.OverrideErrors.F this@@3 (LitInt 5))) 1200)) (= (ControlFlow 0 2) (- 0 1)))) (< |p#0| (+ (+ (ChildIsRefTrait.Trait.yy this@@3) (ChildIsRefTrait.OverrideErrors.F this@@3 (LitInt 5))) 900))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.ChildIsRefTrait.OverrideErrors) ($IsAlloc refType this@@3 Tclass.ChildIsRefTrait.OverrideErrors $Heap))) (<= (LitInt 0) |p#0|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 7) 2))) anon0_correct))))
