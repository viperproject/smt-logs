...
(declare-fun Child_$_ReadsFrame@0 () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (< (ChildIsNonRefTrait.Parent.yy this@@3) 300) (and (=> (= (ControlFlow 0 2) (- 0 5)) (< (ChildIsNonRefTrait.Parent.yy this@@3) 800)) (=> (< (ChildIsNonRefTrait.Parent.yy this@@3) 800) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= |umpa#0@@3| |umpa#0@@3|)) (=> (<= |umpa#0@@3| |umpa#0@@3|) (=> (= Child_$_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@8 T@U) ($f@@0 T@U) ) true)) (=> (forall (($o@@9 T@U) ($f@@1 T@U) ) true) (=> (and (< (ChildIsNonRefTrait.Child.F this@@3 |umpa#0@@3|) (+ (ChildIsNonRefTrait.Parent.yy this@@3) 100)) (= (ControlFlow 0 2) (- 0 1))) (< (ChildIsNonRefTrait.Child.F this@@3 |umpa#0@@3|) (+ (ChildIsNonRefTrait.Parent.yy this@@3) 900)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.ChildIsNonRefTrait.Child) ($IsAlloc refType this@@3 Tclass.ChildIsNonRefTrait.Child $Heap))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 2))) anon0_correct))))
