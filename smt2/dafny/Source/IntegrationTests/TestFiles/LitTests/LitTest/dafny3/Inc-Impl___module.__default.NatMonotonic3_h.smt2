...
(declare-fun |_k##2@0| () Int)
(declare-fun $Heap@2 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $Heap () T@U)
(declare-fun |_k##3@0| () Int)
...
(set-info :boogie-vc-id Impl$$_module.__default.NatMonotonic3_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 50) (let ((anon20_Else_correct true))
...
(let ((anon21_Else_correct  (=> (and (not (_module.__default.NatBigStep_h ($LS $LZ) (- |_k#0@@4| 1) |c0#6@0| |s#1| |s'#15@0|)) (= (ControlFlow 0 43) 29)) anon6_correct)))
...
(let ((anon25_Else_correct  (=> (and (not (_module.__default.NatBigStep_h ($LS $LZ) (- |_k#0@@4| 1) |body#6@0| |s#1| |s'#13@0|)) (= (ControlFlow 0 22) 8)) anon13_correct)))
(let ((anon25_Then_correct  (=> (_module.__default.NatBigStep_h ($LS $LZ) (- |_k#0@@4| 1) |body#6@0| |s#1| |s'#13@0|) (and (=> (= (ControlFlow 0 20) (- 0 21)) ($Is intType (int_2_U (- |_k#0@@4| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |_k#0@@4| 1)) Tclass._System.nat) (=> (= |##_k#1@0| (- |_k#0@@4| 1)) (=> (and ($IsAlloc intType (int_2_U |##_k#1@0|) Tclass._System.nat $Heap) ($IsAlloc DatatypeTypeType |c#1| Tclass._module.cmd $Heap)) (=> (and (and ($IsAlloc intType (int_2_U |s'#13@0|) TInt $Heap) ($IsAlloc intType (int_2_U |t#1|) TInt $Heap)) (and (|_module.__default.NatBigStep_h#canCall| (- |_k#0@@4| 1) |c#1| |s'#13@0| |t#1|) (= (ControlFlow 0 20) 8))) anon13_correct))))))))
(let ((anon24_Then_correct  (and (=> (= (ControlFlow 0 23) (- 0 24)) ($Is intType (int_2_U (- |_k#0@@4| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |_k#0@@4| 1)) Tclass._System.nat) (=> (and (= |##_k#0@0| (- |_k#0@@4| 1)) ($IsAlloc intType (int_2_U |##_k#0@0|) Tclass._System.nat $Heap)) (=> (and (and ($IsAlloc DatatypeTypeType |body#6@0| Tclass._module.cmd $Heap) ($IsAlloc intType (int_2_U |s#1|) TInt $Heap)) (and ($IsAlloc intType (int_2_U |s'#13@0|) TInt $Heap) (|_module.__default.NatBigStep_h#canCall| (- |_k#0@@4| 1) |body#6@0| |s#1| |s'#13@0|))) (and (=> (= (ControlFlow 0 23) 20) anon25_Then_correct) (=> (= (ControlFlow 0 23) 22) anon25_Else_correct))))))))
(let ((anon23_Else_correct  (=> (or (not (= |s#1| |t#1|)) (not true)) (and (=> (= (ControlFlow 0 25) 23) anon24_Then_correct) (=> (= (ControlFlow 0 25) 7) anon24_Else_correct)))))
(let ((anon23_Then_correct  (=> (and (= |s#1| |t#1|) (= (ControlFlow 0 6) 2)) GeneratedUnifiedExit_correct)))
(let ((anon22_Then_correct  (=> (= |c#1| (|#_module.cmd.Repeat| |_mcc#2#0@0|)) (=> (and ($Is DatatypeTypeType |_mcc#2#0@0| Tclass._module.cmd) ($IsAlloc DatatypeTypeType |_mcc#2#0@0| Tclass._module.cmd $Heap)) (=> (and (and (and ($Is DatatypeTypeType |body#6@0| Tclass._module.cmd) ($IsAlloc DatatypeTypeType |body#6@0| Tclass._module.cmd $Heap)) (= |let#0_0_0#0#0| |_mcc#2#0@0|)) (and ($Is DatatypeTypeType |let#0_0_0#0#0| Tclass._module.cmd) (= |body#6@0| |let#0_0_0#0#0|))) (and (=> (= (ControlFlow 0 26) 6) anon23_Then_correct) (=> (= (ControlFlow 0 26) 25) anon23_Else_correct)))))))
(let ((anon19_Else_correct  (=> (or (not (= |c#1| (|#_module.cmd.Seq| |_mcc#0#0@0| |_mcc#1#0@0|))) (not true)) (and (=> (= (ControlFlow 0 27) 26) anon22_Then_correct) (=> (= (ControlFlow 0 27) 5) anon22_Else_correct)))))
(let ((anon18_Else_correct  (=> (or (not (= |c#1| |#_module.cmd.Inc|)) (not true)) (and (=> (= (ControlFlow 0 47) 46) anon19_Then_correct) (=> (= (ControlFlow 0 47) 27) anon19_Else_correct)))))
(let ((anon18_Then_correct  (=> (and (= |c#1| |#_module.cmd.Inc|) (= (ControlFlow 0 4) 2)) GeneratedUnifiedExit_correct)))
(let ((anon17_Then_correct  (=> (< 0 |_k#0@@4|) (and (=> (= (ControlFlow 0 48) 4) anon18_Then_correct) (=> (= (ControlFlow 0 48) 47) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (<= |_k#0@@4| 0) (= (ControlFlow 0 3) 2)) GeneratedUnifiedExit_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 49) 48) anon17_Then_correct) (=> (= (ControlFlow 0 49) 3) anon17_Else_correct)))))
