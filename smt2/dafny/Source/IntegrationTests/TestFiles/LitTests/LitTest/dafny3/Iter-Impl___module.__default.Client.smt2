...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@30 T@U) ($f@@1 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@30 $f@@1))  (=> (and (or (not (= $o@@30 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@30) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |608|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@30 $f@@1))
)))
...
(assert (forall ((_module.M$T@@17 T@U) ($h@@24 T@U) ($o@@31 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@24) (and (or (not (= $o@@31 null)) (not true)) (= (dtype $o@@31) (Tclass._module.M? _module.M$T@@17)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@24 $o@@31) alloc)))) ($IsAlloc refType (_module.M.l $o@@31) (Tclass._module.List _module.M$T@@17) $h@@24))
 :qid |unknown.0:0|
 :skolemid |573|
 :pattern ( (_module.M.l $o@@31) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@24 $o@@31) alloc)) (Tclass._module.M? _module.M$T@@17))
)))
(assert (forall ((_module.M$T@@18 T@U) ($h@@25 T@U) ($o@@32 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@25) (and (or (not (= $o@@32 null)) (not true)) (= (dtype $o@@32) (Tclass._module.M? _module.M$T@@18)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@25 $o@@32) alloc)))) ($IsAlloc refType (_module.M.__decreases0 $o@@32) (Tclass._module.List? _module.M$T@@18) $h@@25))
 :qid |unknown.0:0|
 :skolemid |587|
 :pattern ( (_module.M.__decreases0 $o@@32) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@25 $o@@32) alloc)) (Tclass._module.M? _module.M$T@@18))
)))
...
(assert (forall ((_module.List$T@@15 T@U) ($h@@26 T@U) ($o@@33 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (or (not (= $o@@33 null)) (not true)) (= (dtype $o@@33) (Tclass._module.List? _module.List$T@@15)))) ($Is SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@26 $o@@33) _module.List.Contents)) (TSeq _module.List$T@@15)))
 :qid |unknown.0:0|
 :skolemid |528|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@26 $o@@33) _module.List.Contents)) (Tclass._module.List? _module.List$T@@15))
)))
(assert (forall ((_module.List$T@@16 T@U) ($h@@27 T@U) ($o@@34 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (or (not (= $o@@34 null)) (not true)) (= (dtype $o@@34) (Tclass._module.List? _module.List$T@@16)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@27 $o@@34) _module.List.a)) (Tclass._System.array _module.List$T@@16)))
 :qid |unknown.0:0|
 :skolemid |532|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@27 $o@@34) _module.List.a)) (Tclass._module.List? _module.List$T@@16))
)))
(assert (forall ((_module.M$T@@19 T@U) ($h@@28 T@U) ($o@@35 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (or (not (= $o@@35 null)) (not true)) (= (dtype $o@@35) (Tclass._module.M? _module.M$T@@19)))) ($Is SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@28 $o@@35) _module.M.xs)) (TSeq _module.M$T@@19)))
 :qid |unknown.0:0|
 :skolemid |578|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@28 $o@@35) _module.M.xs)) (Tclass._module.M? _module.M$T@@19))
)))
...
(assert (forall ((_module.M$T@@22 T@U) ($h@@29 T@U) ($o@@36 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@29) (and (or (not (= $o@@36 null)) (not true)) (= (dtype $o@@36) (Tclass._module.M? _module.M$T@@22)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@29 $o@@36) alloc)))) ($IsAlloc refType (_module.M.c $o@@36) Tclass._module.Cell $h@@29))
 :qid |unknown.0:0|
 :skolemid |575|
 :pattern ( (_module.M.c $o@@36) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@29 $o@@36) alloc)) (Tclass._module.M? _module.M$T@@22))
)))
(assert (forall ((_module.M$T@@23 T@U) ($h@@30 T@U) ($o@@37 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@30) (and (or (not (= $o@@37 null)) (not true)) (= (dtype $o@@37) (Tclass._module.M? _module.M$T@@23)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@30 $o@@37) alloc)))) ($IsAlloc refType (_module.M.__decreases1 $o@@37) Tclass._module.Cell? $h@@30))
 :qid |unknown.0:0|
 :skolemid |589|
 :pattern ( (_module.M.__decreases1 $o@@37) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@30 $o@@37) alloc)) (Tclass._module.M? _module.M$T@@23))
)))
...
(assert (forall ((_module.M$T@@24 T@U) ($o@@38 T@U) ) (!  (=> (and (or (not (= $o@@38 null)) (not true)) (= (dtype $o@@38) (Tclass._module.M? _module.M$T@@24))) ($Is SetType (_module.M.__reads $o@@38) (TSet Tclass._System.object?)))
 :qid |unknown.0:0|
 :skolemid |580|
 :pattern ( (_module.M.__reads $o@@38) (Tclass._module.M? _module.M$T@@24))
)))
(assert (forall ((_module.M$T@@25 T@U) ($o@@39 T@U) ) (!  (=> (and (or (not (= $o@@39 null)) (not true)) (= (dtype $o@@39) (Tclass._module.M? _module.M$T@@25))) ($Is SetType (_module.M.__modifies $o@@39) (TSet Tclass._System.object?)))
 :qid |unknown.0:0|
 :skolemid |582|
 :pattern ( (_module.M.__modifies $o@@39) (Tclass._module.M? _module.M$T@@25))
)))
...
(declare-fun call0formal@_module.M$T () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 48) (let ((anon4_correct  (=> (|_module.M.Valid#canCall| _module._default.Client$T $Heap@2 call4formal@this@0) (=> (and (_module.M.Valid _module._default.Client$T $Heap@2 call4formal@this@0) (and (forall (($o@@42 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) _module.M.__new)) ($Box refType $o@@42)) (or (not (= $o@@42 null)) (not true)))
 :qid |Iterdfy.79:31|
 :skolemid |497|
 :pattern (  (or (not (= $o@@42 null)) (not true)))
)) (forall (($o@@43 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) _module.M.__new)) ($Box refType $o@@43)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@43) alloc)))))
 :qid |Iterdfy.79:31|
 :skolemid |498|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) _module.M.__new)) ($Box refType $o@@43)))
)))) (and (=> (= (ControlFlow 0 24) (- 0 29)) true) (and (=> (= (ControlFlow 0 24) (- 0 28)) (or (not (= call4formal@this@0 null)) (not true))) (and (=> (= (ControlFlow 0 24) (- 0 27)) (or (not (= |l#0@@0| null)) (not true))) (=> (and (<= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) _module.M.xs))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |l#0@@0|) _module.List.Contents)))) (|Seq#SameUntil| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) _module.M.xs)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |l#0@@0|) _module.List.Contents)) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) _module.M.xs))))) (and (=> (= (ControlFlow 0 24) (- 0 26)) (or (not (= |l#0@@0| null)) (not true))) (=> (or (not (= |l#0@@0| null)) (not true)) (and (=> (= (ControlFlow 0 24) (- 0 25)) true) (=> (= (ControlFlow 0 24) (- 0 23)) (or (not (= call4formal@this@0 null)) (not true))))))))))))))
(let ((anon16_Else_correct  (=> (and (not (_module.M.Valid _module._default.Client$T $Heap@2 call4formal@this@0)) (= (ControlFlow 0 33) 24)) anon4_correct)))
(let ((anon16_Then_correct  (=> (_module.M.Valid _module._default.Client$T $Heap@2 call4formal@this@0) (and (=> (= (ControlFlow 0 30) (- 0 32)) true) (and (=> (= (ControlFlow 0 30) (- 0 31)) (or (not (= call4formal@this@0 null)) (not true))) (=> (= (ControlFlow 0 30) 24) anon4_correct))))))
(let ((anon15_Then_correct  (=> (not |$w$loop#0@0|) (and (=> (= (ControlFlow 0 34) (- 0 36)) true) (and (=> (= (ControlFlow 0 34) (- 0 35)) (or (not (= call4formal@this@0 null)) (not true))) (=> (and ($IsAllocBox ($Box refType call4formal@this@0) (Tclass._module.M? _module._default.Client$T) $Heap@2) (|_module.M.Valid#canCall| _module._default.Client$T $Heap@2 call4formal@this@0)) (and (=> (= (ControlFlow 0 34) 30) anon16_Then_correct) (=> (= (ControlFlow 0 34) 33) anon16_Else_correct))))))))
(let ((anon19_Else_correct  (=> (or (not (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.x) |stop#0|)) (not true)) (and (=> (= (ControlFlow 0 6) (- 0 10)) (or (<= 0 |$decr$loop#00@1|) (= (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#0@@0|) _module.List.Contents))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.xs)))) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#0@@0|) _module.List.Contents))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.xs)))) |$decr$loop#00@1|)) (and (=> (= (ControlFlow 0 6) (- 0 9)) (< (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#0@@0|) _module.List.Contents))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.xs)))) |$decr$loop#00@1|)) (=> (< (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#0@@0|) _module.List.Contents))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.xs)))) |$decr$loop#00@1|) (=> (|_module.M.Valid#canCall| _module._default.Client$T $Heap@3 call4formal@this@0) (and (=> (= (ControlFlow 0 6) (- 0 8)) (=> |$w$loop#0@0| (_module.M.Valid _module._default.Client$T $Heap@3 call4formal@this@0))) (=> (=> |$w$loop#0@0| (_module.M.Valid _module._default.Client$T $Heap@3 call4formal@this@0)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (=> |$w$loop#0@0| (and (forall (($o@@44 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.__new)) ($Box refType $o@@44)) (or (not (= $o@@44 null)) (not true)))
 :qid |Iterdfy.79:31|
 :skolemid |499|
 :pattern (  (or (not (= $o@@44 null)) (not true)))
)) (forall (($o@@45 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.__new)) ($Box refType $o@@45)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@45) alloc)))))
 :qid |Iterdfy.79:31|
 :skolemid |500|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.__new)) ($Box refType $o@@45)))
))))) (=> (=> |$w$loop#0@0| (and (forall (($o@@46 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.__new)) ($Box refType $o@@46)) (or (not (= $o@@46 null)) (not true)))
 :qid |Iterdfy.79:31|
 :skolemid |499|
 :pattern (  (or (not (= $o@@46 null)) (not true)))
)) (forall (($o@@47 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.__new)) ($Box refType $o@@47)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@47) alloc)))))
 :qid |Iterdfy.79:31|
 :skolemid |500|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.__new)) ($Box refType $o@@47)))
)))) (=> (= (ControlFlow 0 6) (- 0 5)) (=> |$w$loop#0@0| (and (<= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.xs))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#0@@0|) _module.List.Contents)))) (|Seq#SameUntil| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.xs)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#0@@0|) _module.List.Contents)) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.xs)))))))))))))))))))
(let ((anon19_Then_correct true))
(let ((anon18_Else_correct  (=> |call3formal@more#0@0| (and (=> (= (ControlFlow 0 11) (- 0 15)) true) (and (=> (= (ControlFlow 0 11) (- 0 14)) (or (not (= call4formal@this@0 null)) (not true))) (=> (or (not (= call4formal@this@0 null)) (not true)) (=> (= |s#0@2| (|Seq#Append| |s#0@1| (|Seq#Build| |Seq#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.x)))) (and (=> (= (ControlFlow 0 11) (- 0 13)) true) (and (=> (= (ControlFlow 0 11) (- 0 12)) (or (not (= call4formal@this@0 null)) (not true))) (=> (or (not (= call4formal@this@0 null)) (not true)) (and (=> (= (ControlFlow 0 11) 4) anon19_Then_correct) (=> (= (ControlFlow 0 11) 6) anon19_Else_correct))))))))))))
(let ((anon18_Then_correct true))
(let ((anon17_Else_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) (= |$decr$loop#00@1| (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |l#0@@0|) _module.List.Contents))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) _module.M.xs)))))) (and (=> (= (ControlFlow 0 16) (- 0 21)) true) (and (=> (= (ControlFlow 0 16) (- 0 20)) (or (not (= call4formal@this@0 null)) (not true))) (=> (or (not (= call4formal@this@0 null)) (not true)) (and (=> (= (ControlFlow 0 16) (- 0 19)) (forall (($o@@48 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@48 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@48) alloc)))) (or (or (= $o@@48 call4formal@this@0) (|Set#IsMember| (_module.M.__modifies call4formal@this@0) ($Box refType $o@@48))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) _module.M.__new)) ($Box refType $o@@48)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@48 $f@@2)))
 :qid |Iterdfy.83:30|
 :skolemid |503|
))) (=> (forall (($o@@49 T@U) ($f@@3 T@U) ) (!  (=> (and (and (or (not (= $o@@49 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@49) alloc)))) (or (or (= $o@@49 call4formal@this@0) (|Set#IsMember| (_module.M.__modifies call4formal@this@0) ($Box refType $o@@49))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) _module.M.__new)) ($Box refType $o@@49)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@49 $f@@3)))
 :qid |Iterdfy.83:30|
 :skolemid |503|
)) (and (=> (= (ControlFlow 0 16) (- 0 18)) (_module.M.Valid _module._default.Client$T $Heap@2 call4formal@this@0)) (=> (_module.M.Valid _module._default.Client$T $Heap@2 call4formal@this@0) (and (=> (= (ControlFlow 0 16) (- 0 17)) (U_2_bool (Lit boolType (bool_2_U true)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (=> (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (=> (and (and (forall (($o@@50 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.__new)) ($Box refType $o@@50)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) _module.M.__new)) ($Box refType $o@@50)))) (or (not (= $o@@50 null)) (not true)))
 :qid |Iterdfy.48:10|
 :skolemid |596|
 :pattern (  (or (not (= $o@@50 null)) (not true)))
)) (forall (($o@@51 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.__new)) ($Box refType $o@@51)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) _module.M.__new)) ($Box refType $o@@51)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@51) alloc)))))
 :qid |Iterdfy.48:10|
 :skolemid |597|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@51) alloc)))
))) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.__new)) ($Box refType null)))) (=> (and (and (and (=> |call3formal@more#0@0| (|_module.M.Valid#canCall| _module._default.Client$T $Heap@3 call4formal@this@0)) (=> |call3formal@more#0@0| (_module.M.Valid _module._default.Client$T $Heap@3 call4formal@this@0))) (and (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.xs)) (ite |call3formal@more#0@0| (|Seq#Append| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) _module.M.xs)) (|Seq#Build| |Seq#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.x))) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) _module.M.xs)))) (=> |call3formal@more#0@0| (and (<= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.xs))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.M.l call4formal@this@0)) _module.List.Contents)))) (|Seq#SameUntil| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.xs)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.M.l call4formal@this@0)) _module.List.Contents)) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.xs)))))))) (and (and (=> |call3formal@more#0@0| (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.x) (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.M.l call4formal@this@0)) _module.List.Contents)) (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.xs))) 1)))) (=> (not |call3formal@more#0@0|) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call4formal@this@0) _module.M.xs)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.M.l call4formal@this@0)) _module.List.Contents))))) (and (forall (($o@@52 T@U) ) (!  (=> (and (or (not (= $o@@52 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@52) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@52) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@52)) (or (or (= $o@@52 call4formal@this@0) (|Set#IsMember| (_module.M.__modifies call4formal@this@0) ($Box refType $o@@52))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) _module.M.__new)) ($Box refType $o@@52)))))
 :qid |Iterdfy.48:10|
 :skolemid |598|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@52))
)) ($HeapSucc $Heap@2 $Heap@3)))) (and (=> (= (ControlFlow 0 16) 3) anon18_Then_correct) (=> (= (ControlFlow 0 16) 11) anon18_Else_correct)))))))))))))))))
(let ((anon17_Then_correct true))
(let ((anon15_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 22) 2) anon17_Then_correct) (=> (= (ControlFlow 0 22) 16) anon17_Else_correct)))))
(let ((anon14_LoopBody_correct  (and (=> (= (ControlFlow 0 37) 34) anon15_Then_correct) (=> (= (ControlFlow 0 37) 22) anon15_Else_correct))))
(let ((anon14_LoopDone_correct true))
(let ((anon14_LoopHead_correct  (=> (and (and (and (and ($Is SeqType |s#0@1| (TSeq _module._default.Client$T)) ($IsAlloc SeqType |s#0@1| (TSeq _module._default.Client$T) $Heap@2)) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2))) (and (and (not false) true) true)) (and (and (and (=> |$w$loop#0@0| (|_module.M.Valid#canCall| _module._default.Client$T $Heap@2 call4formal@this@0)) (=> |$w$loop#0@0| (_module.M.Valid _module._default.Client$T $Heap@2 call4formal@this@0))) (and (=> |$w$loop#0@0| (and (forall (($o@@53 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) _module.M.__new)) ($Box refType $o@@53)) (or (not (= $o@@53 null)) (not true)))
 :qid |Iterdfy.79:31|
 :skolemid |499|
 :pattern (  (or (not (= $o@@53 null)) (not true)))
)) (forall (($o@@54 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) _module.M.__new)) ($Box refType $o@@54)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@54) alloc)))))
 :qid |Iterdfy.79:31|
 :skolemid |500|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) _module.M.__new)) ($Box refType $o@@54)))
)))) (=> |$w$loop#0@0| (and (<= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) _module.M.xs))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |l#0@@0|) _module.List.Contents)))) (|Seq#SameUntil| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) _module.M.xs)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |l#0@@0|) _module.List.Contents)) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) _module.M.xs)))))))) (and (and (forall (($o@@55 T@U) ) (!  (=> (and (or (not (= $o@@55 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@55) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@55) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@55)))
 :qid |Iterdfy.78:3|
 :skolemid |501|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@55))
)) ($HeapSucc $Heap@1 $Heap@2)) (and (forall (($o@@56 T@U) ($f@@4 T@U) ) (!  (=> (and (or (not (= $o@@56 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@56) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@56) $f@@4) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@56) $f@@4)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@56 $f@@4))))
 :qid |Iterdfy.78:3|
 :skolemid |502|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@56) $f@@4))
)) (<= (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |l#0@@0|) _module.List.Contents))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call4formal@this@0) _module.M.xs)))) |$decr_init$loop#00@0|))))) (and (=> (= (ControlFlow 0 38) 1) anon14_LoopDone_correct) (=> (= (ControlFlow 0 38) 37) anon14_LoopBody_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 Tclass._module.Cell?)) (=> (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0) alloc)))) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 39) (- 0 47)) true) (=> (and (or (not (= call4formal@this null)) (not true)) (and ($Is refType call4formal@this (Tclass._module.M call0formal@_module.M$T)) ($IsAlloc refType call4formal@this (Tclass._module.M call0formal@_module.M$T) $Heap@@1))) (and (=> (= (ControlFlow 0 39) (- 0 46)) (=> (|_module.List.Valid#canCall| _module._default.Client$T $Heap@0 |l#0@@0|) (or (_module.List.Valid _module._default.Client$T $Heap@0 |l#0@@0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#0@@0|) _module.List.Repr)) ($Box refType |l#0@@0|))))) (=> (=> (|_module.List.Valid#canCall| _module._default.Client$T $Heap@0 |l#0@@0|) (or (_module.List.Valid _module._default.Client$T $Heap@0 |l#0@@0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#0@@0|) _module.List.Repr)) ($Box refType |l#0@@0|)))) (and (=> (= (ControlFlow 0 39) (- 0 45)) (=> (|_module.List.Valid#canCall| _module._default.Client$T $Heap@0 |l#0@@0|) (or (_module.List.Valid _module._default.Client$T $Heap@0 |l#0@@0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#0@@0|) _module.List.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#0@@0|) _module.List.a))))) (=> (=> (|_module.List.Valid#canCall| _module._default.Client$T $Heap@0 |l#0@@0|) (or (_module.List.Valid _module._default.Client$T $Heap@0 |l#0@@0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#0@@0|) _module.List.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#0@@0|) _module.List.a)))) (and (=> (= (ControlFlow 0 39) (- 0 44)) (=> (|_module.List.Valid#canCall| _module._default.Client$T $Heap@0 |l#0@@0|) (or (_module.List.Valid _module._default.Client$T $Heap@0 |l#0@@0|) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#0@@0|) _module.List.n))) (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#0@@0|) _module.List.a))))))) (=> (=> (|_module.List.Valid#canCall| _module._default.Client$T $Heap@0 |l#0@@0|) (or (_module.List.Valid _module._default.Client$T $Heap@0 |l#0@@0|) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#0@@0|) _module.List.n))) (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#0@@0|) _module.List.a)))))) (and (=> (= (ControlFlow 0 39) (- 0 43)) (=> (|_module.List.Valid#canCall| _module._default.Client$T $Heap@0 |l#0@@0|) (or (_module.List.Valid _module._default.Client$T $Heap@0 |l#0@@0|) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#0@@0|) _module.List.Contents)) (|Seq#Take| (|Seq#FromArray| $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#0@@0|) _module.List.a))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#0@@0|) _module.List.n)))))))) (=> (=> (|_module.List.Valid#canCall| _module._default.Client$T $Heap@0 |l#0@@0|) (or (_module.List.Valid _module._default.Client$T $Heap@0 |l#0@@0|) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#0@@0|) _module.List.Contents)) (|Seq#Take| (|Seq#FromArray| $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#0@@0|) _module.List.a))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#0@@0|) _module.List.n))))))) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and (and (and (or (not (= call4formal@this@0 null)) (not true)) (and ($Is refType call4formal@this@0 (Tclass._module.M _module._default.Client$T)) ($IsAlloc refType call4formal@this@0 (Tclass._module.M _module._default.Client$T) $Heap@1))) (= (_module.M.l call4formal@this@0) |l#0@@0|)) (and (= (_module.M.c call4formal@this@0) $nw@0) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call4formal@this@0) _module.M.xs)) |Seq#Empty|))) (and (and (|_module.M.Valid#canCall| _module._default.Client$T $Heap@1 call4formal@this@0) (_module.M.Valid _module._default.Client$T $Heap@1 call4formal@this@0)) (and (|Set#Equal| (_module.M.__reads call4formal@this@0) (|Set#Union| |Set#Empty| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#0@@0|) _module.List.Repr)))) (|Set#Equal| (_module.M.__modifies call4formal@this@0) (|Set#UnionOne| |Set#Empty| ($Box refType $nw@0)))))) (and (and (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call4formal@this@0) _module.M.__new)) |Set#Empty|) (= (_module.M.__decreases0 call4formal@this@0) |l#0@@0|)) (and (= (_module.M.__decreases1 call4formal@this@0) $nw@0) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call4formal@this@0) alloc)))))) (and (and (forall (($o@@57 T@U) ) (!  (=> (and (or (not (= $o@@57 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@57) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@57) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@57)))
 :qid |Iterdfy.48:10|
 :skolemid |591|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@57))
)) ($HeapSucc $Heap@0 $Heap@1)) (and (= |s#0@0| (Lit SeqType |Seq#Empty|)) (= |$decr_init$loop#00@0| (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |l#0@@0|) _module.List.Contents))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call4formal@this@0) _module.M.xs))))))))) (and (=> (= (ControlFlow 0 39) (- 0 42)) (=> |$w$loop#0@0| (_module.M.Valid _module._default.Client$T $Heap@1 call4formal@this@0))) (=> (=> |$w$loop#0@0| (_module.M.Valid _module._default.Client$T $Heap@1 call4formal@this@0)) (and (=> (= (ControlFlow 0 39) (- 0 41)) (=> |$w$loop#0@0| (and (forall (($o@@58 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call4formal@this@0) _module.M.__new)) ($Box refType $o@@58)) (or (not (= $o@@58 null)) (not true)))
 :qid |Iterdfy.79:31|
 :skolemid |499|
 :pattern (  (or (not (= $o@@58 null)) (not true)))
)) (forall (($o@@59 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call4formal@this@0) _module.M.__new)) ($Box refType $o@@59)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@59) alloc)))))
 :qid |Iterdfy.79:31|
 :skolemid |500|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call4formal@this@0) _module.M.__new)) ($Box refType $o@@59)))
))))) (=> (=> |$w$loop#0@0| (and (forall (($o@@60 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call4formal@this@0) _module.M.__new)) ($Box refType $o@@60)) (or (not (= $o@@60 null)) (not true)))
 :qid |Iterdfy.79:31|
 :skolemid |499|
 :pattern (  (or (not (= $o@@60 null)) (not true)))
)) (forall (($o@@61 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call4formal@this@0) _module.M.__new)) ($Box refType $o@@61)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@61) alloc)))))
 :qid |Iterdfy.79:31|
 :skolemid |500|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call4formal@this@0) _module.M.__new)) ($Box refType $o@@61)))
)))) (and (=> (= (ControlFlow 0 39) (- 0 40)) (=> |$w$loop#0@0| (and (<= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call4formal@this@0) _module.M.xs))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |l#0@@0|) _module.List.Contents)))) (|Seq#SameUntil| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call4formal@this@0) _module.M.xs)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |l#0@@0|) _module.List.Contents)) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call4formal@this@0) _module.M.xs))))))) (=> (=> |$w$loop#0@0| (and (<= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call4formal@this@0) _module.M.xs))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |l#0@@0|) _module.List.Contents)))) (|Seq#SameUntil| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call4formal@this@0) _module.M.xs)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |l#0@@0|) _module.List.Contents)) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call4formal@this@0) _module.M.xs)))))) (=> (= (ControlFlow 0 39) 38) anon14_LoopHead_correct))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (and (and ($Is refType |l#0@@0| (Tclass._module.List _module._default.Client$T)) ($IsAlloc refType |l#0@@0| (Tclass._module.List _module._default.Client$T) $Heap@@1)) (and ($IsBox |stop#0| _module._default.Client$T) ($IsAllocBox |stop#0| _module._default.Client$T $Heap@@1))) (and (and ($Is SeqType |s#0| (TSeq _module._default.Client$T)) ($IsAlloc SeqType |s#0| (TSeq _module._default.Client$T) $Heap@@1)) (and (=> |defass#c#0| (and ($Is refType |c#0@@9| Tclass._module.Cell) ($IsAlloc refType |c#0@@9| Tclass._module.Cell $Heap@@1))) true))) (and (and (and (=> |defass#iter#0| (and ($Is refType |iter#0| (Tclass._module.M _module._default.Client$T)) ($IsAlloc refType |iter#0| (Tclass._module.M _module._default.Client$T) $Heap@@1))) true) (= 3 $FunctionContextHeight)) (and (and (|_module.List.Valid#canCall| _module._default.Client$T $Heap@@1 |l#0@@0|) (and (_module.List.Valid _module._default.Client$T $Heap@@1 |l#0@@0|) (and (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |l#0@@0|) _module.List.Repr)) ($Box refType |l#0@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |l#0@@0|) _module.List.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |l#0@@0|) _module.List.a))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |l#0@@0|) _module.List.n))) (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |l#0@@0|) _module.List.a))))) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |l#0@@0|) _module.List.Contents)) (|Seq#Take| (|Seq#FromArray| $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |l#0@@0|) _module.List.a))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |l#0@@0|) _module.List.n)))))))) (= (ControlFlow 0 48) 39)))) anon0_correct))))
