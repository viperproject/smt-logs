...
(declare-fun _module._default.Tail_Lemma1$_T0 () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.Tail__Lemma1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (_module.Stream.Cons_q (_module.__default.Tail _module._default.Tail_Lemma1$_T0 ($LS $LZ) |s#0@@5| |n#0@@5|)) (_module.Stream.Cons_q (_module.__default.Tail _module._default.Tail_Lemma1$_T0 ($LS ($LS $LZ)) |s#0@@5| |k#0|))))))
(let ((anon6_Else_correct  (=> (and (not (and (< |k#0| |n#0@@5|) (_module.Stream.Cons_q (_module.__default.Tail _module._default.Tail_Lemma1$_T0 ($LS $LZ) |s#0@@5| |n#0@@5|)))) (= (ControlFlow 0 7) 2)) GeneratedUnifiedExit_correct)))
(let ((anon6_Then_correct  (=> (and (< |k#0| |n#0@@5|) (_module.Stream.Cons_q (_module.__default.Tail _module._default.Tail_Lemma1$_T0 ($LS $LZ) |s#0@@5| |n#0@@5|))) (=> (and (and ($IsAlloc DatatypeTypeType |s#0@@5| (Tclass._module.Stream _module._default.Tail_Lemma1$_T0) $Heap@0) ($IsAlloc intType (int_2_U |n#0@@5|) Tclass._System.nat $Heap@0)) (and (|_module.__default.Tail#canCall| _module._default.Tail_Lemma1$_T0 |s#0@@5| |n#0@@5|) ($IsAlloc DatatypeTypeType |s#0@@5| (Tclass._module.Stream _module._default.Tail_Lemma1$_T0) $Heap@0))) (and (=> (= (ControlFlow 0 3) (- 0 6)) ($Is intType (int_2_U (- |n#0@@5| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0@@5| 1)) Tclass._System.nat) (=> (= |##n#0_1@0| (- |n#0@@5| 1)) (=> (and ($IsAlloc intType (int_2_U |##n#0_1@0|) Tclass._System.nat $Heap@0) (|_module.__default.Tail#canCall| _module._default.Tail_Lemma1$_T0 |s#0@@5| (- |n#0@@5| 1))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (_module.Stream.Cons_q (_module.__default.Tail _module._default.Tail_Lemma1$_T0 ($LS $LZ) |s#0@@5| (- |n#0@@5| 1)))) (=> (_module.Stream.Cons_q (_module.__default.Tail _module._default.Tail_Lemma1$_T0 ($LS $LZ) |s#0@@5| (- |n#0@@5| 1))) (=> (and (and (|$IsA#_module.Stream| (_module.__default.Tail _module._default.Tail_Lemma1$_T0 ($LS $LZ) |s#0@@5| |n#0@@5|)) (|$IsA#_module.Stream| (_module.Stream.tail (_module.__default.Tail _module._default.Tail_Lemma1$_T0 ($LS $LZ) |s#0@@5| (- |n#0@@5| 1))))) (and (|_module.__default.Tail#canCall| _module._default.Tail_Lemma1$_T0 |s#0@@5| |n#0@@5|) (|_module.__default.Tail#canCall| _module._default.Tail_Lemma1$_T0 |s#0@@5| (- |n#0@@5| 1)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (|$Eq#_module.Stream| _module._default.Tail_Lemma1$_T0 _module._default.Tail_Lemma1$_T0 ($LS ($LS $LZ)) (_module.__default.Tail _module._default.Tail_Lemma1$_T0 ($LS ($LS $LZ)) |s#0@@5| |n#0@@5|) (_module.Stream.tail (_module.__default.Tail _module._default.Tail_Lemma1$_T0 ($LS ($LS $LZ)) |s#0@@5| (- |n#0@@5| 1))))) (=> (and (|$Eq#_module.Stream| _module._default.Tail_Lemma1$_T0 _module._default.Tail_Lemma1$_T0 ($LS ($LS $LZ)) (_module.__default.Tail _module._default.Tail_Lemma1$_T0 ($LS $LZ) |s#0@@5| |n#0@@5|) (_module.Stream.tail (_module.__default.Tail _module._default.Tail_Lemma1$_T0 ($LS $LZ) |s#0@@5| (- |n#0@@5| 1)))) (= (ControlFlow 0 3) 2)) GeneratedUnifiedExit_correct)))))))))))))
(let ((anon2_correct  (=> (=> (< |k#0| |n#0@@5|) (|_module.__default.Tail#canCall| _module._default.Tail_Lemma1$_T0 |s#0@@5| |n#0@@5|)) (and (=> (= (ControlFlow 0 8) 3) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (<= |n#0@@5| |k#0|) (= (ControlFlow 0 10) 8)) anon2_correct)))
(let ((anon5_Then_correct  (=> (< |k#0| |n#0@@5|) (=> (and (and ($IsAlloc DatatypeTypeType |s#0@@5| (Tclass._module.Stream _module._default.Tail_Lemma1$_T0) $Heap@0) ($IsAlloc intType (int_2_U |n#0@@5|) Tclass._System.nat $Heap@0)) (and (|_module.__default.Tail#canCall| _module._default.Tail_Lemma1$_T0 |s#0@@5| |n#0@@5|) (= (ControlFlow 0 9) 8))) anon2_correct))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (|$IsA#_module.Stream| |s#0@@5|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@0 $Heap@0) (forall ((|$ih#s0#0| T@U) (|$ih#k0#0| Int) (|$ih#n0#0| Int) ) (!  (=> (and (and (and (and ($Is DatatypeTypeType |$ih#s0#0| (Tclass._module.Stream _module._default.Tail_Lemma1$_T0)) (<= (LitInt 0) |$ih#k0#0|)) (<= (LitInt 0) |$ih#n0#0|)) (<= |$ih#k0#0| |$ih#n0#0|)) (or (and (<= 0 |$ih#k0#0|) (< |$ih#k0#0| |k#0|)) (and (= |$ih#k0#0| |k#0|) (and (<= 0 |$ih#n0#0|) (< |$ih#n0#0| |n#0@@5|))))) (=> (_module.Stream.Cons_q (_module.__default.Tail _module._default.Tail_Lemma1$_T0 ($LS $LZ) |$ih#s0#0| |$ih#n0#0|)) (_module.Stream.Cons_q (_module.__default.Tail _module._default.Tail_Lemma1$_T0 ($LS $LZ) |$ih#s0#0| |$ih#k0#0|))))
 :qid |InfiniteTreesdfy.21:19|
 :skolemid |594|
 :pattern ( (_module.__default.Tail _module._default.Tail_Lemma1$_T0 ($LS $LZ) |$ih#s0#0| |$ih#k0#0|) (_module.__default.Tail _module._default.Tail_Lemma1$_T0 ($LS $LZ) |$ih#s0#0| |$ih#n0#0|))
)))) (and (=> (= (ControlFlow 0 11) 9) anon5_Then_correct) (=> (= (ControlFlow 0 11) 10) anon5_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (and ($Is DatatypeTypeType |s#0@@5| (Tclass._module.Stream _module._default.Tail_Lemma1$_T0)) ($IsAlloc DatatypeTypeType |s#0@@5| (Tclass._module.Stream _module._default.Tail_Lemma1$_T0) $Heap@@0)) (|$IsA#_module.Stream| |s#0@@5|)) (<= (LitInt 0) |k#0|)) (and (and (<= (LitInt 0) |n#0@@5|) (= 2 $FunctionContextHeight)) (and (<= |k#0| |n#0@@5|) (= (ControlFlow 0 12) 11)))) anon0_correct))))
