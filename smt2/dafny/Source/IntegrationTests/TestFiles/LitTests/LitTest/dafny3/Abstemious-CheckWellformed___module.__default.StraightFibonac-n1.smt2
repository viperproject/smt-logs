...
(declare-fun _module.__default.StraightFibonacci (T@U Int) T@U)
(declare-fun |_module.__default.StraightFibonacci#canCall| (Int) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly T@U) (|n#0| Int) ) (!  (=> (or (|_module.__default.nfib#canCall| |n#0|) (and (< 0 $FunctionContextHeight) (<= (LitInt 0) |n#0|))) (and (=> (<= 2 |n#0|) (and (|_module.__default.nfib#canCall| (- |n#0| 2)) (|_module.__default.nfib#canCall| (- |n#0| 1)))) (= (_module.__default.nfib ($LS $ly) |n#0|) (ite (< |n#0| 2) |n#0| (+ (_module.__default.nfib $ly (- |n#0| 2)) (_module.__default.nfib $ly (- |n#0| 1)))))))
 :qid |Abstemiousdfy.131:16|
 :skolemid |737|
 :pattern ( (_module.__default.nfib ($LS $ly) |n#0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@0 T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.__default.nfib#canCall| |n#0@@0|) (and (< 0 $FunctionContextHeight) (<= (LitInt 0) |n#0@@0|))) (<= (LitInt 0) (_module.__default.nfib $ly@@0 |n#0@@0|)))
 :qid |Abstemiousdfy.131:16|
 :skolemid |735|
 :pattern ( (_module.__default.nfib $ly@@0 |n#0@@0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@1 T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.__default.StraightFibonacci#canCall| |n#0@@1|) (and (< 1 $FunctionContextHeight) (<= (LitInt 0) |n#0@@1|))) ($Is DatatypeTypeType (_module.__default.StraightFibonacci $ly@@1 |n#0@@1|) (Tclass._module.Stream TInt)))
 :qid |Abstemiousdfy.176:16|
 :skolemid |754|
 :pattern ( (_module.__default.StraightFibonacci $ly@@1 |n#0@@1|))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@2 T@U) (|n#0@@2| Int) ) (!  (=> (or (|_module.__default.nfib#canCall| (LitInt |n#0@@2|)) (and (< 0 $FunctionContextHeight) (<= (LitInt 0) |n#0@@2|))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (< |n#0@@2| 2))))) (and (|_module.__default.nfib#canCall| (LitInt (- |n#0@@2| 2))) (|_module.__default.nfib#canCall| (LitInt (- |n#0@@2| 1))))) (= (_module.__default.nfib ($LS $ly@@2) (LitInt |n#0@@2|)) (ite (< |n#0@@2| 2) |n#0@@2| (+ (_module.__default.nfib ($LS $ly@@2) (LitInt (- |n#0@@2| 2))) (_module.__default.nfib ($LS $ly@@2) (LitInt (- |n#0@@2| 1))))))))
 :qid |Abstemiousdfy.131:16|
 :weight 3
 :skolemid |738|
 :pattern ( (_module.__default.nfib ($LS $ly@@2) (LitInt |n#0@@2|)))
))))
...
(assert (forall (($ly@@3 T@U) (|n#0@@3| Int) ) (! (= (_module.__default.nfib ($LS $ly@@3) |n#0@@3|) (_module.__default.nfib $ly@@3 |n#0@@3|))
 :qid |Abstemiousdfy.131:16|
 :skolemid |733|
 :pattern ( (_module.__default.nfib ($LS $ly@@3) |n#0@@3|))
)))
(assert (forall (($ly@@4 T@U) (|n#0@@4| Int) ) (! (= (_module.__default.StraightFibonacci ($LS $ly@@4) |n#0@@4|) (_module.__default.StraightFibonacci $ly@@4 |n#0@@4|))
 :qid |Abstemiousdfy.176:16|
 :skolemid |752|
 :pattern ( (_module.__default.StraightFibonacci ($LS $ly@@4) |n#0@@4|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@5 T@U) (|n#0@@5| Int) ) (!  (=> (or (|_module.__default.StraightFibonacci#canCall| |n#0@@5|) (and (< 1 $FunctionContextHeight) (<= (LitInt 0) |n#0@@5|))) (and (and (|_module.__default.nfib#canCall| |n#0@@5|) (|_module.__default.StraightFibonacci#canCall| (+ |n#0@@5| 1))) (= (_module.__default.StraightFibonacci ($LS $ly@@5) |n#0@@5|) (|#_module.Stream.Cons| ($Box intType (int_2_U (_module.__default.nfib ($LS $LZ) |n#0@@5|))) (_module.__default.StraightFibonacci $ly@@5 (+ |n#0@@5| 1))))))
 :qid |Abstemiousdfy.176:16|
 :skolemid |756|
 :pattern ( (_module.__default.StraightFibonacci ($LS $ly@@5) |n#0@@5|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.StraightFibonacci)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct  (=> ($IsAlloc intType (int_2_U |n#0@@6|) Tclass._System.nat $Heap) (=> (and (|_module.__default.nfib#canCall| |n#0@@6|) (= (ControlFlow 0 3) (- 0 2))) ($Is intType (int_2_U (+ |n#0@@6| 1)) Tclass._System.nat)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |n#0@@6|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct)))
