...
(declare-fun $Heap@@0 () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.Theorem3_h)
...
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |_k#0| ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS $LZ) |M#1| (Lit DatatypeTypeType |#_module.Stream.Nil|)) |M#1|) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Nil_q (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| (Lit DatatypeTypeType |#_module.Stream.Nil|))) (_module.Stream.Nil_q |M#1|))))) (=> (or (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |_k#0| ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS $LZ) |M#1| (Lit DatatypeTypeType |#_module.Stream.Nil|)) |M#1|) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Nil_q (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| (Lit DatatypeTypeType |#_module.Stream.Nil|))) (_module.Stream.Nil_q |M#1|)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |_k#0| ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS $LZ) |M#1| (Lit DatatypeTypeType |#_module.Stream.Nil|)) |M#1|) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| (Lit DatatypeTypeType |#_module.Stream.Nil|))) (and (_module.Stream.Cons_q |M#1|) (and (= (_module.Stream.head (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| (Lit DatatypeTypeType |#_module.Stream.Nil|))) (_module.Stream.head |M#1|)) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| (Lit DatatypeTypeType |#_module.Stream.Nil|))) (_module.Stream.tail |M#1|)))))))) (=> (or (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |_k#0| ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS $LZ) |M#1| (Lit DatatypeTypeType |#_module.Stream.Nil|)) |M#1|) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| (Lit DatatypeTypeType |#_module.Stream.Nil|))) (and (_module.Stream.Cons_q |M#1|) (and (= (_module.Stream.head (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| (Lit DatatypeTypeType |#_module.Stream.Nil|))) (_module.Stream.head |M#1|)) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| (Lit DatatypeTypeType |#_module.Stream.Nil|))) (_module.Stream.tail |M#1|))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (or (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |_k#0| ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS $LZ) |M#1| (Lit DatatypeTypeType |#_module.Stream.Nil|)) |M#1|) (or (=> (< 0 (|ORD#Offset| |_k#0|)) (and (=> (_module.Stream.Nil_q (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| (Lit DatatypeTypeType |#_module.Stream.Nil|))) (_module.Stream.Nil_q |M#1|)) (=> (_module.Stream.Cons_q (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| (Lit DatatypeTypeType |#_module.Stream.Nil|))) (and (_module.Stream.Cons_q |M#1|) (and (= (_module.Stream.head (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| (Lit DatatypeTypeType |#_module.Stream.Nil|))) (_module.Stream.head |M#1|)) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| (Lit DatatypeTypeType |#_module.Stream.Nil|))) (_module.Stream.tail |M#1|))))))) (=> (and (or (not (= |_k#0| (|ORD#FromNat| 0))) (not true)) (= (|ORD#Offset| |_k#0|) 0)) (|$Eq#_module.Stream| Tclass._module.X Tclass._module.X ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS $LZ) |M#1| (Lit DatatypeTypeType |#_module.Stream.Nil|)) |M#1|)))))))))))
(let ((anon8_Then_correct  (=> (= |M#1| (|#_module.Stream.Cons| |_mcc#0#0@0| |_mcc#1#0@0|)) (=> (and (and ($IsBox |_mcc#0#0@0| Tclass._module.X) ($IsAllocBox |_mcc#0#0@0| Tclass._module.X $Heap@0)) (and ($Is DatatypeTypeType |_mcc#1#0@0| (Tclass._module.Stream Tclass._module.X)) ($IsAlloc DatatypeTypeType |_mcc#1#0@0| (Tclass._module.Stream Tclass._module.X) $Heap@0))) (=> (and (and (and (and ($Is DatatypeTypeType |N#0@0| (Tclass._module.Stream Tclass._module.X)) ($IsAlloc DatatypeTypeType |N#0@0| (Tclass._module.Stream Tclass._module.X) $Heap@0)) (= |let#0_0_0#0#0| |_mcc#1#0@0|)) (and ($Is DatatypeTypeType |let#0_0_0#0#0| (Tclass._module.Stream Tclass._module.X)) (= |N#0@0| |let#0_0_0#0#0|))) (and (and (and ($IsBox |x#0@0| Tclass._module.X) ($IsAllocBox |x#0@0| Tclass._module.X $Heap@0)) (= |let#0_0_1#0#0| |_mcc#0#0@0|)) (and ($IsBox |let#0_0_1#0#0| Tclass._module.X) (= |x#0@0| |let#0_0_1#0#0|)))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0|)) (=> (= |_k##0@0| (|ORD#Minus| |_k#0| (|ORD#FromNat| 1))) (=> (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (=> (and (and (|_module.__default.append#canCall| Tclass._module.X |N#0@0| (Lit DatatypeTypeType |#_module.Stream.Nil|)) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |_k##0@0| ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS $LZ) |N#0@0| (Lit DatatypeTypeType |#_module.Stream.Nil|)) |N#0@0|)) (and (= $Heap@0 $Heap@2) (= (ControlFlow 0 7) 2))) GeneratedUnifiedExit_correct))))))))))))
...
(let ((anon6_Else_correct  (=> (<= (|ORD#Offset| |_k#0|) 0) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1)) (and (forall ((|_k'#0| T@U) (|M#2| T@U) ) (!  (=> (and ($Is DatatypeTypeType |M#2| (Tclass._module.Stream Tclass._module.X)) (|ORD#Less| |_k'#0| |_k#0|)) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |_k'#0| ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS $LZ) |M#2| (Lit DatatypeTypeType |#_module.Stream.Nil|)) |M#2|))
 :qid |Streamsdfy.138:16|
 :skolemid |644|
 :pattern ( (_module.__default.append Tclass._module.X ($LS $LZ) |M#2| |#_module.Stream.Nil|) (|ORD#Less| |_k'#0| |_k#0|))
)) (= (ControlFlow 0 5) 2))) GeneratedUnifiedExit_correct))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (|$IsA#_module.Stream| |M#1|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@0 $Heap@0) (forall ((|$ih#_k0#0| T@U) (|$ih#M0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#M0#0| (Tclass._module.Stream Tclass._module.X)) (U_2_bool (Lit boolType (bool_2_U true)))) (|ORD#Less| |$ih#_k0#0| |_k#0|)) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |$ih#_k0#0| ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS $LZ) |$ih#M0#0| (Lit DatatypeTypeType |#_module.Stream.Nil|)) |$ih#M0#0|))
 :qid |Streamsdfy.138:16|
 :skolemid |642|
 :pattern ( (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |$ih#_k0#0| ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS $LZ) |$ih#M0#0| (Lit DatatypeTypeType |#_module.Stream.Nil|)) |$ih#M0#0|))
)))) (and (=> (= (ControlFlow 0 13) 12) anon6_Then_correct) (=> (= (ControlFlow 0 13) 5) anon6_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and ($Is DatatypeTypeType |M#1| (Tclass._module.Stream Tclass._module.X)) ($IsAlloc DatatypeTypeType |M#1| (Tclass._module.Stream Tclass._module.X) $Heap@@0)) (|$IsA#_module.Stream| |M#1|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct))))
