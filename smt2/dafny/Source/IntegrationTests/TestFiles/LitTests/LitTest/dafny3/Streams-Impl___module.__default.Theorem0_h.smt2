...
(declare-fun _module.__default.map__g (T@U T@U) T@U)
(declare-fun _module.__default.map__fg (T@U T@U) T@U)
(declare-fun |_module.__default.map__fg#canCall| (T@U) Bool)
(declare-fun |_module.__default.map__f#canCall| (T@U) Bool)
(declare-fun |_module.__default.map__g#canCall| (T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@0| T@U) ) (!  (=> (or (|_module.__default.g#canCall| |x#0@@0|) (and (< 0 $FunctionContextHeight) ($IsBox |x#0@@0| Tclass._module.X))) ($IsBox (_module.__default.g |x#0@@0|) Tclass._module.X))
 :qid |Streamsdfy.20:18|
 :skolemid |593|
...
(assert (forall (($ly T@U) (|M#0| T@U) ) (! (= (_module.__default.map__f ($LS $ly) |M#0|) (_module.__default.map__f $ly |M#0|))
 :qid |Streamsdfy.22:16|
 :skolemid |595|
 :pattern ( (_module.__default.map__f ($LS $ly) |M#0|))
)))
(assert (forall (($ly@@0 T@U) (|M#0@@0| T@U) ) (! (= (_module.__default.map__g ($LS $ly@@0) |M#0@@0|) (_module.__default.map__g $ly@@0 |M#0@@0|))
 :qid |Streamsdfy.29:16|
 :skolemid |602|
 :pattern ( (_module.__default.map__g ($LS $ly@@0) |M#0@@0|))
)))
(assert (forall (($ly@@1 T@U) (|M#0@@1| T@U) ) (! (= (_module.__default.map__fg ($LS $ly@@1) |M#0@@1|) (_module.__default.map__fg $ly@@1 |M#0@@1|))
 :qid |Streamsdfy.36:16|
 :skolemid |609|
 :pattern ( (_module.__default.map__fg ($LS $ly@@1) |M#0@@1|))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) (|M#0@@2| T@U) ) (!  (=> (or (|_module.__default.map__fg#canCall| |M#0@@2|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |M#0@@2| (Tclass._module.Stream Tclass._module.X)))) (and (=> (not (_module.Stream.Nil_q |M#0@@2|)) (let ((|N#1| (_module.Stream.tail |M#0@@2|)))
(let ((|x#1| (_module.Stream.head |M#0@@2|)))
 (and (and (|_module.__default.g#canCall| |x#1|) (|_module.__default.f#canCall| (_module.__default.g |x#1|))) (|_module.__default.map__fg#canCall| |N#1|))))) (= (_module.__default.map__fg ($LS $ly@@2) |M#0@@2|) (ite (_module.Stream.Nil_q |M#0@@2|) |#_module.Stream.Nil| (let ((|N#0| (_module.Stream.tail |M#0@@2|)))
(let ((|x#0@@1| (_module.Stream.head |M#0@@2|)))
(|#_module.Stream.Cons| (_module.__default.f (_module.__default.g |x#0@@1|)) (_module.__default.map__fg $ly@@2 |N#0|))))))))
 :qid |Streamsdfy.36:16|
 :skolemid |613|
 :pattern ( (_module.__default.map__fg ($LS $ly@@2) |M#0@@2|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@3 T@U) (|M#0@@3| T@U) ) (!  (=> (or (|_module.__default.map__f#canCall| |M#0@@3|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |M#0@@3| (Tclass._module.Stream Tclass._module.X)))) (and (=> (not (_module.Stream.Nil_q |M#0@@3|)) (let ((|N#1@@0| (_module.Stream.tail |M#0@@3|)))
(let ((|x#1@@0| (_module.Stream.head |M#0@@3|)))
 (and (|_module.__default.f#canCall| |x#1@@0|) (|_module.__default.map__f#canCall| |N#1@@0|))))) (= (_module.__default.map__f ($LS $ly@@3) |M#0@@3|) (ite (_module.Stream.Nil_q |M#0@@3|) |#_module.Stream.Nil| (let ((|N#0@@0| (_module.Stream.tail |M#0@@3|)))
(let ((|x#0@@2| (_module.Stream.head |M#0@@3|)))
(|#_module.Stream.Cons| (_module.__default.f |x#0@@2|) (_module.__default.map__f $ly@@3 |N#0@@0|))))))))
 :qid |Streamsdfy.22:16|
 :skolemid |599|
 :pattern ( (_module.__default.map__f ($LS $ly@@3) |M#0@@3|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@4 T@U) (|M#0@@4| T@U) ) (!  (=> (or (|_module.__default.map__g#canCall| |M#0@@4|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |M#0@@4| (Tclass._module.Stream Tclass._module.X)))) (and (=> (not (_module.Stream.Nil_q |M#0@@4|)) (let ((|N#1@@1| (_module.Stream.tail |M#0@@4|)))
(let ((|x#1@@1| (_module.Stream.head |M#0@@4|)))
 (and (|_module.__default.g#canCall| |x#1@@1|) (|_module.__default.map__g#canCall| |N#1@@1|))))) (= (_module.__default.map__g ($LS $ly@@4) |M#0@@4|) (ite (_module.Stream.Nil_q |M#0@@4|) |#_module.Stream.Nil| (let ((|N#0@@1| (_module.Stream.tail |M#0@@4|)))
(let ((|x#0@@3| (_module.Stream.head |M#0@@4|)))
(|#_module.Stream.Cons| (_module.__default.g |x#0@@3|) (_module.__default.map__g $ly@@4 |N#0@@1|))))))))
 :qid |Streamsdfy.29:16|
 :skolemid |606|
 :pattern ( (_module.__default.map__g ($LS $ly@@4) |M#0@@4|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@5 T@U) (|M#0@@5| T@U) ) (!  (=> (or (|_module.__default.map__f#canCall| |M#0@@5|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |M#0@@5| (Tclass._module.Stream Tclass._module.X)))) ($Is DatatypeTypeType (_module.__default.map__f $ly@@5 |M#0@@5|) (Tclass._module.Stream Tclass._module.X)))
 :qid |Streamsdfy.22:16|
 :skolemid |597|
 :pattern ( (_module.__default.map__f $ly@@5 |M#0@@5|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@6 T@U) (|M#0@@6| T@U) ) (!  (=> (or (|_module.__default.map__g#canCall| |M#0@@6|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |M#0@@6| (Tclass._module.Stream Tclass._module.X)))) ($Is DatatypeTypeType (_module.__default.map__g $ly@@6 |M#0@@6|) (Tclass._module.Stream Tclass._module.X)))
 :qid |Streamsdfy.29:16|
 :skolemid |604|
 :pattern ( (_module.__default.map__g $ly@@6 |M#0@@6|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@7 T@U) (|M#0@@7| T@U) ) (!  (=> (or (|_module.__default.map__fg#canCall| |M#0@@7|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |M#0@@7| (Tclass._module.Stream Tclass._module.X)))) ($Is DatatypeTypeType (_module.__default.map__fg $ly@@7 |M#0@@7|) (Tclass._module.Stream Tclass._module.X)))
 :qid |Streamsdfy.36:16|
 :skolemid |611|
 :pattern ( (_module.__default.map__fg $ly@@7 |M#0@@7|))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.Theorem0_h)
...
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |_k#0| ($LS ($LS $LZ)) (_module.__default.map__fg ($LS $LZ) |M#1|) (_module.__default.map__f ($LS $LZ) (_module.__default.map__g ($LS $LZ) |M#1|))) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Nil_q (_module.__default.map__fg ($LS ($LS $LZ)) |M#1|)) (_module.Stream.Nil_q (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.map__g ($LS ($LS $LZ)) |M#1|))))))) (=> (or (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |_k#0| ($LS ($LS $LZ)) (_module.__default.map__fg ($LS $LZ) |M#1|) (_module.__default.map__f ($LS $LZ) (_module.__default.map__g ($LS $LZ) |M#1|))) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Nil_q (_module.__default.map__fg ($LS ($LS $LZ)) |M#1|)) (_module.Stream.Nil_q (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.map__g ($LS ($LS $LZ)) |M#1|)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |_k#0| ($LS ($LS $LZ)) (_module.__default.map__fg ($LS $LZ) |M#1|) (_module.__default.map__f ($LS $LZ) (_module.__default.map__g ($LS $LZ) |M#1|))) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (_module.__default.map__fg ($LS ($LS $LZ)) |M#1|)) (and (_module.Stream.Cons_q (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.map__g ($LS ($LS $LZ)) |M#1|))) (and (= (_module.Stream.head (_module.__default.map__fg ($LS ($LS $LZ)) |M#1|)) (_module.Stream.head (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.map__g ($LS ($LS $LZ)) |M#1|)))) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.map__fg ($LS ($LS $LZ)) |M#1|)) (_module.Stream.tail (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.map__g ($LS ($LS $LZ)) |M#1|)))))))))) (=> (or (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |_k#0| ($LS ($LS $LZ)) (_module.__default.map__fg ($LS $LZ) |M#1|) (_module.__default.map__f ($LS $LZ) (_module.__default.map__g ($LS $LZ) |M#1|))) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (_module.__default.map__fg ($LS ($LS $LZ)) |M#1|)) (and (_module.Stream.Cons_q (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.map__g ($LS ($LS $LZ)) |M#1|))) (and (= (_module.Stream.head (_module.__default.map__fg ($LS ($LS $LZ)) |M#1|)) (_module.Stream.head (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.map__g ($LS ($LS $LZ)) |M#1|)))) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.map__fg ($LS ($LS $LZ)) |M#1|)) (_module.Stream.tail (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.map__g ($LS ($LS $LZ)) |M#1|))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (or (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |_k#0| ($LS ($LS $LZ)) (_module.__default.map__fg ($LS $LZ) |M#1|) (_module.__default.map__f ($LS $LZ) (_module.__default.map__g ($LS $LZ) |M#1|))) (or (=> (< 0 (|ORD#Offset| |_k#0|)) (and (=> (_module.Stream.Nil_q (_module.__default.map__fg ($LS ($LS $LZ)) |M#1|)) (_module.Stream.Nil_q (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.map__g ($LS ($LS $LZ)) |M#1|)))) (=> (_module.Stream.Cons_q (_module.__default.map__fg ($LS ($LS $LZ)) |M#1|)) (and (_module.Stream.Cons_q (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.map__g ($LS ($LS $LZ)) |M#1|))) (and (= (_module.Stream.head (_module.__default.map__fg ($LS ($LS $LZ)) |M#1|)) (_module.Stream.head (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.map__g ($LS ($LS $LZ)) |M#1|)))) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.map__fg ($LS ($LS $LZ)) |M#1|)) (_module.Stream.tail (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.map__g ($LS ($LS $LZ)) |M#1|))))))))) (=> (and (or (not (= |_k#0| (|ORD#FromNat| 0))) (not true)) (= (|ORD#Offset| |_k#0|) 0)) (|$Eq#_module.Stream| Tclass._module.X Tclass._module.X ($LS ($LS $LZ)) (_module.__default.map__fg ($LS $LZ) |M#1|) (_module.__default.map__f ($LS $LZ) (_module.__default.map__g ($LS $LZ) |M#1|)))))))))))))
(let ((anon8_Then_correct  (=> (= |M#1| (|#_module.Stream.Cons| |_mcc#0#0@0| |_mcc#1#0@0|)) (=> (and (and ($IsBox |_mcc#0#0@0| Tclass._module.X) ($IsAllocBox |_mcc#0#0@0| Tclass._module.X $Heap@0)) (and ($Is DatatypeTypeType |_mcc#1#0@0| (Tclass._module.Stream Tclass._module.X)) ($IsAlloc DatatypeTypeType |_mcc#1#0@0| (Tclass._module.Stream Tclass._module.X) $Heap@0))) (=> (and (and (and (and ($Is DatatypeTypeType |N#0@0| (Tclass._module.Stream Tclass._module.X)) ($IsAlloc DatatypeTypeType |N#0@0| (Tclass._module.Stream Tclass._module.X) $Heap@0)) (= |let#0_0_0#0#0| |_mcc#1#0@0|)) (and ($Is DatatypeTypeType |let#0_0_0#0#0| (Tclass._module.Stream Tclass._module.X)) (= |N#0@0| |let#0_0_0#0#0|))) (and (and (and ($IsBox |x#0@0| Tclass._module.X) ($IsAllocBox |x#0@0| Tclass._module.X $Heap@0)) (= |let#0_0_1#0#0| |_mcc#0#0@0|)) (and ($IsBox |let#0_0_1#0#0| Tclass._module.X) (= |x#0@0| |let#0_0_1#0#0|)))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0|)) (=> (= |_k##0@0| (|ORD#Minus| |_k#0| (|ORD#FromNat| 1))) (=> (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (=> (and (and (and (|_module.__default.map__fg#canCall| |N#0@0|) (and (|_module.__default.map__g#canCall| |N#0@0|) (|_module.__default.map__f#canCall| (_module.__default.map__g ($LS $LZ) |N#0@0|)))) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |_k##0@0| ($LS ($LS $LZ)) (_module.__default.map__fg ($LS $LZ) |N#0@0|) (_module.__default.map__f ($LS $LZ) (_module.__default.map__g ($LS $LZ) |N#0@0|)))) (and (= $Heap@0 $Heap@2) (= (ControlFlow 0 7) 2))) GeneratedUnifiedExit_correct))))))))))))
...
(let ((anon6_Else_correct  (=> (<= (|ORD#Offset| |_k#0|) 0) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1)) (and (forall ((|_k'#0| T@U) (|M#2| T@U) ) (!  (=> (and ($Is DatatypeTypeType |M#2| (Tclass._module.Stream Tclass._module.X)) (|ORD#Less| |_k'#0| |_k#0|)) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |_k'#0| ($LS ($LS $LZ)) (_module.__default.map__fg ($LS $LZ) |M#2|) (_module.__default.map__f ($LS $LZ) (_module.__default.map__g ($LS $LZ) |M#2|))))
 :qid |Streamsdfy.46:16|
 :skolemid |619|
 :pattern ( (_module.__default.map__g ($LS $LZ) |M#2|) (|ORD#Less| |_k'#0| |_k#0|))
 :pattern ( (_module.__default.map__fg ($LS $LZ) |M#2|) (|ORD#Less| |_k'#0| |_k#0|))
)) (= (ControlFlow 0 5) 2))) GeneratedUnifiedExit_correct))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.Stream| |M#1|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#_k0#0| T@U) (|$ih#M0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#M0#0| (Tclass._module.Stream Tclass._module.X)) (U_2_bool (Lit boolType (bool_2_U true)))) (|ORD#Less| |$ih#_k0#0| |_k#0|)) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |$ih#_k0#0| ($LS ($LS $LZ)) (_module.__default.map__fg ($LS $LZ) |$ih#M0#0|) (_module.__default.map__f ($LS $LZ) (_module.__default.map__g ($LS $LZ) |$ih#M0#0|))))
 :qid |Streamsdfy.46:16|
 :skolemid |617|
 :pattern ( (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |$ih#_k0#0| ($LS ($LS $LZ)) (_module.__default.map__fg ($LS $LZ) |$ih#M0#0|) (_module.__default.map__f ($LS $LZ) (_module.__default.map__g ($LS $LZ) |$ih#M0#0|))))
)))) (and (=> (= (ControlFlow 0 13) 12) anon6_Then_correct) (=> (= (ControlFlow 0 13) 5) anon6_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |M#1| (Tclass._module.Stream Tclass._module.X)) ($IsAlloc DatatypeTypeType |M#1| (Tclass._module.Stream Tclass._module.X) $Heap)) (|$IsA#_module.Stream| |M#1|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct))))
