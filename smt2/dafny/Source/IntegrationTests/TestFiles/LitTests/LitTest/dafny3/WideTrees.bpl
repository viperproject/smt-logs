// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/WideTrees.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/WideTrees-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/WideTrees.dfy
...
axiom 2 <= $FunctionContextHeight
   ==> (forall $ly: LayerType :: 
    ...
    _module.__default.BigTree#canCall() || 2 < $FunctionContextHeight
...
procedure {:verboseName "BigTree (well-formedness)"} CheckWellformed$$_module.__default.BigTree();
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "BigTree (well-formedness)"} CheckWellformed$$_module.__default.BigTree()
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    else
    {
        ...
        assert {:id "id1"} 0 <= LitInt(1) || LitInt(0) == LitInt(1);
        assert {:id "id2"} LitInt(0) <= LitInt(1);
        assume _module.__default.BigTrees#canCall();
        assume {:id "id3"} _module.__default.BigTree($LS($LZ))
...
axiom 2 <= $FunctionContextHeight
   ==> (forall $ly: LayerType :: 
    ...
    _module.__default.BigTrees#canCall() || 2 < $FunctionContextHeight
...
procedure {:verboseName "BigTrees (well-formedness)"} CheckWellformed$$_module.__default.BigTrees();
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
...
axiom {:id "id6"} 3 <= $FunctionContextHeight
...
axiom {:id "id7"} 3 <= $FunctionContextHeight
   ==> (forall t#0: DatatypeType :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "LowerThan (well-formedness)"} CheckWellformed$$_module.__default.LowerThan(s#0: DatatypeType, n#0: int)
{
  ...
  var ##n#1: int;
    ...
    else
    {
        ...
        {
            assume {:id "id16"} _module.__default.LowerThan($LS($LZ), s#0, n#0) == Lit(true);
            assume true;
            // CheckWellformedWithResult: any expression
        ...
        else if (s#0 == #_module.Stream.SCons($Box(_mcc#0#0), _mcc#1#0))
        {
            ...
            assume {:id "id13"} t#Z#0 == let#1#0#0;
            if (LitInt(1) <= n#0)
            {
            ...
            assume {:id "id15"} _module.__default.LowerThan($LS($LZ), s#0, n#0)
               == (
                LitInt(1) <= n#0
                 && _module.__default.LowerThan($LS($LZ), _module.Tree.children(t#Z#0), n#0 - 1)
...
axiom {:id "id19"} 3 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, _k#0: Box, s#0: DatatypeType, n#0: int :: 
...
procedure {:verboseName "SmallTree (well-formedness)"} CheckWellformed$$_module.__default.SmallTree(n#0: int where LitInt(0) <= n#0);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "SmallTree (well-formedness)"} CheckWellformed$$_module.__default.SmallTree(n#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var ##n#0: int;
    ...
    else
    {
        ...
        // assume allocatedness for argument to function
        assume $IsAlloc(##n#0, Tclass._System.nat(), $Heap);
        assert {:id "id21"} 0 <= LitInt(1) || LitInt(0) == LitInt(1);
        assert {:id "id22"} 0 <= n#0 || LitInt(0) < LitInt(1) || LitInt(-1) == n#0;
        assert {:id "id23"} LitInt(0) < LitInt(1) || (LitInt(0) == LitInt(1) && LitInt(-1) < n#0);
        assume _module.__default.SmallTrees#canCall(n#0);
        assume {:id "id24"} _module.__default.SmallTree($LS($LZ), n#0)
...
procedure {:verboseName "SmallTrees (well-formedness)"} CheckWellformed$$_module.__default.SmallTrees(n#0: int where LitInt(0) <= n#0);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "SmallTrees (well-formedness)"} CheckWellformed$$_module.__default.SmallTrees(n#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var ##n#0: int;
  var ##n#1: int;
    ...
    else
    {
        ...
        if (n#0 == LitInt(0))
        {
            assume {:id "id26"} _module.__default.SmallTrees($LS($LZ), n#0) == Lit(#_module.Stream.SNil());
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(_module.__default.SmallTrees($LS($LZ), n#0), 
              Tclass._module.Stream(Tclass._module.Tree()));
        ...
        else
        {
            ...
            assume $IsAlloc(##n#1, Tclass._System.nat(), $Heap);
            assume _module.__default.SmallTrees#canCall(n#0);
            assume {:id "id28"} _module.__default.SmallTrees($LS($LZ), n#0)
...
procedure {:verboseName "Theorem (well-formedness)"} CheckWellFormed$$_module.__default.Theorem(n#0: int where LitInt(0) <= n#0);
  free requires 4 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Theorem (call)"} Call$$_module.__default.Theorem(n#0: int where LitInt(0) <= n#0);
  modifies $Heap;
  ...
  free ensures {:id "id30"} _module.__default.HasBoundedHeight#canCall(_module.__default.SmallTree($LS($LZ), n#0))
     && 
...
procedure {:verboseName "Theorem (correctness)"} Impl$$_module.__default.Theorem(n#0: int where LitInt(0) <= n#0) returns ($_reverifyPost: bool);
  free requires 4 == $FunctionContextHeight;
  modifies $Heap;
  // user-defined postconditions
  free ensures _module.__default.SmallTree#canCall(n#0)
     && _module.__default.HasBoundedHeight#canCall(_module.__default.SmallTree($LS($LZ), n#0));
  ensures {:id "id31"} _module.__default.HasBoundedHeight#canCall(_module.__default.SmallTree($LS($LZ), n#0))
     ==> _module.__default.HasBoundedHeight(_module.__default.SmallTree($LS($LZ), n#0))
       || (exists n#2: int :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Theorem (correctness)"} Impl$$_module.__default.Theorem(n#0: int) returns ($_reverifyPost: bool)
{
  ...
  var n##0: int;
    ...
    assume (forall $ih#n0#0: int :: 
      { _module.__default.SmallTree($LS($LZ), $ih#n0#0) } 
    ...
    $_reverifyPost := false;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/WideTrees.dfy(45,8)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    n##0 := n#0;
    call {:id "id32"} Call$$_module.__default.Lemma(n##0);
    // TrCallStmt: After ProcessCallStmt
}



procedure {:verboseName "Lemma (well-formedness)"} CheckWellFormed$$_module.__default.Lemma(n#0: int where LitInt(0) <= n#0);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Lemma (call)"} Call$$_module.__default.Lemma(n#0: int where LitInt(0) <= n#0);
  modifies $Heap;
  // user-defined postconditions
  ...
  free ensures {:id "id34"} _module.__default.LowerThan#canCall(_module.__default.SmallTrees($LS($LZ), n#0), n#0)
     && 
    _module.__default.LowerThan($LS($LZ), _module.__default.SmallTrees($LS($LZ), n#0), n#0)
     && (if _module.Stream.SNil_q(_module.__default.SmallTrees($LS($LZ), n#0))
       then true
       else (var tail#1 := _module.Stream.tail(_module.__default.SmallTrees($LS($LZ), n#0)); 
        (var t#1 := $Unbox(_module.Stream.head(_module.__default.SmallTrees($LS($LZ), n#0))): DatatypeType; 
          LitInt(1) <= n#0
             && _module.__default.LowerThan($LS($LZ), _module.Tree.children(t#1), n#0 - 1)
             && _module.__default.LowerThan($LS($LZ), tail#1, n#0))));
  // frame condition
  free ensures old($Heap) == $Heap;



procedure {:verboseName "Lemma# (co-call)"} CoCall$$_module.__default.Lemma_h(_k#0: Box, n#1: int where LitInt(0) <= n#1);
  modifies $Heap;
  // user-defined postconditions
  ...
  free ensures {:id "id35"} _module.__default.LowerThan_h#canCall(_k#0, _module.__default.SmallTrees($LS($LZ), n#1), n#1)
     && 
    _module.__default.LowerThan_h($LS($LZ), _k#0, _module.__default.SmallTrees($LS($LZ), n#1), n#1)
     && 
    (0 < ORD#Offset(_k#0)
       ==> (if _module.Stream.SNil_q(_module.__default.SmallTrees($LS($LZ), n#1))
         then true
         else (var tail#3 := _module.Stream.tail(_module.__default.SmallTrees($LS($LZ), n#1)); 
          (var t#3 := $Unbox(_module.Stream.head(_module.__default.SmallTrees($LS($LZ), n#1))): DatatypeType; 
            LitInt(1) <= n#1
               && _module.__default.LowerThan_h($LS($LZ), ORD#Minus(_k#0, ORD#FromNat(1)), _module.Tree.children(t#3), n#1 - 1)
               && _module.__default.LowerThan_h($LS($LZ), ORD#Minus(_k#0, ORD#FromNat(1)), tail#3, n#1)))))
     && (LitInt(0) == ORD#Offset(_k#0)
       ==> (forall _k'#0: Box :: 
        { _module.__default.LowerThan_h($LS($LZ), _k'#0, _module.__default.SmallTrees($LS($LZ), n#1), n#1) } 
        ORD#Less(_k'#0, _k#0)
...
procedure {:verboseName "Lemma# (correctness)"} Impl$$_module.__default.Lemma_h(_k#0: Box, n#1: int where LitInt(0) <= n#1) returns ($_reverifyPost: bool);
  free requires 4 == $FunctionContextHeight;
  modifies $Heap;
  // user-defined postconditions
  free ensures _module.__default.SmallTrees#canCall(n#1)
     && _module.__default.LowerThan_h#canCall(_k#0, _module.__default.SmallTrees($LS($LZ), n#1), n#1);
  ensures {:id "id36"} _module.__default.LowerThan_h#canCall(_k#0, _module.__default.SmallTrees($LS($LZ), n#1), n#1)
     ==> _module.__default.LowerThan_h($LS($LZ), _k#0, _module.__default.SmallTrees($LS($LZ), n#1), n#1)
       || (0 < ORD#Offset(_k#0)
         ==> 
        _module.Stream.SNil_q(_module.__default.SmallTrees($LS($LZ), n#1))
         ==> Lit(true));
  ensures {:id "id37"} _module.__default.LowerThan_h#canCall(_k#0, _module.__default.SmallTrees($LS($LZ), n#1), n#1)
     ==> _module.__default.LowerThan_h($LS($LZ), _k#0, _module.__default.SmallTrees($LS($LZ), n#1), n#1)
       || (0 < ORD#Offset(_k#0)
         ==> 
        !_module.Stream.SNil_q(_module.__default.SmallTrees($LS($LZ), n#1))
         ==> (var tail#4 := _module.Stream.tail(_module.__default.SmallTrees($LS($LS($LZ)), n#1)); 
          (var t#4 := $Unbox(_module.Stream.head(_module.__default.SmallTrees($LS($LS($LZ)), n#1))): DatatypeType; 
            LitInt(1) <= n#1)));
  ensures {:id "id38"} _module.__default.LowerThan_h#canCall(_k#0, _module.__default.SmallTrees($LS($LZ), n#1), n#1)
     ==> _module.__default.LowerThan_h($LS($LZ), _k#0, _module.__default.SmallTrees($LS($LZ), n#1), n#1)
       || (0 < ORD#Offset(_k#0)
         ==> 
        !_module.Stream.SNil_q(_module.__default.SmallTrees($LS($LZ), n#1))
         ==> (var tail#4 := _module.Stream.tail(_module.__default.SmallTrees($LS($LS($LZ)), n#1)); 
          (var t#4 := $Unbox(_module.Stream.head(_module.__default.SmallTrees($LS($LS($LZ)), n#1))): DatatypeType; 
            _module.__default.LowerThan_h($LS($LS($LZ)), 
              ORD#Minus(_k#0, ORD#FromNat(1)), 
              _module.Tree.children(t#4), 
              n#1 - 1))));
  ensures {:id "id39"} _module.__default.LowerThan_h#canCall(_k#0, _module.__default.SmallTrees($LS($LZ), n#1), n#1)
     ==> _module.__default.LowerThan_h($LS($LZ), _k#0, _module.__default.SmallTrees($LS($LZ), n#1), n#1)
       || (0 < ORD#Offset(_k#0)
         ==> 
        !_module.Stream.SNil_q(_module.__default.SmallTrees($LS($LZ), n#1))
         ==> (var tail#4 := _module.Stream.tail(_module.__default.SmallTrees($LS($LS($LZ)), n#1)); 
          (var t#4 := $Unbox(_module.Stream.head(_module.__default.SmallTrees($LS($LS($LZ)), n#1))): DatatypeType; 
            _module.__default.LowerThan_h($LS($LS($LZ)), ORD#Minus(_k#0, ORD#FromNat(1)), tail#4, n#1))));
  ensures {:id "id40"} _module.__default.LowerThan_h#canCall(_k#0, _module.__default.SmallTrees($LS($LZ), n#1), n#1)
     ==> _module.__default.LowerThan_h($LS($LZ), _k#0, _module.__default.SmallTrees($LS($LZ), n#1), n#1)
       || (LitInt(0) == ORD#Offset(_k#0)
         ==> (forall _k'#1: Box :: 
          { _module.__default.LowerThan_h($LS($LS($LZ)), _k'#1, _module.__default.SmallTrees($LS($LS($LZ)), n#1), n#1) } 
          ORD#Less(_k'#1, _k#0)
             ==> _module.__default.LowerThan_h($LS($LS($LZ)), _k'#1, _module.__default.SmallTrees($LS($LS($LZ)), n#1), n#1)));
  // frame condition
  free ensures old($Heap) == $Heap;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Lemma# (correctness)"} Impl$$_module.__default.Lemma_h(_k#0: Box, n#1: int) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var $initHeapForallStmt#0: Heap;
  var _k##0: Box;
  ...
  var $initHeapForallStmt#1_0_0: Heap;
    ...
    assume (forall $ih#_k0#0: Box, $ih#n0#0: int :: 
      ...
      LitInt(0) <= $ih#n0#0
         ...
         ==> _module.__default.LowerThan_h($LS($LZ), $ih#_k0#0, _module.__default.SmallTrees($LS($LZ), $ih#n0#0), $ih#n0#0));
    $_reverifyPost := false;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/WideTrees.dfy(49,1)
    assume true;
    if (0 < ORD#Offset(_k#0))
    {
        // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/WideTrees.dfy(50,3)
        assume true;
        if (0 < n#1)
        {
            // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/WideTrees.dfy(51,10)
            // TrCallStmt: Before ProcessCallStmt
            ...
            assume true;
            // ProcessCallStmt: CheckSubrange
            assert {:id "id43"} $Is(n#1 - 1, Tclass._System.nat());
            n##0 := n#1 - 1;
            call {:id "id44"} CoCall$$_module.__default.Lemma_h(_k##0, n##0);
            // TrCallStmt: After ProcessCallStmt
        }
        else
        {
    ...
    {
        // ----- forall statement (call) ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/WideTrees.dfy(49,1)
        $initHeapForallStmt#1_0_0 := $Heap;
        havoc $Heap;
        assume $initHeapForallStmt#1_0_0 == $Heap;
        assume (forall _k'#2: Box, n#2: int :: 
          { _module.__default.SmallTrees($LS($LZ), n#2), ORD#Less(_k'#2, _k#0) } 
          LitInt(0) <= n#2 && ORD#Less(_k'#2, _k#0)
             ==> _module.__default.LowerThan_h($LS($LZ), _k'#2, _module.__default.SmallTrees($LS($LZ), n#2), n#2));
    }
}
