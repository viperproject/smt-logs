...
(assert (distinct TInt TagInt alloc Tagclass._System.nat Tagclass._System.___hFunc2 Tagclass._System.___hPartialFunc2 Tagclass._System.___hTotalFunc2 Tagclass._module.Stream |##_module.Stream.Cons| tytagFamily$nat |tytagFamily$_#Func2| |tytagFamily$_#PartialFunc2| |tytagFamily$_#TotalFunc2| tytagFamily$Stream)
)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@0| Int) (|y#0| Int) ) (!  (=> (or (|_module.__default.plus#canCall| (LitInt |x#0@@0|) (LitInt |y#0|)) (< 0 $FunctionContextHeight)) (= (_module.__default.plus (LitInt |x#0@@0|) (LitInt |y#0|)) (LitInt (+ |x#0@@0| |y#0|))))
 :qid |Abstemiousdfy.48:15|
 :weight 3
 :skolemid |630|
 :pattern ( (_module.__default.plus (LitInt |x#0@@0|) (LitInt |y#0|)))
))))
...
(assert (forall ((|x#0@@2| Int) (|y#0@@0| Int) ) (! (= (|_module.__default.plus#requires| |x#0@@2| |y#0@@0|) true)
 :qid |Abstemiousdfy.48:15|
 :skolemid |628|
 :pattern ( (|_module.__default.plus#requires| |x#0@@2| |y#0@@0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@3| Int) (|y#0@@1| Int) ) (!  (=> (or (|_module.__default.plus#canCall| |x#0@@3| |y#0@@1|) (< 0 $FunctionContextHeight)) (= (_module.__default.plus |x#0@@3| |y#0@@1|) (+ |x#0@@3| |y#0@@1|)))
 :qid |Abstemiousdfy.48:15|
 :skolemid |629|
 :pattern ( (_module.__default.plus |x#0@@3| |y#0@@1|))
))))
...
(assert (forall ((|#$T0@@16| T@U) (|#$T1@@16| T@U) (|#$R@@16| T@U) (|f#0@@3| T@U) ($h@@1 T@U) ) (! (= ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hPartialFunc2 |#$T0@@16| |#$T1@@16| |#$R@@16|) $h@@1) ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hFunc2 |#$T0@@16| |#$T1@@16| |#$R@@16|) $h@@1))
 :qid |unknown.0:0|
 :skolemid |519|
 :pattern ( ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hPartialFunc2 |#$T0@@16| |#$T1@@16| |#$R@@16|) $h@@1))
)))
(assert (forall ((|#$T0@@17| T@U) (|#$T1@@17| T@U) (|#$R@@17| T@U) (|f#0@@4| T@U) ($h@@2 T@U) ) (! (= ($IsAlloc HandleTypeType |f#0@@4| (Tclass._System.___hTotalFunc2 |#$T0@@17| |#$T1@@17| |#$R@@17|) $h@@2) ($IsAlloc HandleTypeType |f#0@@4| (Tclass._System.___hPartialFunc2 |#$T0@@17| |#$T1@@17| |#$R@@17|) $h@@2))
 :qid |unknown.0:0|
 :skolemid |527|
 :pattern ( ($IsAlloc HandleTypeType |f#0@@4| (Tclass._System.___hTotalFunc2 |#$T0@@17| |#$T1@@17| |#$R@@17|) $h@@2))
)))
...
(assert (forall ((_module.Stream$T@@6 T@U) (|a#14#0#0@@0| T@U) (|a#14#1#0@@0| T@U) ($h@@4 T@U) ) (!  (=> ($IsGoodHeap $h@@4) (= ($IsAlloc DatatypeTypeType (|#_module.Stream.Cons| |a#14#0#0@@0| |a#14#1#0@@0|) (Tclass._module.Stream _module.Stream$T@@6) $h@@4)  (and ($IsAllocBox |a#14#0#0@@0| _module.Stream$T@@6 $h@@4) ($IsAlloc DatatypeTypeType |a#14#1#0@@0| (Tclass._module.Stream _module.Stream$T@@6) $h@@4))))
 :qid |unknown.0:0|
 :skolemid |803|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.Stream.Cons| |a#14#0#0@@0| |a#14#1#0@@0|) (Tclass._module.Stream _module.Stream$T@@6) $h@@4))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.C__Correct)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@2 $Heap@0)) (and ($IsAlloc intType (int_2_U |n#0@@8|) Tclass._System.nat $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= 0 $FunctionContextHeight)) (not true))))))
