...
(set-info :boogie-vc-id Impl$$_module.__default.Tail__Lemma0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (|$IsA#_module.Stream| |s#0@@5|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@0 $Heap@0)) (and (forall ((|$ih#s0#0| T@U) (|$ih#n0#0| Int) ) (!  (=> (and (and (and ($Is DatatypeTypeType |$ih#s0#0| (Tclass._module.Stream _module._default.Tail_Lemma0$_T0)) (<= (LitInt 0) |$ih#n0#0|)) (and (_module.Stream.Cons_q |$ih#s0#0|) (_module.Stream.Cons_q (_module.__default.Tail _module._default.Tail_Lemma0$_T0 ($LS $LZ) |$ih#s0#0| |$ih#n0#0|)))) (and (<= 0 |$ih#n0#0|) (< |$ih#n0#0| |n#0@@5|))) (|$Eq#_module.Stream| _module._default.Tail_Lemma0$_T0 _module._default.Tail_Lemma0$_T0 ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.Tail _module._default.Tail_Lemma0$_T0 ($LS $LZ) |$ih#s0#0| |$ih#n0#0|)) (_module.__default.Tail _module._default.Tail_Lemma0$_T0 ($LS $LZ) (_module.Stream.tail |$ih#s0#0|) |$ih#n0#0|)))
 :qid |InfiniteTreesdfy.16:19|
 :skolemid |593|
 :pattern ( (_module.__default.Tail _module._default.Tail_Lemma0$_T0 ($LS $LZ) (_module.Stream.tail |$ih#s0#0|) |$ih#n0#0|))
 :pattern ( (_module.Stream.tail (_module.__default.Tail _module._default.Tail_Lemma0$_T0 ($LS $LZ) |$ih#s0#0| |$ih#n0#0|)))
 :pattern ( (_module.Stream.Cons_q (_module.__default.Tail _module._default.Tail_Lemma0$_T0 ($LS $LZ) |$ih#s0#0| |$ih#n0#0|)))
)) (= (ControlFlow 0 2) (- 0 1)))) (|$Eq#_module.Stream| _module._default.Tail_Lemma0$_T0 _module._default.Tail_Lemma0$_T0 ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.Tail _module._default.Tail_Lemma0$_T0 ($LS ($LS $LZ)) |s#0@@5| |n#0@@5|)) (_module.__default.Tail _module._default.Tail_Lemma0$_T0 ($LS ($LS $LZ)) (_module.Stream.tail |s#0@@5|) |n#0@@5|))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (and ($Is DatatypeTypeType |s#0@@5| (Tclass._module.Stream _module._default.Tail_Lemma0$_T0)) ($IsAlloc DatatypeTypeType |s#0@@5| (Tclass._module.Stream _module._default.Tail_Lemma0$_T0) $Heap@@0)) (|$IsA#_module.Stream| |s#0@@5|)) (<= (LitInt 0) |n#0@@5|)) (and (and (= 2 $FunctionContextHeight) (_module.Stream.Cons_q |s#0@@5|)) (and (_module.Stream.Cons_q (_module.__default.Tail _module._default.Tail_Lemma0$_T0 ($LS ($LS $LZ)) |s#0@@5| |n#0@@5|)) (= (ControlFlow 0 3) 2)))) anon0_correct))))
