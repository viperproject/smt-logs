...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@3 T@U) (|n#0@@3| Int) ) (!  (=> (or (|_module.__default.SkinnyFiniteTree#canCall| |n#0@@3|) (and (< 3 $FunctionContextHeight) (<= (LitInt 0) |n#0@@3|))) (and (=> (or (not (= |n#0@@3| (LitInt 0))) (not true)) (|_module.__default.SkinnyFiniteTree#canCall| (- |n#0@@3| 1))) (= (_module.__default.SkinnyFiniteTree ($LS $ly@@3) |n#0@@3|) (ite (= |n#0@@3| (LitInt 0)) (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|)) (|#_module.Tree.Node| (|#_module.Stream.Cons| ($Box DatatypeTypeType (_module.__default.SkinnyFiniteTree $ly@@3 (- |n#0@@3| 1))) (Lit DatatypeTypeType |#_module.Stream.Nil|)))))))
 :qid |InfiniteTreesdfy.300:16|
 :skolemid |839|
 :pattern ( (_module.__default.SkinnyFiniteTree ($LS $ly@@3) |n#0@@3|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@4 T@U) (|_k#0@@2| T@U) (|s#0@@3| T@U) (|n#0@@4| Int) ) (!  (=> (or (|_module.__default.LowerThan_h#canCall| (Lit BoxType |_k#0@@2|) |s#0@@3| |n#0@@4|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@3| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@4|)))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@2|)) (=> (not (_module.Stream.Nil_q |s#0@@3|)) (let ((|tail#6| (_module.Stream.tail |s#0@@3|)))
(let ((|t#6| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@3|))))
 (=> (<= (LitInt 1) |n#0@@4|) (and (and (_module.Tree.Node_q |t#6|) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@2| (|ORD#FromNat| 1)) (_module.Tree.children |t#6|) (- |n#0@@4| 1))) (=> (_module.__default.LowerThan_h ($LS $ly@@4) (|ORD#Minus| |_k#0@@2| (|ORD#FromNat| 1)) (_module.Tree.children |t#6|) (- |n#0@@4| 1)) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@2| (|ORD#FromNat| 1)) |tail#6| |n#0@@4|)))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@2|)) (ite (_module.Stream.Nil_q |s#0@@3|) true (let ((|tail#7| (_module.Stream.tail |s#0@@3|)))
(let ((|t#7| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@3|))))
 (and (and (<= (LitInt 1) |n#0@@4|) (_module.__default.LowerThan_h ($LS $ly@@4) (|ORD#Minus| |_k#0@@2| (|ORD#FromNat| 1)) (_module.Tree.children |t#7|) (- |n#0@@4| 1))) (_module.__default.LowerThan_h ($LS $ly@@4) (|ORD#Minus| |_k#0@@2| (|ORD#FromNat| 1)) |tail#7| |n#0@@4|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@2|)) (forall ((|_k'#1| T@U) ) (!  (=> (|ORD#Less| |_k'#1| |_k#0@@2|) (|_module.__default.LowerThan_h#canCall| |_k'#1| |s#0@@3| |n#0@@4|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |666|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@4) |_k'#1| |s#0@@3| |n#0@@4|))
))))) (= (_module.__default.LowerThan_h ($LS $ly@@4) (Lit BoxType |_k#0@@2|) |s#0@@3| |n#0@@4|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@2|)) (ite (_module.Stream.Nil_q |s#0@@3|) true (let ((|tail#5| (_module.Stream.tail |s#0@@3|)))
(let ((|t#5| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@3|))))
 (and (and (<= (LitInt 1) |n#0@@4|) (_module.__default.LowerThan_h ($LS $ly@@4) (|ORD#Minus| |_k#0@@2| (|ORD#FromNat| 1)) (_module.Tree.children |t#5|) (- |n#0@@4| 1))) (_module.__default.LowerThan_h ($LS $ly@@4) (|ORD#Minus| |_k#0@@2| (|ORD#FromNat| 1)) |tail#5| |n#0@@4|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@2|)) (forall ((|_k'#1@@0| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@0| |_k#0@@2|) (_module.__default.LowerThan_h ($LS $ly@@4) |_k'#1@@0| |s#0@@3| |n#0@@4|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |665|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@4) |_k'#1@@0| |s#0@@3| |n#0@@4|))
)))))))
 :qid |InfiniteTreesdfy.71:20|
 :weight 3
 :skolemid |667|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@4) (Lit BoxType |_k#0@@2|) |s#0@@3| |n#0@@4|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@5 T@U) (|_k#0@@3| T@U) (|s#0@@4| T@U) (|n#0@@5| Int) ) (!  (=> (or (|_module.__default.LowerThan_h#canCall| |_k#0@@3| |s#0@@4| |n#0@@5|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@4| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@5|)))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@3|)) (=> (not (_module.Stream.Nil_q |s#0@@4|)) (let ((|tail#3| (_module.Stream.tail |s#0@@4|)))
(let ((|t#3| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@4|))))
 (=> (<= (LitInt 1) |n#0@@5|) (and (and (_module.Tree.Node_q |t#3|) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1)) (_module.Tree.children |t#3|) (- |n#0@@5| 1))) (=> (_module.__default.LowerThan_h $ly@@5 (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1)) (_module.Tree.children |t#3|) (- |n#0@@5| 1)) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1)) |tail#3| |n#0@@5|)))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@3|)) (ite (_module.Stream.Nil_q |s#0@@4|) true (let ((|tail#4| (_module.Stream.tail |s#0@@4|)))
(let ((|t#4| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@4|))))
 (and (and (<= (LitInt 1) |n#0@@5|) (_module.__default.LowerThan_h $ly@@5 (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1)) (_module.Tree.children |t#4|) (- |n#0@@5| 1))) (_module.__default.LowerThan_h $ly@@5 (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1)) |tail#4| |n#0@@5|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@3|)) (forall ((|_k'#0| T@U) ) (!  (=> (|ORD#Less| |_k'#0| |_k#0@@3|) (|_module.__default.LowerThan_h#canCall| |_k'#0| |s#0@@4| |n#0@@5|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |663|
 :pattern ( (_module.__default.LowerThan_h $ly@@5 |_k'#0| |s#0@@4| |n#0@@5|))
))))) (= (_module.__default.LowerThan_h ($LS $ly@@5) |_k#0@@3| |s#0@@4| |n#0@@5|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@3|)) (ite (_module.Stream.Nil_q |s#0@@4|) true (let ((|tail#2| (_module.Stream.tail |s#0@@4|)))
(let ((|t#2| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@4|))))
 (and (and (<= (LitInt 1) |n#0@@5|) (_module.__default.LowerThan_h $ly@@5 (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1)) (_module.Tree.children |t#2|) (- |n#0@@5| 1))) (_module.__default.LowerThan_h $ly@@5 (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1)) |tail#2| |n#0@@5|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@3|)) (forall ((|_k'#0@@0| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@0| |_k#0@@3|) (_module.__default.LowerThan_h $ly@@5 |_k'#0@@0| |s#0@@4| |n#0@@5|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |662|
 :pattern ( (_module.__default.LowerThan_h $ly@@5 |_k'#0@@0| |s#0@@4| |n#0@@5|))
)))))))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |664|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@5) |_k#0@@3| |s#0@@4| |n#0@@5|))
))))
(assert (forall (($ly@@6 T@U) (|_k#0@@4| T@U) (|s#0@@5| T@U) (|n#0@@6| Int) ) (! (= (_module.__default.LowerThan_h ($LS $ly@@6) |_k#0@@4| |s#0@@5| |n#0@@6|) (_module.__default.LowerThan_h $ly@@6 |_k#0@@4| |s#0@@5| |n#0@@6|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |658|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@6) |_k#0@@4| |s#0@@5| |n#0@@6|))
)))
...
(assert (forall (($ly@@7 T@U) (|n#0@@7| Int) ) (! (= (_module.__default.SkinnyFiniteTree ($LS $ly@@7) |n#0@@7|) (_module.__default.SkinnyFiniteTree $ly@@7 |n#0@@7|))
 :qid |InfiniteTreesdfy.300:16|
 :skolemid |834|
 :pattern ( (_module.__default.SkinnyFiniteTree ($LS $ly@@7) |n#0@@7|))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@8 T@U) (|n#0@@8| Int) ) (!  (=> (or (|_module.__default.SkinnyFiniteTree#canCall| |n#0@@8|) (and (< 3 $FunctionContextHeight) (<= (LitInt 0) |n#0@@8|))) (and (forall ((|k#0| Int) ) (!  (=> (<= (LitInt 0) |k#0|) (= (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children (_module.__default.SkinnyFiniteTree $ly@@8 |n#0@@8|)) |k#0|) (<= |n#0@@8| |k#0|)))
 :qid |InfiniteTreesdfy.301:18|
 :skolemid |836|
 :pattern ( (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children (_module.__default.SkinnyFiniteTree $ly@@8 |n#0@@8|)) |k#0|))
)) ($Is DatatypeTypeType (_module.__default.SkinnyFiniteTree $ly@@8 |n#0@@8|) Tclass._module.Tree)))
 :qid |InfiniteTreesdfy.300:16|
 :skolemid |837|
 :pattern ( (_module.__default.SkinnyFiniteTree $ly@@8 |n#0@@8|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@9 T@U) (|n#0@@9| Int) ) (!  (=> (or (|_module.__default.SkinnyFiniteTree#canCall| (LitInt |n#0@@9|)) (and (< 3 $FunctionContextHeight) (<= (LitInt 0) |n#0@@9|))) (and (=> (or (not (= (LitInt |n#0@@9|) (LitInt 0))) (not true)) (|_module.__default.SkinnyFiniteTree#canCall| (LitInt (- |n#0@@9| 1)))) (= (_module.__default.SkinnyFiniteTree ($LS $ly@@9) (LitInt |n#0@@9|)) (ite (= (LitInt |n#0@@9|) (LitInt 0)) (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|)) (|#_module.Tree.Node| (Lit DatatypeTypeType (|#_module.Stream.Cons| ($Box DatatypeTypeType (Lit DatatypeTypeType (_module.__default.SkinnyFiniteTree ($LS $ly@@9) (LitInt (- |n#0@@9| 1))))) (Lit DatatypeTypeType |#_module.Stream.Nil|))))))))
 :qid |InfiniteTreesdfy.300:16|
 :weight 3
 :skolemid |840|
 :pattern ( (_module.__default.SkinnyFiniteTree ($LS $ly@@9) (LitInt |n#0@@9|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@10 T@U) (|s#0@@6| T@U) (|n#0@@10| Int) ) (!  (=> (or (|_module.__default.LowerThan#canCall| |s#0@@6| |n#0@@10|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@6| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@10|)))) (and (=> (not (_module.Stream.Nil_q |s#0@@6|)) (let ((|tail#1| (_module.Stream.tail |s#0@@6|)))
(let ((|t#1| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@6|))))
 (=> (<= (LitInt 1) |n#0@@10|) (and (and (_module.Tree.Node_q |t#1|) (|_module.__default.LowerThan#canCall| (_module.Tree.children |t#1|) (- |n#0@@10| 1))) (=> (_module.__default.LowerThan $ly@@10 (_module.Tree.children |t#1|) (- |n#0@@10| 1)) (|_module.__default.LowerThan#canCall| |tail#1| |n#0@@10|))))))) (= (_module.__default.LowerThan ($LS $ly@@10) |s#0@@6| |n#0@@10|) (ite (_module.Stream.Nil_q |s#0@@6|) true (let ((|tail#0| (_module.Stream.tail |s#0@@6|)))
(let ((|t#0| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@6|))))
 (and (and (<= (LitInt 1) |n#0@@10|) (_module.__default.LowerThan $ly@@10 (_module.Tree.children |t#0|) (- |n#0@@10| 1))) (_module.__default.LowerThan $ly@@10 |tail#0| |n#0@@10|))))))))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |651|
 :pattern ( (_module.__default.LowerThan ($LS $ly@@10) |s#0@@6| |n#0@@10|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@11 T@U) (|s#0@@7| T@U) (|n#0@@11| Int) (|_k#0@@5| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |s#0@@7| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@11|)) (= |_k#0@@5| (|ORD#FromNat| 0))) (_module.__default.LowerThan_h $ly@@11 |_k#0@@5| |s#0@@7| |n#0@@11|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |655|
 :pattern ( (_module.__default.LowerThan_h $ly@@11 |_k#0@@5| |s#0@@7| |n#0@@11|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.SkinnyFiniteTree)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (forall ((|k#1| Int) ) (!  (=> (<= (LitInt 0) |k#1|) (= (_module.__default.LowerThan ($LS ($LS $LZ)) (_module.Tree.children (_module.__default.SkinnyFiniteTree ($LS ($LS $LZ)) |n#0@@12|)) |k#1|) (<= |n#0@@12| |k#1|)))
 :qid |InfiniteTreesdfy.301:18|
 :skolemid |841|
 :pattern ( (_module.__default.LowerThan ($LS ($LS $LZ)) (_module.Tree.children (_module.__default.SkinnyFiniteTree ($LS ($LS $LZ)) |n#0@@12|)) |k#1|))
)))))
(let ((anon8_Else_correct  (=> (or (not (= |n#0@@12| (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 7) (- 0 10)) ($Is intType (int_2_U (- |n#0@@12| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0@@12| 1)) Tclass._System.nat) (=> (and (= |##n#2@0| (- |n#0@@12| 1)) ($IsAlloc intType (int_2_U |##n#2@0|) Tclass._System.nat $Heap)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (or (<= 0 |n#0@@12|) (= |##n#2@0| |n#0@@12|))) (=> (or (<= 0 |n#0@@12|) (= |##n#2@0| |n#0@@12|)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (< |##n#2@0| |n#0@@12|)) (=> (< |##n#2@0| |n#0@@12|) (=> (and (|_module.__default.SkinnyFiniteTree#canCall| (- |n#0@@12| 1)) (_module.Tree.Node_q (_module.__default.SkinnyFiniteTree ($LS $LZ) (- |n#0@@12| 1)))) (=> (and (and (= (_module.__default.SkinnyFiniteTree ($LS $LZ) |n#0@@12|) (|#_module.Tree.Node| (|#_module.Stream.Cons| ($Box DatatypeTypeType (_module.__default.SkinnyFiniteTree ($LS $LZ) (- |n#0@@12| 1))) (Lit DatatypeTypeType |#_module.Stream.Nil|)))) (|_module.__default.SkinnyFiniteTree#canCall| (- |n#0@@12| 1))) (and ($Is DatatypeTypeType (_module.__default.SkinnyFiniteTree ($LS $LZ) |n#0@@12|) Tclass._module.Tree) (= (ControlFlow 0 7) 5))) GeneratedUnifiedExit_correct))))))))))))
(let ((anon8_Then_correct  (=> (and (and (= |n#0@@12| (LitInt 0)) (= (_module.__default.SkinnyFiniteTree ($LS $LZ) |n#0@@12|) (Lit DatatypeTypeType (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|))))) (and ($Is DatatypeTypeType (_module.__default.SkinnyFiniteTree ($LS $LZ) |n#0@@12|) Tclass._module.Tree) (= (ControlFlow 0 6) 5))) GeneratedUnifiedExit_correct)))
(let ((anon7_Then_correct  (=> ($Is DatatypeTypeType (_module.__default.SkinnyFiniteTree ($LS $LZ) |n#0@@12|) Tclass._module.Tree) (=> (and (<= (LitInt 0) |k#2@0|) ($IsAlloc intType (int_2_U |n#0@@12|) Tclass._System.nat $Heap)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (<= 0 |n#0@@12|) (= |n#0@@12| |n#0@@12|))) (=> (or (<= 0 |n#0@@12|) (= |n#0@@12| |n#0@@12|)) (=> (= (ControlFlow 0 2) (- 0 1)) (or (= |n#0@@12| |n#0@@12|) (< |n#0@@12| |n#0@@12|)))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |n#0@@12|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 12) 11))) anon0_correct)))
