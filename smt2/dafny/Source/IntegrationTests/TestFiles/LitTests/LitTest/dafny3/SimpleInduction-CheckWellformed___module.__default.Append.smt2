...
(declare-fun _module._default.Append$T@@5 () T@U)
...
(let ((anon10_Then_correct  (=> (and (and (= |xs#0@@5| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) ($IsBox |_mcc#0#0| _module._default.Append$T@@5)) (and ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List _module._default.Append$T@@5)) (= |let#0#0#0| |_mcc#1#0|))) (=> (and (and (and ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List _module._default.Append$T@@5)) (= |rest#Z#0@0| |let#0#0#0|)) (and (= |let#1#0#0| |_mcc#0#0|) ($IsBox |let#1#0#0| _module._default.Append$T@@5))) (and (and (= |x#Z#0@0| |let#1#0#0|) ($IsAlloc DatatypeTypeType |rest#Z#0@0| (Tclass._module.List _module._default.Append$T@@5) $Heap@@0)) (and ($IsAlloc DatatypeTypeType |ys#0@@5| (Tclass._module.List _module._default.Append$T@@5) $Heap@@0) (= (ControlFlow 0 4) (- 0 3))))) (< (DtRank |rest#Z#0@0|) (DtRank |xs#0@@5|))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is DatatypeTypeType |xs#0@@5| (Tclass._module.List _module._default.Append$T@@5)) ($Is DatatypeTypeType |ys#0@@5| (Tclass._module.List _module._default.Append$T@@5))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
