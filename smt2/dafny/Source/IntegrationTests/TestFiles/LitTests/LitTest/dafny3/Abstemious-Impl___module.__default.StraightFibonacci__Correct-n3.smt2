...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.nth$T@@1 T@U) ($ly@@3 T@U) (|n#0@@3| Int) (|s#0@@1| T@U) ) (!  (=> (or (|_module.__default.nth#canCall| _module._default.nth$T@@1 |n#0@@3| |s#0@@1|) (and (< 1 $FunctionContextHeight) (and (<= (LitInt 0) |n#0@@3|) ($Is DatatypeTypeType |s#0@@1| (Tclass._module.Stream _module._default.nth$T@@1))))) ($IsBox (_module.__default.nth _module._default.nth$T@@1 $ly@@3 |n#0@@3| |s#0@@1|) _module._default.nth$T@@1))
 :qid |unknown.0:0|
 :skolemid |726|
 :pattern ( (_module.__default.nth _module._default.nth$T@@1 $ly@@3 |n#0@@3| |s#0@@1|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.nth$T@@2 T@U) ($ly@@4 T@U) (|n#0@@4| Int) (|s#0@@2| T@U) ) (!  (=> (and (or (|_module.__default.nth#canCall| _module._default.nth$T@@2 |n#0@@4| |s#0@@2|) (and (< 1 $FunctionContextHeight) (and (<= (LitInt 0) |n#0@@4|) (and ($Is DatatypeTypeType |s#0@@2| (Tclass._module.Stream _module._default.nth$T@@2)) ($IsAlloc DatatypeTypeType |s#0@@2| (Tclass._module.Stream _module._default.nth$T@@2) $Heap))))) ($IsGoodHeap $Heap)) ($IsAllocBox (_module.__default.nth _module._default.nth$T@@2 $ly@@4 |n#0@@4| |s#0@@2|) _module._default.nth$T@@2 $Heap))
 :qid |Abstemiousdfy.126:16|
 :skolemid |727|
 :pattern ( ($IsAllocBox (_module.__default.nth _module._default.nth$T@@2 $ly@@4 |n#0@@4| |s#0@@2|) _module._default.nth$T@@2 $Heap))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@5 T@U) (|n#0@@5| Int) ) (!  (=> (or (|_module.__default.StraightFibonacci#canCall| |n#0@@5|) (and (< 1 $FunctionContextHeight) (<= (LitInt 0) |n#0@@5|))) ($Is DatatypeTypeType (_module.__default.StraightFibonacci $ly@@5 |n#0@@5|) (Tclass._module.Stream TInt)))
 :qid |Abstemiousdfy.176:16|
 :skolemid |754|
 :pattern ( (_module.__default.StraightFibonacci $ly@@5 |n#0@@5|))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@6 T@U) (|n#0@@6| Int) ) (!  (=> (or (|_module.__default.nfib#canCall| (LitInt |n#0@@6|)) (and (< 0 $FunctionContextHeight) (<= (LitInt 0) |n#0@@6|))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (< |n#0@@6| 2))))) (and (|_module.__default.nfib#canCall| (LitInt (- |n#0@@6| 2))) (|_module.__default.nfib#canCall| (LitInt (- |n#0@@6| 1))))) (= (_module.__default.nfib ($LS $ly@@6) (LitInt |n#0@@6|)) (ite (< |n#0@@6| 2) |n#0@@6| (+ (_module.__default.nfib ($LS $ly@@6) (LitInt (- |n#0@@6| 2))) (_module.__default.nfib ($LS $ly@@6) (LitInt (- |n#0@@6| 1))))))))
 :qid |Abstemiousdfy.131:16|
 :weight 3
 :skolemid |738|
 :pattern ( (_module.__default.nfib ($LS $ly@@6) (LitInt |n#0@@6|)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.nth$T@@3 T@U) ($ly@@7 T@U) (|n#0@@7| Int) (|s#0@@3| T@U) ) (!  (=> (or (|_module.__default.nth#canCall| _module._default.nth$T@@3 (LitInt |n#0@@7|) (Lit DatatypeTypeType |s#0@@3|)) (and (< 1 $FunctionContextHeight) (and (<= (LitInt 0) |n#0@@7|) ($Is DatatypeTypeType |s#0@@3| (Tclass._module.Stream _module._default.nth$T@@3))))) (and (and (=> (= (LitInt |n#0@@7|) (LitInt 0)) (_module.Stream.Cons_q (Lit DatatypeTypeType |s#0@@3|))) (=> (or (not (= (LitInt |n#0@@7|) (LitInt 0))) (not true)) (and (_module.Stream.Cons_q (Lit DatatypeTypeType |s#0@@3|)) (|_module.__default.nth#canCall| _module._default.nth$T@@3 (LitInt (- |n#0@@7| 1)) (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |s#0@@3|))))))) (= (_module.__default.nth _module._default.nth$T@@3 ($LS $ly@@7) (LitInt |n#0@@7|) (Lit DatatypeTypeType |s#0@@3|)) (ite (= (LitInt |n#0@@7|) (LitInt 0)) (_module.Stream.head (Lit DatatypeTypeType |s#0@@3|)) (_module.__default.nth _module._default.nth$T@@3 ($LS $ly@@7) (LitInt (- |n#0@@7| 1)) (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |s#0@@3|))))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |731|
 :pattern ( (_module.__default.nth _module._default.nth$T@@3 ($LS $ly@@7) (LitInt |n#0@@7|) (Lit DatatypeTypeType |s#0@@3|)))
))))
...
(assert (forall (($ly@@8 T@U) (|n#0@@8| Int) ) (! (= (_module.__default.nfib ($LS $ly@@8) |n#0@@8|) (_module.__default.nfib $ly@@8 |n#0@@8|))
 :qid |Abstemiousdfy.131:16|
 :skolemid |733|
 :pattern ( (_module.__default.nfib ($LS $ly@@8) |n#0@@8|))
)))
(assert (forall (($ly@@9 T@U) (|n#0@@9| Int) ) (! (= (_module.__default.StraightFibonacci ($LS $ly@@9) |n#0@@9|) (_module.__default.StraightFibonacci $ly@@9 |n#0@@9|))
 :qid |Abstemiousdfy.176:16|
 :skolemid |752|
 :pattern ( (_module.__default.StraightFibonacci ($LS $ly@@9) |n#0@@9|))
)))
...
(assert (forall ((_module._default.nth$T@@4 T@U) ($ly@@10 T@U) (|n#0@@10| Int) (|s#0@@4| T@U) ) (! (= (_module.__default.nth _module._default.nth$T@@4 ($LS $ly@@10) |n#0@@10| |s#0@@4|) (_module.__default.nth _module._default.nth$T@@4 $ly@@10 |n#0@@10| |s#0@@4|))
 :qid |unknown.0:0|
 :skolemid |724|
 :pattern ( (_module.__default.nth _module._default.nth$T@@4 ($LS $ly@@10) |n#0@@10| |s#0@@4|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@11 T@U) (|n#0@@11| Int) ) (!  (=> (or (|_module.__default.StraightFibonacci#canCall| |n#0@@11|) (and (< 1 $FunctionContextHeight) (<= (LitInt 0) |n#0@@11|))) (and (and (|_module.__default.nfib#canCall| |n#0@@11|) (|_module.__default.StraightFibonacci#canCall| (+ |n#0@@11| 1))) (= (_module.__default.StraightFibonacci ($LS $ly@@11) |n#0@@11|) (|#_module.Stream.Cons| ($Box intType (int_2_U (_module.__default.nfib ($LS $LZ) |n#0@@11|))) (_module.__default.StraightFibonacci $ly@@11 (+ |n#0@@11| 1))))))
 :qid |Abstemiousdfy.176:16|
 :skolemid |756|
 :pattern ( (_module.__default.StraightFibonacci ($LS $ly@@11) |n#0@@11|))
))))
...
(declare-fun |n#0@@12| () Int)
(declare-fun |k#0| () Int)
(set-info :boogie-vc-id Impl$$_module.__default.StraightFibonacci__Correct)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@0 $Heap@0)) (and (forall ((|$ih#n0#0| Int) (|$ih#k0#0| Int) ) (!  (=> (and (and (and (<= (LitInt 0) |$ih#n0#0|) (<= (LitInt 0) |$ih#k0#0|)) (U_2_bool (Lit boolType (bool_2_U true)))) (or (and (<= 0 |$ih#n0#0|) (< |$ih#n0#0| |n#0@@12|)) (and (= |$ih#n0#0| |n#0@@12|) (and (<= 0 |$ih#k0#0|) (< |$ih#k0#0| |k#0|))))) (= (U_2_int ($Unbox intType (_module.__default.nth TInt ($LS $LZ) |$ih#n0#0| (_module.__default.StraightFibonacci ($LS $LZ) |$ih#k0#0|)))) (_module.__default.nfib ($LS $LZ) (+ |$ih#k0#0| |$ih#n0#0|))))
 :qid |Abstemiousdfy.181:33|
 :skolemid |759|
 :pattern ( ($Unbox intType (_module.__default.nth TInt ($LS $LZ) |$ih#n0#0| (_module.__default.StraightFibonacci ($LS $LZ) |$ih#k0#0|))))
)) (= (ControlFlow 0 2) (- 0 1)))) (= (U_2_int ($Unbox intType (_module.__default.nth TInt ($LS ($LS $LZ)) |n#0@@12| (_module.__default.StraightFibonacci ($LS ($LS $LZ)) |k#0|)))) (_module.__default.nfib ($LS ($LS $LZ)) (+ |k#0| |n#0@@12|)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (<= (LitInt 0) |n#0@@12|) (<= (LitInt 0) |k#0|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
