...
(declare-fun |ch#Z#0@0| () T@U)
(declare-fun |##t#0@0| () T@U)
(declare-fun $Heap@@0 () T@U)
(declare-fun |tail#0@@4| () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun |tChildren#0| () T@U)
(declare-fun |n#0@@9| () Int)
(declare-fun |let#0#0#0| () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Path__Lemma0_k_k)
...
(let ((anon4_Else_correct  (=> (and (not (_module.Stream.Cons_q |ch#Z#0@0|)) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon4_Then_correct  (=> (_module.Stream.Cons_q |ch#Z#0@0|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (_module.Stream.Cons_q |ch#Z#0@0|)) (=> (_module.Stream.Cons_q |ch#Z#0@0|) (=> (= |##t#0@0| ($Unbox DatatypeTypeType (_module.Stream.head |ch#Z#0@0|))) (=> (and (and ($IsAlloc DatatypeTypeType |##t#0@0| Tclass._module.Tree $Heap@@0) ($IsAlloc DatatypeTypeType |tail#0@@4| (Tclass._module.Stream TInt) $Heap@@0)) (and (|_module.__default.ValidPath#canCall| ($Unbox DatatypeTypeType (_module.Stream.head |ch#Z#0@0|)) |tail#0@@4|) (= (ControlFlow 0 2) 1))) anon3_correct)))))))
(let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) ($IsAlloc DatatypeTypeType |tChildren#0| (Tclass._module.Stream Tclass._module.Tree) $Heap@@0)) (and ($IsAlloc intType (int_2_U |n#0@@9|) Tclass._System.nat $Heap@@0) (|_module.__default.Tail#canCall| Tclass._module.Tree |tChildren#0| |n#0@@9|))) (and (and (= |let#0#0#0| (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |tChildren#0| |n#0@@9|)) (|_module.__default.Tail#canCall| Tclass._module.Tree |tChildren#0| |n#0@@9|)) (and ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.Stream Tclass._module.Tree)) (= |ch#Z#0@0| |let#0#0#0|)))) (and (=> (= (ControlFlow 0 5) 2) anon4_Then_correct) (=> (= (ControlFlow 0 5) 4) anon4_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (and ($Is DatatypeTypeType |tChildren#0| (Tclass._module.Stream Tclass._module.Tree)) ($IsAlloc DatatypeTypeType |tChildren#0| (Tclass._module.Stream Tclass._module.Tree) $Heap@@0)) (|$IsA#_module.Stream| |tChildren#0|)) (<= (LitInt 0) |n#0@@9|)) (and (and (and ($Is DatatypeTypeType |tail#0@@4| (Tclass._module.Stream TInt)) ($IsAlloc DatatypeTypeType |tail#0@@4| (Tclass._module.Stream TInt) $Heap@@0)) (|$IsA#_module.Stream| |tail#0@@4|)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 6) 5)))) anon0_correct))))
