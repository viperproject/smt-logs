...
(declare-fun _module.__default.NatBigStep_h (T@U Int T@U Int Int) Bool)
(declare-fun $LS (T@U) T@U)
(declare-fun LitInt (Int) Int)
(declare-fun |_module.__default.NatBigStep_h#canCall| (Int T@U Int Int) Bool)
...
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.BadNatMonotonic0_h)
...
(let ((anon3_Else_correct  (=> (and (<= |_k#0@@4| 0) (= (ControlFlow 0 4) 2)) GeneratedUnifiedExit_correct)))
(let ((anon3_Then_correct  (=> (and (< 0 |_k#0@@4|) (= (ControlFlow 0 3) 2)) GeneratedUnifiedExit_correct)))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.cmd| |c#1|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#_k0#0| Int) (|$ih#c0#0| T@U) (|$ih#s0#0| Int) (|$ih#t0#0| Int) ) (!  (=> (and (and (and (<= (LitInt 0) |$ih#_k0#0|) ($Is DatatypeTypeType |$ih#c0#0| Tclass._module.cmd)) (_module.__default.NatBigStep_h ($LS $LZ) |$ih#_k0#0| |$ih#c0#0| |$ih#s0#0| |$ih#t0#0|)) (or (and (<= 0 |$ih#_k0#0|) (< |$ih#_k0#0| |_k#0@@4|)) (and (= |$ih#_k0#0| |_k#0@@4|) (or (< (DtRank |$ih#c0#0|) (DtRank |c#1|)) (and (= (DtRank |$ih#c0#0|) (DtRank |c#1|)) (or (and (<= 0 |$ih#s0#0|) (< |$ih#s0#0| |s#1|)) (and (= |$ih#s0#0| |s#1|) (and (<= 0 |$ih#t0#0|) (< |$ih#t0#0| |t#1|))))))))) (= |$ih#s0#0| |$ih#t0#0|))
 :qid |Incdfy.208:13|
 :skolemid |980|
 :pattern ( (_module.__default.NatBigStep_h ($LS $LZ) |$ih#_k0#0| |$ih#c0#0| |$ih#s0#0| |$ih#t0#0|))
