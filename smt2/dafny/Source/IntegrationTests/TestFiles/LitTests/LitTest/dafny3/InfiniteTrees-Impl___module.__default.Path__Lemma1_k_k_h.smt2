...
(assert (forall ((d@@16 T@U) ) (!  (=> (|$IsA#_module.Number| d@@16) (or (_module.Number.Succ_q d@@16) (_module.Number.Zero_q d@@16)))
 :qid |unknown.0:0|
 :skolemid |1231|
 :pattern ( (|$IsA#_module.Number| d@@16))
)))
...
(declare-fun $Heap@@0 () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.Path__Lemma1_k_k_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 68) (let ((anon8_correct  (=> (and (|_module.__default.Tail#canCall| Tclass._module.Tree |s#1| |n#1|) (=> (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|)) (and (and (|_module.__default.Tail#canCall| Tclass._module.Tree |s#1| |n#1|) (|_module.__default.N2S#canCall| |r#6@0|)) (|_module.__default.ValidPath_h#canCall| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|))))) (=> (and (and (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|)) (_module.__default.ValidPath_h ($LS $LZ) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|))) (and ($IsAlloc BoxType |_k#0@@18| TORDINAL $Heap@0) (= |##t#5@0| (|#_module.Tree.Node| |s#1|)))) (=> (and (and (and ($IsAlloc DatatypeTypeType |##t#5@0| Tclass._module.Tree $Heap@0) ($IsAlloc DatatypeTypeType |r#6@0| (Tclass._module.CoOption Tclass._module.Number) $Heap@0)) (and (|_module.__default.N2S#canCall| |r#6@0|) (= |##p#5@0| (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|))))) (and (and ($IsAlloc DatatypeTypeType |##p#5@0| (Tclass._module.Stream TInt) $Heap@0) (|_module.__default.ValidPath_h#canCall| |_k#0@@18| (|#_module.Tree.Node| |s#1|) (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|)))) (and (|_module.__default.N2S#canCall| |r#6@0|) (|_module.__default.ValidPath_h#canCall| |_k#0@@18| (|#_module.Tree.Node| |s#1|) (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|)))))) (and (=> (= (ControlFlow 0 56) (- 0 60)) (=> (and (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|)) (_module.__default.ValidPath_h ($LS $LZ) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|))) (=> (|_module.__default.ValidPath_h#canCall| |_k#0@@18| (|#_module.Tree.Node| |s#1|) (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|))) (or (_module.__default.ValidPath_h ($LS $LZ) |_k#0@@18| (|#_module.Tree.Node| |s#1|) (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|))) (=> (< 0 (|ORD#Offset| |_k#0@@18|)) (=> (_module.Stream.Nil_q (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|))) (|_module.Tree#Equal| (|#_module.Tree.Node| |s#1|) (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|))))))))) (and (=> (= (ControlFlow 0 56) (- 0 59)) (=> (and (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|)) (_module.__default.ValidPath_h ($LS $LZ) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|))) (=> (|_module.__default.ValidPath_h#canCall| |_k#0@@18| (|#_module.Tree.Node| |s#1|) (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|))) (or (_module.__default.ValidPath_h ($LS $LZ) |_k#0@@18| (|#_module.Tree.Node| |s#1|) (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|))) (=> (< 0 (|ORD#Offset| |_k#0@@18|)) (=> (not (_module.Stream.Nil_q (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|)))) (let ((|index#10@@0| (U_2_int ($Unbox intType (_module.Stream.head (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS ($LS $LZ)) |r#6@0|)))))))
(<= (LitInt 0) |index#10@@0|)))))))) (and (=> (= (ControlFlow 0 56) (- 0 58)) (=> (and (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|)) (_module.__default.ValidPath_h ($LS $LZ) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|))) (=> (|_module.__default.ValidPath_h#canCall| |_k#0@@18| (|#_module.Tree.Node| |s#1|) (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|))) (or (_module.__default.ValidPath_h ($LS $LZ) |_k#0@@18| (|#_module.Tree.Node| |s#1|) (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|))) (=> (< 0 (|ORD#Offset| |_k#0@@18|)) (=> (not (_module.Stream.Nil_q (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|)))) (let ((|index#10@@1| (U_2_int ($Unbox intType (_module.Stream.head (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS ($LS $LZ)) |r#6@0|)))))))
(let ((|ch#10@@0| (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) (_module.Tree.children (|#_module.Tree.Node| |s#1|)) |index#10@@1|)))
(_module.Stream.Cons_q |ch#10@@0|))))))))) (and (=> (= (ControlFlow 0 56) (- 0 57)) (=> (and (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|)) (_module.__default.ValidPath_h ($LS $LZ) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|))) (=> (|_module.__default.ValidPath_h#canCall| |_k#0@@18| (|#_module.Tree.Node| |s#1|) (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|))) (or (_module.__default.ValidPath_h ($LS $LZ) |_k#0@@18| (|#_module.Tree.Node| |s#1|) (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|))) (=> (< 0 (|ORD#Offset| |_k#0@@18|)) (=> (not (_module.Stream.Nil_q (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|)))) (let ((|tail#10@@0| (_module.Stream.tail (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS ($LS $LZ)) |r#6@0|)))))
(let ((|index#10@@2| (U_2_int ($Unbox intType (_module.Stream.head (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS ($LS $LZ)) |r#6@0|)))))))
(let ((|ch#10@@1| (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) (_module.Tree.children (|#_module.Tree.Node| |s#1|)) |index#10@@2|)))
(_module.__default.ValidPath_h ($LS ($LS $LZ)) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head |ch#10@@1|)) |tail#10@@0|)))))))))) (=> (= (ControlFlow 0 56) (- 0 55)) (=> (and (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|)) (_module.__default.ValidPath_h ($LS $LZ) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|))) (=> (|_module.__default.ValidPath_h#canCall| |_k#0@@18| (|#_module.Tree.Node| |s#1|) (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|))) (or (_module.__default.ValidPath_h ($LS $LZ) |_k#0@@18| (|#_module.Tree.Node| |s#1|) (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@18|)) (forall ((|_k'#4| T@U) ) (!  (=> (|ORD#Less| |_k'#4| |_k#0@@18|) (_module.__default.ValidPath_h ($LS ($LS $LZ)) |_k'#4| (|#_module.Tree.Node| |s#1|) (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS ($LS $LZ)) |r#6@0|))))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |1084|
 :pattern ( (_module.__default.ValidPath_h ($LS ($LS $LZ)) |_k'#4| (|#_module.Tree.Node| |s#1|) (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS ($LS $LZ)) |r#6@0|))))
))))))))))))))))
(let ((anon22_Else_correct  (=> (and (not (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (= (ControlFlow 0 62) 56)) anon8_correct)))
(let ((anon22_Then_correct  (=> (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|)) (=> (and (and (and (and (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@18|))) (and (= |##_k#3@0| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1))) ($IsAlloc BoxType |##_k#3@0| TORDINAL $Heap@0))) (and (and ($IsAlloc DatatypeTypeType |s#1| (Tclass._module.Stream Tclass._module.Tree) $Heap@0) ($IsAlloc intType (int_2_U |n#1|) Tclass._System.nat $Heap@0)) (and (|_module.__default.Tail#canCall| Tclass._module.Tree |s#1| |n#1|) (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))))) (and (and (and (= |##t#4@0| ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|)))) ($IsAlloc DatatypeTypeType |##t#4@0| Tclass._module.Tree $Heap@0)) (and ($IsAlloc DatatypeTypeType |r#6@0| (Tclass._module.CoOption Tclass._module.Number) $Heap@0) (|_module.__default.N2S#canCall| |r#6@0|))) (and (and (= |##p#4@0| (_module.__default.N2S ($LS $LZ) |r#6@0|)) ($IsAlloc DatatypeTypeType |##p#4@0| (Tclass._module.Stream TInt) $Heap@0)) (and (|_module.__default.ValidPath_h#canCall| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (= (ControlFlow 0 61) 56))))) anon8_correct))))
(let ((anon21_Then_correct  (=> ($IsAlloc DatatypeTypeType |s#1| (Tclass._module.Stream Tclass._module.Tree) $Heap@0) (=> (and ($IsAlloc intType (int_2_U |n#1|) Tclass._System.nat $Heap@0) (|_module.__default.Tail#canCall| Tclass._module.Tree |s#1| |n#1|)) (and (=> (= (ControlFlow 0 63) 61) anon22_Then_correct) (=> (= (ControlFlow 0 63) 62) anon22_Else_correct))))))
(let ((anon11_correct  (=> (and (|_module.__default.Tail#canCall| Tclass._module.Tree |s#1| |n#1|) (=> (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|)) (and (and (|_module.__default.Tail#canCall| Tclass._module.Tree |s#1| |n#1|) (|_module.__default.N2S#canCall| |r#6@0|)) (|_module.__default.ValidPath_h#canCall| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|))))) (and (=> (= (ControlFlow 0 42) (- 0 47)) (=> (_module.__default.ValidPath_h ($LS $LZ) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) |s#1| |n#1|)))) (and (=> (= (ControlFlow 0 42) (- 0 46)) (=> (_module.__default.ValidPath_h ($LS $LZ) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (=> (|_module.__default.ValidPath_h#canCall| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (or (_module.__default.ValidPath_h ($LS $LZ) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (=> (< 0 (|ORD#Offset| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)))) (=> (_module.Stream.Nil_q (_module.__default.N2S ($LS $LZ) |r#6@0|)) (|_module.Tree#Equal| ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) |s#1| |n#1|))) (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|))))))))) (and (=> (= (ControlFlow 0 42) (- 0 45)) (=> (_module.__default.ValidPath_h ($LS $LZ) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (=> (|_module.__default.ValidPath_h#canCall| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (or (_module.__default.ValidPath_h ($LS $LZ) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (=> (< 0 (|ORD#Offset| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)))) (=> (not (_module.Stream.Nil_q (_module.__default.N2S ($LS $LZ) |r#6@0|))) (let ((|index#8@@0| (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.N2S ($LS ($LS $LZ)) |r#6@0|))))))
(<= (LitInt 0) |index#8@@0|)))))))) (and (=> (= (ControlFlow 0 42) (- 0 44)) (=> (_module.__default.ValidPath_h ($LS $LZ) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (=> (|_module.__default.ValidPath_h#canCall| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (or (_module.__default.ValidPath_h ($LS $LZ) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (=> (< 0 (|ORD#Offset| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)))) (=> (not (_module.Stream.Nil_q (_module.__default.N2S ($LS $LZ) |r#6@0|))) (let ((|index#8@@1| (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.N2S ($LS ($LS $LZ)) |r#6@0|))))))
(let ((|ch#8@@0| (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) (_module.Tree.children ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) |s#1| |n#1|)))) |index#8@@1|)))
(_module.Stream.Cons_q |ch#8@@0|))))))))) (and (=> (= (ControlFlow 0 42) (- 0 43)) (=> (_module.__default.ValidPath_h ($LS $LZ) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (=> (|_module.__default.ValidPath_h#canCall| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (or (_module.__default.ValidPath_h ($LS $LZ) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (=> (< 0 (|ORD#Offset| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)))) (=> (not (_module.Stream.Nil_q (_module.__default.N2S ($LS $LZ) |r#6@0|))) (let ((|tail#8@@0| (_module.Stream.tail (_module.__default.N2S ($LS ($LS $LZ)) |r#6@0|))))
(let ((|index#8@@2| (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.N2S ($LS ($LS $LZ)) |r#6@0|))))))
(let ((|ch#8@@1| (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) (_module.Tree.children ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) |s#1| |n#1|)))) |index#8@@2|)))
(_module.__default.ValidPath_h ($LS ($LS $LZ)) (|ORD#Minus| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head |ch#8@@1|)) |tail#8@@0|)))))))))) (=> (= (ControlFlow 0 42) (- 0 41)) (=> (_module.__default.ValidPath_h ($LS $LZ) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (=> (|_module.__default.ValidPath_h#canCall| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (or (_module.__default.ValidPath_h ($LS $LZ) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (=> (= (LitInt 0) (|ORD#Offset| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)))) (forall ((|_k'#3| T@U) ) (!  (=> (|ORD#Less| |_k'#3| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1))) (_module.__default.ValidPath_h ($LS ($LS $LZ)) |_k'#3| ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) |s#1| |n#1|))) (_module.__default.N2S ($LS ($LS $LZ)) |r#6@0|)))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |1081|
 :pattern ( (_module.__default.ValidPath_h ($LS ($LS $LZ)) |_k'#3| ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) |s#1| |n#1|))) (_module.__default.N2S ($LS ($LS $LZ)) |r#6@0|)))
)))))))))))))))
(let ((anon24_Else_correct  (=> (and (not (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (= (ControlFlow 0 52) 42)) anon11_correct)))
(let ((anon24_Then_correct  (=> (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|)) (and (=> (= (ControlFlow 0 48) (- 0 51)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 48) (- 0 50)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@18|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@18|)) (=> (= |##_k#2@0| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1))) (=> (and (and ($IsAlloc BoxType |##_k#2@0| TORDINAL $Heap@0) ($IsAlloc DatatypeTypeType |s#1| (Tclass._module.Stream Tclass._module.Tree) $Heap@0)) (and ($IsAlloc intType (int_2_U |n#1|) Tclass._System.nat $Heap@0) (|_module.__default.Tail#canCall| Tclass._module.Tree |s#1| |n#1|))) (and (=> (= (ControlFlow 0 48) (- 0 49)) (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (=> (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|)) (=> (and (and (and (= |##t#3@0| ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|)))) ($IsAlloc DatatypeTypeType |##t#3@0| Tclass._module.Tree $Heap@0)) (and ($IsAlloc DatatypeTypeType |r#6@0| (Tclass._module.CoOption Tclass._module.Number) $Heap@0) (|_module.__default.N2S#canCall| |r#6@0|))) (and (and (= |##p#3@0| (_module.__default.N2S ($LS $LZ) |r#6@0|)) ($IsAlloc DatatypeTypeType |##p#3@0| (Tclass._module.Stream TInt) $Heap@0)) (and (|_module.__default.ValidPath_h#canCall| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (= (ControlFlow 0 48) 42)))) anon11_correct))))))))))))
(let ((anon23_Then_correct  (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (=> (and (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@18|)) (= |##_k#1@0| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)))) (=> (and (and ($IsAlloc BoxType |##_k#1@0| TORDINAL $Heap@0) ($IsAlloc DatatypeTypeType |s#1| (Tclass._module.Stream Tclass._module.Tree) $Heap@0)) (and ($IsAlloc intType (int_2_U |n#1|) Tclass._System.nat $Heap@0) (|_module.__default.Tail#canCall| Tclass._module.Tree |s#1| |n#1|))) (=> (and (and (and (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|)) (= |##t#2@0| ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))))) (and ($IsAlloc DatatypeTypeType |##t#2@0| Tclass._module.Tree $Heap@0) ($IsAlloc DatatypeTypeType |r#6@0| (Tclass._module.CoOption Tclass._module.Number) $Heap@0))) (and (and (|_module.__default.N2S#canCall| |r#6@0|) (= |##p#2@0| (_module.__default.N2S ($LS $LZ) |r#6@0|))) (and ($IsAlloc DatatypeTypeType |##p#2@0| (Tclass._module.Stream TInt) $Heap@0) (|_module.__default.ValidPath_h#canCall| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|))))) (=> (and (and (and (and (|_module.__default.Tail#canCall| Tclass._module.Tree |s#1| |n#1|) (|_module.__default.N2S#canCall| |r#6@0|)) (|_module.__default.ValidPath_h#canCall| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|))) (_module.__default.ValidPath_h ($LS $LZ) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|))) (and (and ($IsAlloc DatatypeTypeType |s#1| (Tclass._module.Stream Tclass._module.Tree) $Heap@0) ($IsAlloc intType (int_2_U |n#1|) Tclass._System.nat $Heap@0)) (and (|_module.__default.Tail#canCall| Tclass._module.Tree |s#1| |n#1|) (|_module.__default.Tail#canCall| Tclass._module.Tree |s#1| |n#1|)))) (and (=> (= (ControlFlow 0 53) (- 0 54)) (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) |s#1| |n#1|))) (=> (and (and (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|)) ($IsAlloc DatatypeTypeType |s#1| (Tclass._module.Stream Tclass._module.Tree) $Heap@0)) (and ($IsAlloc intType (int_2_U |n#1|) Tclass._System.nat $Heap@0) (|_module.__default.Tail#canCall| Tclass._module.Tree |s#1| |n#1|))) (and (=> (= (ControlFlow 0 53) 48) anon24_Then_correct) (=> (= (ControlFlow 0 53) 52) anon24_Else_correct)))))))))))
(let ((anon25_Then_correct  (and (=> (= (ControlFlow 0 25) (- 0 39)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 25) (- 0 38)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@18|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@18|)) (=> (and (and (= |_k##0@0| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1))) ($IsAlloc DatatypeTypeType |s#1| (Tclass._module.Stream Tclass._module.Tree) $Heap@0)) (and ($IsAlloc intType (int_2_U |n#1|) Tclass._System.nat $Heap@0) (|_module.__default.Tail#canCall| Tclass._module.Tree |s#1| |n#1|))) (and (=> (= (ControlFlow 0 25) (- 0 37)) (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (=> (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|)) (=> (and (|_module.__default.Tail#canCall| Tclass._module.Tree |s#1| |n#1|) (= |t##0@0| ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))))) (and (=> (= (ControlFlow 0 25) (- 0 36)) (or (or (<= 0 (LitInt 0)) (|ORD#Less| |_k##0@0| |_k#0@@18|)) (= (LitInt 1) (LitInt 0)))) (=> (or (or (<= 0 (LitInt 0)) (|ORD#Less| |_k##0@0| |_k#0@@18|)) (= (LitInt 1) (LitInt 0))) (and (=> (= (ControlFlow 0 25) (- 0 35)) (or (|ORD#Less| |_k##0@0| |_k#0@@18|) (and (= |_k##0@0| |_k#0@@18|) (< (LitInt 1) (LitInt 0))))) (=> (or (|ORD#Less| |_k##0@0| |_k#0@@18|) (and (= |_k##0@0| |_k#0@@18|) (< (LitInt 1) (LitInt 0)))) (and (=> (= (ControlFlow 0 25) (- 0 34)) (=> (|_module.__default.ValidPath__Alt#canCall| |t##0@0| |r#6@0|) (or (_module.__default.ValidPath__Alt ($LS $LZ) |t##0@0| |r#6@0|) (=> (_module.CoOption.None_q |r#6@0|) (|_module.Tree#Equal| |t##0@0| (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|))))))) (=> (=> (|_module.__default.ValidPath__Alt#canCall| |t##0@0| |r#6@0|) (or (_module.__default.ValidPath__Alt ($LS $LZ) |t##0@0| |r#6@0|) (=> (_module.CoOption.None_q |r#6@0|) (|_module.Tree#Equal| |t##0@0| (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|)))))) (and (=> (= (ControlFlow 0 25) (- 0 33)) (=> (|_module.__default.ValidPath__Alt#canCall| |t##0@0| |r#6@0|) (or (_module.__default.ValidPath__Alt ($LS $LZ) |t##0@0| |r#6@0|) (=> (not (_module.CoOption.None_q |r#6@0|)) (let ((|num#2@@0| ($Unbox DatatypeTypeType (_module.CoOption.get |r#6@0|))))
(_module.__default.ValidPath__Alt_k ($LS ($LS $LZ)) (_module.Tree.children |t##0@0|) |num#2@@0|)))))) (=> (=> (|_module.__default.ValidPath__Alt#canCall| |t##0@0| |r#6@0|) (or (_module.__default.ValidPath__Alt ($LS $LZ) |t##0@0| |r#6@0|) (=> (not (_module.CoOption.None_q |r#6@0|)) (let ((|num#2@@1| ($Unbox DatatypeTypeType (_module.CoOption.get |r#6@0|))))
(_module.__default.ValidPath__Alt_k ($LS ($LS $LZ)) (_module.Tree.children |t##0@0|) |num#2@@1|))))) (=> (and (and (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (and (|_module.__default.N2S#canCall| |r#6@0|) (|_module.__default.ValidPath_h#canCall| |_k##0@0| |t##0@0| (_module.__default.N2S ($LS $LZ) |r#6@0|)))) (and (and (|_module.__default.ValidPath_h#canCall| |_k##0@0| |t##0@0| (_module.__default.N2S ($LS $LZ) |r#6@0|)) (and (_module.__default.ValidPath_h ($LS $LZ) |_k##0@0| |t##0@0| (_module.__default.N2S ($LS $LZ) |r#6@0|)) (and (=> (< 0 (|ORD#Offset| |_k##0@0|)) (ite (_module.Stream.Nil_q (_module.__default.N2S ($LS $LZ) |r#6@0|)) (|_module.Tree#Equal| |t##0@0| (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|))) (let ((|tail#3@@0| (_module.Stream.tail (_module.__default.N2S ($LS $LZ) |r#6@0|))))
(let ((|index#3@@0| (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.N2S ($LS $LZ) |r#6@0|))))))
 (and (<= (LitInt 0) |index#3@@0|) (let ((|ch#3@@0| (_module.__default.Tail Tclass._module.Tree ($LS $LZ) (_module.Tree.children |t##0@0|) |index#3@@0|)))
 (and (_module.Stream.Cons_q |ch#3@@0|) (_module.__default.ValidPath_h ($LS $LZ) (|ORD#Minus| |_k##0@0| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head |ch#3@@0|)) |tail#3@@0|)))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k##0@0|)) (forall ((|_k'#0@@5| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@5| |_k##0@0|) (_module.__default.ValidPath_h ($LS $LZ) |_k'#0@@5| |t##0@0| (_module.__default.N2S ($LS $LZ) |r#6@0|)))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |1054|
 :pattern ( (_module.__default.ValidPath_h ($LS $LZ) |_k'#0@@5| |t##0@0| (_module.__default.N2S ($LS $LZ) |r#6@0|)))
)))))) (= $Heap@0 $Heap@3))) (and (=> (= (ControlFlow 0 25) (- 0 32)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 25) (- 0 31)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@18|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@18|)) (=> (= |##_k#0@0| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1))) (=> (and (and ($IsAlloc BoxType |##_k#0@0| TORDINAL $Heap@3) ($IsAlloc DatatypeTypeType |s#1| (Tclass._module.Stream Tclass._module.Tree) $Heap@3)) (and ($IsAlloc intType (int_2_U |n#1|) Tclass._System.nat $Heap@3) (|_module.__default.Tail#canCall| Tclass._module.Tree |s#1| |n#1|))) (and (=> (= (ControlFlow 0 25) (- 0 30)) (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (=> (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|)) (=> (= |##t#1@0| ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|)))) (=> (and ($IsAlloc DatatypeTypeType |##t#1@0| Tclass._module.Tree $Heap@3) ($IsAlloc DatatypeTypeType |r#6@0| (Tclass._module.CoOption Tclass._module.Number) $Heap@3)) (=> (and (and (and (|_module.__default.N2S#canCall| |r#6@0|) (= |##p#1@0| (_module.__default.N2S ($LS $LZ) |r#6@0|))) (and ($IsAlloc DatatypeTypeType |##p#1@0| (Tclass._module.Stream TInt) $Heap@3) (|_module.__default.ValidPath_h#canCall| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)))) (and (and (|_module.__default.Tail#canCall| Tclass._module.Tree |s#1| |n#1|) (|_module.__default.N2S#canCall| |r#6@0|)) (|_module.__default.ValidPath_h#canCall| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)))) (and (=> (= (ControlFlow 0 25) (- 0 29)) (=> (U_2_bool (Lit boolType (bool_2_U true))) (=> (|_module.__default.ValidPath_h#canCall| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (or (_module.__default.ValidPath_h ($LS $LZ) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (=> (< 0 (|ORD#Offset| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)))) (=> (_module.Stream.Nil_q (_module.__default.N2S ($LS $LZ) |r#6@0|)) (|_module.Tree#Equal| ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) |s#1| |n#1|))) (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|))))))))) (and (=> (= (ControlFlow 0 25) (- 0 28)) (=> (U_2_bool (Lit boolType (bool_2_U true))) (=> (|_module.__default.ValidPath_h#canCall| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (or (_module.__default.ValidPath_h ($LS $LZ) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (=> (< 0 (|ORD#Offset| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)))) (=> (not (_module.Stream.Nil_q (_module.__default.N2S ($LS $LZ) |r#6@0|))) (let ((|index#6@@0| (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.N2S ($LS ($LS $LZ)) |r#6@0|))))))
(<= (LitInt 0) |index#6@@0|)))))))) (and (=> (= (ControlFlow 0 25) (- 0 27)) (=> (U_2_bool (Lit boolType (bool_2_U true))) (=> (|_module.__default.ValidPath_h#canCall| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (or (_module.__default.ValidPath_h ($LS $LZ) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (=> (< 0 (|ORD#Offset| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)))) (=> (not (_module.Stream.Nil_q (_module.__default.N2S ($LS $LZ) |r#6@0|))) (let ((|index#6@@1| (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.N2S ($LS ($LS $LZ)) |r#6@0|))))))
(let ((|ch#6@@0| (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) (_module.Tree.children ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) |s#1| |n#1|)))) |index#6@@1|)))
(_module.Stream.Cons_q |ch#6@@0|))))))))) (and (=> (= (ControlFlow 0 25) (- 0 26)) (=> (U_2_bool (Lit boolType (bool_2_U true))) (=> (|_module.__default.ValidPath_h#canCall| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (or (_module.__default.ValidPath_h ($LS $LZ) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (=> (< 0 (|ORD#Offset| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)))) (=> (not (_module.Stream.Nil_q (_module.__default.N2S ($LS $LZ) |r#6@0|))) (let ((|tail#6@@0| (_module.Stream.tail (_module.__default.N2S ($LS ($LS $LZ)) |r#6@0|))))
(let ((|index#6@@2| (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.N2S ($LS ($LS $LZ)) |r#6@0|))))))
(let ((|ch#6@@1| (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) (_module.Tree.children ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) |s#1| |n#1|)))) |index#6@@2|)))
(_module.__default.ValidPath_h ($LS ($LS $LZ)) (|ORD#Minus| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head |ch#6@@1|)) |tail#6@@0|)))))))))) (=> (= (ControlFlow 0 25) (- 0 24)) (=> (U_2_bool (Lit boolType (bool_2_U true))) (=> (|_module.__default.ValidPath_h#canCall| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (or (_module.__default.ValidPath_h ($LS $LZ) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) (_module.__default.N2S ($LS $LZ) |r#6@0|)) (=> (= (LitInt 0) (|ORD#Offset| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)))) (forall ((|_k'#2@@5| T@U) ) (!  (=> (|ORD#Less| |_k'#2@@5| (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1))) (_module.__default.ValidPath_h ($LS ($LS $LZ)) |_k'#2@@5| ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) |s#1| |n#1|))) (_module.__default.N2S ($LS ($LS $LZ)) |r#6@0|)))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |1078|
 :pattern ( (_module.__default.ValidPath_h ($LS ($LS $LZ)) |_k'#2@@5| ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) |s#1| |n#1|))) (_module.__default.N2S ($LS ($LS $LZ)) |r#6@0|)))
)))))))))))))))))))))))))))))))))))))))))
(let ((anon20_Then_correct  (=> (and ($IsAlloc BoxType |_k#0@@18| TORDINAL $Heap@0) (= |##t#6@0| (|#_module.Tree.Node| |s#1|))) (=> (and (and ($IsAlloc DatatypeTypeType |##t#6@0| Tclass._module.Tree $Heap@0) ($IsAlloc DatatypeTypeType |r#6@0| (Tclass._module.CoOption Tclass._module.Number) $Heap@0)) (and (|_module.__default.N2S#canCall| |r#6@0|) (= |##p#6@0| (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|))))) (=> (and (and (and (and ($IsAlloc DatatypeTypeType |##p#6@0| (Tclass._module.Stream TInt) $Heap@0) (|_module.__default.ValidPath_h#canCall| |_k#0@@18| (|#_module.Tree.Node| |s#1|) (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|)))) (and (|_module.__default.N2S#canCall| |r#6@0|) (|_module.__default.ValidPath_h#canCall| |_k#0@@18| (|#_module.Tree.Node| |s#1|) (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|))))) (and (and (_module.__default.ValidPath_h ($LS $LZ) |_k#0@@18| (|#_module.Tree.Node| |s#1|) (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|))) ($IsAlloc BoxType |_k#0@@18| TORDINAL $Heap@0)) (and (= |##t#7@0| (|#_module.Tree.Node| |s#1|)) ($IsAlloc DatatypeTypeType |##t#7@0| Tclass._module.Tree $Heap@0)))) (and (and (and ($IsAlloc intType (int_2_U |n#1|) Tclass._System.nat $Heap@0) ($IsAlloc DatatypeTypeType |num#1@@1| Tclass._module.Number $Heap@0)) (and (|_module.__default.N2S_k#canCall| |n#1| |num#1@@1|) (= |##p#7@0| (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)))) (and (and ($IsAlloc DatatypeTypeType |##p#7@0| (Tclass._module.Stream TInt) $Heap@0) (|_module.__default.ValidPath_h#canCall| |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|))) (and (|_module.__default.N2S_k#canCall| |n#1| |num#1@@1|) (|_module.__default.ValidPath_h#canCall| |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)))))) (and (=> (= (ControlFlow 0 19) (- 0 23)) (=> (_module.__default.ValidPath_h ($LS $LZ) |_k#0@@18| (|#_module.Tree.Node| |s#1|) (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|))) (=> (|_module.__default.ValidPath_h#canCall| |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (or (_module.__default.ValidPath_h ($LS $LZ) |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (=> (< 0 (|ORD#Offset| |_k#0@@18|)) (=> (_module.Stream.Nil_q (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (|_module.Tree#Equal| (|#_module.Tree.Node| |s#1|) (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|))))))))) (and (=> (= (ControlFlow 0 19) (- 0 22)) (=> (_module.__default.ValidPath_h ($LS $LZ) |_k#0@@18| (|#_module.Tree.Node| |s#1|) (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|))) (=> (|_module.__default.ValidPath_h#canCall| |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (or (_module.__default.ValidPath_h ($LS $LZ) |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (=> (< 0 (|ORD#Offset| |_k#0@@18|)) (=> (not (_module.Stream.Nil_q (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|))) (let ((|index#12| (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.N2S_k ($LS ($LS $LZ)) |n#1| |num#1@@1|))))))
(<= (LitInt 0) |index#12|)))))))) (and (=> (= (ControlFlow 0 19) (- 0 21)) (=> (_module.__default.ValidPath_h ($LS $LZ) |_k#0@@18| (|#_module.Tree.Node| |s#1|) (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|))) (=> (|_module.__default.ValidPath_h#canCall| |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (or (_module.__default.ValidPath_h ($LS $LZ) |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (=> (< 0 (|ORD#Offset| |_k#0@@18|)) (=> (not (_module.Stream.Nil_q (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|))) (let ((|index#12@@0| (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.N2S_k ($LS ($LS $LZ)) |n#1| |num#1@@1|))))))
(let ((|ch#12| (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) (_module.Tree.children (|#_module.Tree.Node| |s#1|)) |index#12@@0|)))
(_module.Stream.Cons_q |ch#12|))))))))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (=> (_module.__default.ValidPath_h ($LS $LZ) |_k#0@@18| (|#_module.Tree.Node| |s#1|) (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|))) (=> (|_module.__default.ValidPath_h#canCall| |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (or (_module.__default.ValidPath_h ($LS $LZ) |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (=> (< 0 (|ORD#Offset| |_k#0@@18|)) (=> (not (_module.Stream.Nil_q (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|))) (let ((|tail#12| (_module.Stream.tail (_module.__default.N2S_k ($LS ($LS $LZ)) |n#1| |num#1@@1|))))
(let ((|index#12@@1| (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.N2S_k ($LS ($LS $LZ)) |n#1| |num#1@@1|))))))
(let ((|ch#12@@0| (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) (_module.Tree.children (|#_module.Tree.Node| |s#1|)) |index#12@@1|)))
(_module.__default.ValidPath_h ($LS ($LS $LZ)) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head |ch#12@@0|)) |tail#12|)))))))))) (=> (= (ControlFlow 0 19) (- 0 18)) (=> (_module.__default.ValidPath_h ($LS $LZ) |_k#0@@18| (|#_module.Tree.Node| |s#1|) (|#_module.Stream.Cons| ($Box intType (int_2_U |n#1|)) (_module.__default.N2S ($LS $LZ) |r#6@0|))) (=> (|_module.__default.ValidPath_h#canCall| |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (or (_module.__default.ValidPath_h ($LS $LZ) |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@18|)) (forall ((|_k'#5| T@U) ) (!  (=> (|ORD#Less| |_k'#5| |_k#0@@18|) (_module.__default.ValidPath_h ($LS ($LS $LZ)) |_k'#5| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS ($LS $LZ)) |n#1| |num#1@@1|)))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |1087|
 :pattern ( (_module.__default.ValidPath_h ($LS ($LS $LZ)) |_k'#5| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS ($LS $LZ)) |n#1| |num#1@@1|)))
))))))))))))))))
(let ((anon19_Then_correct true))
(let ((anon18_Else_correct true))
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.__default.ValidPath_h#canCall| |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (or (_module.__default.ValidPath_h ($LS $LZ) |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (=> (< 0 (|ORD#Offset| |_k#0@@18|)) (=> (_module.Stream.Nil_q (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (|_module.Tree#Equal| (|#_module.Tree.Node| |s#1|) (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|)))))))) (=> (=> (|_module.__default.ValidPath_h#canCall| |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (or (_module.__default.ValidPath_h ($LS $LZ) |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (=> (< 0 (|ORD#Offset| |_k#0@@18|)) (=> (_module.Stream.Nil_q (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (|_module.Tree#Equal| (|#_module.Tree.Node| |s#1|) (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.__default.ValidPath_h#canCall| |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (or (_module.__default.ValidPath_h ($LS $LZ) |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (=> (< 0 (|ORD#Offset| |_k#0@@18|)) (=> (not (_module.Stream.Nil_q (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|))) (let ((|index#4@@0| (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.N2S_k ($LS ($LS $LZ)) |n#1| |num#1@@1|))))))
(<= (LitInt 0) |index#4@@0|))))))) (=> (=> (|_module.__default.ValidPath_h#canCall| |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (or (_module.__default.ValidPath_h ($LS $LZ) |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (=> (< 0 (|ORD#Offset| |_k#0@@18|)) (=> (not (_module.Stream.Nil_q (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|))) (let ((|index#4@@1| (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.N2S_k ($LS ($LS $LZ)) |n#1| |num#1@@1|))))))
(<= (LitInt 0) |index#4@@1|)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.__default.ValidPath_h#canCall| |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (or (_module.__default.ValidPath_h ($LS $LZ) |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (=> (< 0 (|ORD#Offset| |_k#0@@18|)) (=> (not (_module.Stream.Nil_q (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|))) (let ((|index#4@@2| (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.N2S_k ($LS ($LS $LZ)) |n#1| |num#1@@1|))))))
(let ((|ch#4@@0| (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) (_module.Tree.children (|#_module.Tree.Node| |s#1|)) |index#4@@2|)))
(_module.Stream.Cons_q |ch#4@@0|)))))))) (=> (=> (|_module.__default.ValidPath_h#canCall| |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (or (_module.__default.ValidPath_h ($LS $LZ) |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (=> (< 0 (|ORD#Offset| |_k#0@@18|)) (=> (not (_module.Stream.Nil_q (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|))) (let ((|index#4@@3| (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.N2S_k ($LS ($LS $LZ)) |n#1| |num#1@@1|))))))
(let ((|ch#4@@1| (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) (_module.Tree.children (|#_module.Tree.Node| |s#1|)) |index#4@@3|)))
...
(let ((|index#4@@4| (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.N2S_k ($LS ($LS $LZ)) |n#1| |num#1@@1|))))))
(let ((|ch#4@@2| (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) (_module.Tree.children (|#_module.Tree.Node| |s#1|)) |index#4@@4|)))
...
(let ((|index#4@@5| (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.N2S_k ($LS ($LS $LZ)) |n#1| |num#1@@1|))))))
(let ((|ch#4@@3| (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) (_module.Tree.children (|#_module.Tree.Node| |s#1|)) |index#4@@5|)))
(_module.__default.ValidPath_h ($LS ($LS $LZ)) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head |ch#4@@3|)) |tail#4@@1|)))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.__default.ValidPath_h#canCall| |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (or (_module.__default.ValidPath_h ($LS $LZ) |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|)) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@18|)) (forall ((|_k'#1@@5| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@5| |_k#0@@18|) (_module.__default.ValidPath_h ($LS ($LS $LZ)) |_k'#1@@5| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS ($LS $LZ)) |n#1| |num#1@@1|)))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |1073|
 :pattern ( (_module.__default.ValidPath_h ($LS ($LS $LZ)) |_k'#1@@5| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS ($LS $LZ)) |n#1| |num#1@@1|)))
))))))))))))))))
(let ((anon25_Else_correct  (=> (and (=> true (_module.__default.ValidPath_h ($LS $LZ) |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n#1| |num#1@@1|))) (= (ControlFlow 0 40) 2)) GeneratedUnifiedExit_correct)))
(let ((anon18_Then_correct  (=> (= |num#1@@1| (|#_module.Number.Zero| |_mcc#1#0@0|)) (=> (and ($Is DatatypeTypeType |_mcc#1#0@0| (Tclass._module.CoOption Tclass._module.Number)) ($IsAlloc DatatypeTypeType |_mcc#1#0@0| (Tclass._module.CoOption Tclass._module.Number) $Heap@0)) (=> (and (and (and ($Is DatatypeTypeType |r#6@0| (Tclass._module.CoOption Tclass._module.Number)) ($IsAlloc DatatypeTypeType |r#6@0| (Tclass._module.CoOption Tclass._module.Number) $Heap@0)) (= |let#0_0_0#0#0| |_mcc#1#0@0|)) (and ($Is DatatypeTypeType |let#0_0_0#0#0| (Tclass._module.CoOption Tclass._module.Number)) (= |r#6@0| |let#0_0_0#0#0|))) (and (and (and (and (and (=> (= (ControlFlow 0 64) 17) anon19_Then_correct) (=> (= (ControlFlow 0 64) 19) anon20_Then_correct)) (=> (= (ControlFlow 0 64) 63) anon21_Then_correct)) (=> (= (ControlFlow 0 64) 53) anon23_Then_correct)) (=> (= (ControlFlow 0 64) 25) anon25_Then_correct)) (=> (= (ControlFlow 0 64) 40) anon25_Else_correct)))))))
(let ((anon17_Else_correct  (=> (or (not (= |num#1@@1| (|#_module.Number.Succ| |_mcc#0#0@0|))) (not true)) (and (=> (= (ControlFlow 0 65) 64) anon18_Then_correct) (=> (= (ControlFlow 0 65) 16) anon18_Else_correct)))))
(let ((anon17_Then_correct  (=> (= |num#1@@1| (|#_module.Number.Succ| |_mcc#0#0@0|)) (=> (and ($Is DatatypeTypeType |_mcc#0#0@0| Tclass._module.Number) ($IsAlloc DatatypeTypeType |_mcc#0#0@0| Tclass._module.Number $Heap@0)) (=> (and (and (and ($Is DatatypeTypeType |next#6@0| Tclass._module.Number) ($IsAlloc DatatypeTypeType |next#6@0| Tclass._module.Number $Heap@0)) (= |let#0_1_0#0#0| |_mcc#0#0@0|)) (and ($Is DatatypeTypeType |let#0_1_0#0#0| Tclass._module.Number) (= |next#6@0| |let#0_1_0#0#0|))) (and (=> (= (ControlFlow 0 8) (- 0 15)) ($Is intType (int_2_U (+ |n#1| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ |n#1| 1)) Tclass._System.nat) (=> (= |n##0@0| (+ |n#1| 1)) (and (=> (= (ControlFlow 0 8) (- 0 14)) (or (or (<= 0 (LitInt 0)) (|ORD#Less| |_k#0@@18| |_k#0@@18|)) (= (LitInt 0) (LitInt 0)))) (=> (or (or (<= 0 (LitInt 0)) (|ORD#Less| |_k#0@@18| |_k#0@@18|)) (= (LitInt 0) (LitInt 0))) (and (=> (= (ControlFlow 0 8) (- 0 13)) (or (|ORD#Less| |_k#0@@18| |_k#0@@18|) (and (= |_k#0@@18| |_k#0@@18|) (or (< (LitInt 0) (LitInt 0)) (and (= (LitInt 0) (LitInt 0)) (< (DtRank |next#6@0|) (DtRank |num#1@@1|))))))) (=> (or (|ORD#Less| |_k#0@@18| |_k#0@@18|) (and (= |_k#0@@18| |_k#0@@18|) (or (< (LitInt 0) (LitInt 0)) (and (= (LitInt 0) (LitInt 0)) (< (DtRank |next#6@0|) (DtRank |num#1@@1|)))))) (and (=> (= (ControlFlow 0 8) (- 0 12)) (=> (|_module.__default.ValidPath__Alt_k#canCall| (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n##0@0|) |next#6@0|) (or (_module.__default.ValidPath__Alt_k ($LS $LZ) (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n##0@0|) |next#6@0|) (=> (_module.Number.Succ_q |next#6@0|) (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) |s#1| |n##0@0|)))))) (=> (=> (|_module.__default.ValidPath__Alt_k#canCall| (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n##0@0|) |next#6@0|) (or (_module.__default.ValidPath__Alt_k ($LS $LZ) (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n##0@0|) |next#6@0|) (=> (_module.Number.Succ_q |next#6@0|) (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) |s#1| |n##0@0|))))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (=> (|_module.__default.ValidPath__Alt_k#canCall| (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n##0@0|) |next#6@0|) (or (_module.__default.ValidPath__Alt_k ($LS $LZ) (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n##0@0|) |next#6@0|) (=> (_module.Number.Succ_q |next#6@0|) (let ((|next#2@@0| (_module.Number._h4 |next#6@0|)))
(_module.__default.ValidPath__Alt_k ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) |s#1| |n##0@0|)) |next#2@@0|)))))) (=> (=> (|_module.__default.ValidPath__Alt_k#canCall| (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n##0@0|) |next#6@0|) (or (_module.__default.ValidPath__Alt_k ($LS $LZ) (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n##0@0|) |next#6@0|) (=> (_module.Number.Succ_q |next#6@0|) (let ((|next#2@@1| (_module.Number._h4 |next#6@0|)))
(_module.__default.ValidPath__Alt_k ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) |s#1| |n##0@0|)) |next#2@@1|))))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (=> (|_module.__default.ValidPath__Alt_k#canCall| (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n##0@0|) |next#6@0|) (or (_module.__default.ValidPath__Alt_k ($LS $LZ) (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n##0@0|) |next#6@0|) (=> (not (_module.Number.Succ_q |next#6@0|)) (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) |s#1| |n##0@0|)))))) (=> (=> (|_module.__default.ValidPath__Alt_k#canCall| (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n##0@0|) |next#6@0|) (or (_module.__default.ValidPath__Alt_k ($LS $LZ) (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n##0@0|) |next#6@0|) (=> (not (_module.Number.Succ_q |next#6@0|)) (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) |s#1| |n##0@0|))))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (=> (|_module.__default.ValidPath__Alt_k#canCall| (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n##0@0|) |next#6@0|) (or (_module.__default.ValidPath__Alt_k ($LS $LZ) (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n##0@0|) |next#6@0|) (=> (not (_module.Number.Succ_q |next#6@0|)) (let ((|r#2@@0| (_module.Number._h5 |next#6@0|)))
(_module.__default.ValidPath__Alt ($LS ($LS $LZ)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) |s#1| |n##0@0|))) |r#2@@0|)))))) (=> (=> (|_module.__default.ValidPath__Alt_k#canCall| (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n##0@0|) |next#6@0|) (or (_module.__default.ValidPath__Alt_k ($LS $LZ) (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n##0@0|) |next#6@0|) (=> (not (_module.Number.Succ_q |next#6@0|)) (let ((|r#2@@1| (_module.Number._h5 |next#6@0|)))
(_module.__default.ValidPath__Alt ($LS ($LS $LZ)) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) |s#1| |n##0@0|))) |r#2@@1|))))) (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (and (|_module.__default.N2S_k#canCall| |n##0@0| |next#6@0|) (|_module.__default.ValidPath_h#canCall| |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n##0@0| |next#6@0|)))) (and (and (|_module.__default.ValidPath_h#canCall| |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n##0@0| |next#6@0|)) (and (_module.__default.ValidPath_h ($LS $LZ) |_k#0@@18| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n##0@0| |next#6@0|)) (and (=> (< 0 (|ORD#Offset| |_k#0@@18|)) (ite (_module.Stream.Nil_q (_module.__default.N2S_k ($LS $LZ) |n##0@0| |next#6@0|)) (|_module.Tree#Equal| (|#_module.Tree.Node| |s#1|) (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|))) (let ((|tail#3@@1| (_module.Stream.tail (_module.__default.N2S_k ($LS $LZ) |n##0@0| |next#6@0|))))
(let ((|index#3@@1| (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.N2S_k ($LS $LZ) |n##0@0| |next#6@0|))))))
 (and (<= (LitInt 0) |index#3@@1|) (let ((|ch#3@@1| (_module.__default.Tail Tclass._module.Tree ($LS $LZ) (_module.Tree.children (|#_module.Tree.Node| |s#1|)) |index#3@@1|)))
 (and (_module.Stream.Cons_q |ch#3@@1|) (_module.__default.ValidPath_h ($LS $LZ) (|ORD#Minus| |_k#0@@18| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head |ch#3@@1|)) |tail#3@@1|)))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@18|)) (forall ((|_k'#0@@6| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@6| |_k#0@@18|) (_module.__default.ValidPath_h ($LS $LZ) |_k'#0@@6| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n##0@0| |next#6@0|)))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |1072|
 :pattern ( (_module.__default.ValidPath_h ($LS $LZ) |_k'#0@@6| (|#_module.Tree.Node| |s#1|) (_module.__default.N2S_k ($LS $LZ) |n##0@0| |next#6@0|)))
)))))) (and (= $Heap@0 $Heap@2) (= (ControlFlow 0 8) 2)))) GeneratedUnifiedExit_correct)))))))))))))))))))))
(let ((anon16_Then_correct  (=> (< 0 (|ORD#Offset| |_k#0@@18|)) (and (=> (= (ControlFlow 0 66) 8) anon17_Then_correct) (=> (= (ControlFlow 0 66) 65) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (<= (|ORD#Offset| |_k#0@@18|) 0) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1)) (and (forall ((|_k'#6| T@U) (|s#2| T@U) (|n#2| Int) (|num#2@@2| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |s#2| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#2|)) ($Is DatatypeTypeType |num#2@@2| Tclass._module.Number)) (and (|ORD#Less| |_k'#6| |_k#0@@18|) (_module.__default.ValidPath__Alt_k ($LS $LZ) (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#2| |n#2|) |num#2@@2|))) (_module.__default.ValidPath_h ($LS $LZ) |_k'#6| (|#_module.Tree.Node| |s#2|) (_module.__default.N2S_k ($LS $LZ) |n#2| |num#2@@2|)))
 :qid |InfiniteTreesdfy.583:16|
 :skolemid |1091|
 :pattern ( (_module.__default.N2S_k ($LS $LZ) |n#2| |num#2@@2|) (|#_module.Tree.Node| |s#2|) (|ORD#Less| |_k'#6| |_k#0@@18|))
 :pattern ( (_module.__default.ValidPath__Alt_k ($LS $LZ) (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#2| |n#2|) |num#2@@2|) (|ORD#Less| |_k'#6| |_k#0@@18|))
)) (= (ControlFlow 0 7) 2))) GeneratedUnifiedExit_correct))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and (|$IsA#_module.Stream| |s#1|) (|$IsA#_module.Number| |num#1@@1|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@0 $Heap@0) (forall ((|$ih#_k0#0| T@U) (|$ih#s0#0| T@U) (|$ih#n0#0| Int) (|$ih#num0#0| T@U) ) (!  (=> (and (and (and (and ($Is DatatypeTypeType |$ih#s0#0| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |$ih#n0#0|)) ($Is DatatypeTypeType |$ih#num0#0| Tclass._module.Number)) (_module.__default.ValidPath__Alt_k ($LS $LZ) (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |$ih#s0#0| |$ih#n0#0|) |$ih#num0#0|)) (or (|ORD#Less| |$ih#_k0#0| |_k#0@@18|) (and (= |$ih#_k0#0| |_k#0@@18|) (or (and (<= 0 (LitInt 0)) (< (LitInt 0) (LitInt 0))) (and (= (LitInt 0) (LitInt 0)) (< (DtRank |$ih#num0#0|) (DtRank |num#1@@1|))))))) (_module.__default.ValidPath_h ($LS $LZ) |$ih#_k0#0| (|#_module.Tree.Node| |$ih#s0#0|) (_module.__default.N2S_k ($LS $LZ) |$ih#n0#0| |$ih#num0#0|)))
 :qid |InfiniteTreesdfy.583:16|
 :skolemid |1076|
 :pattern ( (_module.__default.ValidPath_h ($LS $LZ) |$ih#_k0#0| (|#_module.Tree.Node| |$ih#s0#0|) (_module.__default.N2S_k ($LS $LZ) |$ih#n0#0| |$ih#num0#0|)))
)))) (and (=> (= (ControlFlow 0 67) 66) anon16_Then_correct) (=> (= (ControlFlow 0 67) 7) anon16_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and ($Is DatatypeTypeType |s#1| (Tclass._module.Stream Tclass._module.Tree)) ($IsAlloc DatatypeTypeType |s#1| (Tclass._module.Stream Tclass._module.Tree) $Heap@@0)) (|$IsA#_module.Stream| |s#1|)) (<= (LitInt 0) |n#1|)) (=> (and (and (and (and ($Is DatatypeTypeType |num#1@@1| Tclass._module.Number) ($IsAlloc DatatypeTypeType |num#1@@1| Tclass._module.Number $Heap@@0)) (|$IsA#_module.Number| |num#1@@1|)) (= 4 $FunctionContextHeight)) (and (and (|_module.__default.ValidPath__Alt_k#canCall| (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|) |num#1@@1|) (and (_module.__default.ValidPath__Alt_k ($LS $LZ) (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|) |num#1@@1|) (ite (_module.Number.Succ_q |num#1@@1|) (let ((|next#5@@0| (_module.Number._h4 |num#1@@1|)))
 (and (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|)) (_module.__default.ValidPath__Alt_k ($LS $LZ) (_module.Stream.tail (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|)) |next#5@@0|))) (let ((|r#5@@0| (_module.Number._h5 |num#1@@1|)))
 (and (_module.Stream.Cons_q (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|)) (_module.__default.ValidPath__Alt ($LS $LZ) ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s#1| |n#1|))) |r#5@@0|)))))) (= (ControlFlow 0 68) 67))) anon0_correct)))))
