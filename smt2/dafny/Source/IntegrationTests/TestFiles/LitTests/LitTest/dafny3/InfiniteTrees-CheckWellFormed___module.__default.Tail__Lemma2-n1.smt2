...
(declare-fun _module._default.Tail_Lemma2$_T0 () T@U)
(declare-fun |n#0@@5| () Int)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Tail__Lemma2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and (_module.Stream.Cons_q |s#0@@5|) (= (ControlFlow 0 2) (- 0 1))) (_module.Stream.Cons_q |s#0@@5|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (and ($Is DatatypeTypeType |s#0@@5| (Tclass._module.Stream _module._default.Tail_Lemma2$_T0)) ($IsAlloc DatatypeTypeType |s#0@@5| (Tclass._module.Stream _module._default.Tail_Lemma2$_T0) $Heap@@0)) (|$IsA#_module.Stream| |s#0@@5|)) (<= (LitInt 0) |n#0@@5|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
