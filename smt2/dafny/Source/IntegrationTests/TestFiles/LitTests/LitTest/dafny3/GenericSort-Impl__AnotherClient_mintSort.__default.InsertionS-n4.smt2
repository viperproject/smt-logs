...
(assert (forall (($h0 T@U) ($h1 T@U) (|a#0@@1| T@U) (|low#0@@0| Int) (|high#0@@0| Int) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|AnotherClient_mintSort.__default.Sorted#canCall| $h0 |a#0@@1| |low#0@@0| |high#0@@0|) ($Is refType |a#0@@1| (Tclass._System.array TInt)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@2 T@U) ($f T@U) )  (=> (and (or (not (= $o@@2 null)) (not true)) (= $o@@2 |a#0@@1|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@2) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@2) $f)))) (= (AnotherClient_mintSort.__default.Sorted $h0 |a#0@@1| |low#0@@0| |high#0@@0|) (AnotherClient_mintSort.__default.Sorted $h1 |a#0@@1| |low#0@@0| |high#0@@0|))))
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (AnotherClient_mintSort.__default.Sorted $h1 |a#0@@1| |low#0@@0| |high#0@@0|))
)))
(assert (forall (($h0@@0 T@U) ($h1@@0 T@U) (|a#0@@2| T@U) (|low#0@@1| Int) (|high#0@@1| Int) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (or (|AnotherClient_mintSort.__default.NeighborSorted#canCall| $h0@@0 |a#0@@2| |low#0@@1| |high#0@@1|) ($Is refType |a#0@@2| (Tclass._System.array TInt)))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@3 T@U) ($f@@0 T@U) )  (=> (and (or (not (= $o@@3 null)) (not true)) (= $o@@3 |a#0@@2|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@3) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@0 $o@@3) $f@@0)))) (= (AnotherClient_mintSort.__default.NeighborSorted $h0@@0 |a#0@@2| |low#0@@1| |high#0@@1|) (AnotherClient_mintSort.__default.NeighborSorted $h1@@0 |a#0@@2| |low#0@@1| |high#0@@1|))))
