...
(declare-fun |IntLexOrder.T#Equal| (T@U T@U) Bool)
...
(assert (forall ((a T@U) (b T@U) ) (! (= (|IntLexOrder.T#Equal| a b)  (and (= (IntLexOrder.T.i a) (IntLexOrder.T.i b)) (= (IntLexOrder.T.j a) (IntLexOrder.T.j b))))
 :qid |unknown.0:0|
 :skolemid |3003|
 :pattern ( (|IntLexOrder.T#Equal| a b))
)))
...
(assert (forall ((a@@0 T@U) (b@@0 T@U) ) (! (= (|IntLexOrder.T#Equal| a@@0 b@@0) (= a@@0 b@@0))
 :qid |unknown.0:0|
 :skolemid |3004|
 :pattern ( (|IntLexOrder.T#Equal| a@@0 b@@0))
)))
...
(set-info :boogie-vc-id Impl$$IntLexOrder.__default.Antisymmetry)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|IntLexOrder.T#Equal| |a#0@@1| |b#0@@1|))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |a#0@@1| Tclass.IntLexOrder.T) ($IsAlloc DatatypeTypeType |a#0@@1| Tclass.IntLexOrder.T $Heap)) (|$IsA#IntLexOrder.T| |a#0@@1|)) (=> (and (and (and ($Is DatatypeTypeType |b#0@@1| Tclass.IntLexOrder.T) ($IsAlloc DatatypeTypeType |b#0@@1| Tclass.IntLexOrder.T $Heap)) (|$IsA#IntLexOrder.T| |b#0@@1|)) (and (and (= 2 $FunctionContextHeight) (IntLexOrder.__default.Leq |a#0@@1| |b#0@@1|)) (and (IntLexOrder.__default.Leq |b#0@@1| |a#0@@1|) (= (ControlFlow 0 3) 2)))) anon0_correct)))))
