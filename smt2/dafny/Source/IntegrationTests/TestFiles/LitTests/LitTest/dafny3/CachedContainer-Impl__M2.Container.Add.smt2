...
(set-info :boogie-vc-id Impl$$M2.Container.Add)
...
)))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@5) M2.Container.Contents)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@5) M2.Container.Contents)) (|Set#UnionOne| |Set#Empty| |t#0|))))))))))))))))))))
(let ((anon4_Else_correct  (=> (or (not (= |call4formal@j#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) M2.Container.elems))))) (not true)) (=> (and (= $Heap@2 $Heap@0) (= (ControlFlow 0 10) 2)) anon3_correct))))
(let ((anon4_Then_correct  (=> (= |call4formal@j#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) M2.Container.elems)))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@5 M2.Container.elems))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@5 M2.Container.elems)) (=> (= |$rhs#0_0@0| (|Seq#Append| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) M2.Container.elems)) (|Seq#Build| |Seq#Empty| |t#0|))) (=> (and (and (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 this@@5 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) M2.Container.elems ($Box SeqType |$rhs#0_0@0|)))) ($IsGoodHeap $Heap@1)) (and (= $Heap@2 $Heap@1) (= (ControlFlow 0 8) 2))) anon3_correct)))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#11| null $Heap@@2 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@5) M2.Container.Repr)))) (<= (LitInt 0) |call4formal@j#0|)) (and (=> (= (ControlFlow 0 11) (- 0 14)) (=> (|M2.Container.Valid#canCall| M2.Container$T@@21 $Heap@@2 this@@5) (or (M2.Container.Valid M2.Container$T@@21 $Heap@@2 this@@5) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@5) M2.Container.Repr)) ($Box refType this@@5))))) (=> (=> (|M2.Container.Valid#canCall| M2.Container$T@@21 $Heap@@2 this@@5) (or (M2.Container.Valid M2.Container$T@@21 $Heap@@2 this@@5) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@5) M2.Container.Repr)) ($Box refType this@@5)))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (=> (|M2.Container.Valid#canCall| M2.Container$T@@21 $Heap@@2 this@@5) (or (M2.Container.Valid M2.Container$T@@21 $Heap@@2 this@@5) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@5) M2.Container.Repr)) ($Box refType null)))))) (=> (=> (|M2.Container.Valid#canCall| M2.Container$T@@21 $Heap@@2 this@@5) (or (M2.Container.Valid M2.Container$T@@21 $Heap@@2 this@@5) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@5) M2.Container.Repr)) ($Box refType null))))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (=> (|M2.Container.Valid#canCall| M2.Container$T@@21 $Heap@@2 this@@5) (or (M2.Container.Valid M2.Container$T@@21 $Heap@@2 this@@5) (M2.Container.Valid_k M2.Container$T@@21 $Heap@@2 this@@5)))) (=> (=> (|M2.Container.Valid#canCall| M2.Container$T@@21 $Heap@@2 this@@5) (or (M2.Container.Valid M2.Container$T@@21 $Heap@@2 this@@5) (M2.Container.Valid_k M2.Container$T@@21 $Heap@@2 this@@5))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (<= (LitInt 0) |call4formal@j#0@0|) (<= |call4formal@j#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) M2.Container.elems)))))) (and (and (=> (< |call4formal@j#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) M2.Container.elems)))) (= (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) M2.Container.elems)) |call4formal@j#0@0|) |t#0|)) (=> (<= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) M2.Container.elems))) |call4formal@j#0@0|) (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) M2.Container.elems)) |t#0|)))) (and (forall (($o@@17 T@U) ) (!  (=> (and (or (not (= $o@@17 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@17) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@17) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@17)))
 :qid |CachedContainerdfy.91:12|
 :skolemid |1572|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@17))
)) ($HeapSucc $Heap@@2 $Heap@0)))) (and (=> (= (ControlFlow 0 11) 8) anon4_Then_correct) (=> (= (ControlFlow 0 11) 10) anon4_Else_correct))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (or (not (= this@@5 null)) (not true)) (and ($Is refType this@@5 (Tclass.M2.Container M2.Container$T@@21)) ($IsAlloc refType this@@5 (Tclass.M2.Container M2.Container$T@@21) $Heap@@2))) (and ($IsBox |t#0| M2.Container$T@@21) ($IsAllocBox |t#0| M2.Container$T@@21 $Heap@@2))) (=> (and (and (and (<= (LitInt 0) |j#0@@1|) true) (= 4 $FunctionContextHeight)) (and (and (|M2.Container.Valid#canCall| M2.Container$T@@21 $Heap@@2 this@@5) (and (M2.Container.Valid M2.Container$T@@21 $Heap@@2 this@@5) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@5) M2.Container.Repr)) ($Box refType this@@5)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@5) M2.Container.Repr)) ($Box refType null)))) (M2.Container.Valid_k M2.Container$T@@21 $Heap@@2 this@@5)))) (= (ControlFlow 0 15) 11))) anon0_correct)))))
