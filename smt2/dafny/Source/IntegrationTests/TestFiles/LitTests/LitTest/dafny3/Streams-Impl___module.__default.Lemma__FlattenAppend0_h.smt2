...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.PrependThenFlattenStartMarker$T T@U) ($ly T@U) (|prefix#0| T@U) (|M#0| T@U) (|startMarker#0| T@U) ) (!  (=> (or (|_module.__default.PrependThenFlattenStartMarker#canCall| _module._default.PrependThenFlattenStartMarker$T |prefix#0| |M#0| |startMarker#0|) (and (< 1 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |prefix#0| (Tclass._module.Stream _module._default.PrependThenFlattenStartMarker$T)) ($Is DatatypeTypeType |M#0| (Tclass._module.Stream (Tclass._module.Stream _module._default.PrependThenFlattenStartMarker$T)))) ($IsBox |startMarker#0| _module._default.PrependThenFlattenStartMarker$T)))) (and (and (=> (_module.Stream.Nil_q |prefix#0|) (=> (not (_module.Stream.Nil_q |M#0|)) (let ((|N#1| (_module.Stream.tail |M#0|)))
(let ((|s#1| ($Unbox DatatypeTypeType (_module.Stream.head |M#0|))))
(|_module.__default.PrependThenFlattenStartMarker#canCall| _module._default.PrependThenFlattenStartMarker$T |s#1| |N#1| |startMarker#0|))))) (=> (not (_module.Stream.Nil_q |prefix#0|)) (let ((|tl#1| (_module.Stream.tail |prefix#0|)))
(|_module.__default.PrependThenFlattenStartMarker#canCall| _module._default.PrependThenFlattenStartMarker$T |tl#1| |M#0| |startMarker#0|)))) (= (_module.__default.PrependThenFlattenStartMarker _module._default.PrependThenFlattenStartMarker$T ($LS $ly) |prefix#0| |M#0| |startMarker#0|) (ite (_module.Stream.Nil_q |prefix#0|) (ite (_module.Stream.Nil_q |M#0|) |#_module.Stream.Nil| (let ((|N#0| (_module.Stream.tail |M#0|)))
(let ((|s#0| ($Unbox DatatypeTypeType (_module.Stream.head |M#0|))))
(|#_module.Stream.Cons| |startMarker#0| (_module.__default.PrependThenFlattenStartMarker _module._default.PrependThenFlattenStartMarker$T $ly |s#0| |N#0| |startMarker#0|))))) (let ((|tl#0| (_module.Stream.tail |prefix#0|)))
(let ((|hd#0| (_module.Stream.head |prefix#0|)))
(|#_module.Stream.Cons| |hd#0| (_module.__default.PrependThenFlattenStartMarker _module._default.PrependThenFlattenStartMarker$T $ly |tl#0| |M#0| |startMarker#0|))))))))
 :qid |unknown.0:0|
 :skolemid |665|
 :pattern ( (_module.__default.PrependThenFlattenStartMarker _module._default.PrependThenFlattenStartMarker$T ($LS $ly) |prefix#0| |M#0| |startMarker#0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.append$_T0 T@U) ($ly@@0 T@U) (|M#0@@0| T@U) (|N#0@@0| T@U) ) (!  (=> (or (|_module.__default.append#canCall| _module._default.append$_T0 |M#0@@0| |N#0@@0|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |M#0@@0| (Tclass._module.Stream _module._default.append$_T0)) ($Is DatatypeTypeType |N#0@@0| (Tclass._module.Stream _module._default.append$_T0))))) (and (=> (not (_module.Stream.Nil_q |M#0@@0|)) (let ((|M'#1| (_module.Stream.tail |M#0@@0|)))
(|_module.__default.append#canCall| _module._default.append$_T0 |M'#1| |N#0@@0|))) (= (_module.__default.append _module._default.append$_T0 ($LS $ly@@0) |M#0@@0| |N#0@@0|) (ite (_module.Stream.Nil_q |M#0@@0|) |N#0@@0| (let ((|M'#0| (_module.Stream.tail |M#0@@0|)))
(let ((|t#0| (_module.Stream.head |M#0@@0|)))
(|#_module.Stream.Cons| |t#0| (_module.__default.append _module._default.append$_T0 $ly@@0 |M'#0| |N#0@@0|))))))))
 :qid |unknown.0:0|
 :skolemid |589|
 :pattern ( (_module.__default.append _module._default.append$_T0 ($LS $ly@@0) |M#0@@0| |N#0@@0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.PrependThenFlattenStartMarker$T@@0 T@U) ($ly@@1 T@U) (|prefix#0@@0| T@U) (|M#0@@1| T@U) (|startMarker#0@@0| T@U) ) (!  (=> (or (|_module.__default.PrependThenFlattenStartMarker#canCall| _module._default.PrependThenFlattenStartMarker$T@@0 |prefix#0@@0| |M#0@@1| |startMarker#0@@0|) (and (< 1 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |prefix#0@@0| (Tclass._module.Stream _module._default.PrependThenFlattenStartMarker$T@@0)) ($Is DatatypeTypeType |M#0@@1| (Tclass._module.Stream (Tclass._module.Stream _module._default.PrependThenFlattenStartMarker$T@@0)))) ($IsBox |startMarker#0@@0| _module._default.PrependThenFlattenStartMarker$T@@0)))) ($Is DatatypeTypeType (_module.__default.PrependThenFlattenStartMarker _module._default.PrependThenFlattenStartMarker$T@@0 $ly@@1 |prefix#0@@0| |M#0@@1| |startMarker#0@@0|) (Tclass._module.Stream _module._default.PrependThenFlattenStartMarker$T@@0)))
 :qid |unknown.0:0|
 :skolemid |662|
 :pattern ( (_module.__default.PrependThenFlattenStartMarker _module._default.PrependThenFlattenStartMarker$T@@0 $ly@@1 |prefix#0@@0| |M#0@@1| |startMarker#0@@0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.append$_T0@@0 T@U) ($ly@@2 T@U) (|M#0@@2| T@U) (|N#0@@1| T@U) ) (!  (=> (or (|_module.__default.append#canCall| _module._default.append$_T0@@0 |M#0@@2| |N#0@@1|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |M#0@@2| (Tclass._module.Stream _module._default.append$_T0@@0)) ($Is DatatypeTypeType |N#0@@1| (Tclass._module.Stream _module._default.append$_T0@@0))))) ($Is DatatypeTypeType (_module.__default.append _module._default.append$_T0@@0 $ly@@2 |M#0@@2| |N#0@@1|) (Tclass._module.Stream _module._default.append$_T0@@0)))
 :qid |unknown.0:0|
 :skolemid |586|
 :pattern ( (_module.__default.append _module._default.append$_T0@@0 $ly@@2 |M#0@@2| |N#0@@1|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) (_module._default.PrependThenFlattenStartMarker$T@@1 T@U) ($ly@@4 T@U) (|prefix#0@@1| T@U) (|M#0@@4| T@U) (|startMarker#0@@1| T@U) ) (!  (=> (and (or (|_module.__default.PrependThenFlattenStartMarker#canCall| _module._default.PrependThenFlattenStartMarker$T@@1 |prefix#0@@1| |M#0@@4| |startMarker#0@@1|) (and (< 1 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |prefix#0@@1| (Tclass._module.Stream _module._default.PrependThenFlattenStartMarker$T@@1)) ($IsAlloc DatatypeTypeType |prefix#0@@1| (Tclass._module.Stream _module._default.PrependThenFlattenStartMarker$T@@1) $Heap@@0)) (and ($Is DatatypeTypeType |M#0@@4| (Tclass._module.Stream (Tclass._module.Stream _module._default.PrependThenFlattenStartMarker$T@@1))) ($IsAlloc DatatypeTypeType |M#0@@4| (Tclass._module.Stream (Tclass._module.Stream _module._default.PrependThenFlattenStartMarker$T@@1)) $Heap@@0))) (and ($IsBox |startMarker#0@@1| _module._default.PrependThenFlattenStartMarker$T@@1) ($IsAllocBox |startMarker#0@@1| _module._default.PrependThenFlattenStartMarker$T@@1 $Heap@@0))))) ($IsGoodHeap $Heap@@0)) ($IsAlloc DatatypeTypeType (_module.__default.PrependThenFlattenStartMarker _module._default.PrependThenFlattenStartMarker$T@@1 $ly@@4 |prefix#0@@1| |M#0@@4| |startMarker#0@@1|) (Tclass._module.Stream _module._default.PrependThenFlattenStartMarker$T@@1) $Heap@@0))
 :qid |Streamsdfy.198:16|
 :skolemid |663|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.__default.PrependThenFlattenStartMarker _module._default.PrependThenFlattenStartMarker$T@@1 $ly@@4 |prefix#0@@1| |M#0@@4| |startMarker#0@@1|) (Tclass._module.Stream _module._default.PrependThenFlattenStartMarker$T@@1) $Heap@@0))
))))
...
(assert (forall ((_module._default.PrependThenFlattenStartMarker$T@@2 T@U) ($ly@@6 T@U) (|prefix#0@@2| T@U) (|M#0@@6| T@U) (|startMarker#0@@2| T@U) ) (! (= (_module.__default.PrependThenFlattenStartMarker _module._default.PrependThenFlattenStartMarker$T@@2 ($LS $ly@@6) |prefix#0@@2| |M#0@@6| |startMarker#0@@2|) (_module.__default.PrependThenFlattenStartMarker _module._default.PrependThenFlattenStartMarker$T@@2 $ly@@6 |prefix#0@@2| |M#0@@6| |startMarker#0@@2|))
 :qid |unknown.0:0|
 :skolemid |660|
 :pattern ( (_module.__default.PrependThenFlattenStartMarker _module._default.PrependThenFlattenStartMarker$T@@2 ($LS $ly@@6) |prefix#0@@2| |M#0@@6| |startMarker#0@@2|))
)))
...
(declare-fun |_module._default.Lemma_FlattenAppend0#$T| () T@U)
(declare-fun |_k#0| () T@U)
(declare-fun $LZ () T@U)
(declare-fun |s#1@@0| () T@U)
(declare-fun |M#1| () T@U)
(declare-fun |startMarker#1| () T@U)
...
(declare-fun $Heap@@1 () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.Lemma__FlattenAppend0_h)
...
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (|$PrefixEq#_module.Stream| |_module._default.Lemma_FlattenAppend0#$T| |_module._default.Lemma_FlattenAppend0#$T| |_k#0| ($LS ($LS $LZ)) (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) |s#1@@0| |M#1| |startMarker#1|) (_module.__default.append |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) |s#1@@0| (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1| |startMarker#1|))) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Nil_q (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) |s#1@@0| |M#1| |startMarker#1|)) (_module.Stream.Nil_q (_module.__default.append |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) |s#1@@0| (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1| |startMarker#1|))))))) (=> (or (|$PrefixEq#_module.Stream| |_module._default.Lemma_FlattenAppend0#$T| |_module._default.Lemma_FlattenAppend0#$T| |_k#0| ($LS ($LS $LZ)) (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) |s#1@@0| |M#1| |startMarker#1|) (_module.__default.append |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) |s#1@@0| (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1| |startMarker#1|))) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Nil_q (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) |s#1@@0| |M#1| |startMarker#1|)) (_module.Stream.Nil_q (_module.__default.append |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) |s#1@@0| (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1| |startMarker#1|)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (|$PrefixEq#_module.Stream| |_module._default.Lemma_FlattenAppend0#$T| |_module._default.Lemma_FlattenAppend0#$T| |_k#0| ($LS ($LS $LZ)) (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) |s#1@@0| |M#1| |startMarker#1|) (_module.__default.append |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) |s#1@@0| (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1| |startMarker#1|))) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) |s#1@@0| |M#1| |startMarker#1|)) (and (_module.Stream.Cons_q (_module.__default.append |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) |s#1@@0| (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1| |startMarker#1|))) (and (= (_module.Stream.head (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) |s#1@@0| |M#1| |startMarker#1|)) (_module.Stream.head (_module.__default.append |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) |s#1@@0| (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1| |startMarker#1|)))) (|$PrefixEq#_module.Stream| |_module._default.Lemma_FlattenAppend0#$T| |_module._default.Lemma_FlattenAppend0#$T| (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) |s#1@@0| |M#1| |startMarker#1|)) (_module.Stream.tail (_module.__default.append |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) |s#1@@0| (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1| |startMarker#1|)))))))))) (=> (or (|$PrefixEq#_module.Stream| |_module._default.Lemma_FlattenAppend0#$T| |_module._default.Lemma_FlattenAppend0#$T| |_k#0| ($LS ($LS $LZ)) (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) |s#1@@0| |M#1| |startMarker#1|) (_module.__default.append |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) |s#1@@0| (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1| |startMarker#1|))) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) |s#1@@0| |M#1| |startMarker#1|)) (and (_module.Stream.Cons_q (_module.__default.append |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) |s#1@@0| (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1| |startMarker#1|))) (and (= (_module.Stream.head (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) |s#1@@0| |M#1| |startMarker#1|)) (_module.Stream.head (_module.__default.append |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) |s#1@@0| (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1| |startMarker#1|)))) (|$PrefixEq#_module.Stream| |_module._default.Lemma_FlattenAppend0#$T| |_module._default.Lemma_FlattenAppend0#$T| (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) |s#1@@0| |M#1| |startMarker#1|)) (_module.Stream.tail (_module.__default.append |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) |s#1@@0| (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1| |startMarker#1|))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (or (|$PrefixEq#_module.Stream| |_module._default.Lemma_FlattenAppend0#$T| |_module._default.Lemma_FlattenAppend0#$T| |_k#0| ($LS ($LS $LZ)) (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) |s#1@@0| |M#1| |startMarker#1|) (_module.__default.append |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) |s#1@@0| (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1| |startMarker#1|))) (or (=> (< 0 (|ORD#Offset| |_k#0|)) (and (=> (_module.Stream.Nil_q (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) |s#1@@0| |M#1| |startMarker#1|)) (_module.Stream.Nil_q (_module.__default.append |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) |s#1@@0| (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1| |startMarker#1|)))) (=> (_module.Stream.Cons_q (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) |s#1@@0| |M#1| |startMarker#1|)) (and (_module.Stream.Cons_q (_module.__default.append |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) |s#1@@0| (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1| |startMarker#1|))) (and (= (_module.Stream.head (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) |s#1@@0| |M#1| |startMarker#1|)) (_module.Stream.head (_module.__default.append |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) |s#1@@0| (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1| |startMarker#1|)))) (|$PrefixEq#_module.Stream| |_module._default.Lemma_FlattenAppend0#$T| |_module._default.Lemma_FlattenAppend0#$T| (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) |s#1@@0| |M#1| |startMarker#1|)) (_module.Stream.tail (_module.__default.append |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) |s#1@@0| (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1| |startMarker#1|))))))))) (=> (and (or (not (= |_k#0| (|ORD#FromNat| 0))) (not true)) (= (|ORD#Offset| |_k#0|) 0)) (|$Eq#_module.Stream| |_module._default.Lemma_FlattenAppend0#$T| |_module._default.Lemma_FlattenAppend0#$T| ($LS ($LS $LZ)) (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) |s#1@@0| |M#1| |startMarker#1|) (_module.__default.append |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) |s#1@@0| (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1| |startMarker#1|)))))))))))))
(let ((anon8_Then_correct  (=> (= |s#1@@0| (|#_module.Stream.Cons| |_mcc#0#0@0| |_mcc#1#0@0|)) (=> (and (and ($IsBox |_mcc#0#0@0| |_module._default.Lemma_FlattenAppend0#$T|) ($IsAllocBox |_mcc#0#0@0| |_module._default.Lemma_FlattenAppend0#$T| $Heap@0)) (and ($Is DatatypeTypeType |_mcc#1#0@0| (Tclass._module.Stream |_module._default.Lemma_FlattenAppend0#$T|)) ($IsAlloc DatatypeTypeType |_mcc#1#0@0| (Tclass._module.Stream |_module._default.Lemma_FlattenAppend0#$T|) $Heap@0))) (=> (and (and (and (and ($Is DatatypeTypeType |tl#0@0| (Tclass._module.Stream |_module._default.Lemma_FlattenAppend0#$T|)) ($IsAlloc DatatypeTypeType |tl#0@0| (Tclass._module.Stream |_module._default.Lemma_FlattenAppend0#$T|) $Heap@0)) (= |let#0_0_0#0#0| |_mcc#1#0@0|)) (and ($Is DatatypeTypeType |let#0_0_0#0#0| (Tclass._module.Stream |_module._default.Lemma_FlattenAppend0#$T|)) (= |tl#0@0| |let#0_0_0#0#0|))) (and (and (and ($IsBox |hd#0@0| |_module._default.Lemma_FlattenAppend0#$T|) ($IsAllocBox |hd#0@0| |_module._default.Lemma_FlattenAppend0#$T| $Heap@0)) (= |let#0_0_1#0#0| |_mcc#0#0@0|)) (and ($IsBox |let#0_0_1#0#0| |_module._default.Lemma_FlattenAppend0#$T|) (= |hd#0@0| |let#0_0_1#0#0|)))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0|)) (=> (= |_k##0@0| (|ORD#Minus| |_k#0| (|ORD#FromNat| 1))) (=> (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (=> (and (and (and (|_module.__default.PrependThenFlattenStartMarker#canCall| |_module._default.Lemma_FlattenAppend0#$T| |tl#0@0| |M#1| |startMarker#1|) (and (|_module.__default.PrependThenFlattenStartMarker#canCall| |_module._default.Lemma_FlattenAppend0#$T| (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1| |startMarker#1|) (|_module.__default.append#canCall| |_module._default.Lemma_FlattenAppend0#$T| |tl#0@0| (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1| |startMarker#1|)))) (|$PrefixEq#_module.Stream| |_module._default.Lemma_FlattenAppend0#$T| |_module._default.Lemma_FlattenAppend0#$T| |_k##0@0| ($LS ($LS $LZ)) (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) |tl#0@0| |M#1| |startMarker#1|) (_module.__default.append |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) |tl#0@0| (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1| |startMarker#1|)))) (and (= $Heap@0 $Heap@2) (= (ControlFlow 0 7) 2))) GeneratedUnifiedExit_correct))))))))))))
(let ((anon7_Else_correct  (=> (or (not (= |s#1@@0| |#_module.Stream.Nil|)) (not true)) (and (=> (= (ControlFlow 0 11) 7) anon8_Then_correct) (=> (= (ControlFlow 0 11) 10) anon8_Else_correct)))))
(let ((anon7_Then_correct  (=> (and (= |s#1@@0| |#_module.Stream.Nil|) (= (ControlFlow 0 6) 2)) GeneratedUnifiedExit_correct)))
...
(let ((anon6_Else_correct  (=> (<= (|ORD#Offset| |_k#0|) 0) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1)) (and (forall ((|_k'#0| T@U) (|s#2| T@U) (|M#2| T@U) (|startMarker#2| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |s#2| (Tclass._module.Stream |_module._default.Lemma_FlattenAppend0#$T|)) ($Is DatatypeTypeType |M#2| (Tclass._module.Stream (Tclass._module.Stream |_module._default.Lemma_FlattenAppend0#$T|)))) ($IsBox |startMarker#2| |_module._default.Lemma_FlattenAppend0#$T|)) (|ORD#Less| |_k'#0| |_k#0|)) (|$PrefixEq#_module.Stream| |_module._default.Lemma_FlattenAppend0#$T| |_module._default.Lemma_FlattenAppend0#$T| |_k'#0| ($LS ($LS $LZ)) (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) |s#2| |M#2| |startMarker#2|) (_module.__default.append |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) |s#2| (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#2| |startMarker#2|))))
 :qid |Streamsdfy.331:16|
 :skolemid |734|
 :pattern ( (_module.__default.append |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) |s#2| (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) |#_module.Stream.Nil| |M#2| |startMarker#2|)) (|ORD#Less| |_k'#0| |_k#0|))
 :pattern ( (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) |s#2| |M#2| |startMarker#2|) (|ORD#Less| |_k'#0| |_k#0|))
)) (= (ControlFlow 0 5) 2))) GeneratedUnifiedExit_correct))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (|$IsA#_module.Stream| |s#1@@0|) (|$IsA#_module.Stream| |M#1|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@1 $Heap@0) (forall ((|$ih#_k0#0| T@U) (|$ih#s0#0| T@U) (|$ih#M0#0| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |$ih#s0#0| (Tclass._module.Stream |_module._default.Lemma_FlattenAppend0#$T|)) ($Is DatatypeTypeType |$ih#M0#0| (Tclass._module.Stream (Tclass._module.Stream |_module._default.Lemma_FlattenAppend0#$T|)))) (U_2_bool (Lit boolType (bool_2_U true)))) (|ORD#Less| |$ih#_k0#0| |_k#0|)) (|$PrefixEq#_module.Stream| |_module._default.Lemma_FlattenAppend0#$T| |_module._default.Lemma_FlattenAppend0#$T| |$ih#_k0#0| ($LS ($LS $LZ)) (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) |$ih#s0#0| |$ih#M0#0| |startMarker#1|) (_module.__default.append |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) |$ih#s0#0| (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) (Lit DatatypeTypeType |#_module.Stream.Nil|) |$ih#M0#0| |startMarker#1|))))
 :qid |Streamsdfy.331:16|
 :skolemid |732|
 :pattern ( (|$PrefixEq#_module.Stream| |_module._default.Lemma_FlattenAppend0#$T| |_module._default.Lemma_FlattenAppend0#$T| |$ih#_k0#0| ($LS ($LS $LZ)) (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) |$ih#s0#0| |$ih#M0#0| |startMarker#1|) (_module.__default.append |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) |$ih#s0#0| (_module.__default.PrependThenFlattenStartMarker |_module._default.Lemma_FlattenAppend0#$T| ($LS $LZ) (Lit DatatypeTypeType |#_module.Stream.Nil|) |$ih#M0#0| |startMarker#1|))))
)))) (and (=> (= (ControlFlow 0 13) 12) anon6_Then_correct) (=> (= (ControlFlow 0 13) 5) anon6_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and ($Is DatatypeTypeType |s#1@@0| (Tclass._module.Stream |_module._default.Lemma_FlattenAppend0#$T|)) ($IsAlloc DatatypeTypeType |s#1@@0| (Tclass._module.Stream |_module._default.Lemma_FlattenAppend0#$T|) $Heap@@1)) (|$IsA#_module.Stream| |s#1@@0|)) (=> (and (and (and ($Is DatatypeTypeType |M#1| (Tclass._module.Stream (Tclass._module.Stream |_module._default.Lemma_FlattenAppend0#$T|))) ($IsAlloc DatatypeTypeType |M#1| (Tclass._module.Stream (Tclass._module.Stream |_module._default.Lemma_FlattenAppend0#$T|)) $Heap@@1)) (|$IsA#_module.Stream| |M#1|)) (and (and ($IsBox |startMarker#1| |_module._default.Lemma_FlattenAppend0#$T|) ($IsAllocBox |startMarker#1| |_module._default.Lemma_FlattenAppend0#$T| $Heap@@1)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 14) 13)))) anon0_correct)))))
