...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.nth$T@@3 T@U) ($ly@@3 T@U) (|n#0@@3| Int) (|s#0@@3| T@U) ) (!  (=> (or (|_module.__default.nth#canCall| _module._default.nth$T@@3 (LitInt |n#0@@3|) (Lit DatatypeTypeType |s#0@@3|)) (and (< 1 $FunctionContextHeight) (and (<= (LitInt 0) |n#0@@3|) ($Is DatatypeTypeType |s#0@@3| (Tclass._module.Stream _module._default.nth$T@@3))))) (and (and (=> (= (LitInt |n#0@@3|) (LitInt 0)) (_module.Stream.Cons_q (Lit DatatypeTypeType |s#0@@3|))) (=> (or (not (= (LitInt |n#0@@3|) (LitInt 0))) (not true)) (and (_module.Stream.Cons_q (Lit DatatypeTypeType |s#0@@3|)) (|_module.__default.nth#canCall| _module._default.nth$T@@3 (LitInt (- |n#0@@3| 1)) (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |s#0@@3|))))))) (= (_module.__default.nth _module._default.nth$T@@3 ($LS $ly@@3) (LitInt |n#0@@3|) (Lit DatatypeTypeType |s#0@@3|)) (ite (= (LitInt |n#0@@3|) (LitInt 0)) (_module.Stream.head (Lit DatatypeTypeType |s#0@@3|)) (_module.__default.nth _module._default.nth$T@@3 ($LS $ly@@3) (LitInt (- |n#0@@3| 1)) (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |s#0@@3|))))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |731|
 :pattern ( (_module.__default.nth _module._default.nth$T@@3 ($LS $ly@@3) (LitInt |n#0@@3|) (Lit DatatypeTypeType |s#0@@3|)))
))))
...
(assert (forall ((_module._default.nth$T@@4 T@U) ($ly@@4 T@U) (|n#0@@4| Int) (|s#0@@4| T@U) ) (! (= (_module.__default.nth _module._default.nth$T@@4 ($LS $ly@@4) |n#0@@4| |s#0@@4|) (_module.__default.nth _module._default.nth$T@@4 $ly@@4 |n#0@@4| |s#0@@4|))
 :qid |unknown.0:0|
 :skolemid |724|
 :pattern ( (_module.__default.nth _module._default.nth$T@@4 ($LS $ly@@4) |n#0@@4| |s#0@@4|))
)))
...
(declare-fun _module._default.nth$T@@5 () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon8_Else_correct  (=> (or (not (= |n#0@@5| (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 6)) ($Is intType (int_2_U (- |n#0@@5| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0@@5| 1)) Tclass._System.nat) (=> (= |##n#0@0| (- |n#0@@5| 1)) (=> (and (and ($IsAlloc intType (int_2_U |##n#0@0|) Tclass._System.nat $Heap@@0) (_module.Stream.Cons_q |s#0@@5|)) (and (= |##s#0@0| (_module.Stream.tail |s#0@@5|)) ($IsAlloc DatatypeTypeType |##s#0@0| (Tclass._module.Stream _module._default.nth$T@@5) $Heap@@0))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (<= 0 |n#0@@5|) (= |##n#0@0| |n#0@@5|))) (=> (or (<= 0 |n#0@@5|) (= |##n#0@0| |n#0@@5|)) (=> (= (ControlFlow 0 4) (- 0 3)) (< |##n#0@0| |n#0@@5|)))))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (<= (LitInt 0) |n#0@@5|) ($Is DatatypeTypeType |s#0@@5| (Tclass._module.Stream _module._default.nth$T@@5))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
