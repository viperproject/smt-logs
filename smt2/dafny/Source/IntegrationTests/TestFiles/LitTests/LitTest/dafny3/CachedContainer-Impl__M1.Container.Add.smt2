...
(set-info :boogie-vc-id Impl$$M1.Container.Add)
...
))) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) M1.Container.Contents)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) M1.Container.Contents)) (|Set#UnionOne| |Set#Empty| |t#0|))))))))))))))))))))
