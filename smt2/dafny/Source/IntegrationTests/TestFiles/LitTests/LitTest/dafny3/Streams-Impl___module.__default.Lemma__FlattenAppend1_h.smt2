...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|_module._default.StreamOfNonEmpties#$_T0| T@U) ($ly@@1 T@U) (|M#0@@1| T@U) ) (!  (=> (and ($Is DatatypeTypeType |M#0@@1| (Tclass._module.Stream (Tclass._module.Stream |_module._default.StreamOfNonEmpties#$_T0|))) (_module.__default.StreamOfNonEmpties |_module._default.StreamOfNonEmpties#$_T0| ($LS $ly@@1) |M#0@@1|)) (forall ((|_k#0| T@U) ) (! (_module.__default.StreamOfNonEmpties_h |_module._default.StreamOfNonEmpties#$_T0| ($LS $ly@@1) |_k#0| |M#0@@1|)
 :qid |Streamsdfy.211:20|
 :skolemid |673|
 :pattern ( (_module.__default.StreamOfNonEmpties_h |_module._default.StreamOfNonEmpties#$_T0| ($LS $ly@@1) |_k#0| |M#0@@1|))
)))
 :qid |unknown.0:0|
 :skolemid |674|
 :pattern ( (_module.__default.StreamOfNonEmpties |_module._default.StreamOfNonEmpties#$_T0| ($LS $ly@@1) |M#0@@1|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|_module._default.StreamOfNonEmpties#$_T0@@0| T@U) ($ly@@2 T@U) (|M#0@@2| T@U) ) (!  (=> (and ($Is DatatypeTypeType |M#0@@2| (Tclass._module.Stream (Tclass._module.Stream |_module._default.StreamOfNonEmpties#$_T0@@0|))) (forall ((|_k#0@@0| T@U) ) (! (_module.__default.StreamOfNonEmpties_h |_module._default.StreamOfNonEmpties#$_T0@@0| ($LS $ly@@2) |_k#0@@0| |M#0@@2|)
 :qid |Streamsdfy.211:20|
 :skolemid |673|
 :pattern ( (_module.__default.StreamOfNonEmpties_h |_module._default.StreamOfNonEmpties#$_T0@@0| ($LS $ly@@2) |_k#0@@0| |M#0@@2|))
))) (_module.__default.StreamOfNonEmpties |_module._default.StreamOfNonEmpties#$_T0@@0| ($LS $ly@@2) |M#0@@2|))
 :qid |unknown.0:0|
 :skolemid |675|
 :pattern ( (_module.__default.StreamOfNonEmpties |_module._default.StreamOfNonEmpties#$_T0@@0| ($LS $ly@@2) |M#0@@2|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((_module._default.PrependThenFlattenNonEmpties$_T0 T@U) ($ly@@3 T@U) (|prefix#0| T@U) (|M#0@@3| T@U) ) (!  (=> (or (|_module.__default.PrependThenFlattenNonEmpties#canCall| _module._default.PrependThenFlattenNonEmpties$_T0 |prefix#0| |M#0@@3|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |prefix#0| (Tclass._module.Stream _module._default.PrependThenFlattenNonEmpties$_T0)) ($Is DatatypeTypeType |M#0@@3| (Tclass._module.Stream (Tclass._module.Stream _module._default.PrependThenFlattenNonEmpties$_T0)))) (_module.__default.StreamOfNonEmpties _module._default.PrependThenFlattenNonEmpties$_T0 ($LS $LZ) |M#0@@3|)))) (and (and (=> (_module.Stream.Nil_q |prefix#0|) (=> (not (_module.Stream.Nil_q |M#0@@3|)) (let ((|N#1@@0| (_module.Stream.tail |M#0@@3|)))
(let ((|s#1@@0| ($Unbox DatatypeTypeType (_module.Stream.head |M#0@@3|))))
...
(|_module.__default.PrependThenFlattenNonEmpties#canCall| _module._default.PrependThenFlattenNonEmpties$_T0 |tl#1| |M#0@@3|)))) (= (_module.__default.PrependThenFlattenNonEmpties _module._default.PrependThenFlattenNonEmpties$_T0 ($LS $ly@@3) |prefix#0| |M#0@@3|) (ite (_module.Stream.Nil_q |prefix#0|) (ite (_module.Stream.Nil_q |M#0@@3|) |#_module.Stream.Nil| (let ((|N#0@@0| (_module.Stream.tail |M#0@@3|)))
(let ((|s#0@@0| ($Unbox DatatypeTypeType (_module.Stream.head |M#0@@3|))))
...
(|#_module.Stream.Cons| |hd#0| (_module.__default.PrependThenFlattenNonEmpties _module._default.PrependThenFlattenNonEmpties$_T0 $ly@@3 |tl#0| |M#0@@3|))))))))
 :qid |unknown.0:0|
 :skolemid |703|
 :pattern ( (_module.__default.PrependThenFlattenNonEmpties _module._default.PrependThenFlattenNonEmpties$_T0 ($LS $ly@@3) |prefix#0| |M#0@@3|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.append$_T0 T@U) ($ly@@4 T@U) (|M#0@@4| T@U) (|N#0@@1| T@U) ) (!  (=> (or (|_module.__default.append#canCall| _module._default.append$_T0 |M#0@@4| |N#0@@1|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |M#0@@4| (Tclass._module.Stream _module._default.append$_T0)) ($Is DatatypeTypeType |N#0@@1| (Tclass._module.Stream _module._default.append$_T0))))) (and (=> (not (_module.Stream.Nil_q |M#0@@4|)) (let ((|M'#1| (_module.Stream.tail |M#0@@4|)))
(|_module.__default.append#canCall| _module._default.append$_T0 |M'#1| |N#0@@1|))) (= (_module.__default.append _module._default.append$_T0 ($LS $ly@@4) |M#0@@4| |N#0@@1|) (ite (_module.Stream.Nil_q |M#0@@4|) |N#0@@1| (let ((|M'#0| (_module.Stream.tail |M#0@@4|)))
(let ((|t#0| (_module.Stream.head |M#0@@4|)))
(|#_module.Stream.Cons| |t#0| (_module.__default.append _module._default.append$_T0 $ly@@4 |M'#0| |N#0@@1|))))))))
 :qid |unknown.0:0|
 :skolemid |589|
 :pattern ( (_module.__default.append _module._default.append$_T0 ($LS $ly@@4) |M#0@@4| |N#0@@1|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|_module._default.StreamOfNonEmpties#$_T0@@3| T@U) ($ly@@8 T@U) (|_k#0@@3| T@U) (|M#0@@8| T@U) ) (!  (=> (or (|_module.__default.StreamOfNonEmpties_h#canCall| |_module._default.StreamOfNonEmpties#$_T0@@3| |_k#0@@3| |M#0@@8|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |M#0@@8| (Tclass._module.Stream (Tclass._module.Stream |_module._default.StreamOfNonEmpties#$_T0@@3|))))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@3|)) (=> (not (_module.Stream.Nil_q |M#0@@8|)) (let ((|N#3| (_module.Stream.tail |M#0@@8|)))
(let ((|s#3| ($Unbox DatatypeTypeType (_module.Stream.head |M#0@@8|))))
 (=> (_module.Stream.Cons_q |s#3|) (|_module.__default.StreamOfNonEmpties_h#canCall| |_module._default.StreamOfNonEmpties#$_T0@@3| (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1)) |N#3|)))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@3|)) (ite (_module.Stream.Nil_q |M#0@@8|) true (let ((|N#4| (_module.Stream.tail |M#0@@8|)))
(let ((|s#4| ($Unbox DatatypeTypeType (_module.Stream.head |M#0@@8|))))
 (and (_module.Stream.Cons_q |s#4|) (_module.__default.StreamOfNonEmpties_h |_module._default.StreamOfNonEmpties#$_T0@@3| $ly@@8 (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1)) |N#4|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@3|)) (forall ((|_k'#0| T@U) ) (!  (=> (|ORD#Less| |_k'#0| |_k#0@@3|) (|_module.__default.StreamOfNonEmpties_h#canCall| |_module._default.StreamOfNonEmpties#$_T0@@3| |_k'#0| |M#0@@8|))
 :qid |Streamsdfy.211:20|
 :skolemid |683|
 :pattern ( (_module.__default.StreamOfNonEmpties_h |_module._default.StreamOfNonEmpties#$_T0@@3| $ly@@8 |_k'#0| |M#0@@8|))
))))) (= (_module.__default.StreamOfNonEmpties_h |_module._default.StreamOfNonEmpties#$_T0@@3| ($LS $ly@@8) |_k#0@@3| |M#0@@8|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@3|)) (ite (_module.Stream.Nil_q |M#0@@8|) true (let ((|N#2| (_module.Stream.tail |M#0@@8|)))
(let ((|s#2| ($Unbox DatatypeTypeType (_module.Stream.head |M#0@@8|))))
 (and (_module.Stream.Cons_q |s#2|) (_module.__default.StreamOfNonEmpties_h |_module._default.StreamOfNonEmpties#$_T0@@3| $ly@@8 (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1)) |N#2|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@3|)) (forall ((|_k'#0@@0| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@0| |_k#0@@3|) (_module.__default.StreamOfNonEmpties_h |_module._default.StreamOfNonEmpties#$_T0@@3| $ly@@8 |_k'#0@@0| |M#0@@8|))
 :qid |Streamsdfy.211:20|
 :skolemid |682|
 :pattern ( (_module.__default.StreamOfNonEmpties_h |_module._default.StreamOfNonEmpties#$_T0@@3| $ly@@8 |_k'#0@@0| |M#0@@8|))
)))))))
 :qid |unknown.0:0|
 :skolemid |684|
 :pattern ( (_module.__default.StreamOfNonEmpties_h |_module._default.StreamOfNonEmpties#$_T0@@3| ($LS $ly@@8) |_k#0@@3| |M#0@@8|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((_module._default.PrependThenFlattenNonEmpties$_T0@@1 T@U) ($ly@@9 T@U) (|prefix#0@@1| T@U) (|M#0@@9| T@U) ) (!  (=> (or (|_module.__default.PrependThenFlattenNonEmpties#canCall| _module._default.PrependThenFlattenNonEmpties$_T0@@1 |prefix#0@@1| |M#0@@9|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |prefix#0@@1| (Tclass._module.Stream _module._default.PrependThenFlattenNonEmpties$_T0@@1)) ($Is DatatypeTypeType |M#0@@9| (Tclass._module.Stream (Tclass._module.Stream _module._default.PrependThenFlattenNonEmpties$_T0@@1)))) (_module.__default.StreamOfNonEmpties _module._default.PrependThenFlattenNonEmpties$_T0@@1 ($LS $LZ) |M#0@@9|)))) ($Is DatatypeTypeType (_module.__default.PrependThenFlattenNonEmpties _module._default.PrependThenFlattenNonEmpties$_T0@@1 $ly@@9 |prefix#0@@1| |M#0@@9|) (Tclass._module.Stream _module._default.PrependThenFlattenNonEmpties$_T0@@1)))
 :qid |unknown.0:0|
 :skolemid |700|
 :pattern ( (_module.__default.PrependThenFlattenNonEmpties _module._default.PrependThenFlattenNonEmpties$_T0@@1 $ly@@9 |prefix#0@@1| |M#0@@9|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.append$_T0@@0 T@U) ($ly@@10 T@U) (|M#0@@10| T@U) (|N#0@@2| T@U) ) (!  (=> (or (|_module.__default.append#canCall| _module._default.append$_T0@@0 |M#0@@10| |N#0@@2|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |M#0@@10| (Tclass._module.Stream _module._default.append$_T0@@0)) ($Is DatatypeTypeType |N#0@@2| (Tclass._module.Stream _module._default.append$_T0@@0))))) ($Is DatatypeTypeType (_module.__default.append _module._default.append$_T0@@0 $ly@@10 |M#0@@10| |N#0@@2|) (Tclass._module.Stream _module._default.append$_T0@@0)))
 :qid |unknown.0:0|
 :skolemid |586|
 :pattern ( (_module.__default.append _module._default.append$_T0@@0 $ly@@10 |M#0@@10| |N#0@@2|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) (_module._default.append$_T0@@1 T@U) ($ly@@13 T@U) (|M#0@@13| T@U) (|N#0@@3| T@U) ) (!  (=> (and (or (|_module.__default.append#canCall| _module._default.append$_T0@@1 |M#0@@13| |N#0@@3|) (and (< 1 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |M#0@@13| (Tclass._module.Stream _module._default.append$_T0@@1)) ($IsAlloc DatatypeTypeType |M#0@@13| (Tclass._module.Stream _module._default.append$_T0@@1) $Heap@@0)) (and ($Is DatatypeTypeType |N#0@@3| (Tclass._module.Stream _module._default.append$_T0@@1)) ($IsAlloc DatatypeTypeType |N#0@@3| (Tclass._module.Stream _module._default.append$_T0@@1) $Heap@@0))))) ($IsGoodHeap $Heap@@0)) ($IsAlloc DatatypeTypeType (_module.__default.append _module._default.append$_T0@@1 $ly@@13 |M#0@@13| |N#0@@3|) (Tclass._module.Stream _module._default.append$_T0@@1) $Heap@@0))
 :qid |Streamsdfy.8:16|
 :skolemid |587|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.__default.append _module._default.append$_T0@@1 $ly@@13 |M#0@@13| |N#0@@3|) (Tclass._module.Stream _module._default.append$_T0@@1) $Heap@@0))
))))
(assert (forall ((_module._default.append$_T0@@2 T@U) ($ly@@14 T@U) (|M#0@@14| T@U) (|N#0@@4| T@U) ) (! (= (_module.__default.append _module._default.append$_T0@@2 ($LS $ly@@14) |M#0@@14| |N#0@@4|) (_module.__default.append _module._default.append$_T0@@2 $ly@@14 |M#0@@14| |N#0@@4|))
 :qid |unknown.0:0|
 :skolemid |581|
 :pattern ( (_module.__default.append _module._default.append$_T0@@2 ($LS $ly@@14) |M#0@@14| |N#0@@4|))
)))
(assert (forall ((_module._default.PrependThenFlattenNonEmpties$_T0@@2 T@U) ($ly@@15 T@U) (|prefix#0@@2| T@U) (|M#0@@15| T@U) ) (! (= (_module.__default.PrependThenFlattenNonEmpties _module._default.PrependThenFlattenNonEmpties$_T0@@2 ($LS $ly@@15) |prefix#0@@2| |M#0@@15|) (_module.__default.PrependThenFlattenNonEmpties _module._default.PrependThenFlattenNonEmpties$_T0@@2 $ly@@15 |prefix#0@@2| |M#0@@15|))
 :qid |unknown.0:0|
 :skolemid |698|
 :pattern ( (_module.__default.PrependThenFlattenNonEmpties _module._default.PrependThenFlattenNonEmpties$_T0@@2 ($LS $ly@@15) |prefix#0@@2| |M#0@@15|))
)))
...
(declare-fun |_module._default.Lemma_FlattenAppend1#$T| () T@U)
...
(declare-fun |tl#0@0| () T@U)
(declare-fun |let#0_0_0#0#0| () T@U)
(declare-fun |hd#0@0| () T@U)
...
(declare-fun $Heap@@1 () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.Lemma__FlattenAppend1_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon8_Else_correct true))
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (|$PrefixEq#_module.Stream| |_module._default.Lemma_FlattenAppend1#$T| |_module._default.Lemma_FlattenAppend1#$T| |_k#0@@6| ($LS ($LS $LZ)) (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |s#7@@0| |M#1|) (_module.__default.append |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |s#7@@0| (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1|))) (=> (< 0 (|ORD#Offset| |_k#0@@6|)) (=> (_module.Stream.Nil_q (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |s#7@@0| |M#1|)) (_module.Stream.Nil_q (_module.__default.append |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |s#7@@0| (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1|))))))) (=> (or (|$PrefixEq#_module.Stream| |_module._default.Lemma_FlattenAppend1#$T| |_module._default.Lemma_FlattenAppend1#$T| |_k#0@@6| ($LS ($LS $LZ)) (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |s#7@@0| |M#1|) (_module.__default.append |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |s#7@@0| (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1|))) (=> (< 0 (|ORD#Offset| |_k#0@@6|)) (=> (_module.Stream.Nil_q (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |s#7@@0| |M#1|)) (_module.Stream.Nil_q (_module.__default.append |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |s#7@@0| (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1|)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (|$PrefixEq#_module.Stream| |_module._default.Lemma_FlattenAppend1#$T| |_module._default.Lemma_FlattenAppend1#$T| |_k#0@@6| ($LS ($LS $LZ)) (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |s#7@@0| |M#1|) (_module.__default.append |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |s#7@@0| (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1|))) (=> (< 0 (|ORD#Offset| |_k#0@@6|)) (=> (_module.Stream.Cons_q (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |s#7@@0| |M#1|)) (and (_module.Stream.Cons_q (_module.__default.append |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |s#7@@0| (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1|))) (and (= (_module.Stream.head (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |s#7@@0| |M#1|)) (_module.Stream.head (_module.__default.append |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |s#7@@0| (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1|)))) (|$PrefixEq#_module.Stream| |_module._default.Lemma_FlattenAppend1#$T| |_module._default.Lemma_FlattenAppend1#$T| (|ORD#Minus| |_k#0@@6| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |s#7@@0| |M#1|)) (_module.Stream.tail (_module.__default.append |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |s#7@@0| (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1|)))))))))) (=> (or (|$PrefixEq#_module.Stream| |_module._default.Lemma_FlattenAppend1#$T| |_module._default.Lemma_FlattenAppend1#$T| |_k#0@@6| ($LS ($LS $LZ)) (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |s#7@@0| |M#1|) (_module.__default.append |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |s#7@@0| (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1|))) (=> (< 0 (|ORD#Offset| |_k#0@@6|)) (=> (_module.Stream.Cons_q (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |s#7@@0| |M#1|)) (and (_module.Stream.Cons_q (_module.__default.append |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |s#7@@0| (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1|))) (and (= (_module.Stream.head (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |s#7@@0| |M#1|)) (_module.Stream.head (_module.__default.append |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |s#7@@0| (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1|)))) (|$PrefixEq#_module.Stream| |_module._default.Lemma_FlattenAppend1#$T| |_module._default.Lemma_FlattenAppend1#$T| (|ORD#Minus| |_k#0@@6| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |s#7@@0| |M#1|)) (_module.Stream.tail (_module.__default.append |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |s#7@@0| (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1|))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (or (|$PrefixEq#_module.Stream| |_module._default.Lemma_FlattenAppend1#$T| |_module._default.Lemma_FlattenAppend1#$T| |_k#0@@6| ($LS ($LS $LZ)) (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |s#7@@0| |M#1|) (_module.__default.append |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |s#7@@0| (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1|))) (or (=> (< 0 (|ORD#Offset| |_k#0@@6|)) (and (=> (_module.Stream.Nil_q (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |s#7@@0| |M#1|)) (_module.Stream.Nil_q (_module.__default.append |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |s#7@@0| (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1|)))) (=> (_module.Stream.Cons_q (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |s#7@@0| |M#1|)) (and (_module.Stream.Cons_q (_module.__default.append |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |s#7@@0| (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1|))) (and (= (_module.Stream.head (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |s#7@@0| |M#1|)) (_module.Stream.head (_module.__default.append |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |s#7@@0| (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1|)))) (|$PrefixEq#_module.Stream| |_module._default.Lemma_FlattenAppend1#$T| |_module._default.Lemma_FlattenAppend1#$T| (|ORD#Minus| |_k#0@@6| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |s#7@@0| |M#1|)) (_module.Stream.tail (_module.__default.append |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |s#7@@0| (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1|))))))))) (=> (and (or (not (= |_k#0@@6| (|ORD#FromNat| 0))) (not true)) (= (|ORD#Offset| |_k#0@@6|) 0)) (|$Eq#_module.Stream| |_module._default.Lemma_FlattenAppend1#$T| |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |s#7@@0| |M#1|) (_module.__default.append |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |s#7@@0| (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1|)))))))))))))
(let ((anon8_Then_correct  (=> (= |s#7@@0| (|#_module.Stream.Cons| |_mcc#0#0@0| |_mcc#1#0@0|)) (=> (and (and ($IsBox |_mcc#0#0@0| |_module._default.Lemma_FlattenAppend1#$T|) ($IsAllocBox |_mcc#0#0@0| |_module._default.Lemma_FlattenAppend1#$T| $Heap@0)) (and ($Is DatatypeTypeType |_mcc#1#0@0| (Tclass._module.Stream |_module._default.Lemma_FlattenAppend1#$T|)) ($IsAlloc DatatypeTypeType |_mcc#1#0@0| (Tclass._module.Stream |_module._default.Lemma_FlattenAppend1#$T|) $Heap@0))) (=> (and (and (and (and ($Is DatatypeTypeType |tl#0@0| (Tclass._module.Stream |_module._default.Lemma_FlattenAppend1#$T|)) ($IsAlloc DatatypeTypeType |tl#0@0| (Tclass._module.Stream |_module._default.Lemma_FlattenAppend1#$T|) $Heap@0)) (= |let#0_0_0#0#0| |_mcc#1#0@0|)) (and ($Is DatatypeTypeType |let#0_0_0#0#0| (Tclass._module.Stream |_module._default.Lemma_FlattenAppend1#$T|)) (= |tl#0@0| |let#0_0_0#0#0|))) (and (and (and ($IsBox |hd#0@0| |_module._default.Lemma_FlattenAppend1#$T|) ($IsAllocBox |hd#0@0| |_module._default.Lemma_FlattenAppend1#$T| $Heap@0)) (= |let#0_0_1#0#0| |_mcc#0#0@0|)) (and ($IsBox |let#0_0_1#0#0| |_module._default.Lemma_FlattenAppend1#$T|) (= |hd#0@0| |let#0_0_1#0#0|)))) (and (=> (= (ControlFlow 0 7) (- 0 12)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 7) (- 0 11)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@6|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@6|)) (=> (= |_k##0@0| (|ORD#Minus| |_k#0@@6| (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (=> (|_module.__default.StreamOfNonEmpties#canCall| |_module._default.Lemma_FlattenAppend1#$T| |M#1|) (or (_module.__default.StreamOfNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |M#1|) (=> (_module.Stream.Nil_q |M#1|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (|_module.__default.StreamOfNonEmpties#canCall| |_module._default.Lemma_FlattenAppend1#$T| |M#1|) (or (_module.__default.StreamOfNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |M#1|) (=> (_module.Stream.Nil_q |M#1|) (U_2_bool (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (=> (|_module.__default.StreamOfNonEmpties#canCall| |_module._default.Lemma_FlattenAppend1#$T| |M#1|) (or (_module.__default.StreamOfNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |M#1|) (=> (not (_module.Stream.Nil_q |M#1|)) (let ((|s#8@@0| ($Unbox DatatypeTypeType (_module.Stream.head |M#1|))))
(_module.Stream.Cons_q |s#8@@0|)))))) (=> (=> (|_module.__default.StreamOfNonEmpties#canCall| |_module._default.Lemma_FlattenAppend1#$T| |M#1|) (or (_module.__default.StreamOfNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |M#1|) (=> (not (_module.Stream.Nil_q |M#1|)) (let ((|s#8@@1| ($Unbox DatatypeTypeType (_module.Stream.head |M#1|))))
(_module.Stream.Cons_q |s#8@@1|))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (=> (|_module.__default.StreamOfNonEmpties#canCall| |_module._default.Lemma_FlattenAppend1#$T| |M#1|) (or (_module.__default.StreamOfNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |M#1|) (=> (not (_module.Stream.Nil_q |M#1|)) (let ((|N#6@@0| (_module.Stream.tail |M#1|)))
(_module.__default.StreamOfNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |N#6@@0|)))))) (=> (=> (|_module.__default.StreamOfNonEmpties#canCall| |_module._default.Lemma_FlattenAppend1#$T| |M#1|) (or (_module.__default.StreamOfNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |M#1|) (=> (not (_module.Stream.Nil_q |M#1|)) (let ((|N#6@@1| (_module.Stream.tail |M#1|)))
(_module.__default.StreamOfNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS ($LS $LZ)) |N#6@@1|))))) (=> (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (=> (and (and (and (|_module.__default.PrependThenFlattenNonEmpties#canCall| |_module._default.Lemma_FlattenAppend1#$T| |tl#0@0| |M#1|) (and (|_module.__default.PrependThenFlattenNonEmpties#canCall| |_module._default.Lemma_FlattenAppend1#$T| (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1|) (|_module.__default.append#canCall| |_module._default.Lemma_FlattenAppend1#$T| |tl#0@0| (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1|)))) (|$PrefixEq#_module.Stream| |_module._default.Lemma_FlattenAppend1#$T| |_module._default.Lemma_FlattenAppend1#$T| |_k##0@0| ($LS ($LS $LZ)) (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |tl#0@0| |M#1|) (_module.__default.append |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |tl#0@0| (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#1|)))) (and (= $Heap@0 $Heap@2) (= (ControlFlow 0 7) 2))) GeneratedUnifiedExit_correct))))))))))))))))))
(let ((anon7_Else_correct  (=> (or (not (= |s#7@@0| |#_module.Stream.Nil|)) (not true)) (and (=> (= (ControlFlow 0 14) 7) anon8_Then_correct) (=> (= (ControlFlow 0 14) 13) anon8_Else_correct)))))
(let ((anon7_Then_correct  (=> (and (= |s#7@@0| |#_module.Stream.Nil|) (= (ControlFlow 0 6) 2)) GeneratedUnifiedExit_correct)))
(let ((anon6_Then_correct  (=> (< 0 (|ORD#Offset| |_k#0@@6|)) (and (=> (= (ControlFlow 0 15) 6) anon7_Then_correct) (=> (= (ControlFlow 0 15) 14) anon7_Else_correct)))))
(let ((anon6_Else_correct  (=> (<= (|ORD#Offset| |_k#0@@6|) 0) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1)) (and (forall ((|_k'#0@@1| T@U) (|s#12| T@U) (|M#2| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |s#12| (Tclass._module.Stream |_module._default.Lemma_FlattenAppend1#$T|)) ($Is DatatypeTypeType |M#2| (Tclass._module.Stream (Tclass._module.Stream |_module._default.Lemma_FlattenAppend1#$T|)))) (and (|ORD#Less| |_k'#0@@1| |_k#0@@6|) (_module.__default.StreamOfNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |M#2|))) (|$PrefixEq#_module.Stream| |_module._default.Lemma_FlattenAppend1#$T| |_module._default.Lemma_FlattenAppend1#$T| |_k'#0@@1| ($LS ($LS $LZ)) (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |s#12| |M#2|) (_module.__default.append |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |s#12| (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#2|))))
 :qid |Streamsdfy.341:16|
 :skolemid |737|
 :pattern ( (_module.__default.append |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |s#12| (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |#_module.Stream.Nil| |M#2|)) (|ORD#Less| |_k'#0@@1| |_k#0@@6|))
 :pattern ( (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |s#12| |M#2|) (|ORD#Less| |_k'#0@@1| |_k#0@@6|))
)) (= (ControlFlow 0 5) 2))) GeneratedUnifiedExit_correct))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (|$IsA#_module.Stream| |s#7@@0|) (|$IsA#_module.Stream| |M#1|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@1 $Heap@0) (forall ((|$ih#_k0#0| T@U) (|$ih#s0#0| T@U) (|$ih#M0#0| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |$ih#s0#0| (Tclass._module.Stream |_module._default.Lemma_FlattenAppend1#$T|)) ($Is DatatypeTypeType |$ih#M0#0| (Tclass._module.Stream (Tclass._module.Stream |_module._default.Lemma_FlattenAppend1#$T|)))) (_module.__default.StreamOfNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |$ih#M0#0|)) (|ORD#Less| |$ih#_k0#0| |_k#0@@6|)) (|$PrefixEq#_module.Stream| |_module._default.Lemma_FlattenAppend1#$T| |_module._default.Lemma_FlattenAppend1#$T| |$ih#_k0#0| ($LS ($LS $LZ)) (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |$ih#s0#0| |$ih#M0#0|) (_module.__default.append |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |$ih#s0#0| (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) (Lit DatatypeTypeType |#_module.Stream.Nil|) |$ih#M0#0|))))
 :qid |Streamsdfy.341:16|
 :skolemid |735|
 :pattern ( (|$PrefixEq#_module.Stream| |_module._default.Lemma_FlattenAppend1#$T| |_module._default.Lemma_FlattenAppend1#$T| |$ih#_k0#0| ($LS ($LS $LZ)) (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |$ih#s0#0| |$ih#M0#0|) (_module.__default.append |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |$ih#s0#0| (_module.__default.PrependThenFlattenNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) (Lit DatatypeTypeType |#_module.Stream.Nil|) |$ih#M0#0|))))
)))) (and (=> (= (ControlFlow 0 16) 15) anon6_Then_correct) (=> (= (ControlFlow 0 16) 5) anon6_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and ($Is DatatypeTypeType |s#7@@0| (Tclass._module.Stream |_module._default.Lemma_FlattenAppend1#$T|)) ($IsAlloc DatatypeTypeType |s#7@@0| (Tclass._module.Stream |_module._default.Lemma_FlattenAppend1#$T|) $Heap@@1)) (|$IsA#_module.Stream| |s#7@@0|)) (=> (and (and (and (and ($Is DatatypeTypeType |M#1| (Tclass._module.Stream (Tclass._module.Stream |_module._default.Lemma_FlattenAppend1#$T|))) ($IsAlloc DatatypeTypeType |M#1| (Tclass._module.Stream (Tclass._module.Stream |_module._default.Lemma_FlattenAppend1#$T|)) $Heap@@1)) (|$IsA#_module.Stream| |M#1|)) (= 4 $FunctionContextHeight)) (and (and (|_module.__default.StreamOfNonEmpties#canCall| |_module._default.Lemma_FlattenAppend1#$T| |M#1|) (and (_module.__default.StreamOfNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |M#1|) (ite (_module.Stream.Nil_q |M#1|) true (let ((|N#9@@0| (_module.Stream.tail |M#1|)))
(let ((|s#11| ($Unbox DatatypeTypeType (_module.Stream.head |M#1|))))
 (and (_module.Stream.Cons_q |s#11|) (_module.__default.StreamOfNonEmpties |_module._default.Lemma_FlattenAppend1#$T| ($LS $LZ) |N#9@@0|))))))) (= (ControlFlow 0 17) 16))) anon0_correct)))))
