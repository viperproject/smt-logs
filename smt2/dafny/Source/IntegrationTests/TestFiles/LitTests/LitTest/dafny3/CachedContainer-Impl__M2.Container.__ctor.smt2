...
(assert (forall ((M2.Container$T@@16 T@U) ($h@@7 T@U) ($o@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (or (not (= $o@@11 null)) (not true)) (= (dtype $o@@11) (Tclass.M2.Container? M2.Container$T@@16)))) ($Is SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@11) M2.Container.elems)) (TSeq M2.Container$T@@16)))
 :qid |unknown.0:0|
 :skolemid |1550|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@11) M2.Container.elems)) (Tclass.M2.Container? M2.Container$T@@16))
)))
(assert (forall ((M2.Container$T@@17 T@U) ($h@@8 T@U) ($o@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (or (not (= $o@@12 null)) (not true)) (= (dtype $o@@12) (Tclass.M2.Container? M2.Container$T@@17)))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@12) M2.Container.Contents)) (TSet M2.Container$T@@17)))
 :qid |unknown.0:0|
 :skolemid |1618|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@12) M2.Container.Contents)) (Tclass.M2.Container? M2.Container$T@@17))
)))
...
(set-info :boogie-vc-id Impl$$M2.Container.__ctor)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#8| null $Heap@@2 alloc false)) (= this.elems@0 (Lit SeqType |Seq#Empty|))) (and (= this.Contents@0 (Lit SetType |Set#Empty|)) (= this.Repr@0 (|Set#UnionOne| |Set#Empty| ($Box refType this@@5))))) (=> (and (and (and (and (or (not (= this@@5 null)) (not true)) ($Is refType this@@5 (Tclass.M2.Container? M2.Container$T@@21))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@5) alloc)))) (= ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@5) M2.Container.elems)) this.elems@0))) (and (and (= ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@5) M2.Container.Contents)) this.Contents@0) (= ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@5) M2.Container.Repr)) this.Repr@0)) (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@2 this@@5 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@5) alloc ($Box boolType (bool_2_U true))))) ($IsGoodHeap $Heap@0)))) (and (and (and ($IsHeapAnchor $Heap@0) ($IsAllocBox ($Box refType this@@5) (Tclass.M2.Container? M2.Container$T@@21) $Heap@0)) (and (|M2.Container.Valid_k_k#canCall| M2.Container$T@@21 $Heap@0 this@@5) (|M2.Container.Valid_k_k#canCall| M2.Container$T@@21 $Heap@0 this@@5))) (and (and (M2.Container.Valid_k_k M2.Container$T@@21 $Heap@0 this@@5) ($IsAllocBox ($Box refType this@@5) (Tclass.M2.Container? M2.Container$T@@21) $Heap@0)) (and (|M2.Container.Valid_k#canCall| M2.Container$T@@21 $Heap@0 this@@5) (|M2.Container.Valid_k#canCall| M2.Container$T@@21 $Heap@0 this@@5))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (M2.Container.Valid_k M2.Container$T@@21 $Heap@0 this@@5)) (=> (M2.Container.Valid_k M2.Container$T@@21 $Heap@0 this@@5) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> false (=> (|M2.Container.Valid#canCall| M2.Container$T@@21 $Heap@0 this@@5) (or (M2.Container.Valid M2.Container$T@@21 $Heap@0 this@@5) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) M2.Container.Repr)) ($Box refType this@@5)))))) (=> (=> false (=> (|M2.Container.Valid#canCall| M2.Container$T@@21 $Heap@0 this@@5) (or (M2.Container.Valid M2.Container$T@@21 $Heap@0 this@@5) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) M2.Container.Repr)) ($Box refType this@@5))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> false (=> (|M2.Container.Valid#canCall| M2.Container$T@@21 $Heap@0 this@@5) (or (M2.Container.Valid M2.Container$T@@21 $Heap@0 this@@5) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) M2.Container.Repr)) ($Box refType null))))))) (=> (=> false (=> (|M2.Container.Valid#canCall| M2.Container$T@@21 $Heap@0 this@@5) (or (M2.Container.Valid M2.Container$T@@21 $Heap@0 this@@5) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) M2.Container.Repr)) ($Box refType null)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> false (=> (|M2.Container.Valid#canCall| M2.Container$T@@21 $Heap@0 this@@5) (or (M2.Container.Valid M2.Container$T@@21 $Heap@0 this@@5) (M2.Container.Valid_k M2.Container$T@@21 $Heap@0 this@@5))))) (=> (=> false (=> (|M2.Container.Valid#canCall| M2.Container$T@@21 $Heap@0 this@@5) (or (M2.Container.Valid M2.Container$T@@21 $Heap@0 this@@5) (M2.Container.Valid_k M2.Container$T@@21 $Heap@0 this@@5)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> false (and (forall (($o@@13 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) M2.Container.Repr)) ($Box refType $o@@13)) (or (not (= $o@@13 null)) (not true)))
 :qid |CachedContainerdfy.40:5|
 :skolemid |1585|
 :pattern (  (or (not (= $o@@13 null)) (not true)))
)) (forall (($o@@14 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) M2.Container.Repr)) ($Box refType $o@@14)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@14) alloc)))))
 :qid |CachedContainerdfy.40:5|
 :skolemid |1586|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) M2.Container.Repr)) ($Box refType $o@@14)))
))))) (=> (=> false (and (forall (($o@@15 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) M2.Container.Repr)) ($Box refType $o@@15)) (or (not (= $o@@15 null)) (not true)))
 :qid |CachedContainerdfy.40:5|
 :skolemid |1585|
 :pattern (  (or (not (= $o@@15 null)) (not true)))
)) (forall (($o@@16 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) M2.Container.Repr)) ($Box refType $o@@16)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@16) alloc)))))
 :qid |CachedContainerdfy.40:5|
 :skolemid |1586|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) M2.Container.Repr)) ($Box refType $o@@16)))
)))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) M2.Container.Contents)) |Set#Empty|)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 8) 2))) anon0_correct)))
