...
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.Theorem2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (|$IsA#_module.Stream| |M#0@@3|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@0 $Heap@0)) (and (forall ((|$ih#M0#0| T@U) ) (! true
 :qid |Streamsdfy.131:16|
 :skolemid |641|
 :pattern ( (_module.__default.append Tclass._module.X ($LS $LZ) (Lit DatatypeTypeType |#_module.Stream.Nil|) |$ih#M0#0|))
)) (= (ControlFlow 0 2) (- 0 1)))) (|$Eq#_module.Stream| Tclass._module.X Tclass._module.X ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) (Lit DatatypeTypeType |#_module.Stream.Nil|) |M#0@@3|) |M#0@@3|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and ($Is DatatypeTypeType |M#0@@3| (Tclass._module.Stream Tclass._module.X)) ($IsAlloc DatatypeTypeType |M#0@@3| (Tclass._module.Stream Tclass._module.X) $Heap@@0)) (|$IsA#_module.Stream| |M#0@@3|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
