...
(declare-fun _module.__default.Repeat (T@U Int) T@U)
(declare-fun |_module.__default.Repeat#canCall| (Int) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly T@U) (|n#0| Int) ) (!  (=> (or (|_module.__default.Repeat#canCall| |n#0|) (< 1 $FunctionContextHeight)) ($Is DatatypeTypeType (_module.__default.Repeat $ly |n#0|) (Tclass._module.Stream TInt)))
 :qid |SimpleCoinductiondfy.50:16|
 :skolemid |627|
 :pattern ( (_module.__default.Repeat $ly |n#0|))
))))
...
(assert (forall (($ly@@0 T@U) (|s#0| T@U) ) (! (= (_module.__default.Inc ($LS $ly@@0) |s#0|) (_module.__default.Inc $ly@@0 |s#0|))
 :qid |SimpleCoinductiondfy.19:16|
 :skolemid |613|
 :pattern ( (_module.__default.Inc ($LS $ly@@0) |s#0|))
)))
(assert (forall (($ly@@1 T@U) (|n#0@@0| Int) ) (! (= (_module.__default.Repeat ($LS $ly@@1) |n#0@@0|) (_module.__default.Repeat $ly@@1 |n#0@@0|))
 :qid |SimpleCoinductiondfy.50:16|
 :skolemid |625|
 :pattern ( (_module.__default.Repeat ($LS $ly@@1) |n#0@@0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) (|s#0@@0| T@U) ) (!  (=> (or (|_module.__default.Inc#canCall| |s#0@@0|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |s#0@@0| (Tclass._module.Stream TInt)))) (and (and (_module.Stream.Cons_q |s#0@@0|) (and (_module.Stream.Cons_q |s#0@@0|) (|_module.__default.Inc#canCall| (_module.Stream.tail |s#0@@0|)))) (= (_module.__default.Inc ($LS $ly@@2) |s#0@@0|) (|#_module.Stream.Cons| ($Box intType (int_2_U (+ (U_2_int ($Unbox intType (_module.Stream.head |s#0@@0|))) 1))) (_module.__default.Inc $ly@@2 (_module.Stream.tail |s#0@@0|))))))
 :qid |SimpleCoinductiondfy.19:16|
 :skolemid |617|
 :pattern ( (_module.__default.Inc ($LS $ly@@2) |s#0@@0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@3 T@U) (|s#0@@1| T@U) ) (!  (=> (or (|_module.__default.Inc#canCall| |s#0@@1|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |s#0@@1| (Tclass._module.Stream TInt)))) ($Is DatatypeTypeType (_module.__default.Inc $ly@@3 |s#0@@1|) (Tclass._module.Stream TInt)))
 :qid |SimpleCoinductiondfy.19:16|
 :skolemid |615|
 :pattern ( (_module.__default.Inc $ly@@3 |s#0@@1|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@4 T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.__default.Repeat#canCall| |n#0@@1|) (< 1 $FunctionContextHeight)) (and (|_module.__default.Repeat#canCall| |n#0@@1|) (= (_module.__default.Repeat ($LS $ly@@4) |n#0@@1|) (|#_module.Stream.Cons| ($Box intType (int_2_U |n#0@@1|)) (_module.__default.Repeat $ly@@4 |n#0@@1|)))))
 :qid |SimpleCoinductiondfy.50:16|
 :skolemid |629|
 :pattern ( (_module.__default.Repeat ($LS $ly@@4) |n#0@@1|))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.RepeatLemma_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (|$PrefixEq#_module.Stream| TInt TInt |_k#0| ($LS ($LS $LZ)) (_module.__default.Inc ($LS $LZ) (_module.__default.Repeat ($LS $LZ) |n#1|)) (_module.__default.Repeat ($LS $LZ) (+ |n#1| 1))) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (_module.__default.Inc ($LS ($LS $LZ)) (_module.__default.Repeat ($LS ($LS $LZ)) |n#1|))) (and (_module.Stream.Cons_q (_module.__default.Repeat ($LS ($LS $LZ)) (+ |n#1| 1))) (and (= (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Inc ($LS ($LS $LZ)) (_module.__default.Repeat ($LS ($LS $LZ)) |n#1|))))) (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Repeat ($LS ($LS $LZ)) (+ |n#1| 1)))))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.Inc ($LS ($LS $LZ)) (_module.__default.Repeat ($LS ($LS $LZ)) |n#1|))) (_module.Stream.tail (_module.__default.Repeat ($LS ($LS $LZ)) (+ |n#1| 1)))))))))) (=> (or (|$PrefixEq#_module.Stream| TInt TInt |_k#0| ($LS ($LS $LZ)) (_module.__default.Inc ($LS $LZ) (_module.__default.Repeat ($LS $LZ) |n#1|)) (_module.__default.Repeat ($LS $LZ) (+ |n#1| 1))) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (_module.__default.Inc ($LS ($LS $LZ)) (_module.__default.Repeat ($LS ($LS $LZ)) |n#1|))) (and (_module.Stream.Cons_q (_module.__default.Repeat ($LS ($LS $LZ)) (+ |n#1| 1))) (and (= (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Inc ($LS ($LS $LZ)) (_module.__default.Repeat ($LS ($LS $LZ)) |n#1|))))) (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Repeat ($LS ($LS $LZ)) (+ |n#1| 1)))))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.Inc ($LS ($LS $LZ)) (_module.__default.Repeat ($LS ($LS $LZ)) |n#1|))) (_module.Stream.tail (_module.__default.Repeat ($LS ($LS $LZ)) (+ |n#1| 1))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (or (|$PrefixEq#_module.Stream| TInt TInt |_k#0| ($LS ($LS $LZ)) (_module.__default.Inc ($LS $LZ) (_module.__default.Repeat ($LS $LZ) |n#1|)) (_module.__default.Repeat ($LS $LZ) (+ |n#1| 1))) (or (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (_module.__default.Inc ($LS ($LS $LZ)) (_module.__default.Repeat ($LS ($LS $LZ)) |n#1|))) (and (_module.Stream.Cons_q (_module.__default.Repeat ($LS ($LS $LZ)) (+ |n#1| 1))) (and (= (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Inc ($LS ($LS $LZ)) (_module.__default.Repeat ($LS ($LS $LZ)) |n#1|))))) (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Repeat ($LS ($LS $LZ)) (+ |n#1| 1)))))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.Inc ($LS ($LS $LZ)) (_module.__default.Repeat ($LS ($LS $LZ)) |n#1|))) (_module.Stream.tail (_module.__default.Repeat ($LS ($LS $LZ)) (+ |n#1| 1)))))))) (=> (and (or (not (= |_k#0| (|ORD#FromNat| 0))) (not true)) (= (|ORD#Offset| |_k#0|) 0)) (|$Eq#_module.Stream| TInt TInt ($LS ($LS $LZ)) (_module.__default.Inc ($LS $LZ) (_module.__default.Repeat ($LS $LZ) |n#1|)) (_module.__default.Repeat ($LS $LZ) (+ |n#1| 1)))))))))))
(let ((anon3_Else_correct  (=> (<= (|ORD#Offset| |_k#0|) 0) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap $Heap@1)) (and (forall ((|_k'#0| T@U) (|n#2| Int) (|_t#0#0| Int) ) (!  (=> (and (= |_t#0#0| (+ |n#2| 1)) (|ORD#Less| |_k'#0| |_k#0|)) (|$PrefixEq#_module.Stream| TInt TInt |_k'#0| ($LS ($LS $LZ)) (_module.__default.Inc ($LS $LZ) (_module.__default.Repeat ($LS $LZ) |n#2|)) (_module.__default.Repeat ($LS $LZ) |_t#0#0|)))
 :qid |SimpleCoinductiondfy.55:16|
 :skolemid |632|
 :pattern ( (_module.__default.Repeat ($LS $LZ) |_t#0#0|) (_module.__default.Repeat ($LS $LZ) |n#2|) (|ORD#Less| |_k'#0| |_k#0|))
)) (= (ControlFlow 0 7) 2))) GeneratedUnifiedExit_correct))))
(let ((anon3_Then_correct  (=> (< 0 (|ORD#Offset| |_k#0|)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0|)) (=> (= |_k##0@0| (|ORD#Minus| |_k#0| (|ORD#FromNat| 1))) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (and (|_module.__default.Repeat#canCall| |n#1|) (|_module.__default.Inc#canCall| (_module.__default.Repeat ($LS $LZ) |n#1|))) (|_module.__default.Repeat#canCall| (+ |n#1| 1))) (|$PrefixEq#_module.Stream| TInt TInt |_k##0@0| ($LS ($LS $LZ)) (_module.__default.Inc ($LS $LZ) (_module.__default.Repeat ($LS $LZ) |n#1|)) (_module.__default.Repeat ($LS $LZ) (+ |n#1| 1)))) (and (= $Heap $Heap@0) (= (ControlFlow 0 4) 2))) GeneratedUnifiedExit_correct))))))))))
