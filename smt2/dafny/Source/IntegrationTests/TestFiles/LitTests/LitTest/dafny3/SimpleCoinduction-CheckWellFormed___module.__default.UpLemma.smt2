...
(declare-fun |k#0| () Int)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.UpLemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (and ($IsAlloc intType (int_2_U |n#0@@2|) TInt $Heap@0) (|_module.__default.Up#canCall| |n#0@@2|)) (and (_module.Stream.Cons_q (_module.__default.Up ($LS $LZ) |n#0@@2|)) (= |##s#0@0| (_module.__default.Up ($LS $LZ) |n#0@@2|))))) (and (and (and ($IsAlloc DatatypeTypeType |##s#0@0| (Tclass._module.Stream TInt) $Heap@0) (|_module.__default.Inc#canCall| (_module.__default.Up ($LS $LZ) |n#0@@2|))) (and (_module.Stream.Cons_q (_module.__default.Inc ($LS $LZ) (_module.__default.Up ($LS $LZ) |n#0@@2|))) (= |##n#1@0| (+ |n#0@@2| 1)))) (and (and ($IsAlloc intType (int_2_U |##n#1@0|) TInt $Heap@0) (|_module.__default.Up#canCall| (+ |n#0@@2| 1))) (and (_module.Stream.Cons_q (_module.__default.Up ($LS $LZ) (+ |n#0@@2| 1))) (= (ControlFlow 0 2) (- 0 1)))))) (<= 0 |k#0|)))))
