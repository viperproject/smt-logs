...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@2 T@U) (|n#0@@2| Int) ) (!  (=> (or (|_module.__default.SmallTree#canCall| |n#0@@2|) (and (< 2 $FunctionContextHeight) (<= (LitInt 0) |n#0@@2|))) (and (|_module.__default.SmallTrees#canCall| |n#0@@2|) (= (_module.__default.SmallTree ($LS $ly@@2) |n#0@@2|) (|#_module.Tree.Node| (_module.__default.SmallTrees $ly@@2 |n#0@@2|)))))
 :qid |WideTreesdfy.32:16|
 :skolemid |638|
 :pattern ( (_module.__default.SmallTree ($LS $ly@@2) |n#0@@2|))
))))
...
(assert (forall (($ly@@3 T@U) (|n#0@@3| Int) ) (! (= (_module.__default.SmallTree ($LS $ly@@3) |n#0@@3|) (_module.__default.SmallTree $ly@@3 |n#0@@3|))
 :qid |WideTreesdfy.32:16|
 :skolemid |634|
 :pattern ( (_module.__default.SmallTree ($LS $ly@@3) |n#0@@3|))
)))
(assert (forall (($ly@@4 T@U) (|n#0@@4| Int) ) (! (= (_module.__default.SmallTrees ($LS $ly@@4) |n#0@@4|) (_module.__default.SmallTrees $ly@@4 |n#0@@4|))
 :qid |WideTreesdfy.36:16|
 :skolemid |640|
 :pattern ( (_module.__default.SmallTrees ($LS $ly@@4) |n#0@@4|))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.SmallTrees)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon8_Else_correct  (=> (and (or (not (= |n#0@@5| (LitInt 0))) (not true)) (= (ControlFlow 0 4) (- 0 3))) ($Is intType (int_2_U (- |n#0@@5| 1)) Tclass._System.nat))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |n#0@@5|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 6) 5))) anon0_correct)))
