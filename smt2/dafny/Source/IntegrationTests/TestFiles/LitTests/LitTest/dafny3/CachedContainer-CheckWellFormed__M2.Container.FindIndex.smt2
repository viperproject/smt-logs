...
(set-info :boogie-vc-id CheckWellFormed$$M2.Container.FindIndex)
...
(let ((anon4_Then_correct  (=> (and (< |j#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) M2.Container.elems)))) (= (ControlFlow 0 2) (- 0 1))) (and (<= 0 |j#0@0|) (< |j#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) M2.Container.elems))))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#8| null $Heap@@2 alloc false)) ($IsAllocBox ($Box refType this@@5) (Tclass.M2.Container? M2.Container$T@@21) $Heap@@2)) (=> (and (and (and (|M2.Container.Valid#canCall| M2.Container$T@@21 $Heap@@2 this@@5) (M2.Container.Valid M2.Container$T@@21 $Heap@@2 this@@5)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (forall (($o@@13 T@U) ) (!  (=> (and (or (not (= $o@@13 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@13) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@13) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@13)))
 :qid |CachedContainerdfy.91:12|
 :skolemid |1571|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@13))
)) ($HeapSucc $Heap@@2 $Heap@0)) (and (<= (LitInt 0) |j#0@0|) (<= |j#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) M2.Container.elems))))))) (and (=> (= (ControlFlow 0 4) 2) anon4_Then_correct) (=> (= (ControlFlow 0 4) 3) anon4_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and (or (not (= this@@5 null)) (not true)) (and ($Is refType this@@5 (Tclass.M2.Container M2.Container$T@@21)) ($IsAlloc refType this@@5 (Tclass.M2.Container M2.Container$T@@21) $Heap@@2)))) (=> (and (and (and ($IsBox |t#0| M2.Container$T@@21) ($IsAllocBox |t#0| M2.Container$T@@21 $Heap@@2)) (<= (LitInt 0) |j#0@@1|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct))))
