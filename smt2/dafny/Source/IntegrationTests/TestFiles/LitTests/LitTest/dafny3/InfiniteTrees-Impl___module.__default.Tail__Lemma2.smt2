...
(declare-fun $Heap@@0 () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.Tail__Lemma2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (_module.Stream.Cons_q (_module.__default.Tail _module._default.Tail_Lemma2$_T0 ($LS ($LS $LZ)) |s#0@@5| |n#0@@5|)))))
(let ((anon3_Else_correct  (=> (and (= |n#0@@5| 0) (= (ControlFlow 0 7) 2)) GeneratedUnifiedExit_correct)))
(let ((anon3_Then_correct  (=> (or (not (= |n#0@@5| 0)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 6)) ($Is intType (int_2_U (- |n#0@@5| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0@@5| 1)) Tclass._System.nat) (=> (= |n##0_0@0| (- |n#0@@5| 1)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (_module.Stream.Cons_q |s#0@@5|)) (=> (_module.Stream.Cons_q |s#0@@5|) (and (=> (= (ControlFlow 0 3) (- 0 4)) (_module.Stream.Cons_q (_module.__default.Tail _module._default.Tail_Lemma2$_T0 ($LS ($LS $LZ)) |s#0@@5| |n##0_0@0|))) (=> (_module.Stream.Cons_q (_module.__default.Tail _module._default.Tail_Lemma2$_T0 ($LS ($LS $LZ)) |s#0@@5| |n##0_0@0|)) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and (and (|$IsA#_module.Stream| (_module.Stream.tail (_module.__default.Tail _module._default.Tail_Lemma2$_T0 ($LS $LZ) |s#0@@5| |n##0_0@0|))) (|$IsA#_module.Stream| (_module.__default.Tail _module._default.Tail_Lemma2$_T0 ($LS $LZ) (_module.Stream.tail |s#0@@5|) |n##0_0@0|))) (and (|_module.__default.Tail#canCall| _module._default.Tail_Lemma2$_T0 |s#0@@5| |n##0_0@0|) (|_module.__default.Tail#canCall| _module._default.Tail_Lemma2$_T0 (_module.Stream.tail |s#0@@5|) |n##0_0@0|))) (|$Eq#_module.Stream| _module._default.Tail_Lemma2$_T0 _module._default.Tail_Lemma2$_T0 ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.Tail _module._default.Tail_Lemma2$_T0 ($LS ($LS $LZ)) |s#0@@5| |n##0_0@0|)) (_module.__default.Tail _module._default.Tail_Lemma2$_T0 ($LS ($LS $LZ)) (_module.Stream.tail |s#0@@5|) |n##0_0@0|))) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct))))))))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (|$IsA#_module.Stream| |s#0@@5|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@0 $Heap@0) (forall ((|$ih#s0#0| T@U) (|$ih#n0#0| Int) ) (!  (=> (and (and (and ($Is DatatypeTypeType |$ih#s0#0| (Tclass._module.Stream _module._default.Tail_Lemma2$_T0)) (<= (LitInt 0) |$ih#n0#0|)) (and (_module.Stream.Cons_q |$ih#s0#0|) (_module.Stream.Cons_q (_module.__default.Tail _module._default.Tail_Lemma2$_T0 ($LS $LZ) (_module.Stream.tail |$ih#s0#0|) |$ih#n0#0|)))) (and (<= 0 |$ih#n0#0|) (< |$ih#n0#0| |n#0@@5|))) (_module.Stream.Cons_q (_module.__default.Tail _module._default.Tail_Lemma2$_T0 ($LS $LZ) |$ih#s0#0| |$ih#n0#0|)))
 :qid |InfiniteTreesdfy.30:19|
 :skolemid |595|
 :pattern ( (_module.__default.Tail _module._default.Tail_Lemma2$_T0 ($LS $LZ) (_module.Stream.tail |$ih#s0#0|) |$ih#n0#0|))
)))) (and (=> (= (ControlFlow 0 8) 3) anon3_Then_correct) (=> (= (ControlFlow 0 8) 7) anon3_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (and ($Is DatatypeTypeType |s#0@@5| (Tclass._module.Stream _module._default.Tail_Lemma2$_T0)) ($IsAlloc DatatypeTypeType |s#0@@5| (Tclass._module.Stream _module._default.Tail_Lemma2$_T0) $Heap@@0)) (|$IsA#_module.Stream| |s#0@@5|)) (<= (LitInt 0) |n#0@@5|)) (and (and (= 3 $FunctionContextHeight) (_module.Stream.Cons_q |s#0@@5|)) (and (_module.Stream.Cons_q (_module.__default.Tail _module._default.Tail_Lemma2$_T0 ($LS ($LS $LZ)) (_module.Stream.tail |s#0@@5|) |n#0@@5|)) (= (ControlFlow 0 9) 8)))) anon0_correct))))
