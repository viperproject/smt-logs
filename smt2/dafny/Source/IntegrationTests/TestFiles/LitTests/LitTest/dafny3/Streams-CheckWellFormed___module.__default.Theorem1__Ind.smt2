...
(declare-fun |k#0| () Int)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Theorem1__Ind)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@0 $Heap@0)) (=> (and (and (and (and ($IsAlloc DatatypeTypeType |M#0@@6| (Tclass._module.Stream Tclass._module.X) $Heap@0) ($IsAlloc DatatypeTypeType |N#0@@4| (Tclass._module.Stream Tclass._module.X) $Heap@0)) (and (|_module.__default.append#canCall| Tclass._module.X |M#0@@6| |N#0@@4|) (= |##M#0@0| (_module.__default.append Tclass._module.X ($LS $LZ) |M#0@@6| |N#0@@4|)))) (and (and ($IsAlloc DatatypeTypeType |##M#0@0| (Tclass._module.Stream Tclass._module.X) $Heap@0) (|_module.__default.map__f#canCall| (_module.__default.append Tclass._module.X ($LS $LZ) |M#0@@6| |N#0@@4|))) (and ($IsAlloc DatatypeTypeType |M#0@@6| (Tclass._module.Stream Tclass._module.X) $Heap@0) (|_module.__default.map__f#canCall| |M#0@@6|)))) (and (and (and (= |##M#2@0| (_module.__default.map__f ($LS $LZ) |M#0@@6|)) ($IsAlloc DatatypeTypeType |##M#2@0| (Tclass._module.Stream Tclass._module.X) $Heap@0)) (and ($IsAlloc DatatypeTypeType |N#0@@4| (Tclass._module.Stream Tclass._module.X) $Heap@0) (|_module.__default.map__f#canCall| |N#0@@4|))) (and (and (= |##N#1@0| (_module.__default.map__f ($LS $LZ) |N#0@@4|)) ($IsAlloc DatatypeTypeType |##N#1@0| (Tclass._module.Stream Tclass._module.X) $Heap@0)) (and (|_module.__default.append#canCall| Tclass._module.X (_module.__default.map__f ($LS $LZ) |M#0@@6|) (_module.__default.map__f ($LS $LZ) |N#0@@4|)) (= (ControlFlow 0 2) (- 0 1)))))) (<= 0 |k#0|))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (<= (LitInt 0) |k#0|)) (and (and ($Is DatatypeTypeType |M#0@@6| (Tclass._module.Stream Tclass._module.X)) ($IsAlloc DatatypeTypeType |M#0@@6| (Tclass._module.Stream Tclass._module.X) $Heap@@0)) (|$IsA#_module.Stream| |M#0@@6|))) (and (and (and ($Is DatatypeTypeType |N#0@@4| (Tclass._module.Stream Tclass._module.X)) ($IsAlloc DatatypeTypeType |N#0@@4| (Tclass._module.Stream Tclass._module.X) $Heap@@0)) (|$IsA#_module.Stream| |N#0@@4|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
