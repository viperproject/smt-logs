...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.nth$T@@1 T@U) ($ly@@2 T@U) (|n#0@@1| Int) (|s#0@@1| T@U) ) (!  (=> (or (|_module.__default.nth#canCall| _module._default.nth$T@@1 |n#0@@1| |s#0@@1|) (and (< 1 $FunctionContextHeight) (and (<= (LitInt 0) |n#0@@1|) ($Is DatatypeTypeType |s#0@@1| (Tclass._module.Stream _module._default.nth$T@@1))))) ($IsBox (_module.__default.nth _module._default.nth$T@@1 $ly@@2 |n#0@@1| |s#0@@1|) _module._default.nth$T@@1))
 :qid |unknown.0:0|
 :skolemid |726|
 :pattern ( (_module.__default.nth _module._default.nth$T@@1 $ly@@2 |n#0@@1| |s#0@@1|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.nth$T@@2 T@U) ($ly@@3 T@U) (|n#0@@2| Int) (|s#0@@2| T@U) ) (!  (=> (and (or (|_module.__default.nth#canCall| _module._default.nth$T@@2 |n#0@@2| |s#0@@2|) (and (< 1 $FunctionContextHeight) (and (<= (LitInt 0) |n#0@@2|) (and ($Is DatatypeTypeType |s#0@@2| (Tclass._module.Stream _module._default.nth$T@@2)) ($IsAlloc DatatypeTypeType |s#0@@2| (Tclass._module.Stream _module._default.nth$T@@2) $Heap))))) ($IsGoodHeap $Heap)) ($IsAllocBox (_module.__default.nth _module._default.nth$T@@2 $ly@@3 |n#0@@2| |s#0@@2|) _module._default.nth$T@@2 $Heap))
 :qid |Abstemiousdfy.126:16|
 :skolemid |727|
 :pattern ( ($IsAllocBox (_module.__default.nth _module._default.nth$T@@2 $ly@@3 |n#0@@2| |s#0@@2|) _module._default.nth$T@@2 $Heap))
))))
...
(assert (forall (($ly@@6 T@U) ) (! (= (_module.__default.ones ($LS $ly@@6)) (_module.__default.ones $ly@@6))
 :qid |Abstemiousdfy.53:10|
 :skolemid |631|
 :pattern ( (_module.__default.ones ($LS $ly@@6)))
)))
(assert (forall ((_module._default.nth$T@@4 T@U) ($ly@@7 T@U) (|n#0@@4| Int) (|s#0@@4| T@U) ) (! (= (_module.__default.nth _module._default.nth$T@@4 ($LS $ly@@7) |n#0@@4| |s#0@@4|) (_module.__default.nth _module._default.nth$T@@4 $ly@@7 |n#0@@4| |s#0@@4|))
 :qid |unknown.0:0|
 :skolemid |724|
 :pattern ( (_module.__default.nth _module._default.nth$T@@4 ($LS $ly@@7) |n#0@@4| |s#0@@4|))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.Ones__Correct)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@0 $Heap@0)) (and (forall ((|$ih#n0#0| Int) ) (!  (=> (and (and (<= (LitInt 0) |$ih#n0#0|) (U_2_bool (Lit boolType (bool_2_U true)))) (and (<= 0 |$ih#n0#0|) (< |$ih#n0#0| |n#0@@5|))) (= (U_2_int ($Unbox intType (_module.__default.nth TInt ($LS $LZ) |$ih#n0#0| (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))))) (LitInt 1)))
 :qid |Abstemiousdfy.136:20|
 :skolemid |741|
 :pattern ( ($Unbox intType (_module.__default.nth TInt ($LS $LZ) |$ih#n0#0| (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ))))))
)) (= (ControlFlow 0 2) (- 0 1)))) (= (U_2_int ($Unbox intType (_module.__default.nth TInt ($LS ($LS $LZ)) |n#0@@5| (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ))))))) (LitInt 1))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (<= (LitInt 0) |n#0@@5|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct)))
