...
(|#_module.LList.Cons| (_module.__default.Apply _module._default.Lmap$_T0@@0 |f#0@@7| |x#0@@1|) (_module.__default.Lmap _module._default.Lmap$_T0@@0 $ly@@5 |f#0@@7| |xs#0|))))))))
 :qid |unknown.0:0|
 :skolemid |598|
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Lemma26)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@2 $Heap@0) ($IsAlloc intType (int_2_U |n#0@@5|) Tclass._System.nat $Heap@0))) (=> (and (and (and ($IsAlloc DatatypeTypeType |f#0@@11| (Tclass._module.FunctionHandle _module._default.Lemma26$A) $Heap@0) ($IsAlloc DatatypeTypeType |f#0@@11| (Tclass._module.FunctionHandle _module._default.Lemma26$A) $Heap@0)) (and ($IsAlloc DatatypeTypeType |x#0@@2| (Tclass._module.LList _module._default.Lemma26$A) $Heap@0) (|_module.__default.Lmap#canCall| _module._default.Lemma26$A |f#0@@11| |x#0@@2|))) (and (and (= |##arg#0@0| (_module.__default.Lmap _module._default.Lemma26$A ($LS $LZ) |f#0@@11| |x#0@@2|)) ($IsAlloc DatatypeTypeType |##arg#0@0| (Tclass._module.LList _module._default.Lemma26$A) $Heap@0)) (and (|_module.__default.LmapIter#canCall| _module._default.Lemma26$A |n#0@@5| |f#0@@11| (_module.__default.Lmap _module._default.Lemma26$A ($LS $LZ) |f#0@@11| |x#0@@2|)) (= (ControlFlow 0 2) (- 0 1))))) ($Is intType (int_2_U (+ |n#0@@5| 1)) Tclass._System.nat))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (<= (LitInt 0) |n#0@@5|)) (and (and ($Is DatatypeTypeType |f#0@@11| (Tclass._module.FunctionHandle _module._default.Lemma26$A)) ($IsAlloc DatatypeTypeType |f#0@@11| (Tclass._module.FunctionHandle _module._default.Lemma26$A) $Heap@@2)) (|$IsA#_module.FunctionHandle| |f#0@@11|))) (and (and (and ($Is DatatypeTypeType |x#0@@2| (Tclass._module.LList _module._default.Lemma26$A)) ($IsAlloc DatatypeTypeType |x#0@@2| (Tclass._module.LList _module._default.Lemma26$A) $Heap@@2)) (|$IsA#_module.LList| |x#0@@2|)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
