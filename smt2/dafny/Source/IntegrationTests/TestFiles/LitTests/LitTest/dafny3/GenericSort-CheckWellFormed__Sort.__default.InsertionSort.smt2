...
(assert (forall (($h0 T@U) ($h1 T@U) (|a#0| T@U) (|low#0| Int) (|high#0| Int) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|Sort.__default.Sorted#canCall| $h0 |a#0| |low#0| |high#0|) ($Is refType |a#0| (Tclass._System.array Tclass.Sort.O.Abs.T)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@2 T@U) ($f T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (= $o@@2 |a#0|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@2) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@2) $f)))
 :qid |unknown.0:0|
 :skolemid |1747|
)) (= (Sort.__default.Sorted $h0 |a#0| |low#0| |high#0|) (Sort.__default.Sorted $h1 |a#0| |low#0| |high#0|))))
...
(set-info :boogie-vc-id CheckWellFormed$$Sort.__default.InsertionSort)
