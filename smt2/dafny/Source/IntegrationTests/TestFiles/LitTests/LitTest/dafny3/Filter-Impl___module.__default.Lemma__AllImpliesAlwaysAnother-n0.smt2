...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|_module._default.AllP#$_T0@@0| T@U) ($ly@@6 T@U) ($Heap@@2 T@U) (|_k#0@@1| T@U) (|s#0@@7| T@U) (|P#0@@3| T@U) ) (!  (=> (or (|_module.__default.AllP_h#canCall| |_module._default.AllP#$_T0@@0| |_k#0@@1| |s#0@@7| |P#0@@3|) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@2) ($Is DatatypeTypeType |s#0@@7| (Tclass._module.Stream |_module._default.AllP#$_T0@@0|))) ($Is HandleTypeType |P#0@@3| (Tclass._System.___hTotalFunc1 |_module._default.AllP#$_T0@@0| TBool))))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@1|)) (and (_module.Stream.Cons_q |s#0@@7|) (=> (U_2_bool ($Unbox boolType (Apply1 |_module._default.AllP#$_T0@@0| TBool $Heap@@2 |P#0@@3| (_module.Stream.head |s#0@@7|)))) (and (_module.Stream.Cons_q |s#0@@7|) (|_module.__default.AllP_h#canCall| |_module._default.AllP#$_T0@@0| (|ORD#Minus| |_k#0@@1| (|ORD#FromNat| 1)) (_module.Stream.tail |s#0@@7|) |P#0@@3|))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@1|)) (and (U_2_bool ($Unbox boolType (Apply1 |_module._default.AllP#$_T0@@0| TBool $Heap@@2 |P#0@@3| (_module.Stream.head |s#0@@7|)))) (_module.__default.AllP_h |_module._default.AllP#$_T0@@0| $ly@@6 (|ORD#Minus| |_k#0@@1| (|ORD#FromNat| 1)) (_module.Stream.tail |s#0@@7|) |P#0@@3|))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@1|)) (forall ((|_k'#0| T@U) ) (!  (=> (|ORD#Less| |_k'#0| |_k#0@@1|) (|_module.__default.AllP_h#canCall| |_module._default.AllP#$_T0@@0| |_k'#0| |s#0@@7| |P#0@@3|))
 :qid |Filterdfy.58:20|
 :skolemid |766|
 :pattern ( (_module.__default.AllP_h |_module._default.AllP#$_T0@@0| $ly@@6 |_k'#0| |s#0@@7| |P#0@@3|))
))))) (= (_module.__default.AllP_h |_module._default.AllP#$_T0@@0| ($LS $ly@@6) |_k#0@@1| |s#0@@7| |P#0@@3|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@1|)) (and (U_2_bool ($Unbox boolType (Apply1 |_module._default.AllP#$_T0@@0| TBool $Heap@@2 |P#0@@3| (_module.Stream.head |s#0@@7|)))) (_module.__default.AllP_h |_module._default.AllP#$_T0@@0| $ly@@6 (|ORD#Minus| |_k#0@@1| (|ORD#FromNat| 1)) (_module.Stream.tail |s#0@@7|) |P#0@@3|))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@1|)) (forall ((|_k'#0@@0| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@0| |_k#0@@1|) (_module.__default.AllP_h |_module._default.AllP#$_T0@@0| $ly@@6 |_k'#0@@0| |s#0@@7| |P#0@@3|))
 :qid |Filterdfy.58:20|
 :skolemid |765|
 :pattern ( (_module.__default.AllP_h |_module._default.AllP#$_T0@@0| $ly@@6 |_k'#0@@0| |s#0@@7| |P#0@@3|))
)))))))
 :qid |unknown.0:0|
 :skolemid |767|
 :pattern ( (_module.__default.AllP_h |_module._default.AllP#$_T0@@0| ($LS $ly@@6) |_k#0@@1| |s#0@@7| |P#0@@3|) ($IsGoodHeap $Heap@@2))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((_module._default.IsAnother$_T0@@0 T@U) ($Heap@@3 T@U) (|s#0@@8| T@U) (|P#0@@4| T@U) ) (!  (=> (or (|_module.__default.IsAnother#canCall| _module._default.IsAnother$_T0@@0 (Lit DatatypeTypeType |s#0@@8|) (Lit HandleTypeType |P#0@@4|)) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@3) ($Is DatatypeTypeType |s#0@@8| (Tclass._module.Stream _module._default.IsAnother$_T0@@0))) ($Is HandleTypeType |P#0@@4| (Tclass._System.___hTotalFunc1 _module._default.IsAnother$_T0@@0 TBool))))) (and (forall ((|n#1| Int) ) (!  (=> (<= (LitInt 0) |n#1|) (=> (<= (LitInt 0) |n#1|) (and (|_module.__default.Tail#canCall| _module._default.IsAnother$_T0@@0 (Lit DatatypeTypeType |s#0@@8|) |n#1|) (_module.Stream.Cons_q (_module.__default.Tail _module._default.IsAnother$_T0@@0 ($LS $LZ) (Lit DatatypeTypeType |s#0@@8|) |n#1|)))))
 :qid |Filterdfy.79:10|
 :skolemid |789|
 :pattern ( (_module.__default.Tail _module._default.IsAnother$_T0@@0 ($LS $LZ) |s#0@@8| |n#1|))
)) (= (_module.__default.IsAnother _module._default.IsAnother$_T0@@0 (Lit DatatypeTypeType |s#0@@8|) (Lit HandleTypeType |P#0@@4|)) (exists ((|n#1@@0| Int) ) (!  (and (<= (LitInt 0) |n#1@@0|) (and (<= (LitInt 0) |n#1@@0|) (U_2_bool ($Unbox boolType (Apply1 _module._default.IsAnother$_T0@@0 TBool $Heap@@3 (Lit HandleTypeType |P#0@@4|) (_module.Stream.head (_module.__default.Tail _module._default.IsAnother$_T0@@0 ($LS $LZ) (Lit DatatypeTypeType |s#0@@8|) |n#1@@0|)))))))
 :qid |Filterdfy.79:10|
 :skolemid |788|
 :pattern ( (_module.__default.Tail _module._default.IsAnother$_T0@@0 ($LS $LZ) |s#0@@8| |n#1@@0|))
)))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |790|
 :pattern ( (_module.__default.IsAnother _module._default.IsAnother$_T0@@0 (Lit DatatypeTypeType |s#0@@8|) (Lit HandleTypeType |P#0@@4|)) ($IsGoodHeap $Heap@@3))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@4 T@U) (_module._default.Tail$_T0@@3 T@U) ($ly@@7 T@U) (|s#0@@9| T@U) (|n#0@@5| Int) ) (!  (=> (and (or (|_module.__default.Tail#canCall| _module._default.Tail$_T0@@3 |s#0@@9| |n#0@@5|) (and (< 1 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |s#0@@9| (Tclass._module.Stream _module._default.Tail$_T0@@3)) ($IsAlloc DatatypeTypeType |s#0@@9| (Tclass._module.Stream _module._default.Tail$_T0@@3) $Heap@@4)) (<= (LitInt 0) |n#0@@5|)))) ($IsGoodHeap $Heap@@4)) ($IsAlloc DatatypeTypeType (_module.__default.Tail _module._default.Tail$_T0@@3 $ly@@7 |s#0@@9| |n#0@@5|) (Tclass._module.Stream _module._default.Tail$_T0@@3) $Heap@@4))
 :qid |Filterdfy.6:16|
 :skolemid |644|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.__default.Tail _module._default.Tail$_T0@@3 $ly@@7 |s#0@@9| |n#0@@5|) (Tclass._module.Stream _module._default.Tail$_T0@@3) $Heap@@4))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|_module._default.AllP#$_T0@@1| T@U) ($ly@@8 T@U) (|s#0@@10| T@U) (|P#0@@5| T@U) (|_k#0@@2| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |s#0@@10| (Tclass._module.Stream |_module._default.AllP#$_T0@@1|)) ($Is HandleTypeType |P#0@@5| (Tclass._System.___hTotalFunc1 |_module._default.AllP#$_T0@@1| TBool))) (= |_k#0@@2| (|ORD#FromNat| 0))) (_module.__default.AllP_h |_module._default.AllP#$_T0@@1| $ly@@8 |_k#0@@2| |s#0@@10| |P#0@@5|))
 :qid |unknown.0:0|
 :skolemid |759|
 :pattern ( (_module.__default.AllP_h |_module._default.AllP#$_T0@@1| $ly@@8 |_k#0@@2| |s#0@@10| |P#0@@5|))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|_module._default.AlwaysAnother#$_T0@@0| T@U) ($ly@@9 T@U) (|s#0@@11| T@U) (|P#0@@6| T@U) (|_k#0@@3| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |s#0@@11| (Tclass._module.Stream |_module._default.AlwaysAnother#$_T0@@0|)) ($Is HandleTypeType |P#0@@6| (Tclass._System.___hTotalFunc1 |_module._default.AlwaysAnother#$_T0@@0| TBool))) (= |_k#0@@3| (|ORD#FromNat| 0))) (_module.__default.AlwaysAnother_h |_module._default.AlwaysAnother#$_T0@@0| $ly@@9 |_k#0@@3| |s#0@@11| |P#0@@6|))
 :qid |unknown.0:0|
 :skolemid |803|
 :pattern ( (_module.__default.AlwaysAnother_h |_module._default.AlwaysAnother#$_T0@@0| $ly@@9 |_k#0@@3| |s#0@@11| |P#0@@6|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|_module._default.AlwaysAnother#$_T0@@1| T@U) ($ly@@10 T@U) (|_k#0@@4| T@U) (|s#0@@12| T@U) (|P#0@@7| T@U) ) (!  (=> (or (|_module.__default.AlwaysAnother_h#canCall| |_module._default.AlwaysAnother#$_T0@@1| |_k#0@@4| |s#0@@12| |P#0@@7|) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@12| (Tclass._module.Stream |_module._default.AlwaysAnother#$_T0@@1|)) ($Is HandleTypeType |P#0@@7| (Tclass._System.___hTotalFunc1 |_module._default.AlwaysAnother#$_T0@@1| TBool))))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (and (|_module.__default.IsAnother#canCall| |_module._default.AlwaysAnother#$_T0@@1| |s#0@@12| |P#0@@7|) (=> (_module.__default.IsAnother |_module._default.AlwaysAnother#$_T0@@1| |s#0@@12| |P#0@@7|) (and (_module.Stream.Cons_q |s#0@@12|) (|_module.__default.AlwaysAnother_h#canCall| |_module._default.AlwaysAnother#$_T0@@1| (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) (_module.Stream.tail |s#0@@12|) |P#0@@7|))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (and (_module.__default.IsAnother |_module._default.AlwaysAnother#$_T0@@1| |s#0@@12| |P#0@@7|) (_module.__default.AlwaysAnother_h |_module._default.AlwaysAnother#$_T0@@1| $ly@@10 (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) (_module.Stream.tail |s#0@@12|) |P#0@@7|))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@4|)) (forall ((|_k'#0@@1| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@1| |_k#0@@4|) (|_module.__default.AlwaysAnother_h#canCall| |_module._default.AlwaysAnother#$_T0@@1| |_k'#0@@1| |s#0@@12| |P#0@@7|))
 :qid |Filterdfy.81:20|
 :skolemid |811|
 :pattern ( (_module.__default.AlwaysAnother_h |_module._default.AlwaysAnother#$_T0@@1| $ly@@10 |_k'#0@@1| |s#0@@12| |P#0@@7|))
))))) (= (_module.__default.AlwaysAnother_h |_module._default.AlwaysAnother#$_T0@@1| ($LS $ly@@10) |_k#0@@4| |s#0@@12| |P#0@@7|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (and (_module.__default.IsAnother |_module._default.AlwaysAnother#$_T0@@1| |s#0@@12| |P#0@@7|) (_module.__default.AlwaysAnother_h |_module._default.AlwaysAnother#$_T0@@1| $ly@@10 (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) (_module.Stream.tail |s#0@@12|) |P#0@@7|))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@4|)) (forall ((|_k'#0@@2| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@2| |_k#0@@4|) (_module.__default.AlwaysAnother_h |_module._default.AlwaysAnother#$_T0@@1| $ly@@10 |_k'#0@@2| |s#0@@12| |P#0@@7|))
 :qid |Filterdfy.81:20|
 :skolemid |810|
 :pattern ( (_module.__default.AlwaysAnother_h |_module._default.AlwaysAnother#$_T0@@1| $ly@@10 |_k'#0@@2| |s#0@@12| |P#0@@7|))
)))))))
 :qid |unknown.0:0|
 :skolemid |812|
 :pattern ( (_module.__default.AlwaysAnother_h |_module._default.AlwaysAnother#$_T0@@1| ($LS $ly@@10) |_k#0@@4| |s#0@@12| |P#0@@7|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|_module._default.AllP#$_T0@@2| T@U) ($ly@@11 T@U) ($Heap@@5 T@U) (|_k#0@@5| T@U) (|s#0@@13| T@U) (|P#0@@8| T@U) ) (!  (=> (or (|_module.__default.AllP_h#canCall| |_module._default.AllP#$_T0@@2| (Lit BoxType |_k#0@@5|) |s#0@@13| |P#0@@8|) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@5) ($Is DatatypeTypeType |s#0@@13| (Tclass._module.Stream |_module._default.AllP#$_T0@@2|))) ($Is HandleTypeType |P#0@@8| (Tclass._System.___hTotalFunc1 |_module._default.AllP#$_T0@@2| TBool))))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@5|)) (and (_module.Stream.Cons_q |s#0@@13|) (=> (U_2_bool ($Unbox boolType (Apply1 |_module._default.AllP#$_T0@@2| TBool $Heap@@5 |P#0@@8| (_module.Stream.head |s#0@@13|)))) (and (_module.Stream.Cons_q |s#0@@13|) (|_module.__default.AllP_h#canCall| |_module._default.AllP#$_T0@@2| (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) (_module.Stream.tail |s#0@@13|) |P#0@@8|))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@5|)) (and (U_2_bool ($Unbox boolType (Apply1 |_module._default.AllP#$_T0@@2| TBool $Heap@@5 |P#0@@8| (_module.Stream.head |s#0@@13|)))) (_module.__default.AllP_h |_module._default.AllP#$_T0@@2| ($LS $ly@@11) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) (_module.Stream.tail |s#0@@13|) |P#0@@8|))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@5|)) (forall ((|_k'#1| T@U) ) (!  (=> (|ORD#Less| |_k'#1| |_k#0@@5|) (|_module.__default.AllP_h#canCall| |_module._default.AllP#$_T0@@2| |_k'#1| |s#0@@13| |P#0@@8|))
 :qid |Filterdfy.58:20|
 :skolemid |769|
 :pattern ( (_module.__default.AllP_h |_module._default.AllP#$_T0@@2| ($LS $ly@@11) |_k'#1| |s#0@@13| |P#0@@8|))
))))) (= (_module.__default.AllP_h |_module._default.AllP#$_T0@@2| ($LS $ly@@11) (Lit BoxType |_k#0@@5|) |s#0@@13| |P#0@@8|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@5|)) (and (U_2_bool ($Unbox boolType (Apply1 |_module._default.AllP#$_T0@@2| TBool $Heap@@5 |P#0@@8| (_module.Stream.head |s#0@@13|)))) (_module.__default.AllP_h |_module._default.AllP#$_T0@@2| ($LS $ly@@11) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) (_module.Stream.tail |s#0@@13|) |P#0@@8|))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@5|)) (forall ((|_k'#1@@0| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@0| |_k#0@@5|) (_module.__default.AllP_h |_module._default.AllP#$_T0@@2| ($LS $ly@@11) |_k'#1@@0| |s#0@@13| |P#0@@8|))
 :qid |Filterdfy.58:20|
 :skolemid |768|
 :pattern ( (_module.__default.AllP_h |_module._default.AllP#$_T0@@2| ($LS $ly@@11) |_k'#1@@0| |s#0@@13| |P#0@@8|))
)))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |770|
 :pattern ( (_module.__default.AllP_h |_module._default.AllP#$_T0@@2| ($LS $ly@@11) (Lit BoxType |_k#0@@5|) |s#0@@13| |P#0@@8|) ($IsGoodHeap $Heap@@5))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|_module._default.AllP#$_T0@@3| T@U) ($ly@@12 T@U) (|s#0@@14| T@U) (|P#0@@9| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |s#0@@14| (Tclass._module.Stream |_module._default.AllP#$_T0@@3|)) ($Is HandleTypeType |P#0@@9| (Tclass._System.___hTotalFunc1 |_module._default.AllP#$_T0@@3| TBool))) (forall ((|_k#0@@6| T@U) ) (! (_module.__default.AllP_h |_module._default.AllP#$_T0@@3| ($LS $ly@@12) |_k#0@@6| |s#0@@14| |P#0@@9|)
 :qid |Filterdfy.58:20|
 :skolemid |756|
 :pattern ( (_module.__default.AllP_h |_module._default.AllP#$_T0@@3| ($LS $ly@@12) |_k#0@@6| |s#0@@14| |P#0@@9|))
))) (_module.__default.AllP |_module._default.AllP#$_T0@@3| ($LS $ly@@12) |s#0@@14| |P#0@@9|))
 :qid |unknown.0:0|
 :skolemid |758|
 :pattern ( (_module.__default.AllP |_module._default.AllP#$_T0@@3| ($LS $ly@@12) |s#0@@14| |P#0@@9|))
))))
...
(assert (forall ((_module._default.AllP$_T0@@0 T@U) ($ly@@13 T@U) (|s#0@@15| T@U) (|P#0@@10| T@U) ) (! (= (_module.__default.AllP _module._default.AllP$_T0@@0 ($LS $ly@@13) |s#0@@15| |P#0@@10|) (_module.__default.AllP _module._default.AllP$_T0@@0 $ly@@13 |s#0@@15| |P#0@@10|))
 :qid |unknown.0:0|
 :skolemid |751|
 :pattern ( (_module.__default.AllP _module._default.AllP$_T0@@0 ($LS $ly@@13) |s#0@@15| |P#0@@10|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|_module._default.AllP#$_T0@@4| T@U) ($ly@@14 T@U) (|s#0@@16| T@U) (|P#0@@11| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |s#0@@16| (Tclass._module.Stream |_module._default.AllP#$_T0@@4|)) ($Is HandleTypeType |P#0@@11| (Tclass._System.___hTotalFunc1 |_module._default.AllP#$_T0@@4| TBool))) (_module.__default.AllP |_module._default.AllP#$_T0@@4| ($LS $ly@@14) |s#0@@16| |P#0@@11|)) (forall ((|_k#0@@7| T@U) ) (! (_module.__default.AllP_h |_module._default.AllP#$_T0@@4| ($LS $ly@@14) |_k#0@@7| |s#0@@16| |P#0@@11|)
 :qid |Filterdfy.58:20|
 :skolemid |756|
 :pattern ( (_module.__default.AllP_h |_module._default.AllP#$_T0@@4| ($LS $ly@@14) |_k#0@@7| |s#0@@16| |P#0@@11|))
)))
 :qid |unknown.0:0|
 :skolemid |757|
 :pattern ( (_module.__default.AllP |_module._default.AllP#$_T0@@4| ($LS $ly@@14) |s#0@@16| |P#0@@11|))
))))
...
(assert (forall ((_module._default.Tail$_T0@@4 T@U) ($ly@@15 T@U) (|s#0@@17| T@U) (|n#0@@6| Int) ) (! (= (_module.__default.Tail _module._default.Tail$_T0@@4 ($LS $ly@@15) |s#0@@17| |n#0@@6|) (_module.__default.Tail _module._default.Tail$_T0@@4 $ly@@15 |s#0@@17| |n#0@@6|))
 :qid |unknown.0:0|
 :skolemid |638|
 :pattern ( (_module.__default.Tail _module._default.Tail$_T0@@4 ($LS $ly@@15) |s#0@@17| |n#0@@6|))
)))
...
(assert (forall ((|_module._default.AllP#$_T0@@5| T@U) ($ly@@16 T@U) (|_k#0@@8| T@U) (|s#0@@18| T@U) (|P#0@@12| T@U) ) (! (= (_module.__default.AllP_h |_module._default.AllP#$_T0@@5| ($LS $ly@@16) |_k#0@@8| |s#0@@18| |P#0@@12|) (_module.__default.AllP_h |_module._default.AllP#$_T0@@5| $ly@@16 |_k#0@@8| |s#0@@18| |P#0@@12|))
 :qid |unknown.0:0|
 :skolemid |761|
 :pattern ( (_module.__default.AllP_h |_module._default.AllP#$_T0@@5| ($LS $ly@@16) |_k#0@@8| |s#0@@18| |P#0@@12|))
)))
(assert (forall ((|_module._default.AlwaysAnother#$_T0@@2| T@U) ($ly@@17 T@U) (|_k#0@@9| T@U) (|s#0@@19| T@U) (|P#0@@13| T@U) ) (! (= (_module.__default.AlwaysAnother_h |_module._default.AlwaysAnother#$_T0@@2| ($LS $ly@@17) |_k#0@@9| |s#0@@19| |P#0@@13|) (_module.__default.AlwaysAnother_h |_module._default.AlwaysAnother#$_T0@@2| $ly@@17 |_k#0@@9| |s#0@@19| |P#0@@13|))
 :qid |unknown.0:0|
 :skolemid |806|
 :pattern ( (_module.__default.AlwaysAnother_h |_module._default.AlwaysAnother#$_T0@@2| ($LS $ly@@17) |_k#0@@9| |s#0@@19| |P#0@@13|))
)))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|_module._default.AlwaysAnother#$_T0@@3| T@U) ($ly@@18 T@U) (|_k#0@@10| T@U) (|s#0@@20| T@U) (|P#0@@14| T@U) ) (!  (=> (or (|_module.__default.AlwaysAnother_h#canCall| |_module._default.AlwaysAnother#$_T0@@3| (Lit BoxType |_k#0@@10|) |s#0@@20| |P#0@@14|) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@20| (Tclass._module.Stream |_module._default.AlwaysAnother#$_T0@@3|)) ($Is HandleTypeType |P#0@@14| (Tclass._System.___hTotalFunc1 |_module._default.AlwaysAnother#$_T0@@3| TBool))))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@10|)) (and (|_module.__default.IsAnother#canCall| |_module._default.AlwaysAnother#$_T0@@3| |s#0@@20| |P#0@@14|) (=> (_module.__default.IsAnother |_module._default.AlwaysAnother#$_T0@@3| |s#0@@20| |P#0@@14|) (and (_module.Stream.Cons_q |s#0@@20|) (|_module.__default.AlwaysAnother_h#canCall| |_module._default.AlwaysAnother#$_T0@@3| (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) (_module.Stream.tail |s#0@@20|) |P#0@@14|))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@10|)) (and (_module.__default.IsAnother |_module._default.AlwaysAnother#$_T0@@3| |s#0@@20| |P#0@@14|) (_module.__default.AlwaysAnother_h |_module._default.AlwaysAnother#$_T0@@3| ($LS $ly@@18) (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) (_module.Stream.tail |s#0@@20|) |P#0@@14|))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@10|)) (forall ((|_k'#1@@1| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@1| |_k#0@@10|) (|_module.__default.AlwaysAnother_h#canCall| |_module._default.AlwaysAnother#$_T0@@3| |_k'#1@@1| |s#0@@20| |P#0@@14|))
 :qid |Filterdfy.81:20|
 :skolemid |814|
 :pattern ( (_module.__default.AlwaysAnother_h |_module._default.AlwaysAnother#$_T0@@3| ($LS $ly@@18) |_k'#1@@1| |s#0@@20| |P#0@@14|))
))))) (= (_module.__default.AlwaysAnother_h |_module._default.AlwaysAnother#$_T0@@3| ($LS $ly@@18) (Lit BoxType |_k#0@@10|) |s#0@@20| |P#0@@14|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@10|)) (and (_module.__default.IsAnother |_module._default.AlwaysAnother#$_T0@@3| |s#0@@20| |P#0@@14|) (_module.__default.AlwaysAnother_h |_module._default.AlwaysAnother#$_T0@@3| ($LS $ly@@18) (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) (_module.Stream.tail |s#0@@20|) |P#0@@14|))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@10|)) (forall ((|_k'#1@@2| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@2| |_k#0@@10|) (_module.__default.AlwaysAnother_h |_module._default.AlwaysAnother#$_T0@@3| ($LS $ly@@18) |_k'#1@@2| |s#0@@20| |P#0@@14|))
 :qid |Filterdfy.81:20|
 :skolemid |813|
 :pattern ( (_module.__default.AlwaysAnother_h |_module._default.AlwaysAnother#$_T0@@3| ($LS $ly@@18) |_k'#1@@2| |s#0@@20| |P#0@@14|))
)))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |815|
 :pattern ( (_module.__default.AlwaysAnother_h |_module._default.AlwaysAnother#$_T0@@3| ($LS $ly@@18) (Lit BoxType |_k#0@@10|) |s#0@@20| |P#0@@14|))
))))
...
(declare-fun |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.Lemma__AllImpliesAlwaysAnother_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.__default.AlwaysAnother_h#canCall| |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| |_k#0@@11| |s#1| |P#1|) (or (_module.__default.AlwaysAnother_h |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS $LZ) |_k#0@@11| |s#1| |P#1|) (=> (< 0 (|ORD#Offset| |_k#0@@11|)) (=> (|_module.__default.IsAnother#canCall| |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| |s#1| |P#1|) (or (_module.__default.IsAnother |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| |s#1| |P#1|) (exists ((|n#2| Int) ) (!  (and (<= (LitInt 0) |n#2|) (and (<= (LitInt 0) |n#2|) (U_2_bool ($Unbox boolType (Apply1 |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| TBool $Heap@2 |P#1| (_module.Stream.head (_module.__default.Tail |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS $LZ) |s#1| |n#2|)))))))
 :qid |Filterdfy.79:10|
 :skolemid |828|
 :pattern ( (_module.__default.Tail |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS $LZ) |s#1| |n#2|))
)))))))) (=> (=> (|_module.__default.AlwaysAnother_h#canCall| |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| |_k#0@@11| |s#1| |P#1|) (or (_module.__default.AlwaysAnother_h |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS $LZ) |_k#0@@11| |s#1| |P#1|) (=> (< 0 (|ORD#Offset| |_k#0@@11|)) (=> (|_module.__default.IsAnother#canCall| |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| |s#1| |P#1|) (or (_module.__default.IsAnother |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| |s#1| |P#1|) (exists ((|n#2@@0| Int) ) (!  (and (<= (LitInt 0) |n#2@@0|) (and (<= (LitInt 0) |n#2@@0|) (U_2_bool ($Unbox boolType (Apply1 |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| TBool $Heap@2 |P#1| (_module.Stream.head (_module.__default.Tail |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS $LZ) |s#1| |n#2@@0|)))))))
 :qid |Filterdfy.79:10|
 :skolemid |828|
 :pattern ( (_module.__default.Tail |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS $LZ) |s#1| |n#2@@0|))
))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.__default.AlwaysAnother_h#canCall| |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| |_k#0@@11| |s#1| |P#1|) (or (_module.__default.AlwaysAnother_h |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS $LZ) |_k#0@@11| |s#1| |P#1|) (=> (< 0 (|ORD#Offset| |_k#0@@11|)) (_module.__default.AlwaysAnother_h |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS ($LS $LZ)) (|ORD#Minus| |_k#0@@11| (|ORD#FromNat| 1)) (_module.Stream.tail |s#1|) |P#1|))))) (=> (=> (|_module.__default.AlwaysAnother_h#canCall| |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| |_k#0@@11| |s#1| |P#1|) (or (_module.__default.AlwaysAnother_h |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS $LZ) |_k#0@@11| |s#1| |P#1|) (=> (< 0 (|ORD#Offset| |_k#0@@11|)) (_module.__default.AlwaysAnother_h |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS ($LS $LZ)) (|ORD#Minus| |_k#0@@11| (|ORD#FromNat| 1)) (_module.Stream.tail |s#1|) |P#1|)))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.__default.AlwaysAnother_h#canCall| |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| |_k#0@@11| |s#1| |P#1|) (or (_module.__default.AlwaysAnother_h |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS $LZ) |_k#0@@11| |s#1| |P#1|) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@11|)) (forall ((|_k'#1@@3| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@3| |_k#0@@11|) (_module.__default.AlwaysAnother_h |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS ($LS $LZ)) |_k'#1@@3| |s#1| |P#1|))
 :qid |Filterdfy.81:20|
 :skolemid |831|
 :pattern ( (_module.__default.AlwaysAnother_h |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS ($LS $LZ)) |_k'#1@@3| |s#1| |P#1|))
))))))))))))
(let ((anon3_Else_correct  (=> (<= (|ORD#Offset| |_k#0@@11|) 0) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (= $Heap@0 $Heap@1) (forall ((|_k'#2@@3| T@U) (|s#2| T@U) (|P#2| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |s#2| (Tclass._module.Stream |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0|)) ($Is HandleTypeType |P#2| (Tclass._System.___hTotalFunc1 |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| TBool))) (and (|ORD#Less| |_k'#2@@3| |_k#0@@11|) (_module.__default.AllP |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS $LZ) |s#2| |P#2|))) (_module.__default.AlwaysAnother_h |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS $LZ) |_k'#2@@3| |s#2| |P#2|))
 :qid |Filterdfy.85:16|
 :skolemid |835|
 :pattern ( (_module.__default.AlwaysAnother_h |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS $LZ) |_k'#2@@3| |s#2| |P#2|))
 :pattern ( (_module.__default.AllP |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS $LZ) |s#2| |P#2|) (|ORD#Less| |_k'#2@@3| |_k#0@@11|))
))) (and (= $Heap@2 $Heap@1) (= (ControlFlow 0 8) 2))) GeneratedUnifiedExit_correct)))))
(let ((anon3_Then_correct  (=> (and (< 0 (|ORD#Offset| |_k#0@@11|)) ($IsAlloc DatatypeTypeType |s#1| (Tclass._module.Stream |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0|) $Heap@0)) (and (=> (= (ControlFlow 0 5) (- 0 7)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (and (and (and (= |##n#0@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##n#0@0|) Tclass._System.nat $Heap@0)) (and (|_module.__default.Tail#canCall| |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| |s#1| (LitInt 0)) (_module.Stream.Cons_q (_module.__default.Tail |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS $LZ) |s#1| (LitInt 0))))) (and (and (|$IsA#_module.Stream| (_module.__default.Tail |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS $LZ) |s#1| (LitInt 0))) (|$IsA#_module.Stream| |s#1|)) (|_module.__default.Tail#canCall| |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| |s#1| (LitInt 0)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (|$Eq#_module.Stream| |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS ($LS $LZ)) (_module.__default.Tail |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS ($LS $LZ)) |s#1| (LitInt 0)) |s#1|)) (=> (|$Eq#_module.Stream| |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS ($LS $LZ)) (_module.__default.Tail |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS $LZ) |s#1| (LitInt 0)) |s#1|) (=> (and (= $Heap@2 $Heap@0) (= (ControlFlow 0 5) 2)) GeneratedUnifiedExit_correct)))))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (|$IsA#_module.Stream| |s#1|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@6 $Heap@0) (forall ((|$ih#_k0#0| T@U) (|$ih#s0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#s0#0| (Tclass._module.Stream |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0|)) (_module.__default.AllP |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS $LZ) |$ih#s0#0| |P#1|)) (|ORD#Less| |$ih#_k0#0| |_k#0@@11|)) (_module.__default.AlwaysAnother_h |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS $LZ) |$ih#_k0#0| |$ih#s0#0| |P#1|))
 :qid |Filterdfy.85:16|
 :skolemid |834|
 :pattern ( (_module.__default.AlwaysAnother_h |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS $LZ) |$ih#_k0#0| |$ih#s0#0| |P#1|))
)))) (and (=> (= (ControlFlow 0 9) 5) anon3_Then_correct) (=> (= (ControlFlow 0 9) 8) anon3_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |s#1| (Tclass._module.Stream |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0|)) ($IsAlloc DatatypeTypeType |s#1| (Tclass._module.Stream |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0|) $Heap@@6)) (|$IsA#_module.Stream| |s#1|)) (=> (and (and (and ($Is HandleTypeType |P#1| (Tclass._System.___hTotalFunc1 |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| TBool)) ($IsAlloc HandleTypeType |P#1| (Tclass._System.___hTotalFunc1 |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| TBool) $Heap@@6)) (= 5 $FunctionContextHeight)) (and (and (|_module.__default.AllP#canCall| |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| |s#1| |P#1|) (and (_module.__default.AllP |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS $LZ) |s#1| |P#1|) (and (U_2_bool ($Unbox boolType (Apply1 |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| TBool $Heap@@6 |P#1| (_module.Stream.head |s#1|)))) (_module.__default.AllP |_module._default.Lemma_AllImpliesAlwaysAnother#$_T0| ($LS $LZ) (_module.Stream.tail |s#1|) |P#1|)))) (= (ControlFlow 0 10) 9))) anon0_correct)))))
