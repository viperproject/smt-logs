...
(set-info :boogie-vc-id Impl$$_module.__default.FibLemma__All)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((|n#1| Int) ) (!  (=> (<= (LitInt 0) |n#1|) (=> (<= (LitInt 0) |n#1|) (= (= (Mod (_module.__default.Fib ($LS ($LS $LZ)) |n#1|) (LitInt 2)) (LitInt 0)) (= (Mod |n#1| (LitInt 3)) (LitInt 0)))))
 :qid |SimpleInductiondfy.42:18|
 :skolemid |547|
 :pattern ( (_module.__default.Fib ($LS ($LS $LZ)) |n#1|))
)))))
(let ((anon3_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap $Heap@1)) (and (forall ((|n#0_1| Int) ) (!  (=> (and (<= (LitInt 0) |n#0_1|) (<= (LitInt 0) |n#0_1|)) (= (= (Mod (_module.__default.Fib ($LS $LZ) |n#0_1|) (LitInt 2)) (LitInt 0)) (= (Mod |n#0_1| (LitInt 3)) (LitInt 0))))
 :qid |SimpleInductiondfy.44:10|
 :skolemid |550|
 :pattern ( (_module.__default.Fib ($LS $LZ) |n#0_1|))
