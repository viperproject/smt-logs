...
(assert (distinct TBool TagBool alloc Tagclass._System.nat Tagclass._module.Tree Tagclass._module.Stream |##_module.Stream.SNil| |##_module.Stream.SCons| |##_module.Tree.Node| tytagFamily$nat tytagFamily$Tree tytagFamily$Stream)
)
...
(assert (forall ((_module.Stream$T T@U) ($h@@0 T@U) ) (!  (=> ($IsGoodHeap $h@@0) ($IsAlloc DatatypeTypeType |#_module.Stream.SNil| (Tclass._module.Stream _module.Stream$T) $h@@0))
 :qid |unknown.0:0|
 :skolemid |667|
 :pattern ( ($IsAlloc DatatypeTypeType |#_module.Stream.SNil| (Tclass._module.Stream _module.Stream$T) $h@@0))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@0 T@U) (|_k#0@@0| T@U) (|s#0@@0| T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.__default.LowerThan_h#canCall| (Lit BoxType |_k#0@@0|) (Lit DatatypeTypeType |s#0@@0|) (LitInt |n#0@@0|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@0| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@0|)))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@0|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Stream.SNil_q (Lit DatatypeTypeType |s#0@@0|)))))) (let ((|tail#9| (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |s#0@@0|)))))
(let ((|t#9| (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Stream.head (Lit DatatypeTypeType |s#0@@0|))))))
 (=> (<= (LitInt 1) (LitInt |n#0@@0|)) (and (and (_module.Tree.Node_q |t#9|) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@0| (|ORD#FromNat| 1)) (_module.Tree.children |t#9|) (LitInt (- |n#0@@0| 1)))) (=> (_module.__default.LowerThan_h ($LS $ly@@0) (|ORD#Minus| |_k#0@@0| (|ORD#FromNat| 1)) (_module.Tree.children |t#9|) (LitInt (- |n#0@@0| 1))) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@0| (|ORD#FromNat| 1)) |tail#9| (LitInt |n#0@@0|))))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@0|)) (ite (_module.Stream.SNil_q (Lit DatatypeTypeType |s#0@@0|)) true (let ((|tail#10| (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |s#0@@0|)))))
...
))))) (= (_module.__default.LowerThan_h ($LS $ly@@0) (Lit BoxType |_k#0@@0|) (Lit DatatypeTypeType |s#0@@0|) (LitInt |n#0@@0|))  (and (=> (< 0 (|ORD#Offset| |_k#0@@0|)) (ite (_module.Stream.SNil_q (Lit DatatypeTypeType |s#0@@0|)) true (let ((|tail#8| (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |s#0@@0|)))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@3 T@U) (|_k#0@@2| T@U) (|s#0@@3| T@U) (|n#0@@3| Int) ) (!  (=> (or (|_module.__default.LowerThan_h#canCall| (Lit BoxType |_k#0@@2|) |s#0@@3| |n#0@@3|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@3| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@3|)))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@2|)) (=> (not (_module.Stream.SNil_q |s#0@@3|)) (let ((|tail#6| (_module.Stream.tail |s#0@@3|)))
(let ((|t#6| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@3|))))
 (=> (<= (LitInt 1) |n#0@@3|) (and (and (_module.Tree.Node_q |t#6|) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@2| (|ORD#FromNat| 1)) (_module.Tree.children |t#6|) (- |n#0@@3| 1))) (=> (_module.__default.LowerThan_h ($LS $ly@@3) (|ORD#Minus| |_k#0@@2| (|ORD#FromNat| 1)) (_module.Tree.children |t#6|) (- |n#0@@3| 1)) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@2| (|ORD#FromNat| 1)) |tail#6| |n#0@@3|)))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@2|)) (ite (_module.Stream.SNil_q |s#0@@3|) true (let ((|tail#7| (_module.Stream.tail |s#0@@3|)))
...
))))) (= (_module.__default.LowerThan_h ($LS $ly@@3) (Lit BoxType |_k#0@@2|) |s#0@@3| |n#0@@3|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@2|)) (ite (_module.Stream.SNil_q |s#0@@3|) true (let ((|tail#5| (_module.Stream.tail |s#0@@3|)))
...
(assert (forall ((_module.Stream$T@@3 T@U) (d@@6 T@U) ) (!  (=> ($Is DatatypeTypeType d@@6 (Tclass._module.Stream _module.Stream$T@@3)) (or (_module.Stream.SNil_q d@@6) (_module.Stream.SCons_q d@@6)))
 :qid |unknown.0:0|
 :skolemid |679|
 :pattern ( (_module.Stream.SCons_q d@@6) ($Is DatatypeTypeType d@@6 (Tclass._module.Stream _module.Stream$T@@3)))
 :pattern ( (_module.Stream.SNil_q d@@6) ($Is DatatypeTypeType d@@6 (Tclass._module.Stream _module.Stream$T@@3)))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@4 T@U) (|_k#0@@3| T@U) (|s#0@@4| T@U) (|n#0@@4| Int) ) (!  (=> (or (|_module.__default.LowerThan_h#canCall| |_k#0@@3| |s#0@@4| |n#0@@4|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@4| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@4|)))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@3|)) (=> (not (_module.Stream.SNil_q |s#0@@4|)) (let ((|tail#3| (_module.Stream.tail |s#0@@4|)))
(let ((|t#3| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@4|))))
 (=> (<= (LitInt 1) |n#0@@4|) (and (and (_module.Tree.Node_q |t#3|) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1)) (_module.Tree.children |t#3|) (- |n#0@@4| 1))) (=> (_module.__default.LowerThan_h $ly@@4 (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1)) (_module.Tree.children |t#3|) (- |n#0@@4| 1)) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1)) |tail#3| |n#0@@4|)))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@3|)) (ite (_module.Stream.SNil_q |s#0@@4|) true (let ((|tail#4| (_module.Stream.tail |s#0@@4|)))
...
))))) (= (_module.__default.LowerThan_h ($LS $ly@@4) |_k#0@@3| |s#0@@4| |n#0@@4|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@3|)) (ite (_module.Stream.SNil_q |s#0@@4|) true (let ((|tail#2| (_module.Stream.tail |s#0@@4|)))
...
(assert (forall ((d@@7 T@U) (_module.Stream$T@@5 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.Stream.SCons_q d@@7) ($IsAlloc DatatypeTypeType d@@7 (Tclass._module.Stream _module.Stream$T@@5) $h@@1))) ($IsAllocBox (_module.Stream.head d@@7) _module.Stream$T@@5 $h@@1))
 :qid |unknown.0:0|
 :skolemid |674|
...
(assert (forall ((d@@8 T@U) (_module.Stream$T@@7 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (_module.Stream.SCons_q d@@8) ($IsAlloc DatatypeTypeType d@@8 (Tclass._module.Stream _module.Stream$T@@7) $h@@2))) ($IsAlloc DatatypeTypeType (_module.Stream.tail d@@8) (Tclass._module.Stream _module.Stream$T@@7) $h@@2))
 :qid |unknown.0:0|
 :skolemid |675|
...
(assert (forall ((_module.Stream$T@@8 T@U) (|a#5#0#0@@0| T@U) (|a#5#1#0@@0| T@U) ($h@@5 T@U) ) (!  (=> ($IsGoodHeap $h@@5) (= ($IsAlloc DatatypeTypeType (|#_module.Stream.SCons| |a#5#0#0@@0| |a#5#1#0@@0|) (Tclass._module.Stream _module.Stream$T@@8) $h@@5)  (and ($IsAllocBox |a#5#0#0@@0| _module.Stream$T@@8 $h@@5) ($IsAlloc DatatypeTypeType |a#5#1#0@@0| (Tclass._module.Stream _module.Stream$T@@8) $h@@5))))
 :qid |unknown.0:0|
 :skolemid |673|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.Stream.SCons| |a#5#0#0@@0| |a#5#1#0@@0|) (Tclass._module.Stream _module.Stream$T@@8) $h@@5))
)))
...
(let ((anon14_Then_correct  (=> (= |s#0@@8| (|#_module.Stream.SCons| ($Box DatatypeTypeType |_mcc#0#0|) |_mcc#1#0|)) (=> (and (and (and ($Is DatatypeTypeType |_mcc#0#0| Tclass._module.Tree) ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.Stream Tclass._module.Tree))) (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.Stream Tclass._module.Tree)))) (and (and (= |tail#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|)) (and ($Is DatatypeTypeType |let#1#0#0| Tclass._module.Tree) (= |t#Z#0@0| |let#1#0#0|)))) (and (=> (= (ControlFlow 0 10) 7) anon15_Then_correct) (=> (= (ControlFlow 0 10) 9) anon15_Else_correct))))))
(let ((anon14_Else_correct true))
(let ((anon13_Else_correct  (=> (or (not (= |s#0@@8| |#_module.Stream.SNil|)) (not true)) (and (=> (= (ControlFlow 0 11) 10) anon14_Then_correct) (=> (= (ControlFlow 0 11) 3) anon14_Else_correct)))))
