...
(declare-fun $Heap@@0 () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.Theorem1__Par)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (|$Eq#_module.Stream| Tclass._module.X Tclass._module.X ($LS ($LS $LZ)) (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#0@@6| |N#0@@4|)) (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) (_module.__default.map__f ($LS ($LS $LZ)) |M#0@@6|) (_module.__default.map__f ($LS ($LS $LZ)) |N#0@@4|))))))
(let ((anon3_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (= $Heap@0 $Heap@2)) (and (forall ((|k#0_1| Int) ) (!  (=> (and (<= (LitInt 0) |k#0_1|) (U_2_bool (Lit boolType (bool_2_U true)))) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#FromNat| |k#0_1|) ($LS ($LS $LZ)) (_module.__default.map__f ($LS $LZ) (_module.__default.append Tclass._module.X ($LS $LZ) |M#0@@6| |N#0@@4|)) (_module.__default.append Tclass._module.X ($LS $LZ) (_module.__default.map__f ($LS $LZ) |M#0@@6|) (_module.__default.map__f ($LS $LZ) |N#0@@4|))))
 :qid |Streamsdfy.105:10|
 :skolemid |637|
)) (= (ControlFlow 0 4) 3))) GeneratedUnifiedExit_correct)))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and (|$IsA#_module.Stream| |M#0@@6|) (|$IsA#_module.Stream| |N#0@@4|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@0 $Heap@0) (forall ((|$ih#M0#0| T@U) (|$ih#N0#0| T@U) ) (! true
 :qid |Streamsdfy.102:20|
 :skolemid |635|
 :pattern ( (_module.__default.append Tclass._module.X ($LS $LZ) (_module.__default.map__f ($LS $LZ) |$ih#M0#0|) (_module.__default.map__f ($LS $LZ) |$ih#N0#0|)))
 :pattern ( (_module.__default.map__f ($LS $LZ) (_module.__default.append Tclass._module.X ($LS $LZ) |$ih#M0#0| |$ih#N0#0|)))
)))) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is DatatypeTypeType |M#0@@6| (Tclass._module.Stream Tclass._module.X)) ($IsAlloc DatatypeTypeType |M#0@@6| (Tclass._module.Stream Tclass._module.X) $Heap@@0)) (|$IsA#_module.Stream| |M#0@@6|)) (=> (and (and (and ($Is DatatypeTypeType |N#0@@4| (Tclass._module.Stream Tclass._module.X)) ($IsAlloc DatatypeTypeType |N#0@@4| (Tclass._module.Stream Tclass._module.X) $Heap@@0)) (|$IsA#_module.Stream| |N#0@@4|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 6) 5))) anon0_correct)))))
