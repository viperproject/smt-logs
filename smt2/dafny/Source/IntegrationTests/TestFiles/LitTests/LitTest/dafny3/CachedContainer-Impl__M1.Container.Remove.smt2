...
(set-info :boogie-vc-id Impl$$M1.Container.Remove)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@1 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) M1.Container.Repr)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@3 M1.Container.Contents))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@3 M1.Container.Contents)) (=> (= |$rhs#0@0| (|Set#Difference| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) M1.Container.Contents)) (|Set#UnionOne| |Set#Empty| |t#0|))) (=> (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) M1.Container.Contents ($Box SetType |$rhs#0@0|)))) ($IsGoodHeap $Heap@0)) (=> (and (and ($IsAllocBox ($Box refType this@@3) (Tclass.M1.Container? M1.Container$T@@17) $Heap@0) (|M1.Container.Valid_k#canCall| M1.Container$T@@17 $Heap@0 this@@3)) (and (|M1.Container.Valid_k#canCall| M1.Container$T@@17 $Heap@0 this@@3) (M1.Container.Valid_k M1.Container$T@@17 $Heap@0 this@@3))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|M1.Container.Valid#canCall| M1.Container$T@@17 $Heap@0 this@@3) (or (M1.Container.Valid M1.Container$T@@17 $Heap@0 this@@3) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) M1.Container.Repr)) ($Box refType this@@3))))) (=> (=> (|M1.Container.Valid#canCall| M1.Container$T@@17 $Heap@0 this@@3) (or (M1.Container.Valid M1.Container$T@@17 $Heap@0 this@@3) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) M1.Container.Repr)) ($Box refType this@@3)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|M1.Container.Valid#canCall| M1.Container$T@@17 $Heap@0 this@@3) (or (M1.Container.Valid M1.Container$T@@17 $Heap@0 this@@3) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) M1.Container.Repr)) ($Box refType null)))))) (=> (=> (|M1.Container.Valid#canCall| M1.Container$T@@17 $Heap@0 this@@3) (or (M1.Container.Valid M1.Container$T@@17 $Heap@0 this@@3) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) M1.Container.Repr)) ($Box refType null))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|M1.Container.Valid#canCall| M1.Container$T@@17 $Heap@0 this@@3) (or (M1.Container.Valid M1.Container$T@@17 $Heap@0 this@@3) (M1.Container.Valid_k M1.Container$T@@17 $Heap@0 this@@3)))) (=> (=> (|M1.Container.Valid#canCall| M1.Container$T@@17 $Heap@0 this@@3) (or (M1.Container.Valid M1.Container$T@@17 $Heap@0 this@@3) (M1.Container.Valid_k M1.Container$T@@17 $Heap@0 this@@3))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (forall (($o@@10 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) M1.Container.Repr)) ($Box refType $o@@10)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) M1.Container.Repr)) ($Box refType $o@@10)))) (or (not (= $o@@10 null)) (not true)))
 :qid |CachedContainerdfy.44:12|
 :skolemid |1038|
 :pattern (  (or (not (= $o@@10 null)) (not true)))
)) (forall (($o@@11 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) M1.Container.Repr)) ($Box refType $o@@11)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) M1.Container.Repr)) ($Box refType $o@@11)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@11) alloc)))))
 :qid |CachedContainerdfy.44:12|
 :skolemid |1039|
...
)))) (=> (and (forall (($o@@12 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) M1.Container.Repr)) ($Box refType $o@@12)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) M1.Container.Repr)) ($Box refType $o@@12)))) (or (not (= $o@@12 null)) (not true)))
 :qid |CachedContainerdfy.44:12|
 :skolemid |1038|
 :pattern (  (or (not (= $o@@12 null)) (not true)))
)) (forall (($o@@13 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) M1.Container.Repr)) ($Box refType $o@@13)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) M1.Container.Repr)) ($Box refType $o@@13)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@13) alloc)))))
 :qid |CachedContainerdfy.44:12|
 :skolemid |1039|
...
))) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) M1.Container.Contents)) (|Set#Difference| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) M1.Container.Contents)) (|Set#UnionOne| |Set#Empty| |t#0|))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 (Tclass.M1.Container M1.Container$T@@17)) ($IsAlloc refType this@@3 (Tclass.M1.Container M1.Container$T@@17) $Heap@@1)))) (=> (and (and (and ($IsBox |t#0| M1.Container$T@@17) ($IsAllocBox |t#0| M1.Container$T@@17 $Heap@@1)) (= 2 $FunctionContextHeight)) (and (and (|M1.Container.Valid#canCall| M1.Container$T@@17 $Heap@@1 this@@3) (and (M1.Container.Valid M1.Container$T@@17 $Heap@@1 this@@3) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) M1.Container.Repr)) ($Box refType this@@3)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) M1.Container.Repr)) ($Box refType null)))) (M1.Container.Valid_k M1.Container$T@@17 $Heap@@1 this@@3)))) (= (ControlFlow 0 8) 2))) anon0_correct))))
