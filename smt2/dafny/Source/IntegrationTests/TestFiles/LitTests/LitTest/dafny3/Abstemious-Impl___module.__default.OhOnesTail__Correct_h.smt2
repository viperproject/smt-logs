...
(set-info :boogie-vc-id Impl$$_module.__default.OhOnesTail__Correct_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (|$PrefixEq#_module.Stream| TInt TInt |_k#0| ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.OhOnes ($LS $LZ))))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.OhOnes ($LS ($LS $LZ))))))) (and (_module.Stream.Cons_q (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ))))) (and (= (U_2_int ($Unbox intType (_module.Stream.head (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.OhOnes ($LS ($LS $LZ))))))))) (U_2_int ($Unbox intType (_module.Stream.head (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ)))))))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.OhOnes ($LS ($LS $LZ))))))) (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ)))))))))))) (=> (or (|$PrefixEq#_module.Stream| TInt TInt |_k#0| ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.OhOnes ($LS $LZ))))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.OhOnes ($LS ($LS $LZ))))))) (and (_module.Stream.Cons_q (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ))))) (and (= (U_2_int ($Unbox intType (_module.Stream.head (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.OhOnes ($LS ($LS $LZ))))))))) (U_2_int ($Unbox intType (_module.Stream.head (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ)))))))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.OhOnes ($LS ($LS $LZ))))))) (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ))))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (or (|$PrefixEq#_module.Stream| TInt TInt |_k#0| ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.OhOnes ($LS $LZ))))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))) (or (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.OhOnes ($LS ($LS $LZ))))))) (and (_module.Stream.Cons_q (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ))))) (and (= (U_2_int ($Unbox intType (_module.Stream.head (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.OhOnes ($LS ($LS $LZ))))))))) (U_2_int ($Unbox intType (_module.Stream.head (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ)))))))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.OhOnes ($LS ($LS $LZ))))))) (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ)))))))))) (=> (and (or (not (= |_k#0| (|ORD#FromNat| 0))) (not true)) (= (|ORD#Offset| |_k#0|) 0)) (|$Eq#_module.Stream| TInt TInt ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.OhOnes ($LS $LZ))))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ))))))))))))
(let ((anon3_Else_correct  (=> (<= (|ORD#Offset| |_k#0|) 0) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1)) (and (forall ((|_k'#0| T@U) ) (!  (=> (|ORD#Less| |_k'#0| |_k#0|) (|$PrefixEq#_module.Stream| TInt TInt |_k'#0| ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.OhOnes ($LS $LZ))))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))))
 :qid |Abstemiousdfy.141:16|
 :skolemid |743|
 :pattern ( (|$PrefixEq#_module.Stream| TInt TInt |_k'#0| ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.OhOnes ($LS $LZ))) (_module.__default.ones ($LS $LZ))))
 :pattern ( (|ORD#Less| |_k'#0| |_k#0|))
)) (= (ControlFlow 0 5) 2))) GeneratedUnifiedExit_correct))))
(let ((anon3_Then_correct  (=> (and (< 0 (|ORD#Offset| |_k#0|)) (= (ControlFlow 0 4) 2)) GeneratedUnifiedExit_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#_k0#0| T@U) ) (!  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) (|ORD#Less| |$ih#_k0#0| |_k#0|)) (|$PrefixEq#_module.Stream| TInt TInt |$ih#_k0#0| ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.OhOnes ($LS $LZ))))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))))
 :qid |Abstemiousdfy.141:16|
 :skolemid |742|
 :pattern ( (|$PrefixEq#_module.Stream| TInt TInt |$ih#_k0#0| ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.OhOnes ($LS $LZ))))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))))
)))) (and (=> (= (ControlFlow 0 6) 4) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct)))
