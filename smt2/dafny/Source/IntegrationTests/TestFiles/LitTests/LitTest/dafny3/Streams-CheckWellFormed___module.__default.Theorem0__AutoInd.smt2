...
(declare-fun $LZ () T@U)
(declare-fun |k#0| () Int)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Theorem0__AutoInd)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (=> (and (and (and ($IsAlloc DatatypeTypeType |M#0@@8| (Tclass._module.Stream Tclass._module.X) $Heap@0) (|_module.__default.map__fg#canCall| |M#0@@8|)) (and ($IsAlloc DatatypeTypeType |M#0@@8| (Tclass._module.Stream Tclass._module.X) $Heap@0) (|_module.__default.map__g#canCall| |M#0@@8|))) (and (and (= |##M#1@0| (_module.__default.map__g ($LS $LZ) |M#0@@8|)) ($IsAlloc DatatypeTypeType |##M#1@0| (Tclass._module.Stream Tclass._module.X) $Heap@0)) (and (|_module.__default.map__f#canCall| (_module.__default.map__g ($LS $LZ) |M#0@@8|)) (= (ControlFlow 0 2) (- 0 1))))) (<= 0 |k#0|))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |k#0|)) (=> (and (and (and ($Is DatatypeTypeType |M#0@@8| (Tclass._module.Stream Tclass._module.X)) ($IsAlloc DatatypeTypeType |M#0@@8| (Tclass._module.Stream Tclass._module.X) $Heap)) (|$IsA#_module.Stream| |M#0@@8|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
