...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.append$_T0@@1 T@U) ($ly@@1 T@U) (|M#0@@1| T@U) (|N#0@@1| T@U) ) (!  (=> (and (or (|_module.__default.append#canCall| _module._default.append$_T0@@1 |M#0@@1| |N#0@@1|) (and (< 1 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |M#0@@1| (Tclass._module.Stream _module._default.append$_T0@@1)) ($IsAlloc DatatypeTypeType |M#0@@1| (Tclass._module.Stream _module._default.append$_T0@@1) $Heap)) (and ($Is DatatypeTypeType |N#0@@1| (Tclass._module.Stream _module._default.append$_T0@@1)) ($IsAlloc DatatypeTypeType |N#0@@1| (Tclass._module.Stream _module._default.append$_T0@@1) $Heap))))) ($IsGoodHeap $Heap)) ($IsAlloc DatatypeTypeType (_module.__default.append _module._default.append$_T0@@1 $ly@@1 |M#0@@1| |N#0@@1|) (Tclass._module.Stream _module._default.append$_T0@@1) $Heap))
 :qid |Streamsdfy.8:16|
 :skolemid |587|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.__default.append _module._default.append$_T0@@1 $ly@@1 |M#0@@1| |N#0@@1|) (Tclass._module.Stream _module._default.append$_T0@@1) $Heap))
))))
(assert (forall ((_module._default.append$_T0@@2 T@U) ($ly@@2 T@U) (|M#0@@2| T@U) (|N#0@@2| T@U) ) (! (= (_module.__default.append _module._default.append$_T0@@2 ($LS $ly@@2) |M#0@@2| |N#0@@2|) (_module.__default.append _module._default.append$_T0@@2 $ly@@2 |M#0@@2| |N#0@@2|))
 :qid |unknown.0:0|
 :skolemid |581|
 :pattern ( (_module.__default.append _module._default.append$_T0@@2 ($LS $ly@@2) |M#0@@2| |N#0@@2|))
)))
...
(declare-fun $Heap@@0 () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.Theorem4__Alt_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |_k#0| ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS $LZ) |M#1| (_module.__default.append Tclass._module.X ($LS $LZ) |N#1| |P#1|)) (_module.__default.append Tclass._module.X ($LS $LZ) (_module.__default.append Tclass._module.X ($LS $LZ) |M#1| |N#1|) |P#1|)) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Nil_q (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |N#1| |P#1|))) (_module.Stream.Nil_q (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| |N#1|) |P#1|)))))) (=> (or (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |_k#0| ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS $LZ) |M#1| (_module.__default.append Tclass._module.X ($LS $LZ) |N#1| |P#1|)) (_module.__default.append Tclass._module.X ($LS $LZ) (_module.__default.append Tclass._module.X ($LS $LZ) |M#1| |N#1|) |P#1|)) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Nil_q (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |N#1| |P#1|))) (_module.Stream.Nil_q (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| |N#1|) |P#1|))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |_k#0| ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS $LZ) |M#1| (_module.__default.append Tclass._module.X ($LS $LZ) |N#1| |P#1|)) (_module.__default.append Tclass._module.X ($LS $LZ) (_module.__default.append Tclass._module.X ($LS $LZ) |M#1| |N#1|) |P#1|)) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |N#1| |P#1|))) (and (_module.Stream.Cons_q (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| |N#1|) |P#1|)) (and (= (_module.Stream.head (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |N#1| |P#1|))) (_module.Stream.head (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| |N#1|) |P#1|))) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |N#1| |P#1|))) (_module.Stream.tail (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| |N#1|) |P#1|))))))))) (=> (or (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |_k#0| ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS $LZ) |M#1| (_module.__default.append Tclass._module.X ($LS $LZ) |N#1| |P#1|)) (_module.__default.append Tclass._module.X ($LS $LZ) (_module.__default.append Tclass._module.X ($LS $LZ) |M#1| |N#1|) |P#1|)) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |N#1| |P#1|))) (and (_module.Stream.Cons_q (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| |N#1|) |P#1|)) (and (= (_module.Stream.head (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |N#1| |P#1|))) (_module.Stream.head (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| |N#1|) |P#1|))) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |N#1| |P#1|))) (_module.Stream.tail (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| |N#1|) |P#1|)))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (or (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |_k#0| ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS $LZ) |M#1| (_module.__default.append Tclass._module.X ($LS $LZ) |N#1| |P#1|)) (_module.__default.append Tclass._module.X ($LS $LZ) (_module.__default.append Tclass._module.X ($LS $LZ) |M#1| |N#1|) |P#1|)) (or (=> (< 0 (|ORD#Offset| |_k#0|)) (and (=> (_module.Stream.Nil_q (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |N#1| |P#1|))) (_module.Stream.Nil_q (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| |N#1|) |P#1|))) (=> (_module.Stream.Cons_q (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |N#1| |P#1|))) (and (_module.Stream.Cons_q (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| |N#1|) |P#1|)) (and (= (_module.Stream.head (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |N#1| |P#1|))) (_module.Stream.head (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| |N#1|) |P#1|))) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |N#1| |P#1|))) (_module.Stream.tail (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#1| |N#1|) |P#1|)))))))) (=> (and (or (not (= |_k#0| (|ORD#FromNat| 0))) (not true)) (= (|ORD#Offset| |_k#0|) 0)) (|$Eq#_module.Stream| Tclass._module.X Tclass._module.X ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS $LZ) |M#1| (_module.__default.append Tclass._module.X ($LS $LZ) |N#1| |P#1|)) (_module.__default.append Tclass._module.X ($LS $LZ) (_module.__default.append Tclass._module.X ($LS $LZ) |M#1| |N#1|) |P#1|))))))))))))
(let ((anon6_Else_correct  (=> (and (not (_module.Stream.Cons_q |M#1|)) (= (ControlFlow 0 10) 2)) GeneratedUnifiedExit_correct)))
(let ((anon6_Then_correct  (=> (_module.Stream.Cons_q |M#1|) (and (=> (= (ControlFlow 0 6) (- 0 9)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0|)) (=> (= |_k##0@0| (|ORD#Minus| |_k#0| (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (_module.Stream.Cons_q |M#1|)) (=> (_module.Stream.Cons_q |M#1|) (=> (= |M##0@0| (_module.Stream.tail |M#1|)) (=> (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (=> (and (and (and (and (|_module.__default.append#canCall| Tclass._module.X |N#1| |P#1|) (|_module.__default.append#canCall| Tclass._module.X |M##0@0| (_module.__default.append Tclass._module.X ($LS $LZ) |N#1| |P#1|))) (and (|_module.__default.append#canCall| Tclass._module.X |M##0@0| |N#1|) (|_module.__default.append#canCall| Tclass._module.X (_module.__default.append Tclass._module.X ($LS $LZ) |M##0@0| |N#1|) |P#1|))) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |_k##0@0| ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS $LZ) |M##0@0| (_module.__default.append Tclass._module.X ($LS $LZ) |N#1| |P#1|)) (_module.__default.append Tclass._module.X ($LS $LZ) (_module.__default.append Tclass._module.X ($LS $LZ) |M##0@0| |N#1|) |P#1|))) (and (= $Heap@0 $Heap@2) (= (ControlFlow 0 6) 2))) GeneratedUnifiedExit_correct)))))))))))))
(let ((anon5_Then_correct  (=> (< 0 (|ORD#Offset| |_k#0|)) (and (=> (= (ControlFlow 0 11) 6) anon6_Then_correct) (=> (= (ControlFlow 0 11) 10) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (<= (|ORD#Offset| |_k#0|) 0) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1)) (and (forall ((|_k'#0| T@U) (|M#2| T@U) (|N#2| T@U) (|P#2| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |M#2| (Tclass._module.Stream Tclass._module.X)) ($Is DatatypeTypeType |N#2| (Tclass._module.Stream Tclass._module.X))) ($Is DatatypeTypeType |P#2| (Tclass._module.Stream Tclass._module.X))) (|ORD#Less| |_k'#0| |_k#0|)) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |_k'#0| ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS $LZ) |M#2| (_module.__default.append Tclass._module.X ($LS $LZ) |N#2| |P#2|)) (_module.__default.append Tclass._module.X ($LS $LZ) (_module.__default.append Tclass._module.X ($LS $LZ) |M#2| |N#2|) |P#2|)))
 :qid |Streamsdfy.165:16|
 :skolemid |653|
 :pattern ( (_module.__default.append Tclass._module.X ($LS $LZ) (_module.__default.append Tclass._module.X ($LS $LZ) |M#2| |N#2|) |P#2|) (|ORD#Less| |_k'#0| |_k#0|))
 :pattern ( (_module.__default.append Tclass._module.X ($LS $LZ) |M#2| (_module.__default.append Tclass._module.X ($LS $LZ) |N#2| |P#2|)) (|ORD#Less| |_k'#0| |_k#0|))
)) (= (ControlFlow 0 5) 2))) GeneratedUnifiedExit_correct))))
(let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (|$IsA#_module.Stream| |M#1|)) (and (|$IsA#_module.Stream| |N#1|) (|$IsA#_module.Stream| |P#1|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@0 $Heap@0) (forall ((|$ih#_k0#0| T@U) (|$ih#M0#0| T@U) (|$ih#N0#0| T@U) (|$ih#P0#0| T@U) ) (!  (=> (and (and (and (and ($Is DatatypeTypeType |$ih#M0#0| (Tclass._module.Stream Tclass._module.X)) ($Is DatatypeTypeType |$ih#N0#0| (Tclass._module.Stream Tclass._module.X))) ($Is DatatypeTypeType |$ih#P0#0| (Tclass._module.Stream Tclass._module.X))) (U_2_bool (Lit boolType (bool_2_U true)))) (|ORD#Less| |$ih#_k0#0| |_k#0|)) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |$ih#_k0#0| ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS $LZ) |$ih#M0#0| (_module.__default.append Tclass._module.X ($LS $LZ) |$ih#N0#0| |$ih#P0#0|)) (_module.__default.append Tclass._module.X ($LS $LZ) (_module.__default.append Tclass._module.X ($LS $LZ) |$ih#M0#0| |$ih#N0#0|) |$ih#P0#0|)))
 :qid |Streamsdfy.165:16|
 :skolemid |651|
 :pattern ( (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X |$ih#_k0#0| ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS $LZ) |$ih#M0#0| (_module.__default.append Tclass._module.X ($LS $LZ) |$ih#N0#0| |$ih#P0#0|)) (_module.__default.append Tclass._module.X ($LS $LZ) (_module.__default.append Tclass._module.X ($LS $LZ) |$ih#M0#0| |$ih#N0#0|) |$ih#P0#0|)))
))))) (and (=> (= (ControlFlow 0 12) 11) anon5_Then_correct) (=> (= (ControlFlow 0 12) 5) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (and ($Is DatatypeTypeType |M#1| (Tclass._module.Stream Tclass._module.X)) ($IsAlloc DatatypeTypeType |M#1| (Tclass._module.Stream Tclass._module.X) $Heap@@0)) (|$IsA#_module.Stream| |M#1|)) (and (and ($Is DatatypeTypeType |N#1| (Tclass._module.Stream Tclass._module.X)) ($IsAlloc DatatypeTypeType |N#1| (Tclass._module.Stream Tclass._module.X) $Heap@@0)) (|$IsA#_module.Stream| |N#1|))) (and (and (and ($Is DatatypeTypeType |P#1| (Tclass._module.Stream Tclass._module.X)) ($IsAlloc DatatypeTypeType |P#1| (Tclass._module.Stream Tclass._module.X) $Heap@@0)) (|$IsA#_module.Stream| |P#1|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 13) 12)))) anon0_correct))))
