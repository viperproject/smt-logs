...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@1 T@U) (|_k#0@@1| T@U) (|s#0@@1| T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.__default.LowerThan_h#canCall| (Lit BoxType |_k#0@@1|) (Lit DatatypeTypeType |s#0@@1|) (LitInt |n#0@@0|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@1| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@0|)))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@1|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Stream.Nil_q (Lit DatatypeTypeType |s#0@@1|)))))) (let ((|tail#9| (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |s#0@@1|)))))
(let ((|t#9| (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Stream.head (Lit DatatypeTypeType |s#0@@1|))))))
 (=> (<= (LitInt 1) (LitInt |n#0@@0|)) (and (and (_module.Tree.Node_q |t#9|) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@1| (|ORD#FromNat| 1)) (_module.Tree.children |t#9|) (LitInt (- |n#0@@0| 1)))) (=> (_module.__default.LowerThan_h ($LS $ly@@1) (|ORD#Minus| |_k#0@@1| (|ORD#FromNat| 1)) (_module.Tree.children |t#9|) (LitInt (- |n#0@@0| 1))) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@1| (|ORD#FromNat| 1)) |tail#9| (LitInt |n#0@@0|))))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@1|)) (ite (_module.Stream.Nil_q (Lit DatatypeTypeType |s#0@@1|)) true (let ((|tail#10| (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |s#0@@1|)))))
(let ((|t#10| (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Stream.head (Lit DatatypeTypeType |s#0@@1|))))))
 (and (and (<= (LitInt 1) (LitInt |n#0@@0|)) (_module.__default.LowerThan_h ($LS $ly@@1) (|ORD#Minus| |_k#0@@1| (|ORD#FromNat| 1)) (Lit DatatypeTypeType (_module.Tree.children |t#10|)) (LitInt (- |n#0@@0| 1)))) (_module.__default.LowerThan_h ($LS $ly@@1) (|ORD#Minus| |_k#0@@1| (|ORD#FromNat| 1)) |tail#10| (LitInt |n#0@@0|))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@1|)) (forall ((|_k'#2| T@U) ) (!  (=> (|ORD#Less| |_k'#2| |_k#0@@1|) (|_module.__default.LowerThan_h#canCall| |_k'#2| |s#0@@1| |n#0@@0|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |669|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@1) |_k'#2| |s#0@@1| |n#0@@0|))
))))) (= (_module.__default.LowerThan_h ($LS $ly@@1) (Lit BoxType |_k#0@@1|) (Lit DatatypeTypeType |s#0@@1|) (LitInt |n#0@@0|))  (and (=> (< 0 (|ORD#Offset| |_k#0@@1|)) (ite (_module.Stream.Nil_q (Lit DatatypeTypeType |s#0@@1|)) true (let ((|tail#8| (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |s#0@@1|)))))
(let ((|t#8| (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Stream.head (Lit DatatypeTypeType |s#0@@1|))))))
 (and (and (<= (LitInt 1) (LitInt |n#0@@0|)) (_module.__default.LowerThan_h ($LS $ly@@1) (|ORD#Minus| |_k#0@@1| (|ORD#FromNat| 1)) (Lit DatatypeTypeType (_module.Tree.children |t#8|)) (LitInt (- |n#0@@0| 1)))) (_module.__default.LowerThan_h ($LS $ly@@1) (|ORD#Minus| |_k#0@@1| (|ORD#FromNat| 1)) |tail#8| (LitInt |n#0@@0|))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@1|)) (forall ((|_k'#2@@0| T@U) ) (!  (=> (|ORD#Less| |_k'#2@@0| |_k#0@@1|) (_module.__default.LowerThan_h ($LS $ly@@1) |_k'#2@@0| |s#0@@1| |n#0@@0|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |668|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@1) |_k'#2@@0| |s#0@@1| |n#0@@0|))
)))))))
 :qid |InfiniteTreesdfy.71:20|
 :weight 3
 :skolemid |670|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@1) (Lit BoxType |_k#0@@1|) (Lit DatatypeTypeType |s#0@@1|) (LitInt |n#0@@0|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@2 T@U) (|s#0@@2| T@U) (|_k#0@@2| T@U) ) (!  (=> (and ($Is DatatypeTypeType |s#0@@2| (Tclass._module.Stream Tclass._module.Tree)) (= |_k#0@@2| (|ORD#FromNat| 0))) (_module.__default.InfiniteEverywhere_h $ly@@2 |_k#0@@2| |s#0@@2|))
 :qid |InfiniteTreesdfy.105:20|
 :skolemid |688|
 :pattern ( (_module.__default.InfiniteEverywhere_h $ly@@2 |_k#0@@2| |s#0@@2|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@3 T@U) (|s#0@@3| T@U) ) (!  (=> (or (|_module.__default.InfiniteEverywhere#canCall| |s#0@@3|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |s#0@@3| (Tclass._module.Stream Tclass._module.Tree)))) (and (=> (not (_module.Stream.Nil_q |s#0@@3|)) (let ((|tail#1| (_module.Stream.tail |s#0@@3|)))
(let ((|t#1| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@3|))))
 (and (and (_module.Tree.Node_q |t#1|) (|_module.__default.InfiniteEverywhere#canCall| (_module.Tree.children |t#1|))) (=> (_module.__default.InfiniteEverywhere $ly@@3 (_module.Tree.children |t#1|)) (|_module.__default.InfiniteEverywhere#canCall| |tail#1|)))))) (= (_module.__default.InfiniteEverywhere ($LS $ly@@3) |s#0@@3|) (ite (_module.Stream.Nil_q |s#0@@3|) false (let ((|tail#0| (_module.Stream.tail |s#0@@3|)))
(let ((|t#0@@0| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@3|))))
 (and (_module.__default.InfiniteEverywhere $ly@@3 (_module.Tree.children |t#0@@0|)) (_module.__default.InfiniteEverywhere $ly@@3 |tail#0|))))))))
 :qid |InfiniteTreesdfy.105:20|
 :skolemid |684|
 :pattern ( (_module.__default.InfiniteEverywhere ($LS $ly@@3) |s#0@@3|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@4 T@U) (|s#0@@4| T@U) ) (!  (=> (and ($Is DatatypeTypeType |s#0@@4| (Tclass._module.Stream Tclass._module.Tree)) (forall ((|_k#0@@3| T@U) ) (! (_module.__default.InfiniteEverywhere_h ($LS $ly@@4) |_k#0@@3| |s#0@@4|)
 :qid |InfiniteTreesdfy.105:20|
 :skolemid |685|
 :pattern ( (_module.__default.InfiniteEverywhere_h ($LS $ly@@4) |_k#0@@3| |s#0@@4|))
))) (_module.__default.InfiniteEverywhere ($LS $ly@@4) |s#0@@4|))
 :qid |InfiniteTreesdfy.105:20|
 :skolemid |687|
 :pattern ( (_module.__default.InfiniteEverywhere ($LS $ly@@4) |s#0@@4|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@5 T@U) (|s#0@@5| T@U) (|n#0@@1| Int) ) (!  (=> (and (and ($Is DatatypeTypeType |s#0@@5| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@1|)) (forall ((|_k#0@@4| T@U) ) (! (_module.__default.LowerThan_h ($LS $ly@@5) |_k#0@@4| |s#0@@5| |n#0@@1|)
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |652|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@5) |_k#0@@4| |s#0@@5| |n#0@@1|))
))) (_module.__default.LowerThan ($LS $ly@@5) |s#0@@5| |n#0@@1|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |654|
 :pattern ( (_module.__default.LowerThan ($LS $ly@@5) |s#0@@5| |n#0@@1|))
))))
...
(assert (forall (($ly@@6 T@U) (|s#0@@6| T@U) (|n#0@@4| Int) ) (! (= (_module.__default.LowerThan ($LS $ly@@6) |s#0@@6| |n#0@@4|) (_module.__default.LowerThan $ly@@6 |s#0@@6| |n#0@@4|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |647|
 :pattern ( (_module.__default.LowerThan ($LS $ly@@6) |s#0@@6| |n#0@@4|))
)))
(assert (forall (($ly@@7 T@U) (|_k#0@@5| T@U) (|s#0@@7| T@U) ) (! (= (_module.__default.InfiniteEverywhere_h ($LS $ly@@7) |_k#0@@5| |s#0@@7|) (_module.__default.InfiniteEverywhere_h $ly@@7 |_k#0@@5| |s#0@@7|))
 :qid |InfiniteTreesdfy.105:20|
 :skolemid |691|
 :pattern ( (_module.__default.InfiniteEverywhere_h ($LS $ly@@7) |_k#0@@5| |s#0@@7|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@8 T@U) (|s#0@@8| T@U) ) (!  (=> (and ($Is DatatypeTypeType |s#0@@8| (Tclass._module.Stream Tclass._module.Tree)) (_module.__default.InfiniteEverywhere ($LS $ly@@8) |s#0@@8|)) (forall ((|_k#0@@6| T@U) ) (! (_module.__default.InfiniteEverywhere_h ($LS $ly@@8) |_k#0@@6| |s#0@@8|)
 :qid |InfiniteTreesdfy.105:20|
 :skolemid |685|
 :pattern ( (_module.__default.InfiniteEverywhere_h ($LS $ly@@8) |_k#0@@6| |s#0@@8|))
)))
 :qid |InfiniteTreesdfy.105:20|
 :skolemid |686|
 :pattern ( (_module.__default.InfiniteEverywhere ($LS $ly@@8) |s#0@@8|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@9 T@U) (|_k#0@@7| T@U) (|s#0@@9| T@U) (|n#0@@5| Int) ) (!  (=> (or (|_module.__default.LowerThan_h#canCall| (Lit BoxType |_k#0@@7|) |s#0@@9| |n#0@@5|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@9| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@5|)))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@7|)) (=> (not (_module.Stream.Nil_q |s#0@@9|)) (let ((|tail#6| (_module.Stream.tail |s#0@@9|)))
(let ((|t#6| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@9|))))
 (=> (<= (LitInt 1) |n#0@@5|) (and (and (_module.Tree.Node_q |t#6|) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@7| (|ORD#FromNat| 1)) (_module.Tree.children |t#6|) (- |n#0@@5| 1))) (=> (_module.__default.LowerThan_h ($LS $ly@@9) (|ORD#Minus| |_k#0@@7| (|ORD#FromNat| 1)) (_module.Tree.children |t#6|) (- |n#0@@5| 1)) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@7| (|ORD#FromNat| 1)) |tail#6| |n#0@@5|)))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@7|)) (ite (_module.Stream.Nil_q |s#0@@9|) true (let ((|tail#7| (_module.Stream.tail |s#0@@9|)))
(let ((|t#7| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@9|))))
 (and (and (<= (LitInt 1) |n#0@@5|) (_module.__default.LowerThan_h ($LS $ly@@9) (|ORD#Minus| |_k#0@@7| (|ORD#FromNat| 1)) (_module.Tree.children |t#7|) (- |n#0@@5| 1))) (_module.__default.LowerThan_h ($LS $ly@@9) (|ORD#Minus| |_k#0@@7| (|ORD#FromNat| 1)) |tail#7| |n#0@@5|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@7|)) (forall ((|_k'#1| T@U) ) (!  (=> (|ORD#Less| |_k'#1| |_k#0@@7|) (|_module.__default.LowerThan_h#canCall| |_k'#1| |s#0@@9| |n#0@@5|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |666|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@9) |_k'#1| |s#0@@9| |n#0@@5|))
))))) (= (_module.__default.LowerThan_h ($LS $ly@@9) (Lit BoxType |_k#0@@7|) |s#0@@9| |n#0@@5|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@7|)) (ite (_module.Stream.Nil_q |s#0@@9|) true (let ((|tail#5| (_module.Stream.tail |s#0@@9|)))
(let ((|t#5| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@9|))))
 (and (and (<= (LitInt 1) |n#0@@5|) (_module.__default.LowerThan_h ($LS $ly@@9) (|ORD#Minus| |_k#0@@7| (|ORD#FromNat| 1)) (_module.Tree.children |t#5|) (- |n#0@@5| 1))) (_module.__default.LowerThan_h ($LS $ly@@9) (|ORD#Minus| |_k#0@@7| (|ORD#FromNat| 1)) |tail#5| |n#0@@5|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@7|)) (forall ((|_k'#1@@0| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@0| |_k#0@@7|) (_module.__default.LowerThan_h ($LS $ly@@9) |_k'#1@@0| |s#0@@9| |n#0@@5|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |665|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@9) |_k'#1@@0| |s#0@@9| |n#0@@5|))
)))))))
 :qid |InfiniteTreesdfy.71:20|
 :weight 3
 :skolemid |667|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@9) (Lit BoxType |_k#0@@7|) |s#0@@9| |n#0@@5|))
))))
(assert (forall ((_module.Stream$T@@3 T@U) (d@@7 T@U) ) (!  (=> ($Is DatatypeTypeType d@@7 (Tclass._module.Stream _module.Stream$T@@3)) (or (_module.Stream.Nil_q d@@7) (_module.Stream.Cons_q d@@7)))
 :qid |unknown.0:0|
 :skolemid |1161|
 :pattern ( (_module.Stream.Cons_q d@@7) ($Is DatatypeTypeType d@@7 (Tclass._module.Stream _module.Stream$T@@3)))
 :pattern ( (_module.Stream.Nil_q d@@7) ($Is DatatypeTypeType d@@7 (Tclass._module.Stream _module.Stream$T@@3)))
)))
(assert (forall (($ly@@10 T@U) (|s#0@@10| T@U) ) (! (= (_module.__default.InfiniteEverywhere ($LS $ly@@10) |s#0@@10|) (_module.__default.InfiniteEverywhere $ly@@10 |s#0@@10|))
 :qid |InfiniteTreesdfy.105:20|
 :skolemid |680|
 :pattern ( (_module.__default.InfiniteEverywhere ($LS $ly@@10) |s#0@@10|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@11 T@U) (|_k#0@@8| T@U) (|s#0@@11| T@U) (|n#0@@6| Int) ) (!  (=> (or (|_module.__default.LowerThan_h#canCall| |_k#0@@8| |s#0@@11| |n#0@@6|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@11| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@6|)))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@8|)) (=> (not (_module.Stream.Nil_q |s#0@@11|)) (let ((|tail#3@@0| (_module.Stream.tail |s#0@@11|)))
(let ((|t#3@@0| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@11|))))
 (=> (<= (LitInt 1) |n#0@@6|) (and (and (_module.Tree.Node_q |t#3@@0|) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@8| (|ORD#FromNat| 1)) (_module.Tree.children |t#3@@0|) (- |n#0@@6| 1))) (=> (_module.__default.LowerThan_h $ly@@11 (|ORD#Minus| |_k#0@@8| (|ORD#FromNat| 1)) (_module.Tree.children |t#3@@0|) (- |n#0@@6| 1)) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@8| (|ORD#FromNat| 1)) |tail#3@@0| |n#0@@6|)))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@8|)) (ite (_module.Stream.Nil_q |s#0@@11|) true (let ((|tail#4@@0| (_module.Stream.tail |s#0@@11|)))
(let ((|t#4@@0| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@11|))))
 (and (and (<= (LitInt 1) |n#0@@6|) (_module.__default.LowerThan_h $ly@@11 (|ORD#Minus| |_k#0@@8| (|ORD#FromNat| 1)) (_module.Tree.children |t#4@@0|) (- |n#0@@6| 1))) (_module.__default.LowerThan_h $ly@@11 (|ORD#Minus| |_k#0@@8| (|ORD#FromNat| 1)) |tail#4@@0| |n#0@@6|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@8|)) (forall ((|_k'#0@@1| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@1| |_k#0@@8|) (|_module.__default.LowerThan_h#canCall| |_k'#0@@1| |s#0@@11| |n#0@@6|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |663|
 :pattern ( (_module.__default.LowerThan_h $ly@@11 |_k'#0@@1| |s#0@@11| |n#0@@6|))
))))) (= (_module.__default.LowerThan_h ($LS $ly@@11) |_k#0@@8| |s#0@@11| |n#0@@6|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@8|)) (ite (_module.Stream.Nil_q |s#0@@11|) true (let ((|tail#2@@0| (_module.Stream.tail |s#0@@11|)))
(let ((|t#2@@0| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@11|))))
 (and (and (<= (LitInt 1) |n#0@@6|) (_module.__default.LowerThan_h $ly@@11 (|ORD#Minus| |_k#0@@8| (|ORD#FromNat| 1)) (_module.Tree.children |t#2@@0|) (- |n#0@@6| 1))) (_module.__default.LowerThan_h $ly@@11 (|ORD#Minus| |_k#0@@8| (|ORD#FromNat| 1)) |tail#2@@0| |n#0@@6|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@8|)) (forall ((|_k'#0@@2| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@2| |_k#0@@8|) (_module.__default.LowerThan_h $ly@@11 |_k'#0@@2| |s#0@@11| |n#0@@6|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |662|
 :pattern ( (_module.__default.LowerThan_h $ly@@11 |_k'#0@@2| |s#0@@11| |n#0@@6|))
)))))))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |664|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@11) |_k#0@@8| |s#0@@11| |n#0@@6|))
))))
(assert (forall (($ly@@12 T@U) (|_k#0@@9| T@U) (|s#0@@12| T@U) (|n#0@@7| Int) ) (! (= (_module.__default.LowerThan_h ($LS $ly@@12) |_k#0@@9| |s#0@@12| |n#0@@7|) (_module.__default.LowerThan_h $ly@@12 |_k#0@@9| |s#0@@12| |n#0@@7|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |658|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@12) |_k#0@@9| |s#0@@12| |n#0@@7|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@13 T@U) (|_k#0@@10| T@U) (|s#0@@13| T@U) ) (!  (=> (or (|_module.__default.InfiniteEverywhere_h#canCall| (Lit BoxType |_k#0@@10|) (Lit DatatypeTypeType |s#0@@13|)) (and (< 3 $FunctionContextHeight) ($Is DatatypeTypeType |s#0@@13| (Tclass._module.Stream Tclass._module.Tree)))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@10|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Stream.Nil_q (Lit DatatypeTypeType |s#0@@13|)))))) (let ((|tail#9@@0| (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |s#0@@13|)))))
(let ((|t#9@@0| (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Stream.head (Lit DatatypeTypeType |s#0@@13|))))))
 (and (and (_module.Tree.Node_q |t#9@@0|) (|_module.__default.InfiniteEverywhere_h#canCall| (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) (_module.Tree.children |t#9@@0|))) (=> (_module.__default.InfiniteEverywhere_h ($LS $ly@@13) (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) (_module.Tree.children |t#9@@0|)) (|_module.__default.InfiniteEverywhere_h#canCall| (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) |tail#9@@0|))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@10|)) (ite (_module.Stream.Nil_q (Lit DatatypeTypeType |s#0@@13|)) false (let ((|tail#10@@0| (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |s#0@@13|)))))
(let ((|t#10@@0| (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Stream.head (Lit DatatypeTypeType |s#0@@13|))))))
 (and (_module.__default.InfiniteEverywhere_h ($LS $ly@@13) (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) (Lit DatatypeTypeType (_module.Tree.children |t#10@@0|))) (_module.__default.InfiniteEverywhere_h ($LS $ly@@13) (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) |tail#10@@0|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@10|)) (forall ((|_k'#2@@1| T@U) ) (!  (=> (|ORD#Less| |_k'#2@@1| |_k#0@@10|) (|_module.__default.InfiniteEverywhere_h#canCall| |_k'#2@@1| |s#0@@13|))
 :qid |InfiniteTreesdfy.105:20|
 :skolemid |702|
 :pattern ( (_module.__default.InfiniteEverywhere_h ($LS $ly@@13) |_k'#2@@1| |s#0@@13|))
))))) (= (_module.__default.InfiniteEverywhere_h ($LS $ly@@13) (Lit BoxType |_k#0@@10|) (Lit DatatypeTypeType |s#0@@13|))  (and (=> (< 0 (|ORD#Offset| |_k#0@@10|)) (ite (_module.Stream.Nil_q (Lit DatatypeTypeType |s#0@@13|)) false (let ((|tail#8@@0| (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |s#0@@13|)))))
(let ((|t#8@@0| (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Stream.head (Lit DatatypeTypeType |s#0@@13|))))))
 (and (_module.__default.InfiniteEverywhere_h ($LS $ly@@13) (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) (Lit DatatypeTypeType (_module.Tree.children |t#8@@0|))) (_module.__default.InfiniteEverywhere_h ($LS $ly@@13) (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) |tail#8@@0|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@10|)) (forall ((|_k'#2@@2| T@U) ) (!  (=> (|ORD#Less| |_k'#2@@2| |_k#0@@10|) (_module.__default.InfiniteEverywhere_h ($LS $ly@@13) |_k'#2@@2| |s#0@@13|))
 :qid |InfiniteTreesdfy.105:20|
 :skolemid |701|
 :pattern ( (_module.__default.InfiniteEverywhere_h ($LS $ly@@13) |_k'#2@@2| |s#0@@13|))
)))))))
 :qid |InfiniteTreesdfy.105:20|
 :weight 3
 :skolemid |703|
 :pattern ( (_module.__default.InfiniteEverywhere_h ($LS $ly@@13) (Lit BoxType |_k#0@@10|) (Lit DatatypeTypeType |s#0@@13|)))
))))
...
(assert (forall ((d@@8 T@U) (_module.Stream$T@@5 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.Stream.Cons_q d@@8) ($IsAlloc DatatypeTypeType d@@8 (Tclass._module.Stream _module.Stream$T@@5) $h@@1))) ($IsAllocBox (_module.Stream.head d@@8) _module.Stream$T@@5 $h@@1))
 :qid |unknown.0:0|
 :skolemid |1156|
 :pattern ( ($IsAllocBox (_module.Stream.head d@@8) _module.Stream$T@@5 $h@@1))
)))
...
(assert (forall ((d@@9 T@U) (_module.Stream$T@@7 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (_module.Stream.Cons_q d@@9) ($IsAlloc DatatypeTypeType d@@9 (Tclass._module.Stream _module.Stream$T@@7) $h@@2))) ($IsAlloc DatatypeTypeType (_module.Stream.tail d@@9) (Tclass._module.Stream _module.Stream$T@@7) $h@@2))
 :qid |unknown.0:0|
 :skolemid |1157|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Stream.tail d@@9) (Tclass._module.Stream _module.Stream$T@@7) $h@@2))
)))
(assert (forall ((d@@10 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) ($Is DatatypeTypeType d@@10 Tclass._module.Tree)) ($IsAlloc DatatypeTypeType d@@10 Tclass._module.Tree $h@@3))
 :qid |unknown.0:0|
 :skolemid |1182|
 :pattern ( ($IsAlloc DatatypeTypeType d@@10 Tclass._module.Tree $h@@3))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@14 T@U) (|_k#0@@11| T@U) (|s#0@@14| T@U) ) (!  (=> (or (|_module.__default.InfiniteEverywhere_h#canCall| (Lit BoxType |_k#0@@11|) |s#0@@14|) (and (< 3 $FunctionContextHeight) ($Is DatatypeTypeType |s#0@@14| (Tclass._module.Stream Tclass._module.Tree)))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@11|)) (=> (not (_module.Stream.Nil_q |s#0@@14|)) (let ((|tail#6@@0| (_module.Stream.tail |s#0@@14|)))
(let ((|t#6@@0| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@14|))))
 (and (and (_module.Tree.Node_q |t#6@@0|) (|_module.__default.InfiniteEverywhere_h#canCall| (|ORD#Minus| |_k#0@@11| (|ORD#FromNat| 1)) (_module.Tree.children |t#6@@0|))) (=> (_module.__default.InfiniteEverywhere_h ($LS $ly@@14) (|ORD#Minus| |_k#0@@11| (|ORD#FromNat| 1)) (_module.Tree.children |t#6@@0|)) (|_module.__default.InfiniteEverywhere_h#canCall| (|ORD#Minus| |_k#0@@11| (|ORD#FromNat| 1)) |tail#6@@0|))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@11|)) (ite (_module.Stream.Nil_q |s#0@@14|) false (let ((|tail#7@@0| (_module.Stream.tail |s#0@@14|)))
(let ((|t#7@@0| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@14|))))
 (and (_module.__default.InfiniteEverywhere_h ($LS $ly@@14) (|ORD#Minus| |_k#0@@11| (|ORD#FromNat| 1)) (_module.Tree.children |t#7@@0|)) (_module.__default.InfiniteEverywhere_h ($LS $ly@@14) (|ORD#Minus| |_k#0@@11| (|ORD#FromNat| 1)) |tail#7@@0|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@11|)) (forall ((|_k'#1@@1| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@1| |_k#0@@11|) (|_module.__default.InfiniteEverywhere_h#canCall| |_k'#1@@1| |s#0@@14|))
 :qid |InfiniteTreesdfy.105:20|
 :skolemid |699|
 :pattern ( (_module.__default.InfiniteEverywhere_h ($LS $ly@@14) |_k'#1@@1| |s#0@@14|))
))))) (= (_module.__default.InfiniteEverywhere_h ($LS $ly@@14) (Lit BoxType |_k#0@@11|) |s#0@@14|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@11|)) (ite (_module.Stream.Nil_q |s#0@@14|) false (let ((|tail#5@@0| (_module.Stream.tail |s#0@@14|)))
(let ((|t#5@@0| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@14|))))
 (and (_module.__default.InfiniteEverywhere_h ($LS $ly@@14) (|ORD#Minus| |_k#0@@11| (|ORD#FromNat| 1)) (_module.Tree.children |t#5@@0|)) (_module.__default.InfiniteEverywhere_h ($LS $ly@@14) (|ORD#Minus| |_k#0@@11| (|ORD#FromNat| 1)) |tail#5@@0|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@11|)) (forall ((|_k'#1@@2| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@2| |_k#0@@11|) (_module.__default.InfiniteEverywhere_h ($LS $ly@@14) |_k'#1@@2| |s#0@@14|))
 :qid |InfiniteTreesdfy.105:20|
 :skolemid |698|
 :pattern ( (_module.__default.InfiniteEverywhere_h ($LS $ly@@14) |_k'#1@@2| |s#0@@14|))
)))))))
 :qid |InfiniteTreesdfy.105:20|
 :weight 3
 :skolemid |700|
 :pattern ( (_module.__default.InfiniteEverywhere_h ($LS $ly@@14) (Lit BoxType |_k#0@@11|) |s#0@@14|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@15 T@U) (|s#0@@15| T@U) (|n#0@@8| Int) ) (!  (=> (or (|_module.__default.LowerThan#canCall| |s#0@@15| |n#0@@8|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@15| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@8|)))) (and (=> (not (_module.Stream.Nil_q |s#0@@15|)) (let ((|tail#1@@0| (_module.Stream.tail |s#0@@15|)))
(let ((|t#1@@0| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@15|))))
 (=> (<= (LitInt 1) |n#0@@8|) (and (and (_module.Tree.Node_q |t#1@@0|) (|_module.__default.LowerThan#canCall| (_module.Tree.children |t#1@@0|) (- |n#0@@8| 1))) (=> (_module.__default.LowerThan $ly@@15 (_module.Tree.children |t#1@@0|) (- |n#0@@8| 1)) (|_module.__default.LowerThan#canCall| |tail#1@@0| |n#0@@8|))))))) (= (_module.__default.LowerThan ($LS $ly@@15) |s#0@@15| |n#0@@8|) (ite (_module.Stream.Nil_q |s#0@@15|) true (let ((|tail#0@@0| (_module.Stream.tail |s#0@@15|)))
(let ((|t#0@@4| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@15|))))
 (and (and (<= (LitInt 1) |n#0@@8|) (_module.__default.LowerThan $ly@@15 (_module.Tree.children |t#0@@4|) (- |n#0@@8| 1))) (_module.__default.LowerThan $ly@@15 |tail#0@@0| |n#0@@8|))))))))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |651|
 :pattern ( (_module.__default.LowerThan ($LS $ly@@15) |s#0@@15| |n#0@@8|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@16 T@U) (|s#0@@16| T@U) (|n#0@@9| Int) (|_k#0@@12| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |s#0@@16| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@9|)) (= |_k#0@@12| (|ORD#FromNat| 0))) (_module.__default.LowerThan_h $ly@@16 |_k#0@@12| |s#0@@16| |n#0@@9|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |655|
 :pattern ( (_module.__default.LowerThan_h $ly@@16 |_k#0@@12| |s#0@@16| |n#0@@9|))
))))
...
(assert (forall ((d@@11 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (_module.Tree.Node_q d@@11) ($IsAlloc DatatypeTypeType d@@11 Tclass._module.Tree $h@@4))) ($IsAlloc DatatypeTypeType (_module.Tree.children d@@11) (Tclass._module.Stream Tclass._module.Tree) $h@@4))
 :qid |unknown.0:0|
 :skolemid |1178|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Tree.children d@@11) (Tclass._module.Stream Tclass._module.Tree) $h@@4))
)))
...
(declare-fun |t#0@@5| () T@U)
(declare-fun |n#2@0| () Int)
(declare-fun |s##0@0| () T@U)
(declare-fun |call3formal@k#0| () Int)
...
(declare-fun |n#2| () Int)
(declare-fun |k#0| () Int)
(set-info :boogie-vc-id Impl$$_module.__default.Theorem0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon4_correct  (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (and (<= (LitInt 0) (LitInt 0)) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@5|) (LitInt 0)))) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (and (<= (LitInt 0) (LitInt 0)) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@5|) (LitInt 0)))) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (and (<= (LitInt 0) (LitInt 0)) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@5|) (LitInt 0)))) (exists ((|$as#n0#0| Int) ) (!  (and (<= (LitInt 0) |$as#n0#0|) (and (<= (LitInt 0) |$as#n0#0|) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@5|) |$as#n0#0|)))
 :qid |InfiniteTreesdfy.131:7|
 :skolemid |721|
)))))) (=> (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (and (<= (LitInt 0) (LitInt 0)) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@5|) (LitInt 0)))) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (and (<= (LitInt 0) (LitInt 0)) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@5|) (LitInt 0)))) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (and (<= (LitInt 0) (LitInt 0)) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@5|) (LitInt 0)))) (exists ((|$as#n0#0@@0| Int) ) (!  (and (<= (LitInt 0) |$as#n0#0@@0|) (and (<= (LitInt 0) |$as#n0#0@@0|) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@5|) |$as#n0#0@@0|)))
 :qid |InfiniteTreesdfy.131:7|
 :skolemid |721|
))))) (=> (<= (LitInt 0) |n#2@0|) (=> (and (<= (LitInt 0) |n#2@0|) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@5|) |n#2@0|)) (=> (and (and (_module.Tree.Node_q |t#0@@5|) (_module.Tree.Node_q |t#0@@5|)) (and (= |s##0@0| (_module.Tree.children |t#0@@5|)) (<= (LitInt 0) |call3formal@k#0|))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.__default.LowerThan#canCall| |s##0@0| |n#2@0|) (or (_module.__default.LowerThan ($LS $LZ) |s##0@0| |n#2@0|) (=> (_module.Stream.Nil_q |s##0@0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (|_module.__default.LowerThan#canCall| |s##0@0| |n#2@0|) (or (_module.__default.LowerThan ($LS $LZ) |s##0@0| |n#2@0|) (=> (_module.Stream.Nil_q |s##0@0|) (U_2_bool (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.__default.LowerThan#canCall| |s##0@0| |n#2@0|) (or (_module.__default.LowerThan ($LS $LZ) |s##0@0| |n#2@0|) (=> (not (_module.Stream.Nil_q |s##0@0|)) (<= (LitInt 1) |n#2@0|))))) (=> (=> (|_module.__default.LowerThan#canCall| |s##0@0| |n#2@0|) (or (_module.__default.LowerThan ($LS $LZ) |s##0@0| |n#2@0|) (=> (not (_module.Stream.Nil_q |s##0@0|)) (<= (LitInt 1) |n#2@0|)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.__default.LowerThan#canCall| |s##0@0| |n#2@0|) (or (_module.__default.LowerThan ($LS $LZ) |s##0@0| |n#2@0|) (=> (not (_module.Stream.Nil_q |s##0@0|)) (let ((|t#0@@6| ($Unbox DatatypeTypeType (_module.Stream.head |s##0@0|))))
(_module.__default.LowerThan ($LS ($LS $LZ)) (_module.Tree.children |t#0@@6|) (- |n#2@0| 1))))))) (=> (=> (|_module.__default.LowerThan#canCall| |s##0@0| |n#2@0|) (or (_module.__default.LowerThan ($LS $LZ) |s##0@0| |n#2@0|) (=> (not (_module.Stream.Nil_q |s##0@0|)) (let ((|t#0@@7| ($Unbox DatatypeTypeType (_module.Stream.head |s##0@0|))))
(_module.__default.LowerThan ($LS ($LS $LZ)) (_module.Tree.children |t#0@@7|) (- |n#2@0| 1)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.__default.LowerThan#canCall| |s##0@0| |n#2@0|) (or (_module.__default.LowerThan ($LS $LZ) |s##0@0| |n#2@0|) (=> (not (_module.Stream.Nil_q |s##0@0|)) (let ((|tail#0@@1| (_module.Stream.tail |s##0@0|)))
(_module.__default.LowerThan ($LS ($LS $LZ)) |tail#0@@1| |n#2@0|)))))) (=> (=> (|_module.__default.LowerThan#canCall| |s##0@0| |n#2@0|) (or (_module.__default.LowerThan ($LS $LZ) |s##0@0| |n#2@0|) (=> (not (_module.Stream.Nil_q |s##0@0|)) (let ((|tail#0@@2| (_module.Stream.tail |s##0@0|)))
(_module.__default.LowerThan ($LS ($LS $LZ)) |tail#0@@2| |n#2@0|))))) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (<= (LitInt 0) |call3formal@k#0@0|)) (and (|_module.__default.InfiniteEverywhere_h#canCall| (|ORD#FromNat| |call3formal@k#0@0|) |s##0@0|) (not (_module.__default.InfiniteEverywhere_h ($LS ($LS $LZ)) (|ORD#FromNat| |call3formal@k#0@0|) |s##0@0|)))) (and (and (= $Heap $Heap@0) (= (ControlFlow 0 2) (- 0 1))) (|_module.__default.IsFiniteSomewhere#canCall| |t#0@@5|))) (or (_module.__default.IsFiniteSomewhere |t#0@@5|) (not (_module.__default.InfiniteEverywhere ($LS ($LS $LZ)) (_module.Tree.children |t#0@@5|))))))))))))))))))))
(let ((anon3_correct  (=> (and (=> (<= (LitInt 0) |n#3@0|) (and (_module.Tree.Node_q |t#0@@5|) (|_module.__default.LowerThan#canCall| (_module.Tree.children |t#0@@5|) |n#3@0|))) (= (ControlFlow 0 9) 2)) anon4_correct)))
(let ((anon6_Else_correct  (=> (and (< |n#3@0| (LitInt 0)) (= (ControlFlow 0 11) 9)) anon3_correct)))
(let ((anon6_Then_correct  (=> (<= (LitInt 0) |n#3@0|) (=> (and (_module.Tree.Node_q |t#0@@5|) (= |##s#0@0| (_module.Tree.children |t#0@@5|))) (=> (and (and ($IsAlloc DatatypeTypeType |##s#0@0| (Tclass._module.Stream Tclass._module.Tree) $Heap) ($IsAlloc intType (int_2_U |n#3@0|) Tclass._System.nat $Heap)) (and (|_module.__default.LowerThan#canCall| (_module.Tree.children |t#0@@5|) |n#3@0|) (= (ControlFlow 0 10) 9))) anon3_correct)))))
(let ((anon5_Then_correct  (=> (<= (LitInt 0) |n#3@0|) (and (=> (= (ControlFlow 0 12) 10) anon6_Then_correct) (=> (= (ControlFlow 0 12) 11) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (< |n#3@0| (LitInt 0)) (= (ControlFlow 0 8) 2)) anon4_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 13) 12) anon5_Then_correct) (=> (= (ControlFlow 0 13) 8) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |t#0@@5| Tclass._module.Tree) ($IsAlloc DatatypeTypeType |t#0@@5| Tclass._module.Tree $Heap)) (|$IsA#_module.Tree| |t#0@@5|)) (and (<= (LitInt 0) |n#2|) true)) (and (and (and (<= (LitInt 0) |k#0|) true) (= 5 $FunctionContextHeight)) (and (and (|_module.__default.HasBoundedHeight#canCall| |t#0@@5|) (and (_module.__default.HasBoundedHeight |t#0@@5|) (exists ((|n#1@@1| Int) ) (!  (and (<= (LitInt 0) |n#1@@1|) (and (<= (LitInt 0) |n#1@@1|) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@5|) |n#1@@1|)))
 :qid |InfiniteTreesdfy.69:10|
 :skolemid |720|
 :pattern ( (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@5|) |n#1@@1|))
