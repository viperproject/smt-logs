...
(declare-fun |M#0@@6| () T@U)
(declare-fun |N#0@@4| () T@U)
(declare-fun $Heap@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $LZ () T@U)
(declare-fun |k#0| () Int)
(set-info :boogie-vc-id Impl$$_module.__default.Theorem1__AutoInd)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and (|$IsA#_module.Stream| |M#0@@6|) (|$IsA#_module.Stream| |N#0@@4|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@0 $Heap@0) (forall ((|$ih#k0#0| Int) (|$ih#M0#0| T@U) (|$ih#N0#0| T@U) ) (!  (=> (and (and (and (and (<= (LitInt 0) |$ih#k0#0|) ($Is DatatypeTypeType |$ih#M0#0| (Tclass._module.Stream Tclass._module.X))) ($Is DatatypeTypeType |$ih#N0#0| (Tclass._module.Stream Tclass._module.X))) (U_2_bool (Lit boolType (bool_2_U true)))) (and (<= 0 |$ih#k0#0|) (< |$ih#k0#0| |k#0|))) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#FromNat| |$ih#k0#0|) ($LS ($LS $LZ)) (_module.__default.map__f ($LS $LZ) (_module.__default.append Tclass._module.X ($LS $LZ) |$ih#M0#0| |$ih#N0#0|)) (_module.__default.append Tclass._module.X ($LS $LZ) (_module.__default.map__f ($LS $LZ) |$ih#M0#0|) (_module.__default.map__f ($LS $LZ) |$ih#N0#0|))))
 :qid |Streamsdfy.121:24|
 :skolemid |640|
 :pattern ( (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#FromNat| |$ih#k0#0|) ($LS ($LS $LZ)) (_module.__default.map__f ($LS $LZ) (_module.__default.append Tclass._module.X ($LS $LZ) |$ih#M0#0| |$ih#N0#0|)) (_module.__default.append Tclass._module.X ($LS $LZ) (_module.__default.map__f ($LS $LZ) |$ih#M0#0|) (_module.__default.map__f ($LS $LZ) |$ih#N0#0|))))
)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#FromNat| |k#0|) ($LS ($LS $LZ)) (_module.__default.map__f ($LS $LZ) (_module.__default.append Tclass._module.X ($LS $LZ) |M#0@@6| |N#0@@4|)) (_module.__default.append Tclass._module.X ($LS $LZ) (_module.__default.map__f ($LS $LZ) |M#0@@6|) (_module.__default.map__f ($LS $LZ) |N#0@@4|))) (=> (< 0 |k#0|) (=> (_module.Stream.Nil_q (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#0@@6| |N#0@@4|))) (_module.Stream.Nil_q (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) (_module.__default.map__f ($LS ($LS $LZ)) |M#0@@6|) (_module.__default.map__f ($LS ($LS $LZ)) |N#0@@4|))))))) (=> (or (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#FromNat| |k#0|) ($LS ($LS $LZ)) (_module.__default.map__f ($LS $LZ) (_module.__default.append Tclass._module.X ($LS $LZ) |M#0@@6| |N#0@@4|)) (_module.__default.append Tclass._module.X ($LS $LZ) (_module.__default.map__f ($LS $LZ) |M#0@@6|) (_module.__default.map__f ($LS $LZ) |N#0@@4|))) (=> (< 0 |k#0|) (=> (_module.Stream.Nil_q (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#0@@6| |N#0@@4|))) (_module.Stream.Nil_q (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) (_module.__default.map__f ($LS ($LS $LZ)) |M#0@@6|) (_module.__default.map__f ($LS ($LS $LZ)) |N#0@@4|)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (or (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#FromNat| |k#0|) ($LS ($LS $LZ)) (_module.__default.map__f ($LS $LZ) (_module.__default.append Tclass._module.X ($LS $LZ) |M#0@@6| |N#0@@4|)) (_module.__default.append Tclass._module.X ($LS $LZ) (_module.__default.map__f ($LS $LZ) |M#0@@6|) (_module.__default.map__f ($LS $LZ) |N#0@@4|))) (=> (< 0 |k#0|) (=> (_module.Stream.Cons_q (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#0@@6| |N#0@@4|))) (and (_module.Stream.Cons_q (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) (_module.__default.map__f ($LS ($LS $LZ)) |M#0@@6|) (_module.__default.map__f ($LS ($LS $LZ)) |N#0@@4|))) (and (= (_module.Stream.head (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#0@@6| |N#0@@4|))) (_module.Stream.head (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) (_module.__default.map__f ($LS ($LS $LZ)) |M#0@@6|) (_module.__default.map__f ($LS ($LS $LZ)) |N#0@@4|)))) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#FromNat| (- |k#0| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#0@@6| |N#0@@4|))) (_module.Stream.tail (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) (_module.__default.map__f ($LS ($LS $LZ)) |M#0@@6|) (_module.__default.map__f ($LS ($LS $LZ)) |N#0@@4|)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (<= (LitInt 0) |k#0|)) (and (and ($Is DatatypeTypeType |M#0@@6| (Tclass._module.Stream Tclass._module.X)) ($IsAlloc DatatypeTypeType |M#0@@6| (Tclass._module.Stream Tclass._module.X) $Heap@@0)) (|$IsA#_module.Stream| |M#0@@6|))) (and (and (and ($Is DatatypeTypeType |N#0@@4| (Tclass._module.Stream Tclass._module.X)) ($IsAlloc DatatypeTypeType |N#0@@4| (Tclass._module.Stream Tclass._module.X) $Heap@@0)) (|$IsA#_module.Stream| |N#0@@4|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct)))
