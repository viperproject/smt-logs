...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.SmallTree)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon5_Else_correct  (=> ($IsAlloc intType (int_2_U |n#0@@5|) Tclass._System.nat $Heap) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (<= 0 (LitInt 1)) (= (LitInt 0) (LitInt 1)))) (=> (or (<= 0 (LitInt 1)) (= (LitInt 0) (LitInt 1))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (or (<= 0 |n#0@@5|) (< (LitInt 0) (LitInt 1))) (= (LitInt (- 0 1)) |n#0@@5|))) (=> (or (or (<= 0 |n#0@@5|) (< (LitInt 0) (LitInt 1))) (= (LitInt (- 0 1)) |n#0@@5|)) (=> (= (ControlFlow 0 3) (- 0 2)) (or (< (LitInt 0) (LitInt 1)) (and (= (LitInt 0) (LitInt 1)) (< (LitInt (- 0 1)) |n#0@@5|)))))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |n#0@@5|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct)))
