...
(declare-fun _module._default.AppendIsAssociative$_T0 () T@U)
(declare-fun $LZ () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.AppendIsAssociative)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (|_module.List#Equal| (_module.__default.Append _module._default.AppendIsAssociative$_T0 ($LS ($LS $LZ)) (_module.__default.Append _module._default.AppendIsAssociative$_T0 ($LS ($LS $LZ)) |xs#0@@5| |ys#0@@5|) |zs#0|) (_module.__default.Append _module._default.AppendIsAssociative$_T0 ($LS ($LS $LZ)) |xs#0@@5| (_module.__default.Append _module._default.AppendIsAssociative$_T0 ($LS ($LS $LZ)) |ys#0@@5| |zs#0|))))))
(let ((anon5_Then_correct  (=> (= |xs#0@@5| (|#_module.List.Cons| |_mcc#0#0_0@0| |_mcc#1#0_0@0|)) (=> (and ($IsBox |_mcc#0#0_0@0| _module._default.AppendIsAssociative$_T0) ($Is DatatypeTypeType |_mcc#1#0_0@0| (Tclass._module.List _module._default.AppendIsAssociative$_T0))) (=> (and (and (and (and ($Is DatatypeTypeType |rest#0_0@0| (Tclass._module.List _module._default.AppendIsAssociative$_T0)) ($IsAlloc DatatypeTypeType |rest#0_0@0| (Tclass._module.List _module._default.AppendIsAssociative$_T0) $Heap@@0)) (= |let#0_0#0#0| |_mcc#1#0_0@0|)) (and ($Is DatatypeTypeType |let#0_0#0#0| (Tclass._module.List _module._default.AppendIsAssociative$_T0)) (= |rest#0_0@0| |let#0_0#0#0|))) (and (and (and ($IsBox |x#0_0@0| _module._default.AppendIsAssociative$_T0) ($IsAllocBox |x#0_0@0| _module._default.AppendIsAssociative$_T0 $Heap@@0)) (= |let#0_1#0#0| |_mcc#0#0_0@0|)) (and ($IsBox |let#0_1#0#0| _module._default.AppendIsAssociative$_T0) (= |x#0_0@0| |let#0_1#0#0|)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< (DtRank |rest#0_0@0|) (DtRank |xs#0@@5|))) (=> (< (DtRank |rest#0_0@0|) (DtRank |xs#0@@5|)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (and (|$IsA#_module.List| (_module.__default.Append _module._default.AppendIsAssociative$_T0 ($LS $LZ) (_module.__default.Append _module._default.AppendIsAssociative$_T0 ($LS $LZ) |rest#0_0@0| |ys#0@@5|) |zs#0|)) (|$IsA#_module.List| (_module.__default.Append _module._default.AppendIsAssociative$_T0 ($LS $LZ) |rest#0_0@0| (_module.__default.Append _module._default.AppendIsAssociative$_T0 ($LS $LZ) |ys#0@@5| |zs#0|)))) (and (and (|_module.__default.Append#canCall| _module._default.AppendIsAssociative$_T0 |rest#0_0@0| |ys#0@@5|) (|_module.__default.Append#canCall| _module._default.AppendIsAssociative$_T0 (_module.__default.Append _module._default.AppendIsAssociative$_T0 ($LS $LZ) |rest#0_0@0| |ys#0@@5|) |zs#0|)) (and (|_module.__default.Append#canCall| _module._default.AppendIsAssociative$_T0 |ys#0@@5| |zs#0|) (|_module.__default.Append#canCall| _module._default.AppendIsAssociative$_T0 |rest#0_0@0| (_module.__default.Append _module._default.AppendIsAssociative$_T0 ($LS $LZ) |ys#0@@5| |zs#0|))))) (|_module.List#Equal| (_module.__default.Append _module._default.AppendIsAssociative$_T0 ($LS ($LS $LZ)) (_module.__default.Append _module._default.AppendIsAssociative$_T0 ($LS ($LS $LZ)) |rest#0_0@0| |ys#0@@5|) |zs#0|) (_module.__default.Append _module._default.AppendIsAssociative$_T0 ($LS ($LS $LZ)) |rest#0_0@0| (_module.__default.Append _module._default.AppendIsAssociative$_T0 ($LS ($LS $LZ)) |ys#0@@5| |zs#0|)))) (and (= $Heap@@0 $Heap@0) (= (ControlFlow 0 5) 3))) GeneratedUnifiedExit_correct)))))))))
...
(let ((anon4_Else_correct  (=> (or (not (= |xs#0@@5| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 7) 5) anon5_Then_correct) (=> (= (ControlFlow 0 7) 1) anon5_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (and (=> (= (ControlFlow 0 8) 4) anon4_Then_correct) (=> (= (ControlFlow 0 8) 7) anon4_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (and ($Is DatatypeTypeType |xs#0@@5| (Tclass._module.List _module._default.AppendIsAssociative$_T0)) ($IsAlloc DatatypeTypeType |xs#0@@5| (Tclass._module.List _module._default.AppendIsAssociative$_T0) $Heap@@0)) (|$IsA#_module.List| |xs#0@@5|)) (and (and ($Is DatatypeTypeType |ys#0@@5| (Tclass._module.List _module._default.AppendIsAssociative$_T0)) ($IsAlloc DatatypeTypeType |ys#0@@5| (Tclass._module.List _module._default.AppendIsAssociative$_T0) $Heap@@0)) (|$IsA#_module.List| |ys#0@@5|))) (and (and (and ($Is DatatypeTypeType |zs#0| (Tclass._module.List _module._default.AppendIsAssociative$_T0)) ($IsAlloc DatatypeTypeType |zs#0| (Tclass._module.List _module._default.AppendIsAssociative$_T0) $Heap@@0)) (|$IsA#_module.List| |zs#0|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 9) 8)))) anon0_correct))))
