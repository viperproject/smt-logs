...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@11 T@U) (|t#0@@3| T@U) (|p#0@@4| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |t#0@@3| Tclass._module.Tree) ($Is DatatypeTypeType |p#0@@4| (Tclass._module.Stream TInt))) (forall ((|_k#0@@6| T@U) ) (! (_module.__default.ValidPath_h ($LS $ly@@11) |_k#0@@6| |t#0@@3| |p#0@@4|)
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |783|
 :pattern ( (_module.__default.ValidPath_h ($LS $ly@@11) |_k#0@@6| |t#0@@3| |p#0@@4|))
))) (_module.__default.ValidPath ($LS $ly@@11) |t#0@@3| |p#0@@4|))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |785|
 :pattern ( (_module.__default.ValidPath ($LS $ly@@11) |t#0@@3| |p#0@@4|))
))))
...
(let ((|index#4| (U_2_int ($Unbox intType (_module.Stream.head |p#0@@5|)))))
 ...
 (and (_module.Stream.Cons_q |ch#5|) (_module.__default.ValidPath_h $ly@@12 (|ORD#Minus| |_k#0@@7| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head |ch#5|)) |tail#4@@0|)))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@7|)) (forall ((|_k'#0@@1| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@1| |_k#0@@7|) (|_module.__default.ValidPath_h#canCall| |_k'#0@@1| |t#0@@5| |p#0@@5|))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |794|
 :pattern ( (_module.__default.ValidPath_h $ly@@12 |_k'#0@@1| |t#0@@5| |p#0@@5|))
))))) (= (_module.__default.ValidPath_h ($LS $ly@@12) |_k#0@@7| |t#0@@5| |p#0@@5|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@7|)) (ite (_module.Stream.Nil_q |p#0@@5|) (|_module.Tree#Equal| |t#0@@5| (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|))) (let ((|tail#2@@0| (_module.Stream.tail |p#0@@5|)))
(let ((|index#2| (U_2_int ($Unbox intType (_module.Stream.head |p#0@@5|)))))
 ...
 (and (_module.Stream.Cons_q |ch#3|) (_module.__default.ValidPath_h $ly@@12 (|ORD#Minus| |_k#0@@7| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head |ch#3|)) |tail#2@@0|)))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@7|)) (forall ((|_k'#0@@2| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@2| |_k#0@@7|) (_module.__default.ValidPath_h $ly@@12 |_k'#0@@2| |t#0@@5| |p#0@@5|))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |793|
 :pattern ( (_module.__default.ValidPath_h $ly@@12 |_k'#0@@2| |t#0@@5| |p#0@@5|))
)))))))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |795|
 :pattern ( (_module.__default.ValidPath_h ($LS $ly@@12) |_k#0@@7| |t#0@@5| |p#0@@5|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|t#0@@6| T@U) ) (!  (=> (or (|_module.__default.HasBoundedHeight#canCall| |t#0@@6|) (and (< 3 $FunctionContextHeight) ($Is DatatypeTypeType |t#0@@6| Tclass._module.Tree))) (and (forall ((|n#0@@4| Int) ) (!  (=> (<= (LitInt 0) |n#0@@4|) (=> (<= (LitInt 0) |n#0@@4|) (and (_module.Tree.Node_q |t#0@@6|) (|_module.__default.LowerThan#canCall| (_module.Tree.children |t#0@@6|) |n#0@@4|))))
 :qid |InfiniteTreesdfy.69:10|
 :skolemid |638|
 :pattern ( (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@6|) |n#0@@4|))
)) (= (_module.__default.HasBoundedHeight |t#0@@6|) (exists ((|n#0@@5| Int) ) (!  (and (<= (LitInt 0) |n#0@@5|) (and (<= (LitInt 0) |n#0@@5|) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@6|) |n#0@@5|)))
 :qid |InfiniteTreesdfy.69:10|
 :skolemid |637|
...
(assert (forall (($ly@@14 T@U) (|s#0@@9| T@U) (|n#0@@6| Int) ) (! (= (_module.__default.LowerThan ($LS $ly@@14) |s#0@@9| |n#0@@6|) (_module.__default.LowerThan $ly@@14 |s#0@@9| |n#0@@6|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |647|
 :pattern ( (_module.__default.LowerThan ($LS $ly@@14) |s#0@@9| |n#0@@6|))
)))
(assert (forall (($ly@@15 T@U) (|t#0@@7| T@U) (|p#0@@6| T@U) ) (! (= (_module.__default.ValidPath ($LS $ly@@15) |t#0@@7| |p#0@@6|) (_module.__default.ValidPath $ly@@15 |t#0@@7| |p#0@@6|))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |778|
 :pattern ( (_module.__default.ValidPath ($LS $ly@@15) |t#0@@7| |p#0@@6|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.Tail$_T0@@1 T@U) ($ly@@16 T@U) (|s#0@@10| T@U) (|n#0@@7| Int) ) (!  (=> (or (|_module.__default.Tail#canCall| _module._default.Tail$_T0@@1 (Lit DatatypeTypeType |s#0@@10|) (LitInt |n#0@@7|)) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@10| (Tclass._module.Stream _module._default.Tail$_T0@@1)) (<= (LitInt 0) |n#0@@7|)))) (and (=> (or (not (= (LitInt |n#0@@7|) (LitInt 0))) (not true)) (and (|_module.__default.Tail#canCall| _module._default.Tail$_T0@@1 (Lit DatatypeTypeType |s#0@@10|) (LitInt (- |n#0@@7| 1))) (let ((|t#2| (Lit DatatypeTypeType (_module.__default.Tail _module._default.Tail$_T0@@1 ($LS $ly@@16) (Lit DatatypeTypeType |s#0@@10|) (LitInt (- |n#0@@7| 1))))))
(|$IsA#_module.Stream| |t#2|)))) (= (_module.__default.Tail _module._default.Tail$_T0@@1 ($LS $ly@@16) (Lit DatatypeTypeType |s#0@@10|) (LitInt |n#0@@7|)) (ite (= (LitInt |n#0@@7|) (LitInt 0)) |s#0@@10| (let ((|t#2@@0| (Lit DatatypeTypeType (_module.__default.Tail _module._default.Tail$_T0@@1 ($LS $ly@@16) (Lit DatatypeTypeType |s#0@@10|) (LitInt (- |n#0@@7| 1))))))
(ite (|$Eq#_module.Stream| _module._default.Tail$_T0@@1 _module._default.Tail$_T0@@1 ($LS ($LS $LZ)) |t#2@@0| |#_module.Stream.Nil|) |t#2@@0| (_module.Stream.tail |t#2@@0|)))))))
 ...
 :weight 3
 :skolemid |591|
 :pattern ( (_module.__default.Tail _module._default.Tail$_T0@@1 ($LS $ly@@16) (Lit DatatypeTypeType |s#0@@10|) (LitInt |n#0@@7|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.Tail$_T0@@2 T@U) ($ly@@17 T@U) (|s#0@@11| T@U) (|n#0@@8| Int) ) (!  (=> (and (or (|_module.__default.Tail#canCall| _module._default.Tail$_T0@@2 |s#0@@11| |n#0@@8|) (and (< 1 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |s#0@@11| (Tclass._module.Stream _module._default.Tail$_T0@@2)) ($IsAlloc DatatypeTypeType |s#0@@11| (Tclass._module.Stream _module._default.Tail$_T0@@2) $Heap)) (<= (LitInt 0) |n#0@@8|)))) ($IsGoodHeap $Heap)) ($IsAlloc DatatypeTypeType (_module.__default.Tail _module._default.Tail$_T0@@2 $ly@@17 |s#0@@11| |n#0@@8|) (Tclass._module.Stream _module._default.Tail$_T0@@2) $Heap))
 :qid |InfiniteTreesdfy.9:16|
 :skolemid |587|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.__default.Tail _module._default.Tail$_T0@@2 $ly@@17 |s#0@@11| |n#0@@8|) (Tclass._module.Stream _module._default.Tail$_T0@@2) $Heap))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@18 T@U) (|_k#0@@9| T@U) (|s#0@@12| T@U) (|n#0@@9| Int) ) (!  (=> (or (|_module.__default.LowerThan_h#canCall| (Lit BoxType |_k#0@@9|) |s#0@@12| |n#0@@9|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@12| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@9|)))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@9|)) (=> (not (_module.Stream.Nil_q |s#0@@12|)) (let ((|tail#6@@0| (_module.Stream.tail |s#0@@12|)))
(let ((|t#6| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@12|))))
 (=> (<= (LitInt 1) |n#0@@9|) (and (and (_module.Tree.Node_q |t#6|) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) (_module.Tree.children |t#6|) (- |n#0@@9| 1))) (=> (_module.__default.LowerThan_h ($LS $ly@@18) (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) (_module.Tree.children |t#6|) (- |n#0@@9| 1)) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) |tail#6@@0| |n#0@@9|)))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@9|)) (ite (_module.Stream.Nil_q |s#0@@12|) true (let ((|tail#7@@0| (_module.Stream.tail |s#0@@12|)))
(let ((|t#7| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@12|))))
 (and (and (<= (LitInt 1) |n#0@@9|) (_module.__default.LowerThan_h ($LS $ly@@18) (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) (_module.Tree.children |t#7|) (- |n#0@@9| 1))) (_module.__default.LowerThan_h ($LS $ly@@18) (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) |tail#7@@0| |n#0@@9|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@9|)) (forall ((|_k'#1@@1| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@1| |_k#0@@9|) (|_module.__default.LowerThan_h#canCall| |_k'#1@@1| |s#0@@12| |n#0@@9|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |666|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@18) |_k'#1@@1| |s#0@@12| |n#0@@9|))
))))) (= (_module.__default.LowerThan_h ($LS $ly@@18) (Lit BoxType |_k#0@@9|) |s#0@@12| |n#0@@9|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@9|)) (ite (_module.Stream.Nil_q |s#0@@12|) true (let ((|tail#5@@0| (_module.Stream.tail |s#0@@12|)))
(let ((|t#5| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@12|))))
 (and (and (<= (LitInt 1) |n#0@@9|) (_module.__default.LowerThan_h ($LS $ly@@18) (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) (_module.Tree.children |t#5|) (- |n#0@@9| 1))) (_module.__default.LowerThan_h ($LS $ly@@18) (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) |tail#5@@0| |n#0@@9|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@9|)) (forall ((|_k'#1@@2| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@2| |_k#0@@9|) (_module.__default.LowerThan_h ($LS $ly@@18) |_k'#1@@2| |s#0@@12| |n#0@@9|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |665|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@18) |_k'#1@@2| |s#0@@12| |n#0@@9|))
)))))))
 :qid |InfiniteTreesdfy.71:20|
 :weight 3
 :skolemid |667|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@18) (Lit BoxType |_k#0@@9|) |s#0@@12| |n#0@@9|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.Tail$_T0@@3 T@U) ($ly@@19 T@U) (|s#0@@13| T@U) (|n#0@@10| Int) ) (!  (=> (or (|_module.__default.Tail#canCall| _module._default.Tail$_T0@@3 |s#0@@13| |n#0@@10|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@13| (Tclass._module.Stream _module._default.Tail$_T0@@3)) (<= (LitInt 0) |n#0@@10|)))) (and (=> (or (not (= |n#0@@10| (LitInt 0))) (not true)) (and (|_module.__default.Tail#canCall| _module._default.Tail$_T0@@3 |s#0@@13| (- |n#0@@10| 1)) (let ((|t#0@@8| (_module.__default.Tail _module._default.Tail$_T0@@3 $ly@@19 |s#0@@13| (- |n#0@@10| 1))))
(|$IsA#_module.Stream| |t#0@@8|)))) (= (_module.__default.Tail _module._default.Tail$_T0@@3 ($LS $ly@@19) |s#0@@13| |n#0@@10|) (ite (= |n#0@@10| (LitInt 0)) |s#0@@13| (let ((|t#0@@9| (_module.__default.Tail _module._default.Tail$_T0@@3 $ly@@19 |s#0@@13| (- |n#0@@10| 1))))
(ite (|$Eq#_module.Stream| _module._default.Tail$_T0@@3 _module._default.Tail$_T0@@3 ($LS ($LS $LZ)) |t#0@@9| |#_module.Stream.Nil|) |t#0@@9| (_module.Stream.tail |t#0@@9|)))))))
 :qid |unknown.0:0|
 :skolemid |589|
 :pattern ( (_module.__default.Tail _module._default.Tail$_T0@@3 ($LS $ly@@19) |s#0@@13| |n#0@@10|))
))))
...
(let ((|t#3| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@14|))))
 (=> (<= (LitInt 1) |n#0@@11|) (and (and (_module.Tree.Node_q |t#3|) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) (_module.Tree.children |t#3|) (- |n#0@@11| 1))) (=> (_module.__default.LowerThan_h $ly@@20 (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) (_module.Tree.children |t#3|) (- |n#0@@11| 1)) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) |tail#3@@1| |n#0@@11|)))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@10|)) (ite (_module.Stream.Nil_q |s#0@@14|) true (let ((|tail#4@@1| (_module.Stream.tail |s#0@@14|)))
(let ((|t#4| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@14|))))
 (and (and (<= (LitInt 1) |n#0@@11|) (_module.__default.LowerThan_h $ly@@20 (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) (_module.Tree.children |t#4|) (- |n#0@@11| 1))) (_module.__default.LowerThan_h $ly@@20 (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) |tail#4@@1| |n#0@@11|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@10|)) (forall ((|_k'#0@@3| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@3| |_k#0@@10|) (|_module.__default.LowerThan_h#canCall| |_k'#0@@3| |s#0@@14| |n#0@@11|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |663|
 :pattern ( (_module.__default.LowerThan_h $ly@@20 |_k'#0@@3| |s#0@@14| |n#0@@11|))
))))) (= (_module.__default.LowerThan_h ($LS $ly@@20) |_k#0@@10| |s#0@@14| |n#0@@11|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@10|)) (ite (_module.Stream.Nil_q |s#0@@14|) true (let ((|tail#2@@1| (_module.Stream.tail |s#0@@14|)))
(let ((|t#2@@1| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@14|))))
 (and (and (<= (LitInt 1) |n#0@@11|) (_module.__default.LowerThan_h $ly@@20 (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) (_module.Tree.children |t#2@@1|) (- |n#0@@11| 1))) (_module.__default.LowerThan_h $ly@@20 (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) |tail#2@@1| |n#0@@11|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@10|)) (forall ((|_k'#0@@4| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@4| |_k#0@@10|) (_module.__default.LowerThan_h $ly@@20 |_k'#0@@4| |s#0@@14| |n#0@@11|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |662|
 :pattern ( (_module.__default.LowerThan_h $ly@@20 |_k'#0@@4| |s#0@@14| |n#0@@11|))
)))))))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |664|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@20) |_k#0@@10| |s#0@@14| |n#0@@11|))
))))
...
(assert (forall (($ly@@22 T@U) (|_k#0@@12| T@U) (|s#0@@16| T@U) (|n#0@@12| Int) ) (! (= (_module.__default.LowerThan_h ($LS $ly@@22) |_k#0@@12| |s#0@@16| |n#0@@12|) (_module.__default.LowerThan_h $ly@@22 |_k#0@@12| |s#0@@16| |n#0@@12|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |658|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@22) |_k#0@@12| |s#0@@16| |n#0@@12|))
)))
(assert (forall (($ly@@23 T@U) (|_k#0@@13| T@U) (|t#0@@10| T@U) (|p#0@@7| T@U) ) (! (= (_module.__default.ValidPath_h ($LS $ly@@23) |_k#0@@13| |t#0@@10| |p#0@@7|) (_module.__default.ValidPath_h $ly@@23 |_k#0@@13| |t#0@@10| |p#0@@7|))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |789|
 :pattern ( (_module.__default.ValidPath_h ($LS $ly@@23) |_k#0@@13| |t#0@@10| |p#0@@7|))
)))
...
(let ((|index#8| (LitInt (U_2_int ($Unbox intType (_module.Stream.head (Lit DatatypeTypeType |p#0@@8|)))))))
 ...
 (and (_module.Stream.Cons_q |ch#9|) (_module.__default.ValidPath_h ($LS $ly@@26) (|ORD#Minus| |_k#0@@16| (|ORD#FromNat| 1)) (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Stream.head |ch#9|))) |tail#8@@0|)))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@16|)) (forall ((|_k'#2@@2| T@U) ) (!  (=> (|ORD#Less| |_k'#2@@2| |_k#0@@16|) (_module.__default.ValidPath_h ($LS $ly@@26) |_k'#2@@2| |t#0@@11| |p#0@@8|))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |799|
 :pattern ( (_module.__default.ValidPath_h ($LS $ly@@26) |_k'#2@@2| |t#0@@11| |p#0@@8|))
)))))))
 :qid |InfiniteTreesdfy.234:20|
 :weight 3
 :skolemid |801|
 :pattern ( (_module.__default.ValidPath_h ($LS $ly@@26) (Lit BoxType |_k#0@@16|) (Lit DatatypeTypeType |t#0@@11|) (Lit DatatypeTypeType |p#0@@8|)))
))))
...
(assert (forall ((_module._default.Tail$_T0@@4 T@U) ($ly@@27 T@U) (|s#0@@19| T@U) (|n#0@@13| Int) ) (! (= (_module.__default.Tail _module._default.Tail$_T0@@4 ($LS $ly@@27) |s#0@@19| |n#0@@13|) (_module.__default.Tail _module._default.Tail$_T0@@4 $ly@@27 |s#0@@19| |n#0@@13|))
 :qid |unknown.0:0|
 :skolemid |581|
 :pattern ( (_module.__default.Tail _module._default.Tail$_T0@@4 ($LS $ly@@27) |s#0@@19| |n#0@@13|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@29 T@U) (|t#0@@13| T@U) (|p#0@@9| T@U) (|_k#0@@18| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |t#0@@13| Tclass._module.Tree) ($Is DatatypeTypeType |p#0@@9| (Tclass._module.Stream TInt))) (= |_k#0@@18| (|ORD#FromNat| 0))) (_module.__default.ValidPath_h $ly@@29 |_k#0@@18| |t#0@@13| |p#0@@9|))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |786|
 :pattern ( (_module.__default.ValidPath_h $ly@@29 |_k#0@@18| |t#0@@13| |p#0@@9|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@30 T@U) (|s#0@@21| T@U) (|n#0@@14| Int) ) (!  (=> (or (|_module.__default.LowerThan#canCall| |s#0@@21| |n#0@@14|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@21| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@14|)))) (and (=> (not (_module.Stream.Nil_q |s#0@@21|)) (let ((|tail#1@@1| (_module.Stream.tail |s#0@@21|)))
(let ((|t#1@@1| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@21|))))
 (=> (<= (LitInt 1) |n#0@@14|) (and (and (_module.Tree.Node_q |t#1@@1|) (|_module.__default.LowerThan#canCall| (_module.Tree.children |t#1@@1|) (- |n#0@@14| 1))) (=> (_module.__default.LowerThan $ly@@30 (_module.Tree.children |t#1@@1|) (- |n#0@@14| 1)) (|_module.__default.LowerThan#canCall| |tail#1@@1| |n#0@@14|))))))) (= (_module.__default.LowerThan ($LS $ly@@30) |s#0@@21| |n#0@@14|) (ite (_module.Stream.Nil_q |s#0@@21|) true (let ((|tail#0@@1| (_module.Stream.tail |s#0@@21|)))
(let ((|t#0@@14| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@21|))))
 (and (and (<= (LitInt 1) |n#0@@14|) (_module.__default.LowerThan $ly@@30 (_module.Tree.children |t#0@@14|) (- |n#0@@14| 1))) (_module.__default.LowerThan $ly@@30 |tail#0@@1| |n#0@@14|))))))))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |651|
 :pattern ( (_module.__default.LowerThan ($LS $ly@@30) |s#0@@21| |n#0@@14|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@31 T@U) (|s#0@@22| T@U) (|n#0@@15| Int) (|_k#0@@19| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |s#0@@22| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@15|)) (= |_k#0@@19| (|ORD#FromNat| 0))) (_module.__default.LowerThan_h $ly@@31 |_k#0@@19| |s#0@@22| |n#0@@15|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |655|
 :pattern ( (_module.__default.LowerThan_h $ly@@31 |_k#0@@19| |s#0@@22| |n#0@@15|))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 11) (- 0 10)) (=> (|_module.__default.HasFiniteHeight#canCall| |t#0@@15|) (or (_module.__default.HasFiniteHeight |t#0@@15|) (forall ((|p#1@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |p#1@@1| (Tclass._module.Stream TInt)) (=> (_module.__default.ValidPath ($LS ($LS $LZ)) |t#0@@15| |p#1@@1|) (not (_module.__default.IsNeverEndingStream TInt ($LS ($LS $LZ)) |p#1@@1|))))
 :qid |InfiniteTreesdfy.260:10|
 :skolemid |826|
 :pattern ( (_module.__default.IsNeverEndingStream TInt ($LS ($LS $LZ)) |p#1@@1|))
 :pattern ( (_module.__default.ValidPath ($LS ($LS $LZ)) |t#0@@15| |p#1@@1|))
)))))))
(let ((anon9_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@@0 $Heap@1)) (and (forall ((|p#0_1| T@U) ) (!  (=> (and ($Is DatatypeTypeType |p#0_1| (Tclass._module.Stream TInt)) (_module.__default.ValidPath ($LS $LZ) |t#0@@15| |p#0_1|)) (not (_module.__default.IsNeverEndingStream TInt ($LS $LZ) |p#0_1|)))
 :qid |InfiniteTreesdfy.270:10|
 :skolemid |831|
 :pattern ( (_module.__default.IsNeverEndingStream TInt ($LS $LZ) |p#0_1|))
 :pattern ( (_module.__default.ValidPath ($LS $LZ) |t#0@@15| |p#0_1|))
)) (= (ControlFlow 0 12) 11))) GeneratedUnifiedExit_correct)))
(let ((anon9_Then_correct  (=> (and ($Is DatatypeTypeType |p#0_0@0| (Tclass._module.Stream TInt)) ($IsAlloc DatatypeTypeType |t#0@@15| Tclass._module.Tree $Heap@@0)) (=> (and (and ($IsAlloc DatatypeTypeType |p#0_0@0| (Tclass._module.Stream TInt) $Heap@@0) (|_module.__default.ValidPath#canCall| |t#0@@15| |p#0_0@0|)) (and (|_module.__default.ValidPath#canCall| |t#0@@15| |p#0_0@0|) (_module.__default.ValidPath ($LS $LZ) |t#0@@15| |p#0_0@0|))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.__default.LowerThan#canCall| (_module.Tree.children |t#0@@15|) |n#2@0|) (or (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@15|) |n#2@0|) (=> (_module.Stream.Nil_q (_module.Tree.children |t#0@@15|)) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (|_module.__default.LowerThan#canCall| (_module.Tree.children |t#0@@15|) |n#2@0|) (or (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@15|) |n#2@0|) (=> (_module.Stream.Nil_q (_module.Tree.children |t#0@@15|)) (U_2_bool (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.__default.LowerThan#canCall| (_module.Tree.children |t#0@@15|) |n#2@0|) (or (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@15|) |n#2@0|) (=> (not (_module.Stream.Nil_q (_module.Tree.children |t#0@@15|))) (<= (LitInt 1) |n#2@0|))))) (=> (=> (|_module.__default.LowerThan#canCall| (_module.Tree.children |t#0@@15|) |n#2@0|) (or (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@15|) |n#2@0|) (=> (not (_module.Stream.Nil_q (_module.Tree.children |t#0@@15|))) (<= (LitInt 1) |n#2@0|)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.__default.LowerThan#canCall| (_module.Tree.children |t#0@@15|) |n#2@0|) (or (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@15|) |n#2@0|) (=> (not (_module.Stream.Nil_q (_module.Tree.children |t#0@@15|))) (let ((|t#1@@2| ($Unbox DatatypeTypeType (_module.Stream.head (_module.Tree.children |t#0@@15|)))))
(_module.__default.LowerThan ($LS ($LS $LZ)) (_module.Tree.children |t#1@@2|) (- |n#2@0| 1))))))) (=> (=> (|_module.__default.LowerThan#canCall| (_module.Tree.children |t#0@@15|) |n#2@0|) (or (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@15|) |n#2@0|) (=> (not (_module.Stream.Nil_q (_module.Tree.children |t#0@@15|))) (let ((|t#1@@3| ($Unbox DatatypeTypeType (_module.Stream.head (_module.Tree.children |t#0@@15|)))))
(_module.__default.LowerThan ($LS ($LS $LZ)) (_module.Tree.children |t#1@@3|) (- |n#2@0| 1)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.__default.LowerThan#canCall| (_module.Tree.children |t#0@@15|) |n#2@0|) (or (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@15|) |n#2@0|) (=> (not (_module.Stream.Nil_q (_module.Tree.children |t#0@@15|))) (let ((|tail#0@@2| (_module.Stream.tail (_module.Tree.children |t#0@@15|))))
(_module.__default.LowerThan ($LS ($LS $LZ)) |tail#0@@2| |n#2@0|)))))) (=> (=> (|_module.__default.LowerThan#canCall| (_module.Tree.children |t#0@@15|) |n#2@0|) (or (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@15|) |n#2@0|) (=> (not (_module.Stream.Nil_q (_module.Tree.children |t#0@@15|))) (let ((|tail#0@@3| (_module.Stream.tail (_module.Tree.children |t#0@@15|))))
(_module.__default.LowerThan ($LS ($LS $LZ)) |tail#0@@3| |n#2@0|))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.__default.ValidPath#canCall| |t#0@@15| |p#0_0@0|) (or (_module.__default.ValidPath ($LS $LZ) |t#0@@15| |p#0_0@0|) (=> (_module.Stream.Nil_q |p#0_0@0|) (|_module.Tree#Equal| |t#0@@15| (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|))))))) (=> (=> (|_module.__default.ValidPath#canCall| |t#0@@15| |p#0_0@0|) (or (_module.__default.ValidPath ($LS $LZ) |t#0@@15| |p#0_0@0|) (=> (_module.Stream.Nil_q |p#0_0@0|) (|_module.Tree#Equal| |t#0@@15| (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.__default.ValidPath#canCall| |t#0@@15| |p#0_0@0|) (or (_module.__default.ValidPath ($LS $LZ) |t#0@@15| |p#0_0@0|) (=> (not (_module.Stream.Nil_q |p#0_0@0|)) (let ((|index#0@@0| (U_2_int ($Unbox intType (_module.Stream.head |p#0_0@0|)))))
(<= (LitInt 0) |index#0@@0|)))))) (=> (=> (|_module.__default.ValidPath#canCall| |t#0@@15| |p#0_0@0|) (or (_module.__default.ValidPath ($LS $LZ) |t#0@@15| |p#0_0@0|) (=> (not (_module.Stream.Nil_q |p#0_0@0|)) (let ((|index#0@@1| (U_2_int ($Unbox intType (_module.Stream.head |p#0_0@0|)))))
(<= (LitInt 0) |index#0@@1|))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.__default.ValidPath#canCall| |t#0@@15| |p#0_0@0|) (or (_module.__default.ValidPath ($LS $LZ) |t#0@@15| |p#0_0@0|) (=> (not (_module.Stream.Nil_q |p#0_0@0|)) (let ((|index#0@@2| (U_2_int ($Unbox intType (_module.Stream.head |p#0_0@0|)))))
(let ((|ch#0@@0| (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) (_module.Tree.children |t#0@@15|) |index#0@@2|)))
(_module.Stream.Cons_q |ch#0@@0|))))))) (=> (=> (|_module.__default.ValidPath#canCall| |t#0@@15| |p#0_0@0|) (or (_module.__default.ValidPath ($LS $LZ) |t#0@@15| |p#0_0@0|) (=> (not (_module.Stream.Nil_q |p#0_0@0|)) (let ((|index#0@@3| (U_2_int ($Unbox intType (_module.Stream.head |p#0_0@0|)))))
(let ((|ch#0@@1| (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) (_module.Tree.children |t#0@@15|) |index#0@@3|)))
(_module.Stream.Cons_q |ch#0@@1|)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.__default.ValidPath#canCall| |t#0@@15| |p#0_0@0|) (or (_module.__default.ValidPath ($LS $LZ) |t#0@@15| |p#0_0@0|) (=> (not (_module.Stream.Nil_q |p#0_0@0|)) (let ((|tail#2@@2| (_module.Stream.tail |p#0_0@0|)))
(let ((|index#0@@4| (U_2_int ($Unbox intType (_module.Stream.head |p#0_0@0|)))))
(let ((|ch#0@@2| (_module.__default.Tail Tclass._module.Tree ($LS ($LS $LZ)) (_module.Tree.children |t#0@@15|) |index#0@@4|)))
(_module.__default.ValidPath ($LS ($LS $LZ)) ($Unbox DatatypeTypeType (_module.Stream.head |ch#0@@2|)) |tail#2@@2|))))))))))))))))))))))))))
(let ((anon4_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (and (<= (LitInt 0) (LitInt 0)) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@15|) (LitInt 0)))) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (and (<= (LitInt 0) (LitInt 0)) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@15|) (LitInt 0)))) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (and (<= (LitInt 0) (LitInt 0)) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@15|) (LitInt 0)))) (exists ((|$as#n0#0| Int) ) (!  (and (<= (LitInt 0) |$as#n0#0|) (and (<= (LitInt 0) |$as#n0#0|) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@15|) |$as#n0#0|)))
 :qid |InfiniteTreesdfy.269:7|
 :skolemid |829|
)))))) (=> (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (and (<= (LitInt 0) (LitInt 0)) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@15|) (LitInt 0)))) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (and (<= (LitInt 0) (LitInt 0)) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@15|) (LitInt 0)))) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (and (<= (LitInt 0) (LitInt 0)) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@15|) (LitInt 0)))) (exists ((|$as#n0#0@@0| Int) ) (!  (and (<= (LitInt 0) |$as#n0#0@@0|) (and (<= (LitInt 0) |$as#n0#0@@0|) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@15|) |$as#n0#0@@0|)))
 :qid |InfiniteTreesdfy.269:7|
 :skolemid |829|
))))) (=> (<= (LitInt 0) |n#2@0|) (=> (and (<= (LitInt 0) |n#2@0|) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@15|) |n#2@0|)) (and (=> (= (ControlFlow 0 13) 2) anon9_Then_correct) (=> (= (ControlFlow 0 13) 12) anon9_Else_correct))))))))
(let ((anon3_correct  (=> (and (=> (<= (LitInt 0) |n#3@0|) (and (_module.Tree.Node_q |t#0@@15|) (|_module.__default.LowerThan#canCall| (_module.Tree.children |t#0@@15|) |n#3@0|))) (= (ControlFlow 0 16) 13)) anon4_correct)))
(let ((anon8_Else_correct  (=> (and (< |n#3@0| (LitInt 0)) (= (ControlFlow 0 18) 16)) anon3_correct)))
(let ((anon8_Then_correct  (=> (<= (LitInt 0) |n#3@0|) (=> (and (_module.Tree.Node_q |t#0@@15|) (= |##s#0@0| (_module.Tree.children |t#0@@15|))) (=> (and (and ($IsAlloc DatatypeTypeType |##s#0@0| (Tclass._module.Stream Tclass._module.Tree) $Heap@@0) ($IsAlloc intType (int_2_U |n#3@0|) Tclass._System.nat $Heap@@0)) (and (|_module.__default.LowerThan#canCall| (_module.Tree.children |t#0@@15|) |n#3@0|) (= (ControlFlow 0 17) 16))) anon3_correct)))))
(let ((anon7_Then_correct  (=> (<= (LitInt 0) |n#3@0|) (and (=> (= (ControlFlow 0 19) 17) anon8_Then_correct) (=> (= (ControlFlow 0 19) 18) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (< |n#3@0| (LitInt 0)) (= (ControlFlow 0 15) 13)) anon4_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (and (=> (= (ControlFlow 0 20) 19) anon7_Then_correct) (=> (= (ControlFlow 0 20) 15) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is DatatypeTypeType |t#0@@15| Tclass._module.Tree) ($IsAlloc DatatypeTypeType |t#0@@15| Tclass._module.Tree $Heap@@0)) (|$IsA#_module.Tree| |t#0@@15|)) (=> (and (and (and (<= (LitInt 0) |n#2|) true) (= 5 $FunctionContextHeight)) (and (and (|_module.__default.HasBoundedHeight#canCall| |t#0@@15|) (and (_module.__default.HasBoundedHeight |t#0@@15|) (exists ((|n#1@@1| Int) ) (!  (and (<= (LitInt 0) |n#1@@1|) (and (<= (LitInt 0) |n#1@@1|) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@15|) |n#1@@1|)))
 :qid |InfiniteTreesdfy.69:10|
 :skolemid |825|
 :pattern ( (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@15|) |n#1@@1|))
