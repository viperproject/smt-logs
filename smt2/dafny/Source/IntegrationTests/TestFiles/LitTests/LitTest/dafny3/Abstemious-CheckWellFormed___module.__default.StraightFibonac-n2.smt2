...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.StraightFibonacci__Correct)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@0 $Heap@0)) (=> (and (and (and ($IsAlloc intType (int_2_U |n#0@@12|) Tclass._System.nat $Heap@0) ($IsAlloc intType (int_2_U |k#0|) Tclass._System.nat $Heap@0)) (and (|_module.__default.StraightFibonacci#canCall| |k#0|) (_module.Stream.Cons_q (_module.__default.StraightFibonacci ($LS $LZ) |k#0|)))) (and (and (= |##s#0@0| (_module.__default.StraightFibonacci ($LS $LZ) |k#0|)) ($IsAlloc DatatypeTypeType |##s#0@0| (Tclass._module.Stream TInt) $Heap@0)) (and (|_module.__default.nth#canCall| TInt |n#0@@12| (_module.__default.StraightFibonacci ($LS $LZ) |k#0|)) (= (ControlFlow 0 2) (- 0 1))))) ($Is intType (int_2_U (+ |k#0| |n#0@@12|)) Tclass._System.nat))))))
