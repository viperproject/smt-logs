...
(declare-fun $LZ () T@U)
(declare-fun |c#0| () T@U)
(declare-fun |##ys#2@0| () T@U)
(declare-fun |k#0| () Int)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.SAppendIsAssociativeK)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (and (= $Heap@@0 $Heap@0) ($IsAlloc DatatypeTypeType |a#0| (Tclass._module.Stream _module._default.SAppendIsAssociativeK$_T0) $Heap@0)) (and ($IsAlloc DatatypeTypeType |b#0| (Tclass._module.Stream _module._default.SAppendIsAssociativeK$_T0) $Heap@0) (|_module.__default.SAppend#canCall| _module._default.SAppendIsAssociativeK$_T0 |a#0| |b#0|))) (and (and (= |##xs#0@0| (_module.__default.SAppend _module._default.SAppendIsAssociativeK$_T0 ($LS $LZ) |a#0| |b#0|)) ($IsAlloc DatatypeTypeType |##xs#0@0| (Tclass._module.Stream _module._default.SAppendIsAssociativeK$_T0) $Heap@0)) (and ($IsAlloc DatatypeTypeType |c#0| (Tclass._module.Stream _module._default.SAppendIsAssociativeK$_T0) $Heap@0) (|_module.__default.SAppend#canCall| _module._default.SAppendIsAssociativeK$_T0 (_module.__default.SAppend _module._default.SAppendIsAssociativeK$_T0 ($LS $LZ) |a#0| |b#0|) |c#0|)))) (and (and (and ($IsAlloc DatatypeTypeType |a#0| (Tclass._module.Stream _module._default.SAppendIsAssociativeK$_T0) $Heap@0) ($IsAlloc DatatypeTypeType |b#0| (Tclass._module.Stream _module._default.SAppendIsAssociativeK$_T0) $Heap@0)) (and ($IsAlloc DatatypeTypeType |c#0| (Tclass._module.Stream _module._default.SAppendIsAssociativeK$_T0) $Heap@0) (|_module.__default.SAppend#canCall| _module._default.SAppendIsAssociativeK$_T0 |b#0| |c#0|))) (and (and (= |##ys#2@0| (_module.__default.SAppend _module._default.SAppendIsAssociativeK$_T0 ($LS $LZ) |b#0| |c#0|)) ($IsAlloc DatatypeTypeType |##ys#2@0| (Tclass._module.Stream _module._default.SAppendIsAssociativeK$_T0) $Heap@0)) (and (|_module.__default.SAppend#canCall| _module._default.SAppendIsAssociativeK$_T0 |a#0| (_module.__default.SAppend _module._default.SAppendIsAssociativeK$_T0 ($LS $LZ) |b#0| |c#0|)) (= (ControlFlow 0 2) (- 0 1)))))) (<= 0 |k#0|))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (<= (LitInt 0) |k#0|)) (=> (and (and (and (and ($Is DatatypeTypeType |a#0| (Tclass._module.Stream _module._default.SAppendIsAssociativeK$_T0)) ($IsAlloc DatatypeTypeType |a#0| (Tclass._module.Stream _module._default.SAppendIsAssociativeK$_T0) $Heap@@0)) (|$IsA#_module.Stream| |a#0|)) (and (and ($Is DatatypeTypeType |b#0| (Tclass._module.Stream _module._default.SAppendIsAssociativeK$_T0)) ($IsAlloc DatatypeTypeType |b#0| (Tclass._module.Stream _module._default.SAppendIsAssociativeK$_T0) $Heap@@0)) (|$IsA#_module.Stream| |b#0|))) (and (and (and ($Is DatatypeTypeType |c#0| (Tclass._module.Stream _module._default.SAppendIsAssociativeK$_T0)) ($IsAlloc DatatypeTypeType |c#0| (Tclass._module.Stream _module._default.SAppendIsAssociativeK$_T0) $Heap@@0)) (|$IsA#_module.Stream| |c#0|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct))))
