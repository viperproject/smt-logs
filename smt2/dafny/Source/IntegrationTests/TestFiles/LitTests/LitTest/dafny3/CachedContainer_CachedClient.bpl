...
procedure {:verboseName "CachedClient.Main (well-formedness)"} CheckWellFormed$$CachedClient.__default.Main();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "CachedClient.Main (call)"} Call$$CachedClient.__default.Main();
  modifies $Heap;
...
procedure {:verboseName "CachedClient.Main (correctness)"} Impl$$CachedClient.__default.Main() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "CachedClient.Main (correctness)"} Impl$$CachedClient.__default.Main() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;

    // AddMethodImpl: Main, Impl$$CachedClient.__default.Main
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/CachedContainer.dfy(211,9)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id560"} Call$$CachedClient.__default.Test();
    // TrCallStmt: After ProcessCallStmt
}



procedure {:verboseName "CachedClient.Test (well-formedness)"} CheckWellFormed$$CachedClient.__default.Test();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "CachedClient.Test (call)"} Call$$CachedClient.__default.Test();
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "CachedClient.Test (correctness)"} Impl$$CachedClient.__default.Test() returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "CachedClient.Test (correctness)"} Impl$$CachedClient.__default.Test() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var defass#c#0: bool;
  var c#0: ref
     where defass#c#0
       ==> $Is(c#0, Tclass.M3.Container(TInt))
         && $IsAlloc(c#0, Tclass.M3.Container(TInt), $Heap);
  var $nw: ref;
  var t##0: int;
  var t##1: int;
  var b#0: bool;
  ...
  var t##6: int;
    ...
    // AddMethodImpl: Test, Impl$$CachedClient.__default.Test
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/CachedContainer.dfy(188,11)
    assume true;
    // ----- init call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/CachedContainer.dfy[CachedClient](188,14)
    // TrCallStmt: Before ProcessCallStmt
    free call {:id "id561"} $nw := Call$$M3.Container.__ctor(TInt);
    // TrCallStmt: After ProcessCallStmt
    c#0 := $nw;
    defass#c#0 := true;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/CachedContainer.dfy[CachedClient](189,10)
    // TrCallStmt: Before ProcessCallStmt
    assume {:id "id563"} defass#c#0;
    assume true;
    assume {:id "id564"} c#0 != null;
    assume true;
    // ProcessCallStmt: CheckSubrange
    t##0 := LitInt(56);
    assume {:id "id565"} (forall $o: ref, $f: Field :: 
      $o != null
           && $Unbox(read($Heap, $o, alloc)): bool
           && Set#IsMember($Unbox(read($Heap, c#0, M3.Container.Repr)): Set, $Box($o))
         ==> $_ModifiesFrame[$o, $f]);
    free call {:id "id566"} Call$$M3.Container.Add(TInt, c#0, $Box(t##0));
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/CachedContainer.dfy[CachedClient](190,10)
    // TrCallStmt: Before ProcessCallStmt
    assume {:id "id567"} defass#c#0;
    assume true;
    assume {:id "id568"} c#0 != null;
    assume true;
    // ProcessCallStmt: CheckSubrange
    t##1 := LitInt(12);
    assume {:id "id569"} (forall $o: ref, $f: Field :: 
      $o != null
           && $Unbox(read($Heap, $o, alloc)): bool
           && Set#IsMember($Unbox(read($Heap, c#0, M3.Container.Repr)): Set, $Box($o))
         ==> $_ModifiesFrame[$o, $f]);
    free call {:id "id570"} Call$$M3.Container.Add(TInt, c#0, $Box(t##1));
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/CachedContainer.dfy[CachedClient](191,24)
    assume true;
    // TrCallStmt: Adding lhs with type bool
    // TrCallStmt: Before ProcessCallStmt
    assume {:id "id571"} defass#c#0;
    assume true;
    assume {:id "id572"} c#0 != null;
    assume true;
    // ProcessCallStmt: CheckSubrange
    t##2 := LitInt(17);
    assume {:id "id573"} (forall $o: ref, $f: Field :: 
      $o != null
           && $Unbox(read($Heap, $o, alloc)): bool
           && Set#IsMember($Unbox(read($Heap, c#0, M3.Container.Repr)): Set, $Box($o))
         ==> $_ModifiesFrame[$o, $f]);
    free call {:id "id574"} $rhs##0 := Call$$M3.Container.Contains(TInt, c#0, $Box(t##2));
    // TrCallStmt: After ProcessCallStmt
    b#0 := $rhs##0;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/CachedContainer.dfy[CachedClient](192,5)
    assume true;
    assume {:id "id576"} !b#0;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/CachedContainer.dfy[CachedClient](193,5)
    assume true;
    assume true;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/CachedContainer.dfy[CachedClient](194,20)
    assume true;
    // TrCallStmt: Adding lhs with type bool
    // TrCallStmt: Before ProcessCallStmt
    assume {:id "id577"} defass#c#0;
    assume true;
    assume {:id "id578"} c#0 != null;
    assume true;
    // ProcessCallStmt: CheckSubrange
    t##3 := LitInt(12);
    assume {:id "id579"} (forall $o: ref, $f: Field :: 
      $o != null
           && $Unbox(read($Heap, $o, alloc)): bool
           && Set#IsMember($Unbox(read($Heap, c#0, M3.Container.Repr)): Set, $Box($o))
         ==> $_ModifiesFrame[$o, $f]);
    free call {:id "id580"} $rhs##1 := Call$$M3.Container.Contains(TInt, c#0, $Box(t##3));
    // TrCallStmt: After ProcessCallStmt
    b#0 := $rhs##1;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/CachedContainer.dfy[CachedClient](195,5)
    assume true;
    assume {:id "id582"} b#0;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/CachedContainer.dfy[CachedClient](196,5)
    assume true;
    assume true;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/CachedContainer.dfy[CachedClient](197,13)
    // TrCallStmt: Before ProcessCallStmt
    assume {:id "id583"} defass#c#0;
    assume true;
    assume {:id "id584"} c#0 != null;
    assume true;
    // ProcessCallStmt: CheckSubrange
    t##4 := LitInt(12);
    assume {:id "id585"} (forall $o: ref, $f: Field :: 
      $o != null
           && $Unbox(read($Heap, $o, alloc)): bool
           && Set#IsMember($Unbox(read($Heap, c#0, M3.Container.Repr)): Set, $Box($o))
         ==> $_ModifiesFrame[$o, $f]);
    free call {:id "id586"} Call$$M3.Container.Remove(TInt, c#0, $Box(t##4));
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/CachedContainer.dfy[CachedClient](198,20)
    assume true;
    // TrCallStmt: Adding lhs with type bool
    // TrCallStmt: Before ProcessCallStmt
    assume {:id "id587"} defass#c#0;
    assume true;
    assume {:id "id588"} c#0 != null;
    assume true;
    // ProcessCallStmt: CheckSubrange
    t##5 := LitInt(12);
    assume {:id "id589"} (forall $o: ref, $f: Field :: 
      $o != null
           && $Unbox(read($Heap, $o, alloc)): bool
           && Set#IsMember($Unbox(read($Heap, c#0, M3.Container.Repr)): Set, $Box($o))
         ==> $_ModifiesFrame[$o, $f]);
    free call {:id "id590"} $rhs##2 := Call$$M3.Container.Contains(TInt, c#0, $Box(t##5));
    // TrCallStmt: After ProcessCallStmt
    b#0 := $rhs##2;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/CachedContainer.dfy[CachedClient](199,5)
    assume true;
    assume {:id "id592"} !b#0;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/CachedContainer.dfy[CachedClient](200,5)
    assume true;
    assume true;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/CachedContainer.dfy[CachedClient](201,5)
    assume {:id "id593"} defass#c#0;
    assume {:id "id594"} {:subsumption 0} c#0 != null;
    assume true;
    assume {:id "id595"} Set#Equal($Unbox(read($Heap, c#0, M3.Container.Contents)): Set, 
      Set#UnionOne(Set#Empty(): Set, $Box(LitInt(56))));
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/CachedContainer.dfy[CachedClient](202,20)
    assume true;
    // TrCallStmt: Adding lhs with type bool
    // TrCallStmt: Before ProcessCallStmt
    assume {:id "id596"} defass#c#0;
    assume true;
    assume {:id "id597"} c#0 != null;
    assume true;
    // ProcessCallStmt: CheckSubrange
    t##6 := LitInt(56);
    assume {:id "id598"} (forall $o: ref, $f: Field :: 
      $o != null
           && $Unbox(read($Heap, $o, alloc)): bool
           && Set#IsMember($Unbox(read($Heap, c#0, M3.Container.Repr)): Set, $Box($o))
         ==> $_ModifiesFrame[$o, $f]);
    free call {:id "id599"} $rhs##3 := Call$$M3.Container.Contains(TInt, c#0, $Box(t##6));
    // TrCallStmt: After ProcessCallStmt
    b#0 := $rhs##3;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/CachedContainer.dfy[CachedClient](203,5)
    assume true;
    assume {:id "id601"} b#0;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny3/CachedContainer.dfy[CachedClient](204,5)
    assume true;
    assume true;
}
...
axiom (forall a#4#0#0: int, a#4#1#0: Box :: 
  { #M3.Cache.Some(a#4#0#0, a#4#1#0) } 
  DatatypeCtorId(#M3.Cache.Some(a#4#0#0, a#4#1#0)) == ##M3.Cache.Some);
}
...
axiom (forall d: DatatypeType :: 
  { M3.Cache.Some_q(d) } 
  M3.Cache.Some_q(d)
     ==> (exists a#5#0#0: int, a#5#1#0: Box :: d == #M3.Cache.Some(a#5#0#0, a#5#1#0)));

// Constructor $Is
axiom (forall M3.Cache$T: Ty, a#6#0#0: int, a#6#1#0: Box :: 
  { $Is(#M3.Cache.Some(a#6#0#0, a#6#1#0), Tclass.M3.Cache(M3.Cache$T)) } 
  $Is(#M3.Cache.Some(a#6#0#0, a#6#1#0), Tclass.M3.Cache(M3.Cache$T))
     <==> $Is(a#6#0#0, Tclass._System.nat()) && $IsBox(a#6#1#0, M3.Cache$T));

// Constructor $IsAlloc
axiom (forall M3.Cache$T: Ty, a#6#0#0: int, a#6#1#0: Box, $h: Heap :: 
  { $IsAlloc(#M3.Cache.Some(a#6#0#0, a#6#1#0), Tclass.M3.Cache(M3.Cache$T), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#M3.Cache.Some(a#6#0#0, a#6#1#0), Tclass.M3.Cache(M3.Cache$T), $h)
       <==> $IsAlloc(a#6#0#0, Tclass._System.nat(), $h)
         && $IsAllocBox(a#6#1#0, M3.Cache$T, $h)));
...
axiom (forall a#7#0#0: int, a#7#1#0: Box :: 
  { #M3.Cache.Some(LitInt(a#7#0#0), Lit(a#7#1#0)) } 
  #M3.Cache.Some(LitInt(a#7#0#0), Lit(a#7#1#0))
     == Lit(#M3.Cache.Some(a#7#0#0, a#7#1#0)));

function M3.Cache.index(DatatypeType) : int;

// Constructor injectivity
axiom (forall a#8#0#0: int, a#8#1#0: Box :: 
  { #M3.Cache.Some(a#8#0#0, a#8#1#0) } 
  M3.Cache.index(#M3.Cache.Some(a#8#0#0, a#8#1#0)) == a#8#0#0);

function M3.Cache.value(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#9#0#0: int, a#9#1#0: Box :: 
  { #M3.Cache.Some(a#9#0#0, a#9#1#0) } 
  M3.Cache.value(#M3.Cache.Some(a#9#0#0, a#9#1#0)) == a#9#1#0);

// Inductive rank
axiom (forall a#10#0#0: int, a#10#1#0: Box :: 
  { #M3.Cache.Some(a#10#0#0, a#10#1#0) } 
  BoxRank(a#10#1#0) < DtRank(#M3.Cache.Some(a#10#0#0, a#10#1#0)));
...
axiom {:id "id602"} (forall M3.Container$T: Ty, $Heap: Heap, this: ref :: 
...
procedure {:verboseName "M3.Container._ctor (call)"} Call$$M3.Container.__ctor(M3.Container$T: Ty)
  ...
  free ensures {:id "id603"} M3.Container.Valid#canCall(M3.Container$T, $Heap, this)
     && 
  ...
  free ensures true;
  ensures {:id "id605"} Set#Equal($Unbox(read($Heap, this, M3.Container.Contents)): Set, Set#Empty(): Set);
...
procedure {:verboseName "M3.Container.Add (call)"} Call$$M3.Container.Add(M3.Container$T: Ty, 
  ...
  requires {:id "id606"} M3.Container.Valid#canCall(M3.Container$T, $Heap, this)
     ==> M3.Container.Valid(M3.Container$T, $Heap, this)
       || Set#IsMember($Unbox(read($Heap, this, M3.Container.Repr)): Set, $Box(this));
  requires {:id "id607"} M3.Container.Valid#canCall(M3.Container$T, $Heap, this)
     ==> M3.Container.Valid(M3.Container$T, $Heap, this)
       || !Set#IsMember($Unbox(read($Heap, this, M3.Container.Repr)): Set, $Box(null));
  requires {:id "id608"} M3.Container.Valid#canCall(M3.Container$T, $Heap, this)
     ==> M3.Container.Valid(M3.Container$T, $Heap, this)
           ...
           || Set#Equal($Unbox(read($Heap, this, M3.Container.Contents)): Set, 
            Set#FromBoogieMap((lambda $y#10: Box :: 
                $IsBox($y#10, M3.Container$T)
                   && Seq#Contains($Unbox(read($Heap, this, M3.Container.elems)): Seq, $y#10)))));
  requires {:id "id609"} M3.Container.Valid#canCall(M3.Container$T, $Heap, this)
     ==> M3.Container.Valid(M3.Container$T, $Heap, this)
       || (M3.Container.Valid_k#canCall(M3.Container$T, $Heap, this)
         ==> M3.Container.Valid_k(M3.Container$T, $Heap, this)
           || (forall i#5: int, j#6: int :: 
            { Seq#Index($Unbox(read($Heap, this, M3.Container.elems)): Seq, j#6), Seq#Index($Unbox(read($Heap, this, M3.Container.elems)): Seq, i#5) } 
            LitInt(0) <= i#5
                 && i#5 < j#6
                 && j#6 < Seq#Length($Unbox(read($Heap, this, M3.Container.elems)): Seq)
               ==> Seq#Index($Unbox(read($Heap, this, M3.Container.elems)): Seq, i#5)
                 != Seq#Index($Unbox(read($Heap, this, M3.Container.elems)): Seq, j#6)));
  requires {:id "id610"} M3.Container.Valid#canCall(M3.Container$T, $Heap, this)
     ==> M3.Container.Valid(M3.Container$T, $Heap, this)
       || (M3.Container.Valid_k#canCall(M3.Container$T, $Heap, this)
         ==> M3.Container.Valid_k(M3.Container$T, $Heap, this)
           || M3.Container.Valid_k_k(M3.Container$T, $Heap, this));
  ...
  // user-defined postconditions
  free ensures M3.Container.Valid#canCall(M3.Container$T, $Heap, this);
  free ensures {:id "id611"} M3.Container.Valid#canCall(M3.Container$T, $Heap, this)
     && 
    M3.Container.Valid(M3.Container$T, $Heap, this)
     && 
    Set#IsMember($Unbox(read($Heap, this, M3.Container.Repr)): Set, $Box(this))
  ...
  ensures {:id "id612"} (forall $o: ref :: 
     ...
     && (forall $o: ref :: 
      ...
      Set#IsMember($Unbox(read($Heap, this, M3.Container.Repr)): Set, $Box($o))
         ...
         ==> !$Unbox(read(old($Heap), $o, alloc)): bool);
  free ensures true;
  ensures {:id "id613"} Set#Equal($Unbox(read($Heap, this, M3.Container.Contents)): Set, 
...
procedure {:verboseName "M3.Container.Remove (call)"} Call$$M3.Container.Remove(M3.Container$T: Ty, 
    ...
    t#0: Box
       where $IsBox(t#0, M3.Container$T) && $IsAllocBox(t#0, M3.Container$T, $Heap));
  // user-defined preconditions
  requires {:id "id614"} M3.Container.Valid#canCall(M3.Container$T, $Heap, this)
     ==> M3.Container.Valid(M3.Container$T, $Heap, this)
       || Set#IsMember($Unbox(read($Heap, this, M3.Container.Repr)): Set, $Box(this));
  requires {:id "id615"} M3.Container.Valid#canCall(M3.Container$T, $Heap, this)
     ==> M3.Container.Valid(M3.Container$T, $Heap, this)
       || !Set#IsMember($Unbox(read($Heap, this, M3.Container.Repr)): Set, $Box(null));
  requires {:id "id616"} M3.Container.Valid#canCall(M3.Container$T, $Heap, this)
     ==> M3.Container.Valid(M3.Container$T, $Heap, this)
       || (M3.Container.Valid_k#canCall(M3.Container$T, $Heap, this)
         ==> M3.Container.Valid_k(M3.Container$T, $Heap, this)
           || Set#Equal($Unbox(read($Heap, this, M3.Container.Contents)): Set, 
            Set#FromBoogieMap((lambda $y#10: Box :: 
                $IsBox($y#10, M3.Container$T)
                   && Seq#Contains($Unbox(read($Heap, this, M3.Container.elems)): Seq, $y#10)))));
  requires {:id "id617"} M3.Container.Valid#canCall(M3.Container$T, $Heap, this)
     ==> M3.Container.Valid(M3.Container$T, $Heap, this)
       || (M3.Container.Valid_k#canCall(M3.Container$T, $Heap, this)
         ==> M3.Container.Valid_k(M3.Container$T, $Heap, this)
           || (forall i#5: int, j#6: int :: 
            ...
            LitInt(0) <= i#5
               ...
               ==> Seq#Index($Unbox(read($Heap, this, M3.Container.elems)): Seq, i#5)
                 != Seq#Index($Unbox(read($Heap, this, M3.Container.elems)): Seq, j#6)));
  requires {:id "id618"} M3.Container.Valid#canCall(M3.Container$T, $Heap, this)
     ==> M3.Container.Valid(M3.Container$T, $Heap, this)
       || (M3.Container.Valid_k#canCall(M3.Container$T, $Heap, this)
         ==> M3.Container.Valid_k(M3.Container$T, $Heap, this)
           || M3.Container.Valid_k_k(M3.Container$T, $Heap, this));
  ...
  // user-defined postconditions
  free ensures M3.Container.Valid#canCall(M3.Container$T, $Heap, this);
  free ensures {:id "id619"} M3.Container.Valid#canCall(M3.Container$T, $Heap, this)
     && 
    M3.Container.Valid(M3.Container$T, $Heap, this)
     && 
    Set#IsMember($Unbox(read($Heap, this, M3.Container.Repr)): Set, $Box(this))
  ...
  ensures {:id "id620"} (forall $o: ref :: 
     ...
     && (forall $o: ref :: 
      ...
      Set#IsMember($Unbox(read($Heap, this, M3.Container.Repr)): Set, $Box($o))
         ...
         ==> !$Unbox(read(old($Heap), $o, alloc)): bool);
  free ensures true;
  ensures {:id "id621"} Set#Equal($Unbox(read($Heap, this, M3.Container.Contents)): Set, 
...
axiom {:id "id622"} (forall M3.Container$T: Ty, $Heap: Heap, this: ref :: 
     ...
     ==> (Set#Equal($Unbox(read($Heap, this, M3.Container.Contents)): Set, 
          Set#FromBoogieMap((lambda $y#8: Box :: 
              $IsBox($y#8, M3.Container$T)
                 && Seq#Contains($Unbox(read($Heap, this, M3.Container.elems)): Seq, $y#8))))
         ==> 
          ...
          Set#Equal($Unbox(read($Heap, this, M3.Container.Contents)): Set, 
            Set#FromBoogieMap((lambda $y#7: Box :: 
                $IsBox($y#7, M3.Container$T)
                   && Seq#Contains($Unbox(read($Heap, this, M3.Container.elems)): Seq, $y#7))))
           && (forall i#3: int, j#3: int :: 
            { Seq#Index($Unbox(read($Heap, this, M3.Container.elems)): Seq, j#3), Seq#Index($Unbox(read($Heap, this, M3.Container.elems)): Seq, i#3) } 
            LitInt(0) <= i#3
                 && i#3 < j#3
...
procedure {:verboseName "M3.Container.Contains (call)"} Call$$M3.Container.Contains(M3.Container$T: Ty, 
   ...
   returns (b#0: bool);
  // user-defined preconditions
  requires {:id "id623"} M3.Container.Valid#canCall(M3.Container$T, $Heap, this)
     ==> M3.Container.Valid(M3.Container$T, $Heap, this)
       || Set#IsMember($Unbox(read($Heap, this, M3.Container.Repr)): Set, $Box(this));
  requires {:id "id624"} M3.Container.Valid#canCall(M3.Container$T, $Heap, this)
     ==> M3.Container.Valid(M3.Container$T, $Heap, this)
       || !Set#IsMember($Unbox(read($Heap, this, M3.Container.Repr)): Set, $Box(null));
  requires {:id "id625"} M3.Container.Valid#canCall(M3.Container$T, $Heap, this)
     ==> M3.Container.Valid(M3.Container$T, $Heap, this)
       || (M3.Container.Valid_k#canCall(M3.Container$T, $Heap, this)
         ==> M3.Container.Valid_k(M3.Container$T, $Heap, this)
           || Set#Equal($Unbox(read($Heap, this, M3.Container.Contents)): Set, 
            Set#FromBoogieMap((lambda $y#8: Box :: 
                $IsBox($y#8, M3.Container$T)
                   && Seq#Contains($Unbox(read($Heap, this, M3.Container.elems)): Seq, $y#8)))));
  requires {:id "id626"} M3.Container.Valid#canCall(M3.Container$T, $Heap, this)
     ==> M3.Container.Valid(M3.Container$T, $Heap, this)
       || (M3.Container.Valid_k#canCall(M3.Container$T, $Heap, this)
         ==> M3.Container.Valid_k(M3.Container$T, $Heap, this)
           || (forall i#4: int, j#5: int :: 
            { Seq#Index($Unbox(read($Heap, this, M3.Container.elems)): Seq, j#5), Seq#Index($Unbox(read($Heap, this, M3.Container.elems)): Seq, i#4) } 
            LitInt(0) <= i#4
                 && i#4 < j#5
                 && j#5 < Seq#Length($Unbox(read($Heap, this, M3.Container.elems)): Seq)
               ==> Seq#Index($Unbox(read($Heap, this, M3.Container.elems)): Seq, i#4)
                 != Seq#Index($Unbox(read($Heap, this, M3.Container.elems)): Seq, j#5)));
  requires {:id "id627"} M3.Container.Valid#canCall(M3.Container$T, $Heap, this)
     ==> M3.Container.Valid(M3.Container$T, $Heap, this)
       || (M3.Container.Valid_k#canCall(M3.Container$T, $Heap, this)
         ==> M3.Container.Valid_k(M3.Container$T, $Heap, this)
           || M3.Container.Valid_k_k(M3.Container$T, $Heap, this));
  ...
  // user-defined postconditions
  free ensures M3.Container.Valid#canCall(M3.Container$T, $Heap, this);
  free ensures {:id "id628"} M3.Container.Valid#canCall(M3.Container$T, $Heap, this)
     && 
    M3.Container.Valid(M3.Container$T, $Heap, this)
     && 
    Set#IsMember($Unbox(read($Heap, this, M3.Container.Repr)): Set, $Box(this))
  ...
  ensures {:id "id629"} (forall $o: ref :: 
     ...
     && (forall $o: ref :: 
      ...
      Set#IsMember($Unbox(read($Heap, this, M3.Container.Repr)): Set, $Box($o))
         ...
         ==> !$Unbox(read(old($Heap), $o, alloc)): bool);
  free ensures true;
  ensures {:id "id630"} Set#Equal($Unbox(read($Heap, this, M3.Container.Contents)): Set, 
    $Unbox(read(old($Heap), this, M3.Container.Contents)): Set);
  free ensures true;
  ensures {:id "id631"} b#0
...
axiom {:id "id632"} (forall M3.Container$T: Ty, $Heap: Heap, this: ref :: 
