...
(declare-fun $LZ () T@U)
(declare-fun |k#0| () Int)
(set-info :boogie-vc-id Impl$$_module.__default.NaturalLemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (forall ((|$ih#k0#0| Int) ) (!  (=> (and (and (<= (LitInt 0) |$ih#k0#0|) (U_2_bool (Lit boolType (bool_2_U true)))) (and (<= 0 |$ih#k0#0|) (< |$ih#k0#0| |k#0|))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#FromNat| |$ih#k0#0|) ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.OhOnes ($LS $LZ))))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))))
 :qid |Abstemiousdfy.218:20|
 :skolemid |765|
 :pattern ( (|$PrefixEq#_module.Stream| TInt TInt (|ORD#FromNat| |$ih#k0#0|) ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.OhOnes ($LS $LZ))))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))))
)) (= (ControlFlow 0 2) (- 0 1)))) (or (|$PrefixEq#_module.Stream| TInt TInt (|ORD#FromNat| |k#0|) ($LS ($LS $LZ)) (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.OhOnes ($LS $LZ))))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))) (=> (< 0 |k#0|) (=> (_module.Stream.Cons_q (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.OhOnes ($LS ($LS $LZ))))))) (and (_module.Stream.Cons_q (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ))))) (and (= (U_2_int ($Unbox intType (_module.Stream.head (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.OhOnes ($LS ($LS $LZ))))))))) (U_2_int ($Unbox intType (_module.Stream.head (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ)))))))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#FromNat| (- |k#0| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.OhOnes ($LS ($LS $LZ))))))) (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ)))))))))))))))
