...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Lemma__FlattenAppend1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) ($IsAlloc DatatypeTypeType |M#0@@16| (Tclass._module.Stream (Tclass._module.Stream _module._default.Lemma_FlattenAppend1$T)) $Heap@@1)) (and (|_module.__default.StreamOfNonEmpties#canCall| _module._default.Lemma_FlattenAppend1$T |M#0@@16|) (_module.__default.StreamOfNonEmpties _module._default.Lemma_FlattenAppend1$T ($LS $LZ) |M#0@@16|))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@1 $Heap@0)) (and ($IsAlloc DatatypeTypeType |s#0@@1| (Tclass._module.Stream _module._default.Lemma_FlattenAppend1$T) $Heap@0) ($IsAlloc DatatypeTypeType |M#0@@16| (Tclass._module.Stream (Tclass._module.Stream _module._default.Lemma_FlattenAppend1$T)) $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.__default.StreamOfNonEmpties#canCall| _module._default.Lemma_FlattenAppend1$T |M#0@@16|) (or (_module.__default.StreamOfNonEmpties _module._default.Lemma_FlattenAppend1$T ($LS $LZ) |M#0@@16|) (=> (_module.Stream.Nil_q |M#0@@16|) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.__default.StreamOfNonEmpties#canCall| _module._default.Lemma_FlattenAppend1$T |M#0@@16|) (or (_module.__default.StreamOfNonEmpties _module._default.Lemma_FlattenAppend1$T ($LS $LZ) |M#0@@16|) (=> (not (_module.Stream.Nil_q |M#0@@16|)) (let ((|s#1@@1| ($Unbox DatatypeTypeType (_module.Stream.head |M#0@@16|))))
(_module.Stream.Cons_q |s#1@@1|)))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.__default.StreamOfNonEmpties#canCall| _module._default.Lemma_FlattenAppend1$T |M#0@@16|) (or (_module.__default.StreamOfNonEmpties _module._default.Lemma_FlattenAppend1$T ($LS $LZ) |M#0@@16|) (=> (not (_module.Stream.Nil_q |M#0@@16|)) (let ((|N#0@@5| (_module.Stream.tail |M#0@@16|)))
(_module.__default.StreamOfNonEmpties _module._default.Lemma_FlattenAppend1$T ($LS ($LS $LZ)) |N#0@@5|)))))) (=> (and (_module.__default.StreamOfNonEmpties _module._default.Lemma_FlattenAppend1$T ($LS $LZ) |M#0@@16|) (|_module.__default.PrependThenFlattenNonEmpties#canCall| _module._default.Lemma_FlattenAppend1$T |s#0@@1| |M#0@@16|)) (=> (and (and ($IsAlloc DatatypeTypeType |s#0@@1| (Tclass._module.Stream _module._default.Lemma_FlattenAppend1$T) $Heap@0) (= |##prefix#1@0| (Lit DatatypeTypeType |#_module.Stream.Nil|))) (and ($IsAlloc DatatypeTypeType |##prefix#1@0| (Tclass._module.Stream _module._default.Lemma_FlattenAppend1$T) $Heap@0) ($IsAlloc DatatypeTypeType |M#0@@16| (Tclass._module.Stream (Tclass._module.Stream _module._default.Lemma_FlattenAppend1$T)) $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.__default.StreamOfNonEmpties#canCall| _module._default.Lemma_FlattenAppend1$T |M#0@@16|) (or (_module.__default.StreamOfNonEmpties _module._default.Lemma_FlattenAppend1$T ($LS $LZ) |M#0@@16|) (=> (_module.Stream.Nil_q |M#0@@16|) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.__default.StreamOfNonEmpties#canCall| _module._default.Lemma_FlattenAppend1$T |M#0@@16|) (or (_module.__default.StreamOfNonEmpties _module._default.Lemma_FlattenAppend1$T ($LS $LZ) |M#0@@16|) (=> (not (_module.Stream.Nil_q |M#0@@16|)) (let ((|s#3@@0| ($Unbox DatatypeTypeType (_module.Stream.head |M#0@@16|))))
(_module.Stream.Cons_q |s#3@@0|)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.__default.StreamOfNonEmpties#canCall| _module._default.Lemma_FlattenAppend1$T |M#0@@16|) (or (_module.__default.StreamOfNonEmpties _module._default.Lemma_FlattenAppend1$T ($LS $LZ) |M#0@@16|) (=> (not (_module.Stream.Nil_q |M#0@@16|)) (let ((|N#2@@0| (_module.Stream.tail |M#0@@16|)))
(_module.__default.StreamOfNonEmpties _module._default.Lemma_FlattenAppend1$T ($LS ($LS $LZ)) |N#2@@0|)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and ($Is DatatypeTypeType |s#0@@1| (Tclass._module.Stream _module._default.Lemma_FlattenAppend1$T)) ($IsAlloc DatatypeTypeType |s#0@@1| (Tclass._module.Stream _module._default.Lemma_FlattenAppend1$T) $Heap@@1)) (|$IsA#_module.Stream| |s#0@@1|)) (=> (and (and (and ($Is DatatypeTypeType |M#0@@16| (Tclass._module.Stream (Tclass._module.Stream _module._default.Lemma_FlattenAppend1$T))) ($IsAlloc DatatypeTypeType |M#0@@16| (Tclass._module.Stream (Tclass._module.Stream _module._default.Lemma_FlattenAppend1$T)) $Heap@@1)) (|$IsA#_module.Stream| |M#0@@16|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 8) 2))) anon0_correct)))))
