...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon8_Else_correct  (=> (and (and (or (not (= |n#0@@5| (LitInt 0))) (not true)) (_module.Stream.Cons_q |s#0@@5|)) (and (= |##s#0@0| (_module.Stream.tail |s#0@@5|)) ($IsAlloc DatatypeTypeType |##s#0@0| (Tclass._module.Stream _module._default.Tail$_T0@@5) $Heap@@0))) (and (=> (= (ControlFlow 0 4) (- 0 6)) ($Is intType (int_2_U (- |n#0@@5| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0@@5| 1)) Tclass._System.nat) (=> (and (= |##n#0@0| (- |n#0@@5| 1)) ($IsAlloc intType (int_2_U |##n#0@0|) Tclass._System.nat $Heap@@0)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (<= 0 |n#0@@5|) (= |##n#0@0| |n#0@@5|))) (=> (or (<= 0 |n#0@@5|) (= |##n#0@0| |n#0@@5|)) (=> (= (ControlFlow 0 4) (- 0 3)) (< |##n#0@0| |n#0@@5|))))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is DatatypeTypeType |s#0@@5| (Tclass._module.Stream _module._default.Tail$_T0@@5)) (<= (LitInt 0) |n#0@@5|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
