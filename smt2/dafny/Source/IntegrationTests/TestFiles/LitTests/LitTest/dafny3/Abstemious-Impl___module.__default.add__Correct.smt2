...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.nth$T@@1 T@U) ($ly@@1 T@U) (|n#0@@1| Int) (|s#0@@1| T@U) ) (!  (=> (or (|_module.__default.nth#canCall| _module._default.nth$T@@1 |n#0@@1| |s#0@@1|) (and (< 1 $FunctionContextHeight) (and (<= (LitInt 0) |n#0@@1|) ($Is DatatypeTypeType |s#0@@1| (Tclass._module.Stream _module._default.nth$T@@1))))) ($IsBox (_module.__default.nth _module._default.nth$T@@1 $ly@@1 |n#0@@1| |s#0@@1|) _module._default.nth$T@@1))
 :qid |unknown.0:0|
 :skolemid |726|
 :pattern ( (_module.__default.nth _module._default.nth$T@@1 $ly@@1 |n#0@@1| |s#0@@1|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.nth$T@@2 T@U) ($ly@@2 T@U) (|n#0@@2| Int) (|s#0@@2| T@U) ) (!  (=> (and (or (|_module.__default.nth#canCall| _module._default.nth$T@@2 |n#0@@2| |s#0@@2|) (and (< 1 $FunctionContextHeight) (and (<= (LitInt 0) |n#0@@2|) (and ($Is DatatypeTypeType |s#0@@2| (Tclass._module.Stream _module._default.nth$T@@2)) ($IsAlloc DatatypeTypeType |s#0@@2| (Tclass._module.Stream _module._default.nth$T@@2) $Heap))))) ($IsGoodHeap $Heap)) ($IsAllocBox (_module.__default.nth _module._default.nth$T@@2 $ly@@2 |n#0@@2| |s#0@@2|) _module._default.nth$T@@2 $Heap))
 :qid |Abstemiousdfy.126:16|
 :skolemid |727|
 :pattern ( ($IsAllocBox (_module.__default.nth _module._default.nth$T@@2 $ly@@2 |n#0@@2| |s#0@@2|) _module._default.nth$T@@2 $Heap))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@3 T@U) (|a#0| T@U) (|b#0| T@U) ) (!  (=> (or (|_module.__default.add#canCall| |a#0| |b#0|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |a#0| (Tclass._module.Stream TInt)) ($Is DatatypeTypeType |b#0| (Tclass._module.Stream TInt))))) (and (and (and (_module.Stream.Cons_q |a#0|) (_module.Stream.Cons_q |b#0|)) (and (and (_module.Stream.Cons_q |a#0|) (_module.Stream.Cons_q |b#0|)) (|_module.__default.add#canCall| (_module.Stream.tail |a#0|) (_module.Stream.tail |b#0|)))) (= (_module.__default.add ($LS $ly@@3) |a#0| |b#0|) (|#_module.Stream.Cons| ($Box intType (int_2_U (+ (U_2_int ($Unbox intType (_module.Stream.head |a#0|))) (U_2_int ($Unbox intType (_module.Stream.head |b#0|)))))) (_module.__default.add $ly@@3 (_module.Stream.tail |a#0|) (_module.Stream.tail |b#0|))))))
 :qid |Abstemiousdfy.93:24|
 :skolemid |687|
 :pattern ( (_module.__default.add ($LS $ly@@3) |a#0| |b#0|))
))))
...
(assert (forall (($ly@@4 T@U) (|a#0@@0| T@U) (|b#0@@0| T@U) ) (! (= (_module.__default.add ($LS $ly@@4) |a#0@@0| |b#0@@0|) (_module.__default.add $ly@@4 |a#0@@0| |b#0@@0|))
 :qid |Abstemiousdfy.93:24|
 :skolemid |683|
 :pattern ( (_module.__default.add ($LS $ly@@4) |a#0@@0| |b#0@@0|))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.nth$T@@3 T@U) ($ly@@5 T@U) (|n#0@@3| Int) (|s#0@@3| T@U) ) (!  (=> (or (|_module.__default.nth#canCall| _module._default.nth$T@@3 (LitInt |n#0@@3|) (Lit DatatypeTypeType |s#0@@3|)) (and (< 1 $FunctionContextHeight) (and (<= (LitInt 0) |n#0@@3|) ($Is DatatypeTypeType |s#0@@3| (Tclass._module.Stream _module._default.nth$T@@3))))) (and (and (=> (= (LitInt |n#0@@3|) (LitInt 0)) (_module.Stream.Cons_q (Lit DatatypeTypeType |s#0@@3|))) (=> (or (not (= (LitInt |n#0@@3|) (LitInt 0))) (not true)) (and (_module.Stream.Cons_q (Lit DatatypeTypeType |s#0@@3|)) (|_module.__default.nth#canCall| _module._default.nth$T@@3 (LitInt (- |n#0@@3| 1)) (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |s#0@@3|))))))) (= (_module.__default.nth _module._default.nth$T@@3 ($LS $ly@@5) (LitInt |n#0@@3|) (Lit DatatypeTypeType |s#0@@3|)) (ite (= (LitInt |n#0@@3|) (LitInt 0)) (_module.Stream.head (Lit DatatypeTypeType |s#0@@3|)) (_module.__default.nth _module._default.nth$T@@3 ($LS $ly@@5) (LitInt (- |n#0@@3| 1)) (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |s#0@@3|))))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |731|
 :pattern ( (_module.__default.nth _module._default.nth$T@@3 ($LS $ly@@5) (LitInt |n#0@@3|) (Lit DatatypeTypeType |s#0@@3|)))
))))
...
(assert (forall ((_module._default.nth$T@@4 T@U) ($ly@@6 T@U) (|n#0@@4| Int) (|s#0@@4| T@U) ) (! (= (_module.__default.nth _module._default.nth$T@@4 ($LS $ly@@6) |n#0@@4| |s#0@@4|) (_module.__default.nth _module._default.nth$T@@4 $ly@@6 |n#0@@4| |s#0@@4|))
 :qid |unknown.0:0|
 :skolemid |724|
 :pattern ( (_module.__default.nth _module._default.nth$T@@4 ($LS $ly@@6) |n#0@@4| |s#0@@4|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@7 T@U) (|a#0@@1| T@U) (|b#0@@1| T@U) ) (!  (=> (or (|_module.__default.add#canCall| |a#0@@1| |b#0@@1|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |a#0@@1| (Tclass._module.Stream TInt)) ($Is DatatypeTypeType |b#0@@1| (Tclass._module.Stream TInt))))) ($Is DatatypeTypeType (_module.__default.add $ly@@7 |a#0@@1| |b#0@@1|) (Tclass._module.Stream TInt)))
 :qid |Abstemiousdfy.93:24|
 :skolemid |685|
 :pattern ( (_module.__default.add $ly@@7 |a#0@@1| |b#0@@1|))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.add__Correct)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and (|$IsA#_module.Stream| |a#0@@2|) (|$IsA#_module.Stream| |b#0@@2|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@0 $Heap@0)) (and (forall ((|$ih#n0#0| Int) (|$ih#a0#0| T@U) (|$ih#b0#0| T@U) ) (!  (=> (and (and (and (and (<= (LitInt 0) |$ih#n0#0|) ($Is DatatypeTypeType |$ih#a0#0| (Tclass._module.Stream TInt))) ($Is DatatypeTypeType |$ih#b0#0| (Tclass._module.Stream TInt))) (U_2_bool (Lit boolType (bool_2_U true)))) (and (<= 0 |$ih#n0#0|) (< |$ih#n0#0| |n#0@@5|))) (= (U_2_int ($Unbox intType (_module.__default.nth TInt ($LS $LZ) |$ih#n0#0| (_module.__default.add ($LS $LZ) |$ih#a0#0| |$ih#b0#0|)))) (+ (U_2_int ($Unbox intType (_module.__default.nth TInt ($LS $LZ) |$ih#n0#0| |$ih#a0#0|))) (U_2_int ($Unbox intType (_module.__default.nth TInt ($LS $LZ) |$ih#n0#0| |$ih#b0#0|))))))
 :qid |Abstemiousdfy.171:19|
 :skolemid |751|
 :pattern ( ($Unbox intType (_module.__default.nth TInt ($LS $LZ) |$ih#n0#0| (_module.__default.add ($LS $LZ) |$ih#a0#0| |$ih#b0#0|))))
)) (= (ControlFlow 0 2) (- 0 1)))) (= (U_2_int ($Unbox intType (_module.__default.nth TInt ($LS ($LS $LZ)) |n#0@@5| (_module.__default.add ($LS ($LS $LZ)) |a#0@@2| |b#0@@2|)))) (+ (U_2_int ($Unbox intType (_module.__default.nth TInt ($LS ($LS $LZ)) |n#0@@5| |a#0@@2|))) (U_2_int ($Unbox intType (_module.__default.nth TInt ($LS ($LS $LZ)) |n#0@@5| |b#0@@2|))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (<= (LitInt 0) |n#0@@5|)) (and (and ($Is DatatypeTypeType |a#0@@2| (Tclass._module.Stream TInt)) ($IsAlloc DatatypeTypeType |a#0@@2| (Tclass._module.Stream TInt) $Heap@@0)) (|$IsA#_module.Stream| |a#0@@2|))) (and (and (and ($Is DatatypeTypeType |b#0@@2| (Tclass._module.Stream TInt)) ($IsAlloc DatatypeTypeType |b#0@@2| (Tclass._module.Stream TInt) $Heap@@0)) (|$IsA#_module.Stream| |b#0@@2|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
