...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@1| T@U) ) (!  (=> (or (|_module.__default.f#canCall| |x#0@@1|) (and (< 0 $FunctionContextHeight) ($IsBox |x#0@@1| Tclass._module.X))) ($IsBox (_module.__default.f |x#0@@1|) Tclass._module.X))
 :qid |Streamsdfy.19:18|
 :skolemid |591|
 :pattern ( (_module.__default.f |x#0@@1|))
))))
...
(let ((|x#0@@2| (_module.Stream.head |M#0@@2|)))
(|#_module.Stream.Cons| (_module.__default.f |x#0@@2|) (_module.__default.map__f $ly@@2 |N#0@@1|))))))))
 :qid |Streamsdfy.22:16|
 :skolemid |599|
...
(declare-fun $Heap@@0 () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.Theorem1__Ind)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#FromNat| |k#0|) ($LS ($LS $LZ)) (_module.__default.map__f ($LS $LZ) (_module.__default.append Tclass._module.X ($LS $LZ) |M#0@@6| |N#0@@4|)) (_module.__default.append Tclass._module.X ($LS $LZ) (_module.__default.map__f ($LS $LZ) |M#0@@6|) (_module.__default.map__f ($LS $LZ) |N#0@@4|))) (=> (< 0 |k#0|) (=> (_module.Stream.Nil_q (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#0@@6| |N#0@@4|))) (_module.Stream.Nil_q (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) (_module.__default.map__f ($LS ($LS $LZ)) |M#0@@6|) (_module.__default.map__f ($LS ($LS $LZ)) |N#0@@4|))))))) (=> (or (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#FromNat| |k#0|) ($LS ($LS $LZ)) (_module.__default.map__f ($LS $LZ) (_module.__default.append Tclass._module.X ($LS $LZ) |M#0@@6| |N#0@@4|)) (_module.__default.append Tclass._module.X ($LS $LZ) (_module.__default.map__f ($LS $LZ) |M#0@@6|) (_module.__default.map__f ($LS $LZ) |N#0@@4|))) (=> (< 0 |k#0|) (=> (_module.Stream.Nil_q (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#0@@6| |N#0@@4|))) (_module.Stream.Nil_q (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) (_module.__default.map__f ($LS ($LS $LZ)) |M#0@@6|) (_module.__default.map__f ($LS ($LS $LZ)) |N#0@@4|)))))) (=> (= (ControlFlow 0 3) (- 0 2)) (or (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#FromNat| |k#0|) ($LS ($LS $LZ)) (_module.__default.map__f ($LS $LZ) (_module.__default.append Tclass._module.X ($LS $LZ) |M#0@@6| |N#0@@4|)) (_module.__default.append Tclass._module.X ($LS $LZ) (_module.__default.map__f ($LS $LZ) |M#0@@6|) (_module.__default.map__f ($LS $LZ) |N#0@@4|))) (=> (< 0 |k#0|) (=> (_module.Stream.Cons_q (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#0@@6| |N#0@@4|))) (and (_module.Stream.Cons_q (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) (_module.__default.map__f ($LS ($LS $LZ)) |M#0@@6|) (_module.__default.map__f ($LS ($LS $LZ)) |N#0@@4|))) (and (= (_module.Stream.head (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#0@@6| |N#0@@4|))) (_module.Stream.head (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) (_module.__default.map__f ($LS ($LS $LZ)) |M#0@@6|) (_module.__default.map__f ($LS ($LS $LZ)) |N#0@@4|)))) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#FromNat| (- |k#0| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) |M#0@@6| |N#0@@4|))) (_module.Stream.tail (_module.__default.append Tclass._module.X ($LS ($LS $LZ)) (_module.__default.map__f ($LS ($LS $LZ)) |M#0@@6|) (_module.__default.map__f ($LS ($LS $LZ)) |N#0@@4|))))))))))))))
(let ((anon8_Else_correct  (=> (and (= |k#0| 0) (= (ControlFlow 0 10) 3)) GeneratedUnifiedExit_correct)))
(let ((anon8_Then_correct  (=> (or (not (= |k#0| 0)) (not true)) (and (=> (= (ControlFlow 0 6) (- 0 9)) ($Is intType (int_2_U (- |k#0| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |k#0| 1)) Tclass._System.nat) (=> (= |k##0_0_0@0| (- |k#0| 1)) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (<= 0 |k#0|) (= |k##0_0_0@0| |k#0|))) (=> (or (<= 0 |k#0|) (= |k##0_0_0@0| |k#0|)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (< |k##0_0_0@0| |k#0|)) (=> (< |k##0_0_0@0| |k#0|) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and (and (|_module.__default.append#canCall| Tclass._module.X |M'#0_0@0| |N#0@@4|) (|_module.__default.map__f#canCall| (_module.__default.append Tclass._module.X ($LS $LZ) |M'#0_0@0| |N#0@@4|))) (and (and (|_module.__default.map__f#canCall| |M'#0_0@0|) (|_module.__default.map__f#canCall| |N#0@@4|)) (|_module.__default.append#canCall| Tclass._module.X (_module.__default.map__f ($LS $LZ) |M'#0_0@0|) (_module.__default.map__f ($LS $LZ) |N#0@@4|)))) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#FromNat| |k##0_0_0@0|) ($LS ($LS $LZ)) (_module.__default.map__f ($LS $LZ) (_module.__default.append Tclass._module.X ($LS $LZ) |M'#0_0@0| |N#0@@4|)) (_module.__default.append Tclass._module.X ($LS $LZ) (_module.__default.map__f ($LS $LZ) |M'#0_0@0|) (_module.__default.map__f ($LS $LZ) |N#0@@4|)))) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 6) 3))) GeneratedUnifiedExit_correct))))))))))))
(let ((anon7_Then_correct  (=> (= |M#0@@6| (|#_module.Stream.Cons| |_mcc#0#0_0@0| |_mcc#1#0_0@0|)) (=> (and ($IsBox |_mcc#0#0_0@0| Tclass._module.X) ($Is DatatypeTypeType |_mcc#1#0_0@0| (Tclass._module.Stream Tclass._module.X))) (=> (and (and (and (and ($Is DatatypeTypeType |M'#0_0@0| (Tclass._module.Stream Tclass._module.X)) ($IsAlloc DatatypeTypeType |M'#0_0@0| (Tclass._module.Stream Tclass._module.X) $Heap@0)) (= |let#0_0#0#0| |_mcc#1#0_0@0|)) (and ($Is DatatypeTypeType |let#0_0#0#0| (Tclass._module.Stream Tclass._module.X)) (= |M'#0_0@0| |let#0_0#0#0|))) (and (and (and ($IsBox |x#0_0@0| Tclass._module.X) ($IsAllocBox |x#0_0@0| Tclass._module.X $Heap@0)) (= |let#0_1#0#0| |_mcc#0#0_0@0|)) (and ($IsBox |let#0_1#0#0| Tclass._module.X) (= |x#0_0@0| |let#0_1#0#0|)))) (and (=> (= (ControlFlow 0 11) 6) anon8_Then_correct) (=> (= (ControlFlow 0 11) 10) anon8_Else_correct)))))))
(let ((anon6_Then_correct  (=> (and (= |M#0@@6| |#_module.Stream.Nil|) (= (ControlFlow 0 5) 3)) GeneratedUnifiedExit_correct)))
(let ((anon7_Else_correct true))
(let ((anon6_Else_correct  (=> (or (not (= |M#0@@6| |#_module.Stream.Nil|)) (not true)) (and (=> (= (ControlFlow 0 12) 11) anon7_Then_correct) (=> (= (ControlFlow 0 12) 1) anon7_Else_correct)))))
