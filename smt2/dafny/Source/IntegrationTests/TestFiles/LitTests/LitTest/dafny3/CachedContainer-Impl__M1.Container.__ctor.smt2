...
(assert (forall ((M1.Container$T@@13 T@U) ($h@@6 T@U) ($o@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (or (not (= $o@@9 null)) (not true)) (= (dtype $o@@9) (Tclass.M1.Container? M1.Container$T@@13)))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@9) M1.Container.Contents)) (TSet M1.Container$T@@13)))
 :qid |unknown.0:0|
 :skolemid |1050|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@9) M1.Container.Contents)) (Tclass.M1.Container? M1.Container$T@@13))
)))
...
(set-info :boogie-vc-id Impl$$M1.Container.__ctor)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (= this.Contents@0 (Lit SetType |Set#Empty|)) (= this.Repr@0 (|Set#UnionOne| |Set#Empty| ($Box refType this@@3)))) (=> (and (and (or (not (= this@@3 null)) (not true)) ($Is refType this@@3 (Tclass.M1.Container? M1.Container$T@@17))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) alloc)))) (= ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) M1.Container.Contents)) this.Contents@0))) (=> (and (and (and (= ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) M1.Container.Repr)) this.Repr@0) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and ($IsAllocBox ($Box refType this@@3) (Tclass.M1.Container? M1.Container$T@@17) $Heap@0) (|M1.Container.Valid_k#canCall| M1.Container$T@@17 $Heap@0 this@@3)) (and (|M1.Container.Valid_k#canCall| M1.Container$T@@17 $Heap@0 this@@3) (M1.Container.Valid_k M1.Container$T@@17 $Heap@0 this@@3)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|M1.Container.Valid#canCall| M1.Container$T@@17 $Heap@0 this@@3) (or (M1.Container.Valid M1.Container$T@@17 $Heap@0 this@@3) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) M1.Container.Repr)) ($Box refType this@@3))))) (=> (=> (|M1.Container.Valid#canCall| M1.Container$T@@17 $Heap@0 this@@3) (or (M1.Container.Valid M1.Container$T@@17 $Heap@0 this@@3) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) M1.Container.Repr)) ($Box refType this@@3)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|M1.Container.Valid#canCall| M1.Container$T@@17 $Heap@0 this@@3) (or (M1.Container.Valid M1.Container$T@@17 $Heap@0 this@@3) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) M1.Container.Repr)) ($Box refType null)))))) (=> (=> (|M1.Container.Valid#canCall| M1.Container$T@@17 $Heap@0 this@@3) (or (M1.Container.Valid M1.Container$T@@17 $Heap@0 this@@3) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) M1.Container.Repr)) ($Box refType null))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|M1.Container.Valid#canCall| M1.Container$T@@17 $Heap@0 this@@3) (or (M1.Container.Valid M1.Container$T@@17 $Heap@0 this@@3) (M1.Container.Valid_k M1.Container$T@@17 $Heap@0 this@@3)))) (=> (=> (|M1.Container.Valid#canCall| M1.Container$T@@17 $Heap@0 this@@3) (or (M1.Container.Valid M1.Container$T@@17 $Heap@0 this@@3) (M1.Container.Valid_k M1.Container$T@@17 $Heap@0 this@@3))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (forall (($o@@10 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) M1.Container.Repr)) ($Box refType $o@@10)) (or (not (= $o@@10 null)) (not true)))
 :qid |CachedContainerdfy.40:5|
 :skolemid |1020|
 :pattern (  (or (not (= $o@@10 null)) (not true)))
)) (forall (($o@@11 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) M1.Container.Repr)) ($Box refType $o@@11)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@11) alloc)))))
 :qid |CachedContainerdfy.40:5|
 :skolemid |1021|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) M1.Container.Repr)) ($Box refType $o@@11)))
)))) (=> (and (forall (($o@@12 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) M1.Container.Repr)) ($Box refType $o@@12)) (or (not (= $o@@12 null)) (not true)))
 :qid |CachedContainerdfy.40:5|
 :skolemid |1020|
 :pattern (  (or (not (= $o@@12 null)) (not true)))
)) (forall (($o@@13 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) M1.Container.Repr)) ($Box refType $o@@13)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@13) alloc)))))
 :qid |CachedContainerdfy.40:5|
 :skolemid |1021|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) M1.Container.Repr)) ($Box refType $o@@13)))
))) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) M1.Container.Contents)) |Set#Empty|))))))))))))))))
