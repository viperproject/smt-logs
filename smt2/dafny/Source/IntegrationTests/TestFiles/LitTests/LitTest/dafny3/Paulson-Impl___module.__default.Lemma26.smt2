...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((_module._default.LmapIter$_T0 T@U) ($ly T@U) (|n#0| Int) (|f#0| T@U) (|arg#0| T@U) ) (!  (=> (or (|_module.__default.LmapIter#canCall| _module._default.LmapIter$_T0 (LitInt |n#0|) (Lit DatatypeTypeType |f#0|) (Lit DatatypeTypeType |arg#0|)) (and (< 3 $FunctionContextHeight) (and (and (<= (LitInt 0) |n#0|) ($Is DatatypeTypeType |f#0| (Tclass._module.FunctionHandle _module._default.LmapIter$_T0))) ($Is DatatypeTypeType |arg#0| (Tclass._module.LList _module._default.LmapIter$_T0))))) (and (=> (or (not (= (LitInt |n#0|) (LitInt 0))) (not true)) (and (|_module.__default.LmapIter#canCall| _module._default.LmapIter$_T0 (LitInt (- |n#0| 1)) (Lit DatatypeTypeType |f#0|) (Lit DatatypeTypeType |arg#0|)) (|_module.__default.Lmap#canCall| _module._default.LmapIter$_T0 (Lit DatatypeTypeType |f#0|) (Lit DatatypeTypeType (_module.__default.LmapIter _module._default.LmapIter$_T0 ($LS $ly) (LitInt (- |n#0| 1)) (Lit DatatypeTypeType |f#0|) (Lit DatatypeTypeType |arg#0|)))))) (= (_module.__default.LmapIter _module._default.LmapIter$_T0 ($LS $ly) (LitInt |n#0|) (Lit DatatypeTypeType |f#0|) (Lit DatatypeTypeType |arg#0|)) (ite (= (LitInt |n#0|) (LitInt 0)) |arg#0| (_module.__default.Lmap _module._default.LmapIter$_T0 ($LS $LZ) (Lit DatatypeTypeType |f#0|) (Lit DatatypeTypeType (_module.__default.LmapIter _module._default.LmapIter$_T0 ($LS $ly) (LitInt (- |n#0| 1)) (Lit DatatypeTypeType |f#0|) (Lit DatatypeTypeType |arg#0|))))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |644|
 :pattern ( (_module.__default.LmapIter _module._default.LmapIter$_T0 ($LS $ly) (LitInt |n#0|) (Lit DatatypeTypeType |f#0|) (Lit DatatypeTypeType |arg#0|)))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.LmapIter$_T0@@0 T@U) ($ly@@0 T@U) (|n#0@@0| Int) (|f#0@@0| T@U) (|arg#0@@0| T@U) ) (!  (=> (and (or (|_module.__default.LmapIter#canCall| _module._default.LmapIter$_T0@@0 |n#0@@0| |f#0@@0| |arg#0@@0|) (and (< 3 $FunctionContextHeight) (and (and (<= (LitInt 0) |n#0@@0|) (and ($Is DatatypeTypeType |f#0@@0| (Tclass._module.FunctionHandle _module._default.LmapIter$_T0@@0)) ($IsAlloc DatatypeTypeType |f#0@@0| (Tclass._module.FunctionHandle _module._default.LmapIter$_T0@@0) $Heap))) (and ($Is DatatypeTypeType |arg#0@@0| (Tclass._module.LList _module._default.LmapIter$_T0@@0)) ($IsAlloc DatatypeTypeType |arg#0@@0| (Tclass._module.LList _module._default.LmapIter$_T0@@0) $Heap))))) ($IsGoodHeap $Heap)) ($IsAlloc DatatypeTypeType (_module.__default.LmapIter _module._default.LmapIter$_T0@@0 $ly@@0 |n#0@@0| |f#0@@0| |arg#0@@0|) (Tclass._module.LList _module._default.LmapIter$_T0@@0) $Heap))
 :qid |Paulsondfy.108:16|
 :skolemid |640|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.__default.LmapIter _module._default.LmapIter$_T0@@0 $ly@@0 |n#0@@0| |f#0@@0| |arg#0@@0|) (Tclass._module.LList _module._default.LmapIter$_T0@@0) $Heap))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((_module._default.LmapIter$_T0@@1 T@U) ($ly@@1 T@U) (|n#0@@1| Int) (|f#0@@1| T@U) (|arg#0@@1| T@U) ) (!  (=> (or (|_module.__default.LmapIter#canCall| _module._default.LmapIter$_T0@@1 |n#0@@1| |f#0@@1| |arg#0@@1|) (and (< 3 $FunctionContextHeight) (and (and (<= (LitInt 0) |n#0@@1|) ($Is DatatypeTypeType |f#0@@1| (Tclass._module.FunctionHandle _module._default.LmapIter$_T0@@1))) ($Is DatatypeTypeType |arg#0@@1| (Tclass._module.LList _module._default.LmapIter$_T0@@1))))) (and (=> (or (not (= |n#0@@1| (LitInt 0))) (not true)) (and (|_module.__default.LmapIter#canCall| _module._default.LmapIter$_T0@@1 (- |n#0@@1| 1) |f#0@@1| |arg#0@@1|) (|_module.__default.Lmap#canCall| _module._default.LmapIter$_T0@@1 |f#0@@1| (_module.__default.LmapIter _module._default.LmapIter$_T0@@1 $ly@@1 (- |n#0@@1| 1) |f#0@@1| |arg#0@@1|)))) (= (_module.__default.LmapIter _module._default.LmapIter$_T0@@1 ($LS $ly@@1) |n#0@@1| |f#0@@1| |arg#0@@1|) (ite (= |n#0@@1| (LitInt 0)) |arg#0@@1| (_module.__default.Lmap _module._default.LmapIter$_T0@@1 ($LS $LZ) |f#0@@1| (_module.__default.LmapIter _module._default.LmapIter$_T0@@1 $ly@@1 (- |n#0@@1| 1) |f#0@@1| |arg#0@@1|))))))
 :qid |unknown.0:0|
 :skolemid |642|
 :pattern ( (_module.__default.LmapIter _module._default.LmapIter$_T0@@1 ($LS $ly@@1) |n#0@@1| |f#0@@1| |arg#0@@1|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((_module._default.LmapIter$_T0@@2 T@U) ($ly@@2 T@U) (|n#0@@2| Int) (|f#0@@2| T@U) (|arg#0@@2| T@U) ) (!  (=> (or (|_module.__default.LmapIter#canCall| _module._default.LmapIter$_T0@@2 |n#0@@2| |f#0@@2| |arg#0@@2|) (and (< 3 $FunctionContextHeight) (and (and (<= (LitInt 0) |n#0@@2|) ($Is DatatypeTypeType |f#0@@2| (Tclass._module.FunctionHandle _module._default.LmapIter$_T0@@2))) ($Is DatatypeTypeType |arg#0@@2| (Tclass._module.LList _module._default.LmapIter$_T0@@2))))) ($Is DatatypeTypeType (_module.__default.LmapIter _module._default.LmapIter$_T0@@2 $ly@@2 |n#0@@2| |f#0@@2| |arg#0@@2|) (Tclass._module.LList _module._default.LmapIter$_T0@@2)))
 :qid |unknown.0:0|
 :skolemid |639|
 :pattern ( (_module.__default.LmapIter _module._default.LmapIter$_T0@@2 $ly@@2 |n#0@@2| |f#0@@2| |arg#0@@2|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.Apply$T T@U) (|f#0@@3| T@U) (|argument#0| T@U) ) (!  (=> (or (|_module.__default.Apply#canCall| _module._default.Apply$T |f#0@@3| |argument#0|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |f#0@@3| (Tclass._module.FunctionHandle _module._default.Apply$T)) ($IsBox |argument#0| _module._default.Apply$T)))) ($IsBox (_module.__default.Apply _module._default.Apply$T |f#0@@3| |argument#0|) _module._default.Apply$T))
 :qid |unknown.0:0|
 :skolemid |584|
 :pattern ( (_module.__default.Apply _module._default.Apply$T |f#0@@3| |argument#0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) (_module._default.Apply$T@@0 T@U) (|f#0@@4| T@U) (|argument#0@@0| T@U) ) (!  (=> (and (or (|_module.__default.Apply#canCall| _module._default.Apply$T@@0 |f#0@@4| |argument#0@@0|) (and (< 1 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |f#0@@4| (Tclass._module.FunctionHandle _module._default.Apply$T@@0)) ($IsAlloc DatatypeTypeType |f#0@@4| (Tclass._module.FunctionHandle _module._default.Apply$T@@0) $Heap@@0)) (and ($IsBox |argument#0@@0| _module._default.Apply$T@@0) ($IsAllocBox |argument#0@@0| _module._default.Apply$T@@0 $Heap@@0))))) ($IsGoodHeap $Heap@@0)) ($IsAllocBox (_module.__default.Apply _module._default.Apply$T@@0 |f#0@@4| |argument#0@@0|) _module._default.Apply$T@@0 $Heap@@0))
 :qid |Paulsondfy.12:16|
 :skolemid |585|
 :pattern ( ($IsAllocBox (_module.__default.Apply _module._default.Apply$T@@0 |f#0@@4| |argument#0@@0|) _module._default.Apply$T@@0 $Heap@@0))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((_module._default.Lmap$_T0 T@U) ($ly@@3 T@U) (|f#0@@5| T@U) (|a#0| T@U) ) (!  (=> (or (|_module.__default.Lmap#canCall| _module._default.Lmap$_T0 |f#0@@5| |a#0|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |f#0@@5| (Tclass._module.FunctionHandle _module._default.Lmap$_T0)) ($Is DatatypeTypeType |a#0| (Tclass._module.LList _module._default.Lmap$_T0))))) ($Is DatatypeTypeType (_module.__default.Lmap _module._default.Lmap$_T0 $ly@@3 |f#0@@5| |a#0|) (Tclass._module.LList _module._default.Lmap$_T0)))
 :qid |unknown.0:0|
 :skolemid |595|
 :pattern ( (_module.__default.Lmap _module._default.Lmap$_T0 $ly@@3 |f#0@@5| |a#0|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((_module._default.LmapIter$_T0@@3 T@U) ($ly@@4 T@U) (|n#0@@3| Int) (|f#0@@6| T@U) (|arg#0@@3| T@U) ) (!  (=> (or (|_module.__default.LmapIter#canCall| _module._default.LmapIter$_T0@@3 (LitInt |n#0@@3|) (Lit DatatypeTypeType |f#0@@6|) |arg#0@@3|) (and (< 3 $FunctionContextHeight) (and (and (<= (LitInt 0) |n#0@@3|) ($Is DatatypeTypeType |f#0@@6| (Tclass._module.FunctionHandle _module._default.LmapIter$_T0@@3))) ($Is DatatypeTypeType |arg#0@@3| (Tclass._module.LList _module._default.LmapIter$_T0@@3))))) (and (=> (or (not (= (LitInt |n#0@@3|) (LitInt 0))) (not true)) (and (|_module.__default.LmapIter#canCall| _module._default.LmapIter$_T0@@3 (LitInt (- |n#0@@3| 1)) (Lit DatatypeTypeType |f#0@@6|) |arg#0@@3|) (|_module.__default.Lmap#canCall| _module._default.LmapIter$_T0@@3 (Lit DatatypeTypeType |f#0@@6|) (_module.__default.LmapIter _module._default.LmapIter$_T0@@3 ($LS $ly@@4) (LitInt (- |n#0@@3| 1)) (Lit DatatypeTypeType |f#0@@6|) |arg#0@@3|)))) (= (_module.__default.LmapIter _module._default.LmapIter$_T0@@3 ($LS $ly@@4) (LitInt |n#0@@3|) (Lit DatatypeTypeType |f#0@@6|) |arg#0@@3|) (ite (= (LitInt |n#0@@3|) (LitInt 0)) |arg#0@@3| (_module.__default.Lmap _module._default.LmapIter$_T0@@3 ($LS $LZ) (Lit DatatypeTypeType |f#0@@6|) (_module.__default.LmapIter _module._default.LmapIter$_T0@@3 ($LS $ly@@4) (LitInt (- |n#0@@3| 1)) (Lit DatatypeTypeType |f#0@@6|) |arg#0@@3|))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |643|
 :pattern ( (_module.__default.LmapIter _module._default.LmapIter$_T0@@3 ($LS $ly@@4) (LitInt |n#0@@3|) (Lit DatatypeTypeType |f#0@@6|) |arg#0@@3|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((_module._default.Lmap$_T0@@0 T@U) ($ly@@5 T@U) (|f#0@@7| T@U) (|a#0@@0| T@U) ) (!  (=> (or (|_module.__default.Lmap#canCall| _module._default.Lmap$_T0@@0 |f#0@@7| |a#0@@0|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |f#0@@7| (Tclass._module.FunctionHandle _module._default.Lmap$_T0@@0)) ($Is DatatypeTypeType |a#0@@0| (Tclass._module.LList _module._default.Lmap$_T0@@0))))) (and (=> (not (_module.LList.Nil_q |a#0@@0|)) (let ((|xs#1| (_module.LList.tail |a#0@@0|)))
(let ((|x#1| (_module.LList.head |a#0@@0|)))
 (and (|_module.__default.Apply#canCall| _module._default.Lmap$_T0@@0 |f#0@@7| |x#1|) (|_module.__default.Lmap#canCall| _module._default.Lmap$_T0@@0 |f#0@@7| |xs#1|))))) (= (_module.__default.Lmap _module._default.Lmap$_T0@@0 ($LS $ly@@5) |f#0@@7| |a#0@@0|) (ite (_module.LList.Nil_q |a#0@@0|) |#_module.LList.Nil| (let ((|xs#0| (_module.LList.tail |a#0@@0|)))
(let ((|x#0| (_module.LList.head |a#0@@0|)))
(|#_module.LList.Cons| (_module.__default.Apply _module._default.Lmap$_T0@@0 |f#0@@7| |x#0|) (_module.__default.Lmap _module._default.Lmap$_T0@@0 $ly@@5 |f#0@@7| |xs#0|))))))))
 :qid |unknown.0:0|
 :skolemid |598|
 :pattern ( (_module.__default.Lmap _module._default.Lmap$_T0@@0 ($LS $ly@@5) |f#0@@7| |a#0@@0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@1 T@U) (_module._default.Lmap$_T0@@1 T@U) ($ly@@6 T@U) (|f#0@@8| T@U) (|a#0@@1| T@U) ) (!  (=> (and (or (|_module.__default.Lmap#canCall| _module._default.Lmap$_T0@@1 |f#0@@8| |a#0@@1|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |f#0@@8| (Tclass._module.FunctionHandle _module._default.Lmap$_T0@@1)) ($IsAlloc DatatypeTypeType |f#0@@8| (Tclass._module.FunctionHandle _module._default.Lmap$_T0@@1) $Heap@@1)) (and ($Is DatatypeTypeType |a#0@@1| (Tclass._module.LList _module._default.Lmap$_T0@@1)) ($IsAlloc DatatypeTypeType |a#0@@1| (Tclass._module.LList _module._default.Lmap$_T0@@1) $Heap@@1))))) ($IsGoodHeap $Heap@@1)) ($IsAlloc DatatypeTypeType (_module.__default.Lmap _module._default.Lmap$_T0@@1 $ly@@6 |f#0@@8| |a#0@@1|) (Tclass._module.LList _module._default.Lmap$_T0@@1) $Heap@@1))
 :qid |Paulsondfy.19:16|
 :skolemid |596|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.__default.Lmap _module._default.Lmap$_T0@@1 $ly@@6 |f#0@@8| |a#0@@1|) (Tclass._module.LList _module._default.Lmap$_T0@@1) $Heap@@1))
))))
...
(assert (forall ((_module._default.Lmap$_T0@@2 T@U) ($ly@@7 T@U) (|f#0@@9| T@U) (|a#0@@2| T@U) ) (! (= (_module.__default.Lmap _module._default.Lmap$_T0@@2 ($LS $ly@@7) |f#0@@9| |a#0@@2|) (_module.__default.Lmap _module._default.Lmap$_T0@@2 $ly@@7 |f#0@@9| |a#0@@2|))
 :qid |unknown.0:0|
 :skolemid |590|
 :pattern ( (_module.__default.Lmap _module._default.Lmap$_T0@@2 ($LS $ly@@7) |f#0@@9| |a#0@@2|))
)))
...
(assert (forall ((_module._default.LmapIter$_T0@@4 T@U) ($ly@@8 T@U) (|n#0@@4| Int) (|f#0@@10| T@U) (|arg#0@@4| T@U) ) (! (= (_module.__default.LmapIter _module._default.LmapIter$_T0@@4 ($LS $ly@@8) |n#0@@4| |f#0@@10| |arg#0@@4|) (_module.__default.LmapIter _module._default.LmapIter$_T0@@4 $ly@@8 |n#0@@4| |f#0@@10| |arg#0@@4|))
 :qid |unknown.0:0|
 :skolemid |637|
 :pattern ( (_module.__default.LmapIter _module._default.LmapIter$_T0@@4 ($LS $ly@@8) |n#0@@4| |f#0@@10| |arg#0@@4|))
)))
...
(declare-fun _module._default.Lemma26$A () T@U)
(declare-fun |n#0@@5| () Int)
(set-info :boogie-vc-id Impl$$_module.__default.Lemma26)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (=> (and (|$IsA#_module.FunctionHandle| |f#0@@11|) (|$IsA#_module.LList| |x#0@@0|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@2 $Heap@0)) (and (forall ((|$ih#n0#0| Int) (|$ih#f0#0| T@U) (|$ih#x0#0| T@U) ) (!  (=> (and (and (and (and (<= (LitInt 0) |$ih#n0#0|) ($Is DatatypeTypeType |$ih#f0#0| (Tclass._module.FunctionHandle _module._default.Lemma26$A))) ($Is DatatypeTypeType |$ih#x0#0| (Tclass._module.LList _module._default.Lemma26$A))) (U_2_bool (Lit boolType (bool_2_U true)))) (or (and (<= 0 |$ih#n0#0|) (< |$ih#n0#0| |n#0@@5|)) (and (= |$ih#n0#0| |n#0@@5|) (< (DtRank |$ih#f0#0|) (DtRank |f#0@@11|))))) (|$Eq#_module.LList| _module._default.Lemma26$A _module._default.Lemma26$A ($LS ($LS $LZ)) (_module.__default.LmapIter _module._default.Lemma26$A ($LS $LZ) |$ih#n0#0| |$ih#f0#0| (_module.__default.Lmap _module._default.Lemma26$A ($LS $LZ) |$ih#f0#0| |$ih#x0#0|)) (_module.__default.LmapIter _module._default.Lemma26$A ($LS $LZ) (+ |$ih#n0#0| 1) |$ih#f0#0| |$ih#x0#0|)))
 :qid |Paulsondfy.119:18|
 :skolemid |648|
 :pattern ( (_module.__default.LmapIter _module._default.Lemma26$A ($LS $LZ) |$ih#n0#0| |$ih#f0#0| (_module.__default.Lmap _module._default.Lemma26$A ($LS $LZ) |$ih#f0#0| |$ih#x0#0|)))
)) (= (ControlFlow 0 2) (- 0 1)))) (|$Eq#_module.LList| _module._default.Lemma26$A _module._default.Lemma26$A ($LS ($LS $LZ)) (_module.__default.LmapIter _module._default.Lemma26$A ($LS ($LS $LZ)) |n#0@@5| |f#0@@11| (_module.__default.Lmap _module._default.Lemma26$A ($LS ($LS $LZ)) |f#0@@11| |x#0@@0|)) (_module.__default.LmapIter _module._default.Lemma26$A ($LS ($LS $LZ)) (+ |n#0@@5| 1) |f#0@@11| |x#0@@0|)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (<= (LitInt 0) |n#0@@5|)) (and (and ($Is DatatypeTypeType |f#0@@11| (Tclass._module.FunctionHandle _module._default.Lemma26$A)) ($IsAlloc DatatypeTypeType |f#0@@11| (Tclass._module.FunctionHandle _module._default.Lemma26$A) $Heap@@2)) (|$IsA#_module.FunctionHandle| |f#0@@11|))) (and (and (and ($Is DatatypeTypeType |x#0@@0| (Tclass._module.LList _module._default.Lemma26$A)) ($IsAlloc DatatypeTypeType |x#0@@0| (Tclass._module.LList _module._default.Lemma26$A) $Heap@@2)) (|$IsA#_module.LList| |x#0@@0|)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
