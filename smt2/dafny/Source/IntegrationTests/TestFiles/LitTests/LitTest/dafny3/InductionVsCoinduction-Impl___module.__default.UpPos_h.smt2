...
(set-info :boogie-vc-id Impl$$_module.__default.UpPos_h)
...
(let ((anon3_Else_correct  (=> (<= (|ORD#Offset| |_k#0@@4|) 0) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap $Heap@1)) (and (forall ((|_k'#2@@1| T@U) (|n#2| Int) ) (!  (=> (and (|ORD#Less| |_k'#2@@1| |_k#0@@4|) (> |n#2| 0)) (_module.__default.Pos_h ($LS $LZ) |_k'#2@@1| (_module.__default.Up ($LS $LZ) |n#2|)))
 :qid |InductionVsCoinductiondfy.102:35|
 :skolemid |592|
 :pattern ( (_module.__default.Up ($LS $LZ) |n#2|) (|ORD#Less| |_k'#2@@1| |_k#0@@4|))
)) (= (ControlFlow 0 10) 2))) GeneratedUnifiedExit_correct))))
(let ((anon3_Then_correct  (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (and (=> (= (ControlFlow 0 6) (- 0 9)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@4|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@4|)) (=> (and (= |_k##0@0| (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1))) (= |n##0@0| (+ |n#1| 1))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (> |n##0@0| 0)) (=> (> |n##0@0| 0) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (|_module.__default.Up#canCall| |n##0@0|) (|_module.__default.Pos_h#canCall| |_k##0@0| (_module.__default.Up ($LS $LZ) |n##0@0|)))) (and (and (|_module.__default.Pos_h#canCall| |_k##0@0| (_module.__default.Up ($LS $LZ) |n##0@0|)) (and (_module.__default.Pos_h ($LS $LZ) |_k##0@0| (_module.__default.Up ($LS $LZ) |n##0@0|)) (and (=> (< 0 (|ORD#Offset| |_k##0@0|)) (ite (_module.Stream.SNil_q (_module.__default.Up ($LS $LZ) |n##0@0|)) true (let ((|rest#3@@0| (_module.Stream.tail (_module.__default.Up ($LS $LZ) |n##0@0|))))
(let ((|x#3@@0| (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Up ($LS $LZ) |n##0@0|))))))
 (and (> |x#3@@0| 0) (_module.__default.Pos_h ($LS $LZ) (|ORD#Minus| |_k##0@0| (|ORD#FromNat| 1)) |rest#3@@0|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k##0@0|)) (forall ((|_k'#0@@1| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@1| |_k##0@0|) (_module.__default.Pos_h ($LS $LZ) |_k'#0@@1| (_module.__default.Up ($LS $LZ) |n##0@0|)))
 :qid |InductionVsCoinductiondfy.38:20|
 :skolemid |587|
 :pattern ( (_module.__default.Pos_h ($LS $LZ) |_k'#0@@1| (_module.__default.Up ($LS $LZ) |n##0@0|)))
)))))) (and (= $Heap $Heap@0) (= (ControlFlow 0 6) 2)))) GeneratedUnifiedExit_correct)))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 11) 6) anon3_Then_correct) (=> (= (ControlFlow 0 11) 10) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 3 $FunctionContextHeight)) (and (> |n#1| 0) (= (ControlFlow 0 12) 11))) anon0_correct)))
