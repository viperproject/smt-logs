...
(let ((anon5_correct  (=> (forall ((|z#3| T@U) )  (=> ($IsBox |z#3| _module.Iter$T@@24) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@0) _module.Iter.xs)) |z#3|) (not (|Set#IsMember| |r#0@1| |z#3|))))) (and (=> (= (ControlFlow 0 25) 24) anon18_Then_correct) (=> (= (ControlFlow 0 25) 21) anon18_Else_correct)))))
