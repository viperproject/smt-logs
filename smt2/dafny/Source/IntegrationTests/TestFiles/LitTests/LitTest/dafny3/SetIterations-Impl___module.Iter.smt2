...
(assert (forall ((s0@@1 T@U) (s1@@1 T@U) (x@@8 T@U) ) (! (= (|Seq#Contains| (|Seq#Append| s0@@1 s1@@1) x@@8)  (or (|Seq#Contains| s0@@1 x@@8) (|Seq#Contains| s1@@1 x@@8)))
...
(assert (forall ((s@@9 T@U) (n@@5 Int) (x@@9 T@U) ) (! (= (|Seq#Contains| (|Seq#Take| s@@9 n@@5) x@@9) (exists ((i@@0 Int) ) (!  (and (and (and (<= 0 i@@0) (< i@@0 n@@5)) (< i@@0 (|Seq#Length| s@@9))) (= (|Seq#Index| s@@9 i@@0) x@@9))
 ...
 :skolemid |236|
 :pattern ( (|Seq#Contains| (|Seq#Take| s@@9 n@@5) x@@9))
)))
...
(assert (forall ((s@@10 T@U) (x@@10 T@U) ) (! (= (|Seq#Contains| s@@10 x@@10) (exists ((i@@1 Int) ) (!  (and (and (<= 0 i@@1) (< i@@1 (|Seq#Length| s@@10))) (= (|Seq#Index| s@@10 i@@1) x@@10))
 ...
 :skolemid |231|
 :pattern ( (|Seq#Contains| s@@10 x@@10))
)))
...
(assert (forall ((s@@14 T@U) (n@@7 Int) (x@@12 T@U) ) (! (= (|Seq#Contains| (|Seq#Drop| s@@14 n@@7) x@@12) (exists ((i@@3 Int) ) (!  (and (and (and (<= 0 n@@7) (<= n@@7 i@@3)) (< i@@3 (|Seq#Length| s@@14))) (= (|Seq#Index| s@@14 i@@3) x@@12))
 ...
 :skolemid |238|
 :pattern ( (|Seq#Contains| (|Seq#Drop| s@@14 n@@7) x@@12))
)))
...
(let ((anon19_Else_correct  (=> (and (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@0) _module.Iter.xs)) |z#4@0|)) (= (ControlFlow 0 23) 20)) anon8_correct)))
(let ((anon19_Then_correct  (=> (and (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@0) _module.Iter.xs)) |z#4@0|) (= (ControlFlow 0 22) 20)) anon8_correct)))
(let ((anon18_Then_correct  (=> (and ($IsBox |z#4@0| _module.Iter$T@@24) ($IsAllocBox |z#4@0| _module.Iter$T@@24 $Heap@1)) (and (=> (= (ControlFlow 0 24) 22) anon19_Then_correct) (=> (= (ControlFlow 0 24) 23) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (and (not (and ($IsBox |z#4@0| _module.Iter$T@@24) ($IsAllocBox |z#4@0| _module.Iter$T@@24 $Heap@1))) (= (ControlFlow 0 21) 20)) anon8_correct)))
(let ((anon5_correct  (=> (forall ((|z#3| T@U) ) (!  (=> ($IsBox |z#3| _module.Iter$T@@24) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@0) _module.Iter.xs)) |z#3|) (not (|Set#IsMember| |r#0@1| |z#3|))))
 :qid |SetIterationsdfy.51:22|
 :skolemid |552|
)) (and (=> (= (ControlFlow 0 25) 24) anon18_Then_correct) (=> (= (ControlFlow 0 25) 21) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@0) _module.Iter.xs)) |z#2@0|)) (= (ControlFlow 0 28) 25)) anon5_correct)))
(let ((anon17_Then_correct  (=> (and (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@0) _module.Iter.xs)) |z#2@0|) (= (ControlFlow 0 27) 25)) anon5_correct)))
(let ((anon16_Then_correct  (=> (and ($IsBox |z#2@0| _module.Iter$T@@24) ($IsAllocBox |z#2@0| _module.Iter$T@@24 $Heap@1)) (and (=> (= (ControlFlow 0 29) 27) anon17_Then_correct) (=> (= (ControlFlow 0 29) 28) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (and (not (and ($IsBox |z#2@0| _module.Iter$T@@24) ($IsAllocBox |z#2@0| _module.Iter$T@@24 $Heap@1))) (= (ControlFlow 0 26) 25)) anon5_correct)))
(let ((anon15_Then_correct  (=> (not |$w$loop#0@0|) (and (=> (= (ControlFlow 0 30) 29) anon16_Then_correct) (=> (= (ControlFlow 0 30) 26) anon16_Else_correct)))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 17) (- 0 16)) (|Set#Equal| (_module.Iter.s this@@0) (|Set#FromBoogieMap| (|lambda#5| _module.Iter$T@@24 ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@0) _module.Iter.xs))))))))
(let ((anon20_Then_correct  (=> (|Set#Equal| |r#0@1| |Set#Empty|) (=> (and (= $Heap@5 $Heap@1) (= (ControlFlow 0 18) 17)) GeneratedUnifiedExit_correct))))
(let ((anon13_correct  (and (=> (= (ControlFlow 0 3) (- 0 12)) (exists ((|$as#y0_0#0| T@U) ) (!  (and ($IsBox |$as#y0_0#0| _module.Iter$T@@24) (|Set#IsMember| |r#0@1| |$as#y0_0#0|))
 :qid |SetIterationsdfy.54:9|
 :skolemid |559|
))) (=> (exists ((|$as#y0_0#0@@0| T@U) ) (!  (and ($IsBox |$as#y0_0#0@@0| _module.Iter$T@@24) (|Set#IsMember| |r#0@1| |$as#y0_0#0@@0|))
 :qid |SetIterationsdfy.54:9|
 :skolemid |559|
)) (=> (and (and ($IsBox |y#0@1| _module.Iter$T@@24) ($IsAllocBox |y#0@1| _module.Iter$T@@24 $Heap@1)) (|Set#IsMember| |r#0@1| |y#0@1|)) (and (=> (= (ControlFlow 0 3) (- 0 11)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@0 _module.Iter.x))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@0 _module.Iter.x)) (=> (= |$rhs#0_0@1| (|Set#Difference| |r#0@1| (|Set#UnionOne| |Set#Empty| |y#0@1|))) (=> (and (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 this@@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@0) _module.Iter.x |y#0@1|))) ($IsGoodHeap $Heap@2)) (=> (and (and (= $Heap@3 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@2 this@@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@0) _module.Iter.xs ($Box SeqType (|Seq#Append| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@0) _module.Iter.xs)) (|Seq#Build| |Seq#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@0) _module.Iter.x))))))) (= |_yieldCount#0@1| (+ |_yieldCount#0@0| 1))) (and (= |_yieldCount#0@1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@0) _module.Iter.xs)))) ($IsGoodHeap $Heap@3))) (and (=> (= (ControlFlow 0 3) (- 0 10)) (|Set#IsMember| (_module.Iter.s this@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@0) _module.Iter.x))) (and (=> (= (ControlFlow 0 3) (- 0 9)) (not (|Seq#Contains| (|Seq#Take| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@0) _module.Iter.xs)) (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@0) _module.Iter.xs))) 1)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@0) _module.Iter.x)))) (=> (and (and (and (|Set#IsMember| (_module.Iter.s this@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@0) _module.Iter.x)) (not (|Seq#Contains| (|Seq#Take| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@0) _module.Iter.xs)) (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@0) _module.Iter.xs))) 1)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@0) _module.Iter.x)))) (and (= call1formal@rds@0 (_module.Iter.__reads this@@0)) (= call2formal@nw@0 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@0) _module.Iter.__new))))) (and (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (and (forall (($o@@19 T@U) ($f@@1 T@U) ) (!  (=> (and (or (not (= $o@@19 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@19) alloc)))) (=> (or (or (= $o@@19 this@@0) (|Set#IsMember| call1formal@rds@0 ($Box refType $o@@19))) (|Set#IsMember| call2formal@nw@0 ($Box refType $o@@19))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@19) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@19) $f@@1))))
...
)) ($HeapSucc $Heap@3 $Heap@4)))) (and (=> (= (ControlFlow 0 3) (- 0 8)) (and (<= 0 (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@0) _module.Iter.xs))) 1)) (< (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@0) _module.Iter.xs))) 1) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@0) _module.Iter.xs)))))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (= |y#0@1| (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@0) _module.Iter.xs)) (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@0) _module.Iter.xs))) 1)))) (=> (= |y#0@1| (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@0) _module.Iter.xs)) (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@0) _module.Iter.xs))) 1))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (> |_yieldCount#0@1| |_yieldCount#0@0|) (and (= |_yieldCount#0@1| |_yieldCount#0@0|) (and (|Set#Subset| |$rhs#0_0@1| |r#0@1|) (not (|Set#Subset| |r#0@1| |$rhs#0_0@1|)))))) (=> (or (> |_yieldCount#0@1| |_yieldCount#0@0|) (and (= |_yieldCount#0@1| |_yieldCount#0@0|) (and (|Set#Subset| |$rhs#0_0@1| |r#0@1|) (not (|Set#Subset| |r#0@1| |$rhs#0_0@1|))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (=> |$w$loop#0@0| (forall ((|z#3@@0| T@U) ) (!  (=> ($IsBox |z#3@@0| _module.Iter$T@@24) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@0) _module.Iter.xs)) |z#3@@0|) (not (|Set#IsMember| |$rhs#0_0@1| |z#3@@0|))))
 :qid |SetIterationsdfy.51:22|
 :skolemid |554|
)))) (=> (=> |$w$loop#0@0| (forall ((|z#3@@1| T@U) ) (!  (=> ($IsBox |z#3@@1| _module.Iter$T@@24) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@0) _module.Iter.xs)) |z#3@@1|) (not (|Set#IsMember| |$rhs#0_0@1| |z#3@@1|))))
 :qid |SetIterationsdfy.51:22|
 :skolemid |554|
))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> |$w$loop#0@0| (|Set#Equal| (_module.Iter.s this@@0) (|Set#Union| |$rhs#0_0@1| (|Set#FromBoogieMap| (|lambda#5| _module.Iter$T@@24 ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@0) _module.Iter.xs)))))))) (=> (=> |$w$loop#0@0| (|Set#Equal| (_module.Iter.s this@@0) (|Set#Union| |$rhs#0_0@1| (|Set#FromBoogieMap| (|lambda#5| _module.Iter$T@@24 ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@0) _module.Iter.xs))))))) (=> (= (ControlFlow 0 3) (- 0 2)) (and (forall (($o@@20 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@0) _module.Iter.__new)) ($Box refType $o@@20)) (or (not (= $o@@20 null)) (not true)))
 :qid |SetIterationsdfy.50:3|
 :skolemid |557|
 :pattern (  (or (not (= $o@@20 null)) (not true)))
)) (forall (($o@@21 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@0) _module.Iter.__new)) ($Box refType $o@@21)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@21) alloc)))))
 :qid |SetIterationsdfy.50:3|
 :skolemid |558|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@0) _module.Iter.__new)) ($Box refType $o@@21)))
))))))))))))))))))))))))))
(let ((anon21_Else_correct  (=> (and (not (and ($IsBox |y#1@1| _module.Iter$T@@24) ($IsAllocBox |y#1@1| _module.Iter$T@@24 $Heap@1))) (= (ControlFlow 0 14) 3)) anon13_correct)))
(let ((anon21_Then_correct  (=> (and (and ($IsBox |y#1@1| _module.Iter$T@@24) ($IsAllocBox |y#1@1| _module.Iter$T@@24 $Heap@1)) (= (ControlFlow 0 13) 3)) anon13_correct)))
(let ((anon20_Else_correct  (=> (not (|Set#Equal| |r#0@1| |Set#Empty|)) (and (=> (= (ControlFlow 0 15) 13) anon21_Then_correct) (=> (= (ControlFlow 0 15) 14) anon21_Else_correct)))))
(let ((anon15_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 19) 18) anon20_Then_correct) (=> (= (ControlFlow 0 19) 15) anon20_Else_correct)))))
(let ((anon14_LoopBody_correct  (and (=> (= (ControlFlow 0 31) 30) anon15_Then_correct) (=> (= (ControlFlow 0 31) 19) anon15_Else_correct))))
(let ((anon14_LoopDone_correct true))
(let ((anon14_LoopHead_correct  (=> (and (and ($IsBox |y#0@0| _module.Iter$T@@24) ($IsAllocBox |y#0@0| _module.Iter$T@@24 $Heap@1)) (and ($Is SetType |r#0@1| (TSet _module.Iter$T@@24)) ($IsAlloc SetType |r#0@1| (TSet _module.Iter$T@@24) $Heap@1))) (=> (and (and (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= |_yieldCount#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@0) _module.Iter.xs))))) (and ($IsGoodHeap $_OldIterHeap@0) ($HeapSucc $_OldIterHeap@0 $Heap@1))) (and (and (<= 0 |_yieldCount#0@0|) (= |_yieldCount#0| 0)) (=> |$w$loop#0@0| (forall ((|z#3@@2| T@U) ) (!  (=> ($IsBox |z#3@@2| _module.Iter$T@@24) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@0) _module.Iter.xs)) |z#3@@2|) (not (|Set#IsMember| |r#0@1| |z#3@@2|))))
 :qid |SetIterationsdfy.51:22|
 :skolemid |554|
))))) (and (and (and (=> |$w$loop#0@0| (|Set#Equal| (_module.Iter.s this@@0) (|Set#Union| |r#0@1| (|Set#FromBoogieMap| (|lambda#5| _module.Iter$T@@24 ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@0) _module.Iter.xs))))))) (forall (($o@@22 T@U) ) (!  (=> (and (or (not (= $o@@22 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@22) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@22) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@22)) (= $o@@22 this@@0)))
 :qid |SetIterationsdfy.50:3|
 :skolemid |555|
...
)))) (and (and (forall (($o@@24 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@0) _module.Iter.__new)) ($Box refType $o@@24)) (or (not (= $o@@24 null)) (not true)))
 :qid |SetIterationsdfy.50:3|
 :skolemid |557|
 :pattern (  (or (not (= $o@@24 null)) (not true)))
)) (forall (($o@@25 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@0) _module.Iter.__new)) ($Box refType $o@@25)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@25) alloc)))))
 :qid |SetIterationsdfy.50:3|
 :skolemid |558|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@0) _module.Iter.__new)) ($Box refType $o@@25)))
))) (and (>= |_yieldCount#0@0| |_yieldCount#0|) (=> (= |_yieldCount#0@0| |_yieldCount#0|) (|Set#Subset| |r#0@1| |r#0@0|)))))) (and (=> (= (ControlFlow 0 32) 1) anon14_LoopDone_correct) (=> (= (ControlFlow 0 32) 31) anon14_LoopBody_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#9| null $Heap alloc this@@0)) (=> (and (|Set#Equal| (_module.Iter.s this@@0) |s#0|) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) _module.Iter.xs)) |Seq#Empty|)) (=> (and (and (and (and (_module.Iter.Valid _module.Iter$T@@24 $Heap this@@0) (|Set#Equal| (_module.Iter.__reads this@@0) |Set#Empty|)) (and (|Set#Equal| (_module.Iter.__modifies this@@0) |Set#Empty|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) _module.Iter.__new)) |Set#Empty|))) (and (and (|Set#Equal| (_module.Iter.__decreases0 this@@0) |s#0|) (= |_yieldCount#0| 0)) (and (= call1formal@rds@0@@0 (_module.Iter.__reads this@@0)) (= call2formal@nw@0@@0 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) _module.Iter.__new)))))) (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@26 T@U) ($f@@3 T@U) ) (!  (=> (and (or (not (= $o@@26 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@26) alloc)))) (=> (or (or (= $o@@26 this@@0) (|Set#IsMember| call1formal@rds@0@@0 ($Box refType $o@@26))) (|Set#IsMember| call2formal@nw@0@@0 ($Box refType $o@@26))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@26) $f@@3) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@26) $f@@3))))
 :qid |DafnyPreludebpl.620:19|
 :skolemid |120|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@26) $f@@3))
))) (and ($HeapSucc $Heap $Heap@0) (= |r#0@0| (_module.Iter.s this@@0))))) (and (=> (= (ControlFlow 0 33) (- 0 36)) (=> |$w$loop#0@0| (forall ((|z#3@@3| T@U) ) (!  (=> ($IsBox |z#3@@3| _module.Iter$T@@24) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@0) _module.Iter.xs)) |z#3@@3|) (not (|Set#IsMember| |r#0@0| |z#3@@3|))))
 :qid |SetIterationsdfy.51:22|
 :skolemid |554|
)))) (=> (=> |$w$loop#0@0| (forall ((|z#3@@4| T@U) ) (!  (=> ($IsBox |z#3@@4| _module.Iter$T@@24) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@0) _module.Iter.xs)) |z#3@@4|) (not (|Set#IsMember| |r#0@0| |z#3@@4|))))
 :qid |SetIterationsdfy.51:22|
 :skolemid |554|
))) (and (=> (= (ControlFlow 0 33) (- 0 35)) (=> |$w$loop#0@0| (|Set#Equal| (_module.Iter.s this@@0) (|Set#Union| |r#0@0| (|Set#FromBoogieMap| (|lambda#5| _module.Iter$T@@24 ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@0) _module.Iter.xs)))))))) (=> (=> |$w$loop#0@0| (|Set#Equal| (_module.Iter.s this@@0) (|Set#Union| |r#0@0| (|Set#FromBoogieMap| (|lambda#5| _module.Iter$T@@24 ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@0) _module.Iter.xs))))))) (and (=> (= (ControlFlow 0 33) (- 0 34)) (and (forall (($o@@27 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@0) _module.Iter.__new)) ($Box refType $o@@27)) (or (not (= $o@@27 null)) (not true)))
 :qid |SetIterationsdfy.50:3|
 :skolemid |557|
 :pattern (  (or (not (= $o@@27 null)) (not true)))
)) (forall (($o@@28 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@0) _module.Iter.__new)) ($Box refType $o@@28)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@28) alloc)))))
 :qid |SetIterationsdfy.50:3|
 :skolemid |558|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@0) _module.Iter.__new)) ($Box refType $o@@28)))
)))) (=> (and (forall (($o@@29 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@0) _module.Iter.__new)) ($Box refType $o@@29)) (or (not (= $o@@29 null)) (not true)))
 :qid |SetIterationsdfy.50:3|
 :skolemid |557|
 :pattern (  (or (not (= $o@@29 null)) (not true)))
)) (forall (($o@@30 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@0) _module.Iter.__new)) ($Box refType $o@@30)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@30) alloc)))))
 :qid |SetIterationsdfy.50:3|
 :skolemid |558|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@0) _module.Iter.__new)) ($Box refType $o@@30)))
))) (=> (= (ControlFlow 0 33) 32) anon14_LoopHead_correct))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 (Tclass._module.Iter _module.Iter$T@@24)) ($IsAlloc refType this@@0 (Tclass._module.Iter _module.Iter$T@@24) $Heap)))) (and (and ($Is SetType |s#0| (TSet _module.Iter$T@@24)) ($IsAlloc SetType |s#0| (TSet _module.Iter$T@@24) $Heap)) (and (= |_yieldCount#0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) _module.Iter.xs)))) true))) (=> (and (and (and (and ($IsGoodHeap $_OldIterHeap) ($HeapSucc $_OldIterHeap $Heap)) true) (and (and ($Is SetType |r#0| (TSet _module.Iter$T@@24)) ($IsAlloc SetType |r#0| (TSet _module.Iter$T@@24) $Heap)) true)) (and (and (and ($IsBox |y#0| _module.Iter$T@@24) ($IsAllocBox |y#0| _module.Iter$T@@24 $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 37) 33)))) anon0_correct))))
