...
(set-info :boogie-vc-id Impl$$_module.__default.FivesUpPos_h)
...
(let ((anon6_Else_correct  (=> (and (or (not (= (Mod |n#1| (LitInt 5)) (LitInt 0))) (not true)) (= |n##1@0| (+ |n#1| 1))) (and (=> (= (ControlFlow 0 13) (- 0 16)) (or (or (<= 0 (- 4 (Mod (- |n#1| 1) (LitInt 5)))) (|ORD#Less| |_k#0@@4| |_k#0@@4|)) (= (- 4 (Mod (- |n##1@0| 1) (LitInt 5))) (- 4 (Mod (- |n#1| 1) (LitInt 5)))))) (=> (or (or (<= 0 (- 4 (Mod (- |n#1| 1) (LitInt 5)))) (|ORD#Less| |_k#0@@4| |_k#0@@4|)) (= (- 4 (Mod (- |n##1@0| 1) (LitInt 5))) (- 4 (Mod (- |n#1| 1) (LitInt 5))))) (and (=> (= (ControlFlow 0 13) (- 0 15)) (or (|ORD#Less| |_k#0@@4| |_k#0@@4|) (and (= |_k#0@@4| |_k#0@@4|) (< (- 4 (Mod (- |n##1@0| 1) (LitInt 5))) (- 4 (Mod (- |n#1| 1) (LitInt 5))))))) (=> (or (|ORD#Less| |_k#0@@4| |_k#0@@4|) (and (= |_k#0@@4| |_k#0@@4|) (< (- 4 (Mod (- |n##1@0| 1) (LitInt 5))) (- 4 (Mod (- |n#1| 1) (LitInt 5)))))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (> |n##1@0| 0)) (=> (> |n##1@0| 0) (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (and (|_module.__default.FivesUp#canCall| |n##1@0|) (|_module.__default.Pos_h#canCall| |_k#0@@4| (_module.__default.FivesUp ($LS $LZ) |n##1@0|)))) (and (and (|_module.__default.Pos_h#canCall| |_k#0@@4| (_module.__default.FivesUp ($LS $LZ) |n##1@0|)) (and (_module.__default.Pos_h ($LS $LZ) |_k#0@@4| (_module.__default.FivesUp ($LS $LZ) |n##1@0|)) (and (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (ite (_module.Stream.SNil_q (_module.__default.FivesUp ($LS $LZ) |n##1@0|)) true (let ((|rest#3@@0| (_module.Stream.tail (_module.__default.FivesUp ($LS $LZ) |n##1@0|))))
(let ((|x#3@@0| (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.FivesUp ($LS $LZ) |n##1@0|))))))
 (and (> |x#3@@0| 0) (_module.__default.Pos_h ($LS $LZ) (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) |rest#3@@0|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@4|)) (forall ((|_k'#0@@1| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@1| |_k#0@@4|) (_module.__default.Pos_h ($LS $LZ) |_k'#0@@1| (_module.__default.FivesUp ($LS $LZ) |n##1@0|)))
 :qid |InductionVsCoinductiondfy.38:20|
 :skolemid |603|
 :pattern ( (_module.__default.Pos_h ($LS $LZ) |_k'#0@@1| (_module.__default.FivesUp ($LS $LZ) |n##1@0|)))
)))))) (and (= $Heap $Heap@2) (= (ControlFlow 0 13) 2)))) GeneratedUnifiedExit_correct))))))))))
(let ((anon6_Then_correct  (=> (= (Mod |n#1| (LitInt 5)) (LitInt 0)) (and (=> (= (ControlFlow 0 7) (- 0 12)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 7) (- 0 11)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@4|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@4|)) (=> (and (= |_k##0@0| (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1))) (= |n##0@0| (+ |n#1| 1))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (or (or (<= 0 (- 4 (Mod (- |n#1| 1) (LitInt 5)))) (|ORD#Less| |_k##0@0| |_k#0@@4|)) (= (- 4 (Mod (- |n##0@0| 1) (LitInt 5))) (- 4 (Mod (- |n#1| 1) (LitInt 5)))))) (=> (or (or (<= 0 (- 4 (Mod (- |n#1| 1) (LitInt 5)))) (|ORD#Less| |_k##0@0| |_k#0@@4|)) (= (- 4 (Mod (- |n##0@0| 1) (LitInt 5))) (- 4 (Mod (- |n#1| 1) (LitInt 5))))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (or (|ORD#Less| |_k##0@0| |_k#0@@4|) (and (= |_k##0@0| |_k#0@@4|) (< (- 4 (Mod (- |n##0@0| 1) (LitInt 5))) (- 4 (Mod (- |n#1| 1) (LitInt 5))))))) (=> (or (|ORD#Less| |_k##0@0| |_k#0@@4|) (and (= |_k##0@0| |_k#0@@4|) (< (- 4 (Mod (- |n##0@0| 1) (LitInt 5))) (- 4 (Mod (- |n#1| 1) (LitInt 5)))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (> |n##0@0| 0)) (=> (> |n##0@0| 0) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (|_module.__default.FivesUp#canCall| |n##0@0|) (|_module.__default.Pos_h#canCall| |_k##0@0| (_module.__default.FivesUp ($LS $LZ) |n##0@0|)))) (and (and (|_module.__default.Pos_h#canCall| |_k##0@0| (_module.__default.FivesUp ($LS $LZ) |n##0@0|)) (and (_module.__default.Pos_h ($LS $LZ) |_k##0@0| (_module.__default.FivesUp ($LS $LZ) |n##0@0|)) (and (=> (< 0 (|ORD#Offset| |_k##0@0|)) (ite (_module.Stream.SNil_q (_module.__default.FivesUp ($LS $LZ) |n##0@0|)) true (let ((|rest#3@@1| (_module.Stream.tail (_module.__default.FivesUp ($LS $LZ) |n##0@0|))))
(let ((|x#3@@1| (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.FivesUp ($LS $LZ) |n##0@0|))))))
 (and (> |x#3@@1| 0) (_module.__default.Pos_h ($LS $LZ) (|ORD#Minus| |_k##0@0| (|ORD#FromNat| 1)) |rest#3@@1|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k##0@0|)) (forall ((|_k'#0@@2| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@2| |_k##0@0|) (_module.__default.Pos_h ($LS $LZ) |_k'#0@@2| (_module.__default.FivesUp ($LS $LZ) |n##0@0|)))
 :qid |InductionVsCoinductiondfy.38:20|
 :skolemid |603|
 :pattern ( (_module.__default.Pos_h ($LS $LZ) |_k'#0@@2| (_module.__default.FivesUp ($LS $LZ) |n##0@0|)))
)))))) (and (= $Heap $Heap@1) (= (ControlFlow 0 7) 2)))) GeneratedUnifiedExit_correct)))))))))))))))
(let ((anon5_Then_correct  (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (or (not (= (LitInt 5) 0)) (not true))) (=> (or (not (= (LitInt 5) 0)) (not true)) (and (=> (= (ControlFlow 0 17) 7) anon6_Then_correct) (=> (= (ControlFlow 0 17) 13) anon6_Else_correct)))))))
(let ((anon5_Else_correct  (=> (<= (|ORD#Offset| |_k#0@@4|) 0) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (forall ((|_k'#2@@1| T@U) (|n#2| Int) ) (!  (=> (and (|ORD#Less| |_k'#2@@1| |_k#0@@4|) (> |n#2| 0)) (_module.__default.Pos_h ($LS $LZ) |_k'#2@@1| (_module.__default.FivesUp ($LS $LZ) |n#2|)))
 :qid |InductionVsCoinductiondfy.116:35|
 :skolemid |609|
 :pattern ( (_module.__default.FivesUp ($LS $LZ) |n#2|) (|ORD#Less| |_k'#2@@1| |_k#0@@4|))
)) (= (ControlFlow 0 6) 2))) GeneratedUnifiedExit_correct))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 19) 17) anon5_Then_correct) (=> (= (ControlFlow 0 19) 6) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 3 $FunctionContextHeight)) (and (> |n#1| 0) (= (ControlFlow 0 20) 19))) anon0_correct)))
