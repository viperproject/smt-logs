...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Path__Lemma2_k_k)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsAlloc DatatypeTypeType |p#0@@2| (Tclass._module.Stream TInt) $Heap) (|_module.__default.IsNeverEndingStream#canCall| TInt |p#0@@2|)) (and (_module.__default.IsNeverEndingStream TInt ($LS $LZ) |p#0@@2|) (= (ControlFlow 0 2) (- 0 1)))) (_module.Stream.Cons_q |p#0@@2|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |p#0@@2| (Tclass._module.Stream TInt)) ($IsAlloc DatatypeTypeType |p#0@@2| (Tclass._module.Stream TInt) $Heap)) (|$IsA#_module.Stream| |p#0@@2|)) (<= (LitInt 0) |n#0@@3|)) (and (and (and ($Is DatatypeTypeType |tail#0@@4| (Tclass._module.Stream TInt)) ($IsAlloc DatatypeTypeType |tail#0@@4| (Tclass._module.Stream TInt) $Heap)) (|$IsA#_module.Stream| |tail#0@@4|)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct))))
