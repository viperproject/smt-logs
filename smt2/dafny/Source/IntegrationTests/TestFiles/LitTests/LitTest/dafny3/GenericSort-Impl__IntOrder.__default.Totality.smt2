...
(set-info :boogie-vc-id Impl$$IntOrder.__default.Totality)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (or (IntOrder.__default.Leq |a#0@@2| |b#0@@2|) (IntOrder.__default.Leq |b#0@@2| |a#0@@2|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |a#0@@2| Tclass.IntOrder.T) ($IsAlloc DatatypeTypeType |a#0@@2| Tclass.IntOrder.T $Heap)) (|$IsA#IntOrder.T| |a#0@@2|)) (=> (and (and (and ($Is DatatypeTypeType |b#0@@2| Tclass.IntOrder.T) ($IsAlloc DatatypeTypeType |b#0@@2| Tclass.IntOrder.T $Heap)) (|$IsA#IntOrder.T| |b#0@@2|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct)))))
