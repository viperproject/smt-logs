...
(set-info :boogie-vc-id Impl$$_module.__default.UpLemma__Auto)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (and (forall ((|$ih#k0#0| Int) (|$ih#n0#0| Int) (|$ih#nn0#0| Int) ) (!  (=> (and (and (<= (LitInt 0) |$ih#k0#0|) (U_2_bool (Lit boolType (bool_2_U true)))) (or (and (<= 0 |$ih#k0#0|) (< |$ih#k0#0| |k#0|)) (and (= |$ih#k0#0| |k#0|) (or (and (<= 0 |$ih#n0#0|) (< |$ih#n0#0| |n#0@@2|)) (and (= |$ih#n0#0| |n#0@@2|) (and (<= 0 |$ih#nn0#0|) (< |$ih#nn0#0| |nn#0|))))))) (=> (= |$ih#nn0#0| (+ |$ih#n0#0| 1)) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#FromNat| |$ih#k0#0|) ($LS ($LS $LZ)) (_module.__default.Inc ($LS $LZ) (_module.__default.Up ($LS $LZ) |$ih#n0#0|)) (_module.__default.Up ($LS $LZ) |$ih#nn0#0|))))
 :qid |SimpleCoinductiondfy.38:20|
 :skolemid |622|
 :pattern ( (|$PrefixEq#_module.Stream| TInt TInt (|ORD#FromNat| |$ih#k0#0|) ($LS ($LS $LZ)) (_module.__default.Inc ($LS $LZ) (_module.__default.Up ($LS $LZ) |$ih#n0#0|)) (_module.__default.Up ($LS $LZ) |$ih#nn0#0|)))
)) (= (ControlFlow 0 2) (- 0 1))) (= |nn#0| (+ |n#0@@2| 1)))) (or (|$PrefixEq#_module.Stream| TInt TInt (|ORD#FromNat| |k#0|) ($LS ($LS $LZ)) (_module.__default.Inc ($LS $LZ) (_module.__default.Up ($LS $LZ) |n#0@@2|)) (_module.__default.Up ($LS $LZ) |nn#0|)) (=> (< 0 |k#0|) (=> (_module.Stream.Cons_q (_module.__default.Inc ($LS ($LS $LZ)) (_module.__default.Up ($LS ($LS $LZ)) |n#0@@2|))) (and (_module.Stream.Cons_q (_module.__default.Up ($LS ($LS $LZ)) |nn#0|)) (and (= (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Inc ($LS ($LS $LZ)) (_module.__default.Up ($LS ($LS $LZ)) |n#0@@2|))))) (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Up ($LS ($LS $LZ)) |nn#0|))))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#FromNat| (- |k#0| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.Inc ($LS ($LS $LZ)) (_module.__default.Up ($LS ($LS $LZ)) |n#0@@2|))) (_module.Stream.tail (_module.__default.Up ($LS ($LS $LZ)) |nn#0|))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |k#0|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct)))
