...
(declare-fun $Heap@@1 () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.CombinePlus__Correct_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (|$PrefixEq#_module.Stream| TInt TInt |_k#0| ($LS ($LS $LZ)) (_module.__default.Combine TInt ($LS $LZ) |_module.__default.plus#Handle| |a#1| |b#1|) (_module.__default.add ($LS $LZ) |a#1| |b#1|)) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (_module.__default.Combine TInt ($LS ($LS $LZ)) |_module.__default.plus#Handle| |a#1| |b#1|)) (and (_module.Stream.Cons_q (_module.__default.add ($LS ($LS $LZ)) |a#1| |b#1|)) (and (= (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Combine TInt ($LS ($LS $LZ)) |_module.__default.plus#Handle| |a#1| |b#1|)))) (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.add ($LS ($LS $LZ)) |a#1| |b#1|))))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.Combine TInt ($LS ($LS $LZ)) |_module.__default.plus#Handle| |a#1| |b#1|)) (_module.Stream.tail (_module.__default.add ($LS ($LS $LZ)) |a#1| |b#1|))))))))) (=> (or (|$PrefixEq#_module.Stream| TInt TInt |_k#0| ($LS ($LS $LZ)) (_module.__default.Combine TInt ($LS $LZ) |_module.__default.plus#Handle| |a#1| |b#1|) (_module.__default.add ($LS $LZ) |a#1| |b#1|)) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (_module.__default.Combine TInt ($LS ($LS $LZ)) |_module.__default.plus#Handle| |a#1| |b#1|)) (and (_module.Stream.Cons_q (_module.__default.add ($LS ($LS $LZ)) |a#1| |b#1|)) (and (= (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Combine TInt ($LS ($LS $LZ)) |_module.__default.plus#Handle| |a#1| |b#1|)))) (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.add ($LS ($LS $LZ)) |a#1| |b#1|))))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.Combine TInt ($LS ($LS $LZ)) |_module.__default.plus#Handle| |a#1| |b#1|)) (_module.Stream.tail (_module.__default.add ($LS ($LS $LZ)) |a#1| |b#1|)))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (or (|$PrefixEq#_module.Stream| TInt TInt |_k#0| ($LS ($LS $LZ)) (_module.__default.Combine TInt ($LS $LZ) |_module.__default.plus#Handle| |a#1| |b#1|) (_module.__default.add ($LS $LZ) |a#1| |b#1|)) (or (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (_module.__default.Combine TInt ($LS ($LS $LZ)) |_module.__default.plus#Handle| |a#1| |b#1|)) (and (_module.Stream.Cons_q (_module.__default.add ($LS ($LS $LZ)) |a#1| |b#1|)) (and (= (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Combine TInt ($LS ($LS $LZ)) |_module.__default.plus#Handle| |a#1| |b#1|)))) (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.add ($LS ($LS $LZ)) |a#1| |b#1|))))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.Combine TInt ($LS ($LS $LZ)) |_module.__default.plus#Handle| |a#1| |b#1|)) (_module.Stream.tail (_module.__default.add ($LS ($LS $LZ)) |a#1| |b#1|))))))) (=> (and (or (not (= |_k#0| (|ORD#FromNat| 0))) (not true)) (= (|ORD#Offset| |_k#0|) 0)) (|$Eq#_module.Stream| TInt TInt ($LS ($LS $LZ)) (_module.__default.Combine TInt ($LS $LZ) |_module.__default.plus#Handle| |a#1| |b#1|) (_module.__default.add ($LS $LZ) |a#1| |b#1|))))))))))
(let ((anon3_Else_correct  (=> (<= (|ORD#Offset| |_k#0|) 0) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1)) (and (forall ((|_k'#0| T@U) (|a#2| T@U) (|b#2| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |a#2| (Tclass._module.Stream TInt)) ($Is DatatypeTypeType |b#2| (Tclass._module.Stream TInt))) (|ORD#Less| |_k'#0| |_k#0|)) (|$PrefixEq#_module.Stream| TInt TInt |_k'#0| ($LS ($LS $LZ)) (_module.__default.Combine TInt ($LS $LZ) |_module.__default.plus#Handle| |a#2| |b#2|) (_module.__default.add ($LS $LZ) |a#2| |b#2|)))
 :qid |Abstemiousdfy.166:16|
 :skolemid |750|
 :pattern ( (_module.__default.add ($LS $LZ) |a#2| |b#2|) (|ORD#Less| |_k'#0| |_k#0|))
 :pattern ( (_module.__default.Combine TInt ($LS $LZ) |_module.__default.plus#Handle| |a#2| |b#2|) (|ORD#Less| |_k'#0| |_k#0|))
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (|$IsA#_module.Stream| |a#1|) (|$IsA#_module.Stream| |b#1|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@1 $Heap@0) (forall ((|$ih#_k0#0| T@U) (|$ih#a0#0| T@U) (|$ih#b0#0| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |$ih#a0#0| (Tclass._module.Stream TInt)) ($Is DatatypeTypeType |$ih#b0#0| (Tclass._module.Stream TInt))) (U_2_bool (Lit boolType (bool_2_U true)))) (|ORD#Less| |$ih#_k0#0| |_k#0|)) (|$PrefixEq#_module.Stream| TInt TInt |$ih#_k0#0| ($LS ($LS $LZ)) (_module.__default.Combine TInt ($LS $LZ) |_module.__default.plus#Handle| |$ih#a0#0| |$ih#b0#0|) (_module.__default.add ($LS $LZ) |$ih#a0#0| |$ih#b0#0|)))
 :qid |Abstemiousdfy.166:16|
 :skolemid |749|
 :pattern ( (|$PrefixEq#_module.Stream| TInt TInt |$ih#_k0#0| ($LS ($LS $LZ)) (_module.__default.Combine TInt ($LS $LZ) |_module.__default.plus#Handle| |$ih#a0#0| |$ih#b0#0|) (_module.__default.add ($LS $LZ) |$ih#a0#0| |$ih#b0#0|)))
)))) (and (=> (= (ControlFlow 0 6) 4) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and ($Is DatatypeTypeType |a#1| (Tclass._module.Stream TInt)) ($IsAlloc DatatypeTypeType |a#1| (Tclass._module.Stream TInt) $Heap@@1)) (|$IsA#_module.Stream| |a#1|)) (=> (and (and (and ($Is DatatypeTypeType |b#1| (Tclass._module.Stream TInt)) ($IsAlloc DatatypeTypeType |b#1| (Tclass._module.Stream TInt) $Heap@@1)) (|$IsA#_module.Stream| |b#1|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct)))))
