...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.S2N)
...
(let ((anon14_Else_correct  (=> (<= 0 |n#Z#0@0|) (and (=> (= (ControlFlow 0 7) (- 0 8)) ($Is intType (int_2_U |n#Z#0@0|) Tclass._System.nat)) (=> ($Is intType (int_2_U |n#Z#0@0|) Tclass._System.nat) (=> (= (ControlFlow 0 7) 4) anon8_correct))))))
(let ((anon14_Then_correct  (=> (< |n#Z#0@0| 0) (and (=> (= (ControlFlow 0 5) (- 0 6)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (= (ControlFlow 0 5) 4) anon8_correct))))))
(let ((anon13_Then_correct  (=> (and (and (and (= |p#0@@2| (|#_module.Stream.Cons| ($Box intType (int_2_U |_mcc#0#0|)) |_mcc#1#0|)) ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.Stream TInt))) (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.Stream TInt)))) (and (and (= |tail#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|)) (and ($Is intType (int_2_U |let#1#0#0|) TInt) (= |n#Z#0@0| |let#1#0#0|)))) (and (=> (= (ControlFlow 0 9) 5) anon14_Then_correct) (=> (= (ControlFlow 0 9) 7) anon14_Else_correct)))))
(let ((anon13_Else_correct true))
(let ((anon12_Else_correct  (=> (or (not (= |p#0@@2| |#_module.Stream.Nil|)) (not true)) (and (=> (= (ControlFlow 0 10) 9) anon13_Then_correct) (=> (= (ControlFlow 0 10) 3) anon13_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |p#0@@2| (Tclass._module.Stream TInt))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 12) 11))) anon0_correct)))
