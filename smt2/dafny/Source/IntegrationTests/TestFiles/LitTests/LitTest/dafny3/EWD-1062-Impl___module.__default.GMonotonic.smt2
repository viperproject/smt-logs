...
(declare-fun _module.__default.Above (T@U T@U) Bool)
(declare-fun |_module.__default.Above#canCall| (T@U T@U) Bool)
...
(declare-fun |_module.__default.Above#Handle| () T@U)
...
(declare-fun |y#2_0@0| () T@U)
(declare-fun $Heap@3 () T@U)
(declare-fun |##x#2_0_0_0@0| () T@U)
(declare-fun |##y#2_0_0_1@0| () T@U)
(declare-fun |##y#2_0_1_0@0| () T@U)
(declare-fun $Heap@5 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |##x#2_0_1_2@0| () T@U)
(declare-fun |##x#2_0_2_0@0| () T@U)
(declare-fun |##y#2_0_2_1@0| () T@U)
(declare-fun |u#0| () T@U)
(declare-fun |v#0| () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let ((anon24_Else_correct  (=> (and (= (_module.__default.Above (_module.__default.g |x#2_0@0|) |y#2_0@0|) (_module.__default.Above |x#2_0@0| (_module.__default.f |y#2_0@0|))) (= (ControlFlow 0 22) (- 0 21))) (= (_module.__default.Above (_module.__default.g |x#2_0@0|) |y#2_0@0|) (_module.__default.Above |x#2_0@0| (_module.__default.f |y#2_0@0|))))))
(let ((anon24_Then_correct  (=> (and ($IsAllocBox |y#2_0@0| Tclass._module.T $Heap@3) (|_module.__default.f#canCall| |y#2_0@0|)) (=> (and (and (and (and (= |##x#2_0_0_0@0| (_module.__default.f |y#2_0@0|)) ($IsAllocBox |##x#2_0_0_0@0| Tclass._module.T $Heap@3)) (and ($IsAllocBox |x#2_0@0| Tclass._module.T $Heap@3) (|_module.__default.Below#canCall| (_module.__default.f |y#2_0@0|) |x#2_0@0|))) (and (and (|_module.__default.f#canCall| |y#2_0@0|) (|_module.__default.Below#canCall| (_module.__default.f |y#2_0@0|) |x#2_0@0|)) (and ($IsAllocBox |x#2_0@0| Tclass._module.T $Heap@3) ($IsAllocBox |y#2_0@0| Tclass._module.T $Heap@3)))) (and (and (and (|_module.__default.f#canCall| |y#2_0@0|) (= |##y#2_0_0_1@0| (_module.__default.f |y#2_0@0|))) (and ($IsAllocBox |##y#2_0_0_1@0| Tclass._module.T $Heap@3) (|_module.__default.Above#canCall| |x#2_0@0| (_module.__default.f |y#2_0@0|)))) (and (and (|_module.__default.f#canCall| |y#2_0@0|) (|_module.__default.Above#canCall| |x#2_0@0| (_module.__default.f |y#2_0@0|))) (= (ControlFlow 0 20) (- 0 19))))) (= (_module.__default.Below (_module.__default.f |y#2_0@0|) |x#2_0@0|) (_module.__default.Above |x#2_0@0| (_module.__default.f |y#2_0@0|)))))))
(let ((anon23_Then_correct  (=> (and ($IsAllocBox |y#2_0@0| Tclass._module.T $Heap@3) ($IsAllocBox |x#2_0@0| Tclass._module.T $Heap@3)) (=> (and (and (and (|_module.__default.g#canCall| |x#2_0@0|) (= |##y#2_0_1_0@0| (_module.__default.g |x#2_0@0|))) (and ($IsAllocBox |##y#2_0_1_0@0| Tclass._module.T $Heap@3) (|_module.__default.Below#canCall| |y#2_0@0| (_module.__default.g |x#2_0@0|)))) (and (and (|_module.__default.g#canCall| |x#2_0@0|) (|_module.__default.Below#canCall| |y#2_0@0| (_module.__default.g |x#2_0@0|))) (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5)))) (=> (and (and (and (and (|_module.__default.f#canCall| |y#2_0@0|) (|_module.__default.Below#canCall| (_module.__default.f |y#2_0@0|) |x#2_0@0|)) (and (|_module.__default.g#canCall| |x#2_0@0|) (|_module.__default.Below#canCall| |y#2_0@0| (_module.__default.g |x#2_0@0|)))) (and (and (= (_module.__default.Below (_module.__default.f |y#2_0@0|) |x#2_0@0|) (_module.__default.Below |y#2_0@0| (_module.__default.g |x#2_0@0|))) (= $Heap@3 $Heap@5)) (and ($IsAllocBox |y#2_0@0| Tclass._module.T $Heap@5) (|_module.__default.f#canCall| |y#2_0@0|)))) (and (and (and (= |##x#2_0_1_2@0| (_module.__default.f |y#2_0@0|)) ($IsAllocBox |##x#2_0_1_2@0| Tclass._module.T $Heap@5)) (and ($IsAllocBox |x#2_0@0| Tclass._module.T $Heap@5) (|_module.__default.Below#canCall| (_module.__default.f |y#2_0@0|) |x#2_0@0|))) (and (and (|_module.__default.f#canCall| |y#2_0@0|) (|_module.__default.Below#canCall| (_module.__default.f |y#2_0@0|) |x#2_0@0|)) (= (ControlFlow 0 18) (- 0 17))))) (= (_module.__default.Below |y#2_0@0| (_module.__default.g |x#2_0@0|)) (_module.__default.Below (_module.__default.f |y#2_0@0|) |x#2_0@0|)))))))
(let ((anon22_Then_correct  (=> (and ($IsAllocBox |x#2_0@0| Tclass._module.T $Heap@3) (|_module.__default.g#canCall| |x#2_0@0|)) (=> (and (and (and (and (= |##x#2_0_2_0@0| (_module.__default.g |x#2_0@0|)) ($IsAllocBox |##x#2_0_2_0@0| Tclass._module.T $Heap@3)) (and ($IsAllocBox |y#2_0@0| Tclass._module.T $Heap@3) (|_module.__default.Above#canCall| (_module.__default.g |x#2_0@0|) |y#2_0@0|))) (and (and (|_module.__default.g#canCall| |x#2_0@0|) (|_module.__default.Above#canCall| (_module.__default.g |x#2_0@0|) |y#2_0@0|)) (and ($IsAllocBox |y#2_0@0| Tclass._module.T $Heap@3) ($IsAllocBox |x#2_0@0| Tclass._module.T $Heap@3)))) (and (and (and (|_module.__default.g#canCall| |x#2_0@0|) (= |##y#2_0_2_1@0| (_module.__default.g |x#2_0@0|))) (and ($IsAllocBox |##y#2_0_2_1@0| Tclass._module.T $Heap@3) (|_module.__default.Below#canCall| |y#2_0@0| (_module.__default.g |x#2_0@0|)))) (and (and (|_module.__default.g#canCall| |x#2_0@0|) (|_module.__default.Below#canCall| |y#2_0@0| (_module.__default.g |x#2_0@0|))) (= (ControlFlow 0 16) (- 0 15))))) (= (_module.__default.Above (_module.__default.g |x#2_0@0|) |y#2_0@0|) (_module.__default.Below |y#2_0@0| (_module.__default.g |x#2_0@0|)))))))
(let ((anon21_Then_correct true))
(let ((anon20_Else_correct  (and (and (and (and (=> (= (ControlFlow 0 23) 14) anon21_Then_correct) (=> (= (ControlFlow 0 23) 16) anon22_Then_correct)) (=> (= (ControlFlow 0 23) 18) anon23_Then_correct)) (=> (= (ControlFlow 0 23) 20) anon24_Then_correct)) (=> (= (ControlFlow 0 23) 22) anon24_Else_correct))))
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 27) 1) anon17_Then_correct) (=> (= (ControlFlow 0 27) 26) anon17_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($IsBox |u#0| Tclass._module.T) ($IsAllocBox |u#0| Tclass._module.T $Heap))) (=> (and (and (and ($IsBox |v#0| Tclass._module.T) ($IsAllocBox |v#0| Tclass._module.T $Heap)) (= 3 $FunctionContextHeight)) (and (_module.__default.Below |u#0| |v#0|) (= (ControlFlow 0 28) 27))) anon0_correct))))
