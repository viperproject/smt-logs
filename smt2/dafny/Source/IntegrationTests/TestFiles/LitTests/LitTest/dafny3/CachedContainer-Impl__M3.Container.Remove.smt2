...
(assert (forall ((s@@6 T@U) (n@@4 Int) (x@@10 T@U) ) (! (= (|Seq#Contains| (|Seq#Take| s@@6 n@@4) x@@10) (exists ((i@@1 Int) ) (!  (and (and (and (<= 0 i@@1) (< i@@1 n@@4)) (< i@@1 (|Seq#Length| s@@6))) (= (|Seq#Index| s@@6 i@@1) x@@10))
 :qid |DafnyPreludebpl.1204:19|
 :skolemid |1865|
 :pattern ( (|Seq#Index| s@@6 i@@1))
)))
 :qid |DafnyPreludebpl.1201:15|
 :skolemid |1866|
 :pattern ( (|Seq#Contains| (|Seq#Take| s@@6 n@@4) x@@10))
)))
...
(assert (forall ((s@@7 T@U) (x@@11 T@U) ) (! (= (|Seq#Contains| s@@7 x@@11) (exists ((i@@2 Int) ) (!  (and (and (<= 0 i@@2) (< i@@2 (|Seq#Length| s@@7))) (= (|Seq#Index| s@@7 i@@2) x@@11))
...
(assert (forall ((s@@10 T@U) (i@@3 Int) (j@@1 Int) ) (!  (=> (and (and (<= 0 i@@3) (< i@@3 j@@1)) (<= j@@1 (|Seq#Length| s@@10))) (< (|Seq#Rank| (|Seq#Append| (|Seq#Take| s@@10 i@@3) (|Seq#Drop| s@@10 j@@1))) (|Seq#Rank| s@@10)))
 :qid |DafnyPreludebpl.1362:15|
 :skolemid |1900|
 :pattern ( (|Seq#Rank| (|Seq#Append| (|Seq#Take| s@@10 i@@3) (|Seq#Drop| s@@10 j@@1))))
)))
...
(assert (forall ((v@@4 T@U) (t0@@2 T@U) (h@@4 T@U) ) (! (= ($IsAlloc SeqType v@@4 (TSeq t0@@2) h@@4) (forall ((i@@4 Int) ) (!  (=> (and (<= 0 i@@4) (< i@@4 (|Seq#Length| v@@4))) ($IsAllocBox (|Seq#Index| v@@4 i@@4) t0@@2 h@@4))
...
(assert (forall ((s@@11 T@U) (n@@6 Int) (x@@13 T@U) ) (! (= (|Seq#Contains| (|Seq#Drop| s@@11 n@@6) x@@13) (exists ((i@@5 Int) ) (!  (and (and (and (<= 0 n@@6) (<= n@@6 i@@5)) (< i@@5 (|Seq#Length| s@@11))) (= (|Seq#Index| s@@11 i@@5) x@@13))
 ...
 :skolemid |1868|
 :pattern ( (|Seq#Contains| (|Seq#Drop| s@@11 n@@6) x@@13))
)))
...
(assert (= (Tag Tclass._System.object) Tagclass._System.object))
(assert (= (TagFamily Tclass._System.object) tytagFamily$object))
(assert (forall ((s@@12 T@U) (n@@7 Int) (k@@2 Int) ) (!  (=> (and (and (<= 0 n@@7) (<= n@@7 k@@2)) (< k@@2 (|Seq#Length| s@@12))) (= (|Seq#Index| (|Seq#Drop| s@@12 n@@7) (- k@@2 n@@7)) (|Seq#Index| s@@12 k@@2)))
 :qid |DafnyPreludebpl.1258:15|
 :weight 25
 :skolemid |1878|
 :pattern ( (|Seq#Index| s@@12 k@@2) (|Seq#Drop| s@@12 n@@7))
)))
...
(assert (forall ((s@@13 T@U) (m@@2 Int) (n@@8 Int) ) (!  (=> (and (and (<= 0 m@@2) (<= 0 n@@8)) (<= (+ m@@2 n@@8) (|Seq#Length| s@@13))) (= (|Seq#Drop| (|Seq#Drop| s@@13 m@@2) n@@8) (|Seq#Drop| s@@13 (+ m@@2 n@@8))))
 :qid |DafnyPreludebpl.1299:15|
 :skolemid |1887|
 :pattern ( (|Seq#Drop| (|Seq#Drop| s@@13 m@@2) n@@8))
)))
...
(assert (forall ((s@@14 T@U) ) (!  (=> (= (|Seq#Length| s@@14) 0) (= s@@14 |Seq#Empty|))
 :qid |DafnyPreludebpl.1131:15|
 :skolemid |1852|
 :pattern ( (|Seq#Length| s@@14))
)))
(assert (forall ((s@@15 T@U) (n@@10 Int) ) (!  (=> (= n@@10 0) (= (|Seq#Take| s@@15 n@@10) |Seq#Empty|))
 :qid |DafnyPreludebpl.1295:15|
 :skolemid |1886|
 :pattern ( (|Seq#Take| s@@15 n@@10))
)))
...
(assert (forall ((v@@5 T@U) (t0@@4 T@U) ) (! (= ($Is SeqType v@@5 (TSeq t0@@4)) (forall ((i@@6 Int) ) (!  (=> (and (<= 0 i@@6) (< i@@6 (|Seq#Length| v@@5))) ($IsBox (|Seq#Index| v@@5 i@@6) t0@@4))
...
(assert (forall ((s@@16 T@U) (i@@7 Int) ) (!  (=> (and (<= 0 i@@7) (< i@@7 (|Seq#Length| s@@16))) (< (DtRank ($Unbox DatatypeTypeType (|Seq#Index| s@@16 i@@7))) (|Seq#Rank| s@@16)))
 :qid |DafnyPreludebpl.1353:15|
 :skolemid |1897|
 :pattern ( (DtRank ($Unbox DatatypeTypeType (|Seq#Index| s@@16 i@@7))))
)))
(push 1)
...
(declare-fun |let#0_0_1_0_0#0#0| () T@U)
(declare-fun |dt_update_tmp#0#Z#0_0_1_0_0@0| () T@U)
(declare-fun |let#0_0_1_0_1#0#0| () Int)
(declare-fun |dt_update#index#0#Z#0_0_1_0_0@0| () Int)
(declare-fun |$rhs#0_0_1_0_0@0| () T@U)
(declare-fun $Heap@2 () T@U)
(declare-fun |$rhs#0_0_0_0@0| () T@U)
(declare-fun $Heap@1 () T@U)
(declare-fun |call4formal@j#0| () Int)
(set-info :boogie-vc-id Impl$$M3.Container.Remove)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 35) (let ((anon12_correct  (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@6 M3.Container.Contents)) (=> (and (= |$rhs#0@0| (|Set#Difference| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@6) M3.Container.Contents)) (|Set#UnionOne| |Set#Empty| |t#0|))) (= $Heap@8 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@7 this@@6 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@6) M3.Container.Contents ($Box SetType |$rhs#0@0|))))) (=> (and (and ($IsGoodHeap $Heap@8) ($IsAllocBox ($Box refType this@@6) (Tclass.M3.Container? M3.Container$T@@24) $Heap@8)) (and (|M3.Container.Valid_k_k#canCall| M3.Container$T@@24 $Heap@8 this@@6) (|M3.Container.Valid_k_k#canCall| M3.Container$T@@24 $Heap@8 this@@6))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (M3.Container.Valid_k_k M3.Container$T@@24 $Heap@8 this@@6)) (=> (M3.Container.Valid_k_k M3.Container$T@@24 $Heap@8 this@@6) (=> (and (and ($IsAllocBox ($Box refType this@@6) (Tclass.M3.Container? M3.Container$T@@24) $Heap@8) (|M3.Container.Valid_k#canCall| M3.Container$T@@24 $Heap@8 this@@6)) (and (|M3.Container.Valid_k#canCall| M3.Container$T@@24 $Heap@8 this@@6) (M3.Container.Valid_k M3.Container$T@@24 $Heap@8 this@@6))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> false (=> (|M3.Container.Valid#canCall| M3.Container$T@@24 $Heap@8 this@@6) (or (M3.Container.Valid M3.Container$T@@24 $Heap@8 this@@6) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) M3.Container.Repr)) ($Box refType this@@6)))))) (=> (=> false (=> (|M3.Container.Valid#canCall| M3.Container$T@@24 $Heap@8 this@@6) (or (M3.Container.Valid M3.Container$T@@24 $Heap@8 this@@6) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) M3.Container.Repr)) ($Box refType this@@6))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> false (=> (|M3.Container.Valid#canCall| M3.Container$T@@24 $Heap@8 this@@6) (or (M3.Container.Valid M3.Container$T@@24 $Heap@8 this@@6) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) M3.Container.Repr)) ($Box refType null))))))) (=> (=> false (=> (|M3.Container.Valid#canCall| M3.Container$T@@24 $Heap@8 this@@6) (or (M3.Container.Valid M3.Container$T@@24 $Heap@8 this@@6) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) M3.Container.Repr)) ($Box refType null)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> false (=> (|M3.Container.Valid#canCall| M3.Container$T@@24 $Heap@8 this@@6) (or (M3.Container.Valid M3.Container$T@@24 $Heap@8 this@@6) (=> (|M3.Container.Valid_k#canCall| M3.Container$T@@24 $Heap@8 this@@6) (or (M3.Container.Valid_k M3.Container$T@@24 $Heap@8 this@@6) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) M3.Container.Contents)) (|Set#FromBoogieMap| (|lambda#1| M3.Container$T@@24 ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) M3.Container.elems))))))))))) (=> (=> false (=> (|M3.Container.Valid#canCall| M3.Container$T@@24 $Heap@8 this@@6) (or (M3.Container.Valid M3.Container$T@@24 $Heap@8 this@@6) (=> (|M3.Container.Valid_k#canCall| M3.Container$T@@24 $Heap@8 this@@6) (or (M3.Container.Valid_k M3.Container$T@@24 $Heap@8 this@@6) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) M3.Container.Contents)) (|Set#FromBoogieMap| (|lambda#1| M3.Container$T@@24 ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) M3.Container.elems)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> false (=> (|M3.Container.Valid#canCall| M3.Container$T@@24 $Heap@8 this@@6) (or (M3.Container.Valid M3.Container$T@@24 $Heap@8 this@@6) (=> (|M3.Container.Valid_k#canCall| M3.Container$T@@24 $Heap@8 this@@6) (or (M3.Container.Valid_k M3.Container$T@@24 $Heap@8 this@@6) (forall ((|i#3| Int) (|j#3| Int) ) (!  (=> (and (and (<= (LitInt 0) |i#3|) (< |i#3| |j#3|)) (< |j#3| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) M3.Container.elems))))) (or (not (= (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) M3.Container.elems)) |i#3|) (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) M3.Container.elems)) |j#3|))) (not true)))
 :qid |CachedContainerdfy.86:15|
 :skolemid |2208|
 :pattern ( (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) M3.Container.elems)) |j#3|) (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) M3.Container.elems)) |i#3|))
)))))))) (=> (=> false (=> (|M3.Container.Valid#canCall| M3.Container$T@@24 $Heap@8 this@@6) (or (M3.Container.Valid M3.Container$T@@24 $Heap@8 this@@6) (=> (|M3.Container.Valid_k#canCall| M3.Container$T@@24 $Heap@8 this@@6) (or (M3.Container.Valid_k M3.Container$T@@24 $Heap@8 this@@6) (forall ((|i#3@@0| Int) (|j#3@@0| Int) ) (!  (=> (and (and (<= (LitInt 0) |i#3@@0|) (< |i#3@@0| |j#3@@0|)) (< |j#3@@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) M3.Container.elems))))) (or (not (= (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) M3.Container.elems)) |i#3@@0|) (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) M3.Container.elems)) |j#3@@0|))) (not true)))
 :qid |CachedContainerdfy.86:15|
 :skolemid |2208|
 :pattern ( (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) M3.Container.elems)) |j#3@@0|) (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) M3.Container.elems)) |i#3@@0|))
))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> false (=> (|M3.Container.Valid#canCall| M3.Container$T@@24 $Heap@8 this@@6) (or (M3.Container.Valid M3.Container$T@@24 $Heap@8 this@@6) (=> (|M3.Container.Valid_k#canCall| M3.Container$T@@24 $Heap@8 this@@6) (or (M3.Container.Valid_k M3.Container$T@@24 $Heap@8 this@@6) (M3.Container.Valid_k_k M3.Container$T@@24 $Heap@8 this@@6))))))) (=> (=> false (=> (|M3.Container.Valid#canCall| M3.Container$T@@24 $Heap@8 this@@6) (or (M3.Container.Valid M3.Container$T@@24 $Heap@8 this@@6) (=> (|M3.Container.Valid_k#canCall| M3.Container$T@@24 $Heap@8 this@@6) (or (M3.Container.Valid_k M3.Container$T@@24 $Heap@8 this@@6) (M3.Container.Valid_k_k M3.Container$T@@24 $Heap@8 this@@6)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> false (and (forall (($o@@15 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) M3.Container.Repr)) ($Box refType $o@@15)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@6) M3.Container.Repr)) ($Box refType $o@@15)))) (or (not (= $o@@15 null)) (not true)))
 :qid |CachedContainerdfy.44:12|
 :skolemid |2210|
 :pattern (  (or (not (= $o@@15 null)) (not true)))
)) (forall (($o@@16 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) M3.Container.Repr)) ($Box refType $o@@16)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@6) M3.Container.Repr)) ($Box refType $o@@16)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@16) alloc)))))
 :qid |CachedContainerdfy.44:12|
 :skolemid |2211|
...
)))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@6) M3.Container.Contents)) (|Set#Difference| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@6) M3.Container.Contents)) (|Set#UnionOne| |Set#Empty| |t#0|)))))))))))))))))))))))))
(let ((anon10_correct  (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@6 M3.Container.elems)) (=> (and (<= 0 |call4formal@j#0@0|) (<= |call4formal@j#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@6) M3.Container.elems))))) (=> (and (and (and (<= 0 (+ |call4formal@j#0@0| 1)) (<= (+ |call4formal@j#0@0| 1) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@6) M3.Container.elems))))) (= |$rhs#0_0@0| (|Seq#Append| (|Seq#Take| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@6) M3.Container.elems)) |call4formal@j#0@0|) (|Seq#Drop| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@6) M3.Container.elems)) (+ |call4formal@j#0@0| 1))))) (and (and (= $Heap@6 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@5 this@@6 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@6) M3.Container.elems ($Box SeqType |$rhs#0_0@0|)))) ($IsGoodHeap $Heap@6)) (and (= $Heap@7 $Heap@6) (= (ControlFlow 0 11) 2)))) anon12_correct)))))
(let ((anon8_correct  (=> (and (= $Heap@5 $Heap@4) (= (ControlFlow 0 13) 11)) anon10_correct)))
(let ((anon7_correct  (=> (and (= $Heap@4 $Heap@3) (= (ControlFlow 0 16) 13)) anon8_correct)))
(let ((anon16_Else_correct  (=> (<= (M3.Cache.index ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) M3.Container.cache))) |call4formal@j#0@0|) (=> (and (= $Heap@3 $Heap@0) (= (ControlFlow 0 23) 16)) anon7_correct))))
(let ((anon16_Then_correct  (=> (< |call4formal@j#0@0| (M3.Cache.index ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) M3.Container.cache)))) (and (=> (= (ControlFlow 0 17) (- 0 22)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@6 M3.Container.cache))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@6 M3.Container.cache)) (and (=> (= (ControlFlow 0 17) (- 0 21)) (M3.Cache.Some_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) M3.Container.cache)))) (=> (M3.Cache.Some_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) M3.Container.cache))) (=> (= |let#0_0_1_0_0#0#0| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) M3.Container.cache))) (=> (and ($Is DatatypeTypeType |let#0_0_1_0_0#0#0| (Tclass.M3.Cache M3.Container$T@@24)) (= |dt_update_tmp#0#Z#0_0_1_0_0@0| |let#0_0_1_0_0#0#0|)) (and (=> (= (ControlFlow 0 17) (- 0 20)) (M3.Cache.Some_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) M3.Container.cache)))) (=> (M3.Cache.Some_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) M3.Container.cache))) (and (=> (= (ControlFlow 0 17) (- 0 19)) ($Is intType (int_2_U (- (M3.Cache.index ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) M3.Container.cache))) 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- (M3.Cache.index ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) M3.Container.cache))) 1)) Tclass._System.nat) (=> (= |let#0_0_1_0_1#0#0| (- (M3.Cache.index ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) M3.Container.cache))) 1)) (=> (and ($Is intType (int_2_U |let#0_0_1_0_1#0#0|) Tclass._System.nat) (= |dt_update#index#0#Z#0_0_1_0_0@0| |let#0_0_1_0_1#0#0|)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (M3.Cache.Some_q |dt_update_tmp#0#Z#0_0_1_0_0@0|)) (=> (M3.Cache.Some_q |dt_update_tmp#0#Z#0_0_1_0_0@0|) (=> (= |$rhs#0_0_1_0_0@0| (let ((|dt_update_tmp#0#0_0_1_0_0| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) M3.Container.cache))))
(let ((|dt_update#index#0#0_0_1_0_0| (- (M3.Cache.index ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) M3.Container.cache))) 1)))
(|#M3.Cache.Some| |dt_update#index#0#0_0_1_0_0| (M3.Cache.value |dt_update_tmp#0#0_0_1_0_0|))))) (=> (and (and (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 this@@6 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) M3.Container.cache ($Box DatatypeTypeType |$rhs#0_0_1_0_0@0|)))) ($IsGoodHeap $Heap@2)) (and (= $Heap@3 $Heap@2) (= (ControlFlow 0 17) 16))) anon7_correct)))))))))))))))))))
(let ((anon15_Else_correct  (=> (or (not (= (M3.Cache.index ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) M3.Container.cache))) |call4formal@j#0@0|)) (not true)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (M3.Cache.Some_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) M3.Container.cache)))) (=> (M3.Cache.Some_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) M3.Container.cache))) (and (=> (= (ControlFlow 0 24) 17) anon16_Then_correct) (=> (= (ControlFlow 0 24) 23) anon16_Else_correct)))))))
(let ((anon15_Then_correct  (=> (= (M3.Cache.index ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) M3.Container.cache))) |call4formal@j#0@0|) (and (=> (= (ControlFlow 0 14) (- 0 15)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@6 M3.Container.cache))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@6 M3.Container.cache)) (=> (= |$rhs#0_0_0_0@0| (Lit DatatypeTypeType |#M3.Cache.None|)) (=> (and (and (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 this@@6 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) M3.Container.cache ($Box DatatypeTypeType |$rhs#0_0_0_0@0|)))) ($IsGoodHeap $Heap@1)) (and (= $Heap@4 $Heap@1) (= (ControlFlow 0 14) 13))) anon8_correct)))))))
(let ((anon14_Then_correct  (=> (M3.Cache.Some_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) M3.Container.cache))) (and (=> (= (ControlFlow 0 26) (- 0 27)) (M3.Cache.Some_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) M3.Container.cache)))) (=> (M3.Cache.Some_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) M3.Container.cache))) (and (=> (= (ControlFlow 0 26) 14) anon15_Then_correct) (=> (= (ControlFlow 0 26) 24) anon15_Else_correct)))))))
(let ((anon14_Else_correct  (=> (not (M3.Cache.Some_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) M3.Container.cache)))) (=> (and (= $Heap@5 $Heap@0) (= (ControlFlow 0 12) 11)) anon10_correct))))
(let ((anon13_Then_correct  (=> (< |call4formal@j#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) M3.Container.elems)))) (and (=> (= (ControlFlow 0 28) 26) anon14_Then_correct) (=> (= (ControlFlow 0 28) 12) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (<= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@6) M3.Container.elems))) |call4formal@j#0@0|) (=> (and (= $Heap@7 $Heap@0) (= (ControlFlow 0 10) 2)) anon12_correct))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#7| null $Heap@@3 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@6) M3.Container.Repr)))) (<= (LitInt 0) |call4formal@j#0|)) (and (=> (= (ControlFlow 0 29) (- 0 34)) (=> (|M3.Container.Valid#canCall| M3.Container$T@@24 $Heap@@3 this@@6) (or (M3.Container.Valid M3.Container$T@@24 $Heap@@3 this@@6) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@6) M3.Container.Repr)) ($Box refType this@@6))))) (=> (=> (|M3.Container.Valid#canCall| M3.Container$T@@24 $Heap@@3 this@@6) (or (M3.Container.Valid M3.Container$T@@24 $Heap@@3 this@@6) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@6) M3.Container.Repr)) ($Box refType this@@6)))) (and (=> (= (ControlFlow 0 29) (- 0 33)) (=> (|M3.Container.Valid#canCall| M3.Container$T@@24 $Heap@@3 this@@6) (or (M3.Container.Valid M3.Container$T@@24 $Heap@@3 this@@6) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@6) M3.Container.Repr)) ($Box refType null)))))) (=> (=> (|M3.Container.Valid#canCall| M3.Container$T@@24 $Heap@@3 this@@6) (or (M3.Container.Valid M3.Container$T@@24 $Heap@@3 this@@6) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@6) M3.Container.Repr)) ($Box refType null))))) (and (=> (= (ControlFlow 0 29) (- 0 32)) (=> (|M3.Container.Valid#canCall| M3.Container$T@@24 $Heap@@3 this@@6) (or (M3.Container.Valid M3.Container$T@@24 $Heap@@3 this@@6) (=> (|M3.Container.Valid_k#canCall| M3.Container$T@@24 $Heap@@3 this@@6) (or (M3.Container.Valid_k M3.Container$T@@24 $Heap@@3 this@@6) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@6) M3.Container.Contents)) (|Set#FromBoogieMap| (|lambda#1| M3.Container$T@@24 ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@6) M3.Container.elems)))))))))) (=> (=> (|M3.Container.Valid#canCall| M3.Container$T@@24 $Heap@@3 this@@6) (or (M3.Container.Valid M3.Container$T@@24 $Heap@@3 this@@6) (=> (|M3.Container.Valid_k#canCall| M3.Container$T@@24 $Heap@@3 this@@6) (or (M3.Container.Valid_k M3.Container$T@@24 $Heap@@3 this@@6) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@6) M3.Container.Contents)) (|Set#FromBoogieMap| (|lambda#1| M3.Container$T@@24 ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@6) M3.Container.elems))))))))) (and (=> (= (ControlFlow 0 29) (- 0 31)) (=> (|M3.Container.Valid#canCall| M3.Container$T@@24 $Heap@@3 this@@6) (or (M3.Container.Valid M3.Container$T@@24 $Heap@@3 this@@6) (=> (|M3.Container.Valid_k#canCall| M3.Container$T@@24 $Heap@@3 this@@6) (or (M3.Container.Valid_k M3.Container$T@@24 $Heap@@3 this@@6) (forall ((|i#0@@1| Int) (|j#1| Int) ) (!  (=> (and (and (<= (LitInt 0) |i#0@@1|) (< |i#0@@1| |j#1|)) (< |j#1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@6) M3.Container.elems))))) (or (not (= (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@6) M3.Container.elems)) |i#0@@1|) (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@6) M3.Container.elems)) |j#1|))) (not true)))
 :qid |CachedContainerdfy.86:15|
 :skolemid |2165|
