...
(declare-fun |##s#0_1@0| () Int)
(declare-fun |##t#0_1@0| () Int)
(declare-fun |##c#0_0@0| () T@U)
(declare-fun |##t#0_0@0| () Int)
(declare-fun |##c#0_0_2@0| () T@U)
(declare-fun |##t#0_0_2@0| () Int)
(declare-fun |##c#0_0_1@0| () T@U)
(declare-fun |##s#0_0_1@0| () Int)
...
(set-info :boogie-vc-id Impl$$_module.__default.StepIncInc)
...
(let ((anon9_Else_correct  (=> (and (not (_module.__default.CoBigStep ($LS $LZ) (Lit DatatypeTypeType |#_module.cmd.Inc|) |s#0@@8| (+ |s#0@@8| 1))) (= (ControlFlow 0 11) 9)) anon3_correct)))
(let ((anon9_Then_correct  (=> (_module.__default.CoBigStep ($LS $LZ) (Lit DatatypeTypeType |#_module.cmd.Inc|) |s#0@@8| (+ |s#0@@8| 1)) (=> (and (and (and (= |##c#0_1@0| (Lit DatatypeTypeType |#_module.cmd.Inc|)) ($IsAlloc DatatypeTypeType |##c#0_1@0| Tclass._module.cmd $Heap)) (and (= |##s#0_1@0| (+ |s#0@@8| 1)) ($IsAlloc intType (int_2_U |##s#0_1@0|) TInt $Heap))) (and (and (= |##t#0_1@0| (+ |s#0@@8| 2)) ($IsAlloc intType (int_2_U |##t#0_1@0|) TInt $Heap)) (and (|_module.__default.CoBigStep#canCall| (Lit DatatypeTypeType |#_module.cmd.Inc|) (+ |s#0@@8| 1) (+ |s#0@@8| 2)) (= (ControlFlow 0 10) 9)))) anon3_correct))))
(let ((anon8_Then_correct  (=> (and (= |##c#0_0@0| (Lit DatatypeTypeType |#_module.cmd.Inc|)) ($IsAlloc DatatypeTypeType |##c#0_0@0| Tclass._module.cmd $Heap)) (=> (and (and ($IsAlloc intType (int_2_U |s#0@@8|) TInt $Heap) (= |##t#0_0@0| (+ |s#0@@8| 1))) (and ($IsAlloc intType (int_2_U |##t#0_0@0|) TInt $Heap) (|_module.__default.CoBigStep#canCall| (Lit DatatypeTypeType |#_module.cmd.Inc|) |s#0@@8| (+ |s#0@@8| 1)))) (and (=> (= (ControlFlow 0 12) 10) anon9_Then_correct) (=> (= (ControlFlow 0 12) 11) anon9_Else_correct))))))
(let ((anon6_correct  (=> (and (|_module.__default.CoBigStep#canCall| (Lit DatatypeTypeType |#_module.cmd.Inc|) |s#0@@8| (+ |s#0@@8| 1)) (=> (_module.__default.CoBigStep ($LS $LZ) (Lit DatatypeTypeType |#_module.cmd.Inc|) |s#0@@8| (+ |s#0@@8| 1)) (|_module.__default.CoBigStep#canCall| (Lit DatatypeTypeType |#_module.cmd.Inc|) (+ |s#0@@8| 1) (+ |s#0@@8| 2)))) (=> (and (and (and (and (_module.__default.CoBigStep ($LS $LZ) (Lit DatatypeTypeType |#_module.cmd.Inc|) |s#0@@8| (+ |s#0@@8| 1)) (_module.__default.CoBigStep ($LS $LZ) (Lit DatatypeTypeType |#_module.cmd.Inc|) (+ |s#0@@8| 1) (+ |s#0@@8| 2))) (and (= |##c#0_0_2@0| (Lit DatatypeTypeType (|#_module.cmd.Seq| (Lit DatatypeTypeType |#_module.cmd.Inc|) (Lit DatatypeTypeType |#_module.cmd.Inc|)))) ($IsAlloc DatatypeTypeType |##c#0_0_2@0| Tclass._module.cmd $Heap))) (and (and ($IsAlloc intType (int_2_U |s#0@@8|) TInt $Heap) (= |##t#0_0_2@0| (+ |s#0@@8| 2))) (and ($IsAlloc intType (int_2_U |##t#0_0_2@0|) TInt $Heap) (|_module.__default.CoBigStep#canCall| (Lit DatatypeTypeType (|#_module.cmd.Seq| (Lit DatatypeTypeType |#_module.cmd.Inc|) (Lit DatatypeTypeType |#_module.cmd.Inc|))) |s#0@@8| (+ |s#0@@8| 2))))) (and (and (and (|_module.__default.CoBigStep#canCall| (Lit DatatypeTypeType (|#_module.cmd.Seq| (Lit DatatypeTypeType |#_module.cmd.Inc|) (Lit DatatypeTypeType |#_module.cmd.Inc|))) |s#0@@8| (+ |s#0@@8| 2)) (= (ControlFlow 0 5) (- 0 4))) (and (_module.__default.CoBigStep ($LS $LZ) (Lit DatatypeTypeType |#_module.cmd.Inc|) |s#0@@8| (+ |s#0@@8| 1)) (_module.__default.CoBigStep ($LS $LZ) (Lit DatatypeTypeType |#_module.cmd.Inc|) (+ |s#0@@8| 1) (+ |s#0@@8| 2)))) (|_module.__default.CoBigStep#canCall| (Lit DatatypeTypeType (|#_module.cmd.Seq| (Lit DatatypeTypeType |#_module.cmd.Inc|) (Lit DatatypeTypeType |#_module.cmd.Inc|))) |s#0@@8| (+ |s#0@@8| 2)))) (_module.__default.CoBigStep ($LS $LZ) (Lit DatatypeTypeType (|#_module.cmd.Seq| (Lit DatatypeTypeType |#_module.cmd.Inc|) (Lit DatatypeTypeType |#_module.cmd.Inc|))) |s#0@@8| (+ |s#0@@8| 2))))))
(let ((anon11_Else_correct  (=> (and (not (_module.__default.CoBigStep ($LS $LZ) (Lit DatatypeTypeType |#_module.cmd.Inc|) |s#0@@8| (+ |s#0@@8| 1))) (= (ControlFlow 0 7) 5)) anon6_correct)))
(let ((anon11_Then_correct  (=> (_module.__default.CoBigStep ($LS $LZ) (Lit DatatypeTypeType |#_module.cmd.Inc|) |s#0@@8| (+ |s#0@@8| 1)) (=> (and (and (and (= |##c#0_0_1@0| (Lit DatatypeTypeType |#_module.cmd.Inc|)) ($IsAlloc DatatypeTypeType |##c#0_0_1@0| Tclass._module.cmd $Heap)) (and (= |##s#0_0_1@0| (+ |s#0@@8| 1)) ($IsAlloc intType (int_2_U |##s#0_0_1@0|) TInt $Heap))) (and (and (= |##t#0_0_1@0| (+ |s#0@@8| 2)) ($IsAlloc intType (int_2_U |##t#0_0_1@0|) TInt $Heap)) (and (|_module.__default.CoBigStep#canCall| (Lit DatatypeTypeType |#_module.cmd.Inc|) (+ |s#0@@8| 1) (+ |s#0@@8| 2)) (= (ControlFlow 0 6) 5)))) anon6_correct))))
(let ((anon10_Then_correct  (=> (and (= |##c#0_0_0@0| (Lit DatatypeTypeType |#_module.cmd.Inc|)) ($IsAlloc DatatypeTypeType |##c#0_0_0@0| Tclass._module.cmd $Heap)) (=> (and (and ($IsAlloc intType (int_2_U |s#0@@8|) TInt $Heap) (= |##t#0_0_0@0| (+ |s#0@@8| 1))) (and ($IsAlloc intType (int_2_U |##t#0_0_0@0|) TInt $Heap) (|_module.__default.CoBigStep#canCall| (Lit DatatypeTypeType |#_module.cmd.Inc|) |s#0@@8| (+ |s#0@@8| 1)))) (and (=> (= (ControlFlow 0 8) 6) anon11_Then_correct) (=> (= (ControlFlow 0 8) 7) anon11_Else_correct))))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.__default.CoBigStep#canCall| (Lit DatatypeTypeType (|#_module.cmd.Seq| (Lit DatatypeTypeType |#_module.cmd.Inc|) (Lit DatatypeTypeType |#_module.cmd.Inc|))) |s#0@@8| (+ |s#0@@8| 2)) (_module.__default.CoBigStep ($LS $LZ) (Lit DatatypeTypeType (|#_module.cmd.Seq| (Lit DatatypeTypeType |#_module.cmd.Inc|) (Lit DatatypeTypeType |#_module.cmd.Inc|))) |s#0@@8| (+ |s#0@@8| 2))))))
(let ((anon10_Else_correct  (=> (and (=> (and (_module.__default.CoBigStep ($LS $LZ) (Lit DatatypeTypeType |#_module.cmd.Inc|) |s#0@@8| (+ |s#0@@8| 1)) (_module.__default.CoBigStep ($LS $LZ) (Lit DatatypeTypeType |#_module.cmd.Inc|) (+ |s#0@@8| 1) (+ |s#0@@8| 2))) (_module.__default.CoBigStep ($LS $LZ) (Lit DatatypeTypeType (|#_module.cmd.Seq| (Lit DatatypeTypeType |#_module.cmd.Inc|) (Lit DatatypeTypeType |#_module.cmd.Inc|))) |s#0@@8| (+ |s#0@@8| 2))) (= (ControlFlow 0 3) 2)) GeneratedUnifiedExit_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 13) 12) anon8_Then_correct) (=> (= (ControlFlow 0 13) 8) anon10_Then_correct)) (=> (= (ControlFlow 0 13) 3) anon10_Else_correct)))))
