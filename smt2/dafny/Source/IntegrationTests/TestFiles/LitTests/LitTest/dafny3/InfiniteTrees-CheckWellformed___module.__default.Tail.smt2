...
(declare-fun _module._default.Tail$_T0@@5 () T@U)
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Tail)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon11_Else_correct  (=> (and (not (|$Eq#_module.Stream| _module._default.Tail$_T0@@5 _module._default.Tail$_T0@@5 ($LS ($LS $LZ)) |t#Z#0@0| |#_module.Stream.Nil|)) (= (ControlFlow 0 5) (- 0 4))) (_module.Stream.Cons_q |t#Z#0@0|))))
(let ((anon11_Then_correct true))
(let ((anon10_Else_correct  (=> (and (or (not (= |n#0@@5| (LitInt 0))) (not true)) ($IsAlloc DatatypeTypeType |s#0@@5| (Tclass._module.Stream _module._default.Tail$_T0@@5) $Heap@@0)) (and (=> (= (ControlFlow 0 6) (- 0 9)) ($Is intType (int_2_U (- |n#0@@5| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0@@5| 1)) Tclass._System.nat) (=> (and (= |##n#0@0| (- |n#0@@5| 1)) ($IsAlloc intType (int_2_U |##n#0@0|) Tclass._System.nat $Heap@@0)) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (<= 0 |n#0@@5|) (= |##n#0@0| |n#0@@5|))) (=> (or (<= 0 |n#0@@5|) (= |##n#0@0| |n#0@@5|)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (< |##n#0@0| |n#0@@5|)) (=> (< |##n#0@0| |n#0@@5|) (=> (|_module.__default.Tail#canCall| _module._default.Tail$_T0@@5 |s#0@@5| (- |n#0@@5| 1)) (=> (and (and (= |let#0#0#0| (_module.__default.Tail _module._default.Tail$_T0@@5 ($LS $LZ) |s#0@@5| (- |n#0@@5| 1))) (|_module.__default.Tail#canCall| _module._default.Tail$_T0@@5 |s#0@@5| (- |n#0@@5| 1))) (and ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.Stream _module._default.Tail$_T0@@5)) (= |t#Z#0@0| |let#0#0#0|))) (and (=> (= (ControlFlow 0 6) 3) anon11_Then_correct) (=> (= (ControlFlow 0 6) 5) anon11_Else_correct))))))))))))))
(let ((anon10_Then_correct true))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (and (and (=> (= (ControlFlow 0 10) 1) anon9_Then_correct) (=> (= (ControlFlow 0 10) 2) anon10_Then_correct)) (=> (= (ControlFlow 0 10) 6) anon10_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is DatatypeTypeType |s#0@@5| (Tclass._module.Stream _module._default.Tail$_T0@@5)) (<= (LitInt 0) |n#0@@5|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct))))
