...
(declare-fun |p#1| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.Path__Lemma2_k_k_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.__default.InfinitePath_k_h#canCall| |_k#0@@16| (_module.__default.S2N_k ($LS $LZ) |n#1@@0| |tail#3@@0|)) (or (_module.__default.InfinitePath_k_h ($LS $LZ) |_k#0@@16| (_module.__default.S2N_k ($LS $LZ) |n#1@@0| |tail#3@@0|)) (=> (< 0 (|ORD#Offset| |_k#0@@16|)) (=> (_module.Number.Succ_q (_module.__default.S2N_k ($LS $LZ) |n#1@@0| |tail#3@@0|)) (let ((|next#4@@0| (_module.Number._h4 (_module.__default.S2N_k ($LS ($LS $LZ)) |n#1@@0| |tail#3@@0|))))
(_module.__default.InfinitePath_k_h ($LS ($LS $LZ)) (|ORD#Minus| |_k#0@@16| (|ORD#FromNat| 1)) |next#4@@0|))))))) (=> (=> (|_module.__default.InfinitePath_k_h#canCall| |_k#0@@16| (_module.__default.S2N_k ($LS $LZ) |n#1@@0| |tail#3@@0|)) (or (_module.__default.InfinitePath_k_h ($LS $LZ) |_k#0@@16| (_module.__default.S2N_k ($LS $LZ) |n#1@@0| |tail#3@@0|)) (=> (< 0 (|ORD#Offset| |_k#0@@16|)) (=> (_module.Number.Succ_q (_module.__default.S2N_k ($LS $LZ) |n#1@@0| |tail#3@@0|)) (let ((|next#4@@1| (_module.Number._h4 (_module.__default.S2N_k ($LS ($LS $LZ)) |n#1@@0| |tail#3@@0|))))
(_module.__default.InfinitePath_k_h ($LS ($LS $LZ)) (|ORD#Minus| |_k#0@@16| (|ORD#FromNat| 1)) |next#4@@1|)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.__default.InfinitePath_k_h#canCall| |_k#0@@16| (_module.__default.S2N_k ($LS $LZ) |n#1@@0| |tail#3@@0|)) (or (_module.__default.InfinitePath_k_h ($LS $LZ) |_k#0@@16| (_module.__default.S2N_k ($LS $LZ) |n#1@@0| |tail#3@@0|)) (=> (< 0 (|ORD#Offset| |_k#0@@16|)) (=> (not (_module.Number.Succ_q (_module.__default.S2N_k ($LS $LZ) |n#1@@0| |tail#3@@0|))) (let ((|r#4@@0| (_module.Number._h5 (_module.__default.S2N_k ($LS ($LS $LZ)) |n#1@@0| |tail#3@@0|))))
(_module.__default.InfinitePath_h ($LS ($LS $LZ)) (|ORD#Minus| |_k#0@@16| (|ORD#FromNat| 1)) |r#4@@0|))))))) (=> (=> (|_module.__default.InfinitePath_k_h#canCall| |_k#0@@16| (_module.__default.S2N_k ($LS $LZ) |n#1@@0| |tail#3@@0|)) (or (_module.__default.InfinitePath_k_h ($LS $LZ) |_k#0@@16| (_module.__default.S2N_k ($LS $LZ) |n#1@@0| |tail#3@@0|)) (=> (< 0 (|ORD#Offset| |_k#0@@16|)) (=> (not (_module.Number.Succ_q (_module.__default.S2N_k ($LS $LZ) |n#1@@0| |tail#3@@0|))) (let ((|r#4@@1| (_module.Number._h5 (_module.__default.S2N_k ($LS ($LS $LZ)) |n#1@@0| |tail#3@@0|))))
(_module.__default.InfinitePath_h ($LS ($LS $LZ)) (|ORD#Minus| |_k#0@@16| (|ORD#FromNat| 1)) |r#4@@1|)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.__default.InfinitePath_k_h#canCall| |_k#0@@16| (_module.__default.S2N_k ($LS $LZ) |n#1@@0| |tail#3@@0|)) (or (_module.__default.InfinitePath_k_h ($LS $LZ) |_k#0@@16| (_module.__default.S2N_k ($LS $LZ) |n#1@@0| |tail#3@@0|)) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@16|)) (forall ((|_k'#1@@5| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@5| |_k#0@@16|) (_module.__default.InfinitePath_k_h ($LS ($LS $LZ)) |_k'#1@@5| (_module.__default.S2N_k ($LS ($LS $LZ)) |n#1@@0| |tail#3@@0|)))
 :qid |InfiniteTreesdfy.440:20|
 :skolemid |1113|
 :pattern ( (_module.__default.InfinitePath_k_h ($LS ($LS $LZ)) |_k'#1@@5| (_module.__default.S2N_k ($LS ($LS $LZ)) |n#1@@0| |tail#3@@0|)))
))))))))))))
(let ((anon3_Else_correct  (=> (<= (|ORD#Offset| |_k#0@@16|) 0) (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (= $Heap@0 $Heap@2)) (and (forall ((|_k'#2@@5| T@U) (|p#2| T@U) (|n#2| Int) (|tail#8@@0| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |p#2| (Tclass._module.Stream TInt)) (<= (LitInt 0) |n#2|)) ($Is DatatypeTypeType |tail#8@@0| (Tclass._module.Stream TInt))) (and (|ORD#Less| |_k'#2@@5| |_k#0@@16|) (and (_module.__default.IsNeverEndingStream TInt ($LS $LZ) |p#2|) (|$Eq#_module.Stream| TInt TInt ($LS ($LS $LZ)) (_module.Stream.tail |p#2|) |tail#8@@0|)))) (_module.__default.InfinitePath_k_h ($LS $LZ) |_k'#2@@5| (_module.__default.S2N_k ($LS $LZ) |n#2| |tail#8@@0|)))
 :qid |InfiniteTreesdfy.629:16|
 :skolemid |1118|
 :pattern ( (_module.__default.S2N_k ($LS $LZ) |n#2| |tail#8@@0|) (_module.Stream.tail |p#2|) (|ORD#Less| |_k'#2@@5| |_k#0@@16|))
 :pattern ( (_module.__default.S2N_k ($LS $LZ) |n#2| |tail#8@@0|) (_module.__default.IsNeverEndingStream TInt ($LS $LZ) |p#2|) (|ORD#Less| |_k'#2@@5| |_k#0@@16|))
)) (= (ControlFlow 0 10) 2))) GeneratedUnifiedExit_correct))))
(let ((anon3_Then_correct  (=> (< 0 (|ORD#Offset| |_k#0@@16|)) (and (=> (= (ControlFlow 0 5) (- 0 9)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@16|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@16|)) (=> (= |_k##0@0| (|ORD#Minus| |_k#0@@16| (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (=> (|_module.__default.IsNeverEndingStream#canCall| TInt |tail#3@@0|) (or (_module.__default.IsNeverEndingStream TInt ($LS $LZ) |tail#3@@0|) (=> (_module.Stream.Nil_q |tail#3@@0|) (U_2_bool (Lit boolType (bool_2_U false))))))) (=> (=> (|_module.__default.IsNeverEndingStream#canCall| TInt |tail#3@@0|) (or (_module.__default.IsNeverEndingStream TInt ($LS $LZ) |tail#3@@0|) (=> (_module.Stream.Nil_q |tail#3@@0|) (U_2_bool (Lit boolType (bool_2_U false)))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (=> (|_module.__default.IsNeverEndingStream#canCall| TInt |tail#3@@0|) (or (_module.__default.IsNeverEndingStream TInt ($LS $LZ) |tail#3@@0|) (=> (not (_module.Stream.Nil_q |tail#3@@0|)) (let ((|tail#2@@0| (_module.Stream.tail |tail#3@@0|)))
(_module.__default.IsNeverEndingStream TInt ($LS ($LS $LZ)) |tail#2@@0|)))))) (=> (=> (|_module.__default.IsNeverEndingStream#canCall| TInt |tail#3@@0|) (or (_module.__default.IsNeverEndingStream TInt ($LS $LZ) |tail#3@@0|) (=> (not (_module.Stream.Nil_q |tail#3@@0|)) (let ((|tail#2@@1| (_module.Stream.tail |tail#3@@0|)))
(_module.__default.IsNeverEndingStream TInt ($LS ($LS $LZ)) |tail#2@@1|))))) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (|_module.__default.S2N#canCall| |tail#3@@0|) (|_module.__default.InfinitePath_h#canCall| |_k##0@0| (_module.__default.S2N ($LS $LZ) |tail#3@@0|)))) (and (and (|_module.__default.InfinitePath_h#canCall| |_k##0@0| (_module.__default.S2N ($LS $LZ) |tail#3@@0|)) (and (_module.__default.InfinitePath_h ($LS $LZ) |_k##0@0| (_module.__default.S2N ($LS $LZ) |tail#3@@0|)) (and (=> (< 0 (|ORD#Offset| |_k##0@0|)) (ite (_module.CoOption.None_q (_module.__default.S2N ($LS $LZ) |tail#3@@0|)) false (let ((|num#3@@0| ($Unbox DatatypeTypeType (_module.CoOption.get (_module.__default.S2N ($LS $LZ) |tail#3@@0|)))))
(_module.__default.InfinitePath_k_h ($LS $LZ) (|ORD#Minus| |_k##0@0| (|ORD#FromNat| 1)) |num#3@@0|)))) (=> (= (LitInt 0) (|ORD#Offset| |_k##0@0|)) (forall ((|_k'#0@@5| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@5| |_k##0@0|) (_module.__default.InfinitePath_h ($LS $LZ) |_k'#0@@5| (_module.__default.S2N ($LS $LZ) |tail#3@@0|)))
 :qid |InfiniteTreesdfy.434:20|
 :skolemid |1096|
 :pattern ( (_module.__default.InfinitePath_h ($LS $LZ) |_k'#0@@5| (_module.__default.S2N ($LS $LZ) |tail#3@@0|)))
)))))) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 5) 2)))) GeneratedUnifiedExit_correct)))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (|$IsA#_module.Stream| |p#1|) (|$IsA#_module.Stream| |tail#3@@0|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#_k0#0| T@U) (|$ih#p0#0| T@U) (|$ih#n0#0| Int) (|$ih#tail0#0| T@U) ) (!  (=> (and (and (and (and ($Is DatatypeTypeType |$ih#p0#0| (Tclass._module.Stream TInt)) (<= (LitInt 0) |$ih#n0#0|)) ($Is DatatypeTypeType |$ih#tail0#0| (Tclass._module.Stream TInt))) (and (_module.__default.IsNeverEndingStream TInt ($LS $LZ) |$ih#p0#0|) (|$Eq#_module.Stream| TInt TInt ($LS ($LS $LZ)) (_module.Stream.tail |$ih#p0#0|) |$ih#tail0#0|))) (or (|ORD#Less| |$ih#_k0#0| |_k#0@@16|) (and (= |$ih#_k0#0| |_k#0@@16|) (and (<= 0 |$ih#n0#0|) (< |$ih#n0#0| |n#1@@0|))))) (_module.__default.InfinitePath_k_h ($LS $LZ) |$ih#_k0#0| (_module.__default.S2N_k ($LS $LZ) |$ih#n0#0| |$ih#tail0#0|)))
 :qid |InfiniteTreesdfy.629:16|
 :skolemid |1116|
 :pattern ( (_module.__default.InfinitePath_k_h ($LS $LZ) |$ih#_k0#0| (_module.__default.S2N_k ($LS $LZ) |$ih#n0#0| |$ih#tail0#0|)) (_module.Stream.tail |$ih#p0#0|))
 :pattern ( (_module.__default.InfinitePath_k_h ($LS $LZ) |$ih#_k0#0| (_module.__default.S2N_k ($LS $LZ) |$ih#n0#0| |$ih#tail0#0|)) (_module.__default.IsNeverEndingStream TInt ($LS $LZ) |$ih#p0#0|))
)))) (and (=> (= (ControlFlow 0 11) 5) anon3_Then_correct) (=> (= (ControlFlow 0 11) 10) anon3_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |p#1| (Tclass._module.Stream TInt)) ($IsAlloc DatatypeTypeType |p#1| (Tclass._module.Stream TInt) $Heap)) (|$IsA#_module.Stream| |p#1|)) (<= (LitInt 0) |n#1@@0|)) (=> (and (and (and (and ($Is DatatypeTypeType |tail#3@@0| (Tclass._module.Stream TInt)) ($IsAlloc DatatypeTypeType |tail#3@@0| (Tclass._module.Stream TInt) $Heap)) (|$IsA#_module.Stream| |tail#3@@0|)) (= 5 $FunctionContextHeight)) (and (and (|_module.__default.IsNeverEndingStream#canCall| TInt |p#1|) (and (_module.__default.IsNeverEndingStream TInt ($LS $LZ) |p#1|) (ite (_module.Stream.Nil_q |p#1|) false (let ((|tail#7@@0| (_module.Stream.tail |p#1|)))
(_module.__default.IsNeverEndingStream TInt ($LS $LZ) |tail#7@@0|))))) (and (|$Eq#_module.Stream| TInt TInt ($LS ($LS $LZ)) (_module.Stream.tail |p#1|) |tail#3@@0|) (= (ControlFlow 0 12) 11)))) anon0_correct)))))
