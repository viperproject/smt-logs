...
(declare-fun $LZ () T@U)
(declare-fun |k#0| () Int)
(set-info :boogie-vc-id Impl$$_module.__default.Theorem0__AutoInd)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.Stream| |M#0@@8|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#k0#0| Int) (|$ih#M0#0| T@U) ) (!  (=> (and (and (and (<= (LitInt 0) |$ih#k0#0|) ($Is DatatypeTypeType |$ih#M0#0| (Tclass._module.Stream Tclass._module.X))) (U_2_bool (Lit boolType (bool_2_U true)))) (and (<= 0 |$ih#k0#0|) (< |$ih#k0#0| |k#0|))) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#FromNat| |$ih#k0#0|) ($LS ($LS $LZ)) (_module.__default.map__fg ($LS $LZ) |$ih#M0#0|) (_module.__default.map__f ($LS $LZ) (_module.__default.map__g ($LS $LZ) |$ih#M0#0|))))
 :qid |Streamsdfy.80:24|
 :skolemid |628|
 :pattern ( (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#FromNat| |$ih#k0#0|) ($LS ($LS $LZ)) (_module.__default.map__fg ($LS $LZ) |$ih#M0#0|) (_module.__default.map__f ($LS $LZ) (_module.__default.map__g ($LS $LZ) |$ih#M0#0|))))
)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#FromNat| |k#0|) ($LS ($LS $LZ)) (_module.__default.map__fg ($LS $LZ) |M#0@@8|) (_module.__default.map__f ($LS $LZ) (_module.__default.map__g ($LS $LZ) |M#0@@8|))) (=> (< 0 |k#0|) (=> (_module.Stream.Nil_q (_module.__default.map__fg ($LS ($LS $LZ)) |M#0@@8|)) (_module.Stream.Nil_q (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.map__g ($LS ($LS $LZ)) |M#0@@8|))))))) (=> (or (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#FromNat| |k#0|) ($LS ($LS $LZ)) (_module.__default.map__fg ($LS $LZ) |M#0@@8|) (_module.__default.map__f ($LS $LZ) (_module.__default.map__g ($LS $LZ) |M#0@@8|))) (=> (< 0 |k#0|) (=> (_module.Stream.Nil_q (_module.__default.map__fg ($LS ($LS $LZ)) |M#0@@8|)) (_module.Stream.Nil_q (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.map__g ($LS ($LS $LZ)) |M#0@@8|)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (or (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#FromNat| |k#0|) ($LS ($LS $LZ)) (_module.__default.map__fg ($LS $LZ) |M#0@@8|) (_module.__default.map__f ($LS $LZ) (_module.__default.map__g ($LS $LZ) |M#0@@8|))) (=> (< 0 |k#0|) (=> (_module.Stream.Cons_q (_module.__default.map__fg ($LS ($LS $LZ)) |M#0@@8|)) (and (_module.Stream.Cons_q (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.map__g ($LS ($LS $LZ)) |M#0@@8|))) (and (= (_module.Stream.head (_module.__default.map__fg ($LS ($LS $LZ)) |M#0@@8|)) (_module.Stream.head (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.map__g ($LS ($LS $LZ)) |M#0@@8|)))) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#FromNat| (- |k#0| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.map__fg ($LS ($LS $LZ)) |M#0@@8|)) (_module.Stream.tail (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.map__g ($LS ($LS $LZ)) |M#0@@8|))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |k#0|)) (=> (and (and (and ($Is DatatypeTypeType |M#0@@8| (Tclass._module.Stream Tclass._module.X)) ($IsAlloc DatatypeTypeType |M#0@@8| (Tclass._module.Stream Tclass._module.X) $Heap)) (|$IsA#_module.Stream| |M#0@@8|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
