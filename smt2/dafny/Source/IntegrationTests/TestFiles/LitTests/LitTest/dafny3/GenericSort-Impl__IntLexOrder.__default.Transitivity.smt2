...
(set-info :boogie-vc-id Impl$$IntLexOrder.__default.Transitivity)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|IntLexOrder.__default.Leq#canCall| |a#0@@1| |c#0|) (or (IntLexOrder.__default.Leq |a#0@@1| |c#0|) (=> (< (IntLexOrder.T.i |a#0@@1|) (IntLexOrder.T.i |c#0|)) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (|IntLexOrder.__default.Leq#canCall| |a#0@@1| |c#0|) (or (IntLexOrder.__default.Leq |a#0@@1| |c#0|) (=> (< (IntLexOrder.T.i |a#0@@1|) (IntLexOrder.T.i |c#0|)) (U_2_bool (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|IntLexOrder.__default.Leq#canCall| |a#0@@1| |c#0|) (or (IntLexOrder.__default.Leq |a#0@@1| |c#0|) (=> (<= (IntLexOrder.T.i |c#0|) (IntLexOrder.T.i |a#0@@1|)) (=> (= (IntLexOrder.T.i |a#0@@1|) (IntLexOrder.T.i |c#0|)) (<= (IntLexOrder.T.j |a#0@@1|) (IntLexOrder.T.j |c#0|))))))) (=> (=> (|IntLexOrder.__default.Leq#canCall| |a#0@@1| |c#0|) (or (IntLexOrder.__default.Leq |a#0@@1| |c#0|) (=> (<= (IntLexOrder.T.i |c#0|) (IntLexOrder.T.i |a#0@@1|)) (=> (= (IntLexOrder.T.i |a#0@@1|) (IntLexOrder.T.i |c#0|)) (<= (IntLexOrder.T.j |a#0@@1|) (IntLexOrder.T.j |c#0|)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|IntLexOrder.__default.Leq#canCall| |a#0@@1| |c#0|) (or (IntLexOrder.__default.Leq |a#0@@1| |c#0|) (=> (<= (IntLexOrder.T.i |c#0|) (IntLexOrder.T.i |a#0@@1|)) (=> (or (not (= (IntLexOrder.T.i |a#0@@1|) (IntLexOrder.T.i |c#0|))) (not true)) (U_2_bool (Lit boolType (bool_2_U false)))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |a#0@@1| Tclass.IntLexOrder.T) ($IsAlloc DatatypeTypeType |a#0@@1| Tclass.IntLexOrder.T $Heap)) (|$IsA#IntLexOrder.T| |a#0@@1|)) (and (and ($Is DatatypeTypeType |b#0@@1| Tclass.IntLexOrder.T) ($IsAlloc DatatypeTypeType |b#0@@1| Tclass.IntLexOrder.T $Heap)) (|$IsA#IntLexOrder.T| |b#0@@1|))) (and (and (and ($Is DatatypeTypeType |c#0| Tclass.IntLexOrder.T) ($IsAlloc DatatypeTypeType |c#0| Tclass.IntLexOrder.T $Heap)) (|$IsA#IntLexOrder.T| |c#0|)) (and (and (= 2 $FunctionContextHeight) (IntLexOrder.__default.Leq |a#0@@1| |b#0@@1|)) (and (IntLexOrder.__default.Leq |b#0@@1| |c#0|) (= (ControlFlow 0 5) 2))))) anon0_correct))))
