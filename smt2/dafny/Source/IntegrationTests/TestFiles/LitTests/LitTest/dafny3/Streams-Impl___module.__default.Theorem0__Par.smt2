...
(set-info :boogie-vc-id Impl$$_module.__default.Theorem0__Par)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (|$Eq#_module.Stream| Tclass._module.X Tclass._module.X ($LS ($LS $LZ)) (_module.__default.map__fg ($LS ($LS $LZ)) |M#0@@8|) (_module.__default.map__f ($LS ($LS $LZ)) (_module.__default.map__g ($LS ($LS $LZ)) |M#0@@8|))))))
(let ((anon3_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (= $Heap@0 $Heap@2)) (and (forall ((|k#0_1| Int) ) (!  (=> (and (<= (LitInt 0) |k#0_1|) (U_2_bool (Lit boolType (bool_2_U true)))) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#FromNat| |k#0_1|) ($LS ($LS $LZ)) (_module.__default.map__fg ($LS $LZ) |M#0@@8|) (_module.__default.map__f ($LS $LZ) (_module.__default.map__g ($LS $LZ) |M#0@@8|))))
 :qid |Streamsdfy.65:10|
 :skolemid |625|
)) (= (ControlFlow 0 4) 3))) GeneratedUnifiedExit_correct)))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.Stream| |M#0@@8|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#M0#0| T@U) ) (! true
 :qid |Streamsdfy.62:20|
 :skolemid |623|
 :pattern ( (_module.__default.map__g ($LS $LZ) |$ih#M0#0|))
 :pattern ( (_module.__default.map__fg ($LS $LZ) |$ih#M0#0|))
)))) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |M#0@@8| (Tclass._module.Stream Tclass._module.X)) ($IsAlloc DatatypeTypeType |M#0@@8| (Tclass._module.Stream Tclass._module.X) $Heap)) (|$IsA#_module.Stream| |M#0@@8|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 6) 5))) anon0_correct))))
