...
(let ((anon3_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (= $Heap@0 $Heap@2)) (and (forall ((|k#0_1| Int) )  (=> (and (<= (LitInt 0) |k#0_1|) (U_2_bool (Lit boolType (bool_2_U true)))) (|$PrefixEq#_module.Stream| Tclass._module.X Tclass._module.X (|ORD#FromNat| |k#0_1|) ($LS ($LS $LZ)) (_module.__default.map__fg ($LS $LZ) |M#0@@8|) (_module.__default.map__f ($LS $LZ) (_module.__default.map__g ($LS $LZ) |M#0@@8|))))) (= (ControlFlow 0 4) 3))) GeneratedUnifiedExit_correct)))
