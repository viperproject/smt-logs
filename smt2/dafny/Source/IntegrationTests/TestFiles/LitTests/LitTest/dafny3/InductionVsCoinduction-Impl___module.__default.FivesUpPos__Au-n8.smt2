...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly T@U) (|n#0| Int) ) (!  (=> (or (|_module.__default.FivesUp#canCall| |n#0|) (< 1 $FunctionContextHeight)) ($Is DatatypeTypeType (_module.__default.FivesUp $ly |n#0|) (Tclass._module.Stream TInt)))
 :qid |InductionVsCoinductiondfy.30:16|
 :skolemid |539|
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@5 T@U) (|_k#0@@3| T@U) (|s#0@@3| T@U) ) (!  (=> (or (|_module.__default.Pos_h#canCall| |_k#0@@3| |s#0@@3|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |s#0@@3| (Tclass._module.Stream TInt)))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@3|)) (=> (not (_module.Stream.SNil_q |s#0@@3|)) (let ((|rest#3| (_module.Stream.tail |s#0@@3|)))
...
(let ((|x#4| (U_2_int ($Unbox intType (_module.Stream.head |s#0@@3|)))))
 (and (> |x#4| 0) (_module.__default.Pos_h $ly@@5 (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1)) |rest#4|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@3|)) (forall ((|_k'#0| T@U) ) (!  (=> (|ORD#Less| |_k'#0| |_k#0@@3|) (|_module.__default.Pos_h#canCall| |_k'#0| |s#0@@3|))
 :qid |InductionVsCoinductiondfy.38:20|
 :skolemid |559|
 :pattern ( (_module.__default.Pos_h $ly@@5 |_k'#0| |s#0@@3|))
))))) (= (_module.__default.Pos_h ($LS $ly@@5) |_k#0@@3| |s#0@@3|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@3|)) (ite (_module.Stream.SNil_q |s#0@@3|) true (let ((|rest#2| (_module.Stream.tail |s#0@@3|)))
(let ((|x#2| (U_2_int ($Unbox intType (_module.Stream.head |s#0@@3|)))))
 (and (> |x#2| 0) (_module.__default.Pos_h $ly@@5 (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1)) |rest#2|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@3|)) (forall ((|_k'#0@@0| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@0| |_k#0@@3|) (_module.__default.Pos_h $ly@@5 |_k'#0@@0| |s#0@@3|))
 :qid |InductionVsCoinductiondfy.38:20|
 :skolemid |558|
 :pattern ( (_module.__default.Pos_h $ly@@5 |_k'#0@@0| |s#0@@3|))
)))))))
 :qid |InductionVsCoinductiondfy.38:20|
 :skolemid |560|
 :pattern ( (_module.__default.Pos_h ($LS $ly@@5) |_k#0@@3| |s#0@@3|))
))))
...
(assert (forall (($ly@@6 T@U) (|n#0@@1| Int) ) (! (= (_module.__default.FivesUp ($LS $ly@@6) |n#0@@1|) (_module.__default.FivesUp $ly@@6 |n#0@@1|))
 :qid |InductionVsCoinductiondfy.30:16|
 :skolemid |537|
 :pattern ( (_module.__default.FivesUp ($LS $ly@@6) |n#0@@1|))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.FivesUpPos__Auto_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.__default.Pos_h#canCall| |_k#0@@4| (_module.__default.FivesUp ($LS $LZ) |n#1|)) (or (_module.__default.Pos_h ($LS $LZ) |_k#0@@4| (_module.__default.FivesUp ($LS $LZ) |n#1|)) (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (=> (_module.Stream.SNil_q (_module.__default.FivesUp ($LS $LZ) |n#1|)) (U_2_bool (Lit boolType (bool_2_U true)))))))) (=> (=> (|_module.__default.Pos_h#canCall| |_k#0@@4| (_module.__default.FivesUp ($LS $LZ) |n#1|)) (or (_module.__default.Pos_h ($LS $LZ) |_k#0@@4| (_module.__default.FivesUp ($LS $LZ) |n#1|)) (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (=> (_module.Stream.SNil_q (_module.__default.FivesUp ($LS $LZ) |n#1|)) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.__default.Pos_h#canCall| |_k#0@@4| (_module.__default.FivesUp ($LS $LZ) |n#1|)) (or (_module.__default.Pos_h ($LS $LZ) |_k#0@@4| (_module.__default.FivesUp ($LS $LZ) |n#1|)) (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (=> (not (_module.Stream.SNil_q (_module.__default.FivesUp ($LS $LZ) |n#1|))) (let ((|x#4@@0| (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.FivesUp ($LS ($LS $LZ)) |n#1|))))))
(> |x#4@@0| 0))))))) (=> (=> (|_module.__default.Pos_h#canCall| |_k#0@@4| (_module.__default.FivesUp ($LS $LZ) |n#1|)) (or (_module.__default.Pos_h ($LS $LZ) |_k#0@@4| (_module.__default.FivesUp ($LS $LZ) |n#1|)) (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (=> (not (_module.Stream.SNil_q (_module.__default.FivesUp ($LS $LZ) |n#1|))) (let ((|x#4@@1| (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.FivesUp ($LS ($LS $LZ)) |n#1|))))))
(> |x#4@@1| 0)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.__default.Pos_h#canCall| |_k#0@@4| (_module.__default.FivesUp ($LS $LZ) |n#1|)) (or (_module.__default.Pos_h ($LS $LZ) |_k#0@@4| (_module.__default.FivesUp ($LS $LZ) |n#1|)) (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (=> (not (_module.Stream.SNil_q (_module.__default.FivesUp ($LS $LZ) |n#1|))) (let ((|rest#4@@0| (_module.Stream.tail (_module.__default.FivesUp ($LS ($LS $LZ)) |n#1|))))
(_module.__default.Pos_h ($LS ($LS $LZ)) (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) |rest#4@@0|))))))) (=> (=> (|_module.__default.Pos_h#canCall| |_k#0@@4| (_module.__default.FivesUp ($LS $LZ) |n#1|)) (or (_module.__default.Pos_h ($LS $LZ) |_k#0@@4| (_module.__default.FivesUp ($LS $LZ) |n#1|)) (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (=> (not (_module.Stream.SNil_q (_module.__default.FivesUp ($LS $LZ) |n#1|))) (let ((|rest#4@@1| (_module.Stream.tail (_module.__default.FivesUp ($LS ($LS $LZ)) |n#1|))))
(_module.__default.Pos_h ($LS ($LS $LZ)) (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) |rest#4@@1|)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.__default.Pos_h#canCall| |_k#0@@4| (_module.__default.FivesUp ($LS $LZ) |n#1|)) (or (_module.__default.Pos_h ($LS $LZ) |_k#0@@4| (_module.__default.FivesUp ($LS $LZ) |n#1|)) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@4|)) (forall ((|_k'#1@@1| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@1| |_k#0@@4|) (_module.__default.Pos_h ($LS ($LS $LZ)) |_k'#1@@1| (_module.__default.FivesUp ($LS ($LS $LZ)) |n#1|)))
 :qid |InductionVsCoinductiondfy.38:20|
 :skolemid |613|
 :pattern ( (_module.__default.Pos_h ($LS ($LS $LZ)) |_k'#1@@1| (_module.__default.FivesUp ($LS ($LS $LZ)) |n#1|)))
))))))))))))))
(let ((anon3_Else_correct  (=> (<= (|ORD#Offset| |_k#0@@4|) 0) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1)) (and (forall ((|_k'#2@@1| T@U) (|n#2| Int) ) (!  (=> (and (|ORD#Less| |_k'#2@@1| |_k#0@@4|) (> |n#2| 0)) (_module.__default.Pos_h ($LS $LZ) |_k'#2@@1| (_module.__default.FivesUp ($LS $LZ) |n#2|)))
 :qid |InductionVsCoinductiondfy.130:16|
 :skolemid |617|
 :pattern ( (_module.__default.FivesUp ($LS $LZ) |n#2|) (|ORD#Less| |_k'#2@@1| |_k#0@@4|))
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#_k0#0| T@U) (|$ih#n0#0| Int) ) (!  (=> (and (> |$ih#n0#0| 0) (or (|ORD#Less| |$ih#_k0#0| |_k#0@@4|) (and (= |$ih#_k0#0| |_k#0@@4|) (and (<= 0 (- 4 (Mod (- |$ih#n0#0| 1) (LitInt 5)))) (< (- 4 (Mod (- |$ih#n0#0| 1) (LitInt 5))) (- 4 (Mod (- |n#1| 1) (LitInt 5)))))))) (_module.__default.Pos_h ($LS $LZ) |$ih#_k0#0| (_module.__default.FivesUp ($LS $LZ) |$ih#n0#0|)))
 :qid |InductionVsCoinductiondfy.130:16|
 :skolemid |616|
 :pattern ( (_module.__default.Pos_h ($LS $LZ) |$ih#_k0#0| (_module.__default.FivesUp ($LS $LZ) |$ih#n0#0|)))
