...
(assert (forall (($Heap T@U) (|a#0| T@U) (|low#0| Int) (|high#0| Int) ) (!  (=> (or (|Client_mIntSort.__default.Sorted#canCall| $Heap |a#0| |low#0| |high#0|) (and (and ($IsGoodHeap $Heap) ($Is refType |a#0| (Tclass._System.array Tclass.IntOrder.T))) (and (and (<= (LitInt 0) |low#0|) (<= |low#0| |high#0|)) (<= |high#0| (_System.array.Length |a#0|))))) (and (forall ((|i#7| Int) (|j#7| Int) ) (!  (=> (<= |low#0| |i#7|) (=> (< |i#7| |j#7|) (=> (< |j#7| |high#0|) (|IntOrder.__default.Leq#canCall| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#7|))) ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |j#7|)))))))
 :qid |GenericSortdfy.30:12|
 :skolemid |4269|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |j#7|))) ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#7|))))
)) (= (Client_mIntSort.__default.Sorted $Heap |a#0| |low#0| |high#0|) (forall ((|i#7@@0| Int) (|j#7@@0| Int) ) (!  (=> (and (and (<= |low#0| |i#7@@0|) (< |i#7@@0| |j#7@@0|)) (< |j#7@@0| |high#0|)) (IntOrder.__default.Leq ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#7@@0|))) ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |j#7@@0|)))))
 :qid |GenericSortdfy.30:12|
 :skolemid |4268|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |j#7@@0|))) ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#7@@0|))))
)))))
 :qid |GenericSortdfy.22:19|
 :skolemid |4270|
 :pattern ( (Client_mIntSort.__default.Sorted $Heap |a#0| |low#0| |high#0|) ($IsGoodHeap $Heap))
)))
...
(assert (forall ((|a#0@@1| T@U) (|b#0| T@U) ) (!  (=> (or (|IntOrder.__default.Leq#canCall| |a#0@@1| |b#0|) (and ($Is DatatypeTypeType |a#0@@1| Tclass.IntOrder.T) ($Is DatatypeTypeType |b#0| Tclass.IntOrder.T))) (=> (IntOrder.__default.Leq |a#0@@1| |b#0|) (<= (IntOrder.T.i |a#0@@1|) (IntOrder.T.i |b#0|))))
 :qid |GenericSortdfy.6:17|
 :skolemid |4246|
 :pattern ( (IntOrder.__default.Leq |a#0@@1| |b#0|))
)))
(assert (forall (($Heap@@0 T@U) (|a#0@@2| T@U) (|low#0@@1| Int) (|high#0@@1| Int) ) (!  (=> (or (|Client_mIntSort.__default.Sorted#canCall| $Heap@@0 |a#0@@2| |low#0@@1| |high#0@@1|) (and (and ($IsGoodHeap $Heap@@0) (and ($Is refType |a#0@@2| (Tclass._System.array Tclass.IntOrder.T)) ($IsAlloc refType |a#0@@2| (Tclass._System.array Tclass.IntOrder.T) $Heap@@0))) (and (and (<= (LitInt 0) |low#0@@1|) (<= |low#0@@1| |high#0@@1|)) (<= |high#0@@1| (_System.array.Length |a#0@@2|))))) (=> (Client_mIntSort.__default.Sorted $Heap@@0 |a#0@@2| |low#0@@1| |high#0@@1|) (forall ((|i#6| Int) (|j#6| Int) ) (!  (=> (and (and (<= |low#0@@1| |i#6|) (< |i#6| |j#6|)) (< |j#6| |high#0@@1|)) (IntOrder.__default.Leq ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |a#0@@2|) (IndexField |i#6|))) ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |a#0@@2|) (IndexField |j#6|)))))
 :qid |GenericSortdfy.28:45|
 :skolemid |4265|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |a#0@@2|) (IndexField |j#6|))) ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |a#0@@2|) (IndexField |i#6|))))
))))
 :qid |GenericSortdfy.22:19|
 :skolemid |4266|
 :pattern ( (Client_mIntSort.__default.Sorted $Heap@@0 |a#0@@2| |low#0@@1| |high#0@@1|))
)))
...
(assert (forall ((|a#0@@3| T@U) (|b#0@@0| T@U) ) (!  (=> (or (|IntOrder.__default.Leq#canCall| |a#0@@3| |b#0@@0|) (and ($Is DatatypeTypeType |a#0@@3| Tclass.IntOrder.T) ($Is DatatypeTypeType |b#0@@0| Tclass.IntOrder.T))) (and (and (IntOrder.T.Int_q |a#0@@3|) (IntOrder.T.Int_q |b#0@@0|)) (= (IntOrder.__default.Leq |a#0@@3| |b#0@@0|) (<= (IntOrder.T.i |a#0@@3|) (IntOrder.T.i |b#0@@0|)))))
 :qid |GenericSortdfy.6:17|
 :skolemid |4248|
 :pattern ( (IntOrder.__default.Leq |a#0@@3| |b#0@@0|))
)))
...
(assert (forall ((|a#0@@4| T@U) (|b#0@@1| T@U) ) (!  (=> (or (|IntOrder.__default.Leq#canCall| (Lit DatatypeTypeType |a#0@@4|) (Lit DatatypeTypeType |b#0@@1|)) (and ($Is DatatypeTypeType |a#0@@4| Tclass.IntOrder.T) ($Is DatatypeTypeType |b#0@@1| Tclass.IntOrder.T))) (and (and (IntOrder.T.Int_q (Lit DatatypeTypeType |a#0@@4|)) (IntOrder.T.Int_q (Lit DatatypeTypeType |b#0@@1|))) (= (IntOrder.__default.Leq (Lit DatatypeTypeType |a#0@@4|) (Lit DatatypeTypeType |b#0@@1|)) (<= (LitInt (IntOrder.T.i (Lit DatatypeTypeType |a#0@@4|))) (LitInt (IntOrder.T.i (Lit DatatypeTypeType |b#0@@1|)))))))
 :qid |GenericSortdfy.6:17|
 :weight 3
 :skolemid |4249|
 :pattern ( (IntOrder.__default.Leq (Lit DatatypeTypeType |a#0@@4|) (Lit DatatypeTypeType |b#0@@1|)))
)))
...
(set-info :boogie-vc-id Impl$$Client.__default.TheMain)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 36) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 35)) (<= 0 (LitInt 4))) (=> (<= 0 (LitInt 4)) (=> (and (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? Tclass.IntOrder.T))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0) alloc))))) (and (and (= (_System.array.Length $nw@0) (LitInt 4)) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 34)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 33)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length $nw@0)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length $nw@0))) (and (=> (= (ControlFlow 0 2) (- 0 32)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (LitInt 0))))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (LitInt 0)))) (=> (= |$rhs#0@0| (Lit DatatypeTypeType (|#IntOrder.T.Int| (LitInt 6)))) (=> (and (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0) (IndexField (LitInt 0)) ($Box DatatypeTypeType |$rhs#0@0|)))) ($IsGoodHeap $Heap@1)) (and (=> (= (ControlFlow 0 2) (- 0 31)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 30)) (and (<= 0 (LitInt 1)) (< (LitInt 1) (_System.array.Length $nw@0)))) (=> (and (<= 0 (LitInt 1)) (< (LitInt 1) (_System.array.Length $nw@0))) (and (=> (= (ControlFlow 0 2) (- 0 29)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (LitInt 1))))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (LitInt 1)))) (=> (= |$rhs#1@0| (Lit DatatypeTypeType (|#IntOrder.T.Int| (LitInt 1)))) (=> (and (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (IndexField (LitInt 1)) ($Box DatatypeTypeType |$rhs#1@0|)))) ($IsGoodHeap $Heap@2)) (and (=> (= (ControlFlow 0 2) (- 0 28)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 27)) (and (<= 0 (LitInt 2)) (< (LitInt 2) (_System.array.Length $nw@0)))) (=> (and (<= 0 (LitInt 2)) (< (LitInt 2) (_System.array.Length $nw@0))) (and (=> (= (ControlFlow 0 2) (- 0 26)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (LitInt 2))))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (LitInt 2)))) (=> (= |$rhs#2@0| (Lit DatatypeTypeType (|#IntOrder.T.Int| (LitInt 0)))) (=> (and (= $Heap@3 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (IndexField (LitInt 2)) ($Box DatatypeTypeType |$rhs#2@0|)))) ($IsGoodHeap $Heap@3)) (and (=> (= (ControlFlow 0 2) (- 0 25)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 24)) (and (<= 0 (LitInt 3)) (< (LitInt 3) (_System.array.Length $nw@0)))) (=> (and (<= 0 (LitInt 3)) (< (LitInt 3) (_System.array.Length $nw@0))) (and (=> (= (ControlFlow 0 2) (- 0 23)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (LitInt 3))))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (LitInt 3)))) (=> (= |$rhs#3@0| (Lit DatatypeTypeType (|#IntOrder.T.Int| (LitInt 4)))) (=> (and (= $Heap@4 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField (LitInt 3)) ($Box DatatypeTypeType |$rhs#3@0|)))) ($IsGoodHeap $Heap@4)) (and (=> (= (ControlFlow 0 2) (- 0 22)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 21)) (|Seq#Equal| (|Seq#FromArray| $Heap@4 $nw@0) (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#IntOrder.T.Int| (LitInt 6))))) ($Box DatatypeTypeType (Lit DatatypeTypeType (|#IntOrder.T.Int| (LitInt 1))))) ($Box DatatypeTypeType (Lit DatatypeTypeType (|#IntOrder.T.Int| (LitInt 0))))) ($Box DatatypeTypeType (Lit DatatypeTypeType (|#IntOrder.T.Int| (LitInt 4))))))) (=> (|Seq#Equal| (|Seq#FromArray| $Heap@4 $nw@0) (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#IntOrder.T.Int| (LitInt 6))))) ($Box DatatypeTypeType (Lit DatatypeTypeType (|#IntOrder.T.Int| (LitInt 1))))) ($Box DatatypeTypeType (Lit DatatypeTypeType (|#IntOrder.T.Int| (LitInt 0))))) ($Box DatatypeTypeType (Lit DatatypeTypeType (|#IntOrder.T.Int| (LitInt 4)))))) (and (=> (= (ControlFlow 0 2) (- 0 20)) (forall (($o@@7 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@7) alloc)))) (= $o@@7 $nw@0)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@7 $f@@1)))
 :qid |GenericSortdfy.140:27|
 :skolemid |4245|
 ...
 :qid |GenericSortdfy.140:27|
 :skolemid |4245|
)) (=> (and (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5)) (|Client_mIntSort.__default.Sorted#canCall| $Heap@5 $nw@0 (LitInt 0) (_System.array.Length $nw@0))) (=> (and (and (and (|Client_mIntSort.__default.Sorted#canCall| $Heap@5 $nw@0 (LitInt 0) (_System.array.Length $nw@0)) (and (Client_mIntSort.__default.Sorted $Heap@5 $nw@0 (LitInt 0) (_System.array.Length $nw@0)) (forall ((|i#4| Int) (|j#2| Int) ) (!  (=> (and (and (<= (LitInt 0) |i#4|) (< |i#4| |j#2|)) (< |j#2| (_System.array.Length $nw@0))) (IntOrder.__default.Leq ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |i#4|))) ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |j#2|)))))
 :qid |GenericSortdfy.30:12|
 :skolemid |4279|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |j#2|))) ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |i#4|))))
...
)) ($HeapSucc $Heap@4 $Heap@5))) (and (=> (= (ControlFlow 0 2) (- 0 19)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 18)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length $nw@0)))) (=> (and (= |##a#0@0| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 0))))) ($IsAlloc DatatypeTypeType |##a#0@0| Tclass.IntOrder.T $Heap@5)) (and (=> (= (ControlFlow 0 2) (- 0 17)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 16)) (and (<= 0 (LitInt 1)) (< (LitInt 1) (_System.array.Length $nw@0)))) (=> (and (and (= |##b#0@0| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 1))))) ($IsAlloc DatatypeTypeType |##b#0@0| Tclass.IntOrder.T $Heap@5)) (and (|IntOrder.__default.Leq#canCall| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 0)))) ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 1))))) (|IntOrder.__default.Leq#canCall| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 0)))) ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 1))))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|IntOrder.__default.Leq#canCall| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 0)))) ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 1))))) (or (IntOrder.__default.Leq ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 0)))) ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 1))))) (<= (IntOrder.T.i ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 0))))) (IntOrder.T.i ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 1))))))))) (=> (IntOrder.__default.Leq ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 0)))) ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 1))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 13)) (and (<= 0 (LitInt 1)) (< (LitInt 1) (_System.array.Length $nw@0)))) (=> (and (= |##a#1@0| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 1))))) ($IsAlloc DatatypeTypeType |##a#1@0| Tclass.IntOrder.T $Heap@5)) (and (=> (= (ControlFlow 0 2) (- 0 12)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 11)) (and (<= 0 (LitInt 2)) (< (LitInt 2) (_System.array.Length $nw@0)))) (=> (and (and (= |##b#1@0| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 2))))) ($IsAlloc DatatypeTypeType |##b#1@0| Tclass.IntOrder.T $Heap@5)) (and (|IntOrder.__default.Leq#canCall| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 1)))) ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 2))))) (|IntOrder.__default.Leq#canCall| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 1)))) ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 2))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|IntOrder.__default.Leq#canCall| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 1)))) ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 2))))) (or (IntOrder.__default.Leq ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 1)))) ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 2))))) (<= (IntOrder.T.i ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 1))))) (IntOrder.T.i ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 2))))))))) (=> (IntOrder.__default.Leq ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 1)))) ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 2))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (and (<= 0 (LitInt 2)) (< (LitInt 2) (_System.array.Length $nw@0)))) (=> (and (= |##a#2@0| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 2))))) ($IsAlloc DatatypeTypeType |##a#2@0| Tclass.IntOrder.T $Heap@5)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (and (<= 0 (LitInt 3)) (< (LitInt 3) (_System.array.Length $nw@0)))) (=> (and (and (= |##b#2@0| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 3))))) ($IsAlloc DatatypeTypeType |##b#2@0| Tclass.IntOrder.T $Heap@5)) (and (|IntOrder.__default.Leq#canCall| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 2)))) ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 3))))) (|IntOrder.__default.Leq#canCall| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 2)))) ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 3))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|IntOrder.__default.Leq#canCall| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 2)))) ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 3))))) (or (IntOrder.__default.Leq ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 2)))) ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 3))))) (<= (IntOrder.T.i ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 2))))) (IntOrder.T.i ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 3))))))))) (=> (IntOrder.__default.Leq ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 2)))) ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField (LitInt 3))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Seq#Equal| (|Seq#FromArray| $Heap@5 $nw@0) (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#IntOrder.T.Int| (LitInt 0))))) ($Box DatatypeTypeType (Lit DatatypeTypeType (|#IntOrder.T.Int| (LitInt 1))))) ($Box DatatypeTypeType (Lit DatatypeTypeType (|#IntOrder.T.Int| (LitInt 4))))) ($Box DatatypeTypeType (Lit DatatypeTypeType (|#IntOrder.T.Int| (LitInt 6))))))) (=> (|Seq#Equal| (|Seq#FromArray| $Heap@5 $nw@0) (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#IntOrder.T.Int| (LitInt 0))))) ($Box DatatypeTypeType (Lit DatatypeTypeType (|#IntOrder.T.Int| (LitInt 1))))) ($Box DatatypeTypeType (Lit DatatypeTypeType (|#IntOrder.T.Int| (LitInt 4))))) ($Box DatatypeTypeType (Lit DatatypeTypeType (|#IntOrder.T.Int| (LitInt 6)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= $nw@0 null)) (not true)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (and ($Is refType |a#0@@5| (Tclass._System.array Tclass.IntOrder.T)) ($IsAlloc refType |a#0@@5| (Tclass._System.array Tclass.IntOrder.T) $Heap@@1)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 36) 2))) anon0_correct))))
