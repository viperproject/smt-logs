...
(assert (distinct TInt TagInt alloc Tagclass._module.Stream Tagclass._module.Tree |##_module.Stream.Nil| |##_module.Stream.Cons| |##_module.Tree.Node| tytagFamily$Stream tytagFamily$Tree)
)
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|t#0@@6| T@U) ) (!  (=> (or (|_module.__default.HasBoundedHeight#canCall| |t#0@@6|) (and (< 3 $FunctionContextHeight) ($Is DatatypeTypeType |t#0@@6| Tclass._module.Tree))) (and (forall ((|n#0@@5| Int) ) (!  (=> (<= (LitInt 0) |n#0@@5|) (=> (<= (LitInt 0) |n#0@@5|) (and (_module.Tree.Node_q |t#0@@6|) (|_module.__default.LowerThan#canCall| (_module.Tree.children |t#0@@6|) |n#0@@5|))))
 :qid |InfiniteTreesdfy.69:10|
 :skolemid |638|
 :pattern ( (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@6|) |n#0@@5|))
)) (= (_module.__default.HasBoundedHeight |t#0@@6|) (exists ((|n#0@@6| Int) ) (!  (and (<= (LitInt 0) |n#0@@6|) (and (<= (LitInt 0) |n#0@@6|) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@6|) |n#0@@6|)))
 :qid |InfiniteTreesdfy.69:10|
 :skolemid |637|
 :pattern ( (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@6|) |n#0@@6|))
)))))
 :qid |InfiniteTreesdfy.67:34|
 :skolemid |639|
 :pattern ( (_module.__default.HasBoundedHeight |t#0@@6|))
))))
...
(assert (forall (($ly@@15 T@U) (|s#0@@9| T@U) (|n#0@@7| Int) ) (! (= (_module.__default.LowerThan ($LS $ly@@15) |s#0@@9| |n#0@@7|) (_module.__default.LowerThan $ly@@15 |s#0@@9| |n#0@@7|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |647|
 :pattern ( (_module.__default.LowerThan ($LS $ly@@15) |s#0@@9| |n#0@@7|))
)))
(assert (forall (($ly@@16 T@U) (|t#0@@7| T@U) (|p#0@@6| T@U) ) (! (= (_module.__default.ValidPath ($LS $ly@@16) |t#0@@7| |p#0@@6|) (_module.__default.ValidPath $ly@@16 |t#0@@7| |p#0@@6|))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |778|
 :pattern ( (_module.__default.ValidPath ($LS $ly@@16) |t#0@@7| |p#0@@6|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@17 T@U) (|n#0@@8| Int) ) (!  (=> (or (|_module.__default.SkinnyFiniteTree#canCall| |n#0@@8|) (and (< 3 $FunctionContextHeight) (<= (LitInt 0) |n#0@@8|))) (and (=> (or (not (= |n#0@@8| (LitInt 0))) (not true)) (|_module.__default.SkinnyFiniteTree#canCall| (- |n#0@@8| 1))) (= (_module.__default.SkinnyFiniteTree ($LS $ly@@17) |n#0@@8|) (ite (= |n#0@@8| (LitInt 0)) (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|)) (|#_module.Tree.Node| (|#_module.Stream.Cons| ($Box DatatypeTypeType (_module.__default.SkinnyFiniteTree $ly@@17 (- |n#0@@8| 1))) (Lit DatatypeTypeType |#_module.Stream.Nil|)))))))
 :qid |InfiniteTreesdfy.300:16|
 :skolemid |839|
 :pattern ( (_module.__default.SkinnyFiniteTree ($LS $ly@@17) |n#0@@8|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.Tail$_T0@@1 T@U) ($ly@@18 T@U) (|s#0@@10| T@U) (|n#0@@9| Int) ) (!  (=> (or (|_module.__default.Tail#canCall| _module._default.Tail$_T0@@1 (Lit DatatypeTypeType |s#0@@10|) (LitInt |n#0@@9|)) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@10| (Tclass._module.Stream _module._default.Tail$_T0@@1)) (<= (LitInt 0) |n#0@@9|)))) (and (=> (or (not (= (LitInt |n#0@@9|) (LitInt 0))) (not true)) (and (|_module.__default.Tail#canCall| _module._default.Tail$_T0@@1 (Lit DatatypeTypeType |s#0@@10|) (LitInt (- |n#0@@9| 1))) (let ((|t#2| (Lit DatatypeTypeType (_module.__default.Tail _module._default.Tail$_T0@@1 ($LS $ly@@18) (Lit DatatypeTypeType |s#0@@10|) (LitInt (- |n#0@@9| 1))))))
(|$IsA#_module.Stream| |t#2|)))) (= (_module.__default.Tail _module._default.Tail$_T0@@1 ($LS $ly@@18) (Lit DatatypeTypeType |s#0@@10|) (LitInt |n#0@@9|)) (ite (= (LitInt |n#0@@9|) (LitInt 0)) |s#0@@10| (let ((|t#2@@0| (Lit DatatypeTypeType (_module.__default.Tail _module._default.Tail$_T0@@1 ($LS $ly@@18) (Lit DatatypeTypeType |s#0@@10|) (LitInt (- |n#0@@9| 1))))))
(ite (|$Eq#_module.Stream| _module._default.Tail$_T0@@1 _module._default.Tail$_T0@@1 ($LS ($LS $LZ)) |t#2@@0| |#_module.Stream.Nil|) |t#2@@0| (_module.Stream.tail |t#2@@0|)))))))
 ...
 :weight 3
 :skolemid |591|
 :pattern ( (_module.__default.Tail _module._default.Tail$_T0@@1 ($LS $ly@@18) (Lit DatatypeTypeType |s#0@@10|) (LitInt |n#0@@9|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.Tail$_T0@@2 T@U) ($ly@@19 T@U) (|s#0@@11| T@U) (|n#0@@10| Int) ) (!  (=> (and (or (|_module.__default.Tail#canCall| _module._default.Tail$_T0@@2 |s#0@@11| |n#0@@10|) (and (< 1 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |s#0@@11| (Tclass._module.Stream _module._default.Tail$_T0@@2)) ($IsAlloc DatatypeTypeType |s#0@@11| (Tclass._module.Stream _module._default.Tail$_T0@@2) $Heap)) (<= (LitInt 0) |n#0@@10|)))) ($IsGoodHeap $Heap)) ($IsAlloc DatatypeTypeType (_module.__default.Tail _module._default.Tail$_T0@@2 $ly@@19 |s#0@@11| |n#0@@10|) (Tclass._module.Stream _module._default.Tail$_T0@@2) $Heap))
 :qid |InfiniteTreesdfy.9:16|
 :skolemid |587|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.__default.Tail _module._default.Tail$_T0@@2 $ly@@19 |s#0@@11| |n#0@@10|) (Tclass._module.Stream _module._default.Tail$_T0@@2) $Heap))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@20 T@U) (|_k#0@@9| T@U) (|s#0@@12| T@U) (|n#0@@11| Int) ) (!  (=> (or (|_module.__default.LowerThan_h#canCall| (Lit BoxType |_k#0@@9|) |s#0@@12| |n#0@@11|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@12| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@11|)))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@9|)) (=> (not (_module.Stream.Nil_q |s#0@@12|)) (let ((|tail#6@@0| (_module.Stream.tail |s#0@@12|)))
(let ((|t#6| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@12|))))
 (=> (<= (LitInt 1) |n#0@@11|) (and (and (_module.Tree.Node_q |t#6|) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) (_module.Tree.children |t#6|) (- |n#0@@11| 1))) (=> (_module.__default.LowerThan_h ($LS $ly@@20) (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) (_module.Tree.children |t#6|) (- |n#0@@11| 1)) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) |tail#6@@0| |n#0@@11|)))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@9|)) (ite (_module.Stream.Nil_q |s#0@@12|) true (let ((|tail#7@@0| (_module.Stream.tail |s#0@@12|)))
(let ((|t#7| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@12|))))
 (and (and (<= (LitInt 1) |n#0@@11|) (_module.__default.LowerThan_h ($LS $ly@@20) (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) (_module.Tree.children |t#7|) (- |n#0@@11| 1))) (_module.__default.LowerThan_h ($LS $ly@@20) (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) |tail#7@@0| |n#0@@11|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@9|)) (forall ((|_k'#1@@1| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@1| |_k#0@@9|) (|_module.__default.LowerThan_h#canCall| |_k'#1@@1| |s#0@@12| |n#0@@11|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |666|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@20) |_k'#1@@1| |s#0@@12| |n#0@@11|))
))))) (= (_module.__default.LowerThan_h ($LS $ly@@20) (Lit BoxType |_k#0@@9|) |s#0@@12| |n#0@@11|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@9|)) (ite (_module.Stream.Nil_q |s#0@@12|) true (let ((|tail#5@@0| (_module.Stream.tail |s#0@@12|)))
(let ((|t#5| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@12|))))
 (and (and (<= (LitInt 1) |n#0@@11|) (_module.__default.LowerThan_h ($LS $ly@@20) (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) (_module.Tree.children |t#5|) (- |n#0@@11| 1))) (_module.__default.LowerThan_h ($LS $ly@@20) (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) |tail#5@@0| |n#0@@11|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@9|)) (forall ((|_k'#1@@2| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@2| |_k#0@@9|) (_module.__default.LowerThan_h ($LS $ly@@20) |_k'#1@@2| |s#0@@12| |n#0@@11|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |665|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@20) |_k'#1@@2| |s#0@@12| |n#0@@11|))
)))))))
 :qid |InfiniteTreesdfy.71:20|
 :weight 3
 :skolemid |667|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@20) (Lit BoxType |_k#0@@9|) |s#0@@12| |n#0@@11|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.Tail$_T0@@3 T@U) ($ly@@21 T@U) (|s#0@@13| T@U) (|n#0@@12| Int) ) (!  (=> (or (|_module.__default.Tail#canCall| _module._default.Tail$_T0@@3 |s#0@@13| |n#0@@12|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@13| (Tclass._module.Stream _module._default.Tail$_T0@@3)) (<= (LitInt 0) |n#0@@12|)))) (and (=> (or (not (= |n#0@@12| (LitInt 0))) (not true)) (and (|_module.__default.Tail#canCall| _module._default.Tail$_T0@@3 |s#0@@13| (- |n#0@@12| 1)) (let ((|t#0@@8| (_module.__default.Tail _module._default.Tail$_T0@@3 $ly@@21 |s#0@@13| (- |n#0@@12| 1))))
(|$IsA#_module.Stream| |t#0@@8|)))) (= (_module.__default.Tail _module._default.Tail$_T0@@3 ($LS $ly@@21) |s#0@@13| |n#0@@12|) (ite (= |n#0@@12| (LitInt 0)) |s#0@@13| (let ((|t#0@@9| (_module.__default.Tail _module._default.Tail$_T0@@3 $ly@@21 |s#0@@13| (- |n#0@@12| 1))))
(ite (|$Eq#_module.Stream| _module._default.Tail$_T0@@3 _module._default.Tail$_T0@@3 ($LS ($LS $LZ)) |t#0@@9| |#_module.Stream.Nil|) |t#0@@9| (_module.Stream.tail |t#0@@9|)))))))
 :qid |unknown.0:0|
 :skolemid |589|
 :pattern ( (_module.__default.Tail _module._default.Tail$_T0@@3 ($LS $ly@@21) |s#0@@13| |n#0@@12|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@22 T@U) (|_k#0@@10| T@U) (|s#0@@14| T@U) (|n#0@@13| Int) ) (!  (=> (or (|_module.__default.LowerThan_h#canCall| |_k#0@@10| |s#0@@14| |n#0@@13|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@14| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@13|)))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@10|)) (=> (not (_module.Stream.Nil_q |s#0@@14|)) (let ((|tail#3@@1| (_module.Stream.tail |s#0@@14|)))
(let ((|t#3| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@14|))))
 (=> (<= (LitInt 1) |n#0@@13|) (and (and (_module.Tree.Node_q |t#3|) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) (_module.Tree.children |t#3|) (- |n#0@@13| 1))) (=> (_module.__default.LowerThan_h $ly@@22 (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) (_module.Tree.children |t#3|) (- |n#0@@13| 1)) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) |tail#3@@1| |n#0@@13|)))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@10|)) (ite (_module.Stream.Nil_q |s#0@@14|) true (let ((|tail#4@@1| (_module.Stream.tail |s#0@@14|)))
(let ((|t#4| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@14|))))
 (and (and (<= (LitInt 1) |n#0@@13|) (_module.__default.LowerThan_h $ly@@22 (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) (_module.Tree.children |t#4|) (- |n#0@@13| 1))) (_module.__default.LowerThan_h $ly@@22 (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) |tail#4@@1| |n#0@@13|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@10|)) (forall ((|_k'#0@@3| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@3| |_k#0@@10|) (|_module.__default.LowerThan_h#canCall| |_k'#0@@3| |s#0@@14| |n#0@@13|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |663|
 :pattern ( (_module.__default.LowerThan_h $ly@@22 |_k'#0@@3| |s#0@@14| |n#0@@13|))
))))) (= (_module.__default.LowerThan_h ($LS $ly@@22) |_k#0@@10| |s#0@@14| |n#0@@13|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@10|)) (ite (_module.Stream.Nil_q |s#0@@14|) true (let ((|tail#2@@1| (_module.Stream.tail |s#0@@14|)))
(let ((|t#2@@1| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@14|))))
 (and (and (<= (LitInt 1) |n#0@@13|) (_module.__default.LowerThan_h $ly@@22 (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) (_module.Tree.children |t#2@@1|) (- |n#0@@13| 1))) (_module.__default.LowerThan_h $ly@@22 (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) |tail#2@@1| |n#0@@13|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@10|)) (forall ((|_k'#0@@4| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@4| |_k#0@@10|) (_module.__default.LowerThan_h $ly@@22 |_k'#0@@4| |s#0@@14| |n#0@@13|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |662|
 :pattern ( (_module.__default.LowerThan_h $ly@@22 |_k'#0@@4| |s#0@@14| |n#0@@13|))
)))))))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |664|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@22) |_k#0@@10| |s#0@@14| |n#0@@13|))
))))
...
(assert (forall (($ly@@24 T@U) (|_k#0@@12| T@U) (|s#0@@16| T@U) (|n#0@@14| Int) ) (! (= (_module.__default.LowerThan_h ($LS $ly@@24) |_k#0@@12| |s#0@@16| |n#0@@14|) (_module.__default.LowerThan_h $ly@@24 |_k#0@@12| |s#0@@16| |n#0@@14|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |658|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@24) |_k#0@@12| |s#0@@16| |n#0@@14|))
)))
(assert (forall (($ly@@25 T@U) (|_k#0@@13| T@U) (|t#0@@10| T@U) (|p#0@@7| T@U) ) (! (= (_module.__default.ValidPath_h ($LS $ly@@25) |_k#0@@13| |t#0@@10| |p#0@@7|) (_module.__default.ValidPath_h $ly@@25 |_k#0@@13| |t#0@@10| |p#0@@7|))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |789|
 :pattern ( (_module.__default.ValidPath_h ($LS $ly@@25) |_k#0@@13| |t#0@@10| |p#0@@7|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@28 T@U) (|_k#0@@16| T@U) (|t#0@@11| T@U) (|p#0@@8| T@U) ) (!  (=> (or (|_module.__default.ValidPath_h#canCall| (Lit BoxType |_k#0@@16|) (Lit DatatypeTypeType |t#0@@11|) (Lit DatatypeTypeType |p#0@@8|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |t#0@@11| Tclass._module.Tree) ($Is DatatypeTypeType |p#0@@8| (Tclass._module.Stream TInt))))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@16|)) (and (=> (U_2_bool (Lit boolType (bool_2_U (_module.Stream.Nil_q (Lit DatatypeTypeType |p#0@@8|))))) (|$IsA#_module.Tree| (Lit DatatypeTypeType |t#0@@11|))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Stream.Nil_q (Lit DatatypeTypeType |p#0@@8|)))))) (let ((|tail#9@@0| (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |p#0@@8|)))))
...
(let ((|index#10| (LitInt (U_2_int ($Unbox intType (_module.Stream.head (Lit DatatypeTypeType |p#0@@8|)))))))
 ...
 (and (_module.Stream.Cons_q |ch#11|) (_module.__default.ValidPath_h ($LS $ly@@28) (|ORD#Minus| |_k#0@@16| (|ORD#FromNat| 1)) (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Stream.head |ch#11|))) |tail#10@@0|)))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@16|)) (forall ((|_k'#2@@1| T@U) ) (!  (=> (|ORD#Less| |_k'#2@@1| |_k#0@@16|) (|_module.__default.ValidPath_h#canCall| |_k'#2@@1| |t#0@@11| |p#0@@8|))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |800|
 :pattern ( (_module.__default.ValidPath_h ($LS $ly@@28) |_k'#2@@1| |t#0@@11| |p#0@@8|))
))))) (= (_module.__default.ValidPath_h ($LS $ly@@28) (Lit BoxType |_k#0@@16|) (Lit DatatypeTypeType |t#0@@11|) (Lit DatatypeTypeType |p#0@@8|))  (and (=> (< 0 (|ORD#Offset| |_k#0@@16|)) (ite (_module.Stream.Nil_q (Lit DatatypeTypeType |p#0@@8|)) (|_module.Tree#Equal| |t#0@@11| (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|))) (let ((|tail#8@@0| (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |p#0@@8|)))))
(let ((|index#8| (LitInt (U_2_int ($Unbox intType (_module.Stream.head (Lit DatatypeTypeType |p#0@@8|)))))))
 ...
 (and (_module.Stream.Cons_q |ch#9|) (_module.__default.ValidPath_h ($LS $ly@@28) (|ORD#Minus| |_k#0@@16| (|ORD#FromNat| 1)) (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Stream.head |ch#9|))) |tail#8@@0|)))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@16|)) (forall ((|_k'#2@@2| T@U) ) (!  (=> (|ORD#Less| |_k'#2@@2| |_k#0@@16|) (_module.__default.ValidPath_h ($LS $ly@@28) |_k'#2@@2| |t#0@@11| |p#0@@8|))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |799|
 :pattern ( (_module.__default.ValidPath_h ($LS $ly@@28) |_k'#2@@2| |t#0@@11| |p#0@@8|))
)))))))
 :qid |InfiniteTreesdfy.234:20|
 :weight 3
 :skolemid |801|
 :pattern ( (_module.__default.ValidPath_h ($LS $ly@@28) (Lit BoxType |_k#0@@16|) (Lit DatatypeTypeType |t#0@@11|) (Lit DatatypeTypeType |p#0@@8|)))
))))
(assert (forall (($ly@@29 T@U) (|n#0@@15| Int) ) (! (= (_module.__default.SkinnyFiniteTree ($LS $ly@@29) |n#0@@15|) (_module.__default.SkinnyFiniteTree $ly@@29 |n#0@@15|))
 :qid |InfiniteTreesdfy.300:16|
 :skolemid |834|
 :pattern ( (_module.__default.SkinnyFiniteTree ($LS $ly@@29) |n#0@@15|))
)))
(assert (forall (($ly@@30 T@U) (|n#0@@16| Int) ) (! (= (_module.__default.EverLongerSkinnyTrees ($LS $ly@@30) |n#0@@16|) (_module.__default.EverLongerSkinnyTrees $ly@@30 |n#0@@16|))
 :qid |InfiniteTreesdfy.313:16|
 :skolemid |846|
 :pattern ( (_module.__default.EverLongerSkinnyTrees ($LS $ly@@30) |n#0@@16|))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@31 T@U) (|n#0@@17| Int) ) (!  (=> (or (|_module.__default.SkinnyFiniteTree#canCall| |n#0@@17|) (and (< 3 $FunctionContextHeight) (<= (LitInt 0) |n#0@@17|))) (and (forall ((|k#0| Int) ) (!  (=> (<= (LitInt 0) |k#0|) (= (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children (_module.__default.SkinnyFiniteTree $ly@@31 |n#0@@17|)) |k#0|) (<= |n#0@@17| |k#0|)))
 :qid |InfiniteTreesdfy.301:18|
 :skolemid |836|
 :pattern ( (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children (_module.__default.SkinnyFiniteTree $ly@@31 |n#0@@17|)) |k#0|))
)) ($Is DatatypeTypeType (_module.__default.SkinnyFiniteTree $ly@@31 |n#0@@17|) Tclass._module.Tree)))
 :qid |InfiniteTreesdfy.300:16|
 :skolemid |837|
 :pattern ( (_module.__default.SkinnyFiniteTree $ly@@31 |n#0@@17|))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (=> (or |_module.__default.FiniteUnboundedTree#canCall| (< 5 $FunctionContextHeight)) (and (|_module.__default.EverLongerSkinnyTrees#canCall| (LitInt 0)) (= _module.__default.FiniteUnboundedTree (Lit DatatypeTypeType (|#_module.Tree.Node| (Lit DatatypeTypeType (_module.__default.EverLongerSkinnyTrees ($LS $LZ) (LitInt 0))))))))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@32 T@U) (|n#0@@18| Int) ) (!  (=> (or (|_module.__default.SkinnyFiniteTree#canCall| (LitInt |n#0@@18|)) (and (< 3 $FunctionContextHeight) (<= (LitInt 0) |n#0@@18|))) (and (=> (or (not (= (LitInt |n#0@@18|) (LitInt 0))) (not true)) (|_module.__default.SkinnyFiniteTree#canCall| (LitInt (- |n#0@@18| 1)))) (= (_module.__default.SkinnyFiniteTree ($LS $ly@@32) (LitInt |n#0@@18|)) (ite (= (LitInt |n#0@@18|) (LitInt 0)) (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|)) (|#_module.Tree.Node| (Lit DatatypeTypeType (|#_module.Stream.Cons| ($Box DatatypeTypeType (Lit DatatypeTypeType (_module.__default.SkinnyFiniteTree ($LS $ly@@32) (LitInt (- |n#0@@18| 1))))) (Lit DatatypeTypeType |#_module.Stream.Nil|))))))))
 :qid |InfiniteTreesdfy.300:16|
 :weight 3
 :skolemid |840|
 :pattern ( (_module.__default.SkinnyFiniteTree ($LS $ly@@32) (LitInt |n#0@@18|)))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|t#0@@12| T@U) ) (!  (=> (or (|_module.__default.HasBoundedHeight#canCall| (Lit DatatypeTypeType |t#0@@12|)) (and (< 3 $FunctionContextHeight) ($Is DatatypeTypeType |t#0@@12| Tclass._module.Tree))) (and (forall ((|n#1| Int) ) (!  (=> (<= (LitInt 0) |n#1|) (=> (<= (LitInt 0) |n#1|) (and (_module.Tree.Node_q (Lit DatatypeTypeType |t#0@@12|)) (|_module.__default.LowerThan#canCall| (Lit DatatypeTypeType (_module.Tree.children (Lit DatatypeTypeType |t#0@@12|))) |n#1|))))
 :qid |InfiniteTreesdfy.69:10|
 :skolemid |641|
 :pattern ( (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@12|) |n#1|))
)) (= (_module.__default.HasBoundedHeight (Lit DatatypeTypeType |t#0@@12|)) (exists ((|n#1@@0| Int) ) (!  (and (<= (LitInt 0) |n#1@@0|) (and (<= (LitInt 0) |n#1@@0|) (_module.__default.LowerThan ($LS $LZ) (Lit DatatypeTypeType (_module.Tree.children (Lit DatatypeTypeType |t#0@@12|))) |n#1@@0|)))
 :qid |InfiniteTreesdfy.69:10|
 :skolemid |640|
 :pattern ( (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@12|) |n#1@@0|))
)))))
 :qid |InfiniteTreesdfy.67:34|
 :weight 3
 :skolemid |642|
 :pattern ( (_module.__default.HasBoundedHeight (Lit DatatypeTypeType |t#0@@12|)))
))))
...
(assert (forall ((d@@9 T@U) (_module.Stream$T@@5 T@U) ($h@@0 T@U) ) (!  (=> (and ($IsGoodHeap $h@@0) (and (_module.Stream.Cons_q d@@9) ($IsAlloc DatatypeTypeType d@@9 (Tclass._module.Stream _module.Stream$T@@5) $h@@0))) ($IsAllocBox (_module.Stream.head d@@9) _module.Stream$T@@5 $h@@0))
 :qid |unknown.0:0|
 :skolemid |1156|
 :pattern ( ($IsAllocBox (_module.Stream.head d@@9) _module.Stream$T@@5 $h@@0))
)))
...
(assert (forall ((_module._default.Tail$_T0@@4 T@U) ($ly@@33 T@U) (|s#0@@19| T@U) (|n#0@@19| Int) ) (! (= (_module.__default.Tail _module._default.Tail$_T0@@4 ($LS $ly@@33) |s#0@@19| |n#0@@19|) (_module.__default.Tail _module._default.Tail$_T0@@4 $ly@@33 |s#0@@19| |n#0@@19|))
 :qid |unknown.0:0|
 :skolemid |581|
 :pattern ( (_module.__default.Tail _module._default.Tail$_T0@@4 ($LS $ly@@33) |s#0@@19| |n#0@@19|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@35 T@U) (|t#0@@13| T@U) (|p#0@@9| T@U) (|_k#0@@18| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |t#0@@13| Tclass._module.Tree) ($Is DatatypeTypeType |p#0@@9| (Tclass._module.Stream TInt))) (= |_k#0@@18| (|ORD#FromNat| 0))) (_module.__default.ValidPath_h $ly@@35 |_k#0@@18| |t#0@@13| |p#0@@9|))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |786|
 :pattern ( (_module.__default.ValidPath_h $ly@@35 |_k#0@@18| |t#0@@13| |p#0@@9|))
))))
(assert (forall ((d@@10 T@U) (_module.Stream$T@@7 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.Stream.Cons_q d@@10) ($IsAlloc DatatypeTypeType d@@10 (Tclass._module.Stream _module.Stream$T@@7) $h@@1))) ($IsAlloc DatatypeTypeType (_module.Stream.tail d@@10) (Tclass._module.Stream _module.Stream$T@@7) $h@@1))
 :qid |unknown.0:0|
 :skolemid |1157|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Stream.tail d@@10) (Tclass._module.Stream _module.Stream$T@@7) $h@@1))
)))
(assert (forall ((d@@11 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) ($Is DatatypeTypeType d@@11 Tclass._module.Tree)) ($IsAlloc DatatypeTypeType d@@11 Tclass._module.Tree $h@@2))
 :qid |unknown.0:0|
 :skolemid |1182|
 :pattern ( ($IsAlloc DatatypeTypeType d@@11 Tclass._module.Tree $h@@2))
)))
(assert (= (Tag Tclass._module.Tree) Tagclass._module.Tree))
(assert (= (TagFamily Tclass._module.Tree) tytagFamily$Tree))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@36 T@U) (|s#0@@21| T@U) (|n#0@@20| Int) ) (!  (=> (or (|_module.__default.LowerThan#canCall| |s#0@@21| |n#0@@20|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@21| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@20|)))) (and (=> (not (_module.Stream.Nil_q |s#0@@21|)) (let ((|tail#1@@1| (_module.Stream.tail |s#0@@21|)))
(let ((|t#1@@1| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@21|))))
 (=> (<= (LitInt 1) |n#0@@20|) (and (and (_module.Tree.Node_q |t#1@@1|) (|_module.__default.LowerThan#canCall| (_module.Tree.children |t#1@@1|) (- |n#0@@20| 1))) (=> (_module.__default.LowerThan $ly@@36 (_module.Tree.children |t#1@@1|) (- |n#0@@20| 1)) (|_module.__default.LowerThan#canCall| |tail#1@@1| |n#0@@20|))))))) (= (_module.__default.LowerThan ($LS $ly@@36) |s#0@@21| |n#0@@20|) (ite (_module.Stream.Nil_q |s#0@@21|) true (let ((|tail#0@@1| (_module.Stream.tail |s#0@@21|)))
(let ((|t#0@@14| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@21|))))
 (and (and (<= (LitInt 1) |n#0@@20|) (_module.__default.LowerThan $ly@@36 (_module.Tree.children |t#0@@14|) (- |n#0@@20| 1))) (_module.__default.LowerThan $ly@@36 |tail#0@@1| |n#0@@20|))))))))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |651|
 :pattern ( (_module.__default.LowerThan ($LS $ly@@36) |s#0@@21| |n#0@@20|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@37 T@U) (|s#0@@22| T@U) (|n#0@@21| Int) (|_k#0@@19| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |s#0@@22| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@21|)) (= |_k#0@@19| (|ORD#FromNat| 0))) (_module.__default.LowerThan_h $ly@@37 |_k#0@@19| |s#0@@22| |n#0@@21|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |655|
 :pattern ( (_module.__default.LowerThan_h $ly@@37 |_k#0@@19| |s#0@@22| |n#0@@21|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@38 T@U) (|n#0@@22| Int) ) (!  (=> (or (|_module.__default.EverLongerSkinnyTrees#canCall| |n#0@@22|) (and (< 4 $FunctionContextHeight) (<= (LitInt 0) |n#0@@22|))) (and (and (|_module.__default.SkinnyFiniteTree#canCall| |n#0@@22|) (|_module.__default.EverLongerSkinnyTrees#canCall| (+ |n#0@@22| 1))) (= (_module.__default.EverLongerSkinnyTrees ($LS $ly@@38) |n#0@@22|) (|#_module.Stream.Cons| ($Box DatatypeTypeType (_module.__default.SkinnyFiniteTree ($LS $LZ) |n#0@@22|)) (_module.__default.EverLongerSkinnyTrees $ly@@38 (+ |n#0@@22| 1))))))
 :qid |InfiniteTreesdfy.313:16|
 :skolemid |850|
 :pattern ( (_module.__default.EverLongerSkinnyTrees ($LS $ly@@38) |n#0@@22|))
))))
(assert (forall ((d@@12 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (_module.Tree.Node_q d@@12) ($IsAlloc DatatypeTypeType d@@12 Tclass._module.Tree $h@@3))) ($IsAlloc DatatypeTypeType (_module.Tree.children d@@12) (Tclass._module.Stream Tclass._module.Tree) $h@@3))
 :qid |unknown.0:0|
 :skolemid |1178|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Tree.children d@@12) (Tclass._module.Stream Tclass._module.Tree) $h@@3))
)))
...
(assert (forall ((_module.Stream$T@@8 T@U) (|a#5#0#0@@0| T@U) (|a#5#1#0@@0| T@U) ($h@@4 T@U) ) (!  (=> ($IsGoodHeap $h@@4) (= ($IsAlloc DatatypeTypeType (|#_module.Stream.Cons| |a#5#0#0@@0| |a#5#1#0@@0|) (Tclass._module.Stream _module.Stream$T@@8) $h@@4)  (and ($IsAllocBox |a#5#0#0@@0| _module.Stream$T@@8 $h@@4) ($IsAlloc DatatypeTypeType |a#5#1#0@@0| (Tclass._module.Stream _module.Stream$T@@8) $h@@4))))
 :qid |unknown.0:0|
 :skolemid |1155|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.Stream.Cons| |a#5#0#0@@0| |a#5#1#0@@0|) (Tclass._module.Stream _module.Stream$T@@8) $h@@4))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.Proposition3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and |_module.__default.FiniteUnboundedTree#canCall| (|_module.__default.HasBoundedHeight#canCall| (Lit DatatypeTypeType _module.__default.FiniteUnboundedTree))) (and (not (U_2_bool (Lit boolType (bool_2_U (_module.__default.HasBoundedHeight (Lit DatatypeTypeType _module.__default.FiniteUnboundedTree)))))) (= $Heap@@0 $Heap@0))) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and |_module.__default.FiniteUnboundedTree#canCall| (|_module.__default.HasFiniteHeight#canCall| (Lit DatatypeTypeType _module.__default.FiniteUnboundedTree)))) (and (and (|_module.__default.HasFiniteHeight#canCall| (Lit DatatypeTypeType _module.__default.FiniteUnboundedTree)) (and (U_2_bool (Lit boolType (bool_2_U (_module.__default.HasFiniteHeight (Lit DatatypeTypeType _module.__default.FiniteUnboundedTree))))) (forall ((|p#0@@10| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@10| (Tclass._module.Stream TInt)) (=> (_module.__default.ValidPath ($LS $LZ) (Lit DatatypeTypeType _module.__default.FiniteUnboundedTree) |p#0@@10|) (not (_module.__default.IsNeverEndingStream TInt ($LS $LZ) |p#0@@10|))))
 :qid |InfiniteTreesdfy.260:10|
 :skolemid |870|
 :pattern ( (_module.__default.IsNeverEndingStream TInt ($LS $LZ) |p#0@@10|))
 :pattern ( (_module.__default.ValidPath ($LS $LZ) _module.__default.FiniteUnboundedTree |p#0@@10|))
)))) (= $Heap@0 $Heap@1))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (U_2_bool (Lit boolType (bool_2_U (_module.__default.HasBoundedHeight (Lit DatatypeTypeType _module.__default.FiniteUnboundedTree))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.__default.HasBoundedHeight (Lit DatatypeTypeType _module.__default.FiniteUnboundedTree)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.__default.HasFiniteHeight#canCall| (Lit DatatypeTypeType _module.__default.FiniteUnboundedTree)) (or (U_2_bool (Lit boolType (bool_2_U (_module.__default.HasFiniteHeight (Lit DatatypeTypeType _module.__default.FiniteUnboundedTree))))) (forall ((|p#1@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |p#1@@1| (Tclass._module.Stream TInt)) (=> (_module.__default.ValidPath ($LS ($LS $LZ)) (Lit DatatypeTypeType _module.__default.FiniteUnboundedTree) |p#1@@1|) (not (_module.__default.IsNeverEndingStream TInt ($LS ($LS $LZ)) |p#1@@1|))))
 :qid |InfiniteTreesdfy.260:10|
 :skolemid |860|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and (= 7 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct)))
