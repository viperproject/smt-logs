...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.N2S_k)
...
(let ((anon9_Else_correct  (=> (or (not (= |num#0@@3| (|#_module.Number.Succ| |_mcc#0#0|))) (not true)) (and (=> (= (ControlFlow 0 8) 6) anon10_Then_correct) (=> (= (ControlFlow 0 8) 7) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> (= |num#0@@3| (|#_module.Number.Succ| |_mcc#0#0|)) (=> (and (and ($Is DatatypeTypeType |_mcc#0#0| Tclass._module.Number) (= |let#1#0#0| |_mcc#0#0|)) (and ($Is DatatypeTypeType |let#1#0#0| Tclass._module.Number) (= |next#Z#0@0| |let#1#0#0|))) (and (=> (= (ControlFlow 0 3) (- 0 5)) ($Is intType (int_2_U (+ |n#0@@2| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ |n#0@@2| 1)) Tclass._System.nat) (=> (= |##n#0@0| (+ |n#0@@2| 1)) (=> (and ($IsAlloc intType (int_2_U |##n#0@0|) Tclass._System.nat $Heap) ($IsAlloc DatatypeTypeType |next#Z#0@0| Tclass._module.Number $Heap)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (<= 0 (LitInt 0)) (= (LitInt 0) (LitInt 0)))) (=> (or (<= 0 (LitInt 0)) (= (LitInt 0) (LitInt 0))) (=> (= (ControlFlow 0 3) (- 0 2)) (or (< (LitInt 0) (LitInt 0)) (and (= (LitInt 0) (LitInt 0)) (< (DtRank |next#Z#0@0|) (DtRank |num#0@@3|)))))))))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (<= (LitInt 0) |n#0@@2|) ($Is DatatypeTypeType |num#0@@3| Tclass._module.Number)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct))))
