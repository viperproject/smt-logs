...
(assert (forall ((_module.Stream$T@@3 T@U) (bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 (Tclass._module.Stream _module.Stream$T@@3)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@1)) bx@@1) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@1) (Tclass._module.Stream _module.Stream$T@@3))))
 :qid |unknown.0:0|
 :skolemid |585|
 :pattern ( ($IsBox bx@@1 (Tclass._module.Stream _module.Stream$T@@3)))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.UpLemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (|$PrefixEq#_module.Stream| TInt TInt (|ORD#FromNat| |k#0|) ($LS ($LS $LZ)) (_module.__default.Inc ($LS $LZ) (_module.__default.Up ($LS $LZ) |n#0@@2|)) (_module.__default.Up ($LS $LZ) (+ |n#0@@2| 1))) (=> (< 0 |k#0|) (=> (_module.Stream.Cons_q (_module.__default.Inc ($LS ($LS $LZ)) (_module.__default.Up ($LS ($LS $LZ)) |n#0@@2|))) (and (_module.Stream.Cons_q (_module.__default.Up ($LS ($LS $LZ)) (+ |n#0@@2| 1))) (and (= (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Inc ($LS ($LS $LZ)) (_module.__default.Up ($LS ($LS $LZ)) |n#0@@2|))))) (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Up ($LS ($LS $LZ)) (+ |n#0@@2| 1)))))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#FromNat| (- |k#0| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.Inc ($LS ($LS $LZ)) (_module.__default.Up ($LS ($LS $LZ)) |n#0@@2|))) (_module.Stream.tail (_module.__default.Up ($LS ($LS $LZ)) (+ |n#0@@2| 1))))))))))))
(let ((anon3_Else_correct  (=> (and (= |k#0| 0) (= (ControlFlow 0 8) 2)) GeneratedUnifiedExit_correct)))
(let ((anon3_Then_correct  (=> (or (not (= |k#0| 0)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 7)) ($Is intType (int_2_U (- |k#0| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |k#0| 1)) Tclass._System.nat) (=> (and (= |k##0_0@0| (- |k#0| 1)) (= |n##0_0@0| (+ |n#0@@2| 1))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (<= 0 |k#0|) (= |k##0_0@0| |k#0|))) (=> (or (<= 0 |k#0|) (= |k##0_0@0| |k#0|)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (or (<= 0 |n#0@@2|) (< |k##0_0@0| |k#0|)) (= |n##0_0@0| |n#0@@2|))) (=> (or (or (<= 0 |n#0@@2|) (< |k##0_0@0| |k#0|)) (= |n##0_0@0| |n#0@@2|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (< |k##0_0@0| |k#0|) (and (= |k##0_0@0| |k#0|) (< |n##0_0@0| |n#0@@2|)))) (=> (or (< |k##0_0@0| |k#0|) (and (= |k##0_0@0| |k#0|) (< |n##0_0@0| |n#0@@2|))) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (and (|_module.__default.Up#canCall| |n##0_0@0|) (|_module.__default.Inc#canCall| (_module.__default.Up ($LS $LZ) |n##0_0@0|))) (|_module.__default.Up#canCall| (+ |n##0_0@0| 1))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#FromNat| |k##0_0@0|) ($LS ($LS $LZ)) (_module.__default.Inc ($LS $LZ) (_module.__default.Up ($LS $LZ) |n##0_0@0|)) (_module.__default.Up ($LS $LZ) (+ |n##0_0@0| 1)))) (and (= $Heap $Heap@0) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct))))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 9) 3) anon3_Then_correct) (=> (= (ControlFlow 0 9) 8) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |k#0|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct)))
