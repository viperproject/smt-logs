...
(declare-fun _module.__default.ThisAintGoinNowhere (T@U) T@U)
(declare-fun $LS (T@U) T@U)
(declare-fun |_module.__default.ThisAintGoinNowhere#canCall| () Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly T@U) ) (!  (=> (or |_module.__default.ThisAintGoinNowhere#canCall| (< 1 $FunctionContextHeight)) (and |_module.__default.ThisAintGoinNowhere#canCall| (= (_module.__default.ThisAintGoinNowhere ($LS $ly)) (Lit DatatypeTypeType (_module.__default.ThisAintGoinNowhere $ly)))))
 :qid |AbstemiousErrorsdfy.51:16|
 :skolemid |584|
 :pattern ( (_module.__default.ThisAintGoinNowhere ($LS $ly)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@0 T@U) ) (!  (=> (or |_module.__default.ThisAintGoinNowhere#canCall| (< 1 $FunctionContextHeight)) (and |_module.__default.ThisAintGoinNowhere#canCall| (= (_module.__default.ThisAintGoinNowhere ($LS $ly@@0)) (Lit DatatypeTypeType (_module.__default.ThisAintGoinNowhere ($LS $ly@@0))))))
 :qid |AbstemiousErrorsdfy.51:16|
 :weight 3
 :skolemid |585|
 :pattern ( (_module.__default.ThisAintGoinNowhere ($LS $ly@@0)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@1 T@U) ) (!  (=> (or |_module.__default.ThisAintGoinNowhere#canCall| (< 1 $FunctionContextHeight)) ($Is DatatypeTypeType (_module.__default.ThisAintGoinNowhere $ly@@1) (Tclass._module.Stream TInt)))
 :qid |AbstemiousErrorsdfy.51:16|
 :skolemid |582|
 :pattern ( (_module.__default.ThisAintGoinNowhere $ly@@1))
))))
...
(assert (forall (($ly@@2 T@U) ) (! (= (_module.__default.ThisAintGoinNowhere ($LS $ly@@2)) (_module.__default.ThisAintGoinNowhere $ly@@2))
 :qid |AbstemiousErrorsdfy.51:16|
 :skolemid |580|
 :pattern ( (_module.__default.ThisAintGoinNowhere ($LS $ly@@2)))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.ThisAintGoinNowhere)
