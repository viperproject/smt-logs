...
(let ((anon20_correct  (and (=> (= (ControlFlow 0 7) (- 0 12)) (or (and ($Is intType (int_2_U (- |n#0@@10| 1)) TInt) (and (and (<= (LitInt 0) (- |n#0@@10| 1)) (< (- |n#0@@10| 1) |n#0@@10|)) (U_2_bool ($Unbox boolType (Apply1 _module._default.NextMinimizer$_T0@@5 TBool $Heap@@4 |P#0@@4| (_module.Stream.head (_module.__default.Tail _module._default.NextMinimizer$_T0@@5 ($LS $LZ) |s#0@@10| (- |n#0@@10| 1)))))))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (and (and (<= (LitInt 0) (LitInt 0)) (< 0 |n#0@@10|)) (U_2_bool ($Unbox boolType (Apply1 _module._default.NextMinimizer$_T0@@5 TBool $Heap@@4 |P#0@@4| (_module.Stream.head (_module.__default.Tail _module._default.NextMinimizer$_T0@@5 ($LS $LZ) |s#0@@10| (LitInt 0)))))))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (and (and (<= (LitInt 0) (LitInt 0)) (< 0 |n#0@@10|)) (U_2_bool ($Unbox boolType (Apply1 _module._default.NextMinimizer$_T0@@5 TBool $Heap@@4 |P#0@@4| (_module.Stream.head (_module.__default.Tail _module._default.NextMinimizer$_T0@@5 ($LS $LZ) |s#0@@10| (LitInt 0)))))))) (exists ((|k#4| Int) )  (and (and (<= (LitInt 0) |k#4|) (< |k#4| |n#0@@10|)) (U_2_bool ($Unbox boolType (Apply1 _module._default.NextMinimizer$_T0@@5 TBool $Heap@@4 |P#0@@4| (_module.Stream.head (_module.__default.Tail _module._default.NextMinimizer$_T0@@5 ($LS $LZ) |s#0@@10| |k#4|))))))))))) (=> (or (and ($Is intType (int_2_U (- |n#0@@10| 1)) TInt) (and (and (<= (LitInt 0) (- |n#0@@10| 1)) (< (- |n#0@@10| 1) |n#0@@10|)) (U_2_bool ($Unbox boolType (Apply1 _module._default.NextMinimizer$_T0@@5 TBool $Heap@@4 |P#0@@4| (_module.Stream.head (_module.__default.Tail _module._default.NextMinimizer$_T0@@5 ($LS $LZ) |s#0@@10| (- |n#0@@10| 1)))))))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (and (and (<= (LitInt 0) (LitInt 0)) (< 0 |n#0@@10|)) (U_2_bool ($Unbox boolType (Apply1 _module._default.NextMinimizer$_T0@@5 TBool $Heap@@4 |P#0@@4| (_module.Stream.head (_module.__default.Tail _module._default.NextMinimizer$_T0@@5 ($LS $LZ) |s#0@@10| (LitInt 0)))))))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (and (and (<= (LitInt 0) (LitInt 0)) (< 0 |n#0@@10|)) (U_2_bool ($Unbox boolType (Apply1 _module._default.NextMinimizer$_T0@@5 TBool $Heap@@4 |P#0@@4| (_module.Stream.head (_module.__default.Tail _module._default.NextMinimizer$_T0@@5 ($LS $LZ) |s#0@@10| (LitInt 0)))))))) (exists ((|k#4@@0| Int) )  (and (and (<= (LitInt 0) |k#4@@0|) (< |k#4@@0| |n#0@@10|)) (U_2_bool ($Unbox boolType (Apply1 _module._default.NextMinimizer$_T0@@5 TBool $Heap@@4 |P#0@@4| (_module.Stream.head (_module.__default.Tail _module._default.NextMinimizer$_T0@@5 ($LS $LZ) |s#0@@10| |k#4@@0|)))))))))) (=> (and (and (and (<= (LitInt 0) |k#3@0|) (< |k#3@0| |n#0@@10|)) (U_2_bool ($Unbox boolType (Apply1 _module._default.NextMinimizer$_T0@@5 TBool $Heap@@4 |P#0@@4| (_module.Stream.head (_module.__default.Tail _module._default.NextMinimizer$_T0@@5 ($LS $LZ) |s#0@@10| |k#3@0|)))))) (and ($IsAlloc DatatypeTypeType |s#0@@10| (Tclass._module.Stream _module._default.NextMinimizer$_T0@@5) $Heap@@4) ($IsAlloc HandleTypeType |P#0@@4| (Tclass._System.___hTotalFunc1 _module._default.NextMinimizer$_T0@@5 TBool) $Heap@@4))) (and (=> (= (ControlFlow 0 7) (- 0 11)) ($Is intType (int_2_U |k#3@0|) Tclass._System.nat)) (=> ($Is intType (int_2_U |k#3@0|) Tclass._System.nat) (=> ($IsAlloc intType (int_2_U |k#3@0|) Tclass._System.nat $Heap@@4) (and (=> (= (ControlFlow 0 7) (- 0 10)) (U_2_bool ($Unbox boolType (Apply1 _module._default.NextMinimizer$_T0@@5 TBool $Heap@@4 |P#0@@4| (_module.Stream.head (_module.__default.Tail _module._default.NextMinimizer$_T0@@5 ($LS ($LS $LZ)) |s#0@@10| |k#3@0|)))))) (=> (U_2_bool ($Unbox boolType (Apply1 _module._default.NextMinimizer$_T0@@5 TBool $Heap@@4 |P#0@@4| (_module.Stream.head (_module.__default.Tail _module._default.NextMinimizer$_T0@@5 ($LS $LZ) |s#0@@10| |k#3@0|))))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (or (<= 0 |n#0@@10|) (= |k#3@0| |n#0@@10|))) (=> (or (<= 0 |n#0@@10|) (= |k#3@0| |n#0@@10|)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (< |k#3@0| |n#0@@10|)) (=> (< |k#3@0| |n#0@@10|) (=> (and (|_module.__default.NextMinimizer#canCall| _module._default.NextMinimizer$_T0@@5 |s#0@@10| |P#0@@4| |k#3@0|) (|$let#3$canCall| _module._default.NextMinimizer$_T0@@5 $Heap@@4 |n#0@@10| |P#0@@4| |s#0@@10|)) (=> (and (and (= (_module.__default.NextMinimizer _module._default.NextMinimizer$_T0@@5 ($LS $LZ) |s#0@@10| |P#0@@4| |n#0@@10|) (_module.__default.NextMinimizer _module._default.NextMinimizer$_T0@@5 ($LS $LZ) |s#0@@10| |P#0@@4| |k#3@0|)) (|_module.__default.NextMinimizer#canCall| _module._default.NextMinimizer$_T0@@5 |s#0@@10| |P#0@@4| |k#3@0|)) (and ($Is intType (int_2_U (_module.__default.NextMinimizer _module._default.NextMinimizer$_T0@@5 ($LS $LZ) |s#0@@10| |P#0@@4| |n#0@@10|)) Tclass._System.nat) (= (ControlFlow 0 7) 4))) GeneratedUnifiedExit_correct))))))))))))))))
