...
(declare-fun _module.__default.FibSortof (T@U) T@U)
(declare-fun |_module.__default.FibSortof#canCall| () Bool)
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly T@U) ) (!  (=> (or |_module.__default.FibSortof#canCall| (< 2 $FunctionContextHeight)) ($Is DatatypeTypeType (_module.__default.FibSortof $ly) (Tclass._module.Stream TInt)))
 :qid |AbstemiousErrorsdfy.43:16|
 :skolemid |573|
 :pattern ( (_module.__default.FibSortof $ly))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@2 T@U) ) (!  (=> (or |_module.__default.FibSortof#canCall| (< 2 $FunctionContextHeight)) (and (and (and |_module.__default.FibSortof#canCall| |_module.__default.FibSortof#canCall|) (|_module.__default.voraciousAdd#canCall| (Lit DatatypeTypeType (_module.__default.FibSortof $ly@@2)) (Lit DatatypeTypeType (_module.__default.FibSortof $ly@@2)))) (= (_module.__default.FibSortof ($LS $ly@@2)) (Lit DatatypeTypeType (|#_module.Stream.Cons| ($Box intType (int_2_U (LitInt 0))) (Lit DatatypeTypeType (|#_module.Stream.Cons| ($Box intType (int_2_U (LitInt 1))) (Lit DatatypeTypeType (_module.__default.voraciousAdd ($LS $LZ) (Lit DatatypeTypeType (_module.__default.FibSortof $ly@@2)) (Lit DatatypeTypeType (_module.__default.FibSortof $ly@@2)))))))))))
 :qid |AbstemiousErrorsdfy.43:16|
 :skolemid |575|
 :pattern ( (_module.__default.FibSortof ($LS $ly@@2)))
))))
...
(assert (forall (($ly@@3 T@U) ) (! (= (_module.__default.FibSortof ($LS $ly@@3)) (_module.__default.FibSortof $ly@@3))
 :qid |AbstemiousErrorsdfy.43:16|
 :skolemid |571|
 :pattern ( (_module.__default.FibSortof ($LS $ly@@3)))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@5 T@U) ) (!  (=> (or |_module.__default.FibSortof#canCall| (< 2 $FunctionContextHeight)) (and (and (and |_module.__default.FibSortof#canCall| |_module.__default.FibSortof#canCall|) (|_module.__default.voraciousAdd#canCall| (Lit DatatypeTypeType (_module.__default.FibSortof ($LS $ly@@5))) (Lit DatatypeTypeType (_module.__default.FibSortof ($LS $ly@@5))))) (= (_module.__default.FibSortof ($LS $ly@@5)) (Lit DatatypeTypeType (|#_module.Stream.Cons| ($Box intType (int_2_U (LitInt 0))) (Lit DatatypeTypeType (|#_module.Stream.Cons| ($Box intType (int_2_U (LitInt 1))) (Lit DatatypeTypeType (_module.__default.voraciousAdd ($LS $LZ) (Lit DatatypeTypeType (_module.__default.FibSortof ($LS $ly@@5))) (Lit DatatypeTypeType (_module.__default.FibSortof ($LS $ly@@5))))))))))))
 :qid |AbstemiousErrorsdfy.43:16|
 :weight 3
 :skolemid |576|
 :pattern ( (_module.__default.FibSortof ($LS $ly@@5)))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.FibSortof)
