...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@1 T@U) (|_k#0@@0| T@U) (|s#0@@0| T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.__default.LowerThan_h#canCall| (Lit BoxType |_k#0@@0|) (Lit DatatypeTypeType |s#0@@0|) (LitInt |n#0@@1|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@0| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@1|)))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@0|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Stream.Nil_q (Lit DatatypeTypeType |s#0@@0|)))))) (let ((|tail#9| (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |s#0@@0|)))))
(let ((|t#9| (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Stream.head (Lit DatatypeTypeType |s#0@@0|))))))
 (=> (<= (LitInt 1) (LitInt |n#0@@1|)) (and (and (_module.Tree.Node_q |t#9|) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@0| (|ORD#FromNat| 1)) (_module.Tree.children |t#9|) (LitInt (- |n#0@@1| 1)))) (=> (_module.__default.LowerThan_h ($LS $ly@@1) (|ORD#Minus| |_k#0@@0| (|ORD#FromNat| 1)) (_module.Tree.children |t#9|) (LitInt (- |n#0@@1| 1))) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@0| (|ORD#FromNat| 1)) |tail#9| (LitInt |n#0@@1|))))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@0|)) (ite (_module.Stream.Nil_q (Lit DatatypeTypeType |s#0@@0|)) true (let ((|tail#10| (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |s#0@@0|)))))
(let ((|t#10| (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Stream.head (Lit DatatypeTypeType |s#0@@0|))))))
 (and (and (<= (LitInt 1) (LitInt |n#0@@1|)) (_module.__default.LowerThan_h ($LS $ly@@1) (|ORD#Minus| |_k#0@@0| (|ORD#FromNat| 1)) (Lit DatatypeTypeType (_module.Tree.children |t#10|)) (LitInt (- |n#0@@1| 1)))) (_module.__default.LowerThan_h ($LS $ly@@1) (|ORD#Minus| |_k#0@@0| (|ORD#FromNat| 1)) |tail#10| (LitInt |n#0@@1|))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@0|)) (forall ((|_k'#2| T@U) ) (!  (=> (|ORD#Less| |_k'#2| |_k#0@@0|) (|_module.__default.LowerThan_h#canCall| |_k'#2| |s#0@@0| |n#0@@1|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |669|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@1) |_k'#2| |s#0@@0| |n#0@@1|))
))))) (= (_module.__default.LowerThan_h ($LS $ly@@1) (Lit BoxType |_k#0@@0|) (Lit DatatypeTypeType |s#0@@0|) (LitInt |n#0@@1|))  (and (=> (< 0 (|ORD#Offset| |_k#0@@0|)) (ite (_module.Stream.Nil_q (Lit DatatypeTypeType |s#0@@0|)) true (let ((|tail#8| (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |s#0@@0|)))))
(let ((|t#8| (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Stream.head (Lit DatatypeTypeType |s#0@@0|))))))
 (and (and (<= (LitInt 1) (LitInt |n#0@@1|)) (_module.__default.LowerThan_h ($LS $ly@@1) (|ORD#Minus| |_k#0@@0| (|ORD#FromNat| 1)) (Lit DatatypeTypeType (_module.Tree.children |t#8|)) (LitInt (- |n#0@@1| 1)))) (_module.__default.LowerThan_h ($LS $ly@@1) (|ORD#Minus| |_k#0@@0| (|ORD#FromNat| 1)) |tail#8| (LitInt |n#0@@1|))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@0|)) (forall ((|_k'#2@@0| T@U) ) (!  (=> (|ORD#Less| |_k'#2@@0| |_k#0@@0|) (_module.__default.LowerThan_h ($LS $ly@@1) |_k'#2@@0| |s#0@@0| |n#0@@1|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |668|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@1) |_k'#2@@0| |s#0@@0| |n#0@@1|))
)))))))
 :qid |InfiniteTreesdfy.71:20|
 :weight 3
 :skolemid |670|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@1) (Lit BoxType |_k#0@@0|) (Lit DatatypeTypeType |s#0@@0|) (LitInt |n#0@@1|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@2 T@U) (|s#0@@1| T@U) (|n#0@@2| Int) ) (!  (=> (and (and ($Is DatatypeTypeType |s#0@@1| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@2|)) (forall ((|_k#0@@1| T@U) ) (! (_module.__default.LowerThan_h ($LS $ly@@2) |_k#0@@1| |s#0@@1| |n#0@@2|)
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |652|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@2) |_k#0@@1| |s#0@@1| |n#0@@2|))
))) (_module.__default.LowerThan ($LS $ly@@2) |s#0@@1| |n#0@@2|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |654|
 :pattern ( (_module.__default.LowerThan ($LS $ly@@2) |s#0@@1| |n#0@@2|))
))))
...
(assert (forall (($ly@@3 T@U) (|s#0@@2| T@U) (|n#0@@3| Int) ) (! (= (_module.__default.LowerThan ($LS $ly@@3) |s#0@@2| |n#0@@3|) (_module.__default.LowerThan $ly@@3 |s#0@@2| |n#0@@3|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |647|
 :pattern ( (_module.__default.LowerThan ($LS $ly@@3) |s#0@@2| |n#0@@3|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@4 T@U) (|n#0@@4| Int) ) (!  (=> (or (|_module.__default.SkinnyFiniteTree#canCall| |n#0@@4|) (and (< 3 $FunctionContextHeight) (<= (LitInt 0) |n#0@@4|))) (and (=> (or (not (= |n#0@@4| (LitInt 0))) (not true)) (|_module.__default.SkinnyFiniteTree#canCall| (- |n#0@@4| 1))) (= (_module.__default.SkinnyFiniteTree ($LS $ly@@4) |n#0@@4|) (ite (= |n#0@@4| (LitInt 0)) (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|)) (|#_module.Tree.Node| (|#_module.Stream.Cons| ($Box DatatypeTypeType (_module.__default.SkinnyFiniteTree $ly@@4 (- |n#0@@4| 1))) (Lit DatatypeTypeType |#_module.Stream.Nil|)))))))
 :qid |InfiniteTreesdfy.300:16|
 :skolemid |839|
 :pattern ( (_module.__default.SkinnyFiniteTree ($LS $ly@@4) |n#0@@4|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@5 T@U) (|_k#0@@2| T@U) (|s#0@@3| T@U) (|n#0@@5| Int) ) (!  (=> (or (|_module.__default.LowerThan_h#canCall| (Lit BoxType |_k#0@@2|) |s#0@@3| |n#0@@5|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@3| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@5|)))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@2|)) (=> (not (_module.Stream.Nil_q |s#0@@3|)) (let ((|tail#6| (_module.Stream.tail |s#0@@3|)))
(let ((|t#6| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@3|))))
 (=> (<= (LitInt 1) |n#0@@5|) (and (and (_module.Tree.Node_q |t#6|) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@2| (|ORD#FromNat| 1)) (_module.Tree.children |t#6|) (- |n#0@@5| 1))) (=> (_module.__default.LowerThan_h ($LS $ly@@5) (|ORD#Minus| |_k#0@@2| (|ORD#FromNat| 1)) (_module.Tree.children |t#6|) (- |n#0@@5| 1)) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@2| (|ORD#FromNat| 1)) |tail#6| |n#0@@5|)))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@2|)) (ite (_module.Stream.Nil_q |s#0@@3|) true (let ((|tail#7| (_module.Stream.tail |s#0@@3|)))
(let ((|t#7| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@3|))))
 (and (and (<= (LitInt 1) |n#0@@5|) (_module.__default.LowerThan_h ($LS $ly@@5) (|ORD#Minus| |_k#0@@2| (|ORD#FromNat| 1)) (_module.Tree.children |t#7|) (- |n#0@@5| 1))) (_module.__default.LowerThan_h ($LS $ly@@5) (|ORD#Minus| |_k#0@@2| (|ORD#FromNat| 1)) |tail#7| |n#0@@5|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@2|)) (forall ((|_k'#1| T@U) ) (!  (=> (|ORD#Less| |_k'#1| |_k#0@@2|) (|_module.__default.LowerThan_h#canCall| |_k'#1| |s#0@@3| |n#0@@5|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |666|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@5) |_k'#1| |s#0@@3| |n#0@@5|))
))))) (= (_module.__default.LowerThan_h ($LS $ly@@5) (Lit BoxType |_k#0@@2|) |s#0@@3| |n#0@@5|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@2|)) (ite (_module.Stream.Nil_q |s#0@@3|) true (let ((|tail#5| (_module.Stream.tail |s#0@@3|)))
(let ((|t#5| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@3|))))
 (and (and (<= (LitInt 1) |n#0@@5|) (_module.__default.LowerThan_h ($LS $ly@@5) (|ORD#Minus| |_k#0@@2| (|ORD#FromNat| 1)) (_module.Tree.children |t#5|) (- |n#0@@5| 1))) (_module.__default.LowerThan_h ($LS $ly@@5) (|ORD#Minus| |_k#0@@2| (|ORD#FromNat| 1)) |tail#5| |n#0@@5|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@2|)) (forall ((|_k'#1@@0| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@0| |_k#0@@2|) (_module.__default.LowerThan_h ($LS $ly@@5) |_k'#1@@0| |s#0@@3| |n#0@@5|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |665|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@5) |_k'#1@@0| |s#0@@3| |n#0@@5|))
)))))))
 :qid |InfiniteTreesdfy.71:20|
 :weight 3
 :skolemid |667|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@5) (Lit BoxType |_k#0@@2|) |s#0@@3| |n#0@@5|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@6 T@U) (|_k#0@@3| T@U) (|s#0@@4| T@U) (|n#0@@6| Int) ) (!  (=> (or (|_module.__default.LowerThan_h#canCall| |_k#0@@3| |s#0@@4| |n#0@@6|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@4| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@6|)))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@3|)) (=> (not (_module.Stream.Nil_q |s#0@@4|)) (let ((|tail#3| (_module.Stream.tail |s#0@@4|)))
(let ((|t#3| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@4|))))
 (=> (<= (LitInt 1) |n#0@@6|) (and (and (_module.Tree.Node_q |t#3|) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1)) (_module.Tree.children |t#3|) (- |n#0@@6| 1))) (=> (_module.__default.LowerThan_h $ly@@6 (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1)) (_module.Tree.children |t#3|) (- |n#0@@6| 1)) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1)) |tail#3| |n#0@@6|)))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@3|)) (ite (_module.Stream.Nil_q |s#0@@4|) true (let ((|tail#4| (_module.Stream.tail |s#0@@4|)))
(let ((|t#4| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@4|))))
 (and (and (<= (LitInt 1) |n#0@@6|) (_module.__default.LowerThan_h $ly@@6 (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1)) (_module.Tree.children |t#4|) (- |n#0@@6| 1))) (_module.__default.LowerThan_h $ly@@6 (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1)) |tail#4| |n#0@@6|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@3|)) (forall ((|_k'#0| T@U) ) (!  (=> (|ORD#Less| |_k'#0| |_k#0@@3|) (|_module.__default.LowerThan_h#canCall| |_k'#0| |s#0@@4| |n#0@@6|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |663|
 :pattern ( (_module.__default.LowerThan_h $ly@@6 |_k'#0| |s#0@@4| |n#0@@6|))
))))) (= (_module.__default.LowerThan_h ($LS $ly@@6) |_k#0@@3| |s#0@@4| |n#0@@6|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@3|)) (ite (_module.Stream.Nil_q |s#0@@4|) true (let ((|tail#2| (_module.Stream.tail |s#0@@4|)))
(let ((|t#2| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@4|))))
 (and (and (<= (LitInt 1) |n#0@@6|) (_module.__default.LowerThan_h $ly@@6 (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1)) (_module.Tree.children |t#2|) (- |n#0@@6| 1))) (_module.__default.LowerThan_h $ly@@6 (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1)) |tail#2| |n#0@@6|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@3|)) (forall ((|_k'#0@@0| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@0| |_k#0@@3|) (_module.__default.LowerThan_h $ly@@6 |_k'#0@@0| |s#0@@4| |n#0@@6|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |662|
 :pattern ( (_module.__default.LowerThan_h $ly@@6 |_k'#0@@0| |s#0@@4| |n#0@@6|))
)))))))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |664|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@6) |_k#0@@3| |s#0@@4| |n#0@@6|))
))))
(assert (forall (($ly@@7 T@U) (|_k#0@@4| T@U) (|s#0@@5| T@U) (|n#0@@7| Int) ) (! (= (_module.__default.LowerThan_h ($LS $ly@@7) |_k#0@@4| |s#0@@5| |n#0@@7|) (_module.__default.LowerThan_h $ly@@7 |_k#0@@4| |s#0@@5| |n#0@@7|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |658|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@7) |_k#0@@4| |s#0@@5| |n#0@@7|))
)))
...
(assert (forall (($ly@@8 T@U) (|n#0@@8| Int) ) (! (= (_module.__default.SkinnyFiniteTree ($LS $ly@@8) |n#0@@8|) (_module.__default.SkinnyFiniteTree $ly@@8 |n#0@@8|))
 :qid |InfiniteTreesdfy.300:16|
 :skolemid |834|
 :pattern ( (_module.__default.SkinnyFiniteTree ($LS $ly@@8) |n#0@@8|))
)))
(assert (forall (($ly@@9 T@U) (|n#0@@9| Int) ) (! (= (_module.__default.EverLongerSkinnyTrees ($LS $ly@@9) |n#0@@9|) (_module.__default.EverLongerSkinnyTrees $ly@@9 |n#0@@9|))
 :qid |InfiniteTreesdfy.313:16|
 :skolemid |846|
 :pattern ( (_module.__default.EverLongerSkinnyTrees ($LS $ly@@9) |n#0@@9|))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@10 T@U) (|n#0@@10| Int) ) (!  (=> (or (|_module.__default.SkinnyFiniteTree#canCall| |n#0@@10|) (and (< 3 $FunctionContextHeight) (<= (LitInt 0) |n#0@@10|))) (and (forall ((|k#0| Int) ) (!  (=> (<= (LitInt 0) |k#0|) (= (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children (_module.__default.SkinnyFiniteTree $ly@@10 |n#0@@10|)) |k#0|) (<= |n#0@@10| |k#0|)))
 :qid |InfiniteTreesdfy.301:18|
 :skolemid |836|
 :pattern ( (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children (_module.__default.SkinnyFiniteTree $ly@@10 |n#0@@10|)) |k#0|))
)) ($Is DatatypeTypeType (_module.__default.SkinnyFiniteTree $ly@@10 |n#0@@10|) Tclass._module.Tree)))
 :qid |InfiniteTreesdfy.300:16|
 :skolemid |837|
 :pattern ( (_module.__default.SkinnyFiniteTree $ly@@10 |n#0@@10|))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (=> (or |_module.__default.FiniteUnboundedTree#canCall| (< 5 $FunctionContextHeight)) (and (|_module.__default.EverLongerSkinnyTrees#canCall| (LitInt 0)) (= _module.__default.FiniteUnboundedTree (Lit DatatypeTypeType (|#_module.Tree.Node| (Lit DatatypeTypeType (_module.__default.EverLongerSkinnyTrees ($LS $LZ) (LitInt 0))))))))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@11 T@U) (|n#0@@11| Int) ) (!  (=> (or (|_module.__default.SkinnyFiniteTree#canCall| (LitInt |n#0@@11|)) (and (< 3 $FunctionContextHeight) (<= (LitInt 0) |n#0@@11|))) (and (=> (or (not (= (LitInt |n#0@@11|) (LitInt 0))) (not true)) (|_module.__default.SkinnyFiniteTree#canCall| (LitInt (- |n#0@@11| 1)))) (= (_module.__default.SkinnyFiniteTree ($LS $ly@@11) (LitInt |n#0@@11|)) (ite (= (LitInt |n#0@@11|) (LitInt 0)) (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|)) (|#_module.Tree.Node| (Lit DatatypeTypeType (|#_module.Stream.Cons| ($Box DatatypeTypeType (Lit DatatypeTypeType (_module.__default.SkinnyFiniteTree ($LS $ly@@11) (LitInt (- |n#0@@11| 1))))) (Lit DatatypeTypeType |#_module.Stream.Nil|))))))))
 :qid |InfiniteTreesdfy.300:16|
 :weight 3
 :skolemid |840|
 :pattern ( (_module.__default.SkinnyFiniteTree ($LS $ly@@11) (LitInt |n#0@@11|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@12 T@U) (|s#0@@6| T@U) (|n#0@@12| Int) ) (!  (=> (or (|_module.__default.LowerThan#canCall| |s#0@@6| |n#0@@12|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@6| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@12|)))) (and (=> (not (_module.Stream.Nil_q |s#0@@6|)) (let ((|tail#1| (_module.Stream.tail |s#0@@6|)))
(let ((|t#1| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@6|))))
 (=> (<= (LitInt 1) |n#0@@12|) (and (and (_module.Tree.Node_q |t#1|) (|_module.__default.LowerThan#canCall| (_module.Tree.children |t#1|) (- |n#0@@12| 1))) (=> (_module.__default.LowerThan $ly@@12 (_module.Tree.children |t#1|) (- |n#0@@12| 1)) (|_module.__default.LowerThan#canCall| |tail#1| |n#0@@12|))))))) (= (_module.__default.LowerThan ($LS $ly@@12) |s#0@@6| |n#0@@12|) (ite (_module.Stream.Nil_q |s#0@@6|) true (let ((|tail#0| (_module.Stream.tail |s#0@@6|)))
(let ((|t#0| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@6|))))
 (and (and (<= (LitInt 1) |n#0@@12|) (_module.__default.LowerThan $ly@@12 (_module.Tree.children |t#0|) (- |n#0@@12| 1))) (_module.__default.LowerThan $ly@@12 |tail#0| |n#0@@12|))))))))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |651|
 :pattern ( (_module.__default.LowerThan ($LS $ly@@12) |s#0@@6| |n#0@@12|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@13 T@U) (|s#0@@7| T@U) (|n#0@@13| Int) (|_k#0@@5| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |s#0@@7| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@13|)) (= |_k#0@@5| (|ORD#FromNat| 0))) (_module.__default.LowerThan_h $ly@@13 |_k#0@@5| |s#0@@7| |n#0@@13|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |655|
 :pattern ( (_module.__default.LowerThan_h $ly@@13 |_k#0@@5| |s#0@@7| |n#0@@13|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@14 T@U) (|n#0@@14| Int) ) (!  (=> (or (|_module.__default.EverLongerSkinnyTrees#canCall| |n#0@@14|) (and (< 4 $FunctionContextHeight) (<= (LitInt 0) |n#0@@14|))) (and (and (|_module.__default.SkinnyFiniteTree#canCall| |n#0@@14|) (|_module.__default.EverLongerSkinnyTrees#canCall| (+ |n#0@@14| 1))) (= (_module.__default.EverLongerSkinnyTrees ($LS $ly@@14) |n#0@@14|) (|#_module.Stream.Cons| ($Box DatatypeTypeType (_module.__default.SkinnyFiniteTree ($LS $LZ) |n#0@@14|)) (_module.__default.EverLongerSkinnyTrees $ly@@14 (+ |n#0@@14| 1))))))
 :qid |InfiniteTreesdfy.313:16|
 :skolemid |850|
 :pattern ( (_module.__default.EverLongerSkinnyTrees ($LS $ly@@14) |n#0@@14|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.FiniteUnboundedTree)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct)))
