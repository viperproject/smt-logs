...
(set-info :boogie-vc-id Impl$$_module.__default.BadNatMonotonic1_h)
...
)))))))) (=> (and (and (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (= |s'#14@0| |t#1|)) (and (= $Heap@3 $Heap@4) (= (ControlFlow 0 29) 2))) GeneratedUnifiedExit_correct))))))))))))))))))))))))))))))
...
(let ((anon25_Then_correct  (=> (_module.__default.NatBigStep_h ($LS $LZ) (- |_k#0@@4| 1) |body#6@0| |s#1| |s'#13@0|) (and (=> (= (ControlFlow 0 20) (- 0 21)) ($Is intType (int_2_U (- |_k#0@@4| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |_k#0@@4| 1)) Tclass._System.nat) (=> (= |##_k#1@0| (- |_k#0@@4| 1)) (=> (and ($IsAlloc intType (int_2_U |##_k#1@0|) Tclass._System.nat $Heap@0) ($IsAlloc DatatypeTypeType |c#1| Tclass._module.cmd $Heap@0)) (=> (and (and ($IsAlloc intType (int_2_U |s'#13@0|) TInt $Heap@0) ($IsAlloc intType (int_2_U |t#1|) TInt $Heap@0)) (and (|_module.__default.NatBigStep_h#canCall| (- |_k#0@@4| 1) |c#1| |s'#13@0| |t#1|) (= (ControlFlow 0 20) 8))) anon13_correct))))))))
(let ((anon24_Then_correct  (and (=> (= (ControlFlow 0 23) (- 0 24)) ($Is intType (int_2_U (- |_k#0@@4| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |_k#0@@4| 1)) Tclass._System.nat) (=> (and (= |##_k#0@0| (- |_k#0@@4| 1)) ($IsAlloc intType (int_2_U |##_k#0@0|) Tclass._System.nat $Heap@0)) (=> (and (and ($IsAlloc DatatypeTypeType |body#6@0| Tclass._module.cmd $Heap@0) ($IsAlloc intType (int_2_U |s#1|) TInt $Heap@0)) (and ($IsAlloc intType (int_2_U |s'#13@0|) TInt $Heap@0) (|_module.__default.NatBigStep_h#canCall| (- |_k#0@@4| 1) |body#6@0| |s#1| |s'#13@0|))) (and (=> (= (ControlFlow 0 23) 20) anon25_Then_correct) (=> (= (ControlFlow 0 23) 22) anon25_Else_correct))))))))
...
)))) (and (=> (= (ControlFlow 0 49) 48) anon17_Then_correct) (=> (= (ControlFlow 0 49) 3) anon17_Else_correct))))))
