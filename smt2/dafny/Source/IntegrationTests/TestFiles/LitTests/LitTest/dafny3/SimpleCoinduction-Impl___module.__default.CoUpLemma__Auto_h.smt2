...
(set-info :boogie-vc-id Impl$$_module.__default.CoUpLemma__Auto_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (= |nn#1| (+ |n#1| 1)) (or (|$PrefixEq#_module.Stream| TInt TInt |_k#0| ($LS ($LS $LZ)) (_module.__default.Inc ($LS $LZ) (_module.__default.Up ($LS $LZ) |n#1|)) (_module.__default.Up ($LS $LZ) |nn#1|)) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (_module.__default.Inc ($LS ($LS $LZ)) (_module.__default.Up ($LS ($LS $LZ)) |n#1|))) (and (_module.Stream.Cons_q (_module.__default.Up ($LS ($LS $LZ)) |nn#1|)) (and (= (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Inc ($LS ($LS $LZ)) (_module.__default.Up ($LS ($LS $LZ)) |n#1|))))) (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Up ($LS ($LS $LZ)) |nn#1|))))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.Inc ($LS ($LS $LZ)) (_module.__default.Up ($LS ($LS $LZ)) |n#1|))) (_module.Stream.tail (_module.__default.Up ($LS ($LS $LZ)) |nn#1|)))))))))) (=> (=> (= |nn#1| (+ |n#1| 1)) (or (|$PrefixEq#_module.Stream| TInt TInt |_k#0| ($LS ($LS $LZ)) (_module.__default.Inc ($LS $LZ) (_module.__default.Up ($LS $LZ) |n#1|)) (_module.__default.Up ($LS $LZ) |nn#1|)) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (_module.__default.Inc ($LS ($LS $LZ)) (_module.__default.Up ($LS ($LS $LZ)) |n#1|))) (and (_module.Stream.Cons_q (_module.__default.Up ($LS ($LS $LZ)) |nn#1|)) (and (= (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Inc ($LS ($LS $LZ)) (_module.__default.Up ($LS ($LS $LZ)) |n#1|))))) (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Up ($LS ($LS $LZ)) |nn#1|))))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.Inc ($LS ($LS $LZ)) (_module.__default.Up ($LS ($LS $LZ)) |n#1|))) (_module.Stream.tail (_module.__default.Up ($LS ($LS $LZ)) |nn#1|))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (= |nn#1| (+ |n#1| 1)) (or (|$PrefixEq#_module.Stream| TInt TInt |_k#0| ($LS ($LS $LZ)) (_module.__default.Inc ($LS $LZ) (_module.__default.Up ($LS $LZ) |n#1|)) (_module.__default.Up ($LS $LZ) |nn#1|)) (or (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (_module.__default.Inc ($LS ($LS $LZ)) (_module.__default.Up ($LS ($LS $LZ)) |n#1|))) (and (_module.Stream.Cons_q (_module.__default.Up ($LS ($LS $LZ)) |nn#1|)) (and (= (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Inc ($LS ($LS $LZ)) (_module.__default.Up ($LS ($LS $LZ)) |n#1|))))) (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Up ($LS ($LS $LZ)) |nn#1|))))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.Inc ($LS ($LS $LZ)) (_module.__default.Up ($LS ($LS $LZ)) |n#1|))) (_module.Stream.tail (_module.__default.Up ($LS ($LS $LZ)) |nn#1|))))))) (=> (and (or (not (= |_k#0| (|ORD#FromNat| 0))) (not true)) (= (|ORD#Offset| |_k#0|) 0)) (|$Eq#_module.Stream| TInt TInt ($LS ($LS $LZ)) (_module.__default.Inc ($LS $LZ) (_module.__default.Up ($LS $LZ) |n#1|)) (_module.__default.Up ($LS $LZ) |nn#1|)))))))))))
(let ((anon3_Else_correct  (=> (<= (|ORD#Offset| |_k#0|) 0) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1)) (and (forall ((|_k'#0| T@U) (|n#2| Int) (|nn#2| Int) ) (!  (=> (|ORD#Less| |_k'#0| |_k#0|) (=> (= |nn#2| (+ |n#2| 1)) (|$PrefixEq#_module.Stream| TInt TInt |_k'#0| ($LS ($LS $LZ)) (_module.__default.Inc ($LS $LZ) (_module.__default.Up ($LS $LZ) |n#2|)) (_module.__default.Up ($LS $LZ) |nn#2|))))
 :qid |SimpleCoinductiondfy.43:16|
 :skolemid |624|
 :pattern ( (_module.__default.Up ($LS $LZ) |nn#2|) (_module.__default.Up ($LS $LZ) |n#2|) (|ORD#Less| |_k'#0| |_k#0|))
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#_k0#0| T@U) (|$ih#n0#0| Int) (|$ih#nn0#0| Int) ) (!  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) (or (|ORD#Less| |$ih#_k0#0| |_k#0|) (and (= |$ih#_k0#0| |_k#0|) (or (and (<= 0 |$ih#n0#0|) (< |$ih#n0#0| |n#1|)) (and (= |$ih#n0#0| |n#1|) (and (<= 0 |$ih#nn0#0|) (< |$ih#nn0#0| |nn#1|))))))) (=> (= |$ih#nn0#0| (+ |$ih#n0#0| 1)) (|$PrefixEq#_module.Stream| TInt TInt |$ih#_k0#0| ($LS ($LS $LZ)) (_module.__default.Inc ($LS $LZ) (_module.__default.Up ($LS $LZ) |$ih#n0#0|)) (_module.__default.Up ($LS $LZ) |$ih#nn0#0|))))
 :qid |SimpleCoinductiondfy.43:16|
 :skolemid |623|
 :pattern ( (|$PrefixEq#_module.Stream| TInt TInt |$ih#_k0#0| ($LS ($LS $LZ)) (_module.__default.Inc ($LS $LZ) (_module.__default.Up ($LS $LZ) |$ih#n0#0|)) (_module.__default.Up ($LS $LZ) |$ih#nn0#0|)))
