...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|_module._default.IsNeverEndingStream#$S@@0| T@U) ($ly@@6 T@U) (|s#0@@3| T@U) ) (!  (=> (and ($Is DatatypeTypeType |s#0@@3| (Tclass._module.Stream |_module._default.IsNeverEndingStream#$S@@0|)) (forall ((|_k#0@@3| T@U) ) (! (_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@0| ($LS $ly@@6) |_k#0@@3| |s#0@@3|)
 :qid |InfiniteTreesdfy.41:20|
 :skolemid |602|
 :pattern ( (_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@0| ($LS $ly@@6) |_k#0@@3| |s#0@@3|))
))) (_module.__default.IsNeverEndingStream |_module._default.IsNeverEndingStream#$S@@0| ($LS $ly@@6) |s#0@@3|))
 :qid |unknown.0:0|
 :skolemid |604|
 :pattern ( (_module.__default.IsNeverEndingStream |_module._default.IsNeverEndingStream#$S@@0| ($LS $ly@@6) |s#0@@3|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.Tail$_T0 T@U) ($ly@@7 T@U) (|s#0@@4| T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.__default.Tail#canCall| _module._default.Tail$_T0 |s#0@@4| |n#0@@0|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@4| (Tclass._module.Stream _module._default.Tail$_T0)) (<= (LitInt 0) |n#0@@0|)))) ($Is DatatypeTypeType (_module.__default.Tail _module._default.Tail$_T0 $ly@@7 |s#0@@4| |n#0@@0|) (Tclass._module.Stream _module._default.Tail$_T0)))
 :qid |unknown.0:0|
 :skolemid |586|
 :pattern ( (_module.__default.Tail _module._default.Tail$_T0 $ly@@7 |s#0@@4| |n#0@@0|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|_module._default.IsNeverEndingStream#$S@@1| T@U) ($ly@@8 T@U) (|_k#0@@4| T@U) (|s#0@@5| T@U) ) (!  (=> (or (|_module.__default.IsNeverEndingStream_h#canCall| |_module._default.IsNeverEndingStream#$S@@1| |_k#0@@4| |s#0@@5|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |s#0@@5| (Tclass._module.Stream |_module._default.IsNeverEndingStream#$S@@1|)))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (=> (not (_module.Stream.Nil_q |s#0@@5|)) (let ((|tail#3| (_module.Stream.tail |s#0@@5|)))
...
(_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@1| $ly@@8 (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) |tail#4|)))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@4|)) (forall ((|_k'#0| T@U) ) (!  (=> (|ORD#Less| |_k'#0| |_k#0@@4|) (|_module.__default.IsNeverEndingStream_h#canCall| |_module._default.IsNeverEndingStream#$S@@1| |_k'#0| |s#0@@5|))
 :qid |InfiniteTreesdfy.41:20|
 :skolemid |612|
 :pattern ( (_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@1| $ly@@8 |_k'#0| |s#0@@5|))
))))) (= (_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@1| ($LS $ly@@8) |_k#0@@4| |s#0@@5|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (ite (_module.Stream.Nil_q |s#0@@5|) false (let ((|tail#2| (_module.Stream.tail |s#0@@5|)))
(_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@1| $ly@@8 (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) |tail#2|)))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@4|)) (forall ((|_k'#0@@0| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@0| |_k#0@@4|) (_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@1| $ly@@8 |_k'#0@@0| |s#0@@5|))
 :qid |InfiniteTreesdfy.41:20|
 :skolemid |611|
 :pattern ( (_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@1| $ly@@8 |_k'#0@@0| |s#0@@5|))
)))))))
 :qid |unknown.0:0|
 :skolemid |613|
 :pattern ( (_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@1| ($LS $ly@@8) |_k#0@@4| |s#0@@5|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.Tail$_T0@@0 T@U) ($ly@@9 T@U) (|s#0@@6| T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.__default.Tail#canCall| _module._default.Tail$_T0@@0 |s#0@@6| (LitInt |n#0@@1|)) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@6| (Tclass._module.Stream _module._default.Tail$_T0@@0)) (<= (LitInt 0) |n#0@@1|)))) (and (=> (or (not (= (LitInt |n#0@@1|) (LitInt 0))) (not true)) (and (|_module.__default.Tail#canCall| _module._default.Tail$_T0@@0 |s#0@@6| (LitInt (- |n#0@@1| 1))) (let ((|t#1| (_module.__default.Tail _module._default.Tail$_T0@@0 ($LS $ly@@9) |s#0@@6| (LitInt (- |n#0@@1| 1)))))
(|$IsA#_module.Stream| |t#1|)))) (= (_module.__default.Tail _module._default.Tail$_T0@@0 ($LS $ly@@9) |s#0@@6| (LitInt |n#0@@1|)) (ite (= (LitInt |n#0@@1|) (LitInt 0)) |s#0@@6| (let ((|t#1@@0| (_module.__default.Tail _module._default.Tail$_T0@@0 ($LS $ly@@9) |s#0@@6| (LitInt (- |n#0@@1| 1)))))
(ite (|$Eq#_module.Stream| _module._default.Tail$_T0@@0 _module._default.Tail$_T0@@0 ($LS ($LS $LZ)) |t#1@@0| |#_module.Stream.Nil|) |t#1@@0| (_module.Stream.tail |t#1@@0|)))))))
 ...
 :weight 3
 :skolemid |590|
 :pattern ( (_module.__default.Tail _module._default.Tail$_T0@@0 ($LS $ly@@9) |s#0@@6| (LitInt |n#0@@1|)))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@10 T@U) (|_k#0@@5| T@U) (|s#0@@7| T@U) (|n#0@@2| Int) ) (!  (=> (or (|_module.__default.LowerThan_h#canCall| (Lit BoxType |_k#0@@5|) (Lit DatatypeTypeType |s#0@@7|) (LitInt |n#0@@2|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@7| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@2|)))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@5|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Stream.Nil_q (Lit DatatypeTypeType |s#0@@7|)))))) (let ((|tail#9| (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |s#0@@7|)))))
(let ((|t#9| (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Stream.head (Lit DatatypeTypeType |s#0@@7|))))))
 (=> (<= (LitInt 1) (LitInt |n#0@@2|)) (and (and (_module.Tree.Node_q |t#9|) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) (_module.Tree.children |t#9|) (LitInt (- |n#0@@2| 1)))) (=> (_module.__default.LowerThan_h ($LS $ly@@10) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) (_module.Tree.children |t#9|) (LitInt (- |n#0@@2| 1))) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |tail#9| (LitInt |n#0@@2|))))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@5|)) (ite (_module.Stream.Nil_q (Lit DatatypeTypeType |s#0@@7|)) true (let ((|tail#10| (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |s#0@@7|)))))
(let ((|t#10| (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Stream.head (Lit DatatypeTypeType |s#0@@7|))))))
 (and (and (<= (LitInt 1) (LitInt |n#0@@2|)) (_module.__default.LowerThan_h ($LS $ly@@10) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) (Lit DatatypeTypeType (_module.Tree.children |t#10|)) (LitInt (- |n#0@@2| 1)))) (_module.__default.LowerThan_h ($LS $ly@@10) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |tail#10| (LitInt |n#0@@2|))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@5|)) (forall ((|_k'#2| T@U) ) (!  (=> (|ORD#Less| |_k'#2| |_k#0@@5|) (|_module.__default.LowerThan_h#canCall| |_k'#2| |s#0@@7| |n#0@@2|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |669|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@10) |_k'#2| |s#0@@7| |n#0@@2|))
))))) (= (_module.__default.LowerThan_h ($LS $ly@@10) (Lit BoxType |_k#0@@5|) (Lit DatatypeTypeType |s#0@@7|) (LitInt |n#0@@2|))  (and (=> (< 0 (|ORD#Offset| |_k#0@@5|)) (ite (_module.Stream.Nil_q (Lit DatatypeTypeType |s#0@@7|)) true (let ((|tail#8| (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |s#0@@7|)))))
(let ((|t#8| (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Stream.head (Lit DatatypeTypeType |s#0@@7|))))))
 (and (and (<= (LitInt 1) (LitInt |n#0@@2|)) (_module.__default.LowerThan_h ($LS $ly@@10) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) (Lit DatatypeTypeType (_module.Tree.children |t#8|)) (LitInt (- |n#0@@2| 1)))) (_module.__default.LowerThan_h ($LS $ly@@10) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |tail#8| (LitInt |n#0@@2|))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@5|)) (forall ((|_k'#2@@0| T@U) ) (!  (=> (|ORD#Less| |_k'#2@@0| |_k#0@@5|) (_module.__default.LowerThan_h ($LS $ly@@10) |_k'#2@@0| |s#0@@7| |n#0@@2|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |668|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@10) |_k'#2@@0| |s#0@@7| |n#0@@2|))
)))))))
 :qid |InfiniteTreesdfy.71:20|
 :weight 3
 :skolemid |670|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@10) (Lit BoxType |_k#0@@5|) (Lit DatatypeTypeType |s#0@@7|) (LitInt |n#0@@2|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@11 T@U) (|t#0@@2| T@U) (|p#0@@2| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |t#0@@2| Tclass._module.Tree) ($Is DatatypeTypeType |p#0@@2| (Tclass._module.Stream TInt))) (forall ((|_k#0@@6| T@U) ) (! (_module.__default.ValidPath_h ($LS $ly@@11) |_k#0@@6| |t#0@@2| |p#0@@2|)
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |783|
 :pattern ( (_module.__default.ValidPath_h ($LS $ly@@11) |_k#0@@6| |t#0@@2| |p#0@@2|))
))) (_module.__default.ValidPath ($LS $ly@@11) |t#0@@2| |p#0@@2|))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |785|
 :pattern ( (_module.__default.ValidPath ($LS $ly@@11) |t#0@@2| |p#0@@2|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@12 T@U) (|_k#0@@7| T@U) (|t#0@@3| T@U) (|p#0@@3| T@U) ) (!  (=> (or (|_module.__default.ValidPath_h#canCall| |_k#0@@7| |t#0@@3| |p#0@@3|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |t#0@@3| Tclass._module.Tree) ($Is DatatypeTypeType |p#0@@3| (Tclass._module.Stream TInt))))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@7|)) (and (=> (_module.Stream.Nil_q |p#0@@3|) (|$IsA#_module.Tree| |t#0@@3|)) (=> (not (_module.Stream.Nil_q |p#0@@3|)) (let ((|tail#3@@0| (_module.Stream.tail |p#0@@3|)))
...
(let ((|index#4| (U_2_int ($Unbox intType (_module.Stream.head |p#0@@3|)))))
 ...
 (and (_module.Stream.Cons_q |ch#5|) (_module.__default.ValidPath_h $ly@@12 (|ORD#Minus| |_k#0@@7| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head |ch#5|)) |tail#4@@0|)))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@7|)) (forall ((|_k'#0@@1| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@1| |_k#0@@7|) (|_module.__default.ValidPath_h#canCall| |_k'#0@@1| |t#0@@3| |p#0@@3|))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |794|
 :pattern ( (_module.__default.ValidPath_h $ly@@12 |_k'#0@@1| |t#0@@3| |p#0@@3|))
))))) (= (_module.__default.ValidPath_h ($LS $ly@@12) |_k#0@@7| |t#0@@3| |p#0@@3|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@7|)) (ite (_module.Stream.Nil_q |p#0@@3|) (|_module.Tree#Equal| |t#0@@3| (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|))) (let ((|tail#2@@0| (_module.Stream.tail |p#0@@3|)))
(let ((|index#2| (U_2_int ($Unbox intType (_module.Stream.head |p#0@@3|)))))
 ...
 (and (_module.Stream.Cons_q |ch#3|) (_module.__default.ValidPath_h $ly@@12 (|ORD#Minus| |_k#0@@7| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head |ch#3|)) |tail#2@@0|)))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@7|)) (forall ((|_k'#0@@2| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@2| |_k#0@@7|) (_module.__default.ValidPath_h $ly@@12 |_k'#0@@2| |t#0@@3| |p#0@@3|))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |793|
 :pattern ( (_module.__default.ValidPath_h $ly@@12 |_k'#0@@2| |t#0@@3| |p#0@@3|))
)))))))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |795|
 :pattern ( (_module.__default.ValidPath_h ($LS $ly@@12) |_k#0@@7| |t#0@@3| |p#0@@3|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@13 T@U) (|s#0@@8| T@U) (|n#0@@3| Int) ) (!  (=> (and (and ($Is DatatypeTypeType |s#0@@8| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@3|)) (forall ((|_k#0@@8| T@U) ) (! (_module.__default.LowerThan_h ($LS $ly@@13) |_k#0@@8| |s#0@@8| |n#0@@3|)
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |652|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@13) |_k#0@@8| |s#0@@8| |n#0@@3|))
))) (_module.__default.LowerThan ($LS $ly@@13) |s#0@@8| |n#0@@3|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |654|
 :pattern ( (_module.__default.LowerThan ($LS $ly@@13) |s#0@@8| |n#0@@3|))
))))
...
(assert (forall (($ly@@14 T@U) (|s#0@@9| T@U) (|n#0@@4| Int) ) (! (= (_module.__default.LowerThan ($LS $ly@@14) |s#0@@9| |n#0@@4|) (_module.__default.LowerThan $ly@@14 |s#0@@9| |n#0@@4|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |647|
 :pattern ( (_module.__default.LowerThan ($LS $ly@@14) |s#0@@9| |n#0@@4|))
)))
(assert (forall (($ly@@15 T@U) (|t#0@@4| T@U) (|p#0@@4| T@U) ) (! (= (_module.__default.ValidPath ($LS $ly@@15) |t#0@@4| |p#0@@4|) (_module.__default.ValidPath $ly@@15 |t#0@@4| |p#0@@4|))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |778|
 :pattern ( (_module.__default.ValidPath ($LS $ly@@15) |t#0@@4| |p#0@@4|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.Tail$_T0@@1 T@U) ($ly@@16 T@U) (|s#0@@10| T@U) (|n#0@@5| Int) ) (!  (=> (or (|_module.__default.Tail#canCall| _module._default.Tail$_T0@@1 (Lit DatatypeTypeType |s#0@@10|) (LitInt |n#0@@5|)) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@10| (Tclass._module.Stream _module._default.Tail$_T0@@1)) (<= (LitInt 0) |n#0@@5|)))) (and (=> (or (not (= (LitInt |n#0@@5|) (LitInt 0))) (not true)) (and (|_module.__default.Tail#canCall| _module._default.Tail$_T0@@1 (Lit DatatypeTypeType |s#0@@10|) (LitInt (- |n#0@@5| 1))) (let ((|t#2| (Lit DatatypeTypeType (_module.__default.Tail _module._default.Tail$_T0@@1 ($LS $ly@@16) (Lit DatatypeTypeType |s#0@@10|) (LitInt (- |n#0@@5| 1))))))
(|$IsA#_module.Stream| |t#2|)))) (= (_module.__default.Tail _module._default.Tail$_T0@@1 ($LS $ly@@16) (Lit DatatypeTypeType |s#0@@10|) (LitInt |n#0@@5|)) (ite (= (LitInt |n#0@@5|) (LitInt 0)) |s#0@@10| (let ((|t#2@@0| (Lit DatatypeTypeType (_module.__default.Tail _module._default.Tail$_T0@@1 ($LS $ly@@16) (Lit DatatypeTypeType |s#0@@10|) (LitInt (- |n#0@@5| 1))))))
(ite (|$Eq#_module.Stream| _module._default.Tail$_T0@@1 _module._default.Tail$_T0@@1 ($LS ($LS $LZ)) |t#2@@0| |#_module.Stream.Nil|) |t#2@@0| (_module.Stream.tail |t#2@@0|)))))))
 ...
 :weight 3
 :skolemid |591|
 :pattern ( (_module.__default.Tail _module._default.Tail$_T0@@1 ($LS $ly@@16) (Lit DatatypeTypeType |s#0@@10|) (LitInt |n#0@@5|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.Tail$_T0@@2 T@U) ($ly@@17 T@U) (|s#0@@11| T@U) (|n#0@@6| Int) ) (!  (=> (and (or (|_module.__default.Tail#canCall| _module._default.Tail$_T0@@2 |s#0@@11| |n#0@@6|) (and (< 1 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |s#0@@11| (Tclass._module.Stream _module._default.Tail$_T0@@2)) ($IsAlloc DatatypeTypeType |s#0@@11| (Tclass._module.Stream _module._default.Tail$_T0@@2) $Heap)) (<= (LitInt 0) |n#0@@6|)))) ($IsGoodHeap $Heap)) ($IsAlloc DatatypeTypeType (_module.__default.Tail _module._default.Tail$_T0@@2 $ly@@17 |s#0@@11| |n#0@@6|) (Tclass._module.Stream _module._default.Tail$_T0@@2) $Heap))
 :qid |InfiniteTreesdfy.9:16|
 :skolemid |587|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.__default.Tail _module._default.Tail$_T0@@2 $ly@@17 |s#0@@11| |n#0@@6|) (Tclass._module.Stream _module._default.Tail$_T0@@2) $Heap))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@18 T@U) (|_k#0@@9| T@U) (|s#0@@12| T@U) (|n#0@@7| Int) ) (!  (=> (or (|_module.__default.LowerThan_h#canCall| (Lit BoxType |_k#0@@9|) |s#0@@12| |n#0@@7|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@12| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@7|)))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@9|)) (=> (not (_module.Stream.Nil_q |s#0@@12|)) (let ((|tail#6@@0| (_module.Stream.tail |s#0@@12|)))
(let ((|t#6| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@12|))))
 (=> (<= (LitInt 1) |n#0@@7|) (and (and (_module.Tree.Node_q |t#6|) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) (_module.Tree.children |t#6|) (- |n#0@@7| 1))) (=> (_module.__default.LowerThan_h ($LS $ly@@18) (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) (_module.Tree.children |t#6|) (- |n#0@@7| 1)) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) |tail#6@@0| |n#0@@7|)))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@9|)) (ite (_module.Stream.Nil_q |s#0@@12|) true (let ((|tail#7@@0| (_module.Stream.tail |s#0@@12|)))
(let ((|t#7| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@12|))))
 (and (and (<= (LitInt 1) |n#0@@7|) (_module.__default.LowerThan_h ($LS $ly@@18) (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) (_module.Tree.children |t#7|) (- |n#0@@7| 1))) (_module.__default.LowerThan_h ($LS $ly@@18) (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) |tail#7@@0| |n#0@@7|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@9|)) (forall ((|_k'#1@@1| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@1| |_k#0@@9|) (|_module.__default.LowerThan_h#canCall| |_k'#1@@1| |s#0@@12| |n#0@@7|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |666|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@18) |_k'#1@@1| |s#0@@12| |n#0@@7|))
))))) (= (_module.__default.LowerThan_h ($LS $ly@@18) (Lit BoxType |_k#0@@9|) |s#0@@12| |n#0@@7|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@9|)) (ite (_module.Stream.Nil_q |s#0@@12|) true (let ((|tail#5@@0| (_module.Stream.tail |s#0@@12|)))
(let ((|t#5| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@12|))))
 (and (and (<= (LitInt 1) |n#0@@7|) (_module.__default.LowerThan_h ($LS $ly@@18) (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) (_module.Tree.children |t#5|) (- |n#0@@7| 1))) (_module.__default.LowerThan_h ($LS $ly@@18) (|ORD#Minus| |_k#0@@9| (|ORD#FromNat| 1)) |tail#5@@0| |n#0@@7|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@9|)) (forall ((|_k'#1@@2| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@2| |_k#0@@9|) (_module.__default.LowerThan_h ($LS $ly@@18) |_k'#1@@2| |s#0@@12| |n#0@@7|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |665|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@18) |_k'#1@@2| |s#0@@12| |n#0@@7|))
)))))))
 :qid |InfiniteTreesdfy.71:20|
 :weight 3
 :skolemid |667|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@18) (Lit BoxType |_k#0@@9|) |s#0@@12| |n#0@@7|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.Tail$_T0@@3 T@U) ($ly@@19 T@U) (|s#0@@13| T@U) (|n#0@@8| Int) ) (!  (=> (or (|_module.__default.Tail#canCall| _module._default.Tail$_T0@@3 |s#0@@13| |n#0@@8|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@13| (Tclass._module.Stream _module._default.Tail$_T0@@3)) (<= (LitInt 0) |n#0@@8|)))) (and (=> (or (not (= |n#0@@8| (LitInt 0))) (not true)) (and (|_module.__default.Tail#canCall| _module._default.Tail$_T0@@3 |s#0@@13| (- |n#0@@8| 1)) (let ((|t#0@@5| (_module.__default.Tail _module._default.Tail$_T0@@3 $ly@@19 |s#0@@13| (- |n#0@@8| 1))))
(|$IsA#_module.Stream| |t#0@@5|)))) (= (_module.__default.Tail _module._default.Tail$_T0@@3 ($LS $ly@@19) |s#0@@13| |n#0@@8|) (ite (= |n#0@@8| (LitInt 0)) |s#0@@13| (let ((|t#0@@6| (_module.__default.Tail _module._default.Tail$_T0@@3 $ly@@19 |s#0@@13| (- |n#0@@8| 1))))
(ite (|$Eq#_module.Stream| _module._default.Tail$_T0@@3 _module._default.Tail$_T0@@3 ($LS ($LS $LZ)) |t#0@@6| |#_module.Stream.Nil|) |t#0@@6| (_module.Stream.tail |t#0@@6|)))))))
 :qid |unknown.0:0|
 :skolemid |589|
 :pattern ( (_module.__default.Tail _module._default.Tail$_T0@@3 ($LS $ly@@19) |s#0@@13| |n#0@@8|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@20 T@U) (|_k#0@@10| T@U) (|s#0@@14| T@U) (|n#0@@9| Int) ) (!  (=> (or (|_module.__default.LowerThan_h#canCall| |_k#0@@10| |s#0@@14| |n#0@@9|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@14| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@9|)))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@10|)) (=> (not (_module.Stream.Nil_q |s#0@@14|)) (let ((|tail#3@@1| (_module.Stream.tail |s#0@@14|)))
(let ((|t#3| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@14|))))
 (=> (<= (LitInt 1) |n#0@@9|) (and (and (_module.Tree.Node_q |t#3|) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) (_module.Tree.children |t#3|) (- |n#0@@9| 1))) (=> (_module.__default.LowerThan_h $ly@@20 (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) (_module.Tree.children |t#3|) (- |n#0@@9| 1)) (|_module.__default.LowerThan_h#canCall| (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) |tail#3@@1| |n#0@@9|)))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@10|)) (ite (_module.Stream.Nil_q |s#0@@14|) true (let ((|tail#4@@1| (_module.Stream.tail |s#0@@14|)))
(let ((|t#4| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@14|))))
 (and (and (<= (LitInt 1) |n#0@@9|) (_module.__default.LowerThan_h $ly@@20 (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) (_module.Tree.children |t#4|) (- |n#0@@9| 1))) (_module.__default.LowerThan_h $ly@@20 (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) |tail#4@@1| |n#0@@9|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@10|)) (forall ((|_k'#0@@3| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@3| |_k#0@@10|) (|_module.__default.LowerThan_h#canCall| |_k'#0@@3| |s#0@@14| |n#0@@9|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |663|
 :pattern ( (_module.__default.LowerThan_h $ly@@20 |_k'#0@@3| |s#0@@14| |n#0@@9|))
))))) (= (_module.__default.LowerThan_h ($LS $ly@@20) |_k#0@@10| |s#0@@14| |n#0@@9|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@10|)) (ite (_module.Stream.Nil_q |s#0@@14|) true (let ((|tail#2@@1| (_module.Stream.tail |s#0@@14|)))
(let ((|t#2@@1| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@14|))))
 (and (and (<= (LitInt 1) |n#0@@9|) (_module.__default.LowerThan_h $ly@@20 (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) (_module.Tree.children |t#2@@1|) (- |n#0@@9| 1))) (_module.__default.LowerThan_h $ly@@20 (|ORD#Minus| |_k#0@@10| (|ORD#FromNat| 1)) |tail#2@@1| |n#0@@9|)))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@10|)) (forall ((|_k'#0@@4| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@4| |_k#0@@10|) (_module.__default.LowerThan_h $ly@@20 |_k'#0@@4| |s#0@@14| |n#0@@9|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |662|
 :pattern ( (_module.__default.LowerThan_h $ly@@20 |_k'#0@@4| |s#0@@14| |n#0@@9|))
)))))))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |664|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@20) |_k#0@@10| |s#0@@14| |n#0@@9|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|_module._default.IsNeverEndingStream#$S@@2| T@U) ($ly@@21 T@U) (|s#0@@15| T@U) (|_k#0@@11| T@U) ) (!  (=> (and ($Is DatatypeTypeType |s#0@@15| (Tclass._module.Stream |_module._default.IsNeverEndingStream#$S@@2|)) (= |_k#0@@11| (|ORD#FromNat| 0))) (_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@2| $ly@@21 |_k#0@@11| |s#0@@15|))
 :qid |unknown.0:0|
 :skolemid |605|
 :pattern ( (_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@2| $ly@@21 |_k#0@@11| |s#0@@15|))
))))
(assert (forall (($ly@@22 T@U) (|_k#0@@12| T@U) (|s#0@@16| T@U) (|n#0@@10| Int) ) (! (= (_module.__default.LowerThan_h ($LS $ly@@22) |_k#0@@12| |s#0@@16| |n#0@@10|) (_module.__default.LowerThan_h $ly@@22 |_k#0@@12| |s#0@@16| |n#0@@10|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |658|
 :pattern ( (_module.__default.LowerThan_h ($LS $ly@@22) |_k#0@@12| |s#0@@16| |n#0@@10|))
)))
(assert (forall (($ly@@23 T@U) (|_k#0@@13| T@U) (|t#0@@7| T@U) (|p#0@@5| T@U) ) (! (= (_module.__default.ValidPath_h ($LS $ly@@23) |_k#0@@13| |t#0@@7| |p#0@@5|) (_module.__default.ValidPath_h $ly@@23 |_k#0@@13| |t#0@@7| |p#0@@5|))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |789|
 :pattern ( (_module.__default.ValidPath_h ($LS $ly@@23) |_k#0@@13| |t#0@@7| |p#0@@5|))
)))
...
(_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@3| ($LS $ly@@24) (|ORD#Minus| |_k#0@@14| (|ORD#FromNat| 1)) |tail#7@@1|)))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@14|)) (forall ((|_k'#1@@3| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@3| |_k#0@@14|) (|_module.__default.IsNeverEndingStream_h#canCall| |_module._default.IsNeverEndingStream#$S@@3| |_k'#1@@3| |s#0@@17|))
 :qid |InfiniteTreesdfy.41:20|
 :skolemid |615|
 :pattern ( (_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@3| ($LS $ly@@24) |_k'#1@@3| |s#0@@17|))
))))) (= (_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@3| ($LS $ly@@24) (Lit BoxType |_k#0@@14|) |s#0@@17|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@14|)) (ite (_module.Stream.Nil_q |s#0@@17|) false (let ((|tail#5@@1| (_module.Stream.tail |s#0@@17|)))
(_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@3| ($LS $ly@@24) (|ORD#Minus| |_k#0@@14| (|ORD#FromNat| 1)) |tail#5@@1|)))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@14|)) (forall ((|_k'#1@@4| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@4| |_k#0@@14|) (_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@3| ($LS $ly@@24) |_k'#1@@4| |s#0@@17|))
 :qid |InfiniteTreesdfy.41:20|
 :skolemid |614|
 :pattern ( (_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@3| ($LS $ly@@24) |_k'#1@@4| |s#0@@17|))
)))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |616|
 :pattern ( (_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@3| ($LS $ly@@24) (Lit BoxType |_k#0@@14|) |s#0@@17|))
))))
(assert (forall ((|_module._default.IsNeverEndingStream#$S@@4| T@U) ($ly@@25 T@U) (|_k#0@@15| T@U) (|s#0@@18| T@U) ) (! (= (_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@4| ($LS $ly@@25) |_k#0@@15| |s#0@@18|) (_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@4| $ly@@25 |_k#0@@15| |s#0@@18|))
 :qid |unknown.0:0|
 :skolemid |607|
 :pattern ( (_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@4| ($LS $ly@@25) |_k#0@@15| |s#0@@18|))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@26 T@U) (|_k#0@@16| T@U) (|t#0@@8| T@U) (|p#0@@6| T@U) ) (!  (=> (or (|_module.__default.ValidPath_h#canCall| (Lit BoxType |_k#0@@16|) (Lit DatatypeTypeType |t#0@@8|) (Lit DatatypeTypeType |p#0@@6|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |t#0@@8| Tclass._module.Tree) ($Is DatatypeTypeType |p#0@@6| (Tclass._module.Stream TInt))))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@16|)) (and (=> (U_2_bool (Lit boolType (bool_2_U (_module.Stream.Nil_q (Lit DatatypeTypeType |p#0@@6|))))) (|$IsA#_module.Tree| (Lit DatatypeTypeType |t#0@@8|))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Stream.Nil_q (Lit DatatypeTypeType |p#0@@6|)))))) (let ((|tail#9@@0| (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |p#0@@6|)))))
(let ((|index#9| (LitInt (U_2_int ($Unbox intType (_module.Stream.head (Lit DatatypeTypeType |p#0@@6|)))))))
 ...
 (=> (_module.Stream.Cons_q |ch#10|) (|_module.__default.ValidPath_h#canCall| (|ORD#Minus| |_k#0@@16| (|ORD#FromNat| 1)) ($Unbox DatatypeTypeType (_module.Stream.head |ch#10|)) |tail#9@@0|)))))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@16|)) (ite (_module.Stream.Nil_q (Lit DatatypeTypeType |p#0@@6|)) (|_module.Tree#Equal| |t#0@@8| (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|))) (let ((|tail#10@@0| (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |p#0@@6|)))))
(let ((|index#10| (LitInt (U_2_int ($Unbox intType (_module.Stream.head (Lit DatatypeTypeType |p#0@@6|)))))))
 ...
 (and (_module.Stream.Cons_q |ch#11|) (_module.__default.ValidPath_h ($LS $ly@@26) (|ORD#Minus| |_k#0@@16| (|ORD#FromNat| 1)) (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Stream.head |ch#11|))) |tail#10@@0|)))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@16|)) (forall ((|_k'#2@@1| T@U) ) (!  (=> (|ORD#Less| |_k'#2@@1| |_k#0@@16|) (|_module.__default.ValidPath_h#canCall| |_k'#2@@1| |t#0@@8| |p#0@@6|))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |800|
 :pattern ( (_module.__default.ValidPath_h ($LS $ly@@26) |_k'#2@@1| |t#0@@8| |p#0@@6|))
))))) (= (_module.__default.ValidPath_h ($LS $ly@@26) (Lit BoxType |_k#0@@16|) (Lit DatatypeTypeType |t#0@@8|) (Lit DatatypeTypeType |p#0@@6|))  (and (=> (< 0 (|ORD#Offset| |_k#0@@16|)) (ite (_module.Stream.Nil_q (Lit DatatypeTypeType |p#0@@6|)) (|_module.Tree#Equal| |t#0@@8| (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|))) (let ((|tail#8@@0| (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |p#0@@6|)))))
(let ((|index#8| (LitInt (U_2_int ($Unbox intType (_module.Stream.head (Lit DatatypeTypeType |p#0@@6|)))))))
 ...
 (and (_module.Stream.Cons_q |ch#9|) (_module.__default.ValidPath_h ($LS $ly@@26) (|ORD#Minus| |_k#0@@16| (|ORD#FromNat| 1)) (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Stream.head |ch#9|))) |tail#8@@0|)))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@16|)) (forall ((|_k'#2@@2| T@U) ) (!  (=> (|ORD#Less| |_k'#2@@2| |_k#0@@16|) (_module.__default.ValidPath_h ($LS $ly@@26) |_k'#2@@2| |t#0@@8| |p#0@@6|))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |799|
 :pattern ( (_module.__default.ValidPath_h ($LS $ly@@26) |_k'#2@@2| |t#0@@8| |p#0@@6|))
)))))))
 :qid |InfiniteTreesdfy.234:20|
 :weight 3
 :skolemid |801|
 :pattern ( (_module.__default.ValidPath_h ($LS $ly@@26) (Lit BoxType |_k#0@@16|) (Lit DatatypeTypeType |t#0@@8|) (Lit DatatypeTypeType |p#0@@6|)))
))))
...
(assert (forall ((_module._default.Tail$_T0@@4 T@U) ($ly@@27 T@U) (|s#0@@19| T@U) (|n#0@@11| Int) ) (! (= (_module.__default.Tail _module._default.Tail$_T0@@4 ($LS $ly@@27) |s#0@@19| |n#0@@11|) (_module.__default.Tail _module._default.Tail$_T0@@4 $ly@@27 |s#0@@19| |n#0@@11|))
 :qid |unknown.0:0|
 :skolemid |581|
 :pattern ( (_module.__default.Tail _module._default.Tail$_T0@@4 ($LS $ly@@27) |s#0@@19| |n#0@@11|))
)))
...
(_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@5| ($LS $ly@@28) (|ORD#Minus| |_k#0@@17| (|ORD#FromNat| 1)) |tail#10@@1|)))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@17|)) (forall ((|_k'#2@@3| T@U) ) (!  (=> (|ORD#Less| |_k'#2@@3| |_k#0@@17|) (|_module.__default.IsNeverEndingStream_h#canCall| |_module._default.IsNeverEndingStream#$S@@5| |_k'#2@@3| |s#0@@20|))
 :qid |InfiniteTreesdfy.41:20|
 :skolemid |618|
 :pattern ( (_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@5| ($LS $ly@@28) |_k'#2@@3| |s#0@@20|))
))))) (= (_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@5| ($LS $ly@@28) (Lit BoxType |_k#0@@17|) (Lit DatatypeTypeType |s#0@@20|))  (and (=> (< 0 (|ORD#Offset| |_k#0@@17|)) (ite (_module.Stream.Nil_q (Lit DatatypeTypeType |s#0@@20|)) false (let ((|tail#8@@1| (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |s#0@@20|)))))
(_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@5| ($LS $ly@@28) (|ORD#Minus| |_k#0@@17| (|ORD#FromNat| 1)) |tail#8@@1|)))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@17|)) (forall ((|_k'#2@@4| T@U) ) (!  (=> (|ORD#Less| |_k'#2@@4| |_k#0@@17|) (_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@5| ($LS $ly@@28) |_k'#2@@4| |s#0@@20|))
 :qid |InfiniteTreesdfy.41:20|
 :skolemid |617|
 :pattern ( (_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@5| ($LS $ly@@28) |_k'#2@@4| |s#0@@20|))
)))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |619|
 :pattern ( (_module.__default.IsNeverEndingStream_h |_module._default.IsNeverEndingStream#$S@@5| ($LS $ly@@28) (Lit BoxType |_k#0@@17|) (Lit DatatypeTypeType |s#0@@20|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@29 T@U) (|t#0@@9| T@U) (|p#0@@7| T@U) (|_k#0@@18| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |t#0@@9| Tclass._module.Tree) ($Is DatatypeTypeType |p#0@@7| (Tclass._module.Stream TInt))) (= |_k#0@@18| (|ORD#FromNat| 0))) (_module.__default.ValidPath_h $ly@@29 |_k#0@@18| |t#0@@9| |p#0@@7|))
 :qid |InfiniteTreesdfy.234:20|
 :skolemid |786|
 :pattern ( (_module.__default.ValidPath_h $ly@@29 |_k#0@@18| |t#0@@9| |p#0@@7|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@30 T@U) (|s#0@@21| T@U) (|n#0@@12| Int) ) (!  (=> (or (|_module.__default.LowerThan#canCall| |s#0@@21| |n#0@@12|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@21| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@12|)))) (and (=> (not (_module.Stream.Nil_q |s#0@@21|)) (let ((|tail#1@@1| (_module.Stream.tail |s#0@@21|)))
(let ((|t#1@@1| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@21|))))
 (=> (<= (LitInt 1) |n#0@@12|) (and (and (_module.Tree.Node_q |t#1@@1|) (|_module.__default.LowerThan#canCall| (_module.Tree.children |t#1@@1|) (- |n#0@@12| 1))) (=> (_module.__default.LowerThan $ly@@30 (_module.Tree.children |t#1@@1|) (- |n#0@@12| 1)) (|_module.__default.LowerThan#canCall| |tail#1@@1| |n#0@@12|))))))) (= (_module.__default.LowerThan ($LS $ly@@30) |s#0@@21| |n#0@@12|) (ite (_module.Stream.Nil_q |s#0@@21|) true (let ((|tail#0@@1| (_module.Stream.tail |s#0@@21|)))
(let ((|t#0@@10| ($Unbox DatatypeTypeType (_module.Stream.head |s#0@@21|))))
 (and (and (<= (LitInt 1) |n#0@@12|) (_module.__default.LowerThan $ly@@30 (_module.Tree.children |t#0@@10|) (- |n#0@@12| 1))) (_module.__default.LowerThan $ly@@30 |tail#0@@1| |n#0@@12|))))))))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |651|
 :pattern ( (_module.__default.LowerThan ($LS $ly@@30) |s#0@@21| |n#0@@12|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@31 T@U) (|s#0@@22| T@U) (|n#0@@13| Int) (|_k#0@@19| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |s#0@@22| (Tclass._module.Stream Tclass._module.Tree)) (<= (LitInt 0) |n#0@@13|)) (= |_k#0@@19| (|ORD#FromNat| 0))) (_module.__default.LowerThan_h $ly@@31 |_k#0@@19| |s#0@@22| |n#0@@13|))
 :qid |InfiniteTreesdfy.71:20|
 :skolemid |655|
 :pattern ( (_module.__default.LowerThan_h $ly@@31 |_k#0@@19| |s#0@@22| |n#0@@13|))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.Proposition3b__Lemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (not (_module.__default.IsNeverEndingStream TInt ($LS ($LS $LZ)) |p#0@@8|)))))
(let ((anon6_correct  (and (=> (= (ControlFlow 0 6) (- 0 12)) (_module.Stream.Cons_q |ch#0_0@0|)) (=> (_module.Stream.Cons_q |ch#0_0@0|) (=> (_module.Tree.Node_q ($Unbox DatatypeTypeType (_module.Stream.head |ch#0_0@0|))) (=> (and (= |##s#0_1@0| (_module.Tree.children ($Unbox DatatypeTypeType (_module.Stream.head |ch#0_0@0|)))) ($IsAlloc DatatypeTypeType |##s#0_1@0| (Tclass._module.Stream Tclass._module.Tree) $Heap@3)) (and (=> (= (ControlFlow 0 6) (- 0 11)) ($Is intType (int_2_U (- |h#0| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |h#0| 1)) Tclass._System.nat) (=> (= |##n#0_1@0| (- |h#0| 1)) (=> (and (and ($IsAlloc intType (int_2_U |##n#0_1@0|) Tclass._System.nat $Heap@3) (|_module.__default.LowerThan#canCall| (_module.Tree.children ($Unbox DatatypeTypeType (_module.Stream.head |ch#0_0@0|))) (- |h#0| 1))) (and (_module.Tree.Node_q ($Unbox DatatypeTypeType (_module.Stream.head |ch#0_0@0|))) (|_module.__default.LowerThan#canCall| (_module.Tree.children ($Unbox DatatypeTypeType (_module.Stream.head |ch#0_0@0|))) (- |h#0| 1)))) (and (=> (= (ControlFlow 0 6) (- 0 10)) (=> (|_module.__default.LowerThan#canCall| (_module.Tree.children ($Unbox DatatypeTypeType (_module.Stream.head |ch#0_0@0|))) (- |h#0| 1)) (or (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children ($Unbox DatatypeTypeType (_module.Stream.head |ch#0_0@0|))) (- |h#0| 1)) (=> (_module.Stream.Nil_q (_module.Tree.children ($Unbox DatatypeTypeType (_module.Stream.head |ch#0_0@0|)))) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 6) (- 0 9)) (=> (|_module.__default.LowerThan#canCall| (_module.Tree.children ($Unbox DatatypeTypeType (_module.Stream.head |ch#0_0@0|))) (- |h#0| 1)) (or (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children ($Unbox DatatypeTypeType (_module.Stream.head |ch#0_0@0|))) (- |h#0| 1)) (=> (not (_module.Stream.Nil_q (_module.Tree.children ($Unbox DatatypeTypeType (_module.Stream.head |ch#0_0@0|))))) (<= (LitInt 1) (- |h#0| 1)))))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (=> (|_module.__default.LowerThan#canCall| (_module.Tree.children ($Unbox DatatypeTypeType (_module.Stream.head |ch#0_0@0|))) (- |h#0| 1)) (or (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children ($Unbox DatatypeTypeType (_module.Stream.head |ch#0_0@0|))) (- |h#0| 1)) (=> (not (_module.Stream.Nil_q (_module.Tree.children ($Unbox DatatypeTypeType (_module.Stream.head |ch#0_0@0|))))) (let ((|t#0_0| ($Unbox DatatypeTypeType (_module.Stream.head (_module.Tree.children ($Unbox DatatypeTypeType (_module.Stream.head |ch#0_0@0|)))))))
(_module.__default.LowerThan ($LS ($LS $LZ)) (_module.Tree.children |t#0_0|) (- (- |h#0| 1) 1))))))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (=> (|_module.__default.LowerThan#canCall| (_module.Tree.children ($Unbox DatatypeTypeType (_module.Stream.head |ch#0_0@0|))) (- |h#0| 1)) (or (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children ($Unbox DatatypeTypeType (_module.Stream.head |ch#0_0@0|))) (- |h#0| 1)) (=> (not (_module.Stream.Nil_q (_module.Tree.children ($Unbox DatatypeTypeType (_module.Stream.head |ch#0_0@0|))))) (let ((|tail#0_1| (_module.Stream.tail (_module.Tree.children ($Unbox DatatypeTypeType (_module.Stream.head |ch#0_0@0|))))))
(_module.__default.LowerThan ($LS ($LS $LZ)) |tail#0_1| (- |h#0| 1))))))) (=> (and (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children ($Unbox DatatypeTypeType (_module.Stream.head |ch#0_0@0|))) (- |h#0| 1)) (= (ControlFlow 0 6) 4)) GeneratedUnifiedExit_correct)))))))))))))))
(let ((anon11_Then_correct  (=> (and (= (_module.Tree.children |t#0@@11|) (|#_module.Stream.Cons| ($Box DatatypeTypeType |_mcc#2#0_0_0@0|) |_mcc#3#0_0_0@0|)) ($Is DatatypeTypeType |_mcc#2#0_0_0@0| Tclass._module.Tree)) (=> (and (and ($Is DatatypeTypeType |_mcc#3#0_0_0@0| (Tclass._module.Stream Tclass._module.Tree)) (_module.Tree.Node_q |t#0@@11|)) (and (_module.Tree.Node_q |t#0@@11|) (= |s##0_0_0@0| (_module.Tree.children |t#0@@11|)))) (and (=> (= (ControlFlow 0 15) (- 0 16)) ($Is intType (int_2_U |index#0_0@0|) Tclass._System.nat)) (=> ($Is intType (int_2_U |index#0_0@0|) Tclass._System.nat) (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (and (|_module.__default.LowerThan#canCall| |s##0_0_0@0| |h#0|) (=> (_module.__default.LowerThan ($LS $LZ) |s##0_0_0@0| |h#0|) (and (|_module.__default.Tail#canCall| Tclass._module.Tree |s##0_0_0@0| |index#0_0@0|) (|_module.__default.LowerThan#canCall| (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s##0_0_0@0| |index#0_0@0|) |h#0|))))) (and (and (=> (_module.__default.LowerThan ($LS $LZ) |s##0_0_0@0| |h#0|) (and (|_module.__default.LowerThan#canCall| (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s##0_0_0@0| |index#0_0@0|) |h#0|) (and (_module.__default.LowerThan ($LS $LZ) (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s##0_0_0@0| |index#0_0@0|) |h#0|) (ite (_module.Stream.Nil_q (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s##0_0_0@0| |index#0_0@0|)) true (let ((|tail#1@@2| (_module.Stream.tail (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s##0_0_0@0| |index#0_0@0|))))
(let ((|t#1@@2| ($Unbox DatatypeTypeType (_module.Stream.head (_module.__default.Tail Tclass._module.Tree ($LS $LZ) |s##0_0_0@0| |index#0_0@0|)))))
 (and (and (<= (LitInt 1) |h#0|) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#1@@2|) (- |h#0| 1))) (_module.__default.LowerThan ($LS $LZ) |tail#1@@2| |h#0|)))))))) (= $Heap@0 $Heap@2)) (and (= $Heap@3 $Heap@2) (= (ControlFlow 0 15) 6)))) anon6_correct)))))))
(let ((anon10_Then_correct  (=> (= (_module.Tree.children |t#0@@11|) |#_module.Stream.Nil|) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (|_module.__default.ValidPath#canCall| (Lit DatatypeTypeType (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|))) |p#0@@8|) (=> (_module.__default.ValidPath ($LS $LZ) (Lit DatatypeTypeType (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|))) |p#0@@8|) (|$IsA#_module.Stream| |p#0@@8|))) (and (=> (_module.__default.ValidPath ($LS $LZ) (Lit DatatypeTypeType (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|))) |p#0@@8|) (|$Eq#_module.Stream| TInt TInt ($LS ($LS $LZ)) |p#0@@8| |#_module.Stream.Nil|)) (= $Heap@0 $Heap@1))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (U_2_bool (Lit boolType (bool_2_U false)))) (=> (U_2_bool (Lit boolType (bool_2_U false))) (=> (and (= $Heap@3 $Heap@1) (= (ControlFlow 0 13) 6)) anon6_correct))))))))
(let ((anon8_Then_correct  (=> (and (= |p#0@@8| |#_module.Stream.Nil|) (= (ControlFlow 0 5) 4)) GeneratedUnifiedExit_correct)))
(let ((anon11_Else_correct true))
(let ((anon10_Else_correct  (=> (or (not (= (_module.Tree.children |t#0@@11|) |#_module.Stream.Nil|)) (not true)) (and (=> (= (ControlFlow 0 17) 15) anon11_Then_correct) (=> (= (ControlFlow 0 17) 2) anon11_Else_correct)))))
(let ((anon9_Then_correct  (=> (and (= |p#0@@8| (|#_module.Stream.Cons| ($Box intType (int_2_U |_mcc#0#0_0@0|)) |_mcc#1#0_0@0|)) ($Is DatatypeTypeType |_mcc#1#0_0@0| (Tclass._module.Stream TInt))) (=> (and (and ($Is DatatypeTypeType |tail#0_0@0| (Tclass._module.Stream TInt)) ($IsAlloc DatatypeTypeType |tail#0_0@0| (Tclass._module.Stream TInt) $Heap@0)) (= |let#0_0#0#0| |_mcc#1#0_0@0|)) (=> (and (and (and ($Is DatatypeTypeType |let#0_0#0#0| (Tclass._module.Stream TInt)) (= |tail#0_0@0| |let#0_0#0#0|)) (and (= |let#0_1#0#0| |_mcc#0#0_0@0|) ($Is intType (int_2_U |let#0_1#0#0|) TInt))) (and (and (= |index#0_0@0| |let#0_1#0#0|) (_module.Tree.Node_q |t#0@@11|)) (and (= |##s#0_0@0| (_module.Tree.children |t#0@@11|)) ($IsAlloc DatatypeTypeType |##s#0_0@0| (Tclass._module.Stream Tclass._module.Tree) $Heap@0)))) (and (=> (= (ControlFlow 0 18) (- 0 19)) ($Is intType (int_2_U |index#0_0@0|) Tclass._System.nat)) (=> ($Is intType (int_2_U |index#0_0@0|) Tclass._System.nat) (=> (and ($IsAlloc intType (int_2_U |index#0_0@0|) Tclass._System.nat $Heap@0) (|_module.__default.Tail#canCall| Tclass._module.Tree (_module.Tree.children |t#0@@11|) |index#0_0@0|)) (=> (and (and (and (_module.Tree.Node_q |t#0@@11|) (|_module.__default.Tail#canCall| Tclass._module.Tree (_module.Tree.children |t#0@@11|) |index#0_0@0|)) (= |ch#0_0@0| (_module.__default.Tail Tclass._module.Tree ($LS $LZ) (_module.Tree.children |t#0@@11|) |index#0_0@0|))) (and (_module.Tree.Node_q |t#0@@11|) (_module.Tree.Node_q |t#0@@11|))) (and (=> (= (ControlFlow 0 18) 13) anon10_Then_correct) (=> (= (ControlFlow 0 18) 17) anon10_Else_correct)))))))))))
(let ((anon9_Else_correct true))
(let ((anon8_Else_correct  (=> (or (not (= |p#0@@8| |#_module.Stream.Nil|)) (not true)) (and (=> (= (ControlFlow 0 20) 18) anon9_Then_correct) (=> (= (ControlFlow 0 20) 1) anon9_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and (|$IsA#_module.Tree| |t#0@@11|) (|$IsA#_module.Stream| |p#0@@8|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@0 $Heap@0) (forall ((|$ih#t0#0| T@U) (|$ih#h0#0| Int) (|$ih#p0#0| T@U) ) (!  (=> (and (and (and (and ($Is DatatypeTypeType |$ih#t0#0| Tclass._module.Tree) (<= (LitInt 0) |$ih#h0#0|)) ($Is DatatypeTypeType |$ih#p0#0| (Tclass._module.Stream TInt))) (and (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |$ih#t0#0|) |$ih#h0#0|) (_module.__default.ValidPath ($LS $LZ) |$ih#t0#0| |$ih#p0#0|))) (and (<= 0 |$ih#h0#0|) (< |$ih#h0#0| |h#0|))) (not (_module.__default.IsNeverEndingStream TInt ($LS $LZ) |$ih#p0#0|)))
 :qid |InfiniteTreesdfy.376:27|
 :skolemid |877|
 :pattern ( (_module.__default.IsNeverEndingStream TInt ($LS $LZ) |$ih#p0#0|) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |$ih#t0#0|) |$ih#h0#0|))
 :pattern ( (_module.__default.ValidPath ($LS $LZ) |$ih#t0#0| |$ih#p0#0|) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |$ih#t0#0|) |$ih#h0#0|))
)))) (and (=> (= (ControlFlow 0 21) 5) anon8_Then_correct) (=> (= (ControlFlow 0 21) 20) anon8_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (and ($Is DatatypeTypeType |t#0@@11| Tclass._module.Tree) ($IsAlloc DatatypeTypeType |t#0@@11| Tclass._module.Tree $Heap@@0)) (|$IsA#_module.Tree| |t#0@@11|)) (<= (LitInt 0) |h#0|)) (and (and ($Is DatatypeTypeType |p#0@@8| (Tclass._module.Stream TInt)) ($IsAlloc DatatypeTypeType |p#0@@8| (Tclass._module.Stream TInt) $Heap@@0)) (|$IsA#_module.Stream| |p#0@@8|))) (=> (and (and (and (and (and ($Is DatatypeTypeType |ch#0_0| (Tclass._module.Stream Tclass._module.Tree)) ($IsAlloc DatatypeTypeType |ch#0_0| (Tclass._module.Stream Tclass._module.Tree) $Heap@@0)) true) (= 4 $FunctionContextHeight)) (and (|_module.__default.LowerThan#canCall| (_module.Tree.children |t#0@@11|) |h#0|) (and (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#0@@11|) |h#0|) (ite (_module.Stream.Nil_q (_module.Tree.children |t#0@@11|)) true (let ((|tail#5@@2| (_module.Stream.tail (_module.Tree.children |t#0@@11|))))
(let ((|t#4@@0| ($Unbox DatatypeTypeType (_module.Stream.head (_module.Tree.children |t#0@@11|)))))
 (and (and (<= (LitInt 1) |h#0|) (_module.__default.LowerThan ($LS $LZ) (_module.Tree.children |t#4@@0|) (- |h#0| 1))) (_module.__default.LowerThan ($LS $LZ) |tail#5@@2| |h#0|)))))))) (and (and (|_module.__default.ValidPath#canCall| |t#0@@11| |p#0@@8|) (and (_module.__default.ValidPath ($LS $LZ) |t#0@@11| |p#0@@8|) (ite (_module.Stream.Nil_q |p#0@@8|) (|_module.Tree#Equal| |t#0@@11| (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Stream.Nil|))) (let ((|tail#7@@2| (_module.Stream.tail |p#0@@8|)))
(let ((|index#3@@0| (U_2_int ($Unbox intType (_module.Stream.head |p#0@@8|)))))
 (and (<= (LitInt 0) |index#3@@0|) (let ((|ch#3@@0| (_module.__default.Tail Tclass._module.Tree ($LS $LZ) (_module.Tree.children |t#0@@11|) |index#3@@0|)))
 (and (_module.Stream.Cons_q |ch#3@@0|) (_module.__default.ValidPath ($LS $LZ) ($Unbox DatatypeTypeType (_module.Stream.head |ch#3@@0|)) |tail#7@@2|))))))))) (= (ControlFlow 0 22) 21))) anon0_correct)))))
