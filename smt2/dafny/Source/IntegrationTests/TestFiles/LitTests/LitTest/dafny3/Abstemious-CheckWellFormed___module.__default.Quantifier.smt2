...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Quantifier)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (<= (LitInt 0) |k#0@0|)) (and |_module.__default.OhOnes#canCall| (_module.Stream.Cons_q (Lit DatatypeTypeType (_module.__default.OhOnes ($LS $LZ)))))) (and (and (_module.Stream.Cons_q (Lit DatatypeTypeType (_module.__default.OhOnes ($LS $LZ)))) |_module.__default.ones#canCall|) (and (_module.Stream.Cons_q (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))) (= (ControlFlow 0 2) (- 0 1))))) (<= 0 |k#0@0|))))
