...
(declare-fun _module._default.CopyFastest$T () T@U)
(declare-fun |t#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.CopyFastest)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SetType |s#0| (TSet _module._default.CopyFastest$T)) ($IsAlloc SetType |s#0| (TSet _module._default.CopyFastest$T) $Heap))) (and (and ($Is SetType |t#0| (TSet _module._default.CopyFastest$T)) ($IsAlloc SetType |t#0| (TSet _module._default.CopyFastest$T) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
