...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.UpLemma__Auto)
...
(let ((anon4_Then_correct  (=> (and (and (= |nn#0| (+ |n#0@@2| 1)) ($IsAlloc intType (int_2_U |n#0@@2|) TInt $Heap@0)) (and (|_module.__default.Up#canCall| |n#0@@2|) (_module.Stream.Cons_q (_module.__default.Up ($LS $LZ) |n#0@@2|)))) (=> (and (and (and (= |##s#0@0| (_module.__default.Up ($LS $LZ) |n#0@@2|)) ($IsAlloc DatatypeTypeType |##s#0@0| (Tclass._module.Stream TInt) $Heap@0)) (and (|_module.__default.Inc#canCall| (_module.__default.Up ($LS $LZ) |n#0@@2|)) (_module.Stream.Cons_q (_module.__default.Inc ($LS $LZ) (_module.__default.Up ($LS $LZ) |n#0@@2|))))) (and (and ($IsAlloc intType (int_2_U |nn#0|) TInt $Heap@0) (|_module.__default.Up#canCall| |nn#0|)) (and (_module.Stream.Cons_q (_module.__default.Up ($LS $LZ) |nn#0|)) (= (ControlFlow 0 2) (- 0 1))))) (<= 0 |k#0|)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (=> (= (ControlFlow 0 4) 2) anon4_Then_correct) (=> (= (ControlFlow 0 4) 3) anon4_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |k#0|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct)))
