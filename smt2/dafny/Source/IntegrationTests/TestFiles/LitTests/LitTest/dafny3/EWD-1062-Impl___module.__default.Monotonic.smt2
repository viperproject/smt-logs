...
(set-info :boogie-vc-id Impl$$_module.__default.Monotonic)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (_module.__default.Below |u#0| |v#0|)) (=> (_module.__default.Below |u#0| |v#0|) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (|_module.__default.f#canCall| |u#0|) (|_module.__default.f#canCall| |v#0|)) (|_module.__default.Below#canCall| (_module.__default.f |u#0|) (_module.__default.f |v#0|))) (and (_module.__default.Below (_module.__default.f |u#0|) (_module.__default.f |v#0|)) (= $Heap $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (_module.__default.Below |u#0| |v#0|)) (=> (_module.__default.Below |u#0| |v#0|) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and (|_module.__default.g#canCall| |u#0|) (|_module.__default.g#canCall| |v#0|)) (|_module.__default.Below#canCall| (_module.__default.g |u#0|) (_module.__default.g |v#0|))) (and (_module.__default.Below (_module.__default.g |u#0|) (_module.__default.g |v#0|)) (= $Heap@0 $Heap@1))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (_module.__default.Below (_module.__default.f |u#0|) (_module.__default.f |v#0|))) (=> (_module.__default.Below (_module.__default.f |u#0|) (_module.__default.f |v#0|)) (=> (= (ControlFlow 0 2) (- 0 1)) (_module.__default.Below (_module.__default.g |u#0|) (_module.__default.g |v#0|))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($IsBox |u#0| Tclass._module.T) ($IsAllocBox |u#0| Tclass._module.T $Heap))) (=> (and (and (and ($IsBox |v#0| Tclass._module.T) ($IsAllocBox |v#0| Tclass._module.T $Heap)) (= 4 $FunctionContextHeight)) (and (_module.__default.Below |u#0| |v#0|) (= (ControlFlow 0 6) 2))) anon0_correct))))
