...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (|p#0@@1| T@U) ) (!  (=> (or (|M3.__default.LocInv__Cmd#canCall| |p#0@@1|) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap) ($Is DatatypeTypeType |p#0@@1| Tclass.M3.Path)))) (and (=> (not (M3.Path.InternalPath_q |p#0@@1|)) |$let#3$canCall|) (= (M3.__default.LocInv__Cmd |p#0@@1|) (ite (M3.Path.InternalPath_q |p#0@@1|) (let ((|cmd#0@@0| (M3.Path.cmd |p#0@@1|)))
|cmd#0@@0|) (let ((|cmd#1| |$let#3_cmd|))
|cmd#1|)))))
 :qid |CloudMakeParallelBuildsdfy.797:18|
 :skolemid |5685|
 :pattern ( (M3.__default.LocInv__Cmd |p#0@@1|) ($IsGoodHeap $Heap))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|p#0@@2| T@U) ) (!  (=> (or (|M3.__default.LocInv__Deps#canCall| |p#0@@2|) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) ($Is DatatypeTypeType |p#0@@2| Tclass.M3.Path)))) (and (=> (not (M3.Path.InternalPath_q |p#0@@2|)) |$let#10$canCall|) (= (M3.__default.LocInv__Deps |p#0@@2|) (ite (M3.Path.InternalPath_q |p#0@@2|) (let ((|deps#0@@0| (M3.Path.deps |p#0@@2|)))
|deps#0@@0|) (let ((|deps#1| |$let#10_deps|))
|deps#1|)))))
 :qid |CloudMakeParallelBuildsdfy.803:18|
 :skolemid |5689|
 :pattern ( (M3.__default.LocInv__Deps |p#0@@2|) ($IsGoodHeap $Heap@@0))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@1 T@U) (|p#0@@3| T@U) ) (!  (=> (or (|M3.__default.LocInv__Exp#canCall| |p#0@@3|) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@1) ($Is DatatypeTypeType |p#0@@3| Tclass.M3.Path)))) (and (=> (not (M3.Path.InternalPath_q |p#0@@3|)) |$let#17$canCall|) (= (M3.__default.LocInv__Exp |p#0@@3|) (ite (M3.Path.InternalPath_q |p#0@@3|) (let ((|exp#0@@0| (M3.Path.exp |p#0@@3|)))
|exp#0@@0|) (let ((|exp#1| |$let#17_exp|))
|exp#1|)))))
 :qid |CloudMakeParallelBuildsdfy.809:18|
 :skolemid |5693|
 :pattern ( (M3.__default.LocInv__Exp |p#0@@3|) ($IsGoodHeap $Heap@@1))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|cmd#0@@1| T@U) (|deps#0@@1| T@U) (|exp#0@@1| T@U) ) (!  (=> (or (|M3.__default.Loc#canCall| (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) (Lit SeqType |exp#0@@1|)) (and (< 1 $FunctionContextHeight) (and (and ($Is SeqType |cmd#0@@1| (TSeq TChar)) ($Is SetType |deps#0@@1| (TSet Tclass.M3.Path))) ($Is SeqType |exp#0@@1| (TSeq TChar))))) (= (M3.__default.Loc (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) (Lit SeqType |exp#0@@1|)) (Lit DatatypeTypeType (|#M3.Path.InternalPath| (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) (Lit SeqType |exp#0@@1|)))))
 :qid |CloudMakeParallelBuildsdfy.154:22|
 :weight 3
 :skolemid |5682|
 :pattern ( (M3.__default.Loc (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) (Lit SeqType |exp#0@@1|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|p#0@@4| T@U) ) (!  (=> (or (|M3.__default.LocInv__Deps#canCall| |p#0@@4|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |p#0@@4| Tclass.M3.Path))) ($Is SetType (M3.__default.LocInv__Deps |p#0@@4|) (TSet Tclass.M3.Path)))
 :qid |CloudMakeParallelBuildsdfy.637:30|
 :skolemid |5687|
 :pattern ( (M3.__default.LocInv__Deps |p#0@@4|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@2 T@U) (|p#0@@5| T@U) ) (!  (=> (or (|M3.__default.LocInv__Cmd#canCall| (Lit DatatypeTypeType |p#0@@5|)) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@2) ($Is DatatypeTypeType |p#0@@5| Tclass.M3.Path)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (M3.Path.InternalPath_q (Lit DatatypeTypeType |p#0@@5|)))))) |$let#3$canCall|) (= (M3.__default.LocInv__Cmd (Lit DatatypeTypeType |p#0@@5|)) (ite (M3.Path.InternalPath_q (Lit DatatypeTypeType |p#0@@5|)) (let ((|cmd#3| (Lit SeqType (M3.Path.cmd (Lit DatatypeTypeType |p#0@@5|)))))
|cmd#3|) (let ((|cmd#4| |$let#3_cmd|))
|cmd#4|)))))
 :qid |CloudMakeParallelBuildsdfy.797:18|
 :weight 3
 :skolemid |5686|
 :pattern ( (M3.__default.LocInv__Cmd (Lit DatatypeTypeType |p#0@@5|)) ($IsGoodHeap $Heap@@2))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@3 T@U) (|p#0@@6| T@U) ) (!  (=> (or (|M3.__default.LocInv__Deps#canCall| (Lit DatatypeTypeType |p#0@@6|)) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@3) ($Is DatatypeTypeType |p#0@@6| Tclass.M3.Path)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (M3.Path.InternalPath_q (Lit DatatypeTypeType |p#0@@6|)))))) |$let#10$canCall|) (= (M3.__default.LocInv__Deps (Lit DatatypeTypeType |p#0@@6|)) (ite (M3.Path.InternalPath_q (Lit DatatypeTypeType |p#0@@6|)) (let ((|deps#3| (Lit SetType (M3.Path.deps (Lit DatatypeTypeType |p#0@@6|)))))
|deps#3|) (let ((|deps#4| |$let#10_deps|))
|deps#4|)))))
 :qid |CloudMakeParallelBuildsdfy.803:18|
 :weight 3
 :skolemid |5690|
 :pattern ( (M3.__default.LocInv__Deps (Lit DatatypeTypeType |p#0@@6|)) ($IsGoodHeap $Heap@@3))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@4 T@U) (|p#0@@7| T@U) ) (!  (=> (or (|M3.__default.LocInv__Exp#canCall| (Lit DatatypeTypeType |p#0@@7|)) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@4) ($Is DatatypeTypeType |p#0@@7| Tclass.M3.Path)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (M3.Path.InternalPath_q (Lit DatatypeTypeType |p#0@@7|)))))) |$let#17$canCall|) (= (M3.__default.LocInv__Exp (Lit DatatypeTypeType |p#0@@7|)) (ite (M3.Path.InternalPath_q (Lit DatatypeTypeType |p#0@@7|)) (let ((|exp#3| (Lit SeqType (M3.Path.exp (Lit DatatypeTypeType |p#0@@7|)))))
|exp#3|) (let ((|exp#4| |$let#17_exp|))
|exp#4|)))))
 :qid |CloudMakeParallelBuildsdfy.809:18|
 :weight 3
 :skolemid |5694|
 :pattern ( (M3.__default.LocInv__Exp (Lit DatatypeTypeType |p#0@@7|)) ($IsGoodHeap $Heap@@4))
))))
...
(assert (forall ((a@@1 T@U) (b@@1 T@U) ) (! (= (|Set#Equal| a@@1 b@@1) (forall ((o T@U) ) (! (= (|Set#IsMember| a@@1 o) (|Set#IsMember| b@@1 o))
 :qid |DafnyPreludebpl.783:19|
 :skolemid |5103|
 :pattern ( (|Set#IsMember| a@@1 o))
 :pattern ( (|Set#IsMember| b@@1 o))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|cmd#0@@2| T@U) (|deps#0@@2| T@U) (|exp#0@@2| T@U) ) (!  (=> (or (|M3.__default.Loc#canCall| |cmd#0@@2| |deps#0@@2| |exp#0@@2|) (and (< 1 $FunctionContextHeight) (and (and ($Is SeqType |cmd#0@@2| (TSeq TChar)) ($Is SetType |deps#0@@2| (TSet Tclass.M3.Path))) ($Is SeqType |exp#0@@2| (TSeq TChar))))) (= (M3.__default.Loc |cmd#0@@2| |deps#0@@2| |exp#0@@2|) (|#M3.Path.InternalPath| |cmd#0@@2| |deps#0@@2| |exp#0@@2|)))
 :qid |CloudMakeParallelBuildsdfy.154:22|
 :skolemid |5681|
 :pattern ( (M3.__default.Loc |cmd#0@@2| |deps#0@@2| |exp#0@@2|))
))))
...
(declare-fun |exp#0@@3| () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id Impl$$M3.__default.LocInjectivity)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#4| null $Heap@@5 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Seq#Equal| (M3.__default.LocInv__Cmd (M3.__default.Loc |cmd#0@@3| |deps#0@@3| |exp#0@@3|)) |cmd#0@@3|)) (=> (|Seq#Equal| (M3.__default.LocInv__Cmd (M3.__default.Loc |cmd#0@@3| |deps#0@@3| |exp#0@@3|)) |cmd#0@@3|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Equal| (M3.__default.LocInv__Deps (M3.__default.Loc |cmd#0@@3| |deps#0@@3| |exp#0@@3|)) |deps#0@@3|)) (=> (|Set#Equal| (M3.__default.LocInv__Deps (M3.__default.Loc |cmd#0@@3| |deps#0@@3| |exp#0@@3|)) |deps#0@@3|) (=> (= (ControlFlow 0 2) (- 0 1)) (|Seq#Equal| (M3.__default.LocInv__Exp (M3.__default.Loc |cmd#0@@3| |deps#0@@3| |exp#0@@3|)) |exp#0@@3|)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@5) ($IsHeapAnchor $Heap@@5)) (=> (and (and (and ($Is SeqType |cmd#0@@3| (TSeq TChar)) ($IsAlloc SeqType |cmd#0@@3| (TSeq TChar) $Heap@@5)) (and ($Is SetType |deps#0@@3| (TSet Tclass.M3.Path)) ($IsAlloc SetType |deps#0@@3| (TSet Tclass.M3.Path) $Heap@@5))) (and (and ($Is SeqType |exp#0@@3| (TSeq TChar)) ($IsAlloc SeqType |exp#0@@3| (TSeq TChar) $Heap@@5)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 5) 2)))) anon0_correct))))
