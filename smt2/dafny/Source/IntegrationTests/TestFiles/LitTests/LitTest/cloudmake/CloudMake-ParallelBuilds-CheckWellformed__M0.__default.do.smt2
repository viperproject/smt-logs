...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@7 T@U) (|stmts#0@@3| T@U) (|st#0@@12| T@U) (|env#0@@7| T@U) ) (!  (=> (or (|M0.__default.do#canCall| (Lit SeqType |stmts#0@@3|) |st#0@@12| |env#0@@7|) (and (< 5 $FunctionContextHeight) (and (and (and ($Is SeqType |stmts#0@@3| (TSeq Tclass.M0.Statement)) ($IsBox |st#0@@12| Tclass.M0.State)) ($IsBox |env#0@@7| Tclass.M0.Env)) (and (M0.__default.Legal (Lit SeqType |stmts#0@@3|)) (M0.__default.ValidEnv |env#0@@7|))))) (and (let ((|stmt#1| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |stmts#0@@3|) (LitInt 0)))))
 (and (=> (M0.Statement.stmtVariable_q |stmt#1|) (and (|M0.__default.eval#canCall| (M0.Statement.expr |stmt#1|) |st#0@@12| |env#0@@7|) (let ((|st'#1| (M0.Tuple.snd (M0.__default.eval ($LS $LZ) (M0.Statement.expr |stmt#1|) |st#0@@12| |env#0@@7|))))
(let ((|expr'#1| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $LZ) (M0.Statement.expr |stmt#1|) |st#0@@12| |env#0@@7|)))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|cmd#0@@4| T@U) (|deps#0@@4| T@U) (|exps#0@@3| T@U) (|st#0@@13| T@U) ) (!  (=> (or (|M0.__default.Pre#canCall| (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) (Lit SetType |exps#0@@3|) |st#0@@13|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@4| (TSeq TChar)) ($Is SetType |deps#0@@4| (TSet Tclass.M0.Path))) ($Is SetType |exps#0@@3| (TSet (TSeq TChar)))) ($IsBox |st#0@@13| Tclass.M0.State)))) (and (forall ((|e#1| T@U) ) (!  (=> ($Is SeqType |e#1| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@3|) ($Box SeqType |e#1|)) (and (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1|) (|M0.__default.DomSt#canCall| |st#0@@13|)) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@13|) (M0.__default.Loc (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1|)) (and (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1|) (|M0.__default.GetSt#canCall| (M0.__default.Loc (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1|) |st#0@@13|)) (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1|) (|M0.__default.Oracle#canCall| (M0.__default.Loc (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1|) |st#0@@13|)))))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |822|
 :pattern ( (M0.__default.Loc |cmd#0@@4| |deps#0@@4| |e#1|))
 :pattern ( (|Set#IsMember| |exps#0@@3| ($Box SeqType |e#1|)))
)) (= (M0.__default.Pre (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) (Lit SetType |exps#0@@3|) |st#0@@13|) (forall ((|e#1@@0| T@U) ) (!  (=> ($Is SeqType |e#1@@0| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@3|) ($Box SeqType |e#1@@0|)) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@13|) (M0.__default.Loc (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1@@0|)) (= (M0.__default.GetSt (M0.__default.Loc (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1@@0|) |st#0@@13|) (M0.__default.Oracle (M0.__default.Loc (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1@@0|) |st#0@@13|)))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |821|
 ...
 :weight 3
 :skolemid |823|
 :pattern ( (M0.__default.Pre (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) (Lit SetType |exps#0@@3|) |st#0@@13|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@10 T@U) (|expr#0@@2| T@U) (|st#0@@14| T@U) (|env#0@@11| T@U) ) (!  (=> (or (|M0.__default.eval#canCall| |expr#0@@2| |st#0@@14| |env#0@@11|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0@@2| Tclass.M0.Expression) ($IsBox |st#0@@14| Tclass.M0.State)) ($IsBox |env#0@@11| Tclass.M0.Env)) (M0.__default.ValidEnv |env#0@@11|)))) ($Is DatatypeTypeType (M0.__default.eval $ly@@10 |expr#0@@2| |st#0@@14| |env#0@@11|) (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State)))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |971|
 :pattern ( (M0.__default.eval $ly@@10 |expr#0@@2| |st#0@@14| |env#0@@11|))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@11 T@U) (|stmts#0@@4| T@U) (|st#0@@15| T@U) (|env#0@@12| T@U) ) (!  (=> (or (|M0.__default.do#canCall| |stmts#0@@4| |st#0@@15| |env#0@@12|) (and (< 5 $FunctionContextHeight) (and (and (and ($Is SeqType |stmts#0@@4| (TSeq Tclass.M0.Statement)) ($IsBox |st#0@@15| Tclass.M0.State)) ($IsBox |env#0@@12| Tclass.M0.Env)) (and (M0.__default.Legal |stmts#0@@4|) (M0.__default.ValidEnv |env#0@@12|))))) ($Is DatatypeTypeType (M0.__default.do $ly@@11 |stmts#0@@4| |st#0@@15| |env#0@@12|) (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State)))
 :qid |CloudMakeParallelBuildsdfy.177:18|
 :skolemid |951|
 :pattern ( (M0.__default.do $ly@@11 |stmts#0@@4| |st#0@@15| |env#0@@12|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|sts#0@@2| T@U) ) (!  (=> (or (|M0.__default.Compatible#canCall| |sts#0@@2|) (and (< 2 $FunctionContextHeight) ($Is SetType |sts#0@@2| (TSet Tclass.M0.State)))) (and (forall ((|st#0@@16| T@U) (|st'#0@@2| T@U) (|p#0@@3| T@U) ) (!  (=> (and (and ($IsBox |st#0@@16| Tclass.M0.State) ($IsBox |st'#0@@2| Tclass.M0.State)) ($IsBox |p#0@@3| Tclass.M0.Path)) (=> (|Set#IsMember| |sts#0@@2| |st#0@@16|) (=> (|Set#IsMember| |sts#0@@2| |st'#0@@2|) (and (|M0.__default.DomSt#canCall| |st#0@@16|) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@16|) |p#0@@3|) (and (|M0.__default.DomSt#canCall| |st'#0@@2|) (=> (|Set#IsMember| (M0.__default.DomSt |st'#0@@2|) |p#0@@3|) (and (|M0.__default.GetSt#canCall| |p#0@@3| |st#0@@16|) (|M0.__default.GetSt#canCall| |p#0@@3| |st'#0@@2|)))))))))
 :qid |CloudMakeParallelBuildsdfy.32:12|
 :skolemid |729|
 :pattern ( (M0.__default.GetSt |p#0@@3| |st'#0@@2|) (M0.__default.GetSt |p#0@@3| |st#0@@16|))
 :pattern ( (M0.__default.GetSt |p#0@@3| |st'#0@@2|) (M0.__default.DomSt |st#0@@16|))
 :pattern ( (M0.__default.GetSt |p#0@@3| |st'#0@@2|) (|Set#IsMember| |sts#0@@2| |st#0@@16|))
 :pattern ( (M0.__default.GetSt |p#0@@3| |st#0@@16|) (M0.__default.DomSt |st'#0@@2|))
 :pattern ( (M0.__default.GetSt |p#0@@3| |st#0@@16|) (|Set#IsMember| |sts#0@@2| |st'#0@@2|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@2|) |p#0@@3|) (M0.__default.DomSt |st#0@@16|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@2|) |p#0@@3|) (|Set#IsMember| |sts#0@@2| |st#0@@16|))
 :pattern ( (M0.__default.DomSt |st'#0@@2|) (|Set#IsMember| (M0.__default.DomSt |st#0@@16|) |p#0@@3|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@16|) |p#0@@3|) (|Set#IsMember| |sts#0@@2| |st'#0@@2|))
)) (= (M0.__default.Compatible |sts#0@@2|) (forall ((|st#0@@17| T@U) (|st'#0@@3| T@U) (|p#0@@4| T@U) ) (!  (=> (and (and ($IsBox |st#0@@17| Tclass.M0.State) ($IsBox |st'#0@@3| Tclass.M0.State)) ($IsBox |p#0@@4| Tclass.M0.Path)) (=> (and (and (and (|Set#IsMember| |sts#0@@2| |st#0@@17|) (|Set#IsMember| |sts#0@@2| |st'#0@@3|)) (|Set#IsMember| (M0.__default.DomSt |st#0@@17|) |p#0@@4|)) (|Set#IsMember| (M0.__default.DomSt |st'#0@@3|) |p#0@@4|)) (= (M0.__default.GetSt |p#0@@4| |st#0@@17|) (M0.__default.GetSt |p#0@@4| |st'#0@@3|))))
 :qid |CloudMakeParallelBuildsdfy.32:12|
 :skolemid |728|
 :pattern ( (M0.__default.GetSt |p#0@@4| |st'#0@@3|) (M0.__default.GetSt |p#0@@4| |st#0@@17|))
 :pattern ( (M0.__default.GetSt |p#0@@4| |st'#0@@3|) (M0.__default.DomSt |st#0@@17|))
 :pattern ( (M0.__default.GetSt |p#0@@4| |st'#0@@3|) (|Set#IsMember| |sts#0@@2| |st#0@@17|))
 :pattern ( (M0.__default.GetSt |p#0@@4| |st#0@@17|) (M0.__default.DomSt |st'#0@@3|))
 :pattern ( (M0.__default.GetSt |p#0@@4| |st#0@@17|) (|Set#IsMember| |sts#0@@2| |st'#0@@3|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@3|) |p#0@@4|) (M0.__default.DomSt |st#0@@17|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@3|) |p#0@@4|) (|Set#IsMember| |sts#0@@2| |st#0@@17|))
 :pattern ( (M0.__default.DomSt |st'#0@@3|) (|Set#IsMember| (M0.__default.DomSt |st#0@@17|) |p#0@@4|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@17|) |p#0@@4|) (|Set#IsMember| |sts#0@@2| |st'#0@@3|))
)))))
 :qid |CloudMakeParallelBuildsdfy.30:30|
 :skolemid |730|
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@12 T@U) (|expr#0@@4| T@U) (|st#0@@18| T@U) (|env#0@@14| T@U) ) (!  (=> (or (|M0.__default.eval#canCall| |expr#0@@4| |st#0@@18| |env#0@@14|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0@@4| Tclass.M0.Expression) ($IsBox |st#0@@18| Tclass.M0.State)) ($IsBox |env#0@@14| Tclass.M0.Env)) (M0.__default.ValidEnv |env#0@@14|)))) (and (and (|M0.__default.Value#canCall| |expr#0@@4|) (=> (not (M0.__default.Value |expr#0@@4|)) (and (=> (M0.Expression.exprIdentifier_q |expr#0@@4|) (|M0.__default.GetEnv#canCall| (M0.Expression.id |expr#0@@4|) |env#0@@14|)) (=> (not (M0.Expression.exprIdentifier_q |expr#0@@4|)) (and (=> (M0.Expression.exprIf_q |expr#0@@4|) (and (|M0.__default.eval#canCall| (M0.Expression.cond |expr#0@@4|) |st#0@@18| |env#0@@14|) (let ((|st'#0@@4| (M0.Tuple.snd (M0.__default.eval $ly@@12 (M0.Expression.cond |expr#0@@4|) |st#0@@18| |env#0@@14|))))
(let ((|cond'#0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@12 (M0.Expression.cond |expr#0@@4|) |st#0@@18| |env#0@@14|)))))
 (and (and (=> (M0.Expression.exprLiteral_q |cond'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#0|))) (=> (and (M0.Expression.exprLiteral_q |cond'#0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#0|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (M0.Expression.ifTrue |expr#0@@4|) |st'#0@@4| |env#0@@14|))) (=> (not (and (M0.Expression.exprLiteral_q |cond'#0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#0|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |cond'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#0|))) (=> (and (M0.Expression.exprLiteral_q |cond'#0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#0|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (M0.Expression.ifFalse |expr#0@@4|) |st'#0@@4| |env#0@@14|))))))))) (=> (not (M0.Expression.exprIf_q |expr#0@@4|)) (and (=> (M0.Expression.exprAnd_q |expr#0@@4|) (and (|M0.__default.eval#canCall| (M0.Expression.conj0 |expr#0@@4|) |st#0@@18| |env#0@@14|) (let ((|st'#1@@3| (M0.Tuple.snd (M0.__default.eval $ly@@12 (M0.Expression.conj0 |expr#0@@4|) |st#0@@18| |env#0@@14|))))
(let ((|conj0'#0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@12 (M0.Expression.conj0 |expr#0@@4|) |st#0@@18| |env#0@@14|)))))
 (and (and (=> (M0.Expression.exprLiteral_q |conj0'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#0|))) (=> (and (M0.Expression.exprLiteral_q |conj0'#0|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#0|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (M0.Expression.conj1 |expr#0@@4|) |st'#1@@3| |env#0@@14|))) (=> (not (and (M0.Expression.exprLiteral_q |conj0'#0|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#0|) |#M0.Literal.litTrue|))) (=> (M0.Expression.exprLiteral_q |conj0'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#0|))))))))) (=> (not (M0.Expression.exprAnd_q |expr#0@@4|)) (and (=> (M0.Expression.exprOr_q |expr#0@@4|) (and (|M0.__default.eval#canCall| (M0.Expression.disj0 |expr#0@@4|) |st#0@@18| |env#0@@14|) (let ((|st'#2| (M0.Tuple.snd (M0.__default.eval $ly@@12 (M0.Expression.disj0 |expr#0@@4|) |st#0@@18| |env#0@@14|))))
(let ((|disj0'#0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@12 (M0.Expression.disj0 |expr#0@@4|) |st#0@@18| |env#0@@14|)))))
 (and (=> (M0.Expression.exprLiteral_q |disj0'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#0|))) (=> (not (and (M0.Expression.exprLiteral_q |disj0'#0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#0|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |disj0'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#0|))) (=> (and (M0.Expression.exprLiteral_q |disj0'#0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#0|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (M0.Expression.disj1 |expr#0@@4|) |st'#2| |env#0@@14|))))))))) (=> (not (M0.Expression.exprOr_q |expr#0@@4|)) (=> (M0.Expression.exprInvocation_q |expr#0@@4|) (and (|M0.__default.eval#canCall| (M0.Expression.fun |expr#0@@4|) |st#0@@18| |env#0@@14|) (let ((|st'#3| (M0.Tuple.snd (M0.__default.eval $ly@@12 (M0.Expression.fun |expr#0@@4|) |st#0@@18| |env#0@@14|))))
(let ((|fun'#0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@12 (M0.Expression.fun |expr#0@@4|) |st#0@@18| |env#0@@14|)))))
 (and (|M0.__default.evalArgs#canCall| |expr#0@@4| (M0.Expression.args |expr#0@@4|) |st#0@@18| |env#0@@14|) (let ((|sts'#0| ($Unbox SetType (M0.Tuple.snd (M0.__default.evalArgs $ly@@12 |expr#0@@4| (M0.Expression.args |expr#0@@4|) |st#0@@18| |env#0@@14|)))))
(let ((|args'#0| ($Unbox SeqType (M0.Tuple.fst (M0.__default.evalArgs $ly@@12 |expr#0@@4| (M0.Expression.args |expr#0@@4|) |st#0@@18| |env#0@@14|)))))
(let ((|sts''#0| (|Set#Union| (|Set#UnionOne| |Set#Empty| |st'#3|) |sts'#0|)))
 ...
 (and (M0.Tuple.Pair_q |ps#0|) (M0.Tuple.Pair_q |ps#0|)))))))))))))))))))))))))))))) (= (M0.__default.eval ($LS $ly@@12) |expr#0@@4| |st#0@@18| |env#0@@14|) (ite (M0.__default.Value |expr#0@@4|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType |expr#0@@4|) |st#0@@18|) (ite (M0.Expression.exprIdentifier_q |expr#0@@4|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (M0.__default.GetEnv (M0.Expression.id |expr#0@@4|) |env#0@@14|)) |st#0@@18|) (ite (M0.Expression.exprIf_q |expr#0@@4|) (let ((|st'#0@@5| (M0.Tuple.snd (M0.__default.eval $ly@@12 (M0.Expression.cond |expr#0@@4|) |st#0@@18| |env#0@@14|))))
(let ((|cond'#0@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@12 (M0.Expression.cond |expr#0@@4|) |st#0@@18| |env#0@@14|)))))
...
(let ((|conj0'#0@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@12 (M0.Expression.conj0 |expr#0@@4|) |st#0@@18| |env#0@@14|)))))
...
(let ((|disj0'#0@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@12 (M0.Expression.disj0 |expr#0@@4|) |st#0@@18| |env#0@@14|)))))
(ite  (and (M0.Expression.exprLiteral_q |disj0'#0@@0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#0@@0|) |#M0.Literal.litTrue|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprLiteral| (Lit DatatypeTypeType |#M0.Literal.litTrue|)))) |st'#2@@0|) (ite  (and (M0.Expression.exprLiteral_q |disj0'#0@@0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#0@@0|) |#M0.Literal.litFalse|)) (M0.__default.eval $ly@@12 (M0.Expression.disj1 |expr#0@@4|) |st'#2@@0| |env#0@@14|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@18|))))) (ite (M0.Expression.exprInvocation_q |expr#0@@4|) (let ((|st'#3@@0| (M0.Tuple.snd (M0.__default.eval $ly@@12 (M0.Expression.fun |expr#0@@4|) |st#0@@18| |env#0@@14|))))
(let ((|fun'#0@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@12 (M0.Expression.fun |expr#0@@4|) |st#0@@18| |env#0@@14|)))))
(let ((|sts'#0@@0| ($Unbox SetType (M0.Tuple.snd (M0.__default.evalArgs $ly@@12 |expr#0@@4| (M0.Expression.args |expr#0@@4|) |st#0@@18| |env#0@@14|)))))
(let ((|args'#0@@0| ($Unbox SeqType (M0.Tuple.fst (M0.__default.evalArgs $ly@@12 |expr#0@@4| (M0.Expression.args |expr#0@@4|) |st#0@@18| |env#0@@14|)))))
(let ((|sts''#0@@0| (|Set#Union| (|Set#UnionOne| |Set#Empty| |st'#3@@0|) |sts'#0@@0|)))
(ite  (not (M0.__default.Compatible |sts''#0@@0|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rCompatibility|)))) |st#0@@18|) (let ((|stCombined#0@@0| (M0.__default.Combine ($LS $LZ) |sts''#0@@0|)))
...
(|#M0.Tuple.Pair| ($Box DatatypeTypeType (|#M0.Expression.exprLiteral| (|#M0.Literal.litArrOfPaths| ($Unbox SetType (M0.Tuple.fst |ps#0@@0|))))) (M0.Tuple.snd |ps#0@@0|))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@18|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@18|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@18|))))))))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@18|))))))))))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |974|
 :pattern ( (M0.__default.eval ($LS $ly@@12) |expr#0@@4| |st#0@@18| |env#0@@14|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|st#0@@19| T@U) ) (!  (=> (or (|M0.__default.DomSt#canCall| |st#0@@19|) (and (< 0 $FunctionContextHeight) ($IsBox |st#0@@19| Tclass.M0.State))) ($Is SetType (M0.__default.DomSt |st#0@@19|) (TSet Tclass.M0.Path)))
 :qid |CloudMakeParallelBuildsdfy.9:24|
 :skolemid |699|
 :pattern ( (M0.__default.DomSt |st#0@@19|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|cmd#0@@5| T@U) (|deps#0@@5| T@U) (|exps#0@@4| T@U) (|st#0@@20| T@U) ) (!  (=> (or (|M0.__default.Pre#canCall| |cmd#0@@5| |deps#0@@5| |exps#0@@4| |st#0@@20|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@5| (TSeq TChar)) ($Is SetType |deps#0@@5| (TSet Tclass.M0.Path))) ($Is SetType |exps#0@@4| (TSet (TSeq TChar)))) ($IsBox |st#0@@20| Tclass.M0.State)))) (and (forall ((|e#0| T@U) ) (!  (=> ($Is SeqType |e#0| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@4| ($Box SeqType |e#0|)) (and (and (|M0.__default.Loc#canCall| |cmd#0@@5| |deps#0@@5| |e#0|) (|M0.__default.DomSt#canCall| |st#0@@20|)) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@20|) (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0|)) (and (and (|M0.__default.Loc#canCall| |cmd#0@@5| |deps#0@@5| |e#0|) (|M0.__default.GetSt#canCall| (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0|) |st#0@@20|)) (and (|M0.__default.Loc#canCall| |cmd#0@@5| |deps#0@@5| |e#0|) (|M0.__default.Oracle#canCall| (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0|) |st#0@@20|)))))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |819|
 :pattern ( (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0|))
 :pattern ( (|Set#IsMember| |exps#0@@4| ($Box SeqType |e#0|)))
)) (= (M0.__default.Pre |cmd#0@@5| |deps#0@@5| |exps#0@@4| |st#0@@20|) (forall ((|e#0@@0| T@U) ) (!  (=> ($Is SeqType |e#0@@0| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@4| ($Box SeqType |e#0@@0|)) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@20|) (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0@@0|)) (= (M0.__default.GetSt (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0@@0|) |st#0@@20|) (M0.__default.Oracle (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0@@0|) |st#0@@20|)))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |818|
 ...
 :qid |CloudMakeParallelBuildsdfy.83:23|
 :skolemid |820|
 :pattern ( (M0.__default.Pre |cmd#0@@5| |deps#0@@5| |exps#0@@4| |st#0@@20|))
))))
(assert (forall (($ly@@14 T@U) (|stmts#0@@5| T@U) (|st#0@@21| T@U) (|env#0@@15| T@U) ) (! (= (M0.__default.do ($LS $ly@@14) |stmts#0@@5| |st#0@@21| |env#0@@15|) (M0.__default.do $ly@@14 |stmts#0@@5| |st#0@@21| |env#0@@15|))
 :qid |CloudMakeParallelBuildsdfy.177:18|
 :skolemid |949|
 :pattern ( (M0.__default.do ($LS $ly@@14) |stmts#0@@5| |st#0@@21| |env#0@@15|))
)))
(assert (forall (($ly@@15 T@U) (|expr#0@@5| T@U) (|st#0@@22| T@U) (|env#0@@16| T@U) ) (! (= (M0.__default.eval ($LS $ly@@15) |expr#0@@5| |st#0@@22| |env#0@@16|) (M0.__default.eval $ly@@15 |expr#0@@5| |st#0@@22| |env#0@@16|))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |969|
 :pattern ( (M0.__default.eval ($LS $ly@@15) |expr#0@@5| |st#0@@22| |env#0@@16|))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@7 T@U) ($ly@@16 T@U) (|expr#0@@6| T@U) (|st#0@@23| T@U) (|env#0@@17| T@U) ) (!  (=> (and (or (|M0.__default.eval#canCall| |expr#0@@6| |st#0@@23| |env#0@@17|) (and (< 4 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |expr#0@@6| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |expr#0@@6| Tclass.M0.Expression $Heap@@7)) (and ($IsBox |st#0@@23| Tclass.M0.State) ($IsAllocBox |st#0@@23| Tclass.M0.State $Heap@@7))) (and ($IsBox |env#0@@17| Tclass.M0.Env) ($IsAllocBox |env#0@@17| Tclass.M0.Env $Heap@@7))) (M0.__default.ValidEnv |env#0@@17|)))) ($IsGoodHeap $Heap@@7)) ($IsAlloc DatatypeTypeType (M0.__default.eval $ly@@16 |expr#0@@6| |st#0@@23| |env#0@@17|) (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State) $Heap@@7))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |972|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.__default.eval $ly@@16 |expr#0@@6| |st#0@@23| |env#0@@17|) (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State) $Heap@@7))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|prim#0@@4| T@U) (|args#0@@6| T@U) (|st#0@@24| T@U) ) (!  (=> (or (|M0.__default.ValidArgs#canCall| (Lit DatatypeTypeType |prim#0@@4|) (Lit SeqType |args#0@@6|) |st#0@@24|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |prim#0@@4| Tclass.M0.Primitive) ($Is SeqType |args#0@@6| (TSeq Tclass.M0.Expression))) ($IsBox |st#0@@24| Tclass.M0.State)) (and (=> (M0.Primitive.primExec_q (Lit DatatypeTypeType |prim#0@@4|)) (= (|Seq#Length| (Lit SeqType |args#0@@6|)) (LitInt 3))) (=> (M0.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@4|)) (= (|Seq#Length| (Lit SeqType |args#0@@6|)) (LitInt 1))))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@4|)))))) (let ((|exps#3| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@6|) (LitInt 2)))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@8 T@U) (|p#0@@5| T@U) (|st#0@@25| T@U) ) (!  (=> (and (or (|M0.__default.Oracle#canCall| |p#0@@5| |st#0@@25|) (and (< 0 $FunctionContextHeight) (and (and ($IsBox |p#0@@5| Tclass.M0.Path) ($IsAllocBox |p#0@@5| Tclass.M0.Path $Heap@@8)) (and ($IsBox |st#0@@25| Tclass.M0.State) ($IsAllocBox |st#0@@25| Tclass.M0.State $Heap@@8))))) ($IsGoodHeap $Heap@@8)) ($IsAllocBox (M0.__default.Oracle |p#0@@5| |st#0@@25|) Tclass.M0.Artifact $Heap@@8))
 :qid |CloudMakeParallelBuildsdfy.104:18|
 :skolemid |869|
 :pattern ( ($IsAllocBox (M0.__default.Oracle |p#0@@5| |st#0@@25|) Tclass.M0.Artifact $Heap@@8))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@9 T@U) (|st#0@@26| T@U) (|st'#0@@6| T@U) ) (!  (=> (and (or (|M0.__default.Union#canCall| |st#0@@26| |st'#0@@6|) (and (< 2 $FunctionContextHeight) (and (and ($IsBox |st#0@@26| Tclass.M0.State) ($IsAllocBox |st#0@@26| Tclass.M0.State $Heap@@9)) (and ($IsBox |st'#0@@6| Tclass.M0.State) ($IsAllocBox |st'#0@@6| Tclass.M0.State $Heap@@9))))) ($IsGoodHeap $Heap@@9)) ($IsAllocBox (M0.__default.Union |st#0@@26| |st'#0@@6|) Tclass.M0.State $Heap@@9))
 :qid |CloudMakeParallelBuildsdfy.23:18|
 :skolemid |722|
 :pattern ( ($IsAllocBox (M0.__default.Union |st#0@@26| |st'#0@@6|) Tclass.M0.State $Heap@@9))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@18 T@U) (|stmts#0@@6| T@U) (|st#0@@27| T@U) (|env#0@@19| T@U) ) (!  (=> (or (|M0.__default.do#canCall| (Lit SeqType |stmts#0@@6|) (Lit BoxType |st#0@@27|) (Lit BoxType |env#0@@19|)) (and (< 5 $FunctionContextHeight) (and (and (and ($Is SeqType |stmts#0@@6| (TSeq Tclass.M0.Statement)) ($IsBox |st#0@@27| Tclass.M0.State)) ($IsBox |env#0@@19| Tclass.M0.Env)) (and (M0.__default.Legal (Lit SeqType |stmts#0@@6|)) (M0.__default.ValidEnv (Lit BoxType |env#0@@19|)))))) (and (let ((|stmt#2| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |stmts#0@@6|) (LitInt 0)))))
 (and (=> (M0.Statement.stmtVariable_q |stmt#2|) (and (|M0.__default.eval#canCall| (M0.Statement.expr |stmt#2|) (Lit BoxType |st#0@@27|) (Lit BoxType |env#0@@19|)) (let ((|st'#2@@1| (M0.Tuple.snd (M0.__default.eval ($LS $LZ) (M0.Statement.expr |stmt#2|) (Lit BoxType |st#0@@27|) (Lit BoxType |env#0@@19|)))))
(let ((|expr'#2| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $LZ) (M0.Statement.expr |stmt#2|) (Lit BoxType |st#0@@27|) (Lit BoxType |env#0@@19|))))))
 ...
 (and (|M0.__default.Legal#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@6|) (LitInt 1)))) (=> (U_2_bool (Lit boolType (bool_2_U (M0.__default.Legal (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@6|) (LitInt 1))))))) (|M0.__default.do#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@6|) (LitInt 1))) |st'#2@@1| |env'#2|))))))))))) (=> (not (M0.Statement.stmtVariable_q |stmt#2|)) (|M0.__default.eval#canCall| (M0.Statement.ret |stmt#2|) (Lit BoxType |st#0@@27|) (Lit BoxType |env#0@@19|))))) (= (M0.__default.do ($LS $ly@@18) (Lit SeqType |stmts#0@@6|) (Lit BoxType |st#0@@27|) (Lit BoxType |env#0@@19|)) (let ((|stmt#2@@0| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |stmts#0@@6|) (LitInt 0)))))
(ite (M0.Statement.stmtVariable_q |stmt#2@@0|) (let ((|st'#2@@2| (M0.Tuple.snd (M0.__default.eval ($LS $LZ) (M0.Statement.expr |stmt#2@@0|) (Lit BoxType |st#0@@27|) (Lit BoxType |env#0@@19|)))))
(let ((|expr'#2@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $LZ) (M0.Statement.expr |stmt#2@@0|) (Lit BoxType |st#0@@27|) (Lit BoxType |env#0@@19|))))))
(ite (M0.__default.Value |expr'#2@@0|) (let ((|env'#2@@0| (M0.__default.SetEnv (M0.Statement.id |stmt#2@@0|) |expr'#2@@0| (Lit BoxType |env#0@@19|))))
(ite (M0.__default.Legal (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@6|) (LitInt 1)))) (M0.__default.do ($LS $ly@@18) (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@6|) (LitInt 1))) |st'#2@@2| |env'#2@@0|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType |expr'#2@@0|) |st'#2@@2|))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) (Lit BoxType |st#0@@27|))))) (M0.__default.eval ($LS $LZ) (M0.Statement.ret |stmt#2@@0|) (Lit BoxType |st#0@@27|) (Lit BoxType |env#0@@19|)))))))
 :qid |CloudMakeParallelBuildsdfy.177:18|
 :weight 3
 :skolemid |956|
 :pattern ( (M0.__default.do ($LS $ly@@18) (Lit SeqType |stmts#0@@6|) (Lit BoxType |st#0@@27|) (Lit BoxType |env#0@@19|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@20 T@U) (|expr#0@@8| T@U) (|st#0@@28| T@U) (|env#0@@20| T@U) ) (!  (=> (or (|M0.__default.eval#canCall| (Lit DatatypeTypeType |expr#0@@8|) |st#0@@28| |env#0@@20|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0@@8| Tclass.M0.Expression) ($IsBox |st#0@@28| Tclass.M0.State)) ($IsBox |env#0@@20| Tclass.M0.Env)) (M0.__default.ValidEnv |env#0@@20|)))) (and (and (|M0.__default.Value#canCall| (Lit DatatypeTypeType |expr#0@@8|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.__default.Value (Lit DatatypeTypeType |expr#0@@8|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@8|))))) (|M0.__default.GetEnv#canCall| (Lit BoxType (M0.Expression.id (Lit DatatypeTypeType |expr#0@@8|))) |env#0@@20|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@8|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@8|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@28| |env#0@@20|) (let ((|st'#4| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@28| |env#0@@20|))))
(let ((|cond'#1| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@28| |env#0@@20|)))))
 (and (and (=> (M0.Expression.exprLiteral_q |cond'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#1|))) (=> (and (M0.Expression.exprLiteral_q |cond'#1|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#1|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.ifTrue (Lit DatatypeTypeType |expr#0@@8|))) |st'#4| |env#0@@20|))) (=> (not (and (M0.Expression.exprLiteral_q |cond'#1|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#1|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |cond'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#1|))) (=> (and (M0.Expression.exprLiteral_q |cond'#1|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#1|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.ifFalse (Lit DatatypeTypeType |expr#0@@8|))) |st'#4| |env#0@@20|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@8|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@8|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@28| |env#0@@20|) (let ((|st'#5| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@28| |env#0@@20|))))
(let ((|conj0'#1| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@28| |env#0@@20|)))))
 (and (and (=> (M0.Expression.exprLiteral_q |conj0'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#1|))) (=> (and (M0.Expression.exprLiteral_q |conj0'#1|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#1|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.conj1 (Lit DatatypeTypeType |expr#0@@8|))) |st'#5| |env#0@@20|))) (=> (not (and (M0.Expression.exprLiteral_q |conj0'#1|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#1|) |#M0.Literal.litTrue|))) (=> (M0.Expression.exprLiteral_q |conj0'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#1|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@8|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@8|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@28| |env#0@@20|) (let ((|st'#6| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@28| |env#0@@20|))))
(let ((|disj0'#1| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@28| |env#0@@20|)))))
 (and (=> (M0.Expression.exprLiteral_q |disj0'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#1|))) (=> (not (and (M0.Expression.exprLiteral_q |disj0'#1|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#1|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |disj0'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#1|))) (=> (and (M0.Expression.exprLiteral_q |disj0'#1|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#1|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.disj1 (Lit DatatypeTypeType |expr#0@@8|))) |st'#6| |env#0@@20|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@8|)))))) (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0@@8|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@28| |env#0@@20|) (let ((|st'#7| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@28| |env#0@@20|))))
(let ((|fun'#1| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@28| |env#0@@20|)))))
 (and (|M0.__default.evalArgs#canCall| (Lit DatatypeTypeType |expr#0@@8|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@28| |env#0@@20|) (let ((|sts'#1| ($Unbox SetType (M0.Tuple.snd (M0.__default.evalArgs ($LS $ly@@20) (Lit DatatypeTypeType |expr#0@@8|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@28| |env#0@@20|)))))
(let ((|args'#1| ($Unbox SeqType (M0.Tuple.fst (M0.__default.evalArgs ($LS $ly@@20) (Lit DatatypeTypeType |expr#0@@8|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@28| |env#0@@20|)))))
(let ((|sts''#1| (|Set#Union| (|Set#UnionOne| |Set#Empty| |st'#7|) |sts'#1|)))
 ...
 (and (M0.Tuple.Pair_q |ps#1|) (M0.Tuple.Pair_q |ps#1|)))))))))))))))))))))))))))))) (= (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType |expr#0@@8|) |st#0@@28| |env#0@@20|) (ite (M0.__default.Value (Lit DatatypeTypeType |expr#0@@8|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType |expr#0@@8|)) |st#0@@28|) (ite (M0.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@8|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (M0.__default.GetEnv (Lit BoxType (M0.Expression.id (Lit DatatypeTypeType |expr#0@@8|))) |env#0@@20|)) |st#0@@28|) (ite (M0.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@8|)) (let ((|st'#4@@0| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@28| |env#0@@20|))))
(let ((|cond'#1@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@28| |env#0@@20|)))))
...
(let ((|conj0'#1@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@28| |env#0@@20|)))))
...
(let ((|disj0'#1@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@28| |env#0@@20|)))))
(ite  (and (M0.Expression.exprLiteral_q |disj0'#1@@0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#1@@0|) |#M0.Literal.litTrue|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprLiteral| (Lit DatatypeTypeType |#M0.Literal.litTrue|)))) |st'#6@@0|) (ite  (and (M0.Expression.exprLiteral_q |disj0'#1@@0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#1@@0|) |#M0.Literal.litFalse|)) (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.disj1 (Lit DatatypeTypeType |expr#0@@8|))) |st'#6@@0| |env#0@@20|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@28|))))) (ite (M0.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0@@8|)) (let ((|st'#7@@0| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@28| |env#0@@20|))))
(let ((|fun'#1@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@28| |env#0@@20|)))))
(let ((|sts'#1@@0| ($Unbox SetType (M0.Tuple.snd (M0.__default.evalArgs ($LS $ly@@20) (Lit DatatypeTypeType |expr#0@@8|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@28| |env#0@@20|)))))
(let ((|args'#1@@0| ($Unbox SeqType (M0.Tuple.fst (M0.__default.evalArgs ($LS $ly@@20) (Lit DatatypeTypeType |expr#0@@8|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@28| |env#0@@20|)))))
...
(|#M0.Tuple.Pair| ($Box DatatypeTypeType (|#M0.Expression.exprLiteral| (|#M0.Literal.litArrOfPaths| ($Unbox SetType (M0.Tuple.fst |ps#1@@0|))))) (M0.Tuple.snd |ps#1@@0|))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@28|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@28|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@28|))))))))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@28|))))))))))
 ...
 :weight 3
 :skolemid |975|
 :pattern ( (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType |expr#0@@8|) |st#0@@28| |env#0@@20|))
))))
...
(declare-fun |##stmts#2@0| () T@U)
(declare-fun $Heap@@11 () T@U)
(declare-fun |st'#Z#0@0| () T@U)
(declare-fun |env'#Z#0@0| () T@U)
(declare-fun |expr'#Z#0@0| () T@U)
(declare-fun |stmt#Z#0@0| () T@U)
...
(set-info :boogie-vc-id CheckWellformed$$M0.__default.do)
...
(let ((anon14_Then_correct  (=> (M0.__default.Legal (|Seq#Drop| |stmts#0@@7| (LitInt 1))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |stmts#0@@7|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |stmts#0@@7|))) (=> (and (and (= |##stmts#2@0| (|Seq#Drop| |stmts#0@@7| (LitInt 1))) ($IsAlloc SeqType |##stmts#2@0| (TSeq Tclass.M0.Statement) $Heap@@11)) (and ($IsAllocBox |st'#Z#0@0| Tclass.M0.State $Heap@@11) ($IsAllocBox |env'#Z#0@0| Tclass.M0.Env $Heap@@11))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (=> (|M0.__default.Legal#canCall| |##stmts#2@0|) (or (M0.__default.Legal |##stmts#2@0|) (or (not (= (|Seq#Length| |##stmts#2@0|) 0)) (not true))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (M0.__default.ValidEnv |env'#Z#0@0|)) (=> (and (and (M0.__default.Legal |##stmts#2@0|) (M0.__default.ValidEnv |env'#Z#0@0|)) (= (ControlFlow 0 7) (- 0 6))) (< (|Seq#Rank| |##stmts#2@0|) (|Seq#Rank| |stmts#0@@7|)))))))))))
(let ((anon13_Then_correct  (=> (M0.__default.Value |expr'#Z#0@0|) (and (=> (= (ControlFlow 0 12) (- 0 16)) (M0.Statement.stmtVariable_q |stmt#Z#0@0|)) (=> (M0.Statement.stmtVariable_q |stmt#Z#0@0|) (=> (and (and (= |##id#0@0| (M0.Statement.id |stmt#Z#0@0|)) ($IsAllocBox |##id#0@0| Tclass.M0.Identifier $Heap@@11)) (and ($IsAlloc DatatypeTypeType |expr'#Z#0@0| Tclass.M0.Expression $Heap@@11) ($IsAllocBox |env#0@@21| Tclass.M0.Env $Heap@@11))) (and (=> (= (ControlFlow 0 12) (- 0 15)) (M0.__default.ValidEnv |env#0@@21|)) (and (=> (= (ControlFlow 0 12) (- 0 14)) (=> (|M0.__default.Value#canCall| |expr'#Z#0@0|) (or (M0.__default.Value |expr'#Z#0@0|) (M0.Expression.exprLiteral_q |expr'#Z#0@0|)))) (=> (and (and (and (M0.__default.ValidEnv |env#0@@21|) (M0.__default.Value |expr'#Z#0@0|)) (|M0.__default.SetEnv#canCall| (M0.Statement.id |stmt#Z#0@0|) |expr'#Z#0@0| |env#0@@21|)) (and (and (= |let#2#0#0| (M0.__default.SetEnv (M0.Statement.id |stmt#Z#0@0|) |expr'#Z#0@0| |env#0@@21|)) (|M0.__default.SetEnv#canCall| (M0.Statement.id |stmt#Z#0@0|) |expr'#Z#0@0| |env#0@@21|)) (and ($IsBox |let#2#0#0| Tclass.M0.Env) (= |env'#Z#0@0| |let#2#0#0|)))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |stmts#0@@7|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |stmts#0@@7|))) (=> (= |##stmts#1@0| (|Seq#Drop| |stmts#0@@7| (LitInt 1))) (=> (and ($IsAlloc SeqType |##stmts#1@0| (TSeq Tclass.M0.Statement) $Heap@@11) (|M0.__default.Legal#canCall| (|Seq#Drop| |stmts#0@@7| (LitInt 1)))) (and (=> (= (ControlFlow 0 12) 7) anon14_Then_correct) (=> (= (ControlFlow 0 12) 11) anon14_Else_correct)))))))))))))))
(let ((anon13_Else_correct true))
(let ((anon12_Then_correct  (=> (M0.Statement.stmtVariable_q |stmt#Z#0@0|) (and (=> (= (ControlFlow 0 17) (- 0 19)) (M0.Statement.stmtVariable_q |stmt#Z#0@0|)) (=> (M0.Statement.stmtVariable_q |stmt#Z#0@0|) (=> (and (and (= |##expr#0@0| (M0.Statement.expr |stmt#Z#0@0|)) ($IsAlloc DatatypeTypeType |##expr#0@0| Tclass.M0.Expression $Heap@@11)) (and ($IsAllocBox |st#0@@29| Tclass.M0.State $Heap@@11) ($IsAllocBox |env#0@@21| Tclass.M0.Env $Heap@@11))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (M0.__default.ValidEnv |env#0@@21|)) (=> (and (M0.__default.ValidEnv |env#0@@21|) (|M0.__default.eval#canCall| (M0.Statement.expr |stmt#Z#0@0|) |st#0@@29| |env#0@@21|)) (=> (and (and (and (M0.Tuple.Pair_q (M0.__default.eval ($LS $LZ) (M0.Statement.expr |stmt#Z#0@0|) |st#0@@29| |env#0@@21|)) (= |let#1#0#0| (M0.__default.eval ($LS $LZ) (M0.Statement.expr |stmt#Z#0@0|) |st#0@@29| |env#0@@21|))) (and (|M0.__default.eval#canCall| (M0.Statement.expr |stmt#Z#0@0|) |st#0@@29| |env#0@@21|) ($Is DatatypeTypeType |let#1#0#0| (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State)))) (and (and (M0.Tuple.Pair_q |let#1#0#0|) (= (|#M0.Tuple.Pair| ($Box DatatypeTypeType |expr'#Z#0@0|) |st'#Z#0@0|) |let#1#0#0|)) (and ($IsAlloc DatatypeTypeType |expr'#Z#0@0| Tclass.M0.Expression $Heap@@11) (|M0.__default.Value#canCall| |expr'#Z#0@0|)))) (and (=> (= (ControlFlow 0 17) 12) anon13_Then_correct) (=> (= (ControlFlow 0 17) 5) anon13_Else_correct)))))))))))
(let ((anon12_Else_correct  (=> (not (M0.Statement.stmtVariable_q |stmt#Z#0@0|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (M0.Statement.stmtReturn_q |stmt#Z#0@0|)) (=> (M0.Statement.stmtReturn_q |stmt#Z#0@0|) (=> (= |##expr#3@0| (M0.Statement.ret |stmt#Z#0@0|)) (=> (and (and ($IsAlloc DatatypeTypeType |##expr#3@0| Tclass.M0.Expression $Heap@@11) ($IsAllocBox |st#0@@29| Tclass.M0.State $Heap@@11)) (and ($IsAllocBox |env#0@@21| Tclass.M0.Env $Heap@@11) (= (ControlFlow 0 3) (- 0 2)))) (M0.__default.ValidEnv |env#0@@21|))))))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |stmts#0@@7|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |stmts#0@@7|))) (=> (= |let#0#0#0| ($Unbox DatatypeTypeType (|Seq#Index| |stmts#0@@7| (LitInt 0)))) (=> (and ($Is DatatypeTypeType |let#0#0#0| Tclass.M0.Statement) (= |stmt#Z#0@0| |let#0#0#0|)) (and (=> (= (ControlFlow 0 20) 17) anon12_Then_correct) (=> (= (ControlFlow 0 20) 3) anon12_Else_correct))))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@11 alloc false)) (=> (and ($IsAlloc SeqType |stmts#0@@7| (TSeq Tclass.M0.Statement) $Heap@@11) (|M0.__default.Legal#canCall| |stmts#0@@7|)) (=> (and (and (M0.__default.Legal |stmts#0@@7|) ($IsAllocBox |env#0@@21| Tclass.M0.Env $Heap@@11)) (and (|M0.__default.ValidEnv#canCall| |env#0@@21|) (M0.__default.ValidEnv |env#0@@21|))) (and (=> (= (ControlFlow 0 22) 1) anon11_Then_correct) (=> (= (ControlFlow 0 22) 20) anon11_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@11) ($IsHeapAnchor $Heap@@11)) ($Is SeqType |stmts#0@@7| (TSeq Tclass.M0.Statement))) (and (and ($IsBox |st#0@@29| Tclass.M0.State) ($IsBox |env#0@@21| Tclass.M0.Env)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 23) 22)))) anon0_correct)))
