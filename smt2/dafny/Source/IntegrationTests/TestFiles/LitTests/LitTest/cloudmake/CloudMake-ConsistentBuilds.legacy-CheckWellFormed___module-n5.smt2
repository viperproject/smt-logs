...
(assert (forall ((d@@1 T@U) ) (!  (=> (|$IsA#_module.Expression| d@@1) (or (or (or (or (or (or (_module.Expression.exprLiteral_q d@@1) (_module.Expression.exprIdentifier_q d@@1)) (_module.Expression.exprIf_q d@@1)) (_module.Expression.exprAnd_q d@@1)) (_module.Expression.exprOr_q d@@1)) (_module.Expression.exprInvocation_q d@@1)) (_module.Expression.exprError_q d@@1)))
 :qid |unknown.0:0|
 :skolemid |1406|
 :pattern ( (|$IsA#_module.Expression| d@@1))
)))
...
(assert (forall ((d@@27 T@U) ) (!  (=> (_module.Literal.litTrue_q d@@27) (= d@@27 |#_module.Literal.litTrue|))
 :qid |unknown.0:0|
 :skolemid |1417|
 :pattern ( (_module.Literal.litTrue_q d@@27))
)))
(assert (forall ((d@@28 T@U) ) (!  (=> (_module.Literal.litFalse_q d@@28) (= d@@28 |#_module.Literal.litFalse|))
 :qid |unknown.0:0|
 :skolemid |1419|
 :pattern ( (_module.Literal.litFalse_q d@@28))
)))
(assert (forall ((d@@29 T@U) ) (!  (=> (_module.Literal.litUndefined_q d@@29) (= d@@29 |#_module.Literal.litUndefined|))
 :qid |unknown.0:0|
 :skolemid |1421|
 :pattern ( (_module.Literal.litUndefined_q d@@29))
)))
(assert (forall ((d@@30 T@U) ) (!  (=> (_module.Literal.litNull_q d@@30) (= d@@30 |#_module.Literal.litNull|))
 :qid |unknown.0:0|
 :skolemid |1423|
 :pattern ( (_module.Literal.litNull_q d@@30))
)))
...
(assert (forall ((d@@31 T@U) ) (!  (=> (_module.Expression.exprLiteral_q d@@31) (exists ((|a#27#0#0| T@U) ) (! (= d@@31 (|#_module.Expression.exprLiteral| |a#27#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.319:35|
 :skolemid |1327|
)))
 :qid |unknown.0:0|
 :skolemid |1328|
 :pattern ( (_module.Expression.exprLiteral_q d@@31))
)))
(assert (forall ((d@@32 T@U) ) (!  (=> (_module.Expression.exprIdentifier_q d@@32) (exists ((|a#33#0#0| T@U) ) (! (= d@@32 (|#_module.Expression.exprIdentifier| |a#33#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.319:66|
 :skolemid |1337|
)))
 :qid |unknown.0:0|
 :skolemid |1338|
 :pattern ( (_module.Expression.exprIdentifier_q d@@32))
)))
(assert (forall ((d@@33 T@U) ) (!  (=> (_module.Expression.exprError_q d@@33) (exists ((|a#73#0#0| T@U) ) (! (= d@@33 (|#_module.Expression.exprError| |a#73#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.324:33|
 :skolemid |1397|
)))
 :qid |unknown.0:0|
 :skolemid |1398|
 :pattern ( (_module.Expression.exprError_q d@@33))
)))
(assert (forall ((d@@34 T@U) ) (!  (=> (_module.Literal.litNumber_q d@@34) (exists ((|a#95#0#0| Int) ) (! (= d@@34 (|#_module.Literal.litNumber| |a#95#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.327:30|
 :skolemid |1426|
)))
 :qid |unknown.0:0|
 :skolemid |1427|
 :pattern ( (_module.Literal.litNumber_q d@@34))
)))
(assert (forall ((d@@35 T@U) ) (!  (=> (_module.Literal.litString_q d@@35) (exists ((|a#100#0#0| T@U) ) (! (= d@@35 (|#_module.Literal.litString| |a#100#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.327:52|
 :skolemid |1434|
)))
 :qid |unknown.0:0|
 :skolemid |1435|
 :pattern ( (_module.Literal.litString_q d@@35))
)))
(assert (forall ((d@@36 T@U) ) (!  (=> (_module.Literal.litPrimitive_q d@@36) (exists ((|a#107#0#0| T@U) ) (! (= d@@36 (|#_module.Literal.litPrimitive| |a#107#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.328:33|
 :skolemid |1444|
)))
 :qid |unknown.0:0|
 :skolemid |1445|
 :pattern ( (_module.Literal.litPrimitive_q d@@36))
)))
(assert (forall ((d@@37 T@U) ) (!  (=> (_module.Literal.litArrOfPaths_q d@@37) (exists ((|a#113#0#0| T@U) ) (! (= d@@37 (|#_module.Literal.litArrOfPaths| |a#113#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.329:34|
 :skolemid |1453|
)))
 :qid |unknown.0:0|
 :skolemid |1454|
 :pattern ( (_module.Literal.litArrOfPaths_q d@@37))
)))
(assert (forall ((d@@38 T@U) ) (!  (=> (_module.Literal.litArrOfStrings_q d@@38) (exists ((|a#119#0#0| T@U) ) (! (= d@@38 (|#_module.Literal.litArrOfStrings| |a#119#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.330:36|
 :skolemid |1462|
)))
 :qid |unknown.0:0|
 :skolemid |1463|
 :pattern ( (_module.Literal.litArrOfStrings_q d@@38))
)))
(assert (forall ((d@@39 T@U) ) (!  (=> (_module.Literal.litArray_q d@@39) (exists ((|a#125#0#0| T@U) ) (! (= d@@39 (|#_module.Literal.litArray| |a#125#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.331:29|
 :skolemid |1471|
)))
 :qid |unknown.0:0|
 :skolemid |1472|
 :pattern ( (_module.Literal.litArray_q d@@39))
)))
(assert (forall ((d@@40 T@U) ) (!  (=> ($Is DatatypeTypeType d@@40 Tclass._module.Expression) (or (or (or (or (or (or (_module.Expression.exprLiteral_q d@@40) (_module.Expression.exprIdentifier_q d@@40)) (_module.Expression.exprIf_q d@@40)) (_module.Expression.exprAnd_q d@@40)) (_module.Expression.exprOr_q d@@40)) (_module.Expression.exprInvocation_q d@@40)) (_module.Expression.exprError_q d@@40)))
 :qid |unknown.0:0|
 :skolemid |1407|
 :pattern ( (_module.Expression.exprError_q d@@40) ($Is DatatypeTypeType d@@40 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprInvocation_q d@@40) ($Is DatatypeTypeType d@@40 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprOr_q d@@40) ($Is DatatypeTypeType d@@40 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprAnd_q d@@40) ($Is DatatypeTypeType d@@40 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprIf_q d@@40) ($Is DatatypeTypeType d@@40 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprIdentifier_q d@@40) ($Is DatatypeTypeType d@@40 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprLiteral_q d@@40) ($Is DatatypeTypeType d@@40 Tclass._module.Expression))
)))
...
(assert (forall ((d@@41 T@U) ) (!  (=> ($Is DatatypeTypeType d@@41 Tclass._module.Literal) (or (or (or (or (or (or (or (or (or (_module.Literal.litTrue_q d@@41) (_module.Literal.litFalse_q d@@41)) (_module.Literal.litUndefined_q d@@41)) (_module.Literal.litNull_q d@@41)) (_module.Literal.litNumber_q d@@41)) (_module.Literal.litString_q d@@41)) (_module.Literal.litPrimitive_q d@@41)) (_module.Literal.litArrOfPaths_q d@@41)) (_module.Literal.litArrOfStrings_q d@@41)) (_module.Literal.litArray_q d@@41)))
 :qid |unknown.0:0|
 :skolemid |1481|
 :pattern ( (_module.Literal.litArray_q d@@41) ($Is DatatypeTypeType d@@41 Tclass._module.Literal))
 :pattern ( (_module.Literal.litArrOfStrings_q d@@41) ($Is DatatypeTypeType d@@41 Tclass._module.Literal))
 :pattern ( (_module.Literal.litArrOfPaths_q d@@41) ($Is DatatypeTypeType d@@41 Tclass._module.Literal))
 :pattern ( (_module.Literal.litPrimitive_q d@@41) ($Is DatatypeTypeType d@@41 Tclass._module.Literal))
 :pattern ( (_module.Literal.litString_q d@@41) ($Is DatatypeTypeType d@@41 Tclass._module.Literal))
 :pattern ( (_module.Literal.litNumber_q d@@41) ($Is DatatypeTypeType d@@41 Tclass._module.Literal))
 :pattern ( (_module.Literal.litNull_q d@@41) ($Is DatatypeTypeType d@@41 Tclass._module.Literal))
 :pattern ( (_module.Literal.litUndefined_q d@@41) ($Is DatatypeTypeType d@@41 Tclass._module.Literal))
 :pattern ( (_module.Literal.litFalse_q d@@41) ($Is DatatypeTypeType d@@41 Tclass._module.Literal))
 :pattern ( (_module.Literal.litTrue_q d@@41) ($Is DatatypeTypeType d@@41 Tclass._module.Literal))
)))
...
(assert (forall ((_module.Triple$A@@5 T@U) (_module.Triple$B@@5 T@U) (_module.Triple$C@@5 T@U) (d@@42 T@U) ) (!  (=> ($Is DatatypeTypeType d@@42 (Tclass._module.Triple _module.Triple$A@@5 _module.Triple$B@@5 _module.Triple$C@@5)) (_module.Triple.Trio_q d@@42))
 :qid |unknown.0:0|
 :skolemid |1577|
 :pattern ( (_module.Triple.Trio_q d@@42) ($Is DatatypeTypeType d@@42 (Tclass._module.Triple _module.Triple$A@@5 _module.Triple$B@@5 _module.Triple$C@@5)))
)))
...
(assert (forall ((d@@43 T@U) ($h@@0 T@U) ) (!  (=> (and ($IsGoodHeap $h@@0) (and (_module.Literal.litNumber_q d@@43) ($IsAlloc DatatypeTypeType d@@43 Tclass._module.Literal $h@@0))) ($IsAlloc intType (int_2_U (_module.Literal.num d@@43)) TInt $h@@0))
 :qid |unknown.0:0|
 :skolemid |1429|
 :pattern ( ($IsAlloc intType (int_2_U (_module.Literal.num d@@43)) TInt $h@@0))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|stC#0@@4| T@U) ) (!  (=> (or (|_module.__default.ConsistentCache#canCall| (Lit DatatypeTypeType |stC#0@@4|)) (and (< 3 $FunctionContextHeight) ($Is DatatypeTypeType |stC#0@@4| Tclass._module.StateC))) (and (forall ((|cmd#1| T@U) (|deps#1| T@U) (|e#1@@1| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#1| Tclass._module.Expression) ($Is DatatypeTypeType |deps#1| Tclass._module.Expression)) ($Is SeqType |e#1@@1| (TSeq TChar))) (and (and (and (|_module.__default.Loc#canCall| |cmd#1| |deps#1| |e#1@@1|) (|_module.__default.Hash#canCall| (_module.__default.Loc |cmd#1| |deps#1| |e#1@@1|))) (and (_module.StateC.S_q (Lit DatatypeTypeType |stC#0@@4|)) (|_module.__default.DomC#canCall| (Lit BoxType (_module.StateC.c (Lit DatatypeTypeType |stC#0@@4|)))))) (=> (|Set#IsMember| (_module.__default.DomC (Lit BoxType (_module.StateC.c (Lit DatatypeTypeType |stC#0@@4|)))) (_module.__default.Hash (_module.__default.Loc |cmd#1| |deps#1| |e#1@@1|))) (and (|_module.__default.Loc#canCall| |cmd#1| |deps#1| |e#1@@1|) (and (_module.StateC.S_q (Lit DatatypeTypeType |stC#0@@4|)) (|_module.__default.DomSt#canCall| (Lit BoxType (_module.StateC.st (Lit DatatypeTypeType |stC#0@@4|)))))))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |877|
 :pattern ( (_module.__default.Loc |cmd#1| |deps#1| |e#1@@1|))
)) (= (_module.__default.ConsistentCache (Lit DatatypeTypeType |stC#0@@4|)) (forall ((|cmd#1@@0| T@U) (|deps#1@@0| T@U) (|e#1@@2| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#1@@0| Tclass._module.Expression) ($Is DatatypeTypeType |deps#1@@0| Tclass._module.Expression)) ($Is SeqType |e#1@@2| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (Lit BoxType (_module.StateC.c (Lit DatatypeTypeType |stC#0@@4|)))) (_module.__default.Hash (_module.__default.Loc |cmd#1@@0| |deps#1@@0| |e#1@@2|))) (|Set#IsMember| (_module.__default.DomSt (Lit BoxType (_module.StateC.st (Lit DatatypeTypeType |stC#0@@4|)))) ($Box DatatypeTypeType (_module.__default.Loc |cmd#1@@0| |deps#1@@0| |e#1@@2|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |876|
 :pattern ( (_module.__default.Loc |cmd#1@@0| |deps#1@@0| |e#1@@2|))
)))))
 :qid |CloudMakeConsistentBuildslegacydfy.149:33|
 :weight 3
 :skolemid |878|
 :pattern ( (_module.__default.ConsistentCache (Lit DatatypeTypeType |stC#0@@4|)))
))))
...
(assert (forall ((d@@45 T@U) (_module.Triple$A@@7 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.Triple.Trio_q d@@45) (exists ((_module.Triple$B@@7 T@U) (_module.Triple$C@@7 T@U) ) (! ($IsAlloc DatatypeTypeType d@@45 (Tclass._module.Triple _module.Triple$A@@7 _module.Triple$B@@7 _module.Triple$C@@7) $h@@1)
 :qid |unknown.0:0|
 :skolemid |1563|
 :pattern ( ($IsAlloc DatatypeTypeType d@@45 (Tclass._module.Triple _module.Triple$A@@7 _module.Triple$B@@7 _module.Triple$C@@7) $h@@1))
)))) ($IsAllocBox (_module.Triple.fst d@@45) _module.Triple$A@@7 $h@@1))
 :qid |unknown.0:0|
 :skolemid |1564|
 :pattern ( ($IsAllocBox (_module.Triple.fst d@@45) _module.Triple$A@@7 $h@@1))
)))
(assert (forall ((d@@46 T@U) (_module.Triple$B@@8 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (_module.Triple.Trio_q d@@46) (exists ((_module.Triple$A@@8 T@U) (_module.Triple$C@@8 T@U) ) (! ($IsAlloc DatatypeTypeType d@@46 (Tclass._module.Triple _module.Triple$A@@8 _module.Triple$B@@8 _module.Triple$C@@8) $h@@2)
 :qid |unknown.0:0|
 :skolemid |1565|
 :pattern ( ($IsAlloc DatatypeTypeType d@@46 (Tclass._module.Triple _module.Triple$A@@8 _module.Triple$B@@8 _module.Triple$C@@8) $h@@2))
)))) ($IsAllocBox (_module.Triple.snd d@@46) _module.Triple$B@@8 $h@@2))
 :qid |unknown.0:0|
 :skolemid |1566|
 :pattern ( ($IsAllocBox (_module.Triple.snd d@@46) _module.Triple$B@@8 $h@@2))
)))
(assert (forall ((d@@47 T@U) (_module.Triple$C@@9 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (_module.Triple.Trio_q d@@47) (exists ((_module.Triple$A@@9 T@U) (_module.Triple$B@@9 T@U) ) (! ($IsAlloc DatatypeTypeType d@@47 (Tclass._module.Triple _module.Triple$A@@9 _module.Triple$B@@9 _module.Triple$C@@9) $h@@3)
 :qid |unknown.0:0|
 :skolemid |1567|
 :pattern ( ($IsAlloc DatatypeTypeType d@@47 (Tclass._module.Triple _module.Triple$A@@9 _module.Triple$B@@9 _module.Triple$C@@9) $h@@3))
)))) ($IsAllocBox (_module.Triple.trd d@@47) _module.Triple$C@@9 $h@@3))
 :qid |unknown.0:0|
 :skolemid |1568|
 :pattern ( ($IsAllocBox (_module.Triple.trd d@@47) _module.Triple$C@@9 $h@@3))
)))
(assert (forall ((d@@48 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) ($Is DatatypeTypeType d@@48 Tclass._module.StateC)) ($IsAlloc DatatypeTypeType d@@48 Tclass._module.StateC $h@@4))
 :qid |unknown.0:0|
 :skolemid |1279|
 :pattern ( ($IsAlloc DatatypeTypeType d@@48 Tclass._module.StateC $h@@4))
)))
(assert (forall ((d@@49 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) ($Is DatatypeTypeType d@@49 Tclass._module.Expression)) ($IsAlloc DatatypeTypeType d@@49 Tclass._module.Expression $h@@5))
 :qid |unknown.0:0|
 :skolemid |1405|
 :pattern ( ($IsAlloc DatatypeTypeType d@@49 Tclass._module.Expression $h@@5))
)))
(assert (forall ((d@@50 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) ($Is DatatypeTypeType d@@50 Tclass._module.Literal)) ($IsAlloc DatatypeTypeType d@@50 Tclass._module.Literal $h@@6))
 :qid |unknown.0:0|
 :skolemid |1479|
 :pattern ( ($IsAlloc DatatypeTypeType d@@50 Tclass._module.Literal $h@@6))
)))
(assert (forall ((d@@51 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) ($Is DatatypeTypeType d@@51 Tclass._module.Primitive)) ($IsAlloc DatatypeTypeType d@@51 Tclass._module.Primitive $h@@7))
 :qid |unknown.0:0|
 :skolemid |1497|
 :pattern ( ($IsAlloc DatatypeTypeType d@@51 Tclass._module.Primitive $h@@7))
)))
(assert (forall ((d@@52 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) ($Is DatatypeTypeType d@@52 Tclass._module.Reason)) ($IsAlloc DatatypeTypeType d@@52 Tclass._module.Reason $h@@8))
 :qid |unknown.0:0|
 :skolemid |1509|
 :pattern ( ($IsAlloc DatatypeTypeType d@@52 Tclass._module.Reason $h@@8))
)))
(assert (forall ((d@@53 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) ($Is DatatypeTypeType d@@53 Tclass._module.Path)) ($IsAlloc DatatypeTypeType d@@53 Tclass._module.Path $h@@9))
 :qid |unknown.0:0|
 :skolemid |1532|
 :pattern ( ($IsAlloc DatatypeTypeType d@@53 Tclass._module.Path $h@@9))
)))
...
(assert (forall ((d@@54 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) (and (_module.Literal.litString_q d@@54) ($IsAlloc DatatypeTypeType d@@54 Tclass._module.Literal $h@@10))) ($IsAlloc SeqType (_module.Literal.str d@@54) (TSeq TChar) $h@@10))
 :qid |unknown.0:0|
 :skolemid |1437|
 :pattern ( ($IsAlloc SeqType (_module.Literal.str d@@54) (TSeq TChar) $h@@10))
)))
(assert (forall ((|a#117#0#0| T@U) (d@@55 T@U) ) (!  (=> (|Set#IsMember| |a#117#0#0| ($Box DatatypeTypeType d@@55)) (< (DtRank d@@55) (DtRank (|#_module.Literal.litArrOfPaths| |a#117#0#0|))))
 :qid |CloudMakeConsistentBuildslegacydfy.329:34|
 :skolemid |1459|
 :pattern ( (|Set#IsMember| |a#117#0#0| ($Box DatatypeTypeType d@@55)) (|#_module.Literal.litArrOfPaths| |a#117#0#0|))
)))
(assert (forall ((|a#123#0#0| T@U) (d@@56 T@U) ) (!  (=> (|Set#IsMember| |a#123#0#0| ($Box DatatypeTypeType d@@56)) (< (DtRank d@@56) (DtRank (|#_module.Literal.litArrOfStrings| |a#123#0#0|))))
 :qid |CloudMakeConsistentBuildslegacydfy.330:36|
 :skolemid |1468|
 :pattern ( (|Set#IsMember| |a#123#0#0| ($Box DatatypeTypeType d@@56)) (|#_module.Literal.litArrOfStrings| |a#123#0#0|))
)))
...
(assert (forall ((d@@57 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (_module.StateC.S_q d@@57) ($IsAlloc DatatypeTypeType d@@57 Tclass._module.StateC $h@@11))) ($IsAllocBox (_module.StateC.st d@@57) Tclass._module.State $h@@11))
 :qid |unknown.0:0|
 :skolemid |1274|
 :pattern ( ($IsAllocBox (_module.StateC.st d@@57) Tclass._module.State $h@@11))
)))
(assert (forall ((d@@58 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (_module.StateC.S_q d@@58) ($IsAlloc DatatypeTypeType d@@58 Tclass._module.StateC $h@@12))) ($IsAllocBox (_module.StateC.c d@@58) Tclass._module.Cache $h@@12))
 :qid |unknown.0:0|
 :skolemid |1275|
 :pattern ( ($IsAllocBox (_module.StateC.c d@@58) Tclass._module.Cache $h@@12))
)))
(assert (forall ((d@@59 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (_module.Expression.exprLiteral_q d@@59) ($IsAlloc DatatypeTypeType d@@59 Tclass._module.Expression $h@@13))) ($IsAlloc DatatypeTypeType (_module.Expression.lit d@@59) Tclass._module.Literal $h@@13))
 :qid |unknown.0:0|
 :skolemid |1331|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.lit d@@59) Tclass._module.Literal $h@@13))
)))
(assert (forall ((d@@60 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (_module.Expression.exprIdentifier_q d@@60) ($IsAlloc DatatypeTypeType d@@60 Tclass._module.Expression $h@@14))) ($IsAllocBox (_module.Expression.id d@@60) Tclass._module.Identifier $h@@14))
 :qid |unknown.0:0|
 :skolemid |1340|
 :pattern ( ($IsAllocBox (_module.Expression.id d@@60) Tclass._module.Identifier $h@@14))
)))
(assert (forall ((d@@61 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (_module.Expression.exprIf_q d@@61) ($IsAlloc DatatypeTypeType d@@61 Tclass._module.Expression $h@@15))) ($IsAlloc DatatypeTypeType (_module.Expression.cond d@@61) Tclass._module.Expression $h@@15))
 :qid |unknown.0:0|
 :skolemid |1348|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.cond d@@61) Tclass._module.Expression $h@@15))
)))
(assert (forall ((d@@62 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (_module.Expression.exprIf_q d@@62) ($IsAlloc DatatypeTypeType d@@62 Tclass._module.Expression $h@@16))) ($IsAlloc DatatypeTypeType (_module.Expression.ifTrue d@@62) Tclass._module.Expression $h@@16))
 :qid |unknown.0:0|
 :skolemid |1349|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.ifTrue d@@62) Tclass._module.Expression $h@@16))
)))
(assert (forall ((d@@63 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (_module.Expression.exprIf_q d@@63) ($IsAlloc DatatypeTypeType d@@63 Tclass._module.Expression $h@@17))) ($IsAlloc DatatypeTypeType (_module.Expression.ifFalse d@@63) Tclass._module.Expression $h@@17))
 :qid |unknown.0:0|
 :skolemid |1350|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.ifFalse d@@63) Tclass._module.Expression $h@@17))
)))
(assert (forall ((d@@64 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (_module.Expression.exprAnd_q d@@64) ($IsAlloc DatatypeTypeType d@@64 Tclass._module.Expression $h@@18))) ($IsAlloc DatatypeTypeType (_module.Expression.conj0 d@@64) Tclass._module.Expression $h@@18))
 :qid |unknown.0:0|
 :skolemid |1363|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.conj0 d@@64) Tclass._module.Expression $h@@18))
)))
(assert (forall ((d@@65 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (_module.Expression.exprAnd_q d@@65) ($IsAlloc DatatypeTypeType d@@65 Tclass._module.Expression $h@@19))) ($IsAlloc DatatypeTypeType (_module.Expression.conj1 d@@65) Tclass._module.Expression $h@@19))
 :qid |unknown.0:0|
 :skolemid |1364|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.conj1 d@@65) Tclass._module.Expression $h@@19))
)))
(assert (forall ((d@@66 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (_module.Expression.exprOr_q d@@66) ($IsAlloc DatatypeTypeType d@@66 Tclass._module.Expression $h@@20))) ($IsAlloc DatatypeTypeType (_module.Expression.disj0 d@@66) Tclass._module.Expression $h@@20))
 :qid |unknown.0:0|
 :skolemid |1375|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.disj0 d@@66) Tclass._module.Expression $h@@20))
)))
(assert (forall ((d@@67 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (_module.Expression.exprOr_q d@@67) ($IsAlloc DatatypeTypeType d@@67 Tclass._module.Expression $h@@21))) ($IsAlloc DatatypeTypeType (_module.Expression.disj1 d@@67) Tclass._module.Expression $h@@21))
 :qid |unknown.0:0|
 :skolemid |1376|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.disj1 d@@67) Tclass._module.Expression $h@@21))
)))
(assert (forall ((d@@68 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (_module.Expression.exprInvocation_q d@@68) ($IsAlloc DatatypeTypeType d@@68 Tclass._module.Expression $h@@22))) ($IsAlloc DatatypeTypeType (_module.Expression.fun d@@68) Tclass._module.Expression $h@@22))
 :qid |unknown.0:0|
 :skolemid |1387|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.fun d@@68) Tclass._module.Expression $h@@22))
)))
(assert (forall ((d@@69 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (_module.Expression.exprError_q d@@69) ($IsAlloc DatatypeTypeType d@@69 Tclass._module.Expression $h@@23))) ($IsAlloc DatatypeTypeType (_module.Expression.r d@@69) Tclass._module.Reason $h@@23))
 :qid |unknown.0:0|
 :skolemid |1401|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.r d@@69) Tclass._module.Reason $h@@23))
)))
(assert (forall ((d@@70 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (_module.Literal.litPrimitive_q d@@70) ($IsAlloc DatatypeTypeType d@@70 Tclass._module.Literal $h@@24))) ($IsAlloc DatatypeTypeType (_module.Literal.prim d@@70) Tclass._module.Primitive $h@@24))
 :qid |unknown.0:0|
 :skolemid |1447|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Literal.prim d@@70) Tclass._module.Primitive $h@@24))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|stC#0@@5| T@U) ) (!  (=> (or (|_module.__default.ConsistentCache#canCall| |stC#0@@5|) (and (< 3 $FunctionContextHeight) ($Is DatatypeTypeType |stC#0@@5| Tclass._module.StateC))) (and (forall ((|cmd#0@@6| T@U) (|deps#0@@5| T@U) (|e#0@@0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#0@@6| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@5| Tclass._module.Expression)) ($Is SeqType |e#0@@0| (TSeq TChar))) (and (and (and (|_module.__default.Loc#canCall| |cmd#0@@6| |deps#0@@5| |e#0@@0|) (|_module.__default.Hash#canCall| (_module.__default.Loc |cmd#0@@6| |deps#0@@5| |e#0@@0|))) (and (_module.StateC.S_q |stC#0@@5|) (|_module.__default.DomC#canCall| (_module.StateC.c |stC#0@@5|)))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@5|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@6| |deps#0@@5| |e#0@@0|))) (and (|_module.__default.Loc#canCall| |cmd#0@@6| |deps#0@@5| |e#0@@0|) (and (_module.StateC.S_q |stC#0@@5|) (|_module.__default.DomSt#canCall| (_module.StateC.st |stC#0@@5|)))))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |874|
 :pattern ( (_module.__default.Loc |cmd#0@@6| |deps#0@@5| |e#0@@0|))
)) (= (_module.__default.ConsistentCache |stC#0@@5|) (forall ((|cmd#0@@7| T@U) (|deps#0@@6| T@U) (|e#0@@1| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#0@@7| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@6| Tclass._module.Expression)) ($Is SeqType |e#0@@1| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@5|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@7| |deps#0@@6| |e#0@@1|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@5|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0@@7| |deps#0@@6| |e#0@@1|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |873|
 :pattern ( (_module.__default.Loc |cmd#0@@7| |deps#0@@6| |e#0@@1|))
)))))
 :qid |CloudMakeConsistentBuildslegacydfy.149:33|
 :skolemid |875|
 :pattern ( (_module.__default.ConsistentCache |stC#0@@5|))
))))
...
(assert (forall ((d@@71 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (_module.Literal.litArrOfStrings_q d@@71) ($IsAlloc DatatypeTypeType d@@71 Tclass._module.Literal $h@@25))) ($IsAlloc SetType (_module.Literal.strs d@@71) (TSet (TSeq TChar)) $h@@25))
 :qid |unknown.0:0|
 :skolemid |1465|
 :pattern ( ($IsAlloc SetType (_module.Literal.strs d@@71) (TSet (TSeq TChar)) $h@@25))
)))
...
(assert (forall ((d@@72 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (_module.Expression.exprInvocation_q d@@72) ($IsAlloc DatatypeTypeType d@@72 Tclass._module.Expression $h@@26))) ($IsAlloc SeqType (_module.Expression.args d@@72) (TSeq Tclass._module.Expression) $h@@26))
 :qid |unknown.0:0|
 :skolemid |1388|
 :pattern ( ($IsAlloc SeqType (_module.Expression.args d@@72) (TSeq Tclass._module.Expression) $h@@26))
)))
(assert (forall ((d@@73 T@U) ($h@@27 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (_module.Literal.litArrOfPaths_q d@@73) ($IsAlloc DatatypeTypeType d@@73 Tclass._module.Literal $h@@27))) ($IsAlloc SetType (_module.Literal.paths d@@73) (TSet Tclass._module.Path) $h@@27))
 :qid |unknown.0:0|
 :skolemid |1456|
 :pattern ( ($IsAlloc SetType (_module.Literal.paths d@@73) (TSet Tclass._module.Path) $h@@27))
)))
(assert (forall ((d@@74 T@U) ($h@@28 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (_module.Literal.litArray_q d@@74) ($IsAlloc DatatypeTypeType d@@74 Tclass._module.Literal $h@@28))) ($IsAlloc SeqType (_module.Literal.arr d@@74) (TSeq Tclass._module.Expression) $h@@28))
 :qid |unknown.0:0|
 :skolemid |1474|
 :pattern ( ($IsAlloc SeqType (_module.Literal.arr d@@74) (TSeq Tclass._module.Expression) $h@@28))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.UpdateCLemma)
...
(let ((anon13_Else_correct  (=> (and (not (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0@@4|)) ($Box SeqType |e#2@0|))) (= (ControlFlow 0 5) 1)) anon9_correct)))
(let ((anon13_Then_correct  (=> (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0@@4|)) ($Box SeqType |e#2@0|)) (=> (and (and ($IsAlloc DatatypeTypeType |cmd#0@@8| Tclass._module.Expression $Heap@0) ($IsAlloc DatatypeTypeType |deps#0@@7| Tclass._module.Expression $Heap@0)) (and ($IsAlloc SeqType |e#2@0| (TSeq TChar) $Heap@0) (|_module.__default.Loc#canCall| |cmd#0@@8| |deps#0@@7| |e#2@0|))) (=> (and (and (and (= |##p#0@0| (_module.__default.Loc |cmd#0@@8| |deps#0@@7| |e#2@0|)) ($IsAlloc DatatypeTypeType |##p#0@0| Tclass._module.Path $Heap@0)) (and (|_module.__default.Hash#canCall| (_module.__default.Loc |cmd#0@@8| |deps#0@@7| |e#2@0|)) (_module.StateC.S_q |stC'#Z#0@0|))) (and (and (= |##c#0@0| (_module.StateC.c |stC'#Z#0@0|)) ($IsAllocBox |##c#0@0| Tclass._module.Cache $Heap@0)) (and (|_module.__default.DomC#canCall| (_module.StateC.c |stC'#Z#0@0|)) (= (ControlFlow 0 4) 1)))) anon9_correct)))))
(let ((anon12_Then_correct  (=> (and ($Is SeqType |e#2@0| (TSeq TChar)) ($IsAlloc SeqType |e#2@0| (TSeq TChar) $Heap@0)) (and (=> (= (ControlFlow 0 6) (- 0 8)) (_module.Expression.exprLiteral_q |exts#0@@4|)) (=> (_module.Expression.exprLiteral_q |exts#0@@4|) (and (=> (= (ControlFlow 0 6) (- 0 7)) (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#0@@4|))) (=> (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#0@@4|)) (and (=> (= (ControlFlow 0 6) 4) anon13_Then_correct) (=> (= (ControlFlow 0 6) 5) anon13_Else_correct)))))))))
(let ((anon12_Else_correct  (=> (and (not (and ($Is SeqType |e#2@0| (TSeq TChar)) ($IsAlloc SeqType |e#2@0| (TSeq TChar) $Heap@0))) (= (ControlFlow 0 3) 1)) anon9_correct)))
(let ((anon11_Then_correct  (=> (_module.__default.ConsistentCache |stC'#Z#0@0|) (and (=> (= (ControlFlow 0 9) 6) anon12_Then_correct) (=> (= (ControlFlow 0 9) 3) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (not (_module.__default.ConsistentCache |stC'#Z#0@0|)) (= (ControlFlow 0 2) 1)) anon9_correct)))
(let ((anon4_correct  (=> (forall ((|e#1@@3| T@U) ) (!  (=> ($Is SeqType |e#1@@3| (TSeq TChar)) (=> (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0@@4|)) ($Box SeqType |e#1@@3|)) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@6|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0@@8| |deps#0@@7| |e#1@@3|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.69:12|
 :skolemid |752|
 :pattern ( (_module.__default.Loc |cmd#0@@8| |deps#0@@7| |e#1@@3|))
 :pattern ( (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0@@4|)) ($Box SeqType |e#1@@3|)))
)) (and (=> (= (ControlFlow 0 10) (- 0 18)) (_module.Expression.exprLiteral_q |exts#0@@4|)) (=> (_module.Expression.exprLiteral_q |exts#0@@4|) (and (=> (= (ControlFlow 0 10) (- 0 17)) (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#0@@4|))) (=> (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#0@@4|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@1 $Heap@0)) (and (and ($IsAlloc DatatypeTypeType |cmd#0@@8| Tclass._module.Expression $Heap@0) ($IsAlloc DatatypeTypeType |deps#0@@7| Tclass._module.Expression $Heap@0)) (and ($IsAlloc DatatypeTypeType |exts#0@@4| Tclass._module.Expression $Heap@0) ($IsAlloc DatatypeTypeType |stC#0@@6| Tclass._module.StateC $Heap@0)))) (and (=> (= (ControlFlow 0 10) (- 0 16)) (_module.Expression.exprLiteral_q |cmd#0@@8|)) (and (=> (= (ControlFlow 0 10) (- 0 15)) (_module.Literal.litString_q (_module.Expression.lit |cmd#0@@8|))) (and (=> (= (ControlFlow 0 10) (- 0 14)) (_module.Expression.exprLiteral_q |deps#0@@7|)) (and (=> (= (ControlFlow 0 10) (- 0 13)) (_module.Literal.litArrOfPaths_q (_module.Expression.lit |deps#0@@7|))) (and (=> (= (ControlFlow 0 10) (- 0 12)) (_module.Expression.exprLiteral_q |exts#0@@4|)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#0@@4|))) (=> (and (and (and (and (and (and (_module.Expression.exprLiteral_q |cmd#0@@8|) (_module.Literal.litString_q (_module.Expression.lit |cmd#0@@8|))) (_module.Expression.exprLiteral_q |deps#0@@7|)) (_module.Literal.litArrOfPaths_q (_module.Expression.lit |deps#0@@7|))) (_module.Expression.exprLiteral_q |exts#0@@4|)) (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#0@@4|))) (and (and (and (|_module.__default.UpdateC#canCall| |cmd#0@@8| |deps#0@@7| |exts#0@@4| |stC#0@@6|) (_module.StateC.S_q (_module.__default.UpdateC ($LS $LZ) |cmd#0@@8| |deps#0@@7| |exts#0@@4| |stC#0@@6|))) (and (= |let#0#0#0| (_module.__default.UpdateC ($LS $LZ) |cmd#0@@8| |deps#0@@7| |exts#0@@4| |stC#0@@6|)) (|_module.__default.UpdateC#canCall| |cmd#0@@8| |deps#0@@7| |exts#0@@4| |stC#0@@6|))) (and (and ($Is DatatypeTypeType |let#0#0#0| Tclass._module.StateC) (= |stC'#Z#0@0| |let#0#0#0|)) (and ($IsAlloc DatatypeTypeType |stC'#Z#0@0| Tclass._module.StateC $Heap@0) (|_module.__default.ConsistentCache#canCall| |stC'#Z#0@0|))))) (and (=> (= (ControlFlow 0 10) 9) anon11_Then_correct) (=> (= (ControlFlow 0 10) 2) anon11_Else_correct)))))))))))))))))
(let ((anon10_Else_correct  (=> (and (=> (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0@@4|)) ($Box SeqType |e#0@0|)) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@6|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0@@8| |deps#0@@7| |e#0@0|)))) (= (ControlFlow 0 22) 10)) anon4_correct)))
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 19) (- 0 21)) (_module.Expression.exprLiteral_q |exts#0@@4|)) (=> (_module.Expression.exprLiteral_q |exts#0@@4|) (and (=> (= (ControlFlow 0 19) (- 0 20)) (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#0@@4|))) (=> (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#0@@4|)) (=> (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0@@4|)) ($Box SeqType |e#0@0|)) (=> (and ($IsAlloc DatatypeTypeType |cmd#0@@8| Tclass._module.Expression $Heap@@1) ($IsAlloc DatatypeTypeType |deps#0@@7| Tclass._module.Expression $Heap@@1)) (=> (and (and (and ($IsAlloc SeqType |e#0@0| (TSeq TChar) $Heap@@1) (|_module.__default.Loc#canCall| |cmd#0@@8| |deps#0@@7| |e#0@0|)) (and (_module.StateC.S_q |stC#0@@6|) (= |##st#0@0| (_module.StateC.st |stC#0@@6|)))) (and (and ($IsAllocBox |##st#0@0| Tclass._module.State $Heap@@1) (|_module.__default.DomSt#canCall| (_module.StateC.st |stC#0@@6|))) (and (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@6|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0@@8| |deps#0@@7| |e#0@0|))) (= (ControlFlow 0 19) 10)))) anon4_correct)))))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (_module.Expression.exprLiteral_q |cmd#0@@8|)) (and (=> (= (ControlFlow 0 23) (- 0 26)) (_module.Expression.exprLiteral_q |cmd#0@@8|)) (=> (_module.Expression.exprLiteral_q |cmd#0@@8|) (=> (and (_module.Literal.litString_q (_module.Expression.lit |cmd#0@@8|)) (_module.Expression.exprLiteral_q |deps#0@@7|)) (and (=> (= (ControlFlow 0 23) (- 0 25)) (_module.Expression.exprLiteral_q |deps#0@@7|)) (=> (_module.Expression.exprLiteral_q |deps#0@@7|) (=> (and (_module.Literal.litArrOfPaths_q (_module.Expression.lit |deps#0@@7|)) (_module.Expression.exprLiteral_q |exts#0@@4|)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (_module.Expression.exprLiteral_q |exts#0@@4|)) (=> (_module.Expression.exprLiteral_q |exts#0@@4|) (=> (and (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#0@@4|)) ($IsAlloc DatatypeTypeType |stC#0@@6| Tclass._module.StateC $Heap@@1)) (=> (and (and (|_module.__default.ConsistentCache#canCall| |stC#0@@6|) (_module.__default.ConsistentCache |stC#0@@6|)) (and ($Is SeqType |e#0@0| (TSeq TChar)) ($IsAlloc SeqType |e#0@0| (TSeq TChar) $Heap@@1))) (and (=> (= (ControlFlow 0 23) 19) anon10_Then_correct) (=> (= (ControlFlow 0 23) 22) anon10_Else_correct)))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and ($Is DatatypeTypeType |cmd#0@@8| Tclass._module.Expression) ($IsAlloc DatatypeTypeType |cmd#0@@8| Tclass._module.Expression $Heap@@1)) (|$IsA#_module.Expression| |cmd#0@@8|)) (=> (and (and (and (and ($Is DatatypeTypeType |deps#0@@7| Tclass._module.Expression) ($IsAlloc DatatypeTypeType |deps#0@@7| Tclass._module.Expression $Heap@@1)) (|$IsA#_module.Expression| |deps#0@@7|)) (and (and ($Is DatatypeTypeType |exts#0@@4| Tclass._module.Expression) ($IsAlloc DatatypeTypeType |exts#0@@4| Tclass._module.Expression $Heap@@1)) (|$IsA#_module.Expression| |exts#0@@4|))) (and (and (and ($Is DatatypeTypeType |stC#0@@6| Tclass._module.StateC) ($IsAlloc DatatypeTypeType |stC#0@@6| Tclass._module.StateC $Heap@@1)) (|$IsA#_module.StateC| |stC#0@@6|)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 27) 23)))) anon0_correct)))))
