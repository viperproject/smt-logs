...
(set-info :boogie-vc-id CheckWellFormed$$M0.__default.EvalLemma)
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@9 alloc false)) (=> (and ($IsAllocBox |st#0@@27| Tclass.M0.State $Heap@@9) (|M0.__default.ValidState#canCall| |st#0@@27|)) (=> (and (and (M0.__default.ValidState |st#0@@27|) ($IsAllocBox |env#0@@13| Tclass.M0.Env $Heap@@9)) (and (|M0.__default.ValidEnv#canCall| |env#0@@13|) (M0.__default.ValidEnv |env#0@@13|))) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@9 $Heap@0)) (and ($Is DatatypeTypeType |expr'#0@0| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |expr'#0@0| Tclass.M0.Expression $Heap@0))) (and (and (and ($IsBox |st'#0@0| Tclass.M0.State) ($IsAllocBox |st'#0@0| Tclass.M0.State $Heap@0)) ($IsAlloc DatatypeTypeType |expr#0@@7| Tclass.M0.Expression $Heap@0)) (and ($IsAllocBox |st#0@@27| Tclass.M0.State $Heap@0) ($IsAllocBox |env#0@@13| Tclass.M0.Env $Heap@0)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (M0.__default.ValidEnv |env#0@@13|)) (=> (M0.__default.ValidEnv |env#0@@13|) (=> (and (|M0.__default.eval#canCall| |expr#0@@7| |st#0@@27| |env#0@@13|) (M0.Tuple.Pair_q (M0.__default.eval ($LS $LZ) |expr#0@@7| |st#0@@27| |env#0@@13|))) (=> (and (and (and (|M0.Tuple#Equal| (|#M0.Tuple.Pair| ($Box DatatypeTypeType |expr'#0@0|) |st'#0@0|) (M0.__default.eval ($LS $LZ) |expr#0@@7| |st#0@@27| |env#0@@13|)) ($IsAllocBox |st'#0@0| Tclass.M0.State $Heap@0)) (and (|M0.__default.ValidState#canCall| |st'#0@0|) (M0.__default.ValidState |st'#0@0|))) (and (and ($IsAllocBox |st#0@@27| Tclass.M0.State $Heap@0) ($IsAllocBox |st'#0@0| Tclass.M0.State $Heap@0)) (and (|M0.__default.Extends#canCall| |st#0@@27| |st'#0@0|) (M0.__default.Extends |st#0@@27| |st'#0@0|)))) (and (=> (= (ControlFlow 0 5) 2) anon4_Then_correct) (=> (= (ControlFlow 0 5) 4) anon4_Else_correct))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@9) ($IsHeapAnchor $Heap@@9)) (=> (and (and (and (and ($Is DatatypeTypeType |expr#0@@7| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |expr#0@@7| Tclass.M0.Expression $Heap@@9)) (|$IsA#M0.Expression| |expr#0@@7|)) (and ($IsBox |st#0@@27| Tclass.M0.State) ($IsAllocBox |st#0@@27| Tclass.M0.State $Heap@@9))) (and (and (and ($IsBox |env#0@@13| Tclass.M0.Env) ($IsAllocBox |env#0@@13| Tclass.M0.Env $Heap@@9)) (and ($Is DatatypeTypeType |expr'#0| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |expr'#0| Tclass.M0.Expression $Heap@@9))) (and (and ($IsBox |st'#0@@7| Tclass.M0.State) ($IsAllocBox |st'#0@@7| Tclass.M0.State $Heap@@9)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 7) 5))))) anon0_correct))))
