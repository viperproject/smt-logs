...
(declare-fun M0._default.PickOne$T@@4 () T@U)
...
(set-info :boogie-vc-id CheckWellformed$$M0.__default.PickOne)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon5_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (exists ((|x#3| T@U) ) (!  (and ($IsBox |x#3| M0._default.PickOne$T@@4) (|Set#IsMember| |s#0@@3| |x#3|))
 :qid |CloudMakeCachedBuildsdfy.76:9|
 :skolemid |793|
)))))
(let ((anon8_Else_correct  (=> (and (not (and ($IsBox |x#2@0| M0._default.PickOne$T@@4) ($IsAllocBox |x#2@0| M0._default.PickOne$T@@4 $Heap@@2))) (= (ControlFlow 0 5) 3)) anon5_correct)))
(let ((anon8_Then_correct  (=> (and (and ($IsBox |x#2@0| M0._default.PickOne$T@@4) ($IsAllocBox |x#2@0| M0._default.PickOne$T@@4 $Heap@@2)) (= (ControlFlow 0 4) 3)) anon5_correct)))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) ($Is SetType |s#0@@3| (TSet M0._default.PickOne$T@@4))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct)))
