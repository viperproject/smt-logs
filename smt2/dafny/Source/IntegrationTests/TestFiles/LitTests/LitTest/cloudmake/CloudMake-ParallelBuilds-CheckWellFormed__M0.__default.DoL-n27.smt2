...
(assert (forall ((d@@0 T@U) ) (! (= (M0.Statement.stmtVariable_q d@@0) (= (DatatypeCtorId d@@0) |##M0.Statement.stmtVariable|))
 :qid |unknown.0:0|
 :skolemid |1136|
 :pattern ( (M0.Statement.stmtVariable_q d@@0))
)))
(assert (forall ((d@@1 T@U) ) (! (= (M0.Statement.stmtReturn_q d@@1) (= (DatatypeCtorId d@@1) |##M0.Statement.stmtReturn|))
 :qid |unknown.0:0|
 :skolemid |1148|
 :pattern ( (M0.Statement.stmtReturn_q d@@1))
)))
...
(assert (forall ((d@@23 T@U) ) (!  (=> (M0.Statement.stmtVariable_q d@@23) (exists ((|a#8#0#0| T@U) (|a#8#1#0| T@U) ) (! (= d@@23 (|#M0.Statement.stmtVariable| |a#8#0#0| |a#8#1#0|))
 :qid |CloudMakeParallelBuildsdfy.130:37|
 :skolemid |1137|
)))
 :qid |unknown.0:0|
 :skolemid |1138|
 :pattern ( (M0.Statement.stmtVariable_q d@@23))
)))
...
(assert (forall ((d@@27 T@U) ) (!  (=> (M0.Tuple.Pair_q d@@27) (exists ((|a#142#0#0| T@U) (|a#142#1#0| T@U) ) (! (= d@@27 (|#M0.Tuple.Pair| |a#142#0#0| |a#142#1#0|))
...
(assert (forall ((d@@35 T@U) ) (!  (=> (M0.Statement.stmtReturn_q d@@35) (exists ((|a#15#0#0| T@U) ) (! (= d@@35 (|#M0.Statement.stmtReturn| |a#15#0#0|))
 :qid |CloudMakeParallelBuildsdfy.131:35|
 :skolemid |1149|
)))
 :qid |unknown.0:0|
 :skolemid |1150|
 :pattern ( (M0.Statement.stmtReturn_q d@@35))
)))
...
(assert (forall ((bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 Tclass.M0.Statement) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@2)) bx@@2) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@2) Tclass.M0.Statement)))
 :qid |unknown.0:0|
 :skolemid |945|
 :pattern ( ($IsBox bx@@2 Tclass.M0.Statement))
)))
...
(assert (forall ((d@@47 T@U) ) (!  (=> ($Is DatatypeTypeType d@@47 Tclass.M0.Statement) (or (M0.Statement.stmtVariable_q d@@47) (M0.Statement.stmtReturn_q d@@47)))
 :qid |unknown.0:0|
 :skolemid |1158|
 :pattern ( (M0.Statement.stmtReturn_q d@@47) ($Is DatatypeTypeType d@@47 Tclass.M0.Statement))
 :pattern ( (M0.Statement.stmtVariable_q d@@47) ($Is DatatypeTypeType d@@47 Tclass.M0.Statement))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@6 T@U) (|id#0@@1| T@U) (|expr#0@@1| T@U) (|env#0@@10| T@U) ) (!  (=> (and (or (|M0.__default.SetEnv#canCall| |id#0@@1| |expr#0@@1| |env#0@@10|) (and (< 3 $FunctionContextHeight) (and (and (and (and ($IsBox |id#0@@1| Tclass.M0.Identifier) ($IsAllocBox |id#0@@1| Tclass.M0.Identifier $Heap@@6)) (and ($Is DatatypeTypeType |expr#0@@1| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |expr#0@@1| Tclass.M0.Expression $Heap@@6))) (and ($IsBox |env#0@@10| Tclass.M0.Env) ($IsAllocBox |env#0@@10| Tclass.M0.Env $Heap@@6))) (and (M0.__default.ValidEnv |env#0@@10|) (M0.__default.Value |expr#0@@1|))))) ($IsGoodHeap $Heap@@6)) ($IsAllocBox (M0.__default.SetEnv |id#0@@1| |expr#0@@1| |env#0@@10|) Tclass.M0.Env $Heap@@6))
 :qid |CloudMakeParallelBuildsdfy.64:18|
 :skolemid |791|
 :pattern ( ($IsAllocBox (M0.__default.SetEnv |id#0@@1| |expr#0@@1| |env#0@@10|) Tclass.M0.Env $Heap@@6))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@10 T@U) (|expr#0@@2| T@U) (|st#0@@16| T@U) (|env#0@@11| T@U) ) (!  (=> (or (|M0.__default.eval#canCall| |expr#0@@2| |st#0@@16| |env#0@@11|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0@@2| Tclass.M0.Expression) ($IsBox |st#0@@16| Tclass.M0.State)) ($IsBox |env#0@@11| Tclass.M0.Env)) (M0.__default.ValidEnv |env#0@@11|)))) ($Is DatatypeTypeType (M0.__default.eval $ly@@10 |expr#0@@2| |st#0@@16| |env#0@@11|) (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State)))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |971|
 :pattern ( (M0.__default.eval $ly@@10 |expr#0@@2| |st#0@@16| |env#0@@11|))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@11 T@U) (|stmts#0@@4| T@U) (|st#0@@17| T@U) (|env#0@@12| T@U) ) (!  (=> (or (|M0.__default.do#canCall| |stmts#0@@4| |st#0@@17| |env#0@@12|) (and (< 5 $FunctionContextHeight) (and (and (and ($Is SeqType |stmts#0@@4| (TSeq Tclass.M0.Statement)) ($IsBox |st#0@@17| Tclass.M0.State)) ($IsBox |env#0@@12| Tclass.M0.Env)) (and (M0.__default.Legal |stmts#0@@4|) (M0.__default.ValidEnv |env#0@@12|))))) ($Is DatatypeTypeType (M0.__default.do $ly@@11 |stmts#0@@4| |st#0@@17| |env#0@@12|) (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State)))
 :qid |CloudMakeParallelBuildsdfy.177:18|
 :skolemid |951|
 :pattern ( (M0.__default.do $ly@@11 |stmts#0@@4| |st#0@@17| |env#0@@12|))
))))
...
(assert (forall ((v@@7 T@U) (t0@@0 T@U) (h@@1 T@U) ) (! (= ($IsAlloc SetType v@@7 (TSet t0@@0) h@@1) (forall ((bx@@8 T@U) ) (!  (=> (|Set#IsMember| v@@7 bx@@8) ($IsAllocBox bx@@8 t0@@0 h@@1))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|sts#0@@2| T@U) ) (!  (=> (or (|M0.__default.Compatible#canCall| |sts#0@@2|) (and (< 2 $FunctionContextHeight) ($Is SetType |sts#0@@2| (TSet Tclass.M0.State)))) (and (forall ((|st#0@@18| T@U) (|st'#0@@3| T@U) (|p#0@@5| T@U) ) (!  (=> (and (and ($IsBox |st#0@@18| Tclass.M0.State) ($IsBox |st'#0@@3| Tclass.M0.State)) ($IsBox |p#0@@5| Tclass.M0.Path)) (=> (|Set#IsMember| |sts#0@@2| |st#0@@18|) (=> (|Set#IsMember| |sts#0@@2| |st'#0@@3|) (and (|M0.__default.DomSt#canCall| |st#0@@18|) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@18|) |p#0@@5|) (and (|M0.__default.DomSt#canCall| |st'#0@@3|) (=> (|Set#IsMember| (M0.__default.DomSt |st'#0@@3|) |p#0@@5|) (and (|M0.__default.GetSt#canCall| |p#0@@5| |st#0@@18|) (|M0.__default.GetSt#canCall| |p#0@@5| |st'#0@@3|)))))))))
 :qid |CloudMakeParallelBuildsdfy.32:12|
 :skolemid |729|
 :pattern ( (M0.__default.GetSt |p#0@@5| |st'#0@@3|) (M0.__default.GetSt |p#0@@5| |st#0@@18|))
 :pattern ( (M0.__default.GetSt |p#0@@5| |st'#0@@3|) (M0.__default.DomSt |st#0@@18|))
 :pattern ( (M0.__default.GetSt |p#0@@5| |st'#0@@3|) (|Set#IsMember| |sts#0@@2| |st#0@@18|))
 :pattern ( (M0.__default.GetSt |p#0@@5| |st#0@@18|) (M0.__default.DomSt |st'#0@@3|))
 :pattern ( (M0.__default.GetSt |p#0@@5| |st#0@@18|) (|Set#IsMember| |sts#0@@2| |st'#0@@3|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@3|) |p#0@@5|) (M0.__default.DomSt |st#0@@18|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@3|) |p#0@@5|) (|Set#IsMember| |sts#0@@2| |st#0@@18|))
 :pattern ( (M0.__default.DomSt |st'#0@@3|) (|Set#IsMember| (M0.__default.DomSt |st#0@@18|) |p#0@@5|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@18|) |p#0@@5|) (|Set#IsMember| |sts#0@@2| |st'#0@@3|))
)) (= (M0.__default.Compatible |sts#0@@2|) (forall ((|st#0@@19| T@U) (|st'#0@@4| T@U) (|p#0@@6| T@U) ) (!  (=> (and (and ($IsBox |st#0@@19| Tclass.M0.State) ($IsBox |st'#0@@4| Tclass.M0.State)) ($IsBox |p#0@@6| Tclass.M0.Path)) (=> (and (and (and (|Set#IsMember| |sts#0@@2| |st#0@@19|) (|Set#IsMember| |sts#0@@2| |st'#0@@4|)) (|Set#IsMember| (M0.__default.DomSt |st#0@@19|) |p#0@@6|)) (|Set#IsMember| (M0.__default.DomSt |st'#0@@4|) |p#0@@6|)) (= (M0.__default.GetSt |p#0@@6| |st#0@@19|) (M0.__default.GetSt |p#0@@6| |st'#0@@4|))))
 :qid |CloudMakeParallelBuildsdfy.32:12|
 :skolemid |728|
 :pattern ( (M0.__default.GetSt |p#0@@6| |st'#0@@4|) (M0.__default.GetSt |p#0@@6| |st#0@@19|))
 :pattern ( (M0.__default.GetSt |p#0@@6| |st'#0@@4|) (M0.__default.DomSt |st#0@@19|))
 :pattern ( (M0.__default.GetSt |p#0@@6| |st'#0@@4|) (|Set#IsMember| |sts#0@@2| |st#0@@19|))
 :pattern ( (M0.__default.GetSt |p#0@@6| |st#0@@19|) (M0.__default.DomSt |st'#0@@4|))
 :pattern ( (M0.__default.GetSt |p#0@@6| |st#0@@19|) (|Set#IsMember| |sts#0@@2| |st'#0@@4|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@4|) |p#0@@6|) (M0.__default.DomSt |st#0@@19|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@4|) |p#0@@6|) (|Set#IsMember| |sts#0@@2| |st#0@@19|))
 :pattern ( (M0.__default.DomSt |st'#0@@4|) (|Set#IsMember| (M0.__default.DomSt |st#0@@19|) |p#0@@6|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@19|) |p#0@@6|) (|Set#IsMember| |sts#0@@2| |st'#0@@4|))
)))))
 :qid |CloudMakeParallelBuildsdfy.30:30|
 :skolemid |730|
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@12 T@U) (|expr#0@@4| T@U) (|st#0@@20| T@U) (|env#0@@14| T@U) ) (!  (=> (or (|M0.__default.eval#canCall| |expr#0@@4| |st#0@@20| |env#0@@14|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0@@4| Tclass.M0.Expression) ($IsBox |st#0@@20| Tclass.M0.State)) ($IsBox |env#0@@14| Tclass.M0.Env)) (M0.__default.ValidEnv |env#0@@14|)))) (and (and (|M0.__default.Value#canCall| |expr#0@@4|) (=> (not (M0.__default.Value |expr#0@@4|)) (and (=> (M0.Expression.exprIdentifier_q |expr#0@@4|) (|M0.__default.GetEnv#canCall| (M0.Expression.id |expr#0@@4|) |env#0@@14|)) (=> (not (M0.Expression.exprIdentifier_q |expr#0@@4|)) (and (=> (M0.Expression.exprIf_q |expr#0@@4|) (and (|M0.__default.eval#canCall| (M0.Expression.cond |expr#0@@4|) |st#0@@20| |env#0@@14|) (let ((|st'#0@@5| (M0.Tuple.snd (M0.__default.eval $ly@@12 (M0.Expression.cond |expr#0@@4|) |st#0@@20| |env#0@@14|))))
(let ((|cond'#0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@12 (M0.Expression.cond |expr#0@@4|) |st#0@@20| |env#0@@14|)))))
 (and (and (=> (M0.Expression.exprLiteral_q |cond'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#0|))) (=> (and (M0.Expression.exprLiteral_q |cond'#0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#0|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (M0.Expression.ifTrue |expr#0@@4|) |st'#0@@5| |env#0@@14|))) (=> (not (and (M0.Expression.exprLiteral_q |cond'#0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#0|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |cond'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#0|))) (=> (and (M0.Expression.exprLiteral_q |cond'#0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#0|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (M0.Expression.ifFalse |expr#0@@4|) |st'#0@@5| |env#0@@14|))))))))) (=> (not (M0.Expression.exprIf_q |expr#0@@4|)) (and (=> (M0.Expression.exprAnd_q |expr#0@@4|) (and (|M0.__default.eval#canCall| (M0.Expression.conj0 |expr#0@@4|) |st#0@@20| |env#0@@14|) (let ((|st'#1@@3| (M0.Tuple.snd (M0.__default.eval $ly@@12 (M0.Expression.conj0 |expr#0@@4|) |st#0@@20| |env#0@@14|))))
(let ((|conj0'#0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@12 (M0.Expression.conj0 |expr#0@@4|) |st#0@@20| |env#0@@14|)))))
 (and (and (=> (M0.Expression.exprLiteral_q |conj0'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#0|))) (=> (and (M0.Expression.exprLiteral_q |conj0'#0|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#0|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (M0.Expression.conj1 |expr#0@@4|) |st'#1@@3| |env#0@@14|))) (=> (not (and (M0.Expression.exprLiteral_q |conj0'#0|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#0|) |#M0.Literal.litTrue|))) (=> (M0.Expression.exprLiteral_q |conj0'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#0|))))))))) (=> (not (M0.Expression.exprAnd_q |expr#0@@4|)) (and (=> (M0.Expression.exprOr_q |expr#0@@4|) (and (|M0.__default.eval#canCall| (M0.Expression.disj0 |expr#0@@4|) |st#0@@20| |env#0@@14|) (let ((|st'#2| (M0.Tuple.snd (M0.__default.eval $ly@@12 (M0.Expression.disj0 |expr#0@@4|) |st#0@@20| |env#0@@14|))))
(let ((|disj0'#0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@12 (M0.Expression.disj0 |expr#0@@4|) |st#0@@20| |env#0@@14|)))))
 (and (=> (M0.Expression.exprLiteral_q |disj0'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#0|))) (=> (not (and (M0.Expression.exprLiteral_q |disj0'#0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#0|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |disj0'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#0|))) (=> (and (M0.Expression.exprLiteral_q |disj0'#0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#0|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (M0.Expression.disj1 |expr#0@@4|) |st'#2| |env#0@@14|))))))))) (=> (not (M0.Expression.exprOr_q |expr#0@@4|)) (=> (M0.Expression.exprInvocation_q |expr#0@@4|) (and (|M0.__default.eval#canCall| (M0.Expression.fun |expr#0@@4|) |st#0@@20| |env#0@@14|) (let ((|st'#3| (M0.Tuple.snd (M0.__default.eval $ly@@12 (M0.Expression.fun |expr#0@@4|) |st#0@@20| |env#0@@14|))))
(let ((|fun'#0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@12 (M0.Expression.fun |expr#0@@4|) |st#0@@20| |env#0@@14|)))))
 (and (|M0.__default.evalArgs#canCall| |expr#0@@4| (M0.Expression.args |expr#0@@4|) |st#0@@20| |env#0@@14|) (let ((|sts'#0| ($Unbox SetType (M0.Tuple.snd (M0.__default.evalArgs $ly@@12 |expr#0@@4| (M0.Expression.args |expr#0@@4|) |st#0@@20| |env#0@@14|)))))
(let ((|args'#0| ($Unbox SeqType (M0.Tuple.fst (M0.__default.evalArgs $ly@@12 |expr#0@@4| (M0.Expression.args |expr#0@@4|) |st#0@@20| |env#0@@14|)))))
...
(let ((|conj0'#0@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@12 (M0.Expression.conj0 |expr#0@@4|) |st#0@@20| |env#0@@14|)))))
...
(let ((|disj0'#0@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@12 (M0.Expression.disj0 |expr#0@@4|) |st#0@@20| |env#0@@14|)))))
...
(let ((|fun'#0@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@12 (M0.Expression.fun |expr#0@@4|) |st#0@@20| |env#0@@14|)))))
(let ((|sts'#0@@0| ($Unbox SetType (M0.Tuple.snd (M0.__default.evalArgs $ly@@12 |expr#0@@4| (M0.Expression.args |expr#0@@4|) |st#0@@20| |env#0@@14|)))))
(let ((|args'#0@@0| ($Unbox SeqType (M0.Tuple.fst (M0.__default.evalArgs $ly@@12 |expr#0@@4| (M0.Expression.args |expr#0@@4|) |st#0@@20| |env#0@@14|)))))
(let ((|sts''#0@@0| (|Set#Union| (|Set#UnionOne| |Set#Empty| |st'#3@@0|) |sts'#0@@0|)))
(ite  (not (M0.__default.Compatible |sts''#0@@0|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rCompatibility|)))) |st#0@@20|) (let ((|stCombined#0@@0| (M0.__default.Combine ($LS $LZ) |sts''#0@@0|)))
...
(|#M0.Tuple.Pair| ($Box DatatypeTypeType (|#M0.Expression.exprLiteral| (|#M0.Literal.litArrOfPaths| ($Unbox SetType (M0.Tuple.fst |ps#0@@0|))))) (M0.Tuple.snd |ps#0@@0|))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@20|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@20|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@20|))))))))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@20|))))))))))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |974|
 :pattern ( (M0.__default.eval ($LS $ly@@12) |expr#0@@4| |st#0@@20| |env#0@@14|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|cmd#0@@5| T@U) (|deps#0@@5| T@U) (|exps#0@@4| T@U) (|st#0@@22| T@U) ) (!  (=> (or (|M0.__default.Pre#canCall| |cmd#0@@5| |deps#0@@5| |exps#0@@4| |st#0@@22|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@5| (TSeq TChar)) ($Is SetType |deps#0@@5| (TSet Tclass.M0.Path))) ($Is SetType |exps#0@@4| (TSet (TSeq TChar)))) ($IsBox |st#0@@22| Tclass.M0.State)))) (and (forall ((|e#0| T@U) ) (!  (=> ($Is SeqType |e#0| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@4| ($Box SeqType |e#0|)) (and (and (|M0.__default.Loc#canCall| |cmd#0@@5| |deps#0@@5| |e#0|) (|M0.__default.DomSt#canCall| |st#0@@22|)) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@22|) (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0|)) (and (and (|M0.__default.Loc#canCall| |cmd#0@@5| |deps#0@@5| |e#0|) (|M0.__default.GetSt#canCall| (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0|) |st#0@@22|)) (and (|M0.__default.Loc#canCall| |cmd#0@@5| |deps#0@@5| |e#0|) (|M0.__default.Oracle#canCall| (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0|) |st#0@@22|)))))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |819|
 :pattern ( (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0|))
 :pattern ( (|Set#IsMember| |exps#0@@4| ($Box SeqType |e#0|)))
)) (= (M0.__default.Pre |cmd#0@@5| |deps#0@@5| |exps#0@@4| |st#0@@22|) (forall ((|e#0@@0| T@U) ) (!  (=> ($Is SeqType |e#0@@0| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@4| ($Box SeqType |e#0@@0|)) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@22|) (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0@@0|)) (= (M0.__default.GetSt (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0@@0|) |st#0@@22|) (M0.__default.Oracle (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0@@0|) |st#0@@22|)))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |818|
 ...
 :qid |CloudMakeParallelBuildsdfy.83:23|
 :skolemid |820|
 :pattern ( (M0.__default.Pre |cmd#0@@5| |deps#0@@5| |exps#0@@4| |st#0@@22|))
))))
(assert (forall (($ly@@14 T@U) (|stmts#0@@5| T@U) (|st#0@@23| T@U) (|env#0@@15| T@U) ) (! (= (M0.__default.do ($LS $ly@@14) |stmts#0@@5| |st#0@@23| |env#0@@15|) (M0.__default.do $ly@@14 |stmts#0@@5| |st#0@@23| |env#0@@15|))
 :qid |CloudMakeParallelBuildsdfy.177:18|
 :skolemid |949|
 :pattern ( (M0.__default.do ($LS $ly@@14) |stmts#0@@5| |st#0@@23| |env#0@@15|))
)))
(assert (forall (($ly@@15 T@U) (|expr#0@@5| T@U) (|st#0@@24| T@U) (|env#0@@16| T@U) ) (! (= (M0.__default.eval ($LS $ly@@15) |expr#0@@5| |st#0@@24| |env#0@@16|) (M0.__default.eval $ly@@15 |expr#0@@5| |st#0@@24| |env#0@@16|))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |969|
 :pattern ( (M0.__default.eval ($LS $ly@@15) |expr#0@@5| |st#0@@24| |env#0@@16|))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@7 T@U) ($ly@@16 T@U) (|expr#0@@6| T@U) (|st#0@@25| T@U) (|env#0@@17| T@U) ) (!  (=> (and (or (|M0.__default.eval#canCall| |expr#0@@6| |st#0@@25| |env#0@@17|) (and (< 4 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |expr#0@@6| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |expr#0@@6| Tclass.M0.Expression $Heap@@7)) (and ($IsBox |st#0@@25| Tclass.M0.State) ($IsAllocBox |st#0@@25| Tclass.M0.State $Heap@@7))) (and ($IsBox |env#0@@17| Tclass.M0.Env) ($IsAllocBox |env#0@@17| Tclass.M0.Env $Heap@@7))) (M0.__default.ValidEnv |env#0@@17|)))) ($IsGoodHeap $Heap@@7)) ($IsAlloc DatatypeTypeType (M0.__default.eval $ly@@16 |expr#0@@6| |st#0@@25| |env#0@@17|) (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State) $Heap@@7))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |972|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.__default.eval $ly@@16 |expr#0@@6| |st#0@@25| |env#0@@17|) (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State) $Heap@@7))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|prim#0@@4| T@U) (|args#0@@6| T@U) (|st#0@@26| T@U) ) (!  (=> (or (|M0.__default.ValidArgs#canCall| (Lit DatatypeTypeType |prim#0@@4|) (Lit SeqType |args#0@@6|) |st#0@@26|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |prim#0@@4| Tclass.M0.Primitive) ($Is SeqType |args#0@@6| (TSeq Tclass.M0.Expression))) ($IsBox |st#0@@26| Tclass.M0.State)) (and (=> (M0.Primitive.primExec_q (Lit DatatypeTypeType |prim#0@@4|)) (= (|Seq#Length| (Lit SeqType |args#0@@6|)) (LitInt 3))) (=> (M0.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@4|)) (= (|Seq#Length| (Lit SeqType |args#0@@6|)) (LitInt 1))))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@4|)))))) (let ((|exps#3| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@6|) (LitInt 2)))))
...
(assert (forall ((d@@49 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (M0.Literal.litNumber_q d@@49) ($IsAlloc DatatypeTypeType d@@49 Tclass.M0.Literal $h@@19))) ($IsAlloc intType (int_2_U (M0.Literal.num d@@49)) TInt $h@@19))
 :qid |unknown.0:0|
 :skolemid |1277|
 :pattern ( ($IsAlloc intType (int_2_U (M0.Literal.num d@@49)) TInt $h@@19))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@8 T@U) (|p#0@@7| T@U) (|st#0@@27| T@U) ) (!  (=> (and (or (|M0.__default.Oracle#canCall| |p#0@@7| |st#0@@27|) (and (< 0 $FunctionContextHeight) (and (and ($IsBox |p#0@@7| Tclass.M0.Path) ($IsAllocBox |p#0@@7| Tclass.M0.Path $Heap@@8)) (and ($IsBox |st#0@@27| Tclass.M0.State) ($IsAllocBox |st#0@@27| Tclass.M0.State $Heap@@8))))) ($IsGoodHeap $Heap@@8)) ($IsAllocBox (M0.__default.Oracle |p#0@@7| |st#0@@27|) Tclass.M0.Artifact $Heap@@8))
 :qid |CloudMakeParallelBuildsdfy.104:18|
 :skolemid |869|
 :pattern ( ($IsAllocBox (M0.__default.Oracle |p#0@@7| |st#0@@27|) Tclass.M0.Artifact $Heap@@8))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@9 T@U) (|st#0@@28| T@U) (|st'#0@@7| T@U) ) (!  (=> (and (or (|M0.__default.Union#canCall| |st#0@@28| |st'#0@@7|) (and (< 2 $FunctionContextHeight) (and (and ($IsBox |st#0@@28| Tclass.M0.State) ($IsAllocBox |st#0@@28| Tclass.M0.State $Heap@@9)) (and ($IsBox |st'#0@@7| Tclass.M0.State) ($IsAllocBox |st'#0@@7| Tclass.M0.State $Heap@@9))))) ($IsGoodHeap $Heap@@9)) ($IsAllocBox (M0.__default.Union |st#0@@28| |st'#0@@7|) Tclass.M0.State $Heap@@9))
 :qid |CloudMakeParallelBuildsdfy.23:18|
 :skolemid |722|
 :pattern ( ($IsAllocBox (M0.__default.Union |st#0@@28| |st'#0@@7|) Tclass.M0.State $Heap@@9))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@29| T@U) (|st'#0@@8| T@U) ) (!  (=> (or (|M0.__default.Extends#canCall| |st#0@@29| |st'#0@@8|) (and (< 2 $FunctionContextHeight) (and ($IsBox |st#0@@29| Tclass.M0.State) ($IsBox |st'#0@@8| Tclass.M0.State)))) (and (and (and (|M0.__default.DomSt#canCall| |st#0@@29|) (|M0.__default.DomSt#canCall| |st'#0@@8|)) (=> (|Set#Subset| (M0.__default.DomSt |st#0@@29|) (M0.__default.DomSt |st'#0@@8|)) (and (forall ((|p#0@@8| T@U) ) (!  (=> ($IsBox |p#0@@8| Tclass.M0.Path) (and (|M0.__default.DomSt#canCall| |st#0@@29|) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@29|) |p#0@@8|) (and (|M0.__default.GetSt#canCall| |p#0@@8| |st'#0@@8|) (|M0.__default.GetSt#canCall| |p#0@@8| |st#0@@29|)))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |879|
 :pattern ( (M0.__default.GetSt |p#0@@8| |st#0@@29|))
 :pattern ( (M0.__default.GetSt |p#0@@8| |st'#0@@8|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@29|) |p#0@@8|))
)) (=> (forall ((|p#0@@9| T@U) ) (!  (=> ($IsBox |p#0@@9| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@29|) |p#0@@9|) (= (M0.__default.GetSt |p#0@@9| |st'#0@@8|) (M0.__default.GetSt |p#0@@9| |st#0@@29|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |881|
 :pattern ( (M0.__default.GetSt |p#0@@9| |st#0@@29|))
 :pattern ( (M0.__default.GetSt |p#0@@9| |st'#0@@8|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@29|) |p#0@@9|))
)) (forall ((|p#1@@1| T@U) ) (!  (=> ($IsBox |p#1@@1| Tclass.M0.Path) (and (|M0.__default.DomSt#canCall| |st#0@@29|) (=> (not (|Set#IsMember| (M0.__default.DomSt |st#0@@29|) |p#1@@1|)) (and (|M0.__default.DomSt#canCall| |st'#0@@8|) (=> (|Set#IsMember| (M0.__default.DomSt |st'#0@@8|) |p#1@@1|) (and (|M0.__default.GetSt#canCall| |p#1@@1| |st'#0@@8|) (|M0.__default.Oracle#canCall| |p#1@@1| |st#0@@29|)))))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |880|
 :pattern ( (M0.__default.Oracle |p#1@@1| |st#0@@29|))
 :pattern ( (M0.__default.GetSt |p#1@@1| |st'#0@@8|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@8|) |p#1@@1|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@29|) |p#1@@1|))
)))))) (= (M0.__default.Extends |st#0@@29| |st'#0@@8|)  (and (and (|Set#Subset| (M0.__default.DomSt |st#0@@29|) (M0.__default.DomSt |st'#0@@8|)) (forall ((|p#0@@10| T@U) ) (!  (=> ($IsBox |p#0@@10| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@29|) |p#0@@10|) (= (M0.__default.GetSt |p#0@@10| |st'#0@@8|) (M0.__default.GetSt |p#0@@10| |st#0@@29|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |877|
 :pattern ( (M0.__default.GetSt |p#0@@10| |st#0@@29|))
 :pattern ( (M0.__default.GetSt |p#0@@10| |st'#0@@8|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@29|) |p#0@@10|))
))) (forall ((|p#1@@2| T@U) ) (!  (=> ($IsBox |p#1@@2| Tclass.M0.Path) (=> (and (not (|Set#IsMember| (M0.__default.DomSt |st#0@@29|) |p#1@@2|)) (|Set#IsMember| (M0.__default.DomSt |st'#0@@8|) |p#1@@2|)) (= (M0.__default.GetSt |p#1@@2| |st'#0@@8|) (M0.__default.Oracle |p#1@@2| |st#0@@29|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |878|
 :pattern ( (M0.__default.Oracle |p#1@@2| |st#0@@29|))
 :pattern ( (M0.__default.GetSt |p#1@@2| |st'#0@@8|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@8|) |p#1@@2|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@29|) |p#1@@2|))
))))))
 :qid |CloudMakeParallelBuildsdfy.112:27|
 :skolemid |882|
 :pattern ( (M0.__default.Extends |st#0@@29| |st'#0@@8|))
))))
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@18 T@U) (|stmts#0@@6| T@U) (|st#0@@30| T@U) (|env#0@@19| T@U) ) (!  (=> (or (|M0.__default.do#canCall| (Lit SeqType |stmts#0@@6|) (Lit BoxType |st#0@@30|) (Lit BoxType |env#0@@19|)) (and (< 5 $FunctionContextHeight) (and (and (and ($Is SeqType |stmts#0@@6| (TSeq Tclass.M0.Statement)) ($IsBox |st#0@@30| Tclass.M0.State)) ($IsBox |env#0@@19| Tclass.M0.Env)) (and (M0.__default.Legal (Lit SeqType |stmts#0@@6|)) (M0.__default.ValidEnv (Lit BoxType |env#0@@19|)))))) (and (let ((|stmt#2| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |stmts#0@@6|) (LitInt 0)))))
 (and (=> (M0.Statement.stmtVariable_q |stmt#2|) (and (|M0.__default.eval#canCall| (M0.Statement.expr |stmt#2|) (Lit BoxType |st#0@@30|) (Lit BoxType |env#0@@19|)) (let ((|st'#2@@1| (M0.Tuple.snd (M0.__default.eval ($LS $LZ) (M0.Statement.expr |stmt#2|) (Lit BoxType |st#0@@30|) (Lit BoxType |env#0@@19|)))))
(let ((|expr'#2| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $LZ) (M0.Statement.expr |stmt#2|) (Lit BoxType |st#0@@30|) (Lit BoxType |env#0@@19|))))))
 ...
 (and (|M0.__default.Legal#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@6|) (LitInt 1)))) (=> (U_2_bool (Lit boolType (bool_2_U (M0.__default.Legal (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@6|) (LitInt 1))))))) (|M0.__default.do#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@6|) (LitInt 1))) |st'#2@@1| |env'#2|))))))))))) (=> (not (M0.Statement.stmtVariable_q |stmt#2|)) (|M0.__default.eval#canCall| (M0.Statement.ret |stmt#2|) (Lit BoxType |st#0@@30|) (Lit BoxType |env#0@@19|))))) (= (M0.__default.do ($LS $ly@@18) (Lit SeqType |stmts#0@@6|) (Lit BoxType |st#0@@30|) (Lit BoxType |env#0@@19|)) (let ((|stmt#2@@0| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |stmts#0@@6|) (LitInt 0)))))
(ite (M0.Statement.stmtVariable_q |stmt#2@@0|) (let ((|st'#2@@2| (M0.Tuple.snd (M0.__default.eval ($LS $LZ) (M0.Statement.expr |stmt#2@@0|) (Lit BoxType |st#0@@30|) (Lit BoxType |env#0@@19|)))))
(let ((|expr'#2@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $LZ) (M0.Statement.expr |stmt#2@@0|) (Lit BoxType |st#0@@30|) (Lit BoxType |env#0@@19|))))))
(ite (M0.__default.Value |expr'#2@@0|) (let ((|env'#2@@0| (M0.__default.SetEnv (M0.Statement.id |stmt#2@@0|) |expr'#2@@0| (Lit BoxType |env#0@@19|))))
(ite (M0.__default.Legal (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@6|) (LitInt 1)))) (M0.__default.do ($LS $ly@@18) (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@6|) (LitInt 1))) |st'#2@@2| |env'#2@@0|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType |expr'#2@@0|) |st'#2@@2|))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) (Lit BoxType |st#0@@30|))))) (M0.__default.eval ($LS $LZ) (M0.Statement.ret |stmt#2@@0|) (Lit BoxType |st#0@@30|) (Lit BoxType |env#0@@19|)))))))
 :qid |CloudMakeParallelBuildsdfy.177:18|
 :weight 3
 :skolemid |956|
 :pattern ( (M0.__default.do ($LS $ly@@18) (Lit SeqType |stmts#0@@6|) (Lit BoxType |st#0@@30|) (Lit BoxType |env#0@@19|)))
))))
(assert (forall ((d@@51 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) ($Is DatatypeTypeType d@@51 Tclass.M0.Primitive)) ($IsAlloc DatatypeTypeType d@@51 Tclass.M0.Primitive $h@@20))
 :qid |unknown.0:0|
 :skolemid |1349|
 :pattern ( ($IsAlloc DatatypeTypeType d@@51 Tclass.M0.Primitive $h@@20))
)))
(assert (forall ((d@@52 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) ($Is DatatypeTypeType d@@52 Tclass.M0.Reason)) ($IsAlloc DatatypeTypeType d@@52 Tclass.M0.Reason $h@@21))
 :qid |unknown.0:0|
 :skolemid |1359|
 :pattern ( ($IsAlloc DatatypeTypeType d@@52 Tclass.M0.Reason $h@@21))
)))
...
(assert (forall ((d@@53 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (M0.Literal.litString_q d@@53) ($IsAlloc DatatypeTypeType d@@53 Tclass.M0.Literal $h@@22))) ($IsAlloc SeqType (M0.Literal.str d@@53) (TSeq TChar) $h@@22))
 :qid |unknown.0:0|
 :skolemid |1286|
 :pattern ( ($IsAlloc SeqType (M0.Literal.str d@@53) (TSeq TChar) $h@@22))
)))
(assert (forall ((|a#111#0#0| T@U) (d@@54 T@U) ) (!  (=> (|Set#IsMember| |a#111#0#0| ($Box DatatypeTypeType d@@54)) (< (DtRank d@@54) (DtRank (|#M0.Literal.litArrOfPaths| |a#111#0#0|))))
 :qid |CloudMakeParallelBuildsdfy.145:36|
 :skolemid |1310|
 :pattern ( (|Set#IsMember| |a#111#0#0| ($Box DatatypeTypeType d@@54)) (|#M0.Literal.litArrOfPaths| |a#111#0#0|))
)))
(assert (forall ((|a#117#0#0| T@U) (d@@55 T@U) ) (!  (=> (|Set#IsMember| |a#117#0#0| ($Box DatatypeTypeType d@@55)) (< (DtRank d@@55) (DtRank (|#M0.Literal.litArrOfStrings| |a#117#0#0|))))
 :qid |CloudMakeParallelBuildsdfy.146:38|
 :skolemid |1320|
 :pattern ( (|Set#IsMember| |a#117#0#0| ($Box DatatypeTypeType d@@55)) (|#M0.Literal.litArrOfStrings| |a#117#0#0|))
)))
...
(assert (forall ((d@@56 T@U) (M0.Tuple$A@@6 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (M0.Tuple.Pair_q d@@56) (exists ((M0.Tuple$B@@6 T@U) ) (! ($IsAlloc DatatypeTypeType d@@56 (Tclass.M0.Tuple M0.Tuple$A@@6 M0.Tuple$B@@6) $h@@23)
 :qid |unknown.0:0|
 :skolemid |1371|
 :pattern ( ($IsAlloc DatatypeTypeType d@@56 (Tclass.M0.Tuple M0.Tuple$A@@6 M0.Tuple$B@@6) $h@@23))
)))) ($IsAllocBox (M0.Tuple.fst d@@56) M0.Tuple$A@@6 $h@@23))
 :qid |unknown.0:0|
 :skolemid |1372|
 :pattern ( ($IsAllocBox (M0.Tuple.fst d@@56) M0.Tuple$A@@6 $h@@23))
)))
(assert (forall ((d@@57 T@U) (M0.Tuple$B@@7 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (M0.Tuple.Pair_q d@@57) (exists ((M0.Tuple$A@@7 T@U) ) (! ($IsAlloc DatatypeTypeType d@@57 (Tclass.M0.Tuple M0.Tuple$A@@7 M0.Tuple$B@@7) $h@@24)
 :qid |unknown.0:0|
 :skolemid |1373|
 :pattern ( ($IsAlloc DatatypeTypeType d@@57 (Tclass.M0.Tuple M0.Tuple$A@@7 M0.Tuple$B@@7) $h@@24))
)))) ($IsAllocBox (M0.Tuple.snd d@@57) M0.Tuple$B@@7 $h@@24))
 :qid |unknown.0:0|
 :skolemid |1374|
 :pattern ( ($IsAllocBox (M0.Tuple.snd d@@57) M0.Tuple$B@@7 $h@@24))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@19 T@U) ($Heap@@10 T@U) (|sts#0@@4| T@U) ) (!  (=> (or (|M0.__default.Combine#canCall| (Lit SetType |sts#0@@4|)) (and (< 3 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@10) ($Is SetType |sts#0@@4| (TSet Tclass.M0.State))) (not (|Set#Equal| |sts#0@@4| |Set#Empty|))))) (and (and (|$let#0$canCall| (Lit SetType |sts#0@@4|)) (=> (not (|Set#Equal| |sts#0@@4| (|Set#UnionOne| |Set#Empty| (|$let#0_st| (Lit SetType |sts#0@@4|))))) (and (|M0.__default.Combine#canCall| (|Set#Difference| |sts#0@@4| (|Set#UnionOne| |Set#Empty| (|$let#0_st| (Lit SetType |sts#0@@4|))))) (|M0.__default.Union#canCall| (|$let#0_st| (Lit SetType |sts#0@@4|)) (M0.__default.Combine ($LS $ly@@19) (|Set#Difference| |sts#0@@4| (|Set#UnionOne| |Set#Empty| (|$let#0_st| (Lit SetType |sts#0@@4|))))))))) (= (M0.__default.Combine ($LS $ly@@19) (Lit SetType |sts#0@@4|)) (let ((|st#1@@1| (|$let#0_st| (Lit SetType |sts#0@@4|))))
(ite (|Set#Equal| |sts#0@@4| (|Set#UnionOne| |Set#Empty| |st#1@@1|)) |st#1@@1| (M0.__default.Union |st#1@@1| (M0.__default.Combine ($LS $ly@@19) (|Set#Difference| |sts#0@@4| (|Set#UnionOne| |Set#Empty| |st#1@@1|)))))))))
 ...
 :weight 3
 :skolemid |748|
 :pattern ( (M0.__default.Combine ($LS $ly@@19) (Lit SetType |sts#0@@4|)) ($IsGoodHeap $Heap@@10))
))))
...
(assert (forall ((d@@58 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (M0.Statement.stmtVariable_q d@@58) ($IsAlloc DatatypeTypeType d@@58 Tclass.M0.Statement $h@@25))) ($IsAllocBox (M0.Statement.id d@@58) Tclass.M0.Identifier $h@@25))
 :qid |unknown.0:0|
 :skolemid |1141|
 :pattern ( ($IsAllocBox (M0.Statement.id d@@58) Tclass.M0.Identifier $h@@25))
)))
(assert (forall ((d@@59 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (M0.Statement.stmtVariable_q d@@59) ($IsAlloc DatatypeTypeType d@@59 Tclass.M0.Statement $h@@26))) ($IsAlloc DatatypeTypeType (M0.Statement.expr d@@59) Tclass.M0.Expression $h@@26))
 :qid |unknown.0:0|
 :skolemid |1142|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Statement.expr d@@59) Tclass.M0.Expression $h@@26))
)))
(assert (forall ((d@@60 T@U) ($h@@27 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (M0.Statement.stmtReturn_q d@@60) ($IsAlloc DatatypeTypeType d@@60 Tclass.M0.Statement $h@@27))) ($IsAlloc DatatypeTypeType (M0.Statement.ret d@@60) Tclass.M0.Expression $h@@27))
 :qid |unknown.0:0|
 :skolemid |1153|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Statement.ret d@@60) Tclass.M0.Expression $h@@27))
)))
(assert (forall ((d@@61 T@U) ($h@@28 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (M0.Expression.exprLiteral_q d@@61) ($IsAlloc DatatypeTypeType d@@61 Tclass.M0.Expression $h@@28))) ($IsAlloc DatatypeTypeType (M0.Expression.lit d@@61) Tclass.M0.Literal $h@@28))
 :qid |unknown.0:0|
 :skolemid |1169|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.lit d@@61) Tclass.M0.Literal $h@@28))
)))
(assert (forall ((d@@62 T@U) ($h@@29 T@U) ) (!  (=> (and ($IsGoodHeap $h@@29) (and (M0.Expression.exprIdentifier_q d@@62) ($IsAlloc DatatypeTypeType d@@62 Tclass.M0.Expression $h@@29))) ($IsAllocBox (M0.Expression.id d@@62) Tclass.M0.Identifier $h@@29))
 :qid |unknown.0:0|
 :skolemid |1179|
 :pattern ( ($IsAllocBox (M0.Expression.id d@@62) Tclass.M0.Identifier $h@@29))
)))
(assert (forall ((d@@63 T@U) ($h@@30 T@U) ) (!  (=> (and ($IsGoodHeap $h@@30) (and (M0.Expression.exprIf_q d@@63) ($IsAlloc DatatypeTypeType d@@63 Tclass.M0.Expression $h@@30))) ($IsAlloc DatatypeTypeType (M0.Expression.cond d@@63) Tclass.M0.Expression $h@@30))
 :qid |unknown.0:0|
 :skolemid |1188|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.cond d@@63) Tclass.M0.Expression $h@@30))
)))
(assert (forall ((d@@64 T@U) ($h@@31 T@U) ) (!  (=> (and ($IsGoodHeap $h@@31) (and (M0.Expression.exprIf_q d@@64) ($IsAlloc DatatypeTypeType d@@64 Tclass.M0.Expression $h@@31))) ($IsAlloc DatatypeTypeType (M0.Expression.ifTrue d@@64) Tclass.M0.Expression $h@@31))
 :qid |unknown.0:0|
 :skolemid |1189|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.ifTrue d@@64) Tclass.M0.Expression $h@@31))
)))
(assert (forall ((d@@65 T@U) ($h@@32 T@U) ) (!  (=> (and ($IsGoodHeap $h@@32) (and (M0.Expression.exprIf_q d@@65) ($IsAlloc DatatypeTypeType d@@65 Tclass.M0.Expression $h@@32))) ($IsAlloc DatatypeTypeType (M0.Expression.ifFalse d@@65) Tclass.M0.Expression $h@@32))
 :qid |unknown.0:0|
 :skolemid |1190|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.ifFalse d@@65) Tclass.M0.Expression $h@@32))
)))
(assert (forall ((d@@66 T@U) ($h@@33 T@U) ) (!  (=> (and ($IsGoodHeap $h@@33) (and (M0.Expression.exprAnd_q d@@66) ($IsAlloc DatatypeTypeType d@@66 Tclass.M0.Expression $h@@33))) ($IsAlloc DatatypeTypeType (M0.Expression.conj0 d@@66) Tclass.M0.Expression $h@@33))
 :qid |unknown.0:0|
 :skolemid |1204|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.conj0 d@@66) Tclass.M0.Expression $h@@33))
)))
(assert (forall ((d@@67 T@U) ($h@@34 T@U) ) (!  (=> (and ($IsGoodHeap $h@@34) (and (M0.Expression.exprAnd_q d@@67) ($IsAlloc DatatypeTypeType d@@67 Tclass.M0.Expression $h@@34))) ($IsAlloc DatatypeTypeType (M0.Expression.conj1 d@@67) Tclass.M0.Expression $h@@34))
 :qid |unknown.0:0|
 :skolemid |1205|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.conj1 d@@67) Tclass.M0.Expression $h@@34))
)))
(assert (forall ((d@@68 T@U) ($h@@35 T@U) ) (!  (=> (and ($IsGoodHeap $h@@35) (and (M0.Expression.exprOr_q d@@68) ($IsAlloc DatatypeTypeType d@@68 Tclass.M0.Expression $h@@35))) ($IsAlloc DatatypeTypeType (M0.Expression.disj0 d@@68) Tclass.M0.Expression $h@@35))
 :qid |unknown.0:0|
 :skolemid |1217|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.disj0 d@@68) Tclass.M0.Expression $h@@35))
)))
(assert (forall ((d@@69 T@U) ($h@@36 T@U) ) (!  (=> (and ($IsGoodHeap $h@@36) (and (M0.Expression.exprOr_q d@@69) ($IsAlloc DatatypeTypeType d@@69 Tclass.M0.Expression $h@@36))) ($IsAlloc DatatypeTypeType (M0.Expression.disj1 d@@69) Tclass.M0.Expression $h@@36))
 :qid |unknown.0:0|
 :skolemid |1218|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.disj1 d@@69) Tclass.M0.Expression $h@@36))
)))
(assert (forall ((d@@70 T@U) ($h@@37 T@U) ) (!  (=> (and ($IsGoodHeap $h@@37) (and (M0.Expression.exprInvocation_q d@@70) ($IsAlloc DatatypeTypeType d@@70 Tclass.M0.Expression $h@@37))) ($IsAlloc DatatypeTypeType (M0.Expression.fun d@@70) Tclass.M0.Expression $h@@37))
 :qid |unknown.0:0|
 :skolemid |1230|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.fun d@@70) Tclass.M0.Expression $h@@37))
)))
(assert (forall ((d@@71 T@U) ($h@@38 T@U) ) (!  (=> (and ($IsGoodHeap $h@@38) (and (M0.Expression.exprError_q d@@71) ($IsAlloc DatatypeTypeType d@@71 Tclass.M0.Expression $h@@38))) ($IsAlloc DatatypeTypeType (M0.Expression.r d@@71) Tclass.M0.Reason $h@@38))
 :qid |unknown.0:0|
 :skolemid |1245|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.r d@@71) Tclass.M0.Reason $h@@38))
)))
(assert (forall ((d@@72 T@U) ($h@@39 T@U) ) (!  (=> (and ($IsGoodHeap $h@@39) (and (M0.Literal.litPrimitive_q d@@72) ($IsAlloc DatatypeTypeType d@@72 Tclass.M0.Literal $h@@39))) ($IsAlloc DatatypeTypeType (M0.Literal.prim d@@72) Tclass.M0.Primitive $h@@39))
 :qid |unknown.0:0|
 :skolemid |1297|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Literal.prim d@@72) Tclass.M0.Primitive $h@@39))
)))
...
(assert (forall ((d@@73 T@U) ($h@@40 T@U) ) (!  (=> (and ($IsGoodHeap $h@@40) (and (M0.Literal.litArrOfStrings_q d@@73) ($IsAlloc DatatypeTypeType d@@73 Tclass.M0.Literal $h@@40))) ($IsAlloc SetType (M0.Literal.strs d@@73) (TSet (TSeq TChar)) $h@@40))
 :qid |unknown.0:0|
 :skolemid |1317|
 :pattern ( ($IsAlloc SetType (M0.Literal.strs d@@73) (TSet (TSeq TChar)) $h@@40))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0@@31| T@U) ) (!  (=> (or (|M0.__default.ValidState#canCall| (Lit BoxType |st#0@@31|)) (and (< 1 $FunctionContextHeight) ($IsBox |st#0@@31| Tclass.M0.State))) (and (forall ((|p#1@@3| T@U) ) (!  (=> ($IsBox |p#1@@3| Tclass.M0.Path) (and (|M0.__default.DomSt#canCall| (Lit BoxType |st#0@@31|)) (=> (|Set#IsMember| (M0.__default.DomSt (Lit BoxType |st#0@@31|)) |p#1@@3|) (|M0.__default.WellFounded#canCall| |p#1@@3|))))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |711|
 :pattern ( (M0.__default.WellFounded |p#1@@3|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@31|) |p#1@@3|))
)) (= (M0.__default.ValidState (Lit BoxType |st#0@@31|)) (forall ((|p#1@@4| T@U) ) (!  (=> ($IsBox |p#1@@4| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt (Lit BoxType |st#0@@31|)) |p#1@@4|) (M0.__default.WellFounded |p#1@@4|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |710|
 :pattern ( (M0.__default.WellFounded |p#1@@4|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@31|) |p#1@@4|))
)))))
 :qid |CloudMakeParallelBuildsdfy.13:30|
 :weight 3
 :skolemid |712|
 :pattern ( (M0.__default.ValidState (Lit BoxType |st#0@@31|)))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@20 T@U) (|expr#0@@8| T@U) (|st#0@@32| T@U) (|env#0@@20| T@U) ) (!  (=> (or (|M0.__default.eval#canCall| (Lit DatatypeTypeType |expr#0@@8|) |st#0@@32| |env#0@@20|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0@@8| Tclass.M0.Expression) ($IsBox |st#0@@32| Tclass.M0.State)) ($IsBox |env#0@@20| Tclass.M0.Env)) (M0.__default.ValidEnv |env#0@@20|)))) (and (and (|M0.__default.Value#canCall| (Lit DatatypeTypeType |expr#0@@8|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.__default.Value (Lit DatatypeTypeType |expr#0@@8|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@8|))))) (|M0.__default.GetEnv#canCall| (Lit BoxType (M0.Expression.id (Lit DatatypeTypeType |expr#0@@8|))) |env#0@@20|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@8|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@8|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@32| |env#0@@20|) (let ((|st'#4| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@32| |env#0@@20|))))
(let ((|cond'#1| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@32| |env#0@@20|)))))
 (and (and (=> (M0.Expression.exprLiteral_q |cond'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#1|))) (=> (and (M0.Expression.exprLiteral_q |cond'#1|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#1|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.ifTrue (Lit DatatypeTypeType |expr#0@@8|))) |st'#4| |env#0@@20|))) (=> (not (and (M0.Expression.exprLiteral_q |cond'#1|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#1|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |cond'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#1|))) (=> (and (M0.Expression.exprLiteral_q |cond'#1|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#1|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.ifFalse (Lit DatatypeTypeType |expr#0@@8|))) |st'#4| |env#0@@20|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@8|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@8|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@32| |env#0@@20|) (let ((|st'#5| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@32| |env#0@@20|))))
(let ((|conj0'#1| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@32| |env#0@@20|)))))
 (and (and (=> (M0.Expression.exprLiteral_q |conj0'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#1|))) (=> (and (M0.Expression.exprLiteral_q |conj0'#1|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#1|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.conj1 (Lit DatatypeTypeType |expr#0@@8|))) |st'#5| |env#0@@20|))) (=> (not (and (M0.Expression.exprLiteral_q |conj0'#1|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#1|) |#M0.Literal.litTrue|))) (=> (M0.Expression.exprLiteral_q |conj0'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#1|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@8|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@8|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@32| |env#0@@20|) (let ((|st'#6| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@32| |env#0@@20|))))
(let ((|disj0'#1| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@32| |env#0@@20|)))))
 (and (=> (M0.Expression.exprLiteral_q |disj0'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#1|))) (=> (not (and (M0.Expression.exprLiteral_q |disj0'#1|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#1|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |disj0'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#1|))) (=> (and (M0.Expression.exprLiteral_q |disj0'#1|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#1|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.disj1 (Lit DatatypeTypeType |expr#0@@8|))) |st'#6| |env#0@@20|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@8|)))))) (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0@@8|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@32| |env#0@@20|) (let ((|st'#7| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@32| |env#0@@20|))))
(let ((|fun'#1| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@32| |env#0@@20|)))))
 (and (|M0.__default.evalArgs#canCall| (Lit DatatypeTypeType |expr#0@@8|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@32| |env#0@@20|) (let ((|sts'#1| ($Unbox SetType (M0.Tuple.snd (M0.__default.evalArgs ($LS $ly@@20) (Lit DatatypeTypeType |expr#0@@8|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@32| |env#0@@20|)))))
(let ((|args'#1| ($Unbox SeqType (M0.Tuple.fst (M0.__default.evalArgs ($LS $ly@@20) (Lit DatatypeTypeType |expr#0@@8|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@32| |env#0@@20|)))))
(let ((|sts''#1| (|Set#Union| (|Set#UnionOne| |Set#Empty| |st'#7|) |sts'#1|)))
 ...
 (and (M0.Tuple.Pair_q |ps#1|) (M0.Tuple.Pair_q |ps#1|)))))))))))))))))))))))))))))) (= (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType |expr#0@@8|) |st#0@@32| |env#0@@20|) (ite (M0.__default.Value (Lit DatatypeTypeType |expr#0@@8|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType |expr#0@@8|)) |st#0@@32|) (ite (M0.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@8|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (M0.__default.GetEnv (Lit BoxType (M0.Expression.id (Lit DatatypeTypeType |expr#0@@8|))) |env#0@@20|)) |st#0@@32|) (ite (M0.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@8|)) (let ((|st'#4@@0| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@32| |env#0@@20|))))
(let ((|cond'#1@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@32| |env#0@@20|)))))
(ite  (and (M0.Expression.exprLiteral_q |cond'#1@@0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#1@@0|) |#M0.Literal.litTrue|)) (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.ifTrue (Lit DatatypeTypeType |expr#0@@8|))) |st'#4@@0| |env#0@@20|) (ite  (and (M0.Expression.exprLiteral_q |cond'#1@@0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#1@@0|) |#M0.Literal.litFalse|)) (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.ifFalse (Lit DatatypeTypeType |expr#0@@8|))) |st'#4@@0| |env#0@@20|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@32|))))) (ite (M0.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@8|)) (let ((|st'#5@@0| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@32| |env#0@@20|))))
(let ((|conj0'#1@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@32| |env#0@@20|)))))
(ite  (and (M0.Expression.exprLiteral_q |conj0'#1@@0|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#1@@0|) |#M0.Literal.litTrue|)) (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.conj1 (Lit DatatypeTypeType |expr#0@@8|))) |st'#5@@0| |env#0@@20|) (ite  (and (M0.Expression.exprLiteral_q |conj0'#1@@0|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#1@@0|) |#M0.Literal.litFalse|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprLiteral| (Lit DatatypeTypeType |#M0.Literal.litFalse|)))) |st'#5@@0|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@32|))))) (ite (M0.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@8|)) (let ((|st'#6@@0| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@32| |env#0@@20|))))
(let ((|disj0'#1@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@32| |env#0@@20|)))))
(ite  (and (M0.Expression.exprLiteral_q |disj0'#1@@0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#1@@0|) |#M0.Literal.litTrue|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprLiteral| (Lit DatatypeTypeType |#M0.Literal.litTrue|)))) |st'#6@@0|) (ite  (and (M0.Expression.exprLiteral_q |disj0'#1@@0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#1@@0|) |#M0.Literal.litFalse|)) (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.disj1 (Lit DatatypeTypeType |expr#0@@8|))) |st'#6@@0| |env#0@@20|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@32|))))) (ite (M0.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0@@8|)) (let ((|st'#7@@0| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@32| |env#0@@20|))))
(let ((|fun'#1@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@32| |env#0@@20|)))))
(let ((|sts'#1@@0| ($Unbox SetType (M0.Tuple.snd (M0.__default.evalArgs ($LS $ly@@20) (Lit DatatypeTypeType |expr#0@@8|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@32| |env#0@@20|)))))
(let ((|args'#1@@0| ($Unbox SeqType (M0.Tuple.fst (M0.__default.evalArgs ($LS $ly@@20) (Lit DatatypeTypeType |expr#0@@8|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@32| |env#0@@20|)))))
(let ((|sts''#1@@0| (|Set#Union| (|Set#UnionOne| |Set#Empty| |st'#7@@0|) |sts'#1@@0|)))
(ite  (not (M0.__default.Compatible |sts''#1@@0|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rCompatibility|)))) |st#0@@32|) (let ((|stCombined#1@@0| (M0.__default.Combine ($LS $LZ) |sts''#1@@0|)))
...
(|#M0.Tuple.Pair| ($Box DatatypeTypeType (|#M0.Expression.exprLiteral| (|#M0.Literal.litArrOfPaths| ($Unbox SetType (M0.Tuple.fst |ps#1@@0|))))) (M0.Tuple.snd |ps#1@@0|))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@32|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@32|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@32|))))))))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@32|))))))))))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :weight 3
 :skolemid |975|
 :pattern ( (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType |expr#0@@8|) |st#0@@32| |env#0@@20|))
))))
...
(assert (forall ((d@@74 T@U) ($h@@41 T@U) ) (!  (=> (and ($IsGoodHeap $h@@41) (and (M0.Expression.exprInvocation_q d@@74) ($IsAlloc DatatypeTypeType d@@74 Tclass.M0.Expression $h@@41))) ($IsAlloc SeqType (M0.Expression.args d@@74) (TSeq Tclass.M0.Expression) $h@@41))
 :qid |unknown.0:0|
 :skolemid |1231|
 :pattern ( ($IsAlloc SeqType (M0.Expression.args d@@74) (TSeq Tclass.M0.Expression) $h@@41))
)))
(assert (forall ((d@@75 T@U) ($h@@42 T@U) ) (!  (=> (and ($IsGoodHeap $h@@42) (and (M0.Literal.litArrOfPaths_q d@@75) ($IsAlloc DatatypeTypeType d@@75 Tclass.M0.Literal $h@@42))) ($IsAlloc SetType (M0.Literal.paths d@@75) (TSet Tclass.M0.Path) $h@@42))
 :qid |unknown.0:0|
 :skolemid |1307|
 :pattern ( ($IsAlloc SetType (M0.Literal.paths d@@75) (TSet Tclass.M0.Path) $h@@42))
)))
(assert (forall ((d@@76 T@U) ($h@@43 T@U) ) (!  (=> (and ($IsGoodHeap $h@@43) (and (M0.Literal.litArray_q d@@76) ($IsAlloc DatatypeTypeType d@@76 Tclass.M0.Literal $h@@43))) ($IsAlloc SeqType (M0.Literal.arr d@@76) (TSeq Tclass.M0.Expression) $h@@43))
 :qid |unknown.0:0|
 :skolemid |1327|
 :pattern ( ($IsAlloc SeqType (M0.Literal.arr d@@76) (TSeq Tclass.M0.Expression) $h@@43))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$M0.__default.DoLemma)
...
(let ((anon4_Else_correct  (=> (and (not (M0.Expression.exprError_q |expr'#0@0|)) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon4_Then_correct  (=> (M0.Expression.exprError_q |expr'#0@0|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (M0.Expression.exprError_q |expr'#0@0|)) (=> (M0.Expression.exprError_q |expr'#0@0|) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@11 alloc false)) ($IsAlloc SeqType |stmts#0@@7| (TSeq Tclass.M0.Statement) $Heap@@11)) (=> (and (and (and (|M0.__default.Legal#canCall| |stmts#0@@7|) (M0.__default.Legal |stmts#0@@7|)) (and ($IsAllocBox |st#0@@33| Tclass.M0.State $Heap@@11) (|M0.__default.ValidState#canCall| |st#0@@33|))) (and (and (M0.__default.ValidState |st#0@@33|) ($IsAllocBox |env#0@@21| Tclass.M0.Env $Heap@@11)) (and (|M0.__default.ValidEnv#canCall| |env#0@@21|) (M0.__default.ValidEnv |env#0@@21|)))) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@11 $Heap@0)) (and ($Is DatatypeTypeType |expr'#0@0| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |expr'#0@0| Tclass.M0.Expression $Heap@0))) (and (and (and ($IsBox |st'#0@0| Tclass.M0.State) ($IsAllocBox |st'#0@0| Tclass.M0.State $Heap@0)) ($IsAlloc SeqType |stmts#0@@7| (TSeq Tclass.M0.Statement) $Heap@0)) (and ($IsAllocBox |st#0@@33| Tclass.M0.State $Heap@0) ($IsAllocBox |env#0@@21| Tclass.M0.Env $Heap@0)))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (=> (|M0.__default.Legal#canCall| |stmts#0@@7|) (or (M0.__default.Legal |stmts#0@@7|) (or (not (= (|Seq#Length| |stmts#0@@7|) 0)) (not true))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (M0.__default.ValidEnv |env#0@@21|)) (=> (and (and (M0.__default.Legal |stmts#0@@7|) (M0.__default.ValidEnv |env#0@@21|)) (and (|M0.__default.do#canCall| |stmts#0@@7| |st#0@@33| |env#0@@21|) (M0.Tuple.Pair_q (M0.__default.do ($LS $LZ) |stmts#0@@7| |st#0@@33| |env#0@@21|)))) (=> (and (and (and (|M0.Tuple#Equal| (|#M0.Tuple.Pair| ($Box DatatypeTypeType |expr'#0@0|) |st'#0@0|) (M0.__default.do ($LS $LZ) |stmts#0@@7| |st#0@@33| |env#0@@21|)) ($IsAllocBox |st'#0@0| Tclass.M0.State $Heap@0)) (and (|M0.__default.ValidState#canCall| |st'#0@0|) (M0.__default.ValidState |st'#0@0|))) (and (and ($IsAllocBox |st#0@@33| Tclass.M0.State $Heap@0) ($IsAllocBox |st'#0@0| Tclass.M0.State $Heap@0)) (and (|M0.__default.Extends#canCall| |st#0@@33| |st'#0@0|) (M0.__default.Extends |st#0@@33| |st'#0@0|)))) (and (=> (= (ControlFlow 0 5) 2) anon4_Then_correct) (=> (= (ControlFlow 0 5) 4) anon4_Else_correct)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@11) ($IsHeapAnchor $Heap@@11)) (=> (and (and ($Is SeqType |stmts#0@@7| (TSeq Tclass.M0.Statement)) ($IsAlloc SeqType |stmts#0@@7| (TSeq Tclass.M0.Statement) $Heap@@11)) (and ($IsBox |st#0@@33| Tclass.M0.State) ($IsAllocBox |st#0@@33| Tclass.M0.State $Heap@@11))) (=> (and (and (and ($IsBox |env#0@@21| Tclass.M0.Env) ($IsAllocBox |env#0@@21| Tclass.M0.Env $Heap@@11)) (and ($Is DatatypeTypeType |expr'#0@@1| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |expr'#0@@1| Tclass.M0.Expression $Heap@@11))) (and (and ($IsBox |st'#0@@9| Tclass.M0.State) ($IsAllocBox |st'#0@@9| Tclass.M0.State $Heap@@11)) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 8) 5)))) anon0_correct)))))
