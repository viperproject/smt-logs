...
(assert (distinct TBool TagBool TagSet TagSeq TagMap alloc |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass.M3.Env Tagclass.M3.Identifier Tagclass.M3.Expression Tagclass.M3.Literal |##M3.Env.EnvCons| |##M3.Expression.exprLiteral| |##M3.Expression.exprIdentifier| |##M3.Expression.exprIf| |##M3.Expression.exprAnd| |##M3.Expression.exprOr| |##M3.Expression.exprInvocation| |##M3.Expression.exprError| Tagclass.M3.Reason |tytagFamily$_tuple#2| tytagFamily$Env tytagFamily$Identifier tytagFamily$Expression tytagFamily$Literal tytagFamily$Reason)
)
...
(declare-fun |id#2@0| () T@U)
(declare-fun |##expr#0@0| () T@U)
(declare-fun $Heap () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$M3.__default.ValidEnv)
...
(let ((anon10_Else_correct  (=> (and (not (|Set#IsMember| (|Map#Domain| (M3.Env.m |env#0@@1|)) ($Box DatatypeTypeType |id#2@0|))) (= (ControlFlow 0 6) 2)) anon6_correct)))
(let ((anon10_Then_correct  (=> (and (|Set#IsMember| (|Map#Domain| (M3.Env.m |env#0@@1|)) ($Box DatatypeTypeType |id#2@0|)) (M3.Env.EnvCons_q |env#0@@1|)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (|Set#IsMember| (|Map#Domain| (M3.Env.m |env#0@@1|)) ($Box DatatypeTypeType |id#2@0|))) (=> (|Set#IsMember| (|Map#Domain| (M3.Env.m |env#0@@1|)) ($Box DatatypeTypeType |id#2@0|)) (=> (and (and (= |##expr#0@0| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (M3.Env.m |env#0@@1|)) ($Box DatatypeTypeType |id#2@0|)))) ($IsAlloc DatatypeTypeType |##expr#0@0| Tclass.M3.Expression $Heap)) (and (|M3.__default.Value#canCall| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (M3.Env.m |env#0@@1|)) ($Box DatatypeTypeType |id#2@0|)))) (= (ControlFlow 0 4) 2))) anon6_correct))))))
(let ((anon9_Then_correct  (=> (and (and ($Is DatatypeTypeType |id#2@0| Tclass.M3.Identifier) ($IsAlloc DatatypeTypeType |id#2@0| Tclass.M3.Identifier $Heap)) (M3.Env.EnvCons_q |env#0@@1|)) (and (=> (= (ControlFlow 0 7) 4) anon10_Then_correct) (=> (= (ControlFlow 0 7) 6) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |id#2@0| Tclass.M3.Identifier) ($IsAlloc DatatypeTypeType |id#2@0| Tclass.M3.Identifier $Heap))) (= (ControlFlow 0 3) 2)) anon6_correct)))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#4| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 8) 1) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Then_correct)) (=> (= (ControlFlow 0 8) 3) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |env#0@@1| Tclass.M3.Env)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct)))
