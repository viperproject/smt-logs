...
(assert (forall ((d@@28 T@U) ) (! (= (_module.Reason.rCompatibility_q d@@28) (= (DatatypeCtorId d@@28) |##_module.Reason.rCompatibility|))
 :qid |unknown.0:0|
 :skolemid |1503|
 :pattern ( (_module.Reason.rCompatibility_q d@@28))
)))
(assert (forall ((d@@29 T@U) ) (! (= (_module.Reason.rValidity_q d@@29) (= (DatatypeCtorId d@@29) |##_module.Reason.rValidity|))
 :qid |unknown.0:0|
 :skolemid |1505|
 :pattern ( (_module.Reason.rValidity_q d@@29))
)))
(assert (forall ((d@@30 T@U) ) (! (= (_module.Reason.rInconsistentCache_q d@@30) (= (DatatypeCtorId d@@30) |##_module.Reason.rInconsistentCache|))
 :qid |unknown.0:0|
 :skolemid |1507|
 :pattern ( (_module.Reason.rInconsistentCache_q d@@30))
)))
(assert (forall ((d@@31 T@U) ) (! (= (_module.Tuple.Pair_q d@@31) (= (DatatypeCtorId d@@31) |##_module.Tuple.Pair|))
 :qid |unknown.0:0|
 :skolemid |1539|
 :pattern ( (_module.Tuple.Pair_q d@@31))
)))
(assert (forall ((d@@32 T@U) ) (! (= (_module.Triple.Trio_q d@@32) (= (DatatypeCtorId d@@32) |##_module.Triple.Trio|))
 :qid |unknown.0:0|
 :skolemid |1558|
...
(assert (forall ((d@@33 T@U) ) (!  (=> (_module.Expression.exprIf_q d@@33) (exists ((|a#38#0#0| T@U) (|a#38#1#0| T@U) (|a#38#2#0| T@U) ) (! (= d@@33 (|#_module.Expression.exprIf| |a#38#0#0| |a#38#1#0| |a#38#2#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.320:30|
 :skolemid |1345|
)))
 :qid |unknown.0:0|
 :skolemid |1346|
 :pattern ( (_module.Expression.exprIf_q d@@33))
)))
(assert (forall ((d@@34 T@U) ) (!  (=> (_module.Triple.Trio_q d@@34) (exists ((|a#170#0#0| T@U) (|a#170#1#0| T@U) (|a#170#2#0| T@U) ) (! (= d@@34 (|#_module.Triple.Trio| |a#170#0#0| |a#170#1#0| |a#170#2#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.345:33|
 :skolemid |1559|
)))
 :qid |unknown.0:0|
 :skolemid |1560|
 :pattern ( (_module.Triple.Trio_q d@@34))
)))
...
(assert (forall ((d@@35 T@U) ) (!  (=> (_module.StateC.S_q d@@35) (exists ((|a#1#0#0| T@U) (|a#1#1#0| T@U) ) (! (= d@@35 (|#_module.StateC.S| |a#1#0#0| |a#1#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.32:21|
 :skolemid |1271|
)))
 :qid |unknown.0:0|
 :skolemid |1272|
 :pattern ( (_module.StateC.S_q d@@35))
)))
(assert (forall ((d@@36 T@U) ) (!  (=> (_module.Statement.stmtVariable_q d@@36) (exists ((|a#14#0#0| T@U) (|a#14#1#0| T@U) ) (! (= d@@36 (|#_module.Statement.stmtVariable| |a#14#0#0| |a#14#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.316:35|
 :skolemid |1301|
)))
 :qid |unknown.0:0|
 :skolemid |1302|
 :pattern ( (_module.Statement.stmtVariable_q d@@36))
)))
(assert (forall ((d@@37 T@U) ) (!  (=> (_module.Expression.exprAnd_q d@@37) (exists ((|a#48#0#0| T@U) (|a#48#1#0| T@U) ) (! (= d@@37 (|#_module.Expression.exprAnd| |a#48#0#0| |a#48#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.321:31|
 :skolemid |1360|
)))
 :qid |unknown.0:0|
 :skolemid |1361|
 :pattern ( (_module.Expression.exprAnd_q d@@37))
)))
(assert (forall ((d@@38 T@U) ) (!  (=> (_module.Expression.exprOr_q d@@38) (exists ((|a#56#0#0| T@U) (|a#56#1#0| T@U) ) (! (= d@@38 (|#_module.Expression.exprOr| |a#56#0#0| |a#56#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.322:30|
 :skolemid |1372|
)))
 :qid |unknown.0:0|
 :skolemid |1373|
 :pattern ( (_module.Expression.exprOr_q d@@38))
)))
(assert (forall ((d@@39 T@U) ) (!  (=> (_module.Expression.exprInvocation_q d@@39) (exists ((|a#64#0#0| T@U) (|a#64#1#0| T@U) ) (! (= d@@39 (|#_module.Expression.exprInvocation| |a#64#0#0| |a#64#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.323:38|
 :skolemid |1384|
)))
 :qid |unknown.0:0|
 :skolemid |1385|
 :pattern ( (_module.Expression.exprInvocation_q d@@39))
)))
(assert (forall ((d@@40 T@U) ) (!  (=> (_module.Tuple.Pair_q d@@40) (exists ((|a#162#0#0| T@U) (|a#162#1#0| T@U) ) (! (= d@@40 (|#_module.Tuple.Pair| |a#162#0#0| |a#162#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.344:29|
 :skolemid |1540|
)))
 :qid |unknown.0:0|
 :skolemid |1541|
 :pattern ( (_module.Tuple.Pair_q d@@40))
)))
...
(assert (forall ((d@@41 T@U) ) (!  (=> (_module.Literal.litTrue_q d@@41) (= d@@41 |#_module.Literal.litTrue|))
 :qid |unknown.0:0|
 :skolemid |1417|
 :pattern ( (_module.Literal.litTrue_q d@@41))
)))
(assert (forall ((d@@42 T@U) ) (!  (=> (_module.Literal.litFalse_q d@@42) (= d@@42 |#_module.Literal.litFalse|))
 :qid |unknown.0:0|
 :skolemid |1419|
 :pattern ( (_module.Literal.litFalse_q d@@42))
)))
(assert (forall ((d@@43 T@U) ) (!  (=> (_module.Literal.litUndefined_q d@@43) (= d@@43 |#_module.Literal.litUndefined|))
 :qid |unknown.0:0|
 :skolemid |1421|
 :pattern ( (_module.Literal.litUndefined_q d@@43))
)))
(assert (forall ((d@@44 T@U) ) (!  (=> (_module.Literal.litNull_q d@@44) (= d@@44 |#_module.Literal.litNull|))
 :qid |unknown.0:0|
 :skolemid |1423|
 :pattern ( (_module.Literal.litNull_q d@@44))
)))
(assert (forall ((d@@45 T@U) ) (!  (=> (_module.Primitive.primCreatePath_q d@@45) (= d@@45 |#_module.Primitive.primCreatePath|))
 :qid |unknown.0:0|
 :skolemid |1494|
 :pattern ( (_module.Primitive.primCreatePath_q d@@45))
)))
(assert (forall ((d@@46 T@U) ) (!  (=> (_module.Primitive.primExec_q d@@46) (= d@@46 |#_module.Primitive.primExec|))
 :qid |unknown.0:0|
 :skolemid |1496|
 :pattern ( (_module.Primitive.primExec_q d@@46))
)))
(assert (forall ((d@@47 T@U) ) (!  (=> (_module.Reason.rCompatibility_q d@@47) (= d@@47 |#_module.Reason.rCompatibility|))
 :qid |unknown.0:0|
 :skolemid |1504|
 :pattern ( (_module.Reason.rCompatibility_q d@@47))
)))
(assert (forall ((d@@48 T@U) ) (!  (=> (_module.Reason.rValidity_q d@@48) (= d@@48 |#_module.Reason.rValidity|))
 :qid |unknown.0:0|
 :skolemid |1506|
 :pattern ( (_module.Reason.rValidity_q d@@48))
)))
(assert (forall ((d@@49 T@U) ) (!  (=> (_module.Reason.rInconsistentCache_q d@@49) (= d@@49 |#_module.Reason.rInconsistentCache|))
 :qid |unknown.0:0|
 :skolemid |1508|
 :pattern ( (_module.Reason.rInconsistentCache_q d@@49))
)))
...
(assert (forall ((d@@51 T@U) ) (!  (=> (_module.Program.Program_q d@@51) (exists ((|a#7#0#0| T@U) ) (! (= d@@51 (|#_module.Program.Program| |a#7#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.314:28|
 :skolemid |1286|
)))
 :qid |unknown.0:0|
 :skolemid |1287|
 :pattern ( (_module.Program.Program_q d@@51))
)))
(assert (forall ((d@@52 T@U) ) (!  (=> (_module.Statement.stmtReturn_q d@@52) (exists ((|a#21#0#0| T@U) ) (! (= d@@52 (|#_module.Statement.stmtReturn| |a#21#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.317:33|
 :skolemid |1312|
)))
 :qid |unknown.0:0|
 :skolemid |1313|
 :pattern ( (_module.Statement.stmtReturn_q d@@52))
)))
(assert (forall ((d@@53 T@U) ) (!  (=> (_module.Expression.exprLiteral_q d@@53) (exists ((|a#27#0#0| T@U) ) (! (= d@@53 (|#_module.Expression.exprLiteral| |a#27#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.319:35|
 :skolemid |1327|
)))
 :qid |unknown.0:0|
 :skolemid |1328|
 :pattern ( (_module.Expression.exprLiteral_q d@@53))
)))
(assert (forall ((d@@54 T@U) ) (!  (=> (_module.Expression.exprIdentifier_q d@@54) (exists ((|a#33#0#0| T@U) ) (! (= d@@54 (|#_module.Expression.exprIdentifier| |a#33#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.319:66|
 :skolemid |1337|
)))
 :qid |unknown.0:0|
 :skolemid |1338|
 :pattern ( (_module.Expression.exprIdentifier_q d@@54))
)))
(assert (forall ((d@@55 T@U) ) (!  (=> (_module.Expression.exprError_q d@@55) (exists ((|a#73#0#0| T@U) ) (! (= d@@55 (|#_module.Expression.exprError| |a#73#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.324:33|
 :skolemid |1397|
)))
 :qid |unknown.0:0|
 :skolemid |1398|
 :pattern ( (_module.Expression.exprError_q d@@55))
)))
(assert (forall ((d@@56 T@U) ) (!  (=> (_module.Literal.litNumber_q d@@56) (exists ((|a#95#0#0| Int) ) (! (= d@@56 (|#_module.Literal.litNumber| |a#95#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.327:30|
 :skolemid |1426|
)))
 :qid |unknown.0:0|
 :skolemid |1427|
 :pattern ( (_module.Literal.litNumber_q d@@56))
)))
(assert (forall ((d@@57 T@U) ) (!  (=> (_module.Literal.litString_q d@@57) (exists ((|a#100#0#0| T@U) ) (! (= d@@57 (|#_module.Literal.litString| |a#100#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.327:52|
 :skolemid |1434|
)))
 :qid |unknown.0:0|
 :skolemid |1435|
 :pattern ( (_module.Literal.litString_q d@@57))
)))
(assert (forall ((d@@58 T@U) ) (!  (=> (_module.Literal.litPrimitive_q d@@58) (exists ((|a#107#0#0| T@U) ) (! (= d@@58 (|#_module.Literal.litPrimitive| |a#107#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.328:33|
 :skolemid |1444|
)))
 :qid |unknown.0:0|
 :skolemid |1445|
 :pattern ( (_module.Literal.litPrimitive_q d@@58))
)))
(assert (forall ((d@@59 T@U) ) (!  (=> (_module.Literal.litArrOfPaths_q d@@59) (exists ((|a#113#0#0| T@U) ) (! (= d@@59 (|#_module.Literal.litArrOfPaths| |a#113#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.329:34|
 :skolemid |1453|
)))
 :qid |unknown.0:0|
 :skolemid |1454|
 :pattern ( (_module.Literal.litArrOfPaths_q d@@59))
)))
(assert (forall ((d@@60 T@U) ) (!  (=> (_module.Literal.litArrOfStrings_q d@@60) (exists ((|a#119#0#0| T@U) ) (! (= d@@60 (|#_module.Literal.litArrOfStrings| |a#119#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.330:36|
 :skolemid |1462|
)))
 :qid |unknown.0:0|
 :skolemid |1463|
 :pattern ( (_module.Literal.litArrOfStrings_q d@@60))
)))
(assert (forall ((d@@61 T@U) ) (!  (=> (_module.Literal.litArray_q d@@61) (exists ((|a#125#0#0| T@U) ) (! (= d@@61 (|#_module.Literal.litArray| |a#125#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.331:29|
 :skolemid |1471|
)))
 :qid |unknown.0:0|
 :skolemid |1472|
 :pattern ( (_module.Literal.litArray_q d@@61))
)))
(assert (forall ((d@@62 T@U) ) (!  (=> ($Is DatatypeTypeType d@@62 Tclass._module.Expression) (or (or (or (or (or (or (_module.Expression.exprLiteral_q d@@62) (_module.Expression.exprIdentifier_q d@@62)) (_module.Expression.exprIf_q d@@62)) (_module.Expression.exprAnd_q d@@62)) (_module.Expression.exprOr_q d@@62)) (_module.Expression.exprInvocation_q d@@62)) (_module.Expression.exprError_q d@@62)))
 :qid |unknown.0:0|
 :skolemid |1407|
 :pattern ( (_module.Expression.exprError_q d@@62) ($Is DatatypeTypeType d@@62 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprInvocation_q d@@62) ($Is DatatypeTypeType d@@62 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprOr_q d@@62) ($Is DatatypeTypeType d@@62 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprAnd_q d@@62) ($Is DatatypeTypeType d@@62 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprIf_q d@@62) ($Is DatatypeTypeType d@@62 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprIdentifier_q d@@62) ($Is DatatypeTypeType d@@62 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprLiteral_q d@@62) ($Is DatatypeTypeType d@@62 Tclass._module.Expression))
)))
...
(assert (forall ((d@@63 T@U) ) (!  (=> ($Is DatatypeTypeType d@@63 Tclass._module.Literal) (or (or (or (or (or (or (or (or (or (_module.Literal.litTrue_q d@@63) (_module.Literal.litFalse_q d@@63)) (_module.Literal.litUndefined_q d@@63)) (_module.Literal.litNull_q d@@63)) (_module.Literal.litNumber_q d@@63)) (_module.Literal.litString_q d@@63)) (_module.Literal.litPrimitive_q d@@63)) (_module.Literal.litArrOfPaths_q d@@63)) (_module.Literal.litArrOfStrings_q d@@63)) (_module.Literal.litArray_q d@@63)))
 :qid |unknown.0:0|
 :skolemid |1481|
 :pattern ( (_module.Literal.litArray_q d@@63) ($Is DatatypeTypeType d@@63 Tclass._module.Literal))
 :pattern ( (_module.Literal.litArrOfStrings_q d@@63) ($Is DatatypeTypeType d@@63 Tclass._module.Literal))
 :pattern ( (_module.Literal.litArrOfPaths_q d@@63) ($Is DatatypeTypeType d@@63 Tclass._module.Literal))
 :pattern ( (_module.Literal.litPrimitive_q d@@63) ($Is DatatypeTypeType d@@63 Tclass._module.Literal))
 :pattern ( (_module.Literal.litString_q d@@63) ($Is DatatypeTypeType d@@63 Tclass._module.Literal))
 :pattern ( (_module.Literal.litNumber_q d@@63) ($Is DatatypeTypeType d@@63 Tclass._module.Literal))
 :pattern ( (_module.Literal.litNull_q d@@63) ($Is DatatypeTypeType d@@63 Tclass._module.Literal))
 :pattern ( (_module.Literal.litUndefined_q d@@63) ($Is DatatypeTypeType d@@63 Tclass._module.Literal))
 :pattern ( (_module.Literal.litFalse_q d@@63) ($Is DatatypeTypeType d@@63 Tclass._module.Literal))
 :pattern ( (_module.Literal.litTrue_q d@@63) ($Is DatatypeTypeType d@@63 Tclass._module.Literal))
)))
...
(assert (forall ((_module.Triple$A@@5 T@U) (_module.Triple$B@@5 T@U) (_module.Triple$C@@5 T@U) (d@@64 T@U) ) (!  (=> ($Is DatatypeTypeType d@@64 (Tclass._module.Triple _module.Triple$A@@5 _module.Triple$B@@5 _module.Triple$C@@5)) (_module.Triple.Trio_q d@@64))
 :qid |unknown.0:0|
 :skolemid |1577|
 :pattern ( (_module.Triple.Trio_q d@@64) ($Is DatatypeTypeType d@@64 (Tclass._module.Triple _module.Triple$A@@5 _module.Triple$B@@5 _module.Triple$C@@5)))
)))
...
(assert (forall ((d@@65 T@U) ) (!  (=> ($Is DatatypeTypeType d@@65 Tclass._module.Statement) (or (_module.Statement.stmtVariable_q d@@65) (_module.Statement.stmtReturn_q d@@65)))
 :qid |unknown.0:0|
 :skolemid |1321|
 :pattern ( (_module.Statement.stmtReturn_q d@@65) ($Is DatatypeTypeType d@@65 Tclass._module.Statement))
 :pattern ( (_module.Statement.stmtVariable_q d@@65) ($Is DatatypeTypeType d@@65 Tclass._module.Statement))
)))
(assert (forall ((d@@66 T@U) ) (!  (=> ($Is DatatypeTypeType d@@66 Tclass._module.Primitive) (or (_module.Primitive.primCreatePath_q d@@66) (_module.Primitive.primExec_q d@@66)))
 :qid |unknown.0:0|
 :skolemid |1499|
 :pattern ( (_module.Primitive.primExec_q d@@66) ($Is DatatypeTypeType d@@66 Tclass._module.Primitive))
 :pattern ( (_module.Primitive.primCreatePath_q d@@66) ($Is DatatypeTypeType d@@66 Tclass._module.Primitive))
)))
...
(assert (forall ((d@@67 T@U) ) (!  (=> (|$IsA#_module.Reason| d@@67) (or (or (_module.Reason.rCompatibility_q d@@67) (_module.Reason.rValidity_q d@@67)) (_module.Reason.rInconsistentCache_q d@@67)))
 :qid |unknown.0:0|
 :skolemid |1510|
 :pattern ( (|$IsA#_module.Reason| d@@67))
)))
...
(assert (forall ((d@@68 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.Literal.litNumber_q d@@68) ($IsAlloc DatatypeTypeType d@@68 Tclass._module.Literal $h@@1))) ($IsAlloc intType (int_2_U (_module.Literal.num d@@68)) TInt $h@@1))
 :qid |unknown.0:0|
 :skolemid |1429|
 :pattern ( ($IsAlloc intType (int_2_U (_module.Literal.num d@@68)) TInt $h@@1))
)))
...
(assert (forall ((d@@69 T@U) ) (!  (=> ($Is DatatypeTypeType d@@69 Tclass._module.Reason) (or (or (_module.Reason.rCompatibility_q d@@69) (_module.Reason.rValidity_q d@@69)) (_module.Reason.rInconsistentCache_q d@@69)))
 :qid |unknown.0:0|
 :skolemid |1511|
 :pattern ( (_module.Reason.rInconsistentCache_q d@@69) ($Is DatatypeTypeType d@@69 Tclass._module.Reason))
 :pattern ( (_module.Reason.rValidity_q d@@69) ($Is DatatypeTypeType d@@69 Tclass._module.Reason))
 :pattern ( (_module.Reason.rCompatibility_q d@@69) ($Is DatatypeTypeType d@@69 Tclass._module.Reason))
)))
...
(assert (forall ((d@@70 T@U) ) (! (= (BoxRank ($Box DatatypeTypeType d@@70)) (DtRank d@@70))
 :qid |DafnyPreludebpl.391:15|
 :skolemid |84|
 :pattern ( (BoxRank ($Box DatatypeTypeType d@@70)))
)))
...
(assert (forall ((d@@71 T@U) (_module.Triple$A@@7 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (_module.Triple.Trio_q d@@71) (exists ((_module.Triple$B@@7 T@U) (_module.Triple$C@@7 T@U) ) (! ($IsAlloc DatatypeTypeType d@@71 (Tclass._module.Triple _module.Triple$A@@7 _module.Triple$B@@7 _module.Triple$C@@7) $h@@2)
 :qid |unknown.0:0|
 :skolemid |1563|
 :pattern ( ($IsAlloc DatatypeTypeType d@@71 (Tclass._module.Triple _module.Triple$A@@7 _module.Triple$B@@7 _module.Triple$C@@7) $h@@2))
)))) ($IsAllocBox (_module.Triple.fst d@@71) _module.Triple$A@@7 $h@@2))
 :qid |unknown.0:0|
 :skolemid |1564|
 :pattern ( ($IsAllocBox (_module.Triple.fst d@@71) _module.Triple$A@@7 $h@@2))
)))
(assert (forall ((d@@72 T@U) (_module.Triple$B@@8 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (_module.Triple.Trio_q d@@72) (exists ((_module.Triple$A@@8 T@U) (_module.Triple$C@@8 T@U) ) (! ($IsAlloc DatatypeTypeType d@@72 (Tclass._module.Triple _module.Triple$A@@8 _module.Triple$B@@8 _module.Triple$C@@8) $h@@3)
 :qid |unknown.0:0|
 :skolemid |1565|
 :pattern ( ($IsAlloc DatatypeTypeType d@@72 (Tclass._module.Triple _module.Triple$A@@8 _module.Triple$B@@8 _module.Triple$C@@8) $h@@3))
)))) ($IsAllocBox (_module.Triple.snd d@@72) _module.Triple$B@@8 $h@@3))
 :qid |unknown.0:0|
 :skolemid |1566|
 :pattern ( ($IsAllocBox (_module.Triple.snd d@@72) _module.Triple$B@@8 $h@@3))
)))
(assert (forall ((d@@73 T@U) (_module.Triple$C@@9 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (_module.Triple.Trio_q d@@73) (exists ((_module.Triple$A@@9 T@U) (_module.Triple$B@@9 T@U) ) (! ($IsAlloc DatatypeTypeType d@@73 (Tclass._module.Triple _module.Triple$A@@9 _module.Triple$B@@9 _module.Triple$C@@9) $h@@4)
 :qid |unknown.0:0|
 :skolemid |1567|
 :pattern ( ($IsAlloc DatatypeTypeType d@@73 (Tclass._module.Triple _module.Triple$A@@9 _module.Triple$B@@9 _module.Triple$C@@9) $h@@4))
)))) ($IsAllocBox (_module.Triple.trd d@@73) _module.Triple$C@@9 $h@@4))
 :qid |unknown.0:0|
 :skolemid |1568|
 :pattern ( ($IsAllocBox (_module.Triple.trd d@@73) _module.Triple$C@@9 $h@@4))
)))
(assert (forall ((d@@74 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) ($Is DatatypeTypeType d@@74 Tclass._module.StateC)) ($IsAlloc DatatypeTypeType d@@74 Tclass._module.StateC $h@@5))
 :qid |unknown.0:0|
 :skolemid |1279|
 :pattern ( ($IsAlloc DatatypeTypeType d@@74 Tclass._module.StateC $h@@5))
)))
(assert (forall ((d@@75 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) ($Is DatatypeTypeType d@@75 Tclass._module.Program)) ($IsAlloc DatatypeTypeType d@@75 Tclass._module.Program $h@@6))
 :qid |unknown.0:0|
 :skolemid |1294|
 :pattern ( ($IsAlloc DatatypeTypeType d@@75 Tclass._module.Program $h@@6))
)))
(assert (forall ((d@@76 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) ($Is DatatypeTypeType d@@76 Tclass._module.Statement)) ($IsAlloc DatatypeTypeType d@@76 Tclass._module.Statement $h@@7))
 :qid |unknown.0:0|
 :skolemid |1319|
 :pattern ( ($IsAlloc DatatypeTypeType d@@76 Tclass._module.Statement $h@@7))
)))
(assert (forall ((d@@77 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) ($Is DatatypeTypeType d@@77 Tclass._module.Expression)) ($IsAlloc DatatypeTypeType d@@77 Tclass._module.Expression $h@@8))
 :qid |unknown.0:0|
 :skolemid |1405|
 :pattern ( ($IsAlloc DatatypeTypeType d@@77 Tclass._module.Expression $h@@8))
)))
(assert (forall ((d@@78 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) ($Is DatatypeTypeType d@@78 Tclass._module.Literal)) ($IsAlloc DatatypeTypeType d@@78 Tclass._module.Literal $h@@9))
 :qid |unknown.0:0|
 :skolemid |1479|
 :pattern ( ($IsAlloc DatatypeTypeType d@@78 Tclass._module.Literal $h@@9))
)))
(assert (forall ((d@@79 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) ($Is DatatypeTypeType d@@79 Tclass._module.Primitive)) ($IsAlloc DatatypeTypeType d@@79 Tclass._module.Primitive $h@@10))
 :qid |unknown.0:0|
 :skolemid |1497|
 :pattern ( ($IsAlloc DatatypeTypeType d@@79 Tclass._module.Primitive $h@@10))
)))
(assert (forall ((d@@80 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) ($Is DatatypeTypeType d@@80 Tclass._module.Reason)) ($IsAlloc DatatypeTypeType d@@80 Tclass._module.Reason $h@@11))
 :qid |unknown.0:0|
 :skolemid |1509|
 :pattern ( ($IsAlloc DatatypeTypeType d@@80 Tclass._module.Reason $h@@11))
)))
(assert (forall ((d@@81 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) ($Is DatatypeTypeType d@@81 Tclass._module.Path)) ($IsAlloc DatatypeTypeType d@@81 Tclass._module.Path $h@@12))
 :qid |unknown.0:0|
 :skolemid |1532|
 :pattern ( ($IsAlloc DatatypeTypeType d@@81 Tclass._module.Path $h@@12))
)))
...
(assert (forall ((d@@82 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (_module.Literal.litString_q d@@82) ($IsAlloc DatatypeTypeType d@@82 Tclass._module.Literal $h@@13))) ($IsAlloc SeqType (_module.Literal.str d@@82) (TSeq TChar) $h@@13))
 :qid |unknown.0:0|
 :skolemid |1437|
 :pattern ( ($IsAlloc SeqType (_module.Literal.str d@@82) (TSeq TChar) $h@@13))
)))
(assert (forall ((|a#117#0#0| T@U) (d@@83 T@U) ) (!  (=> (|Set#IsMember| |a#117#0#0| ($Box DatatypeTypeType d@@83)) (< (DtRank d@@83) (DtRank (|#_module.Literal.litArrOfPaths| |a#117#0#0|))))
 :qid |CloudMakeConsistentBuildslegacydfy.329:34|
 :skolemid |1459|
 :pattern ( (|Set#IsMember| |a#117#0#0| ($Box DatatypeTypeType d@@83)) (|#_module.Literal.litArrOfPaths| |a#117#0#0|))
)))
(assert (forall ((|a#123#0#0| T@U) (d@@84 T@U) ) (!  (=> (|Set#IsMember| |a#123#0#0| ($Box DatatypeTypeType d@@84)) (< (DtRank d@@84) (DtRank (|#_module.Literal.litArrOfStrings| |a#123#0#0|))))
 :qid |CloudMakeConsistentBuildslegacydfy.330:36|
 :skolemid |1468|
 :pattern ( (|Set#IsMember| |a#123#0#0| ($Box DatatypeTypeType d@@84)) (|#_module.Literal.litArrOfStrings| |a#123#0#0|))
)))
...
(assert (forall ((d@@85 T@U) (_module.Tuple$A@@6 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (_module.Tuple.Pair_q d@@85) (exists ((_module.Tuple$B@@6 T@U) ) (! ($IsAlloc DatatypeTypeType d@@85 (Tclass._module.Tuple _module.Tuple$A@@6 _module.Tuple$B@@6) $h@@14)
 :qid |unknown.0:0|
 :skolemid |1544|
 :pattern ( ($IsAlloc DatatypeTypeType d@@85 (Tclass._module.Tuple _module.Tuple$A@@6 _module.Tuple$B@@6) $h@@14))
)))) ($IsAllocBox (_module.Tuple.fst d@@85) _module.Tuple$A@@6 $h@@14))
 :qid |unknown.0:0|
 :skolemid |1545|
 :pattern ( ($IsAllocBox (_module.Tuple.fst d@@85) _module.Tuple$A@@6 $h@@14))
)))
(assert (forall ((d@@86 T@U) (_module.Tuple$B@@7 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (_module.Tuple.Pair_q d@@86) (exists ((_module.Tuple$A@@7 T@U) ) (! ($IsAlloc DatatypeTypeType d@@86 (Tclass._module.Tuple _module.Tuple$A@@7 _module.Tuple$B@@7) $h@@15)
 :qid |unknown.0:0|
 :skolemid |1546|
 :pattern ( ($IsAlloc DatatypeTypeType d@@86 (Tclass._module.Tuple _module.Tuple$A@@7 _module.Tuple$B@@7) $h@@15))
)))) ($IsAllocBox (_module.Tuple.snd d@@86) _module.Tuple$B@@7 $h@@15))
 :qid |unknown.0:0|
 :skolemid |1547|
 :pattern ( ($IsAllocBox (_module.Tuple.snd d@@86) _module.Tuple$B@@7 $h@@15))
)))
...
(assert (forall ((d@@87 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (_module.StateC.S_q d@@87) ($IsAlloc DatatypeTypeType d@@87 Tclass._module.StateC $h@@16))) ($IsAllocBox (_module.StateC.st d@@87) Tclass._module.State $h@@16))
 :qid |unknown.0:0|
 :skolemid |1274|
 :pattern ( ($IsAllocBox (_module.StateC.st d@@87) Tclass._module.State $h@@16))
)))
(assert (forall ((d@@88 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (_module.StateC.S_q d@@88) ($IsAlloc DatatypeTypeType d@@88 Tclass._module.StateC $h@@17))) ($IsAllocBox (_module.StateC.c d@@88) Tclass._module.Cache $h@@17))
 :qid |unknown.0:0|
 :skolemid |1275|
 :pattern ( ($IsAllocBox (_module.StateC.c d@@88) Tclass._module.Cache $h@@17))
)))
(assert (forall ((d@@89 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (_module.Statement.stmtVariable_q d@@89) ($IsAlloc DatatypeTypeType d@@89 Tclass._module.Statement $h@@18))) ($IsAllocBox (_module.Statement.id d@@89) Tclass._module.Identifier $h@@18))
 :qid |unknown.0:0|
 :skolemid |1304|
 :pattern ( ($IsAllocBox (_module.Statement.id d@@89) Tclass._module.Identifier $h@@18))
)))
(assert (forall ((d@@90 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (_module.Statement.stmtVariable_q d@@90) ($IsAlloc DatatypeTypeType d@@90 Tclass._module.Statement $h@@19))) ($IsAlloc DatatypeTypeType (_module.Statement.expr d@@90) Tclass._module.Expression $h@@19))
 :qid |unknown.0:0|
 :skolemid |1305|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Statement.expr d@@90) Tclass._module.Expression $h@@19))
)))
(assert (forall ((d@@91 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (_module.Statement.stmtReturn_q d@@91) ($IsAlloc DatatypeTypeType d@@91 Tclass._module.Statement $h@@20))) ($IsAlloc DatatypeTypeType (_module.Statement.ret d@@91) Tclass._module.Expression $h@@20))
 :qid |unknown.0:0|
 :skolemid |1315|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Statement.ret d@@91) Tclass._module.Expression $h@@20))
)))
(assert (forall ((d@@92 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (_module.Expression.exprLiteral_q d@@92) ($IsAlloc DatatypeTypeType d@@92 Tclass._module.Expression $h@@21))) ($IsAlloc DatatypeTypeType (_module.Expression.lit d@@92) Tclass._module.Literal $h@@21))
 :qid |unknown.0:0|
 :skolemid |1331|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.lit d@@92) Tclass._module.Literal $h@@21))
)))
(assert (forall ((d@@93 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (_module.Expression.exprIdentifier_q d@@93) ($IsAlloc DatatypeTypeType d@@93 Tclass._module.Expression $h@@22))) ($IsAllocBox (_module.Expression.id d@@93) Tclass._module.Identifier $h@@22))
 :qid |unknown.0:0|
 :skolemid |1340|
 :pattern ( ($IsAllocBox (_module.Expression.id d@@93) Tclass._module.Identifier $h@@22))
)))
(assert (forall ((d@@94 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (_module.Expression.exprIf_q d@@94) ($IsAlloc DatatypeTypeType d@@94 Tclass._module.Expression $h@@23))) ($IsAlloc DatatypeTypeType (_module.Expression.cond d@@94) Tclass._module.Expression $h@@23))
 :qid |unknown.0:0|
 :skolemid |1348|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.cond d@@94) Tclass._module.Expression $h@@23))
)))
(assert (forall ((d@@95 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (_module.Expression.exprIf_q d@@95) ($IsAlloc DatatypeTypeType d@@95 Tclass._module.Expression $h@@24))) ($IsAlloc DatatypeTypeType (_module.Expression.ifTrue d@@95) Tclass._module.Expression $h@@24))
 :qid |unknown.0:0|
 :skolemid |1349|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.ifTrue d@@95) Tclass._module.Expression $h@@24))
)))
(assert (forall ((d@@96 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (_module.Expression.exprIf_q d@@96) ($IsAlloc DatatypeTypeType d@@96 Tclass._module.Expression $h@@25))) ($IsAlloc DatatypeTypeType (_module.Expression.ifFalse d@@96) Tclass._module.Expression $h@@25))
 :qid |unknown.0:0|
 :skolemid |1350|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.ifFalse d@@96) Tclass._module.Expression $h@@25))
)))
(assert (forall ((d@@97 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (_module.Expression.exprAnd_q d@@97) ($IsAlloc DatatypeTypeType d@@97 Tclass._module.Expression $h@@26))) ($IsAlloc DatatypeTypeType (_module.Expression.conj0 d@@97) Tclass._module.Expression $h@@26))
 :qid |unknown.0:0|
 :skolemid |1363|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.conj0 d@@97) Tclass._module.Expression $h@@26))
)))
(assert (forall ((d@@98 T@U) ($h@@27 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (_module.Expression.exprAnd_q d@@98) ($IsAlloc DatatypeTypeType d@@98 Tclass._module.Expression $h@@27))) ($IsAlloc DatatypeTypeType (_module.Expression.conj1 d@@98) Tclass._module.Expression $h@@27))
 :qid |unknown.0:0|
 :skolemid |1364|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.conj1 d@@98) Tclass._module.Expression $h@@27))
)))
(assert (forall ((d@@99 T@U) ($h@@28 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (_module.Expression.exprOr_q d@@99) ($IsAlloc DatatypeTypeType d@@99 Tclass._module.Expression $h@@28))) ($IsAlloc DatatypeTypeType (_module.Expression.disj0 d@@99) Tclass._module.Expression $h@@28))
 :qid |unknown.0:0|
 :skolemid |1375|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.disj0 d@@99) Tclass._module.Expression $h@@28))
)))
(assert (forall ((d@@100 T@U) ($h@@29 T@U) ) (!  (=> (and ($IsGoodHeap $h@@29) (and (_module.Expression.exprOr_q d@@100) ($IsAlloc DatatypeTypeType d@@100 Tclass._module.Expression $h@@29))) ($IsAlloc DatatypeTypeType (_module.Expression.disj1 d@@100) Tclass._module.Expression $h@@29))
 :qid |unknown.0:0|
 :skolemid |1376|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.disj1 d@@100) Tclass._module.Expression $h@@29))
)))
(assert (forall ((d@@101 T@U) ($h@@30 T@U) ) (!  (=> (and ($IsGoodHeap $h@@30) (and (_module.Expression.exprInvocation_q d@@101) ($IsAlloc DatatypeTypeType d@@101 Tclass._module.Expression $h@@30))) ($IsAlloc DatatypeTypeType (_module.Expression.fun d@@101) Tclass._module.Expression $h@@30))
 :qid |unknown.0:0|
 :skolemid |1387|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.fun d@@101) Tclass._module.Expression $h@@30))
)))
(assert (forall ((d@@102 T@U) ($h@@31 T@U) ) (!  (=> (and ($IsGoodHeap $h@@31) (and (_module.Expression.exprError_q d@@102) ($IsAlloc DatatypeTypeType d@@102 Tclass._module.Expression $h@@31))) ($IsAlloc DatatypeTypeType (_module.Expression.r d@@102) Tclass._module.Reason $h@@31))
 :qid |unknown.0:0|
 :skolemid |1401|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.r d@@102) Tclass._module.Reason $h@@31))
)))
(assert (forall ((d@@103 T@U) ($h@@32 T@U) ) (!  (=> (and ($IsGoodHeap $h@@32) (and (_module.Literal.litPrimitive_q d@@103) ($IsAlloc DatatypeTypeType d@@103 Tclass._module.Literal $h@@32))) ($IsAlloc DatatypeTypeType (_module.Literal.prim d@@103) Tclass._module.Primitive $h@@32))
 :qid |unknown.0:0|
 :skolemid |1447|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Literal.prim d@@103) Tclass._module.Primitive $h@@32))
)))
...
(assert (forall ((d@@104 T@U) ($h@@33 T@U) ) (!  (=> (and ($IsGoodHeap $h@@33) (and (_module.Literal.litArrOfStrings_q d@@104) ($IsAlloc DatatypeTypeType d@@104 Tclass._module.Literal $h@@33))) ($IsAlloc SetType (_module.Literal.strs d@@104) (TSet (TSeq TChar)) $h@@33))
 :qid |unknown.0:0|
 :skolemid |1465|
 :pattern ( ($IsAlloc SetType (_module.Literal.strs d@@104) (TSet (TSeq TChar)) $h@@33))
)))
...
(assert (forall ((d@@105 T@U) ($h@@34 T@U) ) (!  (=> (and ($IsGoodHeap $h@@34) (and (_module.Program.Program_q d@@105) ($IsAlloc DatatypeTypeType d@@105 Tclass._module.Program $h@@34))) ($IsAlloc SeqType (_module.Program.stmts d@@105) (TSeq Tclass._module.Statement) $h@@34))
 :qid |unknown.0:0|
 :skolemid |1289|
 :pattern ( ($IsAlloc SeqType (_module.Program.stmts d@@105) (TSeq Tclass._module.Statement) $h@@34))
)))
(assert (forall ((d@@106 T@U) ($h@@35 T@U) ) (!  (=> (and ($IsGoodHeap $h@@35) (and (_module.Expression.exprInvocation_q d@@106) ($IsAlloc DatatypeTypeType d@@106 Tclass._module.Expression $h@@35))) ($IsAlloc SeqType (_module.Expression.args d@@106) (TSeq Tclass._module.Expression) $h@@35))
 :qid |unknown.0:0|
 :skolemid |1388|
 :pattern ( ($IsAlloc SeqType (_module.Expression.args d@@106) (TSeq Tclass._module.Expression) $h@@35))
)))
(assert (forall ((d@@107 T@U) ($h@@36 T@U) ) (!  (=> (and ($IsGoodHeap $h@@36) (and (_module.Literal.litArrOfPaths_q d@@107) ($IsAlloc DatatypeTypeType d@@107 Tclass._module.Literal $h@@36))) ($IsAlloc SetType (_module.Literal.paths d@@107) (TSet Tclass._module.Path) $h@@36))
 :qid |unknown.0:0|
 :skolemid |1456|
 :pattern ( ($IsAlloc SetType (_module.Literal.paths d@@107) (TSet Tclass._module.Path) $h@@36))
)))
(assert (forall ((d@@108 T@U) ($h@@37 T@U) ) (!  (=> (and ($IsGoodHeap $h@@37) (and (_module.Literal.litArray_q d@@108) ($IsAlloc DatatypeTypeType d@@108 Tclass._module.Literal $h@@37))) ($IsAlloc SeqType (_module.Literal.arr d@@108) (TSeq Tclass._module.Expression) $h@@37))
 :qid |unknown.0:0|
 :skolemid |1474|
 :pattern ( ($IsAlloc SeqType (_module.Literal.arr d@@108) (TSeq Tclass._module.Expression) $h@@37))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.BuildCLemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@3 alloc false)) (=> (and (_module.Program.Program_q |prog#0@@2|) (_module.Program.Program_q |prog#0@@2|)) (=> (and (and (= |stmts##0@0| (_module.Program.stmts |prog#0@@2|)) |_module.__default.EmptyEnv#canCall|) (and |_module.__default.EmptyEnv#canCall| (= |env##0@0| _module.__default.EmptyEnv))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.__default.Legal#canCall| |stmts##0@0|) (or (_module.__default.Legal |stmts##0@0|) (or (not (= (|Seq#Length| |stmts##0@0|) 0)) (not true))))) (=> (=> (|_module.__default.Legal#canCall| |stmts##0@0|) (or (_module.__default.Legal |stmts##0@0|) (or (not (= (|Seq#Length| |stmts##0@0|) 0)) (not true)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.__default.ConsistentCache#canCall| |stC#0@@40|) (or (_module.__default.ConsistentCache |stC#0@@40|) (forall ((|cmd#0@@19| T@U) (|deps#0@@18| T@U) (|e#0@@10| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#0@@19| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@18| Tclass._module.Expression)) ($Is SeqType |e#0@@10| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@40|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@19| |deps#0@@18| |e#0@@10|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@40|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0@@19| |deps#0@@18| |e#0@@10|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1188|
 :pattern ( (_module.__default.Loc |cmd#0@@19| |deps#0@@18| |e#0@@10|))
))))) (=> (=> (|_module.__default.ConsistentCache#canCall| |stC#0@@40|) (or (_module.__default.ConsistentCache |stC#0@@40|) (forall ((|cmd#0@@20| T@U) (|deps#0@@19| T@U) (|e#0@@11| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#0@@20| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@19| Tclass._module.Expression)) ($Is SeqType |e#0@@11| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@40|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@20| |deps#0@@19| |e#0@@11|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@40|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0@@20| |deps#0@@19| |e#0@@11|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1188|
 :pattern ( (_module.__default.Loc |cmd#0@@20| |deps#0@@19| |e#0@@11|))
)))) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (|_module.__default.doC#canCall| |stmts##0@0| |stC#0@@40| |env##0@0|) (let ((|result#0@@8| (_module.__default.doC ($LS $LZ) |stmts##0@0| |stC#0@@40| |env##0@0|)))
 (and (and (_module.Tuple.Pair_q |result#0@@8|) (_module.Tuple.Pair_q |result#0@@8|)) (let ((|stC'#0@@10| ($Unbox DatatypeTypeType (_module.Tuple.snd |result#0@@8|))))
(let ((|expr'#0@@2| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#0@@8|))))
 (and (|_module.__default.ConsistentCache#canCall| |stC'#0@@10|) (=> (_module.__default.ConsistentCache |stC'#0@@10|) (=> (_module.Expression.exprError_q |expr'#0@@2|) (|$IsA#_module.Reason| (_module.Expression.r |expr'#0@@2|)))))))))) (let ((|result#0@@9| (_module.__default.doC ($LS ($LS $LZ)) |stmts##0@0| |stC#0@@40| |env##0@0|)))
(let ((|stC'#0@@11| ($Unbox DatatypeTypeType (_module.Tuple.snd |result#0@@9|))))
 (and (|_module.__default.ConsistentCache#canCall| |stC'#0@@11|) (and (_module.__default.ConsistentCache |stC'#0@@11|) (forall ((|cmd#1@@2| T@U) (|deps#1@@2| T@U) (|e#1@@9| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#1@@2| Tclass._module.Expression) ($Is DatatypeTypeType |deps#1@@2| Tclass._module.Expression)) ($Is SeqType |e#1@@9| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC'#0@@11|)) (_module.__default.Hash (_module.__default.Loc |cmd#1@@2| |deps#1@@2| |e#1@@9|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC'#0@@11|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#1@@2| |deps#1@@2| |e#1@@9|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1191|
 :pattern ( (_module.__default.Loc |cmd#1@@2| |deps#1@@2| |e#1@@9|))
))))))) (and (let ((|result#0@@10| (_module.__default.doC ($LS ($LS $LZ)) |stmts##0@0| |stC#0@@40| |env##0@0|)))
(let ((|expr'#0@@3| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#0@@10|))))
 (=> (_module.Expression.exprError_q |expr'#0@@3|) (not (|_module.Reason#Equal| (_module.Expression.r |expr'#0@@3|) |#_module.Reason.rInconsistentCache|))))) (= $Heap@@3 $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (let ((|result#0@@11| (_module.__default.buildC |prog#0@@2| |stC#0@@40|)))
(let ((|stC'#0@@12| ($Unbox DatatypeTypeType (_module.Tuple.snd |result#0@@11|))))
 (=> (|_module.__default.ConsistentCache#canCall| |stC'#0@@12|) (or (_module.__default.ConsistentCache |stC'#0@@12|) (forall ((|cmd#3@@0| T@U) (|deps#3@@0| T@U) (|e#3@@2| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#3@@0| Tclass._module.Expression) ($Is DatatypeTypeType |deps#3@@0| Tclass._module.Expression)) ($Is SeqType |e#3@@2| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC'#0@@12|)) (_module.__default.Hash (_module.__default.Loc |cmd#3@@0| |deps#3@@0| |e#3@@2|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC'#0@@12|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#3@@0| |deps#3@@0| |e#3@@2|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1185|
 :pattern ( (_module.__default.Loc |cmd#3@@0| |deps#3@@0| |e#3@@2|))
))))))) (=> (let ((|result#0@@12| (_module.__default.buildC |prog#0@@2| |stC#0@@40|)))
(let ((|stC'#0@@13| ($Unbox DatatypeTypeType (_module.Tuple.snd |result#0@@12|))))
 (=> (|_module.__default.ConsistentCache#canCall| |stC'#0@@13|) (or (_module.__default.ConsistentCache |stC'#0@@13|) (forall ((|cmd#3@@1| T@U) (|deps#3@@1| T@U) (|e#3@@3| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#3@@1| Tclass._module.Expression) ($Is DatatypeTypeType |deps#3@@1| Tclass._module.Expression)) ($Is SeqType |e#3@@3| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC'#0@@13|)) (_module.__default.Hash (_module.__default.Loc |cmd#3@@1| |deps#3@@1| |e#3@@3|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC'#0@@13|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#3@@1| |deps#3@@1| |e#3@@3|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1185|
 :pattern ( (_module.__default.Loc |cmd#3@@1| |deps#3@@1| |e#3@@3|))
)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (let ((|result#0@@13| (_module.__default.buildC |prog#0@@2| |stC#0@@40|)))
(let ((|expr'#0@@4| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#0@@13|))))
 (=> (_module.Expression.exprError_q |expr'#0@@4|) (not (|_module.Reason#Equal| (_module.Expression.r |expr'#0@@4|) |#_module.Reason.rInconsistentCache|)))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and ($Is DatatypeTypeType |prog#0@@2| Tclass._module.Program) ($IsAlloc DatatypeTypeType |prog#0@@2| Tclass._module.Program $Heap@@3)) (|$IsA#_module.Program| |prog#0@@2|)) (=> (and (and (and (and (and ($Is DatatypeTypeType |stC#0@@40| Tclass._module.StateC) ($IsAlloc DatatypeTypeType |stC#0@@40| Tclass._module.StateC $Heap@@3)) (|$IsA#_module.StateC| |stC#0@@40|)) (= 9 $FunctionContextHeight)) (and (|_module.__default.Legal#canCall| (_module.Program.stmts |prog#0@@2|)) (and (_module.__default.Legal (_module.Program.stmts |prog#0@@2|)) (or (not (= (|Seq#Length| (_module.Program.stmts |prog#0@@2|)) 0)) (not true))))) (and (and (|_module.__default.ConsistentCache#canCall| |stC#0@@40|) (and (_module.__default.ConsistentCache |stC#0@@40|) (forall ((|cmd#2@@0| T@U) (|deps#2@@0| T@U) (|e#2@@7| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#2@@0| Tclass._module.Expression) ($Is DatatypeTypeType |deps#2@@0| Tclass._module.Expression)) ($Is SeqType |e#2@@7| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@40|)) (_module.__default.Hash (_module.__default.Loc |cmd#2@@0| |deps#2@@0| |e#2@@7|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@40|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#2@@0| |deps#2@@0| |e#2@@7|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1184|
