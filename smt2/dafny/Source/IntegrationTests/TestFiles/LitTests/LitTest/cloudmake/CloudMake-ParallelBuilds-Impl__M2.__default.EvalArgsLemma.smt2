...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@5 T@U) (|p#0@@7| T@U) (|a#0@@0| T@U) (|st#0@@10| T@U) ) (!  (=> (and (or (|M2.__default.SetSt#canCall| |p#0@@7| |a#0@@0| |st#0@@10|) (and (< 1 $FunctionContextHeight) (and (and (and ($IsBox |p#0@@7| Tclass.M2.Path) ($IsAllocBox |p#0@@7| Tclass.M2.Path $Heap@@5)) (and ($IsBox |a#0@@0| Tclass.M2.Artifact) ($IsAllocBox |a#0@@0| Tclass.M2.Artifact $Heap@@5))) (and ($Is DatatypeTypeType |st#0@@10| Tclass.M2.State) ($IsAlloc DatatypeTypeType |st#0@@10| Tclass.M2.State $Heap@@5))))) ($IsGoodHeap $Heap@@5)) ($IsAlloc DatatypeTypeType (M2.__default.SetSt |p#0@@7| |a#0@@0| |st#0@@10|) Tclass.M2.State $Heap@@5))
 :qid |CloudMakeParallelBuildsdfy.468:18|
 :skolemid |3498|
 :pattern ( ($IsAlloc DatatypeTypeType (M2.__default.SetSt |p#0@@7| |a#0@@0| |st#0@@10|) Tclass.M2.State $Heap@@5))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|p#0@@8| T@U) (|st#0@@11| T@U) ) (!  (=> (or (|M2.__default.GetSt#canCall| (Lit BoxType |p#0@@8|) (Lit DatatypeTypeType |st#0@@11|)) (and (< 2 $FunctionContextHeight) (and (and ($IsBox |p#0@@8| Tclass.M2.Path) ($Is DatatypeTypeType |st#0@@11| Tclass.M2.State)) (|Set#IsMember| (Lit SetType (M2.__default.DomSt (Lit DatatypeTypeType |st#0@@11|))) (Lit BoxType |p#0@@8|))))) (and (M2.State.StateCons_q (Lit DatatypeTypeType |st#0@@11|)) (= (M2.__default.GetSt (Lit BoxType |p#0@@8|) (Lit DatatypeTypeType |st#0@@11|)) (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType (M2.State.m (Lit DatatypeTypeType |st#0@@11|)))) (Lit BoxType |p#0@@8|)))))
 :qid |CloudMakeParallelBuildsdfy.10:24|
 :weight 3
 :skolemid |4261|
 :pattern ( (M2.__default.GetSt (Lit BoxType |p#0@@8|) (Lit DatatypeTypeType |st#0@@11|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|p#0@@9| T@U) (|st#0@@12| T@U) ) (!  (=> (or (|M2.__default.Oracle#canCall| |p#0@@9| |st#0@@12|) (and (< 4 $FunctionContextHeight) (and ($IsBox |p#0@@9| Tclass.M2.Path) ($Is DatatypeTypeType |st#0@@12| Tclass.M2.State)))) ($IsBox (M2.__default.Oracle |p#0@@9| |st#0@@12|) Tclass.M2.Artifact))
 :qid |CloudMakeParallelBuildsdfy.104:25|
 :skolemid |3818|
 :pattern ( (M2.__default.Oracle |p#0@@9| |st#0@@12|))
))))
(assert (forall (($ly@@5 T@U) (|p#0@@10| T@U) (|cert#0@@1| T@U) (|deps#0@@5| T@U) (|st#0@@13| T@U) ) (! (= (M2.__default.CollectDependencies ($LS $ly@@5) |p#0@@10| |cert#0@@1| |deps#0@@5| |st#0@@13|) (M2.__default.CollectDependencies $ly@@5 |p#0@@10| |cert#0@@1| |deps#0@@5| |st#0@@13|))
 :qid |CloudMakeParallelBuildsdfy.660:18|
 :skolemid |3864|
 :pattern ( (M2.__default.CollectDependencies ($LS $ly@@5) |p#0@@10| |cert#0@@1| |deps#0@@5| |st#0@@13|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@7 T@U) (|p#0@@11| T@U) (|cert#0@@2| T@U) (|st#0@@14| T@U) ) (!  (=> (or (|M2.__default.OracleWF#canCall| |p#0@@11| |cert#0@@2| |st#0@@14|) (and (< 3 $FunctionContextHeight) (and (and (and ($IsBox |p#0@@11| Tclass.M2.Path) ($Is DatatypeTypeType |cert#0@@2| Tclass.M2.WFCertificate)) ($Is DatatypeTypeType |st#0@@14| Tclass.M2.State)) (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@11| |cert#0@@2|)))) (and (and (and (and (|M2.__default.LocInv__Cmd#canCall| |p#0@@11|) (|M2.__default.LocInv__Deps#canCall| |p#0@@11|)) (|M2.__default.LocInv__Exp#canCall| |p#0@@11|)) (let ((|e#0| (M2.__default.LocInv__Exp |p#0@@11|)))
(let ((|deps#0@@6| (M2.__default.LocInv__Deps |p#0@@11|)))
(let ((|cmd#0@@3| (M2.__default.LocInv__Cmd |p#0@@11|)))
 (and (|M2.__default.CollectDependencies#canCall| |p#0@@11| |cert#0@@2| |deps#0@@6| |st#0@@14|) (|M2.__default.RunTool#canCall| |cmd#0@@3| (M2.__default.CollectDependencies $ly@@7 |p#0@@11| |cert#0@@2| |deps#0@@6| |st#0@@14|) |e#0|)))))) (= (M2.__default.OracleWF ($LS $ly@@7) |p#0@@11| |cert#0@@2| |st#0@@14|) (let ((|e#0@@0| (M2.__default.LocInv__Exp |p#0@@11|)))
(let ((|deps#0@@7| (M2.__default.LocInv__Deps |p#0@@11|)))
(let ((|cmd#0@@4| (M2.__default.LocInv__Cmd |p#0@@11|)))
(M2.__default.RunTool |cmd#0@@4| (M2.__default.CollectDependencies $ly@@7 |p#0@@11| |cert#0@@2| |deps#0@@7| |st#0@@14|) |e#0@@0|)))))))
 :qid |CloudMakeParallelBuildsdfy.653:18|
 :skolemid |3848|
 :pattern ( (M2.__default.OracleWF ($LS $ly@@7) |p#0@@11| |cert#0@@2| |st#0@@14|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|paths#0@@0| T@U) (|st#0@@15| T@U) ) (!  (=> (or (|M2.__default.Restrict#canCall| |paths#0@@0| |st#0@@15|) (and (< 3 $FunctionContextHeight) (and ($Is SetType |paths#0@@0| (TSet Tclass.M2.Path)) ($Is DatatypeTypeType |st#0@@15| Tclass.M2.State)))) (and (forall ((|p#0@@12| T@U) ) (!  (=> ($IsBox |p#0@@12| Tclass.M2.Path) (and (=> (|Set#IsMember| |paths#0@@0| |p#0@@12|) (|M2.__default.DomSt#canCall| |st#0@@15|)) (=> (and (|Set#IsMember| |paths#0@@0| |p#0@@12|) (|Set#IsMember| (M2.__default.DomSt |st#0@@15|) |p#0@@12|)) (|M2.__default.GetSt#canCall| |p#0@@12| |st#0@@15|))))
 :qid |CloudMakeParallelBuildsdfy.475:9|
 :skolemid |3506|
 :pattern ( (M2.__default.GetSt |p#0@@12| |st#0@@15|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st#0@@15|) |p#0@@12|))
 :pattern ( (|Set#IsMember| |paths#0@@0| |p#0@@12|))
)) (= (M2.__default.Restrict |paths#0@@0| |st#0@@15|) (|Map#Glue| (|Set#FromBoogieMap| (|lambda#0| Tclass.M2.Path |paths#0@@0| (M2.__default.DomSt |st#0@@15|))) (|lambda#1| |st#0@@15|) (TMap Tclass.M2.Path Tclass.M2.Artifact)))))
 :qid |CloudMakeParallelBuildsdfy.473:27|
 :skolemid |3507|
 :pattern ( (M2.__default.Restrict |paths#0@@0| |st#0@@15|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@16| T@U) (|st'#0| T@U) ) (!  (=> (or (|M2.__default.Union#canCall| |st#0@@16| |st'#0|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@16| Tclass.M2.State) ($Is DatatypeTypeType |st'#0| Tclass.M2.State)))) (and (let ((|result#0| (M2.__default.Union |st#0@@16| |st'#0|)))
 (and (|Set#Equal| (M2.__default.DomSt |result#0|) (|Set#Union| (M2.__default.DomSt |st#0@@16|) (M2.__default.DomSt |st'#0|))) (forall ((|p#0@@14| T@U) ) (!  (=> ($IsBox |p#0@@14| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.DomSt |result#0|) |p#0@@14|) (= (M2.__default.GetSt |p#0@@14| |result#0|) (M2.__default.GetSt |p#0@@14| (ite (|Set#IsMember| (M2.__default.DomSt |st#0@@16|) |p#0@@14|) |st#0@@16| |st'#0|)))))
 :qid |CloudMakeParallelBuildsdfy.27:14|
 :skolemid |4291|
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st#0@@16|) |p#0@@14|))
 :pattern ( (M2.__default.GetSt |p#0@@14| |result#0|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |result#0|) |p#0@@14|))
)))) ($Is DatatypeTypeType (M2.__default.Union |st#0@@16| |st'#0|) Tclass.M2.State)))
 :qid |CloudMakeParallelBuildsdfy.23:24|
 :skolemid |4292|
 :pattern ( (M2.__default.Union |st#0@@16| |st'#0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|p#0@@16| T@U) (|st#0@@17| T@U) ) (!  (=> (or (|M2.__default.GetSt#canCall| |p#0@@16| |st#0@@17|) (and (< 2 $FunctionContextHeight) (and (and ($IsBox |p#0@@16| Tclass.M2.Path) ($Is DatatypeTypeType |st#0@@17| Tclass.M2.State)) (|Set#IsMember| (M2.__default.DomSt |st#0@@17|) |p#0@@16|)))) ($IsBox (M2.__default.GetSt |p#0@@16| |st#0@@17|) Tclass.M2.Artifact))
 :qid |CloudMakeParallelBuildsdfy.10:24|
 :skolemid |4256|
 :pattern ( (M2.__default.GetSt |p#0@@16| |st#0@@17|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@8 T@U) (|p#0@@17| T@U) (|st#0@@18| T@U) ) (!  (=> (and (or (|M2.__default.GetSt#canCall| |p#0@@17| |st#0@@18|) (and (< 2 $FunctionContextHeight) (and (and (and ($IsBox |p#0@@17| Tclass.M2.Path) ($IsAllocBox |p#0@@17| Tclass.M2.Path $Heap@@8)) (and ($Is DatatypeTypeType |st#0@@18| Tclass.M2.State) ($IsAlloc DatatypeTypeType |st#0@@18| Tclass.M2.State $Heap@@8))) (|Set#IsMember| (M2.__default.DomSt |st#0@@18|) |p#0@@17|)))) ($IsGoodHeap $Heap@@8)) ($IsAllocBox (M2.__default.GetSt |p#0@@17| |st#0@@18|) Tclass.M2.Artifact $Heap@@8))
 :qid |CloudMakeParallelBuildsdfy.435:18|
 :skolemid |4257|
 :pattern ( ($IsAllocBox (M2.__default.GetSt |p#0@@17| |st#0@@18|) Tclass.M2.Artifact $Heap@@8))
))))
(assert  (=> (<= 7 $FunctionContextHeight) (forall (($ly@@9 T@U) (|expr#0| T@U) (|st#0@@19| T@U) (|env#0@@2| T@U) ) (!  (=> (or (|M2.__default.eval#canCall| (Lit DatatypeTypeType |expr#0|) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)) (and (< 7 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0| Tclass.M2.Expression) ($Is DatatypeTypeType |st#0@@19| Tclass.M2.State)) ($IsBox |env#0@@2| Tclass.M2.Env)) (M2.__default.ValidEnv (Lit BoxType |env#0@@2|))))) (and (and (|M2.__default.Value#canCall| (Lit DatatypeTypeType |expr#0|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (M2.__default.Value (Lit DatatypeTypeType |expr#0|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M2.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0|))))) (|M2.__default.GetEnv#canCall| (Lit BoxType (M2.Expression.id (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |env#0@@2|))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M2.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M2.Expression.exprIf_q (Lit DatatypeTypeType |expr#0|))))) (and (|M2.__default.eval#canCall| (Lit DatatypeTypeType (M2.Expression.cond (Lit DatatypeTypeType |expr#0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)) (let ((|st'#8| ($Unbox DatatypeTypeType (M2.Tuple.snd (Lit DatatypeTypeType (M2.__default.eval ($LS $ly@@9) (Lit DatatypeTypeType (M2.Expression.cond (Lit DatatypeTypeType |expr#0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)))))))
(let ((|cond'#2| ($Unbox DatatypeTypeType (M2.Tuple.fst (Lit DatatypeTypeType (M2.__default.eval ($LS $ly@@9) (Lit DatatypeTypeType (M2.Expression.cond (Lit DatatypeTypeType |expr#0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)))))))
 (and (and (=> (M2.Expression.exprLiteral_q |cond'#2|) (|$IsA#M2.Literal| (M2.Expression.lit |cond'#2|))) (=> (and (M2.Expression.exprLiteral_q |cond'#2|) (|M2.Literal#Equal| (M2.Expression.lit |cond'#2|) |#M2.Literal.litTrue|)) (|M2.__default.eval#canCall| (Lit DatatypeTypeType (M2.Expression.ifTrue (Lit DatatypeTypeType |expr#0|))) |st'#8| (Lit BoxType |env#0@@2|)))) (=> (not (and (M2.Expression.exprLiteral_q |cond'#2|) (|M2.Literal#Equal| (M2.Expression.lit |cond'#2|) |#M2.Literal.litTrue|))) (and (=> (M2.Expression.exprLiteral_q |cond'#2|) (|$IsA#M2.Literal| (M2.Expression.lit |cond'#2|))) (=> (and (M2.Expression.exprLiteral_q |cond'#2|) (|M2.Literal#Equal| (M2.Expression.lit |cond'#2|) |#M2.Literal.litFalse|)) (|M2.__default.eval#canCall| (Lit DatatypeTypeType (M2.Expression.ifFalse (Lit DatatypeTypeType |expr#0|))) |st'#8| (Lit BoxType |env#0@@2|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M2.Expression.exprIf_q (Lit DatatypeTypeType |expr#0|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M2.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0|))))) (and (|M2.__default.eval#canCall| (Lit DatatypeTypeType (M2.Expression.conj0 (Lit DatatypeTypeType |expr#0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)) (let ((|st'#9| ($Unbox DatatypeTypeType (M2.Tuple.snd (Lit DatatypeTypeType (M2.__default.eval ($LS $ly@@9) (Lit DatatypeTypeType (M2.Expression.conj0 (Lit DatatypeTypeType |expr#0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)))))))
(let ((|conj0'#2| ($Unbox DatatypeTypeType (M2.Tuple.fst (Lit DatatypeTypeType (M2.__default.eval ($LS $ly@@9) (Lit DatatypeTypeType (M2.Expression.conj0 (Lit DatatypeTypeType |expr#0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)))))))
 (and (and (=> (M2.Expression.exprLiteral_q |conj0'#2|) (|$IsA#M2.Literal| (M2.Expression.lit |conj0'#2|))) (=> (and (M2.Expression.exprLiteral_q |conj0'#2|) (|M2.Literal#Equal| (M2.Expression.lit |conj0'#2|) |#M2.Literal.litTrue|)) (|M2.__default.eval#canCall| (Lit DatatypeTypeType (M2.Expression.conj1 (Lit DatatypeTypeType |expr#0|))) |st'#9| (Lit BoxType |env#0@@2|)))) (=> (not (and (M2.Expression.exprLiteral_q |conj0'#2|) (|M2.Literal#Equal| (M2.Expression.lit |conj0'#2|) |#M2.Literal.litTrue|))) (=> (M2.Expression.exprLiteral_q |conj0'#2|) (|$IsA#M2.Literal| (M2.Expression.lit |conj0'#2|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M2.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M2.Expression.exprOr_q (Lit DatatypeTypeType |expr#0|))))) (and (|M2.__default.eval#canCall| (Lit DatatypeTypeType (M2.Expression.disj0 (Lit DatatypeTypeType |expr#0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)) (let ((|st'#10| ($Unbox DatatypeTypeType (M2.Tuple.snd (Lit DatatypeTypeType (M2.__default.eval ($LS $ly@@9) (Lit DatatypeTypeType (M2.Expression.disj0 (Lit DatatypeTypeType |expr#0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)))))))
(let ((|disj0'#2| ($Unbox DatatypeTypeType (M2.Tuple.fst (Lit DatatypeTypeType (M2.__default.eval ($LS $ly@@9) (Lit DatatypeTypeType (M2.Expression.disj0 (Lit DatatypeTypeType |expr#0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)))))))
 (and (=> (M2.Expression.exprLiteral_q |disj0'#2|) (|$IsA#M2.Literal| (M2.Expression.lit |disj0'#2|))) (=> (not (and (M2.Expression.exprLiteral_q |disj0'#2|) (|M2.Literal#Equal| (M2.Expression.lit |disj0'#2|) |#M2.Literal.litTrue|))) (and (=> (M2.Expression.exprLiteral_q |disj0'#2|) (|$IsA#M2.Literal| (M2.Expression.lit |disj0'#2|))) (=> (and (M2.Expression.exprLiteral_q |disj0'#2|) (|M2.Literal#Equal| (M2.Expression.lit |disj0'#2|) |#M2.Literal.litFalse|)) (|M2.__default.eval#canCall| (Lit DatatypeTypeType (M2.Expression.disj1 (Lit DatatypeTypeType |expr#0|))) |st'#10| (Lit BoxType |env#0@@2|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M2.Expression.exprOr_q (Lit DatatypeTypeType |expr#0|)))))) (=> (U_2_bool (Lit boolType (bool_2_U (M2.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0|))))) (and (|M2.__default.eval#canCall| (Lit DatatypeTypeType (M2.Expression.fun (Lit DatatypeTypeType |expr#0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)) (let ((|st'#11| ($Unbox DatatypeTypeType (M2.Tuple.snd (Lit DatatypeTypeType (M2.__default.eval ($LS $ly@@9) (Lit DatatypeTypeType (M2.Expression.fun (Lit DatatypeTypeType |expr#0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)))))))
(let ((|fun'#2| ($Unbox DatatypeTypeType (M2.Tuple.fst (Lit DatatypeTypeType (M2.__default.eval ($LS $ly@@9) (Lit DatatypeTypeType (M2.Expression.fun (Lit DatatypeTypeType |expr#0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)))))))
 (and (|M2.__default.evalArgs#canCall| (Lit DatatypeTypeType |expr#0|) (Lit SeqType (M2.Expression.args (Lit DatatypeTypeType |expr#0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)) (let ((|sts'#2| ($Unbox SetType (M2.Tuple.snd (Lit DatatypeTypeType (M2.__default.evalArgs ($LS $ly@@9) (Lit DatatypeTypeType |expr#0|) (Lit SeqType (M2.Expression.args (Lit DatatypeTypeType |expr#0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)))))))
(let ((|args'#2| ($Unbox SeqType (M2.Tuple.fst (Lit DatatypeTypeType (M2.__default.evalArgs ($LS $ly@@9) (Lit DatatypeTypeType |expr#0|) (Lit SeqType (M2.Expression.args (Lit DatatypeTypeType |expr#0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)))))))
(let ((|sts''#2| (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |st'#11|)) |sts'#2|)))
 ...
 (and (M2.Tuple.Pair_q |ps#2|) (M2.Tuple.Pair_q |ps#2|)))))))))))))))))))))))))))))) (= (M2.__default.eval ($LS $ly@@9) (Lit DatatypeTypeType |expr#0|) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)) (ite (M2.__default.Value (Lit DatatypeTypeType |expr#0|)) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType |expr#0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |st#0@@19|))) (ite (M2.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0|)) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (M2.__default.GetEnv (Lit BoxType (M2.Expression.id (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |env#0@@2|))) ($Box DatatypeTypeType (Lit DatatypeTypeType |st#0@@19|))) (ite (M2.Expression.exprIf_q (Lit DatatypeTypeType |expr#0|)) (let ((|st'#8@@0| ($Unbox DatatypeTypeType (M2.Tuple.snd (Lit DatatypeTypeType (M2.__default.eval ($LS $ly@@9) (Lit DatatypeTypeType (M2.Expression.cond (Lit DatatypeTypeType |expr#0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)))))))
(let ((|cond'#2@@0| ($Unbox DatatypeTypeType (M2.Tuple.fst (Lit DatatypeTypeType (M2.__default.eval ($LS $ly@@9) (Lit DatatypeTypeType (M2.Expression.cond (Lit DatatypeTypeType |expr#0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)))))))
(ite  (and (M2.Expression.exprLiteral_q |cond'#2@@0|) (|M2.Literal#Equal| (M2.Expression.lit |cond'#2@@0|) |#M2.Literal.litTrue|)) (M2.__default.eval ($LS $ly@@9) (Lit DatatypeTypeType (M2.Expression.ifTrue (Lit DatatypeTypeType |expr#0|))) |st'#8@@0| (Lit BoxType |env#0@@2|)) (ite  (and (M2.Expression.exprLiteral_q |cond'#2@@0|) (|M2.Literal#Equal| (M2.Expression.lit |cond'#2@@0|) |#M2.Literal.litFalse|)) (M2.__default.eval ($LS $ly@@9) (Lit DatatypeTypeType (M2.Expression.ifFalse (Lit DatatypeTypeType |expr#0|))) |st'#8@@0| (Lit BoxType |env#0@@2|)) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprError| (Lit DatatypeTypeType |#M2.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |st#0@@19|))))))) (ite (M2.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0|)) (let ((|st'#9@@0| ($Unbox DatatypeTypeType (M2.Tuple.snd (Lit DatatypeTypeType (M2.__default.eval ($LS $ly@@9) (Lit DatatypeTypeType (M2.Expression.conj0 (Lit DatatypeTypeType |expr#0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)))))))
(let ((|conj0'#2@@0| ($Unbox DatatypeTypeType (M2.Tuple.fst (Lit DatatypeTypeType (M2.__default.eval ($LS $ly@@9) (Lit DatatypeTypeType (M2.Expression.conj0 (Lit DatatypeTypeType |expr#0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)))))))
(ite  (and (M2.Expression.exprLiteral_q |conj0'#2@@0|) (|M2.Literal#Equal| (M2.Expression.lit |conj0'#2@@0|) |#M2.Literal.litTrue|)) (M2.__default.eval ($LS $ly@@9) (Lit DatatypeTypeType (M2.Expression.conj1 (Lit DatatypeTypeType |expr#0|))) |st'#9@@0| (Lit BoxType |env#0@@2|)) (ite  (and (M2.Expression.exprLiteral_q |conj0'#2@@0|) (|M2.Literal#Equal| (M2.Expression.lit |conj0'#2@@0|) |#M2.Literal.litFalse|)) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprLiteral| (Lit DatatypeTypeType |#M2.Literal.litFalse|)))) ($Box DatatypeTypeType |st'#9@@0|)) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprError| (Lit DatatypeTypeType |#M2.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |st#0@@19|))))))) (ite (M2.Expression.exprOr_q (Lit DatatypeTypeType |expr#0|)) (let ((|st'#10@@0| ($Unbox DatatypeTypeType (M2.Tuple.snd (Lit DatatypeTypeType (M2.__default.eval ($LS $ly@@9) (Lit DatatypeTypeType (M2.Expression.disj0 (Lit DatatypeTypeType |expr#0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)))))))
(let ((|disj0'#2@@0| ($Unbox DatatypeTypeType (M2.Tuple.fst (Lit DatatypeTypeType (M2.__default.eval ($LS $ly@@9) (Lit DatatypeTypeType (M2.Expression.disj0 (Lit DatatypeTypeType |expr#0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)))))))
(ite  (and (M2.Expression.exprLiteral_q |disj0'#2@@0|) (|M2.Literal#Equal| (M2.Expression.lit |disj0'#2@@0|) |#M2.Literal.litTrue|)) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprLiteral| (Lit DatatypeTypeType |#M2.Literal.litTrue|)))) ($Box DatatypeTypeType |st'#10@@0|)) (ite  (and (M2.Expression.exprLiteral_q |disj0'#2@@0|) (|M2.Literal#Equal| (M2.Expression.lit |disj0'#2@@0|) |#M2.Literal.litFalse|)) (M2.__default.eval ($LS $ly@@9) (Lit DatatypeTypeType (M2.Expression.disj1 (Lit DatatypeTypeType |expr#0|))) |st'#10@@0| (Lit BoxType |env#0@@2|)) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprError| (Lit DatatypeTypeType |#M2.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |st#0@@19|))))))) (ite (M2.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0|)) (let ((|st'#11@@0| ($Unbox DatatypeTypeType (M2.Tuple.snd (Lit DatatypeTypeType (M2.__default.eval ($LS $ly@@9) (Lit DatatypeTypeType (M2.Expression.fun (Lit DatatypeTypeType |expr#0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)))))))
(let ((|fun'#2@@0| ($Unbox DatatypeTypeType (M2.Tuple.fst (Lit DatatypeTypeType (M2.__default.eval ($LS $ly@@9) (Lit DatatypeTypeType (M2.Expression.fun (Lit DatatypeTypeType |expr#0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)))))))
(let ((|sts'#2@@0| ($Unbox SetType (M2.Tuple.snd (Lit DatatypeTypeType (M2.__default.evalArgs ($LS $ly@@9) (Lit DatatypeTypeType |expr#0|) (Lit SeqType (M2.Expression.args (Lit DatatypeTypeType |expr#0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)))))))
(let ((|args'#2@@0| ($Unbox SeqType (M2.Tuple.fst (Lit DatatypeTypeType (M2.__default.evalArgs ($LS $ly@@9) (Lit DatatypeTypeType |expr#0|) (Lit SeqType (M2.Expression.args (Lit DatatypeTypeType |expr#0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)))))))
(let ((|sts''#2@@0| (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |st'#11@@0|)) |sts'#2@@0|)))
(ite  (not (M2.__default.Compatible |sts''#2@@0|)) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprError| (Lit DatatypeTypeType |#M2.Reason.rCompatibility|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |st#0@@19|))) (let ((|stCombined#2@@0| (M2.__default.Combine ($LS $LZ) |sts''#2@@0|)))
...
(|#M2.Tuple.Pair| ($Box DatatypeTypeType (|#M2.Expression.exprLiteral| (|#M2.Literal.litArrOfPaths| ($Unbox SetType (M2.Tuple.fst |ps#2@@0|))))) (M2.Tuple.snd |ps#2@@0|))) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprError| (Lit DatatypeTypeType |#M2.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |st#0@@19|)))) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprError| (Lit DatatypeTypeType |#M2.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |st#0@@19|)))) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprError| (Lit DatatypeTypeType |#M2.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |st#0@@19|))))))))))) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprError| (Lit DatatypeTypeType |#M2.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |st#0@@19|))))))))))))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :weight 3
 :skolemid |4517|
 :pattern ( (M2.__default.eval ($LS $ly@@9) (Lit DatatypeTypeType |expr#0|) (Lit DatatypeTypeType |st#0@@19|) (Lit BoxType |env#0@@2|)))
))))
(assert  (=> (<= 6 $FunctionContextHeight) (forall ((|prim#0@@2| T@U) (|args#0@@3| T@U) (|st#0@@20| T@U) ) (!  (=> (or (|M2.__default.ValidArgs#canCall| (Lit DatatypeTypeType |prim#0@@2|) (Lit SeqType |args#0@@3|) (Lit DatatypeTypeType |st#0@@20|)) (and (< 6 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |prim#0@@2| Tclass.M2.Primitive) ($Is SeqType |args#0@@3| (TSeq Tclass.M2.Expression))) ($Is DatatypeTypeType |st#0@@20| Tclass.M2.State)) (and (=> (M2.Primitive.primExec_q (Lit DatatypeTypeType |prim#0@@2|)) (= (|Seq#Length| (Lit SeqType |args#0@@3|)) (LitInt 3))) (=> (M2.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@2|)) (= (|Seq#Length| (Lit SeqType |args#0@@3|)) (LitInt 1))))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (M2.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@2|)))))) (let ((|exps#5| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@3|) (LitInt 2)))))
...
(let ((|cmd#5| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@3|) (LitInt 0)))))
 (=> (M2.Expression.exprLiteral_q |cmd#5|) (=> (M2.Literal.litString_q (M2.Expression.lit |cmd#5|)) (=> (M2.Expression.exprLiteral_q |deps#5|) (=> (M2.Literal.litArrOfPaths_q (M2.Expression.lit |deps#5|)) (=> (M2.Expression.exprLiteral_q |exps#5|) (=> (M2.Literal.litArrOfStrings_q (M2.Expression.lit |exps#5|)) (and (|M2.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@20|)) (=> (|Set#Subset| (M2.Literal.paths (M2.Expression.lit |deps#5|)) (M2.__default.DomSt (Lit DatatypeTypeType |st#0@@20|))) (|M2.__default.Pre#canCall| (M2.Literal.str (M2.Expression.lit |cmd#5|)) (M2.Literal.paths (M2.Expression.lit |deps#5|)) (M2.Literal.strs (M2.Expression.lit |exps#5|)) (Lit DatatypeTypeType |st#0@@20|)))))))))))))) (= (M2.__default.ValidArgs (Lit DatatypeTypeType |prim#0@@2|) (Lit SeqType |args#0@@3|) (Lit DatatypeTypeType |st#0@@20|)) (ite (M2.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@2|)) false (let ((|exps#4| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@3|) (LitInt 2)))))
...
(let ((|cmd#4| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@3|) (LitInt 0)))))
 (and (and (and (and (and (and (and (M2.Expression.exprLiteral_q |cmd#4|) (M2.Literal.litString_q (M2.Expression.lit |cmd#4|))) (M2.Expression.exprLiteral_q |deps#4|)) (M2.Literal.litArrOfPaths_q (M2.Expression.lit |deps#4|))) (M2.Expression.exprLiteral_q |exps#4|)) (M2.Literal.litArrOfStrings_q (M2.Expression.lit |exps#4|))) (|Set#Subset| (M2.Literal.paths (M2.Expression.lit |deps#4|)) (M2.__default.DomSt (Lit DatatypeTypeType |st#0@@20|)))) (M2.__default.Pre (M2.Literal.str (M2.Expression.lit |cmd#4|)) (M2.Literal.paths (M2.Expression.lit |deps#4|)) (M2.Literal.strs (M2.Expression.lit |exps#4|)) (Lit DatatypeTypeType |st#0@@20|))))))))))
 :qid |CloudMakeParallelBuildsdfy.289:29|
 :weight 3
 :skolemid |4563|
 :pattern ( (M2.__default.ValidArgs (Lit DatatypeTypeType |prim#0@@2|) (Lit SeqType |args#0@@3|) (Lit DatatypeTypeType |st#0@@20|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@10 T@U) (|cmd#0@@6| T@U) (|deps#0@@9| T@U) (|restrictedState#0@@0| T@U) (|exps#0@@2| T@U) (|st#0@@21| T@U) ) (!  (=> (or (|M2.__default.execOne#canCall| |cmd#0@@6| |deps#0@@9| |restrictedState#0@@0| |exps#0@@2| |st#0@@21|) (and (< 2 $FunctionContextHeight) (and (and (and (and ($Is SeqType |cmd#0@@6| (TSeq TChar)) ($Is SetType |deps#0@@9| (TSet Tclass.M2.Path))) ($Is MapType |restrictedState#0@@0| (TMap Tclass.M2.Path Tclass.M2.Artifact))) ($Is SetType |exps#0@@2| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@21| Tclass.M2.State)))) (and (=> (not (|Set#Equal| |exps#0@@2| |Set#Empty|)) (and (|M2.__default.PickOne#canCall| (TSeq TChar) |exps#0@@2|) (let ((|exp#0@@1| ($Unbox SeqType (M2.__default.PickOne (TSeq TChar) |exps#0@@2|))))
 (and (|M2.__default.execOne#canCall| |cmd#0@@6| |deps#0@@9| |restrictedState#0@@0| (|Set#Difference| |exps#0@@2| (|Set#UnionOne| |Set#Empty| ($Box SeqType |exp#0@@1|))) |st#0@@21|) (let ((|st'#0@@0| ($Unbox DatatypeTypeType (M2.Tuple.snd (M2.__default.execOne $ly@@10 |cmd#0@@6| |deps#0@@9| |restrictedState#0@@0| (|Set#Difference| |exps#0@@2| (|Set#UnionOne| |Set#Empty| ($Box SeqType |exp#0@@1|))) |st#0@@21|)))))
 (and (|M2.__default.Loc#canCall| |cmd#0@@6| |deps#0@@9| |exp#0@@1|) (let ((|p#0@@19| (M2.__default.Loc |cmd#0@@6| |deps#0@@9| |exp#0@@1|)))
 (and (|M2.__default.DomSt#canCall| |st'#0@@0|) (=> (not (|Set#IsMember| (M2.__default.DomSt |st'#0@@0|) |p#0@@19|)) (and (|M2.__default.RunTool#canCall| |cmd#0@@6| |restrictedState#0@@0| |exp#0@@1|) (|M2.__default.SetSt#canCall| |p#0@@19| (M2.__default.RunTool |cmd#0@@6| |restrictedState#0@@0| |exp#0@@1|) |st'#0@@0|))))))))))) (= (M2.__default.execOne ($LS $ly@@10) |cmd#0@@6| |deps#0@@9| |restrictedState#0@@0| |exps#0@@2| |st#0@@21|) (ite (|Set#Equal| |exps#0@@2| |Set#Empty|) (|#M2.Tuple.Pair| ($Box SetType (Lit SetType |Set#Empty|)) ($Box DatatypeTypeType |st#0@@21|)) (let ((|exp#0@@2| ($Unbox SeqType (M2.__default.PickOne (TSeq TChar) |exps#0@@2|))))
(let ((|st'#0@@1| ($Unbox DatatypeTypeType (M2.Tuple.snd (M2.__default.execOne $ly@@10 |cmd#0@@6| |deps#0@@9| |restrictedState#0@@0| (|Set#Difference| |exps#0@@2| (|Set#UnionOne| |Set#Empty| ($Box SeqType |exp#0@@2|))) |st#0@@21|)))))
(let ((|paths#0@@1| ($Unbox SetType (M2.Tuple.fst (M2.__default.execOne $ly@@10 |cmd#0@@6| |deps#0@@9| |restrictedState#0@@0| (|Set#Difference| |exps#0@@2| (|Set#UnionOne| |Set#Empty| ($Box SeqType |exp#0@@2|))) |st#0@@21|)))))
...
(|#M2.Tuple.Pair| ($Box SetType (|Set#Union| |paths#0@@1| (|Set#UnionOne| |Set#Empty| |p#0@@20|))) ($Box DatatypeTypeType (ite (|Set#IsMember| (M2.__default.DomSt |st'#0@@1|) |p#0@@20|) |st'#0@@1| (M2.__default.SetSt |p#0@@20| (M2.__default.RunTool |cmd#0@@6| |restrictedState#0@@0| |exp#0@@2|) |st'#0@@1|))))))))))))
 :qid |CloudMakeParallelBuildsdfy.513:18|
 :skolemid |3607|
 :pattern ( (M2.__default.execOne ($LS $ly@@10) |cmd#0@@6| |deps#0@@9| |restrictedState#0@@0| |exps#0@@2| |st#0@@21|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@11 T@U) (|p#0@@21| T@U) (|cert#0@@5| T@U) (|st#0@@22| T@U) ) (!  (=> (or (|M2.__default.OracleWF#canCall| |p#0@@21| |cert#0@@5| |st#0@@22|) (and (< 3 $FunctionContextHeight) (and (and (and ($IsBox |p#0@@21| Tclass.M2.Path) ($Is DatatypeTypeType |cert#0@@5| Tclass.M2.WFCertificate)) ($Is DatatypeTypeType |st#0@@22| Tclass.M2.State)) (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@21| |cert#0@@5|)))) ($IsBox (M2.__default.OracleWF $ly@@11 |p#0@@21| |cert#0@@5| |st#0@@22|) Tclass.M2.Artifact))
 :qid |CloudMakeParallelBuildsdfy.653:18|
 :skolemid |3845|
 :pattern ( (M2.__default.OracleWF $ly@@11 |p#0@@21| |cert#0@@5| |st#0@@22|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@12 T@U) (|p#0@@22| T@U) (|cert#0@@6| T@U) (|deps#0@@10| T@U) (|st#0@@23| T@U) ) (!  (=> (or (|M2.__default.CollectDependencies#canCall| (Lit BoxType |p#0@@22|) (Lit DatatypeTypeType |cert#0@@6|) (Lit SetType |deps#0@@10|) (Lit DatatypeTypeType |st#0@@23|)) (and (< 3 $FunctionContextHeight) (and (and (and (and ($IsBox |p#0@@22| Tclass.M2.Path) ($Is DatatypeTypeType |cert#0@@6| Tclass.M2.WFCertificate)) ($Is SetType |deps#0@@10| (TSet Tclass.M2.Path))) ($Is DatatypeTypeType |st#0@@23| Tclass.M2.State)) (and (M2.__default.CheckWellFounded ($LS $LZ) (Lit BoxType |p#0@@22|) (Lit DatatypeTypeType |cert#0@@6|)) (|Set#Equal| |deps#0@@10| (M2.__default.LocInv__Deps (Lit BoxType |p#0@@22|))))))) (and (forall ((|d#0@@2| T@U) ) (!  (=> ($IsBox |d#0@@2| Tclass.M2.Path) (=> (|Set#IsMember| (Lit SetType |deps#0@@10|) |d#0@@2|) (and (and (|M2.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@23|)) (=> (|Set#IsMember| (Lit SetType (M2.__default.DomSt (Lit DatatypeTypeType |st#0@@23|))) |d#0@@2|) (|M2.__default.GetSt#canCall| |d#0@@2| (Lit DatatypeTypeType |st#0@@23|)))) (=> (not (|Set#IsMember| (Lit SetType (M2.__default.DomSt (Lit DatatypeTypeType |st#0@@23|))) |d#0@@2|)) (and (and (M2.WFCertificate.Cert_q (Lit DatatypeTypeType |cert#0@@6|)) (|M2.__default.FindCert#canCall| |d#0@@2| (Lit SetType (M2.WFCertificate.certs (Lit DatatypeTypeType |cert#0@@6|))))) (|M2.__default.OracleWF#canCall| |d#0@@2| (M2.__default.FindCert |d#0@@2| (Lit SetType (M2.WFCertificate.certs (Lit DatatypeTypeType |cert#0@@6|)))) (Lit DatatypeTypeType |st#0@@23|)))))))
 :qid |CloudMakeParallelBuildsdfy.664:9|
 :skolemid |3873|
 :pattern ( (M2.__default.FindCert |d#0@@2| (M2.WFCertificate.certs |cert#0@@6|)))
 :pattern ( (M2.__default.GetSt |d#0@@2| |st#0@@23|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st#0@@23|) |d#0@@2|))
 :pattern ( (|Set#IsMember| |deps#0@@10| |d#0@@2|))
)) (= (M2.__default.CollectDependencies ($LS $ly@@12) (Lit BoxType |p#0@@22|) (Lit DatatypeTypeType |cert#0@@6|) (Lit SetType |deps#0@@10|) (Lit DatatypeTypeType |st#0@@23|)) (|Map#Glue| (|Set#FromBoogieMap| (|lambda#19| Tclass.M2.Path (Lit SetType |deps#0@@10|))) (|lambda#20| (Lit SetType (M2.__default.DomSt (Lit DatatypeTypeType |st#0@@23|))) (Lit DatatypeTypeType |st#0@@23|) ($LS $ly@@12) (Lit SetType (M2.WFCertificate.certs (Lit DatatypeTypeType |cert#0@@6|))) (Lit DatatypeTypeType |st#0@@23|)) (TMap Tclass.M2.Path Tclass.M2.Artifact)))))
 :qid |CloudMakeParallelBuildsdfy.660:18|
 :weight 3
 :skolemid |3874|
 :pattern ( (M2.__default.CollectDependencies ($LS $ly@@12) (Lit BoxType |p#0@@22|) (Lit DatatypeTypeType |cert#0@@6|) (Lit SetType |deps#0@@10|) (Lit DatatypeTypeType |st#0@@23|)))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@24| T@U) ) (!  (=> (or (|M2.__default.ValidState#canCall| |st#0@@24|) (and (< 3 $FunctionContextHeight) ($Is DatatypeTypeType |st#0@@24| Tclass.M2.State))) (and (forall ((|p#0@@23| T@U) ) (!  (=> ($IsBox |p#0@@23| Tclass.M2.Path) (and (|M2.__default.DomSt#canCall| |st#0@@24|) (=> (|Set#IsMember| (M2.__default.DomSt |st#0@@24|) |p#0@@23|) (|M2.__default.WellFounded#canCall| |p#0@@23|))))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |4281|
 :pattern ( (M2.__default.WellFounded |p#0@@23|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st#0@@24|) |p#0@@23|))
)) (= (M2.__default.ValidState |st#0@@24|) (forall ((|p#0@@24| T@U) ) (!  (=> ($IsBox |p#0@@24| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.DomSt |st#0@@24|) |p#0@@24|) (M2.__default.WellFounded |p#0@@24|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |4280|
 :pattern ( (M2.__default.WellFounded |p#0@@24|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st#0@@24|) |p#0@@24|))
)))))
 :qid |CloudMakeParallelBuildsdfy.13:30|
 :skolemid |4282|
 :pattern ( (M2.__default.ValidState |st#0@@24|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|paths#0@@2| T@U) (|st#0@@25| T@U) ) (!  (=> (or (|M2.__default.Restrict#canCall| |paths#0@@2| |st#0@@25|) (and (< 3 $FunctionContextHeight) (and ($Is SetType |paths#0@@2| (TSet Tclass.M2.Path)) ($Is DatatypeTypeType |st#0@@25| Tclass.M2.State)))) ($Is MapType (M2.__default.Restrict |paths#0@@2| |st#0@@25|) (TMap Tclass.M2.Path Tclass.M2.Artifact)))
 :qid |CloudMakeParallelBuildsdfy.473:27|
 :skolemid |3503|
 :pattern ( (M2.__default.Restrict |paths#0@@2| |st#0@@25|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|cmd#0@@7| T@U) (|deps#0@@11| T@U) (|exps#0@@3| T@U) (|st#0@@26| T@U) ) (!  (=> (or (|M2.__default.exec#canCall| (Lit SeqType |cmd#0@@7|) (Lit SetType |deps#0@@11|) (Lit SetType |exps#0@@3|) (Lit DatatypeTypeType |st#0@@26|)) (and (< 4 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@7| (TSeq TChar)) ($Is SetType |deps#0@@11| (TSet Tclass.M2.Path))) ($Is SetType |exps#0@@3| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@26| Tclass.M2.State)))) (and (and (|M2.__default.Restrict#canCall| (Lit SetType |deps#0@@11|) (Lit DatatypeTypeType |st#0@@26|)) (|M2.__default.execOne#canCall| (Lit SeqType |cmd#0@@7|) (Lit SetType |deps#0@@11|) (Lit MapType (M2.__default.Restrict (Lit SetType |deps#0@@11|) (Lit DatatypeTypeType |st#0@@26|))) (Lit SetType |exps#0@@3|) (Lit DatatypeTypeType |st#0@@26|))) (= (M2.__default.exec (Lit SeqType |cmd#0@@7|) (Lit SetType |deps#0@@11|) (Lit SetType |exps#0@@3|) (Lit DatatypeTypeType |st#0@@26|)) (Lit DatatypeTypeType (M2.__default.execOne ($LS $LZ) (Lit SeqType |cmd#0@@7|) (Lit SetType |deps#0@@11|) (Lit MapType (M2.__default.Restrict (Lit SetType |deps#0@@11|) (Lit DatatypeTypeType |st#0@@26|))) (Lit SetType |exps#0@@3|) (Lit DatatypeTypeType |st#0@@26|))))))
 :qid |CloudMakeParallelBuildsdfy.69:23|
 :weight 3
 :skolemid |3599|
 :pattern ( (M2.__default.exec (Lit SeqType |cmd#0@@7|) (Lit SetType |deps#0@@11|) (Lit SetType |exps#0@@3|) (Lit DatatypeTypeType |st#0@@26|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|p#0@@25| T@U) (|st#0@@27| T@U) ) (!  (=> (or (|M2.__default.Oracle#canCall| |p#0@@25| |st#0@@27|) (and (< 4 $FunctionContextHeight) (and ($IsBox |p#0@@25| Tclass.M2.Path) ($Is DatatypeTypeType |st#0@@27| Tclass.M2.State)))) (and (and (and (|M2.__default.WellFounded#canCall| |p#0@@25|) (=> (M2.__default.WellFounded |p#0@@25|) (and (|M2.__default.GetCert#canCall| |p#0@@25|) (|M2.__default.OracleWF#canCall| |p#0@@25| (M2.__default.GetCert |p#0@@25|) |st#0@@27|)))) (=> (not (M2.__default.WellFounded |p#0@@25|)) (|M2.__default.OracleArbitrary#canCall| |p#0@@25|))) (= (M2.__default.Oracle |p#0@@25| |st#0@@27|) (ite (M2.__default.WellFounded |p#0@@25|) (M2.__default.OracleWF ($LS $LZ) |p#0@@25| (M2.__default.GetCert |p#0@@25|) |st#0@@27|) (M2.__default.OracleArbitrary |p#0@@25|)))))
 :qid |CloudMakeParallelBuildsdfy.104:25|
 :skolemid |3821|
 :pattern ( (M2.__default.Oracle |p#0@@25| |st#0@@27|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0@@28| T@U) ) (!  (=> (or (|M2.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@28|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |st#0@@28| Tclass.M2.State))) (and (M2.State.StateCons_q (Lit DatatypeTypeType |st#0@@28|)) (= (M2.__default.DomSt (Lit DatatypeTypeType |st#0@@28|)) (|Set#FromBoogieMap| (|lambda#19| Tclass.M2.Path (|Map#Domain| (M2.State.m (Lit DatatypeTypeType |st#0@@28|))))))))
 :qid |CloudMakeParallelBuildsdfy.9:24|
 :weight 3
 :skolemid |4267|
 :pattern ( (M2.__default.DomSt (Lit DatatypeTypeType |st#0@@28|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@13 T@U) (|p#0@@27| T@U) (|cert#0@@7| T@U) (|st#0@@29| T@U) ) (!  (=> (or (|M2.__default.OracleWF#canCall| |p#0@@27| (Lit DatatypeTypeType |cert#0@@7|) |st#0@@29|) (and (< 3 $FunctionContextHeight) (and (and (and ($IsBox |p#0@@27| Tclass.M2.Path) ($Is DatatypeTypeType |cert#0@@7| Tclass.M2.WFCertificate)) ($Is DatatypeTypeType |st#0@@29| Tclass.M2.State)) (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@27| (Lit DatatypeTypeType |cert#0@@7|))))) (and (and (and (and (|M2.__default.LocInv__Cmd#canCall| |p#0@@27|) (|M2.__default.LocInv__Deps#canCall| |p#0@@27|)) (|M2.__default.LocInv__Exp#canCall| |p#0@@27|)) (let ((|e#1| (M2.__default.LocInv__Exp |p#0@@27|)))
(let ((|deps#1@@0| (M2.__default.LocInv__Deps |p#0@@27|)))
(let ((|cmd#1@@0| (M2.__default.LocInv__Cmd |p#0@@27|)))
 (and (|M2.__default.CollectDependencies#canCall| |p#0@@27| (Lit DatatypeTypeType |cert#0@@7|) |deps#1@@0| |st#0@@29|) (|M2.__default.RunTool#canCall| |cmd#1@@0| (M2.__default.CollectDependencies ($LS $ly@@13) |p#0@@27| (Lit DatatypeTypeType |cert#0@@7|) |deps#1@@0| |st#0@@29|) |e#1|)))))) (= (M2.__default.OracleWF ($LS $ly@@13) |p#0@@27| (Lit DatatypeTypeType |cert#0@@7|) |st#0@@29|) (let ((|e#1@@0| (M2.__default.LocInv__Exp |p#0@@27|)))
(let ((|deps#1@@1| (M2.__default.LocInv__Deps |p#0@@27|)))
(let ((|cmd#1@@1| (M2.__default.LocInv__Cmd |p#0@@27|)))
(M2.__default.RunTool |cmd#1@@1| (M2.__default.CollectDependencies ($LS $ly@@13) |p#0@@27| (Lit DatatypeTypeType |cert#0@@7|) |deps#1@@1| |st#0@@29|) |e#1@@0|)))))))
 :qid |CloudMakeParallelBuildsdfy.653:18|
 :weight 3
 :skolemid |3849|
 :pattern ( (M2.__default.OracleWF ($LS $ly@@13) |p#0@@27| (Lit DatatypeTypeType |cert#0@@7|) |st#0@@29|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@12 T@U) ($ly@@14 T@U) (|p#0@@28| T@U) (|cert#0@@8| T@U) (|st#0@@30| T@U) ) (!  (=> (and (or (|M2.__default.OracleWF#canCall| |p#0@@28| |cert#0@@8| |st#0@@30|) (and (< 3 $FunctionContextHeight) (and (and (and (and ($IsBox |p#0@@28| Tclass.M2.Path) ($IsAllocBox |p#0@@28| Tclass.M2.Path $Heap@@12)) (and ($Is DatatypeTypeType |cert#0@@8| Tclass.M2.WFCertificate) ($IsAlloc DatatypeTypeType |cert#0@@8| Tclass.M2.WFCertificate $Heap@@12))) (and ($Is DatatypeTypeType |st#0@@30| Tclass.M2.State) ($IsAlloc DatatypeTypeType |st#0@@30| Tclass.M2.State $Heap@@12))) (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@28| |cert#0@@8|)))) ($IsGoodHeap $Heap@@12)) ($IsAllocBox (M2.__default.OracleWF $ly@@14 |p#0@@28| |cert#0@@8| |st#0@@30|) Tclass.M2.Artifact $Heap@@12))
 :qid |CloudMakeParallelBuildsdfy.653:18|
 :skolemid |3846|
 :pattern ( ($IsAllocBox (M2.__default.OracleWF $ly@@14 |p#0@@28| |cert#0@@8| |st#0@@30|) Tclass.M2.Artifact $Heap@@12))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|cmd#0@@8| T@U) (|deps#0@@12| T@U) (|exps#0@@4| T@U) (|st#0@@31| T@U) ) (!  (=> (or (|M2.__default.exec#canCall| |cmd#0@@8| |deps#0@@12| |exps#0@@4| |st#0@@31|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@8| (TSeq TChar)) ($Is SetType |deps#0@@12| (TSet Tclass.M2.Path))) ($Is SetType |exps#0@@4| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@31| Tclass.M2.State)))) ($Is DatatypeTypeType (M2.__default.exec |cmd#0@@8| |deps#0@@12| |exps#0@@4| |st#0@@31|) (Tclass.M2.Tuple (TSet Tclass.M2.Path) Tclass.M2.State)))
 :qid |CloudMakeParallelBuildsdfy.69:23|
 :skolemid |3594|
 :pattern ( (M2.__default.exec |cmd#0@@8| |deps#0@@12| |exps#0@@4| |st#0@@31|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@32| T@U) ) (!  (=> (or (|M2.__default.ValidState#canCall| (Lit DatatypeTypeType |st#0@@32|)) (and (< 3 $FunctionContextHeight) ($Is DatatypeTypeType |st#0@@32| Tclass.M2.State))) (and (forall ((|p#1| T@U) ) (!  (=> ($IsBox |p#1| Tclass.M2.Path) (and (|M2.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@32|)) (=> (|Set#IsMember| (Lit SetType (M2.__default.DomSt (Lit DatatypeTypeType |st#0@@32|))) |p#1|) (|M2.__default.WellFounded#canCall| |p#1|))))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |4284|
 :pattern ( (M2.__default.WellFounded |p#1|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st#0@@32|) |p#1|))
)) (= (M2.__default.ValidState (Lit DatatypeTypeType |st#0@@32|)) (forall ((|p#1@@0| T@U) ) (!  (=> ($IsBox |p#1@@0| Tclass.M2.Path) (=> (|Set#IsMember| (Lit SetType (M2.__default.DomSt (Lit DatatypeTypeType |st#0@@32|))) |p#1@@0|) (M2.__default.WellFounded |p#1@@0|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |4283|
 :pattern ( (M2.__default.WellFounded |p#1@@0|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st#0@@32|) |p#1@@0|))
)))))
 :qid |CloudMakeParallelBuildsdfy.13:30|
 :weight 3
 :skolemid |4285|
 :pattern ( (M2.__default.ValidState (Lit DatatypeTypeType |st#0@@32|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|p#0@@32| T@U) (|st#0@@33| T@U) ) (!  (=> (or (|M2.__default.GetSt#canCall| |p#0@@32| (Lit DatatypeTypeType |st#0@@33|)) (and (< 2 $FunctionContextHeight) (and (and ($IsBox |p#0@@32| Tclass.M2.Path) ($Is DatatypeTypeType |st#0@@33| Tclass.M2.State)) (|Set#IsMember| (Lit SetType (M2.__default.DomSt (Lit DatatypeTypeType |st#0@@33|))) |p#0@@32|)))) (and (M2.State.StateCons_q (Lit DatatypeTypeType |st#0@@33|)) (= (M2.__default.GetSt |p#0@@32| (Lit DatatypeTypeType |st#0@@33|)) (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType (M2.State.m (Lit DatatypeTypeType |st#0@@33|)))) |p#0@@32|))))
 :qid |CloudMakeParallelBuildsdfy.10:24|
 :weight 3
 :skolemid |4260|
 :pattern ( (M2.__default.GetSt |p#0@@32| (Lit DatatypeTypeType |st#0@@33|)))
))))
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|cmd#0@@10| T@U) (|deps#0@@14| T@U) (|exps#0@@5| T@U) (|st#0@@34| T@U) ) (!  (=> (or (|M2.__default.Pre#canCall| (Lit SeqType |cmd#0@@10|) (Lit SetType |deps#0@@14|) (Lit SetType |exps#0@@5|) |st#0@@34|) (and (< 5 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@10| (TSeq TChar)) ($Is SetType |deps#0@@14| (TSet Tclass.M2.Path))) ($Is SetType |exps#0@@5| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@34| Tclass.M2.State)))) (and (forall ((|e#1@@1| T@U) ) (!  (=> ($Is SeqType |e#1@@1| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@5|) ($Box SeqType |e#1@@1|)) (and (and (|M2.__default.Loc#canCall| (Lit SeqType |cmd#0@@10|) (Lit SetType |deps#0@@14|) |e#1@@1|) (|M2.__default.DomSt#canCall| |st#0@@34|)) (=> (|Set#IsMember| (M2.__default.DomSt |st#0@@34|) (M2.__default.Loc (Lit SeqType |cmd#0@@10|) (Lit SetType |deps#0@@14|) |e#1@@1|)) (and (and (|M2.__default.Loc#canCall| (Lit SeqType |cmd#0@@10|) (Lit SetType |deps#0@@14|) |e#1@@1|) (|M2.__default.GetSt#canCall| (M2.__default.Loc (Lit SeqType |cmd#0@@10|) (Lit SetType |deps#0@@14|) |e#1@@1|) |st#0@@34|)) (and (|M2.__default.Loc#canCall| (Lit SeqType |cmd#0@@10|) (Lit SetType |deps#0@@14|) |e#1@@1|) (|M2.__default.Oracle#canCall| (M2.__default.Loc (Lit SeqType |cmd#0@@10|) (Lit SetType |deps#0@@14|) |e#1@@1|) |st#0@@34|)))))))
...
)) (= (M2.__default.Pre (Lit SeqType |cmd#0@@10|) (Lit SetType |deps#0@@14|) (Lit SetType |exps#0@@5|) |st#0@@34|) (forall ((|e#1@@2| T@U) ) (!  (=> ($Is SeqType |e#1@@2| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@5|) ($Box SeqType |e#1@@2|)) (=> (|Set#IsMember| (M2.__default.DomSt |st#0@@34|) (M2.__default.Loc (Lit SeqType |cmd#0@@10|) (Lit SetType |deps#0@@14|) |e#1@@2|)) (= (M2.__default.GetSt (M2.__default.Loc (Lit SeqType |cmd#0@@10|) (Lit SetType |deps#0@@14|) |e#1@@2|) |st#0@@34|) (M2.__default.Oracle (M2.__default.Loc (Lit SeqType |cmd#0@@10|) (Lit SetType |deps#0@@14|) |e#1@@2|) |st#0@@34|)))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |4370|
 ...
 :weight 3
 :skolemid |4372|
 :pattern ( (M2.__default.Pre (Lit SeqType |cmd#0@@10|) (Lit SetType |deps#0@@14|) (Lit SetType |exps#0@@5|) |st#0@@34|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|p#0@@33| T@U) (|a#0@@2| T@U) (|st#0@@35| T@U) ) (!  (=> (or (|M2.__default.SetSt#canCall| (Lit BoxType |p#0@@33|) (Lit BoxType |a#0@@2|) (Lit DatatypeTypeType |st#0@@35|)) (and (< 1 $FunctionContextHeight) (and (and ($IsBox |p#0@@33| Tclass.M2.Path) ($IsBox |a#0@@2| Tclass.M2.Artifact)) ($Is DatatypeTypeType |st#0@@35| Tclass.M2.State)))) (and (M2.State.StateCons_q (Lit DatatypeTypeType |st#0@@35|)) (= (M2.__default.SetSt (Lit BoxType |p#0@@33|) (Lit BoxType |a#0@@2|) (Lit DatatypeTypeType |st#0@@35|)) (|#M2.State.StateCons| (|Map#Build| (Lit MapType (M2.State.m (Lit DatatypeTypeType |st#0@@35|))) (Lit BoxType |p#0@@33|) (Lit BoxType |a#0@@2|))))))
 :qid |CloudMakeParallelBuildsdfy.468:24|
 :weight 3
 :skolemid |3502|
 :pattern ( (M2.__default.SetSt (Lit BoxType |p#0@@33|) (Lit BoxType |a#0@@2|) (Lit DatatypeTypeType |st#0@@35|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@18 T@U) (|cmd#0@@11| T@U) (|deps#0@@15| T@U) (|restrictedState#0@@1| T@U) (|exps#0@@6| T@U) (|st#0@@36| T@U) ) (!  (=> (or (|M2.__default.execOne#canCall| (Lit SeqType |cmd#0@@11|) (Lit SetType |deps#0@@15|) (Lit MapType |restrictedState#0@@1|) (Lit SetType |exps#0@@6|) (Lit DatatypeTypeType |st#0@@36|)) (and (< 2 $FunctionContextHeight) (and (and (and (and ($Is SeqType |cmd#0@@11| (TSeq TChar)) ($Is SetType |deps#0@@15| (TSet Tclass.M2.Path))) ($Is MapType |restrictedState#0@@1| (TMap Tclass.M2.Path Tclass.M2.Artifact))) ($Is SetType |exps#0@@6| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@36| Tclass.M2.State)))) (and (=> (not (|Set#Equal| |exps#0@@6| |Set#Empty|)) (and (|M2.__default.PickOne#canCall| (TSeq TChar) (Lit SetType |exps#0@@6|)) (let ((|exp#1| (Lit SeqType ($Unbox SeqType (M2.__default.PickOne (TSeq TChar) (Lit SetType |exps#0@@6|))))))
 (and (|M2.__default.execOne#canCall| (Lit SeqType |cmd#0@@11|) (Lit SetType |deps#0@@15|) (Lit MapType |restrictedState#0@@1|) (|Set#Difference| |exps#0@@6| (|Set#UnionOne| |Set#Empty| ($Box SeqType |exp#1|))) (Lit DatatypeTypeType |st#0@@36|)) (let ((|st'#1| ($Unbox DatatypeTypeType (M2.Tuple.snd (M2.__default.execOne ($LS $ly@@18) (Lit SeqType |cmd#0@@11|) (Lit SetType |deps#0@@15|) (Lit MapType |restrictedState#0@@1|) (|Set#Difference| |exps#0@@6| (|Set#UnionOne| |Set#Empty| ($Box SeqType |exp#1|))) (Lit DatatypeTypeType |st#0@@36|))))))
 ...
 (and (|M2.__default.DomSt#canCall| |st'#1|) (=> (not (|Set#IsMember| (M2.__default.DomSt |st'#1|) |p#1@@1|)) (and (|M2.__default.RunTool#canCall| (Lit SeqType |cmd#0@@11|) (Lit MapType |restrictedState#0@@1|) |exp#1|) (|M2.__default.SetSt#canCall| |p#1@@1| (M2.__default.RunTool (Lit SeqType |cmd#0@@11|) (Lit MapType |restrictedState#0@@1|) |exp#1|) |st'#1|))))))))))) (= (M2.__default.execOne ($LS $ly@@18) (Lit SeqType |cmd#0@@11|) (Lit SetType |deps#0@@15|) (Lit MapType |restrictedState#0@@1|) (Lit SetType |exps#0@@6|) (Lit DatatypeTypeType |st#0@@36|)) (ite (|Set#Equal| |exps#0@@6| |Set#Empty|) (|#M2.Tuple.Pair| ($Box SetType (Lit SetType |Set#Empty|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |st#0@@36|))) (let ((|exp#1@@0| (Lit SeqType ($Unbox SeqType (M2.__default.PickOne (TSeq TChar) (Lit SetType |exps#0@@6|))))))
(let ((|st'#1@@0| ($Unbox DatatypeTypeType (M2.Tuple.snd (M2.__default.execOne ($LS $ly@@18) (Lit SeqType |cmd#0@@11|) (Lit SetType |deps#0@@15|) (Lit MapType |restrictedState#0@@1|) (|Set#Difference| |exps#0@@6| (|Set#UnionOne| |Set#Empty| ($Box SeqType |exp#1@@0|))) (Lit DatatypeTypeType |st#0@@36|))))))
(let ((|paths#1| ($Unbox SetType (M2.Tuple.fst (M2.__default.execOne ($LS $ly@@18) (Lit SeqType |cmd#0@@11|) (Lit SetType |deps#0@@15|) (Lit MapType |restrictedState#0@@1|) (|Set#Difference| |exps#0@@6| (|Set#UnionOne| |Set#Empty| ($Box SeqType |exp#1@@0|))) (Lit DatatypeTypeType |st#0@@36|))))))
...
(|#M2.Tuple.Pair| ($Box SetType (|Set#Union| |paths#1| (|Set#UnionOne| |Set#Empty| |p#1@@2|))) ($Box DatatypeTypeType (ite (|Set#IsMember| (M2.__default.DomSt |st'#1@@0|) |p#1@@2|) |st'#1@@0| (M2.__default.SetSt |p#1@@2| (M2.__default.RunTool (Lit SeqType |cmd#0@@11|) (Lit MapType |restrictedState#0@@1|) |exp#1@@0|) |st'#1@@0|))))))))))))
 ...
 :weight 3
 :skolemid |3608|
 :pattern ( (M2.__default.execOne ($LS $ly@@18) (Lit SeqType |cmd#0@@11|) (Lit SetType |deps#0@@15|) (Lit MapType |restrictedState#0@@1|) (Lit SetType |exps#0@@6|) (Lit DatatypeTypeType |st#0@@36|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@14 T@U) ($ly@@19 T@U) (|p#0@@34| T@U) (|cert#0@@11| T@U) (|deps#0@@16| T@U) (|st#0@@37| T@U) ) (!  (=> (and (or (|M2.__default.CollectDependencies#canCall| |p#0@@34| |cert#0@@11| |deps#0@@16| |st#0@@37|) (and (< 3 $FunctionContextHeight) (and (and (and (and (and ($IsBox |p#0@@34| Tclass.M2.Path) ($IsAllocBox |p#0@@34| Tclass.M2.Path $Heap@@14)) (and ($Is DatatypeTypeType |cert#0@@11| Tclass.M2.WFCertificate) ($IsAlloc DatatypeTypeType |cert#0@@11| Tclass.M2.WFCertificate $Heap@@14))) (and ($Is SetType |deps#0@@16| (TSet Tclass.M2.Path)) ($IsAlloc SetType |deps#0@@16| (TSet Tclass.M2.Path) $Heap@@14))) (and ($Is DatatypeTypeType |st#0@@37| Tclass.M2.State) ($IsAlloc DatatypeTypeType |st#0@@37| Tclass.M2.State $Heap@@14))) (and (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@34| |cert#0@@11|) (|Set#Equal| |deps#0@@16| (M2.__default.LocInv__Deps |p#0@@34|)))))) ($IsGoodHeap $Heap@@14)) ($IsAlloc MapType (M2.__default.CollectDependencies $ly@@19 |p#0@@34| |cert#0@@11| |deps#0@@16| |st#0@@37|) (TMap Tclass.M2.Path Tclass.M2.Artifact) $Heap@@14))
 :qid |CloudMakeParallelBuildsdfy.660:18|
 :skolemid |3867|
 :pattern ( ($IsAlloc MapType (M2.__default.CollectDependencies $ly@@19 |p#0@@34| |cert#0@@11| |deps#0@@16| |st#0@@37|) (TMap Tclass.M2.Path Tclass.M2.Artifact) $Heap@@14))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|p#0@@36| T@U) (|st#0@@38| T@U) ) (!  (=> (or (|M2.__default.Oracle#canCall| |p#0@@36| (Lit DatatypeTypeType |st#0@@38|)) (and (< 4 $FunctionContextHeight) (and ($IsBox |p#0@@36| Tclass.M2.Path) ($Is DatatypeTypeType |st#0@@38| Tclass.M2.State)))) (and (and (and (|M2.__default.WellFounded#canCall| |p#0@@36|) (=> (M2.__default.WellFounded |p#0@@36|) (and (|M2.__default.GetCert#canCall| |p#0@@36|) (|M2.__default.OracleWF#canCall| |p#0@@36| (M2.__default.GetCert |p#0@@36|) (Lit DatatypeTypeType |st#0@@38|))))) (=> (not (M2.__default.WellFounded |p#0@@36|)) (|M2.__default.OracleArbitrary#canCall| |p#0@@36|))) (= (M2.__default.Oracle |p#0@@36| (Lit DatatypeTypeType |st#0@@38|)) (ite (M2.__default.WellFounded |p#0@@36|) (M2.__default.OracleWF ($LS $LZ) |p#0@@36| (M2.__default.GetCert |p#0@@36|) (Lit DatatypeTypeType |st#0@@38|)) (M2.__default.OracleArbitrary |p#0@@36|)))))
 :qid |CloudMakeParallelBuildsdfy.104:25|
 :weight 3
 :skolemid |3822|
 :pattern ( (M2.__default.Oracle |p#0@@36| (Lit DatatypeTypeType |st#0@@38|)))
))))
...
(let ((|sts''#0| (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |st'#3|)) |sts'#0|)))
 ...
 (and (M2.Tuple.Pair_q |ps#0|) (M2.Tuple.Pair_q |ps#0|)))))))))))))))))))))))))))))) (= (M2.__default.eval ($LS $ly@@22) |expr#0@@1| |st#0@@39| |env#0@@7|) (ite (M2.__default.Value |expr#0@@1|) (|#M2.Tuple.Pair| ($Box DatatypeTypeType |expr#0@@1|) ($Box DatatypeTypeType |st#0@@39|)) (ite (M2.Expression.exprIdentifier_q |expr#0@@1|) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (M2.__default.GetEnv (M2.Expression.id |expr#0@@1|) |env#0@@7|)) ($Box DatatypeTypeType |st#0@@39|)) (ite (M2.Expression.exprIf_q |expr#0@@1|) (let ((|st'#0@@3| ($Unbox DatatypeTypeType (M2.Tuple.snd (M2.__default.eval $ly@@22 (M2.Expression.cond |expr#0@@1|) |st#0@@39| |env#0@@7|)))))
(let ((|cond'#0@@0| ($Unbox DatatypeTypeType (M2.Tuple.fst (M2.__default.eval $ly@@22 (M2.Expression.cond |expr#0@@1|) |st#0@@39| |env#0@@7|)))))
(ite  (and (M2.Expression.exprLiteral_q |cond'#0@@0|) (|M2.Literal#Equal| (M2.Expression.lit |cond'#0@@0|) |#M2.Literal.litTrue|)) (M2.__default.eval $ly@@22 (M2.Expression.ifTrue |expr#0@@1|) |st'#0@@3| |env#0@@7|) (ite  (and (M2.Expression.exprLiteral_q |cond'#0@@0|) (|M2.Literal#Equal| (M2.Expression.lit |cond'#0@@0|) |#M2.Literal.litFalse|)) (M2.__default.eval $ly@@22 (M2.Expression.ifFalse |expr#0@@1|) |st'#0@@3| |env#0@@7|) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprError| (Lit DatatypeTypeType |#M2.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@39|)))))) (ite (M2.Expression.exprAnd_q |expr#0@@1|) (let ((|st'#1@@4| ($Unbox DatatypeTypeType (M2.Tuple.snd (M2.__default.eval $ly@@22 (M2.Expression.conj0 |expr#0@@1|) |st#0@@39| |env#0@@7|)))))
(let ((|conj0'#0@@0| ($Unbox DatatypeTypeType (M2.Tuple.fst (M2.__default.eval $ly@@22 (M2.Expression.conj0 |expr#0@@1|) |st#0@@39| |env#0@@7|)))))
(ite  (and (M2.Expression.exprLiteral_q |conj0'#0@@0|) (|M2.Literal#Equal| (M2.Expression.lit |conj0'#0@@0|) |#M2.Literal.litTrue|)) (M2.__default.eval $ly@@22 (M2.Expression.conj1 |expr#0@@1|) |st'#1@@4| |env#0@@7|) (ite  (and (M2.Expression.exprLiteral_q |conj0'#0@@0|) (|M2.Literal#Equal| (M2.Expression.lit |conj0'#0@@0|) |#M2.Literal.litFalse|)) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprLiteral| (Lit DatatypeTypeType |#M2.Literal.litFalse|)))) ($Box DatatypeTypeType |st'#1@@4|)) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprError| (Lit DatatypeTypeType |#M2.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@39|)))))) (ite (M2.Expression.exprOr_q |expr#0@@1|) (let ((|st'#2@@0| ($Unbox DatatypeTypeType (M2.Tuple.snd (M2.__default.eval $ly@@22 (M2.Expression.disj0 |expr#0@@1|) |st#0@@39| |env#0@@7|)))))
(let ((|disj0'#0@@0| ($Unbox DatatypeTypeType (M2.Tuple.fst (M2.__default.eval $ly@@22 (M2.Expression.disj0 |expr#0@@1|) |st#0@@39| |env#0@@7|)))))
(ite  (and (M2.Expression.exprLiteral_q |disj0'#0@@0|) (|M2.Literal#Equal| (M2.Expression.lit |disj0'#0@@0|) |#M2.Literal.litTrue|)) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprLiteral| (Lit DatatypeTypeType |#M2.Literal.litTrue|)))) ($Box DatatypeTypeType |st'#2@@0|)) (ite  (and (M2.Expression.exprLiteral_q |disj0'#0@@0|) (|M2.Literal#Equal| (M2.Expression.lit |disj0'#0@@0|) |#M2.Literal.litFalse|)) (M2.__default.eval $ly@@22 (M2.Expression.disj1 |expr#0@@1|) |st'#2@@0| |env#0@@7|) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprError| (Lit DatatypeTypeType |#M2.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@39|)))))) (ite (M2.Expression.exprInvocation_q |expr#0@@1|) (let ((|st'#3@@0| ($Unbox DatatypeTypeType (M2.Tuple.snd (M2.__default.eval $ly@@22 (M2.Expression.fun |expr#0@@1|) |st#0@@39| |env#0@@7|)))))
(let ((|fun'#0@@0| ($Unbox DatatypeTypeType (M2.Tuple.fst (M2.__default.eval $ly@@22 (M2.Expression.fun |expr#0@@1|) |st#0@@39| |env#0@@7|)))))
(let ((|sts'#0@@0| ($Unbox SetType (M2.Tuple.snd (M2.__default.evalArgs $ly@@22 |expr#0@@1| (M2.Expression.args |expr#0@@1|) |st#0@@39| |env#0@@7|)))))
(let ((|args'#0@@0| ($Unbox SeqType (M2.Tuple.fst (M2.__default.evalArgs $ly@@22 |expr#0@@1| (M2.Expression.args |expr#0@@1|) |st#0@@39| |env#0@@7|)))))
(let ((|sts''#0@@0| (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |st'#3@@0|)) |sts'#0@@0|)))
(ite  (not (M2.__default.Compatible |sts''#0@@0|)) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprError| (Lit DatatypeTypeType |#M2.Reason.rCompatibility|)))) ($Box DatatypeTypeType |st#0@@39|)) (let ((|stCombined#0@@0| (M2.__default.Combine ($LS $LZ) |sts''#0@@0|)))
...
(|#M2.Tuple.Pair| ($Box DatatypeTypeType (|#M2.Expression.exprLiteral| (|#M2.Literal.litArrOfPaths| ($Unbox SetType (M2.Tuple.fst |ps#0@@0|))))) (M2.Tuple.snd |ps#0@@0|))) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprError| (Lit DatatypeTypeType |#M2.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@39|))) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprError| (Lit DatatypeTypeType |#M2.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@39|))) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprError| (Lit DatatypeTypeType |#M2.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@39|)))))))))) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprError| (Lit DatatypeTypeType |#M2.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@39|)))))))))))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |4515|
 :pattern ( (M2.__default.eval ($LS $ly@@22) |expr#0@@1| |st#0@@39| |env#0@@7|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|sts#0@@3| T@U) ) (!  (=> (or (|M2.__default.Compatible#canCall| |sts#0@@3|) (and (< 3 $FunctionContextHeight) ($Is SetType |sts#0@@3| (TSet Tclass.M2.State)))) (and (forall ((|st#0@@40| T@U) (|st'#0@@4| T@U) (|p#0@@37| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |st#0@@40| Tclass.M2.State) ($Is DatatypeTypeType |st'#0@@4| Tclass.M2.State)) ($IsBox |p#0@@37| Tclass.M2.Path)) (=> (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st#0@@40|)) (=> (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st'#0@@4|)) (and (|M2.__default.DomSt#canCall| |st#0@@40|) (=> (|Set#IsMember| (M2.__default.DomSt |st#0@@40|) |p#0@@37|) (and (|M2.__default.DomSt#canCall| |st'#0@@4|) (=> (|Set#IsMember| (M2.__default.DomSt |st'#0@@4|) |p#0@@37|) (and (|M2.__default.GetSt#canCall| |p#0@@37| |st#0@@40|) (|M2.__default.GetSt#canCall| |p#0@@37| |st'#0@@4|)))))))))
 :qid |CloudMakeParallelBuildsdfy.32:12|
 :skolemid |4300|
 :pattern ( (M2.__default.GetSt |p#0@@37| |st'#0@@4|) (M2.__default.GetSt |p#0@@37| |st#0@@40|))
 :pattern ( (M2.__default.GetSt |p#0@@37| |st'#0@@4|) (M2.__default.DomSt |st#0@@40|))
 :pattern ( (M2.__default.GetSt |p#0@@37| |st'#0@@4|) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st#0@@40|)))
 :pattern ( (M2.__default.GetSt |p#0@@37| |st#0@@40|) (M2.__default.DomSt |st'#0@@4|))
 :pattern ( (M2.__default.GetSt |p#0@@37| |st#0@@40|) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st'#0@@4|)))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st'#0@@4|) |p#0@@37|) (M2.__default.DomSt |st#0@@40|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st'#0@@4|) |p#0@@37|) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st#0@@40|)))
 :pattern ( (M2.__default.DomSt |st'#0@@4|) (|Set#IsMember| (M2.__default.DomSt |st#0@@40|) |p#0@@37|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st#0@@40|) |p#0@@37|) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st'#0@@4|)))
)) (= (M2.__default.Compatible |sts#0@@3|) (forall ((|st#0@@41| T@U) (|st'#0@@5| T@U) (|p#0@@38| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |st#0@@41| Tclass.M2.State) ($Is DatatypeTypeType |st'#0@@5| Tclass.M2.State)) ($IsBox |p#0@@38| Tclass.M2.Path)) (=> (and (and (and (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st#0@@41|)) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st'#0@@5|))) (|Set#IsMember| (M2.__default.DomSt |st#0@@41|) |p#0@@38|)) (|Set#IsMember| (M2.__default.DomSt |st'#0@@5|) |p#0@@38|)) (= (M2.__default.GetSt |p#0@@38| |st#0@@41|) (M2.__default.GetSt |p#0@@38| |st'#0@@5|))))
 :qid |CloudMakeParallelBuildsdfy.32:12|
 :skolemid |4299|
 :pattern ( (M2.__default.GetSt |p#0@@38| |st'#0@@5|) (M2.__default.GetSt |p#0@@38| |st#0@@41|))
 :pattern ( (M2.__default.GetSt |p#0@@38| |st'#0@@5|) (M2.__default.DomSt |st#0@@41|))
 :pattern ( (M2.__default.GetSt |p#0@@38| |st'#0@@5|) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st#0@@41|)))
 :pattern ( (M2.__default.GetSt |p#0@@38| |st#0@@41|) (M2.__default.DomSt |st'#0@@5|))
 :pattern ( (M2.__default.GetSt |p#0@@38| |st#0@@41|) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st'#0@@5|)))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st'#0@@5|) |p#0@@38|) (M2.__default.DomSt |st#0@@41|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st'#0@@5|) |p#0@@38|) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st#0@@41|)))
 :pattern ( (M2.__default.DomSt |st'#0@@5|) (|Set#IsMember| (M2.__default.DomSt |st#0@@41|) |p#0@@38|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st#0@@41|) |p#0@@38|) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st'#0@@5|)))
)))))
 :qid |CloudMakeParallelBuildsdfy.30:30|
 :skolemid |4301|
 :pattern ( (M2.__default.Compatible |sts#0@@3|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|p#0@@39| T@U) (|a#0@@3| T@U) (|st#0@@42| T@U) ) (!  (=> (or (|M2.__default.SetSt#canCall| |p#0@@39| |a#0@@3| |st#0@@42|) (and (< 1 $FunctionContextHeight) (and (and ($IsBox |p#0@@39| Tclass.M2.Path) ($IsBox |a#0@@3| Tclass.M2.Artifact)) ($Is DatatypeTypeType |st#0@@42| Tclass.M2.State)))) ($Is DatatypeTypeType (M2.__default.SetSt |p#0@@39| |a#0@@3| |st#0@@42|) Tclass.M2.State))
 :qid |CloudMakeParallelBuildsdfy.468:24|
 :skolemid |3497|
 :pattern ( (M2.__default.SetSt |p#0@@39| |a#0@@3| |st#0@@42|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|cmd#0@@12| T@U) (|deps#0@@17| T@U) (|exps#0@@7| T@U) (|st#0@@43| T@U) ) (!  (=> (or (|M2.__default.exec#canCall| |cmd#0@@12| |deps#0@@17| |exps#0@@7| |st#0@@43|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@12| (TSeq TChar)) ($Is SetType |deps#0@@17| (TSet Tclass.M2.Path))) ($Is SetType |exps#0@@7| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@43| Tclass.M2.State)))) (and (and (|M2.__default.Restrict#canCall| |deps#0@@17| |st#0@@43|) (|M2.__default.execOne#canCall| |cmd#0@@12| |deps#0@@17| (M2.__default.Restrict |deps#0@@17| |st#0@@43|) |exps#0@@7| |st#0@@43|)) (= (M2.__default.exec |cmd#0@@12| |deps#0@@17| |exps#0@@7| |st#0@@43|) (M2.__default.execOne ($LS $LZ) |cmd#0@@12| |deps#0@@17| (M2.__default.Restrict |deps#0@@17| |st#0@@43|) |exps#0@@7| |st#0@@43|))))
 :qid |CloudMakeParallelBuildsdfy.69:23|
 :skolemid |3597|
 :pattern ( (M2.__default.exec |cmd#0@@12| |deps#0@@17| |exps#0@@7| |st#0@@43|))
))))
...
(assert  (=> (<= 7 $FunctionContextHeight) (forall (($ly@@24 T@U) (|expr#0@@2| T@U) (|st#0@@44| T@U) (|env#0@@8| T@U) ) (!  (=> (or (|M2.__default.eval#canCall| |expr#0@@2| |st#0@@44| |env#0@@8|) (and (< 7 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0@@2| Tclass.M2.Expression) ($Is DatatypeTypeType |st#0@@44| Tclass.M2.State)) ($IsBox |env#0@@8| Tclass.M2.Env)) (M2.__default.ValidEnv |env#0@@8|)))) ($Is DatatypeTypeType (M2.__default.eval $ly@@24 |expr#0@@2| |st#0@@44| |env#0@@8|) (Tclass.M2.Tuple Tclass.M2.Expression Tclass.M2.State)))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |4512|
 :pattern ( (M2.__default.eval $ly@@24 |expr#0@@2| |st#0@@44| |env#0@@8|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@17 T@U) (|paths#0@@3| T@U) (|st#0@@45| T@U) ) (!  (=> (and (or (|M2.__default.Restrict#canCall| |paths#0@@3| |st#0@@45|) (and (< 3 $FunctionContextHeight) (and (and ($Is SetType |paths#0@@3| (TSet Tclass.M2.Path)) ($IsAlloc SetType |paths#0@@3| (TSet Tclass.M2.Path) $Heap@@17)) (and ($Is DatatypeTypeType |st#0@@45| Tclass.M2.State) ($IsAlloc DatatypeTypeType |st#0@@45| Tclass.M2.State $Heap@@17))))) ($IsGoodHeap $Heap@@17)) ($IsAlloc MapType (M2.__default.Restrict |paths#0@@3| |st#0@@45|) (TMap Tclass.M2.Path Tclass.M2.Artifact) $Heap@@17))
 :qid |CloudMakeParallelBuildsdfy.473:18|
 :skolemid |3504|
 :pattern ( ($IsAlloc MapType (M2.__default.Restrict |paths#0@@3| |st#0@@45|) (TMap Tclass.M2.Path Tclass.M2.Artifact) $Heap@@17))
))))
...
(assert (forall (($ly@@25 T@U) (|cmd#0@@13| T@U) (|deps#0@@18| T@U) (|restrictedState#0@@2| T@U) (|exps#0@@8| T@U) (|st#0@@46| T@U) ) (! (= (M2.__default.execOne ($LS $ly@@25) |cmd#0@@13| |deps#0@@18| |restrictedState#0@@2| |exps#0@@8| |st#0@@46|) (M2.__default.execOne $ly@@25 |cmd#0@@13| |deps#0@@18| |restrictedState#0@@2| |exps#0@@8| |st#0@@46|))
 :qid |CloudMakeParallelBuildsdfy.513:18|
 :skolemid |3602|
 :pattern ( (M2.__default.execOne ($LS $ly@@25) |cmd#0@@13| |deps#0@@18| |restrictedState#0@@2| |exps#0@@8| |st#0@@46|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@28 T@U) (|p#0@@46| T@U) (|cert#0@@14| T@U) (|deps#0@@19| T@U) (|st#0@@47| T@U) ) (!  (=> (or (|M2.__default.CollectDependencies#canCall| |p#0@@46| |cert#0@@14| |deps#0@@19| |st#0@@47|) (and (< 3 $FunctionContextHeight) (and (and (and (and ($IsBox |p#0@@46| Tclass.M2.Path) ($Is DatatypeTypeType |cert#0@@14| Tclass.M2.WFCertificate)) ($Is SetType |deps#0@@19| (TSet Tclass.M2.Path))) ($Is DatatypeTypeType |st#0@@47| Tclass.M2.State)) (and (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@46| |cert#0@@14|) (|Set#Equal| |deps#0@@19| (M2.__default.LocInv__Deps |p#0@@46|)))))) ($Is MapType (M2.__default.CollectDependencies $ly@@28 |p#0@@46| |cert#0@@14| |deps#0@@19| |st#0@@47|) (TMap Tclass.M2.Path Tclass.M2.Artifact)))
 :qid |CloudMakeParallelBuildsdfy.660:18|
 :skolemid |3866|
 :pattern ( (M2.__default.CollectDependencies $ly@@28 |p#0@@46| |cert#0@@14| |deps#0@@19| |st#0@@47|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@21 T@U) ($ly@@29 T@U) (|cmd#0@@14| T@U) (|deps#0@@20| T@U) (|restrictedState#0@@3| T@U) (|exps#0@@9| T@U) (|st#0@@48| T@U) ) (!  (=> (and (or (|M2.__default.execOne#canCall| |cmd#0@@14| |deps#0@@20| |restrictedState#0@@3| |exps#0@@9| |st#0@@48|) (and (< 2 $FunctionContextHeight) (and (and (and (and (and ($Is SeqType |cmd#0@@14| (TSeq TChar)) ($IsAlloc SeqType |cmd#0@@14| (TSeq TChar) $Heap@@21)) (and ($Is SetType |deps#0@@20| (TSet Tclass.M2.Path)) ($IsAlloc SetType |deps#0@@20| (TSet Tclass.M2.Path) $Heap@@21))) (and ($Is MapType |restrictedState#0@@3| (TMap Tclass.M2.Path Tclass.M2.Artifact)) ($IsAlloc MapType |restrictedState#0@@3| (TMap Tclass.M2.Path Tclass.M2.Artifact) $Heap@@21))) (and ($Is SetType |exps#0@@9| (TSet (TSeq TChar))) ($IsAlloc SetType |exps#0@@9| (TSet (TSeq TChar)) $Heap@@21))) (and ($Is DatatypeTypeType |st#0@@48| Tclass.M2.State) ($IsAlloc DatatypeTypeType |st#0@@48| Tclass.M2.State $Heap@@21))))) ($IsGoodHeap $Heap@@21)) ($IsAlloc DatatypeTypeType (M2.__default.execOne $ly@@29 |cmd#0@@14| |deps#0@@20| |restrictedState#0@@3| |exps#0@@9| |st#0@@48|) (Tclass.M2.Tuple (TSet Tclass.M2.Path) Tclass.M2.State) $Heap@@21))
 :qid |CloudMakeParallelBuildsdfy.513:18|
 :skolemid |3605|
 :pattern ( ($IsAlloc DatatypeTypeType (M2.__default.execOne $ly@@29 |cmd#0@@14| |deps#0@@20| |restrictedState#0@@3| |exps#0@@9| |st#0@@48|) (Tclass.M2.Tuple (TSet Tclass.M2.Path) Tclass.M2.State) $Heap@@21))
))))
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|st#0@@49| T@U) (|st'#0@@6| T@U) ) (!  (=> (or (|M2.__default.Extends#canCall| (Lit DatatypeTypeType |st#0@@49|) (Lit DatatypeTypeType |st'#0@@6|)) (and (< 5 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@49| Tclass.M2.State) ($Is DatatypeTypeType |st'#0@@6| Tclass.M2.State)))) (and (and (and (|M2.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@49|)) (|M2.__default.DomSt#canCall| (Lit DatatypeTypeType |st'#0@@6|))) (=> (|Set#Subset| (M2.__default.DomSt (Lit DatatypeTypeType |st#0@@49|)) (M2.__default.DomSt (Lit DatatypeTypeType |st'#0@@6|))) (and (forall ((|p#2| T@U) ) (!  (=> ($IsBox |p#2| Tclass.M2.Path) (and (|M2.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@49|)) (=> (|Set#IsMember| (Lit SetType (M2.__default.DomSt (Lit DatatypeTypeType |st#0@@49|))) |p#2|) (and (|M2.__default.GetSt#canCall| |p#2| (Lit DatatypeTypeType |st'#0@@6|)) (|M2.__default.GetSt#canCall| |p#2| (Lit DatatypeTypeType |st#0@@49|))))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |4427|
 :pattern ( (M2.__default.GetSt |p#2| |st#0@@49|))
 :pattern ( (M2.__default.GetSt |p#2| |st'#0@@6|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st#0@@49|) |p#2|))
)) (=> (forall ((|p#2@@0| T@U) ) (!  (=> ($IsBox |p#2@@0| Tclass.M2.Path) (=> (|Set#IsMember| (Lit SetType (M2.__default.DomSt (Lit DatatypeTypeType |st#0@@49|))) |p#2@@0|) (= (M2.__default.GetSt |p#2@@0| (Lit DatatypeTypeType |st'#0@@6|)) (M2.__default.GetSt |p#2@@0| (Lit DatatypeTypeType |st#0@@49|)))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |4429|
 :pattern ( (M2.__default.GetSt |p#2@@0| |st#0@@49|))
 :pattern ( (M2.__default.GetSt |p#2@@0| |st'#0@@6|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st#0@@49|) |p#2@@0|))
)) (forall ((|p#3| T@U) ) (!  (=> ($IsBox |p#3| Tclass.M2.Path) (and (|M2.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@49|)) (=> (not (|Set#IsMember| (Lit SetType (M2.__default.DomSt (Lit DatatypeTypeType |st#0@@49|))) |p#3|)) (and (|M2.__default.DomSt#canCall| (Lit DatatypeTypeType |st'#0@@6|)) (=> (|Set#IsMember| (Lit SetType (M2.__default.DomSt (Lit DatatypeTypeType |st'#0@@6|))) |p#3|) (and (|M2.__default.GetSt#canCall| |p#3| (Lit DatatypeTypeType |st'#0@@6|)) (|M2.__default.Oracle#canCall| |p#3| (Lit DatatypeTypeType |st#0@@49|))))))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |4428|
 :pattern ( (M2.__default.Oracle |p#3| |st#0@@49|))
 :pattern ( (M2.__default.GetSt |p#3| |st'#0@@6|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st'#0@@6|) |p#3|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st#0@@49|) |p#3|))
)))))) (= (M2.__default.Extends (Lit DatatypeTypeType |st#0@@49|) (Lit DatatypeTypeType |st'#0@@6|))  (and (and (|Set#Subset| (M2.__default.DomSt (Lit DatatypeTypeType |st#0@@49|)) (M2.__default.DomSt (Lit DatatypeTypeType |st'#0@@6|))) (forall ((|p#2@@1| T@U) ) (!  (=> ($IsBox |p#2@@1| Tclass.M2.Path) (=> (|Set#IsMember| (Lit SetType (M2.__default.DomSt (Lit DatatypeTypeType |st#0@@49|))) |p#2@@1|) (= (M2.__default.GetSt |p#2@@1| (Lit DatatypeTypeType |st'#0@@6|)) (M2.__default.GetSt |p#2@@1| (Lit DatatypeTypeType |st#0@@49|)))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |4425|
 :pattern ( (M2.__default.GetSt |p#2@@1| |st#0@@49|))
 :pattern ( (M2.__default.GetSt |p#2@@1| |st'#0@@6|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st#0@@49|) |p#2@@1|))
))) (forall ((|p#3@@0| T@U) ) (!  (=> ($IsBox |p#3@@0| Tclass.M2.Path) (=> (and (not (|Set#IsMember| (Lit SetType (M2.__default.DomSt (Lit DatatypeTypeType |st#0@@49|))) |p#3@@0|)) (|Set#IsMember| (Lit SetType (M2.__default.DomSt (Lit DatatypeTypeType |st'#0@@6|))) |p#3@@0|)) (= (M2.__default.GetSt |p#3@@0| (Lit DatatypeTypeType |st'#0@@6|)) (M2.__default.Oracle |p#3@@0| (Lit DatatypeTypeType |st#0@@49|)))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |4426|
 :pattern ( (M2.__default.Oracle |p#3@@0| |st#0@@49|))
 :pattern ( (M2.__default.GetSt |p#3@@0| |st'#0@@6|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st'#0@@6|) |p#3@@0|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st#0@@49|) |p#3@@0|))
))))))
 :qid |CloudMakeParallelBuildsdfy.112:27|
 :weight 3
 :skolemid |4430|
 :pattern ( (M2.__default.Extends (Lit DatatypeTypeType |st#0@@49|) (Lit DatatypeTypeType |st'#0@@6|)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|p#0@@47| T@U) (|a#0@@4| T@U) (|st#0@@50| T@U) ) (!  (=> (or (|M2.__default.SetSt#canCall| |p#0@@47| |a#0@@4| |st#0@@50|) (and (< 1 $FunctionContextHeight) (and (and ($IsBox |p#0@@47| Tclass.M2.Path) ($IsBox |a#0@@4| Tclass.M2.Artifact)) ($Is DatatypeTypeType |st#0@@50| Tclass.M2.State)))) (and (M2.State.StateCons_q |st#0@@50|) (= (M2.__default.SetSt |p#0@@47| |a#0@@4| |st#0@@50|) (|#M2.State.StateCons| (|Map#Build| (M2.State.m |st#0@@50|) |p#0@@47| |a#0@@4|)))))
 :qid |CloudMakeParallelBuildsdfy.468:24|
 :skolemid |3500|
 :pattern ( (M2.__default.SetSt |p#0@@47| |a#0@@4| |st#0@@50|))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|cmd#0@@15| T@U) (|deps#0@@21| T@U) (|exps#0@@10| T@U) (|st#0@@51| T@U) ) (!  (=> (or (|M2.__default.Pre#canCall| |cmd#0@@15| |deps#0@@21| |exps#0@@10| |st#0@@51|) (and (< 5 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@15| (TSeq TChar)) ($Is SetType |deps#0@@21| (TSet Tclass.M2.Path))) ($Is SetType |exps#0@@10| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@51| Tclass.M2.State)))) (and (forall ((|e#0@@1| T@U) ) (!  (=> ($Is SeqType |e#0@@1| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@10| ($Box SeqType |e#0@@1|)) (and (and (|M2.__default.Loc#canCall| |cmd#0@@15| |deps#0@@21| |e#0@@1|) (|M2.__default.DomSt#canCall| |st#0@@51|)) (=> (|Set#IsMember| (M2.__default.DomSt |st#0@@51|) (M2.__default.Loc |cmd#0@@15| |deps#0@@21| |e#0@@1|)) (and (and (|M2.__default.Loc#canCall| |cmd#0@@15| |deps#0@@21| |e#0@@1|) (|M2.__default.GetSt#canCall| (M2.__default.Loc |cmd#0@@15| |deps#0@@21| |e#0@@1|) |st#0@@51|)) (and (|M2.__default.Loc#canCall| |cmd#0@@15| |deps#0@@21| |e#0@@1|) (|M2.__default.Oracle#canCall| (M2.__default.Loc |cmd#0@@15| |deps#0@@21| |e#0@@1|) |st#0@@51|)))))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |4368|
 :pattern ( (M2.__default.Loc |cmd#0@@15| |deps#0@@21| |e#0@@1|))
 :pattern ( (|Set#IsMember| |exps#0@@10| ($Box SeqType |e#0@@1|)))
)) (= (M2.__default.Pre |cmd#0@@15| |deps#0@@21| |exps#0@@10| |st#0@@51|) (forall ((|e#0@@2| T@U) ) (!  (=> ($Is SeqType |e#0@@2| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@10| ($Box SeqType |e#0@@2|)) (=> (|Set#IsMember| (M2.__default.DomSt |st#0@@51|) (M2.__default.Loc |cmd#0@@15| |deps#0@@21| |e#0@@2|)) (= (M2.__default.GetSt (M2.__default.Loc |cmd#0@@15| |deps#0@@21| |e#0@@2|) |st#0@@51|) (M2.__default.Oracle (M2.__default.Loc |cmd#0@@15| |deps#0@@21| |e#0@@2|) |st#0@@51|)))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |4367|
 ...
 :qid |CloudMakeParallelBuildsdfy.83:23|
 :skolemid |4369|
 :pattern ( (M2.__default.Pre |cmd#0@@15| |deps#0@@21| |exps#0@@10| |st#0@@51|))
))))
(assert (forall (($ly@@30 T@U) (|p#0@@48| T@U) (|cert#0@@15| T@U) (|st#0@@52| T@U) ) (! (= (M2.__default.OracleWF ($LS $ly@@30) |p#0@@48| |cert#0@@15| |st#0@@52|) (M2.__default.OracleWF $ly@@30 |p#0@@48| |cert#0@@15| |st#0@@52|))
 :qid |CloudMakeParallelBuildsdfy.653:18|
 :skolemid |3843|
 :pattern ( (M2.__default.OracleWF ($LS $ly@@30) |p#0@@48| |cert#0@@15| |st#0@@52|))
)))
(assert (forall (($ly@@31 T@U) (|expr#0@@3| T@U) (|st#0@@53| T@U) (|env#0@@9| T@U) ) (! (= (M2.__default.eval ($LS $ly@@31) |expr#0@@3| |st#0@@53| |env#0@@9|) (M2.__default.eval $ly@@31 |expr#0@@3| |st#0@@53| |env#0@@9|))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |4510|
 :pattern ( (M2.__default.eval ($LS $ly@@31) |expr#0@@3| |st#0@@53| |env#0@@9|))
)))
...
(assert  (=> (<= 7 $FunctionContextHeight) (forall (($Heap@@22 T@U) ($ly@@32 T@U) (|expr#0@@4| T@U) (|st#0@@54| T@U) (|env#0@@10| T@U) ) (!  (=> (and (or (|M2.__default.eval#canCall| |expr#0@@4| |st#0@@54| |env#0@@10|) (and (< 7 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |expr#0@@4| Tclass.M2.Expression) ($IsAlloc DatatypeTypeType |expr#0@@4| Tclass.M2.Expression $Heap@@22)) (and ($Is DatatypeTypeType |st#0@@54| Tclass.M2.State) ($IsAlloc DatatypeTypeType |st#0@@54| Tclass.M2.State $Heap@@22))) (and ($IsBox |env#0@@10| Tclass.M2.Env) ($IsAllocBox |env#0@@10| Tclass.M2.Env $Heap@@22))) (M2.__default.ValidEnv |env#0@@10|)))) ($IsGoodHeap $Heap@@22)) ($IsAlloc DatatypeTypeType (M2.__default.eval $ly@@32 |expr#0@@4| |st#0@@54| |env#0@@10|) (Tclass.M2.Tuple Tclass.M2.Expression Tclass.M2.State) $Heap@@22))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |4513|
 :pattern ( ($IsAlloc DatatypeTypeType (M2.__default.eval $ly@@32 |expr#0@@4| |st#0@@54| |env#0@@10|) (Tclass.M2.Tuple Tclass.M2.Expression Tclass.M2.State) $Heap@@22))
))))
(assert  (=> (<= 6 $FunctionContextHeight) (forall ((|prim#0@@4| T@U) (|args#0@@6| T@U) (|st#0@@55| T@U) ) (!  (=> (or (|M2.__default.ValidArgs#canCall| (Lit DatatypeTypeType |prim#0@@4|) (Lit SeqType |args#0@@6|) |st#0@@55|) (and (< 6 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |prim#0@@4| Tclass.M2.Primitive) ($Is SeqType |args#0@@6| (TSeq Tclass.M2.Expression))) ($Is DatatypeTypeType |st#0@@55| Tclass.M2.State)) (and (=> (M2.Primitive.primExec_q (Lit DatatypeTypeType |prim#0@@4|)) (= (|Seq#Length| (Lit SeqType |args#0@@6|)) (LitInt 3))) (=> (M2.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@4|)) (= (|Seq#Length| (Lit SeqType |args#0@@6|)) (LitInt 1))))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (M2.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@4|)))))) (let ((|exps#3| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@6|) (LitInt 2)))))
...
(let ((|cmd#3| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@6|) (LitInt 0)))))
 (=> (M2.Expression.exprLiteral_q |cmd#3|) (=> (M2.Literal.litString_q (M2.Expression.lit |cmd#3|)) (=> (M2.Expression.exprLiteral_q |deps#3|) (=> (M2.Literal.litArrOfPaths_q (M2.Expression.lit |deps#3|)) (=> (M2.Expression.exprLiteral_q |exps#3|) (=> (M2.Literal.litArrOfStrings_q (M2.Expression.lit |exps#3|)) (and (|M2.__default.DomSt#canCall| |st#0@@55|) (=> (|Set#Subset| (M2.Literal.paths (M2.Expression.lit |deps#3|)) (M2.__default.DomSt |st#0@@55|)) (|M2.__default.Pre#canCall| (M2.Literal.str (M2.Expression.lit |cmd#3|)) (M2.Literal.paths (M2.Expression.lit |deps#3|)) (M2.Literal.strs (M2.Expression.lit |exps#3|)) |st#0@@55|))))))))))))) (= (M2.__default.ValidArgs (Lit DatatypeTypeType |prim#0@@4|) (Lit SeqType |args#0@@6|) |st#0@@55|) (ite (M2.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@4|)) false (let ((|exps#2| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@6|) (LitInt 2)))))
...
(let ((|cmd#2| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@6|) (LitInt 0)))))
 (and (and (and (and (and (and (and (M2.Expression.exprLiteral_q |cmd#2|) (M2.Literal.litString_q (M2.Expression.lit |cmd#2|))) (M2.Expression.exprLiteral_q |deps#2|)) (M2.Literal.litArrOfPaths_q (M2.Expression.lit |deps#2|))) (M2.Expression.exprLiteral_q |exps#2|)) (M2.Literal.litArrOfStrings_q (M2.Expression.lit |exps#2|))) (|Set#Subset| (M2.Literal.paths (M2.Expression.lit |deps#2|)) (M2.__default.DomSt |st#0@@55|))) (M2.__default.Pre (M2.Literal.str (M2.Expression.lit |cmd#2|)) (M2.Literal.paths (M2.Expression.lit |deps#2|)) (M2.Literal.strs (M2.Expression.lit |exps#2|)) |st#0@@55|)))))))))
 :qid |CloudMakeParallelBuildsdfy.289:29|
 :weight 3
 :skolemid |4562|
 :pattern ( (M2.__default.ValidArgs (Lit DatatypeTypeType |prim#0@@4|) (Lit SeqType |args#0@@6|) |st#0@@55|))
))))
...
(assert  (=> (<= 7 $FunctionContextHeight) (forall (($ly@@34 T@U) (|expr#0@@5| T@U) (|st#0@@56| T@U) (|env#0@@12| T@U) ) (!  (=> (or (|M2.__default.eval#canCall| (Lit DatatypeTypeType |expr#0@@5|) |st#0@@56| |env#0@@12|) (and (< 7 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0@@5| Tclass.M2.Expression) ($Is DatatypeTypeType |st#0@@56| Tclass.M2.State)) ($IsBox |env#0@@12| Tclass.M2.Env)) (M2.__default.ValidEnv |env#0@@12|)))) (and (and (|M2.__default.Value#canCall| (Lit DatatypeTypeType |expr#0@@5|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (M2.__default.Value (Lit DatatypeTypeType |expr#0@@5|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M2.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@5|))))) (|M2.__default.GetEnv#canCall| (Lit BoxType (M2.Expression.id (Lit DatatypeTypeType |expr#0@@5|))) |env#0@@12|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (M2.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@5|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M2.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@5|))))) (and (|M2.__default.eval#canCall| (Lit DatatypeTypeType (M2.Expression.cond (Lit DatatypeTypeType |expr#0@@5|))) |st#0@@56| |env#0@@12|) (let ((|st'#4| ($Unbox DatatypeTypeType (M2.Tuple.snd (M2.__default.eval ($LS $ly@@34) (Lit DatatypeTypeType (M2.Expression.cond (Lit DatatypeTypeType |expr#0@@5|))) |st#0@@56| |env#0@@12|)))))
(let ((|cond'#1| ($Unbox DatatypeTypeType (M2.Tuple.fst (M2.__default.eval ($LS $ly@@34) (Lit DatatypeTypeType (M2.Expression.cond (Lit DatatypeTypeType |expr#0@@5|))) |st#0@@56| |env#0@@12|)))))
 (and (and (=> (M2.Expression.exprLiteral_q |cond'#1|) (|$IsA#M2.Literal| (M2.Expression.lit |cond'#1|))) (=> (and (M2.Expression.exprLiteral_q |cond'#1|) (|M2.Literal#Equal| (M2.Expression.lit |cond'#1|) |#M2.Literal.litTrue|)) (|M2.__default.eval#canCall| (Lit DatatypeTypeType (M2.Expression.ifTrue (Lit DatatypeTypeType |expr#0@@5|))) |st'#4| |env#0@@12|))) (=> (not (and (M2.Expression.exprLiteral_q |cond'#1|) (|M2.Literal#Equal| (M2.Expression.lit |cond'#1|) |#M2.Literal.litTrue|))) (and (=> (M2.Expression.exprLiteral_q |cond'#1|) (|$IsA#M2.Literal| (M2.Expression.lit |cond'#1|))) (=> (and (M2.Expression.exprLiteral_q |cond'#1|) (|M2.Literal#Equal| (M2.Expression.lit |cond'#1|) |#M2.Literal.litFalse|)) (|M2.__default.eval#canCall| (Lit DatatypeTypeType (M2.Expression.ifFalse (Lit DatatypeTypeType |expr#0@@5|))) |st'#4| |env#0@@12|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M2.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@5|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M2.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@5|))))) (and (|M2.__default.eval#canCall| (Lit DatatypeTypeType (M2.Expression.conj0 (Lit DatatypeTypeType |expr#0@@5|))) |st#0@@56| |env#0@@12|) (let ((|st'#5| ($Unbox DatatypeTypeType (M2.Tuple.snd (M2.__default.eval ($LS $ly@@34) (Lit DatatypeTypeType (M2.Expression.conj0 (Lit DatatypeTypeType |expr#0@@5|))) |st#0@@56| |env#0@@12|)))))
(let ((|conj0'#1| ($Unbox DatatypeTypeType (M2.Tuple.fst (M2.__default.eval ($LS $ly@@34) (Lit DatatypeTypeType (M2.Expression.conj0 (Lit DatatypeTypeType |expr#0@@5|))) |st#0@@56| |env#0@@12|)))))
 (and (and (=> (M2.Expression.exprLiteral_q |conj0'#1|) (|$IsA#M2.Literal| (M2.Expression.lit |conj0'#1|))) (=> (and (M2.Expression.exprLiteral_q |conj0'#1|) (|M2.Literal#Equal| (M2.Expression.lit |conj0'#1|) |#M2.Literal.litTrue|)) (|M2.__default.eval#canCall| (Lit DatatypeTypeType (M2.Expression.conj1 (Lit DatatypeTypeType |expr#0@@5|))) |st'#5| |env#0@@12|))) (=> (not (and (M2.Expression.exprLiteral_q |conj0'#1|) (|M2.Literal#Equal| (M2.Expression.lit |conj0'#1|) |#M2.Literal.litTrue|))) (=> (M2.Expression.exprLiteral_q |conj0'#1|) (|$IsA#M2.Literal| (M2.Expression.lit |conj0'#1|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M2.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@5|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M2.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@5|))))) (and (|M2.__default.eval#canCall| (Lit DatatypeTypeType (M2.Expression.disj0 (Lit DatatypeTypeType |expr#0@@5|))) |st#0@@56| |env#0@@12|) (let ((|st'#6| ($Unbox DatatypeTypeType (M2.Tuple.snd (M2.__default.eval ($LS $ly@@34) (Lit DatatypeTypeType (M2.Expression.disj0 (Lit DatatypeTypeType |expr#0@@5|))) |st#0@@56| |env#0@@12|)))))
(let ((|disj0'#1| ($Unbox DatatypeTypeType (M2.Tuple.fst (M2.__default.eval ($LS $ly@@34) (Lit DatatypeTypeType (M2.Expression.disj0 (Lit DatatypeTypeType |expr#0@@5|))) |st#0@@56| |env#0@@12|)))))
 (and (=> (M2.Expression.exprLiteral_q |disj0'#1|) (|$IsA#M2.Literal| (M2.Expression.lit |disj0'#1|))) (=> (not (and (M2.Expression.exprLiteral_q |disj0'#1|) (|M2.Literal#Equal| (M2.Expression.lit |disj0'#1|) |#M2.Literal.litTrue|))) (and (=> (M2.Expression.exprLiteral_q |disj0'#1|) (|$IsA#M2.Literal| (M2.Expression.lit |disj0'#1|))) (=> (and (M2.Expression.exprLiteral_q |disj0'#1|) (|M2.Literal#Equal| (M2.Expression.lit |disj0'#1|) |#M2.Literal.litFalse|)) (|M2.__default.eval#canCall| (Lit DatatypeTypeType (M2.Expression.disj1 (Lit DatatypeTypeType |expr#0@@5|))) |st'#6| |env#0@@12|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M2.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@5|)))))) (=> (U_2_bool (Lit boolType (bool_2_U (M2.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0@@5|))))) (and (|M2.__default.eval#canCall| (Lit DatatypeTypeType (M2.Expression.fun (Lit DatatypeTypeType |expr#0@@5|))) |st#0@@56| |env#0@@12|) (let ((|st'#7| ($Unbox DatatypeTypeType (M2.Tuple.snd (M2.__default.eval ($LS $ly@@34) (Lit DatatypeTypeType (M2.Expression.fun (Lit DatatypeTypeType |expr#0@@5|))) |st#0@@56| |env#0@@12|)))))
(let ((|fun'#1| ($Unbox DatatypeTypeType (M2.Tuple.fst (M2.__default.eval ($LS $ly@@34) (Lit DatatypeTypeType (M2.Expression.fun (Lit DatatypeTypeType |expr#0@@5|))) |st#0@@56| |env#0@@12|)))))
 (and (|M2.__default.evalArgs#canCall| (Lit DatatypeTypeType |expr#0@@5|) (Lit SeqType (M2.Expression.args (Lit DatatypeTypeType |expr#0@@5|))) |st#0@@56| |env#0@@12|) (let ((|sts'#1| ($Unbox SetType (M2.Tuple.snd (M2.__default.evalArgs ($LS $ly@@34) (Lit DatatypeTypeType |expr#0@@5|) (Lit SeqType (M2.Expression.args (Lit DatatypeTypeType |expr#0@@5|))) |st#0@@56| |env#0@@12|)))))
(let ((|args'#1| ($Unbox SeqType (M2.Tuple.fst (M2.__default.evalArgs ($LS $ly@@34) (Lit DatatypeTypeType |expr#0@@5|) (Lit SeqType (M2.Expression.args (Lit DatatypeTypeType |expr#0@@5|))) |st#0@@56| |env#0@@12|)))))
(let ((|sts''#1| (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |st'#7|)) |sts'#1|)))
 ...
 (and (M2.Tuple.Pair_q |ps#1|) (M2.Tuple.Pair_q |ps#1|)))))))))))))))))))))))))))))) (= (M2.__default.eval ($LS $ly@@34) (Lit DatatypeTypeType |expr#0@@5|) |st#0@@56| |env#0@@12|) (ite (M2.__default.Value (Lit DatatypeTypeType |expr#0@@5|)) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType |expr#0@@5|)) ($Box DatatypeTypeType |st#0@@56|)) (ite (M2.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@5|)) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (M2.__default.GetEnv (Lit BoxType (M2.Expression.id (Lit DatatypeTypeType |expr#0@@5|))) |env#0@@12|)) ($Box DatatypeTypeType |st#0@@56|)) (ite (M2.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@5|)) (let ((|st'#4@@0| ($Unbox DatatypeTypeType (M2.Tuple.snd (M2.__default.eval ($LS $ly@@34) (Lit DatatypeTypeType (M2.Expression.cond (Lit DatatypeTypeType |expr#0@@5|))) |st#0@@56| |env#0@@12|)))))
(let ((|cond'#1@@0| ($Unbox DatatypeTypeType (M2.Tuple.fst (M2.__default.eval ($LS $ly@@34) (Lit DatatypeTypeType (M2.Expression.cond (Lit DatatypeTypeType |expr#0@@5|))) |st#0@@56| |env#0@@12|)))))
(ite  (and (M2.Expression.exprLiteral_q |cond'#1@@0|) (|M2.Literal#Equal| (M2.Expression.lit |cond'#1@@0|) |#M2.Literal.litTrue|)) (M2.__default.eval ($LS $ly@@34) (Lit DatatypeTypeType (M2.Expression.ifTrue (Lit DatatypeTypeType |expr#0@@5|))) |st'#4@@0| |env#0@@12|) (ite  (and (M2.Expression.exprLiteral_q |cond'#1@@0|) (|M2.Literal#Equal| (M2.Expression.lit |cond'#1@@0|) |#M2.Literal.litFalse|)) (M2.__default.eval ($LS $ly@@34) (Lit DatatypeTypeType (M2.Expression.ifFalse (Lit DatatypeTypeType |expr#0@@5|))) |st'#4@@0| |env#0@@12|) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprError| (Lit DatatypeTypeType |#M2.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@56|)))))) (ite (M2.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@5|)) (let ((|st'#5@@0| ($Unbox DatatypeTypeType (M2.Tuple.snd (M2.__default.eval ($LS $ly@@34) (Lit DatatypeTypeType (M2.Expression.conj0 (Lit DatatypeTypeType |expr#0@@5|))) |st#0@@56| |env#0@@12|)))))
(let ((|conj0'#1@@0| ($Unbox DatatypeTypeType (M2.Tuple.fst (M2.__default.eval ($LS $ly@@34) (Lit DatatypeTypeType (M2.Expression.conj0 (Lit DatatypeTypeType |expr#0@@5|))) |st#0@@56| |env#0@@12|)))))
(ite  (and (M2.Expression.exprLiteral_q |conj0'#1@@0|) (|M2.Literal#Equal| (M2.Expression.lit |conj0'#1@@0|) |#M2.Literal.litTrue|)) (M2.__default.eval ($LS $ly@@34) (Lit DatatypeTypeType (M2.Expression.conj1 (Lit DatatypeTypeType |expr#0@@5|))) |st'#5@@0| |env#0@@12|) (ite  (and (M2.Expression.exprLiteral_q |conj0'#1@@0|) (|M2.Literal#Equal| (M2.Expression.lit |conj0'#1@@0|) |#M2.Literal.litFalse|)) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprLiteral| (Lit DatatypeTypeType |#M2.Literal.litFalse|)))) ($Box DatatypeTypeType |st'#5@@0|)) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprError| (Lit DatatypeTypeType |#M2.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@56|)))))) (ite (M2.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@5|)) (let ((|st'#6@@0| ($Unbox DatatypeTypeType (M2.Tuple.snd (M2.__default.eval ($LS $ly@@34) (Lit DatatypeTypeType (M2.Expression.disj0 (Lit DatatypeTypeType |expr#0@@5|))) |st#0@@56| |env#0@@12|)))))
(let ((|disj0'#1@@0| ($Unbox DatatypeTypeType (M2.Tuple.fst (M2.__default.eval ($LS $ly@@34) (Lit DatatypeTypeType (M2.Expression.disj0 (Lit DatatypeTypeType |expr#0@@5|))) |st#0@@56| |env#0@@12|)))))
(ite  (and (M2.Expression.exprLiteral_q |disj0'#1@@0|) (|M2.Literal#Equal| (M2.Expression.lit |disj0'#1@@0|) |#M2.Literal.litTrue|)) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprLiteral| (Lit DatatypeTypeType |#M2.Literal.litTrue|)))) ($Box DatatypeTypeType |st'#6@@0|)) (ite  (and (M2.Expression.exprLiteral_q |disj0'#1@@0|) (|M2.Literal#Equal| (M2.Expression.lit |disj0'#1@@0|) |#M2.Literal.litFalse|)) (M2.__default.eval ($LS $ly@@34) (Lit DatatypeTypeType (M2.Expression.disj1 (Lit DatatypeTypeType |expr#0@@5|))) |st'#6@@0| |env#0@@12|) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprError| (Lit DatatypeTypeType |#M2.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@56|)))))) (ite (M2.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0@@5|)) (let ((|st'#7@@0| ($Unbox DatatypeTypeType (M2.Tuple.snd (M2.__default.eval ($LS $ly@@34) (Lit DatatypeTypeType (M2.Expression.fun (Lit DatatypeTypeType |expr#0@@5|))) |st#0@@56| |env#0@@12|)))))
(let ((|fun'#1@@0| ($Unbox DatatypeTypeType (M2.Tuple.fst (M2.__default.eval ($LS $ly@@34) (Lit DatatypeTypeType (M2.Expression.fun (Lit DatatypeTypeType |expr#0@@5|))) |st#0@@56| |env#0@@12|)))))
(let ((|sts'#1@@0| ($Unbox SetType (M2.Tuple.snd (M2.__default.evalArgs ($LS $ly@@34) (Lit DatatypeTypeType |expr#0@@5|) (Lit SeqType (M2.Expression.args (Lit DatatypeTypeType |expr#0@@5|))) |st#0@@56| |env#0@@12|)))))
(let ((|args'#1@@0| ($Unbox SeqType (M2.Tuple.fst (M2.__default.evalArgs ($LS $ly@@34) (Lit DatatypeTypeType |expr#0@@5|) (Lit SeqType (M2.Expression.args (Lit DatatypeTypeType |expr#0@@5|))) |st#0@@56| |env#0@@12|)))))
(let ((|sts''#1@@0| (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |st'#7@@0|)) |sts'#1@@0|)))
(ite  (not (M2.__default.Compatible |sts''#1@@0|)) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprError| (Lit DatatypeTypeType |#M2.Reason.rCompatibility|)))) ($Box DatatypeTypeType |st#0@@56|)) (let ((|stCombined#1@@0| (M2.__default.Combine ($LS $LZ) |sts''#1@@0|)))
...
(|#M2.Tuple.Pair| ($Box DatatypeTypeType (|#M2.Expression.exprLiteral| (|#M2.Literal.litArrOfPaths| ($Unbox SetType (M2.Tuple.fst |ps#1@@0|))))) (M2.Tuple.snd |ps#1@@0|))) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprError| (Lit DatatypeTypeType |#M2.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@56|))) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprError| (Lit DatatypeTypeType |#M2.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@56|))) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprError| (Lit DatatypeTypeType |#M2.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@56|)))))))))) (|#M2.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M2.Expression.exprError| (Lit DatatypeTypeType |#M2.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@56|)))))))))))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :weight 3
 :skolemid |4516|
 :pattern ( (M2.__default.eval ($LS $ly@@34) (Lit DatatypeTypeType |expr#0@@5|) |st#0@@56| |env#0@@12|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@23 T@U) (|st#0@@57| T@U) (|st'#0@@7| T@U) ) (!  (=> (and (or (|M2.__default.Union#canCall| |st#0@@57| |st'#0@@7|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@57| Tclass.M2.State) ($IsAlloc DatatypeTypeType |st#0@@57| Tclass.M2.State $Heap@@23)) (and ($Is DatatypeTypeType |st'#0@@7| Tclass.M2.State) ($IsAlloc DatatypeTypeType |st'#0@@7| Tclass.M2.State $Heap@@23))))) ($IsGoodHeap $Heap@@23)) ($IsAlloc DatatypeTypeType (M2.__default.Union |st#0@@57| |st'#0@@7|) Tclass.M2.State $Heap@@23))
 :qid |CloudMakeParallelBuildsdfy.23:18|
 :skolemid |4293|
 :pattern ( ($IsAlloc DatatypeTypeType (M2.__default.Union |st#0@@57| |st'#0@@7|) Tclass.M2.State $Heap@@23))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@24 T@U) (|p#0@@49| T@U) (|st#0@@58| T@U) ) (!  (=> (and (or (|M2.__default.Oracle#canCall| |p#0@@49| |st#0@@58|) (and (< 4 $FunctionContextHeight) (and (and ($IsBox |p#0@@49| Tclass.M2.Path) ($IsAllocBox |p#0@@49| Tclass.M2.Path $Heap@@24)) (and ($Is DatatypeTypeType |st#0@@58| Tclass.M2.State) ($IsAlloc DatatypeTypeType |st#0@@58| Tclass.M2.State $Heap@@24))))) ($IsGoodHeap $Heap@@24)) ($IsAllocBox (M2.__default.Oracle |p#0@@49| |st#0@@58|) Tclass.M2.Artifact $Heap@@24))
 :qid |CloudMakeParallelBuildsdfy.644:18|
 :skolemid |3819|
 :pattern ( ($IsAllocBox (M2.__default.Oracle |p#0@@49| |st#0@@58|) Tclass.M2.Artifact $Heap@@24))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|st#0@@59| T@U) (|st'#0@@8| T@U) ) (!  (=> (or (|M2.__default.Extends#canCall| |st#0@@59| |st'#0@@8|) (and (< 5 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@59| Tclass.M2.State) ($Is DatatypeTypeType |st'#0@@8| Tclass.M2.State)))) (and (and (and (|M2.__default.DomSt#canCall| |st#0@@59|) (|M2.__default.DomSt#canCall| |st'#0@@8|)) (=> (|Set#Subset| (M2.__default.DomSt |st#0@@59|) (M2.__default.DomSt |st'#0@@8|)) (and (forall ((|p#0@@50| T@U) ) (!  (=> ($IsBox |p#0@@50| Tclass.M2.Path) (and (|M2.__default.DomSt#canCall| |st#0@@59|) (=> (|Set#IsMember| (M2.__default.DomSt |st#0@@59|) |p#0@@50|) (and (|M2.__default.GetSt#canCall| |p#0@@50| |st'#0@@8|) (|M2.__default.GetSt#canCall| |p#0@@50| |st#0@@59|)))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |4421|
 :pattern ( (M2.__default.GetSt |p#0@@50| |st#0@@59|))
 :pattern ( (M2.__default.GetSt |p#0@@50| |st'#0@@8|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st#0@@59|) |p#0@@50|))
)) (=> (forall ((|p#0@@51| T@U) ) (!  (=> ($IsBox |p#0@@51| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.DomSt |st#0@@59|) |p#0@@51|) (= (M2.__default.GetSt |p#0@@51| |st'#0@@8|) (M2.__default.GetSt |p#0@@51| |st#0@@59|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |4423|
 :pattern ( (M2.__default.GetSt |p#0@@51| |st#0@@59|))
 :pattern ( (M2.__default.GetSt |p#0@@51| |st'#0@@8|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st#0@@59|) |p#0@@51|))
)) (forall ((|p#1@@5| T@U) ) (!  (=> ($IsBox |p#1@@5| Tclass.M2.Path) (and (|M2.__default.DomSt#canCall| |st#0@@59|) (=> (not (|Set#IsMember| (M2.__default.DomSt |st#0@@59|) |p#1@@5|)) (and (|M2.__default.DomSt#canCall| |st'#0@@8|) (=> (|Set#IsMember| (M2.__default.DomSt |st'#0@@8|) |p#1@@5|) (and (|M2.__default.GetSt#canCall| |p#1@@5| |st'#0@@8|) (|M2.__default.Oracle#canCall| |p#1@@5| |st#0@@59|)))))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |4422|
 :pattern ( (M2.__default.Oracle |p#1@@5| |st#0@@59|))
 :pattern ( (M2.__default.GetSt |p#1@@5| |st'#0@@8|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st'#0@@8|) |p#1@@5|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st#0@@59|) |p#1@@5|))
)))))) (= (M2.__default.Extends |st#0@@59| |st'#0@@8|)  (and (and (|Set#Subset| (M2.__default.DomSt |st#0@@59|) (M2.__default.DomSt |st'#0@@8|)) (forall ((|p#0@@52| T@U) ) (!  (=> ($IsBox |p#0@@52| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.DomSt |st#0@@59|) |p#0@@52|) (= (M2.__default.GetSt |p#0@@52| |st'#0@@8|) (M2.__default.GetSt |p#0@@52| |st#0@@59|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |4419|
 :pattern ( (M2.__default.GetSt |p#0@@52| |st#0@@59|))
 :pattern ( (M2.__default.GetSt |p#0@@52| |st'#0@@8|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st#0@@59|) |p#0@@52|))
))) (forall ((|p#1@@6| T@U) ) (!  (=> ($IsBox |p#1@@6| Tclass.M2.Path) (=> (and (not (|Set#IsMember| (M2.__default.DomSt |st#0@@59|) |p#1@@6|)) (|Set#IsMember| (M2.__default.DomSt |st'#0@@8|) |p#1@@6|)) (= (M2.__default.GetSt |p#1@@6| |st'#0@@8|) (M2.__default.Oracle |p#1@@6| |st#0@@59|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |4420|
 :pattern ( (M2.__default.Oracle |p#1@@6| |st#0@@59|))
 :pattern ( (M2.__default.GetSt |p#1@@6| |st'#0@@8|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st'#0@@8|) |p#1@@6|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st#0@@59|) |p#1@@6|))
))))))
 :qid |CloudMakeParallelBuildsdfy.112:27|
 :skolemid |4424|
 :pattern ( (M2.__default.Extends |st#0@@59| |st'#0@@8|))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|p#0@@53| T@U) (|st#0@@60| T@U) ) (!  (=> (or (|M2.__default.Oracle#canCall| (Lit BoxType |p#0@@53|) (Lit DatatypeTypeType |st#0@@60|)) (and (< 4 $FunctionContextHeight) (and ($IsBox |p#0@@53| Tclass.M2.Path) ($Is DatatypeTypeType |st#0@@60| Tclass.M2.State)))) (and (and (and (|M2.__default.WellFounded#canCall| (Lit BoxType |p#0@@53|)) (=> (U_2_bool (Lit boolType (bool_2_U (M2.__default.WellFounded (Lit BoxType |p#0@@53|))))) (and (|M2.__default.GetCert#canCall| (Lit BoxType |p#0@@53|)) (|M2.__default.OracleWF#canCall| (Lit BoxType |p#0@@53|) (Lit DatatypeTypeType (M2.__default.GetCert (Lit BoxType |p#0@@53|))) (Lit DatatypeTypeType |st#0@@60|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M2.__default.WellFounded (Lit BoxType |p#0@@53|)))))) (|M2.__default.OracleArbitrary#canCall| (Lit BoxType |p#0@@53|)))) (= (M2.__default.Oracle (Lit BoxType |p#0@@53|) (Lit DatatypeTypeType |st#0@@60|)) (ite (M2.__default.WellFounded (Lit BoxType |p#0@@53|)) (M2.__default.OracleWF ($LS $LZ) (Lit BoxType |p#0@@53|) (Lit DatatypeTypeType (M2.__default.GetCert (Lit BoxType |p#0@@53|))) (Lit DatatypeTypeType |st#0@@60|)) (M2.__default.OracleArbitrary (Lit BoxType |p#0@@53|))))))
 :qid |CloudMakeParallelBuildsdfy.104:25|
 :weight 3
 :skolemid |3823|
 :pattern ( (M2.__default.Oracle (Lit BoxType |p#0@@53|) (Lit DatatypeTypeType |st#0@@60|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@35 T@U) (|p#0@@54| T@U) (|cert#0@@16| T@U) (|st#0@@61| T@U) ) (!  (=> (or (|M2.__default.OracleWF#canCall| (Lit BoxType |p#0@@54|) (Lit DatatypeTypeType |cert#0@@16|) (Lit DatatypeTypeType |st#0@@61|)) (and (< 3 $FunctionContextHeight) (and (and (and ($IsBox |p#0@@54| Tclass.M2.Path) ($Is DatatypeTypeType |cert#0@@16| Tclass.M2.WFCertificate)) ($Is DatatypeTypeType |st#0@@61| Tclass.M2.State)) (U_2_bool (Lit boolType (bool_2_U (M2.__default.CheckWellFounded ($LS $LZ) (Lit BoxType |p#0@@54|) (Lit DatatypeTypeType |cert#0@@16|)))))))) (and (and (and (and (|M2.__default.LocInv__Cmd#canCall| (Lit BoxType |p#0@@54|)) (|M2.__default.LocInv__Deps#canCall| (Lit BoxType |p#0@@54|))) (|M2.__default.LocInv__Exp#canCall| (Lit BoxType |p#0@@54|))) (let ((|e#2| (M2.__default.LocInv__Exp (Lit BoxType |p#0@@54|))))
(let ((|deps#2@@0| (M2.__default.LocInv__Deps (Lit BoxType |p#0@@54|))))
(let ((|cmd#2@@0| (M2.__default.LocInv__Cmd (Lit BoxType |p#0@@54|))))
 (and (|M2.__default.CollectDependencies#canCall| (Lit BoxType |p#0@@54|) (Lit DatatypeTypeType |cert#0@@16|) |deps#2@@0| (Lit DatatypeTypeType |st#0@@61|)) (|M2.__default.RunTool#canCall| |cmd#2@@0| (M2.__default.CollectDependencies ($LS $ly@@35) (Lit BoxType |p#0@@54|) (Lit DatatypeTypeType |cert#0@@16|) |deps#2@@0| (Lit DatatypeTypeType |st#0@@61|)) |e#2|)))))) (= (M2.__default.OracleWF ($LS $ly@@35) (Lit BoxType |p#0@@54|) (Lit DatatypeTypeType |cert#0@@16|) (Lit DatatypeTypeType |st#0@@61|)) (let ((|e#2@@0| (M2.__default.LocInv__Exp (Lit BoxType |p#0@@54|))))
(let ((|deps#2@@1| (M2.__default.LocInv__Deps (Lit BoxType |p#0@@54|))))
(let ((|cmd#2@@1| (M2.__default.LocInv__Cmd (Lit BoxType |p#0@@54|))))
(M2.__default.RunTool |cmd#2@@1| (M2.__default.CollectDependencies ($LS $ly@@35) (Lit BoxType |p#0@@54|) (Lit DatatypeTypeType |cert#0@@16|) |deps#2@@1| (Lit DatatypeTypeType |st#0@@61|)) |e#2@@0|)))))))
 :qid |CloudMakeParallelBuildsdfy.653:18|
 :weight 3
 :skolemid |3850|
 :pattern ( (M2.__default.OracleWF ($LS $ly@@35) (Lit BoxType |p#0@@54|) (Lit DatatypeTypeType |cert#0@@16|) (Lit DatatypeTypeType |st#0@@61|)))
))))
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|cmd#0@@16| T@U) (|deps#0@@22| T@U) (|exps#0@@11| T@U) (|st#0@@62| T@U) ) (!  (=> (or (|M2.__default.Pre#canCall| (Lit SeqType |cmd#0@@16|) (Lit SetType |deps#0@@22|) (Lit SetType |exps#0@@11|) (Lit DatatypeTypeType |st#0@@62|)) (and (< 5 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@16| (TSeq TChar)) ($Is SetType |deps#0@@22| (TSet Tclass.M2.Path))) ($Is SetType |exps#0@@11| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@62| Tclass.M2.State)))) (and (forall ((|e#2@@1| T@U) ) (!  (=> ($Is SeqType |e#2@@1| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@11|) ($Box SeqType |e#2@@1|)) (and (and (|M2.__default.Loc#canCall| (Lit SeqType |cmd#0@@16|) (Lit SetType |deps#0@@22|) |e#2@@1|) (|M2.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@62|))) (=> (|Set#IsMember| (Lit SetType (M2.__default.DomSt (Lit DatatypeTypeType |st#0@@62|))) (M2.__default.Loc (Lit SeqType |cmd#0@@16|) (Lit SetType |deps#0@@22|) |e#2@@1|)) (and (and (|M2.__default.Loc#canCall| (Lit SeqType |cmd#0@@16|) (Lit SetType |deps#0@@22|) |e#2@@1|) (|M2.__default.GetSt#canCall| (M2.__default.Loc (Lit SeqType |cmd#0@@16|) (Lit SetType |deps#0@@22|) |e#2@@1|) (Lit DatatypeTypeType |st#0@@62|))) (and (|M2.__default.Loc#canCall| (Lit SeqType |cmd#0@@16|) (Lit SetType |deps#0@@22|) |e#2@@1|) (|M2.__default.Oracle#canCall| (M2.__default.Loc (Lit SeqType |cmd#0@@16|) (Lit SetType |deps#0@@22|) |e#2@@1|) (Lit DatatypeTypeType |st#0@@62|))))))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |4374|
 :pattern ( (M2.__default.Loc |cmd#0@@16| |deps#0@@22| |e#2@@1|))
 :pattern ( (|Set#IsMember| |exps#0@@11| ($Box SeqType |e#2@@1|)))
)) (= (M2.__default.Pre (Lit SeqType |cmd#0@@16|) (Lit SetType |deps#0@@22|) (Lit SetType |exps#0@@11|) (Lit DatatypeTypeType |st#0@@62|)) (forall ((|e#2@@2| T@U) ) (!  (=> ($Is SeqType |e#2@@2| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@11|) ($Box SeqType |e#2@@2|)) (=> (|Set#IsMember| (Lit SetType (M2.__default.DomSt (Lit DatatypeTypeType |st#0@@62|))) (M2.__default.Loc (Lit SeqType |cmd#0@@16|) (Lit SetType |deps#0@@22|) |e#2@@2|)) (= (M2.__default.GetSt (M2.__default.Loc (Lit SeqType |cmd#0@@16|) (Lit SetType |deps#0@@22|) |e#2@@2|) (Lit DatatypeTypeType |st#0@@62|)) (M2.__default.Oracle (M2.__default.Loc (Lit SeqType |cmd#0@@16|) (Lit SetType |deps#0@@22|) |e#2@@2|) (Lit DatatypeTypeType |st#0@@62|))))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |4373|
 ...
 :weight 3
 :skolemid |4375|
 :pattern ( (M2.__default.Pre (Lit SeqType |cmd#0@@16|) (Lit SetType |deps#0@@22|) (Lit SetType |exps#0@@11|) (Lit DatatypeTypeType |st#0@@62|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|cmd#0@@17| T@U) (|deps#0@@23| T@U) (|exps#0@@12| T@U) (|st#0@@63| T@U) ) (!  (=> (or (|M2.__default.exec#canCall| (Lit SeqType |cmd#0@@17|) (Lit SetType |deps#0@@23|) (Lit SetType |exps#0@@12|) |st#0@@63|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@17| (TSeq TChar)) ($Is SetType |deps#0@@23| (TSet Tclass.M2.Path))) ($Is SetType |exps#0@@12| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@63| Tclass.M2.State)))) (and (and (|M2.__default.Restrict#canCall| (Lit SetType |deps#0@@23|) |st#0@@63|) (|M2.__default.execOne#canCall| (Lit SeqType |cmd#0@@17|) (Lit SetType |deps#0@@23|) (M2.__default.Restrict (Lit SetType |deps#0@@23|) |st#0@@63|) (Lit SetType |exps#0@@12|) |st#0@@63|)) (= (M2.__default.exec (Lit SeqType |cmd#0@@17|) (Lit SetType |deps#0@@23|) (Lit SetType |exps#0@@12|) |st#0@@63|) (M2.__default.execOne ($LS $LZ) (Lit SeqType |cmd#0@@17|) (Lit SetType |deps#0@@23|) (M2.__default.Restrict (Lit SetType |deps#0@@23|) |st#0@@63|) (Lit SetType |exps#0@@12|) |st#0@@63|))))
 :qid |CloudMakeParallelBuildsdfy.69:23|
 :weight 3
 :skolemid |3598|
 :pattern ( (M2.__default.exec (Lit SeqType |cmd#0@@17|) (Lit SetType |deps#0@@23|) (Lit SetType |exps#0@@12|) |st#0@@63|))
))))
...
(set-info :boogie-vc-id Impl$$M2.__default.EvalArgsLemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> false (|M2.Tuple#Equal| (|#M2.Tuple.Pair| ($Box SeqType |args'#0@0|) ($Box SetType |sts'#0@0|)) (M2.__default.evalArgs ($LS ($LS $LZ)) |context#0@@5| |args#0@@8| |stOrig#0@@5| |env#0@@13|)))) (=> (=> false (|M2.Tuple#Equal| (|#M2.Tuple.Pair| ($Box SeqType |args'#0@0|) ($Box SetType |sts'#0@0|)) (M2.__default.evalArgs ($LS ($LS $LZ)) |context#0@@5| |args#0@@8| |stOrig#0@@5| |env#0@@13|))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (forall ((|st'#1@@5| T@U) ) (!  (=> ($Is DatatypeTypeType |st'#1@@5| Tclass.M2.State) (and (=> (|Set#IsMember| |sts'#0@0| ($Box DatatypeTypeType |st'#1@@5|)) (M2.__default.ValidState |st'#1@@5|)) (=> (|Set#IsMember| |sts'#0@0| ($Box DatatypeTypeType |st'#1@@5|)) (M2.__default.Extends |stOrig#0@@5| |st'#1@@5|))))
 :qid |CloudMakeParallelBuildsdfy.419:14|
 :skolemid |4657|
 :pattern ( (M2.__default.Extends |stOrig#0@@5| |st'#1@@5|))
 :pattern ( (M2.__default.ValidState |st'#1@@5|))
 :pattern ( (|Set#IsMember| |sts'#0@0| ($Box DatatypeTypeType |st'#1@@5|)))
))))))))
(let ((anon3_Else_correct  (=> (not (|Seq#Equal| |args#0@@8| |Seq#Empty|)) (=> (and (and (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |args#0@@8|))) (and (= |expr##1_0@0| ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@8| (LitInt 0)))) (< (DtRank |expr##1_0@0|) (DtRank |context#0@@5|)))) (and (and ($Is DatatypeTypeType |call4formal@expr'#0| Tclass.M2.Expression) ($IsAlloc DatatypeTypeType |call4formal@expr'#0| Tclass.M2.Expression $Heap@@26)) (and ($Is DatatypeTypeType |call5formal@st'#0| Tclass.M2.State) ($IsAlloc DatatypeTypeType |call5formal@st'#0| Tclass.M2.State $Heap@@26)))) (and (=> (= (ControlFlow 0 5) (- 0 10)) (=> (|M2.__default.ValidState#canCall| |stOrig#0@@5|) (or (M2.__default.ValidState |stOrig#0@@5|) (forall ((|p#0@@55| T@U) ) (!  (=> ($IsBox |p#0@@55| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.DomSt |stOrig#0@@5|) |p#0@@55|) (M2.__default.WellFounded |p#0@@55|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |4612|
 :pattern ( (M2.__default.WellFounded |p#0@@55|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |stOrig#0@@5|) |p#0@@55|))
))))) (=> (=> (|M2.__default.ValidState#canCall| |stOrig#0@@5|) (or (M2.__default.ValidState |stOrig#0@@5|) (forall ((|p#0@@56| T@U) ) (!  (=> ($IsBox |p#0@@56| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.DomSt |stOrig#0@@5|) |p#0@@56|) (M2.__default.WellFounded |p#0@@56|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |4612|
 :pattern ( (M2.__default.WellFounded |p#0@@56|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |stOrig#0@@5|) |p#0@@56|))
)))) (and (=> (= (ControlFlow 0 5) (- 0 9)) (M2.__default.ValidEnv |env#0@@13|)) (=> (M2.__default.ValidEnv |env#0@@13|) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and ($Is DatatypeTypeType |call4formal@expr'#0@0| Tclass.M2.Expression) ($IsAlloc DatatypeTypeType |call4formal@expr'#0@0| Tclass.M2.Expression $Heap@0)) (and ($Is DatatypeTypeType |call5formal@st'#0@0| Tclass.M2.State) ($IsAlloc DatatypeTypeType |call5formal@st'#0@0| Tclass.M2.State $Heap@0))) (=> (and (and (and (and (and (and (|$IsA#M2.Tuple| (M2.__default.eval ($LS $LZ) |expr##1_0@0| |stOrig#0@@5| |env#0@@13|)) (|M2.__default.eval#canCall| |expr##1_0@0| |stOrig#0@@5| |env#0@@13|)) (=> (|M2.Tuple#Equal| (|#M2.Tuple.Pair| ($Box DatatypeTypeType |call4formal@expr'#0@0|) ($Box DatatypeTypeType |call5formal@st'#0@0|)) (M2.__default.eval ($LS $LZ) |expr##1_0@0| |stOrig#0@@5| |env#0@@13|)) (and (|M2.__default.ValidState#canCall| |call5formal@st'#0@0|) (=> (M2.__default.ValidState |call5formal@st'#0@0|) (and (|M2.__default.Extends#canCall| |stOrig#0@@5| |call5formal@st'#0@0|) (=> (M2.__default.Extends |stOrig#0@@5| |call5formal@st'#0@0|) (=> (M2.Expression.exprError_q |call4formal@expr'#0@0|) (|$IsA#M2.Reason| (M2.Expression.r |call4formal@expr'#0@0|))))))))) (|M2.Tuple#Equal| (|#M2.Tuple.Pair| ($Box DatatypeTypeType |call4formal@expr'#0@0|) ($Box DatatypeTypeType |call5formal@st'#0@0|)) (M2.__default.eval ($LS ($LS $LZ)) |expr##1_0@0| |stOrig#0@@5| |env#0@@13|))) (and (|M2.__default.ValidState#canCall| |call5formal@st'#0@0|) (and (M2.__default.ValidState |call5formal@st'#0@0|) (forall ((|p#1@@7| T@U) ) (!  (=> ($IsBox |p#1@@7| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.DomSt |call5formal@st'#0@0|) |p#1@@7|) (M2.__default.WellFounded |p#1@@7|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |4615|
 :pattern ( (M2.__default.WellFounded |p#1@@7|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |call5formal@st'#0@0|) |p#1@@7|))
))))) (and (and (|M2.__default.Extends#canCall| |stOrig#0@@5| |call5formal@st'#0@0|) (and (M2.__default.Extends |stOrig#0@@5| |call5formal@st'#0@0|) (and (and (|Set#Subset| (M2.__default.DomSt |stOrig#0@@5|) (M2.__default.DomSt |call5formal@st'#0@0|)) (forall ((|p#2@@2| T@U) ) (!  (=> ($IsBox |p#2@@2| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.DomSt |stOrig#0@@5|) |p#2@@2|) (= (M2.__default.GetSt |p#2@@2| |call5formal@st'#0@0|) (M2.__default.GetSt |p#2@@2| |stOrig#0@@5|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |4618|
 :pattern ( (M2.__default.GetSt |p#2@@2| |stOrig#0@@5|))
 :pattern ( (M2.__default.GetSt |p#2@@2| |call5formal@st'#0@0|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |stOrig#0@@5|) |p#2@@2|))
))) (forall ((|p#3@@1| T@U) ) (!  (=> ($IsBox |p#3@@1| Tclass.M2.Path) (=> (and (not (|Set#IsMember| (M2.__default.DomSt |stOrig#0@@5|) |p#3@@1|)) (|Set#IsMember| (M2.__default.DomSt |call5formal@st'#0@0|) |p#3@@1|)) (= (M2.__default.GetSt |p#3@@1| |call5formal@st'#0@0|) (M2.__default.Oracle |p#3@@1| |stOrig#0@@5|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |4619|
 :pattern ( (M2.__default.Oracle |p#3@@1| |stOrig#0@@5|))
 :pattern ( (M2.__default.GetSt |p#3@@1| |call5formal@st'#0@0|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |call5formal@st'#0@0|) |p#3@@1|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |stOrig#0@@5|) |p#3@@1|))
))))) (and (=> (M2.Expression.exprError_q |call4formal@expr'#0@0|) (|M2.Reason#Equal| (M2.Expression.r |call4formal@expr'#0@0|) |#M2.Reason.rValidity|)) (= $Heap@@26 $Heap@0)))) (and (and (and (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |args#0@@8|))) (= |args##1_0@0| (|Seq#Drop| |args#0@@8| (LitInt 1)))) (and (or (or (<= 0 (|Seq#Length| |args#0@@8|)) (< (DtRank |context#0@@5|) (DtRank |context#0@@5|))) (= (|Seq#Length| |args##1_0@0|) (|Seq#Length| |args#0@@8|))) (or (< (DtRank |context#0@@5|) (DtRank |context#0@@5|)) (and (= (DtRank |context#0@@5|) (DtRank |context#0@@5|)) (< (|Seq#Length| |args##1_0@0|) (|Seq#Length| |args#0@@8|)))))) (and (and ($Is SeqType |call5formal@args'#0| (TSeq Tclass.M2.Expression)) ($IsAlloc SeqType |call5formal@args'#0| (TSeq Tclass.M2.Expression) $Heap@@26)) (and ($Is SetType |call6formal@sts'#0| (TSet Tclass.M2.State)) ($IsAlloc SetType |call6formal@sts'#0| (TSet Tclass.M2.State) $Heap@@26))))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (=> (|M2.__default.ValidState#canCall| |stOrig#0@@5|) (or (M2.__default.ValidState |stOrig#0@@5|) (forall ((|p#0@@57| T@U) ) (!  (=> ($IsBox |p#0@@57| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.DomSt |stOrig#0@@5|) |p#0@@57|) (M2.__default.WellFounded |p#0@@57|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |4648|
 :pattern ( (M2.__default.WellFounded |p#0@@57|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |stOrig#0@@5|) |p#0@@57|))
))))) (=> (=> (|M2.__default.ValidState#canCall| |stOrig#0@@5|) (or (M2.__default.ValidState |stOrig#0@@5|) (forall ((|p#0@@58| T@U) ) (!  (=> ($IsBox |p#0@@58| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.DomSt |stOrig#0@@5|) |p#0@@58|) (M2.__default.WellFounded |p#0@@58|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |4648|
 :pattern ( (M2.__default.WellFounded |p#0@@58|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |stOrig#0@@5|) |p#0@@58|))
)))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (M2.__default.ValidEnv |env#0@@13|)) (=> (M2.__default.ValidEnv |env#0@@13|) (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((|arg#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#1@@0| Tclass.M2.Expression) (=> (|Seq#Contains| |args##1_0@0| ($Box DatatypeTypeType |arg#1@@0|)) (< (DtRank |arg#1@@0|) (DtRank |context#0@@5|))))
 :qid |CloudMakeParallelBuildsdfy.416:14|
 :skolemid |4650|
 :pattern ( (|Seq#Contains| |args##1_0@0| ($Box DatatypeTypeType |arg#1@@0|)))
))) (=> (forall ((|arg#1@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#1@@1| Tclass.M2.Expression) (=> (|Seq#Contains| |args##1_0@0| ($Box DatatypeTypeType |arg#1@@1|)) (< (DtRank |arg#1@@1|) (DtRank |context#0@@5|))))
 :qid |CloudMakeParallelBuildsdfy.416:14|
 :skolemid |4650|
 :pattern ( (|Seq#Contains| |args##1_0@0| ($Box DatatypeTypeType |arg#1@@1|)))
)) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and (and ($Is SeqType |call5formal@args'#0@0| (TSeq Tclass.M2.Expression)) ($IsAlloc SeqType |call5formal@args'#0@0| (TSeq Tclass.M2.Expression) $Heap@1)) (and ($Is SetType |call6formal@sts'#0@0| (TSet Tclass.M2.State)) ($IsAlloc SetType |call6formal@sts'#0@0| (TSet Tclass.M2.State) $Heap@1))) (and (and (|$IsA#M2.Tuple| (M2.__default.evalArgs ($LS $LZ) |context#0@@5| |args##1_0@0| |stOrig#0@@5| |env#0@@13|)) (|M2.__default.evalArgs#canCall| |context#0@@5| |args##1_0@0| |stOrig#0@@5| |env#0@@13|)) (=> (|M2.Tuple#Equal| (|#M2.Tuple.Pair| ($Box SeqType |call5formal@args'#0@0|) ($Box SetType |call6formal@sts'#0@0|)) (M2.__default.evalArgs ($LS $LZ) |context#0@@5| |args##1_0@0| |stOrig#0@@5| |env#0@@13|)) (forall ((|st'#1@@6| T@U) ) (!  (=> ($Is DatatypeTypeType |st'#1@@6| Tclass.M2.State) (and (=> (|Set#IsMember| |call6formal@sts'#0@0| ($Box DatatypeTypeType |st'#1@@6|)) (|M2.__default.ValidState#canCall| |st'#1@@6|)) (=> (=> (|Set#IsMember| |call6formal@sts'#0@0| ($Box DatatypeTypeType |st'#1@@6|)) (M2.__default.ValidState |st'#1@@6|)) (=> (|Set#IsMember| |call6formal@sts'#0@0| ($Box DatatypeTypeType |st'#1@@6|)) (|M2.__default.Extends#canCall| |stOrig#0@@5| |st'#1@@6|)))))
 :qid |CloudMakeParallelBuildsdfy.419:14|
 :skolemid |4651|
 :pattern ( (M2.__default.Extends |stOrig#0@@5| |st'#1@@6|))
 :pattern ( (M2.__default.ValidState |st'#1@@6|))
 :pattern ( (|Set#IsMember| |call6formal@sts'#0@0| ($Box DatatypeTypeType |st'#1@@6|)))
))))) (and (and (and (|M2.Tuple#Equal| (|#M2.Tuple.Pair| ($Box SeqType |call5formal@args'#0@0|) ($Box SetType |call6formal@sts'#0@0|)) (M2.__default.evalArgs ($LS ($LS $LZ)) |context#0@@5| |args##1_0@0| |stOrig#0@@5| |env#0@@13|)) (forall ((|st'#1@@7| T@U) ) (!  (=> ($Is DatatypeTypeType |st'#1@@7| Tclass.M2.State) (and (=> (|Set#IsMember| |call6formal@sts'#0@0| ($Box DatatypeTypeType |st'#1@@7|)) (M2.__default.ValidState |st'#1@@7|)) (=> (|Set#IsMember| |call6formal@sts'#0@0| ($Box DatatypeTypeType |st'#1@@7|)) (M2.__default.Extends |stOrig#0@@5| |st'#1@@7|))))
 :qid |CloudMakeParallelBuildsdfy.419:14|
 :skolemid |4652|
 :pattern ( (M2.__default.Extends |stOrig#0@@5| |st'#1@@7|))
 :pattern ( (M2.__default.ValidState |st'#1@@7|))
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#4| null $Heap@@26 alloc false)) (and (=> (= (ControlFlow 0 11) 4) anon3_Then_correct) (=> (= (ControlFlow 0 11) 5) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@26) ($IsHeapAnchor $Heap@@26)) (=> (and (and (and (and ($Is DatatypeTypeType |context#0@@5| Tclass.M2.Expression) ($IsAlloc DatatypeTypeType |context#0@@5| Tclass.M2.Expression $Heap@@26)) (|$IsA#M2.Expression| |context#0@@5|)) (and ($Is SeqType |args#0@@8| (TSeq Tclass.M2.Expression)) ($IsAlloc SeqType |args#0@@8| (TSeq Tclass.M2.Expression) $Heap@@26))) (and (and (and ($Is DatatypeTypeType |stOrig#0@@5| Tclass.M2.State) ($IsAlloc DatatypeTypeType |stOrig#0@@5| Tclass.M2.State $Heap@@26)) (|$IsA#M2.State| |stOrig#0@@5|)) (and ($IsBox |env#0@@13| Tclass.M2.Env) ($IsAllocBox |env#0@@13| Tclass.M2.Env $Heap@@26)))) (=> (and (and (and (and (and ($Is SeqType |args'#0@@1| (TSeq Tclass.M2.Expression)) ($IsAlloc SeqType |args'#0@@1| (TSeq Tclass.M2.Expression) $Heap@@26)) (and ($Is SetType |sts'#0@@1| (TSet Tclass.M2.State)) ($IsAlloc SetType |sts'#0@@1| (TSet Tclass.M2.State) $Heap@@26))) (and (and ($Is DatatypeTypeType |rArg#1_0| Tclass.M2.Expression) ($IsAlloc DatatypeTypeType |rArg#1_0| Tclass.M2.Expression $Heap@@26)) true)) (and (and (and ($Is DatatypeTypeType |rSts#1_0| Tclass.M2.State) ($IsAlloc DatatypeTypeType |rSts#1_0| Tclass.M2.State $Heap@@26)) true) (and (and ($Is SeqType |rrArg#1_0| (TSeq Tclass.M2.Expression)) ($IsAlloc SeqType |rrArg#1_0| (TSeq Tclass.M2.Expression) $Heap@@26)) true))) (and (and (and (and ($Is SetType |rrSts#1_0| (TSet Tclass.M2.State)) ($IsAlloc SetType |rrSts#1_0| (TSet Tclass.M2.State) $Heap@@26)) true) (= 11 $FunctionContextHeight)) (and (and (and (|M2.__default.ValidState#canCall| |stOrig#0@@5|) (and (M2.__default.ValidState |stOrig#0@@5|) (forall ((|p#1@@8| T@U) ) (!  (=> ($IsBox |p#1@@8| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.DomSt |stOrig#0@@5|) |p#1@@8|) (M2.__default.WellFounded |p#1@@8|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |4654|
 :pattern ( (M2.__default.WellFounded |p#1@@8|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |stOrig#0@@5|) |p#1@@8|))
)))) (M2.__default.ValidEnv |env#0@@13|)) (and (forall ((|arg#1@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#1@@2| Tclass.M2.Expression) (=> (|Seq#Contains| |args#0@@8| ($Box DatatypeTypeType |arg#1@@2|)) (< (DtRank |arg#1@@2|) (DtRank |context#0@@5|))))
 :qid |CloudMakeParallelBuildsdfy.416:14|
 :skolemid |4655|
