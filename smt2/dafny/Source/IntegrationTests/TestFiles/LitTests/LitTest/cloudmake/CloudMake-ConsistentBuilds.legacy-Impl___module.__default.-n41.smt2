...
(assert (forall ((d@@27 T@U) ) (! (= (_module.Tuple.Pair_q d@@27) (= (DatatypeCtorId d@@27) |##_module.Tuple.Pair|))
 :qid |unknown.0:0|
 :skolemid |1539|
 :pattern ( (_module.Tuple.Pair_q d@@27))
)))
(assert (forall ((d@@28 T@U) ) (! (= (_module.Triple.Trio_q d@@28) (= (DatatypeCtorId d@@28) |##_module.Triple.Trio|))
 :qid |unknown.0:0|
 :skolemid |1558|
...
(assert (forall ((d@@29 T@U) ) (!  (=> (_module.Expression.exprIf_q d@@29) (exists ((|a#38#0#0| T@U) (|a#38#1#0| T@U) (|a#38#2#0| T@U) ) (! (= d@@29 (|#_module.Expression.exprIf| |a#38#0#0| |a#38#1#0| |a#38#2#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.320:30|
 :skolemid |1345|
)))
 :qid |unknown.0:0|
 :skolemid |1346|
 :pattern ( (_module.Expression.exprIf_q d@@29))
)))
(assert (forall ((d@@30 T@U) ) (!  (=> (_module.Triple.Trio_q d@@30) (exists ((|a#170#0#0| T@U) (|a#170#1#0| T@U) (|a#170#2#0| T@U) ) (! (= d@@30 (|#_module.Triple.Trio| |a#170#0#0| |a#170#1#0| |a#170#2#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.345:33|
 :skolemid |1559|
)))
 :qid |unknown.0:0|
...
(assert (forall ((d@@31 T@U) ) (!  (=> (_module.StateC.S_q d@@31) (exists ((|a#1#0#0| T@U) (|a#1#1#0| T@U) ) (! (= d@@31 (|#_module.StateC.S| |a#1#0#0| |a#1#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.32:21|
 :skolemid |1271|
)))
 :qid |unknown.0:0|
 :skolemid |1272|
 :pattern ( (_module.StateC.S_q d@@31))
)))
(assert (forall ((d@@32 T@U) ) (!  (=> (_module.Expression.exprAnd_q d@@32) (exists ((|a#48#0#0| T@U) (|a#48#1#0| T@U) ) (! (= d@@32 (|#_module.Expression.exprAnd| |a#48#0#0| |a#48#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.321:31|
 :skolemid |1360|
)))
 :qid |unknown.0:0|
 :skolemid |1361|
 :pattern ( (_module.Expression.exprAnd_q d@@32))
)))
(assert (forall ((d@@33 T@U) ) (!  (=> (_module.Expression.exprOr_q d@@33) (exists ((|a#56#0#0| T@U) (|a#56#1#0| T@U) ) (! (= d@@33 (|#_module.Expression.exprOr| |a#56#0#0| |a#56#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.322:30|
 :skolemid |1372|
)))
 :qid |unknown.0:0|
 :skolemid |1373|
 :pattern ( (_module.Expression.exprOr_q d@@33))
)))
(assert (forall ((d@@34 T@U) ) (!  (=> (_module.Expression.exprInvocation_q d@@34) (exists ((|a#64#0#0| T@U) (|a#64#1#0| T@U) ) (! (= d@@34 (|#_module.Expression.exprInvocation| |a#64#0#0| |a#64#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.323:38|
 :skolemid |1384|
)))
 :qid |unknown.0:0|
 :skolemid |1385|
 :pattern ( (_module.Expression.exprInvocation_q d@@34))
)))
(assert (forall ((d@@35 T@U) ) (!  (=> (_module.Tuple.Pair_q d@@35) (exists ((|a#162#0#0| T@U) (|a#162#1#0| T@U) ) (! (= d@@35 (|#_module.Tuple.Pair| |a#162#0#0| |a#162#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.344:29|
 :skolemid |1540|
)))
 :qid |unknown.0:0|
 :skolemid |1541|
 :pattern ( (_module.Tuple.Pair_q d@@35))
)))
...
(assert (forall ((d@@36 T@U) ) (!  (=> (_module.Literal.litTrue_q d@@36) (= d@@36 |#_module.Literal.litTrue|))
 :qid |unknown.0:0|
 :skolemid |1417|
 :pattern ( (_module.Literal.litTrue_q d@@36))
)))
(assert (forall ((d@@37 T@U) ) (!  (=> (_module.Literal.litFalse_q d@@37) (= d@@37 |#_module.Literal.litFalse|))
 :qid |unknown.0:0|
 :skolemid |1419|
 :pattern ( (_module.Literal.litFalse_q d@@37))
)))
(assert (forall ((d@@38 T@U) ) (!  (=> (_module.Literal.litUndefined_q d@@38) (= d@@38 |#_module.Literal.litUndefined|))
 :qid |unknown.0:0|
 :skolemid |1421|
 :pattern ( (_module.Literal.litUndefined_q d@@38))
)))
(assert (forall ((d@@39 T@U) ) (!  (=> (_module.Literal.litNull_q d@@39) (= d@@39 |#_module.Literal.litNull|))
 :qid |unknown.0:0|
 :skolemid |1423|
 :pattern ( (_module.Literal.litNull_q d@@39))
)))
(assert (forall ((d@@40 T@U) ) (!  (=> (_module.Primitive.primCreatePath_q d@@40) (= d@@40 |#_module.Primitive.primCreatePath|))
 :qid |unknown.0:0|
 :skolemid |1494|
 :pattern ( (_module.Primitive.primCreatePath_q d@@40))
)))
(assert (forall ((d@@41 T@U) ) (!  (=> (_module.Primitive.primExec_q d@@41) (= d@@41 |#_module.Primitive.primExec|))
 :qid |unknown.0:0|
 :skolemid |1496|
 :pattern ( (_module.Primitive.primExec_q d@@41))
)))
(assert (forall ((d@@42 T@U) ) (!  (=> (_module.Reason.rCompatibility_q d@@42) (= d@@42 |#_module.Reason.rCompatibility|))
 :qid |unknown.0:0|
 :skolemid |1504|
 :pattern ( (_module.Reason.rCompatibility_q d@@42))
)))
(assert (forall ((d@@43 T@U) ) (!  (=> (_module.Reason.rValidity_q d@@43) (= d@@43 |#_module.Reason.rValidity|))
 :qid |unknown.0:0|
 :skolemid |1506|
 :pattern ( (_module.Reason.rValidity_q d@@43))
)))
(assert (forall ((d@@44 T@U) ) (!  (=> (_module.Reason.rInconsistentCache_q d@@44) (= d@@44 |#_module.Reason.rInconsistentCache|))
 :qid |unknown.0:0|
 :skolemid |1508|
 :pattern ( (_module.Reason.rInconsistentCache_q d@@44))
)))
...
(assert (forall ((d@@45 T@U) ) (!  (=> (|$IsA#_module.Literal| d@@45) (or (or (or (or (or (or (or (or (or (_module.Literal.litTrue_q d@@45) (_module.Literal.litFalse_q d@@45)) (_module.Literal.litUndefined_q d@@45)) (_module.Literal.litNull_q d@@45)) (_module.Literal.litNumber_q d@@45)) (_module.Literal.litString_q d@@45)) (_module.Literal.litPrimitive_q d@@45)) (_module.Literal.litArrOfPaths_q d@@45)) (_module.Literal.litArrOfStrings_q d@@45)) (_module.Literal.litArray_q d@@45)))
 :qid |unknown.0:0|
 :skolemid |1480|
 :pattern ( (|$IsA#_module.Literal| d@@45))
)))
...
(assert (forall ((d@@46 T@U) ) (!  (=> (_module.Expression.exprLiteral_q d@@46) (exists ((|a#27#0#0| T@U) ) (! (= d@@46 (|#_module.Expression.exprLiteral| |a#27#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.319:35|
 :skolemid |1327|
)))
 :qid |unknown.0:0|
 :skolemid |1328|
 :pattern ( (_module.Expression.exprLiteral_q d@@46))
)))
(assert (forall ((d@@47 T@U) ) (!  (=> (_module.Expression.exprIdentifier_q d@@47) (exists ((|a#33#0#0| T@U) ) (! (= d@@47 (|#_module.Expression.exprIdentifier| |a#33#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.319:66|
 :skolemid |1337|
)))
 :qid |unknown.0:0|
 :skolemid |1338|
 :pattern ( (_module.Expression.exprIdentifier_q d@@47))
)))
(assert (forall ((d@@48 T@U) ) (!  (=> (_module.Expression.exprError_q d@@48) (exists ((|a#73#0#0| T@U) ) (! (= d@@48 (|#_module.Expression.exprError| |a#73#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.324:33|
 :skolemid |1397|
)))
 :qid |unknown.0:0|
 :skolemid |1398|
 :pattern ( (_module.Expression.exprError_q d@@48))
)))
(assert (forall ((d@@49 T@U) ) (!  (=> (_module.Literal.litNumber_q d@@49) (exists ((|a#95#0#0| Int) ) (! (= d@@49 (|#_module.Literal.litNumber| |a#95#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.327:30|
 :skolemid |1426|
)))
 :qid |unknown.0:0|
 :skolemid |1427|
 :pattern ( (_module.Literal.litNumber_q d@@49))
)))
(assert (forall ((d@@50 T@U) ) (!  (=> (_module.Literal.litString_q d@@50) (exists ((|a#100#0#0| T@U) ) (! (= d@@50 (|#_module.Literal.litString| |a#100#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.327:52|
 :skolemid |1434|
)))
 :qid |unknown.0:0|
 :skolemid |1435|
 :pattern ( (_module.Literal.litString_q d@@50))
)))
(assert (forall ((d@@51 T@U) ) (!  (=> (_module.Literal.litPrimitive_q d@@51) (exists ((|a#107#0#0| T@U) ) (! (= d@@51 (|#_module.Literal.litPrimitive| |a#107#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.328:33|
 :skolemid |1444|
)))
 :qid |unknown.0:0|
 :skolemid |1445|
 :pattern ( (_module.Literal.litPrimitive_q d@@51))
)))
(assert (forall ((d@@52 T@U) ) (!  (=> (_module.Literal.litArrOfPaths_q d@@52) (exists ((|a#113#0#0| T@U) ) (! (= d@@52 (|#_module.Literal.litArrOfPaths| |a#113#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.329:34|
 :skolemid |1453|
)))
 :qid |unknown.0:0|
 :skolemid |1454|
 :pattern ( (_module.Literal.litArrOfPaths_q d@@52))
)))
(assert (forall ((d@@53 T@U) ) (!  (=> (_module.Literal.litArrOfStrings_q d@@53) (exists ((|a#119#0#0| T@U) ) (! (= d@@53 (|#_module.Literal.litArrOfStrings| |a#119#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.330:36|
 :skolemid |1462|
)))
 :qid |unknown.0:0|
 :skolemid |1463|
 :pattern ( (_module.Literal.litArrOfStrings_q d@@53))
)))
(assert (forall ((d@@54 T@U) ) (!  (=> (_module.Literal.litArray_q d@@54) (exists ((|a#125#0#0| T@U) ) (! (= d@@54 (|#_module.Literal.litArray| |a#125#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.331:29|
 :skolemid |1471|
)))
 :qid |unknown.0:0|
 :skolemid |1472|
 :pattern ( (_module.Literal.litArray_q d@@54))
)))
(assert (forall ((d@@55 T@U) ) (!  (=> ($Is DatatypeTypeType d@@55 Tclass._module.Expression) (or (or (or (or (or (or (_module.Expression.exprLiteral_q d@@55) (_module.Expression.exprIdentifier_q d@@55)) (_module.Expression.exprIf_q d@@55)) (_module.Expression.exprAnd_q d@@55)) (_module.Expression.exprOr_q d@@55)) (_module.Expression.exprInvocation_q d@@55)) (_module.Expression.exprError_q d@@55)))
 :qid |unknown.0:0|
 :skolemid |1407|
 :pattern ( (_module.Expression.exprError_q d@@55) ($Is DatatypeTypeType d@@55 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprInvocation_q d@@55) ($Is DatatypeTypeType d@@55 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprOr_q d@@55) ($Is DatatypeTypeType d@@55 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprAnd_q d@@55) ($Is DatatypeTypeType d@@55 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprIf_q d@@55) ($Is DatatypeTypeType d@@55 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprIdentifier_q d@@55) ($Is DatatypeTypeType d@@55 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprLiteral_q d@@55) ($Is DatatypeTypeType d@@55 Tclass._module.Expression))
)))
...
(assert (forall ((d@@56 T@U) ) (!  (=> ($Is DatatypeTypeType d@@56 Tclass._module.Literal) (or (or (or (or (or (or (or (or (or (_module.Literal.litTrue_q d@@56) (_module.Literal.litFalse_q d@@56)) (_module.Literal.litUndefined_q d@@56)) (_module.Literal.litNull_q d@@56)) (_module.Literal.litNumber_q d@@56)) (_module.Literal.litString_q d@@56)) (_module.Literal.litPrimitive_q d@@56)) (_module.Literal.litArrOfPaths_q d@@56)) (_module.Literal.litArrOfStrings_q d@@56)) (_module.Literal.litArray_q d@@56)))
 :qid |unknown.0:0|
 :skolemid |1481|
 :pattern ( (_module.Literal.litArray_q d@@56) ($Is DatatypeTypeType d@@56 Tclass._module.Literal))
 :pattern ( (_module.Literal.litArrOfStrings_q d@@56) ($Is DatatypeTypeType d@@56 Tclass._module.Literal))
 :pattern ( (_module.Literal.litArrOfPaths_q d@@56) ($Is DatatypeTypeType d@@56 Tclass._module.Literal))
 :pattern ( (_module.Literal.litPrimitive_q d@@56) ($Is DatatypeTypeType d@@56 Tclass._module.Literal))
 :pattern ( (_module.Literal.litString_q d@@56) ($Is DatatypeTypeType d@@56 Tclass._module.Literal))
 :pattern ( (_module.Literal.litNumber_q d@@56) ($Is DatatypeTypeType d@@56 Tclass._module.Literal))
 :pattern ( (_module.Literal.litNull_q d@@56) ($Is DatatypeTypeType d@@56 Tclass._module.Literal))
 :pattern ( (_module.Literal.litUndefined_q d@@56) ($Is DatatypeTypeType d@@56 Tclass._module.Literal))
 :pattern ( (_module.Literal.litFalse_q d@@56) ($Is DatatypeTypeType d@@56 Tclass._module.Literal))
 :pattern ( (_module.Literal.litTrue_q d@@56) ($Is DatatypeTypeType d@@56 Tclass._module.Literal))
)))
...
(assert (forall ((_module.Triple$A@@5 T@U) (_module.Triple$B@@5 T@U) (_module.Triple$C@@5 T@U) (d@@57 T@U) ) (!  (=> ($Is DatatypeTypeType d@@57 (Tclass._module.Triple _module.Triple$A@@5 _module.Triple$B@@5 _module.Triple$C@@5)) (_module.Triple.Trio_q d@@57))
 :qid |unknown.0:0|
 :skolemid |1577|
 :pattern ( (_module.Triple.Trio_q d@@57) ($Is DatatypeTypeType d@@57 (Tclass._module.Triple _module.Triple$A@@5 _module.Triple$B@@5 _module.Triple$C@@5)))
)))
...
(assert (forall ((d@@58 T@U) ) (!  (=> ($Is DatatypeTypeType d@@58 Tclass._module.Primitive) (or (_module.Primitive.primCreatePath_q d@@58) (_module.Primitive.primExec_q d@@58)))
 :qid |unknown.0:0|
 :skolemid |1499|
 :pattern ( (_module.Primitive.primExec_q d@@58) ($Is DatatypeTypeType d@@58 Tclass._module.Primitive))
 :pattern ( (_module.Primitive.primCreatePath_q d@@58) ($Is DatatypeTypeType d@@58 Tclass._module.Primitive))
)))
...
(assert (forall ((d@@59 T@U) ) (!  (=> (|$IsA#_module.Reason| d@@59) (or (or (_module.Reason.rCompatibility_q d@@59) (_module.Reason.rValidity_q d@@59)) (_module.Reason.rInconsistentCache_q d@@59)))
 :qid |unknown.0:0|
 :skolemid |1510|
 :pattern ( (|$IsA#_module.Reason| d@@59))
)))
...
(assert (forall ((d@@60 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.Literal.litNumber_q d@@60) ($IsAlloc DatatypeTypeType d@@60 Tclass._module.Literal $h@@1))) ($IsAlloc intType (int_2_U (_module.Literal.num d@@60)) TInt $h@@1))
 :qid |unknown.0:0|
 :skolemid |1429|
 :pattern ( ($IsAlloc intType (int_2_U (_module.Literal.num d@@60)) TInt $h@@1))
)))
...
(assert (forall ((d@@61 T@U) ) (!  (=> ($Is DatatypeTypeType d@@61 Tclass._module.Reason) (or (or (_module.Reason.rCompatibility_q d@@61) (_module.Reason.rValidity_q d@@61)) (_module.Reason.rInconsistentCache_q d@@61)))
 :qid |unknown.0:0|
 :skolemid |1511|
 :pattern ( (_module.Reason.rInconsistentCache_q d@@61) ($Is DatatypeTypeType d@@61 Tclass._module.Reason))
 :pattern ( (_module.Reason.rValidity_q d@@61) ($Is DatatypeTypeType d@@61 Tclass._module.Reason))
 :pattern ( (_module.Reason.rCompatibility_q d@@61) ($Is DatatypeTypeType d@@61 Tclass._module.Reason))
)))
...
(assert (forall ((d@@67 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) ($Is DatatypeTypeType d@@67 Tclass._module.Expression)) ($IsAlloc DatatypeTypeType d@@67 Tclass._module.Expression $h@@6))
 :qid |unknown.0:0|
 :skolemid |1405|
 :pattern ( ($IsAlloc DatatypeTypeType d@@67 Tclass._module.Expression $h@@6))
)))
(assert (forall ((d@@68 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) ($Is DatatypeTypeType d@@68 Tclass._module.Literal)) ($IsAlloc DatatypeTypeType d@@68 Tclass._module.Literal $h@@7))
 :qid |unknown.0:0|
 :skolemid |1479|
 :pattern ( ($IsAlloc DatatypeTypeType d@@68 Tclass._module.Literal $h@@7))
)))
(assert (forall ((d@@69 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) ($Is DatatypeTypeType d@@69 Tclass._module.Primitive)) ($IsAlloc DatatypeTypeType d@@69 Tclass._module.Primitive $h@@8))
 :qid |unknown.0:0|
 :skolemid |1497|
 :pattern ( ($IsAlloc DatatypeTypeType d@@69 Tclass._module.Primitive $h@@8))
)))
(assert (forall ((d@@70 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) ($Is DatatypeTypeType d@@70 Tclass._module.Reason)) ($IsAlloc DatatypeTypeType d@@70 Tclass._module.Reason $h@@9))
 :qid |unknown.0:0|
 :skolemid |1509|
 :pattern ( ($IsAlloc DatatypeTypeType d@@70 Tclass._module.Reason $h@@9))
)))
(assert (forall ((d@@71 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) ($Is DatatypeTypeType d@@71 Tclass._module.Path)) ($IsAlloc DatatypeTypeType d@@71 Tclass._module.Path $h@@10))
 :qid |unknown.0:0|
 :skolemid |1532|
 :pattern ( ($IsAlloc DatatypeTypeType d@@71 Tclass._module.Path $h@@10))
)))
...
(assert (forall ((d@@72 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (_module.Literal.litString_q d@@72) ($IsAlloc DatatypeTypeType d@@72 Tclass._module.Literal $h@@11))) ($IsAlloc SeqType (_module.Literal.str d@@72) (TSeq TChar) $h@@11))
 :qid |unknown.0:0|
 :skolemid |1437|
 :pattern ( ($IsAlloc SeqType (_module.Literal.str d@@72) (TSeq TChar) $h@@11))
)))
(assert (forall ((|a#117#0#0| T@U) (d@@73 T@U) ) (!  (=> (|Set#IsMember| |a#117#0#0| ($Box DatatypeTypeType d@@73)) (< (DtRank d@@73) (DtRank (|#_module.Literal.litArrOfPaths| |a#117#0#0|))))
 :qid |CloudMakeConsistentBuildslegacydfy.329:34|
 :skolemid |1459|
 :pattern ( (|Set#IsMember| |a#117#0#0| ($Box DatatypeTypeType d@@73)) (|#_module.Literal.litArrOfPaths| |a#117#0#0|))
)))
(assert (forall ((|a#123#0#0| T@U) (d@@74 T@U) ) (!  (=> (|Set#IsMember| |a#123#0#0| ($Box DatatypeTypeType d@@74)) (< (DtRank d@@74) (DtRank (|#_module.Literal.litArrOfStrings| |a#123#0#0|))))
 :qid |CloudMakeConsistentBuildslegacydfy.330:36|
 :skolemid |1468|
 :pattern ( (|Set#IsMember| |a#123#0#0| ($Box DatatypeTypeType d@@74)) (|#_module.Literal.litArrOfStrings| |a#123#0#0|))
)))
...
(assert (forall ((d@@75 T@U) (_module.Tuple$A@@6 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (_module.Tuple.Pair_q d@@75) (exists ((_module.Tuple$B@@6 T@U) ) (! ($IsAlloc DatatypeTypeType d@@75 (Tclass._module.Tuple _module.Tuple$A@@6 _module.Tuple$B@@6) $h@@12)
 :qid |unknown.0:0|
 :skolemid |1544|
 :pattern ( ($IsAlloc DatatypeTypeType d@@75 (Tclass._module.Tuple _module.Tuple$A@@6 _module.Tuple$B@@6) $h@@12))
)))) ($IsAllocBox (_module.Tuple.fst d@@75) _module.Tuple$A@@6 $h@@12))
 :qid |unknown.0:0|
 :skolemid |1545|
 :pattern ( ($IsAllocBox (_module.Tuple.fst d@@75) _module.Tuple$A@@6 $h@@12))
)))
(assert (forall ((d@@76 T@U) (_module.Tuple$B@@7 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (_module.Tuple.Pair_q d@@76) (exists ((_module.Tuple$A@@7 T@U) ) (! ($IsAlloc DatatypeTypeType d@@76 (Tclass._module.Tuple _module.Tuple$A@@7 _module.Tuple$B@@7) $h@@13)
 :qid |unknown.0:0|
 :skolemid |1546|
 :pattern ( ($IsAlloc DatatypeTypeType d@@76 (Tclass._module.Tuple _module.Tuple$A@@7 _module.Tuple$B@@7) $h@@13))
)))) ($IsAllocBox (_module.Tuple.snd d@@76) _module.Tuple$B@@7 $h@@13))
 :qid |unknown.0:0|
 :skolemid |1547|
 :pattern ( ($IsAllocBox (_module.Tuple.snd d@@76) _module.Tuple$B@@7 $h@@13))
)))
...
(assert (forall ((d@@77 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (_module.StateC.S_q d@@77) ($IsAlloc DatatypeTypeType d@@77 Tclass._module.StateC $h@@14))) ($IsAllocBox (_module.StateC.st d@@77) Tclass._module.State $h@@14))
 :qid |unknown.0:0|
 :skolemid |1274|
 :pattern ( ($IsAllocBox (_module.StateC.st d@@77) Tclass._module.State $h@@14))
)))
(assert (forall ((d@@78 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (_module.StateC.S_q d@@78) ($IsAlloc DatatypeTypeType d@@78 Tclass._module.StateC $h@@15))) ($IsAllocBox (_module.StateC.c d@@78) Tclass._module.Cache $h@@15))
 :qid |unknown.0:0|
 :skolemid |1275|
 :pattern ( ($IsAllocBox (_module.StateC.c d@@78) Tclass._module.Cache $h@@15))
)))
(assert (forall ((d@@79 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (_module.Expression.exprLiteral_q d@@79) ($IsAlloc DatatypeTypeType d@@79 Tclass._module.Expression $h@@16))) ($IsAlloc DatatypeTypeType (_module.Expression.lit d@@79) Tclass._module.Literal $h@@16))
 :qid |unknown.0:0|
 :skolemid |1331|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.lit d@@79) Tclass._module.Literal $h@@16))
)))
(assert (forall ((d@@80 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (_module.Expression.exprIdentifier_q d@@80) ($IsAlloc DatatypeTypeType d@@80 Tclass._module.Expression $h@@17))) ($IsAllocBox (_module.Expression.id d@@80) Tclass._module.Identifier $h@@17))
 :qid |unknown.0:0|
 :skolemid |1340|
 :pattern ( ($IsAllocBox (_module.Expression.id d@@80) Tclass._module.Identifier $h@@17))
)))
(assert (forall ((d@@81 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (_module.Expression.exprIf_q d@@81) ($IsAlloc DatatypeTypeType d@@81 Tclass._module.Expression $h@@18))) ($IsAlloc DatatypeTypeType (_module.Expression.cond d@@81) Tclass._module.Expression $h@@18))
 :qid |unknown.0:0|
 :skolemid |1348|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.cond d@@81) Tclass._module.Expression $h@@18))
)))
(assert (forall ((d@@82 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (_module.Expression.exprIf_q d@@82) ($IsAlloc DatatypeTypeType d@@82 Tclass._module.Expression $h@@19))) ($IsAlloc DatatypeTypeType (_module.Expression.ifTrue d@@82) Tclass._module.Expression $h@@19))
 :qid |unknown.0:0|
 :skolemid |1349|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.ifTrue d@@82) Tclass._module.Expression $h@@19))
)))
(assert (forall ((d@@83 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (_module.Expression.exprIf_q d@@83) ($IsAlloc DatatypeTypeType d@@83 Tclass._module.Expression $h@@20))) ($IsAlloc DatatypeTypeType (_module.Expression.ifFalse d@@83) Tclass._module.Expression $h@@20))
 :qid |unknown.0:0|
 :skolemid |1350|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.ifFalse d@@83) Tclass._module.Expression $h@@20))
)))
(assert (forall ((d@@84 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (_module.Expression.exprAnd_q d@@84) ($IsAlloc DatatypeTypeType d@@84 Tclass._module.Expression $h@@21))) ($IsAlloc DatatypeTypeType (_module.Expression.conj0 d@@84) Tclass._module.Expression $h@@21))
 :qid |unknown.0:0|
 :skolemid |1363|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.conj0 d@@84) Tclass._module.Expression $h@@21))
)))
(assert (forall ((d@@85 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (_module.Expression.exprAnd_q d@@85) ($IsAlloc DatatypeTypeType d@@85 Tclass._module.Expression $h@@22))) ($IsAlloc DatatypeTypeType (_module.Expression.conj1 d@@85) Tclass._module.Expression $h@@22))
 :qid |unknown.0:0|
 :skolemid |1364|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.conj1 d@@85) Tclass._module.Expression $h@@22))
)))
(assert (forall ((d@@86 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (_module.Expression.exprOr_q d@@86) ($IsAlloc DatatypeTypeType d@@86 Tclass._module.Expression $h@@23))) ($IsAlloc DatatypeTypeType (_module.Expression.disj0 d@@86) Tclass._module.Expression $h@@23))
 :qid |unknown.0:0|
 :skolemid |1375|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.disj0 d@@86) Tclass._module.Expression $h@@23))
)))
(assert (forall ((d@@87 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (_module.Expression.exprOr_q d@@87) ($IsAlloc DatatypeTypeType d@@87 Tclass._module.Expression $h@@24))) ($IsAlloc DatatypeTypeType (_module.Expression.disj1 d@@87) Tclass._module.Expression $h@@24))
 :qid |unknown.0:0|
 :skolemid |1376|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.disj1 d@@87) Tclass._module.Expression $h@@24))
)))
(assert (forall ((d@@88 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (_module.Expression.exprInvocation_q d@@88) ($IsAlloc DatatypeTypeType d@@88 Tclass._module.Expression $h@@25))) ($IsAlloc DatatypeTypeType (_module.Expression.fun d@@88) Tclass._module.Expression $h@@25))
 :qid |unknown.0:0|
 :skolemid |1387|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.fun d@@88) Tclass._module.Expression $h@@25))
)))
(assert (forall ((d@@89 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (_module.Expression.exprError_q d@@89) ($IsAlloc DatatypeTypeType d@@89 Tclass._module.Expression $h@@26))) ($IsAlloc DatatypeTypeType (_module.Expression.r d@@89) Tclass._module.Reason $h@@26))
 :qid |unknown.0:0|
 :skolemid |1401|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.r d@@89) Tclass._module.Reason $h@@26))
)))
(assert (forall ((d@@90 T@U) ($h@@27 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (_module.Literal.litPrimitive_q d@@90) ($IsAlloc DatatypeTypeType d@@90 Tclass._module.Literal $h@@27))) ($IsAlloc DatatypeTypeType (_module.Literal.prim d@@90) Tclass._module.Primitive $h@@27))
 :qid |unknown.0:0|
 :skolemid |1447|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Literal.prim d@@90) Tclass._module.Primitive $h@@27))
)))
...
(assert (forall ((d@@91 T@U) ($h@@28 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (_module.Literal.litArrOfStrings_q d@@91) ($IsAlloc DatatypeTypeType d@@91 Tclass._module.Literal $h@@28))) ($IsAlloc SetType (_module.Literal.strs d@@91) (TSet (TSeq TChar)) $h@@28))
 :qid |unknown.0:0|
 :skolemid |1465|
 :pattern ( ($IsAlloc SetType (_module.Literal.strs d@@91) (TSet (TSeq TChar)) $h@@28))
)))
...
(assert (forall ((d@@92 T@U) ($h@@29 T@U) ) (!  (=> (and ($IsGoodHeap $h@@29) (and (_module.Expression.exprInvocation_q d@@92) ($IsAlloc DatatypeTypeType d@@92 Tclass._module.Expression $h@@29))) ($IsAlloc SeqType (_module.Expression.args d@@92) (TSeq Tclass._module.Expression) $h@@29))
 :qid |unknown.0:0|
 :skolemid |1388|
 :pattern ( ($IsAlloc SeqType (_module.Expression.args d@@92) (TSeq Tclass._module.Expression) $h@@29))
)))
(assert (forall ((d@@93 T@U) ($h@@30 T@U) ) (!  (=> (and ($IsGoodHeap $h@@30) (and (_module.Literal.litArrOfPaths_q d@@93) ($IsAlloc DatatypeTypeType d@@93 Tclass._module.Literal $h@@30))) ($IsAlloc SetType (_module.Literal.paths d@@93) (TSet Tclass._module.Path) $h@@30))
 :qid |unknown.0:0|
 :skolemid |1456|
 :pattern ( ($IsAlloc SetType (_module.Literal.paths d@@93) (TSet Tclass._module.Path) $h@@30))
)))
(assert (forall ((d@@94 T@U) ($h@@31 T@U) ) (!  (=> (and ($IsGoodHeap $h@@31) (and (_module.Literal.litArray_q d@@94) ($IsAlloc DatatypeTypeType d@@94 Tclass._module.Literal $h@@31))) ($IsAlloc SeqType (_module.Literal.arr d@@94) (TSeq Tclass._module.Expression) $h@@31))
 :qid |unknown.0:0|
 :skolemid |1474|
 :pattern ( ($IsAlloc SeqType (_module.Literal.arr d@@94) (TSeq Tclass._module.Expression) $h@@31))
)))
...
(declare-fun |arg#1_0@0| () T@U)
(declare-fun $Heap@1 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $Heap@0 () T@U)
(declare-fun |result#1_0@0| () T@U)
(declare-fun |$rhs#1_0@0| () T@U)
(declare-fun |$rhs#1_1@0| () T@U)
(declare-fun |args##1_0@0| () T@U)
(declare-fun |args'##1_0@0| () T@U)
(declare-fun |stsC'##1_0@0| () T@U)
(declare-fun $Heap@2 () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $Heap@@3 () T@U)
(declare-fun |arg#1_0| () T@U)
(declare-fun |defass#result#1_0| () Bool)
(declare-fun |result#1_0| () T@U)
(declare-fun |arg'#1_0| () T@U)
(declare-fun |defass#stC'#1_0| () Bool)
(declare-fun |stC'#1_0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.EvalArgsC_kLemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (let ((|result#0@@6| (_module.__default.evalArgsC_k ($LS ($LS $LZ)) |expr#0@@16| |args#0@@11| |stC#0@@32| |env#0@@15| |args'#0@@6| |stsC'#0@@6|)))
(let ((|stsC''#0@@1| ($Unbox SetType (_module.Tuple.snd |result#0@@6|))))
(forall ((|stC''#1| T@U) ) (!  (=> ($Is DatatypeTypeType |stC''#1| Tclass._module.StateC) (=> (|Set#IsMember| |stsC''#0@@1| ($Box DatatypeTypeType |stC''#1|)) (_module.__default.ConsistentCache |stC''#1|)))
 :qid |CloudMakeConsistentBuildslegacydfy.652:12|
 :skolemid |1262|
 :pattern ( (_module.__default.ConsistentCache |stC''#1|))
 :pattern ( (|Set#IsMember| |stsC''#0@@1| ($Box DatatypeTypeType |stC''#1|)))
)))))))
(let ((anon3_Else_correct  (=> (not (|Seq#Equal| |args#0@@11| |Seq#Empty|)) (and (=> (= (ControlFlow 0 4) (- 0 16)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |args#0@@11|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |args#0@@11|))) (=> (= |arg#1_0@0| ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@11| (LitInt 0)))) (and (=> (= (ControlFlow 0 4) (- 0 15)) (< (DtRank |arg#1_0@0|) (DtRank |expr#0@@16|))) (=> (< (DtRank |arg#1_0@0|) (DtRank |expr#0@@16|)) (and (=> (= (ControlFlow 0 4) (- 0 14)) (=> (|_module.__default.ConsistentCache#canCall| |stC#0@@32|) (or (_module.__default.ConsistentCache |stC#0@@32|) (forall ((|cmd#0@@19| T@U) (|deps#0@@18| T@U) (|e#0@@10| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#0@@19| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@18| Tclass._module.Expression)) ($Is SeqType |e#0@@10| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@32|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@19| |deps#0@@18| |e#0@@10|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@32|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0@@19| |deps#0@@18| |e#0@@10|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1200|
 :pattern ( (_module.__default.Loc |cmd#0@@19| |deps#0@@18| |e#0@@10|))
))))) (=> (=> (|_module.__default.ConsistentCache#canCall| |stC#0@@32|) (or (_module.__default.ConsistentCache |stC#0@@32|) (forall ((|cmd#0@@20| T@U) (|deps#0@@19| T@U) (|e#0@@11| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#0@@20| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@19| Tclass._module.Expression)) ($Is SeqType |e#0@@11| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@32|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@20| |deps#0@@19| |e#0@@11|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@32|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0@@20| |deps#0@@19| |e#0@@11|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1200|
 :pattern ( (_module.__default.Loc |cmd#0@@20| |deps#0@@19| |e#0@@11|))
)))) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (|_module.__default.evalC#canCall| |arg#1_0@0| |stC#0@@32| |env#0@@15|) (let ((|result#0@@7| (_module.__default.evalC ($LS $LZ) |arg#1_0@0| |stC#0@@32| |env#0@@15|)))
 (and (and (_module.Tuple.Pair_q |result#0@@7|) (_module.Tuple.Pair_q |result#0@@7|)) (let ((|stC'#0@@8| ($Unbox DatatypeTypeType (_module.Tuple.snd |result#0@@7|))))
(let ((|expr'#0@@0| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#0@@7|))))
 (and (|_module.__default.ConsistentCache#canCall| |stC'#0@@8|) (=> (_module.__default.ConsistentCache |stC'#0@@8|) (=> (_module.Expression.exprError_q |expr'#0@@0|) (|$IsA#_module.Reason| (_module.Expression.r |expr'#0@@0|)))))))))) (and (let ((|result#0@@8| (_module.__default.evalC ($LS ($LS $LZ)) |arg#1_0@0| |stC#0@@32| |env#0@@15|)))
(let ((|stC'#0@@9| ($Unbox DatatypeTypeType (_module.Tuple.snd |result#0@@8|))))
 (and (|_module.__default.ConsistentCache#canCall| |stC'#0@@9|) (and (_module.__default.ConsistentCache |stC'#0@@9|) (forall ((|cmd#1@@2| T@U) (|deps#1@@2| T@U) (|e#1@@9| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#1@@2| Tclass._module.Expression) ($Is DatatypeTypeType |deps#1@@2| Tclass._module.Expression)) ($Is SeqType |e#1@@9| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC'#0@@9|)) (_module.__default.Hash (_module.__default.Loc |cmd#1@@2| |deps#1@@2| |e#1@@9|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC'#0@@9|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#1@@2| |deps#1@@2| |e#1@@9|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1203|
 :pattern ( (_module.__default.Loc |cmd#1@@2| |deps#1@@2| |e#1@@9|))
)))))) (let ((|result#0@@9| (_module.__default.evalC ($LS ($LS $LZ)) |arg#1_0@0| |stC#0@@32| |env#0@@15|)))
(let ((|expr'#0@@1| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#0@@9|))))
 (=> (_module.Expression.exprError_q |expr'#0@@1|) (not (|_module.Reason#Equal| (_module.Expression.r |expr'#0@@1|) |#_module.Reason.rInconsistentCache|))))))) (=> (and (and (and (= $Heap@0 $Heap@1) ($IsAlloc DatatypeTypeType |arg#1_0@0| Tclass._module.Expression $Heap@1)) (and ($IsAlloc DatatypeTypeType |stC#0@@32| Tclass._module.StateC $Heap@1) ($IsAllocBox |env#0@@15| Tclass._module.Env $Heap@1))) (and (and (|_module.__default.evalC#canCall| |arg#1_0@0| |stC#0@@32| |env#0@@15|) (_module.Tuple.Pair_q (_module.__default.evalC ($LS $LZ) |arg#1_0@0| |stC#0@@32| |env#0@@15|))) (and (|_module.__default.evalC#canCall| |arg#1_0@0| |stC#0@@32| |env#0@@15|) (= |result#1_0@0| (_module.__default.evalC ($LS $LZ) |arg#1_0@0| |stC#0@@32| |env#0@@15|))))) (and (=> (= (ControlFlow 0 4) (- 0 13)) true) (=> (_module.Tuple.Pair_q |result#1_0@0|) (=> (and (_module.Tuple.Pair_q |result#1_0@0|) (= |$rhs#1_0@0| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#1_0@0|)))) (and (=> (= (ControlFlow 0 4) (- 0 12)) true) (=> (_module.Tuple.Pair_q |result#1_0@0|) (=> (and (_module.Tuple.Pair_q |result#1_0@0|) (= |$rhs#1_1@0| ($Unbox DatatypeTypeType (_module.Tuple.snd |result#1_0@0|)))) (and (=> (= (ControlFlow 0 4) (- 0 11)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |args#0@@11|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |args#0@@11|))) (=> (and (= |args##1_0@0| (|Seq#Drop| |args#0@@11| (LitInt 1))) (= |args'##1_0@0| (|Seq#Append| |args'#0@@6| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |$rhs#1_0@0|))))) (and (=> (= (ControlFlow 0 4) (- 0 10)) true) (=> (= |stsC'##1_0@0| (|Set#Union| |stsC'#0@@6| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |$rhs#1_1@0|)))) (and (=> (= (ControlFlow 0 4) (- 0 9)) (or (or (<= 0 (|Seq#Length| |args#0@@11|)) (< (DtRank |expr#0@@16|) (DtRank |expr#0@@16|))) (= (|Seq#Length| |args##1_0@0|) (|Seq#Length| |args#0@@11|)))) (=> (or (or (<= 0 (|Seq#Length| |args#0@@11|)) (< (DtRank |expr#0@@16|) (DtRank |expr#0@@16|))) (= (|Seq#Length| |args##1_0@0|) (|Seq#Length| |args#0@@11|))) (and (=> (= (ControlFlow 0 4) (- 0 8)) (or (< (DtRank |expr#0@@16|) (DtRank |expr#0@@16|)) (and (= (DtRank |expr#0@@16|) (DtRank |expr#0@@16|)) (< (|Seq#Length| |args##1_0@0|) (|Seq#Length| |args#0@@11|))))) (=> (or (< (DtRank |expr#0@@16|) (DtRank |expr#0@@16|)) (and (= (DtRank |expr#0@@16|) (DtRank |expr#0@@16|)) (< (|Seq#Length| |args##1_0@0|) (|Seq#Length| |args#0@@11|)))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (=> (|_module.__default.ConsistentCache#canCall| |stC#0@@32|) (or (_module.__default.ConsistentCache |stC#0@@32|) (forall ((|cmd#0@@21| T@U) (|deps#0@@20| T@U) (|e#0@@12| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#0@@21| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@20| Tclass._module.Expression)) ($Is SeqType |e#0@@12| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@32|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@21| |deps#0@@20| |e#0@@12|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@32|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0@@21| |deps#0@@20| |e#0@@12|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1247|
 :pattern ( (_module.__default.Loc |cmd#0@@21| |deps#0@@20| |e#0@@12|))
))))) (=> (=> (|_module.__default.ConsistentCache#canCall| |stC#0@@32|) (or (_module.__default.ConsistentCache |stC#0@@32|) (forall ((|cmd#0@@22| T@U) (|deps#0@@21| T@U) (|e#0@@13| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#0@@22| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@21| Tclass._module.Expression)) ($Is SeqType |e#0@@13| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@32|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@22| |deps#0@@21| |e#0@@13|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@32|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0@@22| |deps#0@@21| |e#0@@13|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1247|
 :pattern ( (_module.__default.Loc |cmd#0@@22| |deps#0@@21| |e#0@@13|))
)))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (forall ((|stC'#1@@6| T@U) ) (!  (=> ($Is DatatypeTypeType |stC'#1@@6| Tclass._module.StateC) (=> (|Set#IsMember| |stsC'##1_0@0| ($Box DatatypeTypeType |stC'#1@@6|)) (_module.__default.ConsistentCache |stC'#1@@6|)))
 :qid |CloudMakeConsistentBuildslegacydfy.647:19|
 :skolemid |1249|
 :pattern ( (_module.__default.ConsistentCache |stC'#1@@6|))
 :pattern ( (|Set#IsMember| |stsC'##1_0@0| ($Box DatatypeTypeType |stC'#1@@6|)))
))) (=> (forall ((|stC'#1@@7| T@U) ) (!  (=> ($Is DatatypeTypeType |stC'#1@@7| Tclass._module.StateC) (=> (|Set#IsMember| |stsC'##1_0@0| ($Box DatatypeTypeType |stC'#1@@7|)) (_module.__default.ConsistentCache |stC'#1@@7|)))
 :qid |CloudMakeConsistentBuildslegacydfy.647:19|
 :skolemid |1249|
 :pattern ( (_module.__default.ConsistentCache |stC'#1@@7|))
 :pattern ( (|Set#IsMember| |stsC'##1_0@0| ($Box DatatypeTypeType |stC'#1@@7|)))
)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((|arg#1@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#1@@1| Tclass._module.Expression) (=> (|Seq#Contains| |args##1_0@0| ($Box DatatypeTypeType |arg#1@@1|)) (< (DtRank |arg#1@@1|) (DtRank |expr#0@@16|))))
 :qid |CloudMakeConsistentBuildslegacydfy.648:19|
 :skolemid |1250|
 :pattern ( (|Seq#Contains| |args##1_0@0| ($Box DatatypeTypeType |arg#1@@1|)))
))) (=> (forall ((|arg#1@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#1@@2| Tclass._module.Expression) (=> (|Seq#Contains| |args##1_0@0| ($Box DatatypeTypeType |arg#1@@2|)) (< (DtRank |arg#1@@2|) (DtRank |expr#0@@16|))))
 :qid |CloudMakeConsistentBuildslegacydfy.648:19|
 :skolemid |1250|
 :pattern ( (|Seq#Contains| |args##1_0@0| ($Box DatatypeTypeType |arg#1@@2|)))
)) (=> (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (=> (and (and (and (|_module.__default.evalArgsC_k#canCall| |expr#0@@16| |args##1_0@0| |stC#0@@32| |env#0@@15| |args'##1_0@0| |stsC'##1_0@0|) (let ((|result#0@@10| (_module.__default.evalArgsC_k ($LS $LZ) |expr#0@@16| |args##1_0@0| |stC#0@@32| |env#0@@15| |args'##1_0@0| |stsC'##1_0@0|)))
 (and (_module.Tuple.Pair_q |result#0@@10|) (let ((|stsC''#0@@2| ($Unbox SetType (_module.Tuple.snd |result#0@@10|))))
(forall ((|stC''#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |stC''#1@@0| Tclass._module.StateC) (=> (|Set#IsMember| |stsC''#0@@2| ($Box DatatypeTypeType |stC''#1@@0|)) (|_module.__default.ConsistentCache#canCall| |stC''#1@@0|)))
 :qid |CloudMakeConsistentBuildslegacydfy.652:12|
 :skolemid |1251|
 :pattern ( (_module.__default.ConsistentCache |stC''#1@@0|))
 :pattern ( (|Set#IsMember| |stsC''#0@@2| ($Box DatatypeTypeType |stC''#1@@0|)))
)))))) (let ((|result#0@@11| (_module.__default.evalArgsC_k ($LS ($LS $LZ)) |expr#0@@16| |args##1_0@0| |stC#0@@32| |env#0@@15| |args'##1_0@0| |stsC'##1_0@0|)))
(let ((|stsC''#0@@3| ($Unbox SetType (_module.Tuple.snd |result#0@@11|))))
(forall ((|stC''#1@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |stC''#1@@1| Tclass._module.StateC) (=> (|Set#IsMember| |stsC''#0@@3| ($Box DatatypeTypeType |stC''#1@@1|)) (_module.__default.ConsistentCache |stC''#1@@1|)))
 :qid |CloudMakeConsistentBuildslegacydfy.652:12|
 :skolemid |1254|
 :pattern ( (_module.__default.ConsistentCache |stC''#1@@1|))
 :pattern ( (|Set#IsMember| |stsC''#0@@3| ($Box DatatypeTypeType |stC''#1@@1|)))
))))) (and (= $Heap@1 $Heap@2) (= (ControlFlow 0 4) 2))) GeneratedUnifiedExit_correct))))))))))))))))))))))))))))))))))))
(let ((anon3_Then_correct  (=> (and (|Seq#Equal| |args#0@@11| |Seq#Empty|) (= (ControlFlow 0 3) 2)) GeneratedUnifiedExit_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@3 alloc false)) (=> (and (|$IsA#_module.Expression| |expr#0@@16|) (|$IsA#_module.StateC| |stC#0@@32|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@3 $Heap@0) (forall ((|$ih#expr0#0| T@U) (|$ih#args0#0| T@U) (|$ih#stC0#0| T@U) (|$ih#args'0#0| T@U) (|$ih#stsC'0#0| T@U) ) (!  (=> (and (and (and (and (and (and ($Is DatatypeTypeType |$ih#expr0#0| Tclass._module.Expression) ($Is SeqType |$ih#args0#0| (TSeq Tclass._module.Expression))) ($Is DatatypeTypeType |$ih#stC0#0| Tclass._module.StateC)) ($Is SeqType |$ih#args'0#0| (TSeq Tclass._module.Expression))) ($Is SetType |$ih#stsC'0#0| (TSet Tclass._module.StateC))) (and (and (_module.__default.ConsistentCache |$ih#stC0#0|) (forall ((|stC'#2@@3| T@U) ) (!  (=> ($Is DatatypeTypeType |stC'#2@@3| Tclass._module.StateC) (=> (|Set#IsMember| |$ih#stsC'0#0| ($Box DatatypeTypeType |stC'#2@@3|)) (_module.__default.ConsistentCache |stC'#2@@3|)))
 :qid |CloudMakeConsistentBuildslegacydfy.647:19|
 :skolemid |1263|
 :pattern ( (_module.__default.ConsistentCache |stC'#2@@3|))
 :pattern ( (|Set#IsMember| |$ih#stsC'0#0| ($Box DatatypeTypeType |stC'#2@@3|)))
))) (forall ((|arg#3@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#3@@1| Tclass._module.Expression) (=> (|Seq#Contains| |$ih#args0#0| ($Box DatatypeTypeType |arg#3@@1|)) (< (DtRank |arg#3@@1|) (DtRank |$ih#expr0#0|))))
 :qid |CloudMakeConsistentBuildslegacydfy.648:19|
 :skolemid |1264|
 :pattern ( (|Seq#Contains| |$ih#args0#0| ($Box DatatypeTypeType |arg#3@@1|)))
)))) (or (< (DtRank |$ih#expr0#0|) (DtRank |expr#0@@16|)) (and (= (DtRank |$ih#expr0#0|) (DtRank |expr#0@@16|)) (and (<= 0 (|Seq#Length| |$ih#args0#0|)) (< (|Seq#Length| |$ih#args0#0|) (|Seq#Length| |args#0@@11|)))))) (let ((|result#1@@5| (_module.__default.evalArgsC_k ($LS $LZ) |$ih#expr0#0| |$ih#args0#0| |$ih#stC0#0| |env#0@@15| |$ih#args'0#0| |$ih#stsC'0#0|)))
(let ((|stsC''#1@@1| ($Unbox SetType (_module.Tuple.snd |result#1@@5|))))
(forall ((|stC''#2| T@U) ) (!  (=> ($Is DatatypeTypeType |stC''#2| Tclass._module.StateC) (=> (|Set#IsMember| |stsC''#1@@1| ($Box DatatypeTypeType |stC''#2|)) (_module.__default.ConsistentCache |stC''#2|)))
 :qid |CloudMakeConsistentBuildslegacydfy.652:12|
 :skolemid |1265|
 :pattern ( (_module.__default.ConsistentCache |stC''#2|))
 :pattern ( (|Set#IsMember| |stsC''#1@@1| ($Box DatatypeTypeType |stC''#2|)))
)))))
 :qid |CloudMakeConsistentBuildslegacydfy.644:23|
 :skolemid |1266|
 :pattern ( (_module.__default.evalArgsC_k ($LS $LZ) |$ih#expr0#0| |$ih#args0#0| |$ih#stC0#0| |env#0@@15| |$ih#args'0#0| |$ih#stsC'0#0|))
)))) (and (=> (= (ControlFlow 0 17) 3) anon3_Then_correct) (=> (= (ControlFlow 0 17) 4) anon3_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and (and ($Is DatatypeTypeType |expr#0@@16| Tclass._module.Expression) ($IsAlloc DatatypeTypeType |expr#0@@16| Tclass._module.Expression $Heap@@3)) (|$IsA#_module.Expression| |expr#0@@16|)) (and ($Is SeqType |args#0@@11| (TSeq Tclass._module.Expression)) ($IsAlloc SeqType |args#0@@11| (TSeq Tclass._module.Expression) $Heap@@3))) (=> (and (and (and (and (and (and ($Is DatatypeTypeType |stC#0@@32| Tclass._module.StateC) ($IsAlloc DatatypeTypeType |stC#0@@32| Tclass._module.StateC $Heap@@3)) (|$IsA#_module.StateC| |stC#0@@32|)) (and ($IsBox |env#0@@15| Tclass._module.Env) ($IsAllocBox |env#0@@15| Tclass._module.Env $Heap@@3))) (and (and ($Is SeqType |args'#0@@6| (TSeq Tclass._module.Expression)) ($IsAlloc SeqType |args'#0@@6| (TSeq Tclass._module.Expression) $Heap@@3)) (and ($Is SetType |stsC'#0@@6| (TSet Tclass._module.StateC)) ($IsAlloc SetType |stsC'#0@@6| (TSet Tclass._module.StateC) $Heap@@3)))) (and (and (and ($Is DatatypeTypeType |arg#1_0| Tclass._module.Expression) ($IsAlloc DatatypeTypeType |arg#1_0| Tclass._module.Expression $Heap@@3)) true) (and (=> |defass#result#1_0| (and ($Is DatatypeTypeType |result#1_0| (Tclass._module.Tuple Tclass._module.Expression Tclass._module.StateC)) ($IsAlloc DatatypeTypeType |result#1_0| (Tclass._module.Tuple Tclass._module.Expression Tclass._module.StateC) $Heap@@3))) true))) (and (and (and (and ($Is DatatypeTypeType |arg'#1_0| Tclass._module.Expression) ($IsAlloc DatatypeTypeType |arg'#1_0| Tclass._module.Expression $Heap@@3)) true) (and (and (=> |defass#stC'#1_0| (and ($Is DatatypeTypeType |stC'#1_0| Tclass._module.StateC) ($IsAlloc DatatypeTypeType |stC'#1_0| Tclass._module.StateC $Heap@@3))) true) (= 7 $FunctionContextHeight))) (and (and (and (|_module.__default.ConsistentCache#canCall| |stC#0@@32|) (and (_module.__default.ConsistentCache |stC#0@@32|) (forall ((|cmd#1@@3| T@U) (|deps#1@@3| T@U) (|e#1@@10| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#1@@3| Tclass._module.Expression) ($Is DatatypeTypeType |deps#1@@3| Tclass._module.Expression)) ($Is SeqType |e#1@@10| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@32|)) (_module.__default.Hash (_module.__default.Loc |cmd#1@@3| |deps#1@@3| |e#1@@10|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@32|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#1@@3| |deps#1@@3| |e#1@@10|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1256|
 :pattern ( (_module.__default.Loc |cmd#1@@3| |deps#1@@3| |e#1@@10|))
)))) (forall ((|stC'#1@@8| T@U) ) (!  (=> ($Is DatatypeTypeType |stC'#1@@8| Tclass._module.StateC) (=> (|Set#IsMember| |stsC'#0@@6| ($Box DatatypeTypeType |stC'#1@@8|)) (_module.__default.ConsistentCache |stC'#1@@8|)))
 :qid |CloudMakeConsistentBuildslegacydfy.647:19|
 :skolemid |1257|
 :pattern ( (_module.__default.ConsistentCache |stC'#1@@8|))
 :pattern ( (|Set#IsMember| |stsC'#0@@6| ($Box DatatypeTypeType |stC'#1@@8|)))
))) (and (forall ((|arg#1@@3| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#1@@3| Tclass._module.Expression) (=> (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#1@@3|)) (< (DtRank |arg#1@@3|) (DtRank |expr#0@@16|))))
 :qid |CloudMakeConsistentBuildslegacydfy.648:19|
 :skolemid |1258|
 :pattern ( (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#1@@3|)))
