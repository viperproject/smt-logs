...
(set-info :boogie-vc-id CheckWellFormed$$M0.__default.CompatiblePick)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (|Set#IsMember| |sts#0@@5| |st#0@@9|)) (=> (and (and (and ($IsAlloc SetType |sts#0@@5| (TSet Tclass.M0.State) $Heap@@4) (|M0.__default.Compatible#canCall| |sts#0@@5|)) (and (M0.__default.Compatible |sts#0@@5|) ($IsAllocBox |st#0@@9| Tclass.M0.State $Heap@@4))) (and (and (|M0.__default.DomSt#canCall| |st#0@@9|) (|Set#IsMember| (M0.__default.DomSt |st#0@@9|) |p#0@@4|)) (and ($IsAlloc SetType |sts#0@@5| (TSet Tclass.M0.State) $Heap@@4) ($IsAlloc boolType (bool_2_U |useCache#0@@4|) TBool $Heap@@4)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (not (|Set#Equal| |sts#0@@5| |Set#Empty|))) (=> (and (and (not (|Set#Equal| |sts#0@@5| |Set#Empty|)) (|M0.__default.Combine#canCall| |sts#0@@5| |useCache#0@@4|)) (and (= |##st#1@0| (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |sts#0@@5| |useCache#0@@4|)) ($IsAllocBox |##st#1@0| Tclass.M0.State $Heap@@4))) (=> (and (and (and (|M0.__default.DomSt#canCall| (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |sts#0@@5| |useCache#0@@4|)) (|Set#IsMember| (M0.__default.DomSt (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |sts#0@@5| |useCache#0@@4|)) |p#0@@4|)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (= $Heap@@4 $Heap@0) ($IsAllocBox |p#0@@4| Tclass.M0.Path $Heap@0)) (and ($IsAlloc SetType |sts#0@@5| (TSet Tclass.M0.State) $Heap@0) ($IsAlloc boolType (bool_2_U |useCache#0@@4|) TBool $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (not (|Set#Equal| |sts#0@@5| |Set#Empty|))) (=> (and (and (not (|Set#Equal| |sts#0@@5| |Set#Empty|)) (|M0.__default.Combine#canCall| |sts#0@@5| |useCache#0@@4|)) (and (= |##st#2@0| (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |sts#0@@5| |useCache#0@@4|)) ($IsAllocBox |##st#2@0| Tclass.M0.State $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#IsMember| (M0.__default.DomSt |##st#2@0|) |p#0@@4|)) (=> (|Set#IsMember| (M0.__default.DomSt |##st#2@0|) |p#0@@4|) (=> (and (and (|M0.__default.GetSt#canCall| |p#0@@4| (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |sts#0@@5| |useCache#0@@4|)) ($IsAllocBox |p#0@@4| Tclass.M0.Path $Heap@0)) (and ($IsAllocBox |st#0@@9| Tclass.M0.State $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (|Set#IsMember| (M0.__default.DomSt |st#0@@9|) |p#0@@4|)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (=> (and (and (and ($IsBox |p#0@@4| Tclass.M0.Path) ($IsAllocBox |p#0@@4| Tclass.M0.Path $Heap@@4)) (and ($IsBox |st#0@@9| Tclass.M0.State) ($IsAllocBox |st#0@@9| Tclass.M0.State $Heap@@4))) (and (and ($Is SetType |sts#0@@5| (TSet Tclass.M0.State)) ($IsAlloc SetType |sts#0@@5| (TSet Tclass.M0.State) $Heap@@4)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 6) 2)))) anon0_correct))))
