...
(assert (forall ((d@@25 T@U) ) (!  (=> (M0.Tuple.Pair_q d@@25) (exists ((|a#142#0#0| T@U) (|a#142#1#0| T@U) ) (! (= d@@25 (|#M0.Tuple.Pair| |a#142#0#0| |a#142#1#0|))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon7_correct true))
(let ((anon9_Else_correct  (=> (and (=> (|Set#IsMember| |sts'#0@0| |st'#0@0|) (and (M0.__default.ValidState |st'#0@0|) (M0.__default.Extends |stOrig#0@@5| |st'#0@0|))) (= (ControlFlow 0 3) 1)) anon7_correct)))
(let ((anon9_Then_correct  (=> (|Set#IsMember| |sts'#0@0| |st'#0@0|) (=> (and (and (and ($IsAllocBox |st'#0@0| Tclass.M0.State $Heap@0) (|M0.__default.ValidState#canCall| |st'#0@0|)) (and (M0.__default.ValidState |st'#0@0|) ($IsAllocBox |stOrig#0@@5| Tclass.M0.State $Heap@0))) (and (and ($IsAllocBox |st'#0@0| Tclass.M0.State $Heap@0) (|M0.__default.Extends#canCall| |stOrig#0@@5| |st'#0@0|)) (and (M0.__default.Extends |stOrig#0@@5| |st'#0@0|) (= (ControlFlow 0 2) 1)))) anon7_correct))))
(let ((anon4_correct  (=> (forall ((|arg#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#1@@0| Tclass.M0.Expression) (=> (|Seq#Contains| |args#0@@8| ($Box DatatypeTypeType |arg#1@@0|)) (< (DtRank |arg#1@@0|) (DtRank |context#0@@5|))))
 :qid |CloudMakeParallelBuildsdfy.416:14|
 :skolemid |1104|
 :pattern ( (|Seq#Contains| |args#0@@8| ($Box DatatypeTypeType |arg#1@@0|)))
)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@9 $Heap@0)) (=> (and (and (and ($Is SeqType |args'#0@0| (TSeq Tclass.M0.Expression)) ($IsAlloc SeqType |args'#0@0| (TSeq Tclass.M0.Expression) $Heap@0)) (and ($Is SetType |sts'#0@0| (TSet Tclass.M0.State)) ($IsAlloc SetType |sts'#0@0| (TSet Tclass.M0.State) $Heap@0))) (and (and ($IsAlloc DatatypeTypeType |context#0@@5| Tclass.M0.Expression $Heap@0) ($IsAlloc SeqType |args#0@@8| (TSeq Tclass.M0.Expression) $Heap@0)) (and ($IsAllocBox |stOrig#0@@5| Tclass.M0.State $Heap@0) ($IsAllocBox |env#0@@13| Tclass.M0.Env $Heap@0)))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (M0.__default.ValidEnv |env#0@@13|)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((|arg#2@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#2@@0| Tclass.M0.Expression) (=> (|Seq#Contains| |args#0@@8| ($Box DatatypeTypeType |arg#2@@0|)) (< (DtRank |arg#2@@0|) (DtRank |context#0@@5|))))
 :qid |CloudMakeParallelBuildsdfy.271:14|
 :skolemid |1105|
...
))) (|M0.__default.evalArgs#canCall| |context#0@@5| |args#0@@8| |stOrig#0@@5| |env#0@@13|)) (and (and (M0.Tuple.Pair_q (M0.__default.evalArgs ($LS $LZ) |context#0@@5| |args#0@@8| |stOrig#0@@5| |env#0@@13|)) (|M0.Tuple#Equal| (|#M0.Tuple.Pair| ($Box SeqType |args'#0@0|) ($Box SetType |sts'#0@0|)) (M0.__default.evalArgs ($LS $LZ) |context#0@@5| |args#0@@8| |stOrig#0@@5| |env#0@@13|))) (and ($IsBox |st'#0@0| Tclass.M0.State) ($IsAllocBox |st'#0@0| Tclass.M0.State $Heap@0)))) (and (=> (= (ControlFlow 0 4) 2) anon9_Then_correct) (=> (= (ControlFlow 0 4) 3) anon9_Else_correct))))))))))
(let ((anon8_Else_correct  (=> (and (=> (|Seq#Contains| |args#0@@8| ($Box DatatypeTypeType |arg#0@0|)) (< (DtRank |arg#0@0|) (DtRank |context#0@@5|))) (= (ControlFlow 0 8) 4)) anon4_correct)))
(let ((anon8_Then_correct  (=> (|Seq#Contains| |args#0@@8| ($Box DatatypeTypeType |arg#0@0|)) (=> (and (< (DtRank |arg#0@0|) (DtRank |context#0@@5|)) (= (ControlFlow 0 7) 4)) anon4_correct))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@9 alloc false)) (=> (and (and (and ($IsAllocBox |stOrig#0@@5| Tclass.M0.State $Heap@@9) (|M0.__default.ValidState#canCall| |stOrig#0@@5|)) (and (M0.__default.ValidState |stOrig#0@@5|) ($IsAllocBox |env#0@@13| Tclass.M0.Env $Heap@@9))) (and (and (|M0.__default.ValidEnv#canCall| |env#0@@13|) (M0.__default.ValidEnv |env#0@@13|)) (and ($Is DatatypeTypeType |arg#0@0| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |arg#0@0| Tclass.M0.Expression $Heap@@9)))) (and (=> (= (ControlFlow 0 9) 7) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@9) ($IsHeapAnchor $Heap@@9)) (=> (and (and (and (and ($Is DatatypeTypeType |context#0@@5| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |context#0@@5| Tclass.M0.Expression $Heap@@9)) (|$IsA#M0.Expression| |context#0@@5|)) (and (and ($Is SeqType |args#0@@8| (TSeq Tclass.M0.Expression)) ($IsAlloc SeqType |args#0@@8| (TSeq Tclass.M0.Expression) $Heap@@9)) (and ($IsBox |stOrig#0@@5| Tclass.M0.State) ($IsAllocBox |stOrig#0@@5| Tclass.M0.State $Heap@@9)))) (and (and (and ($IsBox |env#0@@13| Tclass.M0.Env) ($IsAllocBox |env#0@@13| Tclass.M0.Env $Heap@@9)) (and ($Is SeqType |args'#0@@1| (TSeq Tclass.M0.Expression)) ($IsAlloc SeqType |args'#0@@1| (TSeq Tclass.M0.Expression) $Heap@@9))) (and (and ($Is SetType |sts'#0@@1| (TSet Tclass.M0.State)) ($IsAlloc SetType |sts'#0@@1| (TSet Tclass.M0.State) $Heap@@9)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 10) 9))))) anon0_correct))))
