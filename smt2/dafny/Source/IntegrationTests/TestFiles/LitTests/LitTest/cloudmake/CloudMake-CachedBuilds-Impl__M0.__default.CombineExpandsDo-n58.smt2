...
(set-info :boogie-vc-id Impl$$M0.__default.CombineExpandsDomain)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@4 $Heap@0) (forall ((|$ih#sts0#0| T@U) (|$ih#useCache0#0| Bool) ) (!  (=> (and (and ($Is SetType |$ih#sts0#0| (TSet Tclass.M0.State)) (|Set#IsMember| |$ih#sts0#0| |st#0@@7|)) (or (and (|Set#Subset| |$ih#sts0#0| |sts#0@@3|) (not (|Set#Subset| |sts#0@@3| |$ih#sts0#0|))) (and (|Set#Equal| |$ih#sts0#0| |sts#0@@3|) (and (not |$ih#useCache0#0|) |useCache#0@@4|)))) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@7|) |p#0@@2|) (|Set#IsMember| (M0.__default.DomSt (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |$ih#sts0#0| |$ih#useCache0#0|)) |p#0@@2|)))
 :qid |CloudMakeCachedBuildsdfy.1316:50|
 :skolemid |1780|
 :pattern ( (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |$ih#sts0#0| |$ih#useCache0#0|))
)))) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1)) (and (and reveal_M0._default.Combine (= (ControlFlow 0 2) (- 0 1))) (|Set#IsMember| (M0.__default.DomSt |st#0@@7|) |p#0@@2|))) (|Set#IsMember| (M0.__default.DomSt (M0.__default.Combine ($LS ($LS $LZ)) reveal_M0._default.Combine |sts#0@@3| |useCache#0@@4|)) |p#0@@2|))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (=> (and (and ($IsBox |p#0@@2| Tclass.M0.Path) ($IsAllocBox |p#0@@2| Tclass.M0.Path $Heap@@4)) (and ($IsBox |st#0@@7| Tclass.M0.State) ($IsAllocBox |st#0@@7| Tclass.M0.State $Heap@@4))) (=> (and (and (and ($Is SetType |sts#0@@3| (TSet Tclass.M0.State)) ($IsAlloc SetType |sts#0@@3| (TSet Tclass.M0.State) $Heap@@4)) (= 4 $FunctionContextHeight)) (and (|Set#IsMember| |sts#0@@3| |st#0@@7|) (= (ControlFlow 0 3) 2))) anon0_correct)))))
