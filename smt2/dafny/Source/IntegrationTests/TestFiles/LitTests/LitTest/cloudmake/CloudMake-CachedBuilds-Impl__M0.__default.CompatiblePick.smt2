...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|sts#0@@0| T@U) ) (!  (=> (or (|M0.__default.Compatible#canCall| |sts#0@@0|) (and (< 2 $FunctionContextHeight) ($Is SetType |sts#0@@0| (TSet Tclass.M0.State)))) (and (forall ((|st#0@@2| T@U) (|st'#0@@0| T@U) ) (!  (=> (and ($IsBox |st#0@@2| Tclass.M0.State) ($IsBox |st'#0@@0| Tclass.M0.State)) (=> (|Set#IsMember| |sts#0@@0| |st#0@@2|) (=> (|Set#IsMember| |sts#0@@0| |st'#0@@0|) (forall ((|p#0@@2| T@U) ) (!  (=> ($IsBox |p#0@@2| Tclass.M0.Path) (and (|M0.__default.DomSt#canCall| |st#0@@2|) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@2|) |p#0@@2|) (and (|M0.__default.DomSt#canCall| |st'#0@@0|) (=> (|Set#IsMember| (M0.__default.DomSt |st'#0@@0|) |p#0@@2|) (and (|M0.__default.GetSt#canCall| |p#0@@2| |st#0@@2|) (|M0.__default.GetSt#canCall| |p#0@@2| |st'#0@@0|)))))))
 ...
 :pattern ( (M0.__default.DomSt |st'#0@@0|) (|Set#IsMember| |sts#0@@0| |st#0@@2|))
 :pattern ( (M0.__default.DomSt |st#0@@2|) (|Set#IsMember| |sts#0@@0| |st'#0@@0|))
 :pattern ( (|Set#IsMember| |sts#0@@0| |st'#0@@0|) (|Set#IsMember| |sts#0@@0| |st#0@@2|))
)) (= (M0.__default.Compatible |sts#0@@0|) (forall ((|st#0@@3| T@U) (|st'#0@@1| T@U) ) (!  (=> (and ($IsBox |st#0@@3| Tclass.M0.State) ($IsBox |st'#0@@1| Tclass.M0.State)) (=> (and (|Set#IsMember| |sts#0@@0| |st#0@@3|) (|Set#IsMember| |sts#0@@0| |st'#0@@1|)) (forall ((|p#0@@3| T@U) ) (!  (=> ($IsBox |p#0@@3| Tclass.M0.Path) (=> (and (|Set#IsMember| (M0.__default.DomSt |st#0@@3|) |p#0@@3|) (|Set#IsMember| (M0.__default.DomSt |st'#0@@1|) |p#0@@3|)) (= (M0.__default.GetSt |p#0@@3| |st#0@@3|) (M0.__default.GetSt |p#0@@3| |st'#0@@1|))))
 :qid |CloudMakeCachedBuildsdfy.55:14|
 :skolemid |746|
 ...
 :qid |CloudMakeCachedBuildsdfy.54:12|
 :skolemid |747|
 :pattern ( (M0.__default.DomSt |st'#0@@1|) (M0.__default.DomSt |st#0@@3|))
 :pattern ( (M0.__default.DomSt |st'#0@@1|) (|Set#IsMember| |sts#0@@0| |st#0@@3|))
 :pattern ( (M0.__default.DomSt |st#0@@3|) (|Set#IsMember| |sts#0@@0| |st'#0@@1|))
 :pattern ( (|Set#IsMember| |sts#0@@0| |st'#0@@1|) (|Set#IsMember| |sts#0@@0| |st#0@@3|))
)))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@0 T@U) (|sts#0@@1| T@U) (|useCache#0@@1| Bool) ) (!  (=> (or (|M0.__default.Combine#canCall| |sts#0@@1| |useCache#0@@1|) (and (< 3 $FunctionContextHeight) (and ($Is SetType |sts#0@@1| (TSet Tclass.M0.State)) (not (|Set#Equal| |sts#0@@1| |Set#Empty|))))) (and (and (|M0.__default.PickOne#canCall| Tclass.M0.State |sts#0@@1|) (let ((|st#0@@4| (M0.__default.PickOne Tclass.M0.State |sts#0@@1|)))
 (=> (not (|Set#Equal| |sts#0@@1| (|Set#UnionOne| |Set#Empty| |st#0@@4|))) (and (|M0.__default.Combine#canCall| (|Set#Difference| |sts#0@@1| (|Set#UnionOne| |Set#Empty| |st#0@@4|)) |useCache#0@@1|) (|M0.__default.Union#canCall| (M0.__default.Combine $ly@@0 reveal_M0._default.Combine (|Set#Difference| |sts#0@@1| (|Set#UnionOne| |Set#Empty| |st#0@@4|)) |useCache#0@@1|) |st#0@@4| |useCache#0@@1|))))) (= (M0.__default.Combine ($LS $ly@@0) true |sts#0@@1| |useCache#0@@1|) (let ((|st#0@@5| (M0.__default.PickOne Tclass.M0.State |sts#0@@1|)))
(ite (|Set#Equal| |sts#0@@1| (|Set#UnionOne| |Set#Empty| |st#0@@5|)) |st#0@@5| (M0.__default.Union (M0.__default.Combine $ly@@0 reveal_M0._default.Combine (|Set#Difference| |sts#0@@1| (|Set#UnionOne| |Set#Empty| |st#0@@5|)) |useCache#0@@1|) |st#0@@5| |useCache#0@@1|))))))
 :qid |CloudMakeCachedBuildsdfy.64:28|
 :skolemid |782|
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|sts#0@@4| T@U) ) (!  (=> (or (|M0.__default.Compatible#canCall| (Lit SetType |sts#0@@4|)) (and (< 2 $FunctionContextHeight) ($Is SetType |sts#0@@4| (TSet Tclass.M0.State)))) (and (forall ((|st#1@@1| T@U) (|st'#1| T@U) ) (!  (=> (and ($IsBox |st#1@@1| Tclass.M0.State) ($IsBox |st'#1| Tclass.M0.State)) (=> (|Set#IsMember| (Lit SetType |sts#0@@4|) |st#1@@1|) (=> (|Set#IsMember| (Lit SetType |sts#0@@4|) |st'#1|) (forall ((|p#1| T@U) ) (!  (=> ($IsBox |p#1| Tclass.M0.Path) (and (|M0.__default.DomSt#canCall| |st#1@@1|) (=> (|Set#IsMember| (M0.__default.DomSt |st#1@@1|) |p#1|) (and (|M0.__default.DomSt#canCall| |st'#1|) (=> (|Set#IsMember| (M0.__default.DomSt |st'#1|) |p#1|) (and (|M0.__default.GetSt#canCall| |p#1| |st#1@@1|) (|M0.__default.GetSt#canCall| |p#1| |st'#1|)))))))
 :qid |CloudMakeCachedBuildsdfy.55:14|
 :skolemid |753|
...
)) (= (M0.__default.Compatible (Lit SetType |sts#0@@4|)) (forall ((|st#1@@2| T@U) (|st'#1@@0| T@U) ) (!  (=> (and ($IsBox |st#1@@2| Tclass.M0.State) ($IsBox |st'#1@@0| Tclass.M0.State)) (=> (and (|Set#IsMember| (Lit SetType |sts#0@@4|) |st#1@@2|) (|Set#IsMember| (Lit SetType |sts#0@@4|) |st'#1@@0|)) (forall ((|p#1@@0| T@U) ) (!  (=> ($IsBox |p#1@@0| Tclass.M0.Path) (=> (and (|Set#IsMember| (M0.__default.DomSt |st#1@@2|) |p#1@@0|) (|Set#IsMember| (M0.__default.DomSt |st'#1@@0|) |p#1@@0|)) (= (M0.__default.GetSt |p#1@@0| |st#1@@2|) (M0.__default.GetSt |p#1@@0| |st'#1@@0|))))
 :qid |CloudMakeCachedBuildsdfy.55:14|
 :skolemid |751|
...
(set-info :boogie-vc-id Impl$$M0.__default.CompatiblePick)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@4 $Heap@0) (forall ((|$ih#sts0#0| T@U) (|$ih#useCache0#0| Bool) ) (!  (=> (and (and ($Is SetType |$ih#sts0#0| (TSet Tclass.M0.State)) (and (and (|Set#IsMember| |$ih#sts0#0| |st#0@@9|) (M0.__default.Compatible |$ih#sts0#0|)) (and (|Set#IsMember| (M0.__default.DomSt |st#0@@9|) |p#0@@4|) (|Set#IsMember| (M0.__default.DomSt (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |$ih#sts0#0| |$ih#useCache0#0|)) |p#0@@4|)))) (or (and (|Set#Subset| |$ih#sts0#0| |sts#0@@5|) (not (|Set#Subset| |sts#0@@5| |$ih#sts0#0|))) (and (|Set#Equal| |$ih#sts0#0| |sts#0@@5|) (and (not |$ih#useCache0#0|) |useCache#0@@4|)))) (= (M0.__default.GetSt |p#0@@4| (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |$ih#sts0#0| |$ih#useCache0#0|)) (M0.__default.GetSt |p#0@@4| |st#0@@9|)))
 :qid |CloudMakeCachedBuildsdfy.1295:44|
 :skolemid |1776|
 :pattern ( (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |$ih#sts0#0| |$ih#useCache0#0|))
)))) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1)) (and reveal_M0._default.Combine (= (ControlFlow 0 2) (- 0 1)))) (= (M0.__default.GetSt |p#0@@4| (M0.__default.Combine ($LS ($LS $LZ)) reveal_M0._default.Combine |sts#0@@5| |useCache#0@@4|)) (M0.__default.GetSt |p#0@@4| |st#0@@9|)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (=> (and (and (and (and ($IsBox |p#0@@4| Tclass.M0.Path) ($IsAllocBox |p#0@@4| Tclass.M0.Path $Heap@@4)) (and ($IsBox |st#0@@9| Tclass.M0.State) ($IsAllocBox |st#0@@9| Tclass.M0.State $Heap@@4))) (and (and ($Is SetType |sts#0@@5| (TSet Tclass.M0.State)) ($IsAlloc SetType |sts#0@@5| (TSet Tclass.M0.State) $Heap@@4)) (and (= 4 $FunctionContextHeight) (|Set#IsMember| |sts#0@@5| |st#0@@9|)))) (and (and (and (|M0.__default.Compatible#canCall| |sts#0@@5|) (and (M0.__default.Compatible |sts#0@@5|) (forall ((|st#2| T@U) (|st'#1@@1| T@U) ) (!  (=> (and ($IsBox |st#2| Tclass.M0.State) ($IsBox |st'#1@@1| Tclass.M0.State)) (=> (and (|Set#IsMember| |sts#0@@5| |st#2|) (|Set#IsMember| |sts#0@@5| |st'#1@@1|)) (forall ((|p#2| T@U) ) (!  (=> ($IsBox |p#2| Tclass.M0.Path) (=> (and (|Set#IsMember| (M0.__default.DomSt |st#2|) |p#2|) (|Set#IsMember| (M0.__default.DomSt |st'#1@@1|) |p#2|)) (= (M0.__default.GetSt |p#2| |st#2|) (M0.__default.GetSt |p#2| |st'#1@@1|))))
 :qid |CloudMakeCachedBuildsdfy.55:14|
 :skolemid |1774|
 :pattern ( (M0.__default.GetSt |p#2| |st'#1@@1|))
 :pattern ( (M0.__default.GetSt |p#2| |st#2|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#1@@1|) |p#2|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#2|) |p#2|))
))))
 :qid |CloudMakeCachedBuildsdfy.54:12|
 :skolemid |1775|
 :pattern ( (M0.__default.DomSt |st'#1@@1|) (M0.__default.DomSt |st#2|))
 :pattern ( (M0.__default.DomSt |st'#1@@1|) (|Set#IsMember| |sts#0@@5| |st#2|))
 :pattern ( (M0.__default.DomSt |st#2|) (|Set#IsMember| |sts#0@@5| |st'#1@@1|))
 :pattern ( (|Set#IsMember| |sts#0@@5| |st'#1@@1|) (|Set#IsMember| |sts#0@@5| |st#2|))
)))) (|Set#IsMember| (M0.__default.DomSt |st#0@@9|) |p#0@@4|)) (and (|Set#IsMember| (M0.__default.DomSt (M0.__default.Combine ($LS ($LS $LZ)) reveal_M0._default.Combine |sts#0@@5| |useCache#0@@4|)) |p#0@@4|) (= (ControlFlow 0 3) 2)))) anon0_correct))))
