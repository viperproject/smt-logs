...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|p#0@@1| T@U) (|st#0@@1| T@U) ) (!  (=> (and (or (|M0.__default.GetSt#canCall| |p#0@@1| |st#0@@1|) (and (< 1 $FunctionContextHeight) (and (and (and ($IsBox |p#0@@1| Tclass.M0.Path) ($IsAllocBox |p#0@@1| Tclass.M0.Path $Heap@@0)) (and ($IsBox |st#0@@1| Tclass.M0.State) ($IsAllocBox |st#0@@1| Tclass.M0.State $Heap@@0))) (|Set#IsMember| (M0.__default.DomSt |st#0@@1|) |p#0@@1|)))) ($IsGoodHeap $Heap@@0)) ($IsAllocBox (M0.__default.GetSt |p#0@@1| |st#0@@1|) Tclass.M0.Artifact $Heap@@0))
 :qid |CloudMakeParallelBuildsdfy.10:18|
 :skolemid |702|
 :pattern ( ($IsAllocBox (M0.__default.GetSt |p#0@@1| |st#0@@1|) Tclass.M0.Artifact $Heap@@0))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@0 T@U) ($Heap@@1 T@U) (|sts#0@@0| T@U) ) (!  (=> (or (|M0.__default.Combine#canCall| |sts#0@@0|) (and (< 3 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@1) ($Is SetType |sts#0@@0| (TSet Tclass.M0.State))) (not (|Set#Equal| |sts#0@@0| |Set#Empty|))))) (and (and (|$let#0$canCall| |sts#0@@0|) (=> (not (|Set#Equal| |sts#0@@0| (|Set#UnionOne| |Set#Empty| (|$let#0_st| |sts#0@@0|)))) (and (|M0.__default.Combine#canCall| (|Set#Difference| |sts#0@@0| (|Set#UnionOne| |Set#Empty| (|$let#0_st| |sts#0@@0|)))) (|M0.__default.Union#canCall| (|$let#0_st| |sts#0@@0|) (M0.__default.Combine $ly@@0 (|Set#Difference| |sts#0@@0| (|Set#UnionOne| |Set#Empty| (|$let#0_st| |sts#0@@0|)))))))) (= (M0.__default.Combine ($LS $ly@@0) |sts#0@@0|) (let ((|st#0@@2| (|$let#0_st| |sts#0@@0|)))
(ite (|Set#Equal| |sts#0@@0| (|Set#UnionOne| |Set#Empty| |st#0@@2|)) |st#0@@2| (M0.__default.Union |st#0@@2| (M0.__default.Combine $ly@@0 (|Set#Difference| |sts#0@@0| (|Set#UnionOne| |Set#Empty| |st#0@@2|)))))))))
 :qid |CloudMakeParallelBuildsdfy.36:18|
 :skolemid |747|
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@2 T@U) (|st#0@@4| T@U) (|st'#0@@0| T@U) ) (!  (=> (and (or (|M0.__default.Union#canCall| |st#0@@4| |st'#0@@0|) (and (< 2 $FunctionContextHeight) (and (and ($IsBox |st#0@@4| Tclass.M0.State) ($IsAllocBox |st#0@@4| Tclass.M0.State $Heap@@2)) (and ($IsBox |st'#0@@0| Tclass.M0.State) ($IsAllocBox |st'#0@@0| Tclass.M0.State $Heap@@2))))) ($IsGoodHeap $Heap@@2)) ($IsAllocBox (M0.__default.Union |st#0@@4| |st'#0@@0|) Tclass.M0.State $Heap@@2))
 :qid |CloudMakeParallelBuildsdfy.23:18|
 :skolemid |722|
 :pattern ( ($IsAllocBox (M0.__default.Union |st#0@@4| |st'#0@@0|) Tclass.M0.State $Heap@@2))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@2 T@U) ($Heap@@3 T@U) (|sts#0@@2| T@U) ) (!  (=> (or (|M0.__default.Combine#canCall| (Lit SetType |sts#0@@2|)) (and (< 3 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@3) ($Is SetType |sts#0@@2| (TSet Tclass.M0.State))) (not (|Set#Equal| |sts#0@@2| |Set#Empty|))))) (and (and (|$let#0$canCall| (Lit SetType |sts#0@@2|)) (=> (not (|Set#Equal| |sts#0@@2| (|Set#UnionOne| |Set#Empty| (|$let#0_st| (Lit SetType |sts#0@@2|))))) (and (|M0.__default.Combine#canCall| (|Set#Difference| |sts#0@@2| (|Set#UnionOne| |Set#Empty| (|$let#0_st| (Lit SetType |sts#0@@2|))))) (|M0.__default.Union#canCall| (|$let#0_st| (Lit SetType |sts#0@@2|)) (M0.__default.Combine ($LS $ly@@2) (|Set#Difference| |sts#0@@2| (|Set#UnionOne| |Set#Empty| (|$let#0_st| (Lit SetType |sts#0@@2|))))))))) (= (M0.__default.Combine ($LS $ly@@2) (Lit SetType |sts#0@@2|)) (let ((|st#1| (|$let#0_st| (Lit SetType |sts#0@@2|))))
(ite (|Set#Equal| |sts#0@@2| (|Set#UnionOne| |Set#Empty| |st#1|)) |st#1| (M0.__default.Union |st#1| (M0.__default.Combine ($LS $ly@@2) (|Set#Difference| |sts#0@@2| (|Set#UnionOne| |Set#Empty| |st#1|)))))))))
 ...
 :weight 3
 :skolemid |748|
 :pattern ( (M0.__default.Combine ($LS $ly@@2) (Lit SetType |sts#0@@2|)) ($IsGoodHeap $Heap@@3))
))))
...
(set-info :boogie-vc-id CheckWellformed$$M0.__default.Combine)
...
(let ((anon12_Else_correct  (=> (and (and (not (|Set#Equal| |sts#0@@4| (|Set#UnionOne| |Set#Empty| |st#2@0|))) ($IsAllocBox |st#2@0| Tclass.M0.State $Heap@@4)) (and (= |##sts#0@0| (|Set#Difference| |sts#0@@4| (|Set#UnionOne| |Set#Empty| |st#2@0|))) ($IsAlloc SetType |##sts#0@0| (TSet Tclass.M0.State) $Heap@@4))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (not (|Set#Equal| |##sts#0@0| |Set#Empty|))) (=> (not (|Set#Equal| |##sts#0@0| |Set#Empty|)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (and (|Set#Subset| |##sts#0@0| |sts#0@@4|) (not (|Set#Subset| |sts#0@@4| |##sts#0@0|)))) (=> (and (|Set#Subset| |##sts#0@0| |sts#0@@4|) (not (|Set#Subset| |sts#0@@4| |##sts#0@0|))) (=> (|M0.__default.Combine#canCall| (|Set#Difference| |sts#0@@4| (|Set#UnionOne| |Set#Empty| |st#2@0|))) (=> (and (and (= |##st'#0@0| (M0.__default.Combine ($LS $LZ) (|Set#Difference| |sts#0@@4| (|Set#UnionOne| |Set#Empty| |st#2@0|)))) ($IsAllocBox |##st'#0@0| Tclass.M0.State $Heap@@4)) (and (|M0.__default.Union#canCall| |st#2@0| (M0.__default.Combine ($LS $LZ) (|Set#Difference| |sts#0@@4| (|Set#UnionOne| |Set#Empty| |st#2@0|)))) (= (ControlFlow 0 4) 2))) anon8_correct)))))))))
(let ((anon12_Then_correct  (=> (and (|Set#Equal| |sts#0@@4| (|Set#UnionOne| |Set#Empty| |st#2@0|)) (= (ControlFlow 0 3) 2)) anon8_correct)))
(let ((anon5_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (exists ((|st#3| T@U) ) (!  (and ($IsBox |st#3| Tclass.M0.State) (|Set#IsMember| |sts#0@@4| |st#3|))
 :qid |CloudMakeParallelBuildsdfy.39:9|
 :skolemid |749|
))) (=> (exists ((|st#3@@0| T@U) ) (!  (and ($IsBox |st#3@@0| Tclass.M0.State) (|Set#IsMember| |sts#0@@4| |st#3@@0|))
 :qid |CloudMakeParallelBuildsdfy.39:9|
 :skolemid |749|
)) (=> (and (and ($IsBox |st#2@0| Tclass.M0.State) ($IsAllocBox |st#2@0| Tclass.M0.State $Heap@@4)) (|Set#IsMember| |sts#0@@4| |st#2@0|)) (and (=> (= (ControlFlow 0 7) 3) anon12_Then_correct) (=> (= (ControlFlow 0 7) 4) anon12_Else_correct)))))))
(let ((anon11_Else_correct  (=> (and (not (and ($IsBox |st#2@0| Tclass.M0.State) ($IsAllocBox |st#2@0| Tclass.M0.State $Heap@@4))) (= (ControlFlow 0 10) 7)) anon5_correct)))
(let ((anon11_Then_correct  (=> (and (and ($IsBox |st#2@0| Tclass.M0.State) ($IsAllocBox |st#2@0| Tclass.M0.State $Heap@@4)) (= (ControlFlow 0 9) 7)) anon5_correct)))
(let ((anon10_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (not (|Set#Equal| |sts#0@@4| |Set#Empty|))) (and (and (=> (= (ControlFlow 0 11) 1) anon10_Then_correct) (=> (= (ControlFlow 0 11) 9) anon11_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) ($Is SetType |sts#0@@4| (TSet Tclass.M0.State))) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 12) 11))) anon0_correct)))
