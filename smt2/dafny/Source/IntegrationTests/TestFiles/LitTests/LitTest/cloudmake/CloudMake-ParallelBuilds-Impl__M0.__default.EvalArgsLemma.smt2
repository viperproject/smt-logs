...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|st'#0@@0| T@U) ) (!  (=> (or (|M0.__default.Extends#canCall| (Lit BoxType |st#0@@6|) (Lit BoxType |st'#0@@0|)) (and (< 2 $FunctionContextHeight) (and ($IsBox |st#0@@6| Tclass.M0.State) ($IsBox |st'#0@@0| Tclass.M0.State)))) (and (and (and (|M0.__default.DomSt#canCall| (Lit BoxType |st#0@@6|)) (|M0.__default.DomSt#canCall| (Lit BoxType |st'#0@@0|))) (=> (|Set#Subset| (M0.__default.DomSt (Lit BoxType |st#0@@6|)) (M0.__default.DomSt (Lit BoxType |st'#0@@0|))) (and (forall ((|p#2| T@U) ) (!  (=> ($IsBox |p#2| Tclass.M0.Path) (and (|M0.__default.DomSt#canCall| (Lit BoxType |st#0@@6|)) (=> (|Set#IsMember| (M0.__default.DomSt (Lit BoxType |st#0@@6|)) |p#2|) (and (|M0.__default.GetSt#canCall| |p#2| (Lit BoxType |st'#0@@0|)) (|M0.__default.GetSt#canCall| |p#2| (Lit BoxType |st#0@@6|))))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |885|
 :pattern ( (M0.__default.GetSt |p#2| |st#0@@6|))
 :pattern ( (M0.__default.GetSt |p#2| |st'#0@@0|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@6|) |p#2|))
)) (=> (forall ((|p#2@@0| T@U) ) (!  (=> ($IsBox |p#2@@0| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt (Lit BoxType |st#0@@6|)) |p#2@@0|) (= (M0.__default.GetSt |p#2@@0| (Lit BoxType |st'#0@@0|)) (M0.__default.GetSt |p#2@@0| (Lit BoxType |st#0@@6|)))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |887|
 :pattern ( (M0.__default.GetSt |p#2@@0| |st#0@@6|))
 :pattern ( (M0.__default.GetSt |p#2@@0| |st'#0@@0|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@6|) |p#2@@0|))
)) (forall ((|p#3| T@U) ) (!  (=> ($IsBox |p#3| Tclass.M0.Path) (and (|M0.__default.DomSt#canCall| (Lit BoxType |st#0@@6|)) (=> (not (|Set#IsMember| (M0.__default.DomSt (Lit BoxType |st#0@@6|)) |p#3|)) (and (|M0.__default.DomSt#canCall| (Lit BoxType |st'#0@@0|)) (=> (|Set#IsMember| (M0.__default.DomSt (Lit BoxType |st'#0@@0|)) |p#3|) (and (|M0.__default.GetSt#canCall| |p#3| (Lit BoxType |st'#0@@0|)) (|M0.__default.Oracle#canCall| |p#3| (Lit BoxType |st#0@@6|))))))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |886|
 :pattern ( (M0.__default.Oracle |p#3| |st#0@@6|))
...
)))))) (= (M0.__default.Extends (Lit BoxType |st#0@@6|) (Lit BoxType |st'#0@@0|))  (and (and (|Set#Subset| (M0.__default.DomSt (Lit BoxType |st#0@@6|)) (M0.__default.DomSt (Lit BoxType |st'#0@@0|))) (forall ((|p#2@@1| T@U) ) (!  (=> ($IsBox |p#2@@1| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt (Lit BoxType |st#0@@6|)) |p#2@@1|) (= (M0.__default.GetSt |p#2@@1| (Lit BoxType |st'#0@@0|)) (M0.__default.GetSt |p#2@@1| (Lit BoxType |st#0@@6|)))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |883|
 :pattern ( (M0.__default.GetSt |p#2@@1| |st#0@@6|))
 :pattern ( (M0.__default.GetSt |p#2@@1| |st'#0@@0|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@6|) |p#2@@1|))
))) (forall ((|p#3@@0| T@U) ) (!  (=> ($IsBox |p#3@@0| Tclass.M0.Path) (=> (and (not (|Set#IsMember| (M0.__default.DomSt (Lit BoxType |st#0@@6|)) |p#3@@0|)) (|Set#IsMember| (M0.__default.DomSt (Lit BoxType |st'#0@@0|)) |p#3@@0|)) (= (M0.__default.GetSt |p#3@@0| (Lit BoxType |st'#0@@0|)) (M0.__default.Oracle |p#3@@0| (Lit BoxType |st#0@@6|)))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |884|
 :pattern ( (M0.__default.Oracle |p#3@@0| |st#0@@6|))
 ...
 :weight 3
 :skolemid |888|
 :pattern ( (M0.__default.Extends (Lit BoxType |st#0@@6|) (Lit BoxType |st'#0@@0|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0@@7| T@U) ) (!  (=> (or (|M0.__default.ValidState#canCall| |st#0@@7|) (and (< 1 $FunctionContextHeight) ($IsBox |st#0@@7| Tclass.M0.State))) (and (forall ((|p#0@@3| T@U) ) (!  (=> ($IsBox |p#0@@3| Tclass.M0.Path) (and (|M0.__default.DomSt#canCall| |st#0@@7|) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@7|) |p#0@@3|) (|M0.__default.WellFounded#canCall| |p#0@@3|))))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |708|
 :pattern ( (M0.__default.WellFounded |p#0@@3|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@7|) |p#0@@3|))
)) (= (M0.__default.ValidState |st#0@@7|) (forall ((|p#0@@4| T@U) ) (!  (=> ($IsBox |p#0@@4| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@7|) |p#0@@4|) (M0.__default.WellFounded |p#0@@4|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |707|
 ...
 :skolemid |709|
 :pattern ( (M0.__default.ValidState |st#0@@7|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@3 T@U) ($Heap@@3 T@U) (|sts#0@@0| T@U) ) (!  (=> (or (|M0.__default.Combine#canCall| |sts#0@@0|) (and (< 3 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@3) ($Is SetType |sts#0@@0| (TSet Tclass.M0.State))) (not (|Set#Equal| |sts#0@@0| |Set#Empty|))))) (and (and (|$let#0$canCall| |sts#0@@0|) (=> (not (|Set#Equal| |sts#0@@0| (|Set#UnionOne| |Set#Empty| (|$let#0_st| |sts#0@@0|)))) (and (|M0.__default.Combine#canCall| (|Set#Difference| |sts#0@@0| (|Set#UnionOne| |Set#Empty| (|$let#0_st| |sts#0@@0|)))) (|M0.__default.Union#canCall| (|$let#0_st| |sts#0@@0|) (M0.__default.Combine $ly@@3 (|Set#Difference| |sts#0@@0| (|Set#UnionOne| |Set#Empty| (|$let#0_st| |sts#0@@0|)))))))) (= (M0.__default.Combine ($LS $ly@@3) |sts#0@@0|) (let ((|st#0@@8| (|$let#0_st| |sts#0@@0|)))
(ite (|Set#Equal| |sts#0@@0| (|Set#UnionOne| |Set#Empty| |st#0@@8|)) |st#0@@8| (M0.__default.Union |st#0@@8| (M0.__default.Combine $ly@@3 (|Set#Difference| |sts#0@@0| (|Set#UnionOne| |Set#Empty| |st#0@@8|)))))))))
 :qid |CloudMakeParallelBuildsdfy.36:18|
 :skolemid |747|
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@4 T@U) (|expr#0| T@U) (|st#0@@9| T@U) (|env#0@@3| T@U) ) (!  (=> (or (|M0.__default.eval#canCall| (Lit DatatypeTypeType |expr#0|) (Lit BoxType |st#0@@9|) (Lit BoxType |env#0@@3|)) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0| Tclass.M0.Expression) ($IsBox |st#0@@9| Tclass.M0.State)) ($IsBox |env#0@@3| Tclass.M0.Env)) (M0.__default.ValidEnv (Lit BoxType |env#0@@3|))))) (and (and (|M0.__default.Value#canCall| (Lit DatatypeTypeType |expr#0|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.__default.Value (Lit DatatypeTypeType |expr#0|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0|))))) (|M0.__default.GetEnv#canCall| (Lit BoxType (M0.Expression.id (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |env#0@@3|))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIf_q (Lit DatatypeTypeType |expr#0|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@9|) (Lit BoxType |env#0@@3|)) (let ((|st'#8| (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@9|) (Lit BoxType |env#0@@3|))))))
(let ((|cond'#2| ($Unbox DatatypeTypeType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@9|) (Lit BoxType |env#0@@3|)))))))
 (and (and (=> (M0.Expression.exprLiteral_q |cond'#2|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#2|))) (=> (and (M0.Expression.exprLiteral_q |cond'#2|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#2|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.ifTrue (Lit DatatypeTypeType |expr#0|))) |st'#8| (Lit BoxType |env#0@@3|)))) (=> (not (and (M0.Expression.exprLiteral_q |cond'#2|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#2|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |cond'#2|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#2|))) (=> (and (M0.Expression.exprLiteral_q |cond'#2|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#2|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.ifFalse (Lit DatatypeTypeType |expr#0|))) |st'#8| (Lit BoxType |env#0@@3|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIf_q (Lit DatatypeTypeType |expr#0|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@9|) (Lit BoxType |env#0@@3|)) (let ((|st'#9| (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@9|) (Lit BoxType |env#0@@3|))))))
(let ((|conj0'#2| ($Unbox DatatypeTypeType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@9|) (Lit BoxType |env#0@@3|)))))))
 (and (and (=> (M0.Expression.exprLiteral_q |conj0'#2|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#2|))) (=> (and (M0.Expression.exprLiteral_q |conj0'#2|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#2|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.conj1 (Lit DatatypeTypeType |expr#0|))) |st'#9| (Lit BoxType |env#0@@3|)))) (=> (not (and (M0.Expression.exprLiteral_q |conj0'#2|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#2|) |#M0.Literal.litTrue|))) (=> (M0.Expression.exprLiteral_q |conj0'#2|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#2|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprOr_q (Lit DatatypeTypeType |expr#0|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@9|) (Lit BoxType |env#0@@3|)) (let ((|st'#10| (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@9|) (Lit BoxType |env#0@@3|))))))
(let ((|disj0'#2| ($Unbox DatatypeTypeType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@9|) (Lit BoxType |env#0@@3|)))))))
 (and (=> (M0.Expression.exprLiteral_q |disj0'#2|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#2|))) (=> (not (and (M0.Expression.exprLiteral_q |disj0'#2|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#2|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |disj0'#2|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#2|))) (=> (and (M0.Expression.exprLiteral_q |disj0'#2|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#2|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.disj1 (Lit DatatypeTypeType |expr#0|))) |st'#10| (Lit BoxType |env#0@@3|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprOr_q (Lit DatatypeTypeType |expr#0|)))))) (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@9|) (Lit BoxType |env#0@@3|)) (let ((|st'#11| (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@9|) (Lit BoxType |env#0@@3|))))))
(let ((|fun'#2| ($Unbox DatatypeTypeType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@9|) (Lit BoxType |env#0@@3|)))))))
 (and (|M0.__default.evalArgs#canCall| (Lit DatatypeTypeType |expr#0|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@9|) (Lit BoxType |env#0@@3|)) (let ((|sts'#2| ($Unbox SetType (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.evalArgs ($LS $ly@@4) (Lit DatatypeTypeType |expr#0|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@9|) (Lit BoxType |env#0@@3|)))))))
(let ((|args'#2| ($Unbox SeqType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.evalArgs ($LS $ly@@4) (Lit DatatypeTypeType |expr#0|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@9|) (Lit BoxType |env#0@@3|)))))))
(let ((|sts''#2| (|Set#Union| (|Set#UnionOne| |Set#Empty| |st'#11|) |sts'#2|)))
 ...
 (and (M0.Tuple.Pair_q |ps#2|) (M0.Tuple.Pair_q |ps#2|)))))))))))))))))))))))))))))) (= (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType |expr#0|) (Lit BoxType |st#0@@9|) (Lit BoxType |env#0@@3|)) (ite (M0.__default.Value (Lit DatatypeTypeType |expr#0|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType |expr#0|)) (Lit BoxType |st#0@@9|)) (ite (M0.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (M0.__default.GetEnv (Lit BoxType (M0.Expression.id (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |env#0@@3|))) (Lit BoxType |st#0@@9|)) (ite (M0.Expression.exprIf_q (Lit DatatypeTypeType |expr#0|)) (let ((|st'#8@@0| (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@9|) (Lit BoxType |env#0@@3|))))))
(let ((|cond'#2@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@9|) (Lit BoxType |env#0@@3|)))))))
...
(let ((|conj0'#2@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@9|) (Lit BoxType |env#0@@3|)))))))
...
(let ((|disj0'#2@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@9|) (Lit BoxType |env#0@@3|)))))))
...
(let ((|fun'#2@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@9|) (Lit BoxType |env#0@@3|)))))))
(let ((|sts'#2@@0| ($Unbox SetType (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.evalArgs ($LS $ly@@4) (Lit DatatypeTypeType |expr#0|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@9|) (Lit BoxType |env#0@@3|)))))))
(let ((|args'#2@@0| ($Unbox SeqType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.evalArgs ($LS $ly@@4) (Lit DatatypeTypeType |expr#0|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@9|) (Lit BoxType |env#0@@3|)))))))
...
(|#M0.Tuple.Pair| ($Box DatatypeTypeType (|#M0.Expression.exprLiteral| (|#M0.Literal.litArrOfPaths| ($Unbox SetType (M0.Tuple.fst |ps#2@@0|))))) (M0.Tuple.snd |ps#2@@0|))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) (Lit BoxType |st#0@@9|))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) (Lit BoxType |st#0@@9|))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) (Lit BoxType |st#0@@9|)))))))))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) (Lit BoxType |st#0@@9|)))))))))))
 ...
 :weight 3
 :skolemid |976|
 :pattern ( (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType |expr#0|) (Lit BoxType |st#0@@9|) (Lit BoxType |env#0@@3|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|cmd#0@@4| T@U) (|deps#0@@4| T@U) (|exps#0@@3| T@U) (|st#0@@12| T@U) ) (!  (=> (or (|M0.__default.Pre#canCall| (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) (Lit SetType |exps#0@@3|) |st#0@@12|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@4| (TSeq TChar)) ($Is SetType |deps#0@@4| (TSet Tclass.M0.Path))) ($Is SetType |exps#0@@3| (TSet (TSeq TChar)))) ($IsBox |st#0@@12| Tclass.M0.State)))) (and (forall ((|e#1| T@U) ) (!  (=> ($Is SeqType |e#1| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@3|) ($Box SeqType |e#1|)) (and (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1|) (|M0.__default.DomSt#canCall| |st#0@@12|)) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@12|) (M0.__default.Loc (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1|)) (and (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1|) (|M0.__default.GetSt#canCall| (M0.__default.Loc (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1|) |st#0@@12|)) (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1|) (|M0.__default.Oracle#canCall| (M0.__default.Loc (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1|) |st#0@@12|)))))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |822|
 :pattern ( (M0.__default.Loc |cmd#0@@4| |deps#0@@4| |e#1|))
 :pattern ( (|Set#IsMember| |exps#0@@3| ($Box SeqType |e#1|)))
)) (= (M0.__default.Pre (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) (Lit SetType |exps#0@@3|) |st#0@@12|) (forall ((|e#1@@0| T@U) ) (!  (=> ($Is SeqType |e#1@@0| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@3|) ($Box SeqType |e#1@@0|)) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@12|) (M0.__default.Loc (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1@@0|)) (= (M0.__default.GetSt (M0.__default.Loc (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1@@0|) |st#0@@12|) (M0.__default.Oracle (M0.__default.Loc (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1@@0|) |st#0@@12|)))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |821|
 ...
 :weight 3
 :skolemid |823|
 :pattern ( (M0.__default.Pre (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) (Lit SetType |exps#0@@3|) |st#0@@12|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@7 T@U) (|expr#0@@1| T@U) (|st#0@@13| T@U) (|env#0@@7| T@U) ) (!  (=> (or (|M0.__default.eval#canCall| |expr#0@@1| |st#0@@13| |env#0@@7|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0@@1| Tclass.M0.Expression) ($IsBox |st#0@@13| Tclass.M0.State)) ($IsBox |env#0@@7| Tclass.M0.Env)) (M0.__default.ValidEnv |env#0@@7|)))) ($Is DatatypeTypeType (M0.__default.eval $ly@@7 |expr#0@@1| |st#0@@13| |env#0@@7|) (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State)))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |971|
 :pattern ( (M0.__default.eval $ly@@7 |expr#0@@1| |st#0@@13| |env#0@@7|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|sts#0@@2| T@U) ) (!  (=> (or (|M0.__default.Compatible#canCall| |sts#0@@2|) (and (< 2 $FunctionContextHeight) ($Is SetType |sts#0@@2| (TSet Tclass.M0.State)))) (and (forall ((|st#0@@14| T@U) (|st'#0@@1| T@U) (|p#0@@5| T@U) ) (!  (=> (and (and ($IsBox |st#0@@14| Tclass.M0.State) ($IsBox |st'#0@@1| Tclass.M0.State)) ($IsBox |p#0@@5| Tclass.M0.Path)) (=> (|Set#IsMember| |sts#0@@2| |st#0@@14|) (=> (|Set#IsMember| |sts#0@@2| |st'#0@@1|) (and (|M0.__default.DomSt#canCall| |st#0@@14|) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@14|) |p#0@@5|) (and (|M0.__default.DomSt#canCall| |st'#0@@1|) (=> (|Set#IsMember| (M0.__default.DomSt |st'#0@@1|) |p#0@@5|) (and (|M0.__default.GetSt#canCall| |p#0@@5| |st#0@@14|) (|M0.__default.GetSt#canCall| |p#0@@5| |st'#0@@1|)))))))))
 :qid |CloudMakeParallelBuildsdfy.32:12|
 :skolemid |729|
 :pattern ( (M0.__default.GetSt |p#0@@5| |st'#0@@1|) (M0.__default.GetSt |p#0@@5| |st#0@@14|))
 :pattern ( (M0.__default.GetSt |p#0@@5| |st'#0@@1|) (M0.__default.DomSt |st#0@@14|))
 :pattern ( (M0.__default.GetSt |p#0@@5| |st'#0@@1|) (|Set#IsMember| |sts#0@@2| |st#0@@14|))
 :pattern ( (M0.__default.GetSt |p#0@@5| |st#0@@14|) (M0.__default.DomSt |st'#0@@1|))
 :pattern ( (M0.__default.GetSt |p#0@@5| |st#0@@14|) (|Set#IsMember| |sts#0@@2| |st'#0@@1|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@1|) |p#0@@5|) (M0.__default.DomSt |st#0@@14|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@1|) |p#0@@5|) (|Set#IsMember| |sts#0@@2| |st#0@@14|))
 :pattern ( (M0.__default.DomSt |st'#0@@1|) (|Set#IsMember| (M0.__default.DomSt |st#0@@14|) |p#0@@5|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@14|) |p#0@@5|) (|Set#IsMember| |sts#0@@2| |st'#0@@1|))
)) (= (M0.__default.Compatible |sts#0@@2|) (forall ((|st#0@@15| T@U) (|st'#0@@2| T@U) (|p#0@@6| T@U) ) (!  (=> (and (and ($IsBox |st#0@@15| Tclass.M0.State) ($IsBox |st'#0@@2| Tclass.M0.State)) ($IsBox |p#0@@6| Tclass.M0.Path)) (=> (and (and (and (|Set#IsMember| |sts#0@@2| |st#0@@15|) (|Set#IsMember| |sts#0@@2| |st'#0@@2|)) (|Set#IsMember| (M0.__default.DomSt |st#0@@15|) |p#0@@6|)) (|Set#IsMember| (M0.__default.DomSt |st'#0@@2|) |p#0@@6|)) (= (M0.__default.GetSt |p#0@@6| |st#0@@15|) (M0.__default.GetSt |p#0@@6| |st'#0@@2|))))
 :qid |CloudMakeParallelBuildsdfy.32:12|
 :skolemid |728|
 :pattern ( (M0.__default.GetSt |p#0@@6| |st'#0@@2|) (M0.__default.GetSt |p#0@@6| |st#0@@15|))
 :pattern ( (M0.__default.GetSt |p#0@@6| |st'#0@@2|) (M0.__default.DomSt |st#0@@15|))
 :pattern ( (M0.__default.GetSt |p#0@@6| |st'#0@@2|) (|Set#IsMember| |sts#0@@2| |st#0@@15|))
 :pattern ( (M0.__default.GetSt |p#0@@6| |st#0@@15|) (M0.__default.DomSt |st'#0@@2|))
 :pattern ( (M0.__default.GetSt |p#0@@6| |st#0@@15|) (|Set#IsMember| |sts#0@@2| |st'#0@@2|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@2|) |p#0@@6|) (M0.__default.DomSt |st#0@@15|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@2|) |p#0@@6|) (|Set#IsMember| |sts#0@@2| |st#0@@15|))
 :pattern ( (M0.__default.DomSt |st'#0@@2|) (|Set#IsMember| (M0.__default.DomSt |st#0@@15|) |p#0@@6|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@15|) |p#0@@6|) (|Set#IsMember| |sts#0@@2| |st'#0@@2|))
)))))
 :qid |CloudMakeParallelBuildsdfy.30:30|
 :skolemid |730|
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@8 T@U) (|expr#0@@2| T@U) (|st#0@@16| T@U) (|env#0@@8| T@U) ) (!  (=> (or (|M0.__default.eval#canCall| |expr#0@@2| |st#0@@16| |env#0@@8|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0@@2| Tclass.M0.Expression) ($IsBox |st#0@@16| Tclass.M0.State)) ($IsBox |env#0@@8| Tclass.M0.Env)) (M0.__default.ValidEnv |env#0@@8|)))) (and (and (|M0.__default.Value#canCall| |expr#0@@2|) (=> (not (M0.__default.Value |expr#0@@2|)) (and (=> (M0.Expression.exprIdentifier_q |expr#0@@2|) (|M0.__default.GetEnv#canCall| (M0.Expression.id |expr#0@@2|) |env#0@@8|)) (=> (not (M0.Expression.exprIdentifier_q |expr#0@@2|)) (and (=> (M0.Expression.exprIf_q |expr#0@@2|) (and (|M0.__default.eval#canCall| (M0.Expression.cond |expr#0@@2|) |st#0@@16| |env#0@@8|) (let ((|st'#0@@3| (M0.Tuple.snd (M0.__default.eval $ly@@8 (M0.Expression.cond |expr#0@@2|) |st#0@@16| |env#0@@8|))))
(let ((|cond'#0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@8 (M0.Expression.cond |expr#0@@2|) |st#0@@16| |env#0@@8|)))))
 (and (and (=> (M0.Expression.exprLiteral_q |cond'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#0|))) (=> (and (M0.Expression.exprLiteral_q |cond'#0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#0|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (M0.Expression.ifTrue |expr#0@@2|) |st'#0@@3| |env#0@@8|))) (=> (not (and (M0.Expression.exprLiteral_q |cond'#0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#0|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |cond'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#0|))) (=> (and (M0.Expression.exprLiteral_q |cond'#0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#0|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (M0.Expression.ifFalse |expr#0@@2|) |st'#0@@3| |env#0@@8|))))))))) (=> (not (M0.Expression.exprIf_q |expr#0@@2|)) (and (=> (M0.Expression.exprAnd_q |expr#0@@2|) (and (|M0.__default.eval#canCall| (M0.Expression.conj0 |expr#0@@2|) |st#0@@16| |env#0@@8|) (let ((|st'#1@@1| (M0.Tuple.snd (M0.__default.eval $ly@@8 (M0.Expression.conj0 |expr#0@@2|) |st#0@@16| |env#0@@8|))))
(let ((|conj0'#0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@8 (M0.Expression.conj0 |expr#0@@2|) |st#0@@16| |env#0@@8|)))))
 (and (and (=> (M0.Expression.exprLiteral_q |conj0'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#0|))) (=> (and (M0.Expression.exprLiteral_q |conj0'#0|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#0|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (M0.Expression.conj1 |expr#0@@2|) |st'#1@@1| |env#0@@8|))) (=> (not (and (M0.Expression.exprLiteral_q |conj0'#0|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#0|) |#M0.Literal.litTrue|))) (=> (M0.Expression.exprLiteral_q |conj0'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#0|))))))))) (=> (not (M0.Expression.exprAnd_q |expr#0@@2|)) (and (=> (M0.Expression.exprOr_q |expr#0@@2|) (and (|M0.__default.eval#canCall| (M0.Expression.disj0 |expr#0@@2|) |st#0@@16| |env#0@@8|) (let ((|st'#2| (M0.Tuple.snd (M0.__default.eval $ly@@8 (M0.Expression.disj0 |expr#0@@2|) |st#0@@16| |env#0@@8|))))
(let ((|disj0'#0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@8 (M0.Expression.disj0 |expr#0@@2|) |st#0@@16| |env#0@@8|)))))
 (and (=> (M0.Expression.exprLiteral_q |disj0'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#0|))) (=> (not (and (M0.Expression.exprLiteral_q |disj0'#0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#0|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |disj0'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#0|))) (=> (and (M0.Expression.exprLiteral_q |disj0'#0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#0|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (M0.Expression.disj1 |expr#0@@2|) |st'#2| |env#0@@8|))))))))) (=> (not (M0.Expression.exprOr_q |expr#0@@2|)) (=> (M0.Expression.exprInvocation_q |expr#0@@2|) (and (|M0.__default.eval#canCall| (M0.Expression.fun |expr#0@@2|) |st#0@@16| |env#0@@8|) (let ((|st'#3| (M0.Tuple.snd (M0.__default.eval $ly@@8 (M0.Expression.fun |expr#0@@2|) |st#0@@16| |env#0@@8|))))
(let ((|fun'#0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@8 (M0.Expression.fun |expr#0@@2|) |st#0@@16| |env#0@@8|)))))
 (and (|M0.__default.evalArgs#canCall| |expr#0@@2| (M0.Expression.args |expr#0@@2|) |st#0@@16| |env#0@@8|) (let ((|sts'#0| ($Unbox SetType (M0.Tuple.snd (M0.__default.evalArgs $ly@@8 |expr#0@@2| (M0.Expression.args |expr#0@@2|) |st#0@@16| |env#0@@8|)))))
(let ((|args'#0| ($Unbox SeqType (M0.Tuple.fst (M0.__default.evalArgs $ly@@8 |expr#0@@2| (M0.Expression.args |expr#0@@2|) |st#0@@16| |env#0@@8|)))))
(let ((|sts''#0| (|Set#Union| (|Set#UnionOne| |Set#Empty| |st'#3|) |sts'#0|)))
 ...
 (and (M0.Tuple.Pair_q |ps#0|) (M0.Tuple.Pair_q |ps#0|)))))))))))))))))))))))))))))) (= (M0.__default.eval ($LS $ly@@8) |expr#0@@2| |st#0@@16| |env#0@@8|) (ite (M0.__default.Value |expr#0@@2|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType |expr#0@@2|) |st#0@@16|) (ite (M0.Expression.exprIdentifier_q |expr#0@@2|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (M0.__default.GetEnv (M0.Expression.id |expr#0@@2|) |env#0@@8|)) |st#0@@16|) (ite (M0.Expression.exprIf_q |expr#0@@2|) (let ((|st'#0@@4| (M0.Tuple.snd (M0.__default.eval $ly@@8 (M0.Expression.cond |expr#0@@2|) |st#0@@16| |env#0@@8|))))
(let ((|cond'#0@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@8 (M0.Expression.cond |expr#0@@2|) |st#0@@16| |env#0@@8|)))))
(ite  (and (M0.Expression.exprLiteral_q |cond'#0@@0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#0@@0|) |#M0.Literal.litTrue|)) (M0.__default.eval $ly@@8 (M0.Expression.ifTrue |expr#0@@2|) |st'#0@@4| |env#0@@8|) (ite  (and (M0.Expression.exprLiteral_q |cond'#0@@0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#0@@0|) |#M0.Literal.litFalse|)) (M0.__default.eval $ly@@8 (M0.Expression.ifFalse |expr#0@@2|) |st'#0@@4| |env#0@@8|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@16|))))) (ite (M0.Expression.exprAnd_q |expr#0@@2|) (let ((|st'#1@@2| (M0.Tuple.snd (M0.__default.eval $ly@@8 (M0.Expression.conj0 |expr#0@@2|) |st#0@@16| |env#0@@8|))))
(let ((|conj0'#0@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@8 (M0.Expression.conj0 |expr#0@@2|) |st#0@@16| |env#0@@8|)))))
(ite  (and (M0.Expression.exprLiteral_q |conj0'#0@@0|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#0@@0|) |#M0.Literal.litTrue|)) (M0.__default.eval $ly@@8 (M0.Expression.conj1 |expr#0@@2|) |st'#1@@2| |env#0@@8|) (ite  (and (M0.Expression.exprLiteral_q |conj0'#0@@0|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#0@@0|) |#M0.Literal.litFalse|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprLiteral| (Lit DatatypeTypeType |#M0.Literal.litFalse|)))) |st'#1@@2|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@16|))))) (ite (M0.Expression.exprOr_q |expr#0@@2|) (let ((|st'#2@@0| (M0.Tuple.snd (M0.__default.eval $ly@@8 (M0.Expression.disj0 |expr#0@@2|) |st#0@@16| |env#0@@8|))))
(let ((|disj0'#0@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@8 (M0.Expression.disj0 |expr#0@@2|) |st#0@@16| |env#0@@8|)))))
(ite  (and (M0.Expression.exprLiteral_q |disj0'#0@@0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#0@@0|) |#M0.Literal.litTrue|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprLiteral| (Lit DatatypeTypeType |#M0.Literal.litTrue|)))) |st'#2@@0|) (ite  (and (M0.Expression.exprLiteral_q |disj0'#0@@0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#0@@0|) |#M0.Literal.litFalse|)) (M0.__default.eval $ly@@8 (M0.Expression.disj1 |expr#0@@2|) |st'#2@@0| |env#0@@8|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@16|))))) (ite (M0.Expression.exprInvocation_q |expr#0@@2|) (let ((|st'#3@@0| (M0.Tuple.snd (M0.__default.eval $ly@@8 (M0.Expression.fun |expr#0@@2|) |st#0@@16| |env#0@@8|))))
(let ((|fun'#0@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@8 (M0.Expression.fun |expr#0@@2|) |st#0@@16| |env#0@@8|)))))
(let ((|sts'#0@@0| ($Unbox SetType (M0.Tuple.snd (M0.__default.evalArgs $ly@@8 |expr#0@@2| (M0.Expression.args |expr#0@@2|) |st#0@@16| |env#0@@8|)))))
(let ((|args'#0@@0| ($Unbox SeqType (M0.Tuple.fst (M0.__default.evalArgs $ly@@8 |expr#0@@2| (M0.Expression.args |expr#0@@2|) |st#0@@16| |env#0@@8|)))))
(let ((|sts''#0@@0| (|Set#Union| (|Set#UnionOne| |Set#Empty| |st'#3@@0|) |sts'#0@@0|)))
(ite  (not (M0.__default.Compatible |sts''#0@@0|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rCompatibility|)))) |st#0@@16|) (let ((|stCombined#0@@0| (M0.__default.Combine ($LS $LZ) |sts''#0@@0|)))
...
(|#M0.Tuple.Pair| ($Box DatatypeTypeType (|#M0.Expression.exprLiteral| (|#M0.Literal.litArrOfPaths| ($Unbox SetType (M0.Tuple.fst |ps#0@@0|))))) (M0.Tuple.snd |ps#0@@0|))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@16|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@16|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@16|))))))))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@16|))))))))))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |974|
 :pattern ( (M0.__default.eval ($LS $ly@@8) |expr#0@@2| |st#0@@16| |env#0@@8|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|cmd#0@@5| T@U) (|deps#0@@5| T@U) (|exps#0@@4| T@U) (|st#0@@18| T@U) ) (!  (=> (or (|M0.__default.Pre#canCall| |cmd#0@@5| |deps#0@@5| |exps#0@@4| |st#0@@18|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@5| (TSeq TChar)) ($Is SetType |deps#0@@5| (TSet Tclass.M0.Path))) ($Is SetType |exps#0@@4| (TSet (TSeq TChar)))) ($IsBox |st#0@@18| Tclass.M0.State)))) (and (forall ((|e#0| T@U) ) (!  (=> ($Is SeqType |e#0| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@4| ($Box SeqType |e#0|)) (and (and (|M0.__default.Loc#canCall| |cmd#0@@5| |deps#0@@5| |e#0|) (|M0.__default.DomSt#canCall| |st#0@@18|)) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@18|) (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0|)) (and (and (|M0.__default.Loc#canCall| |cmd#0@@5| |deps#0@@5| |e#0|) (|M0.__default.GetSt#canCall| (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0|) |st#0@@18|)) (and (|M0.__default.Loc#canCall| |cmd#0@@5| |deps#0@@5| |e#0|) (|M0.__default.Oracle#canCall| (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0|) |st#0@@18|)))))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |819|
 :pattern ( (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0|))
 :pattern ( (|Set#IsMember| |exps#0@@4| ($Box SeqType |e#0|)))
)) (= (M0.__default.Pre |cmd#0@@5| |deps#0@@5| |exps#0@@4| |st#0@@18|) (forall ((|e#0@@0| T@U) ) (!  (=> ($Is SeqType |e#0@@0| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@4| ($Box SeqType |e#0@@0|)) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@18|) (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0@@0|)) (= (M0.__default.GetSt (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0@@0|) |st#0@@18|) (M0.__default.Oracle (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0@@0|) |st#0@@18|)))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |818|
 ...
 :qid |CloudMakeParallelBuildsdfy.83:23|
 :skolemid |820|
 :pattern ( (M0.__default.Pre |cmd#0@@5| |deps#0@@5| |exps#0@@4| |st#0@@18|))
))))
(assert (forall (($ly@@10 T@U) (|expr#0@@3| T@U) (|st#0@@19| T@U) (|env#0@@9| T@U) ) (! (= (M0.__default.eval ($LS $ly@@10) |expr#0@@3| |st#0@@19| |env#0@@9|) (M0.__default.eval $ly@@10 |expr#0@@3| |st#0@@19| |env#0@@9|))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |969|
 :pattern ( (M0.__default.eval ($LS $ly@@10) |expr#0@@3| |st#0@@19| |env#0@@9|))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@5 T@U) ($ly@@11 T@U) (|expr#0@@4| T@U) (|st#0@@20| T@U) (|env#0@@10| T@U) ) (!  (=> (and (or (|M0.__default.eval#canCall| |expr#0@@4| |st#0@@20| |env#0@@10|) (and (< 4 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |expr#0@@4| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |expr#0@@4| Tclass.M0.Expression $Heap@@5)) (and ($IsBox |st#0@@20| Tclass.M0.State) ($IsAllocBox |st#0@@20| Tclass.M0.State $Heap@@5))) (and ($IsBox |env#0@@10| Tclass.M0.Env) ($IsAllocBox |env#0@@10| Tclass.M0.Env $Heap@@5))) (M0.__default.ValidEnv |env#0@@10|)))) ($IsGoodHeap $Heap@@5)) ($IsAlloc DatatypeTypeType (M0.__default.eval $ly@@11 |expr#0@@4| |st#0@@20| |env#0@@10|) (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State) $Heap@@5))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |972|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.__default.eval $ly@@11 |expr#0@@4| |st#0@@20| |env#0@@10|) (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State) $Heap@@5))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|prim#0@@4| T@U) (|args#0@@6| T@U) (|st#0@@21| T@U) ) (!  (=> (or (|M0.__default.ValidArgs#canCall| (Lit DatatypeTypeType |prim#0@@4|) (Lit SeqType |args#0@@6|) |st#0@@21|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |prim#0@@4| Tclass.M0.Primitive) ($Is SeqType |args#0@@6| (TSeq Tclass.M0.Expression))) ($IsBox |st#0@@21| Tclass.M0.State)) (and (=> (M0.Primitive.primExec_q (Lit DatatypeTypeType |prim#0@@4|)) (= (|Seq#Length| (Lit SeqType |args#0@@6|)) (LitInt 3))) (=> (M0.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@4|)) (= (|Seq#Length| (Lit SeqType |args#0@@6|)) (LitInt 1))))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@4|)))))) (let ((|exps#3| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@6|) (LitInt 2)))))
...
(let ((|cmd#3| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@6|) (LitInt 0)))))
 (=> (M0.Expression.exprLiteral_q |cmd#3|) (=> (M0.Literal.litString_q (M0.Expression.lit |cmd#3|)) (=> (M0.Expression.exprLiteral_q |deps#3|) (=> (M0.Literal.litArrOfPaths_q (M0.Expression.lit |deps#3|)) (=> (M0.Expression.exprLiteral_q |exps#3|) (=> (M0.Literal.litArrOfStrings_q (M0.Expression.lit |exps#3|)) (and (|M0.__default.DomSt#canCall| |st#0@@21|) (=> (|Set#Subset| (M0.Literal.paths (M0.Expression.lit |deps#3|)) (M0.__default.DomSt |st#0@@21|)) (|M0.__default.Pre#canCall| (M0.Literal.str (M0.Expression.lit |cmd#3|)) (M0.Literal.paths (M0.Expression.lit |deps#3|)) (M0.Literal.strs (M0.Expression.lit |exps#3|)) |st#0@@21|))))))))))))) (= (M0.__default.ValidArgs (Lit DatatypeTypeType |prim#0@@4|) (Lit SeqType |args#0@@6|) |st#0@@21|) (ite (M0.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@4|)) false (let ((|exps#2| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@6|) (LitInt 2)))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@6 T@U) (|p#0@@7| T@U) (|st#0@@22| T@U) ) (!  (=> (and (or (|M0.__default.Oracle#canCall| |p#0@@7| |st#0@@22|) (and (< 0 $FunctionContextHeight) (and (and ($IsBox |p#0@@7| Tclass.M0.Path) ($IsAllocBox |p#0@@7| Tclass.M0.Path $Heap@@6)) (and ($IsBox |st#0@@22| Tclass.M0.State) ($IsAllocBox |st#0@@22| Tclass.M0.State $Heap@@6))))) ($IsGoodHeap $Heap@@6)) ($IsAllocBox (M0.__default.Oracle |p#0@@7| |st#0@@22|) Tclass.M0.Artifact $Heap@@6))
 :qid |CloudMakeParallelBuildsdfy.104:18|
 :skolemid |869|
 :pattern ( ($IsAllocBox (M0.__default.Oracle |p#0@@7| |st#0@@22|) Tclass.M0.Artifact $Heap@@6))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@7 T@U) (|st#0@@23| T@U) (|st'#0@@5| T@U) ) (!  (=> (and (or (|M0.__default.Union#canCall| |st#0@@23| |st'#0@@5|) (and (< 2 $FunctionContextHeight) (and (and ($IsBox |st#0@@23| Tclass.M0.State) ($IsAllocBox |st#0@@23| Tclass.M0.State $Heap@@7)) (and ($IsBox |st'#0@@5| Tclass.M0.State) ($IsAllocBox |st'#0@@5| Tclass.M0.State $Heap@@7))))) ($IsGoodHeap $Heap@@7)) ($IsAllocBox (M0.__default.Union |st#0@@23| |st'#0@@5|) Tclass.M0.State $Heap@@7))
 :qid |CloudMakeParallelBuildsdfy.23:18|
 :skolemid |722|
 :pattern ( ($IsAllocBox (M0.__default.Union |st#0@@23| |st'#0@@5|) Tclass.M0.State $Heap@@7))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@24| T@U) (|st'#0@@6| T@U) ) (!  (=> (or (|M0.__default.Extends#canCall| |st#0@@24| |st'#0@@6|) (and (< 2 $FunctionContextHeight) (and ($IsBox |st#0@@24| Tclass.M0.State) ($IsBox |st'#0@@6| Tclass.M0.State)))) (and (and (and (|M0.__default.DomSt#canCall| |st#0@@24|) (|M0.__default.DomSt#canCall| |st'#0@@6|)) (=> (|Set#Subset| (M0.__default.DomSt |st#0@@24|) (M0.__default.DomSt |st'#0@@6|)) (and (forall ((|p#0@@8| T@U) ) (!  (=> ($IsBox |p#0@@8| Tclass.M0.Path) (and (|M0.__default.DomSt#canCall| |st#0@@24|) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@24|) |p#0@@8|) (and (|M0.__default.GetSt#canCall| |p#0@@8| |st'#0@@6|) (|M0.__default.GetSt#canCall| |p#0@@8| |st#0@@24|)))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |879|
 :pattern ( (M0.__default.GetSt |p#0@@8| |st#0@@24|))
 :pattern ( (M0.__default.GetSt |p#0@@8| |st'#0@@6|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@24|) |p#0@@8|))
)) (=> (forall ((|p#0@@9| T@U) ) (!  (=> ($IsBox |p#0@@9| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@24|) |p#0@@9|) (= (M0.__default.GetSt |p#0@@9| |st'#0@@6|) (M0.__default.GetSt |p#0@@9| |st#0@@24|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |881|
 :pattern ( (M0.__default.GetSt |p#0@@9| |st#0@@24|))
 :pattern ( (M0.__default.GetSt |p#0@@9| |st'#0@@6|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@24|) |p#0@@9|))
)) (forall ((|p#1@@1| T@U) ) (!  (=> ($IsBox |p#1@@1| Tclass.M0.Path) (and (|M0.__default.DomSt#canCall| |st#0@@24|) (=> (not (|Set#IsMember| (M0.__default.DomSt |st#0@@24|) |p#1@@1|)) (and (|M0.__default.DomSt#canCall| |st'#0@@6|) (=> (|Set#IsMember| (M0.__default.DomSt |st'#0@@6|) |p#1@@1|) (and (|M0.__default.GetSt#canCall| |p#1@@1| |st'#0@@6|) (|M0.__default.Oracle#canCall| |p#1@@1| |st#0@@24|)))))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |880|
 :pattern ( (M0.__default.Oracle |p#1@@1| |st#0@@24|))
 :pattern ( (M0.__default.GetSt |p#1@@1| |st'#0@@6|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@6|) |p#1@@1|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@24|) |p#1@@1|))
)))))) (= (M0.__default.Extends |st#0@@24| |st'#0@@6|)  (and (and (|Set#Subset| (M0.__default.DomSt |st#0@@24|) (M0.__default.DomSt |st'#0@@6|)) (forall ((|p#0@@10| T@U) ) (!  (=> ($IsBox |p#0@@10| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@24|) |p#0@@10|) (= (M0.__default.GetSt |p#0@@10| |st'#0@@6|) (M0.__default.GetSt |p#0@@10| |st#0@@24|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |877|
 :pattern ( (M0.__default.GetSt |p#0@@10| |st#0@@24|))
 :pattern ( (M0.__default.GetSt |p#0@@10| |st'#0@@6|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@24|) |p#0@@10|))
))) (forall ((|p#1@@2| T@U) ) (!  (=> ($IsBox |p#1@@2| Tclass.M0.Path) (=> (and (not (|Set#IsMember| (M0.__default.DomSt |st#0@@24|) |p#1@@2|)) (|Set#IsMember| (M0.__default.DomSt |st'#0@@6|) |p#1@@2|)) (= (M0.__default.GetSt |p#1@@2| |st'#0@@6|) (M0.__default.Oracle |p#1@@2| |st#0@@24|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |878|
 :pattern ( (M0.__default.Oracle |p#1@@2| |st#0@@24|))
 :pattern ( (M0.__default.GetSt |p#1@@2| |st'#0@@6|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@6|) |p#1@@2|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@24|) |p#1@@2|))
))))))
 :qid |CloudMakeParallelBuildsdfy.112:27|
 :skolemid |882|
 :pattern ( (M0.__default.Extends |st#0@@24| |st'#0@@6|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@14 T@U) (|expr#0@@6| T@U) (|st#0@@26| T@U) (|env#0@@12| T@U) ) (!  (=> (or (|M0.__default.eval#canCall| (Lit DatatypeTypeType |expr#0@@6|) |st#0@@26| |env#0@@12|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0@@6| Tclass.M0.Expression) ($IsBox |st#0@@26| Tclass.M0.State)) ($IsBox |env#0@@12| Tclass.M0.Env)) (M0.__default.ValidEnv |env#0@@12|)))) (and (and (|M0.__default.Value#canCall| (Lit DatatypeTypeType |expr#0@@6|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.__default.Value (Lit DatatypeTypeType |expr#0@@6|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@6|))))) (|M0.__default.GetEnv#canCall| (Lit BoxType (M0.Expression.id (Lit DatatypeTypeType |expr#0@@6|))) |env#0@@12|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@6|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@6|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@26| |env#0@@12|) (let ((|st'#4| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@26| |env#0@@12|))))
(let ((|cond'#1| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@26| |env#0@@12|)))))
 (and (and (=> (M0.Expression.exprLiteral_q |cond'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#1|))) (=> (and (M0.Expression.exprLiteral_q |cond'#1|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#1|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.ifTrue (Lit DatatypeTypeType |expr#0@@6|))) |st'#4| |env#0@@12|))) (=> (not (and (M0.Expression.exprLiteral_q |cond'#1|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#1|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |cond'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#1|))) (=> (and (M0.Expression.exprLiteral_q |cond'#1|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#1|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.ifFalse (Lit DatatypeTypeType |expr#0@@6|))) |st'#4| |env#0@@12|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@6|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@6|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@26| |env#0@@12|) (let ((|st'#5| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@26| |env#0@@12|))))
(let ((|conj0'#1| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@26| |env#0@@12|)))))
 (and (and (=> (M0.Expression.exprLiteral_q |conj0'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#1|))) (=> (and (M0.Expression.exprLiteral_q |conj0'#1|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#1|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.conj1 (Lit DatatypeTypeType |expr#0@@6|))) |st'#5| |env#0@@12|))) (=> (not (and (M0.Expression.exprLiteral_q |conj0'#1|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#1|) |#M0.Literal.litTrue|))) (=> (M0.Expression.exprLiteral_q |conj0'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#1|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@6|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@6|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@26| |env#0@@12|) (let ((|st'#6| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@26| |env#0@@12|))))
(let ((|disj0'#1| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@26| |env#0@@12|)))))
 (and (=> (M0.Expression.exprLiteral_q |disj0'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#1|))) (=> (not (and (M0.Expression.exprLiteral_q |disj0'#1|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#1|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |disj0'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#1|))) (=> (and (M0.Expression.exprLiteral_q |disj0'#1|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#1|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.disj1 (Lit DatatypeTypeType |expr#0@@6|))) |st'#6| |env#0@@12|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@6|)))))) (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0@@6|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@26| |env#0@@12|) (let ((|st'#7| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@26| |env#0@@12|))))
(let ((|fun'#1| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@26| |env#0@@12|)))))
 (and (|M0.__default.evalArgs#canCall| (Lit DatatypeTypeType |expr#0@@6|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@26| |env#0@@12|) (let ((|sts'#1| ($Unbox SetType (M0.Tuple.snd (M0.__default.evalArgs ($LS $ly@@14) (Lit DatatypeTypeType |expr#0@@6|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@26| |env#0@@12|)))))
(let ((|args'#1| ($Unbox SeqType (M0.Tuple.fst (M0.__default.evalArgs ($LS $ly@@14) (Lit DatatypeTypeType |expr#0@@6|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@26| |env#0@@12|)))))
(let ((|sts''#1| (|Set#Union| (|Set#UnionOne| |Set#Empty| |st'#7|) |sts'#1|)))
 ...
 (and (M0.Tuple.Pair_q |ps#1|) (M0.Tuple.Pair_q |ps#1|)))))))))))))))))))))))))))))) (= (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType |expr#0@@6|) |st#0@@26| |env#0@@12|) (ite (M0.__default.Value (Lit DatatypeTypeType |expr#0@@6|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType |expr#0@@6|)) |st#0@@26|) (ite (M0.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@6|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (M0.__default.GetEnv (Lit BoxType (M0.Expression.id (Lit DatatypeTypeType |expr#0@@6|))) |env#0@@12|)) |st#0@@26|) (ite (M0.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@6|)) (let ((|st'#4@@0| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@26| |env#0@@12|))))
(let ((|cond'#1@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@26| |env#0@@12|)))))
...
(let ((|conj0'#1@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@26| |env#0@@12|)))))
...
(let ((|disj0'#1@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@26| |env#0@@12|)))))
(ite  (and (M0.Expression.exprLiteral_q |disj0'#1@@0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#1@@0|) |#M0.Literal.litTrue|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprLiteral| (Lit DatatypeTypeType |#M0.Literal.litTrue|)))) |st'#6@@0|) (ite  (and (M0.Expression.exprLiteral_q |disj0'#1@@0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#1@@0|) |#M0.Literal.litFalse|)) (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.disj1 (Lit DatatypeTypeType |expr#0@@6|))) |st'#6@@0| |env#0@@12|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@26|))))) (ite (M0.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0@@6|)) (let ((|st'#7@@0| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@26| |env#0@@12|))))
(let ((|fun'#1@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@26| |env#0@@12|)))))
(let ((|sts'#1@@0| ($Unbox SetType (M0.Tuple.snd (M0.__default.evalArgs ($LS $ly@@14) (Lit DatatypeTypeType |expr#0@@6|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@26| |env#0@@12|)))))
(let ((|args'#1@@0| ($Unbox SeqType (M0.Tuple.fst (M0.__default.evalArgs ($LS $ly@@14) (Lit DatatypeTypeType |expr#0@@6|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@26| |env#0@@12|)))))
(let ((|sts''#1@@0| (|Set#Union| (|Set#UnionOne| |Set#Empty| |st'#7@@0|) |sts'#1@@0|)))
(ite  (not (M0.__default.Compatible |sts''#1@@0|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rCompatibility|)))) |st#0@@26|) (let ((|stCombined#1@@0| (M0.__default.Combine ($LS $LZ) |sts''#1@@0|)))
...
(|#M0.Tuple.Pair| ($Box DatatypeTypeType (|#M0.Expression.exprLiteral| (|#M0.Literal.litArrOfPaths| ($Unbox SetType (M0.Tuple.fst |ps#1@@0|))))) (M0.Tuple.snd |ps#1@@0|))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@26|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@26|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@26|))))))))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@26|))))))))))
 ...
 :weight 3
 :skolemid |975|
 :pattern ( (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType |expr#0@@6|) |st#0@@26| |env#0@@12|))
))))
...
(declare-fun |args'#0@@1| () T@U)
(declare-fun |sts'#0@@1| () T@U)
(declare-fun |rArg#1_0| () T@U)
(declare-fun |defass#rSts#1_0| () Bool)
(declare-fun |rSts#1_0| () T@U)
(declare-fun |rrArg#1_0| () T@U)
(declare-fun |rrSts#1_0| () T@U)
(set-info :boogie-vc-id Impl$$M0.__default.EvalArgsLemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (|M0.Tuple#Equal| (|#M0.Tuple.Pair| ($Box SeqType |args'#0@0|) ($Box SetType |sts'#0@0|)) (M0.__default.evalArgs ($LS ($LS $LZ)) |context#0@@5| |args#0@@8| |stOrig#0@@5| |env#0@@13|))) (=> (|M0.Tuple#Equal| (|#M0.Tuple.Pair| ($Box SeqType |args'#0@0|) ($Box SetType |sts'#0@0|)) (M0.__default.evalArgs ($LS ($LS $LZ)) |context#0@@5| |args#0@@8| |stOrig#0@@5| |env#0@@13|)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|st'#1@@3| T@U) ) (!  (=> ($IsBox |st'#1@@3| Tclass.M0.State) (and (=> (|Set#IsMember| |sts'#0@0| |st'#1@@3|) (M0.__default.ValidState |st'#1@@3|)) (=> (|Set#IsMember| |sts'#0@0| |st'#1@@3|) (M0.__default.Extends |stOrig#0@@5| |st'#1@@3|))))
 :qid |CloudMakeParallelBuildsdfy.419:14|
 :skolemid |1117|
 :pattern ( (M0.__default.Extends |stOrig#0@@5| |st'#1@@3|))
 :pattern ( (M0.__default.ValidState |st'#1@@3|))
 :pattern ( (|Set#IsMember| |sts'#0@0| |st'#1@@3|))
)))))))
(let ((anon3_Else_correct  (=> (not (|Seq#Equal| |args#0@@8| |Seq#Empty|)) (and (=> (= (ControlFlow 0 5) (- 0 16)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |args#0@@8|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |args#0@@8|))) (=> (= |expr##1_0@0| ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@8| (LitInt 0)))) (and (=> (= (ControlFlow 0 5) (- 0 15)) (< (DtRank |expr##1_0@0|) (DtRank |context#0@@5|))) (=> (< (DtRank |expr##1_0@0|) (DtRank |context#0@@5|)) (=> (and (and ($Is DatatypeTypeType |call4formal@expr'#0| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |call4formal@expr'#0| Tclass.M0.Expression $Heap@@9)) (and ($IsBox |call5formal@st'#0| Tclass.M0.State) ($IsAllocBox |call5formal@st'#0| Tclass.M0.State $Heap@@9))) (and (=> (= (ControlFlow 0 5) (- 0 14)) (=> (|M0.__default.ValidState#canCall| |stOrig#0@@5|) (or (M0.__default.ValidState |stOrig#0@@5|) (forall ((|p#0@@11| T@U) ) (!  (=> ($IsBox |p#0@@11| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |stOrig#0@@5|) |p#0@@11|) (M0.__default.WellFounded |p#0@@11|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |1072|
 :pattern ( (M0.__default.WellFounded |p#0@@11|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |stOrig#0@@5|) |p#0@@11|))
))))) (=> (=> (|M0.__default.ValidState#canCall| |stOrig#0@@5|) (or (M0.__default.ValidState |stOrig#0@@5|) (forall ((|p#0@@12| T@U) ) (!  (=> ($IsBox |p#0@@12| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |stOrig#0@@5|) |p#0@@12|) (M0.__default.WellFounded |p#0@@12|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |1072|
 :pattern ( (M0.__default.WellFounded |p#0@@12|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |stOrig#0@@5|) |p#0@@12|))
)))) (and (=> (= (ControlFlow 0 5) (- 0 13)) (M0.__default.ValidEnv |env#0@@13|)) (=> (M0.__default.ValidEnv |env#0@@13|) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and ($Is DatatypeTypeType |call4formal@expr'#0@0| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |call4formal@expr'#0@0| Tclass.M0.Expression $Heap@0)) (and ($IsBox |call5formal@st'#0@0| Tclass.M0.State) ($IsAllocBox |call5formal@st'#0@0| Tclass.M0.State $Heap@0))) (=> (and (and (and (and (and (|$IsA#M0.Tuple| (M0.__default.eval ($LS $LZ) |expr##1_0@0| |stOrig#0@@5| |env#0@@13|)) (|M0.__default.eval#canCall| |expr##1_0@0| |stOrig#0@@5| |env#0@@13|)) (=> (|M0.Tuple#Equal| (|#M0.Tuple.Pair| ($Box DatatypeTypeType |call4formal@expr'#0@0|) |call5formal@st'#0@0|) (M0.__default.eval ($LS $LZ) |expr##1_0@0| |stOrig#0@@5| |env#0@@13|)) (and (|M0.__default.ValidState#canCall| |call5formal@st'#0@0|) (=> (M0.__default.ValidState |call5formal@st'#0@0|) (and (|M0.__default.Extends#canCall| |stOrig#0@@5| |call5formal@st'#0@0|) (=> (M0.__default.Extends |stOrig#0@@5| |call5formal@st'#0@0|) (=> (M0.Expression.exprError_q |call4formal@expr'#0@0|) (|$IsA#M0.Reason| (M0.Expression.r |call4formal@expr'#0@0|))))))))) (|M0.Tuple#Equal| (|#M0.Tuple.Pair| ($Box DatatypeTypeType |call4formal@expr'#0@0|) |call5formal@st'#0@0|) (M0.__default.eval ($LS ($LS $LZ)) |expr##1_0@0| |stOrig#0@@5| |env#0@@13|))) (and (|M0.__default.ValidState#canCall| |call5formal@st'#0@0|) (and (M0.__default.ValidState |call5formal@st'#0@0|) (forall ((|p#1@@5| T@U) ) (!  (=> ($IsBox |p#1@@5| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |call5formal@st'#0@0|) |p#1@@5|) (M0.__default.WellFounded |p#1@@5|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |1075|
 :pattern ( (M0.__default.WellFounded |p#1@@5|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |call5formal@st'#0@0|) |p#1@@5|))
))))) (and (and (|M0.__default.Extends#canCall| |stOrig#0@@5| |call5formal@st'#0@0|) (and (M0.__default.Extends |stOrig#0@@5| |call5formal@st'#0@0|) (and (and (|Set#Subset| (M0.__default.DomSt |stOrig#0@@5|) (M0.__default.DomSt |call5formal@st'#0@0|)) (forall ((|p#2@@2| T@U) ) (!  (=> ($IsBox |p#2@@2| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |stOrig#0@@5|) |p#2@@2|) (= (M0.__default.GetSt |p#2@@2| |call5formal@st'#0@0|) (M0.__default.GetSt |p#2@@2| |stOrig#0@@5|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |1078|
 :pattern ( (M0.__default.GetSt |p#2@@2| |stOrig#0@@5|))
 :pattern ( (M0.__default.GetSt |p#2@@2| |call5formal@st'#0@0|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |stOrig#0@@5|) |p#2@@2|))
))) (forall ((|p#3@@1| T@U) ) (!  (=> ($IsBox |p#3@@1| Tclass.M0.Path) (=> (and (not (|Set#IsMember| (M0.__default.DomSt |stOrig#0@@5|) |p#3@@1|)) (|Set#IsMember| (M0.__default.DomSt |call5formal@st'#0@0|) |p#3@@1|)) (= (M0.__default.GetSt |p#3@@1| |call5formal@st'#0@0|) (M0.__default.Oracle |p#3@@1| |stOrig#0@@5|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |1079|
 :pattern ( (M0.__default.Oracle |p#3@@1| |stOrig#0@@5|))
 :pattern ( (M0.__default.GetSt |p#3@@1| |call5formal@st'#0@0|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |call5formal@st'#0@0|) |p#3@@1|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |stOrig#0@@5|) |p#3@@1|))
))))) (and (=> (M0.Expression.exprError_q |call4formal@expr'#0@0|) (|M0.Reason#Equal| (M0.Expression.r |call4formal@expr'#0@0|) |#M0.Reason.rValidity|)) (= $Heap@@9 $Heap@0)))) (and (=> (= (ControlFlow 0 5) (- 0 12)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |args#0@@8|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |args#0@@8|))) (=> (= |args##1_0@0| (|Seq#Drop| |args#0@@8| (LitInt 1))) (and (=> (= (ControlFlow 0 5) (- 0 11)) (or (or (<= 0 (|Seq#Length| |args#0@@8|)) (< (DtRank |context#0@@5|) (DtRank |context#0@@5|))) (= (|Seq#Length| |args##1_0@0|) (|Seq#Length| |args#0@@8|)))) (=> (or (or (<= 0 (|Seq#Length| |args#0@@8|)) (< (DtRank |context#0@@5|) (DtRank |context#0@@5|))) (= (|Seq#Length| |args##1_0@0|) (|Seq#Length| |args#0@@8|))) (and (=> (= (ControlFlow 0 5) (- 0 10)) (or (< (DtRank |context#0@@5|) (DtRank |context#0@@5|)) (and (= (DtRank |context#0@@5|) (DtRank |context#0@@5|)) (< (|Seq#Length| |args##1_0@0|) (|Seq#Length| |args#0@@8|))))) (=> (or (< (DtRank |context#0@@5|) (DtRank |context#0@@5|)) (and (= (DtRank |context#0@@5|) (DtRank |context#0@@5|)) (< (|Seq#Length| |args##1_0@0|) (|Seq#Length| |args#0@@8|)))) (=> (and (and ($Is SeqType |call5formal@args'#0| (TSeq Tclass.M0.Expression)) ($IsAlloc SeqType |call5formal@args'#0| (TSeq Tclass.M0.Expression) $Heap@@9)) (and ($Is SetType |call6formal@sts'#0| (TSet Tclass.M0.State)) ($IsAlloc SetType |call6formal@sts'#0| (TSet Tclass.M0.State) $Heap@@9))) (and (=> (= (ControlFlow 0 5) (- 0 9)) (=> (|M0.__default.ValidState#canCall| |stOrig#0@@5|) (or (M0.__default.ValidState |stOrig#0@@5|) (forall ((|p#0@@13| T@U) ) (!  (=> ($IsBox |p#0@@13| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |stOrig#0@@5|) |p#0@@13|) (M0.__default.WellFounded |p#0@@13|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |1108|
 :pattern ( (M0.__default.WellFounded |p#0@@13|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |stOrig#0@@5|) |p#0@@13|))
))))) (=> (=> (|M0.__default.ValidState#canCall| |stOrig#0@@5|) (or (M0.__default.ValidState |stOrig#0@@5|) (forall ((|p#0@@14| T@U) ) (!  (=> ($IsBox |p#0@@14| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |stOrig#0@@5|) |p#0@@14|) (M0.__default.WellFounded |p#0@@14|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |1108|
 :pattern ( (M0.__default.WellFounded |p#0@@14|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |stOrig#0@@5|) |p#0@@14|))
)))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (M0.__default.ValidEnv |env#0@@13|)) (=> (M0.__default.ValidEnv |env#0@@13|) (and (=> (= (ControlFlow 0 5) (- 0 7)) (forall ((|arg#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#1@@0| Tclass.M0.Expression) (=> (|Seq#Contains| |args##1_0@0| ($Box DatatypeTypeType |arg#1@@0|)) (< (DtRank |arg#1@@0|) (DtRank |context#0@@5|))))
...
)) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and ($Is SeqType |call5formal@args'#0@0| (TSeq Tclass.M0.Expression)) ($IsAlloc SeqType |call5formal@args'#0@0| (TSeq Tclass.M0.Expression) $Heap@1)) (and ($Is SetType |call6formal@sts'#0@0| (TSet Tclass.M0.State)) ($IsAlloc SetType |call6formal@sts'#0@0| (TSet Tclass.M0.State) $Heap@1))) (=> (and (and (and (|$IsA#M0.Tuple| (M0.__default.evalArgs ($LS $LZ) |context#0@@5| |args##1_0@0| |stOrig#0@@5| |env#0@@13|)) (|M0.__default.evalArgs#canCall| |context#0@@5| |args##1_0@0| |stOrig#0@@5| |env#0@@13|)) (=> (|M0.Tuple#Equal| (|#M0.Tuple.Pair| ($Box SeqType |call5formal@args'#0@0|) ($Box SetType |call6formal@sts'#0@0|)) (M0.__default.evalArgs ($LS $LZ) |context#0@@5| |args##1_0@0| |stOrig#0@@5| |env#0@@13|)) (forall ((|st'#1@@4| T@U) ) (!  (=> ($IsBox |st'#1@@4| Tclass.M0.State) (and (=> (|Set#IsMember| |call6formal@sts'#0@0| |st'#1@@4|) (|M0.__default.ValidState#canCall| |st'#1@@4|)) (=> (=> (|Set#IsMember| |call6formal@sts'#0@0| |st'#1@@4|) (M0.__default.ValidState |st'#1@@4|)) (=> (|Set#IsMember| |call6formal@sts'#0@0| |st'#1@@4|) (|M0.__default.Extends#canCall| |stOrig#0@@5| |st'#1@@4|)))))
 :qid |CloudMakeParallelBuildsdfy.419:14|
 :skolemid |1111|
 :pattern ( (M0.__default.Extends |stOrig#0@@5| |st'#1@@4|))
 :pattern ( (M0.__default.ValidState |st'#1@@4|))
 :pattern ( (|Set#IsMember| |call6formal@sts'#0@0| |st'#1@@4|))
)))) (and (and (|M0.Tuple#Equal| (|#M0.Tuple.Pair| ($Box SeqType |call5formal@args'#0@0|) ($Box SetType |call6formal@sts'#0@0|)) (M0.__default.evalArgs ($LS ($LS $LZ)) |context#0@@5| |args##1_0@0| |stOrig#0@@5| |env#0@@13|)) (forall ((|st'#1@@5| T@U) ) (!  (=> ($IsBox |st'#1@@5| Tclass.M0.State) (and (=> (|Set#IsMember| |call6formal@sts'#0@0| |st'#1@@5|) (M0.__default.ValidState |st'#1@@5|)) (=> (|Set#IsMember| |call6formal@sts'#0@0| |st'#1@@5|) (M0.__default.Extends |stOrig#0@@5| |st'#1@@5|))))
 :qid |CloudMakeParallelBuildsdfy.419:14|
 :skolemid |1112|
 :pattern ( (M0.__default.Extends |stOrig#0@@5| |st'#1@@5|))
 :pattern ( (M0.__default.ValidState |st'#1@@5|))
 :pattern ( (|Set#IsMember| |call6formal@sts'#0@0| |st'#1@@5|))
))) (and (= $Heap@0 $Heap@1) (= |$rhs#1_0@0| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |call4formal@expr'#0@0|)) |call5formal@args'#0@0|))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) true) (=> (and (and (= |$rhs#1_1@0| (|Set#Union| (|Set#UnionOne| |Set#Empty| |call5formal@st'#0@0|) |call6formal@sts'#0@0|)) (= |args'#0@0| |$rhs#1_0@0|)) (and (= |sts'#0@0| |$rhs#1_1@0|) (= (ControlFlow 0 5) 2))) GeneratedUnifiedExit_correct)))))))))))))))))))))))))))))))))))
(let ((anon3_Then_correct  (=> (and (|Seq#Equal| |args#0@@8| |Seq#Empty|) (= |$rhs#0_0@0| (Lit SeqType |Seq#Empty|))) (=> (and (and (= |$rhs#0_1@0| (Lit SetType |Set#Empty|)) (= |args'#0@0| |$rhs#0_0@0|)) (and (= |sts'#0@0| |$rhs#0_1@0|) (= (ControlFlow 0 4) 2))) GeneratedUnifiedExit_correct))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@9 alloc false)) (and (=> (= (ControlFlow 0 17) 4) anon3_Then_correct) (=> (= (ControlFlow 0 17) 5) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@9) ($IsHeapAnchor $Heap@@9)) (=> (and (and (and (and ($Is DatatypeTypeType |context#0@@5| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |context#0@@5| Tclass.M0.Expression $Heap@@9)) (|$IsA#M0.Expression| |context#0@@5|)) (and ($Is SeqType |args#0@@8| (TSeq Tclass.M0.Expression)) ($IsAlloc SeqType |args#0@@8| (TSeq Tclass.M0.Expression) $Heap@@9))) (and (and (and ($IsBox |stOrig#0@@5| Tclass.M0.State) ($IsAllocBox |stOrig#0@@5| Tclass.M0.State $Heap@@9)) (and ($IsBox |env#0@@13| Tclass.M0.Env) ($IsAllocBox |env#0@@13| Tclass.M0.Env $Heap@@9))) (and (and ($Is SeqType |args'#0@@1| (TSeq Tclass.M0.Expression)) ($IsAlloc SeqType |args'#0@@1| (TSeq Tclass.M0.Expression) $Heap@@9)) (and ($Is SetType |sts'#0@@1| (TSet Tclass.M0.State)) ($IsAlloc SetType |sts'#0@@1| (TSet Tclass.M0.State) $Heap@@9))))) (=> (and (and (and (and (and ($Is DatatypeTypeType |rArg#1_0| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |rArg#1_0| Tclass.M0.Expression $Heap@@9)) true) (and (=> |defass#rSts#1_0| (and ($IsBox |rSts#1_0| Tclass.M0.State) ($IsAllocBox |rSts#1_0| Tclass.M0.State $Heap@@9))) true)) (and (and ($Is SeqType |rrArg#1_0| (TSeq Tclass.M0.Expression)) ($IsAlloc SeqType |rrArg#1_0| (TSeq Tclass.M0.Expression) $Heap@@9)) true)) (and (and (and (and ($Is SetType |rrSts#1_0| (TSet Tclass.M0.State)) ($IsAlloc SetType |rrSts#1_0| (TSet Tclass.M0.State) $Heap@@9)) true) (= 5 $FunctionContextHeight)) (and (and (and (|M0.__default.ValidState#canCall| |stOrig#0@@5|) (and (M0.__default.ValidState |stOrig#0@@5|) (forall ((|p#1@@6| T@U) ) (!  (=> ($IsBox |p#1@@6| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |stOrig#0@@5|) |p#1@@6|) (M0.__default.WellFounded |p#1@@6|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |1114|
 :pattern ( (M0.__default.WellFounded |p#1@@6|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |stOrig#0@@5|) |p#1@@6|))
)))) (M0.__default.ValidEnv |env#0@@13|)) (and (forall ((|arg#1@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#1@@2| Tclass.M0.Expression) (=> (|Seq#Contains| |args#0@@8| ($Box DatatypeTypeType |arg#1@@2|)) (< (DtRank |arg#1@@2|) (DtRank |context#0@@5|))))
 :qid |CloudMakeParallelBuildsdfy.416:14|
 :skolemid |1115|
 :pattern ( (|Seq#Contains| |args#0@@8| ($Box DatatypeTypeType |arg#1@@2|)))
)) (= (ControlFlow 0 18) 17))))) anon0_correct)))))
