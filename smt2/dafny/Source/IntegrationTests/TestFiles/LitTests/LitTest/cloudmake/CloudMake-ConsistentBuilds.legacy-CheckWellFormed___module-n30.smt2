...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.CachedBuildsTheorem)
...
(let ((anon7_Else_correct  (=> (and (not (and (_module.__default.ConsistentCache |stC'#Z#0@0|) (_module.Expression.exprError_q |expr'#Z#0@0|))) (= (ControlFlow 0 4) 1)) anon5_correct)))
(let ((anon7_Then_correct  (=> (and (_module.__default.ConsistentCache |stC'#Z#0@0|) (_module.Expression.exprError_q |expr'#Z#0@0|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (_module.Expression.exprError_q |expr'#Z#0@0|)) (=> (_module.Expression.exprError_q |expr'#Z#0@0|) (=> (= (ControlFlow 0 2) 1) anon5_correct))))))
(let ((anon6_Else_correct  (=> (not (_module.__default.ConsistentCache |stC'#Z#0@0|)) (and (=> (= (ControlFlow 0 6) 2) anon7_Then_correct) (=> (= (ControlFlow 0 6) 4) anon7_Else_correct)))))
(let ((anon6_Then_correct  (=> (_module.__default.ConsistentCache |stC'#Z#0@0|) (and (=> (= (ControlFlow 0 5) 2) anon7_Then_correct) (=> (= (ControlFlow 0 5) 4) anon7_Else_correct)))))
