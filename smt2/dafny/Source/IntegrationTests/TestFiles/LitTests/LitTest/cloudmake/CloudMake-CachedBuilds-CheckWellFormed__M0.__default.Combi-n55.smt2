...
(set-info :boogie-vc-id CheckWellFormed$$M0.__default.Combine__Representative)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (not (|Set#Equal| |sts#0@@3| |Set#Empty|))) (and ($IsAlloc SetType |sts#0@@3| (TSet Tclass.M0.State) $Heap@@4) ($IsAlloc boolType (bool_2_U |useCache#0@@4|) TBool $Heap@@4))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (not (|Set#Equal| |sts#0@@3| |Set#Empty|))) (=> (and (not (|Set#Equal| |sts#0@@3| |Set#Empty|)) (|M0.__default.Combine#canCall| |sts#0@@3| |useCache#0@@4|)) (=> (and (and (and (and (= |##st#0@0| (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |sts#0@@3| |useCache#0@@4|)) ($IsAllocBox |##st#0@0| Tclass.M0.State $Heap@@4)) (and (|M0.__default.DomSt#canCall| (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |sts#0@@3| |useCache#0@@4|)) (|Set#IsMember| (M0.__default.DomSt (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |sts#0@@3| |useCache#0@@4|)) |p#0@@2|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@4 $Heap@0))) (and (and (and ($IsBox |stRepr#0@0| Tclass.M0.State) ($IsAllocBox |stRepr#0@0| Tclass.M0.State $Heap@0)) (and (|Set#IsMember| |sts#0@@3| |stRepr#0@0|) ($IsAllocBox |stRepr#0@0| Tclass.M0.State $Heap@0))) (and (and (|M0.__default.DomSt#canCall| |stRepr#0@0|) (|Set#IsMember| (M0.__default.DomSt |stRepr#0@0|) |p#0@@2|)) (and ($IsAllocBox |p#0@@2| Tclass.M0.Path $Heap@0) ($IsAllocBox |stRepr#0@0| Tclass.M0.State $Heap@0))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Set#IsMember| (M0.__default.DomSt |stRepr#0@0|) |p#0@@2|)) (=> (|Set#IsMember| (M0.__default.DomSt |stRepr#0@0|) |p#0@@2|) (=> (and (and (|M0.__default.GetSt#canCall| |p#0@@2| |stRepr#0@0|) ($IsAllocBox |p#0@@2| Tclass.M0.Path $Heap@0)) (and ($IsAlloc SetType |sts#0@@3| (TSet Tclass.M0.State) $Heap@0) ($IsAlloc boolType (bool_2_U |useCache#0@@4|) TBool $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (|Set#Equal| |sts#0@@3| |Set#Empty|))) (=> (not (|Set#Equal| |sts#0@@3| |Set#Empty|)) (=> (and (and (|M0.__default.Combine#canCall| |sts#0@@3| |useCache#0@@4|) (= |##st#3@0| (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |sts#0@@3| |useCache#0@@4|))) (and ($IsAllocBox |##st#3@0| Tclass.M0.State $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (|Set#IsMember| (M0.__default.DomSt |##st#3@0|) |p#0@@2|)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (=> (and (and (and ($IsBox |p#0@@2| Tclass.M0.Path) ($IsAllocBox |p#0@@2| Tclass.M0.Path $Heap@@4)) (and ($Is SetType |sts#0@@3| (TSet Tclass.M0.State)) ($IsAlloc SetType |sts#0@@3| (TSet Tclass.M0.State) $Heap@@4))) (and (and ($IsBox |stRepr#0| Tclass.M0.State) ($IsAllocBox |stRepr#0| Tclass.M0.State $Heap@@4)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 6) 2)))) anon0_correct))))
