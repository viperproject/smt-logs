...
(set-info :boogie-vc-id Impl$$M3.__default.ParallelBuildsTheorem)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#4| null $Heap@@21 alloc false)) (=> (and (and ($Is DatatypeTypeType |call3formal@expr'#0| Tclass.M3.Expression) ($IsAlloc DatatypeTypeType |call3formal@expr'#0| Tclass.M3.Expression $Heap@@21)) (and ($Is DatatypeTypeType |call4formal@st'#0| Tclass.M3.State) ($IsAlloc DatatypeTypeType |call4formal@st'#0| Tclass.M3.State $Heap@@21))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|M3.__default.Legal#canCall| (M3.Program.stmts |prog#0@@3|)) (or (M3.__default.Legal (M3.Program.stmts |prog#0@@3|)) (or (not (= (|Seq#Length| (M3.Program.stmts |prog#0@@3|)) 0)) (not true))))) (=> (=> (|M3.__default.Legal#canCall| (M3.Program.stmts |prog#0@@3|)) (or (M3.__default.Legal (M3.Program.stmts |prog#0@@3|)) (or (not (= (|Seq#Length| (M3.Program.stmts |prog#0@@3|)) 0)) (not true)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|M3.__default.ValidState#canCall| |st#0@@65|) (or (M3.__default.ValidState |st#0@@65|) (forall ((|p#0@@55| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@55| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@65|) ($Box DatatypeTypeType |p#0@@55|)) (M3.__default.WellFounded |p#0@@55|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6761|
...
)))) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and ($Is DatatypeTypeType |call3formal@expr'#0@0| Tclass.M3.Expression) ($IsAlloc DatatypeTypeType |call3formal@expr'#0@0| Tclass.M3.Expression $Heap@0)) (and ($Is DatatypeTypeType |call4formal@st'#0@0| Tclass.M3.State) ($IsAlloc DatatypeTypeType |call4formal@st'#0@0| Tclass.M3.State $Heap@0))) (=> (and (and (and (and (and (|$IsA#M3.Tuple| (M3.__default.build |prog#0@@3| |st#0@@65|)) (|M3.__default.build#canCall| |prog#0@@3| |st#0@@65|)) (=> (|M3.Tuple#Equal| (M3.__default.build |prog#0@@3| |st#0@@65|) (|#M3.Tuple.Pair| ($Box DatatypeTypeType |call3formal@expr'#0@0|) ($Box DatatypeTypeType |call4formal@st'#0@0|))) (and (|M3.__default.ValidState#canCall| |call4formal@st'#0@0|) (=> (M3.__default.ValidState |call4formal@st'#0@0|) (and (|M3.__default.Extends#canCall| |st#0@@65| |call4formal@st'#0@0|) (=> (M3.__default.Extends |st#0@@65| |call4formal@st'#0@0|) (=> (M3.Expression.exprError_q |call3formal@expr'#0@0|) (|$IsA#M3.Reason| (M3.Expression.r |call3formal@expr'#0@0|))))))))) (|M3.Tuple#Equal| (M3.__default.build |prog#0@@3| |st#0@@65|) (|#M3.Tuple.Pair| ($Box DatatypeTypeType |call3formal@expr'#0@0|) ($Box DatatypeTypeType |call4formal@st'#0@0|)))) (and (|M3.__default.ValidState#canCall| |call4formal@st'#0@0|) (and (M3.__default.ValidState |call4formal@st'#0@0|) (forall ((|p#1@@9| T@U) ) (!  (=> ($Is DatatypeTypeType |p#1@@9| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |call4formal@st'#0@0|) ($Box DatatypeTypeType |p#1@@9|)) (M3.__default.WellFounded |p#1@@9|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6764|
 :pattern ( (M3.__default.WellFounded |p#1@@9|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |call4formal@st'#0@0|) ($Box DatatypeTypeType |p#1@@9|)))
))))) (and (and (|M3.__default.Extends#canCall| |st#0@@65| |call4formal@st'#0@0|) (and (M3.__default.Extends |st#0@@65| |call4formal@st'#0@0|) (and (and (|Set#Subset| (M3.__default.DomSt |st#0@@65|) (M3.__default.DomSt |call4formal@st'#0@0|)) (forall ((|p#2@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |p#2@@2| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@65|) ($Box DatatypeTypeType |p#2@@2|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#2@@2| |call4formal@st'#0@0|) (M3.__default.GetSt |p#2@@2| |st#0@@65|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6767|
 :pattern ( (M3.__default.GetSt |p#2@@2| |st#0@@65|))
 :pattern ( (M3.__default.GetSt |p#2@@2| |call4formal@st'#0@0|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@65|) ($Box DatatypeTypeType |p#2@@2|)))
))) (forall ((|p#3@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |p#3@@1| Tclass.M3.Path) (=> (and (not (|Set#IsMember| (M3.__default.DomSt |st#0@@65|) ($Box DatatypeTypeType |p#3@@1|))) (|Set#IsMember| (M3.__default.DomSt |call4formal@st'#0@0|) ($Box DatatypeTypeType |p#3@@1|))) (|M3.Artifact#Equal| (M3.__default.GetSt |p#3@@1| |call4formal@st'#0@0|) (M3.__default.Oracle |p#3@@1| |st#0@@65|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |6768|
 :pattern ( (M3.__default.Oracle |p#3@@1| |st#0@@65|))
 :pattern ( (M3.__default.GetSt |p#3@@1| |call4formal@st'#0@0|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |call4formal@st'#0@0|) ($Box DatatypeTypeType |p#3@@1|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@65|) ($Box DatatypeTypeType |p#3@@1|)))
))))) (and (=> (M3.Expression.exprError_q |call3formal@expr'#0@0|) (|M3.Reason#Equal| (M3.Expression.r |call3formal@expr'#0@0|) |#M3.Reason.rValidity|)) (= $Heap@@21 $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> false (let ((|st'#0@@12| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.build |prog#0@@3| |st#0@@65|)))))
 (=> (|M3.__default.ValidState#canCall| |st'#0@@12|) (or (M3.__default.ValidState |st'#0@@12|) (forall ((|p#3@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |p#3@@2| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st'#0@@12|) ($Box DatatypeTypeType |p#3@@2|)) (M3.__default.WellFounded |p#3@@2|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6758|
 :pattern ( (M3.__default.WellFounded |p#3@@2|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@12|) ($Box DatatypeTypeType |p#3@@2|)))
))))))) (=> (=> false (let ((|st'#0@@13| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.build |prog#0@@3| |st#0@@65|)))))
 (=> (|M3.__default.ValidState#canCall| |st'#0@@13|) (or (M3.__default.ValidState |st'#0@@13|) (forall ((|p#3@@3| T@U) ) (!  (=> ($Is DatatypeTypeType |p#3@@3| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st'#0@@13|) ($Box DatatypeTypeType |p#3@@3|)) (M3.__default.WellFounded |p#3@@3|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6758|
 :pattern ( (M3.__default.WellFounded |p#3@@3|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@13|) ($Box DatatypeTypeType |p#3@@3|)))
)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (let ((|expr'#0@@1| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.build |prog#0@@3| |st#0@@65|)))))
 (=> (M3.Expression.exprError_q |expr'#0@@1|) (|M3.Reason#Equal| (M3.Expression.r |expr'#0@@1|) |#M3.Reason.rValidity|))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@21) ($IsHeapAnchor $Heap@@21)) (=> (and (and ($Is DatatypeTypeType |prog#0@@3| Tclass.M3.Program) ($IsAlloc DatatypeTypeType |prog#0@@3| Tclass.M3.Program $Heap@@21)) (|$IsA#M3.Program| |prog#0@@3|)) (=> (and (and (and ($Is DatatypeTypeType |st#0@@65| Tclass.M3.State) ($IsAlloc DatatypeTypeType |st#0@@65| Tclass.M3.State $Heap@@21)) (|$IsA#M3.State| |st#0@@65|)) (and (and ($Is DatatypeTypeType |_v0#0| Tclass.M3.Expression) ($IsAlloc DatatypeTypeType |_v0#0| Tclass.M3.Expression $Heap@@21)) true)) (=> (and (and (and (and (and ($Is DatatypeTypeType |_v1#0| Tclass.M3.State) ($IsAlloc DatatypeTypeType |_v1#0| Tclass.M3.State $Heap@@21)) true) (= 15 $FunctionContextHeight)) (and (|M3.__default.Legal#canCall| (M3.Program.stmts |prog#0@@3|)) (and (M3.__default.Legal (M3.Program.stmts |prog#0@@3|)) (or (not (= (|Seq#Length| (M3.Program.stmts |prog#0@@3|)) 0)) (not true))))) (and (and (|M3.__default.ValidState#canCall| |st#0@@65|) (and (M3.__default.ValidState |st#0@@65|) (forall ((|p#2@@3| T@U) ) (!  (=> ($Is DatatypeTypeType |p#2@@3| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@65|) ($Box DatatypeTypeType |p#2@@3|)) (M3.__default.WellFounded |p#2@@3|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6757|
 :pattern ( (M3.__default.WellFounded |p#2@@3|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@65|) ($Box DatatypeTypeType |p#2@@3|)))
