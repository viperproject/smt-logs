...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (|p#0| T@U) ) (!  (=> (or (|M3.__default.LocInv__Deps#canCall| |p#0|) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap) ($Is DatatypeTypeType |p#0| Tclass.M3.Path)))) (and (=> (not (M3.Path.InternalPath_q |p#0|)) |$let#10$canCall|) (= (M3.__default.LocInv__Deps |p#0|) (ite (M3.Path.InternalPath_q |p#0|) (let ((|deps#0| (M3.Path.deps |p#0|)))
|deps#0|) (let ((|deps#1| |$let#10_deps|))
|deps#1|)))))
 :qid |CloudMakeParallelBuildsdfy.803:18|
 :skolemid |5689|
 :pattern ( (M3.__default.LocInv__Deps |p#0|) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|p#0@@0| T@U) ) (!  (=> (or (|M3.__default.LocInv__Deps#canCall| |p#0@@0|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |p#0@@0| Tclass.M3.Path))) ($Is SetType (M3.__default.LocInv__Deps |p#0@@0|) (TSet Tclass.M3.Path)))
 :qid |CloudMakeParallelBuildsdfy.637:30|
 :skolemid |5687|
 :pattern ( (M3.__default.LocInv__Deps |p#0@@0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|p#0@@1| T@U) ) (!  (=> (or (|M3.__default.LocInv__Deps#canCall| (Lit DatatypeTypeType |p#0@@1|)) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) ($Is DatatypeTypeType |p#0@@1| Tclass.M3.Path)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (M3.Path.InternalPath_q (Lit DatatypeTypeType |p#0@@1|)))))) |$let#10$canCall|) (= (M3.__default.LocInv__Deps (Lit DatatypeTypeType |p#0@@1|)) (ite (M3.Path.InternalPath_q (Lit DatatypeTypeType |p#0@@1|)) (let ((|deps#3| (Lit SetType (M3.Path.deps (Lit DatatypeTypeType |p#0@@1|)))))
|deps#3|) (let ((|deps#4| |$let#10_deps|))
|deps#4|)))))
 :qid |CloudMakeParallelBuildsdfy.803:18|
 :weight 3
 :skolemid |5690|
 :pattern ( (M3.__default.LocInv__Deps (Lit DatatypeTypeType |p#0@@1|)) ($IsGoodHeap $Heap@@0))
))))
...
(set-info :boogie-vc-id CheckWellformed$$M3.__default.LocInv__Deps)
...
(let ((anon13_Else_correct  (=> (and (not (and ($Is SetType |deps#6@0| (TSet Tclass.M3.Path)) ($IsAlloc SetType |deps#6@0| (TSet Tclass.M3.Path) $Heap@@1))) (= (ControlFlow 0 7) 5)) anon7_correct)))
(let ((anon13_Then_correct  (=> (and (and ($Is SetType |deps#6@0| (TSet Tclass.M3.Path)) ($IsAlloc SetType |deps#6@0| (TSet Tclass.M3.Path) $Heap@@1)) (= (ControlFlow 0 6) 5)) anon7_correct)))
