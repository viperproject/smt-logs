...
(declare-fun |stCombined#0@0| () T@U)
(declare-fun |args#0@@12| () T@U)
(declare-fun |##useCache#0_0@0| () Bool)
(declare-fun |stC#0@@7| () T@U)
(declare-fun |stCombinedC#0@0| () T@U)
(declare-fun |##useCache#0_1@0| () Bool)
...
(declare-fun |outExprC#0| () T@U)
(declare-fun |defass#stCombined#0| () Bool)
(declare-fun |stCombined#0@@6| () T@U)
(declare-fun |defass#stCombinedC#0| () Bool)
(declare-fun |stCombinedC#0| () T@U)
(set-info :boogie-vc-id Impl$$M0.__default.Continuation)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 64) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (|M0.Expression#Equal| ($Unbox DatatypeTypeType (M0.Tuple.fst |p#0@@17|)) ($Unbox DatatypeTypeType (M0.Tuple.fst |pC#0|))))))
(let ((anon29_Else_correct  (=> (and (not (and (and (M0.Expression.exprLiteral_q |fun#0@@4|) (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|))) (M0.Primitive.primExec_q (M0.Literal.prim (M0.Expression.lit |fun#0@@4|))))) (= (ControlFlow 0 17) 2)) GeneratedUnifiedExit_correct)))
(let ((anon29_Then_correct  (=> (and (and (and (M0.Expression.exprLiteral_q |fun#0@@4|) (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|))) (M0.Primitive.primExec_q (M0.Literal.prim (M0.Expression.lit |fun#0@@4|)))) ($IsAllocBox |st#0@@25| Tclass.M0.State $Heap@2)) (and (=> (= (ControlFlow 0 3) (- 0 16)) true) (=> (and ($IsAllocBox |stCombined#0@0| Tclass.M0.State $Heap@2) ($IsAlloc SeqType |args#0@@12| (TSeq Tclass.M0.Expression) $Heap@2)) (=> (and (and (and (= |##useCache#0_0@0| (U_2_bool (Lit boolType (bool_2_U false)))) ($IsAlloc boolType (bool_2_U |##useCache#0_0@0|) TBool $Heap@2)) (and (|M0.__default.evalCore#canCall| |st#0@@25| |stCombined#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))) (M0.Tuple.Pair_q (M0.__default.evalCore |st#0@@25| |stCombined#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false))))))) (and (and (|$IsA#M0.Tuple| |p#0@@17|) (|$IsA#M0.Tuple| (M0.__default.evalCore |st#0@@25| |stCombined#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))))) (|M0.__default.evalCore#canCall| |st#0@@25| |stCombined#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))))) (and (=> (= (ControlFlow 0 3) (- 0 15)) (|M0.Tuple#Equal| |p#0@@17| (M0.__default.evalCore |st#0@@25| |stCombined#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))))) (=> (|M0.Tuple#Equal| |p#0@@17| (M0.__default.evalCore |st#0@@25| |stCombined#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false))))) (=> ($IsAllocBox |stC#0@@7| Tclass.M0.State $Heap@2) (and (=> (= (ControlFlow 0 3) (- 0 14)) true) (=> (and ($IsAllocBox |stCombinedC#0@0| Tclass.M0.State $Heap@2) ($IsAlloc SeqType |args#0@@12| (TSeq Tclass.M0.Expression) $Heap@2)) (=> (and (and (and (= |##useCache#0_1@0| (U_2_bool (Lit boolType (bool_2_U true)))) ($IsAlloc boolType (bool_2_U |##useCache#0_1@0|) TBool $Heap@2)) (and (|M0.__default.evalCore#canCall| |stC#0@@7| |stCombinedC#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true)))) (M0.Tuple.Pair_q (M0.__default.evalCore |stC#0@@7| |stCombinedC#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true))))))) (and (and (|$IsA#M0.Tuple| |pC#0|) (|$IsA#M0.Tuple| (M0.__default.evalCore |stC#0@@7| |stCombinedC#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true)))))) (|M0.__default.evalCore#canCall| |stC#0@@7| |stCombinedC#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 3) (- 0 13)) (|M0.Tuple#Equal| |pC#0| (M0.__default.evalCore |stC#0@@7| |stCombinedC#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true)))))) (=> (|M0.Tuple#Equal| |pC#0| (M0.__default.evalCore |stC#0@@7| |stCombinedC#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true))))) (and (=> (= (ControlFlow 0 3) (- 0 12)) true) (and (=> (= (ControlFlow 0 3) (- 0 11)) true) (and (=> (= (ControlFlow 0 3) (- 0 10)) (|M0.Tuple#Equal| |p#0@@17| (M0.__default.evalCore |st#0@@25| |stCombined#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))))) (=> (|M0.Tuple#Equal| |p#0@@17| (M0.__default.evalCore |st#0@@25| |stCombined#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false))))) (and (=> (= (ControlFlow 0 3) (- 0 9)) (|M0.Tuple#Equal| |pC#0| (M0.__default.evalCore |stC#0@@7| |stCombinedC#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true)))))) (=> (|M0.Tuple#Equal| |pC#0| (M0.__default.evalCore |stC#0@@7| |stCombinedC#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true))))) (and (=> (= (ControlFlow 0 3) (- 0 8)) (=> (|M0.__default.ValidState#canCall| |stCombined#0@0|) (or (M0.__default.ValidState |stCombined#0@0|) (forall ((|p#1@@7| T@U) ) (!  (=> ($IsBox |p#1@@7| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |stCombined#0@0|) |p#1@@7|) (M0.__default.WellFounded |p#1@@7|)))
 :qid |CloudMakeCachedBuildsdfy.35:12|
 :skolemid |1592|
 :pattern ( (M0.__default.WellFounded |p#1@@7|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |stCombined#0@0|) |p#1@@7|))
))))) (=> (=> (|M0.__default.ValidState#canCall| |stCombined#0@0|) (or (M0.__default.ValidState |stCombined#0@0|) (forall ((|p#1@@8| T@U) ) (!  (=> ($IsBox |p#1@@8| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |stCombined#0@0|) |p#1@@8|) (M0.__default.WellFounded |p#1@@8|)))
 :qid |CloudMakeCachedBuildsdfy.35:12|
 :skolemid |1592|
 :pattern ( (M0.__default.WellFounded |p#1@@8|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |stCombined#0@0|) |p#1@@8|))
)))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (=> (|M0.__default.ValidState#canCall| |stCombinedC#0@0|) (or (M0.__default.ValidState |stCombinedC#0@0|) (forall ((|p#2@@5| T@U) ) (!  (=> ($IsBox |p#2@@5| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |stCombinedC#0@0|) |p#2@@5|) (M0.__default.WellFounded |p#2@@5|)))
 :qid |CloudMakeCachedBuildsdfy.35:12|
 :skolemid |1594|
 :pattern ( (M0.__default.WellFounded |p#2@@5|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |stCombinedC#0@0|) |p#2@@5|))
))))) (=> (=> (|M0.__default.ValidState#canCall| |stCombinedC#0@0|) (or (M0.__default.ValidState |stCombinedC#0@0|) (forall ((|p#2@@6| T@U) ) (!  (=> ($IsBox |p#2@@6| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |stCombinedC#0@0|) |p#2@@6|) (M0.__default.WellFounded |p#2@@6|)))
 :qid |CloudMakeCachedBuildsdfy.35:12|
 :skolemid |1594|
 :pattern ( (M0.__default.WellFounded |p#2@@6|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |stCombinedC#0@0|) |p#2@@6|))
)))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (=> (|M0.__default.ConsistentCache#canCall| |stCombinedC#0@0|) (or (M0.__default.ConsistentCache |stCombinedC#0@0|) (forall ((|cmd#0@@14| T@U) (|deps#0@@14| T@U) (|e#0@@8| T@U) ) (!  (=> (and (and ($Is SeqType |cmd#0@@14| (TSeq TChar)) ($Is SetType |deps#0@@14| (TSet Tclass.M0.Path))) ($Is SeqType |e#0@@8| (TSeq TChar))) (=> (|Set#IsMember| (M0.__default.DomC |stCombinedC#0@0|) (M0.__default.Hash (M0.__default.Loc |cmd#0@@14| |deps#0@@14| |e#0@@8|))) (|Set#IsMember| (M0.__default.DomSt |stCombinedC#0@0|) (M0.__default.Loc |cmd#0@@14| |deps#0@@14| |e#0@@8|))))
 :qid |CloudMakeCachedBuildsdfy.116:12|
 :skolemid |1596|
 :pattern ( (M0.__default.Loc |cmd#0@@14| |deps#0@@14| |e#0@@8|))
))))) (=> (=> (|M0.__default.ConsistentCache#canCall| |stCombinedC#0@0|) (or (M0.__default.ConsistentCache |stCombinedC#0@0|) (forall ((|cmd#0@@15| T@U) (|deps#0@@15| T@U) (|e#0@@9| T@U) ) (!  (=> (and (and ($Is SeqType |cmd#0@@15| (TSeq TChar)) ($Is SetType |deps#0@@15| (TSet Tclass.M0.Path))) ($Is SeqType |e#0@@9| (TSeq TChar))) (=> (|Set#IsMember| (M0.__default.DomC |stCombinedC#0@0|) (M0.__default.Hash (M0.__default.Loc |cmd#0@@15| |deps#0@@15| |e#0@@9|))) (|Set#IsMember| (M0.__default.DomSt |stCombinedC#0@0|) (M0.__default.Loc |cmd#0@@15| |deps#0@@15| |e#0@@9|))))
 :qid |CloudMakeCachedBuildsdfy.116:12|
 :skolemid |1596|
 :pattern ( (M0.__default.Loc |cmd#0@@15| |deps#0@@15| |e#0@@9|))
)))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence |st#0@@25| |stC#0@@7|)) (=> (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence |st#0@@25| |stC#0@@7|) (and (=> (= (ControlFlow 0 3) (- 0 4)) (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence |stCombined#0@0| |stCombinedC#0@0|)) (=> (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence |stCombined#0@0| |stCombinedC#0@0|) (=> (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (=> (and (and (and (|$IsA#M0.Expression| ($Unbox DatatypeTypeType (M0.Tuple.fst |p#0@@17|))) (|$IsA#M0.Expression| ($Unbox DatatypeTypeType (M0.Tuple.fst |pC#0|)))) (and (M0.Tuple.Pair_q |p#0@@17|) (M0.Tuple.Pair_q |pC#0|))) (|M0.Expression#Equal| ($Unbox DatatypeTypeType (M0.Tuple.fst |p#0@@17|)) ($Unbox DatatypeTypeType (M0.Tuple.fst |pC#0|)))) (=> (and (and (and (and (M0.Tuple.Pair_q |p#0@@17|) (M0.Tuple.Pair_q |pC#0|)) (|M0.__default.StateCorrespondence#canCall| (M0.Tuple.snd |p#0@@17|) (M0.Tuple.snd |pC#0|))) (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence (M0.Tuple.snd |p#0@@17|) (M0.Tuple.snd |pC#0|))) (and (= $Heap@2 $Heap@3) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct)))))))))))))))))))))))))))))))))
(let ((anon18_correct  (and (=> (= (ControlFlow 0 18) 3) anon29_Then_correct) (=> (= (ControlFlow 0 18) 17) anon29_Else_correct))))
(let ((anon28_Else_correct  (=> (and (not (and (M0.Expression.exprLiteral_q |fun#0@@4|) (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|)))) (= (ControlFlow 0 22) 18)) anon18_correct)))
(let ((anon28_Then_correct  (=> (and (M0.Expression.exprLiteral_q |fun#0@@4|) (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|))) (and (=> (= (ControlFlow 0 19) (- 0 21)) (M0.Expression.exprLiteral_q |fun#0@@4|)) (=> (M0.Expression.exprLiteral_q |fun#0@@4|) (and (=> (= (ControlFlow 0 19) (- 0 20)) (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|))) (=> (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|)) (=> (= (ControlFlow 0 19) 18) anon18_correct))))))))
(let ((anon27_Else_correct  (=> (not (M0.Expression.exprLiteral_q |fun#0@@4|)) (and (=> (= (ControlFlow 0 25) 19) anon28_Then_correct) (=> (= (ControlFlow 0 25) 22) anon28_Else_correct)))))
(let ((anon27_Then_correct  (=> (M0.Expression.exprLiteral_q |fun#0@@4|) (and (=> (= (ControlFlow 0 23) (- 0 24)) (M0.Expression.exprLiteral_q |fun#0@@4|)) (=> (M0.Expression.exprLiteral_q |fun#0@@4|) (and (=> (= (ControlFlow 0 23) 19) anon28_Then_correct) (=> (= (ControlFlow 0 23) 22) anon28_Else_correct)))))))
(let ((anon14_correct  (=> (and (and (|$IsA#M0.Tuple| |pC#0|) (|$IsA#M0.Tuple| (ite  (and (M0.Expression.exprLiteral_q |fun#0@@4|) (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|))) (ite (M0.Primitive.primExec_q (M0.Literal.prim (M0.Expression.lit |fun#0@@4|))) (M0.__default.evalCore |stC#0@@7| |stCombinedC#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true)))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |stC#0@@7|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |stC#0@@7|)))) (=> (and (M0.Expression.exprLiteral_q |fun#0@@4|) (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|))) (=> (M0.Primitive.primExec_q (M0.Literal.prim (M0.Expression.lit |fun#0@@4|))) (|M0.__default.evalCore#canCall| |stC#0@@7| |stCombinedC#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 26) (- 0 27)) (|M0.Tuple#Equal| |pC#0| (ite  (and (M0.Expression.exprLiteral_q |fun#0@@4|) (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|))) (ite (M0.Primitive.primExec_q (M0.Literal.prim (M0.Expression.lit |fun#0@@4|))) (M0.__default.evalCore |stC#0@@7| |stCombinedC#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true)))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |stC#0@@7|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |stC#0@@7|)))) (=> (|M0.Tuple#Equal| |pC#0| (ite  (and (M0.Expression.exprLiteral_q |fun#0@@4|) (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|))) (ite (M0.Primitive.primExec_q (M0.Literal.prim (M0.Expression.lit |fun#0@@4|))) (M0.__default.evalCore |stC#0@@7| |stCombinedC#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true)))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |stC#0@@7|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |stC#0@@7|))) (and (=> (= (ControlFlow 0 26) 23) anon27_Then_correct) (=> (= (ControlFlow 0 26) 25) anon27_Else_correct)))))))
(let ((anon26_Else_correct  (=> (and (not (M0.Primitive.primExec_q (M0.Literal.prim (M0.Expression.lit |fun#0@@4|)))) (= (ControlFlow 0 31) 26)) anon14_correct)))
(let ((anon26_Then_correct  (=> (and (M0.Primitive.primExec_q (M0.Literal.prim (M0.Expression.lit |fun#0@@4|))) ($IsAllocBox |stC#0@@7| Tclass.M0.State $Heap@2)) (and (=> (= (ControlFlow 0 29) (- 0 30)) true) (=> ($IsAllocBox |stCombinedC#0@0| Tclass.M0.State $Heap@2) (=> (and ($IsAlloc SeqType |args#0@@12| (TSeq Tclass.M0.Expression) $Heap@2) (= |##useCache#7@0| (U_2_bool (Lit boolType (bool_2_U true))))) (=> (and (and ($IsAlloc boolType (bool_2_U |##useCache#7@0|) TBool $Heap@2) (|M0.__default.evalCore#canCall| |stC#0@@7| |stCombinedC#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true))))) (and (M0.Tuple.Pair_q (M0.__default.evalCore |stC#0@@7| |stCombinedC#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true))))) (= (ControlFlow 0 29) 26))) anon14_correct)))))))
(let ((anon25_Then_correct  (=> (and (M0.Expression.exprLiteral_q |fun#0@@4|) (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|))) (and (=> (= (ControlFlow 0 32) (- 0 34)) (M0.Expression.exprLiteral_q |fun#0@@4|)) (=> (M0.Expression.exprLiteral_q |fun#0@@4|) (and (=> (= (ControlFlow 0 32) (- 0 33)) (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|))) (=> (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|)) (and (=> (= (ControlFlow 0 32) 29) anon26_Then_correct) (=> (= (ControlFlow 0 32) 31) anon26_Else_correct)))))))))
(let ((anon25_Else_correct  (=> (and (not (and (M0.Expression.exprLiteral_q |fun#0@@4|) (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|)))) (= (ControlFlow 0 28) 26)) anon14_correct)))
(let ((anon24_Else_correct  (=> (not (M0.Expression.exprLiteral_q |fun#0@@4|)) (and (=> (= (ControlFlow 0 37) 32) anon25_Then_correct) (=> (= (ControlFlow 0 37) 28) anon25_Else_correct)))))
(let ((anon24_Then_correct  (=> (M0.Expression.exprLiteral_q |fun#0@@4|) (and (=> (= (ControlFlow 0 35) (- 0 36)) (M0.Expression.exprLiteral_q |fun#0@@4|)) (=> (M0.Expression.exprLiteral_q |fun#0@@4|) (and (=> (= (ControlFlow 0 35) 32) anon25_Then_correct) (=> (= (ControlFlow 0 35) 28) anon25_Else_correct)))))))
(let ((anon7_correct  (=> (and (and (|$IsA#M0.Tuple| |p#0@@17|) (|$IsA#M0.Tuple| (ite  (and (M0.Expression.exprLiteral_q |fun#0@@4|) (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|))) (ite (M0.Primitive.primExec_q (M0.Literal.prim (M0.Expression.lit |fun#0@@4|))) (M0.__default.evalCore |st#0@@25| |stCombined#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@25|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@25|)))) (=> (and (M0.Expression.exprLiteral_q |fun#0@@4|) (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|))) (=> (M0.Primitive.primExec_q (M0.Literal.prim (M0.Expression.lit |fun#0@@4|))) (|M0.__default.evalCore#canCall| |st#0@@25| |stCombined#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false))))))) (and (=> (= (ControlFlow 0 38) (- 0 39)) (|M0.Tuple#Equal| |p#0@@17| (ite  (and (M0.Expression.exprLiteral_q |fun#0@@4|) (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|))) (ite (M0.Primitive.primExec_q (M0.Literal.prim (M0.Expression.lit |fun#0@@4|))) (M0.__default.evalCore |st#0@@25| |stCombined#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@25|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@25|)))) (=> (|M0.Tuple#Equal| |p#0@@17| (ite  (and (M0.Expression.exprLiteral_q |fun#0@@4|) (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|))) (ite (M0.Primitive.primExec_q (M0.Literal.prim (M0.Expression.lit |fun#0@@4|))) (M0.__default.evalCore |st#0@@25| |stCombined#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@25|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@25|))) (and (=> (= (ControlFlow 0 38) 35) anon24_Then_correct) (=> (= (ControlFlow 0 38) 37) anon24_Else_correct)))))))
(let ((anon23_Else_correct  (=> (and (not (M0.Primitive.primExec_q (M0.Literal.prim (M0.Expression.lit |fun#0@@4|)))) (= (ControlFlow 0 43) 38)) anon7_correct)))
(let ((anon23_Then_correct  (=> (and (M0.Primitive.primExec_q (M0.Literal.prim (M0.Expression.lit |fun#0@@4|))) ($IsAllocBox |st#0@@25| Tclass.M0.State $Heap@2)) (and (=> (= (ControlFlow 0 41) (- 0 42)) true) (=> ($IsAllocBox |stCombined#0@0| Tclass.M0.State $Heap@2) (=> (and ($IsAlloc SeqType |args#0@@12| (TSeq Tclass.M0.Expression) $Heap@2) (= |##useCache#6@0| (U_2_bool (Lit boolType (bool_2_U false))))) (=> (and (and ($IsAlloc boolType (bool_2_U |##useCache#6@0|) TBool $Heap@2) (|M0.__default.evalCore#canCall| |st#0@@25| |stCombined#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false))))) (and (M0.Tuple.Pair_q (M0.__default.evalCore |st#0@@25| |stCombined#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false))))) (= (ControlFlow 0 41) 38))) anon7_correct)))))))
(let ((anon22_Then_correct  (=> (and (M0.Expression.exprLiteral_q |fun#0@@4|) (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|))) (and (=> (= (ControlFlow 0 44) (- 0 46)) (M0.Expression.exprLiteral_q |fun#0@@4|)) (=> (M0.Expression.exprLiteral_q |fun#0@@4|) (and (=> (= (ControlFlow 0 44) (- 0 45)) (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|))) (=> (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|)) (and (=> (= (ControlFlow 0 44) 41) anon23_Then_correct) (=> (= (ControlFlow 0 44) 43) anon23_Else_correct)))))))))
(let ((anon22_Else_correct  (=> (and (not (and (M0.Expression.exprLiteral_q |fun#0@@4|) (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|)))) (= (ControlFlow 0 40) 38)) anon7_correct)))
(let ((anon21_Else_correct  (=> (not (M0.Expression.exprLiteral_q |fun#0@@4|)) (and (=> (= (ControlFlow 0 49) 44) anon22_Then_correct) (=> (= (ControlFlow 0 49) 40) anon22_Else_correct)))))
(let ((anon21_Then_correct  (=> (M0.Expression.exprLiteral_q |fun#0@@4|) (and (=> (= (ControlFlow 0 47) (- 0 48)) (M0.Expression.exprLiteral_q |fun#0@@4|)) (=> (M0.Expression.exprLiteral_q |fun#0@@4|) (and (=> (= (ControlFlow 0 47) 44) anon22_Then_correct) (=> (= (ControlFlow 0 47) 40) anon22_Else_correct)))))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@8 alloc false)) (|$IsA#M0.Tuple| |p#0@@17|)) (and (|$IsA#M0.Tuple| |pC#0|) (|$IsA#M0.Expression| |fun#0@@4|))) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@8 $Heap@0)) (and (forall ((|$ih#sts''0#0| T@U) (|$ih#stsC''0#0| T@U) ) (!  (=> (and (and (and ($Is SetType |$ih#sts''0#0| (TSet Tclass.M0.State)) ($Is SetType |$ih#stsC''0#0| (TSet Tclass.M0.State))) (and (and (and (and (and (and (and (and (not (|Set#Equal| |$ih#sts''0#0| |Set#Empty|)) (M0.__default.Compatible |$ih#sts''0#0|)) (and (not (|Set#Equal| |$ih#stsC''0#0| |Set#Empty|)) (M0.__default.Compatible |$ih#stsC''0#0|))) (|M0.Tuple#Equal| |p#0@@17| (M0.__default.evalCompatCheckCore |st#0@@25| |$ih#sts''0#0| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))))) (|M0.Tuple#Equal| |pC#0| (M0.__default.evalCompatCheckCore |stC#0@@7| |$ih#stsC''0#0| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true)))))) (forall ((|s#4| T@U) ) (!  (=> ($IsBox |s#4| Tclass.M0.State) (and (=> (|Set#IsMember| |$ih#sts''0#0| |s#4|) (M0.__default.ValidState |s#4|)) (=> (|Set#IsMember| |$ih#sts''0#0| |s#4|) (M0.__default.Extends reveal_M0._default.Extends |st#0@@25| |s#4|))))
 :qid |CloudMakeCachedBuildsdfy.911:21|
 :skolemid |1584|
 :pattern ( (M0.__default.Extends reveal_M0._default.Extends |st#0@@25| |s#4|))
 :pattern ( (M0.__default.ValidState |s#4|))
 :pattern ( (|Set#IsMember| |$ih#sts''0#0| |s#4|))
))) (forall ((|s#5| T@U) ) (!  (=> ($IsBox |s#5| Tclass.M0.State) (and (and (=> (|Set#IsMember| |$ih#stsC''0#0| |s#5|) (M0.__default.ValidState |s#5|)) (=> (|Set#IsMember| |$ih#stsC''0#0| |s#5|) (M0.__default.Extends reveal_M0._default.Extends |stC#0@@7| |s#5|))) (=> (|Set#IsMember| |$ih#stsC''0#0| |s#5|) (M0.__default.ConsistentCache |s#5|))))
 :qid |CloudMakeCachedBuildsdfy.912:21|
 :skolemid |1585|
 :pattern ( (M0.__default.ConsistentCache |s#5|))
 :pattern ( (M0.__default.Extends reveal_M0._default.Extends |stC#0@@7| |s#5|))
 :pattern ( (M0.__default.ValidState |s#5|))
 :pattern ( (|Set#IsMember| |$ih#stsC''0#0| |s#5|))
))) (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence |st#0@@25| |stC#0@@7|)) (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |$ih#sts''0#0| (U_2_bool (Lit boolType (bool_2_U false)))) (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |$ih#stsC''0#0| (U_2_bool (Lit boolType (bool_2_U true))))))) (or (< (DtRank |p#0@@17|) (DtRank |p#0@@17|)) (and (= (DtRank |p#0@@17|) (DtRank |p#0@@17|)) (or (and (|Set#Subset| |$ih#sts''0#0| |sts''#0|) (not (|Set#Subset| |sts''#0| |$ih#sts''0#0|))) (and (|Set#Equal| |$ih#sts''0#0| |sts''#0|) (or (< (DtRank |pC#0|) (DtRank |pC#0|)) (and (= (DtRank |pC#0|) (DtRank |pC#0|)) (or (and (|Set#Subset| |$ih#stsC''0#0| |stsC''#0|) (not (|Set#Subset| |stsC''#0| |$ih#stsC''0#0|))) (and (|Set#Equal| |$ih#stsC''0#0| |stsC''#0|) (or (< (DtRank |fun#0@@4|) (DtRank |fun#0@@4|)) (and (= (DtRank |fun#0@@4|) (DtRank |fun#0@@4|)) (< (|Seq#Rank| |args#0@@12|) (|Seq#Rank| |args#0@@12|))))))))))))) (|M0.Expression#Equal| ($Unbox DatatypeTypeType (M0.Tuple.fst |p#0@@17|)) ($Unbox DatatypeTypeType (M0.Tuple.fst |pC#0|))))
 :qid |CloudMakeCachedBuildsdfy.904:62|
 :skolemid |1586|
 :pattern ( (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |$ih#stsC''0#0| (U_2_bool (Lit boolType (bool_2_U true)))) (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |$ih#sts''0#0| (U_2_bool (Lit boolType (bool_2_U false)))))
 :pattern ( (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |$ih#stsC''0#0| (U_2_bool (Lit boolType (bool_2_U true)))) (M0.__default.evalCompatCheckCore |st#0@@25| |$ih#sts''0#0| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))))
 :pattern ( (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |$ih#stsC''0#0| (U_2_bool (Lit boolType (bool_2_U true)))) (M0.__default.Compatible |$ih#sts''0#0|))
 :pattern ( (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |$ih#sts''0#0| (U_2_bool (Lit boolType (bool_2_U false)))) (M0.__default.evalCompatCheckCore |stC#0@@7| |$ih#stsC''0#0| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true)))))
 :pattern ( (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |$ih#sts''0#0| (U_2_bool (Lit boolType (bool_2_U false)))) (M0.__default.Compatible |$ih#stsC''0#0|))
 :pattern ( (M0.__default.evalCompatCheckCore |stC#0@@7| |$ih#stsC''0#0| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true)))) (M0.__default.evalCompatCheckCore |st#0@@25| |$ih#sts''0#0| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))))
 :pattern ( (M0.__default.evalCompatCheckCore |stC#0@@7| |$ih#stsC''0#0| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true)))) (M0.__default.Compatible |$ih#sts''0#0|))
 :pattern ( (M0.__default.evalCompatCheckCore |st#0@@25| |$ih#sts''0#0| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))) (M0.__default.Compatible |$ih#stsC''0#0|))
 :pattern ( (M0.__default.Compatible |$ih#stsC''0#0|) (M0.__default.Compatible |$ih#sts''0#0|))
)) (M0.Tuple.Pair_q |p#0@@17|))) (and (and (and (M0.Tuple.Pair_q |p#0@@17|) (= |$rhs#0@0| ($Unbox DatatypeTypeType (M0.Tuple.fst |p#0@@17|)))) (and (M0.Tuple.Pair_q |pC#0|) (M0.Tuple.Pair_q |pC#0|))) (and (and (= |$rhs#1@0| ($Unbox DatatypeTypeType (M0.Tuple.fst |pC#0|))) ($IsAlloc SetType |sts''#0| (TSet Tclass.M0.State) $Heap@0)) (and (= |##useCache#4@0| (U_2_bool (Lit boolType (bool_2_U false)))) ($IsAlloc boolType (bool_2_U |##useCache#4@0|) TBool $Heap@0))))) (and (=> (= (ControlFlow 0 50) (- 0 63)) (not (|Set#Equal| |sts''#0| |Set#Empty|))) (=> (not (|Set#Equal| |sts''#0| |Set#Empty|)) (=> (and (and (|M0.__default.Combine#canCall| |sts''#0| (U_2_bool (Lit boolType (bool_2_U false)))) (|M0.__default.Combine#canCall| |sts''#0| (U_2_bool (Lit boolType (bool_2_U false))))) (and (= |stCombined#0@0| (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |sts''#0| (U_2_bool (Lit boolType (bool_2_U false))))) (= |useCache##0@0| (U_2_bool (Lit boolType (bool_2_U false)))))) (and (=> (= (ControlFlow 0 50) (- 0 62)) (not (|Set#Equal| |sts''#0| |Set#Empty|))) (=> (not (|Set#Equal| |sts''#0| |Set#Empty|)) (and (=> (= (ControlFlow 0 50) (- 0 61)) (forall ((|st#1@@3| T@U) ) (!  (=> ($IsBox |st#1@@3| Tclass.M0.State) (and (=> (|Set#IsMember| |sts''#0| |st#1@@3|) (M0.__default.ValidState |st#1@@3|)) (=> (|Set#IsMember| |sts''#0| |st#1@@3|) (M0.__default.Extends reveal_M0._default.Extends |st#0@@25| |st#1@@3|))))
 :qid |CloudMakeCachedBuildsdfy.82:15|
 :skolemid |800|
 :pattern ( (M0.__default.Extends reveal_M0._default.Extends |st#0@@25| |st#1@@3|))
 :pattern ( (M0.__default.ValidState |st#1@@3|))
 :pattern ( (|Set#IsMember| |sts''#0| |st#1@@3|))
))) (=> (forall ((|st#1@@4| T@U) ) (!  (=> ($IsBox |st#1@@4| Tclass.M0.State) (and (=> (|Set#IsMember| |sts''#0| |st#1@@4|) (M0.__default.ValidState |st#1@@4|)) (=> (|Set#IsMember| |sts''#0| |st#1@@4|) (M0.__default.Extends reveal_M0._default.Extends |st#0@@25| |st#1@@4|))))
 :qid |CloudMakeCachedBuildsdfy.82:15|
 :skolemid |800|
 :pattern ( (M0.__default.Extends reveal_M0._default.Extends |st#0@@25| |st#1@@4|))
 :pattern ( (M0.__default.ValidState |st#1@@4|))
 :pattern ( (|Set#IsMember| |sts''#0| |st#1@@4|))
)) (and (=> (= (ControlFlow 0 50) (- 0 60)) (=> |useCache##0@0| (forall ((|st#3| T@U) ) (!  (=> ($IsBox |st#3| Tclass.M0.State) (=> (|Set#IsMember| |sts''#0| |st#3|) (M0.__default.ConsistentCache |st#3|)))
 :qid |CloudMakeCachedBuildsdfy.83:28|
 :skolemid |801|
 :pattern ( (M0.__default.ConsistentCache |st#3|))
 :pattern ( (|Set#IsMember| |sts''#0| |st#3|))
)))) (=> (=> |useCache##0@0| (forall ((|st#3@@0| T@U) ) (!  (=> ($IsBox |st#3@@0| Tclass.M0.State) (=> (|Set#IsMember| |sts''#0| |st#3@@0|) (M0.__default.ConsistentCache |st#3@@0|)))
 :qid |CloudMakeCachedBuildsdfy.83:28|
 :skolemid |801|
 :pattern ( (M0.__default.ConsistentCache |st#3@@0|))
 :pattern ( (|Set#IsMember| |sts''#0| |st#3@@0|))
))) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (|M0.__default.Combine#canCall| |sts''#0| |useCache##0@0|) (let ((|stCombined#0@@7| (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |sts''#0| |useCache##0@0|)))
 (and (|M0.__default.ValidState#canCall| |stCombined#0@@7|) (=> (M0.__default.ValidState |stCombined#0@@7|) (and (|M0.__default.Extends#canCall| |st#0@@25| |stCombined#0@@7|) (=> (M0.__default.Extends reveal_M0._default.Extends |st#0@@25| |stCombined#0@@7|) (=> |useCache##0@0| (and (|M0.__default.ConsistentCache#canCall| |stCombined#0@@7|) (=> (M0.__default.ConsistentCache |stCombined#0@@7|) (and (forall ((|st#7| T@U) ) (!  (=> ($IsBox |st#7| Tclass.M0.State) (=> (|Set#IsMember| |sts''#0| |st#7|) (and (|M0.__default.DomC#canCall| |st#7|) (|M0.__default.DomC#canCall| |stCombined#0@@7|))))
 :qid |CloudMakeCachedBuildsdfy.89:17|
 :skolemid |802|
 :pattern ( (M0.__default.DomC |st#7|))
 :pattern ( (|Set#IsMember| |sts''#0| |st#7|))
)) (=> (forall ((|st#7@@0| T@U) ) (!  (=> ($IsBox |st#7@@0| Tclass.M0.State) (=> (|Set#IsMember| |sts''#0| |st#7@@0|) (|Set#Subset| (M0.__default.DomC |st#7@@0|) (M0.__default.DomC |stCombined#0@@7|))))
 :qid |CloudMakeCachedBuildsdfy.89:17|
 :skolemid |805|
 :pattern ( (M0.__default.DomC |st#7@@0|))
 :pattern ( (|Set#IsMember| |sts''#0| |st#7@@0|))
)) (forall ((|h#1| T@U) ) (!  (=> ($IsBox |h#1| Tclass.M0.HashValue) (and (|M0.__default.DomC#canCall| |stCombined#0@@7|) (=> (|Set#IsMember| (M0.__default.DomC |stCombined#0@@7|) |h#1|) (forall ((|st#8| T@U) ) (!  (=> ($IsBox |st#8| Tclass.M0.State) (=> (|Set#IsMember| |sts''#0| |st#8|) (|M0.__default.DomC#canCall| |st#8|)))
 :qid |CloudMakeCachedBuildsdfy.90:55|
 :skolemid |803|
 :pattern ( (M0.__default.DomC |st#8|))
 :pattern ( (|Set#IsMember| |sts''#0| |st#8|))
)))))
 :qid |CloudMakeCachedBuildsdfy.90:17|
 :skolemid |804|
 :pattern ( (|Set#IsMember| (M0.__default.DomC |stCombined#0@@7|) |h#1|))
))))))))))))) (let ((|stCombined#0@@8| (M0.__default.Combine ($LS ($LS $LZ)) reveal_M0._default.Combine |sts''#0| |useCache##0@0|)))
 (and (|M0.__default.ValidState#canCall| |stCombined#0@@8|) (and (M0.__default.ValidState |stCombined#0@@8|) (forall ((|p#0@@18| T@U) ) (!  (=> ($IsBox |p#0@@18| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |stCombined#0@@8|) |p#0@@18|) (M0.__default.WellFounded |p#0@@18|)))
 :qid |CloudMakeCachedBuildsdfy.35:12|
 :skolemid |807|
 :pattern ( (M0.__default.WellFounded |p#0@@18|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |stCombined#0@@8|) |p#0@@18|))
)))))) (=> (and (and (and (let ((|stCombined#0@@9| (M0.__default.Combine ($LS ($LS $LZ)) reveal_M0._default.Combine |sts''#0| |useCache##0@0|)))
(M0.__default.Extends reveal_M0._default.Extends |st#0@@25| |stCombined#0@@9|)) (let ((|stCombined#0@@10| (M0.__default.Combine ($LS ($LS $LZ)) reveal_M0._default.Combine |sts''#0| |useCache##0@0|)))
 (=> |useCache##0@0| (and (|M0.__default.ConsistentCache#canCall| |stCombined#0@@10|) (and (M0.__default.ConsistentCache |stCombined#0@@10|) (forall ((|cmd#0@@16| T@U) (|deps#0@@16| T@U) (|e#0@@10| T@U) ) (!  (=> (and (and ($Is SeqType |cmd#0@@16| (TSeq TChar)) ($Is SetType |deps#0@@16| (TSet Tclass.M0.Path))) ($Is SeqType |e#0@@10| (TSeq TChar))) (=> (|Set#IsMember| (M0.__default.DomC |stCombined#0@@10|) (M0.__default.Hash (M0.__default.Loc |cmd#0@@16| |deps#0@@16| |e#0@@10|))) (|Set#IsMember| (M0.__default.DomSt |stCombined#0@@10|) (M0.__default.Loc |cmd#0@@16| |deps#0@@16| |e#0@@10|))))
 :qid |CloudMakeCachedBuildsdfy.116:12|
 :skolemid |809|
 :pattern ( (M0.__default.Loc |cmd#0@@16| |deps#0@@16| |e#0@@10|))
))))))) (and (let ((|stCombined#0@@11| (M0.__default.Combine ($LS ($LS $LZ)) reveal_M0._default.Combine |sts''#0| |useCache##0@0|)))
 (=> |useCache##0@0| (forall ((|st#7@@1| T@U) ) (!  (=> ($IsBox |st#7@@1| Tclass.M0.State) (=> (|Set#IsMember| |sts''#0| |st#7@@1|) (|Set#Subset| (M0.__default.DomC |st#7@@1|) (M0.__default.DomC |stCombined#0@@11|))))
 :qid |CloudMakeCachedBuildsdfy.89:17|
 :skolemid |810|
 :pattern ( (M0.__default.DomC |st#7@@1|))
 :pattern ( (|Set#IsMember| |sts''#0| |st#7@@1|))
)))) (let ((|stCombined#0@@12| (M0.__default.Combine ($LS ($LS $LZ)) reveal_M0._default.Combine |sts''#0| |useCache##0@0|)))
 (=> |useCache##0@0| (forall ((|h#1@@0| T@U) ) (!  (=> ($IsBox |h#1@@0| Tclass.M0.HashValue) (=> (|Set#IsMember| (M0.__default.DomC |stCombined#0@@12|) |h#1@@0|) (exists ((|st#8@@0| T@U) ) (!  (and ($IsBox |st#8@@0| Tclass.M0.State) (and (|Set#IsMember| |sts''#0| |st#8@@0|) (|Set#IsMember| (M0.__default.DomC |st#8@@0|) |h#1@@0|)))
 :qid |CloudMakeCachedBuildsdfy.90:55|
 :skolemid |811|
 :pattern ( (M0.__default.DomC |st#8@@0|))
 :pattern ( (|Set#IsMember| |sts''#0| |st#8@@0|))
))))
 :qid |CloudMakeCachedBuildsdfy.90:17|
 :skolemid |812|
 :pattern ( (|Set#IsMember| (M0.__default.DomC |stCombined#0@@12|) |h#1@@0|))
)))))) (and (and (= $Heap@0 $Heap@1) ($IsAlloc SetType |stsC''#0| (TSet Tclass.M0.State) $Heap@1)) (and (= |##useCache#5@0| (U_2_bool (Lit boolType (bool_2_U true)))) ($IsAlloc boolType (bool_2_U |##useCache#5@0|) TBool $Heap@1)))) (and (=> (= (ControlFlow 0 50) (- 0 59)) (not (|Set#Equal| |stsC''#0| |Set#Empty|))) (=> (not (|Set#Equal| |stsC''#0| |Set#Empty|)) (=> (and (and (|M0.__default.Combine#canCall| |stsC''#0| (U_2_bool (Lit boolType (bool_2_U true)))) (|M0.__default.Combine#canCall| |stsC''#0| (U_2_bool (Lit boolType (bool_2_U true))))) (and (= |stCombinedC#0@0| (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |stsC''#0| (U_2_bool (Lit boolType (bool_2_U true))))) (= |useCache##1@0| (U_2_bool (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 50) (- 0 58)) (not (|Set#Equal| |stsC''#0| |Set#Empty|))) (=> (not (|Set#Equal| |stsC''#0| |Set#Empty|)) (and (=> (= (ControlFlow 0 50) (- 0 57)) (forall ((|st#1@@5| T@U) ) (!  (=> ($IsBox |st#1@@5| Tclass.M0.State) (and (=> (|Set#IsMember| |stsC''#0| |st#1@@5|) (M0.__default.ValidState |st#1@@5|)) (=> (|Set#IsMember| |stsC''#0| |st#1@@5|) (M0.__default.Extends reveal_M0._default.Extends |stC#0@@7| |st#1@@5|))))
 :qid |CloudMakeCachedBuildsdfy.82:15|
 :skolemid |800|
 :pattern ( (M0.__default.Extends reveal_M0._default.Extends |stC#0@@7| |st#1@@5|))
 :pattern ( (M0.__default.ValidState |st#1@@5|))
 :pattern ( (|Set#IsMember| |stsC''#0| |st#1@@5|))
))) (=> (forall ((|st#1@@6| T@U) ) (!  (=> ($IsBox |st#1@@6| Tclass.M0.State) (and (=> (|Set#IsMember| |stsC''#0| |st#1@@6|) (M0.__default.ValidState |st#1@@6|)) (=> (|Set#IsMember| |stsC''#0| |st#1@@6|) (M0.__default.Extends reveal_M0._default.Extends |stC#0@@7| |st#1@@6|))))
 :qid |CloudMakeCachedBuildsdfy.82:15|
 :skolemid |800|
 :pattern ( (M0.__default.Extends reveal_M0._default.Extends |stC#0@@7| |st#1@@6|))
 :pattern ( (M0.__default.ValidState |st#1@@6|))
 :pattern ( (|Set#IsMember| |stsC''#0| |st#1@@6|))
)) (and (=> (= (ControlFlow 0 50) (- 0 56)) (=> |useCache##1@0| (forall ((|st#3@@1| T@U) ) (!  (=> ($IsBox |st#3@@1| Tclass.M0.State) (=> (|Set#IsMember| |stsC''#0| |st#3@@1|) (M0.__default.ConsistentCache |st#3@@1|)))
 :qid |CloudMakeCachedBuildsdfy.83:28|
 :skolemid |801|
 :pattern ( (M0.__default.ConsistentCache |st#3@@1|))
 :pattern ( (|Set#IsMember| |stsC''#0| |st#3@@1|))
)))) (=> (=> |useCache##1@0| (forall ((|st#3@@2| T@U) ) (!  (=> ($IsBox |st#3@@2| Tclass.M0.State) (=> (|Set#IsMember| |stsC''#0| |st#3@@2|) (M0.__default.ConsistentCache |st#3@@2|)))
 :qid |CloudMakeCachedBuildsdfy.83:28|
 :skolemid |801|
 :pattern ( (M0.__default.ConsistentCache |st#3@@2|))
 :pattern ( (|Set#IsMember| |stsC''#0| |st#3@@2|))
))) (=> (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (=> (and (and (and (|M0.__default.Combine#canCall| |stsC''#0| |useCache##1@0|) (let ((|stCombined#0@@13| (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |stsC''#0| |useCache##1@0|)))
 (and (|M0.__default.ValidState#canCall| |stCombined#0@@13|) (=> (M0.__default.ValidState |stCombined#0@@13|) (and (|M0.__default.Extends#canCall| |stC#0@@7| |stCombined#0@@13|) (=> (M0.__default.Extends reveal_M0._default.Extends |stC#0@@7| |stCombined#0@@13|) (=> |useCache##1@0| (and (|M0.__default.ConsistentCache#canCall| |stCombined#0@@13|) (=> (M0.__default.ConsistentCache |stCombined#0@@13|) (and (forall ((|st#7@@2| T@U) ) (!  (=> ($IsBox |st#7@@2| Tclass.M0.State) (=> (|Set#IsMember| |stsC''#0| |st#7@@2|) (and (|M0.__default.DomC#canCall| |st#7@@2|) (|M0.__default.DomC#canCall| |stCombined#0@@13|))))
 :qid |CloudMakeCachedBuildsdfy.89:17|
 :skolemid |802|
 :pattern ( (M0.__default.DomC |st#7@@2|))
 :pattern ( (|Set#IsMember| |stsC''#0| |st#7@@2|))
)) (=> (forall ((|st#7@@3| T@U) ) (!  (=> ($IsBox |st#7@@3| Tclass.M0.State) (=> (|Set#IsMember| |stsC''#0| |st#7@@3|) (|Set#Subset| (M0.__default.DomC |st#7@@3|) (M0.__default.DomC |stCombined#0@@13|))))
 :qid |CloudMakeCachedBuildsdfy.89:17|
 :skolemid |805|
 :pattern ( (M0.__default.DomC |st#7@@3|))
 :pattern ( (|Set#IsMember| |stsC''#0| |st#7@@3|))
)) (forall ((|h#1@@1| T@U) ) (!  (=> ($IsBox |h#1@@1| Tclass.M0.HashValue) (and (|M0.__default.DomC#canCall| |stCombined#0@@13|) (=> (|Set#IsMember| (M0.__default.DomC |stCombined#0@@13|) |h#1@@1|) (forall ((|st#8@@1| T@U) ) (!  (=> ($IsBox |st#8@@1| Tclass.M0.State) (=> (|Set#IsMember| |stsC''#0| |st#8@@1|) (|M0.__default.DomC#canCall| |st#8@@1|)))
 :qid |CloudMakeCachedBuildsdfy.90:55|
 :skolemid |803|
 :pattern ( (M0.__default.DomC |st#8@@1|))
 :pattern ( (|Set#IsMember| |stsC''#0| |st#8@@1|))
)))))
 :qid |CloudMakeCachedBuildsdfy.90:17|
 :skolemid |804|
 :pattern ( (|Set#IsMember| (M0.__default.DomC |stCombined#0@@13|) |h#1@@1|))
))))))))))))) (and (let ((|stCombined#0@@14| (M0.__default.Combine ($LS ($LS $LZ)) reveal_M0._default.Combine |stsC''#0| |useCache##1@0|)))
 (and (|M0.__default.ValidState#canCall| |stCombined#0@@14|) (and (M0.__default.ValidState |stCombined#0@@14|) (forall ((|p#0@@19| T@U) ) (!  (=> ($IsBox |p#0@@19| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |stCombined#0@@14|) |p#0@@19|) (M0.__default.WellFounded |p#0@@19|)))
 :qid |CloudMakeCachedBuildsdfy.35:12|
 :skolemid |807|
 :pattern ( (M0.__default.WellFounded |p#0@@19|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |stCombined#0@@14|) |p#0@@19|))
))))) (let ((|stCombined#0@@15| (M0.__default.Combine ($LS ($LS $LZ)) reveal_M0._default.Combine |stsC''#0| |useCache##1@0|)))
(M0.__default.Extends reveal_M0._default.Extends |stC#0@@7| |stCombined#0@@15|)))) (and (and (let ((|stCombined#0@@16| (M0.__default.Combine ($LS ($LS $LZ)) reveal_M0._default.Combine |stsC''#0| |useCache##1@0|)))
 (=> |useCache##1@0| (and (|M0.__default.ConsistentCache#canCall| |stCombined#0@@16|) (and (M0.__default.ConsistentCache |stCombined#0@@16|) (forall ((|cmd#0@@17| T@U) (|deps#0@@17| T@U) (|e#0@@11| T@U) ) (!  (=> (and (and ($Is SeqType |cmd#0@@17| (TSeq TChar)) ($Is SetType |deps#0@@17| (TSet Tclass.M0.Path))) ($Is SeqType |e#0@@11| (TSeq TChar))) (=> (|Set#IsMember| (M0.__default.DomC |stCombined#0@@16|) (M0.__default.Hash (M0.__default.Loc |cmd#0@@17| |deps#0@@17| |e#0@@11|))) (|Set#IsMember| (M0.__default.DomSt |stCombined#0@@16|) (M0.__default.Loc |cmd#0@@17| |deps#0@@17| |e#0@@11|))))
 :qid |CloudMakeCachedBuildsdfy.116:12|
 :skolemid |809|
 :pattern ( (M0.__default.Loc |cmd#0@@17| |deps#0@@17| |e#0@@11|))
)))))) (let ((|stCombined#0@@17| (M0.__default.Combine ($LS ($LS $LZ)) reveal_M0._default.Combine |stsC''#0| |useCache##1@0|)))
 (=> |useCache##1@0| (forall ((|st#7@@4| T@U) ) (!  (=> ($IsBox |st#7@@4| Tclass.M0.State) (=> (|Set#IsMember| |stsC''#0| |st#7@@4|) (|Set#Subset| (M0.__default.DomC |st#7@@4|) (M0.__default.DomC |stCombined#0@@17|))))
 :qid |CloudMakeCachedBuildsdfy.89:17|
 :skolemid |810|
 :pattern ( (M0.__default.DomC |st#7@@4|))
 :pattern ( (|Set#IsMember| |stsC''#0| |st#7@@4|))
))))) (and (let ((|stCombined#0@@18| (M0.__default.Combine ($LS ($LS $LZ)) reveal_M0._default.Combine |stsC''#0| |useCache##1@0|)))
 (=> |useCache##1@0| (forall ((|h#1@@2| T@U) ) (!  (=> ($IsBox |h#1@@2| Tclass.M0.HashValue) (=> (|Set#IsMember| (M0.__default.DomC |stCombined#0@@18|) |h#1@@2|) (exists ((|st#8@@2| T@U) ) (!  (and ($IsBox |st#8@@2| Tclass.M0.State) (and (|Set#IsMember| |stsC''#0| |st#8@@2|) (|Set#IsMember| (M0.__default.DomC |st#8@@2|) |h#1@@2|)))
 :qid |CloudMakeCachedBuildsdfy.90:55|
 :skolemid |811|
 :pattern ( (M0.__default.DomC |st#8@@2|))
 :pattern ( (|Set#IsMember| |stsC''#0| |st#8@@2|))
))))
 :qid |CloudMakeCachedBuildsdfy.90:17|
 :skolemid |812|
 :pattern ( (|Set#IsMember| (M0.__default.DomC |stCombined#0@@18|) |h#1@@2|))
)))) (= $Heap@1 $Heap@2)))) (and (=> (= (ControlFlow 0 50) (- 0 55)) true) (=> ($IsAllocBox |stCombinedC#0@0| Tclass.M0.State $Heap@2) (=> (and (|M0.__default.ConsistentCache#canCall| |stCombinedC#0@0|) (|M0.__default.ConsistentCache#canCall| |stCombinedC#0@0|)) (and (=> (= (ControlFlow 0 50) (- 0 54)) (=> (|M0.__default.ConsistentCache#canCall| |stCombinedC#0@0|) (or (M0.__default.ConsistentCache |stCombinedC#0@0|) (forall ((|cmd#0@@18| T@U) (|deps#0@@18| T@U) (|e#0@@12| T@U) ) (!  (=> (and (and ($Is SeqType |cmd#0@@18| (TSeq TChar)) ($Is SetType |deps#0@@18| (TSet Tclass.M0.Path))) ($Is SeqType |e#0@@12| (TSeq TChar))) (=> (|Set#IsMember| (M0.__default.DomC |stCombinedC#0@0|) (M0.__default.Hash (M0.__default.Loc |cmd#0@@18| |deps#0@@18| |e#0@@12|))) (|Set#IsMember| (M0.__default.DomSt |stCombinedC#0@0|) (M0.__default.Loc |cmd#0@@18| |deps#0@@18| |e#0@@12|))))
 :qid |CloudMakeCachedBuildsdfy.116:12|
 :skolemid |1589|
 :pattern ( (M0.__default.Loc |cmd#0@@18| |deps#0@@18| |e#0@@12|))
))))) (=> (M0.__default.ConsistentCache |stCombinedC#0@0|) (and (=> (= (ControlFlow 0 50) (- 0 53)) true) (=> ($IsAllocBox |stCombined#0@0| Tclass.M0.State $Heap@2) (and (=> (= (ControlFlow 0 50) (- 0 52)) true) (=> ($IsAllocBox |stCombinedC#0@0| Tclass.M0.State $Heap@2) (=> (and (|M0.__default.StateCorrespondence#canCall| |stCombined#0@0| |stCombinedC#0@0|) (|M0.__default.StateCorrespondence#canCall| |stCombined#0@0| |stCombinedC#0@0|)) (and (=> (= (ControlFlow 0 50) (- 0 51)) (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence |stCombined#0@0| |stCombinedC#0@0|)) (=> (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence |stCombined#0@0| |stCombinedC#0@0|) (and (=> (= (ControlFlow 0 50) 47) anon21_Then_correct) (=> (= (ControlFlow 0 50) 49) anon21_Else_correct)))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@8) ($IsHeapAnchor $Heap@@8)) (=> (and (and (and (and (and (and ($Is DatatypeTypeType |p#0@@17| (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State)) ($IsAlloc DatatypeTypeType |p#0@@17| (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State) $Heap@@8)) (|$IsA#M0.Tuple| |p#0@@17|)) (and (and ($IsBox |st#0@@25| Tclass.M0.State) ($IsAllocBox |st#0@@25| Tclass.M0.State $Heap@@8)) (and ($Is SetType |sts''#0| (TSet Tclass.M0.State)) ($IsAlloc SetType |sts''#0| (TSet Tclass.M0.State) $Heap@@8)))) (and (and (and ($Is DatatypeTypeType |pC#0| (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State)) ($IsAlloc DatatypeTypeType |pC#0| (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State) $Heap@@8)) (|$IsA#M0.Tuple| |pC#0|)) (and (and ($IsBox |stC#0@@7| Tclass.M0.State) ($IsAllocBox |stC#0@@7| Tclass.M0.State $Heap@@8)) (and ($Is SetType |stsC''#0| (TSet Tclass.M0.State)) ($IsAlloc SetType |stsC''#0| (TSet Tclass.M0.State) $Heap@@8))))) (and (and (and (and ($Is DatatypeTypeType |fun#0@@4| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |fun#0@@4| Tclass.M0.Expression $Heap@@8)) (|$IsA#M0.Expression| |fun#0@@4|)) (and ($Is SeqType |args#0@@12| (TSeq Tclass.M0.Expression)) ($IsAlloc SeqType |args#0@@12| (TSeq Tclass.M0.Expression) $Heap@@8))) (and (and ($Is DatatypeTypeType |outExpr#0| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |outExpr#0| Tclass.M0.Expression $Heap@@8)) true))) (and (and (and (and (and ($Is DatatypeTypeType |outExprC#0| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |outExprC#0| Tclass.M0.Expression $Heap@@8)) true) (and (=> |defass#stCombined#0| (and ($IsBox |stCombined#0@@6| Tclass.M0.State) ($IsAllocBox |stCombined#0@@6| Tclass.M0.State $Heap@@8))) true)) (and (and (and (=> |defass#stCombinedC#0| (and ($IsBox |stCombinedC#0| Tclass.M0.State) ($IsAllocBox |stCombinedC#0| Tclass.M0.State $Heap@@8))) true) (and (= 6 $FunctionContextHeight) (not (|Set#Equal| |sts''#0| |Set#Empty|)))) (and (and (|M0.__default.Compatible#canCall| |sts''#0|) (and (M0.__default.Compatible |sts''#0|) (forall ((|st#3@@3| T@U) (|st'#2@@1| T@U) ) (!  (=> (and ($IsBox |st#3@@3| Tclass.M0.State) ($IsBox |st'#2@@1| Tclass.M0.State)) (=> (and (|Set#IsMember| |sts''#0| |st#3@@3|) (|Set#IsMember| |sts''#0| |st'#2@@1|)) (forall ((|p#3@@3| T@U) ) (!  (=> ($IsBox |p#3@@3| Tclass.M0.Path) (=> (and (|Set#IsMember| (M0.__default.DomSt |st#3@@3|) |p#3@@3|) (|Set#IsMember| (M0.__default.DomSt |st'#2@@1|) |p#3@@3|)) (= (M0.__default.GetSt |p#3@@3| |st#3@@3|) (M0.__default.GetSt |p#3@@3| |st'#2@@1|))))
 :qid |CloudMakeCachedBuildsdfy.55:14|
 :skolemid |1576|
 :pattern ( (M0.__default.GetSt |p#3@@3| |st'#2@@1|))
 :pattern ( (M0.__default.GetSt |p#3@@3| |st#3@@3|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#2@@1|) |p#3@@3|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#3@@3|) |p#3@@3|))
))))
 :qid |CloudMakeCachedBuildsdfy.54:12|
 :skolemid |1577|
 :pattern ( (M0.__default.DomSt |st'#2@@1|) (M0.__default.DomSt |st#3@@3|))
 :pattern ( (M0.__default.DomSt |st'#2@@1|) (|Set#IsMember| |sts''#0| |st#3@@3|))
 :pattern ( (M0.__default.DomSt |st#3@@3|) (|Set#IsMember| |sts''#0| |st'#2@@1|))
 :pattern ( (|Set#IsMember| |sts''#0| |st'#2@@1|) (|Set#IsMember| |sts''#0| |st#3@@3|))
)))) (not (|Set#Equal| |stsC''#0| |Set#Empty|))))) (and (and (and (and (|M0.__default.Compatible#canCall| |stsC''#0|) (and (M0.__default.Compatible |stsC''#0|) (forall ((|st#4| T@U) (|st'#3| T@U) ) (!  (=> (and ($IsBox |st#4| Tclass.M0.State) ($IsBox |st'#3| Tclass.M0.State)) (=> (and (|Set#IsMember| |stsC''#0| |st#4|) (|Set#IsMember| |stsC''#0| |st'#3|)) (forall ((|p#4| T@U) ) (!  (=> ($IsBox |p#4| Tclass.M0.Path) (=> (and (|Set#IsMember| (M0.__default.DomSt |st#4|) |p#4|) (|Set#IsMember| (M0.__default.DomSt |st'#3|) |p#4|)) (= (M0.__default.GetSt |p#4| |st#4|) (M0.__default.GetSt |p#4| |st'#3|))))
 :qid |CloudMakeCachedBuildsdfy.55:14|
 :skolemid |1580|
 :pattern ( (M0.__default.GetSt |p#4| |st'#3|))
 :pattern ( (M0.__default.GetSt |p#4| |st#4|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#3|) |p#4|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#4|) |p#4|))
))))
 :qid |CloudMakeCachedBuildsdfy.54:12|
 :skolemid |1581|
 :pattern ( (M0.__default.DomSt |st'#3|) (M0.__default.DomSt |st#4|))
 :pattern ( (M0.__default.DomSt |st'#3|) (|Set#IsMember| |stsC''#0| |st#4|))
 :pattern ( (M0.__default.DomSt |st#4|) (|Set#IsMember| |stsC''#0| |st'#3|))
 :pattern ( (|Set#IsMember| |stsC''#0| |st'#3|) (|Set#IsMember| |stsC''#0| |st#4|))
)))) (|M0.Tuple#Equal| |p#0@@17| (M0.__default.evalCompatCheckCore |st#0@@25| |sts''#0| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))))) (and (|M0.Tuple#Equal| |pC#0| (M0.__default.evalCompatCheckCore |stC#0@@7| |stsC''#0| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true))))) (forall ((|s#1| T@U) ) (!  (=> ($IsBox |s#1| Tclass.M0.State) (and (=> (|Set#IsMember| |sts''#0| |s#1|) (M0.__default.ValidState |s#1|)) (=> (|Set#IsMember| |sts''#0| |s#1|) (M0.__default.Extends reveal_M0._default.Extends |st#0@@25| |s#1|))))
 :qid |CloudMakeCachedBuildsdfy.911:21|
 :skolemid |1582|
...
)))) (and (and (forall ((|s#3| T@U) ) (!  (=> ($IsBox |s#3| Tclass.M0.State) (and (and (=> (|Set#IsMember| |stsC''#0| |s#3|) (M0.__default.ValidState |s#3|)) (=> (|Set#IsMember| |stsC''#0| |s#3|) (M0.__default.Extends reveal_M0._default.Extends |stC#0@@7| |s#3|))) (=> (|Set#IsMember| |stsC''#0| |s#3|) (M0.__default.ConsistentCache |s#3|))))
 :qid |CloudMakeCachedBuildsdfy.912:21|
 :skolemid |1583|
...
)) (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence |st#0@@25| |stC#0@@7|)) (and (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence (M0.__default.Combine ($LS ($LS $LZ)) reveal_M0._default.Combine |sts''#0| (U_2_bool (Lit boolType (bool_2_U false)))) (M0.__default.Combine ($LS ($LS $LZ)) reveal_M0._default.Combine |stsC''#0| (U_2_bool (Lit boolType (bool_2_U true))))) (= (ControlFlow 0 64) 50)))))) anon0_correct))))
