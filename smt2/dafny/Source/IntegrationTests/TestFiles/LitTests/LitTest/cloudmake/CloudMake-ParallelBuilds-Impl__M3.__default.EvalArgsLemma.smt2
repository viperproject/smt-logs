...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|paths#0@@1| T@U) (|st#0@@15| T@U) ) (!  (=> (or (|M3.__default.Restrict#canCall| |paths#0@@1| |st#0@@15|) (and (< 4 $FunctionContextHeight) (and ($Is SetType |paths#0@@1| (TSet Tclass.M3.Path)) ($Is DatatypeTypeType |st#0@@15| Tclass.M3.State)))) ($Is MapType (M3.__default.Restrict |paths#0@@1| |st#0@@15|) (TMap Tclass.M3.Path Tclass.M3.Artifact)))
 :qid |CloudMakeParallelBuildsdfy.473:27|
 :skolemid |5732|
 :pattern ( (M3.__default.Restrict |paths#0@@1| |st#0@@15|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@8 T@U) (|cmd#0@@8| T@U) (|deps#0@@9| T@U) (|restrictedState#0@@1| T@U) (|exps#0@@4| T@U) (|st#0@@16| T@U) ) (!  (=> (or (|M3.__default.execOne#canCall| (Lit SeqType |cmd#0@@8|) (Lit SetType |deps#0@@9|) (Lit MapType |restrictedState#0@@1|) (Lit SetType |exps#0@@4|) (Lit DatatypeTypeType |st#0@@16|)) (and (< 3 $FunctionContextHeight) (and (and (and (and ($Is SeqType |cmd#0@@8| (TSeq TChar)) ($Is SetType |deps#0@@9| (TSet Tclass.M3.Path))) ($Is MapType |restrictedState#0@@1| (TMap Tclass.M3.Path Tclass.M3.Artifact))) ($Is SetType |exps#0@@4| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@16| Tclass.M3.State)))) (and (=> (not (|Set#Equal| |exps#0@@4| |Set#Empty|)) (and (|M3.__default.PickOne#canCall| (TSeq TChar) (Lit SetType |exps#0@@4|)) (let ((|exp#1| (Lit SeqType ($Unbox SeqType (M3.__default.PickOne (TSeq TChar) (Lit SetType |exps#0@@4|))))))
 (and (|M3.__default.execOne#canCall| (Lit SeqType |cmd#0@@8|) (Lit SetType |deps#0@@9|) (Lit MapType |restrictedState#0@@1|) (|Set#Difference| |exps#0@@4| (|Set#UnionOne| |Set#Empty| ($Box SeqType |exp#1|))) (Lit DatatypeTypeType |st#0@@16|)) (let ((|st'#1| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.execOne ($LS $ly@@8) (Lit SeqType |cmd#0@@8|) (Lit SetType |deps#0@@9|) (Lit MapType |restrictedState#0@@1|) (|Set#Difference| |exps#0@@4| (|Set#UnionOne| |Set#Empty| ($Box SeqType |exp#1|))) (Lit DatatypeTypeType |st#0@@16|))))))
 ...
 (and (|M3.__default.DomSt#canCall| |st'#1|) (=> (not (|Set#IsMember| (M3.__default.DomSt |st'#1|) ($Box DatatypeTypeType |p#1|))) (and (|M3.__default.RunTool#canCall| (Lit SeqType |cmd#0@@8|) (Lit MapType |restrictedState#0@@1|) |exp#1|) (|M3.__default.SetSt#canCall| |p#1| (M3.__default.RunTool (Lit SeqType |cmd#0@@8|) (Lit MapType |restrictedState#0@@1|) |exp#1|) |st'#1|))))))))))) (= (M3.__default.execOne ($LS $ly@@8) (Lit SeqType |cmd#0@@8|) (Lit SetType |deps#0@@9|) (Lit MapType |restrictedState#0@@1|) (Lit SetType |exps#0@@4|) (Lit DatatypeTypeType |st#0@@16|)) (ite (|Set#Equal| |exps#0@@4| |Set#Empty|) (|#M3.Tuple.Pair| ($Box SetType (Lit SetType |Set#Empty|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |st#0@@16|))) (let ((|exp#1@@0| (Lit SeqType ($Unbox SeqType (M3.__default.PickOne (TSeq TChar) (Lit SetType |exps#0@@4|))))))
(let ((|st'#1@@0| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.execOne ($LS $ly@@8) (Lit SeqType |cmd#0@@8|) (Lit SetType |deps#0@@9|) (Lit MapType |restrictedState#0@@1|) (|Set#Difference| |exps#0@@4| (|Set#UnionOne| |Set#Empty| ($Box SeqType |exp#1@@0|))) (Lit DatatypeTypeType |st#0@@16|))))))
(let ((|paths#1| ($Unbox SetType (M3.Tuple.fst (M3.__default.execOne ($LS $ly@@8) (Lit SeqType |cmd#0@@8|) (Lit SetType |deps#0@@9|) (Lit MapType |restrictedState#0@@1|) (|Set#Difference| |exps#0@@4| (|Set#UnionOne| |Set#Empty| ($Box SeqType |exp#1@@0|))) (Lit DatatypeTypeType |st#0@@16|))))))
...
(|#M3.Tuple.Pair| ($Box SetType (|Set#Union| |paths#1| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |p#1@@0|)))) ($Box DatatypeTypeType (ite (|Set#IsMember| (M3.__default.DomSt |st'#1@@0|) ($Box DatatypeTypeType |p#1@@0|)) |st'#1@@0| (M3.__default.SetSt |p#1@@0| (Lit DatatypeTypeType (M3.__default.RunTool (Lit SeqType |cmd#0@@8|) (Lit MapType |restrictedState#0@@1|) |exp#1@@0|)) |st'#1@@0|))))))))))))
 ...
 :weight 3
 :skolemid |5831|
 :pattern ( (M3.__default.execOne ($LS $ly@@8) (Lit SeqType |cmd#0@@8|) (Lit SetType |deps#0@@9|) (Lit MapType |restrictedState#0@@1|) (Lit SetType |exps#0@@4|) (Lit DatatypeTypeType |st#0@@16|)))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|cmd#0@@9| T@U) (|deps#0@@10| T@U) (|exps#0@@5| T@U) (|st#0@@17| T@U) ) (!  (=> (or (|M3.__default.exec#canCall| (Lit SeqType |cmd#0@@9|) (Lit SetType |deps#0@@10|) (Lit SetType |exps#0@@5|) (Lit DatatypeTypeType |st#0@@17|)) (and (< 5 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@9| (TSeq TChar)) ($Is SetType |deps#0@@10| (TSet Tclass.M3.Path))) ($Is SetType |exps#0@@5| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@17| Tclass.M3.State)))) (and (and (|M3.__default.Restrict#canCall| (Lit SetType |deps#0@@10|) (Lit DatatypeTypeType |st#0@@17|)) (|M3.__default.execOne#canCall| (Lit SeqType |cmd#0@@9|) (Lit SetType |deps#0@@10|) (Lit MapType (M3.__default.Restrict (Lit SetType |deps#0@@10|) (Lit DatatypeTypeType |st#0@@17|))) (Lit SetType |exps#0@@5|) (Lit DatatypeTypeType |st#0@@17|))) (= (M3.__default.exec (Lit SeqType |cmd#0@@9|) (Lit SetType |deps#0@@10|) (Lit SetType |exps#0@@5|) (Lit DatatypeTypeType |st#0@@17|)) (Lit DatatypeTypeType (M3.__default.execOne ($LS $LZ) (Lit SeqType |cmd#0@@9|) (Lit SetType |deps#0@@10|) (Lit MapType (M3.__default.Restrict (Lit SetType |deps#0@@10|) (Lit DatatypeTypeType |st#0@@17|))) (Lit SetType |exps#0@@5|) (Lit DatatypeTypeType |st#0@@17|))))))
 :qid |CloudMakeParallelBuildsdfy.69:23|
 :weight 3
 :skolemid |5823|
 :pattern ( (M3.__default.exec (Lit SeqType |cmd#0@@9|) (Lit SetType |deps#0@@10|) (Lit SetType |exps#0@@5|) (Lit DatatypeTypeType |st#0@@17|)))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall ((|cmd#0@@10| T@U) (|deps#0@@11| T@U) (|exps#0@@6| T@U) (|st#0@@22| T@U) ) (!  (=> (or (|M3.__default.Pre#canCall| |cmd#0@@10| |deps#0@@11| |exps#0@@6| |st#0@@22|) (and (< 6 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@10| (TSeq TChar)) ($Is SetType |deps#0@@11| (TSet Tclass.M3.Path))) ($Is SetType |exps#0@@6| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@22| Tclass.M3.State)))) (and (forall ((|e#0@@1| T@U) ) (!  (=> ($Is SeqType |e#0@@1| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@6| ($Box SeqType |e#0@@1|)) (and (and (|M3.__default.Loc#canCall| |cmd#0@@10| |deps#0@@11| |e#0@@1|) (|M3.__default.DomSt#canCall| |st#0@@22|)) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@22|) ($Box DatatypeTypeType (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@1|))) (and (and (|$IsA#M3.Artifact| (M3.__default.GetSt (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@1|) |st#0@@22|)) (|$IsA#M3.Artifact| (M3.__default.Oracle (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@1|) |st#0@@22|))) (and (and (|M3.__default.Loc#canCall| |cmd#0@@10| |deps#0@@11| |e#0@@1|) (|M3.__default.GetSt#canCall| (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@1|) |st#0@@22|)) (and (|M3.__default.Loc#canCall| |cmd#0@@10| |deps#0@@11| |e#0@@1|) (|M3.__default.Oracle#canCall| (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@1|) |st#0@@22|))))))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |6560|
 :pattern ( (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@1|))
 :pattern ( (|Set#IsMember| |exps#0@@6| ($Box SeqType |e#0@@1|)))
)) (= (M3.__default.Pre |cmd#0@@10| |deps#0@@11| |exps#0@@6| |st#0@@22|) (forall ((|e#0@@2| T@U) ) (!  (=> ($Is SeqType |e#0@@2| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@6| ($Box SeqType |e#0@@2|)) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@22|) ($Box DatatypeTypeType (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@2|))) (|M3.Artifact#Equal| (M3.__default.GetSt (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@2|) |st#0@@22|) (M3.__default.Oracle (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@2|) |st#0@@22|)))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |6559|
 ...
 :qid |CloudMakeParallelBuildsdfy.83:23|
 :skolemid |6561|
 :pattern ( (M3.__default.Pre |cmd#0@@10| |deps#0@@11| |exps#0@@6| |st#0@@22|))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|cmd#0@@11| T@U) (|deps#0@@12| T@U) (|exps#0@@7| T@U) (|st#0@@25| T@U) ) (!  (=> (or (|M3.__default.exec#canCall| |cmd#0@@11| |deps#0@@12| |exps#0@@7| |st#0@@25|) (and (< 5 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@11| (TSeq TChar)) ($Is SetType |deps#0@@12| (TSet Tclass.M3.Path))) ($Is SetType |exps#0@@7| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@25| Tclass.M3.State)))) ($Is DatatypeTypeType (M3.__default.exec |cmd#0@@11| |deps#0@@12| |exps#0@@7| |st#0@@25|) (Tclass.M3.Tuple (TSet Tclass.M3.Path) Tclass.M3.State)))
 :qid |CloudMakeParallelBuildsdfy.69:23|
 :skolemid |5819|
 :pattern ( (M3.__default.exec |cmd#0@@11| |deps#0@@12| |exps#0@@7| |st#0@@25|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@16 T@U) (|p#0@@30| T@U) (|cert#0@@8| T@U) (|deps#0@@15| T@U) (|st#0@@29| T@U) ) (!  (=> (or (|M3.__default.CollectDependencies#canCall| |p#0@@30| (Lit DatatypeTypeType |cert#0@@8|) |deps#0@@15| |st#0@@29|) (and (< 4 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |p#0@@30| Tclass.M3.Path) ($Is DatatypeTypeType |cert#0@@8| Tclass.M3.WFCertificate)) ($Is SetType |deps#0@@15| (TSet Tclass.M3.Path))) ($Is DatatypeTypeType |st#0@@29| Tclass.M3.State)) (and (M3.__default.CheckWellFounded ($LS $LZ) |p#0@@30| (Lit DatatypeTypeType |cert#0@@8|)) (|Set#Equal| |deps#0@@15| (M3.__default.LocInv__Deps |p#0@@30|)))))) (and (forall ((|d#0@@5| T@U) ) (!  (=> ($Is DatatypeTypeType |d#0@@5| Tclass.M3.Path) (=> (|Set#IsMember| |deps#0@@15| ($Box DatatypeTypeType |d#0@@5|)) (and (and (|M3.__default.DomSt#canCall| |st#0@@29|) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@29|) ($Box DatatypeTypeType |d#0@@5|)) (|M3.__default.GetSt#canCall| |d#0@@5| |st#0@@29|))) (=> (not (|Set#IsMember| (M3.__default.DomSt |st#0@@29|) ($Box DatatypeTypeType |d#0@@5|))) (and (and (M3.WFCertificate.Cert_q (Lit DatatypeTypeType |cert#0@@8|)) (|M3.__default.FindCert#canCall| |d#0@@5| (Lit SetType (M3.WFCertificate.certs (Lit DatatypeTypeType |cert#0@@8|))))) (|M3.__default.OracleWF#canCall| |d#0@@5| (M3.__default.FindCert |d#0@@5| (Lit SetType (M3.WFCertificate.certs (Lit DatatypeTypeType |cert#0@@8|)))) |st#0@@29|))))))
...
)) (= (M3.__default.CollectDependencies ($LS $ly@@16) |p#0@@30| (Lit DatatypeTypeType |cert#0@@8|) |deps#0@@15| |st#0@@29|) (|Map#Glue| (|Set#FromBoogieMap| (|lambda#0| Tclass.M3.Path |deps#0@@15|)) (|lambda#26| (M3.__default.DomSt |st#0@@29|) |st#0@@29| ($LS $ly@@16) (Lit SetType (M3.WFCertificate.certs (Lit DatatypeTypeType |cert#0@@8|))) |st#0@@29|) (TMap Tclass.M3.Path Tclass.M3.Artifact)))))
 :qid |CloudMakeParallelBuildsdfy.660:18|
 :weight 3
 :skolemid |6085|
 :pattern ( (M3.__default.CollectDependencies ($LS $ly@@16) |p#0@@30| (Lit DatatypeTypeType |cert#0@@8|) |deps#0@@15| |st#0@@29|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@18 T@U) (|p#0@@31| T@U) (|cert#0@@9| T@U) (|deps#0@@16| T@U) (|st#0@@31| T@U) ) (!  (=> (or (|M3.__default.CollectDependencies#canCall| |p#0@@31| |cert#0@@9| |deps#0@@16| |st#0@@31|) (and (< 4 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |p#0@@31| Tclass.M3.Path) ($Is DatatypeTypeType |cert#0@@9| Tclass.M3.WFCertificate)) ($Is SetType |deps#0@@16| (TSet Tclass.M3.Path))) ($Is DatatypeTypeType |st#0@@31| Tclass.M3.State)) (and (M3.__default.CheckWellFounded ($LS $LZ) |p#0@@31| |cert#0@@9|) (|Set#Equal| |deps#0@@16| (M3.__default.LocInv__Deps |p#0@@31|)))))) (and (forall ((|d#0@@6| T@U) ) (!  (=> ($Is DatatypeTypeType |d#0@@6| Tclass.M3.Path) (=> (|Set#IsMember| |deps#0@@16| ($Box DatatypeTypeType |d#0@@6|)) (and (and (|M3.__default.DomSt#canCall| |st#0@@31|) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@31|) ($Box DatatypeTypeType |d#0@@6|)) (|M3.__default.GetSt#canCall| |d#0@@6| |st#0@@31|))) (=> (not (|Set#IsMember| (M3.__default.DomSt |st#0@@31|) ($Box DatatypeTypeType |d#0@@6|))) (and (and (M3.WFCertificate.Cert_q |cert#0@@9|) (|M3.__default.FindCert#canCall| |d#0@@6| (M3.WFCertificate.certs |cert#0@@9|))) (|M3.__default.OracleWF#canCall| |d#0@@6| (M3.__default.FindCert |d#0@@6| (M3.WFCertificate.certs |cert#0@@9|)) |st#0@@31|))))))
 :qid |CloudMakeParallelBuildsdfy.664:9|
 :skolemid |6082|
...
)) (= (M3.__default.CollectDependencies ($LS $ly@@18) |p#0@@31| |cert#0@@9| |deps#0@@16| |st#0@@31|) (|Map#Glue| (|Set#FromBoogieMap| (|lambda#0| Tclass.M3.Path |deps#0@@16|)) (|lambda#26| (M3.__default.DomSt |st#0@@31|) |st#0@@31| $ly@@18 (M3.WFCertificate.certs |cert#0@@9|) |st#0@@31|) (TMap Tclass.M3.Path Tclass.M3.Artifact)))))
 :qid |CloudMakeParallelBuildsdfy.660:18|
 :skolemid |6083|
 :pattern ( (M3.__default.CollectDependencies ($LS $ly@@18) |p#0@@31| |cert#0@@9| |deps#0@@16| |st#0@@31|))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|cmd#0@@15| T@U) (|deps#0@@18| T@U) (|exps#0@@8| T@U) (|st#0@@34| T@U) ) (!  (=> (or (|M3.__default.exec#canCall| |cmd#0@@15| |deps#0@@18| |exps#0@@8| |st#0@@34|) (and (< 5 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@15| (TSeq TChar)) ($Is SetType |deps#0@@18| (TSet Tclass.M3.Path))) ($Is SetType |exps#0@@8| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@34| Tclass.M3.State)))) (and (and (|M3.__default.Restrict#canCall| |deps#0@@18| |st#0@@34|) (|M3.__default.execOne#canCall| |cmd#0@@15| |deps#0@@18| (M3.__default.Restrict |deps#0@@18| |st#0@@34|) |exps#0@@8| |st#0@@34|)) (= (M3.__default.exec |cmd#0@@15| |deps#0@@18| |exps#0@@8| |st#0@@34|) (M3.__default.execOne ($LS $LZ) |cmd#0@@15| |deps#0@@18| (M3.__default.Restrict |deps#0@@18| |st#0@@34|) |exps#0@@8| |st#0@@34|))))
 :qid |CloudMakeParallelBuildsdfy.69:23|
 :skolemid |5821|
 :pattern ( (M3.__default.exec |cmd#0@@15| |deps#0@@18| |exps#0@@8| |st#0@@34|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|p#0@@36| T@U) (|a#0@@2| T@U) (|st#0@@35| T@U) ) (!  (=> (or (|M3.__default.SetSt#canCall| (Lit DatatypeTypeType |p#0@@36|) (Lit DatatypeTypeType |a#0@@2|) (Lit DatatypeTypeType |st#0@@35|)) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |p#0@@36| Tclass.M3.Path) ($Is DatatypeTypeType |a#0@@2| Tclass.M3.Artifact)) ($Is DatatypeTypeType |st#0@@35| Tclass.M3.State)))) (and (M3.State.StateCons_q (Lit DatatypeTypeType |st#0@@35|)) (= (M3.__default.SetSt (Lit DatatypeTypeType |p#0@@36|) (Lit DatatypeTypeType |a#0@@2|) (Lit DatatypeTypeType |st#0@@35|)) (|#M3.State.StateCons| (|Map#Build| (Lit MapType (M3.State.m (Lit DatatypeTypeType |st#0@@35|))) ($Box DatatypeTypeType (Lit DatatypeTypeType |p#0@@36|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |a#0@@2|)))))))
 :qid |CloudMakeParallelBuildsdfy.468:24|
 :weight 3
 :skolemid |5731|
 :pattern ( (M3.__default.SetSt (Lit DatatypeTypeType |p#0@@36|) (Lit DatatypeTypeType |a#0@@2|) (Lit DatatypeTypeType |st#0@@35|)))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($ly@@20 T@U) (|expr#0@@2| T@U) (|st#0@@36| T@U) (|env#0@@10| T@U) ) (!  (=> (or (|M3.__default.eval#canCall| |expr#0@@2| |st#0@@36| |env#0@@10|) (and (< 8 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0@@2| Tclass.M3.Expression) ($Is DatatypeTypeType |st#0@@36| Tclass.M3.State)) ($Is DatatypeTypeType |env#0@@10| Tclass.M3.Env)) (M3.__default.ValidEnv |env#0@@10|)))) ($Is DatatypeTypeType (M3.__default.eval $ly@@20 |expr#0@@2| |st#0@@36| |env#0@@10|) (Tclass.M3.Tuple Tclass.M3.Expression Tclass.M3.State)))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |6700|
 :pattern ( (M3.__default.eval $ly@@20 |expr#0@@2| |st#0@@36| |env#0@@10|))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall ((|st#0@@37| T@U) (|st'#0@@3| T@U) ) (!  (=> (or (|M3.__default.Extends#canCall| |st#0@@37| |st'#0@@3|) (and (< 6 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@37| Tclass.M3.State) ($Is DatatypeTypeType |st'#0@@3| Tclass.M3.State)))) (and (and (and (|M3.__default.DomSt#canCall| |st#0@@37|) (|M3.__default.DomSt#canCall| |st'#0@@3|)) (=> (|Set#Subset| (M3.__default.DomSt |st#0@@37|) (M3.__default.DomSt |st'#0@@3|)) (and (forall ((|p#0@@37| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@37| Tclass.M3.Path) (and (|M3.__default.DomSt#canCall| |st#0@@37|) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@37|) ($Box DatatypeTypeType |p#0@@37|)) (and (and (|$IsA#M3.Artifact| (M3.__default.GetSt |p#0@@37| |st'#0@@3|)) (|$IsA#M3.Artifact| (M3.__default.GetSt |p#0@@37| |st#0@@37|))) (and (|M3.__default.GetSt#canCall| |p#0@@37| |st'#0@@3|) (|M3.__default.GetSt#canCall| |p#0@@37| |st#0@@37|))))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6613|
 :pattern ( (M3.__default.GetSt |p#0@@37| |st#0@@37|))
 :pattern ( (M3.__default.GetSt |p#0@@37| |st'#0@@3|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@37|) ($Box DatatypeTypeType |p#0@@37|)))
)) (=> (forall ((|p#0@@38| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@38| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@37|) ($Box DatatypeTypeType |p#0@@38|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#0@@38| |st'#0@@3|) (M3.__default.GetSt |p#0@@38| |st#0@@37|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6615|
 :pattern ( (M3.__default.GetSt |p#0@@38| |st#0@@37|))
 :pattern ( (M3.__default.GetSt |p#0@@38| |st'#0@@3|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@37|) ($Box DatatypeTypeType |p#0@@38|)))
)) (forall ((|p#1@@3| T@U) ) (!  (=> ($Is DatatypeTypeType |p#1@@3| Tclass.M3.Path) (and (|M3.__default.DomSt#canCall| |st#0@@37|) (=> (not (|Set#IsMember| (M3.__default.DomSt |st#0@@37|) ($Box DatatypeTypeType |p#1@@3|))) (and (|M3.__default.DomSt#canCall| |st'#0@@3|) (=> (|Set#IsMember| (M3.__default.DomSt |st'#0@@3|) ($Box DatatypeTypeType |p#1@@3|)) (and (and (|$IsA#M3.Artifact| (M3.__default.GetSt |p#1@@3| |st'#0@@3|)) (|$IsA#M3.Artifact| (M3.__default.Oracle |p#1@@3| |st#0@@37|))) (and (|M3.__default.GetSt#canCall| |p#1@@3| |st'#0@@3|) (|M3.__default.Oracle#canCall| |p#1@@3| |st#0@@37|))))))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |6614|
 :pattern ( (M3.__default.Oracle |p#1@@3| |st#0@@37|))
 :pattern ( (M3.__default.GetSt |p#1@@3| |st'#0@@3|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@3|) ($Box DatatypeTypeType |p#1@@3|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@37|) ($Box DatatypeTypeType |p#1@@3|)))
)))))) (= (M3.__default.Extends |st#0@@37| |st'#0@@3|)  (and (and (|Set#Subset| (M3.__default.DomSt |st#0@@37|) (M3.__default.DomSt |st'#0@@3|)) (forall ((|p#0@@39| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@39| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@37|) ($Box DatatypeTypeType |p#0@@39|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#0@@39| |st'#0@@3|) (M3.__default.GetSt |p#0@@39| |st#0@@37|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6611|
 :pattern ( (M3.__default.GetSt |p#0@@39| |st#0@@37|))
 :pattern ( (M3.__default.GetSt |p#0@@39| |st'#0@@3|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@37|) ($Box DatatypeTypeType |p#0@@39|)))
))) (forall ((|p#1@@4| T@U) ) (!  (=> ($Is DatatypeTypeType |p#1@@4| Tclass.M3.Path) (=> (and (not (|Set#IsMember| (M3.__default.DomSt |st#0@@37|) ($Box DatatypeTypeType |p#1@@4|))) (|Set#IsMember| (M3.__default.DomSt |st'#0@@3|) ($Box DatatypeTypeType |p#1@@4|))) (|M3.Artifact#Equal| (M3.__default.GetSt |p#1@@4| |st'#0@@3|) (M3.__default.Oracle |p#1@@4| |st#0@@37|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |6612|
 :pattern ( (M3.__default.Oracle |p#1@@4| |st#0@@37|))
 :pattern ( (M3.__default.GetSt |p#1@@4| |st'#0@@3|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@3|) ($Box DatatypeTypeType |p#1@@4|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@37|) ($Box DatatypeTypeType |p#1@@4|)))
))))))
 :qid |CloudMakeParallelBuildsdfy.112:27|
 :skolemid |6616|
 :pattern ( (M3.__default.Extends |st#0@@37| |st'#0@@3|))
))))
...
(assert (forall (($ly@@21 T@U) (|cmd#0@@16| T@U) (|deps#0@@19| T@U) (|restrictedState#0@@2| T@U) (|exps#0@@9| T@U) (|st#0@@38| T@U) ) (! (= (M3.__default.execOne ($LS $ly@@21) |cmd#0@@16| |deps#0@@19| |restrictedState#0@@2| |exps#0@@9| |st#0@@38|) (M3.__default.execOne $ly@@21 |cmd#0@@16| |deps#0@@19| |restrictedState#0@@2| |exps#0@@9| |st#0@@38|))
 :qid |CloudMakeParallelBuildsdfy.513:18|
 :skolemid |5826|
 :pattern ( (M3.__default.execOne ($LS $ly@@21) |cmd#0@@16| |deps#0@@19| |restrictedState#0@@2| |exps#0@@9| |st#0@@38|))
)))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@39| T@U) (|st'#0@@4| T@U) ) (!  (=> (or (|M3.__default.Union#canCall| |st#0@@39| |st'#0@@4|) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@39| Tclass.M3.State) ($Is DatatypeTypeType |st'#0@@4| Tclass.M3.State)))) (and (let ((|result#0| (M3.__default.Union |st#0@@39| |st'#0@@4|)))
 (and (|Set#Equal| (M3.__default.DomSt |result#0|) (|Set#Union| (M3.__default.DomSt |st#0@@39|) (M3.__default.DomSt |st'#0@@4|))) (forall ((|p#0@@40| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@40| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |result#0|) ($Box DatatypeTypeType |p#0@@40|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#0@@40| |result#0|) (M3.__default.GetSt |p#0@@40| (ite (|Set#IsMember| (M3.__default.DomSt |st#0@@39|) ($Box DatatypeTypeType |p#0@@40|)) |st#0@@39| |st'#0@@4|)))))
 :qid |CloudMakeParallelBuildsdfy.27:14|
 :skolemid |5656|
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@39|) ($Box DatatypeTypeType |p#0@@40|)))
 :pattern ( (M3.__default.GetSt |p#0@@40| |result#0|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |result#0|) ($Box DatatypeTypeType |p#0@@40|)))
)))) ($Is DatatypeTypeType (M3.__default.Union |st#0@@39| |st'#0@@4|) Tclass.M3.State)))
 :qid |CloudMakeParallelBuildsdfy.23:24|
 :skolemid |5657|
 :pattern ( (M3.__default.Union |st#0@@39| |st'#0@@4|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|p#0@@42| T@U) (|st#0@@40| T@U) ) (!  (=> (or (|M3.__default.GetSt#canCall| |p#0@@42| (Lit DatatypeTypeType |st#0@@40|)) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |p#0@@42| Tclass.M3.Path) ($Is DatatypeTypeType |st#0@@40| Tclass.M3.State)) (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@40|))) ($Box DatatypeTypeType |p#0@@42|))))) (and (M3.State.StateCons_q (Lit DatatypeTypeType |st#0@@40|)) (= (M3.__default.GetSt |p#0@@42| (Lit DatatypeTypeType |st#0@@40|)) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType (M3.State.m (Lit DatatypeTypeType |st#0@@40|)))) ($Box DatatypeTypeType |p#0@@42|))))))
 :qid |CloudMakeParallelBuildsdfy.10:24|
 :weight 3
 :skolemid |6472|
 :pattern ( (M3.__default.GetSt |p#0@@42| (Lit DatatypeTypeType |st#0@@40|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@23 T@U) (|p#0@@43| T@U) (|cert#0@@11| T@U) (|deps#0@@20| T@U) (|st#0@@41| T@U) ) (!  (=> (or (|M3.__default.CollectDependencies#canCall| |p#0@@43| |cert#0@@11| |deps#0@@20| |st#0@@41|) (and (< 4 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |p#0@@43| Tclass.M3.Path) ($Is DatatypeTypeType |cert#0@@11| Tclass.M3.WFCertificate)) ($Is SetType |deps#0@@20| (TSet Tclass.M3.Path))) ($Is DatatypeTypeType |st#0@@41| Tclass.M3.State)) (and (M3.__default.CheckWellFounded ($LS $LZ) |p#0@@43| |cert#0@@11|) (|Set#Equal| |deps#0@@20| (M3.__default.LocInv__Deps |p#0@@43|)))))) ($Is MapType (M3.__default.CollectDependencies $ly@@23 |p#0@@43| |cert#0@@11| |deps#0@@20| |st#0@@41|) (TMap Tclass.M3.Path Tclass.M3.Artifact)))
 :qid |CloudMakeParallelBuildsdfy.660:18|
 :skolemid |6080|
 :pattern ( (M3.__default.CollectDependencies $ly@@23 |p#0@@43| |cert#0@@11| |deps#0@@20| |st#0@@41|))
))))
...
(assert (forall (($ly@@24 T@U) (|p#0@@44| T@U) (|cert#0@@12| T@U) (|st#0@@42| T@U) ) (! (= (M3.__default.OracleWF ($LS $ly@@24) |p#0@@44| |cert#0@@12| |st#0@@42|) (M3.__default.OracleWF $ly@@24 |p#0@@44| |cert#0@@12| |st#0@@42|))
 :qid |CloudMakeParallelBuildsdfy.653:18|
 :skolemid |6058|
 :pattern ( (M3.__default.OracleWF ($LS $ly@@24) |p#0@@44| |cert#0@@12| |st#0@@42|))
)))
(assert (forall (($ly@@25 T@U) (|expr#0@@3| T@U) (|st#0@@43| T@U) (|env#0@@11| T@U) ) (! (= (M3.__default.eval ($LS $ly@@25) |expr#0@@3| |st#0@@43| |env#0@@11|) (M3.__default.eval $ly@@25 |expr#0@@3| |st#0@@43| |env#0@@11|))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |6698|
 :pattern ( (M3.__default.eval ($LS $ly@@25) |expr#0@@3| |st#0@@43| |env#0@@11|))
)))
...
(assert  (=> (<= 7 $FunctionContextHeight) (forall ((|prim#0@@4| T@U) (|args#0@@5| T@U) (|st#0@@44| T@U) ) (!  (=> (or (|M3.__default.ValidArgs#canCall| (Lit DatatypeTypeType |prim#0@@4|) (Lit SeqType |args#0@@5|) |st#0@@44|) (and (< 7 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |prim#0@@4| Tclass.M3.Primitive) ($Is SeqType |args#0@@5| (TSeq Tclass.M3.Expression))) ($Is DatatypeTypeType |st#0@@44| Tclass.M3.State)) (and (=> (M3.Primitive.primExec_q (Lit DatatypeTypeType |prim#0@@4|)) (= (|Seq#Length| (Lit SeqType |args#0@@5|)) (LitInt 3))) (=> (M3.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@4|)) (= (|Seq#Length| (Lit SeqType |args#0@@5|)) (LitInt 1))))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (M3.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@4|)))))) (let ((|exps#3| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@5|) (LitInt 2)))))
...
(let ((|cmd#3| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@5|) (LitInt 0)))))
 (=> (M3.Expression.exprLiteral_q |cmd#3|) (=> (M3.Literal.litString_q (M3.Expression.lit |cmd#3|)) (=> (M3.Expression.exprLiteral_q |deps#3|) (=> (M3.Literal.litArrOfPaths_q (M3.Expression.lit |deps#3|)) (=> (M3.Expression.exprLiteral_q |exps#3|) (=> (M3.Literal.litArrOfStrings_q (M3.Expression.lit |exps#3|)) (and (|M3.__default.DomSt#canCall| |st#0@@44|) (=> (|Set#Subset| (M3.Literal.paths (M3.Expression.lit |deps#3|)) (M3.__default.DomSt |st#0@@44|)) (|M3.__default.Pre#canCall| (M3.Literal.str (M3.Expression.lit |cmd#3|)) (M3.Literal.paths (M3.Expression.lit |deps#3|)) (M3.Literal.strs (M3.Expression.lit |exps#3|)) |st#0@@44|))))))))))))) (= (M3.__default.ValidArgs (Lit DatatypeTypeType |prim#0@@4|) (Lit SeqType |args#0@@5|) |st#0@@44|) (ite (M3.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@4|)) false (let ((|exps#2| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@5|) (LitInt 2)))))
...
(let ((|cmd#2@@1| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@5|) (LitInt 0)))))
 (and (and (and (and (and (and (and (M3.Expression.exprLiteral_q |cmd#2@@1|) (M3.Literal.litString_q (M3.Expression.lit |cmd#2@@1|))) (M3.Expression.exprLiteral_q |deps#2@@1|)) (M3.Literal.litArrOfPaths_q (M3.Expression.lit |deps#2@@1|))) (M3.Expression.exprLiteral_q |exps#2|)) (M3.Literal.litArrOfStrings_q (M3.Expression.lit |exps#2|))) (|Set#Subset| (M3.Literal.paths (M3.Expression.lit |deps#2@@1|)) (M3.__default.DomSt |st#0@@44|))) (M3.__default.Pre (M3.Literal.str (M3.Expression.lit |cmd#2@@1|)) (M3.Literal.paths (M3.Expression.lit |deps#2@@1|)) (M3.Literal.strs (M3.Expression.lit |exps#2|)) |st#0@@44|)))))))))
 :qid |CloudMakeParallelBuildsdfy.289:29|
 :weight 3
 :skolemid |6748|
 :pattern ( (M3.__default.ValidArgs (Lit DatatypeTypeType |prim#0@@4|) (Lit SeqType |args#0@@5|) |st#0@@44|))
))))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($ly@@27 T@U) (|expr#0@@4| T@U) (|st#0@@45| T@U) (|env#0@@13| T@U) ) (!  (=> (or (|M3.__default.eval#canCall| (Lit DatatypeTypeType |expr#0@@4|) |st#0@@45| |env#0@@13|) (and (< 8 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0@@4| Tclass.M3.Expression) ($Is DatatypeTypeType |st#0@@45| Tclass.M3.State)) ($Is DatatypeTypeType |env#0@@13| Tclass.M3.Env)) (M3.__default.ValidEnv |env#0@@13|)))) (and (and (|M3.__default.Value#canCall| (Lit DatatypeTypeType |expr#0@@4|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (M3.__default.Value (Lit DatatypeTypeType |expr#0@@4|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@4|))))) (|M3.__default.GetEnv#canCall| (Lit DatatypeTypeType (M3.Expression.id (Lit DatatypeTypeType |expr#0@@4|))) |env#0@@13|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@4|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@4|))))) (and (|M3.__default.eval#canCall| (Lit DatatypeTypeType (M3.Expression.cond (Lit DatatypeTypeType |expr#0@@4|))) |st#0@@45| |env#0@@13|) (let ((|st'#4| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval ($LS $ly@@27) (Lit DatatypeTypeType (M3.Expression.cond (Lit DatatypeTypeType |expr#0@@4|))) |st#0@@45| |env#0@@13|)))))
(let ((|cond'#1| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval ($LS $ly@@27) (Lit DatatypeTypeType (M3.Expression.cond (Lit DatatypeTypeType |expr#0@@4|))) |st#0@@45| |env#0@@13|)))))
 (and (and (=> (M3.Expression.exprLiteral_q |cond'#1|) (|$IsA#M3.Literal| (M3.Expression.lit |cond'#1|))) (=> (and (M3.Expression.exprLiteral_q |cond'#1|) (|M3.Literal#Equal| (M3.Expression.lit |cond'#1|) |#M3.Literal.litTrue|)) (|M3.__default.eval#canCall| (Lit DatatypeTypeType (M3.Expression.ifTrue (Lit DatatypeTypeType |expr#0@@4|))) |st'#4| |env#0@@13|))) (=> (not (and (M3.Expression.exprLiteral_q |cond'#1|) (|M3.Literal#Equal| (M3.Expression.lit |cond'#1|) |#M3.Literal.litTrue|))) (and (=> (M3.Expression.exprLiteral_q |cond'#1|) (|$IsA#M3.Literal| (M3.Expression.lit |cond'#1|))) (=> (and (M3.Expression.exprLiteral_q |cond'#1|) (|M3.Literal#Equal| (M3.Expression.lit |cond'#1|) |#M3.Literal.litFalse|)) (|M3.__default.eval#canCall| (Lit DatatypeTypeType (M3.Expression.ifFalse (Lit DatatypeTypeType |expr#0@@4|))) |st'#4| |env#0@@13|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@4|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@4|))))) (and (|M3.__default.eval#canCall| (Lit DatatypeTypeType (M3.Expression.conj0 (Lit DatatypeTypeType |expr#0@@4|))) |st#0@@45| |env#0@@13|) (let ((|st'#5| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval ($LS $ly@@27) (Lit DatatypeTypeType (M3.Expression.conj0 (Lit DatatypeTypeType |expr#0@@4|))) |st#0@@45| |env#0@@13|)))))
(let ((|conj0'#1| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval ($LS $ly@@27) (Lit DatatypeTypeType (M3.Expression.conj0 (Lit DatatypeTypeType |expr#0@@4|))) |st#0@@45| |env#0@@13|)))))
 (and (and (=> (M3.Expression.exprLiteral_q |conj0'#1|) (|$IsA#M3.Literal| (M3.Expression.lit |conj0'#1|))) (=> (and (M3.Expression.exprLiteral_q |conj0'#1|) (|M3.Literal#Equal| (M3.Expression.lit |conj0'#1|) |#M3.Literal.litTrue|)) (|M3.__default.eval#canCall| (Lit DatatypeTypeType (M3.Expression.conj1 (Lit DatatypeTypeType |expr#0@@4|))) |st'#5| |env#0@@13|))) (=> (not (and (M3.Expression.exprLiteral_q |conj0'#1|) (|M3.Literal#Equal| (M3.Expression.lit |conj0'#1|) |#M3.Literal.litTrue|))) (=> (M3.Expression.exprLiteral_q |conj0'#1|) (|$IsA#M3.Literal| (M3.Expression.lit |conj0'#1|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@4|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@4|))))) (and (|M3.__default.eval#canCall| (Lit DatatypeTypeType (M3.Expression.disj0 (Lit DatatypeTypeType |expr#0@@4|))) |st#0@@45| |env#0@@13|) (let ((|st'#6| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval ($LS $ly@@27) (Lit DatatypeTypeType (M3.Expression.disj0 (Lit DatatypeTypeType |expr#0@@4|))) |st#0@@45| |env#0@@13|)))))
(let ((|disj0'#1| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval ($LS $ly@@27) (Lit DatatypeTypeType (M3.Expression.disj0 (Lit DatatypeTypeType |expr#0@@4|))) |st#0@@45| |env#0@@13|)))))
 (and (=> (M3.Expression.exprLiteral_q |disj0'#1|) (|$IsA#M3.Literal| (M3.Expression.lit |disj0'#1|))) (=> (not (and (M3.Expression.exprLiteral_q |disj0'#1|) (|M3.Literal#Equal| (M3.Expression.lit |disj0'#1|) |#M3.Literal.litTrue|))) (and (=> (M3.Expression.exprLiteral_q |disj0'#1|) (|$IsA#M3.Literal| (M3.Expression.lit |disj0'#1|))) (=> (and (M3.Expression.exprLiteral_q |disj0'#1|) (|M3.Literal#Equal| (M3.Expression.lit |disj0'#1|) |#M3.Literal.litFalse|)) (|M3.__default.eval#canCall| (Lit DatatypeTypeType (M3.Expression.disj1 (Lit DatatypeTypeType |expr#0@@4|))) |st'#6| |env#0@@13|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@4|)))))) (=> (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0@@4|))))) (and (|M3.__default.eval#canCall| (Lit DatatypeTypeType (M3.Expression.fun (Lit DatatypeTypeType |expr#0@@4|))) |st#0@@45| |env#0@@13|) (let ((|st'#7| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval ($LS $ly@@27) (Lit DatatypeTypeType (M3.Expression.fun (Lit DatatypeTypeType |expr#0@@4|))) |st#0@@45| |env#0@@13|)))))
(let ((|fun'#1| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval ($LS $ly@@27) (Lit DatatypeTypeType (M3.Expression.fun (Lit DatatypeTypeType |expr#0@@4|))) |st#0@@45| |env#0@@13|)))))
 (and (|M3.__default.evalArgs#canCall| (Lit DatatypeTypeType |expr#0@@4|) (Lit SeqType (M3.Expression.args (Lit DatatypeTypeType |expr#0@@4|))) |st#0@@45| |env#0@@13|) (let ((|sts'#1| ($Unbox SetType (M3.Tuple.snd (M3.__default.evalArgs ($LS $ly@@27) (Lit DatatypeTypeType |expr#0@@4|) (Lit SeqType (M3.Expression.args (Lit DatatypeTypeType |expr#0@@4|))) |st#0@@45| |env#0@@13|)))))
(let ((|args'#1| ($Unbox SeqType (M3.Tuple.fst (M3.__default.evalArgs ($LS $ly@@27) (Lit DatatypeTypeType |expr#0@@4|) (Lit SeqType (M3.Expression.args (Lit DatatypeTypeType |expr#0@@4|))) |st#0@@45| |env#0@@13|)))))
(let ((|sts''#1| (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |st'#7|)) |sts'#1|)))
 ...
 (and (M3.Tuple.Pair_q |ps#1|) (M3.Tuple.Pair_q |ps#1|)))))))))))))))))))))))))))))) (= (M3.__default.eval ($LS $ly@@27) (Lit DatatypeTypeType |expr#0@@4|) |st#0@@45| |env#0@@13|) (ite (M3.__default.Value (Lit DatatypeTypeType |expr#0@@4|)) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType |expr#0@@4|)) ($Box DatatypeTypeType |st#0@@45|)) (ite (M3.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@4|)) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (M3.__default.GetEnv (Lit DatatypeTypeType (M3.Expression.id (Lit DatatypeTypeType |expr#0@@4|))) |env#0@@13|)) ($Box DatatypeTypeType |st#0@@45|)) (ite (M3.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@4|)) (let ((|st'#4@@0| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval ($LS $ly@@27) (Lit DatatypeTypeType (M3.Expression.cond (Lit DatatypeTypeType |expr#0@@4|))) |st#0@@45| |env#0@@13|)))))
(let ((|cond'#1@@0| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval ($LS $ly@@27) (Lit DatatypeTypeType (M3.Expression.cond (Lit DatatypeTypeType |expr#0@@4|))) |st#0@@45| |env#0@@13|)))))
(ite  (and (M3.Expression.exprLiteral_q |cond'#1@@0|) (|M3.Literal#Equal| (M3.Expression.lit |cond'#1@@0|) |#M3.Literal.litTrue|)) (M3.__default.eval ($LS $ly@@27) (Lit DatatypeTypeType (M3.Expression.ifTrue (Lit DatatypeTypeType |expr#0@@4|))) |st'#4@@0| |env#0@@13|) (ite  (and (M3.Expression.exprLiteral_q |cond'#1@@0|) (|M3.Literal#Equal| (M3.Expression.lit |cond'#1@@0|) |#M3.Literal.litFalse|)) (M3.__default.eval ($LS $ly@@27) (Lit DatatypeTypeType (M3.Expression.ifFalse (Lit DatatypeTypeType |expr#0@@4|))) |st'#4@@0| |env#0@@13|) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@45|)))))) (ite (M3.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@4|)) (let ((|st'#5@@0| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval ($LS $ly@@27) (Lit DatatypeTypeType (M3.Expression.conj0 (Lit DatatypeTypeType |expr#0@@4|))) |st#0@@45| |env#0@@13|)))))
(let ((|conj0'#1@@0| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval ($LS $ly@@27) (Lit DatatypeTypeType (M3.Expression.conj0 (Lit DatatypeTypeType |expr#0@@4|))) |st#0@@45| |env#0@@13|)))))
(ite  (and (M3.Expression.exprLiteral_q |conj0'#1@@0|) (|M3.Literal#Equal| (M3.Expression.lit |conj0'#1@@0|) |#M3.Literal.litTrue|)) (M3.__default.eval ($LS $ly@@27) (Lit DatatypeTypeType (M3.Expression.conj1 (Lit DatatypeTypeType |expr#0@@4|))) |st'#5@@0| |env#0@@13|) (ite  (and (M3.Expression.exprLiteral_q |conj0'#1@@0|) (|M3.Literal#Equal| (M3.Expression.lit |conj0'#1@@0|) |#M3.Literal.litFalse|)) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprLiteral| (Lit DatatypeTypeType |#M3.Literal.litFalse|)))) ($Box DatatypeTypeType |st'#5@@0|)) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@45|)))))) (ite (M3.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@4|)) (let ((|st'#6@@0| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval ($LS $ly@@27) (Lit DatatypeTypeType (M3.Expression.disj0 (Lit DatatypeTypeType |expr#0@@4|))) |st#0@@45| |env#0@@13|)))))
(let ((|disj0'#1@@0| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval ($LS $ly@@27) (Lit DatatypeTypeType (M3.Expression.disj0 (Lit DatatypeTypeType |expr#0@@4|))) |st#0@@45| |env#0@@13|)))))
(ite  (and (M3.Expression.exprLiteral_q |disj0'#1@@0|) (|M3.Literal#Equal| (M3.Expression.lit |disj0'#1@@0|) |#M3.Literal.litTrue|)) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprLiteral| (Lit DatatypeTypeType |#M3.Literal.litTrue|)))) ($Box DatatypeTypeType |st'#6@@0|)) (ite  (and (M3.Expression.exprLiteral_q |disj0'#1@@0|) (|M3.Literal#Equal| (M3.Expression.lit |disj0'#1@@0|) |#M3.Literal.litFalse|)) (M3.__default.eval ($LS $ly@@27) (Lit DatatypeTypeType (M3.Expression.disj1 (Lit DatatypeTypeType |expr#0@@4|))) |st'#6@@0| |env#0@@13|) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@45|)))))) (ite (M3.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0@@4|)) (let ((|st'#7@@0| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval ($LS $ly@@27) (Lit DatatypeTypeType (M3.Expression.fun (Lit DatatypeTypeType |expr#0@@4|))) |st#0@@45| |env#0@@13|)))))
(let ((|fun'#1@@0| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval ($LS $ly@@27) (Lit DatatypeTypeType (M3.Expression.fun (Lit DatatypeTypeType |expr#0@@4|))) |st#0@@45| |env#0@@13|)))))
(let ((|sts'#1@@0| ($Unbox SetType (M3.Tuple.snd (M3.__default.evalArgs ($LS $ly@@27) (Lit DatatypeTypeType |expr#0@@4|) (Lit SeqType (M3.Expression.args (Lit DatatypeTypeType |expr#0@@4|))) |st#0@@45| |env#0@@13|)))))
(let ((|args'#1@@0| ($Unbox SeqType (M3.Tuple.fst (M3.__default.evalArgs ($LS $ly@@27) (Lit DatatypeTypeType |expr#0@@4|) (Lit SeqType (M3.Expression.args (Lit DatatypeTypeType |expr#0@@4|))) |st#0@@45| |env#0@@13|)))))
(let ((|sts''#1@@0| (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |st'#7@@0|)) |sts'#1@@0|)))
(ite  (not (M3.__default.Compatible |sts''#1@@0|)) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rCompatibility|)))) ($Box DatatypeTypeType |st#0@@45|)) (let ((|stCombined#1@@0| (M3.__default.Combine ($LS $LZ) |sts''#1@@0|)))
...
(|#M3.Tuple.Pair| ($Box DatatypeTypeType (|#M3.Expression.exprLiteral| (|#M3.Literal.litArrOfPaths| ($Unbox SetType (M3.Tuple.fst |ps#1@@0|))))) (M3.Tuple.snd |ps#1@@0|))) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@45|))) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@45|))) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@45|)))))))))) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@45|)))))))))))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :weight 3
 :skolemid |6703|
 :pattern ( (M3.__default.eval ($LS $ly@@27) (Lit DatatypeTypeType |expr#0@@4|) |st#0@@45| |env#0@@13|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@29 T@U) (|p#0@@49| T@U) (|cert#0@@14| T@U) (|deps#0@@22| T@U) (|st#0@@46| T@U) ) (!  (=> (or (|M3.__default.CollectDependencies#canCall| (Lit DatatypeTypeType |p#0@@49|) (Lit DatatypeTypeType |cert#0@@14|) (Lit SetType |deps#0@@22|) (Lit DatatypeTypeType |st#0@@46|)) (and (< 4 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |p#0@@49| Tclass.M3.Path) ($Is DatatypeTypeType |cert#0@@14| Tclass.M3.WFCertificate)) ($Is SetType |deps#0@@22| (TSet Tclass.M3.Path))) ($Is DatatypeTypeType |st#0@@46| Tclass.M3.State)) (and (M3.__default.CheckWellFounded ($LS $LZ) (Lit DatatypeTypeType |p#0@@49|) (Lit DatatypeTypeType |cert#0@@14|)) (|Set#Equal| |deps#0@@22| (M3.__default.LocInv__Deps (Lit DatatypeTypeType |p#0@@49|))))))) (and (forall ((|d#0@@7| T@U) ) (!  (=> ($Is DatatypeTypeType |d#0@@7| Tclass.M3.Path) (=> (|Set#IsMember| (Lit SetType |deps#0@@22|) ($Box DatatypeTypeType |d#0@@7|)) (and (and (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@46|)) (=> (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@46|))) ($Box DatatypeTypeType |d#0@@7|)) (|M3.__default.GetSt#canCall| |d#0@@7| (Lit DatatypeTypeType |st#0@@46|)))) (=> (not (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@46|))) ($Box DatatypeTypeType |d#0@@7|))) (and (and (M3.WFCertificate.Cert_q (Lit DatatypeTypeType |cert#0@@14|)) (|M3.__default.FindCert#canCall| |d#0@@7| (Lit SetType (M3.WFCertificate.certs (Lit DatatypeTypeType |cert#0@@14|))))) (|M3.__default.OracleWF#canCall| |d#0@@7| (M3.__default.FindCert |d#0@@7| (Lit SetType (M3.WFCertificate.certs (Lit DatatypeTypeType |cert#0@@14|)))) (Lit DatatypeTypeType |st#0@@46|)))))))
 :qid |CloudMakeParallelBuildsdfy.664:9|
 :skolemid |6086|
 :pattern ( (M3.__default.FindCert |d#0@@7| (M3.WFCertificate.certs |cert#0@@14|)))
 :pattern ( (M3.__default.GetSt |d#0@@7| |st#0@@46|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@46|) ($Box DatatypeTypeType |d#0@@7|)))
 :pattern ( (|Set#IsMember| |deps#0@@22| ($Box DatatypeTypeType |d#0@@7|)))
)) (= (M3.__default.CollectDependencies ($LS $ly@@29) (Lit DatatypeTypeType |p#0@@49|) (Lit DatatypeTypeType |cert#0@@14|) (Lit SetType |deps#0@@22|) (Lit DatatypeTypeType |st#0@@46|)) (|Map#Glue| (|Set#FromBoogieMap| (|lambda#0| Tclass.M3.Path (Lit SetType |deps#0@@22|))) (|lambda#26| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@46|))) (Lit DatatypeTypeType |st#0@@46|) ($LS $ly@@29) (Lit SetType (M3.WFCertificate.certs (Lit DatatypeTypeType |cert#0@@14|))) (Lit DatatypeTypeType |st#0@@46|)) (TMap Tclass.M3.Path Tclass.M3.Artifact)))))
 :qid |CloudMakeParallelBuildsdfy.660:18|
 :weight 3
 :skolemid |6087|
 :pattern ( (M3.__default.CollectDependencies ($LS $ly@@29) (Lit DatatypeTypeType |p#0@@49|) (Lit DatatypeTypeType |cert#0@@14|) (Lit SetType |deps#0@@22|) (Lit DatatypeTypeType |st#0@@46|)))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|p#0@@50| T@U) (|st#0@@47| T@U) ) (!  (=> (or (|M3.__default.Oracle#canCall| (Lit DatatypeTypeType |p#0@@50|) (Lit DatatypeTypeType |st#0@@47|)) (and (< 5 $FunctionContextHeight) (and ($Is DatatypeTypeType |p#0@@50| Tclass.M3.Path) ($Is DatatypeTypeType |st#0@@47| Tclass.M3.State)))) (and (and (and (|M3.__default.WellFounded#canCall| (Lit DatatypeTypeType |p#0@@50|)) (=> (U_2_bool (Lit boolType (bool_2_U (M3.__default.WellFounded (Lit DatatypeTypeType |p#0@@50|))))) (and (|M3.__default.GetCert#canCall| (Lit DatatypeTypeType |p#0@@50|)) (|M3.__default.OracleWF#canCall| (Lit DatatypeTypeType |p#0@@50|) (Lit DatatypeTypeType (M3.__default.GetCert (Lit DatatypeTypeType |p#0@@50|))) (Lit DatatypeTypeType |st#0@@47|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M3.__default.WellFounded (Lit DatatypeTypeType |p#0@@50|)))))) (|M3.__default.OracleArbitrary#canCall| (Lit DatatypeTypeType |p#0@@50|)))) (= (M3.__default.Oracle (Lit DatatypeTypeType |p#0@@50|) (Lit DatatypeTypeType |st#0@@47|)) (ite (M3.__default.WellFounded (Lit DatatypeTypeType |p#0@@50|)) (M3.__default.OracleWF ($LS $LZ) (Lit DatatypeTypeType |p#0@@50|) (Lit DatatypeTypeType (M3.__default.GetCert (Lit DatatypeTypeType |p#0@@50|))) (Lit DatatypeTypeType |st#0@@47|)) (M3.__default.OracleArbitrary (Lit DatatypeTypeType |p#0@@50|))))))
 :qid |CloudMakeParallelBuildsdfy.104:25|
 :weight 3
 :skolemid |6039|
 :pattern ( (M3.__default.Oracle (Lit DatatypeTypeType |p#0@@50|) (Lit DatatypeTypeType |st#0@@47|)))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|sts#0@@3| T@U) ) (!  (=> (or (|M3.__default.Compatible#canCall| |sts#0@@3|) (and (< 4 $FunctionContextHeight) ($Is SetType |sts#0@@3| (TSet Tclass.M3.State)))) (and (forall ((|st#0@@48| T@U) (|st'#0@@5| T@U) (|p#0@@51| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |st#0@@48| Tclass.M3.State) ($Is DatatypeTypeType |st'#0@@5| Tclass.M3.State)) ($Is DatatypeTypeType |p#0@@51| Tclass.M3.Path)) (=> (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st#0@@48|)) (=> (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st'#0@@5|)) (and (|M3.__default.DomSt#canCall| |st#0@@48|) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@48|) ($Box DatatypeTypeType |p#0@@51|)) (and (|M3.__default.DomSt#canCall| |st'#0@@5|) (=> (|Set#IsMember| (M3.__default.DomSt |st'#0@@5|) ($Box DatatypeTypeType |p#0@@51|)) (and (and (|$IsA#M3.Artifact| (M3.__default.GetSt |p#0@@51| |st#0@@48|)) (|$IsA#M3.Artifact| (M3.__default.GetSt |p#0@@51| |st'#0@@5|))) (and (|M3.__default.GetSt#canCall| |p#0@@51| |st#0@@48|) (|M3.__default.GetSt#canCall| |p#0@@51| |st'#0@@5|))))))))))
 :qid |CloudMakeParallelBuildsdfy.32:12|
 :skolemid |6505|
 :pattern ( (M3.__default.GetSt |p#0@@51| |st'#0@@5|) (M3.__default.GetSt |p#0@@51| |st#0@@48|))
 :pattern ( (M3.__default.GetSt |p#0@@51| |st'#0@@5|) (M3.__default.DomSt |st#0@@48|))
 :pattern ( (M3.__default.GetSt |p#0@@51| |st'#0@@5|) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st#0@@48|)))
 :pattern ( (M3.__default.GetSt |p#0@@51| |st#0@@48|) (M3.__default.DomSt |st'#0@@5|))
 :pattern ( (M3.__default.GetSt |p#0@@51| |st#0@@48|) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st'#0@@5|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@5|) ($Box DatatypeTypeType |p#0@@51|)) (M3.__default.DomSt |st#0@@48|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@5|) ($Box DatatypeTypeType |p#0@@51|)) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st#0@@48|)))
 :pattern ( (M3.__default.DomSt |st'#0@@5|) (|Set#IsMember| (M3.__default.DomSt |st#0@@48|) ($Box DatatypeTypeType |p#0@@51|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@48|) ($Box DatatypeTypeType |p#0@@51|)) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st'#0@@5|)))
)) (= (M3.__default.Compatible |sts#0@@3|) (forall ((|st#0@@49| T@U) (|st'#0@@6| T@U) (|p#0@@52| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |st#0@@49| Tclass.M3.State) ($Is DatatypeTypeType |st'#0@@6| Tclass.M3.State)) ($Is DatatypeTypeType |p#0@@52| Tclass.M3.Path)) (=> (and (and (and (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st#0@@49|)) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st'#0@@6|))) (|Set#IsMember| (M3.__default.DomSt |st#0@@49|) ($Box DatatypeTypeType |p#0@@52|))) (|Set#IsMember| (M3.__default.DomSt |st'#0@@6|) ($Box DatatypeTypeType |p#0@@52|))) (|M3.Artifact#Equal| (M3.__default.GetSt |p#0@@52| |st#0@@49|) (M3.__default.GetSt |p#0@@52| |st'#0@@6|))))
 :qid |CloudMakeParallelBuildsdfy.32:12|
 :skolemid |6504|
 :pattern ( (M3.__default.GetSt |p#0@@52| |st'#0@@6|) (M3.__default.GetSt |p#0@@52| |st#0@@49|))
 :pattern ( (M3.__default.GetSt |p#0@@52| |st'#0@@6|) (M3.__default.DomSt |st#0@@49|))
 :pattern ( (M3.__default.GetSt |p#0@@52| |st'#0@@6|) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st#0@@49|)))
 :pattern ( (M3.__default.GetSt |p#0@@52| |st#0@@49|) (M3.__default.DomSt |st'#0@@6|))
 :pattern ( (M3.__default.GetSt |p#0@@52| |st#0@@49|) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st'#0@@6|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@6|) ($Box DatatypeTypeType |p#0@@52|)) (M3.__default.DomSt |st#0@@49|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@6|) ($Box DatatypeTypeType |p#0@@52|)) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st#0@@49|)))
 :pattern ( (M3.__default.DomSt |st'#0@@6|) (|Set#IsMember| (M3.__default.DomSt |st#0@@49|) ($Box DatatypeTypeType |p#0@@52|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@49|) ($Box DatatypeTypeType |p#0@@52|)) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st'#0@@6|)))
)))))
 :qid |CloudMakeParallelBuildsdfy.30:30|
 :skolemid |6506|
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall ((|st#0@@50| T@U) (|st'#0@@7| T@U) ) (!  (=> (or (|M3.__default.Extends#canCall| (Lit DatatypeTypeType |st#0@@50|) (Lit DatatypeTypeType |st'#0@@7|)) (and (< 6 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@50| Tclass.M3.State) ($Is DatatypeTypeType |st'#0@@7| Tclass.M3.State)))) (and (and (and (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@50|)) (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st'#0@@7|))) (=> (|Set#Subset| (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@50|)) (M3.__default.DomSt (Lit DatatypeTypeType |st'#0@@7|))) (and (forall ((|p#2| T@U) ) (!  (=> ($Is DatatypeTypeType |p#2| Tclass.M3.Path) (and (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@50|)) (=> (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@50|))) ($Box DatatypeTypeType |p#2|)) (and (and (|$IsA#M3.Artifact| (M3.__default.GetSt |p#2| (Lit DatatypeTypeType |st'#0@@7|))) (|$IsA#M3.Artifact| (M3.__default.GetSt |p#2| (Lit DatatypeTypeType |st#0@@50|)))) (and (|M3.__default.GetSt#canCall| |p#2| (Lit DatatypeTypeType |st'#0@@7|)) (|M3.__default.GetSt#canCall| |p#2| (Lit DatatypeTypeType |st#0@@50|)))))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6619|
 :pattern ( (M3.__default.GetSt |p#2| |st#0@@50|))
 :pattern ( (M3.__default.GetSt |p#2| |st'#0@@7|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@50|) ($Box DatatypeTypeType |p#2|)))
)) (=> (forall ((|p#2@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |p#2@@0| Tclass.M3.Path) (=> (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@50|))) ($Box DatatypeTypeType |p#2@@0|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#2@@0| (Lit DatatypeTypeType |st'#0@@7|)) (M3.__default.GetSt |p#2@@0| (Lit DatatypeTypeType |st#0@@50|)))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6621|
 :pattern ( (M3.__default.GetSt |p#2@@0| |st#0@@50|))
 :pattern ( (M3.__default.GetSt |p#2@@0| |st'#0@@7|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@50|) ($Box DatatypeTypeType |p#2@@0|)))
)) (forall ((|p#3| T@U) ) (!  (=> ($Is DatatypeTypeType |p#3| Tclass.M3.Path) (and (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@50|)) (=> (not (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@50|))) ($Box DatatypeTypeType |p#3|))) (and (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st'#0@@7|)) (=> (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st'#0@@7|))) ($Box DatatypeTypeType |p#3|)) (and (and (|$IsA#M3.Artifact| (M3.__default.GetSt |p#3| (Lit DatatypeTypeType |st'#0@@7|))) (|$IsA#M3.Artifact| (M3.__default.Oracle |p#3| (Lit DatatypeTypeType |st#0@@50|)))) (and (|M3.__default.GetSt#canCall| |p#3| (Lit DatatypeTypeType |st'#0@@7|)) (|M3.__default.Oracle#canCall| |p#3| (Lit DatatypeTypeType |st#0@@50|)))))))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |6620|
 :pattern ( (M3.__default.Oracle |p#3| |st#0@@50|))
 :pattern ( (M3.__default.GetSt |p#3| |st'#0@@7|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@7|) ($Box DatatypeTypeType |p#3|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@50|) ($Box DatatypeTypeType |p#3|)))
)))))) (= (M3.__default.Extends (Lit DatatypeTypeType |st#0@@50|) (Lit DatatypeTypeType |st'#0@@7|))  (and (and (|Set#Subset| (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@50|)) (M3.__default.DomSt (Lit DatatypeTypeType |st'#0@@7|))) (forall ((|p#2@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |p#2@@1| Tclass.M3.Path) (=> (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@50|))) ($Box DatatypeTypeType |p#2@@1|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#2@@1| (Lit DatatypeTypeType |st'#0@@7|)) (M3.__default.GetSt |p#2@@1| (Lit DatatypeTypeType |st#0@@50|)))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6617|
 :pattern ( (M3.__default.GetSt |p#2@@1| |st#0@@50|))
 :pattern ( (M3.__default.GetSt |p#2@@1| |st'#0@@7|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@50|) ($Box DatatypeTypeType |p#2@@1|)))
))) (forall ((|p#3@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |p#3@@0| Tclass.M3.Path) (=> (and (not (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@50|))) ($Box DatatypeTypeType |p#3@@0|))) (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st'#0@@7|))) ($Box DatatypeTypeType |p#3@@0|))) (|M3.Artifact#Equal| (M3.__default.GetSt |p#3@@0| (Lit DatatypeTypeType |st'#0@@7|)) (M3.__default.Oracle |p#3@@0| (Lit DatatypeTypeType |st#0@@50|)))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |6618|
 :pattern ( (M3.__default.Oracle |p#3@@0| |st#0@@50|))
 :pattern ( (M3.__default.GetSt |p#3@@0| |st'#0@@7|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@7|) ($Box DatatypeTypeType |p#3@@0|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@50|) ($Box DatatypeTypeType |p#3@@0|)))
))))))
 :qid |CloudMakeParallelBuildsdfy.112:27|
 :weight 3
 :skolemid |6622|
 :pattern ( (M3.__default.Extends (Lit DatatypeTypeType |st#0@@50|) (Lit DatatypeTypeType |st'#0@@7|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@51| T@U) (|st'#0@@8| T@U) ) (!  (=> (or (|M3.__default.Union#canCall| |st#0@@51| |st'#0@@8|) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@51| Tclass.M3.State) ($Is DatatypeTypeType |st'#0@@8| Tclass.M3.State)))) (and (forall ((|p#1@@7| T@U) ) (!  (=> ($Is DatatypeTypeType |p#1@@7| Tclass.M3.Path) (and (and (|M3.__default.DomSt#canCall| |st#0@@51|) (|M3.__default.DomSt#canCall| |st'#0@@8|)) (=> (|Set#IsMember| (|Set#Union| (M3.__default.DomSt |st#0@@51|) (M3.__default.DomSt |st'#0@@8|)) ($Box DatatypeTypeType |p#1@@7|)) (and (|M3.__default.DomSt#canCall| |st#0@@51|) (|M3.__default.GetSt#canCall| |p#1@@7| (ite (|Set#IsMember| (M3.__default.DomSt |st#0@@51|) ($Box DatatypeTypeType |p#1@@7|)) |st#0@@51| |st'#0@@8|))))))
 :qid |CloudMakeParallelBuildsdfy.770:19|
 :skolemid |5660|
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@51|) ($Box DatatypeTypeType |p#1@@7|)))
 :pattern ( (|Set#IsMember| (|Set#Union| (M3.__default.DomSt |st#0@@51|) (M3.__default.DomSt |st'#0@@8|)) ($Box DatatypeTypeType |p#1@@7|)))
)) (= (M3.__default.Union |st#0@@51| |st'#0@@8|) (|#M3.State.StateCons| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#0| Tclass.M3.Path (|Set#Union| (M3.__default.DomSt |st#0@@51|) (M3.__default.DomSt |st'#0@@8|)))) (|lambda#1| (M3.__default.DomSt |st#0@@51|) |st#0@@51| |st'#0@@8|) (TMap Tclass.M3.Path Tclass.M3.Artifact))))))
 :qid |CloudMakeParallelBuildsdfy.23:24|
 :skolemid |5661|
 :pattern ( (M3.__default.Union |st#0@@51| |st'#0@@8|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@52| T@U) (|st'#0@@9| T@U) ) (!  (=> (or (|M3.__default.Union#canCall| (Lit DatatypeTypeType |st#0@@52|) (Lit DatatypeTypeType |st'#0@@9|)) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@52| Tclass.M3.State) ($Is DatatypeTypeType |st'#0@@9| Tclass.M3.State)))) (and (forall ((|p#1@@8| T@U) ) (!  (=> ($Is DatatypeTypeType |p#1@@8| Tclass.M3.Path) (and (and (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@52|)) (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st'#0@@9|))) (=> (|Set#IsMember| (|Set#Union| (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@52|)) (M3.__default.DomSt (Lit DatatypeTypeType |st'#0@@9|))) ($Box DatatypeTypeType |p#1@@8|)) (and (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@52|)) (|M3.__default.GetSt#canCall| |p#1@@8| (ite (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@52|))) ($Box DatatypeTypeType |p#1@@8|)) |st#0@@52| |st'#0@@9|))))))
 :qid |CloudMakeParallelBuildsdfy.770:19|
 :skolemid |5662|
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@52|) ($Box DatatypeTypeType |p#1@@8|)))
 :pattern ( (|Set#IsMember| (|Set#Union| (M3.__default.DomSt |st#0@@52|) (M3.__default.DomSt |st'#0@@9|)) ($Box DatatypeTypeType |p#1@@8|)))
)) (= (M3.__default.Union (Lit DatatypeTypeType |st#0@@52|) (Lit DatatypeTypeType |st'#0@@9|)) (|#M3.State.StateCons| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#0| Tclass.M3.Path (|Set#Union| (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@52|)) (M3.__default.DomSt (Lit DatatypeTypeType |st'#0@@9|))))) (|lambda#1| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@52|))) |st#0@@52| |st'#0@@9|) (TMap Tclass.M3.Path Tclass.M3.Artifact))))))
 :qid |CloudMakeParallelBuildsdfy.23:24|
 :weight 3
 :skolemid |5663|
 :pattern ( (M3.__default.Union (Lit DatatypeTypeType |st#0@@52|) (Lit DatatypeTypeType |st'#0@@9|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|p#0@@53| T@U) (|a#0@@4| T@U) (|st#0@@53| T@U) ) (!  (=> (or (|M3.__default.SetSt#canCall| |p#0@@53| |a#0@@4| |st#0@@53|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |p#0@@53| Tclass.M3.Path) ($Is DatatypeTypeType |a#0@@4| Tclass.M3.Artifact)) ($Is DatatypeTypeType |st#0@@53| Tclass.M3.State)))) (and (M3.State.StateCons_q |st#0@@53|) (= (M3.__default.SetSt |p#0@@53| |a#0@@4| |st#0@@53|) (|#M3.State.StateCons| (|Map#Build| (M3.State.m |st#0@@53|) ($Box DatatypeTypeType |p#0@@53|) ($Box DatatypeTypeType |a#0@@4|))))))
 :qid |CloudMakeParallelBuildsdfy.468:24|
 :skolemid |5729|
 :pattern ( (M3.__default.SetSt |p#0@@53| |a#0@@4| |st#0@@53|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|paths#0@@2| T@U) (|st#0@@54| T@U) ) (!  (=> (or (|M3.__default.Restrict#canCall| (Lit SetType |paths#0@@2|) (Lit DatatypeTypeType |st#0@@54|)) (and (< 4 $FunctionContextHeight) (and ($Is SetType |paths#0@@2| (TSet Tclass.M3.Path)) ($Is DatatypeTypeType |st#0@@54| Tclass.M3.State)))) (and (forall ((|p#0@@54| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@54| Tclass.M3.Path) (and (=> (|Set#IsMember| (Lit SetType |paths#0@@2|) ($Box DatatypeTypeType |p#0@@54|)) (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@54|))) (=> (and (|Set#IsMember| (Lit SetType |paths#0@@2|) ($Box DatatypeTypeType |p#0@@54|)) (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@54|))) ($Box DatatypeTypeType |p#0@@54|))) (|M3.__default.GetSt#canCall| |p#0@@54| (Lit DatatypeTypeType |st#0@@54|)))))
 :qid |CloudMakeParallelBuildsdfy.475:9|
 :skolemid |5736|
 :pattern ( (M3.__default.GetSt |p#0@@54| |st#0@@54|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@54|) ($Box DatatypeTypeType |p#0@@54|)))
 :pattern ( (|Set#IsMember| |paths#0@@2| ($Box DatatypeTypeType |p#0@@54|)))
)) (= (M3.__default.Restrict (Lit SetType |paths#0@@2|) (Lit DatatypeTypeType |st#0@@54|)) (|Map#Glue| (|Set#FromBoogieMap| (|lambda#16| Tclass.M3.Path (Lit SetType |paths#0@@2|) (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@54|))))) (|lambda#17| (Lit DatatypeTypeType |st#0@@54|)) (TMap Tclass.M3.Path Tclass.M3.Artifact)))))
 :qid |CloudMakeParallelBuildsdfy.473:27|
 :weight 3
 :skolemid |5737|
 :pattern ( (M3.__default.Restrict (Lit SetType |paths#0@@2|) (Lit DatatypeTypeType |st#0@@54|)))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|cmd#0@@19| T@U) (|deps#0@@24| T@U) (|exps#0@@10| T@U) (|st#0@@55| T@U) ) (!  (=> (or (|M3.__default.exec#canCall| (Lit SeqType |cmd#0@@19|) (Lit SetType |deps#0@@24|) (Lit SetType |exps#0@@10|) |st#0@@55|) (and (< 5 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@19| (TSeq TChar)) ($Is SetType |deps#0@@24| (TSet Tclass.M3.Path))) ($Is SetType |exps#0@@10| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@55| Tclass.M3.State)))) (and (and (|M3.__default.Restrict#canCall| (Lit SetType |deps#0@@24|) |st#0@@55|) (|M3.__default.execOne#canCall| (Lit SeqType |cmd#0@@19|) (Lit SetType |deps#0@@24|) (M3.__default.Restrict (Lit SetType |deps#0@@24|) |st#0@@55|) (Lit SetType |exps#0@@10|) |st#0@@55|)) (= (M3.__default.exec (Lit SeqType |cmd#0@@19|) (Lit SetType |deps#0@@24|) (Lit SetType |exps#0@@10|) |st#0@@55|) (M3.__default.execOne ($LS $LZ) (Lit SeqType |cmd#0@@19|) (Lit SetType |deps#0@@24|) (M3.__default.Restrict (Lit SetType |deps#0@@24|) |st#0@@55|) (Lit SetType |exps#0@@10|) |st#0@@55|))))
 :qid |CloudMakeParallelBuildsdfy.69:23|
 :weight 3
 :skolemid |5822|
 :pattern ( (M3.__default.exec (Lit SeqType |cmd#0@@19|) (Lit SetType |deps#0@@24|) (Lit SetType |exps#0@@10|) |st#0@@55|))
))))
...
(declare-fun |context#0@@4| () T@U)
(declare-fun |args#0@@7| () T@U)
(declare-fun |stOrig#0@@4| () T@U)
...
(set-info :boogie-vc-id Impl$$M3.__default.EvalArgsLemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> false (|M3.Tuple#Equal| (|#M3.Tuple.Pair| ($Box SeqType |args'#0@0|) ($Box SetType |sts'#0@0|)) (M3.__default.evalArgs ($LS ($LS $LZ)) |context#0@@4| |args#0@@7| |stOrig#0@@4| |env#0@@14|)))) (=> (=> false (|M3.Tuple#Equal| (|#M3.Tuple.Pair| ($Box SeqType |args'#0@0|) ($Box SetType |sts'#0@0|)) (M3.__default.evalArgs ($LS ($LS $LZ)) |context#0@@4| |args#0@@7| |stOrig#0@@4| |env#0@@14|))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (forall ((|st'#1@@5| T@U) ) (!  (=> ($Is DatatypeTypeType |st'#1@@5| Tclass.M3.State) (and (=> (|Set#IsMember| |sts'#0@0| ($Box DatatypeTypeType |st'#1@@5|)) (M3.__default.ValidState |st'#1@@5|)) (=> (|Set#IsMember| |sts'#0@0| ($Box DatatypeTypeType |st'#1@@5|)) (M3.__default.Extends |stOrig#0@@4| |st'#1@@5|))))
 :qid |CloudMakeParallelBuildsdfy.419:14|
 :skolemid |6843|
 :pattern ( (M3.__default.Extends |stOrig#0@@4| |st'#1@@5|))
 :pattern ( (M3.__default.ValidState |st'#1@@5|))
 :pattern ( (|Set#IsMember| |sts'#0@0| ($Box DatatypeTypeType |st'#1@@5|)))
))))))))
(let ((anon3_Else_correct  (=> (not (|Seq#Equal| |args#0@@7| |Seq#Empty|)) (=> (and (and (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |args#0@@7|))) (and (= |expr##1_0@0| ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@7| (LitInt 0)))) (< (DtRank |expr##1_0@0|) (DtRank |context#0@@4|)))) (and (and ($Is DatatypeTypeType |call4formal@expr'#0| Tclass.M3.Expression) ($IsAlloc DatatypeTypeType |call4formal@expr'#0| Tclass.M3.Expression $Heap@@21)) (and ($Is DatatypeTypeType |call5formal@st'#0| Tclass.M3.State) ($IsAlloc DatatypeTypeType |call5formal@st'#0| Tclass.M3.State $Heap@@21)))) (and (=> (= (ControlFlow 0 5) (- 0 10)) (=> (|M3.__default.ValidState#canCall| |stOrig#0@@4|) (or (M3.__default.ValidState |stOrig#0@@4|) (forall ((|p#0@@55| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@55| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |stOrig#0@@4|) ($Box DatatypeTypeType |p#0@@55|)) (M3.__default.WellFounded |p#0@@55|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6798|
 :pattern ( (M3.__default.WellFounded |p#0@@55|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |stOrig#0@@4|) ($Box DatatypeTypeType |p#0@@55|)))
))))) (=> (=> (|M3.__default.ValidState#canCall| |stOrig#0@@4|) (or (M3.__default.ValidState |stOrig#0@@4|) (forall ((|p#0@@56| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@56| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |stOrig#0@@4|) ($Box DatatypeTypeType |p#0@@56|)) (M3.__default.WellFounded |p#0@@56|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6798|
 :pattern ( (M3.__default.WellFounded |p#0@@56|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |stOrig#0@@4|) ($Box DatatypeTypeType |p#0@@56|)))
)))) (and (=> (= (ControlFlow 0 5) (- 0 9)) (M3.__default.ValidEnv |env#0@@14|)) (=> (M3.__default.ValidEnv |env#0@@14|) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and ($Is DatatypeTypeType |call4formal@expr'#0@0| Tclass.M3.Expression) ($IsAlloc DatatypeTypeType |call4formal@expr'#0@0| Tclass.M3.Expression $Heap@0)) (and ($Is DatatypeTypeType |call5formal@st'#0@0| Tclass.M3.State) ($IsAlloc DatatypeTypeType |call5formal@st'#0@0| Tclass.M3.State $Heap@0))) (=> (and (and (and (and (and (and (|$IsA#M3.Tuple| (M3.__default.eval ($LS $LZ) |expr##1_0@0| |stOrig#0@@4| |env#0@@14|)) (|M3.__default.eval#canCall| |expr##1_0@0| |stOrig#0@@4| |env#0@@14|)) (=> (|M3.Tuple#Equal| (|#M3.Tuple.Pair| ($Box DatatypeTypeType |call4formal@expr'#0@0|) ($Box DatatypeTypeType |call5formal@st'#0@0|)) (M3.__default.eval ($LS $LZ) |expr##1_0@0| |stOrig#0@@4| |env#0@@14|)) (and (|M3.__default.ValidState#canCall| |call5formal@st'#0@0|) (=> (M3.__default.ValidState |call5formal@st'#0@0|) (and (|M3.__default.Extends#canCall| |stOrig#0@@4| |call5formal@st'#0@0|) (=> (M3.__default.Extends |stOrig#0@@4| |call5formal@st'#0@0|) (=> (M3.Expression.exprError_q |call4formal@expr'#0@0|) (|$IsA#M3.Reason| (M3.Expression.r |call4formal@expr'#0@0|))))))))) (|M3.Tuple#Equal| (|#M3.Tuple.Pair| ($Box DatatypeTypeType |call4formal@expr'#0@0|) ($Box DatatypeTypeType |call5formal@st'#0@0|)) (M3.__default.eval ($LS ($LS $LZ)) |expr##1_0@0| |stOrig#0@@4| |env#0@@14|))) (and (|M3.__default.ValidState#canCall| |call5formal@st'#0@0|) (and (M3.__default.ValidState |call5formal@st'#0@0|) (forall ((|p#1@@9| T@U) ) (!  (=> ($Is DatatypeTypeType |p#1@@9| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |call5formal@st'#0@0|) ($Box DatatypeTypeType |p#1@@9|)) (M3.__default.WellFounded |p#1@@9|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6801|
...
))))) (and (and (|M3.__default.Extends#canCall| |stOrig#0@@4| |call5formal@st'#0@0|) (and (M3.__default.Extends |stOrig#0@@4| |call5formal@st'#0@0|) (and (and (|Set#Subset| (M3.__default.DomSt |stOrig#0@@4|) (M3.__default.DomSt |call5formal@st'#0@0|)) (forall ((|p#2@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |p#2@@2| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |stOrig#0@@4|) ($Box DatatypeTypeType |p#2@@2|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#2@@2| |call5formal@st'#0@0|) (M3.__default.GetSt |p#2@@2| |stOrig#0@@4|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6804|
 :pattern ( (M3.__default.GetSt |p#2@@2| |stOrig#0@@4|))
 :pattern ( (M3.__default.GetSt |p#2@@2| |call5formal@st'#0@0|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |stOrig#0@@4|) ($Box DatatypeTypeType |p#2@@2|)))
))) (forall ((|p#3@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |p#3@@1| Tclass.M3.Path) (=> (and (not (|Set#IsMember| (M3.__default.DomSt |stOrig#0@@4|) ($Box DatatypeTypeType |p#3@@1|))) (|Set#IsMember| (M3.__default.DomSt |call5formal@st'#0@0|) ($Box DatatypeTypeType |p#3@@1|))) (|M3.Artifact#Equal| (M3.__default.GetSt |p#3@@1| |call5formal@st'#0@0|) (M3.__default.Oracle |p#3@@1| |stOrig#0@@4|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |6805|
 :pattern ( (M3.__default.Oracle |p#3@@1| |stOrig#0@@4|))
 ...
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |stOrig#0@@4|) ($Box DatatypeTypeType |p#3@@1|)))
))))) (and (=> (M3.Expression.exprError_q |call4formal@expr'#0@0|) (|M3.Reason#Equal| (M3.Expression.r |call4formal@expr'#0@0|) |#M3.Reason.rValidity|)) (= $Heap@@21 $Heap@0)))) (and (and (and (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |args#0@@7|))) (= |args##1_0@0| (|Seq#Drop| |args#0@@7| (LitInt 1)))) (and (or (or (<= 0 (|Seq#Length| |args#0@@7|)) (< (DtRank |context#0@@4|) (DtRank |context#0@@4|))) (= (|Seq#Length| |args##1_0@0|) (|Seq#Length| |args#0@@7|))) (or (< (DtRank |context#0@@4|) (DtRank |context#0@@4|)) (and (= (DtRank |context#0@@4|) (DtRank |context#0@@4|)) (< (|Seq#Length| |args##1_0@0|) (|Seq#Length| |args#0@@7|)))))) (and (and ($Is SeqType |call5formal@args'#0| (TSeq Tclass.M3.Expression)) ($IsAlloc SeqType |call5formal@args'#0| (TSeq Tclass.M3.Expression) $Heap@@21)) (and ($Is SetType |call6formal@sts'#0| (TSet Tclass.M3.State)) ($IsAlloc SetType |call6formal@sts'#0| (TSet Tclass.M3.State) $Heap@@21))))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (=> (|M3.__default.ValidState#canCall| |stOrig#0@@4|) (or (M3.__default.ValidState |stOrig#0@@4|) (forall ((|p#0@@57| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@57| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |stOrig#0@@4|) ($Box DatatypeTypeType |p#0@@57|)) (M3.__default.WellFounded |p#0@@57|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6834|
 :pattern ( (M3.__default.WellFounded |p#0@@57|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |stOrig#0@@4|) ($Box DatatypeTypeType |p#0@@57|)))
))))) (=> (=> (|M3.__default.ValidState#canCall| |stOrig#0@@4|) (or (M3.__default.ValidState |stOrig#0@@4|) (forall ((|p#0@@58| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@58| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |stOrig#0@@4|) ($Box DatatypeTypeType |p#0@@58|)) (M3.__default.WellFounded |p#0@@58|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6834|
 :pattern ( (M3.__default.WellFounded |p#0@@58|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |stOrig#0@@4|) ($Box DatatypeTypeType |p#0@@58|)))
)))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (M3.__default.ValidEnv |env#0@@14|)) (=> (M3.__default.ValidEnv |env#0@@14|) (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((|arg#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#1@@0| Tclass.M3.Expression) (=> (|Seq#Contains| |args##1_0@0| ($Box DatatypeTypeType |arg#1@@0|)) (< (DtRank |arg#1@@0|) (DtRank |context#0@@4|))))
 :qid |CloudMakeParallelBuildsdfy.416:14|
 :skolemid |6836|
 :pattern ( (|Seq#Contains| |args##1_0@0| ($Box DatatypeTypeType |arg#1@@0|)))
))) (=> (forall ((|arg#1@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#1@@1| Tclass.M3.Expression) (=> (|Seq#Contains| |args##1_0@0| ($Box DatatypeTypeType |arg#1@@1|)) (< (DtRank |arg#1@@1|) (DtRank |context#0@@4|))))
 :qid |CloudMakeParallelBuildsdfy.416:14|
 :skolemid |6836|
 :pattern ( (|Seq#Contains| |args##1_0@0| ($Box DatatypeTypeType |arg#1@@1|)))
)) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and (and ($Is SeqType |call5formal@args'#0@0| (TSeq Tclass.M3.Expression)) ($IsAlloc SeqType |call5formal@args'#0@0| (TSeq Tclass.M3.Expression) $Heap@1)) (and ($Is SetType |call6formal@sts'#0@0| (TSet Tclass.M3.State)) ($IsAlloc SetType |call6formal@sts'#0@0| (TSet Tclass.M3.State) $Heap@1))) (and (and (|$IsA#M3.Tuple| (M3.__default.evalArgs ($LS $LZ) |context#0@@4| |args##1_0@0| |stOrig#0@@4| |env#0@@14|)) (|M3.__default.evalArgs#canCall| |context#0@@4| |args##1_0@0| |stOrig#0@@4| |env#0@@14|)) (=> (|M3.Tuple#Equal| (|#M3.Tuple.Pair| ($Box SeqType |call5formal@args'#0@0|) ($Box SetType |call6formal@sts'#0@0|)) (M3.__default.evalArgs ($LS $LZ) |context#0@@4| |args##1_0@0| |stOrig#0@@4| |env#0@@14|)) (forall ((|st'#1@@6| T@U) ) (!  (=> ($Is DatatypeTypeType |st'#1@@6| Tclass.M3.State) (and (=> (|Set#IsMember| |call6formal@sts'#0@0| ($Box DatatypeTypeType |st'#1@@6|)) (|M3.__default.ValidState#canCall| |st'#1@@6|)) (=> (=> (|Set#IsMember| |call6formal@sts'#0@0| ($Box DatatypeTypeType |st'#1@@6|)) (M3.__default.ValidState |st'#1@@6|)) (=> (|Set#IsMember| |call6formal@sts'#0@0| ($Box DatatypeTypeType |st'#1@@6|)) (|M3.__default.Extends#canCall| |stOrig#0@@4| |st'#1@@6|)))))
 :qid |CloudMakeParallelBuildsdfy.419:14|
 :skolemid |6837|
 :pattern ( (M3.__default.Extends |stOrig#0@@4| |st'#1@@6|))
 :pattern ( (M3.__default.ValidState |st'#1@@6|))
 :pattern ( (|Set#IsMember| |call6formal@sts'#0@0| ($Box DatatypeTypeType |st'#1@@6|)))
))))) (and (and (and (|M3.Tuple#Equal| (|#M3.Tuple.Pair| ($Box SeqType |call5formal@args'#0@0|) ($Box SetType |call6formal@sts'#0@0|)) (M3.__default.evalArgs ($LS ($LS $LZ)) |context#0@@4| |args##1_0@0| |stOrig#0@@4| |env#0@@14|)) (forall ((|st'#1@@7| T@U) ) (!  (=> ($Is DatatypeTypeType |st'#1@@7| Tclass.M3.State) (and (=> (|Set#IsMember| |call6formal@sts'#0@0| ($Box DatatypeTypeType |st'#1@@7|)) (M3.__default.ValidState |st'#1@@7|)) (=> (|Set#IsMember| |call6formal@sts'#0@0| ($Box DatatypeTypeType |st'#1@@7|)) (M3.__default.Extends |stOrig#0@@4| |st'#1@@7|))))
 :qid |CloudMakeParallelBuildsdfy.419:14|
 :skolemid |6838|
 :pattern ( (M3.__default.Extends |stOrig#0@@4| |st'#1@@7|))
 :pattern ( (M3.__default.ValidState |st'#1@@7|))
 :pattern ( (|Set#IsMember| |call6formal@sts'#0@0| ($Box DatatypeTypeType |st'#1@@7|)))
))) (and (= $Heap@0 $Heap@1) (= |$rhs#1_0@0| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |call4formal@expr'#0@0|)) |call5formal@args'#0@0|)))) (and (and (= |$rhs#1_1@0| (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |call5formal@st'#0@0|)) |call6formal@sts'#0@0|)) (= |args'#0@0| |$rhs#1_0@0|)) (and (= |sts'#0@0| |$rhs#1_1@0|) (= (ControlFlow 0 5) 2))))) GeneratedUnifiedExit_correct)))))))))))))))))))
(let ((anon3_Then_correct  (=> (and (|Seq#Equal| |args#0@@7| |Seq#Empty|) (= |$rhs#0_0@0| (Lit SeqType |Seq#Empty|))) (=> (and (and (= |$rhs#0_1@0| (Lit SetType |Set#Empty|)) (= |args'#0@0| |$rhs#0_0@0|)) (and (= |sts'#0@0| |$rhs#0_1@0|) (= (ControlFlow 0 4) 2))) GeneratedUnifiedExit_correct))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#4| null $Heap@@21 alloc false)) (and (=> (= (ControlFlow 0 11) 4) anon3_Then_correct) (=> (= (ControlFlow 0 11) 5) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@21) ($IsHeapAnchor $Heap@@21)) (=> (and (and (and (and ($Is DatatypeTypeType |context#0@@4| Tclass.M3.Expression) ($IsAlloc DatatypeTypeType |context#0@@4| Tclass.M3.Expression $Heap@@21)) (|$IsA#M3.Expression| |context#0@@4|)) (and ($Is SeqType |args#0@@7| (TSeq Tclass.M3.Expression)) ($IsAlloc SeqType |args#0@@7| (TSeq Tclass.M3.Expression) $Heap@@21))) (and (and (and ($Is DatatypeTypeType |stOrig#0@@4| Tclass.M3.State) ($IsAlloc DatatypeTypeType |stOrig#0@@4| Tclass.M3.State $Heap@@21)) (|$IsA#M3.State| |stOrig#0@@4|)) (and (and ($Is DatatypeTypeType |env#0@@14| Tclass.M3.Env) ($IsAlloc DatatypeTypeType |env#0@@14| Tclass.M3.Env $Heap@@21)) (|$IsA#M3.Env| |env#0@@14|)))) (=> (and (and (and (and (and ($Is SeqType |args'#0@@1| (TSeq Tclass.M3.Expression)) ($IsAlloc SeqType |args'#0@@1| (TSeq Tclass.M3.Expression) $Heap@@21)) (and ($Is SetType |sts'#0@@1| (TSet Tclass.M3.State)) ($IsAlloc SetType |sts'#0@@1| (TSet Tclass.M3.State) $Heap@@21))) (and (and ($Is DatatypeTypeType |rArg#1_0| Tclass.M3.Expression) ($IsAlloc DatatypeTypeType |rArg#1_0| Tclass.M3.Expression $Heap@@21)) true)) (and (and (and ($Is DatatypeTypeType |rSts#1_0| Tclass.M3.State) ($IsAlloc DatatypeTypeType |rSts#1_0| Tclass.M3.State $Heap@@21)) true) (and (and ($Is SeqType |rrArg#1_0| (TSeq Tclass.M3.Expression)) ($IsAlloc SeqType |rrArg#1_0| (TSeq Tclass.M3.Expression) $Heap@@21)) true))) (and (and (and (and ($Is SetType |rrSts#1_0| (TSet Tclass.M3.State)) ($IsAlloc SetType |rrSts#1_0| (TSet Tclass.M3.State) $Heap@@21)) true) (= 12 $FunctionContextHeight)) (and (and (and (|M3.__default.ValidState#canCall| |stOrig#0@@4|) (and (M3.__default.ValidState |stOrig#0@@4|) (forall ((|p#1@@10| T@U) ) (!  (=> ($Is DatatypeTypeType |p#1@@10| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |stOrig#0@@4|) ($Box DatatypeTypeType |p#1@@10|)) (M3.__default.WellFounded |p#1@@10|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6840|
 :pattern ( (M3.__default.WellFounded |p#1@@10|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |stOrig#0@@4|) ($Box DatatypeTypeType |p#1@@10|)))
)))) (M3.__default.ValidEnv |env#0@@14|)) (and (forall ((|arg#1@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#1@@2| Tclass.M3.Expression) (=> (|Seq#Contains| |args#0@@7| ($Box DatatypeTypeType |arg#1@@2|)) (< (DtRank |arg#1@@2|) (DtRank |context#0@@4|))))
 :qid |CloudMakeParallelBuildsdfy.416:14|
 :skolemid |6841|
 :pattern ( (|Seq#Contains| |args#0@@7| ($Box DatatypeTypeType |arg#1@@2|)))
