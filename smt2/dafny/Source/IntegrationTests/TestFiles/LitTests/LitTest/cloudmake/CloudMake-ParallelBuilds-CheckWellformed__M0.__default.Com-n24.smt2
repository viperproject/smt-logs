...
(let ((anon5_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (exists ((|st#3| T@U) )  (and ($IsBox |st#3| Tclass.M0.State) (|Set#IsMember| |sts#0@@4| |st#3|)))) (=> (exists ((|st#3@@0| T@U) )  (and ($IsBox |st#3@@0| Tclass.M0.State) (|Set#IsMember| |sts#0@@4| |st#3@@0|))) (=> (and (and ($IsBox |st#2@0| Tclass.M0.State) ($IsAllocBox |st#2@0| Tclass.M0.State $Heap@@4)) (|Set#IsMember| |sts#0@@4| |st#2@0|)) (and (=> (= (ControlFlow 0 7) 3) anon12_Then_correct) (=> (= (ControlFlow 0 7) 4) anon12_Else_correct)))))))
