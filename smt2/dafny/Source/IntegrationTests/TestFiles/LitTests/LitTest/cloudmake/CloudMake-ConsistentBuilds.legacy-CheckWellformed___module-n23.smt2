...
(assert (distinct alloc Tagclass._System.nat Tagclass._module.Primitive |##_module.Primitive.primCreatePath| |##_module.Primitive.primExec| tytagFamily$nat tytagFamily$Primitive)
)
...
(assert (forall ((d T@U) ) (! (= (_module.Primitive.primCreatePath_q d) (= (DatatypeCtorId d) |##_module.Primitive.primCreatePath|))
 :qid |unknown.0:0|
 :skolemid |1493|
 :pattern ( (_module.Primitive.primCreatePath_q d))
)))
(assert (forall ((d@@0 T@U) ) (! (= (_module.Primitive.primExec_q d@@0) (= (DatatypeCtorId d@@0) |##_module.Primitive.primExec|))
 :qid |unknown.0:0|
 :skolemid |1495|
 :pattern ( (_module.Primitive.primExec_q d@@0))
)))
...
(assert (forall ((d@@1 T@U) ) (!  (=> (_module.Primitive.primCreatePath_q d@@1) (= d@@1 |#_module.Primitive.primCreatePath|))
 :qid |unknown.0:0|
 :skolemid |1494|
 :pattern ( (_module.Primitive.primCreatePath_q d@@1))
)))
(assert (forall ((d@@2 T@U) ) (!  (=> (_module.Primitive.primExec_q d@@2) (= d@@2 |#_module.Primitive.primExec|))
 :qid |unknown.0:0|
 :skolemid |1496|
 :pattern ( (_module.Primitive.primExec_q d@@2))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|prim#0@@1| T@U) ) (!  (=> (or (|_module.__default.Arity#canCall| |prim#0@@1|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |prim#0@@1| Tclass._module.Primitive))) (<= (LitInt 0) (_module.__default.Arity |prim#0@@1|)))
 :qid |CloudMakeConsistentBuildslegacydfy.360:22|
 :skolemid |1083|
 :pattern ( (_module.__default.Arity |prim#0@@1|))
))))
(assert (forall ((d@@3 T@U) ) (!  (=> ($Is DatatypeTypeType d@@3 Tclass._module.Primitive) (or (_module.Primitive.primCreatePath_q d@@3) (_module.Primitive.primExec_q d@@3)))
 :qid |unknown.0:0|
 :skolemid |1499|
 :pattern ( (_module.Primitive.primExec_q d@@3) ($Is DatatypeTypeType d@@3 Tclass._module.Primitive))
 :pattern ( (_module.Primitive.primCreatePath_q d@@3) ($Is DatatypeTypeType d@@3 Tclass._module.Primitive))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Arity)
...
(let ((anon10_Then_correct  (=> (and (= |prim#0@@2| |#_module.Primitive.primExec|) (= (ControlFlow 0 5) (- 0 4))) ($Is intType (int_2_U (LitInt 3)) Tclass._System.nat))))
(let ((anon9_Else_correct  (=> (or (not (= |prim#0@@2| |#_module.Primitive.primCreatePath|)) (not true)) (and (=> (= (ControlFlow 0 7) 5) anon10_Then_correct) (=> (= (ControlFlow 0 7) 6) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> (and (= |prim#0@@2| |#_module.Primitive.primCreatePath|) (= (ControlFlow 0 3) (- 0 2))) ($Is intType (int_2_U (LitInt 1)) Tclass._System.nat))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |prim#0@@2| Tclass._module.Primitive)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct)))
