...
(assert (forall ((M1.Tuple$A T@U) (M1.Tuple$B T@U) (d@@1 T@U) ) (!  (=> ($Is DatatypeTypeType d@@1 (Tclass.M1.Tuple M1.Tuple$A M1.Tuple$B)) (M1.Tuple.Pair_q d@@1))
 :qid |unknown.0:0|
 :skolemid |2794|
 :pattern ( (M1.Tuple.Pair_q d@@1) ($Is DatatypeTypeType d@@1 (Tclass.M1.Tuple M1.Tuple$A M1.Tuple$B)))
)))
...
(assert (forall ((d@@3 T@U) ) (!  (=> ($Is DatatypeTypeType d@@3 Tclass.M1.Program) (M1.Program.Program_q d@@3))
 :qid |unknown.0:0|
 :skolemid |2545|
 :pattern ( (M1.Program.Program_q d@@3) ($Is DatatypeTypeType d@@3 Tclass.M1.Program))
)))
...
(assert (forall ((a@@8 T@U) (b@@5 T@U) ) (! (= (|M1.Literal#Equal| a@@8 b@@5) (= a@@8 b@@5))
 :qid |unknown.0:0|
 :skolemid |2757|
 :pattern ( (|M1.Literal#Equal| a@@8 b@@5))
)))
(assert (forall ((a@@9 T@U) (b@@6 T@U) ) (! (= (|M1.Primitive#Equal| a@@9 b@@6) (= a@@9 b@@6))
 :qid |unknown.0:0|
 :skolemid |2767|
 :pattern ( (|M1.Primitive#Equal| a@@9 b@@6))
)))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($Heap@@4 T@U) ($ly@@6 T@U) (|stmts#0@@1| T@U) (|st#0@@13| T@U) (|env#0@@4| T@U) ) (!  (=> (and (or (|M1.__default.do#canCall| |stmts#0@@1| |st#0@@13| |env#0@@4|) (and (< 6 $FunctionContextHeight) (and (and (and (and ($Is SeqType |stmts#0@@1| (TSeq Tclass.M1.Statement)) ($IsAlloc SeqType |stmts#0@@1| (TSeq Tclass.M1.Statement) $Heap@@4)) (and ($Is DatatypeTypeType |st#0@@13| Tclass.M1.State) ($IsAlloc DatatypeTypeType |st#0@@13| Tclass.M1.State $Heap@@4))) (and ($IsBox |env#0@@4| Tclass.M1.Env) ($IsAllocBox |env#0@@4| Tclass.M1.Env $Heap@@4))) (and (M1.__default.Legal |stmts#0@@1|) (M1.__default.ValidEnv |env#0@@4|))))) ($IsGoodHeap $Heap@@4)) ($IsAlloc DatatypeTypeType (M1.__default.do $ly@@6 |stmts#0@@1| |st#0@@13| |env#0@@4|) (Tclass.M1.Tuple Tclass.M1.Expression Tclass.M1.State) $Heap@@4))
 :qid |CloudMakeParallelBuildsdfy.177:18|
 :skolemid |2351|
 :pattern ( ($IsAlloc DatatypeTypeType (M1.__default.do $ly@@6 |stmts#0@@1| |st#0@@13| |env#0@@4|) (Tclass.M1.Tuple Tclass.M1.Expression Tclass.M1.State) $Heap@@4))
))))
...
(assert (forall ((d@@5 T@U) ) (! (= (M1.State.StateCons_q d@@5) (= (DatatypeCtorId d@@5) |##M1.State.StateCons|))
 :qid |unknown.0:0|
 :skolemid |2519|
 :pattern ( (M1.State.StateCons_q d@@5))
)))
(assert (forall ((d@@6 T@U) ) (! (= (M1.Program.Program_q d@@6) (= (DatatypeCtorId d@@6) |##M1.Program.Program|))
 :qid |unknown.0:0|
 :skolemid |2534|
 :pattern ( (M1.Program.Program_q d@@6))
)))
...
(assert (forall ((d@@28 T@U) ) (! (= (M1.Tuple.Pair_q d@@28) (= (DatatypeCtorId d@@28) |##M1.Tuple.Pair|))
 :qid |unknown.0:0|
 :skolemid |2779|
 :pattern ( (M1.Tuple.Pair_q d@@28))
)))
...
(assert (forall ((d@@29 T@U) ) (!  (=> (M1.Expression.exprIf_q d@@29) (exists ((|a#39#0#0| T@U) (|a#39#1#0| T@U) (|a#39#2#0| T@U) ) (! (= d@@29 (|#M1.Expression.exprIf| |a#39#0#0| |a#39#1#0| |a#39#2#0|))
 :qid |CloudMakeParallelBuildsdfy.134:32|
 :skolemid |2597|
)))
 :qid |unknown.0:0|
 :skolemid |2598|
 :pattern ( (M1.Expression.exprIf_q d@@29))
)))
...
(assert (forall ((d@@30 T@U) ) (!  (=> (_System.Tuple2.___hMake2_q d@@30) (exists ((|a#1#0#0| T@U) (|a#1#1#0| T@U) ) (! (= d@@30 (|#_System._tuple#2._#Make2| |a#1#0#0| |a#1#1#0|))
 :qid |unknown.0:0|
 :skolemid |1834|
)))
 :qid |unknown.0:0|
 :skolemid |1835|
 :pattern ( (_System.Tuple2.___hMake2_q d@@30))
)))
(assert (forall ((d@@31 T@U) ) (!  (=> (M1.Statement.stmtVariable_q d@@31) (exists ((|a#15#0#0| T@U) (|a#15#1#0| T@U) ) (! (= d@@31 (|#M1.Statement.stmtVariable| |a#15#0#0| |a#15#1#0|))
 :qid |CloudMakeParallelBuildsdfy.130:37|
 :skolemid |2550|
)))
 :qid |unknown.0:0|
 :skolemid |2551|
 :pattern ( (M1.Statement.stmtVariable_q d@@31))
)))
(assert (forall ((d@@32 T@U) ) (!  (=> (M1.Expression.exprAnd_q d@@32) (exists ((|a#49#0#0| T@U) (|a#49#1#0| T@U) ) (! (= d@@32 (|#M1.Expression.exprAnd| |a#49#0#0| |a#49#1#0|))
 :qid |CloudMakeParallelBuildsdfy.135:33|
 :skolemid |2613|
)))
 :qid |unknown.0:0|
 :skolemid |2614|
 :pattern ( (M1.Expression.exprAnd_q d@@32))
)))
(assert (forall ((d@@33 T@U) ) (!  (=> (M1.Expression.exprOr_q d@@33) (exists ((|a#57#0#0| T@U) (|a#57#1#0| T@U) ) (! (= d@@33 (|#M1.Expression.exprOr| |a#57#0#0| |a#57#1#0|))
 :qid |CloudMakeParallelBuildsdfy.136:32|
 :skolemid |2626|
)))
 :qid |unknown.0:0|
 :skolemid |2627|
 :pattern ( (M1.Expression.exprOr_q d@@33))
)))
(assert (forall ((d@@34 T@U) ) (!  (=> (M1.Expression.exprInvocation_q d@@34) (exists ((|a#65#0#0| T@U) (|a#65#1#0| T@U) ) (! (= d@@34 (|#M1.Expression.exprInvocation| |a#65#0#0| |a#65#1#0|))
 :qid |CloudMakeParallelBuildsdfy.137:40|
 :skolemid |2639|
)))
 :qid |unknown.0:0|
 :skolemid |2640|
 :pattern ( (M1.Expression.exprInvocation_q d@@34))
)))
(assert (forall ((d@@35 T@U) ) (!  (=> (M1.Tuple.Pair_q d@@35) (exists ((|a#149#0#0| T@U) (|a#149#1#0| T@U) ) (! (= d@@35 (|#M1.Tuple.Pair| |a#149#0#0| |a#149#1#0|))
 :qid |CloudMakeParallelBuildsdfy.159:31|
 :skolemid |2780|
)))
 :qid |unknown.0:0|
 :skolemid |2781|
 :pattern ( (M1.Tuple.Pair_q d@@35))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0@@14| T@U) ) (!  (=> (or (|M1.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@14|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |st#0@@14| Tclass.M1.State))) (and (M1.State.StateCons_q (Lit DatatypeTypeType |st#0@@14|)) (= (M1.__default.DomSt (Lit DatatypeTypeType |st#0@@14|)) (|Set#FromBoogieMap| (|lambda#1| Tclass.M1.Path (|Map#Domain| (M1.State.m (Lit DatatypeTypeType |st#0@@14|))))))))
 :qid |CloudMakeParallelBuildsdfy.9:24|
 :weight 3
 :skolemid |2095|
 :pattern ( (M1.__default.DomSt (Lit DatatypeTypeType |st#0@@14|)))
))))
(assert (forall ((d@@36 T@U) ) (!  (=> (M1.Literal.litTrue_q d@@36) (= d@@36 |#M1.Literal.litTrue|))
 :qid |unknown.0:0|
 :skolemid |2673|
 :pattern ( (M1.Literal.litTrue_q d@@36))
)))
(assert (forall ((d@@37 T@U) ) (!  (=> (M1.Literal.litFalse_q d@@37) (= d@@37 |#M1.Literal.litFalse|))
 :qid |unknown.0:0|
 :skolemid |2676|
 :pattern ( (M1.Literal.litFalse_q d@@37))
)))
(assert (forall ((d@@38 T@U) ) (!  (=> (M1.Literal.litUndefined_q d@@38) (= d@@38 |#M1.Literal.litUndefined|))
 :qid |unknown.0:0|
 :skolemid |2679|
 :pattern ( (M1.Literal.litUndefined_q d@@38))
)))
(assert (forall ((d@@39 T@U) ) (!  (=> (M1.Literal.litNull_q d@@39) (= d@@39 |#M1.Literal.litNull|))
 :qid |unknown.0:0|
 :skolemid |2682|
 :pattern ( (M1.Literal.litNull_q d@@39))
)))
(assert (forall ((d@@40 T@U) ) (!  (=> (M1.Primitive.primCreatePath_q d@@40) (= d@@40 |#M1.Primitive.primCreatePath|))
 :qid |unknown.0:0|
 :skolemid |2759|
 :pattern ( (M1.Primitive.primCreatePath_q d@@40))
)))
(assert (forall ((d@@41 T@U) ) (!  (=> (M1.Primitive.primExec_q d@@41) (= d@@41 |#M1.Primitive.primExec|))
 :qid |unknown.0:0|
 :skolemid |2761|
 :pattern ( (M1.Primitive.primExec_q d@@41))
)))
...
(assert (forall ((d@@42 T@U) ) (!  (=> (|$IsA#M1.Literal| d@@42) (or (or (or (or (or (or (or (or (or (M1.Literal.litTrue_q d@@42) (M1.Literal.litFalse_q d@@42)) (M1.Literal.litUndefined_q d@@42)) (M1.Literal.litNull_q d@@42)) (M1.Literal.litNumber_q d@@42)) (M1.Literal.litString_q d@@42)) (M1.Literal.litPrimitive_q d@@42)) (M1.Literal.litArrOfPaths_q d@@42)) (M1.Literal.litArrOfStrings_q d@@42)) (M1.Literal.litArray_q d@@42)))
 :qid |unknown.0:0|
 :skolemid |2745|
 :pattern ( (|$IsA#M1.Literal| d@@42))
)))
...
(assert (forall ((d@@43 T@U) ) (!  (=> (M1.State.StateCons_q d@@43) (exists ((|a#1#0#0@@0| T@U) ) (! (= d@@43 (|#M1.State.StateCons| |a#1#0#0@@0|))
 :qid |CloudMakeParallelBuildsdfy.433:30|
 :skolemid |2520|
)))
 :qid |unknown.0:0|
 :skolemid |2521|
 :pattern ( (M1.State.StateCons_q d@@43))
)))
(assert (forall ((d@@44 T@U) ) (!  (=> (M1.Program.Program_q d@@44) (exists ((|a#8#0#0| T@U) ) (! (= d@@44 (|#M1.Program.Program| |a#8#0#0|))
 :qid |CloudMakeParallelBuildsdfy.128:30|
 :skolemid |2535|
)))
 :qid |unknown.0:0|
 :skolemid |2536|
 :pattern ( (M1.Program.Program_q d@@44))
)))
(assert (forall ((d@@45 T@U) ) (!  (=> (M1.Statement.stmtReturn_q d@@45) (exists ((|a#22#0#0| T@U) ) (! (= d@@45 (|#M1.Statement.stmtReturn| |a#22#0#0|))
 :qid |CloudMakeParallelBuildsdfy.131:35|
 :skolemid |2562|
)))
 :qid |unknown.0:0|
 :skolemid |2563|
 :pattern ( (M1.Statement.stmtReturn_q d@@45))
)))
(assert (forall ((d@@46 T@U) ) (!  (=> (M1.Expression.exprLiteral_q d@@46) (exists ((|a#28#0#0| T@U) ) (! (= d@@46 (|#M1.Expression.exprLiteral| |a#28#0#0|))
 :qid |CloudMakeParallelBuildsdfy.133:37|
 :skolemid |2577|
)))
 :qid |unknown.0:0|
 :skolemid |2578|
 :pattern ( (M1.Expression.exprLiteral_q d@@46))
)))
(assert (forall ((d@@47 T@U) ) (!  (=> (M1.Expression.exprIdentifier_q d@@47) (exists ((|a#34#0#0| T@U) ) (! (= d@@47 (|#M1.Expression.exprIdentifier| |a#34#0#0|))
 :qid |CloudMakeParallelBuildsdfy.133:68|
 :skolemid |2588|
)))
 :qid |unknown.0:0|
 :skolemid |2589|
 :pattern ( (M1.Expression.exprIdentifier_q d@@47))
)))
(assert (forall ((d@@48 T@U) ) (!  (=> (M1.Expression.exprError_q d@@48) (exists ((|a#74#0#0| T@U) ) (! (= d@@48 (|#M1.Expression.exprError| |a#74#0#0|))
 :qid |CloudMakeParallelBuildsdfy.138:35|
 :skolemid |2653|
)))
 :qid |unknown.0:0|
 :skolemid |2654|
 :pattern ( (M1.Expression.exprError_q d@@48))
)))
(assert (forall ((d@@49 T@U) ) (!  (=> (M1.Literal.litNumber_q d@@49) (exists ((|a#96#0#0| Int) ) (! (= d@@49 (|#M1.Literal.litNumber| |a#96#0#0|))
 :qid |CloudMakeParallelBuildsdfy.141:32|
 :skolemid |2686|
)))
 :qid |unknown.0:0|
 :skolemid |2687|
 :pattern ( (M1.Literal.litNumber_q d@@49))
)))
(assert (forall ((d@@50 T@U) ) (!  (=> (M1.Literal.litString_q d@@50) (exists ((|a#101#0#0| T@U) ) (! (= d@@50 (|#M1.Literal.litString| |a#101#0#0|))
 :qid |CloudMakeParallelBuildsdfy.141:54|
 :skolemid |2695|
)))
 :qid |unknown.0:0|
 :skolemid |2696|
 :pattern ( (M1.Literal.litString_q d@@50))
)))
(assert (forall ((d@@51 T@U) ) (!  (=> (M1.Literal.litPrimitive_q d@@51) (exists ((|a#108#0#0| T@U) ) (! (= d@@51 (|#M1.Literal.litPrimitive| |a#108#0#0|))
 :qid |CloudMakeParallelBuildsdfy.142:35|
 :skolemid |2706|
)))
 :qid |unknown.0:0|
 :skolemid |2707|
 :pattern ( (M1.Literal.litPrimitive_q d@@51))
)))
(assert (forall ((d@@52 T@U) ) (!  (=> (M1.Literal.litArrOfPaths_q d@@52) (exists ((|a#114#0#0| T@U) ) (! (= d@@52 (|#M1.Literal.litArrOfPaths| |a#114#0#0|))
 :qid |CloudMakeParallelBuildsdfy.145:36|
 :skolemid |2716|
)))
 :qid |unknown.0:0|
 :skolemid |2717|
 :pattern ( (M1.Literal.litArrOfPaths_q d@@52))
)))
(assert (forall ((d@@53 T@U) ) (!  (=> (M1.Literal.litArrOfStrings_q d@@53) (exists ((|a#120#0#0| T@U) ) (! (= d@@53 (|#M1.Literal.litArrOfStrings| |a#120#0#0|))
 :qid |CloudMakeParallelBuildsdfy.146:38|
 :skolemid |2726|
)))
 :qid |unknown.0:0|
 :skolemid |2727|
 :pattern ( (M1.Literal.litArrOfStrings_q d@@53))
)))
(assert (forall ((d@@54 T@U) ) (!  (=> (M1.Literal.litArray_q d@@54) (exists ((|a#126#0#0| T@U) ) (! (= d@@54 (|#M1.Literal.litArray| |a#126#0#0|))
 :qid |CloudMakeParallelBuildsdfy.147:31|
 :skolemid |2736|
)))
 :qid |unknown.0:0|
 :skolemid |2737|
 :pattern ( (M1.Literal.litArray_q d@@54))
)))
(assert (forall ((d@@55 T@U) ) (!  (=> ($Is DatatypeTypeType d@@55 Tclass.M1.Expression) (or (or (or (or (or (or (M1.Expression.exprLiteral_q d@@55) (M1.Expression.exprIdentifier_q d@@55)) (M1.Expression.exprIf_q d@@55)) (M1.Expression.exprAnd_q d@@55)) (M1.Expression.exprOr_q d@@55)) (M1.Expression.exprInvocation_q d@@55)) (M1.Expression.exprError_q d@@55)))
 :qid |unknown.0:0|
 :skolemid |2663|
 :pattern ( (M1.Expression.exprError_q d@@55) ($Is DatatypeTypeType d@@55 Tclass.M1.Expression))
 :pattern ( (M1.Expression.exprInvocation_q d@@55) ($Is DatatypeTypeType d@@55 Tclass.M1.Expression))
 :pattern ( (M1.Expression.exprOr_q d@@55) ($Is DatatypeTypeType d@@55 Tclass.M1.Expression))
 :pattern ( (M1.Expression.exprAnd_q d@@55) ($Is DatatypeTypeType d@@55 Tclass.M1.Expression))
 :pattern ( (M1.Expression.exprIf_q d@@55) ($Is DatatypeTypeType d@@55 Tclass.M1.Expression))
 :pattern ( (M1.Expression.exprIdentifier_q d@@55) ($Is DatatypeTypeType d@@55 Tclass.M1.Expression))
 :pattern ( (M1.Expression.exprLiteral_q d@@55) ($Is DatatypeTypeType d@@55 Tclass.M1.Expression))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|cmd#0@@2| T@U) (|deps#0@@2| T@U) (|exps#0@@1| T@U) (|st#0@@15| T@U) ) (!  (=> (or (|M1.__default.exec#canCall| |cmd#0@@2| |deps#0@@2| |exps#0@@1| |st#0@@15|) (and (< 1 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@2| (TSeq TChar)) ($Is SetType |deps#0@@2| (TSet Tclass.M1.Path))) ($Is SetType |exps#0@@1| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@15| Tclass.M1.State)))) ($Is DatatypeTypeType (M1.__default.exec |cmd#0@@2| |deps#0@@2| |exps#0@@1| |st#0@@15|) (Tclass.M1.Tuple (TSet Tclass.M1.Path) Tclass.M1.State)))
 :qid |CloudMakeParallelBuildsdfy.69:23|
 :skolemid |2199|
 :pattern ( (M1.__default.exec |cmd#0@@2| |deps#0@@2| |exps#0@@1| |st#0@@15|))
))))
...
(assert  (=> (<= 7 $FunctionContextHeight) (forall ((|prog#0| T@U) (|st#0@@16| T@U) ) (!  (=> (or (|M1.__default.build#canCall| |prog#0| |st#0@@16|) (and (< 7 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |prog#0| Tclass.M1.Program) ($Is DatatypeTypeType |st#0@@16| Tclass.M1.State)) (M1.__default.Legal (M1.Program.stmts |prog#0|))))) ($Is DatatypeTypeType (M1.__default.build |prog#0| |st#0@@16|) (Tclass.M1.Tuple Tclass.M1.Expression Tclass.M1.State)))
 :qid |CloudMakeParallelBuildsdfy.170:24|
 :skolemid |2338|
 :pattern ( (M1.__default.build |prog#0| |st#0@@16|))
))))
...
(assert (forall ((d@@56 T@U) ) (!  (=> ($Is DatatypeTypeType d@@56 Tclass.M1.Literal) (or (or (or (or (or (or (or (or (or (M1.Literal.litTrue_q d@@56) (M1.Literal.litFalse_q d@@56)) (M1.Literal.litUndefined_q d@@56)) (M1.Literal.litNull_q d@@56)) (M1.Literal.litNumber_q d@@56)) (M1.Literal.litString_q d@@56)) (M1.Literal.litPrimitive_q d@@56)) (M1.Literal.litArrOfPaths_q d@@56)) (M1.Literal.litArrOfStrings_q d@@56)) (M1.Literal.litArray_q d@@56)))
 :qid |unknown.0:0|
 :skolemid |2746|
 :pattern ( (M1.Literal.litArray_q d@@56) ($Is DatatypeTypeType d@@56 Tclass.M1.Literal))
 :pattern ( (M1.Literal.litArrOfStrings_q d@@56) ($Is DatatypeTypeType d@@56 Tclass.M1.Literal))
 :pattern ( (M1.Literal.litArrOfPaths_q d@@56) ($Is DatatypeTypeType d@@56 Tclass.M1.Literal))
 :pattern ( (M1.Literal.litPrimitive_q d@@56) ($Is DatatypeTypeType d@@56 Tclass.M1.Literal))
 :pattern ( (M1.Literal.litString_q d@@56) ($Is DatatypeTypeType d@@56 Tclass.M1.Literal))
 :pattern ( (M1.Literal.litNumber_q d@@56) ($Is DatatypeTypeType d@@56 Tclass.M1.Literal))
 :pattern ( (M1.Literal.litNull_q d@@56) ($Is DatatypeTypeType d@@56 Tclass.M1.Literal))
 :pattern ( (M1.Literal.litUndefined_q d@@56) ($Is DatatypeTypeType d@@56 Tclass.M1.Literal))
 :pattern ( (M1.Literal.litFalse_q d@@56) ($Is DatatypeTypeType d@@56 Tclass.M1.Literal))
 :pattern ( (M1.Literal.litTrue_q d@@56) ($Is DatatypeTypeType d@@56 Tclass.M1.Literal))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|p#0@@6| T@U) (|st#0@@17| T@U) ) (!  (=> (or (|M1.__default.GetSt#canCall| |p#0@@6| (Lit DatatypeTypeType |st#0@@17|)) (and (< 2 $FunctionContextHeight) (and (and ($IsBox |p#0@@6| Tclass.M1.Path) ($Is DatatypeTypeType |st#0@@17| Tclass.M1.State)) (|Set#IsMember| (Lit SetType (M1.__default.DomSt (Lit DatatypeTypeType |st#0@@17|))) |p#0@@6|)))) (and (M1.State.StateCons_q (Lit DatatypeTypeType |st#0@@17|)) (= (M1.__default.GetSt |p#0@@6| (Lit DatatypeTypeType |st#0@@17|)) (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType (M1.State.m (Lit DatatypeTypeType |st#0@@17|)))) |p#0@@6|))))
 :qid |CloudMakeParallelBuildsdfy.10:24|
 :weight 3
 :skolemid |2088|
 :pattern ( (M1.__default.GetSt |p#0@@6| (Lit DatatypeTypeType |st#0@@17|)))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|cmd#0@@3| T@U) (|deps#0@@3| T@U) (|exps#0@@2| T@U) (|st#0@@18| T@U) ) (!  (=> (or (|M1.__default.Pre#canCall| (Lit SeqType |cmd#0@@3|) (Lit SetType |deps#0@@3|) (Lit SetType |exps#0@@2|) |st#0@@18|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@3| (TSeq TChar)) ($Is SetType |deps#0@@3| (TSet Tclass.M1.Path))) ($Is SetType |exps#0@@2| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@18| Tclass.M1.State)))) (and (forall ((|e#1| T@U) ) (!  (=> ($Is SeqType |e#1| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@2|) ($Box SeqType |e#1|)) (and (and (|M1.__default.Loc#canCall| (Lit SeqType |cmd#0@@3|) (Lit SetType |deps#0@@3|) |e#1|) (|M1.__default.DomSt#canCall| |st#0@@18|)) (=> (|Set#IsMember| (M1.__default.DomSt |st#0@@18|) (M1.__default.Loc (Lit SeqType |cmd#0@@3|) (Lit SetType |deps#0@@3|) |e#1|)) (and (and (|M1.__default.Loc#canCall| (Lit SeqType |cmd#0@@3|) (Lit SetType |deps#0@@3|) |e#1|) (|M1.__default.GetSt#canCall| (M1.__default.Loc (Lit SeqType |cmd#0@@3|) (Lit SetType |deps#0@@3|) |e#1|) |st#0@@18|)) (and (|M1.__default.Loc#canCall| (Lit SeqType |cmd#0@@3|) (Lit SetType |deps#0@@3|) |e#1|) (|M1.__default.Oracle#canCall| (M1.__default.Loc (Lit SeqType |cmd#0@@3|) (Lit SetType |deps#0@@3|) |e#1|) |st#0@@18|)))))))
...
)) (= (M1.__default.Pre (Lit SeqType |cmd#0@@3|) (Lit SetType |deps#0@@3|) (Lit SetType |exps#0@@2|) |st#0@@18|) (forall ((|e#1@@0| T@U) ) (!  (=> ($Is SeqType |e#1@@0| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@2|) ($Box SeqType |e#1@@0|)) (=> (|Set#IsMember| (M1.__default.DomSt |st#0@@18|) (M1.__default.Loc (Lit SeqType |cmd#0@@3|) (Lit SetType |deps#0@@3|) |e#1@@0|)) (= (M1.__default.GetSt (M1.__default.Loc (Lit SeqType |cmd#0@@3|) (Lit SetType |deps#0@@3|) |e#1@@0|) |st#0@@18|) (M1.__default.Oracle (M1.__default.Loc (Lit SeqType |cmd#0@@3|) (Lit SetType |deps#0@@3|) |e#1@@0|) |st#0@@18|)))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |2221|
 ...
 :weight 3
 :skolemid |2223|
 :pattern ( (M1.__default.Pre (Lit SeqType |cmd#0@@3|) (Lit SetType |deps#0@@3|) (Lit SetType |exps#0@@2|) |st#0@@18|))
))))
...
(assert (forall ((a@@12 T@U) (b@@9 T@U) ) (!  (=> (and (M1.Literal.litString_q a@@12) (M1.Literal.litString_q b@@9)) (= (|M1.Literal#Equal| a@@12 b@@9) (|Seq#Equal| (M1.Literal.str a@@12) (M1.Literal.str b@@9))))
 :qid |unknown.0:0|
 :skolemid |2752|
 :pattern ( (|M1.Literal#Equal| a@@12 b@@9) (M1.Literal.litString_q a@@12))
 :pattern ( (|M1.Literal#Equal| a@@12 b@@9) (M1.Literal.litString_q b@@9))
)))
(assert (forall ((a@@13 T@U) (b@@10 T@U) ) (!  (=> (and (M1.Literal.litPrimitive_q a@@13) (M1.Literal.litPrimitive_q b@@10)) (= (|M1.Literal#Equal| a@@13 b@@10) (|M1.Primitive#Equal| (M1.Literal.prim a@@13) (M1.Literal.prim b@@10))))
 :qid |unknown.0:0|
 :skolemid |2753|
 :pattern ( (|M1.Literal#Equal| a@@13 b@@10) (M1.Literal.litPrimitive_q a@@13))
 :pattern ( (|M1.Literal#Equal| a@@13 b@@10) (M1.Literal.litPrimitive_q b@@10))
)))
(assert (forall ((a@@14 T@U) (b@@11 T@U) ) (!  (=> (and (M1.Literal.litArrOfPaths_q a@@14) (M1.Literal.litArrOfPaths_q b@@11)) (= (|M1.Literal#Equal| a@@14 b@@11) (|Set#Equal| (M1.Literal.paths a@@14) (M1.Literal.paths b@@11))))
 :qid |unknown.0:0|
 :skolemid |2754|
 :pattern ( (|M1.Literal#Equal| a@@14 b@@11) (M1.Literal.litArrOfPaths_q a@@14))
 :pattern ( (|M1.Literal#Equal| a@@14 b@@11) (M1.Literal.litArrOfPaths_q b@@11))
)))
(assert (forall ((a@@15 T@U) (b@@12 T@U) ) (!  (=> (and (M1.Literal.litArrOfStrings_q a@@15) (M1.Literal.litArrOfStrings_q b@@12)) (= (|M1.Literal#Equal| a@@15 b@@12) (|Set#Equal| (M1.Literal.strs a@@15) (M1.Literal.strs b@@12))))
 :qid |unknown.0:0|
 :skolemid |2755|
 :pattern ( (|M1.Literal#Equal| a@@15 b@@12) (M1.Literal.litArrOfStrings_q a@@15))
 :pattern ( (|M1.Literal#Equal| a@@15 b@@12) (M1.Literal.litArrOfStrings_q b@@12))
)))
(assert (forall ((a@@16 T@U) (b@@13 T@U) ) (!  (=> (and (M1.Literal.litArray_q a@@16) (M1.Literal.litArray_q b@@13)) (= (|M1.Literal#Equal| a@@16 b@@13) (|Seq#Equal| (M1.Literal.arr a@@16) (M1.Literal.arr b@@13))))
 :qid |unknown.0:0|
 :skolemid |2756|
 :pattern ( (|M1.Literal#Equal| a@@16 b@@13) (M1.Literal.litArray_q a@@16))
 :pattern ( (|M1.Literal#Equal| a@@16 b@@13) (M1.Literal.litArray_q b@@13))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|sts#0@@1| T@U) ) (!  (=> (or (|M1.__default.Compatible#canCall| (Lit SetType |sts#0@@1|)) (and (< 3 $FunctionContextHeight) ($Is SetType |sts#0@@1| (TSet Tclass.M1.State)))) (and (forall ((|st#1| T@U) (|st'#1| T@U) (|p#1| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |st#1| Tclass.M1.State) ($Is DatatypeTypeType |st'#1| Tclass.M1.State)) ($IsBox |p#1| Tclass.M1.Path)) (=> (|Set#IsMember| (Lit SetType |sts#0@@1|) ($Box DatatypeTypeType |st#1|)) (=> (|Set#IsMember| (Lit SetType |sts#0@@1|) ($Box DatatypeTypeType |st'#1|)) (and (|M1.__default.DomSt#canCall| |st#1|) (=> (|Set#IsMember| (M1.__default.DomSt |st#1|) |p#1|) (and (|M1.__default.DomSt#canCall| |st'#1|) (=> (|Set#IsMember| (M1.__default.DomSt |st'#1|) |p#1|) (and (|M1.__default.GetSt#canCall| |p#1| |st#1|) (|M1.__default.GetSt#canCall| |p#1| |st'#1|)))))))))
 :qid |CloudMakeParallelBuildsdfy.32:12|
 :skolemid |2137|
 :pattern ( (M1.__default.GetSt |p#1| |st'#1|) (M1.__default.GetSt |p#1| |st#1|))
 :pattern ( (M1.__default.GetSt |p#1| |st'#1|) (M1.__default.DomSt |st#1|))
 :pattern ( (M1.__default.GetSt |p#1| |st'#1|) (|Set#IsMember| |sts#0@@1| ($Box DatatypeTypeType |st#1|)))
 :pattern ( (M1.__default.GetSt |p#1| |st#1|) (M1.__default.DomSt |st'#1|))
 :pattern ( (M1.__default.GetSt |p#1| |st#1|) (|Set#IsMember| |sts#0@@1| ($Box DatatypeTypeType |st'#1|)))
 :pattern ( (|Set#IsMember| (M1.__default.DomSt |st'#1|) |p#1|) (M1.__default.DomSt |st#1|))
 :pattern ( (|Set#IsMember| (M1.__default.DomSt |st'#1|) |p#1|) (|Set#IsMember| |sts#0@@1| ($Box DatatypeTypeType |st#1|)))
 :pattern ( (M1.__default.DomSt |st'#1|) (|Set#IsMember| (M1.__default.DomSt |st#1|) |p#1|))
 :pattern ( (|Set#IsMember| (M1.__default.DomSt |st#1|) |p#1|) (|Set#IsMember| |sts#0@@1| ($Box DatatypeTypeType |st'#1|)))
)) (= (M1.__default.Compatible (Lit SetType |sts#0@@1|)) (forall ((|st#1@@0| T@U) (|st'#1@@0| T@U) (|p#1@@0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |st#1@@0| Tclass.M1.State) ($Is DatatypeTypeType |st'#1@@0| Tclass.M1.State)) ($IsBox |p#1@@0| Tclass.M1.Path)) (=> (and (and (and (|Set#IsMember| (Lit SetType |sts#0@@1|) ($Box DatatypeTypeType |st#1@@0|)) (|Set#IsMember| (Lit SetType |sts#0@@1|) ($Box DatatypeTypeType |st'#1@@0|))) (|Set#IsMember| (M1.__default.DomSt |st#1@@0|) |p#1@@0|)) (|Set#IsMember| (M1.__default.DomSt |st'#1@@0|) |p#1@@0|)) (= (M1.__default.GetSt |p#1@@0| |st#1@@0|) (M1.__default.GetSt |p#1@@0| |st'#1@@0|))))
 :qid |CloudMakeParallelBuildsdfy.32:12|
 :skolemid |2136|
 :pattern ( (M1.__default.GetSt |p#1@@0| |st'#1@@0|) (M1.__default.GetSt |p#1@@0| |st#1@@0|))
 :pattern ( (M1.__default.GetSt |p#1@@0| |st'#1@@0|) (M1.__default.DomSt |st#1@@0|))
 :pattern ( (M1.__default.GetSt |p#1@@0| |st'#1@@0|) (|Set#IsMember| |sts#0@@1| ($Box DatatypeTypeType |st#1@@0|)))
 :pattern ( (M1.__default.GetSt |p#1@@0| |st#1@@0|) (M1.__default.DomSt |st'#1@@0|))
 :pattern ( (M1.__default.GetSt |p#1@@0| |st#1@@0|) (|Set#IsMember| |sts#0@@1| ($Box DatatypeTypeType |st'#1@@0|)))
 :pattern ( (|Set#IsMember| (M1.__default.DomSt |st'#1@@0|) |p#1@@0|) (M1.__default.DomSt |st#1@@0|))
 :pattern ( (|Set#IsMember| (M1.__default.DomSt |st'#1@@0|) |p#1@@0|) (|Set#IsMember| |sts#0@@1| ($Box DatatypeTypeType |st#1@@0|)))
 :pattern ( (M1.__default.DomSt |st'#1@@0|) (|Set#IsMember| (M1.__default.DomSt |st#1@@0|) |p#1@@0|))
 :pattern ( (|Set#IsMember| (M1.__default.DomSt |st#1@@0|) |p#1@@0|) (|Set#IsMember| |sts#0@@1| ($Box DatatypeTypeType |st'#1@@0|)))
)))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@8 T@U) (|stmts#0@@3| T@U) (|st#0@@19| T@U) (|env#0@@8| T@U) ) (!  (=> (or (|M1.__default.do#canCall| |stmts#0@@3| |st#0@@19| |env#0@@8|) (and (< 6 $FunctionContextHeight) (and (and (and ($Is SeqType |stmts#0@@3| (TSeq Tclass.M1.Statement)) ($Is DatatypeTypeType |st#0@@19| Tclass.M1.State)) ($IsBox |env#0@@8| Tclass.M1.Env)) (and (M1.__default.Legal |stmts#0@@3|) (M1.__default.ValidEnv |env#0@@8|))))) (and (let ((|stmt#0| ($Unbox DatatypeTypeType (|Seq#Index| |stmts#0@@3| (LitInt 0)))))
 (and (=> (M1.Statement.stmtVariable_q |stmt#0|) (and (|M1.__default.eval#canCall| (M1.Statement.expr |stmt#0|) |st#0@@19| |env#0@@8|) (let ((|st'#0@@0| ($Unbox DatatypeTypeType (M1.Tuple.snd (M1.__default.eval ($LS $LZ) (M1.Statement.expr |stmt#0|) |st#0@@19| |env#0@@8|)))))
(let ((|expr'#0| ($Unbox DatatypeTypeType (M1.Tuple.fst (M1.__default.eval ($LS $LZ) (M1.Statement.expr |stmt#0|) |st#0@@19| |env#0@@8|)))))
 ...
 (and (|M1.__default.Legal#canCall| (|Seq#Drop| |stmts#0@@3| (LitInt 1))) (=> (M1.__default.Legal (|Seq#Drop| |stmts#0@@3| (LitInt 1))) (|M1.__default.do#canCall| (|Seq#Drop| |stmts#0@@3| (LitInt 1)) |st'#0@@0| |env'#0|))))))))))) (=> (not (M1.Statement.stmtVariable_q |stmt#0|)) (|M1.__default.eval#canCall| (M1.Statement.ret |stmt#0|) |st#0@@19| |env#0@@8|)))) (= (M1.__default.do ($LS $ly@@8) |stmts#0@@3| |st#0@@19| |env#0@@8|) (let ((|stmt#0@@0| ($Unbox DatatypeTypeType (|Seq#Index| |stmts#0@@3| (LitInt 0)))))
(ite (M1.Statement.stmtVariable_q |stmt#0@@0|) (let ((|st'#0@@1| ($Unbox DatatypeTypeType (M1.Tuple.snd (M1.__default.eval ($LS $LZ) (M1.Statement.expr |stmt#0@@0|) |st#0@@19| |env#0@@8|)))))
(let ((|expr'#0@@0| ($Unbox DatatypeTypeType (M1.Tuple.fst (M1.__default.eval ($LS $LZ) (M1.Statement.expr |stmt#0@@0|) |st#0@@19| |env#0@@8|)))))
(ite (M1.__default.Value |expr'#0@@0|) (let ((|env'#0@@0| (M1.__default.SetEnv (M1.Statement.id |stmt#0@@0|) |expr'#0@@0| |env#0@@8|)))
(ite (M1.__default.Legal (|Seq#Drop| |stmts#0@@3| (LitInt 1))) (M1.__default.do $ly@@8 (|Seq#Drop| |stmts#0@@3| (LitInt 1)) |st'#0@@1| |env'#0@@0|) (|#M1.Tuple.Pair| ($Box DatatypeTypeType |expr'#0@@0|) ($Box DatatypeTypeType |st'#0@@1|)))) (|#M1.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M1.Expression.exprError| (Lit DatatypeTypeType |#M1.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@19|))))) (M1.__default.eval ($LS $LZ) (M1.Statement.ret |stmt#0@@0|) |st#0@@19| |env#0@@8|))))))
 :qid |CloudMakeParallelBuildsdfy.177:18|
 :skolemid |2353|
 :pattern ( (M1.__default.do ($LS $ly@@8) |stmts#0@@3| |st#0@@19| |env#0@@8|))
))))
...
(assert  (=> (<= 7 $FunctionContextHeight) (forall (($Heap@@8 T@U) (|prog#0@@0| T@U) (|st#0@@20| T@U) ) (!  (=> (and (or (|M1.__default.build#canCall| |prog#0@@0| |st#0@@20|) (and (< 7 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |prog#0@@0| Tclass.M1.Program) ($IsAlloc DatatypeTypeType |prog#0@@0| Tclass.M1.Program $Heap@@8)) (and ($Is DatatypeTypeType |st#0@@20| Tclass.M1.State) ($IsAlloc DatatypeTypeType |st#0@@20| Tclass.M1.State $Heap@@8))) (M1.__default.Legal (M1.Program.stmts |prog#0@@0|))))) ($IsGoodHeap $Heap@@8)) ($IsAlloc DatatypeTypeType (M1.__default.build |prog#0@@0| |st#0@@20|) (Tclass.M1.Tuple Tclass.M1.Expression Tclass.M1.State) $Heap@@8))
 :qid |CloudMakeParallelBuildsdfy.170:18|
 :skolemid |2339|
 :pattern ( ($IsAlloc DatatypeTypeType (M1.__default.build |prog#0@@0| |st#0@@20|) (Tclass.M1.Tuple Tclass.M1.Expression Tclass.M1.State) $Heap@@8))
))))
...
(assert  (=> (<= 7 $FunctionContextHeight) (forall ((|prog#0@@1| T@U) (|st#0@@22| T@U) ) (!  (=> (or (|M1.__default.build#canCall| |prog#0@@1| |st#0@@22|) (and (< 7 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |prog#0@@1| Tclass.M1.Program) ($Is DatatypeTypeType |st#0@@22| Tclass.M1.State)) (M1.__default.Legal (M1.Program.stmts |prog#0@@1|))))) (and (and (and (M1.Program.Program_q |prog#0@@1|) |M1.__default.EmptyEnv#canCall|) (|M1.__default.do#canCall| (M1.Program.stmts |prog#0@@1|) |st#0@@22| M1.__default.EmptyEnv)) (= (M1.__default.build |prog#0@@1| |st#0@@22|) (M1.__default.do ($LS $LZ) (M1.Program.stmts |prog#0@@1|) |st#0@@22| M1.__default.EmptyEnv))))
 :qid |CloudMakeParallelBuildsdfy.170:24|
 :skolemid |2341|
 :pattern ( (M1.__default.build |prog#0@@1| |st#0@@22|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|sts#0@@3| T@U) ) (!  (=> (or (|M1.__default.Compatible#canCall| |sts#0@@3|) (and (< 3 $FunctionContextHeight) ($Is SetType |sts#0@@3| (TSet Tclass.M1.State)))) (and (forall ((|st#0@@23| T@U) (|st'#0@@4| T@U) (|p#0@@7| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |st#0@@23| Tclass.M1.State) ($Is DatatypeTypeType |st'#0@@4| Tclass.M1.State)) ($IsBox |p#0@@7| Tclass.M1.Path)) (=> (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st#0@@23|)) (=> (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st'#0@@4|)) (and (|M1.__default.DomSt#canCall| |st#0@@23|) (=> (|Set#IsMember| (M1.__default.DomSt |st#0@@23|) |p#0@@7|) (and (|M1.__default.DomSt#canCall| |st'#0@@4|) (=> (|Set#IsMember| (M1.__default.DomSt |st'#0@@4|) |p#0@@7|) (and (|M1.__default.GetSt#canCall| |p#0@@7| |st#0@@23|) (|M1.__default.GetSt#canCall| |p#0@@7| |st'#0@@4|)))))))))
 :qid |CloudMakeParallelBuildsdfy.32:12|
 :skolemid |2134|
 :pattern ( (M1.__default.GetSt |p#0@@7| |st'#0@@4|) (M1.__default.GetSt |p#0@@7| |st#0@@23|))
 :pattern ( (M1.__default.GetSt |p#0@@7| |st'#0@@4|) (M1.__default.DomSt |st#0@@23|))
 :pattern ( (M1.__default.GetSt |p#0@@7| |st'#0@@4|) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st#0@@23|)))
 :pattern ( (M1.__default.GetSt |p#0@@7| |st#0@@23|) (M1.__default.DomSt |st'#0@@4|))
 :pattern ( (M1.__default.GetSt |p#0@@7| |st#0@@23|) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st'#0@@4|)))
 :pattern ( (|Set#IsMember| (M1.__default.DomSt |st'#0@@4|) |p#0@@7|) (M1.__default.DomSt |st#0@@23|))
 :pattern ( (|Set#IsMember| (M1.__default.DomSt |st'#0@@4|) |p#0@@7|) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st#0@@23|)))
 :pattern ( (M1.__default.DomSt |st'#0@@4|) (|Set#IsMember| (M1.__default.DomSt |st#0@@23|) |p#0@@7|))
 :pattern ( (|Set#IsMember| (M1.__default.DomSt |st#0@@23|) |p#0@@7|) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st'#0@@4|)))
)) (= (M1.__default.Compatible |sts#0@@3|) (forall ((|st#0@@24| T@U) (|st'#0@@5| T@U) (|p#0@@8| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |st#0@@24| Tclass.M1.State) ($Is DatatypeTypeType |st'#0@@5| Tclass.M1.State)) ($IsBox |p#0@@8| Tclass.M1.Path)) (=> (and (and (and (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st#0@@24|)) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st'#0@@5|))) (|Set#IsMember| (M1.__default.DomSt |st#0@@24|) |p#0@@8|)) (|Set#IsMember| (M1.__default.DomSt |st'#0@@5|) |p#0@@8|)) (= (M1.__default.GetSt |p#0@@8| |st#0@@24|) (M1.__default.GetSt |p#0@@8| |st'#0@@5|))))
 :qid |CloudMakeParallelBuildsdfy.32:12|
 :skolemid |2133|
 :pattern ( (M1.__default.GetSt |p#0@@8| |st'#0@@5|) (M1.__default.GetSt |p#0@@8| |st#0@@24|))
 :pattern ( (M1.__default.GetSt |p#0@@8| |st'#0@@5|) (M1.__default.DomSt |st#0@@24|))
 :pattern ( (M1.__default.GetSt |p#0@@8| |st'#0@@5|) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st#0@@24|)))
 :pattern ( (M1.__default.GetSt |p#0@@8| |st#0@@24|) (M1.__default.DomSt |st'#0@@5|))
 :pattern ( (M1.__default.GetSt |p#0@@8| |st#0@@24|) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st'#0@@5|)))
 :pattern ( (|Set#IsMember| (M1.__default.DomSt |st'#0@@5|) |p#0@@8|) (M1.__default.DomSt |st#0@@24|))
 :pattern ( (|Set#IsMember| (M1.__default.DomSt |st'#0@@5|) |p#0@@8|) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st#0@@24|)))
 :pattern ( (M1.__default.DomSt |st'#0@@5|) (|Set#IsMember| (M1.__default.DomSt |st#0@@24|) |p#0@@8|))
 :pattern ( (|Set#IsMember| (M1.__default.DomSt |st#0@@24|) |p#0@@8|) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st'#0@@5|)))
)))))
 :qid |CloudMakeParallelBuildsdfy.30:30|
 :skolemid |2135|
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@12 T@U) (|stmts#0@@4| T@U) (|st#0@@25| T@U) (|env#0@@11| T@U) ) (!  (=> (or (|M1.__default.do#canCall| (Lit SeqType |stmts#0@@4|) |st#0@@25| |env#0@@11|) (and (< 6 $FunctionContextHeight) (and (and (and ($Is SeqType |stmts#0@@4| (TSeq Tclass.M1.Statement)) ($Is DatatypeTypeType |st#0@@25| Tclass.M1.State)) ($IsBox |env#0@@11| Tclass.M1.Env)) (and (M1.__default.Legal (Lit SeqType |stmts#0@@4|)) (M1.__default.ValidEnv |env#0@@11|))))) (and (let ((|stmt#1| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |stmts#0@@4|) (LitInt 0)))))
 (and (=> (M1.Statement.stmtVariable_q |stmt#1|) (and (|M1.__default.eval#canCall| (M1.Statement.expr |stmt#1|) |st#0@@25| |env#0@@11|) (let ((|st'#1@@3| ($Unbox DatatypeTypeType (M1.Tuple.snd (M1.__default.eval ($LS $LZ) (M1.Statement.expr |stmt#1|) |st#0@@25| |env#0@@11|)))))
(let ((|expr'#1| ($Unbox DatatypeTypeType (M1.Tuple.fst (M1.__default.eval ($LS $LZ) (M1.Statement.expr |stmt#1|) |st#0@@25| |env#0@@11|)))))
 ...
 (and (|M1.__default.Legal#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@4|) (LitInt 1)))) (=> (U_2_bool (Lit boolType (bool_2_U (M1.__default.Legal (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@4|) (LitInt 1))))))) (|M1.__default.do#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@4|) (LitInt 1))) |st'#1@@3| |env'#1|))))))))))) (=> (not (M1.Statement.stmtVariable_q |stmt#1|)) (|M1.__default.eval#canCall| (M1.Statement.ret |stmt#1|) |st#0@@25| |env#0@@11|)))) (= (M1.__default.do ($LS $ly@@12) (Lit SeqType |stmts#0@@4|) |st#0@@25| |env#0@@11|) (let ((|stmt#1@@0| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |stmts#0@@4|) (LitInt 0)))))
(ite (M1.Statement.stmtVariable_q |stmt#1@@0|) (let ((|st'#1@@4| ($Unbox DatatypeTypeType (M1.Tuple.snd (M1.__default.eval ($LS $LZ) (M1.Statement.expr |stmt#1@@0|) |st#0@@25| |env#0@@11|)))))
(let ((|expr'#1@@0| ($Unbox DatatypeTypeType (M1.Tuple.fst (M1.__default.eval ($LS $LZ) (M1.Statement.expr |stmt#1@@0|) |st#0@@25| |env#0@@11|)))))
(ite (M1.__default.Value |expr'#1@@0|) (let ((|env'#1@@0| (M1.__default.SetEnv (M1.Statement.id |stmt#1@@0|) |expr'#1@@0| |env#0@@11|)))
(ite (M1.__default.Legal (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@4|) (LitInt 1)))) (M1.__default.do ($LS $ly@@12) (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@4|) (LitInt 1))) |st'#1@@4| |env'#1@@0|) (|#M1.Tuple.Pair| ($Box DatatypeTypeType |expr'#1@@0|) ($Box DatatypeTypeType |st'#1@@4|)))) (|#M1.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M1.Expression.exprError| (Lit DatatypeTypeType |#M1.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@25|))))) (M1.__default.eval ($LS $LZ) (M1.Statement.ret |stmt#1@@0|) |st#0@@25| |env#0@@11|))))))
 :qid |CloudMakeParallelBuildsdfy.177:18|
 :weight 3
 :skolemid |2354|
 :pattern ( (M1.__default.do ($LS $ly@@12) (Lit SeqType |stmts#0@@4|) |st#0@@25| |env#0@@11|))
))))
...
(assert (forall ((d@@57 T@U) ) (!  (=> ($Is DatatypeTypeType d@@57 Tclass.M1.Statement) (or (M1.Statement.stmtVariable_q d@@57) (M1.Statement.stmtReturn_q d@@57)))
 :qid |unknown.0:0|
 :skolemid |2571|
 :pattern ( (M1.Statement.stmtReturn_q d@@57) ($Is DatatypeTypeType d@@57 Tclass.M1.Statement))
 :pattern ( (M1.Statement.stmtVariable_q d@@57) ($Is DatatypeTypeType d@@57 Tclass.M1.Statement))
)))
(assert (forall ((d@@58 T@U) ) (!  (=> ($Is DatatypeTypeType d@@58 Tclass.M1.Primitive) (or (M1.Primitive.primCreatePath_q d@@58) (M1.Primitive.primExec_q d@@58)))
 :qid |unknown.0:0|
 :skolemid |2764|
 :pattern ( (M1.Primitive.primExec_q d@@58) ($Is DatatypeTypeType d@@58 Tclass.M1.Primitive))
 :pattern ( (M1.Primitive.primCreatePath_q d@@58) ($Is DatatypeTypeType d@@58 Tclass.M1.Primitive))
)))
...
(assert  (=> (<= 7 $FunctionContextHeight) (forall ((|prog#0@@2| T@U) (|st#0@@26| T@U) ) (!  (=> (or (|M1.__default.build#canCall| (Lit DatatypeTypeType |prog#0@@2|) |st#0@@26|) (and (< 7 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |prog#0@@2| Tclass.M1.Program) ($Is DatatypeTypeType |st#0@@26| Tclass.M1.State)) (U_2_bool (Lit boolType (bool_2_U (M1.__default.Legal (Lit SeqType (M1.Program.stmts (Lit DatatypeTypeType |prog#0@@2|)))))))))) (and (and (and (M1.Program.Program_q (Lit DatatypeTypeType |prog#0@@2|)) |M1.__default.EmptyEnv#canCall|) (|M1.__default.do#canCall| (Lit SeqType (M1.Program.stmts (Lit DatatypeTypeType |prog#0@@2|))) |st#0@@26| M1.__default.EmptyEnv)) (= (M1.__default.build (Lit DatatypeTypeType |prog#0@@2|) |st#0@@26|) (M1.__default.do ($LS $LZ) (Lit SeqType (M1.Program.stmts (Lit DatatypeTypeType |prog#0@@2|))) |st#0@@26| M1.__default.EmptyEnv))))
 :qid |CloudMakeParallelBuildsdfy.170:24|
 :weight 3
 :skolemid |2342|
 :pattern ( (M1.__default.build (Lit DatatypeTypeType |prog#0@@2|) |st#0@@26|))
))))
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@13 T@U) (|expr#0@@3| T@U) (|st#0@@27| T@U) (|env#0@@13| T@U) ) (!  (=> (or (|M1.__default.eval#canCall| |expr#0@@3| |st#0@@27| |env#0@@13|) (and (< 5 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0@@3| Tclass.M1.Expression) ($Is DatatypeTypeType |st#0@@27| Tclass.M1.State)) ($IsBox |env#0@@13| Tclass.M1.Env)) (M1.__default.ValidEnv |env#0@@13|)))) ($Is DatatypeTypeType (M1.__default.eval $ly@@13 |expr#0@@3| |st#0@@27| |env#0@@13|) (Tclass.M1.Tuple Tclass.M1.Expression Tclass.M1.State)))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |2370|
 :pattern ( (M1.__default.eval $ly@@13 |expr#0@@3| |st#0@@27| |env#0@@13|))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@14 T@U) (|stmts#0@@5| T@U) (|st#0@@28| T@U) (|env#0@@14| T@U) ) (!  (=> (or (|M1.__default.do#canCall| |stmts#0@@5| |st#0@@28| |env#0@@14|) (and (< 6 $FunctionContextHeight) (and (and (and ($Is SeqType |stmts#0@@5| (TSeq Tclass.M1.Statement)) ($Is DatatypeTypeType |st#0@@28| Tclass.M1.State)) ($IsBox |env#0@@14| Tclass.M1.Env)) (and (M1.__default.Legal |stmts#0@@5|) (M1.__default.ValidEnv |env#0@@14|))))) ($Is DatatypeTypeType (M1.__default.do $ly@@14 |stmts#0@@5| |st#0@@28| |env#0@@14|) (Tclass.M1.Tuple Tclass.M1.Expression Tclass.M1.State)))
 :qid |CloudMakeParallelBuildsdfy.177:18|
 :skolemid |2350|
 :pattern ( (M1.__default.do $ly@@14 |stmts#0@@5| |st#0@@28| |env#0@@14|))
))))
...
(assert (forall ((a@@21 T@U) (b@@18 T@U) ) (!  (=> (and (M1.Literal.litTrue_q a@@21) (M1.Literal.litTrue_q b@@18)) (|M1.Literal#Equal| a@@21 b@@18))
 :qid |unknown.0:0|
 :skolemid |2747|
 :pattern ( (|M1.Literal#Equal| a@@21 b@@18) (M1.Literal.litTrue_q a@@21))
 :pattern ( (|M1.Literal#Equal| a@@21 b@@18) (M1.Literal.litTrue_q b@@18))
)))
(assert (forall ((a@@22 T@U) (b@@19 T@U) ) (!  (=> (and (M1.Literal.litFalse_q a@@22) (M1.Literal.litFalse_q b@@19)) (|M1.Literal#Equal| a@@22 b@@19))
 :qid |unknown.0:0|
 :skolemid |2748|
 :pattern ( (|M1.Literal#Equal| a@@22 b@@19) (M1.Literal.litFalse_q a@@22))
 :pattern ( (|M1.Literal#Equal| a@@22 b@@19) (M1.Literal.litFalse_q b@@19))
)))
(assert (forall ((a@@23 T@U) (b@@20 T@U) ) (!  (=> (and (M1.Literal.litUndefined_q a@@23) (M1.Literal.litUndefined_q b@@20)) (|M1.Literal#Equal| a@@23 b@@20))
 :qid |unknown.0:0|
 :skolemid |2749|
 :pattern ( (|M1.Literal#Equal| a@@23 b@@20) (M1.Literal.litUndefined_q a@@23))
 :pattern ( (|M1.Literal#Equal| a@@23 b@@20) (M1.Literal.litUndefined_q b@@20))
)))
(assert (forall ((a@@24 T@U) (b@@21 T@U) ) (!  (=> (and (M1.Literal.litNull_q a@@24) (M1.Literal.litNull_q b@@21)) (|M1.Literal#Equal| a@@24 b@@21))
 :qid |unknown.0:0|
 :skolemid |2750|
 :pattern ( (|M1.Literal#Equal| a@@24 b@@21) (M1.Literal.litNull_q a@@24))
 :pattern ( (|M1.Literal#Equal| a@@24 b@@21) (M1.Literal.litNull_q b@@21))
)))
(assert (forall ((a@@25 T@U) (b@@22 T@U) ) (!  (=> (and (M1.Primitive.primCreatePath_q a@@25) (M1.Primitive.primCreatePath_q b@@22)) (|M1.Primitive#Equal| a@@25 b@@22))
 :qid |unknown.0:0|
 :skolemid |2765|
 :pattern ( (|M1.Primitive#Equal| a@@25 b@@22) (M1.Primitive.primCreatePath_q a@@25))
 :pattern ( (|M1.Primitive#Equal| a@@25 b@@22) (M1.Primitive.primCreatePath_q b@@22))
)))
(assert (forall ((a@@26 T@U) (b@@23 T@U) ) (!  (=> (and (M1.Primitive.primExec_q a@@26) (M1.Primitive.primExec_q b@@23)) (|M1.Primitive#Equal| a@@26 b@@23))
 :qid |unknown.0:0|
 :skolemid |2766|
 :pattern ( (|M1.Primitive#Equal| a@@26 b@@23) (M1.Primitive.primExec_q a@@26))
 :pattern ( (|M1.Primitive#Equal| a@@26 b@@23) (M1.Primitive.primExec_q b@@23))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|cmd#0@@4| T@U) (|deps#0@@4| T@U) (|exps#0@@3| T@U) (|st#0@@29| T@U) ) (!  (=> (or (|M1.__default.Pre#canCall| |cmd#0@@4| |deps#0@@4| |exps#0@@3| |st#0@@29|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@4| (TSeq TChar)) ($Is SetType |deps#0@@4| (TSet Tclass.M1.Path))) ($Is SetType |exps#0@@3| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@29| Tclass.M1.State)))) (and (forall ((|e#0| T@U) ) (!  (=> ($Is SeqType |e#0| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@3| ($Box SeqType |e#0|)) (and (and (|M1.__default.Loc#canCall| |cmd#0@@4| |deps#0@@4| |e#0|) (|M1.__default.DomSt#canCall| |st#0@@29|)) (=> (|Set#IsMember| (M1.__default.DomSt |st#0@@29|) (M1.__default.Loc |cmd#0@@4| |deps#0@@4| |e#0|)) (and (and (|M1.__default.Loc#canCall| |cmd#0@@4| |deps#0@@4| |e#0|) (|M1.__default.GetSt#canCall| (M1.__default.Loc |cmd#0@@4| |deps#0@@4| |e#0|) |st#0@@29|)) (and (|M1.__default.Loc#canCall| |cmd#0@@4| |deps#0@@4| |e#0|) (|M1.__default.Oracle#canCall| (M1.__default.Loc |cmd#0@@4| |deps#0@@4| |e#0|) |st#0@@29|)))))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |2219|
 :pattern ( (M1.__default.Loc |cmd#0@@4| |deps#0@@4| |e#0|))
 :pattern ( (|Set#IsMember| |exps#0@@3| ($Box SeqType |e#0|)))
)) (= (M1.__default.Pre |cmd#0@@4| |deps#0@@4| |exps#0@@3| |st#0@@29|) (forall ((|e#0@@0| T@U) ) (!  (=> ($Is SeqType |e#0@@0| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@3| ($Box SeqType |e#0@@0|)) (=> (|Set#IsMember| (M1.__default.DomSt |st#0@@29|) (M1.__default.Loc |cmd#0@@4| |deps#0@@4| |e#0@@0|)) (= (M1.__default.GetSt (M1.__default.Loc |cmd#0@@4| |deps#0@@4| |e#0@@0|) |st#0@@29|) (M1.__default.Oracle (M1.__default.Loc |cmd#0@@4| |deps#0@@4| |e#0@@0|) |st#0@@29|)))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |2218|
 ...
 :qid |CloudMakeParallelBuildsdfy.83:23|
 :skolemid |2220|
 :pattern ( (M1.__default.Pre |cmd#0@@4| |deps#0@@4| |exps#0@@3| |st#0@@29|))
))))
(assert (forall (($ly@@16 T@U) (|stmts#0@@6| T@U) (|st#0@@30| T@U) (|env#0@@16| T@U) ) (! (= (M1.__default.do ($LS $ly@@16) |stmts#0@@6| |st#0@@30| |env#0@@16|) (M1.__default.do $ly@@16 |stmts#0@@6| |st#0@@30| |env#0@@16|))
 :qid |CloudMakeParallelBuildsdfy.177:18|
 :skolemid |2348|
 :pattern ( (M1.__default.do ($LS $ly@@16) |stmts#0@@6| |st#0@@30| |env#0@@16|))
)))
(assert (forall (($ly@@17 T@U) (|expr#0@@5| T@U) (|st#0@@31| T@U) (|env#0@@17| T@U) ) (! (= (M1.__default.eval ($LS $ly@@17) |expr#0@@5| |st#0@@31| |env#0@@17|) (M1.__default.eval $ly@@17 |expr#0@@5| |st#0@@31| |env#0@@17|))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |2368|
 :pattern ( (M1.__default.eval ($LS $ly@@17) |expr#0@@5| |st#0@@31| |env#0@@17|))
)))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($Heap@@10 T@U) ($ly@@18 T@U) (|expr#0@@6| T@U) (|st#0@@32| T@U) (|env#0@@18| T@U) ) (!  (=> (and (or (|M1.__default.eval#canCall| |expr#0@@6| |st#0@@32| |env#0@@18|) (and (< 5 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |expr#0@@6| Tclass.M1.Expression) ($IsAlloc DatatypeTypeType |expr#0@@6| Tclass.M1.Expression $Heap@@10)) (and ($Is DatatypeTypeType |st#0@@32| Tclass.M1.State) ($IsAlloc DatatypeTypeType |st#0@@32| Tclass.M1.State $Heap@@10))) (and ($IsBox |env#0@@18| Tclass.M1.Env) ($IsAllocBox |env#0@@18| Tclass.M1.Env $Heap@@10))) (M1.__default.ValidEnv |env#0@@18|)))) ($IsGoodHeap $Heap@@10)) ($IsAlloc DatatypeTypeType (M1.__default.eval $ly@@18 |expr#0@@6| |st#0@@32| |env#0@@18|) (Tclass.M1.Tuple Tclass.M1.Expression Tclass.M1.State) $Heap@@10))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |2371|
 :pattern ( ($IsAlloc DatatypeTypeType (M1.__default.eval $ly@@18 |expr#0@@6| |st#0@@32| |env#0@@18|) (Tclass.M1.Tuple Tclass.M1.Expression Tclass.M1.State) $Heap@@10))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|prim#0@@4| T@U) (|args#0@@6| T@U) (|st#0@@33| T@U) ) (!  (=> (or (|M1.__default.ValidArgs#canCall| (Lit DatatypeTypeType |prim#0@@4|) (Lit SeqType |args#0@@6|) |st#0@@33|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |prim#0@@4| Tclass.M1.Primitive) ($Is SeqType |args#0@@6| (TSeq Tclass.M1.Expression))) ($Is DatatypeTypeType |st#0@@33| Tclass.M1.State)) (and (=> (M1.Primitive.primExec_q (Lit DatatypeTypeType |prim#0@@4|)) (= (|Seq#Length| (Lit SeqType |args#0@@6|)) (LitInt 3))) (=> (M1.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@4|)) (= (|Seq#Length| (Lit SeqType |args#0@@6|)) (LitInt 1))))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (M1.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@4|)))))) (let ((|exps#3| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@6|) (LitInt 2)))))
...
(let ((|cmd#3| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@6|) (LitInt 0)))))
 (=> (M1.Expression.exprLiteral_q |cmd#3|) (=> (M1.Literal.litString_q (M1.Expression.lit |cmd#3|)) (=> (M1.Expression.exprLiteral_q |deps#3|) (=> (M1.Literal.litArrOfPaths_q (M1.Expression.lit |deps#3|)) (=> (M1.Expression.exprLiteral_q |exps#3|) (=> (M1.Literal.litArrOfStrings_q (M1.Expression.lit |exps#3|)) (and (|M1.__default.DomSt#canCall| |st#0@@33|) (=> (|Set#Subset| (M1.Literal.paths (M1.Expression.lit |deps#3|)) (M1.__default.DomSt |st#0@@33|)) (|M1.__default.Pre#canCall| (M1.Literal.str (M1.Expression.lit |cmd#3|)) (M1.Literal.paths (M1.Expression.lit |deps#3|)) (M1.Literal.strs (M1.Expression.lit |exps#3|)) |st#0@@33|))))))))))))) (= (M1.__default.ValidArgs (Lit DatatypeTypeType |prim#0@@4|) (Lit SeqType |args#0@@6|) |st#0@@33|) (ite (M1.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@4|)) false (let ((|exps#2| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@6|) (LitInt 2)))))
...
(let ((|cmd#2| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@6|) (LitInt 0)))))
 (and (and (and (and (and (and (and (M1.Expression.exprLiteral_q |cmd#2|) (M1.Literal.litString_q (M1.Expression.lit |cmd#2|))) (M1.Expression.exprLiteral_q |deps#2|)) (M1.Literal.litArrOfPaths_q (M1.Expression.lit |deps#2|))) (M1.Expression.exprLiteral_q |exps#2|)) (M1.Literal.litArrOfStrings_q (M1.Expression.lit |exps#2|))) (|Set#Subset| (M1.Literal.paths (M1.Expression.lit |deps#2|)) (M1.__default.DomSt |st#0@@33|))) (M1.__default.Pre (M1.Literal.str (M1.Expression.lit |cmd#2|)) (M1.Literal.paths (M1.Expression.lit |deps#2|)) (M1.Literal.strs (M1.Expression.lit |exps#2|)) |st#0@@33|)))))))))
 :qid |CloudMakeParallelBuildsdfy.289:29|
 :weight 3
 :skolemid |2420|
 :pattern ( (M1.__default.ValidArgs (Lit DatatypeTypeType |prim#0@@4|) (Lit SeqType |args#0@@6|) |st#0@@33|))
))))
...
(let ((|sts''#1| (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |st'#7|)) |sts'#1|)))
 ...
 (and (M1.Tuple.Pair_q |ps#1|) (M1.Tuple.Pair_q |ps#1|)))))))))))))))))))))))))))))) (= (M1.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType |expr#0@@7|) |st#0@@34| |env#0@@20|) (ite (M1.__default.Value (Lit DatatypeTypeType |expr#0@@7|)) (|#M1.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType |expr#0@@7|)) ($Box DatatypeTypeType |st#0@@34|)) (ite (M1.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@7|)) (|#M1.Tuple.Pair| ($Box DatatypeTypeType (M1.__default.GetEnv (Lit BoxType (M1.Expression.id (Lit DatatypeTypeType |expr#0@@7|))) |env#0@@20|)) ($Box DatatypeTypeType |st#0@@34|)) (ite (M1.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@7|)) (let ((|st'#4@@0| ($Unbox DatatypeTypeType (M1.Tuple.snd (M1.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M1.Expression.cond (Lit DatatypeTypeType |expr#0@@7|))) |st#0@@34| |env#0@@20|)))))
(let ((|cond'#1@@0| ($Unbox DatatypeTypeType (M1.Tuple.fst (M1.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M1.Expression.cond (Lit DatatypeTypeType |expr#0@@7|))) |st#0@@34| |env#0@@20|)))))
(ite  (and (M1.Expression.exprLiteral_q |cond'#1@@0|) (|M1.Literal#Equal| (M1.Expression.lit |cond'#1@@0|) |#M1.Literal.litTrue|)) (M1.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M1.Expression.ifTrue (Lit DatatypeTypeType |expr#0@@7|))) |st'#4@@0| |env#0@@20|) (ite  (and (M1.Expression.exprLiteral_q |cond'#1@@0|) (|M1.Literal#Equal| (M1.Expression.lit |cond'#1@@0|) |#M1.Literal.litFalse|)) (M1.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M1.Expression.ifFalse (Lit DatatypeTypeType |expr#0@@7|))) |st'#4@@0| |env#0@@20|) (|#M1.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M1.Expression.exprError| (Lit DatatypeTypeType |#M1.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@34|)))))) (ite (M1.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@7|)) (let ((|st'#5@@0| ($Unbox DatatypeTypeType (M1.Tuple.snd (M1.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M1.Expression.conj0 (Lit DatatypeTypeType |expr#0@@7|))) |st#0@@34| |env#0@@20|)))))
(let ((|conj0'#1@@0| ($Unbox DatatypeTypeType (M1.Tuple.fst (M1.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M1.Expression.conj0 (Lit DatatypeTypeType |expr#0@@7|))) |st#0@@34| |env#0@@20|)))))
(ite  (and (M1.Expression.exprLiteral_q |conj0'#1@@0|) (|M1.Literal#Equal| (M1.Expression.lit |conj0'#1@@0|) |#M1.Literal.litTrue|)) (M1.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M1.Expression.conj1 (Lit DatatypeTypeType |expr#0@@7|))) |st'#5@@0| |env#0@@20|) (ite  (and (M1.Expression.exprLiteral_q |conj0'#1@@0|) (|M1.Literal#Equal| (M1.Expression.lit |conj0'#1@@0|) |#M1.Literal.litFalse|)) (|#M1.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M1.Expression.exprLiteral| (Lit DatatypeTypeType |#M1.Literal.litFalse|)))) ($Box DatatypeTypeType |st'#5@@0|)) (|#M1.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M1.Expression.exprError| (Lit DatatypeTypeType |#M1.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@34|)))))) (ite (M1.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@7|)) (let ((|st'#6@@0| ($Unbox DatatypeTypeType (M1.Tuple.snd (M1.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M1.Expression.disj0 (Lit DatatypeTypeType |expr#0@@7|))) |st#0@@34| |env#0@@20|)))))
(let ((|disj0'#1@@0| ($Unbox DatatypeTypeType (M1.Tuple.fst (M1.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M1.Expression.disj0 (Lit DatatypeTypeType |expr#0@@7|))) |st#0@@34| |env#0@@20|)))))
(ite  (and (M1.Expression.exprLiteral_q |disj0'#1@@0|) (|M1.Literal#Equal| (M1.Expression.lit |disj0'#1@@0|) |#M1.Literal.litTrue|)) (|#M1.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M1.Expression.exprLiteral| (Lit DatatypeTypeType |#M1.Literal.litTrue|)))) ($Box DatatypeTypeType |st'#6@@0|)) (ite  (and (M1.Expression.exprLiteral_q |disj0'#1@@0|) (|M1.Literal#Equal| (M1.Expression.lit |disj0'#1@@0|) |#M1.Literal.litFalse|)) (M1.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M1.Expression.disj1 (Lit DatatypeTypeType |expr#0@@7|))) |st'#6@@0| |env#0@@20|) (|#M1.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M1.Expression.exprError| (Lit DatatypeTypeType |#M1.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@34|)))))) (ite (M1.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0@@7|)) (let ((|st'#7@@0| ($Unbox DatatypeTypeType (M1.Tuple.snd (M1.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M1.Expression.fun (Lit DatatypeTypeType |expr#0@@7|))) |st#0@@34| |env#0@@20|)))))
(let ((|fun'#1@@0| ($Unbox DatatypeTypeType (M1.Tuple.fst (M1.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M1.Expression.fun (Lit DatatypeTypeType |expr#0@@7|))) |st#0@@34| |env#0@@20|)))))
(let ((|sts'#1@@0| ($Unbox SetType (M1.Tuple.snd (M1.__default.evalArgs ($LS $ly@@20) (Lit DatatypeTypeType |expr#0@@7|) (Lit SeqType (M1.Expression.args (Lit DatatypeTypeType |expr#0@@7|))) |st#0@@34| |env#0@@20|)))))
(let ((|args'#1@@0| ($Unbox SeqType (M1.Tuple.fst (M1.__default.evalArgs ($LS $ly@@20) (Lit DatatypeTypeType |expr#0@@7|) (Lit SeqType (M1.Expression.args (Lit DatatypeTypeType |expr#0@@7|))) |st#0@@34| |env#0@@20|)))))
(let ((|sts''#1@@0| (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |st'#7@@0|)) |sts'#1@@0|)))
(ite  (not (M1.__default.Compatible |sts''#1@@0|)) (|#M1.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M1.Expression.exprError| (Lit DatatypeTypeType |#M1.Reason.rCompatibility|)))) ($Box DatatypeTypeType |st#0@@34|)) (let ((|stCombined#1@@0| (M1.__default.Combine ($LS $LZ) |sts''#1@@0|)))
...
(|#M1.Tuple.Pair| ($Box DatatypeTypeType (|#M1.Expression.exprLiteral| (|#M1.Literal.litArrOfPaths| ($Unbox SetType (M1.Tuple.fst |ps#1@@0|))))) (M1.Tuple.snd |ps#1@@0|))) (|#M1.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M1.Expression.exprError| (Lit DatatypeTypeType |#M1.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@34|))) (|#M1.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M1.Expression.exprError| (Lit DatatypeTypeType |#M1.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@34|))) (|#M1.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M1.Expression.exprError| (Lit DatatypeTypeType |#M1.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@34|)))))))))) (|#M1.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M1.Expression.exprError| (Lit DatatypeTypeType |#M1.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@34|)))))))))))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :weight 3
 :skolemid |2374|
 :pattern ( (M1.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType |expr#0@@7|) |st#0@@34| |env#0@@20|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@11 T@U) (|p#0@@9| T@U) (|st#0@@35| T@U) ) (!  (=> (and (or (|M1.__default.Oracle#canCall| |p#0@@9| |st#0@@35|) (and (< 1 $FunctionContextHeight) (and (and ($IsBox |p#0@@9| Tclass.M1.Path) ($IsAllocBox |p#0@@9| Tclass.M1.Path $Heap@@11)) (and ($Is DatatypeTypeType |st#0@@35| Tclass.M1.State) ($IsAlloc DatatypeTypeType |st#0@@35| Tclass.M1.State $Heap@@11))))) ($IsGoodHeap $Heap@@11)) ($IsAllocBox (M1.__default.Oracle |p#0@@9| |st#0@@35|) Tclass.M1.Artifact $Heap@@11))
 :qid |CloudMakeParallelBuildsdfy.104:18|
 :skolemid |2269|
 :pattern ( ($IsAllocBox (M1.__default.Oracle |p#0@@9| |st#0@@35|) Tclass.M1.Artifact $Heap@@11))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@12 T@U) (|st#0@@36| T@U) (|st'#0@@6| T@U) ) (!  (=> (and (or (|M1.__default.Union#canCall| |st#0@@36| |st'#0@@6|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@36| Tclass.M1.State) ($IsAlloc DatatypeTypeType |st#0@@36| Tclass.M1.State $Heap@@12)) (and ($Is DatatypeTypeType |st'#0@@6| Tclass.M1.State) ($IsAlloc DatatypeTypeType |st'#0@@6| Tclass.M1.State $Heap@@12))))) ($IsGoodHeap $Heap@@12)) ($IsAlloc DatatypeTypeType (M1.__default.Union |st#0@@36| |st'#0@@6|) Tclass.M1.State $Heap@@12))
 :qid |CloudMakeParallelBuildsdfy.23:18|
 :skolemid |2127|
 :pattern ( ($IsAlloc DatatypeTypeType (M1.__default.Union |st#0@@36| |st'#0@@6|) Tclass.M1.State $Heap@@12))
))))
...
(assert (forall ((d@@60 T@U) ) (! (= (BoxRank ($Box DatatypeTypeType d@@60)) (DtRank d@@60))
 :qid |DafnyPreludebpl.391:15|
 :skolemid |1468|
 :pattern ( (BoxRank ($Box DatatypeTypeType d@@60)))
)))
...
(assert (forall ((v@@13 T@U) (t0@@5 T@U) (t1@@2 T@U) ) (! (= ($Is MapType v@@13 (TMap t0@@5 t1@@2)) (forall ((bx@@19 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@13) bx@@19) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@13) bx@@19) t1@@2) ($IsBox bx@@19 t0@@5)))
 ...
 :skolemid |1440|
 :pattern ( ($Is MapType v@@13 (TMap t0@@5 t1@@2)))
)))
(assert (forall ((d@@61 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) ($Is DatatypeTypeType d@@61 Tclass.M1.Primitive)) ($IsAlloc DatatypeTypeType d@@61 Tclass.M1.Primitive $h@@24))
 :qid |unknown.0:0|
 :skolemid |2762|
 :pattern ( ($IsAlloc DatatypeTypeType d@@61 Tclass.M1.Primitive $h@@24))
)))
(assert (forall ((d@@62 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) ($Is DatatypeTypeType d@@62 Tclass.M1.Reason)) ($IsAlloc DatatypeTypeType d@@62 Tclass.M1.Reason $h@@25))
 :qid |unknown.0:0|
 :skolemid |2772|
 :pattern ( ($IsAlloc DatatypeTypeType d@@62 Tclass.M1.Reason $h@@25))
)))
...
(assert (forall ((d@@63 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (M1.Literal.litString_q d@@63) ($IsAlloc DatatypeTypeType d@@63 Tclass.M1.Literal $h@@26))) ($IsAlloc SeqType (M1.Literal.str d@@63) (TSeq TChar) $h@@26))
 :qid |unknown.0:0|
 :skolemid |2699|
 :pattern ( ($IsAlloc SeqType (M1.Literal.str d@@63) (TSeq TChar) $h@@26))
)))
(assert (forall ((|a#118#0#0| T@U) (d@@64 T@U) ) (!  (=> (|Set#IsMember| |a#118#0#0| ($Box DatatypeTypeType d@@64)) (< (DtRank d@@64) (DtRank (|#M1.Literal.litArrOfPaths| |a#118#0#0|))))
 :qid |CloudMakeParallelBuildsdfy.145:36|
 :skolemid |2723|
 :pattern ( (|Set#IsMember| |a#118#0#0| ($Box DatatypeTypeType d@@64)) (|#M1.Literal.litArrOfPaths| |a#118#0#0|))
)))
(assert (forall ((|a#124#0#0| T@U) (d@@65 T@U) ) (!  (=> (|Set#IsMember| |a#124#0#0| ($Box DatatypeTypeType d@@65)) (< (DtRank d@@65) (DtRank (|#M1.Literal.litArrOfStrings| |a#124#0#0|))))
 :qid |CloudMakeParallelBuildsdfy.146:38|
 :skolemid |2733|
 :pattern ( (|Set#IsMember| |a#124#0#0| ($Box DatatypeTypeType d@@65)) (|#M1.Literal.litArrOfStrings| |a#124#0#0|))
)))
(assert  (=> (<= 7 $FunctionContextHeight) (forall ((|prog#0@@3| T@U) (|st#0@@38| T@U) ) (!  (=> (or (|M1.__default.build#canCall| (Lit DatatypeTypeType |prog#0@@3|) (Lit DatatypeTypeType |st#0@@38|)) (and (< 7 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |prog#0@@3| Tclass.M1.Program) ($Is DatatypeTypeType |st#0@@38| Tclass.M1.State)) (U_2_bool (Lit boolType (bool_2_U (M1.__default.Legal (Lit SeqType (M1.Program.stmts (Lit DatatypeTypeType |prog#0@@3|)))))))))) (and (and (and (M1.Program.Program_q (Lit DatatypeTypeType |prog#0@@3|)) |M1.__default.EmptyEnv#canCall|) (|M1.__default.do#canCall| (Lit SeqType (M1.Program.stmts (Lit DatatypeTypeType |prog#0@@3|))) (Lit DatatypeTypeType |st#0@@38|) M1.__default.EmptyEnv)) (= (M1.__default.build (Lit DatatypeTypeType |prog#0@@3|) (Lit DatatypeTypeType |st#0@@38|)) (M1.__default.do ($LS $LZ) (Lit SeqType (M1.Program.stmts (Lit DatatypeTypeType |prog#0@@3|))) (Lit DatatypeTypeType |st#0@@38|) M1.__default.EmptyEnv))))
 :qid |CloudMakeParallelBuildsdfy.170:24|
 :weight 3
 :skolemid |2343|
 :pattern ( (M1.__default.build (Lit DatatypeTypeType |prog#0@@3|) (Lit DatatypeTypeType |st#0@@38|)))
))))
...
(assert (forall ((s@@20 T@U) (m@@10 Int) (n@@9 Int) ) (!  (=> (and (and (<= 0 m@@10) (<= 0 n@@9)) (<= (+ m@@10 n@@9) (|Seq#Length| s@@20))) (= (|Seq#Drop| (|Seq#Drop| s@@20 m@@10) n@@9) (|Seq#Drop| s@@20 (+ m@@10 n@@9))))
 :qid |DafnyPreludebpl.1299:15|
 :skolemid |1641|
 :pattern ( (|Seq#Drop| (|Seq#Drop| s@@20 m@@10) n@@9))
)))
(assert (forall ((d@@66 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@27 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (_System.Tuple2.___hMake2_q d@@66) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@66 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@27)
 :qid |unknown.0:0|
 :skolemid |1842|
 :pattern ( ($IsAlloc DatatypeTypeType d@@66 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@27))
)))) ($IsAllocBox (_System.Tuple2._0 d@@66) |_System._tuple#2$T0@@6| $h@@27))
 :qid |unknown.0:0|
 :skolemid |1843|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@66) |_System._tuple#2$T0@@6| $h@@27))
)))
(assert (forall ((d@@67 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@28 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (_System.Tuple2.___hMake2_q d@@67) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@67 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@28)
 :qid |unknown.0:0|
 :skolemid |1844|
 :pattern ( ($IsAlloc DatatypeTypeType d@@67 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@28))
)))) ($IsAllocBox (_System.Tuple2._1 d@@67) |_System._tuple#2$T1@@7| $h@@28))
 :qid |unknown.0:0|
 :skolemid |1845|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@67) |_System._tuple#2$T1@@7| $h@@28))
)))
(assert (forall ((d@@68 T@U) (M1.Tuple$A@@6 T@U) ($h@@29 T@U) ) (!  (=> (and ($IsGoodHeap $h@@29) (and (M1.Tuple.Pair_q d@@68) (exists ((M1.Tuple$B@@6 T@U) ) (! ($IsAlloc DatatypeTypeType d@@68 (Tclass.M1.Tuple M1.Tuple$A@@6 M1.Tuple$B@@6) $h@@29)
 :qid |unknown.0:0|
 :skolemid |2784|
 :pattern ( ($IsAlloc DatatypeTypeType d@@68 (Tclass.M1.Tuple M1.Tuple$A@@6 M1.Tuple$B@@6) $h@@29))
)))) ($IsAllocBox (M1.Tuple.fst d@@68) M1.Tuple$A@@6 $h@@29))
 :qid |unknown.0:0|
 :skolemid |2785|
 :pattern ( ($IsAllocBox (M1.Tuple.fst d@@68) M1.Tuple$A@@6 $h@@29))
)))
(assert (forall ((d@@69 T@U) (M1.Tuple$B@@7 T@U) ($h@@30 T@U) ) (!  (=> (and ($IsGoodHeap $h@@30) (and (M1.Tuple.Pair_q d@@69) (exists ((M1.Tuple$A@@7 T@U) ) (! ($IsAlloc DatatypeTypeType d@@69 (Tclass.M1.Tuple M1.Tuple$A@@7 M1.Tuple$B@@7) $h@@30)
 :qid |unknown.0:0|
 :skolemid |2786|
 :pattern ( ($IsAlloc DatatypeTypeType d@@69 (Tclass.M1.Tuple M1.Tuple$A@@7 M1.Tuple$B@@7) $h@@30))
)))) ($IsAllocBox (M1.Tuple.snd d@@69) M1.Tuple$B@@7 $h@@30))
 :qid |unknown.0:0|
 :skolemid |2787|
 :pattern ( ($IsAllocBox (M1.Tuple.snd d@@69) M1.Tuple$B@@7 $h@@30))
)))
...
(assert (forall ((d@@70 T@U) ($h@@31 T@U) ) (!  (=> (and ($IsGoodHeap $h@@31) (and (M1.Statement.stmtVariable_q d@@70) ($IsAlloc DatatypeTypeType d@@70 Tclass.M1.Statement $h@@31))) ($IsAllocBox (M1.Statement.id d@@70) Tclass.M1.Identifier $h@@31))
 :qid |unknown.0:0|
 :skolemid |2554|
 :pattern ( ($IsAllocBox (M1.Statement.id d@@70) Tclass.M1.Identifier $h@@31))
)))
(assert (forall ((d@@71 T@U) ($h@@32 T@U) ) (!  (=> (and ($IsGoodHeap $h@@32) (and (M1.Statement.stmtVariable_q d@@71) ($IsAlloc DatatypeTypeType d@@71 Tclass.M1.Statement $h@@32))) ($IsAlloc DatatypeTypeType (M1.Statement.expr d@@71) Tclass.M1.Expression $h@@32))
 :qid |unknown.0:0|
 :skolemid |2555|
 :pattern ( ($IsAlloc DatatypeTypeType (M1.Statement.expr d@@71) Tclass.M1.Expression $h@@32))
)))
(assert (forall ((d@@72 T@U) ($h@@33 T@U) ) (!  (=> (and ($IsGoodHeap $h@@33) (and (M1.Statement.stmtReturn_q d@@72) ($IsAlloc DatatypeTypeType d@@72 Tclass.M1.Statement $h@@33))) ($IsAlloc DatatypeTypeType (M1.Statement.ret d@@72) Tclass.M1.Expression $h@@33))
 :qid |unknown.0:0|
 :skolemid |2566|
 :pattern ( ($IsAlloc DatatypeTypeType (M1.Statement.ret d@@72) Tclass.M1.Expression $h@@33))
)))
(assert (forall ((d@@73 T@U) ($h@@34 T@U) ) (!  (=> (and ($IsGoodHeap $h@@34) (and (M1.Expression.exprLiteral_q d@@73) ($IsAlloc DatatypeTypeType d@@73 Tclass.M1.Expression $h@@34))) ($IsAlloc DatatypeTypeType (M1.Expression.lit d@@73) Tclass.M1.Literal $h@@34))
 :qid |unknown.0:0|
 :skolemid |2582|
 :pattern ( ($IsAlloc DatatypeTypeType (M1.Expression.lit d@@73) Tclass.M1.Literal $h@@34))
)))
(assert (forall ((d@@74 T@U) ($h@@35 T@U) ) (!  (=> (and ($IsGoodHeap $h@@35) (and (M1.Expression.exprIdentifier_q d@@74) ($IsAlloc DatatypeTypeType d@@74 Tclass.M1.Expression $h@@35))) ($IsAllocBox (M1.Expression.id d@@74) Tclass.M1.Identifier $h@@35))
 :qid |unknown.0:0|
 :skolemid |2592|
 :pattern ( ($IsAllocBox (M1.Expression.id d@@74) Tclass.M1.Identifier $h@@35))
)))
(assert (forall ((d@@75 T@U) ($h@@36 T@U) ) (!  (=> (and ($IsGoodHeap $h@@36) (and (M1.Expression.exprIf_q d@@75) ($IsAlloc DatatypeTypeType d@@75 Tclass.M1.Expression $h@@36))) ($IsAlloc DatatypeTypeType (M1.Expression.cond d@@75) Tclass.M1.Expression $h@@36))
 :qid |unknown.0:0|
 :skolemid |2601|
 :pattern ( ($IsAlloc DatatypeTypeType (M1.Expression.cond d@@75) Tclass.M1.Expression $h@@36))
)))
(assert (forall ((d@@76 T@U) ($h@@37 T@U) ) (!  (=> (and ($IsGoodHeap $h@@37) (and (M1.Expression.exprIf_q d@@76) ($IsAlloc DatatypeTypeType d@@76 Tclass.M1.Expression $h@@37))) ($IsAlloc DatatypeTypeType (M1.Expression.ifTrue d@@76) Tclass.M1.Expression $h@@37))
 :qid |unknown.0:0|
 :skolemid |2602|
 :pattern ( ($IsAlloc DatatypeTypeType (M1.Expression.ifTrue d@@76) Tclass.M1.Expression $h@@37))
)))
(assert (forall ((d@@77 T@U) ($h@@38 T@U) ) (!  (=> (and ($IsGoodHeap $h@@38) (and (M1.Expression.exprIf_q d@@77) ($IsAlloc DatatypeTypeType d@@77 Tclass.M1.Expression $h@@38))) ($IsAlloc DatatypeTypeType (M1.Expression.ifFalse d@@77) Tclass.M1.Expression $h@@38))
 :qid |unknown.0:0|
 :skolemid |2603|
 :pattern ( ($IsAlloc DatatypeTypeType (M1.Expression.ifFalse d@@77) Tclass.M1.Expression $h@@38))
)))
(assert (forall ((d@@78 T@U) ($h@@39 T@U) ) (!  (=> (and ($IsGoodHeap $h@@39) (and (M1.Expression.exprAnd_q d@@78) ($IsAlloc DatatypeTypeType d@@78 Tclass.M1.Expression $h@@39))) ($IsAlloc DatatypeTypeType (M1.Expression.conj0 d@@78) Tclass.M1.Expression $h@@39))
 :qid |unknown.0:0|
 :skolemid |2617|
 :pattern ( ($IsAlloc DatatypeTypeType (M1.Expression.conj0 d@@78) Tclass.M1.Expression $h@@39))
)))
(assert (forall ((d@@79 T@U) ($h@@40 T@U) ) (!  (=> (and ($IsGoodHeap $h@@40) (and (M1.Expression.exprAnd_q d@@79) ($IsAlloc DatatypeTypeType d@@79 Tclass.M1.Expression $h@@40))) ($IsAlloc DatatypeTypeType (M1.Expression.conj1 d@@79) Tclass.M1.Expression $h@@40))
 :qid |unknown.0:0|
 :skolemid |2618|
 :pattern ( ($IsAlloc DatatypeTypeType (M1.Expression.conj1 d@@79) Tclass.M1.Expression $h@@40))
)))
(assert (forall ((d@@80 T@U) ($h@@41 T@U) ) (!  (=> (and ($IsGoodHeap $h@@41) (and (M1.Expression.exprOr_q d@@80) ($IsAlloc DatatypeTypeType d@@80 Tclass.M1.Expression $h@@41))) ($IsAlloc DatatypeTypeType (M1.Expression.disj0 d@@80) Tclass.M1.Expression $h@@41))
 :qid |unknown.0:0|
 :skolemid |2630|
 :pattern ( ($IsAlloc DatatypeTypeType (M1.Expression.disj0 d@@80) Tclass.M1.Expression $h@@41))
)))
(assert (forall ((d@@81 T@U) ($h@@42 T@U) ) (!  (=> (and ($IsGoodHeap $h@@42) (and (M1.Expression.exprOr_q d@@81) ($IsAlloc DatatypeTypeType d@@81 Tclass.M1.Expression $h@@42))) ($IsAlloc DatatypeTypeType (M1.Expression.disj1 d@@81) Tclass.M1.Expression $h@@42))
 :qid |unknown.0:0|
 :skolemid |2631|
 :pattern ( ($IsAlloc DatatypeTypeType (M1.Expression.disj1 d@@81) Tclass.M1.Expression $h@@42))
)))
(assert (forall ((d@@82 T@U) ($h@@43 T@U) ) (!  (=> (and ($IsGoodHeap $h@@43) (and (M1.Expression.exprInvocation_q d@@82) ($IsAlloc DatatypeTypeType d@@82 Tclass.M1.Expression $h@@43))) ($IsAlloc DatatypeTypeType (M1.Expression.fun d@@82) Tclass.M1.Expression $h@@43))
 :qid |unknown.0:0|
 :skolemid |2643|
 :pattern ( ($IsAlloc DatatypeTypeType (M1.Expression.fun d@@82) Tclass.M1.Expression $h@@43))
)))
(assert (forall ((d@@83 T@U) ($h@@44 T@U) ) (!  (=> (and ($IsGoodHeap $h@@44) (and (M1.Expression.exprError_q d@@83) ($IsAlloc DatatypeTypeType d@@83 Tclass.M1.Expression $h@@44))) ($IsAlloc DatatypeTypeType (M1.Expression.r d@@83) Tclass.M1.Reason $h@@44))
 :qid |unknown.0:0|
 :skolemid |2658|
 :pattern ( ($IsAlloc DatatypeTypeType (M1.Expression.r d@@83) Tclass.M1.Reason $h@@44))
)))
(assert (forall ((d@@84 T@U) ($h@@45 T@U) ) (!  (=> (and ($IsGoodHeap $h@@45) (and (M1.Literal.litPrimitive_q d@@84) ($IsAlloc DatatypeTypeType d@@84 Tclass.M1.Literal $h@@45))) ($IsAlloc DatatypeTypeType (M1.Literal.prim d@@84) Tclass.M1.Primitive $h@@45))
 :qid |unknown.0:0|
 :skolemid |2710|
 :pattern ( ($IsAlloc DatatypeTypeType (M1.Literal.prim d@@84) Tclass.M1.Primitive $h@@45))
)))
...
(assert (forall ((|a#5#0#0@@0| T@U) (d@@85 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#5#0#0@@0|) ($Box DatatypeTypeType d@@85)) (< (DtRank d@@85) (DtRank (|#M1.State.StateCons| |a#5#0#0@@0|))))
 :qid |CloudMakeParallelBuildsdfy.433:30|
 :skolemid |2527|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#5#0#0@@0|) ($Box DatatypeTypeType d@@85)) (|#M1.State.StateCons| |a#5#0#0@@0|))
)))
(assert (forall ((d@@86 T@U) ($h@@46 T@U) ) (!  (=> (and ($IsGoodHeap $h@@46) (and (M1.Literal.litArrOfStrings_q d@@86) ($IsAlloc DatatypeTypeType d@@86 Tclass.M1.Literal $h@@46))) ($IsAlloc SetType (M1.Literal.strs d@@86) (TSet (TSeq TChar)) $h@@46))
 :qid |unknown.0:0|
 :skolemid |2730|
 :pattern ( ($IsAlloc SetType (M1.Literal.strs d@@86) (TSet (TSeq TChar)) $h@@46))
)))
...
(assert (forall ((d@@87 T@U) ($h@@47 T@U) ) (!  (=> (and ($IsGoodHeap $h@@47) (and (M1.Program.Program_q d@@87) ($IsAlloc DatatypeTypeType d@@87 Tclass.M1.Program $h@@47))) ($IsAlloc SeqType (M1.Program.stmts d@@87) (TSeq Tclass.M1.Statement) $h@@47))
 :qid |unknown.0:0|
 :skolemid |2539|
 :pattern ( ($IsAlloc SeqType (M1.Program.stmts d@@87) (TSeq Tclass.M1.Statement) $h@@47))
)))
(assert (forall ((d@@88 T@U) ($h@@48 T@U) ) (!  (=> (and ($IsGoodHeap $h@@48) (and (M1.Expression.exprInvocation_q d@@88) ($IsAlloc DatatypeTypeType d@@88 Tclass.M1.Expression $h@@48))) ($IsAlloc SeqType (M1.Expression.args d@@88) (TSeq Tclass.M1.Expression) $h@@48))
 :qid |unknown.0:0|
 :skolemid |2644|
 :pattern ( ($IsAlloc SeqType (M1.Expression.args d@@88) (TSeq Tclass.M1.Expression) $h@@48))
)))
(assert (forall ((d@@89 T@U) ($h@@49 T@U) ) (!  (=> (and ($IsGoodHeap $h@@49) (and (M1.Literal.litArrOfPaths_q d@@89) ($IsAlloc DatatypeTypeType d@@89 Tclass.M1.Literal $h@@49))) ($IsAlloc SetType (M1.Literal.paths d@@89) (TSet Tclass.M1.Path) $h@@49))
 :qid |unknown.0:0|
 :skolemid |2720|
 :pattern ( ($IsAlloc SetType (M1.Literal.paths d@@89) (TSet Tclass.M1.Path) $h@@49))
)))
(assert (forall ((d@@90 T@U) ($h@@50 T@U) ) (!  (=> (and ($IsGoodHeap $h@@50) (and (M1.Literal.litArray_q d@@90) ($IsAlloc DatatypeTypeType d@@90 Tclass.M1.Literal $h@@50))) ($IsAlloc SeqType (M1.Literal.arr d@@90) (TSeq Tclass.M1.Expression) $h@@50))
 :qid |unknown.0:0|
 :skolemid |2740|
 :pattern ( ($IsAlloc SeqType (M1.Literal.arr d@@90) (TSeq Tclass.M1.Expression) $h@@50))
)))
...
(assert (forall ((v@@16 T@U) (t0@@6 T@U) ) (! (= ($Is SeqType v@@16 (TSeq t0@@6)) (forall ((i@@11 Int) ) (!  (=> (and (<= 0 i@@11) (< i@@11 (|Seq#Length| v@@16))) ($IsBox (|Seq#Index| v@@16 i@@11) t0@@6))
 ...
 :skolemid |1438|
 :pattern ( ($Is SeqType v@@16 (TSeq t0@@6)))
)))
...
(assert (forall ((v@@18 T@U) (t0@@7 T@U) (t1@@3 T@U) ) (!  (=> ($Is MapType v@@18 (TMap t0@@7 t1@@3)) (and (and ($Is SetType (|Map#Domain| v@@18) (TSet t0@@7)) ($Is SetType (|Map#Values| v@@18) (TSet t1@@3))) ($Is SetType (|Map#Items| v@@18) (TSet (Tclass._System.Tuple2 t0@@7 t1@@3)))))
 :qid |DafnyPreludebpl.267:15|
 :skolemid |1441|
 :pattern ( ($Is MapType v@@18 (TMap t0@@7 t1@@3)))
)))
...
(declare-fun |calcC#0@0| () T@U)
(declare-fun |calcH#0@0| () T@U)
(declare-fun |calcObj#0@0| () T@U)
(declare-fun |exec#0@0| () T@U)
(declare-fun |st#0@0| () T@U)
(declare-fun |program#0@0| () T@U)
...
(declare-fun |calcC#0| () T@U)
(declare-fun |calcH#0| () T@U)
(declare-fun |calcObj#0| () T@U)
(declare-fun |cmd#0@@6| () T@U)
(declare-fun |deps#0@@6| () T@U)
(declare-fun |exps#0@@5| () T@U)
(declare-fun |exec#0| () T@U)
(declare-fun |h#0| () T@U)
(declare-fun |st#0@@39| () T@U)
(declare-fun |program#0| () T@U)
(declare-fun |result#0@@0| () T@U)
(declare-fun |e#1@@1| () T@U)
(declare-fun |st'#0@@7| () T@U)
(set-info :boogie-vc-id Impl$$M1.__default.Main)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon2_correct  (=> (and (|M1.__default.Loc#canCall| |calcC#0@0| (|Set#UnionOne| |Set#Empty| |calcH#0@0|) |calcObj#0@0|) (=> (or (not (= |calcH#0@0| (M1.__default.Loc |calcC#0@0| (|Set#UnionOne| |Set#Empty| |calcH#0@0|) |calcObj#0@0|))) (not true)) (|M1.__default.ValidArgs#canCall| (Lit DatatypeTypeType |#M1.Primitive.primExec|) (M1.Expression.args |exec#0@0|) |st#0@0|))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (or (not (= |calcH#0@0| (M1.__default.Loc |calcC#0@0| (|Set#UnionOne| |Set#Empty| |calcH#0@0|) |calcObj#0@0|))) (not true)) (=> (|M1.__default.ValidArgs#canCall| (Lit DatatypeTypeType |#M1.Primitive.primExec|) (M1.Expression.args |exec#0@0|) |st#0@0|) (or (M1.__default.ValidArgs (Lit DatatypeTypeType |#M1.Primitive.primExec|) (M1.Expression.args |exec#0@0|) |st#0@0|) (=> (U_2_bool (Lit boolType (bool_2_U (M1.Primitive.primCreatePath_q (Lit DatatypeTypeType |#M1.Primitive.primExec|))))) (U_2_bool (Lit boolType (bool_2_U false)))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (or (not (= |calcH#0@0| (M1.__default.Loc |calcC#0@0| (|Set#UnionOne| |Set#Empty| |calcH#0@0|) |calcObj#0@0|))) (not true)) (=> (|M1.__default.ValidArgs#canCall| (Lit DatatypeTypeType |#M1.Primitive.primExec|) (M1.Expression.args |exec#0@0|) |st#0@0|) (or (M1.__default.ValidArgs (Lit DatatypeTypeType |#M1.Primitive.primExec|) (M1.Expression.args |exec#0@0|) |st#0@0|) (=> (not (U_2_bool (Lit boolType (bool_2_U (M1.Primitive.primCreatePath_q (Lit DatatypeTypeType |#M1.Primitive.primExec|)))))) (let ((|cmd#1@@0| ($Unbox DatatypeTypeType (|Seq#Index| (M1.Expression.args |exec#0@0|) (LitInt 0)))))
(M1.Expression.exprLiteral_q |cmd#1@@0|))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (or (not (= |calcH#0@0| (M1.__default.Loc |calcC#0@0| (|Set#UnionOne| |Set#Empty| |calcH#0@0|) |calcObj#0@0|))) (not true)) (=> (|M1.__default.ValidArgs#canCall| (Lit DatatypeTypeType |#M1.Primitive.primExec|) (M1.Expression.args |exec#0@0|) |st#0@0|) (or (M1.__default.ValidArgs (Lit DatatypeTypeType |#M1.Primitive.primExec|) (M1.Expression.args |exec#0@0|) |st#0@0|) (=> (not (U_2_bool (Lit boolType (bool_2_U (M1.Primitive.primCreatePath_q (Lit DatatypeTypeType |#M1.Primitive.primExec|)))))) (let ((|cmd#1@@1| ($Unbox DatatypeTypeType (|Seq#Index| (M1.Expression.args |exec#0@0|) (LitInt 0)))))
(M1.Literal.litString_q (M1.Expression.lit |cmd#1@@1|)))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (or (not (= |calcH#0@0| (M1.__default.Loc |calcC#0@0| (|Set#UnionOne| |Set#Empty| |calcH#0@0|) |calcObj#0@0|))) (not true)) (=> (|M1.__default.ValidArgs#canCall| (Lit DatatypeTypeType |#M1.Primitive.primExec|) (M1.Expression.args |exec#0@0|) |st#0@0|) (or (M1.__default.ValidArgs (Lit DatatypeTypeType |#M1.Primitive.primExec|) (M1.Expression.args |exec#0@0|) |st#0@0|) (=> (not (U_2_bool (Lit boolType (bool_2_U (M1.Primitive.primCreatePath_q (Lit DatatypeTypeType |#M1.Primitive.primExec|)))))) (let ((|deps#1@@0| ($Unbox DatatypeTypeType (|Seq#Index| (M1.Expression.args |exec#0@0|) (LitInt 1)))))
(M1.Expression.exprLiteral_q |deps#1@@0|))))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (or (not (= |calcH#0@0| (M1.__default.Loc |calcC#0@0| (|Set#UnionOne| |Set#Empty| |calcH#0@0|) |calcObj#0@0|))) (not true)) (=> (|M1.__default.ValidArgs#canCall| (Lit DatatypeTypeType |#M1.Primitive.primExec|) (M1.Expression.args |exec#0@0|) |st#0@0|) (or (M1.__default.ValidArgs (Lit DatatypeTypeType |#M1.Primitive.primExec|) (M1.Expression.args |exec#0@0|) |st#0@0|) (=> (not (U_2_bool (Lit boolType (bool_2_U (M1.Primitive.primCreatePath_q (Lit DatatypeTypeType |#M1.Primitive.primExec|)))))) (let ((|deps#1@@1| ($Unbox DatatypeTypeType (|Seq#Index| (M1.Expression.args |exec#0@0|) (LitInt 1)))))
(M1.Literal.litArrOfPaths_q (M1.Expression.lit |deps#1@@1|)))))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (or (not (= |calcH#0@0| (M1.__default.Loc |calcC#0@0| (|Set#UnionOne| |Set#Empty| |calcH#0@0|) |calcObj#0@0|))) (not true)) (=> (|M1.__default.ValidArgs#canCall| (Lit DatatypeTypeType |#M1.Primitive.primExec|) (M1.Expression.args |exec#0@0|) |st#0@0|) (or (M1.__default.ValidArgs (Lit DatatypeTypeType |#M1.Primitive.primExec|) (M1.Expression.args |exec#0@0|) |st#0@0|) (=> (not (U_2_bool (Lit boolType (bool_2_U (M1.Primitive.primCreatePath_q (Lit DatatypeTypeType |#M1.Primitive.primExec|)))))) (let ((|exps#1@@0| ($Unbox DatatypeTypeType (|Seq#Index| (M1.Expression.args |exec#0@0|) (LitInt 2)))))
(M1.Expression.exprLiteral_q |exps#1@@0|))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (or (not (= |calcH#0@0| (M1.__default.Loc |calcC#0@0| (|Set#UnionOne| |Set#Empty| |calcH#0@0|) |calcObj#0@0|))) (not true)) (=> (|M1.__default.ValidArgs#canCall| (Lit DatatypeTypeType |#M1.Primitive.primExec|) (M1.Expression.args |exec#0@0|) |st#0@0|) (or (M1.__default.ValidArgs (Lit DatatypeTypeType |#M1.Primitive.primExec|) (M1.Expression.args |exec#0@0|) |st#0@0|) (=> (not (U_2_bool (Lit boolType (bool_2_U (M1.Primitive.primCreatePath_q (Lit DatatypeTypeType |#M1.Primitive.primExec|)))))) (let ((|exps#1@@1| ($Unbox DatatypeTypeType (|Seq#Index| (M1.Expression.args |exec#0@0|) (LitInt 2)))))
(M1.Literal.litArrOfStrings_q (M1.Expression.lit |exps#1@@1|)))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (or (not (= |calcH#0@0| (M1.__default.Loc |calcC#0@0| (|Set#UnionOne| |Set#Empty| |calcH#0@0|) |calcObj#0@0|))) (not true)) (=> (|M1.__default.ValidArgs#canCall| (Lit DatatypeTypeType |#M1.Primitive.primExec|) (M1.Expression.args |exec#0@0|) |st#0@0|) (or (M1.__default.ValidArgs (Lit DatatypeTypeType |#M1.Primitive.primExec|) (M1.Expression.args |exec#0@0|) |st#0@0|) (=> (not (U_2_bool (Lit boolType (bool_2_U (M1.Primitive.primCreatePath_q (Lit DatatypeTypeType |#M1.Primitive.primExec|)))))) (let ((|deps#1@@2| ($Unbox DatatypeTypeType (|Seq#Index| (M1.Expression.args |exec#0@0|) (LitInt 1)))))
(|Set#Subset| (M1.Literal.paths (M1.Expression.lit |deps#1@@2|)) (M1.__default.DomSt |st#0@0|)))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (or (not (= |calcH#0@0| (M1.__default.Loc |calcC#0@0| (|Set#UnionOne| |Set#Empty| |calcH#0@0|) |calcObj#0@0|))) (not true)) (=> (|M1.__default.ValidArgs#canCall| (Lit DatatypeTypeType |#M1.Primitive.primExec|) (M1.Expression.args |exec#0@0|) |st#0@0|) (or (M1.__default.ValidArgs (Lit DatatypeTypeType |#M1.Primitive.primExec|) (M1.Expression.args |exec#0@0|) |st#0@0|) (=> (not (U_2_bool (Lit boolType (bool_2_U (M1.Primitive.primCreatePath_q (Lit DatatypeTypeType |#M1.Primitive.primExec|)))))) (let ((|exps#1@@2| ($Unbox DatatypeTypeType (|Seq#Index| (M1.Expression.args |exec#0@0|) (LitInt 2)))))
(let ((|deps#1@@3| ($Unbox DatatypeTypeType (|Seq#Index| (M1.Expression.args |exec#0@0|) (LitInt 1)))))
(let ((|cmd#1@@2| ($Unbox DatatypeTypeType (|Seq#Index| (M1.Expression.args |exec#0@0|) (LitInt 0)))))
 (=> (|M1.__default.Pre#canCall| (M1.Literal.str (M1.Expression.lit |cmd#1@@2|)) (M1.Literal.paths (M1.Expression.lit |deps#1@@3|)) (M1.Literal.strs (M1.Expression.lit |exps#1@@2|)) |st#0@0|) (or (M1.__default.Pre (M1.Literal.str (M1.Expression.lit |cmd#1@@2|)) (M1.Literal.paths (M1.Expression.lit |deps#1@@3|)) (M1.Literal.strs (M1.Expression.lit |exps#1@@2|)) |st#0@0|) (forall ((|e#0@@1| T@U) ) (!  (=> ($Is SeqType |e#0@@1| (TSeq TChar)) (=> (|Set#IsMember| (M1.Literal.strs (M1.Expression.lit |exps#1@@2|)) ($Box SeqType |e#0@@1|)) (=> (|Set#IsMember| (M1.__default.DomSt |st#0@0|) (M1.__default.Loc (M1.Literal.str (M1.Expression.lit |cmd#1@@2|)) (M1.Literal.paths (M1.Expression.lit |deps#1@@3|)) |e#0@@1|)) (= (M1.__default.GetSt (M1.__default.Loc (M1.Literal.str (M1.Expression.lit |cmd#1@@2|)) (M1.Literal.paths (M1.Expression.lit |deps#1@@3|)) |e#0@@1|) |st#0@0|) (M1.__default.Oracle (M1.__default.Loc (M1.Literal.str (M1.Expression.lit |cmd#1@@2|)) (M1.Literal.paths (M1.Expression.lit |deps#1@@3|)) |e#0@@1|) |st#0@0|)))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |2103|
 :pattern ( (M1.__default.Loc (M1.Literal.str (M1.Expression.lit |cmd#1@@2|)) (M1.Literal.paths (M1.Expression.lit |deps#1@@3|)) |e#0@@1|))
 :pattern ( (|Set#IsMember| (M1.Literal.strs (M1.Expression.lit |exps#1@@2|)) ($Box SeqType |e#0@@1|)))
)))))))))))) (=> (=> (or (not (= |calcH#0@0| (M1.__default.Loc |calcC#0@0| (|Set#UnionOne| |Set#Empty| |calcH#0@0|) |calcObj#0@0|))) (not true)) (M1.__default.ValidArgs (Lit DatatypeTypeType |#M1.Primitive.primExec|) (M1.Expression.args |exec#0@0|) |st#0@0|)) (=> (and (= |program#0@0| (|#M1.Program.Program| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType (|#M1.Statement.stmtReturn| |exec#0@0|))))) ($IsAlloc DatatypeTypeType |program#0@0| Tclass.M1.Program $Heap@@13)) (=> (and (and ($IsAlloc DatatypeTypeType |st#0@0| Tclass.M1.State $Heap@@13) (= (ControlFlow 0 2) (- 0 1))) (|M1.__default.Legal#canCall| (M1.Program.stmts |program#0@0|))) (or (M1.__default.Legal (M1.Program.stmts |program#0@0|)) (or (not (= (|Seq#Length| (M1.Program.stmts |program#0@0|)) 0)) (not true))))))))))))))))))
(let ((anon3_Else_correct  (=> (and (= |calcH#0@0| (M1.__default.Loc |calcC#0@0| (|Set#UnionOne| |Set#Empty| |calcH#0@0|) |calcObj#0@0|)) (= (ControlFlow 0 16) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (or (not (= |calcH#0@0| (M1.__default.Loc |calcC#0@0| (|Set#UnionOne| |Set#Empty| |calcH#0@0|) |calcObj#0@0|))) (not true)) (=> (and (= |##prim#0@0| (Lit DatatypeTypeType |#M1.Primitive.primExec|)) ($IsAlloc DatatypeTypeType |##prim#0@0| Tclass.M1.Primitive $Heap@@13)) (and (=> (= (ControlFlow 0 12) (- 0 15)) (M1.Expression.exprInvocation_q |exec#0@0|)) (=> (M1.Expression.exprInvocation_q |exec#0@0|) (=> (= |##args#0@0| (M1.Expression.args |exec#0@0|)) (=> (and ($IsAlloc SeqType |##args#0@0| (TSeq Tclass.M1.Expression) $Heap@@13) ($IsAlloc DatatypeTypeType |st#0@0| Tclass.M1.State $Heap@@13)) (and (=> (= (ControlFlow 0 12) (- 0 14)) (=> (M1.Primitive.primExec_q |##prim#0@0|) (= (|Seq#Length| |##args#0@0|) (LitInt 3)))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (=> (M1.Primitive.primCreatePath_q |##prim#0@0|) (= (|Seq#Length| |##args#0@0|) (LitInt 1)))) (=> (and (|M1.__default.ValidArgs#canCall| (Lit DatatypeTypeType |#M1.Primitive.primExec|) (M1.Expression.args |exec#0@0|) |st#0@0|) (= (ControlFlow 0 12) 2)) anon2_correct)))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@13 alloc false)) (=> (and ($Is SeqType |calcC#0@0| (TSeq TChar)) ($IsAlloc SeqType |calcC#0@0| (TSeq TChar) $Heap@@13)) (=> (and (and (and (and ($IsBox |calcH#0@0| Tclass.M1.Path) ($IsAllocBox |calcH#0@0| Tclass.M1.Path $Heap@@13)) (and ($Is SeqType |calcObj#0@0| (TSeq TChar)) ($IsAlloc SeqType |calcObj#0@0| (TSeq TChar) $Heap@@13))) (and (and (= |cmd#0@0| (|#M1.Expression.exprLiteral| (|#M1.Literal.litString| |calcC#0@0|))) (= |deps#0@0| (|#M1.Expression.exprLiteral| (|#M1.Literal.litArrOfPaths| (|Set#UnionOne| |Set#Empty| |calcH#0@0|))))) (and (= |exps#0@0| (|#M1.Expression.exprLiteral| (|#M1.Literal.litArrOfStrings| (|Set#UnionOne| |Set#Empty| ($Box SeqType |calcObj#0@0|))))) (= |exec#0@0| (|#M1.Expression.exprInvocation| (Lit DatatypeTypeType (|#M1.Expression.exprLiteral| (Lit DatatypeTypeType (|#M1.Literal.litPrimitive| (Lit DatatypeTypeType |#M1.Primitive.primExec|))))) (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |cmd#0@0|)) ($Box DatatypeTypeType |deps#0@0|)) ($Box DatatypeTypeType |exps#0@0|))))))) (and (and (and ($IsBox |h#0@0| Tclass.M1.Artifact) ($IsAllocBox |h#0@0| Tclass.M1.Artifact $Heap@@13)) (and (= |st#0@0| (|#M1.State.StateCons| (|Map#Build| |Map#Empty| |calcH#0@0| |h#0@0|))) ($IsAlloc SeqType |calcC#0@0| (TSeq TChar) $Heap@@13))) (and (and (= |##deps#0@0| (|Set#UnionOne| |Set#Empty| |calcH#0@0|)) ($IsAlloc SetType |##deps#0@0| (TSet Tclass.M1.Path) $Heap@@13)) (and ($IsAlloc SeqType |calcObj#0@0| (TSeq TChar) $Heap@@13) (|M1.__default.Loc#canCall| |calcC#0@0| (|Set#UnionOne| |Set#Empty| |calcH#0@0|) |calcObj#0@0|))))) (and (=> (= (ControlFlow 0 17) 12) anon3_Then_correct) (=> (= (ControlFlow 0 17) 16) anon3_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@13) ($IsHeapAnchor $Heap@@13)) (=> (and (and (and ($Is SeqType |calcC#0| (TSeq TChar)) ($IsAlloc SeqType |calcC#0| (TSeq TChar) $Heap@@13)) true) (and (and ($IsBox |calcH#0| Tclass.M1.Path) ($IsAllocBox |calcH#0| Tclass.M1.Path $Heap@@13)) true)) (=> (and (and (and (and ($Is SeqType |calcObj#0| (TSeq TChar)) ($IsAlloc SeqType |calcObj#0| (TSeq TChar) $Heap@@13)) true) (and (and ($Is DatatypeTypeType |cmd#0@@6| Tclass.M1.Expression) ($IsAlloc DatatypeTypeType |cmd#0@@6| Tclass.M1.Expression $Heap@@13)) true)) (and (and (and ($Is DatatypeTypeType |deps#0@@6| Tclass.M1.Expression) ($IsAlloc DatatypeTypeType |deps#0@@6| Tclass.M1.Expression $Heap@@13)) true) (and (and ($Is DatatypeTypeType |exps#0@@5| Tclass.M1.Expression) ($IsAlloc DatatypeTypeType |exps#0@@5| Tclass.M1.Expression $Heap@@13)) true))) (=> (and (and (and (and (and ($Is DatatypeTypeType |exec#0| Tclass.M1.Expression) ($IsAlloc DatatypeTypeType |exec#0| Tclass.M1.Expression $Heap@@13)) true) (and (and ($IsBox |h#0| Tclass.M1.Artifact) ($IsAllocBox |h#0| Tclass.M1.Artifact $Heap@@13)) true)) (and (and (and ($Is DatatypeTypeType |st#0@@39| Tclass.M1.State) ($IsAlloc DatatypeTypeType |st#0@@39| Tclass.M1.State $Heap@@13)) true) (and (and ($Is DatatypeTypeType |program#0| Tclass.M1.Program) ($IsAlloc DatatypeTypeType |program#0| Tclass.M1.Program $Heap@@13)) true))) (and (and (and (and ($Is DatatypeTypeType |result#0@@0| (Tclass.M1.Tuple Tclass.M1.Expression Tclass.M1.State)) ($IsAlloc DatatypeTypeType |result#0@@0| (Tclass.M1.Tuple Tclass.M1.Expression Tclass.M1.State) $Heap@@13)) true) (and (and ($Is DatatypeTypeType |e#1@@1| Tclass.M1.Expression) ($IsAlloc DatatypeTypeType |e#1@@1| Tclass.M1.Expression $Heap@@13)) true)) (and (and (and ($Is DatatypeTypeType |st'#0@@7| Tclass.M1.State) ($IsAlloc DatatypeTypeType |st'#0@@7| Tclass.M1.State $Heap@@13)) true) (and (= 8 $FunctionContextHeight) (= (ControlFlow 0 18) 17))))) anon0_correct))))))
