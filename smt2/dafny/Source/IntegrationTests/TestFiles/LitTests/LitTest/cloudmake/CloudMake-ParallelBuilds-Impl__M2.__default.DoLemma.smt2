...
(assert (forall ((a@@15 T@U) (b@@12 T@U) (t0@@0 T@U) (t1@@0 T@U) ) (!  (=> (forall ((bx@@0 T@U) )  (=> (|Set#IsMember| a@@15 bx@@0) (and ($IsBox bx@@0 t0@@0) ($IsBox (MapType0Select BoxType BoxType b@@12 bx@@0) t1@@0)))) ($Is MapType (|Map#Glue| a@@15 b@@12 (TMap t0@@0 t1@@0)) (TMap t0@@0 t1@@0)))
