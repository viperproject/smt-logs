...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon4_correct  (=> (forall ((|st#1@@0| T@U) ) (!  (=> ($IsBox |st#1@@0| Tclass.M0.State) (and (=> (|Set#IsMember| |sts#0@@4| |st#1@@0|) (M0.__default.ValidState |st#1@@0|)) (=> (|Set#IsMember| |sts#0@@4| |st#1@@0|) (M0.__default.Extends |parent#0| |st#1@@0|))))
...
)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@5 $Heap@0) ($IsAlloc SetType |sts#0@@4| (TSet Tclass.M0.State) $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (|Set#Equal| |sts#0@@4| |Set#Empty|))) (=> (not (|Set#Equal| |sts#0@@4| |Set#Empty|)) (=> (and (and (and (|M0.__default.Combine#canCall| |sts#0@@4|) (= |##st#2@0| (M0.__default.Combine ($LS $LZ) |sts#0@@4|))) (and ($IsAllocBox |##st#2@0| Tclass.M0.State $Heap@0) (|M0.__default.ValidState#canCall| (M0.__default.Combine ($LS $LZ) |sts#0@@4|)))) (and (and (M0.__default.ValidState (M0.__default.Combine ($LS $LZ) |sts#0@@4|)) ($IsAllocBox |parent#0| Tclass.M0.State $Heap@0)) (and ($IsAlloc SetType |sts#0@@4| (TSet Tclass.M0.State) $Heap@0) (= (ControlFlow 0 2) (- 0 1))))) (not (|Set#Equal| |sts#0@@4| |Set#Empty|)))))))))
(let ((anon5_Else_correct  (=> (and (=> (|Set#IsMember| |sts#0@@4| |st#0@0|) (and (M0.__default.ValidState |st#0@0|) (M0.__default.Extends |parent#0| |st#0@0|))) (= (ControlFlow 0 5) 2)) anon4_correct)))
(let ((anon5_Then_correct  (=> (|Set#IsMember| |sts#0@@4| |st#0@0|) (=> (and (and (and ($IsAllocBox |st#0@0| Tclass.M0.State $Heap@@5) (|M0.__default.ValidState#canCall| |st#0@0|)) (and (M0.__default.ValidState |st#0@0|) ($IsAllocBox |parent#0| Tclass.M0.State $Heap@@5))) (and (and ($IsAllocBox |st#0@0| Tclass.M0.State $Heap@@5) (|M0.__default.Extends#canCall| |parent#0| |st#0@0|)) (and (M0.__default.Extends |parent#0| |st#0@0|) (= (ControlFlow 0 4) 2)))) anon4_correct))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@5 alloc false)) (not (|Set#Equal| |sts#0@@4| |Set#Empty|))) (and ($IsBox |st#0@0| Tclass.M0.State) ($IsAllocBox |st#0@0| Tclass.M0.State $Heap@@5))) (and (=> (= (ControlFlow 0 6) 4) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@5) ($IsHeapAnchor $Heap@@5)) (and ($Is SetType |sts#0@@4| (TSet Tclass.M0.State)) ($IsAlloc SetType |sts#0@@4| (TSet Tclass.M0.State) $Heap@@5))) (and (and ($IsBox |parent#0| Tclass.M0.State) ($IsAllocBox |parent#0| Tclass.M0.State $Heap@@5)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 7) 6)))) anon0_correct)))
