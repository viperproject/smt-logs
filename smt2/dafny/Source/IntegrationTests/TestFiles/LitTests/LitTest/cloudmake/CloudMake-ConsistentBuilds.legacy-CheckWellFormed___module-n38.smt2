...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.EvalArgsCLemma)
...
(let ((anon10_Else_correct  (=> (and (not (|Set#IsMember| |stsC'#Z#0@0| ($Box DatatypeTypeType |stC'#0@0|))) (= (ControlFlow 0 4) 1)) anon7_correct)))
(let ((anon10_Then_correct  (=> (and (and (|Set#IsMember| |stsC'#Z#0@0| ($Box DatatypeTypeType |stC'#0@0|)) ($IsAlloc DatatypeTypeType |stC'#0@0| Tclass._module.StateC $Heap@0)) (and (|_module.__default.ConsistentCache#canCall| |stC'#0@0|) (= (ControlFlow 0 3) 1))) anon7_correct)))
(let ((anon9_Then_correct  (=> (and ($Is DatatypeTypeType |stC'#0@0| Tclass._module.StateC) ($IsAlloc DatatypeTypeType |stC'#0@0| Tclass._module.StateC $Heap@0)) (and (=> (= (ControlFlow 0 5) 3) anon10_Then_correct) (=> (= (ControlFlow 0 5) 4) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |stC'#0@0| Tclass._module.StateC) ($IsAlloc DatatypeTypeType |stC'#0@0| Tclass._module.StateC $Heap@0))) (= (ControlFlow 0 2) 1)) anon7_correct)))
(let ((anon4_correct  (=> (forall ((|arg#1@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#1@@1| Tclass._module.Expression) (=> (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#1@@1|)) (< (DtRank |arg#1@@1|) (DtRank |expr#0@@16|))))
 :qid |CloudMakeConsistentBuildslegacydfy.633:19|
 :skolemid |1220|
 :pattern ( (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#1@@1|)))
)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@3 $Heap@0)) (and (and ($IsAlloc DatatypeTypeType |expr#0@@16| Tclass._module.Expression $Heap@0) ($IsAlloc SeqType |args#0@@11| (TSeq Tclass._module.Expression) $Heap@0)) (and ($IsAlloc DatatypeTypeType |stC#0@@32| Tclass._module.StateC $Heap@0) ($IsAllocBox |env#0@@15| Tclass._module.Env $Heap@0)))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((|arg#2@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#2@@2| Tclass._module.Expression) (=> (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#2@@2|)) (< (DtRank |arg#2@@2|) (DtRank |expr#0@@16|))))
 :qid |CloudMakeConsistentBuildslegacydfy.475:19|
 :skolemid |1221|
...
)) (|_module.__default.evalArgsC#canCall| |expr#0@@16| |args#0@@11| |stC#0@@32| |env#0@@15|)) (and (_module.Tuple.Pair_q (_module.__default.evalArgsC ($LS $LZ) |expr#0@@16| |args#0@@11| |stC#0@@32| |env#0@@15|)) (= |let#0#0#0| (_module.__default.evalArgsC ($LS $LZ) |expr#0@@16| |args#0@@11| |stC#0@@32| |env#0@@15|)))) (=> (and (and (and (|_module.__default.evalArgsC#canCall| |expr#0@@16| |args#0@@11| |stC#0@@32| |env#0@@15|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.Tuple (TSeq Tclass._module.Expression) (TSet Tclass._module.StateC)))) (and (= |result#Z#0@0| |let#0#0#0|) (_module.Tuple.Pair_q |result#Z#0@0|))) (and (and (= |let#1#0#0| ($Unbox SetType (_module.Tuple.snd |result#Z#0@0|))) (_module.Tuple.Pair_q |result#Z#0@0|)) (and ($Is SetType |let#1#0#0| (TSet Tclass._module.StateC)) (= |stsC'#Z#0@0| |let#1#0#0|)))) (and (=> (= (ControlFlow 0 6) 5) anon9_Then_correct) (=> (= (ControlFlow 0 6) 2) anon9_Else_correct)))))))))
(let ((anon8_Else_correct  (=> (and (=> (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#0@0|)) (< (DtRank |arg#0@0|) (DtRank |expr#0@@16|))) (= (ControlFlow 0 9) 6)) anon4_correct)))
(let ((anon8_Then_correct  (=> (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#0@0|)) (=> (and (< (DtRank |arg#0@0|) (DtRank |expr#0@@16|)) (= (ControlFlow 0 8) 6)) anon4_correct))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@3 alloc false)) ($IsAlloc DatatypeTypeType |stC#0@@32| Tclass._module.StateC $Heap@@3)) (=> (and (and (|_module.__default.ConsistentCache#canCall| |stC#0@@32|) (_module.__default.ConsistentCache |stC#0@@32|)) (and ($Is DatatypeTypeType |arg#0@0| Tclass._module.Expression) ($IsAlloc DatatypeTypeType |arg#0@0| Tclass._module.Expression $Heap@@3))) (and (=> (= (ControlFlow 0 10) 8) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and (and (and ($Is DatatypeTypeType |expr#0@@16| Tclass._module.Expression) ($IsAlloc DatatypeTypeType |expr#0@@16| Tclass._module.Expression $Heap@@3)) (|$IsA#_module.Expression| |expr#0@@16|)) (and ($Is SeqType |args#0@@11| (TSeq Tclass._module.Expression)) ($IsAlloc SeqType |args#0@@11| (TSeq Tclass._module.Expression) $Heap@@3))) (and (and (and ($Is DatatypeTypeType |stC#0@@32| Tclass._module.StateC) ($IsAlloc DatatypeTypeType |stC#0@@32| Tclass._module.StateC $Heap@@3)) (|$IsA#_module.StateC| |stC#0@@32|)) (and (and ($IsBox |env#0@@15| Tclass._module.Env) ($IsAllocBox |env#0@@15| Tclass._module.Env $Heap@@3)) (and (= 7 $FunctionContextHeight) (= (ControlFlow 0 11) 10))))) anon0_correct))))
