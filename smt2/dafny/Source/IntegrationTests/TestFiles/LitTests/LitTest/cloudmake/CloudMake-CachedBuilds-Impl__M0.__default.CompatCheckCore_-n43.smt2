...
(declare-fun |defass#p#8| () Bool)
(declare-fun |p#8| () T@U)
(declare-fun |defass#pC#0| () Bool)
...
(set-info :boogie-vc-id Impl$$M0.__default.CompatCheckCore__StateCorrespondence)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 44) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence (M0.Tuple.snd (M0.__default.evalCompatCheckCore |stOrig#0@@9| |sts#0@@10| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false))))) (M0.Tuple.snd (M0.__default.evalCompatCheckCore |stOrigC#0| |stsC#0| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true)))))))))
(let ((anon9_Else_correct  (=> (and (not (and (and (M0.Expression.exprLiteral_q |fun#0@@4|) (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|))) (M0.Primitive.primExec_q (M0.Literal.prim (M0.Expression.lit |fun#0@@4|))))) (= (ControlFlow 0 24) 2)) GeneratedUnifiedExit_correct)))
(let ((anon9_Then_correct  (=> (and (and (M0.Expression.exprLiteral_q |fun#0@@4|) (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|))) (M0.Primitive.primExec_q (M0.Literal.prim (M0.Expression.lit |fun#0@@4|)))) (and (=> (= (ControlFlow 0 3) (- 0 23)) true) (=> (and (M0.Tuple.Pair_q |$rhs#0@0|) ($IsAllocBox |stOrig#0@@9| Tclass.M0.State $Heap@2)) (and (=> (= (ControlFlow 0 3) (- 0 22)) true) (=> ($IsAllocBox |stCombined#0@0| Tclass.M0.State $Heap@2) (=> (and (and (and ($IsAlloc SeqType |args#0@@12| (TSeq Tclass.M0.Expression) $Heap@2) (= |##useCache#0_0@0| (U_2_bool (Lit boolType (bool_2_U false))))) (and ($IsAlloc boolType (bool_2_U |##useCache#0_0@0|) TBool $Heap@2) (|M0.__default.evalCore#canCall| |stOrig#0@@9| |stCombined#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))))) (and (and (M0.Tuple.Pair_q (M0.__default.evalCore |stOrig#0@@9| |stCombined#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false))))) (M0.Tuple.Pair_q (M0.__default.evalCore |stOrig#0@@9| |stCombined#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))))) (and (M0.Tuple.Pair_q |$rhs#0@0|) (and (|M0.__default.evalCore#canCall| |stOrig#0@@9| |stCombined#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))) (M0.Tuple.Pair_q (M0.__default.evalCore |stOrig#0@@9| |stCombined#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false))))))))) (and (=> (= (ControlFlow 0 3) (- 0 21)) (= (M0.Tuple.snd |$rhs#0@0|) (M0.Tuple.snd (M0.__default.evalCore |stOrig#0@@9| |stCombined#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false))))))) (=> (= (M0.Tuple.snd |$rhs#0@0|) (M0.Tuple.snd (M0.__default.evalCore |stOrig#0@@9| |stCombined#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))))) (and (=> (= (ControlFlow 0 3) (- 0 20)) true) (=> (and (M0.Tuple.Pair_q |$rhs#1@0|) ($IsAllocBox |stOrigC#0| Tclass.M0.State $Heap@2)) (and (=> (= (ControlFlow 0 3) (- 0 19)) true) (=> ($IsAllocBox |stCombinedC#0@0| Tclass.M0.State $Heap@2) (=> (and (and (and ($IsAlloc SeqType |args#0@@12| (TSeq Tclass.M0.Expression) $Heap@2) (= |##useCache#0_1@0| (U_2_bool (Lit boolType (bool_2_U true))))) (and ($IsAlloc boolType (bool_2_U |##useCache#0_1@0|) TBool $Heap@2) (|M0.__default.evalCore#canCall| |stOrigC#0| |stCombinedC#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true)))))) (and (and (M0.Tuple.Pair_q (M0.__default.evalCore |stOrigC#0| |stCombinedC#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true))))) (M0.Tuple.Pair_q (M0.__default.evalCore |stOrigC#0| |stCombinedC#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true)))))) (and (M0.Tuple.Pair_q |$rhs#1@0|) (and (|M0.__default.evalCore#canCall| |stOrigC#0| |stCombinedC#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true)))) (M0.Tuple.Pair_q (M0.__default.evalCore |stOrigC#0| |stCombinedC#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true))))))))) (and (=> (= (ControlFlow 0 3) (- 0 18)) (= (M0.Tuple.snd |$rhs#1@0|) (M0.Tuple.snd (M0.__default.evalCore |stOrigC#0| |stCombinedC#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (= (M0.Tuple.snd |$rhs#1@0|) (M0.Tuple.snd (M0.__default.evalCore |stOrigC#0| |stCombinedC#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 3) (- 0 17)) true) (and (=> (= (ControlFlow 0 3) (- 0 16)) true) (and (=> (= (ControlFlow 0 3) (- 0 15)) true) (and (=> (= (ControlFlow 0 3) (- 0 14)) true) (and (=> (= (ControlFlow 0 3) (- 0 13)) (|M0.Tuple#Equal| |$rhs#0@0| (M0.__default.evalCore |stOrig#0@@9| |stCombined#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))))) (=> (|M0.Tuple#Equal| |$rhs#0@0| (M0.__default.evalCore |stOrig#0@@9| |stCombined#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false))))) (and (=> (= (ControlFlow 0 3) (- 0 12)) (|M0.Tuple#Equal| |$rhs#1@0| (M0.__default.evalCore |stOrigC#0| |stCombinedC#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true)))))) (=> (|M0.Tuple#Equal| |$rhs#1@0| (M0.__default.evalCore |stOrigC#0| |stCombinedC#0@0| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true))))) (and (=> (= (ControlFlow 0 3) (- 0 11)) (=> (|M0.__default.ValidState#canCall| |stCombined#0@0|) (or (M0.__default.ValidState |stCombined#0@0|) (forall ((|p#1@@7| T@U) ) (!  (=> ($IsBox |p#1@@7| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |stCombined#0@0|) |p#1@@7|) (M0.__default.WellFounded |p#1@@7|)))
 :qid |CloudMakeCachedBuildsdfy.35:12|
 :skolemid |1592|
...
)))) (and (=> (= (ControlFlow 0 3) (- 0 10)) (=> (|M0.__default.ValidState#canCall| |stCombinedC#0@0|) (or (M0.__default.ValidState |stCombinedC#0@0|) (forall ((|p#2@@5| T@U) ) (!  (=> ($IsBox |p#2@@5| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |stCombinedC#0@0|) |p#2@@5|) (M0.__default.WellFounded |p#2@@5|)))
 :qid |CloudMakeCachedBuildsdfy.35:12|
 :skolemid |1594|
...
)))) (and (=> (= (ControlFlow 0 3) (- 0 8)) (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence |stOrig#0@@9| |stOrigC#0|)) (=> (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence |stOrig#0@@9| |stOrigC#0|) (and (=> (= (ControlFlow 0 3) (- 0 7)) (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence |stCombined#0@0| |stCombinedC#0@0|)) (=> (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence |stCombined#0@0| |stCombinedC#0@0|) (=> (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (=> (and (and (and (and (|$IsA#M0.Expression| ($Unbox DatatypeTypeType (M0.Tuple.fst |$rhs#0@0|))) (|$IsA#M0.Expression| ($Unbox DatatypeTypeType (M0.Tuple.fst |$rhs#1@0|)))) (and (M0.Tuple.Pair_q |$rhs#0@0|) (M0.Tuple.Pair_q |$rhs#1@0|))) (|M0.Expression#Equal| ($Unbox DatatypeTypeType (M0.Tuple.fst |$rhs#0@0|)) ($Unbox DatatypeTypeType (M0.Tuple.fst |$rhs#1@0|)))) (and (and (and (M0.Tuple.Pair_q |$rhs#0@0|) (M0.Tuple.Pair_q |$rhs#1@0|)) (|M0.__default.StateCorrespondence#canCall| (M0.Tuple.snd |$rhs#0@0|) (M0.Tuple.snd |$rhs#1@0|))) (and (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence (M0.Tuple.snd |$rhs#0@0|) (M0.Tuple.snd |$rhs#1@0|)) (= $Heap@2 $Heap@3)))) (and (=> (= (ControlFlow 0 3) (- 0 6)) true) (=> (M0.Tuple.Pair_q |$rhs#0@0|) (=> (and (= |##st#0_0@0| (M0.Tuple.snd |$rhs#0@0|)) ($IsAllocBox |##st#0_0@0| Tclass.M0.State $Heap@3)) (and (=> (= (ControlFlow 0 3) (- 0 5)) true) (=> (and (and (and (M0.Tuple.Pair_q |$rhs#1@0|) (= |##stC#0_0@0| (M0.Tuple.snd |$rhs#1@0|))) (and ($IsAllocBox |##stC#0_0@0| Tclass.M0.State $Heap@3) (|M0.__default.StateCorrespondence#canCall| (M0.Tuple.snd |$rhs#0@0|) (M0.Tuple.snd |$rhs#1@0|)))) (and (and (M0.Tuple.Pair_q |$rhs#0@0|) (M0.Tuple.Pair_q |$rhs#1@0|)) (|M0.__default.StateCorrespondence#canCall| (M0.Tuple.snd |$rhs#0@0|) (M0.Tuple.snd |$rhs#1@0|)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence (M0.Tuple.snd |$rhs#0@0|) (M0.Tuple.snd |$rhs#1@0|))) (=> (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence (M0.Tuple.snd |$rhs#0@0|) (M0.Tuple.snd |$rhs#1@0|)) (=> (= (ControlFlow 0 3) 2) GeneratedUnifiedExit_correct)))))))))))))))))))))))))))))))))))))))))))))
(let ((anon4_correct  (and (=> (= (ControlFlow 0 25) 3) anon9_Then_correct) (=> (= (ControlFlow 0 25) 24) anon9_Else_correct))))
(let ((anon8_Else_correct  (=> (and (not (and (M0.Expression.exprLiteral_q |fun#0@@4|) (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|)))) (= (ControlFlow 0 29) 25)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (M0.Expression.exprLiteral_q |fun#0@@4|) (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|))) (and (=> (= (ControlFlow 0 26) (- 0 28)) (M0.Expression.exprLiteral_q |fun#0@@4|)) (=> (M0.Expression.exprLiteral_q |fun#0@@4|) (and (=> (= (ControlFlow 0 26) (- 0 27)) (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|))) (=> (M0.Literal.litPrimitive_q (M0.Expression.lit |fun#0@@4|)) (=> (= (ControlFlow 0 26) 25) anon4_correct))))))))
(let ((anon7_Else_correct  (=> (not (M0.Expression.exprLiteral_q |fun#0@@4|)) (and (=> (= (ControlFlow 0 32) 26) anon8_Then_correct) (=> (= (ControlFlow 0 32) 29) anon8_Else_correct)))))
(let ((anon7_Then_correct  (=> (M0.Expression.exprLiteral_q |fun#0@@4|) (and (=> (= (ControlFlow 0 30) (- 0 31)) (M0.Expression.exprLiteral_q |fun#0@@4|)) (=> (M0.Expression.exprLiteral_q |fun#0@@4|) (and (=> (= (ControlFlow 0 30) 26) anon8_Then_correct) (=> (= (ControlFlow 0 30) 29) anon8_Else_correct)))))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@8 alloc false)) (|$IsA#M0.Expression| |fun#0@@4|)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (=> (and (and (and (= $Heap@@8 $Heap@0) (forall ((|$ih#sts0#0| T@U) (|$ih#stsC0#0| T@U) ) (!  (=> (and (and (and ($Is SetType |$ih#sts0#0| (TSet Tclass.M0.State)) ($Is SetType |$ih#stsC0#0| (TSet Tclass.M0.State))) (and (and (and (and (and (and (and (M0.__default.ValidState |stOrig#0@@9|) (M0.__default.ValidState |stOrigC#0|)) (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence |stOrig#0@@9| |stOrigC#0|)) (and (not (|Set#Equal| |$ih#sts0#0| |Set#Empty|)) (not (|Set#Equal| |$ih#stsC0#0| |Set#Empty|)))) (and (M0.__default.Compatible |$ih#sts0#0|) (M0.__default.Compatible |$ih#stsC0#0|))) (forall ((|s#4| T@U) ) (!  (=> ($IsBox |s#4| Tclass.M0.State) (and (=> (|Set#IsMember| |$ih#sts0#0| |s#4|) (M0.__default.ValidState |s#4|)) (=> (|Set#IsMember| |$ih#sts0#0| |s#4|) (M0.__default.Extends reveal_M0._default.Extends |stOrig#0@@9| |s#4|))))
 :qid |CloudMakeCachedBuildsdfy.883:21|
 :skolemid |1556|
 :pattern ( (M0.__default.Extends reveal_M0._default.Extends |stOrig#0@@9| |s#4|))
 :pattern ( (M0.__default.ValidState |s#4|))
 :pattern ( (|Set#IsMember| |$ih#sts0#0| |s#4|))
))) (forall ((|s#5| T@U) ) (!  (=> ($IsBox |s#5| Tclass.M0.State) (and (and (=> (|Set#IsMember| |$ih#stsC0#0| |s#5|) (M0.__default.ValidState |s#5|)) (=> (|Set#IsMember| |$ih#stsC0#0| |s#5|) (M0.__default.Extends reveal_M0._default.Extends |stOrigC#0| |s#5|))) (=> (|Set#IsMember| |$ih#stsC0#0| |s#5|) (M0.__default.ConsistentCache |s#5|))))
 :qid |CloudMakeCachedBuildsdfy.884:21|
 :skolemid |1557|
 :pattern ( (M0.__default.ConsistentCache |s#5|))
 :pattern ( (M0.__default.Extends reveal_M0._default.Extends |stOrigC#0| |s#5|))
 :pattern ( (M0.__default.ValidState |s#5|))
 :pattern ( (|Set#IsMember| |$ih#stsC0#0| |s#5|))
))) (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |$ih#sts0#0| (U_2_bool (Lit boolType (bool_2_U false)))) (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |$ih#stsC0#0| (U_2_bool (Lit boolType (bool_2_U true))))))) (or (and (|Set#Subset| |$ih#sts0#0| |sts#0@@10|) (not (|Set#Subset| |sts#0@@10| |$ih#sts0#0|))) (and (|Set#Equal| |$ih#sts0#0| |sts#0@@10|) (or (and (|Set#Subset| |$ih#stsC0#0| |stsC#0|) (not (|Set#Subset| |stsC#0| |$ih#stsC0#0|))) (and (|Set#Equal| |$ih#stsC0#0| |stsC#0|) (or (< (DtRank |fun#0@@4|) (DtRank |fun#0@@4|)) (and (= (DtRank |fun#0@@4|) (DtRank |fun#0@@4|)) (< (|Seq#Rank| |args#0@@12|) (|Seq#Rank| |args#0@@12|))))))))) (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence (M0.Tuple.snd (M0.__default.evalCompatCheckCore |stOrig#0@@9| |$ih#sts0#0| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false))))) (M0.Tuple.snd (M0.__default.evalCompatCheckCore |stOrigC#0| |$ih#stsC0#0| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true)))))))
 :qid |CloudMakeCachedBuildsdfy.878:60|
 :skolemid |1558|
 :pattern ( (M0.__default.evalCompatCheckCore |stOrigC#0| |$ih#stsC0#0| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true)))) (M0.__default.evalCompatCheckCore |stOrig#0@@9| |$ih#sts0#0| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))))
 :pattern ( (M0.__default.evalCompatCheckCore |stOrigC#0| |$ih#stsC0#0| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true)))) (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |$ih#sts0#0| (U_2_bool (Lit boolType (bool_2_U false)))))
 :pattern ( (M0.__default.evalCompatCheckCore |stOrigC#0| |$ih#stsC0#0| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true)))) (M0.__default.Compatible |$ih#sts0#0|))
 :pattern ( (M0.__default.evalCompatCheckCore |stOrig#0@@9| |$ih#sts0#0| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))) (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |$ih#stsC0#0| (U_2_bool (Lit boolType (bool_2_U true)))))
 :pattern ( (M0.__default.evalCompatCheckCore |stOrig#0@@9| |$ih#sts0#0| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))) (M0.__default.Compatible |$ih#stsC0#0|))
 :pattern ( (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |$ih#stsC0#0| (U_2_bool (Lit boolType (bool_2_U true)))) (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |$ih#sts0#0| (U_2_bool (Lit boolType (bool_2_U false)))))
 :pattern ( (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |$ih#stsC0#0| (U_2_bool (Lit boolType (bool_2_U true)))) (M0.__default.Compatible |$ih#sts0#0|))
 :pattern ( (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |$ih#sts0#0| (U_2_bool (Lit boolType (bool_2_U false)))) (M0.__default.Compatible |$ih#stsC0#0|))
 :pattern ( (M0.__default.Compatible |$ih#stsC0#0|) (M0.__default.Compatible |$ih#sts0#0|))
))) (and ($IsAllocBox |stOrig#0@@9| Tclass.M0.State $Heap@0) ($IsAlloc SetType |sts#0@@10| (TSet Tclass.M0.State) $Heap@0))) (and (and ($IsAlloc DatatypeTypeType |fun#0@@4| Tclass.M0.Expression $Heap@0) ($IsAlloc SeqType |args#0@@12| (TSeq Tclass.M0.Expression) $Heap@0)) (and (= |##useCache#4@0| (U_2_bool (Lit boolType (bool_2_U false)))) ($IsAlloc boolType (bool_2_U |##useCache#4@0|) TBool $Heap@0)))) (and (=> (= (ControlFlow 0 33) (- 0 43)) (not (|Set#Equal| |sts#0@@10| |Set#Empty|))) (=> (not (|Set#Equal| |sts#0@@10| |Set#Empty|)) (=> (and (|M0.__default.evalCompatCheckCore#canCall| |stOrig#0@@9| |sts#0@@10| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))) (M0.Tuple.Pair_q (M0.__default.evalCompatCheckCore |stOrig#0@@9| |sts#0@@10| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))))) (=> (and (and (and (|M0.__default.evalCompatCheckCore#canCall| |stOrig#0@@9| |sts#0@@10| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))) (= |$rhs#0@0| (M0.__default.evalCompatCheckCore |stOrig#0@@9| |sts#0@@10| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))))) (and ($IsAllocBox |stOrigC#0| Tclass.M0.State $Heap@0) ($IsAlloc SetType |stsC#0| (TSet Tclass.M0.State) $Heap@0))) (and (and ($IsAlloc DatatypeTypeType |fun#0@@4| Tclass.M0.Expression $Heap@0) ($IsAlloc SeqType |args#0@@12| (TSeq Tclass.M0.Expression) $Heap@0)) (and (= |##useCache#5@0| (U_2_bool (Lit boolType (bool_2_U true)))) ($IsAlloc boolType (bool_2_U |##useCache#5@0|) TBool $Heap@0)))) (and (=> (= (ControlFlow 0 33) (- 0 42)) (not (|Set#Equal| |stsC#0| |Set#Empty|))) (=> (and (and (and (not (|Set#Equal| |stsC#0| |Set#Empty|)) (|M0.__default.evalCompatCheckCore#canCall| |stOrigC#0| |stsC#0| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true))))) (and (M0.Tuple.Pair_q (M0.__default.evalCompatCheckCore |stOrigC#0| |stsC#0| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true))))) (|M0.__default.evalCompatCheckCore#canCall| |stOrigC#0| |stsC#0| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true)))))) (and (and (= |$rhs#1@0| (M0.__default.evalCompatCheckCore |stOrigC#0| |stsC#0| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U true))))) ($IsAlloc SetType |sts#0@@10| (TSet Tclass.M0.State) $Heap@0)) (and (= |##useCache#6@0| (U_2_bool (Lit boolType (bool_2_U false)))) ($IsAlloc boolType (bool_2_U |##useCache#6@0|) TBool $Heap@0)))) (and (=> (= (ControlFlow 0 33) (- 0 41)) (not (|Set#Equal| |sts#0@@10| |Set#Empty|))) (=> (not (|Set#Equal| |sts#0@@10| |Set#Empty|)) (=> (and (and (|M0.__default.Combine#canCall| |sts#0@@10| (U_2_bool (Lit boolType (bool_2_U false)))) (|M0.__default.Combine#canCall| |sts#0@@10| (U_2_bool (Lit boolType (bool_2_U false))))) (and (= |stCombined#0@0| (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |sts#0@@10| (U_2_bool (Lit boolType (bool_2_U false))))) (= |useCache##0@0| (U_2_bool (Lit boolType (bool_2_U false)))))) (and (=> (= (ControlFlow 0 33) (- 0 40)) (not (|Set#Equal| |sts#0@@10| |Set#Empty|))) (=> (not (|Set#Equal| |sts#0@@10| |Set#Empty|)) (and (=> (= (ControlFlow 0 33) (- 0 39)) (forall ((|st#1@@3| T@U) ) (!  (=> ($IsBox |st#1@@3| Tclass.M0.State) (and (=> (|Set#IsMember| |sts#0@@10| |st#1@@3|) (M0.__default.ValidState |st#1@@3|)) (=> (|Set#IsMember| |sts#0@@10| |st#1@@3|) (M0.__default.Extends reveal_M0._default.Extends |stOrig#0@@9| |st#1@@3|))))
 :qid |CloudMakeCachedBuildsdfy.82:15|
 :skolemid |800|
 :pattern ( (M0.__default.Extends reveal_M0._default.Extends |stOrig#0@@9| |st#1@@3|))
 :pattern ( (M0.__default.ValidState |st#1@@3|))
 :pattern ( (|Set#IsMember| |sts#0@@10| |st#1@@3|))
))) (=> (forall ((|st#1@@4| T@U) ) (!  (=> ($IsBox |st#1@@4| Tclass.M0.State) (and (=> (|Set#IsMember| |sts#0@@10| |st#1@@4|) (M0.__default.ValidState |st#1@@4|)) (=> (|Set#IsMember| |sts#0@@10| |st#1@@4|) (M0.__default.Extends reveal_M0._default.Extends |stOrig#0@@9| |st#1@@4|))))
 :qid |CloudMakeCachedBuildsdfy.82:15|
 :skolemid |800|
 :pattern ( (M0.__default.Extends reveal_M0._default.Extends |stOrig#0@@9| |st#1@@4|))
 :pattern ( (M0.__default.ValidState |st#1@@4|))
 :pattern ( (|Set#IsMember| |sts#0@@10| |st#1@@4|))
)) (and (=> (= (ControlFlow 0 33) (- 0 38)) (=> |useCache##0@0| (forall ((|st#3| T@U) ) (!  (=> ($IsBox |st#3| Tclass.M0.State) (=> (|Set#IsMember| |sts#0@@10| |st#3|) (M0.__default.ConsistentCache |st#3|)))
 :qid |CloudMakeCachedBuildsdfy.83:28|
 :skolemid |801|
 :pattern ( (M0.__default.ConsistentCache |st#3|))
 :pattern ( (|Set#IsMember| |sts#0@@10| |st#3|))
)))) (=> (=> |useCache##0@0| (forall ((|st#3@@0| T@U) ) (!  (=> ($IsBox |st#3@@0| Tclass.M0.State) (=> (|Set#IsMember| |sts#0@@10| |st#3@@0|) (M0.__default.ConsistentCache |st#3@@0|)))
 :qid |CloudMakeCachedBuildsdfy.83:28|
 :skolemid |801|
 :pattern ( (M0.__default.ConsistentCache |st#3@@0|))
 :pattern ( (|Set#IsMember| |sts#0@@10| |st#3@@0|))
))) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (|M0.__default.Combine#canCall| |sts#0@@10| |useCache##0@0|) (let ((|stCombined#0@@7| (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |sts#0@@10| |useCache##0@0|)))
 (and (|M0.__default.ValidState#canCall| |stCombined#0@@7|) (=> (M0.__default.ValidState |stCombined#0@@7|) (and (|M0.__default.Extends#canCall| |stOrig#0@@9| |stCombined#0@@7|) (=> (M0.__default.Extends reveal_M0._default.Extends |stOrig#0@@9| |stCombined#0@@7|) (=> |useCache##0@0| (and (|M0.__default.ConsistentCache#canCall| |stCombined#0@@7|) (=> (M0.__default.ConsistentCache |stCombined#0@@7|) (and (forall ((|st#7| T@U) ) (!  (=> ($IsBox |st#7| Tclass.M0.State) (=> (|Set#IsMember| |sts#0@@10| |st#7|) (and (|M0.__default.DomC#canCall| |st#7|) (|M0.__default.DomC#canCall| |stCombined#0@@7|))))
 :qid |CloudMakeCachedBuildsdfy.89:17|
 :skolemid |802|
 :pattern ( (M0.__default.DomC |st#7|))
 :pattern ( (|Set#IsMember| |sts#0@@10| |st#7|))
)) (=> (forall ((|st#7@@0| T@U) ) (!  (=> ($IsBox |st#7@@0| Tclass.M0.State) (=> (|Set#IsMember| |sts#0@@10| |st#7@@0|) (|Set#Subset| (M0.__default.DomC |st#7@@0|) (M0.__default.DomC |stCombined#0@@7|))))
 :qid |CloudMakeCachedBuildsdfy.89:17|
 :skolemid |805|
 :pattern ( (M0.__default.DomC |st#7@@0|))
 :pattern ( (|Set#IsMember| |sts#0@@10| |st#7@@0|))
)) (forall ((|h#1| T@U) ) (!  (=> ($IsBox |h#1| Tclass.M0.HashValue) (and (|M0.__default.DomC#canCall| |stCombined#0@@7|) (=> (|Set#IsMember| (M0.__default.DomC |stCombined#0@@7|) |h#1|) (forall ((|st#8| T@U) ) (!  (=> ($IsBox |st#8| Tclass.M0.State) (=> (|Set#IsMember| |sts#0@@10| |st#8|) (|M0.__default.DomC#canCall| |st#8|)))
 :qid |CloudMakeCachedBuildsdfy.90:55|
 :skolemid |803|
 :pattern ( (M0.__default.DomC |st#8|))
 :pattern ( (|Set#IsMember| |sts#0@@10| |st#8|))
)))))
 :qid |CloudMakeCachedBuildsdfy.90:17|
 :skolemid |804|
 :pattern ( (|Set#IsMember| (M0.__default.DomC |stCombined#0@@7|) |h#1|))
))))))))))))) (let ((|stCombined#0@@8| (M0.__default.Combine ($LS ($LS $LZ)) reveal_M0._default.Combine |sts#0@@10| |useCache##0@0|)))
 (and (|M0.__default.ValidState#canCall| |stCombined#0@@8|) (and (M0.__default.ValidState |stCombined#0@@8|) (forall ((|p#0@@17| T@U) ) (!  (=> ($IsBox |p#0@@17| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |stCombined#0@@8|) |p#0@@17|) (M0.__default.WellFounded |p#0@@17|)))
 :qid |CloudMakeCachedBuildsdfy.35:12|
 :skolemid |807|
 :pattern ( (M0.__default.WellFounded |p#0@@17|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |stCombined#0@@8|) |p#0@@17|))
)))))) (=> (and (and (and (let ((|stCombined#0@@9| (M0.__default.Combine ($LS ($LS $LZ)) reveal_M0._default.Combine |sts#0@@10| |useCache##0@0|)))
(M0.__default.Extends reveal_M0._default.Extends |stOrig#0@@9| |stCombined#0@@9|)) (let ((|stCombined#0@@10| (M0.__default.Combine ($LS ($LS $LZ)) reveal_M0._default.Combine |sts#0@@10| |useCache##0@0|)))
...
))))))) (and (let ((|stCombined#0@@11| (M0.__default.Combine ($LS ($LS $LZ)) reveal_M0._default.Combine |sts#0@@10| |useCache##0@0|)))
 (=> |useCache##0@0| (forall ((|st#7@@1| T@U) ) (!  (=> ($IsBox |st#7@@1| Tclass.M0.State) (=> (|Set#IsMember| |sts#0@@10| |st#7@@1|) (|Set#Subset| (M0.__default.DomC |st#7@@1|) (M0.__default.DomC |stCombined#0@@11|))))
 :qid |CloudMakeCachedBuildsdfy.89:17|
 :skolemid |810|
 :pattern ( (M0.__default.DomC |st#7@@1|))
 :pattern ( (|Set#IsMember| |sts#0@@10| |st#7@@1|))
)))) (let ((|stCombined#0@@12| (M0.__default.Combine ($LS ($LS $LZ)) reveal_M0._default.Combine |sts#0@@10| |useCache##0@0|)))
 (=> |useCache##0@0| (forall ((|h#1@@0| T@U) ) (!  (=> ($IsBox |h#1@@0| Tclass.M0.HashValue) (=> (|Set#IsMember| (M0.__default.DomC |stCombined#0@@12|) |h#1@@0|) (exists ((|st#8@@0| T@U) ) (!  (and ($IsBox |st#8@@0| Tclass.M0.State) (and (|Set#IsMember| |sts#0@@10| |st#8@@0|) (|Set#IsMember| (M0.__default.DomC |st#8@@0|) |h#1@@0|)))
 :qid |CloudMakeCachedBuildsdfy.90:55|
 :skolemid |811|
 :pattern ( (M0.__default.DomC |st#8@@0|))
 :pattern ( (|Set#IsMember| |sts#0@@10| |st#8@@0|))
))))
 :qid |CloudMakeCachedBuildsdfy.90:17|
 :skolemid |812|
 :pattern ( (|Set#IsMember| (M0.__default.DomC |stCombined#0@@12|) |h#1@@0|))
)))))) (and (and (= $Heap@0 $Heap@1) ($IsAlloc SetType |stsC#0| (TSet Tclass.M0.State) $Heap@1)) (and (= |##useCache#7@0| (U_2_bool (Lit boolType (bool_2_U true)))) ($IsAlloc boolType (bool_2_U |##useCache#7@0|) TBool $Heap@1)))) (and (=> (= (ControlFlow 0 33) (- 0 37)) (not (|Set#Equal| |stsC#0| |Set#Empty|))) (=> (not (|Set#Equal| |stsC#0| |Set#Empty|)) (=> (and (and (|M0.__default.Combine#canCall| |stsC#0| (U_2_bool (Lit boolType (bool_2_U true)))) (|M0.__default.Combine#canCall| |stsC#0| (U_2_bool (Lit boolType (bool_2_U true))))) (and (= |stCombinedC#0@0| (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |stsC#0| (U_2_bool (Lit boolType (bool_2_U true))))) (= |useCache##1@0| (U_2_bool (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 33) (- 0 36)) (not (|Set#Equal| |stsC#0| |Set#Empty|))) (=> (not (|Set#Equal| |stsC#0| |Set#Empty|)) (and (=> (= (ControlFlow 0 33) (- 0 35)) (forall ((|st#1@@5| T@U) ) (!  (=> ($IsBox |st#1@@5| Tclass.M0.State) (and (=> (|Set#IsMember| |stsC#0| |st#1@@5|) (M0.__default.ValidState |st#1@@5|)) (=> (|Set#IsMember| |stsC#0| |st#1@@5|) (M0.__default.Extends reveal_M0._default.Extends |stOrigC#0| |st#1@@5|))))
 :qid |CloudMakeCachedBuildsdfy.82:15|
 :skolemid |800|
 :pattern ( (M0.__default.Extends reveal_M0._default.Extends |stOrigC#0| |st#1@@5|))
 :pattern ( (M0.__default.ValidState |st#1@@5|))
 :pattern ( (|Set#IsMember| |stsC#0| |st#1@@5|))
))) (=> (forall ((|st#1@@6| T@U) ) (!  (=> ($IsBox |st#1@@6| Tclass.M0.State) (and (=> (|Set#IsMember| |stsC#0| |st#1@@6|) (M0.__default.ValidState |st#1@@6|)) (=> (|Set#IsMember| |stsC#0| |st#1@@6|) (M0.__default.Extends reveal_M0._default.Extends |stOrigC#0| |st#1@@6|))))
 :qid |CloudMakeCachedBuildsdfy.82:15|
 :skolemid |800|
 :pattern ( (M0.__default.Extends reveal_M0._default.Extends |stOrigC#0| |st#1@@6|))
 :pattern ( (M0.__default.ValidState |st#1@@6|))
 :pattern ( (|Set#IsMember| |stsC#0| |st#1@@6|))
)) (and (=> (= (ControlFlow 0 33) (- 0 34)) (=> |useCache##1@0| (forall ((|st#3@@1| T@U) ) (!  (=> ($IsBox |st#3@@1| Tclass.M0.State) (=> (|Set#IsMember| |stsC#0| |st#3@@1|) (M0.__default.ConsistentCache |st#3@@1|)))
 :qid |CloudMakeCachedBuildsdfy.83:28|
 :skolemid |801|
 ...
 (and (|M0.__default.ValidState#canCall| |stCombined#0@@13|) (=> (M0.__default.ValidState |stCombined#0@@13|) (and (|M0.__default.Extends#canCall| |stOrigC#0| |stCombined#0@@13|) (=> (M0.__default.Extends reveal_M0._default.Extends |stOrigC#0| |stCombined#0@@13|) (=> |useCache##1@0| (and (|M0.__default.ConsistentCache#canCall| |stCombined#0@@13|) (=> (M0.__default.ConsistentCache |stCombined#0@@13|) (and (forall ((|st#7@@2| T@U) ) (!  (=> ($IsBox |st#7@@2| Tclass.M0.State) (=> (|Set#IsMember| |stsC#0| |st#7@@2|) (and (|M0.__default.DomC#canCall| |st#7@@2|) (|M0.__default.DomC#canCall| |stCombined#0@@13|))))
 :qid |CloudMakeCachedBuildsdfy.89:17|
 :skolemid |802|
 ...
 (and (|M0.__default.ValidState#canCall| |stCombined#0@@14|) (and (M0.__default.ValidState |stCombined#0@@14|) (forall ((|p#0@@18| T@U) ) (!  (=> ($IsBox |p#0@@18| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |stCombined#0@@14|) |p#0@@18|) (M0.__default.WellFounded |p#0@@18|)))
 :qid |CloudMakeCachedBuildsdfy.35:12|
 :skolemid |807|
 :pattern ( (M0.__default.WellFounded |p#0@@18|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |stCombined#0@@14|) |p#0@@18|))
))))) (let ((|stCombined#0@@15| (M0.__default.Combine ($LS ($LS $LZ)) reveal_M0._default.Combine |stsC#0| |useCache##1@0|)))
(M0.__default.Extends reveal_M0._default.Extends |stOrigC#0| |stCombined#0@@15|)))) (and (and (let ((|stCombined#0@@16| (M0.__default.Combine ($LS ($LS $LZ)) reveal_M0._default.Combine |stsC#0| |useCache##1@0|)))
...
)))) (= $Heap@1 $Heap@2)))) (and (=> (= (ControlFlow 0 33) 30) anon7_Then_correct) (=> (= (ControlFlow 0 33) 32) anon7_Else_correct)))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@8) ($IsHeapAnchor $Heap@@8)) (=> (and (and ($IsBox |stOrig#0@@9| Tclass.M0.State) ($IsAllocBox |stOrig#0@@9| Tclass.M0.State $Heap@@8)) (and ($Is SetType |sts#0@@10| (TSet Tclass.M0.State)) ($IsAlloc SetType |sts#0@@10| (TSet Tclass.M0.State) $Heap@@8))) (=> (and (and (and ($IsBox |stOrigC#0| Tclass.M0.State) ($IsAllocBox |stOrigC#0| Tclass.M0.State $Heap@@8)) (and ($Is SetType |stsC#0| (TSet Tclass.M0.State)) ($IsAlloc SetType |stsC#0| (TSet Tclass.M0.State) $Heap@@8))) (and (and ($Is DatatypeTypeType |fun#0@@4| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |fun#0@@4| Tclass.M0.Expression $Heap@@8)) (|$IsA#M0.Expression| |fun#0@@4|))) (=> (and (and (and (and (and ($Is SeqType |args#0@@12| (TSeq Tclass.M0.Expression)) ($IsAlloc SeqType |args#0@@12| (TSeq Tclass.M0.Expression) $Heap@@8)) (and (=> |defass#p#8| (and ($Is DatatypeTypeType |p#8| (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State)) ($IsAlloc DatatypeTypeType |p#8| (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State) $Heap@@8))) true)) (and (and (=> |defass#pC#0| (and ($Is DatatypeTypeType |pC#0| (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State)) ($IsAlloc DatatypeTypeType |pC#0| (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State) $Heap@@8))) true) (and (=> |defass#stCombined#0| (and ($IsBox |stCombined#0@@6| Tclass.M0.State) ($IsAllocBox |stCombined#0@@6| Tclass.M0.State $Heap@@8))) true))) (and (and (and (=> |defass#stCombinedC#0| (and ($IsBox |stCombinedC#0| Tclass.M0.State) ($IsAllocBox |stCombinedC#0| Tclass.M0.State $Heap@@8))) true) (= 6 $FunctionContextHeight)) (and (|M0.__default.ValidState#canCall| |stOrig#0@@9|) (and (M0.__default.ValidState |stOrig#0@@9|) (forall ((|p#4| T@U) ) (!  (=> ($IsBox |p#4| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |stOrig#0@@9|) |p#4|) (M0.__default.WellFounded |p#4|)))
 :qid |CloudMakeCachedBuildsdfy.35:12|
 :skolemid |1543|
 :pattern ( (M0.__default.WellFounded |p#4|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |stOrig#0@@9|) |p#4|))
)))))) (and (and (and (and (|M0.__default.ValidState#canCall| |stOrigC#0|) (and (M0.__default.ValidState |stOrigC#0|) (forall ((|p#5| T@U) ) (!  (=> ($IsBox |p#5| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |stOrigC#0|) |p#5|) (M0.__default.WellFounded |p#5|)))
 :qid |CloudMakeCachedBuildsdfy.35:12|
 :skolemid |1545|
 :pattern ( (M0.__default.WellFounded |p#5|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |stOrigC#0|) |p#5|))
)))) (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence |stOrig#0@@9| |stOrigC#0|)) (and (not (|Set#Equal| |sts#0@@10| |Set#Empty|)) (not (|Set#Equal| |stsC#0| |Set#Empty|)))) (and (and (and (|M0.__default.Compatible#canCall| |sts#0@@10|) (and (M0.__default.Compatible |sts#0@@10|) (forall ((|st#2| T@U) (|st'#2@@1| T@U) ) (!  (=> (and ($IsBox |st#2| Tclass.M0.State) ($IsBox |st'#2@@1| Tclass.M0.State)) (=> (and (|Set#IsMember| |sts#0@@10| |st#2|) (|Set#IsMember| |sts#0@@10| |st'#2@@1|)) (forall ((|p#6| T@U) ) (!  (=> ($IsBox |p#6| Tclass.M0.Path) (=> (and (|Set#IsMember| (M0.__default.DomSt |st#2|) |p#6|) (|Set#IsMember| (M0.__default.DomSt |st'#2@@1|) |p#6|)) (= (M0.__default.GetSt |p#6| |st#2|) (M0.__default.GetSt |p#6| |st'#2@@1|))))
 :qid |CloudMakeCachedBuildsdfy.55:14|
 :skolemid |1548|
 :pattern ( (M0.__default.GetSt |p#6| |st'#2@@1|))
 :pattern ( (M0.__default.GetSt |p#6| |st#2|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#2@@1|) |p#6|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#2|) |p#6|))
))))
 :qid |CloudMakeCachedBuildsdfy.54:12|
 :skolemid |1549|
 :pattern ( (M0.__default.DomSt |st'#2@@1|) (M0.__default.DomSt |st#2|))
 :pattern ( (M0.__default.DomSt |st'#2@@1|) (|Set#IsMember| |sts#0@@10| |st#2|))
 :pattern ( (M0.__default.DomSt |st#2|) (|Set#IsMember| |sts#0@@10| |st'#2@@1|))
 :pattern ( (|Set#IsMember| |sts#0@@10| |st'#2@@1|) (|Set#IsMember| |sts#0@@10| |st#2|))
)))) (and (|M0.__default.Compatible#canCall| |stsC#0|) (and (M0.__default.Compatible |stsC#0|) (forall ((|st#3@@3| T@U) (|st'#3| T@U) ) (!  (=> (and ($IsBox |st#3@@3| Tclass.M0.State) ($IsBox |st'#3| Tclass.M0.State)) (=> (and (|Set#IsMember| |stsC#0| |st#3@@3|) (|Set#IsMember| |stsC#0| |st'#3|)) (forall ((|p#7| T@U) ) (!  (=> ($IsBox |p#7| Tclass.M0.Path) (=> (and (|Set#IsMember| (M0.__default.DomSt |st#3@@3|) |p#7|) (|Set#IsMember| (M0.__default.DomSt |st'#3|) |p#7|)) (= (M0.__default.GetSt |p#7| |st#3@@3|) (M0.__default.GetSt |p#7| |st'#3|))))
 :qid |CloudMakeCachedBuildsdfy.55:14|
 :skolemid |1552|
 :pattern ( (M0.__default.GetSt |p#7| |st'#3|))
 :pattern ( (M0.__default.GetSt |p#7| |st#3@@3|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#3|) |p#7|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#3@@3|) |p#7|))
))))
 :qid |CloudMakeCachedBuildsdfy.54:12|
 :skolemid |1553|
 :pattern ( (M0.__default.DomSt |st'#3|) (M0.__default.DomSt |st#3@@3|))
 :pattern ( (M0.__default.DomSt |st'#3|) (|Set#IsMember| |stsC#0| |st#3@@3|))
 :pattern ( (M0.__default.DomSt |st#3@@3|) (|Set#IsMember| |stsC#0| |st'#3|))
 :pattern ( (|Set#IsMember| |stsC#0| |st'#3|) (|Set#IsMember| |stsC#0| |st#3@@3|))
))))) (and (and (forall ((|s#1| T@U) ) (!  (=> ($IsBox |s#1| Tclass.M0.State) (and (=> (|Set#IsMember| |sts#0@@10| |s#1|) (M0.__default.ValidState |s#1|)) (=> (|Set#IsMember| |sts#0@@10| |s#1|) (M0.__default.Extends reveal_M0._default.Extends |stOrig#0@@9| |s#1|))))
 :qid |CloudMakeCachedBuildsdfy.883:21|
 :skolemid |1554|
 :pattern ( (M0.__default.Extends reveal_M0._default.Extends |stOrig#0@@9| |s#1|))
 :pattern ( (M0.__default.ValidState |s#1|))
 :pattern ( (|Set#IsMember| |sts#0@@10| |s#1|))
)) (forall ((|s#3| T@U) ) (!  (=> ($IsBox |s#3| Tclass.M0.State) (and (and (=> (|Set#IsMember| |stsC#0| |s#3|) (M0.__default.ValidState |s#3|)) (=> (|Set#IsMember| |stsC#0| |s#3|) (M0.__default.Extends reveal_M0._default.Extends |stOrigC#0| |s#3|))) (=> (|Set#IsMember| |stsC#0| |s#3|) (M0.__default.ConsistentCache |s#3|))))
 :qid |CloudMakeCachedBuildsdfy.884:21|
 :skolemid |1555|
 :pattern ( (M0.__default.ConsistentCache |s#3|))
 :pattern ( (M0.__default.Extends reveal_M0._default.Extends |stOrigC#0| |s#3|))
 :pattern ( (M0.__default.ValidState |s#3|))
 :pattern ( (|Set#IsMember| |stsC#0| |s#3|))
))) (and (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence (M0.__default.Combine ($LS ($LS $LZ)) reveal_M0._default.Combine |sts#0@@10| (U_2_bool (Lit boolType (bool_2_U false)))) (M0.__default.Combine ($LS ($LS $LZ)) reveal_M0._default.Combine |stsC#0| (U_2_bool (Lit boolType (bool_2_U true))))) (= (ControlFlow 0 44) 33)))))) anon0_correct))))))
