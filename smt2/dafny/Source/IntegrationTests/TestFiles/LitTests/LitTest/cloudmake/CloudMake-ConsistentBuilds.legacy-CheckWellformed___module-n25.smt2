...
(assert (forall ((d@@3 T@U) ) (! (= (_module.Statement.stmtVariable_q d@@3) (= (DatatypeCtorId d@@3) |##_module.Statement.stmtVariable|))
 :qid |unknown.0:0|
 :skolemid |1300|
 :pattern ( (_module.Statement.stmtVariable_q d@@3))
)))
(assert (forall ((d@@4 T@U) ) (! (= (_module.Statement.stmtReturn_q d@@4) (= (DatatypeCtorId d@@4) |##_module.Statement.stmtReturn|))
 :qid |unknown.0:0|
 :skolemid |1311|
 :pattern ( (_module.Statement.stmtReturn_q d@@4))
)))
...
(assert (forall ((d@@29 T@U) ) (!  (=> (_module.Statement.stmtVariable_q d@@29) (exists ((|a#14#0#0| T@U) (|a#14#1#0| T@U) ) (! (= d@@29 (|#_module.Statement.stmtVariable| |a#14#0#0| |a#14#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.316:35|
 :skolemid |1301|
)))
 :qid |unknown.0:0|
 :skolemid |1302|
 :pattern ( (_module.Statement.stmtVariable_q d@@29))
)))
(assert (forall ((d@@30 T@U) ) (!  (=> (_module.Expression.exprAnd_q d@@30) (exists ((|a#48#0#0| T@U) (|a#48#1#0| T@U) ) (! (= d@@30 (|#_module.Expression.exprAnd| |a#48#0#0| |a#48#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.321:31|
 :skolemid |1360|
)))
 :qid |unknown.0:0|
 :skolemid |1361|
 :pattern ( (_module.Expression.exprAnd_q d@@30))
)))
(assert (forall ((d@@31 T@U) ) (!  (=> (_module.Expression.exprOr_q d@@31) (exists ((|a#56#0#0| T@U) (|a#56#1#0| T@U) ) (! (= d@@31 (|#_module.Expression.exprOr| |a#56#0#0| |a#56#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.322:30|
 :skolemid |1372|
)))
 :qid |unknown.0:0|
 :skolemid |1373|
 :pattern ( (_module.Expression.exprOr_q d@@31))
)))
(assert (forall ((d@@32 T@U) ) (!  (=> (_module.Expression.exprInvocation_q d@@32) (exists ((|a#64#0#0| T@U) (|a#64#1#0| T@U) ) (! (= d@@32 (|#_module.Expression.exprInvocation| |a#64#0#0| |a#64#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.323:38|
 :skolemid |1384|
)))
 :qid |unknown.0:0|
 :skolemid |1385|
 :pattern ( (_module.Expression.exprInvocation_q d@@32))
)))
(assert (forall ((d@@33 T@U) ) (!  (=> (_module.Tuple.Pair_q d@@33) (exists ((|a#162#0#0| T@U) (|a#162#1#0| T@U) ) (! (= d@@33 (|#_module.Tuple.Pair| |a#162#0#0| |a#162#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.344:29|
 :skolemid |1540|
)))
 :qid |unknown.0:0|
 :skolemid |1541|
 :pattern ( (_module.Tuple.Pair_q d@@33))
)))
...
(assert (forall ((d@@34 T@U) ) (!  (=> (_module.Literal.litTrue_q d@@34) (= d@@34 |#_module.Literal.litTrue|))
 :qid |unknown.0:0|
 :skolemid |1417|
 :pattern ( (_module.Literal.litTrue_q d@@34))
)))
(assert (forall ((d@@35 T@U) ) (!  (=> (_module.Literal.litFalse_q d@@35) (= d@@35 |#_module.Literal.litFalse|))
 :qid |unknown.0:0|
 :skolemid |1419|
 :pattern ( (_module.Literal.litFalse_q d@@35))
)))
(assert (forall ((d@@36 T@U) ) (!  (=> (_module.Literal.litUndefined_q d@@36) (= d@@36 |#_module.Literal.litUndefined|))
 :qid |unknown.0:0|
 :skolemid |1421|
 :pattern ( (_module.Literal.litUndefined_q d@@36))
)))
(assert (forall ((d@@37 T@U) ) (!  (=> (_module.Literal.litNull_q d@@37) (= d@@37 |#_module.Literal.litNull|))
 :qid |unknown.0:0|
 :skolemid |1423|
 :pattern ( (_module.Literal.litNull_q d@@37))
)))
(assert (forall ((d@@38 T@U) ) (!  (=> (_module.Primitive.primCreatePath_q d@@38) (= d@@38 |#_module.Primitive.primCreatePath|))
 :qid |unknown.0:0|
 :skolemid |1494|
 :pattern ( (_module.Primitive.primCreatePath_q d@@38))
)))
(assert (forall ((d@@39 T@U) ) (!  (=> (_module.Primitive.primExec_q d@@39) (= d@@39 |#_module.Primitive.primExec|))
 :qid |unknown.0:0|
 :skolemid |1496|
 :pattern ( (_module.Primitive.primExec_q d@@39))
)))
...
(assert (forall ((d@@40 T@U) ) (!  (=> (|$IsA#_module.Literal| d@@40) (or (or (or (or (or (or (or (or (or (_module.Literal.litTrue_q d@@40) (_module.Literal.litFalse_q d@@40)) (_module.Literal.litUndefined_q d@@40)) (_module.Literal.litNull_q d@@40)) (_module.Literal.litNumber_q d@@40)) (_module.Literal.litString_q d@@40)) (_module.Literal.litPrimitive_q d@@40)) (_module.Literal.litArrOfPaths_q d@@40)) (_module.Literal.litArrOfStrings_q d@@40)) (_module.Literal.litArray_q d@@40)))
 :qid |unknown.0:0|
 :skolemid |1480|
 :pattern ( (|$IsA#_module.Literal| d@@40))
)))
...
(assert (forall ((d@@41 T@U) ) (!  (=> (_module.Statement.stmtReturn_q d@@41) (exists ((|a#21#0#0| T@U) ) (! (= d@@41 (|#_module.Statement.stmtReturn| |a#21#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.317:33|
 :skolemid |1312|
)))
 :qid |unknown.0:0|
 :skolemid |1313|
 :pattern ( (_module.Statement.stmtReturn_q d@@41))
)))
(assert (forall ((d@@42 T@U) ) (!  (=> (_module.Expression.exprLiteral_q d@@42) (exists ((|a#27#0#0| T@U) ) (! (= d@@42 (|#_module.Expression.exprLiteral| |a#27#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.319:35|
 :skolemid |1327|
)))
 :qid |unknown.0:0|
 :skolemid |1328|
 :pattern ( (_module.Expression.exprLiteral_q d@@42))
)))
(assert (forall ((d@@43 T@U) ) (!  (=> (_module.Expression.exprIdentifier_q d@@43) (exists ((|a#33#0#0| T@U) ) (! (= d@@43 (|#_module.Expression.exprIdentifier| |a#33#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.319:66|
 :skolemid |1337|
)))
 :qid |unknown.0:0|
 :skolemid |1338|
 :pattern ( (_module.Expression.exprIdentifier_q d@@43))
)))
(assert (forall ((d@@44 T@U) ) (!  (=> (_module.Expression.exprError_q d@@44) (exists ((|a#73#0#0| T@U) ) (! (= d@@44 (|#_module.Expression.exprError| |a#73#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.324:33|
 :skolemid |1397|
)))
 :qid |unknown.0:0|
 :skolemid |1398|
 :pattern ( (_module.Expression.exprError_q d@@44))
)))
(assert (forall ((d@@45 T@U) ) (!  (=> (_module.Literal.litNumber_q d@@45) (exists ((|a#95#0#0| Int) ) (! (= d@@45 (|#_module.Literal.litNumber| |a#95#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.327:30|
 :skolemid |1426|
)))
 :qid |unknown.0:0|
 :skolemid |1427|
 :pattern ( (_module.Literal.litNumber_q d@@45))
)))
(assert (forall ((d@@46 T@U) ) (!  (=> (_module.Literal.litString_q d@@46) (exists ((|a#100#0#0| T@U) ) (! (= d@@46 (|#_module.Literal.litString| |a#100#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.327:52|
 :skolemid |1434|
)))
 :qid |unknown.0:0|
 :skolemid |1435|
 :pattern ( (_module.Literal.litString_q d@@46))
)))
(assert (forall ((d@@47 T@U) ) (!  (=> (_module.Literal.litPrimitive_q d@@47) (exists ((|a#107#0#0| T@U) ) (! (= d@@47 (|#_module.Literal.litPrimitive| |a#107#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.328:33|
 :skolemid |1444|
)))
 :qid |unknown.0:0|
 :skolemid |1445|
 :pattern ( (_module.Literal.litPrimitive_q d@@47))
)))
(assert (forall ((d@@48 T@U) ) (!  (=> (_module.Literal.litArrOfPaths_q d@@48) (exists ((|a#113#0#0| T@U) ) (! (= d@@48 (|#_module.Literal.litArrOfPaths| |a#113#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.329:34|
 :skolemid |1453|
)))
 :qid |unknown.0:0|
 :skolemid |1454|
 :pattern ( (_module.Literal.litArrOfPaths_q d@@48))
)))
(assert (forall ((d@@49 T@U) ) (!  (=> (_module.Literal.litArrOfStrings_q d@@49) (exists ((|a#119#0#0| T@U) ) (! (= d@@49 (|#_module.Literal.litArrOfStrings| |a#119#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.330:36|
 :skolemid |1462|
)))
 :qid |unknown.0:0|
 :skolemid |1463|
 :pattern ( (_module.Literal.litArrOfStrings_q d@@49))
)))
(assert (forall ((d@@50 T@U) ) (!  (=> (_module.Literal.litArray_q d@@50) (exists ((|a#125#0#0| T@U) ) (! (= d@@50 (|#_module.Literal.litArray| |a#125#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.331:29|
 :skolemid |1471|
)))
 :qid |unknown.0:0|
 :skolemid |1472|
 :pattern ( (_module.Literal.litArray_q d@@50))
)))
(assert (forall ((d@@51 T@U) ) (!  (=> ($Is DatatypeTypeType d@@51 Tclass._module.Expression) (or (or (or (or (or (or (_module.Expression.exprLiteral_q d@@51) (_module.Expression.exprIdentifier_q d@@51)) (_module.Expression.exprIf_q d@@51)) (_module.Expression.exprAnd_q d@@51)) (_module.Expression.exprOr_q d@@51)) (_module.Expression.exprInvocation_q d@@51)) (_module.Expression.exprError_q d@@51)))
 :qid |unknown.0:0|
 :skolemid |1407|
 :pattern ( (_module.Expression.exprError_q d@@51) ($Is DatatypeTypeType d@@51 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprInvocation_q d@@51) ($Is DatatypeTypeType d@@51 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprOr_q d@@51) ($Is DatatypeTypeType d@@51 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprAnd_q d@@51) ($Is DatatypeTypeType d@@51 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprIf_q d@@51) ($Is DatatypeTypeType d@@51 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprIdentifier_q d@@51) ($Is DatatypeTypeType d@@51 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprLiteral_q d@@51) ($Is DatatypeTypeType d@@51 Tclass._module.Expression))
)))
...
(assert (forall ((d@@52 T@U) ) (!  (=> ($Is DatatypeTypeType d@@52 Tclass._module.Literal) (or (or (or (or (or (or (or (or (or (_module.Literal.litTrue_q d@@52) (_module.Literal.litFalse_q d@@52)) (_module.Literal.litUndefined_q d@@52)) (_module.Literal.litNull_q d@@52)) (_module.Literal.litNumber_q d@@52)) (_module.Literal.litString_q d@@52)) (_module.Literal.litPrimitive_q d@@52)) (_module.Literal.litArrOfPaths_q d@@52)) (_module.Literal.litArrOfStrings_q d@@52)) (_module.Literal.litArray_q d@@52)))
 :qid |unknown.0:0|
 :skolemid |1481|
 :pattern ( (_module.Literal.litArray_q d@@52) ($Is DatatypeTypeType d@@52 Tclass._module.Literal))
 :pattern ( (_module.Literal.litArrOfStrings_q d@@52) ($Is DatatypeTypeType d@@52 Tclass._module.Literal))
 :pattern ( (_module.Literal.litArrOfPaths_q d@@52) ($Is DatatypeTypeType d@@52 Tclass._module.Literal))
 :pattern ( (_module.Literal.litPrimitive_q d@@52) ($Is DatatypeTypeType d@@52 Tclass._module.Literal))
 :pattern ( (_module.Literal.litString_q d@@52) ($Is DatatypeTypeType d@@52 Tclass._module.Literal))
 :pattern ( (_module.Literal.litNumber_q d@@52) ($Is DatatypeTypeType d@@52 Tclass._module.Literal))
 :pattern ( (_module.Literal.litNull_q d@@52) ($Is DatatypeTypeType d@@52 Tclass._module.Literal))
 :pattern ( (_module.Literal.litUndefined_q d@@52) ($Is DatatypeTypeType d@@52 Tclass._module.Literal))
 :pattern ( (_module.Literal.litFalse_q d@@52) ($Is DatatypeTypeType d@@52 Tclass._module.Literal))
 :pattern ( (_module.Literal.litTrue_q d@@52) ($Is DatatypeTypeType d@@52 Tclass._module.Literal))
)))
...
(assert (forall ((_module.Triple$A@@5 T@U) (_module.Triple$B@@5 T@U) (_module.Triple$C@@5 T@U) (d@@53 T@U) ) (!  (=> ($Is DatatypeTypeType d@@53 (Tclass._module.Triple _module.Triple$A@@5 _module.Triple$B@@5 _module.Triple$C@@5)) (_module.Triple.Trio_q d@@53))
 :qid |unknown.0:0|
 :skolemid |1577|
 :pattern ( (_module.Triple.Trio_q d@@53) ($Is DatatypeTypeType d@@53 (Tclass._module.Triple _module.Triple$A@@5 _module.Triple$B@@5 _module.Triple$C@@5)))
)))
...
(assert (forall ((d@@54 T@U) ) (!  (=> ($Is DatatypeTypeType d@@54 Tclass._module.Statement) (or (_module.Statement.stmtVariable_q d@@54) (_module.Statement.stmtReturn_q d@@54)))
 :qid |unknown.0:0|
 :skolemid |1321|
 :pattern ( (_module.Statement.stmtReturn_q d@@54) ($Is DatatypeTypeType d@@54 Tclass._module.Statement))
 :pattern ( (_module.Statement.stmtVariable_q d@@54) ($Is DatatypeTypeType d@@54 Tclass._module.Statement))
)))
(assert (forall ((d@@55 T@U) ) (!  (=> ($Is DatatypeTypeType d@@55 Tclass._module.Primitive) (or (_module.Primitive.primCreatePath_q d@@55) (_module.Primitive.primExec_q d@@55)))
 :qid |unknown.0:0|
 :skolemid |1499|
 :pattern ( (_module.Primitive.primExec_q d@@55) ($Is DatatypeTypeType d@@55 Tclass._module.Primitive))
 :pattern ( (_module.Primitive.primCreatePath_q d@@55) ($Is DatatypeTypeType d@@55 Tclass._module.Primitive))
)))
...
(assert (forall ((d@@56 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.Literal.litNumber_q d@@56) ($IsAlloc DatatypeTypeType d@@56 Tclass._module.Literal $h@@1))) ($IsAlloc intType (int_2_U (_module.Literal.num d@@56)) TInt $h@@1))
 :qid |unknown.0:0|
 :skolemid |1429|
 :pattern ( ($IsAlloc intType (int_2_U (_module.Literal.num d@@56)) TInt $h@@1))
)))
...
(assert (forall ((d@@57 T@U) ) (! (= (BoxRank ($Box DatatypeTypeType d@@57)) (DtRank d@@57))
 :qid |DafnyPreludebpl.391:15|
 :skolemid |84|
 :pattern ( (BoxRank ($Box DatatypeTypeType d@@57)))
)))
...
(assert (forall ((d@@58 T@U) (_module.Triple$A@@7 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (_module.Triple.Trio_q d@@58) (exists ((_module.Triple$B@@7 T@U) (_module.Triple$C@@7 T@U) ) (! ($IsAlloc DatatypeTypeType d@@58 (Tclass._module.Triple _module.Triple$A@@7 _module.Triple$B@@7 _module.Triple$C@@7) $h@@2)
 :qid |unknown.0:0|
 :skolemid |1563|
 :pattern ( ($IsAlloc DatatypeTypeType d@@58 (Tclass._module.Triple _module.Triple$A@@7 _module.Triple$B@@7 _module.Triple$C@@7) $h@@2))
)))) ($IsAllocBox (_module.Triple.fst d@@58) _module.Triple$A@@7 $h@@2))
 :qid |unknown.0:0|
 :skolemid |1564|
 :pattern ( ($IsAllocBox (_module.Triple.fst d@@58) _module.Triple$A@@7 $h@@2))
)))
(assert (forall ((d@@59 T@U) (_module.Triple$B@@8 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (_module.Triple.Trio_q d@@59) (exists ((_module.Triple$A@@8 T@U) (_module.Triple$C@@8 T@U) ) (! ($IsAlloc DatatypeTypeType d@@59 (Tclass._module.Triple _module.Triple$A@@8 _module.Triple$B@@8 _module.Triple$C@@8) $h@@3)
 :qid |unknown.0:0|
 :skolemid |1565|
 :pattern ( ($IsAlloc DatatypeTypeType d@@59 (Tclass._module.Triple _module.Triple$A@@8 _module.Triple$B@@8 _module.Triple$C@@8) $h@@3))
)))) ($IsAllocBox (_module.Triple.snd d@@59) _module.Triple$B@@8 $h@@3))
 :qid |unknown.0:0|
 :skolemid |1566|
 :pattern ( ($IsAllocBox (_module.Triple.snd d@@59) _module.Triple$B@@8 $h@@3))
)))
(assert (forall ((d@@60 T@U) (_module.Triple$C@@9 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (_module.Triple.Trio_q d@@60) (exists ((_module.Triple$A@@9 T@U) (_module.Triple$B@@9 T@U) ) (! ($IsAlloc DatatypeTypeType d@@60 (Tclass._module.Triple _module.Triple$A@@9 _module.Triple$B@@9 _module.Triple$C@@9) $h@@4)
 :qid |unknown.0:0|
 :skolemid |1567|
 :pattern ( ($IsAlloc DatatypeTypeType d@@60 (Tclass._module.Triple _module.Triple$A@@9 _module.Triple$B@@9 _module.Triple$C@@9) $h@@4))
)))) ($IsAllocBox (_module.Triple.trd d@@60) _module.Triple$C@@9 $h@@4))
 :qid |unknown.0:0|
 :skolemid |1568|
 :pattern ( ($IsAllocBox (_module.Triple.trd d@@60) _module.Triple$C@@9 $h@@4))
)))
(assert (forall ((d@@61 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) ($Is DatatypeTypeType d@@61 Tclass._module.StateC)) ($IsAlloc DatatypeTypeType d@@61 Tclass._module.StateC $h@@5))
 :qid |unknown.0:0|
 :skolemid |1279|
 :pattern ( ($IsAlloc DatatypeTypeType d@@61 Tclass._module.StateC $h@@5))
)))
(assert (forall ((d@@62 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) ($Is DatatypeTypeType d@@62 Tclass._module.Statement)) ($IsAlloc DatatypeTypeType d@@62 Tclass._module.Statement $h@@6))
 :qid |unknown.0:0|
 :skolemid |1319|
 :pattern ( ($IsAlloc DatatypeTypeType d@@62 Tclass._module.Statement $h@@6))
)))
(assert (forall ((d@@63 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) ($Is DatatypeTypeType d@@63 Tclass._module.Expression)) ($IsAlloc DatatypeTypeType d@@63 Tclass._module.Expression $h@@7))
 :qid |unknown.0:0|
 :skolemid |1405|
 :pattern ( ($IsAlloc DatatypeTypeType d@@63 Tclass._module.Expression $h@@7))
)))
(assert (forall ((d@@64 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) ($Is DatatypeTypeType d@@64 Tclass._module.Literal)) ($IsAlloc DatatypeTypeType d@@64 Tclass._module.Literal $h@@8))
 :qid |unknown.0:0|
 :skolemid |1479|
 :pattern ( ($IsAlloc DatatypeTypeType d@@64 Tclass._module.Literal $h@@8))
)))
(assert (forall ((d@@65 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) ($Is DatatypeTypeType d@@65 Tclass._module.Primitive)) ($IsAlloc DatatypeTypeType d@@65 Tclass._module.Primitive $h@@9))
 :qid |unknown.0:0|
 :skolemid |1497|
 :pattern ( ($IsAlloc DatatypeTypeType d@@65 Tclass._module.Primitive $h@@9))
)))
(assert (forall ((d@@66 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) ($Is DatatypeTypeType d@@66 Tclass._module.Reason)) ($IsAlloc DatatypeTypeType d@@66 Tclass._module.Reason $h@@10))
 :qid |unknown.0:0|
 :skolemid |1509|
 :pattern ( ($IsAlloc DatatypeTypeType d@@66 Tclass._module.Reason $h@@10))
)))
(assert (forall ((d@@67 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) ($Is DatatypeTypeType d@@67 Tclass._module.Path)) ($IsAlloc DatatypeTypeType d@@67 Tclass._module.Path $h@@11))
 :qid |unknown.0:0|
 :skolemid |1532|
 :pattern ( ($IsAlloc DatatypeTypeType d@@67 Tclass._module.Path $h@@11))
)))
...
(assert (forall ((d@@68 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (_module.Literal.litString_q d@@68) ($IsAlloc DatatypeTypeType d@@68 Tclass._module.Literal $h@@12))) ($IsAlloc SeqType (_module.Literal.str d@@68) (TSeq TChar) $h@@12))
 :qid |unknown.0:0|
 :skolemid |1437|
 :pattern ( ($IsAlloc SeqType (_module.Literal.str d@@68) (TSeq TChar) $h@@12))
)))
(assert (forall ((|a#117#0#0| T@U) (d@@69 T@U) ) (!  (=> (|Set#IsMember| |a#117#0#0| ($Box DatatypeTypeType d@@69)) (< (DtRank d@@69) (DtRank (|#_module.Literal.litArrOfPaths| |a#117#0#0|))))
 :qid |CloudMakeConsistentBuildslegacydfy.329:34|
 :skolemid |1459|
 :pattern ( (|Set#IsMember| |a#117#0#0| ($Box DatatypeTypeType d@@69)) (|#_module.Literal.litArrOfPaths| |a#117#0#0|))
)))
(assert (forall ((|a#123#0#0| T@U) (d@@70 T@U) ) (!  (=> (|Set#IsMember| |a#123#0#0| ($Box DatatypeTypeType d@@70)) (< (DtRank d@@70) (DtRank (|#_module.Literal.litArrOfStrings| |a#123#0#0|))))
 :qid |CloudMakeConsistentBuildslegacydfy.330:36|
 :skolemid |1468|
 :pattern ( (|Set#IsMember| |a#123#0#0| ($Box DatatypeTypeType d@@70)) (|#_module.Literal.litArrOfStrings| |a#123#0#0|))
)))
...
(assert (forall ((d@@71 T@U) (_module.Tuple$A@@6 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (_module.Tuple.Pair_q d@@71) (exists ((_module.Tuple$B@@6 T@U) ) (! ($IsAlloc DatatypeTypeType d@@71 (Tclass._module.Tuple _module.Tuple$A@@6 _module.Tuple$B@@6) $h@@13)
 :qid |unknown.0:0|
 :skolemid |1544|
 :pattern ( ($IsAlloc DatatypeTypeType d@@71 (Tclass._module.Tuple _module.Tuple$A@@6 _module.Tuple$B@@6) $h@@13))
)))) ($IsAllocBox (_module.Tuple.fst d@@71) _module.Tuple$A@@6 $h@@13))
 :qid |unknown.0:0|
 :skolemid |1545|
 :pattern ( ($IsAllocBox (_module.Tuple.fst d@@71) _module.Tuple$A@@6 $h@@13))
)))
(assert (forall ((d@@72 T@U) (_module.Tuple$B@@7 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (_module.Tuple.Pair_q d@@72) (exists ((_module.Tuple$A@@7 T@U) ) (! ($IsAlloc DatatypeTypeType d@@72 (Tclass._module.Tuple _module.Tuple$A@@7 _module.Tuple$B@@7) $h@@14)
 :qid |unknown.0:0|
 :skolemid |1546|
 :pattern ( ($IsAlloc DatatypeTypeType d@@72 (Tclass._module.Tuple _module.Tuple$A@@7 _module.Tuple$B@@7) $h@@14))
)))) ($IsAllocBox (_module.Tuple.snd d@@72) _module.Tuple$B@@7 $h@@14))
 :qid |unknown.0:0|
 :skolemid |1547|
 :pattern ( ($IsAllocBox (_module.Tuple.snd d@@72) _module.Tuple$B@@7 $h@@14))
)))
...
(assert (forall ((d@@73 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (_module.StateC.S_q d@@73) ($IsAlloc DatatypeTypeType d@@73 Tclass._module.StateC $h@@15))) ($IsAllocBox (_module.StateC.st d@@73) Tclass._module.State $h@@15))
 :qid |unknown.0:0|
 :skolemid |1274|
 :pattern ( ($IsAllocBox (_module.StateC.st d@@73) Tclass._module.State $h@@15))
)))
(assert (forall ((d@@74 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (_module.StateC.S_q d@@74) ($IsAlloc DatatypeTypeType d@@74 Tclass._module.StateC $h@@16))) ($IsAllocBox (_module.StateC.c d@@74) Tclass._module.Cache $h@@16))
 :qid |unknown.0:0|
 :skolemid |1275|
 :pattern ( ($IsAllocBox (_module.StateC.c d@@74) Tclass._module.Cache $h@@16))
)))
(assert (forall ((d@@75 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (_module.Statement.stmtVariable_q d@@75) ($IsAlloc DatatypeTypeType d@@75 Tclass._module.Statement $h@@17))) ($IsAllocBox (_module.Statement.id d@@75) Tclass._module.Identifier $h@@17))
 :qid |unknown.0:0|
 :skolemid |1304|
 :pattern ( ($IsAllocBox (_module.Statement.id d@@75) Tclass._module.Identifier $h@@17))
)))
(assert (forall ((d@@76 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (_module.Statement.stmtVariable_q d@@76) ($IsAlloc DatatypeTypeType d@@76 Tclass._module.Statement $h@@18))) ($IsAlloc DatatypeTypeType (_module.Statement.expr d@@76) Tclass._module.Expression $h@@18))
 :qid |unknown.0:0|
 :skolemid |1305|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Statement.expr d@@76) Tclass._module.Expression $h@@18))
)))
(assert (forall ((d@@77 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (_module.Statement.stmtReturn_q d@@77) ($IsAlloc DatatypeTypeType d@@77 Tclass._module.Statement $h@@19))) ($IsAlloc DatatypeTypeType (_module.Statement.ret d@@77) Tclass._module.Expression $h@@19))
 :qid |unknown.0:0|
 :skolemid |1315|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Statement.ret d@@77) Tclass._module.Expression $h@@19))
)))
(assert (forall ((d@@78 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (_module.Expression.exprLiteral_q d@@78) ($IsAlloc DatatypeTypeType d@@78 Tclass._module.Expression $h@@20))) ($IsAlloc DatatypeTypeType (_module.Expression.lit d@@78) Tclass._module.Literal $h@@20))
 :qid |unknown.0:0|
 :skolemid |1331|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.lit d@@78) Tclass._module.Literal $h@@20))
)))
(assert (forall ((d@@79 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (_module.Expression.exprIdentifier_q d@@79) ($IsAlloc DatatypeTypeType d@@79 Tclass._module.Expression $h@@21))) ($IsAllocBox (_module.Expression.id d@@79) Tclass._module.Identifier $h@@21))
 :qid |unknown.0:0|
 :skolemid |1340|
 :pattern ( ($IsAllocBox (_module.Expression.id d@@79) Tclass._module.Identifier $h@@21))
)))
(assert (forall ((d@@80 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (_module.Expression.exprIf_q d@@80) ($IsAlloc DatatypeTypeType d@@80 Tclass._module.Expression $h@@22))) ($IsAlloc DatatypeTypeType (_module.Expression.cond d@@80) Tclass._module.Expression $h@@22))
 :qid |unknown.0:0|
 :skolemid |1348|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.cond d@@80) Tclass._module.Expression $h@@22))
)))
(assert (forall ((d@@81 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (_module.Expression.exprIf_q d@@81) ($IsAlloc DatatypeTypeType d@@81 Tclass._module.Expression $h@@23))) ($IsAlloc DatatypeTypeType (_module.Expression.ifTrue d@@81) Tclass._module.Expression $h@@23))
 :qid |unknown.0:0|
 :skolemid |1349|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.ifTrue d@@81) Tclass._module.Expression $h@@23))
)))
(assert (forall ((d@@82 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (_module.Expression.exprIf_q d@@82) ($IsAlloc DatatypeTypeType d@@82 Tclass._module.Expression $h@@24))) ($IsAlloc DatatypeTypeType (_module.Expression.ifFalse d@@82) Tclass._module.Expression $h@@24))
 :qid |unknown.0:0|
 :skolemid |1350|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.ifFalse d@@82) Tclass._module.Expression $h@@24))
)))
(assert (forall ((d@@83 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (_module.Expression.exprAnd_q d@@83) ($IsAlloc DatatypeTypeType d@@83 Tclass._module.Expression $h@@25))) ($IsAlloc DatatypeTypeType (_module.Expression.conj0 d@@83) Tclass._module.Expression $h@@25))
 :qid |unknown.0:0|
 :skolemid |1363|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.conj0 d@@83) Tclass._module.Expression $h@@25))
)))
(assert (forall ((d@@84 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (_module.Expression.exprAnd_q d@@84) ($IsAlloc DatatypeTypeType d@@84 Tclass._module.Expression $h@@26))) ($IsAlloc DatatypeTypeType (_module.Expression.conj1 d@@84) Tclass._module.Expression $h@@26))
 :qid |unknown.0:0|
 :skolemid |1364|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.conj1 d@@84) Tclass._module.Expression $h@@26))
)))
(assert (forall ((d@@85 T@U) ($h@@27 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (_module.Expression.exprOr_q d@@85) ($IsAlloc DatatypeTypeType d@@85 Tclass._module.Expression $h@@27))) ($IsAlloc DatatypeTypeType (_module.Expression.disj0 d@@85) Tclass._module.Expression $h@@27))
 :qid |unknown.0:0|
 :skolemid |1375|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.disj0 d@@85) Tclass._module.Expression $h@@27))
)))
(assert (forall ((d@@86 T@U) ($h@@28 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (_module.Expression.exprOr_q d@@86) ($IsAlloc DatatypeTypeType d@@86 Tclass._module.Expression $h@@28))) ($IsAlloc DatatypeTypeType (_module.Expression.disj1 d@@86) Tclass._module.Expression $h@@28))
 :qid |unknown.0:0|
 :skolemid |1376|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.disj1 d@@86) Tclass._module.Expression $h@@28))
)))
(assert (forall ((d@@87 T@U) ($h@@29 T@U) ) (!  (=> (and ($IsGoodHeap $h@@29) (and (_module.Expression.exprInvocation_q d@@87) ($IsAlloc DatatypeTypeType d@@87 Tclass._module.Expression $h@@29))) ($IsAlloc DatatypeTypeType (_module.Expression.fun d@@87) Tclass._module.Expression $h@@29))
 :qid |unknown.0:0|
 :skolemid |1387|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.fun d@@87) Tclass._module.Expression $h@@29))
)))
(assert (forall ((d@@88 T@U) ($h@@30 T@U) ) (!  (=> (and ($IsGoodHeap $h@@30) (and (_module.Expression.exprError_q d@@88) ($IsAlloc DatatypeTypeType d@@88 Tclass._module.Expression $h@@30))) ($IsAlloc DatatypeTypeType (_module.Expression.r d@@88) Tclass._module.Reason $h@@30))
 :qid |unknown.0:0|
 :skolemid |1401|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.r d@@88) Tclass._module.Reason $h@@30))
)))
(assert (forall ((d@@89 T@U) ($h@@31 T@U) ) (!  (=> (and ($IsGoodHeap $h@@31) (and (_module.Literal.litPrimitive_q d@@89) ($IsAlloc DatatypeTypeType d@@89 Tclass._module.Literal $h@@31))) ($IsAlloc DatatypeTypeType (_module.Literal.prim d@@89) Tclass._module.Primitive $h@@31))
 :qid |unknown.0:0|
 :skolemid |1447|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Literal.prim d@@89) Tclass._module.Primitive $h@@31))
)))
...
(assert (forall ((d@@90 T@U) ($h@@32 T@U) ) (!  (=> (and ($IsGoodHeap $h@@32) (and (_module.Literal.litArrOfStrings_q d@@90) ($IsAlloc DatatypeTypeType d@@90 Tclass._module.Literal $h@@32))) ($IsAlloc SetType (_module.Literal.strs d@@90) (TSet (TSeq TChar)) $h@@32))
 :qid |unknown.0:0|
 :skolemid |1465|
 :pattern ( ($IsAlloc SetType (_module.Literal.strs d@@90) (TSet (TSeq TChar)) $h@@32))
)))
...
(assert (forall ((d@@91 T@U) ($h@@33 T@U) ) (!  (=> (and ($IsGoodHeap $h@@33) (and (_module.Expression.exprInvocation_q d@@91) ($IsAlloc DatatypeTypeType d@@91 Tclass._module.Expression $h@@33))) ($IsAlloc SeqType (_module.Expression.args d@@91) (TSeq Tclass._module.Expression) $h@@33))
 :qid |unknown.0:0|
 :skolemid |1388|
 :pattern ( ($IsAlloc SeqType (_module.Expression.args d@@91) (TSeq Tclass._module.Expression) $h@@33))
)))
(assert (forall ((d@@92 T@U) ($h@@34 T@U) ) (!  (=> (and ($IsGoodHeap $h@@34) (and (_module.Literal.litArrOfPaths_q d@@92) ($IsAlloc DatatypeTypeType d@@92 Tclass._module.Literal $h@@34))) ($IsAlloc SetType (_module.Literal.paths d@@92) (TSet Tclass._module.Path) $h@@34))
 :qid |unknown.0:0|
 :skolemid |1456|
 :pattern ( ($IsAlloc SetType (_module.Literal.paths d@@92) (TSet Tclass._module.Path) $h@@34))
)))
(assert (forall ((d@@93 T@U) ($h@@35 T@U) ) (!  (=> (and ($IsGoodHeap $h@@35) (and (_module.Literal.litArray_q d@@93) ($IsAlloc DatatypeTypeType d@@93 Tclass._module.Literal $h@@35))) ($IsAlloc SeqType (_module.Literal.arr d@@93) (TSeq Tclass._module.Expression) $h@@35))
 :qid |unknown.0:0|
 :skolemid |1474|
 :pattern ( ($IsAlloc SeqType (_module.Literal.arr d@@93) (TSeq Tclass._module.Expression) $h@@35))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.doC)
...
(let ((anon16_Then_correct  (=> (_module.__default.Legal (|Seq#Drop| |stmts#0@@6| (LitInt 1))) (and (=> (= (ControlFlow 0 10) (- 0 12)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |stmts#0@@6|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |stmts#0@@6|))) (=> (and (and (= |##stmts#2@0| (|Seq#Drop| |stmts#0@@6| (LitInt 1))) ($IsAlloc SeqType |##stmts#2@0| (TSeq Tclass._module.Statement) $Heap@@3)) (and ($IsAlloc DatatypeTypeType |stC'#Z#0@0| Tclass._module.StateC $Heap@@3) ($IsAllocBox |env'#Z#0@0| Tclass._module.Env $Heap@@3))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (=> (|_module.__default.Legal#canCall| |##stmts#2@0|) (or (_module.__default.Legal |##stmts#2@0|) (or (not (= (|Seq#Length| |##stmts#2@0|) 0)) (not true))))) (=> (and (_module.__default.Legal |##stmts#2@0|) (= (ControlFlow 0 10) (- 0 9))) (or (< (|Seq#Rank| |##stmts#2@0|) (|Seq#Rank| |stmts#0@@6|)) (and (= (|Seq#Rank| |##stmts#2@0|) (|Seq#Rank| |stmts#0@@6|)) (< (DtRank |stC'#Z#0@0|) (DtRank |stC#0@@37|))))))))))))
(let ((anon15_Then_correct  (=> (_module.__default.Value |expr'#Z#0@0|) (and (=> (= (ControlFlow 0 14) (- 0 17)) (_module.Statement.stmtVariable_q |stmt#Z#0@0|)) (=> (_module.Statement.stmtVariable_q |stmt#Z#0@0|) (=> (and (and (= |##id#0@0| (_module.Statement.id |stmt#Z#0@0|)) ($IsAllocBox |##id#0@0| Tclass._module.Identifier $Heap@@3)) (and ($IsAlloc DatatypeTypeType |expr'#Z#0@0| Tclass._module.Expression $Heap@@3) ($IsAllocBox |env#0@@21| Tclass._module.Env $Heap@@3))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (=> (|_module.__default.Value#canCall| |expr'#Z#0@0|) (or (_module.__default.Value |expr'#Z#0@0|) (_module.Expression.exprLiteral_q |expr'#Z#0@0|)))) (=> (and (_module.__default.Value |expr'#Z#0@0|) (|_module.__default.SetEnv#canCall| (_module.Statement.id |stmt#Z#0@0|) |expr'#Z#0@0| |env#0@@21|)) (=> (and (and (= |let#3#0#0| (_module.__default.SetEnv (_module.Statement.id |stmt#Z#0@0|) |expr'#Z#0@0| |env#0@@21|)) (|_module.__default.SetEnv#canCall| (_module.Statement.id |stmt#Z#0@0|) |expr'#Z#0@0| |env#0@@21|)) (and ($IsBox |let#3#0#0| Tclass._module.Env) (= |env'#Z#0@0| |let#3#0#0|))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |stmts#0@@6|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |stmts#0@@6|))) (=> (= |##stmts#1@0| (|Seq#Drop| |stmts#0@@6| (LitInt 1))) (=> (and ($IsAlloc SeqType |##stmts#1@0| (TSeq Tclass._module.Statement) $Heap@@3) (|_module.__default.Legal#canCall| (|Seq#Drop| |stmts#0@@6| (LitInt 1)))) (and (=> (= (ControlFlow 0 14) 10) anon16_Then_correct) (=> (= (ControlFlow 0 14) 13) anon16_Else_correct)))))))))))))))
(let ((anon15_Else_correct true))
(let ((anon14_Then_correct  (=> (_module.Statement.stmtVariable_q |stmt#Z#0@0|) (and (=> (= (ControlFlow 0 18) (- 0 19)) (_module.Statement.stmtVariable_q |stmt#Z#0@0|)) (=> (_module.Statement.stmtVariable_q |stmt#Z#0@0|) (=> (and (= |##expr#0@0| (_module.Statement.expr |stmt#Z#0@0|)) ($IsAlloc DatatypeTypeType |##expr#0@0| Tclass._module.Expression $Heap@@3)) (=> (and (and ($IsAlloc DatatypeTypeType |stC#0@@37| Tclass._module.StateC $Heap@@3) ($IsAllocBox |env#0@@21| Tclass._module.Env $Heap@@3)) (and (|_module.__default.evalC#canCall| (_module.Statement.expr |stmt#Z#0@0|) |stC#0@@37| |env#0@@21|) (_module.Tuple.Pair_q (_module.__default.evalC ($LS $LZ) (_module.Statement.expr |stmt#Z#0@0|) |stC#0@@37| |env#0@@21|)))) (=> (and (and (and (and (= |let#1#0#0| (_module.__default.evalC ($LS $LZ) (_module.Statement.expr |stmt#Z#0@0|) |stC#0@@37| |env#0@@21|)) (|_module.__default.evalC#canCall| (_module.Statement.expr |stmt#Z#0@0|) |stC#0@@37| |env#0@@21|)) (and ($Is DatatypeTypeType |let#1#0#0| (Tclass._module.Tuple Tclass._module.Expression Tclass._module.StateC)) (= |result#Z#0@0| |let#1#0#0|))) (and (and (_module.Tuple.Pair_q |result#Z#0@0|) (= |let#2#0#0| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#Z#0@0|)))) (and (_module.Tuple.Pair_q |result#Z#0@0|) ($Is DatatypeTypeType |let#2#0#0| Tclass._module.Expression)))) (and (and (and (= |expr'#Z#0@0| |let#2#0#0|) (_module.Tuple.Pair_q |result#Z#0@0|)) (and (= |let#2#1#0| ($Unbox DatatypeTypeType (_module.Tuple.snd |result#Z#0@0|))) (_module.Tuple.Pair_q |result#Z#0@0|))) (and (and ($Is DatatypeTypeType |let#2#1#0| Tclass._module.StateC) (= |stC'#Z#0@0| |let#2#1#0|)) (and ($IsAlloc DatatypeTypeType |expr'#Z#0@0| Tclass._module.Expression $Heap@@3) (|_module.__default.Value#canCall| |expr'#Z#0@0|))))) (and (=> (= (ControlFlow 0 18) 14) anon15_Then_correct) (=> (= (ControlFlow 0 18) 8) anon15_Else_correct))))))))))
(let ((anon11_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (_module.Statement.stmtVariable_q |stmt#Z#0@0|) (_module.Statement.stmtReturn_q |stmt#Z#0@0|))) (=> (or (_module.Statement.stmtVariable_q |stmt#Z#0@0|) (_module.Statement.stmtReturn_q |stmt#Z#0@0|)) (=> (= (ControlFlow 0 3) (- 0 2)) (_module.Statement.stmtReturn_q |stmt#Z#0@0|))))))
(let ((anon17_Else_correct  (=> (and (_module.Statement.stmtVariable_q |stmt#Z#0@0|) (= (ControlFlow 0 6) 3)) anon11_correct)))
(let ((anon17_Then_correct  (=> (and (not (_module.Statement.stmtVariable_q |stmt#Z#0@0|)) (= (ControlFlow 0 5) 3)) anon11_correct)))
(let ((anon14_Else_correct  (=> (not (_module.Statement.stmtVariable_q |stmt#Z#0@0|)) (and (=> (= (ControlFlow 0 7) 5) anon17_Then_correct) (=> (= (ControlFlow 0 7) 6) anon17_Else_correct)))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |stmts#0@@6|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |stmts#0@@6|))) (=> (= |let#0#0#0| ($Unbox DatatypeTypeType (|Seq#Index| |stmts#0@@6| (LitInt 0)))) (=> (and ($Is DatatypeTypeType |let#0#0#0| Tclass._module.Statement) (= |stmt#Z#0@0| |let#0#0#0|)) (and (=> (= (ControlFlow 0 20) 18) anon14_Then_correct) (=> (= (ControlFlow 0 20) 7) anon14_Else_correct))))))))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (and (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@3 alloc false)) ($IsAlloc SeqType |stmts#0@@6| (TSeq Tclass._module.Statement) $Heap@@3)) (and (|_module.__default.Legal#canCall| |stmts#0@@6|) (_module.__default.Legal |stmts#0@@6|))) (and (=> (= (ControlFlow 0 22) 1) anon13_Then_correct) (=> (= (ControlFlow 0 22) 20) anon13_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) ($Is SeqType |stmts#0@@6| (TSeq Tclass._module.Statement))) (and (and ($Is DatatypeTypeType |stC#0@@37| Tclass._module.StateC) ($IsBox |env#0@@21| Tclass._module.Env)) (and (= 7 $FunctionContextHeight) (= (ControlFlow 0 23) 22)))) anon0_correct)))
