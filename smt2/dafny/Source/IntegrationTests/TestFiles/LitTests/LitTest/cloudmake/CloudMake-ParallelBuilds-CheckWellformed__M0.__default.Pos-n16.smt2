...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|cmd#0@@0| T@U) (|deps#0@@0| T@U) (|exps#0| T@U) (|st#0| T@U) ) (!  (=> (or (|M0.__default.Post#canCall| |cmd#0@@0| |deps#0@@0| |exps#0| |st#0|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@0| (TSeq TChar)) ($Is SetType |deps#0@@0| (TSet Tclass.M0.Path))) ($Is SetType |exps#0| (TSet (TSeq TChar)))) ($IsBox |st#0| Tclass.M0.State)))) (and (forall ((|e#0| T@U) ) (!  (=> ($Is SeqType |e#0| (TSeq TChar)) (and (=> (|Set#IsMember| |exps#0| ($Box SeqType |e#0|)) (and (|M0.__default.Loc#canCall| |cmd#0@@0| |deps#0@@0| |e#0|) (|M0.__default.DomSt#canCall| |st#0|))) (=> (=> (|Set#IsMember| |exps#0| ($Box SeqType |e#0|)) (|Set#IsMember| (M0.__default.DomSt |st#0|) (M0.__default.Loc |cmd#0@@0| |deps#0@@0| |e#0|))) (=> (|Set#IsMember| |exps#0| ($Box SeqType |e#0|)) (and (and (|M0.__default.Loc#canCall| |cmd#0@@0| |deps#0@@0| |e#0|) (|M0.__default.GetSt#canCall| (M0.__default.Loc |cmd#0@@0| |deps#0@@0| |e#0|) |st#0|)) (and (|M0.__default.Loc#canCall| |cmd#0@@0| |deps#0@@0| |e#0|) (|M0.__default.Oracle#canCall| (M0.__default.Loc |cmd#0@@0| |deps#0@@0| |e#0|) |st#0|)))))))
 :qid |CloudMakeParallelBuildsdfy.96:12|
 :skolemid |851|
 :pattern ( (M0.__default.Loc |cmd#0@@0| |deps#0@@0| |e#0|))
 :pattern ( (|Set#IsMember| |exps#0| ($Box SeqType |e#0|)))
)) (= (M0.__default.Post |cmd#0@@0| |deps#0@@0| |exps#0| |st#0|) (forall ((|e#0@@0| T@U) ) (!  (=> ($Is SeqType |e#0@@0| (TSeq TChar)) (and (=> (|Set#IsMember| |exps#0| ($Box SeqType |e#0@@0|)) (|Set#IsMember| (M0.__default.DomSt |st#0|) (M0.__default.Loc |cmd#0@@0| |deps#0@@0| |e#0@@0|))) (=> (|Set#IsMember| |exps#0| ($Box SeqType |e#0@@0|)) (= (M0.__default.GetSt (M0.__default.Loc |cmd#0@@0| |deps#0@@0| |e#0@@0|) |st#0|) (M0.__default.Oracle (M0.__default.Loc |cmd#0@@0| |deps#0@@0| |e#0@@0|) |st#0|)))))
 :qid |CloudMakeParallelBuildsdfy.96:12|
 :skolemid |850|
 :pattern ( (M0.__default.Loc |cmd#0@@0| |deps#0@@0| |e#0@@0|))
 :pattern ( (|Set#IsMember| |exps#0| ($Box SeqType |e#0@@0|)))
)))))
 :qid |CloudMakeParallelBuildsdfy.94:24|
 :skolemid |852|
 :pattern ( (M0.__default.Post |cmd#0@@0| |deps#0@@0| |exps#0| |st#0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|cmd#0@@1| T@U) (|deps#0@@1| T@U) (|exps#0@@0| T@U) (|st#0@@5| T@U) ) (!  (=> (or (|M0.__default.Post#canCall| (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) (Lit SetType |exps#0@@0|) (Lit BoxType |st#0@@5|)) (and (< 2 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@1| (TSeq TChar)) ($Is SetType |deps#0@@1| (TSet Tclass.M0.Path))) ($Is SetType |exps#0@@0| (TSet (TSeq TChar)))) ($IsBox |st#0@@5| Tclass.M0.State)))) (and (forall ((|e#2| T@U) ) (!  (=> ($Is SeqType |e#2| (TSeq TChar)) (and (=> (|Set#IsMember| (Lit SetType |exps#0@@0|) ($Box SeqType |e#2|)) (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) |e#2|) (|M0.__default.DomSt#canCall| (Lit BoxType |st#0@@5|)))) (=> (=> (|Set#IsMember| (Lit SetType |exps#0@@0|) ($Box SeqType |e#2|)) (|Set#IsMember| (M0.__default.DomSt (Lit BoxType |st#0@@5|)) (M0.__default.Loc (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) |e#2|))) (=> (|Set#IsMember| (Lit SetType |exps#0@@0|) ($Box SeqType |e#2|)) (and (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) |e#2|) (|M0.__default.GetSt#canCall| (M0.__default.Loc (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) |e#2|) (Lit BoxType |st#0@@5|))) (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) |e#2|) (|M0.__default.Oracle#canCall| (M0.__default.Loc (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) |e#2|) (Lit BoxType |st#0@@5|))))))))
 :qid |CloudMakeParallelBuildsdfy.96:12|
 :skolemid |857|
 :pattern ( (M0.__default.Loc |cmd#0@@1| |deps#0@@1| |e#2|))
 :pattern ( (|Set#IsMember| |exps#0@@0| ($Box SeqType |e#2|)))
)) (= (M0.__default.Post (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) (Lit SetType |exps#0@@0|) (Lit BoxType |st#0@@5|)) (forall ((|e#2@@0| T@U) ) (!  (=> ($Is SeqType |e#2@@0| (TSeq TChar)) (and (=> (|Set#IsMember| (Lit SetType |exps#0@@0|) ($Box SeqType |e#2@@0|)) (|Set#IsMember| (M0.__default.DomSt (Lit BoxType |st#0@@5|)) (M0.__default.Loc (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) |e#2@@0|))) (=> (|Set#IsMember| (Lit SetType |exps#0@@0|) ($Box SeqType |e#2@@0|)) (= (M0.__default.GetSt (M0.__default.Loc (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) |e#2@@0|) (Lit BoxType |st#0@@5|)) (M0.__default.Oracle (M0.__default.Loc (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) |e#2@@0|) (Lit BoxType |st#0@@5|))))))
 :qid |CloudMakeParallelBuildsdfy.96:12|
 :skolemid |856|
 ...
 :weight 3
 :skolemid |858|
 :pattern ( (M0.__default.Post (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) (Lit SetType |exps#0@@0|) (Lit BoxType |st#0@@5|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|cmd#0@@2| T@U) (|deps#0@@2| T@U) (|exps#0@@1| T@U) (|st#0@@6| T@U) ) (!  (=> (or (|M0.__default.Post#canCall| (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) (Lit SetType |exps#0@@1|) |st#0@@6|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@2| (TSeq TChar)) ($Is SetType |deps#0@@2| (TSet Tclass.M0.Path))) ($Is SetType |exps#0@@1| (TSet (TSeq TChar)))) ($IsBox |st#0@@6| Tclass.M0.State)))) (and (forall ((|e#1| T@U) ) (!  (=> ($Is SeqType |e#1| (TSeq TChar)) (and (=> (|Set#IsMember| (Lit SetType |exps#0@@1|) ($Box SeqType |e#1|)) (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#1|) (|M0.__default.DomSt#canCall| |st#0@@6|))) (=> (=> (|Set#IsMember| (Lit SetType |exps#0@@1|) ($Box SeqType |e#1|)) (|Set#IsMember| (M0.__default.DomSt |st#0@@6|) (M0.__default.Loc (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#1|))) (=> (|Set#IsMember| (Lit SetType |exps#0@@1|) ($Box SeqType |e#1|)) (and (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#1|) (|M0.__default.GetSt#canCall| (M0.__default.Loc (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#1|) |st#0@@6|)) (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#1|) (|M0.__default.Oracle#canCall| (M0.__default.Loc (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#1|) |st#0@@6|)))))))
 :qid |CloudMakeParallelBuildsdfy.96:12|
 :skolemid |854|
 :pattern ( (M0.__default.Loc |cmd#0@@2| |deps#0@@2| |e#1|))
 :pattern ( (|Set#IsMember| |exps#0@@1| ($Box SeqType |e#1|)))
)) (= (M0.__default.Post (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) (Lit SetType |exps#0@@1|) |st#0@@6|) (forall ((|e#1@@0| T@U) ) (!  (=> ($Is SeqType |e#1@@0| (TSeq TChar)) (and (=> (|Set#IsMember| (Lit SetType |exps#0@@1|) ($Box SeqType |e#1@@0|)) (|Set#IsMember| (M0.__default.DomSt |st#0@@6|) (M0.__default.Loc (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#1@@0|))) (=> (|Set#IsMember| (Lit SetType |exps#0@@1|) ($Box SeqType |e#1@@0|)) (= (M0.__default.GetSt (M0.__default.Loc (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#1@@0|) |st#0@@6|) (M0.__default.Oracle (M0.__default.Loc (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#1@@0|) |st#0@@6|)))))
 :qid |CloudMakeParallelBuildsdfy.96:12|
 :skolemid |853|
 ...
 :weight 3
 :skolemid |855|
 :pattern ( (M0.__default.Post (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) (Lit SetType |exps#0@@1|) |st#0@@6|))
))))
