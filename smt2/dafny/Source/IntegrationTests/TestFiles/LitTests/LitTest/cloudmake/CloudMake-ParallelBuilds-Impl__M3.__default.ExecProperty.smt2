...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|cmd#0@@9| T@U) (|deps#0@@10| T@U) (|exps#0@@5| T@U) (|st#0@@14| T@U) ) (!  (=> (or (|M3.__default.exec#canCall| (Lit SeqType |cmd#0@@9|) (Lit SetType |deps#0@@10|) (Lit SetType |exps#0@@5|) (Lit DatatypeTypeType |st#0@@14|)) (and (< 5 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@9| (TSeq TChar)) ($Is SetType |deps#0@@10| (TSet Tclass.M3.Path))) ($Is SetType |exps#0@@5| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@14| Tclass.M3.State)))) (and (and (|M3.__default.Restrict#canCall| (Lit SetType |deps#0@@10|) (Lit DatatypeTypeType |st#0@@14|)) (|M3.__default.execOne#canCall| (Lit SeqType |cmd#0@@9|) (Lit SetType |deps#0@@10|) (Lit MapType (M3.__default.Restrict (Lit SetType |deps#0@@10|) (Lit DatatypeTypeType |st#0@@14|))) (Lit SetType |exps#0@@5|) (Lit DatatypeTypeType |st#0@@14|))) (= (M3.__default.exec (Lit SeqType |cmd#0@@9|) (Lit SetType |deps#0@@10|) (Lit SetType |exps#0@@5|) (Lit DatatypeTypeType |st#0@@14|)) (Lit DatatypeTypeType (M3.__default.execOne ($LS $LZ) (Lit SeqType |cmd#0@@9|) (Lit SetType |deps#0@@10|) (Lit MapType (M3.__default.Restrict (Lit SetType |deps#0@@10|) (Lit DatatypeTypeType |st#0@@14|))) (Lit SetType |exps#0@@5|) (Lit DatatypeTypeType |st#0@@14|))))))
 :qid |CloudMakeParallelBuildsdfy.69:23|
 :weight 3
 :skolemid |5823|
 :pattern ( (M3.__default.exec (Lit SeqType |cmd#0@@9|) (Lit SetType |deps#0@@10|) (Lit SetType |exps#0@@5|) (Lit DatatypeTypeType |st#0@@14|)))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|p#0@@15| T@U) (|st#0@@15| T@U) ) (!  (=> (or (|M3.__default.Oracle#canCall| |p#0@@15| |st#0@@15|) (and (< 5 $FunctionContextHeight) (and ($Is DatatypeTypeType |p#0@@15| Tclass.M3.Path) ($Is DatatypeTypeType |st#0@@15| Tclass.M3.State)))) (and (and (and (|M3.__default.WellFounded#canCall| |p#0@@15|) (=> (M3.__default.WellFounded |p#0@@15|) (and (|M3.__default.GetCert#canCall| |p#0@@15|) (|M3.__default.OracleWF#canCall| |p#0@@15| (M3.__default.GetCert |p#0@@15|) |st#0@@15|)))) (=> (not (M3.__default.WellFounded |p#0@@15|)) (|M3.__default.OracleArbitrary#canCall| |p#0@@15|))) (= (M3.__default.Oracle |p#0@@15| |st#0@@15|) (ite (M3.__default.WellFounded |p#0@@15|) (M3.__default.OracleWF ($LS $LZ) |p#0@@15| (M3.__default.GetCert |p#0@@15|) |st#0@@15|) (M3.__default.OracleArbitrary |p#0@@15|)))))
 :qid |CloudMakeParallelBuildsdfy.104:25|
 :skolemid |6037|
 :pattern ( (M3.__default.Oracle |p#0@@15| |st#0@@15|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|p#0@@16| T@U) (|st#0@@16| T@U) ) (!  (=> (or (|M3.__default.GetSt#canCall| |p#0@@16| |st#0@@16|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |p#0@@16| Tclass.M3.Path) ($Is DatatypeTypeType |st#0@@16| Tclass.M3.State)) (|Set#IsMember| (M3.__default.DomSt |st#0@@16|) ($Box DatatypeTypeType |p#0@@16|))))) (and (M3.State.StateCons_q |st#0@@16|) (= (M3.__default.GetSt |p#0@@16| |st#0@@16|) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (M3.State.m |st#0@@16|)) ($Box DatatypeTypeType |p#0@@16|))))))
 :qid |CloudMakeParallelBuildsdfy.10:24|
 :skolemid |6471|
 :pattern ( (M3.__default.GetSt |p#0@@16| |st#0@@16|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@17| T@U) ) (!  (=> (or (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@17|)) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |st#0@@17| Tclass.M3.State))) (and (M3.State.StateCons_q (Lit DatatypeTypeType |st#0@@17|)) (= (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@17|)) (|Set#FromBoogieMap| (|lambda#0| Tclass.M3.Path (|Map#Domain| (M3.State.m (Lit DatatypeTypeType |st#0@@17|))))))))
 :qid |CloudMakeParallelBuildsdfy.9:24|
 :weight 3
 :skolemid |6479|
 :pattern ( (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@17|)))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall ((|cmd#0@@10| T@U) (|deps#0@@11| T@U) (|exps#0@@6| T@U) (|st#0@@18| T@U) ) (!  (=> (or (|M3.__default.Pre#canCall| |cmd#0@@10| |deps#0@@11| |exps#0@@6| |st#0@@18|) (and (< 6 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@10| (TSeq TChar)) ($Is SetType |deps#0@@11| (TSet Tclass.M3.Path))) ($Is SetType |exps#0@@6| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@18| Tclass.M3.State)))) (and (forall ((|e#0@@3| T@U) ) (!  (=> ($Is SeqType |e#0@@3| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@6| ($Box SeqType |e#0@@3|)) (and (and (|M3.__default.Loc#canCall| |cmd#0@@10| |deps#0@@11| |e#0@@3|) (|M3.__default.DomSt#canCall| |st#0@@18|)) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@18|) ($Box DatatypeTypeType (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@3|))) (and (and (|$IsA#M3.Artifact| (M3.__default.GetSt (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@3|) |st#0@@18|)) (|$IsA#M3.Artifact| (M3.__default.Oracle (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@3|) |st#0@@18|))) (and (and (|M3.__default.Loc#canCall| |cmd#0@@10| |deps#0@@11| |e#0@@3|) (|M3.__default.GetSt#canCall| (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@3|) |st#0@@18|)) (and (|M3.__default.Loc#canCall| |cmd#0@@10| |deps#0@@11| |e#0@@3|) (|M3.__default.Oracle#canCall| (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@3|) |st#0@@18|))))))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |6560|
 :pattern ( (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@3|))
 :pattern ( (|Set#IsMember| |exps#0@@6| ($Box SeqType |e#0@@3|)))
)) (= (M3.__default.Pre |cmd#0@@10| |deps#0@@11| |exps#0@@6| |st#0@@18|) (forall ((|e#0@@4| T@U) ) (!  (=> ($Is SeqType |e#0@@4| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@6| ($Box SeqType |e#0@@4|)) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@18|) ($Box DatatypeTypeType (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@4|))) (|M3.Artifact#Equal| (M3.__default.GetSt (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@4|) |st#0@@18|) (M3.__default.Oracle (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@4|) |st#0@@18|)))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |6559|
 :pattern ( (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@4|))
 :pattern ( (|Set#IsMember| |exps#0@@6| ($Box SeqType |e#0@@4|)))
)))))
 :qid |CloudMakeParallelBuildsdfy.83:23|
 :skolemid |6561|
 :pattern ( (M3.__default.Pre |cmd#0@@10| |deps#0@@11| |exps#0@@6| |st#0@@18|))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@6 T@U) (|p#0@@18| T@U) (|cert#0@@5| T@U) (|st#0@@19| T@U) ) (!  (=> (or (|M3.__default.OracleWF#canCall| |p#0@@18| (Lit DatatypeTypeType |cert#0@@5|) |st#0@@19|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |p#0@@18| Tclass.M3.Path) ($Is DatatypeTypeType |cert#0@@5| Tclass.M3.WFCertificate)) ($Is DatatypeTypeType |st#0@@19| Tclass.M3.State)) (M3.__default.CheckWellFounded ($LS $LZ) |p#0@@18| (Lit DatatypeTypeType |cert#0@@5|))))) (and (and (and (and (|M3.__default.LocInv__Cmd#canCall| |p#0@@18|) (|M3.__default.LocInv__Deps#canCall| |p#0@@18|)) (|M3.__default.LocInv__Exp#canCall| |p#0@@18|)) (let ((|e#1@@1| (M3.__default.LocInv__Exp |p#0@@18|)))
(let ((|deps#1| (M3.__default.LocInv__Deps |p#0@@18|)))
(let ((|cmd#1| (M3.__default.LocInv__Cmd |p#0@@18|)))
 (and (|M3.__default.CollectDependencies#canCall| |p#0@@18| (Lit DatatypeTypeType |cert#0@@5|) |deps#1| |st#0@@19|) (|M3.__default.RunTool#canCall| |cmd#1| (M3.__default.CollectDependencies ($LS $ly@@6) |p#0@@18| (Lit DatatypeTypeType |cert#0@@5|) |deps#1| |st#0@@19|) |e#1@@1|)))))) (= (M3.__default.OracleWF ($LS $ly@@6) |p#0@@18| (Lit DatatypeTypeType |cert#0@@5|) |st#0@@19|) (let ((|e#1@@2| (M3.__default.LocInv__Exp |p#0@@18|)))
(let ((|deps#1@@0| (M3.__default.LocInv__Deps |p#0@@18|)))
(let ((|cmd#1@@0| (M3.__default.LocInv__Cmd |p#0@@18|)))
(M3.__default.RunTool |cmd#1@@0| (M3.__default.CollectDependencies ($LS $ly@@6) |p#0@@18| (Lit DatatypeTypeType |cert#0@@5|) |deps#1@@0| |st#0@@19|) |e#1@@2|)))))))
 :qid |CloudMakeParallelBuildsdfy.653:18|
 :weight 3
 :skolemid |6063|
 :pattern ( (M3.__default.OracleWF ($LS $ly@@6) |p#0@@18| (Lit DatatypeTypeType |cert#0@@5|) |st#0@@19|))
))))
...
(assert (forall ((a@@15 T@U) (b@@12 T@U) ) (! (= (|M3.Artifact#Equal| a@@15 b@@12) (= (M3.Artifact._h11 a@@15) (M3.Artifact._h11 b@@12)))
 :qid |unknown.0:0|
 :skolemid |6857|
 :pattern ( (|M3.Artifact#Equal| a@@15 b@@12))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|p#0@@19| T@U) (|st#0@@20| T@U) ) (!  (=> (or (|M3.__default.GetSt#canCall| (Lit DatatypeTypeType |p#0@@19|) (Lit DatatypeTypeType |st#0@@20|)) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |p#0@@19| Tclass.M3.Path) ($Is DatatypeTypeType |st#0@@20| Tclass.M3.State)) (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@20|))) ($Box DatatypeTypeType (Lit DatatypeTypeType |p#0@@19|)))))) (and (M3.State.StateCons_q (Lit DatatypeTypeType |st#0@@20|)) (= (M3.__default.GetSt (Lit DatatypeTypeType |p#0@@19|) (Lit DatatypeTypeType |st#0@@20|)) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType (M3.State.m (Lit DatatypeTypeType |st#0@@20|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |p#0@@19|)))))))
 :qid |CloudMakeParallelBuildsdfy.10:24|
 :weight 3
 :skolemid |6473|
 :pattern ( (M3.__default.GetSt (Lit DatatypeTypeType |p#0@@19|) (Lit DatatypeTypeType |st#0@@20|)))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|cmd#0@@11| T@U) (|deps#0@@12| T@U) (|exps#0@@7| T@U) (|st#0@@21| T@U) ) (!  (=> (or (|M3.__default.exec#canCall| |cmd#0@@11| |deps#0@@12| |exps#0@@7| |st#0@@21|) (and (< 5 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@11| (TSeq TChar)) ($Is SetType |deps#0@@12| (TSet Tclass.M3.Path))) ($Is SetType |exps#0@@7| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@21| Tclass.M3.State)))) ($Is DatatypeTypeType (M3.__default.exec |cmd#0@@11| |deps#0@@12| |exps#0@@7| |st#0@@21|) (Tclass.M3.Tuple (TSet Tclass.M3.Path) Tclass.M3.State)))
 :qid |CloudMakeParallelBuildsdfy.69:23|
 :skolemid |5819|
 :pattern ( (M3.__default.exec |cmd#0@@11| |deps#0@@12| |exps#0@@7| |st#0@@21|))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@22| T@U) ) (!  (=> (or (|M3.__default.ValidState#canCall| |st#0@@22|) (and (< 4 $FunctionContextHeight) ($Is DatatypeTypeType |st#0@@22| Tclass.M3.State))) (and (forall ((|p#0@@21| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@21| Tclass.M3.Path) (and (|M3.__default.DomSt#canCall| |st#0@@22|) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@22|) ($Box DatatypeTypeType |p#0@@21|)) (|M3.__default.WellFounded#canCall| |p#0@@21|))))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6492|
 :pattern ( (M3.__default.WellFounded |p#0@@21|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@22|) ($Box DatatypeTypeType |p#0@@21|)))
)) (= (M3.__default.ValidState |st#0@@22|) (forall ((|p#0@@22| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@22| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@22|) ($Box DatatypeTypeType |p#0@@22|)) (M3.__default.WellFounded |p#0@@22|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6491|
 :pattern ( (M3.__default.WellFounded |p#0@@22|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@22|) ($Box DatatypeTypeType |p#0@@22|)))
)))))
 :qid |CloudMakeParallelBuildsdfy.13:30|
 :skolemid |6493|
 :pattern ( (M3.__default.ValidState |st#0@@22|))
))))
...
|cmd#0@@13|) (let ((|cmd#1@@1| |$let#3_cmd|))
|cmd#1@@1|)))))
 :qid |CloudMakeParallelBuildsdfy.797:18|
 :skolemid |5685|
 :pattern ( (M3.__default.LocInv__Cmd |p#0@@24|) ($IsGoodHeap $Heap@@5))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@6 T@U) (|p#0@@25| T@U) ) (!  (=> (or (|M3.__default.LocInv__Deps#canCall| |p#0@@25|) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@6) ($Is DatatypeTypeType |p#0@@25| Tclass.M3.Path)))) (and (=> (not (M3.Path.InternalPath_q |p#0@@25|)) |$let#10$canCall|) (= (M3.__default.LocInv__Deps |p#0@@25|) (ite (M3.Path.InternalPath_q |p#0@@25|) (let ((|deps#0@@14| (M3.Path.deps |p#0@@25|)))
|deps#0@@14|) (let ((|deps#1@@1| |$let#10_deps|))
|deps#1@@1|)))))
...
(assert (forall ((a@@16 T@U) (b@@13 T@U) ) (!  (=> (and (M3.Path.ExternalPath_q a@@16) (M3.Path.ExternalPath_q b@@13)) (= (|M3.Path#Equal| a@@16 b@@13) (|Seq#Equal| (M3.Path._h13 a@@16) (M3.Path._h13 b@@13))))
 :qid |unknown.0:0|
 :skolemid |6903|
 :pattern ( (|M3.Path#Equal| a@@16 b@@13) (M3.Path.ExternalPath_q a@@16))
 :pattern ( (|M3.Path#Equal| a@@16 b@@13) (M3.Path.ExternalPath_q b@@13))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@23| T@U) ) (!  (=> (or (|M3.__default.ValidState#canCall| (Lit DatatypeTypeType |st#0@@23|)) (and (< 4 $FunctionContextHeight) ($Is DatatypeTypeType |st#0@@23| Tclass.M3.State))) (and (forall ((|p#1@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |p#1@@1| Tclass.M3.Path) (and (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@23|)) (=> (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@23|))) ($Box DatatypeTypeType |p#1@@1|)) (|M3.__default.WellFounded#canCall| |p#1@@1|))))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6495|
 :pattern ( (M3.__default.WellFounded |p#1@@1|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@23|) ($Box DatatypeTypeType |p#1@@1|)))
)) (= (M3.__default.ValidState (Lit DatatypeTypeType |st#0@@23|)) (forall ((|p#1@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |p#1@@2| Tclass.M3.Path) (=> (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@23|))) ($Box DatatypeTypeType |p#1@@2|)) (M3.__default.WellFounded |p#1@@2|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6494|
 :pattern ( (M3.__default.WellFounded |p#1@@2|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@23|) ($Box DatatypeTypeType |p#1@@2|)))
)))))
 :qid |CloudMakeParallelBuildsdfy.13:30|
 :weight 3
 :skolemid |6496|
 :pattern ( (M3.__default.ValidState (Lit DatatypeTypeType |st#0@@23|)))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|p#0@@29| T@U) (|st#0@@24| T@U) ) (!  (=> (or (|M3.__default.Oracle#canCall| |p#0@@29| (Lit DatatypeTypeType |st#0@@24|)) (and (< 5 $FunctionContextHeight) (and ($Is DatatypeTypeType |p#0@@29| Tclass.M3.Path) ($Is DatatypeTypeType |st#0@@24| Tclass.M3.State)))) (and (and (and (|M3.__default.WellFounded#canCall| |p#0@@29|) (=> (M3.__default.WellFounded |p#0@@29|) (and (|M3.__default.GetCert#canCall| |p#0@@29|) (|M3.__default.OracleWF#canCall| |p#0@@29| (M3.__default.GetCert |p#0@@29|) (Lit DatatypeTypeType |st#0@@24|))))) (=> (not (M3.__default.WellFounded |p#0@@29|)) (|M3.__default.OracleArbitrary#canCall| |p#0@@29|))) (= (M3.__default.Oracle |p#0@@29| (Lit DatatypeTypeType |st#0@@24|)) (ite (M3.__default.WellFounded |p#0@@29|) (M3.__default.OracleWF ($LS $LZ) |p#0@@29| (M3.__default.GetCert |p#0@@29|) (Lit DatatypeTypeType |st#0@@24|)) (M3.__default.OracleArbitrary |p#0@@29|)))))
 :qid |CloudMakeParallelBuildsdfy.104:25|
 :weight 3
 :skolemid |6038|
 :pattern ( (M3.__default.Oracle |p#0@@29| (Lit DatatypeTypeType |st#0@@24|)))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@9 T@U) (|p#0@@30| T@U) (|cert#0@@8| T@U) (|deps#0@@15| T@U) (|st#0@@25| T@U) ) (!  (=> (or (|M3.__default.CollectDependencies#canCall| |p#0@@30| (Lit DatatypeTypeType |cert#0@@8|) |deps#0@@15| |st#0@@25|) (and (< 4 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |p#0@@30| Tclass.M3.Path) ($Is DatatypeTypeType |cert#0@@8| Tclass.M3.WFCertificate)) ($Is SetType |deps#0@@15| (TSet Tclass.M3.Path))) ($Is DatatypeTypeType |st#0@@25| Tclass.M3.State)) (and (M3.__default.CheckWellFounded ($LS $LZ) |p#0@@30| (Lit DatatypeTypeType |cert#0@@8|)) (|Set#Equal| |deps#0@@15| (M3.__default.LocInv__Deps |p#0@@30|)))))) (and (forall ((|d#0@@5| T@U) ) (!  (=> ($Is DatatypeTypeType |d#0@@5| Tclass.M3.Path) (=> (|Set#IsMember| |deps#0@@15| ($Box DatatypeTypeType |d#0@@5|)) (and (and (|M3.__default.DomSt#canCall| |st#0@@25|) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@25|) ($Box DatatypeTypeType |d#0@@5|)) (|M3.__default.GetSt#canCall| |d#0@@5| |st#0@@25|))) (=> (not (|Set#IsMember| (M3.__default.DomSt |st#0@@25|) ($Box DatatypeTypeType |d#0@@5|))) (and (and (M3.WFCertificate.Cert_q (Lit DatatypeTypeType |cert#0@@8|)) (|M3.__default.FindCert#canCall| |d#0@@5| (Lit SetType (M3.WFCertificate.certs (Lit DatatypeTypeType |cert#0@@8|))))) (|M3.__default.OracleWF#canCall| |d#0@@5| (M3.__default.FindCert |d#0@@5| (Lit SetType (M3.WFCertificate.certs (Lit DatatypeTypeType |cert#0@@8|)))) |st#0@@25|))))))
 :qid |CloudMakeParallelBuildsdfy.664:9|
 :skolemid |6084|
 :pattern ( (M3.__default.FindCert |d#0@@5| (M3.WFCertificate.certs |cert#0@@8|)))
 :pattern ( (M3.__default.GetSt |d#0@@5| |st#0@@25|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@25|) ($Box DatatypeTypeType |d#0@@5|)))
 :pattern ( (|Set#IsMember| |deps#0@@15| ($Box DatatypeTypeType |d#0@@5|)))
)) (= (M3.__default.CollectDependencies ($LS $ly@@9) |p#0@@30| (Lit DatatypeTypeType |cert#0@@8|) |deps#0@@15| |st#0@@25|) (|Map#Glue| (|Set#FromBoogieMap| (|lambda#0| Tclass.M3.Path |deps#0@@15|)) (|lambda#26| (M3.__default.DomSt |st#0@@25|) |st#0@@25| ($LS $ly@@9) (Lit SetType (M3.WFCertificate.certs (Lit DatatypeTypeType |cert#0@@8|))) |st#0@@25|) (TMap Tclass.M3.Path Tclass.M3.Artifact)))))
 :qid |CloudMakeParallelBuildsdfy.660:18|
 :weight 3
 :skolemid |6085|
 :pattern ( (M3.__default.CollectDependencies ($LS $ly@@9) |p#0@@30| (Lit DatatypeTypeType |cert#0@@8|) |deps#0@@15| |st#0@@25|))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@10 T@U) (|p#0@@31| T@U) (|cert#0@@9| T@U) (|deps#0@@16| T@U) (|st#0@@26| T@U) ) (!  (=> (or (|M3.__default.CollectDependencies#canCall| |p#0@@31| |cert#0@@9| |deps#0@@16| |st#0@@26|) (and (< 4 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |p#0@@31| Tclass.M3.Path) ($Is DatatypeTypeType |cert#0@@9| Tclass.M3.WFCertificate)) ($Is SetType |deps#0@@16| (TSet Tclass.M3.Path))) ($Is DatatypeTypeType |st#0@@26| Tclass.M3.State)) (and (M3.__default.CheckWellFounded ($LS $LZ) |p#0@@31| |cert#0@@9|) (|Set#Equal| |deps#0@@16| (M3.__default.LocInv__Deps |p#0@@31|)))))) (and (forall ((|d#0@@6| T@U) ) (!  (=> ($Is DatatypeTypeType |d#0@@6| Tclass.M3.Path) (=> (|Set#IsMember| |deps#0@@16| ($Box DatatypeTypeType |d#0@@6|)) (and (and (|M3.__default.DomSt#canCall| |st#0@@26|) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@26|) ($Box DatatypeTypeType |d#0@@6|)) (|M3.__default.GetSt#canCall| |d#0@@6| |st#0@@26|))) (=> (not (|Set#IsMember| (M3.__default.DomSt |st#0@@26|) ($Box DatatypeTypeType |d#0@@6|))) (and (and (M3.WFCertificate.Cert_q |cert#0@@9|) (|M3.__default.FindCert#canCall| |d#0@@6| (M3.WFCertificate.certs |cert#0@@9|))) (|M3.__default.OracleWF#canCall| |d#0@@6| (M3.__default.FindCert |d#0@@6| (M3.WFCertificate.certs |cert#0@@9|)) |st#0@@26|))))))
 :qid |CloudMakeParallelBuildsdfy.664:9|
 :skolemid |6082|
 :pattern ( (M3.__default.FindCert |d#0@@6| (M3.WFCertificate.certs |cert#0@@9|)))
 :pattern ( (M3.__default.GetSt |d#0@@6| |st#0@@26|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@26|) ($Box DatatypeTypeType |d#0@@6|)))
 :pattern ( (|Set#IsMember| |deps#0@@16| ($Box DatatypeTypeType |d#0@@6|)))
)) (= (M3.__default.CollectDependencies ($LS $ly@@10) |p#0@@31| |cert#0@@9| |deps#0@@16| |st#0@@26|) (|Map#Glue| (|Set#FromBoogieMap| (|lambda#0| Tclass.M3.Path |deps#0@@16|)) (|lambda#26| (M3.__default.DomSt |st#0@@26|) |st#0@@26| $ly@@10 (M3.WFCertificate.certs |cert#0@@9|) |st#0@@26|) (TMap Tclass.M3.Path Tclass.M3.Artifact)))))
 :qid |CloudMakeParallelBuildsdfy.660:18|
 :skolemid |6083|
 :pattern ( (M3.__default.CollectDependencies ($LS $ly@@10) |p#0@@31| |cert#0@@9| |deps#0@@16| |st#0@@26|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|p#0@@32| T@U) (|a#0@@1| T@U) (|st#0@@27| T@U) ) (!  (=> (or (|M3.__default.SetSt#canCall| |p#0@@32| |a#0@@1| |st#0@@27|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |p#0@@32| Tclass.M3.Path) ($Is DatatypeTypeType |a#0@@1| Tclass.M3.Artifact)) ($Is DatatypeTypeType |st#0@@27| Tclass.M3.State)))) ($Is DatatypeTypeType (M3.__default.SetSt |p#0@@32| |a#0@@1| |st#0@@27|) Tclass.M3.State))
 :qid |CloudMakeParallelBuildsdfy.468:24|
 :skolemid |5727|
 :pattern ( (M3.__default.SetSt |p#0@@32| |a#0@@1| |st#0@@27|))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@11 T@U) (|p#0@@33| T@U) (|cert#0@@10| T@U) (|st#0@@28| T@U) ) (!  (=> (or (|M3.__default.OracleWF#canCall| (Lit DatatypeTypeType |p#0@@33|) (Lit DatatypeTypeType |cert#0@@10|) (Lit DatatypeTypeType |st#0@@28|)) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |p#0@@33| Tclass.M3.Path) ($Is DatatypeTypeType |cert#0@@10| Tclass.M3.WFCertificate)) ($Is DatatypeTypeType |st#0@@28| Tclass.M3.State)) (U_2_bool (Lit boolType (bool_2_U (M3.__default.CheckWellFounded ($LS $LZ) (Lit DatatypeTypeType |p#0@@33|) (Lit DatatypeTypeType |cert#0@@10|)))))))) (and (and (and (and (|M3.__default.LocInv__Cmd#canCall| (Lit DatatypeTypeType |p#0@@33|)) (|M3.__default.LocInv__Deps#canCall| (Lit DatatypeTypeType |p#0@@33|))) (|M3.__default.LocInv__Exp#canCall| (Lit DatatypeTypeType |p#0@@33|))) (let ((|e#2@@1| (Lit SeqType (M3.__default.LocInv__Exp (Lit DatatypeTypeType |p#0@@33|)))))
...
(let ((|cmd#2| (Lit SeqType (M3.__default.LocInv__Cmd (Lit DatatypeTypeType |p#0@@33|)))))
 (and (|M3.__default.CollectDependencies#canCall| (Lit DatatypeTypeType |p#0@@33|) (Lit DatatypeTypeType |cert#0@@10|) |deps#2| (Lit DatatypeTypeType |st#0@@28|)) (|M3.__default.RunTool#canCall| |cmd#2| (M3.__default.CollectDependencies ($LS $ly@@11) (Lit DatatypeTypeType |p#0@@33|) (Lit DatatypeTypeType |cert#0@@10|) |deps#2| (Lit DatatypeTypeType |st#0@@28|)) |e#2@@1|)))))) (= (M3.__default.OracleWF ($LS $ly@@11) (Lit DatatypeTypeType |p#0@@33|) (Lit DatatypeTypeType |cert#0@@10|) (Lit DatatypeTypeType |st#0@@28|)) (let ((|e#2@@2| (Lit SeqType (M3.__default.LocInv__Exp (Lit DatatypeTypeType |p#0@@33|)))))
...
(M3.__default.RunTool |cmd#2@@0| (M3.__default.CollectDependencies ($LS $ly@@11) (Lit DatatypeTypeType |p#0@@33|) (Lit DatatypeTypeType |cert#0@@10|) |deps#2@@0| (Lit DatatypeTypeType |st#0@@28|)) |e#2@@2|)))))))
 :qid |CloudMakeParallelBuildsdfy.653:18|
 :weight 3
 :skolemid |6064|
 :pattern ( (M3.__default.OracleWF ($LS $ly@@11) (Lit DatatypeTypeType |p#0@@33|) (Lit DatatypeTypeType |cert#0@@10|) (Lit DatatypeTypeType |st#0@@28|)))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall ((|cmd#0@@14| T@U) (|deps#0@@17| T@U) (|exps#0@@8| T@U) (|st#0@@29| T@U) ) (!  (=> (or (|M3.__default.Post#canCall| (Lit SeqType |cmd#0@@14|) (Lit SetType |deps#0@@17|) (Lit SetType |exps#0@@8|) (Lit DatatypeTypeType |st#0@@29|)) (and (< 6 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@14| (TSeq TChar)) ($Is SetType |deps#0@@17| (TSet Tclass.M3.Path))) ($Is SetType |exps#0@@8| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@29| Tclass.M3.State)))) (and (forall ((|e#2@@3| T@U) ) (!  (=> ($Is SeqType |e#2@@3| (TSeq TChar)) (and (=> (|Set#IsMember| (Lit SetType |exps#0@@8|) ($Box SeqType |e#2@@3|)) (and (|M3.__default.Loc#canCall| (Lit SeqType |cmd#0@@14|) (Lit SetType |deps#0@@17|) |e#2@@3|) (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@29|)))) (=> (=> (|Set#IsMember| (Lit SetType |exps#0@@8|) ($Box SeqType |e#2@@3|)) (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@29|))) ($Box DatatypeTypeType (M3.__default.Loc (Lit SeqType |cmd#0@@14|) (Lit SetType |deps#0@@17|) |e#2@@3|)))) (=> (|Set#IsMember| (Lit SetType |exps#0@@8|) ($Box SeqType |e#2@@3|)) (and (and (|$IsA#M3.Artifact| (M3.__default.GetSt (M3.__default.Loc (Lit SeqType |cmd#0@@14|) (Lit SetType |deps#0@@17|) |e#2@@3|) (Lit DatatypeTypeType |st#0@@29|))) (|$IsA#M3.Artifact| (M3.__default.Oracle (M3.__default.Loc (Lit SeqType |cmd#0@@14|) (Lit SetType |deps#0@@17|) |e#2@@3|) (Lit DatatypeTypeType |st#0@@29|)))) (and (and (|M3.__default.Loc#canCall| (Lit SeqType |cmd#0@@14|) (Lit SetType |deps#0@@17|) |e#2@@3|) (|M3.__default.GetSt#canCall| (M3.__default.Loc (Lit SeqType |cmd#0@@14|) (Lit SetType |deps#0@@17|) |e#2@@3|) (Lit DatatypeTypeType |st#0@@29|))) (and (|M3.__default.Loc#canCall| (Lit SeqType |cmd#0@@14|) (Lit SetType |deps#0@@17|) |e#2@@3|) (|M3.__default.Oracle#canCall| (M3.__default.Loc (Lit SeqType |cmd#0@@14|) (Lit SetType |deps#0@@17|) |e#2@@3|) (Lit DatatypeTypeType |st#0@@29|)))))))))
 :qid |CloudMakeParallelBuildsdfy.96:12|
 :skolemid |6598|
 :pattern ( (M3.__default.Loc |cmd#0@@14| |deps#0@@17| |e#2@@3|))
 :pattern ( (|Set#IsMember| |exps#0@@8| ($Box SeqType |e#2@@3|)))
)) (= (M3.__default.Post (Lit SeqType |cmd#0@@14|) (Lit SetType |deps#0@@17|) (Lit SetType |exps#0@@8|) (Lit DatatypeTypeType |st#0@@29|)) (forall ((|e#2@@4| T@U) ) (!  (=> ($Is SeqType |e#2@@4| (TSeq TChar)) (and (=> (|Set#IsMember| (Lit SetType |exps#0@@8|) ($Box SeqType |e#2@@4|)) (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@29|))) ($Box DatatypeTypeType (M3.__default.Loc (Lit SeqType |cmd#0@@14|) (Lit SetType |deps#0@@17|) |e#2@@4|)))) (=> (|Set#IsMember| (Lit SetType |exps#0@@8|) ($Box SeqType |e#2@@4|)) (|M3.Artifact#Equal| (M3.__default.GetSt (M3.__default.Loc (Lit SeqType |cmd#0@@14|) (Lit SetType |deps#0@@17|) |e#2@@4|) (Lit DatatypeTypeType |st#0@@29|)) (M3.__default.Oracle (M3.__default.Loc (Lit SeqType |cmd#0@@14|) (Lit SetType |deps#0@@17|) |e#2@@4|) (Lit DatatypeTypeType |st#0@@29|))))))
 :qid |CloudMakeParallelBuildsdfy.96:12|
 :skolemid |6597|
 :pattern ( (M3.__default.Loc |cmd#0@@14| |deps#0@@17| |e#2@@4|))
 :pattern ( (|Set#IsMember| |exps#0@@8| ($Box SeqType |e#2@@4|)))
)))))
 :qid |CloudMakeParallelBuildsdfy.94:24|
 :weight 3
 :skolemid |6599|
 :pattern ( (M3.__default.Post (Lit SeqType |cmd#0@@14|) (Lit SetType |deps#0@@17|) (Lit SetType |exps#0@@8|) (Lit DatatypeTypeType |st#0@@29|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|cmd#0@@15| T@U) (|deps#0@@18| T@U) (|exp#0@@5| T@U) ) (!  (=> (or (|M3.__default.Loc#canCall| (Lit SeqType |cmd#0@@15|) (Lit SetType |deps#0@@18|) (Lit SeqType |exp#0@@5|)) (and (< 1 $FunctionContextHeight) (and (and ($Is SeqType |cmd#0@@15| (TSeq TChar)) ($Is SetType |deps#0@@18| (TSet Tclass.M3.Path))) ($Is SeqType |exp#0@@5| (TSeq TChar))))) (= (M3.__default.Loc (Lit SeqType |cmd#0@@15|) (Lit SetType |deps#0@@18|) (Lit SeqType |exp#0@@5|)) (Lit DatatypeTypeType (|#M3.Path.InternalPath| (Lit SeqType |cmd#0@@15|) (Lit SetType |deps#0@@18|) (Lit SeqType |exp#0@@5|)))))
 :qid |CloudMakeParallelBuildsdfy.154:22|
 :weight 3
 :skolemid |5682|
 :pattern ( (M3.__default.Loc (Lit SeqType |cmd#0@@15|) (Lit SetType |deps#0@@18|) (Lit SeqType |exp#0@@5|)))
))))
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|cmd#0@@16| T@U) (|deps#0@@19| T@U) (|exps#0@@9| T@U) (|st#0@@30| T@U) ) (!  (=> (or (|M3.__default.exec#canCall| |cmd#0@@16| |deps#0@@19| |exps#0@@9| |st#0@@30|) (and (< 5 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@16| (TSeq TChar)) ($Is SetType |deps#0@@19| (TSet Tclass.M3.Path))) ($Is SetType |exps#0@@9| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@30| Tclass.M3.State)))) (and (and (|M3.__default.Restrict#canCall| |deps#0@@19| |st#0@@30|) (|M3.__default.execOne#canCall| |cmd#0@@16| |deps#0@@19| (M3.__default.Restrict |deps#0@@19| |st#0@@30|) |exps#0@@9| |st#0@@30|)) (= (M3.__default.exec |cmd#0@@16| |deps#0@@19| |exps#0@@9| |st#0@@30|) (M3.__default.execOne ($LS $LZ) |cmd#0@@16| |deps#0@@19| (M3.__default.Restrict |deps#0@@19| |st#0@@30|) |exps#0@@9| |st#0@@30|))))
 :qid |CloudMakeParallelBuildsdfy.69:23|
 :skolemid |5821|
 :pattern ( (M3.__default.exec |cmd#0@@16| |deps#0@@19| |exps#0@@9| |st#0@@30|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|p#0@@36| T@U) (|a#0@@2| T@U) (|st#0@@31| T@U) ) (!  (=> (or (|M3.__default.SetSt#canCall| (Lit DatatypeTypeType |p#0@@36|) (Lit DatatypeTypeType |a#0@@2|) (Lit DatatypeTypeType |st#0@@31|)) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |p#0@@36| Tclass.M3.Path) ($Is DatatypeTypeType |a#0@@2| Tclass.M3.Artifact)) ($Is DatatypeTypeType |st#0@@31| Tclass.M3.State)))) (and (M3.State.StateCons_q (Lit DatatypeTypeType |st#0@@31|)) (= (M3.__default.SetSt (Lit DatatypeTypeType |p#0@@36|) (Lit DatatypeTypeType |a#0@@2|) (Lit DatatypeTypeType |st#0@@31|)) (|#M3.State.StateCons| (|Map#Build| (Lit MapType (M3.State.m (Lit DatatypeTypeType |st#0@@31|))) ($Box DatatypeTypeType (Lit DatatypeTypeType |p#0@@36|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |a#0@@2|)))))))
 :qid |CloudMakeParallelBuildsdfy.468:24|
 :weight 3
 :skolemid |5731|
 :pattern ( (M3.__default.SetSt (Lit DatatypeTypeType |p#0@@36|) (Lit DatatypeTypeType |a#0@@2|) (Lit DatatypeTypeType |st#0@@31|)))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall ((|cmd#0@@17| T@U) (|deps#0@@20| T@U) (|exps#0@@10| T@U) (|st#0@@32| T@U) ) (!  (=> (or (|M3.__default.Post#canCall| |cmd#0@@17| |deps#0@@20| |exps#0@@10| |st#0@@32|) (and (< 6 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@17| (TSeq TChar)) ($Is SetType |deps#0@@20| (TSet Tclass.M3.Path))) ($Is SetType |exps#0@@10| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@32| Tclass.M3.State)))) (and (forall ((|e#0@@5| T@U) ) (!  (=> ($Is SeqType |e#0@@5| (TSeq TChar)) (and (=> (|Set#IsMember| |exps#0@@10| ($Box SeqType |e#0@@5|)) (and (|M3.__default.Loc#canCall| |cmd#0@@17| |deps#0@@20| |e#0@@5|) (|M3.__default.DomSt#canCall| |st#0@@32|))) (=> (=> (|Set#IsMember| |exps#0@@10| ($Box SeqType |e#0@@5|)) (|Set#IsMember| (M3.__default.DomSt |st#0@@32|) ($Box DatatypeTypeType (M3.__default.Loc |cmd#0@@17| |deps#0@@20| |e#0@@5|)))) (=> (|Set#IsMember| |exps#0@@10| ($Box SeqType |e#0@@5|)) (and (and (|$IsA#M3.Artifact| (M3.__default.GetSt (M3.__default.Loc |cmd#0@@17| |deps#0@@20| |e#0@@5|) |st#0@@32|)) (|$IsA#M3.Artifact| (M3.__default.Oracle (M3.__default.Loc |cmd#0@@17| |deps#0@@20| |e#0@@5|) |st#0@@32|))) (and (and (|M3.__default.Loc#canCall| |cmd#0@@17| |deps#0@@20| |e#0@@5|) (|M3.__default.GetSt#canCall| (M3.__default.Loc |cmd#0@@17| |deps#0@@20| |e#0@@5|) |st#0@@32|)) (and (|M3.__default.Loc#canCall| |cmd#0@@17| |deps#0@@20| |e#0@@5|) (|M3.__default.Oracle#canCall| (M3.__default.Loc |cmd#0@@17| |deps#0@@20| |e#0@@5|) |st#0@@32|))))))))
 :qid |CloudMakeParallelBuildsdfy.96:12|
 :skolemid |6592|
 :pattern ( (M3.__default.Loc |cmd#0@@17| |deps#0@@20| |e#0@@5|))
 :pattern ( (|Set#IsMember| |exps#0@@10| ($Box SeqType |e#0@@5|)))
)) (= (M3.__default.Post |cmd#0@@17| |deps#0@@20| |exps#0@@10| |st#0@@32|) (forall ((|e#0@@6| T@U) ) (!  (=> ($Is SeqType |e#0@@6| (TSeq TChar)) (and (=> (|Set#IsMember| |exps#0@@10| ($Box SeqType |e#0@@6|)) (|Set#IsMember| (M3.__default.DomSt |st#0@@32|) ($Box DatatypeTypeType (M3.__default.Loc |cmd#0@@17| |deps#0@@20| |e#0@@6|)))) (=> (|Set#IsMember| |exps#0@@10| ($Box SeqType |e#0@@6|)) (|M3.Artifact#Equal| (M3.__default.GetSt (M3.__default.Loc |cmd#0@@17| |deps#0@@20| |e#0@@6|) |st#0@@32|) (M3.__default.Oracle (M3.__default.Loc |cmd#0@@17| |deps#0@@20| |e#0@@6|) |st#0@@32|)))))
 :qid |CloudMakeParallelBuildsdfy.96:12|
 :skolemid |6591|
 :pattern ( (M3.__default.Loc |cmd#0@@17| |deps#0@@20| |e#0@@6|))
 :pattern ( (|Set#IsMember| |exps#0@@10| ($Box SeqType |e#0@@6|)))
)))))
 :qid |CloudMakeParallelBuildsdfy.94:24|
 :skolemid |6593|
 :pattern ( (M3.__default.Post |cmd#0@@17| |deps#0@@20| |exps#0@@10| |st#0@@32|))
))))
(assert  (=> (<= 6 $FunctionContextHeight) (forall ((|st#0@@33| T@U) (|st'#0@@1| T@U) ) (!  (=> (or (|M3.__default.Extends#canCall| |st#0@@33| |st'#0@@1|) (and (< 6 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@33| Tclass.M3.State) ($Is DatatypeTypeType |st'#0@@1| Tclass.M3.State)))) (and (and (and (|M3.__default.DomSt#canCall| |st#0@@33|) (|M3.__default.DomSt#canCall| |st'#0@@1|)) (=> (|Set#Subset| (M3.__default.DomSt |st#0@@33|) (M3.__default.DomSt |st'#0@@1|)) (and (forall ((|p#0@@37| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@37| Tclass.M3.Path) (and (|M3.__default.DomSt#canCall| |st#0@@33|) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@33|) ($Box DatatypeTypeType |p#0@@37|)) (and (and (|$IsA#M3.Artifact| (M3.__default.GetSt |p#0@@37| |st'#0@@1|)) (|$IsA#M3.Artifact| (M3.__default.GetSt |p#0@@37| |st#0@@33|))) (and (|M3.__default.GetSt#canCall| |p#0@@37| |st'#0@@1|) (|M3.__default.GetSt#canCall| |p#0@@37| |st#0@@33|))))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6613|
 :pattern ( (M3.__default.GetSt |p#0@@37| |st#0@@33|))
 :pattern ( (M3.__default.GetSt |p#0@@37| |st'#0@@1|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@33|) ($Box DatatypeTypeType |p#0@@37|)))
)) (=> (forall ((|p#0@@38| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@38| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@33|) ($Box DatatypeTypeType |p#0@@38|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#0@@38| |st'#0@@1|) (M3.__default.GetSt |p#0@@38| |st#0@@33|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6615|
 :pattern ( (M3.__default.GetSt |p#0@@38| |st#0@@33|))
 :pattern ( (M3.__default.GetSt |p#0@@38| |st'#0@@1|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@33|) ($Box DatatypeTypeType |p#0@@38|)))
)) (forall ((|p#1@@3| T@U) ) (!  (=> ($Is DatatypeTypeType |p#1@@3| Tclass.M3.Path) (and (|M3.__default.DomSt#canCall| |st#0@@33|) (=> (not (|Set#IsMember| (M3.__default.DomSt |st#0@@33|) ($Box DatatypeTypeType |p#1@@3|))) (and (|M3.__default.DomSt#canCall| |st'#0@@1|) (=> (|Set#IsMember| (M3.__default.DomSt |st'#0@@1|) ($Box DatatypeTypeType |p#1@@3|)) (and (and (|$IsA#M3.Artifact| (M3.__default.GetSt |p#1@@3| |st'#0@@1|)) (|$IsA#M3.Artifact| (M3.__default.Oracle |p#1@@3| |st#0@@33|))) (and (|M3.__default.GetSt#canCall| |p#1@@3| |st'#0@@1|) (|M3.__default.Oracle#canCall| |p#1@@3| |st#0@@33|))))))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |6614|
 :pattern ( (M3.__default.Oracle |p#1@@3| |st#0@@33|))
 :pattern ( (M3.__default.GetSt |p#1@@3| |st'#0@@1|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@1|) ($Box DatatypeTypeType |p#1@@3|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@33|) ($Box DatatypeTypeType |p#1@@3|)))
)))))) (= (M3.__default.Extends |st#0@@33| |st'#0@@1|)  (and (and (|Set#Subset| (M3.__default.DomSt |st#0@@33|) (M3.__default.DomSt |st'#0@@1|)) (forall ((|p#0@@39| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@39| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@33|) ($Box DatatypeTypeType |p#0@@39|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#0@@39| |st'#0@@1|) (M3.__default.GetSt |p#0@@39| |st#0@@33|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6611|
 :pattern ( (M3.__default.GetSt |p#0@@39| |st#0@@33|))
 :pattern ( (M3.__default.GetSt |p#0@@39| |st'#0@@1|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@33|) ($Box DatatypeTypeType |p#0@@39|)))
))) (forall ((|p#1@@4| T@U) ) (!  (=> ($Is DatatypeTypeType |p#1@@4| Tclass.M3.Path) (=> (and (not (|Set#IsMember| (M3.__default.DomSt |st#0@@33|) ($Box DatatypeTypeType |p#1@@4|))) (|Set#IsMember| (M3.__default.DomSt |st'#0@@1|) ($Box DatatypeTypeType |p#1@@4|))) (|M3.Artifact#Equal| (M3.__default.GetSt |p#1@@4| |st'#0@@1|) (M3.__default.Oracle |p#1@@4| |st#0@@33|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |6612|
 :pattern ( (M3.__default.Oracle |p#1@@4| |st#0@@33|))
 :pattern ( (M3.__default.GetSt |p#1@@4| |st'#0@@1|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@1|) ($Box DatatypeTypeType |p#1@@4|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@33|) ($Box DatatypeTypeType |p#1@@4|)))
))))))
 :qid |CloudMakeParallelBuildsdfy.112:27|
 :skolemid |6616|
 :pattern ( (M3.__default.Extends |st#0@@33| |st'#0@@1|))
))))
...
(assert (forall (($ly@@12 T@U) (|cmd#0@@18| T@U) (|deps#0@@21| T@U) (|restrictedState#0@@2| T@U) (|exps#0@@11| T@U) (|st#0@@34| T@U) ) (! (= (M3.__default.execOne ($LS $ly@@12) |cmd#0@@18| |deps#0@@21| |restrictedState#0@@2| |exps#0@@11| |st#0@@34|) (M3.__default.execOne $ly@@12 |cmd#0@@18| |deps#0@@21| |restrictedState#0@@2| |exps#0@@11| |st#0@@34|))
 :qid |CloudMakeParallelBuildsdfy.513:18|
 :skolemid |5826|
 :pattern ( (M3.__default.execOne ($LS $ly@@12) |cmd#0@@18| |deps#0@@21| |restrictedState#0@@2| |exps#0@@11| |st#0@@34|))
)))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall ((|cmd#0@@19| T@U) (|deps#0@@22| T@U) (|exps#0@@12| T@U) (|st#0@@35| T@U) ) (!  (=> (or (|M3.__default.Post#canCall| (Lit SeqType |cmd#0@@19|) (Lit SetType |deps#0@@22|) (Lit SetType |exps#0@@12|) |st#0@@35|) (and (< 6 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@19| (TSeq TChar)) ($Is SetType |deps#0@@22| (TSet Tclass.M3.Path))) ($Is SetType |exps#0@@12| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@35| Tclass.M3.State)))) (and (forall ((|e#1@@3| T@U) ) (!  (=> ($Is SeqType |e#1@@3| (TSeq TChar)) (and (=> (|Set#IsMember| (Lit SetType |exps#0@@12|) ($Box SeqType |e#1@@3|)) (and (|M3.__default.Loc#canCall| (Lit SeqType |cmd#0@@19|) (Lit SetType |deps#0@@22|) |e#1@@3|) (|M3.__default.DomSt#canCall| |st#0@@35|))) (=> (=> (|Set#IsMember| (Lit SetType |exps#0@@12|) ($Box SeqType |e#1@@3|)) (|Set#IsMember| (M3.__default.DomSt |st#0@@35|) ($Box DatatypeTypeType (M3.__default.Loc (Lit SeqType |cmd#0@@19|) (Lit SetType |deps#0@@22|) |e#1@@3|)))) (=> (|Set#IsMember| (Lit SetType |exps#0@@12|) ($Box SeqType |e#1@@3|)) (and (and (|$IsA#M3.Artifact| (M3.__default.GetSt (M3.__default.Loc (Lit SeqType |cmd#0@@19|) (Lit SetType |deps#0@@22|) |e#1@@3|) |st#0@@35|)) (|$IsA#M3.Artifact| (M3.__default.Oracle (M3.__default.Loc (Lit SeqType |cmd#0@@19|) (Lit SetType |deps#0@@22|) |e#1@@3|) |st#0@@35|))) (and (and (|M3.__default.Loc#canCall| (Lit SeqType |cmd#0@@19|) (Lit SetType |deps#0@@22|) |e#1@@3|) (|M3.__default.GetSt#canCall| (M3.__default.Loc (Lit SeqType |cmd#0@@19|) (Lit SetType |deps#0@@22|) |e#1@@3|) |st#0@@35|)) (and (|M3.__default.Loc#canCall| (Lit SeqType |cmd#0@@19|) (Lit SetType |deps#0@@22|) |e#1@@3|) (|M3.__default.Oracle#canCall| (M3.__default.Loc (Lit SeqType |cmd#0@@19|) (Lit SetType |deps#0@@22|) |e#1@@3|) |st#0@@35|))))))))
 :qid |CloudMakeParallelBuildsdfy.96:12|
 :skolemid |6595|
 :pattern ( (M3.__default.Loc |cmd#0@@19| |deps#0@@22| |e#1@@3|))
 :pattern ( (|Set#IsMember| |exps#0@@12| ($Box SeqType |e#1@@3|)))
)) (= (M3.__default.Post (Lit SeqType |cmd#0@@19|) (Lit SetType |deps#0@@22|) (Lit SetType |exps#0@@12|) |st#0@@35|) (forall ((|e#1@@4| T@U) ) (!  (=> ($Is SeqType |e#1@@4| (TSeq TChar)) (and (=> (|Set#IsMember| (Lit SetType |exps#0@@12|) ($Box SeqType |e#1@@4|)) (|Set#IsMember| (M3.__default.DomSt |st#0@@35|) ($Box DatatypeTypeType (M3.__default.Loc (Lit SeqType |cmd#0@@19|) (Lit SetType |deps#0@@22|) |e#1@@4|)))) (=> (|Set#IsMember| (Lit SetType |exps#0@@12|) ($Box SeqType |e#1@@4|)) (|M3.Artifact#Equal| (M3.__default.GetSt (M3.__default.Loc (Lit SeqType |cmd#0@@19|) (Lit SetType |deps#0@@22|) |e#1@@4|) |st#0@@35|) (M3.__default.Oracle (M3.__default.Loc (Lit SeqType |cmd#0@@19|) (Lit SetType |deps#0@@22|) |e#1@@4|) |st#0@@35|)))))
 :qid |CloudMakeParallelBuildsdfy.96:12|
 :skolemid |6594|
 :pattern ( (M3.__default.Loc |cmd#0@@19| |deps#0@@22| |e#1@@4|))
 :pattern ( (|Set#IsMember| |exps#0@@12| ($Box SeqType |e#1@@4|)))
)))))
 :qid |CloudMakeParallelBuildsdfy.94:24|
 :weight 3
 :skolemid |6596|
 :pattern ( (M3.__default.Post (Lit SeqType |cmd#0@@19|) (Lit SetType |deps#0@@22|) (Lit SetType |exps#0@@12|) |st#0@@35|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|p#0@@41| T@U) (|st#0@@36| T@U) ) (!  (=> (or (|M3.__default.GetSt#canCall| |p#0@@41| (Lit DatatypeTypeType |st#0@@36|)) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |p#0@@41| Tclass.M3.Path) ($Is DatatypeTypeType |st#0@@36| Tclass.M3.State)) (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@36|))) ($Box DatatypeTypeType |p#0@@41|))))) (and (M3.State.StateCons_q (Lit DatatypeTypeType |st#0@@36|)) (= (M3.__default.GetSt |p#0@@41| (Lit DatatypeTypeType |st#0@@36|)) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType (M3.State.m (Lit DatatypeTypeType |st#0@@36|)))) ($Box DatatypeTypeType |p#0@@41|))))))
 :qid |CloudMakeParallelBuildsdfy.10:24|
 :weight 3
 :skolemid |6472|
 :pattern ( (M3.__default.GetSt |p#0@@41| (Lit DatatypeTypeType |st#0@@36|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@13 T@U) (|p#0@@42| T@U) (|cert#0@@11| T@U) (|deps#0@@23| T@U) (|st#0@@37| T@U) ) (!  (=> (or (|M3.__default.CollectDependencies#canCall| |p#0@@42| |cert#0@@11| |deps#0@@23| |st#0@@37|) (and (< 4 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |p#0@@42| Tclass.M3.Path) ($Is DatatypeTypeType |cert#0@@11| Tclass.M3.WFCertificate)) ($Is SetType |deps#0@@23| (TSet Tclass.M3.Path))) ($Is DatatypeTypeType |st#0@@37| Tclass.M3.State)) (and (M3.__default.CheckWellFounded ($LS $LZ) |p#0@@42| |cert#0@@11|) (|Set#Equal| |deps#0@@23| (M3.__default.LocInv__Deps |p#0@@42|)))))) ($Is MapType (M3.__default.CollectDependencies $ly@@13 |p#0@@42| |cert#0@@11| |deps#0@@23| |st#0@@37|) (TMap Tclass.M3.Path Tclass.M3.Artifact)))
 :qid |CloudMakeParallelBuildsdfy.660:18|
 :skolemid |6080|
 :pattern ( (M3.__default.CollectDependencies $ly@@13 |p#0@@42| |cert#0@@11| |deps#0@@23| |st#0@@37|))
))))
...
(assert (forall (($ly@@14 T@U) (|p#0@@43| T@U) (|cert#0@@12| T@U) (|st#0@@38| T@U) ) (! (= (M3.__default.OracleWF ($LS $ly@@14) |p#0@@43| |cert#0@@12| |st#0@@38|) (M3.__default.OracleWF $ly@@14 |p#0@@43| |cert#0@@12| |st#0@@38|))
 :qid |CloudMakeParallelBuildsdfy.653:18|
 :skolemid |6058|
 :pattern ( (M3.__default.OracleWF ($LS $ly@@14) |p#0@@43| |cert#0@@12| |st#0@@38|))
)))
(assert  (=> |$let#10$canCall| (and ($Is SetType |$let#10_deps| (TSet Tclass.M3.Path)) (U_2_bool (Lit boolType (bool_2_U true))))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@11 T@U) (|cmd#0@@20| T@U) (|deps#0@@24| T@U) (|exp#0@@6| T@U) ) (!  (=> (or (|M3.__default.RunTool#canCall| |cmd#0@@20| |deps#0@@24| |exp#0@@6|) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@11) ($Is SeqType |cmd#0@@20| (TSeq TChar))) ($Is MapType |deps#0@@24| (TMap Tclass.M3.Path Tclass.M3.Artifact))) ($Is SeqType |exp#0@@6| (TSeq TChar))))) (and |$let#0$canCall| (= (M3.__default.RunTool |cmd#0@@20| |deps#0@@24| |exp#0@@6|) (let ((|a#0@@3| |$let#0_a|))
|a#0@@3|))))
 :qid |CloudMakeParallelBuildsdfy.773:18|
 :skolemid |5673|
 :pattern ( (M3.__default.RunTool |cmd#0@@20| |deps#0@@24| |exp#0@@6|) ($IsGoodHeap $Heap@@11))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|cmd#0@@21| T@U) (|deps#0@@25| T@U) (|exps#0@@13| T@U) (|paths#0@@3| T@U) ) (!  (=> (or (|M3.__default.OneToOne#canCall| (Lit SeqType |cmd#0@@21|) (Lit SetType |deps#0@@25|) (Lit SetType |exps#0@@13|) (Lit SetType |paths#0@@3|)) (and (< 2 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@21| (TSeq TChar)) ($Is SetType |deps#0@@25| (TSet Tclass.M3.Path))) ($Is SetType |exps#0@@13| (TSet (TSeq TChar)))) ($Is SetType |paths#0@@3| (TSet Tclass.M3.Path))))) (and (forall ((|e#1@@5| T@U) ) (!  (=> ($Is SeqType |e#1@@5| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@13|) ($Box SeqType |e#1@@5|)) (|M3.__default.Loc#canCall| (Lit SeqType |cmd#0@@21|) (Lit SetType |deps#0@@25|) |e#1@@5|)))
 :qid |CloudMakeParallelBuildsdfy.91:12|
 :skolemid |6583|
 :pattern ( (M3.__default.Loc |cmd#0@@21| |deps#0@@25| |e#1@@5|))
 :pattern ( (|Set#IsMember| |exps#0@@13| ($Box SeqType |e#1@@5|)))
)) (= (M3.__default.OneToOne (Lit SeqType |cmd#0@@21|) (Lit SetType |deps#0@@25|) (Lit SetType |exps#0@@13|) (Lit SetType |paths#0@@3|)) (forall ((|e#1@@6| T@U) ) (!  (=> ($Is SeqType |e#1@@6| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@13|) ($Box SeqType |e#1@@6|)) (|Set#IsMember| (Lit SetType |paths#0@@3|) ($Box DatatypeTypeType (M3.__default.Loc (Lit SeqType |cmd#0@@21|) (Lit SetType |deps#0@@25|) |e#1@@6|)))))
 :qid |CloudMakeParallelBuildsdfy.91:12|
 :skolemid |6582|
 :pattern ( (M3.__default.Loc |cmd#0@@21| |deps#0@@25| |e#1@@6|))
 :pattern ( (|Set#IsMember| |exps#0@@13| ($Box SeqType |e#1@@6|)))
)))))
 :qid |CloudMakeParallelBuildsdfy.89:28|
 :weight 3
 :skolemid |6584|
 :pattern ( (M3.__default.OneToOne (Lit SeqType |cmd#0@@21|) (Lit SetType |deps#0@@25|) (Lit SetType |exps#0@@13|) (Lit SetType |paths#0@@3|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@16 T@U) (|p#0@@48| T@U) (|cert#0@@14| T@U) (|deps#0@@26| T@U) (|st#0@@39| T@U) ) (!  (=> (or (|M3.__default.CollectDependencies#canCall| (Lit DatatypeTypeType |p#0@@48|) (Lit DatatypeTypeType |cert#0@@14|) (Lit SetType |deps#0@@26|) (Lit DatatypeTypeType |st#0@@39|)) (and (< 4 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |p#0@@48| Tclass.M3.Path) ($Is DatatypeTypeType |cert#0@@14| Tclass.M3.WFCertificate)) ($Is SetType |deps#0@@26| (TSet Tclass.M3.Path))) ($Is DatatypeTypeType |st#0@@39| Tclass.M3.State)) (and (M3.__default.CheckWellFounded ($LS $LZ) (Lit DatatypeTypeType |p#0@@48|) (Lit DatatypeTypeType |cert#0@@14|)) (|Set#Equal| |deps#0@@26| (M3.__default.LocInv__Deps (Lit DatatypeTypeType |p#0@@48|))))))) (and (forall ((|d#0@@7| T@U) ) (!  (=> ($Is DatatypeTypeType |d#0@@7| Tclass.M3.Path) (=> (|Set#IsMember| (Lit SetType |deps#0@@26|) ($Box DatatypeTypeType |d#0@@7|)) (and (and (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@39|)) (=> (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@39|))) ($Box DatatypeTypeType |d#0@@7|)) (|M3.__default.GetSt#canCall| |d#0@@7| (Lit DatatypeTypeType |st#0@@39|)))) (=> (not (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@39|))) ($Box DatatypeTypeType |d#0@@7|))) (and (and (M3.WFCertificate.Cert_q (Lit DatatypeTypeType |cert#0@@14|)) (|M3.__default.FindCert#canCall| |d#0@@7| (Lit SetType (M3.WFCertificate.certs (Lit DatatypeTypeType |cert#0@@14|))))) (|M3.__default.OracleWF#canCall| |d#0@@7| (M3.__default.FindCert |d#0@@7| (Lit SetType (M3.WFCertificate.certs (Lit DatatypeTypeType |cert#0@@14|)))) (Lit DatatypeTypeType |st#0@@39|)))))))
 :qid |CloudMakeParallelBuildsdfy.664:9|
 :skolemid |6086|
 :pattern ( (M3.__default.FindCert |d#0@@7| (M3.WFCertificate.certs |cert#0@@14|)))
 :pattern ( (M3.__default.GetSt |d#0@@7| |st#0@@39|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@39|) ($Box DatatypeTypeType |d#0@@7|)))
 :pattern ( (|Set#IsMember| |deps#0@@26| ($Box DatatypeTypeType |d#0@@7|)))
)) (= (M3.__default.CollectDependencies ($LS $ly@@16) (Lit DatatypeTypeType |p#0@@48|) (Lit DatatypeTypeType |cert#0@@14|) (Lit SetType |deps#0@@26|) (Lit DatatypeTypeType |st#0@@39|)) (|Map#Glue| (|Set#FromBoogieMap| (|lambda#0| Tclass.M3.Path (Lit SetType |deps#0@@26|))) (|lambda#26| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@39|))) (Lit DatatypeTypeType |st#0@@39|) ($LS $ly@@16) (Lit SetType (M3.WFCertificate.certs (Lit DatatypeTypeType |cert#0@@14|))) (Lit DatatypeTypeType |st#0@@39|)) (TMap Tclass.M3.Path Tclass.M3.Artifact)))))
 :qid |CloudMakeParallelBuildsdfy.660:18|
 :weight 3
 :skolemid |6087|
 :pattern ( (M3.__default.CollectDependencies ($LS $ly@@16) (Lit DatatypeTypeType |p#0@@48|) (Lit DatatypeTypeType |cert#0@@14|) (Lit SetType |deps#0@@26|) (Lit DatatypeTypeType |st#0@@39|)))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|p#0@@49| T@U) (|st#0@@40| T@U) ) (!  (=> (or (|M3.__default.Oracle#canCall| (Lit DatatypeTypeType |p#0@@49|) (Lit DatatypeTypeType |st#0@@40|)) (and (< 5 $FunctionContextHeight) (and ($Is DatatypeTypeType |p#0@@49| Tclass.M3.Path) ($Is DatatypeTypeType |st#0@@40| Tclass.M3.State)))) (and (and (and (|M3.__default.WellFounded#canCall| (Lit DatatypeTypeType |p#0@@49|)) (=> (U_2_bool (Lit boolType (bool_2_U (M3.__default.WellFounded (Lit DatatypeTypeType |p#0@@49|))))) (and (|M3.__default.GetCert#canCall| (Lit DatatypeTypeType |p#0@@49|)) (|M3.__default.OracleWF#canCall| (Lit DatatypeTypeType |p#0@@49|) (Lit DatatypeTypeType (M3.__default.GetCert (Lit DatatypeTypeType |p#0@@49|))) (Lit DatatypeTypeType |st#0@@40|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M3.__default.WellFounded (Lit DatatypeTypeType |p#0@@49|)))))) (|M3.__default.OracleArbitrary#canCall| (Lit DatatypeTypeType |p#0@@49|)))) (= (M3.__default.Oracle (Lit DatatypeTypeType |p#0@@49|) (Lit DatatypeTypeType |st#0@@40|)) (ite (M3.__default.WellFounded (Lit DatatypeTypeType |p#0@@49|)) (M3.__default.OracleWF ($LS $LZ) (Lit DatatypeTypeType |p#0@@49|) (Lit DatatypeTypeType (M3.__default.GetCert (Lit DatatypeTypeType |p#0@@49|))) (Lit DatatypeTypeType |st#0@@40|)) (M3.__default.OracleArbitrary (Lit DatatypeTypeType |p#0@@49|))))))
 :qid |CloudMakeParallelBuildsdfy.104:25|
 :weight 3
 :skolemid |6039|
 :pattern ( (M3.__default.Oracle (Lit DatatypeTypeType |p#0@@49|) (Lit DatatypeTypeType |st#0@@40|)))
))))
...
(assert (forall ((a@@22 T@U) (b@@19 T@U) ) (! (= (|Set#Equal| a@@22 b@@19) (forall ((o@@5 T@U) ) (! (= (|Set#IsMember| a@@22 o@@5) (|Set#IsMember| b@@19 o@@5))
 :qid |DafnyPreludebpl.783:19|
 :skolemid |5103|
 :pattern ( (|Set#IsMember| a@@22 o@@5))
 :pattern ( (|Set#IsMember| b@@19 o@@5))
)))
 :qid |DafnyPreludebpl.780:15|
 :skolemid |5104|
 :pattern ( (|Set#Equal| a@@22 b@@19))
)))
(assert  (=> (<= 6 $FunctionContextHeight) (forall ((|st#0@@41| T@U) (|st'#0@@2| T@U) ) (!  (=> (or (|M3.__default.Extends#canCall| (Lit DatatypeTypeType |st#0@@41|) (Lit DatatypeTypeType |st'#0@@2|)) (and (< 6 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@41| Tclass.M3.State) ($Is DatatypeTypeType |st'#0@@2| Tclass.M3.State)))) (and (and (and (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@41|)) (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st'#0@@2|))) (=> (|Set#Subset| (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@41|)) (M3.__default.DomSt (Lit DatatypeTypeType |st'#0@@2|))) (and (forall ((|p#2| T@U) ) (!  (=> ($Is DatatypeTypeType |p#2| Tclass.M3.Path) (and (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@41|)) (=> (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@41|))) ($Box DatatypeTypeType |p#2|)) (and (and (|$IsA#M3.Artifact| (M3.__default.GetSt |p#2| (Lit DatatypeTypeType |st'#0@@2|))) (|$IsA#M3.Artifact| (M3.__default.GetSt |p#2| (Lit DatatypeTypeType |st#0@@41|)))) (and (|M3.__default.GetSt#canCall| |p#2| (Lit DatatypeTypeType |st'#0@@2|)) (|M3.__default.GetSt#canCall| |p#2| (Lit DatatypeTypeType |st#0@@41|)))))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6619|
 :pattern ( (M3.__default.GetSt |p#2| |st#0@@41|))
 :pattern ( (M3.__default.GetSt |p#2| |st'#0@@2|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@41|) ($Box DatatypeTypeType |p#2|)))
)) (=> (forall ((|p#2@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |p#2@@0| Tclass.M3.Path) (=> (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@41|))) ($Box DatatypeTypeType |p#2@@0|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#2@@0| (Lit DatatypeTypeType |st'#0@@2|)) (M3.__default.GetSt |p#2@@0| (Lit DatatypeTypeType |st#0@@41|)))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6621|
 :pattern ( (M3.__default.GetSt |p#2@@0| |st#0@@41|))
 :pattern ( (M3.__default.GetSt |p#2@@0| |st'#0@@2|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@41|) ($Box DatatypeTypeType |p#2@@0|)))
)) (forall ((|p#3| T@U) ) (!  (=> ($Is DatatypeTypeType |p#3| Tclass.M3.Path) (and (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@41|)) (=> (not (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@41|))) ($Box DatatypeTypeType |p#3|))) (and (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st'#0@@2|)) (=> (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st'#0@@2|))) ($Box DatatypeTypeType |p#3|)) (and (and (|$IsA#M3.Artifact| (M3.__default.GetSt |p#3| (Lit DatatypeTypeType |st'#0@@2|))) (|$IsA#M3.Artifact| (M3.__default.Oracle |p#3| (Lit DatatypeTypeType |st#0@@41|)))) (and (|M3.__default.GetSt#canCall| |p#3| (Lit DatatypeTypeType |st'#0@@2|)) (|M3.__default.Oracle#canCall| |p#3| (Lit DatatypeTypeType |st#0@@41|)))))))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |6620|
 :pattern ( (M3.__default.Oracle |p#3| |st#0@@41|))
 :pattern ( (M3.__default.GetSt |p#3| |st'#0@@2|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@2|) ($Box DatatypeTypeType |p#3|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@41|) ($Box DatatypeTypeType |p#3|)))
)))))) (= (M3.__default.Extends (Lit DatatypeTypeType |st#0@@41|) (Lit DatatypeTypeType |st'#0@@2|))  (and (and (|Set#Subset| (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@41|)) (M3.__default.DomSt (Lit DatatypeTypeType |st'#0@@2|))) (forall ((|p#2@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |p#2@@1| Tclass.M3.Path) (=> (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@41|))) ($Box DatatypeTypeType |p#2@@1|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#2@@1| (Lit DatatypeTypeType |st'#0@@2|)) (M3.__default.GetSt |p#2@@1| (Lit DatatypeTypeType |st#0@@41|)))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6617|
 :pattern ( (M3.__default.GetSt |p#2@@1| |st#0@@41|))
 :pattern ( (M3.__default.GetSt |p#2@@1| |st'#0@@2|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@41|) ($Box DatatypeTypeType |p#2@@1|)))
))) (forall ((|p#3@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |p#3@@0| Tclass.M3.Path) (=> (and (not (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@41|))) ($Box DatatypeTypeType |p#3@@0|))) (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st'#0@@2|))) ($Box DatatypeTypeType |p#3@@0|))) (|M3.Artifact#Equal| (M3.__default.GetSt |p#3@@0| (Lit DatatypeTypeType |st'#0@@2|)) (M3.__default.Oracle |p#3@@0| (Lit DatatypeTypeType |st#0@@41|)))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |6618|
 :pattern ( (M3.__default.Oracle |p#3@@0| |st#0@@41|))
 :pattern ( (M3.__default.GetSt |p#3@@0| |st'#0@@2|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@2|) ($Box DatatypeTypeType |p#3@@0|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@41|) ($Box DatatypeTypeType |p#3@@0|)))
))))))
 :qid |CloudMakeParallelBuildsdfy.112:27|
 :weight 3
 :skolemid |6622|
 :pattern ( (M3.__default.Extends (Lit DatatypeTypeType |st#0@@41|) (Lit DatatypeTypeType |st'#0@@2|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|p#0@@50| T@U) (|a#0@@4| T@U) (|st#0@@42| T@U) ) (!  (=> (or (|M3.__default.SetSt#canCall| |p#0@@50| |a#0@@4| |st#0@@42|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |p#0@@50| Tclass.M3.Path) ($Is DatatypeTypeType |a#0@@4| Tclass.M3.Artifact)) ($Is DatatypeTypeType |st#0@@42| Tclass.M3.State)))) (and (M3.State.StateCons_q |st#0@@42|) (= (M3.__default.SetSt |p#0@@50| |a#0@@4| |st#0@@42|) (|#M3.State.StateCons| (|Map#Build| (M3.State.m |st#0@@42|) ($Box DatatypeTypeType |p#0@@50|) ($Box DatatypeTypeType |a#0@@4|))))))
 :qid |CloudMakeParallelBuildsdfy.468:24|
 :skolemid |5729|
 :pattern ( (M3.__default.SetSt |p#0@@50| |a#0@@4| |st#0@@42|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|cmd#0@@22| T@U) (|deps#0@@27| T@U) (|exp#0@@7| T@U) ) (!  (=> (or (|M3.__default.Loc#canCall| |cmd#0@@22| |deps#0@@27| |exp#0@@7|) (and (< 1 $FunctionContextHeight) (and (and ($Is SeqType |cmd#0@@22| (TSeq TChar)) ($Is SetType |deps#0@@27| (TSet Tclass.M3.Path))) ($Is SeqType |exp#0@@7| (TSeq TChar))))) (= (M3.__default.Loc |cmd#0@@22| |deps#0@@27| |exp#0@@7|) (|#M3.Path.InternalPath| |cmd#0@@22| |deps#0@@27| |exp#0@@7|)))
 :qid |CloudMakeParallelBuildsdfy.154:22|
 :skolemid |5681|
 :pattern ( (M3.__default.Loc |cmd#0@@22| |deps#0@@27| |exp#0@@7|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|paths#0@@4| T@U) (|st#0@@43| T@U) ) (!  (=> (or (|M3.__default.Restrict#canCall| (Lit SetType |paths#0@@4|) (Lit DatatypeTypeType |st#0@@43|)) (and (< 4 $FunctionContextHeight) (and ($Is SetType |paths#0@@4| (TSet Tclass.M3.Path)) ($Is DatatypeTypeType |st#0@@43| Tclass.M3.State)))) (and (forall ((|p#0@@51| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@51| Tclass.M3.Path) (and (=> (|Set#IsMember| (Lit SetType |paths#0@@4|) ($Box DatatypeTypeType |p#0@@51|)) (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@43|))) (=> (and (|Set#IsMember| (Lit SetType |paths#0@@4|) ($Box DatatypeTypeType |p#0@@51|)) (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@43|))) ($Box DatatypeTypeType |p#0@@51|))) (|M3.__default.GetSt#canCall| |p#0@@51| (Lit DatatypeTypeType |st#0@@43|)))))
 :qid |CloudMakeParallelBuildsdfy.475:9|
 :skolemid |5736|
 :pattern ( (M3.__default.GetSt |p#0@@51| |st#0@@43|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@43|) ($Box DatatypeTypeType |p#0@@51|)))
 :pattern ( (|Set#IsMember| |paths#0@@4| ($Box DatatypeTypeType |p#0@@51|)))
)) (= (M3.__default.Restrict (Lit SetType |paths#0@@4|) (Lit DatatypeTypeType |st#0@@43|)) (|Map#Glue| (|Set#FromBoogieMap| (|lambda#16| Tclass.M3.Path (Lit SetType |paths#0@@4|) (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@43|))))) (|lambda#17| (Lit DatatypeTypeType |st#0@@43|)) (TMap Tclass.M3.Path Tclass.M3.Artifact)))))
 :qid |CloudMakeParallelBuildsdfy.473:27|
 :weight 3
 :skolemid |5737|
 :pattern ( (M3.__default.Restrict (Lit SetType |paths#0@@4|) (Lit DatatypeTypeType |st#0@@43|)))
))))
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|cmd#0@@23| T@U) (|deps#0@@28| T@U) (|exps#0@@14| T@U) (|st#0@@44| T@U) ) (!  (=> (or (|M3.__default.exec#canCall| (Lit SeqType |cmd#0@@23|) (Lit SetType |deps#0@@28|) (Lit SetType |exps#0@@14|) |st#0@@44|) (and (< 5 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@23| (TSeq TChar)) ($Is SetType |deps#0@@28| (TSet Tclass.M3.Path))) ($Is SetType |exps#0@@14| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@44| Tclass.M3.State)))) (and (and (|M3.__default.Restrict#canCall| (Lit SetType |deps#0@@28|) |st#0@@44|) (|M3.__default.execOne#canCall| (Lit SeqType |cmd#0@@23|) (Lit SetType |deps#0@@28|) (M3.__default.Restrict (Lit SetType |deps#0@@28|) |st#0@@44|) (Lit SetType |exps#0@@14|) |st#0@@44|)) (= (M3.__default.exec (Lit SeqType |cmd#0@@23|) (Lit SetType |deps#0@@28|) (Lit SetType |exps#0@@14|) |st#0@@44|) (M3.__default.execOne ($LS $LZ) (Lit SeqType |cmd#0@@23|) (Lit SetType |deps#0@@28|) (M3.__default.Restrict (Lit SetType |deps#0@@28|) |st#0@@44|) (Lit SetType |exps#0@@14|) |st#0@@44|))))
 :qid |CloudMakeParallelBuildsdfy.69:23|
 :weight 3
 :skolemid |5822|
 :pattern ( (M3.__default.exec (Lit SeqType |cmd#0@@23|) (Lit SetType |deps#0@@28|) (Lit SetType |exps#0@@14|) |st#0@@44|))
))))
...
(declare-fun |deps#0@@29| () T@U)
(declare-fun |st#0@@45| () T@U)
(declare-fun |restrictedState##0@0| () T@U)
(declare-fun |cmd#0@@24| () T@U)
(declare-fun |exps#0@@15| () T@U)
(declare-fun $Heap@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id Impl$$M3.__default.ExecProperty)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#4| null $Heap@@17 alloc false)) ($IsAlloc SetType |deps#0@@29| (TSet Tclass.M3.Path) $Heap@@17)) (=> (and (and ($IsAlloc DatatypeTypeType |st#0@@45| Tclass.M3.State $Heap@@17) (|M3.__default.Restrict#canCall| |deps#0@@29| |st#0@@45|)) (and (|M3.__default.Restrict#canCall| |deps#0@@29| |st#0@@45|) (= |restrictedState##0@0| (M3.__default.Restrict |deps#0@@29| |st#0@@45|)))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|M3.__default.ValidState#canCall| |st#0@@45|) (or (M3.__default.ValidState |st#0@@45|) (forall ((|p#0@@52| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@52| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@45|) ($Box DatatypeTypeType |p#0@@52|)) (M3.__default.WellFounded |p#0@@52|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |5867|
 :pattern ( (M3.__default.WellFounded |p#0@@52|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@45|) ($Box DatatypeTypeType |p#0@@52|)))
))))) (=> (=> (|M3.__default.ValidState#canCall| |st#0@@45|) (or (M3.__default.ValidState |st#0@@45|) (forall ((|p#0@@53| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@53| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@45|) ($Box DatatypeTypeType |p#0@@53|)) (M3.__default.WellFounded |p#0@@53|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |5867|
 :pattern ( (M3.__default.WellFounded |p#0@@53|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@45|) ($Box DatatypeTypeType |p#0@@53|)))
)))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (|Set#Subset| |deps#0@@29| (M3.__default.DomSt |st#0@@45|))) (=> (|Set#Subset| |deps#0@@29| (M3.__default.DomSt |st#0@@45|)) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|M3.__default.Pre#canCall| |cmd#0@@24| |deps#0@@29| |exps#0@@15| |st#0@@45|) (or (M3.__default.Pre |cmd#0@@24| |deps#0@@29| |exps#0@@15| |st#0@@45|) (forall ((|e#0@@7| T@U) ) (!  (=> ($Is SeqType |e#0@@7| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@15| ($Box SeqType |e#0@@7|)) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@45|) ($Box DatatypeTypeType (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#0@@7|))) (|M3.Artifact#Equal| (M3.__default.GetSt (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#0@@7|) |st#0@@45|) (M3.__default.Oracle (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#0@@7|) |st#0@@45|)))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |5869|
 :pattern ( (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#0@@7|))
 :pattern ( (|Set#IsMember| |exps#0@@15| ($Box SeqType |e#0@@7|)))
))))) (=> (=> (|M3.__default.Pre#canCall| |cmd#0@@24| |deps#0@@29| |exps#0@@15| |st#0@@45|) (or (M3.__default.Pre |cmd#0@@24| |deps#0@@29| |exps#0@@15| |st#0@@45|) (forall ((|e#0@@8| T@U) ) (!  (=> ($Is SeqType |e#0@@8| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@15| ($Box SeqType |e#0@@8|)) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@45|) ($Box DatatypeTypeType (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#0@@8|))) (|M3.Artifact#Equal| (M3.__default.GetSt (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#0@@8|) |st#0@@45|) (M3.__default.Oracle (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#0@@8|) |st#0@@45|)))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |5869|
 :pattern ( (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#0@@8|))
 :pattern ( (|Set#IsMember| |exps#0@@15| ($Box SeqType |e#0@@8|)))
)))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (|Map#Equal| |restrictedState##0@0| (M3.__default.Restrict |deps#0@@29| |st#0@@45|))) (=> (|Map#Equal| |restrictedState##0@0| (M3.__default.Restrict |deps#0@@29| |st#0@@45|)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (|M3.__default.execOne#canCall| |cmd#0@@24| |deps#0@@29| |restrictedState##0@0| |exps#0@@15| |st#0@@45|) (let ((|result''#0| (M3.__default.execOne ($LS $LZ) |cmd#0@@24| |deps#0@@29| |restrictedState##0@0| |exps#0@@15| |st#0@@45|)))
 (and (and (M3.Tuple.Pair_q |result''#0|) (M3.Tuple.Pair_q |result''#0|)) (let ((|st''#0| ($Unbox DatatypeTypeType (M3.Tuple.snd |result''#0|))))
(let ((|paths''#0| ($Unbox SetType (M3.Tuple.fst |result''#0|))))
 (and (|M3.__default.ValidState#canCall| |st''#0|) (=> (M3.__default.ValidState |st''#0|) (and (|M3.__default.Extends#canCall| |st#0@@45| |st''#0|) (=> (M3.__default.Extends |st#0@@45| |st''#0|) (and (|M3.__default.OneToOne#canCall| |cmd#0@@24| |deps#0@@29| |exps#0@@15| |paths''#0|) (=> (M3.__default.OneToOne |cmd#0@@24| |deps#0@@29| |exps#0@@15| |paths''#0|) (|M3.__default.Post#canCall| |cmd#0@@24| |deps#0@@29| |exps#0@@15| |st''#0|)))))))))))) (let ((|result''#0@@0| (M3.__default.execOne ($LS ($LS $LZ)) |cmd#0@@24| |deps#0@@29| |restrictedState##0@0| |exps#0@@15| |st#0@@45|)))
(let ((|st''#0@@0| ($Unbox DatatypeTypeType (M3.Tuple.snd |result''#0@@0|))))
 (and (|M3.__default.ValidState#canCall| |st''#0@@0|) (and (M3.__default.ValidState |st''#0@@0|) (forall ((|p#1@@5| T@U) ) (!  (=> ($Is DatatypeTypeType |p#1@@5| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st''#0@@0|) ($Box DatatypeTypeType |p#1@@5|)) (M3.__default.WellFounded |p#1@@5|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |5872|
 :pattern ( (M3.__default.WellFounded |p#1@@5|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st''#0@@0|) ($Box DatatypeTypeType |p#1@@5|)))
))))))) (and (and (let ((|result''#0@@1| (M3.__default.execOne ($LS ($LS $LZ)) |cmd#0@@24| |deps#0@@29| |restrictedState##0@0| |exps#0@@15| |st#0@@45|)))
(let ((|st''#0@@1| ($Unbox DatatypeTypeType (M3.Tuple.snd |result''#0@@1|))))
 (and (|M3.__default.Extends#canCall| |st#0@@45| |st''#0@@1|) (and (M3.__default.Extends |st#0@@45| |st''#0@@1|) (and (and (|Set#Subset| (M3.__default.DomSt |st#0@@45|) (M3.__default.DomSt |st''#0@@1|)) (forall ((|p#2@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |p#2@@2| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@45|) ($Box DatatypeTypeType |p#2@@2|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#2@@2| |st''#0@@1|) (M3.__default.GetSt |p#2@@2| |st#0@@45|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |5875|
 :pattern ( (M3.__default.GetSt |p#2@@2| |st#0@@45|))
 :pattern ( (M3.__default.GetSt |p#2@@2| |st''#0@@1|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@45|) ($Box DatatypeTypeType |p#2@@2|)))
))) (forall ((|p#3@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |p#3@@1| Tclass.M3.Path) (=> (and (not (|Set#IsMember| (M3.__default.DomSt |st#0@@45|) ($Box DatatypeTypeType |p#3@@1|))) (|Set#IsMember| (M3.__default.DomSt |st''#0@@1|) ($Box DatatypeTypeType |p#3@@1|))) (|M3.Artifact#Equal| (M3.__default.GetSt |p#3@@1| |st''#0@@1|) (M3.__default.Oracle |p#3@@1| |st#0@@45|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |5876|
 :pattern ( (M3.__default.Oracle |p#3@@1| |st#0@@45|))
 :pattern ( (M3.__default.GetSt |p#3@@1| |st''#0@@1|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st''#0@@1|) ($Box DatatypeTypeType |p#3@@1|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@45|) ($Box DatatypeTypeType |p#3@@1|)))
))))))) (let ((|result''#0@@2| (M3.__default.execOne ($LS ($LS $LZ)) |cmd#0@@24| |deps#0@@29| |restrictedState##0@0| |exps#0@@15| |st#0@@45|)))
(let ((|paths''#0@@0| ($Unbox SetType (M3.Tuple.fst |result''#0@@2|))))
 (and (|M3.__default.OneToOne#canCall| |cmd#0@@24| |deps#0@@29| |exps#0@@15| |paths''#0@@0|) (and (M3.__default.OneToOne |cmd#0@@24| |deps#0@@29| |exps#0@@15| |paths''#0@@0|) (forall ((|e#1@@7| T@U) ) (!  (=> ($Is SeqType |e#1@@7| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@15| ($Box SeqType |e#1@@7|)) (|Set#IsMember| |paths''#0@@0| ($Box DatatypeTypeType (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#1@@7|)))))
 :qid |CloudMakeParallelBuildsdfy.91:12|
 :skolemid |5878|
 :pattern ( (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#1@@7|))
 :pattern ( (|Set#IsMember| |exps#0@@15| ($Box SeqType |e#1@@7|)))
))))))) (and (let ((|result''#0@@3| (M3.__default.execOne ($LS ($LS $LZ)) |cmd#0@@24| |deps#0@@29| |restrictedState##0@0| |exps#0@@15| |st#0@@45|)))
(let ((|st''#0@@2| ($Unbox DatatypeTypeType (M3.Tuple.snd |result''#0@@3|))))
 (and (|M3.__default.Post#canCall| |cmd#0@@24| |deps#0@@29| |exps#0@@15| |st''#0@@2|) (and (M3.__default.Post |cmd#0@@24| |deps#0@@29| |exps#0@@15| |st''#0@@2|) (forall ((|e#2@@5| T@U) ) (!  (=> ($Is SeqType |e#2@@5| (TSeq TChar)) (and (=> (|Set#IsMember| |exps#0@@15| ($Box SeqType |e#2@@5|)) (|Set#IsMember| (M3.__default.DomSt |st''#0@@2|) ($Box DatatypeTypeType (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#2@@5|)))) (=> (|Set#IsMember| |exps#0@@15| ($Box SeqType |e#2@@5|)) (|M3.Artifact#Equal| (M3.__default.GetSt (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#2@@5|) |st''#0@@2|) (M3.__default.Oracle (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#2@@5|) |st''#0@@2|)))))
 :qid |CloudMakeParallelBuildsdfy.96:12|
 :skolemid |5880|
 :pattern ( (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#2@@5|))
 :pattern ( (|Set#IsMember| |exps#0@@15| ($Box SeqType |e#2@@5|)))
)))))) (= $Heap@@17 $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> false (let ((|st'#0@@3| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.exec |cmd#0@@24| |deps#0@@29| |exps#0@@15| |st#0@@45|)))))
 (=> (|M3.__default.ValidState#canCall| |st'#0@@3|) (or (M3.__default.ValidState |st'#0@@3|) (forall ((|p#5| T@U) ) (!  (=> ($Is DatatypeTypeType |p#5| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st'#0@@3|) ($Box DatatypeTypeType |p#5|)) (M3.__default.WellFounded |p#5|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |5856|
 :pattern ( (M3.__default.WellFounded |p#5|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@3|) ($Box DatatypeTypeType |p#5|)))
))))))) (=> (=> false (let ((|st'#0@@4| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.exec |cmd#0@@24| |deps#0@@29| |exps#0@@15| |st#0@@45|)))))
 (=> (|M3.__default.ValidState#canCall| |st'#0@@4|) (or (M3.__default.ValidState |st'#0@@4|) (forall ((|p#5@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |p#5@@0| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st'#0@@4|) ($Box DatatypeTypeType |p#5@@0|)) (M3.__default.WellFounded |p#5@@0|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |5856|
 :pattern ( (M3.__default.WellFounded |p#5@@0|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@4|) ($Box DatatypeTypeType |p#5@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> false (let ((|st'#0@@5| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.exec |cmd#0@@24| |deps#0@@29| |exps#0@@15| |st#0@@45|)))))
 (=> (|M3.__default.Extends#canCall| |st#0@@45| |st'#0@@5|) (or (M3.__default.Extends |st#0@@45| |st'#0@@5|) (|Set#Subset| (M3.__default.DomSt |st#0@@45|) (M3.__default.DomSt |st'#0@@5|))))))) (=> (=> false (let ((|st'#0@@6| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.exec |cmd#0@@24| |deps#0@@29| |exps#0@@15| |st#0@@45|)))))
 (=> (|M3.__default.Extends#canCall| |st#0@@45| |st'#0@@6|) (or (M3.__default.Extends |st#0@@45| |st'#0@@6|) (|Set#Subset| (M3.__default.DomSt |st#0@@45|) (M3.__default.DomSt |st'#0@@6|)))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> false (let ((|st'#0@@7| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.exec |cmd#0@@24| |deps#0@@29| |exps#0@@15| |st#0@@45|)))))
 (=> (|M3.__default.Extends#canCall| |st#0@@45| |st'#0@@7|) (or (M3.__default.Extends |st#0@@45| |st'#0@@7|) (forall ((|p#6| T@U) ) (!  (=> ($Is DatatypeTypeType |p#6| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@45|) ($Box DatatypeTypeType |p#6|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#6| |st'#0@@7|) (M3.__default.GetSt |p#6| |st#0@@45|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |5858|
 :pattern ( (M3.__default.GetSt |p#6| |st#0@@45|))
 :pattern ( (M3.__default.GetSt |p#6| |st'#0@@7|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@45|) ($Box DatatypeTypeType |p#6|)))
))))))) (=> (=> false (let ((|st'#0@@8| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.exec |cmd#0@@24| |deps#0@@29| |exps#0@@15| |st#0@@45|)))))
 (=> (|M3.__default.Extends#canCall| |st#0@@45| |st'#0@@8|) (or (M3.__default.Extends |st#0@@45| |st'#0@@8|) (forall ((|p#6@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |p#6@@0| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@45|) ($Box DatatypeTypeType |p#6@@0|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#6@@0| |st'#0@@8|) (M3.__default.GetSt |p#6@@0| |st#0@@45|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |5858|
 :pattern ( (M3.__default.GetSt |p#6@@0| |st#0@@45|))
 :pattern ( (M3.__default.GetSt |p#6@@0| |st'#0@@8|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@45|) ($Box DatatypeTypeType |p#6@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> false (let ((|st'#0@@9| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.exec |cmd#0@@24| |deps#0@@29| |exps#0@@15| |st#0@@45|)))))
 (=> (|M3.__default.Extends#canCall| |st#0@@45| |st'#0@@9|) (or (M3.__default.Extends |st#0@@45| |st'#0@@9|) (forall ((|p#7| T@U) ) (!  (=> ($Is DatatypeTypeType |p#7| Tclass.M3.Path) (=> (and (not (|Set#IsMember| (M3.__default.DomSt |st#0@@45|) ($Box DatatypeTypeType |p#7|))) (|Set#IsMember| (M3.__default.DomSt |st'#0@@9|) ($Box DatatypeTypeType |p#7|))) (|M3.Artifact#Equal| (M3.__default.GetSt |p#7| |st'#0@@9|) (M3.__default.Oracle |p#7| |st#0@@45|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |5859|
 :pattern ( (M3.__default.Oracle |p#7| |st#0@@45|))
 :pattern ( (M3.__default.GetSt |p#7| |st'#0@@9|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@9|) ($Box DatatypeTypeType |p#7|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@45|) ($Box DatatypeTypeType |p#7|)))
))))))) (=> (=> false (let ((|st'#0@@10| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.exec |cmd#0@@24| |deps#0@@29| |exps#0@@15| |st#0@@45|)))))
 (=> (|M3.__default.Extends#canCall| |st#0@@45| |st'#0@@10|) (or (M3.__default.Extends |st#0@@45| |st'#0@@10|) (forall ((|p#7@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |p#7@@0| Tclass.M3.Path) (=> (and (not (|Set#IsMember| (M3.__default.DomSt |st#0@@45|) ($Box DatatypeTypeType |p#7@@0|))) (|Set#IsMember| (M3.__default.DomSt |st'#0@@10|) ($Box DatatypeTypeType |p#7@@0|))) (|M3.Artifact#Equal| (M3.__default.GetSt |p#7@@0| |st'#0@@10|) (M3.__default.Oracle |p#7@@0| |st#0@@45|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |5859|
 :pattern ( (M3.__default.Oracle |p#7@@0| |st#0@@45|))
 :pattern ( (M3.__default.GetSt |p#7@@0| |st'#0@@10|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@10|) ($Box DatatypeTypeType |p#7@@0|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@45|) ($Box DatatypeTypeType |p#7@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> false (let ((|paths#0@@5| ($Unbox SetType (M3.Tuple.fst (M3.__default.exec |cmd#0@@24| |deps#0@@29| |exps#0@@15| |st#0@@45|)))))
 (=> (|M3.__default.OneToOne#canCall| |cmd#0@@24| |deps#0@@29| |exps#0@@15| |paths#0@@5|) (or (M3.__default.OneToOne |cmd#0@@24| |deps#0@@29| |exps#0@@15| |paths#0@@5|) (forall ((|e#4| T@U) ) (!  (=> ($Is SeqType |e#4| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@15| ($Box SeqType |e#4|)) (|Set#IsMember| |paths#0@@5| ($Box DatatypeTypeType (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#4|)))))
 :qid |CloudMakeParallelBuildsdfy.91:12|
 :skolemid |5862|
 :pattern ( (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#4|))
 :pattern ( (|Set#IsMember| |exps#0@@15| ($Box SeqType |e#4|)))
))))))) (=> (=> false (let ((|paths#0@@6| ($Unbox SetType (M3.Tuple.fst (M3.__default.exec |cmd#0@@24| |deps#0@@29| |exps#0@@15| |st#0@@45|)))))
 (=> (|M3.__default.OneToOne#canCall| |cmd#0@@24| |deps#0@@29| |exps#0@@15| |paths#0@@6|) (or (M3.__default.OneToOne |cmd#0@@24| |deps#0@@29| |exps#0@@15| |paths#0@@6|) (forall ((|e#4@@0| T@U) ) (!  (=> ($Is SeqType |e#4@@0| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@15| ($Box SeqType |e#4@@0|)) (|Set#IsMember| |paths#0@@6| ($Box DatatypeTypeType (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#4@@0|)))))
 :qid |CloudMakeParallelBuildsdfy.91:12|
 :skolemid |5862|
 :pattern ( (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#4@@0|))
 :pattern ( (|Set#IsMember| |exps#0@@15| ($Box SeqType |e#4@@0|)))
)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (let ((|st'#0@@11| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.exec |cmd#0@@24| |deps#0@@29| |exps#0@@15| |st#0@@45|)))))
 (=> (|M3.__default.Post#canCall| |cmd#0@@24| |deps#0@@29| |exps#0@@15| |st'#0@@11|) (or (M3.__default.Post |cmd#0@@24| |deps#0@@29| |exps#0@@15| |st'#0@@11|) (forall ((|e#5| T@U) ) (!  (=> ($Is SeqType |e#5| (TSeq TChar)) (and (=> (|Set#IsMember| |exps#0@@15| ($Box SeqType |e#5|)) (|Set#IsMember| (M3.__default.DomSt |st'#0@@11|) ($Box DatatypeTypeType (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#5|)))) (=> (|Set#IsMember| |exps#0@@15| ($Box SeqType |e#5|)) (|M3.Artifact#Equal| (M3.__default.GetSt (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#5|) |st'#0@@11|) (M3.__default.Oracle (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#5|) |st'#0@@11|)))))
 :qid |CloudMakeParallelBuildsdfy.96:12|
 :skolemid |5864|
 :pattern ( (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#5|))
 :pattern ( (|Set#IsMember| |exps#0@@15| ($Box SeqType |e#5|)))
)))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@17) ($IsHeapAnchor $Heap@@17)) (and ($Is SeqType |cmd#0@@24| (TSeq TChar)) ($IsAlloc SeqType |cmd#0@@24| (TSeq TChar) $Heap@@17))) (and (and ($Is SetType |deps#0@@29| (TSet Tclass.M3.Path)) ($IsAlloc SetType |deps#0@@29| (TSet Tclass.M3.Path) $Heap@@17)) (and ($Is SetType |exps#0@@15| (TSet (TSeq TChar))) ($IsAlloc SetType |exps#0@@15| (TSet (TSeq TChar)) $Heap@@17)))) (=> (and (and (and (and ($Is DatatypeTypeType |st#0@@45| Tclass.M3.State) ($IsAlloc DatatypeTypeType |st#0@@45| Tclass.M3.State $Heap@@17)) (|$IsA#M3.State| |st#0@@45|)) (= 11 $FunctionContextHeight)) (and (and (and (|M3.__default.ValidState#canCall| |st#0@@45|) (and (M3.__default.ValidState |st#0@@45|) (forall ((|p#4| T@U) ) (!  (=> ($Is DatatypeTypeType |p#4| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@45|) ($Box DatatypeTypeType |p#4|)) (M3.__default.WellFounded |p#4|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |5853|
 :pattern ( (M3.__default.WellFounded |p#4|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@45|) ($Box DatatypeTypeType |p#4|)))
)))) (|Set#Subset| |deps#0@@29| (M3.__default.DomSt |st#0@@45|))) (and (and (|M3.__default.Pre#canCall| |cmd#0@@24| |deps#0@@29| |exps#0@@15| |st#0@@45|) (and (M3.__default.Pre |cmd#0@@24| |deps#0@@29| |exps#0@@15| |st#0@@45|) (forall ((|e#3| T@U) ) (!  (=> ($Is SeqType |e#3| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@15| ($Box SeqType |e#3|)) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@45|) ($Box DatatypeTypeType (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#3|))) (|M3.Artifact#Equal| (M3.__default.GetSt (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#3|) |st#0@@45|) (M3.__default.Oracle (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#3|) |st#0@@45|)))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |5855|
 :pattern ( (M3.__default.Loc |cmd#0@@24| |deps#0@@29| |e#3|))
 :pattern ( (|Set#IsMember| |exps#0@@15| ($Box SeqType |e#3|)))
