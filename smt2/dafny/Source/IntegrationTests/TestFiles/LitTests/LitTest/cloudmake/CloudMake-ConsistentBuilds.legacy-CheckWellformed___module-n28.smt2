...
(declare-fun |arg#7@0| () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$_module.__default.evalArgsC_k)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon12_Else_correct  (=> (not (|Seq#Equal| |args#0@@11| |Seq#Empty|)) (and (=> (= (ControlFlow 0 4) (- 0 9)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |args#0@@11|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |args#0@@11|))) (=> (and (= |let#0#0#0| ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@11| (LitInt 0)))) ($Is DatatypeTypeType |let#0#0#0| Tclass._module.Expression)) (=> (and (and (= |arg#Z#0@0| |let#0#0#0|) ($IsAlloc DatatypeTypeType |arg#Z#0@0| Tclass._module.Expression $Heap@@3)) (and ($IsAlloc DatatypeTypeType |stC#0@@32| Tclass._module.StateC $Heap@@3) ($IsAllocBox |env#0@@15| Tclass._module.Env $Heap@@3))) (and (=> (= (ControlFlow 0 4) (- 0 8)) (< (DtRank |arg#Z#0@0|) (DtRank |expr#0@@16|))) (=> (< (DtRank |arg#Z#0@0|) (DtRank |expr#0@@16|)) (=> (|_module.__default.evalC#canCall| |arg#Z#0@0| |stC#0@@32| |env#0@@15|) (=> (and (and (and (and (_module.Tuple.Pair_q (_module.__default.evalC ($LS $LZ) |arg#Z#0@0| |stC#0@@32| |env#0@@15|)) (= |let#1#0#0| (_module.__default.evalC ($LS $LZ) |arg#Z#0@0| |stC#0@@32| |env#0@@15|))) (and (|_module.__default.evalC#canCall| |arg#Z#0@0| |stC#0@@32| |env#0@@15|) ($Is DatatypeTypeType |let#1#0#0| (Tclass._module.Tuple Tclass._module.Expression Tclass._module.StateC)))) (and (and (= |result#Z#0@0| |let#1#0#0|) (_module.Tuple.Pair_q |result#Z#0@0|)) (and (= |let#2#0#0| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#Z#0@0|))) (_module.Tuple.Pair_q |result#Z#0@0|)))) (and (and (and ($Is DatatypeTypeType |let#2#0#0| Tclass._module.Expression) (= |arg'#Z#0@0| |let#2#0#0|)) (and (_module.Tuple.Pair_q |result#Z#0@0|) (= |let#2#1#0| ($Unbox DatatypeTypeType (_module.Tuple.snd |result#Z#0@0|))))) (and (and (_module.Tuple.Pair_q |result#Z#0@0|) ($Is DatatypeTypeType |let#2#1#0| Tclass._module.StateC)) (and (= |stC'#Z#0@0| |let#2#1#0|) ($IsAlloc DatatypeTypeType |expr#0@@16| Tclass._module.Expression $Heap@@3))))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |args#0@@11|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |args#0@@11|))) (=> (and (and (and (= |##args#0@0| (|Seq#Drop| |args#0@@11| (LitInt 1))) ($IsAlloc SeqType |##args#0@0| (TSeq Tclass._module.Expression) $Heap@@3)) (and ($IsAlloc DatatypeTypeType |stC#0@@32| Tclass._module.StateC $Heap@@3) ($IsAllocBox |env#0@@15| Tclass._module.Env $Heap@@3))) (and (and (= |##args'#0@0| (|Seq#Append| |args'#0@@6| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |arg'#Z#0@0|)))) ($IsAlloc SeqType |##args'#0@0| (TSeq Tclass._module.Expression) $Heap@@3)) (and (= |##stsC'#0@0| (|Set#Union| |stsC'#0@@6| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |stC'#Z#0@0|)))) ($IsAlloc SetType |##stsC'#0@0| (TSet Tclass._module.StateC) $Heap@@3)))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (forall ((|arg#8| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#8| Tclass._module.Expression) (=> (|Seq#Contains| |##args#0@0| ($Box DatatypeTypeType |arg#8|)) (< (DtRank |arg#8|) (DtRank |expr#0@@16|))))
 :qid |CloudMakeConsistentBuildslegacydfy.485:19|
 :skolemid |1165|
 :pattern ( (|Seq#Contains| |##args#0@0| ($Box DatatypeTypeType |arg#8|)))
))) (=> (forall ((|arg#8@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#8@@0| Tclass._module.Expression) (=> (|Seq#Contains| |##args#0@0| ($Box DatatypeTypeType |arg#8@@0|)) (< (DtRank |arg#8@@0|) (DtRank |expr#0@@16|))))
 :qid |CloudMakeConsistentBuildslegacydfy.485:19|
 :skolemid |1166|
 :pattern ( (|Seq#Contains| |##args#0@0| ($Box DatatypeTypeType |arg#8@@0|)))
)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (or (<= 0 (|Seq#Length| |args#0@@11|)) (< (DtRank |expr#0@@16|) (DtRank |expr#0@@16|))) (= (|Seq#Length| |##args#0@0|) (|Seq#Length| |args#0@@11|)))) (=> (or (or (<= 0 (|Seq#Length| |args#0@@11|)) (< (DtRank |expr#0@@16|) (DtRank |expr#0@@16|))) (= (|Seq#Length| |##args#0@0|) (|Seq#Length| |args#0@@11|))) (=> (= (ControlFlow 0 4) (- 0 3)) (or (< (DtRank |expr#0@@16|) (DtRank |expr#0@@16|)) (and (= (DtRank |expr#0@@16|) (DtRank |expr#0@@16|)) (< (|Seq#Length| |##args#0@0|) (|Seq#Length| |args#0@@11|)))))))))))))))))))))))
(let ((anon12_Then_correct true))
(let ((anon11_Then_correct true))
(let ((anon4_correct  (=> (forall ((|arg#0@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#0@@1| Tclass._module.Expression) (=> (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#0@@1|)) (< (DtRank |arg#0@@1|) (DtRank |expr#0@@16|))))
 :qid |CloudMakeConsistentBuildslegacydfy.485:19|
 :skolemid |1163|
 :pattern ( (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#0@@1|)))
)) (and (and (=> (= (ControlFlow 0 10) 1) anon11_Then_correct) (=> (= (ControlFlow 0 10) 2) anon12_Then_correct)) (=> (= (ControlFlow 0 10) 4) anon12_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (=> (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#7@0|)) (< (DtRank |arg#7@0|) (DtRank |expr#0@@16|))) (= (ControlFlow 0 12) 10)) anon4_correct)))
(let ((anon10_Then_correct  (=> (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#7@0|)) (=> (and (< (DtRank |arg#7@0|) (DtRank |expr#0@@16|)) (= (ControlFlow 0 11) 10)) anon4_correct))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@3 alloc false)) (=> (and ($Is DatatypeTypeType |arg#7@0| Tclass._module.Expression) ($IsAlloc DatatypeTypeType |arg#7@0| Tclass._module.Expression $Heap@@3)) (and (=> (= (ControlFlow 0 13) 11) anon10_Then_correct) (=> (= (ControlFlow 0 13) 12) anon10_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and (and ($Is DatatypeTypeType |expr#0@@16| Tclass._module.Expression) ($Is SeqType |args#0@@11| (TSeq Tclass._module.Expression))) (and ($Is DatatypeTypeType |stC#0@@32| Tclass._module.StateC) ($IsBox |env#0@@15| Tclass._module.Env))) (and (and ($Is SeqType |args'#0@@6| (TSeq Tclass._module.Expression)) ($Is SetType |stsC'#0@@6| (TSet Tclass._module.StateC))) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 14) 13)))) anon0_correct))))
