...
(assert (distinct TChar TagChar TagSet TagSeq TagMap alloc |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass.M3.State Tagclass.M3.Path Tagclass.M3.Artifact Tagclass.M3.WFCertificate |##M3.Path.InternalPath| |##M3.Path.ExternalPath| |##M3.WFCertificate.Cert| |##M3.State.StateCons| |tytagFamily$_tuple#2| tytagFamily$State tytagFamily$Path tytagFamily$Artifact tytagFamily$WFCertificate)
)
...
(assert (forall ((d@@0 T@U) ) (!  (=> (|$IsA#M3.WFCertificate| d@@0) (M3.WFCertificate.Cert_q d@@0))
 :qid |unknown.0:0|
 :skolemid |6933|
 :pattern ( (|$IsA#M3.WFCertificate| d@@0))
)))
...
(assert (forall ((d@@3 T@U) ) (!  (=> ($Is DatatypeTypeType d@@3 Tclass.M3.WFCertificate) (M3.WFCertificate.Cert_q d@@3))
 :qid |unknown.0:0|
 :skolemid |6934|
 :pattern ( (M3.WFCertificate.Cert_q d@@3) ($Is DatatypeTypeType d@@3 Tclass.M3.WFCertificate))
)))
(assert (forall ((d@@4 T@U) ) (!  (=> ($Is DatatypeTypeType d@@4 Tclass.M3.State) (M3.State.StateCons_q d@@4))
 :qid |unknown.0:0|
 :skolemid |6949|
 :pattern ( (M3.State.StateCons_q d@@4) ($Is DatatypeTypeType d@@4 Tclass.M3.State))
)))
...
(assert (forall ((d@@6 T@U) ) (! (= (M3.Path.InternalPath_q d@@6) (= (DatatypeCtorId d@@6) |##M3.Path.InternalPath|))
 :qid |unknown.0:0|
 :skolemid |6873|
 :pattern ( (M3.Path.InternalPath_q d@@6))
)))
(assert (forall ((d@@7 T@U) ) (! (= (M3.Path.ExternalPath_q d@@7) (= (DatatypeCtorId d@@7) |##M3.Path.ExternalPath|))
 :qid |unknown.0:0|
 :skolemid |6890|
 :pattern ( (M3.Path.ExternalPath_q d@@7))
)))
(assert (forall ((d@@8 T@U) ) (! (= (M3.WFCertificate.Cert_q d@@8) (= (DatatypeCtorId d@@8) |##M3.WFCertificate.Cert|))
 :qid |unknown.0:0|
 :skolemid |6921|
 :pattern ( (M3.WFCertificate.Cert_q d@@8))
)))
(assert (forall ((d@@9 T@U) ) (! (= (M3.State.StateCons_q d@@9) (= (DatatypeCtorId d@@9) |##M3.State.StateCons|))
 :qid |unknown.0:0|
 :skolemid |6938|
 :pattern ( (M3.State.StateCons_q d@@9))
)))
...
(assert (forall ((d@@10 T@U) ) (!  (=> (M3.Path.InternalPath_q d@@10) (exists ((|a#11#0#0| T@U) (|a#11#1#0| T@U) (|a#11#2#0| T@U) ) (! (= d@@10 (|#M3.Path.InternalPath| |a#11#0#0| |a#11#1#0| |a#11#2#0|))
 :qid |CloudMakeParallelBuildsdfy.784:18|
 :skolemid |6874|
)))
 :qid |unknown.0:0|
 :skolemid |6875|
 :pattern ( (M3.Path.InternalPath_q d@@10))
)))
...
(assert (forall ((d@@12 T@U) ) (!  (=> (M3.WFCertificate.Cert_q d@@12) (exists ((|a#37#0#0| T@U) (|a#37#1#0| T@U) ) (! (= d@@12 (|#M3.WFCertificate.Cert| |a#37#0#0| |a#37#1#0|))
 :qid |CloudMakeParallelBuildsdfy.500:33|
 :skolemid |6922|
)))
 :qid |unknown.0:0|
 :skolemid |6923|
 :pattern ( (M3.WFCertificate.Cert_q d@@12))
)))
...
(assert (forall ((d@@13 T@U) ) (!  (=> (M3.Path.ExternalPath_q d@@13) (exists ((|a#23#0#0| T@U) ) (! (= d@@13 (|#M3.Path.ExternalPath| |a#23#0#0|))
 :qid |CloudMakeParallelBuildsdfy.785:18|
 :skolemid |6891|
)))
 :qid |unknown.0:0|
 :skolemid |6892|
 :pattern ( (M3.Path.ExternalPath_q d@@13))
)))
(assert (forall ((d@@14 T@U) ) (!  (=> (M3.State.StateCons_q d@@14) (exists ((|a#45#0#0| T@U) ) (! (= d@@14 (|#M3.State.StateCons| |a#45#0#0|))
 :qid |CloudMakeParallelBuildsdfy.433:30|
 :skolemid |6939|
)))
 :qid |unknown.0:0|
 :skolemid |6940|
 :pattern ( (M3.State.StateCons_q d@@14))
)))
...
(assert (forall ((d@@15 T@U) ) (!  (=> (|$IsA#M3.Path| d@@15) (or (M3.Path.InternalPath_q d@@15) (M3.Path.ExternalPath_q d@@15)))
 :qid |unknown.0:0|
 :skolemid |6900|
 :pattern ( (|$IsA#M3.Path| d@@15))
)))
...
(assert (forall ((d@@16 T@U) ) (!  (=> ($Is DatatypeTypeType d@@16 Tclass.M3.Path) (or (M3.Path.InternalPath_q d@@16) (M3.Path.ExternalPath_q d@@16)))
 :qid |unknown.0:0|
 :skolemid |6901|
 :pattern ( (M3.Path.ExternalPath_q d@@16) ($Is DatatypeTypeType d@@16 Tclass.M3.Path))
 :pattern ( (M3.Path.InternalPath_q d@@16) ($Is DatatypeTypeType d@@16 Tclass.M3.Path))
)))
...
(assert (forall ((|a#18#0#0| T@U) (|a#18#1#0| T@U) (|a#18#2#0| T@U) (d@@18 T@U) ) (!  (=> (|Set#IsMember| |a#18#1#0| ($Box DatatypeTypeType d@@18)) (< (DtRank d@@18) (DtRank (|#M3.Path.InternalPath| |a#18#0#0| |a#18#1#0| |a#18#2#0|))))
 :qid |CloudMakeParallelBuildsdfy.784:18|
 :skolemid |6885|
 :pattern ( (|Set#IsMember| |a#18#1#0| ($Box DatatypeTypeType d@@18)) (|#M3.Path.InternalPath| |a#18#0#0| |a#18#1#0| |a#18#2#0|))
)))
...
(assert (forall ((v@@7 T@U) (t0@@6 T@U) (t1@@3 T@U) ) (! (= ($Is MapType v@@7 (TMap t0@@6 t1@@3)) (forall ((bx@@14 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@7) bx@@14) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@7) bx@@14) t1@@3) ($IsBox bx@@14 t0@@6)))
...
(assert (forall ((|a#43#0#0| T@U) (|a#43#1#0| T@U) (d@@19 T@U) ) (!  (=> (|Set#IsMember| |a#43#1#0| ($Box DatatypeTypeType d@@19)) (< (DtRank d@@19) (DtRank (|#M3.WFCertificate.Cert| |a#43#0#0| |a#43#1#0|))))
 :qid |CloudMakeParallelBuildsdfy.500:33|
 :skolemid |6931|
 :pattern ( (|Set#IsMember| |a#43#1#0| ($Box DatatypeTypeType d@@19)) (|#M3.WFCertificate.Cert| |a#43#0#0| |a#43#1#0|))
)))
(assert (forall ((d@@20 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) ($Is DatatypeTypeType d@@20 Tclass.M3.Artifact)) ($IsAlloc DatatypeTypeType d@@20 Tclass.M3.Artifact $h@@1))
 :qid |unknown.0:0|
 :skolemid |6854|
 :pattern ( ($IsAlloc DatatypeTypeType d@@20 Tclass.M3.Artifact $h@@1))
)))
(assert (forall ((d@@21 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) ($Is DatatypeTypeType d@@21 Tclass.M3.Path)) ($IsAlloc DatatypeTypeType d@@21 Tclass.M3.Path $h@@2))
 :qid |unknown.0:0|
 :skolemid |6899|
 :pattern ( ($IsAlloc DatatypeTypeType d@@21 Tclass.M3.Path $h@@2))
)))
(assert (forall ((d@@22 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) ($Is DatatypeTypeType d@@22 Tclass.M3.WFCertificate)) ($IsAlloc DatatypeTypeType d@@22 Tclass.M3.WFCertificate $h@@3))
 :qid |unknown.0:0|
 :skolemid |6932|
 :pattern ( ($IsAlloc DatatypeTypeType d@@22 Tclass.M3.WFCertificate $h@@3))
)))
(assert (forall ((d@@23 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) ($Is DatatypeTypeType d@@23 Tclass.M3.State)) ($IsAlloc DatatypeTypeType d@@23 Tclass.M3.State $h@@4))
 :qid |unknown.0:0|
 :skolemid |6947|
 :pattern ( ($IsAlloc DatatypeTypeType d@@23 Tclass.M3.State $h@@4))
)))
...
(assert (forall ((d@@24 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (M3.Path.InternalPath_q d@@24) ($IsAlloc DatatypeTypeType d@@24 Tclass.M3.Path $h@@5))) ($IsAlloc SeqType (M3.Path.cmd d@@24) (TSeq TChar) $h@@5))
 :qid |unknown.0:0|
 :skolemid |6877|
 :pattern ( ($IsAlloc SeqType (M3.Path.cmd d@@24) (TSeq TChar) $h@@5))
)))
(assert (forall ((d@@25 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (M3.Path.InternalPath_q d@@25) ($IsAlloc DatatypeTypeType d@@25 Tclass.M3.Path $h@@6))) ($IsAlloc SeqType (M3.Path.exp d@@25) (TSeq TChar) $h@@6))
 :qid |unknown.0:0|
 :skolemid |6879|
 :pattern ( ($IsAlloc SeqType (M3.Path.exp d@@25) (TSeq TChar) $h@@6))
)))
(assert (forall ((d@@26 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (M3.Path.ExternalPath_q d@@26) ($IsAlloc DatatypeTypeType d@@26 Tclass.M3.Path $h@@7))) ($IsAlloc SeqType (M3.Path._h13 d@@26) (TSeq TChar) $h@@7))
 :qid |unknown.0:0|
 :skolemid |6894|
 :pattern ( ($IsAlloc SeqType (M3.Path._h13 d@@26) (TSeq TChar) $h@@7))
)))
...
(assert (forall ((d@@27 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (_System.Tuple2.___hMake2_q d@@27) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@27 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@8)
 :qid |unknown.0:0|
 :skolemid |5413|
 :pattern ( ($IsAlloc DatatypeTypeType d@@27 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@8))
)))) ($IsAllocBox (_System.Tuple2._0 d@@27) |_System._tuple#2$T0@@6| $h@@8))
 :qid |unknown.0:0|
 :skolemid |5414|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@27) |_System._tuple#2$T0@@6| $h@@8))
)))
(assert (forall ((d@@28 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) (and (_System.Tuple2.___hMake2_q d@@28) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@28 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@9)
 :qid |unknown.0:0|
 :skolemid |5415|
 :pattern ( ($IsAlloc DatatypeTypeType d@@28 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@9))
)))) ($IsAllocBox (_System.Tuple2._1 d@@28) |_System._tuple#2$T1@@7| $h@@9))
 :qid |unknown.0:0|
 :skolemid |5416|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@28) |_System._tuple#2$T1@@7| $h@@9))
)))
(assert (forall ((d@@29 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) (and (M3.WFCertificate.Cert_q d@@29) ($IsAlloc DatatypeTypeType d@@29 Tclass.M3.WFCertificate $h@@10))) ($IsAlloc DatatypeTypeType (M3.WFCertificate.p d@@29) Tclass.M3.Path $h@@10))
 :qid |unknown.0:0|
 :skolemid |6925|
 :pattern ( ($IsAlloc DatatypeTypeType (M3.WFCertificate.p d@@29) Tclass.M3.Path $h@@10))
)))
(assert (forall ((certs T@U) (d@@30 T@U) ) (!  (=> (|$let#36$canCall| certs d@@30) (and ($Is DatatypeTypeType (|$let#36_c| certs d@@30) Tclass.M3.WFCertificate) (and (|Set#IsMember| certs ($Box DatatypeTypeType (|$let#36_c| certs d@@30))) (|M3.Path#Equal| (M3.WFCertificate.p (|$let#36_c| certs d@@30)) d@@30))))
 :qid |CloudMakeParallelBuildsdfy.669:5|
 :skolemid |6109|
 :pattern ( (|$let#36_c| certs d@@30))
)))
...
(assert (forall ((|a#49#0#0| T@U) (d@@31 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#49#0#0|) ($Box DatatypeTypeType d@@31)) (< (DtRank d@@31) (DtRank (|#M3.State.StateCons| |a#49#0#0|))))
 :qid |CloudMakeParallelBuildsdfy.433:30|
 :skolemid |6945|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#49#0#0|) ($Box DatatypeTypeType d@@31)) (|#M3.State.StateCons| |a#49#0#0|))
)))
...
(assert (forall ((d@@32 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (M3.Path.InternalPath_q d@@32) ($IsAlloc DatatypeTypeType d@@32 Tclass.M3.Path $h@@11))) ($IsAlloc SetType (M3.Path.deps d@@32) (TSet Tclass.M3.Path) $h@@11))
 :qid |unknown.0:0|
 :skolemid |6878|
 :pattern ( ($IsAlloc SetType (M3.Path.deps d@@32) (TSet Tclass.M3.Path) $h@@11))
)))
(assert (forall ((d@@33 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (M3.WFCertificate.Cert_q d@@33) ($IsAlloc DatatypeTypeType d@@33 Tclass.M3.WFCertificate $h@@12))) ($IsAlloc SetType (M3.WFCertificate.certs d@@33) (TSet Tclass.M3.WFCertificate) $h@@12))
 :qid |unknown.0:0|
 :skolemid |6926|
 :pattern ( ($IsAlloc SetType (M3.WFCertificate.certs d@@33) (TSet Tclass.M3.WFCertificate) $h@@12))
)))
...
(assert (forall ((v@@9 T@U) (t0@@7 T@U) ) (! (= ($Is SeqType v@@9 (TSeq t0@@7)) (forall ((i@@3 Int) ) (!  (=> (and (<= 0 i@@3) (< i@@3 (|Seq#Length| v@@9))) ($IsBox (|Seq#Index| v@@9 i@@3) t0@@7))
...
(set-info :boogie-vc-id Impl$$M3.__default.OracleWF__CertificateInsensitivity)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#4| null $Heap@@10 alloc false)) (=> (and (|$IsA#M3.Path| |p#0@@27|) (|$IsA#M3.WFCertificate| |cert0#0|)) (=> (and (and (|$IsA#M3.WFCertificate| |cert1#0|) (|$IsA#M3.State| |st#0@@16|)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (=> (and (and (and (= $Heap@@10 $Heap@0) (forall ((|$ih#p0#0| T@U) (|$ih#cert00#0| T@U) (|$ih#cert10#0| T@U) (|$ih#st0#0| T@U) ) (!  (=> (and (and (and (and (and ($Is DatatypeTypeType |$ih#p0#0| Tclass.M3.Path) ($Is DatatypeTypeType |$ih#cert00#0| Tclass.M3.WFCertificate)) ($Is DatatypeTypeType |$ih#cert10#0| Tclass.M3.WFCertificate)) ($Is DatatypeTypeType |$ih#st0#0| Tclass.M3.State)) (and (M3.__default.CheckWellFounded ($LS $LZ) |$ih#p0#0| |$ih#cert00#0|) (M3.__default.CheckWellFounded ($LS $LZ) |$ih#p0#0| |$ih#cert10#0|))) (or (< (DtRank |$ih#cert00#0|) (DtRank |cert0#0|)) (and (= (DtRank |$ih#cert00#0|) (DtRank |cert0#0|)) (and (<= 0 (LitInt 1)) (< (LitInt 1) (LitInt 1)))))) (|M3.Artifact#Equal| (M3.__default.OracleWF ($LS $LZ) |$ih#p0#0| |$ih#cert00#0| |$ih#st0#0|) (M3.__default.OracleWF ($LS $LZ) |$ih#p0#0| |$ih#cert10#0| |$ih#st0#0|)))
 :qid |CloudMakeParallelBuildsdfy.675:43|
 :skolemid |6158|
 :pattern ( (M3.__default.OracleWF ($LS $LZ) |$ih#p0#0| |$ih#cert10#0| |$ih#st0#0|) (M3.__default.OracleWF ($LS $LZ) |$ih#p0#0| |$ih#cert00#0| |$ih#st0#0|))
 :pattern ( (M3.__default.OracleWF ($LS $LZ) |$ih#p0#0| |$ih#cert00#0| |$ih#st0#0|) (M3.__default.CheckWellFounded ($LS $LZ) |$ih#p0#0| |$ih#cert10#0|))
))) (and ($IsAlloc DatatypeTypeType |p#0@@27| Tclass.M3.Path $Heap@0) (|M3.__default.LocInv__Deps#canCall| |p#0@@27|))) (and (and (|M3.__default.LocInv__Deps#canCall| |p#0@@27|) (= |deps##0@0| (M3.__default.LocInv__Deps |p#0@@27|))) (and (or (or (<= 0 (LitInt 1)) (< (DtRank |cert0#0|) (DtRank |cert0#0|))) (= (LitInt 0) (LitInt 1))) (or (< (DtRank |cert0#0|) (DtRank |cert0#0|)) (and (= (DtRank |cert0#0|) (DtRank |cert0#0|)) (< (LitInt 0) (LitInt 1))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|M3.__default.CheckWellFounded#canCall| |p#0@@27| |cert0#0|) (or (M3.__default.CheckWellFounded ($LS $LZ) |p#0@@27| |cert0#0|) (|M3.Path#Equal| (M3.WFCertificate.p |cert0#0|) |p#0@@27|)))) (=> (=> (|M3.__default.CheckWellFounded#canCall| |p#0@@27| |cert0#0|) (or (M3.__default.CheckWellFounded ($LS $LZ) |p#0@@27| |cert0#0|) (|M3.Path#Equal| (M3.WFCertificate.p |cert0#0|) |p#0@@27|))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|M3.__default.CheckWellFounded#canCall| |p#0@@27| |cert0#0|) (or (M3.__default.CheckWellFounded ($LS $LZ) |p#0@@27| |cert0#0|) (forall ((|d#2@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |d#2@@2| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.LocInv__Deps |p#0@@27|) ($Box DatatypeTypeType |d#2@@2|)) (exists ((|c#4@@3| T@U) ) (!  (and ($Is DatatypeTypeType |c#4@@3| Tclass.M3.WFCertificate) (and (|Set#IsMember| (M3.WFCertificate.certs |cert0#0|) ($Box DatatypeTypeType |c#4@@3|)) (|M3.Path#Equal| (M3.WFCertificate.p |c#4@@3|) |d#2@@2|)))
 :qid |CloudMakeParallelBuildsdfy.497:49|
 :skolemid |6174|
 :pattern ( (M3.WFCertificate.p |c#4@@3|))
 :pattern ( (|Set#IsMember| (M3.WFCertificate.certs |cert0#0|) ($Box DatatypeTypeType |c#4@@3|)))
))))
 :qid |CloudMakeParallelBuildsdfy.497:13|
 :skolemid |6175|
 :pattern ( (|Set#IsMember| (M3.__default.LocInv__Deps |p#0@@27|) ($Box DatatypeTypeType |d#2@@2|)))
))))) (=> (=> (|M3.__default.CheckWellFounded#canCall| |p#0@@27| |cert0#0|) (or (M3.__default.CheckWellFounded ($LS $LZ) |p#0@@27| |cert0#0|) (forall ((|d#2@@3| T@U) ) (!  (=> ($Is DatatypeTypeType |d#2@@3| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.LocInv__Deps |p#0@@27|) ($Box DatatypeTypeType |d#2@@3|)) (exists ((|c#4@@4| T@U) ) (!  (and ($Is DatatypeTypeType |c#4@@4| Tclass.M3.WFCertificate) (and (|Set#IsMember| (M3.WFCertificate.certs |cert0#0|) ($Box DatatypeTypeType |c#4@@4|)) (|M3.Path#Equal| (M3.WFCertificate.p |c#4@@4|) |d#2@@3|)))
 :qid |CloudMakeParallelBuildsdfy.497:49|
 :skolemid |6174|
 :pattern ( (M3.WFCertificate.p |c#4@@4|))
 :pattern ( (|Set#IsMember| (M3.WFCertificate.certs |cert0#0|) ($Box DatatypeTypeType |c#4@@4|)))
))))
 :qid |CloudMakeParallelBuildsdfy.497:13|
 :skolemid |6175|
 :pattern ( (|Set#IsMember| (M3.__default.LocInv__Deps |p#0@@27|) ($Box DatatypeTypeType |d#2@@3|)))
)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|M3.__default.CheckWellFounded#canCall| |p#0@@27| |cert0#0|) (or (M3.__default.CheckWellFounded ($LS $LZ) |p#0@@27| |cert0#0|) (forall ((|c#5@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |c#5@@2| Tclass.M3.WFCertificate) (=> (|Set#IsMember| (M3.WFCertificate.certs |cert0#0|) ($Box DatatypeTypeType |c#5@@2|)) (M3.__default.CheckWellFounded ($LS ($LS $LZ)) (M3.WFCertificate.p |c#5@@2|) |c#5@@2|)))
 :qid |CloudMakeParallelBuildsdfy.498:13|
 :skolemid |6176|
 :pattern ( (M3.WFCertificate.p |c#5@@2|))
 :pattern ( (|Set#IsMember| (M3.WFCertificate.certs |cert0#0|) ($Box DatatypeTypeType |c#5@@2|)))
))))) (=> (=> (|M3.__default.CheckWellFounded#canCall| |p#0@@27| |cert0#0|) (or (M3.__default.CheckWellFounded ($LS $LZ) |p#0@@27| |cert0#0|) (forall ((|c#5@@3| T@U) ) (!  (=> ($Is DatatypeTypeType |c#5@@3| Tclass.M3.WFCertificate) (=> (|Set#IsMember| (M3.WFCertificate.certs |cert0#0|) ($Box DatatypeTypeType |c#5@@3|)) (M3.__default.CheckWellFounded ($LS ($LS $LZ)) (M3.WFCertificate.p |c#5@@3|) |c#5@@3|)))
 :qid |CloudMakeParallelBuildsdfy.498:13|
 :skolemid |6176|
 :pattern ( (M3.WFCertificate.p |c#5@@3|))
 :pattern ( (|Set#IsMember| (M3.WFCertificate.certs |cert0#0|) ($Box DatatypeTypeType |c#5@@3|)))
)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|M3.__default.CheckWellFounded#canCall| |p#0@@27| |cert1#0|) (or (M3.__default.CheckWellFounded ($LS $LZ) |p#0@@27| |cert1#0|) (|M3.Path#Equal| (M3.WFCertificate.p |cert1#0|) |p#0@@27|)))) (=> (=> (|M3.__default.CheckWellFounded#canCall| |p#0@@27| |cert1#0|) (or (M3.__default.CheckWellFounded ($LS $LZ) |p#0@@27| |cert1#0|) (|M3.Path#Equal| (M3.WFCertificate.p |cert1#0|) |p#0@@27|))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|M3.__default.CheckWellFounded#canCall| |p#0@@27| |cert1#0|) (or (M3.__default.CheckWellFounded ($LS $LZ) |p#0@@27| |cert1#0|) (forall ((|d#3| T@U) ) (!  (=> ($Is DatatypeTypeType |d#3| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.LocInv__Deps |p#0@@27|) ($Box DatatypeTypeType |d#3|)) (exists ((|c#6@@0| T@U) ) (!  (and ($Is DatatypeTypeType |c#6@@0| Tclass.M3.WFCertificate) (and (|Set#IsMember| (M3.WFCertificate.certs |cert1#0|) ($Box DatatypeTypeType |c#6@@0|)) (|M3.Path#Equal| (M3.WFCertificate.p |c#6@@0|) |d#3|)))
 :qid |CloudMakeParallelBuildsdfy.497:49|
 :skolemid |6181|
 :pattern ( (M3.WFCertificate.p |c#6@@0|))
 :pattern ( (|Set#IsMember| (M3.WFCertificate.certs |cert1#0|) ($Box DatatypeTypeType |c#6@@0|)))
))))
 :qid |CloudMakeParallelBuildsdfy.497:13|
 :skolemid |6182|
 :pattern ( (|Set#IsMember| (M3.__default.LocInv__Deps |p#0@@27|) ($Box DatatypeTypeType |d#3|)))
))))) (=> (=> (|M3.__default.CheckWellFounded#canCall| |p#0@@27| |cert1#0|) (or (M3.__default.CheckWellFounded ($LS $LZ) |p#0@@27| |cert1#0|) (forall ((|d#3@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |d#3@@0| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.LocInv__Deps |p#0@@27|) ($Box DatatypeTypeType |d#3@@0|)) (exists ((|c#6@@1| T@U) ) (!  (and ($Is DatatypeTypeType |c#6@@1| Tclass.M3.WFCertificate) (and (|Set#IsMember| (M3.WFCertificate.certs |cert1#0|) ($Box DatatypeTypeType |c#6@@1|)) (|M3.Path#Equal| (M3.WFCertificate.p |c#6@@1|) |d#3@@0|)))
 :qid |CloudMakeParallelBuildsdfy.497:49|
 :skolemid |6181|
 :pattern ( (M3.WFCertificate.p |c#6@@1|))
 :pattern ( (|Set#IsMember| (M3.WFCertificate.certs |cert1#0|) ($Box DatatypeTypeType |c#6@@1|)))
))))
 :qid |CloudMakeParallelBuildsdfy.497:13|
 :skolemid |6182|
 :pattern ( (|Set#IsMember| (M3.__default.LocInv__Deps |p#0@@27|) ($Box DatatypeTypeType |d#3@@0|)))
)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|M3.__default.CheckWellFounded#canCall| |p#0@@27| |cert1#0|) (or (M3.__default.CheckWellFounded ($LS $LZ) |p#0@@27| |cert1#0|) (forall ((|c#7| T@U) ) (!  (=> ($Is DatatypeTypeType |c#7| Tclass.M3.WFCertificate) (=> (|Set#IsMember| (M3.WFCertificate.certs |cert1#0|) ($Box DatatypeTypeType |c#7|)) (M3.__default.CheckWellFounded ($LS ($LS $LZ)) (M3.WFCertificate.p |c#7|) |c#7|)))
 :qid |CloudMakeParallelBuildsdfy.498:13|
 :skolemid |6183|
 :pattern ( (M3.WFCertificate.p |c#7|))
 :pattern ( (|Set#IsMember| (M3.WFCertificate.certs |cert1#0|) ($Box DatatypeTypeType |c#7|)))
))))) (=> (=> (|M3.__default.CheckWellFounded#canCall| |p#0@@27| |cert1#0|) (or (M3.__default.CheckWellFounded ($LS $LZ) |p#0@@27| |cert1#0|) (forall ((|c#7@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |c#7@@0| Tclass.M3.WFCertificate) (=> (|Set#IsMember| (M3.WFCertificate.certs |cert1#0|) ($Box DatatypeTypeType |c#7@@0|)) (M3.__default.CheckWellFounded ($LS ($LS $LZ)) (M3.WFCertificate.p |c#7@@0|) |c#7@@0|)))
 :qid |CloudMakeParallelBuildsdfy.498:13|
 :skolemid |6183|
 :pattern ( (M3.WFCertificate.p |c#7@@0|))
 :pattern ( (|Set#IsMember| (M3.WFCertificate.certs |cert1#0|) ($Box DatatypeTypeType |c#7@@0|)))
)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Equal| |deps##0@0| (M3.__default.LocInv__Deps |p#0@@27|))) (=> (|Set#Equal| |deps##0@0| (M3.__default.LocInv__Deps |p#0@@27|)) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and (|M3.__default.CollectDependencies#canCall| |p#0@@27| |cert0#0| |deps##0@0| |st#0@@16|) (|M3.__default.CollectDependencies#canCall| |p#0@@27| |cert1#0| |deps##0@0| |st#0@@16|)) (|Map#Equal| (M3.__default.CollectDependencies ($LS ($LS $LZ)) |p#0@@27| |cert0#0| |deps##0@0| |st#0@@16|) (M3.__default.CollectDependencies ($LS ($LS $LZ)) |p#0@@27| |cert1#0| |deps##0@0| |st#0@@16|))) (and (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 2) (- 0 1))) false)) (|M3.Artifact#Equal| (M3.__default.OracleWF ($LS ($LS $LZ)) |p#0@@27| |cert0#0| |st#0@@16|) (M3.__default.OracleWF ($LS ($LS $LZ)) |p#0@@27| |cert1#0| |st#0@@16|))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@10) ($IsHeapAnchor $Heap@@10)) (=> (and (and ($Is DatatypeTypeType |p#0@@27| Tclass.M3.Path) ($IsAlloc DatatypeTypeType |p#0@@27| Tclass.M3.Path $Heap@@10)) (|$IsA#M3.Path| |p#0@@27|)) (=> (and (and (and ($Is DatatypeTypeType |cert0#0| Tclass.M3.WFCertificate) ($IsAlloc DatatypeTypeType |cert0#0| Tclass.M3.WFCertificate $Heap@@10)) (|$IsA#M3.WFCertificate| |cert0#0|)) (and (and ($Is DatatypeTypeType |cert1#0| Tclass.M3.WFCertificate) ($IsAlloc DatatypeTypeType |cert1#0| Tclass.M3.WFCertificate $Heap@@10)) (|$IsA#M3.WFCertificate| |cert1#0|))) (=> (and (and (and (and (and ($Is DatatypeTypeType |st#0@@16| Tclass.M3.State) ($IsAlloc DatatypeTypeType |st#0@@16| Tclass.M3.State $Heap@@10)) (|$IsA#M3.State| |st#0@@16|)) (= 5 $FunctionContextHeight)) (and (|M3.__default.CheckWellFounded#canCall| |p#0@@27| |cert0#0|) (and (M3.__default.CheckWellFounded ($LS $LZ) |p#0@@27| |cert0#0|) (and (and (|M3.Path#Equal| (M3.WFCertificate.p |cert0#0|) |p#0@@27|) (forall ((|d#4| T@U) ) (!  (=> ($Is DatatypeTypeType |d#4| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.LocInv__Deps |p#0@@27|) ($Box DatatypeTypeType |d#4|)) (exists ((|c#8| T@U) ) (!  (and ($Is DatatypeTypeType |c#8| Tclass.M3.WFCertificate) (and (|Set#IsMember| (M3.WFCertificate.certs |cert0#0|) ($Box DatatypeTypeType |c#8|)) (|M3.Path#Equal| (M3.WFCertificate.p |c#8|) |d#4|)))
 :qid |CloudMakeParallelBuildsdfy.497:49|
 :skolemid |6148|
