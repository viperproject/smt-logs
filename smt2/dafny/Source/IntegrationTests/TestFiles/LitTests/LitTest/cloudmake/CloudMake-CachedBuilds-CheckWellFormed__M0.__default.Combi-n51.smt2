...
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id CheckWellFormed$$M0.__default.Combine__DomSt)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (not (|Set#Equal| |sts#0@@3| |Set#Empty|))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (= $Heap@@4 $Heap@0) (= |##sts#0@0| (|Set#Union| (|Set#UnionOne| |Set#Empty| |st#0@@7|) |sts#0@@3|))) (and ($IsAlloc SetType |##sts#0@0| (TSet Tclass.M0.State) $Heap@0) ($IsAlloc boolType (bool_2_U |useCache#0@@4|) TBool $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (|Set#Equal| |##sts#0@0| |Set#Empty|))) (=> (and (not (|Set#Equal| |##sts#0@0| |Set#Empty|)) (|M0.__default.Combine#canCall| (|Set#Union| (|Set#UnionOne| |Set#Empty| |st#0@@7|) |sts#0@@3|) |useCache#0@@4|)) (=> (and (and (and (= |##st#0@0| (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine (|Set#Union| (|Set#UnionOne| |Set#Empty| |st#0@@7|) |sts#0@@3|) |useCache#0@@4|)) ($IsAllocBox |##st#0@0| Tclass.M0.State $Heap@0)) (and (|M0.__default.DomSt#canCall| (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine (|Set#Union| (|Set#UnionOne| |Set#Empty| |st#0@@7|) |sts#0@@3|) |useCache#0@@4|)) ($IsAllocBox |st#0@@7| Tclass.M0.State $Heap@0))) (and (and (|M0.__default.DomSt#canCall| |st#0@@7|) ($IsAlloc SetType |sts#0@@3| (TSet Tclass.M0.State) $Heap@0)) (and ($IsAlloc boolType (bool_2_U |useCache#0@@4|) TBool $Heap@0) (= (ControlFlow 0 2) (- 0 1))))) (not (|Set#Equal| |sts#0@@3| |Set#Empty|))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (and ($IsBox |st#0@@7| Tclass.M0.State) ($IsAllocBox |st#0@@7| Tclass.M0.State $Heap@@4))) (and (and ($Is SetType |sts#0@@3| (TSet Tclass.M0.State)) ($IsAlloc SetType |sts#0@@3| (TSet Tclass.M0.State) $Heap@@4)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct)))
