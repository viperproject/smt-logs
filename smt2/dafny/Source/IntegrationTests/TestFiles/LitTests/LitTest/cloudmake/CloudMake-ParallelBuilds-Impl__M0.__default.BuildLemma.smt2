...
(assert (forall ((d@@0 T@U) ) (!  (=> (|$IsA#M0.Tuple| d@@0) (M0.Tuple.Pair_q d@@0))
 :qid |unknown.0:0|
 :skolemid |1380|
 :pattern ( (|$IsA#M0.Tuple| d@@0))
)))
...
(assert (forall ((d@@2 T@U) ) (!  (=> ($Is DatatypeTypeType d@@2 Tclass.M0.Program) (M0.Program.Program_q d@@2))
 :qid |unknown.0:0|
 :skolemid |1132|
 :pattern ( (M0.Program.Program_q d@@2) ($Is DatatypeTypeType d@@2 Tclass.M0.Program))
)))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($Heap@@3 T@U) ($ly@@3 T@U) (|stmts#0@@0| T@U) (|st#0@@8| T@U) (|env#0@@2| T@U) ) (!  (=> (and (or (|M0.__default.do#canCall| |stmts#0@@0| |st#0@@8| |env#0@@2|) (and (< 5 $FunctionContextHeight) (and (and (and (and ($Is SeqType |stmts#0@@0| (TSeq Tclass.M0.Statement)) ($IsAlloc SeqType |stmts#0@@0| (TSeq Tclass.M0.Statement) $Heap@@3)) (and ($IsBox |st#0@@8| Tclass.M0.State) ($IsAllocBox |st#0@@8| Tclass.M0.State $Heap@@3))) (and ($IsBox |env#0@@2| Tclass.M0.Env) ($IsAllocBox |env#0@@2| Tclass.M0.Env $Heap@@3))) (and (M0.__default.Legal |stmts#0@@0|) (M0.__default.ValidEnv |env#0@@2|))))) ($IsGoodHeap $Heap@@3)) ($IsAlloc DatatypeTypeType (M0.__default.do $ly@@3 |stmts#0@@0| |st#0@@8| |env#0@@2|) (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State) $Heap@@3))
 :qid |CloudMakeParallelBuildsdfy.177:18|
 :skolemid |952|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.__default.do $ly@@3 |stmts#0@@0| |st#0@@8| |env#0@@2|) (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State) $Heap@@3))
))))
(assert (forall ((d@@3 T@U) ) (! (= (M0.Program.Program_q d@@3) (= (DatatypeCtorId d@@3) |##M0.Program.Program|))
 :qid |unknown.0:0|
 :skolemid |1121|
 :pattern ( (M0.Program.Program_q d@@3))
)))
(assert (forall ((d@@4 T@U) ) (! (= (M0.Statement.stmtVariable_q d@@4) (= (DatatypeCtorId d@@4) |##M0.Statement.stmtVariable|))
 :qid |unknown.0:0|
 :skolemid |1136|
 :pattern ( (M0.Statement.stmtVariable_q d@@4))
)))
(assert (forall ((d@@5 T@U) ) (! (= (M0.Statement.stmtReturn_q d@@5) (= (DatatypeCtorId d@@5) |##M0.Statement.stmtReturn|))
 :qid |unknown.0:0|
 :skolemid |1148|
 :pattern ( (M0.Statement.stmtReturn_q d@@5))
)))
(assert (forall ((d@@6 T@U) ) (! (= (M0.Expression.exprLiteral_q d@@6) (= (DatatypeCtorId d@@6) |##M0.Expression.exprLiteral|))
 :qid |unknown.0:0|
 :skolemid |1163|
 :pattern ( (M0.Expression.exprLiteral_q d@@6))
)))
(assert (forall ((d@@7 T@U) ) (! (= (M0.Expression.exprIdentifier_q d@@7) (= (DatatypeCtorId d@@7) |##M0.Expression.exprIdentifier|))
 :qid |unknown.0:0|
 :skolemid |1174|
 :pattern ( (M0.Expression.exprIdentifier_q d@@7))
)))
(assert (forall ((d@@8 T@U) ) (! (= (M0.Expression.exprIf_q d@@8) (= (DatatypeCtorId d@@8) |##M0.Expression.exprIf|))
 :qid |unknown.0:0|
 :skolemid |1183|
 :pattern ( (M0.Expression.exprIf_q d@@8))
)))
(assert (forall ((d@@9 T@U) ) (! (= (M0.Expression.exprAnd_q d@@9) (= (DatatypeCtorId d@@9) |##M0.Expression.exprAnd|))
 :qid |unknown.0:0|
 :skolemid |1199|
 :pattern ( (M0.Expression.exprAnd_q d@@9))
)))
(assert (forall ((d@@10 T@U) ) (! (= (M0.Expression.exprOr_q d@@10) (= (DatatypeCtorId d@@10) |##M0.Expression.exprOr|))
 :qid |unknown.0:0|
 :skolemid |1212|
 :pattern ( (M0.Expression.exprOr_q d@@10))
)))
(assert (forall ((d@@11 T@U) ) (! (= (M0.Expression.exprInvocation_q d@@11) (= (DatatypeCtorId d@@11) |##M0.Expression.exprInvocation|))
 :qid |unknown.0:0|
 :skolemid |1225|
 :pattern ( (M0.Expression.exprInvocation_q d@@11))
)))
(assert (forall ((d@@12 T@U) ) (! (= (M0.Expression.exprError_q d@@12) (= (DatatypeCtorId d@@12) |##M0.Expression.exprError|))
 :qid |unknown.0:0|
 :skolemid |1239|
 :pattern ( (M0.Expression.exprError_q d@@12))
)))
(assert (forall ((d@@13 T@U) ) (! (= (M0.Literal.litTrue_q d@@13) (= (DatatypeCtorId d@@13) |##M0.Literal.litTrue|))
 :qid |unknown.0:0|
 :skolemid |1259|
 :pattern ( (M0.Literal.litTrue_q d@@13))
)))
(assert (forall ((d@@14 T@U) ) (! (= (M0.Literal.litFalse_q d@@14) (= (DatatypeCtorId d@@14) |##M0.Literal.litFalse|))
 :qid |unknown.0:0|
 :skolemid |1262|
 :pattern ( (M0.Literal.litFalse_q d@@14))
)))
(assert (forall ((d@@15 T@U) ) (! (= (M0.Literal.litUndefined_q d@@15) (= (DatatypeCtorId d@@15) |##M0.Literal.litUndefined|))
 :qid |unknown.0:0|
 :skolemid |1265|
 :pattern ( (M0.Literal.litUndefined_q d@@15))
)))
(assert (forall ((d@@16 T@U) ) (! (= (M0.Literal.litNull_q d@@16) (= (DatatypeCtorId d@@16) |##M0.Literal.litNull|))
 :qid |unknown.0:0|
 :skolemid |1268|
 :pattern ( (M0.Literal.litNull_q d@@16))
)))
(assert (forall ((d@@17 T@U) ) (! (= (M0.Literal.litNumber_q d@@17) (= (DatatypeCtorId d@@17) |##M0.Literal.litNumber|))
 :qid |unknown.0:0|
 :skolemid |1272|
 :pattern ( (M0.Literal.litNumber_q d@@17))
)))
(assert (forall ((d@@18 T@U) ) (! (= (M0.Literal.litString_q d@@18) (= (DatatypeCtorId d@@18) |##M0.Literal.litString|))
 :qid |unknown.0:0|
 :skolemid |1281|
 :pattern ( (M0.Literal.litString_q d@@18))
)))
(assert (forall ((d@@19 T@U) ) (! (= (M0.Literal.litPrimitive_q d@@19) (= (DatatypeCtorId d@@19) |##M0.Literal.litPrimitive|))
 :qid |unknown.0:0|
 :skolemid |1292|
 :pattern ( (M0.Literal.litPrimitive_q d@@19))
)))
(assert (forall ((d@@20 T@U) ) (! (= (M0.Literal.litArrOfPaths_q d@@20) (= (DatatypeCtorId d@@20) |##M0.Literal.litArrOfPaths|))
 :qid |unknown.0:0|
 :skolemid |1302|
 :pattern ( (M0.Literal.litArrOfPaths_q d@@20))
)))
(assert (forall ((d@@21 T@U) ) (! (= (M0.Literal.litArrOfStrings_q d@@21) (= (DatatypeCtorId d@@21) |##M0.Literal.litArrOfStrings|))
 :qid |unknown.0:0|
 :skolemid |1312|
 :pattern ( (M0.Literal.litArrOfStrings_q d@@21))
)))
(assert (forall ((d@@22 T@U) ) (! (= (M0.Literal.litArray_q d@@22) (= (DatatypeCtorId d@@22) |##M0.Literal.litArray|))
 :qid |unknown.0:0|
 :skolemid |1322|
 :pattern ( (M0.Literal.litArray_q d@@22))
)))
(assert (forall ((d@@23 T@U) ) (! (= (M0.Primitive.primCreatePath_q d@@23) (= (DatatypeCtorId d@@23) |##M0.Primitive.primCreatePath|))
 :qid |unknown.0:0|
 :skolemid |1345|
 :pattern ( (M0.Primitive.primCreatePath_q d@@23))
)))
(assert (forall ((d@@24 T@U) ) (! (= (M0.Primitive.primExec_q d@@24) (= (DatatypeCtorId d@@24) |##M0.Primitive.primExec|))
 :qid |unknown.0:0|
 :skolemid |1347|
 :pattern ( (M0.Primitive.primExec_q d@@24))
)))
(assert (forall ((d@@25 T@U) ) (! (= (M0.Reason.rCompatibility_q d@@25) (= (DatatypeCtorId d@@25) |##M0.Reason.rCompatibility|))
 :qid |unknown.0:0|
 :skolemid |1355|
 :pattern ( (M0.Reason.rCompatibility_q d@@25))
)))
(assert (forall ((d@@26 T@U) ) (! (= (M0.Reason.rValidity_q d@@26) (= (DatatypeCtorId d@@26) |##M0.Reason.rValidity|))
 :qid |unknown.0:0|
 :skolemid |1357|
 :pattern ( (M0.Reason.rValidity_q d@@26))
)))
...
(assert (forall ((d@@33 T@U) ) (!  (=> (M0.Tuple.Pair_q d@@33) (exists ((|a#142#0#0| T@U) (|a#142#1#0| T@U) ) (! (= d@@33 (|#M0.Tuple.Pair| |a#142#0#0| |a#142#1#0|))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@4 T@U) ($Heap@@4 T@U) (|sts#0@@0| T@U) ) (!  (=> (or (|M0.__default.Combine#canCall| |sts#0@@0|) (and (< 3 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@4) ($Is SetType |sts#0@@0| (TSet Tclass.M0.State))) (not (|Set#Equal| |sts#0@@0| |Set#Empty|))))) (and (and (|$let#0$canCall| |sts#0@@0|) (=> (not (|Set#Equal| |sts#0@@0| (|Set#UnionOne| |Set#Empty| (|$let#0_st| |sts#0@@0|)))) (and (|M0.__default.Combine#canCall| (|Set#Difference| |sts#0@@0| (|Set#UnionOne| |Set#Empty| (|$let#0_st| |sts#0@@0|)))) (|M0.__default.Union#canCall| (|$let#0_st| |sts#0@@0|) (M0.__default.Combine $ly@@4 (|Set#Difference| |sts#0@@0| (|Set#UnionOne| |Set#Empty| (|$let#0_st| |sts#0@@0|)))))))) (= (M0.__default.Combine ($LS $ly@@4) |sts#0@@0|) (let ((|st#0@@9| (|$let#0_st| |sts#0@@0|)))
(ite (|Set#Equal| |sts#0@@0| (|Set#UnionOne| |Set#Empty| |st#0@@9|)) |st#0@@9| (M0.__default.Union |st#0@@9| (M0.__default.Combine $ly@@4 (|Set#Difference| |sts#0@@0| (|Set#UnionOne| |Set#Empty| |st#0@@9|)))))))))
 :qid |CloudMakeParallelBuildsdfy.36:18|
 :skolemid |747|
 :pattern ( (M0.__default.Combine ($LS $ly@@4) |sts#0@@0|) ($IsGoodHeap $Heap@@4))
))))
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@5 T@U) (|stmts#0@@1| T@U) (|st#0@@10| T@U) (|env#0@@4| T@U) ) (!  (=> (or (|M0.__default.do#canCall| |stmts#0@@1| |st#0@@10| |env#0@@4|) (and (< 5 $FunctionContextHeight) (and (and (and ($Is SeqType |stmts#0@@1| (TSeq Tclass.M0.Statement)) ($IsBox |st#0@@10| Tclass.M0.State)) ($IsBox |env#0@@4| Tclass.M0.Env)) (and (M0.__default.Legal |stmts#0@@1|) (M0.__default.ValidEnv |env#0@@4|))))) (and (let ((|stmt#0| ($Unbox DatatypeTypeType (|Seq#Index| |stmts#0@@1| (LitInt 0)))))
 (and (=> (M0.Statement.stmtVariable_q |stmt#0|) (and (|M0.__default.eval#canCall| (M0.Statement.expr |stmt#0|) |st#0@@10| |env#0@@4|) (let ((|st'#0@@1| (M0.Tuple.snd (M0.__default.eval ($LS $LZ) (M0.Statement.expr |stmt#0|) |st#0@@10| |env#0@@4|))))
(let ((|expr'#0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $LZ) (M0.Statement.expr |stmt#0|) |st#0@@10| |env#0@@4|)))))
 ...
 (and (|M0.__default.Legal#canCall| (|Seq#Drop| |stmts#0@@1| (LitInt 1))) (=> (M0.__default.Legal (|Seq#Drop| |stmts#0@@1| (LitInt 1))) (|M0.__default.do#canCall| (|Seq#Drop| |stmts#0@@1| (LitInt 1)) |st'#0@@1| |env'#0|))))))))))) (=> (not (M0.Statement.stmtVariable_q |stmt#0|)) (|M0.__default.eval#canCall| (M0.Statement.ret |stmt#0|) |st#0@@10| |env#0@@4|)))) (= (M0.__default.do ($LS $ly@@5) |stmts#0@@1| |st#0@@10| |env#0@@4|) (let ((|stmt#0@@0| ($Unbox DatatypeTypeType (|Seq#Index| |stmts#0@@1| (LitInt 0)))))
(ite (M0.Statement.stmtVariable_q |stmt#0@@0|) (let ((|st'#0@@2| (M0.Tuple.snd (M0.__default.eval ($LS $LZ) (M0.Statement.expr |stmt#0@@0|) |st#0@@10| |env#0@@4|))))
(let ((|expr'#0@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $LZ) (M0.Statement.expr |stmt#0@@0|) |st#0@@10| |env#0@@4|)))))
(ite (M0.__default.Value |expr'#0@@0|) (let ((|env'#0@@0| (M0.__default.SetEnv (M0.Statement.id |stmt#0@@0|) |expr'#0@@0| |env#0@@4|)))
(ite (M0.__default.Legal (|Seq#Drop| |stmts#0@@1| (LitInt 1))) (M0.__default.do $ly@@5 (|Seq#Drop| |stmts#0@@1| (LitInt 1)) |st'#0@@2| |env'#0@@0|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType |expr'#0@@0|) |st'#0@@2|))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@10|)))) (M0.__default.eval ($LS $LZ) (M0.Statement.ret |stmt#0@@0|) |st#0@@10| |env#0@@4|))))))
 :qid |CloudMakeParallelBuildsdfy.177:18|
 :skolemid |954|
 :pattern ( (M0.__default.do ($LS $ly@@5) |stmts#0@@1| |st#0@@10| |env#0@@4|))
))))
...
(assert (forall ((d@@42 T@U) ) (!  (=> (|$IsA#M0.Literal| d@@42) (or (or (or (or (or (or (or (or (or (M0.Literal.litTrue_q d@@42) (M0.Literal.litFalse_q d@@42)) (M0.Literal.litUndefined_q d@@42)) (M0.Literal.litNull_q d@@42)) (M0.Literal.litNumber_q d@@42)) (M0.Literal.litString_q d@@42)) (M0.Literal.litPrimitive_q d@@42)) (M0.Literal.litArrOfPaths_q d@@42)) (M0.Literal.litArrOfStrings_q d@@42)) (M0.Literal.litArray_q d@@42)))
 :qid |unknown.0:0|
 :skolemid |1332|
 :pattern ( (|$IsA#M0.Literal| d@@42))
)))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@6 T@U) (|expr#0| T@U) (|st#0@@11| T@U) (|env#0@@5| T@U) ) (!  (=> (or (|M0.__default.eval#canCall| (Lit DatatypeTypeType |expr#0|) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|)) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0| Tclass.M0.Expression) ($IsBox |st#0@@11| Tclass.M0.State)) ($IsBox |env#0@@5| Tclass.M0.Env)) (M0.__default.ValidEnv (Lit BoxType |env#0@@5|))))) (and (and (|M0.__default.Value#canCall| (Lit DatatypeTypeType |expr#0|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.__default.Value (Lit DatatypeTypeType |expr#0|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0|))))) (|M0.__default.GetEnv#canCall| (Lit BoxType (M0.Expression.id (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |env#0@@5|))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIf_q (Lit DatatypeTypeType |expr#0|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|)) (let ((|st'#8| (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@6) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|))))))
(let ((|cond'#2| ($Unbox DatatypeTypeType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@6) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|)))))))
 (and (and (=> (M0.Expression.exprLiteral_q |cond'#2|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#2|))) (=> (and (M0.Expression.exprLiteral_q |cond'#2|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#2|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.ifTrue (Lit DatatypeTypeType |expr#0|))) |st'#8| (Lit BoxType |env#0@@5|)))) (=> (not (and (M0.Expression.exprLiteral_q |cond'#2|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#2|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |cond'#2|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#2|))) (=> (and (M0.Expression.exprLiteral_q |cond'#2|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#2|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.ifFalse (Lit DatatypeTypeType |expr#0|))) |st'#8| (Lit BoxType |env#0@@5|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIf_q (Lit DatatypeTypeType |expr#0|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|)) (let ((|st'#9| (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@6) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|))))))
(let ((|conj0'#2| ($Unbox DatatypeTypeType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@6) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|)))))))
 (and (and (=> (M0.Expression.exprLiteral_q |conj0'#2|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#2|))) (=> (and (M0.Expression.exprLiteral_q |conj0'#2|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#2|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.conj1 (Lit DatatypeTypeType |expr#0|))) |st'#9| (Lit BoxType |env#0@@5|)))) (=> (not (and (M0.Expression.exprLiteral_q |conj0'#2|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#2|) |#M0.Literal.litTrue|))) (=> (M0.Expression.exprLiteral_q |conj0'#2|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#2|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprOr_q (Lit DatatypeTypeType |expr#0|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|)) (let ((|st'#10| (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@6) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|))))))
(let ((|disj0'#2| ($Unbox DatatypeTypeType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@6) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|)))))))
 (and (=> (M0.Expression.exprLiteral_q |disj0'#2|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#2|))) (=> (not (and (M0.Expression.exprLiteral_q |disj0'#2|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#2|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |disj0'#2|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#2|))) (=> (and (M0.Expression.exprLiteral_q |disj0'#2|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#2|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.disj1 (Lit DatatypeTypeType |expr#0|))) |st'#10| (Lit BoxType |env#0@@5|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprOr_q (Lit DatatypeTypeType |expr#0|)))))) (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|)) (let ((|st'#11| (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@6) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|))))))
(let ((|fun'#2| ($Unbox DatatypeTypeType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@6) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|)))))))
 (and (|M0.__default.evalArgs#canCall| (Lit DatatypeTypeType |expr#0|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|)) (let ((|sts'#2| ($Unbox SetType (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.evalArgs ($LS $ly@@6) (Lit DatatypeTypeType |expr#0|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|)))))))
(let ((|args'#2| ($Unbox SeqType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.evalArgs ($LS $ly@@6) (Lit DatatypeTypeType |expr#0|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|)))))))
(let ((|sts''#2| (|Set#Union| (|Set#UnionOne| |Set#Empty| |st'#11|) |sts'#2|)))
 ...
 (and (M0.Tuple.Pair_q |ps#2|) (M0.Tuple.Pair_q |ps#2|)))))))))))))))))))))))))))))) (= (M0.__default.eval ($LS $ly@@6) (Lit DatatypeTypeType |expr#0|) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|)) (ite (M0.__default.Value (Lit DatatypeTypeType |expr#0|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType |expr#0|)) (Lit BoxType |st#0@@11|)) (ite (M0.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (M0.__default.GetEnv (Lit BoxType (M0.Expression.id (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |env#0@@5|))) (Lit BoxType |st#0@@11|)) (ite (M0.Expression.exprIf_q (Lit DatatypeTypeType |expr#0|)) (let ((|st'#8@@0| (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@6) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|))))))
(let ((|cond'#2@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@6) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|)))))))
(ite  (and (M0.Expression.exprLiteral_q |cond'#2@@0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#2@@0|) |#M0.Literal.litTrue|)) (M0.__default.eval ($LS $ly@@6) (Lit DatatypeTypeType (M0.Expression.ifTrue (Lit DatatypeTypeType |expr#0|))) |st'#8@@0| (Lit BoxType |env#0@@5|)) (ite  (and (M0.Expression.exprLiteral_q |cond'#2@@0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#2@@0|) |#M0.Literal.litFalse|)) (M0.__default.eval ($LS $ly@@6) (Lit DatatypeTypeType (M0.Expression.ifFalse (Lit DatatypeTypeType |expr#0|))) |st'#8@@0| (Lit BoxType |env#0@@5|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) (Lit BoxType |st#0@@11|)))))) (ite (M0.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0|)) (let ((|st'#9@@0| (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@6) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|))))))
(let ((|conj0'#2@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@6) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|)))))))
(ite  (and (M0.Expression.exprLiteral_q |conj0'#2@@0|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#2@@0|) |#M0.Literal.litTrue|)) (M0.__default.eval ($LS $ly@@6) (Lit DatatypeTypeType (M0.Expression.conj1 (Lit DatatypeTypeType |expr#0|))) |st'#9@@0| (Lit BoxType |env#0@@5|)) (ite  (and (M0.Expression.exprLiteral_q |conj0'#2@@0|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#2@@0|) |#M0.Literal.litFalse|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprLiteral| (Lit DatatypeTypeType |#M0.Literal.litFalse|)))) |st'#9@@0|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) (Lit BoxType |st#0@@11|)))))) (ite (M0.Expression.exprOr_q (Lit DatatypeTypeType |expr#0|)) (let ((|st'#10@@0| (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@6) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|))))))
(let ((|disj0'#2@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@6) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|)))))))
(ite  (and (M0.Expression.exprLiteral_q |disj0'#2@@0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#2@@0|) |#M0.Literal.litTrue|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprLiteral| (Lit DatatypeTypeType |#M0.Literal.litTrue|)))) |st'#10@@0|) (ite  (and (M0.Expression.exprLiteral_q |disj0'#2@@0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#2@@0|) |#M0.Literal.litFalse|)) (M0.__default.eval ($LS $ly@@6) (Lit DatatypeTypeType (M0.Expression.disj1 (Lit DatatypeTypeType |expr#0|))) |st'#10@@0| (Lit BoxType |env#0@@5|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) (Lit BoxType |st#0@@11|)))))) (ite (M0.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0|)) (let ((|st'#11@@0| (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@6) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|))))))
(let ((|fun'#2@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@6) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|)))))))
(let ((|sts'#2@@0| ($Unbox SetType (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.evalArgs ($LS $ly@@6) (Lit DatatypeTypeType |expr#0|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|)))))))
(let ((|args'#2@@0| ($Unbox SeqType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.evalArgs ($LS $ly@@6) (Lit DatatypeTypeType |expr#0|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|)))))))
(let ((|sts''#2@@0| (|Set#Union| (|Set#UnionOne| |Set#Empty| |st'#11@@0|) |sts'#2@@0|)))
(ite  (not (M0.__default.Compatible |sts''#2@@0|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rCompatibility|)))) (Lit BoxType |st#0@@11|)) (let ((|stCombined#2@@0| (M0.__default.Combine ($LS $LZ) |sts''#2@@0|)))
...
(|#M0.Tuple.Pair| ($Box DatatypeTypeType (|#M0.Expression.exprLiteral| (|#M0.Literal.litArrOfPaths| ($Unbox SetType (M0.Tuple.fst |ps#2@@0|))))) (M0.Tuple.snd |ps#2@@0|))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) (Lit BoxType |st#0@@11|))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) (Lit BoxType |st#0@@11|))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) (Lit BoxType |st#0@@11|)))))))))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) (Lit BoxType |st#0@@11|)))))))))))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :weight 3
 :skolemid |976|
 :pattern ( (M0.__default.eval ($LS $ly@@6) (Lit DatatypeTypeType |expr#0|) (Lit BoxType |st#0@@11|) (Lit BoxType |env#0@@5|)))
))))
...
(assert (forall ((d@@43 T@U) ) (!  (=> (M0.Program.Program_q d@@43) (exists ((|a#1#0#0| T@U) ) (! (= d@@43 (|#M0.Program.Program| |a#1#0#0|))
 :qid |CloudMakeParallelBuildsdfy.128:30|
 :skolemid |1122|
)))
 :qid |unknown.0:0|
 :skolemid |1123|
 :pattern ( (M0.Program.Program_q d@@43))
)))
(assert (forall ((d@@44 T@U) ) (!  (=> (M0.Statement.stmtReturn_q d@@44) (exists ((|a#15#0#0| T@U) ) (! (= d@@44 (|#M0.Statement.stmtReturn| |a#15#0#0|))
 :qid |CloudMakeParallelBuildsdfy.131:35|
 :skolemid |1149|
)))
 :qid |unknown.0:0|
 :skolemid |1150|
 :pattern ( (M0.Statement.stmtReturn_q d@@44))
)))
(assert (forall ((d@@45 T@U) ) (!  (=> (M0.Expression.exprLiteral_q d@@45) (exists ((|a#21#0#0| T@U) ) (! (= d@@45 (|#M0.Expression.exprLiteral| |a#21#0#0|))
 :qid |CloudMakeParallelBuildsdfy.133:37|
 :skolemid |1164|
)))
 :qid |unknown.0:0|
 :skolemid |1165|
 :pattern ( (M0.Expression.exprLiteral_q d@@45))
)))
(assert (forall ((d@@46 T@U) ) (!  (=> (M0.Expression.exprIdentifier_q d@@46) (exists ((|a#27#0#0| T@U) ) (! (= d@@46 (|#M0.Expression.exprIdentifier| |a#27#0#0|))
 :qid |CloudMakeParallelBuildsdfy.133:68|
 :skolemid |1175|
)))
 :qid |unknown.0:0|
 :skolemid |1176|
 :pattern ( (M0.Expression.exprIdentifier_q d@@46))
)))
(assert (forall ((d@@47 T@U) ) (!  (=> (M0.Expression.exprError_q d@@47) (exists ((|a#67#0#0| T@U) ) (! (= d@@47 (|#M0.Expression.exprError| |a#67#0#0|))
 :qid |CloudMakeParallelBuildsdfy.138:35|
 :skolemid |1240|
)))
 :qid |unknown.0:0|
 :skolemid |1241|
 :pattern ( (M0.Expression.exprError_q d@@47))
)))
(assert (forall ((d@@48 T@U) ) (!  (=> (M0.Literal.litNumber_q d@@48) (exists ((|a#89#0#0| Int) ) (! (= d@@48 (|#M0.Literal.litNumber| |a#89#0#0|))
 :qid |CloudMakeParallelBuildsdfy.141:32|
 :skolemid |1273|
)))
 :qid |unknown.0:0|
 :skolemid |1274|
 :pattern ( (M0.Literal.litNumber_q d@@48))
)))
(assert (forall ((d@@49 T@U) ) (!  (=> (M0.Literal.litString_q d@@49) (exists ((|a#94#0#0| T@U) ) (! (= d@@49 (|#M0.Literal.litString| |a#94#0#0|))
 :qid |CloudMakeParallelBuildsdfy.141:54|
 :skolemid |1282|
)))
 :qid |unknown.0:0|
 :skolemid |1283|
 :pattern ( (M0.Literal.litString_q d@@49))
)))
(assert (forall ((d@@50 T@U) ) (!  (=> (M0.Literal.litPrimitive_q d@@50) (exists ((|a#101#0#0| T@U) ) (! (= d@@50 (|#M0.Literal.litPrimitive| |a#101#0#0|))
 :qid |CloudMakeParallelBuildsdfy.142:35|
 :skolemid |1293|
)))
 :qid |unknown.0:0|
 :skolemid |1294|
 :pattern ( (M0.Literal.litPrimitive_q d@@50))
)))
(assert (forall ((d@@51 T@U) ) (!  (=> (M0.Literal.litArrOfPaths_q d@@51) (exists ((|a#107#0#0| T@U) ) (! (= d@@51 (|#M0.Literal.litArrOfPaths| |a#107#0#0|))
 :qid |CloudMakeParallelBuildsdfy.145:36|
 :skolemid |1303|
)))
 :qid |unknown.0:0|
 :skolemid |1304|
 :pattern ( (M0.Literal.litArrOfPaths_q d@@51))
)))
(assert (forall ((d@@52 T@U) ) (!  (=> (M0.Literal.litArrOfStrings_q d@@52) (exists ((|a#113#0#0| T@U) ) (! (= d@@52 (|#M0.Literal.litArrOfStrings| |a#113#0#0|))
 :qid |CloudMakeParallelBuildsdfy.146:38|
 :skolemid |1313|
)))
 :qid |unknown.0:0|
 :skolemid |1314|
 :pattern ( (M0.Literal.litArrOfStrings_q d@@52))
)))
(assert (forall ((d@@53 T@U) ) (!  (=> (M0.Literal.litArray_q d@@53) (exists ((|a#119#0#0| T@U) ) (! (= d@@53 (|#M0.Literal.litArray| |a#119#0#0|))
 :qid |CloudMakeParallelBuildsdfy.147:31|
 :skolemid |1323|
)))
 :qid |unknown.0:0|
 :skolemid |1324|
 :pattern ( (M0.Literal.litArray_q d@@53))
)))
(assert (forall ((d@@54 T@U) ) (!  (=> ($Is DatatypeTypeType d@@54 Tclass.M0.Expression) (or (or (or (or (or (or (M0.Expression.exprLiteral_q d@@54) (M0.Expression.exprIdentifier_q d@@54)) (M0.Expression.exprIf_q d@@54)) (M0.Expression.exprAnd_q d@@54)) (M0.Expression.exprOr_q d@@54)) (M0.Expression.exprInvocation_q d@@54)) (M0.Expression.exprError_q d@@54)))
 :qid |unknown.0:0|
 :skolemid |1250|
 :pattern ( (M0.Expression.exprError_q d@@54) ($Is DatatypeTypeType d@@54 Tclass.M0.Expression))
 :pattern ( (M0.Expression.exprInvocation_q d@@54) ($Is DatatypeTypeType d@@54 Tclass.M0.Expression))
 :pattern ( (M0.Expression.exprOr_q d@@54) ($Is DatatypeTypeType d@@54 Tclass.M0.Expression))
 :pattern ( (M0.Expression.exprAnd_q d@@54) ($Is DatatypeTypeType d@@54 Tclass.M0.Expression))
 :pattern ( (M0.Expression.exprIf_q d@@54) ($Is DatatypeTypeType d@@54 Tclass.M0.Expression))
 :pattern ( (M0.Expression.exprIdentifier_q d@@54) ($Is DatatypeTypeType d@@54 Tclass.M0.Expression))
 :pattern ( (M0.Expression.exprLiteral_q d@@54) ($Is DatatypeTypeType d@@54 Tclass.M0.Expression))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|cmd#0@@2| T@U) (|deps#0@@2| T@U) (|exps#0@@1| T@U) (|st#0@@12| T@U) ) (!  (=> (or (|M0.__default.Pre#canCall| (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) (Lit SetType |exps#0@@1|) (Lit BoxType |st#0@@12|)) (and (< 2 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@2| (TSeq TChar)) ($Is SetType |deps#0@@2| (TSet Tclass.M0.Path))) ($Is SetType |exps#0@@1| (TSet (TSeq TChar)))) ($IsBox |st#0@@12| Tclass.M0.State)))) (and (forall ((|e#2| T@U) ) (!  (=> ($Is SeqType |e#2| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@1|) ($Box SeqType |e#2|)) (and (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#2|) (|M0.__default.DomSt#canCall| (Lit BoxType |st#0@@12|))) (=> (|Set#IsMember| (M0.__default.DomSt (Lit BoxType |st#0@@12|)) (M0.__default.Loc (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#2|)) (and (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#2|) (|M0.__default.GetSt#canCall| (M0.__default.Loc (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#2|) (Lit BoxType |st#0@@12|))) (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#2|) (|M0.__default.Oracle#canCall| (M0.__default.Loc (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#2|) (Lit BoxType |st#0@@12|))))))))
...
)) (= (M0.__default.Pre (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) (Lit SetType |exps#0@@1|) (Lit BoxType |st#0@@12|)) (forall ((|e#2@@0| T@U) ) (!  (=> ($Is SeqType |e#2@@0| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@1|) ($Box SeqType |e#2@@0|)) (=> (|Set#IsMember| (M0.__default.DomSt (Lit BoxType |st#0@@12|)) (M0.__default.Loc (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#2@@0|)) (= (M0.__default.GetSt (M0.__default.Loc (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#2@@0|) (Lit BoxType |st#0@@12|)) (M0.__default.Oracle (M0.__default.Loc (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#2@@0|) (Lit BoxType |st#0@@12|))))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |824|
 ...
 :weight 3
 :skolemid |826|
 :pattern ( (M0.__default.Pre (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) (Lit SetType |exps#0@@1|) (Lit BoxType |st#0@@12|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|cmd#0@@3| T@U) (|deps#0@@3| T@U) (|exps#0@@2| T@U) (|st#0@@13| T@U) ) (!  (=> (or (|M0.__default.exec#canCall| |cmd#0@@3| |deps#0@@3| |exps#0@@2| |st#0@@13|) (and (< 1 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@3| (TSeq TChar)) ($Is SetType |deps#0@@3| (TSet Tclass.M0.Path))) ($Is SetType |exps#0@@2| (TSet (TSeq TChar)))) ($IsBox |st#0@@13| Tclass.M0.State)))) ($Is DatatypeTypeType (M0.__default.exec |cmd#0@@3| |deps#0@@3| |exps#0@@2| |st#0@@13|) (Tclass.M0.Tuple (TSet Tclass.M0.Path) Tclass.M0.State)))
 :qid |CloudMakeParallelBuildsdfy.69:23|
 :skolemid |799|
 :pattern ( (M0.__default.exec |cmd#0@@3| |deps#0@@3| |exps#0@@2| |st#0@@13|))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall ((|prog#0| T@U) (|st#0@@14| T@U) ) (!  (=> (or (|M0.__default.build#canCall| |prog#0| |st#0@@14|) (and (< 6 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |prog#0| Tclass.M0.Program) ($IsBox |st#0@@14| Tclass.M0.State)) (M0.__default.Legal (M0.Program.stmts |prog#0|))))) ($Is DatatypeTypeType (M0.__default.build |prog#0| |st#0@@14|) (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State)))
 :qid |CloudMakeParallelBuildsdfy.170:24|
 :skolemid |939|
 :pattern ( (M0.__default.build |prog#0| |st#0@@14|))
))))
...
(assert (forall ((d@@55 T@U) ) (!  (=> ($Is DatatypeTypeType d@@55 Tclass.M0.Literal) (or (or (or (or (or (or (or (or (or (M0.Literal.litTrue_q d@@55) (M0.Literal.litFalse_q d@@55)) (M0.Literal.litUndefined_q d@@55)) (M0.Literal.litNull_q d@@55)) (M0.Literal.litNumber_q d@@55)) (M0.Literal.litString_q d@@55)) (M0.Literal.litPrimitive_q d@@55)) (M0.Literal.litArrOfPaths_q d@@55)) (M0.Literal.litArrOfStrings_q d@@55)) (M0.Literal.litArray_q d@@55)))
 :qid |unknown.0:0|
 :skolemid |1333|
 :pattern ( (M0.Literal.litArray_q d@@55) ($Is DatatypeTypeType d@@55 Tclass.M0.Literal))
 :pattern ( (M0.Literal.litArrOfStrings_q d@@55) ($Is DatatypeTypeType d@@55 Tclass.M0.Literal))
 :pattern ( (M0.Literal.litArrOfPaths_q d@@55) ($Is DatatypeTypeType d@@55 Tclass.M0.Literal))
 :pattern ( (M0.Literal.litPrimitive_q d@@55) ($Is DatatypeTypeType d@@55 Tclass.M0.Literal))
 :pattern ( (M0.Literal.litString_q d@@55) ($Is DatatypeTypeType d@@55 Tclass.M0.Literal))
 :pattern ( (M0.Literal.litNumber_q d@@55) ($Is DatatypeTypeType d@@55 Tclass.M0.Literal))
 :pattern ( (M0.Literal.litNull_q d@@55) ($Is DatatypeTypeType d@@55 Tclass.M0.Literal))
 :pattern ( (M0.Literal.litUndefined_q d@@55) ($Is DatatypeTypeType d@@55 Tclass.M0.Literal))
 :pattern ( (M0.Literal.litFalse_q d@@55) ($Is DatatypeTypeType d@@55 Tclass.M0.Literal))
 :pattern ( (M0.Literal.litTrue_q d@@55) ($Is DatatypeTypeType d@@55 Tclass.M0.Literal))
)))
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@7 T@U) (|stmts#0@@3| T@U) (|st#0@@15| T@U) (|env#0@@7| T@U) ) (!  (=> (or (|M0.__default.do#canCall| (Lit SeqType |stmts#0@@3|) |st#0@@15| |env#0@@7|) (and (< 5 $FunctionContextHeight) (and (and (and ($Is SeqType |stmts#0@@3| (TSeq Tclass.M0.Statement)) ($IsBox |st#0@@15| Tclass.M0.State)) ($IsBox |env#0@@7| Tclass.M0.Env)) (and (M0.__default.Legal (Lit SeqType |stmts#0@@3|)) (M0.__default.ValidEnv |env#0@@7|))))) (and (let ((|stmt#1| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |stmts#0@@3|) (LitInt 0)))))
 (and (=> (M0.Statement.stmtVariable_q |stmt#1|) (and (|M0.__default.eval#canCall| (M0.Statement.expr |stmt#1|) |st#0@@15| |env#0@@7|) (let ((|st'#1| (M0.Tuple.snd (M0.__default.eval ($LS $LZ) (M0.Statement.expr |stmt#1|) |st#0@@15| |env#0@@7|))))
(let ((|expr'#1| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $LZ) (M0.Statement.expr |stmt#1|) |st#0@@15| |env#0@@7|)))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|cmd#0@@4| T@U) (|deps#0@@4| T@U) (|exps#0@@3| T@U) (|st#0@@16| T@U) ) (!  (=> (or (|M0.__default.Pre#canCall| (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) (Lit SetType |exps#0@@3|) |st#0@@16|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@4| (TSeq TChar)) ($Is SetType |deps#0@@4| (TSet Tclass.M0.Path))) ($Is SetType |exps#0@@3| (TSet (TSeq TChar)))) ($IsBox |st#0@@16| Tclass.M0.State)))) (and (forall ((|e#1| T@U) ) (!  (=> ($Is SeqType |e#1| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@3|) ($Box SeqType |e#1|)) (and (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1|) (|M0.__default.DomSt#canCall| |st#0@@16|)) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@16|) (M0.__default.Loc (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1|)) (and (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1|) (|M0.__default.GetSt#canCall| (M0.__default.Loc (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1|) |st#0@@16|)) (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1|) (|M0.__default.Oracle#canCall| (M0.__default.Loc (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1|) |st#0@@16|)))))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |822|
 :pattern ( (M0.__default.Loc |cmd#0@@4| |deps#0@@4| |e#1|))
 :pattern ( (|Set#IsMember| |exps#0@@3| ($Box SeqType |e#1|)))
)) (= (M0.__default.Pre (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) (Lit SetType |exps#0@@3|) |st#0@@16|) (forall ((|e#1@@0| T@U) ) (!  (=> ($Is SeqType |e#1@@0| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@3|) ($Box SeqType |e#1@@0|)) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@16|) (M0.__default.Loc (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1@@0|)) (= (M0.__default.GetSt (M0.__default.Loc (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1@@0|) |st#0@@16|) (M0.__default.Oracle (M0.__default.Loc (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1@@0|) |st#0@@16|)))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |821|
 ...
 :weight 3
 :skolemid |823|
 :pattern ( (M0.__default.Pre (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) (Lit SetType |exps#0@@3|) |st#0@@16|))
))))
...
(assert (forall ((d@@56 T@U) ) (!  (=> (|$IsA#M0.Reason| d@@56) (or (M0.Reason.rCompatibility_q d@@56) (M0.Reason.rValidity_q d@@56)))
 :qid |unknown.0:0|
 :skolemid |1360|
 :pattern ( (|$IsA#M0.Reason| d@@56))
)))
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($Heap@@7 T@U) (|prog#0@@0| T@U) (|st#0@@17| T@U) ) (!  (=> (and (or (|M0.__default.build#canCall| |prog#0@@0| |st#0@@17|) (and (< 6 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |prog#0@@0| Tclass.M0.Program) ($IsAlloc DatatypeTypeType |prog#0@@0| Tclass.M0.Program $Heap@@7)) (and ($IsBox |st#0@@17| Tclass.M0.State) ($IsAllocBox |st#0@@17| Tclass.M0.State $Heap@@7))) (M0.__default.Legal (M0.Program.stmts |prog#0@@0|))))) ($IsGoodHeap $Heap@@7)) ($IsAlloc DatatypeTypeType (M0.__default.build |prog#0@@0| |st#0@@17|) (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State) $Heap@@7))
 :qid |CloudMakeParallelBuildsdfy.170:18|
 :skolemid |940|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.__default.build |prog#0@@0| |st#0@@17|) (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State) $Heap@@7))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall ((|prog#0@@1| T@U) (|st#0@@18| T@U) ) (!  (=> (or (|M0.__default.build#canCall| |prog#0@@1| |st#0@@18|) (and (< 6 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |prog#0@@1| Tclass.M0.Program) ($IsBox |st#0@@18| Tclass.M0.State)) (M0.__default.Legal (M0.Program.stmts |prog#0@@1|))))) (and (and (and (M0.Program.Program_q |prog#0@@1|) |M0.__default.EmptyEnv#canCall|) (|M0.__default.do#canCall| (M0.Program.stmts |prog#0@@1|) |st#0@@18| M0.__default.EmptyEnv)) (= (M0.__default.build |prog#0@@1| |st#0@@18|) (M0.__default.do ($LS $LZ) (M0.Program.stmts |prog#0@@1|) |st#0@@18| M0.__default.EmptyEnv))))
 :qid |CloudMakeParallelBuildsdfy.170:24|
 :skolemid |942|
 :pattern ( (M0.__default.build |prog#0@@1| |st#0@@18|))
))))
...
(assert (forall ((d@@59 T@U) ) (!  (=> ($Is DatatypeTypeType d@@59 Tclass.M0.Reason) (or (M0.Reason.rCompatibility_q d@@59) (M0.Reason.rValidity_q d@@59)))
 :qid |unknown.0:0|
 :skolemid |1361|
 :pattern ( (M0.Reason.rValidity_q d@@59) ($Is DatatypeTypeType d@@59 Tclass.M0.Reason))
 :pattern ( (M0.Reason.rCompatibility_q d@@59) ($Is DatatypeTypeType d@@59 Tclass.M0.Reason))
)))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall ((|prog#0@@2| T@U) (|st#0@@19| T@U) ) (!  (=> (or (|M0.__default.build#canCall| (Lit DatatypeTypeType |prog#0@@2|) |st#0@@19|) (and (< 6 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |prog#0@@2| Tclass.M0.Program) ($IsBox |st#0@@19| Tclass.M0.State)) (U_2_bool (Lit boolType (bool_2_U (M0.__default.Legal (Lit SeqType (M0.Program.stmts (Lit DatatypeTypeType |prog#0@@2|)))))))))) (and (and (and (M0.Program.Program_q (Lit DatatypeTypeType |prog#0@@2|)) |M0.__default.EmptyEnv#canCall|) (|M0.__default.do#canCall| (Lit SeqType (M0.Program.stmts (Lit DatatypeTypeType |prog#0@@2|))) |st#0@@19| M0.__default.EmptyEnv)) (= (M0.__default.build (Lit DatatypeTypeType |prog#0@@2|) |st#0@@19|) (M0.__default.do ($LS $LZ) (Lit SeqType (M0.Program.stmts (Lit DatatypeTypeType |prog#0@@2|))) |st#0@@19| M0.__default.EmptyEnv))))
 :qid |CloudMakeParallelBuildsdfy.170:24|
 :weight 3
 :skolemid |943|
 :pattern ( (M0.__default.build (Lit DatatypeTypeType |prog#0@@2|) |st#0@@19|))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@10 T@U) (|expr#0@@2| T@U) (|st#0@@20| T@U) (|env#0@@11| T@U) ) (!  (=> (or (|M0.__default.eval#canCall| |expr#0@@2| |st#0@@20| |env#0@@11|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0@@2| Tclass.M0.Expression) ($IsBox |st#0@@20| Tclass.M0.State)) ($IsBox |env#0@@11| Tclass.M0.Env)) (M0.__default.ValidEnv |env#0@@11|)))) ($Is DatatypeTypeType (M0.__default.eval $ly@@10 |expr#0@@2| |st#0@@20| |env#0@@11|) (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State)))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |971|
 :pattern ( (M0.__default.eval $ly@@10 |expr#0@@2| |st#0@@20| |env#0@@11|))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@11 T@U) (|stmts#0@@4| T@U) (|st#0@@21| T@U) (|env#0@@12| T@U) ) (!  (=> (or (|M0.__default.do#canCall| |stmts#0@@4| |st#0@@21| |env#0@@12|) (and (< 5 $FunctionContextHeight) (and (and (and ($Is SeqType |stmts#0@@4| (TSeq Tclass.M0.Statement)) ($IsBox |st#0@@21| Tclass.M0.State)) ($IsBox |env#0@@12| Tclass.M0.Env)) (and (M0.__default.Legal |stmts#0@@4|) (M0.__default.ValidEnv |env#0@@12|))))) ($Is DatatypeTypeType (M0.__default.do $ly@@11 |stmts#0@@4| |st#0@@21| |env#0@@12|) (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State)))
 :qid |CloudMakeParallelBuildsdfy.177:18|
 :skolemid |951|
 :pattern ( (M0.__default.do $ly@@11 |stmts#0@@4| |st#0@@21| |env#0@@12|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|sts#0@@2| T@U) ) (!  (=> (or (|M0.__default.Compatible#canCall| |sts#0@@2|) (and (< 2 $FunctionContextHeight) ($Is SetType |sts#0@@2| (TSet Tclass.M0.State)))) (and (forall ((|st#0@@22| T@U) (|st'#0@@3| T@U) (|p#0@@5| T@U) ) (!  (=> (and (and ($IsBox |st#0@@22| Tclass.M0.State) ($IsBox |st'#0@@3| Tclass.M0.State)) ($IsBox |p#0@@5| Tclass.M0.Path)) (=> (|Set#IsMember| |sts#0@@2| |st#0@@22|) (=> (|Set#IsMember| |sts#0@@2| |st'#0@@3|) (and (|M0.__default.DomSt#canCall| |st#0@@22|) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@22|) |p#0@@5|) (and (|M0.__default.DomSt#canCall| |st'#0@@3|) (=> (|Set#IsMember| (M0.__default.DomSt |st'#0@@3|) |p#0@@5|) (and (|M0.__default.GetSt#canCall| |p#0@@5| |st#0@@22|) (|M0.__default.GetSt#canCall| |p#0@@5| |st'#0@@3|)))))))))
 :qid |CloudMakeParallelBuildsdfy.32:12|
 :skolemid |729|
 :pattern ( (M0.__default.GetSt |p#0@@5| |st'#0@@3|) (M0.__default.GetSt |p#0@@5| |st#0@@22|))
 :pattern ( (M0.__default.GetSt |p#0@@5| |st'#0@@3|) (M0.__default.DomSt |st#0@@22|))
 :pattern ( (M0.__default.GetSt |p#0@@5| |st'#0@@3|) (|Set#IsMember| |sts#0@@2| |st#0@@22|))
 :pattern ( (M0.__default.GetSt |p#0@@5| |st#0@@22|) (M0.__default.DomSt |st'#0@@3|))
 :pattern ( (M0.__default.GetSt |p#0@@5| |st#0@@22|) (|Set#IsMember| |sts#0@@2| |st'#0@@3|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@3|) |p#0@@5|) (M0.__default.DomSt |st#0@@22|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@3|) |p#0@@5|) (|Set#IsMember| |sts#0@@2| |st#0@@22|))
 :pattern ( (M0.__default.DomSt |st'#0@@3|) (|Set#IsMember| (M0.__default.DomSt |st#0@@22|) |p#0@@5|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@22|) |p#0@@5|) (|Set#IsMember| |sts#0@@2| |st'#0@@3|))
)) (= (M0.__default.Compatible |sts#0@@2|) (forall ((|st#0@@23| T@U) (|st'#0@@4| T@U) (|p#0@@6| T@U) ) (!  (=> (and (and ($IsBox |st#0@@23| Tclass.M0.State) ($IsBox |st'#0@@4| Tclass.M0.State)) ($IsBox |p#0@@6| Tclass.M0.Path)) (=> (and (and (and (|Set#IsMember| |sts#0@@2| |st#0@@23|) (|Set#IsMember| |sts#0@@2| |st'#0@@4|)) (|Set#IsMember| (M0.__default.DomSt |st#0@@23|) |p#0@@6|)) (|Set#IsMember| (M0.__default.DomSt |st'#0@@4|) |p#0@@6|)) (= (M0.__default.GetSt |p#0@@6| |st#0@@23|) (M0.__default.GetSt |p#0@@6| |st'#0@@4|))))
 :qid |CloudMakeParallelBuildsdfy.32:12|
 :skolemid |728|
 :pattern ( (M0.__default.GetSt |p#0@@6| |st'#0@@4|) (M0.__default.GetSt |p#0@@6| |st#0@@23|))
 :pattern ( (M0.__default.GetSt |p#0@@6| |st'#0@@4|) (M0.__default.DomSt |st#0@@23|))
 :pattern ( (M0.__default.GetSt |p#0@@6| |st'#0@@4|) (|Set#IsMember| |sts#0@@2| |st#0@@23|))
 :pattern ( (M0.__default.GetSt |p#0@@6| |st#0@@23|) (M0.__default.DomSt |st'#0@@4|))
 :pattern ( (M0.__default.GetSt |p#0@@6| |st#0@@23|) (|Set#IsMember| |sts#0@@2| |st'#0@@4|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@4|) |p#0@@6|) (M0.__default.DomSt |st#0@@23|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@4|) |p#0@@6|) (|Set#IsMember| |sts#0@@2| |st#0@@23|))
 :pattern ( (M0.__default.DomSt |st'#0@@4|) (|Set#IsMember| (M0.__default.DomSt |st#0@@23|) |p#0@@6|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@23|) |p#0@@6|) (|Set#IsMember| |sts#0@@2| |st'#0@@4|))
)))))
 :qid |CloudMakeParallelBuildsdfy.30:30|
 :skolemid |730|
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@12 T@U) (|expr#0@@4| T@U) (|st#0@@24| T@U) (|env#0@@14| T@U) ) (!  (=> (or (|M0.__default.eval#canCall| |expr#0@@4| |st#0@@24| |env#0@@14|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0@@4| Tclass.M0.Expression) ($IsBox |st#0@@24| Tclass.M0.State)) ($IsBox |env#0@@14| Tclass.M0.Env)) (M0.__default.ValidEnv |env#0@@14|)))) (and (and (|M0.__default.Value#canCall| |expr#0@@4|) (=> (not (M0.__default.Value |expr#0@@4|)) (and (=> (M0.Expression.exprIdentifier_q |expr#0@@4|) (|M0.__default.GetEnv#canCall| (M0.Expression.id |expr#0@@4|) |env#0@@14|)) (=> (not (M0.Expression.exprIdentifier_q |expr#0@@4|)) (and (=> (M0.Expression.exprIf_q |expr#0@@4|) (and (|M0.__default.eval#canCall| (M0.Expression.cond |expr#0@@4|) |st#0@@24| |env#0@@14|) (let ((|st'#0@@5| (M0.Tuple.snd (M0.__default.eval $ly@@12 (M0.Expression.cond |expr#0@@4|) |st#0@@24| |env#0@@14|))))
(let ((|cond'#0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@12 (M0.Expression.cond |expr#0@@4|) |st#0@@24| |env#0@@14|)))))
 (and (and (=> (M0.Expression.exprLiteral_q |cond'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#0|))) (=> (and (M0.Expression.exprLiteral_q |cond'#0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#0|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (M0.Expression.ifTrue |expr#0@@4|) |st'#0@@5| |env#0@@14|))) (=> (not (and (M0.Expression.exprLiteral_q |cond'#0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#0|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |cond'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#0|))) (=> (and (M0.Expression.exprLiteral_q |cond'#0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#0|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (M0.Expression.ifFalse |expr#0@@4|) |st'#0@@5| |env#0@@14|))))))))) (=> (not (M0.Expression.exprIf_q |expr#0@@4|)) (and (=> (M0.Expression.exprAnd_q |expr#0@@4|) (and (|M0.__default.eval#canCall| (M0.Expression.conj0 |expr#0@@4|) |st#0@@24| |env#0@@14|) (let ((|st'#1@@3| (M0.Tuple.snd (M0.__default.eval $ly@@12 (M0.Expression.conj0 |expr#0@@4|) |st#0@@24| |env#0@@14|))))
(let ((|conj0'#0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@12 (M0.Expression.conj0 |expr#0@@4|) |st#0@@24| |env#0@@14|)))))
 (and (and (=> (M0.Expression.exprLiteral_q |conj0'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#0|))) (=> (and (M0.Expression.exprLiteral_q |conj0'#0|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#0|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (M0.Expression.conj1 |expr#0@@4|) |st'#1@@3| |env#0@@14|))) (=> (not (and (M0.Expression.exprLiteral_q |conj0'#0|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#0|) |#M0.Literal.litTrue|))) (=> (M0.Expression.exprLiteral_q |conj0'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#0|))))))))) (=> (not (M0.Expression.exprAnd_q |expr#0@@4|)) (and (=> (M0.Expression.exprOr_q |expr#0@@4|) (and (|M0.__default.eval#canCall| (M0.Expression.disj0 |expr#0@@4|) |st#0@@24| |env#0@@14|) (let ((|st'#2| (M0.Tuple.snd (M0.__default.eval $ly@@12 (M0.Expression.disj0 |expr#0@@4|) |st#0@@24| |env#0@@14|))))
(let ((|disj0'#0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@12 (M0.Expression.disj0 |expr#0@@4|) |st#0@@24| |env#0@@14|)))))
 (and (=> (M0.Expression.exprLiteral_q |disj0'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#0|))) (=> (not (and (M0.Expression.exprLiteral_q |disj0'#0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#0|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |disj0'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#0|))) (=> (and (M0.Expression.exprLiteral_q |disj0'#0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#0|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (M0.Expression.disj1 |expr#0@@4|) |st'#2| |env#0@@14|))))))))) (=> (not (M0.Expression.exprOr_q |expr#0@@4|)) (=> (M0.Expression.exprInvocation_q |expr#0@@4|) (and (|M0.__default.eval#canCall| (M0.Expression.fun |expr#0@@4|) |st#0@@24| |env#0@@14|) (let ((|st'#3| (M0.Tuple.snd (M0.__default.eval $ly@@12 (M0.Expression.fun |expr#0@@4|) |st#0@@24| |env#0@@14|))))
(let ((|fun'#0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@12 (M0.Expression.fun |expr#0@@4|) |st#0@@24| |env#0@@14|)))))
 (and (|M0.__default.evalArgs#canCall| |expr#0@@4| (M0.Expression.args |expr#0@@4|) |st#0@@24| |env#0@@14|) (let ((|sts'#0| ($Unbox SetType (M0.Tuple.snd (M0.__default.evalArgs $ly@@12 |expr#0@@4| (M0.Expression.args |expr#0@@4|) |st#0@@24| |env#0@@14|)))))
(let ((|args'#0| ($Unbox SeqType (M0.Tuple.fst (M0.__default.evalArgs $ly@@12 |expr#0@@4| (M0.Expression.args |expr#0@@4|) |st#0@@24| |env#0@@14|)))))
(let ((|sts''#0| (|Set#Union| (|Set#UnionOne| |Set#Empty| |st'#3|) |sts'#0|)))
 ...
 (and (M0.Tuple.Pair_q |ps#0|) (M0.Tuple.Pair_q |ps#0|)))))))))))))))))))))))))))))) (= (M0.__default.eval ($LS $ly@@12) |expr#0@@4| |st#0@@24| |env#0@@14|) (ite (M0.__default.Value |expr#0@@4|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType |expr#0@@4|) |st#0@@24|) (ite (M0.Expression.exprIdentifier_q |expr#0@@4|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (M0.__default.GetEnv (M0.Expression.id |expr#0@@4|) |env#0@@14|)) |st#0@@24|) (ite (M0.Expression.exprIf_q |expr#0@@4|) (let ((|st'#0@@6| (M0.Tuple.snd (M0.__default.eval $ly@@12 (M0.Expression.cond |expr#0@@4|) |st#0@@24| |env#0@@14|))))
(let ((|cond'#0@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@12 (M0.Expression.cond |expr#0@@4|) |st#0@@24| |env#0@@14|)))))
(ite  (and (M0.Expression.exprLiteral_q |cond'#0@@0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#0@@0|) |#M0.Literal.litTrue|)) (M0.__default.eval $ly@@12 (M0.Expression.ifTrue |expr#0@@4|) |st'#0@@6| |env#0@@14|) (ite  (and (M0.Expression.exprLiteral_q |cond'#0@@0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#0@@0|) |#M0.Literal.litFalse|)) (M0.__default.eval $ly@@12 (M0.Expression.ifFalse |expr#0@@4|) |st'#0@@6| |env#0@@14|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@24|))))) (ite (M0.Expression.exprAnd_q |expr#0@@4|) (let ((|st'#1@@4| (M0.Tuple.snd (M0.__default.eval $ly@@12 (M0.Expression.conj0 |expr#0@@4|) |st#0@@24| |env#0@@14|))))
(let ((|conj0'#0@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@12 (M0.Expression.conj0 |expr#0@@4|) |st#0@@24| |env#0@@14|)))))
(ite  (and (M0.Expression.exprLiteral_q |conj0'#0@@0|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#0@@0|) |#M0.Literal.litTrue|)) (M0.__default.eval $ly@@12 (M0.Expression.conj1 |expr#0@@4|) |st'#1@@4| |env#0@@14|) (ite  (and (M0.Expression.exprLiteral_q |conj0'#0@@0|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#0@@0|) |#M0.Literal.litFalse|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprLiteral| (Lit DatatypeTypeType |#M0.Literal.litFalse|)))) |st'#1@@4|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@24|))))) (ite (M0.Expression.exprOr_q |expr#0@@4|) (let ((|st'#2@@0| (M0.Tuple.snd (M0.__default.eval $ly@@12 (M0.Expression.disj0 |expr#0@@4|) |st#0@@24| |env#0@@14|))))
(let ((|disj0'#0@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@12 (M0.Expression.disj0 |expr#0@@4|) |st#0@@24| |env#0@@14|)))))
(ite  (and (M0.Expression.exprLiteral_q |disj0'#0@@0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#0@@0|) |#M0.Literal.litTrue|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprLiteral| (Lit DatatypeTypeType |#M0.Literal.litTrue|)))) |st'#2@@0|) (ite  (and (M0.Expression.exprLiteral_q |disj0'#0@@0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#0@@0|) |#M0.Literal.litFalse|)) (M0.__default.eval $ly@@12 (M0.Expression.disj1 |expr#0@@4|) |st'#2@@0| |env#0@@14|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@24|))))) (ite (M0.Expression.exprInvocation_q |expr#0@@4|) (let ((|st'#3@@0| (M0.Tuple.snd (M0.__default.eval $ly@@12 (M0.Expression.fun |expr#0@@4|) |st#0@@24| |env#0@@14|))))
(let ((|fun'#0@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@12 (M0.Expression.fun |expr#0@@4|) |st#0@@24| |env#0@@14|)))))
(let ((|sts'#0@@0| ($Unbox SetType (M0.Tuple.snd (M0.__default.evalArgs $ly@@12 |expr#0@@4| (M0.Expression.args |expr#0@@4|) |st#0@@24| |env#0@@14|)))))
(let ((|args'#0@@0| ($Unbox SeqType (M0.Tuple.fst (M0.__default.evalArgs $ly@@12 |expr#0@@4| (M0.Expression.args |expr#0@@4|) |st#0@@24| |env#0@@14|)))))
(let ((|sts''#0@@0| (|Set#Union| (|Set#UnionOne| |Set#Empty| |st'#3@@0|) |sts'#0@@0|)))
(ite  (not (M0.__default.Compatible |sts''#0@@0|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rCompatibility|)))) |st#0@@24|) (let ((|stCombined#0@@0| (M0.__default.Combine ($LS $LZ) |sts''#0@@0|)))
...
(|#M0.Tuple.Pair| ($Box DatatypeTypeType (|#M0.Expression.exprLiteral| (|#M0.Literal.litArrOfPaths| ($Unbox SetType (M0.Tuple.fst |ps#0@@0|))))) (M0.Tuple.snd |ps#0@@0|))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@24|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@24|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@24|))))))))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@24|))))))))))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |974|
 :pattern ( (M0.__default.eval ($LS $ly@@12) |expr#0@@4| |st#0@@24| |env#0@@14|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|cmd#0@@5| T@U) (|deps#0@@5| T@U) (|exps#0@@4| T@U) (|st#0@@26| T@U) ) (!  (=> (or (|M0.__default.Pre#canCall| |cmd#0@@5| |deps#0@@5| |exps#0@@4| |st#0@@26|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@5| (TSeq TChar)) ($Is SetType |deps#0@@5| (TSet Tclass.M0.Path))) ($Is SetType |exps#0@@4| (TSet (TSeq TChar)))) ($IsBox |st#0@@26| Tclass.M0.State)))) (and (forall ((|e#0| T@U) ) (!  (=> ($Is SeqType |e#0| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@4| ($Box SeqType |e#0|)) (and (and (|M0.__default.Loc#canCall| |cmd#0@@5| |deps#0@@5| |e#0|) (|M0.__default.DomSt#canCall| |st#0@@26|)) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@26|) (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0|)) (and (and (|M0.__default.Loc#canCall| |cmd#0@@5| |deps#0@@5| |e#0|) (|M0.__default.GetSt#canCall| (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0|) |st#0@@26|)) (and (|M0.__default.Loc#canCall| |cmd#0@@5| |deps#0@@5| |e#0|) (|M0.__default.Oracle#canCall| (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0|) |st#0@@26|)))))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |819|
 :pattern ( (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0|))
 :pattern ( (|Set#IsMember| |exps#0@@4| ($Box SeqType |e#0|)))
)) (= (M0.__default.Pre |cmd#0@@5| |deps#0@@5| |exps#0@@4| |st#0@@26|) (forall ((|e#0@@0| T@U) ) (!  (=> ($Is SeqType |e#0@@0| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@4| ($Box SeqType |e#0@@0|)) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@26|) (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0@@0|)) (= (M0.__default.GetSt (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0@@0|) |st#0@@26|) (M0.__default.Oracle (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0@@0|) |st#0@@26|)))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |818|
 ...
 :qid |CloudMakeParallelBuildsdfy.83:23|
 :skolemid |820|
 :pattern ( (M0.__default.Pre |cmd#0@@5| |deps#0@@5| |exps#0@@4| |st#0@@26|))
))))
(assert (forall (($ly@@14 T@U) (|stmts#0@@5| T@U) (|st#0@@27| T@U) (|env#0@@15| T@U) ) (! (= (M0.__default.do ($LS $ly@@14) |stmts#0@@5| |st#0@@27| |env#0@@15|) (M0.__default.do $ly@@14 |stmts#0@@5| |st#0@@27| |env#0@@15|))
 :qid |CloudMakeParallelBuildsdfy.177:18|
 :skolemid |949|
 :pattern ( (M0.__default.do ($LS $ly@@14) |stmts#0@@5| |st#0@@27| |env#0@@15|))
)))
(assert (forall (($ly@@15 T@U) (|expr#0@@5| T@U) (|st#0@@28| T@U) (|env#0@@16| T@U) ) (! (= (M0.__default.eval ($LS $ly@@15) |expr#0@@5| |st#0@@28| |env#0@@16|) (M0.__default.eval $ly@@15 |expr#0@@5| |st#0@@28| |env#0@@16|))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |969|
 :pattern ( (M0.__default.eval ($LS $ly@@15) |expr#0@@5| |st#0@@28| |env#0@@16|))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@9 T@U) ($ly@@16 T@U) (|expr#0@@6| T@U) (|st#0@@29| T@U) (|env#0@@17| T@U) ) (!  (=> (and (or (|M0.__default.eval#canCall| |expr#0@@6| |st#0@@29| |env#0@@17|) (and (< 4 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |expr#0@@6| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |expr#0@@6| Tclass.M0.Expression $Heap@@9)) (and ($IsBox |st#0@@29| Tclass.M0.State) ($IsAllocBox |st#0@@29| Tclass.M0.State $Heap@@9))) (and ($IsBox |env#0@@17| Tclass.M0.Env) ($IsAllocBox |env#0@@17| Tclass.M0.Env $Heap@@9))) (M0.__default.ValidEnv |env#0@@17|)))) ($IsGoodHeap $Heap@@9)) ($IsAlloc DatatypeTypeType (M0.__default.eval $ly@@16 |expr#0@@6| |st#0@@29| |env#0@@17|) (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State) $Heap@@9))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |972|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.__default.eval $ly@@16 |expr#0@@6| |st#0@@29| |env#0@@17|) (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State) $Heap@@9))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|prim#0@@4| T@U) (|args#0@@6| T@U) (|st#0@@30| T@U) ) (!  (=> (or (|M0.__default.ValidArgs#canCall| (Lit DatatypeTypeType |prim#0@@4|) (Lit SeqType |args#0@@6|) |st#0@@30|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |prim#0@@4| Tclass.M0.Primitive) ($Is SeqType |args#0@@6| (TSeq Tclass.M0.Expression))) ($IsBox |st#0@@30| Tclass.M0.State)) (and (=> (M0.Primitive.primExec_q (Lit DatatypeTypeType |prim#0@@4|)) (= (|Seq#Length| (Lit SeqType |args#0@@6|)) (LitInt 3))) (=> (M0.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@4|)) (= (|Seq#Length| (Lit SeqType |args#0@@6|)) (LitInt 1))))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@4|)))))) (let ((|exps#3| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@6|) (LitInt 2)))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@10 T@U) (|p#0@@7| T@U) (|st#0@@31| T@U) ) (!  (=> (and (or (|M0.__default.Oracle#canCall| |p#0@@7| |st#0@@31|) (and (< 0 $FunctionContextHeight) (and (and ($IsBox |p#0@@7| Tclass.M0.Path) ($IsAllocBox |p#0@@7| Tclass.M0.Path $Heap@@10)) (and ($IsBox |st#0@@31| Tclass.M0.State) ($IsAllocBox |st#0@@31| Tclass.M0.State $Heap@@10))))) ($IsGoodHeap $Heap@@10)) ($IsAllocBox (M0.__default.Oracle |p#0@@7| |st#0@@31|) Tclass.M0.Artifact $Heap@@10))
 :qid |CloudMakeParallelBuildsdfy.104:18|
 :skolemid |869|
 :pattern ( ($IsAllocBox (M0.__default.Oracle |p#0@@7| |st#0@@31|) Tclass.M0.Artifact $Heap@@10))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@11 T@U) (|st#0@@32| T@U) (|st'#0@@7| T@U) ) (!  (=> (and (or (|M0.__default.Union#canCall| |st#0@@32| |st'#0@@7|) (and (< 2 $FunctionContextHeight) (and (and ($IsBox |st#0@@32| Tclass.M0.State) ($IsAllocBox |st#0@@32| Tclass.M0.State $Heap@@11)) (and ($IsBox |st'#0@@7| Tclass.M0.State) ($IsAllocBox |st'#0@@7| Tclass.M0.State $Heap@@11))))) ($IsGoodHeap $Heap@@11)) ($IsAllocBox (M0.__default.Union |st#0@@32| |st'#0@@7|) Tclass.M0.State $Heap@@11))
 :qid |CloudMakeParallelBuildsdfy.23:18|
 :skolemid |722|
 :pattern ( ($IsAllocBox (M0.__default.Union |st#0@@32| |st'#0@@7|) Tclass.M0.State $Heap@@11))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@33| T@U) (|st'#0@@8| T@U) ) (!  (=> (or (|M0.__default.Extends#canCall| |st#0@@33| |st'#0@@8|) (and (< 2 $FunctionContextHeight) (and ($IsBox |st#0@@33| Tclass.M0.State) ($IsBox |st'#0@@8| Tclass.M0.State)))) (and (and (and (|M0.__default.DomSt#canCall| |st#0@@33|) (|M0.__default.DomSt#canCall| |st'#0@@8|)) (=> (|Set#Subset| (M0.__default.DomSt |st#0@@33|) (M0.__default.DomSt |st'#0@@8|)) (and (forall ((|p#0@@8| T@U) ) (!  (=> ($IsBox |p#0@@8| Tclass.M0.Path) (and (|M0.__default.DomSt#canCall| |st#0@@33|) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@33|) |p#0@@8|) (and (|M0.__default.GetSt#canCall| |p#0@@8| |st'#0@@8|) (|M0.__default.GetSt#canCall| |p#0@@8| |st#0@@33|)))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |879|
 :pattern ( (M0.__default.GetSt |p#0@@8| |st#0@@33|))
 :pattern ( (M0.__default.GetSt |p#0@@8| |st'#0@@8|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@33|) |p#0@@8|))
)) (=> (forall ((|p#0@@9| T@U) ) (!  (=> ($IsBox |p#0@@9| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@33|) |p#0@@9|) (= (M0.__default.GetSt |p#0@@9| |st'#0@@8|) (M0.__default.GetSt |p#0@@9| |st#0@@33|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |881|
 :pattern ( (M0.__default.GetSt |p#0@@9| |st#0@@33|))
 :pattern ( (M0.__default.GetSt |p#0@@9| |st'#0@@8|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@33|) |p#0@@9|))
)) (forall ((|p#1@@1| T@U) ) (!  (=> ($IsBox |p#1@@1| Tclass.M0.Path) (and (|M0.__default.DomSt#canCall| |st#0@@33|) (=> (not (|Set#IsMember| (M0.__default.DomSt |st#0@@33|) |p#1@@1|)) (and (|M0.__default.DomSt#canCall| |st'#0@@8|) (=> (|Set#IsMember| (M0.__default.DomSt |st'#0@@8|) |p#1@@1|) (and (|M0.__default.GetSt#canCall| |p#1@@1| |st'#0@@8|) (|M0.__default.Oracle#canCall| |p#1@@1| |st#0@@33|)))))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |880|
 :pattern ( (M0.__default.Oracle |p#1@@1| |st#0@@33|))
 :pattern ( (M0.__default.GetSt |p#1@@1| |st'#0@@8|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@8|) |p#1@@1|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@33|) |p#1@@1|))
)))))) (= (M0.__default.Extends |st#0@@33| |st'#0@@8|)  (and (and (|Set#Subset| (M0.__default.DomSt |st#0@@33|) (M0.__default.DomSt |st'#0@@8|)) (forall ((|p#0@@10| T@U) ) (!  (=> ($IsBox |p#0@@10| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@33|) |p#0@@10|) (= (M0.__default.GetSt |p#0@@10| |st'#0@@8|) (M0.__default.GetSt |p#0@@10| |st#0@@33|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |877|
 :pattern ( (M0.__default.GetSt |p#0@@10| |st#0@@33|))
 :pattern ( (M0.__default.GetSt |p#0@@10| |st'#0@@8|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@33|) |p#0@@10|))
))) (forall ((|p#1@@2| T@U) ) (!  (=> ($IsBox |p#1@@2| Tclass.M0.Path) (=> (and (not (|Set#IsMember| (M0.__default.DomSt |st#0@@33|) |p#1@@2|)) (|Set#IsMember| (M0.__default.DomSt |st'#0@@8|) |p#1@@2|)) (= (M0.__default.GetSt |p#1@@2| |st'#0@@8|) (M0.__default.Oracle |p#1@@2| |st#0@@33|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |878|
 :pattern ( (M0.__default.Oracle |p#1@@2| |st#0@@33|))
 :pattern ( (M0.__default.GetSt |p#1@@2| |st'#0@@8|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@8|) |p#1@@2|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@33|) |p#1@@2|))
))))))
 :qid |CloudMakeParallelBuildsdfy.112:27|
 :skolemid |882|
 :pattern ( (M0.__default.Extends |st#0@@33| |st'#0@@8|))
))))
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($ly@@18 T@U) (|stmts#0@@6| T@U) (|st#0@@34| T@U) (|env#0@@19| T@U) ) (!  (=> (or (|M0.__default.do#canCall| (Lit SeqType |stmts#0@@6|) (Lit BoxType |st#0@@34|) (Lit BoxType |env#0@@19|)) (and (< 5 $FunctionContextHeight) (and (and (and ($Is SeqType |stmts#0@@6| (TSeq Tclass.M0.Statement)) ($IsBox |st#0@@34| Tclass.M0.State)) ($IsBox |env#0@@19| Tclass.M0.Env)) (and (M0.__default.Legal (Lit SeqType |stmts#0@@6|)) (M0.__default.ValidEnv (Lit BoxType |env#0@@19|)))))) (and (let ((|stmt#2| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |stmts#0@@6|) (LitInt 0)))))
 (and (=> (M0.Statement.stmtVariable_q |stmt#2|) (and (|M0.__default.eval#canCall| (M0.Statement.expr |stmt#2|) (Lit BoxType |st#0@@34|) (Lit BoxType |env#0@@19|)) (let ((|st'#2@@1| (M0.Tuple.snd (M0.__default.eval ($LS $LZ) (M0.Statement.expr |stmt#2|) (Lit BoxType |st#0@@34|) (Lit BoxType |env#0@@19|)))))
(let ((|expr'#2| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $LZ) (M0.Statement.expr |stmt#2|) (Lit BoxType |st#0@@34|) (Lit BoxType |env#0@@19|))))))
 ...
 (and (|M0.__default.Legal#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@6|) (LitInt 1)))) (=> (U_2_bool (Lit boolType (bool_2_U (M0.__default.Legal (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@6|) (LitInt 1))))))) (|M0.__default.do#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@6|) (LitInt 1))) |st'#2@@1| |env'#2|))))))))))) (=> (not (M0.Statement.stmtVariable_q |stmt#2|)) (|M0.__default.eval#canCall| (M0.Statement.ret |stmt#2|) (Lit BoxType |st#0@@34|) (Lit BoxType |env#0@@19|))))) (= (M0.__default.do ($LS $ly@@18) (Lit SeqType |stmts#0@@6|) (Lit BoxType |st#0@@34|) (Lit BoxType |env#0@@19|)) (let ((|stmt#2@@0| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |stmts#0@@6|) (LitInt 0)))))
(ite (M0.Statement.stmtVariable_q |stmt#2@@0|) (let ((|st'#2@@2| (M0.Tuple.snd (M0.__default.eval ($LS $LZ) (M0.Statement.expr |stmt#2@@0|) (Lit BoxType |st#0@@34|) (Lit BoxType |env#0@@19|)))))
(let ((|expr'#2@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $LZ) (M0.Statement.expr |stmt#2@@0|) (Lit BoxType |st#0@@34|) (Lit BoxType |env#0@@19|))))))
(ite (M0.__default.Value |expr'#2@@0|) (let ((|env'#2@@0| (M0.__default.SetEnv (M0.Statement.id |stmt#2@@0|) |expr'#2@@0| (Lit BoxType |env#0@@19|))))
(ite (M0.__default.Legal (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@6|) (LitInt 1)))) (M0.__default.do ($LS $ly@@18) (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@6|) (LitInt 1))) |st'#2@@2| |env'#2@@0|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType |expr'#2@@0|) |st'#2@@2|))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) (Lit BoxType |st#0@@34|))))) (M0.__default.eval ($LS $LZ) (M0.Statement.ret |stmt#2@@0|) (Lit BoxType |st#0@@34|) (Lit BoxType |env#0@@19|)))))))
 :qid |CloudMakeParallelBuildsdfy.177:18|
 :weight 3
 :skolemid |956|
 :pattern ( (M0.__default.do ($LS $ly@@18) (Lit SeqType |stmts#0@@6|) (Lit BoxType |st#0@@34|) (Lit BoxType |env#0@@19|)))
))))
(assert (forall ((d@@62 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) ($Is DatatypeTypeType d@@62 Tclass.M0.Primitive)) ($IsAlloc DatatypeTypeType d@@62 Tclass.M0.Primitive $h@@21))
 :qid |unknown.0:0|
 :skolemid |1349|
 :pattern ( ($IsAlloc DatatypeTypeType d@@62 Tclass.M0.Primitive $h@@21))
)))
(assert (forall ((d@@63 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) ($Is DatatypeTypeType d@@63 Tclass.M0.Reason)) ($IsAlloc DatatypeTypeType d@@63 Tclass.M0.Reason $h@@22))
 :qid |unknown.0:0|
 :skolemid |1359|
 :pattern ( ($IsAlloc DatatypeTypeType d@@63 Tclass.M0.Reason $h@@22))
)))
...
(assert (forall ((d@@64 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (M0.Literal.litString_q d@@64) ($IsAlloc DatatypeTypeType d@@64 Tclass.M0.Literal $h@@23))) ($IsAlloc SeqType (M0.Literal.str d@@64) (TSeq TChar) $h@@23))
 :qid |unknown.0:0|
 :skolemid |1286|
 :pattern ( ($IsAlloc SeqType (M0.Literal.str d@@64) (TSeq TChar) $h@@23))
)))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall ((|prog#0@@3| T@U) (|st#0@@35| T@U) ) (!  (=> (or (|M0.__default.build#canCall| (Lit DatatypeTypeType |prog#0@@3|) (Lit BoxType |st#0@@35|)) (and (< 6 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |prog#0@@3| Tclass.M0.Program) ($IsBox |st#0@@35| Tclass.M0.State)) (U_2_bool (Lit boolType (bool_2_U (M0.__default.Legal (Lit SeqType (M0.Program.stmts (Lit DatatypeTypeType |prog#0@@3|)))))))))) (and (and (and (M0.Program.Program_q (Lit DatatypeTypeType |prog#0@@3|)) |M0.__default.EmptyEnv#canCall|) (|M0.__default.do#canCall| (Lit SeqType (M0.Program.stmts (Lit DatatypeTypeType |prog#0@@3|))) (Lit BoxType |st#0@@35|) M0.__default.EmptyEnv)) (= (M0.__default.build (Lit DatatypeTypeType |prog#0@@3|) (Lit BoxType |st#0@@35|)) (M0.__default.do ($LS $LZ) (Lit SeqType (M0.Program.stmts (Lit DatatypeTypeType |prog#0@@3|))) (Lit BoxType |st#0@@35|) M0.__default.EmptyEnv))))
 :qid |CloudMakeParallelBuildsdfy.170:24|
 :weight 3
 :skolemid |944|
 :pattern ( (M0.__default.build (Lit DatatypeTypeType |prog#0@@3|) (Lit BoxType |st#0@@35|)))
))))
...
(assert (forall ((d@@67 T@U) (M0.Tuple$A@@6 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (M0.Tuple.Pair_q d@@67) (exists ((M0.Tuple$B@@6 T@U) ) (! ($IsAlloc DatatypeTypeType d@@67 (Tclass.M0.Tuple M0.Tuple$A@@6 M0.Tuple$B@@6) $h@@24)
 :qid |unknown.0:0|
 :skolemid |1371|
 :pattern ( ($IsAlloc DatatypeTypeType d@@67 (Tclass.M0.Tuple M0.Tuple$A@@6 M0.Tuple$B@@6) $h@@24))
)))) ($IsAllocBox (M0.Tuple.fst d@@67) M0.Tuple$A@@6 $h@@24))
 :qid |unknown.0:0|
 :skolemid |1372|
 :pattern ( ($IsAllocBox (M0.Tuple.fst d@@67) M0.Tuple$A@@6 $h@@24))
)))
(assert (forall ((d@@68 T@U) (M0.Tuple$B@@7 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (M0.Tuple.Pair_q d@@68) (exists ((M0.Tuple$A@@7 T@U) ) (! ($IsAlloc DatatypeTypeType d@@68 (Tclass.M0.Tuple M0.Tuple$A@@7 M0.Tuple$B@@7) $h@@25)
 :qid |unknown.0:0|
 :skolemid |1373|
 :pattern ( ($IsAlloc DatatypeTypeType d@@68 (Tclass.M0.Tuple M0.Tuple$A@@7 M0.Tuple$B@@7) $h@@25))
)))) ($IsAllocBox (M0.Tuple.snd d@@68) M0.Tuple$B@@7 $h@@25))
 :qid |unknown.0:0|
 :skolemid |1374|
 :pattern ( ($IsAllocBox (M0.Tuple.snd d@@68) M0.Tuple$B@@7 $h@@25))
)))
...
(assert (forall ((d@@69 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (M0.Statement.stmtVariable_q d@@69) ($IsAlloc DatatypeTypeType d@@69 Tclass.M0.Statement $h@@26))) ($IsAllocBox (M0.Statement.id d@@69) Tclass.M0.Identifier $h@@26))
 :qid |unknown.0:0|
 :skolemid |1141|
 :pattern ( ($IsAllocBox (M0.Statement.id d@@69) Tclass.M0.Identifier $h@@26))
)))
(assert (forall ((d@@70 T@U) ($h@@27 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (M0.Statement.stmtVariable_q d@@70) ($IsAlloc DatatypeTypeType d@@70 Tclass.M0.Statement $h@@27))) ($IsAlloc DatatypeTypeType (M0.Statement.expr d@@70) Tclass.M0.Expression $h@@27))
 :qid |unknown.0:0|
 :skolemid |1142|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Statement.expr d@@70) Tclass.M0.Expression $h@@27))
)))
(assert (forall ((d@@71 T@U) ($h@@28 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (M0.Statement.stmtReturn_q d@@71) ($IsAlloc DatatypeTypeType d@@71 Tclass.M0.Statement $h@@28))) ($IsAlloc DatatypeTypeType (M0.Statement.ret d@@71) Tclass.M0.Expression $h@@28))
 :qid |unknown.0:0|
 :skolemid |1153|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Statement.ret d@@71) Tclass.M0.Expression $h@@28))
)))
(assert (forall ((d@@72 T@U) ($h@@29 T@U) ) (!  (=> (and ($IsGoodHeap $h@@29) (and (M0.Expression.exprLiteral_q d@@72) ($IsAlloc DatatypeTypeType d@@72 Tclass.M0.Expression $h@@29))) ($IsAlloc DatatypeTypeType (M0.Expression.lit d@@72) Tclass.M0.Literal $h@@29))
 :qid |unknown.0:0|
 :skolemid |1169|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.lit d@@72) Tclass.M0.Literal $h@@29))
)))
(assert (forall ((d@@73 T@U) ($h@@30 T@U) ) (!  (=> (and ($IsGoodHeap $h@@30) (and (M0.Expression.exprIdentifier_q d@@73) ($IsAlloc DatatypeTypeType d@@73 Tclass.M0.Expression $h@@30))) ($IsAllocBox (M0.Expression.id d@@73) Tclass.M0.Identifier $h@@30))
 :qid |unknown.0:0|
 :skolemid |1179|
 :pattern ( ($IsAllocBox (M0.Expression.id d@@73) Tclass.M0.Identifier $h@@30))
)))
(assert (forall ((d@@74 T@U) ($h@@31 T@U) ) (!  (=> (and ($IsGoodHeap $h@@31) (and (M0.Expression.exprIf_q d@@74) ($IsAlloc DatatypeTypeType d@@74 Tclass.M0.Expression $h@@31))) ($IsAlloc DatatypeTypeType (M0.Expression.cond d@@74) Tclass.M0.Expression $h@@31))
 :qid |unknown.0:0|
 :skolemid |1188|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.cond d@@74) Tclass.M0.Expression $h@@31))
)))
(assert (forall ((d@@75 T@U) ($h@@32 T@U) ) (!  (=> (and ($IsGoodHeap $h@@32) (and (M0.Expression.exprIf_q d@@75) ($IsAlloc DatatypeTypeType d@@75 Tclass.M0.Expression $h@@32))) ($IsAlloc DatatypeTypeType (M0.Expression.ifTrue d@@75) Tclass.M0.Expression $h@@32))
 :qid |unknown.0:0|
 :skolemid |1189|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.ifTrue d@@75) Tclass.M0.Expression $h@@32))
)))
(assert (forall ((d@@76 T@U) ($h@@33 T@U) ) (!  (=> (and ($IsGoodHeap $h@@33) (and (M0.Expression.exprIf_q d@@76) ($IsAlloc DatatypeTypeType d@@76 Tclass.M0.Expression $h@@33))) ($IsAlloc DatatypeTypeType (M0.Expression.ifFalse d@@76) Tclass.M0.Expression $h@@33))
 :qid |unknown.0:0|
 :skolemid |1190|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.ifFalse d@@76) Tclass.M0.Expression $h@@33))
)))
(assert (forall ((d@@77 T@U) ($h@@34 T@U) ) (!  (=> (and ($IsGoodHeap $h@@34) (and (M0.Expression.exprAnd_q d@@77) ($IsAlloc DatatypeTypeType d@@77 Tclass.M0.Expression $h@@34))) ($IsAlloc DatatypeTypeType (M0.Expression.conj0 d@@77) Tclass.M0.Expression $h@@34))
 :qid |unknown.0:0|
 :skolemid |1204|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.conj0 d@@77) Tclass.M0.Expression $h@@34))
)))
(assert (forall ((d@@78 T@U) ($h@@35 T@U) ) (!  (=> (and ($IsGoodHeap $h@@35) (and (M0.Expression.exprAnd_q d@@78) ($IsAlloc DatatypeTypeType d@@78 Tclass.M0.Expression $h@@35))) ($IsAlloc DatatypeTypeType (M0.Expression.conj1 d@@78) Tclass.M0.Expression $h@@35))
 :qid |unknown.0:0|
 :skolemid |1205|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.conj1 d@@78) Tclass.M0.Expression $h@@35))
)))
(assert (forall ((d@@79 T@U) ($h@@36 T@U) ) (!  (=> (and ($IsGoodHeap $h@@36) (and (M0.Expression.exprOr_q d@@79) ($IsAlloc DatatypeTypeType d@@79 Tclass.M0.Expression $h@@36))) ($IsAlloc DatatypeTypeType (M0.Expression.disj0 d@@79) Tclass.M0.Expression $h@@36))
 :qid |unknown.0:0|
 :skolemid |1217|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.disj0 d@@79) Tclass.M0.Expression $h@@36))
)))
(assert (forall ((d@@80 T@U) ($h@@37 T@U) ) (!  (=> (and ($IsGoodHeap $h@@37) (and (M0.Expression.exprOr_q d@@80) ($IsAlloc DatatypeTypeType d@@80 Tclass.M0.Expression $h@@37))) ($IsAlloc DatatypeTypeType (M0.Expression.disj1 d@@80) Tclass.M0.Expression $h@@37))
 :qid |unknown.0:0|
 :skolemid |1218|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.disj1 d@@80) Tclass.M0.Expression $h@@37))
)))
(assert (forall ((d@@81 T@U) ($h@@38 T@U) ) (!  (=> (and ($IsGoodHeap $h@@38) (and (M0.Expression.exprInvocation_q d@@81) ($IsAlloc DatatypeTypeType d@@81 Tclass.M0.Expression $h@@38))) ($IsAlloc DatatypeTypeType (M0.Expression.fun d@@81) Tclass.M0.Expression $h@@38))
 :qid |unknown.0:0|
 :skolemid |1230|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.fun d@@81) Tclass.M0.Expression $h@@38))
)))
(assert (forall ((d@@82 T@U) ($h@@39 T@U) ) (!  (=> (and ($IsGoodHeap $h@@39) (and (M0.Expression.exprError_q d@@82) ($IsAlloc DatatypeTypeType d@@82 Tclass.M0.Expression $h@@39))) ($IsAlloc DatatypeTypeType (M0.Expression.r d@@82) Tclass.M0.Reason $h@@39))
 :qid |unknown.0:0|
 :skolemid |1245|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.r d@@82) Tclass.M0.Reason $h@@39))
)))
(assert (forall ((d@@83 T@U) ($h@@40 T@U) ) (!  (=> (and ($IsGoodHeap $h@@40) (and (M0.Literal.litPrimitive_q d@@83) ($IsAlloc DatatypeTypeType d@@83 Tclass.M0.Literal $h@@40))) ($IsAlloc DatatypeTypeType (M0.Literal.prim d@@83) Tclass.M0.Primitive $h@@40))
 :qid |unknown.0:0|
 :skolemid |1297|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Literal.prim d@@83) Tclass.M0.Primitive $h@@40))
)))
...
(assert (forall ((d@@84 T@U) ($h@@41 T@U) ) (!  (=> (and ($IsGoodHeap $h@@41) (and (M0.Literal.litArrOfStrings_q d@@84) ($IsAlloc DatatypeTypeType d@@84 Tclass.M0.Literal $h@@41))) ($IsAlloc SetType (M0.Literal.strs d@@84) (TSet (TSeq TChar)) $h@@41))
 :qid |unknown.0:0|
 :skolemid |1317|
 :pattern ( ($IsAlloc SetType (M0.Literal.strs d@@84) (TSet (TSeq TChar)) $h@@41))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0@@36| T@U) ) (!  (=> (or (|M0.__default.ValidState#canCall| (Lit BoxType |st#0@@36|)) (and (< 1 $FunctionContextHeight) ($IsBox |st#0@@36| Tclass.M0.State))) (and (forall ((|p#1@@3| T@U) ) (!  (=> ($IsBox |p#1@@3| Tclass.M0.Path) (and (|M0.__default.DomSt#canCall| (Lit BoxType |st#0@@36|)) (=> (|Set#IsMember| (M0.__default.DomSt (Lit BoxType |st#0@@36|)) |p#1@@3|) (|M0.__default.WellFounded#canCall| |p#1@@3|))))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |711|
 :pattern ( (M0.__default.WellFounded |p#1@@3|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@36|) |p#1@@3|))
)) (= (M0.__default.ValidState (Lit BoxType |st#0@@36|)) (forall ((|p#1@@4| T@U) ) (!  (=> ($IsBox |p#1@@4| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt (Lit BoxType |st#0@@36|)) |p#1@@4|) (M0.__default.WellFounded |p#1@@4|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |710|
 :pattern ( (M0.__default.WellFounded |p#1@@4|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@36|) |p#1@@4|))
)))))
 :qid |CloudMakeParallelBuildsdfy.13:30|
 :weight 3
 :skolemid |712|
 :pattern ( (M0.__default.ValidState (Lit BoxType |st#0@@36|)))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@20 T@U) (|expr#0@@8| T@U) (|st#0@@37| T@U) (|env#0@@20| T@U) ) (!  (=> (or (|M0.__default.eval#canCall| (Lit DatatypeTypeType |expr#0@@8|) |st#0@@37| |env#0@@20|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0@@8| Tclass.M0.Expression) ($IsBox |st#0@@37| Tclass.M0.State)) ($IsBox |env#0@@20| Tclass.M0.Env)) (M0.__default.ValidEnv |env#0@@20|)))) (and (and (|M0.__default.Value#canCall| (Lit DatatypeTypeType |expr#0@@8|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.__default.Value (Lit DatatypeTypeType |expr#0@@8|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@8|))))) (|M0.__default.GetEnv#canCall| (Lit BoxType (M0.Expression.id (Lit DatatypeTypeType |expr#0@@8|))) |env#0@@20|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@8|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@8|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@37| |env#0@@20|) (let ((|st'#4| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@37| |env#0@@20|))))
(let ((|cond'#1| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@37| |env#0@@20|)))))
 (and (and (=> (M0.Expression.exprLiteral_q |cond'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#1|))) (=> (and (M0.Expression.exprLiteral_q |cond'#1|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#1|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.ifTrue (Lit DatatypeTypeType |expr#0@@8|))) |st'#4| |env#0@@20|))) (=> (not (and (M0.Expression.exprLiteral_q |cond'#1|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#1|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |cond'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#1|))) (=> (and (M0.Expression.exprLiteral_q |cond'#1|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#1|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.ifFalse (Lit DatatypeTypeType |expr#0@@8|))) |st'#4| |env#0@@20|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@8|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@8|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@37| |env#0@@20|) (let ((|st'#5| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@37| |env#0@@20|))))
(let ((|conj0'#1| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@37| |env#0@@20|)))))
 (and (and (=> (M0.Expression.exprLiteral_q |conj0'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#1|))) (=> (and (M0.Expression.exprLiteral_q |conj0'#1|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#1|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.conj1 (Lit DatatypeTypeType |expr#0@@8|))) |st'#5| |env#0@@20|))) (=> (not (and (M0.Expression.exprLiteral_q |conj0'#1|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#1|) |#M0.Literal.litTrue|))) (=> (M0.Expression.exprLiteral_q |conj0'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#1|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@8|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@8|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@37| |env#0@@20|) (let ((|st'#6| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@37| |env#0@@20|))))
(let ((|disj0'#1| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@37| |env#0@@20|)))))
 (and (=> (M0.Expression.exprLiteral_q |disj0'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#1|))) (=> (not (and (M0.Expression.exprLiteral_q |disj0'#1|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#1|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |disj0'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#1|))) (=> (and (M0.Expression.exprLiteral_q |disj0'#1|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#1|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.disj1 (Lit DatatypeTypeType |expr#0@@8|))) |st'#6| |env#0@@20|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@8|)))))) (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0@@8|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@37| |env#0@@20|) (let ((|st'#7| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@37| |env#0@@20|))))
(let ((|fun'#1| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@37| |env#0@@20|)))))
 (and (|M0.__default.evalArgs#canCall| (Lit DatatypeTypeType |expr#0@@8|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@37| |env#0@@20|) (let ((|sts'#1| ($Unbox SetType (M0.Tuple.snd (M0.__default.evalArgs ($LS $ly@@20) (Lit DatatypeTypeType |expr#0@@8|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@37| |env#0@@20|)))))
(let ((|args'#1| ($Unbox SeqType (M0.Tuple.fst (M0.__default.evalArgs ($LS $ly@@20) (Lit DatatypeTypeType |expr#0@@8|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@37| |env#0@@20|)))))
(let ((|sts''#1| (|Set#Union| (|Set#UnionOne| |Set#Empty| |st'#7|) |sts'#1|)))
 ...
 (and (M0.Tuple.Pair_q |ps#1|) (M0.Tuple.Pair_q |ps#1|)))))))))))))))))))))))))))))) (= (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType |expr#0@@8|) |st#0@@37| |env#0@@20|) (ite (M0.__default.Value (Lit DatatypeTypeType |expr#0@@8|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType |expr#0@@8|)) |st#0@@37|) (ite (M0.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@8|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (M0.__default.GetEnv (Lit BoxType (M0.Expression.id (Lit DatatypeTypeType |expr#0@@8|))) |env#0@@20|)) |st#0@@37|) (ite (M0.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@8|)) (let ((|st'#4@@0| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@37| |env#0@@20|))))
(let ((|cond'#1@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@37| |env#0@@20|)))))
(ite  (and (M0.Expression.exprLiteral_q |cond'#1@@0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#1@@0|) |#M0.Literal.litTrue|)) (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.ifTrue (Lit DatatypeTypeType |expr#0@@8|))) |st'#4@@0| |env#0@@20|) (ite  (and (M0.Expression.exprLiteral_q |cond'#1@@0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#1@@0|) |#M0.Literal.litFalse|)) (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.ifFalse (Lit DatatypeTypeType |expr#0@@8|))) |st'#4@@0| |env#0@@20|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@37|))))) (ite (M0.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@8|)) (let ((|st'#5@@0| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@37| |env#0@@20|))))
(let ((|conj0'#1@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@37| |env#0@@20|)))))
(ite  (and (M0.Expression.exprLiteral_q |conj0'#1@@0|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#1@@0|) |#M0.Literal.litTrue|)) (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.conj1 (Lit DatatypeTypeType |expr#0@@8|))) |st'#5@@0| |env#0@@20|) (ite  (and (M0.Expression.exprLiteral_q |conj0'#1@@0|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#1@@0|) |#M0.Literal.litFalse|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprLiteral| (Lit DatatypeTypeType |#M0.Literal.litFalse|)))) |st'#5@@0|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@37|))))) (ite (M0.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@8|)) (let ((|st'#6@@0| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@37| |env#0@@20|))))
(let ((|disj0'#1@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@37| |env#0@@20|)))))
(ite  (and (M0.Expression.exprLiteral_q |disj0'#1@@0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#1@@0|) |#M0.Literal.litTrue|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprLiteral| (Lit DatatypeTypeType |#M0.Literal.litTrue|)))) |st'#6@@0|) (ite  (and (M0.Expression.exprLiteral_q |disj0'#1@@0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#1@@0|) |#M0.Literal.litFalse|)) (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.disj1 (Lit DatatypeTypeType |expr#0@@8|))) |st'#6@@0| |env#0@@20|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@37|))))) (ite (M0.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0@@8|)) (let ((|st'#7@@0| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@37| |env#0@@20|))))
(let ((|fun'#1@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@37| |env#0@@20|)))))
(let ((|sts'#1@@0| ($Unbox SetType (M0.Tuple.snd (M0.__default.evalArgs ($LS $ly@@20) (Lit DatatypeTypeType |expr#0@@8|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@37| |env#0@@20|)))))
(let ((|args'#1@@0| ($Unbox SeqType (M0.Tuple.fst (M0.__default.evalArgs ($LS $ly@@20) (Lit DatatypeTypeType |expr#0@@8|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@37| |env#0@@20|)))))
(let ((|sts''#1@@0| (|Set#Union| (|Set#UnionOne| |Set#Empty| |st'#7@@0|) |sts'#1@@0|)))
(ite  (not (M0.__default.Compatible |sts''#1@@0|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rCompatibility|)))) |st#0@@37|) (let ((|stCombined#1@@0| (M0.__default.Combine ($LS $LZ) |sts''#1@@0|)))
...
(|#M0.Tuple.Pair| ($Box DatatypeTypeType (|#M0.Expression.exprLiteral| (|#M0.Literal.litArrOfPaths| ($Unbox SetType (M0.Tuple.fst |ps#1@@0|))))) (M0.Tuple.snd |ps#1@@0|))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@37|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@37|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@37|))))))))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@37|))))))))))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :weight 3
 :skolemid |975|
 :pattern ( (M0.__default.eval ($LS $ly@@20) (Lit DatatypeTypeType |expr#0@@8|) |st#0@@37| |env#0@@20|))
))))
...
(assert (forall ((d@@85 T@U) ($h@@42 T@U) ) (!  (=> (and ($IsGoodHeap $h@@42) (and (M0.Program.Program_q d@@85) ($IsAlloc DatatypeTypeType d@@85 Tclass.M0.Program $h@@42))) ($IsAlloc SeqType (M0.Program.stmts d@@85) (TSeq Tclass.M0.Statement) $h@@42))
 :qid |unknown.0:0|
 :skolemid |1126|
 :pattern ( ($IsAlloc SeqType (M0.Program.stmts d@@85) (TSeq Tclass.M0.Statement) $h@@42))
)))
(assert (forall ((d@@86 T@U) ($h@@43 T@U) ) (!  (=> (and ($IsGoodHeap $h@@43) (and (M0.Expression.exprInvocation_q d@@86) ($IsAlloc DatatypeTypeType d@@86 Tclass.M0.Expression $h@@43))) ($IsAlloc SeqType (M0.Expression.args d@@86) (TSeq Tclass.M0.Expression) $h@@43))
 :qid |unknown.0:0|
 :skolemid |1231|
 :pattern ( ($IsAlloc SeqType (M0.Expression.args d@@86) (TSeq Tclass.M0.Expression) $h@@43))
)))
(assert (forall ((d@@87 T@U) ($h@@44 T@U) ) (!  (=> (and ($IsGoodHeap $h@@44) (and (M0.Literal.litArrOfPaths_q d@@87) ($IsAlloc DatatypeTypeType d@@87 Tclass.M0.Literal $h@@44))) ($IsAlloc SetType (M0.Literal.paths d@@87) (TSet Tclass.M0.Path) $h@@44))
 :qid |unknown.0:0|
 :skolemid |1307|
 :pattern ( ($IsAlloc SetType (M0.Literal.paths d@@87) (TSet Tclass.M0.Path) $h@@44))
)))
(assert (forall ((d@@88 T@U) ($h@@45 T@U) ) (!  (=> (and ($IsGoodHeap $h@@45) (and (M0.Literal.litArray_q d@@88) ($IsAlloc DatatypeTypeType d@@88 Tclass.M0.Literal $h@@45))) ($IsAlloc SeqType (M0.Literal.arr d@@88) (TSeq Tclass.M0.Expression) $h@@45))
 :qid |unknown.0:0|
 :skolemid |1327|
 :pattern ( ($IsAlloc SeqType (M0.Literal.arr d@@88) (TSeq Tclass.M0.Expression) $h@@45))
)))
...
(declare-fun |defass#_v3#0| () Bool)
(declare-fun |_v3#0| () T@U)
(set-info :boogie-vc-id Impl$$M0.__default.BuildLemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@13 alloc false)) (=> (and ($IsAlloc DatatypeTypeType |prog#0@@4| Tclass.M0.Program $Heap@@13) ($IsAllocBox |st#0@@38| Tclass.M0.State $Heap@@13)) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|M0.__default.Legal#canCall| (M0.Program.stmts |prog#0@@4|)) (or (M0.__default.Legal (M0.Program.stmts |prog#0@@4|)) (or (not (= (|Seq#Length| (M0.Program.stmts |prog#0@@4|)) 0)) (not true))))) (=> (M0.__default.Legal (M0.Program.stmts |prog#0@@4|)) (=> (and (and (|M0.__default.build#canCall| |prog#0@@4| |st#0@@38|) (M0.Tuple.Pair_q (M0.__default.build |prog#0@@4| |st#0@@38|))) (and (|M0.__default.build#canCall| |prog#0@@4| |st#0@@38|) (= |result#0@0| (M0.__default.build |prog#0@@4| |st#0@@38|)))) (and (=> (= (ControlFlow 0 2) (- 0 13)) true) (=> (M0.Tuple.Pair_q |result#0@0|) (=> (and (M0.Tuple.Pair_q |result#0@0|) (= |$rhs#0@0| ($Unbox DatatypeTypeType (M0.Tuple.fst |result#0@0|)))) (and (=> (= (ControlFlow 0 2) (- 0 12)) true) (=> (M0.Tuple.Pair_q |result#0@0|) (=> (and (and (M0.Tuple.Pair_q |result#0@0|) (= |$rhs#1@0| (M0.Tuple.snd |result#0@0|))) (and (M0.Program.Program_q |prog#0@@4|) (M0.Program.Program_q |prog#0@@4|))) (=> (and (and (and (= |stmts##0@0| (M0.Program.stmts |prog#0@@4|)) |M0.__default.EmptyEnv#canCall|) (and |M0.__default.EmptyEnv#canCall| (= |env##0@0| M0.__default.EmptyEnv))) (and (and ($Is DatatypeTypeType |call4formal@expr'#0| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |call4formal@expr'#0| Tclass.M0.Expression $Heap@@13)) (and ($IsBox |call5formal@st'#0| Tclass.M0.State) ($IsAllocBox |call5formal@st'#0| Tclass.M0.State $Heap@@13)))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|M0.__default.Legal#canCall| |stmts##0@0|) (or (M0.__default.Legal |stmts##0@0|) (or (not (= (|Seq#Length| |stmts##0@0|) 0)) (not true))))) (=> (=> (|M0.__default.Legal#canCall| |stmts##0@0|) (or (M0.__default.Legal |stmts##0@0|) (or (not (= (|Seq#Length| |stmts##0@0|) 0)) (not true)))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|M0.__default.ValidState#canCall| |st#0@@38|) (or (M0.__default.ValidState |st#0@@38|) (forall ((|p#0@@11| T@U) ) (!  (=> ($IsBox |p#0@@11| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@38|) |p#0@@11|) (M0.__default.WellFounded |p#0@@11|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |1052|
 :pattern ( (M0.__default.WellFounded |p#0@@11|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@38|) |p#0@@11|))
))))) (=> (=> (|M0.__default.ValidState#canCall| |st#0@@38|) (or (M0.__default.ValidState |st#0@@38|) (forall ((|p#0@@12| T@U) ) (!  (=> ($IsBox |p#0@@12| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@38|) |p#0@@12|) (M0.__default.WellFounded |p#0@@12|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |1052|
 :pattern ( (M0.__default.WellFounded |p#0@@12|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@38|) |p#0@@12|))
)))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (M0.__default.ValidEnv |env##0@0|)) (=> (M0.__default.ValidEnv |env##0@0|) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and ($Is DatatypeTypeType |call4formal@expr'#0@0| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |call4formal@expr'#0@0| Tclass.M0.Expression $Heap@0)) (and ($IsBox |call5formal@st'#0@0| Tclass.M0.State) ($IsAllocBox |call5formal@st'#0@0| Tclass.M0.State $Heap@0))) (=> (and (and (and (and (and (|$IsA#M0.Tuple| (M0.__default.do ($LS $LZ) |stmts##0@0| |st#0@@38| |env##0@0|)) (|M0.__default.do#canCall| |stmts##0@0| |st#0@@38| |env##0@0|)) (=> (|M0.Tuple#Equal| (|#M0.Tuple.Pair| ($Box DatatypeTypeType |call4formal@expr'#0@0|) |call5formal@st'#0@0|) (M0.__default.do ($LS $LZ) |stmts##0@0| |st#0@@38| |env##0@0|)) (and (|M0.__default.ValidState#canCall| |call5formal@st'#0@0|) (=> (M0.__default.ValidState |call5formal@st'#0@0|) (and (|M0.__default.Extends#canCall| |st#0@@38| |call5formal@st'#0@0|) (=> (M0.__default.Extends |st#0@@38| |call5formal@st'#0@0|) (=> (M0.Expression.exprError_q |call4formal@expr'#0@0|) (|$IsA#M0.Reason| (M0.Expression.r |call4formal@expr'#0@0|))))))))) (|M0.Tuple#Equal| (|#M0.Tuple.Pair| ($Box DatatypeTypeType |call4formal@expr'#0@0|) |call5formal@st'#0@0|) (M0.__default.do ($LS ($LS $LZ)) |stmts##0@0| |st#0@@38| |env##0@0|))) (and (|M0.__default.ValidState#canCall| |call5formal@st'#0@0|) (and (M0.__default.ValidState |call5formal@st'#0@0|) (forall ((|p#1@@5| T@U) ) (!  (=> ($IsBox |p#1@@5| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |call5formal@st'#0@0|) |p#1@@5|) (M0.__default.WellFounded |p#1@@5|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |1055|
 :pattern ( (M0.__default.WellFounded |p#1@@5|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |call5formal@st'#0@0|) |p#1@@5|))
))))) (and (and (|M0.__default.Extends#canCall| |st#0@@38| |call5formal@st'#0@0|) (and (M0.__default.Extends |st#0@@38| |call5formal@st'#0@0|) (and (and (|Set#Subset| (M0.__default.DomSt |st#0@@38|) (M0.__default.DomSt |call5formal@st'#0@0|)) (forall ((|p#2@@2| T@U) ) (!  (=> ($IsBox |p#2@@2| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@38|) |p#2@@2|) (= (M0.__default.GetSt |p#2@@2| |call5formal@st'#0@0|) (M0.__default.GetSt |p#2@@2| |st#0@@38|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |1058|
 :pattern ( (M0.__default.GetSt |p#2@@2| |st#0@@38|))
 :pattern ( (M0.__default.GetSt |p#2@@2| |call5formal@st'#0@0|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@38|) |p#2@@2|))
))) (forall ((|p#3@@1| T@U) ) (!  (=> ($IsBox |p#3@@1| Tclass.M0.Path) (=> (and (not (|Set#IsMember| (M0.__default.DomSt |st#0@@38|) |p#3@@1|)) (|Set#IsMember| (M0.__default.DomSt |call5formal@st'#0@0|) |p#3@@1|)) (= (M0.__default.GetSt |p#3@@1| |call5formal@st'#0@0|) (M0.__default.Oracle |p#3@@1| |st#0@@38|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |1059|
 :pattern ( (M0.__default.Oracle |p#3@@1| |st#0@@38|))
 :pattern ( (M0.__default.GetSt |p#3@@1| |call5formal@st'#0@0|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |call5formal@st'#0@0|) |p#3@@1|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@38|) |p#3@@1|))
))))) (and (=> (M0.Expression.exprError_q |call4formal@expr'#0@0|) (|M0.Reason#Equal| (M0.Expression.r |call4formal@expr'#0@0|) |#M0.Reason.rValidity|)) (= $Heap@@13 $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 8)) true) (and (=> (= (ControlFlow 0 2) (- 0 7)) (|M0.Tuple#Equal| (M0.__default.build |prog#0@@4| |st#0@@38|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType |$rhs#0@0|) |$rhs#1@0|))) (=> (|M0.Tuple#Equal| (M0.__default.build |prog#0@@4| |st#0@@38|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType |$rhs#0@0|) |$rhs#1@0|)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|M0.__default.ValidState#canCall| |$rhs#1@0|) (or (M0.__default.ValidState |$rhs#1@0|) (forall ((|p#5| T@U) ) (!  (=> ($IsBox |p#5| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |$rhs#1@0|) |p#5|) (M0.__default.WellFounded |p#5|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |1045|
...
)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|M0.__default.Extends#canCall| |st#0@@38| |$rhs#1@0|) (or (M0.__default.Extends |st#0@@38| |$rhs#1@0|) (|Set#Subset| (M0.__default.DomSt |st#0@@38|) (M0.__default.DomSt |$rhs#1@0|))))) (=> (=> (|M0.__default.Extends#canCall| |st#0@@38| |$rhs#1@0|) (or (M0.__default.Extends |st#0@@38| |$rhs#1@0|) (|Set#Subset| (M0.__default.DomSt |st#0@@38|) (M0.__default.DomSt |$rhs#1@0|)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|M0.__default.Extends#canCall| |st#0@@38| |$rhs#1@0|) (or (M0.__default.Extends |st#0@@38| |$rhs#1@0|) (forall ((|p#6| T@U) ) (!  (=> ($IsBox |p#6| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@38|) |p#6|) (= (M0.__default.GetSt |p#6| |$rhs#1@0|) (M0.__default.GetSt |p#6| |st#0@@38|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |1047|
 :pattern ( (M0.__default.GetSt |p#6| |st#0@@38|))
 :pattern ( (M0.__default.GetSt |p#6| |$rhs#1@0|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@38|) |p#6|))
))))) (=> (=> (|M0.__default.Extends#canCall| |st#0@@38| |$rhs#1@0|) (or (M0.__default.Extends |st#0@@38| |$rhs#1@0|) (forall ((|p#6@@0| T@U) ) (!  (=> ($IsBox |p#6@@0| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@38|) |p#6@@0|) (= (M0.__default.GetSt |p#6@@0| |$rhs#1@0|) (M0.__default.GetSt |p#6@@0| |st#0@@38|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |1047|
 :pattern ( (M0.__default.GetSt |p#6@@0| |st#0@@38|))
 :pattern ( (M0.__default.GetSt |p#6@@0| |$rhs#1@0|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@38|) |p#6@@0|))
)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|M0.__default.Extends#canCall| |st#0@@38| |$rhs#1@0|) (or (M0.__default.Extends |st#0@@38| |$rhs#1@0|) (forall ((|p#7| T@U) ) (!  (=> ($IsBox |p#7| Tclass.M0.Path) (=> (and (not (|Set#IsMember| (M0.__default.DomSt |st#0@@38|) |p#7|)) (|Set#IsMember| (M0.__default.DomSt |$rhs#1@0|) |p#7|)) (= (M0.__default.GetSt |p#7| |$rhs#1@0|) (M0.__default.Oracle |p#7| |st#0@@38|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |1048|
 :pattern ( (M0.__default.Oracle |p#7| |st#0@@38|))
 :pattern ( (M0.__default.GetSt |p#7| |$rhs#1@0|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |$rhs#1@0|) |p#7|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@38|) |p#7|))
))))) (=> (=> (|M0.__default.Extends#canCall| |st#0@@38| |$rhs#1@0|) (or (M0.__default.Extends |st#0@@38| |$rhs#1@0|) (forall ((|p#7@@0| T@U) ) (!  (=> ($IsBox |p#7@@0| Tclass.M0.Path) (=> (and (not (|Set#IsMember| (M0.__default.DomSt |st#0@@38|) |p#7@@0|)) (|Set#IsMember| (M0.__default.DomSt |$rhs#1@0|) |p#7@@0|)) (= (M0.__default.GetSt |p#7@@0| |$rhs#1@0|) (M0.__default.Oracle |p#7@@0| |st#0@@38|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |1048|
 :pattern ( (M0.__default.Oracle |p#7@@0| |st#0@@38|))
 :pattern ( (M0.__default.GetSt |p#7@@0| |$rhs#1@0|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |$rhs#1@0|) |p#7@@0|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@38|) |p#7@@0|))
)))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (M0.Expression.exprError_q |$rhs#0@0|) (|M0.Reason#Equal| (M0.Expression.r |$rhs#0@0|) |#M0.Reason.rValidity|)))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@13) ($IsHeapAnchor $Heap@@13)) (=> (and (and (and ($Is DatatypeTypeType |prog#0@@4| Tclass.M0.Program) ($IsAlloc DatatypeTypeType |prog#0@@4| Tclass.M0.Program $Heap@@13)) (|$IsA#M0.Program| |prog#0@@4|)) (and ($IsBox |st#0@@38| Tclass.M0.State) ($IsAllocBox |st#0@@38| Tclass.M0.State $Heap@@13))) (=> (and (and (and (and (and ($Is DatatypeTypeType |expr'#0@@1| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |expr'#0@@1| Tclass.M0.Expression $Heap@@13)) (=> |defass#st'#0| (and ($IsBox |st'#0@@9| Tclass.M0.State) ($IsAllocBox |st'#0@@9| Tclass.M0.State $Heap@@13)))) (and (=> |defass#result#0| (and ($Is DatatypeTypeType |result#0@@0| (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State)) ($IsAlloc DatatypeTypeType |result#0@@0| (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State) $Heap@@13))) true)) (and (and ($Is DatatypeTypeType |_v2#0| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |_v2#0| Tclass.M0.Expression $Heap@@13)) true)) (and (and (and (and (=> |defass#_v3#0| (and ($IsBox |_v3#0| Tclass.M0.State) ($IsAllocBox |_v3#0| Tclass.M0.State $Heap@@13))) true) (= 7 $FunctionContextHeight)) (and (|M0.__default.Legal#canCall| (M0.Program.stmts |prog#0@@4|)) (and (M0.__default.Legal (M0.Program.stmts |prog#0@@4|)) (or (not (= (|Seq#Length| (M0.Program.stmts |prog#0@@4|)) 0)) (not true))))) (and (and (|M0.__default.ValidState#canCall| |st#0@@38|) (and (M0.__default.ValidState |st#0@@38|) (forall ((|p#4| T@U) ) (!  (=> ($IsBox |p#4| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@38|) |p#4|) (M0.__default.WellFounded |p#4|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |1044|
 :pattern ( (M0.__default.WellFounded |p#4|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@38|) |p#4|))
