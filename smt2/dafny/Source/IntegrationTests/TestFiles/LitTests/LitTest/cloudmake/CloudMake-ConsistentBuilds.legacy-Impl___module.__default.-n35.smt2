...
(assert (forall ((d@@25 T@U) ) (! (= (_module.Reason.rCompatibility_q d@@25) (= (DatatypeCtorId d@@25) |##_module.Reason.rCompatibility|))
 :qid |unknown.0:0|
 :skolemid |1503|
 :pattern ( (_module.Reason.rCompatibility_q d@@25))
)))
(assert (forall ((d@@26 T@U) ) (! (= (_module.Reason.rValidity_q d@@26) (= (DatatypeCtorId d@@26) |##_module.Reason.rValidity|))
 :qid |unknown.0:0|
 :skolemid |1505|
 :pattern ( (_module.Reason.rValidity_q d@@26))
)))
(assert (forall ((d@@27 T@U) ) (! (= (_module.Reason.rInconsistentCache_q d@@27) (= (DatatypeCtorId d@@27) |##_module.Reason.rInconsistentCache|))
 :qid |unknown.0:0|
 :skolemid |1507|
 :pattern ( (_module.Reason.rInconsistentCache_q d@@27))
)))
...
(assert (forall ((d@@48 T@U) ) (!  (=> (_module.Statement.stmtReturn_q d@@48) (exists ((|a#21#0#0| T@U) ) (! (= d@@48 (|#_module.Statement.stmtReturn| |a#21#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.317:33|
 :skolemid |1312|
)))
 :qid |unknown.0:0|
 :skolemid |1313|
 :pattern ( (_module.Statement.stmtReturn_q d@@48))
)))
(assert (forall ((d@@49 T@U) ) (!  (=> (_module.Expression.exprLiteral_q d@@49) (exists ((|a#27#0#0| T@U) ) (! (= d@@49 (|#_module.Expression.exprLiteral| |a#27#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.319:35|
 :skolemid |1327|
)))
 :qid |unknown.0:0|
 :skolemid |1328|
 :pattern ( (_module.Expression.exprLiteral_q d@@49))
)))
(assert (forall ((d@@50 T@U) ) (!  (=> (_module.Expression.exprIdentifier_q d@@50) (exists ((|a#33#0#0| T@U) ) (! (= d@@50 (|#_module.Expression.exprIdentifier| |a#33#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.319:66|
 :skolemid |1337|
)))
 :qid |unknown.0:0|
 :skolemid |1338|
 :pattern ( (_module.Expression.exprIdentifier_q d@@50))
)))
(assert (forall ((d@@51 T@U) ) (!  (=> (_module.Expression.exprError_q d@@51) (exists ((|a#73#0#0| T@U) ) (! (= d@@51 (|#_module.Expression.exprError| |a#73#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.324:33|
 :skolemid |1397|
)))
 :qid |unknown.0:0|
 :skolemid |1398|
 :pattern ( (_module.Expression.exprError_q d@@51))
)))
(assert (forall ((d@@52 T@U) ) (!  (=> (_module.Literal.litNumber_q d@@52) (exists ((|a#95#0#0| Int) ) (! (= d@@52 (|#_module.Literal.litNumber| |a#95#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.327:30|
 :skolemid |1426|
)))
 :qid |unknown.0:0|
 :skolemid |1427|
 :pattern ( (_module.Literal.litNumber_q d@@52))
)))
(assert (forall ((d@@53 T@U) ) (!  (=> (_module.Literal.litString_q d@@53) (exists ((|a#100#0#0| T@U) ) (! (= d@@53 (|#_module.Literal.litString| |a#100#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.327:52|
 :skolemid |1434|
)))
 :qid |unknown.0:0|
 :skolemid |1435|
 :pattern ( (_module.Literal.litString_q d@@53))
)))
(assert (forall ((d@@54 T@U) ) (!  (=> (_module.Literal.litPrimitive_q d@@54) (exists ((|a#107#0#0| T@U) ) (! (= d@@54 (|#_module.Literal.litPrimitive| |a#107#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.328:33|
 :skolemid |1444|
)))
 :qid |unknown.0:0|
 :skolemid |1445|
 :pattern ( (_module.Literal.litPrimitive_q d@@54))
)))
(assert (forall ((d@@55 T@U) ) (!  (=> (_module.Literal.litArrOfPaths_q d@@55) (exists ((|a#113#0#0| T@U) ) (! (= d@@55 (|#_module.Literal.litArrOfPaths| |a#113#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.329:34|
 :skolemid |1453|
)))
 :qid |unknown.0:0|
 :skolemid |1454|
 :pattern ( (_module.Literal.litArrOfPaths_q d@@55))
)))
(assert (forall ((d@@56 T@U) ) (!  (=> (_module.Literal.litArrOfStrings_q d@@56) (exists ((|a#119#0#0| T@U) ) (! (= d@@56 (|#_module.Literal.litArrOfStrings| |a#119#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.330:36|
 :skolemid |1462|
)))
 :qid |unknown.0:0|
 :skolemid |1463|
 :pattern ( (_module.Literal.litArrOfStrings_q d@@56))
)))
(assert (forall ((d@@57 T@U) ) (!  (=> (_module.Literal.litArray_q d@@57) (exists ((|a#125#0#0| T@U) ) (! (= d@@57 (|#_module.Literal.litArray| |a#125#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.331:29|
 :skolemid |1471|
)))
 :qid |unknown.0:0|
 :skolemid |1472|
 :pattern ( (_module.Literal.litArray_q d@@57))
)))
(assert (forall ((d@@58 T@U) ) (!  (=> ($Is DatatypeTypeType d@@58 Tclass._module.Expression) (or (or (or (or (or (or (_module.Expression.exprLiteral_q d@@58) (_module.Expression.exprIdentifier_q d@@58)) (_module.Expression.exprIf_q d@@58)) (_module.Expression.exprAnd_q d@@58)) (_module.Expression.exprOr_q d@@58)) (_module.Expression.exprInvocation_q d@@58)) (_module.Expression.exprError_q d@@58)))
 :qid |unknown.0:0|
 :skolemid |1407|
 :pattern ( (_module.Expression.exprError_q d@@58) ($Is DatatypeTypeType d@@58 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprInvocation_q d@@58) ($Is DatatypeTypeType d@@58 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprOr_q d@@58) ($Is DatatypeTypeType d@@58 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprAnd_q d@@58) ($Is DatatypeTypeType d@@58 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprIf_q d@@58) ($Is DatatypeTypeType d@@58 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprIdentifier_q d@@58) ($Is DatatypeTypeType d@@58 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprLiteral_q d@@58) ($Is DatatypeTypeType d@@58 Tclass._module.Expression))
)))
...
(assert (forall ((d@@59 T@U) ) (!  (=> ($Is DatatypeTypeType d@@59 Tclass._module.Literal) (or (or (or (or (or (or (or (or (or (_module.Literal.litTrue_q d@@59) (_module.Literal.litFalse_q d@@59)) (_module.Literal.litUndefined_q d@@59)) (_module.Literal.litNull_q d@@59)) (_module.Literal.litNumber_q d@@59)) (_module.Literal.litString_q d@@59)) (_module.Literal.litPrimitive_q d@@59)) (_module.Literal.litArrOfPaths_q d@@59)) (_module.Literal.litArrOfStrings_q d@@59)) (_module.Literal.litArray_q d@@59)))
 :qid |unknown.0:0|
 :skolemid |1481|
 :pattern ( (_module.Literal.litArray_q d@@59) ($Is DatatypeTypeType d@@59 Tclass._module.Literal))
 :pattern ( (_module.Literal.litArrOfStrings_q d@@59) ($Is DatatypeTypeType d@@59 Tclass._module.Literal))
 :pattern ( (_module.Literal.litArrOfPaths_q d@@59) ($Is DatatypeTypeType d@@59 Tclass._module.Literal))
 :pattern ( (_module.Literal.litPrimitive_q d@@59) ($Is DatatypeTypeType d@@59 Tclass._module.Literal))
 :pattern ( (_module.Literal.litString_q d@@59) ($Is DatatypeTypeType d@@59 Tclass._module.Literal))
 :pattern ( (_module.Literal.litNumber_q d@@59) ($Is DatatypeTypeType d@@59 Tclass._module.Literal))
 :pattern ( (_module.Literal.litNull_q d@@59) ($Is DatatypeTypeType d@@59 Tclass._module.Literal))
 :pattern ( (_module.Literal.litUndefined_q d@@59) ($Is DatatypeTypeType d@@59 Tclass._module.Literal))
 :pattern ( (_module.Literal.litFalse_q d@@59) ($Is DatatypeTypeType d@@59 Tclass._module.Literal))
 :pattern ( (_module.Literal.litTrue_q d@@59) ($Is DatatypeTypeType d@@59 Tclass._module.Literal))
)))
...
(assert (forall ((_module.Triple$A@@5 T@U) (_module.Triple$B@@5 T@U) (_module.Triple$C@@5 T@U) (d@@60 T@U) ) (!  (=> ($Is DatatypeTypeType d@@60 (Tclass._module.Triple _module.Triple$A@@5 _module.Triple$B@@5 _module.Triple$C@@5)) (_module.Triple.Trio_q d@@60))
 :qid |unknown.0:0|
 :skolemid |1577|
 :pattern ( (_module.Triple.Trio_q d@@60) ($Is DatatypeTypeType d@@60 (Tclass._module.Triple _module.Triple$A@@5 _module.Triple$B@@5 _module.Triple$C@@5)))
)))
...
(assert (forall ((d@@61 T@U) ) (!  (=> ($Is DatatypeTypeType d@@61 Tclass._module.Statement) (or (_module.Statement.stmtVariable_q d@@61) (_module.Statement.stmtReturn_q d@@61)))
 :qid |unknown.0:0|
 :skolemid |1321|
 :pattern ( (_module.Statement.stmtReturn_q d@@61) ($Is DatatypeTypeType d@@61 Tclass._module.Statement))
 :pattern ( (_module.Statement.stmtVariable_q d@@61) ($Is DatatypeTypeType d@@61 Tclass._module.Statement))
)))
...
(assert (forall ((d@@63 T@U) ) (!  (=> (|$IsA#_module.Reason| d@@63) (or (or (_module.Reason.rCompatibility_q d@@63) (_module.Reason.rValidity_q d@@63)) (_module.Reason.rInconsistentCache_q d@@63)))
 :qid |unknown.0:0|
 :skolemid |1510|
 :pattern ( (|$IsA#_module.Reason| d@@63))
)))
...
(assert (forall ((d@@64 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.Literal.litNumber_q d@@64) ($IsAlloc DatatypeTypeType d@@64 Tclass._module.Literal $h@@1))) ($IsAlloc intType (int_2_U (_module.Literal.num d@@64)) TInt $h@@1))
 :qid |unknown.0:0|
 :skolemid |1429|
 :pattern ( ($IsAlloc intType (int_2_U (_module.Literal.num d@@64)) TInt $h@@1))
)))
...
(assert (forall ((d@@65 T@U) ) (!  (=> ($Is DatatypeTypeType d@@65 Tclass._module.Reason) (or (or (_module.Reason.rCompatibility_q d@@65) (_module.Reason.rValidity_q d@@65)) (_module.Reason.rInconsistentCache_q d@@65)))
 :qid |unknown.0:0|
 :skolemid |1511|
 :pattern ( (_module.Reason.rInconsistentCache_q d@@65) ($Is DatatypeTypeType d@@65 Tclass._module.Reason))
 :pattern ( (_module.Reason.rValidity_q d@@65) ($Is DatatypeTypeType d@@65 Tclass._module.Reason))
 :pattern ( (_module.Reason.rCompatibility_q d@@65) ($Is DatatypeTypeType d@@65 Tclass._module.Reason))
)))
...
(assert (forall ((d@@66 T@U) ) (! (= (BoxRank ($Box DatatypeTypeType d@@66)) (DtRank d@@66))
 :qid |DafnyPreludebpl.391:15|
 :skolemid |84|
 :pattern ( (BoxRank ($Box DatatypeTypeType d@@66)))
)))
...
(assert (forall ((d@@67 T@U) (_module.Triple$A@@7 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (_module.Triple.Trio_q d@@67) (exists ((_module.Triple$B@@7 T@U) (_module.Triple$C@@7 T@U) ) (! ($IsAlloc DatatypeTypeType d@@67 (Tclass._module.Triple _module.Triple$A@@7 _module.Triple$B@@7 _module.Triple$C@@7) $h@@2)
 :qid |unknown.0:0|
 :skolemid |1563|
 :pattern ( ($IsAlloc DatatypeTypeType d@@67 (Tclass._module.Triple _module.Triple$A@@7 _module.Triple$B@@7 _module.Triple$C@@7) $h@@2))
)))) ($IsAllocBox (_module.Triple.fst d@@67) _module.Triple$A@@7 $h@@2))
 :qid |unknown.0:0|
 :skolemid |1564|
 :pattern ( ($IsAllocBox (_module.Triple.fst d@@67) _module.Triple$A@@7 $h@@2))
)))
(assert (forall ((d@@68 T@U) (_module.Triple$B@@8 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (_module.Triple.Trio_q d@@68) (exists ((_module.Triple$A@@8 T@U) (_module.Triple$C@@8 T@U) ) (! ($IsAlloc DatatypeTypeType d@@68 (Tclass._module.Triple _module.Triple$A@@8 _module.Triple$B@@8 _module.Triple$C@@8) $h@@3)
 :qid |unknown.0:0|
 :skolemid |1565|
 :pattern ( ($IsAlloc DatatypeTypeType d@@68 (Tclass._module.Triple _module.Triple$A@@8 _module.Triple$B@@8 _module.Triple$C@@8) $h@@3))
)))) ($IsAllocBox (_module.Triple.snd d@@68) _module.Triple$B@@8 $h@@3))
 :qid |unknown.0:0|
 :skolemid |1566|
 :pattern ( ($IsAllocBox (_module.Triple.snd d@@68) _module.Triple$B@@8 $h@@3))
)))
(assert (forall ((d@@69 T@U) (_module.Triple$C@@9 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (_module.Triple.Trio_q d@@69) (exists ((_module.Triple$A@@9 T@U) (_module.Triple$B@@9 T@U) ) (! ($IsAlloc DatatypeTypeType d@@69 (Tclass._module.Triple _module.Triple$A@@9 _module.Triple$B@@9 _module.Triple$C@@9) $h@@4)
 :qid |unknown.0:0|
 :skolemid |1567|
 :pattern ( ($IsAlloc DatatypeTypeType d@@69 (Tclass._module.Triple _module.Triple$A@@9 _module.Triple$B@@9 _module.Triple$C@@9) $h@@4))
)))) ($IsAllocBox (_module.Triple.trd d@@69) _module.Triple$C@@9 $h@@4))
 :qid |unknown.0:0|
 :skolemid |1568|
 :pattern ( ($IsAllocBox (_module.Triple.trd d@@69) _module.Triple$C@@9 $h@@4))
)))
(assert (forall ((d@@70 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) ($Is DatatypeTypeType d@@70 Tclass._module.StateC)) ($IsAlloc DatatypeTypeType d@@70 Tclass._module.StateC $h@@5))
 :qid |unknown.0:0|
 :skolemid |1279|
 :pattern ( ($IsAlloc DatatypeTypeType d@@70 Tclass._module.StateC $h@@5))
)))
(assert (forall ((d@@71 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) ($Is DatatypeTypeType d@@71 Tclass._module.Statement)) ($IsAlloc DatatypeTypeType d@@71 Tclass._module.Statement $h@@6))
 :qid |unknown.0:0|
 :skolemid |1319|
 :pattern ( ($IsAlloc DatatypeTypeType d@@71 Tclass._module.Statement $h@@6))
)))
(assert (forall ((d@@72 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) ($Is DatatypeTypeType d@@72 Tclass._module.Expression)) ($IsAlloc DatatypeTypeType d@@72 Tclass._module.Expression $h@@7))
 :qid |unknown.0:0|
 :skolemid |1405|
 :pattern ( ($IsAlloc DatatypeTypeType d@@72 Tclass._module.Expression $h@@7))
)))
(assert (forall ((d@@73 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) ($Is DatatypeTypeType d@@73 Tclass._module.Literal)) ($IsAlloc DatatypeTypeType d@@73 Tclass._module.Literal $h@@8))
 :qid |unknown.0:0|
 :skolemid |1479|
 :pattern ( ($IsAlloc DatatypeTypeType d@@73 Tclass._module.Literal $h@@8))
)))
(assert (forall ((d@@74 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) ($Is DatatypeTypeType d@@74 Tclass._module.Primitive)) ($IsAlloc DatatypeTypeType d@@74 Tclass._module.Primitive $h@@9))
 :qid |unknown.0:0|
 :skolemid |1497|
 :pattern ( ($IsAlloc DatatypeTypeType d@@74 Tclass._module.Primitive $h@@9))
)))
(assert (forall ((d@@75 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) ($Is DatatypeTypeType d@@75 Tclass._module.Reason)) ($IsAlloc DatatypeTypeType d@@75 Tclass._module.Reason $h@@10))
 :qid |unknown.0:0|
 :skolemid |1509|
 :pattern ( ($IsAlloc DatatypeTypeType d@@75 Tclass._module.Reason $h@@10))
)))
(assert (forall ((d@@76 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) ($Is DatatypeTypeType d@@76 Tclass._module.Path)) ($IsAlloc DatatypeTypeType d@@76 Tclass._module.Path $h@@11))
 :qid |unknown.0:0|
 :skolemid |1532|
 :pattern ( ($IsAlloc DatatypeTypeType d@@76 Tclass._module.Path $h@@11))
)))
...
(assert (forall ((d@@77 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (_module.Literal.litString_q d@@77) ($IsAlloc DatatypeTypeType d@@77 Tclass._module.Literal $h@@12))) ($IsAlloc SeqType (_module.Literal.str d@@77) (TSeq TChar) $h@@12))
 :qid |unknown.0:0|
 :skolemid |1437|
 :pattern ( ($IsAlloc SeqType (_module.Literal.str d@@77) (TSeq TChar) $h@@12))
)))
(assert (forall ((|a#117#0#0| T@U) (d@@78 T@U) ) (!  (=> (|Set#IsMember| |a#117#0#0| ($Box DatatypeTypeType d@@78)) (< (DtRank d@@78) (DtRank (|#_module.Literal.litArrOfPaths| |a#117#0#0|))))
 :qid |CloudMakeConsistentBuildslegacydfy.329:34|
 :skolemid |1459|
 :pattern ( (|Set#IsMember| |a#117#0#0| ($Box DatatypeTypeType d@@78)) (|#_module.Literal.litArrOfPaths| |a#117#0#0|))
)))
(assert (forall ((|a#123#0#0| T@U) (d@@79 T@U) ) (!  (=> (|Set#IsMember| |a#123#0#0| ($Box DatatypeTypeType d@@79)) (< (DtRank d@@79) (DtRank (|#_module.Literal.litArrOfStrings| |a#123#0#0|))))
 :qid |CloudMakeConsistentBuildslegacydfy.330:36|
 :skolemid |1468|
 :pattern ( (|Set#IsMember| |a#123#0#0| ($Box DatatypeTypeType d@@79)) (|#_module.Literal.litArrOfStrings| |a#123#0#0|))
)))
...
(assert (forall ((d@@80 T@U) (_module.Tuple$A@@6 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (_module.Tuple.Pair_q d@@80) (exists ((_module.Tuple$B@@6 T@U) ) (! ($IsAlloc DatatypeTypeType d@@80 (Tclass._module.Tuple _module.Tuple$A@@6 _module.Tuple$B@@6) $h@@13)
 :qid |unknown.0:0|
 :skolemid |1544|
 :pattern ( ($IsAlloc DatatypeTypeType d@@80 (Tclass._module.Tuple _module.Tuple$A@@6 _module.Tuple$B@@6) $h@@13))
)))) ($IsAllocBox (_module.Tuple.fst d@@80) _module.Tuple$A@@6 $h@@13))
 :qid |unknown.0:0|
 :skolemid |1545|
 :pattern ( ($IsAllocBox (_module.Tuple.fst d@@80) _module.Tuple$A@@6 $h@@13))
)))
(assert (forall ((d@@81 T@U) (_module.Tuple$B@@7 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (_module.Tuple.Pair_q d@@81) (exists ((_module.Tuple$A@@7 T@U) ) (! ($IsAlloc DatatypeTypeType d@@81 (Tclass._module.Tuple _module.Tuple$A@@7 _module.Tuple$B@@7) $h@@14)
 :qid |unknown.0:0|
 :skolemid |1546|
 :pattern ( ($IsAlloc DatatypeTypeType d@@81 (Tclass._module.Tuple _module.Tuple$A@@7 _module.Tuple$B@@7) $h@@14))
)))) ($IsAllocBox (_module.Tuple.snd d@@81) _module.Tuple$B@@7 $h@@14))
 :qid |unknown.0:0|
 :skolemid |1547|
 :pattern ( ($IsAllocBox (_module.Tuple.snd d@@81) _module.Tuple$B@@7 $h@@14))
)))
...
(assert (forall ((d@@82 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (_module.StateC.S_q d@@82) ($IsAlloc DatatypeTypeType d@@82 Tclass._module.StateC $h@@15))) ($IsAllocBox (_module.StateC.st d@@82) Tclass._module.State $h@@15))
 :qid |unknown.0:0|
 :skolemid |1274|
 :pattern ( ($IsAllocBox (_module.StateC.st d@@82) Tclass._module.State $h@@15))
)))
(assert (forall ((d@@83 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (_module.StateC.S_q d@@83) ($IsAlloc DatatypeTypeType d@@83 Tclass._module.StateC $h@@16))) ($IsAllocBox (_module.StateC.c d@@83) Tclass._module.Cache $h@@16))
 :qid |unknown.0:0|
 :skolemid |1275|
 :pattern ( ($IsAllocBox (_module.StateC.c d@@83) Tclass._module.Cache $h@@16))
)))
(assert (forall ((d@@84 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (_module.Statement.stmtVariable_q d@@84) ($IsAlloc DatatypeTypeType d@@84 Tclass._module.Statement $h@@17))) ($IsAllocBox (_module.Statement.id d@@84) Tclass._module.Identifier $h@@17))
 :qid |unknown.0:0|
 :skolemid |1304|
 :pattern ( ($IsAllocBox (_module.Statement.id d@@84) Tclass._module.Identifier $h@@17))
)))
(assert (forall ((d@@85 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (_module.Statement.stmtVariable_q d@@85) ($IsAlloc DatatypeTypeType d@@85 Tclass._module.Statement $h@@18))) ($IsAlloc DatatypeTypeType (_module.Statement.expr d@@85) Tclass._module.Expression $h@@18))
 :qid |unknown.0:0|
 :skolemid |1305|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Statement.expr d@@85) Tclass._module.Expression $h@@18))
)))
(assert (forall ((d@@86 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (_module.Statement.stmtReturn_q d@@86) ($IsAlloc DatatypeTypeType d@@86 Tclass._module.Statement $h@@19))) ($IsAlloc DatatypeTypeType (_module.Statement.ret d@@86) Tclass._module.Expression $h@@19))
 :qid |unknown.0:0|
 :skolemid |1315|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Statement.ret d@@86) Tclass._module.Expression $h@@19))
)))
(assert (forall ((d@@87 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (_module.Expression.exprLiteral_q d@@87) ($IsAlloc DatatypeTypeType d@@87 Tclass._module.Expression $h@@20))) ($IsAlloc DatatypeTypeType (_module.Expression.lit d@@87) Tclass._module.Literal $h@@20))
 :qid |unknown.0:0|
 :skolemid |1331|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.lit d@@87) Tclass._module.Literal $h@@20))
)))
(assert (forall ((d@@88 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (_module.Expression.exprIdentifier_q d@@88) ($IsAlloc DatatypeTypeType d@@88 Tclass._module.Expression $h@@21))) ($IsAllocBox (_module.Expression.id d@@88) Tclass._module.Identifier $h@@21))
 :qid |unknown.0:0|
 :skolemid |1340|
 :pattern ( ($IsAllocBox (_module.Expression.id d@@88) Tclass._module.Identifier $h@@21))
)))
(assert (forall ((d@@89 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (_module.Expression.exprIf_q d@@89) ($IsAlloc DatatypeTypeType d@@89 Tclass._module.Expression $h@@22))) ($IsAlloc DatatypeTypeType (_module.Expression.cond d@@89) Tclass._module.Expression $h@@22))
 :qid |unknown.0:0|
 :skolemid |1348|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.cond d@@89) Tclass._module.Expression $h@@22))
)))
(assert (forall ((d@@90 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (_module.Expression.exprIf_q d@@90) ($IsAlloc DatatypeTypeType d@@90 Tclass._module.Expression $h@@23))) ($IsAlloc DatatypeTypeType (_module.Expression.ifTrue d@@90) Tclass._module.Expression $h@@23))
 :qid |unknown.0:0|
 :skolemid |1349|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.ifTrue d@@90) Tclass._module.Expression $h@@23))
)))
(assert (forall ((d@@91 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (_module.Expression.exprIf_q d@@91) ($IsAlloc DatatypeTypeType d@@91 Tclass._module.Expression $h@@24))) ($IsAlloc DatatypeTypeType (_module.Expression.ifFalse d@@91) Tclass._module.Expression $h@@24))
 :qid |unknown.0:0|
 :skolemid |1350|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.ifFalse d@@91) Tclass._module.Expression $h@@24))
)))
(assert (forall ((d@@92 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (_module.Expression.exprAnd_q d@@92) ($IsAlloc DatatypeTypeType d@@92 Tclass._module.Expression $h@@25))) ($IsAlloc DatatypeTypeType (_module.Expression.conj0 d@@92) Tclass._module.Expression $h@@25))
 :qid |unknown.0:0|
 :skolemid |1363|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.conj0 d@@92) Tclass._module.Expression $h@@25))
)))
(assert (forall ((d@@93 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (_module.Expression.exprAnd_q d@@93) ($IsAlloc DatatypeTypeType d@@93 Tclass._module.Expression $h@@26))) ($IsAlloc DatatypeTypeType (_module.Expression.conj1 d@@93) Tclass._module.Expression $h@@26))
 :qid |unknown.0:0|
 :skolemid |1364|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.conj1 d@@93) Tclass._module.Expression $h@@26))
)))
(assert (forall ((d@@94 T@U) ($h@@27 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (_module.Expression.exprOr_q d@@94) ($IsAlloc DatatypeTypeType d@@94 Tclass._module.Expression $h@@27))) ($IsAlloc DatatypeTypeType (_module.Expression.disj0 d@@94) Tclass._module.Expression $h@@27))
 :qid |unknown.0:0|
 :skolemid |1375|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.disj0 d@@94) Tclass._module.Expression $h@@27))
)))
(assert (forall ((d@@95 T@U) ($h@@28 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (_module.Expression.exprOr_q d@@95) ($IsAlloc DatatypeTypeType d@@95 Tclass._module.Expression $h@@28))) ($IsAlloc DatatypeTypeType (_module.Expression.disj1 d@@95) Tclass._module.Expression $h@@28))
 :qid |unknown.0:0|
 :skolemid |1376|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.disj1 d@@95) Tclass._module.Expression $h@@28))
)))
(assert (forall ((d@@96 T@U) ($h@@29 T@U) ) (!  (=> (and ($IsGoodHeap $h@@29) (and (_module.Expression.exprInvocation_q d@@96) ($IsAlloc DatatypeTypeType d@@96 Tclass._module.Expression $h@@29))) ($IsAlloc DatatypeTypeType (_module.Expression.fun d@@96) Tclass._module.Expression $h@@29))
 :qid |unknown.0:0|
 :skolemid |1387|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.fun d@@96) Tclass._module.Expression $h@@29))
)))
(assert (forall ((d@@97 T@U) ($h@@30 T@U) ) (!  (=> (and ($IsGoodHeap $h@@30) (and (_module.Expression.exprError_q d@@97) ($IsAlloc DatatypeTypeType d@@97 Tclass._module.Expression $h@@30))) ($IsAlloc DatatypeTypeType (_module.Expression.r d@@97) Tclass._module.Reason $h@@30))
 :qid |unknown.0:0|
 :skolemid |1401|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.r d@@97) Tclass._module.Reason $h@@30))
)))
(assert (forall ((d@@98 T@U) ($h@@31 T@U) ) (!  (=> (and ($IsGoodHeap $h@@31) (and (_module.Literal.litPrimitive_q d@@98) ($IsAlloc DatatypeTypeType d@@98 Tclass._module.Literal $h@@31))) ($IsAlloc DatatypeTypeType (_module.Literal.prim d@@98) Tclass._module.Primitive $h@@31))
 :qid |unknown.0:0|
 :skolemid |1447|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Literal.prim d@@98) Tclass._module.Primitive $h@@31))
)))
...
(assert (forall ((d@@99 T@U) ($h@@32 T@U) ) (!  (=> (and ($IsGoodHeap $h@@32) (and (_module.Literal.litArrOfStrings_q d@@99) ($IsAlloc DatatypeTypeType d@@99 Tclass._module.Literal $h@@32))) ($IsAlloc SetType (_module.Literal.strs d@@99) (TSet (TSeq TChar)) $h@@32))
 :qid |unknown.0:0|
 :skolemid |1465|
 :pattern ( ($IsAlloc SetType (_module.Literal.strs d@@99) (TSet (TSeq TChar)) $h@@32))
)))
...
(assert (forall ((d@@100 T@U) ($h@@33 T@U) ) (!  (=> (and ($IsGoodHeap $h@@33) (and (_module.Expression.exprInvocation_q d@@100) ($IsAlloc DatatypeTypeType d@@100 Tclass._module.Expression $h@@33))) ($IsAlloc SeqType (_module.Expression.args d@@100) (TSeq Tclass._module.Expression) $h@@33))
 :qid |unknown.0:0|
 :skolemid |1388|
 :pattern ( ($IsAlloc SeqType (_module.Expression.args d@@100) (TSeq Tclass._module.Expression) $h@@33))
)))
(assert (forall ((d@@101 T@U) ($h@@34 T@U) ) (!  (=> (and ($IsGoodHeap $h@@34) (and (_module.Literal.litArrOfPaths_q d@@101) ($IsAlloc DatatypeTypeType d@@101 Tclass._module.Literal $h@@34))) ($IsAlloc SetType (_module.Literal.paths d@@101) (TSet Tclass._module.Path) $h@@34))
 :qid |unknown.0:0|
 :skolemid |1456|
 :pattern ( ($IsAlloc SetType (_module.Literal.paths d@@101) (TSet Tclass._module.Path) $h@@34))
)))
(assert (forall ((d@@102 T@U) ($h@@35 T@U) ) (!  (=> (and ($IsGoodHeap $h@@35) (and (_module.Literal.litArray_q d@@102) ($IsAlloc DatatypeTypeType d@@102 Tclass._module.Literal $h@@35))) ($IsAlloc SeqType (_module.Literal.arr d@@102) (TSeq Tclass._module.Expression) $h@@35))
 :qid |unknown.0:0|
 :skolemid |1474|
 :pattern ( ($IsAlloc SeqType (_module.Literal.arr d@@102) (TSeq Tclass._module.Expression) $h@@35))
)))
...
(declare-fun |defass#result#0_0| () Bool)
(declare-fun |result#0_0| () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.DoCLemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 39) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (let ((|result#0@@8| (_module.__default.doC ($LS ($LS $LZ)) |stmts#0@@6| |stC#0@@37| |env#0@@21|)))
(let ((|stC'#0@@10| ($Unbox DatatypeTypeType (_module.Tuple.snd |result#0@@8|))))
 (=> (|_module.__default.ConsistentCache#canCall| |stC'#0@@10|) (or (_module.__default.ConsistentCache |stC'#0@@10|) (forall ((|cmd#3@@0| T@U) (|deps#3@@0| T@U) (|e#3@@2| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#3@@0| Tclass._module.Expression) ($Is DatatypeTypeType |deps#3@@0| Tclass._module.Expression)) ($Is SeqType |e#3@@2| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC'#0@@10|)) (_module.__default.Hash (_module.__default.Loc |cmd#3@@0| |deps#3@@0| |e#3@@2|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC'#0@@10|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#3@@0| |deps#3@@0| |e#3@@2|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1194|
 :pattern ( (_module.__default.Loc |cmd#3@@0| |deps#3@@0| |e#3@@2|))
))))))) (=> (let ((|result#0@@9| (_module.__default.doC ($LS ($LS $LZ)) |stmts#0@@6| |stC#0@@37| |env#0@@21|)))
(let ((|stC'#0@@11| ($Unbox DatatypeTypeType (_module.Tuple.snd |result#0@@9|))))
 (=> (|_module.__default.ConsistentCache#canCall| |stC'#0@@11|) (or (_module.__default.ConsistentCache |stC'#0@@11|) (forall ((|cmd#3@@1| T@U) (|deps#3@@1| T@U) (|e#3@@3| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#3@@1| Tclass._module.Expression) ($Is DatatypeTypeType |deps#3@@1| Tclass._module.Expression)) ($Is SeqType |e#3@@3| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC'#0@@11|)) (_module.__default.Hash (_module.__default.Loc |cmd#3@@1| |deps#3@@1| |e#3@@3|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC'#0@@11|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#3@@1| |deps#3@@1| |e#3@@3|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1194|
 :pattern ( (_module.__default.Loc |cmd#3@@1| |deps#3@@1| |e#3@@3|))
)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (let ((|result#0@@10| (_module.__default.doC ($LS ($LS $LZ)) |stmts#0@@6| |stC#0@@37| |env#0@@21|)))
(let ((|expr'#0@@2| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#0@@10|))))
 (=> (_module.Expression.exprError_q |expr'#0@@2|) (not (|_module.Reason#Equal| (_module.Expression.r |expr'#0@@2|) |#_module.Reason.rInconsistentCache|))))))))))
(let ((anon11_Else_correct  (=> (and (not (_module.__default.Legal (|Seq#Drop| |stmts#0@@6| (LitInt 1)))) (= (ControlFlow 0 22) 2)) GeneratedUnifiedExit_correct)))
(let ((anon11_Then_correct  (=> (_module.__default.Legal (|Seq#Drop| |stmts#0@@6| (LitInt 1))) (and (=> (= (ControlFlow 0 15) (- 0 21)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |stmts#0@@6|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |stmts#0@@6|))) (=> (= |stmts##0_0_0_0@0| (|Seq#Drop| |stmts#0@@6| (LitInt 1))) (and (=> (= (ControlFlow 0 15) (- 0 20)) true) (and (=> (= (ControlFlow 0 15) (- 0 19)) true) (and (=> (= (ControlFlow 0 15) (- 0 18)) (or (< (|Seq#Rank| |stmts##0_0_0_0@0|) (|Seq#Rank| |stmts#0@@6|)) (and (= (|Seq#Rank| |stmts##0_0_0_0@0|) (|Seq#Rank| |stmts#0@@6|)) (< (DtRank |$rhs#0_1@0|) (DtRank |stC#0@@37|))))) (=> (or (< (|Seq#Rank| |stmts##0_0_0_0@0|) (|Seq#Rank| |stmts#0@@6|)) (and (= (|Seq#Rank| |stmts##0_0_0_0@0|) (|Seq#Rank| |stmts#0@@6|)) (< (DtRank |$rhs#0_1@0|) (DtRank |stC#0@@37|)))) (and (=> (= (ControlFlow 0 15) (- 0 17)) (=> (|_module.__default.Legal#canCall| |stmts##0_0_0_0@0|) (or (_module.__default.Legal |stmts##0_0_0_0@0|) (or (not (= (|Seq#Length| |stmts##0_0_0_0@0|) 0)) (not true))))) (=> (=> (|_module.__default.Legal#canCall| |stmts##0_0_0_0@0|) (or (_module.__default.Legal |stmts##0_0_0_0@0|) (or (not (= (|Seq#Length| |stmts##0_0_0_0@0|) 0)) (not true)))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (=> (|_module.__default.ConsistentCache#canCall| |$rhs#0_1@0|) (or (_module.__default.ConsistentCache |$rhs#0_1@0|) (forall ((|cmd#0@@19| T@U) (|deps#0@@18| T@U) (|e#0@@10| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#0@@19| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@18| Tclass._module.Expression)) ($Is SeqType |e#0@@10| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |$rhs#0_1@0|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@19| |deps#0@@18| |e#0@@10|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |$rhs#0_1@0|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0@@19| |deps#0@@18| |e#0@@10|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1188|
 :pattern ( (_module.__default.Loc |cmd#0@@19| |deps#0@@18| |e#0@@10|))
))))) (=> (=> (|_module.__default.ConsistentCache#canCall| |$rhs#0_1@0|) (or (_module.__default.ConsistentCache |$rhs#0_1@0|) (forall ((|cmd#0@@20| T@U) (|deps#0@@19| T@U) (|e#0@@11| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#0@@20| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@19| Tclass._module.Expression)) ($Is SeqType |e#0@@11| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |$rhs#0_1@0|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@20| |deps#0@@19| |e#0@@11|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |$rhs#0_1@0|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0@@20| |deps#0@@19| |e#0@@11|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1188|
 :pattern ( (_module.__default.Loc |cmd#0@@20| |deps#0@@19| |e#0@@11|))
)))) (=> (and (and (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (and (|_module.__default.doC#canCall| |stmts##0_0_0_0@0| |$rhs#0_1@0| |env'#0_0_0@0|) (let ((|result#0@@11| (_module.__default.doC ($LS $LZ) |stmts##0_0_0_0@0| |$rhs#0_1@0| |env'#0_0_0@0|)))
 (and (and (_module.Tuple.Pair_q |result#0@@11|) (_module.Tuple.Pair_q |result#0@@11|)) (let ((|stC'#0@@12| ($Unbox DatatypeTypeType (_module.Tuple.snd |result#0@@11|))))
(let ((|expr'#0@@3| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#0@@11|))))
 (and (|_module.__default.ConsistentCache#canCall| |stC'#0@@12|) (=> (_module.__default.ConsistentCache |stC'#0@@12|) (=> (_module.Expression.exprError_q |expr'#0@@3|) (|$IsA#_module.Reason| (_module.Expression.r |expr'#0@@3|))))))))))) (and (and (let ((|result#0@@12| (_module.__default.doC ($LS ($LS $LZ)) |stmts##0_0_0_0@0| |$rhs#0_1@0| |env'#0_0_0@0|)))
(let ((|stC'#0@@13| ($Unbox DatatypeTypeType (_module.Tuple.snd |result#0@@12|))))
 (and (|_module.__default.ConsistentCache#canCall| |stC'#0@@13|) (and (_module.__default.ConsistentCache |stC'#0@@13|) (forall ((|cmd#1@@2| T@U) (|deps#1@@2| T@U) (|e#1@@9| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#1@@2| Tclass._module.Expression) ($Is DatatypeTypeType |deps#1@@2| Tclass._module.Expression)) ($Is SeqType |e#1@@9| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC'#0@@13|)) (_module.__default.Hash (_module.__default.Loc |cmd#1@@2| |deps#1@@2| |e#1@@9|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC'#0@@13|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#1@@2| |deps#1@@2| |e#1@@9|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1191|
 :pattern ( (_module.__default.Loc |cmd#1@@2| |deps#1@@2| |e#1@@9|))
)))))) (let ((|result#0@@13| (_module.__default.doC ($LS ($LS $LZ)) |stmts##0_0_0_0@0| |$rhs#0_1@0| |env'#0_0_0@0|)))
(let ((|expr'#0@@4| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#0@@13|))))
 (=> (_module.Expression.exprError_q |expr'#0@@4|) (not (|_module.Reason#Equal| (_module.Expression.r |expr'#0@@4|) |#_module.Reason.rInconsistentCache|)))))) (and (= $Heap@1 $Heap@3) (= (ControlFlow 0 15) 2)))) GeneratedUnifiedExit_correct)))))))))))))))
(let ((anon10_Then_correct  (=> (_module.__default.Value |$rhs#0_0@0|) (and (=> (= (ControlFlow 0 23) (- 0 27)) true) (and (=> (= (ControlFlow 0 23) (- 0 26)) (_module.Statement.stmtVariable_q |stmt#0@0|)) (=> (_module.Statement.stmtVariable_q |stmt#0@0|) (=> (and (and (= |##id#0_0_0@0| (_module.Statement.id |stmt#0@0|)) ($IsAllocBox |##id#0_0_0@0| Tclass._module.Identifier $Heap@1)) (and ($IsAlloc DatatypeTypeType |$rhs#0_0@0| Tclass._module.Expression $Heap@1) ($IsAllocBox |env#0@@21| Tclass._module.Env $Heap@1))) (and (=> (= (ControlFlow 0 23) (- 0 25)) (=> (|_module.__default.Value#canCall| |$rhs#0_0@0|) (or (_module.__default.Value |$rhs#0_0@0|) (_module.Expression.exprLiteral_q |$rhs#0_0@0|)))) (=> (and (and (_module.__default.Value |$rhs#0_0@0|) (|_module.__default.SetEnv#canCall| (_module.Statement.id |stmt#0@0|) |$rhs#0_0@0| |env#0@@21|)) (and (|_module.__default.SetEnv#canCall| (_module.Statement.id |stmt#0@0|) |$rhs#0_0@0| |env#0@@21|) (= |env'#0_0_0@0| (_module.__default.SetEnv (_module.Statement.id |stmt#0@0|) |$rhs#0_0@0| |env#0@@21|)))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |stmts#0@@6|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |stmts#0@@6|))) (=> (and (and (= |##stmts#0_0_0@0| (|Seq#Drop| |stmts#0@@6| (LitInt 1))) ($IsAlloc SeqType |##stmts#0_0_0@0| (TSeq Tclass._module.Statement) $Heap@1)) (and (|_module.__default.Legal#canCall| (|Seq#Drop| |stmts#0@@6| (LitInt 1))) (|_module.__default.Legal#canCall| (|Seq#Drop| |stmts#0@@6| (LitInt 1))))) (and (=> (= (ControlFlow 0 23) 15) anon11_Then_correct) (=> (= (ControlFlow 0 23) 22) anon11_Else_correct))))))))))))))
(let ((anon10_Else_correct  (=> (and (not (_module.__default.Value |$rhs#0_0@0|)) (= (ControlFlow 0 14) 2)) GeneratedUnifiedExit_correct)))
(let ((anon9_Then_correct  (=> (_module.Statement.stmtVariable_q |stmt#0@0|) (and (=> (= (ControlFlow 0 28) (- 0 35)) true) (and (=> (= (ControlFlow 0 28) (- 0 34)) (_module.Statement.stmtVariable_q |stmt#0@0|)) (=> (_module.Statement.stmtVariable_q |stmt#0@0|) (=> (= |expr##0_0@0| (_module.Statement.expr |stmt#0@0|)) (and (=> (= (ControlFlow 0 28) (- 0 33)) (=> (|_module.__default.ConsistentCache#canCall| |stC#0@@37|) (or (_module.__default.ConsistentCache |stC#0@@37|) (forall ((|cmd#0@@21| T@U) (|deps#0@@20| T@U) (|e#0@@12| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#0@@21| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@20| Tclass._module.Expression)) ($Is SeqType |e#0@@12| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@37|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@21| |deps#0@@20| |e#0@@12|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@37|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0@@21| |deps#0@@20| |e#0@@12|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1200|
 :pattern ( (_module.__default.Loc |cmd#0@@21| |deps#0@@20| |e#0@@12|))
))))) (=> (=> (|_module.__default.ConsistentCache#canCall| |stC#0@@37|) (or (_module.__default.ConsistentCache |stC#0@@37|) (forall ((|cmd#0@@22| T@U) (|deps#0@@21| T@U) (|e#0@@13| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#0@@22| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@21| Tclass._module.Expression)) ($Is SeqType |e#0@@13| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@37|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@22| |deps#0@@21| |e#0@@13|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@37|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0@@22| |deps#0@@21| |e#0@@13|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1200|
 :pattern ( (_module.__default.Loc |cmd#0@@22| |deps#0@@21| |e#0@@13|))
)))) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and (|_module.__default.evalC#canCall| |expr##0_0@0| |stC#0@@37| |env#0@@21|) (let ((|result#0@@14| (_module.__default.evalC ($LS $LZ) |expr##0_0@0| |stC#0@@37| |env#0@@21|)))
 (and (and (_module.Tuple.Pair_q |result#0@@14|) (_module.Tuple.Pair_q |result#0@@14|)) (let ((|stC'#0@@14| ($Unbox DatatypeTypeType (_module.Tuple.snd |result#0@@14|))))
(let ((|expr'#0@@5| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#0@@14|))))
 (and (|_module.__default.ConsistentCache#canCall| |stC'#0@@14|) (=> (_module.__default.ConsistentCache |stC'#0@@14|) (=> (_module.Expression.exprError_q |expr'#0@@5|) (|$IsA#_module.Reason| (_module.Expression.r |expr'#0@@5|)))))))))) (let ((|result#0@@15| (_module.__default.evalC ($LS ($LS $LZ)) |expr##0_0@0| |stC#0@@37| |env#0@@21|)))
(let ((|stC'#0@@15| ($Unbox DatatypeTypeType (_module.Tuple.snd |result#0@@15|))))
 (and (|_module.__default.ConsistentCache#canCall| |stC'#0@@15|) (and (_module.__default.ConsistentCache |stC'#0@@15|) (forall ((|cmd#1@@3| T@U) (|deps#1@@3| T@U) (|e#1@@10| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#1@@3| Tclass._module.Expression) ($Is DatatypeTypeType |deps#1@@3| Tclass._module.Expression)) ($Is SeqType |e#1@@10| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC'#0@@15|)) (_module.__default.Hash (_module.__default.Loc |cmd#1@@3| |deps#1@@3| |e#1@@10|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC'#0@@15|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#1@@3| |deps#1@@3| |e#1@@10|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1203|
 :pattern ( (_module.__default.Loc |cmd#1@@3| |deps#1@@3| |e#1@@10|))
))))))) (and (let ((|result#0@@16| (_module.__default.evalC ($LS ($LS $LZ)) |expr##0_0@0| |stC#0@@37| |env#0@@21|)))
(let ((|expr'#0@@6| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#0@@16|))))
 (=> (_module.Expression.exprError_q |expr'#0@@6|) (not (|_module.Reason#Equal| (_module.Expression.r |expr'#0@@6|) |#_module.Reason.rInconsistentCache|))))) (= $Heap@0 $Heap@1))) (and (=> (= (ControlFlow 0 28) (- 0 32)) true) (and (=> (= (ControlFlow 0 28) (- 0 31)) (_module.Statement.stmtVariable_q |stmt#0@0|)) (=> (_module.Statement.stmtVariable_q |stmt#0@0|) (=> (and (and (and (= |##expr#0_0@0| (_module.Statement.expr |stmt#0@0|)) ($IsAlloc DatatypeTypeType |##expr#0_0@0| Tclass._module.Expression $Heap@1)) (and ($IsAlloc DatatypeTypeType |stC#0@@37| Tclass._module.StateC $Heap@1) ($IsAllocBox |env#0@@21| Tclass._module.Env $Heap@1))) (and (and (|_module.__default.evalC#canCall| (_module.Statement.expr |stmt#0@0|) |stC#0@@37| |env#0@@21|) (_module.Tuple.Pair_q (_module.__default.evalC ($LS $LZ) (_module.Statement.expr |stmt#0@0|) |stC#0@@37| |env#0@@21|))) (and (|_module.__default.evalC#canCall| (_module.Statement.expr |stmt#0@0|) |stC#0@@37| |env#0@@21|) (= |result#0_0@0| (_module.__default.evalC ($LS $LZ) (_module.Statement.expr |stmt#0@0|) |stC#0@@37| |env#0@@21|))))) (and (=> (= (ControlFlow 0 28) (- 0 30)) true) (=> (_module.Tuple.Pair_q |result#0_0@0|) (=> (and (_module.Tuple.Pair_q |result#0_0@0|) (= |$rhs#0_0@0| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#0_0@0|)))) (and (=> (= (ControlFlow 0 28) (- 0 29)) true) (=> (and (_module.Tuple.Pair_q |result#0_0@0|) (_module.Tuple.Pair_q |result#0_0@0|)) (=> (and (and (= |$rhs#0_1@0| ($Unbox DatatypeTypeType (_module.Tuple.snd |result#0_0@0|))) ($IsAlloc DatatypeTypeType |$rhs#0_0@0| Tclass._module.Expression $Heap@1)) (and (|_module.__default.Value#canCall| |$rhs#0_0@0|) (|_module.__default.Value#canCall| |$rhs#0_0@0|))) (and (=> (= (ControlFlow 0 28) 23) anon10_Then_correct) (=> (= (ControlFlow 0 28) 14) anon10_Else_correct)))))))))))))))))))))))
(let ((anon8_correct  (and (=> (= (ControlFlow 0 4) (- 0 8)) (or (_module.Statement.stmtVariable_q |stmt#0@0|) (_module.Statement.stmtReturn_q |stmt#0@0|))) (=> (or (_module.Statement.stmtVariable_q |stmt#0@0|) (_module.Statement.stmtReturn_q |stmt#0@0|)) (and (=> (= (ControlFlow 0 4) (- 0 7)) true) (and (=> (= (ControlFlow 0 4) (- 0 6)) (_module.Statement.stmtReturn_q |stmt#0@0|)) (=> (_module.Statement.stmtReturn_q |stmt#0@0|) (=> (= |expr##1_0@0| (_module.Statement.ret |stmt#0@0|)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (=> (|_module.__default.ConsistentCache#canCall| |stC#0@@37|) (or (_module.__default.ConsistentCache |stC#0@@37|) (forall ((|cmd#0@@23| T@U) (|deps#0@@22| T@U) (|e#0@@14| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#0@@23| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@22| Tclass._module.Expression)) ($Is SeqType |e#0@@14| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@37|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@23| |deps#0@@22| |e#0@@14|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@37|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0@@23| |deps#0@@22| |e#0@@14|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1200|
 :pattern ( (_module.__default.Loc |cmd#0@@23| |deps#0@@22| |e#0@@14|))
))))) (=> (=> (|_module.__default.ConsistentCache#canCall| |stC#0@@37|) (or (_module.__default.ConsistentCache |stC#0@@37|) (forall ((|cmd#0@@24| T@U) (|deps#0@@23| T@U) (|e#0@@15| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#0@@24| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@23| Tclass._module.Expression)) ($Is SeqType |e#0@@15| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@37|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@24| |deps#0@@23| |e#0@@15|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@37|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0@@24| |deps#0@@23| |e#0@@15|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1200|
 :pattern ( (_module.__default.Loc |cmd#0@@24| |deps#0@@23| |e#0@@15|))
)))) (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (and (|_module.__default.evalC#canCall| |expr##1_0@0| |stC#0@@37| |env#0@@21|) (let ((|result#0@@17| (_module.__default.evalC ($LS $LZ) |expr##1_0@0| |stC#0@@37| |env#0@@21|)))
 (and (and (_module.Tuple.Pair_q |result#0@@17|) (_module.Tuple.Pair_q |result#0@@17|)) (let ((|stC'#0@@16| ($Unbox DatatypeTypeType (_module.Tuple.snd |result#0@@17|))))
(let ((|expr'#0@@7| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#0@@17|))))
 (and (|_module.__default.ConsistentCache#canCall| |stC'#0@@16|) (=> (_module.__default.ConsistentCache |stC'#0@@16|) (=> (_module.Expression.exprError_q |expr'#0@@7|) (|$IsA#_module.Reason| (_module.Expression.r |expr'#0@@7|))))))))))) (and (and (let ((|result#0@@18| (_module.__default.evalC ($LS ($LS $LZ)) |expr##1_0@0| |stC#0@@37| |env#0@@21|)))
(let ((|stC'#0@@17| ($Unbox DatatypeTypeType (_module.Tuple.snd |result#0@@18|))))
 (and (|_module.__default.ConsistentCache#canCall| |stC'#0@@17|) (and (_module.__default.ConsistentCache |stC'#0@@17|) (forall ((|cmd#1@@4| T@U) (|deps#1@@4| T@U) (|e#1@@11| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#1@@4| Tclass._module.Expression) ($Is DatatypeTypeType |deps#1@@4| Tclass._module.Expression)) ($Is SeqType |e#1@@11| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC'#0@@17|)) (_module.__default.Hash (_module.__default.Loc |cmd#1@@4| |deps#1@@4| |e#1@@11|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC'#0@@17|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#1@@4| |deps#1@@4| |e#1@@11|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1203|
 :pattern ( (_module.__default.Loc |cmd#1@@4| |deps#1@@4| |e#1@@11|))
)))))) (let ((|result#0@@19| (_module.__default.evalC ($LS ($LS $LZ)) |expr##1_0@0| |stC#0@@37| |env#0@@21|)))
(let ((|expr'#0@@8| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#0@@19|))))
 (=> (_module.Expression.exprError_q |expr'#0@@8|) (not (|_module.Reason#Equal| (_module.Expression.r |expr'#0@@8|) |#_module.Reason.rInconsistentCache|)))))) (and (= $Heap@0 $Heap@2) (= (ControlFlow 0 4) 2)))) GeneratedUnifiedExit_correct)))))))))))
(let ((anon12_Else_correct  (=> (and (_module.Statement.stmtVariable_q |stmt#0@0|) (= (ControlFlow 0 11) 4)) anon8_correct)))
(let ((anon12_Then_correct  (=> (not (_module.Statement.stmtVariable_q |stmt#0@0|)) (and (=> (= (ControlFlow 0 9) (- 0 10)) true) (=> (= (ControlFlow 0 9) 4) anon8_correct)))))
(let ((anon9_Else_correct  (=> (not (_module.Statement.stmtVariable_q |stmt#0@0|)) (and (=> (= (ControlFlow 0 12) (- 0 13)) true) (and (=> (= (ControlFlow 0 12) 9) anon12_Then_correct) (=> (= (ControlFlow 0 12) 11) anon12_Else_correct))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@3 alloc false)) (|$IsA#_module.StateC| |stC#0@@37|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@3 $Heap@0) (forall ((|$ih#stmts0#0| T@U) (|$ih#stC0#0| T@U) ) (!  (=> (and (and (and ($Is SeqType |$ih#stmts0#0| (TSeq Tclass._module.Statement)) ($Is DatatypeTypeType |$ih#stC0#0| Tclass._module.StateC)) (and (_module.__default.Legal |$ih#stmts0#0|) (_module.__default.ConsistentCache |$ih#stC0#0|))) (or (< (|Seq#Rank| |$ih#stmts0#0|) (|Seq#Rank| |stmts#0@@6|)) (and (= (|Seq#Rank| |$ih#stmts0#0|) (|Seq#Rank| |stmts#0@@6|)) (< (DtRank |$ih#stC0#0|) (DtRank |stC#0@@37|))))) (let ((|result#1@@7| (_module.__default.doC ($LS $LZ) |$ih#stmts0#0| |$ih#stC0#0| |env#0@@21|)))
(let ((|stC'#1@@8| ($Unbox DatatypeTypeType (_module.Tuple.snd |result#1@@7|))))
(let ((|expr'#1@@2| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#1@@7|))))
 (and (_module.__default.ConsistentCache |stC'#1@@8|) (=> (_module.Expression.exprError_q |expr'#1@@2|) (not (|_module.Reason#Equal| (_module.Expression.r |expr'#1@@2|) |#_module.Reason.rInconsistentCache|))))))))
 :qid |CloudMakeConsistentBuildslegacydfy.536:16|
 :skolemid |1196|
 :pattern ( (_module.__default.doC ($LS $LZ) |$ih#stmts0#0| |$ih#stC0#0| |env#0@@21|))
)))) (and (=> (= (ControlFlow 0 36) (- 0 38)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |stmts#0@@6|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |stmts#0@@6|))) (=> (= |stmt#0@0| ($Unbox DatatypeTypeType (|Seq#Index| |stmts#0@@6| (LitInt 0)))) (and (=> (= (ControlFlow 0 36) (- 0 37)) true) (and (=> (= (ControlFlow 0 36) 28) anon9_Then_correct) (=> (= (ControlFlow 0 36) 12) anon9_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (and ($Is SeqType |stmts#0@@6| (TSeq Tclass._module.Statement)) ($IsAlloc SeqType |stmts#0@@6| (TSeq Tclass._module.Statement) $Heap@@3))) (=> (and (and (and (and (and (and ($Is DatatypeTypeType |stC#0@@37| Tclass._module.StateC) ($IsAlloc DatatypeTypeType |stC#0@@37| Tclass._module.StateC $Heap@@3)) (|$IsA#_module.StateC| |stC#0@@37|)) (and ($IsBox |env#0@@21| Tclass._module.Env) ($IsAllocBox |env#0@@21| Tclass._module.Env $Heap@@3))) (and (and (=> |defass#stmt#0| (and ($Is DatatypeTypeType |stmt#0@@1| Tclass._module.Statement) ($IsAlloc DatatypeTypeType |stmt#0@@1| Tclass._module.Statement $Heap@@3))) true) (and (=> |defass#result#0_0| (and ($Is DatatypeTypeType |result#0_0| (Tclass._module.Tuple Tclass._module.Expression Tclass._module.StateC)) ($IsAlloc DatatypeTypeType |result#0_0| (Tclass._module.Tuple Tclass._module.Expression Tclass._module.StateC) $Heap@@3))) true))) (and (and (and ($Is DatatypeTypeType |expr'#0_0| Tclass._module.Expression) ($IsAlloc DatatypeTypeType |expr'#0_0| Tclass._module.Expression $Heap@@3)) true) (and (=> |defass#stC'#0_0| (and ($Is DatatypeTypeType |stC'#0_0| Tclass._module.StateC) ($IsAlloc DatatypeTypeType |stC'#0_0| Tclass._module.StateC $Heap@@3))) true))) (and (and (and (and (=> |defass#env'#0_0_0| (and ($IsBox |env'#0_0_0| Tclass._module.Env) ($IsAllocBox |env'#0_0_0| Tclass._module.Env $Heap@@3))) true) (= 8 $FunctionContextHeight)) (and (|_module.__default.Legal#canCall| |stmts#0@@6|) (and (_module.__default.Legal |stmts#0@@6|) (or (not (= (|Seq#Length| |stmts#0@@6|) 0)) (not true))))) (and (and (|_module.__default.ConsistentCache#canCall| |stC#0@@37|) (and (_module.__default.ConsistentCache |stC#0@@37|) (forall ((|cmd#2@@0| T@U) (|deps#2@@0| T@U) (|e#2@@7| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#2@@0| Tclass._module.Expression) ($Is DatatypeTypeType |deps#2@@0| Tclass._module.Expression)) ($Is SeqType |e#2@@7| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@37|)) (_module.__default.Hash (_module.__default.Loc |cmd#2@@0| |deps#2@@0| |e#2@@7|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@37|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#2@@0| |deps#2@@0| |e#2@@7|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1193|
 :pattern ( (_module.__default.Loc |cmd#2@@0| |deps#2@@0| |e#2@@7|))
)))) (= (ControlFlow 0 39) 36)))) anon0_correct))))
