...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.evalArgsC)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon9_Else_correct  (=> (and (and (and ($IsAlloc DatatypeTypeType |expr#0@@16| Tclass._module.Expression $Heap@@3) ($IsAlloc SeqType |args#0@@11| (TSeq Tclass._module.Expression) $Heap@@3)) (and ($IsAlloc DatatypeTypeType |stC#0@@32| Tclass._module.StateC $Heap@@3) ($IsAllocBox |env#0@@15| Tclass._module.Env $Heap@@3))) (and (and (= |##args'#0@0| (Lit SeqType |Seq#Empty|)) ($IsAlloc SeqType |##args'#0@0| (TSeq Tclass._module.Expression) $Heap@@3)) (and (= |##stsC'#0@0| (Lit SetType |Set#Empty|)) ($IsAlloc SetType |##stsC'#0@0| (TSet Tclass._module.StateC) $Heap@@3)))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((|arg#5@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#5@@0| Tclass._module.Expression) (=> (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#5@@0|)) (< (DtRank |arg#5@@0|) (DtRank |expr#0@@16|))))
 :qid |CloudMakeConsistentBuildslegacydfy.485:19|
 :skolemid |1149|
 :pattern ( (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#5@@0|)))
))) (=> (forall ((|arg#5@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#5@@1| Tclass._module.Expression) (=> (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#5@@1|)) (< (DtRank |arg#5@@1|) (DtRank |expr#0@@16|))))
 :qid |CloudMakeConsistentBuildslegacydfy.485:19|
 :skolemid |1150|
 :pattern ( (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#5@@1|)))
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (or (<= 0 (+ (|Seq#Length| |args#0@@11|) 1)) (< (DtRank |expr#0@@16|) (DtRank |expr#0@@16|))) (= (|Seq#Length| |args#0@@11|) (+ (|Seq#Length| |args#0@@11|) 1)))) (=> (or (or (<= 0 (+ (|Seq#Length| |args#0@@11|) 1)) (< (DtRank |expr#0@@16|) (DtRank |expr#0@@16|))) (= (|Seq#Length| |args#0@@11|) (+ (|Seq#Length| |args#0@@11|) 1))) (=> (= (ControlFlow 0 3) (- 0 2)) (or (< (DtRank |expr#0@@16|) (DtRank |expr#0@@16|)) (and (= (DtRank |expr#0@@16|) (DtRank |expr#0@@16|)) (< (|Seq#Length| |args#0@@11|) (+ (|Seq#Length| |args#0@@11|) 1))))))))))))
...
)) (and (=> (= (ControlFlow 0 6) 1) anon9_Then_correct) (=> (= (ControlFlow 0 6) 3) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (=> (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#4@0|)) (< (DtRank |arg#4@0|) (DtRank |expr#0@@16|))) (= (ControlFlow 0 8) 6)) anon4_correct)))
(let ((anon8_Then_correct  (=> (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#4@0|)) (=> (and (< (DtRank |arg#4@0|) (DtRank |expr#0@@16|)) (= (ControlFlow 0 7) 6)) anon4_correct))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@3 alloc false)) (=> (and ($Is DatatypeTypeType |arg#4@0| Tclass._module.Expression) ($IsAlloc DatatypeTypeType |arg#4@0| Tclass._module.Expression $Heap@@3)) (and (=> (= (ControlFlow 0 9) 7) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (and ($Is DatatypeTypeType |expr#0@@16| Tclass._module.Expression) ($Is SeqType |args#0@@11| (TSeq Tclass._module.Expression)))) (and (and ($Is DatatypeTypeType |stC#0@@32| Tclass._module.StateC) ($IsBox |env#0@@15| Tclass._module.Env)) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 10) 9)))) anon0_correct)))
