...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.EmptyCache)
...
(let ((anon4_Then_correct  (=> (and ($IsBox _module.__default.EmptyCache Tclass._module.Cache) (= (ControlFlow 0 2) (- 0 1))) (U_2_bool (Lit boolType (bool_2_U true))))))
