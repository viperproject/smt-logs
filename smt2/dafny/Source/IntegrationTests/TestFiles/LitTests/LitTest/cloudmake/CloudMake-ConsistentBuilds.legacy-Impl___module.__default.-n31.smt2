...
(set-info :boogie-vc-id Impl$$_module.__default.CachedBuildsTheorem)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@3 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.__default.Legal#canCall| (_module.Program.stmts |prog#0@@2|)) (or (_module.__default.Legal (_module.Program.stmts |prog#0@@2|)) (or (not (= (|Seq#Length| (_module.Program.stmts |prog#0@@2|)) 0)) (not true))))) (=> (=> (|_module.__default.Legal#canCall| (_module.Program.stmts |prog#0@@2|)) (or (_module.__default.Legal (_module.Program.stmts |prog#0@@2|)) (or (not (= (|Seq#Length| (_module.Program.stmts |prog#0@@2|)) 0)) (not true)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.__default.ConsistentCache#canCall| |stC#0@@40|) (or (_module.__default.ConsistentCache |stC#0@@40|) (forall ((|cmd#0@@19| T@U) (|deps#0@@18| T@U) (|e#0@@10| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#0@@19| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@18| Tclass._module.Expression)) ($Is SeqType |e#0@@10| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@40|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@19| |deps#0@@18| |e#0@@10|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@40|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0@@19| |deps#0@@18| |e#0@@10|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1179|
...
)))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (|_module.__default.buildC#canCall| |prog#0@@2| |stC#0@@40|) (let ((|result#0@@8| (_module.__default.buildC |prog#0@@2| |stC#0@@40|)))
...
(let ((|expr'#0@@2| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#0@@8|))))
 (and (|_module.__default.ConsistentCache#canCall| |stC'#0@@10|) (=> (_module.__default.ConsistentCache |stC'#0@@10|) (=> (_module.Expression.exprError_q |expr'#0@@2|) (|$IsA#_module.Reason| (_module.Expression.r |expr'#0@@2|))))))))))) (and (and (let ((|result#0@@9| (_module.__default.buildC |prog#0@@2| |stC#0@@40|)))
...
)))))) (let ((|result#0@@10| (_module.__default.buildC |prog#0@@2| |stC#0@@40|)))
(let ((|expr'#0@@3| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#0@@10|))))
 (=> (_module.Expression.exprError_q |expr'#0@@3|) (not (|_module.Reason#Equal| (_module.Expression.r |expr'#0@@3|) |#_module.Reason.rInconsistentCache|)))))) (and (= $Heap@@3 $Heap@0) (= (ControlFlow 0 2) (- 0 1))))) (let ((|result#0@@11| (_module.__default.buildC |prog#0@@2| |stC#0@@40|)))
(let ((|stC'#0@@12| ($Unbox DatatypeTypeType (_module.Tuple.snd |result#0@@11|))))
(let ((|expr'#0@@4| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#0@@11|))))
 (=> (and (_module.__default.ConsistentCache |stC'#0@@12|) (_module.Expression.exprError_q |expr'#0@@4|)) (not (|_module.Reason#Equal| (_module.Expression.r |expr'#0@@4|) |#_module.Reason.rInconsistentCache|))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and ($Is DatatypeTypeType |prog#0@@2| Tclass._module.Program) ($IsAlloc DatatypeTypeType |prog#0@@2| Tclass._module.Program $Heap@@3)) (|$IsA#_module.Program| |prog#0@@2|)) (=> (and (and (and (and (and ($Is DatatypeTypeType |stC#0@@40| Tclass._module.StateC) ($IsAlloc DatatypeTypeType |stC#0@@40| Tclass._module.StateC $Heap@@3)) (|$IsA#_module.StateC| |stC#0@@40|)) (= 10 $FunctionContextHeight)) (and (|_module.__default.Legal#canCall| (_module.Program.stmts |prog#0@@2|)) (and (_module.__default.Legal (_module.Program.stmts |prog#0@@2|)) (or (not (= (|Seq#Length| (_module.Program.stmts |prog#0@@2|)) 0)) (not true))))) (and (and (|_module.__default.ConsistentCache#canCall| |stC#0@@40|) (and (_module.__default.ConsistentCache |stC#0@@40|) (forall ((|cmd#1@@3| T@U) (|deps#1@@3| T@U) (|e#1@@10| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#1@@3| Tclass._module.Expression) ($Is DatatypeTypeType |deps#1@@3| Tclass._module.Expression)) ($Is SeqType |e#1@@10| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@40|)) (_module.__default.Hash (_module.__default.Loc |cmd#1@@3| |deps#1@@3| |e#1@@10|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@40|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#1@@3| |deps#1@@3| |e#1@@10|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1177|
