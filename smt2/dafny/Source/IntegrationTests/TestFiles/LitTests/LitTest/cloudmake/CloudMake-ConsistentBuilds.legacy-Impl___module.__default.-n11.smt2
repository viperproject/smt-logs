...
(set-info :boogie-vc-id Impl$$_module.__default.CombineCLemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@1 $Heap@0)) (and (forall ((|$ih#stsC0#0| T@U) ) (!  (=> (and (and ($Is SetType |$ih#stsC0#0| (TSet Tclass._module.StateC)) (and (not (|Set#Equal| |$ih#stsC0#0| |Set#Empty|)) (forall ((|stC#2@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |stC#2@@0| Tclass._module.StateC) (=> (|Set#IsMember| |$ih#stsC0#0| ($Box DatatypeTypeType |stC#2@@0|)) (_module.__default.ConsistentCache |stC#2@@0|)))
 :qid |CloudMakeConsistentBuildslegacydfy.142:19|
 :skolemid |869|
 :pattern ( (_module.__default.ConsistentCache |stC#2@@0|))
 :pattern ( (|Set#IsMember| |$ih#stsC0#0| ($Box DatatypeTypeType |stC#2@@0|)))
)))) (and (|Set#Subset| |$ih#stsC0#0| |stsC#0@@3|) (not (|Set#Subset| |stsC#0@@3| |$ih#stsC0#0|)))) (let ((|stC'#1| (_module.__default.CombineC ($LS $LZ) |$ih#stsC0#0|)))
(_module.__default.ConsistentCache |stC'#1|)))
 :qid |CloudMakeConsistentBuildslegacydfy.140:21|
 :skolemid |870|
 :pattern ( (_module.__default.CombineC ($LS $LZ) |$ih#stsC0#0|))
)) (= (ControlFlow 0 2) (- 0 1)))) (let ((|stC'#0@@0| (_module.__default.CombineC ($LS ($LS $LZ)) |stsC#0@@3|)))
 (=> (|_module.__default.ConsistentCache#canCall| |stC'#0@@0|) (or (_module.__default.ConsistentCache |stC'#0@@0|) (forall ((|cmd#1@@1| T@U) (|deps#1@@1| T@U) (|e#1@@1| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#1@@1| Tclass._module.Expression) ($Is DatatypeTypeType |deps#1@@1| Tclass._module.Expression)) ($Is SeqType |e#1@@1| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC'#0@@0|)) (_module.__default.Hash (_module.__default.Loc |cmd#1@@1| |deps#1@@1| |e#1@@1|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC'#0@@0|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#1@@1| |deps#1@@1| |e#1@@1|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |867|
 :pattern ( (_module.__default.Loc |cmd#1@@1| |deps#1@@1| |e#1@@1|))
)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and ($Is SetType |stsC#0@@3| (TSet Tclass._module.StateC)) ($IsAlloc SetType |stsC#0@@3| (TSet Tclass._module.StateC) $Heap@@1))) (and (and (= 5 $FunctionContextHeight) (not (|Set#Equal| |stsC#0@@3| |Set#Empty|))) (and (forall ((|stC#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |stC#1@@0| Tclass._module.StateC) (=> (|Set#IsMember| |stsC#0@@3| ($Box DatatypeTypeType |stC#1@@0|)) (_module.__default.ConsistentCache |stC#1@@0|)))
 :qid |CloudMakeConsistentBuildslegacydfy.142:19|
 :skolemid |866|
