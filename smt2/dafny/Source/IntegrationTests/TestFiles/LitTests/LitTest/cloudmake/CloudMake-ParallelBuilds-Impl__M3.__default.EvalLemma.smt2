...
(assert (forall ((a@@18 T@U) (b@@15 T@U) (t0@@0 T@U) (t1@@0 T@U) ) (!  (=> (forall ((bx@@0 T@U) )  (=> (|Set#IsMember| a@@18 bx@@0) (and ($IsBox bx@@0 t0@@0) ($IsBox (MapType0Select BoxType BoxType b@@15 bx@@0) t1@@0)))) ($Is MapType (|Map#Glue| a@@18 b@@15 (TMap t0@@0 t1@@0)) (TMap t0@@0 t1@@0)))
