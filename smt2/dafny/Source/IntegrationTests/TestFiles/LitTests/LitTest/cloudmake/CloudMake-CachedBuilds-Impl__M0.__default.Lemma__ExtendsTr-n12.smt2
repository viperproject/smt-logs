...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|st'#0@@0| T@U) ) (!  (=> (or (|M0.__default.Extends#canCall| (Lit BoxType |st#0@@3|) (Lit BoxType |st'#0@@0|)) (and (< 2 $FunctionContextHeight) (and ($IsBox |st#0@@3| Tclass.M0.State) ($IsBox |st'#0@@0| Tclass.M0.State)))) (and (and (and (|M0.__default.DomSt#canCall| (Lit BoxType |st#0@@3|)) (|M0.__default.DomSt#canCall| (Lit BoxType |st'#0@@0|))) (=> (|Set#Subset| (M0.__default.DomSt (Lit BoxType |st#0@@3|)) (M0.__default.DomSt (Lit BoxType |st'#0@@0|))) (and (forall ((|p#2| T@U) ) (!  (=> ($IsBox |p#2| Tclass.M0.Path) (and (|M0.__default.DomSt#canCall| (Lit BoxType |st#0@@3|)) (=> (|Set#IsMember| (M0.__default.DomSt (Lit BoxType |st#0@@3|)) |p#2|) (and (|M0.__default.GetSt#canCall| |p#2| (Lit BoxType |st'#0@@0|)) (|M0.__default.GetSt#canCall| |p#2| (Lit BoxType |st#0@@3|))))))
...
)))))) (= (M0.__default.Extends true (Lit BoxType |st#0@@3|) (Lit BoxType |st'#0@@0|))  (and (and (|Set#Subset| (M0.__default.DomSt (Lit BoxType |st#0@@3|)) (M0.__default.DomSt (Lit BoxType |st'#0@@0|))) (forall ((|p#2@@1| T@U) ) (!  (=> ($IsBox |p#2@@1| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt (Lit BoxType |st#0@@3|)) |p#2@@1|) (= (M0.__default.GetSt |p#2@@1| (Lit BoxType |st'#0@@0|)) (M0.__default.GetSt |p#2@@1| (Lit BoxType |st#0@@3|)))))
 :qid |CloudMakeCachedBuildsdfy.197:13|
 :skolemid |995|
 ...
 :weight 3
 :skolemid |1000|
 :pattern ( (M0.__default.Extends true (Lit BoxType |st#0@@3|) (Lit BoxType |st'#0@@0|)))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (M0.__default.Extends reveal_M0._default.Extends |st0#0| |st2#0|))))
(let ((anon3_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (= $Heap@0 $Heap@2)) (and (forall ((|p#0_1| T@U) ) (!  (=> (and ($IsBox |p#0_1| Tclass.M0.Path) (U_2_bool (Lit boolType (bool_2_U true)))) (= (M0.__default.Oracle |p#0_1| |st0#0|) (M0.__default.Oracle |p#0_1| |st1#0|)))
 :qid |CloudMakeCachedBuildsdfy.206:12|
 :skolemid |1020|
...
(let ((anon3_Then_correct  (=> (and ($IsBox |p#0_0@0| Tclass.M0.Path) (= (ControlFlow 0 2) (- 0 1))) (M0.__default.Extends reveal_M0._default.Extends |st0#0| |st1#0|))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@1 $Heap@0) reveal_M0._default.Extends)) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and ($IsBox |st0#0| Tclass.M0.State) ($IsAllocBox |st0#0| Tclass.M0.State $Heap@@1))) (=> (and (and (and ($IsBox |st1#0| Tclass.M0.State) ($IsAllocBox |st1#0| Tclass.M0.State $Heap@@1)) (and ($IsBox |st2#0| Tclass.M0.State) ($IsAllocBox |st2#0| Tclass.M0.State $Heap@@1))) (and (and (= 4 $FunctionContextHeight) (M0.__default.Extends reveal_M0._default.Extends |st0#0| |st1#0|)) (and (M0.__default.Extends reveal_M0._default.Extends |st1#0| |st2#0|) (= (ControlFlow 0 7) 6)))) anon0_correct))))
