...
(assert (distinct TChar TInt TagChar TagInt TagSet TagSeq TagMap alloc |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass.M3.State Tagclass.M3.Path Tagclass.M3.Artifact Tagclass.M3.Env Tagclass.M3.Identifier Tagclass.M3.Expression Tagclass.M3.Literal Tagclass.M3.WFCertificate Tagclass.M3.Tuple Tagclass.M3.Primitive Tagclass.M3.Statement |##M3.Artifact.ArtifactCons| |##M3.Path.InternalPath| |##M3.Path.ExternalPath| |##M3.Env.EnvCons| |##M3.WFCertificate.Cert| |##M3.State.StateCons| |##M3.Statement.stmtVariable| |##M3.Statement.stmtReturn| |##M3.Expression.exprLiteral| |##M3.Expression.exprIdentifier| |##M3.Expression.exprIf| |##M3.Expression.exprAnd| |##M3.Expression.exprOr| |##M3.Expression.exprInvocation| |##M3.Expression.exprError| Tagclass.M3.Reason |##M3.Literal.litTrue| |##M3.Literal.litFalse| |##M3.Literal.litUndefined| |##M3.Literal.litNull| |##M3.Literal.litNumber| |##M3.Literal.litString| |##M3.Literal.litPrimitive| |##M3.Literal.litArrOfPaths| |##M3.Literal.litArrOfStrings| |##M3.Literal.litArray| |##M3.Primitive.primCreatePath| |##M3.Primitive.primExec| |##M3.Reason.rCompatibility| |##M3.Reason.rValidity| |##M3.Tuple.Pair| |tytagFamily$_tuple#2| tytagFamily$State tytagFamily$Path tytagFamily$Artifact tytagFamily$Env tytagFamily$Identifier tytagFamily$Expression tytagFamily$Literal tytagFamily$WFCertificate tytagFamily$Tuple tytagFamily$Primitive tytagFamily$Statement tytagFamily$Reason)
)
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@10| T@U) ) (!  (=> (or (|M3.__default.DomSt#canCall| |st#0@@10|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |st#0@@10| Tclass.M3.State))) (and (forall ((|p#0@@9| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@9| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@10|) ($Box DatatypeTypeType |p#0@@9|)) (|Set#IsMember| (|Map#Domain| (M3.State.m |st#0@@10|)) ($Box DatatypeTypeType |p#0@@9|))))
 :qid |CloudMakeParallelBuildsdfy.441:20|
 :skolemid |6475|
 :pattern ( (|Set#IsMember| (|Map#Domain| (M3.State.m |st#0@@10|)) ($Box DatatypeTypeType |p#0@@9|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@10|) ($Box DatatypeTypeType |p#0@@9|)))
)) ($Is SetType (M3.__default.DomSt |st#0@@10|) (TSet Tclass.M3.Path))))
 :qid |CloudMakeParallelBuildsdfy.9:24|
 :skolemid |6476|
 :pattern ( (M3.__default.DomSt |st#0@@10|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|p#0@@10| T@U) (|a#0| T@U) (|st#0@@11| T@U) ) (!  (=> (or (|M3.__default.SetSt#canCall| |p#0@@10| |a#0| (Lit DatatypeTypeType |st#0@@11|)) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |p#0@@10| Tclass.M3.Path) ($Is DatatypeTypeType |a#0| Tclass.M3.Artifact)) ($Is DatatypeTypeType |st#0@@11| Tclass.M3.State)))) (and (M3.State.StateCons_q (Lit DatatypeTypeType |st#0@@11|)) (= (M3.__default.SetSt |p#0@@10| |a#0| (Lit DatatypeTypeType |st#0@@11|)) (|#M3.State.StateCons| (|Map#Build| (Lit MapType (M3.State.m (Lit DatatypeTypeType |st#0@@11|))) ($Box DatatypeTypeType |p#0@@10|) ($Box DatatypeTypeType |a#0|))))))
 :qid |CloudMakeParallelBuildsdfy.468:24|
 :weight 3
 :skolemid |5730|
 :pattern ( (M3.__default.SetSt |p#0@@10| |a#0| (Lit DatatypeTypeType |st#0@@11|)))
))))
...
(assert  (=> (<= 7 $FunctionContextHeight) (forall ((|prim#0@@2| T@U) (|args#0@@2| T@U) (|st#0@@12| T@U) ) (!  (=> (or (|M3.__default.ValidArgs#canCall| (Lit DatatypeTypeType |prim#0@@2|) (Lit SeqType |args#0@@2|) (Lit DatatypeTypeType |st#0@@12|)) (and (< 7 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |prim#0@@2| Tclass.M3.Primitive) ($Is SeqType |args#0@@2| (TSeq Tclass.M3.Expression))) ($Is DatatypeTypeType |st#0@@12| Tclass.M3.State)) (and (=> (M3.Primitive.primExec_q (Lit DatatypeTypeType |prim#0@@2|)) (= (|Seq#Length| (Lit SeqType |args#0@@2|)) (LitInt 3))) (=> (M3.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@2|)) (= (|Seq#Length| (Lit SeqType |args#0@@2|)) (LitInt 1))))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (M3.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@2|)))))) (let ((|exps#5| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@2|) (LitInt 2)))))
...
(let ((|cmd#5| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@2|) (LitInt 0)))))
 (=> (M3.Expression.exprLiteral_q |cmd#5|) (=> (M3.Literal.litString_q (M3.Expression.lit |cmd#5|)) (=> (M3.Expression.exprLiteral_q |deps#5|) (=> (M3.Literal.litArrOfPaths_q (M3.Expression.lit |deps#5|)) (=> (M3.Expression.exprLiteral_q |exps#5|) (=> (M3.Literal.litArrOfStrings_q (M3.Expression.lit |exps#5|)) (and (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@12|)) (=> (|Set#Subset| (M3.Literal.paths (M3.Expression.lit |deps#5|)) (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@12|))) (|M3.__default.Pre#canCall| (M3.Literal.str (M3.Expression.lit |cmd#5|)) (M3.Literal.paths (M3.Expression.lit |deps#5|)) (M3.Literal.strs (M3.Expression.lit |exps#5|)) (Lit DatatypeTypeType |st#0@@12|)))))))))))))) (= (M3.__default.ValidArgs (Lit DatatypeTypeType |prim#0@@2|) (Lit SeqType |args#0@@2|) (Lit DatatypeTypeType |st#0@@12|)) (ite (M3.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@2|)) false (let ((|exps#4| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@2|) (LitInt 2)))))
...
(let ((|cmd#4| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@2|) (LitInt 0)))))
 (and (and (and (and (and (and (and (M3.Expression.exprLiteral_q |cmd#4|) (M3.Literal.litString_q (M3.Expression.lit |cmd#4|))) (M3.Expression.exprLiteral_q |deps#4|)) (M3.Literal.litArrOfPaths_q (M3.Expression.lit |deps#4|))) (M3.Expression.exprLiteral_q |exps#4|)) (M3.Literal.litArrOfStrings_q (M3.Expression.lit |exps#4|))) (|Set#Subset| (M3.Literal.paths (M3.Expression.lit |deps#4|)) (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@12|)))) (M3.__default.Pre (M3.Literal.str (M3.Expression.lit |cmd#4|)) (M3.Literal.paths (M3.Expression.lit |deps#4|)) (M3.Literal.strs (M3.Expression.lit |exps#4|)) (Lit DatatypeTypeType |st#0@@12|))))))))))
 :qid |CloudMakeParallelBuildsdfy.289:29|
 :weight 3
 :skolemid |6749|
 :pattern ( (M3.__default.ValidArgs (Lit DatatypeTypeType |prim#0@@2|) (Lit SeqType |args#0@@2|) (Lit DatatypeTypeType |st#0@@12|)))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall ((|cmd#0@@7| T@U) (|deps#0@@8| T@U) (|exps#0@@3| T@U) (|st#0@@13| T@U) ) (!  (=> (or (|M3.__default.Pre#canCall| (Lit SeqType |cmd#0@@7|) (Lit SetType |deps#0@@8|) (Lit SetType |exps#0@@3|) |st#0@@13|) (and (< 6 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@7| (TSeq TChar)) ($Is SetType |deps#0@@8| (TSet Tclass.M3.Path))) ($Is SetType |exps#0@@3| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@13| Tclass.M3.State)))) (and (forall ((|e#1| T@U) ) (!  (=> ($Is SeqType |e#1| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@3|) ($Box SeqType |e#1|)) (and (and (|M3.__default.Loc#canCall| (Lit SeqType |cmd#0@@7|) (Lit SetType |deps#0@@8|) |e#1|) (|M3.__default.DomSt#canCall| |st#0@@13|)) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@13|) ($Box DatatypeTypeType (M3.__default.Loc (Lit SeqType |cmd#0@@7|) (Lit SetType |deps#0@@8|) |e#1|))) (and (and (|$IsA#M3.Artifact| (M3.__default.GetSt (M3.__default.Loc (Lit SeqType |cmd#0@@7|) (Lit SetType |deps#0@@8|) |e#1|) |st#0@@13|)) (|$IsA#M3.Artifact| (M3.__default.Oracle (M3.__default.Loc (Lit SeqType |cmd#0@@7|) (Lit SetType |deps#0@@8|) |e#1|) |st#0@@13|))) (and (and (|M3.__default.Loc#canCall| (Lit SeqType |cmd#0@@7|) (Lit SetType |deps#0@@8|) |e#1|) (|M3.__default.GetSt#canCall| (M3.__default.Loc (Lit SeqType |cmd#0@@7|) (Lit SetType |deps#0@@8|) |e#1|) |st#0@@13|)) (and (|M3.__default.Loc#canCall| (Lit SeqType |cmd#0@@7|) (Lit SetType |deps#0@@8|) |e#1|) (|M3.__default.Oracle#canCall| (M3.__default.Loc (Lit SeqType |cmd#0@@7|) (Lit SetType |deps#0@@8|) |e#1|) |st#0@@13|))))))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |6563|
 :pattern ( (M3.__default.Loc |cmd#0@@7| |deps#0@@8| |e#1|))
 :pattern ( (|Set#IsMember| |exps#0@@3| ($Box SeqType |e#1|)))
)) (= (M3.__default.Pre (Lit SeqType |cmd#0@@7|) (Lit SetType |deps#0@@8|) (Lit SetType |exps#0@@3|) |st#0@@13|) (forall ((|e#1@@0| T@U) ) (!  (=> ($Is SeqType |e#1@@0| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@3|) ($Box SeqType |e#1@@0|)) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@13|) ($Box DatatypeTypeType (M3.__default.Loc (Lit SeqType |cmd#0@@7|) (Lit SetType |deps#0@@8|) |e#1@@0|))) (|M3.Artifact#Equal| (M3.__default.GetSt (M3.__default.Loc (Lit SeqType |cmd#0@@7|) (Lit SetType |deps#0@@8|) |e#1@@0|) |st#0@@13|) (M3.__default.Oracle (M3.__default.Loc (Lit SeqType |cmd#0@@7|) (Lit SetType |deps#0@@8|) |e#1@@0|) |st#0@@13|)))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |6562|
 ...
 :weight 3
 :skolemid |6564|
 :pattern ( (M3.__default.Pre (Lit SeqType |cmd#0@@7|) (Lit SetType |deps#0@@8|) (Lit SetType |exps#0@@3|) |st#0@@13|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|p#0@@13| T@U) (|st#0@@14| T@U) ) (!  (=> (or (|M3.__default.GetSt#canCall| |p#0@@13| |st#0@@14|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |p#0@@13| Tclass.M3.Path) ($Is DatatypeTypeType |st#0@@14| Tclass.M3.State)) (|Set#IsMember| (M3.__default.DomSt |st#0@@14|) ($Box DatatypeTypeType |p#0@@13|))))) ($Is DatatypeTypeType (M3.__default.GetSt |p#0@@13| |st#0@@14|) Tclass.M3.Artifact))
 :qid |CloudMakeParallelBuildsdfy.10:24|
 :skolemid |6469|
 :pattern ( (M3.__default.GetSt |p#0@@13| |st#0@@14|))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@8 T@U) (|p#0@@14| T@U) (|cert#0@@4| T@U) (|st#0@@15| T@U) ) (!  (=> (or (|M3.__default.OracleWF#canCall| |p#0@@14| |cert#0@@4| |st#0@@15|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |p#0@@14| Tclass.M3.Path) ($Is DatatypeTypeType |cert#0@@4| Tclass.M3.WFCertificate)) ($Is DatatypeTypeType |st#0@@15| Tclass.M3.State)) (M3.__default.CheckWellFounded ($LS $LZ) |p#0@@14| |cert#0@@4|)))) ($Is DatatypeTypeType (M3.__default.OracleWF $ly@@8 |p#0@@14| |cert#0@@4| |st#0@@15|) Tclass.M3.Artifact))
 :qid |CloudMakeParallelBuildsdfy.653:18|
 :skolemid |6060|
 :pattern ( (M3.__default.OracleWF $ly@@8 |p#0@@14| |cert#0@@4| |st#0@@15|))
))))
...
(assert (forall ((d@@11 T@U) ) (! (= (_System.Tuple2.___hMake2_q d@@11) (= (DatatypeCtorId d@@11) |##_System._tuple#2._#Make2|))
 :qid |unknown.0:0|
 :skolemid |5404|
 :pattern ( (_System.Tuple2.___hMake2_q d@@11))
)))
(assert (forall ((d@@12 T@U) ) (! (= (M3.Artifact.ArtifactCons_q d@@12) (= (DatatypeCtorId d@@12) |##M3.Artifact.ArtifactCons|))
 :qid |unknown.0:0|
 :skolemid |6847|
 :pattern ( (M3.Artifact.ArtifactCons_q d@@12))
)))
(assert (forall ((d@@13 T@U) ) (! (= (M3.Path.InternalPath_q d@@13) (= (DatatypeCtorId d@@13) |##M3.Path.InternalPath|))
 :qid |unknown.0:0|
 :skolemid |6873|
 :pattern ( (M3.Path.InternalPath_q d@@13))
)))
(assert (forall ((d@@14 T@U) ) (! (= (M3.Path.ExternalPath_q d@@14) (= (DatatypeCtorId d@@14) |##M3.Path.ExternalPath|))
 :qid |unknown.0:0|
 :skolemid |6890|
 :pattern ( (M3.Path.ExternalPath_q d@@14))
)))
(assert (forall ((d@@15 T@U) ) (! (= (M3.Env.EnvCons_q d@@15) (= (DatatypeCtorId d@@15) |##M3.Env.EnvCons|))
 :qid |unknown.0:0|
 :skolemid |6906|
 :pattern ( (M3.Env.EnvCons_q d@@15))
)))
(assert (forall ((d@@16 T@U) ) (! (= (M3.WFCertificate.Cert_q d@@16) (= (DatatypeCtorId d@@16) |##M3.WFCertificate.Cert|))
 :qid |unknown.0:0|
 :skolemid |6921|
 :pattern ( (M3.WFCertificate.Cert_q d@@16))
)))
(assert (forall ((d@@17 T@U) ) (! (= (M3.State.StateCons_q d@@17) (= (DatatypeCtorId d@@17) |##M3.State.StateCons|))
 :qid |unknown.0:0|
 :skolemid |6938|
 :pattern ( (M3.State.StateCons_q d@@17))
)))
(assert (forall ((d@@18 T@U) ) (! (= (M3.Statement.stmtVariable_q d@@18) (= (DatatypeCtorId d@@18) |##M3.Statement.stmtVariable|))
 :qid |unknown.0:0|
 :skolemid |6968|
 :pattern ( (M3.Statement.stmtVariable_q d@@18))
)))
(assert (forall ((d@@19 T@U) ) (! (= (M3.Statement.stmtReturn_q d@@19) (= (DatatypeCtorId d@@19) |##M3.Statement.stmtReturn|))
 :qid |unknown.0:0|
 :skolemid |6980|
 :pattern ( (M3.Statement.stmtReturn_q d@@19))
)))
(assert (forall ((d@@20 T@U) ) (! (= (M3.Expression.exprLiteral_q d@@20) (= (DatatypeCtorId d@@20) |##M3.Expression.exprLiteral|))
 :qid |unknown.0:0|
 :skolemid |6995|
 :pattern ( (M3.Expression.exprLiteral_q d@@20))
)))
(assert (forall ((d@@21 T@U) ) (! (= (M3.Expression.exprIdentifier_q d@@21) (= (DatatypeCtorId d@@21) |##M3.Expression.exprIdentifier|))
 :qid |unknown.0:0|
 :skolemid |7004|
 :pattern ( (M3.Expression.exprIdentifier_q d@@21))
)))
(assert (forall ((d@@22 T@U) ) (! (= (M3.Expression.exprIf_q d@@22) (= (DatatypeCtorId d@@22) |##M3.Expression.exprIf|))
 :qid |unknown.0:0|
 :skolemid |7013|
 :pattern ( (M3.Expression.exprIf_q d@@22))
)))
(assert (forall ((d@@23 T@U) ) (! (= (M3.Expression.exprAnd_q d@@23) (= (DatatypeCtorId d@@23) |##M3.Expression.exprAnd|))
 :qid |unknown.0:0|
 :skolemid |7028|
 :pattern ( (M3.Expression.exprAnd_q d@@23))
)))
(assert (forall ((d@@24 T@U) ) (! (= (M3.Expression.exprOr_q d@@24) (= (DatatypeCtorId d@@24) |##M3.Expression.exprOr|))
 :qid |unknown.0:0|
 :skolemid |7040|
 :pattern ( (M3.Expression.exprOr_q d@@24))
)))
(assert (forall ((d@@25 T@U) ) (! (= (M3.Expression.exprInvocation_q d@@25) (= (DatatypeCtorId d@@25) |##M3.Expression.exprInvocation|))
 :qid |unknown.0:0|
 :skolemid |7052|
 :pattern ( (M3.Expression.exprInvocation_q d@@25))
)))
(assert (forall ((d@@26 T@U) ) (! (= (M3.Expression.exprError_q d@@26) (= (DatatypeCtorId d@@26) |##M3.Expression.exprError|))
 :qid |unknown.0:0|
 :skolemid |7065|
 :pattern ( (M3.Expression.exprError_q d@@26))
)))
(assert (forall ((d@@27 T@U) ) (! (= (M3.Literal.litTrue_q d@@27) (= (DatatypeCtorId d@@27) |##M3.Literal.litTrue|))
 :qid |unknown.0:0|
 :skolemid |7085|
 :pattern ( (M3.Literal.litTrue_q d@@27))
)))
(assert (forall ((d@@28 T@U) ) (! (= (M3.Literal.litFalse_q d@@28) (= (DatatypeCtorId d@@28) |##M3.Literal.litFalse|))
 :qid |unknown.0:0|
 :skolemid |7087|
 :pattern ( (M3.Literal.litFalse_q d@@28))
)))
(assert (forall ((d@@29 T@U) ) (! (= (M3.Literal.litUndefined_q d@@29) (= (DatatypeCtorId d@@29) |##M3.Literal.litUndefined|))
 :qid |unknown.0:0|
 :skolemid |7089|
 :pattern ( (M3.Literal.litUndefined_q d@@29))
)))
(assert (forall ((d@@30 T@U) ) (! (= (M3.Literal.litNull_q d@@30) (= (DatatypeCtorId d@@30) |##M3.Literal.litNull|))
 :qid |unknown.0:0|
 :skolemid |7091|
 :pattern ( (M3.Literal.litNull_q d@@30))
)))
(assert (forall ((d@@31 T@U) ) (! (= (M3.Literal.litNumber_q d@@31) (= (DatatypeCtorId d@@31) |##M3.Literal.litNumber|))
 :qid |unknown.0:0|
 :skolemid |7094|
 :pattern ( (M3.Literal.litNumber_q d@@31))
)))
(assert (forall ((d@@32 T@U) ) (! (= (M3.Literal.litString_q d@@32) (= (DatatypeCtorId d@@32) |##M3.Literal.litString|))
 :qid |unknown.0:0|
 :skolemid |7102|
 :pattern ( (M3.Literal.litString_q d@@32))
)))
(assert (forall ((d@@33 T@U) ) (! (= (M3.Literal.litPrimitive_q d@@33) (= (DatatypeCtorId d@@33) |##M3.Literal.litPrimitive|))
 :qid |unknown.0:0|
 :skolemid |7112|
 :pattern ( (M3.Literal.litPrimitive_q d@@33))
)))
(assert (forall ((d@@34 T@U) ) (! (= (M3.Literal.litArrOfPaths_q d@@34) (= (DatatypeCtorId d@@34) |##M3.Literal.litArrOfPaths|))
 :qid |unknown.0:0|
 :skolemid |7121|
 :pattern ( (M3.Literal.litArrOfPaths_q d@@34))
)))
(assert (forall ((d@@35 T@U) ) (! (= (M3.Literal.litArrOfStrings_q d@@35) (= (DatatypeCtorId d@@35) |##M3.Literal.litArrOfStrings|))
 :qid |unknown.0:0|
 :skolemid |7130|
 :pattern ( (M3.Literal.litArrOfStrings_q d@@35))
)))
(assert (forall ((d@@36 T@U) ) (! (= (M3.Literal.litArray_q d@@36) (= (DatatypeCtorId d@@36) |##M3.Literal.litArray|))
 :qid |unknown.0:0|
 :skolemid |7139|
 :pattern ( (M3.Literal.litArray_q d@@36))
)))
(assert (forall ((d@@37 T@U) ) (! (= (M3.Primitive.primCreatePath_q d@@37) (= (DatatypeCtorId d@@37) |##M3.Primitive.primCreatePath|))
 :qid |unknown.0:0|
 :skolemid |7162|
 :pattern ( (M3.Primitive.primCreatePath_q d@@37))
)))
(assert (forall ((d@@38 T@U) ) (! (= (M3.Primitive.primExec_q d@@38) (= (DatatypeCtorId d@@38) |##M3.Primitive.primExec|))
 :qid |unknown.0:0|
 :skolemid |7164|
 :pattern ( (M3.Primitive.primExec_q d@@38))
)))
(assert (forall ((d@@39 T@U) ) (! (= (M3.Reason.rCompatibility_q d@@39) (= (DatatypeCtorId d@@39) |##M3.Reason.rCompatibility|))
 :qid |unknown.0:0|
 :skolemid |7172|
 :pattern ( (M3.Reason.rCompatibility_q d@@39))
)))
(assert (forall ((d@@40 T@U) ) (! (= (M3.Reason.rValidity_q d@@40) (= (DatatypeCtorId d@@40) |##M3.Reason.rValidity|))
 :qid |unknown.0:0|
 :skolemid |7174|
 :pattern ( (M3.Reason.rValidity_q d@@40))
)))
(assert (forall ((d@@41 T@U) ) (! (= (M3.Tuple.Pair_q d@@41) (= (DatatypeCtorId d@@41) |##M3.Tuple.Pair|))
 :qid |unknown.0:0|
 :skolemid |7183|
 :pattern ( (M3.Tuple.Pair_q d@@41))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|paths#0@@1| T@U) (|st#0@@16| T@U) ) (!  (=> (or (|M3.__default.Restrict#canCall| |paths#0@@1| |st#0@@16|) (and (< 4 $FunctionContextHeight) (and ($Is SetType |paths#0@@1| (TSet Tclass.M3.Path)) ($Is DatatypeTypeType |st#0@@16| Tclass.M3.State)))) ($Is MapType (M3.__default.Restrict |paths#0@@1| |st#0@@16|) (TMap Tclass.M3.Path Tclass.M3.Artifact)))
 :qid |CloudMakeParallelBuildsdfy.473:27|
 :skolemid |5732|
 :pattern ( (M3.__default.Restrict |paths#0@@1| |st#0@@16|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@9 T@U) (|cmd#0@@8| T@U) (|deps#0@@9| T@U) (|restrictedState#0@@1| T@U) (|exps#0@@4| T@U) (|st#0@@17| T@U) ) (!  (=> (or (|M3.__default.execOne#canCall| (Lit SeqType |cmd#0@@8|) (Lit SetType |deps#0@@9|) (Lit MapType |restrictedState#0@@1|) (Lit SetType |exps#0@@4|) (Lit DatatypeTypeType |st#0@@17|)) (and (< 3 $FunctionContextHeight) (and (and (and (and ($Is SeqType |cmd#0@@8| (TSeq TChar)) ($Is SetType |deps#0@@9| (TSet Tclass.M3.Path))) ($Is MapType |restrictedState#0@@1| (TMap Tclass.M3.Path Tclass.M3.Artifact))) ($Is SetType |exps#0@@4| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@17| Tclass.M3.State)))) (and (=> (not (|Set#Equal| |exps#0@@4| |Set#Empty|)) (and (|M3.__default.PickOne#canCall| (TSeq TChar) (Lit SetType |exps#0@@4|)) (let ((|exp#1| (Lit SeqType ($Unbox SeqType (M3.__default.PickOne (TSeq TChar) (Lit SetType |exps#0@@4|))))))
 (and (|M3.__default.execOne#canCall| (Lit SeqType |cmd#0@@8|) (Lit SetType |deps#0@@9|) (Lit MapType |restrictedState#0@@1|) (|Set#Difference| |exps#0@@4| (|Set#UnionOne| |Set#Empty| ($Box SeqType |exp#1|))) (Lit DatatypeTypeType |st#0@@17|)) (let ((|st'#1| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.execOne ($LS $ly@@9) (Lit SeqType |cmd#0@@8|) (Lit SetType |deps#0@@9|) (Lit MapType |restrictedState#0@@1|) (|Set#Difference| |exps#0@@4| (|Set#UnionOne| |Set#Empty| ($Box SeqType |exp#1|))) (Lit DatatypeTypeType |st#0@@17|))))))
 ...
 (and (|M3.__default.DomSt#canCall| |st'#1|) (=> (not (|Set#IsMember| (M3.__default.DomSt |st'#1|) ($Box DatatypeTypeType |p#1|))) (and (|M3.__default.RunTool#canCall| (Lit SeqType |cmd#0@@8|) (Lit MapType |restrictedState#0@@1|) |exp#1|) (|M3.__default.SetSt#canCall| |p#1| (M3.__default.RunTool (Lit SeqType |cmd#0@@8|) (Lit MapType |restrictedState#0@@1|) |exp#1|) |st'#1|))))))))))) (= (M3.__default.execOne ($LS $ly@@9) (Lit SeqType |cmd#0@@8|) (Lit SetType |deps#0@@9|) (Lit MapType |restrictedState#0@@1|) (Lit SetType |exps#0@@4|) (Lit DatatypeTypeType |st#0@@17|)) (ite (|Set#Equal| |exps#0@@4| |Set#Empty|) (|#M3.Tuple.Pair| ($Box SetType (Lit SetType |Set#Empty|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |st#0@@17|))) (let ((|exp#1@@0| (Lit SeqType ($Unbox SeqType (M3.__default.PickOne (TSeq TChar) (Lit SetType |exps#0@@4|))))))
(let ((|st'#1@@0| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.execOne ($LS $ly@@9) (Lit SeqType |cmd#0@@8|) (Lit SetType |deps#0@@9|) (Lit MapType |restrictedState#0@@1|) (|Set#Difference| |exps#0@@4| (|Set#UnionOne| |Set#Empty| ($Box SeqType |exp#1@@0|))) (Lit DatatypeTypeType |st#0@@17|))))))
(let ((|paths#1| ($Unbox SetType (M3.Tuple.fst (M3.__default.execOne ($LS $ly@@9) (Lit SeqType |cmd#0@@8|) (Lit SetType |deps#0@@9|) (Lit MapType |restrictedState#0@@1|) (|Set#Difference| |exps#0@@4| (|Set#UnionOne| |Set#Empty| ($Box SeqType |exp#1@@0|))) (Lit DatatypeTypeType |st#0@@17|))))))
...
(|#M3.Tuple.Pair| ($Box SetType (|Set#Union| |paths#1| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |p#1@@0|)))) ($Box DatatypeTypeType (ite (|Set#IsMember| (M3.__default.DomSt |st'#1@@0|) ($Box DatatypeTypeType |p#1@@0|)) |st'#1@@0| (M3.__default.SetSt |p#1@@0| (Lit DatatypeTypeType (M3.__default.RunTool (Lit SeqType |cmd#0@@8|) (Lit MapType |restrictedState#0@@1|) |exp#1@@0|)) |st'#1@@0|))))))))))))
 ...
 :weight 3
 :skolemid |5831|
 :pattern ( (M3.__default.execOne ($LS $ly@@9) (Lit SeqType |cmd#0@@8|) (Lit SetType |deps#0@@9|) (Lit MapType |restrictedState#0@@1|) (Lit SetType |exps#0@@4|) (Lit DatatypeTypeType |st#0@@17|)))
))))
(assert (forall ((d@@42 T@U) ) (!  (=> (M3.Path.InternalPath_q d@@42) (exists ((|a#11#0#0| T@U) (|a#11#1#0| T@U) (|a#11#2#0| T@U) ) (! (= d@@42 (|#M3.Path.InternalPath| |a#11#0#0| |a#11#1#0| |a#11#2#0|))
 :qid |CloudMakeParallelBuildsdfy.784:18|
 :skolemid |6874|
)))
 :qid |unknown.0:0|
 :skolemid |6875|
 :pattern ( (M3.Path.InternalPath_q d@@42))
)))
(assert (forall ((d@@43 T@U) ) (!  (=> (M3.Expression.exprIf_q d@@43) (exists ((|a#85#0#0| T@U) (|a#85#1#0| T@U) (|a#85#2#0| T@U) ) (! (= d@@43 (|#M3.Expression.exprIf| |a#85#0#0| |a#85#1#0| |a#85#2#0|))
 :qid |CloudMakeParallelBuildsdfy.134:32|
 :skolemid |7014|
)))
 :qid |unknown.0:0|
 :skolemid |7015|
 :pattern ( (M3.Expression.exprIf_q d@@43))
)))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|cmd#0@@9| T@U) (|deps#0@@10| T@U) (|exps#0@@5| T@U) (|st#0@@18| T@U) ) (!  (=> (or (|M3.__default.exec#canCall| (Lit SeqType |cmd#0@@9|) (Lit SetType |deps#0@@10|) (Lit SetType |exps#0@@5|) (Lit DatatypeTypeType |st#0@@18|)) (and (< 5 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@9| (TSeq TChar)) ($Is SetType |deps#0@@10| (TSet Tclass.M3.Path))) ($Is SetType |exps#0@@5| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@18| Tclass.M3.State)))) (and (and (|M3.__default.Restrict#canCall| (Lit SetType |deps#0@@10|) (Lit DatatypeTypeType |st#0@@18|)) (|M3.__default.execOne#canCall| (Lit SeqType |cmd#0@@9|) (Lit SetType |deps#0@@10|) (Lit MapType (M3.__default.Restrict (Lit SetType |deps#0@@10|) (Lit DatatypeTypeType |st#0@@18|))) (Lit SetType |exps#0@@5|) (Lit DatatypeTypeType |st#0@@18|))) (= (M3.__default.exec (Lit SeqType |cmd#0@@9|) (Lit SetType |deps#0@@10|) (Lit SetType |exps#0@@5|) (Lit DatatypeTypeType |st#0@@18|)) (Lit DatatypeTypeType (M3.__default.execOne ($LS $LZ) (Lit SeqType |cmd#0@@9|) (Lit SetType |deps#0@@10|) (Lit MapType (M3.__default.Restrict (Lit SetType |deps#0@@10|) (Lit DatatypeTypeType |st#0@@18|))) (Lit SetType |exps#0@@5|) (Lit DatatypeTypeType |st#0@@18|))))))
 :qid |CloudMakeParallelBuildsdfy.69:23|
 :weight 3
 :skolemid |5823|
 :pattern ( (M3.__default.exec (Lit SeqType |cmd#0@@9|) (Lit SetType |deps#0@@10|) (Lit SetType |exps#0@@5|) (Lit DatatypeTypeType |st#0@@18|)))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($ly@@10 T@U) (|expr#0@@0| T@U) (|st#0@@19| T@U) (|env#0@@6| T@U) ) (!  (=> (or (|M3.__default.eval#canCall| (Lit DatatypeTypeType |expr#0@@0|) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)) (and (< 8 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0@@0| Tclass.M3.Expression) ($Is DatatypeTypeType |st#0@@19| Tclass.M3.State)) ($Is DatatypeTypeType |env#0@@6| Tclass.M3.Env)) (U_2_bool (Lit boolType (bool_2_U (M3.__default.ValidEnv (Lit DatatypeTypeType |env#0@@6|)))))))) (and (and (|M3.__default.Value#canCall| (Lit DatatypeTypeType |expr#0@@0|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (M3.__default.Value (Lit DatatypeTypeType |expr#0@@0|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@0|))))) (|M3.__default.GetEnv#canCall| (Lit DatatypeTypeType (M3.Expression.id (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |env#0@@6|))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@0|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@0|))))) (and (|M3.__default.eval#canCall| (Lit DatatypeTypeType (M3.Expression.cond (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)) (let ((|st'#8| ($Unbox DatatypeTypeType (M3.Tuple.snd (Lit DatatypeTypeType (M3.__default.eval ($LS $ly@@10) (Lit DatatypeTypeType (M3.Expression.cond (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)))))))
(let ((|cond'#2| ($Unbox DatatypeTypeType (M3.Tuple.fst (Lit DatatypeTypeType (M3.__default.eval ($LS $ly@@10) (Lit DatatypeTypeType (M3.Expression.cond (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)))))))
 (and (and (=> (M3.Expression.exprLiteral_q |cond'#2|) (|$IsA#M3.Literal| (M3.Expression.lit |cond'#2|))) (=> (and (M3.Expression.exprLiteral_q |cond'#2|) (|M3.Literal#Equal| (M3.Expression.lit |cond'#2|) |#M3.Literal.litTrue|)) (|M3.__default.eval#canCall| (Lit DatatypeTypeType (M3.Expression.ifTrue (Lit DatatypeTypeType |expr#0@@0|))) |st'#8| (Lit DatatypeTypeType |env#0@@6|)))) (=> (not (and (M3.Expression.exprLiteral_q |cond'#2|) (|M3.Literal#Equal| (M3.Expression.lit |cond'#2|) |#M3.Literal.litTrue|))) (and (=> (M3.Expression.exprLiteral_q |cond'#2|) (|$IsA#M3.Literal| (M3.Expression.lit |cond'#2|))) (=> (and (M3.Expression.exprLiteral_q |cond'#2|) (|M3.Literal#Equal| (M3.Expression.lit |cond'#2|) |#M3.Literal.litFalse|)) (|M3.__default.eval#canCall| (Lit DatatypeTypeType (M3.Expression.ifFalse (Lit DatatypeTypeType |expr#0@@0|))) |st'#8| (Lit DatatypeTypeType |env#0@@6|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@0|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@0|))))) (and (|M3.__default.eval#canCall| (Lit DatatypeTypeType (M3.Expression.conj0 (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)) (let ((|st'#9| ($Unbox DatatypeTypeType (M3.Tuple.snd (Lit DatatypeTypeType (M3.__default.eval ($LS $ly@@10) (Lit DatatypeTypeType (M3.Expression.conj0 (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)))))))
(let ((|conj0'#2| ($Unbox DatatypeTypeType (M3.Tuple.fst (Lit DatatypeTypeType (M3.__default.eval ($LS $ly@@10) (Lit DatatypeTypeType (M3.Expression.conj0 (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)))))))
 (and (and (=> (M3.Expression.exprLiteral_q |conj0'#2|) (|$IsA#M3.Literal| (M3.Expression.lit |conj0'#2|))) (=> (and (M3.Expression.exprLiteral_q |conj0'#2|) (|M3.Literal#Equal| (M3.Expression.lit |conj0'#2|) |#M3.Literal.litTrue|)) (|M3.__default.eval#canCall| (Lit DatatypeTypeType (M3.Expression.conj1 (Lit DatatypeTypeType |expr#0@@0|))) |st'#9| (Lit DatatypeTypeType |env#0@@6|)))) (=> (not (and (M3.Expression.exprLiteral_q |conj0'#2|) (|M3.Literal#Equal| (M3.Expression.lit |conj0'#2|) |#M3.Literal.litTrue|))) (=> (M3.Expression.exprLiteral_q |conj0'#2|) (|$IsA#M3.Literal| (M3.Expression.lit |conj0'#2|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@0|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@0|))))) (and (|M3.__default.eval#canCall| (Lit DatatypeTypeType (M3.Expression.disj0 (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)) (let ((|st'#10| ($Unbox DatatypeTypeType (M3.Tuple.snd (Lit DatatypeTypeType (M3.__default.eval ($LS $ly@@10) (Lit DatatypeTypeType (M3.Expression.disj0 (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)))))))
(let ((|disj0'#2| ($Unbox DatatypeTypeType (M3.Tuple.fst (Lit DatatypeTypeType (M3.__default.eval ($LS $ly@@10) (Lit DatatypeTypeType (M3.Expression.disj0 (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)))))))
 (and (=> (M3.Expression.exprLiteral_q |disj0'#2|) (|$IsA#M3.Literal| (M3.Expression.lit |disj0'#2|))) (=> (not (and (M3.Expression.exprLiteral_q |disj0'#2|) (|M3.Literal#Equal| (M3.Expression.lit |disj0'#2|) |#M3.Literal.litTrue|))) (and (=> (M3.Expression.exprLiteral_q |disj0'#2|) (|$IsA#M3.Literal| (M3.Expression.lit |disj0'#2|))) (=> (and (M3.Expression.exprLiteral_q |disj0'#2|) (|M3.Literal#Equal| (M3.Expression.lit |disj0'#2|) |#M3.Literal.litFalse|)) (|M3.__default.eval#canCall| (Lit DatatypeTypeType (M3.Expression.disj1 (Lit DatatypeTypeType |expr#0@@0|))) |st'#10| (Lit DatatypeTypeType |env#0@@6|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@0|)))))) (=> (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0@@0|))))) (and (|M3.__default.eval#canCall| (Lit DatatypeTypeType (M3.Expression.fun (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)) (let ((|st'#11| ($Unbox DatatypeTypeType (M3.Tuple.snd (Lit DatatypeTypeType (M3.__default.eval ($LS $ly@@10) (Lit DatatypeTypeType (M3.Expression.fun (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)))))))
(let ((|fun'#2| ($Unbox DatatypeTypeType (M3.Tuple.fst (Lit DatatypeTypeType (M3.__default.eval ($LS $ly@@10) (Lit DatatypeTypeType (M3.Expression.fun (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)))))))
 (and (|M3.__default.evalArgs#canCall| (Lit DatatypeTypeType |expr#0@@0|) (Lit SeqType (M3.Expression.args (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)) (let ((|sts'#2| ($Unbox SetType (M3.Tuple.snd (Lit DatatypeTypeType (M3.__default.evalArgs ($LS $ly@@10) (Lit DatatypeTypeType |expr#0@@0|) (Lit SeqType (M3.Expression.args (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)))))))
(let ((|args'#2| ($Unbox SeqType (M3.Tuple.fst (Lit DatatypeTypeType (M3.__default.evalArgs ($LS $ly@@10) (Lit DatatypeTypeType |expr#0@@0|) (Lit SeqType (M3.Expression.args (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)))))))
(let ((|sts''#2| (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |st'#11|)) |sts'#2|)))
 ...
 (and (M3.Tuple.Pair_q |ps#2|) (M3.Tuple.Pair_q |ps#2|)))))))))))))))))))))))))))))) (= (M3.__default.eval ($LS $ly@@10) (Lit DatatypeTypeType |expr#0@@0|) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)) (ite (M3.__default.Value (Lit DatatypeTypeType |expr#0@@0|)) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType |expr#0@@0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |st#0@@19|))) (ite (M3.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@0|)) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (M3.__default.GetEnv (Lit DatatypeTypeType (M3.Expression.id (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |env#0@@6|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |st#0@@19|))) (ite (M3.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@0|)) (let ((|st'#8@@0| ($Unbox DatatypeTypeType (M3.Tuple.snd (Lit DatatypeTypeType (M3.__default.eval ($LS $ly@@10) (Lit DatatypeTypeType (M3.Expression.cond (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)))))))
(let ((|cond'#2@@0| ($Unbox DatatypeTypeType (M3.Tuple.fst (Lit DatatypeTypeType (M3.__default.eval ($LS $ly@@10) (Lit DatatypeTypeType (M3.Expression.cond (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)))))))
(ite  (and (M3.Expression.exprLiteral_q |cond'#2@@0|) (|M3.Literal#Equal| (M3.Expression.lit |cond'#2@@0|) |#M3.Literal.litTrue|)) (M3.__default.eval ($LS $ly@@10) (Lit DatatypeTypeType (M3.Expression.ifTrue (Lit DatatypeTypeType |expr#0@@0|))) |st'#8@@0| (Lit DatatypeTypeType |env#0@@6|)) (ite  (and (M3.Expression.exprLiteral_q |cond'#2@@0|) (|M3.Literal#Equal| (M3.Expression.lit |cond'#2@@0|) |#M3.Literal.litFalse|)) (M3.__default.eval ($LS $ly@@10) (Lit DatatypeTypeType (M3.Expression.ifFalse (Lit DatatypeTypeType |expr#0@@0|))) |st'#8@@0| (Lit DatatypeTypeType |env#0@@6|)) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |st#0@@19|))))))) (ite (M3.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@0|)) (let ((|st'#9@@0| ($Unbox DatatypeTypeType (M3.Tuple.snd (Lit DatatypeTypeType (M3.__default.eval ($LS $ly@@10) (Lit DatatypeTypeType (M3.Expression.conj0 (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)))))))
(let ((|conj0'#2@@0| ($Unbox DatatypeTypeType (M3.Tuple.fst (Lit DatatypeTypeType (M3.__default.eval ($LS $ly@@10) (Lit DatatypeTypeType (M3.Expression.conj0 (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)))))))
(ite  (and (M3.Expression.exprLiteral_q |conj0'#2@@0|) (|M3.Literal#Equal| (M3.Expression.lit |conj0'#2@@0|) |#M3.Literal.litTrue|)) (M3.__default.eval ($LS $ly@@10) (Lit DatatypeTypeType (M3.Expression.conj1 (Lit DatatypeTypeType |expr#0@@0|))) |st'#9@@0| (Lit DatatypeTypeType |env#0@@6|)) (ite  (and (M3.Expression.exprLiteral_q |conj0'#2@@0|) (|M3.Literal#Equal| (M3.Expression.lit |conj0'#2@@0|) |#M3.Literal.litFalse|)) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprLiteral| (Lit DatatypeTypeType |#M3.Literal.litFalse|)))) ($Box DatatypeTypeType |st'#9@@0|)) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |st#0@@19|))))))) (ite (M3.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@0|)) (let ((|st'#10@@0| ($Unbox DatatypeTypeType (M3.Tuple.snd (Lit DatatypeTypeType (M3.__default.eval ($LS $ly@@10) (Lit DatatypeTypeType (M3.Expression.disj0 (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)))))))
(let ((|disj0'#2@@0| ($Unbox DatatypeTypeType (M3.Tuple.fst (Lit DatatypeTypeType (M3.__default.eval ($LS $ly@@10) (Lit DatatypeTypeType (M3.Expression.disj0 (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)))))))
(ite  (and (M3.Expression.exprLiteral_q |disj0'#2@@0|) (|M3.Literal#Equal| (M3.Expression.lit |disj0'#2@@0|) |#M3.Literal.litTrue|)) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprLiteral| (Lit DatatypeTypeType |#M3.Literal.litTrue|)))) ($Box DatatypeTypeType |st'#10@@0|)) (ite  (and (M3.Expression.exprLiteral_q |disj0'#2@@0|) (|M3.Literal#Equal| (M3.Expression.lit |disj0'#2@@0|) |#M3.Literal.litFalse|)) (M3.__default.eval ($LS $ly@@10) (Lit DatatypeTypeType (M3.Expression.disj1 (Lit DatatypeTypeType |expr#0@@0|))) |st'#10@@0| (Lit DatatypeTypeType |env#0@@6|)) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |st#0@@19|))))))) (ite (M3.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0@@0|)) (let ((|st'#11@@0| ($Unbox DatatypeTypeType (M3.Tuple.snd (Lit DatatypeTypeType (M3.__default.eval ($LS $ly@@10) (Lit DatatypeTypeType (M3.Expression.fun (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)))))))
(let ((|fun'#2@@0| ($Unbox DatatypeTypeType (M3.Tuple.fst (Lit DatatypeTypeType (M3.__default.eval ($LS $ly@@10) (Lit DatatypeTypeType (M3.Expression.fun (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)))))))
(let ((|sts'#2@@0| ($Unbox SetType (M3.Tuple.snd (Lit DatatypeTypeType (M3.__default.evalArgs ($LS $ly@@10) (Lit DatatypeTypeType |expr#0@@0|) (Lit SeqType (M3.Expression.args (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)))))))
(let ((|args'#2@@0| ($Unbox SeqType (M3.Tuple.fst (Lit DatatypeTypeType (M3.__default.evalArgs ($LS $ly@@10) (Lit DatatypeTypeType |expr#0@@0|) (Lit SeqType (M3.Expression.args (Lit DatatypeTypeType |expr#0@@0|))) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)))))))
(let ((|sts''#2@@0| (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |st'#11@@0|)) |sts'#2@@0|)))
(ite  (not (M3.__default.Compatible |sts''#2@@0|)) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rCompatibility|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |st#0@@19|))) (let ((|stCombined#2@@0| (M3.__default.Combine ($LS $LZ) |sts''#2@@0|)))
...
(|#M3.Tuple.Pair| ($Box DatatypeTypeType (|#M3.Expression.exprLiteral| (|#M3.Literal.litArrOfPaths| ($Unbox SetType (M3.Tuple.fst |ps#2@@0|))))) (M3.Tuple.snd |ps#2@@0|))) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |st#0@@19|)))) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |st#0@@19|)))) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |st#0@@19|))))))))))) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |st#0@@19|))))))))))))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :weight 3
 :skolemid |6704|
 :pattern ( (M3.__default.eval ($LS $ly@@10) (Lit DatatypeTypeType |expr#0@@0|) (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |env#0@@6|)))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|p#0@@15| T@U) (|st#0@@20| T@U) ) (!  (=> (or (|M3.__default.Oracle#canCall| |p#0@@15| |st#0@@20|) (and (< 5 $FunctionContextHeight) (and ($Is DatatypeTypeType |p#0@@15| Tclass.M3.Path) ($Is DatatypeTypeType |st#0@@20| Tclass.M3.State)))) (and (and (and (|M3.__default.WellFounded#canCall| |p#0@@15|) (=> (M3.__default.WellFounded |p#0@@15|) (and (|M3.__default.GetCert#canCall| |p#0@@15|) (|M3.__default.OracleWF#canCall| |p#0@@15| (M3.__default.GetCert |p#0@@15|) |st#0@@20|)))) (=> (not (M3.__default.WellFounded |p#0@@15|)) (|M3.__default.OracleArbitrary#canCall| |p#0@@15|))) (= (M3.__default.Oracle |p#0@@15| |st#0@@20|) (ite (M3.__default.WellFounded |p#0@@15|) (M3.__default.OracleWF ($LS $LZ) |p#0@@15| (M3.__default.GetCert |p#0@@15|) |st#0@@20|) (M3.__default.OracleArbitrary |p#0@@15|)))))
 :qid |CloudMakeParallelBuildsdfy.104:25|
 :skolemid |6037|
 :pattern ( (M3.__default.Oracle |p#0@@15| |st#0@@20|))
))))
(assert (forall ((d@@44 T@U) ) (!  (=> (_System.Tuple2.___hMake2_q d@@44) (exists ((|a#1#0#0| T@U) (|a#1#1#0| T@U) ) (! (= d@@44 (|#_System._tuple#2._#Make2| |a#1#0#0| |a#1#1#0|))
 :qid |unknown.0:0|
 :skolemid |5405|
)))
 :qid |unknown.0:0|
 :skolemid |5406|
 :pattern ( (_System.Tuple2.___hMake2_q d@@44))
)))
(assert (forall ((d@@45 T@U) ) (!  (=> (M3.WFCertificate.Cert_q d@@45) (exists ((|a#37#0#0| T@U) (|a#37#1#0| T@U) ) (! (= d@@45 (|#M3.WFCertificate.Cert| |a#37#0#0| |a#37#1#0|))
 :qid |CloudMakeParallelBuildsdfy.500:33|
 :skolemid |6922|
)))
 :qid |unknown.0:0|
 :skolemid |6923|
 :pattern ( (M3.WFCertificate.Cert_q d@@45))
)))
(assert (forall ((d@@46 T@U) ) (!  (=> (M3.Statement.stmtVariable_q d@@46) (exists ((|a#59#0#0| T@U) (|a#59#1#0| T@U) ) (! (= d@@46 (|#M3.Statement.stmtVariable| |a#59#0#0| |a#59#1#0|))
 :qid |CloudMakeParallelBuildsdfy.130:37|
 :skolemid |6969|
)))
 :qid |unknown.0:0|
 :skolemid |6970|
 :pattern ( (M3.Statement.stmtVariable_q d@@46))
)))
(assert (forall ((d@@47 T@U) ) (!  (=> (M3.Expression.exprAnd_q d@@47) (exists ((|a#95#0#0| T@U) (|a#95#1#0| T@U) ) (! (= d@@47 (|#M3.Expression.exprAnd| |a#95#0#0| |a#95#1#0|))
 :qid |CloudMakeParallelBuildsdfy.135:33|
 :skolemid |7029|
)))
 :qid |unknown.0:0|
 :skolemid |7030|
 :pattern ( (M3.Expression.exprAnd_q d@@47))
)))
(assert (forall ((d@@48 T@U) ) (!  (=> (M3.Expression.exprOr_q d@@48) (exists ((|a#103#0#0| T@U) (|a#103#1#0| T@U) ) (! (= d@@48 (|#M3.Expression.exprOr| |a#103#0#0| |a#103#1#0|))
 :qid |CloudMakeParallelBuildsdfy.136:32|
 :skolemid |7041|
)))
 :qid |unknown.0:0|
 :skolemid |7042|
 :pattern ( (M3.Expression.exprOr_q d@@48))
)))
(assert (forall ((d@@49 T@U) ) (!  (=> (M3.Expression.exprInvocation_q d@@49) (exists ((|a#111#0#0| T@U) (|a#111#1#0| T@U) ) (! (= d@@49 (|#M3.Expression.exprInvocation| |a#111#0#0| |a#111#1#0|))
 :qid |CloudMakeParallelBuildsdfy.137:40|
 :skolemid |7053|
)))
 :qid |unknown.0:0|
 :skolemid |7054|
 :pattern ( (M3.Expression.exprInvocation_q d@@49))
)))
(assert (forall ((d@@50 T@U) ) (!  (=> (M3.Tuple.Pair_q d@@50) (exists ((|a#195#0#0| T@U) (|a#195#1#0| T@U) ) (! (= d@@50 (|#M3.Tuple.Pair| |a#195#0#0| |a#195#1#0|))
 :qid |CloudMakeParallelBuildsdfy.159:31|
 :skolemid |7184|
)))
 :qid |unknown.0:0|
 :skolemid |7185|
 :pattern ( (M3.Tuple.Pair_q d@@50))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|p#0@@16| T@U) (|st#0@@21| T@U) ) (!  (=> (or (|M3.__default.GetSt#canCall| |p#0@@16| |st#0@@21|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |p#0@@16| Tclass.M3.Path) ($Is DatatypeTypeType |st#0@@21| Tclass.M3.State)) (|Set#IsMember| (M3.__default.DomSt |st#0@@21|) ($Box DatatypeTypeType |p#0@@16|))))) (and (M3.State.StateCons_q |st#0@@21|) (= (M3.__default.GetSt |p#0@@16| |st#0@@21|) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (M3.State.m |st#0@@21|)) ($Box DatatypeTypeType |p#0@@16|))))))
 :qid |CloudMakeParallelBuildsdfy.10:24|
 :skolemid |6471|
 :pattern ( (M3.__default.GetSt |p#0@@16| |st#0@@21|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@22| T@U) ) (!  (=> (or (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@22|)) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |st#0@@22| Tclass.M3.State))) (and (M3.State.StateCons_q (Lit DatatypeTypeType |st#0@@22|)) (= (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@22|)) (|Set#FromBoogieMap| (|lambda#0| Tclass.M3.Path (|Map#Domain| (M3.State.m (Lit DatatypeTypeType |st#0@@22|))))))))
 :qid |CloudMakeParallelBuildsdfy.9:24|
 :weight 3
 :skolemid |6479|
 :pattern ( (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@22|)))
))))
(assert (forall ((d@@51 T@U) ) (!  (=> (M3.Literal.litTrue_q d@@51) (= d@@51 |#M3.Literal.litTrue|))
 :qid |unknown.0:0|
 :skolemid |7086|
 :pattern ( (M3.Literal.litTrue_q d@@51))
)))
(assert (forall ((d@@52 T@U) ) (!  (=> (M3.Literal.litFalse_q d@@52) (= d@@52 |#M3.Literal.litFalse|))
 :qid |unknown.0:0|
 :skolemid |7088|
 :pattern ( (M3.Literal.litFalse_q d@@52))
)))
(assert (forall ((d@@53 T@U) ) (!  (=> (M3.Literal.litUndefined_q d@@53) (= d@@53 |#M3.Literal.litUndefined|))
 :qid |unknown.0:0|
 :skolemid |7090|
 :pattern ( (M3.Literal.litUndefined_q d@@53))
)))
(assert (forall ((d@@54 T@U) ) (!  (=> (M3.Literal.litNull_q d@@54) (= d@@54 |#M3.Literal.litNull|))
 :qid |unknown.0:0|
 :skolemid |7092|
 :pattern ( (M3.Literal.litNull_q d@@54))
)))
(assert (forall ((d@@55 T@U) ) (!  (=> (M3.Primitive.primCreatePath_q d@@55) (= d@@55 |#M3.Primitive.primCreatePath|))
 :qid |unknown.0:0|
 :skolemid |7163|
 :pattern ( (M3.Primitive.primCreatePath_q d@@55))
)))
(assert (forall ((d@@56 T@U) ) (!  (=> (M3.Primitive.primExec_q d@@56) (= d@@56 |#M3.Primitive.primExec|))
 :qid |unknown.0:0|
 :skolemid |7165|
 :pattern ( (M3.Primitive.primExec_q d@@56))
)))
(assert (forall ((d@@57 T@U) ) (!  (=> (M3.Reason.rCompatibility_q d@@57) (= d@@57 |#M3.Reason.rCompatibility|))
 :qid |unknown.0:0|
 :skolemid |7173|
 :pattern ( (M3.Reason.rCompatibility_q d@@57))
)))
(assert (forall ((d@@58 T@U) ) (!  (=> (M3.Reason.rValidity_q d@@58) (= d@@58 |#M3.Reason.rValidity|))
 :qid |unknown.0:0|
 :skolemid |7175|
 :pattern ( (M3.Reason.rValidity_q d@@58))
)))
...
(assert (forall ((d@@59 T@U) ) (!  (=> (|$IsA#M3.Literal| d@@59) (or (or (or (or (or (or (or (or (or (M3.Literal.litTrue_q d@@59) (M3.Literal.litFalse_q d@@59)) (M3.Literal.litUndefined_q d@@59)) (M3.Literal.litNull_q d@@59)) (M3.Literal.litNumber_q d@@59)) (M3.Literal.litString_q d@@59)) (M3.Literal.litPrimitive_q d@@59)) (M3.Literal.litArrOfPaths_q d@@59)) (M3.Literal.litArrOfStrings_q d@@59)) (M3.Literal.litArray_q d@@59)))
 :qid |unknown.0:0|
 :skolemid |7149|
 :pattern ( (|$IsA#M3.Literal| d@@59))
)))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall ((|cmd#0@@10| T@U) (|deps#0@@11| T@U) (|exps#0@@6| T@U) (|st#0@@23| T@U) ) (!  (=> (or (|M3.__default.Pre#canCall| |cmd#0@@10| |deps#0@@11| |exps#0@@6| |st#0@@23|) (and (< 6 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@10| (TSeq TChar)) ($Is SetType |deps#0@@11| (TSet Tclass.M3.Path))) ($Is SetType |exps#0@@6| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@23| Tclass.M3.State)))) (and (forall ((|e#0@@1| T@U) ) (!  (=> ($Is SeqType |e#0@@1| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@6| ($Box SeqType |e#0@@1|)) (and (and (|M3.__default.Loc#canCall| |cmd#0@@10| |deps#0@@11| |e#0@@1|) (|M3.__default.DomSt#canCall| |st#0@@23|)) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@23|) ($Box DatatypeTypeType (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@1|))) (and (and (|$IsA#M3.Artifact| (M3.__default.GetSt (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@1|) |st#0@@23|)) (|$IsA#M3.Artifact| (M3.__default.Oracle (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@1|) |st#0@@23|))) (and (and (|M3.__default.Loc#canCall| |cmd#0@@10| |deps#0@@11| |e#0@@1|) (|M3.__default.GetSt#canCall| (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@1|) |st#0@@23|)) (and (|M3.__default.Loc#canCall| |cmd#0@@10| |deps#0@@11| |e#0@@1|) (|M3.__default.Oracle#canCall| (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@1|) |st#0@@23|))))))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |6560|
 :pattern ( (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@1|))
 :pattern ( (|Set#IsMember| |exps#0@@6| ($Box SeqType |e#0@@1|)))
)) (= (M3.__default.Pre |cmd#0@@10| |deps#0@@11| |exps#0@@6| |st#0@@23|) (forall ((|e#0@@2| T@U) ) (!  (=> ($Is SeqType |e#0@@2| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@6| ($Box SeqType |e#0@@2|)) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@23|) ($Box DatatypeTypeType (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@2|))) (|M3.Artifact#Equal| (M3.__default.GetSt (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@2|) |st#0@@23|) (M3.__default.Oracle (M3.__default.Loc |cmd#0@@10| |deps#0@@11| |e#0@@2|) |st#0@@23|)))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |6559|
 ...
 :qid |CloudMakeParallelBuildsdfy.83:23|
 :skolemid |6561|
 :pattern ( (M3.__default.Pre |cmd#0@@10| |deps#0@@11| |exps#0@@6| |st#0@@23|))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@11 T@U) (|p#0@@18| T@U) (|cert#0@@5| T@U) (|st#0@@24| T@U) ) (!  (=> (or (|M3.__default.OracleWF#canCall| |p#0@@18| (Lit DatatypeTypeType |cert#0@@5|) |st#0@@24|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |p#0@@18| Tclass.M3.Path) ($Is DatatypeTypeType |cert#0@@5| Tclass.M3.WFCertificate)) ($Is DatatypeTypeType |st#0@@24| Tclass.M3.State)) (M3.__default.CheckWellFounded ($LS $LZ) |p#0@@18| (Lit DatatypeTypeType |cert#0@@5|))))) (and (and (and (and (|M3.__default.LocInv__Cmd#canCall| |p#0@@18|) (|M3.__default.LocInv__Deps#canCall| |p#0@@18|)) (|M3.__default.LocInv__Exp#canCall| |p#0@@18|)) (let ((|e#1@@1| (M3.__default.LocInv__Exp |p#0@@18|)))
(let ((|deps#1@@0| (M3.__default.LocInv__Deps |p#0@@18|)))
(let ((|cmd#1@@0| (M3.__default.LocInv__Cmd |p#0@@18|)))
 (and (|M3.__default.CollectDependencies#canCall| |p#0@@18| (Lit DatatypeTypeType |cert#0@@5|) |deps#1@@0| |st#0@@24|) (|M3.__default.RunTool#canCall| |cmd#1@@0| (M3.__default.CollectDependencies ($LS $ly@@11) |p#0@@18| (Lit DatatypeTypeType |cert#0@@5|) |deps#1@@0| |st#0@@24|) |e#1@@1|)))))) (= (M3.__default.OracleWF ($LS $ly@@11) |p#0@@18| (Lit DatatypeTypeType |cert#0@@5|) |st#0@@24|) (let ((|e#1@@2| (M3.__default.LocInv__Exp |p#0@@18|)))
(let ((|deps#1@@1| (M3.__default.LocInv__Deps |p#0@@18|)))
(let ((|cmd#1@@1| (M3.__default.LocInv__Cmd |p#0@@18|)))
(M3.__default.RunTool |cmd#1@@1| (M3.__default.CollectDependencies ($LS $ly@@11) |p#0@@18| (Lit DatatypeTypeType |cert#0@@5|) |deps#1@@1| |st#0@@24|) |e#1@@2|)))))))
 :qid |CloudMakeParallelBuildsdfy.653:18|
 :weight 3
 :skolemid |6063|
 :pattern ( (M3.__default.OracleWF ($LS $ly@@11) |p#0@@18| (Lit DatatypeTypeType |cert#0@@5|) |st#0@@24|))
))))
(assert (forall ((d@@60 T@U) ) (!  (=> (M3.Artifact.ArtifactCons_q d@@60) (exists ((|a#1#0#0@@0| Int) ) (! (= d@@60 (|#M3.Artifact.ArtifactCons| |a#1#0#0@@0|))
 :qid |CloudMakeParallelBuildsdfy.780:36|
 :skolemid |6848|
)))
 :qid |unknown.0:0|
 :skolemid |6849|
 :pattern ( (M3.Artifact.ArtifactCons_q d@@60))
)))
(assert (forall ((d@@61 T@U) ) (!  (=> (M3.Path.ExternalPath_q d@@61) (exists ((|a#23#0#0| T@U) ) (! (= d@@61 (|#M3.Path.ExternalPath| |a#23#0#0|))
 :qid |CloudMakeParallelBuildsdfy.785:18|
 :skolemid |6891|
)))
 :qid |unknown.0:0|
 :skolemid |6892|
 :pattern ( (M3.Path.ExternalPath_q d@@61))
)))
(assert (forall ((d@@62 T@U) ) (!  (=> (M3.Env.EnvCons_q d@@62) (exists ((|a#30#0#0| T@U) ) (! (= d@@62 (|#M3.Env.EnvCons| |a#30#0#0|))
 :qid |CloudMakeParallelBuildsdfy.819:26|
 :skolemid |6907|
)))
 :qid |unknown.0:0|
 :skolemid |6908|
 :pattern ( (M3.Env.EnvCons_q d@@62))
)))
(assert (forall ((d@@63 T@U) ) (!  (=> (M3.State.StateCons_q d@@63) (exists ((|a#45#0#0| T@U) ) (! (= d@@63 (|#M3.State.StateCons| |a#45#0#0|))
 :qid |CloudMakeParallelBuildsdfy.433:30|
 :skolemid |6939|
)))
 :qid |unknown.0:0|
 :skolemid |6940|
 :pattern ( (M3.State.StateCons_q d@@63))
)))
(assert (forall ((d@@64 T@U) ) (!  (=> (M3.Statement.stmtReturn_q d@@64) (exists ((|a#67#0#0| T@U) ) (! (= d@@64 (|#M3.Statement.stmtReturn| |a#67#0#0|))
 :qid |CloudMakeParallelBuildsdfy.131:35|
 :skolemid |6981|
)))
 :qid |unknown.0:0|
 :skolemid |6982|
 :pattern ( (M3.Statement.stmtReturn_q d@@64))
)))
(assert (forall ((d@@65 T@U) ) (!  (=> (M3.Expression.exprLiteral_q d@@65) (exists ((|a#73#0#0| T@U) ) (! (= d@@65 (|#M3.Expression.exprLiteral| |a#73#0#0|))
 :qid |CloudMakeParallelBuildsdfy.133:37|
 :skolemid |6996|
)))
 :qid |unknown.0:0|
 :skolemid |6997|
 :pattern ( (M3.Expression.exprLiteral_q d@@65))
)))
(assert (forall ((d@@66 T@U) ) (!  (=> (M3.Expression.exprIdentifier_q d@@66) (exists ((|a#79#0#0| T@U) ) (! (= d@@66 (|#M3.Expression.exprIdentifier| |a#79#0#0|))
 :qid |CloudMakeParallelBuildsdfy.133:68|
 :skolemid |7005|
)))
 :qid |unknown.0:0|
 :skolemid |7006|
 :pattern ( (M3.Expression.exprIdentifier_q d@@66))
)))
(assert (forall ((d@@67 T@U) ) (!  (=> (M3.Expression.exprError_q d@@67) (exists ((|a#120#0#0| T@U) ) (! (= d@@67 (|#M3.Expression.exprError| |a#120#0#0|))
 :qid |CloudMakeParallelBuildsdfy.138:35|
 :skolemid |7066|
)))
 :qid |unknown.0:0|
 :skolemid |7067|
 :pattern ( (M3.Expression.exprError_q d@@67))
)))
(assert (forall ((d@@68 T@U) ) (!  (=> (M3.Literal.litNumber_q d@@68) (exists ((|a#142#0#0| Int) ) (! (= d@@68 (|#M3.Literal.litNumber| |a#142#0#0|))
 :qid |CloudMakeParallelBuildsdfy.141:32|
 :skolemid |7095|
)))
 :qid |unknown.0:0|
 :skolemid |7096|
 :pattern ( (M3.Literal.litNumber_q d@@68))
)))
(assert (forall ((d@@69 T@U) ) (!  (=> (M3.Literal.litString_q d@@69) (exists ((|a#147#0#0| T@U) ) (! (= d@@69 (|#M3.Literal.litString| |a#147#0#0|))
 :qid |CloudMakeParallelBuildsdfy.141:54|
 :skolemid |7103|
)))
 :qid |unknown.0:0|
 :skolemid |7104|
 :pattern ( (M3.Literal.litString_q d@@69))
)))
(assert (forall ((d@@70 T@U) ) (!  (=> (M3.Literal.litPrimitive_q d@@70) (exists ((|a#154#0#0| T@U) ) (! (= d@@70 (|#M3.Literal.litPrimitive| |a#154#0#0|))
 :qid |CloudMakeParallelBuildsdfy.142:35|
 :skolemid |7113|
)))
 :qid |unknown.0:0|
 :skolemid |7114|
 :pattern ( (M3.Literal.litPrimitive_q d@@70))
)))
(assert (forall ((d@@71 T@U) ) (!  (=> (M3.Literal.litArrOfPaths_q d@@71) (exists ((|a#160#0#0| T@U) ) (! (= d@@71 (|#M3.Literal.litArrOfPaths| |a#160#0#0|))
 :qid |CloudMakeParallelBuildsdfy.145:36|
 :skolemid |7122|
)))
 :qid |unknown.0:0|
 :skolemid |7123|
 :pattern ( (M3.Literal.litArrOfPaths_q d@@71))
)))
(assert (forall ((d@@72 T@U) ) (!  (=> (M3.Literal.litArrOfStrings_q d@@72) (exists ((|a#166#0#0| T@U) ) (! (= d@@72 (|#M3.Literal.litArrOfStrings| |a#166#0#0|))
 :qid |CloudMakeParallelBuildsdfy.146:38|
 :skolemid |7131|
)))
 :qid |unknown.0:0|
 :skolemid |7132|
 :pattern ( (M3.Literal.litArrOfStrings_q d@@72))
)))
(assert (forall ((d@@73 T@U) ) (!  (=> (M3.Literal.litArray_q d@@73) (exists ((|a#172#0#0| T@U) ) (! (= d@@73 (|#M3.Literal.litArray| |a#172#0#0|))
 :qid |CloudMakeParallelBuildsdfy.147:31|
 :skolemid |7140|
)))
 :qid |unknown.0:0|
 :skolemid |7141|
 :pattern ( (M3.Literal.litArray_q d@@73))
)))
(assert (forall ((d@@74 T@U) ) (!  (=> ($Is DatatypeTypeType d@@74 Tclass.M3.Expression) (or (or (or (or (or (or (M3.Expression.exprLiteral_q d@@74) (M3.Expression.exprIdentifier_q d@@74)) (M3.Expression.exprIf_q d@@74)) (M3.Expression.exprAnd_q d@@74)) (M3.Expression.exprOr_q d@@74)) (M3.Expression.exprInvocation_q d@@74)) (M3.Expression.exprError_q d@@74)))
 :qid |unknown.0:0|
 :skolemid |7076|
 :pattern ( (M3.Expression.exprError_q d@@74) ($Is DatatypeTypeType d@@74 Tclass.M3.Expression))
 :pattern ( (M3.Expression.exprInvocation_q d@@74) ($Is DatatypeTypeType d@@74 Tclass.M3.Expression))
 :pattern ( (M3.Expression.exprOr_q d@@74) ($Is DatatypeTypeType d@@74 Tclass.M3.Expression))
 :pattern ( (M3.Expression.exprAnd_q d@@74) ($Is DatatypeTypeType d@@74 Tclass.M3.Expression))
 :pattern ( (M3.Expression.exprIf_q d@@74) ($Is DatatypeTypeType d@@74 Tclass.M3.Expression))
 :pattern ( (M3.Expression.exprIdentifier_q d@@74) ($Is DatatypeTypeType d@@74 Tclass.M3.Expression))
 :pattern ( (M3.Expression.exprLiteral_q d@@74) ($Is DatatypeTypeType d@@74 Tclass.M3.Expression))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|p#0@@19| T@U) (|st#0@@25| T@U) ) (!  (=> (or (|M3.__default.GetSt#canCall| (Lit DatatypeTypeType |p#0@@19|) (Lit DatatypeTypeType |st#0@@25|)) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |p#0@@19| Tclass.M3.Path) ($Is DatatypeTypeType |st#0@@25| Tclass.M3.State)) (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@25|))) ($Box DatatypeTypeType (Lit DatatypeTypeType |p#0@@19|)))))) (and (M3.State.StateCons_q (Lit DatatypeTypeType |st#0@@25|)) (= (M3.__default.GetSt (Lit DatatypeTypeType |p#0@@19|) (Lit DatatypeTypeType |st#0@@25|)) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType (M3.State.m (Lit DatatypeTypeType |st#0@@25|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |p#0@@19|)))))))
 :qid |CloudMakeParallelBuildsdfy.10:24|
 :weight 3
 :skolemid |6473|
 :pattern ( (M3.__default.GetSt (Lit DatatypeTypeType |p#0@@19|) (Lit DatatypeTypeType |st#0@@25|)))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|cmd#0@@11| T@U) (|deps#0@@12| T@U) (|exps#0@@7| T@U) (|st#0@@26| T@U) ) (!  (=> (or (|M3.__default.exec#canCall| |cmd#0@@11| |deps#0@@12| |exps#0@@7| |st#0@@26|) (and (< 5 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@11| (TSeq TChar)) ($Is SetType |deps#0@@12| (TSet Tclass.M3.Path))) ($Is SetType |exps#0@@7| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@26| Tclass.M3.State)))) ($Is DatatypeTypeType (M3.__default.exec |cmd#0@@11| |deps#0@@12| |exps#0@@7| |st#0@@26|) (Tclass.M3.Tuple (TSet Tclass.M3.Path) Tclass.M3.State)))
 :qid |CloudMakeParallelBuildsdfy.69:23|
 :skolemid |5819|
 :pattern ( (M3.__default.exec |cmd#0@@11| |deps#0@@12| |exps#0@@7| |st#0@@26|))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@27| T@U) ) (!  (=> (or (|M3.__default.ValidState#canCall| |st#0@@27|) (and (< 4 $FunctionContextHeight) ($Is DatatypeTypeType |st#0@@27| Tclass.M3.State))) (and (forall ((|p#0@@21| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@21| Tclass.M3.Path) (and (|M3.__default.DomSt#canCall| |st#0@@27|) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@27|) ($Box DatatypeTypeType |p#0@@21|)) (|M3.__default.WellFounded#canCall| |p#0@@21|))))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6492|
 :pattern ( (M3.__default.WellFounded |p#0@@21|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@27|) ($Box DatatypeTypeType |p#0@@21|)))
)) (= (M3.__default.ValidState |st#0@@27|) (forall ((|p#0@@22| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@22| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@27|) ($Box DatatypeTypeType |p#0@@22|)) (M3.__default.WellFounded |p#0@@22|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6491|
 :pattern ( (M3.__default.WellFounded |p#0@@22|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@27|) ($Box DatatypeTypeType |p#0@@22|)))
)))))
 :qid |CloudMakeParallelBuildsdfy.13:30|
 :skolemid |6493|
 :pattern ( (M3.__default.ValidState |st#0@@27|))
))))
...
(assert (forall ((d@@75 T@U) ) (!  (=> ($Is DatatypeTypeType d@@75 Tclass.M3.Literal) (or (or (or (or (or (or (or (or (or (M3.Literal.litTrue_q d@@75) (M3.Literal.litFalse_q d@@75)) (M3.Literal.litUndefined_q d@@75)) (M3.Literal.litNull_q d@@75)) (M3.Literal.litNumber_q d@@75)) (M3.Literal.litString_q d@@75)) (M3.Literal.litPrimitive_q d@@75)) (M3.Literal.litArrOfPaths_q d@@75)) (M3.Literal.litArrOfStrings_q d@@75)) (M3.Literal.litArray_q d@@75)))
 :qid |unknown.0:0|
 :skolemid |7150|
 :pattern ( (M3.Literal.litArray_q d@@75) ($Is DatatypeTypeType d@@75 Tclass.M3.Literal))
 :pattern ( (M3.Literal.litArrOfStrings_q d@@75) ($Is DatatypeTypeType d@@75 Tclass.M3.Literal))
 :pattern ( (M3.Literal.litArrOfPaths_q d@@75) ($Is DatatypeTypeType d@@75 Tclass.M3.Literal))
 :pattern ( (M3.Literal.litPrimitive_q d@@75) ($Is DatatypeTypeType d@@75 Tclass.M3.Literal))
 :pattern ( (M3.Literal.litString_q d@@75) ($Is DatatypeTypeType d@@75 Tclass.M3.Literal))
 :pattern ( (M3.Literal.litNumber_q d@@75) ($Is DatatypeTypeType d@@75 Tclass.M3.Literal))
 :pattern ( (M3.Literal.litNull_q d@@75) ($Is DatatypeTypeType d@@75 Tclass.M3.Literal))
 :pattern ( (M3.Literal.litUndefined_q d@@75) ($Is DatatypeTypeType d@@75 Tclass.M3.Literal))
 :pattern ( (M3.Literal.litFalse_q d@@75) ($Is DatatypeTypeType d@@75 Tclass.M3.Literal))
 :pattern ( (M3.Literal.litTrue_q d@@75) ($Is DatatypeTypeType d@@75 Tclass.M3.Literal))
)))
...
(assert (forall ((bx@@12 T@U) ) (!  (=> ($IsBox bx@@12 Tclass.M3.Statement) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@12)) bx@@12) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@12) Tclass.M3.Statement)))
 :qid |unknown.0:0|
 :skolemid |6675|
 :pattern ( ($IsBox bx@@12 Tclass.M3.Statement))
)))
(assert (forall ((bx@@13 T@U) ) (!  (=> ($IsBox bx@@13 Tclass.M3.Reason) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@13)) bx@@13) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@13) Tclass.M3.Reason)))
 :qid |unknown.0:0|
 :skolemid |7068|
 :pattern ( ($IsBox bx@@13 Tclass.M3.Reason))
)))
...
(assert (forall ((|a#35#0#0| T@U) (bx@@14 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#35#0#0|) bx@@14) (< (DtRank ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |a#35#0#0|) bx@@14))) (DtRank (|#M3.Env.EnvCons| |a#35#0#0|))))
 :qid |CloudMakeParallelBuildsdfy.819:26|
 :skolemid |6914|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#35#0#0|) bx@@14) (|#M3.Env.EnvCons| |a#35#0#0|))
)))
(assert (forall ((|a#50#0#0| T@U) (bx@@15 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#50#0#0|) bx@@15) (< (DtRank ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |a#50#0#0|) bx@@15))) (DtRank (|#M3.State.StateCons| |a#50#0#0|))))
 :qid |CloudMakeParallelBuildsdfy.433:30|
 :skolemid |6946|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#50#0#0|) bx@@15) (|#M3.State.StateCons| |a#50#0#0|))
)))
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($ly@@15 T@U) (|stmts#0@@2| T@U) (|st#0@@28| T@U) (|env#0@@11| T@U) ) (!  (=> (or (|M3.__default.do#canCall| |stmts#0@@2| |st#0@@28| |env#0@@11|) (and (< 9 $FunctionContextHeight) (and (and (and ($Is SeqType |stmts#0@@2| (TSeq Tclass.M3.Statement)) ($Is DatatypeTypeType |st#0@@28| Tclass.M3.State)) ($Is DatatypeTypeType |env#0@@11| Tclass.M3.Env)) (and (M3.__default.Legal |stmts#0@@2|) (M3.__default.ValidEnv |env#0@@11|))))) (and (let ((|stmt#0| ($Unbox DatatypeTypeType (|Seq#Index| |stmts#0@@2| (LitInt 0)))))
 (and (=> (M3.Statement.stmtVariable_q |stmt#0|) (and (|M3.__default.eval#canCall| (M3.Statement.expr |stmt#0|) |st#0@@28| |env#0@@11|) (let ((|st'#0@@1| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval ($LS $LZ) (M3.Statement.expr |stmt#0|) |st#0@@28| |env#0@@11|)))))
(let ((|expr'#0| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval ($LS $LZ) (M3.Statement.expr |stmt#0|) |st#0@@28| |env#0@@11|)))))
 ...
 (and (|M3.__default.Legal#canCall| (|Seq#Drop| |stmts#0@@2| (LitInt 1))) (=> (M3.__default.Legal (|Seq#Drop| |stmts#0@@2| (LitInt 1))) (|M3.__default.do#canCall| (|Seq#Drop| |stmts#0@@2| (LitInt 1)) |st'#0@@1| |env'#0|))))))))))) (=> (not (M3.Statement.stmtVariable_q |stmt#0|)) (|M3.__default.eval#canCall| (M3.Statement.ret |stmt#0|) |st#0@@28| |env#0@@11|)))) (= (M3.__default.do ($LS $ly@@15) |stmts#0@@2| |st#0@@28| |env#0@@11|) (let ((|stmt#0@@0| ($Unbox DatatypeTypeType (|Seq#Index| |stmts#0@@2| (LitInt 0)))))
(ite (M3.Statement.stmtVariable_q |stmt#0@@0|) (let ((|st'#0@@2| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval ($LS $LZ) (M3.Statement.expr |stmt#0@@0|) |st#0@@28| |env#0@@11|)))))
(let ((|expr'#0@@0| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval ($LS $LZ) (M3.Statement.expr |stmt#0@@0|) |st#0@@28| |env#0@@11|)))))
(ite (M3.__default.Value |expr'#0@@0|) (let ((|env'#0@@0| (M3.__default.SetEnv (M3.Statement.id |stmt#0@@0|) |expr'#0@@0| |env#0@@11|)))
(ite (M3.__default.Legal (|Seq#Drop| |stmts#0@@2| (LitInt 1))) (M3.__default.do $ly@@15 (|Seq#Drop| |stmts#0@@2| (LitInt 1)) |st'#0@@2| |env'#0@@0|) (|#M3.Tuple.Pair| ($Box DatatypeTypeType |expr'#0@@0|) ($Box DatatypeTypeType |st'#0@@2|)))) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@28|))))) (M3.__default.eval ($LS $LZ) (M3.Statement.ret |stmt#0@@0|) |st#0@@28| |env#0@@11|))))))
 :qid |CloudMakeParallelBuildsdfy.177:18|
 :skolemid |6683|
 :pattern ( (M3.__default.do ($LS $ly@@15) |stmts#0@@2| |st#0@@28| |env#0@@11|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@29| T@U) ) (!  (=> (or (|M3.__default.ValidState#canCall| (Lit DatatypeTypeType |st#0@@29|)) (and (< 4 $FunctionContextHeight) ($Is DatatypeTypeType |st#0@@29| Tclass.M3.State))) (and (forall ((|p#1@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |p#1@@1| Tclass.M3.Path) (and (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@29|)) (=> (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@29|))) ($Box DatatypeTypeType |p#1@@1|)) (|M3.__default.WellFounded#canCall| |p#1@@1|))))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6495|
 :pattern ( (M3.__default.WellFounded |p#1@@1|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@29|) ($Box DatatypeTypeType |p#1@@1|)))
)) (= (M3.__default.ValidState (Lit DatatypeTypeType |st#0@@29|)) (forall ((|p#1@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |p#1@@2| Tclass.M3.Path) (=> (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@29|))) ($Box DatatypeTypeType |p#1@@2|)) (M3.__default.WellFounded |p#1@@2|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6494|
 :pattern ( (M3.__default.WellFounded |p#1@@2|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@29|) ($Box DatatypeTypeType |p#1@@2|)))
)))))
 :qid |CloudMakeParallelBuildsdfy.13:30|
 :weight 3
 :skolemid |6496|
 :pattern ( (M3.__default.ValidState (Lit DatatypeTypeType |st#0@@29|)))
))))
...
(assert (forall ((d@@76 T@U) ) (!  (=> (|$IsA#M3.Path| d@@76) (or (M3.Path.InternalPath_q d@@76) (M3.Path.ExternalPath_q d@@76)))
 :qid |unknown.0:0|
 :skolemid |6900|
 :pattern ( (|$IsA#M3.Path| d@@76))
)))
(assert (forall ((d@@77 T@U) ) (!  (=> (|$IsA#M3.Reason| d@@77) (or (M3.Reason.rCompatibility_q d@@77) (M3.Reason.rValidity_q d@@77)))
 :qid |unknown.0:0|
 :skolemid |7177|
 :pattern ( (|$IsA#M3.Reason| d@@77))
)))
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|p#0@@29| T@U) (|st#0@@30| T@U) ) (!  (=> (or (|M3.__default.Oracle#canCall| |p#0@@29| (Lit DatatypeTypeType |st#0@@30|)) (and (< 5 $FunctionContextHeight) (and ($Is DatatypeTypeType |p#0@@29| Tclass.M3.Path) ($Is DatatypeTypeType |st#0@@30| Tclass.M3.State)))) (and (and (and (|M3.__default.WellFounded#canCall| |p#0@@29|) (=> (M3.__default.WellFounded |p#0@@29|) (and (|M3.__default.GetCert#canCall| |p#0@@29|) (|M3.__default.OracleWF#canCall| |p#0@@29| (M3.__default.GetCert |p#0@@29|) (Lit DatatypeTypeType |st#0@@30|))))) (=> (not (M3.__default.WellFounded |p#0@@29|)) (|M3.__default.OracleArbitrary#canCall| |p#0@@29|))) (= (M3.__default.Oracle |p#0@@29| (Lit DatatypeTypeType |st#0@@30|)) (ite (M3.__default.WellFounded |p#0@@29|) (M3.__default.OracleWF ($LS $LZ) |p#0@@29| (M3.__default.GetCert |p#0@@29|) (Lit DatatypeTypeType |st#0@@30|)) (M3.__default.OracleArbitrary |p#0@@29|)))))
 :qid |CloudMakeParallelBuildsdfy.104:25|
 :weight 3
 :skolemid |6038|
 :pattern ( (M3.__default.Oracle |p#0@@29| (Lit DatatypeTypeType |st#0@@30|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@18 T@U) (|p#0@@30| T@U) (|cert#0@@8| T@U) (|deps#0@@15| T@U) (|st#0@@31| T@U) ) (!  (=> (or (|M3.__default.CollectDependencies#canCall| |p#0@@30| (Lit DatatypeTypeType |cert#0@@8|) |deps#0@@15| |st#0@@31|) (and (< 4 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |p#0@@30| Tclass.M3.Path) ($Is DatatypeTypeType |cert#0@@8| Tclass.M3.WFCertificate)) ($Is SetType |deps#0@@15| (TSet Tclass.M3.Path))) ($Is DatatypeTypeType |st#0@@31| Tclass.M3.State)) (and (M3.__default.CheckWellFounded ($LS $LZ) |p#0@@30| (Lit DatatypeTypeType |cert#0@@8|)) (|Set#Equal| |deps#0@@15| (M3.__default.LocInv__Deps |p#0@@30|)))))) (and (forall ((|d#0@@5| T@U) ) (!  (=> ($Is DatatypeTypeType |d#0@@5| Tclass.M3.Path) (=> (|Set#IsMember| |deps#0@@15| ($Box DatatypeTypeType |d#0@@5|)) (and (and (|M3.__default.DomSt#canCall| |st#0@@31|) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@31|) ($Box DatatypeTypeType |d#0@@5|)) (|M3.__default.GetSt#canCall| |d#0@@5| |st#0@@31|))) (=> (not (|Set#IsMember| (M3.__default.DomSt |st#0@@31|) ($Box DatatypeTypeType |d#0@@5|))) (and (and (M3.WFCertificate.Cert_q (Lit DatatypeTypeType |cert#0@@8|)) (|M3.__default.FindCert#canCall| |d#0@@5| (Lit SetType (M3.WFCertificate.certs (Lit DatatypeTypeType |cert#0@@8|))))) (|M3.__default.OracleWF#canCall| |d#0@@5| (M3.__default.FindCert |d#0@@5| (Lit SetType (M3.WFCertificate.certs (Lit DatatypeTypeType |cert#0@@8|)))) |st#0@@31|))))))
 :qid |CloudMakeParallelBuildsdfy.664:9|
 :skolemid |6084|
 :pattern ( (M3.__default.FindCert |d#0@@5| (M3.WFCertificate.certs |cert#0@@8|)))
 :pattern ( (M3.__default.GetSt |d#0@@5| |st#0@@31|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@31|) ($Box DatatypeTypeType |d#0@@5|)))
 :pattern ( (|Set#IsMember| |deps#0@@15| ($Box DatatypeTypeType |d#0@@5|)))
)) (= (M3.__default.CollectDependencies ($LS $ly@@18) |p#0@@30| (Lit DatatypeTypeType |cert#0@@8|) |deps#0@@15| |st#0@@31|) (|Map#Glue| (|Set#FromBoogieMap| (|lambda#0| Tclass.M3.Path |deps#0@@15|)) (|lambda#26| (M3.__default.DomSt |st#0@@31|) |st#0@@31| ($LS $ly@@18) (Lit SetType (M3.WFCertificate.certs (Lit DatatypeTypeType |cert#0@@8|))) |st#0@@31|) (TMap Tclass.M3.Path Tclass.M3.Artifact)))))
 :qid |CloudMakeParallelBuildsdfy.660:18|
 :weight 3
 :skolemid |6085|
 :pattern ( (M3.__default.CollectDependencies ($LS $ly@@18) |p#0@@30| (Lit DatatypeTypeType |cert#0@@8|) |deps#0@@15| |st#0@@31|))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($ly@@19 T@U) (|expr#0@@4| T@U) (|st#0@@32| T@U) (|env#0@@14| T@U) ) (!  (=> (or (|M3.__default.eval#canCall| |expr#0@@4| |st#0@@32| |env#0@@14|) (and (< 8 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0@@4| Tclass.M3.Expression) ($Is DatatypeTypeType |st#0@@32| Tclass.M3.State)) ($Is DatatypeTypeType |env#0@@14| Tclass.M3.Env)) (M3.__default.ValidEnv |env#0@@14|)))) (and (and (|M3.__default.Value#canCall| |expr#0@@4|) (=> (not (M3.__default.Value |expr#0@@4|)) (and (=> (M3.Expression.exprIdentifier_q |expr#0@@4|) (|M3.__default.GetEnv#canCall| (M3.Expression.id |expr#0@@4|) |env#0@@14|)) (=> (not (M3.Expression.exprIdentifier_q |expr#0@@4|)) (and (=> (M3.Expression.exprIf_q |expr#0@@4|) (and (|M3.__default.eval#canCall| (M3.Expression.cond |expr#0@@4|) |st#0@@32| |env#0@@14|) (let ((|st'#0@@3| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval $ly@@19 (M3.Expression.cond |expr#0@@4|) |st#0@@32| |env#0@@14|)))))
(let ((|cond'#0| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval $ly@@19 (M3.Expression.cond |expr#0@@4|) |st#0@@32| |env#0@@14|)))))
 (and (and (=> (M3.Expression.exprLiteral_q |cond'#0|) (|$IsA#M3.Literal| (M3.Expression.lit |cond'#0|))) (=> (and (M3.Expression.exprLiteral_q |cond'#0|) (|M3.Literal#Equal| (M3.Expression.lit |cond'#0|) |#M3.Literal.litTrue|)) (|M3.__default.eval#canCall| (M3.Expression.ifTrue |expr#0@@4|) |st'#0@@3| |env#0@@14|))) (=> (not (and (M3.Expression.exprLiteral_q |cond'#0|) (|M3.Literal#Equal| (M3.Expression.lit |cond'#0|) |#M3.Literal.litTrue|))) (and (=> (M3.Expression.exprLiteral_q |cond'#0|) (|$IsA#M3.Literal| (M3.Expression.lit |cond'#0|))) (=> (and (M3.Expression.exprLiteral_q |cond'#0|) (|M3.Literal#Equal| (M3.Expression.lit |cond'#0|) |#M3.Literal.litFalse|)) (|M3.__default.eval#canCall| (M3.Expression.ifFalse |expr#0@@4|) |st'#0@@3| |env#0@@14|))))))))) (=> (not (M3.Expression.exprIf_q |expr#0@@4|)) (and (=> (M3.Expression.exprAnd_q |expr#0@@4|) (and (|M3.__default.eval#canCall| (M3.Expression.conj0 |expr#0@@4|) |st#0@@32| |env#0@@14|) (let ((|st'#1@@1| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval $ly@@19 (M3.Expression.conj0 |expr#0@@4|) |st#0@@32| |env#0@@14|)))))
(let ((|conj0'#0| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval $ly@@19 (M3.Expression.conj0 |expr#0@@4|) |st#0@@32| |env#0@@14|)))))
 (and (and (=> (M3.Expression.exprLiteral_q |conj0'#0|) (|$IsA#M3.Literal| (M3.Expression.lit |conj0'#0|))) (=> (and (M3.Expression.exprLiteral_q |conj0'#0|) (|M3.Literal#Equal| (M3.Expression.lit |conj0'#0|) |#M3.Literal.litTrue|)) (|M3.__default.eval#canCall| (M3.Expression.conj1 |expr#0@@4|) |st'#1@@1| |env#0@@14|))) (=> (not (and (M3.Expression.exprLiteral_q |conj0'#0|) (|M3.Literal#Equal| (M3.Expression.lit |conj0'#0|) |#M3.Literal.litTrue|))) (=> (M3.Expression.exprLiteral_q |conj0'#0|) (|$IsA#M3.Literal| (M3.Expression.lit |conj0'#0|))))))))) (=> (not (M3.Expression.exprAnd_q |expr#0@@4|)) (and (=> (M3.Expression.exprOr_q |expr#0@@4|) (and (|M3.__default.eval#canCall| (M3.Expression.disj0 |expr#0@@4|) |st#0@@32| |env#0@@14|) (let ((|st'#2@@1| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval $ly@@19 (M3.Expression.disj0 |expr#0@@4|) |st#0@@32| |env#0@@14|)))))
(let ((|disj0'#0| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval $ly@@19 (M3.Expression.disj0 |expr#0@@4|) |st#0@@32| |env#0@@14|)))))
 (and (=> (M3.Expression.exprLiteral_q |disj0'#0|) (|$IsA#M3.Literal| (M3.Expression.lit |disj0'#0|))) (=> (not (and (M3.Expression.exprLiteral_q |disj0'#0|) (|M3.Literal#Equal| (M3.Expression.lit |disj0'#0|) |#M3.Literal.litTrue|))) (and (=> (M3.Expression.exprLiteral_q |disj0'#0|) (|$IsA#M3.Literal| (M3.Expression.lit |disj0'#0|))) (=> (and (M3.Expression.exprLiteral_q |disj0'#0|) (|M3.Literal#Equal| (M3.Expression.lit |disj0'#0|) |#M3.Literal.litFalse|)) (|M3.__default.eval#canCall| (M3.Expression.disj1 |expr#0@@4|) |st'#2@@1| |env#0@@14|))))))))) (=> (not (M3.Expression.exprOr_q |expr#0@@4|)) (=> (M3.Expression.exprInvocation_q |expr#0@@4|) (and (|M3.__default.eval#canCall| (M3.Expression.fun |expr#0@@4|) |st#0@@32| |env#0@@14|) (let ((|st'#3| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval $ly@@19 (M3.Expression.fun |expr#0@@4|) |st#0@@32| |env#0@@14|)))))
(let ((|fun'#0| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval $ly@@19 (M3.Expression.fun |expr#0@@4|) |st#0@@32| |env#0@@14|)))))
 (and (|M3.__default.evalArgs#canCall| |expr#0@@4| (M3.Expression.args |expr#0@@4|) |st#0@@32| |env#0@@14|) (let ((|sts'#0| ($Unbox SetType (M3.Tuple.snd (M3.__default.evalArgs $ly@@19 |expr#0@@4| (M3.Expression.args |expr#0@@4|) |st#0@@32| |env#0@@14|)))))
(let ((|args'#0| ($Unbox SeqType (M3.Tuple.fst (M3.__default.evalArgs $ly@@19 |expr#0@@4| (M3.Expression.args |expr#0@@4|) |st#0@@32| |env#0@@14|)))))
(let ((|sts''#0| (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |st'#3|)) |sts'#0|)))
 ...
 (and (M3.Tuple.Pair_q |ps#0|) (M3.Tuple.Pair_q |ps#0|)))))))))))))))))))))))))))))) (= (M3.__default.eval ($LS $ly@@19) |expr#0@@4| |st#0@@32| |env#0@@14|) (ite (M3.__default.Value |expr#0@@4|) (|#M3.Tuple.Pair| ($Box DatatypeTypeType |expr#0@@4|) ($Box DatatypeTypeType |st#0@@32|)) (ite (M3.Expression.exprIdentifier_q |expr#0@@4|) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (M3.__default.GetEnv (M3.Expression.id |expr#0@@4|) |env#0@@14|)) ($Box DatatypeTypeType |st#0@@32|)) (ite (M3.Expression.exprIf_q |expr#0@@4|) (let ((|st'#0@@4| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval $ly@@19 (M3.Expression.cond |expr#0@@4|) |st#0@@32| |env#0@@14|)))))
(let ((|cond'#0@@0| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval $ly@@19 (M3.Expression.cond |expr#0@@4|) |st#0@@32| |env#0@@14|)))))
(ite  (and (M3.Expression.exprLiteral_q |cond'#0@@0|) (|M3.Literal#Equal| (M3.Expression.lit |cond'#0@@0|) |#M3.Literal.litTrue|)) (M3.__default.eval $ly@@19 (M3.Expression.ifTrue |expr#0@@4|) |st'#0@@4| |env#0@@14|) (ite  (and (M3.Expression.exprLiteral_q |cond'#0@@0|) (|M3.Literal#Equal| (M3.Expression.lit |cond'#0@@0|) |#M3.Literal.litFalse|)) (M3.__default.eval $ly@@19 (M3.Expression.ifFalse |expr#0@@4|) |st'#0@@4| |env#0@@14|) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@32|)))))) (ite (M3.Expression.exprAnd_q |expr#0@@4|) (let ((|st'#1@@2| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval $ly@@19 (M3.Expression.conj0 |expr#0@@4|) |st#0@@32| |env#0@@14|)))))
(let ((|conj0'#0@@0| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval $ly@@19 (M3.Expression.conj0 |expr#0@@4|) |st#0@@32| |env#0@@14|)))))
(ite  (and (M3.Expression.exprLiteral_q |conj0'#0@@0|) (|M3.Literal#Equal| (M3.Expression.lit |conj0'#0@@0|) |#M3.Literal.litTrue|)) (M3.__default.eval $ly@@19 (M3.Expression.conj1 |expr#0@@4|) |st'#1@@2| |env#0@@14|) (ite  (and (M3.Expression.exprLiteral_q |conj0'#0@@0|) (|M3.Literal#Equal| (M3.Expression.lit |conj0'#0@@0|) |#M3.Literal.litFalse|)) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprLiteral| (Lit DatatypeTypeType |#M3.Literal.litFalse|)))) ($Box DatatypeTypeType |st'#1@@2|)) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@32|)))))) (ite (M3.Expression.exprOr_q |expr#0@@4|) (let ((|st'#2@@2| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval $ly@@19 (M3.Expression.disj0 |expr#0@@4|) |st#0@@32| |env#0@@14|)))))
(let ((|disj0'#0@@0| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval $ly@@19 (M3.Expression.disj0 |expr#0@@4|) |st#0@@32| |env#0@@14|)))))
(ite  (and (M3.Expression.exprLiteral_q |disj0'#0@@0|) (|M3.Literal#Equal| (M3.Expression.lit |disj0'#0@@0|) |#M3.Literal.litTrue|)) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprLiteral| (Lit DatatypeTypeType |#M3.Literal.litTrue|)))) ($Box DatatypeTypeType |st'#2@@2|)) (ite  (and (M3.Expression.exprLiteral_q |disj0'#0@@0|) (|M3.Literal#Equal| (M3.Expression.lit |disj0'#0@@0|) |#M3.Literal.litFalse|)) (M3.__default.eval $ly@@19 (M3.Expression.disj1 |expr#0@@4|) |st'#2@@2| |env#0@@14|) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@32|)))))) (ite (M3.Expression.exprInvocation_q |expr#0@@4|) (let ((|st'#3@@0| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval $ly@@19 (M3.Expression.fun |expr#0@@4|) |st#0@@32| |env#0@@14|)))))
(let ((|fun'#0@@0| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval $ly@@19 (M3.Expression.fun |expr#0@@4|) |st#0@@32| |env#0@@14|)))))
(let ((|sts'#0@@0| ($Unbox SetType (M3.Tuple.snd (M3.__default.evalArgs $ly@@19 |expr#0@@4| (M3.Expression.args |expr#0@@4|) |st#0@@32| |env#0@@14|)))))
(let ((|args'#0@@0| ($Unbox SeqType (M3.Tuple.fst (M3.__default.evalArgs $ly@@19 |expr#0@@4| (M3.Expression.args |expr#0@@4|) |st#0@@32| |env#0@@14|)))))
(let ((|sts''#0@@0| (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |st'#3@@0|)) |sts'#0@@0|)))
(ite  (not (M3.__default.Compatible |sts''#0@@0|)) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rCompatibility|)))) ($Box DatatypeTypeType |st#0@@32|)) (let ((|stCombined#0@@0| (M3.__default.Combine ($LS $LZ) |sts''#0@@0|)))
...
(|#M3.Tuple.Pair| ($Box DatatypeTypeType (|#M3.Expression.exprLiteral| (|#M3.Literal.litArrOfPaths| ($Unbox SetType (M3.Tuple.fst |ps#0@@0|))))) (M3.Tuple.snd |ps#0@@0|))) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@32|))) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@32|))) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@32|)))))))))) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@32|)))))))))))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |6702|
 :pattern ( (M3.__default.eval ($LS $ly@@19) |expr#0@@4| |st#0@@32| |env#0@@14|))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@20 T@U) (|p#0@@31| T@U) (|cert#0@@9| T@U) (|deps#0@@16| T@U) (|st#0@@33| T@U) ) (!  (=> (or (|M3.__default.CollectDependencies#canCall| |p#0@@31| |cert#0@@9| |deps#0@@16| |st#0@@33|) (and (< 4 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |p#0@@31| Tclass.M3.Path) ($Is DatatypeTypeType |cert#0@@9| Tclass.M3.WFCertificate)) ($Is SetType |deps#0@@16| (TSet Tclass.M3.Path))) ($Is DatatypeTypeType |st#0@@33| Tclass.M3.State)) (and (M3.__default.CheckWellFounded ($LS $LZ) |p#0@@31| |cert#0@@9|) (|Set#Equal| |deps#0@@16| (M3.__default.LocInv__Deps |p#0@@31|)))))) (and (forall ((|d#0@@6| T@U) ) (!  (=> ($Is DatatypeTypeType |d#0@@6| Tclass.M3.Path) (=> (|Set#IsMember| |deps#0@@16| ($Box DatatypeTypeType |d#0@@6|)) (and (and (|M3.__default.DomSt#canCall| |st#0@@33|) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@33|) ($Box DatatypeTypeType |d#0@@6|)) (|M3.__default.GetSt#canCall| |d#0@@6| |st#0@@33|))) (=> (not (|Set#IsMember| (M3.__default.DomSt |st#0@@33|) ($Box DatatypeTypeType |d#0@@6|))) (and (and (M3.WFCertificate.Cert_q |cert#0@@9|) (|M3.__default.FindCert#canCall| |d#0@@6| (M3.WFCertificate.certs |cert#0@@9|))) (|M3.__default.OracleWF#canCall| |d#0@@6| (M3.__default.FindCert |d#0@@6| (M3.WFCertificate.certs |cert#0@@9|)) |st#0@@33|))))))
 :qid |CloudMakeParallelBuildsdfy.664:9|
 :skolemid |6082|
 :pattern ( (M3.__default.FindCert |d#0@@6| (M3.WFCertificate.certs |cert#0@@9|)))
 :pattern ( (M3.__default.GetSt |d#0@@6| |st#0@@33|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@33|) ($Box DatatypeTypeType |d#0@@6|)))
 :pattern ( (|Set#IsMember| |deps#0@@16| ($Box DatatypeTypeType |d#0@@6|)))
)) (= (M3.__default.CollectDependencies ($LS $ly@@20) |p#0@@31| |cert#0@@9| |deps#0@@16| |st#0@@33|) (|Map#Glue| (|Set#FromBoogieMap| (|lambda#0| Tclass.M3.Path |deps#0@@16|)) (|lambda#26| (M3.__default.DomSt |st#0@@33|) |st#0@@33| $ly@@20 (M3.WFCertificate.certs |cert#0@@9|) |st#0@@33|) (TMap Tclass.M3.Path Tclass.M3.Artifact)))))
 :qid |CloudMakeParallelBuildsdfy.660:18|
 :skolemid |6083|
 :pattern ( (M3.__default.CollectDependencies ($LS $ly@@20) |p#0@@31| |cert#0@@9| |deps#0@@16| |st#0@@33|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|p#0@@32| T@U) (|a#0@@1| T@U) (|st#0@@34| T@U) ) (!  (=> (or (|M3.__default.SetSt#canCall| |p#0@@32| |a#0@@1| |st#0@@34|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |p#0@@32| Tclass.M3.Path) ($Is DatatypeTypeType |a#0@@1| Tclass.M3.Artifact)) ($Is DatatypeTypeType |st#0@@34| Tclass.M3.State)))) ($Is DatatypeTypeType (M3.__default.SetSt |p#0@@32| |a#0@@1| |st#0@@34|) Tclass.M3.State))
 :qid |CloudMakeParallelBuildsdfy.468:24|
 :skolemid |5727|
 :pattern ( (M3.__default.SetSt |p#0@@32| |a#0@@1| |st#0@@34|))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@21 T@U) (|p#0@@33| T@U) (|cert#0@@10| T@U) (|st#0@@35| T@U) ) (!  (=> (or (|M3.__default.OracleWF#canCall| (Lit DatatypeTypeType |p#0@@33|) (Lit DatatypeTypeType |cert#0@@10|) (Lit DatatypeTypeType |st#0@@35|)) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |p#0@@33| Tclass.M3.Path) ($Is DatatypeTypeType |cert#0@@10| Tclass.M3.WFCertificate)) ($Is DatatypeTypeType |st#0@@35| Tclass.M3.State)) (U_2_bool (Lit boolType (bool_2_U (M3.__default.CheckWellFounded ($LS $LZ) (Lit DatatypeTypeType |p#0@@33|) (Lit DatatypeTypeType |cert#0@@10|)))))))) (and (and (and (and (|M3.__default.LocInv__Cmd#canCall| (Lit DatatypeTypeType |p#0@@33|)) (|M3.__default.LocInv__Deps#canCall| (Lit DatatypeTypeType |p#0@@33|))) (|M3.__default.LocInv__Exp#canCall| (Lit DatatypeTypeType |p#0@@33|))) (let ((|e#2@@1| (Lit SeqType (M3.__default.LocInv__Exp (Lit DatatypeTypeType |p#0@@33|)))))
...
(let ((|cmd#2| (Lit SeqType (M3.__default.LocInv__Cmd (Lit DatatypeTypeType |p#0@@33|)))))
 (and (|M3.__default.CollectDependencies#canCall| (Lit DatatypeTypeType |p#0@@33|) (Lit DatatypeTypeType |cert#0@@10|) |deps#2| (Lit DatatypeTypeType |st#0@@35|)) (|M3.__default.RunTool#canCall| |cmd#2| (M3.__default.CollectDependencies ($LS $ly@@21) (Lit DatatypeTypeType |p#0@@33|) (Lit DatatypeTypeType |cert#0@@10|) |deps#2| (Lit DatatypeTypeType |st#0@@35|)) |e#2@@1|)))))) (= (M3.__default.OracleWF ($LS $ly@@21) (Lit DatatypeTypeType |p#0@@33|) (Lit DatatypeTypeType |cert#0@@10|) (Lit DatatypeTypeType |st#0@@35|)) (let ((|e#2@@2| (Lit SeqType (M3.__default.LocInv__Exp (Lit DatatypeTypeType |p#0@@33|)))))
...
(M3.__default.RunTool |cmd#2@@0| (M3.__default.CollectDependencies ($LS $ly@@21) (Lit DatatypeTypeType |p#0@@33|) (Lit DatatypeTypeType |cert#0@@10|) |deps#2@@0| (Lit DatatypeTypeType |st#0@@35|)) |e#2@@2|)))))))
 :qid |CloudMakeParallelBuildsdfy.653:18|
 :weight 3
 :skolemid |6064|
 :pattern ( (M3.__default.OracleWF ($LS $ly@@21) (Lit DatatypeTypeType |p#0@@33|) (Lit DatatypeTypeType |cert#0@@10|) (Lit DatatypeTypeType |st#0@@35|)))
))))
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($ly@@22 T@U) (|stmts#0@@3| T@U) (|st#0@@36| T@U) (|env#0@@15| T@U) ) (!  (=> (or (|M3.__default.do#canCall| (Lit SeqType |stmts#0@@3|) |st#0@@36| |env#0@@15|) (and (< 9 $FunctionContextHeight) (and (and (and ($Is SeqType |stmts#0@@3| (TSeq Tclass.M3.Statement)) ($Is DatatypeTypeType |st#0@@36| Tclass.M3.State)) ($Is DatatypeTypeType |env#0@@15| Tclass.M3.Env)) (and (M3.__default.Legal (Lit SeqType |stmts#0@@3|)) (M3.__default.ValidEnv |env#0@@15|))))) (and (let ((|stmt#1| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |stmts#0@@3|) (LitInt 0)))))
 (and (=> (M3.Statement.stmtVariable_q |stmt#1|) (and (|M3.__default.eval#canCall| (M3.Statement.expr |stmt#1|) |st#0@@36| |env#0@@15|) (let ((|st'#1@@3| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval ($LS $LZ) (M3.Statement.expr |stmt#1|) |st#0@@36| |env#0@@15|)))))
(let ((|expr'#1| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval ($LS $LZ) (M3.Statement.expr |stmt#1|) |st#0@@36| |env#0@@15|)))))
 ...
 (and (|M3.__default.Legal#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@3|) (LitInt 1)))) (=> (U_2_bool (Lit boolType (bool_2_U (M3.__default.Legal (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@3|) (LitInt 1))))))) (|M3.__default.do#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@3|) (LitInt 1))) |st'#1@@3| |env'#1|))))))))))) (=> (not (M3.Statement.stmtVariable_q |stmt#1|)) (|M3.__default.eval#canCall| (M3.Statement.ret |stmt#1|) |st#0@@36| |env#0@@15|)))) (= (M3.__default.do ($LS $ly@@22) (Lit SeqType |stmts#0@@3|) |st#0@@36| |env#0@@15|) (let ((|stmt#1@@0| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |stmts#0@@3|) (LitInt 0)))))
(ite (M3.Statement.stmtVariable_q |stmt#1@@0|) (let ((|st'#1@@4| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval ($LS $LZ) (M3.Statement.expr |stmt#1@@0|) |st#0@@36| |env#0@@15|)))))
(let ((|expr'#1@@0| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval ($LS $LZ) (M3.Statement.expr |stmt#1@@0|) |st#0@@36| |env#0@@15|)))))
(ite (M3.__default.Value |expr'#1@@0|) (let ((|env'#1@@0| (M3.__default.SetEnv (M3.Statement.id |stmt#1@@0|) |expr'#1@@0| |env#0@@15|)))
(ite (M3.__default.Legal (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@3|) (LitInt 1)))) (M3.__default.do ($LS $ly@@22) (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@3|) (LitInt 1))) |st'#1@@4| |env'#1@@0|) (|#M3.Tuple.Pair| ($Box DatatypeTypeType |expr'#1@@0|) ($Box DatatypeTypeType |st'#1@@4|)))) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@36|))))) (M3.__default.eval ($LS $LZ) (M3.Statement.ret |stmt#1@@0|) |st#0@@36| |env#0@@15|))))))
 :qid |CloudMakeParallelBuildsdfy.177:18|
 :weight 3
 :skolemid |6684|
 :pattern ( (M3.__default.do ($LS $ly@@22) (Lit SeqType |stmts#0@@3|) |st#0@@36| |env#0@@15|))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|cmd#0@@15| T@U) (|deps#0@@18| T@U) (|exps#0@@8| T@U) (|st#0@@37| T@U) ) (!  (=> (or (|M3.__default.exec#canCall| |cmd#0@@15| |deps#0@@18| |exps#0@@8| |st#0@@37|) (and (< 5 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@15| (TSeq TChar)) ($Is SetType |deps#0@@18| (TSet Tclass.M3.Path))) ($Is SetType |exps#0@@8| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@37| Tclass.M3.State)))) (and (and (|M3.__default.Restrict#canCall| |deps#0@@18| |st#0@@37|) (|M3.__default.execOne#canCall| |cmd#0@@15| |deps#0@@18| (M3.__default.Restrict |deps#0@@18| |st#0@@37|) |exps#0@@8| |st#0@@37|)) (= (M3.__default.exec |cmd#0@@15| |deps#0@@18| |exps#0@@8| |st#0@@37|) (M3.__default.execOne ($LS $LZ) |cmd#0@@15| |deps#0@@18| (M3.__default.Restrict |deps#0@@18| |st#0@@37|) |exps#0@@8| |st#0@@37|))))
 :qid |CloudMakeParallelBuildsdfy.69:23|
 :skolemid |5821|
 :pattern ( (M3.__default.exec |cmd#0@@15| |deps#0@@18| |exps#0@@8| |st#0@@37|))
))))
...
(assert (forall ((d@@78 T@U) ) (!  (=> ($Is DatatypeTypeType d@@78 Tclass.M3.Path) (or (M3.Path.InternalPath_q d@@78) (M3.Path.ExternalPath_q d@@78)))
 :qid |unknown.0:0|
 :skolemid |6901|
 :pattern ( (M3.Path.ExternalPath_q d@@78) ($Is DatatypeTypeType d@@78 Tclass.M3.Path))
 :pattern ( (M3.Path.InternalPath_q d@@78) ($Is DatatypeTypeType d@@78 Tclass.M3.Path))
)))
(assert (forall ((d@@79 T@U) ) (!  (=> ($Is DatatypeTypeType d@@79 Tclass.M3.Statement) (or (M3.Statement.stmtVariable_q d@@79) (M3.Statement.stmtReturn_q d@@79)))
 :qid |unknown.0:0|
 :skolemid |6990|
 :pattern ( (M3.Statement.stmtReturn_q d@@79) ($Is DatatypeTypeType d@@79 Tclass.M3.Statement))
 :pattern ( (M3.Statement.stmtVariable_q d@@79) ($Is DatatypeTypeType d@@79 Tclass.M3.Statement))
)))
(assert (forall ((d@@80 T@U) ) (!  (=> ($Is DatatypeTypeType d@@80 Tclass.M3.Primitive) (or (M3.Primitive.primCreatePath_q d@@80) (M3.Primitive.primExec_q d@@80)))
 :qid |unknown.0:0|
 :skolemid |7168|
 :pattern ( (M3.Primitive.primExec_q d@@80) ($Is DatatypeTypeType d@@80 Tclass.M3.Primitive))
 :pattern ( (M3.Primitive.primCreatePath_q d@@80) ($Is DatatypeTypeType d@@80 Tclass.M3.Primitive))
)))
(assert (forall ((d@@81 T@U) ) (!  (=> ($Is DatatypeTypeType d@@81 Tclass.M3.Reason) (or (M3.Reason.rCompatibility_q d@@81) (M3.Reason.rValidity_q d@@81)))
 :qid |unknown.0:0|
 :skolemid |7178|
 :pattern ( (M3.Reason.rValidity_q d@@81) ($Is DatatypeTypeType d@@81 Tclass.M3.Reason))
 :pattern ( (M3.Reason.rCompatibility_q d@@81) ($Is DatatypeTypeType d@@81 Tclass.M3.Reason))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|p#0@@36| T@U) (|a#0@@2| T@U) (|st#0@@38| T@U) ) (!  (=> (or (|M3.__default.SetSt#canCall| (Lit DatatypeTypeType |p#0@@36|) (Lit DatatypeTypeType |a#0@@2|) (Lit DatatypeTypeType |st#0@@38|)) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |p#0@@36| Tclass.M3.Path) ($Is DatatypeTypeType |a#0@@2| Tclass.M3.Artifact)) ($Is DatatypeTypeType |st#0@@38| Tclass.M3.State)))) (and (M3.State.StateCons_q (Lit DatatypeTypeType |st#0@@38|)) (= (M3.__default.SetSt (Lit DatatypeTypeType |p#0@@36|) (Lit DatatypeTypeType |a#0@@2|) (Lit DatatypeTypeType |st#0@@38|)) (|#M3.State.StateCons| (|Map#Build| (Lit MapType (M3.State.m (Lit DatatypeTypeType |st#0@@38|))) ($Box DatatypeTypeType (Lit DatatypeTypeType |p#0@@36|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |a#0@@2|)))))))
 :qid |CloudMakeParallelBuildsdfy.468:24|
 :weight 3
 :skolemid |5731|
 :pattern ( (M3.__default.SetSt (Lit DatatypeTypeType |p#0@@36|) (Lit DatatypeTypeType |a#0@@2|) (Lit DatatypeTypeType |st#0@@38|)))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($ly@@23 T@U) (|expr#0@@5| T@U) (|st#0@@39| T@U) (|env#0@@16| T@U) ) (!  (=> (or (|M3.__default.eval#canCall| |expr#0@@5| |st#0@@39| |env#0@@16|) (and (< 8 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0@@5| Tclass.M3.Expression) ($Is DatatypeTypeType |st#0@@39| Tclass.M3.State)) ($Is DatatypeTypeType |env#0@@16| Tclass.M3.Env)) (M3.__default.ValidEnv |env#0@@16|)))) ($Is DatatypeTypeType (M3.__default.eval $ly@@23 |expr#0@@5| |st#0@@39| |env#0@@16|) (Tclass.M3.Tuple Tclass.M3.Expression Tclass.M3.State)))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |6700|
 :pattern ( (M3.__default.eval $ly@@23 |expr#0@@5| |st#0@@39| |env#0@@16|))
))))
...
(assert (forall ((bx@@17 T@U) ) (!  (=> ($IsBox bx@@17 TChar) (and (= ($Box charType ($Unbox charType bx@@17)) bx@@17) ($Is charType ($Unbox charType bx@@17) TChar)))
 :qid |DafnyPreludebpl.185:15|
 :skolemid |4985|
 :pattern ( ($IsBox bx@@17 TChar))
)))
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($ly@@24 T@U) (|stmts#0@@4| T@U) (|st#0@@40| T@U) (|env#0@@17| T@U) ) (!  (=> (or (|M3.__default.do#canCall| |stmts#0@@4| |st#0@@40| |env#0@@17|) (and (< 9 $FunctionContextHeight) (and (and (and ($Is SeqType |stmts#0@@4| (TSeq Tclass.M3.Statement)) ($Is DatatypeTypeType |st#0@@40| Tclass.M3.State)) ($Is DatatypeTypeType |env#0@@17| Tclass.M3.Env)) (and (M3.__default.Legal |stmts#0@@4|) (M3.__default.ValidEnv |env#0@@17|))))) ($Is DatatypeTypeType (M3.__default.do $ly@@24 |stmts#0@@4| |st#0@@40| |env#0@@17|) (Tclass.M3.Tuple Tclass.M3.Expression Tclass.M3.State)))
 :qid |CloudMakeParallelBuildsdfy.177:18|
 :skolemid |6681|
 :pattern ( (M3.__default.do $ly@@24 |stmts#0@@4| |st#0@@40| |env#0@@17|))
))))
(assert  (=> (<= 6 $FunctionContextHeight) (forall ((|st#0@@41| T@U) (|st'#0@@5| T@U) ) (!  (=> (or (|M3.__default.Extends#canCall| |st#0@@41| |st'#0@@5|) (and (< 6 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@41| Tclass.M3.State) ($Is DatatypeTypeType |st'#0@@5| Tclass.M3.State)))) (and (and (and (|M3.__default.DomSt#canCall| |st#0@@41|) (|M3.__default.DomSt#canCall| |st'#0@@5|)) (=> (|Set#Subset| (M3.__default.DomSt |st#0@@41|) (M3.__default.DomSt |st'#0@@5|)) (and (forall ((|p#0@@37| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@37| Tclass.M3.Path) (and (|M3.__default.DomSt#canCall| |st#0@@41|) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@41|) ($Box DatatypeTypeType |p#0@@37|)) (and (and (|$IsA#M3.Artifact| (M3.__default.GetSt |p#0@@37| |st'#0@@5|)) (|$IsA#M3.Artifact| (M3.__default.GetSt |p#0@@37| |st#0@@41|))) (and (|M3.__default.GetSt#canCall| |p#0@@37| |st'#0@@5|) (|M3.__default.GetSt#canCall| |p#0@@37| |st#0@@41|))))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6613|
 :pattern ( (M3.__default.GetSt |p#0@@37| |st#0@@41|))
 :pattern ( (M3.__default.GetSt |p#0@@37| |st'#0@@5|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@41|) ($Box DatatypeTypeType |p#0@@37|)))
)) (=> (forall ((|p#0@@38| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@38| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@41|) ($Box DatatypeTypeType |p#0@@38|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#0@@38| |st'#0@@5|) (M3.__default.GetSt |p#0@@38| |st#0@@41|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6615|
 :pattern ( (M3.__default.GetSt |p#0@@38| |st#0@@41|))
 :pattern ( (M3.__default.GetSt |p#0@@38| |st'#0@@5|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@41|) ($Box DatatypeTypeType |p#0@@38|)))
)) (forall ((|p#1@@3| T@U) ) (!  (=> ($Is DatatypeTypeType |p#1@@3| Tclass.M3.Path) (and (|M3.__default.DomSt#canCall| |st#0@@41|) (=> (not (|Set#IsMember| (M3.__default.DomSt |st#0@@41|) ($Box DatatypeTypeType |p#1@@3|))) (and (|M3.__default.DomSt#canCall| |st'#0@@5|) (=> (|Set#IsMember| (M3.__default.DomSt |st'#0@@5|) ($Box DatatypeTypeType |p#1@@3|)) (and (and (|$IsA#M3.Artifact| (M3.__default.GetSt |p#1@@3| |st'#0@@5|)) (|$IsA#M3.Artifact| (M3.__default.Oracle |p#1@@3| |st#0@@41|))) (and (|M3.__default.GetSt#canCall| |p#1@@3| |st'#0@@5|) (|M3.__default.Oracle#canCall| |p#1@@3| |st#0@@41|))))))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |6614|
 :pattern ( (M3.__default.Oracle |p#1@@3| |st#0@@41|))
 :pattern ( (M3.__default.GetSt |p#1@@3| |st'#0@@5|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@5|) ($Box DatatypeTypeType |p#1@@3|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@41|) ($Box DatatypeTypeType |p#1@@3|)))
)))))) (= (M3.__default.Extends |st#0@@41| |st'#0@@5|)  (and (and (|Set#Subset| (M3.__default.DomSt |st#0@@41|) (M3.__default.DomSt |st'#0@@5|)) (forall ((|p#0@@39| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@39| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@41|) ($Box DatatypeTypeType |p#0@@39|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#0@@39| |st'#0@@5|) (M3.__default.GetSt |p#0@@39| |st#0@@41|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6611|
 :pattern ( (M3.__default.GetSt |p#0@@39| |st#0@@41|))
 :pattern ( (M3.__default.GetSt |p#0@@39| |st'#0@@5|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@41|) ($Box DatatypeTypeType |p#0@@39|)))
))) (forall ((|p#1@@4| T@U) ) (!  (=> ($Is DatatypeTypeType |p#1@@4| Tclass.M3.Path) (=> (and (not (|Set#IsMember| (M3.__default.DomSt |st#0@@41|) ($Box DatatypeTypeType |p#1@@4|))) (|Set#IsMember| (M3.__default.DomSt |st'#0@@5|) ($Box DatatypeTypeType |p#1@@4|))) (|M3.Artifact#Equal| (M3.__default.GetSt |p#1@@4| |st'#0@@5|) (M3.__default.Oracle |p#1@@4| |st#0@@41|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |6612|
 :pattern ( (M3.__default.Oracle |p#1@@4| |st#0@@41|))
 :pattern ( (M3.__default.GetSt |p#1@@4| |st'#0@@5|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@5|) ($Box DatatypeTypeType |p#1@@4|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@41|) ($Box DatatypeTypeType |p#1@@4|)))
))))))
 :qid |CloudMakeParallelBuildsdfy.112:27|
 :skolemid |6616|
 :pattern ( (M3.__default.Extends |st#0@@41| |st'#0@@5|))
))))
...
(assert (forall ((v@@6 T@U) (t0@@2 T@U) (h@@0 T@U) ) (! (= ($IsAlloc SetType v@@6 (TSet t0@@2) h@@0) (forall ((bx@@18 T@U) ) (!  (=> (|Set#IsMember| v@@6 bx@@18) ($IsAllocBox bx@@18 t0@@2 h@@0))
 :qid |DafnyPreludebpl.299:11|
 :skolemid |5022|
 :pattern ( (|Set#IsMember| v@@6 bx@@18))
)))
...
(assert (forall (($ly@@25 T@U) (|cmd#0@@16| T@U) (|deps#0@@19| T@U) (|restrictedState#0@@2| T@U) (|exps#0@@9| T@U) (|st#0@@42| T@U) ) (! (= (M3.__default.execOne ($LS $ly@@25) |cmd#0@@16| |deps#0@@19| |restrictedState#0@@2| |exps#0@@9| |st#0@@42|) (M3.__default.execOne $ly@@25 |cmd#0@@16| |deps#0@@19| |restrictedState#0@@2| |exps#0@@9| |st#0@@42|))
 :qid |CloudMakeParallelBuildsdfy.513:18|
 :skolemid |5826|
 :pattern ( (M3.__default.execOne ($LS $ly@@25) |cmd#0@@16| |deps#0@@19| |restrictedState#0@@2| |exps#0@@9| |st#0@@42|))
)))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@43| T@U) (|st'#0@@6| T@U) ) (!  (=> (or (|M3.__default.Union#canCall| |st#0@@43| |st'#0@@6|) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@43| Tclass.M3.State) ($Is DatatypeTypeType |st'#0@@6| Tclass.M3.State)))) (and (let ((|result#0| (M3.__default.Union |st#0@@43| |st'#0@@6|)))
 (and (|Set#Equal| (M3.__default.DomSt |result#0|) (|Set#Union| (M3.__default.DomSt |st#0@@43|) (M3.__default.DomSt |st'#0@@6|))) (forall ((|p#0@@40| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@40| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |result#0|) ($Box DatatypeTypeType |p#0@@40|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#0@@40| |result#0|) (M3.__default.GetSt |p#0@@40| (ite (|Set#IsMember| (M3.__default.DomSt |st#0@@43|) ($Box DatatypeTypeType |p#0@@40|)) |st#0@@43| |st'#0@@6|)))))
 :qid |CloudMakeParallelBuildsdfy.27:14|
 :skolemid |5656|
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@43|) ($Box DatatypeTypeType |p#0@@40|)))
 :pattern ( (M3.__default.GetSt |p#0@@40| |result#0|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |result#0|) ($Box DatatypeTypeType |p#0@@40|)))
)))) ($Is DatatypeTypeType (M3.__default.Union |st#0@@43| |st'#0@@6|) Tclass.M3.State)))
 :qid |CloudMakeParallelBuildsdfy.23:24|
 :skolemid |5657|
 :pattern ( (M3.__default.Union |st#0@@43| |st'#0@@6|))
))))
...
(assert (forall ((v@@8 T@U) (t0@@4 T@U) (t1@@1 T@U) (h@@2 T@U) ) (! (= ($IsAlloc MapType v@@8 (TMap t0@@4 t1@@1) h@@2) (forall ((bx@@19 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@8) bx@@19) (and ($IsAllocBox (MapType0Select BoxType BoxType (|Map#Elements| v@@8) bx@@19) t1@@1 h@@2) ($IsAllocBox bx@@19 t0@@4 h@@2)))
 :qid |DafnyPreludebpl.318:19|
 :skolemid |5030|
 :pattern ( (MapType0Select BoxType BoxType (|Map#Elements| v@@8) bx@@19))
 :pattern ( (|Set#IsMember| (|Map#Domain| v@@8) bx@@19))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|p#0@@42| T@U) (|st#0@@44| T@U) ) (!  (=> (or (|M3.__default.GetSt#canCall| |p#0@@42| (Lit DatatypeTypeType |st#0@@44|)) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |p#0@@42| Tclass.M3.Path) ($Is DatatypeTypeType |st#0@@44| Tclass.M3.State)) (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@44|))) ($Box DatatypeTypeType |p#0@@42|))))) (and (M3.State.StateCons_q (Lit DatatypeTypeType |st#0@@44|)) (= (M3.__default.GetSt |p#0@@42| (Lit DatatypeTypeType |st#0@@44|)) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType (M3.State.m (Lit DatatypeTypeType |st#0@@44|)))) ($Box DatatypeTypeType |p#0@@42|))))))
 :qid |CloudMakeParallelBuildsdfy.10:24|
 :weight 3
 :skolemid |6472|
 :pattern ( (M3.__default.GetSt |p#0@@42| (Lit DatatypeTypeType |st#0@@44|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@27 T@U) (|p#0@@43| T@U) (|cert#0@@11| T@U) (|deps#0@@20| T@U) (|st#0@@45| T@U) ) (!  (=> (or (|M3.__default.CollectDependencies#canCall| |p#0@@43| |cert#0@@11| |deps#0@@20| |st#0@@45|) (and (< 4 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |p#0@@43| Tclass.M3.Path) ($Is DatatypeTypeType |cert#0@@11| Tclass.M3.WFCertificate)) ($Is SetType |deps#0@@20| (TSet Tclass.M3.Path))) ($Is DatatypeTypeType |st#0@@45| Tclass.M3.State)) (and (M3.__default.CheckWellFounded ($LS $LZ) |p#0@@43| |cert#0@@11|) (|Set#Equal| |deps#0@@20| (M3.__default.LocInv__Deps |p#0@@43|)))))) ($Is MapType (M3.__default.CollectDependencies $ly@@27 |p#0@@43| |cert#0@@11| |deps#0@@20| |st#0@@45|) (TMap Tclass.M3.Path Tclass.M3.Artifact)))
 :qid |CloudMakeParallelBuildsdfy.660:18|
 :skolemid |6080|
 :pattern ( (M3.__default.CollectDependencies $ly@@27 |p#0@@43| |cert#0@@11| |deps#0@@20| |st#0@@45|))
))))
...
(assert (forall (($ly@@28 T@U) (|p#0@@44| T@U) (|cert#0@@12| T@U) (|st#0@@46| T@U) ) (! (= (M3.__default.OracleWF ($LS $ly@@28) |p#0@@44| |cert#0@@12| |st#0@@46|) (M3.__default.OracleWF $ly@@28 |p#0@@44| |cert#0@@12| |st#0@@46|))
 :qid |CloudMakeParallelBuildsdfy.653:18|
 :skolemid |6058|
 :pattern ( (M3.__default.OracleWF ($LS $ly@@28) |p#0@@44| |cert#0@@12| |st#0@@46|))
)))
(assert (forall (($ly@@29 T@U) (|stmts#0@@5| T@U) (|st#0@@47| T@U) (|env#0@@19| T@U) ) (! (= (M3.__default.do ($LS $ly@@29) |stmts#0@@5| |st#0@@47| |env#0@@19|) (M3.__default.do $ly@@29 |stmts#0@@5| |st#0@@47| |env#0@@19|))
 :qid |CloudMakeParallelBuildsdfy.177:18|
 :skolemid |6679|
 :pattern ( (M3.__default.do ($LS $ly@@29) |stmts#0@@5| |st#0@@47| |env#0@@19|))
)))
(assert (forall (($ly@@30 T@U) (|expr#0@@7| T@U) (|st#0@@48| T@U) (|env#0@@20| T@U) ) (! (= (M3.__default.eval ($LS $ly@@30) |expr#0@@7| |st#0@@48| |env#0@@20|) (M3.__default.eval $ly@@30 |expr#0@@7| |st#0@@48| |env#0@@20|))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |6698|
 :pattern ( (M3.__default.eval ($LS $ly@@30) |expr#0@@7| |st#0@@48| |env#0@@20|))
)))
...
(assert (forall ((bx@@20 T@U) (s@@17 T@U) (t@@12 T@U) ) (!  (=> ($IsBox bx@@20 (TMap s@@17 t@@12)) (and (= ($Box MapType ($Unbox MapType bx@@20)) bx@@20) ($Is MapType ($Unbox MapType bx@@20) (TMap s@@17 t@@12))))
 :qid |DafnyPreludebpl.207:15|
 :skolemid |4991|
 :pattern ( ($IsBox bx@@20 (TMap s@@17 t@@12)))
)))
...
(assert (forall ((M3.Tuple$A@@4 T@U) (M3.Tuple$B@@4 T@U) (bx@@22 T@U) ) (!  (=> ($IsBox bx@@22 (Tclass.M3.Tuple M3.Tuple$A@@4 M3.Tuple$B@@4)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@22)) bx@@22) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@22) (Tclass.M3.Tuple M3.Tuple$A@@4 M3.Tuple$B@@4))))
 :qid |unknown.0:0|
 :skolemid |5818|
 :pattern ( ($IsBox bx@@22 (Tclass.M3.Tuple M3.Tuple$A@@4 M3.Tuple$B@@4)))
)))
...
(let ((|cmd#3| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@5|) (LitInt 0)))))
 (=> (M3.Expression.exprLiteral_q |cmd#3|) (=> (M3.Literal.litString_q (M3.Expression.lit |cmd#3|)) (=> (M3.Expression.exprLiteral_q |deps#3|) (=> (M3.Literal.litArrOfPaths_q (M3.Expression.lit |deps#3|)) (=> (M3.Expression.exprLiteral_q |exps#3|) (=> (M3.Literal.litArrOfStrings_q (M3.Expression.lit |exps#3|)) (and (|M3.__default.DomSt#canCall| |st#0@@49|) (=> (|Set#Subset| (M3.Literal.paths (M3.Expression.lit |deps#3|)) (M3.__default.DomSt |st#0@@49|)) (|M3.__default.Pre#canCall| (M3.Literal.str (M3.Expression.lit |cmd#3|)) (M3.Literal.paths (M3.Expression.lit |deps#3|)) (M3.Literal.strs (M3.Expression.lit |exps#3|)) |st#0@@49|))))))))))))) (= (M3.__default.ValidArgs (Lit DatatypeTypeType |prim#0@@4|) (Lit SeqType |args#0@@5|) |st#0@@49|) (ite (M3.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@4|)) false (let ((|exps#2| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@5|) (LitInt 2)))))
...
(let ((|cmd#2@@1| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@5|) (LitInt 0)))))
 (and (and (and (and (and (and (and (M3.Expression.exprLiteral_q |cmd#2@@1|) (M3.Literal.litString_q (M3.Expression.lit |cmd#2@@1|))) (M3.Expression.exprLiteral_q |deps#2@@1|)) (M3.Literal.litArrOfPaths_q (M3.Expression.lit |deps#2@@1|))) (M3.Expression.exprLiteral_q |exps#2|)) (M3.Literal.litArrOfStrings_q (M3.Expression.lit |exps#2|))) (|Set#Subset| (M3.Literal.paths (M3.Expression.lit |deps#2@@1|)) (M3.__default.DomSt |st#0@@49|))) (M3.__default.Pre (M3.Literal.str (M3.Expression.lit |cmd#2@@1|)) (M3.Literal.paths (M3.Expression.lit |deps#2@@1|)) (M3.Literal.strs (M3.Expression.lit |exps#2|)) |st#0@@49|)))))))))
 :qid |CloudMakeParallelBuildsdfy.289:29|
 :weight 3
 :skolemid |6748|
 :pattern ( (M3.__default.ValidArgs (Lit DatatypeTypeType |prim#0@@4|) (Lit SeqType |args#0@@5|) |st#0@@49|))
))))
...
(assert (forall ((d@@82 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (M3.Artifact.ArtifactCons_q d@@82) ($IsAlloc DatatypeTypeType d@@82 Tclass.M3.Artifact $h@@3))) ($IsAlloc intType (int_2_U (M3.Artifact._h11 d@@82)) TInt $h@@3))
 :qid |unknown.0:0|
 :skolemid |6851|
 :pattern ( ($IsAlloc intType (int_2_U (M3.Artifact._h11 d@@82)) TInt $h@@3))
)))
(assert (forall ((d@@83 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (M3.Literal.litNumber_q d@@83) ($IsAlloc DatatypeTypeType d@@83 Tclass.M3.Literal $h@@4))) ($IsAlloc intType (int_2_U (M3.Literal.num d@@83)) TInt $h@@4))
 :qid |unknown.0:0|
 :skolemid |7098|
 :pattern ( ($IsAlloc intType (int_2_U (M3.Literal.num d@@83)) TInt $h@@4))
)))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($ly@@32 T@U) (|expr#0@@8| T@U) (|st#0@@50| T@U) (|env#0@@22| T@U) ) (!  (=> (or (|M3.__default.eval#canCall| (Lit DatatypeTypeType |expr#0@@8|) |st#0@@50| |env#0@@22|) (and (< 8 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0@@8| Tclass.M3.Expression) ($Is DatatypeTypeType |st#0@@50| Tclass.M3.State)) ($Is DatatypeTypeType |env#0@@22| Tclass.M3.Env)) (M3.__default.ValidEnv |env#0@@22|)))) (and (and (|M3.__default.Value#canCall| (Lit DatatypeTypeType |expr#0@@8|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (M3.__default.Value (Lit DatatypeTypeType |expr#0@@8|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@8|))))) (|M3.__default.GetEnv#canCall| (Lit DatatypeTypeType (M3.Expression.id (Lit DatatypeTypeType |expr#0@@8|))) |env#0@@22|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@8|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@8|))))) (and (|M3.__default.eval#canCall| (Lit DatatypeTypeType (M3.Expression.cond (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@50| |env#0@@22|) (let ((|st'#4| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval ($LS $ly@@32) (Lit DatatypeTypeType (M3.Expression.cond (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@50| |env#0@@22|)))))
(let ((|cond'#1| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval ($LS $ly@@32) (Lit DatatypeTypeType (M3.Expression.cond (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@50| |env#0@@22|)))))
 (and (and (=> (M3.Expression.exprLiteral_q |cond'#1|) (|$IsA#M3.Literal| (M3.Expression.lit |cond'#1|))) (=> (and (M3.Expression.exprLiteral_q |cond'#1|) (|M3.Literal#Equal| (M3.Expression.lit |cond'#1|) |#M3.Literal.litTrue|)) (|M3.__default.eval#canCall| (Lit DatatypeTypeType (M3.Expression.ifTrue (Lit DatatypeTypeType |expr#0@@8|))) |st'#4| |env#0@@22|))) (=> (not (and (M3.Expression.exprLiteral_q |cond'#1|) (|M3.Literal#Equal| (M3.Expression.lit |cond'#1|) |#M3.Literal.litTrue|))) (and (=> (M3.Expression.exprLiteral_q |cond'#1|) (|$IsA#M3.Literal| (M3.Expression.lit |cond'#1|))) (=> (and (M3.Expression.exprLiteral_q |cond'#1|) (|M3.Literal#Equal| (M3.Expression.lit |cond'#1|) |#M3.Literal.litFalse|)) (|M3.__default.eval#canCall| (Lit DatatypeTypeType (M3.Expression.ifFalse (Lit DatatypeTypeType |expr#0@@8|))) |st'#4| |env#0@@22|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@8|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@8|))))) (and (|M3.__default.eval#canCall| (Lit DatatypeTypeType (M3.Expression.conj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@50| |env#0@@22|) (let ((|st'#5| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval ($LS $ly@@32) (Lit DatatypeTypeType (M3.Expression.conj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@50| |env#0@@22|)))))
(let ((|conj0'#1| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval ($LS $ly@@32) (Lit DatatypeTypeType (M3.Expression.conj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@50| |env#0@@22|)))))
 (and (and (=> (M3.Expression.exprLiteral_q |conj0'#1|) (|$IsA#M3.Literal| (M3.Expression.lit |conj0'#1|))) (=> (and (M3.Expression.exprLiteral_q |conj0'#1|) (|M3.Literal#Equal| (M3.Expression.lit |conj0'#1|) |#M3.Literal.litTrue|)) (|M3.__default.eval#canCall| (Lit DatatypeTypeType (M3.Expression.conj1 (Lit DatatypeTypeType |expr#0@@8|))) |st'#5| |env#0@@22|))) (=> (not (and (M3.Expression.exprLiteral_q |conj0'#1|) (|M3.Literal#Equal| (M3.Expression.lit |conj0'#1|) |#M3.Literal.litTrue|))) (=> (M3.Expression.exprLiteral_q |conj0'#1|) (|$IsA#M3.Literal| (M3.Expression.lit |conj0'#1|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@8|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@8|))))) (and (|M3.__default.eval#canCall| (Lit DatatypeTypeType (M3.Expression.disj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@50| |env#0@@22|) (let ((|st'#6| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval ($LS $ly@@32) (Lit DatatypeTypeType (M3.Expression.disj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@50| |env#0@@22|)))))
(let ((|disj0'#1| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval ($LS $ly@@32) (Lit DatatypeTypeType (M3.Expression.disj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@50| |env#0@@22|)))))
 (and (=> (M3.Expression.exprLiteral_q |disj0'#1|) (|$IsA#M3.Literal| (M3.Expression.lit |disj0'#1|))) (=> (not (and (M3.Expression.exprLiteral_q |disj0'#1|) (|M3.Literal#Equal| (M3.Expression.lit |disj0'#1|) |#M3.Literal.litTrue|))) (and (=> (M3.Expression.exprLiteral_q |disj0'#1|) (|$IsA#M3.Literal| (M3.Expression.lit |disj0'#1|))) (=> (and (M3.Expression.exprLiteral_q |disj0'#1|) (|M3.Literal#Equal| (M3.Expression.lit |disj0'#1|) |#M3.Literal.litFalse|)) (|M3.__default.eval#canCall| (Lit DatatypeTypeType (M3.Expression.disj1 (Lit DatatypeTypeType |expr#0@@8|))) |st'#6| |env#0@@22|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@8|)))))) (=> (U_2_bool (Lit boolType (bool_2_U (M3.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0@@8|))))) (and (|M3.__default.eval#canCall| (Lit DatatypeTypeType (M3.Expression.fun (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@50| |env#0@@22|) (let ((|st'#7| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval ($LS $ly@@32) (Lit DatatypeTypeType (M3.Expression.fun (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@50| |env#0@@22|)))))
(let ((|fun'#1| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval ($LS $ly@@32) (Lit DatatypeTypeType (M3.Expression.fun (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@50| |env#0@@22|)))))
 (and (|M3.__default.evalArgs#canCall| (Lit DatatypeTypeType |expr#0@@8|) (Lit SeqType (M3.Expression.args (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@50| |env#0@@22|) (let ((|sts'#1| ($Unbox SetType (M3.Tuple.snd (M3.__default.evalArgs ($LS $ly@@32) (Lit DatatypeTypeType |expr#0@@8|) (Lit SeqType (M3.Expression.args (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@50| |env#0@@22|)))))
(let ((|args'#1| ($Unbox SeqType (M3.Tuple.fst (M3.__default.evalArgs ($LS $ly@@32) (Lit DatatypeTypeType |expr#0@@8|) (Lit SeqType (M3.Expression.args (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@50| |env#0@@22|)))))
(let ((|sts''#1| (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |st'#7|)) |sts'#1|)))
 ...
 (and (M3.Tuple.Pair_q |ps#1|) (M3.Tuple.Pair_q |ps#1|)))))))))))))))))))))))))))))) (= (M3.__default.eval ($LS $ly@@32) (Lit DatatypeTypeType |expr#0@@8|) |st#0@@50| |env#0@@22|) (ite (M3.__default.Value (Lit DatatypeTypeType |expr#0@@8|)) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType |expr#0@@8|)) ($Box DatatypeTypeType |st#0@@50|)) (ite (M3.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@8|)) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (M3.__default.GetEnv (Lit DatatypeTypeType (M3.Expression.id (Lit DatatypeTypeType |expr#0@@8|))) |env#0@@22|)) ($Box DatatypeTypeType |st#0@@50|)) (ite (M3.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@8|)) (let ((|st'#4@@0| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval ($LS $ly@@32) (Lit DatatypeTypeType (M3.Expression.cond (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@50| |env#0@@22|)))))
(let ((|cond'#1@@0| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval ($LS $ly@@32) (Lit DatatypeTypeType (M3.Expression.cond (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@50| |env#0@@22|)))))
(ite  (and (M3.Expression.exprLiteral_q |cond'#1@@0|) (|M3.Literal#Equal| (M3.Expression.lit |cond'#1@@0|) |#M3.Literal.litTrue|)) (M3.__default.eval ($LS $ly@@32) (Lit DatatypeTypeType (M3.Expression.ifTrue (Lit DatatypeTypeType |expr#0@@8|))) |st'#4@@0| |env#0@@22|) (ite  (and (M3.Expression.exprLiteral_q |cond'#1@@0|) (|M3.Literal#Equal| (M3.Expression.lit |cond'#1@@0|) |#M3.Literal.litFalse|)) (M3.__default.eval ($LS $ly@@32) (Lit DatatypeTypeType (M3.Expression.ifFalse (Lit DatatypeTypeType |expr#0@@8|))) |st'#4@@0| |env#0@@22|) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@50|)))))) (ite (M3.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@8|)) (let ((|st'#5@@0| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval ($LS $ly@@32) (Lit DatatypeTypeType (M3.Expression.conj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@50| |env#0@@22|)))))
(let ((|conj0'#1@@0| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval ($LS $ly@@32) (Lit DatatypeTypeType (M3.Expression.conj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@50| |env#0@@22|)))))
(ite  (and (M3.Expression.exprLiteral_q |conj0'#1@@0|) (|M3.Literal#Equal| (M3.Expression.lit |conj0'#1@@0|) |#M3.Literal.litTrue|)) (M3.__default.eval ($LS $ly@@32) (Lit DatatypeTypeType (M3.Expression.conj1 (Lit DatatypeTypeType |expr#0@@8|))) |st'#5@@0| |env#0@@22|) (ite  (and (M3.Expression.exprLiteral_q |conj0'#1@@0|) (|M3.Literal#Equal| (M3.Expression.lit |conj0'#1@@0|) |#M3.Literal.litFalse|)) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprLiteral| (Lit DatatypeTypeType |#M3.Literal.litFalse|)))) ($Box DatatypeTypeType |st'#5@@0|)) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@50|)))))) (ite (M3.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@8|)) (let ((|st'#6@@0| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval ($LS $ly@@32) (Lit DatatypeTypeType (M3.Expression.disj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@50| |env#0@@22|)))))
(let ((|disj0'#1@@0| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval ($LS $ly@@32) (Lit DatatypeTypeType (M3.Expression.disj0 (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@50| |env#0@@22|)))))
(ite  (and (M3.Expression.exprLiteral_q |disj0'#1@@0|) (|M3.Literal#Equal| (M3.Expression.lit |disj0'#1@@0|) |#M3.Literal.litTrue|)) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprLiteral| (Lit DatatypeTypeType |#M3.Literal.litTrue|)))) ($Box DatatypeTypeType |st'#6@@0|)) (ite  (and (M3.Expression.exprLiteral_q |disj0'#1@@0|) (|M3.Literal#Equal| (M3.Expression.lit |disj0'#1@@0|) |#M3.Literal.litFalse|)) (M3.__default.eval ($LS $ly@@32) (Lit DatatypeTypeType (M3.Expression.disj1 (Lit DatatypeTypeType |expr#0@@8|))) |st'#6@@0| |env#0@@22|) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@50|)))))) (ite (M3.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0@@8|)) (let ((|st'#7@@0| ($Unbox DatatypeTypeType (M3.Tuple.snd (M3.__default.eval ($LS $ly@@32) (Lit DatatypeTypeType (M3.Expression.fun (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@50| |env#0@@22|)))))
(let ((|fun'#1@@0| ($Unbox DatatypeTypeType (M3.Tuple.fst (M3.__default.eval ($LS $ly@@32) (Lit DatatypeTypeType (M3.Expression.fun (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@50| |env#0@@22|)))))
(let ((|sts'#1@@0| ($Unbox SetType (M3.Tuple.snd (M3.__default.evalArgs ($LS $ly@@32) (Lit DatatypeTypeType |expr#0@@8|) (Lit SeqType (M3.Expression.args (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@50| |env#0@@22|)))))
(let ((|args'#1@@0| ($Unbox SeqType (M3.Tuple.fst (M3.__default.evalArgs ($LS $ly@@32) (Lit DatatypeTypeType |expr#0@@8|) (Lit SeqType (M3.Expression.args (Lit DatatypeTypeType |expr#0@@8|))) |st#0@@50| |env#0@@22|)))))
(let ((|sts''#1@@0| (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |st'#7@@0|)) |sts'#1@@0|)))
(ite  (not (M3.__default.Compatible |sts''#1@@0|)) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rCompatibility|)))) ($Box DatatypeTypeType |st#0@@50|)) (let ((|stCombined#1@@0| (M3.__default.Combine ($LS $LZ) |sts''#1@@0|)))
...
(|#M3.Tuple.Pair| ($Box DatatypeTypeType (|#M3.Expression.exprLiteral| (|#M3.Literal.litArrOfPaths| ($Unbox SetType (M3.Tuple.fst |ps#1@@0|))))) (M3.Tuple.snd |ps#1@@0|))) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@50|))) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@50|))) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@50|)))))))))) (|#M3.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M3.Expression.exprError| (Lit DatatypeTypeType |#M3.Reason.rValidity|)))) ($Box DatatypeTypeType |st#0@@50|)))))))))))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :weight 3
 :skolemid |6703|
 :pattern ( (M3.__default.eval ($LS $ly@@32) (Lit DatatypeTypeType |expr#0@@8|) |st#0@@50| |env#0@@22|))
))))
...
(assert (forall ((d@@84 T@U) ) (! (= (BoxRank ($Box DatatypeTypeType d@@84)) (DtRank d@@84))
 :qid |DafnyPreludebpl.391:15|
 :skolemid |5039|
 :pattern ( (BoxRank ($Box DatatypeTypeType d@@84)))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@34 T@U) (|p#0@@49| T@U) (|cert#0@@14| T@U) (|deps#0@@22| T@U) (|st#0@@51| T@U) ) (!  (=> (or (|M3.__default.CollectDependencies#canCall| (Lit DatatypeTypeType |p#0@@49|) (Lit DatatypeTypeType |cert#0@@14|) (Lit SetType |deps#0@@22|) (Lit DatatypeTypeType |st#0@@51|)) (and (< 4 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |p#0@@49| Tclass.M3.Path) ($Is DatatypeTypeType |cert#0@@14| Tclass.M3.WFCertificate)) ($Is SetType |deps#0@@22| (TSet Tclass.M3.Path))) ($Is DatatypeTypeType |st#0@@51| Tclass.M3.State)) (and (M3.__default.CheckWellFounded ($LS $LZ) (Lit DatatypeTypeType |p#0@@49|) (Lit DatatypeTypeType |cert#0@@14|)) (|Set#Equal| |deps#0@@22| (M3.__default.LocInv__Deps (Lit DatatypeTypeType |p#0@@49|))))))) (and (forall ((|d#0@@7| T@U) ) (!  (=> ($Is DatatypeTypeType |d#0@@7| Tclass.M3.Path) (=> (|Set#IsMember| (Lit SetType |deps#0@@22|) ($Box DatatypeTypeType |d#0@@7|)) (and (and (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@51|)) (=> (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@51|))) ($Box DatatypeTypeType |d#0@@7|)) (|M3.__default.GetSt#canCall| |d#0@@7| (Lit DatatypeTypeType |st#0@@51|)))) (=> (not (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@51|))) ($Box DatatypeTypeType |d#0@@7|))) (and (and (M3.WFCertificate.Cert_q (Lit DatatypeTypeType |cert#0@@14|)) (|M3.__default.FindCert#canCall| |d#0@@7| (Lit SetType (M3.WFCertificate.certs (Lit DatatypeTypeType |cert#0@@14|))))) (|M3.__default.OracleWF#canCall| |d#0@@7| (M3.__default.FindCert |d#0@@7| (Lit SetType (M3.WFCertificate.certs (Lit DatatypeTypeType |cert#0@@14|)))) (Lit DatatypeTypeType |st#0@@51|)))))))
 :qid |CloudMakeParallelBuildsdfy.664:9|
 :skolemid |6086|
 :pattern ( (M3.__default.FindCert |d#0@@7| (M3.WFCertificate.certs |cert#0@@14|)))
 :pattern ( (M3.__default.GetSt |d#0@@7| |st#0@@51|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@51|) ($Box DatatypeTypeType |d#0@@7|)))
 :pattern ( (|Set#IsMember| |deps#0@@22| ($Box DatatypeTypeType |d#0@@7|)))
)) (= (M3.__default.CollectDependencies ($LS $ly@@34) (Lit DatatypeTypeType |p#0@@49|) (Lit DatatypeTypeType |cert#0@@14|) (Lit SetType |deps#0@@22|) (Lit DatatypeTypeType |st#0@@51|)) (|Map#Glue| (|Set#FromBoogieMap| (|lambda#0| Tclass.M3.Path (Lit SetType |deps#0@@22|))) (|lambda#26| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@51|))) (Lit DatatypeTypeType |st#0@@51|) ($LS $ly@@34) (Lit SetType (M3.WFCertificate.certs (Lit DatatypeTypeType |cert#0@@14|))) (Lit DatatypeTypeType |st#0@@51|)) (TMap Tclass.M3.Path Tclass.M3.Artifact)))))
 :qid |CloudMakeParallelBuildsdfy.660:18|
 :weight 3
 :skolemid |6087|
 :pattern ( (M3.__default.CollectDependencies ($LS $ly@@34) (Lit DatatypeTypeType |p#0@@49|) (Lit DatatypeTypeType |cert#0@@14|) (Lit SetType |deps#0@@22|) (Lit DatatypeTypeType |st#0@@51|)))
))))
...
(assert (forall ((|a#18#0#0| T@U) (|a#18#1#0| T@U) (|a#18#2#0| T@U) (d@@85 T@U) ) (!  (=> (|Set#IsMember| |a#18#1#0| ($Box DatatypeTypeType d@@85)) (< (DtRank d@@85) (DtRank (|#M3.Path.InternalPath| |a#18#0#0| |a#18#1#0| |a#18#2#0|))))
 :qid |CloudMakeParallelBuildsdfy.784:18|
 :skolemid |6885|
 :pattern ( (|Set#IsMember| |a#18#1#0| ($Box DatatypeTypeType d@@85)) (|#M3.Path.InternalPath| |a#18#0#0| |a#18#1#0| |a#18#2#0|))
)))
(assert (forall ((bx@@23 T@U) (t@@13 T@U) ) (!  (=> ($IsBox bx@@23 (TSet t@@13)) (and (= ($Box SetType ($Unbox SetType bx@@23)) bx@@23) ($Is SetType ($Unbox SetType bx@@23) (TSet t@@13))))
 :qid |DafnyPreludebpl.195:15|
 :skolemid |4987|
 :pattern ( ($IsBox bx@@23 (TSet t@@13)))
)))
(assert (forall ((bx@@24 T@U) (t@@14 T@U) ) (!  (=> ($IsBox bx@@24 (TSeq t@@14)) (and (= ($Box SeqType ($Unbox SeqType bx@@24)) bx@@24) ($Is SeqType ($Unbox SeqType bx@@24) (TSeq t@@14))))
 :qid |DafnyPreludebpl.204:15|
 :skolemid |4990|
 :pattern ( ($IsBox bx@@24 (TSeq t@@14)))
)))
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|p#0@@50| T@U) (|st#0@@52| T@U) ) (!  (=> (or (|M3.__default.Oracle#canCall| (Lit DatatypeTypeType |p#0@@50|) (Lit DatatypeTypeType |st#0@@52|)) (and (< 5 $FunctionContextHeight) (and ($Is DatatypeTypeType |p#0@@50| Tclass.M3.Path) ($Is DatatypeTypeType |st#0@@52| Tclass.M3.State)))) (and (and (and (|M3.__default.WellFounded#canCall| (Lit DatatypeTypeType |p#0@@50|)) (=> (U_2_bool (Lit boolType (bool_2_U (M3.__default.WellFounded (Lit DatatypeTypeType |p#0@@50|))))) (and (|M3.__default.GetCert#canCall| (Lit DatatypeTypeType |p#0@@50|)) (|M3.__default.OracleWF#canCall| (Lit DatatypeTypeType |p#0@@50|) (Lit DatatypeTypeType (M3.__default.GetCert (Lit DatatypeTypeType |p#0@@50|))) (Lit DatatypeTypeType |st#0@@52|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M3.__default.WellFounded (Lit DatatypeTypeType |p#0@@50|)))))) (|M3.__default.OracleArbitrary#canCall| (Lit DatatypeTypeType |p#0@@50|)))) (= (M3.__default.Oracle (Lit DatatypeTypeType |p#0@@50|) (Lit DatatypeTypeType |st#0@@52|)) (ite (M3.__default.WellFounded (Lit DatatypeTypeType |p#0@@50|)) (M3.__default.OracleWF ($LS $LZ) (Lit DatatypeTypeType |p#0@@50|) (Lit DatatypeTypeType (M3.__default.GetCert (Lit DatatypeTypeType |p#0@@50|))) (Lit DatatypeTypeType |st#0@@52|)) (M3.__default.OracleArbitrary (Lit DatatypeTypeType |p#0@@50|))))))
 :qid |CloudMakeParallelBuildsdfy.104:25|
 :weight 3
 :skolemid |6039|
 :pattern ( (M3.__default.Oracle (Lit DatatypeTypeType |p#0@@50|) (Lit DatatypeTypeType |st#0@@52|)))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|sts#0@@3| T@U) ) (!  (=> (or (|M3.__default.Compatible#canCall| |sts#0@@3|) (and (< 4 $FunctionContextHeight) ($Is SetType |sts#0@@3| (TSet Tclass.M3.State)))) (and (forall ((|st#0@@53| T@U) (|st'#0@@7| T@U) (|p#0@@51| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |st#0@@53| Tclass.M3.State) ($Is DatatypeTypeType |st'#0@@7| Tclass.M3.State)) ($Is DatatypeTypeType |p#0@@51| Tclass.M3.Path)) (=> (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st#0@@53|)) (=> (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st'#0@@7|)) (and (|M3.__default.DomSt#canCall| |st#0@@53|) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@53|) ($Box DatatypeTypeType |p#0@@51|)) (and (|M3.__default.DomSt#canCall| |st'#0@@7|) (=> (|Set#IsMember| (M3.__default.DomSt |st'#0@@7|) ($Box DatatypeTypeType |p#0@@51|)) (and (and (|$IsA#M3.Artifact| (M3.__default.GetSt |p#0@@51| |st#0@@53|)) (|$IsA#M3.Artifact| (M3.__default.GetSt |p#0@@51| |st'#0@@7|))) (and (|M3.__default.GetSt#canCall| |p#0@@51| |st#0@@53|) (|M3.__default.GetSt#canCall| |p#0@@51| |st'#0@@7|))))))))))
 :qid |CloudMakeParallelBuildsdfy.32:12|
 :skolemid |6505|
 :pattern ( (M3.__default.GetSt |p#0@@51| |st'#0@@7|) (M3.__default.GetSt |p#0@@51| |st#0@@53|))
 :pattern ( (M3.__default.GetSt |p#0@@51| |st'#0@@7|) (M3.__default.DomSt |st#0@@53|))
 :pattern ( (M3.__default.GetSt |p#0@@51| |st'#0@@7|) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st#0@@53|)))
 :pattern ( (M3.__default.GetSt |p#0@@51| |st#0@@53|) (M3.__default.DomSt |st'#0@@7|))
 :pattern ( (M3.__default.GetSt |p#0@@51| |st#0@@53|) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st'#0@@7|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@7|) ($Box DatatypeTypeType |p#0@@51|)) (M3.__default.DomSt |st#0@@53|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@7|) ($Box DatatypeTypeType |p#0@@51|)) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st#0@@53|)))
 :pattern ( (M3.__default.DomSt |st'#0@@7|) (|Set#IsMember| (M3.__default.DomSt |st#0@@53|) ($Box DatatypeTypeType |p#0@@51|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@53|) ($Box DatatypeTypeType |p#0@@51|)) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st'#0@@7|)))
)) (= (M3.__default.Compatible |sts#0@@3|) (forall ((|st#0@@54| T@U) (|st'#0@@8| T@U) (|p#0@@52| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |st#0@@54| Tclass.M3.State) ($Is DatatypeTypeType |st'#0@@8| Tclass.M3.State)) ($Is DatatypeTypeType |p#0@@52| Tclass.M3.Path)) (=> (and (and (and (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st#0@@54|)) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st'#0@@8|))) (|Set#IsMember| (M3.__default.DomSt |st#0@@54|) ($Box DatatypeTypeType |p#0@@52|))) (|Set#IsMember| (M3.__default.DomSt |st'#0@@8|) ($Box DatatypeTypeType |p#0@@52|))) (|M3.Artifact#Equal| (M3.__default.GetSt |p#0@@52| |st#0@@54|) (M3.__default.GetSt |p#0@@52| |st'#0@@8|))))
 :qid |CloudMakeParallelBuildsdfy.32:12|
 :skolemid |6504|
 :pattern ( (M3.__default.GetSt |p#0@@52| |st'#0@@8|) (M3.__default.GetSt |p#0@@52| |st#0@@54|))
 :pattern ( (M3.__default.GetSt |p#0@@52| |st'#0@@8|) (M3.__default.DomSt |st#0@@54|))
 :pattern ( (M3.__default.GetSt |p#0@@52| |st'#0@@8|) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st#0@@54|)))
 :pattern ( (M3.__default.GetSt |p#0@@52| |st#0@@54|) (M3.__default.DomSt |st'#0@@8|))
 :pattern ( (M3.__default.GetSt |p#0@@52| |st#0@@54|) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st'#0@@8|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@8|) ($Box DatatypeTypeType |p#0@@52|)) (M3.__default.DomSt |st#0@@54|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@8|) ($Box DatatypeTypeType |p#0@@52|)) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st#0@@54|)))
 :pattern ( (M3.__default.DomSt |st'#0@@8|) (|Set#IsMember| (M3.__default.DomSt |st#0@@54|) ($Box DatatypeTypeType |p#0@@52|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@54|) ($Box DatatypeTypeType |p#0@@52|)) (|Set#IsMember| |sts#0@@3| ($Box DatatypeTypeType |st'#0@@8|)))
)))))
 :qid |CloudMakeParallelBuildsdfy.30:30|
 :skolemid |6506|
 :pattern ( (M3.__default.Compatible |sts#0@@3|))
))))
(assert (forall ((v@@12 T@U) (t0@@6 T@U) (t1@@3 T@U) ) (! (= ($Is MapType v@@12 (TMap t0@@6 t1@@3)) (forall ((bx@@25 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@12) bx@@25) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@12) bx@@25) t1@@3) ($IsBox bx@@25 t0@@6)))
...
(assert (forall ((|a#43#0#0| T@U) (|a#43#1#0| T@U) (d@@86 T@U) ) (!  (=> (|Set#IsMember| |a#43#1#0| ($Box DatatypeTypeType d@@86)) (< (DtRank d@@86) (DtRank (|#M3.WFCertificate.Cert| |a#43#0#0| |a#43#1#0|))))
 :qid |CloudMakeParallelBuildsdfy.500:33|
 :skolemid |6931|
 :pattern ( (|Set#IsMember| |a#43#1#0| ($Box DatatypeTypeType d@@86)) (|#M3.WFCertificate.Cert| |a#43#0#0| |a#43#1#0|))
)))
(assert (forall ((d@@87 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) ($Is DatatypeTypeType d@@87 Tclass.M3.Artifact)) ($IsAlloc DatatypeTypeType d@@87 Tclass.M3.Artifact $h@@5))
 :qid |unknown.0:0|
 :skolemid |6854|
 :pattern ( ($IsAlloc DatatypeTypeType d@@87 Tclass.M3.Artifact $h@@5))
)))
(assert (forall ((d@@88 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) ($Is DatatypeTypeType d@@88 Tclass.M3.Identifier)) ($IsAlloc DatatypeTypeType d@@88 Tclass.M3.Identifier $h@@6))
 :qid |unknown.0:0|
 :skolemid |6867|
 :pattern ( ($IsAlloc DatatypeTypeType d@@88 Tclass.M3.Identifier $h@@6))
)))
(assert (forall ((d@@89 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) ($Is DatatypeTypeType d@@89 Tclass.M3.Path)) ($IsAlloc DatatypeTypeType d@@89 Tclass.M3.Path $h@@7))
 :qid |unknown.0:0|
 :skolemid |6899|
 :pattern ( ($IsAlloc DatatypeTypeType d@@89 Tclass.M3.Path $h@@7))
)))
(assert (forall ((d@@90 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) ($Is DatatypeTypeType d@@90 Tclass.M3.Env)) ($IsAlloc DatatypeTypeType d@@90 Tclass.M3.Env $h@@8))
 :qid |unknown.0:0|
 :skolemid |6915|
 :pattern ( ($IsAlloc DatatypeTypeType d@@90 Tclass.M3.Env $h@@8))
)))
(assert (forall ((d@@91 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) ($Is DatatypeTypeType d@@91 Tclass.M3.WFCertificate)) ($IsAlloc DatatypeTypeType d@@91 Tclass.M3.WFCertificate $h@@9))
 :qid |unknown.0:0|
 :skolemid |6932|
 :pattern ( ($IsAlloc DatatypeTypeType d@@91 Tclass.M3.WFCertificate $h@@9))
)))
(assert (forall ((d@@92 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) ($Is DatatypeTypeType d@@92 Tclass.M3.State)) ($IsAlloc DatatypeTypeType d@@92 Tclass.M3.State $h@@10))
 :qid |unknown.0:0|
 :skolemid |6947|
 :pattern ( ($IsAlloc DatatypeTypeType d@@92 Tclass.M3.State $h@@10))
)))
(assert (forall ((d@@93 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) ($Is DatatypeTypeType d@@93 Tclass.M3.Statement)) ($IsAlloc DatatypeTypeType d@@93 Tclass.M3.Statement $h@@11))
 :qid |unknown.0:0|
 :skolemid |6988|
 :pattern ( ($IsAlloc DatatypeTypeType d@@93 Tclass.M3.Statement $h@@11))
)))
(assert (forall ((d@@94 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) ($Is DatatypeTypeType d@@94 Tclass.M3.Expression)) ($IsAlloc DatatypeTypeType d@@94 Tclass.M3.Expression $h@@12))
 :qid |unknown.0:0|
 :skolemid |7074|
 :pattern ( ($IsAlloc DatatypeTypeType d@@94 Tclass.M3.Expression $h@@12))
)))
(assert (forall ((d@@95 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) ($Is DatatypeTypeType d@@95 Tclass.M3.Literal)) ($IsAlloc DatatypeTypeType d@@95 Tclass.M3.Literal $h@@13))
 :qid |unknown.0:0|
 :skolemid |7148|
 :pattern ( ($IsAlloc DatatypeTypeType d@@95 Tclass.M3.Literal $h@@13))
)))
(assert (forall ((d@@96 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) ($Is DatatypeTypeType d@@96 Tclass.M3.Primitive)) ($IsAlloc DatatypeTypeType d@@96 Tclass.M3.Primitive $h@@14))
 :qid |unknown.0:0|
 :skolemid |7166|
 :pattern ( ($IsAlloc DatatypeTypeType d@@96 Tclass.M3.Primitive $h@@14))
)))
(assert (forall ((d@@97 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) ($Is DatatypeTypeType d@@97 Tclass.M3.Reason)) ($IsAlloc DatatypeTypeType d@@97 Tclass.M3.Reason $h@@15))
 :qid |unknown.0:0|
 :skolemid |7176|
 :pattern ( ($IsAlloc DatatypeTypeType d@@97 Tclass.M3.Reason $h@@15))
)))
...
(assert (forall ((d@@98 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (M3.Path.InternalPath_q d@@98) ($IsAlloc DatatypeTypeType d@@98 Tclass.M3.Path $h@@16))) ($IsAlloc SeqType (M3.Path.cmd d@@98) (TSeq TChar) $h@@16))
 :qid |unknown.0:0|
 :skolemid |6877|
 :pattern ( ($IsAlloc SeqType (M3.Path.cmd d@@98) (TSeq TChar) $h@@16))
)))
(assert (forall ((d@@99 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (M3.Path.InternalPath_q d@@99) ($IsAlloc DatatypeTypeType d@@99 Tclass.M3.Path $h@@17))) ($IsAlloc SeqType (M3.Path.exp d@@99) (TSeq TChar) $h@@17))
 :qid |unknown.0:0|
 :skolemid |6879|
 :pattern ( ($IsAlloc SeqType (M3.Path.exp d@@99) (TSeq TChar) $h@@17))
)))
(assert (forall ((d@@100 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (M3.Path.ExternalPath_q d@@100) ($IsAlloc DatatypeTypeType d@@100 Tclass.M3.Path $h@@18))) ($IsAlloc SeqType (M3.Path._h13 d@@100) (TSeq TChar) $h@@18))
 :qid |unknown.0:0|
 :skolemid |6894|
 :pattern ( ($IsAlloc SeqType (M3.Path._h13 d@@100) (TSeq TChar) $h@@18))
)))
(assert (forall ((d@@101 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (M3.Literal.litString_q d@@101) ($IsAlloc DatatypeTypeType d@@101 Tclass.M3.Literal $h@@19))) ($IsAlloc SeqType (M3.Literal.str d@@101) (TSeq TChar) $h@@19))
 :qid |unknown.0:0|
 :skolemid |7106|
 :pattern ( ($IsAlloc SeqType (M3.Literal.str d@@101) (TSeq TChar) $h@@19))
)))
(assert (forall ((|a#164#0#0| T@U) (d@@102 T@U) ) (!  (=> (|Set#IsMember| |a#164#0#0| ($Box DatatypeTypeType d@@102)) (< (DtRank d@@102) (DtRank (|#M3.Literal.litArrOfPaths| |a#164#0#0|))))
 :qid |CloudMakeParallelBuildsdfy.145:36|
 :skolemid |7128|
 :pattern ( (|Set#IsMember| |a#164#0#0| ($Box DatatypeTypeType d@@102)) (|#M3.Literal.litArrOfPaths| |a#164#0#0|))
)))
(assert (forall ((|a#170#0#0| T@U) (d@@103 T@U) ) (!  (=> (|Set#IsMember| |a#170#0#0| ($Box DatatypeTypeType d@@103)) (< (DtRank d@@103) (DtRank (|#M3.Literal.litArrOfStrings| |a#170#0#0|))))
 :qid |CloudMakeParallelBuildsdfy.146:38|
 :skolemid |7137|
 :pattern ( (|Set#IsMember| |a#170#0#0| ($Box DatatypeTypeType d@@103)) (|#M3.Literal.litArrOfStrings| |a#170#0#0|))
)))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall ((|st#0@@55| T@U) (|st'#0@@9| T@U) ) (!  (=> (or (|M3.__default.Extends#canCall| (Lit DatatypeTypeType |st#0@@55|) (Lit DatatypeTypeType |st'#0@@9|)) (and (< 6 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@55| Tclass.M3.State) ($Is DatatypeTypeType |st'#0@@9| Tclass.M3.State)))) (and (and (and (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@55|)) (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st'#0@@9|))) (=> (|Set#Subset| (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@55|)) (M3.__default.DomSt (Lit DatatypeTypeType |st'#0@@9|))) (and (forall ((|p#2| T@U) ) (!  (=> ($Is DatatypeTypeType |p#2| Tclass.M3.Path) (and (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@55|)) (=> (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@55|))) ($Box DatatypeTypeType |p#2|)) (and (and (|$IsA#M3.Artifact| (M3.__default.GetSt |p#2| (Lit DatatypeTypeType |st'#0@@9|))) (|$IsA#M3.Artifact| (M3.__default.GetSt |p#2| (Lit DatatypeTypeType |st#0@@55|)))) (and (|M3.__default.GetSt#canCall| |p#2| (Lit DatatypeTypeType |st'#0@@9|)) (|M3.__default.GetSt#canCall| |p#2| (Lit DatatypeTypeType |st#0@@55|)))))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6619|
 :pattern ( (M3.__default.GetSt |p#2| |st#0@@55|))
 :pattern ( (M3.__default.GetSt |p#2| |st'#0@@9|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@55|) ($Box DatatypeTypeType |p#2|)))
)) (=> (forall ((|p#2@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |p#2@@0| Tclass.M3.Path) (=> (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@55|))) ($Box DatatypeTypeType |p#2@@0|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#2@@0| (Lit DatatypeTypeType |st'#0@@9|)) (M3.__default.GetSt |p#2@@0| (Lit DatatypeTypeType |st#0@@55|)))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6621|
 :pattern ( (M3.__default.GetSt |p#2@@0| |st#0@@55|))
 :pattern ( (M3.__default.GetSt |p#2@@0| |st'#0@@9|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@55|) ($Box DatatypeTypeType |p#2@@0|)))
)) (forall ((|p#3| T@U) ) (!  (=> ($Is DatatypeTypeType |p#3| Tclass.M3.Path) (and (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@55|)) (=> (not (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@55|))) ($Box DatatypeTypeType |p#3|))) (and (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st'#0@@9|)) (=> (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st'#0@@9|))) ($Box DatatypeTypeType |p#3|)) (and (and (|$IsA#M3.Artifact| (M3.__default.GetSt |p#3| (Lit DatatypeTypeType |st'#0@@9|))) (|$IsA#M3.Artifact| (M3.__default.Oracle |p#3| (Lit DatatypeTypeType |st#0@@55|)))) (and (|M3.__default.GetSt#canCall| |p#3| (Lit DatatypeTypeType |st'#0@@9|)) (|M3.__default.Oracle#canCall| |p#3| (Lit DatatypeTypeType |st#0@@55|)))))))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |6620|
 :pattern ( (M3.__default.Oracle |p#3| |st#0@@55|))
 :pattern ( (M3.__default.GetSt |p#3| |st'#0@@9|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@9|) ($Box DatatypeTypeType |p#3|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@55|) ($Box DatatypeTypeType |p#3|)))
)))))) (= (M3.__default.Extends (Lit DatatypeTypeType |st#0@@55|) (Lit DatatypeTypeType |st'#0@@9|))  (and (and (|Set#Subset| (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@55|)) (M3.__default.DomSt (Lit DatatypeTypeType |st'#0@@9|))) (forall ((|p#2@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |p#2@@1| Tclass.M3.Path) (=> (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@55|))) ($Box DatatypeTypeType |p#2@@1|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#2@@1| (Lit DatatypeTypeType |st'#0@@9|)) (M3.__default.GetSt |p#2@@1| (Lit DatatypeTypeType |st#0@@55|)))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6617|
 :pattern ( (M3.__default.GetSt |p#2@@1| |st#0@@55|))
 :pattern ( (M3.__default.GetSt |p#2@@1| |st'#0@@9|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@55|) ($Box DatatypeTypeType |p#2@@1|)))
))) (forall ((|p#3@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |p#3@@0| Tclass.M3.Path) (=> (and (not (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@55|))) ($Box DatatypeTypeType |p#3@@0|))) (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st'#0@@9|))) ($Box DatatypeTypeType |p#3@@0|))) (|M3.Artifact#Equal| (M3.__default.GetSt |p#3@@0| (Lit DatatypeTypeType |st'#0@@9|)) (M3.__default.Oracle |p#3@@0| (Lit DatatypeTypeType |st#0@@55|)))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |6618|
 :pattern ( (M3.__default.Oracle |p#3@@0| |st#0@@55|))
 :pattern ( (M3.__default.GetSt |p#3@@0| |st'#0@@9|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st'#0@@9|) ($Box DatatypeTypeType |p#3@@0|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@55|) ($Box DatatypeTypeType |p#3@@0|)))
))))))
 :qid |CloudMakeParallelBuildsdfy.112:27|
 :weight 3
 :skolemid |6622|
 :pattern ( (M3.__default.Extends (Lit DatatypeTypeType |st#0@@55|) (Lit DatatypeTypeType |st'#0@@9|)))
))))
(assert (forall ((d@@104 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (_System.Tuple2.___hMake2_q d@@104) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@104 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@20)
 :qid |unknown.0:0|
 :skolemid |5413|
 :pattern ( ($IsAlloc DatatypeTypeType d@@104 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@20))
)))) ($IsAllocBox (_System.Tuple2._0 d@@104) |_System._tuple#2$T0@@6| $h@@20))
 :qid |unknown.0:0|
 :skolemid |5414|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@104) |_System._tuple#2$T0@@6| $h@@20))
)))
(assert (forall ((d@@105 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (_System.Tuple2.___hMake2_q d@@105) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@105 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@21)
 :qid |unknown.0:0|
 :skolemid |5415|
 :pattern ( ($IsAlloc DatatypeTypeType d@@105 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@21))
)))) ($IsAllocBox (_System.Tuple2._1 d@@105) |_System._tuple#2$T1@@7| $h@@21))
 :qid |unknown.0:0|
 :skolemid |5416|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@105) |_System._tuple#2$T1@@7| $h@@21))
)))
(assert (forall ((d@@106 T@U) (M3.Tuple$A@@6 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (M3.Tuple.Pair_q d@@106) (exists ((M3.Tuple$B@@6 T@U) ) (! ($IsAlloc DatatypeTypeType d@@106 (Tclass.M3.Tuple M3.Tuple$A@@6 M3.Tuple$B@@6) $h@@22)
 :qid |unknown.0:0|
 :skolemid |7188|
 :pattern ( ($IsAlloc DatatypeTypeType d@@106 (Tclass.M3.Tuple M3.Tuple$A@@6 M3.Tuple$B@@6) $h@@22))
)))) ($IsAllocBox (M3.Tuple.fst d@@106) M3.Tuple$A@@6 $h@@22))
 :qid |unknown.0:0|
 :skolemid |7189|
 :pattern ( ($IsAllocBox (M3.Tuple.fst d@@106) M3.Tuple$A@@6 $h@@22))
)))
(assert (forall ((d@@107 T@U) (M3.Tuple$B@@7 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (M3.Tuple.Pair_q d@@107) (exists ((M3.Tuple$A@@7 T@U) ) (! ($IsAlloc DatatypeTypeType d@@107 (Tclass.M3.Tuple M3.Tuple$A@@7 M3.Tuple$B@@7) $h@@23)
 :qid |unknown.0:0|
 :skolemid |7190|
 :pattern ( ($IsAlloc DatatypeTypeType d@@107 (Tclass.M3.Tuple M3.Tuple$A@@7 M3.Tuple$B@@7) $h@@23))
)))) ($IsAllocBox (M3.Tuple.snd d@@107) M3.Tuple$B@@7 $h@@23))
 :qid |unknown.0:0|
 :skolemid |7191|
 :pattern ( ($IsAllocBox (M3.Tuple.snd d@@107) M3.Tuple$B@@7 $h@@23))
)))
...
(assert (forall ((d@@108 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (M3.WFCertificate.Cert_q d@@108) ($IsAlloc DatatypeTypeType d@@108 Tclass.M3.WFCertificate $h@@24))) ($IsAlloc DatatypeTypeType (M3.WFCertificate.p d@@108) Tclass.M3.Path $h@@24))
 :qid |unknown.0:0|
 :skolemid |6925|
 :pattern ( ($IsAlloc DatatypeTypeType (M3.WFCertificate.p d@@108) Tclass.M3.Path $h@@24))
)))
(assert (forall ((d@@109 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (M3.Statement.stmtVariable_q d@@109) ($IsAlloc DatatypeTypeType d@@109 Tclass.M3.Statement $h@@25))) ($IsAlloc DatatypeTypeType (M3.Statement.id d@@109) Tclass.M3.Identifier $h@@25))
 :qid |unknown.0:0|
 :skolemid |6972|
 :pattern ( ($IsAlloc DatatypeTypeType (M3.Statement.id d@@109) Tclass.M3.Identifier $h@@25))
)))
(assert (forall ((d@@110 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (M3.Statement.stmtVariable_q d@@110) ($IsAlloc DatatypeTypeType d@@110 Tclass.M3.Statement $h@@26))) ($IsAlloc DatatypeTypeType (M3.Statement.expr d@@110) Tclass.M3.Expression $h@@26))
 :qid |unknown.0:0|
 :skolemid |6973|
 :pattern ( ($IsAlloc DatatypeTypeType (M3.Statement.expr d@@110) Tclass.M3.Expression $h@@26))
)))
(assert (forall ((d@@111 T@U) ($h@@27 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (M3.Statement.stmtReturn_q d@@111) ($IsAlloc DatatypeTypeType d@@111 Tclass.M3.Statement $h@@27))) ($IsAlloc DatatypeTypeType (M3.Statement.ret d@@111) Tclass.M3.Expression $h@@27))
 :qid |unknown.0:0|
 :skolemid |6984|
 :pattern ( ($IsAlloc DatatypeTypeType (M3.Statement.ret d@@111) Tclass.M3.Expression $h@@27))
)))
(assert (forall ((d@@112 T@U) ($h@@28 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (M3.Expression.exprLiteral_q d@@112) ($IsAlloc DatatypeTypeType d@@112 Tclass.M3.Expression $h@@28))) ($IsAlloc DatatypeTypeType (M3.Expression.lit d@@112) Tclass.M3.Literal $h@@28))
 :qid |unknown.0:0|
 :skolemid |6999|
 :pattern ( ($IsAlloc DatatypeTypeType (M3.Expression.lit d@@112) Tclass.M3.Literal $h@@28))
)))
(assert (forall ((d@@113 T@U) ($h@@29 T@U) ) (!  (=> (and ($IsGoodHeap $h@@29) (and (M3.Expression.exprIdentifier_q d@@113) ($IsAlloc DatatypeTypeType d@@113 Tclass.M3.Expression $h@@29))) ($IsAlloc DatatypeTypeType (M3.Expression.id d@@113) Tclass.M3.Identifier $h@@29))
 :qid |unknown.0:0|
 :skolemid |7008|
 :pattern ( ($IsAlloc DatatypeTypeType (M3.Expression.id d@@113) Tclass.M3.Identifier $h@@29))
)))
(assert (forall ((d@@114 T@U) ($h@@30 T@U) ) (!  (=> (and ($IsGoodHeap $h@@30) (and (M3.Expression.exprIf_q d@@114) ($IsAlloc DatatypeTypeType d@@114 Tclass.M3.Expression $h@@30))) ($IsAlloc DatatypeTypeType (M3.Expression.cond d@@114) Tclass.M3.Expression $h@@30))
 :qid |unknown.0:0|
 :skolemid |7017|
 :pattern ( ($IsAlloc DatatypeTypeType (M3.Expression.cond d@@114) Tclass.M3.Expression $h@@30))
)))
(assert (forall ((d@@115 T@U) ($h@@31 T@U) ) (!  (=> (and ($IsGoodHeap $h@@31) (and (M3.Expression.exprIf_q d@@115) ($IsAlloc DatatypeTypeType d@@115 Tclass.M3.Expression $h@@31))) ($IsAlloc DatatypeTypeType (M3.Expression.ifTrue d@@115) Tclass.M3.Expression $h@@31))
 :qid |unknown.0:0|
 :skolemid |7018|
 :pattern ( ($IsAlloc DatatypeTypeType (M3.Expression.ifTrue d@@115) Tclass.M3.Expression $h@@31))
)))
(assert (forall ((d@@116 T@U) ($h@@32 T@U) ) (!  (=> (and ($IsGoodHeap $h@@32) (and (M3.Expression.exprIf_q d@@116) ($IsAlloc DatatypeTypeType d@@116 Tclass.M3.Expression $h@@32))) ($IsAlloc DatatypeTypeType (M3.Expression.ifFalse d@@116) Tclass.M3.Expression $h@@32))
 :qid |unknown.0:0|
 :skolemid |7019|
 :pattern ( ($IsAlloc DatatypeTypeType (M3.Expression.ifFalse d@@116) Tclass.M3.Expression $h@@32))
)))
(assert (forall ((d@@117 T@U) ($h@@33 T@U) ) (!  (=> (and ($IsGoodHeap $h@@33) (and (M3.Expression.exprAnd_q d@@117) ($IsAlloc DatatypeTypeType d@@117 Tclass.M3.Expression $h@@33))) ($IsAlloc DatatypeTypeType (M3.Expression.conj0 d@@117) Tclass.M3.Expression $h@@33))
 :qid |unknown.0:0|
 :skolemid |7032|
 :pattern ( ($IsAlloc DatatypeTypeType (M3.Expression.conj0 d@@117) Tclass.M3.Expression $h@@33))
)))
(assert (forall ((d@@118 T@U) ($h@@34 T@U) ) (!  (=> (and ($IsGoodHeap $h@@34) (and (M3.Expression.exprAnd_q d@@118) ($IsAlloc DatatypeTypeType d@@118 Tclass.M3.Expression $h@@34))) ($IsAlloc DatatypeTypeType (M3.Expression.conj1 d@@118) Tclass.M3.Expression $h@@34))
 :qid |unknown.0:0|
 :skolemid |7033|
 :pattern ( ($IsAlloc DatatypeTypeType (M3.Expression.conj1 d@@118) Tclass.M3.Expression $h@@34))
)))
(assert (forall ((d@@119 T@U) ($h@@35 T@U) ) (!  (=> (and ($IsGoodHeap $h@@35) (and (M3.Expression.exprOr_q d@@119) ($IsAlloc DatatypeTypeType d@@119 Tclass.M3.Expression $h@@35))) ($IsAlloc DatatypeTypeType (M3.Expression.disj0 d@@119) Tclass.M3.Expression $h@@35))
 :qid |unknown.0:0|
 :skolemid |7044|
 :pattern ( ($IsAlloc DatatypeTypeType (M3.Expression.disj0 d@@119) Tclass.M3.Expression $h@@35))
)))
(assert (forall ((d@@120 T@U) ($h@@36 T@U) ) (!  (=> (and ($IsGoodHeap $h@@36) (and (M3.Expression.exprOr_q d@@120) ($IsAlloc DatatypeTypeType d@@120 Tclass.M3.Expression $h@@36))) ($IsAlloc DatatypeTypeType (M3.Expression.disj1 d@@120) Tclass.M3.Expression $h@@36))
 :qid |unknown.0:0|
 :skolemid |7045|
 :pattern ( ($IsAlloc DatatypeTypeType (M3.Expression.disj1 d@@120) Tclass.M3.Expression $h@@36))
)))
(assert (forall ((d@@121 T@U) ($h@@37 T@U) ) (!  (=> (and ($IsGoodHeap $h@@37) (and (M3.Expression.exprInvocation_q d@@121) ($IsAlloc DatatypeTypeType d@@121 Tclass.M3.Expression $h@@37))) ($IsAlloc DatatypeTypeType (M3.Expression.fun d@@121) Tclass.M3.Expression $h@@37))
 :qid |unknown.0:0|
 :skolemid |7056|
 :pattern ( ($IsAlloc DatatypeTypeType (M3.Expression.fun d@@121) Tclass.M3.Expression $h@@37))
)))
(assert (forall ((d@@122 T@U) ($h@@38 T@U) ) (!  (=> (and ($IsGoodHeap $h@@38) (and (M3.Expression.exprError_q d@@122) ($IsAlloc DatatypeTypeType d@@122 Tclass.M3.Expression $h@@38))) ($IsAlloc DatatypeTypeType (M3.Expression.r d@@122) Tclass.M3.Reason $h@@38))
 :qid |unknown.0:0|
 :skolemid |7070|
 :pattern ( ($IsAlloc DatatypeTypeType (M3.Expression.r d@@122) Tclass.M3.Reason $h@@38))
)))
(assert (forall ((d@@123 T@U) ($h@@39 T@U) ) (!  (=> (and ($IsGoodHeap $h@@39) (and (M3.Literal.litPrimitive_q d@@123) ($IsAlloc DatatypeTypeType d@@123 Tclass.M3.Literal $h@@39))) ($IsAlloc DatatypeTypeType (M3.Literal.prim d@@123) Tclass.M3.Primitive $h@@39))
 :qid |unknown.0:0|
 :skolemid |7116|
 :pattern ( ($IsAlloc DatatypeTypeType (M3.Literal.prim d@@123) Tclass.M3.Primitive $h@@39))
)))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@56| T@U) (|st'#0@@10| T@U) ) (!  (=> (or (|M3.__default.Union#canCall| |st#0@@56| |st'#0@@10|) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@56| Tclass.M3.State) ($Is DatatypeTypeType |st'#0@@10| Tclass.M3.State)))) (and (forall ((|p#1@@7| T@U) ) (!  (=> ($Is DatatypeTypeType |p#1@@7| Tclass.M3.Path) (and (and (|M3.__default.DomSt#canCall| |st#0@@56|) (|M3.__default.DomSt#canCall| |st'#0@@10|)) (=> (|Set#IsMember| (|Set#Union| (M3.__default.DomSt |st#0@@56|) (M3.__default.DomSt |st'#0@@10|)) ($Box DatatypeTypeType |p#1@@7|)) (and (|M3.__default.DomSt#canCall| |st#0@@56|) (|M3.__default.GetSt#canCall| |p#1@@7| (ite (|Set#IsMember| (M3.__default.DomSt |st#0@@56|) ($Box DatatypeTypeType |p#1@@7|)) |st#0@@56| |st'#0@@10|))))))
 :qid |CloudMakeParallelBuildsdfy.770:19|
 :skolemid |5660|
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@56|) ($Box DatatypeTypeType |p#1@@7|)))
 :pattern ( (|Set#IsMember| (|Set#Union| (M3.__default.DomSt |st#0@@56|) (M3.__default.DomSt |st'#0@@10|)) ($Box DatatypeTypeType |p#1@@7|)))
)) (= (M3.__default.Union |st#0@@56| |st'#0@@10|) (|#M3.State.StateCons| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#0| Tclass.M3.Path (|Set#Union| (M3.__default.DomSt |st#0@@56|) (M3.__default.DomSt |st'#0@@10|)))) (|lambda#1| (M3.__default.DomSt |st#0@@56|) |st#0@@56| |st'#0@@10|) (TMap Tclass.M3.Path Tclass.M3.Artifact))))))
 :qid |CloudMakeParallelBuildsdfy.23:24|
 :skolemid |5661|
 :pattern ( (M3.__default.Union |st#0@@56| |st'#0@@10|))
))))
(assert (forall ((certs T@U) (d@@124 T@U) ) (!  (=> (|$let#36$canCall| certs d@@124) (and ($Is DatatypeTypeType (|$let#36_c| certs d@@124) Tclass.M3.WFCertificate) (and (|Set#IsMember| certs ($Box DatatypeTypeType (|$let#36_c| certs d@@124))) (|M3.Path#Equal| (M3.WFCertificate.p (|$let#36_c| certs d@@124)) d@@124))))
 :qid |CloudMakeParallelBuildsdfy.669:5|
 :skolemid |6109|
 :pattern ( (|$let#36_c| certs d@@124))
)))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@57| T@U) (|st'#0@@11| T@U) ) (!  (=> (or (|M3.__default.Union#canCall| (Lit DatatypeTypeType |st#0@@57|) (Lit DatatypeTypeType |st'#0@@11|)) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@57| Tclass.M3.State) ($Is DatatypeTypeType |st'#0@@11| Tclass.M3.State)))) (and (forall ((|p#1@@8| T@U) ) (!  (=> ($Is DatatypeTypeType |p#1@@8| Tclass.M3.Path) (and (and (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@57|)) (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st'#0@@11|))) (=> (|Set#IsMember| (|Set#Union| (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@57|)) (M3.__default.DomSt (Lit DatatypeTypeType |st'#0@@11|))) ($Box DatatypeTypeType |p#1@@8|)) (and (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@57|)) (|M3.__default.GetSt#canCall| |p#1@@8| (ite (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@57|))) ($Box DatatypeTypeType |p#1@@8|)) |st#0@@57| |st'#0@@11|))))))
 :qid |CloudMakeParallelBuildsdfy.770:19|
 :skolemid |5662|
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@57|) ($Box DatatypeTypeType |p#1@@8|)))
 :pattern ( (|Set#IsMember| (|Set#Union| (M3.__default.DomSt |st#0@@57|) (M3.__default.DomSt |st'#0@@11|)) ($Box DatatypeTypeType |p#1@@8|)))
)) (= (M3.__default.Union (Lit DatatypeTypeType |st#0@@57|) (Lit DatatypeTypeType |st'#0@@11|)) (|#M3.State.StateCons| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#0| Tclass.M3.Path (|Set#Union| (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@57|)) (M3.__default.DomSt (Lit DatatypeTypeType |st'#0@@11|))))) (|lambda#1| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@57|))) |st#0@@57| |st'#0@@11|) (TMap Tclass.M3.Path Tclass.M3.Artifact))))))
 :qid |CloudMakeParallelBuildsdfy.23:24|
 :weight 3
 :skolemid |5663|
 :pattern ( (M3.__default.Union (Lit DatatypeTypeType |st#0@@57|) (Lit DatatypeTypeType |st'#0@@11|)))
))))
...
(assert (forall ((|a#34#0#0| T@U) (d@@125 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#34#0#0|) ($Box DatatypeTypeType d@@125)) (< (DtRank d@@125) (DtRank (|#M3.Env.EnvCons| |a#34#0#0|))))
 :qid |CloudMakeParallelBuildsdfy.819:26|
 :skolemid |6913|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#34#0#0|) ($Box DatatypeTypeType d@@125)) (|#M3.Env.EnvCons| |a#34#0#0|))
)))
(assert (forall ((|a#49#0#0| T@U) (d@@126 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#49#0#0|) ($Box DatatypeTypeType d@@126)) (< (DtRank d@@126) (DtRank (|#M3.State.StateCons| |a#49#0#0|))))
 :qid |CloudMakeParallelBuildsdfy.433:30|
 :skolemid |6945|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#49#0#0|) ($Box DatatypeTypeType d@@126)) (|#M3.State.StateCons| |a#49#0#0|))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|p#0@@53| T@U) (|a#0@@4| T@U) (|st#0@@58| T@U) ) (!  (=> (or (|M3.__default.SetSt#canCall| |p#0@@53| |a#0@@4| |st#0@@58|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |p#0@@53| Tclass.M3.Path) ($Is DatatypeTypeType |a#0@@4| Tclass.M3.Artifact)) ($Is DatatypeTypeType |st#0@@58| Tclass.M3.State)))) (and (M3.State.StateCons_q |st#0@@58|) (= (M3.__default.SetSt |p#0@@53| |a#0@@4| |st#0@@58|) (|#M3.State.StateCons| (|Map#Build| (M3.State.m |st#0@@58|) ($Box DatatypeTypeType |p#0@@53|) ($Box DatatypeTypeType |a#0@@4|))))))
 :qid |CloudMakeParallelBuildsdfy.468:24|
 :skolemid |5729|
 :pattern ( (M3.__default.SetSt |p#0@@53| |a#0@@4| |st#0@@58|))
))))
...
(assert (forall ((d@@127 T@U) ($h@@40 T@U) ) (!  (=> (and ($IsGoodHeap $h@@40) (and (M3.Literal.litArrOfStrings_q d@@127) ($IsAlloc DatatypeTypeType d@@127 Tclass.M3.Literal $h@@40))) ($IsAlloc SetType (M3.Literal.strs d@@127) (TSet (TSeq TChar)) $h@@40))
 :qid |unknown.0:0|
 :skolemid |7134|
 :pattern ( ($IsAlloc SetType (M3.Literal.strs d@@127) (TSet (TSeq TChar)) $h@@40))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|paths#0@@2| T@U) (|st#0@@59| T@U) ) (!  (=> (or (|M3.__default.Restrict#canCall| (Lit SetType |paths#0@@2|) (Lit DatatypeTypeType |st#0@@59|)) (and (< 4 $FunctionContextHeight) (and ($Is SetType |paths#0@@2| (TSet Tclass.M3.Path)) ($Is DatatypeTypeType |st#0@@59| Tclass.M3.State)))) (and (forall ((|p#0@@54| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@54| Tclass.M3.Path) (and (=> (|Set#IsMember| (Lit SetType |paths#0@@2|) ($Box DatatypeTypeType |p#0@@54|)) (|M3.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@59|))) (=> (and (|Set#IsMember| (Lit SetType |paths#0@@2|) ($Box DatatypeTypeType |p#0@@54|)) (|Set#IsMember| (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@59|))) ($Box DatatypeTypeType |p#0@@54|))) (|M3.__default.GetSt#canCall| |p#0@@54| (Lit DatatypeTypeType |st#0@@59|)))))
 :qid |CloudMakeParallelBuildsdfy.475:9|
 :skolemid |5736|
 :pattern ( (M3.__default.GetSt |p#0@@54| |st#0@@59|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@59|) ($Box DatatypeTypeType |p#0@@54|)))
 :pattern ( (|Set#IsMember| |paths#0@@2| ($Box DatatypeTypeType |p#0@@54|)))
)) (= (M3.__default.Restrict (Lit SetType |paths#0@@2|) (Lit DatatypeTypeType |st#0@@59|)) (|Map#Glue| (|Set#FromBoogieMap| (|lambda#16| Tclass.M3.Path (Lit SetType |paths#0@@2|) (Lit SetType (M3.__default.DomSt (Lit DatatypeTypeType |st#0@@59|))))) (|lambda#17| (Lit DatatypeTypeType |st#0@@59|)) (TMap Tclass.M3.Path Tclass.M3.Artifact)))))
 :qid |CloudMakeParallelBuildsdfy.473:27|
 :weight 3
 :skolemid |5737|
 :pattern ( (M3.__default.Restrict (Lit SetType |paths#0@@2|) (Lit DatatypeTypeType |st#0@@59|)))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|cmd#0@@19| T@U) (|deps#0@@24| T@U) (|exps#0@@10| T@U) (|st#0@@60| T@U) ) (!  (=> (or (|M3.__default.exec#canCall| (Lit SeqType |cmd#0@@19|) (Lit SetType |deps#0@@24|) (Lit SetType |exps#0@@10|) |st#0@@60|) (and (< 5 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@19| (TSeq TChar)) ($Is SetType |deps#0@@24| (TSet Tclass.M3.Path))) ($Is SetType |exps#0@@10| (TSet (TSeq TChar)))) ($Is DatatypeTypeType |st#0@@60| Tclass.M3.State)))) (and (and (|M3.__default.Restrict#canCall| (Lit SetType |deps#0@@24|) |st#0@@60|) (|M3.__default.execOne#canCall| (Lit SeqType |cmd#0@@19|) (Lit SetType |deps#0@@24|) (M3.__default.Restrict (Lit SetType |deps#0@@24|) |st#0@@60|) (Lit SetType |exps#0@@10|) |st#0@@60|)) (= (M3.__default.exec (Lit SeqType |cmd#0@@19|) (Lit SetType |deps#0@@24|) (Lit SetType |exps#0@@10|) |st#0@@60|) (M3.__default.execOne ($LS $LZ) (Lit SeqType |cmd#0@@19|) (Lit SetType |deps#0@@24|) (M3.__default.Restrict (Lit SetType |deps#0@@24|) |st#0@@60|) (Lit SetType |exps#0@@10|) |st#0@@60|))))
 :qid |CloudMakeParallelBuildsdfy.69:23|
 :weight 3
 :skolemid |5822|
 :pattern ( (M3.__default.exec (Lit SeqType |cmd#0@@19|) (Lit SetType |deps#0@@24|) (Lit SetType |exps#0@@10|) |st#0@@60|))
))))
...
(assert (forall ((d@@128 T@U) ($h@@41 T@U) ) (!  (=> (and ($IsGoodHeap $h@@41) (and (M3.Path.InternalPath_q d@@128) ($IsAlloc DatatypeTypeType d@@128 Tclass.M3.Path $h@@41))) ($IsAlloc SetType (M3.Path.deps d@@128) (TSet Tclass.M3.Path) $h@@41))
 :qid |unknown.0:0|
 :skolemid |6878|
 :pattern ( ($IsAlloc SetType (M3.Path.deps d@@128) (TSet Tclass.M3.Path) $h@@41))
)))
(assert (forall ((d@@129 T@U) ($h@@42 T@U) ) (!  (=> (and ($IsGoodHeap $h@@42) (and (M3.WFCertificate.Cert_q d@@129) ($IsAlloc DatatypeTypeType d@@129 Tclass.M3.WFCertificate $h@@42))) ($IsAlloc SetType (M3.WFCertificate.certs d@@129) (TSet Tclass.M3.WFCertificate) $h@@42))
 :qid |unknown.0:0|
 :skolemid |6926|
 :pattern ( ($IsAlloc SetType (M3.WFCertificate.certs d@@129) (TSet Tclass.M3.WFCertificate) $h@@42))
)))
(assert (forall ((d@@130 T@U) ($h@@43 T@U) ) (!  (=> (and ($IsGoodHeap $h@@43) (and (M3.Expression.exprInvocation_q d@@130) ($IsAlloc DatatypeTypeType d@@130 Tclass.M3.Expression $h@@43))) ($IsAlloc SeqType (M3.Expression.args d@@130) (TSeq Tclass.M3.Expression) $h@@43))
 :qid |unknown.0:0|
 :skolemid |7057|
 :pattern ( ($IsAlloc SeqType (M3.Expression.args d@@130) (TSeq Tclass.M3.Expression) $h@@43))
)))
(assert (forall ((d@@131 T@U) ($h@@44 T@U) ) (!  (=> (and ($IsGoodHeap $h@@44) (and (M3.Literal.litArrOfPaths_q d@@131) ($IsAlloc DatatypeTypeType d@@131 Tclass.M3.Literal $h@@44))) ($IsAlloc SetType (M3.Literal.paths d@@131) (TSet Tclass.M3.Path) $h@@44))
 :qid |unknown.0:0|
 :skolemid |7125|
 :pattern ( ($IsAlloc SetType (M3.Literal.paths d@@131) (TSet Tclass.M3.Path) $h@@44))
)))
(assert (forall ((d@@132 T@U) ($h@@45 T@U) ) (!  (=> (and ($IsGoodHeap $h@@45) (and (M3.Literal.litArray_q d@@132) ($IsAlloc DatatypeTypeType d@@132 Tclass.M3.Literal $h@@45))) ($IsAlloc SeqType (M3.Literal.arr d@@132) (TSeq Tclass.M3.Expression) $h@@45))
 :qid |unknown.0:0|
 :skolemid |7143|
 :pattern ( ($IsAlloc SeqType (M3.Literal.arr d@@132) (TSeq Tclass.M3.Expression) $h@@45))
)))
...
(set-info :boogie-vc-id Impl$$M3.__default.DoLemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 31) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> false (|M3.Tuple#Equal| (|#M3.Tuple.Pair| ($Box DatatypeTypeType |$rhs#0@0|) ($Box DatatypeTypeType |$rhs#1@0|)) (M3.__default.do ($LS ($LS $LZ)) |stmts#0@@6| |st#0@@61| |env#0@@23|)))) (=> (=> false (|M3.Tuple#Equal| (|#M3.Tuple.Pair| ($Box DatatypeTypeType |$rhs#0@0|) ($Box DatatypeTypeType |$rhs#1@0|)) (M3.__default.do ($LS ($LS $LZ)) |stmts#0@@6| |st#0@@61| |env#0@@23|))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> false (=> (|M3.__default.ValidState#canCall| |$rhs#1@0|) (or (M3.__default.ValidState |$rhs#1@0|) (forall ((|p#5| T@U) ) (!  (=> ($Is DatatypeTypeType |p#5| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |$rhs#1@0|) ($Box DatatypeTypeType |p#5|)) (M3.__default.WellFounded |p#5|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6788|
...
))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> false (=> (|M3.__default.Extends#canCall| |st#0@@61| |$rhs#1@0|) (or (M3.__default.Extends |st#0@@61| |$rhs#1@0|) (|Set#Subset| (M3.__default.DomSt |st#0@@61|) (M3.__default.DomSt |$rhs#1@0|)))))) (=> (=> false (=> (|M3.__default.Extends#canCall| |st#0@@61| |$rhs#1@0|) (or (M3.__default.Extends |st#0@@61| |$rhs#1@0|) (|Set#Subset| (M3.__default.DomSt |st#0@@61|) (M3.__default.DomSt |$rhs#1@0|))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> false (=> (|M3.__default.Extends#canCall| |st#0@@61| |$rhs#1@0|) (or (M3.__default.Extends |st#0@@61| |$rhs#1@0|) (forall ((|p#6| T@U) ) (!  (=> ($Is DatatypeTypeType |p#6| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#6|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#6| |$rhs#1@0|) (M3.__default.GetSt |p#6| |st#0@@61|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6790|
 :pattern ( (M3.__default.GetSt |p#6| |st#0@@61|))
 :pattern ( (M3.__default.GetSt |p#6| |$rhs#1@0|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#6|)))
)))))) (=> (=> false (=> (|M3.__default.Extends#canCall| |st#0@@61| |$rhs#1@0|) (or (M3.__default.Extends |st#0@@61| |$rhs#1@0|) (forall ((|p#6@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |p#6@@0| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#6@@0|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#6@@0| |$rhs#1@0|) (M3.__default.GetSt |p#6@@0| |st#0@@61|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6790|
 :pattern ( (M3.__default.GetSt |p#6@@0| |st#0@@61|))
 :pattern ( (M3.__default.GetSt |p#6@@0| |$rhs#1@0|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#6@@0|)))
))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> false (=> (|M3.__default.Extends#canCall| |st#0@@61| |$rhs#1@0|) (or (M3.__default.Extends |st#0@@61| |$rhs#1@0|) (forall ((|p#7| T@U) ) (!  (=> ($Is DatatypeTypeType |p#7| Tclass.M3.Path) (=> (and (not (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#7|))) (|Set#IsMember| (M3.__default.DomSt |$rhs#1@0|) ($Box DatatypeTypeType |p#7|))) (|M3.Artifact#Equal| (M3.__default.GetSt |p#7| |$rhs#1@0|) (M3.__default.Oracle |p#7| |st#0@@61|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |6791|
 :pattern ( (M3.__default.Oracle |p#7| |st#0@@61|))
 :pattern ( (M3.__default.GetSt |p#7| |$rhs#1@0|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |$rhs#1@0|) ($Box DatatypeTypeType |p#7|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#7|)))
)))))) (=> (=> false (=> (|M3.__default.Extends#canCall| |st#0@@61| |$rhs#1@0|) (or (M3.__default.Extends |st#0@@61| |$rhs#1@0|) (forall ((|p#7@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |p#7@@0| Tclass.M3.Path) (=> (and (not (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#7@@0|))) (|Set#IsMember| (M3.__default.DomSt |$rhs#1@0|) ($Box DatatypeTypeType |p#7@@0|))) (|M3.Artifact#Equal| (M3.__default.GetSt |p#7@@0| |$rhs#1@0|) (M3.__default.Oracle |p#7@@0| |st#0@@61|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |6791|
 :pattern ( (M3.__default.Oracle |p#7@@0| |st#0@@61|))
 :pattern ( (M3.__default.GetSt |p#7@@0| |$rhs#1@0|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |$rhs#1@0|) ($Box DatatypeTypeType |p#7@@0|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#7@@0|)))
))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (=> (M3.Expression.exprError_q |$rhs#0@0|) (|M3.Reason#Equal| (M3.Expression.r |$rhs#0@0|) |#M3.Reason.rValidity|))))))))))))))))
(let ((anon11_Else_correct  (=> (and (not (M3.__default.Legal (|Seq#Drop| |stmts#0@@6| (LitInt 1)))) (= (ControlFlow 0 25) 2)) GeneratedUnifiedExit_correct)))
(let ((anon11_Then_correct  (=> (M3.__default.Legal (|Seq#Drop| |stmts#0@@6| (LitInt 1))) (=> (and (and (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |stmts#0@@6|))) (and (= |stmts##0_0_0_0@0| (|Seq#Drop| |stmts#0@@6| (LitInt 1))) (< (|Seq#Rank| |stmts##0_0_0_0@0|) (|Seq#Rank| |stmts#0@@6|)))) (and (and ($Is DatatypeTypeType |call4formal@expr'#0| Tclass.M3.Expression) ($IsAlloc DatatypeTypeType |call4formal@expr'#0| Tclass.M3.Expression $Heap@@21)) (and ($Is DatatypeTypeType |call5formal@st'#0| Tclass.M3.State) ($IsAlloc DatatypeTypeType |call5formal@st'#0| Tclass.M3.State $Heap@@21)))) (and (=> (= (ControlFlow 0 15) (- 0 24)) (=> (|M3.__default.Legal#canCall| |stmts##0_0_0_0@0|) (or (M3.__default.Legal |stmts##0_0_0_0@0|) (or (not (= (|Seq#Length| |stmts##0_0_0_0@0|) 0)) (not true))))) (=> (=> (|M3.__default.Legal#canCall| |stmts##0_0_0_0@0|) (or (M3.__default.Legal |stmts##0_0_0_0@0|) (or (not (= (|Seq#Length| |stmts##0_0_0_0@0|) 0)) (not true)))) (and (=> (= (ControlFlow 0 15) (- 0 23)) (=> (|M3.__default.ValidState#canCall| |call5formal@st'#0@0|) (or (M3.__default.ValidState |call5formal@st'#0@0|) (forall ((|p#0@@55| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@55| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |call5formal@st'#0@0|) ($Box DatatypeTypeType |p#0@@55|)) (M3.__default.WellFounded |p#0@@55|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6778|
...
)))) (and (=> (= (ControlFlow 0 15) (- 0 22)) (M3.__default.ValidEnv |env'#0_0_0@0|)) (=> (M3.__default.ValidEnv |env'#0_0_0@0|) (=> (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (=> (and (and ($Is DatatypeTypeType |call4formal@expr'#0@0| Tclass.M3.Expression) ($IsAlloc DatatypeTypeType |call4formal@expr'#0@0| Tclass.M3.Expression $Heap@2)) (and ($Is DatatypeTypeType |call5formal@st'#0@0@@0| Tclass.M3.State) ($IsAlloc DatatypeTypeType |call5formal@st'#0@0@@0| Tclass.M3.State $Heap@2))) (=> (and (and (and (and (and (|$IsA#M3.Tuple| (M3.__default.do ($LS $LZ) |stmts##0_0_0_0@0| |call5formal@st'#0@0| |env'#0_0_0@0|)) (|M3.__default.do#canCall| |stmts##0_0_0_0@0| |call5formal@st'#0@0| |env'#0_0_0@0|)) (=> (|M3.Tuple#Equal| (|#M3.Tuple.Pair| ($Box DatatypeTypeType |call4formal@expr'#0@0|) ($Box DatatypeTypeType |call5formal@st'#0@0@@0|)) (M3.__default.do ($LS $LZ) |stmts##0_0_0_0@0| |call5formal@st'#0@0| |env'#0_0_0@0|)) (and (|M3.__default.ValidState#canCall| |call5formal@st'#0@0@@0|) (=> (M3.__default.ValidState |call5formal@st'#0@0@@0|) (and (|M3.__default.Extends#canCall| |call5formal@st'#0@0| |call5formal@st'#0@0@@0|) (=> (M3.__default.Extends |call5formal@st'#0@0| |call5formal@st'#0@0@@0|) (=> (M3.Expression.exprError_q |call4formal@expr'#0@0|) (|$IsA#M3.Reason| (M3.Expression.r |call4formal@expr'#0@0|))))))))) (|M3.Tuple#Equal| (|#M3.Tuple.Pair| ($Box DatatypeTypeType |call4formal@expr'#0@0|) ($Box DatatypeTypeType |call5formal@st'#0@0@@0|)) (M3.__default.do ($LS ($LS $LZ)) |stmts##0_0_0_0@0| |call5formal@st'#0@0| |env'#0_0_0@0|))) (and (|M3.__default.ValidState#canCall| |call5formal@st'#0@0@@0|) (and (M3.__default.ValidState |call5formal@st'#0@0@@0|) (forall ((|p#1@@9| T@U) ) (!  (=> ($Is DatatypeTypeType |p#1@@9| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |call5formal@st'#0@0@@0|) ($Box DatatypeTypeType |p#1@@9|)) (M3.__default.WellFounded |p#1@@9|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6781|
...
))))) (and (=> (M3.Expression.exprError_q |call4formal@expr'#0@0|) (|M3.Reason#Equal| (M3.Expression.r |call4formal@expr'#0@0|) |#M3.Reason.rValidity|)) (= $Heap@0 $Heap@2)))) (and (=> (= (ControlFlow 0 15) (- 0 21)) (=> (|M3.__default.Extends#canCall| |st#0@@61| |call5formal@st'#0@0|) (or (M3.__default.Extends |st#0@@61| |call5formal@st'#0@0|) (|Set#Subset| (M3.__default.DomSt |st#0@@61|) (M3.__default.DomSt |call5formal@st'#0@0|))))) (=> (=> (|M3.__default.Extends#canCall| |st#0@@61| |call5formal@st'#0@0|) (or (M3.__default.Extends |st#0@@61| |call5formal@st'#0@0|) (|Set#Subset| (M3.__default.DomSt |st#0@@61|) (M3.__default.DomSt |call5formal@st'#0@0|)))) (and (=> (= (ControlFlow 0 15) (- 0 20)) (=> (|M3.__default.Extends#canCall| |st#0@@61| |call5formal@st'#0@0|) (or (M3.__default.Extends |st#0@@61| |call5formal@st'#0@0|) (forall ((|p#0@@57| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@57| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#0@@57|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#0@@57| |call5formal@st'#0@0|) (M3.__default.GetSt |p#0@@57| |st#0@@61|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6640|
 :pattern ( (M3.__default.GetSt |p#0@@57| |st#0@@61|))
 :pattern ( (M3.__default.GetSt |p#0@@57| |call5formal@st'#0@0|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#0@@57|)))
))))) (=> (=> (|M3.__default.Extends#canCall| |st#0@@61| |call5formal@st'#0@0|) (or (M3.__default.Extends |st#0@@61| |call5formal@st'#0@0|) (forall ((|p#0@@58| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@58| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#0@@58|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#0@@58| |call5formal@st'#0@0|) (M3.__default.GetSt |p#0@@58| |st#0@@61|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6640|
 :pattern ( (M3.__default.GetSt |p#0@@58| |st#0@@61|))
 :pattern ( (M3.__default.GetSt |p#0@@58| |call5formal@st'#0@0|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#0@@58|)))
)))) (and (=> (= (ControlFlow 0 15) (- 0 19)) (=> (|M3.__default.Extends#canCall| |st#0@@61| |call5formal@st'#0@0|) (or (M3.__default.Extends |st#0@@61| |call5formal@st'#0@0|) (forall ((|p#1@@10| T@U) ) (!  (=> ($Is DatatypeTypeType |p#1@@10| Tclass.M3.Path) (=> (and (not (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#1@@10|))) (|Set#IsMember| (M3.__default.DomSt |call5formal@st'#0@0|) ($Box DatatypeTypeType |p#1@@10|))) (|M3.Artifact#Equal| (M3.__default.GetSt |p#1@@10| |call5formal@st'#0@0|) (M3.__default.Oracle |p#1@@10| |st#0@@61|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |6641|
 :pattern ( (M3.__default.Oracle |p#1@@10| |st#0@@61|))
 ...
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#1@@10|)))
))))) (=> (=> (|M3.__default.Extends#canCall| |st#0@@61| |call5formal@st'#0@0|) (or (M3.__default.Extends |st#0@@61| |call5formal@st'#0@0|) (forall ((|p#1@@11| T@U) ) (!  (=> ($Is DatatypeTypeType |p#1@@11| Tclass.M3.Path) (=> (and (not (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#1@@11|))) (|Set#IsMember| (M3.__default.DomSt |call5formal@st'#0@0|) ($Box DatatypeTypeType |p#1@@11|))) (|M3.Artifact#Equal| (M3.__default.GetSt |p#1@@11| |call5formal@st'#0@0|) (M3.__default.Oracle |p#1@@11| |st#0@@61|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |6641|
 :pattern ( (M3.__default.Oracle |p#1@@11| |st#0@@61|))
 ...
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#1@@11|)))
)))) (and (=> (= (ControlFlow 0 15) (- 0 18)) (=> (|M3.__default.Extends#canCall| |call5formal@st'#0@0| |call5formal@st'#0@0@@0|) (or (M3.__default.Extends |call5formal@st'#0@0| |call5formal@st'#0@0@@0|) (|Set#Subset| (M3.__default.DomSt |call5formal@st'#0@0|) (M3.__default.DomSt |call5formal@st'#0@0@@0|))))) (=> (=> (|M3.__default.Extends#canCall| |call5formal@st'#0@0| |call5formal@st'#0@0@@0|) (or (M3.__default.Extends |call5formal@st'#0@0| |call5formal@st'#0@0@@0|) (|Set#Subset| (M3.__default.DomSt |call5formal@st'#0@0|) (M3.__default.DomSt |call5formal@st'#0@0@@0|)))) (and (=> (= (ControlFlow 0 15) (- 0 17)) (=> (|M3.__default.Extends#canCall| |call5formal@st'#0@0| |call5formal@st'#0@0@@0|) (or (M3.__default.Extends |call5formal@st'#0@0| |call5formal@st'#0@0@@0|) (forall ((|p#2@@3| T@U) ) (!  (=> ($Is DatatypeTypeType |p#2@@3| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |call5formal@st'#0@0|) ($Box DatatypeTypeType |p#2@@3|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#2@@3| |call5formal@st'#0@0@@0|) (M3.__default.GetSt |p#2@@3| |call5formal@st'#0@0|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6644|
...
)))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (=> (|M3.__default.Extends#canCall| |call5formal@st'#0@0| |call5formal@st'#0@0@@0|) (or (M3.__default.Extends |call5formal@st'#0@0| |call5formal@st'#0@0@@0|) (forall ((|p#3@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |p#3@@2| Tclass.M3.Path) (=> (and (not (|Set#IsMember| (M3.__default.DomSt |call5formal@st'#0@0|) ($Box DatatypeTypeType |p#3@@2|))) (|Set#IsMember| (M3.__default.DomSt |call5formal@st'#0@0@@0|) ($Box DatatypeTypeType |p#3@@2|))) (|M3.Artifact#Equal| (M3.__default.GetSt |p#3@@2| |call5formal@st'#0@0@@0|) (M3.__default.Oracle |p#3@@2| |call5formal@st'#0@0|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |6645|
...
)))) (=> (and (and (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (|M3.__default.Extends#canCall| |st#0@@61| |call5formal@st'#0@0@@0|)) (and (and (|M3.__default.Extends#canCall| |st#0@@61| |call5formal@st'#0@0@@0|) (and (M3.__default.Extends |st#0@@61| |call5formal@st'#0@0@@0|) (and (and (|Set#Subset| (M3.__default.DomSt |st#0@@61|) (M3.__default.DomSt |call5formal@st'#0@0@@0|)) (forall ((|p#4| T@U) ) (!  (=> ($Is DatatypeTypeType |p#4| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#4|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#4| |call5formal@st'#0@0@@0|) (M3.__default.GetSt |p#4| |st#0@@61|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6650|
 :pattern ( (M3.__default.GetSt |p#4| |st#0@@61|))
 :pattern ( (M3.__default.GetSt |p#4| |call5formal@st'#0@0@@0|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#4|)))
))) (forall ((|p#5@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |p#5@@1| Tclass.M3.Path) (=> (and (not (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#5@@1|))) (|Set#IsMember| (M3.__default.DomSt |call5formal@st'#0@0@@0|) ($Box DatatypeTypeType |p#5@@1|))) (|M3.Artifact#Equal| (M3.__default.GetSt |p#5@@1| |call5formal@st'#0@0@@0|) (M3.__default.Oracle |p#5@@1| |st#0@@61|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |6651|
 :pattern ( (M3.__default.Oracle |p#5@@1| |st#0@@61|))
 ...
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#5@@1|)))
))))) (and (= $Heap@2 $Heap@3) (= (ControlFlow 0 15) 2)))) GeneratedUnifiedExit_correct))))))))))))))))))))))))))
(let ((anon10_Then_correct  (=> (and (M3.__default.Value |call4formal@expr'#0@0@@0|) (M3.Statement.stmtVariable_q |stmt#0@0|)) (=> (and (and (and (and (= |##id#0_0_0@0| (M3.Statement.id |stmt#0@0|)) ($IsAlloc DatatypeTypeType |##id#0_0_0@0| Tclass.M3.Identifier $Heap@0)) (and ($IsAlloc DatatypeTypeType |call4formal@expr'#0@0@@0| Tclass.M3.Expression $Heap@0) ($IsAlloc DatatypeTypeType |env#0@@23| Tclass.M3.Env $Heap@0))) (and (and (M3.__default.ValidEnv |env#0@@23|) (M3.__default.Value |call4formal@expr'#0@0@@0|)) (and (|M3.__default.SetEnv#canCall| (M3.Statement.id |stmt#0@0|) |call4formal@expr'#0@0@@0| |env#0@@23|) (M3.Env.EnvCons_q (M3.__default.SetEnv (M3.Statement.id |stmt#0@0|) |call4formal@expr'#0@0@@0| |env#0@@23|))))) (and (and (and (|M3.__default.SetEnv#canCall| (M3.Statement.id |stmt#0@0|) |call4formal@expr'#0@0@@0| |env#0@@23|) (= |env'#0_0_0@0| (M3.__default.SetEnv (M3.Statement.id |stmt#0@0|) |call4formal@expr'#0@0@@0| |env#0@@23|))) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |stmts#0@@6|)))) (and (and (= |##stmts#0_0_0@0| (|Seq#Drop| |stmts#0@@6| (LitInt 1))) ($IsAlloc SeqType |##stmts#0_0_0@0| (TSeq Tclass.M3.Statement) $Heap@0)) (and (|M3.__default.Legal#canCall| (|Seq#Drop| |stmts#0@@6| (LitInt 1))) (|M3.__default.Legal#canCall| (|Seq#Drop| |stmts#0@@6| (LitInt 1))))))) (and (=> (= (ControlFlow 0 26) 15) anon11_Then_correct) (=> (= (ControlFlow 0 26) 25) anon11_Else_correct))))))
(let ((anon10_Else_correct  (=> (and (not (M3.__default.Value |call4formal@expr'#0@0@@0|)) (= (ControlFlow 0 14) 2)) GeneratedUnifiedExit_correct)))
(let ((anon9_Then_correct  (=> (M3.Statement.stmtVariable_q |stmt#0@0|) (=> (and (M3.Statement.stmtVariable_q |stmt#0@0|) (= |expr##0_0@0| (M3.Statement.expr |stmt#0@0|))) (=> (and (and ($Is DatatypeTypeType |call4formal@expr'#0@@0| Tclass.M3.Expression) ($IsAlloc DatatypeTypeType |call4formal@expr'#0@@0| Tclass.M3.Expression $Heap@@21)) (and ($Is DatatypeTypeType |call5formal@st'#0@@0| Tclass.M3.State) ($IsAlloc DatatypeTypeType |call5formal@st'#0@@0| Tclass.M3.State $Heap@@21))) (and (=> (= (ControlFlow 0 27) (- 0 29)) (=> (|M3.__default.ValidState#canCall| |st#0@@61|) (or (M3.__default.ValidState |st#0@@61|) (forall ((|p#0@@59| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@59| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#0@@59|)) (M3.__default.WellFounded |p#0@@59|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6798|
 :pattern ( (M3.__default.WellFounded |p#0@@59|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#0@@59|)))
))))) (=> (=> (|M3.__default.ValidState#canCall| |st#0@@61|) (or (M3.__default.ValidState |st#0@@61|) (forall ((|p#0@@60| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@60| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#0@@60|)) (M3.__default.WellFounded |p#0@@60|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6798|
 :pattern ( (M3.__default.WellFounded |p#0@@60|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#0@@60|)))
)))) (and (=> (= (ControlFlow 0 27) (- 0 28)) (M3.__default.ValidEnv |env#0@@23|)) (=> (M3.__default.ValidEnv |env#0@@23|) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and ($Is DatatypeTypeType |call4formal@expr'#0@0@@0| Tclass.M3.Expression) ($IsAlloc DatatypeTypeType |call4formal@expr'#0@0@@0| Tclass.M3.Expression $Heap@0)) (and ($Is DatatypeTypeType |call5formal@st'#0@0| Tclass.M3.State) ($IsAlloc DatatypeTypeType |call5formal@st'#0@0| Tclass.M3.State $Heap@0))) (=> (and (and (and (and (and (|$IsA#M3.Tuple| (M3.__default.eval ($LS $LZ) |expr##0_0@0| |st#0@@61| |env#0@@23|)) (|M3.__default.eval#canCall| |expr##0_0@0| |st#0@@61| |env#0@@23|)) (=> (|M3.Tuple#Equal| (|#M3.Tuple.Pair| ($Box DatatypeTypeType |call4formal@expr'#0@0@@0|) ($Box DatatypeTypeType |call5formal@st'#0@0|)) (M3.__default.eval ($LS $LZ) |expr##0_0@0| |st#0@@61| |env#0@@23|)) (and (|M3.__default.ValidState#canCall| |call5formal@st'#0@0|) (=> (M3.__default.ValidState |call5formal@st'#0@0|) (and (|M3.__default.Extends#canCall| |st#0@@61| |call5formal@st'#0@0|) (=> (M3.__default.Extends |st#0@@61| |call5formal@st'#0@0|) (=> (M3.Expression.exprError_q |call4formal@expr'#0@0@@0|) (|$IsA#M3.Reason| (M3.Expression.r |call4formal@expr'#0@0@@0|))))))))) (|M3.Tuple#Equal| (|#M3.Tuple.Pair| ($Box DatatypeTypeType |call4formal@expr'#0@0@@0|) ($Box DatatypeTypeType |call5formal@st'#0@0|)) (M3.__default.eval ($LS ($LS $LZ)) |expr##0_0@0| |st#0@@61| |env#0@@23|))) (and (|M3.__default.ValidState#canCall| |call5formal@st'#0@0|) (and (M3.__default.ValidState |call5formal@st'#0@0|) (forall ((|p#1@@12| T@U) ) (!  (=> ($Is DatatypeTypeType |p#1@@12| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |call5formal@st'#0@0|) ($Box DatatypeTypeType |p#1@@12|)) (M3.__default.WellFounded |p#1@@12|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6801|
 :pattern ( (M3.__default.WellFounded |p#1@@12|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |call5formal@st'#0@0|) ($Box DatatypeTypeType |p#1@@12|)))
))))) (and (and (and (|M3.__default.Extends#canCall| |st#0@@61| |call5formal@st'#0@0|) (and (M3.__default.Extends |st#0@@61| |call5formal@st'#0@0|) (and (and (|Set#Subset| (M3.__default.DomSt |st#0@@61|) (M3.__default.DomSt |call5formal@st'#0@0|)) (forall ((|p#2@@5| T@U) ) (!  (=> ($Is DatatypeTypeType |p#2@@5| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#2@@5|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#2@@5| |call5formal@st'#0@0|) (M3.__default.GetSt |p#2@@5| |st#0@@61|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6804|
 :pattern ( (M3.__default.GetSt |p#2@@5| |st#0@@61|))
 :pattern ( (M3.__default.GetSt |p#2@@5| |call5formal@st'#0@0|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#2@@5|)))
))) (forall ((|p#3@@4| T@U) ) (!  (=> ($Is DatatypeTypeType |p#3@@4| Tclass.M3.Path) (=> (and (not (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#3@@4|))) (|Set#IsMember| (M3.__default.DomSt |call5formal@st'#0@0|) ($Box DatatypeTypeType |p#3@@4|))) (|M3.Artifact#Equal| (M3.__default.GetSt |p#3@@4| |call5formal@st'#0@0|) (M3.__default.Oracle |p#3@@4| |st#0@@61|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |6805|
 :pattern ( (M3.__default.Oracle |p#3@@4| |st#0@@61|))
 :pattern ( (M3.__default.GetSt |p#3@@4| |call5formal@st'#0@0|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |call5formal@st'#0@0|) ($Box DatatypeTypeType |p#3@@4|)))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#3@@4|)))
))))) (=> (M3.Expression.exprError_q |call4formal@expr'#0@0@@0|) (|M3.Reason#Equal| (M3.Expression.r |call4formal@expr'#0@0@@0|) |#M3.Reason.rValidity|))) (and (and (= $Heap@@21 $Heap@0) ($IsAlloc DatatypeTypeType |call4formal@expr'#0@0@@0| Tclass.M3.Expression $Heap@0)) (and (|M3.__default.Value#canCall| |call4formal@expr'#0@0@@0|) (|M3.__default.Value#canCall| |call4formal@expr'#0@0@@0|))))) (and (=> (= (ControlFlow 0 27) 26) anon10_Then_correct) (=> (= (ControlFlow 0 27) 14) anon10_Else_correct))))))))))))))
(let ((anon8_correct  (=> (or (M3.Statement.stmtVariable_q |stmt#0@0|) (M3.Statement.stmtReturn_q |stmt#0@0|)) (=> (and (M3.Statement.stmtReturn_q |stmt#0@0|) (= |expr##1_0@0| (M3.Statement.ret |stmt#0@0|))) (=> (and (and ($Is DatatypeTypeType |call4formal@expr'#0@@1| Tclass.M3.Expression) ($IsAlloc DatatypeTypeType |call4formal@expr'#0@@1| Tclass.M3.Expression $Heap@@21)) (and ($Is DatatypeTypeType |call5formal@st'#0@@1| Tclass.M3.State) ($IsAlloc DatatypeTypeType |call5formal@st'#0@@1| Tclass.M3.State $Heap@@21))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (=> (|M3.__default.ValidState#canCall| |st#0@@61|) (or (M3.__default.ValidState |st#0@@61|) (forall ((|p#0@@61| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@61| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#0@@61|)) (M3.__default.WellFounded |p#0@@61|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6798|
 :pattern ( (M3.__default.WellFounded |p#0@@61|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#0@@61|)))
))))) (=> (=> (|M3.__default.ValidState#canCall| |st#0@@61|) (or (M3.__default.ValidState |st#0@@61|) (forall ((|p#0@@62| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@62| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#0@@62|)) (M3.__default.WellFounded |p#0@@62|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6798|
 :pattern ( (M3.__default.WellFounded |p#0@@62|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#0@@62|)))
)))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (M3.__default.ValidEnv |env#0@@23|)) (=> (M3.__default.ValidEnv |env#0@@23|) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and ($Is DatatypeTypeType |call4formal@expr'#0@0@@1| Tclass.M3.Expression) ($IsAlloc DatatypeTypeType |call4formal@expr'#0@0@@1| Tclass.M3.Expression $Heap@1)) (and ($Is DatatypeTypeType |call5formal@st'#0@0@@1| Tclass.M3.State) ($IsAlloc DatatypeTypeType |call5formal@st'#0@0@@1| Tclass.M3.State $Heap@1))) (=> (and (and (and (and (and (|$IsA#M3.Tuple| (M3.__default.eval ($LS $LZ) |expr##1_0@0| |st#0@@61| |env#0@@23|)) (|M3.__default.eval#canCall| |expr##1_0@0| |st#0@@61| |env#0@@23|)) (=> (|M3.Tuple#Equal| (|#M3.Tuple.Pair| ($Box DatatypeTypeType |call4formal@expr'#0@0@@1|) ($Box DatatypeTypeType |call5formal@st'#0@0@@1|)) (M3.__default.eval ($LS $LZ) |expr##1_0@0| |st#0@@61| |env#0@@23|)) (and (|M3.__default.ValidState#canCall| |call5formal@st'#0@0@@1|) (=> (M3.__default.ValidState |call5formal@st'#0@0@@1|) (and (|M3.__default.Extends#canCall| |st#0@@61| |call5formal@st'#0@0@@1|) (=> (M3.__default.Extends |st#0@@61| |call5formal@st'#0@0@@1|) (=> (M3.Expression.exprError_q |call4formal@expr'#0@0@@1|) (|$IsA#M3.Reason| (M3.Expression.r |call4formal@expr'#0@0@@1|))))))))) (|M3.Tuple#Equal| (|#M3.Tuple.Pair| ($Box DatatypeTypeType |call4formal@expr'#0@0@@1|) ($Box DatatypeTypeType |call5formal@st'#0@0@@1|)) (M3.__default.eval ($LS ($LS $LZ)) |expr##1_0@0| |st#0@@61| |env#0@@23|))) (and (|M3.__default.ValidState#canCall| |call5formal@st'#0@0@@1|) (and (M3.__default.ValidState |call5formal@st'#0@0@@1|) (forall ((|p#1@@13| T@U) ) (!  (=> ($Is DatatypeTypeType |p#1@@13| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |call5formal@st'#0@0@@1|) ($Box DatatypeTypeType |p#1@@13|)) (M3.__default.WellFounded |p#1@@13|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6801|
 :pattern ( (M3.__default.WellFounded |p#1@@13|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |call5formal@st'#0@0@@1|) ($Box DatatypeTypeType |p#1@@13|)))
))))) (and (and (and (|M3.__default.Extends#canCall| |st#0@@61| |call5formal@st'#0@0@@1|) (and (M3.__default.Extends |st#0@@61| |call5formal@st'#0@0@@1|) (and (and (|Set#Subset| (M3.__default.DomSt |st#0@@61|) (M3.__default.DomSt |call5formal@st'#0@0@@1|)) (forall ((|p#2@@6| T@U) ) (!  (=> ($Is DatatypeTypeType |p#2@@6| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#2@@6|)) (|M3.Artifact#Equal| (M3.__default.GetSt |p#2@@6| |call5formal@st'#0@0@@1|) (M3.__default.GetSt |p#2@@6| |st#0@@61|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |6804|
 :pattern ( (M3.__default.GetSt |p#2@@6| |st#0@@61|))
 :pattern ( (M3.__default.GetSt |p#2@@6| |call5formal@st'#0@0@@1|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#2@@6|)))
))) (forall ((|p#3@@5| T@U) ) (!  (=> ($Is DatatypeTypeType |p#3@@5| Tclass.M3.Path) (=> (and (not (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#3@@5|))) (|Set#IsMember| (M3.__default.DomSt |call5formal@st'#0@0@@1|) ($Box DatatypeTypeType |p#3@@5|))) (|M3.Artifact#Equal| (M3.__default.GetSt |p#3@@5| |call5formal@st'#0@0@@1|) (M3.__default.Oracle |p#3@@5| |st#0@@61|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |6805|
 :pattern ( (M3.__default.Oracle |p#3@@5| |st#0@@61|))
 ...
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#3@@5|)))
))))) (=> (M3.Expression.exprError_q |call4formal@expr'#0@0@@1|) (|M3.Reason#Equal| (M3.Expression.r |call4formal@expr'#0@0@@1|) |#M3.Reason.rValidity|))) (and (= $Heap@@21 $Heap@1) (= (ControlFlow 0 8) 2)))) GeneratedUnifiedExit_correct))))))))))))
(let ((anon12_Else_correct  (=> (and (M3.Statement.stmtVariable_q |stmt#0@0|) (= (ControlFlow 0 12) 8)) anon8_correct)))
(let ((anon12_Then_correct  (=> (and (not (M3.Statement.stmtVariable_q |stmt#0@0|)) (= (ControlFlow 0 11) 8)) anon8_correct)))
(let ((anon9_Else_correct  (=> (not (M3.Statement.stmtVariable_q |stmt#0@0|)) (and (=> (= (ControlFlow 0 13) 11) anon12_Then_correct) (=> (= (ControlFlow 0 13) 12) anon12_Else_correct)))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#4| null $Heap@@21 alloc false)) ($IsAlloc SeqType |stmts#0@@6| (TSeq Tclass.M3.Statement) $Heap@@21)) (and ($IsAlloc DatatypeTypeType |st#0@@61| Tclass.M3.State $Heap@@21) ($IsAlloc DatatypeTypeType |env#0@@23| Tclass.M3.Env $Heap@@21))) (=> (and (and (and (and (M3.__default.Legal |stmts#0@@6|) (M3.__default.ValidEnv |env#0@@23|)) (and (|M3.__default.do#canCall| |stmts#0@@6| |st#0@@61| |env#0@@23|) (M3.Tuple.Pair_q (M3.__default.do ($LS $LZ) |stmts#0@@6| |st#0@@61| |env#0@@23|)))) (and (and (|M3.__default.do#canCall| |stmts#0@@6| |st#0@@61| |env#0@@23|) (= |result#0@0| (M3.__default.do ($LS $LZ) |stmts#0@@6| |st#0@@61| |env#0@@23|))) (and (M3.Tuple.Pair_q |result#0@0|) (M3.Tuple.Pair_q |result#0@0|)))) (and (and (and (= |$rhs#0@0| ($Unbox DatatypeTypeType (M3.Tuple.fst |result#0@0|))) (M3.Tuple.Pair_q |result#0@0|)) (and (M3.Tuple.Pair_q |result#0@0|) (= |$rhs#1@0| ($Unbox DatatypeTypeType (M3.Tuple.snd |result#0@0|))))) (and (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |stmts#0@@6|))) (= |stmt#0@0| ($Unbox DatatypeTypeType (|Seq#Index| |stmts#0@@6| (LitInt 0))))))) (and (=> (= (ControlFlow 0 30) 27) anon9_Then_correct) (=> (= (ControlFlow 0 30) 13) anon9_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@21) ($IsHeapAnchor $Heap@@21)) (and ($Is SeqType |stmts#0@@6| (TSeq Tclass.M3.Statement)) ($IsAlloc SeqType |stmts#0@@6| (TSeq Tclass.M3.Statement) $Heap@@21))) (and (and ($Is DatatypeTypeType |st#0@@61| Tclass.M3.State) ($IsAlloc DatatypeTypeType |st#0@@61| Tclass.M3.State $Heap@@21)) (|$IsA#M3.State| |st#0@@61|))) (and (and (and ($Is DatatypeTypeType |env#0@@23| Tclass.M3.Env) ($IsAlloc DatatypeTypeType |env#0@@23| Tclass.M3.Env $Heap@@21)) (|$IsA#M3.Env| |env#0@@23|)) (and (and ($Is DatatypeTypeType |expr'#0@@1| Tclass.M3.Expression) ($IsAlloc DatatypeTypeType |expr'#0@@1| Tclass.M3.Expression $Heap@@21)) (and ($Is DatatypeTypeType |st'#0@@12| Tclass.M3.State) ($IsAlloc DatatypeTypeType |st'#0@@12| Tclass.M3.State $Heap@@21))))) (=> (and (and (and (and (and (and ($Is DatatypeTypeType |result#0@@0| (Tclass.M3.Tuple Tclass.M3.Expression Tclass.M3.State)) ($IsAlloc DatatypeTypeType |result#0@@0| (Tclass.M3.Tuple Tclass.M3.Expression Tclass.M3.State) $Heap@@21)) true) (and (and ($Is DatatypeTypeType |stmt#0@@1| Tclass.M3.Statement) ($IsAlloc DatatypeTypeType |stmt#0@@1| Tclass.M3.Statement $Heap@@21)) true)) (and (and (and ($Is DatatypeTypeType |expr'#0_0| Tclass.M3.Expression) ($IsAlloc DatatypeTypeType |expr'#0_0| Tclass.M3.Expression $Heap@@21)) true) (and (and ($Is DatatypeTypeType |st'#0_0| Tclass.M3.State) ($IsAlloc DatatypeTypeType |st'#0_0| Tclass.M3.State $Heap@@21)) true))) (and (and (and (and ($Is DatatypeTypeType |env'#0_0_0| Tclass.M3.Env) ($IsAlloc DatatypeTypeType |env'#0_0_0| Tclass.M3.Env $Heap@@21)) true) (and (and ($Is DatatypeTypeType |_v4#0_0_0_0| Tclass.M3.Expression) ($IsAlloc DatatypeTypeType |_v4#0_0_0_0| Tclass.M3.Expression $Heap@@21)) true)) (and (and (and ($Is DatatypeTypeType |st''#0_0_0_0| Tclass.M3.State) ($IsAlloc DatatypeTypeType |st''#0_0_0_0| Tclass.M3.State $Heap@@21)) true) (and (and ($Is DatatypeTypeType |_v5#1_0| Tclass.M3.Expression) ($IsAlloc DatatypeTypeType |_v5#1_0| Tclass.M3.Expression $Heap@@21)) true)))) (and (and (and (and (and ($Is DatatypeTypeType |_v6#1_0| Tclass.M3.State) ($IsAlloc DatatypeTypeType |_v6#1_0| Tclass.M3.State $Heap@@21)) true) (= 13 $FunctionContextHeight)) (and (|M3.__default.Legal#canCall| |stmts#0@@6|) (and (M3.__default.Legal |stmts#0@@6|) (or (not (= (|Seq#Length| |stmts#0@@6|) 0)) (not true))))) (and (and (|M3.__default.ValidState#canCall| |st#0@@61|) (and (M3.__default.ValidState |st#0@@61|) (forall ((|p#4@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |p#4@@0| Tclass.M3.Path) (=> (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#4@@0|)) (M3.__default.WellFounded |p#4@@0|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |6787|
 :pattern ( (M3.__default.WellFounded |p#4@@0|))
 :pattern ( (|Set#IsMember| (M3.__default.DomSt |st#0@@61|) ($Box DatatypeTypeType |p#4@@0|)))
)))) (and (M3.__default.ValidEnv |env#0@@23|) (= (ControlFlow 0 31) 30))))) anon0_correct))))
