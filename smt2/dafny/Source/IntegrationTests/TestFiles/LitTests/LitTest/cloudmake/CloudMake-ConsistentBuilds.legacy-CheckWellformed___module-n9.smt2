...
(let ((anon43_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (exists ((|stC#26| T@U) )  (and ($Is DatatypeTypeType |stC#26| Tclass._module.StateC) (|Set#IsMember| |stsC#0@@3| ($Box DatatypeTypeType |stC#26|))))) (=> (exists ((|stC#26@@0| T@U) )  (and ($Is DatatypeTypeType |stC#26@@0| Tclass._module.StateC) (|Set#IsMember| |stsC#0@@3| ($Box DatatypeTypeType |stC#26@@0|)))) (=> (and (and ($Is DatatypeTypeType |stC#25@0| Tclass._module.StateC) ($IsAlloc DatatypeTypeType |stC#25@0| Tclass._module.StateC $Heap@@1)) (|Set#IsMember| |stsC#0@@3| ($Box DatatypeTypeType |stC#25@0|))) (and (=> (= (ControlFlow 0 13) 9) anon73_Then_correct) (=> (= (ControlFlow 0 13) 10) anon73_Else_correct)))))))
