...
(set-info :boogie-vc-id Impl$$M2.__default.BuildLemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#4| null $Heap@@30 alloc false)) ($IsAlloc DatatypeTypeType |prog#0@@4| Tclass.M2.Program $Heap@@30)) (and ($IsAlloc DatatypeTypeType |st#0@@75| Tclass.M2.State $Heap@@30) (M2.__default.Legal (M2.Program.stmts |prog#0@@4|)))) (and (and (|M2.__default.build#canCall| |prog#0@@4| |st#0@@75|) (M2.Tuple.Pair_q (M2.__default.build |prog#0@@4| |st#0@@75|))) (and (|M2.__default.build#canCall| |prog#0@@4| |st#0@@75|) (= |result#0@0| (M2.__default.build |prog#0@@4| |st#0@@75|))))) (=> (and (and (and (and (M2.Tuple.Pair_q |result#0@0|) (M2.Tuple.Pair_q |result#0@0|)) (and (= |$rhs#0@0| ($Unbox DatatypeTypeType (M2.Tuple.fst |result#0@0|))) (M2.Tuple.Pair_q |result#0@0|))) (and (and (M2.Tuple.Pair_q |result#0@0|) (= |$rhs#1@0| ($Unbox DatatypeTypeType (M2.Tuple.snd |result#0@0|)))) (and (M2.Program.Program_q |prog#0@@4|) (M2.Program.Program_q |prog#0@@4|)))) (and (and (and (= |stmts##0@0| (M2.Program.stmts |prog#0@@4|)) |M2.__default.EmptyEnv#canCall|) (and |M2.__default.EmptyEnv#canCall| (= |env##0@0| M2.__default.EmptyEnv))) (and (and ($Is DatatypeTypeType |call4formal@expr'#0| Tclass.M2.Expression) ($IsAlloc DatatypeTypeType |call4formal@expr'#0| Tclass.M2.Expression $Heap@@30)) (and ($Is DatatypeTypeType |call5formal@st'#0| Tclass.M2.State) ($IsAlloc DatatypeTypeType |call5formal@st'#0| Tclass.M2.State $Heap@@30))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|M2.__default.Legal#canCall| |stmts##0@0|) (or (M2.__default.Legal |stmts##0@0|) (or (not (= (|Seq#Length| |stmts##0@0|) 0)) (not true))))) (=> (=> (|M2.__default.Legal#canCall| |stmts##0@0|) (or (M2.__default.Legal |stmts##0@0|) (or (not (= (|Seq#Length| |stmts##0@0|) 0)) (not true)))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|M2.__default.ValidState#canCall| |st#0@@75|) (or (M2.__default.ValidState |st#0@@75|) (forall ((|p#0@@55| T@U) ) (!  (=> ($IsBox |p#0@@55| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.DomSt |st#0@@75|) |p#0@@55|) (M2.__default.WellFounded |p#0@@55|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |4592|
...
)))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (M2.__default.ValidEnv |env##0@0|)) (=> (M2.__default.ValidEnv |env##0@0|) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and ($Is DatatypeTypeType |call4formal@expr'#0@0| Tclass.M2.Expression) ($IsAlloc DatatypeTypeType |call4formal@expr'#0@0| Tclass.M2.Expression $Heap@0)) (and ($Is DatatypeTypeType |call5formal@st'#0@0| Tclass.M2.State) ($IsAlloc DatatypeTypeType |call5formal@st'#0@0| Tclass.M2.State $Heap@0))) (=> (and (and (and (and (and (|$IsA#M2.Tuple| (M2.__default.do ($LS $LZ) |stmts##0@0| |st#0@@75| |env##0@0|)) (|M2.__default.do#canCall| |stmts##0@0| |st#0@@75| |env##0@0|)) (=> (|M2.Tuple#Equal| (|#M2.Tuple.Pair| ($Box DatatypeTypeType |call4formal@expr'#0@0|) ($Box DatatypeTypeType |call5formal@st'#0@0|)) (M2.__default.do ($LS $LZ) |stmts##0@0| |st#0@@75| |env##0@0|)) (and (|M2.__default.ValidState#canCall| |call5formal@st'#0@0|) (=> (M2.__default.ValidState |call5formal@st'#0@0|) (and (|M2.__default.Extends#canCall| |st#0@@75| |call5formal@st'#0@0|) (=> (M2.__default.Extends |st#0@@75| |call5formal@st'#0@0|) (=> (M2.Expression.exprError_q |call4formal@expr'#0@0|) (|$IsA#M2.Reason| (M2.Expression.r |call4formal@expr'#0@0|))))))))) (|M2.Tuple#Equal| (|#M2.Tuple.Pair| ($Box DatatypeTypeType |call4formal@expr'#0@0|) ($Box DatatypeTypeType |call5formal@st'#0@0|)) (M2.__default.do ($LS ($LS $LZ)) |stmts##0@0| |st#0@@75| |env##0@0|))) (and (|M2.__default.ValidState#canCall| |call5formal@st'#0@0|) (and (M2.__default.ValidState |call5formal@st'#0@0|) (forall ((|p#1@@7| T@U) ) (!  (=> ($IsBox |p#1@@7| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.DomSt |call5formal@st'#0@0|) |p#1@@7|) (M2.__default.WellFounded |p#1@@7|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |4595|
 :pattern ( (M2.__default.WellFounded |p#1@@7|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |call5formal@st'#0@0|) |p#1@@7|))
))))) (and (and (|M2.__default.Extends#canCall| |st#0@@75| |call5formal@st'#0@0|) (and (M2.__default.Extends |st#0@@75| |call5formal@st'#0@0|) (and (and (|Set#Subset| (M2.__default.DomSt |st#0@@75|) (M2.__default.DomSt |call5formal@st'#0@0|)) (forall ((|p#2@@2| T@U) ) (!  (=> ($IsBox |p#2@@2| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.DomSt |st#0@@75|) |p#2@@2|) (= (M2.__default.GetSt |p#2@@2| |call5formal@st'#0@0|) (M2.__default.GetSt |p#2@@2| |st#0@@75|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |4598|
...
))) (forall ((|p#3@@1| T@U) ) (!  (=> ($IsBox |p#3@@1| Tclass.M2.Path) (=> (and (not (|Set#IsMember| (M2.__default.DomSt |st#0@@75|) |p#3@@1|)) (|Set#IsMember| (M2.__default.DomSt |call5formal@st'#0@0|) |p#3@@1|)) (= (M2.__default.GetSt |p#3@@1| |call5formal@st'#0@0|) (M2.__default.Oracle |p#3@@1| |st#0@@75|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |4599|
 :pattern ( (M2.__default.Oracle |p#3@@1| |st#0@@75|))
 :pattern ( (M2.__default.GetSt |p#3@@1| |call5formal@st'#0@0|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |call5formal@st'#0@0|) |p#3@@1|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st#0@@75|) |p#3@@1|))
))))) (and (=> (M2.Expression.exprError_q |call4formal@expr'#0@0|) (|M2.Reason#Equal| (M2.Expression.r |call4formal@expr'#0@0|) |#M2.Reason.rValidity|)) (= $Heap@@30 $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> false (|M2.Tuple#Equal| (M2.__default.build |prog#0@@4| |st#0@@75|) (|#M2.Tuple.Pair| ($Box DatatypeTypeType |$rhs#0@0|) ($Box DatatypeTypeType |$rhs#1@0|))))) (=> (=> false (|M2.Tuple#Equal| (M2.__default.build |prog#0@@4| |st#0@@75|) (|#M2.Tuple.Pair| ($Box DatatypeTypeType |$rhs#0@0|) ($Box DatatypeTypeType |$rhs#1@0|)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> false (=> (|M2.__default.ValidState#canCall| |$rhs#1@0|) (or (M2.__default.ValidState |$rhs#1@0|) (forall ((|p#5| T@U) ) (!  (=> ($IsBox |p#5| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.DomSt |$rhs#1@0|) |p#5|) (M2.__default.WellFounded |p#5|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |4585|
...
))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> false (=> (|M2.__default.Extends#canCall| |st#0@@75| |$rhs#1@0|) (or (M2.__default.Extends |st#0@@75| |$rhs#1@0|) (|Set#Subset| (M2.__default.DomSt |st#0@@75|) (M2.__default.DomSt |$rhs#1@0|)))))) (=> (=> false (=> (|M2.__default.Extends#canCall| |st#0@@75| |$rhs#1@0|) (or (M2.__default.Extends |st#0@@75| |$rhs#1@0|) (|Set#Subset| (M2.__default.DomSt |st#0@@75|) (M2.__default.DomSt |$rhs#1@0|))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> false (=> (|M2.__default.Extends#canCall| |st#0@@75| |$rhs#1@0|) (or (M2.__default.Extends |st#0@@75| |$rhs#1@0|) (forall ((|p#6| T@U) ) (!  (=> ($IsBox |p#6| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.DomSt |st#0@@75|) |p#6|) (= (M2.__default.GetSt |p#6| |$rhs#1@0|) (M2.__default.GetSt |p#6| |st#0@@75|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |4587|
 :pattern ( (M2.__default.GetSt |p#6| |st#0@@75|))
 :pattern ( (M2.__default.GetSt |p#6| |$rhs#1@0|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st#0@@75|) |p#6|))
)))))) (=> (=> false (=> (|M2.__default.Extends#canCall| |st#0@@75| |$rhs#1@0|) (or (M2.__default.Extends |st#0@@75| |$rhs#1@0|) (forall ((|p#6@@0| T@U) ) (!  (=> ($IsBox |p#6@@0| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.DomSt |st#0@@75|) |p#6@@0|) (= (M2.__default.GetSt |p#6@@0| |$rhs#1@0|) (M2.__default.GetSt |p#6@@0| |st#0@@75|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |4587|
 :pattern ( (M2.__default.GetSt |p#6@@0| |st#0@@75|))
 :pattern ( (M2.__default.GetSt |p#6@@0| |$rhs#1@0|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st#0@@75|) |p#6@@0|))
))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> false (=> (|M2.__default.Extends#canCall| |st#0@@75| |$rhs#1@0|) (or (M2.__default.Extends |st#0@@75| |$rhs#1@0|) (forall ((|p#7| T@U) ) (!  (=> ($IsBox |p#7| Tclass.M2.Path) (=> (and (not (|Set#IsMember| (M2.__default.DomSt |st#0@@75|) |p#7|)) (|Set#IsMember| (M2.__default.DomSt |$rhs#1@0|) |p#7|)) (= (M2.__default.GetSt |p#7| |$rhs#1@0|) (M2.__default.Oracle |p#7| |st#0@@75|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |4588|
 :pattern ( (M2.__default.Oracle |p#7| |st#0@@75|))
 :pattern ( (M2.__default.GetSt |p#7| |$rhs#1@0|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |$rhs#1@0|) |p#7|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st#0@@75|) |p#7|))
)))))) (=> (=> false (=> (|M2.__default.Extends#canCall| |st#0@@75| |$rhs#1@0|) (or (M2.__default.Extends |st#0@@75| |$rhs#1@0|) (forall ((|p#7@@0| T@U) ) (!  (=> ($IsBox |p#7@@0| Tclass.M2.Path) (=> (and (not (|Set#IsMember| (M2.__default.DomSt |st#0@@75|) |p#7@@0|)) (|Set#IsMember| (M2.__default.DomSt |$rhs#1@0|) |p#7@@0|)) (= (M2.__default.GetSt |p#7@@0| |$rhs#1@0|) (M2.__default.Oracle |p#7@@0| |st#0@@75|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |4588|
 :pattern ( (M2.__default.Oracle |p#7@@0| |st#0@@75|))
 :pattern ( (M2.__default.GetSt |p#7@@0| |$rhs#1@0|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |$rhs#1@0|) |p#7@@0|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st#0@@75|) |p#7@@0|))
))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (=> (M2.Expression.exprError_q |$rhs#0@0|) (|M2.Reason#Equal| (M2.Expression.r |$rhs#0@0|) |#M2.Reason.rValidity|)))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@30) ($IsHeapAnchor $Heap@@30)) (=> (and (and ($Is DatatypeTypeType |prog#0@@4| Tclass.M2.Program) ($IsAlloc DatatypeTypeType |prog#0@@4| Tclass.M2.Program $Heap@@30)) (|$IsA#M2.Program| |prog#0@@4|)) (=> (and (and (and (and ($Is DatatypeTypeType |st#0@@75| Tclass.M2.State) ($IsAlloc DatatypeTypeType |st#0@@75| Tclass.M2.State $Heap@@30)) (|$IsA#M2.State| |st#0@@75|)) (and (and ($Is DatatypeTypeType |expr'#0@@1| Tclass.M2.Expression) ($IsAlloc DatatypeTypeType |expr'#0@@1| Tclass.M2.Expression $Heap@@30)) (and ($Is DatatypeTypeType |st'#0@@11| Tclass.M2.State) ($IsAlloc DatatypeTypeType |st'#0@@11| Tclass.M2.State $Heap@@30)))) (and (and (and ($Is DatatypeTypeType |result#0@@0| (Tclass.M2.Tuple Tclass.M2.Expression Tclass.M2.State)) ($IsAlloc DatatypeTypeType |result#0@@0| (Tclass.M2.Tuple Tclass.M2.Expression Tclass.M2.State) $Heap@@30)) true) (and (and ($Is DatatypeTypeType |_v2#0| Tclass.M2.Expression) ($IsAlloc DatatypeTypeType |_v2#0| Tclass.M2.Expression $Heap@@30)) true))) (=> (and (and (and (and (and ($Is DatatypeTypeType |_v3#0| Tclass.M2.State) ($IsAlloc DatatypeTypeType |_v3#0| Tclass.M2.State $Heap@@30)) true) (= 13 $FunctionContextHeight)) (and (|M2.__default.Legal#canCall| (M2.Program.stmts |prog#0@@4|)) (and (M2.__default.Legal (M2.Program.stmts |prog#0@@4|)) (or (not (= (|Seq#Length| (M2.Program.stmts |prog#0@@4|)) 0)) (not true))))) (and (and (|M2.__default.ValidState#canCall| |st#0@@75|) (and (M2.__default.ValidState |st#0@@75|) (forall ((|p#4| T@U) ) (!  (=> ($IsBox |p#4| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.DomSt |st#0@@75|) |p#4|) (M2.__default.WellFounded |p#4|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |4584|
 :pattern ( (M2.__default.WellFounded |p#4|))
 :pattern ( (|Set#IsMember| (M2.__default.DomSt |st#0@@75|) |p#4|))
