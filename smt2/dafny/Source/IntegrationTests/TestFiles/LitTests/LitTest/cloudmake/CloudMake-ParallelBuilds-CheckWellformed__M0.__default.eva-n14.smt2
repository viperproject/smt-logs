...
(assert (forall ((d@@24 T@U) ) (!  (=> (M0.Tuple.Pair_q d@@24) (exists ((|a#142#0#0| T@U) (|a#142#1#0| T@U) ) (! (= d@@24 (|#M0.Tuple.Pair| |a#142#0#0| |a#142#1#0|))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@3 T@U) ($Heap@@3 T@U) (|sts#0@@0| T@U) ) (!  (=> (or (|M0.__default.Combine#canCall| |sts#0@@0|) (and (< 3 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@3) ($Is SetType |sts#0@@0| (TSet Tclass.M0.State))) (not (|Set#Equal| |sts#0@@0| |Set#Empty|))))) (and (and (|$let#0$canCall| |sts#0@@0|) (=> (not (|Set#Equal| |sts#0@@0| (|Set#UnionOne| |Set#Empty| (|$let#0_st| |sts#0@@0|)))) (and (|M0.__default.Combine#canCall| (|Set#Difference| |sts#0@@0| (|Set#UnionOne| |Set#Empty| (|$let#0_st| |sts#0@@0|)))) (|M0.__default.Union#canCall| (|$let#0_st| |sts#0@@0|) (M0.__default.Combine $ly@@3 (|Set#Difference| |sts#0@@0| (|Set#UnionOne| |Set#Empty| (|$let#0_st| |sts#0@@0|)))))))) (= (M0.__default.Combine ($LS $ly@@3) |sts#0@@0|) (let ((|st#0@@6| (|$let#0_st| |sts#0@@0|)))
(ite (|Set#Equal| |sts#0@@0| (|Set#UnionOne| |Set#Empty| |st#0@@6|)) |st#0@@6| (M0.__default.Union |st#0@@6| (M0.__default.Combine $ly@@3 (|Set#Difference| |sts#0@@0| (|Set#UnionOne| |Set#Empty| |st#0@@6|)))))))))
 :qid |CloudMakeParallelBuildsdfy.36:18|
 :skolemid |747|
...
(assert (forall ((d@@31 T@U) ) (!  (=> (|$IsA#M0.Literal| d@@31) (or (or (or (or (or (or (or (or (or (M0.Literal.litTrue_q d@@31) (M0.Literal.litFalse_q d@@31)) (M0.Literal.litUndefined_q d@@31)) (M0.Literal.litNull_q d@@31)) (M0.Literal.litNumber_q d@@31)) (M0.Literal.litString_q d@@31)) (M0.Literal.litPrimitive_q d@@31)) (M0.Literal.litArrOfPaths_q d@@31)) (M0.Literal.litArrOfStrings_q d@@31)) (M0.Literal.litArray_q d@@31)))
 :qid |unknown.0:0|
 :skolemid |1332|
 :pattern ( (|$IsA#M0.Literal| d@@31))
)))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@4 T@U) (|expr#0| T@U) (|st#0@@7| T@U) (|env#0@@3| T@U) ) (!  (=> (or (|M0.__default.eval#canCall| (Lit DatatypeTypeType |expr#0|) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|)) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0| Tclass.M0.Expression) ($IsBox |st#0@@7| Tclass.M0.State)) ($IsBox |env#0@@3| Tclass.M0.Env)) (M0.__default.ValidEnv (Lit BoxType |env#0@@3|))))) (and (and (|M0.__default.Value#canCall| (Lit DatatypeTypeType |expr#0|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.__default.Value (Lit DatatypeTypeType |expr#0|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0|))))) (|M0.__default.GetEnv#canCall| (Lit BoxType (M0.Expression.id (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |env#0@@3|))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIf_q (Lit DatatypeTypeType |expr#0|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|)) (let ((|st'#8| (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|))))))
(let ((|cond'#2| ($Unbox DatatypeTypeType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|)))))))
 (and (and (=> (M0.Expression.exprLiteral_q |cond'#2|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#2|))) (=> (and (M0.Expression.exprLiteral_q |cond'#2|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#2|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.ifTrue (Lit DatatypeTypeType |expr#0|))) |st'#8| (Lit BoxType |env#0@@3|)))) (=> (not (and (M0.Expression.exprLiteral_q |cond'#2|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#2|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |cond'#2|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#2|))) (=> (and (M0.Expression.exprLiteral_q |cond'#2|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#2|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.ifFalse (Lit DatatypeTypeType |expr#0|))) |st'#8| (Lit BoxType |env#0@@3|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIf_q (Lit DatatypeTypeType |expr#0|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|)) (let ((|st'#9| (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|))))))
(let ((|conj0'#2| ($Unbox DatatypeTypeType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|)))))))
 (and (and (=> (M0.Expression.exprLiteral_q |conj0'#2|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#2|))) (=> (and (M0.Expression.exprLiteral_q |conj0'#2|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#2|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.conj1 (Lit DatatypeTypeType |expr#0|))) |st'#9| (Lit BoxType |env#0@@3|)))) (=> (not (and (M0.Expression.exprLiteral_q |conj0'#2|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#2|) |#M0.Literal.litTrue|))) (=> (M0.Expression.exprLiteral_q |conj0'#2|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#2|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprOr_q (Lit DatatypeTypeType |expr#0|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|)) (let ((|st'#10| (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|))))))
(let ((|disj0'#2| ($Unbox DatatypeTypeType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|)))))))
 (and (=> (M0.Expression.exprLiteral_q |disj0'#2|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#2|))) (=> (not (and (M0.Expression.exprLiteral_q |disj0'#2|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#2|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |disj0'#2|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#2|))) (=> (and (M0.Expression.exprLiteral_q |disj0'#2|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#2|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.disj1 (Lit DatatypeTypeType |expr#0|))) |st'#10| (Lit BoxType |env#0@@3|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprOr_q (Lit DatatypeTypeType |expr#0|)))))) (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|)) (let ((|st'#11| (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|))))))
(let ((|fun'#2| ($Unbox DatatypeTypeType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|)))))))
 (and (|M0.__default.evalArgs#canCall| (Lit DatatypeTypeType |expr#0|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|)) (let ((|sts'#2| ($Unbox SetType (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.evalArgs ($LS $ly@@4) (Lit DatatypeTypeType |expr#0|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|)))))))
(let ((|args'#2| ($Unbox SeqType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.evalArgs ($LS $ly@@4) (Lit DatatypeTypeType |expr#0|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|)))))))
(let ((|sts''#2| (|Set#Union| (|Set#UnionOne| |Set#Empty| |st'#11|) |sts'#2|)))
 ...
 (and (M0.Tuple.Pair_q |ps#2|) (M0.Tuple.Pair_q |ps#2|)))))))))))))))))))))))))))))) (= (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType |expr#0|) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|)) (ite (M0.__default.Value (Lit DatatypeTypeType |expr#0|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType |expr#0|)) (Lit BoxType |st#0@@7|)) (ite (M0.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (M0.__default.GetEnv (Lit BoxType (M0.Expression.id (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |env#0@@3|))) (Lit BoxType |st#0@@7|)) (ite (M0.Expression.exprIf_q (Lit DatatypeTypeType |expr#0|)) (let ((|st'#8@@0| (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|))))))
(let ((|cond'#2@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|)))))))
(ite  (and (M0.Expression.exprLiteral_q |cond'#2@@0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#2@@0|) |#M0.Literal.litTrue|)) (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.ifTrue (Lit DatatypeTypeType |expr#0|))) |st'#8@@0| (Lit BoxType |env#0@@3|)) (ite  (and (M0.Expression.exprLiteral_q |cond'#2@@0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#2@@0|) |#M0.Literal.litFalse|)) (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.ifFalse (Lit DatatypeTypeType |expr#0|))) |st'#8@@0| (Lit BoxType |env#0@@3|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) (Lit BoxType |st#0@@7|)))))) (ite (M0.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0|)) (let ((|st'#9@@0| (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|))))))
(let ((|conj0'#2@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|)))))))
...
(let ((|disj0'#2@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|)))))))
(ite  (and (M0.Expression.exprLiteral_q |disj0'#2@@0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#2@@0|) |#M0.Literal.litTrue|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprLiteral| (Lit DatatypeTypeType |#M0.Literal.litTrue|)))) |st'#10@@0|) (ite  (and (M0.Expression.exprLiteral_q |disj0'#2@@0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#2@@0|) |#M0.Literal.litFalse|)) (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.disj1 (Lit DatatypeTypeType |expr#0|))) |st'#10@@0| (Lit BoxType |env#0@@3|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) (Lit BoxType |st#0@@7|)))))) (ite (M0.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0|)) (let ((|st'#11@@0| (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|))))))
(let ((|fun'#2@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|)))))))
(let ((|sts'#2@@0| ($Unbox SetType (M0.Tuple.snd (Lit DatatypeTypeType (M0.__default.evalArgs ($LS $ly@@4) (Lit DatatypeTypeType |expr#0|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|)))))))
(let ((|args'#2@@0| ($Unbox SeqType (M0.Tuple.fst (Lit DatatypeTypeType (M0.__default.evalArgs ($LS $ly@@4) (Lit DatatypeTypeType |expr#0|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0|))) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|)))))))
(let ((|sts''#2@@0| (|Set#Union| (|Set#UnionOne| |Set#Empty| |st'#11@@0|) |sts'#2@@0|)))
(ite  (not (M0.__default.Compatible |sts''#2@@0|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rCompatibility|)))) (Lit BoxType |st#0@@7|)) (let ((|stCombined#2@@0| (M0.__default.Combine ($LS $LZ) |sts''#2@@0|)))
...
(|#M0.Tuple.Pair| ($Box DatatypeTypeType (|#M0.Expression.exprLiteral| (|#M0.Literal.litArrOfPaths| ($Unbox SetType (M0.Tuple.fst |ps#2@@0|))))) (M0.Tuple.snd |ps#2@@0|))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) (Lit BoxType |st#0@@7|))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) (Lit BoxType |st#0@@7|))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) (Lit BoxType |st#0@@7|)))))))))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) (Lit BoxType |st#0@@7|)))))))))))
 ...
 :weight 3
 :skolemid |976|
 :pattern ( (M0.__default.eval ($LS $ly@@4) (Lit DatatypeTypeType |expr#0|) (Lit BoxType |st#0@@7|) (Lit BoxType |env#0@@3|)))
))))
...
(assert (forall ((d@@32 T@U) ) (!  (=> (M0.Expression.exprLiteral_q d@@32) (exists ((|a#21#0#0| T@U) ) (! (= d@@32 (|#M0.Expression.exprLiteral| |a#21#0#0|))
 :qid |CloudMakeParallelBuildsdfy.133:37|
 :skolemid |1164|
)))
 :qid |unknown.0:0|
 :skolemid |1165|
 :pattern ( (M0.Expression.exprLiteral_q d@@32))
)))
(assert (forall ((d@@33 T@U) ) (!  (=> (M0.Expression.exprIdentifier_q d@@33) (exists ((|a#27#0#0| T@U) ) (! (= d@@33 (|#M0.Expression.exprIdentifier| |a#27#0#0|))
 :qid |CloudMakeParallelBuildsdfy.133:68|
 :skolemid |1175|
)))
 :qid |unknown.0:0|
 :skolemid |1176|
 :pattern ( (M0.Expression.exprIdentifier_q d@@33))
)))
(assert (forall ((d@@34 T@U) ) (!  (=> (M0.Expression.exprError_q d@@34) (exists ((|a#67#0#0| T@U) ) (! (= d@@34 (|#M0.Expression.exprError| |a#67#0#0|))
 :qid |CloudMakeParallelBuildsdfy.138:35|
 :skolemid |1240|
)))
 :qid |unknown.0:0|
 :skolemid |1241|
 :pattern ( (M0.Expression.exprError_q d@@34))
)))
(assert (forall ((d@@35 T@U) ) (!  (=> (M0.Literal.litNumber_q d@@35) (exists ((|a#89#0#0| Int) ) (! (= d@@35 (|#M0.Literal.litNumber| |a#89#0#0|))
 :qid |CloudMakeParallelBuildsdfy.141:32|
 :skolemid |1273|
)))
 :qid |unknown.0:0|
 :skolemid |1274|
 :pattern ( (M0.Literal.litNumber_q d@@35))
)))
(assert (forall ((d@@36 T@U) ) (!  (=> (M0.Literal.litString_q d@@36) (exists ((|a#94#0#0| T@U) ) (! (= d@@36 (|#M0.Literal.litString| |a#94#0#0|))
 :qid |CloudMakeParallelBuildsdfy.141:54|
 :skolemid |1282|
)))
 :qid |unknown.0:0|
 :skolemid |1283|
 :pattern ( (M0.Literal.litString_q d@@36))
)))
(assert (forall ((d@@37 T@U) ) (!  (=> (M0.Literal.litPrimitive_q d@@37) (exists ((|a#101#0#0| T@U) ) (! (= d@@37 (|#M0.Literal.litPrimitive| |a#101#0#0|))
 :qid |CloudMakeParallelBuildsdfy.142:35|
 :skolemid |1293|
)))
 :qid |unknown.0:0|
 :skolemid |1294|
 :pattern ( (M0.Literal.litPrimitive_q d@@37))
)))
(assert (forall ((d@@38 T@U) ) (!  (=> (M0.Literal.litArrOfPaths_q d@@38) (exists ((|a#107#0#0| T@U) ) (! (= d@@38 (|#M0.Literal.litArrOfPaths| |a#107#0#0|))
 :qid |CloudMakeParallelBuildsdfy.145:36|
 :skolemid |1303|
)))
 :qid |unknown.0:0|
 :skolemid |1304|
 :pattern ( (M0.Literal.litArrOfPaths_q d@@38))
)))
(assert (forall ((d@@39 T@U) ) (!  (=> (M0.Literal.litArrOfStrings_q d@@39) (exists ((|a#113#0#0| T@U) ) (! (= d@@39 (|#M0.Literal.litArrOfStrings| |a#113#0#0|))
 :qid |CloudMakeParallelBuildsdfy.146:38|
 :skolemid |1313|
)))
 :qid |unknown.0:0|
 :skolemid |1314|
 :pattern ( (M0.Literal.litArrOfStrings_q d@@39))
)))
(assert (forall ((d@@40 T@U) ) (!  (=> (M0.Literal.litArray_q d@@40) (exists ((|a#119#0#0| T@U) ) (! (= d@@40 (|#M0.Literal.litArray| |a#119#0#0|))
 :qid |CloudMakeParallelBuildsdfy.147:31|
 :skolemid |1323|
)))
 :qid |unknown.0:0|
 :skolemid |1324|
 :pattern ( (M0.Literal.litArray_q d@@40))
)))
(assert (forall ((d@@41 T@U) ) (!  (=> ($Is DatatypeTypeType d@@41 Tclass.M0.Expression) (or (or (or (or (or (or (M0.Expression.exprLiteral_q d@@41) (M0.Expression.exprIdentifier_q d@@41)) (M0.Expression.exprIf_q d@@41)) (M0.Expression.exprAnd_q d@@41)) (M0.Expression.exprOr_q d@@41)) (M0.Expression.exprInvocation_q d@@41)) (M0.Expression.exprError_q d@@41)))
 :qid |unknown.0:0|
 :skolemid |1250|
 :pattern ( (M0.Expression.exprError_q d@@41) ($Is DatatypeTypeType d@@41 Tclass.M0.Expression))
 :pattern ( (M0.Expression.exprInvocation_q d@@41) ($Is DatatypeTypeType d@@41 Tclass.M0.Expression))
 :pattern ( (M0.Expression.exprOr_q d@@41) ($Is DatatypeTypeType d@@41 Tclass.M0.Expression))
 :pattern ( (M0.Expression.exprAnd_q d@@41) ($Is DatatypeTypeType d@@41 Tclass.M0.Expression))
 :pattern ( (M0.Expression.exprIf_q d@@41) ($Is DatatypeTypeType d@@41 Tclass.M0.Expression))
 :pattern ( (M0.Expression.exprIdentifier_q d@@41) ($Is DatatypeTypeType d@@41 Tclass.M0.Expression))
 :pattern ( (M0.Expression.exprLiteral_q d@@41) ($Is DatatypeTypeType d@@41 Tclass.M0.Expression))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|cmd#0@@2| T@U) (|deps#0@@2| T@U) (|exps#0@@1| T@U) (|st#0@@8| T@U) ) (!  (=> (or (|M0.__default.Pre#canCall| (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) (Lit SetType |exps#0@@1|) (Lit BoxType |st#0@@8|)) (and (< 2 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@2| (TSeq TChar)) ($Is SetType |deps#0@@2| (TSet Tclass.M0.Path))) ($Is SetType |exps#0@@1| (TSet (TSeq TChar)))) ($IsBox |st#0@@8| Tclass.M0.State)))) (and (forall ((|e#2| T@U) ) (!  (=> ($Is SeqType |e#2| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@1|) ($Box SeqType |e#2|)) (and (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#2|) (|M0.__default.DomSt#canCall| (Lit BoxType |st#0@@8|))) (=> (|Set#IsMember| (M0.__default.DomSt (Lit BoxType |st#0@@8|)) (M0.__default.Loc (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#2|)) (and (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#2|) (|M0.__default.GetSt#canCall| (M0.__default.Loc (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#2|) (Lit BoxType |st#0@@8|))) (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#2|) (|M0.__default.Oracle#canCall| (M0.__default.Loc (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#2|) (Lit BoxType |st#0@@8|))))))))
...
)) (= (M0.__default.Pre (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) (Lit SetType |exps#0@@1|) (Lit BoxType |st#0@@8|)) (forall ((|e#2@@0| T@U) ) (!  (=> ($Is SeqType |e#2@@0| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@1|) ($Box SeqType |e#2@@0|)) (=> (|Set#IsMember| (M0.__default.DomSt (Lit BoxType |st#0@@8|)) (M0.__default.Loc (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#2@@0|)) (= (M0.__default.GetSt (M0.__default.Loc (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#2@@0|) (Lit BoxType |st#0@@8|)) (M0.__default.Oracle (M0.__default.Loc (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) |e#2@@0|) (Lit BoxType |st#0@@8|))))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |824|
 ...
 :weight 3
 :skolemid |826|
 :pattern ( (M0.__default.Pre (Lit SeqType |cmd#0@@2|) (Lit SetType |deps#0@@2|) (Lit SetType |exps#0@@1|) (Lit BoxType |st#0@@8|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|cmd#0@@3| T@U) (|deps#0@@3| T@U) (|exps#0@@2| T@U) (|st#0@@9| T@U) ) (!  (=> (or (|M0.__default.exec#canCall| |cmd#0@@3| |deps#0@@3| |exps#0@@2| |st#0@@9|) (and (< 1 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@3| (TSeq TChar)) ($Is SetType |deps#0@@3| (TSet Tclass.M0.Path))) ($Is SetType |exps#0@@2| (TSet (TSeq TChar)))) ($IsBox |st#0@@9| Tclass.M0.State)))) ($Is DatatypeTypeType (M0.__default.exec |cmd#0@@3| |deps#0@@3| |exps#0@@2| |st#0@@9|) (Tclass.M0.Tuple (TSet Tclass.M0.Path) Tclass.M0.State)))
 :qid |CloudMakeParallelBuildsdfy.69:23|
 :skolemid |799|
 :pattern ( (M0.__default.exec |cmd#0@@3| |deps#0@@3| |exps#0@@2| |st#0@@9|))
))))
...
(assert (forall ((d@@42 T@U) ) (!  (=> ($Is DatatypeTypeType d@@42 Tclass.M0.Literal) (or (or (or (or (or (or (or (or (or (M0.Literal.litTrue_q d@@42) (M0.Literal.litFalse_q d@@42)) (M0.Literal.litUndefined_q d@@42)) (M0.Literal.litNull_q d@@42)) (M0.Literal.litNumber_q d@@42)) (M0.Literal.litString_q d@@42)) (M0.Literal.litPrimitive_q d@@42)) (M0.Literal.litArrOfPaths_q d@@42)) (M0.Literal.litArrOfStrings_q d@@42)) (M0.Literal.litArray_q d@@42)))
 :qid |unknown.0:0|
 :skolemid |1333|
 :pattern ( (M0.Literal.litArray_q d@@42) ($Is DatatypeTypeType d@@42 Tclass.M0.Literal))
 :pattern ( (M0.Literal.litArrOfStrings_q d@@42) ($Is DatatypeTypeType d@@42 Tclass.M0.Literal))
 :pattern ( (M0.Literal.litArrOfPaths_q d@@42) ($Is DatatypeTypeType d@@42 Tclass.M0.Literal))
 :pattern ( (M0.Literal.litPrimitive_q d@@42) ($Is DatatypeTypeType d@@42 Tclass.M0.Literal))
 :pattern ( (M0.Literal.litString_q d@@42) ($Is DatatypeTypeType d@@42 Tclass.M0.Literal))
 :pattern ( (M0.Literal.litNumber_q d@@42) ($Is DatatypeTypeType d@@42 Tclass.M0.Literal))
 :pattern ( (M0.Literal.litNull_q d@@42) ($Is DatatypeTypeType d@@42 Tclass.M0.Literal))
 :pattern ( (M0.Literal.litUndefined_q d@@42) ($Is DatatypeTypeType d@@42 Tclass.M0.Literal))
 :pattern ( (M0.Literal.litFalse_q d@@42) ($Is DatatypeTypeType d@@42 Tclass.M0.Literal))
 :pattern ( (M0.Literal.litTrue_q d@@42) ($Is DatatypeTypeType d@@42 Tclass.M0.Literal))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|cmd#0@@4| T@U) (|deps#0@@4| T@U) (|exps#0@@3| T@U) (|st#0@@10| T@U) ) (!  (=> (or (|M0.__default.Pre#canCall| (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) (Lit SetType |exps#0@@3|) |st#0@@10|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@4| (TSeq TChar)) ($Is SetType |deps#0@@4| (TSet Tclass.M0.Path))) ($Is SetType |exps#0@@3| (TSet (TSeq TChar)))) ($IsBox |st#0@@10| Tclass.M0.State)))) (and (forall ((|e#1| T@U) ) (!  (=> ($Is SeqType |e#1| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@3|) ($Box SeqType |e#1|)) (and (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1|) (|M0.__default.DomSt#canCall| |st#0@@10|)) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@10|) (M0.__default.Loc (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1|)) (and (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1|) (|M0.__default.GetSt#canCall| (M0.__default.Loc (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1|) |st#0@@10|)) (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1|) (|M0.__default.Oracle#canCall| (M0.__default.Loc (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1|) |st#0@@10|)))))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |822|
 :pattern ( (M0.__default.Loc |cmd#0@@4| |deps#0@@4| |e#1|))
 :pattern ( (|Set#IsMember| |exps#0@@3| ($Box SeqType |e#1|)))
)) (= (M0.__default.Pre (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) (Lit SetType |exps#0@@3|) |st#0@@10|) (forall ((|e#1@@0| T@U) ) (!  (=> ($Is SeqType |e#1@@0| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@3|) ($Box SeqType |e#1@@0|)) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@10|) (M0.__default.Loc (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1@@0|)) (= (M0.__default.GetSt (M0.__default.Loc (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1@@0|) |st#0@@10|) (M0.__default.Oracle (M0.__default.Loc (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) |e#1@@0|) |st#0@@10|)))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |821|
 ...
 :weight 3
 :skolemid |823|
 :pattern ( (M0.__default.Pre (Lit SeqType |cmd#0@@4|) (Lit SetType |deps#0@@4|) (Lit SetType |exps#0@@3|) |st#0@@10|))
))))
...
(assert (forall ((d@@43 T@U) ) (!  (=> ($Is DatatypeTypeType d@@43 Tclass.M0.Primitive) (or (M0.Primitive.primCreatePath_q d@@43) (M0.Primitive.primExec_q d@@43)))
 :qid |unknown.0:0|
 :skolemid |1351|
 :pattern ( (M0.Primitive.primExec_q d@@43) ($Is DatatypeTypeType d@@43 Tclass.M0.Primitive))
 :pattern ( (M0.Primitive.primCreatePath_q d@@43) ($Is DatatypeTypeType d@@43 Tclass.M0.Primitive))
)))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@7 T@U) (|expr#0@@1| T@U) (|st#0@@11| T@U) (|env#0@@7| T@U) ) (!  (=> (or (|M0.__default.eval#canCall| |expr#0@@1| |st#0@@11| |env#0@@7|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0@@1| Tclass.M0.Expression) ($IsBox |st#0@@11| Tclass.M0.State)) ($IsBox |env#0@@7| Tclass.M0.Env)) (M0.__default.ValidEnv |env#0@@7|)))) ($Is DatatypeTypeType (M0.__default.eval $ly@@7 |expr#0@@1| |st#0@@11| |env#0@@7|) (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State)))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |971|
 :pattern ( (M0.__default.eval $ly@@7 |expr#0@@1| |st#0@@11| |env#0@@7|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|sts#0@@2| T@U) ) (!  (=> (or (|M0.__default.Compatible#canCall| |sts#0@@2|) (and (< 2 $FunctionContextHeight) ($Is SetType |sts#0@@2| (TSet Tclass.M0.State)))) (and (forall ((|st#0@@12| T@U) (|st'#0@@0| T@U) (|p#0@@3| T@U) ) (!  (=> (and (and ($IsBox |st#0@@12| Tclass.M0.State) ($IsBox |st'#0@@0| Tclass.M0.State)) ($IsBox |p#0@@3| Tclass.M0.Path)) (=> (|Set#IsMember| |sts#0@@2| |st#0@@12|) (=> (|Set#IsMember| |sts#0@@2| |st'#0@@0|) (and (|M0.__default.DomSt#canCall| |st#0@@12|) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@12|) |p#0@@3|) (and (|M0.__default.DomSt#canCall| |st'#0@@0|) (=> (|Set#IsMember| (M0.__default.DomSt |st'#0@@0|) |p#0@@3|) (and (|M0.__default.GetSt#canCall| |p#0@@3| |st#0@@12|) (|M0.__default.GetSt#canCall| |p#0@@3| |st'#0@@0|)))))))))
 :qid |CloudMakeParallelBuildsdfy.32:12|
 :skolemid |729|
 :pattern ( (M0.__default.GetSt |p#0@@3| |st'#0@@0|) (M0.__default.GetSt |p#0@@3| |st#0@@12|))
 :pattern ( (M0.__default.GetSt |p#0@@3| |st'#0@@0|) (M0.__default.DomSt |st#0@@12|))
 :pattern ( (M0.__default.GetSt |p#0@@3| |st'#0@@0|) (|Set#IsMember| |sts#0@@2| |st#0@@12|))
 :pattern ( (M0.__default.GetSt |p#0@@3| |st#0@@12|) (M0.__default.DomSt |st'#0@@0|))
 :pattern ( (M0.__default.GetSt |p#0@@3| |st#0@@12|) (|Set#IsMember| |sts#0@@2| |st'#0@@0|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@0|) |p#0@@3|) (M0.__default.DomSt |st#0@@12|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@0|) |p#0@@3|) (|Set#IsMember| |sts#0@@2| |st#0@@12|))
 :pattern ( (M0.__default.DomSt |st'#0@@0|) (|Set#IsMember| (M0.__default.DomSt |st#0@@12|) |p#0@@3|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@12|) |p#0@@3|) (|Set#IsMember| |sts#0@@2| |st'#0@@0|))
)) (= (M0.__default.Compatible |sts#0@@2|) (forall ((|st#0@@13| T@U) (|st'#0@@1| T@U) (|p#0@@4| T@U) ) (!  (=> (and (and ($IsBox |st#0@@13| Tclass.M0.State) ($IsBox |st'#0@@1| Tclass.M0.State)) ($IsBox |p#0@@4| Tclass.M0.Path)) (=> (and (and (and (|Set#IsMember| |sts#0@@2| |st#0@@13|) (|Set#IsMember| |sts#0@@2| |st'#0@@1|)) (|Set#IsMember| (M0.__default.DomSt |st#0@@13|) |p#0@@4|)) (|Set#IsMember| (M0.__default.DomSt |st'#0@@1|) |p#0@@4|)) (= (M0.__default.GetSt |p#0@@4| |st#0@@13|) (M0.__default.GetSt |p#0@@4| |st'#0@@1|))))
 :qid |CloudMakeParallelBuildsdfy.32:12|
 :skolemid |728|
 :pattern ( (M0.__default.GetSt |p#0@@4| |st'#0@@1|) (M0.__default.GetSt |p#0@@4| |st#0@@13|))
 :pattern ( (M0.__default.GetSt |p#0@@4| |st'#0@@1|) (M0.__default.DomSt |st#0@@13|))
 :pattern ( (M0.__default.GetSt |p#0@@4| |st'#0@@1|) (|Set#IsMember| |sts#0@@2| |st#0@@13|))
 :pattern ( (M0.__default.GetSt |p#0@@4| |st#0@@13|) (M0.__default.DomSt |st'#0@@1|))
 :pattern ( (M0.__default.GetSt |p#0@@4| |st#0@@13|) (|Set#IsMember| |sts#0@@2| |st'#0@@1|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@1|) |p#0@@4|) (M0.__default.DomSt |st#0@@13|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@1|) |p#0@@4|) (|Set#IsMember| |sts#0@@2| |st#0@@13|))
 :pattern ( (M0.__default.DomSt |st'#0@@1|) (|Set#IsMember| (M0.__default.DomSt |st#0@@13|) |p#0@@4|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@13|) |p#0@@4|) (|Set#IsMember| |sts#0@@2| |st'#0@@1|))
)))))
 :qid |CloudMakeParallelBuildsdfy.30:30|
 :skolemid |730|
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@8 T@U) (|expr#0@@2| T@U) (|st#0@@14| T@U) (|env#0@@8| T@U) ) (!  (=> (or (|M0.__default.eval#canCall| |expr#0@@2| |st#0@@14| |env#0@@8|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0@@2| Tclass.M0.Expression) ($IsBox |st#0@@14| Tclass.M0.State)) ($IsBox |env#0@@8| Tclass.M0.Env)) (M0.__default.ValidEnv |env#0@@8|)))) (and (and (|M0.__default.Value#canCall| |expr#0@@2|) (=> (not (M0.__default.Value |expr#0@@2|)) (and (=> (M0.Expression.exprIdentifier_q |expr#0@@2|) (|M0.__default.GetEnv#canCall| (M0.Expression.id |expr#0@@2|) |env#0@@8|)) (=> (not (M0.Expression.exprIdentifier_q |expr#0@@2|)) (and (=> (M0.Expression.exprIf_q |expr#0@@2|) (and (|M0.__default.eval#canCall| (M0.Expression.cond |expr#0@@2|) |st#0@@14| |env#0@@8|) (let ((|st'#0@@2| (M0.Tuple.snd (M0.__default.eval $ly@@8 (M0.Expression.cond |expr#0@@2|) |st#0@@14| |env#0@@8|))))
(let ((|cond'#0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@8 (M0.Expression.cond |expr#0@@2|) |st#0@@14| |env#0@@8|)))))
 (and (and (=> (M0.Expression.exprLiteral_q |cond'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#0|))) (=> (and (M0.Expression.exprLiteral_q |cond'#0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#0|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (M0.Expression.ifTrue |expr#0@@2|) |st'#0@@2| |env#0@@8|))) (=> (not (and (M0.Expression.exprLiteral_q |cond'#0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#0|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |cond'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#0|))) (=> (and (M0.Expression.exprLiteral_q |cond'#0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#0|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (M0.Expression.ifFalse |expr#0@@2|) |st'#0@@2| |env#0@@8|))))))))) (=> (not (M0.Expression.exprIf_q |expr#0@@2|)) (and (=> (M0.Expression.exprAnd_q |expr#0@@2|) (and (|M0.__default.eval#canCall| (M0.Expression.conj0 |expr#0@@2|) |st#0@@14| |env#0@@8|) (let ((|st'#1@@1| (M0.Tuple.snd (M0.__default.eval $ly@@8 (M0.Expression.conj0 |expr#0@@2|) |st#0@@14| |env#0@@8|))))
(let ((|conj0'#0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@8 (M0.Expression.conj0 |expr#0@@2|) |st#0@@14| |env#0@@8|)))))
 (and (and (=> (M0.Expression.exprLiteral_q |conj0'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#0|))) (=> (and (M0.Expression.exprLiteral_q |conj0'#0|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#0|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (M0.Expression.conj1 |expr#0@@2|) |st'#1@@1| |env#0@@8|))) (=> (not (and (M0.Expression.exprLiteral_q |conj0'#0|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#0|) |#M0.Literal.litTrue|))) (=> (M0.Expression.exprLiteral_q |conj0'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#0|))))))))) (=> (not (M0.Expression.exprAnd_q |expr#0@@2|)) (and (=> (M0.Expression.exprOr_q |expr#0@@2|) (and (|M0.__default.eval#canCall| (M0.Expression.disj0 |expr#0@@2|) |st#0@@14| |env#0@@8|) (let ((|st'#2| (M0.Tuple.snd (M0.__default.eval $ly@@8 (M0.Expression.disj0 |expr#0@@2|) |st#0@@14| |env#0@@8|))))
(let ((|disj0'#0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@8 (M0.Expression.disj0 |expr#0@@2|) |st#0@@14| |env#0@@8|)))))
 (and (=> (M0.Expression.exprLiteral_q |disj0'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#0|))) (=> (not (and (M0.Expression.exprLiteral_q |disj0'#0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#0|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |disj0'#0|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#0|))) (=> (and (M0.Expression.exprLiteral_q |disj0'#0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#0|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (M0.Expression.disj1 |expr#0@@2|) |st'#2| |env#0@@8|))))))))) (=> (not (M0.Expression.exprOr_q |expr#0@@2|)) (=> (M0.Expression.exprInvocation_q |expr#0@@2|) (and (|M0.__default.eval#canCall| (M0.Expression.fun |expr#0@@2|) |st#0@@14| |env#0@@8|) (let ((|st'#3| (M0.Tuple.snd (M0.__default.eval $ly@@8 (M0.Expression.fun |expr#0@@2|) |st#0@@14| |env#0@@8|))))
(let ((|fun'#0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@8 (M0.Expression.fun |expr#0@@2|) |st#0@@14| |env#0@@8|)))))
 (and (|M0.__default.evalArgs#canCall| |expr#0@@2| (M0.Expression.args |expr#0@@2|) |st#0@@14| |env#0@@8|) (let ((|sts'#0| ($Unbox SetType (M0.Tuple.snd (M0.__default.evalArgs $ly@@8 |expr#0@@2| (M0.Expression.args |expr#0@@2|) |st#0@@14| |env#0@@8|)))))
(let ((|args'#0| ($Unbox SeqType (M0.Tuple.fst (M0.__default.evalArgs $ly@@8 |expr#0@@2| (M0.Expression.args |expr#0@@2|) |st#0@@14| |env#0@@8|)))))
(let ((|sts''#0| (|Set#Union| (|Set#UnionOne| |Set#Empty| |st'#3|) |sts'#0|)))
 ...
 (and (M0.Tuple.Pair_q |ps#0|) (M0.Tuple.Pair_q |ps#0|)))))))))))))))))))))))))))))) (= (M0.__default.eval ($LS $ly@@8) |expr#0@@2| |st#0@@14| |env#0@@8|) (ite (M0.__default.Value |expr#0@@2|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType |expr#0@@2|) |st#0@@14|) (ite (M0.Expression.exprIdentifier_q |expr#0@@2|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (M0.__default.GetEnv (M0.Expression.id |expr#0@@2|) |env#0@@8|)) |st#0@@14|) (ite (M0.Expression.exprIf_q |expr#0@@2|) (let ((|st'#0@@3| (M0.Tuple.snd (M0.__default.eval $ly@@8 (M0.Expression.cond |expr#0@@2|) |st#0@@14| |env#0@@8|))))
(let ((|cond'#0@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@8 (M0.Expression.cond |expr#0@@2|) |st#0@@14| |env#0@@8|)))))
(ite  (and (M0.Expression.exprLiteral_q |cond'#0@@0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#0@@0|) |#M0.Literal.litTrue|)) (M0.__default.eval $ly@@8 (M0.Expression.ifTrue |expr#0@@2|) |st'#0@@3| |env#0@@8|) (ite  (and (M0.Expression.exprLiteral_q |cond'#0@@0|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#0@@0|) |#M0.Literal.litFalse|)) (M0.__default.eval $ly@@8 (M0.Expression.ifFalse |expr#0@@2|) |st'#0@@3| |env#0@@8|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@14|))))) (ite (M0.Expression.exprAnd_q |expr#0@@2|) (let ((|st'#1@@2| (M0.Tuple.snd (M0.__default.eval $ly@@8 (M0.Expression.conj0 |expr#0@@2|) |st#0@@14| |env#0@@8|))))
(let ((|conj0'#0@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@8 (M0.Expression.conj0 |expr#0@@2|) |st#0@@14| |env#0@@8|)))))
...
(let ((|disj0'#0@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@8 (M0.Expression.disj0 |expr#0@@2|) |st#0@@14| |env#0@@8|)))))
...
(let ((|fun'#0@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval $ly@@8 (M0.Expression.fun |expr#0@@2|) |st#0@@14| |env#0@@8|)))))
(let ((|sts'#0@@0| ($Unbox SetType (M0.Tuple.snd (M0.__default.evalArgs $ly@@8 |expr#0@@2| (M0.Expression.args |expr#0@@2|) |st#0@@14| |env#0@@8|)))))
(let ((|args'#0@@0| ($Unbox SeqType (M0.Tuple.fst (M0.__default.evalArgs $ly@@8 |expr#0@@2| (M0.Expression.args |expr#0@@2|) |st#0@@14| |env#0@@8|)))))
(let ((|sts''#0@@0| (|Set#Union| (|Set#UnionOne| |Set#Empty| |st'#3@@0|) |sts'#0@@0|)))
(ite  (not (M0.__default.Compatible |sts''#0@@0|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rCompatibility|)))) |st#0@@14|) (let ((|stCombined#0@@0| (M0.__default.Combine ($LS $LZ) |sts''#0@@0|)))
...
(|#M0.Tuple.Pair| ($Box DatatypeTypeType (|#M0.Expression.exprLiteral| (|#M0.Literal.litArrOfPaths| ($Unbox SetType (M0.Tuple.fst |ps#0@@0|))))) (M0.Tuple.snd |ps#0@@0|))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@14|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@14|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@14|))))))))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@14|))))))))))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |974|
 :pattern ( (M0.__default.eval ($LS $ly@@8) |expr#0@@2| |st#0@@14| |env#0@@8|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|st#0@@15| T@U) ) (!  (=> (or (|M0.__default.DomSt#canCall| |st#0@@15|) (and (< 0 $FunctionContextHeight) ($IsBox |st#0@@15| Tclass.M0.State))) ($Is SetType (M0.__default.DomSt |st#0@@15|) (TSet Tclass.M0.Path)))
 :qid |CloudMakeParallelBuildsdfy.9:24|
 :skolemid |699|
 :pattern ( (M0.__default.DomSt |st#0@@15|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|cmd#0@@5| T@U) (|deps#0@@5| T@U) (|exps#0@@4| T@U) (|st#0@@16| T@U) ) (!  (=> (or (|M0.__default.Pre#canCall| |cmd#0@@5| |deps#0@@5| |exps#0@@4| |st#0@@16|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@5| (TSeq TChar)) ($Is SetType |deps#0@@5| (TSet Tclass.M0.Path))) ($Is SetType |exps#0@@4| (TSet (TSeq TChar)))) ($IsBox |st#0@@16| Tclass.M0.State)))) (and (forall ((|e#0| T@U) ) (!  (=> ($Is SeqType |e#0| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@4| ($Box SeqType |e#0|)) (and (and (|M0.__default.Loc#canCall| |cmd#0@@5| |deps#0@@5| |e#0|) (|M0.__default.DomSt#canCall| |st#0@@16|)) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@16|) (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0|)) (and (and (|M0.__default.Loc#canCall| |cmd#0@@5| |deps#0@@5| |e#0|) (|M0.__default.GetSt#canCall| (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0|) |st#0@@16|)) (and (|M0.__default.Loc#canCall| |cmd#0@@5| |deps#0@@5| |e#0|) (|M0.__default.Oracle#canCall| (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0|) |st#0@@16|)))))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |819|
 :pattern ( (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0|))
 :pattern ( (|Set#IsMember| |exps#0@@4| ($Box SeqType |e#0|)))
)) (= (M0.__default.Pre |cmd#0@@5| |deps#0@@5| |exps#0@@4| |st#0@@16|) (forall ((|e#0@@0| T@U) ) (!  (=> ($Is SeqType |e#0@@0| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@4| ($Box SeqType |e#0@@0|)) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@16|) (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0@@0|)) (= (M0.__default.GetSt (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0@@0|) |st#0@@16|) (M0.__default.Oracle (M0.__default.Loc |cmd#0@@5| |deps#0@@5| |e#0@@0|) |st#0@@16|)))))
 :qid |CloudMakeParallelBuildsdfy.85:12|
 :skolemid |818|
 ...
 :qid |CloudMakeParallelBuildsdfy.83:23|
 :skolemid |820|
 :pattern ( (M0.__default.Pre |cmd#0@@5| |deps#0@@5| |exps#0@@4| |st#0@@16|))
))))
(assert (forall (($ly@@10 T@U) (|expr#0@@3| T@U) (|st#0@@17| T@U) (|env#0@@9| T@U) ) (! (= (M0.__default.eval ($LS $ly@@10) |expr#0@@3| |st#0@@17| |env#0@@9|) (M0.__default.eval $ly@@10 |expr#0@@3| |st#0@@17| |env#0@@9|))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |969|
 :pattern ( (M0.__default.eval ($LS $ly@@10) |expr#0@@3| |st#0@@17| |env#0@@9|))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@5 T@U) ($ly@@11 T@U) (|expr#0@@4| T@U) (|st#0@@18| T@U) (|env#0@@10| T@U) ) (!  (=> (and (or (|M0.__default.eval#canCall| |expr#0@@4| |st#0@@18| |env#0@@10|) (and (< 4 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |expr#0@@4| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |expr#0@@4| Tclass.M0.Expression $Heap@@5)) (and ($IsBox |st#0@@18| Tclass.M0.State) ($IsAllocBox |st#0@@18| Tclass.M0.State $Heap@@5))) (and ($IsBox |env#0@@10| Tclass.M0.Env) ($IsAllocBox |env#0@@10| Tclass.M0.Env $Heap@@5))) (M0.__default.ValidEnv |env#0@@10|)))) ($IsGoodHeap $Heap@@5)) ($IsAlloc DatatypeTypeType (M0.__default.eval $ly@@11 |expr#0@@4| |st#0@@18| |env#0@@10|) (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State) $Heap@@5))
 :qid |CloudMakeParallelBuildsdfy.202:18|
 :skolemid |972|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.__default.eval $ly@@11 |expr#0@@4| |st#0@@18| |env#0@@10|) (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State) $Heap@@5))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|prim#0@@4| T@U) (|args#0@@6| T@U) (|st#0@@19| T@U) ) (!  (=> (or (|M0.__default.ValidArgs#canCall| (Lit DatatypeTypeType |prim#0@@4|) (Lit SeqType |args#0@@6|) |st#0@@19|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |prim#0@@4| Tclass.M0.Primitive) ($Is SeqType |args#0@@6| (TSeq Tclass.M0.Expression))) ($IsBox |st#0@@19| Tclass.M0.State)) (and (=> (M0.Primitive.primExec_q (Lit DatatypeTypeType |prim#0@@4|)) (= (|Seq#Length| (Lit SeqType |args#0@@6|)) (LitInt 3))) (=> (M0.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@4|)) (= (|Seq#Length| (Lit SeqType |args#0@@6|)) (LitInt 1))))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@4|)))))) (let ((|exps#3| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@6|) (LitInt 2)))))
...
(let ((|cmd#3| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@6|) (LitInt 0)))))
 (=> (M0.Expression.exprLiteral_q |cmd#3|) (=> (M0.Literal.litString_q (M0.Expression.lit |cmd#3|)) (=> (M0.Expression.exprLiteral_q |deps#3|) (=> (M0.Literal.litArrOfPaths_q (M0.Expression.lit |deps#3|)) (=> (M0.Expression.exprLiteral_q |exps#3|) (=> (M0.Literal.litArrOfStrings_q (M0.Expression.lit |exps#3|)) (and (|M0.__default.DomSt#canCall| |st#0@@19|) (=> (|Set#Subset| (M0.Literal.paths (M0.Expression.lit |deps#3|)) (M0.__default.DomSt |st#0@@19|)) (|M0.__default.Pre#canCall| (M0.Literal.str (M0.Expression.lit |cmd#3|)) (M0.Literal.paths (M0.Expression.lit |deps#3|)) (M0.Literal.strs (M0.Expression.lit |exps#3|)) |st#0@@19|))))))))))))) (= (M0.__default.ValidArgs (Lit DatatypeTypeType |prim#0@@4|) (Lit SeqType |args#0@@6|) |st#0@@19|) (ite (M0.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@4|)) false (let ((|exps#2| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@6|) (LitInt 2)))))
...
(assert (forall ((d@@44 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (M0.Literal.litNumber_q d@@44) ($IsAlloc DatatypeTypeType d@@44 Tclass.M0.Literal $h@@17))) ($IsAlloc intType (int_2_U (M0.Literal.num d@@44)) TInt $h@@17))
 :qid |unknown.0:0|
 :skolemid |1277|
 :pattern ( ($IsAlloc intType (int_2_U (M0.Literal.num d@@44)) TInt $h@@17))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@6 T@U) (|p#0@@5| T@U) (|st#0@@20| T@U) ) (!  (=> (and (or (|M0.__default.Oracle#canCall| |p#0@@5| |st#0@@20|) (and (< 0 $FunctionContextHeight) (and (and ($IsBox |p#0@@5| Tclass.M0.Path) ($IsAllocBox |p#0@@5| Tclass.M0.Path $Heap@@6)) (and ($IsBox |st#0@@20| Tclass.M0.State) ($IsAllocBox |st#0@@20| Tclass.M0.State $Heap@@6))))) ($IsGoodHeap $Heap@@6)) ($IsAllocBox (M0.__default.Oracle |p#0@@5| |st#0@@20|) Tclass.M0.Artifact $Heap@@6))
 :qid |CloudMakeParallelBuildsdfy.104:18|
 :skolemid |869|
 :pattern ( ($IsAllocBox (M0.__default.Oracle |p#0@@5| |st#0@@20|) Tclass.M0.Artifact $Heap@@6))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@7 T@U) (|st#0@@21| T@U) (|st'#0@@4| T@U) ) (!  (=> (and (or (|M0.__default.Union#canCall| |st#0@@21| |st'#0@@4|) (and (< 2 $FunctionContextHeight) (and (and ($IsBox |st#0@@21| Tclass.M0.State) ($IsAllocBox |st#0@@21| Tclass.M0.State $Heap@@7)) (and ($IsBox |st'#0@@4| Tclass.M0.State) ($IsAllocBox |st'#0@@4| Tclass.M0.State $Heap@@7))))) ($IsGoodHeap $Heap@@7)) ($IsAllocBox (M0.__default.Union |st#0@@21| |st'#0@@4|) Tclass.M0.State $Heap@@7))
 :qid |CloudMakeParallelBuildsdfy.23:18|
 :skolemid |722|
 :pattern ( ($IsAllocBox (M0.__default.Union |st#0@@21| |st'#0@@4|) Tclass.M0.State $Heap@@7))
))))
...
(assert (forall ((d@@46 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) ($Is DatatypeTypeType d@@46 Tclass.M0.Primitive)) ($IsAlloc DatatypeTypeType d@@46 Tclass.M0.Primitive $h@@18))
 :qid |unknown.0:0|
 :skolemid |1349|
 :pattern ( ($IsAlloc DatatypeTypeType d@@46 Tclass.M0.Primitive $h@@18))
)))
(assert (forall ((d@@47 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) ($Is DatatypeTypeType d@@47 Tclass.M0.Reason)) ($IsAlloc DatatypeTypeType d@@47 Tclass.M0.Reason $h@@19))
 :qid |unknown.0:0|
 :skolemid |1359|
 :pattern ( ($IsAlloc DatatypeTypeType d@@47 Tclass.M0.Reason $h@@19))
)))
...
(assert (forall ((d@@48 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (M0.Literal.litString_q d@@48) ($IsAlloc DatatypeTypeType d@@48 Tclass.M0.Literal $h@@20))) ($IsAlloc SeqType (M0.Literal.str d@@48) (TSeq TChar) $h@@20))
 :qid |unknown.0:0|
 :skolemid |1286|
 :pattern ( ($IsAlloc SeqType (M0.Literal.str d@@48) (TSeq TChar) $h@@20))
)))
(assert (forall ((|a#111#0#0| T@U) (d@@49 T@U) ) (!  (=> (|Set#IsMember| |a#111#0#0| ($Box DatatypeTypeType d@@49)) (< (DtRank d@@49) (DtRank (|#M0.Literal.litArrOfPaths| |a#111#0#0|))))
 :qid |CloudMakeParallelBuildsdfy.145:36|
 :skolemid |1310|
 :pattern ( (|Set#IsMember| |a#111#0#0| ($Box DatatypeTypeType d@@49)) (|#M0.Literal.litArrOfPaths| |a#111#0#0|))
)))
(assert (forall ((|a#117#0#0| T@U) (d@@50 T@U) ) (!  (=> (|Set#IsMember| |a#117#0#0| ($Box DatatypeTypeType d@@50)) (< (DtRank d@@50) (DtRank (|#M0.Literal.litArrOfStrings| |a#117#0#0|))))
 :qid |CloudMakeParallelBuildsdfy.146:38|
 :skolemid |1320|
 :pattern ( (|Set#IsMember| |a#117#0#0| ($Box DatatypeTypeType d@@50)) (|#M0.Literal.litArrOfStrings| |a#117#0#0|))
)))
...
(assert (forall ((d@@51 T@U) (M0.Tuple$A@@6 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (M0.Tuple.Pair_q d@@51) (exists ((M0.Tuple$B@@6 T@U) ) (! ($IsAlloc DatatypeTypeType d@@51 (Tclass.M0.Tuple M0.Tuple$A@@6 M0.Tuple$B@@6) $h@@21)
 :qid |unknown.0:0|
 :skolemid |1371|
 :pattern ( ($IsAlloc DatatypeTypeType d@@51 (Tclass.M0.Tuple M0.Tuple$A@@6 M0.Tuple$B@@6) $h@@21))
)))) ($IsAllocBox (M0.Tuple.fst d@@51) M0.Tuple$A@@6 $h@@21))
 :qid |unknown.0:0|
 :skolemid |1372|
 :pattern ( ($IsAllocBox (M0.Tuple.fst d@@51) M0.Tuple$A@@6 $h@@21))
)))
(assert (forall ((d@@52 T@U) (M0.Tuple$B@@7 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (M0.Tuple.Pair_q d@@52) (exists ((M0.Tuple$A@@7 T@U) ) (! ($IsAlloc DatatypeTypeType d@@52 (Tclass.M0.Tuple M0.Tuple$A@@7 M0.Tuple$B@@7) $h@@22)
 :qid |unknown.0:0|
 :skolemid |1373|
 :pattern ( ($IsAlloc DatatypeTypeType d@@52 (Tclass.M0.Tuple M0.Tuple$A@@7 M0.Tuple$B@@7) $h@@22))
)))) ($IsAllocBox (M0.Tuple.snd d@@52) M0.Tuple$B@@7 $h@@22))
 :qid |unknown.0:0|
 :skolemid |1374|
 :pattern ( ($IsAllocBox (M0.Tuple.snd d@@52) M0.Tuple$B@@7 $h@@22))
)))
...
(assert (forall ((d@@53 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (M0.Expression.exprLiteral_q d@@53) ($IsAlloc DatatypeTypeType d@@53 Tclass.M0.Expression $h@@23))) ($IsAlloc DatatypeTypeType (M0.Expression.lit d@@53) Tclass.M0.Literal $h@@23))
 :qid |unknown.0:0|
 :skolemid |1169|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.lit d@@53) Tclass.M0.Literal $h@@23))
)))
(assert (forall ((d@@54 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (M0.Expression.exprIdentifier_q d@@54) ($IsAlloc DatatypeTypeType d@@54 Tclass.M0.Expression $h@@24))) ($IsAllocBox (M0.Expression.id d@@54) Tclass.M0.Identifier $h@@24))
 :qid |unknown.0:0|
 :skolemid |1179|
 :pattern ( ($IsAllocBox (M0.Expression.id d@@54) Tclass.M0.Identifier $h@@24))
)))
(assert (forall ((d@@55 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (M0.Expression.exprIf_q d@@55) ($IsAlloc DatatypeTypeType d@@55 Tclass.M0.Expression $h@@25))) ($IsAlloc DatatypeTypeType (M0.Expression.cond d@@55) Tclass.M0.Expression $h@@25))
 :qid |unknown.0:0|
 :skolemid |1188|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.cond d@@55) Tclass.M0.Expression $h@@25))
)))
(assert (forall ((d@@56 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (M0.Expression.exprIf_q d@@56) ($IsAlloc DatatypeTypeType d@@56 Tclass.M0.Expression $h@@26))) ($IsAlloc DatatypeTypeType (M0.Expression.ifTrue d@@56) Tclass.M0.Expression $h@@26))
 :qid |unknown.0:0|
 :skolemid |1189|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.ifTrue d@@56) Tclass.M0.Expression $h@@26))
)))
(assert (forall ((d@@57 T@U) ($h@@27 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (M0.Expression.exprIf_q d@@57) ($IsAlloc DatatypeTypeType d@@57 Tclass.M0.Expression $h@@27))) ($IsAlloc DatatypeTypeType (M0.Expression.ifFalse d@@57) Tclass.M0.Expression $h@@27))
 :qid |unknown.0:0|
 :skolemid |1190|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.ifFalse d@@57) Tclass.M0.Expression $h@@27))
)))
(assert (forall ((d@@58 T@U) ($h@@28 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (M0.Expression.exprAnd_q d@@58) ($IsAlloc DatatypeTypeType d@@58 Tclass.M0.Expression $h@@28))) ($IsAlloc DatatypeTypeType (M0.Expression.conj0 d@@58) Tclass.M0.Expression $h@@28))
 :qid |unknown.0:0|
 :skolemid |1204|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.conj0 d@@58) Tclass.M0.Expression $h@@28))
)))
(assert (forall ((d@@59 T@U) ($h@@29 T@U) ) (!  (=> (and ($IsGoodHeap $h@@29) (and (M0.Expression.exprAnd_q d@@59) ($IsAlloc DatatypeTypeType d@@59 Tclass.M0.Expression $h@@29))) ($IsAlloc DatatypeTypeType (M0.Expression.conj1 d@@59) Tclass.M0.Expression $h@@29))
 :qid |unknown.0:0|
 :skolemid |1205|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.conj1 d@@59) Tclass.M0.Expression $h@@29))
)))
(assert (forall ((d@@60 T@U) ($h@@30 T@U) ) (!  (=> (and ($IsGoodHeap $h@@30) (and (M0.Expression.exprOr_q d@@60) ($IsAlloc DatatypeTypeType d@@60 Tclass.M0.Expression $h@@30))) ($IsAlloc DatatypeTypeType (M0.Expression.disj0 d@@60) Tclass.M0.Expression $h@@30))
 :qid |unknown.0:0|
 :skolemid |1217|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.disj0 d@@60) Tclass.M0.Expression $h@@30))
)))
(assert (forall ((d@@61 T@U) ($h@@31 T@U) ) (!  (=> (and ($IsGoodHeap $h@@31) (and (M0.Expression.exprOr_q d@@61) ($IsAlloc DatatypeTypeType d@@61 Tclass.M0.Expression $h@@31))) ($IsAlloc DatatypeTypeType (M0.Expression.disj1 d@@61) Tclass.M0.Expression $h@@31))
 :qid |unknown.0:0|
 :skolemid |1218|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.disj1 d@@61) Tclass.M0.Expression $h@@31))
)))
(assert (forall ((d@@62 T@U) ($h@@32 T@U) ) (!  (=> (and ($IsGoodHeap $h@@32) (and (M0.Expression.exprInvocation_q d@@62) ($IsAlloc DatatypeTypeType d@@62 Tclass.M0.Expression $h@@32))) ($IsAlloc DatatypeTypeType (M0.Expression.fun d@@62) Tclass.M0.Expression $h@@32))
 :qid |unknown.0:0|
 :skolemid |1230|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.fun d@@62) Tclass.M0.Expression $h@@32))
)))
(assert (forall ((d@@63 T@U) ($h@@33 T@U) ) (!  (=> (and ($IsGoodHeap $h@@33) (and (M0.Expression.exprError_q d@@63) ($IsAlloc DatatypeTypeType d@@63 Tclass.M0.Expression $h@@33))) ($IsAlloc DatatypeTypeType (M0.Expression.r d@@63) Tclass.M0.Reason $h@@33))
 :qid |unknown.0:0|
 :skolemid |1245|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Expression.r d@@63) Tclass.M0.Reason $h@@33))
)))
(assert (forall ((d@@64 T@U) ($h@@34 T@U) ) (!  (=> (and ($IsGoodHeap $h@@34) (and (M0.Literal.litPrimitive_q d@@64) ($IsAlloc DatatypeTypeType d@@64 Tclass.M0.Literal $h@@34))) ($IsAlloc DatatypeTypeType (M0.Literal.prim d@@64) Tclass.M0.Primitive $h@@34))
 :qid |unknown.0:0|
 :skolemid |1297|
 :pattern ( ($IsAlloc DatatypeTypeType (M0.Literal.prim d@@64) Tclass.M0.Primitive $h@@34))
)))
...
(assert (forall ((d@@65 T@U) ($h@@35 T@U) ) (!  (=> (and ($IsGoodHeap $h@@35) (and (M0.Literal.litArrOfStrings_q d@@65) ($IsAlloc DatatypeTypeType d@@65 Tclass.M0.Literal $h@@35))) ($IsAlloc SetType (M0.Literal.strs d@@65) (TSet (TSeq TChar)) $h@@35))
 :qid |unknown.0:0|
 :skolemid |1317|
 :pattern ( ($IsAlloc SetType (M0.Literal.strs d@@65) (TSet (TSeq TChar)) $h@@35))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@14 T@U) (|expr#0@@6| T@U) (|st#0@@22| T@U) (|env#0@@12| T@U) ) (!  (=> (or (|M0.__default.eval#canCall| (Lit DatatypeTypeType |expr#0@@6|) |st#0@@22| |env#0@@12|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |expr#0@@6| Tclass.M0.Expression) ($IsBox |st#0@@22| Tclass.M0.State)) ($IsBox |env#0@@12| Tclass.M0.Env)) (M0.__default.ValidEnv |env#0@@12|)))) (and (and (|M0.__default.Value#canCall| (Lit DatatypeTypeType |expr#0@@6|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.__default.Value (Lit DatatypeTypeType |expr#0@@6|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@6|))))) (|M0.__default.GetEnv#canCall| (Lit BoxType (M0.Expression.id (Lit DatatypeTypeType |expr#0@@6|))) |env#0@@12|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@6|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@6|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@22| |env#0@@12|) (let ((|st'#4| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@22| |env#0@@12|))))
(let ((|cond'#1| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@22| |env#0@@12|)))))
 (and (and (=> (M0.Expression.exprLiteral_q |cond'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#1|))) (=> (and (M0.Expression.exprLiteral_q |cond'#1|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#1|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.ifTrue (Lit DatatypeTypeType |expr#0@@6|))) |st'#4| |env#0@@12|))) (=> (not (and (M0.Expression.exprLiteral_q |cond'#1|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#1|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |cond'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |cond'#1|))) (=> (and (M0.Expression.exprLiteral_q |cond'#1|) (|M0.Literal#Equal| (M0.Expression.lit |cond'#1|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.ifFalse (Lit DatatypeTypeType |expr#0@@6|))) |st'#4| |env#0@@12|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@6|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@6|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@22| |env#0@@12|) (let ((|st'#5| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@22| |env#0@@12|))))
(let ((|conj0'#1| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@22| |env#0@@12|)))))
 (and (and (=> (M0.Expression.exprLiteral_q |conj0'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#1|))) (=> (and (M0.Expression.exprLiteral_q |conj0'#1|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#1|) |#M0.Literal.litTrue|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.conj1 (Lit DatatypeTypeType |expr#0@@6|))) |st'#5| |env#0@@12|))) (=> (not (and (M0.Expression.exprLiteral_q |conj0'#1|) (|M0.Literal#Equal| (M0.Expression.lit |conj0'#1|) |#M0.Literal.litTrue|))) (=> (M0.Expression.exprLiteral_q |conj0'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |conj0'#1|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@6|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@6|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@22| |env#0@@12|) (let ((|st'#6| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@22| |env#0@@12|))))
(let ((|disj0'#1| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@22| |env#0@@12|)))))
 (and (=> (M0.Expression.exprLiteral_q |disj0'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#1|))) (=> (not (and (M0.Expression.exprLiteral_q |disj0'#1|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#1|) |#M0.Literal.litTrue|))) (and (=> (M0.Expression.exprLiteral_q |disj0'#1|) (|$IsA#M0.Literal| (M0.Expression.lit |disj0'#1|))) (=> (and (M0.Expression.exprLiteral_q |disj0'#1|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#1|) |#M0.Literal.litFalse|)) (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.disj1 (Lit DatatypeTypeType |expr#0@@6|))) |st'#6| |env#0@@12|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@6|)))))) (=> (U_2_bool (Lit boolType (bool_2_U (M0.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0@@6|))))) (and (|M0.__default.eval#canCall| (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@22| |env#0@@12|) (let ((|st'#7| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@22| |env#0@@12|))))
(let ((|fun'#1| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@22| |env#0@@12|)))))
 (and (|M0.__default.evalArgs#canCall| (Lit DatatypeTypeType |expr#0@@6|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@22| |env#0@@12|) (let ((|sts'#1| ($Unbox SetType (M0.Tuple.snd (M0.__default.evalArgs ($LS $ly@@14) (Lit DatatypeTypeType |expr#0@@6|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@22| |env#0@@12|)))))
(let ((|args'#1| ($Unbox SeqType (M0.Tuple.fst (M0.__default.evalArgs ($LS $ly@@14) (Lit DatatypeTypeType |expr#0@@6|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@22| |env#0@@12|)))))
(let ((|sts''#1| (|Set#Union| (|Set#UnionOne| |Set#Empty| |st'#7|) |sts'#1|)))
 ...
 (and (M0.Tuple.Pair_q |ps#1|) (M0.Tuple.Pair_q |ps#1|)))))))))))))))))))))))))))))) (= (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType |expr#0@@6|) |st#0@@22| |env#0@@12|) (ite (M0.__default.Value (Lit DatatypeTypeType |expr#0@@6|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType |expr#0@@6|)) |st#0@@22|) (ite (M0.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@6|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (M0.__default.GetEnv (Lit BoxType (M0.Expression.id (Lit DatatypeTypeType |expr#0@@6|))) |env#0@@12|)) |st#0@@22|) (ite (M0.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@6|)) (let ((|st'#4@@0| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@22| |env#0@@12|))))
(let ((|cond'#1@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.cond (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@22| |env#0@@12|)))))
...
(let ((|conj0'#1@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.conj0 (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@22| |env#0@@12|)))))
...
(let ((|disj0'#1@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.disj0 (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@22| |env#0@@12|)))))
(ite  (and (M0.Expression.exprLiteral_q |disj0'#1@@0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#1@@0|) |#M0.Literal.litTrue|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprLiteral| (Lit DatatypeTypeType |#M0.Literal.litTrue|)))) |st'#6@@0|) (ite  (and (M0.Expression.exprLiteral_q |disj0'#1@@0|) (|M0.Literal#Equal| (M0.Expression.lit |disj0'#1@@0|) |#M0.Literal.litFalse|)) (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.disj1 (Lit DatatypeTypeType |expr#0@@6|))) |st'#6@@0| |env#0@@12|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@22|))))) (ite (M0.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0@@6|)) (let ((|st'#7@@0| (M0.Tuple.snd (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@22| |env#0@@12|))))
(let ((|fun'#1@@0| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType (M0.Expression.fun (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@22| |env#0@@12|)))))
(let ((|sts'#1@@0| ($Unbox SetType (M0.Tuple.snd (M0.__default.evalArgs ($LS $ly@@14) (Lit DatatypeTypeType |expr#0@@6|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@22| |env#0@@12|)))))
(let ((|args'#1@@0| ($Unbox SeqType (M0.Tuple.fst (M0.__default.evalArgs ($LS $ly@@14) (Lit DatatypeTypeType |expr#0@@6|) (Lit SeqType (M0.Expression.args (Lit DatatypeTypeType |expr#0@@6|))) |st#0@@22| |env#0@@12|)))))
(let ((|sts''#1@@0| (|Set#Union| (|Set#UnionOne| |Set#Empty| |st'#7@@0|) |sts'#1@@0|)))
(ite  (not (M0.__default.Compatible |sts''#1@@0|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rCompatibility|)))) |st#0@@22|) (let ((|stCombined#1@@0| (M0.__default.Combine ($LS $LZ) |sts''#1@@0|)))
...
(|#M0.Tuple.Pair| ($Box DatatypeTypeType (|#M0.Expression.exprLiteral| (|#M0.Literal.litArrOfPaths| ($Unbox SetType (M0.Tuple.fst |ps#1@@0|))))) (M0.Tuple.snd |ps#1@@0|))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@22|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@22|)) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@22|))))))))) (|#M0.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#M0.Expression.exprError| (Lit DatatypeTypeType |#M0.Reason.rValidity|)))) |st#0@@22|))))))))))
 ...
 :weight 3
 :skolemid |975|
 :pattern ( (M0.__default.eval ($LS $ly@@14) (Lit DatatypeTypeType |expr#0@@6|) |st#0@@22| |env#0@@12|))
))))
...
(assert (forall ((d@@66 T@U) ($h@@36 T@U) ) (!  (=> (and ($IsGoodHeap $h@@36) (and (M0.Expression.exprInvocation_q d@@66) ($IsAlloc DatatypeTypeType d@@66 Tclass.M0.Expression $h@@36))) ($IsAlloc SeqType (M0.Expression.args d@@66) (TSeq Tclass.M0.Expression) $h@@36))
 :qid |unknown.0:0|
 :skolemid |1231|
 :pattern ( ($IsAlloc SeqType (M0.Expression.args d@@66) (TSeq Tclass.M0.Expression) $h@@36))
)))
(assert (forall ((d@@67 T@U) ($h@@37 T@U) ) (!  (=> (and ($IsGoodHeap $h@@37) (and (M0.Literal.litArrOfPaths_q d@@67) ($IsAlloc DatatypeTypeType d@@67 Tclass.M0.Literal $h@@37))) ($IsAlloc SetType (M0.Literal.paths d@@67) (TSet Tclass.M0.Path) $h@@37))
 :qid |unknown.0:0|
 :skolemid |1307|
 :pattern ( ($IsAlloc SetType (M0.Literal.paths d@@67) (TSet Tclass.M0.Path) $h@@37))
)))
(assert (forall ((d@@68 T@U) ($h@@38 T@U) ) (!  (=> (and ($IsGoodHeap $h@@38) (and (M0.Literal.litArray_q d@@68) ($IsAlloc DatatypeTypeType d@@68 Tclass.M0.Literal $h@@38))) ($IsAlloc SeqType (M0.Literal.arr d@@68) (TSeq Tclass.M0.Expression) $h@@38))
 :qid |unknown.0:0|
 :skolemid |1327|
 :pattern ( ($IsAlloc SeqType (M0.Literal.arr d@@68) (TSeq Tclass.M0.Expression) $h@@38))
)))
...
(declare-fun |arg#4@0| () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun |M0.__default.ValidEnv#canCall| (T@U) Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$M0.__default.evalArgs)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon12_Else_correct  (=> (not (|Seq#Equal| |args#0@@8| |Seq#Empty|)) (and (=> (= (ControlFlow 0 4) (- 0 11)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |args#0@@8|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |args#0@@8|))) (=> (and (and (= |##expr#0@0| ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@8| (LitInt 0)))) ($IsAlloc DatatypeTypeType |##expr#0@0| Tclass.M0.Expression $Heap@@9)) (and ($IsAllocBox |stOrig#0@@5| Tclass.M0.State $Heap@@9) ($IsAllocBox |env#0@@13| Tclass.M0.Env $Heap@@9))) (and (=> (= (ControlFlow 0 4) (- 0 10)) (M0.__default.ValidEnv |env#0@@13|)) (=> (M0.__default.ValidEnv |env#0@@13|) (and (=> (= (ControlFlow 0 4) (- 0 9)) (< (DtRank |##expr#0@0|) (DtRank |context#0@@5|))) (=> (< (DtRank |##expr#0@0|) (DtRank |context#0@@5|)) (=> (|M0.__default.eval#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@8| (LitInt 0))) |stOrig#0@@5| |env#0@@13|) (=> (and (M0.Tuple.Pair_q (M0.__default.eval ($LS $LZ) ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@8| (LitInt 0))) |stOrig#0@@5| |env#0@@13|)) (= |let#0#0#0| (M0.__default.eval ($LS $LZ) ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@8| (LitInt 0))) |stOrig#0@@5| |env#0@@13|))) (=> (and (and (|M0.__default.eval#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@8| (LitInt 0))) |stOrig#0@@5| |env#0@@13|) ($Is DatatypeTypeType |let#0#0#0| (Tclass.M0.Tuple Tclass.M0.Expression Tclass.M0.State))) (and (= |r#Z#0@0| |let#0#0#0|) ($IsAlloc DatatypeTypeType |context#0@@5| Tclass.M0.Expression $Heap@@9))) (and (=> (= (ControlFlow 0 4) (- 0 8)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |args#0@@8|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |args#0@@8|))) (=> (and (and (= |##args#0@0| (|Seq#Drop| |args#0@@8| (LitInt 1))) ($IsAlloc SeqType |##args#0@0| (TSeq Tclass.M0.Expression) $Heap@@9)) (and ($IsAllocBox |stOrig#0@@5| Tclass.M0.State $Heap@@9) ($IsAllocBox |env#0@@13| Tclass.M0.Env $Heap@@9))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (M0.__default.ValidEnv |env#0@@13|)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (forall ((|arg#5| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#5| Tclass.M0.Expression) (=> (|Seq#Contains| |##args#0@0| ($Box DatatypeTypeType |arg#5|)) (< (DtRank |arg#5|) (DtRank |context#0@@5|))))
 :qid |CloudMakeParallelBuildsdfy.271:14|
 :skolemid |1012|
 :pattern ( (|Seq#Contains| |##args#0@0| ($Box DatatypeTypeType |arg#5|)))
))) (=> (and (M0.__default.ValidEnv |env#0@@13|) (forall ((|arg#5@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#5@@0| Tclass.M0.Expression) (=> (|Seq#Contains| |##args#0@0| ($Box DatatypeTypeType |arg#5@@0|)) (< (DtRank |arg#5@@0|) (DtRank |context#0@@5|))))
 :qid |CloudMakeParallelBuildsdfy.271:14|
 :skolemid |1013|
 :pattern ( (|Seq#Contains| |##args#0@0| ($Box DatatypeTypeType |arg#5@@0|)))
))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (or (<= 0 (|Seq#Length| |args#0@@8|)) (< (DtRank |context#0@@5|) (DtRank |context#0@@5|))) (= (|Seq#Length| |##args#0@0|) (|Seq#Length| |args#0@@8|)))) (=> (or (or (<= 0 (|Seq#Length| |args#0@@8|)) (< (DtRank |context#0@@5|) (DtRank |context#0@@5|))) (= (|Seq#Length| |##args#0@0|) (|Seq#Length| |args#0@@8|))) (=> (= (ControlFlow 0 4) (- 0 3)) (or (< (DtRank |context#0@@5|) (DtRank |context#0@@5|)) (and (= (DtRank |context#0@@5|) (DtRank |context#0@@5|)) (< (|Seq#Length| |##args#0@0|) (|Seq#Length| |args#0@@8|))))))))))))))))))))))))))
(let ((anon12_Then_correct true))
(let ((anon11_Then_correct true))
(let ((anon4_correct  (=> (forall ((|arg#0@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#0@@1| Tclass.M0.Expression) (=> (|Seq#Contains| |args#0@@8| ($Box DatatypeTypeType |arg#0@@1|)) (< (DtRank |arg#0@@1|) (DtRank |context#0@@5|))))
 :qid |CloudMakeParallelBuildsdfy.271:14|
 :skolemid |1010|
 :pattern ( (|Seq#Contains| |args#0@@8| ($Box DatatypeTypeType |arg#0@@1|)))
)) (and (and (=> (= (ControlFlow 0 12) 1) anon11_Then_correct) (=> (= (ControlFlow 0 12) 2) anon12_Then_correct)) (=> (= (ControlFlow 0 12) 4) anon12_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (=> (|Seq#Contains| |args#0@@8| ($Box DatatypeTypeType |arg#4@0|)) (< (DtRank |arg#4@0|) (DtRank |context#0@@5|))) (= (ControlFlow 0 14) 12)) anon4_correct)))
(let ((anon10_Then_correct  (=> (|Seq#Contains| |args#0@@8| ($Box DatatypeTypeType |arg#4@0|)) (=> (and (< (DtRank |arg#4@0|) (DtRank |context#0@@5|)) (= (ControlFlow 0 13) 12)) anon4_correct))))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@9 alloc false)) ($IsAllocBox |env#0@@13| Tclass.M0.Env $Heap@@9)) (=> (and (and (|M0.__default.ValidEnv#canCall| |env#0@@13|) (M0.__default.ValidEnv |env#0@@13|)) (and ($Is DatatypeTypeType |arg#4@0| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |arg#4@0| Tclass.M0.Expression $Heap@@9))) (and (=> (= (ControlFlow 0 15) 13) anon10_Then_correct) (=> (= (ControlFlow 0 15) 14) anon10_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@9) ($IsHeapAnchor $Heap@@9)) (and ($Is DatatypeTypeType |context#0@@5| Tclass.M0.Expression) ($Is SeqType |args#0@@8| (TSeq Tclass.M0.Expression)))) (and (and ($IsBox |stOrig#0@@5| Tclass.M0.State) ($IsBox |env#0@@13| Tclass.M0.Env)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 16) 15)))) anon0_correct)))
