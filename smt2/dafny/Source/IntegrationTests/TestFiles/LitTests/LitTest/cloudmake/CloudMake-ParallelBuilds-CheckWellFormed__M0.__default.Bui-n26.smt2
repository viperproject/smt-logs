...
(set-info :boogie-vc-id CheckWellFormed$$M0.__default.BuildLemma)
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@13 alloc false)) (=> (and (and (and (M0.Program.Program_q |prog#0@@4|) (= |##stmts#0@0| (M0.Program.stmts |prog#0@@4|))) (and ($IsAlloc SeqType |##stmts#0@0| (TSeq Tclass.M0.Statement) $Heap@@13) (|M0.__default.Legal#canCall| (M0.Program.stmts |prog#0@@4|)))) (and (and (M0.__default.Legal (M0.Program.stmts |prog#0@@4|)) ($IsAllocBox |st#0@@38| Tclass.M0.State $Heap@@13)) (and (|M0.__default.ValidState#canCall| |st#0@@38|) (M0.__default.ValidState |st#0@@38|)))) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@13 $Heap@0)) (and ($Is DatatypeTypeType |expr'#0@0| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |expr'#0@0| Tclass.M0.Expression $Heap@0))) (and (and ($IsBox |st'#0@0| Tclass.M0.State) ($IsAllocBox |st'#0@0| Tclass.M0.State $Heap@0)) (and ($IsAlloc DatatypeTypeType |prog#0@@4| Tclass.M0.Program $Heap@0) ($IsAllocBox |st#0@@38| Tclass.M0.State $Heap@0)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (=> (|M0.__default.Legal#canCall| (M0.Program.stmts |prog#0@@4|)) (or (M0.__default.Legal (M0.Program.stmts |prog#0@@4|)) (or (not (= (|Seq#Length| (M0.Program.stmts |prog#0@@4|)) 0)) (not true))))) (=> (M0.__default.Legal (M0.Program.stmts |prog#0@@4|)) (=> (and (|M0.__default.build#canCall| |prog#0@@4| |st#0@@38|) (M0.Tuple.Pair_q (M0.__default.build |prog#0@@4| |st#0@@38|))) (=> (and (and (and (|M0.Tuple#Equal| (M0.__default.build |prog#0@@4| |st#0@@38|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType |expr'#0@0|) |st'#0@0|)) ($IsAllocBox |st'#0@0| Tclass.M0.State $Heap@0)) (and (|M0.__default.ValidState#canCall| |st'#0@0|) (M0.__default.ValidState |st'#0@0|))) (and (and ($IsAllocBox |st#0@@38| Tclass.M0.State $Heap@0) ($IsAllocBox |st'#0@0| Tclass.M0.State $Heap@0)) (and (|M0.__default.Extends#canCall| |st#0@@38| |st'#0@0|) (M0.__default.Extends |st#0@@38| |st'#0@0|)))) (and (=> (= (ControlFlow 0 5) 2) anon4_Then_correct) (=> (= (ControlFlow 0 5) 4) anon4_Else_correct)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@13) ($IsHeapAnchor $Heap@@13)) (=> (and (and ($Is DatatypeTypeType |prog#0@@4| Tclass.M0.Program) ($IsAlloc DatatypeTypeType |prog#0@@4| Tclass.M0.Program $Heap@@13)) (|$IsA#M0.Program| |prog#0@@4|)) (=> (and (and (and ($IsBox |st#0@@38| Tclass.M0.State) ($IsAllocBox |st#0@@38| Tclass.M0.State $Heap@@13)) (and ($Is DatatypeTypeType |expr'#0@@1| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |expr'#0@@1| Tclass.M0.Expression $Heap@@13))) (and (and ($IsBox |st'#0@@9| Tclass.M0.State) ($IsAllocBox |st'#0@@9| Tclass.M0.State $Heap@@13)) (and (= 7 $FunctionContextHeight) (= (ControlFlow 0 7) 5)))) anon0_correct)))))
