...
(set-info :boogie-vc-id CheckWellFormed$$M0.__default.CombineExpandsDomain)
...
(let ((anon4_Then_correct  (=> (and ($IsAllocBox |st#0@@7| Tclass.M0.State $Heap@0) (|M0.__default.DomSt#canCall| |st#0@@7|)) (=> (and (and (|Set#IsMember| (M0.__default.DomSt |st#0@@7|) |p#0@@2|) ($IsAlloc SetType |sts#0@@3| (TSet Tclass.M0.State) $Heap@0)) (and ($IsAlloc boolType (bool_2_U |useCache#0@@4|) TBool $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (not (|Set#Equal| |sts#0@@3| |Set#Empty|))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (|Set#IsMember| |sts#0@@3| |st#0@@7|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@4 $Heap@0)) (and (=> (= (ControlFlow 0 4) 2) anon4_Then_correct) (=> (= (ControlFlow 0 4) 3) anon4_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (=> (and (and (and ($IsBox |p#0@@2| Tclass.M0.Path) ($IsAllocBox |p#0@@2| Tclass.M0.Path $Heap@@4)) (and ($IsBox |st#0@@7| Tclass.M0.State) ($IsAllocBox |st#0@@7| Tclass.M0.State $Heap@@4))) (and (and ($Is SetType |sts#0@@3| (TSet Tclass.M0.State)) ($IsAlloc SetType |sts#0@@3| (TSet Tclass.M0.State) $Heap@@4)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 5) 4)))) anon0_correct))))
