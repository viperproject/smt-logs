...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@13 alloc false)) (=> (and (and ($Is DatatypeTypeType |call3formal@expr'#0| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |call3formal@expr'#0| Tclass.M0.Expression $Heap@@13)) (and ($IsBox |call4formal@st'#0| Tclass.M0.State) ($IsAllocBox |call4formal@st'#0| Tclass.M0.State $Heap@@13))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|M0.__default.Legal#canCall| (M0.Program.stmts |prog#0@@4|)) (or (M0.__default.Legal (M0.Program.stmts |prog#0@@4|)) (or (not (= (|Seq#Length| (M0.Program.stmts |prog#0@@4|)) 0)) (not true))))) (=> (=> (|M0.__default.Legal#canCall| (M0.Program.stmts |prog#0@@4|)) (or (M0.__default.Legal (M0.Program.stmts |prog#0@@4|)) (or (not (= (|Seq#Length| (M0.Program.stmts |prog#0@@4|)) 0)) (not true)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|M0.__default.ValidState#canCall| |st#0@@38|) (or (M0.__default.ValidState |st#0@@38|) (forall ((|p#0@@11| T@U) ) (!  (=> ($IsBox |p#0@@11| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@38|) |p#0@@11|) (M0.__default.WellFounded |p#0@@11|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |1035|
...
)))) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and ($Is DatatypeTypeType |call3formal@expr'#0@0| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |call3formal@expr'#0@0| Tclass.M0.Expression $Heap@0)) (and ($IsBox |call4formal@st'#0@0| Tclass.M0.State) ($IsAllocBox |call4formal@st'#0@0| Tclass.M0.State $Heap@0))) (=> (and (and (and (and (and (|$IsA#M0.Tuple| (M0.__default.build |prog#0@@4| |st#0@@38|)) (|M0.__default.build#canCall| |prog#0@@4| |st#0@@38|)) (=> (|M0.Tuple#Equal| (M0.__default.build |prog#0@@4| |st#0@@38|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType |call3formal@expr'#0@0|) |call4formal@st'#0@0|)) (and (|M0.__default.ValidState#canCall| |call4formal@st'#0@0|) (=> (M0.__default.ValidState |call4formal@st'#0@0|) (and (|M0.__default.Extends#canCall| |st#0@@38| |call4formal@st'#0@0|) (=> (M0.__default.Extends |st#0@@38| |call4formal@st'#0@0|) (=> (M0.Expression.exprError_q |call3formal@expr'#0@0|) (|$IsA#M0.Reason| (M0.Expression.r |call3formal@expr'#0@0|))))))))) (|M0.Tuple#Equal| (M0.__default.build |prog#0@@4| |st#0@@38|) (|#M0.Tuple.Pair| ($Box DatatypeTypeType |call3formal@expr'#0@0|) |call4formal@st'#0@0|))) (and (|M0.__default.ValidState#canCall| |call4formal@st'#0@0|) (and (M0.__default.ValidState |call4formal@st'#0@0|) (forall ((|p#1@@5| T@U) ) (!  (=> ($IsBox |p#1@@5| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |call4formal@st'#0@0|) |p#1@@5|) (M0.__default.WellFounded |p#1@@5|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |1038|
 :pattern ( (M0.__default.WellFounded |p#1@@5|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |call4formal@st'#0@0|) |p#1@@5|))
))))) (and (and (|M0.__default.Extends#canCall| |st#0@@38| |call4formal@st'#0@0|) (and (M0.__default.Extends |st#0@@38| |call4formal@st'#0@0|) (and (and (|Set#Subset| (M0.__default.DomSt |st#0@@38|) (M0.__default.DomSt |call4formal@st'#0@0|)) (forall ((|p#2@@2| T@U) ) (!  (=> ($IsBox |p#2@@2| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@38|) |p#2@@2|) (= (M0.__default.GetSt |p#2@@2| |call4formal@st'#0@0|) (M0.__default.GetSt |p#2@@2| |st#0@@38|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |1041|
 :pattern ( (M0.__default.GetSt |p#2@@2| |st#0@@38|))
 :pattern ( (M0.__default.GetSt |p#2@@2| |call4formal@st'#0@0|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@38|) |p#2@@2|))
))) (forall ((|p#3@@1| T@U) ) (!  (=> ($IsBox |p#3@@1| Tclass.M0.Path) (=> (and (not (|Set#IsMember| (M0.__default.DomSt |st#0@@38|) |p#3@@1|)) (|Set#IsMember| (M0.__default.DomSt |call4formal@st'#0@0|) |p#3@@1|)) (= (M0.__default.GetSt |p#3@@1| |call4formal@st'#0@0|) (M0.__default.Oracle |p#3@@1| |st#0@@38|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |1042|
 :pattern ( (M0.__default.Oracle |p#3@@1| |st#0@@38|))
 :pattern ( (M0.__default.GetSt |p#3@@1| |call4formal@st'#0@0|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |call4formal@st'#0@0|) |p#3@@1|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@38|) |p#3@@1|))
))))) (and (=> (M0.Expression.exprError_q |call3formal@expr'#0@0|) (|M0.Reason#Equal| (M0.Expression.r |call3formal@expr'#0@0|) |#M0.Reason.rValidity|)) (= $Heap@@13 $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (let ((|st'#0@@9| (M0.Tuple.snd (M0.__default.build |prog#0@@4| |st#0@@38|))))
 (=> (|M0.__default.ValidState#canCall| |st'#0@@9|) (or (M0.__default.ValidState |st'#0@@9|) (forall ((|p#3@@2| T@U) ) (!  (=> ($IsBox |p#3@@2| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |st'#0@@9|) |p#3@@2|) (M0.__default.WellFounded |p#3@@2|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |1032|
 :pattern ( (M0.__default.WellFounded |p#3@@2|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@9|) |p#3@@2|))
)))))) (=> (let ((|st'#0@@10| (M0.Tuple.snd (M0.__default.build |prog#0@@4| |st#0@@38|))))
 (=> (|M0.__default.ValidState#canCall| |st'#0@@10|) (or (M0.__default.ValidState |st'#0@@10|) (forall ((|p#3@@3| T@U) ) (!  (=> ($IsBox |p#3@@3| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |st'#0@@10|) |p#3@@3|) (M0.__default.WellFounded |p#3@@3|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |1032|
 :pattern ( (M0.__default.WellFounded |p#3@@3|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st'#0@@10|) |p#3@@3|))
))))) (=> (= (ControlFlow 0 2) (- 0 1)) (let ((|expr'#0@@1| ($Unbox DatatypeTypeType (M0.Tuple.fst (M0.__default.build |prog#0@@4| |st#0@@38|)))))
 (=> (M0.Expression.exprError_q |expr'#0@@1|) (|M0.Reason#Equal| (M0.Expression.r |expr'#0@@1|) |#M0.Reason.rValidity|)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@13) ($IsHeapAnchor $Heap@@13)) (=> (and (and (and (and (and ($Is DatatypeTypeType |prog#0@@4| Tclass.M0.Program) ($IsAlloc DatatypeTypeType |prog#0@@4| Tclass.M0.Program $Heap@@13)) (|$IsA#M0.Program| |prog#0@@4|)) (and ($IsBox |st#0@@38| Tclass.M0.State) ($IsAllocBox |st#0@@38| Tclass.M0.State $Heap@@13))) (and (and ($Is DatatypeTypeType |_v0#0| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |_v0#0| Tclass.M0.Expression $Heap@@13)) true)) (and (and (and (and (=> |defass#_v1#0| (and ($IsBox |_v1#0| Tclass.M0.State) ($IsAllocBox |_v1#0| Tclass.M0.State $Heap@@13))) true) (= 8 $FunctionContextHeight)) (and (|M0.__default.Legal#canCall| (M0.Program.stmts |prog#0@@4|)) (and (M0.__default.Legal (M0.Program.stmts |prog#0@@4|)) (or (not (= (|Seq#Length| (M0.Program.stmts |prog#0@@4|)) 0)) (not true))))) (and (and (|M0.__default.ValidState#canCall| |st#0@@38|) (and (M0.__default.ValidState |st#0@@38|) (forall ((|p#2@@3| T@U) ) (!  (=> ($IsBox |p#2@@3| Tclass.M0.Path) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@38|) |p#2@@3|) (M0.__default.WellFounded |p#2@@3|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |1031|
 :pattern ( (M0.__default.WellFounded |p#2@@3|))
 :pattern ( (|Set#IsMember| (M0.__default.DomSt |st#0@@38|) |p#2@@3|))
