...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|cmd#0| T@U) (|deps#0| T@U) (|exts#0| T@U) (|st#0@@0| T@U) ) (!  (=> (or (|_module.__default.Pre#canCall| |cmd#0| |deps#0| |exts#0| |st#0@@0|) (and (< 3 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |cmd#0| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0| Tclass._module.Expression)) ($Is DatatypeTypeType |exts#0| Tclass._module.Expression)) ($IsBox |st#0@@0| Tclass._module.State)) (and (and (and (and (and (_module.Expression.exprLiteral_q |cmd#0|) (_module.Literal.litString_q (_module.Expression.lit |cmd#0|))) (_module.Expression.exprLiteral_q |deps#0|)) (_module.Literal.litArrOfPaths_q (_module.Expression.lit |deps#0|))) (_module.Expression.exprLiteral_q |exts#0|)) (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#0|)))))) (and (forall ((|e#0| T@U) ) (!  (=> ($Is SeqType |e#0| (TSeq TChar)) (=> (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0|)) ($Box SeqType |e#0|)) (and (and (|_module.__default.Loc#canCall| |cmd#0| |deps#0| |e#0|) (|_module.__default.DomSt#canCall| |st#0@@0|)) (=> (|Set#IsMember| (_module.__default.DomSt |st#0@@0|) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0| |deps#0| |e#0|))) (and (and (|_module.__default.Loc#canCall| |cmd#0| |deps#0| |e#0|) (|_module.__default.GetSt#canCall| (_module.__default.Loc |cmd#0| |deps#0| |e#0|) |st#0@@0|)) (|_module.__default.Res#canCall| |cmd#0| |deps#0| |e#0| |st#0@@0|))))))
 :qid |CloudMakeConsistentBuildslegacydfy.202:10|
 :skolemid |917|
 :pattern ( (_module.__default.Res |cmd#0| |deps#0| |e#0| |st#0@@0|))
...
)) (= (_module.__default.Pre |cmd#0| |deps#0| |exts#0| |st#0@@0|) (forall ((|e#0@@0| T@U) ) (!  (=> ($Is SeqType |e#0@@0| (TSeq TChar)) (=> (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0|)) ($Box SeqType |e#0@@0|)) (=> (|Set#IsMember| (_module.__default.DomSt |st#0@@0|) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0| |deps#0| |e#0@@0|))) (= (_module.__default.GetSt (_module.__default.Loc |cmd#0| |deps#0| |e#0@@0|) |st#0@@0|) (_module.__default.Res |cmd#0| |deps#0| |e#0@@0| |st#0@@0|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.202:10|
 :skolemid |916|
 :pattern ( (_module.__default.Res |cmd#0| |deps#0| |e#0@@0| |st#0@@0|))
 ...
 :skolemid |918|
 :pattern ( (_module.__default.Pre |cmd#0| |deps#0| |exts#0| |st#0@@0|))
))))
(assert (= (Ctor BoxType) 6))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|cmd#0@@0| T@U) (|deps#0@@0| T@U) (|exts#0@@0| T@U) (|st#0@@1| T@U) ) (!  (=> (or (|_module.__default.Pre#canCall| (Lit DatatypeTypeType |cmd#0@@0|) (Lit DatatypeTypeType |deps#0@@0|) (Lit DatatypeTypeType |exts#0@@0|) (Lit BoxType |st#0@@1|)) (and (< 3 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |cmd#0@@0| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@0| Tclass._module.Expression)) ($Is DatatypeTypeType |exts#0@@0| Tclass._module.Expression)) ($IsBox |st#0@@1| Tclass._module.State)) (U_2_bool (Lit boolType (bool_2_U  (and (and (and (and (and (_module.Expression.exprLiteral_q (Lit DatatypeTypeType |cmd#0@@0|)) (_module.Literal.litString_q (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |cmd#0@@0|))))) (_module.Expression.exprLiteral_q (Lit DatatypeTypeType |deps#0@@0|))) (_module.Literal.litArrOfPaths_q (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |deps#0@@0|))))) (_module.Expression.exprLiteral_q (Lit DatatypeTypeType |exts#0@@0|))) (_module.Literal.litArrOfStrings_q (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@0|))))))))))) (and (forall ((|e#2| T@U) ) (!  (=> ($Is SeqType |e#2| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType (_module.Literal.strs (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@0|))))) ($Box SeqType |e#2|)) (and (and (|_module.__default.Loc#canCall| (Lit DatatypeTypeType |cmd#0@@0|) (Lit DatatypeTypeType |deps#0@@0|) |e#2|) (|_module.__default.DomSt#canCall| (Lit BoxType |st#0@@1|))) (=> (|Set#IsMember| (_module.__default.DomSt (Lit BoxType |st#0@@1|)) ($Box DatatypeTypeType (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@0|) (Lit DatatypeTypeType |deps#0@@0|) |e#2|))) (and (and (|_module.__default.Loc#canCall| (Lit DatatypeTypeType |cmd#0@@0|) (Lit DatatypeTypeType |deps#0@@0|) |e#2|) (|_module.__default.GetSt#canCall| (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@0|) (Lit DatatypeTypeType |deps#0@@0|) |e#2|) (Lit BoxType |st#0@@1|))) (|_module.__default.Res#canCall| (Lit DatatypeTypeType |cmd#0@@0|) (Lit DatatypeTypeType |deps#0@@0|) |e#2| (Lit BoxType |st#0@@1|)))))))
 :qid |CloudMakeConsistentBuildslegacydfy.202:10|
 :skolemid |923|
 :pattern ( (_module.__default.Res |cmd#0@@0| |deps#0@@0| |e#2| |st#0@@1|))
 :pattern ( (_module.__default.Loc |cmd#0@@0| |deps#0@@0| |e#2|))
 :pattern ( (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0@@0|)) ($Box SeqType |e#2|)))
)) (= (_module.__default.Pre (Lit DatatypeTypeType |cmd#0@@0|) (Lit DatatypeTypeType |deps#0@@0|) (Lit DatatypeTypeType |exts#0@@0|) (Lit BoxType |st#0@@1|)) (forall ((|e#2@@0| T@U) ) (!  (=> ($Is SeqType |e#2@@0| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType (_module.Literal.strs (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@0|))))) ($Box SeqType |e#2@@0|)) (=> (|Set#IsMember| (_module.__default.DomSt (Lit BoxType |st#0@@1|)) ($Box DatatypeTypeType (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@0|) (Lit DatatypeTypeType |deps#0@@0|) |e#2@@0|))) (= (_module.__default.GetSt (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@0|) (Lit DatatypeTypeType |deps#0@@0|) |e#2@@0|) (Lit BoxType |st#0@@1|)) (_module.__default.Res (Lit DatatypeTypeType |cmd#0@@0|) (Lit DatatypeTypeType |deps#0@@0|) |e#2@@0| (Lit BoxType |st#0@@1|))))))
 :qid |CloudMakeConsistentBuildslegacydfy.202:10|
 :skolemid |922|
 :pattern ( (_module.__default.Res |cmd#0@@0| |deps#0@@0| |e#2@@0| |st#0@@1|))
 :pattern ( (_module.__default.Loc |cmd#0@@0| |deps#0@@0| |e#2@@0|))
 :pattern ( (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0@@0|)) ($Box SeqType |e#2@@0|)))
)))))
 :qid |CloudMakeConsistentBuildslegacydfy.196:21|
 :weight 3
 :skolemid |924|
 :pattern ( (_module.__default.Pre (Lit DatatypeTypeType |cmd#0@@0|) (Lit DatatypeTypeType |deps#0@@0|) (Lit DatatypeTypeType |exts#0@@0|) (Lit BoxType |st#0@@1|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|cmd#0@@2| T@U) (|deps#0@@2| T@U) (|exts#0@@1| T@U) (|st#0@@2| T@U) ) (!  (=> (or (|_module.__default.Pre#canCall| (Lit DatatypeTypeType |cmd#0@@2|) (Lit DatatypeTypeType |deps#0@@2|) (Lit DatatypeTypeType |exts#0@@1|) |st#0@@2|) (and (< 3 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |cmd#0@@2| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@2| Tclass._module.Expression)) ($Is DatatypeTypeType |exts#0@@1| Tclass._module.Expression)) ($IsBox |st#0@@2| Tclass._module.State)) (U_2_bool (Lit boolType (bool_2_U  (and (and (and (and (and (_module.Expression.exprLiteral_q (Lit DatatypeTypeType |cmd#0@@2|)) (_module.Literal.litString_q (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |cmd#0@@2|))))) (_module.Expression.exprLiteral_q (Lit DatatypeTypeType |deps#0@@2|))) (_module.Literal.litArrOfPaths_q (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |deps#0@@2|))))) (_module.Expression.exprLiteral_q (Lit DatatypeTypeType |exts#0@@1|))) (_module.Literal.litArrOfStrings_q (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@1|))))))))))) (and (forall ((|e#1| T@U) ) (!  (=> ($Is SeqType |e#1| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType (_module.Literal.strs (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@1|))))) ($Box SeqType |e#1|)) (and (and (|_module.__default.Loc#canCall| (Lit DatatypeTypeType |cmd#0@@2|) (Lit DatatypeTypeType |deps#0@@2|) |e#1|) (|_module.__default.DomSt#canCall| |st#0@@2|)) (=> (|Set#IsMember| (_module.__default.DomSt |st#0@@2|) ($Box DatatypeTypeType (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@2|) (Lit DatatypeTypeType |deps#0@@2|) |e#1|))) (and (and (|_module.__default.Loc#canCall| (Lit DatatypeTypeType |cmd#0@@2|) (Lit DatatypeTypeType |deps#0@@2|) |e#1|) (|_module.__default.GetSt#canCall| (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@2|) (Lit DatatypeTypeType |deps#0@@2|) |e#1|) |st#0@@2|)) (|_module.__default.Res#canCall| (Lit DatatypeTypeType |cmd#0@@2|) (Lit DatatypeTypeType |deps#0@@2|) |e#1| |st#0@@2|))))))
 :qid |CloudMakeConsistentBuildslegacydfy.202:10|
 :skolemid |920|
 :pattern ( (_module.__default.Res |cmd#0@@2| |deps#0@@2| |e#1| |st#0@@2|))
 :pattern ( (_module.__default.Loc |cmd#0@@2| |deps#0@@2| |e#1|))
 :pattern ( (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0@@1|)) ($Box SeqType |e#1|)))
)) (= (_module.__default.Pre (Lit DatatypeTypeType |cmd#0@@2|) (Lit DatatypeTypeType |deps#0@@2|) (Lit DatatypeTypeType |exts#0@@1|) |st#0@@2|) (forall ((|e#1@@0| T@U) ) (!  (=> ($Is SeqType |e#1@@0| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType (_module.Literal.strs (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@1|))))) ($Box SeqType |e#1@@0|)) (=> (|Set#IsMember| (_module.__default.DomSt |st#0@@2|) ($Box DatatypeTypeType (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@2|) (Lit DatatypeTypeType |deps#0@@2|) |e#1@@0|))) (= (_module.__default.GetSt (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@2|) (Lit DatatypeTypeType |deps#0@@2|) |e#1@@0|) |st#0@@2|) (_module.__default.Res (Lit DatatypeTypeType |cmd#0@@2|) (Lit DatatypeTypeType |deps#0@@2|) |e#1@@0| |st#0@@2|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.202:10|
 :skolemid |919|
 :pattern ( (_module.__default.Res |cmd#0@@2| |deps#0@@2| |e#1@@0| |st#0@@2|))
 :pattern ( (_module.__default.Loc |cmd#0@@2| |deps#0@@2| |e#1@@0|))
 :pattern ( (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0@@1|)) ($Box SeqType |e#1@@0|)))
)))))
 :qid |CloudMakeConsistentBuildslegacydfy.196:21|
 :weight 3
 :skolemid |921|
 :pattern ( (_module.__default.Pre (Lit DatatypeTypeType |cmd#0@@2|) (Lit DatatypeTypeType |deps#0@@2|) (Lit DatatypeTypeType |exts#0@@1|) |st#0@@2|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0@@3| T@U) ) (!  (=> (or (|_module.__default.DomSt#canCall| |st#0@@3|) (and (< 1 $FunctionContextHeight) ($IsBox |st#0@@3| Tclass._module.State))) ($Is SetType (_module.__default.DomSt |st#0@@3|) (TSet Tclass._module.Path)))
 :qid |CloudMakeConsistentBuildslegacydfy.10:22|
 :skolemid |708|
 :pattern ( (_module.__default.DomSt |st#0@@3|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|cmd#0@@3| T@U) (|deps#0@@3| T@U) (|ext#0@@0| T@U) (|st#0@@4| T@U) ) (!  (=> (or (|_module.__default.Res#canCall| |cmd#0@@3| |deps#0@@3| |ext#0@@0| |st#0@@4|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |cmd#0@@3| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@3| Tclass._module.Expression)) ($Is SeqType |ext#0@@0| (TSeq TChar))) ($IsBox |st#0@@4| Tclass._module.State)))) ($IsBox (_module.__default.Res |cmd#0@@3| |deps#0@@3| |ext#0@@0| |st#0@@4|) Tclass._module.Artifact))
 :qid |CloudMakeConsistentBuildslegacydfy.216:20|
 :skolemid |952|
 :pattern ( (_module.__default.Res |cmd#0@@3| |deps#0@@3| |ext#0@@0| |st#0@@4|))
))))
...
(declare-fun |cmd#0@@4| () T@U)
(declare-fun |deps#0@@4| () T@U)
(declare-fun |e#3@0| () T@U)
(declare-fun $Heap () T@U)
(declare-fun |##p#0@0| () T@U)
(declare-fun |exts#0@@2| () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Pre)
...
(let ((anon12_Else_correct  (=> (and (not (|Set#IsMember| (_module.__default.DomSt |st#0@@5|) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0@@4| |deps#0@@4| |e#3@0|)))) (= (ControlFlow 0 6) 2)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Set#IsMember| (_module.__default.DomSt |st#0@@5|) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0@@4| |deps#0@@4| |e#3@0|))) (=> (and ($IsAlloc DatatypeTypeType |cmd#0@@4| Tclass._module.Expression $Heap) ($IsAlloc DatatypeTypeType |deps#0@@4| Tclass._module.Expression $Heap)) (=> (and (and ($IsAlloc SeqType |e#3@0| (TSeq TChar) $Heap) (|_module.__default.Loc#canCall| |cmd#0@@4| |deps#0@@4| |e#3@0|)) (and (= |##p#0@0| (_module.__default.Loc |cmd#0@@4| |deps#0@@4| |e#3@0|)) ($IsAlloc DatatypeTypeType |##p#0@0| Tclass._module.Path $Heap))) (=> (and (and (and ($IsAllocBox |st#0@@5| Tclass._module.State $Heap) (|_module.__default.GetSt#canCall| (_module.__default.Loc |cmd#0@@4| |deps#0@@4| |e#3@0|) |st#0@@5|)) (and ($IsAlloc DatatypeTypeType |cmd#0@@4| Tclass._module.Expression $Heap) ($IsAlloc DatatypeTypeType |deps#0@@4| Tclass._module.Expression $Heap))) (and (and ($IsAlloc SeqType |e#3@0| (TSeq TChar) $Heap) ($IsAllocBox |st#0@@5| Tclass._module.State $Heap)) (and (|_module.__default.Res#canCall| |cmd#0@@4| |deps#0@@4| |e#3@0| |st#0@@5|) (= (ControlFlow 0 5) 2)))) anon7_correct))))))
(let ((anon11_Then_correct  (=> (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0@@2|)) ($Box SeqType |e#3@0|)) (=> (and ($IsAlloc DatatypeTypeType |cmd#0@@4| Tclass._module.Expression $Heap) ($IsAlloc DatatypeTypeType |deps#0@@4| Tclass._module.Expression $Heap)) (=> (and (and ($IsAlloc SeqType |e#3@0| (TSeq TChar) $Heap) (|_module.__default.Loc#canCall| |cmd#0@@4| |deps#0@@4| |e#3@0|)) (and ($IsAllocBox |st#0@@5| Tclass._module.State $Heap) (|_module.__default.DomSt#canCall| |st#0@@5|))) (and (=> (= (ControlFlow 0 7) 5) anon12_Then_correct) (=> (= (ControlFlow 0 7) 6) anon12_Else_correct)))))))
(let ((anon11_Else_correct  (=> (and (not (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0@@2|)) ($Box SeqType |e#3@0|))) (= (ControlFlow 0 4) 2)) anon7_correct)))
(let ((anon10_Then_correct  (=> (and ($Is SeqType |e#3@0| (TSeq TChar)) ($IsAlloc SeqType |e#3@0| (TSeq TChar) $Heap)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (_module.Expression.exprLiteral_q |exts#0@@2|)) (=> (_module.Expression.exprLiteral_q |exts#0@@2|) (and (=> (= (ControlFlow 0 8) (- 0 9)) (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#0@@2|))) (=> (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#0@@2|)) (and (=> (= (ControlFlow 0 8) 7) anon11_Then_correct) (=> (= (ControlFlow 0 8) 4) anon11_Else_correct)))))))))
(let ((anon10_Else_correct  (=> (and (not (and ($Is SeqType |e#3@0| (TSeq TChar)) ($IsAlloc SeqType |e#3@0| (TSeq TChar) $Heap))) (= (ControlFlow 0 3) 2)) anon7_correct)))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (_module.Expression.exprLiteral_q |cmd#0@@4|)) (and (=> (= (ControlFlow 0 11) (- 0 14)) (_module.Expression.exprLiteral_q |cmd#0@@4|)) (=> (_module.Expression.exprLiteral_q |cmd#0@@4|) (=> (and (_module.Literal.litString_q (_module.Expression.lit |cmd#0@@4|)) (_module.Expression.exprLiteral_q |deps#0@@4|)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (_module.Expression.exprLiteral_q |deps#0@@4|)) (=> (_module.Expression.exprLiteral_q |deps#0@@4|) (=> (and (_module.Literal.litArrOfPaths_q (_module.Expression.lit |deps#0@@4|)) (_module.Expression.exprLiteral_q |exts#0@@2|)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (_module.Expression.exprLiteral_q |exts#0@@2|)) (=> (_module.Expression.exprLiteral_q |exts#0@@2|) (=> (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#0@@2|)) (and (and (=> (= (ControlFlow 0 11) 1) anon9_Then_correct) (=> (= (ControlFlow 0 11) 8) anon10_Then_correct)) (=> (= (ControlFlow 0 11) 3) anon10_Else_correct))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is DatatypeTypeType |cmd#0@@4| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@4| Tclass._module.Expression))) (and (and ($Is DatatypeTypeType |exts#0@@2| Tclass._module.Expression) ($IsBox |st#0@@5| Tclass._module.State)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 15) 11)))) anon0_correct)))
