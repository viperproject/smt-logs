...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0| T@U) ) (!  (=> (or (|M1.__default.DomSt#canCall| |st#0|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |st#0| Tclass.M1.State))) (and (forall ((|p#0| T@U) ) (!  (=> ($IsBox |p#0| Tclass.M1.Path) (=> (|Set#IsMember| (M1.__default.DomSt |st#0|) |p#0|) (|Set#IsMember| (|Map#Domain| (M1.State.m |st#0|)) |p#0|)))
 :qid |CloudMakeParallelBuildsdfy.441:20|
 :skolemid |2091|
 :pattern ( (|Set#IsMember| (|Map#Domain| (M1.State.m |st#0|)) |p#0|))
 :pattern ( (|Set#IsMember| (M1.__default.DomSt |st#0|) |p#0|))
)) ($Is SetType (M1.__default.DomSt |st#0|) (TSet Tclass.M1.Path))))
 :qid |CloudMakeParallelBuildsdfy.9:24|
 :skolemid |2092|
 :pattern ( (M1.__default.DomSt |st#0|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0@@0| T@U) ) (!  (=> (or (|M1.__default.DomSt#canCall| |st#0@@0|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |st#0@@0| Tclass.M1.State))) (and (M1.State.StateCons_q |st#0@@0|) (= (M1.__default.DomSt |st#0@@0|) (|Set#FromBoogieMap| (|lambda#1| Tclass.M1.Path (|Map#Domain| (M1.State.m |st#0@@0|)))))))
 :qid |CloudMakeParallelBuildsdfy.9:24|
 :skolemid |2094|
...
(assert (forall ((a T@U) (b T@U) ) (! (= (|M1.State#Equal| a b) (= a b))
 :qid |unknown.0:0|
 :skolemid |2532|
 :pattern ( (|M1.State#Equal| a b))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0@@1| T@U) ) (!  (=> (or (|M1.__default.DomSt#canCall| (Lit DatatypeTypeType |st#0@@1|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |st#0@@1| Tclass.M1.State))) (and (M1.State.StateCons_q (Lit DatatypeTypeType |st#0@@1|)) (= (M1.__default.DomSt (Lit DatatypeTypeType |st#0@@1|)) (|Set#FromBoogieMap| (|lambda#1| Tclass.M1.Path (|Map#Domain| (M1.State.m (Lit DatatypeTypeType |st#0@@1|))))))))
 :qid |CloudMakeParallelBuildsdfy.9:24|
 :weight 3
 :skolemid |2095|
 :pattern ( (M1.__default.DomSt (Lit DatatypeTypeType |st#0@@1|)))
))))
...
(assert (forall ((a@@0 T@U) (b@@0 T@U) ) (! (= (|M1.State#Equal| a@@0 b@@0) (|Map#Equal| (M1.State.m a@@0) (M1.State.m b@@0)))
 :qid |unknown.0:0|
 :skolemid |2531|
 :pattern ( (|M1.State#Equal| a@@0 b@@0))
)))
...
(set-info :boogie-vc-id CheckWellformed$$M1.__default.DomSt)
...
(let ((anon12_Else_correct  (=> (and (=> (|Set#IsMember| (M1.__default.DomSt |st#0@@2|) |p#4@0|) (|Set#IsMember| (|Map#Domain| (M1.State.m |st#0@@2|)) |p#4@0|)) (= (ControlFlow 0 11) 8)) anon5_correct)))
(let ((anon12_Then_correct  (=> ($IsAlloc DatatypeTypeType |st#0@@2| Tclass.M1.State $Heap) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (|M1.State#Equal| |st#0@@2| |st#0@@2|) (< (DtRank |st#0@@2|) (DtRank |st#0@@2|)))) (=> (or (|M1.State#Equal| |st#0@@2| |st#0@@2|) (< (DtRank |st#0@@2|) (DtRank |st#0@@2|))) (=> (or (|M1.State#Equal| |st#0@@2| |st#0@@2|) (|M1.__default.DomSt#canCall| |st#0@@2|)) (=> (and (and (|Set#IsMember| (M1.__default.DomSt |st#0@@2|) |p#4@0|) (M1.State.StateCons_q |st#0@@2|)) (and (|Set#IsMember| (|Map#Domain| (M1.State.m |st#0@@2|)) |p#4@0|) (= (ControlFlow 0 9) 8))) anon5_correct)))))))
(let ((anon11_Then_correct  (=> ($Is SetType (M1.__default.DomSt |st#0@@2|) (TSet Tclass.M1.Path)) (=> (and ($IsBox |p#4@0| Tclass.M1.Path) ($IsAllocBox |p#4@0| Tclass.M1.Path $Heap)) (and (=> (= (ControlFlow 0 12) 9) anon12_Then_correct) (=> (= (ControlFlow 0 12) 11) anon12_Else_correct))))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|p#3| T@U) ) (!  (=> ($IsBox |p#3| Tclass.M1.Path) (=> (|Set#IsMember| (M1.__default.DomSt |st#0@@2|) |p#3|) (|Set#IsMember| (|Map#Domain| (M1.State.m |st#0@@2|)) |p#3|)))
 :qid |CloudMakeParallelBuildsdfy.441:20|
 :skolemid |2096|
 :pattern ( (|Set#IsMember| (|Map#Domain| (M1.State.m |st#0@@2|)) |p#3|))
 :pattern ( (|Set#IsMember| (M1.__default.DomSt |st#0@@2|) |p#3|))
)))))
(let ((anon9_correct  (=> (and (and (= (M1.__default.DomSt |st#0@@2|) (|Set#FromBoogieMap| (|lambda#1| Tclass.M1.Path (|Map#Domain| (M1.State.m |st#0@@2|))))) (M1.State.StateCons_q |st#0@@2|)) (and ($Is SetType (M1.__default.DomSt |st#0@@2|) (TSet Tclass.M1.Path)) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct)))
(let ((anon14_Else_correct  (=> (and (not (|Set#IsMember| (|Map#Domain| (M1.State.m |st#0@@2|)) |p#5@0|)) (= (ControlFlow 0 6) 3)) anon9_correct)))
(let ((anon14_Then_correct  (=> (and (|Set#IsMember| (|Map#Domain| (M1.State.m |st#0@@2|)) |p#5@0|) (= (ControlFlow 0 5) 3)) anon9_correct)))
(let ((anon13_Then_correct  (=> (and (and ($IsBox |p#5@0| Tclass.M1.Path) ($IsAllocBox |p#5@0| Tclass.M1.Path $Heap)) (M1.State.StateCons_q |st#0@@2|)) (and (=> (= (ControlFlow 0 7) 5) anon14_Then_correct) (=> (= (ControlFlow 0 7) 6) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (not (and ($IsBox |p#5@0| Tclass.M1.Path) ($IsAllocBox |p#5@0| Tclass.M1.Path $Heap))) (= (ControlFlow 0 4) 3)) anon9_correct)))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 13) 12) anon11_Then_correct) (=> (= (ControlFlow 0 13) 7) anon13_Then_correct)) (=> (= (ControlFlow 0 13) 4) anon13_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |st#0@@2| Tclass.M1.State)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct)))
