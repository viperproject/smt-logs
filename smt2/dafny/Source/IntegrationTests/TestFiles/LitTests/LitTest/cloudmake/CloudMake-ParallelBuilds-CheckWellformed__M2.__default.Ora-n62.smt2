...
(set-info :boogie-vc-id CheckWellformed$$M2.__default.OracleWF)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon5_Else_correct  (=> ($IsAllocBox |p#0@@24| Tclass.M2.Path $Heap@@6) (=> (and (|M2.__default.LocInv__Cmd#canCall| |p#0@@24|) (= |let#0#0#0| (M2.__default.LocInv__Cmd |p#0@@24|))) (=> (and (and (|M2.__default.LocInv__Cmd#canCall| |p#0@@24|) ($Is SeqType |let#0#0#0| (TSeq TChar))) (and (= |cmd#Z#0@0| |let#0#0#0|) ($IsAllocBox |p#0@@24| Tclass.M2.Path $Heap@@6))) (=> (and (and (and (and (|M2.__default.LocInv__Deps#canCall| |p#0@@24|) (= |let#0#1#0| (M2.__default.LocInv__Deps |p#0@@24|))) (and (|M2.__default.LocInv__Deps#canCall| |p#0@@24|) ($Is SetType |let#0#1#0| (TSet Tclass.M2.Path)))) (and (and (= |deps#Z#0@0| |let#0#1#0|) ($IsAllocBox |p#0@@24| Tclass.M2.Path $Heap@@6)) (and (|M2.__default.LocInv__Exp#canCall| |p#0@@24|) (= |let#0#2#0| (M2.__default.LocInv__Exp |p#0@@24|))))) (and (and (and (|M2.__default.LocInv__Exp#canCall| |p#0@@24|) ($Is SeqType |let#0#2#0| (TSeq TChar))) (and (= |e#Z#0@0| |let#0#2#0|) ($IsAlloc SeqType |cmd#Z#0@0| (TSeq TChar) $Heap@@6))) (and (and ($IsAllocBox |p#0@@24| Tclass.M2.Path $Heap@@6) ($IsAlloc DatatypeTypeType |cert#0@@15| Tclass.M2.WFCertificate $Heap@@6)) (and ($IsAlloc SetType |deps#Z#0@0| (TSet Tclass.M2.Path) $Heap@@6) ($IsAlloc DatatypeTypeType |st#0@@19| Tclass.M2.State $Heap@@6))))) (and (=> (= (ControlFlow 0 3) (- 0 8)) (=> (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert#0@@15|) (or (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert#0@@15|) (= (M2.WFCertificate.p |cert#0@@15|) |p#0@@24|)))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (=> (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert#0@@15|) (or (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert#0@@15|) (forall ((|d#0@@9| T@U) ) (!  (=> ($IsBox |d#0@@9| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.LocInv__Deps |p#0@@24|) |d#0@@9|) (exists ((|c#0@@3| T@U) ) (!  (and ($Is DatatypeTypeType |c#0@@3| Tclass.M2.WFCertificate) (and (|Set#IsMember| (M2.WFCertificate.certs |cert#0@@15|) ($Box DatatypeTypeType |c#0@@3|)) (= (M2.WFCertificate.p |c#0@@3|) |d#0@@9|)))
 :qid |CloudMakeParallelBuildsdfy.497:49|
 :skolemid |3855|
 :pattern ( (M2.WFCertificate.p |c#0@@3|))
 :pattern ( (|Set#IsMember| (M2.WFCertificate.certs |cert#0@@15|) ($Box DatatypeTypeType |c#0@@3|)))
))))
 :qid |CloudMakeParallelBuildsdfy.497:13|
 :skolemid |3856|
 :pattern ( (|Set#IsMember| (M2.__default.LocInv__Deps |p#0@@24|) |d#0@@9|))
))))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (=> (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert#0@@15|) (or (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert#0@@15|) (forall ((|c#1@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |c#1@@2| Tclass.M2.WFCertificate) (=> (|Set#IsMember| (M2.WFCertificate.certs |cert#0@@15|) ($Box DatatypeTypeType |c#1@@2|)) (M2.__default.CheckWellFounded ($LS ($LS $LZ)) (M2.WFCertificate.p |c#1@@2|) |c#1@@2|)))
 :qid |CloudMakeParallelBuildsdfy.498:13|
 :skolemid |3857|
 :pattern ( (M2.WFCertificate.p |c#1@@2|))
 :pattern ( (|Set#IsMember| (M2.WFCertificate.certs |cert#0@@15|) ($Box DatatypeTypeType |c#1@@2|)))
))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (|Set#Equal| |deps#Z#0@0| (M2.__default.LocInv__Deps |p#0@@24|))) (=> (and (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert#0@@15|) (|Set#Equal| |deps#Z#0@0| (M2.__default.LocInv__Deps |p#0@@24|))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (or (<= 0 (LitInt 1)) (< (DtRank |cert#0@@15|) (DtRank |cert#0@@15|))) (= (LitInt 0) (LitInt 1)))) (=> (or (or (<= 0 (LitInt 1)) (< (DtRank |cert#0@@15|) (DtRank |cert#0@@15|))) (= (LitInt 0) (LitInt 1))) (=> (= (ControlFlow 0 3) (- 0 2)) (or (< (DtRank |cert#0@@15|) (DtRank |cert#0@@15|)) (and (= (DtRank |cert#0@@15|) (DtRank |cert#0@@15|)) (< (LitInt 0) (LitInt 1))))))))))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#4| null $Heap@@6 alloc false)) (=> (and (and ($IsAllocBox |p#0@@24| Tclass.M2.Path $Heap@@6) ($IsAlloc DatatypeTypeType |cert#0@@15| Tclass.M2.WFCertificate $Heap@@6)) (and (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert#0@@15|) (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert#0@@15|))) (and (=> (= (ControlFlow 0 9) 1) anon5_Then_correct) (=> (= (ControlFlow 0 9) 3) anon5_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) ($IsBox |p#0@@24| Tclass.M2.Path)) (and (and ($Is DatatypeTypeType |cert#0@@15| Tclass.M2.WFCertificate) ($Is DatatypeTypeType |st#0@@19| Tclass.M2.State)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 10) 9)))) anon0_correct)))
