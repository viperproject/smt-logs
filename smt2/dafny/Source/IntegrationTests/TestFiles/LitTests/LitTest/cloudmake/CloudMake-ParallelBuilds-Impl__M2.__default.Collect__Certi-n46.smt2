...
(set-info :boogie-vc-id Impl$$M2.__default.Collect__CertificateInsensitivity)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 13) (- 0 12)) (|Map#Equal| (M2.__default.CollectDependencies ($LS ($LS $LZ)) |p#0@@24| |cert0#0| |deps#0@@9| |st#0@@19|) (M2.__default.CollectDependencies ($LS ($LS $LZ)) |p#0@@24| |cert1#0| |deps#0@@9| |st#0@@19|)))))
(let ((anon3_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (= $Heap@0 $Heap@2)) (and (forall ((|d#0_1| T@U) ) (!  (=> (and ($IsBox |d#0_1| Tclass.M2.Path) (|Set#IsMember| |deps#0@@9| |d#0_1|)) (= (M2.__default.OracleWF ($LS $LZ) |d#0_1| (M2.__default.FindCert |d#0_1| (M2.WFCertificate.certs |cert0#0|)) |st#0@@19|) (M2.__default.OracleWF ($LS $LZ) |d#0_1| (M2.__default.FindCert |d#0_1| (M2.WFCertificate.certs |cert1#0|)) |st#0@@19|)))
 :qid |CloudMakeParallelBuildsdfy.687:12|
 :skolemid |3995|
 :pattern ( (M2.__default.FindCert |d#0_1| (M2.WFCertificate.certs |cert1#0|)))
 :pattern ( (M2.__default.FindCert |d#0_1| (M2.WFCertificate.certs |cert0#0|)))
 :pattern ( (|Set#IsMember| |deps#0@@9| |d#0_1|))
)) (= (ControlFlow 0 14) 13))) GeneratedUnifiedExit_correct)))
(let ((anon3_Then_correct  (=> (and ($IsBox |d#0_0@0| Tclass.M2.Path) (|Set#IsMember| |deps#0@@9| |d#0_0@0|)) (=> (and (and ($IsAllocBox |d#0_0@0| Tclass.M2.Path $Heap@0) (M2.WFCertificate.Cert_q |cert0#0|)) (and (= |##certs#0_0@0| (M2.WFCertificate.certs |cert0#0|)) ($IsAlloc SetType |##certs#0_0@0| (TSet Tclass.M2.WFCertificate) $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (exists ((|c#0_0| T@U) ) (!  (and ($Is DatatypeTypeType |c#0_0| Tclass.M2.WFCertificate) (and (|Set#IsMember| |##certs#0_0@0| ($Box DatatypeTypeType |c#0_0|)) (= (M2.WFCertificate.p |c#0_0|) |d#0_0@0|)))
 :qid |CloudMakeParallelBuildsdfy.667:21|
 :skolemid |3990|
 :pattern ( (M2.WFCertificate.p |c#0_0|))
 :pattern ( (|Set#IsMember| |##certs#0_0@0| ($Box DatatypeTypeType |c#0_0|)))
))) (=> (exists ((|c#0_0@@0| T@U) ) (!  (and ($Is DatatypeTypeType |c#0_0@@0| Tclass.M2.WFCertificate) (and (|Set#IsMember| |##certs#0_0@0| ($Box DatatypeTypeType |c#0_0@@0|)) (= (M2.WFCertificate.p |c#0_0@@0|) |d#0_0@0|)))
 :qid |CloudMakeParallelBuildsdfy.667:21|
 :skolemid |3991|
 :pattern ( (M2.WFCertificate.p |c#0_0@@0|))
 :pattern ( (|Set#IsMember| |##certs#0_0@0| ($Box DatatypeTypeType |c#0_0@@0|)))
)) (=> (and (|M2.__default.FindCert#canCall| |d#0_0@0| (M2.WFCertificate.certs |cert0#0|)) (M2.WFCertificate.Cert_q (M2.__default.FindCert |d#0_0@0| (M2.WFCertificate.certs |cert0#0|)))) (=> (and (and (and (M2.WFCertificate.Cert_q |cert0#0|) (|M2.__default.FindCert#canCall| |d#0_0@0| (M2.WFCertificate.certs |cert0#0|))) (= |cert0##0_0@0| (M2.__default.FindCert |d#0_0@0| (M2.WFCertificate.certs |cert0#0|)))) (and (and ($IsAllocBox |d#0_0@0| Tclass.M2.Path $Heap@0) (M2.WFCertificate.Cert_q |cert1#0|)) (and (= |##certs#0_1@0| (M2.WFCertificate.certs |cert1#0|)) ($IsAlloc SetType |##certs#0_1@0| (TSet Tclass.M2.WFCertificate) $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (exists ((|c#0_1| T@U) ) (!  (and ($Is DatatypeTypeType |c#0_1| Tclass.M2.WFCertificate) (and (|Set#IsMember| |##certs#0_1@0| ($Box DatatypeTypeType |c#0_1|)) (= (M2.WFCertificate.p |c#0_1|) |d#0_0@0|)))
 :qid |CloudMakeParallelBuildsdfy.667:21|
 :skolemid |3992|
 :pattern ( (M2.WFCertificate.p |c#0_1|))
 :pattern ( (|Set#IsMember| |##certs#0_1@0| ($Box DatatypeTypeType |c#0_1|)))
))) (=> (exists ((|c#0_1@@0| T@U) ) (!  (and ($Is DatatypeTypeType |c#0_1@@0| Tclass.M2.WFCertificate) (and (|Set#IsMember| |##certs#0_1@0| ($Box DatatypeTypeType |c#0_1@@0|)) (= (M2.WFCertificate.p |c#0_1@@0|) |d#0_0@0|)))
 :qid |CloudMakeParallelBuildsdfy.667:21|
 :skolemid |3993|
 :pattern ( (M2.WFCertificate.p |c#0_1@@0|))
 :pattern ( (|Set#IsMember| |##certs#0_1@0| ($Box DatatypeTypeType |c#0_1@@0|)))
)) (=> (and (|M2.__default.FindCert#canCall| |d#0_0@0| (M2.WFCertificate.certs |cert1#0|)) (M2.WFCertificate.Cert_q (M2.__default.FindCert |d#0_0@0| (M2.WFCertificate.certs |cert1#0|)))) (=> (and (and (M2.WFCertificate.Cert_q |cert1#0|) (|M2.__default.FindCert#canCall| |d#0_0@0| (M2.WFCertificate.certs |cert1#0|))) (= |cert1##0_0@0| (M2.__default.FindCert |d#0_0@0| (M2.WFCertificate.certs |cert1#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (or (or (<= 0 (LitInt 0)) (< (DtRank |cert0##0_0@0|) (DtRank |cert0#0|))) (= (LitInt 1) (LitInt 0)))) (=> (or (or (<= 0 (LitInt 0)) (< (DtRank |cert0##0_0@0|) (DtRank |cert0#0|))) (= (LitInt 1) (LitInt 0))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (or (< (DtRank |cert0##0_0@0|) (DtRank |cert0#0|)) (and (= (DtRank |cert0##0_0@0|) (DtRank |cert0#0|)) (< (LitInt 1) (LitInt 0))))) (=> (or (< (DtRank |cert0##0_0@0|) (DtRank |cert0#0|)) (and (= (DtRank |cert0##0_0@0|) (DtRank |cert0#0|)) (< (LitInt 1) (LitInt 0)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|M2.__default.CheckWellFounded#canCall| |d#0_0@0| |cert0##0_0@0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |d#0_0@0| |cert0##0_0@0|) (= (M2.WFCertificate.p |cert0##0_0@0|) |d#0_0@0|)))) (=> (=> (|M2.__default.CheckWellFounded#canCall| |d#0_0@0| |cert0##0_0@0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |d#0_0@0| |cert0##0_0@0|) (= (M2.WFCertificate.p |cert0##0_0@0|) |d#0_0@0|))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|M2.__default.CheckWellFounded#canCall| |d#0_0@0| |cert0##0_0@0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |d#0_0@0| |cert0##0_0@0|) (forall ((|d#2@@2| T@U) ) (!  (=> ($IsBox |d#2@@2| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.LocInv__Deps |d#0_0@0|) |d#2@@2|) (exists ((|c#4@@3| T@U) ) (!  (and ($Is DatatypeTypeType |c#4@@3| Tclass.M2.WFCertificate) (and (|Set#IsMember| (M2.WFCertificate.certs |cert0##0_0@0|) ($Box DatatypeTypeType |c#4@@3|)) (= (M2.WFCertificate.p |c#4@@3|) |d#2@@2|)))
 :qid |CloudMakeParallelBuildsdfy.497:49|
 :skolemid |3917|
 :pattern ( (M2.WFCertificate.p |c#4@@3|))
 :pattern ( (|Set#IsMember| (M2.WFCertificate.certs |cert0##0_0@0|) ($Box DatatypeTypeType |c#4@@3|)))
))))
 :qid |CloudMakeParallelBuildsdfy.497:13|
 :skolemid |3918|
 :pattern ( (|Set#IsMember| (M2.__default.LocInv__Deps |d#0_0@0|) |d#2@@2|))
))))) (=> (=> (|M2.__default.CheckWellFounded#canCall| |d#0_0@0| |cert0##0_0@0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |d#0_0@0| |cert0##0_0@0|) (forall ((|d#2@@3| T@U) ) (!  (=> ($IsBox |d#2@@3| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.LocInv__Deps |d#0_0@0|) |d#2@@3|) (exists ((|c#4@@4| T@U) ) (!  (and ($Is DatatypeTypeType |c#4@@4| Tclass.M2.WFCertificate) (and (|Set#IsMember| (M2.WFCertificate.certs |cert0##0_0@0|) ($Box DatatypeTypeType |c#4@@4|)) (= (M2.WFCertificate.p |c#4@@4|) |d#2@@3|)))
 :qid |CloudMakeParallelBuildsdfy.497:49|
 :skolemid |3917|
 :pattern ( (M2.WFCertificate.p |c#4@@4|))
 :pattern ( (|Set#IsMember| (M2.WFCertificate.certs |cert0##0_0@0|) ($Box DatatypeTypeType |c#4@@4|)))
))))
 :qid |CloudMakeParallelBuildsdfy.497:13|
 :skolemid |3918|
 :pattern ( (|Set#IsMember| (M2.__default.LocInv__Deps |d#0_0@0|) |d#2@@3|))
)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|M2.__default.CheckWellFounded#canCall| |d#0_0@0| |cert0##0_0@0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |d#0_0@0| |cert0##0_0@0|) (forall ((|c#5@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |c#5@@2| Tclass.M2.WFCertificate) (=> (|Set#IsMember| (M2.WFCertificate.certs |cert0##0_0@0|) ($Box DatatypeTypeType |c#5@@2|)) (M2.__default.CheckWellFounded ($LS ($LS $LZ)) (M2.WFCertificate.p |c#5@@2|) |c#5@@2|)))
 :qid |CloudMakeParallelBuildsdfy.498:13|
 :skolemid |3919|
 :pattern ( (M2.WFCertificate.p |c#5@@2|))
 :pattern ( (|Set#IsMember| (M2.WFCertificate.certs |cert0##0_0@0|) ($Box DatatypeTypeType |c#5@@2|)))
))))) (=> (=> (|M2.__default.CheckWellFounded#canCall| |d#0_0@0| |cert0##0_0@0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |d#0_0@0| |cert0##0_0@0|) (forall ((|c#5@@3| T@U) ) (!  (=> ($Is DatatypeTypeType |c#5@@3| Tclass.M2.WFCertificate) (=> (|Set#IsMember| (M2.WFCertificate.certs |cert0##0_0@0|) ($Box DatatypeTypeType |c#5@@3|)) (M2.__default.CheckWellFounded ($LS ($LS $LZ)) (M2.WFCertificate.p |c#5@@3|) |c#5@@3|)))
 :qid |CloudMakeParallelBuildsdfy.498:13|
 :skolemid |3919|
 :pattern ( (M2.WFCertificate.p |c#5@@3|))
 :pattern ( (|Set#IsMember| (M2.WFCertificate.certs |cert0##0_0@0|) ($Box DatatypeTypeType |c#5@@3|)))
)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|M2.__default.CheckWellFounded#canCall| |d#0_0@0| |cert1##0_0@0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |d#0_0@0| |cert1##0_0@0|) (= (M2.WFCertificate.p |cert1##0_0@0|) |d#0_0@0|)))) (=> (=> (|M2.__default.CheckWellFounded#canCall| |d#0_0@0| |cert1##0_0@0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |d#0_0@0| |cert1##0_0@0|) (= (M2.WFCertificate.p |cert1##0_0@0|) |d#0_0@0|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|M2.__default.CheckWellFounded#canCall| |d#0_0@0| |cert1##0_0@0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |d#0_0@0| |cert1##0_0@0|) (forall ((|d#3| T@U) ) (!  (=> ($IsBox |d#3| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.LocInv__Deps |d#0_0@0|) |d#3|) (exists ((|c#6@@0| T@U) ) (!  (and ($Is DatatypeTypeType |c#6@@0| Tclass.M2.WFCertificate) (and (|Set#IsMember| (M2.WFCertificate.certs |cert1##0_0@0|) ($Box DatatypeTypeType |c#6@@0|)) (= (M2.WFCertificate.p |c#6@@0|) |d#3|)))
 :qid |CloudMakeParallelBuildsdfy.497:49|
 :skolemid |3924|
 :pattern ( (M2.WFCertificate.p |c#6@@0|))
 :pattern ( (|Set#IsMember| (M2.WFCertificate.certs |cert1##0_0@0|) ($Box DatatypeTypeType |c#6@@0|)))
))))
 :qid |CloudMakeParallelBuildsdfy.497:13|
 :skolemid |3925|
 :pattern ( (|Set#IsMember| (M2.__default.LocInv__Deps |d#0_0@0|) |d#3|))
))))) (=> (=> (|M2.__default.CheckWellFounded#canCall| |d#0_0@0| |cert1##0_0@0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |d#0_0@0| |cert1##0_0@0|) (forall ((|d#3@@0| T@U) ) (!  (=> ($IsBox |d#3@@0| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.LocInv__Deps |d#0_0@0|) |d#3@@0|) (exists ((|c#6@@1| T@U) ) (!  (and ($Is DatatypeTypeType |c#6@@1| Tclass.M2.WFCertificate) (and (|Set#IsMember| (M2.WFCertificate.certs |cert1##0_0@0|) ($Box DatatypeTypeType |c#6@@1|)) (= (M2.WFCertificate.p |c#6@@1|) |d#3@@0|)))
 :qid |CloudMakeParallelBuildsdfy.497:49|
 :skolemid |3924|
 :pattern ( (M2.WFCertificate.p |c#6@@1|))
 :pattern ( (|Set#IsMember| (M2.WFCertificate.certs |cert1##0_0@0|) ($Box DatatypeTypeType |c#6@@1|)))
))))
 :qid |CloudMakeParallelBuildsdfy.497:13|
 :skolemid |3925|
 :pattern ( (|Set#IsMember| (M2.__default.LocInv__Deps |d#0_0@0|) |d#3@@0|))
)))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|M2.__default.CheckWellFounded#canCall| |d#0_0@0| |cert1##0_0@0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |d#0_0@0| |cert1##0_0@0|) (forall ((|c#7| T@U) ) (!  (=> ($Is DatatypeTypeType |c#7| Tclass.M2.WFCertificate) (=> (|Set#IsMember| (M2.WFCertificate.certs |cert1##0_0@0|) ($Box DatatypeTypeType |c#7|)) (M2.__default.CheckWellFounded ($LS ($LS $LZ)) (M2.WFCertificate.p |c#7|) |c#7|)))
 :qid |CloudMakeParallelBuildsdfy.498:13|
 :skolemid |3926|
 :pattern ( (M2.WFCertificate.p |c#7|))
 :pattern ( (|Set#IsMember| (M2.WFCertificate.certs |cert1##0_0@0|) ($Box DatatypeTypeType |c#7|)))
)))))))))))))))))))))))))))))))
(let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#4| null $Heap@@6 alloc false)) (|$IsA#M2.WFCertificate| |cert0#0|)) (and (|$IsA#M2.WFCertificate| |cert1#0|) (|$IsA#M2.State| |st#0@@19|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@6 $Heap@0) (forall ((|$ih#cert00#0| T@U) (|$ih#cert10#0| T@U) (|$ih#deps0#0| T@U) (|$ih#st0#0| T@U) ) (!  (=> (and (and (and (and (and ($Is DatatypeTypeType |$ih#cert00#0| Tclass.M2.WFCertificate) ($Is DatatypeTypeType |$ih#cert10#0| Tclass.M2.WFCertificate)) ($Is SetType |$ih#deps0#0| (TSet Tclass.M2.Path))) ($Is DatatypeTypeType |$ih#st0#0| Tclass.M2.State)) (and (and (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |$ih#cert00#0|) (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |$ih#cert10#0|)) (|Set#Equal| |$ih#deps0#0| (M2.__default.LocInv__Deps |p#0@@24|)))) (or (< (DtRank |$ih#cert00#0|) (DtRank |cert0#0|)) (and (= (DtRank |$ih#cert00#0|) (DtRank |cert0#0|)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (LitInt 0)))))) (|Map#Equal| (M2.__default.CollectDependencies ($LS $LZ) |p#0@@24| |$ih#cert00#0| |$ih#deps0#0| |$ih#st0#0|) (M2.__default.CollectDependencies ($LS $LZ) |p#0@@24| |$ih#cert10#0| |$ih#deps0#0| |$ih#st0#0|)))
 :qid |CloudMakeParallelBuildsdfy.682:51|
 :skolemid |3989|
 :pattern ( (M2.__default.CollectDependencies ($LS $LZ) |p#0@@24| |$ih#cert10#0| |$ih#deps0#0| |$ih#st0#0|) (M2.__default.CollectDependencies ($LS $LZ) |p#0@@24| |$ih#cert00#0| |$ih#deps0#0| |$ih#st0#0|))
 :pattern ( (M2.__default.CollectDependencies ($LS $LZ) |p#0@@24| |$ih#cert10#0| |$ih#deps0#0| |$ih#st0#0|) (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |$ih#cert00#0|))
 :pattern ( (M2.__default.CollectDependencies ($LS $LZ) |p#0@@24| |$ih#cert00#0| |$ih#deps0#0| |$ih#st0#0|) (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |$ih#cert10#0|))
))))) (and (=> (= (ControlFlow 0 15) 2) anon3_Then_correct) (=> (= (ControlFlow 0 15) 14) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (and ($IsBox |p#0@@24| Tclass.M2.Path) ($IsAllocBox |p#0@@24| Tclass.M2.Path $Heap@@6))) (and (and ($Is DatatypeTypeType |cert0#0| Tclass.M2.WFCertificate) ($IsAlloc DatatypeTypeType |cert0#0| Tclass.M2.WFCertificate $Heap@@6)) (|$IsA#M2.WFCertificate| |cert0#0|))) (and (and (and ($Is DatatypeTypeType |cert1#0| Tclass.M2.WFCertificate) ($IsAlloc DatatypeTypeType |cert1#0| Tclass.M2.WFCertificate $Heap@@6)) (|$IsA#M2.WFCertificate| |cert1#0|)) (and ($Is SetType |deps#0@@9| (TSet Tclass.M2.Path)) ($IsAlloc SetType |deps#0@@9| (TSet Tclass.M2.Path) $Heap@@6)))) (=> (and (and (and (and (and ($Is DatatypeTypeType |st#0@@19| Tclass.M2.State) ($IsAlloc DatatypeTypeType |st#0@@19| Tclass.M2.State $Heap@@6)) (|$IsA#M2.State| |st#0@@19|)) (= 4 $FunctionContextHeight)) (and (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert0#0|) (and (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert0#0|) (and (and (= (M2.WFCertificate.p |cert0#0|) |p#0@@24|) (forall ((|d#4| T@U) ) (!  (=> ($IsBox |d#4| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.LocInv__Deps |p#0@@24|) |d#4|) (exists ((|c#8| T@U) ) (!  (and ($Is DatatypeTypeType |c#8| Tclass.M2.WFCertificate) (and (|Set#IsMember| (M2.WFCertificate.certs |cert0#0|) ($Box DatatypeTypeType |c#8|)) (= (M2.WFCertificate.p |c#8|) |d#4|)))
 :qid |CloudMakeParallelBuildsdfy.497:49|
 :skolemid |3979|
 :pattern ( (M2.WFCertificate.p |c#8|))
 :pattern ( (|Set#IsMember| (M2.WFCertificate.certs |cert0#0|) ($Box DatatypeTypeType |c#8|)))
))))
 :qid |CloudMakeParallelBuildsdfy.497:13|
 :skolemid |3980|
 :pattern ( (|Set#IsMember| (M2.__default.LocInv__Deps |p#0@@24|) |d#4|))
))) (forall ((|c#9| T@U) ) (!  (=> ($Is DatatypeTypeType |c#9| Tclass.M2.WFCertificate) (=> (|Set#IsMember| (M2.WFCertificate.certs |cert0#0|) ($Box DatatypeTypeType |c#9|)) (M2.__default.CheckWellFounded ($LS $LZ) (M2.WFCertificate.p |c#9|) |c#9|)))
 :qid |CloudMakeParallelBuildsdfy.498:13|
 :skolemid |3981|
 :pattern ( (M2.WFCertificate.p |c#9|))
 :pattern ( (|Set#IsMember| (M2.WFCertificate.certs |cert0#0|) ($Box DatatypeTypeType |c#9|)))
)))))) (and (and (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert1#0|) (and (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert1#0|) (and (and (= (M2.WFCertificate.p |cert1#0|) |p#0@@24|) (forall ((|d#5| T@U) ) (!  (=> ($IsBox |d#5| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.LocInv__Deps |p#0@@24|) |d#5|) (exists ((|c#10| T@U) ) (!  (and ($Is DatatypeTypeType |c#10| Tclass.M2.WFCertificate) (and (|Set#IsMember| (M2.WFCertificate.certs |cert1#0|) ($Box DatatypeTypeType |c#10|)) (= (M2.WFCertificate.p |c#10|) |d#5|)))
 :qid |CloudMakeParallelBuildsdfy.497:49|
 :skolemid |3986|
 :pattern ( (M2.WFCertificate.p |c#10|))
 :pattern ( (|Set#IsMember| (M2.WFCertificate.certs |cert1#0|) ($Box DatatypeTypeType |c#10|)))
))))
 :qid |CloudMakeParallelBuildsdfy.497:13|
 :skolemid |3987|
 :pattern ( (|Set#IsMember| (M2.__default.LocInv__Deps |p#0@@24|) |d#5|))
))) (forall ((|c#11| T@U) ) (!  (=> ($Is DatatypeTypeType |c#11| Tclass.M2.WFCertificate) (=> (|Set#IsMember| (M2.WFCertificate.certs |cert1#0|) ($Box DatatypeTypeType |c#11|)) (M2.__default.CheckWellFounded ($LS $LZ) (M2.WFCertificate.p |c#11|) |c#11|)))
 :qid |CloudMakeParallelBuildsdfy.498:13|
 :skolemid |3988|
 :pattern ( (M2.WFCertificate.p |c#11|))
 :pattern ( (|Set#IsMember| (M2.WFCertificate.certs |cert1#0|) ($Box DatatypeTypeType |c#11|)))
))))) (and (|Set#Equal| |deps#0@@9| (M2.__default.LocInv__Deps |p#0@@24|)) (= (ControlFlow 0 16) 15)))) anon0_correct))))
