...
(set-info :boogie-vc-id Impl$$M2.__default.OracleWF__CertificateInsensitivity)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#4| null $Heap@@6 alloc false)) (|$IsA#M2.WFCertificate| |cert0#0|)) (and (|$IsA#M2.WFCertificate| |cert1#0|) (|$IsA#M2.State| |st#0@@19|))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@6 $Heap@0) (forall ((|$ih#cert00#0| T@U) (|$ih#cert10#0| T@U) (|$ih#st0#0| T@U) ) (!  (=> (and (and (and (and ($Is DatatypeTypeType |$ih#cert00#0| Tclass.M2.WFCertificate) ($Is DatatypeTypeType |$ih#cert10#0| Tclass.M2.WFCertificate)) ($Is DatatypeTypeType |$ih#st0#0| Tclass.M2.State)) (and (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |$ih#cert00#0|) (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |$ih#cert10#0|))) (or (< (DtRank |$ih#cert00#0|) (DtRank |cert0#0|)) (and (= (DtRank |$ih#cert00#0|) (DtRank |cert0#0|)) (and (<= 0 (LitInt 1)) (< (LitInt 1) (LitInt 1)))))) (= (M2.__default.OracleWF ($LS $LZ) |p#0@@24| |$ih#cert00#0| |$ih#st0#0|) (M2.__default.OracleWF ($LS $LZ) |p#0@@24| |$ih#cert10#0| |$ih#st0#0|)))
 :qid |CloudMakeParallelBuildsdfy.675:52|
 :skolemid |3945|
 :pattern ( (M2.__default.OracleWF ($LS $LZ) |p#0@@24| |$ih#cert10#0| |$ih#st0#0|) (M2.__default.OracleWF ($LS $LZ) |p#0@@24| |$ih#cert00#0| |$ih#st0#0|))
 :pattern ( (M2.__default.OracleWF ($LS $LZ) |p#0@@24| |$ih#cert10#0| |$ih#st0#0|) (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |$ih#cert00#0|))
 :pattern ( (M2.__default.OracleWF ($LS $LZ) |p#0@@24| |$ih#cert00#0| |$ih#st0#0|) (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |$ih#cert10#0|))
)))) (and (and ($IsAllocBox |p#0@@24| Tclass.M2.Path $Heap@0) (|M2.__default.LocInv__Deps#canCall| |p#0@@24|)) (and (|M2.__default.LocInv__Deps#canCall| |p#0@@24|) (= |deps##0@0| (M2.__default.LocInv__Deps |p#0@@24|))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (or (or (<= 0 (LitInt 1)) (< (DtRank |cert0#0|) (DtRank |cert0#0|))) (= (LitInt 0) (LitInt 1)))) (=> (or (or (<= 0 (LitInt 1)) (< (DtRank |cert0#0|) (DtRank |cert0#0|))) (= (LitInt 0) (LitInt 1))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (or (< (DtRank |cert0#0|) (DtRank |cert0#0|)) (and (= (DtRank |cert0#0|) (DtRank |cert0#0|)) (< (LitInt 0) (LitInt 1))))) (=> (or (< (DtRank |cert0#0|) (DtRank |cert0#0|)) (and (= (DtRank |cert0#0|) (DtRank |cert0#0|)) (< (LitInt 0) (LitInt 1)))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert0#0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert0#0|) (= (M2.WFCertificate.p |cert0#0|) |p#0@@24|)))) (=> (=> (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert0#0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert0#0|) (= (M2.WFCertificate.p |cert0#0|) |p#0@@24|))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert0#0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert0#0|) (forall ((|d#2@@2| T@U) ) (!  (=> ($IsBox |d#2@@2| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.LocInv__Deps |p#0@@24|) |d#2@@2|) (exists ((|c#4@@3| T@U) ) (!  (and ($Is DatatypeTypeType |c#4@@3| Tclass.M2.WFCertificate) (and (|Set#IsMember| (M2.WFCertificate.certs |cert0#0|) ($Box DatatypeTypeType |c#4@@3|)) (= (M2.WFCertificate.p |c#4@@3|) |d#2@@2|)))
 :qid |CloudMakeParallelBuildsdfy.497:49|
 :skolemid |3961|
 :pattern ( (M2.WFCertificate.p |c#4@@3|))
 :pattern ( (|Set#IsMember| (M2.WFCertificate.certs |cert0#0|) ($Box DatatypeTypeType |c#4@@3|)))
))))
 :qid |CloudMakeParallelBuildsdfy.497:13|
 :skolemid |3962|
 :pattern ( (|Set#IsMember| (M2.__default.LocInv__Deps |p#0@@24|) |d#2@@2|))
))))) (=> (=> (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert0#0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert0#0|) (forall ((|d#2@@3| T@U) ) (!  (=> ($IsBox |d#2@@3| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.LocInv__Deps |p#0@@24|) |d#2@@3|) (exists ((|c#4@@4| T@U) ) (!  (and ($Is DatatypeTypeType |c#4@@4| Tclass.M2.WFCertificate) (and (|Set#IsMember| (M2.WFCertificate.certs |cert0#0|) ($Box DatatypeTypeType |c#4@@4|)) (= (M2.WFCertificate.p |c#4@@4|) |d#2@@3|)))
 :qid |CloudMakeParallelBuildsdfy.497:49|
 :skolemid |3961|
 :pattern ( (M2.WFCertificate.p |c#4@@4|))
 :pattern ( (|Set#IsMember| (M2.WFCertificate.certs |cert0#0|) ($Box DatatypeTypeType |c#4@@4|)))
))))
 :qid |CloudMakeParallelBuildsdfy.497:13|
 :skolemid |3962|
 :pattern ( (|Set#IsMember| (M2.__default.LocInv__Deps |p#0@@24|) |d#2@@3|))
)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert0#0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert0#0|) (forall ((|c#5@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |c#5@@2| Tclass.M2.WFCertificate) (=> (|Set#IsMember| (M2.WFCertificate.certs |cert0#0|) ($Box DatatypeTypeType |c#5@@2|)) (M2.__default.CheckWellFounded ($LS ($LS $LZ)) (M2.WFCertificate.p |c#5@@2|) |c#5@@2|)))
 :qid |CloudMakeParallelBuildsdfy.498:13|
 :skolemid |3963|
 :pattern ( (M2.WFCertificate.p |c#5@@2|))
 :pattern ( (|Set#IsMember| (M2.WFCertificate.certs |cert0#0|) ($Box DatatypeTypeType |c#5@@2|)))
))))) (=> (=> (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert0#0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert0#0|) (forall ((|c#5@@3| T@U) ) (!  (=> ($Is DatatypeTypeType |c#5@@3| Tclass.M2.WFCertificate) (=> (|Set#IsMember| (M2.WFCertificate.certs |cert0#0|) ($Box DatatypeTypeType |c#5@@3|)) (M2.__default.CheckWellFounded ($LS ($LS $LZ)) (M2.WFCertificate.p |c#5@@3|) |c#5@@3|)))
 :qid |CloudMakeParallelBuildsdfy.498:13|
 :skolemid |3963|
 :pattern ( (M2.WFCertificate.p |c#5@@3|))
 :pattern ( (|Set#IsMember| (M2.WFCertificate.certs |cert0#0|) ($Box DatatypeTypeType |c#5@@3|)))
)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert1#0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert1#0|) (= (M2.WFCertificate.p |cert1#0|) |p#0@@24|)))) (=> (=> (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert1#0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert1#0|) (= (M2.WFCertificate.p |cert1#0|) |p#0@@24|))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert1#0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert1#0|) (forall ((|d#3| T@U) ) (!  (=> ($IsBox |d#3| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.LocInv__Deps |p#0@@24|) |d#3|) (exists ((|c#6@@0| T@U) ) (!  (and ($Is DatatypeTypeType |c#6@@0| Tclass.M2.WFCertificate) (and (|Set#IsMember| (M2.WFCertificate.certs |cert1#0|) ($Box DatatypeTypeType |c#6@@0|)) (= (M2.WFCertificate.p |c#6@@0|) |d#3|)))
 :qid |CloudMakeParallelBuildsdfy.497:49|
 :skolemid |3968|
 :pattern ( (M2.WFCertificate.p |c#6@@0|))
 :pattern ( (|Set#IsMember| (M2.WFCertificate.certs |cert1#0|) ($Box DatatypeTypeType |c#6@@0|)))
))))
 :qid |CloudMakeParallelBuildsdfy.497:13|
 :skolemid |3969|
 :pattern ( (|Set#IsMember| (M2.__default.LocInv__Deps |p#0@@24|) |d#3|))
))))) (=> (=> (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert1#0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert1#0|) (forall ((|d#3@@0| T@U) ) (!  (=> ($IsBox |d#3@@0| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.LocInv__Deps |p#0@@24|) |d#3@@0|) (exists ((|c#6@@1| T@U) ) (!  (and ($Is DatatypeTypeType |c#6@@1| Tclass.M2.WFCertificate) (and (|Set#IsMember| (M2.WFCertificate.certs |cert1#0|) ($Box DatatypeTypeType |c#6@@1|)) (= (M2.WFCertificate.p |c#6@@1|) |d#3@@0|)))
 :qid |CloudMakeParallelBuildsdfy.497:49|
 :skolemid |3968|
 :pattern ( (M2.WFCertificate.p |c#6@@1|))
 :pattern ( (|Set#IsMember| (M2.WFCertificate.certs |cert1#0|) ($Box DatatypeTypeType |c#6@@1|)))
))))
 :qid |CloudMakeParallelBuildsdfy.497:13|
 :skolemid |3969|
 :pattern ( (|Set#IsMember| (M2.__default.LocInv__Deps |p#0@@24|) |d#3@@0|))
)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert1#0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert1#0|) (forall ((|c#7| T@U) ) (!  (=> ($Is DatatypeTypeType |c#7| Tclass.M2.WFCertificate) (=> (|Set#IsMember| (M2.WFCertificate.certs |cert1#0|) ($Box DatatypeTypeType |c#7|)) (M2.__default.CheckWellFounded ($LS ($LS $LZ)) (M2.WFCertificate.p |c#7|) |c#7|)))
 :qid |CloudMakeParallelBuildsdfy.498:13|
 :skolemid |3970|
 :pattern ( (M2.WFCertificate.p |c#7|))
 :pattern ( (|Set#IsMember| (M2.WFCertificate.certs |cert1#0|) ($Box DatatypeTypeType |c#7|)))
))))) (=> (=> (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert1#0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert1#0|) (forall ((|c#7@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |c#7@@0| Tclass.M2.WFCertificate) (=> (|Set#IsMember| (M2.WFCertificate.certs |cert1#0|) ($Box DatatypeTypeType |c#7@@0|)) (M2.__default.CheckWellFounded ($LS ($LS $LZ)) (M2.WFCertificate.p |c#7@@0|) |c#7@@0|)))
 :qid |CloudMakeParallelBuildsdfy.498:13|
 :skolemid |3970|
 :pattern ( (M2.WFCertificate.p |c#7@@0|))
 :pattern ( (|Set#IsMember| (M2.WFCertificate.certs |cert1#0|) ($Box DatatypeTypeType |c#7@@0|)))
)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Equal| |deps##0@0| (M2.__default.LocInv__Deps |p#0@@24|))) (=> (|Set#Equal| |deps##0@0| (M2.__default.LocInv__Deps |p#0@@24|)) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and (|M2.__default.CollectDependencies#canCall| |p#0@@24| |cert0#0| |deps##0@0| |st#0@@19|) (|M2.__default.CollectDependencies#canCall| |p#0@@24| |cert1#0| |deps##0@0| |st#0@@19|)) (|Map#Equal| (M2.__default.CollectDependencies ($LS ($LS $LZ)) |p#0@@24| |cert0#0| |deps##0@0| |st#0@@19|) (M2.__default.CollectDependencies ($LS ($LS $LZ)) |p#0@@24| |cert1#0| |deps##0@0| |st#0@@19|))) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 2) (- 0 1)))) (= (M2.__default.OracleWF ($LS ($LS $LZ)) |p#0@@24| |cert0#0| |st#0@@19|) (M2.__default.OracleWF ($LS ($LS $LZ)) |p#0@@24| |cert1#0| |st#0@@19|))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (and ($IsBox |p#0@@24| Tclass.M2.Path) ($IsAllocBox |p#0@@24| Tclass.M2.Path $Heap@@6))) (=> (and (and (and ($Is DatatypeTypeType |cert0#0| Tclass.M2.WFCertificate) ($IsAlloc DatatypeTypeType |cert0#0| Tclass.M2.WFCertificate $Heap@@6)) (|$IsA#M2.WFCertificate| |cert0#0|)) (and (and ($Is DatatypeTypeType |cert1#0| Tclass.M2.WFCertificate) ($IsAlloc DatatypeTypeType |cert1#0| Tclass.M2.WFCertificate $Heap@@6)) (|$IsA#M2.WFCertificate| |cert1#0|))) (=> (and (and (and (and (and ($Is DatatypeTypeType |st#0@@19| Tclass.M2.State) ($IsAlloc DatatypeTypeType |st#0@@19| Tclass.M2.State $Heap@@6)) (|$IsA#M2.State| |st#0@@19|)) (= 4 $FunctionContextHeight)) (and (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert0#0|) (and (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert0#0|) (and (and (= (M2.WFCertificate.p |cert0#0|) |p#0@@24|) (forall ((|d#4| T@U) ) (!  (=> ($IsBox |d#4| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.LocInv__Deps |p#0@@24|) |d#4|) (exists ((|c#8| T@U) ) (!  (and ($Is DatatypeTypeType |c#8| Tclass.M2.WFCertificate) (and (|Set#IsMember| (M2.WFCertificate.certs |cert0#0|) ($Box DatatypeTypeType |c#8|)) (= (M2.WFCertificate.p |c#8|) |d#4|)))
 :qid |CloudMakeParallelBuildsdfy.497:49|
 :skolemid |3935|
