...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.EvalCLemma)
...
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@3 alloc false)) ($IsAlloc DatatypeTypeType |stC#0@@32| Tclass._module.StateC $Heap@@3)) (and (|_module.__default.ConsistentCache#canCall| |stC#0@@32|) (_module.__default.ConsistentCache |stC#0@@32|))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@3 $Heap@0) ($IsAlloc DatatypeTypeType |expr#0@@16| Tclass._module.Expression $Heap@0))) (and (and ($IsAlloc DatatypeTypeType |stC#0@@32| Tclass._module.StateC $Heap@0) ($IsAllocBox |env#0@@15| Tclass._module.Env $Heap@0)) (and (|_module.__default.evalC#canCall| |expr#0@@16| |stC#0@@32| |env#0@@15|) (_module.Tuple.Pair_q (_module.__default.evalC ($LS $LZ) |expr#0@@16| |stC#0@@32| |env#0@@15|))))) (=> (and (and (and (and (= |let#0#0#0| (_module.__default.evalC ($LS $LZ) |expr#0@@16| |stC#0@@32| |env#0@@15|)) (|_module.__default.evalC#canCall| |expr#0@@16| |stC#0@@32| |env#0@@15|)) (and ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.Tuple Tclass._module.Expression Tclass._module.StateC)) (= |result#Z#0@0| |let#0#0#0|))) (and (and (_module.Tuple.Pair_q |result#Z#0@0|) (= |let#1#0#0| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#Z#0@0|)))) (and (_module.Tuple.Pair_q |result#Z#0@0|) ($Is DatatypeTypeType |let#1#0#0| Tclass._module.Expression)))) (and (and (and (= |expr'#Z#0@0| |let#1#0#0|) (_module.Tuple.Pair_q |result#Z#0@0|)) (and (= |let#1#1#0| ($Unbox DatatypeTypeType (_module.Tuple.snd |result#Z#0@0|))) (_module.Tuple.Pair_q |result#Z#0@0|))) (and (and ($Is DatatypeTypeType |let#1#1#0| Tclass._module.StateC) (= |stC'#Z#0@0| |let#1#1#0|)) (and ($IsAlloc DatatypeTypeType |stC'#Z#0@0| Tclass._module.StateC $Heap@0) (|_module.__default.ConsistentCache#canCall| |stC'#Z#0@0|))))) (and (=> (= (ControlFlow 0 7) 6) anon5_Then_correct) (=> (= (ControlFlow 0 7) 2) anon5_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and ($Is DatatypeTypeType |expr#0@@16| Tclass._module.Expression) ($IsAlloc DatatypeTypeType |expr#0@@16| Tclass._module.Expression $Heap@@3)) (|$IsA#_module.Expression| |expr#0@@16|)) (=> (and (and (and ($Is DatatypeTypeType |stC#0@@32| Tclass._module.StateC) ($IsAlloc DatatypeTypeType |stC#0@@32| Tclass._module.StateC $Heap@@3)) (|$IsA#_module.StateC| |stC#0@@32|)) (and (and ($IsBox |env#0@@15| Tclass._module.Env) ($IsAllocBox |env#0@@15| Tclass._module.Env $Heap@@3)) (and (= 7 $FunctionContextHeight) (= (ControlFlow 0 8) 7)))) anon0_correct)))))
