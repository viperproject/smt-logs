...
(assert (forall ((d@@1 T@U) ) (!  (=> ($Is DatatypeTypeType d@@1 Tclass.M2.WFCertificate) (M2.WFCertificate.Cert_q d@@1))
 :qid |unknown.0:0|
 :skolemid |4673|
 :pattern ( (M2.WFCertificate.Cert_q d@@1) ($Is DatatypeTypeType d@@1 Tclass.M2.WFCertificate))
)))
...
(assert (forall ((d@@4 T@U) ) (! (= (M2.WFCertificate.Cert_q d@@4) (= (DatatypeCtorId d@@4) |##M2.WFCertificate.Cert|))
 :qid |unknown.0:0|
 :skolemid |4661|
 :pattern ( (M2.WFCertificate.Cert_q d@@4))
)))
(assert (forall ((d@@5 T@U) ) (! (= (M2.State.StateCons_q d@@5) (= (DatatypeCtorId d@@5) |##M2.State.StateCons|))
 :qid |unknown.0:0|
 :skolemid |4677|
...
(assert (forall ((d@@7 T@U) ) (!  (=> (M2.WFCertificate.Cert_q d@@7) (exists ((|a#1#0#0@@0| T@U) (|a#1#1#0@@0| T@U) ) (! (= d@@7 (|#M2.WFCertificate.Cert| |a#1#0#0@@0| |a#1#1#0@@0|))
 :qid |CloudMakeParallelBuildsdfy.500:33|
 :skolemid |4662|
)))
 :qid |unknown.0:0|
...
(assert (forall ((certs T@U) (d@@9 T@U) ) (!  (=> (|$let#9$canCall| certs d@@9) (and ($Is DatatypeTypeType (|$let#9_c| certs d@@9) Tclass.M2.WFCertificate) (and (|Set#IsMember| certs ($Box DatatypeTypeType (|$let#9_c| certs d@@9))) (= (M2.WFCertificate.p (|$let#9_c| certs d@@9)) d@@9))))
 :qid |CloudMakeParallelBuildsdfy.669:5|
 :skolemid |3896|
 :pattern ( (|$let#9_c| certs d@@9))
)))
...
(assert (forall ((|a#6#0#0@@0| T@U) (|a#6#1#0@@0| T@U) (d@@11 T@U) ) (!  (=> (|Set#IsMember| |a#6#1#0@@0| ($Box DatatypeTypeType d@@11)) (< (DtRank d@@11) (DtRank (|#M2.WFCertificate.Cert| |a#6#0#0@@0| |a#6#1#0@@0|))))
 :qid |CloudMakeParallelBuildsdfy.500:33|
 :skolemid |4670|
 :pattern ( (|Set#IsMember| |a#6#1#0@@0| ($Box DatatypeTypeType d@@11)) (|#M2.WFCertificate.Cert| |a#6#0#0@@0| |a#6#1#0@@0|))
)))
(assert (forall ((d@@12 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) ($Is DatatypeTypeType d@@12 Tclass.M2.WFCertificate)) ($IsAlloc DatatypeTypeType d@@12 Tclass.M2.WFCertificate $h@@2))
 :qid |unknown.0:0|
 :skolemid |4671|
 :pattern ( ($IsAlloc DatatypeTypeType d@@12 Tclass.M2.WFCertificate $h@@2))
)))
...
(assert (forall ((d@@15 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (M2.WFCertificate.Cert_q d@@15) ($IsAlloc DatatypeTypeType d@@15 Tclass.M2.WFCertificate $h@@5))) ($IsAllocBox (M2.WFCertificate.p d@@15) Tclass.M2.Path $h@@5))
 :qid |unknown.0:0|
 :skolemid |4665|
 :pattern ( ($IsAllocBox (M2.WFCertificate.p d@@15) Tclass.M2.Path $h@@5))
)))
...
(assert (forall ((|a#12#0#0| T@U) (d@@16 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#12#0#0|) ($Box DatatypeTypeType d@@16)) (< (DtRank d@@16) (DtRank (|#M2.State.StateCons| |a#12#0#0|))))
 :qid |CloudMakeParallelBuildsdfy.433:30|
 :skolemid |4685|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#12#0#0|) ($Box DatatypeTypeType d@@16)) (|#M2.State.StateCons| |a#12#0#0|))
)))
...
(assert (forall ((d@@17 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (M2.WFCertificate.Cert_q d@@17) ($IsAlloc DatatypeTypeType d@@17 Tclass.M2.WFCertificate $h@@6))) ($IsAlloc SetType (M2.WFCertificate.certs d@@17) (TSet Tclass.M2.WFCertificate) $h@@6))
 :qid |unknown.0:0|
 :skolemid |4666|
 :pattern ( ($IsAlloc SetType (M2.WFCertificate.certs d@@17) (TSet Tclass.M2.WFCertificate) $h@@6))
)))
...
(declare-fun |cert#0@@15| () T@U)
(declare-fun |##certs#0@0| () T@U)
(declare-fun |##cert#1@0| () T@U)
(declare-fun |deps#0@@9| () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun |p#0@@24| () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$M2.__default.CollectDependencies)
...
(let ((anon13_Else_correct  (=> (and (not (|Set#IsMember| (M2.__default.DomSt |st#0@@19|) |d#1@0|)) ($IsAllocBox |d#1@0| Tclass.M2.Path $Heap@@6)) (=> (and (and ($IsAllocBox |d#1@0| Tclass.M2.Path $Heap@@6) (M2.WFCertificate.Cert_q |cert#0@@15|)) (and (= |##certs#0@0| (M2.WFCertificate.certs |cert#0@@15|)) ($IsAlloc SetType |##certs#0@0| (TSet Tclass.M2.WFCertificate) $Heap@@6))) (and (=> (= (ControlFlow 0 7) (- 0 13)) (exists ((|c#0@@3| T@U) ) (!  (and ($Is DatatypeTypeType |c#0@@3| Tclass.M2.WFCertificate) (and (|Set#IsMember| |##certs#0@0| ($Box DatatypeTypeType |c#0@@3|)) (= (M2.WFCertificate.p |c#0@@3|) |d#1@0|)))
 :qid |CloudMakeParallelBuildsdfy.667:21|
 :skolemid |3879|
 :pattern ( (M2.WFCertificate.p |c#0@@3|))
 :pattern ( (|Set#IsMember| |##certs#0@0| ($Box DatatypeTypeType |c#0@@3|)))
))) (=> (and (exists ((|c#0@@4| T@U) ) (!  (and ($Is DatatypeTypeType |c#0@@4| Tclass.M2.WFCertificate) (and (|Set#IsMember| |##certs#0@0| ($Box DatatypeTypeType |c#0@@4|)) (= (M2.WFCertificate.p |c#0@@4|) |d#1@0|)))
 :qid |CloudMakeParallelBuildsdfy.667:21|
 :skolemid |3881|
 :pattern ( (M2.WFCertificate.p |c#0@@4|))
 :pattern ( (|Set#IsMember| |##certs#0@0| ($Box DatatypeTypeType |c#0@@4|)))
)) (|M2.__default.FindCert#canCall| |d#1@0| (M2.WFCertificate.certs |cert#0@@15|))) (=> (and (and (M2.WFCertificate.Cert_q (M2.__default.FindCert |d#1@0| (M2.WFCertificate.certs |cert#0@@15|))) (= |##cert#1@0| (M2.__default.FindCert |d#1@0| (M2.WFCertificate.certs |cert#0@@15|)))) (and ($IsAlloc DatatypeTypeType |##cert#1@0| Tclass.M2.WFCertificate $Heap@@6) ($IsAlloc DatatypeTypeType |st#0@@19| Tclass.M2.State $Heap@@6))) (and (=> (= (ControlFlow 0 7) (- 0 12)) (=> (|M2.__default.CheckWellFounded#canCall| |d#1@0| |##cert#1@0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |d#1@0| |##cert#1@0|) (= (M2.WFCertificate.p |##cert#1@0|) |d#1@0|)))) (and (=> (= (ControlFlow 0 7) (- 0 11)) (=> (|M2.__default.CheckWellFounded#canCall| |d#1@0| |##cert#1@0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |d#1@0| |##cert#1@0|) (forall ((|d#2@@2| T@U) ) (!  (=> ($IsBox |d#2@@2| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.LocInv__Deps |d#1@0|) |d#2@@2|) (exists ((|c#1@@2| T@U) ) (!  (and ($Is DatatypeTypeType |c#1@@2| Tclass.M2.WFCertificate) (and (|Set#IsMember| (M2.WFCertificate.certs |##cert#1@0|) ($Box DatatypeTypeType |c#1@@2|)) (= (M2.WFCertificate.p |c#1@@2|) |d#2@@2|)))
 :qid |CloudMakeParallelBuildsdfy.497:49|
 :skolemid |3883|
 :pattern ( (M2.WFCertificate.p |c#1@@2|))
 :pattern ( (|Set#IsMember| (M2.WFCertificate.certs |##cert#1@0|) ($Box DatatypeTypeType |c#1@@2|)))
))))
 :qid |CloudMakeParallelBuildsdfy.497:13|
 :skolemid |3884|
 :pattern ( (|Set#IsMember| (M2.__default.LocInv__Deps |d#1@0|) |d#2@@2|))
))))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (=> (|M2.__default.CheckWellFounded#canCall| |d#1@0| |##cert#1@0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |d#1@0| |##cert#1@0|) (forall ((|c#2@@3| T@U) ) (!  (=> ($Is DatatypeTypeType |c#2@@3| Tclass.M2.WFCertificate) (=> (|Set#IsMember| (M2.WFCertificate.certs |##cert#1@0|) ($Box DatatypeTypeType |c#2@@3|)) (M2.__default.CheckWellFounded ($LS ($LS $LZ)) (M2.WFCertificate.p |c#2@@3|) |c#2@@3|)))
 :qid |CloudMakeParallelBuildsdfy.498:13|
 :skolemid |3885|
 :pattern ( (M2.WFCertificate.p |c#2@@3|))
 :pattern ( (|Set#IsMember| (M2.WFCertificate.certs |##cert#1@0|) ($Box DatatypeTypeType |c#2@@3|)))
))))) (=> (M2.__default.CheckWellFounded ($LS $LZ) |d#1@0| |##cert#1@0|) (and (=> (= (ControlFlow 0 7) (- 0 9)) (or (or (<= 0 (LitInt 0)) (< (DtRank |##cert#1@0|) (DtRank |cert#0@@15|))) (= (LitInt 1) (LitInt 0)))) (=> (or (or (<= 0 (LitInt 0)) (< (DtRank |##cert#1@0|) (DtRank |cert#0@@15|))) (= (LitInt 1) (LitInt 0))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (< (DtRank |##cert#1@0|) (DtRank |cert#0@@15|)) (and (= (DtRank |##cert#1@0|) (DtRank |cert#0@@15|)) (< (LitInt 1) (LitInt 0))))) (=> (or (< (DtRank |##cert#1@0|) (DtRank |cert#0@@15|)) (and (= (DtRank |##cert#1@0|) (DtRank |cert#0@@15|)) (< (LitInt 1) (LitInt 0)))) (=> (and (|M2.__default.OracleWF#canCall| |d#1@0| (M2.__default.FindCert |d#1@0| (M2.WFCertificate.certs |cert#0@@15|)) |st#0@@19|) (= (ControlFlow 0 7) 2)) anon8_correct))))))))))))))))
(let ((anon13_Then_correct  (=> (|Set#IsMember| (M2.__default.DomSt |st#0@@19|) |d#1@0|) (=> (and ($IsAllocBox |d#1@0| Tclass.M2.Path $Heap@@6) ($IsAlloc DatatypeTypeType |st#0@@19| Tclass.M2.State $Heap@@6)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (|Set#IsMember| (M2.__default.DomSt |st#0@@19|) |d#1@0|)) (=> (|Set#IsMember| (M2.__default.DomSt |st#0@@19|) |d#1@0|) (=> (and (|M2.__default.GetSt#canCall| |d#1@0| |st#0@@19|) (= (ControlFlow 0 5) 2)) anon8_correct)))))))
(let ((anon12_Then_correct  (=> (|Set#IsMember| |deps#0@@9| |d#1@0|) (=> (and ($IsAlloc DatatypeTypeType |st#0@@19| Tclass.M2.State $Heap@@6) (|M2.__default.DomSt#canCall| |st#0@@19|)) (and (=> (= (ControlFlow 0 14) 5) anon13_Then_correct) (=> (= (ControlFlow 0 14) 7) anon13_Else_correct))))))
(let ((anon12_Else_correct  (=> (and (not (|Set#IsMember| |deps#0@@9| |d#1@0|)) (= (ControlFlow 0 4) 2)) anon8_correct)))
(let ((anon11_Then_correct  (=> (and ($IsBox |d#1@0| Tclass.M2.Path) ($IsAllocBox |d#1@0| Tclass.M2.Path $Heap@@6)) (and (=> (= (ControlFlow 0 15) 14) anon12_Then_correct) (=> (= (ControlFlow 0 15) 4) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (not (and ($IsBox |d#1@0| Tclass.M2.Path) ($IsAllocBox |d#1@0| Tclass.M2.Path $Heap@@6))) (= (ControlFlow 0 3) 2)) anon8_correct)))
(let ((anon10_Then_correct true))
(let ((anon0_correct  (=> (and (and (and (= $_ReadsFrame@0 (|lambda#4| null $Heap@@6 alloc false)) ($IsAllocBox |p#0@@24| Tclass.M2.Path $Heap@@6)) (and ($IsAlloc DatatypeTypeType |cert#0@@15| Tclass.M2.WFCertificate $Heap@@6) (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert#0@@15|))) (and (and (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert#0@@15|) ($IsAllocBox |p#0@@24| Tclass.M2.Path $Heap@@6)) (and (|M2.__default.LocInv__Deps#canCall| |p#0@@24|) (|Set#Equal| |deps#0@@9| (M2.__default.LocInv__Deps |p#0@@24|))))) (and (and (=> (= (ControlFlow 0 16) 1) anon10_Then_correct) (=> (= (ControlFlow 0 16) 15) anon11_Then_correct)) (=> (= (ControlFlow 0 16) 3) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (and ($IsBox |p#0@@24| Tclass.M2.Path) ($Is DatatypeTypeType |cert#0@@15| Tclass.M2.WFCertificate))) (and (and ($Is SetType |deps#0@@9| (TSet Tclass.M2.Path)) ($Is DatatypeTypeType |st#0@@19| Tclass.M2.State)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 17) 16)))) anon0_correct)))
