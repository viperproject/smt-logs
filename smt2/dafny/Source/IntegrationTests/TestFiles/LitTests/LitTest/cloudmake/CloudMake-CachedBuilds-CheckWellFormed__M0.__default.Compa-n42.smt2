...
(set-info :boogie-vc-id CheckWellFormed$$M0.__default.CompatCheckCore__StateCorrespondence)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon7_correct  (=> (and (and (forall ((|s#3| T@U) ) (!  (=> ($IsBox |s#3| Tclass.M0.State) (and (and (=> (|Set#IsMember| |stsC#0| |s#3|) (M0.__default.ValidState |s#3|)) (=> (|Set#IsMember| |stsC#0| |s#3|) (M0.__default.Extends reveal_M0._default.Extends |stOrigC#0| |s#3|))) (=> (|Set#IsMember| |stsC#0| |s#3|) (M0.__default.ConsistentCache |s#3|))))
...
)) ($IsAlloc SetType |sts#0@@10| (TSet Tclass.M0.State) $Heap@@8)) (and (= |##useCache#0@0| (U_2_bool (Lit boolType (bool_2_U false)))) ($IsAlloc boolType (bool_2_U |##useCache#0@0|) TBool $Heap@@8))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (not (|Set#Equal| |sts#0@@10| |Set#Empty|))) (=> (not (|Set#Equal| |sts#0@@10| |Set#Empty|)) (=> (and (|M0.__default.Combine#canCall| |sts#0@@10| (U_2_bool (Lit boolType (bool_2_U false)))) (= |##st#7@0| (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |sts#0@@10| (U_2_bool (Lit boolType (bool_2_U false)))))) (=> (and (and ($IsAllocBox |##st#7@0| Tclass.M0.State $Heap@@8) ($IsAlloc SetType |stsC#0| (TSet Tclass.M0.State) $Heap@@8)) (and (= |##useCache#1@0| (U_2_bool (Lit boolType (bool_2_U true)))) ($IsAlloc boolType (bool_2_U |##useCache#1@0|) TBool $Heap@@8))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (not (|Set#Equal| |stsC#0| |Set#Empty|))) (=> (and (not (|Set#Equal| |stsC#0| |Set#Empty|)) (|M0.__default.Combine#canCall| |stsC#0| (U_2_bool (Lit boolType (bool_2_U true))))) (=> (and (and (= |##stC#2@0| (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |stsC#0| (U_2_bool (Lit boolType (bool_2_U true))))) ($IsAllocBox |##stC#2@0| Tclass.M0.State $Heap@@8)) (and (|M0.__default.StateCorrespondence#canCall| (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |sts#0@@10| (U_2_bool (Lit boolType (bool_2_U false)))) (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |stsC#0| (U_2_bool (Lit boolType (bool_2_U true))))) (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |sts#0@@10| (U_2_bool (Lit boolType (bool_2_U false)))) (M0.__default.Combine ($LS $LZ) reveal_M0._default.Combine |stsC#0| (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@8 $Heap@0)) (and ($IsAllocBox |stOrig#0@@9| Tclass.M0.State $Heap@0) ($IsAlloc SetType |sts#0@@10| (TSet Tclass.M0.State) $Heap@0))) (and (and ($IsAlloc DatatypeTypeType |fun#0@@4| Tclass.M0.Expression $Heap@0) ($IsAlloc SeqType |args#0@@12| (TSeq Tclass.M0.Expression) $Heap@0)) (and (= |##useCache#2@0| (U_2_bool (Lit boolType (bool_2_U false)))) ($IsAlloc boolType (bool_2_U |##useCache#2@0|) TBool $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (|Set#Equal| |sts#0@@10| |Set#Empty|))) (=> (not (|Set#Equal| |sts#0@@10| |Set#Empty|)) (=> (and (and (|M0.__default.evalCompatCheckCore#canCall| |stOrig#0@@9| |sts#0@@10| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))) (M0.Tuple.Pair_q (M0.__default.evalCompatCheckCore |stOrig#0@@9| |sts#0@@10| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))))) (and (M0.Tuple.Pair_q (M0.__default.evalCompatCheckCore |stOrig#0@@9| |sts#0@@10| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false))))) (= |##st#8@0| (M0.Tuple.snd (M0.__default.evalCompatCheckCore |stOrig#0@@9| |sts#0@@10| |fun#0@@4| |args#0@@12| (U_2_bool (Lit boolType (bool_2_U false)))))))) (=> (and (and (and ($IsAllocBox |##st#8@0| Tclass.M0.State $Heap@0) ($IsAllocBox |stOrigC#0| Tclass.M0.State $Heap@0)) (and ($IsAlloc SetType |stsC#0| (TSet Tclass.M0.State) $Heap@0) ($IsAlloc DatatypeTypeType |fun#0@@4| Tclass.M0.Expression $Heap@0))) (and (and ($IsAlloc SeqType |args#0@@12| (TSeq Tclass.M0.Expression) $Heap@0) (= |##useCache#3@0| (U_2_bool (Lit boolType (bool_2_U true))))) (and ($IsAlloc boolType (bool_2_U |##useCache#3@0|) TBool $Heap@0) (= (ControlFlow 0 2) (- 0 1))))) (not (|Set#Equal| |stsC#0| |Set#Empty|)))))))))))))))))
(let ((anon9_Else_correct  (=> (and (=> (|Set#IsMember| |stsC#0| |s#2@0|) (and (and (M0.__default.ValidState |s#2@0|) (M0.__default.Extends reveal_M0._default.Extends |stOrigC#0| |s#2@0|)) (M0.__default.ConsistentCache |s#2@0|))) (= (ControlFlow 0 7) 2)) anon7_correct)))
(let ((anon9_Then_correct  (=> (and (and (|Set#IsMember| |stsC#0| |s#2@0|) ($IsAllocBox |s#2@0| Tclass.M0.State $Heap@@8)) (and (|M0.__default.ValidState#canCall| |s#2@0|) (M0.__default.ValidState |s#2@0|))) (=> (and (and (and ($IsAllocBox |stOrigC#0| Tclass.M0.State $Heap@@8) ($IsAllocBox |s#2@0| Tclass.M0.State $Heap@@8)) (and (|M0.__default.Extends#canCall| |stOrigC#0| |s#2@0|) (M0.__default.Extends reveal_M0._default.Extends |stOrigC#0| |s#2@0|))) (and (and ($IsAllocBox |s#2@0| Tclass.M0.State $Heap@@8) (|M0.__default.ConsistentCache#canCall| |s#2@0|)) (and (M0.__default.ConsistentCache |s#2@0|) (= (ControlFlow 0 6) 2)))) anon7_correct))))
(let ((anon4_correct  (=> (forall ((|s#1| T@U) ) (!  (=> ($IsBox |s#1| Tclass.M0.State) (and (=> (|Set#IsMember| |sts#0@@10| |s#1|) (M0.__default.ValidState |s#1|)) (=> (|Set#IsMember| |sts#0@@10| |s#1|) (M0.__default.Extends reveal_M0._default.Extends |stOrig#0@@9| |s#1|))))
...
)) (=> (and ($IsBox |s#2@0| Tclass.M0.State) ($IsAllocBox |s#2@0| Tclass.M0.State $Heap@@8)) (and (=> (= (ControlFlow 0 8) 6) anon9_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct))))))
(let ((anon8_Else_correct  (=> (and (=> (|Set#IsMember| |sts#0@@10| |s#0@0|) (and (M0.__default.ValidState |s#0@0|) (M0.__default.Extends reveal_M0._default.Extends |stOrig#0@@9| |s#0@0|))) (= (ControlFlow 0 10) 8)) anon4_correct)))
(let ((anon8_Then_correct  (=> (|Set#IsMember| |sts#0@@10| |s#0@0|) (=> (and (and (and ($IsAllocBox |s#0@0| Tclass.M0.State $Heap@@8) (|M0.__default.ValidState#canCall| |s#0@0|)) (and (M0.__default.ValidState |s#0@0|) ($IsAllocBox |stOrig#0@@9| Tclass.M0.State $Heap@@8))) (and (and ($IsAllocBox |s#0@0| Tclass.M0.State $Heap@@8) (|M0.__default.Extends#canCall| |stOrig#0@@9| |s#0@0|)) (and (M0.__default.Extends reveal_M0._default.Extends |stOrig#0@@9| |s#0@0|) (= (ControlFlow 0 9) 8)))) anon4_correct))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@8 alloc false)) (=> (and (and ($IsAllocBox |stOrig#0@@9| Tclass.M0.State $Heap@@8) (|M0.__default.ValidState#canCall| |stOrig#0@@9|)) (and (M0.__default.ValidState |stOrig#0@@9|) ($IsAllocBox |stOrigC#0| Tclass.M0.State $Heap@@8))) (=> (and (and (and (and (|M0.__default.ValidState#canCall| |stOrigC#0|) (M0.__default.ValidState |stOrigC#0|)) (and ($IsAllocBox |stOrig#0@@9| Tclass.M0.State $Heap@@8) ($IsAllocBox |stOrigC#0| Tclass.M0.State $Heap@@8))) (and (and (|M0.__default.StateCorrespondence#canCall| |stOrig#0@@9| |stOrigC#0|) (M0.__default.StateCorrespondence reveal_M0._default.StateCorrespondence |stOrig#0@@9| |stOrigC#0|)) (and (not (|Set#Equal| |sts#0@@10| |Set#Empty|)) (not (|Set#Equal| |stsC#0| |Set#Empty|))))) (and (and (and ($IsAlloc SetType |sts#0@@10| (TSet Tclass.M0.State) $Heap@@8) (|M0.__default.Compatible#canCall| |sts#0@@10|)) (and (M0.__default.Compatible |sts#0@@10|) ($IsAlloc SetType |stsC#0| (TSet Tclass.M0.State) $Heap@@8))) (and (and (|M0.__default.Compatible#canCall| |stsC#0|) (M0.__default.Compatible |stsC#0|)) (and ($IsBox |s#0@0| Tclass.M0.State) ($IsAllocBox |s#0@0| Tclass.M0.State $Heap@@8))))) (and (=> (= (ControlFlow 0 11) 9) anon8_Then_correct) (=> (= (ControlFlow 0 11) 10) anon8_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@8) ($IsHeapAnchor $Heap@@8)) (=> (and (and (and (and ($IsBox |stOrig#0@@9| Tclass.M0.State) ($IsAllocBox |stOrig#0@@9| Tclass.M0.State $Heap@@8)) (and ($Is SetType |sts#0@@10| (TSet Tclass.M0.State)) ($IsAlloc SetType |sts#0@@10| (TSet Tclass.M0.State) $Heap@@8))) (and (and ($IsBox |stOrigC#0| Tclass.M0.State) ($IsAllocBox |stOrigC#0| Tclass.M0.State $Heap@@8)) (and ($Is SetType |stsC#0| (TSet Tclass.M0.State)) ($IsAlloc SetType |stsC#0| (TSet Tclass.M0.State) $Heap@@8)))) (and (and (and ($Is DatatypeTypeType |fun#0@@4| Tclass.M0.Expression) ($IsAlloc DatatypeTypeType |fun#0@@4| Tclass.M0.Expression $Heap@@8)) (|$IsA#M0.Expression| |fun#0@@4|)) (and (and ($Is SeqType |args#0@@12| (TSeq Tclass.M0.Expression)) ($IsAlloc SeqType |args#0@@12| (TSeq Tclass.M0.Expression) $Heap@@8)) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 12) 11))))) anon0_correct))))
