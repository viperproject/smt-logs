...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|cmd#0@@0| T@U) (|deps#0@@0| T@U) (|exps#0| T@U) (|st#0@@2| T@U) ) (!  (=> (or (|M0.__default.Pre#canCall| (Lit SeqType |cmd#0@@0|) (Lit SetType |deps#0@@0|) (Lit SetType |exps#0|) (Lit BoxType |st#0@@2|)) (and (< 2 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@0| (TSeq TChar)) ($Is SetType |deps#0@@0| (TSet Tclass.M0.Path))) ($Is SetType |exps#0| (TSet (TSeq TChar)))) ($IsBox |st#0@@2| Tclass.M0.State)))) (and (forall ((|e#2| T@U) ) (!  (=> ($Is SeqType |e#2| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0|) ($Box SeqType |e#2|)) (and (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@0|) (Lit SetType |deps#0@@0|) |e#2|) (|M0.__default.DomSt#canCall| (Lit BoxType |st#0@@2|))) (=> (|Set#IsMember| (M0.__default.DomSt (Lit BoxType |st#0@@2|)) (M0.__default.Loc (Lit SeqType |cmd#0@@0|) (Lit SetType |deps#0@@0|) |e#2|)) (and (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@0|) (Lit SetType |deps#0@@0|) |e#2|) (|M0.__default.GetSt#canCall| (M0.__default.Loc (Lit SeqType |cmd#0@@0|) (Lit SetType |deps#0@@0|) |e#2|) (Lit BoxType |st#0@@2|))) (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@0|) (Lit SetType |deps#0@@0|) |e#2|) (|M0.__default.Oracle#canCall| (M0.__default.Loc (Lit SeqType |cmd#0@@0|) (Lit SetType |deps#0@@0|) |e#2|) (Lit BoxType |st#0@@2|))))))))
 :pattern ( (M0.__default.Loc |cmd#0@@0| |deps#0@@0| |e#2|))
 :pattern ( (|Set#IsMember| |exps#0| ($Box SeqType |e#2|)))
)) (= (M0.__default.Pre (Lit SeqType |cmd#0@@0|) (Lit SetType |deps#0@@0|) (Lit SetType |exps#0|) (Lit BoxType |st#0@@2|)) (forall ((|e#2@@0| T@U) ) (!  (=> ($Is SeqType |e#2@@0| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0|) ($Box SeqType |e#2@@0|)) (=> (|Set#IsMember| (M0.__default.DomSt (Lit BoxType |st#0@@2|)) (M0.__default.Loc (Lit SeqType |cmd#0@@0|) (Lit SetType |deps#0@@0|) |e#2@@0|)) (= (M0.__default.GetSt (M0.__default.Loc (Lit SeqType |cmd#0@@0|) (Lit SetType |deps#0@@0|) |e#2@@0|) (Lit BoxType |st#0@@2|)) (M0.__default.Oracle (M0.__default.Loc (Lit SeqType |cmd#0@@0|) (Lit SetType |deps#0@@0|) |e#2@@0|) (Lit BoxType |st#0@@2|))))))
 :pattern ( (M0.__default.Loc |cmd#0@@0| |deps#0@@0| |e#2@@0|))
 :pattern ( (|Set#IsMember| |exps#0| ($Box SeqType |e#2@@0|)))
)))))
 :weight 3
 :pattern ( (M0.__default.Pre (Lit SeqType |cmd#0@@0|) (Lit SetType |deps#0@@0|) (Lit SetType |exps#0|) (Lit BoxType |st#0@@2|)))
))))
(assert (forall ((v@@0 T@U) (t T@U) (h T@U) (T@@1 T@T) ) (! (= ($IsAllocBox ($Box T@@1 v@@0) t h) ($IsAlloc T@@1 v@@0 t h))
 :pattern ( ($IsAllocBox ($Box T@@1 v@@0) t h))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|cmd#0@@1| T@U) (|deps#0@@1| T@U) (|exps#0@@0| T@U) (|st#0@@3| T@U) ) (!  (=> (or (|M0.__default.Pre#canCall| (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) (Lit SetType |exps#0@@0|) |st#0@@3|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@1| (TSeq TChar)) ($Is SetType |deps#0@@1| (TSet Tclass.M0.Path))) ($Is SetType |exps#0@@0| (TSet (TSeq TChar)))) ($IsBox |st#0@@3| Tclass.M0.State)))) (and (forall ((|e#1| T@U) ) (!  (=> ($Is SeqType |e#1| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@0|) ($Box SeqType |e#1|)) (and (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) |e#1|) (|M0.__default.DomSt#canCall| |st#0@@3|)) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@3|) (M0.__default.Loc (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) |e#1|)) (and (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) |e#1|) (|M0.__default.GetSt#canCall| (M0.__default.Loc (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) |e#1|) |st#0@@3|)) (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) |e#1|) (|M0.__default.Oracle#canCall| (M0.__default.Loc (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) |e#1|) |st#0@@3|)))))))
 :pattern ( (M0.__default.Loc |cmd#0@@1| |deps#0@@1| |e#1|))
 :pattern ( (|Set#IsMember| |exps#0@@0| ($Box SeqType |e#1|)))
)) (= (M0.__default.Pre (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) (Lit SetType |exps#0@@0|) |st#0@@3|) (forall ((|e#1@@0| T@U) ) (!  (=> ($Is SeqType |e#1@@0| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@0|) ($Box SeqType |e#1@@0|)) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@3|) (M0.__default.Loc (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) |e#1@@0|)) (= (M0.__default.GetSt (M0.__default.Loc (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) |e#1@@0|) |st#0@@3|) (M0.__default.Oracle (M0.__default.Loc (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) |e#1@@0|) |st#0@@3|)))))
 :pattern ( (M0.__default.Loc |cmd#0@@1| |deps#0@@1| |e#1@@0|))
 :pattern ( (|Set#IsMember| |exps#0@@0| ($Box SeqType |e#1@@0|)))
)))))
 :weight 3
 :pattern ( (M0.__default.Pre (Lit SeqType |cmd#0@@1|) (Lit SetType |deps#0@@1|) (Lit SetType |exps#0@@0|) |st#0@@3|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|cmd#0@@2| T@U) (|deps#0@@2| T@U) (|exps#0@@1| T@U) (|st#0@@5| T@U) ) (!  (=> (or (|M0.__default.Pre#canCall| |cmd#0@@2| |deps#0@@2| |exps#0@@1| |st#0@@5|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@2| (TSeq TChar)) ($Is SetType |deps#0@@2| (TSet Tclass.M0.Path))) ($Is SetType |exps#0@@1| (TSet (TSeq TChar)))) ($IsBox |st#0@@5| Tclass.M0.State)))) (and (forall ((|e#0| T@U) ) (!  (=> ($Is SeqType |e#0| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@1| ($Box SeqType |e#0|)) (and (and (|M0.__default.Loc#canCall| |cmd#0@@2| |deps#0@@2| |e#0|) (|M0.__default.DomSt#canCall| |st#0@@5|)) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@5|) (M0.__default.Loc |cmd#0@@2| |deps#0@@2| |e#0|)) (and (and (|M0.__default.Loc#canCall| |cmd#0@@2| |deps#0@@2| |e#0|) (|M0.__default.GetSt#canCall| (M0.__default.Loc |cmd#0@@2| |deps#0@@2| |e#0|) |st#0@@5|)) (and (|M0.__default.Loc#canCall| |cmd#0@@2| |deps#0@@2| |e#0|) (|M0.__default.Oracle#canCall| (M0.__default.Loc |cmd#0@@2| |deps#0@@2| |e#0|) |st#0@@5|)))))))
 :pattern ( (M0.__default.Loc |cmd#0@@2| |deps#0@@2| |e#0|))
 :pattern ( (|Set#IsMember| |exps#0@@1| ($Box SeqType |e#0|)))
)) (= (M0.__default.Pre |cmd#0@@2| |deps#0@@2| |exps#0@@1| |st#0@@5|) (forall ((|e#0@@0| T@U) ) (!  (=> ($Is SeqType |e#0@@0| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@1| ($Box SeqType |e#0@@0|)) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@5|) (M0.__default.Loc |cmd#0@@2| |deps#0@@2| |e#0@@0|)) (= (M0.__default.GetSt (M0.__default.Loc |cmd#0@@2| |deps#0@@2| |e#0@@0|) |st#0@@5|) (M0.__default.Oracle (M0.__default.Loc |cmd#0@@2| |deps#0@@2| |e#0@@0|) |st#0@@5|)))))
 :pattern ( (M0.__default.Loc |cmd#0@@2| |deps#0@@2| |e#0@@0|))
 :pattern ( (|Set#IsMember| |exps#0@@1| ($Box SeqType |e#0@@0|)))
)))))
 :pattern ( (M0.__default.Pre |cmd#0@@2| |deps#0@@2| |exps#0@@1| |st#0@@5|))
))))
