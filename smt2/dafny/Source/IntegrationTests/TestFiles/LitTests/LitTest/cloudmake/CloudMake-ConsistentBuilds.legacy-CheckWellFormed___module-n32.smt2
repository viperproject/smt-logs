...
(declare-fun Tagclass._module.Program () T@U)
(declare-fun |##_module.StateC.S| () T@U)
(declare-fun |##_module.Program.Program| () T@U)
...
(declare-fun |$IsA#_module.Program| (T@U) Bool)
(declare-fun _module.Program.Program_q (T@U) Bool)
...
(declare-fun |#_module.Program.Program| (T@U) T@U)
...
(declare-fun Tclass._module.Program () T@U)
...
(declare-fun |_module.__default.EmptyEnv#canCall| () Bool)
(declare-fun _module.__default.EmptyEnv () T@U)
...
(declare-fun _module.__default.buildC (T@U T@U) T@U)
(declare-fun |_module.__default.buildC#canCall| (T@U T@U) Bool)
(declare-fun _module.Program.stmts (T@U) T@U)
...
(assert (distinct TChar TInt TagChar TagInt TagSet TagSeq alloc Tagclass._module.Path Tagclass._module.Expression Tagclass._module.Triple Tagclass._module.StateC Tagclass._module.Tuple Tagclass._module.Statement Tagclass._module.Primitive Tagclass._module.Program |##_module.StateC.S| |##_module.Program.Program| |##_module.Statement.stmtVariable| |##_module.Statement.stmtReturn| |##_module.Expression.exprLiteral| Tagclass._module.Literal |##_module.Expression.exprIdentifier| |##_module.Expression.exprIf| |##_module.Expression.exprAnd| |##_module.Expression.exprOr| |##_module.Expression.exprInvocation| |##_module.Expression.exprError| Tagclass._module.Reason |##_module.Literal.litTrue| |##_module.Literal.litFalse| |##_module.Literal.litUndefined| |##_module.Literal.litNull| |##_module.Literal.litNumber| |##_module.Literal.litString| |##_module.Literal.litPrimitive| |##_module.Literal.litArrOfPaths| |##_module.Literal.litArrOfStrings| |##_module.Literal.litArray| |##_module.Primitive.primCreatePath| |##_module.Primitive.primExec| |##_module.Reason.rCompatibility| |##_module.Reason.rValidity| |##_module.Reason.rInconsistentCache| |##_module.Tuple.Pair| |##_module.Triple.Trio| tytagFamily$Path tytagFamily$Expression tytagFamily$Triple tytagFamily$StateC tytagFamily$Tuple tytagFamily$Statement tytagFamily$Primitive tytagFamily$Program tytagFamily$Literal tytagFamily$Reason)
)
...
(assert  (=> (<= 7 $FunctionContextHeight) (forall (($ly@@0 T@U) (|stmts#0| T@U) (|stC#0| T@U) (|env#0| T@U) ) (!  (=> (or (|_module.__default.doC#canCall| |stmts#0| |stC#0| |env#0|) (and (< 7 $FunctionContextHeight) (and (and (and ($Is SeqType |stmts#0| (TSeq Tclass._module.Statement)) ($Is DatatypeTypeType |stC#0| Tclass._module.StateC)) ($IsBox |env#0| Tclass._module.Env)) (_module.__default.Legal |stmts#0|)))) ($Is DatatypeTypeType (_module.__default.doC $ly@@0 |stmts#0| |stC#0| |env#0|) (Tclass._module.Tuple Tclass._module.Expression Tclass._module.StateC)))
 :qid |CloudMakeConsistentBuildslegacydfy.375:16|
 :skolemid |1097|
...
(assert (forall ((|a#15#0#0| T@U) (|a#15#1#0| T@U) ) (! (= ($Is DatatypeTypeType (|#_module.Statement.stmtVariable| |a#15#0#0| |a#15#1#0|) Tclass._module.Statement)  (and ($IsBox |a#15#0#0| Tclass._module.Identifier) ($Is DatatypeTypeType |a#15#1#0| Tclass._module.Expression)))
 :qid |CloudMakeConsistentBuildslegacydfy.316:35|
 :skolemid |1303|
...
(assert (forall ((d@@0 T@U) ) (!  (=> (|$IsA#_module.Program| d@@0) (_module.Program.Program_q d@@0))
 :qid |unknown.0:0|
 :skolemid |1295|
 :pattern ( (|$IsA#_module.Program| d@@0))
)))
(assert (forall ((d@@1 T@U) ) (!  (=> (|$IsA#_module.Triple| d@@1) (_module.Triple.Trio_q d@@1))
 :qid |unknown.0:0|
 :skolemid |1576|
 :pattern ( (|$IsA#_module.Triple| d@@1))
)))
...
(assert (forall ((|a#11#0#0| T@U) (i@@0 Int) ) (!  (=> (and (<= 0 i@@0) (< i@@0 (|Seq#Length| |a#11#0#0|))) (< (DtRank ($Unbox DatatypeTypeType (|Seq#Index| |a#11#0#0| i@@0))) (DtRank (|#_module.Program.Program| |a#11#0#0|))))
 :qid |CloudMakeConsistentBuildslegacydfy.314:28|
 :skolemid |1292|
 :pattern ( (|Seq#Index| |a#11#0#0| i@@0) (|#_module.Program.Program| |a#11#0#0|))
)))
(assert (forall ((|a#104#0#0| T@U) (i@@1 Int) ) (!  (=> (and (<= 0 i@@1) (< i@@1 (|Seq#Length| |a#104#0#0|))) (< (DtRank ($Unbox DatatypeTypeType (|Seq#Index| |a#104#0#0| i@@1))) (DtRank (|#_module.Literal.litString| |a#104#0#0|))))
 :qid |CloudMakeConsistentBuildslegacydfy.327:52|
 :skolemid |1440|
 :pattern ( (|Seq#Index| |a#104#0#0| i@@1) (|#_module.Literal.litString| |a#104#0#0|))
)))
(assert (forall ((|a#129#0#0| T@U) (i@@2 Int) ) (!  (=> (and (<= 0 i@@2) (< i@@2 (|Seq#Length| |a#129#0#0|))) (< (DtRank ($Unbox DatatypeTypeType (|Seq#Index| |a#129#0#0| i@@2))) (DtRank (|#_module.Literal.litArray| |a#129#0#0|))))
 :qid |CloudMakeConsistentBuildslegacydfy.331:29|
 :skolemid |1477|
 :pattern ( (|Seq#Index| |a#129#0#0| i@@2) (|#_module.Literal.litArray| |a#129#0#0|))
)))
...
(assert (forall ((_module.Tuple$A T@U) (_module.Tuple$B T@U) (d@@2 T@U) ) (!  (=> ($Is DatatypeTypeType d@@2 (Tclass._module.Tuple _module.Tuple$A _module.Tuple$B)) (_module.Tuple.Pair_q d@@2))
 :qid |unknown.0:0|
 :skolemid |1554|
 :pattern ( (_module.Tuple.Pair_q d@@2) ($Is DatatypeTypeType d@@2 (Tclass._module.Tuple _module.Tuple$A _module.Tuple$B)))
)))
...
(assert (forall ((d@@3 T@U) ) (!  (=> ($Is DatatypeTypeType d@@3 Tclass._module.StateC) (_module.StateC.S_q d@@3))
 :qid |unknown.0:0|
 :skolemid |1281|
 :pattern ( (_module.StateC.S_q d@@3) ($Is DatatypeTypeType d@@3 Tclass._module.StateC))
)))
(assert (forall ((d@@4 T@U) ) (!  (=> ($Is DatatypeTypeType d@@4 Tclass._module.Program) (_module.Program.Program_q d@@4))
 :qid |unknown.0:0|
 :skolemid |1296|
 :pattern ( (_module.Program.Program_q d@@4) ($Is DatatypeTypeType d@@4 Tclass._module.Program))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.EmptyEnv#canCall| (< 0 $FunctionContextHeight)) ($IsBox _module.__default.EmptyEnv Tclass._module.Env))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|stmts#0@@0| T@U) ) (!  (=> (or (|_module.__default.Legal#canCall| |stmts#0@@0|) (and (< 3 $FunctionContextHeight) ($Is SeqType |stmts#0@@0| (TSeq Tclass._module.Statement)))) (= (_module.__default.Legal |stmts#0@@0|)  (or (not (= (|Seq#Length| |stmts#0@@0|) 0)) (not true))))
 :qid |CloudMakeConsistentBuildslegacydfy.355:23|
 :skolemid |1080|
...
(assert (forall ((d@@5 T@U) ) (! (= (_module.StateC.S_q d@@5) (= (DatatypeCtorId d@@5) |##_module.StateC.S|))
 :qid |unknown.0:0|
 :skolemid |1270|
 :pattern ( (_module.StateC.S_q d@@5))
)))
(assert (forall ((d@@6 T@U) ) (! (= (_module.Program.Program_q d@@6) (= (DatatypeCtorId d@@6) |##_module.Program.Program|))
 :qid |unknown.0:0|
 :skolemid |1285|
 :pattern ( (_module.Program.Program_q d@@6))
)))
(assert (forall ((d@@7 T@U) ) (! (= (_module.Statement.stmtVariable_q d@@7) (= (DatatypeCtorId d@@7) |##_module.Statement.stmtVariable|))
 :qid |unknown.0:0|
 :skolemid |1300|
 :pattern ( (_module.Statement.stmtVariable_q d@@7))
)))
(assert (forall ((d@@8 T@U) ) (! (= (_module.Statement.stmtReturn_q d@@8) (= (DatatypeCtorId d@@8) |##_module.Statement.stmtReturn|))
 :qid |unknown.0:0|
 :skolemid |1311|
 :pattern ( (_module.Statement.stmtReturn_q d@@8))
)))
(assert (forall ((d@@9 T@U) ) (! (= (_module.Expression.exprLiteral_q d@@9) (= (DatatypeCtorId d@@9) |##_module.Expression.exprLiteral|))
 :qid |unknown.0:0|
 :skolemid |1326|
 :pattern ( (_module.Expression.exprLiteral_q d@@9))
)))
(assert (forall ((d@@10 T@U) ) (! (= (_module.Expression.exprIdentifier_q d@@10) (= (DatatypeCtorId d@@10) |##_module.Expression.exprIdentifier|))
 :qid |unknown.0:0|
 :skolemid |1336|
 :pattern ( (_module.Expression.exprIdentifier_q d@@10))
)))
(assert (forall ((d@@11 T@U) ) (! (= (_module.Expression.exprIf_q d@@11) (= (DatatypeCtorId d@@11) |##_module.Expression.exprIf|))
 :qid |unknown.0:0|
 :skolemid |1344|
 :pattern ( (_module.Expression.exprIf_q d@@11))
)))
(assert (forall ((d@@12 T@U) ) (! (= (_module.Expression.exprAnd_q d@@12) (= (DatatypeCtorId d@@12) |##_module.Expression.exprAnd|))
 :qid |unknown.0:0|
 :skolemid |1359|
 :pattern ( (_module.Expression.exprAnd_q d@@12))
)))
(assert (forall ((d@@13 T@U) ) (! (= (_module.Expression.exprOr_q d@@13) (= (DatatypeCtorId d@@13) |##_module.Expression.exprOr|))
 :qid |unknown.0:0|
 :skolemid |1371|
 :pattern ( (_module.Expression.exprOr_q d@@13))
)))
(assert (forall ((d@@14 T@U) ) (! (= (_module.Expression.exprInvocation_q d@@14) (= (DatatypeCtorId d@@14) |##_module.Expression.exprInvocation|))
 :qid |unknown.0:0|
 :skolemid |1383|
 :pattern ( (_module.Expression.exprInvocation_q d@@14))
)))
(assert (forall ((d@@15 T@U) ) (! (= (_module.Expression.exprError_q d@@15) (= (DatatypeCtorId d@@15) |##_module.Expression.exprError|))
 :qid |unknown.0:0|
 :skolemid |1396|
 :pattern ( (_module.Expression.exprError_q d@@15))
)))
(assert (forall ((d@@16 T@U) ) (! (= (_module.Literal.litTrue_q d@@16) (= (DatatypeCtorId d@@16) |##_module.Literal.litTrue|))
 :qid |unknown.0:0|
 :skolemid |1416|
 :pattern ( (_module.Literal.litTrue_q d@@16))
)))
(assert (forall ((d@@17 T@U) ) (! (= (_module.Literal.litFalse_q d@@17) (= (DatatypeCtorId d@@17) |##_module.Literal.litFalse|))
 :qid |unknown.0:0|
 :skolemid |1418|
 :pattern ( (_module.Literal.litFalse_q d@@17))
)))
(assert (forall ((d@@18 T@U) ) (! (= (_module.Literal.litUndefined_q d@@18) (= (DatatypeCtorId d@@18) |##_module.Literal.litUndefined|))
 :qid |unknown.0:0|
 :skolemid |1420|
 :pattern ( (_module.Literal.litUndefined_q d@@18))
)))
(assert (forall ((d@@19 T@U) ) (! (= (_module.Literal.litNull_q d@@19) (= (DatatypeCtorId d@@19) |##_module.Literal.litNull|))
 :qid |unknown.0:0|
 :skolemid |1422|
 :pattern ( (_module.Literal.litNull_q d@@19))
)))
(assert (forall ((d@@20 T@U) ) (! (= (_module.Literal.litNumber_q d@@20) (= (DatatypeCtorId d@@20) |##_module.Literal.litNumber|))
 :qid |unknown.0:0|
 :skolemid |1425|
 :pattern ( (_module.Literal.litNumber_q d@@20))
)))
(assert (forall ((d@@21 T@U) ) (! (= (_module.Literal.litString_q d@@21) (= (DatatypeCtorId d@@21) |##_module.Literal.litString|))
 :qid |unknown.0:0|
 :skolemid |1433|
 :pattern ( (_module.Literal.litString_q d@@21))
)))
(assert (forall ((d@@22 T@U) ) (! (= (_module.Literal.litPrimitive_q d@@22) (= (DatatypeCtorId d@@22) |##_module.Literal.litPrimitive|))
 :qid |unknown.0:0|
 :skolemid |1443|
 :pattern ( (_module.Literal.litPrimitive_q d@@22))
)))
(assert (forall ((d@@23 T@U) ) (! (= (_module.Literal.litArrOfPaths_q d@@23) (= (DatatypeCtorId d@@23) |##_module.Literal.litArrOfPaths|))
 :qid |unknown.0:0|
 :skolemid |1452|
 :pattern ( (_module.Literal.litArrOfPaths_q d@@23))
)))
(assert (forall ((d@@24 T@U) ) (! (= (_module.Literal.litArrOfStrings_q d@@24) (= (DatatypeCtorId d@@24) |##_module.Literal.litArrOfStrings|))
 :qid |unknown.0:0|
 :skolemid |1461|
 :pattern ( (_module.Literal.litArrOfStrings_q d@@24))
)))
(assert (forall ((d@@25 T@U) ) (! (= (_module.Literal.litArray_q d@@25) (= (DatatypeCtorId d@@25) |##_module.Literal.litArray|))
 :qid |unknown.0:0|
 :skolemid |1470|
 :pattern ( (_module.Literal.litArray_q d@@25))
)))
(assert (forall ((d@@26 T@U) ) (! (= (_module.Primitive.primCreatePath_q d@@26) (= (DatatypeCtorId d@@26) |##_module.Primitive.primCreatePath|))
 :qid |unknown.0:0|
 :skolemid |1493|
 :pattern ( (_module.Primitive.primCreatePath_q d@@26))
)))
(assert (forall ((d@@27 T@U) ) (! (= (_module.Primitive.primExec_q d@@27) (= (DatatypeCtorId d@@27) |##_module.Primitive.primExec|))
 :qid |unknown.0:0|
 :skolemid |1495|
 :pattern ( (_module.Primitive.primExec_q d@@27))
)))
(assert (forall ((d@@28 T@U) ) (! (= (_module.Tuple.Pair_q d@@28) (= (DatatypeCtorId d@@28) |##_module.Tuple.Pair|))
 :qid |unknown.0:0|
 :skolemid |1539|
 :pattern ( (_module.Tuple.Pair_q d@@28))
)))
(assert (forall ((d@@29 T@U) ) (! (= (_module.Triple.Trio_q d@@29) (= (DatatypeCtorId d@@29) |##_module.Triple.Trio|))
 :qid |unknown.0:0|
 :skolemid |1558|
 :pattern ( (_module.Triple.Trio_q d@@29))
)))
...
(assert (forall ((d@@30 T@U) ) (!  (=> (_module.Expression.exprIf_q d@@30) (exists ((|a#38#0#0| T@U) (|a#38#1#0| T@U) (|a#38#2#0| T@U) ) (! (= d@@30 (|#_module.Expression.exprIf| |a#38#0#0| |a#38#1#0| |a#38#2#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.320:30|
 :skolemid |1345|
)))
 :qid |unknown.0:0|
 :skolemid |1346|
 :pattern ( (_module.Expression.exprIf_q d@@30))
)))
(assert (forall ((d@@31 T@U) ) (!  (=> (_module.Triple.Trio_q d@@31) (exists ((|a#170#0#0| T@U) (|a#170#1#0| T@U) (|a#170#2#0| T@U) ) (! (= d@@31 (|#_module.Triple.Trio| |a#170#0#0| |a#170#1#0| |a#170#2#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.345:33|
 :skolemid |1559|
)))
 :qid |unknown.0:0|
 :skolemid |1560|
 :pattern ( (_module.Triple.Trio_q d@@31))
)))
...
(assert (forall ((d@@32 T@U) ) (!  (=> (_module.StateC.S_q d@@32) (exists ((|a#1#0#0| T@U) (|a#1#1#0| T@U) ) (! (= d@@32 (|#_module.StateC.S| |a#1#0#0| |a#1#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.32:21|
 :skolemid |1271|
)))
 :qid |unknown.0:0|
 :skolemid |1272|
 :pattern ( (_module.StateC.S_q d@@32))
)))
(assert (forall ((d@@33 T@U) ) (!  (=> (_module.Statement.stmtVariable_q d@@33) (exists ((|a#14#0#0| T@U) (|a#14#1#0| T@U) ) (! (= d@@33 (|#_module.Statement.stmtVariable| |a#14#0#0| |a#14#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.316:35|
 :skolemid |1301|
)))
 :qid |unknown.0:0|
 :skolemid |1302|
 :pattern ( (_module.Statement.stmtVariable_q d@@33))
)))
...
(assert (forall ((d@@44 T@U) ) (!  (=> (|$IsA#_module.Literal| d@@44) (or (or (or (or (or (or (or (or (or (_module.Literal.litTrue_q d@@44) (_module.Literal.litFalse_q d@@44)) (_module.Literal.litUndefined_q d@@44)) (_module.Literal.litNull_q d@@44)) (_module.Literal.litNumber_q d@@44)) (_module.Literal.litString_q d@@44)) (_module.Literal.litPrimitive_q d@@44)) (_module.Literal.litArrOfPaths_q d@@44)) (_module.Literal.litArrOfStrings_q d@@44)) (_module.Literal.litArray_q d@@44)))
 :qid |unknown.0:0|
 :skolemid |1480|
 :pattern ( (|$IsA#_module.Literal| d@@44))
)))
...
(assert (forall ((d@@45 T@U) ) (!  (=> (_module.Program.Program_q d@@45) (exists ((|a#7#0#0| T@U) ) (! (= d@@45 (|#_module.Program.Program| |a#7#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.314:28|
 :skolemid |1286|
)))
 :qid |unknown.0:0|
 :skolemid |1287|
 :pattern ( (_module.Program.Program_q d@@45))
)))
(assert (forall ((d@@46 T@U) ) (!  (=> (_module.Statement.stmtReturn_q d@@46) (exists ((|a#21#0#0| T@U) ) (! (= d@@46 (|#_module.Statement.stmtReturn| |a#21#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.317:33|
 :skolemid |1312|
)))
 :qid |unknown.0:0|
 :skolemid |1313|
 :pattern ( (_module.Statement.stmtReturn_q d@@46))
)))
(assert (forall ((d@@47 T@U) ) (!  (=> (_module.Expression.exprLiteral_q d@@47) (exists ((|a#27#0#0| T@U) ) (! (= d@@47 (|#_module.Expression.exprLiteral| |a#27#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.319:35|
 :skolemid |1327|
)))
 :qid |unknown.0:0|
 :skolemid |1328|
 :pattern ( (_module.Expression.exprLiteral_q d@@47))
)))
(assert (forall ((d@@48 T@U) ) (!  (=> (_module.Expression.exprIdentifier_q d@@48) (exists ((|a#33#0#0| T@U) ) (! (= d@@48 (|#_module.Expression.exprIdentifier| |a#33#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.319:66|
 :skolemid |1337|
)))
 :qid |unknown.0:0|
 :skolemid |1338|
 :pattern ( (_module.Expression.exprIdentifier_q d@@48))
)))
(assert (forall ((d@@49 T@U) ) (!  (=> (_module.Expression.exprError_q d@@49) (exists ((|a#73#0#0| T@U) ) (! (= d@@49 (|#_module.Expression.exprError| |a#73#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.324:33|
 :skolemid |1397|
)))
 :qid |unknown.0:0|
 :skolemid |1398|
 :pattern ( (_module.Expression.exprError_q d@@49))
)))
(assert (forall ((d@@50 T@U) ) (!  (=> (_module.Literal.litNumber_q d@@50) (exists ((|a#95#0#0| Int) ) (! (= d@@50 (|#_module.Literal.litNumber| |a#95#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.327:30|
 :skolemid |1426|
)))
 :qid |unknown.0:0|
 :skolemid |1427|
 :pattern ( (_module.Literal.litNumber_q d@@50))
)))
(assert (forall ((d@@51 T@U) ) (!  (=> (_module.Literal.litString_q d@@51) (exists ((|a#100#0#0| T@U) ) (! (= d@@51 (|#_module.Literal.litString| |a#100#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.327:52|
 :skolemid |1434|
)))
 :qid |unknown.0:0|
 :skolemid |1435|
 :pattern ( (_module.Literal.litString_q d@@51))
)))
(assert (forall ((d@@52 T@U) ) (!  (=> (_module.Literal.litPrimitive_q d@@52) (exists ((|a#107#0#0| T@U) ) (! (= d@@52 (|#_module.Literal.litPrimitive| |a#107#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.328:33|
 :skolemid |1444|
)))
 :qid |unknown.0:0|
 :skolemid |1445|
 :pattern ( (_module.Literal.litPrimitive_q d@@52))
)))
(assert (forall ((d@@53 T@U) ) (!  (=> (_module.Literal.litArrOfPaths_q d@@53) (exists ((|a#113#0#0| T@U) ) (! (= d@@53 (|#_module.Literal.litArrOfPaths| |a#113#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.329:34|
 :skolemid |1453|
)))
 :qid |unknown.0:0|
 :skolemid |1454|
 :pattern ( (_module.Literal.litArrOfPaths_q d@@53))
)))
(assert (forall ((d@@54 T@U) ) (!  (=> (_module.Literal.litArrOfStrings_q d@@54) (exists ((|a#119#0#0| T@U) ) (! (= d@@54 (|#_module.Literal.litArrOfStrings| |a#119#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.330:36|
 :skolemid |1462|
)))
 :qid |unknown.0:0|
 :skolemid |1463|
 :pattern ( (_module.Literal.litArrOfStrings_q d@@54))
)))
(assert (forall ((d@@55 T@U) ) (!  (=> (_module.Literal.litArray_q d@@55) (exists ((|a#125#0#0| T@U) ) (! (= d@@55 (|#_module.Literal.litArray| |a#125#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.331:29|
 :skolemid |1471|
)))
 :qid |unknown.0:0|
 :skolemid |1472|
 :pattern ( (_module.Literal.litArray_q d@@55))
)))
(assert (forall ((d@@56 T@U) ) (!  (=> ($Is DatatypeTypeType d@@56 Tclass._module.Expression) (or (or (or (or (or (or (_module.Expression.exprLiteral_q d@@56) (_module.Expression.exprIdentifier_q d@@56)) (_module.Expression.exprIf_q d@@56)) (_module.Expression.exprAnd_q d@@56)) (_module.Expression.exprOr_q d@@56)) (_module.Expression.exprInvocation_q d@@56)) (_module.Expression.exprError_q d@@56)))
 :qid |unknown.0:0|
 :skolemid |1407|
 :pattern ( (_module.Expression.exprError_q d@@56) ($Is DatatypeTypeType d@@56 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprInvocation_q d@@56) ($Is DatatypeTypeType d@@56 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprOr_q d@@56) ($Is DatatypeTypeType d@@56 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprAnd_q d@@56) ($Is DatatypeTypeType d@@56 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprIf_q d@@56) ($Is DatatypeTypeType d@@56 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprIdentifier_q d@@56) ($Is DatatypeTypeType d@@56 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprLiteral_q d@@56) ($Is DatatypeTypeType d@@56 Tclass._module.Expression))
)))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall ((|prog#0| T@U) (|stC#0@@13| T@U) ) (!  (=> (or (|_module.__default.buildC#canCall| |prog#0| |stC#0@@13|) (and (< 8 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |prog#0| Tclass._module.Program) ($Is DatatypeTypeType |stC#0@@13| Tclass._module.StateC)) (_module.__default.Legal (_module.Program.stmts |prog#0|))))) ($Is DatatypeTypeType (_module.__default.buildC |prog#0| |stC#0@@13|) (Tclass._module.Tuple Tclass._module.Expression Tclass._module.StateC)))
 :qid |CloudMakeConsistentBuildslegacydfy.368:23|
 :skolemid |1088|
 :pattern ( (_module.__default.buildC |prog#0| |stC#0@@13|))
))))
...
(assert (forall (($ly@@8 T@U) (|expr#0@@2| T@U) (|args#0@@2| T@U) (|stC#0@@14| T@U) (|env#0@@6| T@U) (|args'#0| T@U) (|stsC'#0| T@U) ) (! (= (_module.__default.evalArgsC_k ($LS $ly@@8) |expr#0@@2| |args#0@@2| |stC#0@@14| |env#0@@6| |args'#0| |stsC'#0|) (_module.__default.evalArgsC_k $ly@@8 |expr#0@@2| |args#0@@2| |stC#0@@14| |env#0@@6| |args'#0| |stsC'#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.482:16|
 :skolemid |1152|
 :pattern ( (_module.__default.evalArgsC_k ($LS $ly@@8) |expr#0@@2| |args#0@@2| |stC#0@@14| |env#0@@6| |args'#0| |stsC'#0|))
)))
(assert (forall ((d@@57 T@U) ) (!  (=> ($Is DatatypeTypeType d@@57 Tclass._module.Literal) (or (or (or (or (or (or (or (or (or (_module.Literal.litTrue_q d@@57) (_module.Literal.litFalse_q d@@57)) (_module.Literal.litUndefined_q d@@57)) (_module.Literal.litNull_q d@@57)) (_module.Literal.litNumber_q d@@57)) (_module.Literal.litString_q d@@57)) (_module.Literal.litPrimitive_q d@@57)) (_module.Literal.litArrOfPaths_q d@@57)) (_module.Literal.litArrOfStrings_q d@@57)) (_module.Literal.litArray_q d@@57)))
 :qid |unknown.0:0|
 :skolemid |1481|
 :pattern ( (_module.Literal.litArray_q d@@57) ($Is DatatypeTypeType d@@57 Tclass._module.Literal))
 :pattern ( (_module.Literal.litArrOfStrings_q d@@57) ($Is DatatypeTypeType d@@57 Tclass._module.Literal))
 :pattern ( (_module.Literal.litArrOfPaths_q d@@57) ($Is DatatypeTypeType d@@57 Tclass._module.Literal))
 :pattern ( (_module.Literal.litPrimitive_q d@@57) ($Is DatatypeTypeType d@@57 Tclass._module.Literal))
 :pattern ( (_module.Literal.litString_q d@@57) ($Is DatatypeTypeType d@@57 Tclass._module.Literal))
 :pattern ( (_module.Literal.litNumber_q d@@57) ($Is DatatypeTypeType d@@57 Tclass._module.Literal))
 :pattern ( (_module.Literal.litNull_q d@@57) ($Is DatatypeTypeType d@@57 Tclass._module.Literal))
 :pattern ( (_module.Literal.litUndefined_q d@@57) ($Is DatatypeTypeType d@@57 Tclass._module.Literal))
 :pattern ( (_module.Literal.litFalse_q d@@57) ($Is DatatypeTypeType d@@57 Tclass._module.Literal))
 :pattern ( (_module.Literal.litTrue_q d@@57) ($Is DatatypeTypeType d@@57 Tclass._module.Literal))
)))
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@9 T@U) (|expr#0@@3| T@U) (|args#0@@3| T@U) (|stC#0@@15| T@U) (|env#0@@7| T@U) (|args'#0@@0| T@U) (|stsC'#0@@0| T@U) ) (!  (=> (or (|_module.__default.evalArgsC_k#canCall| (Lit DatatypeTypeType |expr#0@@3|) (Lit SeqType |args#0@@3|) (Lit DatatypeTypeType |stC#0@@15|) (Lit BoxType |env#0@@7|) (Lit SeqType |args'#0@@0|) (Lit SetType |stsC'#0@@0|)) (and (< 6 $FunctionContextHeight) (and (and (and (and (and (and ($Is DatatypeTypeType |expr#0@@3| Tclass._module.Expression) ($Is SeqType |args#0@@3| (TSeq Tclass._module.Expression))) ($Is DatatypeTypeType |stC#0@@15| Tclass._module.StateC)) ($IsBox |env#0@@7| Tclass._module.Env)) ($Is SeqType |args'#0@@0| (TSeq Tclass._module.Expression))) ($Is SetType |stsC'#0@@0| (TSet Tclass._module.StateC))) (forall ((|arg#5| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#5| Tclass._module.Expression) (=> (|Seq#Contains| |args#0@@3| ($Box DatatypeTypeType |arg#5|)) (< (DtRank |arg#5|) (DtRank |expr#0@@3|))))
 ...
 (and (|_module.__default.evalC#canCall| |arg#6| (Lit DatatypeTypeType |stC#0@@15|) (Lit BoxType |env#0@@7|)) (let ((|result#2| (_module.__default.evalC ($LS $ly@@9) |arg#6| (Lit DatatypeTypeType |stC#0@@15|) (Lit BoxType |env#0@@7|))))
...
(|_module.__default.evalArgsC_k#canCall| (Lit DatatypeTypeType |expr#0@@3|) (Lit SeqType (|Seq#Drop| (Lit SeqType |args#0@@3|) (LitInt 1))) (Lit DatatypeTypeType |stC#0@@15|) (Lit BoxType |env#0@@7|) (|Seq#Append| |args'#0@@0| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |arg'#2|))) (|Set#Union| |stsC'#0@@0| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |stC'#2|))))))))))) (= (_module.__default.evalArgsC_k ($LS $ly@@9) (Lit DatatypeTypeType |expr#0@@3|) (Lit SeqType |args#0@@3|) (Lit DatatypeTypeType |stC#0@@15|) (Lit BoxType |env#0@@7|) (Lit SeqType |args'#0@@0|) (Lit SetType |stsC'#0@@0|)) (ite (|Seq#Equal| |args#0@@3| |Seq#Empty|) (|#_module.Tuple.Pair| ($Box SeqType (Lit SeqType |args'#0@@0|)) ($Box SetType (Lit SetType |stsC'#0@@0|))) (let ((|arg#6@@0| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@3|) (LitInt 0)))))
(let ((|result#2@@0| (_module.__default.evalC ($LS $ly@@9) |arg#6@@0| (Lit DatatypeTypeType |stC#0@@15|) (Lit BoxType |env#0@@7|))))
...
(_module.__default.evalArgsC_k ($LS $ly@@9) (Lit DatatypeTypeType |expr#0@@3|) (Lit SeqType (|Seq#Drop| (Lit SeqType |args#0@@3|) (LitInt 1))) (Lit DatatypeTypeType |stC#0@@15|) (Lit BoxType |env#0@@7|) (|Seq#Append| |args'#0@@0| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |arg'#2@@0|))) (|Set#Union| |stsC'#0@@0| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |stC'#2@@0|))))))))))))
 :qid |CloudMakeConsistentBuildslegacydfy.482:16|
 :weight 3
 :skolemid |1162|
 :pattern ( (_module.__default.evalArgsC_k ($LS $ly@@9) (Lit DatatypeTypeType |expr#0@@3|) (Lit SeqType |args#0@@3|) (Lit DatatypeTypeType |stC#0@@15|) (Lit BoxType |env#0@@7|) (Lit SeqType |args'#0@@0|) (Lit SetType |stsC'#0@@0|)))
))))
...
(assert (forall ((bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 Tclass._module.Program) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@8)) bx@@8) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@8) Tclass._module.Program)))
 :qid |unknown.0:0|
 :skolemid |1087|
 :pattern ( ($IsBox bx@@8 Tclass._module.Program))
)))
(assert (forall ((bx@@9 T@U) ) (!  (=> ($IsBox bx@@9 Tclass._module.Literal) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@9)) bx@@9) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@9) Tclass._module.Literal)))
 :qid |unknown.0:0|
 :skolemid |1329|
 :pattern ( ($IsBox bx@@9 Tclass._module.Literal))
)))
(assert (forall ((bx@@10 T@U) ) (!  (=> ($IsBox bx@@10 Tclass._module.Reason) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@10)) bx@@10) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@10) Tclass._module.Reason)))
 :qid |unknown.0:0|
 :skolemid |1399|
 :pattern ( ($IsBox bx@@10 Tclass._module.Reason))
)))
...
(assert  (=> (<= 7 $FunctionContextHeight) (forall (($ly@@10 T@U) (|stmts#0@@4| T@U) (|stC#0@@16| T@U) (|env#0@@8| T@U) ) (!  (=> (or (|_module.__default.doC#canCall| (Lit SeqType |stmts#0@@4|) (Lit DatatypeTypeType |stC#0@@16|) (Lit BoxType |env#0@@8|)) (and (< 7 $FunctionContextHeight) (and (and (and ($Is SeqType |stmts#0@@4| (TSeq Tclass._module.Statement)) ($Is DatatypeTypeType |stC#0@@16| Tclass._module.StateC)) ($IsBox |env#0@@8| Tclass._module.Env)) (U_2_bool (Lit boolType (bool_2_U (_module.__default.Legal (Lit SeqType |stmts#0@@4|)))))))) (and (let ((|stmt#2| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |stmts#0@@4|) (LitInt 0)))))
 (and (=> (_module.Statement.stmtVariable_q |stmt#2|) (and (|_module.__default.evalC#canCall| (_module.Statement.expr |stmt#2|) (Lit DatatypeTypeType |stC#0@@16|) (Lit BoxType |env#0@@8|)) (let ((|result#2@@1| (_module.__default.evalC ($LS $LZ) (_module.Statement.expr |stmt#2|) (Lit DatatypeTypeType |stC#0@@16|) (Lit BoxType |env#0@@8|))))
...
(let ((|expr'#2@@0| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#2@@1|))))
 ...
 (and (|_module.__default.Legal#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@4|) (LitInt 1)))) (=> (U_2_bool (Lit boolType (bool_2_U (_module.__default.Legal (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@4|) (LitInt 1))))))) (|_module.__default.doC#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@4|) (LitInt 1))) |stC'#2@@1| |env'#2|))))))))))))) (=> (not (_module.Statement.stmtVariable_q |stmt#2|)) (|_module.__default.evalC#canCall| (_module.Statement.ret |stmt#2|) (Lit DatatypeTypeType |stC#0@@16|) (Lit BoxType |env#0@@8|))))) (= (_module.__default.doC ($LS $ly@@10) (Lit SeqType |stmts#0@@4|) (Lit DatatypeTypeType |stC#0@@16|) (Lit BoxType |env#0@@8|)) (let ((|stmt#2@@0| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |stmts#0@@4|) (LitInt 0)))))
(ite (_module.Statement.stmtVariable_q |stmt#2@@0|) (let ((|result#2@@2| (_module.__default.evalC ($LS $LZ) (_module.Statement.expr |stmt#2@@0|) (Lit DatatypeTypeType |stC#0@@16|) (Lit BoxType |env#0@@8|))))
...
(ite (_module.__default.Legal (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@4|) (LitInt 1)))) (_module.__default.doC ($LS $ly@@10) (Lit SeqType (|Seq#Drop| (Lit SeqType |stmts#0@@4|) (LitInt 1))) |stC'#2@@2| |env'#2@@0|) (|#_module.Tuple.Pair| ($Box DatatypeTypeType |expr'#2@@1|) ($Box DatatypeTypeType |stC'#2@@2|)))) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |stC#0@@16|))))))) (_module.__default.evalC ($LS $LZ) (_module.Statement.ret |stmt#2@@0|) (Lit DatatypeTypeType |stC#0@@16|) (Lit BoxType |env#0@@8|)))))))
 :qid |CloudMakeConsistentBuildslegacydfy.375:16|
 :weight 3
 :skolemid |1101|
 :pattern ( (_module.__default.doC ($LS $ly@@10) (Lit SeqType |stmts#0@@4|) (Lit DatatypeTypeType |stC#0@@16|) (Lit BoxType |env#0@@8|)))
))))
...
(assert (forall ((_module.Triple$A@@5 T@U) (_module.Triple$B@@5 T@U) (_module.Triple$C@@5 T@U) (d@@58 T@U) ) (!  (=> ($Is DatatypeTypeType d@@58 (Tclass._module.Triple _module.Triple$A@@5 _module.Triple$B@@5 _module.Triple$C@@5)) (_module.Triple.Trio_q d@@58))
 :qid |unknown.0:0|
 :skolemid |1577|
 :pattern ( (_module.Triple.Trio_q d@@58) ($Is DatatypeTypeType d@@58 (Tclass._module.Triple _module.Triple$A@@5 _module.Triple$B@@5 _module.Triple$C@@5)))
)))
...
(let ((|hashValues#0| (|Set#FromBoogieMap| (|lambda#4| (TSeq TChar) (_module.Literal.strs (_module.Expression.lit |exts#0@@6|)) |cmd#0@@7| |deps#0@@6| (_module.Literal.strs (_module.Expression.lit |exts#0@@6|)) |cmd#0@@7| |deps#0@@6|))))
 (and (= (_module.StateC.st |stC'#0@@3|) (_module.StateC.st |stC#0@@17|)) (|Set#Equal| (|Set#Union| (_module.__default.DomC (_module.StateC.c |stC#0@@17|)) |hashValues#0|) (_module.__default.DomC (_module.StateC.c |stC'#0@@3|)))))) ($Is DatatypeTypeType (_module.__default.UpdateC $ly@@11 |cmd#0@@7| |deps#0@@6| |exts#0@@6| |stC#0@@17|) Tclass._module.StateC)))
 :qid |CloudMakeConsistentBuildslegacydfy.41:16|
 :skolemid |737|
 :pattern ( (_module.__default.UpdateC $ly@@11 |cmd#0@@7| |deps#0@@6| |exts#0@@6| |stC#0@@17|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|id#0@@0| T@U) (|expr#0@@5| T@U) (|env#0@@9| T@U) ) (!  (=> (or (|_module.__default.SetEnv#canCall| |id#0@@0| |expr#0@@5| |env#0@@9|) (and (< 3 $FunctionContextHeight) (and (and (and ($IsBox |id#0@@0| Tclass._module.Identifier) ($Is DatatypeTypeType |expr#0@@5| Tclass._module.Expression)) ($IsBox |env#0@@9| Tclass._module.Env)) (_module.__default.Value |expr#0@@5|)))) ($IsBox (_module.__default.SetEnv |id#0@@0| |expr#0@@5| |env#0@@9|) Tclass._module.Env))
 :qid |CloudMakeConsistentBuildslegacydfy.172:23|
 :skolemid |896|
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@13 T@U) (|expr#0@@6| T@U) (|args#0@@4| T@U) (|stC#0@@18| T@U) (|env#0@@10| T@U) ) (!  (=> (or (|_module.__default.evalArgsC#canCall| |expr#0@@6| |args#0@@4| |stC#0@@18| |env#0@@10|) (and (< 6 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |expr#0@@6| Tclass._module.Expression) ($Is SeqType |args#0@@4| (TSeq Tclass._module.Expression))) ($Is DatatypeTypeType |stC#0@@18| Tclass._module.StateC)) ($IsBox |env#0@@10| Tclass._module.Env)) (forall ((|arg#0| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#0| Tclass._module.Expression) (=> (|Seq#Contains| |args#0@@4| ($Box DatatypeTypeType |arg#0|)) (< (DtRank |arg#0|) (DtRank |expr#0@@6|))))
 :qid |CloudMakeConsistentBuildslegacydfy.475:19|
 :skolemid |1139|
 :pattern ( (|Seq#Contains| |args#0@@4| ($Box DatatypeTypeType |arg#0|)))
))))) ($Is DatatypeTypeType (_module.__default.evalArgsC $ly@@13 |expr#0@@6| |args#0@@4| |stC#0@@18| |env#0@@10|) (Tclass._module.Tuple (TSeq Tclass._module.Expression) (TSet Tclass._module.StateC))))
 :qid |CloudMakeConsistentBuildslegacydfy.473:16|
 :skolemid |1140|
 :pattern ( (_module.__default.evalArgsC $ly@@13 |expr#0@@6| |args#0@@4| |stC#0@@18| |env#0@@10|))
))))
(assert (forall ((|a#8#0#0| T@U) ) (! (= ($Is DatatypeTypeType (|#_module.Program.Program| |a#8#0#0|) Tclass._module.Program) ($Is SeqType |a#8#0#0| (TSeq Tclass._module.Statement)))
 :qid |CloudMakeConsistentBuildslegacydfy.314:28|
 :skolemid |1288|
 :pattern ( ($Is DatatypeTypeType (|#_module.Program.Program| |a#8#0#0|) Tclass._module.Program))
)))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall ((|prog#0@@0| T@U) (|stC#0@@19| T@U) ) (!  (=> (or (|_module.__default.buildC#canCall| |prog#0@@0| |stC#0@@19|) (and (< 8 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |prog#0@@0| Tclass._module.Program) ($Is DatatypeTypeType |stC#0@@19| Tclass._module.StateC)) (_module.__default.Legal (_module.Program.stmts |prog#0@@0|))))) (and (and (and (_module.Program.Program_q |prog#0@@0|) |_module.__default.EmptyEnv#canCall|) (|_module.__default.doC#canCall| (_module.Program.stmts |prog#0@@0|) |stC#0@@19| _module.__default.EmptyEnv)) (= (_module.__default.buildC |prog#0@@0| |stC#0@@19|) (_module.__default.doC ($LS $LZ) (_module.Program.stmts |prog#0@@0|) |stC#0@@19| _module.__default.EmptyEnv))))
 :qid |CloudMakeConsistentBuildslegacydfy.368:23|
 :skolemid |1090|
 :pattern ( (_module.__default.buildC |prog#0@@0| |stC#0@@19|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|stC#0@@20| T@U) (|stC'#0@@4| T@U) ) (!  (=> (or (|_module.__default.UnionC#canCall| |stC#0@@20| |stC'#0@@4|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |stC#0@@20| Tclass._module.StateC) ($Is DatatypeTypeType |stC'#0@@4| Tclass._module.StateC)))) (and (let ((|result#0@@1| (_module.__default.UnionC |stC#0@@20| |stC'#0@@4|)))
 (and (and (and (|Set#Equal| (_module.__default.DomSt (_module.StateC.st |result#0@@1|)) (|Set#Union| (_module.__default.DomSt (_module.StateC.st |stC#0@@20|)) (_module.__default.DomSt (_module.StateC.st |stC'#0@@4|)))) (forall ((|p#0@@3| T@U) ) (!  (=> ($Is DatatypeTypeType |p#0@@3| Tclass._module.Path) (and (=> (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |result#0@@1|)) ($Box DatatypeTypeType |p#0@@3|)) (=> (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@20|)) ($Box DatatypeTypeType |p#0@@3|)) (= (_module.__default.GetSt |p#0@@3| (_module.StateC.st |result#0@@1|)) (_module.__default.GetSt |p#0@@3| (_module.StateC.st |stC#0@@20|))))) (=> (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |result#0@@1|)) ($Box DatatypeTypeType |p#0@@3|)) (=> (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC'#0@@4|)) ($Box DatatypeTypeType |p#0@@3|)) (= (_module.__default.GetSt |p#0@@3| (_module.StateC.st |result#0@@1|)) (_module.__default.GetSt |p#0@@3| (_module.StateC.st |stC'#0@@4|)))))))
 ...
 :pattern ( (_module.__default.GetSt |p#0@@3| (_module.StateC.st |stC#0@@20|)))
 :pattern ( (_module.__default.GetSt |p#0@@3| (_module.StateC.st |result#0@@1|)))
 :pattern ( (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@20|)) ($Box DatatypeTypeType |p#0@@3|)))
 :pattern ( (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |result#0@@1|)) ($Box DatatypeTypeType |p#0@@3|)))
))) (|Set#Equal| (_module.__default.DomC (_module.StateC.c |result#0@@1|)) (|Set#Union| (_module.__default.DomC (_module.StateC.c |stC#0@@20|)) (_module.__default.DomC (_module.StateC.c |stC'#0@@4|))))) (forall ((|h#0@@2| T@U) ) (!  (=> ($IsBox |h#0@@2| Tclass._module.HashValue) (and (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |result#0@@1|)) |h#0@@2|) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@20|)) |h#0@@2|) (|_module.Triple#Equal| (_module.__default.GetC |h#0@@2| (_module.StateC.c |result#0@@1|)) (_module.__default.GetC |h#0@@2| (_module.StateC.c |stC#0@@20|))))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |result#0@@1|)) |h#0@@2|) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC'#0@@4|)) |h#0@@2|) (|_module.Triple#Equal| (_module.__default.GetC |h#0@@2| (_module.StateC.c |result#0@@1|)) (_module.__default.GetC |h#0@@2| (_module.StateC.c |stC'#0@@4|)))))))
 ...
 :pattern ( (_module.__default.GetC |h#0@@2| (_module.StateC.c |stC#0@@20|)))
 :pattern ( (_module.__default.GetC |h#0@@2| (_module.StateC.c |result#0@@1|)))
 :pattern ( (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@20|)) |h#0@@2|))
 :pattern ( (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |result#0@@1|)) |h#0@@2|))
)))) ($Is DatatypeTypeType (_module.__default.UnionC |stC#0@@20| |stC'#0@@4|) Tclass._module.StateC)))
 :qid |CloudMakeConsistentBuildslegacydfy.99:23|
 :skolemid |783|
 :pattern ( (_module.__default.UnionC |stC#0@@20| |stC'#0@@4|))
))))
...
(assert (forall ((d@@59 T@U) ) (!  (=> ($Is DatatypeTypeType d@@59 Tclass._module.Statement) (or (_module.Statement.stmtVariable_q d@@59) (_module.Statement.stmtReturn_q d@@59)))
 :qid |unknown.0:0|
 :skolemid |1321|
 :pattern ( (_module.Statement.stmtReturn_q d@@59) ($Is DatatypeTypeType d@@59 Tclass._module.Statement))
 :pattern ( (_module.Statement.stmtVariable_q d@@59) ($Is DatatypeTypeType d@@59 Tclass._module.Statement))
)))
(assert (forall ((d@@60 T@U) ) (!  (=> ($Is DatatypeTypeType d@@60 Tclass._module.Primitive) (or (_module.Primitive.primCreatePath_q d@@60) (_module.Primitive.primExec_q d@@60)))
 :qid |unknown.0:0|
 :skolemid |1499|
 :pattern ( (_module.Primitive.primExec_q d@@60) ($Is DatatypeTypeType d@@60 Tclass._module.Primitive))
 :pattern ( (_module.Primitive.primCreatePath_q d@@60) ($Is DatatypeTypeType d@@60 Tclass._module.Primitive))
)))
...
(assert (forall ((v@@7 T@U) (t0@@1 T@U) (h@@1 T@U) ) (! (= ($IsAlloc SetType v@@7 (TSet t0@@1) h@@1) (forall ((bx@@13 T@U) ) (!  (=> (|Set#IsMember| v@@7 bx@@13) ($IsAllocBox bx@@13 t0@@1 h@@1))
...
(let ((|fun'#2| ($Unbox DatatypeTypeType (_module.Tuple.fst |resultFun#2|))))
 (and (|_module.__default.evalArgsC#canCall| (Lit DatatypeTypeType |expr#0@@7|) (Lit SeqType (_module.Expression.args (Lit DatatypeTypeType |expr#0@@7|))) (Lit DatatypeTypeType |stC#0@@21|) (Lit BoxType |env#0@@11|)) (let ((|resultArgs#2| (Lit DatatypeTypeType (_module.__default.evalArgsC ($LS $ly@@14) (Lit DatatypeTypeType |expr#0@@7|) (Lit SeqType (_module.Expression.args (Lit DatatypeTypeType |expr#0@@7|))) (Lit DatatypeTypeType |stC#0@@21|) (Lit BoxType |env#0@@11|)))))
...
(ite  (and (_module.Expression.exprLiteral_q |conj0'#2@@0|) (|_module.Literal#Equal| (_module.Expression.lit |conj0'#2@@0|) |#_module.Literal.litTrue|)) (_module.__default.evalC ($LS $ly@@14) (Lit DatatypeTypeType (_module.Expression.conj1 (Lit DatatypeTypeType |expr#0@@7|))) |stC'#9@@0| (Lit BoxType |env#0@@11|)) (ite  (and (_module.Expression.exprLiteral_q |conj0'#2@@0|) (|_module.Literal#Equal| (_module.Expression.lit |conj0'#2@@0|) |#_module.Literal.litFalse|)) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprLiteral| (Lit DatatypeTypeType |#_module.Literal.litFalse|)))) ($Box DatatypeTypeType |stC'#9@@0|)) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |stC#0@@21|)))))))) (ite (_module.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@7|)) (let ((|result#8@@0| (Lit DatatypeTypeType (_module.__default.evalC ($LS $ly@@14) (Lit DatatypeTypeType (_module.Expression.disj0 (Lit DatatypeTypeType |expr#0@@7|))) (Lit DatatypeTypeType |stC#0@@21|) (Lit BoxType |env#0@@11|)))))
...
(let ((|resultArgs#2@@0| (Lit DatatypeTypeType (_module.__default.evalArgsC ($LS $ly@@14) (Lit DatatypeTypeType |expr#0@@7|) (Lit SeqType (_module.Expression.args (Lit DatatypeTypeType |expr#0@@7|))) (Lit DatatypeTypeType |stC#0@@21|) (Lit BoxType |env#0@@11|)))))
...
(ite  (and (_module.Expression.exprLiteral_q |fun'#2@@0|) (_module.Literal.litPrimitive_q (Lit DatatypeTypeType (_module.Expression.lit |fun'#2@@0|)))) (ite (_module.Primitive.primExec_q (Lit DatatypeTypeType (_module.Literal.prim (Lit DatatypeTypeType (_module.Expression.lit |fun'#2@@0|))))) (ite  (and (= (|Seq#Length| |args'#2@@0|) (LitInt (_module.__default.Arity (Lit DatatypeTypeType |#_module.Primitive.primExec|)))) (_module.__default.ValidArgsC (Lit DatatypeTypeType |#_module.Primitive.primExec|) |args'#2@@0| |stCombinedC#2@@0|)) (_module.__default.execC ($Unbox DatatypeTypeType (|Seq#Index| |args'#2@@0| (LitInt 0))) ($Unbox DatatypeTypeType (|Seq#Index| |args'#2@@0| (LitInt 1))) ($Unbox DatatypeTypeType (|Seq#Index| |args'#2@@0| (LitInt 2))) |stCombinedC#2@@0|) (ite (_module.__default.ConsistentCache |stCombinedC#2@@0|) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |stC#0@@21|))) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rInconsistentCache|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |stC#0@@21|))))) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |stC#0@@21|)))) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |stC#0@@21|))))) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rCompatibility|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |stC#0@@21|))))))))))) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |stC#0@@21|))))))))))))))
 :qid |CloudMakeConsistentBuildslegacydfy.397:16|
 :weight 3
 :skolemid |1115|
 :pattern ( (_module.__default.evalC ($LS $ly@@14) (Lit DatatypeTypeType |expr#0@@7|) (Lit DatatypeTypeType |stC#0@@21|) (Lit BoxType |env#0@@11|)))
))))
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@15 T@U) (|expr#0@@8| T@U) (|stC#0@@22| T@U) (|env#0@@12| T@U) ) (!  (=> (or (|_module.__default.evalC#canCall| |expr#0@@8| |stC#0@@22| |env#0@@12|) (and (< 6 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |expr#0@@8| Tclass._module.Expression) ($Is DatatypeTypeType |stC#0@@22| Tclass._module.StateC)) ($IsBox |env#0@@12| Tclass._module.Env)))) ($Is DatatypeTypeType (_module.__default.evalC $ly@@15 |expr#0@@8| |stC#0@@22| |env#0@@12|) (Tclass._module.Tuple Tclass._module.Expression Tclass._module.StateC)))
 :qid |CloudMakeConsistentBuildslegacydfy.397:16|
 :skolemid |1111|
 :pattern ( (_module.__default.evalC $ly@@15 |expr#0@@8| |stC#0@@22| |env#0@@12|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@16 T@U) (|cmd#0@@11| T@U) (|deps#0@@10| T@U) (|exts#0@@9| T@U) (|stC#0@@23| T@U) ) (!  (=> (or (|_module.__default.UpdateC#canCall| |cmd#0@@11| |deps#0@@10| |exts#0@@9| |stC#0@@23|) (and (< 3 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |cmd#0@@11| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@10| Tclass._module.Expression)) ($Is DatatypeTypeType |exts#0@@9| Tclass._module.Expression)) ($Is DatatypeTypeType |stC#0@@23| Tclass._module.StateC)) (and (and (and (and (and (_module.Expression.exprLiteral_q |cmd#0@@11|) (_module.Literal.litString_q (_module.Expression.lit |cmd#0@@11|))) (_module.Expression.exprLiteral_q |deps#0@@10|)) (_module.Literal.litArrOfPaths_q (_module.Expression.lit |deps#0@@10|))) (_module.Expression.exprLiteral_q |exts#0@@9|)) (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#0@@9|)))))) (and (let ((|strs#0| (_module.Literal.strs (_module.Expression.lit |exts#0@@9|))))
 (=> (not (|Set#Equal| |strs#0| |Set#Empty|)) (and (|_module.__default.Choose#canCall| |strs#0|) (let ((|e#1@@2| (_module.__default.Choose |strs#0|)))
 (and (and (and (and (|_module.__default.Loc#canCall| |cmd#0@@11| |deps#0@@10| |e#1@@2|) (|_module.__default.Hash#canCall| (_module.__default.Loc |cmd#0@@11| |deps#0@@10| |e#1@@2|))) (_module.StateC.S_q |stC#0@@23|)) (|_module.__default.SetC#canCall| (_module.__default.Hash (_module.__default.Loc |cmd#0@@11| |deps#0@@10| |e#1@@2|)) (|#_module.Triple.Trio| ($Box DatatypeTypeType |cmd#0@@11|) ($Box DatatypeTypeType |deps#0@@10|) ($Box SeqType |e#1@@2|)) (_module.StateC.c |stC#0@@23|))) (let ((|c'#0| (_module.__default.SetC (_module.__default.Hash (_module.__default.Loc |cmd#0@@11| |deps#0@@10| |e#1@@2|)) (|#_module.Triple.Trio| ($Box DatatypeTypeType |cmd#0@@11|) ($Box DatatypeTypeType |deps#0@@10|) ($Box SeqType |e#1@@2|)) (_module.StateC.c |stC#0@@23|))))
(let ((|exts'#0| (|#_module.Expression.exprLiteral| (|#_module.Literal.litArrOfStrings| (|Set#Difference| |strs#0| (|Set#UnionOne| |Set#Empty| ($Box SeqType |e#1@@2|)))))))
 (and (_module.StateC.S_q |stC#0@@23|) (|_module.__default.UpdateC#canCall| |cmd#0@@11| |deps#0@@10| |exts'#0| (|#_module.StateC.S| (_module.StateC.st |stC#0@@23|) |c'#0|)))))))))) (= (_module.__default.UpdateC ($LS $ly@@16) |cmd#0@@11| |deps#0@@10| |exts#0@@9| |stC#0@@23|) (let ((|strs#0@@0| (_module.Literal.strs (_module.Expression.lit |exts#0@@9|))))
(ite (|Set#Equal| |strs#0@@0| |Set#Empty|) |stC#0@@23| (let ((|e#1@@3| (_module.__default.Choose |strs#0@@0|)))
(let ((|c'#0@@0| (_module.__default.SetC (_module.__default.Hash (_module.__default.Loc |cmd#0@@11| |deps#0@@10| |e#1@@3|)) (|#_module.Triple.Trio| ($Box DatatypeTypeType |cmd#0@@11|) ($Box DatatypeTypeType |deps#0@@10|) ($Box SeqType |e#1@@3|)) (_module.StateC.c |stC#0@@23|))))
...
(_module.__default.UpdateC $ly@@16 |cmd#0@@11| |deps#0@@10| |exts'#0@@0| (|#_module.StateC.S| (_module.StateC.st |stC#0@@23|) |c'#0@@0|))))))))))
 :qid |CloudMakeConsistentBuildslegacydfy.41:16|
 :skolemid |739|
 :pattern ( (_module.__default.UpdateC ($LS $ly@@16) |cmd#0@@11| |deps#0@@10| |exts#0@@9| |stC#0@@23|))
))))
...
(assert (forall ((|a#6#0#0| T@U) ) (! (= (DatatypeCtorId (|#_module.Program.Program| |a#6#0#0|)) |##_module.Program.Program|)
 :qid |CloudMakeConsistentBuildslegacydfy.314:28|
 :skolemid |1284|
 :pattern ( (|#_module.Program.Program| |a#6#0#0|))
)))
(assert (forall ((|a#10#0#0| T@U) ) (! (= (_module.Program.stmts (|#_module.Program.Program| |a#10#0#0|)) |a#10#0#0|)
 :qid |CloudMakeConsistentBuildslegacydfy.314:28|
 :skolemid |1291|
 :pattern ( (|#_module.Program.Program| |a#10#0#0|))
)))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@18 T@U) (|expr#0@@9| T@U) (|args#0@@5| T@U) (|stC#0@@24| T@U) (|env#0@@13| T@U) (|args'#0@@1| T@U) (|stsC'#0@@1| T@U) ) (!  (=> (or (|_module.__default.evalArgsC_k#canCall| (Lit DatatypeTypeType |expr#0@@9|) (Lit SeqType |args#0@@5|) |stC#0@@24| |env#0@@13| |args'#0@@1| |stsC'#0@@1|) (and (< 6 $FunctionContextHeight) (and (and (and (and (and (and ($Is DatatypeTypeType |expr#0@@9| Tclass._module.Expression) ($Is SeqType |args#0@@5| (TSeq Tclass._module.Expression))) ($Is DatatypeTypeType |stC#0@@24| Tclass._module.StateC)) ($IsBox |env#0@@13| Tclass._module.Env)) ($Is SeqType |args'#0@@1| (TSeq Tclass._module.Expression))) ($Is SetType |stsC'#0@@1| (TSet Tclass._module.StateC))) (forall ((|arg#3| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#3| Tclass._module.Expression) (=> (|Seq#Contains| |args#0@@5| ($Box DatatypeTypeType |arg#3|)) (< (DtRank |arg#3|) (DtRank |expr#0@@9|))))
 :qid |CloudMakeConsistentBuildslegacydfy.485:19|
 :skolemid |1159|
 ...
 (and (|_module.__default.evalC#canCall| |arg#4| |stC#0@@24| |env#0@@13|) (let ((|result#1@@3| (_module.__default.evalC ($LS $ly@@18) |arg#4| |stC#0@@24| |env#0@@13|)))
...
(|_module.__default.evalArgsC_k#canCall| (Lit DatatypeTypeType |expr#0@@9|) (Lit SeqType (|Seq#Drop| (Lit SeqType |args#0@@5|) (LitInt 1))) |stC#0@@24| |env#0@@13| (|Seq#Append| |args'#0@@1| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |arg'#1|))) (|Set#Union| |stsC'#0@@1| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |stC'#1@@4|))))))))))) (= (_module.__default.evalArgsC_k ($LS $ly@@18) (Lit DatatypeTypeType |expr#0@@9|) (Lit SeqType |args#0@@5|) |stC#0@@24| |env#0@@13| |args'#0@@1| |stsC'#0@@1|) (ite (|Seq#Equal| |args#0@@5| |Seq#Empty|) (|#_module.Tuple.Pair| ($Box SeqType |args'#0@@1|) ($Box SetType |stsC'#0@@1|)) (let ((|arg#4@@0| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@5|) (LitInt 0)))))
(let ((|result#1@@4| (_module.__default.evalC ($LS $ly@@18) |arg#4@@0| |stC#0@@24| |env#0@@13|)))
...
(_module.__default.evalArgsC_k ($LS $ly@@18) (Lit DatatypeTypeType |expr#0@@9|) (Lit SeqType (|Seq#Drop| (Lit SeqType |args#0@@5|) (LitInt 1))) |stC#0@@24| |env#0@@13| (|Seq#Append| |args'#0@@1| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |arg'#1@@0|))) (|Set#Union| |stsC'#0@@1| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |stC'#1@@5|))))))))))))
 :qid |CloudMakeConsistentBuildslegacydfy.482:16|
 :weight 3
 :skolemid |1160|
 :pattern ( (_module.__default.evalArgsC_k ($LS $ly@@18) (Lit DatatypeTypeType |expr#0@@9|) (Lit SeqType |args#0@@5|) |stC#0@@24| |env#0@@13| |args'#0@@1| |stsC'#0@@1|))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@19 T@U) (|expr#0@@10| T@U) (|args#0@@6| T@U) (|stC#0@@25| T@U) (|env#0@@14| T@U) ) (!  (=> (or (|_module.__default.evalArgsC#canCall| (Lit DatatypeTypeType |expr#0@@10|) (Lit SeqType |args#0@@6|) (Lit DatatypeTypeType |stC#0@@25|) (Lit BoxType |env#0@@14|)) (and (< 6 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |expr#0@@10| Tclass._module.Expression) ($Is SeqType |args#0@@6| (TSeq Tclass._module.Expression))) ($Is DatatypeTypeType |stC#0@@25| Tclass._module.StateC)) ($IsBox |env#0@@14| Tclass._module.Env)) (forall ((|arg#3@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#3@@0| Tclass._module.Expression) (=> (|Seq#Contains| |args#0@@6| ($Box DatatypeTypeType |arg#3@@0|)) (< (DtRank |arg#3@@0|) (DtRank |expr#0@@10|))))
 :qid |CloudMakeConsistentBuildslegacydfy.475:19|
 :skolemid |1146|
 :pattern ( (|Seq#Contains| |args#0@@6| ($Box DatatypeTypeType |arg#3@@0|)))
))))) (and (|_module.__default.evalArgsC_k#canCall| (Lit DatatypeTypeType |expr#0@@10|) (Lit SeqType |args#0@@6|) (Lit DatatypeTypeType |stC#0@@25|) (Lit BoxType |env#0@@14|) (Lit SeqType |Seq#Empty|) (Lit SetType |Set#Empty|)) (= (_module.__default.evalArgsC ($LS $ly@@19) (Lit DatatypeTypeType |expr#0@@10|) (Lit SeqType |args#0@@6|) (Lit DatatypeTypeType |stC#0@@25|) (Lit BoxType |env#0@@14|)) (Lit DatatypeTypeType (_module.__default.evalArgsC_k ($LS $ly@@19) (Lit DatatypeTypeType |expr#0@@10|) (Lit SeqType |args#0@@6|) (Lit DatatypeTypeType |stC#0@@25|) (Lit BoxType |env#0@@14|) (Lit SeqType |Seq#Empty|) (Lit SetType |Set#Empty|))))))
 :qid |CloudMakeConsistentBuildslegacydfy.473:16|
 :weight 3
 :skolemid |1147|
 :pattern ( (_module.__default.evalArgsC ($LS $ly@@19) (Lit DatatypeTypeType |expr#0@@10|) (Lit SeqType |args#0@@6|) (Lit DatatypeTypeType |stC#0@@25|) (Lit BoxType |env#0@@14|)))
))))
...
(let ((|cmd#3| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@7|) (LitInt 0)))))
 (=> (_module.Expression.exprLiteral_q |cmd#3|) (=> (_module.Literal.litString_q (_module.Expression.lit |cmd#3|)) (=> (_module.Expression.exprLiteral_q |deps#3|) (=> (_module.Literal.litArrOfPaths_q (_module.Expression.lit |deps#3|)) (=> (_module.Expression.exprLiteral_q |exts#3|) (=> (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#3|)) (and (and (_module.StateC.S_q (Lit DatatypeTypeType |stC#0@@26|)) (|_module.__default.DomSt#canCall| (Lit BoxType (_module.StateC.st (Lit DatatypeTypeType |stC#0@@26|))))) (=> (|Set#Subset| (_module.Literal.paths (_module.Expression.lit |deps#3|)) (_module.__default.DomSt (Lit BoxType (_module.StateC.st (Lit DatatypeTypeType |stC#0@@26|))))) (|_module.__default.PreC#canCall| |cmd#3| |deps#3| |exts#3| (Lit DatatypeTypeType |stC#0@@26|)))))))))))))) (= (_module.__default.ValidArgsC (Lit DatatypeTypeType |prim#0@@3|) (Lit SeqType |args#0@@7|) (Lit DatatypeTypeType |stC#0@@26|)) (ite (_module.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@3|)) false (let ((|exts#2| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@7|) (LitInt 2)))))
...
(let ((|cmd#2| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@7|) (LitInt 0)))))
 (and (and (and (and (and (and (and (_module.Expression.exprLiteral_q |cmd#2|) (_module.Literal.litString_q (_module.Expression.lit |cmd#2|))) (_module.Expression.exprLiteral_q |deps#2|)) (_module.Literal.litArrOfPaths_q (_module.Expression.lit |deps#2|))) (_module.Expression.exprLiteral_q |exts#2|)) (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#2|))) (|Set#Subset| (_module.Literal.paths (_module.Expression.lit |deps#2|)) (_module.__default.DomSt (Lit BoxType (_module.StateC.st (Lit DatatypeTypeType |stC#0@@26|)))))) (_module.__default.PreC |cmd#2| |deps#2| |exts#2| (Lit DatatypeTypeType |stC#0@@26|))))))))))
 :qid |CloudMakeConsistentBuildslegacydfy.497:28|
 :weight 3
 :skolemid |1171|
 :pattern ( (_module.__default.ValidArgsC (Lit DatatypeTypeType |prim#0@@3|) (Lit SeqType |args#0@@7|) (Lit DatatypeTypeType |stC#0@@26|)))
))))
(assert (forall (($ly@@20 T@U) (|stmts#0@@5| T@U) (|stC#0@@27| T@U) (|env#0@@15| T@U) ) (! (= (_module.__default.doC ($LS $ly@@20) |stmts#0@@5| |stC#0@@27| |env#0@@15|) (_module.__default.doC $ly@@20 |stmts#0@@5| |stC#0@@27| |env#0@@15|))
 :qid |CloudMakeConsistentBuildslegacydfy.375:16|
 :skolemid |1095|
 :pattern ( (_module.__default.doC ($LS $ly@@20) |stmts#0@@5| |stC#0@@27| |env#0@@15|))
)))
(assert (forall (($ly@@21 T@U) (|expr#0@@11| T@U) (|stC#0@@28| T@U) (|env#0@@16| T@U) ) (! (= (_module.__default.evalC ($LS $ly@@21) |expr#0@@11| |stC#0@@28| |env#0@@16|) (_module.__default.evalC $ly@@21 |expr#0@@11| |stC#0@@28| |env#0@@16|))
 :qid |CloudMakeConsistentBuildslegacydfy.397:16|
 :skolemid |1109|
 :pattern ( (_module.__default.evalC ($LS $ly@@21) |expr#0@@11| |stC#0@@28| |env#0@@16|))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@22 T@U) (|cmd#0@@13| T@U) (|deps#0@@12| T@U) (|exts#0@@10| T@U) (|stC#0@@29| T@U) ) (!  (=> (or (|_module.__default.UpdateC#canCall| |cmd#0@@13| |deps#0@@12| (Lit DatatypeTypeType |exts#0@@10|) |stC#0@@29|) (and (< 3 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |cmd#0@@13| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@12| Tclass._module.Expression)) ($Is DatatypeTypeType |exts#0@@10| Tclass._module.Expression)) ($Is DatatypeTypeType |stC#0@@29| Tclass._module.StateC)) (and (and (and (and (and (_module.Expression.exprLiteral_q |cmd#0@@13|) (_module.Literal.litString_q (_module.Expression.lit |cmd#0@@13|))) (_module.Expression.exprLiteral_q |deps#0@@12|)) (_module.Literal.litArrOfPaths_q (_module.Expression.lit |deps#0@@12|))) (_module.Expression.exprLiteral_q (Lit DatatypeTypeType |exts#0@@10|))) (_module.Literal.litArrOfStrings_q (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@10|)))))))) (and (let ((|strs#1| (Lit SetType (_module.Literal.strs (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@10|)))))))
 (=> (not (|Set#Equal| |strs#1| |Set#Empty|)) (and (|_module.__default.Choose#canCall| |strs#1|) (let ((|e#2@@5| (_module.__default.Choose |strs#1|)))
 (and (and (and (and (|_module.__default.Loc#canCall| |cmd#0@@13| |deps#0@@12| |e#2@@5|) (|_module.__default.Hash#canCall| (_module.__default.Loc |cmd#0@@13| |deps#0@@12| |e#2@@5|))) (_module.StateC.S_q |stC#0@@29|)) (|_module.__default.SetC#canCall| (_module.__default.Hash (_module.__default.Loc |cmd#0@@13| |deps#0@@12| |e#2@@5|)) (|#_module.Triple.Trio| ($Box DatatypeTypeType |cmd#0@@13|) ($Box DatatypeTypeType |deps#0@@12|) ($Box SeqType |e#2@@5|)) (_module.StateC.c |stC#0@@29|))) (let ((|c'#1| (_module.__default.SetC (_module.__default.Hash (_module.__default.Loc |cmd#0@@13| |deps#0@@12| |e#2@@5|)) (|#_module.Triple.Trio| ($Box DatatypeTypeType |cmd#0@@13|) ($Box DatatypeTypeType |deps#0@@12|) ($Box SeqType |e#2@@5|)) (_module.StateC.c |stC#0@@29|))))
(let ((|exts'#1| (|#_module.Expression.exprLiteral| (|#_module.Literal.litArrOfStrings| (|Set#Difference| |strs#1| (|Set#UnionOne| |Set#Empty| ($Box SeqType |e#2@@5|)))))))
 (and (_module.StateC.S_q |stC#0@@29|) (|_module.__default.UpdateC#canCall| |cmd#0@@13| |deps#0@@12| |exts'#1| (|#_module.StateC.S| (_module.StateC.st |stC#0@@29|) |c'#1|)))))))))) (= (_module.__default.UpdateC ($LS $ly@@22) |cmd#0@@13| |deps#0@@12| (Lit DatatypeTypeType |exts#0@@10|) |stC#0@@29|) (let ((|strs#1@@0| (Lit SetType (_module.Literal.strs (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@10|)))))))
(ite (|Set#Equal| |strs#1@@0| |Set#Empty|) |stC#0@@29| (let ((|e#2@@6| (Lit SeqType (_module.__default.Choose |strs#1@@0|))))
(let ((|c'#1@@0| (_module.__default.SetC (_module.__default.Hash (_module.__default.Loc |cmd#0@@13| |deps#0@@12| |e#2@@6|)) (|#_module.Triple.Trio| ($Box DatatypeTypeType |cmd#0@@13|) ($Box DatatypeTypeType |deps#0@@12|) ($Box SeqType |e#2@@6|)) (_module.StateC.c |stC#0@@29|))))
...
(_module.__default.UpdateC ($LS $ly@@22) |cmd#0@@13| |deps#0@@12| |exts'#1@@0| (|#_module.StateC.S| (_module.StateC.st |stC#0@@29|) |c'#1@@0|))))))))))
 :qid |CloudMakeConsistentBuildslegacydfy.41:16|
 :weight 3
 :skolemid |740|
 :pattern ( (_module.__default.UpdateC ($LS $ly@@22) |cmd#0@@13| |deps#0@@12| (Lit DatatypeTypeType |exts#0@@10|) |stC#0@@29|))
))))
(assert (forall ((_module.Tuple$A@@4 T@U) (_module.Tuple$B@@4 T@U) (bx@@14 T@U) ) (!  (=> ($IsBox bx@@14 (Tclass._module.Tuple _module.Tuple$A@@4 _module.Tuple$B@@4)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@14)) bx@@14) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@14) (Tclass._module.Tuple _module.Tuple$A@@4 _module.Tuple$B@@4))))
 :qid |unknown.0:0|
 :skolemid |902|
 :pattern ( ($IsBox bx@@14 (Tclass._module.Tuple _module.Tuple$A@@4 _module.Tuple$B@@4)))
)))
(assert (forall ((|a#12#0#0| T@U) ) (! (< (|Seq#Rank| |a#12#0#0|) (DtRank (|#_module.Program.Program| |a#12#0#0|)))
 :qid |CloudMakeConsistentBuildslegacydfy.314:28|
 :skolemid |1293|
 :pattern ( (|#_module.Program.Program| |a#12#0#0|))
)))
...
(let ((|fun'#0| ($Unbox DatatypeTypeType (_module.Tuple.fst |resultFun#0|))))
 (and (|_module.__default.evalArgsC#canCall| |expr#0@@12| (_module.Expression.args |expr#0@@12|) |stC#0@@30| |env#0@@17|) (let ((|resultArgs#0| (_module.__default.evalArgsC $ly@@23 |expr#0@@12| (_module.Expression.args |expr#0@@12|) |stC#0@@30| |env#0@@17|)))
...
(let ((|stsC''#0| (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |stC'#3|)) |stsC'#0@@2|)))
 ...
 (=> (and (_module.Expression.exprLiteral_q |fun'#0|) (_module.Literal.litPrimitive_q (_module.Expression.lit |fun'#0|))) (=> (_module.Primitive.primExec_q (_module.Literal.prim (_module.Expression.lit |fun'#0|))) (and (and (and (|_module.__default.Arity#canCall| (Lit DatatypeTypeType |#_module.Primitive.primExec|)) (=> (= (|Seq#Length| |args'#0@@2|) (LitInt (_module.__default.Arity (Lit DatatypeTypeType |#_module.Primitive.primExec|)))) (|_module.__default.ValidArgsC#canCall| (Lit DatatypeTypeType |#_module.Primitive.primExec|) |args'#0@@2| |stCombinedC#0|))) (=> (and (= (|Seq#Length| |args'#0@@2|) (LitInt (_module.__default.Arity (Lit DatatypeTypeType |#_module.Primitive.primExec|)))) (_module.__default.ValidArgsC (Lit DatatypeTypeType |#_module.Primitive.primExec|) |args'#0@@2| |stCombinedC#0|)) (|_module.__default.execC#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |args'#0@@2| (LitInt 0))) ($Unbox DatatypeTypeType (|Seq#Index| |args'#0@@2| (LitInt 1))) ($Unbox DatatypeTypeType (|Seq#Index| |args'#0@@2| (LitInt 2))) |stCombinedC#0|))) (=> (not (and (= (|Seq#Length| |args'#0@@2|) (LitInt (_module.__default.Arity (Lit DatatypeTypeType |#_module.Primitive.primExec|)))) (_module.__default.ValidArgsC (Lit DatatypeTypeType |#_module.Primitive.primExec|) |args'#0@@2| |stCombinedC#0|))) (|_module.__default.ConsistentCache#canCall| |stCombinedC#0|))))))))))))))))))))))))))))))))))) (= (_module.__default.evalC ($LS $ly@@23) |expr#0@@12| |stC#0@@30| |env#0@@17|) (ite (_module.__default.Value |expr#0@@12|) (|#_module.Tuple.Pair| ($Box DatatypeTypeType |expr#0@@12|) ($Box DatatypeTypeType |stC#0@@30|)) (ite (_module.Expression.exprIdentifier_q |expr#0@@12|) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (_module.__default.GetEnv (_module.Expression.id |expr#0@@12|) |env#0@@17|)) ($Box DatatypeTypeType |stC#0@@30|)) (ite  (and (and (_module.Expression.exprIf_q |expr#0@@12|) (_module.Expression.exprLiteral_q (_module.Expression.cond |expr#0@@12|))) (|_module.Literal#Equal| (_module.Expression.lit (_module.Expression.cond |expr#0@@12|)) |#_module.Literal.litTrue|)) (_module.__default.evalC $ly@@23 (_module.Expression.ifTrue |expr#0@@12|) |stC#0@@30| |env#0@@17|) (ite  (and (and (_module.Expression.exprIf_q |expr#0@@12|) (_module.Expression.exprLiteral_q (_module.Expression.cond |expr#0@@12|))) (|_module.Literal#Equal| (_module.Expression.lit (_module.Expression.cond |expr#0@@12|)) |#_module.Literal.litFalse|)) (_module.__default.evalC $ly@@23 (_module.Expression.ifFalse |expr#0@@12|) |stC#0@@30| |env#0@@17|) (ite (_module.Expression.exprIf_q |expr#0@@12|) (let ((|result#0@@3| (_module.__default.evalC $ly@@23 (_module.Expression.cond |expr#0@@12|) |stC#0@@30| |env#0@@17|)))
...
(ite  (and (_module.Expression.exprLiteral_q |conj0'#0@@0|) (|_module.Literal#Equal| (_module.Expression.lit |conj0'#0@@0|) |#_module.Literal.litTrue|)) (_module.__default.evalC $ly@@23 (_module.Expression.conj1 |expr#0@@12|) |stC'#1@@7| |env#0@@17|) (ite  (and (_module.Expression.exprLiteral_q |conj0'#0@@0|) (|_module.Literal#Equal| (_module.Expression.lit |conj0'#0@@0|) |#_module.Literal.litFalse|)) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprLiteral| (Lit DatatypeTypeType |#_module.Literal.litFalse|)))) ($Box DatatypeTypeType |stC'#1@@7|)) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rValidity|)))) ($Box DatatypeTypeType |stC#0@@30|))))))) (ite (_module.Expression.exprOr_q |expr#0@@12|) (let ((|result#2@@4| (_module.__default.evalC $ly@@23 (_module.Expression.disj0 |expr#0@@12|) |stC#0@@30| |env#0@@17|)))
...
(let ((|resultArgs#0@@0| (_module.__default.evalArgsC $ly@@23 |expr#0@@12| (_module.Expression.args |expr#0@@12|) |stC#0@@30| |env#0@@17|)))
...
(ite  (and (_module.Expression.exprLiteral_q |fun'#0@@0|) (_module.Literal.litPrimitive_q (_module.Expression.lit |fun'#0@@0|))) (ite (_module.Primitive.primExec_q (_module.Literal.prim (_module.Expression.lit |fun'#0@@0|))) (ite  (and (= (|Seq#Length| |args'#0@@3|) (LitInt (_module.__default.Arity (Lit DatatypeTypeType |#_module.Primitive.primExec|)))) (_module.__default.ValidArgsC (Lit DatatypeTypeType |#_module.Primitive.primExec|) |args'#0@@3| |stCombinedC#0@@0|)) (_module.__default.execC ($Unbox DatatypeTypeType (|Seq#Index| |args'#0@@3| (LitInt 0))) ($Unbox DatatypeTypeType (|Seq#Index| |args'#0@@3| (LitInt 1))) ($Unbox DatatypeTypeType (|Seq#Index| |args'#0@@3| (LitInt 2))) |stCombinedC#0@@0|) (ite (_module.__default.ConsistentCache |stCombinedC#0@@0|) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rValidity|)))) ($Box DatatypeTypeType |stC#0@@30|)) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rInconsistentCache|)))) ($Box DatatypeTypeType |stC#0@@30|)))) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rValidity|)))) ($Box DatatypeTypeType |stC#0@@30|))) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rValidity|)))) ($Box DatatypeTypeType |stC#0@@30|)))) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rCompatibility|)))) ($Box DatatypeTypeType |stC#0@@30|)))))))))) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rValidity|)))) ($Box DatatypeTypeType |stC#0@@30|)))))))))))))
 :qid |CloudMakeConsistentBuildslegacydfy.397:16|
 :skolemid |1113|
 :pattern ( (_module.__default.evalC ($LS $ly@@23) |expr#0@@12| |stC#0@@30| |env#0@@17|))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|cmd#0@@14| T@U) (|deps#0@@13| T@U) (|exts#0@@11| T@U) (|stC#0@@31| T@U) ) (!  (=> (or (|_module.__default.execC#canCall| |cmd#0@@14| |deps#0@@13| |exts#0@@11| |stC#0@@31|) (and (< 4 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |cmd#0@@14| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@13| Tclass._module.Expression)) ($Is DatatypeTypeType |exts#0@@11| Tclass._module.Expression)) ($Is DatatypeTypeType |stC#0@@31| Tclass._module.StateC)) (and (and (and (and (and (_module.Expression.exprLiteral_q |cmd#0@@14|) (_module.Literal.litString_q (_module.Expression.lit |cmd#0@@14|))) (_module.Expression.exprLiteral_q |deps#0@@13|)) (_module.Literal.litArrOfPaths_q (_module.Expression.lit |deps#0@@13|))) (_module.Expression.exprLiteral_q |exts#0@@11|)) (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#0@@11|)))))) (and (and (and (forall ((|e#0@@4| T@U) ) (!  (=> ($Is SeqType |e#0@@4| (TSeq TChar)) (=> (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0@@11|)) ($Box SeqType |e#0@@4|)) (and (and (|_module.__default.Loc#canCall| |cmd#0@@14| |deps#0@@13| |e#0@@4|) (|_module.__default.Hash#canCall| (_module.__default.Loc |cmd#0@@14| |deps#0@@13| |e#0@@4|))) (and (_module.StateC.S_q |stC#0@@31|) (|_module.__default.DomC#canCall| (_module.StateC.c |stC#0@@31|))))))
 :qid |CloudMakeConsistentBuildslegacydfy.237:13|
 :skolemid |972|
...
)) (=> (forall ((|e#0@@5| T@U) ) (!  (=> (and ($Is SeqType |e#0@@5| (TSeq TChar)) (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0@@11|)) ($Box SeqType |e#0@@5|))) (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@31|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@14| |deps#0@@13| |e#0@@5|))))
 :qid |CloudMakeConsistentBuildslegacydfy.237:13|
 :skolemid |973|
...
)))) (=> (not (forall ((|e#0@@6| T@U) ) (!  (=> (and ($Is SeqType |e#0@@6| (TSeq TChar)) (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0@@11|)) ($Box SeqType |e#0@@6|))) (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@31|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@14| |deps#0@@13| |e#0@@6|))))
 :qid |CloudMakeConsistentBuildslegacydfy.237:13|
 :skolemid |973|
...
))) (and (and (_module.StateC.S_q |stC#0@@31|) (|_module.__default.exec#canCall| |cmd#0@@14| |deps#0@@13| |exts#0@@11| (_module.StateC.st |stC#0@@31|))) (let ((|result#0@@4| (_module.__default.exec |cmd#0@@14| |deps#0@@13| |exts#0@@11| (_module.StateC.st |stC#0@@31|))))
 (and (and (_module.Tuple.Pair_q |result#0@@4|) (_module.Tuple.Pair_q |result#0@@4|)) (let ((|st'#0@@0| (_module.Tuple.snd |result#0@@4|)))
 (and (_module.StateC.S_q |stC#0@@31|) (|_module.__default.UpdateC#canCall| |cmd#0@@14| |deps#0@@13| |exts#0@@11| (|#_module.StateC.S| |st'#0@@0| (_module.StateC.c |stC#0@@31|)))))))))) (= (_module.__default.execC |cmd#0@@14| |deps#0@@13| |exts#0@@11| |stC#0@@31|) (ite (forall ((|e#0@@7| T@U) ) (!  (=> (and ($Is SeqType |e#0@@7| (TSeq TChar)) (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0@@11|)) ($Box SeqType |e#0@@7|))) (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@31|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@14| |deps#0@@13| |e#0@@7|))))
 :qid |CloudMakeConsistentBuildslegacydfy.237:13|
 :skolemid |970|
...
(|#_module.Tuple.Pair| ($Box DatatypeTypeType |expr'#0@@1|) ($Box DatatypeTypeType |stC#0@@31|)))) (let ((|result#0@@5| (_module.__default.exec |cmd#0@@14| |deps#0@@13| |exts#0@@11| (_module.StateC.st |stC#0@@31|))))
(let ((|st'#0@@1| (_module.Tuple.snd |result#0@@5|)))
(let ((|expr'#1@@1| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#0@@5|))))
(let ((|stC'#0@@7| (_module.__default.UpdateC ($LS $LZ) |cmd#0@@14| |deps#0@@13| |exts#0@@11| (|#_module.StateC.S| |st'#0@@1| (_module.StateC.c |stC#0@@31|)))))
(|#_module.Tuple.Pair| ($Box DatatypeTypeType |expr'#1@@1|) ($Box DatatypeTypeType |stC'#0@@7|))))))))))
 :qid |CloudMakeConsistentBuildslegacydfy.231:22|
 :skolemid |976|
 :pattern ( (_module.__default.execC |cmd#0@@14| |deps#0@@13| |exts#0@@11| |stC#0@@31|))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@24 T@U) (|expr#0@@13| T@U) (|args#0@@8| T@U) (|stC#0@@32| T@U) (|env#0@@18| T@U) ) (!  (=> (or (|_module.__default.evalArgsC#canCall| (Lit DatatypeTypeType |expr#0@@13|) (Lit SeqType |args#0@@8|) |stC#0@@32| |env#0@@18|) (and (< 6 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |expr#0@@13| Tclass._module.Expression) ($Is SeqType |args#0@@8| (TSeq Tclass._module.Expression))) ($Is DatatypeTypeType |stC#0@@32| Tclass._module.StateC)) ($IsBox |env#0@@18| Tclass._module.Env)) (forall ((|arg#2| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#2| Tclass._module.Expression) (=> (|Seq#Contains| |args#0@@8| ($Box DatatypeTypeType |arg#2|)) (< (DtRank |arg#2|) (DtRank |expr#0@@13|))))
 :qid |CloudMakeConsistentBuildslegacydfy.475:19|
 :skolemid |1144|
 :pattern ( (|Seq#Contains| |args#0@@8| ($Box DatatypeTypeType |arg#2|)))
))))) (and (|_module.__default.evalArgsC_k#canCall| (Lit DatatypeTypeType |expr#0@@13|) (Lit SeqType |args#0@@8|) |stC#0@@32| |env#0@@18| (Lit SeqType |Seq#Empty|) (Lit SetType |Set#Empty|)) (= (_module.__default.evalArgsC ($LS $ly@@24) (Lit DatatypeTypeType |expr#0@@13|) (Lit SeqType |args#0@@8|) |stC#0@@32| |env#0@@18|) (_module.__default.evalArgsC_k ($LS $ly@@24) (Lit DatatypeTypeType |expr#0@@13|) (Lit SeqType |args#0@@8|) |stC#0@@32| |env#0@@18| (Lit SeqType |Seq#Empty|) (Lit SetType |Set#Empty|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.473:16|
 :weight 3
 :skolemid |1145|
 :pattern ( (_module.__default.evalArgsC ($LS $ly@@24) (Lit DatatypeTypeType |expr#0@@13|) (Lit SeqType |args#0@@8|) |stC#0@@32| |env#0@@18|))
))))
...
(assert (forall ((d@@61 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.Literal.litNumber_q d@@61) ($IsAlloc DatatypeTypeType d@@61 Tclass._module.Literal $h@@1))) ($IsAlloc intType (int_2_U (_module.Literal.num d@@61)) TInt $h@@1))
 :qid |unknown.0:0|
 :skolemid |1429|
 :pattern ( ($IsAlloc intType (int_2_U (_module.Literal.num d@@61)) TInt $h@@1))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|stC#0@@33| T@U) ) (!  (=> (or (|_module.__default.ConsistentCache#canCall| (Lit DatatypeTypeType |stC#0@@33|)) (and (< 3 $FunctionContextHeight) ($Is DatatypeTypeType |stC#0@@33| Tclass._module.StateC))) (and (forall ((|cmd#1@@0| T@U) (|deps#1@@0| T@U) (|e#1@@5| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#1@@0| Tclass._module.Expression) ($Is DatatypeTypeType |deps#1@@0| Tclass._module.Expression)) ($Is SeqType |e#1@@5| (TSeq TChar))) (and (and (and (|_module.__default.Loc#canCall| |cmd#1@@0| |deps#1@@0| |e#1@@5|) (|_module.__default.Hash#canCall| (_module.__default.Loc |cmd#1@@0| |deps#1@@0| |e#1@@5|))) (and (_module.StateC.S_q (Lit DatatypeTypeType |stC#0@@33|)) (|_module.__default.DomC#canCall| (Lit BoxType (_module.StateC.c (Lit DatatypeTypeType |stC#0@@33|)))))) (=> (|Set#IsMember| (_module.__default.DomC (Lit BoxType (_module.StateC.c (Lit DatatypeTypeType |stC#0@@33|)))) (_module.__default.Hash (_module.__default.Loc |cmd#1@@0| |deps#1@@0| |e#1@@5|))) (and (|_module.__default.Loc#canCall| |cmd#1@@0| |deps#1@@0| |e#1@@5|) (and (_module.StateC.S_q (Lit DatatypeTypeType |stC#0@@33|)) (|_module.__default.DomSt#canCall| (Lit BoxType (_module.StateC.st (Lit DatatypeTypeType |stC#0@@33|)))))))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |877|
 :pattern ( (_module.__default.Loc |cmd#1@@0| |deps#1@@0| |e#1@@5|))
)) (= (_module.__default.ConsistentCache (Lit DatatypeTypeType |stC#0@@33|)) (forall ((|cmd#1@@1| T@U) (|deps#1@@1| T@U) (|e#1@@6| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#1@@1| Tclass._module.Expression) ($Is DatatypeTypeType |deps#1@@1| Tclass._module.Expression)) ($Is SeqType |e#1@@6| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (Lit BoxType (_module.StateC.c (Lit DatatypeTypeType |stC#0@@33|)))) (_module.__default.Hash (_module.__default.Loc |cmd#1@@1| |deps#1@@1| |e#1@@6|))) (|Set#IsMember| (_module.__default.DomSt (Lit BoxType (_module.StateC.st (Lit DatatypeTypeType |stC#0@@33|)))) ($Box DatatypeTypeType (_module.__default.Loc |cmd#1@@1| |deps#1@@1| |e#1@@6|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |876|
 ...
 :weight 3
 :skolemid |878|
 :pattern ( (_module.__default.ConsistentCache (Lit DatatypeTypeType |stC#0@@33|)))
))))
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@25 T@U) (|expr#0@@14| T@U) (|args#0@@9| T@U) (|stC#0@@34| T@U) (|env#0@@19| T@U) (|args'#0@@4| T@U) (|stsC'#0@@4| T@U) ) (!  (=> (or (|_module.__default.evalArgsC_k#canCall| |expr#0@@14| |args#0@@9| |stC#0@@34| |env#0@@19| |args'#0@@4| |stsC'#0@@4|) (and (< 6 $FunctionContextHeight) (and (and (and (and (and (and ($Is DatatypeTypeType |expr#0@@14| Tclass._module.Expression) ($Is SeqType |args#0@@9| (TSeq Tclass._module.Expression))) ($Is DatatypeTypeType |stC#0@@34| Tclass._module.StateC)) ($IsBox |env#0@@19| Tclass._module.Env)) ($Is SeqType |args'#0@@4| (TSeq Tclass._module.Expression))) ($Is SetType |stsC'#0@@4| (TSet Tclass._module.StateC))) (forall ((|arg#0@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#0@@0| Tclass._module.Expression) (=> (|Seq#Contains| |args#0@@9| ($Box DatatypeTypeType |arg#0@@0|)) (< (DtRank |arg#0@@0|) (DtRank |expr#0@@14|))))
 :qid |CloudMakeConsistentBuildslegacydfy.485:19|
 :skolemid |1154|
 :pattern ( (|Seq#Contains| |args#0@@9| ($Box DatatypeTypeType |arg#0@@0|)))
))))) ($Is DatatypeTypeType (_module.__default.evalArgsC_k $ly@@25 |expr#0@@14| |args#0@@9| |stC#0@@34| |env#0@@19| |args'#0@@4| |stsC'#0@@4|) (Tclass._module.Tuple (TSeq Tclass._module.Expression) (TSet Tclass._module.StateC))))
 :qid |CloudMakeConsistentBuildslegacydfy.482:16|
 :skolemid |1155|
 :pattern ( (_module.__default.evalArgsC_k $ly@@25 |expr#0@@14| |args#0@@9| |stC#0@@34| |env#0@@19| |args'#0@@4| |stsC'#0@@4|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@26 T@U) (|stsC#0@@4| T@U) ) (!  (=> (or (|_module.__default.CombineC#canCall| |stsC#0@@4|) (and (< 4 $FunctionContextHeight) (and ($Is SetType |stsC#0@@4| (TSet Tclass._module.StateC)) (not (|Set#Equal| |stsC#0@@4| |Set#Empty|))))) (and (let ((|stCombinedC#0@@1| (_module.__default.CombineC $ly@@26 |stsC#0@@4|)))
 (and (and (and (and (and (forall ((|stC#0@@35| T@U) ) (!  (=> ($Is DatatypeTypeType |stC#0@@35| Tclass._module.StateC) (=> (|Set#IsMember| |stsC#0@@4| ($Box DatatypeTypeType |stC#0@@35|)) (|Set#Subset| (_module.__default.DomSt (_module.StateC.st |stC#0@@35|)) (_module.__default.DomSt (_module.StateC.st |stCombinedC#0@@1|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.124:13|
 :skolemid |812|
 :pattern ( (_module.StateC.st |stC#0@@35|))
 :pattern ( (|Set#IsMember| |stsC#0@@4| ($Box DatatypeTypeType |stC#0@@35|)))
...
(assert (forall ((d@@63 T@U) (_module.Triple$A@@7 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (_module.Triple.Trio_q d@@63) (exists ((_module.Triple$B@@7 T@U) (_module.Triple$C@@7 T@U) ) (! ($IsAlloc DatatypeTypeType d@@63 (Tclass._module.Triple _module.Triple$A@@7 _module.Triple$B@@7 _module.Triple$C@@7) $h@@2)
 :qid |unknown.0:0|
 :skolemid |1563|
 :pattern ( ($IsAlloc DatatypeTypeType d@@63 (Tclass._module.Triple _module.Triple$A@@7 _module.Triple$B@@7 _module.Triple$C@@7) $h@@2))
)))) ($IsAllocBox (_module.Triple.fst d@@63) _module.Triple$A@@7 $h@@2))
 :qid |unknown.0:0|
 :skolemid |1564|
 :pattern ( ($IsAllocBox (_module.Triple.fst d@@63) _module.Triple$A@@7 $h@@2))
)))
(assert (forall ((d@@64 T@U) (_module.Triple$B@@8 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (_module.Triple.Trio_q d@@64) (exists ((_module.Triple$A@@8 T@U) (_module.Triple$C@@8 T@U) ) (! ($IsAlloc DatatypeTypeType d@@64 (Tclass._module.Triple _module.Triple$A@@8 _module.Triple$B@@8 _module.Triple$C@@8) $h@@3)
 :qid |unknown.0:0|
 :skolemid |1565|
 :pattern ( ($IsAlloc DatatypeTypeType d@@64 (Tclass._module.Triple _module.Triple$A@@8 _module.Triple$B@@8 _module.Triple$C@@8) $h@@3))
)))) ($IsAllocBox (_module.Triple.snd d@@64) _module.Triple$B@@8 $h@@3))
 :qid |unknown.0:0|
 :skolemid |1566|
 :pattern ( ($IsAllocBox (_module.Triple.snd d@@64) _module.Triple$B@@8 $h@@3))
)))
(assert (forall ((d@@65 T@U) (_module.Triple$C@@9 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (_module.Triple.Trio_q d@@65) (exists ((_module.Triple$A@@9 T@U) (_module.Triple$B@@9 T@U) ) (! ($IsAlloc DatatypeTypeType d@@65 (Tclass._module.Triple _module.Triple$A@@9 _module.Triple$B@@9 _module.Triple$C@@9) $h@@4)
 :qid |unknown.0:0|
 :skolemid |1567|
 :pattern ( ($IsAlloc DatatypeTypeType d@@65 (Tclass._module.Triple _module.Triple$A@@9 _module.Triple$B@@9 _module.Triple$C@@9) $h@@4))
)))) ($IsAllocBox (_module.Triple.trd d@@65) _module.Triple$C@@9 $h@@4))
 :qid |unknown.0:0|
 :skolemid |1568|
 :pattern ( ($IsAllocBox (_module.Triple.trd d@@65) _module.Triple$C@@9 $h@@4))
)))
(assert (forall ((d@@66 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) ($Is DatatypeTypeType d@@66 Tclass._module.StateC)) ($IsAlloc DatatypeTypeType d@@66 Tclass._module.StateC $h@@5))
 :qid |unknown.0:0|
 :skolemid |1279|
 :pattern ( ($IsAlloc DatatypeTypeType d@@66 Tclass._module.StateC $h@@5))
)))
(assert (forall ((d@@67 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) ($Is DatatypeTypeType d@@67 Tclass._module.Program)) ($IsAlloc DatatypeTypeType d@@67 Tclass._module.Program $h@@6))
 :qid |unknown.0:0|
 :skolemid |1294|
 :pattern ( ($IsAlloc DatatypeTypeType d@@67 Tclass._module.Program $h@@6))
)))
(assert (forall ((d@@68 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) ($Is DatatypeTypeType d@@68 Tclass._module.Statement)) ($IsAlloc DatatypeTypeType d@@68 Tclass._module.Statement $h@@7))
 :qid |unknown.0:0|
 :skolemid |1319|
 :pattern ( ($IsAlloc DatatypeTypeType d@@68 Tclass._module.Statement $h@@7))
)))
(assert (forall ((d@@69 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) ($Is DatatypeTypeType d@@69 Tclass._module.Expression)) ($IsAlloc DatatypeTypeType d@@69 Tclass._module.Expression $h@@8))
 :qid |unknown.0:0|
 :skolemid |1405|
 :pattern ( ($IsAlloc DatatypeTypeType d@@69 Tclass._module.Expression $h@@8))
)))
(assert (forall ((d@@70 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) ($Is DatatypeTypeType d@@70 Tclass._module.Literal)) ($IsAlloc DatatypeTypeType d@@70 Tclass._module.Literal $h@@9))
 :qid |unknown.0:0|
 :skolemid |1479|
 :pattern ( ($IsAlloc DatatypeTypeType d@@70 Tclass._module.Literal $h@@9))
)))
(assert (forall ((d@@71 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) ($Is DatatypeTypeType d@@71 Tclass._module.Primitive)) ($IsAlloc DatatypeTypeType d@@71 Tclass._module.Primitive $h@@10))
 :qid |unknown.0:0|
 :skolemid |1497|
 :pattern ( ($IsAlloc DatatypeTypeType d@@71 Tclass._module.Primitive $h@@10))
)))
(assert (forall ((d@@72 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) ($Is DatatypeTypeType d@@72 Tclass._module.Reason)) ($IsAlloc DatatypeTypeType d@@72 Tclass._module.Reason $h@@11))
 :qid |unknown.0:0|
 :skolemid |1509|
 :pattern ( ($IsAlloc DatatypeTypeType d@@72 Tclass._module.Reason $h@@11))
)))
(assert (forall ((d@@73 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) ($Is DatatypeTypeType d@@73 Tclass._module.Path)) ($IsAlloc DatatypeTypeType d@@73 Tclass._module.Path $h@@12))
 :qid |unknown.0:0|
 :skolemid |1532|
 :pattern ( ($IsAlloc DatatypeTypeType d@@73 Tclass._module.Path $h@@12))
)))
...
(assert (= (Tag Tclass._module.Program) Tagclass._module.Program))
(assert (= (TagFamily Tclass._module.Program) tytagFamily$Program))
...
(assert (forall ((d@@74 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (_module.Literal.litString_q d@@74) ($IsAlloc DatatypeTypeType d@@74 Tclass._module.Literal $h@@13))) ($IsAlloc SeqType (_module.Literal.str d@@74) (TSeq TChar) $h@@13))
 :qid |unknown.0:0|
 :skolemid |1437|
 :pattern ( ($IsAlloc SeqType (_module.Literal.str d@@74) (TSeq TChar) $h@@13))
)))
(assert (forall ((|a#117#0#0| T@U) (d@@75 T@U) ) (!  (=> (|Set#IsMember| |a#117#0#0| ($Box DatatypeTypeType d@@75)) (< (DtRank d@@75) (DtRank (|#_module.Literal.litArrOfPaths| |a#117#0#0|))))
 :qid |CloudMakeConsistentBuildslegacydfy.329:34|
 :skolemid |1459|
 :pattern ( (|Set#IsMember| |a#117#0#0| ($Box DatatypeTypeType d@@75)) (|#_module.Literal.litArrOfPaths| |a#117#0#0|))
)))
(assert (forall ((|a#123#0#0| T@U) (d@@76 T@U) ) (!  (=> (|Set#IsMember| |a#123#0#0| ($Box DatatypeTypeType d@@76)) (< (DtRank d@@76) (DtRank (|#_module.Literal.litArrOfStrings| |a#123#0#0|))))
 :qid |CloudMakeConsistentBuildslegacydfy.330:36|
 :skolemid |1468|
 :pattern ( (|Set#IsMember| |a#123#0#0| ($Box DatatypeTypeType d@@76)) (|#_module.Literal.litArrOfStrings| |a#123#0#0|))
)))
(assert  (=> (<= 8 $FunctionContextHeight) (forall ((|prog#0@@1| T@U) (|stC#0@@36| T@U) ) (!  (=> (or (|_module.__default.buildC#canCall| (Lit DatatypeTypeType |prog#0@@1|) (Lit DatatypeTypeType |stC#0@@36|)) (and (< 8 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |prog#0@@1| Tclass._module.Program) ($Is DatatypeTypeType |stC#0@@36| Tclass._module.StateC)) (U_2_bool (Lit boolType (bool_2_U (_module.__default.Legal (Lit SeqType (_module.Program.stmts (Lit DatatypeTypeType |prog#0@@1|)))))))))) (and (and (and (_module.Program.Program_q (Lit DatatypeTypeType |prog#0@@1|)) |_module.__default.EmptyEnv#canCall|) (|_module.__default.doC#canCall| (Lit SeqType (_module.Program.stmts (Lit DatatypeTypeType |prog#0@@1|))) (Lit DatatypeTypeType |stC#0@@36|) _module.__default.EmptyEnv)) (= (_module.__default.buildC (Lit DatatypeTypeType |prog#0@@1|) (Lit DatatypeTypeType |stC#0@@36|)) (_module.__default.doC ($LS $LZ) (Lit SeqType (_module.Program.stmts (Lit DatatypeTypeType |prog#0@@1|))) (Lit DatatypeTypeType |stC#0@@36|) _module.__default.EmptyEnv))))
 :qid |CloudMakeConsistentBuildslegacydfy.368:23|
 :weight 3
 :skolemid |1091|
 :pattern ( (_module.__default.buildC (Lit DatatypeTypeType |prog#0@@1|) (Lit DatatypeTypeType |stC#0@@36|)))
))))
...
(assert (forall ((d@@77 T@U) (_module.Tuple$A@@6 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (_module.Tuple.Pair_q d@@77) (exists ((_module.Tuple$B@@6 T@U) ) (! ($IsAlloc DatatypeTypeType d@@77 (Tclass._module.Tuple _module.Tuple$A@@6 _module.Tuple$B@@6) $h@@14)
 :qid |unknown.0:0|
 :skolemid |1544|
 :pattern ( ($IsAlloc DatatypeTypeType d@@77 (Tclass._module.Tuple _module.Tuple$A@@6 _module.Tuple$B@@6) $h@@14))
)))) ($IsAllocBox (_module.Tuple.fst d@@77) _module.Tuple$A@@6 $h@@14))
 :qid |unknown.0:0|
 :skolemid |1545|
 :pattern ( ($IsAllocBox (_module.Tuple.fst d@@77) _module.Tuple$A@@6 $h@@14))
)))
(assert (forall ((d@@78 T@U) (_module.Tuple$B@@7 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (_module.Tuple.Pair_q d@@78) (exists ((_module.Tuple$A@@7 T@U) ) (! ($IsAlloc DatatypeTypeType d@@78 (Tclass._module.Tuple _module.Tuple$A@@7 _module.Tuple$B@@7) $h@@15)
 :qid |unknown.0:0|
 :skolemid |1546|
 :pattern ( ($IsAlloc DatatypeTypeType d@@78 (Tclass._module.Tuple _module.Tuple$A@@7 _module.Tuple$B@@7) $h@@15))
)))) ($IsAllocBox (_module.Tuple.snd d@@78) _module.Tuple$B@@7 $h@@15))
 :qid |unknown.0:0|
 :skolemid |1547|
 :pattern ( ($IsAllocBox (_module.Tuple.snd d@@78) _module.Tuple$B@@7 $h@@15))
)))
...
(assert (forall ((d@@79 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (_module.StateC.S_q d@@79) ($IsAlloc DatatypeTypeType d@@79 Tclass._module.StateC $h@@16))) ($IsAllocBox (_module.StateC.st d@@79) Tclass._module.State $h@@16))
 :qid |unknown.0:0|
 :skolemid |1274|
 :pattern ( ($IsAllocBox (_module.StateC.st d@@79) Tclass._module.State $h@@16))
)))
(assert (forall ((d@@80 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (_module.StateC.S_q d@@80) ($IsAlloc DatatypeTypeType d@@80 Tclass._module.StateC $h@@17))) ($IsAllocBox (_module.StateC.c d@@80) Tclass._module.Cache $h@@17))
 :qid |unknown.0:0|
 :skolemid |1275|
 :pattern ( ($IsAllocBox (_module.StateC.c d@@80) Tclass._module.Cache $h@@17))
)))
(assert (forall ((d@@81 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (_module.Statement.stmtVariable_q d@@81) ($IsAlloc DatatypeTypeType d@@81 Tclass._module.Statement $h@@18))) ($IsAllocBox (_module.Statement.id d@@81) Tclass._module.Identifier $h@@18))
 :qid |unknown.0:0|
 :skolemid |1304|
 :pattern ( ($IsAllocBox (_module.Statement.id d@@81) Tclass._module.Identifier $h@@18))
)))
(assert (forall ((d@@82 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (_module.Statement.stmtVariable_q d@@82) ($IsAlloc DatatypeTypeType d@@82 Tclass._module.Statement $h@@19))) ($IsAlloc DatatypeTypeType (_module.Statement.expr d@@82) Tclass._module.Expression $h@@19))
 :qid |unknown.0:0|
 :skolemid |1305|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Statement.expr d@@82) Tclass._module.Expression $h@@19))
)))
(assert (forall ((d@@83 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (_module.Statement.stmtReturn_q d@@83) ($IsAlloc DatatypeTypeType d@@83 Tclass._module.Statement $h@@20))) ($IsAlloc DatatypeTypeType (_module.Statement.ret d@@83) Tclass._module.Expression $h@@20))
 :qid |unknown.0:0|
 :skolemid |1315|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Statement.ret d@@83) Tclass._module.Expression $h@@20))
)))
(assert (forall ((d@@84 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (_module.Expression.exprLiteral_q d@@84) ($IsAlloc DatatypeTypeType d@@84 Tclass._module.Expression $h@@21))) ($IsAlloc DatatypeTypeType (_module.Expression.lit d@@84) Tclass._module.Literal $h@@21))
 :qid |unknown.0:0|
 :skolemid |1331|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.lit d@@84) Tclass._module.Literal $h@@21))
)))
(assert (forall ((d@@85 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (_module.Expression.exprIdentifier_q d@@85) ($IsAlloc DatatypeTypeType d@@85 Tclass._module.Expression $h@@22))) ($IsAllocBox (_module.Expression.id d@@85) Tclass._module.Identifier $h@@22))
 :qid |unknown.0:0|
 :skolemid |1340|
 :pattern ( ($IsAllocBox (_module.Expression.id d@@85) Tclass._module.Identifier $h@@22))
)))
(assert (forall ((d@@86 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (_module.Expression.exprIf_q d@@86) ($IsAlloc DatatypeTypeType d@@86 Tclass._module.Expression $h@@23))) ($IsAlloc DatatypeTypeType (_module.Expression.cond d@@86) Tclass._module.Expression $h@@23))
 :qid |unknown.0:0|
 :skolemid |1348|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.cond d@@86) Tclass._module.Expression $h@@23))
)))
(assert (forall ((d@@87 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (_module.Expression.exprIf_q d@@87) ($IsAlloc DatatypeTypeType d@@87 Tclass._module.Expression $h@@24))) ($IsAlloc DatatypeTypeType (_module.Expression.ifTrue d@@87) Tclass._module.Expression $h@@24))
 :qid |unknown.0:0|
 :skolemid |1349|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.ifTrue d@@87) Tclass._module.Expression $h@@24))
)))
(assert (forall ((d@@88 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (_module.Expression.exprIf_q d@@88) ($IsAlloc DatatypeTypeType d@@88 Tclass._module.Expression $h@@25))) ($IsAlloc DatatypeTypeType (_module.Expression.ifFalse d@@88) Tclass._module.Expression $h@@25))
 :qid |unknown.0:0|
 :skolemid |1350|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.ifFalse d@@88) Tclass._module.Expression $h@@25))
)))
(assert (forall ((d@@89 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (_module.Expression.exprAnd_q d@@89) ($IsAlloc DatatypeTypeType d@@89 Tclass._module.Expression $h@@26))) ($IsAlloc DatatypeTypeType (_module.Expression.conj0 d@@89) Tclass._module.Expression $h@@26))
 :qid |unknown.0:0|
 :skolemid |1363|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.conj0 d@@89) Tclass._module.Expression $h@@26))
)))
(assert (forall ((d@@90 T@U) ($h@@27 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (_module.Expression.exprAnd_q d@@90) ($IsAlloc DatatypeTypeType d@@90 Tclass._module.Expression $h@@27))) ($IsAlloc DatatypeTypeType (_module.Expression.conj1 d@@90) Tclass._module.Expression $h@@27))
 :qid |unknown.0:0|
 :skolemid |1364|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.conj1 d@@90) Tclass._module.Expression $h@@27))
)))
(assert (forall ((d@@91 T@U) ($h@@28 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (_module.Expression.exprOr_q d@@91) ($IsAlloc DatatypeTypeType d@@91 Tclass._module.Expression $h@@28))) ($IsAlloc DatatypeTypeType (_module.Expression.disj0 d@@91) Tclass._module.Expression $h@@28))
 :qid |unknown.0:0|
 :skolemid |1375|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.disj0 d@@91) Tclass._module.Expression $h@@28))
)))
(assert (forall ((d@@92 T@U) ($h@@29 T@U) ) (!  (=> (and ($IsGoodHeap $h@@29) (and (_module.Expression.exprOr_q d@@92) ($IsAlloc DatatypeTypeType d@@92 Tclass._module.Expression $h@@29))) ($IsAlloc DatatypeTypeType (_module.Expression.disj1 d@@92) Tclass._module.Expression $h@@29))
 :qid |unknown.0:0|
 :skolemid |1376|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.disj1 d@@92) Tclass._module.Expression $h@@29))
)))
(assert (forall ((d@@93 T@U) ($h@@30 T@U) ) (!  (=> (and ($IsGoodHeap $h@@30) (and (_module.Expression.exprInvocation_q d@@93) ($IsAlloc DatatypeTypeType d@@93 Tclass._module.Expression $h@@30))) ($IsAlloc DatatypeTypeType (_module.Expression.fun d@@93) Tclass._module.Expression $h@@30))
 :qid |unknown.0:0|
 :skolemid |1387|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.fun d@@93) Tclass._module.Expression $h@@30))
)))
(assert (forall ((d@@94 T@U) ($h@@31 T@U) ) (!  (=> (and ($IsGoodHeap $h@@31) (and (_module.Expression.exprError_q d@@94) ($IsAlloc DatatypeTypeType d@@94 Tclass._module.Expression $h@@31))) ($IsAlloc DatatypeTypeType (_module.Expression.r d@@94) Tclass._module.Reason $h@@31))
 :qid |unknown.0:0|
 :skolemid |1401|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.r d@@94) Tclass._module.Reason $h@@31))
)))
(assert (forall ((d@@95 T@U) ($h@@32 T@U) ) (!  (=> (and ($IsGoodHeap $h@@32) (and (_module.Literal.litPrimitive_q d@@95) ($IsAlloc DatatypeTypeType d@@95 Tclass._module.Literal $h@@32))) ($IsAlloc DatatypeTypeType (_module.Literal.prim d@@95) Tclass._module.Primitive $h@@32))
 :qid |unknown.0:0|
 :skolemid |1447|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Literal.prim d@@95) Tclass._module.Primitive $h@@32))
)))
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@27 T@U) (|expr#0@@16| T@U) (|args#0@@10| T@U) (|stC#0@@37| T@U) (|env#0@@20| T@U) (|args'#0@@5| T@U) (|stsC'#0@@5| T@U) ) (!  (=> (or (|_module.__default.evalArgsC_k#canCall| |expr#0@@16| |args#0@@10| |stC#0@@37| |env#0@@20| |args'#0@@5| |stsC'#0@@5|) (and (< 6 $FunctionContextHeight) (and (and (and (and (and (and ($Is DatatypeTypeType |expr#0@@16| Tclass._module.Expression) ($Is SeqType |args#0@@10| (TSeq Tclass._module.Expression))) ($Is DatatypeTypeType |stC#0@@37| Tclass._module.StateC)) ($IsBox |env#0@@20| Tclass._module.Env)) ($Is SeqType |args'#0@@5| (TSeq Tclass._module.Expression))) ($Is SetType |stsC'#0@@5| (TSet Tclass._module.StateC))) (forall ((|arg#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#1@@0| Tclass._module.Expression) (=> (|Seq#Contains| |args#0@@10| ($Box DatatypeTypeType |arg#1@@0|)) (< (DtRank |arg#1@@0|) (DtRank |expr#0@@16|))))
 :qid |CloudMakeConsistentBuildslegacydfy.485:19|
 :skolemid |1156|
 ...
 (and (|_module.__default.evalC#canCall| |arg#2@@0| |stC#0@@37| |env#0@@20|) (let ((|result#0@@6| (_module.__default.evalC $ly@@27 |arg#2@@0| |stC#0@@37| |env#0@@20|)))
...
(|_module.__default.evalArgsC_k#canCall| |expr#0@@16| (|Seq#Drop| |args#0@@10| (LitInt 1)) |stC#0@@37| |env#0@@20| (|Seq#Append| |args'#0@@5| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |arg'#0|))) (|Set#Union| |stsC'#0@@5| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |stC'#0@@8|))))))))))) (= (_module.__default.evalArgsC_k ($LS $ly@@27) |expr#0@@16| |args#0@@10| |stC#0@@37| |env#0@@20| |args'#0@@5| |stsC'#0@@5|) (ite (|Seq#Equal| |args#0@@10| |Seq#Empty|) (|#_module.Tuple.Pair| ($Box SeqType |args'#0@@5|) ($Box SetType |stsC'#0@@5|)) (let ((|arg#2@@1| ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@10| (LitInt 0)))))
(let ((|result#0@@7| (_module.__default.evalC $ly@@27 |arg#2@@1| |stC#0@@37| |env#0@@20|)))
...
(_module.__default.evalArgsC_k $ly@@27 |expr#0@@16| (|Seq#Drop| |args#0@@10| (LitInt 1)) |stC#0@@37| |env#0@@20| (|Seq#Append| |args'#0@@5| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |arg'#0@@0|))) (|Set#Union| |stsC'#0@@5| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |stC'#0@@9|))))))))))))
 :qid |CloudMakeConsistentBuildslegacydfy.482:16|
 :skolemid |1158|
 :pattern ( (_module.__default.evalArgsC_k ($LS $ly@@27) |expr#0@@16| |args#0@@10| |stC#0@@37| |env#0@@20| |args'#0@@5| |stsC'#0@@5|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|stC#0@@38| T@U) ) (!  (=> (or (|_module.__default.ConsistentCache#canCall| |stC#0@@38|) (and (< 3 $FunctionContextHeight) ($Is DatatypeTypeType |stC#0@@38| Tclass._module.StateC))) (and (forall ((|cmd#0@@15| T@U) (|deps#0@@14| T@U) (|e#0@@8| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#0@@15| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@14| Tclass._module.Expression)) ($Is SeqType |e#0@@8| (TSeq TChar))) (and (and (and (|_module.__default.Loc#canCall| |cmd#0@@15| |deps#0@@14| |e#0@@8|) (|_module.__default.Hash#canCall| (_module.__default.Loc |cmd#0@@15| |deps#0@@14| |e#0@@8|))) (and (_module.StateC.S_q |stC#0@@38|) (|_module.__default.DomC#canCall| (_module.StateC.c |stC#0@@38|)))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@38|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@15| |deps#0@@14| |e#0@@8|))) (and (|_module.__default.Loc#canCall| |cmd#0@@15| |deps#0@@14| |e#0@@8|) (and (_module.StateC.S_q |stC#0@@38|) (|_module.__default.DomSt#canCall| (_module.StateC.st |stC#0@@38|)))))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |874|
 :pattern ( (_module.__default.Loc |cmd#0@@15| |deps#0@@14| |e#0@@8|))
)) (= (_module.__default.ConsistentCache |stC#0@@38|) (forall ((|cmd#0@@16| T@U) (|deps#0@@15| T@U) (|e#0@@9| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#0@@16| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@15| Tclass._module.Expression)) ($Is SeqType |e#0@@9| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@38|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@16| |deps#0@@15| |e#0@@9|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@38|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0@@16| |deps#0@@15| |e#0@@9|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |873|
 ...
 :qid |CloudMakeConsistentBuildslegacydfy.149:33|
 :skolemid |875|
 :pattern ( (_module.__default.ConsistentCache |stC#0@@38|))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|cmd#0@@17| T@U) (|deps#0@@16| T@U) (|exts#0@@12| T@U) (|stC#0@@39| T@U) ) (!  (=> (or (|_module.__default.PreC#canCall| (Lit DatatypeTypeType |cmd#0@@17|) (Lit DatatypeTypeType |deps#0@@16|) (Lit DatatypeTypeType |exts#0@@12|) (Lit DatatypeTypeType |stC#0@@39|)) (and (< 4 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |cmd#0@@17| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@16| Tclass._module.Expression)) ($Is DatatypeTypeType |exts#0@@12| Tclass._module.Expression)) ($Is DatatypeTypeType |stC#0@@39| Tclass._module.StateC)) (and (and (and (and (and (and (_module.Expression.exprLiteral_q (Lit DatatypeTypeType |cmd#0@@17|)) (_module.Literal.litString_q (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |cmd#0@@17|))))) (_module.Expression.exprLiteral_q (Lit DatatypeTypeType |deps#0@@16|))) (_module.Literal.litArrOfPaths_q (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |deps#0@@16|))))) (_module.Expression.exprLiteral_q (Lit DatatypeTypeType |exts#0@@12|))) (_module.Literal.litArrOfStrings_q (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@12|))))) (|Set#Subset| (_module.Literal.paths (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |deps#0@@16|)))) (_module.__default.DomSt (Lit BoxType (_module.StateC.st (Lit DatatypeTypeType |stC#0@@39|))))))))) (and (and (and (and (_module.StateC.S_q (Lit DatatypeTypeType |stC#0@@39|)) (|_module.__default.Restrict#canCall| (Lit SetType (_module.Literal.paths (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |deps#0@@16|))))) (Lit BoxType (_module.StateC.st (Lit DatatypeTypeType |stC#0@@39|))))) (|_module.__default.Pre#canCall| (Lit DatatypeTypeType |cmd#0@@17|) (Lit DatatypeTypeType |deps#0@@16|) (Lit DatatypeTypeType |exts#0@@12|) (_module.__default.Restrict (Lit SetType (_module.Literal.paths (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |deps#0@@16|))))) (Lit BoxType (_module.StateC.st (Lit DatatypeTypeType |stC#0@@39|)))))) (=> (_module.__default.Pre (Lit DatatypeTypeType |cmd#0@@17|) (Lit DatatypeTypeType |deps#0@@16|) (Lit DatatypeTypeType |exts#0@@12|) (_module.__default.Restrict (Lit SetType (_module.Literal.paths (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |deps#0@@16|))))) (Lit BoxType (_module.StateC.st (Lit DatatypeTypeType |stC#0@@39|))))) (forall ((|e#1@@7| T@U) ) (!  (=> ($Is SeqType |e#1@@7| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType (_module.Literal.strs (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@12|))))) ($Box SeqType |e#1@@7|)) (and (and (and (|_module.__default.Loc#canCall| (Lit DatatypeTypeType |cmd#0@@17|) (Lit DatatypeTypeType |deps#0@@16|) |e#1@@7|) (|_module.__default.Hash#canCall| (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@17|) (Lit DatatypeTypeType |deps#0@@16|) |e#1@@7|))) (and (_module.StateC.S_q (Lit DatatypeTypeType |stC#0@@39|)) (|_module.__default.DomC#canCall| (Lit BoxType (_module.StateC.c (Lit DatatypeTypeType |stC#0@@39|)))))) (=> (|Set#IsMember| (_module.__default.DomC (Lit BoxType (_module.StateC.c (Lit DatatypeTypeType |stC#0@@39|)))) (_module.__default.Hash (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@17|) (Lit DatatypeTypeType |deps#0@@16|) |e#1@@7|))) (|_module.__default.Loc#canCall| (Lit DatatypeTypeType |cmd#0@@17|) (Lit DatatypeTypeType |deps#0@@16|) |e#1@@7|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.291:10|
 :skolemid |1042|
...
)))) (= (_module.__default.PreC (Lit DatatypeTypeType |cmd#0@@17|) (Lit DatatypeTypeType |deps#0@@16|) (Lit DatatypeTypeType |exts#0@@12|) (Lit DatatypeTypeType |stC#0@@39|))  (and (_module.__default.Pre (Lit DatatypeTypeType |cmd#0@@17|) (Lit DatatypeTypeType |deps#0@@16|) (Lit DatatypeTypeType |exts#0@@12|) (_module.__default.Restrict (Lit SetType (_module.Literal.paths (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |deps#0@@16|))))) (Lit BoxType (_module.StateC.st (Lit DatatypeTypeType |stC#0@@39|))))) (forall ((|e#1@@8| T@U) ) (!  (=> ($Is SeqType |e#1@@8| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType (_module.Literal.strs (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@12|))))) ($Box SeqType |e#1@@8|)) (=> (|Set#IsMember| (_module.__default.DomC (Lit BoxType (_module.StateC.c (Lit DatatypeTypeType |stC#0@@39|)))) (_module.__default.Hash (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@17|) (Lit DatatypeTypeType |deps#0@@16|) |e#1@@8|))) (|Set#IsMember| (Lit SetType (_module.Literal.paths (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |deps#0@@16|))))) ($Box DatatypeTypeType (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@17|) (Lit DatatypeTypeType |deps#0@@16|) |e#1@@8|))))))
 :qid |CloudMakeConsistentBuildslegacydfy.291:10|
 :skolemid |1041|
 ...
 :weight 3
 :skolemid |1043|
 :pattern ( (_module.__default.PreC (Lit DatatypeTypeType |cmd#0@@17|) (Lit DatatypeTypeType |deps#0@@16|) (Lit DatatypeTypeType |exts#0@@12|) (Lit DatatypeTypeType |stC#0@@39|)))
))))
...
(assert (forall ((|a#9#0#0| T@U) ) (! (= (|#_module.Program.Program| (Lit SeqType |a#9#0#0|)) (Lit DatatypeTypeType (|#_module.Program.Program| |a#9#0#0|)))
 :qid |CloudMakeConsistentBuildslegacydfy.314:28|
 :skolemid |1290|
 :pattern ( (|#_module.Program.Program| (Lit SeqType |a#9#0#0|)))
)))
...
(assert (forall ((d@@96 T@U) ($h@@33 T@U) ) (!  (=> (and ($IsGoodHeap $h@@33) (and (_module.Literal.litArrOfStrings_q d@@96) ($IsAlloc DatatypeTypeType d@@96 Tclass._module.Literal $h@@33))) ($IsAlloc SetType (_module.Literal.strs d@@96) (TSet (TSeq TChar)) $h@@33))
 :qid |unknown.0:0|
 :skolemid |1465|
 :pattern ( ($IsAlloc SetType (_module.Literal.strs d@@96) (TSet (TSeq TChar)) $h@@33))
)))
...
(assert (forall ((d@@97 T@U) ($h@@34 T@U) ) (!  (=> (and ($IsGoodHeap $h@@34) (and (_module.Program.Program_q d@@97) ($IsAlloc DatatypeTypeType d@@97 Tclass._module.Program $h@@34))) ($IsAlloc SeqType (_module.Program.stmts d@@97) (TSeq Tclass._module.Statement) $h@@34))
 :qid |unknown.0:0|
 :skolemid |1289|
 :pattern ( ($IsAlloc SeqType (_module.Program.stmts d@@97) (TSeq Tclass._module.Statement) $h@@34))
)))
(assert (forall ((d@@98 T@U) ($h@@35 T@U) ) (!  (=> (and ($IsGoodHeap $h@@35) (and (_module.Expression.exprInvocation_q d@@98) ($IsAlloc DatatypeTypeType d@@98 Tclass._module.Expression $h@@35))) ($IsAlloc SeqType (_module.Expression.args d@@98) (TSeq Tclass._module.Expression) $h@@35))
 :qid |unknown.0:0|
 :skolemid |1388|
 :pattern ( ($IsAlloc SeqType (_module.Expression.args d@@98) (TSeq Tclass._module.Expression) $h@@35))
)))
(assert (forall ((d@@99 T@U) ($h@@36 T@U) ) (!  (=> (and ($IsGoodHeap $h@@36) (and (_module.Literal.litArrOfPaths_q d@@99) ($IsAlloc DatatypeTypeType d@@99 Tclass._module.Literal $h@@36))) ($IsAlloc SetType (_module.Literal.paths d@@99) (TSet Tclass._module.Path) $h@@36))
 :qid |unknown.0:0|
 :skolemid |1456|
 :pattern ( ($IsAlloc SetType (_module.Literal.paths d@@99) (TSet Tclass._module.Path) $h@@36))
)))
(assert (forall ((d@@100 T@U) ($h@@37 T@U) ) (!  (=> (and ($IsGoodHeap $h@@37) (and (_module.Literal.litArray_q d@@100) ($IsAlloc DatatypeTypeType d@@100 Tclass._module.Literal $h@@37))) ($IsAlloc SeqType (_module.Literal.arr d@@100) (TSeq Tclass._module.Expression) $h@@37))
 :qid |unknown.0:0|
 :skolemid |1474|
 :pattern ( ($IsAlloc SeqType (_module.Literal.arr d@@100) (TSeq Tclass._module.Expression) $h@@37))
)))
...
(declare-fun |prog#0@@2| () T@U)
(declare-fun |##stmts#0@0| () T@U)
(declare-fun |stC#0@@40| () T@U)
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.BuildCLemma)
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@3 alloc false)) (=> (and (and (and (and (_module.Program.Program_q |prog#0@@2|) (= |##stmts#0@0| (_module.Program.stmts |prog#0@@2|))) (and ($IsAlloc SeqType |##stmts#0@0| (TSeq Tclass._module.Statement) $Heap@@3) (|_module.__default.Legal#canCall| (_module.Program.stmts |prog#0@@2|)))) (and (and (_module.__default.Legal (_module.Program.stmts |prog#0@@2|)) ($IsAlloc DatatypeTypeType |stC#0@@40| Tclass._module.StateC $Heap@@3)) (and (|_module.__default.ConsistentCache#canCall| |stC#0@@40|) (_module.__default.ConsistentCache |stC#0@@40|)))) (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@3 $Heap@0)) (and ($IsAlloc DatatypeTypeType |prog#0@@2| Tclass._module.Program $Heap@0) ($IsAlloc DatatypeTypeType |stC#0@@40| Tclass._module.StateC $Heap@0)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (=> (|_module.__default.Legal#canCall| (_module.Program.stmts |prog#0@@2|)) (or (_module.__default.Legal (_module.Program.stmts |prog#0@@2|)) (or (not (= (|Seq#Length| (_module.Program.stmts |prog#0@@2|)) 0)) (not true))))) (=> (_module.__default.Legal (_module.Program.stmts |prog#0@@2|)) (=> (and (|_module.__default.buildC#canCall| |prog#0@@2| |stC#0@@40|) (_module.Tuple.Pair_q (_module.__default.buildC |prog#0@@2| |stC#0@@40|))) (=> (and (and (and (and (= |let#0#0#0| (_module.__default.buildC |prog#0@@2| |stC#0@@40|)) (|_module.__default.buildC#canCall| |prog#0@@2| |stC#0@@40|)) (and ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.Tuple Tclass._module.Expression Tclass._module.StateC)) (= |result#Z#0@0| |let#0#0#0|))) (and (and (_module.Tuple.Pair_q |result#Z#0@0|) (= |let#1#0#0| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#Z#0@0|)))) (and (_module.Tuple.Pair_q |result#Z#0@0|) ($Is DatatypeTypeType |let#1#0#0| Tclass._module.Expression)))) (and (and (and (= |expr'#Z#0@0| |let#1#0#0|) (_module.Tuple.Pair_q |result#Z#0@0|)) (and (= |let#1#1#0| ($Unbox DatatypeTypeType (_module.Tuple.snd |result#Z#0@0|))) (_module.Tuple.Pair_q |result#Z#0@0|))) (and (and ($Is DatatypeTypeType |let#1#1#0| Tclass._module.StateC) (= |stC'#Z#0@0| |let#1#1#0|)) (and ($IsAlloc DatatypeTypeType |stC'#Z#0@0| Tclass._module.StateC $Heap@0) (|_module.__default.ConsistentCache#canCall| |stC'#Z#0@0|))))) (and (=> (= (ControlFlow 0 7) 6) anon5_Then_correct) (=> (= (ControlFlow 0 7) 2) anon5_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and ($Is DatatypeTypeType |prog#0@@2| Tclass._module.Program) ($IsAlloc DatatypeTypeType |prog#0@@2| Tclass._module.Program $Heap@@3)) (|$IsA#_module.Program| |prog#0@@2|)) (=> (and (and (and ($Is DatatypeTypeType |stC#0@@40| Tclass._module.StateC) ($IsAlloc DatatypeTypeType |stC#0@@40| Tclass._module.StateC $Heap@@3)) (|$IsA#_module.StateC| |stC#0@@40|)) (and (= 9 $FunctionContextHeight) (= (ControlFlow 0 9) 7))) anon0_correct)))))
