...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap T@U) (|id#0| T@U) (|env#0| T@U) ) (!  (=> (or (|M3.__default.GetEnv#canCall| (Lit DatatypeTypeType |id#0|) (Lit DatatypeTypeType |env#0|)) (and (< 4 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap) ($Is DatatypeTypeType |id#0| Tclass.M3.Identifier)) ($Is DatatypeTypeType |env#0| Tclass.M3.Env)) (U_2_bool (Lit boolType (bool_2_U (M3.__default.ValidEnv (Lit DatatypeTypeType |env#0|)))))))) (and (and (and (M3.Env.EnvCons_q (Lit DatatypeTypeType |env#0|)) (=> (|Set#IsMember| (|Map#Domain| (M3.Env.m (Lit DatatypeTypeType |env#0|))) ($Box DatatypeTypeType |id#0|)) (M3.Env.EnvCons_q (Lit DatatypeTypeType |env#0|)))) (=> (not (|Set#IsMember| (|Map#Domain| (M3.Env.m (Lit DatatypeTypeType |env#0|))) ($Box DatatypeTypeType |id#0|))) |$let#24$canCall|)) (= (M3.__default.GetEnv (Lit DatatypeTypeType |id#0|) (Lit DatatypeTypeType |env#0|)) (ite (|Set#IsMember| (|Map#Domain| (M3.Env.m (Lit DatatypeTypeType |env#0|))) ($Box DatatypeTypeType |id#0|)) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType (M3.Env.m (Lit DatatypeTypeType |env#0|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |id#0|)))) (let ((|lit#1| |$let#24_lit|))
(|#M3.Expression.exprLiteral| |lit#1|))))))
 :qid |CloudMakeParallelBuildsdfy.824:18|
 :weight 3
 :skolemid |5704|
 :pattern ( (M3.__default.GetEnv (Lit DatatypeTypeType |id#0|) (Lit DatatypeTypeType |env#0|)) ($IsGoodHeap $Heap))
))))
...
(assert (forall ((a T@U) (b T@U) ) (! (= (|M3.Identifier#Equal| a b) (= a b))
 :qid |unknown.0:0|
 :skolemid |6871|
 :pattern ( (|M3.Identifier#Equal| a b))
)))
(assert (forall ((a@@0 T@U) (b@@0 T@U) ) (! (= (|M3.Env#Equal| a@@0 b@@0) (= a@@0 b@@0))
 :qid |unknown.0:0|
 :skolemid |6919|
 :pattern ( (|M3.Env#Equal| a@@0 b@@0))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|id#0@@0| T@U) (|env#0@@1| T@U) ) (!  (=> (or (|M3.__default.GetEnv#canCall| |id#0@@0| |env#0@@1|) (and (< 4 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |id#0@@0| Tclass.M3.Identifier) ($Is DatatypeTypeType |env#0@@1| Tclass.M3.Env)) (M3.__default.ValidEnv |env#0@@1|)))) (and (M3.__default.Value (M3.__default.GetEnv |id#0@@0| |env#0@@1|)) ($Is DatatypeTypeType (M3.__default.GetEnv |id#0@@0| |env#0@@1|) Tclass.M3.Expression)))
 :qid |CloudMakeParallelBuildsdfy.61:25|
 :skolemid |5700|
 :pattern ( (M3.__default.GetEnv |id#0@@0| |env#0@@1|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|env#0@@2| T@U) ) (!  (=> (or (|M3.__default.ValidEnv#canCall| |env#0@@2|) (and (< 3 $FunctionContextHeight) ($Is DatatypeTypeType |env#0@@2| Tclass.M3.Env))) (and (forall ((|id#0@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |id#0@@1| Tclass.M3.Identifier) (and (M3.Env.EnvCons_q |env#0@@2|) (=> (|Set#IsMember| (|Map#Domain| (M3.Env.m |env#0@@2|)) ($Box DatatypeTypeType |id#0@@1|)) (and (M3.Env.EnvCons_q |env#0@@2|) (|M3.__default.Value#canCall| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (M3.Env.m |env#0@@2|)) ($Box DatatypeTypeType |id#0@@1|))))))))
 :qid |CloudMakeParallelBuildsdfy.834:12|
 :skolemid |5718|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (M3.Env.m |env#0@@2|)) ($Box DatatypeTypeType |id#0@@1|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| (M3.Env.m |env#0@@2|)) ($Box DatatypeTypeType |id#0@@1|)))
)) (= (M3.__default.ValidEnv |env#0@@2|) (forall ((|id#0@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |id#0@@2| Tclass.M3.Identifier) (=> (|Set#IsMember| (|Map#Domain| (M3.Env.m |env#0@@2|)) ($Box DatatypeTypeType |id#0@@2|)) (M3.__default.Value ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (M3.Env.m |env#0@@2|)) ($Box DatatypeTypeType |id#0@@2|))))))
 :qid |CloudMakeParallelBuildsdfy.834:12|
 :skolemid |5717|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (M3.Env.m |env#0@@2|)) ($Box DatatypeTypeType |id#0@@2|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| (M3.Env.m |env#0@@2|)) ($Box DatatypeTypeType |id#0@@2|)))
)))))
 :qid |CloudMakeParallelBuildsdfy.58:28|
 :skolemid |5719|
 :pattern ( (M3.__default.ValidEnv |env#0@@2|))
))))
(assert (forall ((a@@1 T@U) (b@@1 T@U) ) (! (= (|M3.Identifier#Equal| a@@1 b@@1) (= (M3.Identifier._h12 a@@1) (M3.Identifier._h12 b@@1)))
 :qid |unknown.0:0|
 :skolemid |6870|
 :pattern ( (|M3.Identifier#Equal| a@@1 b@@1))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|id#0@@3| T@U) (|env#0@@3| T@U) ) (!  (=> (or (|M3.__default.GetEnv#canCall| |id#0@@3| |env#0@@3|) (and (< 4 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@0) ($Is DatatypeTypeType |id#0@@3| Tclass.M3.Identifier)) ($Is DatatypeTypeType |env#0@@3| Tclass.M3.Env)) (M3.__default.ValidEnv |env#0@@3|)))) (and (and (and (M3.Env.EnvCons_q |env#0@@3|) (=> (|Set#IsMember| (|Map#Domain| (M3.Env.m |env#0@@3|)) ($Box DatatypeTypeType |id#0@@3|)) (M3.Env.EnvCons_q |env#0@@3|))) (=> (not (|Set#IsMember| (|Map#Domain| (M3.Env.m |env#0@@3|)) ($Box DatatypeTypeType |id#0@@3|))) |$let#24$canCall|)) (= (M3.__default.GetEnv |id#0@@3| |env#0@@3|) (ite (|Set#IsMember| (|Map#Domain| (M3.Env.m |env#0@@3|)) ($Box DatatypeTypeType |id#0@@3|)) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (M3.Env.m |env#0@@3|)) ($Box DatatypeTypeType |id#0@@3|))) (let ((|lit#0| |$let#24_lit|))
(|#M3.Expression.exprLiteral| |lit#0|))))))
 :qid |CloudMakeParallelBuildsdfy.824:18|
 :skolemid |5703|
 :pattern ( (M3.__default.GetEnv |id#0@@3| |env#0@@3|) ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall ((a@@2 T@U) (b@@2 T@U) ) (! (= (|M3.Env#Equal| a@@2 b@@2) (|Map#Equal| (M3.Env.m a@@2) (M3.Env.m b@@2)))
 :qid |unknown.0:0|
 :skolemid |6918|
 :pattern ( (|M3.Env#Equal| a@@2 b@@2))
)))
...
(declare-fun |id#0@@4| () T@U)
(declare-fun |env#0@@4| () T@U)
(declare-fun |lit#2@0| () T@U)
(declare-fun $Heap@@1 () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$M3.__default.GetEnv)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (=> (|M3.__default.Value#canCall| (M3.__default.GetEnv |id#0@@4| |env#0@@4|)) (or (M3.__default.Value (M3.__default.GetEnv |id#0@@4| |env#0@@4|)) (M3.Expression.exprLiteral_q (M3.__default.GetEnv |id#0@@4| |env#0@@4|)))))))
(let ((anon7_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (U_2_bool (Lit boolType (bool_2_U true)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (=> (and ($Is DatatypeTypeType |lit#2@0| Tclass.M3.Literal) ($IsAlloc DatatypeTypeType |lit#2@0| Tclass.M3.Literal $Heap@@1)) (=> (and (and |$let#24$canCall| (= (M3.__default.GetEnv |id#0@@4| |env#0@@4|) (|#M3.Expression.exprLiteral| |lit#2@0|))) (and ($Is DatatypeTypeType (M3.__default.GetEnv |id#0@@4| |env#0@@4|) Tclass.M3.Expression) (= (ControlFlow 0 8) 5))) GeneratedUnifiedExit_correct))))))
(let ((anon11_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |lit#2@0| Tclass.M3.Literal) ($IsAlloc DatatypeTypeType |lit#2@0| Tclass.M3.Literal $Heap@@1))) (= (ControlFlow 0 11) 8)) anon7_correct)))
(let ((anon11_Then_correct  (=> (and (and ($Is DatatypeTypeType |lit#2@0| Tclass.M3.Literal) ($IsAlloc DatatypeTypeType |lit#2@0| Tclass.M3.Literal $Heap@@1)) (= (ControlFlow 0 10) 8)) anon7_correct)))
(let ((anon10_Else_correct  (=> (not (|Set#IsMember| (|Map#Domain| (M3.Env.m |env#0@@4|)) ($Box DatatypeTypeType |id#0@@4|))) (and (=> (= (ControlFlow 0 12) 10) anon11_Then_correct) (=> (= (ControlFlow 0 12) 11) anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (and (|Set#IsMember| (|Map#Domain| (M3.Env.m |env#0@@4|)) ($Box DatatypeTypeType |id#0@@4|)) (M3.Env.EnvCons_q |env#0@@4|)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (|Set#IsMember| (|Map#Domain| (M3.Env.m |env#0@@4|)) ($Box DatatypeTypeType |id#0@@4|))) (=> (|Set#IsMember| (|Map#Domain| (M3.Env.m |env#0@@4|)) ($Box DatatypeTypeType |id#0@@4|)) (=> (and (and (= (M3.__default.GetEnv |id#0@@4| |env#0@@4|) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (M3.Env.m |env#0@@4|)) ($Box DatatypeTypeType |id#0@@4|)))) (M3.Env.EnvCons_q |env#0@@4|)) (and ($Is DatatypeTypeType (M3.__default.GetEnv |id#0@@4| |env#0@@4|) Tclass.M3.Expression) (= (ControlFlow 0 6) 5))) GeneratedUnifiedExit_correct))))))
(let ((anon9_Else_correct  (=> (M3.Env.EnvCons_q |env#0@@4|) (and (=> (= (ControlFlow 0 13) 6) anon10_Then_correct) (=> (= (ControlFlow 0 13) 12) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> ($Is DatatypeTypeType (M3.__default.GetEnv |id#0@@4| |env#0@@4|) Tclass.M3.Expression) (=> (and ($IsAlloc DatatypeTypeType |id#0@@4| Tclass.M3.Identifier $Heap@@1) ($IsAlloc DatatypeTypeType |env#0@@4| Tclass.M3.Env $Heap@@1)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (M3.__default.ValidEnv |env#0@@4|)) (=> (and (M3.__default.ValidEnv |env#0@@4|) (= (ControlFlow 0 2) (- 0 1))) (or (and (|M3.Identifier#Equal| |id#0@@4| |id#0@@4|) (|M3.Env#Equal| |env#0@@4| |env#0@@4|)) (or (< (DtRank |id#0@@4|) (DtRank |id#0@@4|)) (and (= (DtRank |id#0@@4|) (DtRank |id#0@@4|)) (< (DtRank |env#0@@4|) (DtRank |env#0@@4|)))))))))))
(let ((anon0_correct  (=> (and (and (= $_ReadsFrame@0 (|lambda#4| null $Heap@@1 alloc false)) ($IsAlloc DatatypeTypeType |env#0@@4| Tclass.M3.Env $Heap@@1)) (and (|M3.__default.ValidEnv#canCall| |env#0@@4|) (M3.__default.ValidEnv |env#0@@4|))) (and (=> (= (ControlFlow 0 14) 2) anon9_Then_correct) (=> (= (ControlFlow 0 14) 13) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and ($Is DatatypeTypeType |id#0@@4| Tclass.M3.Identifier) ($Is DatatypeTypeType |env#0@@4| Tclass.M3.Env)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 15) 14))) anon0_correct))))
