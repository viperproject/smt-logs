...
(assert (forall ((a@@8 T@U) (b@@8 T@U) (t0@@0 T@U) (t1@@0 T@U) ) (!  (=> (forall ((bx T@U) )  (=> (|Set#IsMember| a@@8 bx) (and ($IsBox bx t0@@0) ($IsBox (MapType0Select BoxType BoxType b@@8 bx) t1@@0)))) ($Is MapType (|Map#Glue| a@@8 b@@8 (TMap t0@@0 t1@@0)) (TMap t0@@0 t1@@0)))
