...
(assert (forall ((d T@U) ) (!  (=> (|$IsA#_module.Triple| d) (_module.Triple.Trio_q d))
 :qid |unknown.0:0|
 :skolemid |1576|
 :pattern ( (|$IsA#_module.Triple| d))
)))
...
(assert (forall ((d@@2 T@U) ) (! (= (_module.StateC.S_q d@@2) (= (DatatypeCtorId d@@2) |##_module.StateC.S|))
 :qid |unknown.0:0|
 :skolemid |1270|
 :pattern ( (_module.StateC.S_q d@@2))
)))
(assert (forall ((d@@3 T@U) ) (! (= (_module.Expression.exprLiteral_q d@@3) (= (DatatypeCtorId d@@3) |##_module.Expression.exprLiteral|))
 :qid |unknown.0:0|
 :skolemid |1326|
 :pattern ( (_module.Expression.exprLiteral_q d@@3))
)))
(assert (forall ((d@@4 T@U) ) (! (= (_module.Expression.exprIdentifier_q d@@4) (= (DatatypeCtorId d@@4) |##_module.Expression.exprIdentifier|))
 :qid |unknown.0:0|
 :skolemid |1336|
 :pattern ( (_module.Expression.exprIdentifier_q d@@4))
)))
(assert (forall ((d@@5 T@U) ) (! (= (_module.Expression.exprIf_q d@@5) (= (DatatypeCtorId d@@5) |##_module.Expression.exprIf|))
 :qid |unknown.0:0|
 :skolemid |1344|
 :pattern ( (_module.Expression.exprIf_q d@@5))
)))
(assert (forall ((d@@6 T@U) ) (! (= (_module.Expression.exprAnd_q d@@6) (= (DatatypeCtorId d@@6) |##_module.Expression.exprAnd|))
 :qid |unknown.0:0|
 :skolemid |1359|
 :pattern ( (_module.Expression.exprAnd_q d@@6))
)))
(assert (forall ((d@@7 T@U) ) (! (= (_module.Expression.exprOr_q d@@7) (= (DatatypeCtorId d@@7) |##_module.Expression.exprOr|))
 :qid |unknown.0:0|
 :skolemid |1371|
 :pattern ( (_module.Expression.exprOr_q d@@7))
)))
(assert (forall ((d@@8 T@U) ) (! (= (_module.Expression.exprInvocation_q d@@8) (= (DatatypeCtorId d@@8) |##_module.Expression.exprInvocation|))
 :qid |unknown.0:0|
 :skolemid |1383|
 :pattern ( (_module.Expression.exprInvocation_q d@@8))
)))
(assert (forall ((d@@9 T@U) ) (! (= (_module.Expression.exprError_q d@@9) (= (DatatypeCtorId d@@9) |##_module.Expression.exprError|))
 :qid |unknown.0:0|
 :skolemid |1396|
 :pattern ( (_module.Expression.exprError_q d@@9))
)))
(assert (forall ((d@@10 T@U) ) (! (= (_module.Literal.litTrue_q d@@10) (= (DatatypeCtorId d@@10) |##_module.Literal.litTrue|))
 :qid |unknown.0:0|
 :skolemid |1416|
 :pattern ( (_module.Literal.litTrue_q d@@10))
)))
(assert (forall ((d@@11 T@U) ) (! (= (_module.Literal.litFalse_q d@@11) (= (DatatypeCtorId d@@11) |##_module.Literal.litFalse|))
 :qid |unknown.0:0|
 :skolemid |1418|
 :pattern ( (_module.Literal.litFalse_q d@@11))
)))
(assert (forall ((d@@12 T@U) ) (! (= (_module.Literal.litUndefined_q d@@12) (= (DatatypeCtorId d@@12) |##_module.Literal.litUndefined|))
 :qid |unknown.0:0|
 :skolemid |1420|
 :pattern ( (_module.Literal.litUndefined_q d@@12))
)))
(assert (forall ((d@@13 T@U) ) (! (= (_module.Literal.litNull_q d@@13) (= (DatatypeCtorId d@@13) |##_module.Literal.litNull|))
 :qid |unknown.0:0|
 :skolemid |1422|
 :pattern ( (_module.Literal.litNull_q d@@13))
)))
(assert (forall ((d@@14 T@U) ) (! (= (_module.Literal.litNumber_q d@@14) (= (DatatypeCtorId d@@14) |##_module.Literal.litNumber|))
 :qid |unknown.0:0|
 :skolemid |1425|
 :pattern ( (_module.Literal.litNumber_q d@@14))
)))
(assert (forall ((d@@15 T@U) ) (! (= (_module.Literal.litString_q d@@15) (= (DatatypeCtorId d@@15) |##_module.Literal.litString|))
 :qid |unknown.0:0|
 :skolemid |1433|
 :pattern ( (_module.Literal.litString_q d@@15))
)))
(assert (forall ((d@@16 T@U) ) (! (= (_module.Literal.litPrimitive_q d@@16) (= (DatatypeCtorId d@@16) |##_module.Literal.litPrimitive|))
 :qid |unknown.0:0|
 :skolemid |1443|
 :pattern ( (_module.Literal.litPrimitive_q d@@16))
)))
(assert (forall ((d@@17 T@U) ) (! (= (_module.Literal.litArrOfPaths_q d@@17) (= (DatatypeCtorId d@@17) |##_module.Literal.litArrOfPaths|))
 :qid |unknown.0:0|
 :skolemid |1452|
 :pattern ( (_module.Literal.litArrOfPaths_q d@@17))
)))
(assert (forall ((d@@18 T@U) ) (! (= (_module.Literal.litArrOfStrings_q d@@18) (= (DatatypeCtorId d@@18) |##_module.Literal.litArrOfStrings|))
 :qid |unknown.0:0|
 :skolemid |1461|
 :pattern ( (_module.Literal.litArrOfStrings_q d@@18))
)))
(assert (forall ((d@@19 T@U) ) (! (= (_module.Literal.litArray_q d@@19) (= (DatatypeCtorId d@@19) |##_module.Literal.litArray|))
 :qid |unknown.0:0|
 :skolemid |1470|
 :pattern ( (_module.Literal.litArray_q d@@19))
)))
(assert (forall ((d@@20 T@U) ) (! (= (_module.Primitive.primCreatePath_q d@@20) (= (DatatypeCtorId d@@20) |##_module.Primitive.primCreatePath|))
 :qid |unknown.0:0|
 :skolemid |1493|
 :pattern ( (_module.Primitive.primCreatePath_q d@@20))
)))
(assert (forall ((d@@21 T@U) ) (! (= (_module.Primitive.primExec_q d@@21) (= (DatatypeCtorId d@@21) |##_module.Primitive.primExec|))
 :qid |unknown.0:0|
 :skolemid |1495|
 :pattern ( (_module.Primitive.primExec_q d@@21))
)))
(assert (forall ((d@@22 T@U) ) (! (= (_module.Tuple.Pair_q d@@22) (= (DatatypeCtorId d@@22) |##_module.Tuple.Pair|))
 :qid |unknown.0:0|
 :skolemid |1539|
 :pattern ( (_module.Tuple.Pair_q d@@22))
)))
(assert (forall ((d@@23 T@U) ) (! (= (_module.Triple.Trio_q d@@23) (= (DatatypeCtorId d@@23) |##_module.Triple.Trio|))
 :qid |unknown.0:0|
 :skolemid |1558|
 :pattern ( (_module.Triple.Trio_q d@@23))
)))
...
(assert (forall ((d@@24 T@U) ) (!  (=> (_module.Expression.exprIf_q d@@24) (exists ((|a#38#0#0| T@U) (|a#38#1#0| T@U) (|a#38#2#0| T@U) ) (! (= d@@24 (|#_module.Expression.exprIf| |a#38#0#0| |a#38#1#0| |a#38#2#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.320:30|
 :skolemid |1345|
)))
 :qid |unknown.0:0|
 :skolemid |1346|
 :pattern ( (_module.Expression.exprIf_q d@@24))
)))
(assert (forall ((d@@25 T@U) ) (!  (=> (_module.Triple.Trio_q d@@25) (exists ((|a#170#0#0| T@U) (|a#170#1#0| T@U) (|a#170#2#0| T@U) ) (! (= d@@25 (|#_module.Triple.Trio| |a#170#0#0| |a#170#1#0| |a#170#2#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.345:33|
 :skolemid |1559|
)))
 :qid |unknown.0:0|
...
(assert (forall ((d@@26 T@U) ) (!  (=> (_module.StateC.S_q d@@26) (exists ((|a#1#0#0| T@U) (|a#1#1#0| T@U) ) (! (= d@@26 (|#_module.StateC.S| |a#1#0#0| |a#1#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.32:21|
 :skolemid |1271|
)))
 :qid |unknown.0:0|
 :skolemid |1272|
 :pattern ( (_module.StateC.S_q d@@26))
)))
(assert (forall ((d@@27 T@U) ) (!  (=> (_module.Expression.exprAnd_q d@@27) (exists ((|a#48#0#0| T@U) (|a#48#1#0| T@U) ) (! (= d@@27 (|#_module.Expression.exprAnd| |a#48#0#0| |a#48#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.321:31|
 :skolemid |1360|
)))
 :qid |unknown.0:0|
 :skolemid |1361|
 :pattern ( (_module.Expression.exprAnd_q d@@27))
)))
(assert (forall ((d@@28 T@U) ) (!  (=> (_module.Expression.exprOr_q d@@28) (exists ((|a#56#0#0| T@U) (|a#56#1#0| T@U) ) (! (= d@@28 (|#_module.Expression.exprOr| |a#56#0#0| |a#56#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.322:30|
 :skolemid |1372|
)))
 :qid |unknown.0:0|
 :skolemid |1373|
 :pattern ( (_module.Expression.exprOr_q d@@28))
)))
(assert (forall ((d@@29 T@U) ) (!  (=> (_module.Expression.exprInvocation_q d@@29) (exists ((|a#64#0#0| T@U) (|a#64#1#0| T@U) ) (! (= d@@29 (|#_module.Expression.exprInvocation| |a#64#0#0| |a#64#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.323:38|
 :skolemid |1384|
)))
 :qid |unknown.0:0|
 :skolemid |1385|
 :pattern ( (_module.Expression.exprInvocation_q d@@29))
)))
(assert (forall ((d@@30 T@U) ) (!  (=> (_module.Tuple.Pair_q d@@30) (exists ((|a#162#0#0| T@U) (|a#162#1#0| T@U) ) (! (= d@@30 (|#_module.Tuple.Pair| |a#162#0#0| |a#162#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.344:29|
 :skolemid |1540|
)))
 :qid |unknown.0:0|
 :skolemid |1541|
 :pattern ( (_module.Tuple.Pair_q d@@30))
)))
...
(assert (forall ((d@@31 T@U) ) (!  (=> (_module.Literal.litTrue_q d@@31) (= d@@31 |#_module.Literal.litTrue|))
 :qid |unknown.0:0|
 :skolemid |1417|
 :pattern ( (_module.Literal.litTrue_q d@@31))
)))
(assert (forall ((d@@32 T@U) ) (!  (=> (_module.Literal.litFalse_q d@@32) (= d@@32 |#_module.Literal.litFalse|))
 :qid |unknown.0:0|
 :skolemid |1419|
 :pattern ( (_module.Literal.litFalse_q d@@32))
)))
(assert (forall ((d@@33 T@U) ) (!  (=> (_module.Literal.litUndefined_q d@@33) (= d@@33 |#_module.Literal.litUndefined|))
 :qid |unknown.0:0|
 :skolemid |1421|
 :pattern ( (_module.Literal.litUndefined_q d@@33))
)))
(assert (forall ((d@@34 T@U) ) (!  (=> (_module.Literal.litNull_q d@@34) (= d@@34 |#_module.Literal.litNull|))
 :qid |unknown.0:0|
 :skolemid |1423|
 :pattern ( (_module.Literal.litNull_q d@@34))
)))
(assert (forall ((d@@35 T@U) ) (!  (=> (_module.Primitive.primCreatePath_q d@@35) (= d@@35 |#_module.Primitive.primCreatePath|))
 :qid |unknown.0:0|
 :skolemid |1494|
 :pattern ( (_module.Primitive.primCreatePath_q d@@35))
)))
(assert (forall ((d@@36 T@U) ) (!  (=> (_module.Primitive.primExec_q d@@36) (= d@@36 |#_module.Primitive.primExec|))
 :qid |unknown.0:0|
 :skolemid |1496|
 :pattern ( (_module.Primitive.primExec_q d@@36))
)))
...
(assert (forall ((d@@37 T@U) ) (!  (=> (|$IsA#_module.Literal| d@@37) (or (or (or (or (or (or (or (or (or (_module.Literal.litTrue_q d@@37) (_module.Literal.litFalse_q d@@37)) (_module.Literal.litUndefined_q d@@37)) (_module.Literal.litNull_q d@@37)) (_module.Literal.litNumber_q d@@37)) (_module.Literal.litString_q d@@37)) (_module.Literal.litPrimitive_q d@@37)) (_module.Literal.litArrOfPaths_q d@@37)) (_module.Literal.litArrOfStrings_q d@@37)) (_module.Literal.litArray_q d@@37)))
 :qid |unknown.0:0|
 :skolemid |1480|
 :pattern ( (|$IsA#_module.Literal| d@@37))
)))
...
(assert (forall ((d@@38 T@U) ) (!  (=> (_module.Expression.exprLiteral_q d@@38) (exists ((|a#27#0#0| T@U) ) (! (= d@@38 (|#_module.Expression.exprLiteral| |a#27#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.319:35|
 :skolemid |1327|
)))
 :qid |unknown.0:0|
 :skolemid |1328|
 :pattern ( (_module.Expression.exprLiteral_q d@@38))
)))
(assert (forall ((d@@39 T@U) ) (!  (=> (_module.Expression.exprIdentifier_q d@@39) (exists ((|a#33#0#0| T@U) ) (! (= d@@39 (|#_module.Expression.exprIdentifier| |a#33#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.319:66|
 :skolemid |1337|
)))
 :qid |unknown.0:0|
 :skolemid |1338|
 :pattern ( (_module.Expression.exprIdentifier_q d@@39))
)))
(assert (forall ((d@@40 T@U) ) (!  (=> (_module.Expression.exprError_q d@@40) (exists ((|a#73#0#0| T@U) ) (! (= d@@40 (|#_module.Expression.exprError| |a#73#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.324:33|
 :skolemid |1397|
)))
 :qid |unknown.0:0|
 :skolemid |1398|
 :pattern ( (_module.Expression.exprError_q d@@40))
)))
(assert (forall ((d@@41 T@U) ) (!  (=> (_module.Literal.litNumber_q d@@41) (exists ((|a#95#0#0| Int) ) (! (= d@@41 (|#_module.Literal.litNumber| |a#95#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.327:30|
 :skolemid |1426|
)))
 :qid |unknown.0:0|
 :skolemid |1427|
 :pattern ( (_module.Literal.litNumber_q d@@41))
)))
(assert (forall ((d@@42 T@U) ) (!  (=> (_module.Literal.litString_q d@@42) (exists ((|a#100#0#0| T@U) ) (! (= d@@42 (|#_module.Literal.litString| |a#100#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.327:52|
 :skolemid |1434|
)))
 :qid |unknown.0:0|
 :skolemid |1435|
 :pattern ( (_module.Literal.litString_q d@@42))
)))
(assert (forall ((d@@43 T@U) ) (!  (=> (_module.Literal.litPrimitive_q d@@43) (exists ((|a#107#0#0| T@U) ) (! (= d@@43 (|#_module.Literal.litPrimitive| |a#107#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.328:33|
 :skolemid |1444|
)))
 :qid |unknown.0:0|
 :skolemid |1445|
 :pattern ( (_module.Literal.litPrimitive_q d@@43))
)))
(assert (forall ((d@@44 T@U) ) (!  (=> (_module.Literal.litArrOfPaths_q d@@44) (exists ((|a#113#0#0| T@U) ) (! (= d@@44 (|#_module.Literal.litArrOfPaths| |a#113#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.329:34|
 :skolemid |1453|
)))
 :qid |unknown.0:0|
 :skolemid |1454|
 :pattern ( (_module.Literal.litArrOfPaths_q d@@44))
)))
(assert (forall ((d@@45 T@U) ) (!  (=> (_module.Literal.litArrOfStrings_q d@@45) (exists ((|a#119#0#0| T@U) ) (! (= d@@45 (|#_module.Literal.litArrOfStrings| |a#119#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.330:36|
 :skolemid |1462|
)))
 :qid |unknown.0:0|
 :skolemid |1463|
 :pattern ( (_module.Literal.litArrOfStrings_q d@@45))
)))
(assert (forall ((d@@46 T@U) ) (!  (=> (_module.Literal.litArray_q d@@46) (exists ((|a#125#0#0| T@U) ) (! (= d@@46 (|#_module.Literal.litArray| |a#125#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.331:29|
 :skolemid |1471|
)))
 :qid |unknown.0:0|
 :skolemid |1472|
 :pattern ( (_module.Literal.litArray_q d@@46))
)))
...
(assert (forall ((d@@50 T@U) ) (!  (=> ($Is DatatypeTypeType d@@50 Tclass._module.Primitive) (or (_module.Primitive.primCreatePath_q d@@50) (_module.Primitive.primExec_q d@@50)))
 :qid |unknown.0:0|
 :skolemid |1499|
 :pattern ( (_module.Primitive.primExec_q d@@50) ($Is DatatypeTypeType d@@50 Tclass._module.Primitive))
 :pattern ( (_module.Primitive.primCreatePath_q d@@50) ($Is DatatypeTypeType d@@50 Tclass._module.Primitive))
)))
...
(assert (forall ((d@@53 T@U) (_module.Triple$A@@7 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (_module.Triple.Trio_q d@@53) (exists ((_module.Triple$B@@7 T@U) (_module.Triple$C@@7 T@U) ) (! ($IsAlloc DatatypeTypeType d@@53 (Tclass._module.Triple _module.Triple$A@@7 _module.Triple$B@@7 _module.Triple$C@@7) $h@@2)
 :qid |unknown.0:0|
 :skolemid |1563|
 :pattern ( ($IsAlloc DatatypeTypeType d@@53 (Tclass._module.Triple _module.Triple$A@@7 _module.Triple$B@@7 _module.Triple$C@@7) $h@@2))
)))) ($IsAllocBox (_module.Triple.fst d@@53) _module.Triple$A@@7 $h@@2))
 :qid |unknown.0:0|
 :skolemid |1564|
 :pattern ( ($IsAllocBox (_module.Triple.fst d@@53) _module.Triple$A@@7 $h@@2))
)))
(assert (forall ((d@@54 T@U) (_module.Triple$B@@8 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (_module.Triple.Trio_q d@@54) (exists ((_module.Triple$A@@8 T@U) (_module.Triple$C@@8 T@U) ) (! ($IsAlloc DatatypeTypeType d@@54 (Tclass._module.Triple _module.Triple$A@@8 _module.Triple$B@@8 _module.Triple$C@@8) $h@@3)
 :qid |unknown.0:0|
 :skolemid |1565|
 :pattern ( ($IsAlloc DatatypeTypeType d@@54 (Tclass._module.Triple _module.Triple$A@@8 _module.Triple$B@@8 _module.Triple$C@@8) $h@@3))
)))) ($IsAllocBox (_module.Triple.snd d@@54) _module.Triple$B@@8 $h@@3))
 :qid |unknown.0:0|
 :skolemid |1566|
 :pattern ( ($IsAllocBox (_module.Triple.snd d@@54) _module.Triple$B@@8 $h@@3))
)))
(assert (forall ((d@@55 T@U) (_module.Triple$C@@9 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (_module.Triple.Trio_q d@@55) (exists ((_module.Triple$A@@9 T@U) (_module.Triple$B@@9 T@U) ) (! ($IsAlloc DatatypeTypeType d@@55 (Tclass._module.Triple _module.Triple$A@@9 _module.Triple$B@@9 _module.Triple$C@@9) $h@@4)
 :qid |unknown.0:0|
 :skolemid |1567|
 :pattern ( ($IsAlloc DatatypeTypeType d@@55 (Tclass._module.Triple _module.Triple$A@@9 _module.Triple$B@@9 _module.Triple$C@@9) $h@@4))
)))) ($IsAllocBox (_module.Triple.trd d@@55) _module.Triple$C@@9 $h@@4))
 :qid |unknown.0:0|
 :skolemid |1568|
 :pattern ( ($IsAllocBox (_module.Triple.trd d@@55) _module.Triple$C@@9 $h@@4))
)))
(assert (forall ((d@@56 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) ($Is DatatypeTypeType d@@56 Tclass._module.StateC)) ($IsAlloc DatatypeTypeType d@@56 Tclass._module.StateC $h@@5))
 :qid |unknown.0:0|
 :skolemid |1279|
 :pattern ( ($IsAlloc DatatypeTypeType d@@56 Tclass._module.StateC $h@@5))
)))
(assert (forall ((d@@57 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) ($Is DatatypeTypeType d@@57 Tclass._module.Expression)) ($IsAlloc DatatypeTypeType d@@57 Tclass._module.Expression $h@@6))
 :qid |unknown.0:0|
 :skolemid |1405|
 :pattern ( ($IsAlloc DatatypeTypeType d@@57 Tclass._module.Expression $h@@6))
)))
(assert (forall ((d@@58 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) ($Is DatatypeTypeType d@@58 Tclass._module.Literal)) ($IsAlloc DatatypeTypeType d@@58 Tclass._module.Literal $h@@7))
 :qid |unknown.0:0|
 :skolemid |1479|
 :pattern ( ($IsAlloc DatatypeTypeType d@@58 Tclass._module.Literal $h@@7))
)))
(assert (forall ((d@@59 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) ($Is DatatypeTypeType d@@59 Tclass._module.Primitive)) ($IsAlloc DatatypeTypeType d@@59 Tclass._module.Primitive $h@@8))
 :qid |unknown.0:0|
 :skolemid |1497|
 :pattern ( ($IsAlloc DatatypeTypeType d@@59 Tclass._module.Primitive $h@@8))
)))
(assert (forall ((d@@60 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) ($Is DatatypeTypeType d@@60 Tclass._module.Reason)) ($IsAlloc DatatypeTypeType d@@60 Tclass._module.Reason $h@@9))
 :qid |unknown.0:0|
 :skolemid |1509|
 :pattern ( ($IsAlloc DatatypeTypeType d@@60 Tclass._module.Reason $h@@9))
)))
(assert (forall ((d@@61 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) ($Is DatatypeTypeType d@@61 Tclass._module.Path)) ($IsAlloc DatatypeTypeType d@@61 Tclass._module.Path $h@@10))
 :qid |unknown.0:0|
 :skolemid |1532|
 :pattern ( ($IsAlloc DatatypeTypeType d@@61 Tclass._module.Path $h@@10))
)))
...
(assert (forall ((d@@62 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (_module.Literal.litString_q d@@62) ($IsAlloc DatatypeTypeType d@@62 Tclass._module.Literal $h@@11))) ($IsAlloc SeqType (_module.Literal.str d@@62) (TSeq TChar) $h@@11))
 :qid |unknown.0:0|
 :skolemid |1437|
 :pattern ( ($IsAlloc SeqType (_module.Literal.str d@@62) (TSeq TChar) $h@@11))
)))
(assert (forall ((|a#117#0#0| T@U) (d@@63 T@U) ) (!  (=> (|Set#IsMember| |a#117#0#0| ($Box DatatypeTypeType d@@63)) (< (DtRank d@@63) (DtRank (|#_module.Literal.litArrOfPaths| |a#117#0#0|))))
 :qid |CloudMakeConsistentBuildslegacydfy.329:34|
 :skolemid |1459|
 :pattern ( (|Set#IsMember| |a#117#0#0| ($Box DatatypeTypeType d@@63)) (|#_module.Literal.litArrOfPaths| |a#117#0#0|))
)))
(assert (forall ((|a#123#0#0| T@U) (d@@64 T@U) ) (!  (=> (|Set#IsMember| |a#123#0#0| ($Box DatatypeTypeType d@@64)) (< (DtRank d@@64) (DtRank (|#_module.Literal.litArrOfStrings| |a#123#0#0|))))
 :qid |CloudMakeConsistentBuildslegacydfy.330:36|
 :skolemid |1468|
 :pattern ( (|Set#IsMember| |a#123#0#0| ($Box DatatypeTypeType d@@64)) (|#_module.Literal.litArrOfStrings| |a#123#0#0|))
)))
...
(assert (forall ((d@@65 T@U) (_module.Tuple$A@@6 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (_module.Tuple.Pair_q d@@65) (exists ((_module.Tuple$B@@6 T@U) ) (! ($IsAlloc DatatypeTypeType d@@65 (Tclass._module.Tuple _module.Tuple$A@@6 _module.Tuple$B@@6) $h@@12)
 :qid |unknown.0:0|
 :skolemid |1544|
 :pattern ( ($IsAlloc DatatypeTypeType d@@65 (Tclass._module.Tuple _module.Tuple$A@@6 _module.Tuple$B@@6) $h@@12))
)))) ($IsAllocBox (_module.Tuple.fst d@@65) _module.Tuple$A@@6 $h@@12))
 :qid |unknown.0:0|
 :skolemid |1545|
 :pattern ( ($IsAllocBox (_module.Tuple.fst d@@65) _module.Tuple$A@@6 $h@@12))
)))
(assert (forall ((d@@66 T@U) (_module.Tuple$B@@7 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (_module.Tuple.Pair_q d@@66) (exists ((_module.Tuple$A@@7 T@U) ) (! ($IsAlloc DatatypeTypeType d@@66 (Tclass._module.Tuple _module.Tuple$A@@7 _module.Tuple$B@@7) $h@@13)
 :qid |unknown.0:0|
 :skolemid |1546|
 :pattern ( ($IsAlloc DatatypeTypeType d@@66 (Tclass._module.Tuple _module.Tuple$A@@7 _module.Tuple$B@@7) $h@@13))
)))) ($IsAllocBox (_module.Tuple.snd d@@66) _module.Tuple$B@@7 $h@@13))
 :qid |unknown.0:0|
 :skolemid |1547|
 :pattern ( ($IsAllocBox (_module.Tuple.snd d@@66) _module.Tuple$B@@7 $h@@13))
)))
...
(assert (forall ((d@@67 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (_module.StateC.S_q d@@67) ($IsAlloc DatatypeTypeType d@@67 Tclass._module.StateC $h@@14))) ($IsAllocBox (_module.StateC.st d@@67) Tclass._module.State $h@@14))
 :qid |unknown.0:0|
 :skolemid |1274|
 :pattern ( ($IsAllocBox (_module.StateC.st d@@67) Tclass._module.State $h@@14))
)))
(assert (forall ((d@@68 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (_module.StateC.S_q d@@68) ($IsAlloc DatatypeTypeType d@@68 Tclass._module.StateC $h@@15))) ($IsAllocBox (_module.StateC.c d@@68) Tclass._module.Cache $h@@15))
 :qid |unknown.0:0|
 :skolemid |1275|
 :pattern ( ($IsAllocBox (_module.StateC.c d@@68) Tclass._module.Cache $h@@15))
)))
(assert (forall ((d@@69 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (_module.Expression.exprLiteral_q d@@69) ($IsAlloc DatatypeTypeType d@@69 Tclass._module.Expression $h@@16))) ($IsAlloc DatatypeTypeType (_module.Expression.lit d@@69) Tclass._module.Literal $h@@16))
 :qid |unknown.0:0|
 :skolemid |1331|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.lit d@@69) Tclass._module.Literal $h@@16))
)))
(assert (forall ((d@@70 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (_module.Expression.exprIdentifier_q d@@70) ($IsAlloc DatatypeTypeType d@@70 Tclass._module.Expression $h@@17))) ($IsAllocBox (_module.Expression.id d@@70) Tclass._module.Identifier $h@@17))
 :qid |unknown.0:0|
 :skolemid |1340|
 :pattern ( ($IsAllocBox (_module.Expression.id d@@70) Tclass._module.Identifier $h@@17))
)))
(assert (forall ((d@@71 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (_module.Expression.exprIf_q d@@71) ($IsAlloc DatatypeTypeType d@@71 Tclass._module.Expression $h@@18))) ($IsAlloc DatatypeTypeType (_module.Expression.cond d@@71) Tclass._module.Expression $h@@18))
 :qid |unknown.0:0|
 :skolemid |1348|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.cond d@@71) Tclass._module.Expression $h@@18))
)))
(assert (forall ((d@@72 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (_module.Expression.exprIf_q d@@72) ($IsAlloc DatatypeTypeType d@@72 Tclass._module.Expression $h@@19))) ($IsAlloc DatatypeTypeType (_module.Expression.ifTrue d@@72) Tclass._module.Expression $h@@19))
 :qid |unknown.0:0|
 :skolemid |1349|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.ifTrue d@@72) Tclass._module.Expression $h@@19))
)))
(assert (forall ((d@@73 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (_module.Expression.exprIf_q d@@73) ($IsAlloc DatatypeTypeType d@@73 Tclass._module.Expression $h@@20))) ($IsAlloc DatatypeTypeType (_module.Expression.ifFalse d@@73) Tclass._module.Expression $h@@20))
 :qid |unknown.0:0|
 :skolemid |1350|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.ifFalse d@@73) Tclass._module.Expression $h@@20))
)))
(assert (forall ((d@@74 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (_module.Expression.exprAnd_q d@@74) ($IsAlloc DatatypeTypeType d@@74 Tclass._module.Expression $h@@21))) ($IsAlloc DatatypeTypeType (_module.Expression.conj0 d@@74) Tclass._module.Expression $h@@21))
 :qid |unknown.0:0|
 :skolemid |1363|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.conj0 d@@74) Tclass._module.Expression $h@@21))
)))
(assert (forall ((d@@75 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (_module.Expression.exprAnd_q d@@75) ($IsAlloc DatatypeTypeType d@@75 Tclass._module.Expression $h@@22))) ($IsAlloc DatatypeTypeType (_module.Expression.conj1 d@@75) Tclass._module.Expression $h@@22))
 :qid |unknown.0:0|
 :skolemid |1364|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.conj1 d@@75) Tclass._module.Expression $h@@22))
)))
(assert (forall ((d@@76 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (_module.Expression.exprOr_q d@@76) ($IsAlloc DatatypeTypeType d@@76 Tclass._module.Expression $h@@23))) ($IsAlloc DatatypeTypeType (_module.Expression.disj0 d@@76) Tclass._module.Expression $h@@23))
 :qid |unknown.0:0|
 :skolemid |1375|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.disj0 d@@76) Tclass._module.Expression $h@@23))
)))
(assert (forall ((d@@77 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (_module.Expression.exprOr_q d@@77) ($IsAlloc DatatypeTypeType d@@77 Tclass._module.Expression $h@@24))) ($IsAlloc DatatypeTypeType (_module.Expression.disj1 d@@77) Tclass._module.Expression $h@@24))
 :qid |unknown.0:0|
 :skolemid |1376|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.disj1 d@@77) Tclass._module.Expression $h@@24))
)))
(assert (forall ((d@@78 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (_module.Expression.exprInvocation_q d@@78) ($IsAlloc DatatypeTypeType d@@78 Tclass._module.Expression $h@@25))) ($IsAlloc DatatypeTypeType (_module.Expression.fun d@@78) Tclass._module.Expression $h@@25))
 :qid |unknown.0:0|
 :skolemid |1387|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.fun d@@78) Tclass._module.Expression $h@@25))
)))
(assert (forall ((d@@79 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (_module.Expression.exprError_q d@@79) ($IsAlloc DatatypeTypeType d@@79 Tclass._module.Expression $h@@26))) ($IsAlloc DatatypeTypeType (_module.Expression.r d@@79) Tclass._module.Reason $h@@26))
 :qid |unknown.0:0|
 :skolemid |1401|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.r d@@79) Tclass._module.Reason $h@@26))
)))
(assert (forall ((d@@80 T@U) ($h@@27 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (_module.Literal.litPrimitive_q d@@80) ($IsAlloc DatatypeTypeType d@@80 Tclass._module.Literal $h@@27))) ($IsAlloc DatatypeTypeType (_module.Literal.prim d@@80) Tclass._module.Primitive $h@@27))
 :qid |unknown.0:0|
 :skolemid |1447|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Literal.prim d@@80) Tclass._module.Primitive $h@@27))
)))
...
(assert (forall ((d@@81 T@U) ($h@@28 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (_module.Literal.litArrOfStrings_q d@@81) ($IsAlloc DatatypeTypeType d@@81 Tclass._module.Literal $h@@28))) ($IsAlloc SetType (_module.Literal.strs d@@81) (TSet (TSeq TChar)) $h@@28))
 :qid |unknown.0:0|
 :skolemid |1465|
 :pattern ( ($IsAlloc SetType (_module.Literal.strs d@@81) (TSet (TSeq TChar)) $h@@28))
)))
...
(assert (forall ((d@@82 T@U) ($h@@29 T@U) ) (!  (=> (and ($IsGoodHeap $h@@29) (and (_module.Expression.exprInvocation_q d@@82) ($IsAlloc DatatypeTypeType d@@82 Tclass._module.Expression $h@@29))) ($IsAlloc SeqType (_module.Expression.args d@@82) (TSeq Tclass._module.Expression) $h@@29))
 :qid |unknown.0:0|
 :skolemid |1388|
 :pattern ( ($IsAlloc SeqType (_module.Expression.args d@@82) (TSeq Tclass._module.Expression) $h@@29))
)))
(assert (forall ((d@@83 T@U) ($h@@30 T@U) ) (!  (=> (and ($IsGoodHeap $h@@30) (and (_module.Literal.litArrOfPaths_q d@@83) ($IsAlloc DatatypeTypeType d@@83 Tclass._module.Literal $h@@30))) ($IsAlloc SetType (_module.Literal.paths d@@83) (TSet Tclass._module.Path) $h@@30))
 :qid |unknown.0:0|
 :skolemid |1456|
 :pattern ( ($IsAlloc SetType (_module.Literal.paths d@@83) (TSet Tclass._module.Path) $h@@30))
)))
(assert (forall ((d@@84 T@U) ($h@@31 T@U) ) (!  (=> (and ($IsGoodHeap $h@@31) (and (_module.Literal.litArray_q d@@84) ($IsAlloc DatatypeTypeType d@@84 Tclass._module.Literal $h@@31))) ($IsAlloc SeqType (_module.Literal.arr d@@84) (TSeq Tclass._module.Expression) $h@@31))
 :qid |unknown.0:0|
 :skolemid |1474|
 :pattern ( ($IsAlloc SeqType (_module.Literal.arr d@@84) (TSeq Tclass._module.Expression) $h@@31))
)))
...
(declare-fun |conj0'#Z#0@0| () T@U)
(declare-fun |##expr#7@0| () T@U)
(declare-fun |stC'#Z#1@0| () T@U)
(declare-fun |##expr#6@0| () T@U)
(declare-fun |let#2#0#0| () T@U)
(declare-fun |result#Z#1@0| () T@U)
(declare-fun |let#3#0#0| () T@U)
(declare-fun |let#3#1#0| () T@U)
(declare-fun |disj0'#Z#0@0| () T@U)
(declare-fun |##expr#9@0| () T@U)
(declare-fun |stC'#Z#2@0| () T@U)
(declare-fun |##expr#8@0| () T@U)
(declare-fun |let#4#0#0| () T@U)
(declare-fun |result#Z#2@0| () T@U)
(declare-fun |let#5#0#0| () T@U)
(declare-fun |let#5#1#0| () T@U)
(declare-fun |args'#Z#0@0| () T@U)
(declare-fun |stCombinedC#Z#0@0| () T@U)
(declare-fun |##cmd#0@0| () T@U)
(declare-fun |##deps#0@0| () T@U)
(declare-fun |##exts#0@0| () T@U)
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.evalC)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 117) (let ((anon80_Else_correct true))
(let ((anon80_Then_correct  (=> (and (_module.Expression.exprLiteral_q |cond'#Z#0@0|) (|_module.Literal#Equal| (_module.Expression.lit |cond'#Z#0@0|) |#_module.Literal.litFalse|)) (and (=> (= (ControlFlow 0 84) (- 0 85)) (_module.Expression.exprIf_q |expr#0@@16|)) (=> (_module.Expression.exprIf_q |expr#0@@16|) (=> (= |##expr#5@0| (_module.Expression.ifFalse |expr#0@@16|)) (=> (and (and ($IsAlloc DatatypeTypeType |##expr#5@0| Tclass._module.Expression $Heap@@3) ($IsAlloc DatatypeTypeType |stC'#Z#0@0| Tclass._module.StateC $Heap@@3)) (and ($IsAllocBox |env#0@@15| Tclass._module.Env $Heap@@3) (= (ControlFlow 0 84) (- 0 83)))) (< (DtRank |##expr#5@0|) (DtRank |expr#0@@16|)))))))))
(let ((anon79_Else_correct  (=> (not (_module.Expression.exprLiteral_q |cond'#Z#0@0|)) (and (=> (= (ControlFlow 0 89) 84) anon80_Then_correct) (=> (= (ControlFlow 0 89) 86) anon80_Else_correct)))))
(let ((anon79_Then_correct  (=> (_module.Expression.exprLiteral_q |cond'#Z#0@0|) (and (=> (= (ControlFlow 0 87) (- 0 88)) (_module.Expression.exprLiteral_q |cond'#Z#0@0|)) (=> (_module.Expression.exprLiteral_q |cond'#Z#0@0|) (and (=> (= (ControlFlow 0 87) 84) anon80_Then_correct) (=> (= (ControlFlow 0 87) 86) anon80_Else_correct)))))))
(let ((anon78_Else_correct  (=> (not (and (_module.Expression.exprLiteral_q |cond'#Z#0@0|) (|_module.Literal#Equal| (_module.Expression.lit |cond'#Z#0@0|) |#_module.Literal.litTrue|))) (and (=> (= (ControlFlow 0 90) 87) anon79_Then_correct) (=> (= (ControlFlow 0 90) 89) anon79_Else_correct)))))
(let ((anon78_Then_correct  (=> (and (_module.Expression.exprLiteral_q |cond'#Z#0@0|) (|_module.Literal#Equal| (_module.Expression.lit |cond'#Z#0@0|) |#_module.Literal.litTrue|)) (and (=> (= (ControlFlow 0 81) (- 0 82)) (_module.Expression.exprIf_q |expr#0@@16|)) (=> (_module.Expression.exprIf_q |expr#0@@16|) (=> (= |##expr#4@0| (_module.Expression.ifTrue |expr#0@@16|)) (=> (and (and ($IsAlloc DatatypeTypeType |##expr#4@0| Tclass._module.Expression $Heap@@3) ($IsAlloc DatatypeTypeType |stC'#Z#0@0| Tclass._module.StateC $Heap@@3)) (and ($IsAllocBox |env#0@@15| Tclass._module.Env $Heap@@3) (= (ControlFlow 0 81) (- 0 80)))) (< (DtRank |##expr#4@0|) (DtRank |expr#0@@16|)))))))))
(let ((anon77_Else_correct  (=> (not (_module.Expression.exprLiteral_q |cond'#Z#0@0|)) (and (=> (= (ControlFlow 0 93) 81) anon78_Then_correct) (=> (= (ControlFlow 0 93) 90) anon78_Else_correct)))))
(let ((anon77_Then_correct  (=> (_module.Expression.exprLiteral_q |cond'#Z#0@0|) (and (=> (= (ControlFlow 0 91) (- 0 92)) (_module.Expression.exprLiteral_q |cond'#Z#0@0|)) (=> (_module.Expression.exprLiteral_q |cond'#Z#0@0|) (and (=> (= (ControlFlow 0 91) 81) anon78_Then_correct) (=> (= (ControlFlow 0 91) 90) anon78_Else_correct)))))))
(let ((anon76_Then_correct  (=> (_module.Expression.exprIf_q |expr#0@@16|) (and (=> (= (ControlFlow 0 94) (- 0 96)) (_module.Expression.exprIf_q |expr#0@@16|)) (=> (_module.Expression.exprIf_q |expr#0@@16|) (=> (and (and (= |##expr#3@0| (_module.Expression.cond |expr#0@@16|)) ($IsAlloc DatatypeTypeType |##expr#3@0| Tclass._module.Expression $Heap@@3)) (and ($IsAlloc DatatypeTypeType |stC#0@@32| Tclass._module.StateC $Heap@@3) ($IsAllocBox |env#0@@15| Tclass._module.Env $Heap@@3))) (and (=> (= (ControlFlow 0 94) (- 0 95)) (< (DtRank |##expr#3@0|) (DtRank |expr#0@@16|))) (=> (< (DtRank |##expr#3@0|) (DtRank |expr#0@@16|)) (=> (and (and (and (and (|_module.__default.evalC#canCall| (_module.Expression.cond |expr#0@@16|) |stC#0@@32| |env#0@@15|) (_module.Tuple.Pair_q (_module.__default.evalC ($LS $LZ) (_module.Expression.cond |expr#0@@16|) |stC#0@@32| |env#0@@15|))) (and (= |let#0#0#0| (_module.__default.evalC ($LS $LZ) (_module.Expression.cond |expr#0@@16|) |stC#0@@32| |env#0@@15|)) (|_module.__default.evalC#canCall| (_module.Expression.cond |expr#0@@16|) |stC#0@@32| |env#0@@15|))) (and (and ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.Tuple Tclass._module.Expression Tclass._module.StateC)) (= |result#Z#0@0| |let#0#0#0|)) (and (_module.Tuple.Pair_q |result#Z#0@0|) (= |let#1#0#0| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#Z#0@0|)))))) (and (and (and (_module.Tuple.Pair_q |result#Z#0@0|) ($Is DatatypeTypeType |let#1#0#0| Tclass._module.Expression)) (and (= |cond'#Z#0@0| |let#1#0#0|) (_module.Tuple.Pair_q |result#Z#0@0|))) (and (and (= |let#1#1#0| ($Unbox DatatypeTypeType (_module.Tuple.snd |result#Z#0@0|))) (_module.Tuple.Pair_q |result#Z#0@0|)) (and ($Is DatatypeTypeType |let#1#1#0| Tclass._module.StateC) (= |stC'#Z#0@0| |let#1#1#0|))))) (and (=> (= (ControlFlow 0 94) 91) anon77_Then_correct) (=> (= (ControlFlow 0 94) 93) anon77_Else_correct)))))))))))
(let ((anon85_Else_correct true))
(let ((anon85_Then_correct true))
(let ((anon84_Else_correct  (=> (not (_module.Expression.exprLiteral_q |conj0'#Z#0@0|)) (and (=> (= (ControlFlow 0 71) 67) anon85_Then_correct) (=> (= (ControlFlow 0 71) 68) anon85_Else_correct)))))
(let ((anon84_Then_correct  (=> (_module.Expression.exprLiteral_q |conj0'#Z#0@0|) (and (=> (= (ControlFlow 0 69) (- 0 70)) (_module.Expression.exprLiteral_q |conj0'#Z#0@0|)) (=> (_module.Expression.exprLiteral_q |conj0'#Z#0@0|) (and (=> (= (ControlFlow 0 69) 67) anon85_Then_correct) (=> (= (ControlFlow 0 69) 68) anon85_Else_correct)))))))
(let ((anon83_Else_correct  (=> (not (and (_module.Expression.exprLiteral_q |conj0'#Z#0@0|) (|_module.Literal#Equal| (_module.Expression.lit |conj0'#Z#0@0|) |#_module.Literal.litTrue|))) (and (=> (= (ControlFlow 0 72) 69) anon84_Then_correct) (=> (= (ControlFlow 0 72) 71) anon84_Else_correct)))))
(let ((anon83_Then_correct  (=> (and (_module.Expression.exprLiteral_q |conj0'#Z#0@0|) (|_module.Literal#Equal| (_module.Expression.lit |conj0'#Z#0@0|) |#_module.Literal.litTrue|)) (and (=> (= (ControlFlow 0 65) (- 0 66)) (_module.Expression.exprAnd_q |expr#0@@16|)) (=> (_module.Expression.exprAnd_q |expr#0@@16|) (=> (= |##expr#7@0| (_module.Expression.conj1 |expr#0@@16|)) (=> (and (and ($IsAlloc DatatypeTypeType |##expr#7@0| Tclass._module.Expression $Heap@@3) ($IsAlloc DatatypeTypeType |stC'#Z#1@0| Tclass._module.StateC $Heap@@3)) (and ($IsAllocBox |env#0@@15| Tclass._module.Env $Heap@@3) (= (ControlFlow 0 65) (- 0 64)))) (< (DtRank |##expr#7@0|) (DtRank |expr#0@@16|)))))))))
(let ((anon82_Else_correct  (=> (not (_module.Expression.exprLiteral_q |conj0'#Z#0@0|)) (and (=> (= (ControlFlow 0 75) 65) anon83_Then_correct) (=> (= (ControlFlow 0 75) 72) anon83_Else_correct)))))
(let ((anon82_Then_correct  (=> (_module.Expression.exprLiteral_q |conj0'#Z#0@0|) (and (=> (= (ControlFlow 0 73) (- 0 74)) (_module.Expression.exprLiteral_q |conj0'#Z#0@0|)) (=> (_module.Expression.exprLiteral_q |conj0'#Z#0@0|) (and (=> (= (ControlFlow 0 73) 65) anon83_Then_correct) (=> (= (ControlFlow 0 73) 72) anon83_Else_correct)))))))
(let ((anon81_Then_correct  (=> (_module.Expression.exprAnd_q |expr#0@@16|) (and (=> (= (ControlFlow 0 76) (- 0 78)) (_module.Expression.exprAnd_q |expr#0@@16|)) (=> (_module.Expression.exprAnd_q |expr#0@@16|) (=> (and (and (= |##expr#6@0| (_module.Expression.conj0 |expr#0@@16|)) ($IsAlloc DatatypeTypeType |##expr#6@0| Tclass._module.Expression $Heap@@3)) (and ($IsAlloc DatatypeTypeType |stC#0@@32| Tclass._module.StateC $Heap@@3) ($IsAllocBox |env#0@@15| Tclass._module.Env $Heap@@3))) (and (=> (= (ControlFlow 0 76) (- 0 77)) (< (DtRank |##expr#6@0|) (DtRank |expr#0@@16|))) (=> (< (DtRank |##expr#6@0|) (DtRank |expr#0@@16|)) (=> (and (and (and (and (|_module.__default.evalC#canCall| (_module.Expression.conj0 |expr#0@@16|) |stC#0@@32| |env#0@@15|) (_module.Tuple.Pair_q (_module.__default.evalC ($LS $LZ) (_module.Expression.conj0 |expr#0@@16|) |stC#0@@32| |env#0@@15|))) (and (= |let#2#0#0| (_module.__default.evalC ($LS $LZ) (_module.Expression.conj0 |expr#0@@16|) |stC#0@@32| |env#0@@15|)) (|_module.__default.evalC#canCall| (_module.Expression.conj0 |expr#0@@16|) |stC#0@@32| |env#0@@15|))) (and (and ($Is DatatypeTypeType |let#2#0#0| (Tclass._module.Tuple Tclass._module.Expression Tclass._module.StateC)) (= |result#Z#1@0| |let#2#0#0|)) (and (_module.Tuple.Pair_q |result#Z#1@0|) (= |let#3#0#0| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#Z#1@0|)))))) (and (and (and (_module.Tuple.Pair_q |result#Z#1@0|) ($Is DatatypeTypeType |let#3#0#0| Tclass._module.Expression)) (and (= |conj0'#Z#0@0| |let#3#0#0|) (_module.Tuple.Pair_q |result#Z#1@0|))) (and (and (= |let#3#1#0| ($Unbox DatatypeTypeType (_module.Tuple.snd |result#Z#1@0|))) (_module.Tuple.Pair_q |result#Z#1@0|)) (and ($Is DatatypeTypeType |let#3#1#0| Tclass._module.StateC) (= |stC'#Z#1@0| |let#3#1#0|))))) (and (=> (= (ControlFlow 0 76) 73) anon82_Then_correct) (=> (= (ControlFlow 0 76) 75) anon82_Else_correct)))))))))))
(let ((anon90_Else_correct true))
(let ((anon90_Then_correct  (=> (and (_module.Expression.exprLiteral_q |disj0'#Z#0@0|) (|_module.Literal#Equal| (_module.Expression.lit |disj0'#Z#0@0|) |#_module.Literal.litFalse|)) (and (=> (= (ControlFlow 0 50) (- 0 51)) (_module.Expression.exprOr_q |expr#0@@16|)) (=> (_module.Expression.exprOr_q |expr#0@@16|) (=> (= |##expr#9@0| (_module.Expression.disj1 |expr#0@@16|)) (=> (and (and ($IsAlloc DatatypeTypeType |##expr#9@0| Tclass._module.Expression $Heap@@3) ($IsAlloc DatatypeTypeType |stC'#Z#2@0| Tclass._module.StateC $Heap@@3)) (and ($IsAllocBox |env#0@@15| Tclass._module.Env $Heap@@3) (= (ControlFlow 0 50) (- 0 49)))) (< (DtRank |##expr#9@0|) (DtRank |expr#0@@16|)))))))))
(let ((anon89_Else_correct  (=> (not (_module.Expression.exprLiteral_q |disj0'#Z#0@0|)) (and (=> (= (ControlFlow 0 55) 50) anon90_Then_correct) (=> (= (ControlFlow 0 55) 52) anon90_Else_correct)))))
(let ((anon89_Then_correct  (=> (_module.Expression.exprLiteral_q |disj0'#Z#0@0|) (and (=> (= (ControlFlow 0 53) (- 0 54)) (_module.Expression.exprLiteral_q |disj0'#Z#0@0|)) (=> (_module.Expression.exprLiteral_q |disj0'#Z#0@0|) (and (=> (= (ControlFlow 0 53) 50) anon90_Then_correct) (=> (= (ControlFlow 0 53) 52) anon90_Else_correct)))))))
(let ((anon88_Else_correct  (=> (not (and (_module.Expression.exprLiteral_q |disj0'#Z#0@0|) (|_module.Literal#Equal| (_module.Expression.lit |disj0'#Z#0@0|) |#_module.Literal.litTrue|))) (and (=> (= (ControlFlow 0 56) 53) anon89_Then_correct) (=> (= (ControlFlow 0 56) 55) anon89_Else_correct)))))
(let ((anon88_Then_correct true))
(let ((anon87_Else_correct  (=> (not (_module.Expression.exprLiteral_q |disj0'#Z#0@0|)) (and (=> (= (ControlFlow 0 59) 48) anon88_Then_correct) (=> (= (ControlFlow 0 59) 56) anon88_Else_correct)))))
(let ((anon87_Then_correct  (=> (_module.Expression.exprLiteral_q |disj0'#Z#0@0|) (and (=> (= (ControlFlow 0 57) (- 0 58)) (_module.Expression.exprLiteral_q |disj0'#Z#0@0|)) (=> (_module.Expression.exprLiteral_q |disj0'#Z#0@0|) (and (=> (= (ControlFlow 0 57) 48) anon88_Then_correct) (=> (= (ControlFlow 0 57) 56) anon88_Else_correct)))))))
(let ((anon86_Then_correct  (=> (_module.Expression.exprOr_q |expr#0@@16|) (and (=> (= (ControlFlow 0 60) (- 0 62)) (_module.Expression.exprOr_q |expr#0@@16|)) (=> (_module.Expression.exprOr_q |expr#0@@16|) (=> (and (and (= |##expr#8@0| (_module.Expression.disj0 |expr#0@@16|)) ($IsAlloc DatatypeTypeType |##expr#8@0| Tclass._module.Expression $Heap@@3)) (and ($IsAlloc DatatypeTypeType |stC#0@@32| Tclass._module.StateC $Heap@@3) ($IsAllocBox |env#0@@15| Tclass._module.Env $Heap@@3))) (and (=> (= (ControlFlow 0 60) (- 0 61)) (< (DtRank |##expr#8@0|) (DtRank |expr#0@@16|))) (=> (< (DtRank |##expr#8@0|) (DtRank |expr#0@@16|)) (=> (and (and (and (and (|_module.__default.evalC#canCall| (_module.Expression.disj0 |expr#0@@16|) |stC#0@@32| |env#0@@15|) (_module.Tuple.Pair_q (_module.__default.evalC ($LS $LZ) (_module.Expression.disj0 |expr#0@@16|) |stC#0@@32| |env#0@@15|))) (and (= |let#4#0#0| (_module.__default.evalC ($LS $LZ) (_module.Expression.disj0 |expr#0@@16|) |stC#0@@32| |env#0@@15|)) (|_module.__default.evalC#canCall| (_module.Expression.disj0 |expr#0@@16|) |stC#0@@32| |env#0@@15|))) (and (and ($Is DatatypeTypeType |let#4#0#0| (Tclass._module.Tuple Tclass._module.Expression Tclass._module.StateC)) (= |result#Z#2@0| |let#4#0#0|)) (and (_module.Tuple.Pair_q |result#Z#2@0|) (= |let#5#0#0| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#Z#2@0|)))))) (and (and (and (_module.Tuple.Pair_q |result#Z#2@0|) ($Is DatatypeTypeType |let#5#0#0| Tclass._module.Expression)) (and (= |disj0'#Z#0@0| |let#5#0#0|) (_module.Tuple.Pair_q |result#Z#2@0|))) (and (and (= |let#5#1#0| ($Unbox DatatypeTypeType (_module.Tuple.snd |result#Z#2@0|))) (_module.Tuple.Pair_q |result#Z#2@0|)) (and ($Is DatatypeTypeType |let#5#1#0| Tclass._module.StateC) (= |stC'#Z#2@0| |let#5#1#0|))))) (and (=> (= (ControlFlow 0 60) 57) anon87_Then_correct) (=> (= (ControlFlow 0 60) 59) anon87_Else_correct)))))))))))
(let ((anon98_Else_correct true))
(let ((anon98_Then_correct true))
(let ((anon97_Else_correct  (=> (not (and (= (|Seq#Length| |args'#Z#0@0|) (LitInt (_module.__default.Arity (Lit DatatypeTypeType |#_module.Primitive.primExec|)))) (_module.__default.ValidArgsC (Lit DatatypeTypeType |#_module.Primitive.primExec|) |args'#Z#0@0| |stCombinedC#Z#0@0|))) (=> (and ($IsAlloc DatatypeTypeType |stCombinedC#Z#0@0| Tclass._module.StateC $Heap@@3) (|_module.__default.ConsistentCache#canCall| |stCombinedC#Z#0@0|)) (and (=> (= (ControlFlow 0 27) 25) anon98_Then_correct) (=> (= (ControlFlow 0 27) 26) anon98_Else_correct))))))
(let ((anon97_Then_correct  (=> (and (= (|Seq#Length| |args'#Z#0@0|) (LitInt (_module.__default.Arity (Lit DatatypeTypeType |#_module.Primitive.primExec|)))) (_module.__default.ValidArgsC (Lit DatatypeTypeType |#_module.Primitive.primExec|) |args'#Z#0@0| |stCombinedC#Z#0@0|)) (and (=> (= (ControlFlow 0 16) (- 0 24)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |args'#Z#0@0|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |args'#Z#0@0|))) (=> (and (= |##cmd#0@0| ($Unbox DatatypeTypeType (|Seq#Index| |args'#Z#0@0| (LitInt 0)))) ($IsAlloc DatatypeTypeType |##cmd#0@0| Tclass._module.Expression $Heap@@3)) (and (=> (= (ControlFlow 0 16) (- 0 23)) (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |args'#Z#0@0|)))) (=> (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |args'#Z#0@0|))) (=> (and (= |##deps#0@0| ($Unbox DatatypeTypeType (|Seq#Index| |args'#Z#0@0| (LitInt 1)))) ($IsAlloc DatatypeTypeType |##deps#0@0| Tclass._module.Expression $Heap@@3)) (and (=> (= (ControlFlow 0 16) (- 0 22)) (and (<= 0 (LitInt 2)) (< (LitInt 2) (|Seq#Length| |args'#Z#0@0|)))) (=> (and (<= 0 (LitInt 2)) (< (LitInt 2) (|Seq#Length| |args'#Z#0@0|))) (=> (= |##exts#0@0| ($Unbox DatatypeTypeType (|Seq#Index| |args'#Z#0@0| (LitInt 2)))) (=> (and ($IsAlloc DatatypeTypeType |##exts#0@0| Tclass._module.Expression $Heap@@3) ($IsAlloc DatatypeTypeType |stCombinedC#Z#0@0| Tclass._module.StateC $Heap@@3)) (and (=> (= (ControlFlow 0 16) (- 0 21)) (_module.Expression.exprLiteral_q |##cmd#0@0|)) (and (=> (= (ControlFlow 0 16) (- 0 20)) (_module.Literal.litString_q (_module.Expression.lit |##cmd#0@0|))) (and (=> (= (ControlFlow 0 16) (- 0 19)) (_module.Expression.exprLiteral_q |##deps#0@0|)) (and (=> (= (ControlFlow 0 16) (- 0 18)) (_module.Literal.litArrOfPaths_q (_module.Expression.lit |##deps#0@0|))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (_module.Expression.exprLiteral_q |##exts#0@0|)) (=> (= (ControlFlow 0 16) (- 0 15)) (_module.Literal.litArrOfStrings_q (_module.Expression.lit |##exts#0@0|)))))))))))))))))))))
(let ((anon96_Else_correct  (=> (or (not (= (|Seq#Length| |args'#Z#0@0|) (LitInt (_module.__default.Arity (Lit DatatypeTypeType |#_module.Primitive.primExec|))))) (not true)) (and (=> (= (ControlFlow 0 31) 16) anon97_Then_correct) (=> (= (ControlFlow 0 31) 27) anon97_Else_correct)))))
(let ((anon96_Then_correct  (=> (= (|Seq#Length| |args'#Z#0@0|) (LitInt (_module.__default.Arity (Lit DatatypeTypeType |#_module.Primitive.primExec|)))) (=> (and (and (= |##prim#1@0| (Lit DatatypeTypeType |#_module.Primitive.primExec|)) ($IsAlloc DatatypeTypeType |##prim#1@0| Tclass._module.Primitive $Heap@@3)) (and ($IsAlloc SeqType |args'#Z#0@0| (TSeq Tclass._module.Expression) $Heap@@3) ($IsAlloc DatatypeTypeType |stCombinedC#Z#0@0| Tclass._module.StateC $Heap@@3))) (and (=> (= (ControlFlow 0 28) (- 0 30)) (=> (_module.Primitive.primExec_q |##prim#1@0|) (= (|Seq#Length| |args'#Z#0@0|) (LitInt 3)))) (=> (=> (_module.Primitive.primExec_q |##prim#1@0|) (= (|Seq#Length| |args'#Z#0@0|) (LitInt 3))) (and (=> (= (ControlFlow 0 28) (- 0 29)) (=> (_module.Primitive.primCreatePath_q |##prim#1@0|) (= (|Seq#Length| |args'#Z#0@0|) (LitInt 1)))) (=> (and (=> (_module.Primitive.primCreatePath_q |##prim#1@0|) (= (|Seq#Length| |args'#Z#0@0|) (LitInt 1))) (|_module.__default.ValidArgsC#canCall| (Lit DatatypeTypeType |#_module.Primitive.primExec|) |args'#Z#0@0| |stCombinedC#Z#0@0|)) (and (=> (= (ControlFlow 0 28) 16) anon97_Then_correct) (=> (= (ControlFlow 0 28) 27) anon97_Else_correct))))))))))
(let ((anon95_Then_correct  (=> (and (and (_module.Primitive.primExec_q (_module.Literal.prim (_module.Expression.lit |fun'#Z#0@0|))) (= |##prim#0@0| (Lit DatatypeTypeType |#_module.Primitive.primExec|))) (and ($IsAlloc DatatypeTypeType |##prim#0@0| Tclass._module.Primitive $Heap@@3) (|_module.__default.Arity#canCall| (Lit DatatypeTypeType |#_module.Primitive.primExec|)))) (and (=> (= (ControlFlow 0 32) 28) anon96_Then_correct) (=> (= (ControlFlow 0 32) 31) anon96_Else_correct)))))
(let ((anon95_Else_correct true))
(let ((anon94_Then_correct  (=> (and (_module.Expression.exprLiteral_q |fun'#Z#0@0|) (_module.Literal.litPrimitive_q (_module.Expression.lit |fun'#Z#0@0|))) (and (=> (= (ControlFlow 0 33) (- 0 35)) (_module.Expression.exprLiteral_q |fun'#Z#0@0|)) (=> (_module.Expression.exprLiteral_q |fun'#Z#0@0|) (and (=> (= (ControlFlow 0 33) (- 0 34)) (_module.Literal.litPrimitive_q (_module.Expression.lit |fun'#Z#0@0|))) (=> (_module.Literal.litPrimitive_q (_module.Expression.lit |fun'#Z#0@0|)) (and (=> (= (ControlFlow 0 33) 32) anon95_Then_correct) (=> (= (ControlFlow 0 33) 14) anon95_Else_correct)))))))))
(let ((anon94_Else_correct true))
(let ((anon93_Else_correct  (=> (not (_module.Expression.exprLiteral_q |fun'#Z#0@0|)) (and (=> (= (ControlFlow 0 38) 33) anon94_Then_correct) (=> (= (ControlFlow 0 38) 13) anon94_Else_correct)))))
(let ((anon93_Then_correct  (=> (_module.Expression.exprLiteral_q |fun'#Z#0@0|) (and (=> (= (ControlFlow 0 36) (- 0 37)) (_module.Expression.exprLiteral_q |fun'#Z#0@0|)) (=> (_module.Expression.exprLiteral_q |fun'#Z#0@0|) (and (=> (= (ControlFlow 0 36) 33) anon94_Then_correct) (=> (= (ControlFlow 0 36) 13) anon94_Else_correct)))))))
(let ((anon92_Then_correct  (=> (and (_module.__default.CompatibleC |stsC''#Z#0@0|) ($IsAlloc SetType |stsC''#Z#0@0| (TSet Tclass._module.StateC) $Heap@@3)) (and (=> (= (ControlFlow 0 39) (- 0 40)) (not (|Set#Equal| |stsC''#Z#0@0| |Set#Empty|))) (=> (not (|Set#Equal| |stsC''#Z#0@0| |Set#Empty|)) (=> (and (|_module.__default.CombineC#canCall| |stsC''#Z#0@0|) (_module.StateC.S_q (_module.__default.CombineC ($LS $LZ) |stsC''#Z#0@0|))) (=> (and (and (= |let#11#0#0| (_module.__default.CombineC ($LS $LZ) |stsC''#Z#0@0|)) (|_module.__default.CombineC#canCall| |stsC''#Z#0@0|)) (and ($Is DatatypeTypeType |let#11#0#0| Tclass._module.StateC) (= |stCombinedC#Z#0@0| |let#11#0#0|))) (and (=> (= (ControlFlow 0 39) 36) anon93_Then_correct) (=> (= (ControlFlow 0 39) 38) anon93_Else_correct)))))))))
(let ((anon92_Else_correct true))
(let ((anon91_Then_correct  (=> (_module.Expression.exprInvocation_q |expr#0@@16|) (and (=> (= (ControlFlow 0 41) (- 0 46)) (_module.Expression.exprInvocation_q |expr#0@@16|)) (=> (_module.Expression.exprInvocation_q |expr#0@@16|) (=> (and (and (= |##expr#10@0| (_module.Expression.fun |expr#0@@16|)) ($IsAlloc DatatypeTypeType |##expr#10@0| Tclass._module.Expression $Heap@@3)) (and ($IsAlloc DatatypeTypeType |stC#0@@32| Tclass._module.StateC $Heap@@3) ($IsAllocBox |env#0@@15| Tclass._module.Env $Heap@@3))) (and (=> (= (ControlFlow 0 41) (- 0 45)) (< (DtRank |##expr#10@0|) (DtRank |expr#0@@16|))) (=> (< (DtRank |##expr#10@0|) (DtRank |expr#0@@16|)) (=> (|_module.__default.evalC#canCall| (_module.Expression.fun |expr#0@@16|) |stC#0@@32| |env#0@@15|) (=> (and (and (and (and (_module.Tuple.Pair_q (_module.__default.evalC ($LS $LZ) (_module.Expression.fun |expr#0@@16|) |stC#0@@32| |env#0@@15|)) (= |let#6#0#0| (_module.__default.evalC ($LS $LZ) (_module.Expression.fun |expr#0@@16|) |stC#0@@32| |env#0@@15|))) (and (|_module.__default.evalC#canCall| (_module.Expression.fun |expr#0@@16|) |stC#0@@32| |env#0@@15|) ($Is DatatypeTypeType |let#6#0#0| (Tclass._module.Tuple Tclass._module.Expression Tclass._module.StateC)))) (and (and (= |resultFun#Z#0@0| |let#6#0#0|) (_module.Tuple.Pair_q |resultFun#Z#0@0|)) (and (= |let#7#0#0| ($Unbox DatatypeTypeType (_module.Tuple.fst |resultFun#Z#0@0|))) (_module.Tuple.Pair_q |resultFun#Z#0@0|)))) (and (and (and ($Is DatatypeTypeType |let#7#0#0| Tclass._module.Expression) (= |fun'#Z#0@0| |let#7#0#0|)) (and (_module.Tuple.Pair_q |resultFun#Z#0@0|) (= |let#7#1#0| ($Unbox DatatypeTypeType (_module.Tuple.snd |resultFun#Z#0@0|))))) (and (and (_module.Tuple.Pair_q |resultFun#Z#0@0|) ($Is DatatypeTypeType |let#7#1#0| Tclass._module.StateC)) (and (= |stC'#Z#3@0| |let#7#1#0|) ($IsAlloc DatatypeTypeType |expr#0@@16| Tclass._module.Expression $Heap@@3))))) (and (=> (= (ControlFlow 0 41) (- 0 44)) (_module.Expression.exprInvocation_q |expr#0@@16|)) (=> (_module.Expression.exprInvocation_q |expr#0@@16|) (=> (and (and (= |##args#0@0| (_module.Expression.args |expr#0@@16|)) ($IsAlloc SeqType |##args#0@0| (TSeq Tclass._module.Expression) $Heap@@3)) (and ($IsAlloc DatatypeTypeType |stC#0@@32| Tclass._module.StateC $Heap@@3) ($IsAllocBox |env#0@@15| Tclass._module.Env $Heap@@3))) (and (=> (= (ControlFlow 0 41) (- 0 43)) (forall ((|arg#0@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#0@@1| Tclass._module.Expression) (=> (|Seq#Contains| |##args#0@0| ($Box DatatypeTypeType |arg#0@@1|)) (< (DtRank |arg#0@@1|) (DtRank |expr#0@@16|))))
 :qid |CloudMakeConsistentBuildslegacydfy.475:19|
 :skolemid |1128|
 :pattern ( (|Seq#Contains| |##args#0@0| ($Box DatatypeTypeType |arg#0@@1|)))
))) (=> (forall ((|arg#0@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#0@@2| Tclass._module.Expression) (=> (|Seq#Contains| |##args#0@0| ($Box DatatypeTypeType |arg#0@@2|)) (< (DtRank |arg#0@@2|) (DtRank |expr#0@@16|))))
 :qid |CloudMakeConsistentBuildslegacydfy.475:19|
 :skolemid |1129|
 :pattern ( (|Seq#Contains| |##args#0@0| ($Box DatatypeTypeType |arg#0@@2|)))
)) (and (=> (= (ControlFlow 0 41) (- 0 42)) (<= (DtRank |expr#0@@16|) (DtRank |expr#0@@16|))) (=> (<= (DtRank |expr#0@@16|) (DtRank |expr#0@@16|)) (=> (|_module.__default.evalArgsC#canCall| |expr#0@@16| (_module.Expression.args |expr#0@@16|) |stC#0@@32| |env#0@@15|) (=> (and (and (_module.Tuple.Pair_q (_module.__default.evalArgsC ($LS $LZ) |expr#0@@16| (_module.Expression.args |expr#0@@16|) |stC#0@@32| |env#0@@15|)) (= |let#8#0#0| (_module.__default.evalArgsC ($LS $LZ) |expr#0@@16| (_module.Expression.args |expr#0@@16|) |stC#0@@32| |env#0@@15|))) (and (|_module.__default.evalArgsC#canCall| |expr#0@@16| (_module.Expression.args |expr#0@@16|) |stC#0@@32| |env#0@@15|) ($Is DatatypeTypeType |let#8#0#0| (Tclass._module.Tuple (TSeq Tclass._module.Expression) (TSet Tclass._module.StateC))))) (=> (and (and (and (and (= |resultArgs#Z#0@0| |let#8#0#0|) (_module.Tuple.Pair_q |resultArgs#Z#0@0|)) (and (= |let#9#0#0| ($Unbox SeqType (_module.Tuple.fst |resultArgs#Z#0@0|))) (_module.Tuple.Pair_q |resultArgs#Z#0@0|))) (and (and ($Is SeqType |let#9#0#0| (TSeq Tclass._module.Expression)) (= |args'#Z#0@0| |let#9#0#0|)) (and (_module.Tuple.Pair_q |resultArgs#Z#0@0|) (= |let#9#1#0| ($Unbox SetType (_module.Tuple.snd |resultArgs#Z#0@0|)))))) (and (and (and (_module.Tuple.Pair_q |resultArgs#Z#0@0|) ($Is SetType |let#9#1#0| (TSet Tclass._module.StateC))) (and (= |stsC'#Z#0@0| |let#9#1#0|) (= |let#10#0#0| (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |stC'#Z#3@0|)) |stsC'#Z#0@0|)))) (and (and ($Is SetType |let#10#0#0| (TSet Tclass._module.StateC)) (= |stsC''#Z#0@0| |let#10#0#0|)) (and ($IsAlloc SetType |stsC''#Z#0@0| (TSet Tclass._module.StateC) $Heap@@3) (|_module.__default.CompatibleC#canCall| |stsC''#Z#0@0|))))) (and (=> (= (ControlFlow 0 41) 39) anon92_Then_correct) (=> (= (ControlFlow 0 41) 12) anon92_Else_correct))))))))))))))))))))))
(let ((anon91_Else_correct true))
(let ((anon86_Else_correct  (=> (not (_module.Expression.exprOr_q |expr#0@@16|)) (and (=> (= (ControlFlow 0 47) 41) anon91_Then_correct) (=> (= (ControlFlow 0 47) 11) anon91_Else_correct)))))
(let ((anon81_Else_correct  (=> (not (_module.Expression.exprAnd_q |expr#0@@16|)) (and (=> (= (ControlFlow 0 63) 60) anon86_Then_correct) (=> (= (ControlFlow 0 63) 47) anon86_Else_correct)))))
(let ((anon76_Else_correct  (=> (not (_module.Expression.exprIf_q |expr#0@@16|)) (and (=> (= (ControlFlow 0 79) 76) anon81_Then_correct) (=> (= (ControlFlow 0 79) 63) anon81_Else_correct)))))
(let ((anon75_Else_correct  (=> (not (and (and (_module.Expression.exprIf_q |expr#0@@16|) (_module.Expression.exprLiteral_q (_module.Expression.cond |expr#0@@16|))) (|_module.Literal#Equal| (_module.Expression.lit (_module.Expression.cond |expr#0@@16|)) |#_module.Literal.litFalse|))) (and (=> (= (ControlFlow 0 97) 94) anon76_Then_correct) (=> (= (ControlFlow 0 97) 79) anon76_Else_correct)))))
(let ((anon75_Then_correct  (=> (and (and (_module.Expression.exprIf_q |expr#0@@16|) (_module.Expression.exprLiteral_q (_module.Expression.cond |expr#0@@16|))) (|_module.Literal#Equal| (_module.Expression.lit (_module.Expression.cond |expr#0@@16|)) |#_module.Literal.litFalse|)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (_module.Expression.exprIf_q |expr#0@@16|)) (=> (_module.Expression.exprIf_q |expr#0@@16|) (=> (= |##expr#2@0| (_module.Expression.ifFalse |expr#0@@16|)) (=> (and (and ($IsAlloc DatatypeTypeType |##expr#2@0| Tclass._module.Expression $Heap@@3) ($IsAlloc DatatypeTypeType |stC#0@@32| Tclass._module.StateC $Heap@@3)) (and ($IsAllocBox |env#0@@15| Tclass._module.Env $Heap@@3) (= (ControlFlow 0 9) (- 0 8)))) (< (DtRank |##expr#2@0|) (DtRank |expr#0@@16|)))))))))
(let ((anon74_Else_correct  (=> (not (and (_module.Expression.exprIf_q |expr#0@@16|) (_module.Expression.exprLiteral_q (_module.Expression.cond |expr#0@@16|)))) (and (=> (= (ControlFlow 0 101) 9) anon75_Then_correct) (=> (= (ControlFlow 0 101) 97) anon75_Else_correct)))))
(let ((anon74_Then_correct  (=> (and (_module.Expression.exprIf_q |expr#0@@16|) (_module.Expression.exprLiteral_q (_module.Expression.cond |expr#0@@16|))) (and (=> (= (ControlFlow 0 98) (- 0 100)) (_module.Expression.exprIf_q |expr#0@@16|)) (=> (_module.Expression.exprIf_q |expr#0@@16|) (and (=> (= (ControlFlow 0 98) (- 0 99)) (_module.Expression.exprLiteral_q (_module.Expression.cond |expr#0@@16|))) (=> (_module.Expression.exprLiteral_q (_module.Expression.cond |expr#0@@16|)) (and (=> (= (ControlFlow 0 98) 9) anon75_Then_correct) (=> (= (ControlFlow 0 98) 97) anon75_Else_correct)))))))))
(let ((anon73_Else_correct  (=> (not (_module.Expression.exprIf_q |expr#0@@16|)) (and (=> (= (ControlFlow 0 104) 98) anon74_Then_correct) (=> (= (ControlFlow 0 104) 101) anon74_Else_correct)))))
(let ((anon73_Then_correct  (=> (_module.Expression.exprIf_q |expr#0@@16|) (and (=> (= (ControlFlow 0 102) (- 0 103)) (_module.Expression.exprIf_q |expr#0@@16|)) (=> (_module.Expression.exprIf_q |expr#0@@16|) (and (=> (= (ControlFlow 0 102) 98) anon74_Then_correct) (=> (= (ControlFlow 0 102) 101) anon74_Else_correct)))))))
(let ((anon72_Else_correct  (=> (not (and (and (_module.Expression.exprIf_q |expr#0@@16|) (_module.Expression.exprLiteral_q (_module.Expression.cond |expr#0@@16|))) (|_module.Literal#Equal| (_module.Expression.lit (_module.Expression.cond |expr#0@@16|)) |#_module.Literal.litTrue|))) (and (=> (= (ControlFlow 0 105) 102) anon73_Then_correct) (=> (= (ControlFlow 0 105) 104) anon73_Else_correct)))))
(let ((anon72_Then_correct  (=> (and (and (_module.Expression.exprIf_q |expr#0@@16|) (_module.Expression.exprLiteral_q (_module.Expression.cond |expr#0@@16|))) (|_module.Literal#Equal| (_module.Expression.lit (_module.Expression.cond |expr#0@@16|)) |#_module.Literal.litTrue|)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (_module.Expression.exprIf_q |expr#0@@16|)) (=> (_module.Expression.exprIf_q |expr#0@@16|) (=> (= |##expr#1@0| (_module.Expression.ifTrue |expr#0@@16|)) (=> (and (and ($IsAlloc DatatypeTypeType |##expr#1@0| Tclass._module.Expression $Heap@@3) ($IsAlloc DatatypeTypeType |stC#0@@32| Tclass._module.StateC $Heap@@3)) (and ($IsAllocBox |env#0@@15| Tclass._module.Env $Heap@@3) (= (ControlFlow 0 6) (- 0 5)))) (< (DtRank |##expr#1@0|) (DtRank |expr#0@@16|)))))))))
(let ((anon71_Else_correct  (=> (not (and (_module.Expression.exprIf_q |expr#0@@16|) (_module.Expression.exprLiteral_q (_module.Expression.cond |expr#0@@16|)))) (and (=> (= (ControlFlow 0 109) 6) anon72_Then_correct) (=> (= (ControlFlow 0 109) 105) anon72_Else_correct)))))
(let ((anon71_Then_correct  (=> (and (_module.Expression.exprIf_q |expr#0@@16|) (_module.Expression.exprLiteral_q (_module.Expression.cond |expr#0@@16|))) (and (=> (= (ControlFlow 0 106) (- 0 108)) (_module.Expression.exprIf_q |expr#0@@16|)) (=> (_module.Expression.exprIf_q |expr#0@@16|) (and (=> (= (ControlFlow 0 106) (- 0 107)) (_module.Expression.exprLiteral_q (_module.Expression.cond |expr#0@@16|))) (=> (_module.Expression.exprLiteral_q (_module.Expression.cond |expr#0@@16|)) (and (=> (= (ControlFlow 0 106) 6) anon72_Then_correct) (=> (= (ControlFlow 0 106) 105) anon72_Else_correct)))))))))
(let ((anon70_Else_correct  (=> (not (_module.Expression.exprIf_q |expr#0@@16|)) (and (=> (= (ControlFlow 0 112) 106) anon71_Then_correct) (=> (= (ControlFlow 0 112) 109) anon71_Else_correct)))))
(let ((anon70_Then_correct  (=> (_module.Expression.exprIf_q |expr#0@@16|) (and (=> (= (ControlFlow 0 110) (- 0 111)) (_module.Expression.exprIf_q |expr#0@@16|)) (=> (_module.Expression.exprIf_q |expr#0@@16|) (and (=> (= (ControlFlow 0 110) 106) anon71_Then_correct) (=> (= (ControlFlow 0 110) 109) anon71_Else_correct)))))))
(let ((anon69_Else_correct  (=> (not (_module.Expression.exprIdentifier_q |expr#0@@16|)) (and (=> (= (ControlFlow 0 113) 110) anon70_Then_correct) (=> (= (ControlFlow 0 113) 112) anon70_Else_correct)))))
(let ((anon69_Then_correct  (=> (and (_module.Expression.exprIdentifier_q |expr#0@@16|) (= (ControlFlow 0 4) (- 0 3))) (_module.Expression.exprIdentifier_q |expr#0@@16|))))
(let ((anon68_Else_correct  (=> (not (_module.__default.Value |expr#0@@16|)) (and (=> (= (ControlFlow 0 114) 4) anon69_Then_correct) (=> (= (ControlFlow 0 114) 113) anon69_Else_correct)))))
(let ((anon68_Then_correct true))
(let ((anon67_Else_correct  (=> (and ($IsAlloc DatatypeTypeType |expr#0@@16| Tclass._module.Expression $Heap@@3) (|_module.__default.Value#canCall| |expr#0@@16|)) (and (=> (= (ControlFlow 0 115) 2) anon68_Then_correct) (=> (= (ControlFlow 0 115) 114) anon68_Else_correct)))))
(let ((anon67_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@3 alloc false)) (and (=> (= (ControlFlow 0 116) 1) anon67_Then_correct) (=> (= (ControlFlow 0 116) 115) anon67_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) ($Is DatatypeTypeType |expr#0@@16| Tclass._module.Expression)) (and (and ($Is DatatypeTypeType |stC#0@@32| Tclass._module.StateC) ($IsBox |env#0@@15| Tclass._module.Env)) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 117) 116)))) anon0_correct)))
