...
(set-info :boogie-vc-id Impl$$_module.__default.EvalArgsCLemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@3 alloc false)) (=> (and (and (and (|$IsA#_module.Expression| |expr#0@@16|) (|$IsA#_module.StateC| |stC#0@@32|)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (= $Heap@@3 $Heap@0) (forall ((|$ih#expr0#0| T@U) (|$ih#args0#0| T@U) (|$ih#stC0#0| T@U) ) (!  (=> (and (and (and (and ($Is DatatypeTypeType |$ih#expr0#0| Tclass._module.Expression) ($Is SeqType |$ih#args0#0| (TSeq Tclass._module.Expression))) ($Is DatatypeTypeType |$ih#stC0#0| Tclass._module.StateC)) (and (_module.__default.ConsistentCache |$ih#stC0#0|) (forall ((|arg#3@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#3@@1| Tclass._module.Expression) (=> (|Seq#Contains| |$ih#args0#0| ($Box DatatypeTypeType |arg#3@@1|)) (< (DtRank |arg#3@@1|) (DtRank |$ih#expr0#0|))))
 :qid |CloudMakeConsistentBuildslegacydfy.633:19|
 :skolemid |1238|
 :pattern ( (|Seq#Contains| |$ih#args0#0| ($Box DatatypeTypeType |arg#3@@1|)))
)))) (or (< (DtRank |$ih#expr0#0|) (DtRank |expr#0@@16|)) (and (= (DtRank |$ih#expr0#0|) (DtRank |expr#0@@16|)) (and (<= 0 (+ (|Seq#Length| |$ih#args0#0|) 1)) (< (+ (|Seq#Length| |$ih#args0#0|) 1) (+ (|Seq#Length| |args#0@@11|) 1)))))) (let ((|result#1@@5| (_module.__default.evalArgsC ($LS $LZ) |$ih#expr0#0| |$ih#args0#0| |$ih#stC0#0| |env#0@@15|)))
(let ((|stsC'#1@@1| ($Unbox SetType (_module.Tuple.snd |result#1@@5|))))
(forall ((|stC'#2@@3| T@U) ) (!  (=> ($Is DatatypeTypeType |stC'#2@@3| Tclass._module.StateC) (=> (|Set#IsMember| |stsC'#1@@1| ($Box DatatypeTypeType |stC'#2@@3|)) (_module.__default.ConsistentCache |stC'#2@@3|)))
 :qid |CloudMakeConsistentBuildslegacydfy.637:12|
 :skolemid |1239|
 :pattern ( (_module.__default.ConsistentCache |stC'#2@@3|))
 :pattern ( (|Set#IsMember| |stsC'#1@@1| ($Box DatatypeTypeType |stC'#2@@3|)))
)))))
 :qid |CloudMakeConsistentBuildslegacydfy.631:22|
 :skolemid |1240|
 :pattern ( (_module.__default.evalArgsC ($LS $LZ) |$ih#expr0#0| |$ih#args0#0| |$ih#stC0#0| |env#0@@15|))
))) (and (= |args'##0@0| (Lit SeqType |Seq#Empty|)) (= |stsC'##0@0| (Lit SetType |Set#Empty|))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (or (<= 0 (+ (|Seq#Length| |args#0@@11|) 1)) (< (DtRank |expr#0@@16|) (DtRank |expr#0@@16|))) (= (|Seq#Length| |args#0@@11|) (+ (|Seq#Length| |args#0@@11|) 1)))) (=> (or (or (<= 0 (+ (|Seq#Length| |args#0@@11|) 1)) (< (DtRank |expr#0@@16|) (DtRank |expr#0@@16|))) (= (|Seq#Length| |args#0@@11|) (+ (|Seq#Length| |args#0@@11|) 1))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (< (DtRank |expr#0@@16|) (DtRank |expr#0@@16|)) (and (= (DtRank |expr#0@@16|) (DtRank |expr#0@@16|)) (< (|Seq#Length| |args#0@@11|) (+ (|Seq#Length| |args#0@@11|) 1))))) (=> (or (< (DtRank |expr#0@@16|) (DtRank |expr#0@@16|)) (and (= (DtRank |expr#0@@16|) (DtRank |expr#0@@16|)) (< (|Seq#Length| |args#0@@11|) (+ (|Seq#Length| |args#0@@11|) 1)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.__default.ConsistentCache#canCall| |stC#0@@32|) (or (_module.__default.ConsistentCache |stC#0@@32|) (forall ((|cmd#0@@19| T@U) (|deps#0@@18| T@U) (|e#0@@10| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#0@@19| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@18| Tclass._module.Expression)) ($Is SeqType |e#0@@10| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@32|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@19| |deps#0@@18| |e#0@@10|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@32|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0@@19| |deps#0@@18| |e#0@@10|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1247|
...
)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((|stC'#1@@6| T@U) ) (!  (=> ($Is DatatypeTypeType |stC'#1@@6| Tclass._module.StateC) (=> (|Set#IsMember| |stsC'##0@0| ($Box DatatypeTypeType |stC'#1@@6|)) (_module.__default.ConsistentCache |stC'#1@@6|)))
 :qid |CloudMakeConsistentBuildslegacydfy.647:19|
 :skolemid |1249|
 :pattern ( (_module.__default.ConsistentCache |stC'#1@@6|))
 :pattern ( (|Set#IsMember| |stsC'##0@0| ($Box DatatypeTypeType |stC'#1@@6|)))
))) (=> (forall ((|stC'#1@@7| T@U) ) (!  (=> ($Is DatatypeTypeType |stC'#1@@7| Tclass._module.StateC) (=> (|Set#IsMember| |stsC'##0@0| ($Box DatatypeTypeType |stC'#1@@7|)) (_module.__default.ConsistentCache |stC'#1@@7|)))
 :qid |CloudMakeConsistentBuildslegacydfy.647:19|
 :skolemid |1249|
 :pattern ( (_module.__default.ConsistentCache |stC'#1@@7|))
 :pattern ( (|Set#IsMember| |stsC'##0@0| ($Box DatatypeTypeType |stC'#1@@7|)))
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((|arg#1@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#1@@1| Tclass._module.Expression) (=> (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#1@@1|)) (< (DtRank |arg#1@@1|) (DtRank |expr#0@@16|))))
 :qid |CloudMakeConsistentBuildslegacydfy.648:19|
 :skolemid |1250|
 :pattern ( (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#1@@1|)))
))) (=> (forall ((|arg#1@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#1@@2| Tclass._module.Expression) (=> (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#1@@2|)) (< (DtRank |arg#1@@2|) (DtRank |expr#0@@16|))))
 :qid |CloudMakeConsistentBuildslegacydfy.648:19|
 :skolemid |1250|
 :pattern ( (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#1@@2|)))
)) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and (|_module.__default.evalArgsC_k#canCall| |expr#0@@16| |args#0@@11| |stC#0@@32| |env#0@@15| |args'##0@0| |stsC'##0@0|) (let ((|result#0@@6| (_module.__default.evalArgsC_k ($LS $LZ) |expr#0@@16| |args#0@@11| |stC#0@@32| |env#0@@15| |args'##0@0| |stsC'##0@0|)))
 (and (_module.Tuple.Pair_q |result#0@@6|) (let ((|stsC''#0@@1| ($Unbox SetType (_module.Tuple.snd |result#0@@6|))))
(forall ((|stC''#1| T@U) ) (!  (=> ($Is DatatypeTypeType |stC''#1| Tclass._module.StateC) (=> (|Set#IsMember| |stsC''#0@@1| ($Box DatatypeTypeType |stC''#1|)) (|_module.__default.ConsistentCache#canCall| |stC''#1|)))
...
)))))) (let ((|result#0@@7| (_module.__default.evalArgsC_k ($LS ($LS $LZ)) |expr#0@@16| |args#0@@11| |stC#0@@32| |env#0@@15| |args'##0@0| |stsC'##0@0|)))
(let ((|stsC''#0@@2| ($Unbox SetType (_module.Tuple.snd |result#0@@7|))))
(forall ((|stC''#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |stC''#1@@0| Tclass._module.StateC) (=> (|Set#IsMember| |stsC''#0@@2| ($Box DatatypeTypeType |stC''#1@@0|)) (_module.__default.ConsistentCache |stC''#1@@0|)))
 :qid |CloudMakeConsistentBuildslegacydfy.652:12|
 :skolemid |1254|
 :pattern ( (_module.__default.ConsistentCache |stC''#1@@0|))
 :pattern ( (|Set#IsMember| |stsC''#0@@2| ($Box DatatypeTypeType |stC''#1@@0|)))
))))) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 2) (- 0 1)))) (let ((|result#0@@8| (_module.__default.evalArgsC ($LS ($LS $LZ)) |expr#0@@16| |args#0@@11| |stC#0@@32| |env#0@@15|)))
(let ((|stsC'#0@@6| ($Unbox SetType (_module.Tuple.snd |result#0@@8|))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and (and (and (and ($Is DatatypeTypeType |expr#0@@16| Tclass._module.Expression) ($IsAlloc DatatypeTypeType |expr#0@@16| Tclass._module.Expression $Heap@@3)) (|$IsA#_module.Expression| |expr#0@@16|)) (and ($Is SeqType |args#0@@11| (TSeq Tclass._module.Expression)) ($IsAlloc SeqType |args#0@@11| (TSeq Tclass._module.Expression) $Heap@@3))) (and (and ($Is DatatypeTypeType |stC#0@@32| Tclass._module.StateC) ($IsAlloc DatatypeTypeType |stC#0@@32| Tclass._module.StateC $Heap@@3)) (|$IsA#_module.StateC| |stC#0@@32|))) (and (and (and ($IsBox |env#0@@15| Tclass._module.Env) ($IsAllocBox |env#0@@15| Tclass._module.Env $Heap@@3)) (= 7 $FunctionContextHeight)) (and (and (|_module.__default.ConsistentCache#canCall| |stC#0@@32|) (and (_module.__default.ConsistentCache |stC#0@@32|) (forall ((|cmd#1@@2| T@U) (|deps#1@@2| T@U) (|e#1@@9| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#1@@2| Tclass._module.Expression) ($Is DatatypeTypeType |deps#1@@2| Tclass._module.Expression)) ($Is SeqType |e#1@@9| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@32|)) (_module.__default.Hash (_module.__default.Loc |cmd#1@@2| |deps#1@@2| |e#1@@9|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@32|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#1@@2| |deps#1@@2| |e#1@@9|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |1232|
