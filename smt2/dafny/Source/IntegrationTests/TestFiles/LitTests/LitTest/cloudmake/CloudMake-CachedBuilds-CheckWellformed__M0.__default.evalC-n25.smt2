...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (|p#0@@2| T@U) (|st#0@@3| T@U) ) (!  (=> (and (or (|M0.__default.GetSt#canCall| |p#0@@2| |st#0@@3|) (and (< 1 $FunctionContextHeight) (and (and (and ($IsBox |p#0@@2| Tclass.M0.Path) ($IsAllocBox |p#0@@2| Tclass.M0.Path $Heap)) (and ($IsBox |st#0@@3| Tclass.M0.State) ($IsAllocBox |st#0@@3| Tclass.M0.State $Heap))) (|Set#IsMember| (M0.__default.DomSt |st#0@@3|) |p#0@@2|)))) ($IsGoodHeap $Heap)) ($IsAllocBox (M0.__default.GetSt |p#0@@2| |st#0@@3|) Tclass.M0.Artifact $Heap))
 :qid |CloudMakeCachedBuildsdfy.10:18|
 :skolemid |702|
 :pattern ( ($IsAllocBox (M0.__default.GetSt |p#0@@2| |st#0@@3|) Tclass.M0.Artifact $Heap))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|stOrig#0| T@U) (|stCombined#0| T@U) (|args#0@@1| T@U) (|useCache#0| Bool) ) (!  (=> (or (|M0.__default.evalCore#canCall| |stOrig#0| |stCombined#0| |args#0@@1| |useCache#0|) (and (< 4 $FunctionContextHeight) (and (and ($IsBox |stOrig#0| Tclass.M0.State) ($IsBox |stCombined#0| Tclass.M0.State)) ($Is SeqType |args#0@@1| (TSeq Tclass.M0.Expression))))) (and (and (and (|M0.__default.Arity#canCall| (Lit DatatypeTypeType |#M0.Primitive.primExec|)) (=> (= (|Seq#Length| |args#0@@1|) (LitInt (M0.__default.Arity (Lit DatatypeTypeType |#M0.Primitive.primExec|)))) (|M0.__default.ValidArgs#canCall| (Lit DatatypeTypeType |#M0.Primitive.primExec|) |args#0@@1| |stCombined#0|))) (=> (and (= (|Seq#Length| |args#0@@1|) (LitInt (M0.__default.Arity (Lit DatatypeTypeType |#M0.Primitive.primExec|)))) (M0.__default.ValidArgs (Lit DatatypeTypeType |#M0.Primitive.primExec|) |args#0@@1| |stCombined#0|)) (let ((|exps#0@@1| (M0.Literal.strs (M0.Expression.lit ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@1| (LitInt 2)))))))
...
(let ((|cmd#0@@4| (M0.Literal.str (M0.Expression.lit ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@1| (LitInt 0)))))))
 (and (=> (not |useCache#0|) (and (|M0.__default.exec#canCall| |cmd#0@@4| |deps#0@@4| |exps#0@@1| |stCombined#0|) (let ((|ps#0| (M0.__default.exec |cmd#0@@4| |deps#0@@4| |exps#0@@1| |stCombined#0|)))
 (and (M0.Tuple.Pair_q |ps#0|) (M0.Tuple.Pair_q |ps#0|))))) (=> |useCache#0| (and (|M0.__default.ConsistentCache#canCall| |stCombined#0|) (=> (M0.__default.ConsistentCache |stCombined#0|) (and (|M0.__default.execC#canCall| |cmd#0@@4| |deps#0@@4| |exps#0@@1| |stCombined#0|) (let ((|ps#1| (M0.__default.execC |cmd#0@@4| |deps#0@@4| |exps#0@@1| |stCombined#0|)))
 (and (M0.Tuple.Pair_q |ps#1|) (M0.Tuple.Pair_q |ps#1|))))))))))))) (= (M0.__default.evalCore |stOrig#0| |stCombined#0| |args#0@@1| |useCache#0|) (ite  (and (= (|Seq#Length| |args#0@@1|) (LitInt (M0.__default.Arity (Lit DatatypeTypeType |#M0.Primitive.primExec|)))) (M0.__default.ValidArgs (Lit DatatypeTypeType |#M0.Primitive.primExec|) |args#0@@1| |stCombined#0|)) (let ((|exps#0@@2| (M0.Literal.strs (M0.Expression.lit ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@1| (LitInt 2)))))))
...
(ite  (not |useCache#0|) (let ((|ps#0@@0| (M0.__default.exec |cmd#0@@5| |deps#0@@5| |exps#0@@2| |stCombined#0|)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|cmd#0@@6| T@U) (|deps#0@@6| T@U) (|exps#0@@3| T@U) (|st#0@@5| T@U) ) (!  (=> (or (|M0.__default.Pre#canCall| (Lit SeqType |cmd#0@@6|) (Lit SetType |deps#0@@6|) (Lit SetType |exps#0@@3|) (Lit BoxType |st#0@@5|)) (and (< 2 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@6| (TSeq TChar)) ($Is SetType |deps#0@@6| (TSet Tclass.M0.Path))) ($Is SetType |exps#0@@3| (TSet (TSeq TChar)))) ($IsBox |st#0@@5| Tclass.M0.State)))) (and (forall ((|e#2| T@U) ) (!  (=> ($Is SeqType |e#2| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@3|) ($Box SeqType |e#2|)) (and (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@6|) (Lit SetType |deps#0@@6|) |e#2|) (|M0.__default.DomSt#canCall| (Lit BoxType |st#0@@5|))) (=> (|Set#IsMember| (M0.__default.DomSt (Lit BoxType |st#0@@5|)) (M0.__default.Loc (Lit SeqType |cmd#0@@6|) (Lit SetType |deps#0@@6|) |e#2|)) (and (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@6|) (Lit SetType |deps#0@@6|) |e#2|) (|M0.__default.GetSt#canCall| (M0.__default.Loc (Lit SeqType |cmd#0@@6|) (Lit SetType |deps#0@@6|) |e#2|) (Lit BoxType |st#0@@5|))) (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@6|) (Lit SetType |deps#0@@6|) |e#2|) (|M0.__default.Oracle#canCall| (M0.__default.Loc (Lit SeqType |cmd#0@@6|) (Lit SetType |deps#0@@6|) |e#2|) (Lit BoxType |st#0@@5|))))))))
...
)) (= (M0.__default.Pre (Lit SeqType |cmd#0@@6|) (Lit SetType |deps#0@@6|) (Lit SetType |exps#0@@3|) (Lit BoxType |st#0@@5|)) (forall ((|e#2@@0| T@U) ) (!  (=> ($Is SeqType |e#2@@0| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@3|) ($Box SeqType |e#2@@0|)) (=> (|Set#IsMember| (M0.__default.DomSt (Lit BoxType |st#0@@5|)) (M0.__default.Loc (Lit SeqType |cmd#0@@6|) (Lit SetType |deps#0@@6|) |e#2@@0|)) (= (M0.__default.GetSt (M0.__default.Loc (Lit SeqType |cmd#0@@6|) (Lit SetType |deps#0@@6|) |e#2@@0|) (Lit BoxType |st#0@@5|)) (M0.__default.Oracle (M0.__default.Loc (Lit SeqType |cmd#0@@6|) (Lit SetType |deps#0@@6|) |e#2@@0|) (Lit BoxType |st#0@@5|))))))
 :qid |CloudMakeCachedBuildsdfy.158:12|
 :skolemid |923|
 ...
 :weight 3
 :skolemid |925|
 :pattern ( (M0.__default.Pre (Lit SeqType |cmd#0@@6|) (Lit SetType |deps#0@@6|) (Lit SetType |exps#0@@3|) (Lit BoxType |st#0@@5|)))
))))
...
))) (and (|M0.__default.exec#canCall| |cmd#0@@7| |deps#0@@7| |exps#0@@4| |stC#0@@0|) (let ((|result#0| (M0.__default.exec |cmd#0@@7| |deps#0@@7| |exps#0@@4| |stC#0@@0|)))
 (and (and (M0.Tuple.Pair_q |result#0|) (M0.Tuple.Pair_q |result#0|)) (let ((|st'#0@@0| (M0.Tuple.snd |result#0|)))
(|M0.__default.UpdateC#canCall| |cmd#0@@7| |deps#0@@7| |exps#0@@4| |st'#0@@0|))))))) (= (M0.__default.execC |cmd#0@@7| |deps#0@@7| |exps#0@@4| |stC#0@@0|) (ite (forall ((|e#0@@5| T@U) ) (!  (=> (and ($Is SeqType |e#0@@5| (TSeq TChar)) (|Set#IsMember| |exps#0@@4| ($Box SeqType |e#0@@5|))) (|Set#IsMember| (M0.__default.DomC |stC#0@@0|) (M0.__default.Hash (M0.__default.Loc |cmd#0@@7| |deps#0@@7| |e#0@@5|))))
 :qid |CloudMakeCachedBuildsdfy.211:15|
 :skolemid |1023|
...
(|#M0.Tuple.Pair| ($Box SetType |paths#0|) |stC#0@@0|)) (let ((|result#0@@0| (M0.__default.exec |cmd#0@@7| |deps#0@@7| |exps#0@@4| |stC#0@@0|)))
(let ((|st'#0@@1| (M0.Tuple.snd |result#0@@0|)))
(let ((|expr'#0| ($Unbox SetType (M0.Tuple.fst |result#0@@0|))))
(let ((|stC'#0| (M0.__default.UpdateC |cmd#0@@7| |deps#0@@7| |exps#0@@4| |st'#0@@1|)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|cmd#0@@9| T@U) (|deps#0@@9| T@U) (|exps#0@@6| T@U) (|st#0@@6| T@U) ) (!  (=> (or (|M0.__default.exec#canCall| |cmd#0@@9| |deps#0@@9| |exps#0@@6| |st#0@@6|) (and (< 1 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@9| (TSeq TChar)) ($Is SetType |deps#0@@9| (TSet Tclass.M0.Path))) ($Is SetType |exps#0@@6| (TSet (TSeq TChar)))) ($IsBox |st#0@@6| Tclass.M0.State)))) ($Is DatatypeTypeType (M0.__default.exec |cmd#0@@9| |deps#0@@9| |exps#0@@6| |st#0@@6|) (Tclass.M0.Tuple (TSet Tclass.M0.Path) Tclass.M0.State)))
 :qid |CloudMakeCachedBuildsdfy.140:23|
 :skolemid |903|
 :pattern ( (M0.__default.exec |cmd#0@@9| |deps#0@@9| |exps#0@@6| |st#0@@6|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|cmd#0@@12| T@U) (|deps#0@@12| T@U) (|exps#0@@9| T@U) (|st#0@@7| T@U) ) (!  (=> (or (|M0.__default.Pre#canCall| (Lit SeqType |cmd#0@@12|) (Lit SetType |deps#0@@12|) (Lit SetType |exps#0@@9|) |st#0@@7|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@12| (TSeq TChar)) ($Is SetType |deps#0@@12| (TSet Tclass.M0.Path))) ($Is SetType |exps#0@@9| (TSet (TSeq TChar)))) ($IsBox |st#0@@7| Tclass.M0.State)))) (and (forall ((|e#1@@1| T@U) ) (!  (=> ($Is SeqType |e#1@@1| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType |exps#0@@9|) ($Box SeqType |e#1@@1|)) (and (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@12|) (Lit SetType |deps#0@@12|) |e#1@@1|) (|M0.__default.DomSt#canCall| |st#0@@7|)) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@7|) (M0.__default.Loc (Lit SeqType |cmd#0@@12|) (Lit SetType |deps#0@@12|) |e#1@@1|)) (and (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@12|) (Lit SetType |deps#0@@12|) |e#1@@1|) (|M0.__default.GetSt#canCall| (M0.__default.Loc (Lit SeqType |cmd#0@@12|) (Lit SetType |deps#0@@12|) |e#1@@1|) |st#0@@7|)) (and (|M0.__default.Loc#canCall| (Lit SeqType |cmd#0@@12|) (Lit SetType |deps#0@@12|) |e#1@@1|) (|M0.__default.Oracle#canCall| (M0.__default.Loc (Lit SeqType |cmd#0@@12|) (Lit SetType |deps#0@@12|) |e#1@@1|) |st#0@@7|)))))))
 ...
 :weight 3
 :skolemid |922|
 :pattern ( (M0.__default.Pre (Lit SeqType |cmd#0@@12|) (Lit SetType |deps#0@@12|) (Lit SetType |exps#0@@9|) |st#0@@7|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|p#0@@3| T@U) ) (!  (=> (or (|M0.__default.Hash#canCall| |p#0@@3|) (and (< 0 $FunctionContextHeight) ($IsBox |p#0@@3| Tclass.M0.Path))) ($IsBox (M0.__default.Hash |p#0@@3|) Tclass.M0.HashValue))
 :qid |CloudMakeCachedBuildsdfy.16:23|
 :skolemid |708|
 :pattern ( (M0.__default.Hash |p#0@@3|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@1 T@U) (|p#0@@4| T@U) ) (!  (=> (and (or (|M0.__default.Hash#canCall| |p#0@@4|) (and (< 0 $FunctionContextHeight) (and ($IsBox |p#0@@4| Tclass.M0.Path) ($IsAllocBox |p#0@@4| Tclass.M0.Path $Heap@@1)))) ($IsGoodHeap $Heap@@1)) ($IsAllocBox (M0.__default.Hash |p#0@@4|) Tclass.M0.HashValue $Heap@@1))
 :qid |CloudMakeCachedBuildsdfy.16:18|
 :skolemid |709|
 :pattern ( ($IsAllocBox (M0.__default.Hash |p#0@@4|) Tclass.M0.HashValue $Heap@@1))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|cmd#0@@13| T@U) (|deps#0@@13| T@U) (|exps#0@@10| T@U) (|st#0@@10| T@U) ) (!  (=> (or (|M0.__default.Pre#canCall| |cmd#0@@13| |deps#0@@13| |exps#0@@10| |st#0@@10|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is SeqType |cmd#0@@13| (TSeq TChar)) ($Is SetType |deps#0@@13| (TSet Tclass.M0.Path))) ($Is SetType |exps#0@@10| (TSet (TSeq TChar)))) ($IsBox |st#0@@10| Tclass.M0.State)))) (and (forall ((|e#0@@6| T@U) ) (!  (=> ($Is SeqType |e#0@@6| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@10| ($Box SeqType |e#0@@6|)) (and (and (|M0.__default.Loc#canCall| |cmd#0@@13| |deps#0@@13| |e#0@@6|) (|M0.__default.DomSt#canCall| |st#0@@10|)) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@10|) (M0.__default.Loc |cmd#0@@13| |deps#0@@13| |e#0@@6|)) (and (and (|M0.__default.Loc#canCall| |cmd#0@@13| |deps#0@@13| |e#0@@6|) (|M0.__default.GetSt#canCall| (M0.__default.Loc |cmd#0@@13| |deps#0@@13| |e#0@@6|) |st#0@@10|)) (and (|M0.__default.Loc#canCall| |cmd#0@@13| |deps#0@@13| |e#0@@6|) (|M0.__default.Oracle#canCall| (M0.__default.Loc |cmd#0@@13| |deps#0@@13| |e#0@@6|) |st#0@@10|)))))))
 :qid |CloudMakeCachedBuildsdfy.158:12|
 :skolemid |918|
 :pattern ( (M0.__default.Loc |cmd#0@@13| |deps#0@@13| |e#0@@6|))
 :pattern ( (|Set#IsMember| |exps#0@@10| ($Box SeqType |e#0@@6|)))
)) (= (M0.__default.Pre |cmd#0@@13| |deps#0@@13| |exps#0@@10| |st#0@@10|) (forall ((|e#0@@7| T@U) ) (!  (=> ($Is SeqType |e#0@@7| (TSeq TChar)) (=> (|Set#IsMember| |exps#0@@10| ($Box SeqType |e#0@@7|)) (=> (|Set#IsMember| (M0.__default.DomSt |st#0@@10|) (M0.__default.Loc |cmd#0@@13| |deps#0@@13| |e#0@@7|)) (= (M0.__default.GetSt (M0.__default.Loc |cmd#0@@13| |deps#0@@13| |e#0@@7|) |st#0@@10|) (M0.__default.Oracle (M0.__default.Loc |cmd#0@@13| |deps#0@@13| |e#0@@7|) |st#0@@10|)))))
 :qid |CloudMakeCachedBuildsdfy.158:12|
 :skolemid |917|
 ...
 :qid |CloudMakeCachedBuildsdfy.156:23|
 :skolemid |919|
 :pattern ( (M0.__default.Pre |cmd#0@@13| |deps#0@@13| |exps#0@@10| |st#0@@10|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@2 T@U) (|st#0@@11| T@U) ) (!  (=> (and (or (|M0.__default.DomC#canCall| |st#0@@11|) (and (< 0 $FunctionContextHeight) (and ($IsBox |st#0@@11| Tclass.M0.State) ($IsAllocBox |st#0@@11| Tclass.M0.State $Heap@@2)))) ($IsGoodHeap $Heap@@2)) ($IsAlloc SetType (M0.__default.DomC |st#0@@11|) (TSet Tclass.M0.HashValue) $Heap@@2))
 :qid |CloudMakeCachedBuildsdfy.15:18|
 :skolemid |706|
 :pattern ( ($IsAlloc SetType (M0.__default.DomC |st#0@@11|) (TSet Tclass.M0.HashValue) $Heap@@2))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|prim#0@@4| T@U) (|args#0@@3| T@U) (|st#0@@12| T@U) ) (!  (=> (or (|M0.__default.ValidArgs#canCall| (Lit DatatypeTypeType |prim#0@@4|) (Lit SeqType |args#0@@3|) |st#0@@12|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |prim#0@@4| Tclass.M0.Primitive) ($Is SeqType |args#0@@3| (TSeq Tclass.M0.Expression))) ($IsBox |st#0@@12| Tclass.M0.State)) (and (=> (M0.Primitive.primExec_q (Lit DatatypeTypeType |prim#0@@4|)) (= (|Seq#Length| (Lit SeqType |args#0@@3|)) (LitInt 3))) (=> (M0.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@4|)) (= (|Seq#Length| (Lit SeqType |args#0@@3|)) (LitInt 1))))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (M0.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@4|)))))) (let ((|exps#3| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@3|) (LitInt 2)))))
...
(let ((|cmd#3| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@3|) (LitInt 0)))))
 (=> (M0.Expression.exprLiteral_q |cmd#3|) (=> (M0.Literal.litString_q (M0.Expression.lit |cmd#3|)) (=> (M0.Expression.exprLiteral_q |deps#3|) (=> (M0.Literal.litArrOfPaths_q (M0.Expression.lit |deps#3|)) (=> (M0.Expression.exprLiteral_q |exps#3|) (=> (M0.Literal.litArrOfStrings_q (M0.Expression.lit |exps#3|)) (and (|M0.__default.DomSt#canCall| |st#0@@12|) (=> (|Set#Subset| (M0.Literal.paths (M0.Expression.lit |deps#3|)) (M0.__default.DomSt |st#0@@12|)) (|M0.__default.Pre#canCall| (M0.Literal.str (M0.Expression.lit |cmd#3|)) (M0.Literal.paths (M0.Expression.lit |deps#3|)) (M0.Literal.strs (M0.Expression.lit |exps#3|)) |st#0@@12|))))))))))))) (= (M0.__default.ValidArgs (Lit DatatypeTypeType |prim#0@@4|) (Lit SeqType |args#0@@3|) |st#0@@12|) (ite (M0.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@4|)) false (let ((|exps#2| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@3|) (LitInt 2)))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@3 T@U) (|p#0@@5| T@U) (|st#0@@13| T@U) ) (!  (=> (and (or (|M0.__default.Oracle#canCall| |p#0@@5| |st#0@@13|) (and (< 0 $FunctionContextHeight) (and (and ($IsBox |p#0@@5| Tclass.M0.Path) ($IsAllocBox |p#0@@5| Tclass.M0.Path $Heap@@3)) (and ($IsBox |st#0@@13| Tclass.M0.State) ($IsAllocBox |st#0@@13| Tclass.M0.State $Heap@@3))))) ($IsGoodHeap $Heap@@3)) ($IsAllocBox (M0.__default.Oracle |p#0@@5| |st#0@@13|) Tclass.M0.Artifact $Heap@@3))
 :qid |CloudMakeCachedBuildsdfy.186:18|
 :skolemid |985|
 :pattern ( ($IsAllocBox (M0.__default.Oracle |p#0@@5| |st#0@@13|) Tclass.M0.Artifact $Heap@@3))
))))
...
(set-info :boogie-vc-id CheckWellformed$$M0.__default.evalCore)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon17_Else_correct true))
(let ((anon17_Then_correct true))
(let ((anon16_Else_correct  (=> |useCache#0@@4| (=> (and ($IsAllocBox |stCombined#0@@4| Tclass.M0.State $Heap@@4) (|M0.__default.ConsistentCache#canCall| |stCombined#0@@4|)) (and (=> (= (ControlFlow 0 6) 4) anon17_Then_correct) (=> (= (ControlFlow 0 6) 5) anon17_Else_correct))))))
(let ((anon16_Then_correct true))
(let ((anon15_Then_correct  (=> (and (= (|Seq#Length| |args#0@@7|) (LitInt (M0.__default.Arity (Lit DatatypeTypeType |#M0.Primitive.primExec|)))) (M0.__default.ValidArgs (Lit DatatypeTypeType |#M0.Primitive.primExec|) |args#0@@7| |stCombined#0@@4|)) (and (=> (= (ControlFlow 0 7) (- 0 16)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |args#0@@7|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |args#0@@7|))) (and (=> (= (ControlFlow 0 7) (- 0 15)) (M0.Expression.exprLiteral_q ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@7| (LitInt 0))))) (=> (M0.Expression.exprLiteral_q ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@7| (LitInt 0)))) (and (=> (= (ControlFlow 0 7) (- 0 14)) (M0.Literal.litString_q (M0.Expression.lit ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@7| (LitInt 0)))))) (=> (M0.Literal.litString_q (M0.Expression.lit ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@7| (LitInt 0))))) (=> (= |let#0#0#0| (M0.Literal.str (M0.Expression.lit ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@7| (LitInt 0)))))) (=> (and ($Is SeqType |let#0#0#0| (TSeq TChar)) (= |cmd#Z#0@0| |let#0#0#0|)) (and (=> (= (ControlFlow 0 7) (- 0 13)) (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |args#0@@7|)))) (=> (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |args#0@@7|))) (and (=> (= (ControlFlow 0 7) (- 0 12)) (M0.Expression.exprLiteral_q ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@7| (LitInt 1))))) (=> (M0.Expression.exprLiteral_q ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@7| (LitInt 1)))) (and (=> (= (ControlFlow 0 7) (- 0 11)) (M0.Literal.litArrOfPaths_q (M0.Expression.lit ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@7| (LitInt 1)))))) (=> (M0.Literal.litArrOfPaths_q (M0.Expression.lit ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@7| (LitInt 1))))) (=> (= |let#0#1#0| (M0.Literal.paths (M0.Expression.lit ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@7| (LitInt 1)))))) (=> (and ($Is SetType |let#0#1#0| (TSet Tclass.M0.Path)) (= |deps#Z#0@0| |let#0#1#0|)) (and (=> (= (ControlFlow 0 7) (- 0 10)) (and (<= 0 (LitInt 2)) (< (LitInt 2) (|Seq#Length| |args#0@@7|)))) (=> (and (<= 0 (LitInt 2)) (< (LitInt 2) (|Seq#Length| |args#0@@7|))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (M0.Expression.exprLiteral_q ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@7| (LitInt 2))))) (=> (M0.Expression.exprLiteral_q ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@7| (LitInt 2)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (M0.Literal.litArrOfStrings_q (M0.Expression.lit ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@7| (LitInt 2)))))) (=> (M0.Literal.litArrOfStrings_q (M0.Expression.lit ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@7| (LitInt 2))))) (=> (= |let#0#2#0| (M0.Literal.strs (M0.Expression.lit ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@7| (LitInt 2)))))) (=> (and ($Is SetType |let#0#2#0| (TSet (TSeq TChar))) (= |exps#Z#0@0| |let#0#2#0|)) (and (=> (= (ControlFlow 0 7) 3) anon16_Then_correct) (=> (= (ControlFlow 0 7) 6) anon16_Else_correct)))))))))))))))))))))))))))))
(let ((anon15_Else_correct true))
(let ((anon14_Else_correct  (=> (or (not (= (|Seq#Length| |args#0@@7|) (LitInt (M0.__default.Arity (Lit DatatypeTypeType |#M0.Primitive.primExec|))))) (not true)) (and (=> (= (ControlFlow 0 20) 7) anon15_Then_correct) (=> (= (ControlFlow 0 20) 2) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (= (|Seq#Length| |args#0@@7|) (LitInt (M0.__default.Arity (Lit DatatypeTypeType |#M0.Primitive.primExec|)))) (=> (and (and (= |##prim#1@0| (Lit DatatypeTypeType |#M0.Primitive.primExec|)) ($IsAlloc DatatypeTypeType |##prim#1@0| Tclass.M0.Primitive $Heap@@4)) (and ($IsAlloc SeqType |args#0@@7| (TSeq Tclass.M0.Expression) $Heap@@4) ($IsAllocBox |stCombined#0@@4| Tclass.M0.State $Heap@@4))) (and (=> (= (ControlFlow 0 17) (- 0 19)) (=> (M0.Primitive.primExec_q |##prim#1@0|) (= (|Seq#Length| |args#0@@7|) (LitInt 3)))) (=> (=> (M0.Primitive.primExec_q |##prim#1@0|) (= (|Seq#Length| |args#0@@7|) (LitInt 3))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (=> (M0.Primitive.primCreatePath_q |##prim#1@0|) (= (|Seq#Length| |args#0@@7|) (LitInt 1)))) (=> (and (=> (M0.Primitive.primCreatePath_q |##prim#1@0|) (= (|Seq#Length| |args#0@@7|) (LitInt 1))) (|M0.__default.ValidArgs#canCall| (Lit DatatypeTypeType |#M0.Primitive.primExec|) |args#0@@7| |stCombined#0@@4|)) (and (=> (= (ControlFlow 0 17) 7) anon15_Then_correct) (=> (= (ControlFlow 0 17) 2) anon15_Else_correct))))))))))
(let ((anon13_Else_correct  (=> (= |##prim#0@0| (Lit DatatypeTypeType |#M0.Primitive.primExec|)) (=> (and ($IsAlloc DatatypeTypeType |##prim#0@0| Tclass.M0.Primitive $Heap@@4) (|M0.__default.Arity#canCall| (Lit DatatypeTypeType |#M0.Primitive.primExec|))) (and (=> (= (ControlFlow 0 21) 17) anon14_Then_correct) (=> (= (ControlFlow 0 21) 20) anon14_Else_correct))))))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (and (=> (= (ControlFlow 0 22) 1) anon13_Then_correct) (=> (= (ControlFlow 0 22) 21) anon13_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) ($IsBox |stOrig#0@@4| Tclass.M0.State)) (and (and ($IsBox |stCombined#0@@4| Tclass.M0.State) ($Is SeqType |args#0@@7| (TSeq Tclass.M0.Expression))) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 23) 22)))) anon0_correct)))
