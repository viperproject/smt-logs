...
(set-info :boogie-vc-id CheckWellFormed$$M2.__default.Collect__CertificateInsensitivity)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#4| null $Heap@@6 alloc false)) ($IsAllocBox |p#0@@24| Tclass.M2.Path $Heap@@6)) (and ($IsAlloc DatatypeTypeType |cert0#0| Tclass.M2.WFCertificate $Heap@@6) (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert0#0|))) (=> (and (and (and (and (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert0#0|) ($IsAllocBox |p#0@@24| Tclass.M2.Path $Heap@@6)) (and ($IsAlloc DatatypeTypeType |cert1#0| Tclass.M2.WFCertificate $Heap@@6) (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert1#0|))) (and (and (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert1#0|) ($IsAllocBox |p#0@@24| Tclass.M2.Path $Heap@@6)) (and (|M2.__default.LocInv__Deps#canCall| |p#0@@24|) (|Set#Equal| |deps#0@@9| (M2.__default.LocInv__Deps |p#0@@24|))))) (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@6 $Heap@0)) (and (and ($IsAllocBox |p#0@@24| Tclass.M2.Path $Heap@0) ($IsAlloc DatatypeTypeType |cert0#0| Tclass.M2.WFCertificate $Heap@0)) (and ($IsAlloc SetType |deps#0@@9| (TSet Tclass.M2.Path) $Heap@0) ($IsAlloc DatatypeTypeType |st#0@@19| Tclass.M2.State $Heap@0))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert0#0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert0#0|) (= (M2.WFCertificate.p |cert0#0|) |p#0@@24|)))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert0#0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert0#0|) (forall ((|d#0@@9| T@U) ) (!  (=> ($IsBox |d#0@@9| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.LocInv__Deps |p#0@@24|) |d#0@@9|) (exists ((|c#0@@3| T@U) ) (!  (and ($Is DatatypeTypeType |c#0@@3| Tclass.M2.WFCertificate) (and (|Set#IsMember| (M2.WFCertificate.certs |cert0#0|) ($Box DatatypeTypeType |c#0@@3|)) (= (M2.WFCertificate.p |c#0@@3|) |d#0@@9|)))
 :qid |CloudMakeParallelBuildsdfy.497:49|
 :skolemid |3947|
...
))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert0#0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert0#0|) (forall ((|c#1@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |c#1@@2| Tclass.M2.WFCertificate) (=> (|Set#IsMember| (M2.WFCertificate.certs |cert0#0|) ($Box DatatypeTypeType |c#1@@2|)) (M2.__default.CheckWellFounded ($LS ($LS $LZ)) (M2.WFCertificate.p |c#1@@2|) |c#1@@2|)))
 :qid |CloudMakeParallelBuildsdfy.498:13|
 :skolemid |3949|
 :pattern ( (M2.WFCertificate.p |c#1@@2|))
 :pattern ( (|Set#IsMember| (M2.WFCertificate.certs |cert0#0|) ($Box DatatypeTypeType |c#1@@2|)))
))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (|Set#Equal| |deps#0@@9| (M2.__default.LocInv__Deps |p#0@@24|))) (=> (and (and (and (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert0#0|) (|Set#Equal| |deps#0@@9| (M2.__default.LocInv__Deps |p#0@@24|))) (|M2.__default.CollectDependencies#canCall| |p#0@@24| |cert0#0| |deps#0@@9| |st#0@@19|)) (and (and ($IsAllocBox |p#0@@24| Tclass.M2.Path $Heap@0) ($IsAlloc DatatypeTypeType |cert1#0| Tclass.M2.WFCertificate $Heap@0)) (and ($IsAlloc SetType |deps#0@@9| (TSet Tclass.M2.Path) $Heap@0) ($IsAlloc DatatypeTypeType |st#0@@19| Tclass.M2.State $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert1#0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert1#0|) (= (M2.WFCertificate.p |cert1#0|) |p#0@@24|)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert1#0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert1#0|) (forall ((|d#1@@2| T@U) ) (!  (=> ($IsBox |d#1@@2| Tclass.M2.Path) (=> (|Set#IsMember| (M2.__default.LocInv__Deps |p#0@@24|) |d#1@@2|) (exists ((|c#2@@3| T@U) ) (!  (and ($Is DatatypeTypeType |c#2@@3| Tclass.M2.WFCertificate) (and (|Set#IsMember| (M2.WFCertificate.certs |cert1#0|) ($Box DatatypeTypeType |c#2@@3|)) (= (M2.WFCertificate.p |c#2@@3|) |d#1@@2|)))
 :qid |CloudMakeParallelBuildsdfy.497:49|
 :skolemid |3954|
...
))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|M2.__default.CheckWellFounded#canCall| |p#0@@24| |cert1#0|) (or (M2.__default.CheckWellFounded ($LS $LZ) |p#0@@24| |cert1#0|) (forall ((|c#3@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |c#3@@2| Tclass.M2.WFCertificate) (=> (|Set#IsMember| (M2.WFCertificate.certs |cert1#0|) ($Box DatatypeTypeType |c#3@@2|)) (M2.__default.CheckWellFounded ($LS ($LS $LZ)) (M2.WFCertificate.p |c#3@@2|) |c#3@@2|)))
 :qid |CloudMakeParallelBuildsdfy.498:13|
 :skolemid |3956|
 :pattern ( (M2.WFCertificate.p |c#3@@2|))
 :pattern ( (|Set#IsMember| (M2.WFCertificate.certs |cert1#0|) ($Box DatatypeTypeType |c#3@@2|)))
))))) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#Equal| |deps#0@@9| (M2.__default.LocInv__Deps |p#0@@24|)))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (and ($IsBox |p#0@@24| Tclass.M2.Path) ($IsAllocBox |p#0@@24| Tclass.M2.Path $Heap@@6))) (and (and ($Is DatatypeTypeType |cert0#0| Tclass.M2.WFCertificate) ($IsAlloc DatatypeTypeType |cert0#0| Tclass.M2.WFCertificate $Heap@@6)) (|$IsA#M2.WFCertificate| |cert0#0|))) (=> (and (and (and (and ($Is DatatypeTypeType |cert1#0| Tclass.M2.WFCertificate) ($IsAlloc DatatypeTypeType |cert1#0| Tclass.M2.WFCertificate $Heap@@6)) (|$IsA#M2.WFCertificate| |cert1#0|)) (and ($Is SetType |deps#0@@9| (TSet Tclass.M2.Path)) ($IsAlloc SetType |deps#0@@9| (TSet Tclass.M2.Path) $Heap@@6))) (and (and (and ($Is DatatypeTypeType |st#0@@19| Tclass.M2.State) ($IsAlloc DatatypeTypeType |st#0@@19| Tclass.M2.State $Heap@@6)) (|$IsA#M2.State| |st#0@@19|)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 10) 2)))) anon0_correct))))
