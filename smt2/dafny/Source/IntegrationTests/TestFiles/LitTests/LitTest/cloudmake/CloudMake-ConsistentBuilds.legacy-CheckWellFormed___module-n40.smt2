...
(assert (forall ((a@@10 T@U) (b@@7 T@U) ) (! (= (|_module.Triple#Equal| a@@10 b@@7) (= a@@10 b@@7))
 :qid |unknown.0:0|
 :skolemid |1579|
 :pattern ( (|_module.Triple#Equal| a@@10 b@@7))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@3 T@U) (|cmd#0@@2| T@U) (|deps#0@@2| T@U) (|exts#0@@2| T@U) (|stC#0@@6| T@U) ) (!  (=> (or (|_module.__default.UpdateC#canCall| (Lit DatatypeTypeType |cmd#0@@2|) (Lit DatatypeTypeType |deps#0@@2|) (Lit DatatypeTypeType |exts#0@@2|) (Lit DatatypeTypeType |stC#0@@6|)) (and (< 3 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |cmd#0@@2| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@2| Tclass._module.Expression)) ($Is DatatypeTypeType |exts#0@@2| Tclass._module.Expression)) ($Is DatatypeTypeType |stC#0@@6| Tclass._module.StateC)) (U_2_bool (Lit boolType (bool_2_U  (and (and (and (and (and (_module.Expression.exprLiteral_q (Lit DatatypeTypeType |cmd#0@@2|)) (_module.Literal.litString_q (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |cmd#0@@2|))))) (_module.Expression.exprLiteral_q (Lit DatatypeTypeType |deps#0@@2|))) (_module.Literal.litArrOfPaths_q (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |deps#0@@2|))))) (_module.Expression.exprLiteral_q (Lit DatatypeTypeType |exts#0@@2|))) (_module.Literal.litArrOfStrings_q (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@2|))))))))))) (and (let ((|strs#2| (Lit SetType (_module.Literal.strs (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@2|)))))))
 (=> (not (|Set#Equal| |strs#2| |Set#Empty|)) (and (|_module.__default.Choose#canCall| |strs#2|) (let ((|e#3@@0| (_module.__default.Choose |strs#2|)))
 (and (and (and (and (|_module.__default.Loc#canCall| (Lit DatatypeTypeType |cmd#0@@2|) (Lit DatatypeTypeType |deps#0@@2|) |e#3@@0|) (|_module.__default.Hash#canCall| (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@2|) (Lit DatatypeTypeType |deps#0@@2|) |e#3@@0|))) (_module.StateC.S_q (Lit DatatypeTypeType |stC#0@@6|))) (|_module.__default.SetC#canCall| (_module.__default.Hash (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@2|) (Lit DatatypeTypeType |deps#0@@2|) |e#3@@0|)) (|#_module.Triple.Trio| ($Box DatatypeTypeType (Lit DatatypeTypeType |cmd#0@@2|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |deps#0@@2|)) ($Box SeqType |e#3@@0|)) (Lit BoxType (_module.StateC.c (Lit DatatypeTypeType |stC#0@@6|))))) (let ((|c'#2| (_module.__default.SetC (_module.__default.Hash (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@2|) (Lit DatatypeTypeType |deps#0@@2|) |e#3@@0|)) (|#_module.Triple.Trio| ($Box DatatypeTypeType (Lit DatatypeTypeType |cmd#0@@2|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |deps#0@@2|)) ($Box SeqType |e#3@@0|)) (Lit BoxType (_module.StateC.c (Lit DatatypeTypeType |stC#0@@6|))))))
(let ((|exts'#2| (|#_module.Expression.exprLiteral| (|#_module.Literal.litArrOfStrings| (|Set#Difference| |strs#2| (|Set#UnionOne| |Set#Empty| ($Box SeqType |e#3@@0|)))))))
 (and (_module.StateC.S_q (Lit DatatypeTypeType |stC#0@@6|)) (|_module.__default.UpdateC#canCall| (Lit DatatypeTypeType |cmd#0@@2|) (Lit DatatypeTypeType |deps#0@@2|) |exts'#2| (|#_module.StateC.S| (Lit BoxType (_module.StateC.st (Lit DatatypeTypeType |stC#0@@6|))) |c'#2|)))))))))) (= (_module.__default.UpdateC ($LS $ly@@3) (Lit DatatypeTypeType |cmd#0@@2|) (Lit DatatypeTypeType |deps#0@@2|) (Lit DatatypeTypeType |exts#0@@2|) (Lit DatatypeTypeType |stC#0@@6|)) (let ((|strs#2@@0| (Lit SetType (_module.Literal.strs (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@2|)))))))
(ite (|Set#Equal| |strs#2@@0| |Set#Empty|) |stC#0@@6| (let ((|e#3@@1| (Lit SeqType (_module.__default.Choose |strs#2@@0|))))
(let ((|c'#2@@0| (_module.__default.SetC (_module.__default.Hash (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@2|) (Lit DatatypeTypeType |deps#0@@2|) |e#3@@1|)) (Lit DatatypeTypeType (|#_module.Triple.Trio| ($Box DatatypeTypeType (Lit DatatypeTypeType |cmd#0@@2|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |deps#0@@2|)) ($Box SeqType |e#3@@1|))) (Lit BoxType (_module.StateC.c (Lit DatatypeTypeType |stC#0@@6|))))))
...
(_module.__default.UpdateC ($LS $ly@@3) (Lit DatatypeTypeType |cmd#0@@2|) (Lit DatatypeTypeType |deps#0@@2|) |exts'#2@@0| (|#_module.StateC.S| (Lit BoxType (_module.StateC.st (Lit DatatypeTypeType |stC#0@@6|))) |c'#2@@0|))))))))))
 :qid |CloudMakeConsistentBuildslegacydfy.41:16|
 :weight 3
 :skolemid |741|
 :pattern ( (_module.__default.UpdateC ($LS $ly@@3) (Lit DatatypeTypeType |cmd#0@@2|) (Lit DatatypeTypeType |deps#0@@2|) (Lit DatatypeTypeType |exts#0@@2|) (Lit DatatypeTypeType |stC#0@@6|)))
))))
...
(assert (forall ((d@@24 T@U) ) (! (= (_module.Tuple.Pair_q d@@24) (= (DatatypeCtorId d@@24) |##_module.Tuple.Pair|))
 :qid |unknown.0:0|
 :skolemid |1539|
 :pattern ( (_module.Tuple.Pair_q d@@24))
)))
(assert (forall ((d@@25 T@U) ) (! (= (_module.Triple.Trio_q d@@25) (= (DatatypeCtorId d@@25) |##_module.Triple.Trio|))
 :qid |unknown.0:0|
 :skolemid |1558|
 :pattern ( (_module.Triple.Trio_q d@@25))
)))
...
(assert (forall ((d@@26 T@U) ) (!  (=> (_module.Expression.exprIf_q d@@26) (exists ((|a#38#0#0| T@U) (|a#38#1#0| T@U) (|a#38#2#0| T@U) ) (! (= d@@26 (|#_module.Expression.exprIf| |a#38#0#0| |a#38#1#0| |a#38#2#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.320:30|
 :skolemid |1345|
)))
 :qid |unknown.0:0|
 :skolemid |1346|
 :pattern ( (_module.Expression.exprIf_q d@@26))
)))
(assert (forall ((d@@27 T@U) ) (!  (=> (_module.Triple.Trio_q d@@27) (exists ((|a#170#0#0| T@U) (|a#170#1#0| T@U) (|a#170#2#0| T@U) ) (! (= d@@27 (|#_module.Triple.Trio| |a#170#0#0| |a#170#1#0| |a#170#2#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.345:33|
 :skolemid |1559|
)))
 :qid |unknown.0:0|
 :skolemid |1560|
 :pattern ( (_module.Triple.Trio_q d@@27))
)))
...
(assert (forall ((d@@28 T@U) ) (!  (=> (_module.StateC.S_q d@@28) (exists ((|a#1#0#0| T@U) (|a#1#1#0| T@U) ) (! (= d@@28 (|#_module.StateC.S| |a#1#0#0| |a#1#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.32:21|
 :skolemid |1271|
)))
 :qid |unknown.0:0|
 :skolemid |1272|
 :pattern ( (_module.StateC.S_q d@@28))
)))
(assert (forall ((d@@29 T@U) ) (!  (=> (_module.Expression.exprAnd_q d@@29) (exists ((|a#48#0#0| T@U) (|a#48#1#0| T@U) ) (! (= d@@29 (|#_module.Expression.exprAnd| |a#48#0#0| |a#48#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.321:31|
 :skolemid |1360|
)))
 :qid |unknown.0:0|
 :skolemid |1361|
 :pattern ( (_module.Expression.exprAnd_q d@@29))
)))
(assert (forall ((d@@30 T@U) ) (!  (=> (_module.Expression.exprOr_q d@@30) (exists ((|a#56#0#0| T@U) (|a#56#1#0| T@U) ) (! (= d@@30 (|#_module.Expression.exprOr| |a#56#0#0| |a#56#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.322:30|
 :skolemid |1372|
)))
 :qid |unknown.0:0|
 :skolemid |1373|
 :pattern ( (_module.Expression.exprOr_q d@@30))
)))
(assert (forall ((d@@31 T@U) ) (!  (=> (_module.Expression.exprInvocation_q d@@31) (exists ((|a#64#0#0| T@U) (|a#64#1#0| T@U) ) (! (= d@@31 (|#_module.Expression.exprInvocation| |a#64#0#0| |a#64#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.323:38|
 :skolemid |1384|
)))
 :qid |unknown.0:0|
 :skolemid |1385|
 :pattern ( (_module.Expression.exprInvocation_q d@@31))
)))
(assert (forall ((d@@32 T@U) ) (!  (=> (_module.Tuple.Pair_q d@@32) (exists ((|a#162#0#0| T@U) (|a#162#1#0| T@U) ) (! (= d@@32 (|#_module.Tuple.Pair| |a#162#0#0| |a#162#1#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.344:29|
 :skolemid |1540|
)))
 :qid |unknown.0:0|
 :skolemid |1541|
 :pattern ( (_module.Tuple.Pair_q d@@32))
)))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|cmd#0@@3| T@U) (|deps#0@@3| T@U) (|exts#0@@3| T@U) (|stC#0@@7| T@U) ) (!  (=> (or (|_module.__default.PreC#canCall| |cmd#0@@3| |deps#0@@3| |exts#0@@3| |stC#0@@7|) (and (< 4 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |cmd#0@@3| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@3| Tclass._module.Expression)) ($Is DatatypeTypeType |exts#0@@3| Tclass._module.Expression)) ($Is DatatypeTypeType |stC#0@@7| Tclass._module.StateC)) (and (and (and (and (and (and (_module.Expression.exprLiteral_q |cmd#0@@3|) (_module.Literal.litString_q (_module.Expression.lit |cmd#0@@3|))) (_module.Expression.exprLiteral_q |deps#0@@3|)) (_module.Literal.litArrOfPaths_q (_module.Expression.lit |deps#0@@3|))) (_module.Expression.exprLiteral_q |exts#0@@3|)) (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#0@@3|))) (|Set#Subset| (_module.Literal.paths (_module.Expression.lit |deps#0@@3|)) (_module.__default.DomSt (_module.StateC.st |stC#0@@7|))))))) (and (and (and (and (_module.StateC.S_q |stC#0@@7|) (|_module.__default.Restrict#canCall| (_module.Literal.paths (_module.Expression.lit |deps#0@@3|)) (_module.StateC.st |stC#0@@7|))) (|_module.__default.Pre#canCall| |cmd#0@@3| |deps#0@@3| |exts#0@@3| (_module.__default.Restrict (_module.Literal.paths (_module.Expression.lit |deps#0@@3|)) (_module.StateC.st |stC#0@@7|)))) (=> (_module.__default.Pre |cmd#0@@3| |deps#0@@3| |exts#0@@3| (_module.__default.Restrict (_module.Literal.paths (_module.Expression.lit |deps#0@@3|)) (_module.StateC.st |stC#0@@7|))) (forall ((|e#0@@0| T@U) ) (!  (=> ($Is SeqType |e#0@@0| (TSeq TChar)) (=> (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0@@3|)) ($Box SeqType |e#0@@0|)) (and (and (and (|_module.__default.Loc#canCall| |cmd#0@@3| |deps#0@@3| |e#0@@0|) (|_module.__default.Hash#canCall| (_module.__default.Loc |cmd#0@@3| |deps#0@@3| |e#0@@0|))) (and (_module.StateC.S_q |stC#0@@7|) (|_module.__default.DomC#canCall| (_module.StateC.c |stC#0@@7|)))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@7|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@3| |deps#0@@3| |e#0@@0|))) (|_module.__default.Loc#canCall| |cmd#0@@3| |deps#0@@3| |e#0@@0|)))))
...
)))) (= (_module.__default.PreC |cmd#0@@3| |deps#0@@3| |exts#0@@3| |stC#0@@7|)  (and (_module.__default.Pre |cmd#0@@3| |deps#0@@3| |exts#0@@3| (_module.__default.Restrict (_module.Literal.paths (_module.Expression.lit |deps#0@@3|)) (_module.StateC.st |stC#0@@7|))) (forall ((|e#0@@1| T@U) ) (!  (=> ($Is SeqType |e#0@@1| (TSeq TChar)) (=> (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0@@3|)) ($Box SeqType |e#0@@1|)) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@7|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@3| |deps#0@@3| |e#0@@1|))) (|Set#IsMember| (_module.Literal.paths (_module.Expression.lit |deps#0@@3|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0@@3| |deps#0@@3| |e#0@@1|))))))
 :qid |CloudMakeConsistentBuildslegacydfy.291:10|
 :skolemid |1038|
 ...
 :skolemid |1040|
 :pattern ( (_module.__default.PreC |cmd#0@@3| |deps#0@@3| |exts#0@@3| |stC#0@@7|))
))))
(assert (forall ((d@@33 T@U) ) (!  (=> (_module.Literal.litTrue_q d@@33) (= d@@33 |#_module.Literal.litTrue|))
 :qid |unknown.0:0|
 :skolemid |1417|
 :pattern ( (_module.Literal.litTrue_q d@@33))
)))
(assert (forall ((d@@34 T@U) ) (!  (=> (_module.Literal.litFalse_q d@@34) (= d@@34 |#_module.Literal.litFalse|))
 :qid |unknown.0:0|
 :skolemid |1419|
 :pattern ( (_module.Literal.litFalse_q d@@34))
)))
(assert (forall ((d@@35 T@U) ) (!  (=> (_module.Literal.litUndefined_q d@@35) (= d@@35 |#_module.Literal.litUndefined|))
 :qid |unknown.0:0|
 :skolemid |1421|
 :pattern ( (_module.Literal.litUndefined_q d@@35))
)))
(assert (forall ((d@@36 T@U) ) (!  (=> (_module.Literal.litNull_q d@@36) (= d@@36 |#_module.Literal.litNull|))
 :qid |unknown.0:0|
 :skolemid |1423|
 :pattern ( (_module.Literal.litNull_q d@@36))
)))
(assert (forall ((d@@37 T@U) ) (!  (=> (_module.Primitive.primCreatePath_q d@@37) (= d@@37 |#_module.Primitive.primCreatePath|))
 :qid |unknown.0:0|
 :skolemid |1494|
 :pattern ( (_module.Primitive.primCreatePath_q d@@37))
)))
(assert (forall ((d@@38 T@U) ) (!  (=> (_module.Primitive.primExec_q d@@38) (= d@@38 |#_module.Primitive.primExec|))
 :qid |unknown.0:0|
 :skolemid |1496|
 :pattern ( (_module.Primitive.primExec_q d@@38))
)))
...
(assert (forall ((d@@40 T@U) ) (!  (=> (_module.Expression.exprLiteral_q d@@40) (exists ((|a#27#0#0| T@U) ) (! (= d@@40 (|#_module.Expression.exprLiteral| |a#27#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.319:35|
 :skolemid |1327|
)))
 :qid |unknown.0:0|
 :skolemid |1328|
 :pattern ( (_module.Expression.exprLiteral_q d@@40))
)))
(assert (forall ((d@@41 T@U) ) (!  (=> (_module.Expression.exprIdentifier_q d@@41) (exists ((|a#33#0#0| T@U) ) (! (= d@@41 (|#_module.Expression.exprIdentifier| |a#33#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.319:66|
 :skolemid |1337|
)))
 :qid |unknown.0:0|
 :skolemid |1338|
 :pattern ( (_module.Expression.exprIdentifier_q d@@41))
)))
(assert (forall ((d@@42 T@U) ) (!  (=> (_module.Expression.exprError_q d@@42) (exists ((|a#73#0#0| T@U) ) (! (= d@@42 (|#_module.Expression.exprError| |a#73#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.324:33|
 :skolemid |1397|
)))
 :qid |unknown.0:0|
 :skolemid |1398|
 :pattern ( (_module.Expression.exprError_q d@@42))
)))
(assert (forall ((d@@43 T@U) ) (!  (=> (_module.Literal.litNumber_q d@@43) (exists ((|a#95#0#0| Int) ) (! (= d@@43 (|#_module.Literal.litNumber| |a#95#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.327:30|
 :skolemid |1426|
)))
 :qid |unknown.0:0|
 :skolemid |1427|
 :pattern ( (_module.Literal.litNumber_q d@@43))
)))
(assert (forall ((d@@44 T@U) ) (!  (=> (_module.Literal.litString_q d@@44) (exists ((|a#100#0#0| T@U) ) (! (= d@@44 (|#_module.Literal.litString| |a#100#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.327:52|
 :skolemid |1434|
)))
 :qid |unknown.0:0|
 :skolemid |1435|
 :pattern ( (_module.Literal.litString_q d@@44))
)))
(assert (forall ((d@@45 T@U) ) (!  (=> (_module.Literal.litPrimitive_q d@@45) (exists ((|a#107#0#0| T@U) ) (! (= d@@45 (|#_module.Literal.litPrimitive| |a#107#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.328:33|
 :skolemid |1444|
)))
 :qid |unknown.0:0|
 :skolemid |1445|
 :pattern ( (_module.Literal.litPrimitive_q d@@45))
)))
(assert (forall ((d@@46 T@U) ) (!  (=> (_module.Literal.litArrOfPaths_q d@@46) (exists ((|a#113#0#0| T@U) ) (! (= d@@46 (|#_module.Literal.litArrOfPaths| |a#113#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.329:34|
 :skolemid |1453|
)))
 :qid |unknown.0:0|
 :skolemid |1454|
 :pattern ( (_module.Literal.litArrOfPaths_q d@@46))
)))
(assert (forall ((d@@47 T@U) ) (!  (=> (_module.Literal.litArrOfStrings_q d@@47) (exists ((|a#119#0#0| T@U) ) (! (= d@@47 (|#_module.Literal.litArrOfStrings| |a#119#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.330:36|
 :skolemid |1462|
)))
 :qid |unknown.0:0|
 :skolemid |1463|
 :pattern ( (_module.Literal.litArrOfStrings_q d@@47))
)))
(assert (forall ((d@@48 T@U) ) (!  (=> (_module.Literal.litArray_q d@@48) (exists ((|a#125#0#0| T@U) ) (! (= d@@48 (|#_module.Literal.litArray| |a#125#0#0|))
 :qid |CloudMakeConsistentBuildslegacydfy.331:29|
 :skolemid |1471|
)))
 :qid |unknown.0:0|
 :skolemid |1472|
 :pattern ( (_module.Literal.litArray_q d@@48))
)))
(assert (forall ((d@@49 T@U) ) (!  (=> ($Is DatatypeTypeType d@@49 Tclass._module.Expression) (or (or (or (or (or (or (_module.Expression.exprLiteral_q d@@49) (_module.Expression.exprIdentifier_q d@@49)) (_module.Expression.exprIf_q d@@49)) (_module.Expression.exprAnd_q d@@49)) (_module.Expression.exprOr_q d@@49)) (_module.Expression.exprInvocation_q d@@49)) (_module.Expression.exprError_q d@@49)))
 :qid |unknown.0:0|
 :skolemid |1407|
 :pattern ( (_module.Expression.exprError_q d@@49) ($Is DatatypeTypeType d@@49 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprInvocation_q d@@49) ($Is DatatypeTypeType d@@49 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprOr_q d@@49) ($Is DatatypeTypeType d@@49 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprAnd_q d@@49) ($Is DatatypeTypeType d@@49 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprIf_q d@@49) ($Is DatatypeTypeType d@@49 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprIdentifier_q d@@49) ($Is DatatypeTypeType d@@49 Tclass._module.Expression))
 :pattern ( (_module.Expression.exprLiteral_q d@@49) ($Is DatatypeTypeType d@@49 Tclass._module.Expression))
)))
...
(let ((|cmd#0@@4| ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@1| (LitInt 0)))))
 (and (and (and (and (and (and (and (_module.Expression.exprLiteral_q |cmd#0@@4|) (_module.Literal.litString_q (_module.Expression.lit |cmd#0@@4|))) (_module.Expression.exprLiteral_q |deps#0@@4|)) (_module.Literal.litArrOfPaths_q (_module.Expression.lit |deps#0@@4|))) (_module.Expression.exprLiteral_q |exts#0@@4|)) (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#0@@4|))) (|Set#Subset| (_module.Literal.paths (_module.Expression.lit |deps#0@@4|)) (_module.__default.DomSt (_module.StateC.st |stC#0@@9|)))) (_module.__default.PreC |cmd#0@@4| |deps#0@@4| |exts#0@@4| |stC#0@@9|)))))))))
...
(assert (forall ((d@@50 T@U) ) (!  (=> ($Is DatatypeTypeType d@@50 Tclass._module.Literal) (or (or (or (or (or (or (or (or (or (_module.Literal.litTrue_q d@@50) (_module.Literal.litFalse_q d@@50)) (_module.Literal.litUndefined_q d@@50)) (_module.Literal.litNull_q d@@50)) (_module.Literal.litNumber_q d@@50)) (_module.Literal.litString_q d@@50)) (_module.Literal.litPrimitive_q d@@50)) (_module.Literal.litArrOfPaths_q d@@50)) (_module.Literal.litArrOfStrings_q d@@50)) (_module.Literal.litArray_q d@@50)))
 :qid |unknown.0:0|
 :skolemid |1481|
 :pattern ( (_module.Literal.litArray_q d@@50) ($Is DatatypeTypeType d@@50 Tclass._module.Literal))
 :pattern ( (_module.Literal.litArrOfStrings_q d@@50) ($Is DatatypeTypeType d@@50 Tclass._module.Literal))
 :pattern ( (_module.Literal.litArrOfPaths_q d@@50) ($Is DatatypeTypeType d@@50 Tclass._module.Literal))
 :pattern ( (_module.Literal.litPrimitive_q d@@50) ($Is DatatypeTypeType d@@50 Tclass._module.Literal))
 :pattern ( (_module.Literal.litString_q d@@50) ($Is DatatypeTypeType d@@50 Tclass._module.Literal))
 :pattern ( (_module.Literal.litNumber_q d@@50) ($Is DatatypeTypeType d@@50 Tclass._module.Literal))
 :pattern ( (_module.Literal.litNull_q d@@50) ($Is DatatypeTypeType d@@50 Tclass._module.Literal))
 :pattern ( (_module.Literal.litUndefined_q d@@50) ($Is DatatypeTypeType d@@50 Tclass._module.Literal))
 :pattern ( (_module.Literal.litFalse_q d@@50) ($Is DatatypeTypeType d@@50 Tclass._module.Literal))
 :pattern ( (_module.Literal.litTrue_q d@@50) ($Is DatatypeTypeType d@@50 Tclass._module.Literal))
)))
...
(assert (forall ((_module.Triple$A@@5 T@U) (_module.Triple$B@@5 T@U) (_module.Triple$C@@5 T@U) (d@@51 T@U) ) (!  (=> ($Is DatatypeTypeType d@@51 (Tclass._module.Triple _module.Triple$A@@5 _module.Triple$B@@5 _module.Triple$C@@5)) (_module.Triple.Trio_q d@@51))
 :qid |unknown.0:0|
 :skolemid |1577|
 :pattern ( (_module.Triple.Trio_q d@@51) ($Is DatatypeTypeType d@@51 (Tclass._module.Triple _module.Triple$A@@5 _module.Triple$B@@5 _module.Triple$C@@5)))
)))
(assert (forall ((a@@13 T@U) (b@@10 T@U) ) (!  (=> (and (_module.Literal.litString_q a@@13) (_module.Literal.litString_q b@@10)) (= (|_module.Literal#Equal| a@@13 b@@10) (|Seq#Equal| (_module.Literal.str a@@13) (_module.Literal.str b@@10))))
 :qid |unknown.0:0|
 :skolemid |1487|
 :pattern ( (|_module.Literal#Equal| a@@13 b@@10) (_module.Literal.litString_q a@@13))
 :pattern ( (|_module.Literal#Equal| a@@13 b@@10) (_module.Literal.litString_q b@@10))
)))
(assert (forall ((a@@14 T@U) (b@@11 T@U) ) (!  (=> (and (_module.Literal.litPrimitive_q a@@14) (_module.Literal.litPrimitive_q b@@11)) (= (|_module.Literal#Equal| a@@14 b@@11) (|_module.Primitive#Equal| (_module.Literal.prim a@@14) (_module.Literal.prim b@@11))))
 :qid |unknown.0:0|
 :skolemid |1488|
 :pattern ( (|_module.Literal#Equal| a@@14 b@@11) (_module.Literal.litPrimitive_q a@@14))
 :pattern ( (|_module.Literal#Equal| a@@14 b@@11) (_module.Literal.litPrimitive_q b@@11))
)))
(assert (forall ((a@@15 T@U) (b@@12 T@U) ) (!  (=> (and (_module.Literal.litArrOfPaths_q a@@15) (_module.Literal.litArrOfPaths_q b@@12)) (= (|_module.Literal#Equal| a@@15 b@@12) (|Set#Equal| (_module.Literal.paths a@@15) (_module.Literal.paths b@@12))))
 :qid |unknown.0:0|
 :skolemid |1489|
 :pattern ( (|_module.Literal#Equal| a@@15 b@@12) (_module.Literal.litArrOfPaths_q a@@15))
 :pattern ( (|_module.Literal#Equal| a@@15 b@@12) (_module.Literal.litArrOfPaths_q b@@12))
)))
(assert (forall ((a@@16 T@U) (b@@13 T@U) ) (!  (=> (and (_module.Literal.litArrOfStrings_q a@@16) (_module.Literal.litArrOfStrings_q b@@13)) (= (|_module.Literal#Equal| a@@16 b@@13) (|Set#Equal| (_module.Literal.strs a@@16) (_module.Literal.strs b@@13))))
 :qid |unknown.0:0|
 :skolemid |1490|
 :pattern ( (|_module.Literal#Equal| a@@16 b@@13) (_module.Literal.litArrOfStrings_q a@@16))
 :pattern ( (|_module.Literal#Equal| a@@16 b@@13) (_module.Literal.litArrOfStrings_q b@@13))
)))
(assert (forall ((a@@17 T@U) (b@@14 T@U) ) (!  (=> (and (_module.Literal.litArray_q a@@17) (_module.Literal.litArray_q b@@14)) (= (|_module.Literal#Equal| a@@17 b@@14) (|Seq#Equal| (_module.Literal.arr a@@17) (_module.Literal.arr b@@14))))
 :qid |unknown.0:0|
 :skolemid |1491|
 :pattern ( (|_module.Literal#Equal| a@@17 b@@14) (_module.Literal.litArray_q a@@17))
 :pattern ( (|_module.Literal#Equal| a@@17 b@@14) (_module.Literal.litArray_q b@@14))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@7 T@U) (|cmd#0@@7| T@U) (|deps#0@@6| T@U) (|exts#0@@6| T@U) (|stC#0@@12| T@U) ) (!  (=> (or (|_module.__default.UpdateC#canCall| |cmd#0@@7| |deps#0@@6| |exts#0@@6| |stC#0@@12|) (and (< 3 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |cmd#0@@7| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@6| Tclass._module.Expression)) ($Is DatatypeTypeType |exts#0@@6| Tclass._module.Expression)) ($Is DatatypeTypeType |stC#0@@12| Tclass._module.StateC)) (and (and (and (and (and (_module.Expression.exprLiteral_q |cmd#0@@7|) (_module.Literal.litString_q (_module.Expression.lit |cmd#0@@7|))) (_module.Expression.exprLiteral_q |deps#0@@6|)) (_module.Literal.litArrOfPaths_q (_module.Expression.lit |deps#0@@6|))) (_module.Expression.exprLiteral_q |exts#0@@6|)) (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#0@@6|)))))) (and (let ((|stC'#0@@1| (_module.__default.UpdateC $ly@@7 |cmd#0@@7| |deps#0@@6| |exts#0@@6| |stC#0@@12|)))
(let ((|hashValues#0| (|Set#FromBoogieMap| (|lambda#4| (TSeq TChar) (_module.Literal.strs (_module.Expression.lit |exts#0@@6|)) |cmd#0@@7| |deps#0@@6| (_module.Literal.strs (_module.Expression.lit |exts#0@@6|)) |cmd#0@@7| |deps#0@@6|))))
 (and (= (_module.StateC.st |stC'#0@@1|) (_module.StateC.st |stC#0@@12|)) (|Set#Equal| (|Set#Union| (_module.__default.DomC (_module.StateC.c |stC#0@@12|)) |hashValues#0|) (_module.__default.DomC (_module.StateC.c |stC'#0@@1|)))))) ($Is DatatypeTypeType (_module.__default.UpdateC $ly@@7 |cmd#0@@7| |deps#0@@6| |exts#0@@6| |stC#0@@12|) Tclass._module.StateC)))
 :qid |CloudMakeConsistentBuildslegacydfy.41:16|
 :skolemid |737|
 :pattern ( (_module.__default.UpdateC $ly@@7 |cmd#0@@7| |deps#0@@6| |exts#0@@6| |stC#0@@12|))
))))
...
(assert (forall ((d@@52 T@U) ) (!  (=> ($Is DatatypeTypeType d@@52 Tclass._module.Primitive) (or (_module.Primitive.primCreatePath_q d@@52) (_module.Primitive.primExec_q d@@52)))
 :qid |unknown.0:0|
 :skolemid |1499|
 :pattern ( (_module.Primitive.primExec_q d@@52) ($Is DatatypeTypeType d@@52 Tclass._module.Primitive))
 :pattern ( (_module.Primitive.primCreatePath_q d@@52) ($Is DatatypeTypeType d@@52 Tclass._module.Primitive))
)))
...
(assert (forall ((a@@22 T@U) (b@@19 T@U) ) (!  (=> (and (_module.Literal.litTrue_q a@@22) (_module.Literal.litTrue_q b@@19)) (|_module.Literal#Equal| a@@22 b@@19))
 :qid |unknown.0:0|
 :skolemid |1482|
 :pattern ( (|_module.Literal#Equal| a@@22 b@@19) (_module.Literal.litTrue_q a@@22))
 :pattern ( (|_module.Literal#Equal| a@@22 b@@19) (_module.Literal.litTrue_q b@@19))
)))
(assert (forall ((a@@23 T@U) (b@@20 T@U) ) (!  (=> (and (_module.Literal.litFalse_q a@@23) (_module.Literal.litFalse_q b@@20)) (|_module.Literal#Equal| a@@23 b@@20))
 :qid |unknown.0:0|
 :skolemid |1483|
 :pattern ( (|_module.Literal#Equal| a@@23 b@@20) (_module.Literal.litFalse_q a@@23))
 :pattern ( (|_module.Literal#Equal| a@@23 b@@20) (_module.Literal.litFalse_q b@@20))
)))
(assert (forall ((a@@24 T@U) (b@@21 T@U) ) (!  (=> (and (_module.Literal.litUndefined_q a@@24) (_module.Literal.litUndefined_q b@@21)) (|_module.Literal#Equal| a@@24 b@@21))
 :qid |unknown.0:0|
 :skolemid |1484|
 :pattern ( (|_module.Literal#Equal| a@@24 b@@21) (_module.Literal.litUndefined_q a@@24))
 :pattern ( (|_module.Literal#Equal| a@@24 b@@21) (_module.Literal.litUndefined_q b@@21))
)))
(assert (forall ((a@@25 T@U) (b@@22 T@U) ) (!  (=> (and (_module.Literal.litNull_q a@@25) (_module.Literal.litNull_q b@@22)) (|_module.Literal#Equal| a@@25 b@@22))
 :qid |unknown.0:0|
 :skolemid |1485|
 :pattern ( (|_module.Literal#Equal| a@@25 b@@22) (_module.Literal.litNull_q a@@25))
 :pattern ( (|_module.Literal#Equal| a@@25 b@@22) (_module.Literal.litNull_q b@@22))
)))
(assert (forall ((a@@26 T@U) (b@@23 T@U) ) (!  (=> (and (_module.Primitive.primCreatePath_q a@@26) (_module.Primitive.primCreatePath_q b@@23)) (|_module.Primitive#Equal| a@@26 b@@23))
 :qid |unknown.0:0|
 :skolemid |1500|
 :pattern ( (|_module.Primitive#Equal| a@@26 b@@23) (_module.Primitive.primCreatePath_q a@@26))
 :pattern ( (|_module.Primitive#Equal| a@@26 b@@23) (_module.Primitive.primCreatePath_q b@@23))
)))
(assert (forall ((a@@27 T@U) (b@@24 T@U) ) (!  (=> (and (_module.Primitive.primExec_q a@@27) (_module.Primitive.primExec_q b@@24)) (|_module.Primitive#Equal| a@@27 b@@24))
 :qid |unknown.0:0|
 :skolemid |1501|
 :pattern ( (|_module.Primitive#Equal| a@@27 b@@24) (_module.Primitive.primExec_q a@@27))
 :pattern ( (|_module.Primitive#Equal| a@@27 b@@24) (_module.Primitive.primExec_q b@@24))
)))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@10 T@U) (|expr#0@@6| T@U) (|stC#0@@15| T@U) (|env#0@@6| T@U) ) (!  (=> (or (|_module.__default.evalC#canCall| (Lit DatatypeTypeType |expr#0@@6|) (Lit DatatypeTypeType |stC#0@@15|) (Lit BoxType |env#0@@6|)) (and (< 6 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |expr#0@@6| Tclass._module.Expression) ($Is DatatypeTypeType |stC#0@@15| Tclass._module.StateC)) ($IsBox |env#0@@6| Tclass._module.Env)))) (and (and (|_module.__default.Value#canCall| (Lit DatatypeTypeType |expr#0@@6|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.__default.Value (Lit DatatypeTypeType |expr#0@@6|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (_module.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@6|))))) (|_module.__default.GetEnv#canCall| (Lit BoxType (_module.Expression.id (Lit DatatypeTypeType |expr#0@@6|))) (Lit BoxType |env#0@@6|))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@6|)))))) (and (and (=> (U_2_bool (Lit boolType (bool_2_U (_module.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@6|))))) (=> (U_2_bool (Lit boolType (bool_2_U (_module.Expression.exprLiteral_q (Lit DatatypeTypeType (_module.Expression.cond (Lit DatatypeTypeType |expr#0@@6|))))))) (|$IsA#_module.Literal| (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType (_module.Expression.cond (Lit DatatypeTypeType |expr#0@@6|)))))))) (=> (and (and (_module.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@6|)) (_module.Expression.exprLiteral_q (Lit DatatypeTypeType (_module.Expression.cond (Lit DatatypeTypeType |expr#0@@6|))))) (|_module.Literal#Equal| (_module.Expression.lit (Lit DatatypeTypeType (_module.Expression.cond (Lit DatatypeTypeType |expr#0@@6|)))) |#_module.Literal.litTrue|)) (|_module.__default.evalC#canCall| (Lit DatatypeTypeType (_module.Expression.ifTrue (Lit DatatypeTypeType |expr#0@@6|))) (Lit DatatypeTypeType |stC#0@@15|) (Lit BoxType |env#0@@6|)))) (=> (not (and (and (_module.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@6|)) (_module.Expression.exprLiteral_q (Lit DatatypeTypeType (_module.Expression.cond (Lit DatatypeTypeType |expr#0@@6|))))) (|_module.Literal#Equal| (_module.Expression.lit (Lit DatatypeTypeType (_module.Expression.cond (Lit DatatypeTypeType |expr#0@@6|)))) |#_module.Literal.litTrue|))) (and (and (=> (U_2_bool (Lit boolType (bool_2_U (_module.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@6|))))) (=> (U_2_bool (Lit boolType (bool_2_U (_module.Expression.exprLiteral_q (Lit DatatypeTypeType (_module.Expression.cond (Lit DatatypeTypeType |expr#0@@6|))))))) (|$IsA#_module.Literal| (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType (_module.Expression.cond (Lit DatatypeTypeType |expr#0@@6|)))))))) (=> (and (and (_module.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@6|)) (_module.Expression.exprLiteral_q (Lit DatatypeTypeType (_module.Expression.cond (Lit DatatypeTypeType |expr#0@@6|))))) (|_module.Literal#Equal| (_module.Expression.lit (Lit DatatypeTypeType (_module.Expression.cond (Lit DatatypeTypeType |expr#0@@6|)))) |#_module.Literal.litFalse|)) (|_module.__default.evalC#canCall| (Lit DatatypeTypeType (_module.Expression.ifFalse (Lit DatatypeTypeType |expr#0@@6|))) (Lit DatatypeTypeType |stC#0@@15|) (Lit BoxType |env#0@@6|)))) (=> (not (and (and (_module.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@6|)) (_module.Expression.exprLiteral_q (Lit DatatypeTypeType (_module.Expression.cond (Lit DatatypeTypeType |expr#0@@6|))))) (|_module.Literal#Equal| (_module.Expression.lit (Lit DatatypeTypeType (_module.Expression.cond (Lit DatatypeTypeType |expr#0@@6|)))) |#_module.Literal.litFalse|))) (and (=> (U_2_bool (Lit boolType (bool_2_U (_module.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@6|))))) (and (|_module.__default.evalC#canCall| (Lit DatatypeTypeType (_module.Expression.cond (Lit DatatypeTypeType |expr#0@@6|))) (Lit DatatypeTypeType |stC#0@@15|) (Lit BoxType |env#0@@6|)) (let ((|result#6| (Lit DatatypeTypeType (_module.__default.evalC ($LS $ly@@10) (Lit DatatypeTypeType (_module.Expression.cond (Lit DatatypeTypeType |expr#0@@6|))) (Lit DatatypeTypeType |stC#0@@15|) (Lit BoxType |env#0@@6|)))))
...
(let ((|fun'#2| ($Unbox DatatypeTypeType (_module.Tuple.fst |resultFun#2|))))
 (and (|_module.__default.evalArgsC#canCall| (Lit DatatypeTypeType |expr#0@@6|) (Lit SeqType (_module.Expression.args (Lit DatatypeTypeType |expr#0@@6|))) (Lit DatatypeTypeType |stC#0@@15|) (Lit BoxType |env#0@@6|)) (let ((|resultArgs#2| (Lit DatatypeTypeType (_module.__default.evalArgsC ($LS $ly@@10) (Lit DatatypeTypeType |expr#0@@6|) (Lit SeqType (_module.Expression.args (Lit DatatypeTypeType |expr#0@@6|))) (Lit DatatypeTypeType |stC#0@@15|) (Lit BoxType |env#0@@6|)))))
...
(let ((|stsC''#2| (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |stC'#11|)) |stsC'#2|)))
 ...
 (=> (and (_module.Expression.exprLiteral_q |fun'#2|) (_module.Literal.litPrimitive_q (_module.Expression.lit |fun'#2|))) (=> (_module.Primitive.primExec_q (_module.Literal.prim (_module.Expression.lit |fun'#2|))) (and (and (and (|_module.__default.Arity#canCall| (Lit DatatypeTypeType |#_module.Primitive.primExec|)) (=> (= (|Seq#Length| |args'#2|) (LitInt (_module.__default.Arity (Lit DatatypeTypeType |#_module.Primitive.primExec|)))) (|_module.__default.ValidArgsC#canCall| (Lit DatatypeTypeType |#_module.Primitive.primExec|) |args'#2| |stCombinedC#2|))) (=> (and (= (|Seq#Length| |args'#2|) (LitInt (_module.__default.Arity (Lit DatatypeTypeType |#_module.Primitive.primExec|)))) (_module.__default.ValidArgsC (Lit DatatypeTypeType |#_module.Primitive.primExec|) |args'#2| |stCombinedC#2|)) (|_module.__default.execC#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |args'#2| (LitInt 0))) ($Unbox DatatypeTypeType (|Seq#Index| |args'#2| (LitInt 1))) ($Unbox DatatypeTypeType (|Seq#Index| |args'#2| (LitInt 2))) |stCombinedC#2|))) (=> (not (and (= (|Seq#Length| |args'#2|) (LitInt (_module.__default.Arity (Lit DatatypeTypeType |#_module.Primitive.primExec|)))) (_module.__default.ValidArgsC (Lit DatatypeTypeType |#_module.Primitive.primExec|) |args'#2| |stCombinedC#2|))) (|_module.__default.ConsistentCache#canCall| |stCombinedC#2|))))))))))))))))))))))))))))))))))) (= (_module.__default.evalC ($LS $ly@@10) (Lit DatatypeTypeType |expr#0@@6|) (Lit DatatypeTypeType |stC#0@@15|) (Lit BoxType |env#0@@6|)) (ite (_module.__default.Value (Lit DatatypeTypeType |expr#0@@6|)) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType |expr#0@@6|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |stC#0@@15|))) (ite (_module.Expression.exprIdentifier_q (Lit DatatypeTypeType |expr#0@@6|)) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (_module.__default.GetEnv (Lit BoxType (_module.Expression.id (Lit DatatypeTypeType |expr#0@@6|))) (Lit BoxType |env#0@@6|))) ($Box DatatypeTypeType (Lit DatatypeTypeType |stC#0@@15|))) (ite  (and (and (_module.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@6|)) (_module.Expression.exprLiteral_q (Lit DatatypeTypeType (_module.Expression.cond (Lit DatatypeTypeType |expr#0@@6|))))) (|_module.Literal#Equal| (_module.Expression.lit (Lit DatatypeTypeType (_module.Expression.cond (Lit DatatypeTypeType |expr#0@@6|)))) |#_module.Literal.litTrue|)) (_module.__default.evalC ($LS $ly@@10) (Lit DatatypeTypeType (_module.Expression.ifTrue (Lit DatatypeTypeType |expr#0@@6|))) (Lit DatatypeTypeType |stC#0@@15|) (Lit BoxType |env#0@@6|)) (ite  (and (and (_module.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@6|)) (_module.Expression.exprLiteral_q (Lit DatatypeTypeType (_module.Expression.cond (Lit DatatypeTypeType |expr#0@@6|))))) (|_module.Literal#Equal| (_module.Expression.lit (Lit DatatypeTypeType (_module.Expression.cond (Lit DatatypeTypeType |expr#0@@6|)))) |#_module.Literal.litFalse|)) (_module.__default.evalC ($LS $ly@@10) (Lit DatatypeTypeType (_module.Expression.ifFalse (Lit DatatypeTypeType |expr#0@@6|))) (Lit DatatypeTypeType |stC#0@@15|) (Lit BoxType |env#0@@6|)) (ite (_module.Expression.exprIf_q (Lit DatatypeTypeType |expr#0@@6|)) (let ((|result#6@@0| (Lit DatatypeTypeType (_module.__default.evalC ($LS $ly@@10) (Lit DatatypeTypeType (_module.Expression.cond (Lit DatatypeTypeType |expr#0@@6|))) (Lit DatatypeTypeType |stC#0@@15|) (Lit BoxType |env#0@@6|)))))
...
(ite  (and (_module.Expression.exprLiteral_q |cond'#2@@0|) (|_module.Literal#Equal| (_module.Expression.lit |cond'#2@@0|) |#_module.Literal.litTrue|)) (_module.__default.evalC ($LS $ly@@10) (Lit DatatypeTypeType (_module.Expression.ifTrue (Lit DatatypeTypeType |expr#0@@6|))) |stC'#8@@0| (Lit BoxType |env#0@@6|)) (ite  (and (_module.Expression.exprLiteral_q |cond'#2@@0|) (|_module.Literal#Equal| (_module.Expression.lit |cond'#2@@0|) |#_module.Literal.litFalse|)) (_module.__default.evalC ($LS $ly@@10) (Lit DatatypeTypeType (_module.Expression.ifFalse (Lit DatatypeTypeType |expr#0@@6|))) |stC'#8@@0| (Lit BoxType |env#0@@6|)) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |stC#0@@15|)))))))) (ite (_module.Expression.exprAnd_q (Lit DatatypeTypeType |expr#0@@6|)) (let ((|result#7@@0| (Lit DatatypeTypeType (_module.__default.evalC ($LS $ly@@10) (Lit DatatypeTypeType (_module.Expression.conj0 (Lit DatatypeTypeType |expr#0@@6|))) (Lit DatatypeTypeType |stC#0@@15|) (Lit BoxType |env#0@@6|)))))
...
(ite  (and (_module.Expression.exprLiteral_q |conj0'#2@@0|) (|_module.Literal#Equal| (_module.Expression.lit |conj0'#2@@0|) |#_module.Literal.litTrue|)) (_module.__default.evalC ($LS $ly@@10) (Lit DatatypeTypeType (_module.Expression.conj1 (Lit DatatypeTypeType |expr#0@@6|))) |stC'#9@@0| (Lit BoxType |env#0@@6|)) (ite  (and (_module.Expression.exprLiteral_q |conj0'#2@@0|) (|_module.Literal#Equal| (_module.Expression.lit |conj0'#2@@0|) |#_module.Literal.litFalse|)) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprLiteral| (Lit DatatypeTypeType |#_module.Literal.litFalse|)))) ($Box DatatypeTypeType |stC'#9@@0|)) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |stC#0@@15|)))))))) (ite (_module.Expression.exprOr_q (Lit DatatypeTypeType |expr#0@@6|)) (let ((|result#8@@0| (Lit DatatypeTypeType (_module.__default.evalC ($LS $ly@@10) (Lit DatatypeTypeType (_module.Expression.disj0 (Lit DatatypeTypeType |expr#0@@6|))) (Lit DatatypeTypeType |stC#0@@15|) (Lit BoxType |env#0@@6|)))))
...
(ite  (and (_module.Expression.exprLiteral_q |disj0'#2@@0|) (|_module.Literal#Equal| (_module.Expression.lit |disj0'#2@@0|) |#_module.Literal.litTrue|)) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprLiteral| (Lit DatatypeTypeType |#_module.Literal.litTrue|)))) ($Box DatatypeTypeType |stC'#10@@0|)) (ite  (and (_module.Expression.exprLiteral_q |disj0'#2@@0|) (|_module.Literal#Equal| (_module.Expression.lit |disj0'#2@@0|) |#_module.Literal.litFalse|)) (_module.__default.evalC ($LS $ly@@10) (Lit DatatypeTypeType (_module.Expression.disj1 (Lit DatatypeTypeType |expr#0@@6|))) |stC'#10@@0| (Lit BoxType |env#0@@6|)) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |stC#0@@15|)))))))) (ite (_module.Expression.exprInvocation_q (Lit DatatypeTypeType |expr#0@@6|)) (let ((|resultFun#2@@0| (Lit DatatypeTypeType (_module.__default.evalC ($LS $ly@@10) (Lit DatatypeTypeType (_module.Expression.fun (Lit DatatypeTypeType |expr#0@@6|))) (Lit DatatypeTypeType |stC#0@@15|) (Lit BoxType |env#0@@6|)))))
...
(let ((|resultArgs#2@@0| (Lit DatatypeTypeType (_module.__default.evalArgsC ($LS $ly@@10) (Lit DatatypeTypeType |expr#0@@6|) (Lit SeqType (_module.Expression.args (Lit DatatypeTypeType |expr#0@@6|))) (Lit DatatypeTypeType |stC#0@@15|) (Lit BoxType |env#0@@6|)))))
...
(ite  (and (_module.Expression.exprLiteral_q |fun'#2@@0|) (_module.Literal.litPrimitive_q (Lit DatatypeTypeType (_module.Expression.lit |fun'#2@@0|)))) (ite (_module.Primitive.primExec_q (Lit DatatypeTypeType (_module.Literal.prim (Lit DatatypeTypeType (_module.Expression.lit |fun'#2@@0|))))) (ite  (and (= (|Seq#Length| |args'#2@@0|) (LitInt (_module.__default.Arity (Lit DatatypeTypeType |#_module.Primitive.primExec|)))) (_module.__default.ValidArgsC (Lit DatatypeTypeType |#_module.Primitive.primExec|) |args'#2@@0| |stCombinedC#2@@0|)) (_module.__default.execC ($Unbox DatatypeTypeType (|Seq#Index| |args'#2@@0| (LitInt 0))) ($Unbox DatatypeTypeType (|Seq#Index| |args'#2@@0| (LitInt 1))) ($Unbox DatatypeTypeType (|Seq#Index| |args'#2@@0| (LitInt 2))) |stCombinedC#2@@0|) (ite (_module.__default.ConsistentCache |stCombinedC#2@@0|) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |stC#0@@15|))) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rInconsistentCache|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |stC#0@@15|))))) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |stC#0@@15|)))) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |stC#0@@15|))))) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rCompatibility|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |stC#0@@15|))))))))))) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rValidity|)))) ($Box DatatypeTypeType (Lit DatatypeTypeType |stC#0@@15|))))))))))))))
 :qid |CloudMakeConsistentBuildslegacydfy.397:16|
 :weight 3
 :skolemid |1115|
 :pattern ( (_module.__default.evalC ($LS $ly@@10) (Lit DatatypeTypeType |expr#0@@6|) (Lit DatatypeTypeType |stC#0@@15|) (Lit BoxType |env#0@@6|)))
))))
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@11 T@U) (|expr#0@@7| T@U) (|stC#0@@16| T@U) (|env#0@@7| T@U) ) (!  (=> (or (|_module.__default.evalC#canCall| |expr#0@@7| |stC#0@@16| |env#0@@7|) (and (< 6 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |expr#0@@7| Tclass._module.Expression) ($Is DatatypeTypeType |stC#0@@16| Tclass._module.StateC)) ($IsBox |env#0@@7| Tclass._module.Env)))) ($Is DatatypeTypeType (_module.__default.evalC $ly@@11 |expr#0@@7| |stC#0@@16| |env#0@@7|) (Tclass._module.Tuple Tclass._module.Expression Tclass._module.StateC)))
 :qid |CloudMakeConsistentBuildslegacydfy.397:16|
 :skolemid |1111|
 :pattern ( (_module.__default.evalC $ly@@11 |expr#0@@7| |stC#0@@16| |env#0@@7|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@12 T@U) (|cmd#0@@11| T@U) (|deps#0@@10| T@U) (|exts#0@@9| T@U) (|stC#0@@17| T@U) ) (!  (=> (or (|_module.__default.UpdateC#canCall| |cmd#0@@11| |deps#0@@10| |exts#0@@9| |stC#0@@17|) (and (< 3 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |cmd#0@@11| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@10| Tclass._module.Expression)) ($Is DatatypeTypeType |exts#0@@9| Tclass._module.Expression)) ($Is DatatypeTypeType |stC#0@@17| Tclass._module.StateC)) (and (and (and (and (and (_module.Expression.exprLiteral_q |cmd#0@@11|) (_module.Literal.litString_q (_module.Expression.lit |cmd#0@@11|))) (_module.Expression.exprLiteral_q |deps#0@@10|)) (_module.Literal.litArrOfPaths_q (_module.Expression.lit |deps#0@@10|))) (_module.Expression.exprLiteral_q |exts#0@@9|)) (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#0@@9|)))))) (and (let ((|strs#0| (_module.Literal.strs (_module.Expression.lit |exts#0@@9|))))
 (=> (not (|Set#Equal| |strs#0| |Set#Empty|)) (and (|_module.__default.Choose#canCall| |strs#0|) (let ((|e#1@@2| (_module.__default.Choose |strs#0|)))
 (and (and (and (and (|_module.__default.Loc#canCall| |cmd#0@@11| |deps#0@@10| |e#1@@2|) (|_module.__default.Hash#canCall| (_module.__default.Loc |cmd#0@@11| |deps#0@@10| |e#1@@2|))) (_module.StateC.S_q |stC#0@@17|)) (|_module.__default.SetC#canCall| (_module.__default.Hash (_module.__default.Loc |cmd#0@@11| |deps#0@@10| |e#1@@2|)) (|#_module.Triple.Trio| ($Box DatatypeTypeType |cmd#0@@11|) ($Box DatatypeTypeType |deps#0@@10|) ($Box SeqType |e#1@@2|)) (_module.StateC.c |stC#0@@17|))) (let ((|c'#0| (_module.__default.SetC (_module.__default.Hash (_module.__default.Loc |cmd#0@@11| |deps#0@@10| |e#1@@2|)) (|#_module.Triple.Trio| ($Box DatatypeTypeType |cmd#0@@11|) ($Box DatatypeTypeType |deps#0@@10|) ($Box SeqType |e#1@@2|)) (_module.StateC.c |stC#0@@17|))))
(let ((|exts'#0| (|#_module.Expression.exprLiteral| (|#_module.Literal.litArrOfStrings| (|Set#Difference| |strs#0| (|Set#UnionOne| |Set#Empty| ($Box SeqType |e#1@@2|)))))))
 (and (_module.StateC.S_q |stC#0@@17|) (|_module.__default.UpdateC#canCall| |cmd#0@@11| |deps#0@@10| |exts'#0| (|#_module.StateC.S| (_module.StateC.st |stC#0@@17|) |c'#0|)))))))))) (= (_module.__default.UpdateC ($LS $ly@@12) |cmd#0@@11| |deps#0@@10| |exts#0@@9| |stC#0@@17|) (let ((|strs#0@@0| (_module.Literal.strs (_module.Expression.lit |exts#0@@9|))))
(ite (|Set#Equal| |strs#0@@0| |Set#Empty|) |stC#0@@17| (let ((|e#1@@3| (_module.__default.Choose |strs#0@@0|)))
(let ((|c'#0@@0| (_module.__default.SetC (_module.__default.Hash (_module.__default.Loc |cmd#0@@11| |deps#0@@10| |e#1@@3|)) (|#_module.Triple.Trio| ($Box DatatypeTypeType |cmd#0@@11|) ($Box DatatypeTypeType |deps#0@@10|) ($Box SeqType |e#1@@3|)) (_module.StateC.c |stC#0@@17|))))
...
(_module.__default.UpdateC $ly@@12 |cmd#0@@11| |deps#0@@10| |exts'#0@@0| (|#_module.StateC.S| (_module.StateC.st |stC#0@@17|) |c'#0@@0|))))))))))
 :qid |CloudMakeConsistentBuildslegacydfy.41:16|
 :skolemid |739|
 :pattern ( (_module.__default.UpdateC ($LS $ly@@12) |cmd#0@@11| |deps#0@@10| |exts#0@@9| |stC#0@@17|))
))))
...
(assert (forall ((a@@28 T@U) (b@@25 T@U) ) (! (= (|Set#Union| a@@28 (|Set#Union| a@@28 b@@25)) (|Set#Union| a@@28 b@@25))
 :qid |DafnyPreludebpl.733:15|
 :skolemid |139|
 :pattern ( (|Set#Union| a@@28 (|Set#Union| a@@28 b@@25)))
)))
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@14 T@U) (|expr#0@@8| T@U) (|args#0@@5| T@U) (|stC#0@@18| T@U) (|env#0@@8| T@U) (|args'#0@@1| T@U) (|stsC'#0@@1| T@U) ) (!  (=> (or (|_module.__default.evalArgsC_k#canCall| (Lit DatatypeTypeType |expr#0@@8|) (Lit SeqType |args#0@@5|) |stC#0@@18| |env#0@@8| |args'#0@@1| |stsC'#0@@1|) (and (< 6 $FunctionContextHeight) (and (and (and (and (and (and ($Is DatatypeTypeType |expr#0@@8| Tclass._module.Expression) ($Is SeqType |args#0@@5| (TSeq Tclass._module.Expression))) ($Is DatatypeTypeType |stC#0@@18| Tclass._module.StateC)) ($IsBox |env#0@@8| Tclass._module.Env)) ($Is SeqType |args'#0@@1| (TSeq Tclass._module.Expression))) ($Is SetType |stsC'#0@@1| (TSet Tclass._module.StateC))) (forall ((|arg#3| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#3| Tclass._module.Expression) (=> (|Seq#Contains| |args#0@@5| ($Box DatatypeTypeType |arg#3|)) (< (DtRank |arg#3|) (DtRank |expr#0@@8|))))
 :qid |CloudMakeConsistentBuildslegacydfy.485:19|
 :skolemid |1159|
 ...
 (and (|_module.__default.evalC#canCall| |arg#4| |stC#0@@18| |env#0@@8|) (let ((|result#1@@1| (_module.__default.evalC ($LS $ly@@14) |arg#4| |stC#0@@18| |env#0@@8|)))
...
(|_module.__default.evalArgsC_k#canCall| (Lit DatatypeTypeType |expr#0@@8|) (Lit SeqType (|Seq#Drop| (Lit SeqType |args#0@@5|) (LitInt 1))) |stC#0@@18| |env#0@@8| (|Seq#Append| |args'#0@@1| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |arg'#1|))) (|Set#Union| |stsC'#0@@1| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |stC'#1@@2|))))))))))) (= (_module.__default.evalArgsC_k ($LS $ly@@14) (Lit DatatypeTypeType |expr#0@@8|) (Lit SeqType |args#0@@5|) |stC#0@@18| |env#0@@8| |args'#0@@1| |stsC'#0@@1|) (ite (|Seq#Equal| |args#0@@5| |Seq#Empty|) (|#_module.Tuple.Pair| ($Box SeqType |args'#0@@1|) ($Box SetType |stsC'#0@@1|)) (let ((|arg#4@@0| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@5|) (LitInt 0)))))
(let ((|result#1@@2| (_module.__default.evalC ($LS $ly@@14) |arg#4@@0| |stC#0@@18| |env#0@@8|)))
...
(_module.__default.evalArgsC_k ($LS $ly@@14) (Lit DatatypeTypeType |expr#0@@8|) (Lit SeqType (|Seq#Drop| (Lit SeqType |args#0@@5|) (LitInt 1))) |stC#0@@18| |env#0@@8| (|Seq#Append| |args'#0@@1| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |arg'#1@@0|))) (|Set#Union| |stsC'#0@@1| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |stC'#1@@3|))))))))))))
 :qid |CloudMakeConsistentBuildslegacydfy.482:16|
 :weight 3
 :skolemid |1160|
 :pattern ( (_module.__default.evalArgsC_k ($LS $ly@@14) (Lit DatatypeTypeType |expr#0@@8|) (Lit SeqType |args#0@@5|) |stC#0@@18| |env#0@@8| |args'#0@@1| |stsC'#0@@1|))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@15 T@U) (|expr#0@@9| T@U) (|args#0@@6| T@U) (|stC#0@@19| T@U) (|env#0@@9| T@U) ) (!  (=> (or (|_module.__default.evalArgsC#canCall| (Lit DatatypeTypeType |expr#0@@9|) (Lit SeqType |args#0@@6|) (Lit DatatypeTypeType |stC#0@@19|) (Lit BoxType |env#0@@9|)) (and (< 6 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |expr#0@@9| Tclass._module.Expression) ($Is SeqType |args#0@@6| (TSeq Tclass._module.Expression))) ($Is DatatypeTypeType |stC#0@@19| Tclass._module.StateC)) ($IsBox |env#0@@9| Tclass._module.Env)) (forall ((|arg#3@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#3@@0| Tclass._module.Expression) (=> (|Seq#Contains| |args#0@@6| ($Box DatatypeTypeType |arg#3@@0|)) (< (DtRank |arg#3@@0|) (DtRank |expr#0@@9|))))
 :qid |CloudMakeConsistentBuildslegacydfy.475:19|
 :skolemid |1146|
 :pattern ( (|Seq#Contains| |args#0@@6| ($Box DatatypeTypeType |arg#3@@0|)))
))))) (and (|_module.__default.evalArgsC_k#canCall| (Lit DatatypeTypeType |expr#0@@9|) (Lit SeqType |args#0@@6|) (Lit DatatypeTypeType |stC#0@@19|) (Lit BoxType |env#0@@9|) (Lit SeqType |Seq#Empty|) (Lit SetType |Set#Empty|)) (= (_module.__default.evalArgsC ($LS $ly@@15) (Lit DatatypeTypeType |expr#0@@9|) (Lit SeqType |args#0@@6|) (Lit DatatypeTypeType |stC#0@@19|) (Lit BoxType |env#0@@9|)) (Lit DatatypeTypeType (_module.__default.evalArgsC_k ($LS $ly@@15) (Lit DatatypeTypeType |expr#0@@9|) (Lit SeqType |args#0@@6|) (Lit DatatypeTypeType |stC#0@@19|) (Lit BoxType |env#0@@9|) (Lit SeqType |Seq#Empty|) (Lit SetType |Set#Empty|))))))
 :qid |CloudMakeConsistentBuildslegacydfy.473:16|
 :weight 3
 :skolemid |1147|
 :pattern ( (_module.__default.evalArgsC ($LS $ly@@15) (Lit DatatypeTypeType |expr#0@@9|) (Lit SeqType |args#0@@6|) (Lit DatatypeTypeType |stC#0@@19|) (Lit BoxType |env#0@@9|)))
))))
...
(let ((|cmd#3| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@7|) (LitInt 0)))))
 (=> (_module.Expression.exprLiteral_q |cmd#3|) (=> (_module.Literal.litString_q (_module.Expression.lit |cmd#3|)) (=> (_module.Expression.exprLiteral_q |deps#3|) (=> (_module.Literal.litArrOfPaths_q (_module.Expression.lit |deps#3|)) (=> (_module.Expression.exprLiteral_q |exts#3|) (=> (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#3|)) (and (and (_module.StateC.S_q (Lit DatatypeTypeType |stC#0@@20|)) (|_module.__default.DomSt#canCall| (Lit BoxType (_module.StateC.st (Lit DatatypeTypeType |stC#0@@20|))))) (=> (|Set#Subset| (_module.Literal.paths (_module.Expression.lit |deps#3|)) (_module.__default.DomSt (Lit BoxType (_module.StateC.st (Lit DatatypeTypeType |stC#0@@20|))))) (|_module.__default.PreC#canCall| |cmd#3| |deps#3| |exts#3| (Lit DatatypeTypeType |stC#0@@20|)))))))))))))) (= (_module.__default.ValidArgsC (Lit DatatypeTypeType |prim#0@@3|) (Lit SeqType |args#0@@7|) (Lit DatatypeTypeType |stC#0@@20|)) (ite (_module.Primitive.primCreatePath_q (Lit DatatypeTypeType |prim#0@@3|)) false (let ((|exts#2| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@7|) (LitInt 2)))))
...
(let ((|cmd#2| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |args#0@@7|) (LitInt 0)))))
 (and (and (and (and (and (and (and (_module.Expression.exprLiteral_q |cmd#2|) (_module.Literal.litString_q (_module.Expression.lit |cmd#2|))) (_module.Expression.exprLiteral_q |deps#2|)) (_module.Literal.litArrOfPaths_q (_module.Expression.lit |deps#2|))) (_module.Expression.exprLiteral_q |exts#2|)) (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#2|))) (|Set#Subset| (_module.Literal.paths (_module.Expression.lit |deps#2|)) (_module.__default.DomSt (Lit BoxType (_module.StateC.st (Lit DatatypeTypeType |stC#0@@20|)))))) (_module.__default.PreC |cmd#2| |deps#2| |exts#2| (Lit DatatypeTypeType |stC#0@@20|))))))))))
 :qid |CloudMakeConsistentBuildslegacydfy.497:28|
 :weight 3
 :skolemid |1171|
 :pattern ( (_module.__default.ValidArgsC (Lit DatatypeTypeType |prim#0@@3|) (Lit SeqType |args#0@@7|) (Lit DatatypeTypeType |stC#0@@20|)))
))))
(assert (forall (($ly@@16 T@U) (|expr#0@@10| T@U) (|stC#0@@21| T@U) (|env#0@@10| T@U) ) (! (= (_module.__default.evalC ($LS $ly@@16) |expr#0@@10| |stC#0@@21| |env#0@@10|) (_module.__default.evalC $ly@@16 |expr#0@@10| |stC#0@@21| |env#0@@10|))
 :qid |CloudMakeConsistentBuildslegacydfy.397:16|
 :skolemid |1109|
 :pattern ( (_module.__default.evalC ($LS $ly@@16) |expr#0@@10| |stC#0@@21| |env#0@@10|))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@17 T@U) (|cmd#0@@13| T@U) (|deps#0@@12| T@U) (|exts#0@@10| T@U) (|stC#0@@22| T@U) ) (!  (=> (or (|_module.__default.UpdateC#canCall| |cmd#0@@13| |deps#0@@12| (Lit DatatypeTypeType |exts#0@@10|) |stC#0@@22|) (and (< 3 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |cmd#0@@13| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@12| Tclass._module.Expression)) ($Is DatatypeTypeType |exts#0@@10| Tclass._module.Expression)) ($Is DatatypeTypeType |stC#0@@22| Tclass._module.StateC)) (and (and (and (and (and (_module.Expression.exprLiteral_q |cmd#0@@13|) (_module.Literal.litString_q (_module.Expression.lit |cmd#0@@13|))) (_module.Expression.exprLiteral_q |deps#0@@12|)) (_module.Literal.litArrOfPaths_q (_module.Expression.lit |deps#0@@12|))) (_module.Expression.exprLiteral_q (Lit DatatypeTypeType |exts#0@@10|))) (_module.Literal.litArrOfStrings_q (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@10|)))))))) (and (let ((|strs#1| (Lit SetType (_module.Literal.strs (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@10|)))))))
 (=> (not (|Set#Equal| |strs#1| |Set#Empty|)) (and (|_module.__default.Choose#canCall| |strs#1|) (let ((|e#2@@5| (_module.__default.Choose |strs#1|)))
 (and (and (and (and (|_module.__default.Loc#canCall| |cmd#0@@13| |deps#0@@12| |e#2@@5|) (|_module.__default.Hash#canCall| (_module.__default.Loc |cmd#0@@13| |deps#0@@12| |e#2@@5|))) (_module.StateC.S_q |stC#0@@22|)) (|_module.__default.SetC#canCall| (_module.__default.Hash (_module.__default.Loc |cmd#0@@13| |deps#0@@12| |e#2@@5|)) (|#_module.Triple.Trio| ($Box DatatypeTypeType |cmd#0@@13|) ($Box DatatypeTypeType |deps#0@@12|) ($Box SeqType |e#2@@5|)) (_module.StateC.c |stC#0@@22|))) (let ((|c'#1| (_module.__default.SetC (_module.__default.Hash (_module.__default.Loc |cmd#0@@13| |deps#0@@12| |e#2@@5|)) (|#_module.Triple.Trio| ($Box DatatypeTypeType |cmd#0@@13|) ($Box DatatypeTypeType |deps#0@@12|) ($Box SeqType |e#2@@5|)) (_module.StateC.c |stC#0@@22|))))
(let ((|exts'#1| (|#_module.Expression.exprLiteral| (|#_module.Literal.litArrOfStrings| (|Set#Difference| |strs#1| (|Set#UnionOne| |Set#Empty| ($Box SeqType |e#2@@5|)))))))
 (and (_module.StateC.S_q |stC#0@@22|) (|_module.__default.UpdateC#canCall| |cmd#0@@13| |deps#0@@12| |exts'#1| (|#_module.StateC.S| (_module.StateC.st |stC#0@@22|) |c'#1|)))))))))) (= (_module.__default.UpdateC ($LS $ly@@17) |cmd#0@@13| |deps#0@@12| (Lit DatatypeTypeType |exts#0@@10|) |stC#0@@22|) (let ((|strs#1@@0| (Lit SetType (_module.Literal.strs (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@10|)))))))
(ite (|Set#Equal| |strs#1@@0| |Set#Empty|) |stC#0@@22| (let ((|e#2@@6| (Lit SeqType (_module.__default.Choose |strs#1@@0|))))
(let ((|c'#1@@0| (_module.__default.SetC (_module.__default.Hash (_module.__default.Loc |cmd#0@@13| |deps#0@@12| |e#2@@6|)) (|#_module.Triple.Trio| ($Box DatatypeTypeType |cmd#0@@13|) ($Box DatatypeTypeType |deps#0@@12|) ($Box SeqType |e#2@@6|)) (_module.StateC.c |stC#0@@22|))))
...
(_module.__default.UpdateC ($LS $ly@@17) |cmd#0@@13| |deps#0@@12| |exts'#1@@0| (|#_module.StateC.S| (_module.StateC.st |stC#0@@22|) |c'#1@@0|))))))))))
 :qid |CloudMakeConsistentBuildslegacydfy.41:16|
 :weight 3
 :skolemid |740|
 :pattern ( (_module.__default.UpdateC ($LS $ly@@17) |cmd#0@@13| |deps#0@@12| (Lit DatatypeTypeType |exts#0@@10|) |stC#0@@22|))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@18 T@U) (|expr#0@@11| T@U) (|stC#0@@23| T@U) (|env#0@@11| T@U) ) (!  (=> (or (|_module.__default.evalC#canCall| |expr#0@@11| |stC#0@@23| |env#0@@11|) (and (< 6 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |expr#0@@11| Tclass._module.Expression) ($Is DatatypeTypeType |stC#0@@23| Tclass._module.StateC)) ($IsBox |env#0@@11| Tclass._module.Env)))) (and (and (|_module.__default.Value#canCall| |expr#0@@11|) (=> (not (_module.__default.Value |expr#0@@11|)) (and (=> (_module.Expression.exprIdentifier_q |expr#0@@11|) (|_module.__default.GetEnv#canCall| (_module.Expression.id |expr#0@@11|) |env#0@@11|)) (=> (not (_module.Expression.exprIdentifier_q |expr#0@@11|)) (and (and (=> (_module.Expression.exprIf_q |expr#0@@11|) (=> (_module.Expression.exprLiteral_q (_module.Expression.cond |expr#0@@11|)) (|$IsA#_module.Literal| (_module.Expression.lit (_module.Expression.cond |expr#0@@11|))))) (=> (and (and (_module.Expression.exprIf_q |expr#0@@11|) (_module.Expression.exprLiteral_q (_module.Expression.cond |expr#0@@11|))) (|_module.Literal#Equal| (_module.Expression.lit (_module.Expression.cond |expr#0@@11|)) |#_module.Literal.litTrue|)) (|_module.__default.evalC#canCall| (_module.Expression.ifTrue |expr#0@@11|) |stC#0@@23| |env#0@@11|))) (=> (not (and (and (_module.Expression.exprIf_q |expr#0@@11|) (_module.Expression.exprLiteral_q (_module.Expression.cond |expr#0@@11|))) (|_module.Literal#Equal| (_module.Expression.lit (_module.Expression.cond |expr#0@@11|)) |#_module.Literal.litTrue|))) (and (and (=> (_module.Expression.exprIf_q |expr#0@@11|) (=> (_module.Expression.exprLiteral_q (_module.Expression.cond |expr#0@@11|)) (|$IsA#_module.Literal| (_module.Expression.lit (_module.Expression.cond |expr#0@@11|))))) (=> (and (and (_module.Expression.exprIf_q |expr#0@@11|) (_module.Expression.exprLiteral_q (_module.Expression.cond |expr#0@@11|))) (|_module.Literal#Equal| (_module.Expression.lit (_module.Expression.cond |expr#0@@11|)) |#_module.Literal.litFalse|)) (|_module.__default.evalC#canCall| (_module.Expression.ifFalse |expr#0@@11|) |stC#0@@23| |env#0@@11|))) (=> (not (and (and (_module.Expression.exprIf_q |expr#0@@11|) (_module.Expression.exprLiteral_q (_module.Expression.cond |expr#0@@11|))) (|_module.Literal#Equal| (_module.Expression.lit (_module.Expression.cond |expr#0@@11|)) |#_module.Literal.litFalse|))) (and (=> (_module.Expression.exprIf_q |expr#0@@11|) (and (|_module.__default.evalC#canCall| (_module.Expression.cond |expr#0@@11|) |stC#0@@23| |env#0@@11|) (let ((|result#0@@0| (_module.__default.evalC $ly@@18 (_module.Expression.cond |expr#0@@11|) |stC#0@@23| |env#0@@11|)))
...
(let ((|fun'#0| ($Unbox DatatypeTypeType (_module.Tuple.fst |resultFun#0|))))
 (and (|_module.__default.evalArgsC#canCall| |expr#0@@11| (_module.Expression.args |expr#0@@11|) |stC#0@@23| |env#0@@11|) (let ((|resultArgs#0| (_module.__default.evalArgsC $ly@@18 |expr#0@@11| (_module.Expression.args |expr#0@@11|) |stC#0@@23| |env#0@@11|)))
...
(let ((|stsC''#0| (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |stC'#3|)) |stsC'#0@@2|)))
 ...
 (=> (and (_module.Expression.exprLiteral_q |fun'#0|) (_module.Literal.litPrimitive_q (_module.Expression.lit |fun'#0|))) (=> (_module.Primitive.primExec_q (_module.Literal.prim (_module.Expression.lit |fun'#0|))) (and (and (and (|_module.__default.Arity#canCall| (Lit DatatypeTypeType |#_module.Primitive.primExec|)) (=> (= (|Seq#Length| |args'#0@@2|) (LitInt (_module.__default.Arity (Lit DatatypeTypeType |#_module.Primitive.primExec|)))) (|_module.__default.ValidArgsC#canCall| (Lit DatatypeTypeType |#_module.Primitive.primExec|) |args'#0@@2| |stCombinedC#0|))) (=> (and (= (|Seq#Length| |args'#0@@2|) (LitInt (_module.__default.Arity (Lit DatatypeTypeType |#_module.Primitive.primExec|)))) (_module.__default.ValidArgsC (Lit DatatypeTypeType |#_module.Primitive.primExec|) |args'#0@@2| |stCombinedC#0|)) (|_module.__default.execC#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |args'#0@@2| (LitInt 0))) ($Unbox DatatypeTypeType (|Seq#Index| |args'#0@@2| (LitInt 1))) ($Unbox DatatypeTypeType (|Seq#Index| |args'#0@@2| (LitInt 2))) |stCombinedC#0|))) (=> (not (and (= (|Seq#Length| |args'#0@@2|) (LitInt (_module.__default.Arity (Lit DatatypeTypeType |#_module.Primitive.primExec|)))) (_module.__default.ValidArgsC (Lit DatatypeTypeType |#_module.Primitive.primExec|) |args'#0@@2| |stCombinedC#0|))) (|_module.__default.ConsistentCache#canCall| |stCombinedC#0|))))))))))))))))))))))))))))))))))) (= (_module.__default.evalC ($LS $ly@@18) |expr#0@@11| |stC#0@@23| |env#0@@11|) (ite (_module.__default.Value |expr#0@@11|) (|#_module.Tuple.Pair| ($Box DatatypeTypeType |expr#0@@11|) ($Box DatatypeTypeType |stC#0@@23|)) (ite (_module.Expression.exprIdentifier_q |expr#0@@11|) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (_module.__default.GetEnv (_module.Expression.id |expr#0@@11|) |env#0@@11|)) ($Box DatatypeTypeType |stC#0@@23|)) (ite  (and (and (_module.Expression.exprIf_q |expr#0@@11|) (_module.Expression.exprLiteral_q (_module.Expression.cond |expr#0@@11|))) (|_module.Literal#Equal| (_module.Expression.lit (_module.Expression.cond |expr#0@@11|)) |#_module.Literal.litTrue|)) (_module.__default.evalC $ly@@18 (_module.Expression.ifTrue |expr#0@@11|) |stC#0@@23| |env#0@@11|) (ite  (and (and (_module.Expression.exprIf_q |expr#0@@11|) (_module.Expression.exprLiteral_q (_module.Expression.cond |expr#0@@11|))) (|_module.Literal#Equal| (_module.Expression.lit (_module.Expression.cond |expr#0@@11|)) |#_module.Literal.litFalse|)) (_module.__default.evalC $ly@@18 (_module.Expression.ifFalse |expr#0@@11|) |stC#0@@23| |env#0@@11|) (ite (_module.Expression.exprIf_q |expr#0@@11|) (let ((|result#0@@1| (_module.__default.evalC $ly@@18 (_module.Expression.cond |expr#0@@11|) |stC#0@@23| |env#0@@11|)))
...
(ite  (and (_module.Expression.exprLiteral_q |cond'#0@@0|) (|_module.Literal#Equal| (_module.Expression.lit |cond'#0@@0|) |#_module.Literal.litTrue|)) (_module.__default.evalC $ly@@18 (_module.Expression.ifTrue |expr#0@@11|) |stC'#0@@4| |env#0@@11|) (ite  (and (_module.Expression.exprLiteral_q |cond'#0@@0|) (|_module.Literal#Equal| (_module.Expression.lit |cond'#0@@0|) |#_module.Literal.litFalse|)) (_module.__default.evalC $ly@@18 (_module.Expression.ifFalse |expr#0@@11|) |stC'#0@@4| |env#0@@11|) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rValidity|)))) ($Box DatatypeTypeType |stC#0@@23|))))))) (ite (_module.Expression.exprAnd_q |expr#0@@11|) (let ((|result#1@@4| (_module.__default.evalC $ly@@18 (_module.Expression.conj0 |expr#0@@11|) |stC#0@@23| |env#0@@11|)))
...
(ite  (and (_module.Expression.exprLiteral_q |disj0'#0@@0|) (|_module.Literal#Equal| (_module.Expression.lit |disj0'#0@@0|) |#_module.Literal.litTrue|)) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprLiteral| (Lit DatatypeTypeType |#_module.Literal.litTrue|)))) ($Box DatatypeTypeType |stC'#2@@2|)) (ite  (and (_module.Expression.exprLiteral_q |disj0'#0@@0|) (|_module.Literal#Equal| (_module.Expression.lit |disj0'#0@@0|) |#_module.Literal.litFalse|)) (_module.__default.evalC $ly@@18 (_module.Expression.disj1 |expr#0@@11|) |stC'#2@@2| |env#0@@11|) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rValidity|)))) ($Box DatatypeTypeType |stC#0@@23|))))))) (ite (_module.Expression.exprInvocation_q |expr#0@@11|) (let ((|resultFun#0@@0| (_module.__default.evalC $ly@@18 (_module.Expression.fun |expr#0@@11|) |stC#0@@23| |env#0@@11|)))
...
(let ((|resultArgs#0@@0| (_module.__default.evalArgsC $ly@@18 |expr#0@@11| (_module.Expression.args |expr#0@@11|) |stC#0@@23| |env#0@@11|)))
...
(ite  (and (_module.Expression.exprLiteral_q |fun'#0@@0|) (_module.Literal.litPrimitive_q (_module.Expression.lit |fun'#0@@0|))) (ite (_module.Primitive.primExec_q (_module.Literal.prim (_module.Expression.lit |fun'#0@@0|))) (ite  (and (= (|Seq#Length| |args'#0@@3|) (LitInt (_module.__default.Arity (Lit DatatypeTypeType |#_module.Primitive.primExec|)))) (_module.__default.ValidArgsC (Lit DatatypeTypeType |#_module.Primitive.primExec|) |args'#0@@3| |stCombinedC#0@@0|)) (_module.__default.execC ($Unbox DatatypeTypeType (|Seq#Index| |args'#0@@3| (LitInt 0))) ($Unbox DatatypeTypeType (|Seq#Index| |args'#0@@3| (LitInt 1))) ($Unbox DatatypeTypeType (|Seq#Index| |args'#0@@3| (LitInt 2))) |stCombinedC#0@@0|) (ite (_module.__default.ConsistentCache |stCombinedC#0@@0|) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rValidity|)))) ($Box DatatypeTypeType |stC#0@@23|)) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rInconsistentCache|)))) ($Box DatatypeTypeType |stC#0@@23|)))) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rValidity|)))) ($Box DatatypeTypeType |stC#0@@23|))) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rValidity|)))) ($Box DatatypeTypeType |stC#0@@23|)))) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rCompatibility|)))) ($Box DatatypeTypeType |stC#0@@23|)))))))))) (|#_module.Tuple.Pair| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Expression.exprError| (Lit DatatypeTypeType |#_module.Reason.rValidity|)))) ($Box DatatypeTypeType |stC#0@@23|)))))))))))))
 :qid |CloudMakeConsistentBuildslegacydfy.397:16|
 :skolemid |1113|
 :pattern ( (_module.__default.evalC ($LS $ly@@18) |expr#0@@11| |stC#0@@23| |env#0@@11|))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|cmd#0@@14| T@U) (|deps#0@@13| T@U) (|exts#0@@11| T@U) (|stC#0@@24| T@U) ) (!  (=> (or (|_module.__default.execC#canCall| |cmd#0@@14| |deps#0@@13| |exts#0@@11| |stC#0@@24|) (and (< 4 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |cmd#0@@14| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@13| Tclass._module.Expression)) ($Is DatatypeTypeType |exts#0@@11| Tclass._module.Expression)) ($Is DatatypeTypeType |stC#0@@24| Tclass._module.StateC)) (and (and (and (and (and (_module.Expression.exprLiteral_q |cmd#0@@14|) (_module.Literal.litString_q (_module.Expression.lit |cmd#0@@14|))) (_module.Expression.exprLiteral_q |deps#0@@13|)) (_module.Literal.litArrOfPaths_q (_module.Expression.lit |deps#0@@13|))) (_module.Expression.exprLiteral_q |exts#0@@11|)) (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#0@@11|)))))) (and (and (and (forall ((|e#0@@4| T@U) ) (!  (=> ($Is SeqType |e#0@@4| (TSeq TChar)) (=> (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0@@11|)) ($Box SeqType |e#0@@4|)) (and (and (|_module.__default.Loc#canCall| |cmd#0@@14| |deps#0@@13| |e#0@@4|) (|_module.__default.Hash#canCall| (_module.__default.Loc |cmd#0@@14| |deps#0@@13| |e#0@@4|))) (and (_module.StateC.S_q |stC#0@@24|) (|_module.__default.DomC#canCall| (_module.StateC.c |stC#0@@24|))))))
 :qid |CloudMakeConsistentBuildslegacydfy.237:13|
 :skolemid |972|
...
)) (=> (forall ((|e#0@@5| T@U) ) (!  (=> (and ($Is SeqType |e#0@@5| (TSeq TChar)) (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0@@11|)) ($Box SeqType |e#0@@5|))) (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@24|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@14| |deps#0@@13| |e#0@@5|))))
 :qid |CloudMakeConsistentBuildslegacydfy.237:13|
 :skolemid |973|
...
)))) (=> (not (forall ((|e#0@@6| T@U) ) (!  (=> (and ($Is SeqType |e#0@@6| (TSeq TChar)) (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0@@11|)) ($Box SeqType |e#0@@6|))) (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@24|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@14| |deps#0@@13| |e#0@@6|))))
 :qid |CloudMakeConsistentBuildslegacydfy.237:13|
 :skolemid |973|
...
))) (and (and (_module.StateC.S_q |stC#0@@24|) (|_module.__default.exec#canCall| |cmd#0@@14| |deps#0@@13| |exts#0@@11| (_module.StateC.st |stC#0@@24|))) (let ((|result#0@@2| (_module.__default.exec |cmd#0@@14| |deps#0@@13| |exts#0@@11| (_module.StateC.st |stC#0@@24|))))
 (and (and (_module.Tuple.Pair_q |result#0@@2|) (_module.Tuple.Pair_q |result#0@@2|)) (let ((|st'#0@@0| (_module.Tuple.snd |result#0@@2|)))
 (and (_module.StateC.S_q |stC#0@@24|) (|_module.__default.UpdateC#canCall| |cmd#0@@14| |deps#0@@13| |exts#0@@11| (|#_module.StateC.S| |st'#0@@0| (_module.StateC.c |stC#0@@24|)))))))))) (= (_module.__default.execC |cmd#0@@14| |deps#0@@13| |exts#0@@11| |stC#0@@24|) (ite (forall ((|e#0@@7| T@U) ) (!  (=> (and ($Is SeqType |e#0@@7| (TSeq TChar)) (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0@@11|)) ($Box SeqType |e#0@@7|))) (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@24|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@14| |deps#0@@13| |e#0@@7|))))
 :qid |CloudMakeConsistentBuildslegacydfy.237:13|
 :skolemid |970|
...
(let ((|expr'#0| (|#_module.Expression.exprLiteral| (|#_module.Literal.litArrOfPaths| |paths#0@@0|))))
(|#_module.Tuple.Pair| ($Box DatatypeTypeType |expr'#0|) ($Box DatatypeTypeType |stC#0@@24|)))) (let ((|result#0@@3| (_module.__default.exec |cmd#0@@14| |deps#0@@13| |exts#0@@11| (_module.StateC.st |stC#0@@24|))))
(let ((|st'#0@@1| (_module.Tuple.snd |result#0@@3|)))
(let ((|expr'#1| ($Unbox DatatypeTypeType (_module.Tuple.fst |result#0@@3|))))
(let ((|stC'#0@@5| (_module.__default.UpdateC ($LS $LZ) |cmd#0@@14| |deps#0@@13| |exts#0@@11| (|#_module.StateC.S| |st'#0@@1| (_module.StateC.c |stC#0@@24|)))))
(|#_module.Tuple.Pair| ($Box DatatypeTypeType |expr'#1|) ($Box DatatypeTypeType |stC'#0@@5|))))))))))
 :qid |CloudMakeConsistentBuildslegacydfy.231:22|
 :skolemid |976|
 :pattern ( (_module.__default.execC |cmd#0@@14| |deps#0@@13| |exts#0@@11| |stC#0@@24|))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@19 T@U) (|expr#0@@12| T@U) (|args#0@@8| T@U) (|stC#0@@25| T@U) (|env#0@@12| T@U) ) (!  (=> (or (|_module.__default.evalArgsC#canCall| (Lit DatatypeTypeType |expr#0@@12|) (Lit SeqType |args#0@@8|) |stC#0@@25| |env#0@@12|) (and (< 6 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |expr#0@@12| Tclass._module.Expression) ($Is SeqType |args#0@@8| (TSeq Tclass._module.Expression))) ($Is DatatypeTypeType |stC#0@@25| Tclass._module.StateC)) ($IsBox |env#0@@12| Tclass._module.Env)) (forall ((|arg#2| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#2| Tclass._module.Expression) (=> (|Seq#Contains| |args#0@@8| ($Box DatatypeTypeType |arg#2|)) (< (DtRank |arg#2|) (DtRank |expr#0@@12|))))
 :qid |CloudMakeConsistentBuildslegacydfy.475:19|
 :skolemid |1144|
 :pattern ( (|Seq#Contains| |args#0@@8| ($Box DatatypeTypeType |arg#2|)))
))))) (and (|_module.__default.evalArgsC_k#canCall| (Lit DatatypeTypeType |expr#0@@12|) (Lit SeqType |args#0@@8|) |stC#0@@25| |env#0@@12| (Lit SeqType |Seq#Empty|) (Lit SetType |Set#Empty|)) (= (_module.__default.evalArgsC ($LS $ly@@19) (Lit DatatypeTypeType |expr#0@@12|) (Lit SeqType |args#0@@8|) |stC#0@@25| |env#0@@12|) (_module.__default.evalArgsC_k ($LS $ly@@19) (Lit DatatypeTypeType |expr#0@@12|) (Lit SeqType |args#0@@8|) |stC#0@@25| |env#0@@12| (Lit SeqType |Seq#Empty|) (Lit SetType |Set#Empty|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.473:16|
 :weight 3
 :skolemid |1145|
 :pattern ( (_module.__default.evalArgsC ($LS $ly@@19) (Lit DatatypeTypeType |expr#0@@12|) (Lit SeqType |args#0@@8|) |stC#0@@25| |env#0@@12|))
))))
...
(assert (forall ((d@@53 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.Literal.litNumber_q d@@53) ($IsAlloc DatatypeTypeType d@@53 Tclass._module.Literal $h@@1))) ($IsAlloc intType (int_2_U (_module.Literal.num d@@53)) TInt $h@@1))
 :qid |unknown.0:0|
 :skolemid |1429|
 :pattern ( ($IsAlloc intType (int_2_U (_module.Literal.num d@@53)) TInt $h@@1))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|stC#0@@26| T@U) ) (!  (=> (or (|_module.__default.ConsistentCache#canCall| (Lit DatatypeTypeType |stC#0@@26|)) (and (< 3 $FunctionContextHeight) ($Is DatatypeTypeType |stC#0@@26| Tclass._module.StateC))) (and (forall ((|cmd#1@@0| T@U) (|deps#1@@0| T@U) (|e#1@@5| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#1@@0| Tclass._module.Expression) ($Is DatatypeTypeType |deps#1@@0| Tclass._module.Expression)) ($Is SeqType |e#1@@5| (TSeq TChar))) (and (and (and (|_module.__default.Loc#canCall| |cmd#1@@0| |deps#1@@0| |e#1@@5|) (|_module.__default.Hash#canCall| (_module.__default.Loc |cmd#1@@0| |deps#1@@0| |e#1@@5|))) (and (_module.StateC.S_q (Lit DatatypeTypeType |stC#0@@26|)) (|_module.__default.DomC#canCall| (Lit BoxType (_module.StateC.c (Lit DatatypeTypeType |stC#0@@26|)))))) (=> (|Set#IsMember| (_module.__default.DomC (Lit BoxType (_module.StateC.c (Lit DatatypeTypeType |stC#0@@26|)))) (_module.__default.Hash (_module.__default.Loc |cmd#1@@0| |deps#1@@0| |e#1@@5|))) (and (|_module.__default.Loc#canCall| |cmd#1@@0| |deps#1@@0| |e#1@@5|) (and (_module.StateC.S_q (Lit DatatypeTypeType |stC#0@@26|)) (|_module.__default.DomSt#canCall| (Lit BoxType (_module.StateC.st (Lit DatatypeTypeType |stC#0@@26|)))))))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |877|
 :pattern ( (_module.__default.Loc |cmd#1@@0| |deps#1@@0| |e#1@@5|))
)) (= (_module.__default.ConsistentCache (Lit DatatypeTypeType |stC#0@@26|)) (forall ((|cmd#1@@1| T@U) (|deps#1@@1| T@U) (|e#1@@6| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#1@@1| Tclass._module.Expression) ($Is DatatypeTypeType |deps#1@@1| Tclass._module.Expression)) ($Is SeqType |e#1@@6| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (Lit BoxType (_module.StateC.c (Lit DatatypeTypeType |stC#0@@26|)))) (_module.__default.Hash (_module.__default.Loc |cmd#1@@1| |deps#1@@1| |e#1@@6|))) (|Set#IsMember| (_module.__default.DomSt (Lit BoxType (_module.StateC.st (Lit DatatypeTypeType |stC#0@@26|)))) ($Box DatatypeTypeType (_module.__default.Loc |cmd#1@@1| |deps#1@@1| |e#1@@6|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |876|
 ...
 :weight 3
 :skolemid |878|
 :pattern ( (_module.__default.ConsistentCache (Lit DatatypeTypeType |stC#0@@26|)))
))))
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@20 T@U) (|expr#0@@13| T@U) (|args#0@@9| T@U) (|stC#0@@27| T@U) (|env#0@@13| T@U) (|args'#0@@4| T@U) (|stsC'#0@@4| T@U) ) (!  (=> (or (|_module.__default.evalArgsC_k#canCall| |expr#0@@13| |args#0@@9| |stC#0@@27| |env#0@@13| |args'#0@@4| |stsC'#0@@4|) (and (< 6 $FunctionContextHeight) (and (and (and (and (and (and ($Is DatatypeTypeType |expr#0@@13| Tclass._module.Expression) ($Is SeqType |args#0@@9| (TSeq Tclass._module.Expression))) ($Is DatatypeTypeType |stC#0@@27| Tclass._module.StateC)) ($IsBox |env#0@@13| Tclass._module.Env)) ($Is SeqType |args'#0@@4| (TSeq Tclass._module.Expression))) ($Is SetType |stsC'#0@@4| (TSet Tclass._module.StateC))) (forall ((|arg#0@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#0@@0| Tclass._module.Expression) (=> (|Seq#Contains| |args#0@@9| ($Box DatatypeTypeType |arg#0@@0|)) (< (DtRank |arg#0@@0|) (DtRank |expr#0@@13|))))
 :qid |CloudMakeConsistentBuildslegacydfy.485:19|
 :skolemid |1154|
 :pattern ( (|Seq#Contains| |args#0@@9| ($Box DatatypeTypeType |arg#0@@0|)))
))))) ($Is DatatypeTypeType (_module.__default.evalArgsC_k $ly@@20 |expr#0@@13| |args#0@@9| |stC#0@@27| |env#0@@13| |args'#0@@4| |stsC'#0@@4|) (Tclass._module.Tuple (TSeq Tclass._module.Expression) (TSet Tclass._module.StateC))))
 :qid |CloudMakeConsistentBuildslegacydfy.482:16|
 :skolemid |1155|
 :pattern ( (_module.__default.evalArgsC_k $ly@@20 |expr#0@@13| |args#0@@9| |stC#0@@27| |env#0@@13| |args'#0@@4| |stsC'#0@@4|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($ly@@21 T@U) (|stsC#0@@4| T@U) ) (!  (=> (or (|_module.__default.CombineC#canCall| |stsC#0@@4|) (and (< 4 $FunctionContextHeight) (and ($Is SetType |stsC#0@@4| (TSet Tclass._module.StateC)) (not (|Set#Equal| |stsC#0@@4| |Set#Empty|))))) (and (let ((|stCombinedC#0@@1| (_module.__default.CombineC $ly@@21 |stsC#0@@4|)))
 (and (and (and (and (and (forall ((|stC#0@@28| T@U) ) (!  (=> ($Is DatatypeTypeType |stC#0@@28| Tclass._module.StateC) (=> (|Set#IsMember| |stsC#0@@4| ($Box DatatypeTypeType |stC#0@@28|)) (|Set#Subset| (_module.__default.DomSt (_module.StateC.st |stC#0@@28|)) (_module.__default.DomSt (_module.StateC.st |stCombinedC#0@@1|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.124:13|
 :skolemid |812|
 :pattern ( (_module.StateC.st |stC#0@@28|))
 :pattern ( (|Set#IsMember| |stsC#0@@4| ($Box DatatypeTypeType |stC#0@@28|)))
...
(assert (forall ((d@@55 T@U) (_module.Triple$A@@7 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (_module.Triple.Trio_q d@@55) (exists ((_module.Triple$B@@7 T@U) (_module.Triple$C@@7 T@U) ) (! ($IsAlloc DatatypeTypeType d@@55 (Tclass._module.Triple _module.Triple$A@@7 _module.Triple$B@@7 _module.Triple$C@@7) $h@@2)
 :qid |unknown.0:0|
 :skolemid |1563|
 :pattern ( ($IsAlloc DatatypeTypeType d@@55 (Tclass._module.Triple _module.Triple$A@@7 _module.Triple$B@@7 _module.Triple$C@@7) $h@@2))
)))) ($IsAllocBox (_module.Triple.fst d@@55) _module.Triple$A@@7 $h@@2))
 :qid |unknown.0:0|
 :skolemid |1564|
 :pattern ( ($IsAllocBox (_module.Triple.fst d@@55) _module.Triple$A@@7 $h@@2))
)))
(assert (forall ((d@@56 T@U) (_module.Triple$B@@8 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (_module.Triple.Trio_q d@@56) (exists ((_module.Triple$A@@8 T@U) (_module.Triple$C@@8 T@U) ) (! ($IsAlloc DatatypeTypeType d@@56 (Tclass._module.Triple _module.Triple$A@@8 _module.Triple$B@@8 _module.Triple$C@@8) $h@@3)
 :qid |unknown.0:0|
 :skolemid |1565|
 :pattern ( ($IsAlloc DatatypeTypeType d@@56 (Tclass._module.Triple _module.Triple$A@@8 _module.Triple$B@@8 _module.Triple$C@@8) $h@@3))
)))) ($IsAllocBox (_module.Triple.snd d@@56) _module.Triple$B@@8 $h@@3))
 :qid |unknown.0:0|
 :skolemid |1566|
 :pattern ( ($IsAllocBox (_module.Triple.snd d@@56) _module.Triple$B@@8 $h@@3))
)))
(assert (forall ((d@@57 T@U) (_module.Triple$C@@9 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (_module.Triple.Trio_q d@@57) (exists ((_module.Triple$A@@9 T@U) (_module.Triple$B@@9 T@U) ) (! ($IsAlloc DatatypeTypeType d@@57 (Tclass._module.Triple _module.Triple$A@@9 _module.Triple$B@@9 _module.Triple$C@@9) $h@@4)
 :qid |unknown.0:0|
 :skolemid |1567|
 :pattern ( ($IsAlloc DatatypeTypeType d@@57 (Tclass._module.Triple _module.Triple$A@@9 _module.Triple$B@@9 _module.Triple$C@@9) $h@@4))
)))) ($IsAllocBox (_module.Triple.trd d@@57) _module.Triple$C@@9 $h@@4))
 :qid |unknown.0:0|
 :skolemid |1568|
 :pattern ( ($IsAllocBox (_module.Triple.trd d@@57) _module.Triple$C@@9 $h@@4))
)))
(assert (forall ((d@@58 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) ($Is DatatypeTypeType d@@58 Tclass._module.StateC)) ($IsAlloc DatatypeTypeType d@@58 Tclass._module.StateC $h@@5))
 :qid |unknown.0:0|
 :skolemid |1279|
 :pattern ( ($IsAlloc DatatypeTypeType d@@58 Tclass._module.StateC $h@@5))
)))
(assert (forall ((d@@59 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) ($Is DatatypeTypeType d@@59 Tclass._module.Expression)) ($IsAlloc DatatypeTypeType d@@59 Tclass._module.Expression $h@@6))
 :qid |unknown.0:0|
 :skolemid |1405|
 :pattern ( ($IsAlloc DatatypeTypeType d@@59 Tclass._module.Expression $h@@6))
)))
(assert (forall ((d@@60 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) ($Is DatatypeTypeType d@@60 Tclass._module.Literal)) ($IsAlloc DatatypeTypeType d@@60 Tclass._module.Literal $h@@7))
 :qid |unknown.0:0|
 :skolemid |1479|
 :pattern ( ($IsAlloc DatatypeTypeType d@@60 Tclass._module.Literal $h@@7))
)))
(assert (forall ((d@@61 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) ($Is DatatypeTypeType d@@61 Tclass._module.Primitive)) ($IsAlloc DatatypeTypeType d@@61 Tclass._module.Primitive $h@@8))
 :qid |unknown.0:0|
 :skolemid |1497|
 :pattern ( ($IsAlloc DatatypeTypeType d@@61 Tclass._module.Primitive $h@@8))
)))
(assert (forall ((d@@62 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) ($Is DatatypeTypeType d@@62 Tclass._module.Reason)) ($IsAlloc DatatypeTypeType d@@62 Tclass._module.Reason $h@@9))
 :qid |unknown.0:0|
 :skolemid |1509|
 :pattern ( ($IsAlloc DatatypeTypeType d@@62 Tclass._module.Reason $h@@9))
)))
(assert (forall ((d@@63 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) ($Is DatatypeTypeType d@@63 Tclass._module.Path)) ($IsAlloc DatatypeTypeType d@@63 Tclass._module.Path $h@@10))
 :qid |unknown.0:0|
 :skolemid |1532|
 :pattern ( ($IsAlloc DatatypeTypeType d@@63 Tclass._module.Path $h@@10))
)))
...
(assert (forall ((d@@64 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (_module.Literal.litString_q d@@64) ($IsAlloc DatatypeTypeType d@@64 Tclass._module.Literal $h@@11))) ($IsAlloc SeqType (_module.Literal.str d@@64) (TSeq TChar) $h@@11))
 :qid |unknown.0:0|
 :skolemid |1437|
 :pattern ( ($IsAlloc SeqType (_module.Literal.str d@@64) (TSeq TChar) $h@@11))
)))
...
(assert (forall ((a@@29 T@U) (b@@26 T@U) ) (! (= (|_module.Triple#Equal| a@@29 b@@26)  (and (and (= (_module.Triple.fst a@@29) (_module.Triple.fst b@@26)) (= (_module.Triple.snd a@@29) (_module.Triple.snd b@@26))) (= (_module.Triple.trd a@@29) (_module.Triple.trd b@@26))))
 :qid |unknown.0:0|
 :skolemid |1578|
 :pattern ( (|_module.Triple#Equal| a@@29 b@@26))
)))
...
(assert (forall ((d@@67 T@U) (_module.Tuple$A@@6 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (_module.Tuple.Pair_q d@@67) (exists ((_module.Tuple$B@@6 T@U) ) (! ($IsAlloc DatatypeTypeType d@@67 (Tclass._module.Tuple _module.Tuple$A@@6 _module.Tuple$B@@6) $h@@12)
 :qid |unknown.0:0|
 :skolemid |1544|
 :pattern ( ($IsAlloc DatatypeTypeType d@@67 (Tclass._module.Tuple _module.Tuple$A@@6 _module.Tuple$B@@6) $h@@12))
)))) ($IsAllocBox (_module.Tuple.fst d@@67) _module.Tuple$A@@6 $h@@12))
 :qid |unknown.0:0|
 :skolemid |1545|
 :pattern ( ($IsAllocBox (_module.Tuple.fst d@@67) _module.Tuple$A@@6 $h@@12))
)))
(assert (forall ((d@@68 T@U) (_module.Tuple$B@@7 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (_module.Tuple.Pair_q d@@68) (exists ((_module.Tuple$A@@7 T@U) ) (! ($IsAlloc DatatypeTypeType d@@68 (Tclass._module.Tuple _module.Tuple$A@@7 _module.Tuple$B@@7) $h@@13)
 :qid |unknown.0:0|
 :skolemid |1546|
 :pattern ( ($IsAlloc DatatypeTypeType d@@68 (Tclass._module.Tuple _module.Tuple$A@@7 _module.Tuple$B@@7) $h@@13))
)))) ($IsAllocBox (_module.Tuple.snd d@@68) _module.Tuple$B@@7 $h@@13))
 :qid |unknown.0:0|
 :skolemid |1547|
 :pattern ( ($IsAllocBox (_module.Tuple.snd d@@68) _module.Tuple$B@@7 $h@@13))
)))
...
(assert (forall ((d@@69 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (_module.StateC.S_q d@@69) ($IsAlloc DatatypeTypeType d@@69 Tclass._module.StateC $h@@14))) ($IsAllocBox (_module.StateC.st d@@69) Tclass._module.State $h@@14))
 :qid |unknown.0:0|
 :skolemid |1274|
 :pattern ( ($IsAllocBox (_module.StateC.st d@@69) Tclass._module.State $h@@14))
)))
(assert (forall ((d@@70 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (_module.StateC.S_q d@@70) ($IsAlloc DatatypeTypeType d@@70 Tclass._module.StateC $h@@15))) ($IsAllocBox (_module.StateC.c d@@70) Tclass._module.Cache $h@@15))
 :qid |unknown.0:0|
 :skolemid |1275|
 :pattern ( ($IsAllocBox (_module.StateC.c d@@70) Tclass._module.Cache $h@@15))
)))
(assert (forall ((d@@71 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (_module.Expression.exprLiteral_q d@@71) ($IsAlloc DatatypeTypeType d@@71 Tclass._module.Expression $h@@16))) ($IsAlloc DatatypeTypeType (_module.Expression.lit d@@71) Tclass._module.Literal $h@@16))
 :qid |unknown.0:0|
 :skolemid |1331|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.lit d@@71) Tclass._module.Literal $h@@16))
)))
(assert (forall ((d@@72 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (_module.Expression.exprIdentifier_q d@@72) ($IsAlloc DatatypeTypeType d@@72 Tclass._module.Expression $h@@17))) ($IsAllocBox (_module.Expression.id d@@72) Tclass._module.Identifier $h@@17))
 :qid |unknown.0:0|
 :skolemid |1340|
 :pattern ( ($IsAllocBox (_module.Expression.id d@@72) Tclass._module.Identifier $h@@17))
)))
(assert (forall ((d@@73 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (_module.Expression.exprIf_q d@@73) ($IsAlloc DatatypeTypeType d@@73 Tclass._module.Expression $h@@18))) ($IsAlloc DatatypeTypeType (_module.Expression.cond d@@73) Tclass._module.Expression $h@@18))
 :qid |unknown.0:0|
 :skolemid |1348|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.cond d@@73) Tclass._module.Expression $h@@18))
)))
(assert (forall ((d@@74 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (_module.Expression.exprIf_q d@@74) ($IsAlloc DatatypeTypeType d@@74 Tclass._module.Expression $h@@19))) ($IsAlloc DatatypeTypeType (_module.Expression.ifTrue d@@74) Tclass._module.Expression $h@@19))
 :qid |unknown.0:0|
 :skolemid |1349|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.ifTrue d@@74) Tclass._module.Expression $h@@19))
)))
(assert (forall ((d@@75 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (_module.Expression.exprIf_q d@@75) ($IsAlloc DatatypeTypeType d@@75 Tclass._module.Expression $h@@20))) ($IsAlloc DatatypeTypeType (_module.Expression.ifFalse d@@75) Tclass._module.Expression $h@@20))
 :qid |unknown.0:0|
 :skolemid |1350|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.ifFalse d@@75) Tclass._module.Expression $h@@20))
)))
(assert (forall ((d@@76 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (_module.Expression.exprAnd_q d@@76) ($IsAlloc DatatypeTypeType d@@76 Tclass._module.Expression $h@@21))) ($IsAlloc DatatypeTypeType (_module.Expression.conj0 d@@76) Tclass._module.Expression $h@@21))
 :qid |unknown.0:0|
 :skolemid |1363|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.conj0 d@@76) Tclass._module.Expression $h@@21))
)))
(assert (forall ((d@@77 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (_module.Expression.exprAnd_q d@@77) ($IsAlloc DatatypeTypeType d@@77 Tclass._module.Expression $h@@22))) ($IsAlloc DatatypeTypeType (_module.Expression.conj1 d@@77) Tclass._module.Expression $h@@22))
 :qid |unknown.0:0|
 :skolemid |1364|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.conj1 d@@77) Tclass._module.Expression $h@@22))
)))
(assert (forall ((d@@78 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (_module.Expression.exprOr_q d@@78) ($IsAlloc DatatypeTypeType d@@78 Tclass._module.Expression $h@@23))) ($IsAlloc DatatypeTypeType (_module.Expression.disj0 d@@78) Tclass._module.Expression $h@@23))
 :qid |unknown.0:0|
 :skolemid |1375|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.disj0 d@@78) Tclass._module.Expression $h@@23))
)))
(assert (forall ((d@@79 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (_module.Expression.exprOr_q d@@79) ($IsAlloc DatatypeTypeType d@@79 Tclass._module.Expression $h@@24))) ($IsAlloc DatatypeTypeType (_module.Expression.disj1 d@@79) Tclass._module.Expression $h@@24))
 :qid |unknown.0:0|
 :skolemid |1376|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.disj1 d@@79) Tclass._module.Expression $h@@24))
)))
(assert (forall ((d@@80 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (_module.Expression.exprInvocation_q d@@80) ($IsAlloc DatatypeTypeType d@@80 Tclass._module.Expression $h@@25))) ($IsAlloc DatatypeTypeType (_module.Expression.fun d@@80) Tclass._module.Expression $h@@25))
 :qid |unknown.0:0|
 :skolemid |1387|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.fun d@@80) Tclass._module.Expression $h@@25))
)))
(assert (forall ((d@@81 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (_module.Expression.exprError_q d@@81) ($IsAlloc DatatypeTypeType d@@81 Tclass._module.Expression $h@@26))) ($IsAlloc DatatypeTypeType (_module.Expression.r d@@81) Tclass._module.Reason $h@@26))
 :qid |unknown.0:0|
 :skolemid |1401|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expression.r d@@81) Tclass._module.Reason $h@@26))
)))
(assert (forall ((d@@82 T@U) ($h@@27 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (_module.Literal.litPrimitive_q d@@82) ($IsAlloc DatatypeTypeType d@@82 Tclass._module.Literal $h@@27))) ($IsAlloc DatatypeTypeType (_module.Literal.prim d@@82) Tclass._module.Primitive $h@@27))
 :qid |unknown.0:0|
 :skolemid |1447|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Literal.prim d@@82) Tclass._module.Primitive $h@@27))
)))
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($ly@@22 T@U) (|expr#0@@15| T@U) (|args#0@@10| T@U) (|stC#0@@29| T@U) (|env#0@@14| T@U) (|args'#0@@5| T@U) (|stsC'#0@@5| T@U) ) (!  (=> (or (|_module.__default.evalArgsC_k#canCall| |expr#0@@15| |args#0@@10| |stC#0@@29| |env#0@@14| |args'#0@@5| |stsC'#0@@5|) (and (< 6 $FunctionContextHeight) (and (and (and (and (and (and ($Is DatatypeTypeType |expr#0@@15| Tclass._module.Expression) ($Is SeqType |args#0@@10| (TSeq Tclass._module.Expression))) ($Is DatatypeTypeType |stC#0@@29| Tclass._module.StateC)) ($IsBox |env#0@@14| Tclass._module.Env)) ($Is SeqType |args'#0@@5| (TSeq Tclass._module.Expression))) ($Is SetType |stsC'#0@@5| (TSet Tclass._module.StateC))) (forall ((|arg#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#1@@0| Tclass._module.Expression) (=> (|Seq#Contains| |args#0@@10| ($Box DatatypeTypeType |arg#1@@0|)) (< (DtRank |arg#1@@0|) (DtRank |expr#0@@15|))))
 :qid |CloudMakeConsistentBuildslegacydfy.485:19|
 :skolemid |1156|
 ...
 (and (|_module.__default.evalC#canCall| |arg#2@@0| |stC#0@@29| |env#0@@14|) (let ((|result#0@@4| (_module.__default.evalC $ly@@22 |arg#2@@0| |stC#0@@29| |env#0@@14|)))
...
(|_module.__default.evalArgsC_k#canCall| |expr#0@@15| (|Seq#Drop| |args#0@@10| (LitInt 1)) |stC#0@@29| |env#0@@14| (|Seq#Append| |args'#0@@5| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |arg'#0|))) (|Set#Union| |stsC'#0@@5| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |stC'#0@@6|))))))))))) (= (_module.__default.evalArgsC_k ($LS $ly@@22) |expr#0@@15| |args#0@@10| |stC#0@@29| |env#0@@14| |args'#0@@5| |stsC'#0@@5|) (ite (|Seq#Equal| |args#0@@10| |Seq#Empty|) (|#_module.Tuple.Pair| ($Box SeqType |args'#0@@5|) ($Box SetType |stsC'#0@@5|)) (let ((|arg#2@@1| ($Unbox DatatypeTypeType (|Seq#Index| |args#0@@10| (LitInt 0)))))
(let ((|result#0@@5| (_module.__default.evalC $ly@@22 |arg#2@@1| |stC#0@@29| |env#0@@14|)))
...
(_module.__default.evalArgsC_k $ly@@22 |expr#0@@15| (|Seq#Drop| |args#0@@10| (LitInt 1)) |stC#0@@29| |env#0@@14| (|Seq#Append| |args'#0@@5| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |arg'#0@@0|))) (|Set#Union| |stsC'#0@@5| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |stC'#0@@7|))))))))))))
 :qid |CloudMakeConsistentBuildslegacydfy.482:16|
 :skolemid |1158|
 :pattern ( (_module.__default.evalArgsC_k ($LS $ly@@22) |expr#0@@15| |args#0@@10| |stC#0@@29| |env#0@@14| |args'#0@@5| |stsC'#0@@5|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|stC#0@@30| T@U) ) (!  (=> (or (|_module.__default.ConsistentCache#canCall| |stC#0@@30|) (and (< 3 $FunctionContextHeight) ($Is DatatypeTypeType |stC#0@@30| Tclass._module.StateC))) (and (forall ((|cmd#0@@15| T@U) (|deps#0@@14| T@U) (|e#0@@8| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#0@@15| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@14| Tclass._module.Expression)) ($Is SeqType |e#0@@8| (TSeq TChar))) (and (and (and (|_module.__default.Loc#canCall| |cmd#0@@15| |deps#0@@14| |e#0@@8|) (|_module.__default.Hash#canCall| (_module.__default.Loc |cmd#0@@15| |deps#0@@14| |e#0@@8|))) (and (_module.StateC.S_q |stC#0@@30|) (|_module.__default.DomC#canCall| (_module.StateC.c |stC#0@@30|)))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@30|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@15| |deps#0@@14| |e#0@@8|))) (and (|_module.__default.Loc#canCall| |cmd#0@@15| |deps#0@@14| |e#0@@8|) (and (_module.StateC.S_q |stC#0@@30|) (|_module.__default.DomSt#canCall| (_module.StateC.st |stC#0@@30|)))))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |874|
 :pattern ( (_module.__default.Loc |cmd#0@@15| |deps#0@@14| |e#0@@8|))
)) (= (_module.__default.ConsistentCache |stC#0@@30|) (forall ((|cmd#0@@16| T@U) (|deps#0@@15| T@U) (|e#0@@9| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#0@@16| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@15| Tclass._module.Expression)) ($Is SeqType |e#0@@9| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@30|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@16| |deps#0@@15| |e#0@@9|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@30|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0@@16| |deps#0@@15| |e#0@@9|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |873|
 ...
 :qid |CloudMakeConsistentBuildslegacydfy.149:33|
 :skolemid |875|
 :pattern ( (_module.__default.ConsistentCache |stC#0@@30|))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|cmd#0@@17| T@U) (|deps#0@@16| T@U) (|exts#0@@12| T@U) (|stC#0@@31| T@U) ) (!  (=> (or (|_module.__default.PreC#canCall| (Lit DatatypeTypeType |cmd#0@@17|) (Lit DatatypeTypeType |deps#0@@16|) (Lit DatatypeTypeType |exts#0@@12|) (Lit DatatypeTypeType |stC#0@@31|)) (and (< 4 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |cmd#0@@17| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@16| Tclass._module.Expression)) ($Is DatatypeTypeType |exts#0@@12| Tclass._module.Expression)) ($Is DatatypeTypeType |stC#0@@31| Tclass._module.StateC)) (and (and (and (and (and (and (_module.Expression.exprLiteral_q (Lit DatatypeTypeType |cmd#0@@17|)) (_module.Literal.litString_q (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |cmd#0@@17|))))) (_module.Expression.exprLiteral_q (Lit DatatypeTypeType |deps#0@@16|))) (_module.Literal.litArrOfPaths_q (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |deps#0@@16|))))) (_module.Expression.exprLiteral_q (Lit DatatypeTypeType |exts#0@@12|))) (_module.Literal.litArrOfStrings_q (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@12|))))) (|Set#Subset| (_module.Literal.paths (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |deps#0@@16|)))) (_module.__default.DomSt (Lit BoxType (_module.StateC.st (Lit DatatypeTypeType |stC#0@@31|))))))))) (and (and (and (and (_module.StateC.S_q (Lit DatatypeTypeType |stC#0@@31|)) (|_module.__default.Restrict#canCall| (Lit SetType (_module.Literal.paths (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |deps#0@@16|))))) (Lit BoxType (_module.StateC.st (Lit DatatypeTypeType |stC#0@@31|))))) (|_module.__default.Pre#canCall| (Lit DatatypeTypeType |cmd#0@@17|) (Lit DatatypeTypeType |deps#0@@16|) (Lit DatatypeTypeType |exts#0@@12|) (_module.__default.Restrict (Lit SetType (_module.Literal.paths (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |deps#0@@16|))))) (Lit BoxType (_module.StateC.st (Lit DatatypeTypeType |stC#0@@31|)))))) (=> (_module.__default.Pre (Lit DatatypeTypeType |cmd#0@@17|) (Lit DatatypeTypeType |deps#0@@16|) (Lit DatatypeTypeType |exts#0@@12|) (_module.__default.Restrict (Lit SetType (_module.Literal.paths (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |deps#0@@16|))))) (Lit BoxType (_module.StateC.st (Lit DatatypeTypeType |stC#0@@31|))))) (forall ((|e#1@@7| T@U) ) (!  (=> ($Is SeqType |e#1@@7| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType (_module.Literal.strs (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@12|))))) ($Box SeqType |e#1@@7|)) (and (and (and (|_module.__default.Loc#canCall| (Lit DatatypeTypeType |cmd#0@@17|) (Lit DatatypeTypeType |deps#0@@16|) |e#1@@7|) (|_module.__default.Hash#canCall| (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@17|) (Lit DatatypeTypeType |deps#0@@16|) |e#1@@7|))) (and (_module.StateC.S_q (Lit DatatypeTypeType |stC#0@@31|)) (|_module.__default.DomC#canCall| (Lit BoxType (_module.StateC.c (Lit DatatypeTypeType |stC#0@@31|)))))) (=> (|Set#IsMember| (_module.__default.DomC (Lit BoxType (_module.StateC.c (Lit DatatypeTypeType |stC#0@@31|)))) (_module.__default.Hash (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@17|) (Lit DatatypeTypeType |deps#0@@16|) |e#1@@7|))) (|_module.__default.Loc#canCall| (Lit DatatypeTypeType |cmd#0@@17|) (Lit DatatypeTypeType |deps#0@@16|) |e#1@@7|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.291:10|
 :skolemid |1042|
...
)))) (= (_module.__default.PreC (Lit DatatypeTypeType |cmd#0@@17|) (Lit DatatypeTypeType |deps#0@@16|) (Lit DatatypeTypeType |exts#0@@12|) (Lit DatatypeTypeType |stC#0@@31|))  (and (_module.__default.Pre (Lit DatatypeTypeType |cmd#0@@17|) (Lit DatatypeTypeType |deps#0@@16|) (Lit DatatypeTypeType |exts#0@@12|) (_module.__default.Restrict (Lit SetType (_module.Literal.paths (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |deps#0@@16|))))) (Lit BoxType (_module.StateC.st (Lit DatatypeTypeType |stC#0@@31|))))) (forall ((|e#1@@8| T@U) ) (!  (=> ($Is SeqType |e#1@@8| (TSeq TChar)) (=> (|Set#IsMember| (Lit SetType (_module.Literal.strs (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@12|))))) ($Box SeqType |e#1@@8|)) (=> (|Set#IsMember| (_module.__default.DomC (Lit BoxType (_module.StateC.c (Lit DatatypeTypeType |stC#0@@31|)))) (_module.__default.Hash (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@17|) (Lit DatatypeTypeType |deps#0@@16|) |e#1@@8|))) (|Set#IsMember| (Lit SetType (_module.Literal.paths (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |deps#0@@16|))))) ($Box DatatypeTypeType (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@17|) (Lit DatatypeTypeType |deps#0@@16|) |e#1@@8|))))))
 :qid |CloudMakeConsistentBuildslegacydfy.291:10|
 :skolemid |1041|
 ...
 :weight 3
 :skolemid |1043|
 :pattern ( (_module.__default.PreC (Lit DatatypeTypeType |cmd#0@@17|) (Lit DatatypeTypeType |deps#0@@16|) (Lit DatatypeTypeType |exts#0@@12|) (Lit DatatypeTypeType |stC#0@@31|)))
))))
...
(assert (forall ((d@@83 T@U) ($h@@28 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (_module.Literal.litArrOfStrings_q d@@83) ($IsAlloc DatatypeTypeType d@@83 Tclass._module.Literal $h@@28))) ($IsAlloc SetType (_module.Literal.strs d@@83) (TSet (TSeq TChar)) $h@@28))
 :qid |unknown.0:0|
 :skolemid |1465|
 :pattern ( ($IsAlloc SetType (_module.Literal.strs d@@83) (TSet (TSeq TChar)) $h@@28))
)))
...
(assert (forall ((d@@84 T@U) ($h@@29 T@U) ) (!  (=> (and ($IsGoodHeap $h@@29) (and (_module.Expression.exprInvocation_q d@@84) ($IsAlloc DatatypeTypeType d@@84 Tclass._module.Expression $h@@29))) ($IsAlloc SeqType (_module.Expression.args d@@84) (TSeq Tclass._module.Expression) $h@@29))
 :qid |unknown.0:0|
 :skolemid |1388|
 :pattern ( ($IsAlloc SeqType (_module.Expression.args d@@84) (TSeq Tclass._module.Expression) $h@@29))
)))
(assert (forall ((d@@85 T@U) ($h@@30 T@U) ) (!  (=> (and ($IsGoodHeap $h@@30) (and (_module.Literal.litArrOfPaths_q d@@85) ($IsAlloc DatatypeTypeType d@@85 Tclass._module.Literal $h@@30))) ($IsAlloc SetType (_module.Literal.paths d@@85) (TSet Tclass._module.Path) $h@@30))
 :qid |unknown.0:0|
 :skolemid |1456|
 :pattern ( ($IsAlloc SetType (_module.Literal.paths d@@85) (TSet Tclass._module.Path) $h@@30))
)))
(assert (forall ((d@@86 T@U) ($h@@31 T@U) ) (!  (=> (and ($IsGoodHeap $h@@31) (and (_module.Literal.litArray_q d@@86) ($IsAlloc DatatypeTypeType d@@86 Tclass._module.Literal $h@@31))) ($IsAlloc SeqType (_module.Literal.arr d@@86) (TSeq Tclass._module.Expression) $h@@31))
 :qid |unknown.0:0|
 :skolemid |1474|
 :pattern ( ($IsAlloc SeqType (_module.Literal.arr d@@86) (TSeq Tclass._module.Expression) $h@@31))
)))
...
(declare-fun |stsC''#Z#0@0| () T@U)
(declare-fun |stC''#0@0| () T@U)
(declare-fun $Heap@0 () T@U)
(declare-fun |args#0@@11| () T@U)
(declare-fun |expr#0@@16| () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $Heap@@3 () T@U)
(declare-fun |stC#0@@32| () T@U)
(declare-fun |env#0@@15| () T@U)
(declare-fun |args'#0@@6| () T@U)
(declare-fun |stsC'#0@@6| () T@U)
(declare-fun |let#0#0#0| () T@U)
(declare-fun |result#Z#0@0| () T@U)
(declare-fun |let#1#0#0| () T@U)
(declare-fun |arg#0@0| () T@U)
(declare-fun |stC'#0@0| () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun null () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.EvalArgsC_kLemma)
...
(let ((anon14_Else_correct  (=> (and (not (|Set#IsMember| |stsC''#Z#0@0| ($Box DatatypeTypeType |stC''#0@0|))) (= (ControlFlow 0 4) 1)) anon10_correct)))
(let ((anon14_Then_correct  (=> (and (and (|Set#IsMember| |stsC''#Z#0@0| ($Box DatatypeTypeType |stC''#0@0|)) ($IsAlloc DatatypeTypeType |stC''#0@0| Tclass._module.StateC $Heap@0)) (and (|_module.__default.ConsistentCache#canCall| |stC''#0@0|) (= (ControlFlow 0 3) 1))) anon10_correct)))
(let ((anon13_Then_correct  (=> (and ($Is DatatypeTypeType |stC''#0@0| Tclass._module.StateC) ($IsAlloc DatatypeTypeType |stC''#0@0| Tclass._module.StateC $Heap@0)) (and (=> (= (ControlFlow 0 5) 3) anon14_Then_correct) (=> (= (ControlFlow 0 5) 4) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |stC''#0@0| Tclass._module.StateC) ($IsAlloc DatatypeTypeType |stC''#0@0| Tclass._module.StateC $Heap@0))) (= (ControlFlow 0 2) 1)) anon10_correct)))
(let ((anon7_correct  (=> (forall ((|arg#1@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#1@@1| Tclass._module.Expression) (=> (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#1@@1|)) (< (DtRank |arg#1@@1|) (DtRank |expr#0@@16|))))
 :qid |CloudMakeConsistentBuildslegacydfy.648:19|
 :skolemid |1243|
 :pattern ( (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#1@@1|)))
)) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@3 $Heap@0)) (and ($IsAlloc DatatypeTypeType |expr#0@@16| Tclass._module.Expression $Heap@0) ($IsAlloc SeqType |args#0@@11| (TSeq Tclass._module.Expression) $Heap@0))) (and (and ($IsAlloc DatatypeTypeType |stC#0@@32| Tclass._module.StateC $Heap@0) ($IsAllocBox |env#0@@15| Tclass._module.Env $Heap@0)) (and ($IsAlloc SeqType |args'#0@@6| (TSeq Tclass._module.Expression) $Heap@0) ($IsAlloc SetType |stsC'#0@@6| (TSet Tclass._module.StateC) $Heap@0)))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((|arg#2@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#2@@2| Tclass._module.Expression) (=> (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#2@@2|)) (< (DtRank |arg#2@@2|) (DtRank |expr#0@@16|))))
 :qid |CloudMakeConsistentBuildslegacydfy.485:19|
 :skolemid |1244|
 :pattern ( (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#2@@2|)))
))) (=> (and (and (forall ((|arg#2@@3| T@U) ) (!  (=> ($Is DatatypeTypeType |arg#2@@3| Tclass._module.Expression) (=> (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#2@@3|)) (< (DtRank |arg#2@@3|) (DtRank |expr#0@@16|))))
 :qid |CloudMakeConsistentBuildslegacydfy.485:19|
 :skolemid |1245|
 :pattern ( (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#2@@3|)))
)) (|_module.__default.evalArgsC_k#canCall| |expr#0@@16| |args#0@@11| |stC#0@@32| |env#0@@15| |args'#0@@6| |stsC'#0@@6|)) (and (_module.Tuple.Pair_q (_module.__default.evalArgsC_k ($LS $LZ) |expr#0@@16| |args#0@@11| |stC#0@@32| |env#0@@15| |args'#0@@6| |stsC'#0@@6|)) (= |let#0#0#0| (_module.__default.evalArgsC_k ($LS $LZ) |expr#0@@16| |args#0@@11| |stC#0@@32| |env#0@@15| |args'#0@@6| |stsC'#0@@6|)))) (=> (and (and (and (|_module.__default.evalArgsC_k#canCall| |expr#0@@16| |args#0@@11| |stC#0@@32| |env#0@@15| |args'#0@@6| |stsC'#0@@6|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.Tuple (TSeq Tclass._module.Expression) (TSet Tclass._module.StateC)))) (and (= |result#Z#0@0| |let#0#0#0|) (_module.Tuple.Pair_q |result#Z#0@0|))) (and (and (= |let#1#0#0| ($Unbox SetType (_module.Tuple.snd |result#Z#0@0|))) (_module.Tuple.Pair_q |result#Z#0@0|)) (and ($Is SetType |let#1#0#0| (TSet Tclass._module.StateC)) (= |stsC''#Z#0@0| |let#1#0#0|)))) (and (=> (= (ControlFlow 0 6) 5) anon13_Then_correct) (=> (= (ControlFlow 0 6) 2) anon13_Else_correct)))))))))
(let ((anon12_Else_correct  (=> (and (=> (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#0@0|)) (< (DtRank |arg#0@0|) (DtRank |expr#0@@16|))) (= (ControlFlow 0 9) 6)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Seq#Contains| |args#0@@11| ($Box DatatypeTypeType |arg#0@0|)) (=> (and (< (DtRank |arg#0@0|) (DtRank |expr#0@@16|)) (= (ControlFlow 0 8) 6)) anon7_correct))))
(let ((anon4_correct  (=> (forall ((|stC'#1@@6| T@U) ) (!  (=> ($Is DatatypeTypeType |stC'#1@@6| Tclass._module.StateC) (=> (|Set#IsMember| |stsC'#0@@6| ($Box DatatypeTypeType |stC'#1@@6|)) (_module.__default.ConsistentCache |stC'#1@@6|)))
 :qid |CloudMakeConsistentBuildslegacydfy.647:19|
 :skolemid |1242|
 :pattern ( (_module.__default.ConsistentCache |stC'#1@@6|))
 :pattern ( (|Set#IsMember| |stsC'#0@@6| ($Box DatatypeTypeType |stC'#1@@6|)))
)) (=> (and ($Is DatatypeTypeType |arg#0@0| Tclass._module.Expression) ($IsAlloc DatatypeTypeType |arg#0@0| Tclass._module.Expression $Heap@@3)) (and (=> (= (ControlFlow 0 10) 8) anon12_Then_correct) (=> (= (ControlFlow 0 10) 9) anon12_Else_correct))))))
(let ((anon11_Else_correct  (=> (and (=> (|Set#IsMember| |stsC'#0@@6| ($Box DatatypeTypeType |stC'#0@0|)) (_module.__default.ConsistentCache |stC'#0@0|)) (= (ControlFlow 0 12) 10)) anon4_correct)))
(let ((anon11_Then_correct  (=> (|Set#IsMember| |stsC'#0@@6| ($Box DatatypeTypeType |stC'#0@0|)) (=> (and (and ($IsAlloc DatatypeTypeType |stC'#0@0| Tclass._module.StateC $Heap@@3) (|_module.__default.ConsistentCache#canCall| |stC'#0@0|)) (and (_module.__default.ConsistentCache |stC'#0@0|) (= (ControlFlow 0 11) 10))) anon4_correct))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@3 alloc false)) ($IsAlloc DatatypeTypeType |stC#0@@32| Tclass._module.StateC $Heap@@3)) (=> (and (and (|_module.__default.ConsistentCache#canCall| |stC#0@@32|) (_module.__default.ConsistentCache |stC#0@@32|)) (and ($Is DatatypeTypeType |stC'#0@0| Tclass._module.StateC) ($IsAlloc DatatypeTypeType |stC'#0@0| Tclass._module.StateC $Heap@@3))) (and (=> (= (ControlFlow 0 13) 11) anon11_Then_correct) (=> (= (ControlFlow 0 13) 12) anon11_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and (and (and (and ($Is DatatypeTypeType |expr#0@@16| Tclass._module.Expression) ($IsAlloc DatatypeTypeType |expr#0@@16| Tclass._module.Expression $Heap@@3)) (|$IsA#_module.Expression| |expr#0@@16|)) (and ($Is SeqType |args#0@@11| (TSeq Tclass._module.Expression)) ($IsAlloc SeqType |args#0@@11| (TSeq Tclass._module.Expression) $Heap@@3))) (and (and ($Is DatatypeTypeType |stC#0@@32| Tclass._module.StateC) ($IsAlloc DatatypeTypeType |stC#0@@32| Tclass._module.StateC $Heap@@3)) (|$IsA#_module.StateC| |stC#0@@32|))) (and (and (and ($IsBox |env#0@@15| Tclass._module.Env) ($IsAllocBox |env#0@@15| Tclass._module.Env $Heap@@3)) (and ($Is SeqType |args'#0@@6| (TSeq Tclass._module.Expression)) ($IsAlloc SeqType |args'#0@@6| (TSeq Tclass._module.Expression) $Heap@@3))) (and (and ($Is SetType |stsC'#0@@6| (TSet Tclass._module.StateC)) ($IsAlloc SetType |stsC'#0@@6| (TSet Tclass._module.StateC) $Heap@@3)) (and (= 7 $FunctionContextHeight) (= (ControlFlow 0 14) 13))))) anon0_correct))))
