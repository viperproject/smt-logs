...
(set-info :boogie-vc-id Impl$$M1.__default.BuildLemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@13 alloc false)) ($IsAlloc DatatypeTypeType |prog#0@@4| Tclass.M1.Program $Heap@@13)) (and ($IsAlloc DatatypeTypeType |st#0@@43| Tclass.M1.State $Heap@@13) (M1.__default.Legal (M1.Program.stmts |prog#0@@4|)))) (and (and (|M1.__default.build#canCall| |prog#0@@4| |st#0@@43|) (M1.Tuple.Pair_q (M1.__default.build |prog#0@@4| |st#0@@43|))) (and (|M1.__default.build#canCall| |prog#0@@4| |st#0@@43|) (= |result#0@0| (M1.__default.build |prog#0@@4| |st#0@@43|))))) (=> (and (and (and (and (M1.Tuple.Pair_q |result#0@0|) (M1.Tuple.Pair_q |result#0@0|)) (and (= |$rhs#0@0| ($Unbox DatatypeTypeType (M1.Tuple.fst |result#0@0|))) (M1.Tuple.Pair_q |result#0@0|))) (and (and (M1.Tuple.Pair_q |result#0@0|) (= |$rhs#1@0| ($Unbox DatatypeTypeType (M1.Tuple.snd |result#0@0|)))) (and (M1.Program.Program_q |prog#0@@4|) (M1.Program.Program_q |prog#0@@4|)))) (and (and (and (= |stmts##0@0| (M1.Program.stmts |prog#0@@4|)) |M1.__default.EmptyEnv#canCall|) (and |M1.__default.EmptyEnv#canCall| (= |env##0@0| M1.__default.EmptyEnv))) (and (and ($Is DatatypeTypeType |call4formal@expr'#0| Tclass.M1.Expression) ($IsAlloc DatatypeTypeType |call4formal@expr'#0| Tclass.M1.Expression $Heap@@13)) (and ($Is DatatypeTypeType |call5formal@st'#0| Tclass.M1.State) ($IsAlloc DatatypeTypeType |call5formal@st'#0| Tclass.M1.State $Heap@@13))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|M1.__default.Legal#canCall| |stmts##0@0|) (or (M1.__default.Legal |stmts##0@0|) (or (not (= (|Seq#Length| |stmts##0@0|) 0)) (not true))))) (=> (=> (|M1.__default.Legal#canCall| |stmts##0@0|) (or (M1.__default.Legal |stmts##0@0|) (or (not (= (|Seq#Length| |stmts##0@0|) 0)) (not true)))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|M1.__default.ValidState#canCall| |st#0@@43|) (or (M1.__default.ValidState |st#0@@43|) (forall ((|p#0@@15| T@U) ) (!  (=> ($IsBox |p#0@@15| Tclass.M1.Path) (=> (|Set#IsMember| (M1.__default.DomSt |st#0@@43|) |p#0@@15|) (M1.__default.WellFounded |p#0@@15|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |2450|
...
)))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (M1.__default.ValidEnv |env##0@0|)) (=> (M1.__default.ValidEnv |env##0@0|) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and ($Is DatatypeTypeType |call4formal@expr'#0@0| Tclass.M1.Expression) ($IsAlloc DatatypeTypeType |call4formal@expr'#0@0| Tclass.M1.Expression $Heap@0)) (and ($Is DatatypeTypeType |call5formal@st'#0@0| Tclass.M1.State) ($IsAlloc DatatypeTypeType |call5formal@st'#0@0| Tclass.M1.State $Heap@0))) (=> (and (and (and (and (and (|$IsA#M1.Tuple| (M1.__default.do ($LS $LZ) |stmts##0@0| |st#0@@43| |env##0@0|)) (|M1.__default.do#canCall| |stmts##0@0| |st#0@@43| |env##0@0|)) (=> (|M1.Tuple#Equal| (|#M1.Tuple.Pair| ($Box DatatypeTypeType |call4formal@expr'#0@0|) ($Box DatatypeTypeType |call5formal@st'#0@0|)) (M1.__default.do ($LS $LZ) |stmts##0@0| |st#0@@43| |env##0@0|)) (and (|M1.__default.ValidState#canCall| |call5formal@st'#0@0|) (=> (M1.__default.ValidState |call5formal@st'#0@0|) (and (|M1.__default.Extends#canCall| |st#0@@43| |call5formal@st'#0@0|) (=> (M1.__default.Extends |st#0@@43| |call5formal@st'#0@0|) (=> (M1.Expression.exprError_q |call4formal@expr'#0@0|) (|$IsA#M1.Reason| (M1.Expression.r |call4formal@expr'#0@0|))))))))) (|M1.Tuple#Equal| (|#M1.Tuple.Pair| ($Box DatatypeTypeType |call4formal@expr'#0@0|) ($Box DatatypeTypeType |call5formal@st'#0@0|)) (M1.__default.do ($LS ($LS $LZ)) |stmts##0@0| |st#0@@43| |env##0@0|))) (and (|M1.__default.ValidState#canCall| |call5formal@st'#0@0|) (and (M1.__default.ValidState |call5formal@st'#0@0|) (forall ((|p#1@@5| T@U) ) (!  (=> ($IsBox |p#1@@5| Tclass.M1.Path) (=> (|Set#IsMember| (M1.__default.DomSt |call5formal@st'#0@0|) |p#1@@5|) (M1.__default.WellFounded |p#1@@5|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |2453|
 :pattern ( (M1.__default.WellFounded |p#1@@5|))
 :pattern ( (|Set#IsMember| (M1.__default.DomSt |call5formal@st'#0@0|) |p#1@@5|))
))))) (and (and (|M1.__default.Extends#canCall| |st#0@@43| |call5formal@st'#0@0|) (and (M1.__default.Extends |st#0@@43| |call5formal@st'#0@0|) (and (and (|Set#Subset| (M1.__default.DomSt |st#0@@43|) (M1.__default.DomSt |call5formal@st'#0@0|)) (forall ((|p#2@@2| T@U) ) (!  (=> ($IsBox |p#2@@2| Tclass.M1.Path) (=> (|Set#IsMember| (M1.__default.DomSt |st#0@@43|) |p#2@@2|) (= (M1.__default.GetSt |p#2@@2| |call5formal@st'#0@0|) (M1.__default.GetSt |p#2@@2| |st#0@@43|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |2456|
...
))) (forall ((|p#3@@1| T@U) ) (!  (=> ($IsBox |p#3@@1| Tclass.M1.Path) (=> (and (not (|Set#IsMember| (M1.__default.DomSt |st#0@@43|) |p#3@@1|)) (|Set#IsMember| (M1.__default.DomSt |call5formal@st'#0@0|) |p#3@@1|)) (= (M1.__default.GetSt |p#3@@1| |call5formal@st'#0@0|) (M1.__default.Oracle |p#3@@1| |st#0@@43|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |2457|
 :pattern ( (M1.__default.Oracle |p#3@@1| |st#0@@43|))
 :pattern ( (M1.__default.GetSt |p#3@@1| |call5formal@st'#0@0|))
 :pattern ( (|Set#IsMember| (M1.__default.DomSt |call5formal@st'#0@0|) |p#3@@1|))
 :pattern ( (|Set#IsMember| (M1.__default.DomSt |st#0@@43|) |p#3@@1|))
))))) (and (=> (M1.Expression.exprError_q |call4formal@expr'#0@0|) (|M1.Reason#Equal| (M1.Expression.r |call4formal@expr'#0@0|) |#M1.Reason.rValidity|)) (= $Heap@@13 $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> false (|M1.Tuple#Equal| (M1.__default.build |prog#0@@4| |st#0@@43|) (|#M1.Tuple.Pair| ($Box DatatypeTypeType |$rhs#0@0|) ($Box DatatypeTypeType |$rhs#1@0|))))) (=> (=> false (|M1.Tuple#Equal| (M1.__default.build |prog#0@@4| |st#0@@43|) (|#M1.Tuple.Pair| ($Box DatatypeTypeType |$rhs#0@0|) ($Box DatatypeTypeType |$rhs#1@0|)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> false (=> (|M1.__default.ValidState#canCall| |$rhs#1@0|) (or (M1.__default.ValidState |$rhs#1@0|) (forall ((|p#5| T@U) ) (!  (=> ($IsBox |p#5| Tclass.M1.Path) (=> (|Set#IsMember| (M1.__default.DomSt |$rhs#1@0|) |p#5|) (M1.__default.WellFounded |p#5|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |2443|
...
))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> false (=> (|M1.__default.Extends#canCall| |st#0@@43| |$rhs#1@0|) (or (M1.__default.Extends |st#0@@43| |$rhs#1@0|) (|Set#Subset| (M1.__default.DomSt |st#0@@43|) (M1.__default.DomSt |$rhs#1@0|)))))) (=> (=> false (=> (|M1.__default.Extends#canCall| |st#0@@43| |$rhs#1@0|) (or (M1.__default.Extends |st#0@@43| |$rhs#1@0|) (|Set#Subset| (M1.__default.DomSt |st#0@@43|) (M1.__default.DomSt |$rhs#1@0|))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> false (=> (|M1.__default.Extends#canCall| |st#0@@43| |$rhs#1@0|) (or (M1.__default.Extends |st#0@@43| |$rhs#1@0|) (forall ((|p#6| T@U) ) (!  (=> ($IsBox |p#6| Tclass.M1.Path) (=> (|Set#IsMember| (M1.__default.DomSt |st#0@@43|) |p#6|) (= (M1.__default.GetSt |p#6| |$rhs#1@0|) (M1.__default.GetSt |p#6| |st#0@@43|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |2445|
 :pattern ( (M1.__default.GetSt |p#6| |st#0@@43|))
 :pattern ( (M1.__default.GetSt |p#6| |$rhs#1@0|))
 :pattern ( (|Set#IsMember| (M1.__default.DomSt |st#0@@43|) |p#6|))
)))))) (=> (=> false (=> (|M1.__default.Extends#canCall| |st#0@@43| |$rhs#1@0|) (or (M1.__default.Extends |st#0@@43| |$rhs#1@0|) (forall ((|p#6@@0| T@U) ) (!  (=> ($IsBox |p#6@@0| Tclass.M1.Path) (=> (|Set#IsMember| (M1.__default.DomSt |st#0@@43|) |p#6@@0|) (= (M1.__default.GetSt |p#6@@0| |$rhs#1@0|) (M1.__default.GetSt |p#6@@0| |st#0@@43|))))
 :qid |CloudMakeParallelBuildsdfy.115:13|
 :skolemid |2445|
 :pattern ( (M1.__default.GetSt |p#6@@0| |st#0@@43|))
 :pattern ( (M1.__default.GetSt |p#6@@0| |$rhs#1@0|))
 :pattern ( (|Set#IsMember| (M1.__default.DomSt |st#0@@43|) |p#6@@0|))
))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> false (=> (|M1.__default.Extends#canCall| |st#0@@43| |$rhs#1@0|) (or (M1.__default.Extends |st#0@@43| |$rhs#1@0|) (forall ((|p#7| T@U) ) (!  (=> ($IsBox |p#7| Tclass.M1.Path) (=> (and (not (|Set#IsMember| (M1.__default.DomSt |st#0@@43|) |p#7|)) (|Set#IsMember| (M1.__default.DomSt |$rhs#1@0|) |p#7|)) (= (M1.__default.GetSt |p#7| |$rhs#1@0|) (M1.__default.Oracle |p#7| |st#0@@43|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |2446|
 :pattern ( (M1.__default.Oracle |p#7| |st#0@@43|))
 :pattern ( (M1.__default.GetSt |p#7| |$rhs#1@0|))
 :pattern ( (|Set#IsMember| (M1.__default.DomSt |$rhs#1@0|) |p#7|))
 :pattern ( (|Set#IsMember| (M1.__default.DomSt |st#0@@43|) |p#7|))
)))))) (=> (=> false (=> (|M1.__default.Extends#canCall| |st#0@@43| |$rhs#1@0|) (or (M1.__default.Extends |st#0@@43| |$rhs#1@0|) (forall ((|p#7@@0| T@U) ) (!  (=> ($IsBox |p#7@@0| Tclass.M1.Path) (=> (and (not (|Set#IsMember| (M1.__default.DomSt |st#0@@43|) |p#7@@0|)) (|Set#IsMember| (M1.__default.DomSt |$rhs#1@0|) |p#7@@0|)) (= (M1.__default.GetSt |p#7@@0| |$rhs#1@0|) (M1.__default.Oracle |p#7@@0| |st#0@@43|))))
 :qid |CloudMakeParallelBuildsdfy.116:13|
 :skolemid |2446|
 :pattern ( (M1.__default.Oracle |p#7@@0| |st#0@@43|))
 :pattern ( (M1.__default.GetSt |p#7@@0| |$rhs#1@0|))
 :pattern ( (|Set#IsMember| (M1.__default.DomSt |$rhs#1@0|) |p#7@@0|))
 :pattern ( (|Set#IsMember| (M1.__default.DomSt |st#0@@43|) |p#7@@0|))
))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (=> (M1.Expression.exprError_q |$rhs#0@0|) (|M1.Reason#Equal| (M1.Expression.r |$rhs#0@0|) |#M1.Reason.rValidity|)))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@13) ($IsHeapAnchor $Heap@@13)) (=> (and (and ($Is DatatypeTypeType |prog#0@@4| Tclass.M1.Program) ($IsAlloc DatatypeTypeType |prog#0@@4| Tclass.M1.Program $Heap@@13)) (|$IsA#M1.Program| |prog#0@@4|)) (=> (and (and (and (and ($Is DatatypeTypeType |st#0@@43| Tclass.M1.State) ($IsAlloc DatatypeTypeType |st#0@@43| Tclass.M1.State $Heap@@13)) (|$IsA#M1.State| |st#0@@43|)) (and (and ($Is DatatypeTypeType |expr'#0@@1| Tclass.M1.Expression) ($IsAlloc DatatypeTypeType |expr'#0@@1| Tclass.M1.Expression $Heap@@13)) (and ($Is DatatypeTypeType |st'#0@@9| Tclass.M1.State) ($IsAlloc DatatypeTypeType |st'#0@@9| Tclass.M1.State $Heap@@13)))) (and (and (and ($Is DatatypeTypeType |result#0@@0| (Tclass.M1.Tuple Tclass.M1.Expression Tclass.M1.State)) ($IsAlloc DatatypeTypeType |result#0@@0| (Tclass.M1.Tuple Tclass.M1.Expression Tclass.M1.State) $Heap@@13)) true) (and (and ($Is DatatypeTypeType |_v2#0| Tclass.M1.Expression) ($IsAlloc DatatypeTypeType |_v2#0| Tclass.M1.Expression $Heap@@13)) true))) (=> (and (and (and (and (and ($Is DatatypeTypeType |_v3#0| Tclass.M1.State) ($IsAlloc DatatypeTypeType |_v3#0| Tclass.M1.State $Heap@@13)) true) (= 8 $FunctionContextHeight)) (and (|M1.__default.Legal#canCall| (M1.Program.stmts |prog#0@@4|)) (and (M1.__default.Legal (M1.Program.stmts |prog#0@@4|)) (or (not (= (|Seq#Length| (M1.Program.stmts |prog#0@@4|)) 0)) (not true))))) (and (and (|M1.__default.ValidState#canCall| |st#0@@43|) (and (M1.__default.ValidState |st#0@@43|) (forall ((|p#4| T@U) ) (!  (=> ($IsBox |p#4| Tclass.M1.Path) (=> (|Set#IsMember| (M1.__default.DomSt |st#0@@43|) |p#4|) (M1.__default.WellFounded |p#4|)))
 :qid |CloudMakeParallelBuildsdfy.15:12|
 :skolemid |2442|
 :pattern ( (M1.__default.WellFounded |p#4|))
 :pattern ( (|Set#IsMember| (M1.__default.DomSt |st#0@@43|) |p#4|))
