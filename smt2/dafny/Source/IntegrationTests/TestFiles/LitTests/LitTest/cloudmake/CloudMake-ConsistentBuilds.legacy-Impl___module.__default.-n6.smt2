...
(declare-fun |strs#0@0| () T@U)
(declare-fun |cmd'#1_0_0@0| () T@U)
(declare-fun |deps'#1_0_0@0| () T@U)
(declare-fun |e'#1_0_0@0| () T@U)
(declare-fun |##p#1_0_0@0| () T@U)
(declare-fun |##p#1_0_1@0| () T@U)
(declare-fun |##p#1_0@0| () T@U)
(declare-fun |##h#1_0@0| () T@U)
(declare-fun |##cmd#1_1@0| () T@U)
(declare-fun |##c#1_0@0| () T@U)
(declare-fun |c'#1_0@0| () T@U)
(declare-fun |exts'#1_0@0| () T@U)
(declare-fun |##stC#1_0@0| () T@U)
(declare-fun |stC'#2@0| () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $Heap@@1 () T@U)
(declare-fun |strs#0@@1| () T@U)
(declare-fun |defass#stC'#2| () Bool)
(declare-fun |stC'#2| () T@U)
(declare-fun |e#1_0| () T@U)
(declare-fun |defass#c'#1_0| () Bool)
(declare-fun |c'#1_0| () T@U)
(declare-fun |exts'#1_0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.UpdateCLemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (let ((|stC'#0@@0| (_module.__default.UpdateC ($LS ($LS $LZ)) |cmd#0@@8| |deps#0@@7| |exts#0@@4| |stC#0@@6|)))
 (=> (|_module.__default.ConsistentCache#canCall| |stC'#0@@0|) (or (_module.__default.ConsistentCache |stC'#0@@0|) (forall ((|cmd#4| T@U) (|deps#4| T@U) (|e#7| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#4| Tclass._module.Expression) ($Is DatatypeTypeType |deps#4| Tclass._module.Expression)) ($Is SeqType |e#7| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC'#0@@0|)) (_module.__default.Hash (_module.__default.Loc |cmd#4| |deps#4| |e#7|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC'#0@@0|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#4| |deps#4| |e#7|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |765|
 :pattern ( (_module.__default.Loc |cmd#4| |deps#4| |e#7|))
)))))) (=> (let ((|stC'#0@@1| (_module.__default.UpdateC ($LS ($LS $LZ)) |cmd#0@@8| |deps#0@@7| |exts#0@@4| |stC#0@@6|)))
 (=> (|_module.__default.ConsistentCache#canCall| |stC'#0@@1|) (or (_module.__default.ConsistentCache |stC'#0@@1|) (forall ((|cmd#4@@0| T@U) (|deps#4@@0| T@U) (|e#7@@0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#4@@0| Tclass._module.Expression) ($Is DatatypeTypeType |deps#4@@0| Tclass._module.Expression)) ($Is SeqType |e#7@@0| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC'#0@@1|)) (_module.__default.Hash (_module.__default.Loc |cmd#4@@0| |deps#4@@0| |e#7@@0|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC'#0@@1|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#4@@0| |deps#4@@0| |e#7@@0|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |765|
 :pattern ( (_module.__default.Loc |cmd#4@@0| |deps#4@@0| |e#7@@0|))
))))) (=> (= (ControlFlow 0 4) (- 0 3)) (let ((|stC'#0@@2| (_module.__default.UpdateC ($LS ($LS $LZ)) |cmd#0@@8| |deps#0@@7| |exts#0@@4| |stC#0@@6|)))
(forall ((|e#3@@1| T@U) ) (!  (=> ($Is SeqType |e#3@@1| (TSeq TChar)) (=> (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0@@4|)) ($Box SeqType |e#3@@1|)) (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC'#0@@2|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@8| |deps#0@@7| |e#3@@1|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.73:12|
 :skolemid |767|
 :pattern ( (_module.__default.Loc |cmd#0@@8| |deps#0@@7| |e#3@@1|))
 :pattern ( (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0@@4|)) ($Box SeqType |e#3@@1|)))
))))))))
(let ((anon6_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (= $Heap@0 $Heap@2)) (and (forall ((|cmd'#1_0_1| T@U) (|deps'#1_0_1| T@U) (|e'#1_0_1| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |cmd'#1_0_1| Tclass._module.Expression) ($Is DatatypeTypeType |deps'#1_0_1| Tclass._module.Expression)) ($Is SeqType |e'#1_0_1| (TSeq TChar))) (= (_module.__default.Hash (_module.__default.Loc |cmd'#1_0_1| |deps'#1_0_1| |e'#1_0_1|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@8| |deps#0@@7| |e#1_0@0|)))) (and (and (|_module.Expression#Equal| |cmd'#1_0_1| |cmd#0@@8|) (|_module.Expression#Equal| |deps'#1_0_1| |deps#0@@7|)) (|Seq#Equal| |e'#1_0_1| |e#1_0@0|)))
 :qid |CloudMakeConsistentBuildslegacydfy.85:12|
 :skolemid |772|
 :pattern ( (_module.__default.Loc |cmd'#1_0_1| |deps'#1_0_1| |e'#1_0_1|))
)) (= (ControlFlow 0 7) 4))) GeneratedUnifiedExit_correct)))
(let ((anon5_Then_correct  (=> (and (|Set#Equal| |strs#0@0| |Set#Empty|) (= (ControlFlow 0 6) 4)) GeneratedUnifiedExit_correct)))
(let ((anon6_Then_correct  (=> (and (and (and (and (and ($Is DatatypeTypeType |cmd'#1_0_0@0| Tclass._module.Expression) ($Is DatatypeTypeType |deps'#1_0_0@0| Tclass._module.Expression)) ($Is SeqType |e'#1_0_0@0| (TSeq TChar))) (and ($IsAlloc DatatypeTypeType |cmd'#1_0_0@0| Tclass._module.Expression $Heap@0) ($IsAlloc DatatypeTypeType |deps'#1_0_0@0| Tclass._module.Expression $Heap@0))) (and (and ($IsAlloc SeqType |e'#1_0_0@0| (TSeq TChar) $Heap@0) (|_module.__default.Loc#canCall| |cmd'#1_0_0@0| |deps'#1_0_0@0| |e'#1_0_0@0|)) (and (= |##p#1_0_0@0| (_module.__default.Loc |cmd'#1_0_0@0| |deps'#1_0_0@0| |e'#1_0_0@0|)) ($IsAlloc DatatypeTypeType |##p#1_0_0@0| Tclass._module.Path $Heap@0)))) (and (and (and (and (|_module.__default.Hash#canCall| (_module.__default.Loc |cmd'#1_0_0@0| |deps'#1_0_0@0| |e'#1_0_0@0|)) ($IsAlloc DatatypeTypeType |cmd#0@@8| Tclass._module.Expression $Heap@0)) (and ($IsAlloc DatatypeTypeType |deps#0@@7| Tclass._module.Expression $Heap@0) ($IsAlloc SeqType |e#1_0@0| (TSeq TChar) $Heap@0))) (and (and (|_module.__default.Loc#canCall| |cmd#0@@8| |deps#0@@7| |e#1_0@0|) (= |##p#1_0_1@0| (_module.__default.Loc |cmd#0@@8| |deps#0@@7| |e#1_0@0|))) (and ($IsAlloc DatatypeTypeType |##p#1_0_1@0| Tclass._module.Path $Heap@0) (|_module.__default.Hash#canCall| (_module.__default.Loc |cmd#0@@8| |deps#0@@7| |e#1_0@0|))))) (and (and (and (|_module.__default.Loc#canCall| |cmd'#1_0_0@0| |deps'#1_0_0@0| |e'#1_0_0@0|) (|_module.__default.Hash#canCall| (_module.__default.Loc |cmd'#1_0_0@0| |deps'#1_0_0@0| |e'#1_0_0@0|))) (and (|_module.__default.Loc#canCall| |cmd#0@@8| |deps#0@@7| |e#1_0@0|) (|_module.__default.Hash#canCall| (_module.__default.Loc |cmd#0@@8| |deps#0@@7| |e#1_0@0|)))) (and (= (_module.__default.Hash (_module.__default.Loc |cmd'#1_0_0@0| |deps'#1_0_0@0| |e'#1_0_0@0|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@8| |deps#0@@7| |e#1_0@0|))) (= (ControlFlow 0 2) (- 0 1)))))) (= (_module.__default.Hash (_module.__default.Loc |cmd'#1_0_0@0| |deps'#1_0_0@0| |e'#1_0_0@0|)) (_module.__default.Hash (_module.__default.Loc |cmd#0@@8| |deps#0@@7| |e#1_0@0|))))))
(let ((anon5_Else_correct  (=> (and (not (|Set#Equal| |strs#0@0| |Set#Empty|)) ($IsAlloc SetType |strs#0@0| (TSet (TSeq TChar)) $Heap@0)) (and (=> (= (ControlFlow 0 8) (- 0 18)) (not (|Set#Equal| |strs#0@0| |Set#Empty|))) (=> (not (|Set#Equal| |strs#0@0| |Set#Empty|)) (=> (and (|_module.__default.Choose#canCall| |strs#0@0|) (|_module.__default.Choose#canCall| |strs#0@0|)) (=> (and (and (and (and (and (= |e#1_0@0| (_module.__default.Choose |strs#0@0|)) ($IsAlloc DatatypeTypeType |cmd#0@@8| Tclass._module.Expression $Heap@0)) (and ($IsAlloc DatatypeTypeType |deps#0@@7| Tclass._module.Expression $Heap@0) ($IsAlloc SeqType |e#1_0@0| (TSeq TChar) $Heap@0))) (and (and (|_module.__default.Loc#canCall| |cmd#0@@8| |deps#0@@7| |e#1_0@0|) (= |##p#1_0@0| (_module.__default.Loc |cmd#0@@8| |deps#0@@7| |e#1_0@0|))) (and ($IsAlloc DatatypeTypeType |##p#1_0@0| Tclass._module.Path $Heap@0) (|_module.__default.Hash#canCall| (_module.__default.Loc |cmd#0@@8| |deps#0@@7| |e#1_0@0|))))) (and (and (and (= |##h#1_0@0| (_module.__default.Hash (_module.__default.Loc |cmd#0@@8| |deps#0@@7| |e#1_0@0|))) ($IsAllocBox |##h#1_0@0| Tclass._module.HashValue $Heap@0)) (and (= |##cmd#1_1@0| (|#_module.Triple.Trio| ($Box DatatypeTypeType |cmd#0@@8|) ($Box DatatypeTypeType |deps#0@@7|) ($Box SeqType |e#1_0@0|))) ($IsAlloc DatatypeTypeType |##cmd#1_1@0| (Tclass._module.Triple Tclass._module.Expression Tclass._module.Expression (TSeq TChar)) $Heap@0))) (and (and (_module.StateC.S_q |stC#0@@6|) (= |##c#1_0@0| (_module.StateC.c |stC#0@@6|))) (and ($IsAllocBox |##c#1_0@0| Tclass._module.Cache $Heap@0) (|_module.__default.SetC#canCall| (_module.__default.Hash (_module.__default.Loc |cmd#0@@8| |deps#0@@7| |e#1_0@0|)) (|#_module.Triple.Trio| ($Box DatatypeTypeType |cmd#0@@8|) ($Box DatatypeTypeType |deps#0@@7|) ($Box SeqType |e#1_0@0|)) (_module.StateC.c |stC#0@@6|)))))) (and (and (and (and (|_module.__default.Loc#canCall| |cmd#0@@8| |deps#0@@7| |e#1_0@0|) (|_module.__default.Hash#canCall| (_module.__default.Loc |cmd#0@@8| |deps#0@@7| |e#1_0@0|))) (_module.StateC.S_q |stC#0@@6|)) (|_module.__default.SetC#canCall| (_module.__default.Hash (_module.__default.Loc |cmd#0@@8| |deps#0@@7| |e#1_0@0|)) (|#_module.Triple.Trio| ($Box DatatypeTypeType |cmd#0@@8|) ($Box DatatypeTypeType |deps#0@@7|) ($Box SeqType |e#1_0@0|)) (_module.StateC.c |stC#0@@6|))) (and (= |c'#1_0@0| (_module.__default.SetC (_module.__default.Hash (_module.__default.Loc |cmd#0@@8| |deps#0@@7| |e#1_0@0|)) (|#_module.Triple.Trio| ($Box DatatypeTypeType |cmd#0@@8|) ($Box DatatypeTypeType |deps#0@@7|) ($Box SeqType |e#1_0@0|)) (_module.StateC.c |stC#0@@6|))) (= |exts'#1_0@0| (|#_module.Expression.exprLiteral| (|#_module.Literal.litArrOfStrings| (|Set#Difference| |strs#0@0| (|Set#UnionOne| |Set#Empty| ($Box SeqType |e#1_0@0|))))))))) (and (=> (= (ControlFlow 0 8) (- 0 17)) true) (=> (and (and ($IsAlloc DatatypeTypeType |cmd#0@@8| Tclass._module.Expression $Heap@0) ($IsAlloc DatatypeTypeType |deps#0@@7| Tclass._module.Expression $Heap@0)) (and ($IsAlloc DatatypeTypeType |exts'#1_0@0| Tclass._module.Expression $Heap@0) (_module.StateC.S_q |stC#0@@6|))) (and (=> (= (ControlFlow 0 8) (- 0 16)) true) (=> (and (= |##stC#1_0@0| (|#_module.StateC.S| (_module.StateC.st |stC#0@@6|) |c'#1_0@0|)) ($IsAlloc DatatypeTypeType |##stC#1_0@0| Tclass._module.StateC $Heap@0)) (and (=> (= (ControlFlow 0 8) (- 0 15)) (_module.Expression.exprLiteral_q |cmd#0@@8|)) (and (=> (= (ControlFlow 0 8) (- 0 14)) (_module.Literal.litString_q (_module.Expression.lit |cmd#0@@8|))) (and (=> (= (ControlFlow 0 8) (- 0 13)) (_module.Expression.exprLiteral_q |deps#0@@7|)) (and (=> (= (ControlFlow 0 8) (- 0 12)) (_module.Literal.litArrOfPaths_q (_module.Expression.lit |deps#0@@7|))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (_module.Expression.exprLiteral_q |exts'#1_0@0|)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts'#1_0@0|))) (=> (and (|_module.__default.UpdateC#canCall| |cmd#0@@8| |deps#0@@7| |exts'#1_0@0| (|#_module.StateC.S| (_module.StateC.st |stC#0@@6|) |c'#1_0@0|)) (_module.StateC.S_q (_module.__default.UpdateC ($LS $LZ) |cmd#0@@8| |deps#0@@7| |exts'#1_0@0| (|#_module.StateC.S| (_module.StateC.st |stC#0@@6|) |c'#1_0@0|)))) (=> (and (and (|$IsA#_module.StateC| |stC'#2@0|) (|$IsA#_module.StateC| (_module.__default.UpdateC ($LS $LZ) |cmd#0@@8| |deps#0@@7| |exts'#1_0@0| (|#_module.StateC.S| (_module.StateC.st |stC#0@@6|) |c'#1_0@0|)))) (and (_module.StateC.S_q |stC#0@@6|) (|_module.__default.UpdateC#canCall| |cmd#0@@8| |deps#0@@7| |exts'#1_0@0| (|#_module.StateC.S| (_module.StateC.st |stC#0@@6|) |c'#1_0@0|)))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (|_module.StateC#Equal| |stC'#2@0| (_module.__default.UpdateC ($LS ($LS $LZ)) |cmd#0@@8| |deps#0@@7| |exts'#1_0@0| (|#_module.StateC.S| (_module.StateC.st |stC#0@@6|) |c'#1_0@0|)))) (=> (|_module.StateC#Equal| |stC'#2@0| (_module.__default.UpdateC ($LS $LZ) |cmd#0@@8| |deps#0@@7| |exts'#1_0@0| (|#_module.StateC.S| (_module.StateC.st |stC#0@@6|) |c'#1_0@0|))) (and (=> (= (ControlFlow 0 8) 2) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))))))))))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (and (and (|$IsA#_module.Expression| |cmd#0@@8|) (|$IsA#_module.Expression| |deps#0@@7|)) (and (|$IsA#_module.Expression| |exts#0@@4|) (|$IsA#_module.StateC| |stC#0@@6|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@1 $Heap@0) (forall ((|$ih#cmd0#0| T@U) (|$ih#deps0#0| T@U) (|$ih#exts0#0| T@U) (|$ih#stC0#0| T@U) ) (!  (=> (and (and (and (and (and ($Is DatatypeTypeType |$ih#cmd0#0| Tclass._module.Expression) ($Is DatatypeTypeType |$ih#deps0#0| Tclass._module.Expression)) ($Is DatatypeTypeType |$ih#exts0#0| Tclass._module.Expression)) ($Is DatatypeTypeType |$ih#stC0#0| Tclass._module.StateC)) (and (and (and (and (and (and (and (_module.Expression.exprLiteral_q |$ih#cmd0#0|) (_module.Literal.litString_q (_module.Expression.lit |$ih#cmd0#0|))) (_module.Expression.exprLiteral_q |$ih#deps0#0|)) (_module.Literal.litArrOfPaths_q (_module.Expression.lit |$ih#deps0#0|))) (_module.Expression.exprLiteral_q |$ih#exts0#0|)) (_module.Literal.litArrOfStrings_q (_module.Expression.lit |$ih#exts0#0|))) (_module.__default.ConsistentCache |$ih#stC0#0|)) (forall ((|e#8| T@U) ) (!  (=> ($Is SeqType |e#8| (TSeq TChar)) (=> (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |$ih#exts0#0|)) ($Box SeqType |e#8|)) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |$ih#stC0#0|)) ($Box DatatypeTypeType (_module.__default.Loc |$ih#cmd0#0| |$ih#deps0#0| |e#8|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.69:12|
 :skolemid |768|
 :pattern ( (_module.__default.Loc |$ih#cmd0#0| |$ih#deps0#0| |e#8|))
 :pattern ( (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |$ih#exts0#0|)) ($Box SeqType |e#8|)))
)))) (and (|Set#Subset| (_module.Literal.strs (_module.Expression.lit |$ih#exts0#0|)) (_module.Literal.strs (_module.Expression.lit |exts#0@@4|))) (not (|Set#Subset| (_module.Literal.strs (_module.Expression.lit |exts#0@@4|)) (_module.Literal.strs (_module.Expression.lit |$ih#exts0#0|)))))) (let ((|stC'#1| (_module.__default.UpdateC ($LS $LZ) |$ih#cmd0#0| |$ih#deps0#0| |$ih#exts0#0| |$ih#stC0#0|)))
 (and (_module.__default.ConsistentCache |stC'#1|) (forall ((|e#9| T@U) ) (!  (=> ($Is SeqType |e#9| (TSeq TChar)) (=> (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |$ih#exts0#0|)) ($Box SeqType |e#9|)) (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC'#1|)) (_module.__default.Hash (_module.__default.Loc |$ih#cmd0#0| |$ih#deps0#0| |e#9|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.73:12|
 :skolemid |769|
 :pattern ( (_module.__default.Loc |$ih#cmd0#0| |$ih#deps0#0| |e#9|))
 :pattern ( (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |$ih#exts0#0|)) ($Box SeqType |e#9|)))
)))))
 :qid |CloudMakeConsistentBuildslegacydfy.63:20|
 :skolemid |770|
 :pattern ( (_module.__default.UpdateC ($LS $LZ) |$ih#cmd0#0| |$ih#deps0#0| |$ih#exts0#0| |$ih#stC0#0|))
 :pattern ( (_module.StateC.st |$ih#stC0#0|) (_module.Expression.lit |$ih#exts0#0|) (_module.Expression.lit |$ih#deps0#0|) (_module.Expression.lit |$ih#cmd0#0|))
 :pattern ( (_module.StateC.st |$ih#stC0#0|) (_module.Expression.lit |$ih#exts0#0|) (_module.Expression.lit |$ih#deps0#0|) (_module.Expression.exprLiteral_q |$ih#cmd0#0|))
 :pattern ( (_module.StateC.st |$ih#stC0#0|) (_module.Expression.lit |$ih#exts0#0|) (_module.Expression.exprLiteral_q |$ih#deps0#0|) (_module.Expression.lit |$ih#cmd0#0|))
 :pattern ( (_module.StateC.st |$ih#stC0#0|) (_module.Expression.lit |$ih#exts0#0|) (_module.Expression.exprLiteral_q |$ih#deps0#0|) (_module.Expression.exprLiteral_q |$ih#cmd0#0|))
 :pattern ( (_module.StateC.st |$ih#stC0#0|) (_module.Expression.exprLiteral_q |$ih#exts0#0|) (_module.Expression.lit |$ih#deps0#0|) (_module.Expression.lit |$ih#cmd0#0|))
 :pattern ( (_module.StateC.st |$ih#stC0#0|) (_module.Expression.exprLiteral_q |$ih#exts0#0|) (_module.Expression.lit |$ih#deps0#0|) (_module.Expression.exprLiteral_q |$ih#cmd0#0|))
 :pattern ( (_module.StateC.st |$ih#stC0#0|) (_module.Expression.exprLiteral_q |$ih#exts0#0|) (_module.Expression.exprLiteral_q |$ih#deps0#0|) (_module.Expression.lit |$ih#cmd0#0|))
 :pattern ( (_module.StateC.st |$ih#stC0#0|) (_module.Expression.exprLiteral_q |$ih#exts0#0|) (_module.Expression.exprLiteral_q |$ih#deps0#0|) (_module.Expression.exprLiteral_q |$ih#cmd0#0|))
))))) (and (=> (= (ControlFlow 0 19) (- 0 27)) (_module.Expression.exprLiteral_q |exts#0@@4|)) (=> (_module.Expression.exprLiteral_q |exts#0@@4|) (and (=> (= (ControlFlow 0 19) (- 0 26)) (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#0@@4|))) (=> (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#0@@4|)) (=> (= |strs#0@0| (_module.Literal.strs (_module.Expression.lit |exts#0@@4|))) (=> (and (and ($IsAlloc DatatypeTypeType |cmd#0@@8| Tclass._module.Expression $Heap@0) ($IsAlloc DatatypeTypeType |deps#0@@7| Tclass._module.Expression $Heap@0)) (and ($IsAlloc DatatypeTypeType |exts#0@@4| Tclass._module.Expression $Heap@0) ($IsAlloc DatatypeTypeType |stC#0@@6| Tclass._module.StateC $Heap@0))) (and (=> (= (ControlFlow 0 19) (- 0 25)) (_module.Expression.exprLiteral_q |cmd#0@@8|)) (and (=> (= (ControlFlow 0 19) (- 0 24)) (_module.Literal.litString_q (_module.Expression.lit |cmd#0@@8|))) (and (=> (= (ControlFlow 0 19) (- 0 23)) (_module.Expression.exprLiteral_q |deps#0@@7|)) (and (=> (= (ControlFlow 0 19) (- 0 22)) (_module.Literal.litArrOfPaths_q (_module.Expression.lit |deps#0@@7|))) (and (=> (= (ControlFlow 0 19) (- 0 21)) (_module.Expression.exprLiteral_q |exts#0@@4|)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#0@@4|))) (=> (and (and (and (and (and (and (_module.Expression.exprLiteral_q |cmd#0@@8|) (_module.Literal.litString_q (_module.Expression.lit |cmd#0@@8|))) (_module.Expression.exprLiteral_q |deps#0@@7|)) (_module.Literal.litArrOfPaths_q (_module.Expression.lit |deps#0@@7|))) (_module.Expression.exprLiteral_q |exts#0@@4|)) (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#0@@4|))) (and (and (|_module.__default.UpdateC#canCall| |cmd#0@@8| |deps#0@@7| |exts#0@@4| |stC#0@@6|) (_module.StateC.S_q (_module.__default.UpdateC ($LS $LZ) |cmd#0@@8| |deps#0@@7| |exts#0@@4| |stC#0@@6|))) (and (|_module.__default.UpdateC#canCall| |cmd#0@@8| |deps#0@@7| |exts#0@@4| |stC#0@@6|) (= |stC'#2@0| (_module.__default.UpdateC ($LS $LZ) |cmd#0@@8| |deps#0@@7| |exts#0@@4| |stC#0@@6|))))) (and (=> (= (ControlFlow 0 19) 6) anon5_Then_correct) (=> (= (ControlFlow 0 19) 8) anon5_Else_correct)))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (and (and (and (and ($Is DatatypeTypeType |cmd#0@@8| Tclass._module.Expression) ($IsAlloc DatatypeTypeType |cmd#0@@8| Tclass._module.Expression $Heap@@1)) (|$IsA#_module.Expression| |cmd#0@@8|)) (and (and ($Is DatatypeTypeType |deps#0@@7| Tclass._module.Expression) ($IsAlloc DatatypeTypeType |deps#0@@7| Tclass._module.Expression $Heap@@1)) (|$IsA#_module.Expression| |deps#0@@7|))) (and (and (and ($Is DatatypeTypeType |exts#0@@4| Tclass._module.Expression) ($IsAlloc DatatypeTypeType |exts#0@@4| Tclass._module.Expression $Heap@@1)) (|$IsA#_module.Expression| |exts#0@@4|)) (and (and ($Is DatatypeTypeType |stC#0@@6| Tclass._module.StateC) ($IsAlloc DatatypeTypeType |stC#0@@6| Tclass._module.StateC $Heap@@1)) (|$IsA#_module.StateC| |stC#0@@6|)))) (and (and (and (and ($Is SetType |strs#0@@1| (TSet (TSeq TChar))) ($IsAlloc SetType |strs#0@@1| (TSet (TSeq TChar)) $Heap@@1)) true) (and (=> |defass#stC'#2| (and ($Is DatatypeTypeType |stC'#2| Tclass._module.StateC) ($IsAlloc DatatypeTypeType |stC'#2| Tclass._module.StateC $Heap@@1))) true)) (and (and (and ($Is SeqType |e#1_0| (TSeq TChar)) ($IsAlloc SeqType |e#1_0| (TSeq TChar) $Heap@@1)) true) (and (=> |defass#c'#1_0| (and ($IsBox |c'#1_0| Tclass._module.Cache) ($IsAllocBox |c'#1_0| Tclass._module.Cache $Heap@@1))) true)))) (and (and (and (and (and ($Is DatatypeTypeType |exts'#1_0| Tclass._module.Expression) ($IsAlloc DatatypeTypeType |exts'#1_0| Tclass._module.Expression $Heap@@1)) true) (= 4 $FunctionContextHeight)) (and (_module.Expression.exprLiteral_q |cmd#0@@8|) (_module.Literal.litString_q (_module.Expression.lit |cmd#0@@8|)))) (and (and (and (_module.Expression.exprLiteral_q |deps#0@@7|) (_module.Literal.litArrOfPaths_q (_module.Expression.lit |deps#0@@7|))) (and (_module.Expression.exprLiteral_q |exts#0@@4|) (_module.Literal.litArrOfStrings_q (_module.Expression.lit |exts#0@@4|)))) (and (and (|_module.__default.ConsistentCache#canCall| |stC#0@@6|) (and (_module.__default.ConsistentCache |stC#0@@6|) (forall ((|cmd#3| T@U) (|deps#3| T@U) (|e#6| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |cmd#3| Tclass._module.Expression) ($Is DatatypeTypeType |deps#3| Tclass._module.Expression)) ($Is SeqType |e#6| (TSeq TChar))) (=> (|Set#IsMember| (_module.__default.DomC (_module.StateC.c |stC#0@@6|)) (_module.__default.Hash (_module.__default.Loc |cmd#3| |deps#3| |e#6|))) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@6|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#3| |deps#3| |e#6|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.151:10|
 :skolemid |762|
 :pattern ( (_module.__default.Loc |cmd#3| |deps#3| |e#6|))
)))) (and (forall ((|e#1@@3| T@U) ) (!  (=> ($Is SeqType |e#1@@3| (TSeq TChar)) (=> (|Set#IsMember| (_module.Literal.strs (_module.Expression.lit |exts#0@@4|)) ($Box SeqType |e#1@@3|)) (|Set#IsMember| (_module.__default.DomSt (_module.StateC.st |stC#0@@6|)) ($Box DatatypeTypeType (_module.__default.Loc |cmd#0@@8| |deps#0@@7| |e#1@@3|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.69:12|
 :skolemid |763|
...
)) (= (ControlFlow 0 28) 19)))))) anon0_correct))))
