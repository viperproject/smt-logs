...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|cmd#0@@1| T@U) (|deps#0@@1| T@U) (|exts#0@@0| T@U) (|st#0@@2| T@U) ) (!  (=> (or (|_module.__default.Post#canCall| (Lit DatatypeTypeType |cmd#0@@1|) (Lit DatatypeTypeType |deps#0@@1|) (Lit DatatypeTypeType |exts#0@@0|) (Lit BoxType |st#0@@2|)) (and (< 3 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |cmd#0@@1| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@1| Tclass._module.Expression)) ($Is DatatypeTypeType |exts#0@@0| Tclass._module.Expression)) ($IsBox |st#0@@2| Tclass._module.State)) (U_2_bool (Lit boolType (bool_2_U  (and (and (and (and (and (_module.Expression.exprLiteral_q (Lit DatatypeTypeType |cmd#0@@1|)) (_module.Literal.litString_q (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |cmd#0@@1|))))) (_module.Expression.exprLiteral_q (Lit DatatypeTypeType |deps#0@@1|))) (_module.Literal.litArrOfPaths_q (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |deps#0@@1|))))) (_module.Expression.exprLiteral_q (Lit DatatypeTypeType |exts#0@@0|))) (_module.Literal.litArrOfStrings_q (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@0|))))))))))) (and (forall ((|e#2| T@U) ) (!  (=> ($Is SeqType |e#2| (TSeq TChar)) (and (=> (|Set#IsMember| (Lit SetType (_module.Literal.strs (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@0|))))) ($Box SeqType |e#2|)) (and (|_module.__default.Loc#canCall| (Lit DatatypeTypeType |cmd#0@@1|) (Lit DatatypeTypeType |deps#0@@1|) |e#2|) (|_module.__default.DomSt#canCall| (Lit BoxType |st#0@@2|)))) (=> (=> (|Set#IsMember| (Lit SetType (_module.Literal.strs (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@0|))))) ($Box SeqType |e#2|)) (|Set#IsMember| (_module.__default.DomSt (Lit BoxType |st#0@@2|)) ($Box DatatypeTypeType (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@1|) (Lit DatatypeTypeType |deps#0@@1|) |e#2|)))) (=> (|Set#IsMember| (Lit SetType (_module.Literal.strs (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@0|))))) ($Box SeqType |e#2|)) (and (and (|_module.__default.Loc#canCall| (Lit DatatypeTypeType |cmd#0@@1|) (Lit DatatypeTypeType |deps#0@@1|) |e#2|) (|_module.__default.GetSt#canCall| (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@1|) (Lit DatatypeTypeType |deps#0@@1|) |e#2|) (Lit BoxType |st#0@@2|))) (|_module.__default.Res#canCall| (Lit DatatypeTypeType |cmd#0@@1|) (Lit DatatypeTypeType |deps#0@@1|) |e#2| (Lit BoxType |st#0@@2|)))))))
 :qid |CloudMakeConsistentBuildslegacydfy.212:10|
 :skolemid |942|
...
)) (= (_module.__default.Post (Lit DatatypeTypeType |cmd#0@@1|) (Lit DatatypeTypeType |deps#0@@1|) (Lit DatatypeTypeType |exts#0@@0|) (Lit BoxType |st#0@@2|)) (forall ((|e#2@@0| T@U) ) (!  (=> ($Is SeqType |e#2@@0| (TSeq TChar)) (and (=> (|Set#IsMember| (Lit SetType (_module.Literal.strs (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@0|))))) ($Box SeqType |e#2@@0|)) (|Set#IsMember| (_module.__default.DomSt (Lit BoxType |st#0@@2|)) ($Box DatatypeTypeType (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@1|) (Lit DatatypeTypeType |deps#0@@1|) |e#2@@0|)))) (=> (|Set#IsMember| (Lit SetType (_module.Literal.strs (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@0|))))) ($Box SeqType |e#2@@0|)) (= (_module.__default.GetSt (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@1|) (Lit DatatypeTypeType |deps#0@@1|) |e#2@@0|) (Lit BoxType |st#0@@2|)) (_module.__default.Res (Lit DatatypeTypeType |cmd#0@@1|) (Lit DatatypeTypeType |deps#0@@1|) |e#2@@0| (Lit BoxType |st#0@@2|))))))
 :qid |CloudMakeConsistentBuildslegacydfy.212:10|
 :skolemid |941|
 ...
 :weight 3
 :skolemid |943|
 :pattern ( (_module.__default.Post (Lit DatatypeTypeType |cmd#0@@1|) (Lit DatatypeTypeType |deps#0@@1|) (Lit DatatypeTypeType |exts#0@@0|) (Lit BoxType |st#0@@2|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|cmd#0@@2| T@U) (|deps#0@@2| T@U) (|ext#0@@0| T@U) (|st#0@@3| T@U) ) (!  (=> (or (|_module.__default.Res#canCall| |cmd#0@@2| |deps#0@@2| |ext#0@@0| |st#0@@3|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |cmd#0@@2| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@2| Tclass._module.Expression)) ($Is SeqType |ext#0@@0| (TSeq TChar))) ($IsBox |st#0@@3| Tclass._module.State)))) ($IsBox (_module.__default.Res |cmd#0@@2| |deps#0@@2| |ext#0@@0| |st#0@@3|) Tclass._module.Artifact))
 :qid |CloudMakeConsistentBuildslegacydfy.216:20|
 :skolemid |952|
 :pattern ( (_module.__default.Res |cmd#0@@2| |deps#0@@2| |ext#0@@0| |st#0@@3|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|cmd#0@@3| T@U) (|deps#0@@3| T@U) (|exts#0@@1| T@U) (|st#0@@4| T@U) ) (!  (=> (or (|_module.__default.Post#canCall| (Lit DatatypeTypeType |cmd#0@@3|) (Lit DatatypeTypeType |deps#0@@3|) (Lit DatatypeTypeType |exts#0@@1|) |st#0@@4|) (and (< 3 $FunctionContextHeight) (and (and (and (and ($Is DatatypeTypeType |cmd#0@@3| Tclass._module.Expression) ($Is DatatypeTypeType |deps#0@@3| Tclass._module.Expression)) ($Is DatatypeTypeType |exts#0@@1| Tclass._module.Expression)) ($IsBox |st#0@@4| Tclass._module.State)) (U_2_bool (Lit boolType (bool_2_U  (and (and (and (and (and (_module.Expression.exprLiteral_q (Lit DatatypeTypeType |cmd#0@@3|)) (_module.Literal.litString_q (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |cmd#0@@3|))))) (_module.Expression.exprLiteral_q (Lit DatatypeTypeType |deps#0@@3|))) (_module.Literal.litArrOfPaths_q (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |deps#0@@3|))))) (_module.Expression.exprLiteral_q (Lit DatatypeTypeType |exts#0@@1|))) (_module.Literal.litArrOfStrings_q (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@1|))))))))))) (and (forall ((|e#1| T@U) ) (!  (=> ($Is SeqType |e#1| (TSeq TChar)) (and (=> (|Set#IsMember| (Lit SetType (_module.Literal.strs (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@1|))))) ($Box SeqType |e#1|)) (and (|_module.__default.Loc#canCall| (Lit DatatypeTypeType |cmd#0@@3|) (Lit DatatypeTypeType |deps#0@@3|) |e#1|) (|_module.__default.DomSt#canCall| |st#0@@4|))) (=> (=> (|Set#IsMember| (Lit SetType (_module.Literal.strs (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@1|))))) ($Box SeqType |e#1|)) (|Set#IsMember| (_module.__default.DomSt |st#0@@4|) ($Box DatatypeTypeType (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@3|) (Lit DatatypeTypeType |deps#0@@3|) |e#1|)))) (=> (|Set#IsMember| (Lit SetType (_module.Literal.strs (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@1|))))) ($Box SeqType |e#1|)) (and (and (|_module.__default.Loc#canCall| (Lit DatatypeTypeType |cmd#0@@3|) (Lit DatatypeTypeType |deps#0@@3|) |e#1|) (|_module.__default.GetSt#canCall| (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@3|) (Lit DatatypeTypeType |deps#0@@3|) |e#1|) |st#0@@4|)) (|_module.__default.Res#canCall| (Lit DatatypeTypeType |cmd#0@@3|) (Lit DatatypeTypeType |deps#0@@3|) |e#1| |st#0@@4|))))))
 :qid |CloudMakeConsistentBuildslegacydfy.212:10|
 :skolemid |939|
 :pattern ( (_module.__default.Res |cmd#0@@3| |deps#0@@3| |e#1| |st#0@@4|))
...
)) (= (_module.__default.Post (Lit DatatypeTypeType |cmd#0@@3|) (Lit DatatypeTypeType |deps#0@@3|) (Lit DatatypeTypeType |exts#0@@1|) |st#0@@4|) (forall ((|e#1@@0| T@U) ) (!  (=> ($Is SeqType |e#1@@0| (TSeq TChar)) (and (=> (|Set#IsMember| (Lit SetType (_module.Literal.strs (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@1|))))) ($Box SeqType |e#1@@0|)) (|Set#IsMember| (_module.__default.DomSt |st#0@@4|) ($Box DatatypeTypeType (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@3|) (Lit DatatypeTypeType |deps#0@@3|) |e#1@@0|)))) (=> (|Set#IsMember| (Lit SetType (_module.Literal.strs (Lit DatatypeTypeType (_module.Expression.lit (Lit DatatypeTypeType |exts#0@@1|))))) ($Box SeqType |e#1@@0|)) (= (_module.__default.GetSt (_module.__default.Loc (Lit DatatypeTypeType |cmd#0@@3|) (Lit DatatypeTypeType |deps#0@@3|) |e#1@@0|) |st#0@@4|) (_module.__default.Res (Lit DatatypeTypeType |cmd#0@@3|) (Lit DatatypeTypeType |deps#0@@3|) |e#1@@0| |st#0@@4|)))))
 :qid |CloudMakeConsistentBuildslegacydfy.212:10|
 :skolemid |938|
 :pattern ( (_module.__default.Res |cmd#0@@3| |deps#0@@3| |e#1@@0| |st#0@@4|))
 ...
 :weight 3
 :skolemid |940|
 :pattern ( (_module.__default.Post (Lit DatatypeTypeType |cmd#0@@3|) (Lit DatatypeTypeType |deps#0@@3|) (Lit DatatypeTypeType |exts#0@@1|) |st#0@@4|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Post)
