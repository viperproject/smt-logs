...
(let ((anon16_Else_correct  (=> (and (not (and (and (<= (LitInt 0) |i#2@0|) (< |i#2@0| |j#2@0|)) (< |j#2@0| (|Seq#Length| (Shared.Board.pieces |board#0@@1|))))) (= (ControlFlow 0 7) 2)) anon10_correct)))
(let ((anon16_Then_correct  (=> (and (and (and (<= (LitInt 0) |i#2@0|) (< |i#2@0| |j#2@0|)) (< |j#2@0| (|Seq#Length| (Shared.Board.pieces |board#0@@1|)))) (Shared.Board.Board_q |board#0@@1|)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (and (<= 0 |i#2@0|) (< |i#2@0| (|Seq#Length| (Shared.Board.pieces |board#0@@1|))))) (=> (and (<= 0 |i#2@0|) (< |i#2@0| (|Seq#Length| (Shared.Board.pieces |board#0@@1|)))) (=> (and (Shared.Piece.Piece_q ($Unbox DatatypeTypeType (|Seq#Index| (Shared.Board.pieces |board#0@@1|) |i#2@0|))) (Shared.Board.Board_q |board#0@@1|)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (and (<= 0 |j#2@0|) (< |j#2@0| (|Seq#Length| (Shared.Board.pieces |board#0@@1|))))) (=> (and (<= 0 |j#2@0|) (< |j#2@0| (|Seq#Length| (Shared.Board.pieces |board#0@@1|)))) (=> (and (Shared.Piece.Piece_q ($Unbox DatatypeTypeType (|Seq#Index| (Shared.Board.pieces |board#0@@1|) |j#2@0|))) (= (ControlFlow 0 4) 2)) anon10_correct)))))))))
...
(let ((anon15_Then_correct  (=> (and (and (<= (LitInt 0) |i#2@0|) (< |i#2@0| |j#2@0|)) (Shared.Board.Board_q |board#0@@1|)) (and (=> (= (ControlFlow 0 8) 4) anon16_Then_correct) (=> (= (ControlFlow 0 8) 7) anon16_Else_correct)))))
...
(let ((anon13_Then_correct  (=> (and (<= (LitInt 0) |i#2@0|) (<= (LitInt 0) |j#2@0|)) (and (=> (= (ControlFlow 0 12) 10) anon14_Then_correct) (=> (= (ControlFlow 0 12) 11) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#2@0|) (<= (LitInt 0) |j#2@0|))) (= (ControlFlow 0 3) 2)) anon10_correct)))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |board#0@@1| Tclass.Shared.Board)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct)))
