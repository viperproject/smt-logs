// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/blogposts/TestGenerationWithInliningQuantifiedDefinitions.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/blogposts/TestGenerationWithInliningQuantifiedDefinitions-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/blogposts/TestGenerationWithInliningQuantifiedDefinitions.dfy
   ...
   ==> (forall board#0: DatatypeType :: 
    ...
    Chess.__default.BoardIsValid#canCall(board#0)
       ...
       ==> (forall i#0: int, j#0: int :: 
          { $Unbox(Seq#Index(Shared.Board.pieces(board#0), j#0)): DatatypeType, $Unbox(Seq#Index(Shared.Board.pieces(board#0), i#0)): DatatypeType } 
          LitInt(0) <= i#0 && LitInt(0) <= j#0
            ...
            i#0 < j#0
             ==> Shared.Board.Board_q(board#0)
               && (j#0 < Seq#Length(Shared.Board.pieces(board#0))
                 ==> $IsA#Shared.Pos(Shared.Piece.at($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#0)): DatatypeType))
                   && $IsA#Shared.Pos(Shared.Piece.at($Unbox(Seq#Index(Shared.Board.pieces(board#0), j#0)): DatatypeType))
                   && 
                  Shared.Board.Board_q(board#0)
                   && Shared.Piece.Piece_q($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#0)): DatatypeType)
                   && 
                  Shared.Board.Board_q(board#0)
                   && Shared.Piece.Piece_q($Unbox(Seq#Index(Shared.Board.pieces(board#0), j#0)): DatatypeType)))
         && Chess.__default.BoardIsValid(board#0)
           == (forall i#0: int, j#0: int :: 
            { $Unbox(Seq#Index(Shared.Board.pieces(board#0), j#0)): DatatypeType, $Unbox(Seq#Index(Shared.Board.pieces(board#0), i#0)): DatatypeType } 
            LitInt(0) <= i#0 && LitInt(0) <= j#0
               ==> 
              LitInt(0) <= i#0 && i#0 < j#0 && j#0 < Seq#Length(Shared.Board.pieces(board#0))
               ==> !Shared.Pos#Equal(Shared.Piece.at($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#0)): DatatypeType), 
                Shared.Piece.at($Unbox(Seq#Index(Shared.Board.pieces(board#0), j#0)): DatatypeType))));
   ...
   ==> (forall board#0: DatatypeType :: 
    ...
    Chess.__default.BoardIsValid#canCall(Lit(board#0))
       ...
       ==> (forall i#1: int, j#1: int :: 
          { $Unbox(Seq#Index(Shared.Board.pieces(board#0), j#1)): DatatypeType, $Unbox(Seq#Index(Shared.Board.pieces(board#0), i#1)): DatatypeType } 
          LitInt(0) <= i#1 && LitInt(0) <= j#1
            ...
            i#1 < j#1
             ==> Shared.Board.Board_q(Lit(board#0))
               && (j#1 < Seq#Length(Lit(Shared.Board.pieces(Lit(board#0))))
                 ==> $IsA#Shared.Pos(Shared.Piece.at($Unbox(Seq#Index(Lit(Shared.Board.pieces(Lit(board#0))), i#1)): DatatypeType))
                   && $IsA#Shared.Pos(Shared.Piece.at($Unbox(Seq#Index(Lit(Shared.Board.pieces(Lit(board#0))), j#1)): DatatypeType))
                   && 
                  Shared.Board.Board_q(Lit(board#0))
                   && Shared.Piece.Piece_q($Unbox(Seq#Index(Lit(Shared.Board.pieces(Lit(board#0))), i#1)): DatatypeType)
                   && 
                  Shared.Board.Board_q(Lit(board#0))
                   && Shared.Piece.Piece_q($Unbox(Seq#Index(Lit(Shared.Board.pieces(Lit(board#0))), j#1)): DatatypeType)))
           ...
           == (forall i#1: int, j#1: int :: 
            ...
            LitInt(0) <= i#1 && LitInt(0) <= j#1
              ...
              LitInt(0) <= i#1
                 && i#1 < j#1
                 && j#1 < Seq#Length(Lit(Shared.Board.pieces(Lit(board#0))))
               ==> !Shared.Pos#Equal(Shared.Piece.at($Unbox(Seq#Index(Lit(Shared.Board.pieces(Lit(board#0))), i#1)): DatatypeType), 
                Shared.Piece.at($Unbox(Seq#Index(Lit(Shared.Board.pieces(Lit(board#0))), j#1)): DatatypeType))));
}
  ...
  var j#2: int;
    ...
    else
    {
        ...
        if (LitInt(0) <= i#2 && LitInt(0) <= j#2)
        {
            ...
            if (LitInt(0) <= i#2 && i#2 < j#2 && j#2 < Seq#Length(Shared.Board.pieces(board#0)))
            {
                assume Shared.Board.Board_q(board#0);
                assert {:id "id2"} 0 <= i#2 && i#2 < Seq#Length(Shared.Board.pieces(board#0));
                assume Shared.Piece.Piece_q($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#2)): DatatypeType);
                assume Shared.Board.Board_q(board#0);
                assert {:id "id3"} 0 <= j#2 && j#2 < Seq#Length(Shared.Board.pieces(board#0));
                assume Shared.Piece.Piece_q($Unbox(Seq#Index(Shared.Board.pieces(board#0), j#2)): DatatypeType);
            }
        }

        // End Comprehension WF check
        assume {:id "id4"} Chess.__default.BoardIsValid(board#0)
           == (forall i#3: int, j#3: int :: 
            { $Unbox(Seq#Index(Shared.Board.pieces(board#0), j#3)): DatatypeType, $Unbox(Seq#Index(Shared.Board.pieces(board#0), i#3)): DatatypeType } 
            LitInt(0) <= i#3 && LitInt(0) <= j#3
               ==> 
              LitInt(0) <= i#3 && i#3 < j#3 && j#3 < Seq#Length(Shared.Board.pieces(board#0))
               ==> !Shared.Pos#Equal(Shared.Piece.at($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#3)): DatatypeType), 
                Shared.Piece.at($Unbox(Seq#Index(Shared.Board.pieces(board#0), j#3)): DatatypeType)));
        assume (forall i#3: int, j#3: int :: 
          { $Unbox(Seq#Index(Shared.Board.pieces(board#0), j#3)): DatatypeType, $Unbox(Seq#Index(Shared.Board.pieces(board#0), i#3)): DatatypeType } 
          LitInt(0) <= i#3 && LitInt(0) <= j#3
             ==> (LitInt(0) <= i#3 ==> i#3 < j#3 ==> Shared.Board.Board_q(board#0))
               && (LitInt(0) <= i#3 && i#3 < j#3 && j#3 < Seq#Length(Shared.Board.pieces(board#0))
                 ==> $IsA#Shared.Pos(Shared.Piece.at($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#3)): DatatypeType))
                   && $IsA#Shared.Pos(Shared.Piece.at($Unbox(Seq#Index(Shared.Board.pieces(board#0), j#3)): DatatypeType))
                   && 
                  Shared.Board.Board_q(board#0)
                   && Shared.Piece.Piece_q($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#3)): DatatypeType)
                   && 
                  Shared.Board.Board_q(board#0)
                   && Shared.Piece.Piece_q($Unbox(Seq#Index(Shared.Board.pieces(board#0), j#3)): DatatypeType)));
...
axiom {:id "id5"} 4 <= $FunctionContextHeight
...
axiom {:id "id6"} 4 <= $FunctionContextHeight
   ==> (forall board#0: DatatypeType, king#0: DatatypeType, byPlayer#0: DatatypeType :: 
...
procedure {:verboseName "Chess.CheckedByPlayer (well-formedness)"} {:testInline 1} CheckWellformed$$Chess.__default.CheckedByPlayer(board#0: DatatypeType where $Is(board#0, Tclass.Chess.ValidBoard()), 
...
axiom {:id "id8"} 2 <= $FunctionContextHeight
   ==> (forall board#0: DatatypeType, king#0: DatatypeType, byPiece#0: DatatypeType :: 
    ...
    Chess.__default.CheckedByPiece#canCall(board#0, king#0, byPiece#0)
       ...
       ==> (forall i#0: int :: 
          { $Unbox(Seq#Index(Shared.Board.pieces(board#0), i#0)): DatatypeType } 
          LitInt(0) <= i#0
             ==> Shared.Board.Board_q(board#0)
               && (i#0 < Seq#Length(Shared.Board.pieces(board#0))
                 ==> $IsA#Shared.PieceKind(Shared.Piece.kind($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#0)): DatatypeType))
                   && $IsA#Shared.PieceKind(byPiece#0)
                   && 
                  Shared.Board.Board_q(board#0)
                   && Shared.Piece.Piece_q($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#0)): DatatypeType)
                   && (Shared.PieceKind#Equal(Shared.Piece.kind($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#0)): DatatypeType), 
                      byPiece#0)
                     ==> Shared.Board.Board_q(board#0)
                       && Shared.Piece.Piece_q(king#0)
                       && Shared.Piece.Attacks#canCall($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#0)): DatatypeType, 
         ...
         && Chess.__default.CheckedByPiece(board#0, king#0, byPiece#0)
           == (exists i#0: int :: 
            ...
            LitInt(0) <= i#0
               ...
               && Shared.PieceKind#Equal(Shared.Piece.kind($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#0)): DatatypeType), 
                byPiece#0)
               && Shared.Piece.Attacks($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#0)): DatatypeType, 
                Shared.Piece.at(king#0))));
    ...
    Chess.__default.CheckedByPiece#canCall(Lit(board#0), Lit(king#0), Lit(byPiece#0))
         || (2 < $FunctionContextHeight
          ...
          $Is(board#0, Tclass.Chess.ValidBoard())
           ...
           && $Is(byPiece#0, Tclass.Shared.PieceKind()))
       ==> (forall i#1: int :: 
          { $Unbox(Seq#Index(Shared.Board.pieces(board#0), i#1)): DatatypeType } 
          LitInt(0) <= i#1
             ==> Shared.Board.Board_q(Lit(board#0))
               && (i#1 < Seq#Length(Lit(Shared.Board.pieces(Lit(board#0))))
                 ==> $IsA#Shared.PieceKind(Shared.Piece.kind($Unbox(Seq#Index(Lit(Shared.Board.pieces(Lit(board#0))), i#1)): DatatypeType))
                   && $IsA#Shared.PieceKind(Lit(byPiece#0))
                   && 
                  Shared.Board.Board_q(Lit(board#0))
                   && Shared.Piece.Piece_q($Unbox(Seq#Index(Lit(Shared.Board.pieces(Lit(board#0))), i#1)): DatatypeType)
                   && (Shared.PieceKind#Equal(Shared.Piece.kind($Unbox(Seq#Index(Lit(Shared.Board.pieces(Lit(board#0))), i#1)): DatatypeType), 
                      byPiece#0)
                     ==> Shared.Board.Board_q(Lit(board#0))
                       && Shared.Piece.Piece_q(Lit(king#0))
                       && Shared.Piece.Attacks#canCall($Unbox(Seq#Index(Lit(Shared.Board.pieces(Lit(board#0))), i#1)): DatatypeType, 
         ...
         && Chess.__default.CheckedByPiece(Lit(board#0), Lit(king#0), Lit(byPiece#0))
           == (exists i#1: int :: 
            ...
            LitInt(0) <= i#1
               ...
               && Shared.PieceKind#Equal(Shared.Piece.kind($Unbox(Seq#Index(Lit(Shared.Board.pieces(Lit(board#0))), i#1)): DatatypeType), 
                byPiece#0)
               && Shared.Piece.Attacks($Unbox(Seq#Index(Lit(Shared.Board.pieces(Lit(board#0))), i#1)): DatatypeType, 
                Lit(Shared.Piece.at(Lit(king#0))))));
}
  ...
  var ##pos#0: DatatypeType;
    ...
    else
    {
        ...
        if (true)
        {
            ...
            if (LitInt(0) <= i#2 && i#2 < Seq#Length(Shared.Board.pieces(board#0)))
            {
                assume Shared.Board.Board_q(board#0);
                assert {:id "id10"} 0 <= i#2 && i#2 < Seq#Length(Shared.Board.pieces(board#0));
                assume Shared.Piece.Piece_q($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#2)): DatatypeType);
            }

            if (LitInt(0) <= i#2
               && i#2 < Seq#Length(Shared.Board.pieces(board#0))
               && Shared.PieceKind#Equal(Shared.Piece.kind($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#2)): DatatypeType), 
                byPiece#0))
            {
                assume Shared.Board.Board_q(board#0);
                assert {:id "id11"} 0 <= i#2 && i#2 < Seq#Length(Shared.Board.pieces(board#0));
                // assume allocatedness for receiver argument to function
                assume $IsAllocBox(Seq#Index(Shared.Board.pieces(board#0), i#2), Tclass.Shared.Piece(), $Heap);
                assume Shared.Piece.Piece_q(king#0);
                ##pos#0 := Shared.Piece.at(king#0);
                // assume allocatedness for argument to function
                assume $IsAlloc(##pos#0, Tclass.Shared.ChessPos(), $Heap);
                assume Shared.Piece.Attacks#canCall($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#2)): DatatypeType, 
                  Shared.Piece.at(king#0));
            }
        }

        // End Comprehension WF check
        assume {:id "id12"} Chess.__default.CheckedByPiece(board#0, king#0, byPiece#0)
           == (exists i#3: int :: 
            { $Unbox(Seq#Index(Shared.Board.pieces(board#0), i#3)): DatatypeType } 
            LitInt(0) <= i#3
               && i#3 < Seq#Length(Shared.Board.pieces(board#0))
               && Shared.PieceKind#Equal(Shared.Piece.kind($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#3)): DatatypeType), 
                byPiece#0)
               && Shared.Piece.Attacks($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#3)): DatatypeType, 
                Shared.Piece.at(king#0)));
        assume (forall i#3: int :: 
          { $Unbox(Seq#Index(Shared.Board.pieces(board#0), i#3)): DatatypeType } 
          (LitInt(0) <= i#3 ==> Shared.Board.Board_q(board#0))
             && (LitInt(0) <= i#3 && i#3 < Seq#Length(Shared.Board.pieces(board#0))
               ==> $IsA#Shared.PieceKind(Shared.Piece.kind($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#3)): DatatypeType))
                 && $IsA#Shared.PieceKind(byPiece#0)
                 && 
                Shared.Board.Board_q(board#0)
                 && Shared.Piece.Piece_q($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#3)): DatatypeType)
                 && (Shared.PieceKind#Equal(Shared.Piece.kind($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#3)): DatatypeType), 
                   ...
                   ==> Shared.Board.Board_q(board#0)
                     && Shared.Piece.Piece_q(king#0)
                     && Shared.Piece.Attacks#canCall($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#3)): DatatypeType, 
                      Shared.Piece.at(king#0)))));
        // CheckWellformedWithResult: any expression
...
procedure {:verboseName "Chess.CheckedByPiece (correctness)"} Impl$$Chess.__default.CheckedByPiece(board#0: DatatypeType
       where $Is(board#0, Tclass.Chess.ValidBoard())
         && $IsAlloc(board#0, Tclass.Chess.ValidBoard(), $Heap)
         && $IsA#Shared.Board(board#0), 
    king#0: DatatypeType
       where $Is(king#0, Tclass.Shared.Piece())
         && $IsAlloc(king#0, Tclass.Shared.Piece(), $Heap)
         && $IsA#Shared.Piece(king#0), 
    byPiece#0: DatatypeType
       where $Is(byPiece#0, Tclass.Shared.PieceKind())
         && $IsAlloc(byPiece#0, Tclass.Shared.PieceKind(), $Heap)
         && $IsA#Shared.PieceKind(byPiece#0))
   returns (#result#0: bool, $_reverifyPost: bool);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap;
  // user-defined postconditions
  free ensures Chess.__default.CheckedByPiece#canCall(board#0, king#0, byPiece#0);
  ensures {:id "id13"} #result#0 == Chess.__default.CheckedByPiece(board#0, king#0, byPiece#0);
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Chess.CheckedByPiece (correctness)"} Impl$$Chess.__default.CheckedByPiece(board#0: DatatypeType, king#0: DatatypeType, byPiece#0: DatatypeType)
   returns (#result#0: bool, $_reverifyPost: bool)
{
  ...
  var ##byPiece#0: DatatypeType;
  var ##pos#1: DatatypeType;

    // AddMethodImpl: CheckedByPiece, Impl$$Chess.__default.CheckedByPiece
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- for-loop statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/blogposts/TestGenerationWithInliningQuantifiedDefinitions.dfy(32,5)
    i#4#lo := LitInt(0);
    assume Shared.Board.Board_q(board#0);
    i#4#hi := Seq#Length(Shared.Board.pieces(board#0));
    assert {:id "id14"} i#4#lo <= i#4#hi;
    i#4 := i#4#lo;
    ...
    while (true)
      ...
      free invariant $w$loop#0
         ==> Shared.Board.Board_q(board#0)
           && Chess.__default.CheckedByPiece#canCall(#Shared.Board.Board(Seq#Take(Shared.Board.pieces(board#0), i#4)), 
            king#0, 
            byPiece#0);
      invariant {:id "id18"} $w$loop#0
         ==> !Chess.__default.CheckedByPiece(#Shared.Board.Board(Seq#Take(Shared.Board.pieces(board#0), i#4)), 
          king#0, 
          byPiece#0);
      ...
      free invariant true;
    {
        ...
        {
            assume Shared.Board.Board_q(board#0);
            assert {:id "id15"} {:subsumption 0} 0 <= i#4 && i#4 <= Seq#Length(Shared.Board.pieces(board#0));
            assert {:id "id16"} $Is(#Shared.Board.Board(Seq#Take(Shared.Board.pieces(board#0), i#4)), 
              Tclass.Chess.ValidBoard());
            ##board#0 := #Shared.Board.Board(Seq#Take(Shared.Board.pieces(board#0), i#4));
            // assume allocatedness for argument to function
            ...
            ##byPiece#0 := byPiece#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##byPiece#0, Tclass.Shared.PieceKind(), $Heap);
            assume Chess.__default.CheckedByPiece#canCall(#Shared.Board.Board(Seq#Take(Shared.Board.pieces(board#0), i#4)), 
              king#0, 
              byPiece#0);
            assume Shared.Board.Board_q(board#0)
               && Chess.__default.CheckedByPiece#canCall(#Shared.Board.Board(Seq#Take(Shared.Board.pieces(board#0), i#4)), 
                king#0, 
                byPiece#0);
            assume {:id "id17"} !Chess.__default.CheckedByPiece(#Shared.Board.Board(Seq#Take(Shared.Board.pieces(board#0), i#4)), 
              king#0, 
              byPiece#0);
            assume false;
        }
        ...
        push;
        // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/blogposts/TestGenerationWithInliningQuantifiedDefinitions.dfy(34,9)
        assume Shared.Board.Board_q(board#0);
        assert {:id "id19"} 0 <= i#4 && i#4 < Seq#Length(Shared.Board.pieces(board#0));
        assume Shared.Piece.Piece_q($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#4)): DatatypeType);
        if (Shared.PieceKind#Equal(Shared.Piece.kind($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#4)): DatatypeType), 
          byPiece#0))
        {
            assume Shared.Board.Board_q(board#0);
            assert {:id "id20"} 0 <= i#4 && i#4 < Seq#Length(Shared.Board.pieces(board#0));
            // assume allocatedness for receiver argument to function
            assume $IsAllocBox(Seq#Index(Shared.Board.pieces(board#0), i#4), Tclass.Shared.Piece(), $Heap);
            assume Shared.Piece.Piece_q(king#0);
            ##pos#1 := Shared.Piece.at(king#0);
            // assume allocatedness for argument to function
            assume $IsAlloc(##pos#1, Tclass.Shared.ChessPos(), $Heap);
            assume Shared.Piece.Attacks#canCall($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#4)): DatatypeType, 
              Shared.Piece.at(king#0));
        }

        assume $IsA#Shared.PieceKind(Shared.Piece.kind($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#4)): DatatypeType))
           && $IsA#Shared.PieceKind(byPiece#0)
           && 
          Shared.Board.Board_q(board#0)
           && Shared.Piece.Piece_q($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#4)): DatatypeType)
           && (Shared.PieceKind#Equal(Shared.Piece.kind($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#4)): DatatypeType), 
              byPiece#0)
             ==> Shared.Board.Board_q(board#0)
               && Shared.Piece.Piece_q(king#0)
               && Shared.Piece.Attacks#canCall($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#4)): DatatypeType, 
                Shared.Piece.at(king#0)));
        if (Shared.PieceKind#Equal(Shared.Piece.kind($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#4)): DatatypeType), 
            byPiece#0)
           && Shared.Piece.Attacks($Unbox(Seq#Index(Shared.Board.pieces(board#0), i#4)): DatatypeType, 
            Shared.Piece.at(king#0)))
        {
            push;
            // ----- return statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/blogposts/TestGenerationWithInliningQuantifiedDefinitions.dfy(36,13)
            // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/blogposts/TestGenerationWithInliningQuantifiedDefinitions.dfy(36,13)
            assume true;
            assume true;
            #result#0 := Lit(true);
            assume Chess.__default.CheckedByPiece#canCall(board#0, king#0, byPiece#0);
            pop;
            pop;
            return;
    ...
    // ----- return statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/blogposts/TestGenerationWithInliningQuantifiedDefinitions.dfy(39,5)
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/blogposts/TestGenerationWithInliningQuantifiedDefinitions.dfy(39,5)
    assume true;
    assume true;
    #result#0 := Lit(false);
    assume Chess.__default.CheckedByPiece#canCall(board#0, king#0, byPiece#0);
...
// function declaration for Chess._default.BoardPreset
function Chess.__default.BoardPreset(board#0: DatatypeType) : bool
uses {
// definition axiom for Chess.__default.BoardPreset (revealed)
axiom {:id "id23"} 0 <= $FunctionContextHeight
   ==> (forall board#0: DatatypeType :: 
    { Chess.__default.BoardPreset(board#0) } 
    Chess.__default.BoardPreset#canCall(board#0)
         || (0 < $FunctionContextHeight && $Is(board#0, Tclass.Shared.Board()))
       ==> Shared.Board.Board_q(board#0)
           ...
           == (
            Seq#Length(Shared.Board.pieces(board#0)) == LitInt(5)
             ...
             && Shared.PieceKind#Equal(Shared.Piece.kind($Unbox(Seq#Index(Shared.Board.pieces(board#0), LitInt(4))): DatatypeType), 
              #Shared.PieceKind.Pawn(Lit(#Shared.Color.Black())))));
// definition axiom for Chess.__default.BoardPreset for all literals (revealed)
axiom {:id "id24"} 0 <= $FunctionContextHeight
   ==> (forall board#0: DatatypeType :: 
    {:weight 3} { Chess.__default.BoardPreset(Lit(board#0)) } 
    Chess.__default.BoardPreset#canCall(Lit(board#0))
         || (0 < $FunctionContextHeight && $Is(board#0, Tclass.Shared.Board()))
       ==> Shared.Board.Board_q(Lit(board#0))
         ...
         && Chess.__default.BoardPreset(Lit(board#0))
           == (
            Seq#Length(Lit(Shared.Board.pieces(Lit(board#0)))) == LitInt(5)
             && Shared.PieceKind#Equal(Shared.Piece.kind($Unbox(Seq#Index(Lit(Shared.Board.pieces(Lit(board#0))), LitInt(0))): DatatypeType), 
              #Shared.PieceKind.King(Lit(#Shared.Color.White())))
...
function Chess.__default.BoardPreset#canCall(board#0: DatatypeType) : bool;

function Chess.__default.BoardPreset#requires(DatatypeType) : bool;

// #requires axiom for Chess.__default.BoardPreset
axiom (forall board#0: DatatypeType :: 
  { Chess.__default.BoardPreset#requires(board#0) } 
  $Is(board#0, Tclass.Shared.Board())
     ==> Chess.__default.BoardPreset#requires(board#0) == true);

procedure {:verboseName "Chess.BoardPreset (well-formedness)"} CheckWellformed$$Chess.__default.BoardPreset(board#0: DatatypeType where $Is(board#0, Tclass.Shared.Board()));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Chess.BoardPreset (well-formedness)"} CheckWellformed$$Chess.__default.BoardPreset(board#0: DatatypeType)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    else
    {
        ...
        {
            assume Shared.Board.Board_q(board#0);
            assert {:id "id25"} 0 <= LitInt(0) && LitInt(0) < Seq#Length(Shared.Board.pieces(board#0));
        ...
        {
            assume Shared.Board.Board_q(board#0);
            assert {:id "id26"} 0 <= LitInt(1) && LitInt(1) < Seq#Length(Shared.Board.pieces(board#0));
        ...
        {
            assume Shared.Board.Board_q(board#0);
            assert {:id "id27"} 0 <= LitInt(2) && LitInt(2) < Seq#Length(Shared.Board.pieces(board#0));
        ...
        {
            assume Shared.Board.Board_q(board#0);
            assert {:id "id28"} 0 <= LitInt(3) && LitInt(3) < Seq#Length(Shared.Board.pieces(board#0));
        ...
        {
            assume Shared.Board.Board_q(board#0);
            assert {:id "id29"} 0 <= LitInt(4) && LitInt(4) < Seq#Length(Shared.Board.pieces(board#0));
            assume Shared.Piece.Piece_q($Unbox(Seq#Index(Shared.Board.pieces(board#0), LitInt(4))): DatatypeType);
        }

        assume {:id "id30"} Chess.__default.BoardPreset(board#0)
           == (
            Seq#Length(Shared.Board.pieces(board#0)) == LitInt(5)
             && Shared.PieceKind#Equal(Shared.Piece.kind($Unbox(Seq#Index(Shared.Board.pieces(board#0), LitInt(0))): DatatypeType), 
              #Shared.PieceKind.King(Lit(#Shared.Color.White())))
                           ...
                           && (Shared.PieceKind#Equal(Shared.Piece.kind($Unbox(Seq#Index(Shared.Board.pieces(board#0), LitInt(3))): DatatypeType), 
                             ...
                             ==> $IsA#Shared.PieceKind(Shared.Piece.kind($Unbox(Seq#Index(Shared.Board.pieces(board#0), LitInt(4))): DatatypeType))
                              ...
                              Shared.Board.Board_q(board#0)
                               && Shared.Piece.Piece_q($Unbox(Seq#Index(Shared.Board.pieces(board#0), LitInt(4))): DatatypeType))))));
        // CheckWellformedWithResult: any expression
        assume $Is(Chess.__default.BoardPreset(board#0), TBool);
        return;
...
axiom {:id "id31"} 5 <= $FunctionContextHeight
   ==> (forall board#0: DatatypeType, king#0: DatatypeType, byPlayer#0: DatatypeType :: 
...
axiom {:id "id32"} 5 <= $FunctionContextHeight
   ==> (forall board#0: DatatypeType, king#0: DatatypeType, byPlayer#0: DatatypeType :: 
  ...
  var ##byPlayer#8: DatatypeType;
    ...
    else
    {
           ...
           || Shared.Pos.col(Shared.Piece.at(king#0)) == LitInt(7)))
        {
            ...
            assume Shared.Piece.Piece_q(king#0);
            assume Shared.Pos.Pos_q(Shared.Piece.at(king#0));
            assert {:id "id33"} $Is(#Shared.Pos.Pos(Shared.Pos.row(Shared.Piece.at(king#0)) - 1, 
                Shared.Pos.col(Shared.Piece.at(king#0)) + 1), 
            ...
            byPlayer#0))
        {
            ...
            if (Shared.Pos.col(Shared.Piece.at(king#0)) != LitInt(7))
            {
                ...
                assume Shared.Piece.Piece_q(king#0);
                assume Shared.Pos.Pos_q(Shared.Piece.at(king#0));
                assert {:id "id34"} $Is(#Shared.Pos.Pos(Shared.Pos.row(Shared.Piece.at(king#0)), 
                    Shared.Pos.col(Shared.Piece.at(king#0)) + 1), 
                  Tclass.Shared.ChessPos());
              ...
              byPlayer#0)))
        {
               ...
               || Shared.Pos.col(Shared.Piece.at(king#0)) == LitInt(7)))
            {
                ...
                assume Shared.Piece.Piece_q(king#0);
                assume Shared.Pos.Pos_q(Shared.Piece.at(king#0));
                assert {:id "id35"} $Is(#Shared.Pos.Pos(Shared.Pos.row(Shared.Piece.at(king#0)) + 1, 
                    Shared.Pos.col(Shared.Piece.at(king#0)) + 1), 
                  Tclass.Shared.ChessPos());
              ...
              byPlayer#0)))
        {
            ...
            if (Shared.Pos.row(Shared.Piece.at(king#0)) != LitInt(0))
            {
                ...
                assume Shared.Piece.Piece_q(king#0);
                assume Shared.Pos.Pos_q(Shared.Piece.at(king#0));
                assert {:id "id36"} $Is(#Shared.Pos.Pos(Shared.Pos.row(Shared.Piece.at(king#0)) - 1, 
                    Shared.Pos.col(Shared.Piece.at(king#0))), 
                  Tclass.Shared.ChessPos());
           ...
           && Chess.__default.CheckedByPlayer(board#0, king#0, byPlayer#0))
        {
            ...
            if (Shared.Pos.row(Shared.Piece.at(king#0)) != LitInt(7))
            {
                ...
                assume Shared.Piece.Piece_q(king#0);
                assume Shared.Pos.Pos_q(Shared.Piece.at(king#0));
                assert {:id "id37"} $Is(#Shared.Pos.Pos(Shared.Pos.row(Shared.Piece.at(king#0)) + 1, 
                    Shared.Pos.col(Shared.Piece.at(king#0))), 
                  Tclass.Shared.ChessPos());
              ...
              byPlayer#0)))
        {
               ...
               || Shared.Pos.col(Shared.Piece.at(king#0)) == LitInt(0)))
            {
                ...
                assume Shared.Piece.Piece_q(king#0);
                assume Shared.Pos.Pos_q(Shared.Piece.at(king#0));
                assert {:id "id38"} $Is(#Shared.Pos.Pos(Shared.Pos.row(Shared.Piece.at(king#0)) - 1, 
                    Shared.Pos.col(Shared.Piece.at(king#0)) - 1), 
                  Tclass.Shared.ChessPos());
              ...
              byPlayer#0)))
        {
            ...
            if (Shared.Pos.col(Shared.Piece.at(king#0)) != LitInt(0))
            {
                ...
                assume Shared.Piece.Piece_q(king#0);
                assume Shared.Pos.Pos_q(Shared.Piece.at(king#0));
                assert {:id "id39"} $Is(#Shared.Pos.Pos(Shared.Pos.row(Shared.Piece.at(king#0)), 
                    Shared.Pos.col(Shared.Piece.at(king#0)) - 1), 
                  Tclass.Shared.ChessPos());
              ...
              byPlayer#0)))
        {
               ...
               || Shared.Pos.col(Shared.Piece.at(king#0)) == LitInt(0)))
            {
                ...
                assume Shared.Piece.Piece_q(king#0);
                assume Shared.Pos.Pos_q(Shared.Piece.at(king#0));
                assert {:id "id40"} $Is(#Shared.Pos.Pos(Shared.Pos.row(Shared.Piece.at(king#0)) + 1, 
                    Shared.Pos.col(Shared.Piece.at(king#0)) - 1), 
                  Tclass.Shared.ChessPos());
        ...
        assume {:id "id41"} Chess.__default.CheckmatedByPlayer(board#0, king#0, byPlayer#0)
           == (
            (
              Shared.Pos.row(Shared.Piece.at(king#0)) == LitInt(0)
               || Shared.Pos.col(Shared.Piece.at(king#0)) == LitInt(7)
...
procedure {:verboseName "Chess.Describe (call)"} {:testEntry} Call$$Chess.__default.Describe(board#0: DatatypeType
  ...
  requires {:id "id43"} Chess.__default.BoardPreset#canCall(board#0)
     ==> Chess.__default.BoardPreset(board#0)
       || Seq#Length(Shared.Board.pieces(board#0)) == LitInt(5);
  requires {:id "id44"} Chess.__default.BoardPreset#canCall(board#0)
     ==> Chess.__default.BoardPreset(board#0)
       || Shared.PieceKind#Equal(Shared.Piece.kind($Unbox(Seq#Index(Shared.Board.pieces(board#0), LitInt(0))): DatatypeType), 
        #Shared.PieceKind.King(Lit(#Shared.Color.White())));
  requires {:id "id45"} Chess.__default.BoardPreset#canCall(board#0)
     ==> Chess.__default.BoardPreset(board#0)
       || Shared.PieceKind#Equal(Shared.Piece.kind($Unbox(Seq#Index(Shared.Board.pieces(board#0), LitInt(1))): DatatypeType), 
        #Shared.PieceKind.Knight(Lit(#Shared.Color.Black())));
  requires {:id "id46"} Chess.__default.BoardPreset#canCall(board#0)
     ==> Chess.__default.BoardPreset(board#0)
       || Shared.PieceKind#Equal(Shared.Piece.kind($Unbox(Seq#Index(Shared.Board.pieces(board#0), LitInt(2))): DatatypeType), 
        #Shared.PieceKind.Knight(Lit(#Shared.Color.Black())));
  requires {:id "id47"} Chess.__default.BoardPreset#canCall(board#0)
     ==> Chess.__default.BoardPreset(board#0)
       || Shared.PieceKind#Equal(Shared.Piece.kind($Unbox(Seq#Index(Shared.Board.pieces(board#0), LitInt(3))): DatatypeType), 
        #Shared.PieceKind.Pawn(Lit(#Shared.Color.Black())));
  requires {:id "id48"} Chess.__default.BoardPreset#canCall(board#0)
     ==> Chess.__default.BoardPreset(board#0)
       || Shared.PieceKind#Equal(Shared.Piece.kind($Unbox(Seq#Index(Shared.Board.pieces(board#0), LitInt(4))): DatatypeType), 
        #Shared.PieceKind.Pawn(Lit(#Shared.Color.Black())));
  modifies $Heap;
...
procedure {:verboseName "Chess.Describe (correctness)"} {:testEntry} Impl$$Chess.__default.Describe(board#0: DatatypeType
  ...
  free requires 6 == $FunctionContextHeight;
  // user-defined preconditions
  free requires {:id "id49"} Chess.__default.BoardPreset#canCall(board#0)
     && 
    Chess.__default.BoardPreset(board#0)
     && 
    Seq#Length(Shared.Board.pieces(board#0)) == LitInt(5)
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Chess.Describe (correctness)"} {:testEntry} Impl$$Chess.__default.Describe(board#0: DatatypeType) returns ($_reverifyPost: bool)
{
  ...
  var board##0: DatatypeType;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/blogposts/TestGenerationWithInliningQuantifiedDefinitions.dfy(63,19)
    assume true;
    assume Shared.Board.Board_q(board#0);
    assert {:id "id50"} 0 <= LitInt(0) && LitInt(0) < Seq#Length(Shared.Board.pieces(board#0));
    assume Shared.Board.Board_q(board#0);
    whiteKing#0 := $Unbox(Seq#Index(Shared.Board.pieces(board#0), LitInt(0))): DatatypeType;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/blogposts/TestGenerationWithInliningQuantifiedDefinitions.dfy(64,5)
    assume true;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/blogposts/TestGenerationWithInliningQuantifiedDefinitions.dfy(65,5)
    ##board#1 := board#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##board#1, Tclass.Chess.ValidBoard(), $Heap);
    ##king#0 := whiteKing#0;
    ...
    {
        push;
        // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/blogposts/TestGenerationWithInliningQuantifiedDefinitions.dfy(66,7)
        assume true;
        pop;
    }
    else
    {
        push;
        // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/blogposts/TestGenerationWithInliningQuantifiedDefinitions.dfy(68,7)
        assume true;
        pop;
    }

    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/blogposts/TestGenerationWithInliningQuantifiedDefinitions.dfy(70,5)
    ##board#2 := board#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##board#2, Tclass.Chess.ValidBoard(), $Heap);
    ##king#1 := whiteKing#0;
    ...
    {
        push;
        // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/blogposts/TestGenerationWithInliningQuantifiedDefinitions.dfy(71,7)
        assume true;
        pop;
    }
    else
    {
        push;
        // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/blogposts/TestGenerationWithInliningQuantifiedDefinitions.dfy(73,7)
        assume true;
        pop;
    }

    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/blogposts/TestGenerationWithInliningQuantifiedDefinitions.dfy(75,10)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    board##0 := board#0;
    call {:id "id52"} Call$$Chess.__default.Debug(board##0);
    // TrCallStmt: After ProcessCallStmt
}



procedure {:verboseName "Chess.Debug (well-formedness)"} CheckWellFormed$$Chess.__default.Debug(board#0: DatatypeType
       where $Is(board#0, Tclass.Chess.ValidBoard())
         && $IsAlloc(board#0, Tclass.Chess.ValidBoard(), $Heap)
         && $IsA#Shared.Board(board#0));
  free requires 4 == $FunctionContextHeight;
...
procedure {:verboseName "Chess.Debug (call)"} Call$$Chess.__default.Debug(board#0: DatatypeType
       where $Is(board#0, Tclass.Chess.ValidBoard())
         && $IsAlloc(board#0, Tclass.Chess.ValidBoard(), $Heap)
         && $IsA#Shared.Board(board#0));
  // user-defined preconditions
  requires {:id "id54"} Chess.__default.BoardPreset#canCall(board#0)
     ==> Chess.__default.BoardPreset(board#0)
       || Seq#Length(Shared.Board.pieces(board#0)) == LitInt(5);
  requires {:id "id55"} Chess.__default.BoardPreset#canCall(board#0)
     ==> Chess.__default.BoardPreset(board#0)
       || Shared.PieceKind#Equal(Shared.Piece.kind($Unbox(Seq#Index(Shared.Board.pieces(board#0), LitInt(0))): DatatypeType), 
        #Shared.PieceKind.King(Lit(#Shared.Color.White())));
  requires {:id "id56"} Chess.__default.BoardPreset#canCall(board#0)
     ==> Chess.__default.BoardPreset(board#0)
       || Shared.PieceKind#Equal(Shared.Piece.kind($Unbox(Seq#Index(Shared.Board.pieces(board#0), LitInt(1))): DatatypeType), 
        #Shared.PieceKind.Knight(Lit(#Shared.Color.Black())));
  requires {:id "id57"} Chess.__default.BoardPreset#canCall(board#0)
     ==> Chess.__default.BoardPreset(board#0)
       || Shared.PieceKind#Equal(Shared.Piece.kind($Unbox(Seq#Index(Shared.Board.pieces(board#0), LitInt(2))): DatatypeType), 
        #Shared.PieceKind.Knight(Lit(#Shared.Color.Black())));
  requires {:id "id58"} Chess.__default.BoardPreset#canCall(board#0)
     ==> Chess.__default.BoardPreset(board#0)
       || Shared.PieceKind#Equal(Shared.Piece.kind($Unbox(Seq#Index(Shared.Board.pieces(board#0), LitInt(3))): DatatypeType), 
        #Shared.PieceKind.Pawn(Lit(#Shared.Color.Black())));
  requires {:id "id59"} Chess.__default.BoardPreset#canCall(board#0)
     ==> Chess.__default.BoardPreset(board#0)
       || Shared.PieceKind#Equal(Shared.Piece.kind($Unbox(Seq#Index(Shared.Board.pieces(board#0), LitInt(4))): DatatypeType), 
        #Shared.PieceKind.Pawn(Lit(#Shared.Color.Black())));
  modifies $Heap;
...
procedure {:verboseName "Chess.Debug (correctness)"} Impl$$Chess.__default.Debug(board#0: DatatypeType
       where $Is(board#0, Tclass.Chess.ValidBoard())
         && $IsAlloc(board#0, Tclass.Chess.ValidBoard(), $Heap)
         && $IsA#Shared.Board(board#0))
   returns ($_reverifyPost: bool);
  free requires 4 == $FunctionContextHeight;
  // user-defined preconditions
  free requires {:id "id60"} Chess.__default.BoardPreset#canCall(board#0)
     && 
    Chess.__default.BoardPreset(board#0)
     && 
    Seq#Length(Shared.Board.pieces(board#0)) == LitInt(5)
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Chess.Debug (correctness)"} Impl$$Chess.__default.Debug(board#0: DatatypeType) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var whiteKing#0: DatatypeType
     where $Is(whiteKing#0, Tclass.Shared.Piece())
  ...
  var ##king#0: DatatypeType;
  var ##byPiece#0: DatatypeType;
  var ##board#1_0: DatatypeType;
  var ##king#1_0: DatatypeType;
  var ##byPiece#1_0: DatatypeType;

    // AddMethodImpl: Debug, Impl$$Chess.__default.Debug
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/blogposts/TestGenerationWithInliningQuantifiedDefinitions.dfy(81,19)
    assume true;
    assume Shared.Board.Board_q(board#0);
    assert {:id "id61"} 0 <= LitInt(0) && LitInt(0) < Seq#Length(Shared.Board.pieces(board#0));
    assume Shared.Board.Board_q(board#0);
    whiteKing#0 := $Unbox(Seq#Index(Shared.Board.pieces(board#0), LitInt(0))): DatatypeType;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/blogposts/TestGenerationWithInliningQuantifiedDefinitions.dfy(82,5)
    ##board#1 := board#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##board#1, Tclass.Chess.ValidBoard(), $Heap);
    ##king#0 := whiteKing#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##king#0, Tclass.Shared.Piece(), $Heap);
    ##byPiece#0 := Lit(#Shared.PieceKind.Knight(Lit(#Shared.Color.Black())));
    // assume allocatedness for argument to function
    assume $IsAlloc(##byPiece#0, Tclass.Shared.PieceKind(), $Heap);
    assume Chess.__default.CheckedByPiece#canCall(board#0, whiteKing#0, Lit(#Shared.PieceKind.Knight(Lit(#Shared.Color.Black()))));
    assume Chess.__default.CheckedByPiece#canCall(board#0, whiteKing#0, Lit(#Shared.PieceKind.Knight(Lit(#Shared.Color.Black()))));
    if (Chess.__default.CheckedByPiece(board#0, whiteKing#0, Lit(#Shared.PieceKind.Knight(Lit(#Shared.Color.Black())))))
    {
        // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/blogposts/TestGenerationWithInliningQuantifiedDefinitions.dfy(83,7)
        assume true;
    }
    else
    {
        // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/blogposts/TestGenerationWithInliningQuantifiedDefinitions.dfy(84,12)
        ##board#1_0 := board#0;
        // assume allocatedness for argument to function
        assume $IsAlloc(##board#1_0, Tclass.Chess.ValidBoard(), $Heap);
        ##king#1_0 := whiteKing#0;
        // assume allocatedness for argument to function
        assume $IsAlloc(##king#1_0, Tclass.Shared.Piece(), $Heap);
        ##byPiece#1_0 := Lit(#Shared.PieceKind.Pawn(Lit(#Shared.Color.Black())));
        // assume allocatedness for argument to function
        assume $IsAlloc(##byPiece#1_0, Tclass.Shared.PieceKind(), $Heap);
        assume Chess.__default.CheckedByPiece#canCall(board#0, whiteKing#0, Lit(#Shared.PieceKind.Pawn(Lit(#Shared.Color.Black()))));
        assume Chess.__default.CheckedByPiece#canCall(board#0, whiteKing#0, Lit(#Shared.PieceKind.Pawn(Lit(#Shared.Color.Black()))));
        if (Chess.__default.CheckedByPiece(board#0, whiteKing#0, Lit(#Shared.PieceKind.Pawn(Lit(#Shared.Color.Black())))))
        {
            // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/blogposts/TestGenerationWithInliningQuantifiedDefinitions.dfy(85,7)
            assume true;
        }
        else
        {
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Chess.ValidBoard (well-formedness)"} CheckWellFormed$$Chess.ValidBoard(board#0: DatatypeType)
{
  ...
  var ##board#0: DatatypeType;
    ...
    if (*)
    {
        ...
        assume {:id "id63"} Chess.__default.BoardIsValid(board#0);
        assume false;
    }
    ...
    if (*)
    {
        ...
        assume Chess.__default.BoardIsValid#canCall(Lit(#Shared.Board.Board(Lit(Seq#Empty(): Seq))));
        assert {:id "id64"} {:subsumption 0} Chess.__default.BoardIsValid#canCall(Lit(#Shared.Board.Board(Lit(Seq#Empty(): Seq))))
           ==> Lit(Chess.__default.BoardIsValid(Lit(#Shared.Board.Board(Lit(Seq#Empty(): Seq)))))
             || (forall i#0: int, j#0: int :: 
              { $Unbox(Seq#Index(Shared.Board.pieces(#Shared.Board.Board(Seq#Empty(): Seq)), j#0)): DatatypeType, $Unbox(Seq#Index(Shared.Board.pieces(#Shared.Board.Board(Seq#Empty(): Seq)), i#0)): DatatypeType } 
              LitInt(0) <= i#0 && LitInt(0) <= j#0
                 ==> 
                LitInt(0) <= i#0
                   && i#0 < j#0
                   && j#0
                     < Seq#Length(Lit(Shared.Board.pieces(Lit(#Shared.Board.Board(Lit(Seq#Empty(): Seq))))))
                 ==> !Shared.Pos#Equal(Shared.Piece.at($Unbox(Seq#Index(Lit(Shared.Board.pieces(Lit(#Shared.Board.Board(Lit(Seq#Empty(): Seq))))), i#0)): DatatypeType), 
                  Shared.Piece.at($Unbox(Seq#Index(Lit(Shared.Board.pieces(Lit(#Shared.Board.Board(Lit(Seq#Empty(): Seq))))), j#0)): DatatypeType)));
        assume false;
    }
}
...
axiom {:id "id67"} (forall this: DatatypeType, pos#0: DatatypeType :: 
...
axiom {:id "id68"} (forall this: DatatypeType, pos#0: DatatypeType :: 
