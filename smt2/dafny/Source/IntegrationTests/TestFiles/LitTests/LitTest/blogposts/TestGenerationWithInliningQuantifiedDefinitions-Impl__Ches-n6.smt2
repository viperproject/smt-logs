...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|board#0@@2| T@U) ) (!  (=> (or (|Chess.__default.BoardIsValid#canCall| (Lit DatatypeTypeType |board#0@@2|)) (and (< 0 $FunctionContextHeight) ($Is DatatypeTypeType |board#0@@2| Tclass.Shared.Board))) (and (forall ((|i#1| Int) (|j#1| Int) ) (!  (=> (and (<= (LitInt 0) |i#1|) (<= (LitInt 0) |j#1|)) (=> (<= (LitInt 0) |i#1|) (=> (< |i#1| |j#1|) (and (Shared.Board.Board_q (Lit DatatypeTypeType |board#0@@2|)) (=> (< |j#1| (|Seq#Length| (Lit SeqType (Shared.Board.pieces (Lit DatatypeTypeType |board#0@@2|))))) (and (and (|$IsA#Shared.Pos| (Shared.Piece.at ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (Shared.Board.pieces (Lit DatatypeTypeType |board#0@@2|))) |i#1|)))) (|$IsA#Shared.Pos| (Shared.Piece.at ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (Shared.Board.pieces (Lit DatatypeTypeType |board#0@@2|))) |j#1|))))) (and (and (Shared.Board.Board_q (Lit DatatypeTypeType |board#0@@2|)) (Shared.Piece.Piece_q ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (Shared.Board.pieces (Lit DatatypeTypeType |board#0@@2|))) |i#1|)))) (and (Shared.Board.Board_q (Lit DatatypeTypeType |board#0@@2|)) (Shared.Piece.Piece_q ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (Shared.Board.pieces (Lit DatatypeTypeType |board#0@@2|))) |j#1|)))))))))))
 :qid |TestGenerationWithInliningQuantifiedDefinitionsdfy.18:12|
 :skolemid |539|
 :pattern ( ($Unbox DatatypeTypeType (|Seq#Index| (Shared.Board.pieces |board#0@@2|) |j#1|)) ($Unbox DatatypeTypeType (|Seq#Index| (Shared.Board.pieces |board#0@@2|) |i#1|)))
)) (= (Chess.__default.BoardIsValid (Lit DatatypeTypeType |board#0@@2|)) (forall ((|i#1@@0| Int) (|j#1@@0| Int) ) (!  (=> (and (<= (LitInt 0) |i#1@@0|) (<= (LitInt 0) |j#1@@0|)) (=> (and (and (<= (LitInt 0) |i#1@@0|) (< |i#1@@0| |j#1@@0|)) (< |j#1@@0| (|Seq#Length| (Lit SeqType (Shared.Board.pieces (Lit DatatypeTypeType |board#0@@2|)))))) (not (|Shared.Pos#Equal| (Shared.Piece.at ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (Shared.Board.pieces (Lit DatatypeTypeType |board#0@@2|))) |i#1@@0|))) (Shared.Piece.at ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (Shared.Board.pieces (Lit DatatypeTypeType |board#0@@2|))) |j#1@@0|)))))))
 :qid |TestGenerationWithInliningQuantifiedDefinitionsdfy.18:12|
 :skolemid |538|
 :pattern ( ($Unbox DatatypeTypeType (|Seq#Index| (Shared.Board.pieces |board#0@@2|) |j#1@@0|)) ($Unbox DatatypeTypeType (|Seq#Index| (Shared.Board.pieces |board#0@@2|) |i#1@@0|)))
)))))
 :qid |TestGenerationWithInliningQuantifiedDefinitionsdfy.17:26|
 :weight 3
 :skolemid |540|
 :pattern ( (Chess.__default.BoardIsValid (Lit DatatypeTypeType |board#0@@2|)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|board#0@@4| T@U) ) (!  (=> (or (|Chess.__default.BoardIsValid#canCall| |board#0@@4|) (and (< 0 $FunctionContextHeight) ($Is DatatypeTypeType |board#0@@4| Tclass.Shared.Board))) (and (forall ((|i#0@@1| Int) (|j#0| Int) ) (!  (=> (and (<= (LitInt 0) |i#0@@1|) (<= (LitInt 0) |j#0|)) (=> (<= (LitInt 0) |i#0@@1|) (=> (< |i#0@@1| |j#0|) (and (Shared.Board.Board_q |board#0@@4|) (=> (< |j#0| (|Seq#Length| (Shared.Board.pieces |board#0@@4|))) (and (and (|$IsA#Shared.Pos| (Shared.Piece.at ($Unbox DatatypeTypeType (|Seq#Index| (Shared.Board.pieces |board#0@@4|) |i#0@@1|)))) (|$IsA#Shared.Pos| (Shared.Piece.at ($Unbox DatatypeTypeType (|Seq#Index| (Shared.Board.pieces |board#0@@4|) |j#0|))))) (and (and (Shared.Board.Board_q |board#0@@4|) (Shared.Piece.Piece_q ($Unbox DatatypeTypeType (|Seq#Index| (Shared.Board.pieces |board#0@@4|) |i#0@@1|)))) (and (Shared.Board.Board_q |board#0@@4|) (Shared.Piece.Piece_q ($Unbox DatatypeTypeType (|Seq#Index| (Shared.Board.pieces |board#0@@4|) |j#0|)))))))))))
 :qid |TestGenerationWithInliningQuantifiedDefinitionsdfy.18:12|
 :skolemid |536|
 :pattern ( ($Unbox DatatypeTypeType (|Seq#Index| (Shared.Board.pieces |board#0@@4|) |j#0|)) ($Unbox DatatypeTypeType (|Seq#Index| (Shared.Board.pieces |board#0@@4|) |i#0@@1|)))
)) (= (Chess.__default.BoardIsValid |board#0@@4|) (forall ((|i#0@@2| Int) (|j#0@@0| Int) ) (!  (=> (and (<= (LitInt 0) |i#0@@2|) (<= (LitInt 0) |j#0@@0|)) (=> (and (and (<= (LitInt 0) |i#0@@2|) (< |i#0@@2| |j#0@@0|)) (< |j#0@@0| (|Seq#Length| (Shared.Board.pieces |board#0@@4|)))) (not (|Shared.Pos#Equal| (Shared.Piece.at ($Unbox DatatypeTypeType (|Seq#Index| (Shared.Board.pieces |board#0@@4|) |i#0@@2|))) (Shared.Piece.at ($Unbox DatatypeTypeType (|Seq#Index| (Shared.Board.pieces |board#0@@4|) |j#0@@0|)))))))
 :qid |TestGenerationWithInliningQuantifiedDefinitionsdfy.18:12|
 :skolemid |535|
 :pattern ( ($Unbox DatatypeTypeType (|Seq#Index| (Shared.Board.pieces |board#0@@4|) |j#0@@0|)) ($Unbox DatatypeTypeType (|Seq#Index| (Shared.Board.pieces |board#0@@4|) |i#0@@2|)))
)))))
 :qid |TestGenerationWithInliningQuantifiedDefinitionsdfy.17:26|
 :skolemid |537|
 :pattern ( (Chess.__default.BoardIsValid |board#0@@4|))
))))
...
(assert (forall ((|board#0@@5| T@U) ) (! (= ($Is DatatypeTypeType |board#0@@5| Tclass.Chess.ValidBoard)  (and ($Is DatatypeTypeType |board#0@@5| Tclass.Shared.Board) (Chess.__default.BoardIsValid |board#0@@5|)))
 :qid |unknown.0:0|
 :skolemid |597|
 :pattern ( ($Is DatatypeTypeType |board#0@@5| Tclass.Chess.ValidBoard))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|board#0@@6| T@U) (|king#0@@0| T@U) (|byPiece#0@@0| T@U) ) (!  (=> (or (|Chess.__default.CheckedByPiece#canCall| (Lit DatatypeTypeType |board#0@@6|) (Lit DatatypeTypeType |king#0@@0|) (Lit DatatypeTypeType |byPiece#0@@0|)) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |board#0@@6| Tclass.Chess.ValidBoard) ($Is DatatypeTypeType |king#0@@0| Tclass.Shared.Piece)) ($Is DatatypeTypeType |byPiece#0@@0| Tclass.Shared.PieceKind)))) (and (forall ((|i#1@@1| Int) ) (!  (=> (<= (LitInt 0) |i#1@@1|) (and (Shared.Board.Board_q (Lit DatatypeTypeType |board#0@@6|)) (=> (< |i#1@@1| (|Seq#Length| (Lit SeqType (Shared.Board.pieces (Lit DatatypeTypeType |board#0@@6|))))) (and (and (and (|$IsA#Shared.PieceKind| (Shared.Piece.kind ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (Shared.Board.pieces (Lit DatatypeTypeType |board#0@@6|))) |i#1@@1|)))) (|$IsA#Shared.PieceKind| (Lit DatatypeTypeType |byPiece#0@@0|))) (and (Shared.Board.Board_q (Lit DatatypeTypeType |board#0@@6|)) (Shared.Piece.Piece_q ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (Shared.Board.pieces (Lit DatatypeTypeType |board#0@@6|))) |i#1@@1|))))) (=> (|Shared.PieceKind#Equal| (Shared.Piece.kind ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (Shared.Board.pieces (Lit DatatypeTypeType |board#0@@6|))) |i#1@@1|))) |byPiece#0@@0|) (and (and (Shared.Board.Board_q (Lit DatatypeTypeType |board#0@@6|)) (Shared.Piece.Piece_q (Lit DatatypeTypeType |king#0@@0|))) (|Shared.Piece.Attacks#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (Shared.Board.pieces (Lit DatatypeTypeType |board#0@@6|))) |i#1@@1|)) (Lit DatatypeTypeType (Shared.Piece.at (Lit DatatypeTypeType |king#0@@0|))))))))))
 :qid |TestGenerationWithInliningQuantifiedDefinitionsdfy.28:12|
 :skolemid |560|
 :pattern ( ($Unbox DatatypeTypeType (|Seq#Index| (Shared.Board.pieces |board#0@@6|) |i#1@@1|)))
)) (= (Chess.__default.CheckedByPiece (Lit DatatypeTypeType |board#0@@6|) (Lit DatatypeTypeType |king#0@@0|) (Lit DatatypeTypeType |byPiece#0@@0|)) (exists ((|i#1@@2| Int) ) (!  (and (and (and (<= (LitInt 0) |i#1@@2|) (< |i#1@@2| (|Seq#Length| (Lit SeqType (Shared.Board.pieces (Lit DatatypeTypeType |board#0@@6|)))))) (|Shared.PieceKind#Equal| (Shared.Piece.kind ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (Shared.Board.pieces (Lit DatatypeTypeType |board#0@@6|))) |i#1@@2|))) |byPiece#0@@0|)) (Shared.Piece.Attacks ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (Shared.Board.pieces (Lit DatatypeTypeType |board#0@@6|))) |i#1@@2|)) (Lit DatatypeTypeType (Shared.Piece.at (Lit DatatypeTypeType |king#0@@0|)))))
 :qid |TestGenerationWithInliningQuantifiedDefinitionsdfy.28:12|
 :skolemid |559|
 :pattern ( ($Unbox DatatypeTypeType (|Seq#Index| (Shared.Board.pieces |board#0@@6|) |i#1@@2|)))
)))))
 :qid |TestGenerationWithInliningQuantifiedDefinitionsdfy.27:28|
 :weight 3
 :skolemid |561|
 :pattern ( (Chess.__default.CheckedByPiece (Lit DatatypeTypeType |board#0@@6|) (Lit DatatypeTypeType |king#0@@0|) (Lit DatatypeTypeType |byPiece#0@@0|)))
))))
...
(declare-fun |board#0@@7| () T@U)
(declare-fun |whiteKing#0@0| () T@U)
(declare-fun $Heap () T@U)
(declare-fun |##byPiece#1_0@0| () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun |##byPiece#0@0| () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |whiteKing#0| () T@U)
(set-info :boogie-vc-id Impl$$Chess.__default.Debug)
...
(let ((anon5_Else_correct  (=> (not (Chess.__default.CheckedByPiece |board#0@@7| |whiteKing#0@0| (Lit DatatypeTypeType (|#Shared.PieceKind.Knight| (Lit DatatypeTypeType |#Shared.Color.Black|))))) (=> (and ($IsAlloc DatatypeTypeType |board#0@@7| Tclass.Chess.ValidBoard $Heap) ($IsAlloc DatatypeTypeType |whiteKing#0@0| Tclass.Shared.Piece $Heap)) (=> (and (and (= |##byPiece#1_0@0| (Lit DatatypeTypeType (|#Shared.PieceKind.Pawn| (Lit DatatypeTypeType |#Shared.Color.Black|)))) ($IsAlloc DatatypeTypeType |##byPiece#1_0@0| Tclass.Shared.PieceKind $Heap)) (and (|Chess.__default.CheckedByPiece#canCall| |board#0@@7| |whiteKing#0@0| (Lit DatatypeTypeType (|#Shared.PieceKind.Pawn| (Lit DatatypeTypeType |#Shared.Color.Black|)))) (|Chess.__default.CheckedByPiece#canCall| |board#0@@7| |whiteKing#0@0| (Lit DatatypeTypeType (|#Shared.PieceKind.Pawn| (Lit DatatypeTypeType |#Shared.Color.Black|)))))) (and (=> (= (ControlFlow 0 4) 2) anon6_Then_correct) (=> (= (ControlFlow 0 4) 3) anon6_Else_correct)))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (Shared.Board.Board_q |board#0@@7|)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| (Shared.Board.pieces |board#0@@7|))))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| (Shared.Board.pieces |board#0@@7|)))) (=> (and (and (and (Shared.Board.Board_q |board#0@@7|) (= |whiteKing#0@0| ($Unbox DatatypeTypeType (|Seq#Index| (Shared.Board.pieces |board#0@@7|) (LitInt 0))))) (and ($IsAlloc DatatypeTypeType |board#0@@7| Tclass.Chess.ValidBoard $Heap) ($IsAlloc DatatypeTypeType |whiteKing#0@0| Tclass.Shared.Piece $Heap))) (and (and (= |##byPiece#0@0| (Lit DatatypeTypeType (|#Shared.PieceKind.Knight| (Lit DatatypeTypeType |#Shared.Color.Black|)))) ($IsAlloc DatatypeTypeType |##byPiece#0@0| Tclass.Shared.PieceKind $Heap)) (and (|Chess.__default.CheckedByPiece#canCall| |board#0@@7| |whiteKing#0@0| (Lit DatatypeTypeType (|#Shared.PieceKind.Knight| (Lit DatatypeTypeType |#Shared.Color.Black|)))) (|Chess.__default.CheckedByPiece#canCall| |board#0@@7| |whiteKing#0@0| (Lit DatatypeTypeType (|#Shared.PieceKind.Knight| (Lit DatatypeTypeType |#Shared.Color.Black|))))))) (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 4) anon5_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |board#0@@7| Tclass.Chess.ValidBoard) ($IsAlloc DatatypeTypeType |board#0@@7| Tclass.Chess.ValidBoard $Heap)) (|$IsA#Shared.Board| |board#0@@7|)) (=> (and (and (and (and ($Is DatatypeTypeType |whiteKing#0| Tclass.Shared.Piece) ($IsAlloc DatatypeTypeType |whiteKing#0| Tclass.Shared.Piece $Heap)) true) (= 4 $FunctionContextHeight)) (and (and (|Chess.__default.BoardPreset#canCall| |board#0@@7|) (and (Chess.__default.BoardPreset |board#0@@7|) (and (and (and (and (and (= (|Seq#Length| (Shared.Board.pieces |board#0@@7|)) (LitInt 5)) (|Shared.PieceKind#Equal| (Shared.Piece.kind ($Unbox DatatypeTypeType (|Seq#Index| (Shared.Board.pieces |board#0@@7|) (LitInt 0)))) (|#Shared.PieceKind.King| (Lit DatatypeTypeType |#Shared.Color.White|)))) (|Shared.PieceKind#Equal| (Shared.Piece.kind ($Unbox DatatypeTypeType (|Seq#Index| (Shared.Board.pieces |board#0@@7|) (LitInt 1)))) (|#Shared.PieceKind.Knight| (Lit DatatypeTypeType |#Shared.Color.Black|)))) (|Shared.PieceKind#Equal| (Shared.Piece.kind ($Unbox DatatypeTypeType (|Seq#Index| (Shared.Board.pieces |board#0@@7|) (LitInt 2)))) (|#Shared.PieceKind.Knight| (Lit DatatypeTypeType |#Shared.Color.Black|)))) (|Shared.PieceKind#Equal| (Shared.Piece.kind ($Unbox DatatypeTypeType (|Seq#Index| (Shared.Board.pieces |board#0@@7|) (LitInt 3)))) (|#Shared.PieceKind.Pawn| (Lit DatatypeTypeType |#Shared.Color.Black|)))) (|Shared.PieceKind#Equal| (Shared.Piece.kind ($Unbox DatatypeTypeType (|Seq#Index| (Shared.Board.pieces |board#0@@7|) (LitInt 4)))) (|#Shared.PieceKind.Pawn| (Lit DatatypeTypeType |#Shared.Color.Black|)))))) (= (ControlFlow 0 7) 5))) anon0_correct)))))
