...
(assert (distinct TChar TagChar TagSeq alloc Tagclass._module.Option |##_module.Option.None| |##_module.Option.Some| tytagFamily$Option)
)
...
(assert (forall ((d@@2 T@U) ) (!  (=> (_module.Option.Some_q d@@2) (exists ((|a#5#0#0| T@U) ) (! (= d@@2 (|#_module.Option.Some| |a#5#0#0|))
 :qid |VerificationErrorsdfy.4:34|
 :skolemid |491|
)))
 :qid |unknown.0:0|
 :skolemid |492|
...
(assert (forall ((_module.Option$T@@3 T@U) (d@@4 T@U) ) (!  (=> ($Is DatatypeTypeType d@@4 (Tclass._module.Option _module.Option$T@@3)) (or (_module.Option.None_q d@@4) (_module.Option.Some_q d@@4)))
 :qid |unknown.0:0|
 :skolemid |500|
 :pattern ( (_module.Option.Some_q d@@4) ($Is DatatypeTypeType d@@4 (Tclass._module.Option _module.Option$T@@3)))
 :pattern ( (_module.Option.None_q d@@4) ($Is DatatypeTypeType d@@4 (Tclass._module.Option _module.Option$T@@3)))
)))
...
(assert (forall ((d@@5 T@U) (_module.Option$T@@6 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.Option.Some_q d@@5) ($IsAlloc DatatypeTypeType d@@5 (Tclass._module.Option _module.Option$T@@6) $h@@1))) ($IsAllocBox (_module.Option.get d@@5) _module.Option$T@@6 $h@@1))
 :qid |unknown.0:0|
 :skolemid |495|
 :pattern ( ($IsAllocBox (_module.Option.get d@@5) _module.Option$T@@6 $h@@1))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.CheckThatMessageIsVerifiedAssumingExpectFails)
...
(let ((anon5_Then_correct  (=> (and (not (_module.Option.Some_q |x#0|)) (= (ControlFlow 0 4) (- 0 3))) (_module.Option.Some_q |x#0|))))
(let ((anon4_Else_correct  (=> (_module.Option.None_q |x#0|) (and (=> (= (ControlFlow 0 6) 4) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct)))))
(let ((anon4_Then_correct  (=> (and (not (_module.Option.None_q |x#0|)) (= (ControlFlow 0 2) (- 0 1))) (_module.Option.Some_q |x#0|))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |x#0| (Tclass._module.Option (TSeq TChar))) ($IsAlloc DatatypeTypeType |x#0| (Tclass._module.Option (TSeq TChar)) $Heap)) (|$IsA#_module.Option| |x#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
