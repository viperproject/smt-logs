// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/expectations/VerificationErrors.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/expectations/VerificationErrors-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/expectations/VerificationErrors.dfy
...
procedure {:verboseName "CheckThatMessageIsVerifiedAssumingExpectFails (well-formedness)"} CheckWellFormed$$_module.__default.CheckThatMessageIsVerifiedAssumingExpectFails(x#0: DatatypeType
       where $Is(x#0, Tclass._module.Option(TSeq(TChar)))
         && $IsAlloc(x#0, Tclass._module.Option(TSeq(TChar)), $Heap)
...
procedure {:verboseName "CheckThatMessageIsVerifiedAssumingExpectFails (call)"} Call$$_module.__default.CheckThatMessageIsVerifiedAssumingExpectFails(x#0: DatatypeType
       where $Is(x#0, Tclass._module.Option(TSeq(TChar)))
         && $IsAlloc(x#0, Tclass._module.Option(TSeq(TChar)), $Heap)
         && $IsA#_module.Option(x#0));
  modifies $Heap;
...
procedure {:verboseName "CheckThatMessageIsVerifiedAssumingExpectFails (correctness)"} Impl$$_module.__default.CheckThatMessageIsVerifiedAssumingExpectFails(x#0: DatatypeType
       where $Is(x#0, Tclass._module.Option(TSeq(TChar)))
         && $IsAlloc(x#0, Tclass._module.Option(TSeq(TChar)), $Heap)
         && $IsA#_module.Option(x#0))
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "CheckThatMessageIsVerifiedAssumingExpectFails (correctness)"} Impl$$_module.__default.CheckThatMessageIsVerifiedAssumingExpectFails(x#0: DatatypeType) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;

    // AddMethodImpl: CheckThatMessageIsVerifiedAssumingExpectFails, Impl$$_module.__default.CheckThatMessageIsVerifiedAssumingExpectFails
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- expect statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/expectations/VerificationErrors.dfy(7,5)
    assume true;
    if (!_module.Option.None_q(x#0))
    {
        assert {:id "id0"} _module.Option.Some_q(x#0);
        assume true;
        assume false;
    }

    // ----- expect statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/expectations/VerificationErrors.dfy(8,5)
    assume true;
    if (!_module.Option.Some_q(x#0))
    {
        assert {:id "id1"} _module.Option.Some_q(x#0);
        assume true;
        assume false;
    }
}
