...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@14 T@U) ($f@@0 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#3| |l#0| |l#1| |l#2| |l#3|) $o@@14 $f@@0))  (=> (and (or (not (= $o@@14 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@14) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1015|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#3| |l#0| |l#1| |l#2| |l#3|) $o@@14 $f@@0))
)))
...
(assert (forall ((_module.Map$Key@@19 T@U) (_module.Map$Value@@19 T@U) ($h0@@0 T@U) ($h1@@0 T@U) (this@@1 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 (Tclass._module.Map _module.Map$Key@@19 _module.Map$Value@@19)))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@15 T@U) ($f@@1 T@U) ) (!  (=> (and (or (not (= $o@@15 null)) (not true)) (or (= $o@@15 this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 this@@1) _module.Map.Repr)) ($Box refType $o@@15)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@15) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@0 $o@@15) $f@@1)))
 :qid |unknown.0:0|
 :skolemid |550|
...
(assert (forall ((_module.Map$Key@@20 T@U) (_module.Map$Value@@20 T@U) ($h@@14 T@U) ($o@@16 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@14) (and (or (not (= $o@@16 null)) (not true)) (= (dtype $o@@16) (Tclass._module.Map? _module.Map$Key@@20 _module.Map$Value@@20)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@16) alloc)))) ($IsAlloc MapType ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@16) _module.Map.M)) (TMap _module.Map$Key@@20 _module.Map$Value@@20) $h@@14))
 :qid |unknown.0:0|
 :skolemid |535|
 :pattern ( ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@16) _module.Map.M)) (Tclass._module.Map? _module.Map$Key@@20 _module.Map$Value@@20))
)))
(assert (forall ((_module.Map$Key@@21 T@U) (_module.Map$Value@@21 T@U) ($h@@15 T@U) ($o@@17 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@15) (and (or (not (= $o@@17 null)) (not true)) (= (dtype $o@@17) (Tclass._module.Map? _module.Map$Key@@21 _module.Map$Value@@21)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@17) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@17) _module.Map.head)) (Tclass._module.Node? _module.Map$Key@@21 _module.Map$Value@@21) $h@@15))
 :qid |unknown.0:0|
 :skolemid |543|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@17) _module.Map.head)) (Tclass._module.Map? _module.Map$Key@@21 _module.Map$Value@@21))
)))
(assert (forall ((_module.Node$Key@@16 T@U) (_module.Node$Value@@16 T@U) ($h@@16 T@U) ($o@@18 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@16) (and (or (not (= $o@@18 null)) (not true)) (= (dtype $o@@18) (Tclass._module.Node? _module.Node$Key@@16 _module.Node$Value@@16)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@18) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@18) _module.Node.next)) (Tclass._module.Node? _module.Node$Key@@16 _module.Node$Value@@16) $h@@16))
 :qid |unknown.0:0|
 :skolemid |986|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@18) _module.Node.next)) (Tclass._module.Node? _module.Node$Key@@16 _module.Node$Value@@16))
)))
...
(assert (forall ((v@@7 T@U) (t0@@4 T@U) (t1@@2 T@U) ) (! (= ($Is MapType v@@7 (TMap t0@@4 t1@@2)) (forall ((bx@@12 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@7) bx@@12) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@7) bx@@12) t1@@2) ($IsBox bx@@12 t0@@4)))
...
(assert (= (Tag Tclass._System.object) Tagclass._System.object))
(assert (= (TagFamily Tclass._System.object) tytagFamily$object))
(assert (forall ((_module.Map$Key@@22 T@U) (_module.Map$Value@@22 T@U) ($h@@17 T@U) ($o@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (or (not (= $o@@19 null)) (not true)) (= (dtype $o@@19) (Tclass._module.Map? _module.Map$Key@@22 _module.Map$Value@@22)))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@19) _module.Map.Spine)) (TSet (Tclass._module.Node _module.Map$Key@@22 _module.Map$Value@@22))))
 :qid |unknown.0:0|
 :skolemid |548|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@19) _module.Map.Spine)) (Tclass._module.Map? _module.Map$Key@@22 _module.Map$Value@@22))
)))
(assert (forall ((_module.Node$Key@@17 T@U) (_module.Node$Value@@17 T@U) ($h@@18 T@U) ($o@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (or (not (= $o@@20 null)) (not true)) (= (dtype $o@@20) (Tclass._module.Node? _module.Node$Key@@17 _module.Node$Value@@17)))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@20) _module.Node.Spine)) (TSet (Tclass._module.Node _module.Node$Key@@17 _module.Node$Value@@17))))
 :qid |unknown.0:0|
 :skolemid |987|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@20) _module.Node.Spine)) (Tclass._module.Node? _module.Node$Key@@17 _module.Node$Value@@17))
)))
(assert (forall ((_module.Map$Key@@23 T@U) (_module.Map$Value@@23 T@U) ($h@@19 T@U) ($o@@21 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@19) (and (or (not (= $o@@21 null)) (not true)) (= (dtype $o@@21) (Tclass._module.Map? _module.Map$Key@@23 _module.Map$Value@@23)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@21) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@21) _module.Map.Spine)) (TSet (Tclass._module.Node _module.Map$Key@@23 _module.Map$Value@@23)) $h@@19))
 :qid |unknown.0:0|
 :skolemid |549|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@21) _module.Map.Spine)) (Tclass._module.Map? _module.Map$Key@@23 _module.Map$Value@@23))
)))
(assert (forall ((_module.Node$Key@@18 T@U) (_module.Node$Value@@18 T@U) ($h@@20 T@U) ($o@@22 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@20) (and (or (not (= $o@@22 null)) (not true)) (= (dtype $o@@22) (Tclass._module.Node? _module.Node$Key@@18 _module.Node$Value@@18)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@20 $o@@22) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@20 $o@@22) _module.Node.Spine)) (TSet (Tclass._module.Node _module.Node$Key@@18 _module.Node$Value@@18)) $h@@20))
 :qid |unknown.0:0|
 :skolemid |988|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@20 $o@@22) _module.Node.Spine)) (Tclass._module.Node? _module.Node$Key@@18 _module.Node$Value@@18))
)))
...
(assert (forall ((_module.Map$Key@@24 T@U) (_module.Map$Value@@24 T@U) ($h@@23 T@U) ($o@@23 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@23) (and (or (not (= $o@@23 null)) (not true)) (= (dtype $o@@23) (Tclass._module.Map? _module.Map$Key@@24 _module.Map$Value@@24)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@23 $o@@23) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@23 $o@@23) _module.Map.Repr)) (TSet Tclass._System.object) $h@@23))
 :qid |unknown.0:0|
 :skolemid |537|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@23 $o@@23) _module.Map.Repr)) (Tclass._module.Map? _module.Map$Key@@24 _module.Map$Value@@24))
)))
...
(declare-fun |prev#0@1| () T@U)
(declare-fun |spine#0@2| () T@U)
(declare-fun |$rhs#0_1_1@1| () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 59) (let ((anon16_correct true))
(let ((anon32_Else_correct  (=> (and (not (|Set#IsMember| |spine#0@1| ($Box refType |n#10@0|))) (= (ControlFlow 0 31) 26)) anon16_correct)))
(let ((anon32_Then_correct  (=> (|Set#IsMember| |spine#0@1| ($Box refType |n#10@0|)) (and (=> (= (ControlFlow 0 29) (- 0 30)) (or (not (= |n#10@0| null)) (not true))) (=> (= (ControlFlow 0 29) 26) anon16_correct)))))
(let ((anon31_Then_correct  (=> (and ($Is refType |n#10@0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType |n#10@0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)) (and (=> (= (ControlFlow 0 32) 29) anon32_Then_correct) (=> (= (ControlFlow 0 32) 31) anon32_Else_correct)))))
(let ((anon31_Else_correct  (=> (and (not (and ($Is refType |n#10@0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType |n#10@0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3))) (= (ControlFlow 0 28) 26)) anon16_correct)))
(let ((anon30_Then_correct  (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |key#0|) (and (=> (= (ControlFlow 0 33) 32) anon31_Then_correct) (=> (= (ControlFlow 0 33) 28) anon31_Else_correct)))))
(let ((anon30_Else_correct  (=> (and (not (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |key#0|)) (= (ControlFlow 0 27) 26)) anon16_correct)))
(let ((anon11_correct  (=> (=> (or (not (= |p#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (not true)) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |prev#0@0|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |prev#0@0|) _module.Node.next)) |p#0@0|)) (not (|Set#IsMember| |spine#0@1| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))))) (and (=> (= (ControlFlow 0 34) 33) anon30_Then_correct) (=> (= (ControlFlow 0 34) 27) anon30_Else_correct)))))
(let ((anon29_Else_correct  (=> (and (not (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |prev#0@0|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |prev#0@0|) _module.Node.next)) |p#0@0|))) (= (ControlFlow 0 37) 34)) anon11_correct)))
(let ((anon29_Then_correct  (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |prev#0@0|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |prev#0@0|) _module.Node.next)) |p#0@0|)) (= (ControlFlow 0 36) 34)) anon11_correct)))
(let ((anon28_Else_correct  (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |prev#0@0|))) (and (=> (= (ControlFlow 0 40) 36) anon29_Then_correct) (=> (= (ControlFlow 0 40) 37) anon29_Else_correct)))))
(let ((anon28_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |prev#0@0|)) (and (=> (= (ControlFlow 0 38) (- 0 39)) (or (not (= |prev#0@0| null)) (not true))) (and (=> (= (ControlFlow 0 38) 36) anon29_Then_correct) (=> (= (ControlFlow 0 38) 37) anon29_Else_correct))))))
(let ((anon27_Then_correct  (=> (or (not (= |p#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (not true)) (and (=> (= (ControlFlow 0 41) 38) anon28_Then_correct) (=> (= (ControlFlow 0 41) 40) anon28_Else_correct)))))
(let ((anon27_Else_correct  (=> (and (= |p#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (= (ControlFlow 0 35) 34)) anon11_correct)))
(let ((anon6_correct  (=> (=> (= |p#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (= |prev#0@0| null)) (and (=> (= (ControlFlow 0 42) 41) anon27_Then_correct) (=> (= (ControlFlow 0 42) 35) anon27_Else_correct)))))
(let ((anon26_Else_correct  (=> (and (or (not (= |p#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (not true)) (= (ControlFlow 0 44) 42)) anon6_correct)))
(let ((anon26_Then_correct  (=> (and (= |p#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (= (ControlFlow 0 43) 42)) anon6_correct)))
(let ((anon4_correct  (=> (=> (or (not (= |p#0@0| null)) (not true)) (|Set#IsMember| |spine#0@1| ($Box refType |p#0@0|))) (and (=> (= (ControlFlow 0 45) 43) anon26_Then_correct) (=> (= (ControlFlow 0 45) 44) anon26_Else_correct)))))
(let ((anon25_Else_correct  (=> (and (= |p#0@0| null) (= (ControlFlow 0 47) 45)) anon4_correct)))
(let ((anon25_Then_correct  (=> (and (or (not (= |p#0@0| null)) (not true)) (= (ControlFlow 0 46) 45)) anon4_correct)))
(let ((anon24_Then_correct  (=> (and (not |$w$loop#0@0|) ($IsAlloc SetType |spine#0@1| (TSet (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) $Heap@@3)) (=> (and (and ($IsAlloc refType |p#0@0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3) (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 |spine#0@1| |p#0@0|)) (and (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 |spine#0@1| |p#0@0|) (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 |spine#0@1| |p#0@0|))) (and (=> (= (ControlFlow 0 48) 46) anon25_Then_correct) (=> (= (ControlFlow 0 48) 47) anon25_Else_correct))))))
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 14) (- 0 20)) (=> (= |p#0@1| null) (not (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |key#0|)))) (=> (=> (= |p#0@1| null) (not (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |key#0|))) (and (=> (= (ControlFlow 0 14) (- 0 19)) (=> (or (not (= |p#0@1| null)) (not true)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |key#0|))) (=> (=> (or (not (= |p#0@1| null)) (not true)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |key#0|)) (and (=> (= (ControlFlow 0 14) (- 0 18)) (=> (or (not (= |p#0@1| null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |p#0@1|)))) (=> (=> (or (not (= |p#0@1| null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |p#0@1|))) (and (=> (= (ControlFlow 0 14) (- 0 17)) (=> (or (not (= |p#0@1| null)) (not true)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |p#0@1|) _module.Node.key) |key#0|))) (=> (=> (or (not (= |p#0@1| null)) (not true)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |p#0@1|) _module.Node.key) |key#0|)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (=> (or (not (= |p#0@1| null)) (not true)) (=> (= |p#0@1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (= |prev#0@1| null)))) (=> (=> (or (not (= |p#0@1| null)) (not true)) (=> (= |p#0@1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (= |prev#0@1| null))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (=> (or (not (= |p#0@1| null)) (not true)) (=> (or (not (= |p#0@1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |prev#0@1|))))) (=> (=> (or (not (= |p#0@1| null)) (not true)) (=> (or (not (= |p#0@1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |prev#0@1|)))) (=> (= (ControlFlow 0 14) (- 0 13)) (=> (or (not (= |p#0@1| null)) (not true)) (=> (or (not (= |p#0@1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (not true)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |prev#0@1|) _module.Node.next)) |p#0@1|))))))))))))))))))
(let ((anon34_Then_correct  (=> (and (and (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |p#0@0|) _module.Node.key) |key#0|) (= |prev#0@1| |prev#0@0|)) (and (= |p#0@1| |p#0@0|) (= (ControlFlow 0 22) 14))) GeneratedUnifiedExit_correct)))
(let ((anon33_Then_correct  (=> (and (and (= |p#0@0| null) (= |prev#0@1| |prev#0@0|)) (and (= |p#0@1| |p#0@0|) (= (ControlFlow 0 21) 14))) GeneratedUnifiedExit_correct)))
(let ((anon34_Else_correct  (=> (or (not (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |p#0@0|) _module.Node.key) |key#0|)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 12)) (or (not (= |p#0@0| null)) (not true))) (=> (or (not (= |p#0@0| null)) (not true)) (=> (= |spine#0@2| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |p#0@0|) _module.Node.Spine))) (and (=> (= (ControlFlow 0 3) (- 0 11)) (or (not (= |p#0@0| null)) (not true))) (=> (or (not (= |p#0@0| null)) (not true)) (=> (= |$rhs#0_1_1@1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |p#0@0|) _module.Node.next))) (and (=> (= (ControlFlow 0 3) (- 0 10)) (and (|Set#Subset| |spine#0@2| |spine#0@1|) (not (|Set#Subset| |spine#0@1| |spine#0@2|)))) (=> (and (|Set#Subset| |spine#0@2| |spine#0@1|) (not (|Set#Subset| |spine#0@1| |spine#0@2|))) (=> (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 |spine#0@2| |$rhs#0_1_1@1|) (and (=> (= (ControlFlow 0 3) (- 0 9)) (=> |$w$loop#0@0| (=> (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 |spine#0@2| |$rhs#0_1_1@1|) (or (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 |spine#0@2| |$rhs#0_1_1@1|) (or (and (= |$rhs#0_1_1@1| null) (|Set#Equal| |spine#0@2| |Set#Empty|)) (and (and (and (or (not (= |$rhs#0_1_1@1| null)) (not true)) (|Set#IsMember| |spine#0@2| ($Box refType |$rhs#0_1_1@1|))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |$rhs#0_1_1@1|) _module.Node.Spine)) (|Set#Difference| |spine#0@2| (|Set#UnionOne| |Set#Empty| ($Box refType |$rhs#0_1_1@1|))))) (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS ($LS $LZ)) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |$rhs#0_1_1@1|) _module.Node.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |$rhs#0_1_1@1|) _module.Node.next))))))))) (=> (=> |$w$loop#0@0| (=> (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 |spine#0@2| |$rhs#0_1_1@1|) (or (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 |spine#0@2| |$rhs#0_1_1@1|) (or (and (= |$rhs#0_1_1@1| null) (|Set#Equal| |spine#0@2| |Set#Empty|)) (and (and (and (or (not (= |$rhs#0_1_1@1| null)) (not true)) (|Set#IsMember| |spine#0@2| ($Box refType |$rhs#0_1_1@1|))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |$rhs#0_1_1@1|) _module.Node.Spine)) (|Set#Difference| |spine#0@2| (|Set#UnionOne| |Set#Empty| ($Box refType |$rhs#0_1_1@1|))))) (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS ($LS $LZ)) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |$rhs#0_1_1@1|) _module.Node.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |$rhs#0_1_1@1|) _module.Node.next)))))))) (and (=> (= (ControlFlow 0 3) (- 0 8)) (=> |$w$loop#0@0| (=> (or (not (= |$rhs#0_1_1@1| null)) (not true)) (|Set#IsMember| |spine#0@2| ($Box refType |$rhs#0_1_1@1|))))) (=> (=> |$w$loop#0@0| (=> (or (not (= |$rhs#0_1_1@1| null)) (not true)) (|Set#IsMember| |spine#0@2| ($Box refType |$rhs#0_1_1@1|)))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (=> |$w$loop#0@0| (=> (= |$rhs#0_1_1@1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (= |p#0@0| null)))) (=> (=> |$w$loop#0@0| (=> (= |$rhs#0_1_1@1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (= |p#0@0| null))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (=> |$w$loop#0@0| (=> (or (not (= |$rhs#0_1_1@1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |p#0@0|))))) (=> (=> |$w$loop#0@0| (=> (or (not (= |$rhs#0_1_1@1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |p#0@0|)))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (=> |$w$loop#0@0| (=> (or (not (= |$rhs#0_1_1@1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (not true)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |p#0@0|) _module.Node.next)) |$rhs#0_1_1@1|)))) (=> (=> |$w$loop#0@0| (=> (or (not (= |$rhs#0_1_1@1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (not true)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |p#0@0|) _module.Node.next)) |$rhs#0_1_1@1|))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> |$w$loop#0@0| (=> (or (not (= |$rhs#0_1_1@1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (not true)) (not (|Set#IsMember| |spine#0@2| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))))) (=> (=> |$w$loop#0@0| (=> (or (not (= |$rhs#0_1_1@1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (not true)) (not (|Set#IsMember| |spine#0@2| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))))) (=> (= (ControlFlow 0 3) (- 0 2)) (=> |$w$loop#0@0| (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |key#0|) (exists ((|n#11| T@U) ) (!  (and ($Is refType |n#11| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) (and (|Set#IsMember| |spine#0@2| ($Box refType |n#11|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#11|) _module.Node.key) |key#0|)))
 :qid |b4dfy.81:37|
 :skolemid |692|
 ...
 :pattern ( (|Set#IsMember| |spine#0@2| ($Box refType |n#11|)))
)))))))))))))))))))))))))))))
(let ((anon33_Else_correct  (=> (or (not (= |p#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (or (not (= |p#0@0| null)) (not true))) (=> (or (not (= |p#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 23) 22) anon34_Then_correct) (=> (= (ControlFlow 0 23) 3) anon34_Else_correct)))))))
(let ((anon24_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 25) 21) anon33_Then_correct) (=> (= (ControlFlow 0 25) 23) anon33_Else_correct)))))
(let ((anon23_LoopBody_correct  (and (=> (= (ControlFlow 0 49) 48) anon24_Then_correct) (=> (= (ControlFlow 0 49) 25) anon24_Else_correct))))
(let ((anon23_LoopDone_correct true))
(let ((anon23_LoopHead_correct  (=> (and (and ($Is SetType |spine#0@1| (TSet (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25))) ($IsAlloc SetType |spine#0@1| (TSet (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) $Heap@@3)) (and ($Is refType |prev#0@0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType |prev#0@0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3))) (=> (and (and (and (and (and ($Is refType |p#0@0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType |p#0@0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)) (not false)) (and (=> |$w$loop#0@0| (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 |spine#0@1| |p#0@0|)) (=> |$w$loop#0@0| (=> (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 |spine#0@1| |p#0@0|) (or (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 |spine#0@1| |p#0@0|) (or (and (= |p#0@0| null) (|Set#Equal| |spine#0@1| |Set#Empty|)) (and (and (and (or (not (= |p#0@0| null)) (not true)) (|Set#IsMember| |spine#0@1| ($Box refType |p#0@0|))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |p#0@0|) _module.Node.Spine)) (|Set#Difference| |spine#0@1| (|Set#UnionOne| |Set#Empty| ($Box refType |p#0@0|))))) (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS ($LS $LZ)) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |p#0@0|) _module.Node.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |p#0@0|) _module.Node.next)))))))))) (and (and (=> |$w$loop#0@0| (and (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 |spine#0@1| |p#0@0|) (and (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 |spine#0@1| |p#0@0|) (or (and (= |p#0@0| null) (|Set#Equal| |spine#0@1| |Set#Empty|)) (and (and (and (or (not (= |p#0@0| null)) (not true)) (|Set#IsMember| |spine#0@1| ($Box refType |p#0@0|))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |p#0@0|) _module.Node.Spine)) (|Set#Difference| |spine#0@1| (|Set#UnionOne| |Set#Empty| ($Box refType |p#0@0|))))) (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |p#0@0|) _module.Node.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |p#0@0|) _module.Node.next)))))))) (=> |$w$loop#0@0| (=> (or (not (= |p#0@0| null)) (not true)) (|Set#IsMember| |spine#0@1| ($Box refType |p#0@0|))))) (and (=> |$w$loop#0@0| (=> (= |p#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (= |prev#0@0| null))) (=> |$w$loop#0@0| (=> (or (not (= |p#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |prev#0@0|))))))) (and (and (and (=> |$w$loop#0@0| (=> (or (not (= |p#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (not true)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |prev#0@0|) _module.Node.next)) |p#0@0|))) (=> |$w$loop#0@0| (=> (or (not (= |p#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (not true)) (not (|Set#IsMember| |spine#0@1| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))))) (and (=> |$w$loop#0@0| (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |key#0|) (exists ((|n#11@@0| T@U) ) (!  (and ($Is refType |n#11@@0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) (and (|Set#IsMember| |spine#0@1| ($Box refType |n#11@@0|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#11@@0|) _module.Node.key) |key#0|)))
 :qid |b4dfy.81:37|
 :skolemid |692|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#11@@0|) _module.Node.key))
 :pattern ( (|Set#IsMember| |spine#0@1| ($Box refType |n#11@@0|)))
)))) (=> |$w$loop#0@0| (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |key#0|) (exists ((|n#11@@1| T@U) ) (!  (and ($Is refType |n#11@@1| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) (and (|Set#IsMember| |spine#0@1| ($Box refType |n#11@@1|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#11@@1|) _module.Node.key) |key#0|)))
 :qid |b4dfy.81:37|
 :skolemid |693|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#11@@1|) _module.Node.key))
 :pattern ( (|Set#IsMember| |spine#0@1| ($Box refType |n#11@@1|)))
)))))) (and (and (forall (($o@@24 T@U) ) (!  (=> (and (or (not (= $o@@24 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@24) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@24) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@24)))
 :qid |b4dfy.76:5|
 :skolemid |694|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@24))
)) ($HeapSucc $Heap@@3 $Heap@@3)) (and (forall (($o@@25 T@U) ($f@@2 T@U) ) (!  (=> (and (or (not (= $o@@25 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@25) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@25) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@25) $f@@2)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@25 $f@@2))))
 :qid |b4dfy.76:5|
 :skolemid |695|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@25) $f@@2))
)) (|Set#Subset| |spine#0@1| |spine#0@0|))))) (and (=> (= (ControlFlow 0 50) 1) anon23_LoopDone_correct) (=> (= (ControlFlow 0 50) 49) anon23_LoopBody_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#3| null $Heap@@3 alloc false)) (=> (and (= |$rhs#1@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (= |spine#0@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)))) (and (=> (= (ControlFlow 0 51) (- 0 58)) (=> |$w$loop#0@0| (=> (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 |spine#0@0| |$rhs#1@0|) (or (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 |spine#0@0| |$rhs#1@0|) (or (and (= |$rhs#1@0| null) (|Set#Equal| |spine#0@0| |Set#Empty|)) (and (and (and (or (not (= |$rhs#1@0| null)) (not true)) (|Set#IsMember| |spine#0@0| ($Box refType |$rhs#1@0|))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |$rhs#1@0|) _module.Node.Spine)) (|Set#Difference| |spine#0@0| (|Set#UnionOne| |Set#Empty| ($Box refType |$rhs#1@0|))))) (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS ($LS $LZ)) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |$rhs#1@0|) _module.Node.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |$rhs#1@0|) _module.Node.next))))))))) (=> (=> |$w$loop#0@0| (=> (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 |spine#0@0| |$rhs#1@0|) (or (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 |spine#0@0| |$rhs#1@0|) (or (and (= |$rhs#1@0| null) (|Set#Equal| |spine#0@0| |Set#Empty|)) (and (and (and (or (not (= |$rhs#1@0| null)) (not true)) (|Set#IsMember| |spine#0@0| ($Box refType |$rhs#1@0|))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |$rhs#1@0|) _module.Node.Spine)) (|Set#Difference| |spine#0@0| (|Set#UnionOne| |Set#Empty| ($Box refType |$rhs#1@0|))))) (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS ($LS $LZ)) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |$rhs#1@0|) _module.Node.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |$rhs#1@0|) _module.Node.next)))))))) (and (=> (= (ControlFlow 0 51) (- 0 57)) (=> |$w$loop#0@0| (=> (or (not (= |$rhs#1@0| null)) (not true)) (|Set#IsMember| |spine#0@0| ($Box refType |$rhs#1@0|))))) (=> (=> |$w$loop#0@0| (=> (or (not (= |$rhs#1@0| null)) (not true)) (|Set#IsMember| |spine#0@0| ($Box refType |$rhs#1@0|)))) (and (=> (= (ControlFlow 0 51) (- 0 56)) (=> |$w$loop#0@0| (=> (= |$rhs#1@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (= null null)))) (=> (=> |$w$loop#0@0| (=> (= |$rhs#1@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (= null null))) (and (=> (= (ControlFlow 0 51) (- 0 55)) (=> |$w$loop#0@0| (=> (or (not (= |$rhs#1@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType null))))) (=> (=> |$w$loop#0@0| (=> (or (not (= |$rhs#1@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType null)))) (and (=> (= (ControlFlow 0 51) (- 0 54)) (=> |$w$loop#0@0| (=> (or (not (= |$rhs#1@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (not true)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 null) _module.Node.next)) |$rhs#1@0|)))) (=> (=> |$w$loop#0@0| (=> (or (not (= |$rhs#1@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (not true)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 null) _module.Node.next)) |$rhs#1@0|))) (and (=> (= (ControlFlow 0 51) (- 0 53)) (=> |$w$loop#0@0| (=> (or (not (= |$rhs#1@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (not true)) (not (|Set#IsMember| |spine#0@0| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))))) (=> (=> |$w$loop#0@0| (=> (or (not (= |$rhs#1@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (not true)) (not (|Set#IsMember| |spine#0@0| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))))) (and (=> (= (ControlFlow 0 51) (- 0 52)) (=> |$w$loop#0@0| (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |key#0|) (exists ((|n#11@@2| T@U) ) (!  (and ($Is refType |n#11@@2| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) (and (|Set#IsMember| |spine#0@0| ($Box refType |n#11@@2|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#11@@2|) _module.Node.key) |key#0|)))
 :qid |b4dfy.81:37|
 :skolemid |692|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#11@@2|) _module.Node.key))
 :pattern ( (|Set#IsMember| |spine#0@0| ($Box refType |n#11@@2|)))
))))) (=> (=> |$w$loop#0@0| (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |key#0|) (exists ((|n#11@@3| T@U) ) (!  (and ($Is refType |n#11@@3| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) (and (|Set#IsMember| |spine#0@0| ($Box refType |n#11@@3|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#11@@3|) _module.Node.key) |key#0|)))
 :qid |b4dfy.81:37|
 :skolemid |692|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#11@@3|) _module.Node.key))
 :pattern ( (|Set#IsMember| |spine#0@0| ($Box refType |n#11@@3|)))
)))) (=> (= (ControlFlow 0 51) 50) anon23_LoopHead_correct)))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 (Tclass._module.Map _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType this@@2 (Tclass._module.Map _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3))) (and ($IsBox |key#0| _module.Map$Key@@25) ($IsAllocBox |key#0| _module.Map$Key@@25 $Heap@@3))) (and (and ($Is refType |prev#0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType |prev#0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)) (and ($Is refType |p#0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType |p#0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)))) (=> (and (and (and (and ($Is SetType |spine#0@@2| (TSet (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25))) ($IsAlloc SetType |spine#0@@2| (TSet (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) $Heap@@3)) true) (= 3 $FunctionContextHeight)) (and (and (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (and (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (and (and (and (and (and (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Repr)) ($Box refType this@@2)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Repr)))) (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (forall ((|k#1| T@U) ) (!  (=> ($IsBox |k#1| _module.Map$Key@@25) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |k#1|) (exists ((|n#5| T@U) ) (!  (and ($Is refType |n#5| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#5|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#5|) _module.Node.key) |k#1|)))
 :qid |b4dfy.24:36|
 :skolemid |684|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#5|) _module.Node.key))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#5|)))
))))
 :qid |b4dfy.24:13|
 :skolemid |685|
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |k#1|))
))) (forall ((|n#6| T@U) ) (!  (=> ($Is refType |n#6| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#6|)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#6|) _module.Node.key))) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#6|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#6|) _module.Node.val) (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#6|) _module.Node.key))))))
 :qid |b4dfy.25:13|
 :skolemid |686|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#6|) _module.Node.val))
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#6|) _module.Node.key))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#6|)))
))) (forall ((|n#7| T@U) (|n'#2| T@U) ) (!  (=> (and ($Is refType |n#7| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) ($Is refType |n'#2| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25))) (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#7|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n'#2|))) (or (not (= |n#7| |n'#2|)) (not true))) (or (not (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#7|) _module.Node.key) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n'#2|) _module.Node.key))) (not true))))
 :qid |b4dfy.26:13|
 :skolemid |687|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n'#2|) _module.Node.key) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#7|) _module.Node.key))
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n'#2|) _module.Node.key) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#7|)))
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#7|) _module.Node.key) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n'#2|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n'#2|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#7|)))
))) (forall ((|n#8| T@U) ) (!  (=> ($Is refType |n#8| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#8|)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#8|) _module.Node.next)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (not true))))
 :qid |b4dfy.27:13|
 :skolemid |688|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#8|) _module.Node.next)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#8|)))
))) (forall ((|n#9| T@U) (|n'#3| T@U) ) (!  (=> (and ($Is refType |n#9| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) ($Is refType |n'#3| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25))) (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#9|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n'#3|))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#9|) _module.Node.next)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n'#3|) _module.Node.next)))) (= |n#9| |n'#3|)))
 :qid |b4dfy.28:13|
 :skolemid |689|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n'#3|) _module.Node.next)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#9|) _module.Node.next)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n'#3|) _module.Node.next)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#9|)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#9|) _module.Node.next)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n'#3|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n'#3|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#9|)))
))))) (= (ControlFlow 0 59) 51))) anon0_correct)))))
