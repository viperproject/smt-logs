...
(set-info :boogie-vc-id Impl$$_module.Map.Remove_split22)
...
))) (and ($HeapSucc $Heap@@3 $Heap@0) (or (not (= |call6formal@p#0@0| null)) (not true))))) (and (and (and (or (not (= |call5formal@prev#0@0| null)) (not true)) ($Is refType |call5formal@prev#0@0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25))) (and ($Is refType |call6formal@p#0@0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) (forall (($o@@25 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@25 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@25) alloc)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.Repr)) ($Box refType $o@@25))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@25 $f@@2)))
 :qid |b4dfy.150:23|
 :skolemid |847|
