...
(assert (forall ((_module.Map$Key@@2 T@U) (_module.Map$Value@@2 T@U) ($o@@0 T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType $o@@0 (Tclass._module.Map? _module.Map$Key@@2 _module.Map$Value@@2) $h@@0)  (or (= $o@@0 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@0 $o@@0) alloc)))))
 :qid |unknown.0:0|
 :skolemid |731|
 :pattern ( ($IsAlloc refType $o@@0 (Tclass._module.Map? _module.Map$Key@@2 _module.Map$Value@@2) $h@@0))
)))
...
(set-info :boogie-vc-id Impl$$_module.Map.FindIndex)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 10) (- 0 13)) (<= (LitInt (- 0 1)) |idx#0@1|)) (=> (<= (LitInt (- 0 1)) |idx#0@1|) (and (=> (= (ControlFlow 0 10) (- 0 12)) (< |idx#0@1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys))))) (=> (< |idx#0@1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys)))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (=> (= |idx#0@1| (LitInt (- 0 1))) (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys)) |key#0|)))) (=> (=> (= |idx#0@1| (LitInt (- 0 1))) (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys)) |key#0|))) (=> (= (ControlFlow 0 10) (- 0 9)) (=> (<= (LitInt 0) |idx#0@1|) (= (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys)) |idx#0@1|) |key#0|)))))))))))
(let ((anon14_Then_correct  (=> (= (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys)) |j#2@1|) |key#0|) (=> (and (= |idx#0@1| |j#2@1|) (= (ControlFlow 0 15) 10)) GeneratedUnifiedExit_correct))))
(let ((anon13_Then_correct  (=> (and (and (<= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys))) |j#2@1|) (= |idx#0@0| (LitInt (- 0 1)))) (and (= |idx#0@1| |idx#0@0|) (= (ControlFlow 0 14) 10))) GeneratedUnifiedExit_correct)))
(let ((anon14_Else_correct  (=> (and (or (not (= (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys)) |j#2@1|) |key#0|)) (not true)) (= |j#2@2| (+ |j#2@1| 1))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (or (<= 0 |$decr$loop#00@1|) (= (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys))) |j#2@2|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys))) |j#2@2|) |$decr$loop#00@1|)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (< (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys))) |j#2@2|) |$decr$loop#00@1|)) (=> (< (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys))) |j#2@2|) |$decr$loop#00@1|) (and (=> (= (ControlFlow 0 5) (- 0 6)) (=> |$w$loop#0@0| (<= |j#2@2| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys)))))) (=> (=> |$w$loop#0@0| (<= |j#2@2| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys))))) (=> (= (ControlFlow 0 5) (- 0 4)) (=> |$w$loop#0@0| (not (|Seq#Contains| (|Seq#Take| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys)) |j#2@2|) |key#0|)))))))))))))
(let ((anon13_Else_correct  (=> (and (< |j#2@1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys)))) (= |$decr$loop#00@1| (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys))) |j#2@1|))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (and (<= 0 |j#2@1|) (< |j#2@1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys)))))) (=> (and (<= 0 |j#2@1|) (< |j#2@1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys))))) (and (=> (= (ControlFlow 0 16) 15) anon14_Then_correct) (=> (= (ControlFlow 0 16) 5) anon14_Else_correct)))))))
(let ((anon12_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 18) 14) anon13_Then_correct) (=> (= (ControlFlow 0 18) 16) anon13_Else_correct)))))
(let ((anon12_Then_correct  (=> (not |$w$loop#0@0|) (=> (and (<= |j#2@1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys)))) (= (ControlFlow 0 3) (- 0 2))) (and (<= 0 |j#2@1|) (<= |j#2@1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys)))))))))
...
(let ((anon11_LoopHead_correct  (=> (and (and (and (not false) (<= 0 |j#2@1|)) (and (=> |$w$loop#0@0| (<= |j#2@1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys))))) (=> |$w$loop#0@0| (not (|Seq#Contains| (|Seq#Take| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys)) |j#2@1|) |key#0|))))) (and (and (forall (($o@@7 T@U) ) (!  (=> (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@7) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@7) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@7)))
 :qid |b8dfy.327:5|
 :skolemid |810|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@7))
)) ($HeapSucc $Heap@@0 $Heap@@0)) (and (forall (($o@@8 T@U) ($f@@1 T@U) ) (!  (=> (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@8) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@8) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@8) $f@@1)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@8 $f@@1))))
 :qid |b8dfy.327:5|
 :skolemid |811|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@8) $f@@1))
)) (<= (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys))) |j#2@1|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 20) 1) anon11_LoopDone_correct) (=> (= (ControlFlow 0 20) 19) anon11_LoopBody_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#5| null $Heap@@0 alloc false)) (=> (and (= |j#2@0| (LitInt 0)) (= |$decr_init$loop#00@0| (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys))) |j#2@0|))) (and (=> (= (ControlFlow 0 21) (- 0 23)) (=> |$w$loop#0@0| (<= |j#2@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys)))))) (=> (=> |$w$loop#0@0| (<= |j#2@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys))))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (=> |$w$loop#0@0| (not (|Seq#Contains| (|Seq#Take| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys)) |j#2@0|) |key#0|)))) (=> (=> |$w$loop#0@0| (not (|Seq#Contains| (|Seq#Take| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys)) |j#2@0|) |key#0|))) (=> (= (ControlFlow 0 21) 20) anon11_LoopHead_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 (Tclass._module.Map _module.Map$Key@@17 _module.Map$Value@@17)) ($IsAlloc refType this@@1 (Tclass._module.Map _module.Map$Key@@17 _module.Map$Value@@17) $Heap@@0)))) (=> (and (and (and ($IsBox |key#0| _module.Map$Key@@17) ($IsAllocBox |key#0| _module.Map$Key@@17 $Heap@@0)) (= 1 $FunctionContextHeight)) (and (and (|_module.Map.Valid#canCall| _module.Map$Key@@17 _module.Map$Value@@17 $Heap@@0 this@@1) (and (_module.Map.Valid _module.Map$Key@@17 _module.Map$Value@@17 $Heap@@0 this@@1) (and (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.values)))) (forall ((|i#1| Int) (|j#1| Int) ) (!  (=> (and (and (<= (LitInt 0) |i#1|) (< |i#1| |j#1|)) (< |j#1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys))))) (or (not (= (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys)) |i#1|) (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys)) |j#1|))) (not true)))
 :qid |b8dfy.250:12|
 :skolemid |808|
 :pattern ( (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys)) |j#1|) (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Map.keys)) |i#1|))
))))) (= (ControlFlow 0 24) 21))) anon0_correct))))
