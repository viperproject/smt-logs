...
(set-info :boogie-vc-id Impl$$_module.Map.Remove_split35)
...
)))) (and (and ($HeapSucc $Heap@@3 $Heap@0) (or (not (= |call6formal@p#0@0| null)) (not true))) (and (= |call5formal@prev#0@0| null) (= (ControlFlow 0 2) (- 0 1))))))) ($Is refType |call6formal@p#0@0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
