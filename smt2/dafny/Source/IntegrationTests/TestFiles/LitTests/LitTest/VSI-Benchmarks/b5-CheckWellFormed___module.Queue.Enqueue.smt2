...
(declare-fun |t#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.Queue.Enqueue)
...
))) (= (ControlFlow 0 2) (- 0 1))) ($IsAlloc refType this@@3 (Tclass._module.Queue _module.Queue$T@@21) $Heap@@1))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 (Tclass._module.Queue _module.Queue$T@@21)) ($IsAlloc refType this@@3 (Tclass._module.Queue _module.Queue$T@@21) $Heap@@1)))) (and (and ($IsBox |t#0| _module.Queue$T@@21) ($IsAllocBox |t#0| _module.Queue$T@@21 $Heap@@1)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct)))
