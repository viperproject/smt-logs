...
(set-info :boogie-vc-id CheckWellFormed$$_module.Map.RemoveNonFirst)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 (Tclass._module.Map _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType this@@2 (Tclass._module.Map _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)))) (=> (and (and (and ($IsBox |key#0| _module.Map$Key@@25) ($IsAllocBox |key#0| _module.Map$Key@@25 $Heap@@3)) (and ($Is refType |prev#0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType |prev#0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3))) (and (and ($Is refType |p#0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType |p#0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 15) 11)))) anon0_correct))))
