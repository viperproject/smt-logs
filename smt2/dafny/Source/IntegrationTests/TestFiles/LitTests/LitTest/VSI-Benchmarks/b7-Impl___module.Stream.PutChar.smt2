...
(declare-fun |x#0| () Int)
(declare-fun $Heap@0 () T@U)
(set-info :boogie-vc-id Impl$$_module.Stream.PutChar)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#8| null $Heap@@0 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Stream.footprint)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@1 _module.Stream.stream))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@1 _module.Stream.stream)) (=> (= |$rhs#0@0| (|Seq#Append| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Stream.stream)) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |x#0|))))) (=> (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Stream.stream ($Box SeqType |$rhs#0@0|)))) ($IsGoodHeap $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.Stream.Valid#canCall| $Heap@0 this@@1) (or (_module.Stream.Valid $Heap@0 this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@1) _module.Stream.footprint)) ($Box refType this@@1))))) (=> (=> (|_module.Stream.Valid#canCall| $Heap@0 this@@1) (or (_module.Stream.Valid $Heap@0 this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@1) _module.Stream.footprint)) ($Box refType this@@1)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.Stream.Valid#canCall| $Heap@0 this@@1) (or (_module.Stream.Valid $Heap@0 this@@1) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@1) _module.Stream.isOpen)))))) (=> (=> (|_module.Stream.Valid#canCall| $Heap@0 this@@1) (or (_module.Stream.Valid $Heap@0 this@@1) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@1) _module.Stream.isOpen))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (forall (($o@@11 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@1) _module.Stream.footprint)) ($Box refType $o@@11)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Stream.footprint)) ($Box refType $o@@11)))) (or (not (= $o@@11 null)) (not true)))
 :qid |b7dfy.73:24|
 :skolemid |551|
...
))) (=> (= (ControlFlow 0 2) (- 0 1)) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@1) _module.Stream.stream)) (|Seq#Append| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Stream.stream)) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |x#0|)))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.Stream) ($IsAlloc refType this@@1 Tclass._module.Stream $Heap@@0))) (= 1 $FunctionContextHeight)) (and (and (|_module.Stream.Valid#canCall| $Heap@@0 this@@1) (and (_module.Stream.Valid $Heap@@0 this@@1) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Stream.footprint)) ($Box refType this@@1)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Stream.isOpen)))))) (= (ControlFlow 0 7) 2))) anon0_correct))))
