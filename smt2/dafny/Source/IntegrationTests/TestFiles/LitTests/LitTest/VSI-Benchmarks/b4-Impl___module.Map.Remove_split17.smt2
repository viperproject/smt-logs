...
(set-info :boogie-vc-id Impl$$_module.Map.Remove_split17)
...
))) (= (ControlFlow 0 2) (- 0 1)))) (|Map#Equal| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@2) _module.Map.M)) (|Map#Glue| (|Set#FromBoogieMap| (|lambda#15| _module.Map$Key@@25 (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |key#0|)) (|lambda#16| (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M)))) (TMap _module.Map$Key@@25 _module.Map$Value@@25)))))))
(let ((anon6_Else_correct  (=> (and (or (not (= |call5formal@prev#0@0| null)) (not true)) ($Is refType |call5formal@prev#0@0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25))) (=> (and (and (and (and (and ($Is refType |call6formal@p#0@0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) (forall (($o@@26 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@26 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@26) alloc)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.Repr)) ($Box refType $o@@26))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@26 $f@@2)))
 :qid |b4dfy.150:23|
 :skolemid |847|
...
(let ((anon6_Then_correct  (=> (= |call5formal@prev#0@0| null) (=> (and ($Is refType |call6formal@p#0@0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) (forall (($o@@30 T@U) ($f@@3 T@U) ) (!  (=> (and (and (or (not (= $o@@30 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@30) alloc)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.Repr)) ($Box refType $o@@30))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@30 $f@@3)))
 :qid |b4dfy.148:20|
 :skolemid |846|
...
)))))) (and (and (and (forall (($o@@31 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) _module.Map.Repr)) ($Box refType $o@@31)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.Repr)) ($Box refType $o@@31)))) (or (not (= $o@@31 null)) (not true)))
 :qid |b4dfy.160:24|
 :skolemid |875|
 :pattern (  (or (not (= $o@@31 null)) (not true)))
)) (forall (($o@@32 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) _module.Map.Repr)) ($Box refType $o@@32)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.Repr)) ($Box refType $o@@32)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@32) alloc)))))
 :qid |b4dfy.160:24|
 :skolemid |876|
