...
(set-info :boogie-vc-id Impl$$_module.Map.Remove_split30)
...
))))) (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.M))) |key#0|) (= (ControlFlow 0 2) (- 0 1)))))))) (or (not (= |call6formal@p#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.head)))) (not true))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
