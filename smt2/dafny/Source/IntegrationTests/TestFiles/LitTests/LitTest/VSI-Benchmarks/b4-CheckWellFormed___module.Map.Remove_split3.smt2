...
(set-info :boogie-vc-id CheckWellFormed$$_module.Map.Remove_split3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon9_Then_correct  (=> (and (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |k#0@0|) (or (not (= |k#0@0| |key#0|)) (not true))) (and ($IsAlloc refType this@@2 (Tclass._module.Map _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3) (= (ControlFlow 0 2) (- 0 1)))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |k#0@0|))))
(let ((anon8_Else_correct  (=> (and (not (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |k#0@0|)) (= (ControlFlow 0 4) 2)) anon9_Then_correct)))
(let ((anon8_Then_correct  (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |k#0@0|) (= (ControlFlow 0 3) 2)) anon9_Then_correct)))
...
)))) (and (and ($IsBox |k#0@0| _module.Map$Key@@25) ($IsAllocBox |k#0@0| _module.Map$Key@@25 $Heap@0)) ($IsAlloc refType this@@2 (Tclass._module.Map _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)))) (and (=> (= (ControlFlow 0 5) 3) anon8_Then_correct) (=> (= (ControlFlow 0 5) 4) anon8_Else_correct)))))))
anon0_correct)))))
))
(check-sat)
(get-info :rlimit)
