...
(assert (distinct TagSet TagMap alloc allocName Tagclass._System.object? Tagclass._System.object |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 class._module.Map? Tagclass._module.Map? Tagclass._module.Node? Tagclass._module.Node Tagclass._module.Map Tagclass._module.Maybe class._module.Node? |##_module.Maybe.None| |##_module.Maybe.Some| tytagFamily$object |tytagFamily$_tuple#2| tytagFamily$Map tytagFamily$Node tytagFamily$Maybe field$M field$Repr field$head field$Spine field$key field$val field$next)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((a@@2 T@U) (b T@U) ) (!  (=> (and (_module.Maybe.Some_q a@@2) (_module.Maybe.Some_q b)) (= (|_module.Maybe#Equal| a@@2 b) (= (_module.Maybe.get a@@2) (_module.Maybe.get b))))
 :qid |unknown.0:0|
 :skolemid |1011|
 :pattern ( (|_module.Maybe#Equal| a@@2 b) (_module.Maybe.Some_q a@@2))
 :pattern ( (|_module.Maybe#Equal| a@@2 b) (_module.Maybe.Some_q b))
)))
(assert (forall ((a@@3 T@U) (b@@0 T@U) (y@@0 T@U) ) (!  (=> (|Set#IsMember| b@@0 y@@0) (not (|Set#IsMember| (|Set#Difference| a@@3 b@@0) y@@0)))
 :qid |DafnyPreludebpl.757:15|
 :skolemid |144|
 :pattern ( (|Set#Difference| a@@3 b@@0) (|Set#IsMember| b@@0 y@@0))
)))
...
(assert (forall ((_module.Maybe$T T@U) ($h@@2 T@U) ) (!  (=> ($IsGoodHeap $h@@2) ($IsAlloc DatatypeTypeType |#_module.Maybe.None| (Tclass._module.Maybe _module.Maybe$T) $h@@2))
 :qid |unknown.0:0|
 :skolemid |997|
 :pattern ( ($IsAlloc DatatypeTypeType |#_module.Maybe.None| (Tclass._module.Maybe _module.Maybe$T) $h@@2))
)))
...
(assert (forall ((a@@5 T@U) (b@@2 T@U) ) (! (= (|_module.Maybe#Equal| a@@5 b@@2) (= a@@5 b@@2))
 :qid |unknown.0:0|
 :skolemid |1012|
 :pattern ( (|_module.Maybe#Equal| a@@5 b@@2))
)))
...
(assert (forall ((d@@1 T@U) ) (! (= (_module.Maybe.None_q d@@1) (= (DatatypeCtorId d@@1) |##_module.Maybe.None|))
 :qid |unknown.0:0|
 :skolemid |994|
 :pattern ( (_module.Maybe.None_q d@@1))
)))
(assert (forall ((d@@2 T@U) ) (! (= (_module.Maybe.Some_q d@@2) (= (DatatypeCtorId d@@2) |##_module.Maybe.Some|))
 :qid |unknown.0:0|
 :skolemid |999|
...
(assert (forall ((d@@4 T@U) ) (!  (=> (_module.Maybe.None_q d@@4) (= d@@4 |#_module.Maybe.None|))
 :qid |unknown.0:0|
 :skolemid |995|
 :pattern ( (_module.Maybe.None_q d@@4))
)))
...
(assert (forall ((d@@5 T@U) ) (!  (=> (_module.Maybe.Some_q d@@5) (exists ((|a#5#0#0| T@U) ) (! (= d@@5 (|#_module.Maybe.Some| |a#5#0#0|))
 :qid |b4dfy.223:33|
 :skolemid |1000|
)))
 :qid |unknown.0:0|
 :skolemid |1001|
 :pattern ( (_module.Maybe.Some_q d@@5))
)))
...
(assert (forall ((_module.Node$Key@@3 T@U) (_module.Node$Value@@3 T@U) ($h@@5 T@U) ($o@@4 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@5) (and (or (not (= $o@@4 null)) (not true)) (= (dtype $o@@4) (Tclass._module.Node? _module.Node$Key@@3 _module.Node$Value@@3)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@4) alloc)))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@4) _module.Node.key) _module.Node$Key@@3 $h@@5))
 :qid |unknown.0:0|
 :skolemid |982|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@4) _module.Node.key) (Tclass._module.Node? _module.Node$Key@@3 _module.Node$Value@@3))
)))
(assert (forall ((_module.Node$Key@@4 T@U) (_module.Node$Value@@4 T@U) ($h@@6 T@U) ($o@@5 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@6) (and (or (not (= $o@@5 null)) (not true)) (= (dtype $o@@5) (Tclass._module.Node? _module.Node$Key@@4 _module.Node$Value@@4)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@5) alloc)))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@5) _module.Node.val) _module.Node$Value@@4 $h@@6))
 :qid |unknown.0:0|
 :skolemid |984|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@5) _module.Node.val) (Tclass._module.Node? _module.Node$Key@@4 _module.Node$Value@@4))
)))
(assert (forall ((_module.Map$Key@@5 T@U) (_module.Map$Value@@5 T@U) (|c#0@@2| T@U) ($h@@7 T@U) ) (! (= ($IsAlloc refType |c#0@@2| (Tclass._module.Map _module.Map$Key@@5 _module.Map$Value@@5) $h@@7) ($IsAlloc refType |c#0@@2| (Tclass._module.Map? _module.Map$Key@@5 _module.Map$Value@@5) $h@@7))
 :qid |unknown.0:0|
 :skolemid |978|
 :pattern ( ($IsAlloc refType |c#0@@2| (Tclass._module.Map _module.Map$Key@@5 _module.Map$Value@@5) $h@@7))
 :pattern ( ($IsAlloc refType |c#0@@2| (Tclass._module.Map? _module.Map$Key@@5 _module.Map$Value@@5) $h@@7))
)))
(assert (forall ((_module.Node$Key@@5 T@U) (_module.Node$Value@@5 T@U) (|c#0@@3| T@U) ($h@@8 T@U) ) (! (= ($IsAlloc refType |c#0@@3| (Tclass._module.Node _module.Node$Key@@5 _module.Node$Value@@5) $h@@8) ($IsAlloc refType |c#0@@3| (Tclass._module.Node? _module.Node$Key@@5 _module.Node$Value@@5) $h@@8))
 :qid |unknown.0:0|
 :skolemid |993|
 :pattern ( ($IsAlloc refType |c#0@@3| (Tclass._module.Node _module.Node$Key@@5 _module.Node$Value@@5) $h@@8))
 :pattern ( ($IsAlloc refType |c#0@@3| (Tclass._module.Node? _module.Node$Key@@5 _module.Node$Value@@5) $h@@8))
)))
...
(assert (forall ((_module.Map$Key@@7 T@U) (_module.Map$Value@@7 T@U) ($h@@9 T@U) ($o@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) (and (or (not (= $o@@7 null)) (not true)) (= (dtype $o@@7) (Tclass._module.Map? _module.Map$Key@@7 _module.Map$Value@@7)))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@7) _module.Map.Repr)) (TSet Tclass._System.object)))
 :qid |unknown.0:0|
 :skolemid |536|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@7) _module.Map.Repr)) (Tclass._module.Map? _module.Map$Key@@7 _module.Map$Value@@7))
)))
(assert (forall ((_module.Maybe$T@@2 T@U) (|a#6#0#0| T@U) ($h@@10 T@U) ) (!  (=> ($IsGoodHeap $h@@10) (= ($IsAlloc DatatypeTypeType (|#_module.Maybe.Some| |a#6#0#0|) (Tclass._module.Maybe _module.Maybe$T@@2) $h@@10) ($IsAllocBox |a#6#0#0| _module.Maybe$T@@2 $h@@10)))
 :qid |unknown.0:0|
 :skolemid |1003|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.Maybe.Some| |a#6#0#0|) (Tclass._module.Maybe _module.Maybe$T@@2) $h@@10))
)))
(assert (forall ((_module.Map$Key@@8 T@U) (_module.Map$Value@@8 T@U) ($o@@8 T@U) ($h@@11 T@U) ) (! (= ($IsAlloc refType $o@@8 (Tclass._module.Map? _module.Map$Key@@8 _module.Map$Value@@8) $h@@11)  (or (= $o@@8 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@8) alloc)))))
 :qid |unknown.0:0|
 :skolemid |533|
 :pattern ( ($IsAlloc refType $o@@8 (Tclass._module.Map? _module.Map$Key@@8 _module.Map$Value@@8) $h@@11))
)))
(assert (forall ((_module.Node$Key@@6 T@U) (_module.Node$Value@@6 T@U) ($o@@9 T@U) ($h@@12 T@U) ) (! (= ($IsAlloc refType $o@@9 (Tclass._module.Node? _module.Node$Key@@6 _module.Node$Value@@6) $h@@12)  (or (= $o@@9 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@9) alloc)))))
 :qid |unknown.0:0|
 :skolemid |980|
 :pattern ( ($IsAlloc refType $o@@9 (Tclass._module.Node? _module.Node$Key@@6 _module.Node$Value@@6) $h@@12))
)))
(assert (forall ((_module.Maybe$T@@3 T@U) (d@@6 T@U) ) (!  (=> ($Is DatatypeTypeType d@@6 (Tclass._module.Maybe _module.Maybe$T@@3)) (or (_module.Maybe.None_q d@@6) (_module.Maybe.Some_q d@@6)))
 :qid |unknown.0:0|
 :skolemid |1009|
 :pattern ( (_module.Maybe.Some_q d@@6) ($Is DatatypeTypeType d@@6 (Tclass._module.Maybe _module.Maybe$T@@3)))
 :pattern ( (_module.Maybe.None_q d@@6) ($Is DatatypeTypeType d@@6 (Tclass._module.Maybe _module.Maybe$T@@3)))
)))
...
(assert (forall ((a@@9 T@U) (b@@6 T@U) ) (!  (=> (and (_module.Maybe.None_q a@@9) (_module.Maybe.None_q b@@6)) (|_module.Maybe#Equal| a@@9 b@@6))
 :qid |unknown.0:0|
 :skolemid |1010|
 :pattern ( (|_module.Maybe#Equal| a@@9 b@@6) (_module.Maybe.None_q a@@9))
 :pattern ( (|_module.Maybe#Equal| a@@9 b@@6) (_module.Maybe.None_q b@@6))
)))
...
(assert (forall ((|a#4#0#0@@0| T@U) ) (! (= (DatatypeCtorId (|#_module.Maybe.Some| |a#4#0#0@@0|)) |##_module.Maybe.Some|)
 :qid |b4dfy.223:33|
 :skolemid |998|
 :pattern ( (|#_module.Maybe.Some| |a#4#0#0@@0|))
)))
(assert (forall ((|a#8#0#0| T@U) ) (! (= (_module.Maybe.get (|#_module.Maybe.Some| |a#8#0#0|)) |a#8#0#0|)
 :qid |b4dfy.223:33|
 :skolemid |1006|
 :pattern ( (|#_module.Maybe.Some| |a#8#0#0|))
)))
...
(assert (forall ((_module.Maybe$T@@5 T@U) (|a#6#0#0@@1| T@U) ) (! (= ($Is DatatypeTypeType (|#_module.Maybe.Some| |a#6#0#0@@1|) (Tclass._module.Maybe _module.Maybe$T@@5)) ($IsBox |a#6#0#0@@1| _module.Maybe$T@@5))
 :qid |unknown.0:0|
 :skolemid |1002|
 :pattern ( ($Is DatatypeTypeType (|#_module.Maybe.Some| |a#6#0#0@@1|) (Tclass._module.Maybe _module.Maybe$T@@5)))
)))
...
(assert (forall ((_module.Map$Key@@13 T@U) (_module.Map$Value@@13 T@U) ($h@@13 T@U) ($o@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (or (not (= $o@@11 null)) (not true)) (= (dtype $o@@11) (Tclass._module.Map? _module.Map$Key@@13 _module.Map$Value@@13)))) ($Is MapType ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@11) _module.Map.M)) (TMap _module.Map$Key@@13 _module.Map$Value@@13)))
 :qid |unknown.0:0|
 :skolemid |534|
 :pattern ( ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@11) _module.Map.M)) (Tclass._module.Map? _module.Map$Key@@13 _module.Map$Value@@13))
)))
(assert (forall ((_module.Map$Key@@14 T@U) (_module.Map$Value@@14 T@U) ($h@@14 T@U) ($o@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (or (not (= $o@@12 null)) (not true)) (= (dtype $o@@12) (Tclass._module.Map? _module.Map$Key@@14 _module.Map$Value@@14)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@12) _module.Map.head)) (Tclass._module.Node? _module.Map$Key@@14 _module.Map$Value@@14)))
 :qid |unknown.0:0|
 :skolemid |542|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@12) _module.Map.head)) (Tclass._module.Map? _module.Map$Key@@14 _module.Map$Value@@14))
)))
(assert (forall ((_module.Node$Key@@11 T@U) (_module.Node$Value@@11 T@U) ($h@@15 T@U) ($o@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (or (not (= $o@@13 null)) (not true)) (= (dtype $o@@13) (Tclass._module.Node? _module.Node$Key@@11 _module.Node$Value@@11)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@13) _module.Node.next)) (Tclass._module.Node? _module.Node$Key@@11 _module.Node$Value@@11)))
 :qid |unknown.0:0|
 :skolemid |985|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@13) _module.Node.next)) (Tclass._module.Node? _module.Node$Key@@11 _module.Node$Value@@11))
)))
...
(assert (forall ((|a#9#0#0| T@U) ) (! (< (BoxRank |a#9#0#0|) (DtRank (|#_module.Maybe.Some| |a#9#0#0|)))
 :qid |b4dfy.223:33|
 :skolemid |1007|
 :pattern ( (|#_module.Maybe.Some| |a#9#0#0|))
)))
(assert (forall ((d@@7 T@U) (_module.Maybe$T@@6 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (_module.Maybe.Some_q d@@7) ($IsAlloc DatatypeTypeType d@@7 (Tclass._module.Maybe _module.Maybe$T@@6) $h@@16))) ($IsAllocBox (_module.Maybe.get d@@7) _module.Maybe$T@@6 $h@@16))
 :qid |unknown.0:0|
 :skolemid |1004|
 :pattern ( ($IsAllocBox (_module.Maybe.get d@@7) _module.Maybe$T@@6 $h@@16))
)))
...
(assert (forall ((_module.Map$Key@@20 T@U) (_module.Map$Value@@20 T@U) ($h@@17 T@U) ($o@@16 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@17) (and (or (not (= $o@@16 null)) (not true)) (= (dtype $o@@16) (Tclass._module.Map? _module.Map$Key@@20 _module.Map$Value@@20)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@16) alloc)))) ($IsAlloc MapType ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@16) _module.Map.M)) (TMap _module.Map$Key@@20 _module.Map$Value@@20) $h@@17))
 :qid |unknown.0:0|
 :skolemid |535|
 :pattern ( ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@16) _module.Map.M)) (Tclass._module.Map? _module.Map$Key@@20 _module.Map$Value@@20))
)))
(assert (forall ((_module.Map$Key@@21 T@U) (_module.Map$Value@@21 T@U) ($h@@18 T@U) ($o@@17 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@18) (and (or (not (= $o@@17 null)) (not true)) (= (dtype $o@@17) (Tclass._module.Map? _module.Map$Key@@21 _module.Map$Value@@21)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@17) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@17) _module.Map.head)) (Tclass._module.Node? _module.Map$Key@@21 _module.Map$Value@@21) $h@@18))
 :qid |unknown.0:0|
 :skolemid |543|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@17) _module.Map.head)) (Tclass._module.Map? _module.Map$Key@@21 _module.Map$Value@@21))
)))
(assert (forall ((_module.Node$Key@@16 T@U) (_module.Node$Value@@16 T@U) ($h@@19 T@U) ($o@@18 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@19) (and (or (not (= $o@@18 null)) (not true)) (= (dtype $o@@18) (Tclass._module.Node? _module.Node$Key@@16 _module.Node$Value@@16)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@18) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@18) _module.Node.next)) (Tclass._module.Node? _module.Node$Key@@16 _module.Node$Value@@16) $h@@19))
 :qid |unknown.0:0|
 :skolemid |986|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@18) _module.Node.next)) (Tclass._module.Node? _module.Node$Key@@16 _module.Node$Value@@16))
)))
...
(assert (forall ((_module.Maybe$T@@7 T@U) (bx@@12 T@U) ) (!  (=> ($IsBox bx@@12 (Tclass._module.Maybe _module.Maybe$T@@7)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@12)) bx@@12) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@12) (Tclass._module.Maybe _module.Maybe$T@@7))))
 :qid |unknown.0:0|
 :skolemid |698|
 :pattern ( ($IsBox bx@@12 (Tclass._module.Maybe _module.Maybe$T@@7)))
)))
(assert (forall ((v@@7 T@U) (t0@@4 T@U) (t1@@2 T@U) ) (! (= ($Is MapType v@@7 (TMap t0@@4 t1@@2)) (forall ((bx@@13 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@7) bx@@13) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@7) bx@@13) t1@@2) ($IsBox bx@@13 t0@@4)))
...
(assert (= (Tag Tclass._System.object) Tagclass._System.object))
(assert (= (TagFamily Tclass._System.object) tytagFamily$object))
(assert (forall ((_module.Map$Key@@22 T@U) (_module.Map$Value@@22 T@U) ($h@@20 T@U) ($o@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (or (not (= $o@@19 null)) (not true)) (= (dtype $o@@19) (Tclass._module.Map? _module.Map$Key@@22 _module.Map$Value@@22)))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@20 $o@@19) _module.Map.Spine)) (TSet (Tclass._module.Node _module.Map$Key@@22 _module.Map$Value@@22))))
 :qid |unknown.0:0|
 :skolemid |548|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@20 $o@@19) _module.Map.Spine)) (Tclass._module.Map? _module.Map$Key@@22 _module.Map$Value@@22))
)))
(assert (forall ((_module.Node$Key@@17 T@U) (_module.Node$Value@@17 T@U) ($h@@21 T@U) ($o@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (or (not (= $o@@20 null)) (not true)) (= (dtype $o@@20) (Tclass._module.Node? _module.Node$Key@@17 _module.Node$Value@@17)))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@21 $o@@20) _module.Node.Spine)) (TSet (Tclass._module.Node _module.Node$Key@@17 _module.Node$Value@@17))))
 :qid |unknown.0:0|
 :skolemid |987|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@21 $o@@20) _module.Node.Spine)) (Tclass._module.Node? _module.Node$Key@@17 _module.Node$Value@@17))
)))
(assert (= |#_module.Maybe.None| (Lit DatatypeTypeType |#_module.Maybe.None|)))
(assert (forall ((_module.Map$Key@@23 T@U) (_module.Map$Value@@23 T@U) ($h@@22 T@U) ($o@@21 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@22) (and (or (not (= $o@@21 null)) (not true)) (= (dtype $o@@21) (Tclass._module.Map? _module.Map$Key@@23 _module.Map$Value@@23)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@22 $o@@21) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@22 $o@@21) _module.Map.Spine)) (TSet (Tclass._module.Node _module.Map$Key@@23 _module.Map$Value@@23)) $h@@22))
 :qid |unknown.0:0|
 :skolemid |549|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@22 $o@@21) _module.Map.Spine)) (Tclass._module.Map? _module.Map$Key@@23 _module.Map$Value@@23))
)))
(assert (forall ((_module.Node$Key@@18 T@U) (_module.Node$Value@@18 T@U) ($h@@23 T@U) ($o@@22 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@23) (and (or (not (= $o@@22 null)) (not true)) (= (dtype $o@@22) (Tclass._module.Node? _module.Node$Key@@18 _module.Node$Value@@18)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@23 $o@@22) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@23 $o@@22) _module.Node.Spine)) (TSet (Tclass._module.Node _module.Node$Key@@18 _module.Node$Value@@18)) $h@@23))
 :qid |unknown.0:0|
 :skolemid |988|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@23 $o@@22) _module.Node.Spine)) (Tclass._module.Node? _module.Node$Key@@18 _module.Node$Value@@18))
)))
...
(assert (forall ((d@@9 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (_System.Tuple2.___hMake2_q d@@9) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@9 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@24)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@9 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@24))
)))) ($IsAllocBox (_System.Tuple2._0 d@@9) |_System._tuple#2$T0@@6| $h@@24))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@9) |_System._tuple#2$T0@@6| $h@@24))
)))
(assert (forall ((d@@10 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (_System.Tuple2.___hMake2_q d@@10) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@10 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@25)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@10 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@25))
)))) ($IsAllocBox (_System.Tuple2._1 d@@10) |_System._tuple#2$T1@@7| $h@@25))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@10) |_System._tuple#2$T1@@7| $h@@25))
)))
...
(assert (forall ((|a#7#0#0@@0| T@U) ) (! (= (|#_module.Maybe.Some| (Lit BoxType |a#7#0#0@@0|)) (Lit DatatypeTypeType (|#_module.Maybe.Some| |a#7#0#0@@0|)))
 :qid |b4dfy.223:33|
 :skolemid |1005|
 :pattern ( (|#_module.Maybe.Some| (Lit BoxType |a#7#0#0@@0|)))
)))
...
(assert (forall ((_module.Map$Key@@24 T@U) (_module.Map$Value@@24 T@U) ($h@@26 T@U) ($o@@23 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@26) (and (or (not (= $o@@23 null)) (not true)) (= (dtype $o@@23) (Tclass._module.Map? _module.Map$Key@@24 _module.Map$Value@@24)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@26 $o@@23) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@26 $o@@23) _module.Map.Repr)) (TSet Tclass._System.object) $h@@26))
 :qid |unknown.0:0|
 :skolemid |537|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@26 $o@@23) _module.Map.Repr)) (Tclass._module.Map? _module.Map$Key@@24 _module.Map$Value@@24))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.Map.Find)
...
(let ((anon8_Then_correct  (=> (and (_module.Maybe.Some_q |result#0@0|) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.M))) |key#0|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (_module.Maybe.Some_q |result#0@0|)) (=> (_module.Maybe.Some_q |result#0@0|) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.M))) |key#0|)))))))
(let ((anon7_Else_correct  (=> (=> (|_module.Maybe#Equal| |result#0@0| |#_module.Maybe.None|) (not (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.M))) |key#0|))) (and (=> (= (ControlFlow 0 6) 2) anon8_Then_correct) (=> (= (ControlFlow 0 6) 4) anon8_Else_correct)))))
(let ((anon7_Then_correct  (=> (and (|_module.Maybe#Equal| |result#0@0| |#_module.Maybe.None|) (not (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.M))) |key#0|))) (and (=> (= (ControlFlow 0 5) 2) anon8_Then_correct) (=> (= (ControlFlow 0 5) 4) anon8_Else_correct)))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#3| null $Heap@@3 alloc false)) ($IsAllocBox ($Box refType this@@2) (Tclass._module.Map? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)) (=> (and (and (and (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (forall (($o@@24 T@U) ) (!  (=> (and (or (not (= $o@@24 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@24) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@24) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@24)))
 :qid |b4dfy.93:10|
 :skolemid |699|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@24))
)) ($HeapSucc $Heap@@3 $Heap@0)) (and ($Is DatatypeTypeType |result#0@0| (Tclass._module.Maybe _module.Map$Value@@25)) ($IsAlloc DatatypeTypeType |result#0@0| (Tclass._module.Maybe _module.Map$Value@@25) $Heap@0)))) (and (=> (= (ControlFlow 0 7) 5) anon7_Then_correct) (=> (= (ControlFlow 0 7) 6) anon7_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 (Tclass._module.Map _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType this@@2 (Tclass._module.Map _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3))) (and ($IsBox |key#0| _module.Map$Key@@25) ($IsAllocBox |key#0| _module.Map$Key@@25 $Heap@@3))) (and (and ($Is DatatypeTypeType |result#0| (Tclass._module.Maybe _module.Map$Value@@25)) ($IsAlloc DatatypeTypeType |result#0| (Tclass._module.Maybe _module.Map$Value@@25) $Heap@@3)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 8) 7)))) anon0_correct))))
