...
(set-info :boogie-vc-id CheckWellFormed$$_module.Benchmark3.RemoveMin)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 29) (let ((anon8_correct  (=> (forall ((|i#1| Int) ) (!  (=> (and (<= (LitInt 0) |i#1|) (< |i#1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |q#0|) _module.Queue.contents))))) (<= |m#0@0| (U_2_int ($Unbox intType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |q#0|) _module.Queue.contents)) |i#1|)))))
 :qid |b3dfy.76:20|
 :skolemid |545|
 :pattern ( ($Unbox intType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |q#0|) _module.Queue.contents)) |i#1|)))
)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (or (not (= |q#0| null)) (not true))) (=> (or (not (= |q#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= |q#0| null)) (not true))) (=> (or (not (= |q#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 6)) ($IsAlloc refType |q#0| (Tclass._module.Queue TInt) $Heap)) (=> ($IsAlloc refType |q#0| (Tclass._module.Queue TInt) $Heap) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 (+ |k#0@0| 1)) (<= (+ |k#0@0| 1) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |q#0|) _module.Queue.contents)))))) (=> (and (<= 0 (+ |k#0@0| 1)) (<= (+ |k#0@0| 1) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |q#0|) _module.Queue.contents))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |q#0| null)) (not true))) (=> (or (not (= |q#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |q#0| (Tclass._module.Queue TInt) $Heap)) (=> ($IsAlloc refType |q#0| (Tclass._module.Queue TInt) $Heap) (=> (= (ControlFlow 0 2) (- 0 1)) (and (<= 0 |k#0@0|) (<= |k#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |q#0|) _module.Queue.contents)))))))))))))))))))))
(let ((anon6_correct  (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |q#0|) _module.Queue.contents))))) (and (=> (= (ControlFlow 0 10) (- 0 12)) (or (not (= |q#0| null)) (not true))) (=> (or (not (= |q#0| null)) (not true)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |q#0|) _module.Queue.contents)))))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |q#0|) _module.Queue.contents))))) (=> (and (<= |m#0@0| (U_2_int ($Unbox intType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |q#0|) _module.Queue.contents)) |i#0@0|)))) (= (ControlFlow 0 10) 2)) anon8_correct))))))))
(let ((anon11_Else_correct  (=> (and (< |i#0@0| (LitInt 0)) (= (ControlFlow 0 15) 10)) anon6_correct)))
(let ((anon11_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 13) (- 0 14)) (or (not (= |q#0| null)) (not true))) (=> (or (not (= |q#0| null)) (not true)) (=> (= (ControlFlow 0 13) 10) anon6_correct))))))
(let ((anon10_Else_correct  (=> (and (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |q#0|) _module.Queue.contents))))) (<= |m#0@0| (U_2_int ($Unbox intType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |q#0|) _module.Queue.contents)) |i#0@0|))))) (= (ControlFlow 0 9) 2)) anon8_correct)))
(let ((anon3_correct  (=> (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |q#0|) _module.Queue.contents))))) (and (=> (= (ControlFlow 0 16) (- 0 19)) (or (not (= |q#0| null)) (not true))) (=> (or (not (= |q#0| null)) (not true)) (and (=> (= (ControlFlow 0 16) (- 0 18)) ($IsAlloc refType |q#0| (Tclass._module.Queue TInt) $Heap)) (=> ($IsAlloc refType |q#0| (Tclass._module.Queue TInt) $Heap) (and (=> (= (ControlFlow 0 16) (- 0 17)) (and (<= 0 |k#0@0|) (< |k#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |q#0|) _module.Queue.contents)))))) (=> (and (<= 0 |k#0@0|) (< |k#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |q#0|) _module.Queue.contents))))) (=> (= (U_2_int ($Unbox intType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |q#0|) _module.Queue.contents)) |k#0@0|))) |m#0@0|) (and (and (=> (= (ControlFlow 0 16) 9) anon10_Else_correct) (=> (= (ControlFlow 0 16) 13) anon11_Then_correct)) (=> (= (ControlFlow 0 16) 15) anon11_Else_correct))))))))))))
(let ((anon9_Else_correct  (=> (and (< |k#0@0| (LitInt 0)) (= (ControlFlow 0 23) 16)) anon3_correct)))
(let ((anon9_Then_correct  (=> (<= (LitInt 0) |k#0@0|) (and (=> (= (ControlFlow 0 20) (- 0 22)) (or (not (= |q#0| null)) (not true))) (=> (or (not (= |q#0| null)) (not true)) (and (=> (= (ControlFlow 0 20) (- 0 21)) ($IsAlloc refType |q#0| (Tclass._module.Queue TInt) $Heap)) (=> ($IsAlloc refType |q#0| (Tclass._module.Queue TInt) $Heap) (=> (= (ControlFlow 0 20) 16) anon3_correct))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc |q#0|)) (and (=> (= (ControlFlow 0 24) (- 0 28)) (or (not (= |q#0| null)) (not true))) (=> (or (not (= |q#0| null)) (not true)) (=> (or (not (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |q#0|) _module.Queue.contents))) 0)) (not true)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6)) (= $o@@6 |q#0|)))
 :qid |b3dfy.71:10|
 :skolemid |544|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6))
)) ($HeapSucc $Heap $Heap@0))) (and (=> (= (ControlFlow 0 24) (- 0 27)) (or (not (= |q#0| null)) (not true))) (=> (or (not (= |q#0| null)) (not true)) (and (=> (= (ControlFlow 0 24) (- 0 26)) ($IsAlloc refType |q#0| (Tclass._module.Queue TInt) $Heap)) (=> ($IsAlloc refType |q#0| (Tclass._module.Queue TInt) $Heap) (and (=> (= (ControlFlow 0 24) (- 0 25)) (or (not (= |q#0| null)) (not true))) (=> (or (not (= |q#0| null)) (not true)) (=> (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |q#0|) _module.Queue.contents))) (+ (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |q#0|) _module.Queue.contents))) 1)) (and (=> (= (ControlFlow 0 24) 20) anon9_Then_correct) (=> (= (ControlFlow 0 24) 23) anon9_Else_correct))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.Benchmark3) ($IsAlloc refType this Tclass._module.Benchmark3 $Heap)))) (and (and ($Is refType |q#0| (Tclass._module.Queue TInt)) ($IsAlloc refType |q#0| (Tclass._module.Queue TInt) $Heap)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 29) 24)))) anon0_correct)))
