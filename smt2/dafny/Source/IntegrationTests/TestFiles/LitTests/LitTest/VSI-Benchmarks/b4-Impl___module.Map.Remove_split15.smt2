...
(set-info :boogie-vc-id Impl$$_module.Map.Remove_split15)
...
)))) (= (ControlFlow 0 2) (- 0 1))) (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@3 this@@2))) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@3 this@@2) (forall ((|n#19| T@U) (|n'#7| T@U) ) (!  (=> (and ($Is refType |n#19| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) ($Is refType |n'#7| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25))) (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@2) _module.Map.Spine)) ($Box refType |n#19|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@2) _module.Map.Spine)) ($Box refType |n'#7|))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |n#19|) _module.Node.next)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |n'#7|) _module.Node.next)))) (= |n#19| |n'#7|)))
 :qid |b4dfy.28:13|
 :skolemid |835|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |n'#7|) _module.Node.next)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |n#19|) _module.Node.next)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |n'#7|) _module.Node.next)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@2) _module.Map.Spine)) ($Box refType |n#19|)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |n#19|) _module.Node.next)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@2) _module.Map.Spine)) ($Box refType |n'#7|)))
