...
(assert (distinct TInt TagInt TagSeq alloc allocName class._module.Queue? Tagclass._module.Queue? Tagclass._module.Queue Tagclass._module.Glossary? Tagclass._module.Glossary Tagclass._module.Word Tagclass._module.Word? tytagFamily$Queue tytagFamily$Glossary tytagFamily$Word field$contents)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((_module.Queue$T@@0 T@U) ($o@@1 T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType $o@@1 (Tclass._module.Queue? _module.Queue$T@@0) $h@@2)  (or (= $o@@1 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@1) alloc)))))
 :qid |unknown.0:0|
 :skolemid |505|
 :pattern ( ($IsAlloc refType $o@@1 (Tclass._module.Queue? _module.Queue$T@@0) $h@@2))
)))
...
(assert (forall (($o@@2 T@U) ($h@@3 T@U) ) (! (= ($IsAlloc refType $o@@2 Tclass._module.Glossary? $h@@3)  (or (= $o@@2 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@2) alloc)))))
 :qid |unknown.0:0|
 :skolemid |533|
 :pattern ( ($IsAlloc refType $o@@2 Tclass._module.Glossary? $h@@3))
)))
(assert (forall (($o@@3 T@U) ($h@@4 T@U) ) (! (= ($IsAlloc refType $o@@3 Tclass._module.Word? $h@@4)  (or (= $o@@3 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@3) alloc)))))
 :qid |unknown.0:0|
 :skolemid |634|
 :pattern ( ($IsAlloc refType $o@@3 Tclass._module.Word? $h@@4))
)))
...
(assert (forall ((_module.Queue$T@@5 T@U) ($h@@5 T@U) ($o@@4 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@5) (and (or (not (= $o@@4 null)) (not true)) (= (dtype $o@@4) (Tclass._module.Queue? _module.Queue$T@@5)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@4) alloc)))) ($IsAlloc SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@4) _module.Queue.contents)) (TSeq _module.Queue$T@@5) $h@@5))
 :qid |unknown.0:0|
 :skolemid |507|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@4) _module.Queue.contents)) (Tclass._module.Queue? _module.Queue$T@@5))
)))
...
(assert (forall ((bx@@0 T@U) ) (!  (=> ($IsBox bx@@0 Tclass._module.Glossary?) (and (= ($Box refType ($Unbox refType bx@@0)) bx@@0) ($Is refType ($Unbox refType bx@@0) Tclass._module.Glossary?)))
 :qid |unknown.0:0|
 :skolemid |531|
 :pattern ( ($IsBox bx@@0 Tclass._module.Glossary?))
)))
(assert (forall ((bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 Tclass._module.Glossary) (and (= ($Box refType ($Unbox refType bx@@1)) bx@@1) ($Is refType ($Unbox refType bx@@1) Tclass._module.Glossary)))
 :qid |unknown.0:0|
 :skolemid |534|
 :pattern ( ($IsBox bx@@1 Tclass._module.Glossary))
)))
...
(assert (forall ((_module.Queue$T@@7 T@U) ($o@@6 T@U) ) (! (= ($Is refType $o@@6 (Tclass._module.Queue? _module.Queue$T@@7))  (or (= $o@@6 null) (= (dtype $o@@6) (Tclass._module.Queue? _module.Queue$T@@7))))
 :qid |unknown.0:0|
 :skolemid |504|
 :pattern ( ($Is refType $o@@6 (Tclass._module.Queue? _module.Queue$T@@7)))
)))
(assert (forall ((|c#0@@3| T@U) ) (! (= ($Is refType |c#0@@3| Tclass._module.Glossary)  (and ($Is refType |c#0@@3| Tclass._module.Glossary?) (or (not (= |c#0@@3| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |631|
 :pattern ( ($Is refType |c#0@@3| Tclass._module.Glossary))
 :pattern ( ($Is refType |c#0@@3| Tclass._module.Glossary?))
)))
(assert (forall ((|c#0@@4| T@U) ) (! (= ($Is refType |c#0@@4| Tclass._module.Word)  (and ($Is refType |c#0@@4| Tclass._module.Word?) (or (not (= |c#0@@4| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |637|
 :pattern ( ($Is refType |c#0@@4| Tclass._module.Word))
 :pattern ( ($Is refType |c#0@@4| Tclass._module.Word?))
)))
(assert (forall ((_module.Queue$T@@8 T@U) ($h0 T@U) ($h1 T@U) (this@@1 T@U) (|i#0@@1| Int) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 (Tclass._module.Queue _module.Queue$T@@8)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@7 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@7 null)) (not true)) (= $o@@7 this@@1)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@7) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@7) $f@@0)))
 :qid |unknown.0:0|
 :skolemid |523|
...
(assert (forall ((_module.Queue$T@@12 T@U) ($h@@6 T@U) ($o@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (or (not (= $o@@8 null)) (not true)) (= (dtype $o@@8) (Tclass._module.Queue? _module.Queue$T@@12)))) ($Is SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@8) _module.Queue.contents)) (TSeq _module.Queue$T@@12)))
 :qid |unknown.0:0|
 :skolemid |506|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@8) _module.Queue.contents)) (Tclass._module.Queue? _module.Queue$T@@12))
)))
...
(assert (forall ((_module.Queue$T@@13 T@U) (bx@@7 T@U) ) (!  (=> ($IsBox bx@@7 (Tclass._module.Queue? _module.Queue$T@@13)) (and (= ($Box refType ($Unbox refType bx@@7)) bx@@7) ($Is refType ($Unbox refType bx@@7) (Tclass._module.Queue? _module.Queue$T@@13))))
 :qid |unknown.0:0|
 :skolemid |503|
 :pattern ( ($IsBox bx@@7 (Tclass._module.Queue? _module.Queue$T@@13)))
)))
(assert (forall ((_module.Queue$T@@14 T@U) (bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 (Tclass._module.Queue _module.Queue$T@@14)) (and (= ($Box refType ($Unbox refType bx@@8)) bx@@8) ($Is refType ($Unbox refType bx@@8) (Tclass._module.Queue _module.Queue$T@@14))))
 :qid |unknown.0:0|
 :skolemid |511|
 :pattern ( ($IsBox bx@@8 (Tclass._module.Queue _module.Queue$T@@14)))
)))
...
(declare-fun |r#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.Glossary.Sort)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon4_correct  (=> (forall ((|i#1| Int) (|j#1| Int) ) (!  (=> (and (and (<= (LitInt 0) |i#1|) (< |i#1| |j#1|)) (< |j#1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) _module.Queue.contents))))) (_module.Word.AtMost ($Unbox refType (_module.Queue.Get Tclass._module.Word $Heap@0 |r#0@0| |i#1|)) ($Unbox refType (_module.Queue.Get Tclass._module.Word $Heap@0 |r#0@0| |j#1|))))
 :qid |b8dfy.39:20|
 :skolemid |538|
 :pattern ( ($Unbox refType (_module.Queue.Get Tclass._module.Word $Heap@0 |r#0@0| |j#1|)) ($Unbox refType (_module.Queue.Get Tclass._module.Word $Heap@0 |r#0@0| |i#1|)))
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |r#0@0| null)) (not true))) (=> (or (not (= |r#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |q#0| null)) (not true))) (=> (or (not (= |q#0| null)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) ($IsAlloc refType |q#0| (Tclass._module.Queue Tclass._module.Word) $Heap@@2)))))))))
(let ((anon5_Else_correct  (=> (and (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |j#0@0|)) (< |j#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) _module.Queue.contents))))) (_module.Word.AtMost ($Unbox refType (_module.Queue.Get Tclass._module.Word $Heap@0 |r#0@0| |i#0@0|)) ($Unbox refType (_module.Queue.Get Tclass._module.Word $Heap@0 |r#0@0| |j#0@0|)))) (= (ControlFlow 0 14) 2)) anon4_correct)))
(let ((anon5_Then_correct  (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |j#0@0|)) (and (=> (= (ControlFlow 0 5) (- 0 13)) (or (not (= |r#0@0| null)) (not true))) (=> (or (not (= |r#0@0| null)) (not true)) (=> (< |j#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) _module.Queue.contents)))) (and (=> (= (ControlFlow 0 5) (- 0 12)) (or (not (= |r#0@0| null)) (not true))) (=> (or (not (= |r#0@0| null)) (not true)) (=> (and ($IsAllocBox ($Box refType |r#0@0|) (Tclass._module.Queue? Tclass._module.Word) $Heap@0) ($IsAlloc intType (int_2_U |i#0@0|) TInt $Heap@0)) (and (=> (= (ControlFlow 0 5) (- 0 11)) (<= (LitInt 0) |i#0@0|)) (and (=> (= (ControlFlow 0 5) (- 0 10)) (< |i#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) _module.Queue.contents))))) (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) _module.Queue.contents))))) (|_module.Queue.Get#canCall| Tclass._module.Word $Heap@0 |r#0@0| |i#0@0|)) (and (=> (= (ControlFlow 0 5) (- 0 9)) (or (not (= ($Unbox refType (_module.Queue.Get Tclass._module.Word $Heap@0 |r#0@0| |i#0@0|)) null)) (not true))) (=> (or (not (= ($Unbox refType (_module.Queue.Get Tclass._module.Word $Heap@0 |r#0@0| |i#0@0|)) null)) (not true)) (=> ($IsAllocBox (_module.Queue.Get Tclass._module.Word $Heap@0 |r#0@0| |i#0@0|) Tclass._module.Word? $Heap@0) (and (=> (= (ControlFlow 0 5) (- 0 8)) (or (not (= |r#0@0| null)) (not true))) (=> (or (not (= |r#0@0| null)) (not true)) (=> (and ($IsAllocBox ($Box refType |r#0@0|) (Tclass._module.Queue? Tclass._module.Word) $Heap@0) ($IsAlloc intType (int_2_U |j#0@0|) TInt $Heap@0)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (<= (LitInt 0) |j#0@0|)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< |j#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) _module.Queue.contents))))) (=> (and (and (and (<= (LitInt 0) |j#0@0|) (< |j#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) _module.Queue.contents))))) (and (|_module.Queue.Get#canCall| Tclass._module.Word $Heap@0 |r#0@0| |j#0@0|) (= |##w#0@0| ($Unbox refType (_module.Queue.Get Tclass._module.Word $Heap@0 |r#0@0| |j#0@0|))))) (and (and ($IsAlloc refType |##w#0@0| Tclass._module.Word $Heap@0) (|_module.Word.AtMost#canCall| ($Unbox refType (_module.Queue.Get Tclass._module.Word $Heap@0 |r#0@0| |i#0@0|)) ($Unbox refType (_module.Queue.Get Tclass._module.Word $Heap@0 |r#0@0| |j#0@0|)))) (and (_module.Word.AtMost ($Unbox refType (_module.Queue.Get Tclass._module.Word $Heap@0 |r#0@0| |i#0@0|)) ($Unbox refType (_module.Queue.Get Tclass._module.Word $Heap@0 |r#0@0| |j#0@0|))) (= (ControlFlow 0 5) 2)))) anon4_correct)))))))))))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc |q#0|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@9 T@U) ) (!  (=> (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@9) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@9) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@9)) (= $o@@9 |q#0|)))
 :qid |b8dfy.35:10|
 :skolemid |536|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@9))
)) ($HeapSucc $Heap@@2 $Heap@0))) (and (and ($Is refType |r#0@0| (Tclass._module.Queue Tclass._module.Word)) ($IsAlloc refType |r#0@0| (Tclass._module.Queue Tclass._module.Word) $Heap@0)) (and (or (not (= |r#0@0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |r#0@0|) alloc))))))) (and (=> (= (ControlFlow 0 15) (- 0 18)) (or (not (= |r#0@0| null)) (not true))) (=> (or (not (= |r#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 15) (- 0 17)) (or (not (= |q#0| null)) (not true))) (=> (or (not (= |q#0| null)) (not true)) (and (=> (= (ControlFlow 0 15) (- 0 16)) ($IsAlloc refType |q#0| (Tclass._module.Queue Tclass._module.Word) $Heap@@2)) (=> ($IsAlloc refType |q#0| (Tclass._module.Queue Tclass._module.Word) $Heap@@2) (=> (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) _module.Queue.contents))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |q#0|) _module.Queue.contents)))) (and (=> (= (ControlFlow 0 15) 5) anon5_Then_correct) (=> (= (ControlFlow 0 15) 14) anon5_Else_correct)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.Glossary) ($IsAlloc refType this@@3 Tclass._module.Glossary $Heap@@2))) (and ($Is refType |q#0| (Tclass._module.Queue Tclass._module.Word)) ($IsAlloc refType |q#0| (Tclass._module.Queue Tclass._module.Word) $Heap@@2))) (and (and ($Is refType |r#0| (Tclass._module.Queue Tclass._module.Word)) ($IsAlloc refType |r#0| (Tclass._module.Queue Tclass._module.Word) $Heap@@2)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 19) 15)))) anon0_correct))))
