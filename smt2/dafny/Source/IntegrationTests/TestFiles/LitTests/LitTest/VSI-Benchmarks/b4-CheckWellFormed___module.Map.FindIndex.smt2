...
(let ((anon16_Else_correct  (=> (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.Spine)) ($Box refType |prev#0@0|))) (= (ControlFlow 0 6) 2)) anon10_correct)))
(let ((anon16_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.Spine)) ($Box refType |prev#0@0|)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (not (= |prev#0@0| null)) (not true))) (=> (or (not (= |prev#0@0| null)) (not true)) (=> (= (ControlFlow 0 4) 2) anon10_correct))))))
(let ((anon15_Then_correct  (=> (or (not (= |p#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.head)))) (not true)) (and (=> (= (ControlFlow 0 7) 4) anon16_Then_correct) (=> (= (ControlFlow 0 7) 6) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (= |p#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.head))) (= (ControlFlow 0 3) 2)) anon10_correct)))
(let ((anon7_correct  (=> (=> (= |p#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.head))) (= |prev#0@0| null)) (and (=> (= (ControlFlow 0 8) 7) anon15_Then_correct) (=> (= (ControlFlow 0 8) 3) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (or (not (= |p#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.head)))) (not true)) (= (ControlFlow 0 10) 8)) anon7_correct)))
(let ((anon14_Then_correct  (=> (and (= |p#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.head))) (= (ControlFlow 0 9) 8)) anon7_correct)))
(let ((anon13_Then_correct  (=> (or (not (= |p#0@0| null)) (not true)) (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.M))) |key#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.Spine)) ($Box refType |p#0@0|))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (or (not (= |p#0@0| null)) (not true))) (=> (or (not (= |p#0@0| null)) (not true)) (=> (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |p#0@0|) _module.Node.key) |key#0|) (and (=> (= (ControlFlow 0 11) 9) anon14_Then_correct) (=> (= (ControlFlow 0 11) 10) anon14_Else_correct)))))))))
(let ((anon13_Else_correct true))
(let ((anon12_Else_correct  (=> (=> (= |p#0@0| null) (not (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.M))) |key#0|))) (and (=> (= (ControlFlow 0 14) 11) anon13_Then_correct) (=> (= (ControlFlow 0 14) 1) anon13_Else_correct)))))
(let ((anon12_Then_correct  (=> (and (= |p#0@0| null) (not (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.M))) |key#0|))) (and (=> (= (ControlFlow 0 13) 11) anon13_Then_correct) (=> (= (ControlFlow 0 13) 1) anon13_Else_correct)))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#3| null $Heap@@3 alloc false)) ($IsAllocBox ($Box refType this@@2) (Tclass._module.Map? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)) (and (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@24 T@U) ) (!  (=> (and (or (not (= $o@@24 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@24) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@24) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@24)))
 :qid |b4dfy.65:22|
 :skolemid |664|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@24))
)) ($HeapSucc $Heap@@3 $Heap@0))) (and (and ($Is refType |prev#0@0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType |prev#0@0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@0)) (and ($Is refType |p#0@0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType |p#0@0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@0)))) (and (=> (= (ControlFlow 0 15) 13) anon12_Then_correct) (=> (= (ControlFlow 0 15) 14) anon12_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 (Tclass._module.Map _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType this@@2 (Tclass._module.Map _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)))) (=> (and (and (and ($IsBox |key#0| _module.Map$Key@@25) ($IsAllocBox |key#0| _module.Map$Key@@25 $Heap@@3)) (and ($Is refType |prev#0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType |prev#0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3))) (and (and ($Is refType |p#0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType |p#0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 16) 15)))) anon0_correct))))
