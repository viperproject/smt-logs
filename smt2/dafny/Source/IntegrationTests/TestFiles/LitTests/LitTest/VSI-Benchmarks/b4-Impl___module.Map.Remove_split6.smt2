...
(set-info :boogie-vc-id Impl$$_module.Map.Remove_split6)
...
(assert (not
...
)))))) (and (and (=> (|_module.Map.Valid#canCall| _module.Map$Key@@23 _module.Map$Value@@23 $Heap@@3 this@@1) (or (_module.Map.Valid _module.Map$Key@@23 _module.Map$Value@@23 $Heap@@3 this@@1) (forall ((|n#2@@0| T@U) (|n'#0@@0| T@U) ) (!  (=> (and ($Is refType |n#2@@0| (Tclass._module.Node _module.Map$Key@@23 _module.Map$Value@@23)) ($Is refType |n'#0@@0| (Tclass._module.Node _module.Map$Key@@23 _module.Map$Value@@23))) (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n#2@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n'#0@@0|))) (or (not (= |n#2@@0| |n'#0@@0|)) (not true))) (or (not (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#2@@0|) _module.Node.key) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n'#0@@0|) _module.Node.key))) (not true))))
 :qid |b4dfy.26:13|
 :skolemid |668|
 ...
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n'#0@@0|) _module.Node.key) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n#2@@0|)))
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#2@@0|) _module.Node.key) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n'#0@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n'#0@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n#2@@0|)))
)))) (= (ControlFlow 0 2) (- 0 1))) (|_module.Map.Valid#canCall| _module.Map$Key@@23 _module.Map$Value@@23 $Heap@@3 this@@1)))) (or (_module.Map.Valid _module.Map$Key@@23 _module.Map$Value@@23 $Heap@@3 this@@1) (forall ((|n#3@@0| T@U) ) (!  (=> ($Is refType |n#3@@0| (Tclass._module.Node _module.Map$Key@@23 _module.Map$Value@@23)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n#3@@0|)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#3@@0|) _module.Node.next)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.head)))) (not true))))
 :qid |b4dfy.27:13|
 :skolemid |669|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n#3@@0|)))
))))))))
anon0_correct))
))
(check-sat)
