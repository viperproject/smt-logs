...
(set-info :boogie-vc-id Impl$$_module.Map.Remove_split7)
...
(assert (not
...
)))) (= (ControlFlow 0 2) (- 0 1))) (|_module.Map.Valid#canCall| _module.Map$Key@@23 _module.Map$Value@@23 $Heap@@3 this@@1)))) (or (_module.Map.Valid _module.Map$Key@@23 _module.Map$Value@@23 $Heap@@3 this@@1) (forall ((|n#4@@0| T@U) (|n'#1@@0| T@U) ) (!  (=> (and ($Is refType |n#4@@0| (Tclass._module.Node _module.Map$Key@@23 _module.Map$Value@@23)) ($Is refType |n'#1@@0| (Tclass._module.Node _module.Map$Key@@23 _module.Map$Value@@23))) (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n#4@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n'#1@@0|))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#4@@0|) _module.Node.next)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n'#1@@0|) _module.Node.next)))) (= |n#4@@0| |n'#1@@0|)))
 :qid |b4dfy.28:13|
 :skolemid |670|
 ...
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n'#1@@0|) _module.Node.next)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n#4@@0|)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#4@@0|) _module.Node.next)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n'#1@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n'#1@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n#4@@0|)))
))))))))
anon0_correct))
))
(check-sat)
