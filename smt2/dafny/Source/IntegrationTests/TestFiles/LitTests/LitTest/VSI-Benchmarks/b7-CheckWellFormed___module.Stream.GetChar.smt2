...
(set-info :boogie-vc-id CheckWellFormed$$_module.Stream.GetChar)
...
))) (and (=> (= (ControlFlow 0 2) (- 0 5)) ($IsAlloc refType this@@1 Tclass._module.Stream $Heap@@0)) (=> ($IsAlloc refType this@@1 Tclass._module.Stream $Heap@@0) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Stream.stream)))))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Stream.stream))))) (=> (= |x#0@0| (U_2_int ($Unbox intType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Stream.stream)) (LitInt 0))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType this@@1 Tclass._module.Stream $Heap@@0)) (=> ($IsAlloc refType this@@1 Tclass._module.Stream $Heap@@0) (=> (= (ControlFlow 0 2) (- 0 1)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Stream.stream)))))))))))))))))))))
