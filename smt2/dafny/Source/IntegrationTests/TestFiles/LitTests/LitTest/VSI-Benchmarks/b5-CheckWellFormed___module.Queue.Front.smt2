...
(assert (forall ((_module.Queue$T@@14 T@U) ($h@@17 T@U) ($o@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (or (not (= $o@@20 null)) (not true)) (= (dtype $o@@20) (Tclass._module.Queue? _module.Queue$T@@14)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@20) _module.Queue.head)) (Tclass._module.Node _module.Queue$T@@14)))
 :qid |unknown.0:0|
 :skolemid |487|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@20) _module.Queue.head)) (Tclass._module.Queue? _module.Queue$T@@14))
)))
(assert (forall ((_module.Queue$T@@15 T@U) ($h@@18 T@U) ($o@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (or (not (= $o@@21 null)) (not true)) (= (dtype $o@@21) (Tclass._module.Queue? _module.Queue$T@@15)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@21) _module.Queue.tail)) (Tclass._module.Node _module.Queue$T@@15)))
 :qid |unknown.0:0|
 :skolemid |489|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@21) _module.Queue.tail)) (Tclass._module.Queue? _module.Queue$T@@15))
)))
(assert (forall ((_module.Queue$T@@16 T@U) ($h@@19 T@U) ($o@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (or (not (= $o@@22 null)) (not true)) (= (dtype $o@@22) (Tclass._module.Queue? _module.Queue$T@@16)))) ($Is SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@22) _module.Queue.contents)) (TSeq _module.Queue$T@@16)))
 :qid |unknown.0:0|
 :skolemid |491|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@22) _module.Queue.contents)) (Tclass._module.Queue? _module.Queue$T@@16))
)))
(assert (forall ((_module.Node$T@@15 T@U) ($h@@20 T@U) ($o@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (or (not (= $o@@23 null)) (not true)) (= (dtype $o@@23) (Tclass._module.Node? _module.Node$T@@15)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@20 $o@@23) _module.Node.next)) (Tclass._module.Node? _module.Node$T@@15)))
 :qid |unknown.0:0|
 :skolemid |686|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@20 $o@@23) _module.Node.next)) (Tclass._module.Node? _module.Node$T@@15))
)))
(assert (forall ((_module.Node$T@@16 T@U) ($h@@21 T@U) ($o@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (or (not (= $o@@24 null)) (not true)) (= (dtype $o@@24) (Tclass._module.Node? _module.Node$T@@16)))) ($Is SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@21 $o@@24) _module.Node.tailContents)) (TSeq _module.Node$T@@16)))
 :qid |unknown.0:0|
 :skolemid |688|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@21 $o@@24) _module.Node.tailContents)) (Tclass._module.Node? _module.Node$T@@16))
)))
...
(assert (forall ((_module.Queue$T@@19 T@U) ($h@@22 T@U) ($o@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (or (not (= $o@@25 null)) (not true)) (= (dtype $o@@25) (Tclass._module.Queue? _module.Queue$T@@19)))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@22 $o@@25) _module.Queue.spine)) (TSet (Tclass._module.Node _module.Queue$T@@19))))
 :qid |unknown.0:0|
 :skolemid |495|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@22 $o@@25) _module.Queue.spine)) (Tclass._module.Queue? _module.Queue$T@@19))
)))
...
(declare-fun |t#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.Queue.Front)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@1 alloc false)) (=> (and (and ($IsAllocBox ($Box refType this@@3) (Tclass._module.Queue? _module.Queue$T@@21) $Heap@@1) (|_module.Queue.Valid#canCall| _module.Queue$T@@21 $Heap@@1 this@@3)) (and (_module.Queue.Valid _module.Queue$T@@21 $Heap@@1 this@@3) (< 0 (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.Queue.contents)))))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@26 T@U) ) (!  (=> (and (or (not (= $o@@26 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@26) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@26) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@26)))
 :qid |b5dfy.73:10|
 :skolemid |585|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@26))
)) ($HeapSucc $Heap@@1 $Heap@0))) (and (and ($IsBox |t#0@0| _module.Queue$T@@21) ($IsAllocBox |t#0@0| _module.Queue$T@@21 $Heap@0)) (= (ControlFlow 0 2) (- 0 1)))) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.Queue.contents))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 (Tclass._module.Queue _module.Queue$T@@21)) ($IsAlloc refType this@@3 (Tclass._module.Queue _module.Queue$T@@21) $Heap@@1)))) (and (and ($IsBox |t#0| _module.Queue$T@@21) ($IsAllocBox |t#0| _module.Queue$T@@21 $Heap@@1)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
