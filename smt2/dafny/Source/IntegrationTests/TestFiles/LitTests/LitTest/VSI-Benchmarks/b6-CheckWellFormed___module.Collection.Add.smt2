...
(declare-fun $Heap@0 () T@U)
(declare-fun |x#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.Collection.Add)
...
))) (= (ControlFlow 0 2) (- 0 1))) ($IsAlloc refType this@@1 (Tclass._module.Collection _module.Collection$T@@15) $Heap@@0))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 (Tclass._module.Collection _module.Collection$T@@15)) ($IsAlloc refType this@@1 (Tclass._module.Collection _module.Collection$T@@15) $Heap@@0)))) (and (and ($IsBox |x#0| _module.Collection$T@@15) ($IsAllocBox |x#0| _module.Collection$T@@15 $Heap@@0)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct)))
