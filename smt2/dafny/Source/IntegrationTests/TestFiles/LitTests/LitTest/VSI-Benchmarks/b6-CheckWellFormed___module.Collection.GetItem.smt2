...
(declare-fun |x#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.Collection.GetItem)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_correct  (=> (and (<= (LitInt 0) |i#0|) (< |i#0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Collection.elements))))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@9 T@U) ) (!  (=> (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@9) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@9) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@9)))
 :qid |b6dfy.28:10|
 :skolemid |508|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@9))
)) ($HeapSucc $Heap@@0 $Heap@0))) (and (and ($IsBox |x#0@0| _module.Collection$T@@15) ($IsAllocBox |x#0@0| _module.Collection$T@@15 $Heap@0)) (= (ControlFlow 0 2) (- 0 1)))) (and (<= 0 |i#0|) (< |i#0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@1) _module.Collection.elements)))))))))
(let ((anon4_Else_correct  (=> (and (< |i#0| (LitInt 0)) (= (ControlFlow 0 4) 2)) anon3_correct)))
(let ((anon4_Then_correct  (=> (and (<= (LitInt 0) |i#0|) (= (ControlFlow 0 3) 2)) anon3_correct)))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@0 alloc false)) ($IsAllocBox ($Box refType this@@1) (Tclass._module.Collection? _module.Collection$T@@15) $Heap@@0)) (and (|_module.Collection.Valid#canCall| _module.Collection$T@@15 $Heap@@0 this@@1) (_module.Collection.Valid _module.Collection$T@@15 $Heap@@0 this@@1))) (and (=> (= (ControlFlow 0 5) 3) anon4_Then_correct) (=> (= (ControlFlow 0 5) 4) anon4_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 (Tclass._module.Collection _module.Collection$T@@15)) ($IsAlloc refType this@@1 (Tclass._module.Collection _module.Collection$T@@15) $Heap@@0)))) (and (and ($IsBox |x#0| _module.Collection$T@@15) ($IsAllocBox |x#0| _module.Collection$T@@15 $Heap@@0)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 5)))) anon0_correct)))
