...
(assert (distinct TagSeq alloc Tagclass._module.Benchmark3? Tagclass._module.Benchmark3 tytagFamily$Benchmark3)
)
...
(assert (forall ((|c#0| T@U) ($h T@U) ) (! (= ($IsAlloc refType |c#0| Tclass._module.Benchmark3 $h) ($IsAlloc refType |c#0| Tclass._module.Benchmark3? $h))
 :qid |unknown.0:0|
 :skolemid |569|
 :pattern ( ($IsAlloc refType |c#0| Tclass._module.Benchmark3 $h))
 :pattern ( ($IsAlloc refType |c#0| Tclass._module.Benchmark3? $h))
)))
...
(assert (forall (($o@@0 T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType $o@@0 Tclass._module.Benchmark3? $h@@0)  (or (= $o@@0 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@0 $o@@0) alloc)))))
 :qid |unknown.0:0|
 :skolemid |521|
 :pattern ( ($IsAlloc refType $o@@0 Tclass._module.Benchmark3? $h@@0))
)))
...
(assert (forall ((|c#0@@0| T@U) ) (! (= ($Is refType |c#0@@0| Tclass._module.Benchmark3)  (and ($Is refType |c#0@@0| Tclass._module.Benchmark3?) (or (not (= |c#0@@0| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |568|
 :pattern ( ($Is refType |c#0@@0| Tclass._module.Benchmark3))
 :pattern ( ($Is refType |c#0@@0| Tclass._module.Benchmark3?))
)))
...
(assert (forall ((v@@4 T@U) (t0@@0 T@U) (h@@0 T@U) ) (! (= ($IsAlloc SeqType v@@4 (TSeq t0@@0) h@@0) (forall ((i@@0 Int) ) (!  (=> (and (<= 0 i@@0) (< i@@0 (|Seq#Length| v@@4))) ($IsAllocBox (|Seq#Index| v@@4 i@@0) t0@@0 h@@0))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@1 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#10| |l#0| |l#1| |l#2| |l#3|) $o@@1 $f))  (=> (and (or (not (= $o@@1 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@1) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |571|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#10| |l#0| |l#1| |l#2| |l#3|) $o@@1 $f))
)))
...
(declare-fun _module.Benchmark3.RotationLemma$_T0 () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id CheckWellFormed$$_module.Benchmark3.RotationLemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#10| null $Heap alloc false)) (< |j#0| (|Seq#Length| |O#0|))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (and (<= 0 |j#0|) (<= |j#0| (|Seq#Length| |O#0|)))) (=> (and (<= 0 |j#0|) (<= |j#0| (|Seq#Length| |O#0|))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (and (<= 0 |j#0|) (<= |j#0| (|Seq#Length| |O#0|)))) (=> (and (<= 0 |j#0|) (<= |j#0| (|Seq#Length| |O#0|))) (=> (|Seq#Equal| |A#0| (|Seq#Append| (|Seq#Drop| |O#0| |j#0|) (|Seq#Take| |O#0| |j#0|))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |A#0|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |A#0|))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= 0 |j#0|) (< |j#0| (|Seq#Length| |O#0|)))) (=> (and (<= 0 |j#0|) (< |j#0| (|Seq#Length| |O#0|))) (=> (|Seq#Equal| |C#0| (|Seq#Append| (|Seq#Drop| |A#0| (LitInt 1)) (|Seq#Build| |Seq#Empty| (|Seq#Index| |O#0| |j#0|)))) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 (+ |j#0| 1)) (<= (+ |j#0| 1) (|Seq#Length| |O#0|)))) (=> (and (<= 0 (+ |j#0| 1)) (<= (+ |j#0| 1) (|Seq#Length| |O#0|))) (=> (= (ControlFlow 0 2) (- 0 1)) (and (<= 0 (+ |j#0| 1)) (<= (+ |j#0| 1) (|Seq#Length| |O#0|))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.Benchmark3) ($IsAlloc refType this Tclass._module.Benchmark3 $Heap)))) (=> (and (and (and (and ($Is SeqType |O#0| (TSeq _module.Benchmark3.RotationLemma$_T0)) ($IsAlloc SeqType |O#0| (TSeq _module.Benchmark3.RotationLemma$_T0) $Heap)) (<= (LitInt 0) |j#0|)) (and ($Is SeqType |A#0| (TSeq _module.Benchmark3.RotationLemma$_T0)) ($IsAlloc SeqType |A#0| (TSeq _module.Benchmark3.RotationLemma$_T0) $Heap))) (and (and ($Is SeqType |C#0| (TSeq _module.Benchmark3.RotationLemma$_T0)) ($IsAlloc SeqType |C#0| (TSeq _module.Benchmark3.RotationLemma$_T0) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 8) 2)))) anon0_correct))))
