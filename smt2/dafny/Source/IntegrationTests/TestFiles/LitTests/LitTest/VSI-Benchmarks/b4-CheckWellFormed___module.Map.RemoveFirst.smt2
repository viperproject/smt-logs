...
(declare-fun |p#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.Map.RemoveFirst)
...
(let ((anon9_Else_correct  (=> (and (not (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |k#0@0|) (or (not (= |k#0@0| |key#0|)) (not true)))) (= (ControlFlow 0 6) 1)) anon6_correct)))
(let ((anon9_Then_correct  (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |k#0@0|) (or (not (= |k#0@0| |key#0|)) (not true))) (and (=> (= (ControlFlow 0 3) (- 0 5)) ($IsAlloc refType this@@2 (Tclass._module.Map _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)) (=> ($IsAlloc refType this@@2 (Tclass._module.Map _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3) (and (=> (= (ControlFlow 0 3) (- 0 4)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |k#0@0|)) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |k#0@0|) (=> (= (ControlFlow 0 3) 1) anon6_correct))))))))
(let ((anon8_Else_correct  (=> (not (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |k#0@0|)) (and (=> (= (ControlFlow 0 8) 3) anon9_Then_correct) (=> (= (ControlFlow 0 8) 6) anon9_Else_correct)))))
(let ((anon8_Then_correct  (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |k#0@0|) (and (=> (= (ControlFlow 0 7) 3) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))
(let ((anon7_Then_correct  (=> (and ($IsBox |k#0@0| _module.Map$Key@@25) ($IsAllocBox |k#0@0| _module.Map$Key@@25 $Heap@0)) (and (=> (= (ControlFlow 0 9) (- 0 10)) ($IsAlloc refType this@@2 (Tclass._module.Map _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)) (=> ($IsAlloc refType this@@2 (Tclass._module.Map _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3) (and (=> (= (ControlFlow 0 9) 7) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct)))))))
(let ((anon7_Else_correct  (=> (and (not (and ($IsBox |k#0@0| _module.Map$Key@@25) ($IsAllocBox |k#0@0| _module.Map$Key@@25 $Heap@0))) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@3 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Repr)))) (=> (and ($IsAllocBox ($Box refType this@@2) (Tclass._module.Map? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3) (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2)) (=> (and (and (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |key#0|)) (and (= |p#0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |p#0|)))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (or (not (= |p#0| null)) (not true))) (=> (or (not (= |p#0| null)) (not true)) (=> (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |p#0|) _module.Node.key) |key#0|) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@24 T@U) ) (!  (=> (and (or (not (= $o@@24 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@24) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@24) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@24)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Repr)) ($Box refType $o@@24))))
 :qid |b4dfy.155:22|
 :skolemid |848|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@24))
))) (and (and ($HeapSucc $Heap@@3 $Heap@0) ($IsAllocBox ($Box refType this@@2) (Tclass._module.Map? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@0)) (and (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@0 this@@2) (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@0 this@@2)))) (and (=> (= (ControlFlow 0 11) (- 0 12)) ($IsAlloc refType this@@2 (Tclass._module.Map _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)) (=> ($IsAlloc refType this@@2 (Tclass._module.Map _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3) (=> (and (forall (($o@@25 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.Repr)) ($Box refType $o@@25)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Repr)) ($Box refType $o@@25)))) (or (not (= $o@@25 null)) (not true)))
 :qid |b4dfy.160:24|
 :skolemid |849|
 :pattern (  (or (not (= $o@@25 null)) (not true)))
)) (forall (($o@@26 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.Repr)) ($Box refType $o@@26)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Repr)) ($Box refType $o@@26)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@26) alloc)))))
 :qid |b4dfy.160:24|
 :skolemid |850|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@26) alloc)))
))) (and (=> (= (ControlFlow 0 11) 9) anon7_Then_correct) (=> (= (ControlFlow 0 11) 2) anon7_Else_correct))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 (Tclass._module.Map _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType this@@2 (Tclass._module.Map _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3))) (and ($IsBox |key#0| _module.Map$Key@@25) ($IsAllocBox |key#0| _module.Map$Key@@25 $Heap@@3))) (and (and ($Is refType |p#0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType |p#0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 14) 11)))) anon0_correct))))
