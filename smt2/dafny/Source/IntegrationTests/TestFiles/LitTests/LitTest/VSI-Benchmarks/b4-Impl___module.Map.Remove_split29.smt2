...
(set-info :boogie-vc-id Impl$$_module.Map.Remove_split29)
...
)))) (= (ControlFlow 0 2) (- 0 1)))))))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.M))) |key#0|))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
