...
(set-info :boogie-vc-id Impl$$_module.Map.Remove_split33)
...
)))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.M))) |key#0|))) (and (and (or (not (= |call6formal@p#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.head)))) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.Spine)) ($Box refType |call6formal@p#0@0|))) (and (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |call6formal@p#0@0|) _module.Node.key) |key#0|) (= (ControlFlow 0 2) (- 0 1)))))))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.Spine)) ($Box refType |call5formal@prev#0@0|)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
