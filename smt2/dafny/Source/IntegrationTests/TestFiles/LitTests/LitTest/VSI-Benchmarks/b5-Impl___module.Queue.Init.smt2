...
(declare-fun this.spine@0 () T@U)
(declare-fun $Heap@1 () T@U)
(declare-fun |defass#n#4| () Bool)
(declare-fun |n#4| () T@U)
(set-info :boogie-vc-id Impl$$_module.Queue.Init)
...
(assert (not
...
))))) (=> (=> (|_module.Queue.Valid#canCall| _module.Queue$T@@21 $Heap@1 this@@3) (or (_module.Queue.Valid _module.Queue$T@@21 $Heap@1 this@@3) (forall ((|n#2@@0| T@U) ) (!  (=> ($Is refType |n#2@@0| (Tclass._module.Node _module.Queue$T@@21)) (and (and (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@3) _module.Queue.spine)) ($Box refType |n#2@@0|)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#2@@0|) _module.Node.footprint)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@3) _module.Queue.footprint)))) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@3) _module.Queue.spine)) ($Box refType |n#2@@0|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#2@@0|) _module.Node.footprint)) ($Box refType this@@3))))) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@3) _module.Queue.spine)) ($Box refType |n#2@@0|)) (_module.Node.Valid _module.Queue$T@@21 $Heap@1 |n#2@@0|))) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@3) _module.Queue.spine)) ($Box refType |n#2@@0|)) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#2@@0|) _module.Node.next)) null) (= |n#2@@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@3) _module.Queue.tail)))))))
 :qid |b5dfy.19:13|
 :skolemid |534|
 ...
 :pattern ( (_module.Node.Valid _module.Queue$T@@21 $Heap@1 |n#2@@0|))
...
))))) (=> (=> (|_module.Queue.Valid#canCall| _module.Queue$T@@21 $Heap@1 this@@3) (or (_module.Queue.Valid _module.Queue$T@@21 $Heap@1 this@@3) (forall ((|n#3@@0| T@U) ) (!  (=> ($Is refType |n#3@@0| (Tclass._module.Node _module.Queue$T@@21)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@3) _module.Queue.spine)) ($Box refType |n#3@@0|)) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#3@@0|) _module.Node.next)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@3) _module.Queue.spine)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#3@@0|) _module.Node.next)))))
 :qid |b5dfy.24:13|
 :skolemid |535|
...
)))) (=> (and (forall (($o@@31 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@3) _module.Queue.footprint)) ($Box refType $o@@31)) (or (not (= $o@@31 this@@3)) (not true))) (or (not (= $o@@31 null)) (not true)))
 :qid |b5dfy.31:24|
 :skolemid |538|
 :pattern (  (or (not (= $o@@31 null)) (not true)))
)) (forall (($o@@32 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@3) _module.Queue.footprint)) ($Box refType $o@@32)) (or (not (= $o@@32 this@@3)) (not true))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@32) alloc)))))
 :qid |b5dfy.31:24|
 :skolemid |539|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@32) alloc)))
))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@3) _module.Queue.contents))) (LitInt 0)))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (=> |defass#n#4| (and ($Is refType |n#4| (Tclass._module.Node _module.Queue$T@@21)) ($IsAlloc refType |n#4| (Tclass._module.Node _module.Queue$T@@21) $Heap@@1))) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 21) 2))) anon0_correct))))
