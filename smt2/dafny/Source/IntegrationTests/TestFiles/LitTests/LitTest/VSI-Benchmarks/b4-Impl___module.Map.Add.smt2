...
(assert (forall ((m@@3 T@U) ) (!  (or (= m@@3 |Map#Empty|) (exists ((k@@3 T@U) ) (! (|Set#IsMember| (|Map#Domain| m@@3) k@@3)
...
(assert (forall ((h@@6 T@U) (r T@U) (f@@0 T@U) (x@@7 T@U) ) (!  (=> ($IsGoodHeap (MapType0Store refType (MapType0Type FieldType BoxType) h@@6 r (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h@@6 r) f@@0 x@@7))) ($HeapSucc h@@6 (MapType0Store refType (MapType0Type FieldType BoxType) h@@6 r (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h@@6 r) f@@0 x@@7))))
 :qid |DafnyPreludebpl.603:15|
 :skolemid |116|
 :pattern ( (MapType0Store refType (MapType0Type FieldType BoxType) h@@6 r (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h@@6 r) f@@0 x@@7)))
)))
...
(assert (forall ((m@@11 T@U) ) (!  (or (= m@@11 |Map#Empty|) (exists ((k@@4 T@U) (v@@9 T@U) ) (! (|Set#IsMember| (|Map#Items| m@@11) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| k@@4 v@@9)))
...
(declare-fun |##spine#1_2@0| () T@U)
(declare-fun |##n#1_2@0| () T@U)
(declare-fun |$w$loop#1_0@0| () Bool)
(declare-fun |##spine#1_1@0| () T@U)
(declare-fun |##n#1_1@0| () T@U)
(declare-fun $Heap@10 () T@U)
(declare-fun |key#0| () T@U)
(declare-fun |val#0| () T@U)
(declare-fun |call6formal@p#0@0| () T@U)
(declare-fun call5formal@this () T@U)
(declare-fun call0formal@_module.Node$Key () T@U)
(declare-fun call1formal@_module.Node$Value () T@U)
...
(declare-fun $Heap@3 () T@U)
(declare-fun |$rhs#0_3@0| () T@U)
(declare-fun |$rhs#0_4@0| () T@U)
(declare-fun $Heap@4 () T@U)
(declare-fun $Heap@5 () T@U)
(declare-fun $Heap@6 () T@U)
(declare-fun |$rhs#0_5@0| () T@U)
(declare-fun $Heap@7 () T@U)
(declare-fun |$rhs#1_0_0@1| () T@U)
(declare-fun |$rhs#1_0_1@1| () T@U)
...
(set-info :boogie-vc-id Impl$$_module.Map.Add)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 66) (let ((anon7_correct true))
(let ((anon15_Else_correct  (=> (and (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@9 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.head))) (= (ControlFlow 0 39) 36)) anon7_correct)))
(let ((anon15_Then_correct  (=> (not (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@9 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.head)))) (=> (and (and ($IsAlloc SetType |s'#1_0@0| (TSet (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) $Heap@9) ($IsAlloc refType |p'#1_0@0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@9)) (and (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@9 |s'#1_0@0| |p'#1_0@0|) (= (ControlFlow 0 38) 36))) anon7_correct))))
(let ((anon14_Then_correct  (=> (and (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (= |##spine#1_2@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.Spine)))) (=> (and (and ($IsAlloc SetType |##spine#1_2@0| (TSet (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) $Heap@9) (= |##n#1_2@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.head)))) (and ($IsAlloc refType |##n#1_2@0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@9) (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@9 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.head))))) (and (=> (= (ControlFlow 0 40) 38) anon15_Then_correct) (=> (= (ControlFlow 0 40) 39) anon15_Else_correct))))))
(let ((anon14_Else_correct  (=> (and (not (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (= (ControlFlow 0 37) 36)) anon7_correct)))
(let ((anon13_Then_correct  (=> (and (not |$w$loop#1_0@0|) ($IsAllocBox ($Box refType |p'#1_0@0|) (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)) (and (=> (= (ControlFlow 0 41) (- 0 47)) ($IsAlloc SetType |s'#1_0@0| (TSet (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) $Heap@@3)) (=> ($IsAlloc SetType |s'#1_0@0| (TSet (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) $Heap@@3) (and (=> (= (ControlFlow 0 41) (- 0 46)) ($IsAlloc refType |p'#1_0@0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)) (=> ($IsAlloc refType |p'#1_0@0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3) (=> (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 |s'#1_0@0| |p'#1_0@0|) (=> (and (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 |s'#1_0@0| |p'#1_0@0|) (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 |s'#1_0@0| |p'#1_0@0|)) (and (=> (= (ControlFlow 0 41) (- 0 45)) ($IsAlloc refType this@@2 (Tclass._module.Map _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)) (=> ($IsAlloc refType this@@2 (Tclass._module.Map _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3) (=> (= |##spine#1_1@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine))) (and (=> (= (ControlFlow 0 41) (- 0 44)) ($IsAlloc refType this@@2 (Tclass._module.Map _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)) (=> ($IsAlloc refType this@@2 (Tclass._module.Map _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3) (=> (= |##n#1_1@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (and (=> (= (ControlFlow 0 41) (- 0 43)) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) (TSet (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) $Heap@@3)) (=> ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) (TSet (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) $Heap@@3) (and (=> (= (ControlFlow 0 41) (- 0 42)) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)) (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)) (=> ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)) (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3) (=> (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (and (=> (= (ControlFlow 0 41) 40) anon14_Then_correct) (=> (= (ControlFlow 0 41) 37) anon14_Else_correct))))))))))))))))))))))
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 10) (- 0 19)) (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Repr)) ($Box refType this@@2))))) (=> (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Repr)) ($Box refType this@@2)))) (and (=> (= (ControlFlow 0 10) (- 0 18)) (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Repr)))))) (=> (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Repr))))) (and (=> (= (ControlFlow 0 10) (- 0 17)) (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (=> (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.head))) (or (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@10 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.head))) (or (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.head)) null) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) |Set#Empty|)) (and (and (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.head)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.head))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.head))) _module.Node.Spine)) (|Set#Difference| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) (|Set#UnionOne| |Set#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.head))))) (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS ($LS $LZ)) $Heap@10 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.head))) _module.Node.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.head))) _module.Node.next)))))))))) (=> (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (=> (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.head))) (or (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@10 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.head))) (or (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.head)) null) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) |Set#Empty|)) (and (and (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.head)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.head))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.head))) _module.Node.Spine)) (|Set#Difference| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) (|Set#UnionOne| |Set#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.head))))) (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS ($LS $LZ)) $Heap@10 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.head))) _module.Node.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.head))) _module.Node.next))))))))) (and (=> (= (ControlFlow 0 10) (- 0 16)) (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (forall ((|k#3| T@U) ) (!  (=> ($IsBox |k#3| _module.Map$Key@@25) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.M))) |k#3|) (exists ((|n#15| T@U) ) (!  (and ($Is refType |n#15| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#15|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#15|) _module.Node.key) |k#3|)))
 :qid |b4dfy.24:36|
 :skolemid |769|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#15|) _module.Node.key))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#15|)))
))))
 :qid |b4dfy.24:13|
 :skolemid |770|
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.M))) |k#3|))
))))) (=> (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (forall ((|k#3@@0| T@U) ) (!  (=> ($IsBox |k#3@@0| _module.Map$Key@@25) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.M))) |k#3@@0|) (exists ((|n#15@@0| T@U) ) (!  (and ($Is refType |n#15@@0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#15@@0|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#15@@0|) _module.Node.key) |k#3@@0|)))
 :qid |b4dfy.24:36|
 :skolemid |769|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#15@@0|) _module.Node.key))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#15@@0|)))
))))
 :qid |b4dfy.24:13|
 :skolemid |770|
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.M))) |k#3@@0|))
)))) (and (=> (= (ControlFlow 0 10) (- 0 15)) (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (forall ((|n#16| T@U) ) (!  (=> ($Is refType |n#16| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#16|)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.M))) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#16|) _module.Node.key))) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#16|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#16|) _module.Node.val) (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.M))) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#16|) _module.Node.key))))))
 :qid |b4dfy.25:13|
 :skolemid |771|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#16|) _module.Node.val))
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#16|) _module.Node.key))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#16|)))
))))) (=> (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (forall ((|n#16@@0| T@U) ) (!  (=> ($Is refType |n#16@@0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#16@@0|)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.M))) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#16@@0|) _module.Node.key))) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#16@@0|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#16@@0|) _module.Node.val) (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.M))) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#16@@0|) _module.Node.key))))))
 :qid |b4dfy.25:13|
 :skolemid |771|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#16@@0|) _module.Node.val))
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#16@@0|) _module.Node.key))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#16@@0|)))
)))) (and (=> (= (ControlFlow 0 10) (- 0 14)) (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (forall ((|n#17| T@U) (|n'#6| T@U) ) (!  (=> (and ($Is refType |n#17| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) ($Is refType |n'#6| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25))) (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#17|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n'#6|))) (or (not (= |n#17| |n'#6|)) (not true))) (or (not (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#17|) _module.Node.key) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n'#6|) _module.Node.key))) (not true))))
 :qid |b4dfy.26:13|
 :skolemid |772|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n'#6|) _module.Node.key) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#17|) _module.Node.key))
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n'#6|) _module.Node.key) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#17|)))
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#17|) _module.Node.key) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n'#6|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n'#6|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#17|)))
))))) (=> (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (forall ((|n#17@@0| T@U) (|n'#6@@0| T@U) ) (!  (=> (and ($Is refType |n#17@@0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) ($Is refType |n'#6@@0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25))) (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#17@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n'#6@@0|))) (or (not (= |n#17@@0| |n'#6@@0|)) (not true))) (or (not (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#17@@0|) _module.Node.key) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n'#6@@0|) _module.Node.key))) (not true))))
 :qid |b4dfy.26:13|
 :skolemid |772|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n'#6@@0|) _module.Node.key) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#17@@0|) _module.Node.key))
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n'#6@@0|) _module.Node.key) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#17@@0|)))
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#17@@0|) _module.Node.key) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n'#6@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n'#6@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#17@@0|)))
)))) (and (=> (= (ControlFlow 0 10) (- 0 13)) (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (forall ((|n#18| T@U) ) (!  (=> ($Is refType |n#18| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#18|)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#18|) _module.Node.next)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.head)))) (not true))))
 :qid |b4dfy.27:13|
 :skolemid |773|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#18|) _module.Node.next)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#18|)))
))))) (=> (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (forall ((|n#18@@0| T@U) ) (!  (=> ($Is refType |n#18@@0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#18@@0|)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#18@@0|) _module.Node.next)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.head)))) (not true))))
 :qid |b4dfy.27:13|
 :skolemid |773|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#18@@0|) _module.Node.next)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#18@@0|)))
)))) (and (=> (= (ControlFlow 0 10) (- 0 12)) (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (forall ((|n#19| T@U) (|n'#7| T@U) ) (!  (=> (and ($Is refType |n#19| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) ($Is refType |n'#7| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25))) (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#19|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n'#7|))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#19|) _module.Node.next)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n'#7|) _module.Node.next)))) (= |n#19| |n'#7|)))
 :qid |b4dfy.28:13|
 :skolemid |774|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n'#7|) _module.Node.next)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#19|) _module.Node.next)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n'#7|) _module.Node.next)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#19|)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#19|) _module.Node.next)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n'#7|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n'#7|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#19|)))
))))) (=> (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@10 this@@2) (forall ((|n#19@@0| T@U) (|n'#7@@0| T@U) ) (!  (=> (and ($Is refType |n#19@@0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) ($Is refType |n'#7@@0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25))) (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#19@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n'#7@@0|))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#19@@0|) _module.Node.next)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n'#7@@0|) _module.Node.next)))) (= |n#19@@0| |n'#7@@0|)))
 :qid |b4dfy.28:13|
 :skolemid |774|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n'#7@@0|) _module.Node.next)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#19@@0|) _module.Node.next)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n'#7@@0|) _module.Node.next)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#19@@0|)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#19@@0|) _module.Node.next)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n'#7@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n'#7@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Spine)) ($Box refType |n#19@@0|)))
)))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (and (forall (($o@@24 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.Repr)) ($Box refType $o@@24)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Repr)) ($Box refType $o@@24)))) (or (not (= $o@@24 null)) (not true)))
 :qid |b4dfy.111:24|
 :skolemid |781|
...
))) (=> (= (ControlFlow 0 10) (- 0 9)) (|Map#Equal| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@2) _module.Map.M)) (|Map#Build| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M)) |key#0| |val#0|)))))))))))))))))))))))
(let ((anon16_Then_correct  (=> (= |p'#1_0@0| null) (=> (and (= $Heap@10 $Heap@9) (= (ControlFlow 0 34) 10)) GeneratedUnifiedExit_correct))))
(let ((anon11_Then_correct  (=> (= |call6formal@p#0@0| null) (=> (and (and (or (not (= call5formal@this null)) (not true)) (and ($Is refType call5formal@this (Tclass._module.Node call0formal@_module.Node$Key call1formal@_module.Node$Value)) ($IsAlloc refType call5formal@this (Tclass._module.Node call0formal@_module.Node$Key call1formal@_module.Node$Value) $Heap@@3))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1))) (=> (and (and (and (or (not (= call5formal@this@0 null)) (not true)) (and ($Is refType call5formal@this@0 (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType call5formal@this@0 (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25) $Heap@1))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call5formal@this@0) _module.Node.key) |key#0|)) (and (and (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call5formal@this@0) _module.Node.val) |val#0|) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call5formal@this@0) alloc))))) (and (forall (($o@@28 T@U) ) (!  (=> (and (or (not (= $o@@28 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@28) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@28) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@28)))
 :qid |b4dfy.216:3|
 :skolemid |990|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@28))
)) ($HeapSucc $Heap@0 $Heap@1)))) (and (=> (= (ControlFlow 0 20) (- 0 33)) true) (and (=> (= (ControlFlow 0 20) (- 0 32)) (or (not (= call5formal@this@0 null)) (not true))) (=> (or (not (= call5formal@this@0 null)) (not true)) (and (=> (= (ControlFlow 0 20) (- 0 31)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 call5formal@this@0 _module.Node.next))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 call5formal@this@0 _module.Node.next)) (and (=> (= (ControlFlow 0 20) (- 0 30)) true) (and (=> (= (ControlFlow 0 20) (- 0 29)) (or (not (= call5formal@this@0 null)) (not true))) (=> (or (not (= call5formal@this@0 null)) (not true)) (and (=> (= (ControlFlow 0 20) (- 0 28)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 call5formal@this@0 _module.Node.Spine))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 call5formal@this@0 _module.Node.Spine)) (=> (and (= |$rhs#0_0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) _module.Map.head))) (= |$rhs#0_1@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) _module.Map.Spine)))) (=> (and (and (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 call5formal@this@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call5formal@this@0) _module.Node.next ($Box refType |$rhs#0_0@0|)))) ($IsGoodHeap $Heap@2)) (and (= $Heap@3 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@2 call5formal@this@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call5formal@this@0) _module.Node.Spine ($Box SetType |$rhs#0_1@0|)))) ($IsGoodHeap $Heap@3))) (and (=> (= (ControlFlow 0 20) (- 0 27)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@2 _module.Map.head))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@2 _module.Map.head)) (and (=> (= (ControlFlow 0 20) (- 0 26)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@2 _module.Map.Spine))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@2 _module.Map.Spine)) (and (=> (= (ControlFlow 0 20) (- 0 25)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@2 _module.Map.Repr))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@2 _module.Map.Repr)) (and (=> (= (ControlFlow 0 20) (- 0 24)) true) (and (=> (= (ControlFlow 0 20) (- 0 23)) true) (=> (= |$rhs#0_3@0| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@2) _module.Map.Spine)) (|Set#UnionOne| |Set#Empty| ($Box refType call5formal@this@0)))) (and (=> (= (ControlFlow 0 20) (- 0 22)) true) (=> (= |$rhs#0_4@0| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@2) _module.Map.Repr)) (|Set#UnionOne| |Set#Empty| ($Box refType call5formal@this@0)))) (=> (and (= $Heap@4 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@3 this@@2 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@2) _module.Map.head ($Box refType call5formal@this@0)))) ($IsGoodHeap $Heap@4)) (=> (and (and (= $Heap@5 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@4 this@@2 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@2) _module.Map.Spine ($Box SetType |$rhs#0_3@0|)))) ($IsGoodHeap $Heap@5)) (and (= $Heap@6 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@5 this@@2 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@2) _module.Map.Repr ($Box SetType |$rhs#0_4@0|)))) ($IsGoodHeap $Heap@6))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@2 _module.Map.M))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@2 _module.Map.M)) (=> (= |$rhs#0_5@0| (|Map#Build| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@2) _module.Map.M)) |key#0| |val#0|)) (=> (and (and (= $Heap@7 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@6 this@@2 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@2) _module.Map.M ($Box MapType |$rhs#0_5@0|)))) ($IsGoodHeap $Heap@7)) (and (= $Heap@10 $Heap@7) (= (ControlFlow 0 20) 10))) GeneratedUnifiedExit_correct))))))))))))))))))))))))))))))))))
(let ((anon16_Else_correct  (=> (or (not (= |p'#1_0@0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 8)) (or (not (= |p'#1_0@0| null)) (not true))) (=> (or (not (= |p'#1_0@0| null)) (not true)) (=> (= |$rhs#1_0_0@1| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |p'#1_0@0|) _module.Node.Spine))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (or (not (= |p'#1_0@0| null)) (not true))) (=> (or (not (= |p'#1_0@0| null)) (not true)) (=> (= |$rhs#1_0_1@1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |p'#1_0@0|) _module.Node.next))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (and (|Set#Subset| |$rhs#1_0_0@1| |s'#1_0@0|) (not (|Set#Subset| |s'#1_0@0| |$rhs#1_0_0@1|)))) (=> (and (|Set#Subset| |$rhs#1_0_0@1| |s'#1_0@0|) (not (|Set#Subset| |s'#1_0@0| |$rhs#1_0_0@1|))) (=> (=> ($IsAllocBox ($Box refType |$rhs#1_0_1@1|) (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3) (and (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 |$rhs#1_0_0@1| |$rhs#1_0_1@1|) (=> (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 |$rhs#1_0_0@1| |$rhs#1_0_1@1|) (and (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (=> (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (and (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@9 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.head))) (=> (not (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@9 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.head)))) (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@9 |$rhs#1_0_0@1| |$rhs#1_0_1@1|)))))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (=> |$w$loop#1_0@0| ($IsAllocBox ($Box refType |$rhs#1_0_1@1|) (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3))) (=> (=> |$w$loop#1_0@0| ($IsAllocBox ($Box refType |$rhs#1_0_1@1|) (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> |$w$loop#1_0@0| (=> (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 |$rhs#1_0_0@1| |$rhs#1_0_1@1|) (or (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 |$rhs#1_0_0@1| |$rhs#1_0_1@1|) (or (and (= |$rhs#1_0_1@1| null) (|Set#Equal| |$rhs#1_0_0@1| |Set#Empty|)) (and (and (and (or (not (= |$rhs#1_0_1@1| null)) (not true)) (|Set#IsMember| |$rhs#1_0_0@1| ($Box refType |$rhs#1_0_1@1|))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |$rhs#1_0_1@1|) _module.Node.Spine)) (|Set#Difference| |$rhs#1_0_0@1| (|Set#UnionOne| |Set#Empty| ($Box refType |$rhs#1_0_1@1|))))) (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS ($LS $LZ)) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |$rhs#1_0_1@1|) _module.Node.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |$rhs#1_0_1@1|) _module.Node.next))))))))) (=> (=> |$w$loop#1_0@0| (=> (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 |$rhs#1_0_0@1| |$rhs#1_0_1@1|) (or (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 |$rhs#1_0_0@1| |$rhs#1_0_1@1|) (or (and (= |$rhs#1_0_1@1| null) (|Set#Equal| |$rhs#1_0_0@1| |Set#Empty|)) (and (and (and (or (not (= |$rhs#1_0_1@1| null)) (not true)) (|Set#IsMember| |$rhs#1_0_0@1| ($Box refType |$rhs#1_0_1@1|))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |$rhs#1_0_1@1|) _module.Node.Spine)) (|Set#Difference| |$rhs#1_0_0@1| (|Set#UnionOne| |Set#Empty| ($Box refType |$rhs#1_0_1@1|))))) (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS ($LS $LZ)) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |$rhs#1_0_1@1|) _module.Node.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |$rhs#1_0_1@1|) _module.Node.next)))))))) (=> (= (ControlFlow 0 3) (- 0 2)) (=> |$w$loop#1_0@0| (=> (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (or (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS ($LS $LZ)) $Heap@9 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.head))) (not (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS ($LS $LZ)) $Heap@9 |$rhs#1_0_0@1| |$rhs#1_0_1@1|))))))))))))))))))))))
(let ((anon13_Else_correct  (=> |$w$loop#1_0@0| (and (=> (= (ControlFlow 0 35) 34) anon16_Then_correct) (=> (= (ControlFlow 0 35) 3) anon16_Else_correct)))))
(let ((anon12_LoopBody_correct  (and (=> (= (ControlFlow 0 48) 41) anon13_Then_correct) (=> (= (ControlFlow 0 48) 35) anon13_Else_correct))))
(let ((anon12_LoopDone_correct true))
(let ((anon12_LoopHead_correct  (=> (and ($Is SetType |s'#1_0@0| (TSet (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25))) ($IsAlloc SetType |s'#1_0@0| (TSet (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) $Heap@9)) (=> (and (and (and (and ($Is refType |p'#1_0@0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType |p'#1_0@0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@9)) (not false)) (and (=> |$w$loop#1_0@0| ($IsAllocBox ($Box refType |p'#1_0@0|) (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)) (=> |$w$loop#1_0@0| (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 |s'#1_0@0| |p'#1_0@0|)))) (and (and (and (=> |$w$loop#1_0@0| (=> (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 |s'#1_0@0| |p'#1_0@0|) (or (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 |s'#1_0@0| |p'#1_0@0|) (or (and (= |p'#1_0@0| null) (|Set#Equal| |s'#1_0@0| |Set#Empty|)) (and (and (and (or (not (= |p'#1_0@0| null)) (not true)) (|Set#IsMember| |s'#1_0@0| ($Box refType |p'#1_0@0|))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |p'#1_0@0|) _module.Node.Spine)) (|Set#Difference| |s'#1_0@0| (|Set#UnionOne| |Set#Empty| ($Box refType |p'#1_0@0|))))) (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS ($LS $LZ)) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |p'#1_0@0|) _module.Node.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |p'#1_0@0|) _module.Node.next)))))))) (=> |$w$loop#1_0@0| (and (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 |s'#1_0@0| |p'#1_0@0|) (and (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 |s'#1_0@0| |p'#1_0@0|) (or (and (= |p'#1_0@0| null) (|Set#Equal| |s'#1_0@0| |Set#Empty|)) (and (and (and (or (not (= |p'#1_0@0| null)) (not true)) (|Set#IsMember| |s'#1_0@0| ($Box refType |p'#1_0@0|))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |p'#1_0@0|) _module.Node.Spine)) (|Set#Difference| |s'#1_0@0| (|Set#UnionOne| |Set#Empty| ($Box refType |p'#1_0@0|))))) (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |p'#1_0@0|) _module.Node.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |p'#1_0@0|) _module.Node.next))))))))) (and (=> |$w$loop#1_0@0| (and (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (=> (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (and (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@9 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.head))) (=> (not (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@9 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.head)))) (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@9 |s'#1_0@0| |p'#1_0@0|)))))) (=> |$w$loop#1_0@0| (=> (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (or (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS ($LS $LZ)) $Heap@9 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.head))) (not (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS ($LS $LZ)) $Heap@9 |s'#1_0@0| |p'#1_0@0|))))))) (and (and (forall (($o@@29 T@U) ) (!  (=> (and (or (not (= $o@@29 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@29) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@29) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@29)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Repr)) ($Box refType $o@@29))))
 :qid |b4dfy.127:7|
 :skolemid |786|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@29))
)) ($HeapSuccGhost $Heap@9 $Heap@9)) (and (forall (($o@@30 T@U) ($f@@2 T@U) ) (!  (=> (and (or (not (= $o@@30 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@30) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@30) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@30) $f@@2)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@30 $f@@2))))
 :qid |b4dfy.127:7|
 :skolemid |787|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@30) $f@@2))
)) (|Set#Subset| |s'#1_0@0| |$rhs#1_2@0|))))) (and (=> (= (ControlFlow 0 49) 1) anon12_LoopDone_correct) (=> (= (ControlFlow 0 49) 48) anon12_LoopBody_correct))))))
(let ((anon11_Else_correct  (=> (or (not (= |call6formal@p#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 50) (- 0 56)) (or (not (= |call6formal@p#0@0| null)) (not true))) (=> (or (not (= |call6formal@p#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 50) (- 0 55)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |call6formal@p#0@0| _module.Node.val))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |call6formal@p#0@0| _module.Node.val)) (=> (and (= $Heap@8 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 |call6formal@p#0@0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |call6formal@p#0@0|) _module.Node.val |val#0|))) ($IsGoodHeap $Heap@8)) (and (=> (= (ControlFlow 0 50) (- 0 54)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@2 _module.Map.M))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@2 _module.Map.M)) (=> (= |$rhs#1_1@0| (|Map#Build| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@2) _module.Map.M)) |key#0| |val#0|)) (=> (and (and (= $Heap@9 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@8 this@@2 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@2) _module.Map.M ($Box MapType |$rhs#1_1@0|)))) ($IsGoodHeap $Heap@9)) (and (= |$rhs#1_2@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.Spine))) (= |$rhs#1_3@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.head))))) (and (=> (= (ControlFlow 0 50) (- 0 53)) (=> |$w$loop#1_0@0| ($IsAllocBox ($Box refType |$rhs#1_3@0|) (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3))) (=> (=> |$w$loop#1_0@0| ($IsAllocBox ($Box refType |$rhs#1_3@0|) (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)) (and (=> (= (ControlFlow 0 50) (- 0 52)) (=> |$w$loop#1_0@0| (=> (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 |$rhs#1_2@0| |$rhs#1_3@0|) (or (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 |$rhs#1_2@0| |$rhs#1_3@0|) (or (and (= |$rhs#1_3@0| null) (|Set#Equal| |$rhs#1_2@0| |Set#Empty|)) (and (and (and (or (not (= |$rhs#1_3@0| null)) (not true)) (|Set#IsMember| |$rhs#1_2@0| ($Box refType |$rhs#1_3@0|))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |$rhs#1_3@0|) _module.Node.Spine)) (|Set#Difference| |$rhs#1_2@0| (|Set#UnionOne| |Set#Empty| ($Box refType |$rhs#1_3@0|))))) (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS ($LS $LZ)) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |$rhs#1_3@0|) _module.Node.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |$rhs#1_3@0|) _module.Node.next))))))))) (=> (=> |$w$loop#1_0@0| (=> (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 |$rhs#1_2@0| |$rhs#1_3@0|) (or (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 |$rhs#1_2@0| |$rhs#1_3@0|) (or (and (= |$rhs#1_3@0| null) (|Set#Equal| |$rhs#1_2@0| |Set#Empty|)) (and (and (and (or (not (= |$rhs#1_3@0| null)) (not true)) (|Set#IsMember| |$rhs#1_2@0| ($Box refType |$rhs#1_3@0|))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |$rhs#1_3@0|) _module.Node.Spine)) (|Set#Difference| |$rhs#1_2@0| (|Set#UnionOne| |Set#Empty| ($Box refType |$rhs#1_3@0|))))) (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS ($LS $LZ)) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |$rhs#1_3@0|) _module.Node.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |$rhs#1_3@0|) _module.Node.next)))))))) (and (=> (= (ControlFlow 0 50) (- 0 51)) (=> |$w$loop#1_0@0| (=> (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (or (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS ($LS $LZ)) $Heap@9 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.head))) (not (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS ($LS $LZ)) $Heap@9 |$rhs#1_2@0| |$rhs#1_3@0|)))))) (=> (=> |$w$loop#1_0@0| (=> (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (or (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS ($LS $LZ)) $Heap@9 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@2) _module.Map.head))) (not (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS ($LS $LZ)) $Heap@9 |$rhs#1_2@0| |$rhs#1_3@0|))))) (=> (= (ControlFlow 0 50) 49) anon12_LoopHead_correct)))))))))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@3 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Repr)))) (=> (and (and ($Is refType |call5formal@prev#0| (Tclass._module.Node? call0formal@_module.Map$Key call1formal@_module.Map$Value)) ($IsAlloc refType |call5formal@prev#0| (Tclass._module.Node? call0formal@_module.Map$Key call1formal@_module.Map$Value) $Heap@@3)) (and ($Is refType |call6formal@p#0| (Tclass._module.Node? call0formal@_module.Map$Key call1formal@_module.Map$Value)) ($IsAlloc refType |call6formal@p#0| (Tclass._module.Node? call0formal@_module.Map$Key call1formal@_module.Map$Value) $Heap@@3))) (and (=> (= (ControlFlow 0 57) (- 0 65)) (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Repr)) ($Box refType this@@2))))) (=> (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Repr)) ($Box refType this@@2)))) (and (=> (= (ControlFlow 0 57) (- 0 64)) (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Repr)))))) (=> (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Repr))))) (and (=> (= (ControlFlow 0 57) (- 0 63)) (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (=> (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (or (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (or (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)) null) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) |Set#Empty|)) (and (and (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) _module.Node.Spine)) (|Set#Difference| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) (|Set#UnionOne| |Set#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))))) (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS ($LS $LZ)) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) _module.Node.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) _module.Node.next)))))))))) (=> (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (=> (|_module.Map.SpineValid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (or (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (or (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)) null) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) |Set#Empty|)) (and (and (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) _module.Node.Spine)) (|Set#Difference| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) (|Set#UnionOne| |Set#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))))) (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS ($LS $LZ)) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) _module.Node.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head))) _module.Node.next))))))))) (and (=> (= (ControlFlow 0 57) (- 0 62)) (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (forall ((|k#0@@0| T@U) ) (!  (=> ($IsBox |k#0@@0| _module.Map$Key@@25) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |k#0@@0|) (exists ((|n#0@@3| T@U) ) (!  (and ($Is refType |n#0@@3| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#0@@3|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#0@@3|) _module.Node.key) |k#0@@0|)))
 :qid |b4dfy.24:36|
 :skolemid |665|
...
))))) (=> (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (forall ((|n#1@@1| T@U) ) (!  (=> ($Is refType |n#1@@1| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#1@@1|)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#1@@1|) _module.Node.key))) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#1@@1|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#1@@1|) _module.Node.val) (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#1@@1|) _module.Node.key))))))
 :qid |b4dfy.25:13|
 :skolemid |667|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#1@@1|) _module.Node.val))
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#1@@1|) _module.Node.key))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#1@@1|)))
)))) (and (=> (= (ControlFlow 0 57) (- 0 60)) (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (forall ((|n#2@@0| T@U) (|n'#0@@0| T@U) ) (!  (=> (and ($Is refType |n#2@@0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) ($Is refType |n'#0@@0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25))) (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#2@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n'#0@@0|))) (or (not (= |n#2@@0| |n'#0@@0|)) (not true))) (or (not (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#2@@0|) _module.Node.key) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n'#0@@0|) _module.Node.key))) (not true))))
 :qid |b4dfy.26:13|
 :skolemid |668|
...
))))) (=> (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (forall ((|n#2@@1| T@U) (|n'#0@@1| T@U) ) (!  (=> (and ($Is refType |n#2@@1| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) ($Is refType |n'#0@@1| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25))) (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#2@@1|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n'#0@@1|))) (or (not (= |n#2@@1| |n'#0@@1|)) (not true))) (or (not (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#2@@1|) _module.Node.key) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n'#0@@1|) _module.Node.key))) (not true))))
 :qid |b4dfy.26:13|
 :skolemid |668|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n'#0@@1|) _module.Node.key) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#2@@1|) _module.Node.key))
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n'#0@@1|) _module.Node.key) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#2@@1|)))
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#2@@1|) _module.Node.key) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n'#0@@1|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n'#0@@1|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#2@@1|)))
)))) (and (=> (= (ControlFlow 0 57) (- 0 59)) (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (forall ((|n#3@@0| T@U) ) (!  (=> ($Is refType |n#3@@0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#3@@0|)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#3@@0|) _module.Node.next)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (not true))))
 :qid |b4dfy.27:13|
 :skolemid |669|
...
))))) (=> (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (forall ((|n#3@@1| T@U) ) (!  (=> ($Is refType |n#3@@1| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#3@@1|)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#3@@1|) _module.Node.next)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (not true))))
 :qid |b4dfy.27:13|
 :skolemid |669|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#3@@1|) _module.Node.next)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#3@@1|)))
)))) (and (=> (= (ControlFlow 0 57) (- 0 58)) (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (forall ((|n#4@@0| T@U) (|n'#1@@0| T@U) ) (!  (=> (and ($Is refType |n#4@@0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) ($Is refType |n'#1@@0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25))) (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#4@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n'#1@@0|))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#4@@0|) _module.Node.next)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n'#1@@0|) _module.Node.next)))) (= |n#4@@0| |n'#1@@0|)))
 :qid |b4dfy.28:13|
 :skolemid |670|
...
))))) (=> (=> (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (or (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (forall ((|n#4@@1| T@U) (|n'#1@@1| T@U) ) (!  (=> (and ($Is refType |n#4@@1| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) ($Is refType |n'#1@@1| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25))) (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#4@@1|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n'#1@@1|))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#4@@1|) _module.Node.next)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n'#1@@1|) _module.Node.next)))) (= |n#4@@1| |n'#1@@1|)))
 :qid |b4dfy.28:13|
 :skolemid |670|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n'#1@@1|) _module.Node.next)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#4@@1|) _module.Node.next)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n'#1@@1|) _module.Node.next)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#4@@1|)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#4@@1|) _module.Node.next)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n'#1@@1|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n'#1@@1|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#4@@1|)))
)))) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and ($Is refType |call5formal@prev#0@0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType |call5formal@prev#0@0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@0))) (and (and ($Is refType |call6formal@p#0@0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType |call6formal@p#0@0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@0)) (=> (= |call6formal@p#0@0| null) (not (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.M))) |key#0|))))) (and (and (and (=> (or (not (= |call6formal@p#0@0| null)) (not true)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.M))) |key#0|)) (=> (or (not (= |call6formal@p#0@0| null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.Spine)) ($Box refType |call6formal@p#0@0|)))) (and (=> (or (not (= |call6formal@p#0@0| null)) (not true)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |call6formal@p#0@0|) _module.Node.key) |key#0|)) (=> (or (not (= |call6formal@p#0@0| null)) (not true)) (=> (= |call6formal@p#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.head))) (= |call5formal@prev#0@0| null))))) (and (and (=> (or (not (= |call6formal@p#0@0| null)) (not true)) (=> (or (not (= |call6formal@p#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.head)))) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.Spine)) ($Box refType |call5formal@prev#0@0|)))) (=> (or (not (= |call6formal@p#0@0| null)) (not true)) (=> (or (not (= |call6formal@p#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Map.head)))) (not true)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |call5formal@prev#0@0|) _module.Node.next)) |call6formal@p#0@0|)))) (and (forall (($o@@31 T@U) ) (!  (=> (and (or (not (= $o@@31 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@31) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@31) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@31)))
 :qid |b4dfy.65:22|
 :skolemid |677|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@31))
)) ($HeapSucc $Heap@@3 $Heap@0))))) (and (=> (= (ControlFlow 0 57) 20) anon11_Then_correct) (=> (= (ControlFlow 0 57) 50) anon11_Else_correct)))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 (Tclass._module.Map _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType this@@2 (Tclass._module.Map _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)))) (=> (and (and (and ($IsBox |key#0| _module.Map$Key@@25) ($IsAllocBox |key#0| _module.Map$Key@@25 $Heap@@3)) (and ($IsBox |val#0| _module.Map$Value@@25) ($IsAllocBox |val#0| _module.Map$Value@@25 $Heap@@3))) (and (and ($Is refType |prev#0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType |prev#0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)) true)) (=> (and (and (and (and (and ($Is refType |p#0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType |p#0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)) true) (and (=> |defass#h#0_0| (and ($Is refType |h#0_0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType |h#0_0| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3))) true)) (and (and ($Is SetType |s'#1_0| (TSet (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25))) ($IsAlloc SetType |s'#1_0| (TSet (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) $Heap@@3)) true)) (and (and (and (and ($Is refType |p'#1_0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25)) ($IsAlloc refType |p'#1_0| (Tclass._module.Node? _module.Map$Key@@25 _module.Map$Value@@25) $Heap@@3)) true) (= 4 $FunctionContextHeight)) (and (and (|_module.Map.Valid#canCall| _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (and (_module.Map.Valid _module.Map$Key@@25 _module.Map$Value@@25 $Heap@@3 this@@2) (and (and (and (and (and (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Repr)) ($Box refType this@@2)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Repr)))) (_module.Map.SpineValid _module.Map$Key@@25 _module.Map$Value@@25 ($LS $LZ) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.head)))) (forall ((|k#2| T@U) ) (!  (=> ($IsBox |k#2| _module.Map$Key@@25) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |k#2|) (exists ((|n#10| T@U) ) (!  (and ($Is refType |n#10| (Tclass._module.Node _module.Map$Key@@25 _module.Map$Value@@25)) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.Spine)) ($Box refType |n#10|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#10|) _module.Node.key) |k#2|)))
 :qid |b4dfy.24:36|
 :skolemid |763|
 ...
 :qid |b4dfy.24:13|
 :skolemid |764|
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.Map.M))) |k#2|))
...
))))) (= (ControlFlow 0 66) 57)))) anon0_correct)))))
