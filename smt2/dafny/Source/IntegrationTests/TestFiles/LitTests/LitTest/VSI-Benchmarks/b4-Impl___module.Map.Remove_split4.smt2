...
(assert (forall ((_module.Map$Key@@6 T@U) (_module.Map$Value@@6 T@U) ($h@@8 T@U) ($o@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (or (not (= $o@@6 null)) (not true)) (= (dtype $o@@6) (Tclass._module.Map? _module.Map$Key@@6 _module.Map$Value@@6)))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@6) _module.Map.Repr)) (TSet Tclass._System.object)))
 :qid |unknown.0:0|
 :skolemid |536|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@6) _module.Map.Repr)) (Tclass._module.Map? _module.Map$Key@@6 _module.Map$Value@@6))
)))
(assert (forall ((_module.Map$Key@@7 T@U) (_module.Map$Value@@7 T@U) ($o@@7 T@U) ($h@@9 T@U) ) (! (= ($IsAlloc refType $o@@7 (Tclass._module.Map? _module.Map$Key@@7 _module.Map$Value@@7) $h@@9)  (or (= $o@@7 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@7) alloc)))))
 :qid |unknown.0:0|
 :skolemid |533|
 :pattern ( ($IsAlloc refType $o@@7 (Tclass._module.Map? _module.Map$Key@@7 _module.Map$Value@@7) $h@@9))
)))
(assert (forall ((_module.Node$Key@@6 T@U) (_module.Node$Value@@6 T@U) ($o@@8 T@U) ($h@@10 T@U) ) (! (= ($IsAlloc refType $o@@8 (Tclass._module.Node? _module.Node$Key@@6 _module.Node$Value@@6) $h@@10)  (or (= $o@@8 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@8) alloc)))))
 :qid |unknown.0:0|
 :skolemid |980|
 :pattern ( ($IsAlloc refType $o@@8 (Tclass._module.Node? _module.Node$Key@@6 _module.Node$Value@@6) $h@@10))
)))
...
(assert (forall ((_module.Map$Key@@12 T@U) (_module.Map$Value@@12 T@U) ($h@@11 T@U) ($o@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (or (not (= $o@@10 null)) (not true)) (= (dtype $o@@10) (Tclass._module.Map? _module.Map$Key@@12 _module.Map$Value@@12)))) ($Is MapType ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@10) _module.Map.M)) (TMap _module.Map$Key@@12 _module.Map$Value@@12)))
 :qid |unknown.0:0|
 :skolemid |534|
 :pattern ( ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@10) _module.Map.M)) (Tclass._module.Map? _module.Map$Key@@12 _module.Map$Value@@12))
)))
(assert (forall ((_module.Map$Key@@13 T@U) (_module.Map$Value@@13 T@U) ($h@@12 T@U) ($o@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (or (not (= $o@@11 null)) (not true)) (= (dtype $o@@11) (Tclass._module.Map? _module.Map$Key@@13 _module.Map$Value@@13)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@11) _module.Map.head)) (Tclass._module.Node? _module.Map$Key@@13 _module.Map$Value@@13)))
 :qid |unknown.0:0|
 :skolemid |542|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@11) _module.Map.head)) (Tclass._module.Map? _module.Map$Key@@13 _module.Map$Value@@13))
)))
(assert (forall ((_module.Node$Key@@11 T@U) (_module.Node$Value@@11 T@U) ($h@@13 T@U) ($o@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (or (not (= $o@@12 null)) (not true)) (= (dtype $o@@12) (Tclass._module.Node? _module.Node$Key@@11 _module.Node$Value@@11)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@12) _module.Node.next)) (Tclass._module.Node? _module.Node$Key@@11 _module.Node$Value@@11)))
 :qid |unknown.0:0|
 :skolemid |985|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@12) _module.Node.next)) (Tclass._module.Node? _module.Node$Key@@11 _module.Node$Value@@11))
)))
...
(assert (forall ((_module.Map$Key@@14 T@U) (_module.Map$Value@@14 T@U) (bx@@6 T@U) ) (!  (=> ($IsBox bx@@6 (Tclass._module.Map? _module.Map$Key@@14 _module.Map$Value@@14)) (and (= ($Box refType ($Unbox refType bx@@6)) bx@@6) ($Is refType ($Unbox refType bx@@6) (Tclass._module.Map? _module.Map$Key@@14 _module.Map$Value@@14))))
 :qid |unknown.0:0|
 :skolemid |531|
 :pattern ( ($IsBox bx@@6 (Tclass._module.Map? _module.Map$Key@@14 _module.Map$Value@@14)))
)))
(assert (forall ((_module.Node$Key@@12 T@U) (_module.Node$Value@@12 T@U) (bx@@7 T@U) ) (!  (=> ($IsBox bx@@7 (Tclass._module.Node? _module.Node$Key@@12 _module.Node$Value@@12)) (and (= ($Box refType ($Unbox refType bx@@7)) bx@@7) ($Is refType ($Unbox refType bx@@7) (Tclass._module.Node? _module.Node$Key@@12 _module.Node$Value@@12))))
 :qid |unknown.0:0|
 :skolemid |541|
 :pattern ( ($IsBox bx@@7 (Tclass._module.Node? _module.Node$Key@@12 _module.Node$Value@@12)))
)))
(assert (forall ((_module.Node$Key@@13 T@U) (_module.Node$Value@@13 T@U) (bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 (Tclass._module.Node _module.Node$Key@@13 _module.Node$Value@@13)) (and (= ($Box refType ($Unbox refType bx@@8)) bx@@8) ($Is refType ($Unbox refType bx@@8) (Tclass._module.Node _module.Node$Key@@13 _module.Node$Value@@13))))
 :qid |unknown.0:0|
 :skolemid |547|
 :pattern ( ($IsBox bx@@8 (Tclass._module.Node _module.Node$Key@@13 _module.Node$Value@@13)))
)))
...
(assert (forall ((_module.Map$Key@@18 T@U) (_module.Map$Value@@18 T@U) ($h@@14 T@U) ($o@@13 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@14) (and (or (not (= $o@@13 null)) (not true)) (= (dtype $o@@13) (Tclass._module.Map? _module.Map$Key@@18 _module.Map$Value@@18)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@13) alloc)))) ($IsAlloc MapType ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@13) _module.Map.M)) (TMap _module.Map$Key@@18 _module.Map$Value@@18) $h@@14))
 :qid |unknown.0:0|
 :skolemid |535|
 :pattern ( ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@13) _module.Map.M)) (Tclass._module.Map? _module.Map$Key@@18 _module.Map$Value@@18))
)))
(assert (forall ((_module.Map$Key@@19 T@U) (_module.Map$Value@@19 T@U) ($h@@15 T@U) ($o@@14 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@15) (and (or (not (= $o@@14 null)) (not true)) (= (dtype $o@@14) (Tclass._module.Map? _module.Map$Key@@19 _module.Map$Value@@19)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@14) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@14) _module.Map.head)) (Tclass._module.Node? _module.Map$Key@@19 _module.Map$Value@@19) $h@@15))
 :qid |unknown.0:0|
 :skolemid |543|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@14) _module.Map.head)) (Tclass._module.Map? _module.Map$Key@@19 _module.Map$Value@@19))
)))
(assert (forall ((_module.Node$Key@@16 T@U) (_module.Node$Value@@16 T@U) ($h@@16 T@U) ($o@@15 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@16) (and (or (not (= $o@@15 null)) (not true)) (= (dtype $o@@15) (Tclass._module.Node? _module.Node$Key@@16 _module.Node$Value@@16)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@15) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@15) _module.Node.next)) (Tclass._module.Node? _module.Node$Key@@16 _module.Node$Value@@16) $h@@16))
 :qid |unknown.0:0|
 :skolemid |986|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@15) _module.Node.next)) (Tclass._module.Node? _module.Node$Key@@16 _module.Node$Value@@16))
)))
...
(assert (forall ((m@@2 T@U) ) (!  (or (= m@@2 |Map#Empty|) (exists ((v@@4 T@U) ) (! (|Set#IsMember| (|Map#Values| m@@2) v@@4)
...
(assert (forall ((m@@4 T@U) (v@@5 T@U) ) (! (= (|Set#IsMember| (|Map#Values| m@@4) v@@5) (exists ((u@@3 T@U) ) (!  (and (|Set#IsMember| (|Map#Domain| m@@4) u@@3) (= v@@5 (MapType0Select BoxType BoxType (|Map#Elements| m@@4) u@@3)))
 ...
 :skolemid |283|
 :pattern ( (|Set#IsMember| (|Map#Values| m@@4) v@@5))
)))
...
(assert (forall ((v@@6 T@U) (t0@@3 T@U) (t1@@1 T@U) ) (! (= ($Is MapType v@@6 (TMap t0@@3 t1@@1)) (forall ((bx@@11 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@6) bx@@11) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@6) bx@@11) t1@@1) ($IsBox bx@@11 t0@@3)))
 ...
 :skolemid |56|
 :pattern ( ($Is MapType v@@6 (TMap t0@@3 t1@@1)))
)))
(assert (= (Tag Tclass._System.object?) Tagclass._System.object?))
(assert (= (TagFamily Tclass._System.object?) tytagFamily$object))
(assert (= (Tag Tclass._System.object) Tagclass._System.object))
(assert (= (TagFamily Tclass._System.object) tytagFamily$object))
(assert (forall ((_module.Map$Key@@20 T@U) (_module.Map$Value@@20 T@U) ($h@@17 T@U) ($o@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (or (not (= $o@@16 null)) (not true)) (= (dtype $o@@16) (Tclass._module.Map? _module.Map$Key@@20 _module.Map$Value@@20)))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@16) _module.Map.Spine)) (TSet (Tclass._module.Node _module.Map$Key@@20 _module.Map$Value@@20))))
 :qid |unknown.0:0|
 :skolemid |548|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@16) _module.Map.Spine)) (Tclass._module.Map? _module.Map$Key@@20 _module.Map$Value@@20))
)))
(assert (forall ((_module.Node$Key@@17 T@U) (_module.Node$Value@@17 T@U) ($h@@18 T@U) ($o@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (or (not (= $o@@17 null)) (not true)) (= (dtype $o@@17) (Tclass._module.Node? _module.Node$Key@@17 _module.Node$Value@@17)))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@17) _module.Node.Spine)) (TSet (Tclass._module.Node _module.Node$Key@@17 _module.Node$Value@@17))))
 :qid |unknown.0:0|
 :skolemid |987|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@17) _module.Node.Spine)) (Tclass._module.Node? _module.Node$Key@@17 _module.Node$Value@@17))
)))
(assert (forall ((_module.Map$Key@@21 T@U) (_module.Map$Value@@21 T@U) ($h@@19 T@U) ($o@@18 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@19) (and (or (not (= $o@@18 null)) (not true)) (= (dtype $o@@18) (Tclass._module.Map? _module.Map$Key@@21 _module.Map$Value@@21)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@18) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@18) _module.Map.Spine)) (TSet (Tclass._module.Node _module.Map$Key@@21 _module.Map$Value@@21)) $h@@19))
 :qid |unknown.0:0|
 :skolemid |549|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@18) _module.Map.Spine)) (Tclass._module.Map? _module.Map$Key@@21 _module.Map$Value@@21))
)))
(assert (forall ((_module.Node$Key@@18 T@U) (_module.Node$Value@@18 T@U) ($h@@20 T@U) ($o@@19 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@20) (and (or (not (= $o@@19 null)) (not true)) (= (dtype $o@@19) (Tclass._module.Node? _module.Node$Key@@18 _module.Node$Value@@18)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@20 $o@@19) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@20 $o@@19) _module.Node.Spine)) (TSet (Tclass._module.Node _module.Node$Key@@18 _module.Node$Value@@18)) $h@@20))
 :qid |unknown.0:0|
 :skolemid |988|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@20 $o@@19) _module.Node.Spine)) (Tclass._module.Node? _module.Node$Key@@18 _module.Node$Value@@18))
)))
...
(assert (forall ((_module.Map$Key@@22 T@U) (_module.Map$Value@@22 T@U) ($h@@23 T@U) ($o@@20 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@23) (and (or (not (= $o@@20 null)) (not true)) (= (dtype $o@@20) (Tclass._module.Map? _module.Map$Key@@22 _module.Map$Value@@22)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@23 $o@@20) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@23 $o@@20) _module.Map.Repr)) (TSet Tclass._System.object) $h@@23))
 :qid |unknown.0:0|
 :skolemid |537|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@23 $o@@20) _module.Map.Repr)) (Tclass._module.Map? _module.Map$Key@@22 _module.Map$Value@@22))
)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@21 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#1| |l#0| |l#1| |l#2| |l#3|) $o@@21 $f))  (=> (and (or (not (= $o@@21 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@21) |l#2|)))) (|Set#IsMember| |l#3| ($Box refType $o@@21))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1014|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#1| |l#0| |l#1| |l#2| |l#3|) $o@@21 $f))
)))
...
(set-info :boogie-vc-id Impl$$_module.Map.Remove_split4)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 (Tclass._module.Map _module.Map$Key@@23 _module.Map$Value@@23)) ($IsAlloc refType this@@1 (Tclass._module.Map _module.Map$Key@@23 _module.Map$Value@@23) $Heap@@3))) (and ($IsBox |key#0| _module.Map$Key@@23) ($IsAllocBox |key#0| _module.Map$Key@@23 $Heap@@3))) (and (and ($Is refType |prev#0| (Tclass._module.Node? _module.Map$Key@@23 _module.Map$Value@@23)) ($IsAlloc refType |prev#0| (Tclass._module.Node? _module.Map$Key@@23 _module.Map$Value@@23) $Heap@@3)) true)) (=> (and (and (and (and (and ($Is refType |p#0| (Tclass._module.Node? _module.Map$Key@@23 _module.Map$Value@@23)) ($IsAlloc refType |p#0| (Tclass._module.Node? _module.Map$Key@@23 _module.Map$Value@@23) $Heap@@3)) true) (= 4 $FunctionContextHeight)) (and (and (and (|_module.Map.Valid#canCall| _module.Map$Key@@23 _module.Map$Value@@23 $Heap@@3 this@@1) (and (_module.Map.Valid _module.Map$Key@@23 _module.Map$Value@@23 $Heap@@3 this@@1) (and (and (and (and (and (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Repr)) ($Box refType this@@1)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Repr)))) (_module.Map.SpineValid _module.Map$Key@@23 _module.Map$Value@@23 ($LS $LZ) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.head)))) (forall ((|k#4| T@U) ) (!  (=> ($IsBox |k#4| _module.Map$Key@@23) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.M))) |k#4|) (exists ((|n#10| T@U) ) (!  (and ($Is refType |n#10| (Tclass._module.Node _module.Map$Key@@23 _module.Map$Value@@23)) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n#10|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#10|) _module.Node.key) |k#4|)))
 :qid |b4dfy.24:36|
 :skolemid |824|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n#10|)))
))))
 :qid |b4dfy.24:13|
 :skolemid |825|
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.M))) |k#4|))
))) (forall ((|n#11| T@U) ) (!  (=> ($Is refType |n#11| (Tclass._module.Node _module.Map$Key@@23 _module.Map$Value@@23)) (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n#11|)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.M))) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#11|) _module.Node.key))) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n#11|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#11|) _module.Node.val) (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.M))) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#11|) _module.Node.key))))))
 :qid |b4dfy.25:13|
 :skolemid |826|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n#11|)))
))) (forall ((|n#12| T@U) (|n'#4| T@U) ) (!  (=> (and ($Is refType |n#12| (Tclass._module.Node _module.Map$Key@@23 _module.Map$Value@@23)) ($Is refType |n'#4| (Tclass._module.Node _module.Map$Key@@23 _module.Map$Value@@23))) (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n#12|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n'#4|))) (or (not (= |n#12| |n'#4|)) (not true))) (or (not (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#12|) _module.Node.key) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n'#4|) _module.Node.key))) (not true))))
 :qid |b4dfy.26:13|
 :skolemid |827|
 ...
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n'#4|) _module.Node.key) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n#12|)))
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#12|) _module.Node.key) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n'#4|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n'#4|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n#12|)))
...
))))) (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@3 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Repr))))) (and ($Is refType |call5formal@prev#0| (Tclass._module.Node? call0formal@_module.Map$Key call1formal@_module.Map$Value)) ($IsAlloc refType |call5formal@prev#0| (Tclass._module.Node? call0formal@_module.Map$Key call1formal@_module.Map$Value) $Heap@@3)))) (and (and (and (and ($Is refType |call6formal@p#0| (Tclass._module.Node? call0formal@_module.Map$Key call1formal@_module.Map$Value)) ($IsAlloc refType |call6formal@p#0| (Tclass._module.Node? call0formal@_module.Map$Key call1formal@_module.Map$Value) $Heap@@3)) (=> (|_module.Map.Valid#canCall| _module.Map$Key@@23 _module.Map$Value@@23 $Heap@@3 this@@1) (or (_module.Map.Valid _module.Map$Key@@23 _module.Map$Value@@23 $Heap@@3 this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Repr)) ($Box refType this@@1))))) (and (=> (|_module.Map.Valid#canCall| _module.Map$Key@@23 _module.Map$Value@@23 $Heap@@3 this@@1) (or (_module.Map.Valid _module.Map$Key@@23 _module.Map$Value@@23 $Heap@@3 this@@1) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Repr))))) (=> (|_module.Map.Valid#canCall| _module.Map$Key@@23 _module.Map$Value@@23 $Heap@@3 this@@1) (or (_module.Map.Valid _module.Map$Key@@23 _module.Map$Value@@23 $Heap@@3 this@@1) (=> (|_module.Map.SpineValid#canCall| _module.Map$Key@@23 _module.Map$Value@@23 $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.head))) (or (_module.Map.SpineValid _module.Map$Key@@23 _module.Map$Value@@23 ($LS $LZ) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.head))) (or (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.head)) null) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) |Set#Empty|)) (and (and (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.head)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.head))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.head))) _module.Node.Spine)) (|Set#Difference| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) (|Set#UnionOne| |Set#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.head))))) (_module.Map.SpineValid _module.Map$Key@@23 _module.Map$Value@@23 ($LS ($LS $LZ)) $Heap@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.head))) _module.Node.Spine)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.head))) _module.Node.next))))))))))) (and (and (=> (|_module.Map.Valid#canCall| _module.Map$Key@@23 _module.Map$Value@@23 $Heap@@3 this@@1) (or (_module.Map.Valid _module.Map$Key@@23 _module.Map$Value@@23 $Heap@@3 this@@1) (forall ((|k#0@@0| T@U) ) (!  (=> ($IsBox |k#0@@0| _module.Map$Key@@23) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.M))) |k#0@@0|) (exists ((|n#0@@2| T@U) ) (!  (and ($Is refType |n#0@@2| (Tclass._module.Node _module.Map$Key@@23 _module.Map$Value@@23)) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n#0@@2|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#0@@2|) _module.Node.key) |k#0@@0|)))
 :qid |b4dfy.24:36|
 :skolemid |665|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#0@@2|) _module.Node.key))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n#0@@2|)))
))))
 :qid |b4dfy.24:13|
 :skolemid |666|
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.M))) |k#0@@0|))
)))) (= (ControlFlow 0 2) (- 0 1))) (|_module.Map.Valid#canCall| _module.Map$Key@@23 _module.Map$Value@@23 $Heap@@3 this@@1)))) (or (_module.Map.Valid _module.Map$Key@@23 _module.Map$Value@@23 $Heap@@3 this@@1) (forall ((|n#1@@0| T@U) ) (!  (=> ($Is refType |n#1@@0| (Tclass._module.Node _module.Map$Key@@23 _module.Map$Value@@23)) (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n#1@@0|)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.M))) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#1@@0|) _module.Node.key))) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n#1@@0|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#1@@0|) _module.Node.val) (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.M))) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#1@@0|) _module.Node.key))))))
 :qid |b4dfy.25:13|
 :skolemid |667|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Box refType |n#1@@0|)))
))))))))
anon0_correct))
))
(check-sat)
