...
(assert (forall ((v@@4 T@U) (t0@@1 T@U) (h@@3 T@U) ) (! (= ($IsAlloc SeqType v@@4 (TSeq t0@@1) h@@3) (forall ((i@@0 Int) ) (!  (=> (and (<= 0 i@@0) (< i@@0 (|Seq#Length| v@@4))) ($IsAllocBox (|Seq#Index| v@@4 i@@0) t0@@1 h@@3))
...
(assert (forall ((_module.Queue$T@@9 T@U) (bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 (Tclass._module.Queue? _module.Queue$T@@9)) (and (= ($Box refType ($Unbox refType bx@@2)) bx@@2) ($Is refType ($Unbox refType bx@@2) (Tclass._module.Queue? _module.Queue$T@@9))))
 :qid |unknown.0:0|
 :skolemid |481|
 :pattern ( ($IsBox bx@@2 (Tclass._module.Queue? _module.Queue$T@@9)))
)))
(assert (forall ((_module.Queue$T@@10 T@U) (bx@@3 T@U) ) (!  (=> ($IsBox bx@@3 (Tclass._module.Queue _module.Queue$T@@10)) (and (= ($Box refType ($Unbox refType bx@@3)) bx@@3) ($Is refType ($Unbox refType bx@@3) (Tclass._module.Queue _module.Queue$T@@10))))
 :qid |unknown.0:0|
 :skolemid |488|
 :pattern ( ($IsBox bx@@3 (Tclass._module.Queue _module.Queue$T@@10)))
)))
