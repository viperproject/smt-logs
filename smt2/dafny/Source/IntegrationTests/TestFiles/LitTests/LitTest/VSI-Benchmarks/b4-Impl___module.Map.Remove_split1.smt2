...
(set-info :boogie-vc-id Impl$$_module.Map.Remove_split1)
...
))))) (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@3 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Repr)))))) (and (and (and ($Is refType |call5formal@prev#0| (Tclass._module.Node? call0formal@_module.Map$Key call1formal@_module.Map$Value)) ($IsAlloc refType |call5formal@prev#0| (Tclass._module.Node? call0formal@_module.Map$Key call1formal@_module.Map$Value) $Heap@@3)) (and ($Is refType |call6formal@p#0| (Tclass._module.Node? call0formal@_module.Map$Key call1formal@_module.Map$Value)) ($IsAlloc refType |call6formal@p#0| (Tclass._module.Node? call0formal@_module.Map$Key call1formal@_module.Map$Value) $Heap@@3))) (and (and (=> (|_module.Map.Valid#canCall| _module.Map$Key@@23 _module.Map$Value@@23 $Heap@@3 this@@1) (or (_module.Map.Valid _module.Map$Key@@23 _module.Map$Value@@23 $Heap@@3 this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Repr)) ($Box refType this@@1)))) (= (ControlFlow 0 2) (- 0 1))) (|_module.Map.Valid#canCall| _module.Map$Key@@23 _module.Map$Value@@23 $Heap@@3 this@@1)))) (or (_module.Map.Valid _module.Map$Key@@23 _module.Map$Value@@23 $Heap@@3 this@@1) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Spine)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@1) _module.Map.Repr)))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
