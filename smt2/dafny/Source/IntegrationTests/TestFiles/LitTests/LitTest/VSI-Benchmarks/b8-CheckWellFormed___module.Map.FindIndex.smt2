...
(set-info :boogie-vc-id CheckWellFormed$$_module.Map.FindIndex)
...
(let ((anon8_Then_correct  (=> (and (<= (LitInt 0) |idx#0@0|) (= (ControlFlow 0 2) (- 0 1))) (and (<= 0 |idx#0@0|) (< |idx#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@1) _module.Map.keys))))))))
(let ((anon7_Else_correct  (=> (=> (= |idx#0@0| (LitInt (- 0 1))) (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@1) _module.Map.keys)) |key#0|))) (and (=> (= (ControlFlow 0 5) 2) anon8_Then_correct) (=> (= (ControlFlow 0 5) 3) anon8_Else_correct)))))
(let ((anon7_Then_correct  (=> (and (= |idx#0@0| (LitInt (- 0 1))) (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@1) _module.Map.keys)) |key#0|))) (and (=> (= (ControlFlow 0 4) 2) anon8_Then_correct) (=> (= (ControlFlow 0 4) 3) anon8_Else_correct)))))
...
)) ($HeapSucc $Heap@@0 $Heap@0)) (and (<= (LitInt (- 0 1)) |idx#0@0|) (< |idx#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@1) _module.Map.keys))))))) (and (=> (= (ControlFlow 0 6) 4) anon7_Then_correct) (=> (= (ControlFlow 0 6) 5) anon7_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 (Tclass._module.Map _module.Map$Key@@17 _module.Map$Value@@17)) ($IsAlloc refType this@@1 (Tclass._module.Map _module.Map$Key@@17 _module.Map$Value@@17) $Heap@@0)))) (and (and ($IsBox |key#0| _module.Map$Key@@17) ($IsAllocBox |key#0| _module.Map$Key@@17 $Heap@@0)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 7) 6)))) anon0_correct)))
