...
(declare-fun |eos#0@0| () Bool)
(declare-fun this@@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id Impl$$_module.Stream.AtEndOfStream)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#5| null $Heap@@0 alloc false)) (=> (and (= |eos#0@0| (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.Stream.stream))) (LitInt 0))) (= (ControlFlow 0 2) (- 0 1))) (= |eos#0@0| (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.Stream.stream))) (LitInt 0)))))))
