// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/metatests/RefreshResolverFails.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/metatests/RefreshResolverFails-@PROC@.smt2 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/metatests/RefreshResolverFails.dfy
...
procedure {:verboseName "M (well-formedness)"} CheckWellFormed$$_module.__default.M(c#0: ref
       where $Is(c#0, Tclass._module.Class()) && $IsAlloc(c#0, Tclass._module.Class(), $Heap));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "M (call)"} Call$$_module.__default.M(c#0: ref
       where $Is(c#0, Tclass._module.Class()) && $IsAlloc(c#0, Tclass._module.Class(), $Heap));
  modifies $Heap;
...
procedure {:verboseName "M (correctness)"} Impl$$_module.__default.M(c#0: ref
       where $Is(c#0, Tclass._module.Class()) && $IsAlloc(c#0, Tclass._module.Class(), $Heap))
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "M (correctness)"} Impl$$_module.__default.M(c#0: ref) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var defass#t#0: bool;
  var t#0: ref
     where defass#t#0
       ==> $Is(t#0, Tclass._module.Trait()) && $IsAlloc(t#0, Tclass._module.Trait(), $Heap);
  var defass#d#0: bool;
  var d#0: ref
     where defass#d#0
       ==> $Is(d#0, Tclass._module.Class()) && $IsAlloc(d#0, Tclass._module.Class(), $Heap);

    // AddMethodImpl: M, Impl$$_module.__default.M
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/metatests/RefreshResolverFails.dfy(7,16)
    assume true;
    assume true;
    t#0 := c#0;
    defass#t#0 := true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/metatests/RefreshResolverFails.dfy(8,16)
    assume true;
    assert {:id "id1"} defass#t#0;
    assert {:id "id2"} $Is(t#0, Tclass._module.Class());
    assume true;
    d#0 := t#0;
    defass#d#0 := true;
}
