...
(assert (forall (($heap@@0 T@U) (|$fh$0x#0@@0| T@U) ) (! (= (Apply1 Tclass._module.Ref Tclass._System.Tuple0 $heap@@0 |_module.__default.myf#Handle| |$fh$0x#0@@0|) ($Box DatatypeTypeType (_module.__default.myf $heap@@0 ($Unbox refType |$fh$0x#0@@0|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |490|
 :pattern ( (Apply1 Tclass._module.Ref Tclass._System.Tuple0 $heap@@0 |_module.__default.myf#Handle| |$fh$0x#0@@0|))
)))
...
(assert (forall (($bx T@U) ($heap@@1 T@U) (|$fh$0x#0@@1| T@U) ) (! (= (|Set#IsMember| (Reads1 Tclass._module.Ref Tclass._System.Tuple0 $heap@@1 |_module.__default.myf#Handle| |$fh$0x#0@@1|) $bx) (= ($Unbox refType $bx) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $heap@@1 ($Unbox refType |$fh$0x#0@@1|)) _module.Ref.inner))))
 :qid |unknown.0:0|
 :skolemid |492|
 :pattern ( (|Set#IsMember| (Reads1 Tclass._module.Ref Tclass._System.Tuple0 $heap@@1 |_module.__default.myf#Handle| |$fh$0x#0@@1|) $bx))
)))
...
(assert (forall (($heap@@2 T@U) (|$fh$0x#0@@2| T@U) ) (! (= (_module.__default.myf $heap@@2 |$fh$0x#0@@2|) ($Unbox DatatypeTypeType (Apply1 Tclass._module.Ref Tclass._System.Tuple0 $heap@@2 |_module.__default.myf#Handle| ($Box refType |$fh$0x#0@@2|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |493|
 :pattern ( (_module.__default.myf $heap@@2 |$fh$0x#0@@2|))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@2 alloc false)) (=> (and (and (or (not (= call1formal@this null)) (not true)) (and ($Is refType call1formal@this Tclass._module.Ref) ($IsAlloc refType call1formal@this Tclass._module.Ref $Heap@@2))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (=> (and (and (and (and (and (or (not (= call1formal@this@0 null)) (not true)) (and ($Is refType call1formal@this@0 Tclass._module.Ref) ($IsAlloc refType call1formal@this@0 Tclass._module.Ref $Heap@0))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 call1formal@this@0) alloc))))) (and (forall (($o@@7 T@U) ) (!  (=> (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@7) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@7)))
 :qid |ReadPreconditionBypass1dfy.6:3|
 :skolemid |501|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7))
)) ($HeapSucc $Heap@@2 $Heap@0))) (and (and (or (not (= call1formal@this@@0 null)) (not true)) (and ($Is refType call1formal@this@@0 Tclass._module.Ref) ($IsAlloc refType call1formal@this@@0 Tclass._module.Ref $Heap@@2))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)))) (and (and (and (or (not (= call1formal@this@0@@0 null)) (not true)) (and ($Is refType call1formal@this@0@@0 Tclass._module.Ref) ($IsAlloc refType call1formal@this@0@@0 Tclass._module.Ref $Heap@1))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call1formal@this@0@@0) alloc))))) (and (forall (($o@@8 T@U) ) (!  (=> (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@8) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@8) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@8)))
 :qid |ReadPreconditionBypass1dfy.6:3|
 :skolemid |501|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@8))
)) ($HeapSucc $Heap@0 $Heap@1)))) (and (=> (= (ControlFlow 0 2) (- 0 20)) true) (and (=> (= (ControlFlow 0 2) (- 0 19)) (or (not (= call1formal@this@0 null)) (not true))) (=> (or (not (= call1formal@this@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 18)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 call1formal@this@0 _module.Ref.inner))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 call1formal@this@0 _module.Ref.inner)) (and (=> (= (ControlFlow 0 2) (- 0 17)) true) (=> (and (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call1formal@this@0) _module.Ref.inner ($Box refType call1formal@this@0@@0)))) ($IsGoodHeap $Heap@2)) (and (=> (= (ControlFlow 0 2) (- 0 16)) (or (not (= 1 $FunctionContextHeight)) (not true))) (=> (or (not (= 1 $FunctionContextHeight)) (not true)) (=> ($IsAllocBox ($Box HandleTypeType |_module.__default.myf#Handle|) (Tclass._System.___hFunc1 Tclass._module.Ref Tclass._System.Tuple0) $Heap@2) (and (=> (= (ControlFlow 0 2) (- 0 15)) true) (=> ($IsAlloc refType call1formal@this@0 Tclass._module.Ref $Heap@2) (and (=> (= (ControlFlow 0 2) (- 0 14)) (Requires1 Tclass._module.Ref Tclass._System.Tuple0 $Heap@2 |_module.__default.myf#Handle| ($Box refType call1formal@this@0))) (=> (Requires1 Tclass._module.Ref Tclass._System.Tuple0 $Heap@2 |_module.__default.myf#Handle| ($Box refType call1formal@this@0)) (=> (= |reads1#0@0| (Reads1 Tclass._module.Ref Tclass._System.Tuple0 $Heap@2 |_module.__default.myf#Handle| ($Box refType call1formal@this@0))) (and (=> (= (ControlFlow 0 2) (- 0 13)) true) (and (=> (= (ControlFlow 0 2) (- 0 12)) (|Set#Equal| |reads1#0@0| (|Set#UnionOne| |Set#Empty| ($Box refType call1formal@this@0@@0)))) (=> (|Set#Equal| |reads1#0@0| (|Set#UnionOne| |Set#Empty| ($Box refType call1formal@this@0@@0))) (=> (and (and (or (not (= call1formal@this@@1 null)) (not true)) (and ($Is refType call1formal@this@@1 Tclass._module.Ref) ($IsAlloc refType call1formal@this@@1 Tclass._module.Ref $Heap@@2))) (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3))) (=> (and (and (and (or (not (= call1formal@this@0@@1 null)) (not true)) (and ($Is refType call1formal@this@0@@1 Tclass._module.Ref) ($IsAlloc refType call1formal@this@0@@1 Tclass._module.Ref $Heap@3))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call1formal@this@0@@1) alloc))))) (and (forall (($o@@9 T@U) ) (!  (=> (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@9) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@9) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@9)))
 :qid |ReadPreconditionBypass1dfy.6:3|
 :skolemid |501|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@9))
)) ($HeapSucc $Heap@2 $Heap@3))) (and (=> (= (ControlFlow 0 2) (- 0 11)) true) (and (=> (= (ControlFlow 0 2) (- 0 10)) (or (not (= call1formal@this@0 null)) (not true))) (=> (or (not (= call1formal@this@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 9)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 call1formal@this@0 _module.Ref.inner))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 call1formal@this@0 _module.Ref.inner)) (and (=> (= (ControlFlow 0 2) (- 0 8)) true) (=> (and (= $Heap@4 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@3 call1formal@this@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call1formal@this@0) _module.Ref.inner ($Box refType call1formal@this@0@@1)))) ($IsGoodHeap $Heap@4)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= 1 $FunctionContextHeight)) (not true))) (=> (or (not (= 1 $FunctionContextHeight)) (not true)) (=> ($IsAllocBox ($Box HandleTypeType |_module.__default.myf#Handle|) (Tclass._System.___hFunc1 Tclass._module.Ref Tclass._System.Tuple0) $Heap@4) (and (=> (= (ControlFlow 0 2) (- 0 6)) true) (=> ($IsAlloc refType call1formal@this@0 Tclass._module.Ref $Heap@4) (and (=> (= (ControlFlow 0 2) (- 0 5)) (Requires1 Tclass._module.Ref Tclass._System.Tuple0 $Heap@4 |_module.__default.myf#Handle| ($Box refType call1formal@this@0))) (=> (Requires1 Tclass._module.Ref Tclass._System.Tuple0 $Heap@4 |_module.__default.myf#Handle| ($Box refType call1formal@this@0)) (=> (= |reads2#0@0| (Reads1 Tclass._module.Ref Tclass._System.Tuple0 $Heap@4 |_module.__default.myf#Handle| ($Box refType call1formal@this@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Equal| |reads2#0@0| (|Set#UnionOne| |Set#Empty| ($Box refType call1formal@this@0@@1)))) (=> (|Set#Equal| |reads2#0@0| (|Set#UnionOne| |Set#Empty| ($Box refType call1formal@this@0@@1))) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (Lit boolType (bool_2_U false)))))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (=> |defass#outer#0| (and ($Is refType |outer#0| Tclass._module.Ref) ($IsAlloc refType |outer#0| Tclass._module.Ref $Heap@@2))) true) (and (=> |defass#inner1#0| (and ($Is refType |inner1#0| Tclass._module.Ref) ($IsAlloc refType |inner1#0| Tclass._module.Ref $Heap@@2))) true)) (=> (and (and (and (and ($Is SetType |reads1#0| (TSet Tclass._System.object?)) ($IsAlloc SetType |reads1#0| (TSet Tclass._System.object?) $Heap@@2)) true) (and (=> |defass#inner2#0| (and ($Is refType |inner2#0| Tclass._module.Ref) ($IsAlloc refType |inner2#0| Tclass._module.Ref $Heap@@2))) true)) (and (and (and ($Is SetType |reads2#0| (TSet Tclass._System.object?)) ($IsAlloc SetType |reads2#0| (TSet Tclass._System.object?) $Heap@@2)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 21) 2)))) anon0_correct)))))
