...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let (($generated@@96 true))
(let (($generated@@97  (=> (and (= $generated@@88 ($generated 6)) (= (ControlFlow 0 12) (- 0 11))) (or (not (= $generated@@88 6)) (not true)))))
(let (($generated@@98  (=> (or (not (= $generated@@88 ($generated 5))) (not true)) (and (=> (= (ControlFlow 0 14) 12) $generated@@97) (=> (= (ControlFlow 0 14) 13) $generated@@96)))))
(let (($generated@@99  (=> (and (= $generated@@88 ($generated 5)) (= (ControlFlow 0 10) (- 0 9))) (or (not (= $generated@@88 5)) (not true)))))
(let (($generated@@100  (=> (or (not (= $generated@@88 ($generated 4))) (not true)) (and (=> (= (ControlFlow 0 15) 10) $generated@@99) (=> (= (ControlFlow 0 15) 14) $generated@@98)))))
(let (($generated@@101  (=> (and (= $generated@@88 ($generated 4)) (= (ControlFlow 0 8) (- 0 7))) (or (not (= $generated@@88 4)) (not true)))))
(let (($generated@@102  (=> (or (not (= $generated@@88 ($generated 3))) (not true)) (and (=> (= (ControlFlow 0 16) 8) $generated@@101) (=> (= (ControlFlow 0 16) 15) $generated@@100)))))
(let (($generated@@103  (=> (and (= $generated@@88 ($generated 3)) (= (ControlFlow 0 6) (- 0 5))) (or (not (= $generated@@88 3)) (not true)))))
(let (($generated@@104  (=> (or (not (= $generated@@88 ($generated 2))) (not true)) (and (=> (= (ControlFlow 0 17) 6) $generated@@103) (=> (= (ControlFlow 0 17) 16) $generated@@102)))))
(let (($generated@@105  (=> (and (= $generated@@88 ($generated 2)) (= (ControlFlow 0 4) (- 0 3))) (or (not (= $generated@@88 2)) (not true)))))
(let (($generated@@106  (=> (or (not (= $generated@@88 ($generated 1))) (not true)) (and (=> (= (ControlFlow 0 18) 4) $generated@@105) (=> (= (ControlFlow 0 18) 17) $generated@@104)))))
(let (($generated@@107  (=> (and (= $generated@@88 ($generated 1)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= $generated@@88 1)) (not true)))))
(let (($generated@@108  (=> (= $generated@@89 ($generated@@29 $generated@@90 $generated@@91 $generated@@92 false)) (and (=> (= (ControlFlow 0 19) 2) $generated@@107) (=> (= (ControlFlow 0 19) 18) $generated@@106)))))
(let (($generated@@109  (=> (and (and ($generated@@93 $generated@@91) ($generated@@94 $generated@@91)) (and (= 0 $generated@@95) (= (ControlFlow 0 20) 19))) $generated@@108)))
$generated@@109)))))))))))))))
))
(check-sat)
