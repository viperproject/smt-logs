...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.y)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |newtype$check#0@0| (LitInt 257)) (= (ControlFlow 0 2) (- 0 1))) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 256))))))
