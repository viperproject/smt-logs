...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "m (correctness)"} Impl$$_module.__default.m() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
    ...
    $_reverifyPost := false;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/cli/proverPath.dfy(5,3)
    assume true;
