...
(assert (distinct alloc Tagclass._System.object? Tagclass._System.object Tagclass._module.Number Tagclass._module.Integer Tagclass._module.Number? Tagclass._module.Integer? tytagFamily$object tytagFamily$Number tytagFamily$Integer)
)
...
(assert (forall ((|c#0@@0| T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType |c#0@@0| Tclass._module.Number $h@@0) ($IsAlloc refType |c#0@@0| Tclass._module.Number? $h@@0))
 :qid |unknown.0:0|
 :skolemid |1472|
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass._module.Number $h@@0))
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass._module.Number? $h@@0))
)))
...
(assert (forall (($o@@1 T@U) ($h@@3 T@U) ) (! (= ($IsAlloc refType $o@@1 Tclass._module.Number? $h@@3)  (or (= $o@@1 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@1) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1466|
 :pattern ( ($IsAlloc refType $o@@1 Tclass._module.Number? $h@@3))
)))
...
(assert (forall (($o@@7 T@U) ) (!  (=> ($Is refType $o@@7 Tclass._module.Integer?) ($Is refType $o@@7 Tclass._module.Number?))
 :qid |unknown.0:0|
 :skolemid |1525|
...
(assert (= (Tag Tclass._module.Integer?) Tagclass._module.Integer?))
(assert (= (TagFamily Tclass._module.Integer?) tytagFamily$Integer))
(assert (forall (($o@@8 T@U) ) (! (= ($Is refType $o@@8 Tclass._module.Number?)  (or (= $o@@8 null) (implements$_module.Number (dtype $o@@8))))
 :qid |unknown.0:0|
 :skolemid |1465|
 :pattern ( ($Is refType $o@@8 Tclass._module.Number?))
)))
(push 1)
...
(set-info :boogie-vc-id OverrideCheck$$_module.Integer.Print)
...
(assert (not
 ...
 :qid |CovariantCollectionsdfy.22:10|
 :skolemid |1479|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.Integer) ($IsAlloc refType this Tclass._module.Integer $Heap))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct))))
