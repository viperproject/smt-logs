...
(declare-fun Tagclass.All.ObjectContainer () T@U)
...
(declare-fun |##All.ObjectContainer.ObjectContainer| () T@U)
(declare-fun Tagclass.TraitDefinitions.NoMemberTrait? () T@U)
(declare-fun Tagclass.TraitDefinitions.NoMemberTrait2? () T@U)
(declare-fun Tagclass.TraitDefinitions.SuperTrait? () T@U)
(declare-fun Tagclass.TraitDefinitions.SubTrait? () T@U)
...
(declare-fun tytagFamily$ObjectContainer () T@U)
...
(declare-fun |$IsA#All.ObjectContainer| (T@U) Bool)
(declare-fun All.ObjectContainer.ObjectContainer_q (T@U) Bool)
...
(declare-fun Tclass.All.ObjectContainer () T@U)
...
(declare-fun |#All.ObjectContainer.ObjectContainer| (T@U) T@U)
(declare-fun Tclass.TraitDefinitions.SubTrait (T@U T@U) T@U)
...
(declare-fun All.ObjectContainer.y (T@U) T@U)
...
(assert (distinct TInt TagInt alloc Tagclass.TraitDefinitions.SubTrait Tagclass.All.Y Tagclass.All.ObjectContainer Tagclass.TraitDefinitions.SuperTrait Tagclass.All.Y? Tagclass.TraitDefinitions.NoMemberTrait Tagclass.TraitDefinitions.NoMemberTrait2 |##All.ObjectContainer.ObjectContainer| Tagclass.TraitDefinitions.NoMemberTrait? Tagclass.TraitDefinitions.NoMemberTrait2? Tagclass.TraitDefinitions.SuperTrait? Tagclass.TraitDefinitions.SubTrait? tytagFamily$SubTrait tytagFamily$Y tytagFamily$ObjectContainer tytagFamily$SuperTrait tytagFamily$NoMemberTrait tytagFamily$NoMemberTrait2)
)
...
(assert (forall ((d T@U) ) (!  (=> (|$IsA#All.ObjectContainer| d) (All.ObjectContainer.ObjectContainer_q d))
 :qid |unknown.0:0|
 :skolemid |2184|
 :pattern ( (|$IsA#All.ObjectContainer| d))
)))
...
(assert (forall ((d@@0 T@U) ) (!  (=> ($Is DatatypeTypeType d@@0 Tclass.All.ObjectContainer) (All.ObjectContainer.ObjectContainer_q d@@0))
 :qid |unknown.0:0|
 :skolemid |2185|
 :pattern ( (All.ObjectContainer.ObjectContainer_q d@@0) ($Is DatatypeTypeType d@@0 Tclass.All.ObjectContainer))
)))
...
(assert (forall ((d@@1 T@U) ) (! (= (All.ObjectContainer.ObjectContainer_q d@@1) (= (DatatypeCtorId d@@1) |##All.ObjectContainer.ObjectContainer|))
 :qid |unknown.0:0|
 :skolemid |2176|
 :pattern ( (All.ObjectContainer.ObjectContainer_q d@@1))
)))
...
(assert (forall ((d@@2 T@U) ) (!  (=> (All.ObjectContainer.ObjectContainer_q d@@2) (exists ((|a#1#0#0| T@U) ) (! (= d@@2 (|#All.ObjectContainer.ObjectContainer| |a#1#0#0|))
 :qid |traitsdfy.133:46|
 :skolemid |2177|
)))
 :qid |unknown.0:0|
 :skolemid |2178|
 :pattern ( (All.ObjectContainer.ObjectContainer_q d@@2))
)))
...
(assert (forall ((|a#2#0#0| T@U) ($h@@9 T@U) ) (!  (=> ($IsGoodHeap $h@@9) (= ($IsAlloc DatatypeTypeType (|#All.ObjectContainer.ObjectContainer| |a#2#0#0|) Tclass.All.ObjectContainer $h@@9) ($IsAlloc refType |a#2#0#0| (Tclass.All.Y TInt) $h@@9)))
 :qid |traitsdfy.133:46|
 :skolemid |2180|
 :pattern ( ($IsAlloc DatatypeTypeType (|#All.ObjectContainer.ObjectContainer| |a#2#0#0|) Tclass.All.ObjectContainer $h@@9))
)))
...
(assert (forall ((|a#0#0#0| T@U) ) (! (= (DatatypeCtorId (|#All.ObjectContainer.ObjectContainer| |a#0#0#0|)) |##All.ObjectContainer.ObjectContainer|)
 :qid |traitsdfy.133:46|
 :skolemid |2175|
 :pattern ( (|#All.ObjectContainer.ObjectContainer| |a#0#0#0|))
)))
(assert (forall ((|a#4#0#0| T@U) ) (! (= (All.ObjectContainer.y (|#All.ObjectContainer.ObjectContainer| |a#4#0#0|)) |a#4#0#0|)
 :qid |traitsdfy.133:46|
 :skolemid |2183|
 :pattern ( (|#All.ObjectContainer.ObjectContainer| |a#4#0#0|))
)))
...
(assert (= (Tag Tclass.All.ObjectContainer) Tagclass.All.ObjectContainer))
(assert (= (TagFamily Tclass.All.ObjectContainer) tytagFamily$ObjectContainer))
...
(assert (= (Tag Tclass.TraitDefinitions.SuperTrait?) Tagclass.TraitDefinitions.SuperTrait?))
(assert (= (TagFamily Tclass.TraitDefinitions.SuperTrait?) tytagFamily$SuperTrait))
(assert (forall ((|a#2#0#0@@0| T@U) ) (! (= ($Is DatatypeTypeType (|#All.ObjectContainer.ObjectContainer| |a#2#0#0@@0|) Tclass.All.ObjectContainer) ($Is refType |a#2#0#0@@0| (Tclass.All.Y TInt)))
 :qid |traitsdfy.133:46|
 :skolemid |2179|
 :pattern ( ($Is DatatypeTypeType (|#All.ObjectContainer.ObjectContainer| |a#2#0#0@@0|) Tclass.All.ObjectContainer))
)))
(assert (forall ((d@@3 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) (and (All.ObjectContainer.ObjectContainer_q d@@3) ($IsAlloc DatatypeTypeType d@@3 Tclass.All.ObjectContainer $h@@10))) ($IsAlloc refType (All.ObjectContainer.y d@@3) (Tclass.All.Y TInt) $h@@10))
 :qid |unknown.0:0|
 :skolemid |2181|
 :pattern ( ($IsAlloc refType (All.ObjectContainer.y d@@3) (Tclass.All.Y TInt) $h@@10))
)))
...
(declare-fun |p#0| () T@U)
(declare-fun |defass#y2#0| () Bool)
(declare-fun |y2#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$All.__default.ParameterBorrows)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (All.ObjectContainer.ObjectContainer_q |o#0|)) (and (All.ObjectContainer.ObjectContainer_q |o#0|) (= |y2#0@0| (All.ObjectContainer.y |o#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@18 T@U) ) (!  (=> (and (or (not (= $o@@18 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@18) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@18) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@18)))
 :qid |traitsdfy.143:10|
 :skolemid |2080|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |y#0| (Tclass.All.Y TInt)) ($IsAlloc refType |y#0| (Tclass.All.Y TInt) $Heap))) (and (and ($Is DatatypeTypeType |o#0| Tclass.All.ObjectContainer) ($IsAlloc DatatypeTypeType |o#0| Tclass.All.ObjectContainer $Heap)) (|$IsA#All.ObjectContainer| |o#0|))) (and (and (and (=> |defass#z#0| (and ($Is refType |z#0| (Tclass.TraitDefinitions.SubTrait TInt TInt)) ($IsAlloc refType |z#0| (Tclass.TraitDefinitions.SubTrait TInt TInt) $Heap))) true) (and (=> |defass#p#0| (and ($Is refType |p#0| Tclass.TraitDefinitions.SuperTrait) ($IsAlloc refType |p#0| Tclass.TraitDefinitions.SuperTrait $Heap))) true)) (and (and (=> |defass#y2#0| (and ($Is refType |y2#0| (Tclass.All.Y TInt)) ($IsAlloc refType |y2#0| (Tclass.All.Y TInt) $Heap))) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 4) 2))))) anon0_correct)))
