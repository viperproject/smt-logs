...
(assert (forall ((t0@@10 T@U) (t1@@7 T@U) (t2@@6 T@U) (h0 T@U) (h1 T@U) (f@@5 T@U) (bx0@@4 T@U) (bx1@@4 T@U) ) (!  (=> (and (and (and ($HeapSucc h0 h1) (and ($IsGoodHeap h0) ($IsGoodHeap h1))) (and (and ($IsBox bx0@@4 t0@@10) ($IsBox bx1@@4 t1@@7)) ($Is HandleTypeType f@@5 (Tclass._System.___hFunc2 t0@@10 t1@@7 t2@@6)))) (forall ((o@@4 T@U) (fld T@U) ) (!  (=> (and (or (not (= o@@4 null)) (not true)) (|Set#IsMember| (Reads2 t0@@10 t1@@7 t2@@6 h0 f@@5 bx0@@4 bx1@@4) ($Box refType o@@4))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0 o@@4) fld) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1 o@@4) fld)))
 :qid |unknown.0:0|
 :skolemid |2254|
))) (= (Requires2 t0@@10 t1@@7 t2@@6 h0 f@@5 bx0@@4 bx1@@4) (Requires2 t0@@10 t1@@7 t2@@6 h1 f@@5 bx0@@4 bx1@@4)))
 :qid |unknown.0:0|
 :skolemid |2255|
...
(assert (forall ((t0@@11 T@U) (t1@@8 T@U) (t2@@7 T@U) (h0@@0 T@U) (h1@@0 T@U) (f@@6 T@U) (bx0@@5 T@U) (bx1@@5 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@0 h1@@0) (and ($IsGoodHeap h0@@0) ($IsGoodHeap h1@@0))) (and (and ($IsBox bx0@@5 t0@@11) ($IsBox bx1@@5 t1@@8)) ($Is HandleTypeType f@@6 (Tclass._System.___hFunc2 t0@@11 t1@@8 t2@@7)))) (forall ((o@@5 T@U) (fld@@0 T@U) ) (!  (=> (and (or (not (= o@@5 null)) (not true)) (|Set#IsMember| (Reads2 t0@@11 t1@@8 t2@@7 h1@@0 f@@6 bx0@@5 bx1@@5) ($Box refType o@@5))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@0 o@@5) fld@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@0 o@@5) fld@@0)))
 :qid |unknown.0:0|
 :skolemid |2256|
))) (= (Requires2 t0@@11 t1@@8 t2@@7 h0@@0 f@@6 bx0@@5 bx1@@5) (Requires2 t0@@11 t1@@8 t2@@7 h1@@0 f@@6 bx0@@5 bx1@@5)))
 :qid |unknown.0:0|
 :skolemid |2257|
...
(assert (forall ((t0@@12 T@U) (t1@@9 T@U) (t2@@8 T@U) (h0@@1 T@U) (h1@@1 T@U) (f@@7 T@U) (bx0@@6 T@U) (bx1@@6 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@1 h1@@1) (and ($IsGoodHeap h0@@1) ($IsGoodHeap h1@@1))) (and (and ($IsBox bx0@@6 t0@@12) ($IsBox bx1@@6 t1@@9)) ($Is HandleTypeType f@@7 (Tclass._System.___hFunc2 t0@@12 t1@@9 t2@@8)))) (forall ((o@@7 T@U) (fld@@1 T@U) ) (!  (=> (and (or (not (= o@@7 null)) (not true)) (|Set#IsMember| (Reads2 t0@@12 t1@@9 t2@@8 h0@@1 f@@7 bx0@@6 bx1@@6) ($Box refType o@@7))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@1 o@@7) fld@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@1 o@@7) fld@@1)))
 :qid |unknown.0:0|
 :skolemid |2250|
))) (= (Reads2 t0@@12 t1@@9 t2@@8 h0@@1 f@@7 bx0@@6 bx1@@6) (Reads2 t0@@12 t1@@9 t2@@8 h1@@1 f@@7 bx0@@6 bx1@@6)))
 :qid |unknown.0:0|
 :skolemid |2251|
 :pattern ( ($HeapSucc h0@@1 h1@@1) (Reads2 t0@@12 t1@@9 t2@@8 h1@@1 f@@7 bx0@@6 bx1@@6))
)))
(assert (forall ((t0@@13 T@U) (t1@@10 T@U) (t2@@9 T@U) (h0@@2 T@U) (h1@@2 T@U) (f@@8 T@U) (bx0@@7 T@U) (bx1@@7 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@2 h1@@2) (and ($IsGoodHeap h0@@2) ($IsGoodHeap h1@@2))) (and (and ($IsBox bx0@@7 t0@@13) ($IsBox bx1@@7 t1@@10)) ($Is HandleTypeType f@@8 (Tclass._System.___hFunc2 t0@@13 t1@@10 t2@@9)))) (forall ((o@@8 T@U) (fld@@2 T@U) ) (!  (=> (and (or (not (= o@@8 null)) (not true)) (|Set#IsMember| (Reads2 t0@@13 t1@@10 t2@@9 h1@@2 f@@8 bx0@@7 bx1@@7) ($Box refType o@@8))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@2 o@@8) fld@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@2 o@@8) fld@@2)))
 :qid |unknown.0:0|
 :skolemid |2252|
))) (= (Reads2 t0@@13 t1@@10 t2@@9 h0@@2 f@@8 bx0@@7 bx1@@7) (Reads2 t0@@13 t1@@10 t2@@9 h1@@2 f@@8 bx0@@7 bx1@@7)))
 :qid |unknown.0:0|
 :skolemid |2253|
 :pattern ( ($HeapSucc h0@@2 h1@@2) (Reads2 t0@@13 t1@@10 t2@@9 h1@@2 f@@8 bx0@@7 bx1@@7))
)))
(assert (forall ((t0@@14 T@U) (t1@@11 T@U) (t2@@10 T@U) (h0@@3 T@U) (h1@@3 T@U) (f@@9 T@U) (bx0@@8 T@U) (bx1@@8 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@3 h1@@3) (and ($IsGoodHeap h0@@3) ($IsGoodHeap h1@@3))) (and (and ($IsBox bx0@@8 t0@@14) ($IsBox bx1@@8 t1@@11)) ($Is HandleTypeType f@@9 (Tclass._System.___hFunc2 t0@@14 t1@@11 t2@@10)))) (forall ((o@@9 T@U) (fld@@3 T@U) ) (!  (=> (and (or (not (= o@@9 null)) (not true)) (|Set#IsMember| (Reads2 t0@@14 t1@@11 t2@@10 h0@@3 f@@9 bx0@@8 bx1@@8) ($Box refType o@@9))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@3 o@@9) fld@@3) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@3 o@@9) fld@@3)))
 :qid |unknown.0:0|
 :skolemid |2258|
))) (= (Apply2 t0@@14 t1@@11 t2@@10 h0@@3 f@@9 bx0@@8 bx1@@8) (Apply2 t0@@14 t1@@11 t2@@10 h1@@3 f@@9 bx0@@8 bx1@@8)))
 :qid |unknown.0:0|
 :skolemid |2259|
 :pattern ( ($HeapSucc h0@@3 h1@@3) (Apply2 t0@@14 t1@@11 t2@@10 h1@@3 f@@9 bx0@@8 bx1@@8))
)))
(assert (forall ((t0@@15 T@U) (t1@@12 T@U) (t2@@11 T@U) (h0@@4 T@U) (h1@@4 T@U) (f@@10 T@U) (bx0@@9 T@U) (bx1@@9 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@4 h1@@4) (and ($IsGoodHeap h0@@4) ($IsGoodHeap h1@@4))) (and (and ($IsBox bx0@@9 t0@@15) ($IsBox bx1@@9 t1@@12)) ($Is HandleTypeType f@@10 (Tclass._System.___hFunc2 t0@@15 t1@@12 t2@@11)))) (forall ((o@@10 T@U) (fld@@4 T@U) ) (!  (=> (and (or (not (= o@@10 null)) (not true)) (|Set#IsMember| (Reads2 t0@@15 t1@@12 t2@@11 h1@@4 f@@10 bx0@@9 bx1@@9) ($Box refType o@@10))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@4 o@@10) fld@@4) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@4 o@@10) fld@@4)))
 :qid |unknown.0:0|
 :skolemid |2260|
))) (= (Apply2 t0@@15 t1@@12 t2@@11 h0@@4 f@@10 bx0@@9 bx1@@9) (Apply2 t0@@15 t1@@12 t2@@11 h1@@4 f@@10 bx0@@9 bx1@@9)))
 :qid |unknown.0:0|
 :skolemid |2261|
...
(set-info :boogie-vc-id Impl$$EnumerationRegression.__default.ToSeq)
...
(let ((anon7_correct  (and (=> (= (ControlFlow 0 4) (- 0 7)) (exists ((|$as#x0_0#0_0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0| EnumerationRegression._default.ToSeq$X) (|Set#IsMember| |ss#0@0| |$as#x0_0#0_0|))
 :qid |Comprehensionsdfy.574:11|
 :skolemid |2315|
))) (=> (exists ((|$as#x0_0#0_0@@0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0@@0| EnumerationRegression._default.ToSeq$X) (|Set#IsMember| |ss#0@0| |$as#x0_0#0_0@@0|))
 :qid |Comprehensionsdfy.574:11|
 :skolemid |2315|
)) (=> (and (=> true (and ($IsBox |x#0_0@1| EnumerationRegression._default.ToSeq$X) ($IsAllocBox |x#0_0@1| EnumerationRegression._default.ToSeq$X $Heap))) (|Set#IsMember| |ss#0@0| |x#0_0@1|)) (and (=> (= (ControlFlow 0 4) (- 0 6)) true) (=> (= |$rhs#0_0@1| (|Set#Difference| |ss#0@0| (|Set#UnionOne| |Set#Empty| |x#0_0@1|))) (and (=> (= (ControlFlow 0 4) (- 0 5)) true) (=> (and (= |$rhs#0_1@1| (|Seq#Append| |r#0@1| (|Seq#Build| |Seq#Empty| |x#0_0@1|))) (= (ControlFlow 0 4) (- 0 3))) (and (|Set#Subset| |$rhs#0_0@1| |ss#0@0|) (not (|Set#Subset| |ss#0@0| |$rhs#0_0@1|))))))))))))
