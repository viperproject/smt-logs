...
procedure {:verboseName "ImportedTypes.Test (correctness)"} Impl$$ImportedTypes.__default.Test() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ImportedTypes.Test (correctness)"} Impl$$ImportedTypes.__default.Test() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var c#0: DatatypeType
     where $Is(c#0, Tclass.ImportedTypes_mLibrary.Color())
       && $IsAlloc(c#0, Tclass.ImportedTypes_mLibrary.Color(), $Heap);
  var a##0: DatatypeType;
  var co#0: DatatypeType
     where $Is(co#0, Tclass.ImportedTypes_mLibrary.CoColor())
       && $IsAlloc(co#0, Tclass.ImportedTypes_mLibrary.CoColor(), $Heap);
  var a##1: DatatypeType;
  var mo#0: DatatypeType
     where $Is(mo#0, Tclass.ImportedTypes_mLibrary.MoColor())
       && $IsAlloc(mo#0, Tclass.ImportedTypes_mLibrary.MoColor(), $Heap);
  var a##2: DatatypeType;
  var nt#0: real where LitReal(-1e0) <= nt#0 && nt#0 <= LitReal(1e0);
  var a##3: real;

    // AddMethodImpl: Test, Impl$$ImportedTypes.__default.Test
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    havoc c#0 /* where $Is(c#0, Tclass.ImportedTypes_mLibrary.Color())
       && $IsAlloc(c#0, Tclass.ImportedTypes_mLibrary.Color(), $Heap) */;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(271,8)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    a##0 := c#0;
    call {:id "id181"} Call$$ImportedTypes.__default.Try(Tclass.ImportedTypes_mLibrary.Color(), $Box(a##0));
    // TrCallStmt: After ProcessCallStmt
    havoc co#0 /* where $Is(co#0, Tclass.ImportedTypes_mLibrary.CoColor())
       && $IsAlloc(co#0, Tclass.ImportedTypes_mLibrary.CoColor(), $Heap) */;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(274,8)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    a##1 := co#0;
    call {:id "id182"} Call$$ImportedTypes.__default.Try(Tclass.ImportedTypes_mLibrary.CoColor(), $Box(a##1));
    // TrCallStmt: After ProcessCallStmt
    havoc mo#0 /* where $Is(mo#0, Tclass.ImportedTypes_mLibrary.MoColor())
       && $IsAlloc(mo#0, Tclass.ImportedTypes_mLibrary.MoColor(), $Heap) */;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(276,8)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    a##2 := mo#0;
    call {:id "id183"} Call$$ImportedTypes.__default.Try(Tclass.ImportedTypes_mLibrary.MoColor(), $Box(a##2));
    // TrCallStmt: After ProcessCallStmt
    havoc nt#0 /* where LitReal(-1e0) <= nt#0 && nt#0 <= LitReal(1e0) */;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(279,8)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    a##3 := nt#0;
    call {:id "id184"} Call$$ImportedTypes.__default.Try(Tclass.ImportedTypes_mLibrary.Nt(), $Box(a##3));
    // TrCallStmt: After ProcessCallStmt
}



procedure {:verboseName "ImportedTypes.Try (well-formedness)"} CheckWellFormed$$ImportedTypes.__default.Try(ImportedTypes._default.Try$A: Ty, 
    a#0: Box
       where $IsBox(a#0, ImportedTypes._default.Try$A)
         && $IsAllocBox(a#0, ImportedTypes._default.Try$A, $Heap));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "ImportedTypes.Try (call)"} Call$$ImportedTypes.__default.Try(ImportedTypes._default.Try$A: Ty, 
    a#0: Box
       where $IsBox(a#0, ImportedTypes._default.Try$A)
         && $IsAllocBox(a#0, ImportedTypes._default.Try$A, $Heap));
  modifies $Heap;
...
procedure {:verboseName "ImportedTypes.Try (correctness)"} Impl$$ImportedTypes.__default.Try(ImportedTypes._default.Try$A: Ty, 
    a#0: Box
       where $IsBox(a#0, ImportedTypes._default.Try$A)
         && $IsAllocBox(a#0, ImportedTypes._default.Try$A, $Heap))
...
axiom (forall a#0#0#0: int :: 
  { #ImportedTypes.Library.Color.Red(a#0#0#0) } 
  DatatypeCtorId(#ImportedTypes.Library.Color.Red(a#0#0#0))
...
axiom (forall d: DatatypeType :: 
  { ImportedTypes_mLibrary.Color.Red_q(d) } 
  ImportedTypes_mLibrary.Color.Red_q(d)
     ==> (exists a#1#0#0: int :: d == #ImportedTypes.Library.Color.Red(a#1#0#0)));

// Constructor $Is
axiom (forall a#2#0#0: int :: 
  { $Is(#ImportedTypes.Library.Color.Red(a#2#0#0), Tclass.ImportedTypes_mLibrary.Color()) } 
  $Is(#ImportedTypes.Library.Color.Red(a#2#0#0), Tclass.ImportedTypes_mLibrary.Color())
     <==> $Is(a#2#0#0, TInt));
...
axiom (forall a#3#0#0: int :: 
  { #ImportedTypes.Library.Color.Red(LitInt(a#3#0#0)) } 
  #ImportedTypes.Library.Color.Red(LitInt(a#3#0#0))
     == Lit(#ImportedTypes.Library.Color.Red(a#3#0#0)));

function ImportedTypes_mLibrary.Color._h14(DatatypeType) : int;

// Constructor injectivity
axiom (forall a#4#0#0: int :: 
  { #ImportedTypes.Library.Color.Red(a#4#0#0) } 
  ImportedTypes_mLibrary.Color._h14(#ImportedTypes.Library.Color.Red(a#4#0#0))
     == a#4#0#0);
...
axiom (forall a#5#0#0: real :: 
  { #ImportedTypes.Library.Color.Green(a#5#0#0) } 
  DatatypeCtorId(#ImportedTypes.Library.Color.Green(a#5#0#0))
...
axiom (forall d: DatatypeType :: 
  { ImportedTypes_mLibrary.Color.Green_q(d) } 
  ImportedTypes_mLibrary.Color.Green_q(d)
     ==> (exists a#6#0#0: real :: d == #ImportedTypes.Library.Color.Green(a#6#0#0)));

// Constructor $Is
axiom (forall a#7#0#0: real :: 
  { $Is(#ImportedTypes.Library.Color.Green(a#7#0#0), 
...
axiom (forall a#8#0#0: real :: 
  { #ImportedTypes.Library.Color.Green(LitReal(a#8#0#0)) } 
  #ImportedTypes.Library.Color.Green(LitReal(a#8#0#0))
     == Lit(#ImportedTypes.Library.Color.Green(a#8#0#0)));

function ImportedTypes_mLibrary.Color._h15(DatatypeType) : real;

// Constructor injectivity
axiom (forall a#9#0#0: real :: 
  { #ImportedTypes.Library.Color.Green(a#9#0#0) } 
  ImportedTypes_mLibrary.Color._h15(#ImportedTypes.Library.Color.Green(a#9#0#0))
     == a#9#0#0);
...
uses {
// Constructor identifier
axiom (forall a#10#0#0: bv30 :: 
  { #ImportedTypes.Library.Color.Blue(a#10#0#0) } 
  DatatypeCtorId(#ImportedTypes.Library.Color.Blue(a#10#0#0))
...
axiom (forall d: DatatypeType :: 
  { ImportedTypes_mLibrary.Color.Blue_q(d) } 
  ImportedTypes_mLibrary.Color.Blue_q(d)
     ==> (exists a#11#0#0: bv30 :: d == #ImportedTypes.Library.Color.Blue(a#11#0#0)));

// Constructor $Is
axiom (forall a#12#0#0: bv30 :: 
  { $Is(#ImportedTypes.Library.Color.Blue(a#12#0#0), 
      Tclass.ImportedTypes_mLibrary.Color()) } 
  $Is(#ImportedTypes.Library.Color.Blue(a#12#0#0), 
      Tclass.ImportedTypes_mLibrary.Color())
     <==> $Is(a#12#0#0, TBitvector(30)));
...
// Constructor literal
axiom (forall a#13#0#0: bv30 :: 
  { #ImportedTypes.Library.Color.Blue(Lit(a#13#0#0)) } 
  #ImportedTypes.Library.Color.Blue(Lit(a#13#0#0))
     == Lit(#ImportedTypes.Library.Color.Blue(a#13#0#0)));

function ImportedTypes_mLibrary.Color._h16(DatatypeType) : bv30;

// Constructor injectivity
axiom (forall a#14#0#0: bv30 :: 
  { #ImportedTypes.Library.Color.Blue(a#14#0#0) } 
  ImportedTypes_mLibrary.Color._h16(#ImportedTypes.Library.Color.Blue(a#14#0#0))
     == a#14#0#0);
...
axiom (forall a#15#0#0: int :: 
  { #ImportedTypes.Library.CoColor.Yellow(a#15#0#0) } 
  DatatypeCtorId(#ImportedTypes.Library.CoColor.Yellow(a#15#0#0))
...
axiom (forall d: DatatypeType :: 
  { ImportedTypes_mLibrary.CoColor.Yellow_q(d) } 
  ImportedTypes_mLibrary.CoColor.Yellow_q(d)
     ==> (exists a#16#0#0: int :: d == #ImportedTypes.Library.CoColor.Yellow(a#16#0#0)));

// Constructor $Is
axiom (forall a#17#0#0: int :: 
  { $Is(#ImportedTypes.Library.CoColor.Yellow(a#17#0#0), 
...
axiom (forall a#18#0#0: int :: 
  { #ImportedTypes.Library.CoColor.Yellow(a#18#0#0) } 
  ImportedTypes_mLibrary.CoColor._h17(#ImportedTypes.Library.CoColor.Yellow(a#18#0#0))
     == a#18#0#0);
...
axiom (forall a#19#0#0: int, a#19#1#0: DatatypeType :: 
  { #ImportedTypes.Library.MoColor.MoYellow(a#19#0#0, a#19#1#0) } 
  DatatypeCtorId(#ImportedTypes.Library.MoColor.MoYellow(a#19#0#0, a#19#1#0))
...
axiom (forall d: DatatypeType :: 
  ...
  ImportedTypes_mLibrary.MoColor.MoYellow_q(d)
     ==> (exists a#20#0#0: int, a#20#1#0: DatatypeType :: 
      d == #ImportedTypes.Library.MoColor.MoYellow(a#20#0#0, a#20#1#0)));

// Constructor $Is
axiom (forall a#21#0#0: int, a#21#1#0: DatatypeType :: 
  { $Is(#ImportedTypes.Library.MoColor.MoYellow(a#21#0#0, a#21#1#0), 
      Tclass.ImportedTypes_mLibrary.MoColor()) } 
  $Is(#ImportedTypes.Library.MoColor.MoYellow(a#21#0#0, a#21#1#0), 
      Tclass.ImportedTypes_mLibrary.MoColor())
     <==> $Is(a#21#0#0, TInt) && $Is(a#21#1#0, Tclass.ImportedTypes_mLibrary.MoColor()));
...
axiom (forall a#22#0#0: int, a#22#1#0: DatatypeType :: 
  { #ImportedTypes.Library.MoColor.MoYellow(a#22#0#0, a#22#1#0) } 
  ImportedTypes_mLibrary.MoColor._h18(#ImportedTypes.Library.MoColor.MoYellow(a#22#0#0, a#22#1#0))
     == a#22#0#0);
...
axiom (forall a#23#0#0: int, a#23#1#0: DatatypeType :: 
  { #ImportedTypes.Library.MoColor.MoYellow(a#23#0#0, a#23#1#0) } 
  ImportedTypes_mLibrary.MoColor._h19(#ImportedTypes.Library.MoColor.MoYellow(a#23#0#0, a#23#1#0))
     == a#23#1#0);
