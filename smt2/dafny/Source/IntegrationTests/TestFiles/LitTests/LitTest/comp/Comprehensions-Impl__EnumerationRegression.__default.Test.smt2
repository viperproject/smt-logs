...
(assert (forall ((|x#0@@3| T@U) ) (! (= ($Is intType |x#0@@3| Tclass.EnumerationRegression.AlsoLong)  (and (<= (LitInt 137438953474) (U_2_int |x#0@@3|)) (< (U_2_int |x#0@@3|) 137438953480)))
 :pattern ( ($Is intType |x#0@@3| Tclass.EnumerationRegression.AlsoLong))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@5| Int) ) (!  (=> (or (|EnumerationRegression.__default.Digit#canCall| |x#0@@5|) (and (< 0 $FunctionContextHeight) (and (<= (LitInt 137438953472) |x#0@@5|) (< |x#0@@5| 137438953482)))) (= (EnumerationRegression.__default.Digit |x#0@@5|) (|char#Plus| (|char#FromInt| 97) (|char#FromInt| (- |x#0@@5| 137438953472)))))
 :pattern ( (EnumerationRegression.__default.Digit |x#0@@5|))
))))
