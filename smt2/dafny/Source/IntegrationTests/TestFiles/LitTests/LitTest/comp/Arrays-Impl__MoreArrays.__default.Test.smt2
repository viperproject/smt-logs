...
(assert (distinct alloc Tagclass._System.array? Tagclass._System.array Tagclass.MoreArrays.byte tytagFamily$array tytagFamily$byte)
)
...
(set-info :boogie-vc-id Impl$$MoreArrays.__default.Test)
