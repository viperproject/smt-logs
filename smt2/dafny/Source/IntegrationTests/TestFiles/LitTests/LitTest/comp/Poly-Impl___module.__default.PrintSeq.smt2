...
(assert (distinct TagSeq alloc Tagclass._module.Shape? Tagclass._module.Shape tytagFamily$Shape)
)
...
(let ((anon10_Else_correct  (=> (and (< |i#0@1| (LitInt 0)) (= (ControlFlow 0 13) 11)) anon4_correct)))
(let ((anon10_Then_correct  (=> (and (<= (LitInt 0) |i#0@1|) (= (ControlFlow 0 12) 11)) anon4_correct)))
(let ((anon9_Then_correct  (=> (not |$w$loop#0@0|) (and (=> (= (ControlFlow 0 14) 12) anon10_Then_correct) (=> (= (ControlFlow 0 14) 13) anon10_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (< |i#0@1| (|Seq#Length| |shapes#0|)) (= |$decr$loop#00@1| (- (|Seq#Length| |shapes#0|) |i#0@1|))) (and (=> (= (ControlFlow 0 4) (- 0 9)) (and (<= 0 |i#0@1|) (< |i#0@1| (|Seq#Length| |shapes#0|)))) (=> (and (<= 0 |i#0@1|) (< |i#0@1| (|Seq#Length| |shapes#0|))) (and (=> (= (ControlFlow 0 4) (- 0 8)) (or (not (= ($Unbox refType (|Seq#Index| |shapes#0| |i#0@1|)) null)) (not true))) (=> (or (not (= ($Unbox refType (|Seq#Index| |shapes#0| |i#0@1|)) null)) (not true)) (=> (= call0formal@this@0 ($Unbox refType (|Seq#Index| |shapes#0| |i#0@1|))) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (forall (($o@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@2) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@2) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@2)))
 :qid |Polydfy.6:10|
 :skolemid |574|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@2))
))) (and ($HeapSucc $Heap@0 $Heap@1) (= |i#0@2| (+ |i#0@1| 1)))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (or (<= 0 |$decr$loop#00@1|) (= (- (|Seq#Length| |shapes#0|) |i#0@2|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- (|Seq#Length| |shapes#0|) |i#0@2|) |$decr$loop#00@1|)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (< (- (|Seq#Length| |shapes#0|) |i#0@2|) |$decr$loop#00@1|)) (=> (< (- (|Seq#Length| |shapes#0|) |i#0@2|) |$decr$loop#00@1|) (and (=> (= (ControlFlow 0 4) (- 0 5)) (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@2|))) (=> (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@2|)) (=> (= (ControlFlow 0 4) (- 0 3)) (=> |$w$loop#0@0| (<= |i#0@2| (|Seq#Length| |shapes#0|)))))))))))))))))))
(let ((anon11_Then_correct true))
(let ((anon9_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 10) 2) anon11_Then_correct) (=> (= (ControlFlow 0 10) 4) anon11_Else_correct)))))
(let ((anon8_LoopBody_correct  (and (=> (= (ControlFlow 0 15) 14) anon9_Then_correct) (=> (= (ControlFlow 0 15) 10) anon9_Else_correct))))
(let ((anon8_LoopDone_correct true))
(let ((anon8_LoopHead_correct  (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (not false) (<= 0 |i#0@1|)) (and (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@1|)) (=> |$w$loop#0@0| (<= |i#0@1| (|Seq#Length| |shapes#0|))))) (and (and (forall (($o@@3 T@U) ) (!  (=> (and (or (not (= $o@@3 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@3) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@3) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@3)))
 :qid |Polydfy.53:3|
 :skolemid |490|
...
)) (<= (- (|Seq#Length| |shapes#0|) |i#0@1|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 16) 1) anon8_LoopDone_correct) (=> (= (ControlFlow 0 16) 15) anon8_LoopBody_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |i#0@0| (LitInt 0)) (= |$decr_init$loop#00@0| (- (|Seq#Length| |shapes#0|) |i#0@0|))) (and (=> (= (ControlFlow 0 17) (- 0 19)) (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@0|))) (=> (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@0|)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (=> |$w$loop#0@0| (<= |i#0@0| (|Seq#Length| |shapes#0|)))) (=> (=> |$w$loop#0@0| (<= |i#0@0| (|Seq#Length| |shapes#0|))) (=> (= (ControlFlow 0 17) 16) anon8_LoopHead_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |shapes#0| (TSeq Tclass._module.Shape)) ($IsAlloc SeqType |shapes#0| (TSeq Tclass._module.Shape) $Heap)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 20) 17))) anon0_correct))))
