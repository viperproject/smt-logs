...
(assert (forall ((_module.Cell$T@@0 T@U) ($o@@0 T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType $o@@0 (Tclass._module.Cell? _module.Cell$T@@0) $h@@2)  (or (= $o@@0 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@0) alloc)))))
 :qid |unknown.0:0|
 :skolemid |7651|
 :pattern ( ($IsAlloc refType $o@@0 (Tclass._module.Cell? _module.Cell$T@@0) $h@@2))
)))
...
(assert (forall ((_module.Cell$T@@4 T@U) ($h@@3 T@U) ($o@@1 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@3) (and (or (not (= $o@@1 null)) (not true)) (= (dtype $o@@1) (Tclass._module.Cell? _module.Cell$T@@4)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@1) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@1) _module.Cell.arr)) (Tclass._System.array _module.Cell$T@@4) $h@@3))
 :qid |unknown.0:0|
 :skolemid |7653|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@1) _module.Cell.arr)) (Tclass._module.Cell? _module.Cell$T@@4))
)))
(assert (forall ((_System.array$arg@@4 T@U) ($o@@2 T@U) ) (! (= ($Is refType $o@@2 (Tclass._System.array? _System.array$arg@@4))  (or (= $o@@2 null) (= (dtype $o@@2) (Tclass._System.array? _System.array$arg@@4))))
 :qid |unknown.0:0|
 :skolemid |7126|
 :pattern ( ($Is refType $o@@2 (Tclass._System.array? _System.array$arg@@4)))
)))
(assert (forall ((_module.Cell$T@@5 T@U) ($o@@3 T@U) ) (! (= ($Is refType $o@@3 (Tclass._module.Cell? _module.Cell$T@@5))  (or (= $o@@3 null) (= (dtype $o@@3) (Tclass._module.Cell? _module.Cell$T@@5))))
 :qid |unknown.0:0|
 :skolemid |7650|
 :pattern ( ($Is refType $o@@3 (Tclass._module.Cell? _module.Cell$T@@5)))
)))
...
(assert (forall ((_module.Cell$T@@8 T@U) ($h@@4 T@U) ($o@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (or (not (= $o@@5 null)) (not true)) (= (dtype $o@@5) (Tclass._module.Cell? _module.Cell$T@@8)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@5) _module.Cell.arr)) (Tclass._System.array _module.Cell$T@@8)))
 :qid |unknown.0:0|
 :skolemid |7652|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@5) _module.Cell.arr)) (Tclass._module.Cell? _module.Cell$T@@8))
)))
(push 1)
...
(declare-fun _module.Cell$T@@9 () T@U)
(declare-fun |x#0| () T@U)
(declare-fun |y#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.Cell.MArray2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |$rhs#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.Cell.arr))) (= |$rhs#1@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.Cell.arr)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= |$rhs#0@0| |$rhs#1@0|)) (=> (= |$rhs#0@0| |$rhs#1@0|) (=> (= (ControlFlow 0 2) (- 0 1)) (= |$rhs#1@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.Cell.arr))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass._module.Cell _module.Cell$T@@9)) ($IsAlloc refType this (Tclass._module.Cell _module.Cell$T@@9) $Heap))) (and ($Is refType |x#0| (Tclass._System.array _module.Cell$T@@9)) ($IsAlloc refType |x#0| (Tclass._System.array _module.Cell$T@@9) $Heap))) (and (and ($Is refType |y#0| (Tclass._System.array _module.Cell$T@@9)) ($IsAlloc refType |y#0| (Tclass._System.array _module.Cell$T@@9) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct))))
