...
(set-info :boogie-vc-id CheckWellFormed$$ImportedTypes_mLibrary.Nt)
...
(let ((anon8_Else_correct  (=> (and (< |r#0| (LitReal (- 0.0 1.0))) (= (ControlFlow 0 6) 4)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (<= (LitReal (- 0.0 1.0)) |r#0|) (= (ControlFlow 0 5) 4)) anon4_correct)))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitReal (- 0.0 1.0)) (LitReal 0.0))) (=> (= (ControlFlow 0 2) (- 0 1)) (<= (LitReal 0.0) (LitReal 1.0))))))
