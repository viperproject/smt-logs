...
(declare-fun |_module.__default.ZeroSeq#canCall| () Bool)
(declare-fun _module.__default.ZeroSeq () T@U)
(declare-fun Lit (T@T T@U) T@U)
(declare-fun SeqType () T@T)
(declare-fun |Seq#Build| (T@U T@U) T@U)
(declare-fun $Box (T@T T@U) T@U)
(declare-fun LitInt (Int) Int)
(declare-fun _module.__default.UpTo (T@U Int) T@U)
...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.ZeroSeq#canCall| (< 0 $FunctionContextHeight)) (= _module.__default.ZeroSeq (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 0)))))))))
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.ZeroSeq#canCall| (< 0 $FunctionContextHeight)) (= _module.__default.ZeroSeq (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 0)))))))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly T@U) (|n#0| Int) ) (!  (=> (or (|_module.__default.UpTo#canCall| |n#0|) (and (< 1 $FunctionContextHeight) (<= (LitInt 0) |n#0|))) (and (and (=> (= |n#0| (LitInt 0)) |_module.__default.ZeroSeq#canCall|) (=> (or (not (= |n#0| (LitInt 0))) (not true)) (|_module.__default.UpTo#canCall| (- |n#0| 1)))) (= (_module.__default.UpTo ($LS $ly) |n#0|) (ite (= |n#0| (LitInt 0)) _module.__default.ZeroSeq (|Seq#Append| (_module.__default.UpTo $ly (- |n#0| 1)) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |n#0|))))))))
 :qid |TailRecursiondfy.243:27|
 :skolemid |1207|
 :pattern ( (_module.__default.UpTo ($LS $ly) |n#0|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@0 T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.__default.UpTo#canCall| |n#0@@0|) (and (< 1 $FunctionContextHeight) (<= (LitInt 0) |n#0@@0|))) ($Is SeqType (_module.__default.UpTo $ly@@0 |n#0@@0|) (TSeq Tclass._System.nat)))
 :qid |TailRecursiondfy.243:27|
 :skolemid |1205|
 :pattern ( (_module.__default.UpTo $ly@@0 |n#0@@0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.ZeroSeq#canCall| (< 0 $FunctionContextHeight)) ($Is SeqType _module.__default.ZeroSeq (TSeq TInt)))))
...
(assert (forall (($ly@@1 T@U) (|n#0@@1| Int) ) (! (= (_module.__default.UpTo ($LS $ly@@1) |n#0@@1|) (_module.__default.UpTo $ly@@1 |n#0@@1|))
 :qid |TailRecursiondfy.243:27|
 :skolemid |1203|
 :pattern ( (_module.__default.UpTo ($LS $ly@@1) |n#0@@1|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) (|n#0@@2| Int) ) (!  (=> (or (|_module.__default.UpTo#canCall| (LitInt |n#0@@2|)) (and (< 1 $FunctionContextHeight) (<= (LitInt 0) |n#0@@2|))) (and (and (=> (= (LitInt |n#0@@2|) (LitInt 0)) |_module.__default.ZeroSeq#canCall|) (=> (or (not (= (LitInt |n#0@@2|) (LitInt 0))) (not true)) (|_module.__default.UpTo#canCall| (LitInt (- |n#0@@2| 1))))) (= (_module.__default.UpTo ($LS $ly@@2) (LitInt |n#0@@2|)) (ite (= (LitInt |n#0@@2|) (LitInt 0)) _module.__default.ZeroSeq (|Seq#Append| (_module.__default.UpTo ($LS $ly@@2) (LitInt (- |n#0@@2| 1))) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt |n#0@@2|)))))))))
 :qid |TailRecursiondfy.243:27|
 :weight 3
 :skolemid |1208|
 :pattern ( (_module.__default.UpTo ($LS $ly@@2) (LitInt |n#0@@2|)))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.UpTo)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon8_Else_correct  (=> (or (not (= |n#0@@3| (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 7)) ($Is intType (int_2_U (- |n#0@@3| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0@@3| 1)) Tclass._System.nat) (=> (and (= |##n#0@0| (- |n#0@@3| 1)) ($IsAlloc intType (int_2_U |##n#0@0|) Tclass._System.nat $Heap)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (<= 0 |n#0@@3|) (= |##n#0@0| |n#0@@3|))) (=> (or (<= 0 |n#0@@3|) (= |##n#0@0| |n#0@@3|)) (=> (= (ControlFlow 0 5) (- 0 4)) (< |##n#0@0| |n#0@@3|))))))))))
(let ((anon8_Then_correct  (=> (= |n#0@@3| (LitInt 0)) (=> (and |_module.__default.ZeroSeq#canCall| (= (ControlFlow 0 3) (- 0 2))) ($Is SeqType (Lit SeqType _module.__default.ZeroSeq) (TSeq Tclass._System.nat))))))
