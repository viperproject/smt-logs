...
(declare-fun |##_module.CCon.CCon| () T@U)
(declare-fun Tagclass._module.X? () T@U)
(declare-fun Tagclass._module.Int? () T@U)
...
(declare-fun _module.CCon.CCon_q (T@U) Bool)
...
(declare-fun |#_module.CCon.CCon| (T@U) T@U)
(declare-fun $FunctionContextHeight () Int)
(declare-fun _module.CCon.x (T@U T@U) Int)
(declare-fun Apply1 (T@U T@U T@U T@U T@U) T@U)
(declare-fun TagFamily (T@U) T@U)
(declare-fun _module.CCon.y (T@U T@U) T@U)
...
(declare-fun _module.CCon._h2 (T@U) T@U)
...
(assert (forall ((_module.CCon$T T@U) (d T@U) ) (!  (=> ($Is DatatypeTypeType d (Tclass._module.CCon _module.CCon$T)) (_module.CCon.CCon_q d))
 :qid |unknown.0:0|
 :skolemid |831|
 :pattern ( (_module.CCon.CCon_q d) ($Is DatatypeTypeType d (Tclass._module.CCon _module.CCon$T)))
)))
...
(assert (forall ((d@@0 T@U) ) (! (= (_module.CCon.CCon_q d@@0) (= (DatatypeCtorId d@@0) |##_module.CCon.CCon|))
 :qid |unknown.0:0|
 :skolemid |823|
 :pattern ( (_module.CCon.CCon_q d@@0))
)))
...
(assert (forall ((d@@1 T@U) ) (!  (=> (_module.CCon.CCon_q d@@1) (exists ((|a#1#0#0| T@U) ) (! (= d@@1 (|#_module.CCon.CCon| |a#1#0#0|))
 :qid |Variancedfy.78:28|
 :skolemid |824|
)))
 :qid |unknown.0:0|
 :skolemid |825|
 :pattern ( (_module.CCon.CCon_q d@@1))
)))
(assert  (=> (< 0 $FunctionContextHeight) (forall ((_module.CCon$T@@0 T@U) ($h@@6 T@U) ($o@@3 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@6) ($Is DatatypeTypeType $o@@3 (Tclass._module.CCon _module.CCon$T@@0))) ($IsAlloc DatatypeTypeType $o@@3 (Tclass._module.CCon _module.CCon$T@@0) $h@@6)) ($IsAlloc intType (int_2_U (_module.CCon.x _module.CCon$T@@0 $o@@3)) TInt $h@@6))
 :qid |unknown.0:0|
 :skolemid |844|
 :pattern ( (_module.CCon.x _module.CCon$T@@0 $o@@3) ($IsAlloc DatatypeTypeType $o@@3 (Tclass._module.CCon _module.CCon$T@@0) $h@@6))
))))
(assert ($IsGoodHeap $OneHeap))
(assert  (=> (< 0 $FunctionContextHeight) (forall ((_module.CCon$T@@1 T@U) ($o@@4 T@U) ) (!  (=> ($Is DatatypeTypeType $o@@4 (Tclass._module.CCon _module.CCon$T@@1)) ($Is intType (int_2_U (_module.CCon.x _module.CCon$T@@1 $o@@4)) TInt))
 :qid |unknown.0:0|
 :skolemid |843|
 :pattern ( (_module.CCon.x _module.CCon$T@@1 $o@@4))
))))
...
(assert (forall ((_module.CCon$T@@2 T@U) ) (!  (and (= (Tag (Tclass._module.CCon _module.CCon$T@@2)) Tagclass._module.CCon) (= (TagFamily (Tclass._module.CCon _module.CCon$T@@2)) tytagFamily$CCon))
 :qid |unknown.0:0|
 :skolemid |531|
 :pattern ( (Tclass._module.CCon _module.CCon$T@@2))
)))
(assert (= (Ctor SeqType) 11))
(assert  (=> (< 0 $FunctionContextHeight) (forall ((_module.CCon$T@@3 T@U) ($h@@7 T@U) ($o@@5 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@7) ($Is DatatypeTypeType $o@@5 (Tclass._module.CCon _module.CCon$T@@3))) ($IsAlloc DatatypeTypeType $o@@5 (Tclass._module.CCon _module.CCon$T@@3) $h@@7)) ($IsAlloc SeqType (_module.CCon.y _module.CCon$T@@3 $o@@5) (TSeq _module.CCon$T@@3) $h@@7))
 :qid |unknown.0:0|
 :skolemid |846|
 :pattern ( (_module.CCon.y _module.CCon$T@@3 $o@@5) ($IsAlloc DatatypeTypeType $o@@5 (Tclass._module.CCon _module.CCon$T@@3) $h@@7))
))))
...
(assert  (=> (< 0 $FunctionContextHeight) (forall ((_module.CCon$T@@4 T@U) ($o@@6 T@U) ) (!  (=> ($Is DatatypeTypeType $o@@6 (Tclass._module.CCon _module.CCon$T@@4)) ($Is SeqType (_module.CCon.y _module.CCon$T@@4 $o@@6) (TSeq _module.CCon$T@@4)))
 :qid |unknown.0:0|
 :skolemid |845|
 :pattern ( (_module.CCon.y _module.CCon$T@@4 $o@@6))
))))
...
(assert (forall ((_module.CCon$T@@5 T@U) (|a#2#0#0| T@U) ($h@@10 T@U) ) (!  (=> ($IsGoodHeap $h@@10) (= ($IsAlloc DatatypeTypeType (|#_module.CCon.CCon| |a#2#0#0|) (Tclass._module.CCon _module.CCon$T@@5) $h@@10) ($IsAlloc HandleTypeType |a#2#0#0| (Tclass._System.___hTotalFunc1 _module.CCon$T@@5 TInt) $h@@10)))
 :qid |unknown.0:0|
 :skolemid |827|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.CCon.CCon| |a#2#0#0|) (Tclass._module.CCon _module.CCon$T@@5) $h@@10))
)))
...
(assert (forall ((_module.CCon$T@@6 T@U) ) (! (= (Tclass._module.CCon_0 (Tclass._module.CCon _module.CCon$T@@6)) _module.CCon$T@@6)
 :qid |unknown.0:0|
 :skolemid |532|
 :pattern ( (Tclass._module.CCon _module.CCon$T@@6))
)))
(assert (forall ((|a#0#0#0| T@U) ) (! (= (DatatypeCtorId (|#_module.CCon.CCon| |a#0#0#0|)) |##_module.CCon.CCon|)
 :qid |Variancedfy.78:28|
 :skolemid |822|
 :pattern ( (|#_module.CCon.CCon| |a#0#0#0|))
)))
(assert (forall ((|a#3#0#0| T@U) ) (! (= (_module.CCon._h2 (|#_module.CCon.CCon| |a#3#0#0|)) |a#3#0#0|)
 :qid |Variancedfy.78:28|
 :skolemid |829|
 :pattern ( (|#_module.CCon.CCon| |a#3#0#0|))
)))
...
(assert (forall ((_module.CCon$T@@7 T@U) (|a#2#0#0@@0| T@U) ) (! (= ($Is DatatypeTypeType (|#_module.CCon.CCon| |a#2#0#0@@0|) (Tclass._module.CCon _module.CCon$T@@7)) ($Is HandleTypeType |a#2#0#0@@0| (Tclass._System.___hTotalFunc1 _module.CCon$T@@7 TInt)))
 :qid |unknown.0:0|
 :skolemid |826|
 :pattern ( ($Is DatatypeTypeType (|#_module.CCon.CCon| |a#2#0#0@@0|) (Tclass._module.CCon _module.CCon$T@@7)))
)))
...
(assert (forall ((_module.CCon$T@@8 T@U) (bx@@19 T@U) ) (!  (=> ($IsBox bx@@19 (Tclass._module.CCon _module.CCon$T@@8)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@19)) bx@@19) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@19) (Tclass._module.CCon _module.CCon$T@@8))))
 :qid |unknown.0:0|
 :skolemid |533|
 :pattern ( ($IsBox bx@@19 (Tclass._module.CCon _module.CCon$T@@8)))
)))
(assert (forall ((d@@2 T@U) (_module.CCon$T@@9 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (_module.CCon.CCon_q d@@2) ($IsAlloc DatatypeTypeType d@@2 (Tclass._module.CCon _module.CCon$T@@9) $h@@11))) ($IsAlloc HandleTypeType (_module.CCon._h2 d@@2) (Tclass._System.___hTotalFunc1 _module.CCon$T@@9 TInt) $h@@11))
 :qid |unknown.0:0|
 :skolemid |828|
 :pattern ( ($IsAlloc HandleTypeType (_module.CCon._h2 d@@2) (Tclass._System.___hTotalFunc1 _module.CCon$T@@9 TInt) $h@@11))
)))
...
(declare-fun call0formal@_module.CCon$T () T@U)
(declare-fun call0formal@_module.CCon$T@0 () T@U)
(declare-fun |call2formal@x#0@0| () T@U)
(declare-fun $Heap@1 () T@U)
(declare-fun |call4formal@r#0@0| () T@U)
(declare-fun |$rhs##0@0| () T@U)
(declare-fun call0formal@_module.CCon$T@0@@0 () T@U)
(declare-fun |call2formal@x#0@0@@0| () T@U)
(declare-fun $Heap@2 () T@U)
(declare-fun |##x#0@0| () Int)
(declare-fun |_module.CCon.C#canCall| (T@U T@U Int) Bool)
(declare-fun |##x#1@0| () T@U)
(declare-fun |_module.CCon.B#canCall| (T@U T@U T@U) Bool)
(declare-fun |_module.CCon.A#canCall| (T@U T@U T@U) Bool)
(declare-fun |_module.CCon.sA#canCall| (T@U T@U) Bool)
...
(declare-fun |t#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.CContravariant)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon3_correct true))
(let ((anon10_Else_correct  (=> (and (not (and ($Is refType |_v5#0@0| Tclass._module.X) ($IsAlloc refType |_v5#0@0| Tclass._module.X |$lambdaHeap#0@0|))) (= (ControlFlow 0 15) 13)) anon3_correct)))
(let ((anon10_Then_correct  (=> (and ($Is refType |_v5#0@0| Tclass._module.X) ($IsAlloc refType |_v5#0@0| Tclass._module.X |$lambdaHeap#0@0|)) (=> (and (and (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (= |lambdaResult#0| (LitInt 0))) (and ($Is intType (int_2_U |lambdaResult#0|) TInt) (= (ControlFlow 0 14) 13))) anon3_correct))))
(let ((anon9_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 16) 14) anon10_Then_correct) (=> (= (ControlFlow 0 16) 15) anon10_Else_correct)))))
(let ((anon7_correct true))
(let ((anon12_Else_correct  (=> (and (not (and ($Is refType |_v6#0@0| Tclass._module.X) ($IsAlloc refType |_v6#0@0| Tclass._module.X |$lambdaHeap#1@0|))) (= (ControlFlow 0 10) 8)) anon7_correct)))
(let ((anon12_Then_correct  (=> (and ($Is refType |_v6#0@0| Tclass._module.X) ($IsAlloc refType |_v6#0@0| Tclass._module.X |$lambdaHeap#1@0|)) (=> (and (and (= |$_Frame#l1@0| (|lambda#0| null |$lambdaHeap#1@0| alloc false)) (= |lambdaResult#1| (LitInt 1))) (and ($Is intType (int_2_U |lambdaResult#1|) TInt) (= (ControlFlow 0 9) 8))) anon7_correct))))
(let ((anon11_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#1@0|) (or (= $Heap |$lambdaHeap#1@0|) ($HeapSucc $Heap |$lambdaHeap#1@0|))) (and (=> (= (ControlFlow 0 11) 9) anon12_Then_correct) (=> (= (ControlFlow 0 11) 10) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (= |s#0@0| (Lit DatatypeTypeType (|#_module.CCon.CCon| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#7| (Handle1 (|lambda#3| ($Box intType (int_2_U (LitInt 1)))) (|lambda#4| Tclass._module.X) (|lambda#6| (SetRef_to_SetBox (|lambda#5| false))))) ($LS $LZ)))))) (=> (and (and (or (not (= call1formal@this null)) (not true)) (and ($Is refType call1formal@this Tclass._module.Int) ($IsAlloc refType call1formal@this Tclass._module.Int $Heap))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (=> (and (and (and (or (not (= call1formal@this@0 null)) (not true)) (and ($Is refType call1formal@this@0 Tclass._module.Int) ($IsAlloc refType call1formal@this@0 Tclass._module.Int $Heap@0))) (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap call1formal@this@0) alloc))))) (and (forall (($o@@12 T@U) ) (!  (=> (and (or (not (= $o@@12 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $o@@12) alloc)))) (= (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $o@@12) (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $o@@12)))
 :qid |Variancedfy.96:15|
 :skolemid |890|
 :pattern ( (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $o@@12))
)) ($HeapSucc $Heap $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 7)) true) (=> (and ($IsBox |call4formal@r#0| call0formal@_module.CCon$T) ($IsAllocBox |call4formal@r#0| call0formal@_module.CCon$T $Heap)) (=> (and (and (= call0formal@_module.CCon$T@0 Tclass._module.X) (= |call2formal@x#0@0| ($Box refType call1formal@this@0))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1))) (=> (and (and (and ($IsBox |call4formal@r#0@0| call0formal@_module.CCon$T@0) ($IsAllocBox |call4formal@r#0@0| call0formal@_module.CCon$T@0 $Heap@1)) (forall (($o@@13 T@U) ) (!  (=> (and (or (not (= $o@@13 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $o@@13) alloc)))) (= (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $o@@13) (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $o@@13)))
 :qid |Variancedfy.90:12|
 :skolemid |879|
 :pattern ( (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $o@@13))
))) (and ($HeapSucc $Heap@0 $Heap@1) (= |$rhs##0@0| ($Unbox refType |call4formal@r#0@0|)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) true) (=> (and (= call0formal@_module.CCon$T@0@@0 Tclass._module.X) (= |call2formal@x#0@0@@0| ($Box refType |$rhs##0@0|))) (=> (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (and (forall (($o@@14 T@U) ) (!  (=> (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $o@@14) alloc)))) (= (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 $o@@14) (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $o@@14)))
 :qid |Variancedfy.89:12|
 :skolemid |876|
 :pattern ( (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 $o@@14))
)) ($HeapSucc $Heap@1 $Heap@2))) (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (=> ($IsAllocBox ($Box DatatypeTypeType |s#0@0|) (Tclass._module.CCon Tclass._module.X) $Heap@2) (=> (and (= |##x#0@0| (_module.CCon.x Tclass._module.X |s#0@0|)) ($IsAlloc intType (int_2_U |##x#0@0|) TInt $Heap@2)) (=> (and (and (and (|_module.CCon.C#canCall| Tclass._module.X |s#0@0| (_module.CCon.x Tclass._module.X |s#0@0|)) (|_module.CCon.C#canCall| Tclass._module.X |s#0@0| (_module.CCon.x Tclass._module.X |s#0@0|))) (and ($IsAllocBox ($Box DatatypeTypeType |s#0@0|) (Tclass._module.CCon Tclass._module.X) $Heap@2) (= |##x#1@0| (_module.CCon.y Tclass._module.X |s#0@0|)))) (and (and ($IsAlloc SeqType |##x#1@0| (TSeq Tclass._module.X) $Heap@2) (|_module.CCon.B#canCall| Tclass._module.X |s#0@0| (_module.CCon.y Tclass._module.X |s#0@0|))) (and (|_module.CCon.B#canCall| Tclass._module.X |s#0@0| (_module.CCon.y Tclass._module.X |s#0@0|)) ($IsAllocBox ($Box DatatypeTypeType |s#0@0|) (Tclass._module.CCon Tclass._module.X) $Heap@2)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (=> ($IsAlloc refType |$rhs##0@0| Tclass._module.X $Heap@2) (=> (and (|_module.CCon.A#canCall| Tclass._module.X |s#0@0| ($Box refType |$rhs##0@0|)) (|_module.CCon.A#canCall| Tclass._module.X |s#0@0| ($Box refType |$rhs##0@0|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> ($IsAlloc refType |$rhs##0@0| Tclass._module.X $Heap@2) (=> (and (and (|_module.CCon.sA#canCall| Tclass._module.X ($Box refType |$rhs##0@0|)) (|_module.CCon.sA#canCall| Tclass._module.X ($Box refType |$rhs##0@0|))) (and ($IsAllocBox ($Box DatatypeTypeType |s#0@0|) (Tclass._module.CCon Tclass._module.X) $Heap@2) (= (ControlFlow 0 2) (- 0 1)))) true))))))))))))))))))))))
(let ((anon9_Else_correct  (=> (= |a#0@0| (Lit DatatypeTypeType (|#_module.CCon.CCon| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#7| (Handle1 (|lambda#3| ($Box intType (int_2_U (LitInt 0)))) (|lambda#4| Tclass._module.X) (|lambda#6| (SetRef_to_SetBox (|lambda#5| false))))) ($LS $LZ)))))) (=> (and ($Is DatatypeTypeType |b#0@0| (Tclass._module.CCon Tclass._module.Int)) ($IsAlloc DatatypeTypeType |b#0@0| (Tclass._module.CCon Tclass._module.Int) $Heap)) (and (=> (= (ControlFlow 0 12) 11) anon11_Then_correct) (=> (= (ControlFlow 0 12) 2) anon11_Else_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 17) 16) anon9_Then_correct) (=> (= (ControlFlow 0 17) 12) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |a#0| (Tclass._module.CCon Tclass._module.X)) ($IsAlloc DatatypeTypeType |a#0| (Tclass._module.CCon Tclass._module.X) $Heap)) true) (and (and ($Is DatatypeTypeType |b#0| (Tclass._module.CCon Tclass._module.Int)) ($IsAlloc DatatypeTypeType |b#0| (Tclass._module.CCon Tclass._module.Int) $Heap)) true)) (=> (and (and (and (and ($Is DatatypeTypeType |s#0| (Tclass._module.CCon Tclass._module.X)) ($IsAlloc DatatypeTypeType |s#0| (Tclass._module.CCon Tclass._module.X) $Heap)) true) (and (=> |defass#i#0| (and ($Is refType |i#0| Tclass._module.Int) ($IsAlloc refType |i#0| Tclass._module.Int $Heap))) true)) (and (and (=> |defass#t#0| (and ($Is refType |t#0| Tclass._module.X) ($IsAlloc refType |t#0| Tclass._module.X $Heap))) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 18) 17)))) anon0_correct)))))
