// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/type-test.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/type-test-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/type-test.dfy
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Main (correctness)"} Impl$$_module.__default.Main() returns ($_reverifyPost: bool)
{
  ...
  var v#0: ref
     where defass#v#0
       ==> $Is(v#0, Tclass._module.T()) && $IsAlloc(v#0, Tclass._module.T(), $Heap);
  var $nw: ref;
    ...
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/type-test.dfy(12,12)
    assume true;
    // ----- init call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/type-test.dfy(12,15)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id0"} $nw := Call$$_module.A.__ctor();
    // TrCallStmt: After ProcessCallStmt
    v#0 := $nw;
    defass#v#0 := true;
    // ----- expect statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/type-test.dfy(13,3)
    assert {:id "id2"} defass#v#0;
    assume true;
    if ($Is(v#0, Tclass._module.B()))
    {
        assume true;
        assume false;
    }

    // ----- expect statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/type-test.dfy(14,3)
    assert {:id "id3"} defass#v#0;
    assume true;
    if (!$Is(v#0, Tclass._module.A()))
    {
        assume true;
        assume false;
    }
...
axiom Tag(Tclass._module.A?()) == Tagclass._module.A?
   && TagFamily(Tclass._module.A?()) == tytagFamily$A;
axiom implements$_module.T(Tclass._module.A?());
}
...
procedure {:verboseName "A._ctor (correctness)"} Impl$$_module.A.__ctor() returns (this: ref, $_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
axiom Tag(Tclass._module.B?()) == Tagclass._module.B?
   && TagFamily(Tclass._module.B?()) == tytagFamily$B;
axiom implements$_module.T(Tclass._module.B?());
}
...
// type axiom for trait parent: A? extends T?
axiom (forall $o: ref :: 
  { $Is($o, Tclass._module.A?()) } 
  $Is($o, Tclass._module.A?()) ==> $Is($o, Tclass._module.T?()));

axiom (forall bx: Box :: 
  { $IsBox(bx, Tclass._module.A?()) } 
  $IsBox(bx, Tclass._module.A?()) ==> $IsBox(bx, Tclass._module.T?()));

// allocation axiom for trait parent: A? extends T?
...
// type axiom for trait parent: B? extends T?
axiom (forall $o: ref :: 
  { $Is($o, Tclass._module.B?()) } 
  $Is($o, Tclass._module.B?()) ==> $Is($o, Tclass._module.T?()));

axiom (forall bx: Box :: 
  { $IsBox(bx, Tclass._module.B?()) } 
  $IsBox(bx, Tclass._module.B?()) ==> $IsBox(bx, Tclass._module.T?()));

// allocation axiom for trait parent: B? extends T?
axiom (forall $o: ref, $heap: Heap :: 
