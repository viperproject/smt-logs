...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0| Int) ) (!  (=> (or (|EnumerationRegression.__default.Digit#canCall| |x#0|) (and (< 0 $FunctionContextHeight) (and (<= (LitInt 137438953472) |x#0|) (< |x#0| 137438953482)))) ($Is charType (EnumerationRegression.__default.Digit |x#0|) TChar))
