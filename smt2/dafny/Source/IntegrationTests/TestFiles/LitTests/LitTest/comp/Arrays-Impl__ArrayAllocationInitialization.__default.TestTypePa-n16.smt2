...
(set-info :boogie-vc-id Impl$$ArrayAllocationInitialization.__default.TestTypeParameter)
...
(assert (not
 ...
 :qid |Arraysdfy.711:10|
 :skolemid |4499|
))) (=> (and (and (forall ((|arrayinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0@@0|) (< |arrayinit#0#i0#0@@0| |$rhs#0@0|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@6) (IndexField |arrayinit#0#i0#0@@0|)) (Apply1 Tclass._System.nat ArrayAllocationInitialization._default.TestTypeParameter$T $Heap@5 |initF#0| ($Box intType (int_2_U |arrayinit#0#i0#0@@0|)))))
 :qid |Arraysdfy.711:10|
 :skolemid |4500|
 ...
 :qid |Arraysdfy.713:10|
 :skolemid |4501|
))) (=> (forall ((|arrayinit#1#i0#0@@0| Int) ) (!  (=> (and (<= 0 |arrayinit#1#i0#0@@0|) (< |arrayinit#1#i0#0@@0| |$rhs#1@0|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $nw@7) (IndexField |arrayinit#1#i0#0@@0|)) (Apply1 Tclass._System.nat ArrayAllocationInitialization._default.TestTypeParameter$T $Heap@6 |initF#0| ($Box intType (int_2_U |arrayinit#1#i0#0@@0|)))))
 :qid |Arraysdfy.713:10|
 :skolemid |4502|
