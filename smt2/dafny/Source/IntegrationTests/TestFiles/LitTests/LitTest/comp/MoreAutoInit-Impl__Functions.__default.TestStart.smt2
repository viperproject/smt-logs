...
(declare-fun Tagclass.Functions.Uni () T@U)
(declare-fun |##Functions.Uni.Uni| () T@U)
...
(declare-fun Tclass.Functions.Uni () T@U)
...
(assert (distinct TInt TagInt TagSet TagSeq alloc Tagclass.Functions.Uni |##Functions.Uni.Uni| tytagFamily$Uni)
)
...
(assert (= (DatatypeCtorId |#Functions.Uni.Uni|) |##Functions.Uni.Uni|))
(assert (= (Ctor DatatypeTypeType) 3))
(assert ($Is DatatypeTypeType |#Functions.Uni.Uni| Tclass.Functions.Uni))
...
(assert (forall ((bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 Tclass.Functions.Uni) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@1)) bx@@1) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@1) Tclass.Functions.Uni)))
 :qid |unknown.0:0|
 :skolemid |1493|
 :pattern ( ($IsBox bx@@1 Tclass.Functions.Uni))
)))
...
(assert (= (Tag Tclass.Functions.Uni) Tagclass.Functions.Uni))
(assert (= (TagFamily Tclass.Functions.Uni) tytagFamily$Uni))
(assert (= |#Functions.Uni.Uni| (Lit DatatypeTypeType |#Functions.Uni.Uni|)))
...
(set-info :boogie-vc-id Impl$$Functions.__default.TestStart)
