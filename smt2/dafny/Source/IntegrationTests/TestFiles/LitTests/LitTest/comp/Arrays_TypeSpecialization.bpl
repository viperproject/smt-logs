...
procedure {:verboseName "TypeSpecialization.Test (correctness)"} Impl$$TypeSpecialization.__default.Test() returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TypeSpecialization.Test (correctness)"} Impl$$TypeSpecialization.__default.Test() returns ($_reverifyPost: bool)
{
  ...
  var t##0: int;
  var b#0: ref
     where $Is(b#0, Tclass._System.array(Tclass.TypeSpecialization.byte()))
       && $IsAlloc(b#0, Tclass._System.array(Tclass.TypeSpecialization.byte()), $Heap);
  var a##1: ref;
  var b##1: ref;
  var t##1: int;
  ...
  var t##2: char;
    ...
    // AddMethodImpl: Test, Impl$$TypeSpecialization.__default.Test
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(830,11)
    assume true;
    assert {:id "id898"} 0 <= LitInt(100);
    havoc $nw;
    ...
    a#0 := $nw;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(831,8)
    ...
    // ProcessCallStmt: CheckSubrange
    t##0 := LitInt(50);
    assert {:id "id900"} (forall $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool && ($o == a##0 || $o == b##0)
         ==> $_ModifiesFrame[$o, $f]);
    call {:id "id901"} Call$$TypeSpecialization.__default.Int(TInt, a##0, b##0, $Box(t##0));
    // TrCallStmt: After ProcessCallStmt
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(832,5)
    assert {:id "id902"} a#0 != null;
    assert {:id "id903"} {:subsumption 0} 0 <= LitInt(19) && LitInt(19) < _System.array.Length(a#0);
    assume true;
    assume true;
    assert {:id "id904"} a#0 != null;
    assert {:id "id905"} {:subsumption 0} 0 <= LitInt(20) && LitInt(20) < _System.array.Length(a#0);
    assume true;
    assume true;
    assert {:id "id906"} a#0 != null;
    assert {:id "id907"} {:subsumption 0} 0 <= LitInt(21) && LitInt(21) < _System.array.Length(a#0);
    assume true;
    assume true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(834,11)
    assume true;
    assert {:id "id908"} 0 <= LitInt(100);
    havoc $nw;
    assume $nw != null && $Is($nw, Tclass._System.array?(Tclass.TypeSpecialization.byte()));
    assume !$Unbox(read($Heap, $nw, alloc)): bool;
    assume _System.array.Length($nw) == LitInt(100);
    $Heap := update($Heap, $nw, alloc, $Box(true));
    assume $IsGoodHeap($Heap);
    assume $IsHeapAnchor($Heap);
    b#0 := $nw;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(835,9)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    a##1 := b#0;
    ...
    assert {:id "id910"} LitInt(0) <= newtype$check#0 && newtype$check#0 < 256;
    assume true;
    // ProcessCallStmt: CheckSubrange
    t##1 := LitInt(50);
    assert {:id "id911"} (forall $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool && ($o == a##1 || $o == b##1)
         ==> $_ModifiesFrame[$o, $f]);
    call {:id "id912"} Call$$TypeSpecialization.__default.Byte(Tclass.TypeSpecialization.byte(), a##1, b##1, $Box(t##1));
    // TrCallStmt: After ProcessCallStmt
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(836,5)
    assert {:id "id913"} b#0 != null;
    assert {:id "id914"} {:subsumption 0} 0 <= LitInt(19) && LitInt(19) < _System.array.Length(b#0);
    assume true;
    assume true;
    assert {:id "id915"} b#0 != null;
    assert {:id "id916"} {:subsumption 0} 0 <= LitInt(20) && LitInt(20) < _System.array.Length(b#0);
    assume true;
    assume true;
    assert {:id "id917"} b#0 != null;
    assert {:id "id918"} {:subsumption 0} 0 <= LitInt(21) && LitInt(21) < _System.array.Length(b#0);
    assume true;
    assume true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(838,11)
    assume true;
    assert {:id "id919"} 0 <= LitInt(100);
    havoc $nw;
    ...
    assume $IsHeapAnchor($Heap);
    c#0 := $nw;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(839,9)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    a##2 := c#0;
    ...
    assume true;
    // ProcessCallStmt: CheckSubrange
    t##2 := Lit(char#FromInt(110));
    assert {:id "id921"} (forall $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool && ($o == a##2 || $o == b##2)
         ==> $_ModifiesFrame[$o, $f]);
    call {:id "id922"} Call$$TypeSpecialization.__default.Char(TChar, a##2, b##2, $Box(t##2));
    // TrCallStmt: After ProcessCallStmt
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(840,5)
    assert {:id "id923"} c#0 != null;
    assert {:id "id924"} {:subsumption 0} 0 <= LitInt(19) && LitInt(19) < _System.array.Length(c#0);
    assume true;
    assume true;
    assert {:id "id925"} c#0 != null;
    assert {:id "id926"} {:subsumption 0} 0 <= LitInt(20) && LitInt(20) < _System.array.Length(c#0);
    assume true;
    assume true;
    assert {:id "id927"} c#0 != null;
    assert {:id "id928"} {:subsumption 0} 0 <= LitInt(21) && LitInt(21) < _System.array.Length(c#0);
    assume true;
    assume true;
}
...
procedure {:verboseName "TypeSpecialization.Int (well-formedness)"} CheckWellFormed$$TypeSpecialization.__default.Int(TypeSpecialization._default.Int$T: Ty, 
    a#0: ref
       where $Is(a#0, Tclass._System.array(TypeSpecialization._default.Int$T))
         && $IsAlloc(a#0, Tclass._System.array(TypeSpecialization._default.Int$T), $Heap), 
    b#0: ref
       where $Is(b#0, Tclass._System.array(TInt))
         && $IsAlloc(b#0, Tclass._System.array(TInt), $Heap), 
    t#0: Box
       where $IsBox(t#0, TypeSpecialization._default.Int$T)
         && $IsAllocBox(t#0, TypeSpecialization._default.Int$T, $Heap));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TypeSpecialization.Int (well-formedness)"} CheckWellFormed$$TypeSpecialization.__default.Int(TypeSpecialization._default.Int$T: Ty, a#0: ref, b#0: ref, t#0: Box)
{
  var $_ModifiesFrame: [ref,Field]bool;


    // AddMethodImpl: Int, CheckWellFormed$$TypeSpecialization.__default.Int
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> $o == a#0 || $o == b#0);
    assert {:id "id929"} a#0 != null;
    assert {:id "id930"} b#0 != null;
    if (_System.array.Length(a#0) == _System.array.Length(b#0))
    {
        assert {:id "id931"} b#0 != null;
    }

    assume {:id "id932"} _System.array.Length(a#0) == _System.array.Length(b#0)
       && _System.array.Length(b#0) == LitInt(100);
    havoc $Heap;
    assume (forall $o: ref :: 
      { $Heap[$o] } 
      $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
...
procedure {:verboseName "TypeSpecialization.Int (call)"} Call$$TypeSpecialization.__default.Int(TypeSpecialization._default.Int$T: Ty, 
    a#0: ref
       where $Is(a#0, Tclass._System.array(TypeSpecialization._default.Int$T))
         && $IsAlloc(a#0, Tclass._System.array(TypeSpecialization._default.Int$T), $Heap), 
    b#0: ref
  ...
  requires {:id "id933"} _System.array.Length(a#0) == _System.array.Length(b#0);
  requires {:id "id934"} _System.array.Length(b#0) == LitInt(100);
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "TypeSpecialization.Int (correctness)"} Impl$$TypeSpecialization.__default.Int(TypeSpecialization._default.Int$T: Ty, 
    a#0: ref
       where $Is(a#0, Tclass._System.array(TypeSpecialization._default.Int$T))
         && $IsAlloc(a#0, Tclass._System.array(TypeSpecialization._default.Int$T), $Heap), 
    b#0: ref
  ...
  free requires 0 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id935"} _System.array.Length(a#0) == _System.array.Length(b#0);
  requires {:id "id936"} _System.array.Length(b#0) == LitInt(100);
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TypeSpecialization.Int (correctness)"} Impl$$TypeSpecialization.__default.Int(TypeSpecialization._default.Int$T: Ty, a#0: ref, b#0: ref, t#0: Box)
   returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var $rhs#0: Box;
  ...
  var $rhs#3: Box;
    ...
    // AddMethodImpl: Int, Impl$$TypeSpecialization.__default.Int
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> $o == a#0 || $o == b#0);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(847,11)
    assert {:id "id937"} a#0 != null;
    assert {:id "id938"} 0 <= LitInt(20) && LitInt(20) < _System.array.Length(a#0);
    assume true;
    assert {:id "id939"} $_ModifiesFrame[a#0, IndexField(LitInt(20))];
    assume true;
    $rhs#0 := t#0;
    $Heap := update($Heap, a#0, IndexField(LitInt(20)), $rhs#0);
    assume $IsGoodHeap($Heap);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(848,11)
    assert {:id "id942"} b#0 != null;
    assert {:id "id943"} 0 <= LitInt(20) && LitInt(20) < _System.array.Length(b#0);
    assume true;
    assert {:id "id944"} $_ModifiesFrame[b#0, IndexField(LitInt(20))];
    assume true;
    $rhs#1 := LitInt(69);
    $Heap := update($Heap, b#0, IndexField(LitInt(20)), $Box($rhs#1));
    assume $IsGoodHeap($Heap);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(849,11)
    assert {:id "id947"} b#0 != null;
    assert {:id "id948"} 0 <= LitInt(21) && LitInt(21) < _System.array.Length(b#0);
    assume true;
    assert {:id "id949"} $_ModifiesFrame[b#0, IndexField(LitInt(21))];
    assume true;
    $rhs#2 := LitInt(69);
    $Heap := update($Heap, b#0, IndexField(LitInt(21)), $Box($rhs#2));
    assume $IsGoodHeap($Heap);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(850,11)
    assert {:id "id952"} a#0 != null;
    assert {:id "id953"} 0 <= LitInt(21) && LitInt(21) < _System.array.Length(a#0);
    assume true;
    assert {:id "id954"} $_ModifiesFrame[a#0, IndexField(LitInt(21))];
    assume true;
    $rhs#3 := t#0;
    $Heap := update($Heap, a#0, IndexField(LitInt(21)), $rhs#3);
    assume $IsGoodHeap($Heap);
}



procedure {:verboseName "TypeSpecialization.Byte (well-formedness)"} CheckWellFormed$$TypeSpecialization.__default.Byte(TypeSpecialization._default.Byte$T: Ty, 
    a#0: ref
       where $Is(a#0, Tclass._System.array(TypeSpecialization._default.Byte$T))
         && $IsAlloc(a#0, Tclass._System.array(TypeSpecialization._default.Byte$T), $Heap), 
    b#0: ref
       where $Is(b#0, Tclass._System.array(Tclass.TypeSpecialization.byte()))
         && $IsAlloc(b#0, Tclass._System.array(Tclass.TypeSpecialization.byte()), $Heap), 
    t#0: Box
       where $IsBox(t#0, TypeSpecialization._default.Byte$T)
         && $IsAllocBox(t#0, TypeSpecialization._default.Byte$T, $Heap));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TypeSpecialization.Byte (well-formedness)"} CheckWellFormed$$TypeSpecialization.__default.Byte(TypeSpecialization._default.Byte$T: Ty, a#0: ref, b#0: ref, t#0: Box)
{
  var $_ModifiesFrame: [ref,Field]bool;


    // AddMethodImpl: Byte, CheckWellFormed$$TypeSpecialization.__default.Byte
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> $o == a#0 || $o == b#0);
    assert {:id "id957"} a#0 != null;
    assert {:id "id958"} b#0 != null;
    if (_System.array.Length(a#0) == _System.array.Length(b#0))
    {
        assert {:id "id959"} b#0 != null;
    }

    assume {:id "id960"} _System.array.Length(a#0) == _System.array.Length(b#0)
       && _System.array.Length(b#0) == LitInt(100);
    havoc $Heap;
    assume (forall $o: ref :: 
      { $Heap[$o] } 
...
procedure {:verboseName "TypeSpecialization.Byte (call)"} Call$$TypeSpecialization.__default.Byte(TypeSpecialization._default.Byte$T: Ty, 
    a#0: ref
       where $Is(a#0, Tclass._System.array(TypeSpecialization._default.Byte$T))
         && $IsAlloc(a#0, Tclass._System.array(TypeSpecialization._default.Byte$T), $Heap), 
    b#0: ref
    ...
    t#0: Box
       where $IsBox(t#0, TypeSpecialization._default.Byte$T)
         && $IsAllocBox(t#0, TypeSpecialization._default.Byte$T, $Heap));
  // user-defined preconditions
  requires {:id "id961"} _System.array.Length(a#0) == _System.array.Length(b#0);
  requires {:id "id962"} _System.array.Length(b#0) == LitInt(100);
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "TypeSpecialization.Byte (correctness)"} Impl$$TypeSpecialization.__default.Byte(TypeSpecialization._default.Byte$T: Ty, 
    a#0: ref
       where $Is(a#0, Tclass._System.array(TypeSpecialization._default.Byte$T))
         && $IsAlloc(a#0, Tclass._System.array(TypeSpecialization._default.Byte$T), $Heap), 
    b#0: ref
  ...
  free requires 1 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id963"} _System.array.Length(a#0) == _System.array.Length(b#0);
  requires {:id "id964"} _System.array.Length(b#0) == LitInt(100);
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TypeSpecialization.Byte (correctness)"} Impl$$TypeSpecialization.__default.Byte(TypeSpecialization._default.Byte$T: Ty, a#0: ref, b#0: ref, t#0: Box)
   returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var $rhs#0: Box;
  ...
  var $rhs#3: Box;
    ...
    // AddMethodImpl: Byte, Impl$$TypeSpecialization.__default.Byte
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> $o == a#0 || $o == b#0);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(857,11)
    assert {:id "id965"} a#0 != null;
    assert {:id "id966"} 0 <= LitInt(20) && LitInt(20) < _System.array.Length(a#0);
    assume true;
    assert {:id "id967"} $_ModifiesFrame[a#0, IndexField(LitInt(20))];
    assume true;
    $rhs#0 := t#0;
    $Heap := update($Heap, a#0, IndexField(LitInt(20)), $rhs#0);
    assume $IsGoodHeap($Heap);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(858,11)
    assert {:id "id970"} b#0 != null;
    assert {:id "id971"} 0 <= LitInt(20) && LitInt(20) < _System.array.Length(b#0);
    assume true;
    assert {:id "id972"} $_ModifiesFrame[b#0, IndexField(LitInt(20))];
    newtype$check#0 := LitInt(69);
    assert {:id "id973"} LitInt(0) <= newtype$check#0 && newtype$check#0 < 256;
    assume true;
    $rhs#1 := LitInt(69);
    $Heap := update($Heap, b#0, IndexField(LitInt(20)), $Box($rhs#1));
    assume $IsGoodHeap($Heap);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(859,11)
    assert {:id "id976"} b#0 != null;
    assert {:id "id977"} 0 <= LitInt(21) && LitInt(21) < _System.array.Length(b#0);
    assume true;
    assert {:id "id978"} $_ModifiesFrame[b#0, IndexField(LitInt(21))];
    newtype$check#1 := LitInt(69);
    assert {:id "id979"} LitInt(0) <= newtype$check#1 && newtype$check#1 < 256;
    assume true;
    $rhs#2 := LitInt(69);
    $Heap := update($Heap, b#0, IndexField(LitInt(21)), $Box($rhs#2));
    assume $IsGoodHeap($Heap);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(860,11)
    assert {:id "id982"} a#0 != null;
    assert {:id "id983"} 0 <= LitInt(21) && LitInt(21) < _System.array.Length(a#0);
    assume true;
    assert {:id "id984"} $_ModifiesFrame[a#0, IndexField(LitInt(21))];
    assume true;
    $rhs#3 := t#0;
    $Heap := update($Heap, a#0, IndexField(LitInt(21)), $rhs#3);
    assume $IsGoodHeap($Heap);
...
procedure {:verboseName "TypeSpecialization.Char (well-formedness)"} CheckWellFormed$$TypeSpecialization.__default.Char(TypeSpecialization._default.Char$T: Ty, 
    a#0: ref
       where $Is(a#0, Tclass._System.array(TypeSpecialization._default.Char$T))
         && $IsAlloc(a#0, Tclass._System.array(TypeSpecialization._default.Char$T), $Heap), 
    b#0: ref
       where $Is(b#0, Tclass._System.array(TChar))
         && $IsAlloc(b#0, Tclass._System.array(TChar), $Heap), 
    t#0: Box
       where $IsBox(t#0, TypeSpecialization._default.Char$T)
         && $IsAllocBox(t#0, TypeSpecialization._default.Char$T, $Heap));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TypeSpecialization.Char (well-formedness)"} CheckWellFormed$$TypeSpecialization.__default.Char(TypeSpecialization._default.Char$T: Ty, a#0: ref, b#0: ref, t#0: Box)
{
  var $_ModifiesFrame: [ref,Field]bool;


    // AddMethodImpl: Char, CheckWellFormed$$TypeSpecialization.__default.Char
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> $o == a#0 || $o == b#0);
    assert {:id "id987"} a#0 != null;
    assert {:id "id988"} b#0 != null;
    if (_System.array.Length(a#0) == _System.array.Length(b#0))
    {
        assert {:id "id989"} b#0 != null;
    }

    assume {:id "id990"} _System.array.Length(a#0) == _System.array.Length(b#0)
       && _System.array.Length(b#0) == LitInt(100);
    havoc $Heap;
    assume (forall $o: ref :: 
      { $Heap[$o] } 
...
procedure {:verboseName "TypeSpecialization.Char (call)"} Call$$TypeSpecialization.__default.Char(TypeSpecialization._default.Char$T: Ty, 
    a#0: ref
       where $Is(a#0, Tclass._System.array(TypeSpecialization._default.Char$T))
         && $IsAlloc(a#0, Tclass._System.array(TypeSpecialization._default.Char$T), $Heap), 
    b#0: ref
    ...
    t#0: Box
       where $IsBox(t#0, TypeSpecialization._default.Char$T)
         && $IsAllocBox(t#0, TypeSpecialization._default.Char$T, $Heap));
  // user-defined preconditions
  requires {:id "id991"} _System.array.Length(a#0) == _System.array.Length(b#0);
  requires {:id "id992"} _System.array.Length(b#0) == LitInt(100);
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "TypeSpecialization.Char (correctness)"} Impl$$TypeSpecialization.__default.Char(TypeSpecialization._default.Char$T: Ty, 
    a#0: ref
       where $Is(a#0, Tclass._System.array(TypeSpecialization._default.Char$T))
         && $IsAlloc(a#0, Tclass._System.array(TypeSpecialization._default.Char$T), $Heap), 
    b#0: ref
  ...
  free requires 0 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id993"} _System.array.Length(a#0) == _System.array.Length(b#0);
  requires {:id "id994"} _System.array.Length(b#0) == LitInt(100);
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TypeSpecialization.Char (correctness)"} Impl$$TypeSpecialization.__default.Char(TypeSpecialization._default.Char$T: Ty, a#0: ref, b#0: ref, t#0: Box)
   returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var $rhs#0: Box;
  ...
  var $rhs#3: Box;
    ...
    // AddMethodImpl: Char, Impl$$TypeSpecialization.__default.Char
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> $o == a#0 || $o == b#0);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(867,11)
    assert {:id "id995"} a#0 != null;
    assert {:id "id996"} 0 <= LitInt(20) && LitInt(20) < _System.array.Length(a#0);
    assume true;
    assert {:id "id997"} $_ModifiesFrame[a#0, IndexField(LitInt(20))];
    assume true;
    $rhs#0 := t#0;
    $Heap := update($Heap, a#0, IndexField(LitInt(20)), $rhs#0);
    assume $IsGoodHeap($Heap);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(868,11)
    assert {:id "id1000"} b#0 != null;
    assert {:id "id1001"} 0 <= LitInt(20) && LitInt(20) < _System.array.Length(b#0);
    assume true;
    assert {:id "id1002"} $_ModifiesFrame[b#0, IndexField(LitInt(20))];
    assume true;
    $rhs#1 := Lit(char#FromInt(107));
    $Heap := update($Heap, b#0, IndexField(LitInt(20)), $Box($rhs#1));
    assume $IsGoodHeap($Heap);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(869,11)
    assert {:id "id1005"} b#0 != null;
    assert {:id "id1006"} 0 <= LitInt(21) && LitInt(21) < _System.array.Length(b#0);
    assume true;
    assert {:id "id1007"} $_ModifiesFrame[b#0, IndexField(LitInt(21))];
    assume true;
    $rhs#2 := Lit(char#FromInt(107));
    $Heap := update($Heap, b#0, IndexField(LitInt(21)), $Box($rhs#2));
    assume $IsGoodHeap($Heap);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(870,11)
    assert {:id "id1010"} a#0 != null;
    assert {:id "id1011"} 0 <= LitInt(21) && LitInt(21) < _System.array.Length(a#0);
    assume true;
    assert {:id "id1012"} $_ModifiesFrame[a#0, IndexField(LitInt(21))];
    assume true;
    $rhs#3 := t#0;
    $Heap := update($Heap, a#0, IndexField(LitInt(21)), $rhs#3);
    assume $IsGoodHeap($Heap);
...
procedure {:verboseName "TypeSpecialization.byte (well-formedness)"} CheckWellFormed$$TypeSpecialization.byte(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TypeSpecialization.byte (well-formedness)"} CheckWellFormed$$TypeSpecialization.byte(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assume {:id "id1015"} LitInt(0) <= x#0 && x#0 < 256;
        assume false;
    }
    ...
    if (*)
    {
        ...
        assume true;
        assert {:id "id1016"} {:subsumption 0} LitInt(0) <= LitInt(0);
        assert {:id "id1017"} {:subsumption 0} Lit(0 < 256);
        assume false;
    }
}
