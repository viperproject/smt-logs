...
(declare-fun |_module.__default.IncrementChar#requires| (T@U) Bool)
(declare-fun |lambda#27| (T@U Int) T@U)
...
(assert (distinct TChar TagChar TagSet alloc Tagclass._System.object? Tagclass._System.object Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 tytagFamily$object |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1|)
)
...
(assert (forall (($heap@@0 T@U) (|$fh$0x#0@@0| T@U) ) (! (= (Requires1 TChar TChar $heap@@0 |_module.__default.IncrementChar#Handle| |$fh$0x#0@@0|) (|_module.__default.IncrementChar#requires| ($Unbox charType |$fh$0x#0@@0|)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |582|
 :pattern ( (Requires1 TChar TChar $heap@@0 |_module.__default.IncrementChar#Handle| |$fh$0x#0@@0|))
)))
(assert (forall ((|l#0| T@U) (|l#1| Int) (|$l#0#heap#0| T@U) (|$l#0#c#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#27| |l#0| |l#1|) |$l#0#heap#0| |$l#0#c#0|))  (and ($IsBox |$l#0#c#0| |l#0|) (<= (|char#ToInt| ($Unbox charType |$l#0#c#0|)) |l#1|)))
 :qid |DafnyPreludebpl.24:1|
 :skolemid |658|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#27| |l#0| |l#1|) |$l#0#heap#0| |$l#0#c#0|))
)))
...
(assert (forall (($bx T@U) ($heap@@1 T@U) (|$fh$0x#0@@1| T@U) ) (! (= (|Set#IsMember| (Reads1 TChar TChar $heap@@1 |_module.__default.IncrementChar#Handle| |$fh$0x#0@@1|) $bx) false)
 :qid |unknown.0:0|
 :skolemid |583|
 :pattern ( (|Set#IsMember| (Reads1 TChar TChar $heap@@1 |_module.__default.IncrementChar#Handle| |$fh$0x#0@@1|) $bx))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|c#0@@1| T@U) ) (!  (=> (or (|_module.__default.IncrementChar#canCall| |c#0@@1|) (and (< 0 $FunctionContextHeight) (and ($Is charType |c#0@@1| TChar) (<= (|char#ToInt| |c#0@@1|) (|char#ToInt| (Lit charType (|char#FromInt| 90))))))) (= (_module.__default.IncrementChar |c#0@@1|) (|char#Plus| |c#0@@1| (|char#FromInt| (LitInt 1)))))
 :qid |UnicodeStringsdfy.256:24|
 :skolemid |587|
 :pattern ( (_module.__default.IncrementChar |c#0@@1|))
))))
(assert (forall (($heap@@2 T@U) (|$fh$0x#0@@2| T@U) ) (! (= (Apply1 TChar TChar $heap@@2 |_module.__default.IncrementChar#Handle| |$fh$0x#0@@2|) ($Box charType (_module.__default.IncrementChar ($Unbox charType |$fh$0x#0@@2|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |581|
 :pattern ( (Apply1 TChar TChar $heap@@2 |_module.__default.IncrementChar#Handle| |$fh$0x#0@@2|))
)))
...
(assert (forall ((|c#0@@2| T@U) ) (!  (=> ($Is charType |c#0@@2| TChar) (= (|_module.__default.IncrementChar#requires| |c#0@@2|) (<= (|char#ToInt| |c#0@@2|) (|char#ToInt| (Lit charType (|char#FromInt| 90))))))
 :qid |UnicodeStringsdfy.256:24|
 :skolemid |586|
 :pattern ( (|_module.__default.IncrementChar#requires| |c#0@@2|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|c#0@@3| T@U) ) (!  (=> (or (|_module.__default.IncrementChar#canCall| |c#0@@3|) (and (< 0 $FunctionContextHeight) (and ($Is charType |c#0@@3| TChar) (<= (|char#ToInt| |c#0@@3|) (|char#ToInt| (Lit charType (|char#FromInt| 90))))))) ($Is charType (_module.__default.IncrementChar |c#0@@3|) TChar))
 :qid |UnicodeStringsdfy.256:24|
 :skolemid |585|
 :pattern ( (_module.__default.IncrementChar |c#0@@3|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|c#0@@4| T@U) ) (!  (=> (or (|_module.__default.IncrementChar#canCall| (Lit charType |c#0@@4|)) (and (< 0 $FunctionContextHeight) (and ($Is charType |c#0@@4| TChar) (<= (|char#ToInt| (Lit charType |c#0@@4|)) (|char#ToInt| (Lit charType (|char#FromInt| 90))))))) (= (_module.__default.IncrementChar (Lit charType |c#0@@4|)) (|char#Plus| |c#0@@4| (|char#FromInt| (LitInt 1)))))
 :qid |UnicodeStringsdfy.256:24|
 :weight 3
 :skolemid |588|
 :pattern ( (_module.__default.IncrementChar (Lit charType |c#0@@4|)))
))))
...
(assert (forall ((|l#0@@2| T@U) (|l#1@@0| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@1 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#5| |l#0@@2| |l#1@@0| |l#2| |l#3|) $o@@1 $f))  (=> (and (or (not (= $o@@1 |l#0@@2|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@0| $o@@1) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |654|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#5| |l#0@@2| |l#1@@0| |l#2| |l#3|) $o@@1 $f))
)))
...
(assert (forall ((|l#0@@3| T@U) (|$l#0#heap#0@@0| T@U) (|$l#0#c#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#26| |l#0@@3|) |$l#0#heap#0@@0| |$l#0#c#0@@0|) ($Box charType (|char#Plus| ($Unbox charType |$l#0#c#0@@0|) |l#0@@3|)))
 :qid |UnicodeStringsdfy.247:54|
 :skolemid |657|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#26| |l#0@@3|) |$l#0#heap#0@@0| |$l#0#c#0@@0|))
)))
...
(assert (forall ((h@@10 T@U) (v@@4 T@U) ) (! ($IsAlloc charType v@@4 TChar h@@10)
 :qid |DafnyPreludebpl.292:14|
 :skolemid |64|
 :pattern ( ($IsAlloc charType v@@4 TChar h@@10))
)))
(assert (forall ((|l#0@@4| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#i#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#3| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#i#0|) |l#0@@4|)
 :qid |UnicodeStringsdfy.48:31|
 :skolemid |652|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#3| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#i#0|))
)))
...
(declare-fun |lambda#0@0| () T@U)
(declare-fun $LZ () T@U)
(declare-fun |fromLambda#0@0| () T@U)
(declare-fun |funcRef#0@0| () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |lambda#0| () T@U)
(declare-fun |fromLambda#0| () T@U)
(declare-fun |funcRef#0| () T@U)
(declare-fun |fromFuncRef#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.CharsAndArrows)
...
(let ((anon8_Else_correct  (=> (and (< (|char#ToInt| (Lit charType (|char#FromInt| 90))) (|char#ToInt| |c#0@0|)) (= (ControlFlow 0 10) 5)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (<= (|char#ToInt| |c#0@0|) (|char#ToInt| (Lit charType (|char#FromInt| 90)))) (= |newtype$check#0@0| (LitInt 1))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (or (and (<= 0 |newtype$check#0@0|) (< |newtype$check#0@0| 55296)) (and (<= 57344 |newtype$check#0@0|) (< |newtype$check#0@0| 1114112)))) (=> (or (and (<= 0 |newtype$check#0@0|) (< |newtype$check#0@0| 55296)) (and (<= 57344 |newtype$check#0@0|) (< |newtype$check#0@0| 1114112))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (and (<= 0 (+ (|char#ToInt| |c#0@0|) (|char#ToInt| (|char#FromInt| (LitInt 1))))) (< (+ (|char#ToInt| |c#0@0|) (|char#ToInt| (|char#FromInt| (LitInt 1)))) 55296)) (and (<= 57344 (+ (|char#ToInt| |c#0@0|) (|char#ToInt| (|char#FromInt| (LitInt 1))))) (< (+ (|char#ToInt| |c#0@0|) (|char#ToInt| (|char#FromInt| (LitInt 1)))) 1114112)))) (=> (or (and (<= 0 (+ (|char#ToInt| |c#0@0|) (|char#ToInt| (|char#FromInt| (LitInt 1))))) (< (+ (|char#ToInt| |c#0@0|) (|char#ToInt| (|char#FromInt| (LitInt 1)))) 55296)) (and (<= 57344 (+ (|char#ToInt| |c#0@0|) (|char#ToInt| (|char#FromInt| (LitInt 1))))) (< (+ (|char#ToInt| |c#0@0|) (|char#ToInt| (|char#FromInt| (LitInt 1)))) 1114112))) (=> (= |lambdaResult#0| (|char#Plus| |c#0@0| (|char#FromInt| (LitInt 1)))) (=> (and ($Is charType |lambdaResult#0| TChar) (= (ControlFlow 0 7) 5)) anon4_correct)))))))))
(let ((anon7_Then_correct  (=> (and ($Is charType |c#0@0| TChar) (= |$_Frame#l0@0| (|lambda#5| null |$lambdaHeap#0@0| alloc false))) (and (=> (= (ControlFlow 0 11) 7) anon8_Then_correct) (=> (= (ControlFlow 0 11) 10) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (not ($Is charType |c#0@0| TChar)) (= (ControlFlow 0 6) 5)) anon4_correct)))
(let ((anon6_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 12) 11) anon7_Then_correct) (=> (= (ControlFlow 0 12) 6) anon7_Else_correct)))))
(let ((anon6_Else_correct  (=> (= |lambda#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#26| (|char#FromInt| (LitInt 1))) (|lambda#27| TChar (|char#ToInt| (Lit charType (|char#FromInt| 90)))) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (Requires1 TChar TChar $Heap |lambda#0@0| ($Box charType (Lit charType (|char#FromInt| 67))))) (=> (Requires1 TChar TChar $Heap |lambda#0@0| ($Box charType (Lit charType (|char#FromInt| 67)))) (=> (= |fromLambda#0@0| ($Unbox charType (Apply1 TChar TChar $Heap |lambda#0@0| ($Box charType (Lit charType (|char#FromInt| 67)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> (and (= |funcRef#0@0| |_module.__default.IncrementChar#Handle|) (= (ControlFlow 0 2) (- 0 1))) (Requires1 TChar TChar $Heap |funcRef#0@0| ($Box charType (Lit charType (|char#FromInt| 67)))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#5| null $Heap alloc false)) (and (=> (= (ControlFlow 0 13) 12) anon6_Then_correct) (=> (= (ControlFlow 0 13) 2) anon6_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is HandleTypeType |lambda#0| (Tclass._System.___hPartialFunc1 TChar TChar)) ($IsAlloc HandleTypeType |lambda#0| (Tclass._System.___hPartialFunc1 TChar TChar) $Heap)) true) (and ($Is charType |fromLambda#0| TChar) true)) (and (and (and ($Is HandleTypeType |funcRef#0| (Tclass._System.___hPartialFunc1 TChar TChar)) ($IsAlloc HandleTypeType |funcRef#0| (Tclass._System.___hPartialFunc1 TChar TChar) $Heap)) true) (and (and ($Is charType |fromFuncRef#0| TChar) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 14) 13))))) anon0_correct))))
