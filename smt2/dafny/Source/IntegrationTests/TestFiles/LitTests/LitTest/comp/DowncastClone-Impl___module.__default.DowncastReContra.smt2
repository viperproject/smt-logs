...
(declare-fun Tagclass._module.ReContra () T@U)
(declare-fun |##_module.ReContra.ReContra| () T@U)
(declare-fun Tagclass._module.X? () T@U)
(declare-fun Tagclass._module.Y? () T@U)
...
(declare-fun tytagFamily$ReContra () T@U)
...
(declare-fun _module.ReContra.ReContra_q (T@U) Bool)
(declare-fun $Is (T@T T@U T@U) Bool)
(declare-fun DatatypeTypeType () T@T)
(declare-fun Tclass._module.ReContra (T@U) T@U)
...
(declare-fun |#_module.ReContra.ReContra| (T@U) T@U)
...
(declare-fun Tclass._module.ReContra_0 (T@U) T@U)
(declare-fun _module.ReContra.f (T@U) T@U)
...
(assert (distinct TBool TagBool TagSet alloc Tagclass._System.object? Tagclass._System.object Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 Tagclass._System.___hTotalFunc1 Tagclass._module.Y Tagclass._module.X Tagclass._module.ReContra |##_module.ReContra.ReContra| Tagclass._module.X? Tagclass._module.Y? tytagFamily$object |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1| |tytagFamily$_#TotalFunc1| tytagFamily$Y tytagFamily$X tytagFamily$ReContra)
)
...
(assert (forall ((_module.ReContra$T T@U) (d T@U) ) (!  (=> ($Is DatatypeTypeType d (Tclass._module.ReContra _module.ReContra$T)) (_module.ReContra.ReContra_q d))
 :qid |unknown.0:0|
 :skolemid |584|
 :pattern ( (_module.ReContra.ReContra_q d) ($Is DatatypeTypeType d (Tclass._module.ReContra _module.ReContra$T)))
)))
...
(assert (forall ((d@@0 T@U) ) (! (= (_module.ReContra.ReContra_q d@@0) (= (DatatypeCtorId d@@0) |##_module.ReContra.ReContra|))
 :qid |unknown.0:0|
 :skolemid |575|
 :pattern ( (_module.ReContra.ReContra_q d@@0))
)))
...
(assert (forall ((d@@1 T@U) ) (!  (=> (_module.ReContra.ReContra_q d@@1) (exists ((|a#26#0#0| T@U) ) (! (= d@@1 (|#_module.ReContra.ReContra| |a#26#0#0|))
 :qid |DowncastClonedfy.6:34|
 :skolemid |576|
)))
 :qid |unknown.0:0|
 :skolemid |577|
 :pattern ( (_module.ReContra.ReContra_q d@@1))
)))
...
(assert (forall ((_module.ReContra$T@@0 T@U) ) (!  (and (= (Tag (Tclass._module.ReContra _module.ReContra$T@@0)) Tagclass._module.ReContra) (= (TagFamily (Tclass._module.ReContra _module.ReContra$T@@0)) tytagFamily$ReContra))
 :qid |unknown.0:0|
 :skolemid |508|
 :pattern ( (Tclass._module.ReContra _module.ReContra$T@@0))
)))
...
(assert (forall ((_module.ReContra$T@@1 T@U) (|a#27#0#0| T@U) ($h@@8 T@U) ) (!  (=> ($IsGoodHeap $h@@8) (= ($IsAlloc DatatypeTypeType (|#_module.ReContra.ReContra| |a#27#0#0|) (Tclass._module.ReContra _module.ReContra$T@@1) $h@@8) ($IsAlloc HandleTypeType |a#27#0#0| (Tclass._System.___hTotalFunc1 _module.ReContra$T@@1 TBool) $h@@8)))
 :qid |unknown.0:0|
 :skolemid |579|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.ReContra.ReContra| |a#27#0#0|) (Tclass._module.ReContra _module.ReContra$T@@1) $h@@8))
)))
...
(assert (forall ((_module.ReContra$T@@2 T@U) ) (! (= (Tclass._module.ReContra_0 (Tclass._module.ReContra _module.ReContra$T@@2)) _module.ReContra$T@@2)
 :qid |unknown.0:0|
 :skolemid |509|
 :pattern ( (Tclass._module.ReContra _module.ReContra$T@@2))
)))
(assert (forall ((|a#25#0#0| T@U) ) (! (= (DatatypeCtorId (|#_module.ReContra.ReContra| |a#25#0#0|)) |##_module.ReContra.ReContra|)
 :qid |DowncastClonedfy.6:34|
 :skolemid |574|
 :pattern ( (|#_module.ReContra.ReContra| |a#25#0#0|))
)))
(assert (forall ((|a#29#0#0| T@U) ) (! (= (_module.ReContra.f (|#_module.ReContra.ReContra| |a#29#0#0|)) |a#29#0#0|)
 :qid |DowncastClonedfy.6:34|
 :skolemid |582|
 :pattern ( (|#_module.ReContra.ReContra| |a#29#0#0|))
)))
...
(assert (forall ((_module.ReContra$T@@3 T@U) (|a#27#0#0@@0| T@U) ) (! (= ($Is DatatypeTypeType (|#_module.ReContra.ReContra| |a#27#0#0@@0|) (Tclass._module.ReContra _module.ReContra$T@@3)) ($Is HandleTypeType |a#27#0#0@@0| (Tclass._System.___hTotalFunc1 _module.ReContra$T@@3 TBool)))
 :qid |unknown.0:0|
 :skolemid |578|
 :pattern ( ($Is DatatypeTypeType (|#_module.ReContra.ReContra| |a#27#0#0@@0|) (Tclass._module.ReContra _module.ReContra$T@@3)))
)))
...
(assert (forall ((_module.ReContra$T@@4 T@U) (bx@@18 T@U) ) (!  (=> ($IsBox bx@@18 (Tclass._module.ReContra _module.ReContra$T@@4)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@18)) bx@@18) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@18) (Tclass._module.ReContra _module.ReContra$T@@4))))
 :qid |unknown.0:0|
 :skolemid |510|
 :pattern ( ($IsBox bx@@18 (Tclass._module.ReContra _module.ReContra$T@@4)))
)))
(assert (forall ((d@@2 T@U) (_module.ReContra$T@@5 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) (and (_module.ReContra.ReContra_q d@@2) ($IsAlloc DatatypeTypeType d@@2 (Tclass._module.ReContra _module.ReContra$T@@5) $h@@9))) ($IsAlloc HandleTypeType (_module.ReContra.f d@@2) (Tclass._System.___hTotalFunc1 _module.ReContra$T@@5 TBool) $h@@9))
 :qid |unknown.0:0|
 :skolemid |580|
 :pattern ( ($IsAlloc HandleTypeType (_module.ReContra.f d@@2) (Tclass._System.___hTotalFunc1 _module.ReContra$T@@5 TBool) $h@@9))
)))
...
(assert (forall ((|a#28#0#0| T@U) ) (! (= (|#_module.ReContra.ReContra| (Lit HandleTypeType |a#28#0#0|)) (Lit DatatypeTypeType (|#_module.ReContra.ReContra| |a#28#0#0|)))
 :qid |DowncastClonedfy.6:34|
 :skolemid |581|
 :pattern ( (|#_module.ReContra.ReContra| (Lit HandleTypeType |a#28#0#0|)))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.DowncastReContra)
...
(let ((anon6_Else_correct  (=> (and (not (and ($Is refType |_v3#0@0| Tclass._module.X) ($IsAlloc refType |_v3#0@0| Tclass._module.X |$lambdaHeap#0@0|))) (= (ControlFlow 0 7) 5)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and ($Is refType |_v3#0@0| Tclass._module.X) ($IsAlloc refType |_v3#0@0| Tclass._module.X |$lambdaHeap#0@0|)) (=> (and (and (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (= |lambdaResult#0| (U_2_bool (Lit boolType (bool_2_U false))))) (and ($Is boolType (bool_2_U |lambdaResult#0|) TBool) (= (ControlFlow 0 6) 5))) anon3_correct))))
(let ((anon5_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@0 |$lambdaHeap#0@0|) ($HeapSucc $Heap@0 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 8) 6) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (= |i#0@0| (Lit DatatypeTypeType (|#_module.ReContra.ReContra| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#7| (Handle1 (|lambda#3| ($Box boolType (Lit boolType (bool_2_U false)))) (|lambda#4| Tclass._module.X) (|lambda#6| (SetRef_to_SetBox (|lambda#5| false))))) ($LS $LZ)))))) (=> (and ($Is DatatypeTypeType |b#0@0| (Tclass._module.ReContra Tclass._module.X)) ($IsAlloc DatatypeTypeType |b#0@0| (Tclass._module.ReContra Tclass._module.X) $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($Is DatatypeTypeType |i#0@0| (Tclass._module.ReContra Tclass._module.X))) (=> ($Is DatatypeTypeType |i#0@0| (Tclass._module.ReContra Tclass._module.X)) (=> (_module.ReContra.ReContra_q |i#0@0|) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (_module.ReContra.ReContra_q |i#0@0|) (=> (and (_module.ReContra.ReContra_q |i#0@0|) (= (ControlFlow 0 2) (- 0 1))) true))))))))))
...
)) ($HeapSucc $Heap $Heap@0))) (and (=> (= (ControlFlow 0 9) 8) anon5_Then_correct) (=> (= (ControlFlow 0 9) 2) anon5_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (=> |defass#y#0| (and ($Is refType |y#0| Tclass._module.Y) ($IsAlloc refType |y#0| Tclass._module.Y $Heap))) true)) (=> (and (and (and (and ($Is DatatypeTypeType |i#0| (Tclass._module.ReContra Tclass._module.X)) ($IsAlloc DatatypeTypeType |i#0| (Tclass._module.ReContra Tclass._module.X) $Heap)) true) (and (and ($Is DatatypeTypeType |a#0| (Tclass._module.ReContra Tclass._module.Y)) ($IsAlloc DatatypeTypeType |a#0| (Tclass._module.ReContra Tclass._module.Y) $Heap)) true)) (and (and (and ($Is DatatypeTypeType |b#0| (Tclass._module.ReContra Tclass._module.X)) ($IsAlloc DatatypeTypeType |b#0| (Tclass._module.ReContra Tclass._module.X) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 9)))) anon0_correct))))
