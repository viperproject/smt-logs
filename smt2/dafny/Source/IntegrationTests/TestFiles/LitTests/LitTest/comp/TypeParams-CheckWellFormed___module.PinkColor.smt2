...
(declare-fun |##_module.Color.Pink| () T@U)
...
(assert (distinct alloc Tagclass._module.Color |##_module.Color.Orange| |##_module.Color.Pink| tytagFamily$Color)
)
(assert (= (DatatypeCtorId |#_module.Color.Orange|) |##_module.Color.Orange|))
(assert (= (DatatypeCtorId |#_module.Color.Pink|) |##_module.Color.Pink|))
(assert (= (Ctor DatatypeTypeType) 3))
(assert ($Is DatatypeTypeType |#_module.Color.Orange| Tclass._module.Color))
(assert ($Is DatatypeTypeType |#_module.Color.Pink| Tclass._module.Color))
...
(assert (= |#_module.Color.Pink| (Lit DatatypeTypeType |#_module.Color.Pink|)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.PinkColor)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon6_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (not (|_module.Color#Equal| |#_module.Color.Pink| |#_module.Color.Orange|)))))
