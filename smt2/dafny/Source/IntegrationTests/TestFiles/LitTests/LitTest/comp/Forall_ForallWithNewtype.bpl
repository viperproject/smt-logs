...
axiom {:id "id0"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    ForallWithNewtype.__default.P#canCall(x#0) || 0 < $FunctionContextHeight
...
axiom {:id "id1"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    ForallWithNewtype.__default.P#canCall(LitInt(x#0)) || 0 < $FunctionContextHeight
...
procedure {:verboseName "ForallWithNewtype.P (well-formedness)"} CheckWellformed$$ForallWithNewtype.__default.P(x#0: int);
...
procedure {:verboseName "ForallWithNewtype.Test (correctness)"} Impl$$ForallWithNewtype.__default.Test() returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ForallWithNewtype.Test (correctness)"} Impl$$ForallWithNewtype.__default.Test() returns ($_reverifyPost: bool)
{
  ...
  var $prevHeap: Heap;
    ...
    // AddMethodImpl: Test, Impl$$ForallWithNewtype.__default.Test
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Forall.dfy(360,11)
    assume true;
    assert {:id "id3"} 0 <= LitInt(20);
    havoc $nw;
    ...
    a#0 := $nw;
    // ----- forall statement (assign) ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Forall.dfy(361,5)
    if (*)
    {
        // Assume Fuel Constant
        havoc i#0_0;
        assume LitInt(-2) <= i#0_0 && i#0_0 < 16 && ForallWithNewtype.__default.P(i#0_0);
        newtype$check#0_0 := LitInt(5);
        assert {:id "id5"} LitInt(-2) <= newtype$check#0_0
           && newtype$check#0_0 < 16
           && ForallWithNewtype.__default.P(newtype$check#0_0);
        if (LitInt(5) <= i#0_0)
        {
        ...
        assume true;
        assume LitInt(5) <= i#0_0 && i#0_0 < _System.array.Length(a#0);
        assert {:id "id7"} a#0 != null;
        assert {:id "id8"} {:subsumption 0} 0 <= i#0_0 && i#0_0 < _System.array.Length(a#0);
        assume true;
        assert {:id "id9"} $_ModifiesFrame[a#0, IndexField(i#0_0)];
        assume true;
        havoc i#0_1;
        assume LitInt(-2) <= i#0_1 && i#0_1 < 16 && ForallWithNewtype.__default.P(i#0_1);
        assume LitInt(5) <= i#0_1 && i#0_1 < _System.array.Length(a#0);
        assume i#0_0 != i#0_1;
        assert {:id "id10"} a#0 != a#0 || IndexField(i#0_0) != IndexField(i#0_1) || i#0_0 == i#0_1;
        assume false;
    }
    else
    {
        ...
        assume (forall $o: ref, $f: Field :: 
          ...
          read($Heap, $o, $f) == read($prevHeap, $o, $f)
             || (exists i#0_2: int :: 
              LitInt(-2) <= i#0_2
                 && i#0_2 < 16
                 && ForallWithNewtype.__default.P(i#0_2)
                 && 
                LitInt(5) <= i#0_2
        ...
        assume (forall i#inv#0_0: int :: 
          ...
          LitInt(-2) <= i#inv#0_0
               && i#inv#0_0 < 16
               && ForallWithNewtype.__default.P(i#inv#0_0)
               && 
              LitInt(-2) <= i#inv#0_0
               && i#inv#0_0 < 16
               && ForallWithNewtype.__default.P(i#inv#0_0)
             ...
             ==> read($Heap, a#0, IndexField(i#inv#0_0)) == $Box(i#inv#0_0));
    }

    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Forall.dfy(364,5)
    assume true;
...
procedure {:verboseName "ForallWithNewtype.MyInt (well-formedness)"} CheckWellFormed$$ForallWithNewtype.MyInt(x#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ForallWithNewtype.MyInt (well-formedness)"} CheckWellFormed$$ForallWithNewtype.MyInt(x#0: int)
{
  ...
  var ##x#0: int;
    ...
    if (*)
    {
        ...
        assume {:id "id12"} LitInt(-2) <= x#0 && x#0 < 16;
        ##x#0 := x#0;
        // assume allocatedness for argument to function
        assume $IsAlloc(##x#0, TInt, $Heap);
        assume ForallWithNewtype.__default.P#canCall(x#0);
        assume {:id "id13"} ForallWithNewtype.__default.P(x#0);
        assume false;
    }
    ...
    if (*)
    {
        ...
        assume LitInt(-2) <= LitInt(0)
           ==> 
          Lit(0 < 16)
           ==> ForallWithNewtype.__default.P#canCall(LitInt(0));
        assert {:id "id14"} {:subsumption 0} LitInt(-2) <= LitInt(0);
        assert {:id "id15"} {:subsumption 0} Lit(0 < 16);
        assert {:id "id16"} {:subsumption 0} ForallWithNewtype.__default.P#canCall(LitInt(0))
           ==> Lit(ForallWithNewtype.__default.P(LitInt(0))) || Lit(0 != 11);
        assume false;
    }
}
