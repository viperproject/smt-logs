...
(assert (forall ((|l#0| T@U) (|$l#0#heap#0| T@U) (|$l#0#x#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#3| |l#0|) |$l#0#heap#0| |$l#0#x#0|)) ($IsBox |$l#0#x#0| |l#0|))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |489|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#3| |l#0|) |$l#0#heap#0| |$l#0#x#0|))
)))
...
(assert (forall ((v@@9 T@U) (t0@@19 T@U) ) (! (= ($Is SeqType v@@9 (TSeq t0@@19)) (forall ((i@@1 Int) ) (!  (=> (and (<= 0 i@@1) (< i@@1 (|Seq#Length| v@@9))) ($IsBox (|Seq#Index| v@@9 i@@1) t0@@19))
...
(assert (forall ((|l#0@@3| T@U) (|$l#0#heap#0@@0| T@U) (|$l#0#x#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#2| |l#0@@3|) |$l#0#heap#0@@0| |$l#0#x#0@@0|) |l#0@@3|)
 :qid |Printdfy.25:28|
 :skolemid |488|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#2| |l#0@@3|) |$l#0#heap#0@@0| |$l#0#x#0@@0|))
)))
(assert (forall ((|l#0@@4| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#x#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#5| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#x#0@@1|) |l#0@@4|)
 :qid |Printdfy.25:23|
 :skolemid |491|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#5| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#x#0@@1|))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.PrintString)
...
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|seqinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| (LitInt 5))) (Requires1 TInt TChar $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| ($Box charType (Lit charType (|char#FromInt| 97)))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0|))))
 :qid |Printdfy.25:16|
 :skolemid |486|
)))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |a#0@0| (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box SeqType (Lit SeqType |Seq#Empty|)))))) (and ($Is SeqType |b#0@0| (TSeq TChar)) ($IsAlloc SeqType |b#0@0| (TSeq TChar) $Heap))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= 0 (LitInt 5))) (=> (<= 0 (LitInt 5)) (and (=> (= (ControlFlow 0 6) 5) anon5_Then_correct) (=> (= (ControlFlow 0 6) 2) anon5_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |a#0| (TSeq (TSeq TChar))) ($IsAlloc SeqType |a#0| (TSeq (TSeq TChar)) $Heap)) true) (=> (and (and (and ($Is SeqType |b#0| (TSeq TChar)) ($IsAlloc SeqType |b#0| (TSeq TChar) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 8) 6))) anon0_correct)))))
