// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/arrays.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/arrays-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/arrays.dfy
...
const unique class.Origin_mImported.__default: ClassName;

const unique class.Origin_mImported.SuperTrait?: ClassName;

function Tclass.Origin_mImported.SuperTrait?() : Ty
uses {
// Tclass.Origin_mImported.SuperTrait? Tag
axiom Tag(Tclass.Origin_mImported.SuperTrait?())
     == Tagclass.Origin_mImported.SuperTrait?
   && TagFamily(Tclass.Origin_mImported.SuperTrait?()) == tytagFamily$SuperTrait;
}

const unique Tagclass.Origin_mImported.SuperTrait?: TyTag;

// Box/unbox axiom for Tclass.Origin_mImported.SuperTrait?
axiom (forall bx: Box :: 
  { $IsBox(bx, Tclass.Origin_mImported.SuperTrait?()) } 
  $IsBox(bx, Tclass.Origin_mImported.SuperTrait?())
     ==> $Box($Unbox(bx): ref) == bx
       && $Is($Unbox(bx): ref, Tclass.Origin_mImported.SuperTrait?()));

// $Is axiom for trait SuperTrait
axiom (forall $o: ref :: 
  { $Is($o, Tclass.Origin_mImported.SuperTrait?()) } 
  $Is($o, Tclass.Origin_mImported.SuperTrait?())
     <==> $o == null || implements$Origin_mImported.SuperTrait(dtype($o)));

// $IsAlloc axiom for trait SuperTrait
axiom (forall $o: ref, $h: Heap :: 
  { $IsAlloc($o, Tclass.Origin_mImported.SuperTrait?(), $h) } 
  $IsAlloc($o, Tclass.Origin_mImported.SuperTrait?(), $h)
     <==> $o == null || $Unbox(read($h, $o, alloc)): bool);

function implements$Origin_mImported.SuperTrait(ty: Ty) : bool;
...
procedure {:verboseName "Origin.Imported.SuperTrait.X (well-formedness)"} CheckWellFormed$$Origin_mImported.SuperTrait.X(this: ref
       where this != null
         && 
        $Is(this, Tclass.Origin_mImported.SuperTrait())
         && $IsAlloc(this, Tclass.Origin_mImported.SuperTrait(), $Heap));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Origin.Imported.SuperTrait.X (call)"} Call$$Origin_mImported.SuperTrait.X(this: ref
       where this != null
         && 
        $Is(this, Tclass.Origin_mImported.SuperTrait())
         && $IsAlloc(this, Tclass.Origin_mImported.SuperTrait(), $Heap));
...
// $Is axiom for non-null type Origin.Imported.SuperTrait
axiom (forall c#0: ref :: 
  { $Is(c#0, Tclass.Origin_mImported.SuperTrait()) } 
    { $Is(c#0, Tclass.Origin_mImported.SuperTrait?()) } 
  $Is(c#0, Tclass.Origin_mImported.SuperTrait())
     <==> $Is(c#0, Tclass.Origin_mImported.SuperTrait?()) && c#0 != null);

// $IsAlloc axiom for non-null type Origin.Imported.SuperTrait
axiom (forall c#0: ref, $h: Heap :: 
  { $IsAlloc(c#0, Tclass.Origin_mImported.SuperTrait(), $h) } 
    { $IsAlloc(c#0, Tclass.Origin_mImported.SuperTrait?(), $h) } 
  $IsAlloc(c#0, Tclass.Origin_mImported.SuperTrait(), $h)
     <==> $IsAlloc(c#0, Tclass.Origin_mImported.SuperTrait?(), $h));
