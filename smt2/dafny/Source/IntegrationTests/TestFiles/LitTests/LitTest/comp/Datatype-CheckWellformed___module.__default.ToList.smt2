...
(assert (distinct TInt TagInt alloc Tagclass._System.nat Tagclass._module.List Tagclass._module.Stream |##_module.List.Nil| |##_module.List.Cons| |##_module.Stream.Next| tytagFamily$nat tytagFamily$List tytagFamily$Stream)
)
...
(assert (forall (($ly@@1 T@U) (|s#0@@1| T@U) (|n#0@@1| Int) ) (! (= (_module.__default.ToList ($LS $ly@@1) |s#0@@1| |n#0@@1|) (_module.__default.ToList $ly@@1 |s#0@@1| |n#0@@1|))
 :qid |Datatypedfy.93:10|
 :skolemid |2011|
 :pattern ( (_module.__default.ToList ($LS $ly@@1) |s#0@@1| |n#0@@1|))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) (|s#0@@2| T@U) (|n#0@@2| Int) ) (!  (=> (or (|_module.__default.ToList#canCall| |s#0@@2| (LitInt |n#0@@2|)) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@2| Tclass._module.Stream) (<= (LitInt 0) |n#0@@2|)))) (and (=> (or (not (= (LitInt |n#0@@2|) (LitInt 0))) (not true)) (and (_module.Stream.Next_q |s#0@@2|) (and (_module.Stream.Next_q |s#0@@2|) (|_module.__default.ToList#canCall| (_module.Stream.stail |s#0@@2|) (LitInt (- |n#0@@2| 1)))))) (= (_module.__default.ToList ($LS $ly@@2) |s#0@@2| (LitInt |n#0@@2|)) (ite (= (LitInt |n#0@@2|) (LitInt 0)) |#_module.List.Nil| (|#_module.List.Cons| (_module.Stream.shead |s#0@@2|) (_module.__default.ToList ($LS $ly@@2) (_module.Stream.stail |s#0@@2|) (LitInt (- |n#0@@2| 1))))))))
 :qid |Datatypedfy.93:10|
 :weight 3
 :skolemid |2016|
 :pattern ( (_module.__default.ToList ($LS $ly@@2) |s#0@@2| (LitInt |n#0@@2|)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@3 T@U) (|s#0@@3| T@U) (|n#0@@3| Int) ) (!  (=> (or (|_module.__default.ToList#canCall| (Lit DatatypeTypeType |s#0@@3|) (LitInt |n#0@@3|)) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |s#0@@3| Tclass._module.Stream) (<= (LitInt 0) |n#0@@3|)))) (and (=> (or (not (= (LitInt |n#0@@3|) (LitInt 0))) (not true)) (and (_module.Stream.Next_q (Lit DatatypeTypeType |s#0@@3|)) (and (_module.Stream.Next_q (Lit DatatypeTypeType |s#0@@3|)) (|_module.__default.ToList#canCall| (Lit DatatypeTypeType (_module.Stream.stail (Lit DatatypeTypeType |s#0@@3|))) (LitInt (- |n#0@@3| 1)))))) (= (_module.__default.ToList ($LS $ly@@3) (Lit DatatypeTypeType |s#0@@3|) (LitInt |n#0@@3|)) (ite (= (LitInt |n#0@@3|) (LitInt 0)) |#_module.List.Nil| (|#_module.List.Cons| (LitInt (_module.Stream.shead (Lit DatatypeTypeType |s#0@@3|))) (Lit DatatypeTypeType (_module.__default.ToList ($LS $ly@@3) (Lit DatatypeTypeType (_module.Stream.stail (Lit DatatypeTypeType |s#0@@3|))) (LitInt (- |n#0@@3| 1)))))))))
 :qid |Datatypedfy.93:10|
 :weight 3
 :skolemid |2017|
 :pattern ( (_module.__default.ToList ($LS $ly@@3) (Lit DatatypeTypeType |s#0@@3|) (LitInt |n#0@@3|)))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.ToList)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon8_Else_correct  (=> (or (not (= |n#0@@4| (LitInt 0))) (not true)) (=> (and (and (_module.Stream.Next_q |s#0@@4|) (_module.Stream.Next_q |s#0@@4|)) (and (= |##s#0@0| (_module.Stream.stail |s#0@@4|)) ($IsAlloc DatatypeTypeType |##s#0@0| Tclass._module.Stream $Heap))) (and (=> (= (ControlFlow 0 4) (- 0 6)) ($Is intType (int_2_U (- |n#0@@4| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0@@4| 1)) Tclass._System.nat) (=> (and (= |##n#0@0| (- |n#0@@4| 1)) ($IsAlloc intType (int_2_U |##n#0@0|) Tclass._System.nat $Heap)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (<= 0 |n#0@@4|) (= |##n#0@0| |n#0@@4|))) (=> (or (<= 0 |n#0@@4|) (= |##n#0@0| |n#0@@4|)) (=> (= (ControlFlow 0 4) (- 0 3)) (< |##n#0@0| |n#0@@4|)))))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |s#0@@4| Tclass._module.Stream) (<= (LitInt 0) |n#0@@4|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
