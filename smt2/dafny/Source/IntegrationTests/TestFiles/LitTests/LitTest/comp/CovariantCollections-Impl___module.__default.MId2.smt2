...
(declare-fun _module._default.MId2$T () T@U)
(declare-fun |r0#0| () T@U)
(declare-fun |r1#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.MId2)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SetType |s#0| (TSet _module._default.MId2$T)) ($IsAlloc SetType |s#0| (TSet _module._default.MId2$T) $Heap)) (and ($Is SetType |r0#0| (TSet _module._default.MId2$T)) ($IsAlloc SetType |r0#0| (TSet _module._default.MId2$T) $Heap))) (and (and ($Is SetType |r1#0| (TSet _module._default.MId2$T)) ($IsAlloc SetType |r1#0| (TSet _module._default.MId2$T) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct))))
