...
(assert (distinct TagSet TagSeq TagMap alloc Tagclass._System.nat |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass._module.Shape? Tagclass._module.Shape tytagFamily$nat |tytagFamily$_tuple#2| tytagFamily$Shape)
)
...
(assert (forall (($o T@U) ($h@@1 T@U) ) (! (= ($IsAlloc refType $o Tclass._module.Shape? $h@@1)  (or (= $o null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@1 $o) alloc)))))
 :qid |unknown.0:0|
 :skolemid |568|
 :pattern ( ($IsAlloc refType $o Tclass._module.Shape? $h@@1))
)))
...
(assert (forall ((bx@@7 T@U) (s@@5 T@U) (t@@11 T@U) ) (!  (=> ($IsBox bx@@7 (TMap s@@5 t@@11)) (and (= ($Box MapType ($Unbox MapType bx@@7)) bx@@7) ($Is MapType ($Unbox MapType bx@@7) (TMap s@@5 t@@11))))
 :qid |DafnyPreludebpl.207:15|
 :skolemid |36|
 :pattern ( ($IsBox bx@@7 (TMap s@@5 t@@11)))
)))
...
(assert (forall ((m@@13 T@U) ) (!  (or (= m@@13 |Map#Empty|) (exists ((k@@3 T@U) (v@@12 T@U) ) (! (|Set#IsMember| (|Map#Items| m@@13) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| k@@3 v@@12)))
...
(declare-fun |k#0_0| () Int)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.PrintMap)
...
(let ((anon19_Else_correct  (=> (and (< (LitInt 0) (|Set#Card| |s#0@1|)) (= (ControlFlow 0 23) 21)) anon5_correct)))
(let ((anon19_Then_correct  (=> (and (<= (|Set#Card| |s#0@1|) (LitInt 0)) (= (ControlFlow 0 22) 21)) anon5_correct)))
(let ((anon18_Then_correct  (=> (and (not |$w$loop#0@0|) (|Set#Subset| |s#0@1| (|Map#Domain| |shapes#0|))) (and (=> (= (ControlFlow 0 24) 22) anon19_Then_correct) (=> (= (ControlFlow 0 24) 23) anon19_Else_correct)))))
(let ((anon23_Else_correct true))
(let ((anon15_correct  (and (=> (= (ControlFlow 0 4) (- 0 8)) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (and (|Set#IsMember| |s#0@1| ($Box intType (int_2_U (LitInt 0)))) (forall ((|k'#0_4| Int) ) (!  (=> (|Set#IsMember| |s#0@1| ($Box intType (int_2_U |k'#0_4|))) (<= (LitInt 0) |k'#0_4|))
 :qid |Polydfy.130:31|
 :skolemid |550|
 :pattern ( (|Set#IsMember| |s#0@1| ($Box intType (int_2_U |k'#0_4|))))
)))) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (and (|Set#IsMember| |s#0@1| ($Box intType (int_2_U (LitInt 0)))) (forall ((|k'#0_3| Int) ) (!  (=> (|Set#IsMember| |s#0@1| ($Box intType (int_2_U |k'#0_3|))) (<= (LitInt 0) |k'#0_3|))
 :qid |Polydfy.130:31|
 :skolemid |549|
 :pattern ( (|Set#IsMember| |s#0@1| ($Box intType (int_2_U |k'#0_3|))))
)))) (exists ((|$as#k0_0#0_0| T@U) ) (!  (and (<= (LitInt 0) (U_2_int |$as#k0_0#0_0|)) (and (|Set#IsMember| |s#0@1| ($Box intType |$as#k0_0#0_0|)) (forall ((|k'#0_2| Int) ) (!  (=> (|Set#IsMember| |s#0@1| ($Box intType (int_2_U |k'#0_2|))) (<= (U_2_int |$as#k0_0#0_0|) |k'#0_2|))
 :qid |Polydfy.130:31|
 :skolemid |547|
 :pattern ( (|Set#IsMember| |s#0@1| ($Box intType (int_2_U |k'#0_2|))))
))))
 :qid |Polydfy.130:9|
 :skolemid |548|
))))) (=> (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (and (|Set#IsMember| |s#0@1| ($Box intType (int_2_U (LitInt 0)))) (forall ((|k'#0_4@@0| T@U) ) (!  (=> (|Set#IsMember| |s#0@1| ($Box intType |k'#0_4@@0|)) (<= (LitInt 0) (U_2_int |k'#0_4@@0|)))
 :qid |Polydfy.130:31|
 :skolemid |550|
 :pattern ( (|Set#IsMember| |s#0@1| ($Box intType |k'#0_4@@0|)))
)))) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (and (|Set#IsMember| |s#0@1| ($Box intType (int_2_U (LitInt 0)))) (forall ((|k'#0_3@@0| T@U) ) (!  (=> (|Set#IsMember| |s#0@1| ($Box intType |k'#0_3@@0|)) (<= (LitInt 0) (U_2_int |k'#0_3@@0|)))
 :qid |Polydfy.130:31|
 :skolemid |549|
 :pattern ( (|Set#IsMember| |s#0@1| ($Box intType |k'#0_3@@0|)))
)))) (exists ((|$as#k0_0#0_0@@0| Int) ) (!  (and (<= (LitInt 0) |$as#k0_0#0_0@@0|) (and (|Set#IsMember| |s#0@1| ($Box intType (int_2_U |$as#k0_0#0_0@@0|))) (forall ((|k'#0_2@@0| T@U) ) (!  (=> (|Set#IsMember| |s#0@1| ($Box intType |k'#0_2@@0|)) (<= |$as#k0_0#0_0@@0| (U_2_int |k'#0_2@@0|)))
 :qid |Polydfy.130:31|
 :skolemid |547|
 :pattern ( (|Set#IsMember| |s#0@1| ($Box intType |k'#0_2@@0|)))
))))
 :qid |Polydfy.130:9|
 :skolemid |548|
)))) (=> (<= (LitInt 0) |k#0_0@1|) (=> (and (|Set#IsMember| |s#0@1| ($Box intType (int_2_U |k#0_0@1|))) (forall ((|k'#0_5| T@U) ) (!  (=> (|Set#IsMember| |s#0@1| ($Box intType |k'#0_5|)) (<= |k#0_0@1| (U_2_int |k'#0_5|)))
 :qid |Polydfy.130:31|
 :skolemid |551|
 :pattern ( (|Set#IsMember| |s#0@1| ($Box intType |k'#0_5|)))
))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (|Set#IsMember| (|Map#Domain| |shapes#0|) ($Box intType (int_2_U |k#0_0@1|)))) (=> (|Set#IsMember| (|Map#Domain| |shapes#0|) ($Box intType (int_2_U |k#0_0@1|))) (=> (and (= |ordered#0@2| (|Seq#Append| |ordered#0@1| (|Seq#Build| |Seq#Empty| (MapType0Select BoxType BoxType (|Map#Elements| |shapes#0|) ($Box intType (int_2_U |k#0_0@1|)))))) (= |s#0@2| (|Set#Difference| |s#0@1| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U |k#0_0@1|)))))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (or (<= 0 |$decr$loop#00@1|) (= (ite (<= (|Set#Card| |s#0@2|) (LitInt 0)) (- 0 (|Set#Card| |s#0@2|)) (- (|Set#Card| |s#0@2|) 0)) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (ite (<= (|Set#Card| |s#0@2|) (LitInt 0)) (- 0 (|Set#Card| |s#0@2|)) (- (|Set#Card| |s#0@2|) 0)) |$decr$loop#00@1|)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< (ite (<= (|Set#Card| |s#0@2|) (LitInt 0)) (- 0 (|Set#Card| |s#0@2|)) (- (|Set#Card| |s#0@2|) 0)) |$decr$loop#00@1|)) (=> (< (ite (<= (|Set#Card| |s#0@2|) (LitInt 0)) (- 0 (|Set#Card| |s#0@2|)) (- (|Set#Card| |s#0@2|) 0)) |$decr$loop#00@1|) (=> (= (ControlFlow 0 4) (- 0 3)) (=> |$w$loop#0@0| (|Set#Subset| |s#0@2| (|Map#Domain| |shapes#0|)))))))))))))))))
(let ((anon14_correct  (=> (= (ControlFlow 0 10) 4) anon15_correct)))
(let ((anon24_Else_correct  (=> (and (not (|Set#IsMember| |s#0@1| ($Box intType (int_2_U |k'#0_0@1|)))) (= (ControlFlow 0 14) 10)) anon14_correct)))
(let ((anon24_Then_correct  (=> (and (|Set#IsMember| |s#0@1| ($Box intType (int_2_U |k'#0_0@1|))) (= (ControlFlow 0 13) 10)) anon14_correct)))
(let ((anon23_Then_correct  (and (=> (= (ControlFlow 0 15) 13) anon24_Then_correct) (=> (= (ControlFlow 0 15) 14) anon24_Else_correct))))
(let ((anon22_Then_correct  (=> (|Set#IsMember| |s#0@1| ($Box intType (int_2_U |k#0_1@1|))) (and (=> (= (ControlFlow 0 16) 15) anon23_Then_correct) (=> (= (ControlFlow 0 16) 12) anon23_Else_correct)))))
(let ((anon22_Else_correct  (=> (and (not (|Set#IsMember| |s#0@1| ($Box intType (int_2_U |k#0_1@1|)))) (= (ControlFlow 0 11) 10)) anon14_correct)))
(let ((anon21_Then_correct  (=> (<= (LitInt 0) |k#0_1@1|) (and (=> (= (ControlFlow 0 17) 16) anon22_Then_correct) (=> (= (ControlFlow 0 17) 11) anon22_Else_correct)))))
(let ((anon21_Else_correct  (=> (and (< |k#0_1@1| (LitInt 0)) (= (ControlFlow 0 9) 4)) anon15_correct)))
(let ((anon20_Else_correct  (=> (and (or (not (= (|Set#Card| |s#0@1|) 0)) (not true)) (= |$decr$loop#00@1| (ite (<= (|Set#Card| |s#0@1|) (LitInt 0)) (- 0 (|Set#Card| |s#0@1|)) (- (|Set#Card| |s#0@1|) 0)))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (not (|Set#Equal| |s#0@1| |Set#Empty|))) (=> (not (|Set#Equal| |s#0@1| |Set#Empty|)) (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (|Set#IsMember| |s#0@1| ($Box intType (int_2_U |call2formal@k#0@0|)))) (and (forall ((|k'#1| T@U) ) (!  (=> (|Set#IsMember| |s#0@1| ($Box intType |k'#1|)) (<= |call2formal@k#0@0| (U_2_int |k'#1|)))
 :qid |Polydfy.112:28|
 :skolemid |536|
 :pattern ( (|Set#IsMember| |s#0@1| ($Box intType |k'#1|)))
)) (= $Heap@0 $Heap@2))) (and (=> (= (ControlFlow 0 18) 17) anon21_Then_correct) (=> (= (ControlFlow 0 18) 9) anon21_Else_correct))))))))
(let ((anon20_Then_correct true))
(let ((anon18_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 20) 2) anon20_Then_correct) (=> (= (ControlFlow 0 20) 18) anon20_Else_correct)))))
(let ((anon17_LoopBody_correct  (and (=> (= (ControlFlow 0 25) 24) anon18_Then_correct) (=> (= (ControlFlow 0 25) 20) anon18_Else_correct))))
(let ((anon17_LoopDone_correct true))
(let ((anon17_LoopHead_correct  (=> (<= (LitInt 0) |k#0_0@0|) (=> (and (and ($Is SeqType |ordered#0@1| (TSeq Tclass._module.Shape)) ($IsAlloc SeqType |ordered#0@1| (TSeq Tclass._module.Shape) $Heap@0)) (and ($Is SetType |s#0@1| (TSet Tclass._System.nat)) ($IsAlloc SetType |s#0@1| (TSet Tclass._System.nat) $Heap@0))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (not false) (=> |$w$loop#0@0| (|Set#Subset| |s#0@1| (|Map#Domain| |shapes#0|))))) (and (and (forall (($o@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@2) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2)))
 :qid |Polydfy.126:3|
 :skolemid |544|
...
)) (<= (ite (<= (|Set#Card| |s#0@1|) (LitInt 0)) (- 0 (|Set#Card| |s#0@1|)) (- (|Set#Card| |s#0@1|) 0)) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 26) 1) anon17_LoopDone_correct) (=> (= (ControlFlow 0 26) 25) anon17_LoopBody_correct)))))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |s#0@0| (|Map#Domain| |shapes#0|))) (and (= |ordered#0@0| (Lit SeqType |Seq#Empty|)) (= |$decr_init$loop#00@0| (ite (<= (|Set#Card| |s#0@0|) (LitInt 0)) (- 0 (|Set#Card| |s#0@0|)) (- (|Set#Card| |s#0@0|) 0))))) (and (=> (= (ControlFlow 0 27) (- 0 28)) (=> |$w$loop#0@0| (|Set#Subset| |s#0@0| (|Map#Domain| |shapes#0|)))) (=> (=> |$w$loop#0@0| (|Set#Subset| |s#0@0| (|Map#Domain| |shapes#0|))) (=> (= (ControlFlow 0 27) 26) anon17_LoopHead_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is MapType |shapes#0| (TMap Tclass._System.nat Tclass._module.Shape)) ($IsAlloc MapType |shapes#0| (TMap Tclass._System.nat Tclass._module.Shape) $Heap))) (and (and ($Is SetType |s#0| (TSet Tclass._System.nat)) ($IsAlloc SetType |s#0| (TSet Tclass._System.nat) $Heap)) true)) (and (and (and ($Is SeqType |ordered#0| (TSeq Tclass._module.Shape)) ($IsAlloc SeqType |ordered#0| (TSeq Tclass._module.Shape) $Heap)) true) (and (and (<= (LitInt 0) |k#0_0|) true) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 29) 27))))) anon0_correct)))
