...
(declare-fun |lambda#25| (T@U T@U) T@U)
...
(assert (distinct TBool TagBool TagSet alloc Tagclass._System.object? Tagclass._System.object Tagclass._System.___hFunc2 Tagclass._System.___hPartialFunc2 Tagclass._System.___hTotalFunc2 Tagclass._module.uint8 tytagFamily$object |tytagFamily$_#Func2| |tytagFamily$_#PartialFunc2| |tytagFamily$_#TotalFunc2| tytagFamily$uint8)
)
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|$l#1#heap#0| T@U) (|$l#1#a#0| T@U) (|$l#1#b#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType boolType (|lambda#25| |l#0| |l#1|) |$l#1#heap#0| |$l#1#a#0| |$l#1#b#0|))  (and ($IsBox |$l#1#a#0| |l#0|) ($IsBox |$l#1#b#0| |l#1|)))
 :qid |lambdadfy.3:9|
 :skolemid |578|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType boolType (|lambda#25| |l#0| |l#1|) |$l#1#heap#0| |$l#1#a#0| |$l#1#b#0|))
)))
...
(assert (forall ((|x#0| T@U) ($h T@U) ) (! ($IsAlloc intType |x#0| Tclass._module.uint8 $h)
 :qid |unknown.0:0|
 :skolemid |570|
 :pattern ( ($IsAlloc intType |x#0| Tclass._module.uint8 $h))
)))
...
(assert (forall ((|$l#1#heap#0@@0| T@U) (|$l#1#a#0@@0| T@U) (|$l#1#b#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType BoxType |lambda#24| |$l#1#heap#0@@0| |$l#1#a#0@@0| |$l#1#b#0@@0|) ($Box boolType (bool_2_U (= (U_2_int ($Unbox intType |$l#1#a#0@@0|)) (U_2_int ($Unbox intType |$l#1#b#0@@0|))))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |577|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType BoxType |lambda#24| |$l#1#heap#0@@0| |$l#1#a#0@@0| |$l#1#b#0@@0|))
)))
...
(assert (forall ((bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 Tclass._module.uint8) (and (= ($Box intType ($Unbox intType bx@@8)) bx@@8) ($Is intType ($Unbox intType bx@@8) Tclass._module.uint8)))
 :qid |unknown.0:0|
 :skolemid |568|
 :pattern ( ($IsBox bx@@8 Tclass._module.uint8))
)))
...
(assert (forall ((|l#0@@0| Bool) (|$l#2#o#0| T@U) ) (! (= (U_2_bool (MapType1Select refType boolType (|lambda#3| |l#0@@0|) |$l#2#o#0|)) |l#0@@0|)
 :qid |unknown.0:0|
 :skolemid |574|
 :pattern ( (MapType1Select refType boolType (|lambda#3| |l#0@@0|) |$l#2#o#0|))
)))
(assert (forall ((|l#0@@1| T@U) (|$l#2#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#5| |l#0@@1|) |$l#2#ly#0|) |l#0@@1|)
 :qid |lambdadfy.13:27|
 :skolemid |576|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#5| |l#0@@1|) |$l#2#ly#0|))
)))
...
(assert (forall ((|l#0@@2| T@U) (|$l#1#heap#0@@1| T@U) (|$l#1#a#0@@1| T@U) (|$l#1#b#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType SetType (|lambda#27| |l#0@@2|) |$l#1#heap#0@@1| |$l#1#a#0@@1| |$l#1#b#0@@1|) |l#0@@2|)
 :qid |lambdadfy.22:12|
 :skolemid |579|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType SetType (|lambda#27| |l#0@@2|) |$l#1#heap#0@@1| |$l#1#a#0@@1| |$l#1#b#0@@1|))
)))
...
(assert (forall ((|#$T0@@16| T@U) (|#$T1@@16| T@U) (|#$R@@16| T@U) (|f#0@@1| T@U) ($h@@2 T@U) ) (! (= ($IsAlloc HandleTypeType |f#0@@1| (Tclass._System.___hPartialFunc2 |#$T0@@16| |#$T1@@16| |#$R@@16|) $h@@2) ($IsAlloc HandleTypeType |f#0@@1| (Tclass._System.___hFunc2 |#$T0@@16| |#$T1@@16| |#$R@@16|) $h@@2))
 :qid |unknown.0:0|
 :skolemid |519|
 :pattern ( ($IsAlloc HandleTypeType |f#0@@1| (Tclass._System.___hPartialFunc2 |#$T0@@16| |#$T1@@16| |#$R@@16|) $h@@2))
)))
(assert (forall ((|#$T0@@17| T@U) (|#$T1@@17| T@U) (|#$R@@17| T@U) (|f#0@@2| T@U) ($h@@3 T@U) ) (! (= ($IsAlloc HandleTypeType |f#0@@2| (Tclass._System.___hTotalFunc2 |#$T0@@17| |#$T1@@17| |#$R@@17|) $h@@3) ($IsAlloc HandleTypeType |f#0@@2| (Tclass._System.___hPartialFunc2 |#$T0@@17| |#$T1@@17| |#$R@@17|) $h@@3))
 :qid |unknown.0:0|
 :skolemid |527|
 :pattern ( ($IsAlloc HandleTypeType |f#0@@2| (Tclass._System.___hTotalFunc2 |#$T0@@17| |#$T1@@17| |#$R@@17|) $h@@3))
)))
...
(assert (forall ((|x#0@@0| T@U) ) (! (= ($Is intType |x#0@@0| Tclass._module.uint8)  (and (<= (LitInt 0) (U_2_int |x#0@@0|)) (< (U_2_int |x#0@@0|) 256)))
 :qid |unknown.0:0|
 :skolemid |569|
 :pattern ( ($Is intType |x#0@@0| Tclass._module.uint8))
)))
...
(let ((anon6_Else_correct  (=> (and (not (and (and (<= (LitInt 0) |a#0@0|) (< |a#0@0| 256)) (and (<= (LitInt 0) |b#0@0|) (< |b#0@0| 256)))) (= (ControlFlow 0 6) 4)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (and (and (<= (LitInt 0) |a#0@0|) (< |a#0@0| 256)) (and (<= (LitInt 0) |b#0@0|) (< |b#0@0| 256))) (and (and (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (= |lambdaResult#0| (= |a#0@0| |b#0@0|))) (and ($Is boolType (bool_2_U |lambdaResult#0|) TBool) (= (ControlFlow 0 5) 4)))) anon3_correct)))
...
(let ((anon5_Else_correct  (=> (= |##f#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle2 |lambda#24| (|lambda#25| Tclass._module.uint8 Tclass._module.uint8) (|lambda#27| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))) (=> (and ($IsAlloc HandleTypeType |##f#0@0| (Tclass._System.___hTotalFunc2 Tclass._module.uint8 Tclass._module.uint8 TBool) $Heap) (= |newtype$check#0@0| (LitInt 2))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 256))) (=> (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 256)) (=> (and (= |newtype$check#1@0| (LitInt 2)) (= (ControlFlow 0 2) (- 0 1))) (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 256)))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 8) 7) anon5_Then_correct) (=> (= (ControlFlow 0 8) 2) anon5_Else_correct)))))
