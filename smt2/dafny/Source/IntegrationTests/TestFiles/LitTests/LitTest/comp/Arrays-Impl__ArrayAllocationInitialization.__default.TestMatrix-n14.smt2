...
(assert (forall ((ArrayAllocationInitialization._default.M2S$T@@0 T@U) ($ly@@0 T@U) ($h0 T@U) ($h1 T@U) (|m#0@@0| T@U) (|i#0@@0| Int) (|j#0@@0| Int) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|ArrayAllocationInitialization.__default.M2S#canCall| ArrayAllocationInitialization._default.M2S$T@@0 $h0 |m#0@@0| |i#0@@0| |j#0@@0|) (and (and ($Is refType |m#0@@0| (Tclass._System.array2 ArrayAllocationInitialization._default.M2S$T@@0)) (<= (LitInt 0) |i#0@@0|)) (<= (LitInt 0) |j#0@@0|)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@2 T@U) ($f T@U) )  (=> (and (or (not (= $o@@2 null)) (not true)) (= $o@@2 |m#0@@0|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@2) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@2) $f)))) (= (ArrayAllocationInitialization.__default.M2S ArrayAllocationInitialization._default.M2S$T@@0 $ly@@0 $h0 |m#0@@0| |i#0@@0| |j#0@@0|) (ArrayAllocationInitialization.__default.M2S ArrayAllocationInitialization._default.M2S$T@@0 $ly@@0 $h1 |m#0@@0| |i#0@@0| |j#0@@0|))))
