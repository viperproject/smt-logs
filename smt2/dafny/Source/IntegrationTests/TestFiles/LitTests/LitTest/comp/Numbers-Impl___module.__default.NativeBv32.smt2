...
(declare-fun |y#0@0| () (_ BitVec 32))
(declare-fun |x#0@1| () (_ BitVec 32))
(declare-fun |y#0@1| () (_ BitVec 32))
...
))) (forall ((x@@6 T@U) ) (! (= (bv32_2_U (U_2_bv32 x@@6)) x@@6)
 :qid |cast:U_2_bv32|
 :pattern ( (U_2_bv32 x@@6))
))))
(set-info :boogie-vc-id Impl$$_module.__default.NativeBv32)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |x#0@0| (U_2_bv32 (Lit bv32Type (bv32_2_U #x00000000))))) (and (= |y#0@0| (U_2_bv32 (Lit bv32Type (bv32_2_U #x0000000f)))) (= |x#0@1| (bvadd (bvsub (bvadd (bvadd |x#0@0| |y#0@0|) |y#0@0|) |x#0@0|) #x00000001)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |y#0@0| #x00000000)) (not true))) (=> (or (not (= |y#0@0| #x00000000)) (not true)) (=> (and (and (= |y#0@1| (bvudiv |x#0@1| |y#0@0|)) (= |x#0@2| (bvsub |x#0@1| |y#0@1|))) (and (= |z#0@0| (U_2_bv32 (Lit bv32Type (bv32_2_U #x00000011)))) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= (U_2_bv32 (Lit bv32Type (bv32_2_U #x00000003))) #x00000000)) (not true))))))))
