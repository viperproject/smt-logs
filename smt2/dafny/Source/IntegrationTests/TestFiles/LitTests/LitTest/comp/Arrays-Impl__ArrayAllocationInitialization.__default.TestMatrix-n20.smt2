...
(assert (distinct TInt TagInt TagSeq alloc Tagclass._System.nat Tagclass._System.array2? Tagclass._System.array2 Tagclass._System.___hFunc2 Tagclass._System.___hPartialFunc2 Tagclass._System.___hTotalFunc2 tytagFamily$nat tytagFamily$array2 |tytagFamily$_#Func2| |tytagFamily$_#PartialFunc2| |tytagFamily$_#TotalFunc2|)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((ArrayAllocationInitialization._default.M2S$T@@0 T@U) ($ly@@0 T@U) ($h0 T@U) ($h1 T@U) (|m#0@@0| T@U) (|i#0@@0| Int) (|j#0@@0| Int) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|ArrayAllocationInitialization.__default.M2S#canCall| ArrayAllocationInitialization._default.M2S$T@@0 $h0 |m#0@@0| |i#0@@0| |j#0@@0|) (and (and ($Is refType |m#0@@0| (Tclass._System.array2 ArrayAllocationInitialization._default.M2S$T@@0)) (<= (LitInt 0) |i#0@@0|)) (<= (LitInt 0) |j#0@@0|)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@2 T@U) ($f T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (= $o@@2 |m#0@@0|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@2) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@2) $f)))
 :qid |unknown.0:0|
 :skolemid |4512|
)) (= (ArrayAllocationInitialization.__default.M2S ArrayAllocationInitialization._default.M2S$T@@0 $ly@@0 $h0 |m#0@@0| |i#0@@0| |j#0@@0|) (ArrayAllocationInitialization.__default.M2S ArrayAllocationInitialization._default.M2S$T@@0 $ly@@0 $h1 |m#0@@0| |i#0@@0| |j#0@@0|))))
 :qid |unknown.0:0|
 :skolemid |4513|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (ArrayAllocationInitialization.__default.M2S ArrayAllocationInitialization._default.M2S$T@@0 $ly@@0 $h1 |m#0@@0| |i#0@@0| |j#0@@0|))
)))
...
(assert (forall ((_System.array2$arg@@4 T@U) ($h@@2 T@U) ($o@@3 T@U) ($i0 Int) ($i1 Int) ) (!  (=> (and (and (and ($IsGoodHeap $h@@2) (and (or (not (= $o@@3 null)) (not true)) (= (dtype $o@@3) (Tclass._System.array2? _System.array2$arg@@4)))) (and (and (<= 0 $i0) (< $i0 (_System.array2.Length0 $o@@3))) (and (<= 0 $i1) (< $i1 (_System.array2.Length1 $o@@3))))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@3) alloc)))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@3) (MultiIndexField (IndexField $i0) $i1)) _System.array2$arg@@4 $h@@2))
 :qid |unknown.0:0|
 :skolemid |4184|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@3) (MultiIndexField (IndexField $i0) $i1)) (Tclass._System.array2? _System.array2$arg@@4))
)))
...
(assert (forall ((ArrayAllocationInitialization._default.M2S$T@@1 T@U) ($ly@@1 T@U) ($Heap@@0 T@U) (|m#0@@1| T@U) (|i#0@@1| Int) (|j#0@@1| Int) ) (! (= (ArrayAllocationInitialization.__default.M2S ArrayAllocationInitialization._default.M2S$T@@1 ($LS $ly@@1) $Heap@@0 |m#0@@1| |i#0@@1| |j#0@@1|) (ArrayAllocationInitialization.__default.M2S ArrayAllocationInitialization._default.M2S$T@@1 $ly@@1 $Heap@@0 |m#0@@1| |i#0@@1| |j#0@@1|))
 :qid |unknown.0:0|
 :skolemid |4510|
 :pattern ( (ArrayAllocationInitialization.__default.M2S ArrayAllocationInitialization._default.M2S$T@@1 ($LS $ly@@1) $Heap@@0 |m#0@@1| |i#0@@1| |j#0@@1|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((ArrayAllocationInitialization._default.M2S$T@@2 T@U) ($ly@@2 T@U) ($Heap@@3 T@U) (|m#0@@4| T@U) (|i#0@@2| Int) (|j#0@@2| Int) ) (!  (=> (or (|ArrayAllocationInitialization.__default.M2S#canCall| ArrayAllocationInitialization._default.M2S$T@@2 $Heap@@3 |m#0@@4| |i#0@@2| |j#0@@2|) (and (< 0 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $Heap@@3) (and ($Is refType |m#0@@4| (Tclass._System.array2 ArrayAllocationInitialization._default.M2S$T@@2)) ($IsAlloc refType |m#0@@4| (Tclass._System.array2 ArrayAllocationInitialization._default.M2S$T@@2) $Heap@@3))) (<= (LitInt 0) |i#0@@2|)) (<= (LitInt 0) |j#0@@2|)) (and (and (<= |i#0@@2| (_System.array2.Length0 |m#0@@4|)) (<= |j#0@@2| (_System.array2.Length1 |m#0@@4|))) (=> (= |i#0@@2| (_System.array2.Length0 |m#0@@4|)) (= |j#0@@2| (LitInt 0))))))) ($Is SeqType (ArrayAllocationInitialization.__default.M2S ArrayAllocationInitialization._default.M2S$T@@2 $ly@@2 $Heap@@3 |m#0@@4| |i#0@@2| |j#0@@2|) (TSeq ArrayAllocationInitialization._default.M2S$T@@2)))
 :qid |unknown.0:0|
 :skolemid |4514|
 :pattern ( (ArrayAllocationInitialization.__default.M2S ArrayAllocationInitialization._default.M2S$T@@2 $ly@@2 $Heap@@3 |m#0@@4| |i#0@@2| |j#0@@2|))
))))
(assert (forall ((f@@5 T@U) (t0@@6 T@U) (t1@@5 T@U) (t2@@4 T@U) (u0@@0 T@U) (u1@@0 T@U) (u2 T@U) ) (!  (=> (and (and (and ($Is HandleTypeType f@@5 (Tclass._System.___hFunc2 t0@@6 t1@@5 t2@@4)) (forall ((bx@@6 T@U) ) (!  (=> ($IsBox bx@@6 u0@@0) ($IsBox bx@@6 t0@@6))
 :qid |unknown.0:0|
 :skolemid |4220|
...
(assert (forall ((|#$T0@@16| T@U) (|#$T1@@16| T@U) (|#$R@@16| T@U) (|f#0@@1| T@U) ($h@@6 T@U) ) (! (= ($IsAlloc HandleTypeType |f#0@@1| (Tclass._System.___hPartialFunc2 |#$T0@@16| |#$T1@@16| |#$R@@16|) $h@@6) ($IsAlloc HandleTypeType |f#0@@1| (Tclass._System.___hFunc2 |#$T0@@16| |#$T1@@16| |#$R@@16|) $h@@6))
 :qid |unknown.0:0|
 :skolemid |4236|
 :pattern ( ($IsAlloc HandleTypeType |f#0@@1| (Tclass._System.___hPartialFunc2 |#$T0@@16| |#$T1@@16| |#$R@@16|) $h@@6))
)))
(assert (forall ((|#$T0@@17| T@U) (|#$T1@@17| T@U) (|#$R@@17| T@U) (|f#0@@2| T@U) ($h@@7 T@U) ) (! (= ($IsAlloc HandleTypeType |f#0@@2| (Tclass._System.___hTotalFunc2 |#$T0@@17| |#$T1@@17| |#$R@@17|) $h@@7) ($IsAlloc HandleTypeType |f#0@@2| (Tclass._System.___hPartialFunc2 |#$T0@@17| |#$T1@@17| |#$R@@17|) $h@@7))
 :qid |unknown.0:0|
 :skolemid |4244|
 :pattern ( ($IsAlloc HandleTypeType |f#0@@2| (Tclass._System.___hTotalFunc2 |#$T0@@17| |#$T1@@17| |#$R@@17|) $h@@7))
)))
...
(assert (forall ((_System.array2$arg@@13 T@U) (bx@@10 T@U) ) (!  (=> ($IsBox bx@@10 (Tclass._System.array2? _System.array2$arg@@13)) (and (= ($Box refType ($Unbox refType bx@@10)) bx@@10) ($Is refType ($Unbox refType bx@@10) (Tclass._System.array2? _System.array2$arg@@13))))
 :qid |unknown.0:0|
 :skolemid |4180|
 :pattern ( ($IsBox bx@@10 (Tclass._System.array2? _System.array2$arg@@13)))
)))
(assert (forall ((_System.array2$arg@@14 T@U) (bx@@11 T@U) ) (!  (=> ($IsBox bx@@11 (Tclass._System.array2 _System.array2$arg@@14)) (and (= ($Box refType ($Unbox refType bx@@11)) bx@@11) ($Is refType ($Unbox refType bx@@11) (Tclass._System.array2 _System.array2$arg@@14))))
 :qid |unknown.0:0|
 :skolemid |4193|
 :pattern ( ($IsBox bx@@11 (Tclass._System.array2 _System.array2$arg@@14)))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((ArrayAllocationInitialization._default.M2S$T@@3 T@U) ($ly@@3 T@U) ($Heap@@5 T@U) (|m#0@@7| T@U) (|i#0@@3| Int) (|j#0@@3| Int) ) (!  (=> (or (|ArrayAllocationInitialization.__default.M2S#canCall| ArrayAllocationInitialization._default.M2S$T@@3 $Heap@@5 |m#0@@7| |i#0@@3| |j#0@@3|) (and (< 0 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $Heap@@5) ($Is refType |m#0@@7| (Tclass._System.array2 ArrayAllocationInitialization._default.M2S$T@@3))) (<= (LitInt 0) |i#0@@3|)) (<= (LitInt 0) |j#0@@3|)) (and (and (<= |i#0@@3| (_System.array2.Length0 |m#0@@7|)) (<= |j#0@@3| (_System.array2.Length1 |m#0@@7|))) (=> (= |i#0@@3| (_System.array2.Length0 |m#0@@7|)) (= |j#0@@3| (LitInt 0))))))) (and (=> (or (not (= |i#0@@3| (_System.array2.Length0 |m#0@@7|))) (not true)) (and (=> (= |j#0@@3| (_System.array2.Length1 |m#0@@7|)) (|ArrayAllocationInitialization.__default.M2S#canCall| ArrayAllocationInitialization._default.M2S$T@@3 $Heap@@5 |m#0@@7| (+ |i#0@@3| 1) (LitInt 0))) (=> (or (not (= |j#0@@3| (_System.array2.Length1 |m#0@@7|))) (not true)) (|ArrayAllocationInitialization.__default.M2S#canCall| ArrayAllocationInitialization._default.M2S$T@@3 $Heap@@5 |m#0@@7| |i#0@@3| (+ |j#0@@3| 1))))) (= (ArrayAllocationInitialization.__default.M2S ArrayAllocationInitialization._default.M2S$T@@3 ($LS $ly@@3) $Heap@@5 |m#0@@7| |i#0@@3| |j#0@@3|) (ite (= |i#0@@3| (_System.array2.Length0 |m#0@@7|)) |Seq#Empty| (ite (= |j#0@@3| (_System.array2.Length1 |m#0@@7|)) (ArrayAllocationInitialization.__default.M2S ArrayAllocationInitialization._default.M2S$T@@3 $ly@@3 $Heap@@5 |m#0@@7| (+ |i#0@@3| 1) (LitInt 0)) (|Seq#Append| (|Seq#Build| |Seq#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |m#0@@7|) (MultiIndexField (IndexField |i#0@@3|) |j#0@@3|))) (ArrayAllocationInitialization.__default.M2S ArrayAllocationInitialization._default.M2S$T@@3 $ly@@3 $Heap@@5 |m#0@@7| |i#0@@3| (+ |j#0@@3| 1))))))))
 :qid |unknown.0:0|
 :skolemid |4517|
 :pattern ( (ArrayAllocationInitialization.__default.M2S ArrayAllocationInitialization._default.M2S$T@@3 ($LS $ly@@3) $Heap@@5 |m#0@@7| |i#0@@3| |j#0@@3|) ($IsGoodHeap $Heap@@5))
))))
...
(declare-fun ArrayAllocationInitialization._default.TestMatrixTypeParameter$T () T@U)
...
(declare-fun |a#0| () T@U)
(declare-fun |s#0| () T@U)
(set-info :boogie-vc-id Impl$$ArrayAllocationInitialization.__default.TestMatrixTypeParameter)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (= |$rhs#0@0| (LitInt 0))) (and (= |$rhs#1@0| (LitInt 2)) (= |$rhs#2@0| (LitInt 5)))) (and (and ($Is refType |a#0@0| (Tclass._System.array2 ArrayAllocationInitialization._default.TestMatrixTypeParameter$T)) ($IsAlloc refType |a#0@0| (Tclass._System.array2 ArrayAllocationInitialization._default.TestMatrixTypeParameter$T) $Heap@@6)) (= |s#0@0| (Lit SeqType |Seq#Empty|)))) (and (=> (= (ControlFlow 0 2) (- 0 21)) (<= 0 |$rhs#0@0|)) (=> (<= 0 |$rhs#0@0|) (and (=> (= (ControlFlow 0 2) (- 0 20)) (<= 0 |$rhs#0@0|)) (=> (<= 0 |$rhs#0@0|) (=> (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array2? ArrayAllocationInitialization._default.TestMatrixTypeParameter$T))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 $nw@0) alloc)))) (= (_System.array2.Length0 $nw@0) |$rhs#0@0|))) (=> (and (and (and (= (_System.array2.Length1 $nw@0) |$rhs#0@0|) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@6 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and ($IsAlloc refType $nw@0 (Tclass._System.array2 ArrayAllocationInitialization._default.TestMatrixTypeParameter$T) $Heap@0) (|ArrayAllocationInitialization.__default.MatrixToSequence#canCall| ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@0 $nw@0)) (and (|ArrayAllocationInitialization.__default.MatrixToSequence#canCall| ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@0 $nw@0) (= |s#0@1| (|Seq#Append| |s#0@0| (ArrayAllocationInitialization.__default.MatrixToSequence ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@0 $nw@0)))))) (and (=> (= (ControlFlow 0 2) (- 0 19)) (<= 0 |$rhs#0@0|)) (=> (<= 0 |$rhs#0@0|) (and (=> (= (ControlFlow 0 2) (- 0 18)) (<= 0 |$rhs#2@0|)) (=> (<= 0 |$rhs#2@0|) (=> (and (and (or (not (= $nw@1 null)) (not true)) ($Is refType $nw@1 (Tclass._System.array2? ArrayAllocationInitialization._default.TestMatrixTypeParameter$T))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1) alloc)))) (= (_System.array2.Length0 $nw@1) |$rhs#0@0|))) (=> (and (and (and (= (_System.array2.Length1 $nw@1) |$rhs#2@0|) (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1))) (and (and ($IsAlloc refType $nw@1 (Tclass._System.array2 ArrayAllocationInitialization._default.TestMatrixTypeParameter$T) $Heap@1) (|ArrayAllocationInitialization.__default.MatrixToSequence#canCall| ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@1 $nw@1)) (and (|ArrayAllocationInitialization.__default.MatrixToSequence#canCall| ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@1 $nw@1) (= |s#0@2| (|Seq#Append| |s#0@1| (ArrayAllocationInitialization.__default.MatrixToSequence ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@1 $nw@1)))))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (<= 0 |$rhs#2@0|)) (=> (<= 0 |$rhs#2@0|) (and (=> (= (ControlFlow 0 2) (- 0 16)) (<= 0 |$rhs#0@0|)) (=> (<= 0 |$rhs#0@0|) (=> (and (and (or (not (= $nw@2 null)) (not true)) ($Is refType $nw@2 (Tclass._System.array2? ArrayAllocationInitialization._default.TestMatrixTypeParameter$T))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@2) alloc)))) (= (_System.array2.Length0 $nw@2) |$rhs#2@0|))) (=> (and (and (and (= (_System.array2.Length1 $nw@2) |$rhs#0@0|) (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 $nw@2 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@2) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2))) (and (and ($IsAlloc refType $nw@2 (Tclass._System.array2 ArrayAllocationInitialization._default.TestMatrixTypeParameter$T) $Heap@2) (|ArrayAllocationInitialization.__default.MatrixToSequence#canCall| ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@2 $nw@2)) (and (|ArrayAllocationInitialization.__default.MatrixToSequence#canCall| ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@2 $nw@2) (= |s#0@3| (|Seq#Append| |s#0@2| (ArrayAllocationInitialization.__default.MatrixToSequence ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@2 $nw@2)))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (<= 0 |$rhs#1@0|)) (=> (<= 0 |$rhs#1@0|) (and (=> (= (ControlFlow 0 2) (- 0 14)) (<= 0 |$rhs#2@0|)) (=> (<= 0 |$rhs#2@0|) (=> (and (and (or (not (= $nw@3 null)) (not true)) ($Is refType $nw@3 (Tclass._System.array2? ArrayAllocationInitialization._default.TestMatrixTypeParameter$T))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@3) alloc)))) (= (_System.array2.Length0 $nw@3) |$rhs#1@0|))) (=> (and (and (and (= (_System.array2.Length1 $nw@3) |$rhs#2@0|) (= $Heap@3 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@2 $nw@3 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@3) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3))) (and (and ($IsAlloc refType $nw@3 (Tclass._System.array2 ArrayAllocationInitialization._default.TestMatrixTypeParameter$T) $Heap@3) (|ArrayAllocationInitialization.__default.MatrixToSequence#canCall| ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@3 $nw@3)) (and (|ArrayAllocationInitialization.__default.MatrixToSequence#canCall| ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@3 $nw@3) (= |s#0@4| (|Seq#Append| |s#0@3| (ArrayAllocationInitialization.__default.MatrixToSequence ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@3 $nw@3)))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (<= 0 |$rhs#0@0|)) (=> (<= 0 |$rhs#0@0|) (and (=> (= (ControlFlow 0 2) (- 0 12)) (<= 0 |$rhs#0@0|)) (=> (<= 0 |$rhs#0@0|) (=> (and (and (and (or (not (= $nw@4 null)) (not true)) ($Is refType $nw@4 (Tclass._System.array2? ArrayAllocationInitialization._default.TestMatrixTypeParameter$T))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@4) alloc))))) (and (= (_System.array2.Length0 $nw@4) |$rhs#0@0|) (= (_System.array2.Length1 $nw@4) |$rhs#0@0|))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (forall ((|arrayinit#0#i0#0| Int) (|arrayinit#0#i1#0| Int) ) (!  (=> (and (and (<= 0 |arrayinit#0#i0#0|) (< |arrayinit#0#i0#0| |$rhs#0@0|)) (and (<= 0 |arrayinit#0#i1#0|) (< |arrayinit#0#i1#0| |$rhs#0@0|))) (Requires2 Tclass._System.nat Tclass._System.nat ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@3 |initF2#0| ($Box intType (int_2_U |arrayinit#0#i0#0|)) ($Box intType (int_2_U |arrayinit#0#i1#0|))))
 :qid |Arraysdfy.779:10|
 :skolemid |4534|
))) (=> (and (and (and (forall ((|arrayinit#0#i0#0@@0| Int) (|arrayinit#0#i1#0@@0| Int) ) (!  (=> (and (and (<= 0 |arrayinit#0#i0#0@@0|) (< |arrayinit#0#i0#0@@0| |$rhs#0@0|)) (and (<= 0 |arrayinit#0#i1#0@@0|) (< |arrayinit#0#i1#0@@0| |$rhs#0@0|))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@4) (MultiIndexField (IndexField |arrayinit#0#i0#0@@0|) |arrayinit#0#i1#0@@0|)) (Apply2 Tclass._System.nat Tclass._System.nat ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@3 |initF2#0| ($Box intType (int_2_U |arrayinit#0#i0#0@@0|)) ($Box intType (int_2_U |arrayinit#0#i1#0@@0|)))))
 :qid |Arraysdfy.779:10|
 :skolemid |4535|
...
)) (= $Heap@4 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@3 $nw@4 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@4) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4))) (and (and ($IsAlloc refType $nw@4 (Tclass._System.array2 ArrayAllocationInitialization._default.TestMatrixTypeParameter$T) $Heap@4) (|ArrayAllocationInitialization.__default.MatrixToSequence#canCall| ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@4 $nw@4)) (and (|ArrayAllocationInitialization.__default.MatrixToSequence#canCall| ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@4 $nw@4) (= |s#0@5| (|Seq#Append| |s#0@4| (ArrayAllocationInitialization.__default.MatrixToSequence ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@4 $nw@4)))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (<= 0 |$rhs#0@0|)) (=> (<= 0 |$rhs#0@0|) (and (=> (= (ControlFlow 0 2) (- 0 9)) (<= 0 |$rhs#2@0|)) (=> (<= 0 |$rhs#2@0|) (=> (and (and (and (or (not (= $nw@5 null)) (not true)) ($Is refType $nw@5 (Tclass._System.array2? ArrayAllocationInitialization._default.TestMatrixTypeParameter$T))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $nw@5) alloc))))) (and (= (_System.array2.Length0 $nw@5) |$rhs#0@0|) (= (_System.array2.Length1 $nw@5) |$rhs#2@0|))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (forall ((|arrayinit#1#i0#0| Int) (|arrayinit#1#i1#0| Int) ) (!  (=> (and (and (<= 0 |arrayinit#1#i0#0|) (< |arrayinit#1#i0#0| |$rhs#0@0|)) (and (<= 0 |arrayinit#1#i1#0|) (< |arrayinit#1#i1#0| |$rhs#2@0|))) (Requires2 Tclass._System.nat Tclass._System.nat ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@4 |initF2#0| ($Box intType (int_2_U |arrayinit#1#i0#0|)) ($Box intType (int_2_U |arrayinit#1#i1#0|))))
 :qid |Arraysdfy.781:10|
 :skolemid |4536|
))) (=> (and (and (and (forall ((|arrayinit#1#i0#0@@0| Int) (|arrayinit#1#i1#0@@0| Int) ) (!  (=> (and (and (<= 0 |arrayinit#1#i0#0@@0|) (< |arrayinit#1#i0#0@@0| |$rhs#0@0|)) (and (<= 0 |arrayinit#1#i1#0@@0|) (< |arrayinit#1#i1#0@@0| |$rhs#2@0|))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $nw@5) (MultiIndexField (IndexField |arrayinit#1#i0#0@@0|) |arrayinit#1#i1#0@@0|)) (Apply2 Tclass._System.nat Tclass._System.nat ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@4 |initF2#0| ($Box intType (int_2_U |arrayinit#1#i0#0@@0|)) ($Box intType (int_2_U |arrayinit#1#i1#0@@0|)))))
 :qid |Arraysdfy.781:10|
 :skolemid |4537|
...
)) (= $Heap@5 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@4 $nw@5 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $nw@5) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5))) (and (and ($IsAlloc refType $nw@5 (Tclass._System.array2 ArrayAllocationInitialization._default.TestMatrixTypeParameter$T) $Heap@5) (|ArrayAllocationInitialization.__default.MatrixToSequence#canCall| ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@5 $nw@5)) (and (|ArrayAllocationInitialization.__default.MatrixToSequence#canCall| ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@5 $nw@5) (= |s#0@6| (|Seq#Append| |s#0@5| (ArrayAllocationInitialization.__default.MatrixToSequence ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@5 $nw@5)))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (<= 0 |$rhs#2@0|)) (=> (<= 0 |$rhs#2@0|) (and (=> (= (ControlFlow 0 2) (- 0 6)) (<= 0 |$rhs#0@0|)) (=> (<= 0 |$rhs#0@0|) (=> (and (and (and (or (not (= $nw@6 null)) (not true)) ($Is refType $nw@6 (Tclass._System.array2? ArrayAllocationInitialization._default.TestMatrixTypeParameter$T))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@6) alloc))))) (and (= (_System.array2.Length0 $nw@6) |$rhs#2@0|) (= (_System.array2.Length1 $nw@6) |$rhs#0@0|))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall ((|arrayinit#2#i0#0| Int) (|arrayinit#2#i1#0| Int) ) (!  (=> (and (and (<= 0 |arrayinit#2#i0#0|) (< |arrayinit#2#i0#0| |$rhs#2@0|)) (and (<= 0 |arrayinit#2#i1#0|) (< |arrayinit#2#i1#0| |$rhs#0@0|))) (Requires2 Tclass._System.nat Tclass._System.nat ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@5 |initF2#0| ($Box intType (int_2_U |arrayinit#2#i0#0|)) ($Box intType (int_2_U |arrayinit#2#i1#0|))))
 :qid |Arraysdfy.783:10|
 :skolemid |4538|
))) (=> (and (and (and (forall ((|arrayinit#2#i0#0@@0| Int) (|arrayinit#2#i1#0@@0| Int) ) (!  (=> (and (and (<= 0 |arrayinit#2#i0#0@@0|) (< |arrayinit#2#i0#0@@0| |$rhs#2@0|)) (and (<= 0 |arrayinit#2#i1#0@@0|) (< |arrayinit#2#i1#0@@0| |$rhs#0@0|))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@6) (MultiIndexField (IndexField |arrayinit#2#i0#0@@0|) |arrayinit#2#i1#0@@0|)) (Apply2 Tclass._System.nat Tclass._System.nat ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@5 |initF2#0| ($Box intType (int_2_U |arrayinit#2#i0#0@@0|)) ($Box intType (int_2_U |arrayinit#2#i1#0@@0|)))))
 :qid |Arraysdfy.783:10|
 :skolemid |4539|
...
)) (= $Heap@6 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@5 $nw@6 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@6) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@6) ($IsHeapAnchor $Heap@6))) (and (and ($IsAlloc refType $nw@6 (Tclass._System.array2 ArrayAllocationInitialization._default.TestMatrixTypeParameter$T) $Heap@6) (|ArrayAllocationInitialization.__default.MatrixToSequence#canCall| ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@6 $nw@6)) (and (|ArrayAllocationInitialization.__default.MatrixToSequence#canCall| ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@6 $nw@6) (= |s#0@7| (|Seq#Append| |s#0@6| (ArrayAllocationInitialization.__default.MatrixToSequence ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@6 $nw@6)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= 0 |$rhs#1@0|)) (=> (<= 0 |$rhs#1@0|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= 0 |$rhs#2@0|)) (=> (<= 0 |$rhs#2@0|) (=> (and (or (not (= $nw@7 null)) (not true)) ($Is refType $nw@7 (Tclass._System.array2? ArrayAllocationInitialization._default.TestMatrixTypeParameter$T))) (=> (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $nw@7) alloc)))) (= (_System.array2.Length0 $nw@7) |$rhs#1@0|)) (and (= (_System.array2.Length1 $nw@7) |$rhs#2@0|) (= (ControlFlow 0 2) (- 0 1)))) (forall ((|arrayinit#3#i0#0| Int) (|arrayinit#3#i1#0| Int) ) (!  (=> (and (and (<= 0 |arrayinit#3#i0#0|) (< |arrayinit#3#i0#0| |$rhs#1@0|)) (and (<= 0 |arrayinit#3#i1#0|) (< |arrayinit#3#i1#0| |$rhs#2@0|))) (Requires2 Tclass._System.nat Tclass._System.nat ArrayAllocationInitialization._default.TestMatrixTypeParameter$T $Heap@6 |initF2#0| ($Box intType (int_2_U |arrayinit#3#i0#0|)) ($Box intType (int_2_U |arrayinit#3#i1#0|))))
 :qid |Arraysdfy.785:10|
 :skolemid |4540|
))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (and ($Is HandleTypeType |initF2#0| (Tclass._System.___hTotalFunc2 Tclass._System.nat Tclass._System.nat ArrayAllocationInitialization._default.TestMatrixTypeParameter$T)) ($IsAlloc HandleTypeType |initF2#0| (Tclass._System.___hTotalFunc2 Tclass._System.nat Tclass._System.nat ArrayAllocationInitialization._default.TestMatrixTypeParameter$T) $Heap@@6))) (and (and ($Is refType |a#0| (Tclass._System.array2 ArrayAllocationInitialization._default.TestMatrixTypeParameter$T)) ($IsAlloc refType |a#0| (Tclass._System.array2 ArrayAllocationInitialization._default.TestMatrixTypeParameter$T) $Heap@@6)) true)) (and (and (and ($Is SeqType |s#0| (TSeq ArrayAllocationInitialization._default.TestMatrixTypeParameter$T)) ($IsAlloc SeqType |s#0| (TSeq ArrayAllocationInitialization._default.TestMatrixTypeParameter$T) $Heap@@6)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 22) 2)))) anon0_correct)))
