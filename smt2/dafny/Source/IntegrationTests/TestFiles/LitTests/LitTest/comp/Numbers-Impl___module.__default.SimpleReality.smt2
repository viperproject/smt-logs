...
(set-info :boogie-vc-id Impl$$_module.__default.SimpleReality)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (= |z#0@0| (- |r#0@0| |r#0@0|)) (= |s#0@0| (LitReal 0.81))) (and (= |t#0@0| (- (+ (* 2.0 |s#0@0|) |z#0@0|) |s#0@0|)) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= |t#0@0| 0.0)) (not true))))))
