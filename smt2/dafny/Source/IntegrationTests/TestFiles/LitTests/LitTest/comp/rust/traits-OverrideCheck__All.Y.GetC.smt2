...
(assert (forall (($o@@11 T@U) ) (!  (=> ($Is refType $o@@11 Tclass.TraitDefinitions.SuperTrait?) ($Is refType $o@@11 Tclass.TraitDefinitions.NoMemberTrait?))
 :qid |unknown.0:0|
 :skolemid |2274|
 :pattern ( ($Is refType $o@@11 Tclass.TraitDefinitions.SuperTrait?))
)))
(assert (forall (($o@@12 T@U) ) (!  (=> ($Is refType $o@@12 Tclass.TraitDefinitions.SuperTrait?) ($Is refType $o@@12 Tclass.TraitDefinitions.NoMemberTrait2?))
 :qid |unknown.0:0|
 :skolemid |2278|
...
(assert (= (Tag Tclass.TraitDefinitions.SuperTrait?) Tagclass.TraitDefinitions.SuperTrait?))
(assert (= (TagFamily Tclass.TraitDefinitions.SuperTrait?) tytagFamily$SuperTrait))
(assert (forall (($o@@13 T@U) ) (! (= ($Is refType $o@@13 Tclass.TraitDefinitions.NoMemberTrait?)  (or (= $o@@13 null) (implements$TraitDefinitions.NoMemberTrait (dtype $o@@13))))
 :qid |unknown.0:0|
 :skolemid |2243|
 :pattern ( ($Is refType $o@@13 Tclass.TraitDefinitions.NoMemberTrait?))
)))
(assert (forall (($o@@14 T@U) ) (! (= ($Is refType $o@@14 Tclass.TraitDefinitions.NoMemberTrait2?)  (or (= $o@@14 null) (implements$TraitDefinitions.NoMemberTrait2 (dtype $o@@14))))
 :qid |unknown.0:0|
 :skolemid |2248|
 :pattern ( ($Is refType $o@@14 Tclass.TraitDefinitions.NoMemberTrait2?))
)))
(assert (forall (($o@@15 T@U) ) (! (= ($Is refType $o@@15 Tclass.TraitDefinitions.SuperTrait?)  (or (= $o@@15 null) (implements$TraitDefinitions.SuperTrait (dtype $o@@15))))
 :qid |unknown.0:0|
 :skolemid |2253|
 :pattern ( ($Is refType $o@@15 Tclass.TraitDefinitions.SuperTrait?))
)))
(assert (forall ((TraitDefinitions.SubTrait$T@@10 T@U) (TraitDefinitions.SubTrait$I@@10 T@U) ($o@@16 T@U) ($heap@@2 T@U) ) (!  (=> ($IsAlloc refType $o@@16 (Tclass.TraitDefinitions.SubTrait? TraitDefinitions.SubTrait$T@@10 TraitDefinitions.SubTrait$I@@10) $heap@@2) ($IsAlloc refType $o@@16 Tclass.TraitDefinitions.SuperTrait? $heap@@2))
 :qid |unknown.0:0|
 :skolemid |2283|
 :pattern ( ($IsAlloc refType $o@@16 (Tclass.TraitDefinitions.SubTrait? TraitDefinitions.SubTrait$T@@10 TraitDefinitions.SubTrait$I@@10) $heap@@2))
)))
...
(declare-fun |c#0@@9| () Int)
(declare-fun this () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id OverrideCheck$$All.Y.GetC)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (= TraitDefinitions.SubTrait$T@@11 TInt) (= TraitDefinitions.SubTrait$I@@11 All.Y$I@@10)) (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@17 T@U) ($f T@U) ) (! true
 :qid |traitsdfy.100:12|
 :skolemid |2145|
))) (=> (forall (($o@@18 T@U) ($f@@0 T@U) ) (! true
 :qid |traitsdfy.100:12|
 :skolemid |2145|
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@19 T@U) ($f@@1 T@U) ) (! true
 :qid |traitsdfy.100:12|
 :skolemid |2146|
))) (=> (forall (($o@@20 T@U) ($f@@2 T@U) ) (! true
 :qid |traitsdfy.100:12|
 :skolemid |2146|
)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (forall (($o@@21 T@U) ) (!  (=> (and (or (not (= $o@@21 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@21) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@21) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@21)))
 :qid |traitsdfy.100:12|
 :skolemid |2147|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@21))
)) ($HeapSucc $Heap $Heap@0)) (and (>= |c#0@@9| (LitInt 0)) (= (ControlFlow 0 2) (- 0 1)))) (>= |c#0@@9| (LitInt 0))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass.All.Y All.Y$I@@10)) ($IsAlloc refType this (Tclass.All.Y All.Y$I@@10) $Heap))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 6) 2))) anon0_correct))))
