...
(declare-fun |##_module.CNon.CNon| () T@U)
(declare-fun Tagclass._module.X? () T@U)
(declare-fun Tagclass._module.Int? () T@U)
...
(declare-fun _module.CNon.CNon_q (T@U) Bool)
...
(declare-fun |#_module.CNon.CNon| (T@U) T@U)
(declare-fun $FunctionContextHeight () Int)
(declare-fun _module.CNon.x (T@U T@U) Int)
(declare-fun TagFamily (T@U) T@U)
(declare-fun _module.CNon.y (T@U T@U) T@U)
...
(declare-fun _module.CNon.z (T@U) T@U)
...
(assert (distinct TBool TInt TagBool TagInt TagSeq alloc Tagclass._module.Int Tagclass._module.X Tagclass._module.CNon |##_module.CNon.CNon| Tagclass._module.X? Tagclass._module.Int? tytagFamily$Int tytagFamily$X tytagFamily$CNon)
)
...
(assert (forall ((_module.CNon$T T@U) (d T@U) ) (!  (=> ($Is DatatypeTypeType d (Tclass._module.CNon _module.CNon$T)) (_module.CNon.CNon_q d))
 :pattern ( (_module.CNon.CNon_q d) ($Is DatatypeTypeType d (Tclass._module.CNon _module.CNon$T)))
)))
...
(assert (forall ((d@@0 T@U) ) (! (= (_module.CNon.CNon_q d@@0) (= (DatatypeCtorId d@@0) |##_module.CNon.CNon|))
 :pattern ( (_module.CNon.CNon_q d@@0))
)))
(assert (forall ((x@@3 T@U) (T@@0 T@T) ) (! (= ($Box T@@0 ($Unbox T@@0 x@@3)) x@@3)
 :pattern ( ($Unbox T@@0 x@@3))
)))
(assert (forall ((d@@1 T@U) ) (!  (=> (_module.CNon.CNon_q d@@1) (exists ((|a#1#0#0| T@U) ) (= d@@1 (|#_module.CNon.CNon| |a#1#0#0|))))
 :pattern ( (_module.CNon.CNon_q d@@1))
)))
(assert  (=> (< 0 $FunctionContextHeight) (forall ((_module.CNon$T@@0 T@U) ($h@@4 T@U) ($o@@2 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@4) ($Is DatatypeTypeType $o@@2 (Tclass._module.CNon _module.CNon$T@@0))) ($IsAlloc DatatypeTypeType $o@@2 (Tclass._module.CNon _module.CNon$T@@0) $h@@4)) ($IsAlloc intType (int_2_U (_module.CNon.x _module.CNon$T@@0 $o@@2)) TInt $h@@4))
 :pattern ( (_module.CNon.x _module.CNon$T@@0 $o@@2) ($IsAlloc DatatypeTypeType $o@@2 (Tclass._module.CNon _module.CNon$T@@0) $h@@4))
))))
(assert  (=> (< 0 $FunctionContextHeight) (forall ((_module.CNon$T@@1 T@U) ($o@@3 T@U) ) (!  (=> ($Is DatatypeTypeType $o@@3 (Tclass._module.CNon _module.CNon$T@@1)) ($Is intType (int_2_U (_module.CNon.x _module.CNon$T@@1 $o@@3)) TInt))
 :pattern ( (_module.CNon.x _module.CNon$T@@1 $o@@3))
))))
...
(assert (forall ((_module.CNon$T@@2 T@U) ) (!  (and (= (Tag (Tclass._module.CNon _module.CNon$T@@2)) Tagclass._module.CNon) (= (TagFamily (Tclass._module.CNon _module.CNon$T@@2)) tytagFamily$CNon))
 :pattern ( (Tclass._module.CNon _module.CNon$T@@2))
)))
(assert (= (Ctor SeqType) 8))
(assert  (=> (< 0 $FunctionContextHeight) (forall ((_module.CNon$T@@3 T@U) ($h@@5 T@U) ($o@@4 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@5) ($Is DatatypeTypeType $o@@4 (Tclass._module.CNon _module.CNon$T@@3))) ($IsAlloc DatatypeTypeType $o@@4 (Tclass._module.CNon _module.CNon$T@@3) $h@@5)) ($IsAlloc SeqType (_module.CNon.y _module.CNon$T@@3 $o@@4) (TSeq _module.CNon$T@@3) $h@@5))
 :pattern ( (_module.CNon.y _module.CNon$T@@3 $o@@4) ($IsAlloc DatatypeTypeType $o@@4 (Tclass._module.CNon _module.CNon$T@@3) $h@@5))
))))
...
(assert  (=> (< 0 $FunctionContextHeight) (forall ((_module.CNon$T@@4 T@U) ($o@@5 T@U) ) (!  (=> ($Is DatatypeTypeType $o@@5 (Tclass._module.CNon _module.CNon$T@@4)) ($Is SeqType (_module.CNon.y _module.CNon$T@@4 $o@@5) (TSeq _module.CNon$T@@4)))
 :pattern ( (_module.CNon.y _module.CNon$T@@4 $o@@5))
))))
(assert (forall ((_module.CNon$T@@5 T@U) (|a#2#0#0| T@U) ($h@@6 T@U) ) (!  (=> ($IsGoodHeap $h@@6) (= ($IsAlloc DatatypeTypeType (|#_module.CNon.CNon| |a#2#0#0|) (Tclass._module.CNon _module.CNon$T@@5) $h@@6) ($IsAllocBox |a#2#0#0| _module.CNon$T@@5 $h@@6)))
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.CNon.CNon| |a#2#0#0|) (Tclass._module.CNon _module.CNon$T@@5) $h@@6))
)))
...
(assert (forall ((_module.CNon$T@@6 T@U) ) (! (= (Tclass._module.CNon_0 (Tclass._module.CNon _module.CNon$T@@6)) _module.CNon$T@@6)
 :pattern ( (Tclass._module.CNon _module.CNon$T@@6))
)))
(assert (forall ((|a#0#0#0| T@U) ) (! (= (DatatypeCtorId (|#_module.CNon.CNon| |a#0#0#0|)) |##_module.CNon.CNon|)
 :pattern ( (|#_module.CNon.CNon| |a#0#0#0|))
)))
(assert (forall ((|a#3#0#0| T@U) ) (! (= (_module.CNon.z (|#_module.CNon.CNon| |a#3#0#0|)) |a#3#0#0|)
 :pattern ( (|#_module.CNon.CNon| |a#3#0#0|))
)))
(assert (forall ((x@@4 T@U) (T@@4 T@T) ) (! (= ($Unbox T@@4 ($Box T@@4 x@@4)) x@@4)
 :pattern ( ($Box T@@4 x@@4))
)))
(assert (forall ((_module.CNon$T@@7 T@U) (|a#2#0#0@@0| T@U) ) (! (= ($Is DatatypeTypeType (|#_module.CNon.CNon| |a#2#0#0@@0|) (Tclass._module.CNon _module.CNon$T@@7)) ($IsBox |a#2#0#0@@0| _module.CNon$T@@7))
 :pattern ( ($Is DatatypeTypeType (|#_module.CNon.CNon| |a#2#0#0@@0|) (Tclass._module.CNon _module.CNon$T@@7)))
)))
(assert (forall ((d@@2 T@U) (_module.CNon$T@@8 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (_module.CNon.CNon_q d@@2) ($IsAlloc DatatypeTypeType d@@2 (Tclass._module.CNon _module.CNon$T@@8) $h@@7))) ($IsAllocBox (_module.CNon.z d@@2) _module.CNon$T@@8 $h@@7))
 :pattern ( ($IsAllocBox (_module.CNon.z d@@2) _module.CNon$T@@8 $h@@7))
)))
...
(assert (forall ((_module.CNon$T@@9 T@U) (bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 (Tclass._module.CNon _module.CNon$T@@9)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@8)) bx@@8) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@8) (Tclass._module.CNon _module.CNon$T@@9))))
 :pattern ( ($IsBox bx@@8 (Tclass._module.CNon _module.CNon$T@@9)))
)))
...
)) ($HeapSucc $Heap@0 $Heap@1)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (=> (and (= |a#0@0| (|#_module.CNon.CNon| ($Box refType call1formal@this@0))) (=> |defass#b#0| (and ($Is DatatypeTypeType |b#0@0| (Tclass._module.CNon Tclass._module.Int)) ($IsAlloc DatatypeTypeType |b#0@0| (Tclass._module.CNon Tclass._module.Int) $Heap@1)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (= (ControlFlow 0 2) (- 0 1)) true))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and (=> |defass#i#0| (and ($Is refType |i#0| Tclass._module.Int) ($IsAlloc refType |i#0| Tclass._module.Int $Heap))) true) (and (=> |defass#j#0| (and ($Is refType |j#0| Tclass._module.Int) ($IsAlloc refType |j#0| Tclass._module.Int $Heap))) true)) (and (and (=> |defass#a#0| (and ($Is DatatypeTypeType |a#0| (Tclass._module.CNon Tclass._module.Int)) ($IsAlloc DatatypeTypeType |a#0| (Tclass._module.CNon Tclass._module.Int) $Heap))) true) (and (=> |defass#b#0| (and ($Is DatatypeTypeType |b#0| (Tclass._module.CNon Tclass._module.Int)) ($IsAlloc DatatypeTypeType |b#0| (Tclass._module.CNon Tclass._module.Int) $Heap))) true))) (and (and (and ($Is DatatypeTypeType |s#0| (Tclass._module.CNon TBool)) ($IsAlloc DatatypeTypeType |s#0| (Tclass._module.CNon TBool) $Heap)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 6) 2)))) anon0_correct))))
