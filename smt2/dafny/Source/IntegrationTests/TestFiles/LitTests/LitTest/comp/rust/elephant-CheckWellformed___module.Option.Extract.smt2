...
(assert (distinct TChar TagChar TagSeq alloc Tagclass._module.Option |##_module.Option.Some| |##_module.Option.None| tytagFamily$Option)
)
...
(assert (forall ((bx T@U) ) (!  (=> ($IsBox bx Tclass._module.Option) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx)) bx) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx) Tclass._module.Option)))
 :qid |unknown.0:0|
 :skolemid |479|
 :pattern ( ($IsBox bx Tclass._module.Option))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@0 T@U) ) (!  (=> (or (|_module.Option.IsFailure#canCall| this@@0) (and (< 0 $FunctionContextHeight) ($Is DatatypeTypeType this@@0 Tclass._module.Option))) (= (_module.Option.IsFailure this@@0) (_module.Option.None_q this@@0)))
 :qid |elephantdfy.6:12|
 :skolemid |515|
 :pattern ( (_module.Option.IsFailure this@@0))
))))
(assert (= (Ctor SeqType) 4))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@1 T@U) ) (!  (=> (or (|_module.Option.Extract#canCall| this@@1) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType this@@1 Tclass._module.Option) (not (_module.Option.IsFailure this@@1))))) ($Is SeqType (_module.Option.Extract this@@1) (TSeq TChar)))
 :qid |elephantdfy.10:12|
 :skolemid |522|
 :pattern ( (_module.Option.Extract this@@1))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@2 T@U) ) (!  (=> (or (|_module.Option.Extract#canCall| (Lit DatatypeTypeType this@@2)) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType this@@2 Tclass._module.Option) (not (U_2_bool (Lit boolType (bool_2_U (_module.Option.IsFailure (Lit DatatypeTypeType this@@2))))))))) (= (_module.Option.Extract (Lit DatatypeTypeType this@@2)) (Lit SeqType (_module.Option.value (Lit DatatypeTypeType this@@2)))))
 :qid |elephantdfy.10:12|
 :weight 3
 :skolemid |525|
 :pattern ( (_module.Option.Extract (Lit DatatypeTypeType this@@2)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@3 T@U) ) (!  (=> (or (|_module.Option.IsFailure#canCall| (Lit DatatypeTypeType this@@3)) (and (< 0 $FunctionContextHeight) ($Is DatatypeTypeType this@@3 Tclass._module.Option))) (= (_module.Option.IsFailure (Lit DatatypeTypeType this@@3)) (U_2_bool (Lit boolType (bool_2_U (_module.Option.None_q (Lit DatatypeTypeType this@@3)))))))
 :qid |elephantdfy.6:12|
 :weight 3
 :skolemid |516|
 :pattern ( (_module.Option.IsFailure (Lit DatatypeTypeType this@@3)))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (_module.Option.Some_q this@@4))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) ($IsAllocBox ($Box DatatypeTypeType this@@4) Tclass._module.Option $Heap)) (and (|_module.Option.IsFailure#canCall| this@@4) (not (_module.Option.IsFailure this@@4)))) (and (=> (= (ControlFlow 0 4) 1) anon5_Then_correct) (=> (= (ControlFlow 0 4) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType this@@4 Tclass._module.Option) ($IsAlloc DatatypeTypeType this@@4 Tclass._module.Option $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct))))
