...
(set-info :boogie-vc-id Impl$$_module.__default.SetToSeq__Regression)
...
(let ((anon11_correct  (=> (= |smaller#0@0| (|Set#FromBoogieMap| (|lambda#13| TInt |S#0| |x#0@0|))) (and (=> (= (ControlFlow 0 13) 12) anon22_Then_correct) (=> (= (ControlFlow 0 13) 7) anon22_Else_correct)))))
