...
(assert (distinct TChar TagChar TagSeq alloc Tagclass._module.int32 tytagFamily$int32)
)
...
(assert (forall (($ly@@1 T@U) (|s#0@@1| T@U) ) (! (= (_module.__default.MapToInt32 ($LS $ly@@1) |s#0@@1|) (_module.__default.MapToInt32 $ly@@1 |s#0@@1|))
 :qid |UnicodeStringsdfy.126:10|
 :skolemid |512|
 :pattern ( (_module.__default.MapToInt32 ($LS $ly@@1) |s#0@@1|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) (|s#0@@2| T@U) ) (!  (=> (or (|_module.__default.MapToInt32#canCall| (Lit SeqType |s#0@@2|)) (and (< 1 $FunctionContextHeight) ($Is SeqType |s#0@@2| (TSeq TChar)))) (and (=> (or (not (= (LitInt 0) (|Seq#Length| (Lit SeqType |s#0@@2|)))) (not true)) (|_module.__default.MapToInt32#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |s#0@@2|) (LitInt 1))))) (= (_module.__default.MapToInt32 ($LS $ly@@2) (Lit SeqType |s#0@@2|)) (ite (= (LitInt 0) (|Seq#Length| (Lit SeqType |s#0@@2|))) |Seq#Empty| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (|char#ToInt| ($Unbox charType (|Seq#Index| (Lit SeqType |s#0@@2|) (LitInt 0))))))) (_module.__default.MapToInt32 ($LS $ly@@2) (Lit SeqType (|Seq#Drop| (Lit SeqType |s#0@@2|) (LitInt 1)))))))))
 :qid |UnicodeStringsdfy.126:10|
 :weight 3
 :skolemid |518|
 :pattern ( (_module.__default.MapToInt32 ($LS $ly@@2) (Lit SeqType |s#0@@2|)))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.MapToInt32)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon8_Else_correct  (=> (or (not (= (LitInt 0) (|Seq#Length| |s#0@@3|))) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 8)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s#0@@3|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s#0@@3|))) (=> (= |newtype$check#0@0| (|char#ToInt| ($Unbox charType (|Seq#Index| |s#0@@3| (LitInt 0))))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (and (<= (LitInt (- 0 2147483648)) |newtype$check#0@0|) (< |newtype$check#0@0| 2147483648))) (=> (and (<= (LitInt (- 0 2147483648)) |newtype$check#0@0|) (< |newtype$check#0@0| 2147483648)) (=> (= |newtype$check#1@0| (|char#ToInt| ($Unbox charType (|Seq#Index| |s#0@@3| (LitInt 0))))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (and (<= (LitInt (- 0 2147483648)) |newtype$check#1@0|) (< |newtype$check#1@0| 2147483648))) (=> (and (<= (LitInt (- 0 2147483648)) |newtype$check#1@0|) (< |newtype$check#1@0| 2147483648)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |s#0@@3|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |s#0@@3|))) (=> (= |##s#0@0| (|Seq#Drop| |s#0@@3| (LitInt 1))) (=> (and ($IsAlloc SeqType |##s#0@0| (TSeq TChar) $Heap) (= (ControlFlow 0 4) (- 0 3))) (< (|Seq#Rank| |##s#0@0|) (|Seq#Rank| |s#0@@3|)))))))))))))))))
(let ((anon8_Then_correct true))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#5| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 9) 1) anon7_Then_correct) (=> (= (ControlFlow 0 9) 2) anon8_Then_correct)) (=> (= (ControlFlow 0 9) 4) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is SeqType |s#0@@3| (TSeq TChar))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct)))
