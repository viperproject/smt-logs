...
procedure {:verboseName "ObjectTests.Test (correctness)"} Impl$$ObjectTests.__default.Test() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ObjectTests.Test (correctness)"} Impl$$ObjectTests.__default.Test() returns ($_reverifyPost: bool)
{
  ...
  var ##y#5: ref;
    ...
    // AddMethodImpl: Test, Impl$$ObjectTests.__default.Test
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Comprehensions.dfy(505,14)
    assume true;
    assume true;
    havoc $nw;
    assume $nw != null;
    ...
    p#0 := $rhs#1;
    defass#p#0 := true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Comprehensions.dfy(506,5)
    assert {:id "id32"} defass#o#0;
    assert {:id "id33"} defass#p#0;
    assume true;
    assume true;
    assert {:id "id34"} defass#p#0;
    assert {:id "id35"} defass#p#0;
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Comprehensions.dfy(507,5)
    assert {:id "id36"} defass#o#0;
    ##x#0 := o#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#0, Tclass._System.object(), $Heap);
    assert {:id "id37"} defass#p#0;
    ##y#0 := p#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##y#0, Tclass._System.object(), $Heap);
    assume ObjectTests.__default.GenEqual#canCall(Tclass._System.object(), $Box(o#0), $Box(p#0));
    assume ObjectTests.__default.GenEqual#canCall(Tclass._System.object(), $Box(o#0), $Box(p#0));
    assume true;
    assert {:id "id38"} defass#p#0;
    ##x#1 := p#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#1, Tclass._System.object(), $Heap);
    assert {:id "id39"} defass#p#0;
    ##y#1 := p#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##y#1, Tclass._System.object(), $Heap);
    assume ObjectTests.__default.GenEqual#canCall(Tclass._System.object(), $Box(p#0), $Box(p#0));
    assume ObjectTests.__default.GenEqual#canCall(Tclass._System.object(), $Box(p#0), $Box(p#0));
    assume true;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Comprehensions.dfy(508,22)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id40"} Call$$ObjectTests.__default.AutoInit(Tclass._System.object?());
    // TrCallStmt: After ProcessCallStmt
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Comprehensions.dfy(509,34)
    assume true;
    assume true;
    assert {:id "id41"} defass#o#0;
    assume true;
    $rhs#2 := o#0;
    assert {:id "id43"} defass#p#0;
    assume true;
    $rhs#3 := p#0;
    o'#0 := $rhs#2;
    p'#0 := $rhs#3;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Comprehensions.dfy(510,5)
    ##x#2 := o'#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#2, Tclass._System.object?(), $Heap);
    ##y#2 := p'#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##y#2, Tclass._System.object?(), $Heap);
    assume ObjectTests.__default.GenEqual#canCall(Tclass._System.object?(), $Box(o'#0), $Box(p'#0));
    assume ObjectTests.__default.GenEqual#canCall(Tclass._System.object?(), $Box(o'#0), $Box(p'#0));
    assume true;
    ##x#3 := p'#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#3, Tclass._System.object?(), $Heap);
    ##y#3 := p'#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##y#3, Tclass._System.object?(), $Heap);
    assume ObjectTests.__default.GenEqual#canCall(Tclass._System.object?(), $Box(p'#0), $Box(p'#0));
    assume ObjectTests.__default.GenEqual#canCall(Tclass._System.object?(), $Box(p'#0), $Box(p'#0));
    assume true;
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Comprehensions.dfy(511,12)
    assume true;
    assume true;
    ...
    o'#0 := $rhs#4;
    p'#0 := $rhs#5;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Comprehensions.dfy(512,5)
    ##x#4 := o'#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#4, Tclass._System.object?(), $Heap);
    ##y#4 := p'#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##y#4, Tclass._System.object?(), $Heap);
    assume ObjectTests.__default.GenEqual#canCall(Tclass._System.object?(), $Box(o'#0), $Box(p'#0));
    assume ObjectTests.__default.GenEqual#canCall(Tclass._System.object?(), $Box(o'#0), $Box(p'#0));
    assume true;
    ##x#5 := p'#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#5, Tclass._System.object?(), $Heap);
    ##y#5 := p'#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##y#5, Tclass._System.object?(), $Heap);
    assume ObjectTests.__default.GenEqual#canCall(Tclass._System.object?(), $Box(p'#0), $Box(p'#0));
    assume ObjectTests.__default.GenEqual#canCall(Tclass._System.object?(), $Box(p'#0), $Box(p'#0));
    assume true;
}
...
axiom {:id "id51"} 0 <= $FunctionContextHeight
   ==> (forall ObjectTests._default.GenEqual$X: Ty, x#0: Box, y#0: Box :: 
...
procedure {:verboseName "ObjectTests.GenEqual (well-formedness)"} CheckWellformed$$ObjectTests.__default.GenEqual(ObjectTests._default.GenEqual$X: Ty, 
    x#0: Box where $IsBox(x#0, ObjectTests._default.GenEqual$X), 
    y#0: Box where $IsBox(y#0, ObjectTests._default.GenEqual$X));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "ObjectTests.AutoInit (well-formedness)"} CheckWellFormed$$ObjectTests.__default.AutoInit(ObjectTests._default.AutoInit$X: Ty);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "ObjectTests.AutoInit (call)"} Call$$ObjectTests.__default.AutoInit(ObjectTests._default.AutoInit$X: Ty);
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "ObjectTests.AutoInit (correctness)"} Impl$$ObjectTests.__default.AutoInit(ObjectTests._default.AutoInit$X: Ty) returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
