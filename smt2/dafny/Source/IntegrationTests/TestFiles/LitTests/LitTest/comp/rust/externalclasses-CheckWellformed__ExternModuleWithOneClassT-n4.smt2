...
(set-info :boogie-vc-id CheckWellformed$$ExternModuleWithOneClassToImport.NonShareableBox.GetOpt)
...
(assert (not
 ...
 :qid |externalclassesdfy.77:47|
 :skolemid |2011|
))) (|ExternModuleWithOneClassToImport.NonShareableBox.Get#canCall| $Heap@@2 this@@2))) (and (and (= (ExternModuleWithOneClassToImport.NonShareableBox.GetOpt $Heap@@2 this@@2) (|Seq#Append| (|Seq#Append| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 83))) ($Box charType (|char#FromInt| 111))) ($Box charType (|char#FromInt| 109))) ($Box charType (|char#FromInt| 101))) ($Box charType (|char#FromInt| 40))) (ExternModuleWithOneClassToImport.NonShareableBox.Get $Heap@@2 this@@2)) (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 41))))) (|ExternModuleWithOneClassToImport.NonShareableBox.Get#canCall| $Heap@@2 this@@2)) (and ($Is SeqType (ExternModuleWithOneClassToImport.NonShareableBox.GetOpt $Heap@@2 this@@2) (TSeq TChar)) (= (ExternModuleWithOneClassToImport.NonShareableBox.GetOpt $Heap@@2 this@@2) |o#0|)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (=> (= (ControlFlow 0 5) (- 0 4)) |b$reqreads#1@0|))))))
...
(let ((anon7_Else_correct  (=> ($IsAllocBox ($Box refType this@@2) Tclass.ExternModuleWithOneClassToImport.NonShareableBox? $Heap@@2) (=> (and (= |b$reqreads#0@0| (forall (($o@@7 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@7) alloc)))) (= $o@@7 this@@2)) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@7 $f@@1)))
 :qid |externalclassesdfy.77:10|
 :skolemid |2010|
))) (|ExternModuleWithOneClassToImport.NonShareableBox.Get#canCall| $Heap@@2 this@@2)) (and (=> (= (ControlFlow 0 7) 3) anon8_Then_correct) (=> (= (ControlFlow 0 7) 5) anon8_Else_correct))))))
