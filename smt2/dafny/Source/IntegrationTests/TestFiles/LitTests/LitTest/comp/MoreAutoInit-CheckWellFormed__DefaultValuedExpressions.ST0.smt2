...
(set-info :boogie-vc-id CheckWellFormed$$DefaultValuedExpressions.ST0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon6_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (= (LitInt (Mod 0 (LitInt 5))) (LitInt 0)))))
(let ((anon5_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= (LitInt 5) 0)) (not true)))))
