...
(set-info :boogie-vc-id CheckWellFormed$$_module.xnLong)
...
(let ((anon8_Else_correct  (=> (and (< |x#0| (LitInt (- 0 10))) (= (ControlFlow 0 6) 4)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (<= (LitInt (- 0 10)) |x#0|) (= (ControlFlow 0 5) 4)) anon4_correct)))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt (- 0 10)) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (Lit boolType (bool_2_U (< 0 72057594037927936))))))))
