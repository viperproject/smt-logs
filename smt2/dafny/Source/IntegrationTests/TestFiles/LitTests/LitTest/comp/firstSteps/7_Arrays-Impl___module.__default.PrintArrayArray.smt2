...
(declare-fun _module._default.PrintArrayArray$A () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.PrintArrayArray)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon9_Else_correct  (=> (and (< |i#0@1| (_System.array.Length |a#0|)) (= |$decr$loop#00@1| (- (_System.array.Length |a#0|) |i#0@1|))) (and (=> (= (ControlFlow 0 6) (- 0 10)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 6) (- 0 9)) (and (<= 0 |i#0@1|) (< |i#0@1| (_System.array.Length |a#0|)))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#0@1|))) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#0@1|))) null)) (not true)) (=> (= |i#0@2| (+ |i#0@1| 1)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (<= 0 |$decr$loop#00@1|) (= (- (_System.array.Length |a#0|) |i#0@2|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- (_System.array.Length |a#0|) |i#0@2|) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 6) (- 0 5)) (< (- (_System.array.Length |a#0|) |i#0@2|) |$decr$loop#00@1|)))))))))))))
(let ((anon9_Then_correct true))
(let ((anon8_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 11) (- 0 12)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 11) 4) anon9_Then_correct) (=> (= (ControlFlow 0 11) 6) anon9_Else_correct)))))))
(let ((anon8_Then_correct  (=> (and (not |$w$loop#0@0|) (= (ControlFlow 0 3) (- 0 2))) (or (not (= |a#0| null)) (not true)))))
(let ((anon7_LoopBody_correct  (and (=> (= (ControlFlow 0 13) 3) anon8_Then_correct) (=> (= (ControlFlow 0 13) 11) anon8_Else_correct))))
(let ((anon7_LoopDone_correct true))
(let ((anon7_LoopHead_correct  (=> (and (not false) (<= 0 |i#0@1|)) (=> (and (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6)))
 :qid |_7Arraysdfy.85:3|
 :skolemid |581|
...
)) (<= (- (_System.array.Length |a#0|) |i#0@1|) |$decr_init$loop#00@0|))) (and (=> (= (ControlFlow 0 14) 1) anon7_LoopDone_correct) (=> (= (ControlFlow 0 14) 13) anon7_LoopBody_correct))))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |i#0@0| (LitInt 0))) (and (= |$decr_init$loop#00@0| (- (_System.array.Length |a#0|) |i#0@0|)) (= (ControlFlow 0 15) 14))) anon7_LoopHead_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |a#0| (Tclass._System.array (Tclass._System.array _module._default.PrintArrayArray$A))) ($IsAlloc refType |a#0| (Tclass._System.array (Tclass._System.array _module._default.PrintArrayArray$A)) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 16) 15))) anon0_correct))))
