...
procedure {:verboseName "SimultaneousAssignment.Test (correctness)"} Impl$$SimultaneousAssignment.__default.Test() returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "SimultaneousAssignment.Test (correctness)"} Impl$$SimultaneousAssignment.__default.Test() returns ($_reverifyPost: bool)
{
  ...
  var $rhs#13: ref;
    ...
    // AddMethodImpl: Test, Impl$$SimultaneousAssignment.__default.Test
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(511,13)
    assume true;
    assert {:id "id232"} 0 <= LitInt(250);
    havoc $nw;
    ...
    arr#0 := $nw;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(512,11)
    assume true;
    assert {:id "id234"} 0 <= LitInt(20);
    assert {:id "id235"} 0 <= LitInt(30);
    havoc $nw;
    ...
    assume $IsHeapAnchor($Heap);
    m#0 := $nw;
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(513,18)
    assume true;
    assume true;
    assume true;
    $rhs#0 := arr#0;
    ...
    arr'#0 := $rhs#0;
    m'#0 := $rhs#1;
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(515,17)
    assume true;
    assume true;
    assume true;
    assume true;
    ...
    b#0 := $rhs#3;
    c#0 := $rhs#4;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(516,15)
    assume true;
    assert {:id "id247"} 0 <= LitInt(1);
    havoc $nw;
    assume $nw != null && $Is($nw, Tclass._System.array?(TInt));
    assume !$Unbox(read($Heap, $nw, alloc)): bool;
    ...
    assume $IsHeapAnchor($Heap);
    arr''#0 := $nw;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(517,13)
    assume true;
    assert {:id "id249"} 0 <= LitInt(1);
    assert {:id "id250"} 0 <= LitInt(1);
    havoc $nw;
    assume $nw != null && $Is($nw, Tclass._System.array2?(TInt));
    assume !$Unbox(read($Heap, $nw, alloc)): bool;
    ...
    assume $IsHeapAnchor($Heap);
    m''#0 := $nw;
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(519,50)
    assume true;
    assume true;
    assert {:id "id252"} arr#0 != null;
    assert {:id "id253"} 0 <= a#0 + b#0 && a#0 + b#0 < _System.array.Length(arr#0);
    assume true;
    $obj2 := arr#0;
    $index2 := IndexField(a#0 + b#0);
    assert {:id "id254"} $_ModifiesFrame[$obj2, $index2];
    assume true;
    assume true;
    assume true;
    assert {:id "id255"} m#0 != null;
    assert {:id "id256"} 0 <= a#0 && a#0 < _System.array2.Length0(m#0);
    assert {:id "id257"} 0 <= b#0 && b#0 < _System.array2.Length1(m#0);
    assume true;
    $obj6 := m#0;
    $index6 := MultiIndexField(IndexField(a#0), b#0);
    assert {:id "id258"} $_ModifiesFrame[$obj6, $index6];
    assume true;
    assume true;
    assume true;
    $rhs#5 := arr''#0;
    ...
    assume true;
    $rhs#13 := m''#0;
    assert {:id "id268"} $rhs#9 == $rhs#5;
    assert {:id "id269"} $rhs#13 == $rhs#8;
    arr#0 := $rhs#5;
    a#0 := $rhs#6;
    $Heap := update($Heap, $obj2, $index2, $Box($rhs#7));
    assume $IsGoodHeap($Heap);
    m#0 := $rhs#8;
    arr#0 := $rhs#9;
    c#0 := $rhs#10;
    $Heap := update($Heap, $obj6, $index6, $Box($rhs#11));
    assume $IsGoodHeap($Heap);
    b#0 := $rhs#12;
    m#0 := $rhs#13;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(521,5)
    assume true;
    assume true;
    assume true;
    assume true;
    assume true;
    assume true;
    assert {:id "id279"} arr'#0 != null;
    assert {:id "id280"} {:subsumption 0} 0 <= LitInt(46) && LitInt(46) < _System.array.Length(arr'#0);
    assume true;
    assume true;
    assert {:id "id281"} m'#0 != null;
    assert {:id "id282"} {:subsumption 0} 0 <= LitInt(18) && LitInt(18) < _System.array2.Length0(m'#0);
    assert {:id "id283"} {:subsumption 0} 0 <= LitInt(28) && LitInt(28) < _System.array2.Length1(m'#0);
    assume true;
    assume true;
}
