...
(assert (distinct TInt TagInt TagSet alloc Tagclass._System.nat Tagclass._System.object? Tagclass._System.object Tagclass._System.array2? Tagclass._System.array2 Tagclass._System.___hFunc2 tytagFamily$nat tytagFamily$object tytagFamily$array2 |tytagFamily$_#Func2|)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|$l#0#heap#0| T@U) (|$l#0#x#0| T@U) (|$l#0#y#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType boolType (|lambda#20| |l#0| |l#1|) |$l#0#heap#0| |$l#0#x#0| |$l#0#y#0|))  (and ($IsBox |$l#0#x#0| |l#0|) ($IsBox |$l#0#y#0| |l#1|)))
 :qid |unknown.0:0|
 :skolemid |7833|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType boolType (|lambda#20| |l#0| |l#1|) |$l#0#heap#0| |$l#0#x#0| |$l#0#y#0|))
)))
...
(assert (forall ((|l#0@@0| T@U) (|l#1@@0| T@U) (|$l#0#heap#0@@0| T@U) (|$l#0#x#0@@0| T@U) (|$l#0#y#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType BoxType (|lambda#19| |l#0@@0| |l#1@@0|) |$l#0#heap#0@@0| |$l#0#x#0@@0| |$l#0#y#0@@0|) (ite (= (U_2_int ($Unbox intType |$l#0#x#0@@0|)) (U_2_int ($Unbox intType |$l#0#y#0@@0|))) |l#0@@0| |l#1@@0|))
 :qid |Arraysdfy.110:53|
 :skolemid |7832|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType BoxType (|lambda#19| |l#0@@0| |l#1@@0|) |$l#0#heap#0@@0| |$l#0#x#0@@0| |$l#0#y#0@@0|))
)))
...
(assert (forall ((v@@3 T@U) (t0@@8 T@U) (h@@8 T@U) ) (! (= ($IsAlloc SetType v@@3 (TSet t0@@8) h@@8) (forall ((bx@@8 T@U) ) (!  (=> (|Set#IsMember| v@@3 bx@@8) ($IsAllocBox bx@@8 t0@@8 h@@8))
...
(assert (forall ((|l#0@@3| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#x#0@@1| T@U) (|$l#0#y#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType SetType (|lambda#22| |l#0@@3|) |$l#0#heap#0@@1| |$l#0#x#0@@1| |$l#0#y#0@@1|) |l#0@@3|)
 :qid |Arraysdfy.114:28|
 :skolemid |7834|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType SetType (|lambda#22| |l#0@@3|) |$l#0#heap#0@@1| |$l#0#x#0@@1| |$l#0#y#0@@1|))
)))
...
(assert (forall ((f@@6 T@U) (t0@@10 T@U) (t1@@8 T@U) (t2@@7 T@U) (u0@@3 T@U) (u1@@3 T@U) (u2@@2 T@U) ) (!  (=> (and (and (and ($Is HandleTypeType f@@6 (Tclass._System.___hFunc2 t0@@10 t1@@8 t2@@7)) (forall ((bx@@9 T@U) ) (!  (=> ($IsBox bx@@9 u0@@3) ($IsBox bx@@9 t0@@10))
 :qid |unknown.0:0|
 :skolemid |7290|
...
(declare-fun _module._default.DiagMatrix$A () T@U)
(declare-fun |one#0| () T@U)
(declare-fun |$_Frame#l0@0| () T@U)
(declare-fun |$lambdaHeap#0@0| () T@U)
(declare-fun $Heap () T@U)
(declare-fun $nw@0 () T@U)
(declare-fun |rows#0| () Int)
(declare-fun |cols#0| () Int)
(declare-fun $LZ () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |a#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.DiagMatrix)
...
(let ((anon9_Else_correct  (=> (and (and (or (not (= |x#0@0| |y#0@0|)) (not true)) (= |lambdaResult#0| |zero#0|)) (and ($IsBox |lambdaResult#0| _module._default.DiagMatrix$A) (= (ControlFlow 0 6) 3))) anon5_correct)))
(let ((anon9_Then_correct  (=> (and (and (= |x#0@0| |y#0@0|) (= |lambdaResult#0| |one#0|)) (and ($IsBox |lambdaResult#0| _module._default.DiagMatrix$A) (= (ControlFlow 0 5) 3))) anon5_correct)))
(let ((anon8_Then_correct  (=> (and (<= (LitInt 0) |x#0@0|) (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false))) (and (=> (= (ControlFlow 0 7) 5) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (< |x#0@0| (LitInt 0)) (= (ControlFlow 0 4) 3)) anon5_correct)))
(let ((anon7_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 8) 7) anon8_Then_correct) (=> (= (ControlFlow 0 8) 4) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array2? _module._default.DiagMatrix$A))) (=> (and (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc)))) (= (_System.array2.Length0 $nw@0) |rows#0|)) (and (= (_System.array2.Length1 $nw@0) |cols#0|) (= (ControlFlow 0 2) (- 0 1)))) (forall ((|arrayinit#0#i0#0| Int) (|arrayinit#0#i1#0| Int) ) (!  (=> (and (and (<= 0 |arrayinit#0#i0#0|) (< |arrayinit#0#i0#0| |rows#0|)) (and (<= 0 |arrayinit#0#i1#0|) (< |arrayinit#0#i1#0| |cols#0|))) (Requires2 Tclass._System.nat TInt _module._default.DiagMatrix$A $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#9| (Handle2 (|lambda#19| |one#0| |zero#0|) (|lambda#20| Tclass._System.nat TInt) (|lambda#22| (SetRef_to_SetBox (|lambda#7| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0|)) ($Box intType (int_2_U |arrayinit#0#i1#0|))))
 :qid |Arraysdfy.114:10|
 :skolemid |7522|
))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (<= 0 |rows#0|)) (=> (<= 0 |rows#0|) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= 0 |cols#0|)) (=> (<= 0 |cols#0|) (and (=> (= (ControlFlow 0 9) 8) anon7_Then_correct) (=> (= (ControlFlow 0 9) 2) anon7_Else_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($IsBox |zero#0| _module._default.DiagMatrix$A) ($IsAllocBox |zero#0| _module._default.DiagMatrix$A $Heap))) (=> (and (and (and ($IsBox |one#0| _module._default.DiagMatrix$A) ($IsAllocBox |one#0| _module._default.DiagMatrix$A $Heap)) (and ($Is refType |a#0| (Tclass._System.array2 _module._default.DiagMatrix$A)) ($IsAlloc refType |a#0| (Tclass._System.array2 _module._default.DiagMatrix$A) $Heap))) (and (and (= 0 $FunctionContextHeight) (>= |rows#0| (LitInt 0))) (and (>= |cols#0| (LitInt 0)) (= (ControlFlow 0 12) 9)))) anon0_correct))))
