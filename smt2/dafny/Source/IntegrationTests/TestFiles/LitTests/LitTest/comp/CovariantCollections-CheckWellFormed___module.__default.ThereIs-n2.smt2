...
(let ((anon5_Else_correct  (=> (and (=> (> (|MultiSet#Multiplicity| |s#0| ($Box refType |y#0@0|)) 0) (<= (_module.Number.value |m#0@0|) (_module.Number.value |y#0@0|))) (= (ControlFlow 0 5) 1)) anon4_correct)))
(let ((anon5_Then_correct  (=> (> (|MultiSet#Multiplicity| |s#0| ($Box refType |y#0@0|)) 0) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |m#0@0| null)) (not true))) (=> (or (not (= |m#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |y#0@0| null)) (not true))) (=> (or (not (= |y#0@0| null)) (not true)) (=> (and (<= (_module.Number.value |m#0@0|) (_module.Number.value |y#0@0|)) (= (ControlFlow 0 2) 1)) anon4_correct))))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (not (|MultiSet#Equal| |s#0| |MultiSet#Empty|))) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (=> (and (and (and ($Is refType |m#0@0| Tclass._module.Number) ($IsAlloc refType |m#0@0| Tclass._module.Number $Heap@0)) (> (|MultiSet#Multiplicity| |s#0| ($Box refType |m#0@0|)) 0)) (and ($Is refType |y#0@0| Tclass._module.Number) ($IsAlloc refType |y#0@0| Tclass._module.Number $Heap@0))) (and (=> (= (ControlFlow 0 6) 2) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is MultiSetType |s#0| (TMultiSet Tclass._module.Number)) ($IsAlloc MultiSetType |s#0| (TMultiSet Tclass._module.Number) $Heap))) (and (and ($Is refType |m#0| Tclass._module.Number) ($IsAlloc refType |m#0| Tclass._module.Number $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 7) 6)))) anon0_correct)))
