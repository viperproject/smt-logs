...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@16 T@U) ($f@@0 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#1| |l#0| |l#1| |l#2| |l#3|) $o@@16 $f@@0))  (=> (and (or (not (= $o@@16 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@16) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |4796|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#1| |l#0| |l#1| |l#2| |l#3|) $o@@16 $f@@0))
)))
(assert (forall ((Stacks.Stack$T@@16 T@U) ($h@@18 T@U) ($o@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (or (not (= $o@@17 null)) (not true)) (= (dtype $o@@17) (Tclass.Stacks.Stack? Stacks.Stack$T@@16)))) ($Is SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@17) Stacks.Stack.Elements)) (TSeq Stacks.Stack$T@@16)))
 :qid |unknown.0:0|
 :skolemid |612|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@17) Stacks.Stack.Elements)) (Tclass.Stacks.Stack? Stacks.Stack$T@@16))
)))
...
(assert (forall ((Stacks.Stack$T@@19 T@U) ($h@@19 T@U) ($o@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (or (not (= $o@@18 null)) (not true)) (= (dtype $o@@18) (Tclass.Stacks.Stack? Stacks.Stack$T@@19)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@18) Stacks.Stack.arr)) (Tclass._System.array (Tclass.Stacks.MaybeInitialized Stacks.Stack$T@@19))))
 :qid |unknown.0:0|
 :skolemid |625|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@18) Stacks.Stack.arr)) (Tclass.Stacks.Stack? Stacks.Stack$T@@19))
)))
...
(declare-fun $Heap@1 () T@U)
(set-info :boogie-vc-id Impl$$Stacks.Stack.__ctor)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@1 alloc false)) (= |$rhs#0@0| (Lit SeqType |Seq#Empty|))) (and (=> (= (ControlFlow 0 2) (- 0 11)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (= |$rhs#1@0| (LitInt 0)) (and (=> (= (ControlFlow 0 2) (- 0 10)) (<= 0 (LitInt 20))) (=> (<= 0 (LitInt 20)) (=> (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? (Tclass.Stacks.MaybeInitialized Stacks.Stack$T@@20)))) (=> (and (and (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0) alloc)))) (= (_System.array.Length $nw@0) (LitInt 20))) (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0) alloc ($Box boolType (bool_2_U true))))) ($IsGoodHeap $Heap@0))) (and (and ($IsHeapAnchor $Heap@0) (= this.Repr@0 (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType this@@2)) ($Box refType $nw@0)))) (and (or (not (= this@@2 null)) (not true)) ($Is refType this@@2 (Tclass.Stacks.Stack? Stacks.Stack$T@@20))))) (and (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) alloc)))) (= ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Stacks.Stack.Repr)) this.Repr@0)) (and (= ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Stacks.Stack.Elements)) |$rhs#0@0|) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Stacks.Stack.arr)) $nw@0))) (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) Stacks.Stack.n))) |$rhs#1@0|) (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 this@@2 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|Stacks.Stack.Valid#canCall| Stacks.Stack$T@@20 $Heap@1 this@@2) (or (Stacks.Stack.Valid Stacks.Stack$T@@20 $Heap@1 this@@2) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.Repr)) ($Box refType this@@2))))) (=> (=> (|Stacks.Stack.Valid#canCall| Stacks.Stack$T@@20 $Heap@1 this@@2) (or (Stacks.Stack.Valid Stacks.Stack$T@@20 $Heap@1 this@@2) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.Repr)) ($Box refType this@@2)))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|Stacks.Stack.Valid#canCall| Stacks.Stack$T@@20 $Heap@1 this@@2) (or (Stacks.Stack.Valid Stacks.Stack$T@@20 $Heap@1 this@@2) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.arr))))) (=> (=> (|Stacks.Stack.Valid#canCall| Stacks.Stack$T@@20 $Heap@1 this@@2) (or (Stacks.Stack.Valid Stacks.Stack$T@@20 $Heap@1 this@@2) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.arr)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|Stacks.Stack.Valid#canCall| Stacks.Stack$T@@20 $Heap@1 this@@2) (or (Stacks.Stack.Valid Stacks.Stack$T@@20 $Heap@1 this@@2) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.n))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.Elements))))))) (=> (=> (|Stacks.Stack.Valid#canCall| Stacks.Stack$T@@20 $Heap@1 this@@2) (or (Stacks.Stack.Valid Stacks.Stack$T@@20 $Heap@1 this@@2) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.n))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.Elements)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|Stacks.Stack.Valid#canCall| Stacks.Stack$T@@20 $Heap@1 this@@2) (or (Stacks.Stack.Valid Stacks.Stack$T@@20 $Heap@1 this@@2) (<= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.Elements))) (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.arr))))))) (=> (=> (|Stacks.Stack.Valid#canCall| Stacks.Stack$T@@20 $Heap@1 this@@2) (or (Stacks.Stack.Valid Stacks.Stack$T@@20 $Heap@1 this@@2) (<= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.Elements))) (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.arr)))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|Stacks.Stack.Valid#canCall| Stacks.Stack$T@@20 $Heap@1 this@@2) (or (Stacks.Stack.Valid Stacks.Stack$T@@20 $Heap@1 this@@2) (or (not (= (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.arr))) 0)) (not true))))) (=> (=> (|Stacks.Stack.Valid#canCall| Stacks.Stack$T@@20 $Heap@1 this@@2) (or (Stacks.Stack.Valid Stacks.Stack$T@@20 $Heap@1 this@@2) (or (not (= (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.arr))) 0)) (not true)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|Stacks.Stack.Valid#canCall| Stacks.Stack$T@@20 $Heap@1 this@@2) (or (Stacks.Stack.Valid Stacks.Stack$T@@20 $Heap@1 this@@2) (forall ((|i#1| Int) ) (!  (and (=> (and (<= (LitInt 0) |i#1|) (< |i#1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.n))))) (Stacks.MaybeInitialized.Initialized_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.arr))) (IndexField |i#1|))))) (=> (and (<= (LitInt 0) |i#1|) (< |i#1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.n))))) (= (Stacks.MaybeInitialized.value ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.arr))) (IndexField |i#1|)))) (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.Elements)) |i#1|))))
 :qid |Uninitializeddfy.24:14|
 :skolemid |641|
 :pattern ( (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.Elements)) |i#1|))
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.arr))) (IndexField |i#1|))))
))))) (=> (=> (|Stacks.Stack.Valid#canCall| Stacks.Stack$T@@20 $Heap@1 this@@2) (or (Stacks.Stack.Valid Stacks.Stack$T@@20 $Heap@1 this@@2) (forall ((|i#1@@0| Int) ) (!  (and (=> (and (<= (LitInt 0) |i#1@@0|) (< |i#1@@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.n))))) (Stacks.MaybeInitialized.Initialized_q ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.arr))) (IndexField |i#1@@0|))))) (=> (and (<= (LitInt 0) |i#1@@0|) (< |i#1@@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.n))))) (= (Stacks.MaybeInitialized.value ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.arr))) (IndexField |i#1@@0|)))) (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.Elements)) |i#1@@0|))))
 :qid |Uninitializeddfy.24:14|
 :skolemid |641|
 :pattern ( (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.Elements)) |i#1@@0|))
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.arr))) (IndexField |i#1@@0|))))
)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (forall (($o@@19 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.Repr)) ($Box refType $o@@19)) (or (not (= $o@@19 null)) (not true)))
 :qid |Uninitializeddfy.32:26|
 :skolemid |643|
 ...
 :qid |Uninitializeddfy.32:26|
 :skolemid |644|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.Repr)) ($Box refType $o@@20)))
)))) (=> (and (forall (($o@@21 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.Repr)) ($Box refType $o@@21)) (or (not (= $o@@21 null)) (not true)))
 :qid |Uninitializeddfy.32:26|
 :skolemid |643|
 ...
 :qid |Uninitializeddfy.32:26|
 :skolemid |644|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.Repr)) ($Box refType $o@@22)))
))) (=> (= (ControlFlow 0 2) (- 0 1)) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) Stacks.Stack.Elements)) |Seq#Empty|))))))))))))))))))))))))))
