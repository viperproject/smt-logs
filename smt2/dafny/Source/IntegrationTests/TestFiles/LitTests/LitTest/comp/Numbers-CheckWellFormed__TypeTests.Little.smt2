...
(set-info :boogie-vc-id CheckWellFormed$$TypeTests.Little)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon6_Then_correct  (=> (= |newtype$check#2@0| (LitInt 0)) (and (=> (= (ControlFlow 0 9) (- 0 13)) (and (and (<= (LitInt 0) |newtype$check#2@0|) (< |newtype$check#2@0| 10000)) (or (not (= |newtype$check#2@0| 22)) (not true)))) (=> (and (and (<= (LitInt 0) |newtype$check#2@0|) (< |newtype$check#2@0| 10000)) (or (not (= |newtype$check#2@0| 22)) (not true))) (and (=> (= (ControlFlow 0 9) (- 0 12)) (or (not (= |newtype$check#2@0| 10)) (not true))) (=> (or (not (= |newtype$check#2@0| 10)) (not true)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (and (or (not (= |newtype$check#2@0| 34)) (not true)) (= (|Seq#Length| (Lit SeqType (TypeTests.__default.EmptySequence TBool))) (|Seq#Length| (Lit SeqType (TypeTests.__default.EmptySequence TChar)))))) (=> (and (or (not (= |newtype$check#2@0| 34)) (not true)) (= (|Seq#Length| (Lit SeqType (TypeTests.__default.EmptySequence TBool))) (|Seq#Length| (Lit SeqType (TypeTests.__default.EmptySequence TChar))))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (U_2_bool (Lit boolType (bool_2_U (< 0 200))))) (=> (= (ControlFlow 0 9) (- 0 8)) (U_2_bool (Lit boolType (bool_2_U  (or (not (= 0 16)) (not true))))))))))))))))
(let ((anon5_Then_correct  (=> (and (and (and (and (and (<= (LitInt 0) |z#0|) (< |z#0| 10000)) (or (not (= |z#0| 22)) (not true))) (or (not (= |z#0| 10)) (not true))) (and (or (not (= |z#0| 34)) (not true)) (= (|Seq#Length| (Lit SeqType (TypeTests.__default.EmptySequence TBool))) (|Seq#Length| (Lit SeqType (TypeTests.__default.EmptySequence TChar)))))) (= |newtype$check#0@0| (LitInt 200))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (and (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 10000)) (or (not (= |newtype$check#0@0| 22)) (not true)))) (=> (and (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 10000)) (or (not (= |newtype$check#0@0| 22)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= |newtype$check#0@0| 10)) (not true))) (=> (or (not (= |newtype$check#0@0| 10)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (or (not (= |newtype$check#0@0| 34)) (not true)) (= (|Seq#Length| (Lit SeqType (TypeTests.__default.EmptySequence TBool))) (|Seq#Length| (Lit SeqType (TypeTests.__default.EmptySequence TChar)))))) (=> (and (or (not (= |newtype$check#0@0| 34)) (not true)) (= (|Seq#Length| (Lit SeqType (TypeTests.__default.EmptySequence TBool))) (|Seq#Length| (Lit SeqType (TypeTests.__default.EmptySequence TChar))))) (=> (and (< |z#0| 200) (= |newtype$check#1@0| (LitInt 16))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 10000)) (or (not (= |newtype$check#1@0| 22)) (not true)))) (=> (and (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 10000)) (or (not (= |newtype$check#1@0| 22)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |newtype$check#1@0| 10)) (not true))) (=> (or (not (= |newtype$check#1@0| 10)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) (and (or (not (= |newtype$check#1@0| 34)) (not true)) (= (|Seq#Length| (Lit SeqType (TypeTests.__default.EmptySequence TBool))) (|Seq#Length| (Lit SeqType (TypeTests.__default.EmptySequence TChar))))))))))))))))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (and (=> (= (ControlFlow 0 14) 2) anon5_Then_correct) (=> (= (ControlFlow 0 14) 9) anon6_Then_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 15) 14))) anon0_correct)))
