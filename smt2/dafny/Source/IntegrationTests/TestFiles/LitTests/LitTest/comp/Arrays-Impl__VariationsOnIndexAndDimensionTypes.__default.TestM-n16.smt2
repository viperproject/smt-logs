...
(assert (forall ((t0@@9 T@U) (t1@@9 T@U) (t2@@8 T@U) (t3@@7 T@U) (h0@@1 T@U) (h1@@1 T@U) (f@@10 T@U) (bx0@@6 T@U) (bx1@@6 T@U) (bx2@@6 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@1 h1@@1) (and ($IsGoodHeap h0@@1) ($IsGoodHeap h1@@1))) (and (and (and ($IsBox bx0@@6 t0@@9) ($IsBox bx1@@6 t1@@9)) ($IsBox bx2@@6 t2@@8)) ($Is HandleTypeType f@@10 (Tclass._System.___hFunc3 t0@@9 t1@@9 t2@@8 t3@@7)))) (forall ((o@@7 T@U) (fld@@1 T@U) )  (=> (and (or (not (= o@@7 null)) (not true)) (|Set#IsMember| (Reads3 t0@@9 t1@@9 t2@@8 t3@@7 h0@@1 f@@10 bx0@@6 bx1@@6 bx2@@6) ($Box refType o@@7))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@1 o@@7) fld@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@1 o@@7) fld@@1))))) (= (Reads3 t0@@9 t1@@9 t2@@8 t3@@7 h0@@1 f@@10 bx0@@6 bx1@@6 bx2@@6) (Reads3 t0@@9 t1@@9 t2@@8 t3@@7 h1@@1 f@@10 bx0@@6 bx1@@6 bx2@@6)))
 :pattern ( ($HeapSucc h0@@1 h1@@1) (Reads3 t0@@9 t1@@9 t2@@8 t3@@7 h1@@1 f@@10 bx0@@6 bx1@@6 bx2@@6))
)))
(assert (forall ((t0@@10 T@U) (t1@@10 T@U) (t2@@9 T@U) (t3@@8 T@U) (h0@@2 T@U) (h1@@2 T@U) (f@@11 T@U) (bx0@@7 T@U) (bx1@@7 T@U) (bx2@@7 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@2 h1@@2) (and ($IsGoodHeap h0@@2) ($IsGoodHeap h1@@2))) (and (and (and ($IsBox bx0@@7 t0@@10) ($IsBox bx1@@7 t1@@10)) ($IsBox bx2@@7 t2@@9)) ($Is HandleTypeType f@@11 (Tclass._System.___hFunc3 t0@@10 t1@@10 t2@@9 t3@@8)))) (forall ((o@@8 T@U) (fld@@2 T@U) )  (=> (and (or (not (= o@@8 null)) (not true)) (|Set#IsMember| (Reads3 t0@@10 t1@@10 t2@@9 t3@@8 h1@@2 f@@11 bx0@@7 bx1@@7 bx2@@7) ($Box refType o@@8))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@2 o@@8) fld@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@2 o@@8) fld@@2))))) (= (Reads3 t0@@10 t1@@10 t2@@9 t3@@8 h0@@2 f@@11 bx0@@7 bx1@@7 bx2@@7) (Reads3 t0@@10 t1@@10 t2@@9 t3@@8 h1@@2 f@@11 bx0@@7 bx1@@7 bx2@@7)))
 :pattern ( ($HeapSucc h0@@2 h1@@2) (Reads3 t0@@10 t1@@10 t2@@9 t3@@8 h1@@2 f@@11 bx0@@7 bx1@@7 bx2@@7))
)))
(assert (forall ((t0@@11 T@U) (t1@@11 T@U) (t2@@10 T@U) (t3@@9 T@U) (h0@@3 T@U) (h1@@3 T@U) (f@@12 T@U) (bx0@@8 T@U) (bx1@@8 T@U) (bx2@@8 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@3 h1@@3) (and ($IsGoodHeap h0@@3) ($IsGoodHeap h1@@3))) (and (and (and ($IsBox bx0@@8 t0@@11) ($IsBox bx1@@8 t1@@11)) ($IsBox bx2@@8 t2@@10)) ($Is HandleTypeType f@@12 (Tclass._System.___hFunc3 t0@@11 t1@@11 t2@@10 t3@@9)))) (forall ((o@@9 T@U) (fld@@3 T@U) )  (=> (and (or (not (= o@@9 null)) (not true)) (|Set#IsMember| (Reads3 t0@@11 t1@@11 t2@@10 t3@@9 h0@@3 f@@12 bx0@@8 bx1@@8 bx2@@8) ($Box refType o@@9))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@3 o@@9) fld@@3) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@3 o@@9) fld@@3))))) (= (Apply3 t0@@11 t1@@11 t2@@10 t3@@9 h0@@3 f@@12 bx0@@8 bx1@@8 bx2@@8) (Apply3 t0@@11 t1@@11 t2@@10 t3@@9 h1@@3 f@@12 bx0@@8 bx1@@8 bx2@@8)))
 :pattern ( ($HeapSucc h0@@3 h1@@3) (Apply3 t0@@11 t1@@11 t2@@10 t3@@9 h1@@3 f@@12 bx0@@8 bx1@@8 bx2@@8))
)))
(assert (forall ((t0@@12 T@U) (t1@@12 T@U) (t2@@11 T@U) (t3@@10 T@U) (h0@@4 T@U) (h1@@4 T@U) (f@@13 T@U) (bx0@@9 T@U) (bx1@@9 T@U) (bx2@@9 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@4 h1@@4) (and ($IsGoodHeap h0@@4) ($IsGoodHeap h1@@4))) (and (and (and ($IsBox bx0@@9 t0@@12) ($IsBox bx1@@9 t1@@12)) ($IsBox bx2@@9 t2@@11)) ($Is HandleTypeType f@@13 (Tclass._System.___hFunc3 t0@@12 t1@@12 t2@@11 t3@@10)))) (forall ((o@@10 T@U) (fld@@4 T@U) )  (=> (and (or (not (= o@@10 null)) (not true)) (|Set#IsMember| (Reads3 t0@@12 t1@@12 t2@@11 t3@@10 h1@@4 f@@13 bx0@@9 bx1@@9 bx2@@9) ($Box refType o@@10))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@4 o@@10) fld@@4) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@4 o@@10) fld@@4))))) (= (Apply3 t0@@12 t1@@12 t2@@11 t3@@10 h0@@4 f@@13 bx0@@9 bx1@@9 bx2@@9) (Apply3 t0@@12 t1@@12 t2@@11 t3@@10 h1@@4 f@@13 bx0@@9 bx1@@9 bx2@@9)))
