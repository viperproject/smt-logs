...
(assert (distinct alloc Tagclass.ExternModuleWithOneClassToImport.TraitDefinedInModule? Tagclass.ExternModuleWithOneClassToImport.TraitDefinedInModule Tagclass.ExternModuleWithOneClassToImport.NonShareableBox? Tagclass.ExternModuleWithOneClassToImport.NonShareableBox tytagFamily$TraitDefinedInModule tytagFamily$NonShareableBox)
)
...
(assert (forall ((|c#0| T@U) ($h T@U) ) (! (= ($IsAlloc refType |c#0| Tclass.ExternModuleWithOneClassToImport.TraitDefinedInModule $h) ($IsAlloc refType |c#0| Tclass.ExternModuleWithOneClassToImport.TraitDefinedInModule? $h))
 :qid |unknown.0:0|
 :skolemid |1987|
 :pattern ( ($IsAlloc refType |c#0| Tclass.ExternModuleWithOneClassToImport.TraitDefinedInModule $h))
 :pattern ( ($IsAlloc refType |c#0| Tclass.ExternModuleWithOneClassToImport.TraitDefinedInModule? $h))
)))
(assert (forall ((|c#0@@0| T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType |c#0@@0| Tclass.ExternModuleWithOneClassToImport.NonShareableBox $h@@0) ($IsAlloc refType |c#0@@0| Tclass.ExternModuleWithOneClassToImport.NonShareableBox? $h@@0))
 :qid |unknown.0:0|
 :skolemid |2013|
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass.ExternModuleWithOneClassToImport.NonShareableBox $h@@0))
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass.ExternModuleWithOneClassToImport.NonShareableBox? $h@@0))
)))
...
(assert (forall (($o@@0 T@U) ($h@@1 T@U) ) (! (= ($IsAlloc refType $o@@0 Tclass.ExternModuleWithOneClassToImport.TraitDefinedInModule? $h@@1)  (or (= $o@@0 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@1 $o@@0) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1978|
 :pattern ( ($IsAlloc refType $o@@0 Tclass.ExternModuleWithOneClassToImport.TraitDefinedInModule? $h@@1))
)))
(assert (forall (($o@@1 T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType $o@@1 Tclass.ExternModuleWithOneClassToImport.NonShareableBox? $h@@2)  (or (= $o@@1 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@1) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1990|
 :pattern ( ($IsAlloc refType $o@@1 Tclass.ExternModuleWithOneClassToImport.NonShareableBox? $h@@2))
)))
...
(declare-fun NonShareableBox_$_ReadsFrame@0 () T@U)
(declare-fun $Heap () T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id OverrideCheck$$ExternModuleWithOneClassToImport.NonShareableBox.Get)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType this)) (|Set#UnionOne| |Set#Empty| ($Box refType this)))) (=> (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType this)) (|Set#UnionOne| |Set#Empty| ($Box refType this))) (=> (and (= NonShareableBox_$_ReadsFrame@0 (|lambda#0| null $Heap alloc this)) (= (ControlFlow 0 2) (- 0 1))) (forall (($o@@6 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (= $o@@6 this)) (= $o@@6 this))
 :qid |externalclassesdfy.67:24|
 :skolemid |1999|
)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass.ExternModuleWithOneClassToImport.NonShareableBox) ($IsAlloc refType this Tclass.ExternModuleWithOneClassToImport.NonShareableBox $Heap))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
