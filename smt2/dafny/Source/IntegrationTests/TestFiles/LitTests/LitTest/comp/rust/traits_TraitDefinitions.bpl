...
axiom (forall a#12#0#0: Box :: 
  { #TraitDefinitions.Option.Some(a#12#0#0) } 
  DatatypeCtorId(#TraitDefinitions.Option.Some(a#12#0#0))
...
axiom (forall d: DatatypeType :: 
  { TraitDefinitions.Option.Some_q(d) } 
  TraitDefinitions.Option.Some_q(d)
     ==> (exists a#13#0#0: Box :: d == #TraitDefinitions.Option.Some(a#13#0#0)));
...
// Constructor $Is
axiom (forall TraitDefinitions.Option$T: Ty, a#14#0#0: Box :: 
  { $Is(#TraitDefinitions.Option.Some(a#14#0#0), 
      Tclass.TraitDefinitions.Option(TraitDefinitions.Option$T)) } 
  $Is(#TraitDefinitions.Option.Some(a#14#0#0), 
      Tclass.TraitDefinitions.Option(TraitDefinitions.Option$T))
     <==> $IsBox(a#14#0#0, TraitDefinitions.Option$T));

// Constructor $IsAlloc
axiom (forall TraitDefinitions.Option$T: Ty, a#14#0#0: Box, $h: Heap :: 
  { $IsAlloc(#TraitDefinitions.Option.Some(a#14#0#0), 
      Tclass.TraitDefinitions.Option(TraitDefinitions.Option$T), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#TraitDefinitions.Option.Some(a#14#0#0), 
        Tclass.TraitDefinitions.Option(TraitDefinitions.Option$T), 
        $h)
       <==> $IsAllocBox(a#14#0#0, TraitDefinitions.Option$T, $h)));
...
axiom (forall a#15#0#0: Box :: 
  { #TraitDefinitions.Option.Some(Lit(a#15#0#0)) } 
  #TraitDefinitions.Option.Some(Lit(a#15#0#0))
     == Lit(#TraitDefinitions.Option.Some(a#15#0#0)));

function TraitDefinitions.Option.value(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#16#0#0: Box :: 
  { #TraitDefinitions.Option.Some(a#16#0#0) } 
  TraitDefinitions.Option.value(#TraitDefinitions.Option.Some(a#16#0#0))
     == a#16#0#0);

// Inductive rank
axiom (forall a#17#0#0: Box :: 
  { #TraitDefinitions.Option.Some(a#17#0#0) } 
  BoxRank(a#17#0#0) < DtRank(#TraitDefinitions.Option.Some(a#17#0#0)));
...
axiom 1 <= $FunctionContextHeight
   ==> (forall TraitDefinitions.Option$T: Ty, this: DatatypeType, t#0: Box :: 
...
axiom 1 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, TraitDefinitions.Option$T: Ty, this: DatatypeType, t#0: Box :: 
    ...
    TraitDefinitions.Option.Negate#canCall(TraitDefinitions.Option$T, this, t#0)
       ...
       ==> TraitDefinitions.Option.Negate(TraitDefinitions.Option$T, this, t#0)
         == (if TraitDefinitions.Option.Some_q(this)
           then (var v#0 := TraitDefinitions.Option.value(this); 
    ...
    TraitDefinitions.Option.Negate#canCall(TraitDefinitions.Option$T, Lit(this), t#0)
       ...
       ==> TraitDefinitions.Option.Negate(TraitDefinitions.Option$T, Lit(this), t#0)
         == (if TraitDefinitions.Option.Some_q(Lit(this))
           then (var v#2 := Lit(TraitDefinitions.Option.value(Lit(this))); 
            Lit(#TraitDefinitions.Option.None()))
           else #TraitDefinitions.Option.Some(t#0)));
   ...
   ==> (forall TraitDefinitions.Option$T: Ty, this: DatatypeType, t#0: Box :: 
    ...
    TraitDefinitions.Option.Negate#canCall(TraitDefinitions.Option$T, Lit(this), Lit(t#0))
       ...
       ==> TraitDefinitions.Option.Negate(TraitDefinitions.Option$T, Lit(this), Lit(t#0))
         == (if TraitDefinitions.Option.Some_q(Lit(this))
           then (var v#4 := Lit(TraitDefinitions.Option.value(Lit(this))); 
            Lit(#TraitDefinitions.Option.None()))
...
procedure {:verboseName "TraitDefinitions.Option.Negate (well-formedness)"} CheckWellformed$$TraitDefinitions.Option.Negate(TraitDefinitions.Option$T: Ty, 
    this: DatatypeType
       where $Is(this, Tclass.TraitDefinitions.Option(TraitDefinitions.Option$T))
         && $IsAlloc(this, Tclass.TraitDefinitions.Option(TraitDefinitions.Option$T), $Heap), 
    t#0: Box where $IsBox(t#0, TraitDefinitions.Option$T));
...
axiom {:id "id12"} 0 <= $FunctionContextHeight
   ==> (forall TraitDefinitions.Option$T: Ty, this: DatatypeType :: 
...
procedure {:verboseName "TraitDefinitions.Option.IsFailure (well-formedness)"} CheckWellformed$$TraitDefinitions.Option.IsFailure(TraitDefinitions.Option$T: Ty, 
    this: DatatypeType
       where $Is(this, Tclass.TraitDefinitions.Option(TraitDefinitions.Option$T))
         && $IsAlloc(this, Tclass.TraitDefinitions.Option(TraitDefinitions.Option$T), $Heap));
...
axiom 1 <= $FunctionContextHeight
   ==> (forall TraitDefinitions.Option$T: Ty, 
      TraitDefinitions.Option.PropagateFailure$U: Ty, 
      this: DatatypeType :: 
...
procedure {:verboseName "TraitDefinitions.Option.PropagateFailure (well-formedness)"} CheckWellformed$$TraitDefinitions.Option.PropagateFailure(TraitDefinitions.Option$T: Ty, 
    TraitDefinitions.Option.PropagateFailure$U: Ty, 
    this: DatatypeType
       where $Is(this, Tclass.TraitDefinitions.Option(TraitDefinitions.Option$T))
         && $IsAlloc(this, Tclass.TraitDefinitions.Option(TraitDefinitions.Option$T), $Heap));
...
axiom 1 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, TraitDefinitions.Option$T: Ty, this: DatatypeType :: 
...
procedure {:verboseName "TraitDefinitions.Option.Extract (well-formedness)"} CheckWellformed$$TraitDefinitions.Option.Extract(TraitDefinitions.Option$T: Ty, 
    this: DatatypeType
       where $Is(this, Tclass.TraitDefinitions.Option(TraitDefinitions.Option$T))
         && $IsAlloc(this, Tclass.TraitDefinitions.Option(TraitDefinitions.Option$T), $Heap));
  free requires 1 == $FunctionContextHeight;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TraitDefinitions.Option.Extract (well-formedness)"} CheckWellformed$$TraitDefinitions.Option.Extract(TraitDefinitions.Option$T: Ty, this: DatatypeType)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    assume $IsAllocBox($Box(this), Tclass.TraitDefinitions.Option(TraitDefinitions.Option$T), $Heap);
    assume TraitDefinitions.Option.IsFailure#canCall(TraitDefinitions.Option$T, this);
    assume {:id "id20"} !TraitDefinitions.Option.IsFailure(TraitDefinitions.Option$T, this);
    ...
    if (*)
    {
        ...
        assume $IsBox(TraitDefinitions.Option.Extract(TraitDefinitions.Option$T, this), 
          TraitDefinitions.Option$T);
        assume false;
    }
    else
    {
        ...
        assert {:id "id21"} TraitDefinitions.Option.Some_q(this);
        assume {:id "id22"} TraitDefinitions.Option.Extract(TraitDefinitions.Option$T, this)
           == TraitDefinitions.Option.value(this);
        assume true;
...
procedure {:verboseName "TraitDefinitions.SubTrait.GetC (override check)"} OverrideCheck$$TraitDefinitions.SubTrait.GetC(TraitDefinitions.SubTrait$T: Ty, 
    TraitDefinitions.SubTrait$I: Ty, 
    this: ref
       where this != null
         && 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TraitDefinitions.SubTrait.GetC (override check)"} OverrideCheck$$TraitDefinitions.SubTrait.GetC(TraitDefinitions.SubTrait$T: Ty, TraitDefinitions.SubTrait$I: Ty, this: ref)
   returns (c#0: int)
{
    assert {:id "id24"} true;
...
procedure {:verboseName "TraitDefinitions.SubTrait.GetCTwicePlusD (correctness)"} Impl$$TraitDefinitions.SubTrait.GetCTwicePlusD(TraitDefinitions.SubTrait$T: Ty, 
    TraitDefinitions.SubTrait$I: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, 
         ...
         && $IsAlloc(this, 
          Tclass.TraitDefinitions.SubTrait(TraitDefinitions.SubTrait$T, TraitDefinitions.SubTrait$I), 
          $Heap))
   returns (c2#0: int, $_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TraitDefinitions.SubTrait.GetCTwicePlusD (correctness)"} Impl$$TraitDefinitions.SubTrait.GetCTwicePlusD(TraitDefinitions.SubTrait$T: Ty, TraitDefinitions.SubTrait$I: Ty, this: ref)
   returns (c2#0: int, $_reverifyPost: bool)
{
  ...
  var $rhs##1: int;
    ...
    // AddMethodImpl: GetCTwicePlusD, Impl$$TraitDefinitions.SubTrait.GetCTwicePlusD
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/traits.dfy(60,20)
    assume true;
    // TrCallStmt: Adding lhs with type int
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    call {:id "id29"} $rhs##0 := Call$$TraitDefinitions.SubTrait.GetC(TraitDefinitions.SubTrait$T, TraitDefinitions.SubTrait$I, this);
    // TrCallStmt: After ProcessCallStmt
    c#0 := $rhs##0;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/traits.dfy(61,20)
    assume true;
    // TrCallStmt: Adding lhs with type int
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    call {:id "id31"} $rhs##1 := Call$$TraitDefinitions.SubTrait.GetD(TraitDefinitions.SubTrait$T, TraitDefinitions.SubTrait$I, this);
    // TrCallStmt: After ProcessCallStmt
    d#0 := $rhs##1;
    // ----- return statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/traits.dfy(62,7)
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/traits.dfy(62,7)
    assume true;
    assume true;
    c2#0 := c#0 + c#0 + d#0;
    return;
...
procedure {:verboseName "TraitDefinitions.SubTrait.GetDFunc (well-formedness)"} CheckWellformed$$TraitDefinitions.SubTrait.GetDFunc(TraitDefinitions.SubTrait$T: Ty, 
    TraitDefinitions.SubTrait$I: Ty, 
    this: ref
       where this != null
         && 
