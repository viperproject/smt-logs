...
procedure {:verboseName "FunctionsAsValues.TestStart (correctness)"} Impl$$FunctionsAsValues.__default.TestStart() returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "FunctionsAsValues.TestStart (correctness)"} Impl$$FunctionsAsValues.__default.TestStart() returns ($_reverifyPost: bool)
{
  ...
  var c#0: ref
     where defass#c#0
       ==> $Is(c#0, Tclass.FunctionsAsValues.Class())
         && $IsAlloc(c#0, Tclass.FunctionsAsValues.Class(), $Heap);
  var $nw: ref;
  var x#0: int;
  var ##g#0: int;
  var ##h#0: int;
  var ##j#0: int;
    ...
    // AddMethodImpl: TestStart, Impl$$FunctionsAsValues.__default.TestStart
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(341,11)
    assume true;
    // ----- init call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(341,14)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id324"} $nw := Call$$FunctionsAsValues.Class.__ctor();
    // TrCallStmt: After ProcessCallStmt
    c#0 := $nw;
    defass#c#0 := true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(342,11)
    assume true;
    assert {:id "id326"} defass#c#0;
    assert {:id "id327"} c#0 != null;
    // assume allocatedness for receiver argument to function
    assume $IsAllocBox($Box(c#0), Tclass.FunctionsAsValues.Trait?(TInt, TInt, TInt), $Heap);
    ##g#0 := LitInt(15);
    ...
    assume FunctionsAsValues.Trait.ApplySelect#canCall(TInt, TInt, TInt, c#0, $Box(LitInt(15)), $Box(LitInt(20)), $Box(LitInt(25)));
    assume FunctionsAsValues.Trait.ApplySelect#canCall(TInt, TInt, TInt, c#0, $Box(LitInt(15)), $Box(LitInt(20)), $Box(LitInt(25)));
    x#0 := $Unbox(FunctionsAsValues.Trait.ApplySelect(TInt, TInt, TInt, c#0, $Box(LitInt(15)), $Box(LitInt(20)), $Box(LitInt(25)))): int;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(343,5)
    assume true;
    assume true;
}
...
axiom 0 <= $FunctionContextHeight
   ==> (forall FunctionsAsValues.Trait$G: Ty, 
      FunctionsAsValues.Trait$H: Ty, 
      FunctionsAsValues.Trait$J: Ty, 
      this: ref, 
      g#0: Box, 
...
procedure {:verboseName "FunctionsAsValues.Trait.Select (well-formedness)"} CheckWellformed$$FunctionsAsValues.Trait.Select(FunctionsAsValues.Trait$G: Ty, 
    FunctionsAsValues.Trait$H: Ty, 
    FunctionsAsValues.Trait$J: Ty, 
    this: ref
       where this != null
        ...
        $Is(this, 
         ...
         && $IsAlloc(this, 
          Tclass.FunctionsAsValues.Trait(FunctionsAsValues.Trait$G, FunctionsAsValues.Trait$H, FunctionsAsValues.Trait$J), 
          $Heap), 
    g#0: Box where $IsBox(g#0, FunctionsAsValues.Trait$G), 
    h#0: Box where $IsBox(h#0, FunctionsAsValues.Trait$H), 
    j#0: Box where $IsBox(j#0, FunctionsAsValues.Trait$J));
...
axiom {:id "id332"} 1 <= $FunctionContextHeight
   ==> (forall FunctionsAsValues.Trait$G: Ty, 
      FunctionsAsValues.Trait$H: Ty, 
      FunctionsAsValues.Trait$J: Ty, 
      $Heap: Heap, 
    ...
    FunctionsAsValues.Trait.ApplySelect#canCall(FunctionsAsValues.Trait$G, 
       ...
       ==> FunctionsAsValues.Trait.ApplySelect(FunctionsAsValues.Trait$G, 
          ...
          h#0, 
          j#0)
         == (var f#0 := FunctionsAsValues.Trait.Select#Handle(FunctionsAsValues.Trait$G, 
              FunctionsAsValues.Trait$H, 
              FunctionsAsValues.Trait$J, 
              this); 
...
axiom {:id "id333"} 1 <= $FunctionContextHeight
   ==> (forall FunctionsAsValues.Trait$G: Ty, 
      FunctionsAsValues.Trait$H: Ty, 
      FunctionsAsValues.Trait$J: Ty, 
      $Heap: Heap, 
    ...
    FunctionsAsValues.Trait.ApplySelect#canCall(FunctionsAsValues.Trait$G, 
       ...
       ==> FunctionsAsValues.Trait.ApplySelect(FunctionsAsValues.Trait$G, 
          ...
          Lit(h#0), 
          Lit(j#0))
         == (var f#1 := FunctionsAsValues.Trait.Select#Handle(FunctionsAsValues.Trait$G, 
              FunctionsAsValues.Trait$H, 
              FunctionsAsValues.Trait$J, 
              Lit(this)); 
          Apply3(FunctionsAsValues.Trait$G, 
...
procedure {:verboseName "FunctionsAsValues.Trait.ApplySelect (well-formedness)"} CheckWellformed$$FunctionsAsValues.Trait.ApplySelect(FunctionsAsValues.Trait$G: Ty, 
    FunctionsAsValues.Trait$H: Ty, 
    FunctionsAsValues.Trait$J: Ty, 
    this: ref
       where this != null
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "FunctionsAsValues.Trait.ApplySelect (well-formedness)"} CheckWellformed$$FunctionsAsValues.Trait.ApplySelect(FunctionsAsValues.Trait$G: Ty, 
    FunctionsAsValues.Trait$H: Ty, 
    FunctionsAsValues.Trait$J: Ty, 
    this: ref, 
    g#0: Box, 
    ...
    j#0: Box)
{
  ...
  var let#0#0#0: HandleType;
    ...
    if (*)
    {
        ...
        assume $IsBox(FunctionsAsValues.Trait.ApplySelect(FunctionsAsValues.Trait$G, 
            FunctionsAsValues.Trait$H, 
            FunctionsAsValues.Trait$J, 
            this, 
            g#0, 
    ...
    else
    {
        ...
        havoc f#Z#0;
        assert {:id "id334"} 0 != $FunctionContextHeight;
        assume {:id "id335"} let#0#0#0
           == FunctionsAsValues.Trait.Select#Handle(FunctionsAsValues.Trait$G, 
            FunctionsAsValues.Trait$H, 
            FunctionsAsValues.Trait$J, 
            this);
        ...
        assume $Is(let#0#0#0, 
          Tclass._System.___hTotalFunc3(FunctionsAsValues.Trait$G, 
            FunctionsAsValues.Trait$H, 
            FunctionsAsValues.Trait$J, 
            FunctionsAsValues.Trait$G));
        assume {:id "id336"} f#Z#0 == let#0#0#0;
        assume {:id "id337"} FunctionsAsValues.Trait.ApplySelect(FunctionsAsValues.Trait$G, 
            FunctionsAsValues.Trait$H, 
            FunctionsAsValues.Trait$J, 
            this, 
            g#0, 
...
procedure {:verboseName "FunctionsAsValues.Class._ctor (well-formedness)"} CheckWellFormed$$FunctionsAsValues.Class.__ctor() returns (this: ref);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "FunctionsAsValues.Class._ctor (call)"} Call$$FunctionsAsValues.Class.__ctor()
   returns (this: ref
       where this != null
         && 
        $Is(this, Tclass.FunctionsAsValues.Class())
         && $IsAlloc(this, Tclass.FunctionsAsValues.Class(), $Heap));
  modifies $Heap;
...
procedure {:verboseName "FunctionsAsValues.Class._ctor (correctness)"} Impl$$FunctionsAsValues.Class.__ctor() returns (this: ref, $_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
