...
(declare-fun |t#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$Stacks.Stack.Push)
...
))) (= (ControlFlow 0 2) (- 0 1))) ($IsAlloc refType this@@2 (Tclass.Stacks.Stack Stacks.Stack$T@@20) $Heap@@1))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 (Tclass.Stacks.Stack Stacks.Stack$T@@20)) ($IsAlloc refType this@@2 (Tclass.Stacks.Stack Stacks.Stack$T@@20) $Heap@@1)))) (and (and ($IsBox |t#0| Stacks.Stack$T@@20) ($IsAllocBox |t#0| Stacks.Stack$T@@20 $Heap@@1)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct)))
