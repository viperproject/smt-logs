...
(declare-fun _module._default.MId$T () T@U)
(declare-fun |r#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.MId)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SetType |s#0| (TSet _module._default.MId$T)) ($IsAlloc SetType |s#0| (TSet _module._default.MId$T) $Heap))) (and (and ($Is SetType |r#0| (TSet _module._default.MId$T)) ($IsAlloc SetType |r#0| (TSet _module._default.MId$T) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
