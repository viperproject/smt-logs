...
(set-info :boogie-vc-id Impl$$Regression.C.RecM)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon9_Else_correct  (=> (or (not (= (Regression.C.data Regression.C$U@@20 this@@2) (LitInt 17))) (not true)) (and (=> (= (ControlFlow 0 9) (- 0 12)) (or (not (= (Regression.C.next Regression.C$U@@20 this@@2) null)) (not true))) (=> (or (not (= (Regression.C.next Regression.C$U@@20 this@@2) null)) (not true)) (and (=> (= (ControlFlow 0 9) (- 0 11)) ($Is intType (int_2_U (- |n#0| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0| 1)) Tclass._System.nat) (=> (= |n##1_1_0@0| (- |n#0| 1)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (<= 0 |n#0|) (= |n##1_1_0@0| |n#0|))) (=> (or (<= 0 |n#0|) (= |n##1_1_0@0| |n#0|)) (=> (= (ControlFlow 0 9) (- 0 8)) (< |n##1_1_0@0| |n#0|))))))))))))
(let ((anon9_Then_correct  (=> (= (Regression.C.data Regression.C$U@@20 this@@2) (LitInt 17)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (or (not (= (Regression.C.next Regression.C$U@@20 this@@2) null)) (not true))) (=> (or (not (= (Regression.C.next Regression.C$U@@20 this@@2) null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 6)) ($Is intType (int_2_U (- |n#0| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0| 1)) Tclass._System.nat) (=> (= |n##1_0_0@0| (- |n#0| 1)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= 1 $FunctionContextHeight)) (not true))) (=> (or (not (= 1 $FunctionContextHeight)) (not true)) (=> (= |f##1_0_0@0| (|Regression.C.F#Handle| Regression.C$U@@20 this@@2)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (<= 0 |n#0|) (= |n##1_0_0@0| |n#0|))) (=> (or (<= 0 |n#0|) (= |n##1_0_0@0| |n#0|)) (=> (= (ControlFlow 0 3) (- 0 2)) (< |n##1_0_0@0| |n#0|)))))))))))))))
(let ((anon8_Else_correct  (=> (not (or (= |n#0| (LitInt 0)) (= (Regression.C.next Regression.C$U@@20 this@@2) null))) (and (=> (= (ControlFlow 0 13) 3) anon9_Then_correct) (=> (= (ControlFlow 0 13) 9) anon9_Else_correct)))))
(let ((anon8_Then_correct true))
(let ((anon2_correct  (and (=> (= (ControlFlow 0 14) 1) anon8_Then_correct) (=> (= (ControlFlow 0 14) 13) anon8_Else_correct))))
(let ((anon7_Else_correct  (=> (and (= |n#0| (LitInt 0)) (= (ControlFlow 0 16) 14)) anon2_correct)))
(let ((anon7_Then_correct  (=> (and (or (not (= |n#0| (LitInt 0))) (not true)) (= (ControlFlow 0 15) 14)) anon2_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 17) 15) anon7_Then_correct) (=> (= (ControlFlow 0 17) 16) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 (Tclass.Regression.C Regression.C$U@@20)) ($IsAlloc refType this@@2 (Tclass.Regression.C Regression.C$U@@20) $Heap))) (<= (LitInt 0) |n#0|)) (and (and ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc0 TInt)) ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc0 TInt) $Heap)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 18) 17)))) anon0_correct))))
