...
(let ((anon5_Else_correct  (=> (= |g#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#13| 1) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ)))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (<= 0 (LitInt 10))) (=> (<= 0 (LitInt 10)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (forall ((|seqinit#0#i0#0| Int) )  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| (LitInt 10))) (Requires1 TInt TInt $Heap |_module.__default.f#Handle| ($Box intType (int_2_U |seqinit#0#i0#0|)))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (<= 0 (LitInt 10))) (=> (<= 0 (LitInt 10)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((|seqinit#1#i0#0| Int) )  (=> (and (<= 0 |seqinit#1#i0#0|) (< |seqinit#1#i0#0| (LitInt 10))) (Requires1 TInt TInt $Heap |g#0@0| ($Box intType (int_2_U |seqinit#1#i0#0|)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= 0 (LitInt 10))) (=> (<= 0 (LitInt 10)) (=> (and (and (= |##i#0@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##i#0@0|) TInt $Heap)) (and (|_module.__default.F#canCall| (LitInt 0)) (= (ControlFlow 0 2) (- 0 1)))) (forall ((|seqinit#2#i0#0| Int) )  (=> (and (<= 0 |seqinit#2#i0#0|) (< |seqinit#2#i0#0| (LitInt 10))) (Requires1 TInt TInt $Heap (Lit HandleTypeType (_module.__default.F (LitInt 0))) ($Box intType (int_2_U |seqinit#2#i0#0|)))))))))))))))))))
