...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|i#0| Int) ) (!  (=> (or (|_module.__default.F#canCall| |i#0|) (< 0 $FunctionContextHeight)) (= (_module.__default.F |i#0|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| |i#0| 1) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ)))))
 :qid |Variousdfy.30:12|
 :skolemid |496|
 :pattern ( (_module.__default.F |i#0|))
))))
(assert (forall ((|l#0| T@U) (|$l#0#heap#0| T@U) (|$l#0#j#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#3| |l#0|) |$l#0#heap#0| |$l#0#j#0|)) ($IsBox |$l#0#j#0| |l#0|))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |530|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#3| |l#0|) |$l#0#heap#0| |$l#0#j#0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|i#0@@0| Int) ) (!  (=> (or (|_module.__default.F#canCall| |i#0@@0|) (< 0 $FunctionContextHeight)) ($Is HandleTypeType (_module.__default.F |i#0@@0|) (Tclass._System.___hTotalFunc1 TInt TInt)))
 :qid |Variousdfy.30:12|
 :skolemid |494|
 :pattern ( (_module.__default.F |i#0@@0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|i#0@@1| Int) ) (!  (=> (or (|_module.__default.F#canCall| (LitInt |i#0@@1|)) (< 0 $FunctionContextHeight)) (= (_module.__default.F (LitInt |i#0@@1|)) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| |i#0@@1| 1) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ)))))
 :qid |Variousdfy.30:12|
 :weight 3
 :skolemid |497|
 :pattern ( (_module.__default.F (LitInt |i#0@@1|)))
))))
...
(assert (forall ((|l#0@@0| Int) (|l#1| Int) (|$l#0#heap#0@@0| T@U) (|$l#0#j#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#2| |l#0@@0| |l#1|) |$l#0#heap#0@@0| |$l#0#j#0@@0|) ($Box intType (int_2_U (+ (+ (U_2_int ($Unbox intType |$l#0#j#0@@0|)) |l#0@@0|) |l#1|))))
 :qid |Variousdfy.30:12|
 :skolemid |529|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#2| |l#0@@0| |l#1|) |$l#0#heap#0@@0| |$l#0#j#0@@0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|i#0@@2| Int) ) (!  (=> (or (|_module.__default.f#canCall| |i#0@@2|) (< 0 $FunctionContextHeight)) (= (_module.__default.f |i#0@@2|) (+ |i#0@@2| 1)))
 :qid |Variousdfy.26:12|
 :skolemid |492|
 :pattern ( (_module.__default.f |i#0@@2|))
))))
...
(assert (forall ((|l#0@@1| Int) (|$l#0#heap#0@@1| T@U) (|$l#0#i#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#13| |l#0@@1|) |$l#0#heap#0@@1| |$l#0#i#0|) ($Box intType (int_2_U (+ (U_2_int ($Unbox intType |$l#0#i#0|)) |l#0@@1|))))
 :qid |unknown.0:0|
 :skolemid |534|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#13| |l#0@@1|) |$l#0#heap#0@@1| |$l#0#i#0|))
)))
(assert (forall (($heap T@U) (|$fh$0x#0| Int) ) (! (= (_module.__default.f |$fh$0x#0|) (U_2_int ($Unbox intType (Apply1 TInt TInt $heap |_module.__default.f#Handle| ($Box intType (int_2_U |$fh$0x#0|))))))
...
(assert (forall (($heap@@0 T@U) (|$fh$0x#0@@0| T@U) ) (! (= (Requires1 TInt TInt $heap@@0 |_module.__default.f#Handle| |$fh$0x#0@@0|) (|_module.__default.f#requires| (U_2_int ($Unbox intType |$fh$0x#0@@0|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |502|
 :pattern ( (Requires1 TInt TInt $heap@@0 |_module.__default.f#Handle| |$fh$0x#0@@0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|i#0@@3| Int) ) (!  (=> (or (|_module.__default.f#canCall| (LitInt |i#0@@3|)) (< 0 $FunctionContextHeight)) (= (_module.__default.f (LitInt |i#0@@3|)) (LitInt (+ |i#0@@3| 1))))
 :qid |Variousdfy.26:12|
 :weight 3
 :skolemid |493|
 :pattern ( (_module.__default.f (LitInt |i#0@@3|)))
))))
...
(assert (forall (($bx T@U) ($heap@@1 T@U) (|$fh$0x#0@@1| T@U) ) (! (= (|Set#IsMember| (Reads1 TInt TInt $heap@@1 |_module.__default.f#Handle| |$fh$0x#0@@1|) $bx) false)
 :qid |unknown.0:0|
 :skolemid |503|
 :pattern ( (|Set#IsMember| (Reads1 TInt TInt $heap@@1 |_module.__default.f#Handle| |$fh$0x#0@@1|) $bx))
)))
...
(assert (forall (($heap@@2 T@U) (|$fh$0x#0@@2| T@U) ) (! (= (Apply1 TInt TInt $heap@@2 |_module.__default.f#Handle| |$fh$0x#0@@2|) ($Box intType (int_2_U (_module.__default.f (U_2_int ($Unbox intType |$fh$0x#0@@2|))))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |501|
 :pattern ( (Apply1 TInt TInt $heap@@2 |_module.__default.f#Handle| |$fh$0x#0@@2|))
)))
...
(assert (forall ((|i#0@@4| Int) ) (! (= (|_module.__default.f#requires| |i#0@@4|) true)
 :qid |Variousdfy.26:12|
 :skolemid |491|
 :pattern ( (|_module.__default.f#requires| |i#0@@4|))
)))
...
(assert (forall ((|l#0@@5| T@U) (|$l#0#heap#0@@2| T@U) (|$l#0#j#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#5| |l#0@@5|) |$l#0#heap#0@@2| |$l#0#j#0@@1|) |l#0@@5|)
 :qid |Variousdfy.31:3|
 :skolemid |532|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#5| |l#0@@5|) |$l#0#heap#0@@2| |$l#0#j#0@@1|))
)))
...
(declare-fun |g#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.SequenceConstructionWithNamedFunction)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon6_Else_correct true))
...
(let ((anon5_Else_correct  (=> (= |g#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#13| 1) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ)))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (<= 0 (LitInt 10))) (=> (<= 0 (LitInt 10)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (forall ((|seqinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| (LitInt 10))) (Requires1 TInt TInt $Heap |_module.__default.f#Handle| ($Box intType (int_2_U |seqinit#0#i0#0|))))
 :qid |Variousdfy.36:9|
 :skolemid |505|
))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (<= 0 (LitInt 10))) (=> (<= 0 (LitInt 10)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((|seqinit#1#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#1#i0#0|) (< |seqinit#1#i0#0| (LitInt 10))) (Requires1 TInt TInt $Heap |g#0@0| ($Box intType (int_2_U |seqinit#1#i0#0|))))
 :qid |Variousdfy.37:9|
 :skolemid |506|
))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= 0 (LitInt 10))) (=> (<= 0 (LitInt 10)) (=> (and (and (= |##i#0@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##i#0@0|) TInt $Heap)) (and (|_module.__default.F#canCall| (LitInt 0)) (= (ControlFlow 0 2) (- 0 1)))) (forall ((|seqinit#2#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#2#i0#0|) (< |seqinit#2#i0#0| (LitInt 10))) (Requires1 TInt TInt $Heap (Lit HandleTypeType (_module.__default.F (LitInt 0))) ($Box intType (int_2_U |seqinit#2#i0#0|))))
 :qid |Variousdfy.38:9|
 :skolemid |507|
))))))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 12) 11) anon5_Then_correct) (=> (= (ControlFlow 0 12) 2) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 13) 12))) anon0_correct))))
