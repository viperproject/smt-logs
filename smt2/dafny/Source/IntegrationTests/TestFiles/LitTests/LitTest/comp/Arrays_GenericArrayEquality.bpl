...
procedure {:verboseName "GenericArrayEquality.Test (correctness)"} Impl$$GenericArrayEquality.__default.Test() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "GenericArrayEquality.Test (correctness)"} Impl$$GenericArrayEquality.__default.Test() returns ($_reverifyPost: bool)
{
  ...
  var b##9: ref;
    ...
    // AddMethodImpl: Test, Impl$$GenericArrayEquality.__default.Test
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(876,11)
    assume true;
    assert {:id "id1018"} 0 <= LitInt(25);
    havoc $nw;
    ...
    a#0 := $nw;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(877,11)
    assume true;
    assert {:id "id1020"} 0 <= LitInt(25);
    havoc $nw;
    assume $nw != null && $Is($nw, Tclass._System.array?(TInt));
    assume !$Unbox(read($Heap, $nw, alloc)): bool;
    assume _System.array.Length($nw) == LitInt(25);
    ...
    assume $IsHeapAnchor($Heap);
    b#0 := $nw;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(878,17)
    ...
    // ProcessCallStmt: CheckSubrange
    b##0 := b#0;
    call {:id "id1022"} Call$$GenericArrayEquality.__default.ArrayCompare(TInt, a##0, b##0);
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(879,19)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    a##1 := a#0;
    ...
    // ProcessCallStmt: CheckSubrange
    b##1 := b#0;
    call {:id "id1023"} Call$$GenericArrayEquality.__default.GenericCompare(Tclass._System.array?(TInt), $Box(a##1), $Box(b##1));
    // TrCallStmt: After ProcessCallStmt
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(884,7)
    assume true;
    assume true;
    b#0 := a#0;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(885,17)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    a##2 := a#0;
    ...
    // ProcessCallStmt: CheckSubrange
    b##2 := b#0;
    call {:id "id1025"} Call$$GenericArrayEquality.__default.ArrayCompare(TInt, a##2, b##2);
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(886,19)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    a##3 := a#0;
    ...
    // ProcessCallStmt: CheckSubrange
    b##3 := b#0;
    call {:id "id1026"} Call$$GenericArrayEquality.__default.GenericCompare(Tclass._System.array?(TInt), $Box(a##3), $Box(b##3));
    // TrCallStmt: After ProcessCallStmt
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(888,7)
    assume true;
    newtype$check#0 := null;
    assume true;
    b#0 := null;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(889,17)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    a##4 := a#0;
    ...
    // ProcessCallStmt: CheckSubrange
    b##4 := b#0;
    call {:id "id1028"} Call$$GenericArrayEquality.__default.ArrayCompare(TInt, a##4, b##4);
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(890,19)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    a##5 := a#0;
    ...
    // ProcessCallStmt: CheckSubrange
    b##5 := b#0;
    call {:id "id1029"} Call$$GenericArrayEquality.__default.GenericCompare(Tclass._System.array?(TInt), $Box(a##5), $Box(b##5));
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(891,17)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    a##6 := b#0;
    ...
    // ProcessCallStmt: CheckSubrange
    b##6 := a#0;
    call {:id "id1030"} Call$$GenericArrayEquality.__default.ArrayCompare(TInt, a##6, b##6);
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(892,19)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    a##7 := b#0;
    ...
    // ProcessCallStmt: CheckSubrange
    b##7 := a#0;
    call {:id "id1031"} Call$$GenericArrayEquality.__default.GenericCompare(Tclass._System.array?(TInt), $Box(a##7), $Box(b##7));
    // TrCallStmt: After ProcessCallStmt
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(894,7)
    assume true;
    newtype$check#1 := null;
    assume true;
    a#0 := null;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(895,17)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    a##8 := a#0;
    ...
    // ProcessCallStmt: CheckSubrange
    b##8 := b#0;
    call {:id "id1033"} Call$$GenericArrayEquality.__default.ArrayCompare(TInt, a##8, b##8);
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(896,19)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    a##9 := a#0;
    ...
    // ProcessCallStmt: CheckSubrange
    b##9 := b#0;
    call {:id "id1034"} Call$$GenericArrayEquality.__default.GenericCompare(Tclass._System.array?(TInt), $Box(a##9), $Box(b##9));
    // TrCallStmt: After ProcessCallStmt
}



procedure {:verboseName "GenericArrayEquality.ArrayCompare (well-formedness)"} CheckWellFormed$$GenericArrayEquality.__default.ArrayCompare(GenericArrayEquality._default.ArrayCompare$X: Ty, 
    a#0: ref
       where $Is(a#0, Tclass._System.array?(GenericArrayEquality._default.ArrayCompare$X))
         && $IsAlloc(a#0, Tclass._System.array?(GenericArrayEquality._default.ArrayCompare$X), $Heap), 
    b#0: ref
       where $Is(b#0, Tclass._System.array?(GenericArrayEquality._default.ArrayCompare$X))
         && $IsAlloc(b#0, Tclass._System.array?(GenericArrayEquality._default.ArrayCompare$X), $Heap));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "GenericArrayEquality.ArrayCompare (call)"} Call$$GenericArrayEquality.__default.ArrayCompare(GenericArrayEquality._default.ArrayCompare$X: Ty, 
    a#0: ref
       where $Is(a#0, Tclass._System.array?(GenericArrayEquality._default.ArrayCompare$X))
         && $IsAlloc(a#0, Tclass._System.array?(GenericArrayEquality._default.ArrayCompare$X), $Heap), 
    b#0: ref
...
procedure {:verboseName "GenericArrayEquality.ArrayCompare (correctness)"} Impl$$GenericArrayEquality.__default.ArrayCompare(GenericArrayEquality._default.ArrayCompare$X: Ty, 
    a#0: ref
       where $Is(a#0, Tclass._System.array?(GenericArrayEquality._default.ArrayCompare$X))
         && $IsAlloc(a#0, Tclass._System.array?(GenericArrayEquality._default.ArrayCompare$X), $Heap), 
    b#0: ref
...
procedure {:verboseName "GenericArrayEquality.GenericCompare (well-formedness)"} CheckWellFormed$$GenericArrayEquality.__default.GenericCompare(GenericArrayEquality._default.GenericCompare$X: Ty, 
    a#0: Box
       where $IsBox(a#0, GenericArrayEquality._default.GenericCompare$X)
         && $IsAllocBox(a#0, GenericArrayEquality._default.GenericCompare$X, $Heap), 
    b#0: Box
       where $IsBox(b#0, GenericArrayEquality._default.GenericCompare$X)
         && $IsAllocBox(b#0, GenericArrayEquality._default.GenericCompare$X, $Heap));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "GenericArrayEquality.GenericCompare (call)"} Call$$GenericArrayEquality.__default.GenericCompare(GenericArrayEquality._default.GenericCompare$X: Ty, 
    a#0: Box
       where $IsBox(a#0, GenericArrayEquality._default.GenericCompare$X)
         && $IsAllocBox(a#0, GenericArrayEquality._default.GenericCompare$X, $Heap), 
    b#0: Box
...
procedure {:verboseName "GenericArrayEquality.GenericCompare (correctness)"} Impl$$GenericArrayEquality.__default.GenericCompare(GenericArrayEquality._default.GenericCompare$X: Ty, 
    a#0: Box
       where $IsBox(a#0, GenericArrayEquality._default.GenericCompare$X)
         && $IsAllocBox(a#0, GenericArrayEquality._default.GenericCompare$X, $Heap), 
    b#0: Box
