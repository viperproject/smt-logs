...
procedure {:verboseName "ArrayToSeq.Test (correctness)"} Impl$$ArrayToSeq.__default.Test() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ArrayToSeq.Test (correctness)"} Impl$$ArrayToSeq.__default.Test() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var arrChar#0: ref
     where $Is(arrChar#0, Tclass._System.array(TChar))
       && $IsAlloc(arrChar#0, Tclass._System.array(TChar), $Heap);
  var $nw: ref;
  var arrInt#0: ref
     where $Is(arrInt#0, Tclass._System.array(TInt))
       && $IsAlloc(arrInt#0, Tclass._System.array(TInt), $Heap);
  var $lambdaHeap#0: Heap;
  var i#0: int;
  var $_Frame#l0: [ref,Field]bool;
  var lambdaResult#0: int;
  var arrByte#0: ref
     where $Is(arrByte#0, Tclass._System.array(Tclass.ArrayToSeq.byte()))
       && $IsAlloc(arrByte#0, Tclass._System.array(Tclass.ArrayToSeq.byte()), $Heap);
  ...
  var c#0: ref
     where defass#c#0
       ==> $Is(c#0, Tclass.ArrayToSeq.MyClass())
         && $IsAlloc(c#0, Tclass.ArrayToSeq.MyClass(), $Heap);
  var defass#tr#0: bool;
  var tr#0: ref
     where defass#tr#0
       ==> $Is(tr#0, Tclass.ArrayToSeq.TraitMeRite())
         && $IsAlloc(tr#0, Tclass.ArrayToSeq.TraitMeRite(), $Heap);
  var arrClass#0: ref
     where $Is(arrClass#0, Tclass._System.array(Tclass.ArrayToSeq.MyClass()))
       && $IsAlloc(arrClass#0, Tclass._System.array(Tclass.ArrayToSeq.MyClass()), $Heap);
  var arrTrait#0: ref
     where $Is(arrTrait#0, Tclass._System.array(Tclass.ArrayToSeq.TraitMeRite()))
       && $IsAlloc(arrTrait#0, Tclass._System.array(Tclass.ArrayToSeq.TraitMeRite()), $Heap);
  var s0#0: Seq where $Is(s0#0, TSeq(TChar)) && $IsAlloc(s0#0, TSeq(TChar), $Heap);
  var s1#0: Seq where $Is(s1#0, TSeq(TInt)) && $IsAlloc(s1#0, TSeq(TInt), $Heap);
  var s2#0: Seq
     where $Is(s2#0, TSeq(Tclass.ArrayToSeq.byte()))
       && $IsAlloc(s2#0, TSeq(Tclass.ArrayToSeq.byte()), $Heap);
  var s3#0: Seq
     where $Is(s3#0, TSeq(Tclass.ArrayToSeq.MyClass()))
       && $IsAlloc(s3#0, TSeq(Tclass.ArrayToSeq.MyClass()), $Heap);
  var s4#0: Seq
     where $Is(s4#0, TSeq(Tclass.ArrayToSeq.TraitMeRite()))
       && $IsAlloc(s4#0, TSeq(Tclass.ArrayToSeq.TraitMeRite()), $Heap);
  ...
  var newtype$check#8: int;
    ...
    // AddMethodImpl: Test, Impl$$ArrayToSeq.__default.Test
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(535,17)
    assume true;
    assert {:id "id284"} 0 <= LitInt(5);
    assert {:id "id285"} LitInt(5) == 5;
    havoc $nw;
    assume $nw != null && $Is($nw, Tclass._System.array?(TChar));
    assume !$Unbox(read($Heap, $nw, alloc)): bool;
    assume _System.array.Length($nw) == LitInt(5);
    assume $Unbox(read($Heap, $nw, IndexField(0))): char == Lit(char#FromInt(104));
    assume $Unbox(read($Heap, $nw, IndexField(1))): char == Lit(char#FromInt(101));
    assume $Unbox(read($Heap, $nw, IndexField(2))): char == Lit(char#FromInt(108));
    assume $Unbox(read($Heap, $nw, IndexField(3))): char == Lit(char#FromInt(108));
    assume $Unbox(read($Heap, $nw, IndexField(4))): char == Lit(char#FromInt(111));
    $Heap := update($Heap, $nw, alloc, $Box(true));
    assume $IsGoodHeap($Heap);
    assume $IsHeapAnchor($Heap);
    arrChar#0 := $nw;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(536,16)
    assume true;
    ...
    if (*)
    {
        ...
        if (LitInt(0) <= i#0)
        {
            ...
            assume {:id "id288"} lambdaResult#0 == i#0;
            assume true;
    ...
    assume !$Unbox(read($Heap, $nw, alloc)): bool;
    assume _System.array.Length($nw) == LitInt(5);
    assert {:id "id289"} {:subsumption 0} (forall arrayinit#0#i0#0: int :: 
      0 <= arrayinit#0#i0#0 && arrayinit#0#i0#0 < LitInt(5)
         ==> Requires1(Tclass._System.nat(), 
          Tclass._System.nat(), 
          $Heap, 
          Lit(AtLayer((lambda $l#0#ly#0: LayerType :: 
                Handle1((lambda $l#0#heap#0: Heap, $l#0#i#0: Box :: $Box($Unbox($l#0#i#0): int)), 
    ...
    assume $IsHeapAnchor($Heap);
    arrInt#0 := $nw;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(537,17)
    assume true;
    ...
    if (*)
    {
        ...
        if (LitInt(0) <= _v10#0)
        {
            ...
            assert {:id "id292"} LitInt(0) <= newtype$check#0 && newtype$check#0 < 256;
            assume {:id "id293"} lambdaResult#1 == LitInt(2);
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(lambdaResult#1, Tclass.ArrayToSeq.byte());
        }
    ...
    // End Comprehension WF check
    havoc $nw;
    assume $nw != null && $Is($nw, Tclass._System.array?(Tclass.ArrayToSeq.byte()));
    assume !$Unbox(read($Heap, $nw, alloc)): bool;
    assume _System.array.Length($nw) == LitInt(5);
    assert {:id "id294"} {:subsumption 0} (forall arrayinit#1#i0#0: int :: 
      0 <= arrayinit#1#i0#0 && arrayinit#1#i0#0 < LitInt(5)
         ==> Requires1(Tclass._System.nat(), 
          Tclass.ArrayToSeq.byte(), 
          $Heap, 
          Lit(AtLayer((lambda $l#1#ly#0: LayerType :: 
                Handle1((lambda $l#1#heap#0: Heap, $l#1#_v10#0: Box :: $Box(LitInt(2))), 
                  (lambda $l#1#heap#0: Heap, $l#1#_v10#0: Box :: 
                    $IsBox($l#1#_v10#0, Tclass._System.nat())), 
                  (lambda $l#1#heap#0: Heap, $l#1#_v10#0: Box :: 
    ...
    assume $IsHeapAnchor($Heap);
    arrByte#0 := $nw;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(538,20)
    assume true;
    havoc $nw;
    assume $nw != null && $Is($nw, Tclass.ArrayToSeq.MyClass?());
    assume !$Unbox(read($Heap, $nw, alloc)): bool;
    $Heap := update($Heap, $nw, alloc, $Box(true));
    assume $IsGoodHeap($Heap);
    assume $IsHeapAnchor($Heap);
    c#0 := $nw;
    defass#c#0 := true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(539,25)
    assume true;
    assert {:id "id297"} defass#c#0;
    assume true;
    tr#0 := c#0;
    defass#tr#0 := true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(540,18)
    assume true;
    assert {:id "id299"} 0 <= LitInt(3);
    assert {:id "id300"} LitInt(3) == 3;
    assert {:id "id301"} defass#c#0;
    assert {:id "id302"} defass#c#0;
    assert {:id "id303"} defass#c#0;
    havoc $nw;
    assume $nw != null && $Is($nw, Tclass._System.array?(Tclass.ArrayToSeq.MyClass()));
    assume !$Unbox(read($Heap, $nw, alloc)): bool;
    assume _System.array.Length($nw) == LitInt(3);
    assume $Unbox(read($Heap, $nw, IndexField(0))): ref == c#0;
    assume $Unbox(read($Heap, $nw, IndexField(1))): ref == c#0;
    assume $Unbox(read($Heap, $nw, IndexField(2))): ref == c#0;
    $Heap := update($Heap, $nw, alloc, $Box(true));
    assume $IsGoodHeap($Heap);
    assume $IsHeapAnchor($Heap);
    arrClass#0 := $nw;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(541,18)
    assume true;
    assert {:id "id305"} 0 <= LitInt(3);
    assert {:id "id306"} LitInt(3) == 3;
    assert {:id "id307"} defass#tr#0;
    assert {:id "id308"} defass#c#0;
    assert {:id "id309"} defass#tr#0;
    havoc $nw;
    assume $nw != null && $Is($nw, Tclass._System.array?(Tclass.ArrayToSeq.TraitMeRite()));
    assume !$Unbox(read($Heap, $nw, alloc)): bool;
    assume _System.array.Length($nw) == LitInt(3);
    assume $Unbox(read($Heap, $nw, IndexField(0))): ref == tr#0;
    assume $Unbox(read($Heap, $nw, IndexField(1))): ref == c#0;
    assume $Unbox(read($Heap, $nw, IndexField(2))): ref == tr#0;
    $Heap := update($Heap, $nw, alloc, $Box(true));
    assume $IsGoodHeap($Heap);
    assume $IsHeapAnchor($Heap);
    arrTrait#0 := $nw;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(543,12)
    assume true;
    assert {:id "id311"} arrChar#0 != null;
    assume true;
    s0#0 := Seq#FromArray($Heap, arrChar#0);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(544,12)
    assume true;
    assert {:id "id313"} arrInt#0 != null;
    assume true;
    s1#0 := Seq#FromArray($Heap, arrInt#0);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(545,12)
    assume true;
    assert {:id "id315"} arrByte#0 != null;
    assume true;
    s2#0 := Seq#FromArray($Heap, arrByte#0);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(546,12)
    assume true;
    assert {:id "id317"} arrClass#0 != null;
    assume true;
    s3#0 := Seq#FromArray($Heap, arrClass#0);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(547,12)
    assume true;
    assert {:id "id319"} arrTrait#0 != null;
    assume true;
    s4#0 := Seq#FromArray($Heap, arrTrait#0);
    // ----- expect statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(549,5)
    assume true;
    if (!Seq#Equal(s0#0, 
      Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(104))), $Box(char#FromInt(101))), 
    ...
    // ----- expect statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(550,5)
    assert {:id "id321"} arrInt#0 != null;
    assert {:id "id322"} {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= _System.array.Length(arrInt#0);
    assert {:id "id323"} {:subsumption 0} 0 <= LitInt(2)
       && LitInt(2) <= Seq#Length(Seq#Drop(Seq#FromArray($Heap, arrInt#0), LitInt(1)));
    assert {:id "id324"} arrInt#0 != null;
    assert {:id "id325"} {:subsumption 0} 0 <= LitInt(3) && LitInt(3) <= _System.array.Length(arrInt#0);
    assert {:id "id326"} {:subsumption 0} 0 <= LitInt(1)
       && LitInt(1) <= Seq#Length(Seq#Take(Seq#FromArray($Heap, arrInt#0), LitInt(3)));
    assume true;
    if (!Seq#Equal(Seq#Take(Seq#Drop(Seq#FromArray($Heap, arrInt#0), LitInt(1)), LitInt(2)), 
      Seq#Drop(Seq#Take(Seq#FromArray($Heap, arrInt#0), LitInt(3)), LitInt(1))))
    {
        assume true;
        assume false;
    }

    // ----- expect statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(551,5)
    assert {:id "id327"} arrInt#0 != null;
    newtype$check#1 := LitInt(1);
    assert {:id "id328"} LitInt(0) <= newtype$check#1 && newtype$check#1 < 256;
    newtype$check#2 := LitInt(1);
    assert {:id "id329"} LitInt(0) <= newtype$check#2 && newtype$check#2 < 256;
    assert {:id "id330"} {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= _System.array.Length(arrInt#0);
    assert {:id "id331"} {:subsumption 0} 0 <= LitInt(2)
       && LitInt(2) <= Seq#Length(Seq#Drop(Seq#FromArray($Heap, arrInt#0), LitInt(1)));
    assert {:id "id332"} arrInt#0 != null;
    newtype$check#3 := LitInt(3);
    assert {:id "id333"} LitInt(0) <= newtype$check#3 && newtype$check#3 < 256;
    newtype$check#4 := LitInt(3);
    assert {:id "id334"} LitInt(0) <= newtype$check#4 && newtype$check#4 < 256;
    assert {:id "id335"} {:subsumption 0} 0 <= LitInt(3) && LitInt(3) <= _System.array.Length(arrInt#0);
    assert {:id "id336"} {:subsumption 0} 0 <= LitInt(1)
       && LitInt(1) <= Seq#Length(Seq#Take(Seq#FromArray($Heap, arrInt#0), LitInt(3)));
    assume true;
    if (!Seq#Equal(Seq#Take(Seq#Drop(Seq#FromArray($Heap, arrInt#0), LitInt(1)), LitInt(2)), 
      Seq#Drop(Seq#Take(Seq#FromArray($Heap, arrInt#0), LitInt(3)), LitInt(1))))
    ...
    // ----- expect statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(552,5)
    assert {:id "id337"} arrInt#0 != null;
    newtype$check#5 := LitInt(1);
    assert {:id "id338"} LitInt(0) <= newtype$check#5 && newtype$check#5 < 256;
    newtype$check#6 := LitInt(1);
    assert {:id "id339"} LitInt(0) <= newtype$check#6 && newtype$check#6 < 256;
    assert {:id "id340"} {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= _System.array.Length(arrInt#0);
    assert {:id "id341"} {:subsumption 0} LitInt(1) <= LitInt(3) && LitInt(3) <= _System.array.Length(arrInt#0);
    assert {:id "id342"} arrInt#0 != null;
    assert {:id "id343"} {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= _System.array.Length(arrInt#0);
    newtype$check#7 := LitInt(3);
    assert {:id "id344"} LitInt(0) <= newtype$check#7 && newtype$check#7 < 256;
    newtype$check#8 := LitInt(3);
    assert {:id "id345"} LitInt(0) <= newtype$check#8 && newtype$check#8 < 256;
    assert {:id "id346"} {:subsumption 0} LitInt(1) <= LitInt(3) && LitInt(3) <= _System.array.Length(arrInt#0);
    assume true;
    if (!Seq#Equal(Seq#Drop(Seq#Take(Seq#FromArray($Heap, arrInt#0), LitInt(3)), LitInt(1)), 
      Seq#Drop(Seq#Take(Seq#FromArray($Heap, arrInt#0), LitInt(3)), LitInt(1))))
    {
        assume true;
        assume false;
    ...
    // ----- expect statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(553,5)
    assert {:id "id347"} arrByte#0 != null;
    assert {:id "id348"} {:subsumption 0} 0 <= LitInt(0) && LitInt(0) <= _System.array.Length(arrByte#0);
    assert {:id "id349"} arrByte#0 != null;
    assert {:id "id350"} {:subsumption 0} 0 <= LitInt(5) && LitInt(5) <= _System.array.Length(arrByte#0);
    if (Seq#Length(Seq#Take(Seq#FromArray($Heap, arrByte#0), LitInt(0)))
         <= Seq#Length(Seq#Drop(Seq#FromArray($Heap, arrByte#0), LitInt(5)))
       && Seq#SameUntil(Seq#Take(Seq#FromArray($Heap, arrByte#0), LitInt(0)), 
        Seq#Drop(Seq#FromArray($Heap, arrByte#0), LitInt(5)), 
        Seq#Length(Seq#Take(Seq#FromArray($Heap, arrByte#0), LitInt(0)))))
    {
        assert {:id "id351"} arrByte#0 != null;
        assert {:id "id352"} {:subsumption 0} 0 <= LitInt(5) && LitInt(5) <= _System.array.Length(arrByte#0);
        assert {:id "id353"} arrByte#0 != null;
        assert {:id "id354"} {:subsumption 0} 0 <= LitInt(3) && LitInt(3) <= _System.array.Length(arrByte#0);
    }
    ...
    if (Seq#Length(Seq#Take(Seq#FromArray($Heap, arrByte#0), LitInt(0)))
       ...
       && 
      Seq#Length(Seq#Drop(Seq#FromArray($Heap, arrByte#0), LitInt(5)))
         <= Seq#Length(Seq#Take(Seq#FromArray($Heap, arrByte#0), LitInt(3)))
       && Seq#SameUntil(Seq#Drop(Seq#FromArray($Heap, arrByte#0), LitInt(5)), 
        Seq#Take(Seq#FromArray($Heap, arrByte#0), LitInt(3)), 
        Seq#Length(Seq#Drop(Seq#FromArray($Heap, arrByte#0), LitInt(5)))))
    {
        assert {:id "id355"} arrByte#0 != null;
        assert {:id "id356"} {:subsumption 0} 0 <= LitInt(3) && LitInt(3) <= _System.array.Length(arrByte#0);
    }
    ...
    if (!(
      ...
      Seq#Length(Seq#Take(Seq#FromArray($Heap, arrByte#0), LitInt(3)))
         <= Seq#Length(s2#0)
       && Seq#SameUntil(Seq#Take(Seq#FromArray($Heap, arrByte#0), LitInt(3)), 
        s2#0, 
        Seq#Length(Seq#Take(Seq#FromArray($Heap, arrByte#0), LitInt(3))))))
    {
        assume true;
    ...
    // ----- expect statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(554,5)
    assume true;
    if (!Seq#Equal(s3#0, s4#0))
    {
        assume true;
        assume false;
    }

    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(556,5)
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(557,5)
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(558,5)
    assume true;
    assume true;
}
...
procedure {:verboseName "ArrayToSeq.byte (well-formedness)"} CheckWellFormed$$ArrayToSeq.byte(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ArrayToSeq.byte (well-formedness)"} CheckWellFormed$$ArrayToSeq.byte(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assume {:id "id357"} LitInt(0) <= x#0 && x#0 < 256;
        assume false;
    }
    ...
    if (*)
    {
        ...
        assume true;
        assert {:id "id358"} {:subsumption 0} LitInt(0) <= LitInt(0);
        assert {:id "id359"} {:subsumption 0} Lit(0 < 256);
        assume false;
    }
}
