...
(declare-fun _module.__default.TriangleNumber__ORDINAL (T@U Int) T@U)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly T@U) (|n#0| Int) ) (!  (=> (or (|_module.__default.TriangleNumber__ORDINAL#canCall| |n#0|) (and (< 0 $FunctionContextHeight) (<= (LitInt 0) |n#0|))) (and (=> (or (not (= |n#0| (LitInt 0))) (not true)) (|_module.__default.TriangleNumber__ORDINAL#canCall| (- |n#0| 1))) (= (_module.__default.TriangleNumber__ORDINAL ($LS $ly) |n#0|) (ite (= |n#0| (LitInt 0)) (|ORD#FromNat| 0) (|ORD#Plus| (_module.__default.TriangleNumber__ORDINAL $ly (- |n#0| 1)) (|ORD#FromNat| |n#0|))))))
 :qid |TailRecursiondfy.189:27|
 :skolemid |1172|
 :pattern ( (_module.__default.TriangleNumber__ORDINAL ($LS $ly) |n#0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@0 T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.__default.TriangleNumber__ORDINAL#canCall| (LitInt |n#0@@0|)) (and (< 0 $FunctionContextHeight) (<= (LitInt 0) |n#0@@0|))) (and (=> (or (not (= (LitInt |n#0@@0|) (LitInt 0))) (not true)) (|_module.__default.TriangleNumber__ORDINAL#canCall| (LitInt (- |n#0@@0| 1)))) (= (_module.__default.TriangleNumber__ORDINAL ($LS $ly@@0) (LitInt |n#0@@0|)) (ite (= (LitInt |n#0@@0|) (LitInt 0)) (|ORD#FromNat| 0) (|ORD#Plus| (_module.__default.TriangleNumber__ORDINAL ($LS $ly@@0) (LitInt (- |n#0@@0| 1))) (|ORD#FromNat| (LitInt |n#0@@0|)))))))
 :qid |TailRecursiondfy.189:27|
 :weight 3
 :skolemid |1173|
 :pattern ( (_module.__default.TriangleNumber__ORDINAL ($LS $ly@@0) (LitInt |n#0@@0|)))
))))
...
(assert (forall (($ly@@1 T@U) (|n#0@@1| Int) ) (! (= (_module.__default.TriangleNumber__ORDINAL ($LS $ly@@1) |n#0@@1|) (_module.__default.TriangleNumber__ORDINAL $ly@@1 |n#0@@1|))
 :qid |TailRecursiondfy.189:27|
 :skolemid |1168|
 :pattern ( (_module.__default.TriangleNumber__ORDINAL ($LS $ly@@1) |n#0@@1|))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.TriangleNumber__ORDINAL)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon8_Else_correct  (=> (or (not (= |n#0@@2| (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 7)) ($Is intType (int_2_U (- |n#0@@2| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0@@2| 1)) Tclass._System.nat) (=> (and (= |##n#0@0| (- |n#0@@2| 1)) ($IsAlloc intType (int_2_U |##n#0@0|) Tclass._System.nat $Heap)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (or (<= 0 |n#0@@2|) (= |##n#0@0| |n#0@@2|))) (=> (or (<= 0 |n#0@@2|) (= |##n#0@0| |n#0@@2|)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< |##n#0@0| |n#0@@2|)) (=> (< |##n#0@0| |n#0@@2|) (=> (and (|_module.__default.TriangleNumber__ORDINAL#canCall| (- |n#0@@2| 1)) (= (ControlFlow 0 4) (- 0 3))) (<= 0 |n#0@@2|))))))))))))
