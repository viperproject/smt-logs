...
(declare-fun TypeTests.SubsetInBetween$G () T@U)
(declare-fun TypeTests.SubsetInBetween$H () T@U)
(declare-fun |y#0| () Int)
...
(set-info :boogie-vc-id CheckWellFormed$$TypeTests.SubsetInBetween)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon6_Then_correct  (=> (= |newtype$check#1@0| (LitInt 0)) (and (=> (= (ControlFlow 0 4) (- 0 7)) (and (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 10000)) (or (not (= |newtype$check#1@0| 22)) (not true)))) (=> (and (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 10000)) (or (not (= |newtype$check#1@0| 22)) (not true))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (or (not (= |newtype$check#1@0| 10)) (not true))) (=> (or (not (= |newtype$check#1@0| 10)) (not true)) (=> (=> (U_2_bool (Lit boolType (bool_2_U  (or (not (= 0 34)) (not true))))) (and (|TypeTests.__default.EmptySequence#canCall| TypeTests.SubsetInBetween$G) (|TypeTests.__default.EmptySequence#canCall| TypeTests.SubsetInBetween$H))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (U_2_bool (Lit boolType (bool_2_U  (or (not (= 0 34)) (not true)))))) (=> (= (ControlFlow 0 4) (- 0 3)) (= (|Seq#Length| (Lit SeqType (TypeTests.__default.EmptySequence TypeTests.SubsetInBetween$G))) (|Seq#Length| (Lit SeqType (TypeTests.__default.EmptySequence TypeTests.SubsetInBetween$H))))))))))))))
(let ((anon5_Then_correct  (=> (and (and (and (and (<= (LitInt 0) |y#0|) (< |y#0| 10000)) (or (not (= |y#0| 22)) (not true))) (or (not (= |y#0| 10)) (not true))) (and (= |newtype$check#0@0| (LitInt 34)) (= (ControlFlow 0 2) (- 0 1)))) (and (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 10000)) (or (not (= |newtype$check#0@0| 22)) (not true))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (and (=> (= (ControlFlow 0 8) 2) anon5_Then_correct) (=> (= (ControlFlow 0 8) 4) anon6_Then_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct)))
