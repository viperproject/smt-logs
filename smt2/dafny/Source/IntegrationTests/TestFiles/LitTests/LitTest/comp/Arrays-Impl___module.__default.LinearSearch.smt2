...
(set-info :boogie-vc-id Impl$$_module.__default.LinearSearch)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 26) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 11) (- 0 13)) (<= (LitInt 0) |n#0@3|)) (=> (<= (LitInt 0) |n#0@3|) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= |n#0@3| (_System.array.Length |a#0|))) (=> (<= |n#0@3| (_System.array.Length |a#0|)) (=> (= (ControlFlow 0 11) (- 0 10)) (or (= |n#0@3| (_System.array.Length |a#0|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |n#0@3|)))) |key#0|)))))))))
(let ((anon13_Then_correct  (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |n#0@1|)))) |key#0|) (=> (and (= |n#0@3| |n#0@1|) (= (ControlFlow 0 15) 11)) GeneratedUnifiedExit_correct))))
(let ((anon12_Then_correct  (=> (<= (_System.array.Length |a#0|) |n#0@1|) (=> (and (= |n#0@3| |n#0@1|) (= (ControlFlow 0 14) 11)) GeneratedUnifiedExit_correct))))
(let ((anon13_Else_correct  (=> (or (not (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |n#0@1|)))) |key#0|)) (not true)) (and (=> (= (ControlFlow 0 6) (- 0 9)) ($Is intType (int_2_U (+ |n#0@1| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ |n#0@1| 1)) Tclass._System.nat) (=> (= |n#0@2| (+ |n#0@1| 1)) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (<= 0 |$decr$loop#00@1|) (= (- (_System.array.Length |a#0|) |n#0@2|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- (_System.array.Length |a#0|) |n#0@2|) |$decr$loop#00@1|)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (< (- (_System.array.Length |a#0|) |n#0@2|) |$decr$loop#00@1|)) (=> (< (- (_System.array.Length |a#0|) |n#0@2|) |$decr$loop#00@1|) (=> (= (ControlFlow 0 6) (- 0 5)) (=> |$w$loop#0@0| (<= |n#0@2| (_System.array.Length |a#0|))))))))))))))
(let ((anon12_Else_correct  (=> (and (< |n#0@1| (_System.array.Length |a#0|)) (= |$decr$loop#00@1| (- (_System.array.Length |a#0|) |n#0@1|))) (and (=> (= (ControlFlow 0 16) (- 0 18)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (and (<= 0 |n#0@1|) (< |n#0@1| (_System.array.Length |a#0|)))) (=> (and (<= 0 |n#0@1|) (< |n#0@1| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 16) 15) anon13_Then_correct) (=> (= (ControlFlow 0 16) 6) anon13_Else_correct)))))))))
(let ((anon11_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 19) (- 0 20)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 19) 14) anon12_Then_correct) (=> (= (ControlFlow 0 19) 16) anon12_Else_correct)))))))
(let ((anon11_Then_correct  (=> (not |$w$loop#0@0|) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= |a#0| null)) (not true))) (=> (and (<= |n#0@1| (_System.array.Length |a#0|)) (= (ControlFlow 0 3) (- 0 2))) (or (not (= |a#0| null)) (not true)))))))
(let ((anon10_LoopBody_correct  (and (=> (= (ControlFlow 0 21) 3) anon11_Then_correct) (=> (= (ControlFlow 0 21) 19) anon11_Else_correct))))
(let ((anon10_LoopDone_correct true))
(let ((anon10_LoopHead_correct  (=> (<= (LitInt 0) |n#0@1|) (=> (and (and (and (<= 0 |n#0@1|) (not false)) (=> |$w$loop#0@0| (<= |n#0@1| (_System.array.Length |a#0|)))) (and (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6)))
 :qid |Arraysdfy.8:3|
 :skolemid |7468|
...
)) (<= (- (_System.array.Length |a#0|) |n#0@1|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 22) 1) anon10_LoopDone_correct) (=> (= (ControlFlow 0 22) 21) anon10_LoopBody_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 23) (- 0 25)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (and (= |n#0@0| (LitInt 0)) (= |$decr_init$loop#00@0| (- (_System.array.Length |a#0|) |n#0@0|))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (=> |$w$loop#0@0| (<= |n#0@0| (_System.array.Length |a#0|)))) (=> (=> |$w$loop#0@0| (<= |n#0@0| (_System.array.Length |a#0|))) (=> (= (ControlFlow 0 23) 22) anon10_LoopHead_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (<= (LitInt 0) |n#0|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 26) 23))) anon0_correct))))
