...
(assert (distinct TInt TagInt TagSet TagMap alloc |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass.Regressions.uint32 |tytagFamily$_tuple#2| tytagFamily$uint32)
)
...
(set-info :boogie-vc-id Impl$$Regressions.__default.TestMap)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |newtype$check#0@0| (LitInt 1))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 4294967296))) (=> (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 4294967296)) (=> (= |newtype$check#1@0| (LitInt 123)) (and (=> (= (ControlFlow 0 2) (- 0 12)) (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 4294967296))) (=> (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 4294967296)) (=> (and (= |s#0@0| (Lit MapType (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 1))) ($Box intType (int_2_U (LitInt 123)))))) (= |newtype$check#2@0| (LitInt 1))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (and (<= (LitInt 0) |newtype$check#2@0|) (< |newtype$check#2@0| 4294967296))) (=> (and (<= (LitInt 0) |newtype$check#2@0|) (< |newtype$check#2@0| 4294967296)) (=> (= |newtype$check#3@0| (LitInt 40)) (and (=> (= (ControlFlow 0 2) (- 0 10)) (and (<= (LitInt 0) |newtype$check#3@0|) (< |newtype$check#3@0| 4294967296))) (=> (and (<= (LitInt 0) |newtype$check#3@0|) (< |newtype$check#3@0| 4294967296)) (=> (and (= |u#0@0| (|Map#Build| |s#0@0| ($Box intType (int_2_U (LitInt 1))) ($Box intType (int_2_U (LitInt 40))))) (= |newtype$check#4@0| (LitInt 1))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (and (<= (LitInt 0) |newtype$check#4@0|) (< |newtype$check#4@0| 4294967296))) (=> (and (<= (LitInt 0) |newtype$check#4@0|) (< |newtype$check#4@0| 4294967296)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (|Set#IsMember| (|Map#Domain| |s#0@0|) ($Box intType (int_2_U (LitInt 1))))) (=> (= |newtype$check#5@0| (LitInt 1)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (and (<= (LitInt 0) |newtype$check#5@0|) (< |newtype$check#5@0| 4294967296))) (=> (and (<= (LitInt 0) |newtype$check#5@0|) (< |newtype$check#5@0| 4294967296)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (|Set#IsMember| (|Map#Domain| |u#0@0|) ($Box intType (int_2_U (LitInt 1))))) (=> (= |newtype$check#6@0| (LitInt 123)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= (LitInt 0) |newtype$check#6@0|) (< |newtype$check#6@0| 4294967296))) (=> (and (<= (LitInt 0) |newtype$check#6@0|) (< |newtype$check#6@0| 4294967296)) (=> (and (= |S#0@0| (Lit MapType (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 1))) ($Box intType (int_2_U (LitInt 123)))))) (= |newtype$check#7@0| (LitInt 41))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= (LitInt 0) |newtype$check#7@0|) (< |newtype$check#7@0| 4294967296))) (=> (and (<= (LitInt 0) |newtype$check#7@0|) (< |newtype$check#7@0| 4294967296)) (=> (= |U#0@0| (|Map#Build| |S#0@0| ($Box intType (int_2_U (LitInt 1))) ($Box intType (int_2_U (LitInt 41))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#IsMember| (|Map#Domain| |S#0@0|) ($Box intType (int_2_U (LitInt 1))))) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#IsMember| (|Map#Domain| |U#0@0|) ($Box intType (int_2_U (LitInt 1)))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is MapType |s#0| (TMap Tclass.Regressions.uint32 Tclass.Regressions.uint32)) ($IsAlloc MapType |s#0| (TMap Tclass.Regressions.uint32 Tclass.Regressions.uint32) $Heap)) true) (=> (and (and (and (and ($Is MapType |u#0| (TMap Tclass.Regressions.uint32 Tclass.Regressions.uint32)) ($IsAlloc MapType |u#0| (TMap Tclass.Regressions.uint32 Tclass.Regressions.uint32) $Heap)) true) (and (and ($Is MapType |S#0| (TMap TInt Tclass.Regressions.uint32)) ($IsAlloc MapType |S#0| (TMap TInt Tclass.Regressions.uint32) $Heap)) true)) (and (and (and ($Is MapType |U#0| (TMap TInt Tclass.Regressions.uint32)) ($IsAlloc MapType |U#0| (TMap TInt Tclass.Regressions.uint32) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 14) 2)))) anon0_correct)))))
