...
(assert (forall (($ly T@U) (|vs#0| T@U) ) (!  (=> (or (|Reverser.__default.Reverse#canCall| |vs#0|) ($Is SeqType |vs#0| (TSeq Tclass.Reverser.U8))) ($Is SeqType (Reverser.__default.Reverse $ly |vs#0|) Tclass.Reverser.WellFormedSequence))
 :qid |bymethoddfy.11:12|
 :skolemid |1488|
 :pattern ( (Reverser.__default.Reverse $ly |vs#0|))
)))
...
(assert (forall (($ly@@0 T@U) (|vs#0@@0| T@U) ) (!  (=> (or (|Reverser.__default.Reverse#canCall| |vs#0@@0|) ($Is SeqType |vs#0@@0| (TSeq Tclass.Reverser.U8))) (and (=> (or (not (= (|Seq#Length| |vs#0@@0|) (LitInt 0))) (not true)) (|Reverser.__default.Reverse#canCall| (|Seq#Drop| |vs#0@@0| (LitInt 1)))) (= (Reverser.__default.Reverse ($LS $ly@@0) |vs#0@@0|) (ite (= (|Seq#Length| |vs#0@@0|) (LitInt 0)) |Seq#Empty| (|Seq#Append| (Reverser.__default.Reverse $ly@@0 (|Seq#Drop| |vs#0@@0| (LitInt 1))) (|Seq#Build| |Seq#Empty| (|Seq#Index| |vs#0@@0| (LitInt 0))))))))
 :qid |bymethoddfy.11:12|
 :skolemid |1490|
 :pattern ( (Reverser.__default.Reverse ($LS $ly@@0) |vs#0@@0|))
)))
...
(assert (forall ((bx@@0 T@U) ) (!  (=> ($IsBox bx@@0 Tclass.Reverser.U8) (and (= ($Box intType ($Unbox intType bx@@0)) bx@@0) ($Is intType ($Unbox intType bx@@0) Tclass.Reverser.U8)))
 :qid |unknown.0:0|
 :skolemid |1472|
 :pattern ( ($IsBox bx@@0 Tclass.Reverser.U8))
)))
(assert (forall ((bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 Tclass.Reverser.WellFormedSequence) (and (= ($Box SeqType ($Unbox SeqType bx@@1)) bx@@1) ($Is SeqType ($Unbox SeqType bx@@1) Tclass.Reverser.WellFormedSequence)))
 :qid |unknown.0:0|
 :skolemid |1487|
 :pattern ( ($IsBox bx@@1 Tclass.Reverser.WellFormedSequence))
)))
...
(assert (forall (($ly@@1 T@U) (|vs#0@@1| T@U) ) (!  (=> (or (|Reverser.__default.Reverse#canCall| (Lit SeqType |vs#0@@1|)) ($Is SeqType |vs#0@@1| (TSeq Tclass.Reverser.U8))) (and (=> (or (not (= (|Seq#Length| (Lit SeqType |vs#0@@1|)) (LitInt 0))) (not true)) (|Reverser.__default.Reverse#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |vs#0@@1|) (LitInt 1))))) (= (Reverser.__default.Reverse ($LS $ly@@1) (Lit SeqType |vs#0@@1|)) (ite (= (|Seq#Length| (Lit SeqType |vs#0@@1|)) (LitInt 0)) |Seq#Empty| (|Seq#Append| (Reverser.__default.Reverse ($LS $ly@@1) (Lit SeqType (|Seq#Drop| (Lit SeqType |vs#0@@1|) (LitInt 1)))) (|Seq#Build| |Seq#Empty| (|Seq#Index| (Lit SeqType |vs#0@@1|) (LitInt 0))))))))
 :qid |bymethoddfy.11:12|
 :weight 3
 :skolemid |1491|
 :pattern ( (Reverser.__default.Reverse ($LS $ly@@1) (Lit SeqType |vs#0@@1|)))
)))
...
(assert (forall (($ly@@2 T@U) (|vs#0@@2| T@U) ) (! (= (Reverser.__default.Reverse ($LS $ly@@2) |vs#0@@2|) (Reverser.__default.Reverse $ly@@2 |vs#0@@2|))
 :qid |bymethoddfy.11:12|
 :skolemid |1485|
...
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |newtype$check#0@0| (LitInt 1))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 256))) (=> (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 256)) (=> (= |newtype$check#1@0| (LitInt 2)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 256))) (=> (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 256)) (=> (and (and (= |##vs#0@0| (Lit SeqType (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 2)))))) ($IsAlloc SeqType |##vs#0@0| (TSeq Tclass.Reverser.U8) $Heap)) (and (|Reverser.__default.Reverse#canCall| (Lit SeqType (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 2)))))) (= |newtype$check#2@0| (LitInt 2)))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (and (<= (LitInt 0) |newtype$check#2@0|) (< |newtype$check#2@0| 256))) (=> (and (<= (LitInt 0) |newtype$check#2@0|) (< |newtype$check#2@0| 256)) (=> (= |newtype$check#3@0| (LitInt 1)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= (LitInt 0) |newtype$check#3@0|) (< |newtype$check#3@0| 256))) (=> (and (<= (LitInt 0) |newtype$check#3@0|) (< |newtype$check#3@0| 256)) (=> (|Reverser.__default.Reverse#canCall| (Lit SeqType (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 2)))))) (and (=> (= (ControlFlow 0 3) 1) anon3_Then_correct) (=> (= (ControlFlow 0 3) 2) anon3_Else_correct)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 8) 3))) anon0_correct)))
