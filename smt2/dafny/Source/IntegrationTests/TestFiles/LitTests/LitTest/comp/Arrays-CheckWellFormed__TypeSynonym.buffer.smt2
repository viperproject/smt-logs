...
(declare-fun |a#0| () T@U)
(declare-fun TypeSynonym.buffer$T () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun $Heap () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id CheckWellFormed$$TypeSynonym.buffer)
...
(let ((anon5_Then_correct  (=> (and ($Is refType |a#0| (Tclass._System.array TypeSynonym.buffer$T)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |a#0| null)) (not true)))))
