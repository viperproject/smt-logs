...
(set-info :boogie-vc-id OverrideCheck$$All.Y.GetD)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (= TraitDefinitions.SubTrait$T@@11 TInt) (= TraitDefinitions.SubTrait$I@@11 All.Y$I@@10)) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@17 T@U) ($f T@U) ) (! true
 :qid |traitsdfy.105:12|
 :skolemid |2151|
))) (=> (forall (($o@@18 T@U) ($f@@0 T@U) ) (! true
 :qid |traitsdfy.105:12|
 :skolemid |2151|
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall (($o@@19 T@U) ($f@@1 T@U) ) (! true
 :qid |traitsdfy.105:12|
 :skolemid |2152|
)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass.All.Y All.Y$I@@10)) ($IsAlloc refType this (Tclass.All.Y All.Y$I@@10) $Heap))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct))))
