...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (= TraitDefinitions.SubTrait$T@@11 TInt) (= TraitDefinitions.SubTrait$I@@11 All.Y$I@@10)) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@17 T@U) ($f T@U) ) true)) (=> (forall (($o@@18 T@U) ($f@@0 T@U) ) true) (=> (= (ControlFlow 0 2) (- 0 1)) (forall (($o@@19 T@U) ($f@@1 T@U) ) true))))))))
