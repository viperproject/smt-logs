...
(declare-fun Tagclass.ArrayAllocationInitialization.byte () T@U)
...
(declare-fun Tclass.ArrayAllocationInitialization.byte () T@U)
(declare-fun $FunctionContextHeight () Int)
(declare-fun ArrayAllocationInitialization.__default.ByteF (Int) Int)
(declare-fun |ArrayAllocationInitialization.__default.ByteF#canCall| (Int) Bool)
...
(declare-fun |ArrayAllocationInitialization.__default.ByteF#Handle| () T@U)
(declare-fun |ArrayAllocationInitialization.__default.ByteF#requires| (Int) Bool)
...
(assert (distinct TInt TagInt TagSeq alloc Tagclass._System.nat Tagclass._System.array? Tagclass._System.array Tagclass._System.___hFunc1 Tagclass.ArrayAllocationInitialization.byte tytagFamily$nat tytagFamily$array |tytagFamily$_#Func1| tytagFamily$byte)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((|x#0@@0| T@U) ($h@@0 T@U) ) (! ($IsAlloc intType |x#0@@0| Tclass.ArrayAllocationInitialization.byte $h@@0)
 :qid |unknown.0:0|
 :skolemid |4547|
 :pattern ( ($IsAlloc intType |x#0@@0| Tclass.ArrayAllocationInitialization.byte $h@@0))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|i#0| Int) ) (!  (=> (or (|ArrayAllocationInitialization.__default.ByteF#canCall| |i#0|) (and (< 1 $FunctionContextHeight) (<= (LitInt 0) |i#0|))) (= (ArrayAllocationInitialization.__default.ByteF |i#0|) (ite  (and (<= (LitInt 20) |i#0|) (< |i#0| 30)) |i#0| 60)))
 :qid |Arraysdfy.569:18|
 :skolemid |4407|
 :pattern ( (ArrayAllocationInitialization.__default.ByteF |i#0|))
))))
...
(assert (forall (($heap T@U) (|$fh$0x#0| T@U) ) (! (= (Requires1 Tclass._System.nat Tclass.ArrayAllocationInitialization.byte $heap |ArrayAllocationInitialization.__default.ByteF#Handle| |$fh$0x#0|) (|ArrayAllocationInitialization.__default.ByteF#requires| (U_2_int ($Unbox intType |$fh$0x#0|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |4438|
 :pattern ( (Requires1 Tclass._System.nat Tclass.ArrayAllocationInitialization.byte $heap |ArrayAllocationInitialization.__default.ByteF#Handle| |$fh$0x#0|))
)))
...
(assert (forall ((|i#0@@0| Int) ) (!  (=> (<= (LitInt 0) |i#0@@0|) (= (|ArrayAllocationInitialization.__default.ByteF#requires| |i#0@@0|) true))
 :qid |Arraysdfy.569:18|
 :skolemid |4406|
 :pattern ( (|ArrayAllocationInitialization.__default.ByteF#requires| |i#0@@0|))
)))
(assert (forall (($bx T@U) ($heap@@0 T@U) (|$fh$0x#0@@0| T@U) ) (! (= (|Set#IsMember| (Reads1 Tclass._System.nat Tclass.ArrayAllocationInitialization.byte $heap@@0 |ArrayAllocationInitialization.__default.ByteF#Handle| |$fh$0x#0@@0|) $bx) false)
 :qid |unknown.0:0|
 :skolemid |4439|
 :pattern ( (|Set#IsMember| (Reads1 Tclass._System.nat Tclass.ArrayAllocationInitialization.byte $heap@@0 |ArrayAllocationInitialization.__default.ByteF#Handle| |$fh$0x#0@@0|) $bx))
)))
...
(assert (forall (($heap@@1 T@U) (|$fh$0x#0@@1| T@U) ) (! (= (Apply1 Tclass._System.nat Tclass.ArrayAllocationInitialization.byte $heap@@1 |ArrayAllocationInitialization.__default.ByteF#Handle| |$fh$0x#0@@1|) ($Box intType (int_2_U (ArrayAllocationInitialization.__default.ByteF (U_2_int ($Unbox intType |$fh$0x#0@@1|))))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |4437|
 :pattern ( (Apply1 Tclass._System.nat Tclass.ArrayAllocationInitialization.byte $heap@@1 |ArrayAllocationInitialization.__default.ByteF#Handle| |$fh$0x#0@@1|))
)))
...
(assert (forall ((bx@@3 T@U) ) (!  (=> ($IsBox bx@@3 Tclass.ArrayAllocationInitialization.byte) (and (= ($Box intType ($Unbox intType bx@@3)) bx@@3) ($Is intType ($Unbox intType bx@@3) Tclass.ArrayAllocationInitialization.byte)))
 :qid |unknown.0:0|
 :skolemid |4409|
 :pattern ( ($IsBox bx@@3 Tclass.ArrayAllocationInitialization.byte))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|i#0@@1| Int) ) (!  (=> (or (|ArrayAllocationInitialization.__default.ByteF#canCall| (LitInt |i#0@@1|)) (and (< 1 $FunctionContextHeight) (<= (LitInt 0) |i#0@@1|))) (= (ArrayAllocationInitialization.__default.ByteF (LitInt |i#0@@1|)) (ite  (and (<= (LitInt 20) (LitInt |i#0@@1|)) (< |i#0@@1| 30)) |i#0@@1| 60)))
 :qid |Arraysdfy.569:18|
 :weight 3
 :skolemid |4408|
 :pattern ( (ArrayAllocationInitialization.__default.ByteF (LitInt |i#0@@1|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|i#0@@2| Int) ) (!  (=> (or (|ArrayAllocationInitialization.__default.ByteF#canCall| |i#0@@2|) (and (< 1 $FunctionContextHeight) (<= (LitInt 0) |i#0@@2|))) (and (<= (LitInt 0) (ArrayAllocationInitialization.__default.ByteF |i#0@@2|)) (< (ArrayAllocationInitialization.__default.ByteF |i#0@@2|) 256)))
 :qid |Arraysdfy.569:18|
 :skolemid |4405|
 :pattern ( (ArrayAllocationInitialization.__default.ByteF |i#0@@2|))
))))
...
(assert (forall (($heap@@2 T@U) (|$fh$0x#0@@2| Int) ) (! (= (ArrayAllocationInitialization.__default.ByteF |$fh$0x#0@@2|) (U_2_int ($Unbox intType (Apply1 Tclass._System.nat Tclass.ArrayAllocationInitialization.byte $heap@@2 |ArrayAllocationInitialization.__default.ByteF#Handle| ($Box intType (int_2_U |$fh$0x#0@@2|))))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |4440|
 :pattern ( (ArrayAllocationInitialization.__default.ByteF |$fh$0x#0@@2|) ($IsGoodHeap $heap@@2))
)))
...
(assert (= (Tag Tclass.ArrayAllocationInitialization.byte) Tagclass.ArrayAllocationInitialization.byte))
(assert (= (TagFamily Tclass.ArrayAllocationInitialization.byte) tytagFamily$byte))
...
(assert (forall ((|x#0@@2| T@U) ) (! (= ($Is intType |x#0@@2| Tclass.ArrayAllocationInitialization.byte)  (and (<= (LitInt 0) (U_2_int |x#0@@2|)) (< (U_2_int |x#0@@2|) 256)))
 :qid |unknown.0:0|
 :skolemid |4546|
 :pattern ( ($Is intType |x#0@@2| Tclass.ArrayAllocationInitialization.byte))
)))
...
(declare-fun |a#0| () T@U)
(declare-fun |s#0| () T@U)
(set-info :boogie-vc-id Impl$$ArrayAllocationInitialization.__default.TestByte)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 36) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |$rhs#0@0| (LitInt 0)) (= |$rhs#1@0| (LitInt 5))) (=> (and (and ($Is refType |a#0@0| (Tclass._System.array Tclass.ArrayAllocationInitialization.byte)) ($IsAlloc refType |a#0@0| (Tclass._System.array Tclass.ArrayAllocationInitialization.byte) $Heap)) (= |s#0@0| (Lit SeqType |Seq#Empty|))) (and (=> (= (ControlFlow 0 2) (- 0 35)) (<= 0 |$rhs#0@0|)) (=> (<= 0 |$rhs#0@0|) (=> (and (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? Tclass.ArrayAllocationInitialization.byte))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc))))) (and (and (= (_System.array.Length $nw@0) |$rhs#0@0|) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 34)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (=> (= |s#0@1| (|Seq#Append| |s#0@0| (|Seq#FromArray| $Heap@0 $nw@0))) (and (=> (= (ControlFlow 0 2) (- 0 33)) (<= 0 |$rhs#1@0|)) (=> (<= 0 |$rhs#1@0|) (=> (and (and (and (or (not (= $nw@1 null)) (not true)) ($Is refType $nw@1 (Tclass._System.array? Tclass.ArrayAllocationInitialization.byte))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1) alloc))))) (and (and (= (_System.array.Length $nw@1) |$rhs#1@0|) (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)))) (and (=> (= (ControlFlow 0 2) (- 0 32)) (or (not (= $nw@1 null)) (not true))) (=> (or (not (= $nw@1 null)) (not true)) (=> (= |s#0@2| (|Seq#Append| |s#0@1| (|Seq#FromArray| $Heap@1 $nw@1))) (and (=> (= (ControlFlow 0 2) (- 0 31)) (<= 0 |$rhs#0@0|)) (=> (<= 0 |$rhs#0@0|) (and (=> (= (ControlFlow 0 2) (- 0 30)) (= |$rhs#0@0| 0)) (=> (= |$rhs#0@0| 0) (=> (and (and (and (or (not (= $nw@2 null)) (not true)) ($Is refType $nw@2 (Tclass._System.array? Tclass.ArrayAllocationInitialization.byte))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@2) alloc))))) (and (and (= (_System.array.Length $nw@2) |$rhs#0@0|) (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 $nw@2 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@2) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)))) (and (=> (= (ControlFlow 0 2) (- 0 29)) (or (not (= $nw@2 null)) (not true))) (=> (or (not (= $nw@2 null)) (not true)) (=> (= |s#0@3| (|Seq#Append| |s#0@2| (|Seq#FromArray| $Heap@2 $nw@2))) (and (=> (= (ControlFlow 0 2) (- 0 28)) (<= 0 (LitInt 0))) (=> (<= 0 (LitInt 0)) (and (=> (= (ControlFlow 0 2) (- 0 27)) (= (LitInt 0) 0)) (=> (= (LitInt 0) 0) (=> (and (and (and (or (not (= $nw@3 null)) (not true)) ($Is refType $nw@3 (Tclass._System.array? Tclass.ArrayAllocationInitialization.byte))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@3) alloc))))) (and (and (= (_System.array.Length $nw@3) (LitInt 0)) (= $Heap@3 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@2 $nw@3 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@3) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)))) (and (=> (= (ControlFlow 0 2) (- 0 26)) (or (not (= $nw@3 null)) (not true))) (=> (or (not (= $nw@3 null)) (not true)) (=> (= |s#0@4| (|Seq#Append| |s#0@3| (|Seq#FromArray| $Heap@3 $nw@3))) (and (=> (= (ControlFlow 0 2) (- 0 25)) (<= 0 |$rhs#1@0|)) (=> (<= 0 |$rhs#1@0|) (and (=> (= (ControlFlow 0 2) (- 0 24)) (= |$rhs#1@0| 5)) (=> (= |$rhs#1@0| 5) (=> (= |newtype$check#0@0| (LitInt 20)) (and (=> (= (ControlFlow 0 2) (- 0 23)) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 256))) (=> (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 256)) (=> (= |newtype$check#1@0| (LitInt 21)) (and (=> (= (ControlFlow 0 2) (- 0 22)) (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 256))) (=> (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 256)) (=> (= |newtype$check#2@0| (LitInt 22)) (and (=> (= (ControlFlow 0 2) (- 0 21)) (and (<= (LitInt 0) |newtype$check#2@0|) (< |newtype$check#2@0| 256))) (=> (and (<= (LitInt 0) |newtype$check#2@0|) (< |newtype$check#2@0| 256)) (=> (= |newtype$check#3@0| (LitInt 23)) (and (=> (= (ControlFlow 0 2) (- 0 20)) (and (<= (LitInt 0) |newtype$check#3@0|) (< |newtype$check#3@0| 256))) (=> (and (<= (LitInt 0) |newtype$check#3@0|) (< |newtype$check#3@0| 256)) (=> (= |newtype$check#4@0| (LitInt 24)) (and (=> (= (ControlFlow 0 2) (- 0 19)) (and (<= (LitInt 0) |newtype$check#4@0|) (< |newtype$check#4@0| 256))) (=> (and (<= (LitInt 0) |newtype$check#4@0|) (< |newtype$check#4@0| 256)) (=> (and (and (or (not (= $nw@4 null)) (not true)) ($Is refType $nw@4 (Tclass._System.array? Tclass.ArrayAllocationInitialization.byte))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@4) alloc)))) (= (_System.array.Length $nw@4) |$rhs#1@0|))) (=> (and (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@4) (IndexField 0)))) (LitInt 20)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@4) (IndexField 1)))) (LitInt 21))) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@4) (IndexField 2)))) (LitInt 22)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@4) (IndexField 3)))) (LitInt 23)))) (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@4) (IndexField 4)))) (LitInt 24)) (= $Heap@4 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@3 $nw@4 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@4) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)))) (and (=> (= (ControlFlow 0 2) (- 0 18)) (or (not (= $nw@4 null)) (not true))) (=> (or (not (= $nw@4 null)) (not true)) (=> (= |s#0@5| (|Seq#Append| |s#0@4| (|Seq#FromArray| $Heap@4 $nw@4))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (<= 0 (LitInt 5))) (=> (<= 0 (LitInt 5)) (and (=> (= (ControlFlow 0 2) (- 0 16)) (= (LitInt 5) 5)) (=> (= (LitInt 5) 5) (=> (= |newtype$check#5@0| (LitInt 20)) (and (=> (= (ControlFlow 0 2) (- 0 15)) (and (<= (LitInt 0) |newtype$check#5@0|) (< |newtype$check#5@0| 256))) (=> (and (<= (LitInt 0) |newtype$check#5@0|) (< |newtype$check#5@0| 256)) (=> (= |newtype$check#6@0| (LitInt 21)) (and (=> (= (ControlFlow 0 2) (- 0 14)) (and (<= (LitInt 0) |newtype$check#6@0|) (< |newtype$check#6@0| 256))) (=> (and (<= (LitInt 0) |newtype$check#6@0|) (< |newtype$check#6@0| 256)) (=> (= |newtype$check#7@0| (LitInt 22)) (and (=> (= (ControlFlow 0 2) (- 0 13)) (and (<= (LitInt 0) |newtype$check#7@0|) (< |newtype$check#7@0| 256))) (=> (and (<= (LitInt 0) |newtype$check#7@0|) (< |newtype$check#7@0| 256)) (=> (= |newtype$check#8@0| (LitInt 23)) (and (=> (= (ControlFlow 0 2) (- 0 12)) (and (<= (LitInt 0) |newtype$check#8@0|) (< |newtype$check#8@0| 256))) (=> (and (<= (LitInt 0) |newtype$check#8@0|) (< |newtype$check#8@0| 256)) (=> (= |newtype$check#9@0| (LitInt 24)) (and (=> (= (ControlFlow 0 2) (- 0 11)) (and (<= (LitInt 0) |newtype$check#9@0|) (< |newtype$check#9@0| 256))) (=> (and (<= (LitInt 0) |newtype$check#9@0|) (< |newtype$check#9@0| 256)) (=> (and (and (or (not (= $nw@5 null)) (not true)) ($Is refType $nw@5 (Tclass._System.array? Tclass.ArrayAllocationInitialization.byte))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $nw@5) alloc)))) (= (_System.array.Length $nw@5) (LitInt 5)))) (=> (and (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $nw@5) (IndexField 0)))) (LitInt 20)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $nw@5) (IndexField 1)))) (LitInt 21))) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $nw@5) (IndexField 2)))) (LitInt 22)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $nw@5) (IndexField 3)))) (LitInt 23)))) (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $nw@5) (IndexField 4)))) (LitInt 24)) (= $Heap@5 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@4 $nw@5 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $nw@5) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5)))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (or (not (= $nw@5 null)) (not true))) (=> (or (not (= $nw@5 null)) (not true)) (=> (= |s#0@6| (|Seq#Append| |s#0@5| (|Seq#FromArray| $Heap@5 $nw@5))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (<= 0 |$rhs#0@0|)) (=> (<= 0 |$rhs#0@0|) (and (=> (= (ControlFlow 0 2) (- 0 8)) (or (not (= 1 $FunctionContextHeight)) (not true))) (=> (or (not (= 1 $FunctionContextHeight)) (not true)) (=> (and (and (or (not (= $nw@6 null)) (not true)) ($Is refType $nw@6 (Tclass._System.array? Tclass.ArrayAllocationInitialization.byte))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@6) alloc)))) (= (_System.array.Length $nw@6) |$rhs#0@0|))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (forall ((|arrayinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0|) (< |arrayinit#0#i0#0| |$rhs#0@0|)) (Requires1 Tclass._System.nat Tclass.ArrayAllocationInitialization.byte $Heap@5 |ArrayAllocationInitialization.__default.ByteF#Handle| ($Box intType (int_2_U |arrayinit#0#i0#0|))))
 :qid |Arraysdfy.661:10|
 :skolemid |4485|
))) (=> (and (and (forall ((|arrayinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0@@0|) (< |arrayinit#0#i0#0@@0| |$rhs#0@0|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@6) (IndexField |arrayinit#0#i0#0@@0|)))) (U_2_int ($Unbox intType (Apply1 Tclass._System.nat Tclass.ArrayAllocationInitialization.byte $Heap@5 |ArrayAllocationInitialization.__default.ByteF#Handle| ($Box intType (int_2_U |arrayinit#0#i0#0@@0|)))))))
 :qid |Arraysdfy.661:10|
 :skolemid |4486|
...
)) (= $Heap@6 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@5 $nw@6 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@6) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@6) ($IsHeapAnchor $Heap@6))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= $nw@6 null)) (not true))) (=> (or (not (= $nw@6 null)) (not true)) (=> (= |s#0@7| (|Seq#Append| |s#0@6| (|Seq#FromArray| $Heap@6 $nw@6))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (<= 0 |$rhs#1@0|)) (=> (<= 0 |$rhs#1@0|) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= 1 $FunctionContextHeight)) (not true))) (=> (or (not (= 1 $FunctionContextHeight)) (not true)) (=> (and (and (or (not (= $nw@7 null)) (not true)) ($Is refType $nw@7 (Tclass._System.array? Tclass.ArrayAllocationInitialization.byte))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $nw@7) alloc)))) (= (_System.array.Length $nw@7) |$rhs#1@0|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((|arrayinit#1#i0#0| Int) ) (!  (=> (and (<= 0 |arrayinit#1#i0#0|) (< |arrayinit#1#i0#0| |$rhs#1@0|)) (Requires1 Tclass._System.nat Tclass.ArrayAllocationInitialization.byte $Heap@6 |ArrayAllocationInitialization.__default.ByteF#Handle| ($Box intType (int_2_U |arrayinit#1#i0#0|))))
 :qid |Arraysdfy.663:10|
 :skolemid |4487|
))) (=> (forall ((|arrayinit#1#i0#0@@0| Int) ) (!  (=> (and (<= 0 |arrayinit#1#i0#0@@0|) (< |arrayinit#1#i0#0@@0| |$rhs#1@0|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $nw@7) (IndexField |arrayinit#1#i0#0@@0|)))) (U_2_int ($Unbox intType (Apply1 Tclass._System.nat Tclass.ArrayAllocationInitialization.byte $Heap@6 |ArrayAllocationInitialization.__default.ByteF#Handle| ($Box intType (int_2_U |arrayinit#1#i0#0@@0|)))))))
 :qid |Arraysdfy.663:10|
 :skolemid |4488|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |a#0| (Tclass._System.array Tclass.ArrayAllocationInitialization.byte)) ($IsAlloc refType |a#0| (Tclass._System.array Tclass.ArrayAllocationInitialization.byte) $Heap)) true) (=> (and (and (and ($Is SeqType |s#0| (TSeq Tclass.ArrayAllocationInitialization.byte)) ($IsAlloc SeqType |s#0| (TSeq Tclass.ArrayAllocationInitialization.byte) $Heap)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 36) 2))) anon0_correct)))))
