...
(assert (forall ((v@@8 T@U) (t0@@2 T@U) ) (! (= ($Is SeqType v@@8 (TSeq t0@@2)) (forall ((i@@3 Int) ) (!  (=> (and (<= 0 i@@3) (< i@@3 (|Seq#Length| v@@8))) ($IsBox (|Seq#Index| v@@8 i@@3) t0@@2))
...
(set-info :boogie-vc-id Impl$$_module.__default.SeqUpdate)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |s#0@0| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 104))) ($Box charType (|char#FromInt| 101))) ($Box charType (|char#FromInt| 108))) ($Box charType (|char#FromInt| 108))) ($Box charType (|char#FromInt| 111))))) (= |newtype$check#0@0| (LitInt 69))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (and (<= 0 |newtype$check#0@0|) (< |newtype$check#0@0| 55296)) (and (<= 57344 |newtype$check#0@0|) (< |newtype$check#0@0| 1114112)))) (=> (or (and (<= 0 |newtype$check#0@0|) (< |newtype$check#0@0| 55296)) (and (<= 57344 |newtype$check#0@0|) (< |newtype$check#0@0| 1114112))) (=> (= |ch#0@0| (|char#FromInt| (LitInt 69))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |s#0@0|)))) (=> (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |s#0@0|))) (=> (= |s#0@1| (|Seq#Update| |s#0@0| (LitInt 1) ($Box charType |ch#0@0|))) (=> (and (= |t#0@0| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 2)))) ($Box intType (int_2_U (LitInt 4)))) ($Box intType (int_2_U (LitInt 6)))) ($Box intType (int_2_U (LitInt 8)))) ($Box intType (int_2_U (LitInt 10)))))) (= (ControlFlow 0 2) (- 0 1))) (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |t#0@0|))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is SeqType |s#0| (TSeq TChar)) ($IsAlloc SeqType |s#0| (TSeq TChar) $Heap)) true) (and ($Is charType |ch#0| TChar) true)) (and (and (and ($Is SeqType |t#0| (TSeq TInt)) ($IsAlloc SeqType |t#0| (TSeq TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 2)))) anon0_correct))))
