...
(set-info :boogie-vc-id CheckWellFormed$$DefaultValuedExpressions.NT4)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon6_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (= (LitInt (Mod 1 (LitInt 2))) (LitInt 1)))))
