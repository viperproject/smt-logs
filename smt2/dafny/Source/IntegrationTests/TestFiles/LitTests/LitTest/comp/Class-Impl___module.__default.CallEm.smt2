...
)) ($HeapSucc $Heap@10 $Heap@11))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@25 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@25 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 $o@@25) alloc)))) (= $o@@25 |i#0|)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@25 $f@@0)))
 :qid |Classdfy.110:32|
 :skolemid |1966|
))) (=> (forall (($o@@26 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@26 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 $o@@26) alloc)))) (= $o@@26 |i#0|)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@26 $f@@1)))
 :qid |Classdfy.110:32|
 :skolemid |1966|
