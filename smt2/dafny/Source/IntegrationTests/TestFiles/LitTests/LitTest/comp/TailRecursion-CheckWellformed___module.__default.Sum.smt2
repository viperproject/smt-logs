...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly T@U) (|xs#0| T@U) ) (!  (=> (or (|_module.__default.Sum#canCall| |xs#0|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0| Tclass._module.List))) (and (=> (not (_module.List.Nil_q |xs#0|)) (|_module.__default.Sum#canCall| (_module.List.tail |xs#0|))) (= (_module.__default.Sum ($LS $ly) |xs#0|) (ite (_module.List.Nil_q |xs#0|) (let ((|zero#0| (LitInt 0)))
|zero#0|) (+ (_module.__default.Sum $ly (_module.List.tail |xs#0|)) (_module.List.head |xs#0|))))))
 :qid |TailRecursiondfy.263:27|
 :skolemid |1223|
 :pattern ( (_module.__default.Sum ($LS $ly) |xs#0|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@0 T@U) (|xs#0@@0| T@U) ) (!  (=> (or (|_module.__default.Sum#canCall| (Lit DatatypeTypeType |xs#0@@0|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@0| Tclass._module.List))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@0|)))))) (|_module.__default.Sum#canCall| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@0|))))) (= (_module.__default.Sum ($LS $ly@@0) (Lit DatatypeTypeType |xs#0@@0|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@0|)) (let ((|zero#2| (LitInt 0)))
|zero#2|) (LitInt (+ (_module.__default.Sum ($LS $ly@@0) (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@0|)))) (_module.List.head (Lit DatatypeTypeType |xs#0@@0|))))))))
 :qid |TailRecursiondfy.263:27|
 :weight 3
 :skolemid |1224|
 :pattern ( (_module.__default.Sum ($LS $ly@@0) (Lit DatatypeTypeType |xs#0@@0|)))
))))
...
(assert (forall (($ly@@1 T@U) (|xs#0@@1| T@U) ) (! (= (_module.__default.Sum ($LS $ly@@1) |xs#0@@1|) (_module.__default.Sum $ly@@1 |xs#0@@1|))
 :qid |TailRecursiondfy.263:27|
 :skolemid |1219|
 :pattern ( (_module.__default.Sum ($LS $ly@@1) |xs#0@@1|))
)))
...
(let ((anon10_Then_correct  (=> (and (and (and (= |xs#0@@2| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) ($Is DatatypeTypeType |_mcc#1#0| Tclass._module.List)) (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| Tclass._module.List))) (and (and (= |rest#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|)) (and ($Is intType (int_2_U |let#1#0#0|) TInt) (= |x#Z#0@0| |let#1#0#0|)))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (_module.List.Cons_q |xs#0@@2|)) (=> (_module.List.Cons_q |xs#0@@2|) (=> (and (= |##xs#0@0| (_module.List.tail |xs#0@@2|)) ($IsAlloc DatatypeTypeType |##xs#0@0| Tclass._module.List $Heap)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< (DtRank |##xs#0@0|) (DtRank |xs#0@@2|))) (=> (< (DtRank |##xs#0@0|) (DtRank |xs#0@@2|)) (=> (and (|_module.__default.Sum#canCall| (_module.List.tail |xs#0@@2|)) (= (ControlFlow 0 5) (- 0 4))) (_module.List.Cons_q |xs#0@@2|))))))))))
(let ((anon9_Else_correct  (=> (or (not (= |xs#0@@2| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 9) 5) anon10_Then_correct) (=> (= (ControlFlow 0 9) 8) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> (and (= |xs#0@@2| |#_module.List.Nil|) (= (ControlFlow 0 3) (- 0 2))) (_module.List.Nil_q |xs#0@@2|))))
