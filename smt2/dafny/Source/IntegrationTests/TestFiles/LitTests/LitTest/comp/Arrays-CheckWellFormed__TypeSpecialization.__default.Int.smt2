...
(set-info :boogie-vc-id CheckWellFormed$$TypeSpecialization.__default.Int)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array TypeSpecialization._default.Int$T)) ($IsAlloc refType |a#0| (Tclass._System.array TypeSpecialization._default.Int$T) $Heap)) (and ($Is refType |b#0| (Tclass._System.array TInt)) ($IsAlloc refType |b#0| (Tclass._System.array TInt) $Heap))) (and (and ($IsBox |t#0| TypeSpecialization._default.Int$T) ($IsAllocBox |t#0| TypeSpecialization._default.Int$T $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 8) 5)))) anon0_correct))))
