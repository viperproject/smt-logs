...
(assert (distinct TBool TagBool alloc Tagclass._System.array? Tagclass._System.array Tagclass._module.MyClass Tagclass._module.MyClass? tytagFamily$array tytagFamily$MyClass)
)
