...
(set-info :boogie-vc-id Impl$$_module.__default.DowncastM)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|Set#Equal| |s#0| |s#0|))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SetType |s#0| (TSet Tclass._module.Integer)) ($IsAlloc SetType |s#0| (TSet Tclass._module.Integer) $Heap))) (and (and ($Is SetType |r#0| (TSet Tclass._module.Number)) ($IsAlloc SetType |r#0| (TSet Tclass._module.Number) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
