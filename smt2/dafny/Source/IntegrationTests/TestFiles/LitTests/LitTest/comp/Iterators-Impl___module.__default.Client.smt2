...
(assert (forall ((_module.Iter$X@@18 T@U) ($h0 T@U) ($h1 T@U) (this T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this null)) (not true)) ($Is refType this (Tclass._module.Iter _module.Iter$X@@18)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@19 T@U) ($f T@U) )  (=> (and (or (not (= $o@@19 null)) (not true)) (or (or (= $o@@19 this) (|Set#IsMember| (_module.Iter.__reads this) ($Box refType $o@@19))) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h0 this) _module.Iter.__new)) ($Box refType $o@@19)))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h0 $o@@19) $f) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h1 $o@@19) $f)))) (= (_module.Iter.Valid _module.Iter$X@@18 $h0 this) (_module.Iter.Valid _module.Iter$X@@18 $h1 this))))
