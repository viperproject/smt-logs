...
(assert (forall ((v@@4 T@U) (t0@@4 T@U) ) (! (= ($Is SeqType v@@4 (TSeq t0@@4)) (forall ((i@@0 Int) ) (!  (=> (and (<= 0 i@@0) (< i@@0 (|Seq#Length| v@@4))) ($IsBox (|Seq#Index| v@@4 i@@0) t0@@4))
...
(declare-fun _module._default.ToSet$T () T@U)
(declare-fun |r#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.ToSet)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct  (=> (and (or (not (= (|Seq#Length| |s#0|) (LitInt 0))) (not true)) (= (ControlFlow 0 3) (- 0 2))) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s#0|))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 4) 1) anon5_Then_correct) (=> (= (ControlFlow 0 4) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SeqType |s#0| (TSeq _module._default.ToSet$T)) ($IsAlloc SeqType |s#0| (TSeq _module._default.ToSet$T) $Heap))) (and (and ($Is SetType |r#0| (TSet _module._default.ToSet$T)) ($IsAlloc SetType |r#0| (TSet _module._default.ToSet$T) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 4)))) anon0_correct)))
