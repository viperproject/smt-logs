...
axiom (forall a#12#0#0: Box :: 
  ...
  DatatypeCtorId(#RustStdOption.Option.Some(a#12#0#0))
...
axiom (forall d: DatatypeType :: 
  { RustStdOption.Option.Some_q(d) } 
  RustStdOption.Option.Some_q(d)
     ==> (exists a#13#0#0: Box :: d == #RustStdOption.Option.Some(a#13#0#0)));
...
// Constructor $Is
axiom (forall RustStdOption.Option$T: Ty, a#14#0#0: Box :: 
  { $Is(#RustStdOption.Option.Some(a#14#0#0), 
      Tclass.RustStdOption.Option(RustStdOption.Option$T)) } 
  $Is(#RustStdOption.Option.Some(a#14#0#0), 
      Tclass.RustStdOption.Option(RustStdOption.Option$T))
     <==> $IsBox(a#14#0#0, RustStdOption.Option$T));

// Constructor $IsAlloc
axiom (forall RustStdOption.Option$T: Ty, a#14#0#0: Box, $h: Heap :: 
  { $IsAlloc(#RustStdOption.Option.Some(a#14#0#0), 
      Tclass.RustStdOption.Option(RustStdOption.Option$T), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#RustStdOption.Option.Some(a#14#0#0), 
        Tclass.RustStdOption.Option(RustStdOption.Option$T), 
        $h)
       <==> $IsAllocBox(a#14#0#0, RustStdOption.Option$T, $h)));
...
axiom (forall a#15#0#0: Box :: 
  { #RustStdOption.Option.Some(Lit(a#15#0#0)) } 
  #RustStdOption.Option.Some(Lit(a#15#0#0))
     == Lit(#RustStdOption.Option.Some(a#15#0#0)));

function RustStdOption.Option.value(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#16#0#0: Box :: 
  { #RustStdOption.Option.Some(a#16#0#0) } 
  RustStdOption.Option.value(#RustStdOption.Option.Some(a#16#0#0)) == a#16#0#0);

// Inductive rank
axiom (forall a#17#0#0: Box :: 
  { #RustStdOption.Option.Some(a#17#0#0) } 
  BoxRank(a#17#0#0) < DtRank(#RustStdOption.Option.Some(a#17#0#0)));
