...
(assert (distinct TInt TagInt alloc Tagclass._System.nat Tagclass._System.array2? Tagclass._System.array2 tytagFamily$nat tytagFamily$array2)
)
...
(assert (forall ((_System.array2$arg@@9 T@U) ($h@@2 T@U) ($o@@3 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@2) (and (or (not (= $o@@3 null)) (not true)) (= (dtype $o@@3) (Tclass._System.array2? _System.array2$arg@@9)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@3) alloc)))) ($IsAlloc intType (int_2_U (_System.array2.Length0 $o@@3)) TInt $h@@2))
 :qid |unknown.0:0|
 :skolemid |489|
 :pattern ( (_System.array2.Length0 $o@@3) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@3) alloc)) (Tclass._System.array2? _System.array2$arg@@9))
)))
(assert (forall ((_System.array2$arg@@10 T@U) ($h@@3 T@U) ($o@@4 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@3) (and (or (not (= $o@@4 null)) (not true)) (= (dtype $o@@4) (Tclass._System.array2? _System.array2$arg@@10)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@4) alloc)))) ($IsAlloc intType (int_2_U (_System.array2.Length1 $o@@4)) TInt $h@@3))
 :qid |unknown.0:0|
 :skolemid |491|
 :pattern ( (_System.array2.Length1 $o@@4) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@4) alloc)) (Tclass._System.array2? _System.array2$arg@@10))
)))
...
(declare-fun _module._default.MLen$_T0@@2 () T@U)
(set-info :boogie-vc-id CheckWellformed$$_module.__default.MLen)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= |m#0@@2| null)) (not true))) (=> (or (not (= |m#0@@2| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= |m#0@@2| null)) (not true))) (=> (or (not (= |m#0@@2| null)) (not true)) (=> (= (ControlFlow 0 3) (- 0 2)) ($Is intType (int_2_U (+ (_System.array2.Length0 |m#0@@2|) (_System.array2.Length1 |m#0@@2|))) Tclass._System.nat))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is refType |m#0@@2| (Tclass._System.array2 _module._default.MLen$_T0@@2))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct)))
