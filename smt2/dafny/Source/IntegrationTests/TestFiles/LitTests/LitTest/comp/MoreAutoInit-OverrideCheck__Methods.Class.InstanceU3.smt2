...
(set-info :boogie-vc-id OverrideCheck$$Methods.Class.InstanceU3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (= Methods.UberTrait$Au@@9 Methods.Class$Ac@@14) (= Methods.UberTrait.InstanceU3$Bu Methods.Class.InstanceU3$Bc)) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@13 T@U) ($f T@U) ) (! true
