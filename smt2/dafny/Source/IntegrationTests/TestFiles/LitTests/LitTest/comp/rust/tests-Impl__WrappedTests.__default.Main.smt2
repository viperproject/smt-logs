...
(set-info :boogie-vc-id Impl$$WrappedTests.__default.Main)
...
(let ((anon3_Then_correct  (=> (and (> (|Seq#Length| |args#0|) 1) (= (ControlFlow 0 2) (- 0 1))) (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |args#0|))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |args#0| (TSeq (TSeq TChar))) ($IsAlloc SeqType |args#0| (TSeq (TSeq TChar)) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct))))
