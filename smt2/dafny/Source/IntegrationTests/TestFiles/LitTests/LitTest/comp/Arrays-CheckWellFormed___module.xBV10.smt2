...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let (($generated@@92  (=> (= (ControlFlow 0 3) (- 0 2)) ($generated@@5 ($generated $generated@@1 ($generated@@4  (or (not (= #b0000000000 #b1111100111)) (not true))))))))
(let (($generated@@93 true))
(let (($generated@@94  (=> (= $generated@@85 ($generated@@27 $generated@@86 $generated@@87 $generated@@88 false)) (and (=> (= (ControlFlow 0 4) 1) $generated@@93) (=> (= (ControlFlow 0 4) 3) $generated@@92)))))
(let (($generated@@95  (=> (and (and ($generated@@89 $generated@@87) ($generated@@90 $generated@@87)) (and (= 0 $generated@@91) (= (ControlFlow 0 5) 4))) $generated@@94)))
$generated@@95)))))
))
(check-sat)
(get-info :rlimit)
