...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let (($generated@@148  (=> (= $generated@@143 ($generated@@31 0)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (and (and (<= ($generated@@31 0) $generated@@143) (< $generated@@143 10000)) (or (not (= $generated@@143 22)) (not true)))) (=> (and (and (<= ($generated@@31 0) $generated@@143) (< $generated@@143 10000)) (or (not (= $generated@@143 22)) (not true))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= $generated@@143 10)) (not true))) (=> (or (not (= $generated@@143 10)) (not true)) (=> (= (ControlFlow 0 3) (- 0 2)) (and (or (not (= $generated@@143 34)) (not true)) (= ($generated@@22 ($generated@@33 $generated@@28 ($generated@@25 $generated))) ($generated@@22 ($generated@@33 $generated@@28 ($generated@@25 $generated@@0)))))))))))))
(let (($generated@@149 true))
(let (($generated@@150  (=> (= $generated@@144 ($generated@@69 $generated@@145 $generated@@146 $generated@@4 false)) (and (=> (= (ControlFlow 0 6) 1) $generated@@149) (=> (= (ControlFlow 0 6) 3) $generated@@148)))))
(let (($generated@@151  (=> (and (and ($generated@@127 $generated@@146) ($generated@@147 $generated@@146)) (and (= 3 $generated@@24) (= (ControlFlow 0 7) 6))) $generated@@150)))
$generated@@151)))))
))
(check-sat)
(get-info :rlimit)
