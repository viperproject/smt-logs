...
(set-info :boogie-vc-id CheckWellFormed$$TypeTests.Middle)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon6_Then_correct  (=> (= |newtype$check#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (and (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 10000)) (or (not (= |newtype$check#0@0| 22)) (not true)))) (=> (and (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 10000)) (or (not (= |newtype$check#0@0| 22)) (not true))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= |newtype$check#0@0| 10)) (not true))) (=> (or (not (= |newtype$check#0@0| 10)) (not true)) (=> (= (ControlFlow 0 3) (- 0 2)) (and (or (not (= |newtype$check#0@0| 34)) (not true)) (= (|Seq#Length| (Lit SeqType (TypeTests.__default.EmptySequence TBool))) (|Seq#Length| (Lit SeqType (TypeTests.__default.EmptySequence TChar)))))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 3) anon6_Then_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct)))
