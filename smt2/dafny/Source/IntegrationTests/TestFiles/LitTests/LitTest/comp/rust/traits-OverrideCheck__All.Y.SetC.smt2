...
(set-info :boogie-vc-id OverrideCheck$$All.Y.SetC)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= |newC#0| |newC#0|)) (=> (<= |newC#0| |newC#0|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@17 T@U) ($f T@U) ) (! true
 :qid |traitsdfy.95:12|
 :skolemid |2139|
))) (=> (forall (($o@@18 T@U) ($f@@0 T@U) ) (! true
 :qid |traitsdfy.95:12|
 :skolemid |2139|
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall (($o@@19 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@19 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@19) alloc)))) (= $o@@19 this)) (= $o@@19 this))
 :qid |traitsdfy.95:12|
 :skolemid |2140|
)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass.All.Y All.Y$I@@10)) ($IsAlloc refType this (Tclass.All.Y All.Y$I@@10) $Heap))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct))))
