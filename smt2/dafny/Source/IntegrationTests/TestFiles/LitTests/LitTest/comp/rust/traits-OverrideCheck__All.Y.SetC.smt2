...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= |newC#0| |newC#0|)) (=> (<= |newC#0| |newC#0|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@17 T@U) ($f T@U) ) true)) (=> (forall (($o@@18 T@U) ($f@@0 T@U) ) true) (=> (= (ControlFlow 0 2) (- 0 1)) (forall (($o@@19 T@U) ($f@@1 T@U) )  (=> (and (and (or (not (= $o@@19 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@19) alloc)))) (= $o@@19 this)) (= $o@@19 this))))))))))
