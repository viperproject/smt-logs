...
procedure {:verboseName "CovarianceRegressions.Test (correctness)"} Impl$$CovarianceRegressions.__default.Test() returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "CovarianceRegressions.Test (correctness)"} Impl$$CovarianceRegressions.__default.Test() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var a#0: Set
     where $Is(a#0, TSet(Tclass.CovarianceRegressions.Trait()))
       && $IsAlloc(a#0, TSet(Tclass.CovarianceRegressions.Trait()), $Heap);
  var b#0: Seq
     where $Is(b#0, TSeq(Tclass.CovarianceRegressions.Trait()))
       && $IsAlloc(b#0, TSeq(Tclass.CovarianceRegressions.Trait()), $Heap);
  var c#0: MultiSet
     where $Is(c#0, TMultiSet(Tclass.CovarianceRegressions.Trait()))
       && $IsAlloc(c#0, TMultiSet(Tclass.CovarianceRegressions.Trait()), $Heap);
  var d#0: Map
     where $Is(d#0, 
        TMap(Tclass.CovarianceRegressions.Trait(), Tclass.CovarianceRegressions.Trait()))
       && $IsAlloc(d#0, 
        TMap(Tclass.CovarianceRegressions.Trait(), Tclass.CovarianceRegressions.Trait()), 
        $Heap);
  var a##0: Set;
  ...
  var x##3: Map;
    ...
    // AddMethodImpl: Test, Impl$$CovarianceRegressions.__default.Test
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    havoc a#0 /* where $Is(a#0, TSet(Tclass.CovarianceRegressions.Trait()))
       && $IsAlloc(a#0, TSet(Tclass.CovarianceRegressions.Trait()), $Heap) */;
    havoc b#0 /* where $Is(b#0, TSeq(Tclass.CovarianceRegressions.Trait()))
       && $IsAlloc(b#0, TSeq(Tclass.CovarianceRegressions.Trait()), $Heap) */;
    havoc c#0 /* where $Is(c#0, TMultiSet(Tclass.CovarianceRegressions.Trait()))
       && $IsAlloc(c#0, TMultiSet(Tclass.CovarianceRegressions.Trait()), $Heap) */;
    havoc d#0 /* where $Is(d#0, 
        TMap(Tclass.CovarianceRegressions.Trait(), Tclass.CovarianceRegressions.Trait()))
       && $IsAlloc(d#0, 
        TMap(Tclass.CovarianceRegressions.Trait(), Tclass.CovarianceRegressions.Trait()), 
        $Heap) */;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/CovariantCollections.dfy(471,8)
    ...
    // ProcessCallStmt: CheckSubrange
    d##0 := d#0;
    call {:id "id0"} Call$$CovarianceRegressions.__default.Ins(a##0, b##0, c##0, d##0);
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/CovariantCollections.dfy(472,23)
    assume true;
    assume true;
    assume true;
    assume true;
    // TrCallStmt: Adding lhs with type set<Trait>
    // TrCallStmt: Adding lhs with type seq<Trait>
    // TrCallStmt: Adding lhs with type multiset<Trait>
    // TrCallStmt: Adding lhs with type map<Trait, Trait>
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id1"} $rhs##0, $rhs##1, $rhs##2, $rhs##3 := Call$$CovarianceRegressions.__default.Outs();
    // TrCallStmt: After ProcessCallStmt
    a#0 := $rhs##0;
    b#0 := $rhs##1;
    c#0 := $rhs##2;
    d#0 := $rhs##3;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/CovariantCollections.dfy(474,13)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##0 := a#0;
    call {:id "id6"} Call$$CovarianceRegressions.__default.Anything(TSet(Tclass.CovarianceRegressions.Trait()), $Box(x##0));
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/CovariantCollections.dfy(475,13)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##1 := b#0;
    call {:id "id7"} Call$$CovarianceRegressions.__default.Anything(TSeq(Tclass.CovarianceRegressions.Trait()), $Box(x##1));
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/CovariantCollections.dfy(476,13)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##2 := c#0;
    call {:id "id8"} Call$$CovarianceRegressions.__default.Anything(TMultiSet(Tclass.CovarianceRegressions.Trait()), $Box(x##2));
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/CovariantCollections.dfy(477,13)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##3 := d#0;
    call {:id "id9"} Call$$CovarianceRegressions.__default.Anything(TMap(Tclass.CovarianceRegressions.Trait(), Tclass.CovarianceRegressions.Trait()), $Box(x##3));
    // TrCallStmt: After ProcessCallStmt
}



procedure {:verboseName "CovarianceRegressions.Anything (well-formedness)"} CheckWellFormed$$CovarianceRegressions.__default.Anything(CovarianceRegressions._default.Anything$X: Ty, 
    x#0: Box
       where $IsBox(x#0, CovarianceRegressions._default.Anything$X)
         && $IsAllocBox(x#0, CovarianceRegressions._default.Anything$X, $Heap));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "CovarianceRegressions.Anything (call)"} Call$$CovarianceRegressions.__default.Anything(CovarianceRegressions._default.Anything$X: Ty, 
    x#0: Box
       where $IsBox(x#0, CovarianceRegressions._default.Anything$X)
         && $IsAllocBox(x#0, CovarianceRegressions._default.Anything$X, $Heap));
  modifies $Heap;
...
procedure {:verboseName "CovarianceRegressions.Anything (correctness)"} Impl$$CovarianceRegressions.__default.Anything(CovarianceRegressions._default.Anything$X: Ty, 
    x#0: Box
       where $IsBox(x#0, CovarianceRegressions._default.Anything$X)
         && $IsAllocBox(x#0, CovarianceRegressions._default.Anything$X, $Heap))
...
procedure {:verboseName "CovarianceRegressions.Ins (well-formedness)"} CheckWellFormed$$CovarianceRegressions.__default.Ins(a#0: Set
       where $Is(a#0, TSet(Tclass.CovarianceRegressions.Trait()))
         && $IsAlloc(a#0, TSet(Tclass.CovarianceRegressions.Trait()), $Heap), 
    b#0: Seq
       where $Is(b#0, TSeq(Tclass.CovarianceRegressions.Trait()))
...
procedure {:verboseName "CovarianceRegressions.Ins (call)"} Call$$CovarianceRegressions.__default.Ins(a#0: Set
       where $Is(a#0, TSet(Tclass.CovarianceRegressions.Trait()))
         && $IsAlloc(a#0, TSet(Tclass.CovarianceRegressions.Trait()), $Heap), 
    b#0: Seq
       where $Is(b#0, TSeq(Tclass.CovarianceRegressions.Trait()))
...
procedure {:verboseName "CovarianceRegressions.Ins (correctness)"} Impl$$CovarianceRegressions.__default.Ins(a#0: Set
       where $Is(a#0, TSet(Tclass.CovarianceRegressions.Trait()))
         && $IsAlloc(a#0, TSet(Tclass.CovarianceRegressions.Trait()), $Heap), 
    b#0: Seq
       where $Is(b#0, TSeq(Tclass.CovarianceRegressions.Trait()))
...
procedure {:verboseName "CovarianceRegressions.Outs (well-formedness)"} CheckWellFormed$$CovarianceRegressions.__default.Outs()
   returns (a#0: Set
       where $Is(a#0, TSet(Tclass.CovarianceRegressions.Trait()))
         && $IsAlloc(a#0, TSet(Tclass.CovarianceRegressions.Trait()), $Heap), 
    b#0: Seq
...
procedure {:verboseName "CovarianceRegressions.Outs (call)"} Call$$CovarianceRegressions.__default.Outs()
   returns (a#0: Set
       where $Is(a#0, TSet(Tclass.CovarianceRegressions.Trait()))
         && $IsAlloc(a#0, TSet(Tclass.CovarianceRegressions.Trait()), $Heap), 
    b#0: Seq
...
procedure {:verboseName "CovarianceRegressions.Outs (correctness)"} Impl$$CovarianceRegressions.__default.Outs()
   returns (a#0: Set
       where $Is(a#0, TSet(Tclass.CovarianceRegressions.Trait()))
         && $IsAlloc(a#0, TSet(Tclass.CovarianceRegressions.Trait()), $Heap), 
    b#0: Seq
...
procedure {:verboseName "CovarianceRegressions.TestDisjointTypeArgument_Set (well-formedness)"} CheckWellFormed$$CovarianceRegressions.__default.TestDisjointTypeArgument__Set(a#0: Set
       where $Is(a#0, TSet(Tclass.CovarianceRegressions.Trait()))
         && $IsAlloc(a#0, TSet(Tclass.CovarianceRegressions.Trait()), $Heap), 
    b#0: Set
       where $Is(b#0, TSet(Tclass.CovarianceRegressions.Class()))
         && $IsAlloc(b#0, TSet(Tclass.CovarianceRegressions.Class()), $Heap));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "CovarianceRegressions.TestDisjointTypeArgument_Set (call)"} Call$$CovarianceRegressions.__default.TestDisjointTypeArgument__Set(a#0: Set
       where $Is(a#0, TSet(Tclass.CovarianceRegressions.Trait()))
         && $IsAlloc(a#0, TSet(Tclass.CovarianceRegressions.Trait()), $Heap), 
    b#0: Set
       where $Is(b#0, TSet(Tclass.CovarianceRegressions.Class()))
...
procedure {:verboseName "CovarianceRegressions.TestDisjointTypeArgument_Set (correctness)"} Impl$$CovarianceRegressions.__default.TestDisjointTypeArgument__Set(a#0: Set
       where $Is(a#0, TSet(Tclass.CovarianceRegressions.Trait()))
         && $IsAlloc(a#0, TSet(Tclass.CovarianceRegressions.Trait()), $Heap), 
    b#0: Set
       where $Is(b#0, TSet(Tclass.CovarianceRegressions.Class()))
...
procedure {:verboseName "CovarianceRegressions.TestDisjointTypeArgument_MultiSet (well-formedness)"} CheckWellFormed$$CovarianceRegressions.__default.TestDisjointTypeArgument__MultiSet(a#0: MultiSet
       where $Is(a#0, TMultiSet(Tclass.CovarianceRegressions.Trait()))
         && $IsAlloc(a#0, TMultiSet(Tclass.CovarianceRegressions.Trait()), $Heap), 
    b#0: MultiSet
       where $Is(b#0, TMultiSet(Tclass.CovarianceRegressions.Class()))
         && $IsAlloc(b#0, TMultiSet(Tclass.CovarianceRegressions.Class()), $Heap));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "CovarianceRegressions.TestDisjointTypeArgument_MultiSet (call)"} Call$$CovarianceRegressions.__default.TestDisjointTypeArgument__MultiSet(a#0: MultiSet
       where $Is(a#0, TMultiSet(Tclass.CovarianceRegressions.Trait()))
         && $IsAlloc(a#0, TMultiSet(Tclass.CovarianceRegressions.Trait()), $Heap), 
    b#0: MultiSet
       where $Is(b#0, TMultiSet(Tclass.CovarianceRegressions.Class()))
...
procedure {:verboseName "CovarianceRegressions.TestDisjointTypeArgument_MultiSet (correctness)"} Impl$$CovarianceRegressions.__default.TestDisjointTypeArgument__MultiSet(a#0: MultiSet
       where $Is(a#0, TMultiSet(Tclass.CovarianceRegressions.Trait()))
         && $IsAlloc(a#0, TMultiSet(Tclass.CovarianceRegressions.Trait()), $Heap), 
    b#0: MultiSet
       where $Is(b#0, TMultiSet(Tclass.CovarianceRegressions.Class()))
