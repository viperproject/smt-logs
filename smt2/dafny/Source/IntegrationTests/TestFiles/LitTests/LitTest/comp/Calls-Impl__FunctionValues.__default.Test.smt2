...
(assert (distinct TInt TagInt alloc Tagclass._System.___hFunc0 Tagclass._System.___hPartialFunc0 Tagclass._System.___hTotalFunc0 Tagclass.FunctionValues.Class Tagclass.FunctionValues.Color Tagclass.FunctionValues.Class? |##FunctionValues.Color.Red| |##FunctionValues.Color.Green| |##FunctionValues.Color.Blue| |tytagFamily$_#Func0| |tytagFamily$_#PartialFunc0| |tytagFamily$_#TotalFunc0| tytagFamily$Class tytagFamily$Color)
)
...
(assert (forall (($self@@0 T@U) ($heap@@0 T@U) ) (! (= (Requires0 TInt $heap@@0 (|FunctionValues.Color.F#Handle| $self@@0)) (|FunctionValues.Color.F#requires| $self@@0))
 :qid |unknown.0:0|
 :skolemid |545|
 :pattern ( (Requires0 TInt $heap@@0 (|FunctionValues.Color.F#Handle| $self@@0)))
)))
(assert (forall (($self@@1 Int) ($heap@@1 T@U) ) (! (= (Requires0 TInt $heap@@1 (|FunctionValues.NT.F#Handle| $self@@1)) (|FunctionValues.NT.F#requires| $self@@1))
 :qid |unknown.0:0|
 :skolemid |555|
 :pattern ( (Requires0 TInt $heap@@1 (|FunctionValues.NT.F#Handle| $self@@1)))
)))
...
(assert (forall (($self@@2 T@U) ($heap@@2 T@U) ) (! (= (Apply0 TInt $heap@@2 (|FunctionValues.Class.F#Handle| $self@@2)) ($Box intType (int_2_U (FunctionValues.Class.F $self@@2))))
 :qid |unknown.0:0|
 :skolemid |534|
 :pattern ( (Apply0 TInt $heap@@2 (|FunctionValues.Class.F#Handle| $self@@2)))
)))
(assert (forall (($self@@3 T@U) ($heap@@3 T@U) ) (! (= (Apply0 TInt $heap@@3 (|FunctionValues.Color.F#Handle| $self@@3)) ($Box intType (int_2_U (FunctionValues.Color.F $self@@3))))
 :qid |unknown.0:0|
 :skolemid |544|
 :pattern ( (Apply0 TInt $heap@@3 (|FunctionValues.Color.F#Handle| $self@@3)))
)))
(assert (forall (($self@@4 Int) ($heap@@4 T@U) ) (! (= (Apply0 TInt $heap@@4 (|FunctionValues.NT.F#Handle| $self@@4)) ($Box intType (int_2_U (FunctionValues.NT.F $self@@4))))
 :qid |unknown.0:0|
 :skolemid |554|
 :pattern ( (Apply0 TInt $heap@@4 (|FunctionValues.NT.F#Handle| $self@@4)))
)))
...
(assert (forall ((bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 Tclass.FunctionValues.Color) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@1)) bx@@1) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@1) Tclass.FunctionValues.Color)))
 :qid |unknown.0:0|
 :skolemid |533|
 :pattern ( ($IsBox bx@@1 Tclass.FunctionValues.Color))
)))
(assert (forall ((bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 Tclass.FunctionValues.Class?) (and (= ($Box refType ($Unbox refType bx@@2)) bx@@2) ($Is refType ($Unbox refType bx@@2) Tclass.FunctionValues.Class?)))
 :qid |unknown.0:0|
 :skolemid |568|
 :pattern ( ($IsBox bx@@2 Tclass.FunctionValues.Class?))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@2 T@U) ) (!  (=> (or (|FunctionValues.Color.F#canCall| this@@2) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType this@@2 Tclass.FunctionValues.Color))) (and (|$IsA#FunctionValues.Color| this@@2) (= (FunctionValues.Color.F this@@2) (ite (|FunctionValues.Color#Equal| this@@2 |#FunctionValues.Color.Red|) 5 2))))
 :qid |Callsdfy.81:14|
 :skolemid |597|
 :pattern ( (FunctionValues.Color.F this@@2))
))))
(assert (forall (($heap@@5 T@U) ) (! (= FunctionValues.Class.G (U_2_int ($Unbox intType (Apply0 TInt $heap@@5 |FunctionValues.Class.G#Handle|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |542|
 :pattern ( FunctionValues.Class.G ($IsGoodHeap $heap@@5))
)))
(assert (forall (($heap@@6 T@U) ) (! (= FunctionValues.Color.G (U_2_int ($Unbox intType (Apply0 TInt $heap@@6 |FunctionValues.Color.G#Handle|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |552|
 :pattern ( FunctionValues.Color.G ($IsGoodHeap $heap@@6))
)))
(assert (forall (($heap@@7 T@U) ) (! (= FunctionValues.NT.G (U_2_int ($Unbox intType (Apply0 TInt $heap@@7 |FunctionValues.NT.G#Handle|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |562|
 :pattern ( FunctionValues.NT.G ($IsGoodHeap $heap@@7))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@3 Int) ) (!  (=> (or (|FunctionValues.NT.F#canCall| (LitInt this@@3)) (and (< 0 $FunctionContextHeight) (and (<= (LitInt 0) this@@3) (< this@@3 15)))) (= (FunctionValues.NT.F (LitInt this@@3)) (LitInt this@@3)))
 :qid |Callsdfy.86:14|
 :weight 3
 :skolemid |605|
 :pattern ( (FunctionValues.NT.F (LitInt this@@3)))
))))
...
(assert (forall ((this@@4 T@U) ) (!  (=> ($Is DatatypeTypeType this@@4 Tclass.FunctionValues.Color) (= (|FunctionValues.Color.F#requires| this@@4) true))
 :qid |Callsdfy.81:14|
 :skolemid |596|
 :pattern ( (|FunctionValues.Color.F#requires| this@@4))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@5 T@U) ) (!  (=> (or (|FunctionValues.Color.F#canCall| (Lit DatatypeTypeType this@@5)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType this@@5 Tclass.FunctionValues.Color))) (and (|$IsA#FunctionValues.Color| (Lit DatatypeTypeType this@@5)) (= (FunctionValues.Color.F (Lit DatatypeTypeType this@@5)) (ite (|FunctionValues.Color#Equal| this@@5 |#FunctionValues.Color.Red|) 5 2))))
 :qid |Callsdfy.81:14|
 :weight 3
 :skolemid |598|
 :pattern ( (FunctionValues.Color.F (Lit DatatypeTypeType this@@5)))
))))
...
(assert (forall (($heap@@8 T@U) ) (! (= (Requires0 TInt $heap@@8 |FunctionValues.Class.G#Handle|) |FunctionValues.Class.G#requires|)
 :qid |DafnyPreludebpl.593:12|
 :skolemid |540|
 :pattern ( (Requires0 TInt $heap@@8 |FunctionValues.Class.G#Handle|))
)))
(assert (forall (($heap@@9 T@U) ) (! (= (Requires0 TInt $heap@@9 |FunctionValues.Color.G#Handle|) |FunctionValues.Color.G#requires|)
 :qid |DafnyPreludebpl.593:12|
 :skolemid |550|
 :pattern ( (Requires0 TInt $heap@@9 |FunctionValues.Color.G#Handle|))
)))
(assert (forall (($heap@@10 T@U) ) (! (= (Requires0 TInt $heap@@10 |FunctionValues.NT.G#Handle|) |FunctionValues.NT.G#requires|)
 :qid |DafnyPreludebpl.593:12|
 :skolemid |560|
 :pattern ( (Requires0 TInt $heap@@10 |FunctionValues.NT.G#Handle|))
)))
...
(assert (forall ((|#$R@@8| T@U) (bx@@4 T@U) ) (!  (=> ($IsBox bx@@4 (Tclass._System.___hFunc0 |#$R@@8|)) (and (= ($Box HandleTypeType ($Unbox HandleTypeType bx@@4)) bx@@4) ($Is HandleTypeType ($Unbox HandleTypeType bx@@4) (Tclass._System.___hFunc0 |#$R@@8|))))
 :qid |unknown.0:0|
 :skolemid |413|
 :pattern ( ($IsBox bx@@4 (Tclass._System.___hFunc0 |#$R@@8|)))
)))
(assert (forall ((|#$R@@9| T@U) (bx@@5 T@U) ) (!  (=> ($IsBox bx@@5 (Tclass._System.___hPartialFunc0 |#$R@@9|)) (and (= ($Box HandleTypeType ($Unbox HandleTypeType bx@@5)) bx@@5) ($Is HandleTypeType ($Unbox HandleTypeType bx@@5) (Tclass._System.___hPartialFunc0 |#$R@@9|))))
 :qid |unknown.0:0|
 :skolemid |440|
 :pattern ( ($IsBox bx@@5 (Tclass._System.___hPartialFunc0 |#$R@@9|)))
)))
(assert (forall ((|#$R@@10| T@U) (bx@@6 T@U) ) (!  (=> ($IsBox bx@@6 (Tclass._System.___hTotalFunc0 |#$R@@10|)) (and (= ($Box HandleTypeType ($Unbox HandleTypeType bx@@6)) bx@@6) ($Is HandleTypeType ($Unbox HandleTypeType bx@@6) (Tclass._System.___hTotalFunc0 |#$R@@10|))))
 :qid |unknown.0:0|
 :skolemid |445|
 :pattern ( ($IsBox bx@@6 (Tclass._System.___hTotalFunc0 |#$R@@10|)))
)))
(assert (forall ((d@@7 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) ($Is DatatypeTypeType d@@7 Tclass.FunctionValues.Color)) ($IsAlloc DatatypeTypeType d@@7 Tclass.FunctionValues.Color $h@@4))
 :qid |unknown.0:0|
 :skolemid |588|
 :pattern ( ($IsAlloc DatatypeTypeType d@@7 Tclass.FunctionValues.Color $h@@4))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@6 T@U) ) (!  (=> (or (|FunctionValues.Class.F#canCall| this@@6) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@6 null)) (not true)) ($Is refType this@@6 Tclass.FunctionValues.Class)))) (= (FunctionValues.Class.F this@@6) (FunctionValues.Class.x this@@6)))
 :qid |Callsdfy.76:14|
 :skolemid |578|
 :pattern ( (FunctionValues.Class.F this@@6))
))))
...
(assert (forall (($self@@5 T@U) ($heap@@11 T@U) ) (! (= (FunctionValues.Class.F $self@@5) (U_2_int ($Unbox intType (Apply0 TInt $heap@@11 (|FunctionValues.Class.F#Handle| $self@@5)))))
 :qid |unknown.0:0|
 :skolemid |537|
 :pattern ( (FunctionValues.Class.F $self@@5) ($IsGoodHeap $heap@@11))
)))
(assert (forall (($self@@6 T@U) ($heap@@12 T@U) ) (! (= (FunctionValues.Color.F $self@@6) (U_2_int ($Unbox intType (Apply0 TInt $heap@@12 (|FunctionValues.Color.F#Handle| $self@@6)))))
 :qid |unknown.0:0|
 :skolemid |547|
 :pattern ( (FunctionValues.Color.F $self@@6) ($IsGoodHeap $heap@@12))
)))
(assert (forall (($self@@7 Int) ($heap@@13 T@U) ) (! (= (FunctionValues.NT.F $self@@7) (U_2_int ($Unbox intType (Apply0 TInt $heap@@13 (|FunctionValues.NT.F#Handle| $self@@7)))))
 :qid |unknown.0:0|
 :skolemid |557|
 :pattern ( (FunctionValues.NT.F $self@@7) ($IsGoodHeap $heap@@13))
)))
...
(assert (forall (($heap@@14 T@U) ) (! (= (Apply0 TInt $heap@@14 |FunctionValues.Class.G#Handle|) ($Box intType (int_2_U FunctionValues.Class.G)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |539|
 :pattern ( (Apply0 TInt $heap@@14 |FunctionValues.Class.G#Handle|))
)))
(assert (forall (($heap@@15 T@U) ) (! (= (Apply0 TInt $heap@@15 |FunctionValues.Color.G#Handle|) ($Box intType (int_2_U FunctionValues.Color.G)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |549|
 :pattern ( (Apply0 TInt $heap@@15 |FunctionValues.Color.G#Handle|))
)))
(assert (forall (($heap@@16 T@U) ) (! (= (Apply0 TInt $heap@@16 |FunctionValues.NT.G#Handle|) ($Box intType (int_2_U FunctionValues.NT.G)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |559|
 :pattern ( (Apply0 TInt $heap@@16 |FunctionValues.NT.G#Handle|))
)))
...
(assert (forall (($bx T@U) ($self@@8 T@U) ($heap@@17 T@U) ) (! (= (|Set#IsMember| (Reads0 TInt $heap@@17 (|FunctionValues.Class.F#Handle| $self@@8)) $bx) false)
 :qid |unknown.0:0|
 :skolemid |536|
 :pattern ( (|Set#IsMember| (Reads0 TInt $heap@@17 (|FunctionValues.Class.F#Handle| $self@@8)) $bx))
)))
(assert (forall (($bx@@0 T@U) ($self@@9 T@U) ($heap@@18 T@U) ) (! (= (|Set#IsMember| (Reads0 TInt $heap@@18 (|FunctionValues.Color.F#Handle| $self@@9)) $bx@@0) false)
 :qid |unknown.0:0|
 :skolemid |546|
 :pattern ( (|Set#IsMember| (Reads0 TInt $heap@@18 (|FunctionValues.Color.F#Handle| $self@@9)) $bx@@0))
)))
(assert (forall (($bx@@1 T@U) ($self@@10 Int) ($heap@@19 T@U) ) (! (= (|Set#IsMember| (Reads0 TInt $heap@@19 (|FunctionValues.NT.F#Handle| $self@@10)) $bx@@1) false)
 :qid |unknown.0:0|
 :skolemid |556|
 :pattern ( (|Set#IsMember| (Reads0 TInt $heap@@19 (|FunctionValues.NT.F#Handle| $self@@10)) $bx@@1))
)))
...
(assert (forall ((this@@7 T@U) ) (!  (=> (and (or (not (= this@@7 null)) (not true)) ($Is refType this@@7 Tclass.FunctionValues.Class)) (= (|FunctionValues.Class.F#requires| this@@7) true))
 :qid |Callsdfy.76:14|
 :skolemid |577|
 :pattern ( (|FunctionValues.Class.F#requires| this@@7))
)))
...
(assert (forall (($bx@@2 T@U) ($heap@@20 T@U) ) (! (= (|Set#IsMember| (Reads0 TInt $heap@@20 |FunctionValues.Class.G#Handle|) $bx@@2) false)
 :qid |unknown.0:0|
 :skolemid |541|
 :pattern ( (|Set#IsMember| (Reads0 TInt $heap@@20 |FunctionValues.Class.G#Handle|) $bx@@2))
)))
(assert (forall (($bx@@3 T@U) ($heap@@21 T@U) ) (! (= (|Set#IsMember| (Reads0 TInt $heap@@21 |FunctionValues.Color.G#Handle|) $bx@@3) false)
 :qid |unknown.0:0|
 :skolemid |551|
 :pattern ( (|Set#IsMember| (Reads0 TInt $heap@@21 |FunctionValues.Color.G#Handle|) $bx@@3))
)))
(assert (forall (($bx@@4 T@U) ($heap@@22 T@U) ) (! (= (|Set#IsMember| (Reads0 TInt $heap@@22 |FunctionValues.NT.G#Handle|) $bx@@4) false)
 :qid |unknown.0:0|
 :skolemid |561|
 :pattern ( (|Set#IsMember| (Reads0 TInt $heap@@22 |FunctionValues.NT.G#Handle|) $bx@@4))
)))
(push 1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |x##0@0| (LitInt 5))) (=> (and (and (or (not (= call2formal@this null)) (not true)) (and ($Is refType call2formal@this Tclass.FunctionValues.Class) ($IsAlloc refType call2formal@this Tclass.FunctionValues.Class $Heap))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (=> (and (and (and (or (not (= call2formal@this@0 null)) (not true)) (and ($Is refType call2formal@this@0 Tclass.FunctionValues.Class) ($IsAlloc refType call2formal@this@0 Tclass.FunctionValues.Class $Heap@0))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap call2formal@this@0) alloc))))) (and (and (forall (($o@@4 T@U) ) (!  (=> (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@4) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@4)))
 :qid |Callsdfy.75:5|
 :skolemid |574|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4))
)) ($HeapSucc $Heap $Heap@0)) (and (= |color#0@0| (Lit DatatypeTypeType |#FunctionValues.Color.Red|)) (= |newtype$check#0@0| (LitInt 5))))) (and (=> (= (ControlFlow 0 2) (- 0 21)) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 15))) (=> (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 15)) (=> (= |nt#0@0| (LitInt 5)) (and (=> (= (ControlFlow 0 2) (- 0 20)) (or (not (= 1 $FunctionContextHeight)) (not true))) (=> (or (not (= 1 $FunctionContextHeight)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 19)) true) (and (=> (= (ControlFlow 0 2) (- 0 18)) (or (not (= call2formal@this@0 null)) (not true))) (=> (or (not (= call2formal@this@0 null)) (not true)) (=> (= |f##0@0| (|FunctionValues.Class.F#Handle| call2formal@this@0)) (=> (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (forall (($o@@5 T@U) ) (!  (=> (and (or (not (= $o@@5 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@5) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@5) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@5)))
 :qid |Callsdfy.69:10|
 :skolemid |566|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@5))
)) ($HeapSucc $Heap@0 $Heap@1))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 16)) true) (=> (= |f##1@0| |FunctionValues.Class.G#Handle|) (=> (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@6) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@6)))
 :qid |Callsdfy.69:10|
 :skolemid |566|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@6))
)) ($HeapSucc $Heap@1 $Heap@2))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (or (not (= 1 $FunctionContextHeight)) (not true))) (=> (or (not (= 1 $FunctionContextHeight)) (not true)) (=> (= |f##2@0| (|FunctionValues.Color.F#Handle| |color#0@0|)) (=> (and (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (and (forall (($o@@7 T@U) ) (!  (=> (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@7) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@7) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@7)))
 :qid |Callsdfy.69:10|
 :skolemid |566|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@7))
)) ($HeapSucc $Heap@2 $Heap@3))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> (= |f##3@0| |FunctionValues.Color.G#Handle|) (=> (and (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (and (forall (($o@@8 T@U) ) (!  (=> (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@8) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@8) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@8)))
 :qid |Callsdfy.69:10|
 :skolemid |566|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@8))
)) ($HeapSucc $Heap@3 $Heap@4))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> (= |f##4@0| (|FunctionValues.NT.F#Handle| |nt#0@0|)) (=> (and (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5)) (and (forall (($o@@9 T@U) ) (!  (=> (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@9) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@9) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@9)))
 :qid |Callsdfy.69:10|
 :skolemid |566|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@9))
)) ($HeapSucc $Heap@4 $Heap@5))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> (= |f##5@0| |FunctionValues.NT.G#Handle|) (=> (and (and ($IsGoodHeap $Heap@6) ($IsHeapAnchor $Heap@6)) (and (forall (($o@@10 T@U) ) (!  (=> (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@10) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@10) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@10)))
 :qid |Callsdfy.69:10|
 :skolemid |566|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@10))
)) ($HeapSucc $Heap@5 $Heap@6))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (or (not (= 1 $FunctionContextHeight)) (not true))) (=> (or (not (= 1 $FunctionContextHeight)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 10)) true) (and (=> (= (ControlFlow 0 2) (- 0 9)) (or (not (= call2formal@this@0 null)) (not true))) (=> (or (not (= call2formal@this@0 null)) (not true)) (=> (= |$rhs#0@0| (|FunctionValues.Class.F#Handle| call2formal@this@0)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 7)) true) (=> (= |$rhs#1@0| |FunctionValues.Class.G#Handle|) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= 1 $FunctionContextHeight)) (not true))) (=> (or (not (= 1 $FunctionContextHeight)) (not true)) (=> (= |$rhs#2@0| (|FunctionValues.Color.F#Handle| |color#0@0|)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> (= |$rhs#3@0| |FunctionValues.Color.G#Handle|) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> (= |$rhs#4@0| (|FunctionValues.NT.F#Handle| |nt#0@0|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> (and (= |$rhs#5@0| |FunctionValues.NT.G#Handle|) (= |x##1@0| (LitInt 2))) (=> (and (and (or (not (= call2formal@this@@0 null)) (not true)) (and ($Is refType call2formal@this@@0 Tclass.FunctionValues.Class) ($IsAlloc refType call2formal@this@@0 Tclass.FunctionValues.Class $Heap))) (and ($IsGoodHeap $Heap@7) ($IsHeapAnchor $Heap@7))) (=> (and (and (and (or (not (= call2formal@this@0@@0 null)) (not true)) (and ($Is refType call2formal@this@0@@0 Tclass.FunctionValues.Class) ($IsAlloc refType call2formal@this@0@@0 Tclass.FunctionValues.Class $Heap@7))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call2formal@this@0@@0) alloc)))) (forall (($o@@11 T@U) ) (!  (=> (and (or (not (= $o@@11 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@11) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@11) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@11)))
 :qid |Callsdfy.75:5|
 :skolemid |574|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@11))
)))) (and (and ($HeapSucc $Heap@6 $Heap@7) (= |$rhs#6@0| (Lit DatatypeTypeType |#FunctionValues.Color.Blue|))) (and (= |newtype$check#1@0| (LitInt 2)) (= (ControlFlow 0 2) (- 0 1))))) (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 15))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (=> |defass#c#0| (and ($Is refType |c#0@@1| Tclass.FunctionValues.Class) ($IsAlloc refType |c#0@@1| Tclass.FunctionValues.Class $Heap))) true)) (and (and ($Is DatatypeTypeType |color#0| Tclass.FunctionValues.Color) ($IsAlloc DatatypeTypeType |color#0| Tclass.FunctionValues.Color $Heap)) true)) (=> (and (and (and (and (and (<= (LitInt 0) |nt#0|) (< |nt#0| 15)) true) (and (and ($Is HandleTypeType |x0#0| (Tclass._System.___hTotalFunc0 TInt)) ($IsAlloc HandleTypeType |x0#0| (Tclass._System.___hTotalFunc0 TInt) $Heap)) true)) (and (and (and ($Is HandleTypeType |x1#0| (Tclass._System.___hTotalFunc0 TInt)) ($IsAlloc HandleTypeType |x1#0| (Tclass._System.___hTotalFunc0 TInt) $Heap)) true) (and (and ($Is HandleTypeType |x2#0| (Tclass._System.___hTotalFunc0 TInt)) ($IsAlloc HandleTypeType |x2#0| (Tclass._System.___hTotalFunc0 TInt) $Heap)) true))) (and (and (and (and ($Is HandleTypeType |x3#0| (Tclass._System.___hTotalFunc0 TInt)) ($IsAlloc HandleTypeType |x3#0| (Tclass._System.___hTotalFunc0 TInt) $Heap)) true) (and (and ($Is HandleTypeType |x4#0| (Tclass._System.___hTotalFunc0 TInt)) ($IsAlloc HandleTypeType |x4#0| (Tclass._System.___hTotalFunc0 TInt) $Heap)) true)) (and (and (and ($Is HandleTypeType |x5#0| (Tclass._System.___hTotalFunc0 TInt)) ($IsAlloc HandleTypeType |x5#0| (Tclass._System.___hTotalFunc0 TInt) $Heap)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 22) 2))))) anon0_correct))))
