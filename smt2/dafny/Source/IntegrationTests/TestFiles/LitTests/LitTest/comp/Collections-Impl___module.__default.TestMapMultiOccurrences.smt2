...
(assert (forall ((m T@U) (u T@U) (v T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| m) u) (= (|Map#Card| (|Map#Build| m u v)) (|Map#Card| m)))
 :qid |DafnyPreludebpl.1469:15|
 :skolemid |4768|
 :pattern ( (|Map#Card| (|Map#Build| m u v)))
)))
...
(assert (forall ((m@@0 T@U) (u@@0 T@U) (v@@1 T@U) ) (!  (=> (not (|Set#IsMember| (|Map#Domain| m@@0) u@@0)) (= (|Map#Card| (|Map#Build| m@@0 u@@0 v@@1)) (+ (|Map#Card| m@@0) 1)))
 :qid |DafnyPreludebpl.1471:15|
 :skolemid |4769|
 :pattern ( (|Map#Card| (|Map#Build| m@@0 u@@0 v@@1)))
)))
...
(assert (forall ((v@@4 T@U) (t0@@0 T@U) (h@@0 T@U) ) (! (= ($IsAlloc SetType v@@4 (TSet t0@@0) h@@0) (forall ((bx@@1 T@U) ) (!  (=> (|Set#IsMember| v@@4 bx@@1) ($IsAllocBox bx@@1 t0@@0 h@@0))
 :qid |DafnyPreludebpl.299:11|
 :skolemid |4544|
 :pattern ( (|Set#IsMember| v@@4 bx@@1))
)))
...
(assert  (and (and (and (= (Ctor MapType) 5) (forall ((t0@@1 T@T) (t1 T@T) (val T@U) (m@@3 T@U) (x0 T@U) ) (! (= (MapType0Select t0@@1 t1 (MapType0Store t0@@1 t1 m@@3 x0 val) x0) val)
 :qid |mapAx0:MapType0Select|
 :weight 0
))) (forall ((u0 T@T) (u1 T@T) (val@@0 T@U) (m@@4 T@U) (x0@@0 T@U) (y0 T@U) ) (!  (or (= x0@@0 y0) (= (MapType0Select u0 u1 (MapType0Store u0 u1 m@@4 x0@@0 val@@0) y0) (MapType0Select u0 u1 m@@4 y0)))
 :qid |mapAx1:MapType0Select:0|
 :weight 0
))) (= (Ctor BoxType) 6)))
(assert (forall ((v@@5 T@U) (t0@@2 T@U) (t1@@0 T@U) (h@@1 T@U) ) (! (= ($IsAlloc MapType v@@5 (TMap t0@@2 t1@@0) h@@1) (forall ((bx@@2 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@5) bx@@2) (and ($IsAllocBox (MapType0Select BoxType BoxType (|Map#Elements| v@@5) bx@@2) t1@@0 h@@1) ($IsAllocBox bx@@2 t0@@2 h@@1)))
 :qid |DafnyPreludebpl.318:19|
 :skolemid |4552|
 :pattern ( (MapType0Select BoxType BoxType (|Map#Elements| v@@5) bx@@2))
 :pattern ( (|Set#IsMember| (|Map#Domain| v@@5) bx@@2))
)))
 :qid |DafnyPreludebpl.315:15|
 :skolemid |4553|
 :pattern ( ($IsAlloc MapType v@@5 (TMap t0@@2 t1@@0) h@@1))
)))
...
(assert (forall ((bx@@3 T@U) (s@@1 T@U) (t@@6 T@U) ) (!  (=> ($IsBox bx@@3 (TMap s@@1 t@@6)) (and (= ($Box MapType ($Unbox MapType bx@@3)) bx@@3) ($Is MapType ($Unbox MapType bx@@3) (TMap s@@1 t@@6))))
 :qid |DafnyPreludebpl.207:15|
 :skolemid |4513|
 :pattern ( ($IsBox bx@@3 (TMap s@@1 t@@6)))
)))
...
(assert  (and (and (and (and (and (and (forall ((t0@@3 T@T) (t1@@1 T@T) (t2 T@T) (val@@1 T@U) (m@@5 T@U) (x0@@1 T@U) (x1 T@U) ) (! (= (MapType1Select t0@@3 t1@@1 t2 (MapType1Store t0@@3 t1@@1 t2 m@@5 x0@@1 x1 val@@1) x0@@1 x1) val@@1)
...
(assert (forall ((m@@12 T@U) (u@@6 T@U) (|u'| T@U) (v@@8 T@U) ) (!  (and (=> (= |u'| u@@6) (and (|Set#IsMember| (|Map#Domain| (|Map#Build| m@@12 u@@6 v@@8)) |u'|) (= (MapType0Select BoxType BoxType (|Map#Elements| (|Map#Build| m@@12 u@@6 v@@8)) |u'|) v@@8))) (=> (or (not (= |u'| u@@6)) (not true)) (and (= (|Set#IsMember| (|Map#Domain| (|Map#Build| m@@12 u@@6 v@@8)) |u'|) (|Set#IsMember| (|Map#Domain| m@@12) |u'|)) (= (MapType0Select BoxType BoxType (|Map#Elements| (|Map#Build| m@@12 u@@6 v@@8)) |u'|) (MapType0Select BoxType BoxType (|Map#Elements| m@@12) |u'|)))))
 :qid |DafnyPreludebpl.1463:15|
 :skolemid |4767|
 :pattern ( (|Set#IsMember| (|Map#Domain| (|Map#Build| m@@12 u@@6 v@@8)) |u'|))
 :pattern ( (MapType0Select BoxType BoxType (|Map#Elements| (|Map#Build| m@@12 u@@6 v@@8)) |u'|))
)))
...
(assert (forall ((v@@9 T@U) (t0@@4 T@U) (t1@@2 T@U) ) (! (= ($Is MapType v@@9 (TMap t0@@4 t1@@2)) (forall ((bx@@6 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@9) bx@@6) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@9) bx@@6) t1@@2) ($IsBox bx@@6 t0@@4)))
...
(assert (forall ((h@@2 T@U) (v@@10 T@U) ) (! ($IsAlloc intType v@@10 TInt h@@2)
 :qid |DafnyPreludebpl.289:14|
 :skolemid |4538|
 :pattern ( ($IsAlloc intType v@@10 TInt h@@2))
)))
(assert (forall ((m@@16 T@U) ) (!  (or (= m@@16 |Map#Empty|) (exists ((k@@0 T@U) (v@@11 T@U) ) (! (|Set#IsMember| (|Map#Items| m@@16) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| k@@0 v@@11)))
...
(set-info :boogie-vc-id Impl$$_module.__default.TestMapMultiOccurrences)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |a#0@0| (Lit MapType (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 1))) ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 1))) ($Box intType (int_2_U (LitInt 2))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= (|Map#Card| |a#0@0|) (LitInt 1))) (=> (= (|Map#Card| |a#0@0|) (LitInt 1)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Set#IsMember| (|Map#Domain| |a#0@0|) ($Box intType (int_2_U (LitInt 1))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |a#0@0|) ($Box intType (int_2_U (LitInt 1)))))) (LitInt 2))) (=> (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |a#0@0|) ($Box intType (int_2_U (LitInt 1)))))) (LitInt 2)) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#IsMember| (|Map#Domain| |a#0@0|) ($Box intType (int_2_U (LitInt 1)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |a#0| (TMap TInt TInt)) ($IsAlloc MapType |a#0| (TMap TInt TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 6) 2))) anon0_correct))))
