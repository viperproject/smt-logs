...
(set-info :boogie-vc-id Impl$$CharSetPrinter.__default.Minimum)
...
(let ((anon9_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (exists ((|$as#i0_0#0_0| T@U) ) (!  (and ($Is charType |$as#i0_0#0_0| TChar) (|Set#IsMember| |ss#0@1| ($Box charType |$as#i0_0#0_0|)))
 :qid |Collectionsdfy.101:11|
 :skolemid |2948|
))) (=> (exists ((|$as#i0_0#0_0@@0| T@U) ) (!  (and ($Is charType |$as#i0_0#0_0@@0| TChar) (|Set#IsMember| |ss#0@1| ($Box charType |$as#i0_0#0_0@@0|)))
 :qid |Collectionsdfy.101:11|
 :skolemid |2948|
)) (=> ($Is charType |i#0_0@1| TChar) (=> (and (|Set#IsMember| |ss#0@1| ($Box charType |i#0_0@1|)) (= |ss#0@2| (|Set#Difference| |ss#0@1| (|Set#UnionOne| |Set#Empty| ($Box charType |i#0_0@1|))))) (=> (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0)))
 :qid |Collectionsdfy.55:10|
 :skolemid |2957|
...
(let ((anon2_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (exists ((|$as#r0#0| T@U) ) (!  (and ($Is charType |$as#r0#0| TChar) (|Set#IsMember| |s#0| ($Box charType |$as#r0#0|)))
 :qid |Collectionsdfy.95:5|
 :skolemid |2945|
))) (=> (exists ((|$as#r0#0@@0| T@U) ) (!  (and ($Is charType |$as#r0#0@@0| TChar) (|Set#IsMember| |s#0| ($Box charType |$as#r0#0@@0|)))
 :qid |Collectionsdfy.95:5|
 :skolemid |2945|
)) (=> (and (and ($Is charType |r#0@0| TChar) (|Set#IsMember| |s#0| ($Box charType |r#0@0|))) (and (= |ss#0@0| (|Set#Difference| |s#0| (|Set#UnionOne| |Set#Empty| ($Box charType |r#0@0|)))) (= (ControlFlow 0 18) 17))) anon14_LoopHead_correct)))))
