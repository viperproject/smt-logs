...
(assert (distinct alloc Tagclass._module.IList |##_module.IList.ICons| |##_module.IList.INil| tytagFamily$IList)
)
(assert (= (DatatypeCtorId |#_module.IList.INil|) |##_module.IList.INil|))
(assert (= (Ctor DatatypeTypeType) 3))
(assert (forall ((_module.IList$G T@U) ) (! ($Is DatatypeTypeType |#_module.IList.INil| (Tclass._module.IList _module.IList$G))
 :qid |unknown.0:0|
 :skolemid |890|
 :pattern ( ($Is DatatypeTypeType |#_module.IList.INil| (Tclass._module.IList _module.IList$G)))
)))
...
(assert (forall ((_module.IList$G@@0 T@U) (|a#2#0#0| T@U) (|a#2#1#0| T@U) ) (! (= ($Is DatatypeTypeType (|#_module.IList.ICons| |a#2#0#0| |a#2#1#0|) (Tclass._module.IList _module.IList$G@@0))  (and ($IsBox |a#2#0#0| _module.IList$G@@0) ($Is DatatypeTypeType |a#2#1#0| (Tclass._module.IList _module.IList$G@@0))))
 :qid |unknown.0:0|
 :skolemid |882|
 :pattern ( ($Is DatatypeTypeType (|#_module.IList.ICons| |a#2#0#0| |a#2#1#0|) (Tclass._module.IList _module.IList$G@@0)))
)))
...
(assert (forall ((_module.IList$G@@1 T@U) ) (!  (and (= (Tag (Tclass._module.IList _module.IList$G@@1)) Tagclass._module.IList) (= (TagFamily (Tclass._module.IList _module.IList$G@@1)) tytagFamily$IList))
 :qid |unknown.0:0|
 :skolemid |694|
 :pattern ( (Tclass._module.IList _module.IList$G@@1))
)))
(assert (forall ((_module.IList$G@@2 T@U) (d@@3 T@U) ) (!  (=> ($Is DatatypeTypeType d@@3 (Tclass._module.IList _module.IList$G@@2)) (or (_module.IList.ICons_q d@@3) (_module.IList.INil_q d@@3)))
 :qid |unknown.0:0|
 :skolemid |893|
 :pattern ( (_module.IList.INil_q d@@3) ($Is DatatypeTypeType d@@3 (Tclass._module.IList _module.IList$G@@2)))
 :pattern ( (_module.IList.ICons_q d@@3) ($Is DatatypeTypeType d@@3 (Tclass._module.IList _module.IList$G@@2)))
)))
...
(assert (forall ((_module.IList$G@@3 T@U) ) (! (= (Tclass._module.IList_0 (Tclass._module.IList _module.IList$G@@3)) _module.IList$G@@3)
 :qid |unknown.0:0|
 :skolemid |695|
 :pattern ( (Tclass._module.IList _module.IList$G@@3))
)))
...
(assert (forall ((_module.IList$G@@4 T@U) (bx T@U) ) (!  (=> ($IsBox bx (Tclass._module.IList _module.IList$G@@4)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx)) bx) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx) (Tclass._module.IList _module.IList$G@@4))))
 :qid |unknown.0:0|
 :skolemid |696|
 :pattern ( ($IsBox bx (Tclass._module.IList _module.IList$G@@4)))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.EmptyList)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon6_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (not (U_2_bool (Lit boolType (bool_2_U (_module.IList.ICons_q (Lit DatatypeTypeType |#_module.IList.INil|)))))))))
