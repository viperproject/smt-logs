...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Main (correctness)"} Impl$$_module.__default.Main() returns ($_reverifyPost: bool)
{
  ...
  var ##xs#1: DatatypeType;
    ...
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(9,9)
    assume true;
    assume true;
    a#0 := Lit(#_module.List.Nil());
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(10,9)
    assume true;
    assume true;
    b#0 := #_module.List.Cons(LitInt(5), a#0);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(11,9)
    assume true;
    assume true;
    c#0 := #_System._tuple#2._#Make2($Box(a#0), $Box(b#0));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(12,9)
    assume true;
    ...
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(13,9)
    assume true;
    assume true;
    e#0 := Lit(#_System._tuple#0._#Make0());
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(14,3)
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(15,3)
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(16,3)
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(17,3)
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(18,3)
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(20,3)
    assert {:id "id5"} _module.List.Cons_q(b#0);
    assume true;
    assume true;
    assert {:id "id6"} _module.List.Cons_q(b#0);
    assume true;
    assume true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(22,9)
    assume true;
    assert {:id "id7"} $Is(LitInt(0), Tclass._System.nat());
    ##m#0 := LitInt(0);
    // assume allocatedness for argument to function
    assume $IsAlloc(##m#0, Tclass._System.nat(), $Heap);
    assert {:id "id8"} $Is(LitInt(7), Tclass._System.nat());
    ##n#0 := LitInt(7);
    // assume allocatedness for argument to function
    assume $IsAlloc(##n#0, Tclass._System.nat(), $Heap);
    assert {:id "id9"} {:subsumption 0} ##m#0 <= ##n#0;
    assume ##m#0 <= ##n#0;
    assume _module.__default.Up#canCall(LitInt(0), LitInt(7));
    assume _module.__default.Up#canCall(LitInt(0), LitInt(7));
    u#0 := Lit(_module.__default.Up($LS($LZ), LitInt(0), LitInt(7)));
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(23,3)
    assume true;
    assume true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(24,9)
    assume true;
    ##xs#0 := u#0;
    // assume allocatedness for argument to function
    ...
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(25,11)
    ...
    call {:id "id12"} Call$$_module.__default.PrintSum(xs##0, prefix##0);
    // TrCallStmt: After ProcessCallStmt
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(26,3)
    assume true;
    assume true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(27,5)
    assume true;
    ##xs#1 := u#0;
    // assume allocatedness for argument to function
    ...
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(28,3)
    assume true;
    assume true;
    assume true;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(30,11)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id14"} Call$$_module.__default.AllBerry();
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(31,23)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id15"} Call$$_module.__default.TestConflictingNames();
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(32,13)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id16"} Call$$_module.__default.TestModule();
    // TrCallStmt: After ProcessCallStmt
}
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Up (well-formedness)"} CheckWellformed$$_module.__default.Up(m#0: int, n#0: int)
{
  ...
  var ##n#0: int;
    ...
    else
    {
        ...
        if (m#0 == n#0)
        {
            assume {:id "id20"} _module.__default.Up($LS($LZ), m#0, n#0) == Lit(#_module.List.Nil());
            assume true;
        ...
        {
            assert {:id "id21"} $Is(m#0 + 1, Tclass._System.nat());
            ##m#0 := m#0 + 1;
            // assume allocatedness for argument to function
            assume $IsAlloc(##m#0, Tclass._System.nat(), $Heap);
            ##n#0 := n#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##n#0, Tclass._System.nat(), $Heap);
            assert {:id "id22"} {:subsumption 0} ##m#0 <= ##n#0;
            assume ##m#0 <= ##n#0;
            assert {:id "id23"} 0 <= n#0 - m#0 || ##n#0 - ##m#0 == n#0 - m#0;
            assert {:id "id24"} ##n#0 - ##m#0 < n#0 - m#0;
            assume _module.__default.Up#canCall(m#0 + 1, n#0);
            assume {:id "id25"} _module.__default.Up($LS($LZ), m#0, n#0)
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Sum (well-formedness)"} CheckWellformed$$_module.__default.Sum(xs#0: DatatypeType)
{
  ...
  var ##xs#0: DatatypeType;
    ...
    else
    {
        ...
        {
            assume {:id "id34"} _module.__default.Sum($LS($LZ), xs#0) == LitInt(0);
            assume true;
            // CheckWellformedWithResult: any expression
        ...
        else if (xs#0 == #_module.List.Cons(_mcc#0#0, _mcc#1#0))
        {
            ...
            havoc tail#Z#0;
            assume {:id "id28"} let#0#0#0 == _mcc#1#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#0#0#0, Tclass._module.List());
            assume {:id "id29"} tail#Z#0 == let#0#0#0;
            havoc x#Z#0;
            assume {:id "id30"} let#1#0#0 == _mcc#0#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#1#0#0, TInt);
            assume {:id "id31"} x#Z#0 == let#1#0#0;
            ##xs#0 := tail#Z#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##xs#0, Tclass._module.List(), $Heap);
            assert {:id "id32"} DtRank(##xs#0) < DtRank(xs#0);
            assume _module.__default.Sum#canCall(tail#Z#0);
            assume {:id "id33"} _module.__default.Sum($LS($LZ), xs#0)
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "SumAgain (well-formedness)"} CheckWellformed$$_module.__default.SumAgain(xs#0: DatatypeType)
{
  ...
  var ##xs#0: DatatypeType;
    ...
    else
    {
        ...
        if (xs#0 == #_module.List.Nil())
        {
            assume {:id "id43"} let#0#0#0 == LitInt(0);
            assume true;
            // CheckWellformedWithResult: any expression
        ...
        else if (xs#0 == #_module.List.Cons(_mcc#0#0, _mcc#1#0))
        {
            assume $Is(_mcc#1#0, Tclass._module.List());
            havoc tail#Z#0;
            assume {:id "id37"} let#1#0#0 == _mcc#1#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#1#0#0, Tclass._module.List());
            assume {:id "id38"} tail#Z#0 == let#1#0#0;
            havoc x#Z#0;
            assume {:id "id39"} let#2#0#0 == _mcc#0#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#2#0#0, TInt);
            assume {:id "id40"} x#Z#0 == let#2#0#0;
            ##xs#0 := tail#Z#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##xs#0, Tclass._module.List(), $Heap);
            assert {:id "id41"} DtRank(##xs#0) < DtRank(xs#0);
            assume _module.__default.SumAgain#canCall(tail#Z#0);
            assume {:id "id42"} let#0#0#0 == x#Z#0 + _module.__default.SumAgain($LS($LZ), tail#Z#0);
            assume _module.__default.SumAgain#canCall(tail#Z#0);
            // CheckWellformedWithResult: any expression
            assume $Is(let#0#0#0, TInt);
        }
        ...
        assume {:id "id44"} r#Z#0 == let#0#0#0;
        assume {:id "id45"} _module.__default.SumAgain($LS($LZ), xs#0) == r#Z#0;
        assume true;
        // CheckWellformedWithResult: any expression
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "PrintSum (correctness)"} Impl$$_module.__default.PrintSum(xs#0: DatatypeType, prefix#0: Seq) returns ($_reverifyPost: bool)
{
  ...
  var prefix##0_0: Seq;
    ...
    else if (xs#0 == #_module.List.Cons(_mcc#0#0_0, _mcc#1#0_0))
    {
        ...
        assume {:id "id46"} let#0_0#0#0 == _mcc#1#0_0;
        assume true;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(let#0_0#0#0, Tclass._module.List());
        assume {:id "id47"} tail#0_0 == let#0_0#0#0;
        havoc x#0_0;
        assume {:id "id48"} let#0_1#0#0 == _mcc#0#0_0;
        assume true;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(let#0_1#0#0, TInt);
        assume {:id "id49"} x#0_0 == let#0_1#0#0;
        // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(59,5)
        assume true;
        assume true;
        // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(60,13)
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        // ProcessCallStmt: CheckSubrange
        xs##0_0 := tail#0_0;
        ...
        prefix##0_0 := Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(32))), $Box(char#FromInt(43))), 
            $Box(char#FromInt(32))));
        assert {:id "id50"} DtRank(xs##0_0) < DtRank(xs#0)
           || (DtRank(xs##0_0) == DtRank(xs#0) && Seq#Rank(prefix##0_0) < Seq#Rank(prefix#0));
        call {:id "id51"} Call$$_module.__default.PrintSum(xs##0_0, prefix##0_0);
        // TrCallStmt: After ProcessCallStmt
    }
    else
    {
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestConflictingNames (correctness)"} Impl$$_module.__default.TestConflictingNames() returns ($_reverifyPost: bool)
{
  ...
  var x#0: DatatypeType
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(76,9)
    assume true;
    assume true;
    ...
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(77,3)
    assert {:id "id57"} _module.ConflictingNames.ConflictingNames1_q(x#0);
    assume true;
    assume true;
    assert {:id "id58"} _module.ConflictingNames.ConflictingNames1_q(x#0);
    assume true;
    assume true;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestModule (correctness)"} Impl$$_module.__default.TestModule() returns ($_reverifyPost: bool)
{
  ...
  var x##0: DatatypeType;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/firstSteps/7_Dt_Algebraic.dfy(85,13)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##0 := Lit(#ModuleM.OptionInt.Some(LitInt(1701)));
    call {:id "id59"} Call$$_module.__default.PrintMaybe(x##0);
    // TrCallStmt: After ProcessCallStmt
}



function Tclass.ModuleM.OptionInt() : Ty
uses {
// Tclass.ModuleM.OptionInt Tag
axiom Tag(Tclass.ModuleM.OptionInt()) == Tagclass.ModuleM.OptionInt
   && TagFamily(Tclass.ModuleM.OptionInt()) == tytagFamily$OptionInt;
}

const unique Tagclass.ModuleM.OptionInt: TyTag;

// Box/unbox axiom for Tclass.ModuleM.OptionInt
axiom (forall bx: Box :: 
  { $IsBox(bx, Tclass.ModuleM.OptionInt()) } 
  $IsBox(bx, Tclass.ModuleM.OptionInt())
     ==> $Box($Unbox(bx): DatatypeType) == bx
       && $Is($Unbox(bx): DatatypeType, Tclass.ModuleM.OptionInt()));

procedure {:verboseName "PrintMaybe (well-formedness)"} CheckWellFormed$$_module.__default.PrintMaybe(x#0: DatatypeType
       where $Is(x#0, Tclass.ModuleM.OptionInt())
         && $IsAlloc(x#0, Tclass.ModuleM.OptionInt(), $Heap)
         && $IsA#ModuleM.OptionInt(x#0));
...
uses {
// Constructor identifier
axiom (forall a#27#0#0: int, a#27#1#0: char, a#27#2#0: Seq :: 
  { #_module.ConflictingNames.ConflictingNames1(a#27#0#0, a#27#1#0, a#27#2#0) } 
  DatatypeCtorId(#_module.ConflictingNames.ConflictingNames1(a#27#0#0, a#27#1#0, a#27#2#0))
...
axiom (forall d: DatatypeType :: 
  { _module.ConflictingNames.ConflictingNames1_q(d) } 
  _module.ConflictingNames.ConflictingNames1_q(d)
     ==> (exists a#28#0#0: int, a#28#1#0: char, a#28#2#0: Seq :: 
      d == #_module.ConflictingNames.ConflictingNames1(a#28#0#0, a#28#1#0, a#28#2#0)));

// Constructor $Is
axiom (forall a#29#0#0: int, a#29#1#0: char, a#29#2#0: Seq :: 
  { $Is(#_module.ConflictingNames.ConflictingNames1(a#29#0#0, a#29#1#0, a#29#2#0), 
      Tclass._module.ConflictingNames()) } 
  $Is(#_module.ConflictingNames.ConflictingNames1(a#29#0#0, a#29#1#0, a#29#2#0), 
      Tclass._module.ConflictingNames())
     <==> $Is(a#29#0#0, TInt) && $Is(a#29#1#0, TChar) && $Is(a#29#2#0, TSeq(TChar)));
...
// Constructor literal
axiom (forall a#30#0#0: int, a#30#1#0: char, a#30#2#0: Seq :: 
  { #_module.ConflictingNames.ConflictingNames1(LitInt(a#30#0#0), Lit(a#30#1#0), Lit(a#30#2#0)) } 
  #_module.ConflictingNames.ConflictingNames1(LitInt(a#30#0#0), Lit(a#30#1#0), Lit(a#30#2#0))
     == Lit(#_module.ConflictingNames.ConflictingNames1(a#30#0#0, a#30#1#0, a#30#2#0)));

function _module.ConflictingNames.len(DatatypeType) : int;

// Constructor injectivity
axiom (forall a#31#0#0: int, a#31#1#0: char, a#31#2#0: Seq :: 
  { #_module.ConflictingNames.ConflictingNames1(a#31#0#0, a#31#1#0, a#31#2#0) } 
  _module.ConflictingNames.len(#_module.ConflictingNames.ConflictingNames1(a#31#0#0, a#31#1#0, a#31#2#0))
     == a#31#0#0);

function _module.ConflictingNames.public(DatatypeType) : char;

// Constructor injectivity
axiom (forall a#32#0#0: int, a#32#1#0: char, a#32#2#0: Seq :: 
  { #_module.ConflictingNames.ConflictingNames1(a#32#0#0, a#32#1#0, a#32#2#0) } 
  _module.ConflictingNames.public(#_module.ConflictingNames.ConflictingNames1(a#32#0#0, a#32#1#0, a#32#2#0))
     == a#32#1#0);

function _module.ConflictingNames.goto(DatatypeType) : Seq;

// Constructor injectivity
axiom (forall a#33#0#0: int, a#33#1#0: char, a#33#2#0: Seq :: 
  { #_module.ConflictingNames.ConflictingNames1(a#33#0#0, a#33#1#0, a#33#2#0) } 
  _module.ConflictingNames.goto(#_module.ConflictingNames.ConflictingNames1(a#33#0#0, a#33#1#0, a#33#2#0))
     == a#33#2#0);

// Inductive seq element rank
axiom (forall a#34#0#0: int, a#34#1#0: char, a#34#2#0: Seq, i: int :: 
  { Seq#Index(a#34#2#0, i), #_module.ConflictingNames.ConflictingNames1(a#34#0#0, a#34#1#0, a#34#2#0) } 
  0 <= i && i < Seq#Length(a#34#2#0)
     ==> DtRank($Unbox(Seq#Index(a#34#2#0, i)): DatatypeType)
       < DtRank(#_module.ConflictingNames.ConflictingNames1(a#34#0#0, a#34#1#0, a#34#2#0)));

// Inductive seq rank
axiom (forall a#35#0#0: int, a#35#1#0: char, a#35#2#0: Seq :: 
  { #_module.ConflictingNames.ConflictingNames1(a#35#0#0, a#35#1#0, a#35#2#0) } 
  Seq#Rank(a#35#2#0)
     < DtRank(#_module.ConflictingNames.ConflictingNames1(a#35#0#0, a#35#1#0, a#35#2#0)));
...
axiom (forall a#36#0#0: Seq :: 
  { #_module.ConflictingNames.ConflictingNames2(a#36#0#0) } 
  DatatypeCtorId(#_module.ConflictingNames.ConflictingNames2(a#36#0#0))
...
axiom (forall d: DatatypeType :: 
  ...
  _module.ConflictingNames.ConflictingNames2_q(d)
     ==> (exists a#37#0#0: Seq :: 
      d == #_module.ConflictingNames.ConflictingNames2(a#37#0#0)));

// Constructor $Is
axiom (forall a#38#0#0: Seq :: 
  { $Is(#_module.ConflictingNames.ConflictingNames2(a#38#0#0), 
      Tclass._module.ConflictingNames()) } 
  $Is(#_module.ConflictingNames.ConflictingNames2(a#38#0#0), 
      Tclass._module.ConflictingNames())
     <==> $Is(a#38#0#0, TSeq(TChar)));
...
axiom (forall a#39#0#0: Seq :: 
  { #_module.ConflictingNames.ConflictingNames2(Lit(a#39#0#0)) } 
  #_module.ConflictingNames.ConflictingNames2(Lit(a#39#0#0))
     == Lit(#_module.ConflictingNames.ConflictingNames2(a#39#0#0)));

// Constructor injectivity
axiom (forall a#40#0#0: Seq :: 
  { #_module.ConflictingNames.ConflictingNames2(a#40#0#0) } 
  _module.ConflictingNames.goto(#_module.ConflictingNames.ConflictingNames2(a#40#0#0))
     == a#40#0#0);

// Inductive seq element rank
axiom (forall a#41#0#0: Seq, i: int :: 
  { Seq#Index(a#41#0#0, i), #_module.ConflictingNames.ConflictingNames2(a#41#0#0) } 
  0 <= i && i < Seq#Length(a#41#0#0)
     ==> DtRank($Unbox(Seq#Index(a#41#0#0, i)): DatatypeType)
       < DtRank(#_module.ConflictingNames.ConflictingNames2(a#41#0#0)));

// Inductive seq rank
axiom (forall a#42#0#0: Seq :: 
  { #_module.ConflictingNames.ConflictingNames2(a#42#0#0) } 
  Seq#Rank(a#42#0#0)
     < DtRank(#_module.ConflictingNames.ConflictingNames2(a#42#0#0)));
...
const unique class.ModuleM.__default: ClassName;

// Constructor function declaration
function #ModuleM.OptionInt.Some(int) : DatatypeType;

const unique ##ModuleM.OptionInt.Some: DtCtorId
uses {
// Constructor identifier
axiom (forall a#43#0#0: int :: 
  { #ModuleM.OptionInt.Some(a#43#0#0) } 
  DatatypeCtorId(#ModuleM.OptionInt.Some(a#43#0#0)) == ##ModuleM.OptionInt.Some);
}

function ModuleM.OptionInt.Some_q(DatatypeType) : bool;

// Questionmark and identifier
axiom (forall d: DatatypeType :: 
  { ModuleM.OptionInt.Some_q(d) } 
  ModuleM.OptionInt.Some_q(d) <==> DatatypeCtorId(d) == ##ModuleM.OptionInt.Some);

// Constructor questionmark has arguments
axiom (forall d: DatatypeType :: 
  { ModuleM.OptionInt.Some_q(d) } 
  ModuleM.OptionInt.Some_q(d)
     ==> (exists a#44#0#0: int :: d == #ModuleM.OptionInt.Some(a#44#0#0)));

// Constructor $Is
axiom (forall a#45#0#0: int :: 
  { $Is(#ModuleM.OptionInt.Some(a#45#0#0), Tclass.ModuleM.OptionInt()) } 
  $Is(#ModuleM.OptionInt.Some(a#45#0#0), Tclass.ModuleM.OptionInt())
     <==> $Is(a#45#0#0, TInt));

// Destructor $IsAlloc
axiom (forall d: DatatypeType, $h: Heap :: 
  { $IsAlloc(ModuleM.OptionInt._h0(d), TInt, $h) } 
  $IsGoodHeap($h)
       && 
      ModuleM.OptionInt.Some_q(d)
       && $IsAlloc(d, Tclass.ModuleM.OptionInt(), $h)
     ==> $IsAlloc(ModuleM.OptionInt._h0(d), TInt, $h));

// Constructor literal
axiom (forall a#46#0#0: int :: 
  { #ModuleM.OptionInt.Some(LitInt(a#46#0#0)) } 
  #ModuleM.OptionInt.Some(LitInt(a#46#0#0))
     == Lit(#ModuleM.OptionInt.Some(a#46#0#0)));

function ModuleM.OptionInt._h0(DatatypeType) : int;

// Constructor injectivity
axiom (forall a#47#0#0: int :: 
  { #ModuleM.OptionInt.Some(a#47#0#0) } 
  ModuleM.OptionInt._h0(#ModuleM.OptionInt.Some(a#47#0#0)) == a#47#0#0);

// Constructor function declaration
function #ModuleM.OptionInt.None() : DatatypeType
uses {
// Constructor identifier
axiom DatatypeCtorId(#ModuleM.OptionInt.None()) == ##ModuleM.OptionInt.None;
// Constructor $Is
axiom $Is(#ModuleM.OptionInt.None(), Tclass.ModuleM.OptionInt());
// Constructor literal
axiom #ModuleM.OptionInt.None() == Lit(#ModuleM.OptionInt.None());
}

const unique ##ModuleM.OptionInt.None: DtCtorId
uses {
// Constructor identifier
axiom DatatypeCtorId(#ModuleM.OptionInt.None()) == ##ModuleM.OptionInt.None;
}

function ModuleM.OptionInt.None_q(DatatypeType) : bool;

// Questionmark and identifier
axiom (forall d: DatatypeType :: 
  { ModuleM.OptionInt.None_q(d) } 
  ModuleM.OptionInt.None_q(d) <==> DatatypeCtorId(d) == ##ModuleM.OptionInt.None);

// Constructor questionmark has arguments
axiom (forall d: DatatypeType :: 
  { ModuleM.OptionInt.None_q(d) } 
  ModuleM.OptionInt.None_q(d) ==> d == #ModuleM.OptionInt.None());

// Datatype $IsAlloc
axiom (forall d: DatatypeType, $h: Heap :: 
  { $IsAlloc(d, Tclass.ModuleM.OptionInt(), $h) } 
  $IsGoodHeap($h) && $Is(d, Tclass.ModuleM.OptionInt())
     ==> $IsAlloc(d, Tclass.ModuleM.OptionInt(), $h));

// Depth-one case-split function
function $IsA#ModuleM.OptionInt(DatatypeType) : bool;

// Depth-one case-split axiom
axiom (forall d: DatatypeType :: 
  { $IsA#ModuleM.OptionInt(d) } 
  $IsA#ModuleM.OptionInt(d)
     ==> ModuleM.OptionInt.Some_q(d) || ModuleM.OptionInt.None_q(d));

// Questionmark data type disjunctivity
axiom (forall d: DatatypeType :: 
  { ModuleM.OptionInt.None_q(d), $Is(d, Tclass.ModuleM.OptionInt()) } 
    { ModuleM.OptionInt.Some_q(d), $Is(d, Tclass.ModuleM.OptionInt()) } 
  $Is(d, Tclass.ModuleM.OptionInt())
     ==> ModuleM.OptionInt.Some_q(d) || ModuleM.OptionInt.None_q(d));

// Datatype extensional equality declaration
function ModuleM.OptionInt#Equal(DatatypeType, DatatypeType) : bool;

// Datatype extensional equality definition: #ModuleM.OptionInt.Some
axiom (forall a: DatatypeType, b: DatatypeType :: 
  { ModuleM.OptionInt#Equal(a, b), ModuleM.OptionInt.Some_q(a) } 
    { ModuleM.OptionInt#Equal(a, b), ModuleM.OptionInt.Some_q(b) } 
  ModuleM.OptionInt.Some_q(a) && ModuleM.OptionInt.Some_q(b)
     ==> (ModuleM.OptionInt#Equal(a, b)
       <==> ModuleM.OptionInt._h0(a) == ModuleM.OptionInt._h0(b)));

// Datatype extensional equality definition: #ModuleM.OptionInt.None
axiom (forall a: DatatypeType, b: DatatypeType :: 
  { ModuleM.OptionInt#Equal(a, b), ModuleM.OptionInt.None_q(a) } 
    { ModuleM.OptionInt#Equal(a, b), ModuleM.OptionInt.None_q(b) } 
  ModuleM.OptionInt.None_q(a) && ModuleM.OptionInt.None_q(b)
     ==> ModuleM.OptionInt#Equal(a, b));

// Datatype extensionality axiom: ModuleM.OptionInt
axiom (forall a: DatatypeType, b: DatatypeType :: 
  { ModuleM.OptionInt#Equal(a, b) } 
  ModuleM.OptionInt#Equal(a, b) <==> a == b);

const unique class.ModuleM.OptionInt: ClassName;
