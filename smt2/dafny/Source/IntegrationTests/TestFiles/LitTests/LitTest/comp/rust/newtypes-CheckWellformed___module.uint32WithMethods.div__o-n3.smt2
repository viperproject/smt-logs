...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@0 Int) (|y#0@@0| Int) ) (!  (=> (or (|_module.uint32WithMethods.div__overflow#canCall| this@@0 |y#0@@0|) (and (< 1 $FunctionContextHeight) (and (and (and (<= (LitInt 0) this@@0) (< this@@0 4294967296)) (and (<= (LitInt 0) |y#0@@0|) (< |y#0@@0| 4294967296))) (or (not (= |y#0@@0| 0)) (not true))))) (= (_module.uint32WithMethods.div__overflow this@@0 |y#0@@0|) (nat_from_bv32 (bvudiv ((_ int2bv 32) this@@0) ((_ int2bv 32) |y#0@@0|)))))
 :qid |newtypesdfy.49:12|
 :skolemid |605|
 :pattern ( (_module.uint32WithMethods.div__overflow this@@0 |y#0@@0|))
))))
...
(declare-fun |newtype$check#3@0| () (_ BitVec 32))
...
(set-info :boogie-vc-id CheckWellformed$$_module.uint32WithMethods.div__overflow)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 7)) (and (<= 0 this@@2) (< this@@2 4294967296))) (=> (and (<= 0 this@@2) (< this@@2 4294967296)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (and (<= 0 |y#0@@2|) (< |y#0@@2| 4294967296))) (=> (and (<= 0 |y#0@@2|) (< |y#0@@2| 4294967296)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= ((_ int2bv 32) |y#0@@2|) #x00000000)) (not true))) (=> (or (not (= ((_ int2bv 32) |y#0@@2|) #x00000000)) (not true)) (=> (= |newtype$check#3@0| (bvudiv ((_ int2bv 32) this@@2) ((_ int2bv 32) |y#0@@2|))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= (LitInt 0) (nat_from_bv32 |newtype$check#3@0|)) (< (nat_from_bv32 |newtype$check#3@0|) 4294967296))) (=> (and (<= (LitInt 0) (nat_from_bv32 |newtype$check#3@0|)) (< (nat_from_bv32 |newtype$check#3@0|) 4294967296)) (=> (and (= |newtype$check#4@0| (nat_from_bv32 (bvudiv ((_ int2bv 32) this@@2) ((_ int2bv 32) |y#0@@2|)))) (= (ControlFlow 0 3) (- 0 2))) (and (<= (LitInt 0) |newtype$check#4@0|) (< |newtype$check#4@0| 4294967296))))))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (= |newtype$check#0@0| (LitInt 0))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 4294967296))) (=> (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 4294967296)) (=> (or (not (= |y#0@@2| 0)) (not true)) (and (=> (= (ControlFlow 0 8) 1) anon5_Then_correct) (=> (= (ControlFlow 0 8) 3) anon5_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (<= (LitInt 0) this@@2) (< this@@2 4294967296))) (and (and (<= (LitInt 0) |y#0@@2|) (< |y#0@@2| 4294967296)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 8)))) anon0_correct)))
