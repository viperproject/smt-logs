...
axiom (forall a#42#0#0: int :: 
  { #ImportedTypes.Library.Color.Red(a#42#0#0) } 
  DatatypeCtorId(#ImportedTypes.Library.Color.Red(a#42#0#0))
...
axiom (forall d: DatatypeType :: 
  { ImportedTypes_mLibrary.Color.Red_q(d) } 
  ImportedTypes_mLibrary.Color.Red_q(d)
     ==> (exists a#43#0#0: int :: d == #ImportedTypes.Library.Color.Red(a#43#0#0)));
...
axiom (forall a#44#0#0: int :: 
  { $Is(#ImportedTypes.Library.Color.Red(a#44#0#0), 
...
axiom (forall a#45#0#0: int :: 
  { #ImportedTypes.Library.Color.Red(LitInt(a#45#0#0)) } 
  #ImportedTypes.Library.Color.Red(LitInt(a#45#0#0))
     == Lit(#ImportedTypes.Library.Color.Red(a#45#0#0)));

function ImportedTypes_mLibrary.Color._h14(DatatypeType) : int;

// Constructor injectivity
axiom (forall a#46#0#0: int :: 
  { #ImportedTypes.Library.Color.Red(a#46#0#0) } 
  ImportedTypes_mLibrary.Color._h14(#ImportedTypes.Library.Color.Red(a#46#0#0))
     == a#46#0#0);
...
uses {
// Constructor identifier
axiom (forall a#47#0#0: real :: 
  { #ImportedTypes.Library.Color.Green(a#47#0#0) } 
  DatatypeCtorId(#ImportedTypes.Library.Color.Green(a#47#0#0))
...
axiom (forall d: DatatypeType :: 
  { ImportedTypes_mLibrary.Color.Green_q(d) } 
  ImportedTypes_mLibrary.Color.Green_q(d)
     ==> (exists a#48#0#0: real :: d == #ImportedTypes.Library.Color.Green(a#48#0#0)));

// Constructor $Is
axiom (forall a#49#0#0: real :: 
  { $Is(#ImportedTypes.Library.Color.Green(a#49#0#0), 
      Tclass.ImportedTypes_mLibrary.Color()) } 
  $Is(#ImportedTypes.Library.Color.Green(a#49#0#0), 
      Tclass.ImportedTypes_mLibrary.Color())
     <==> $Is(a#49#0#0, TReal));
...
// Constructor literal
axiom (forall a#50#0#0: real :: 
  { #ImportedTypes.Library.Color.Green(LitReal(a#50#0#0)) } 
  #ImportedTypes.Library.Color.Green(LitReal(a#50#0#0))
     == Lit(#ImportedTypes.Library.Color.Green(a#50#0#0)));

function ImportedTypes_mLibrary.Color._h15(DatatypeType) : real;

// Constructor injectivity
axiom (forall a#51#0#0: real :: 
  { #ImportedTypes.Library.Color.Green(a#51#0#0) } 
  ImportedTypes_mLibrary.Color._h15(#ImportedTypes.Library.Color.Green(a#51#0#0))
     == a#51#0#0);
...
uses {
// Constructor identifier
axiom (forall a#52#0#0: bv30 :: 
  { #ImportedTypes.Library.Color.Blue(a#52#0#0) } 
  DatatypeCtorId(#ImportedTypes.Library.Color.Blue(a#52#0#0))
...
axiom (forall d: DatatypeType :: 
  { ImportedTypes_mLibrary.Color.Blue_q(d) } 
  ImportedTypes_mLibrary.Color.Blue_q(d)
     ==> (exists a#53#0#0: bv30 :: d == #ImportedTypes.Library.Color.Blue(a#53#0#0)));

// Constructor $Is
axiom (forall a#54#0#0: bv30 :: 
  { $Is(#ImportedTypes.Library.Color.Blue(a#54#0#0), 
      Tclass.ImportedTypes_mLibrary.Color()) } 
  $Is(#ImportedTypes.Library.Color.Blue(a#54#0#0), 
      Tclass.ImportedTypes_mLibrary.Color())
     <==> $Is(a#54#0#0, TBitvector(30)));
...
// Constructor literal
axiom (forall a#55#0#0: bv30 :: 
  { #ImportedTypes.Library.Color.Blue(Lit(a#55#0#0)) } 
  #ImportedTypes.Library.Color.Blue(Lit(a#55#0#0))
     == Lit(#ImportedTypes.Library.Color.Blue(a#55#0#0)));

function ImportedTypes_mLibrary.Color._h16(DatatypeType) : bv30;

// Constructor injectivity
axiom (forall a#56#0#0: bv30 :: 
  { #ImportedTypes.Library.Color.Blue(a#56#0#0) } 
  ImportedTypes_mLibrary.Color._h16(#ImportedTypes.Library.Color.Blue(a#56#0#0))
     == a#56#0#0);
...
axiom (forall a#57#0#0: int :: 
  { #ImportedTypes.Library.CoColor.Yellow(a#57#0#0) } 
  DatatypeCtorId(#ImportedTypes.Library.CoColor.Yellow(a#57#0#0))
...
axiom (forall d: DatatypeType :: 
  { ImportedTypes_mLibrary.CoColor.Yellow_q(d) } 
  ImportedTypes_mLibrary.CoColor.Yellow_q(d)
     ==> (exists a#58#0#0: int :: d == #ImportedTypes.Library.CoColor.Yellow(a#58#0#0)));
...
axiom (forall a#59#0#0: int :: 
  { $Is(#ImportedTypes.Library.CoColor.Yellow(a#59#0#0), 
...
axiom (forall a#60#0#0: int :: 
  { #ImportedTypes.Library.CoColor.Yellow(a#60#0#0) } 
  ImportedTypes_mLibrary.CoColor._h17(#ImportedTypes.Library.CoColor.Yellow(a#60#0#0))
     == a#60#0#0);
...
axiom (forall a#61#0#0: int, a#61#1#0: DatatypeType :: 
  { #ImportedTypes.Library.MoColor.MoYellow(a#61#0#0, a#61#1#0) } 
  DatatypeCtorId(#ImportedTypes.Library.MoColor.MoYellow(a#61#0#0, a#61#1#0))
...
axiom (forall d: DatatypeType :: 
  { ImportedTypes_mLibrary.MoColor.MoYellow_q(d) } 
  ImportedTypes_mLibrary.MoColor.MoYellow_q(d)
     ==> (exists a#62#0#0: int, a#62#1#0: DatatypeType :: 
      d == #ImportedTypes.Library.MoColor.MoYellow(a#62#0#0, a#62#1#0)));
...
axiom (forall a#63#0#0: int, a#63#1#0: DatatypeType :: 
  { $Is(#ImportedTypes.Library.MoColor.MoYellow(a#63#0#0, a#63#1#0), 
      Tclass.ImportedTypes_mLibrary.MoColor()) } 
  $Is(#ImportedTypes.Library.MoColor.MoYellow(a#63#0#0, a#63#1#0), 
      Tclass.ImportedTypes_mLibrary.MoColor())
     <==> $Is(a#63#0#0, TInt) && $Is(a#63#1#0, Tclass.ImportedTypes_mLibrary.MoColor()));
...
axiom (forall a#64#0#0: int, a#64#1#0: DatatypeType :: 
  { #ImportedTypes.Library.MoColor.MoYellow(a#64#0#0, a#64#1#0) } 
  ImportedTypes_mLibrary.MoColor._h18(#ImportedTypes.Library.MoColor.MoYellow(a#64#0#0, a#64#1#0))
     == a#64#0#0);
...
axiom (forall a#65#0#0: int, a#65#1#0: DatatypeType :: 
  { #ImportedTypes.Library.MoColor.MoYellow(a#65#0#0, a#65#1#0) } 
  ImportedTypes_mLibrary.MoColor._h19(#ImportedTypes.Library.MoColor.MoYellow(a#65#0#0, a#65#1#0))
     == a#65#1#0);
...
procedure {:verboseName "ImportedTypes.Library.Nt (well-formedness)"} CheckWellFormed$$ImportedTypes_mLibrary.Nt(r#0: real);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ImportedTypes.Library.Nt (well-formedness)"} CheckWellFormed$$ImportedTypes_mLibrary.Nt(r#0: real)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assume {:id "id178"} LitReal(-1e0) <= r#0 && r#0 <= LitReal(1e0);
        assume false;
    }
    ...
    if (*)
    {
        ...
        assume true;
        assert {:id "id179"} {:subsumption 0} LitReal(-1e0) <= LitReal(0e0);
        assert {:id "id180"} {:subsumption 0} LitReal(0e0) <= LitReal(1e0);
        assume false;
    }
}
