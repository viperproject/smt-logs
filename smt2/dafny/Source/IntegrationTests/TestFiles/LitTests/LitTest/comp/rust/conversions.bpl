// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/conversions.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/conversions-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/conversions.dfy
...
procedure {:verboseName "TestCompile (well-formedness)"} CheckWellFormed$$_module.__default.TestCompile(input#0: DatatypeType
       where $Is(input#0, Tclass._module.Option(Tclass._module.Uint8()))
         && $IsAlloc(input#0, Tclass._module.Option(Tclass._module.Uint8()), $Heap)
         && $IsA#_module.Option(input#0))
   returns (output#0: DatatypeType
       where $Is(output#0, Tclass._module.Option(Tclass._module.Uint8()))
         && $IsAlloc(output#0, Tclass._module.Option(Tclass._module.Uint8()), $Heap));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "TestCompile (call)"} Call$$_module.__default.TestCompile(input#0: DatatypeType
       where $Is(input#0, Tclass._module.Option(Tclass._module.Uint8()))
         && $IsAlloc(input#0, Tclass._module.Option(Tclass._module.Uint8()), $Heap)
         && $IsA#_module.Option(input#0))
   returns (output#0: DatatypeType
...
procedure {:verboseName "TestCompile (correctness)"} Impl$$_module.__default.TestCompile(input#0: DatatypeType
       where $Is(input#0, Tclass._module.Option(Tclass._module.Uint8()))
         && $IsAlloc(input#0, Tclass._module.Option(Tclass._module.Uint8()), $Heap)
         && $IsA#_module.Option(input#0))
   returns (output#0: DatatypeType
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestCompile (correctness)"} Impl$$_module.__default.TestCompile(input#0: DatatypeType) returns (output#0: DatatypeType, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var middle#0: int where LitInt(0) <= middle#0 && middle#0 < 256;
  var valueOrError0#0: DatatypeType
     where $Is(valueOrError0#0, Tclass._module.Option(Tclass._module.Uint8()))
       && $IsAlloc(valueOrError0#0, Tclass._module.Option(Tclass._module.Uint8()), $Heap);
  var middleMethod#0: int where LitInt(0) <= middleMethod#0 && middleMethod#0 < 256;
  var $rhs##0: int;
  var $tmp##0: Box;

    // AddMethodImpl: TestCompile, Impl$$_module.__default.TestCompile
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assign-or-return statement (:-) ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/conversions.dfy(25,14)
    havoc valueOrError0#0 /* where $Is(valueOrError0#0, Tclass._module.Option(Tclass._module.Uint8()))
       && $IsAlloc(valueOrError0#0, Tclass._module.Option(Tclass._module.Uint8()), $Heap) */;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/conversions.dfy(25,17)
    assume true;
    assume true;
    valueOrError0#0 := input#0;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/conversions.dfy(25,14)
    // assume allocatedness for receiver argument to function
    assume $IsAllocBox($Box(valueOrError0#0), Tclass._module.Option(Tclass._module.Uint8()), $Heap);
    assume _module.Option.IsFailure#canCall(Tclass._module.Uint8(), valueOrError0#0);
    assume _module.Option.IsFailure#canCall(Tclass._module.Uint8(), valueOrError0#0);
    if (_module.Option.IsFailure(Tclass._module.Uint8(), valueOrError0#0))
    {
        push;
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/conversions.dfy(25,14)
        assume true;
        // assume allocatedness for receiver argument to function
        assume $IsAllocBox($Box(valueOrError0#0), Tclass._module.Option(Tclass._module.Uint8()), $Heap);
        assume _module.Option.PropagateFailure#canCall(Tclass._module.Uint8(), Tclass._module.Uint8(), valueOrError0#0);
        assume _module.Option.PropagateFailure#canCall(Tclass._module.Uint8(), Tclass._module.Uint8(), valueOrError0#0);
        output#0 := _module.Option.PropagateFailure(Tclass._module.Uint8(), Tclass._module.Uint8(), valueOrError0#0);
        // ----- return statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/conversions.dfy(25,14)
        pop;
        return;
    ...
    // assume allocatedness for receiver argument to function
    assume $IsAllocBox($Box(valueOrError0#0), Tclass._module.Option(Tclass._module.Uint8()), $Heap);
    assert {:id "id2"} {:subsumption 0} !_module.Option.IsFailure(Tclass._module.Uint8(), valueOrError0#0);
    assume !_module.Option.IsFailure(Tclass._module.Uint8(), valueOrError0#0);
    assume _module.Option.Extract#canCall(Tclass._module.Uint8(), valueOrError0#0);
    assume _module.Option.Extract#canCall(Tclass._module.Uint8(), valueOrError0#0);
    middle#0 := $Unbox(_module.Option.Extract(Tclass._module.Uint8(), valueOrError0#0)): int;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/conversions.dfy(26,49)
    assume true;
    // TrCallStmt: Adding lhs with type Uint8
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    call {:id "id4"} $tmp##0 := Call$$_module.Option.ExtractMethod(Tclass._module.Uint8(), #_module.Option.Some($Box(middle#0)));
    havoc $rhs##0;
    assume $rhs##0 == $Unbox($tmp##0): int;
    // TrCallStmt: After ProcessCallStmt
    middleMethod#0 := $rhs##0;
    // ----- return statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/conversions.dfy(27,3)
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/conversions.dfy(27,3)
    assume true;
    assume true;
    output#0 := Lit(#_module.Option.None());
    return;
}
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Main (correctness)"} Impl$$_module.__default.Main() returns ($_reverifyPost: bool)
{
  ...
  var newtype$check#4: int;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/conversions.dfy(31,16)
    assume true;
    newtype$check#0 := LitInt(2);
    assert {:id "id7"} LitInt(0) <= newtype$check#0 && newtype$check#0 < 256;
    assume true;
    x#0 := LitInt(2);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/conversions.dfy(33,15)
    assume true;
    newtype$check#1 := x#0;
    assert {:id "id9"} 0 <= newtype$check#1 && newtype$check#1 < 65536;
    newtype$check#2 := LitInt(2);
    assert {:id "id10"} 0 <= newtype$check#2 && newtype$check#2 < 32;
    assert {:id "id11"} le_bv5(2bv5, 16bv5);
    assume true;
    y#0 := LeftShift_bv16(nat_to_bv16(x#0), (0bv11 ++ 2bv5): bv16);
    // ----- expect statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/conversions.dfy(34,3)
    assume true;
    if (y#0 != Lit(8bv16))
    {
        assume true;
    ...
    // ----- expect statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/conversions.dfy(35,3)
    newtype$check#3 := x#0;
    assert {:id "id13"} 0 <= newtype$check#3 && newtype$check#3 < 65536;
    assume true;
    if (!lt_bv16(nat_to_bv16(x#0), 3bv16))
    {
        assume true;
        assume false;
    }

    // ----- expect statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/conversions.dfy(36,3)
    newtype$check#4 := x#0;
    assert {:id "id14"} 0 <= newtype$check#4 && newtype$check#4 < 65536;
    assume true;
    if (!le_bv16(nat_to_bv16(x#0), 3bv16))
    {
        assume true;
        assume false;
    }

    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/conversions.dfy(37,3)
    assume true;
}
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Uint8 (well-formedness)"} CheckWellFormed$$_module.Uint8(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assume {:id "id15"} LitInt(0) <= x#0 && x#0 < 256;
        assume false;
    }
    ...
    if (*)
    {
        ...
        assert {:id "id17"} {:subsumption 0} Lit(0 < 256);
        assume false;
    }
}
   ...
   ==> (forall _module.Option$T: Ty, this: DatatypeType :: 
    ...
    _module.Option.Extract#canCall(_module.Option$T, Lit(this))
         || (1 < $FunctionContextHeight
           && 
          $Is(this, Tclass._module.Option(_module.Option$T))
           && !Lit(_module.Option.IsFailure(_module.Option$T, Lit(this))))
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Option.Extract (well-formedness)"} CheckWellformed$$_module.Option.Extract(_module.Option$T: Ty, this: DatatypeType)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    // assume allocatedness for receiver argument to function
    assume $IsAllocBox($Box(this), Tclass._module.Option(_module.Option$T), $Heap);
    assume _module.Option.IsFailure#canCall(_module.Option$T, this);
    assume {:id "id26"} !_module.Option.IsFailure(_module.Option$T, this);
    ...
    else
    {
        ...
        assert {:id "id27"} _module.Option.Some_q(this);
        assume {:id "id28"} _module.Option.Extract(_module.Option$T, this) == _module.Option.value(this);
        assume true;
...
procedure {:verboseName "Option.ExtractMethod (well-formedness)"} CheckWellFormed$$_module.Option.ExtractMethod(_module.Option$T: Ty, 
    this: DatatypeType
       where $Is(this, Tclass._module.Option(_module.Option$T))
         && $IsAlloc(this, Tclass._module.Option(_module.Option$T), $Heap))
   returns (r#0: Box
       where $IsBox(r#0, _module.Option$T) && $IsAllocBox(r#0, _module.Option$T, $Heap));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Option.ExtractMethod (call)"} Call$$_module.Option.ExtractMethod(_module.Option$T: Ty, 
    this: DatatypeType
       where $Is(this, Tclass._module.Option(_module.Option$T))
         && $IsAlloc(this, Tclass._module.Option(_module.Option$T), $Heap))
   returns (r#0: Box
  ...
  requires {:id "id30"} !_module.Option.IsFailure(_module.Option$T, this);
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "Option.ExtractMethod (correctness)"} Impl$$_module.Option.ExtractMethod(_module.Option$T: Ty, 
    this: DatatypeType
       where $Is(this, Tclass._module.Option(_module.Option$T))
         && $IsAlloc(this, Tclass._module.Option(_module.Option$T), $Heap))
   returns (defass#r#0: bool, 
    r#0: Box
       where defass#r#0
         ==> $IsBox(r#0, _module.Option$T) && $IsAllocBox(r#0, _module.Option$T, $Heap), 
    $_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id31"} !_module.Option.IsFailure(_module.Option$T, this);
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Option.ExtractMethod (correctness)"} Impl$$_module.Option.ExtractMethod(_module.Option$T: Ty, this: DatatypeType)
   returns (defass#r#0: bool, r#0: Box, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;

    // AddMethodImpl: ExtractMethod, Impl$$_module.Option.ExtractMethod
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- return statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/conversions.dfy(20,5)
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/rust/conversions.dfy(20,5)
    assume true;
    assert {:id "id32"} _module.Option.Some_q(this);
    assume true;
    r#0 := _module.Option.value(this);
    defass#r#0 := true;
