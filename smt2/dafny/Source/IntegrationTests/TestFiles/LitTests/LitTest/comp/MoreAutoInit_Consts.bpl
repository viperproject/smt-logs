...
procedure {:verboseName "Consts.TestStart (correctness)"} Impl$$Consts.__default.TestStart() returns ($_reverifyPost: bool);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Consts.TestStart (correctness)"} Impl$$Consts.__default.TestStart() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var x##0: DatatypeType;
  var x##1: Seq;

    // AddMethodImpl: TestStart, Impl$$Consts.__default.TestStart
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(284,9)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##0 := Lit(#Consts.Uni.Uni());
    call {:id "id281"} Call$$Consts.__default.Test(Tclass.Consts.Uni(), $Box(x##0));
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(285,9)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##1 := Lit(Seq#Build(Seq#Empty(): Seq, $Box(Lit(#Consts.Uni.Uni()))));
    call {:id "id282"} Call$$Consts.__default.Test(TSeq(Tclass.Consts.Uni()), $Box(x##1));
    // TrCallStmt: After ProcessCallStmt
}



procedure {:verboseName "Consts.Test (well-formedness)"} CheckWellFormed$$Consts.__default.Test(Consts._default.Test$X: Ty, 
    x#0: Box
       where $IsBox(x#0, Consts._default.Test$X)
         && $IsAllocBox(x#0, Consts._default.Test$X, $Heap));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Consts.Test (call)"} Call$$Consts.__default.Test(Consts._default.Test$X: Ty, 
    x#0: Box
       where $IsBox(x#0, Consts._default.Test$X)
         && $IsAllocBox(x#0, Consts._default.Test$X, $Heap));
  modifies $Heap;
...
procedure {:verboseName "Consts.Test (correctness)"} Impl$$Consts.__default.Test(Consts._default.Test$X: Ty, 
    x#0: Box
       where $IsBox(x#0, Consts._default.Test$X)
         && $IsAllocBox(x#0, Consts._default.Test$X, $Heap))
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Consts.Test (correctness)"} Impl$$Consts.__default.Test(Consts._default.Test$X: Ty, x#0: Box) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var d#0: DatatypeType
     where $Is(d#0, Tclass.Consts.Datatype(Consts._default.Test$X))
       && $IsAlloc(d#0, Tclass.Consts.Datatype(Consts._default.Test$X), $Heap);
  var defass#c#0: bool;
  var c#0: ref
     where defass#c#0
       ==> $Is(c#0, Tclass.Consts.Class(Consts._default.Test$X))
         && $IsAlloc(c#0, Tclass.Consts.Class(Consts._default.Test$X), $Heap);
  var $nw: ref;
  var a##0: Box;
  var defass#t#0: bool;
  var t#0: ref
     where defass#t#0
       ==> $Is(t#0, Tclass.Consts.Trait(Consts._default.Test$X))
         && $IsAlloc(t#0, Tclass.Consts.Trait(Consts._default.Test$X), $Heap);

    // AddMethodImpl: Test, Impl$$Consts.__default.Test
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(289,24)
    assume true;
    assume true;
    d#0 := #Consts.Datatype.Dt1(x#0);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(290,21)
    assume true;
    // ----- init call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(290,24)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    a##0 := x#0;
    call {:id "id284"} $nw := Call$$Consts.Class.__ctor(Consts._default.Test$X, a##0);
    // TrCallStmt: After ProcessCallStmt
    c#0 := $nw;
    defass#c#0 := true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(291,21)
    assume true;
    assert {:id "id286"} defass#c#0;
    assume true;
    t#0 := c#0;
    defass#t#0 := true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(293,5)
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(294,5)
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(295,5)
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(296,5)
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(297,5)
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(298,5)
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(299,5)
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(301,5)
    assert {:id "id288"} defass#t#0;
    assert {:id "id289"} {:subsumption 0} t#0 != null;
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(302,5)
    assert {:id "id290"} defass#t#0;
    assert {:id "id291"} {:subsumption 0} t#0 != null;
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(303,5)
    assert {:id "id292"} defass#t#0;
    assert {:id "id293"} {:subsumption 0} t#0 != null;
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(304,5)
    assert {:id "id294"} defass#t#0;
    assert {:id "id295"} {:subsumption 0} t#0 != null;
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(305,5)
    assert {:id "id296"} defass#t#0;
    assert {:id "id297"} {:subsumption 0} t#0 != null;
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(306,5)
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(307,5)
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(309,5)
    assert {:id "id298"} defass#c#0;
    assert {:id "id299"} {:subsumption 0} c#0 != null;
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(310,5)
    assert {:id "id300"} defass#c#0;
    assert {:id "id301"} {:subsumption 0} c#0 != null;
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(311,5)
    assert {:id "id302"} defass#c#0;
    assert {:id "id303"} {:subsumption 0} c#0 != null;
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(312,5)
    assert {:id "id304"} defass#c#0;
    assert {:id "id305"} {:subsumption 0} c#0 != null;
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(313,5)
    assert {:id "id306"} defass#c#0;
    assert {:id "id307"} {:subsumption 0} c#0 != null;
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(314,5)
    assert {:id "id308"} defass#c#0;
    assert {:id "id309"} {:subsumption 0} c#0 != null;
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(315,5)
    assert {:id "id310"} defass#c#0;
    assert {:id "id311"} {:subsumption 0} c#0 != null;
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(316,5)
    assert {:id "id312"} defass#c#0;
    assert {:id "id313"} {:subsumption 0} c#0 != null;
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(317,5)
    assert {:id "id314"} defass#c#0;
    assert {:id "id315"} {:subsumption 0} c#0 != null;
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(318,5)
    assert {:id "id316"} defass#c#0;
    assert {:id "id317"} {:subsumption 0} c#0 != null;
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(319,5)
    assert {:id "id318"} defass#c#0;
    assert {:id "id319"} {:subsumption 0} c#0 != null;
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(320,5)
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(321,5)
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/MoreAutoInit.dfy(322,5)
    assume true;
    assume true;
}
...
axiom 0 < $FunctionContextHeight
   ==> (forall Consts.Datatype$Ad: Ty, $o: DatatypeType :: 
...
axiom 0 < $FunctionContextHeight
   ==> (forall Consts.Datatype$Ad: Ty, $h: Heap, $o: DatatypeType :: 
...
procedure {:verboseName "Consts.Datatype.InstanceD1 (well-formedness)"} CheckWellFormed$$Consts.Datatype.InstanceD1(Consts.Datatype$Ad: Ty, 
    this: DatatypeType
       where $Is(this, Tclass.Consts.Datatype(Consts.Datatype$Ad))
         && $IsAlloc(this, Tclass.Consts.Datatype(Consts.Datatype$Ad), $Heap));
...
procedure {:verboseName "Consts.Datatype.InstanceD2 (well-formedness)"} CheckWellFormed$$Consts.Datatype.InstanceD2(Consts.Datatype$Ad: Ty, 
    this: DatatypeType
       where $Is(this, Tclass.Consts.Datatype(Consts.Datatype$Ad))
         && $IsAlloc(this, Tclass.Consts.Datatype(Consts.Datatype$Ad), $Heap));
  free requires 1 == $FunctionContextHeight;
...
procedure {:verboseName "Consts.Datatype.InstanceD3 (well-formedness)"} CheckWellFormed$$Consts.Datatype.InstanceD3(Consts.Datatype$Ad: Ty, 
    this: DatatypeType
       where $Is(this, Tclass.Consts.Datatype(Consts.Datatype$Ad))
         && $IsAlloc(this, Tclass.Consts.Datatype(Consts.Datatype$Ad), $Heap));
...
procedure {:verboseName "Consts.Datatype.InstanceD4 (well-formedness)"} CheckWellFormed$$Consts.Datatype.InstanceD4(Consts.Datatype$Ad: Ty, 
    this: DatatypeType
       where $Is(this, Tclass.Consts.Datatype(Consts.Datatype$Ad))
         && $IsAlloc(this, Tclass.Consts.Datatype(Consts.Datatype$Ad), $Heap));
  free requires 1 == $FunctionContextHeight;
...
axiom 0 < $FunctionContextHeight
   ==> (forall Consts.Datatype$Ad: Ty, $h: Heap :: 
...
procedure {:verboseName "Consts.Datatype.StaticD1 (well-formedness)"} CheckWellFormed$$Consts.Datatype.StaticD1(Consts.Datatype$Ad: Ty);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
axiom 0 < $FunctionContextHeight
   ==> (forall Consts.Trait$At: Ty, $o: ref :: 
...
axiom 0 < $FunctionContextHeight
   ==> (forall Consts.Trait$At: Ty, $h: Heap, $o: ref :: 
...
procedure {:verboseName "Consts.Trait.InstanceT1 (well-formedness)"} CheckWellFormed$$Consts.Trait.InstanceT1(Consts.Trait$At: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass.Consts.Trait(Consts.Trait$At))
         && $IsAlloc(this, Tclass.Consts.Trait(Consts.Trait$At), $Heap));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
axiom 0 < $FunctionContextHeight
   ==> (forall Consts.Trait$At: Ty, $h: Heap :: 
...
procedure {:verboseName "Consts.Trait.StaticT1 (well-formedness)"} CheckWellFormed$$Consts.Trait.StaticT1(Consts.Trait$At: Ty);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
axiom 0 < $FunctionContextHeight
   ==> (forall Consts.Class$Ac: Ty, $o: ref :: 
...
axiom 0 < $FunctionContextHeight
   ==> (forall Consts.Class$Ac: Ty, $h: Heap, $o: ref :: 
...
procedure {:verboseName "Consts.Class.InstanceC1 (well-formedness)"} CheckWellFormed$$Consts.Class.InstanceC1(Consts.Class$Ac: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass.Consts.Class(Consts.Class$Ac))
         && $IsAlloc(this, Tclass.Consts.Class(Consts.Class$Ac), $Heap));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "Consts.Class.InstanceC2 (well-formedness)"} CheckWellFormed$$Consts.Class.InstanceC2(Consts.Class$Ac: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass.Consts.Class(Consts.Class$Ac))
...
procedure {:verboseName "Consts.Class._ctor (well-formedness)"} CheckWellFormed$$Consts.Class.__ctor(Consts.Class$Ac: Ty, 
    a#0: Box
       where $IsBox(a#0, Consts.Class$Ac) && $IsAllocBox(a#0, Consts.Class$Ac, $Heap))
   returns (this: ref);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "Consts.Class._ctor (call)"} Call$$Consts.Class.__ctor(Consts.Class$Ac: Ty, 
    a#0: Box
       where $IsBox(a#0, Consts.Class$Ac) && $IsAllocBox(a#0, Consts.Class$Ac, $Heap))
   returns (this: ref
       where this != null
...
procedure {:verboseName "Consts.Class._ctor (correctness)"} Impl$$Consts.Class.__ctor(Consts.Class$Ac: Ty, 
    a#0: Box
       where $IsBox(a#0, Consts.Class$Ac) && $IsAllocBox(a#0, Consts.Class$Ac, $Heap))
...
axiom 0 < $FunctionContextHeight
   ==> (forall Consts.Class$Ac: Ty, $h: Heap :: 
...
procedure {:verboseName "Consts.Class.StaticC1 (well-formedness)"} CheckWellFormed$$Consts.Class.StaticC1(Consts.Class$Ac: Ty);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "Consts.Class.StaticC2 (well-formedness)"} CheckWellFormed$$Consts.Class.StaticC2(Consts.Class$Ac: Ty);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
