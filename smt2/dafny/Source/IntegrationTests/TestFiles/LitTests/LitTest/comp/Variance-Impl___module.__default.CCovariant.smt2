...
(declare-fun Tagclass._module.CCo () T@U)
(declare-fun |##_module.CCo.CCo| () T@U)
(declare-fun Tagclass._module.X? () T@U)
(declare-fun Tagclass._module.Int? () T@U)
(declare-fun tytagFamily$Int () T@U)
(declare-fun tytagFamily$X () T@U)
(declare-fun tytagFamily$CCo () T@U)
...
(declare-fun _module.CCo.CCo_q (T@U) Bool)
(declare-fun $Is (T@T T@U T@U) Bool)
(declare-fun DatatypeTypeType () T@T)
(declare-fun Tclass._module.CCo (T@U) T@U)
...
(declare-fun |#_module.CCo.CCo| (T@U) T@U)
(declare-fun $FunctionContextHeight () Int)
(declare-fun _module.CCo.x (T@U T@U) Int)
(declare-fun TagFamily (T@U) T@U)
(declare-fun _module.CCo.y (T@U T@U) T@U)
(declare-fun SeqType () T@T)
(declare-fun TSeq (T@U) T@U)
(declare-fun $IsBox (T@U T@U) Bool)
(declare-fun |Seq#Index| (T@U Int) T@U)
(declare-fun Inv0_TSeq (T@U) T@U)
(declare-fun Tclass._module.CCo_0 (T@U) T@U)
(declare-fun _module.CCo._h1 (T@U) T@U)
...
(assert (distinct TBool TInt TagBool TagInt TagSeq alloc Tagclass._module.Int Tagclass._module.X Tagclass._module.CCo |##_module.CCo.CCo| Tagclass._module.X? Tagclass._module.Int? tytagFamily$Int tytagFamily$X tytagFamily$CCo)
)
...
(assert (forall ((_module.CCo$T T@U) (d T@U) ) (!  (=> ($Is DatatypeTypeType d (Tclass._module.CCo _module.CCo$T)) (_module.CCo.CCo_q d))
 :qid |unknown.0:0|
 :skolemid |713|
 :pattern ( (_module.CCo.CCo_q d) ($Is DatatypeTypeType d (Tclass._module.CCo _module.CCo$T)))
)))
...
(assert (forall ((d@@0 T@U) ) (! (= (_module.CCo.CCo_q d@@0) (= (DatatypeCtorId d@@0) |##_module.CCo.CCo|))
 :qid |unknown.0:0|
 :skolemid |705|
 :pattern ( (_module.CCo.CCo_q d@@0))
)))
...
(assert (forall ((d@@1 T@U) ) (!  (=> (_module.CCo.CCo_q d@@1) (exists ((|a#1#0#0| T@U) ) (! (= d@@1 (|#_module.CCo.CCo| |a#1#0#0|))
 :qid |Variancedfy.48:26|
 :skolemid |706|
)))
 :qid |unknown.0:0|
 :skolemid |707|
 :pattern ( (_module.CCo.CCo_q d@@1))
)))
(assert  (=> (< 0 $FunctionContextHeight) (forall ((_module.CCo$T@@0 T@U) ($h@@4 T@U) ($o@@2 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@4) ($Is DatatypeTypeType $o@@2 (Tclass._module.CCo _module.CCo$T@@0))) ($IsAlloc DatatypeTypeType $o@@2 (Tclass._module.CCo _module.CCo$T@@0) $h@@4)) ($IsAlloc intType (int_2_U (_module.CCo.x _module.CCo$T@@0 $o@@2)) TInt $h@@4))
 :qid |unknown.0:0|
 :skolemid |726|
 :pattern ( (_module.CCo.x _module.CCo$T@@0 $o@@2) ($IsAlloc DatatypeTypeType $o@@2 (Tclass._module.CCo _module.CCo$T@@0) $h@@4))
))))
(assert  (=> (< 0 $FunctionContextHeight) (forall ((_module.CCo$T@@1 T@U) ($o@@3 T@U) ) (!  (=> ($Is DatatypeTypeType $o@@3 (Tclass._module.CCo _module.CCo$T@@1)) ($Is intType (int_2_U (_module.CCo.x _module.CCo$T@@1 $o@@3)) TInt))
 :qid |unknown.0:0|
 :skolemid |725|
 :pattern ( (_module.CCo.x _module.CCo$T@@1 $o@@3))
))))
...
(assert (forall ((_module.CCo$T@@2 T@U) ) (!  (and (= (Tag (Tclass._module.CCo _module.CCo$T@@2)) Tagclass._module.CCo) (= (TagFamily (Tclass._module.CCo _module.CCo$T@@2)) tytagFamily$CCo))
 :qid |unknown.0:0|
 :skolemid |513|
 :pattern ( (Tclass._module.CCo _module.CCo$T@@2))
)))
(assert (= (Ctor SeqType) 8))
(assert  (=> (< 0 $FunctionContextHeight) (forall ((_module.CCo$T@@3 T@U) ($h@@5 T@U) ($o@@4 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@5) ($Is DatatypeTypeType $o@@4 (Tclass._module.CCo _module.CCo$T@@3))) ($IsAlloc DatatypeTypeType $o@@4 (Tclass._module.CCo _module.CCo$T@@3) $h@@5)) ($IsAlloc SeqType (_module.CCo.y _module.CCo$T@@3 $o@@4) (TSeq _module.CCo$T@@3) $h@@5))
 :qid |unknown.0:0|
 :skolemid |728|
 :pattern ( (_module.CCo.y _module.CCo$T@@3 $o@@4) ($IsAlloc DatatypeTypeType $o@@4 (Tclass._module.CCo _module.CCo$T@@3) $h@@5))
))))
...
(assert  (=> (< 0 $FunctionContextHeight) (forall ((_module.CCo$T@@4 T@U) ($o@@5 T@U) ) (!  (=> ($Is DatatypeTypeType $o@@5 (Tclass._module.CCo _module.CCo$T@@4)) ($Is SeqType (_module.CCo.y _module.CCo$T@@4 $o@@5) (TSeq _module.CCo$T@@4)))
 :qid |unknown.0:0|
 :skolemid |727|
 :pattern ( (_module.CCo.y _module.CCo$T@@4 $o@@5))
))))
(assert (forall ((_module.CCo$T@@5 T@U) (|a#2#0#0| T@U) ($h@@6 T@U) ) (!  (=> ($IsGoodHeap $h@@6) (= ($IsAlloc DatatypeTypeType (|#_module.CCo.CCo| |a#2#0#0|) (Tclass._module.CCo _module.CCo$T@@5) $h@@6) ($IsAllocBox |a#2#0#0| _module.CCo$T@@5 $h@@6)))
 :qid |unknown.0:0|
 :skolemid |709|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.CCo.CCo| |a#2#0#0|) (Tclass._module.CCo _module.CCo$T@@5) $h@@6))
)))
...
(assert (forall ((_module.CCo$T@@6 T@U) ) (! (= (Tclass._module.CCo_0 (Tclass._module.CCo _module.CCo$T@@6)) _module.CCo$T@@6)
 :qid |unknown.0:0|
 :skolemid |514|
 :pattern ( (Tclass._module.CCo _module.CCo$T@@6))
)))
(assert (forall ((|a#0#0#0| T@U) ) (! (= (DatatypeCtorId (|#_module.CCo.CCo| |a#0#0#0|)) |##_module.CCo.CCo|)
 :qid |Variancedfy.48:26|
 :skolemid |704|
 :pattern ( (|#_module.CCo.CCo| |a#0#0#0|))
)))
(assert (forall ((|a#3#0#0| T@U) ) (! (= (_module.CCo._h1 (|#_module.CCo.CCo| |a#3#0#0|)) |a#3#0#0|)
 :qid |Variancedfy.48:26|
 :skolemid |711|
 :pattern ( (|#_module.CCo.CCo| |a#3#0#0|))
)))
...
(assert (forall ((_module.CCo$T@@7 T@U) (|a#2#0#0@@0| T@U) ) (! (= ($Is DatatypeTypeType (|#_module.CCo.CCo| |a#2#0#0@@0|) (Tclass._module.CCo _module.CCo$T@@7)) ($IsBox |a#2#0#0@@0| _module.CCo$T@@7))
 :qid |unknown.0:0|
 :skolemid |708|
 :pattern ( ($Is DatatypeTypeType (|#_module.CCo.CCo| |a#2#0#0@@0|) (Tclass._module.CCo _module.CCo$T@@7)))
)))
(assert (forall ((d@@2 T@U) (_module.CCo$T@@8 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (_module.CCo.CCo_q d@@2) ($IsAlloc DatatypeTypeType d@@2 (Tclass._module.CCo _module.CCo$T@@8) $h@@7))) ($IsAllocBox (_module.CCo._h1 d@@2) _module.CCo$T@@8 $h@@7))
 :qid |unknown.0:0|
 :skolemid |710|
 :pattern ( ($IsAllocBox (_module.CCo._h1 d@@2) _module.CCo$T@@8 $h@@7))
)))
...
(assert (forall ((_module.CCo$T@@9 T@U) (bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 (Tclass._module.CCo _module.CCo$T@@9)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@8)) bx@@8) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@8) (Tclass._module.CCo _module.CCo$T@@9))))
 :qid |unknown.0:0|
 :skolemid |515|
 :pattern ( ($IsBox bx@@8 (Tclass._module.CCo _module.CCo$T@@9)))
)))
...
(declare-fun |b#0| () T@U)
(declare-fun |s#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.CCovariant)
...
)) ($HeapSucc $Heap $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (=> (and (= |a#0@0| (|#_module.CCo.CCo| ($Box refType call1formal@this@0))) (=> |defass#b#0| (and ($Is DatatypeTypeType |b#0@0| (Tclass._module.CCo Tclass._module.X)) ($IsAlloc DatatypeTypeType |b#0@0| (Tclass._module.CCo Tclass._module.X) $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (= (ControlFlow 0 2) (- 0 1)) true))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (=> |defass#i#0| (and ($Is refType |i#0| Tclass._module.Int) ($IsAlloc refType |i#0| Tclass._module.Int $Heap))) true)) (and (and (=> |defass#a#0| (and ($Is DatatypeTypeType |a#0| (Tclass._module.CCo Tclass._module.Int)) ($IsAlloc DatatypeTypeType |a#0| (Tclass._module.CCo Tclass._module.Int) $Heap))) true) (and (=> |defass#b#0| (and ($Is DatatypeTypeType |b#0| (Tclass._module.CCo Tclass._module.X)) ($IsAlloc DatatypeTypeType |b#0| (Tclass._module.CCo Tclass._module.X) $Heap))) true))) (and (and (and ($Is DatatypeTypeType |s#0| (Tclass._module.CCo TBool)) ($IsAlloc DatatypeTypeType |s#0| (Tclass._module.CCo TBool) $Heap)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 6) 2)))) anon0_correct)))
