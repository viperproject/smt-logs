...
(assert (forall (($o@@8 T@U) ) (!  (=> ($Is refType $o@@8 Tclass.TraitDefinitions.SuperTrait?) ($Is refType $o@@8 Tclass.TraitDefinitions.NoMemberTrait?))
 :qid |unknown.0:0|
 :skolemid |1567|
 :pattern ( ($Is refType $o@@8 Tclass.TraitDefinitions.SuperTrait?))
)))
(assert (forall (($o@@9 T@U) ) (!  (=> ($Is refType $o@@9 Tclass.TraitDefinitions.SuperTrait?) ($Is refType $o@@9 Tclass.TraitDefinitions.NoMemberTrait2?))
 :qid |unknown.0:0|
 :skolemid |1571|
 :pattern ( ($Is refType $o@@9 Tclass.TraitDefinitions.SuperTrait?))
)))
...
(assert (= (Tag Tclass.TraitDefinitions.SuperTrait) Tagclass.TraitDefinitions.SuperTrait))
(assert (= (TagFamily Tclass.TraitDefinitions.SuperTrait) tytagFamily$SuperTrait))
(assert (forall (($o@@10 T@U) ) (! (= ($Is refType $o@@10 Tclass.TraitDefinitions.NoMemberTrait?)  (or (= $o@@10 null) (implements$TraitDefinitions.NoMemberTrait (dtype $o@@10))))
 :qid |unknown.0:0|
 :skolemid |1518|
 :pattern ( ($Is refType $o@@10 Tclass.TraitDefinitions.NoMemberTrait?))
)))
(assert (forall (($o@@11 T@U) ) (! (= ($Is refType $o@@11 Tclass.TraitDefinitions.NoMemberTrait2?)  (or (= $o@@11 null) (implements$TraitDefinitions.NoMemberTrait2 (dtype $o@@11))))
 :qid |unknown.0:0|
 :skolemid |1524|
 :pattern ( ($Is refType $o@@11 Tclass.TraitDefinitions.NoMemberTrait2?))
)))
(assert (forall (($o@@12 T@U) ) (! (= ($Is refType $o@@12 Tclass.TraitDefinitions.SuperTrait?)  (or (= $o@@12 null) (implements$TraitDefinitions.SuperTrait (dtype $o@@12))))
 :qid |unknown.0:0|
 :skolemid |1530|
 :pattern ( ($Is refType $o@@12 Tclass.TraitDefinitions.SuperTrait?))
)))
(assert (forall ((TraitDefinitions.SubTrait$T@@10 T@U) (TraitDefinitions.SubTrait$I@@10 T@U) ($o@@13 T@U) ($heap@@1 T@U) ) (!  (=> ($IsAlloc refType $o@@13 (Tclass.TraitDefinitions.SubTrait? TraitDefinitions.SubTrait$T@@10 TraitDefinitions.SubTrait$I@@10) $heap@@1) ($IsAlloc refType $o@@13 Tclass.TraitDefinitions.SuperTrait? $heap@@1))
 :qid |unknown.0:0|
 :skolemid |1576|
 :pattern ( ($IsAlloc refType $o@@13 (Tclass.TraitDefinitions.SubTrait? TraitDefinitions.SubTrait$T@@10 TraitDefinitions.SubTrait$I@@10) $heap@@1))
)))
...
(set-info :boogie-vc-id Impl$$TraitDefinitions.SubTrait.GetCTwicePlusD)
