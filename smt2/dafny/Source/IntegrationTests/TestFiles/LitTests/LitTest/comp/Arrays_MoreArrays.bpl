...
procedure {:verboseName "MoreArrays.Test (correctness)"} Impl$$MoreArrays.__default.Test() returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MoreArrays.Test (correctness)"} Impl$$MoreArrays.__default.Test() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var a#0: ref
     where $Is(a#0, Tclass._System.array(Tclass.MoreArrays.byte()))
       && $IsAlloc(a#0, Tclass._System.array(Tclass.MoreArrays.byte()), $Heap);
  var $rhs##0: ref;
  var s##0: Seq;
  var arr##0: ref;
  var b#0: ref
     where $Is(b#0, Tclass._System.array(Tclass.MoreArrays.byte()))
       && $IsAlloc(b#0, Tclass._System.array(Tclass.MoreArrays.byte()), $Heap);
  var $rhs##1: ref;
  var s##1: Seq;
  var x##0: ref;
  var y##0: ref;
  ...
  var y##1: ref;
  var c#0: ref
     where $Is(c#0, Tclass._System.array?(Tclass.MoreArrays.byte()))
       && $IsAlloc(c#0, Tclass._System.array?(Tclass.MoreArrays.byte()), $Heap);
  ...
  var y##3: ref;
    ...
    // AddMethodImpl: Test, Impl$$MoreArrays.__default.Test
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(389,35)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id16"} Call$$MoreArrays.__default.TestEqualityOfSomeNonArraysToo();
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(391,31)
    assume true;
    // TrCallStmt: Adding lhs with type array<byte>
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    s##0 := Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(104))), $Box(char#FromInt(101))), 
        ...
        $Box(char#FromInt(101))));
    call {:id "id17"} $rhs##0 := Call$$MoreArrays.__default.StringToByteArray(s##0);
    // TrCallStmt: After ProcessCallStmt
    a#0 := $rhs##0;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(392,14)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    arr##0 := a#0;
    call {:id "id19"} Call$$MoreArrays.__default.WriteLine(arr##0);
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(394,31)
    assume true;
    // TrCallStmt: Adding lhs with type array<byte>
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    s##1 := Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(104))), $Box(char#FromInt(101))), 
                        $Box(char#FromInt(108))), 
                      $Box(char#FromInt(108))), 
                    $Box(char#FromInt(111))), 
                  $Box(char#FromInt(32))), 
          ...
          $Box(char#FromInt(114))), 
        $Box(char#FromInt(101))));
    call {:id "id20"} $rhs##1 := Call$$MoreArrays.__default.StringToByteArray(s##1);
    // TrCallStmt: After ProcessCallStmt
    b#0 := $rhs##1;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(395,5)
    assume true;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(396,18)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##0 := a#0;
    ...
    // ProcessCallStmt: CheckSubrange
    y##0 := b#0;
    call {:id "id22"} Call$$MoreArrays.__default.CheckEquality(Tclass._System.array(Tclass.MoreArrays.byte()), $Box(x##0), $Box(y##0));
    // TrCallStmt: After ProcessCallStmt
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(397,5)
    assume true;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(398,18)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##1 := a#0;
    ...
    // ProcessCallStmt: CheckSubrange
    y##1 := a#0;
    call {:id "id23"} Call$$MoreArrays.__default.CheckEquality(Tclass._System.array(Tclass.MoreArrays.byte()), $Box(x##1), $Box(y##1));
    // TrCallStmt: After ProcessCallStmt
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(399,25)
    assume true;
    newtype$check#0 := null;
    assume true;
    c#0 := null;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(400,5)
    assume true;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(401,18)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##2 := a#0;
    ...
    // ProcessCallStmt: CheckSubrange
    y##2 := c#0;
    call {:id "id25"} Call$$MoreArrays.__default.CheckEquality(Tclass._System.array?(Tclass.MoreArrays.byte()), $Box(x##2), $Box(y##2));
    // TrCallStmt: After ProcessCallStmt
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(402,5)
    assume true;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(403,18)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##3 := c#0;
    ...
    // ProcessCallStmt: CheckSubrange
    y##3 := a#0;
    call {:id "id26"} Call$$MoreArrays.__default.CheckEquality(Tclass._System.array?(Tclass.MoreArrays.byte()), $Box(x##3), $Box(y##3));
    // TrCallStmt: After ProcessCallStmt
}



procedure {:verboseName "MoreArrays.TestEqualityOfSomeNonArraysToo (well-formedness)"} CheckWellFormed$$MoreArrays.__default.TestEqualityOfSomeNonArraysToo();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "MoreArrays.TestEqualityOfSomeNonArraysToo (call)"} Call$$MoreArrays.__default.TestEqualityOfSomeNonArraysToo();
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "MoreArrays.TestEqualityOfSomeNonArraysToo (correctness)"} Impl$$MoreArrays.__default.TestEqualityOfSomeNonArraysToo() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MoreArrays.TestEqualityOfSomeNonArraysToo (correctness)"} Impl$$MoreArrays.__default.TestEqualityOfSomeNonArraysToo() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var bb#0: int where LitInt(0) <= bb#0 && bb#0 < 256;
  ...
  var defass#cc0#0: bool;
  var cc0#0: ref
     where defass#cc0#0
       ==> $Is(cc0#0, Tclass.MoreArrays.MyClass())
         && $IsAlloc(cc0#0, Tclass.MoreArrays.MyClass(), $Heap);
  var $nw: ref;
  var defass#cc1#0: bool;
  var cc1#0: ref
     where defass#cc1#0
       ==> $Is(cc1#0, Tclass.MoreArrays.MyClass())
         && $IsAlloc(cc1#0, Tclass.MoreArrays.MyClass(), $Heap);
  var x##2: ref;
  var y##2: ref;
  var x##3: ref;
  var y##3: ref;
  ...
  var y##9: DatatypeType;
  var x##10: DatatypeType;
  var y##10: DatatypeType;
  var m0#0: Map
     where $Is(m0#0, TMap(TInt, TBool)) && $IsAlloc(m0#0, TMap(TInt, TBool), $Heap);
  var m1#0: Map
     where $Is(m1#0, TMap(TInt, TBool)) && $IsAlloc(m1#0, TMap(TInt, TBool), $Heap);
  var m2#0: Map
     where $Is(m2#0, TMap(TInt, TBool)) && $IsAlloc(m2#0, TMap(TInt, TBool), $Heap);
  var m3#0: Map
     where $Is(m3#0, TMap(TInt, TBool)) && $IsAlloc(m3#0, TMap(TInt, TBool), $Heap);
  var x##11: Map;
  var y##11: Map;
  var x##12: Map;
  var y##12: Map;
  ...
  var y##13: Map;
    ...
    // AddMethodImpl: TestEqualityOfSomeNonArraysToo, Impl$$MoreArrays.__default.TestEqualityOfSomeNonArraysToo
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(407,18)
    assume true;
    newtype$check#0 := LitInt(76);
    assert {:id "id27"} LitInt(0) <= newtype$check#0 && newtype$check#0 < 256;
    assume true;
    bb#0 := LitInt(76);
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(408,18)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##0 := bb#0;
    ...
    // ProcessCallStmt: CheckSubrange
    y##0 := bb#0;
    call {:id "id29"} Call$$MoreArrays.__default.CheckEquality(Tclass.MoreArrays.byte(), $Box(x##0), $Box(y##0));
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(409,18)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##1 := bb#0;
    newtype$check#1 := LitInt(1);
    assert {:id "id30"} LitInt(0) <= newtype$check#1 && newtype$check#1 < 256;
    newtype$check#2 := bb#0 + 1;
    assert {:id "id31"} LitInt(0) <= newtype$check#2 && newtype$check#2 < 256;
    assume true;
    // ProcessCallStmt: CheckSubrange
    y##1 := bb#0 + 1;
    call {:id "id32"} Call$$MoreArrays.__default.CheckEquality(Tclass.MoreArrays.byte(), $Box(x##1), $Box(y##1));
    // TrCallStmt: After ProcessCallStmt
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(411,13)
    assume true;
    havoc $nw;
    assume $nw != null && $Is($nw, Tclass.MoreArrays.MyClass?());
    ...
    cc0#0 := $nw;
    defass#cc0#0 := true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(412,13)
    assume true;
    havoc $nw;
    assume $nw != null && $Is($nw, Tclass.MoreArrays.MyClass?());
    assume !$Unbox(read($Heap, $nw, alloc)): bool;
    ...
    cc1#0 := $nw;
    defass#cc1#0 := true;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(413,18)
    // TrCallStmt: Before ProcessCallStmt
    assert {:id "id35"} defass#cc0#0;
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##2 := cc0#0;
    assert {:id "id36"} defass#cc0#0;
    assume true;
    // ProcessCallStmt: CheckSubrange
    y##2 := cc0#0;
    call {:id "id37"} Call$$MoreArrays.__default.CheckEquality(Tclass.MoreArrays.MyClass(), $Box(x##2), $Box(y##2));
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(414,18)
    // TrCallStmt: Before ProcessCallStmt
    assert {:id "id38"} defass#cc0#0;
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##3 := cc0#0;
    assert {:id "id39"} defass#cc1#0;
    assume true;
    // ProcessCallStmt: CheckSubrange
    y##3 := cc1#0;
    call {:id "id40"} Call$$MoreArrays.__default.CheckEquality(Tclass.MoreArrays.MyClass(), $Box(x##3), $Box(y##3));
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(415,18)
    // TrCallStmt: Before ProcessCallStmt
    assert {:id "id41"} defass#cc0#0;
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##4 := cc0#0;
    ...
    // ProcessCallStmt: CheckSubrange
    y##4 := null;
    call {:id "id42"} Call$$MoreArrays.__default.CheckEquality(Tclass.MoreArrays.MyClass?(), $Box(x##4), $Box(y##4));
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(416,18)
    // TrCallStmt: Before ProcessCallStmt
    newtype$check#4 := null;
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##5 := null;
    assert {:id "id43"} defass#cc0#0;
    assume true;
    // ProcessCallStmt: CheckSubrange
    y##5 := cc0#0;
    call {:id "id44"} Call$$MoreArrays.__default.CheckEquality(Tclass.MoreArrays.MyClass?(), $Box(x##5), $Box(y##5));
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(417,18)
    // TrCallStmt: Before ProcessCallStmt
    ...
    // ProcessCallStmt: CheckSubrange
    y##6 := null;
    call {:id "id45"} Call$$MoreArrays.__default.CheckEquality(Tclass._System.object?(), $Box(x##6), $Box(y##6));
    // TrCallStmt: After ProcessCallStmt
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(419,12)
    assume true;
    assume true;
    s0#0 := Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq, $Box(LitInt(20))), $Box(LitInt(10))), 
        $Box(LitInt(20))));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(420,12)
    assume true;
    assume true;
    s1#0 := Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq, $Box(LitInt(20))), $Box(LitInt(10))), 
        $Box(LitInt(20))));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(421,12)
    assume true;
    assume true;
    s2#0 := Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq, $Box(LitInt(20))), $Box(LitInt(10))), 
        $Box(LitInt(22))));
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(422,18)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##7 := s0#0;
    ...
    // ProcessCallStmt: CheckSubrange
    y##7 := s1#0;
    call {:id "id49"} Call$$MoreArrays.__default.CheckEquality(TSeq(TInt), $Box(x##7), $Box(y##7));
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(423,18)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##8 := s0#0;
    ...
    // ProcessCallStmt: CheckSubrange
    y##8 := s2#0;
    call {:id "id50"} Call$$MoreArrays.__default.CheckEquality(TSeq(TInt), $Box(x##8), $Box(y##8));
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(425,18)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##9 := Lit(#_System._tuple#2._#Make2($Box(Lit(true)), $Box(LitInt(100))));
    assume true;
    // ProcessCallStmt: CheckSubrange
    y##9 := Lit(#_System._tuple#2._#Make2($Box(Lit(true)), $Box(LitInt(100))));
    call {:id "id51"} Call$$MoreArrays.__default.CheckEquality(Tclass._System.Tuple2(TBool, TInt), $Box(x##9), $Box(y##9));
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(426,18)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##10 := Lit(#_System._tuple#2._#Make2($Box(Lit(true)), $Box(LitInt(100))));
    assume true;
    // ProcessCallStmt: CheckSubrange
    y##10 := Lit(#_System._tuple#2._#Make2($Box(Lit(false)), $Box(LitInt(100))));
    call {:id "id52"} Call$$MoreArrays.__default.CheckEquality(Tclass._System.Tuple2(TBool, TInt), $Box(x##10), $Box(y##10));
    // TrCallStmt: After ProcessCallStmt
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(428,12)
    assume true;
    assume true;
    m0#0 := Lit(Map#Build(Map#Build(Map#Empty(): Map, $Box(LitInt(4)), $Box(Lit(true))), 
        $Box(LitInt(3)), 
        $Box(Lit(false))));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(429,12)
    assume true;
    assume true;
    m1#0 := Map#Build(Lit(Map#Build(Map#Empty(): Map, $Box(LitInt(4)), $Box(Lit(true)))), 
      $Box(LitInt(3)), 
      $Box(Lit(false)));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(430,12)
    assume true;
    assume true;
    m2#0 := Map#Build(Map#Build(Map#Build(Lit(Map#Build(Map#Empty(): Map, $Box(LitInt(3)), $Box(Lit(false)))), 
          $Box(LitInt(4)), 
          $Box(Lit(true))), 
        $Box(LitInt(3)), 
        $Box(Lit(false))), 
      $Box(LitInt(4)), 
      $Box(Lit(true)));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(431,12)
    assume true;
    assume true;
    m3#0 := Map#Build(Map#Build(Map#Build(Lit(Map#Build(Map#Empty(): Map, $Box(LitInt(3)), $Box(Lit(false)))), 
          $Box(LitInt(4)), 
          $Box(Lit(false))), 
        $Box(LitInt(3)), 
        $Box(Lit(false))), 
      $Box(LitInt(3)), 
      $Box(Lit(false)));
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(432,18)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##11 := m0#0;
    ...
    // ProcessCallStmt: CheckSubrange
    y##11 := m1#0;
    call {:id "id57"} Call$$MoreArrays.__default.CheckEquality(TMap(TInt, TBool), $Box(x##11), $Box(y##11));
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(433,18)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##12 := m0#0;
    ...
    // ProcessCallStmt: CheckSubrange
    y##12 := m2#0;
    call {:id "id58"} Call$$MoreArrays.__default.CheckEquality(TMap(TInt, TBool), $Box(x##12), $Box(y##12));
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(434,18)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##13 := m0#0;
    ...
    // ProcessCallStmt: CheckSubrange
    y##13 := m3#0;
    call {:id "id59"} Call$$MoreArrays.__default.CheckEquality(TMap(TInt, TBool), $Box(x##13), $Box(y##13));
    // TrCallStmt: After ProcessCallStmt
}



procedure {:verboseName "MoreArrays.StringToByteArray (well-formedness)"} CheckWellFormed$$MoreArrays.__default.StringToByteArray(s#0: Seq where $Is(s#0, TSeq(TChar)) && $IsAlloc(s#0, TSeq(TChar), $Heap))
   returns (arr#0: ref
       where $Is(arr#0, Tclass._System.array(Tclass.MoreArrays.byte()))
         && $IsAlloc(arr#0, Tclass._System.array(Tclass.MoreArrays.byte()), $Heap));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "MoreArrays.StringToByteArray (call)"} Call$$MoreArrays.__default.StringToByteArray(s#0: Seq where $Is(s#0, TSeq(TChar)) && $IsAlloc(s#0, TSeq(TChar), $Heap))
   returns (arr#0: ref
       where $Is(arr#0, Tclass._System.array(Tclass.MoreArrays.byte()))
         && $IsAlloc(arr#0, Tclass._System.array(Tclass.MoreArrays.byte()), $Heap));
  modifies $Heap;
...
procedure {:verboseName "MoreArrays.StringToByteArray (correctness)"} Impl$$MoreArrays.__default.StringToByteArray(s#0: Seq where $Is(s#0, TSeq(TChar)) && $IsAlloc(s#0, TSeq(TChar), $Heap))
   returns (arr#0: ref
       where $Is(arr#0, Tclass._System.array(Tclass.MoreArrays.byte()))
         && $IsAlloc(arr#0, Tclass._System.array(Tclass.MoreArrays.byte()), $Heap), 
    $_reverifyPost: bool);
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MoreArrays.StringToByteArray (correctness)"} Impl$$MoreArrays.__default.StringToByteArray(s#0: Seq) returns (arr#0: ref, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var $nw: ref;
  var i#0_0: int;
  ...
  var $prevHeap: Heap;
    ...
    // AddMethodImpl: StringToByteArray, Impl$$MoreArrays.__default.StringToByteArray
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(438,9)
    assume true;
    assert {:id "id60"} 0 <= Seq#Length(s#0);
    havoc $nw;
    assume $nw != null && $Is($nw, Tclass._System.array?(Tclass.MoreArrays.byte()));
    assume !$Unbox(read($Heap, $nw, alloc)): bool;
    ...
    assume $IsHeapAnchor($Heap);
    arr#0 := $nw;
    // ----- forall statement (assign) ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(439,5)
    if (*)
    {
        ...
        assume true;
        assume LitInt(0) <= i#0_0 && i#0_0 < Seq#Length(s#0);
        assert {:id "id62"} arr#0 != null;
        assert {:id "id63"} {:subsumption 0} 0 <= i#0_0 && i#0_0 < _System.array.Length(arr#0);
        assume true;
        assert {:id "id64"} $_ModifiesFrame[arr#0, IndexField(i#0_0)];
        havoc ch#Z#0_0;
        assert {:id "id65"} {:subsumption 0} 0 <= i#0_0 && i#0_0 < Seq#Length(s#0);
        assume {:id "id66"} let#0_0#0#0 == $Unbox(Seq#Index(s#0, i#0_0)): char;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(let#0_0#0#0, TChar);
        assume {:id "id67"} ch#Z#0_0 == let#0_0#0#0;
        if (char#ToInt(Lit(char#FromInt(32))) <= char#ToInt(ch#Z#0_0))
        {
        }

        if (char#ToInt(Lit(char#FromInt(32))) <= char#ToInt(ch#Z#0_0)
           && char#ToInt(ch#Z#0_0) <= char#ToInt(Lit(char#FromInt(122))))
        {
        }
        else
        {
        ...
        newtype$check#0_0 := char#ToInt((var ch#0_0 := $Unbox(Seq#Index(s#0, i#0_0)): char; 
            (if char#ToInt(Lit(char#FromInt(32))) <= char#ToInt(ch#0_0)
                 && char#ToInt(ch#0_0) <= char#ToInt(Lit(char#FromInt(122)))
               then ch#0_0
               else char#FromInt(88))));
        assert {:id "id68"} LitInt(0) <= newtype$check#0_0 && newtype$check#0_0 < 256;
        newtype$check#0_1 := char#ToInt((var ch#0_0 := $Unbox(Seq#Index(s#0, i#0_0)): char; 
            (if char#ToInt(Lit(char#FromInt(32))) <= char#ToInt(ch#0_0)
                 && char#ToInt(ch#0_0) <= char#ToInt(Lit(char#FromInt(122)))
               then ch#0_0
               else char#FromInt(88))));
        assert {:id "id69"} LitInt(0) <= newtype$check#0_1 && newtype$check#0_1 < 256;
        assume true;
        havoc i#0_1;
        assume true;
        assume LitInt(0) <= i#0_1 && i#0_1 < Seq#Length(s#0);
        assume i#0_0 != i#0_1;
        assert {:id "id70"} arr#0 != arr#0
           || IndexField(i#0_0) != IndexField(i#0_1)
           || char#ToInt((var ch#0_1 := $Unbox(Seq#Index(s#0, i#0_0)): char; 
                (if char#ToInt(Lit(char#FromInt(32))) <= char#ToInt(ch#0_1)
                     && char#ToInt(ch#0_1) <= char#ToInt(Lit(char#FromInt(122)))
                   then ch#0_1
                   else char#FromInt(88))))
             == char#ToInt((var ch#0_2 := $Unbox(Seq#Index(s#0, i#0_1)): char; 
                (if char#ToInt(Lit(char#FromInt(32))) <= char#ToInt(ch#0_2)
                     && char#ToInt(ch#0_2) <= char#ToInt(Lit(char#FromInt(122)))
                   then ch#0_2
                   else char#FromInt(88))));
        assume false;
    }
    else
    {
        ...
        assume (forall $o: ref, $f: Field :: 
          ...
          read($Heap, $o, $f) == read($prevHeap, $o, $f)
             || (exists i#0_2: int :: 
              LitInt(0) <= i#0_2
                 && i#0_2 < Seq#Length(s#0)
                 && $o == arr#0
                 && $f == IndexField(i#0_2)));
        assume (forall i#inv#0_0: int :: 
          { read($Heap, arr#0, IndexField(i#inv#0_0)) } 
          LitInt(0) <= i#inv#0_0 && i#inv#0_0 < Seq#Length(s#0)
             ==> read($Heap, arr#0, IndexField(i#inv#0_0))
               == $Box(char#ToInt((var ch#0_3 := $Unbox(Seq#Index(s#0, i#inv#0_0)): char; 
                    (if char#ToInt(Lit(char#FromInt(32))) <= char#ToInt(ch#0_3)
                         && char#ToInt(ch#0_3) <= char#ToInt(Lit(char#FromInt(122)))
                       then ch#0_3
                       else char#FromInt(88))))));
    }
}
...
procedure {:verboseName "MoreArrays.WriteLine (well-formedness)"} CheckWellFormed$$MoreArrays.__default.WriteLine(arr#0: ref
       where $Is(arr#0, Tclass._System.array(Tclass.MoreArrays.byte()))
         && $IsAlloc(arr#0, Tclass._System.array(Tclass.MoreArrays.byte()), $Heap));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "MoreArrays.WriteLine (call)"} Call$$MoreArrays.__default.WriteLine(arr#0: ref
       where $Is(arr#0, Tclass._System.array(Tclass.MoreArrays.byte()))
         && $IsAlloc(arr#0, Tclass._System.array(Tclass.MoreArrays.byte()), $Heap));
  modifies $Heap;
  // frame condition: object granularity
...
procedure {:verboseName "MoreArrays.WriteLine (correctness)"} Impl$$MoreArrays.__default.WriteLine(arr#0: ref
       where $Is(arr#0, Tclass._System.array(Tclass.MoreArrays.byte()))
         && $IsAlloc(arr#0, Tclass._System.array(Tclass.MoreArrays.byte()), $Heap))
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MoreArrays.WriteLine (correctness)"} Impl$$MoreArrays.__default.WriteLine(arr#0: ref) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var i#0: int;
  var i#0#lo: int;
  ...
  var newtype$check#0_0: int;
    ...
    // AddMethodImpl: WriteLine, Impl$$MoreArrays.__default.WriteLine
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- for-loop statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(445,5)
    i#0#lo := LitInt(0);
    assert {:id "id71"} arr#0 != null;
    i#0#hi := _System.array.Length(arr#0);
    assert {:id "id72"} i#0#lo <= i#0#hi;
    i#0 := i#0#lo;
      ...
      free invariant true;
    {
        ...
        push;
        // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(446,7)
        assert {:id "id73"} arr#0 != null;
        assert {:id "id74"} {:subsumption 0} 0 <= i#0 && i#0 < _System.array.Length(arr#0);
        newtype$check#0_0 := $Unbox(read($Heap, arr#0, IndexField(i#0))): int;
        assert {:id "id75"} char#IsChar(newtype$check#0_0);
        assume true;
        pop;
        i#0 := i#0 + 1;
    }

    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(448,5)
    assume true;
}



procedure {:verboseName "MoreArrays.CheckEquality (well-formedness)"} CheckWellFormed$$MoreArrays.__default.CheckEquality(MoreArrays._default.CheckEquality$T: Ty, 
    x#0: Box
       where $IsBox(x#0, MoreArrays._default.CheckEquality$T)
         && $IsAllocBox(x#0, MoreArrays._default.CheckEquality$T, $Heap), 
    y#0: Box
       where $IsBox(y#0, MoreArrays._default.CheckEquality$T)
         && $IsAllocBox(y#0, MoreArrays._default.CheckEquality$T, $Heap));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "MoreArrays.CheckEquality (call)"} Call$$MoreArrays.__default.CheckEquality(MoreArrays._default.CheckEquality$T: Ty, 
    x#0: Box
       where $IsBox(x#0, MoreArrays._default.CheckEquality$T)
         && $IsAllocBox(x#0, MoreArrays._default.CheckEquality$T, $Heap), 
    y#0: Box
...
procedure {:verboseName "MoreArrays.CheckEquality (correctness)"} Impl$$MoreArrays.__default.CheckEquality(MoreArrays._default.CheckEquality$T: Ty, 
    x#0: Box
       where $IsBox(x#0, MoreArrays._default.CheckEquality$T)
         && $IsAllocBox(x#0, MoreArrays._default.CheckEquality$T, $Heap), 
    y#0: Box
...
procedure {:verboseName "MoreArrays.byte (well-formedness)"} CheckWellFormed$$MoreArrays.byte(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MoreArrays.byte (well-formedness)"} CheckWellFormed$$MoreArrays.byte(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assume {:id "id76"} LitInt(0) <= x#0 && x#0 < 256;
        assume false;
    }
    ...
    if (*)
    {
        ...
        assume true;
        assert {:id "id77"} {:subsumption 0} LitInt(0) <= LitInt(0);
        assert {:id "id78"} {:subsumption 0} Lit(0 < 256);
        assume false;
    }
}
