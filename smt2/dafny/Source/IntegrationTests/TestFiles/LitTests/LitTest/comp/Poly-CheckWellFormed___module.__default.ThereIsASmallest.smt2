...
(let ((anon5_Else_correct  (=> (and (=> (|Set#IsMember| |s#0| ($Box refType |shape'#0@0|)) (<= (U_2_real ($Unbox realType (_System.Tuple2._0 (_module.Shape.Center $Heap@0 |shape#0@0|)))) (U_2_real ($Unbox realType (_System.Tuple2._0 (_module.Shape.Center $Heap@0 |shape'#0@0|)))))) (= (ControlFlow 0 5) 1)) anon4_correct)))
(let ((anon5_Then_correct  (=> (|Set#IsMember| |s#0| ($Box refType |shape'#0@0|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |shape#0@0| null)) (not true))) (=> (or (not (= |shape#0@0| null)) (not true)) (=> (and (and ($IsAllocBox ($Box refType |shape#0@0|) Tclass._module.Shape? $Heap@0) (|_module.Shape.Center#canCall| $Heap@0 |shape#0@0|)) (and (_System.Tuple2.___hMake2_q (_module.Shape.Center $Heap@0 |shape#0@0|)) (_System.Tuple2.___hMake2_q (_module.Shape.Center $Heap@0 |shape#0@0|)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |shape'#0@0| null)) (not true))) (=> (or (not (= |shape'#0@0| null)) (not true)) (=> (and ($IsAllocBox ($Box refType |shape'#0@0|) Tclass._module.Shape? $Heap@0) (|_module.Shape.Center#canCall| $Heap@0 |shape'#0@0|)) (=> (and (and (_System.Tuple2.___hMake2_q (_module.Shape.Center $Heap@0 |shape'#0@0|)) (_System.Tuple2.___hMake2_q (_module.Shape.Center $Heap@0 |shape'#0@0|))) (and (<= (U_2_real ($Unbox realType (_System.Tuple2._0 (_module.Shape.Center $Heap@0 |shape#0@0|)))) (U_2_real ($Unbox realType (_System.Tuple2._0 (_module.Shape.Center $Heap@0 |shape'#0@0|))))) (= (ControlFlow 0 2) 1))) anon4_correct))))))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (not (|Set#Equal| |s#0| |Set#Empty|))) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@0 $Heap@0)) (=> (and (and (and ($Is refType |shape#0@0| Tclass._module.Shape) ($IsAlloc refType |shape#0@0| Tclass._module.Shape $Heap@0)) (|Set#IsMember| |s#0| ($Box refType |shape#0@0|))) (and ($Is refType |shape'#0@0| Tclass._module.Shape) ($IsAlloc refType |shape'#0@0| Tclass._module.Shape $Heap@0))) (and (=> (= (ControlFlow 0 6) 2) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and ($Is SetType |s#0| (TSet Tclass._module.Shape)) ($IsAlloc SetType |s#0| (TSet Tclass._module.Shape) $Heap@@0))) (and (and ($Is refType |shape#0| Tclass._module.Shape) ($IsAlloc refType |shape#0| Tclass._module.Shape $Heap@@0)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 7) 6)))) anon0_correct)))
