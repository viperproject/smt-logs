...
(assert (distinct TInt TagInt TagSet TagMap alloc |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass._module.Color |##_module.Color.Blue| |##_module.Color.Yellow| |tytagFamily$_tuple#2| tytagFamily$Color)
)
...
(assert (forall ((bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 Tclass._module.Color) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@1)) bx@@1) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@1) Tclass._module.Color)))
 :qid |unknown.0:0|
 :skolemid |5019|
 :pattern ( ($IsBox bx@@1 Tclass._module.Color))
)))
...
(assert (forall ((d@@3 T@U) ($h@@0 T@U) ) (!  (=> (and ($IsGoodHeap $h@@0) ($Is DatatypeTypeType d@@3 Tclass._module.Color)) ($IsAlloc DatatypeTypeType d@@3 Tclass._module.Color $h@@0))
 :qid |unknown.0:0|
 :skolemid |5106|
 :pattern ( ($IsAlloc DatatypeTypeType d@@3 Tclass._module.Color $h@@0))
)))
...
(assert (forall ((d@@4 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_System.Tuple2.___hMake2_q d@@4) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@4 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@1)
 :qid |unknown.0:0|
 :skolemid |4939|
 :pattern ( ($IsAlloc DatatypeTypeType d@@4 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@1))
)))) ($IsAllocBox (_System.Tuple2._0 d@@4) |_System._tuple#2$T0@@6| $h@@1))
 :qid |unknown.0:0|
 :skolemid |4940|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@4) |_System._tuple#2$T0@@6| $h@@1))
)))
(assert (forall ((d@@5 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (_System.Tuple2.___hMake2_q d@@5) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@5 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@2)
 :qid |unknown.0:0|
 :skolemid |4941|
 :pattern ( ($IsAlloc DatatypeTypeType d@@5 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@2))
)))) ($IsAllocBox (_System.Tuple2._1 d@@5) |_System._tuple#2$T1@@7| $h@@2))
 :qid |unknown.0:0|
 :skolemid |4942|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@5) |_System._tuple#2$T1@@7| $h@@2))
)))
...
(declare-fun |items#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.Maps)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |a#0@0| (Lit MapType |Map#Empty|)) (= |b#0@0| (Lit MapType (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 17))) ($Box intType (int_2_U (LitInt 2)))) ($Box intType (int_2_U (LitInt 82))) ($Box intType (int_2_U (LitInt 2))))))) (=> (and (and (= |c#0@0| (Lit MapType (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 17))) ($Box intType (int_2_U (LitInt 0)))) ($Box intType (int_2_U (LitInt 12))) ($Box intType (int_2_U (LitInt 26)))))) (= |$rhs#0@0| (|Map#Build| |a#0@0| ($Box intType (int_2_U (LitInt 17))) ($Box intType (int_2_U (LitInt 6)))))) (and (= |$rhs#1@0| (|Map#Build| |b#0@0| ($Box intType (int_2_U (LitInt 17))) ($Box intType (int_2_U (LitInt 6))))) (= |$rhs#2@0| (|Map#Build| |c#0@0| ($Box intType (int_2_U (LitInt 17))) ($Box intType (int_2_U (LitInt 6))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (|Set#IsMember| (|Map#Domain| |$rhs#0@0|) ($Box intType (int_2_U (LitInt 17))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (|Set#IsMember| (|Map#Domain| |$rhs#1@0|) ($Box intType (int_2_U (LitInt 17))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (|Set#IsMember| (|Map#Domain| |b#0@0|) ($Box intType (int_2_U (LitInt 17))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Set#IsMember| (|Map#Domain| |$rhs#2@0|) ($Box intType (int_2_U (LitInt 17))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Set#IsMember| (|Map#Domain| |c#0@0|) ($Box intType (int_2_U (LitInt 17))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#IsMember| (|Map#Domain| |b#0@0|) ($Box intType (int_2_U (LitInt 17))))) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#IsMember| (|Map#Domain| |c#0@0|) ($Box intType (int_2_U (LitInt 17))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is MapType |a#0| (TMap TInt TInt)) ($IsAlloc MapType |a#0| (TMap TInt TInt) $Heap)) true) (=> (and (and (and ($Is MapType |b#0| (TMap TInt TInt)) ($IsAlloc MapType |b#0| (TMap TInt TInt) $Heap)) true) (and (and ($Is MapType |c#0| (TMap TInt TInt)) ($IsAlloc MapType |c#0| (TMap TInt TInt) $Heap)) true)) (=> (and (and (and (and (and ($Is MapType |a'#0| (TMap TInt TInt)) ($IsAlloc MapType |a'#0| (TMap TInt TInt) $Heap)) true) (and (and ($Is MapType |b'#0| (TMap TInt TInt)) ($IsAlloc MapType |b'#0| (TMap TInt TInt) $Heap)) true)) (and (and (and ($Is MapType |c'#0| (TMap TInt TInt)) ($IsAlloc MapType |c'#0| (TMap TInt TInt) $Heap)) true) (and (and ($Is MapType |m#0| (TMap Tclass._module.Color TInt)) ($IsAlloc MapType |m#0| (TMap Tclass._module.Color TInt) $Heap)) true))) (and (and (and (and ($Is SetType |keys#0| (TSet Tclass._module.Color)) ($IsAlloc SetType |keys#0| (TSet Tclass._module.Color) $Heap)) true) (and (and ($Is SetType |values#0| (TSet TInt)) ($IsAlloc SetType |values#0| (TSet TInt) $Heap)) true)) (and (and (and ($Is SetType |items#0| (TSet (Tclass._System.Tuple2 Tclass._module.Color TInt))) ($IsAlloc SetType |items#0| (TSet (Tclass._System.Tuple2 Tclass._module.Color TInt)) $Heap)) true) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 9) 2))))) anon0_correct))))))
