...
procedure {:verboseName "EuclideanDivisionRegressions.Test (correctness)"} Impl$$EuclideanDivisionRegressions.__default.Test() returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "EuclideanDivisionRegressions.Test (correctness)"} Impl$$EuclideanDivisionRegressions.__default.Test() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;

    // AddMethodImpl: Test, Impl$$EuclideanDivisionRegressions.__default.Test
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(581,12)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id0"} Call$$EuclideanDivisionRegressions.__default.TestDiv();
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(582,19)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id1"} Call$$EuclideanDivisionRegressions.__default.TestWraparound();
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(583,12)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id2"} Call$$EuclideanDivisionRegressions.__default.TestMod();
    // TrCallStmt: After ProcessCallStmt
}



procedure {:verboseName "EuclideanDivisionRegressions.TestDiv (well-formedness)"} CheckWellFormed$$EuclideanDivisionRegressions.__default.TestDiv();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "EuclideanDivisionRegressions.TestDiv (call)"} Call$$EuclideanDivisionRegressions.__default.TestDiv();
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "EuclideanDivisionRegressions.TestDiv (correctness)"} Impl$$EuclideanDivisionRegressions.__default.TestDiv() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "EuclideanDivisionRegressions.TestDiv (correctness)"} Impl$$EuclideanDivisionRegressions.__default.TestDiv() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var r0#0: real;
  var r1#0: real where Lit(true);
  var newtype$check#0: real;
  var newtype$check#1: real;
  var newtype$check#2: real;
  var r2#0: real where LitReal(0e0) <= r2#0;
  var newtype$check#3: real;
  var newtype$check#4: real;
  var newtype$check#5: real;
  var i0#0: int;
  var i1#0: int where Lit(true);
  var newtype$check#6: int;
  var newtype$check#7: int;
  var newtype$check#8: int;
  var i2#0: int where LitInt(-200) <= i2#0;
  var newtype$check#9: int;
  var newtype$check#10: int;
  var newtype$check#11: int;
  var b0#0: int where LitInt(0) <= b0#0 && b0#0 < 256;
  var newtype$check#12: int;
  var newtype$check#13: int;
  var newtype$check#14: int;
  var b1#0: int where LitInt(0) <= b1#0 && b1#0 < 256;
  var newtype$check#15: int;
  var newtype$check#16: int;
  var newtype$check#17: int;
  var b2#0: int where LitInt(-128) <= b2#0 && b2#0 < 128;
  var newtype$check#18: int;
  var newtype$check#19: int;
  var newtype$check#20: int;
  var b3#0: int where LitInt(-128) <= b3#0 && b3#0 < 128;
  ...
  var h3#0: bv68;
    ...
    // AddMethodImpl: TestDiv, Impl$$EuclideanDivisionRegressions.__default.TestDiv
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(589,18)
    assume true;
    assert {:id "id3"} LitReal(1e1) != 0e0;
    assume true;
    r0#0 := LitReal(621e0 / 1e1);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(590,20)
    assume true;
    newtype$check#0 := LitReal(622e0);
    newtype$check#1 := LitReal(1e1);
    assert {:id "id5"} LitReal(1e1) != 0e0;
    newtype$check#2 := LitReal(622e0 / 1e1);
    assume true;
    r1#0 := LitReal(622e0 / 1e1);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(591,34)
    assume true;
    newtype$check#3 := LitReal(623e0);
    assert {:id "id7"} LitReal(0e0) <= newtype$check#3;
    newtype$check#4 := LitReal(1e1);
    assert {:id "id8"} LitReal(0e0) <= newtype$check#4;
    assert {:id "id9"} LitReal(1e1) != 0e0;
    newtype$check#5 := LitReal(623e0 / 1e1);
    assert {:id "id10"} LitReal(0e0) <= newtype$check#5;
    assume true;
    r2#0 := LitReal(623e0 / 1e1);
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(592,5)
    assume true;
    assume true;
    assume true;
    assume true;
    assume true;
    assume true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(594,17)
    assume true;
    assert {:id "id12"} LitInt(-2) != 0;
    assume true;
    i0#0 := LitInt(Div(7, LitInt(-2)));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(595,19)
    assume true;
    newtype$check#6 := LitInt(7);
    newtype$check#7 := LitInt(-2);
    assert {:id "id14"} LitInt(-2) != 0;
    newtype$check#8 := LitInt(Div(7, LitInt(-2)));
    assume true;
    i1#0 := LitInt(Div(7, LitInt(-2)));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(596,33)
    assume true;
    newtype$check#9 := LitInt(7);
    assert {:id "id16"} LitInt(-200) <= newtype$check#9;
    newtype$check#10 := LitInt(-2);
    assert {:id "id17"} LitInt(-200) <= newtype$check#10;
    assert {:id "id18"} LitInt(-2) != 0;
    newtype$check#11 := LitInt(Div(7, LitInt(-2)));
    assert {:id "id19"} LitInt(-200) <= newtype$check#11;
    assume true;
    i2#0 := LitInt(Div(7, LitInt(-2)));
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(597,5)
    assume true;
    assume true;
    assume true;
    assume true;
    assume true;
    assume true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(599,18)
    assume true;
    newtype$check#12 := LitInt(248);
    assert {:id "id21"} LitInt(0) <= newtype$check#12 && newtype$check#12 < 256;
    newtype$check#13 := LitInt(3);
    assert {:id "id22"} LitInt(0) <= newtype$check#13 && newtype$check#13 < 256;
    assert {:id "id23"} LitInt(3) != 0;
    newtype$check#14 := LitInt(Div(248, LitInt(3)));
    assert {:id "id24"} LitInt(0) <= newtype$check#14 && newtype$check#14 < 256;
    assume true;
    b0#0 := LitInt(Div(248, LitInt(3)));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(600,18)
    assume true;
    newtype$check#15 := LitInt(100);
    assert {:id "id26"} LitInt(0) <= newtype$check#15 && newtype$check#15 < 256;
    newtype$check#16 := LitInt(253);
    assert {:id "id27"} LitInt(0) <= newtype$check#16 && newtype$check#16 < 256;
    assert {:id "id28"} LitInt(253) != 0;
    newtype$check#17 := LitInt(Div(100, LitInt(253)));
    assert {:id "id29"} LitInt(0) <= newtype$check#17 && newtype$check#17 < 256;
    assume true;
    b1#0 := LitInt(Div(100, LitInt(253)));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(601,19)
    assume true;
    newtype$check#18 := LitInt(-8);
    assert {:id "id31"} LitInt(-128) <= newtype$check#18 && newtype$check#18 < 128;
    newtype$check#19 := LitInt(3);
    assert {:id "id32"} LitInt(-128) <= newtype$check#19 && newtype$check#19 < 128;
    assert {:id "id33"} LitInt(3) != 0;
    newtype$check#20 := LitInt(Div(-8, LitInt(3)));
    assert {:id "id34"} LitInt(-128) <= newtype$check#20 && newtype$check#20 < 128;
    assume true;
    b2#0 := LitInt(Div(-8, LitInt(3)));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(602,19)
    assume true;
    newtype$check#21 := LitInt(100);
    assert {:id "id36"} LitInt(-128) <= newtype$check#21 && newtype$check#21 < 128;
    newtype$check#22 := LitInt(-3);
    assert {:id "id37"} LitInt(-128) <= newtype$check#22 && newtype$check#22 < 128;
    assert {:id "id38"} LitInt(-3) != 0;
    newtype$check#23 := LitInt(Div(100, LitInt(-3)));
    assert {:id "id39"} LitInt(-128) <= newtype$check#23 && newtype$check#23 < 128;
    assume true;
    b3#0 := LitInt(Div(100, LitInt(-3)));
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(603,5)
    assume true;
    assume true;
    assume true;
    assume true;
    ...
    assume true;
    assume true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(606,17)
    assume true;
    assert {:id "id41"} Lit(3bv8) != 0bv8;
    assume true;
    v0#0 := Lit(div_bv8(248bv8, 3bv8));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(607,17)
    assume true;
    assert {:id "id43"} Lit(253bv8) != 0bv8;
    assume true;
    v1#0 := Lit(div_bv8(100bv8, 253bv8));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(608,17)
    assume true;
    assert {:id "id45"} Lit(3bv8) != 0bv8;
    assume true;
    v2#0 := Lit(div_bv8(sub_bv8(0bv8, 8bv8), 3bv8));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(609,17)
    assume true;
    assert {:id "id47"} Lit(sub_bv8(0bv8, 3bv8)) != 0bv8;
    assume true;
    v3#0 := Lit(div_bv8(100bv8, sub_bv8(0bv8, 3bv8)));
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(610,5)
    assume true;
    assume true;
    assume true;
    assume true;
    ...
    assume true;
    assume true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(612,20)
    assume true;
    newtype$check#24 := LitInt(2147483641);
    assert {:id "id49"} LitInt(0) <= newtype$check#24 && newtype$check#24 < 4294967296;
    newtype$check#25 := LitInt(3);
    assert {:id "id50"} LitInt(0) <= newtype$check#25 && newtype$check#25 < 4294967296;
    assert {:id "id51"} LitInt(3) != 0;
    newtype$check#26 := LitInt(Div(2147483641, LitInt(3)));
    assert {:id "id52"} LitInt(0) <= newtype$check#26 && newtype$check#26 < 4294967296;
    assume true;
    j0#0 := LitInt(Div(2147483641, LitInt(3)));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(613,20)
    assume true;
    newtype$check#27 := LitInt(100);
    assert {:id "id54"} LitInt(0) <= newtype$check#27 && newtype$check#27 < 4294967296;
    newtype$check#28 := LitInt(2147483645);
    assert {:id "id55"} LitInt(0) <= newtype$check#28 && newtype$check#28 < 4294967296;
    assert {:id "id56"} LitInt(2147483645) != 0;
    newtype$check#29 := LitInt(Div(100, LitInt(2147483645)));
    assert {:id "id57"} LitInt(0) <= newtype$check#29 && newtype$check#29 < 4294967296;
    assume true;
    j1#0 := LitInt(Div(100, LitInt(2147483645)));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(614,19)
    assume true;
    newtype$check#30 := LitInt(-7);
    assert {:id "id59"} LitInt(-2147483648) <= newtype$check#30 && newtype$check#30 < 2147483648;
    newtype$check#31 := LitInt(3);
    assert {:id "id60"} LitInt(-2147483648) <= newtype$check#31 && newtype$check#31 < 2147483648;
    assert {:id "id61"} LitInt(3) != 0;
    newtype$check#32 := LitInt(Div(-7, LitInt(3)));
    assert {:id "id62"} LitInt(-2147483648) <= newtype$check#32 && newtype$check#32 < 2147483648;
    assume true;
    j2#0 := LitInt(Div(-7, LitInt(3)));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(615,19)
    assume true;
    newtype$check#33 := LitInt(100);
    assert {:id "id64"} LitInt(-2147483648) <= newtype$check#33 && newtype$check#33 < 2147483648;
    newtype$check#34 := LitInt(-3);
    assert {:id "id65"} LitInt(-2147483648) <= newtype$check#34 && newtype$check#34 < 2147483648;
    assert {:id "id66"} LitInt(-3) != 0;
    newtype$check#35 := LitInt(Div(100, LitInt(-3)));
    assert {:id "id67"} LitInt(-2147483648) <= newtype$check#35 && newtype$check#35 < 2147483648;
    assume true;
    j3#0 := LitInt(Div(100, LitInt(-3)));
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(616,5)
    assume true;
    assume true;
    assume true;
    assume true;
    ...
    assume true;
    assume true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(619,18)
    assume true;
    assert {:id "id69"} Lit(3bv32) != 0bv32;
    assume true;
    w0#0 := Lit(div_bv32(4294967288bv32, 3bv32));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(620,18)
    assume true;
    assert {:id "id71"} Lit(4294967293bv32) != 0bv32;
    assume true;
    w1#0 := Lit(div_bv32(100bv32, 4294967293bv32));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(621,18)
    assume true;
    assert {:id "id73"} Lit(3bv32) != 0bv32;
    assume true;
    w2#0 := Lit(div_bv32(sub_bv32(0bv32, 8bv32), 3bv32));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(622,18)
    assume true;
    assert {:id "id75"} Lit(sub_bv32(0bv32, 3bv32)) != 0bv32;
    assume true;
    w3#0 := Lit(div_bv32(100bv32, sub_bv32(0bv32, 3bv32)));
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(623,5)
    assume true;
    assume true;
    assume true;
    assume true;
    ...
    assume true;
    assume true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(626,18)
    assume true;
    assert {:id "id77"} Lit(3bv68) != 0bv68;
    assume true;
    h0#0 := Lit(div_bv68(295147905179352825848bv68, 3bv68));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(627,18)
    assume true;
    assert {:id "id79"} Lit(295147905179352825853bv68) != 0bv68;
    assume true;
    h1#0 := Lit(div_bv68(100bv68, 295147905179352825853bv68));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(628,18)
    assume true;
    assert {:id "id81"} Lit(3bv68) != 0bv68;
    assume true;
    h2#0 := Lit(div_bv68(sub_bv68(0bv68, 8bv68), 3bv68));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(629,18)
    assume true;
    assert {:id "id83"} Lit(sub_bv68(0bv68, 3bv68)) != 0bv68;
    assume true;
    h3#0 := Lit(div_bv68(100bv68, sub_bv68(0bv68, 3bv68)));
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(630,5)
    assume true;
    assume true;
    assume true;
    assume true;
...
procedure {:verboseName "EuclideanDivisionRegressions.TestWraparound (well-formedness)"} CheckWellFormed$$EuclideanDivisionRegressions.__default.TestWraparound();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "EuclideanDivisionRegressions.TestWraparound (call)"} Call$$EuclideanDivisionRegressions.__default.TestWraparound();
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "EuclideanDivisionRegressions.TestWraparound (correctness)"} Impl$$EuclideanDivisionRegressions.__default.TestWraparound() returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
procedure {:verboseName "EuclideanDivisionRegressions.TestMod (well-formedness)"} CheckWellFormed$$EuclideanDivisionRegressions.__default.TestMod();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "EuclideanDivisionRegressions.TestMod (call)"} Call$$EuclideanDivisionRegressions.__default.TestMod();
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "EuclideanDivisionRegressions.TestMod (correctness)"} Impl$$EuclideanDivisionRegressions.__default.TestMod() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "EuclideanDivisionRegressions.TestMod (correctness)"} Impl$$EuclideanDivisionRegressions.__default.TestMod() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var m0#0: int;
  var m1#0: int;
  var m2#0: int;
  var m3#0: int;
  var n0#0: int where LitInt(-200) <= n0#0;
  var newtype$check#0: int;
  var newtype$check#1: int;
  var newtype$check#2: int;
  var n1#0: int where LitInt(-200) <= n1#0;
  var newtype$check#3: int;
  var newtype$check#4: int;
  var newtype$check#5: int;
  var n2#0: int where LitInt(-200) <= n2#0;
  var newtype$check#6: int;
  var newtype$check#7: int;
  var newtype$check#8: int;
  var n3#0: int where LitInt(-200) <= n3#0;
  var newtype$check#9: int;
  var newtype$check#10: int;
  var newtype$check#11: int;
  var p0#0: int where LitInt(-2147483648) <= p0#0 && p0#0 < 2147483648;
  var newtype$check#12: int;
  var newtype$check#13: int;
  var newtype$check#14: int;
  var p1#0: int where LitInt(-2147483648) <= p1#0 && p1#0 < 2147483648;
  var newtype$check#15: int;
  var newtype$check#16: int;
  var newtype$check#17: int;
  var p2#0: int where LitInt(-2147483648) <= p2#0 && p2#0 < 2147483648;
  var newtype$check#18: int;
  var newtype$check#19: int;
  var newtype$check#20: int;
  var p3#0: int where LitInt(-2147483648) <= p3#0 && p3#0 < 2147483648;
  var newtype$check#21: int;
  var newtype$check#22: int;
  var newtype$check#23: int;

    // AddMethodImpl: TestMod, Impl$$EuclideanDivisionRegressions.__default.TestMod
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(644,17)
    assume true;
    assert {:id "id91"} LitInt(-3) != 0;
    assume true;
    m0#0 := LitInt(Mod(100, LitInt(-3)));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(645,17)
    assume true;
    assert {:id "id93"} LitInt(3) != 0;
    assume true;
    m1#0 := LitInt(Mod(-100, LitInt(3)));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(646,17)
    assume true;
    assert {:id "id95"} LitInt(-2) != 0;
    assume true;
    m2#0 := LitInt(Mod(-100, LitInt(-2)));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(647,17)
    assume true;
    assert {:id "id97"} LitInt(3) != 0;
    assume true;
    m3#0 := LitInt(Mod(100, LitInt(3)));
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(648,5)
    assume true;
    assume true;
    assume true;
    assume true;
    ...
    assume true;
    assume true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(650,33)
    assume true;
    newtype$check#0 := LitInt(100);
    assert {:id "id99"} LitInt(-200) <= newtype$check#0;
    newtype$check#1 := LitInt(-3);
    assert {:id "id100"} LitInt(-200) <= newtype$check#1;
    assert {:id "id101"} LitInt(-3) != 0;
    newtype$check#2 := LitInt(Mod(100, LitInt(-3)));
    assert {:id "id102"} LitInt(-200) <= newtype$check#2;
    assume true;
    n0#0 := LitInt(Mod(100, LitInt(-3)));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(651,33)
    assume true;
    newtype$check#3 := LitInt(-100);
    assert {:id "id104"} LitInt(-200) <= newtype$check#3;
    newtype$check#4 := LitInt(3);
    assert {:id "id105"} LitInt(-200) <= newtype$check#4;
    assert {:id "id106"} LitInt(3) != 0;
    newtype$check#5 := LitInt(Mod(-100, LitInt(3)));
    assert {:id "id107"} LitInt(-200) <= newtype$check#5;
    assume true;
    n1#0 := LitInt(Mod(-100, LitInt(3)));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(652,33)
    assume true;
    newtype$check#6 := LitInt(-100);
    assert {:id "id109"} LitInt(-200) <= newtype$check#6;
    newtype$check#7 := LitInt(-2);
    assert {:id "id110"} LitInt(-200) <= newtype$check#7;
    assert {:id "id111"} LitInt(-2) != 0;
    newtype$check#8 := LitInt(Mod(-100, LitInt(-2)));
    assert {:id "id112"} LitInt(-200) <= newtype$check#8;
    assume true;
    n2#0 := LitInt(Mod(-100, LitInt(-2)));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(653,33)
    assume true;
    newtype$check#9 := LitInt(100);
    assert {:id "id114"} LitInt(-200) <= newtype$check#9;
    newtype$check#10 := LitInt(3);
    assert {:id "id115"} LitInt(-200) <= newtype$check#10;
    assert {:id "id116"} LitInt(3) != 0;
    newtype$check#11 := LitInt(Mod(100, LitInt(3)));
    assert {:id "id117"} LitInt(-200) <= newtype$check#11;
    assume true;
    n3#0 := LitInt(Mod(100, LitInt(3)));
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(654,5)
    assume true;
    assume true;
    assume true;
    assume true;
    ...
    assume true;
    assume true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(656,19)
    assume true;
    newtype$check#12 := LitInt(100);
    assert {:id "id119"} LitInt(-2147483648) <= newtype$check#12 && newtype$check#12 < 2147483648;
    newtype$check#13 := LitInt(-3);
    assert {:id "id120"} LitInt(-2147483648) <= newtype$check#13 && newtype$check#13 < 2147483648;
    assert {:id "id121"} LitInt(-3) != 0;
    newtype$check#14 := LitInt(Mod(100, LitInt(-3)));
    assert {:id "id122"} LitInt(-2147483648) <= newtype$check#14 && newtype$check#14 < 2147483648;
    assume true;
    p0#0 := LitInt(Mod(100, LitInt(-3)));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(657,19)
    assume true;
    newtype$check#15 := LitInt(-100);
    assert {:id "id124"} LitInt(-2147483648) <= newtype$check#15 && newtype$check#15 < 2147483648;
    newtype$check#16 := LitInt(3);
    assert {:id "id125"} LitInt(-2147483648) <= newtype$check#16 && newtype$check#16 < 2147483648;
    assert {:id "id126"} LitInt(3) != 0;
    newtype$check#17 := LitInt(Mod(-100, LitInt(3)));
    assert {:id "id127"} LitInt(-2147483648) <= newtype$check#17 && newtype$check#17 < 2147483648;
    assume true;
    p1#0 := LitInt(Mod(-100, LitInt(3)));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(658,19)
    assume true;
    newtype$check#18 := LitInt(-100);
    assert {:id "id129"} LitInt(-2147483648) <= newtype$check#18 && newtype$check#18 < 2147483648;
    newtype$check#19 := LitInt(-2);
    assert {:id "id130"} LitInt(-2147483648) <= newtype$check#19 && newtype$check#19 < 2147483648;
    assert {:id "id131"} LitInt(-2) != 0;
    newtype$check#20 := LitInt(Mod(-100, LitInt(-2)));
    assert {:id "id132"} LitInt(-2147483648) <= newtype$check#20 && newtype$check#20 < 2147483648;
    assume true;
    p2#0 := LitInt(Mod(-100, LitInt(-2)));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(659,19)
    assume true;
    newtype$check#21 := LitInt(100);
    assert {:id "id134"} LitInt(-2147483648) <= newtype$check#21 && newtype$check#21 < 2147483648;
    newtype$check#22 := LitInt(3);
    assert {:id "id135"} LitInt(-2147483648) <= newtype$check#22 && newtype$check#22 < 2147483648;
    assert {:id "id136"} LitInt(3) != 0;
    newtype$check#23 := LitInt(Mod(100, LitInt(3)));
    assert {:id "id137"} LitInt(-2147483648) <= newtype$check#23 && newtype$check#23 < 2147483648;
    assume true;
    p3#0 := LitInt(Mod(100, LitInt(3)));
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(660,5)
    assume true;
    assume true;
    assume true;
    assume true;
...
procedure {:verboseName "EuclideanDivisionRegressions.MyReal (well-formedness)"} CheckWellFormed$$EuclideanDivisionRegressions.MyReal();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
axiom (forall c0#0: real :: 
  { $Is(c0#0, Tclass.EuclideanDivisionRegressions.MyReal()) } 
  $Is(c0#0, Tclass.EuclideanDivisionRegressions.MyReal()) <==> Lit(true));

// $IsAlloc axiom for newtype EuclideanDivisionRegressions.MyReal
axiom (forall c1#0: real, $h: Heap :: 
  { $IsAlloc(c1#0, Tclass.EuclideanDivisionRegressions.MyReal(), $h) } 
  $IsAlloc(c1#0, Tclass.EuclideanDivisionRegressions.MyReal(), $h));

const unique class.EuclideanDivisionRegressions.MyReal: ClassName;

procedure {:verboseName "EuclideanDivisionRegressions.MyRealWithConstraint (well-formedness)"} CheckWellFormed$$EuclideanDivisionRegressions.MyRealWithConstraint(r#0: real);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "EuclideanDivisionRegressions.MyRealWithConstraint (well-formedness)"} CheckWellFormed$$EuclideanDivisionRegressions.MyRealWithConstraint(r#0: real)
{
  var $_ReadsFrame: [ref,Field]bool;


    // AddWellformednessCheck for newtype MyRealWithConstraint
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    if (*)
    {
        // check well-formedness of newtype constraint
        assume {:id "id139"} LitReal(0e0) <= r#0;
        assume false;
    }
    ...
    if (*)
    {
        ...
        assume true;
        assert {:id "id140"} LitReal(0e0) <= LitReal(0e0);
        assume false;
    }
}
...
procedure {:verboseName "EuclideanDivisionRegressions.MyInt (well-formedness)"} CheckWellFormed$$EuclideanDivisionRegressions.MyInt();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
axiom (forall c0#0: int :: 
  { $Is(c0#0, Tclass.EuclideanDivisionRegressions.MyInt()) } 
  $Is(c0#0, Tclass.EuclideanDivisionRegressions.MyInt()) <==> Lit(true));

// $IsAlloc axiom for newtype EuclideanDivisionRegressions.MyInt
axiom (forall c1#0: int, $h: Heap :: 
  { $IsAlloc(c1#0, Tclass.EuclideanDivisionRegressions.MyInt(), $h) } 
  $IsAlloc(c1#0, Tclass.EuclideanDivisionRegressions.MyInt(), $h));

const unique class.EuclideanDivisionRegressions.MyInt: ClassName;

procedure {:verboseName "EuclideanDivisionRegressions.MyIntWithConstraint (well-formedness)"} CheckWellFormed$$EuclideanDivisionRegressions.MyIntWithConstraint(i#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "EuclideanDivisionRegressions.MyIntWithConstraint (well-formedness)"} CheckWellFormed$$EuclideanDivisionRegressions.MyIntWithConstraint(i#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;


    // AddWellformednessCheck for newtype MyIntWithConstraint
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    if (*)
    {
        // check well-formedness of newtype constraint
        assume {:id "id141"} LitInt(-200) <= i#0;
        assume false;
    }
    ...
    if (*)
    {
        // check well-formedness of newtype witness, and that it satisfies the constraint
        assume true;
        assert {:id "id142"} LitInt(-200) <= LitInt(0);
        assume false;
    }
}
...
procedure {:verboseName "EuclideanDivisionRegressions.byte (well-formedness)"} CheckWellFormed$$EuclideanDivisionRegressions.byte(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "EuclideanDivisionRegressions.byte (well-formedness)"} CheckWellFormed$$EuclideanDivisionRegressions.byte(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assume {:id "id143"} LitInt(0) <= x#0 && x#0 < 256;
        assume false;
    }
    ...
    if (*)
    {
        // check well-formedness of newtype witness, and that it satisfies the constraint
        assume true;
        assert {:id "id144"} {:subsumption 0} LitInt(0) <= LitInt(0);
        assert {:id "id145"} {:subsumption 0} Lit(0 < 256);
        assume false;
    }
}
...
procedure {:verboseName "EuclideanDivisionRegressions.sbyte (well-formedness)"} CheckWellFormed$$EuclideanDivisionRegressions.sbyte(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "EuclideanDivisionRegressions.sbyte (well-formedness)"} CheckWellFormed$$EuclideanDivisionRegressions.sbyte(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;


    // AddWellformednessCheck for newtype sbyte
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    if (*)
    {
        ...
        assume {:id "id146"} LitInt(-128) <= x#0 && x#0 < 128;
        assume false;
    }
    ...
    if (*)
    {
        // check well-formedness of newtype witness, and that it satisfies the constraint
        assume true;
        assert {:id "id147"} {:subsumption 0} LitInt(-128) <= LitInt(0);
        assert {:id "id148"} {:subsumption 0} Lit(0 < 128);
        assume false;
    }
}
...
procedure {:verboseName "EuclideanDivisionRegressions.uint32 (well-formedness)"} CheckWellFormed$$EuclideanDivisionRegressions.uint32(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "EuclideanDivisionRegressions.uint32 (well-formedness)"} CheckWellFormed$$EuclideanDivisionRegressions.uint32(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assume {:id "id149"} LitInt(0) <= x#0 && x#0 < 4294967296;
        assume false;
    }
    ...
    if (*)
    {
        // check well-formedness of newtype witness, and that it satisfies the constraint
        assume true;
        assert {:id "id150"} {:subsumption 0} LitInt(0) <= LitInt(0);
        assert {:id "id151"} {:subsumption 0} Lit(0 < 4294967296);
        assume false;
    }
}
...
procedure {:verboseName "EuclideanDivisionRegressions.int32 (well-formedness)"} CheckWellFormed$$EuclideanDivisionRegressions.int32(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "EuclideanDivisionRegressions.int32 (well-formedness)"} CheckWellFormed$$EuclideanDivisionRegressions.int32(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assume {:id "id152"} LitInt(-2147483648) <= x#0 && x#0 < 2147483648;
        assume false;
    }
    ...
    if (*)
    {
        // check well-formedness of newtype witness, and that it satisfies the constraint
        assume true;
        assert {:id "id153"} {:subsumption 0} LitInt(-2147483648) <= LitInt(0);
        assert {:id "id154"} {:subsumption 0} Lit(0 < 2147483648);
        assume false;
    }
}
