...
(declare-fun |Mod1.Class1.Fun1#canCall| () Bool)
(declare-fun Mod1.Class1.Fun1 () Int)
...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |Mod1.Class1.Fun1#canCall| (< 0 $FunctionContextHeight)) (> Mod1.Class1.Fun1 0))))
...
(set-info :boogie-vc-id CheckWellformed$$Mod1.Class1.Fun1)
