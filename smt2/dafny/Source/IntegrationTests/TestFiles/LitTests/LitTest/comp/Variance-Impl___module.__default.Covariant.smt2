...
(declare-fun _module.Co.x (T@U T@U) Int)
(declare-fun TagFamily (T@U) T@U)
(declare-fun _module.Co.y (T@U T@U) T@U)
...
(declare-fun _module.Co.z (T@U) T@U)
...
(assert (distinct TBool TInt TagBool TagInt TagSeq alloc Tagclass._module.Int Tagclass._module.Co Tagclass._module.X |##_module.Co.Co| Tagclass._module.X? Tagclass._module.Int? tytagFamily$Int tytagFamily$Co tytagFamily$X)
)
...
(assert (forall ((_module.Co$T T@U) (d T@U) ) (!  (=> ($Is DatatypeTypeType d (Tclass._module.Co _module.Co$T)) (_module.Co.Co_q d))
 :qid |unknown.0:0|
 :skolemid |557|
 :pattern ( (_module.Co.Co_q d) ($Is DatatypeTypeType d (Tclass._module.Co _module.Co$T)))
)))
...
(assert (forall ((d@@0 T@U) ) (! (= (_module.Co.Co_q d@@0) (= (DatatypeCtorId d@@0) |##_module.Co.Co|))
 :qid |unknown.0:0|
 :skolemid |547|
 :pattern ( (_module.Co.Co_q d@@0))
)))
...
(assert (forall ((d@@1 T@U) ) (!  (=> (_module.Co.Co_q d@@1) (exists ((|a#1#0#0| T@U) ) (! (= d@@1 (|#_module.Co.Co| |a#1#0#0|))
 :qid |Variancedfy.3:22|
 :skolemid |548|
)))
 :qid |unknown.0:0|
 :skolemid |549|
 :pattern ( (_module.Co.Co_q d@@1))
)))
(assert  (=> (< 0 $FunctionContextHeight) (forall ((_module.Co$T@@0 T@U) ($h@@4 T@U) ($o@@2 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@4) ($Is DatatypeTypeType $o@@2 (Tclass._module.Co _module.Co$T@@0))) ($IsAlloc DatatypeTypeType $o@@2 (Tclass._module.Co _module.Co$T@@0) $h@@4)) ($IsAlloc intType (int_2_U (_module.Co.x _module.Co$T@@0 $o@@2)) TInt $h@@4))
 :qid |unknown.0:0|
 :skolemid |561|
 :pattern ( (_module.Co.x _module.Co$T@@0 $o@@2) ($IsAlloc DatatypeTypeType $o@@2 (Tclass._module.Co _module.Co$T@@0) $h@@4))
))))
(assert  (=> (< 0 $FunctionContextHeight) (forall ((_module.Co$T@@1 T@U) ($o@@3 T@U) ) (!  (=> ($Is DatatypeTypeType $o@@3 (Tclass._module.Co _module.Co$T@@1)) ($Is intType (int_2_U (_module.Co.x _module.Co$T@@1 $o@@3)) TInt))
 :qid |unknown.0:0|
 :skolemid |560|
 :pattern ( (_module.Co.x _module.Co$T@@1 $o@@3))
))))
...
(assert (forall ((_module.Co$T@@2 T@U) ) (!  (and (= (Tag (Tclass._module.Co _module.Co$T@@2)) Tagclass._module.Co) (= (TagFamily (Tclass._module.Co _module.Co$T@@2)) tytagFamily$Co))
 :qid |unknown.0:0|
 :skolemid |484|
 :pattern ( (Tclass._module.Co _module.Co$T@@2))
)))
(assert (= (Ctor SeqType) 8))
(assert  (=> (< 0 $FunctionContextHeight) (forall ((_module.Co$T@@3 T@U) ($h@@5 T@U) ($o@@4 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@5) ($Is DatatypeTypeType $o@@4 (Tclass._module.Co _module.Co$T@@3))) ($IsAlloc DatatypeTypeType $o@@4 (Tclass._module.Co _module.Co$T@@3) $h@@5)) ($IsAlloc SeqType (_module.Co.y _module.Co$T@@3 $o@@4) (TSeq _module.Co$T@@3) $h@@5))
 :qid |unknown.0:0|
 :skolemid |563|
 :pattern ( (_module.Co.y _module.Co$T@@3 $o@@4) ($IsAlloc DatatypeTypeType $o@@4 (Tclass._module.Co _module.Co$T@@3) $h@@5))
))))
...
(assert  (=> (< 0 $FunctionContextHeight) (forall ((_module.Co$T@@4 T@U) ($o@@5 T@U) ) (!  (=> ($Is DatatypeTypeType $o@@5 (Tclass._module.Co _module.Co$T@@4)) ($Is SeqType (_module.Co.y _module.Co$T@@4 $o@@5) (TSeq _module.Co$T@@4)))
 :qid |unknown.0:0|
 :skolemid |562|
 :pattern ( (_module.Co.y _module.Co$T@@4 $o@@5))
))))
(assert (forall ((_module.Co$T@@5 T@U) (|a#2#0#0| T@U) ($h@@6 T@U) ) (!  (=> ($IsGoodHeap $h@@6) (= ($IsAlloc DatatypeTypeType (|#_module.Co.Co| |a#2#0#0|) (Tclass._module.Co _module.Co$T@@5) $h@@6) ($IsAllocBox |a#2#0#0| _module.Co$T@@5 $h@@6)))
 :qid |unknown.0:0|
 :skolemid |551|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.Co.Co| |a#2#0#0|) (Tclass._module.Co _module.Co$T@@5) $h@@6))
)))
...
(assert (forall ((_module.Co$T@@6 T@U) ) (! (= (Tclass._module.Co_0 (Tclass._module.Co _module.Co$T@@6)) _module.Co$T@@6)
 :qid |unknown.0:0|
 :skolemid |485|
 :pattern ( (Tclass._module.Co _module.Co$T@@6))
)))
...
(assert (forall ((|a#4#0#0| T@U) ) (! (= (_module.Co.z (|#_module.Co.Co| |a#4#0#0|)) |a#4#0#0|)
 :qid |Variancedfy.3:22|
 :skolemid |554|
...
(assert (forall ((_module.Co$T@@7 T@U) (|a#2#0#0@@0| T@U) ) (! (= ($Is DatatypeTypeType (|#_module.Co.Co| |a#2#0#0@@0|) (Tclass._module.Co _module.Co$T@@7)) ($IsBox |a#2#0#0@@0| _module.Co$T@@7))
 :qid |unknown.0:0|
 :skolemid |550|
 :pattern ( ($Is DatatypeTypeType (|#_module.Co.Co| |a#2#0#0@@0|) (Tclass._module.Co _module.Co$T@@7)))
)))
...
(assert (forall ((d@@2 T@U) (_module.Co$T@@8 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (_module.Co.Co_q d@@2) ($IsAlloc DatatypeTypeType d@@2 (Tclass._module.Co _module.Co$T@@8) $h@@7))) ($IsAllocBox (_module.Co.z d@@2) _module.Co$T@@8 $h@@7))
 :qid |unknown.0:0|
 :skolemid |552|
 :pattern ( ($IsAllocBox (_module.Co.z d@@2) _module.Co$T@@8 $h@@7))
)))
...
(assert (forall ((_module.Co$T@@9 T@U) (bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 (Tclass._module.Co _module.Co$T@@9)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@8)) bx@@8) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@8) (Tclass._module.Co _module.Co$T@@9))))
 :qid |unknown.0:0|
 :skolemid |486|
 :pattern ( ($IsBox bx@@8 (Tclass._module.Co _module.Co$T@@9)))
)))
...
(declare-fun |b#0| () T@U)
(declare-fun |s#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.Covariant)
...
)) ($HeapSucc $Heap $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (=> (and (= |a#0@0| (|#_module.Co.Co| ($Box refType call1formal@this@0))) (=> |defass#b#0| (and ($Is DatatypeTypeType |b#0@0| (Tclass._module.Co Tclass._module.X)) ($IsAlloc DatatypeTypeType |b#0@0| (Tclass._module.Co Tclass._module.X) $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (= (ControlFlow 0 2) (- 0 1)) true))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (=> |defass#i#0| (and ($Is refType |i#0| Tclass._module.Int) ($IsAlloc refType |i#0| Tclass._module.Int $Heap))) true)) (and (and (=> |defass#a#0| (and ($Is DatatypeTypeType |a#0| (Tclass._module.Co Tclass._module.Int)) ($IsAlloc DatatypeTypeType |a#0| (Tclass._module.Co Tclass._module.Int) $Heap))) true) (and (=> |defass#b#0| (and ($Is DatatypeTypeType |b#0| (Tclass._module.Co Tclass._module.X)) ($IsAlloc DatatypeTypeType |b#0| (Tclass._module.Co Tclass._module.X) $Heap))) true))) (and (and (and ($Is DatatypeTypeType |s#0| (Tclass._module.Co TBool)) ($IsAlloc DatatypeTypeType |s#0| (Tclass._module.Co TBool) $Heap)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 6) 2)))) anon0_correct)))
