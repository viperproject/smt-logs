...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.TestDivModInt8)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |newtype$check#0@0| (LitInt 0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= (LitInt (- 0 128)) |newtype$check#0@0|) (< |newtype$check#0@0| 128))) (=> (and (<= (LitInt (- 0 128)) |newtype$check#0@0|) (< |newtype$check#0@0| 128)) (=> (or (not (= |b#0| 0)) (not true)) (=> (and (= |newtype$check#1@0| (LitInt (- 0 127))) (= (ControlFlow 0 2) (- 0 1))) (and (<= (LitInt (- 0 128)) |newtype$check#1@0|) (< |newtype$check#1@0| 128)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (<= (LitInt (- 0 128)) |a#0|) (< |a#0| 128)) (and (<= (LitInt (- 0 128)) |b#0|) (< |b#0| 128))) (and (and ($Is SeqType |suffix#0| (TSeq TChar)) ($IsAlloc SeqType |suffix#0| (TSeq TChar) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct))))
