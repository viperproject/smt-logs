...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let (($generated@@155  (=> (and (= $generated@@150 ($generated@@108 $generated@@34 $generated@@151 $generated false)) (= (ControlFlow 0 2) (- 0 1))) true)))
(let (($generated@@156  (=> (and (and (and ($generated@@89 $generated@@151) ($generated@@152 $generated@@151)) (<= ($generated@@75 0) $generated@@153)) (and (= 0 $generated@@154) (= (ControlFlow 0 3) 2))) $generated@@155)))
$generated@@156)))
))
(check-sat)
(get-info :rlimit)
