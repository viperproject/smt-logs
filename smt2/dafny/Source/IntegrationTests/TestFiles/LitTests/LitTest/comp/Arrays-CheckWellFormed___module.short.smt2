...
(set-info :boogie-vc-id CheckWellFormed$$_module.short)
...
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt (- 0 10)) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (Lit boolType (bool_2_U (< 0 12000))))))))
