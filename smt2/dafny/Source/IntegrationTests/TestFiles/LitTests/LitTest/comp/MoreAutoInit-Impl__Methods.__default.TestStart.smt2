...
(declare-fun Tagclass.Methods.Uni () T@U)
(declare-fun |##Methods.Uni.Uni| () T@U)
...
(declare-fun Tclass.Methods.Uni () T@U)
...
(assert (distinct TInt TagInt TagSet TagSeq alloc Tagclass.Methods.Uni |##Methods.Uni.Uni| tytagFamily$Uni)
)
...
(assert (= (DatatypeCtorId |#Methods.Uni.Uni|) |##Methods.Uni.Uni|))
(assert (= (Ctor DatatypeTypeType) 3))
(assert ($Is DatatypeTypeType |#Methods.Uni.Uni| Tclass.Methods.Uni))
...
(assert (forall ((bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 Tclass.Methods.Uni) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@1)) bx@@1) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@1) Tclass.Methods.Uni)))
 :qid |unknown.0:0|
 :skolemid |661|
 :pattern ( ($IsBox bx@@1 Tclass.Methods.Uni))
)))
...
(assert (= (Tag Tclass.Methods.Uni) Tagclass.Methods.Uni))
(assert (= (TagFamily Tclass.Methods.Uni) tytagFamily$Uni))
(assert (= |#Methods.Uni.Uni| (Lit DatatypeTypeType |#Methods.Uni.Uni|)))
...
(set-info :boogie-vc-id Impl$$Methods.__default.TestStart)
