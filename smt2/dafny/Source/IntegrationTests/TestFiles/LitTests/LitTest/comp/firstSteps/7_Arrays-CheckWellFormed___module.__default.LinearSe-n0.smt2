...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.LinearSearch)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon7_Else_correct  (=> (or (not (= |n#0@0| (_System.array.Length |a#0|))) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (= (ControlFlow 0 4) (- 0 3)) (and (<= 0 |n#0@0|) (< |n#0@0| (_System.array.Length |a#0|)))))))))
(let ((anon7_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= |a#0| null)) (not true)))))
(let ((anon3_correct  (=> (and (<= (LitInt 0) |n#0@0|) (<= |n#0@0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 6) 2) anon7_Then_correct) (=> (= (ControlFlow 0 6) 4) anon7_Else_correct)))))
(let ((anon6_Else_correct  (=> (and (< |n#0@0| (LitInt 0)) (= (ControlFlow 0 9) 6)) anon3_correct)))
(let ((anon6_Then_correct  (=> (<= (LitInt 0) |n#0@0|) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (= (ControlFlow 0 7) 6) anon3_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6)))
 :qid |_7Arraysdfy.5:8|
 :skolemid |546|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6))
))) (and ($HeapSucc $Heap $Heap@0) (<= (LitInt 0) |n#0@0|))) (and (=> (= (ControlFlow 0 10) 7) anon6_Then_correct) (=> (= (ControlFlow 0 10) 9) anon6_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (<= (LitInt 0) |n#0|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct))))
