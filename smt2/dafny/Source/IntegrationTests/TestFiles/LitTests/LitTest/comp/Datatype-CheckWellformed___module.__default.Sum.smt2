...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly T@U) (|xs#0| T@U) ) (!  (=> (or (|_module.__default.Sum#canCall| |xs#0|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0| Tclass._module.List))) (and (=> (not (_module.List.Nil_q |xs#0|)) (let ((|tail#1| (_module.List.tail |xs#0|)))
(|_module.__default.Sum#canCall| |tail#1|))) (= (_module.__default.Sum ($LS $ly) |xs#0|) (ite (_module.List.Nil_q |xs#0|) 0 (let ((|tail#0| (_module.List.tail |xs#0|)))
(let ((|x#0| (_module.List.head |xs#0|)))
(+ |x#0| (_module.__default.Sum $ly |tail#0|))))))))
 :qid |Datatypedfy.50:10|
 :skolemid |1986|
 :pattern ( (_module.__default.Sum ($LS $ly) |xs#0|))
))))
...
(assert (forall (($ly@@0 T@U) (|xs#0@@0| T@U) ) (! (= (_module.__default.Sum ($LS $ly@@0) |xs#0@@0|) (_module.__default.Sum $ly@@0 |xs#0@@0|))
 :qid |Datatypedfy.50:10|
 :skolemid |1982|
 :pattern ( (_module.__default.Sum ($LS $ly@@0) |xs#0@@0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@1 T@U) (|xs#0@@1| T@U) ) (!  (=> (or (|_module.__default.Sum#canCall| (Lit DatatypeTypeType |xs#0@@1|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@1| Tclass._module.List))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@1|)))))) (let ((|tail#3| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@1|)))))
(|_module.__default.Sum#canCall| |tail#3|))) (= (_module.__default.Sum ($LS $ly@@1) (Lit DatatypeTypeType |xs#0@@1|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@1|)) 0 (let ((|tail#2| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |xs#0@@1|)))))
(let ((|x#2| (LitInt (_module.List.head (Lit DatatypeTypeType |xs#0@@1|)))))
(LitInt (+ |x#2| (_module.__default.Sum ($LS $ly@@1) |tail#2|)))))))))
 :qid |Datatypedfy.50:10|
 :weight 3
 :skolemid |1987|
 :pattern ( (_module.__default.Sum ($LS $ly@@1) (Lit DatatypeTypeType |xs#0@@1|)))
))))
...
(let ((anon10_Then_correct  (=> (and (= |xs#0@@2| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) ($Is DatatypeTypeType |_mcc#1#0| Tclass._module.List)) (=> (and (and (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| Tclass._module.List)) (and (= |tail#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|))) (and (and ($Is intType (int_2_U |let#1#0#0|) TInt) (= |x#Z#0@0| |let#1#0#0|)) (and ($IsAlloc DatatypeTypeType |tail#Z#0@0| Tclass._module.List $Heap) (= (ControlFlow 0 4) (- 0 3))))) (< (DtRank |tail#Z#0@0|) (DtRank |xs#0@@2|))))))
(let ((anon9_Else_correct  (=> (or (not (= |xs#0@@2| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 6) 4) anon10_Then_correct) (=> (= (ControlFlow 0 6) 5) anon10_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |xs#0@@2| Tclass._module.List)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct)))
