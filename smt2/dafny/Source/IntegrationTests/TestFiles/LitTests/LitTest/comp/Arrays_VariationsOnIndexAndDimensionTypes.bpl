...
procedure {:verboseName "VariationsOnIndexAndDimensionTypes.Test (correctness)"} Impl$$VariationsOnIndexAndDimensionTypes.__default.Test() returns ($_reverifyPost: bool);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "VariationsOnIndexAndDimensionTypes.Test (correctness)"} Impl$$VariationsOnIndexAndDimensionTypes.__default.Test() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;

    // AddMethodImpl: Test, Impl$$VariationsOnIndexAndDimensionTypes.__default.Test
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(798,14)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id827"} Call$$VariationsOnIndexAndDimensionTypes.__default.TestArray();
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(799,15)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id828"} Call$$VariationsOnIndexAndDimensionTypes.__default.TestMatrix();
    // TrCallStmt: After ProcessCallStmt
}



procedure {:verboseName "VariationsOnIndexAndDimensionTypes.TestArray (well-formedness)"} CheckWellFormed$$VariationsOnIndexAndDimensionTypes.__default.TestArray();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "VariationsOnIndexAndDimensionTypes.TestArray (call)"} Call$$VariationsOnIndexAndDimensionTypes.__default.TestArray();
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "VariationsOnIndexAndDimensionTypes.TestArray (correctness)"} Impl$$VariationsOnIndexAndDimensionTypes.__default.TestArray() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "VariationsOnIndexAndDimensionTypes.TestArray (correctness)"} Impl$$VariationsOnIndexAndDimensionTypes.__default.TestArray() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var aa#0: ref
     where $Is(aa#0, Tclass._System.array(Tclass.VariationsOnIndexAndDimensionTypes.byte()))
       && $IsAlloc(aa#0, 
        Tclass._System.array(Tclass.VariationsOnIndexAndDimensionTypes.byte()), 
        $Heap);
  ...
  var $nw: ref;
    ...
    // AddMethodImpl: TestArray, Impl$$VariationsOnIndexAndDimensionTypes.__default.TestArray
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    havoc aa#0 /* where $Is(aa#0, Tclass._System.array(Tclass.VariationsOnIndexAndDimensionTypes.byte()))
       && $IsAlloc(aa#0, 
        Tclass._System.array(Tclass.VariationsOnIndexAndDimensionTypes.byte()), 
        $Heap) */;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(804,8)
    assume true;
    assert {:id "id829"} 0 <= LitInt(3);
    ...
    if (*)
    {
        ...
        if (LitInt(0) <= i#0)
        {
            ...
            {
                newtype$check#0 := 20 + i#0;
                assert {:id "id830"} LitInt(0) <= newtype$check#0;
                newtype$check#1 := 20 + i#0;
                assert {:id "id831"} LitInt(0) <= newtype$check#1 && newtype$check#1 < 256;
                newtype$check#2 := 20 + i#0;
                assert {:id "id832"} LitInt(0) <= newtype$check#2 && newtype$check#2 < 256;
                assume {:id "id833"} lambdaResult#0 == 20 + i#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(lambdaResult#0, Tclass.VariationsOnIndexAndDimensionTypes.byte());
            }
            else
            {
                newtype$check#3 := LitInt(88);
                assert {:id "id834"} LitInt(0) <= newtype$check#3 && newtype$check#3 < 256;
                assume {:id "id835"} lambdaResult#0 == LitInt(88);
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(lambdaResult#0, Tclass.VariationsOnIndexAndDimensionTypes.byte());
            }
    ...
    havoc $nw;
    assume $nw != null
       && $Is($nw, Tclass._System.array?(Tclass.VariationsOnIndexAndDimensionTypes.byte()));
    assume !$Unbox(read($Heap, $nw, alloc)): bool;
    assume _System.array.Length($nw) == LitInt(3);
    assert {:id "id836"} {:subsumption 0} (forall arrayinit#0#i0#0: int :: 
      0 <= arrayinit#0#i0#0 && arrayinit#0#i0#0 < LitInt(3)
         ==> Requires1(Tclass._System.nat(), 
          Tclass.VariationsOnIndexAndDimensionTypes.byte(), 
          $Heap, 
...
procedure {:verboseName "VariationsOnIndexAndDimensionTypes.TestMatrix (well-formedness)"} CheckWellFormed$$VariationsOnIndexAndDimensionTypes.__default.TestMatrix();
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "VariationsOnIndexAndDimensionTypes.TestMatrix (call)"} Call$$VariationsOnIndexAndDimensionTypes.__default.TestMatrix();
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "VariationsOnIndexAndDimensionTypes.TestMatrix (correctness)"} Impl$$VariationsOnIndexAndDimensionTypes.__default.TestMatrix() returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
function VariationsOnIndexAndDimensionTypes.__default.F#Handle() : HandleType;
...
axiom {:id "id881"} 1 <= $FunctionContextHeight
   ==> (forall a#0: int, b#0: int, c#0: int :: 
    { VariationsOnIndexAndDimensionTypes.__default.F(a#0, b#0, c#0) } 
    VariationsOnIndexAndDimensionTypes.__default.F#canCall(a#0, b#0, c#0)
         || (1 < $FunctionContextHeight
...
axiom {:id "id882"} 1 <= $FunctionContextHeight
   ==> (forall a#0: int, b#0: int, c#0: int :: 
...
axiom (forall $heap: Heap, $fh$0x#0: Box, $fh$0x#1: Box, $fh$0x#2: Box :: 
  { Apply3(Tclass._System.nat(), 
      Tclass._System.nat(), 
      Tclass._System.nat(), 
      Tclass.VariationsOnIndexAndDimensionTypes.byte(), 
      $heap, 
      VariationsOnIndexAndDimensionTypes.__default.F#Handle(), 
      $fh$0x#0, 
      $fh$0x#1, 
      $fh$0x#2) } 
  Apply3(Tclass._System.nat(), 
      ...
      $fh$0x#1, 
      $fh$0x#2)
     == $Box(VariationsOnIndexAndDimensionTypes.__default.F($Unbox($fh$0x#0): int, $Unbox($fh$0x#1): int, $Unbox($fh$0x#2): int)));
...
axiom (forall $heap: Heap, $fh$0x#0: Box, $fh$0x#1: Box, $fh$0x#2: Box :: 
  ...
  Requires3(Tclass._System.nat(), 
      ...
      $fh$0x#1, 
      $fh$0x#2)
     == VariationsOnIndexAndDimensionTypes.__default.F#requires($Unbox($fh$0x#0): int, $Unbox($fh$0x#1): int, $Unbox($fh$0x#2): int));

axiom (forall $bx: Box, $heap: Heap, $fh$0x#0: Box, $fh$0x#1: Box, $fh$0x#2: Box :: 
  { Set#IsMember(Reads3(Tclass._System.nat(), 
        Tclass._System.nat(), 
        Tclass._System.nat(), 
        Tclass.VariationsOnIndexAndDimensionTypes.byte(), 
        $heap, 
...
axiom (forall $heap: Heap, $fh$0x#0: int, $fh$0x#1: int, $fh$0x#2: int :: 
  { VariationsOnIndexAndDimensionTypes.__default.F($fh$0x#0, $fh$0x#1, $fh$0x#2), $IsGoodHeap($heap) } 
  VariationsOnIndexAndDimensionTypes.__default.F($fh$0x#0, $fh$0x#1, $fh$0x#2)
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "VariationsOnIndexAndDimensionTypes.TestMatrix (correctness)"} Impl$$VariationsOnIndexAndDimensionTypes.__default.TestMatrix() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var a#0: int where LitInt(0) <= a#0 && a#0 < 256;
  var b#0: int;
  var c#0: int where -9223372036854775808 < c#0 && c#0 < 9223372036854775808;
  var $rhs#0: int;
  var newtype$check#0: int;
  var newtype$check#1: int;
  var $rhs#1: int;
  ...
  var newtype$check#3: int;
  var m#0: ref
     where $Is(m#0, Tclass._System.array3(Tclass.VariationsOnIndexAndDimensionTypes.byte()))
       && $IsAlloc(m#0, 
        Tclass._System.array3(Tclass.VariationsOnIndexAndDimensionTypes.byte()), 
        $Heap);
  var $nw: ref;
  ...
  var newtype$check#18: int;
    ...
    // AddMethodImpl: TestMatrix, Impl$$VariationsOnIndexAndDimensionTypes.__default.TestMatrix
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(808,17)
    assume true;
    assume true;
    assume true;
    newtype$check#0 := LitInt(3);
    assert {:id "id838"} LitInt(0) <= newtype$check#0 && newtype$check#0 < 256;
    newtype$check#1 := LitInt(3);
    assert {:id "id839"} LitInt(0) <= newtype$check#1 && newtype$check#1 < 256;
    assume true;
    $rhs#0 := LitInt(3);
    assume true;
    $rhs#1 := LitInt(2);
    newtype$check#2 := LitInt(5);
    assert {:id "id842"} -9223372036854775808 < newtype$check#2 && newtype$check#2 < 9223372036854775808;
    newtype$check#3 := LitInt(5);
    assert {:id "id843"} -9223372036854775808 < newtype$check#3 && newtype$check#3 < 9223372036854775808;
    assume true;
    $rhs#2 := LitInt(5);
    a#0 := $rhs#0;
    b#0 := $rhs#1;
    c#0 := $rhs#2;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(809,11)
    assume true;
    assert {:id "id848"} 0 <= a#0;
    assert {:id "id849"} 0 <= b#0;
    assert {:id "id850"} 0 <= c#0;
    assert {:id "id851"} 1 != $FunctionContextHeight;
    havoc $nw;
    assume $nw != null
       && $Is($nw, Tclass._System.array3?(Tclass.VariationsOnIndexAndDimensionTypes.byte()));
    assume !$Unbox(read($Heap, $nw, alloc)): bool;
    assume _System.array3.Length0($nw) == a#0;
    assume _System.array3.Length1($nw) == b#0;
    assume _System.array3.Length2($nw) == c#0;
    assert {:id "id852"} {:subsumption 0} (forall arrayinit#0#i0#0: int, arrayinit#0#i1#0: int, arrayinit#0#i2#0: int :: 
      0 <= arrayinit#0#i0#0
           && arrayinit#0#i0#0 < a#0
           && 
          0 <= arrayinit#0#i1#0
           && arrayinit#0#i1#0 < b#0
           && 
          0 <= arrayinit#0#i2#0
           && arrayinit#0#i2#0 < c#0
         ==> Requires3(Tclass._System.nat(), 
          Tclass._System.nat(), 
          Tclass._System.nat(), 
          Tclass.VariationsOnIndexAndDimensionTypes.byte(), 
    ...
    assume $IsHeapAnchor($Heap);
    m#0 := $nw;
    // ----- expect statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Arrays.dfy(810,5)
    assert {:id "id854"} m#0 != null;
    newtype$check#4 := LitInt(0);
    assert {:id "id855"} LitInt(0) <= newtype$check#4 && newtype$check#4 < 256;
    newtype$check#5 := LitInt(0);
    assert {:id "id856"} LitInt(0) <= newtype$check#5 && newtype$check#5 < 256;
    assert {:id "id857"} {:subsumption 0} 0 <= LitInt(0) && LitInt(0) < _System.array3.Length0(m#0);
    assert {:id "id858"} {:subsumption 0} 0 <= LitInt(1) && LitInt(1) < _System.array3.Length1(m#0);
    newtype$check#6 := LitInt(2);
    assert {:id "id859"} -9223372036854775808 < newtype$check#6 && newtype$check#6 < 9223372036854775808;
    newtype$check#7 := LitInt(2);
    assert {:id "id860"} -9223372036854775808 < newtype$check#7 && newtype$check#7 < 9223372036854775808;
    assert {:id "id861"} {:subsumption 0} 0 <= LitInt(2) && LitInt(2) < _System.array3.Length2(m#0);
    assert {:id "id862"} m#0 != null;
    newtype$check#8 := LitInt(1);
    assert {:id "id863"} -9223372036854775808 < newtype$check#8 && newtype$check#8 < 9223372036854775808;
    newtype$check#9 := LitInt(1);
    assert {:id "id864"} -9223372036854775808 < newtype$check#9 && newtype$check#9 < 9223372036854775808;
    assert {:id "id865"} {:subsumption 0} 0 <= LitInt(1) && LitInt(1) < _System.array3.Length0(m#0);
    newtype$check#10 := LitInt(1);
    assert {:id "id866"} LitInt(0) <= newtype$check#10 && newtype$check#10 < 256;
    newtype$check#11 := LitInt(1);
    assert {:id "id867"} LitInt(0) <= newtype$check#11 && newtype$check#11 < 256;
    assert {:id "id868"} {:subsumption 0} 0 <= LitInt(1) && LitInt(1) < _System.array3.Length1(m#0);
    assert {:id "id869"} {:subsumption 0} 0 <= LitInt(2) && LitInt(2) < _System.array3.Length2(m#0);
    newtype$check#12 := $Unbox(read($Heap, 
          m#0, 
          MultiIndexField(MultiIndexField(IndexField(LitInt(0)), LitInt(1)), LitInt(2)))): int
       + $Unbox(read($Heap, 
          m#0, 
          MultiIndexField(MultiIndexField(IndexField(LitInt(1)), LitInt(1)), LitInt(2)))): int;
    assert {:id "id870"} LitInt(0) <= newtype$check#12 && newtype$check#12 < 256;
    assert {:id "id871"} m#0 != null;
    assert {:id "id872"} {:subsumption 0} 0 <= LitInt(2) && LitInt(2) < _System.array3.Length0(m#0);
    newtype$check#13 := LitInt(1);
    assert {:id "id873"} -9223372036854775808 < newtype$check#13
       && newtype$check#13 < 9223372036854775808;
    newtype$check#14 := LitInt(1);
    assert {:id "id874"} -9223372036854775808 < newtype$check#14
       && newtype$check#14 < 9223372036854775808;
    assert {:id "id875"} {:subsumption 0} 0 <= LitInt(1) && LitInt(1) < _System.array3.Length1(m#0);
    newtype$check#15 := LitInt(2);
    assert {:id "id876"} LitInt(0) <= newtype$check#15 && newtype$check#15 < 256;
    newtype$check#16 := LitInt(2);
    assert {:id "id877"} LitInt(0) <= newtype$check#16 && newtype$check#16 < 256;
    assert {:id "id878"} {:subsumption 0} 0 <= LitInt(2) && LitInt(2) < _System.array3.Length2(m#0);
    newtype$check#17 := $Unbox(read($Heap, 
          m#0, 
          MultiIndexField(MultiIndexField(IndexField(LitInt(0)), LitInt(1)), LitInt(2)))): int
       + $Unbox(read($Heap, 
          m#0, 
       ...
       + $Unbox(read($Heap, 
          m#0, 
          MultiIndexField(MultiIndexField(IndexField(LitInt(2)), LitInt(1)), LitInt(2)))): int;
    assert {:id "id879"} LitInt(0) <= newtype$check#17 && newtype$check#17 < 256;
    newtype$check#18 := LitInt(138);
    assert {:id "id880"} LitInt(0) <= newtype$check#18 && newtype$check#18 < 256;
    assume true;
    if ($Unbox(read($Heap, 
            m#0, 
            MultiIndexField(MultiIndexField(IndexField(LitInt(0)), LitInt(1)), LitInt(2)))): int
...
procedure {:verboseName "VariationsOnIndexAndDimensionTypes.F (well-formedness)"} CheckWellformed$$VariationsOnIndexAndDimensionTypes.__default.F(a#0: int where LitInt(0) <= a#0, 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "VariationsOnIndexAndDimensionTypes.F (well-formedness)"} CheckWellformed$$VariationsOnIndexAndDimensionTypes.__default.F(a#0: int, b#0: int, c#0: int)
{
  ...
  var newtype$check#2: int;
    ...
    if (*)
    {
        ...
        assume LitInt(0) <= VariationsOnIndexAndDimensionTypes.__default.F(a#0, b#0, c#0)
           && VariationsOnIndexAndDimensionTypes.__default.F(a#0, b#0, c#0) < 256;
        assume false;
    }
    else
    {
        ...
        if (a#0 == LitInt(0))
        {
            newtype$check#0 := LitInt(45);
            assert {:id "id883"} LitInt(0) <= newtype$check#0 && newtype$check#0 < 256;
            assume {:id "id884"} VariationsOnIndexAndDimensionTypes.__default.F(a#0, b#0, c#0) == LitInt(45);
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(VariationsOnIndexAndDimensionTypes.__default.F(a#0, b#0, c#0), 
              Tclass.VariationsOnIndexAndDimensionTypes.byte());
            return;
        }
        else
        {
            if (a#0 == LitInt(1))
            {
                newtype$check#1 := LitInt(46);
                assert {:id "id885"} LitInt(0) <= newtype$check#1 && newtype$check#1 < 256;
                assume {:id "id886"} VariationsOnIndexAndDimensionTypes.__default.F(a#0, b#0, c#0) == LitInt(46);
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(VariationsOnIndexAndDimensionTypes.__default.F(a#0, b#0, c#0), 
                  Tclass.VariationsOnIndexAndDimensionTypes.byte());
            ...
            {
                newtype$check#2 := LitInt(47);
                assert {:id "id887"} LitInt(0) <= newtype$check#2 && newtype$check#2 < 256;
                assume {:id "id888"} VariationsOnIndexAndDimensionTypes.__default.F(a#0, b#0, c#0) == LitInt(47);
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(VariationsOnIndexAndDimensionTypes.__default.F(a#0, b#0, c#0), 
                  Tclass.VariationsOnIndexAndDimensionTypes.byte());
...
procedure {:verboseName "VariationsOnIndexAndDimensionTypes.byte (well-formedness)"} CheckWellFormed$$VariationsOnIndexAndDimensionTypes.byte(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "VariationsOnIndexAndDimensionTypes.byte (well-formedness)"} CheckWellFormed$$VariationsOnIndexAndDimensionTypes.byte(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assume {:id "id889"} LitInt(0) <= x#0 && x#0 < 256;
        assume false;
    }
    ...
    if (*)
    {
        ...
        assume true;
        assert {:id "id890"} {:subsumption 0} LitInt(0) <= LitInt(0);
        assert {:id "id891"} {:subsumption 0} Lit(0 < 256);
        assume false;
    }
}
...
procedure {:verboseName "VariationsOnIndexAndDimensionTypes.onebyte (well-formedness)"} CheckWellFormed$$VariationsOnIndexAndDimensionTypes.onebyte(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "VariationsOnIndexAndDimensionTypes.onebyte (well-formedness)"} CheckWellFormed$$VariationsOnIndexAndDimensionTypes.onebyte(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        // check well-formedness of newtype witness, and that it satisfies the constraint
        assume true;
        assert {:id "id893"} {:subsumption 0} Lit(0 < 1);
        assert {:id "id894"} {:subsumption 0} Lit(1 < 256);
        assume false;
    }
}
...
procedure {:verboseName "VariationsOnIndexAndDimensionTypes.Long (well-formedness)"} CheckWellFormed$$VariationsOnIndexAndDimensionTypes.Long(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "VariationsOnIndexAndDimensionTypes.Long (well-formedness)"} CheckWellFormed$$VariationsOnIndexAndDimensionTypes.Long(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;


    // AddWellformednessCheck for newtype Long
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    if (*)
    {
        ...
        assume {:id "id895"} -9223372036854775808 < x#0 && x#0 < 9223372036854775808;
        assume false;
    }
    ...
    if (*)
    {
        // check well-formedness of newtype witness, and that it satisfies the constraint
        assume true;
        assert {:id "id896"} {:subsumption 0} Lit(-9223372036854775808 < 0);
        assert {:id "id897"} {:subsumption 0} Lit(0 < 9223372036854775808);
        assume false;
    }
}
