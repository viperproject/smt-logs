...
axiom (forall a#56#0#0: int :: 
  { #ModuleX.OptionInt.Some(a#56#0#0) } 
  DatatypeCtorId(#ModuleX.OptionInt.Some(a#56#0#0)) == ##ModuleX.OptionInt.Some);
}
...
axiom (forall d: DatatypeType :: 
  { ModuleX.OptionInt.Some_q(d) } 
  ModuleX.OptionInt.Some_q(d)
     ==> (exists a#57#0#0: int :: d == #ModuleX.OptionInt.Some(a#57#0#0)));
...
axiom (forall a#58#0#0: int :: 
  { $Is(#ModuleX.OptionInt.Some(a#58#0#0), Tclass.ModuleX.OptionInt()) } 
  $Is(#ModuleX.OptionInt.Some(a#58#0#0), Tclass.ModuleX.OptionInt())
     <==> $Is(a#58#0#0, TInt));
...
axiom (forall a#59#0#0: int :: 
  { #ModuleX.OptionInt.Some(LitInt(a#59#0#0)) } 
  #ModuleX.OptionInt.Some(LitInt(a#59#0#0))
     == Lit(#ModuleX.OptionInt.Some(a#59#0#0)));

function ModuleX.OptionInt._h3(DatatypeType) : int;

// Constructor injectivity
axiom (forall a#60#0#0: int :: 
  { #ModuleX.OptionInt.Some(a#60#0#0) } 
  ModuleX.OptionInt._h3(#ModuleX.OptionInt.Some(a#60#0#0)) == a#60#0#0);
