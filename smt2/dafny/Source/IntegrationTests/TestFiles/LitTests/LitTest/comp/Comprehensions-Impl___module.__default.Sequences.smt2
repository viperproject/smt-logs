...
(declare-fun |lambda#23| (Bool) T@U)
...
(assert (forall ((|l#0| T@U) (|$l#1#heap#0| T@U) (|$l#1#_v0#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#22| |l#0|) |$l#1#heap#0| |$l#1#_v0#0|)) ($IsBox |$l#1#_v0#0| |l#0|))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |3342|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#22| |l#0|) |$l#1#heap#0| |$l#1#_v0#0|))
)))
...
(assert (forall ((|$l#4#heap#0| T@U) (|$l#4#i#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#31| |$l#4#heap#0| |$l#4#i#0|) ($Box intType (int_2_U (Mul (U_2_int ($Unbox intType |$l#4#i#0|)) (U_2_int ($Unbox intType |$l#4#i#0|))))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |3346|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#31| |$l#4#heap#0| |$l#4#i#0|))
)))
(assert (forall ((|l#0@@0| Bool) (|$l#1#o#0| T@U) ) (! (= (U_2_bool (MapType1Select refType boolType (|lambda#23| |l#0@@0|) |$l#1#o#0|)) |l#0@@0|)
 :qid |unknown.0:0|
 :skolemid |3343|
 :pattern ( (MapType1Select refType boolType (|lambda#23| |l#0@@0|) |$l#1#o#0|))
)))
(assert (forall ((|l#0@@1| T@U) (|$l#1#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#25| |l#0@@1|) |$l#1#ly#0|) |l#0@@1|)
 :qid |Comprehensionsdfy.241:27|
 :skolemid |3345|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#25| |l#0@@1|) |$l#1#ly#0|))
)))
...
(assert (forall ((|$l#7#heap#0| T@U) (|$l#7#i#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#41| |$l#7#heap#0| |$l#7#i#0|) ($Box intType ($Unbox intType |$l#7#i#0|)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |3347|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#41| |$l#7#heap#0| |$l#7#i#0|))
)))
...
(assert (forall ((|l#0@@3| T@U) (|$l#1#heap#0@@0| T@U) (|$l#1#_v0#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#21| |l#0@@3|) |$l#1#heap#0@@0| |$l#1#_v0#0@@0|) |l#0@@3|)
 :qid |unknown.0:0|
 :skolemid |3341|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#21| |l#0@@3|) |$l#1#heap#0@@0| |$l#1#_v0#0@@0|))
)))
(assert (forall ((|l#0@@4| T@U) (|$l#1#heap#0@@1| T@U) (|$l#1#_v0#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#24| |l#0@@4|) |$l#1#heap#0@@1| |$l#1#_v0#0@@1|) |l#0@@4|)
 :qid |Comprehensionsdfy.241:27|
 :skolemid |3344|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#24| |l#0@@4|) |$l#1#heap#0@@1| |$l#1#_v0#0@@1|))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon14_Else_correct true))
(let ((anon14_Then_correct true))
(let ((anon13_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 21) 19) anon14_Then_correct) (=> (= (ControlFlow 0 21) 20) anon14_Else_correct)))))
(let ((anon16_Else_correct true))
(let ((anon16_Then_correct true))
(let ((anon15_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#1@0|) (or (= $Heap |$lambdaHeap#1@0|) ($HeapSucc $Heap |$lambdaHeap#1@0|))) (and (=> (= (ControlFlow 0 14) 12) anon16_Then_correct) (=> (= (ControlFlow 0 14) 13) anon16_Else_correct)))))
(let ((anon18_Else_correct true))
(let ((anon18_Then_correct true))
(let ((anon17_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#2@0|) (or (= $Heap |$lambdaHeap#2@0|) ($HeapSucc $Heap |$lambdaHeap#2@0|))) (and (=> (= (ControlFlow 0 5) 3) anon18_Then_correct) (=> (= (ControlFlow 0 5) 4) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|seqinit#2#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#2#i0#0|) (< |seqinit#2#i0#0| (LitInt 8))) (Requires1 TInt TInt $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#25| (Handle1 |lambda#41| (|lambda#22| TInt) (|lambda#24| (SetRef_to_SetBox (|lambda#23| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#2#i0#0|))))
 :qid |Comprehensionsdfy.248:15|
 :skolemid |3123|
)))))
(let ((anon15_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 11)) (forall ((|seqinit#1#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#1#i0#0|) (< |seqinit#1#i0#0| (LitInt 8))) (Requires1 TInt TInt $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#25| (Handle1 |lambda#31| (|lambda#22| TInt) (|lambda#24| (SetRef_to_SetBox (|lambda#23| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#1#i0#0|))))
 :qid |Comprehensionsdfy.244:18|
 :skolemid |3122|
))) (=> (= |squares#0@0| (|Seq#Create| TInt $Heap (LitInt 8) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#25| (Handle1 |lambda#31| (|lambda#22| TInt) (|lambda#24| (SetRef_to_SetBox (|lambda#23| false))))) ($LS $LZ))))) (and (=> (= (ControlFlow 0 6) (- 0 10)) (= (|Seq#Length| |squares#0@0|) (LitInt 8))) (=> (= (|Seq#Length| |squares#0@0|) (LitInt 8)) (and (=> (= (ControlFlow 0 6) (- 0 9)) (and (<= 0 (LitInt 6)) (< (LitInt 6) (|Seq#Length| |squares#0@0|)))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (= (U_2_int ($Unbox intType (|Seq#Index| |squares#0@0| (LitInt 6)))) (LitInt 36))) (=> (= (U_2_int ($Unbox intType (|Seq#Index| |squares#0@0| (LitInt 6)))) (LitInt 36)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= 0 (LitInt 8))) (=> (<= 0 (LitInt 8)) (and (=> (= (ControlFlow 0 6) 5) anon17_Then_correct) (=> (= (ControlFlow 0 6) 2) anon17_Else_correct)))))))))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 18)) (forall ((|seqinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| (LitInt 12))) (Requires1 TInt TInt $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#25| (Handle1 (|lambda#21| ($Box intType (int_2_U (LitInt 1)))) (|lambda#22| TInt) (|lambda#24| (SetRef_to_SetBox (|lambda#23| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0|))))
 :qid |Comprehensionsdfy.241:19|
 :skolemid |3121|
))) (=> (= |twelve1s#0@0| (|Seq#Create| TInt $Heap (LitInt 12) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#25| (Handle1 (|lambda#21| ($Box intType (int_2_U (LitInt 1)))) (|lambda#22| TInt) (|lambda#24| (SetRef_to_SetBox (|lambda#23| false))))) ($LS $LZ))))) (and (=> (= (ControlFlow 0 15) (- 0 17)) (|Seq#Equal| |twelve1s#0@0| (|Seq#Append| (|Seq#Append| |four1s#0@0| |four1s#0@0|) |four1s#0@0|))) (=> (|Seq#Equal| |twelve1s#0@0| (|Seq#Append| (|Seq#Append| |four1s#0@0| |four1s#0@0|) |four1s#0@0|)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= 0 (LitInt 8))) (=> (<= 0 (LitInt 8)) (and (=> (= (ControlFlow 0 15) 14) anon15_Then_correct) (=> (= (ControlFlow 0 15) 6) anon15_Else_correct))))))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |four1s#0@0| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 1))))))) (and (=> (= (ControlFlow 0 22) (- 0 23)) (<= 0 (LitInt 12))) (=> (<= 0 (LitInt 12)) (and (=> (= (ControlFlow 0 22) 21) anon13_Then_correct) (=> (= (ControlFlow 0 22) 15) anon13_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |four1s#0| (TSeq TInt)) ($IsAlloc SeqType |four1s#0| (TSeq TInt) $Heap)) true) (=> (and (and (and (and ($Is SeqType |twelve1s#0| (TSeq TInt)) ($IsAlloc SeqType |twelve1s#0| (TSeq TInt) $Heap)) true) (and (and ($Is SeqType |squares#0| (TSeq TInt)) ($IsAlloc SeqType |squares#0| (TSeq TInt) $Heap)) true)) (and (and (and ($Is SeqType |nats#0| (TSeq TInt)) ($IsAlloc SeqType |nats#0| (TSeq TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 24) 22)))) anon0_correct)))))
