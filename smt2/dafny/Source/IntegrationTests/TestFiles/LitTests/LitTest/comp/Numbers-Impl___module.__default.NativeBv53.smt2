...
(declare-fun $generated@@89 () (_ BitVec 53))
(declare-fun $generated@@90 (T@U) (_ BitVec 53))
(declare-fun $generated@@91 () T@T)
(declare-fun $generated@@92 ((_ BitVec 53)) T@U)
(declare-fun $generated@@93 () (_ BitVec 53))
(declare-fun $generated@@94 () (_ BitVec 53))
(declare-fun $generated@@95 () (_ BitVec 53))
(declare-fun $generated@@96 () (_ BitVec 53))
(declare-fun $generated@@97 () (_ BitVec 53))
(declare-fun $generated@@98 (T@U) Bool)
(declare-fun $generated@@99 (T@U) Bool)
(declare-fun $generated@@100 () Int)
(assert  (and (and (= ($generated@@0 $generated@@91) 7) (forall (($generated@@101 (_ BitVec 53)) ) (! (= ($generated@@90 ($generated@@92 $generated@@101)) $generated@@101)
 :pattern ( ($generated@@92 $generated@@101))
))) (forall (($generated@@102 T@U) ) (! (= ($generated@@92 ($generated@@90 $generated@@102)) $generated@@102)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let (($generated@@103  (=> (and (and (= $generated@@85 ($generated@@27 $generated@@86 $generated@@87 $generated@@88 false)) (= $generated@@89 ($generated@@90 ($generated $generated@@91 ($generated@@92 #b00000000000000000000000000000000000000000000000000000))))) (and (= $generated@@93 ($generated@@90 ($generated $generated@@91 ($generated@@92 #b00000000000000000000000000000000000000000000000001111)))) (= $generated@@94 (bvadd (bvsub (bvadd (bvadd $generated@@89 $generated@@93) $generated@@93) $generated@@89) #b00000000000000000000000000000000000000000000000000001)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= $generated@@93 #b00000000000000000000000000000000000000000000000000000)) (not true))) (=> (or (not (= $generated@@93 #b00000000000000000000000000000000000000000000000000000)) (not true)) (=> (and (and (= $generated@@95 (bvudiv $generated@@94 $generated@@93)) (= $generated@@96 (bvsub $generated@@94 $generated@@95))) (and (= $generated@@97 ($generated@@90 ($generated $generated@@91 ($generated@@92 #b00000000000000000000000000000000000000000000000010001)))) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= ($generated@@90 ($generated $generated@@91 ($generated@@92 #b00000000000000000000000000000000000000000000000000011))) #b00000000000000000000000000000000000000000000000000000)) (not true))))))))
(let (($generated@@104  (=> (and (and ($generated@@98 $generated@@87) ($generated@@99 $generated@@87)) (and (= 0 $generated@@100) (= (ControlFlow 0 4) 2))) $generated@@103)))
$generated@@104)))
))
(check-sat)
(get-info :rlimit)
