...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|x#0| Int) ) (!  (=> (or (|_module.uint32WithMethods.ctor#canCall| |x#0|) (< 2 $FunctionContextHeight)) (and (<= (LitInt 0) (_module.uint32WithMethods.ctor |x#0|)) (< (_module.uint32WithMethods.ctor |x#0|) 4294967296)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.uint32WithMethods.ctor)
...
(let ((anon11_Then_correct  (=> (and (<= (LitInt 0) |x#0@@3|) (< |x#0@@3| 4294967296)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= (LitInt 0) |x#0@@3|) (< |x#0@@3| 4294967296))) (=> (and (<= (LitInt 0) |x#0@@3|) (< |x#0@@3| 4294967296)) (=> (= (ControlFlow 0 3) (- 0 2)) (and (<= (LitInt 0) |x#0@@3|) (< |x#0@@3| 4294967296))))))))
(let ((anon10_Else_correct  (=> (< |x#0@@3| (LitInt 0)) (and (=> (= (ControlFlow 0 7) 3) anon11_Then_correct) (=> (= (ControlFlow 0 7) 5) anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (<= (LitInt 0) |x#0@@3|) (and (=> (= (ControlFlow 0 6) 3) anon11_Then_correct) (=> (= (ControlFlow 0 6) 5) anon11_Else_correct)))))
