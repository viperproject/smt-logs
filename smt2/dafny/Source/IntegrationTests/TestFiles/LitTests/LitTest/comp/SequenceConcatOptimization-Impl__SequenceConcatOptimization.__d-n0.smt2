...
(set-info :boogie-vc-id Impl$$SequenceConcatOptimization.__default.SirConcatsALot)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 25) (let ((anon23_Else_correct true))
(let ((anon23_Then_correct true))
(let ((anon21_Then_correct  (=> (= |i#1@0| |n#0@0|) (and (=> (= (ControlFlow 0 13) 11) anon23_Then_correct) (=> (= (ControlFlow 0 13) 12) anon23_Else_correct)))))
(let ((anon22_Else_correct true))
(let ((anon22_Then_correct true))
(let ((anon21_Else_correct  (=> (or (not (= |i#1@0| |n#0@0|)) (not true)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (and (<= 0 |i#1@0|) (< |i#1@0| (|Seq#Length| |s#0@1|)))) (and (=> (= (ControlFlow 0 9) 7) anon22_Then_correct) (=> (= (ControlFlow 0 9) 8) anon22_Else_correct))))))
(let ((anon20_Else_correct  (=> |$w$loop#1@0| (and (=> (= (ControlFlow 0 14) 13) anon21_Then_correct) (=> (= (ControlFlow 0 14) 9) anon21_Else_correct)))))
(let ((anon20_Then_correct true))
(let ((anon19_LoopBody_correct  (and (=> (= (ControlFlow 0 15) 6) anon20_Then_correct) (=> (= (ControlFlow 0 15) 14) anon20_Else_correct))))
(let ((anon19_LoopDone_correct true))
(let ((anon19_LoopHead_correct  (=> (and (and (and (and (and (and (and (and (and (not false) (= |n#0@0| 1000000)) (= |i#0@0| 1000000)) (= |i#0#lo@0| 0)) (= |n#0@0| 1000000)) |$w$loop#0@0|) (<= 0 |i#1@0|)) (= |i#1#lo@0| 0)) (= |n#0@0| 1000000)) (and (and (and (<= |i#1#lo@0| |i#1@0|) (<= |i#1@0| |n#0@0|)) (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |SequenceConcatOptimizationdfy.24:5|
 :skolemid |484|
...
))))) (and (=> (= (ControlFlow 0 16) 5) anon19_LoopDone_correct) (=> (= (ControlFlow 0 16) 15) anon19_LoopBody_correct)))))
(let ((anon18_Then_correct  (=> (and (= |i#0@0| |n#0@0|) (= |i#1#lo@0| (LitInt 0))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (<= |i#1#lo@0| |n#0@0|)) (=> (<= |i#1#lo@0| |n#0@0|) (=> (= (ControlFlow 0 17) 16) anon19_LoopHead_correct))))))
(let ((anon18_Else_correct  (=> (and (or (not (= |i#0@0| |n#0@0|)) (not true)) (= |s#0@2| (|Seq#Append| |s#0@1| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |i#0@0|)))))) (=> (and (and (= |i#0@1| (+ |i#0@0| 1)) (= (ControlFlow 0 4) (- 0 3))) |$w$loop#0@0|) (= (|Seq#Length| |s#0@2|) |i#0@1|)))))
(let ((anon17_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 19) 17) anon18_Then_correct) (=> (= (ControlFlow 0 19) 4) anon18_Else_correct)))))
...
(let ((anon16_LoopHead_correct  (=> (and ($Is SeqType |s#0@1| (TSeq TInt)) ($IsAlloc SeqType |s#0@1| (TSeq TInt) $Heap)) (=> (and (and (and (and (and (and (not false) (= |n#0@0| 1000000)) (<= 0 |i#0@0|)) (= |i#0#lo@0| 0)) (= |n#0@0| 1000000)) (and (<= |i#0#lo@0| |i#0@0|) (<= |i#0@0| |n#0@0|))) (and (and (=> |$w$loop#0@0| (= (|Seq#Length| |s#0@1|) |i#0@0|)) (forall (($o@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2)))
 :qid |SequenceConcatOptimizationdfy.18:5|
 :skolemid |482|
...
))))) (and (=> (= (ControlFlow 0 21) 1) anon16_LoopDone_correct) (=> (= (ControlFlow 0 21) 20) anon16_LoopBody_correct))))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |s#0@0| (Lit SeqType |Seq#Empty|))) (and (= |n#0@0| (LitInt 1000000)) (= |i#0#lo@0| (LitInt 0)))) (and (=> (= (ControlFlow 0 22) (- 0 24)) (<= |i#0#lo@0| |n#0@0|)) (=> (<= |i#0#lo@0| |n#0@0|) (and (=> (= (ControlFlow 0 22) (- 0 23)) (=> |$w$loop#0@0| (= (|Seq#Length| |s#0@0|) |i#0#lo@0|))) (=> (=> |$w$loop#0@0| (= (|Seq#Length| |s#0@0|) |i#0#lo@0|)) (=> (= (ControlFlow 0 22) 21) anon16_LoopHead_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SeqType |s#0| (TSeq TInt)) ($IsAlloc SeqType |s#0| (TSeq TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 25) 22))) anon0_correct))))
