...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#5| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) true)))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($IsBox |t#0| _module._default.Print$T) ($IsAllocBox |t#0| _module._default.Print$T $Heap)) (=> |defass#r#0| (and ($IsBox |r#0| _module._default.Print$T) ($IsAllocBox |r#0| _module._default.Print$T $Heap)))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
