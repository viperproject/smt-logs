...
(assert (distinct TInt TagInt TagSet alloc Tagclass._System.nat Tagclass._System.object? Tagclass._System.object Tagclass._System.array? Tagclass._System.array Tagclass._System.___hFunc1 Tagclass.VariationsOnIndexAndDimensionTypes.byte tytagFamily$nat tytagFamily$object tytagFamily$array |tytagFamily$_#Func1| tytagFamily$byte)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((|l#0| T@U) (|$l#0#heap#0| T@U) (|$l#0#i#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#3| |l#0|) |$l#0#heap#0| |$l#0#i#0|)) ($IsBox |$l#0#i#0| |l#0|))
 :qid |unknown.0:0|
 :skolemid |7807|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#3| |l#0|) |$l#0#heap#0| |$l#0#i#0|))
)))
...
(assert (forall ((bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 Tclass.VariationsOnIndexAndDimensionTypes.byte) (and (= ($Box intType ($Unbox intType bx@@8)) bx@@8) ($Is intType ($Unbox intType bx@@8) Tclass.VariationsOnIndexAndDimensionTypes.byte)))
 :qid |unknown.0:0|
 :skolemid |5268|
 :pattern ( ($IsBox bx@@8 Tclass.VariationsOnIndexAndDimensionTypes.byte))
)))
...
(assert (forall ((|l#0@@2| Int) (|l#1| Int) (|l#2| Int) (|l#3| Int) (|$l#0#heap#0@@0| T@U) (|$l#0#i#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#2| |l#0@@2| |l#1| |l#2| |l#3|) |$l#0#heap#0@@0| |$l#0#i#0@@0|) ($Box intType (int_2_U (ite  (and (<= |l#0@@2| (U_2_int ($Unbox intType |$l#0#i#0@@0|))) (< (U_2_int ($Unbox intType |$l#0#i#0@@0|)) |l#1|)) (+ |l#2| (U_2_int ($Unbox intType |$l#0#i#0@@0|))) |l#3|))))
 :qid |unknown.0:0|
 :skolemid |7806|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#2| |l#0@@2| |l#1| |l#2| |l#3|) |$l#0#heap#0@@0| |$l#0#i#0@@0|))
)))
...
(assert (forall ((|l#0@@4| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#i#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#5| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#i#0@@1|) |l#0@@4|)
 :qid |Arraysdfy.804:23|
 :skolemid |7809|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#5| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#i#0@@1|))
)))
...
(set-info :boogie-vc-id Impl$$VariationsOnIndexAndDimensionTypes.__default.TestArray)
...
(let ((anon12_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 10))) (= |newtype$check#3@0| (LitInt 88))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (and (<= (LitInt 0) |newtype$check#3@0|) (< |newtype$check#3@0| 256))) (=> (and (<= (LitInt 0) |newtype$check#3@0|) (< |newtype$check#3@0| 256)) (=> (= |lambdaResult#0| (LitInt 88)) (=> (and ($Is intType (int_2_U |lambdaResult#0|) Tclass.VariationsOnIndexAndDimensionTypes.byte) (= (ControlFlow 0 9) 3)) anon7_correct)))))))
(let ((anon12_Then_correct  (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 10)) (= |newtype$check#0@0| (+ 20 |i#0@0|))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (<= (LitInt 0) |newtype$check#0@0|)) (=> (<= (LitInt 0) |newtype$check#0@0|) (=> (= |newtype$check#1@0| (+ 20 |i#0@0|)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 256))) (=> (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 256)) (=> (= |newtype$check#2@0| (+ 20 |i#0@0|)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (and (<= (LitInt 0) |newtype$check#2@0|) (< |newtype$check#2@0| 256))) (=> (and (<= (LitInt 0) |newtype$check#2@0|) (< |newtype$check#2@0| 256)) (=> (= |lambdaResult#0| (+ 20 |i#0@0|)) (=> (and ($Is intType (int_2_U |lambdaResult#0|) Tclass.VariationsOnIndexAndDimensionTypes.byte) (= (ControlFlow 0 5) 3)) anon7_correct)))))))))))))
(let ((anon11_Else_correct  (=> (< |i#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 12) 5) anon12_Then_correct) (=> (= (ControlFlow 0 12) 9) anon12_Else_correct)))))
(let ((anon11_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 11) 5) anon12_Then_correct) (=> (= (ControlFlow 0 11) 9) anon12_Else_correct)))))
(let ((anon10_Then_correct  (=> (and (<= (LitInt 0) |i#0@0|) (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false))) (and (=> (= (ControlFlow 0 13) 11) anon11_Then_correct) (=> (= (ControlFlow 0 13) 12) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (< |i#0@0| (LitInt 0)) (= (ControlFlow 0 4) 3)) anon7_correct)))
(let ((anon9_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 14) 13) anon10_Then_correct) (=> (= (ControlFlow 0 14) 4) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? Tclass.VariationsOnIndexAndDimensionTypes.byte))) (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc))))) (and (= (_System.array.Length $nw@0) (LitInt 3)) (= (ControlFlow 0 2) (- 0 1)))) (forall ((|arrayinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0|) (< |arrayinit#0#i0#0| (LitInt 3))) (Requires1 Tclass._System.nat Tclass.VariationsOnIndexAndDimensionTypes.byte $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| (LitInt 0) 10 20 88) (|lambda#3| Tclass._System.nat) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0|))))
 :qid |Arraysdfy.804:11|
 :skolemid |5269|
)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and ($Is refType |aa#0@0| (Tclass._System.array Tclass.VariationsOnIndexAndDimensionTypes.byte)) ($IsAlloc refType |aa#0@0| (Tclass._System.array Tclass.VariationsOnIndexAndDimensionTypes.byte) $Heap)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= 0 (LitInt 3))) (=> (<= 0 (LitInt 3)) (and (=> (= (ControlFlow 0 15) 14) anon9_Then_correct) (=> (= (ControlFlow 0 15) 2) anon9_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |aa#0| (Tclass._System.array Tclass.VariationsOnIndexAndDimensionTypes.byte)) ($IsAlloc refType |aa#0| (Tclass._System.array Tclass.VariationsOnIndexAndDimensionTypes.byte) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 17) 15))) anon0_correct))))
