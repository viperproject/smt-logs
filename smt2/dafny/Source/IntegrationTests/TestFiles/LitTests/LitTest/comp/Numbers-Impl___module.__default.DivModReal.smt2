...
(declare-fun $generated@@84 () Real)
(declare-fun $generated@@85 () Real)
(declare-fun $generated@@86 () Real)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let (($generated@@90  (=> (= $generated@@80 ($generated@@24 $generated@@81 $generated@@82 $generated@@83 false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= $generated@@84 0.0)) (not true))) (=> (or (not (= $generated@@84 0.0)) (not true)) (=> (and (= $generated@@85 (/ $generated@@86 $generated@@84)) (= (ControlFlow 0 2) (- 0 1))) (= (* $generated@@85 $generated@@84) $generated@@86)))))))
(let (($generated@@91  (=> (and (and (and ($generated@@87 $generated@@82) ($generated@@88 $generated@@82)) (= 0 $generated@@89)) (and (or (not (= $generated@@84 0.0)) (not true)) (= (ControlFlow 0 4) 2))) $generated@@90)))
$generated@@91)))
))
(check-sat)
(get-info :rlimit)
