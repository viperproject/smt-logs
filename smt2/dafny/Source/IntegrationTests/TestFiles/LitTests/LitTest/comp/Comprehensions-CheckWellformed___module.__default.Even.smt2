...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|y#0| Int) ) (!  (=> (or (|_module.__default.Even#canCall| |y#0|) (< 0 $FunctionContextHeight)) (= (_module.__default.Even |y#0|) (= (Mod |y#0| (LitInt 2)) (LitInt 1))))
 :qid |Comprehensionsdfy.25:16|
 :skolemid |2914|
 :pattern ( (_module.__default.Even |y#0|))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|y#0@@0| Int) ) (!  (=> (or (|_module.__default.Even#canCall| (LitInt |y#0@@0|)) (< 0 $FunctionContextHeight)) (= (_module.__default.Even (LitInt |y#0@@0|)) (= (LitInt (Mod |y#0@@0| (LitInt 2))) (LitInt 1))))
 :qid |Comprehensionsdfy.25:16|
 :weight 3
 :skolemid |2915|
 :pattern ( (_module.__default.Even (LitInt |y#0@@0|)))
))))
