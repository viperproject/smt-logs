...
(let ((anon2_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (or (and ($Is refType null Tclass._module.Number) (> (|MultiSet#Multiplicity| |s#0| ($Box refType null)) 0)) (exists ((|$as#m0#0| T@U) )  (and ($Is refType |$as#m0#0| Tclass._module.Number) (> (|MultiSet#Multiplicity| |s#0| ($Box refType |$as#m0#0|)) 0))))) (=> (or (and ($Is refType null Tclass._module.Number) (> (|MultiSet#Multiplicity| |s#0| ($Box refType null)) 0)) (exists ((|$as#m0#0@@0| T@U) )  (and ($Is refType |$as#m0#0@@0| Tclass._module.Number) (> (|MultiSet#Multiplicity| |s#0| ($Box refType |$as#m0#0@@0|)) 0)))) (=> (and (=> true (and ($Is refType |m#0@0| Tclass._module.Number) ($IsAlloc refType |m#0@0| Tclass._module.Number $Heap))) (> (|MultiSet#Multiplicity| |s#0| ($Box refType |m#0@0|)) 0)) (and (=> (= (ControlFlow 0 19) 18) anon10_Then_correct) (=> (= (ControlFlow 0 19) 12) anon10_Else_correct)))))))
