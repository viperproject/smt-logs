...
(assert (forall ((a T@U) (b T@U) ) (! (= (|MultiSet#Card| (|MultiSet#Union| a b)) (+ (|MultiSet#Card| a) (|MultiSet#Card| b)))
...
(assert (forall ((a@@1 T@U) (b@@1 T@U) (o@@1 T@U) ) (! (= (|MultiSet#Multiplicity| (|MultiSet#Union| a@@1 b@@1) o@@1) (+ (|MultiSet#Multiplicity| a@@1 o@@1) (|MultiSet#Multiplicity| b@@1 o@@1)))
 :qid |DafnyPreludebpl.989:15|
 :skolemid |4674|
 :pattern ( (|MultiSet#Multiplicity| (|MultiSet#Union| a@@1 b@@1) o@@1))
)))
...
(declare-fun _module._default.ExplosiveUnion$T () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.ExplosiveUnion)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon13_Else_correct  (=> (and (and (< |n#0@1| |N#0|) (= |$decr$loop#00@1| (- |N#0| |n#0@1|))) (and (= |b#0@2| (|MultiSet#Union| |b#0@1| |b#0@1|)) (= |n#0@2| (+ |n#0@1| 1)))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (<= 0 |$decr$loop#00@1|) (= (- |N#0| |n#0@2|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- |N#0| |n#0@2|) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 6) (- 0 5)) (< (- |N#0| |n#0@2|) |$decr$loop#00@1|)))))))
(let ((anon13_Then_correct true))
(let ((anon12_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 8) 4) anon13_Then_correct) (=> (= (ControlFlow 0 8) 6) anon13_Else_correct)))))
(let ((anon12_Then_correct true))
(let ((anon11_LoopBody_correct  (and (=> (= (ControlFlow 0 9) 3) anon12_Then_correct) (=> (= (ControlFlow 0 9) 8) anon12_Else_correct))))
(let ((anon11_LoopDone_correct true))
(let ((anon11_LoopHead_correct  (=> (and (and (and ($Is MultiSetType |b#0@1| (TMultiSet _module._default.ExplosiveUnion$T)) ($IsAlloc MultiSetType |b#0@1| (TMultiSet _module._default.ExplosiveUnion$T) $Heap)) (and (not false) (<= 1 |n#0@1|))) (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |Collectionsdfy.515:3|
 :skolemid |5065|
...
)) (<= (- |N#0| |n#0@1|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 10) 2) anon11_LoopDone_correct) (=> (= (ControlFlow 0 10) 9) anon11_LoopBody_correct)))))
(let ((anon10_Else_correct  (=> (and (and (or (not (= |N#0| (LitInt 0))) (not true)) (= |n#0@0| (LitInt 1))) (and (= |$decr_init$loop#00@0| (- |N#0| |n#0@0|)) (= (ControlFlow 0 11) 10))) anon11_LoopHead_correct)))
(let ((anon10_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 12) 1) anon10_Then_correct) (=> (= (ControlFlow 0 12) 11) anon10_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MultiSetType |a#0| (TMultiSet _module._default.ExplosiveUnion$T)) ($IsAlloc MultiSetType |a#0| (TMultiSet _module._default.ExplosiveUnion$T) $Heap)) (<= (LitInt 0) |N#0|)) (and (and ($Is MultiSetType |b#0| (TMultiSet _module._default.ExplosiveUnion$T)) ($IsAlloc MultiSetType |b#0| (TMultiSet _module._default.ExplosiveUnion$T) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 13) 12)))) anon0_correct))))
