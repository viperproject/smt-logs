...
(declare-fun Dafny_mFileIO.__default.INTERNAL__ReadBytesFromFile (T@U) T@U)
(declare-fun |Dafny_mFileIO.__default.INTERNAL__ReadBytesFromFile#canCall| (T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|path#0| T@U) ) (!  (=> (or (|Dafny_mFileIO.__default.INTERNAL__ReadBytesFromFile#canCall| |path#0|) (and (< 0 $FunctionContextHeight) ($Is SeqType |path#0| (TSeq TChar)))) ($Is SeqType (Dafny_mFileIO.__default.INTERNAL__ReadBytesFromFile |path#0|) (TSeq TChar)))
 :qid |externalclassesdfy.42:30|
 :skolemid |2503|
 :pattern ( (Dafny_mFileIO.__default.INTERNAL__ReadBytesFromFile |path#0|))
))))
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(set-info :boogie-vc-id Impl$$Dafny_mFileIO.__default.ReadBytesFromFile)
