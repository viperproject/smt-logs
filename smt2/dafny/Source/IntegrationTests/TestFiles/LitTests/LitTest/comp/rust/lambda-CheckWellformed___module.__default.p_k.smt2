...
(assert (forall (($heap@@0 T@U) (|$fh$0x#0@@0| T@U) ) (! (= (_module.__default.p_k |$fh$0x#0@@0|) (U_2_bool ($Unbox boolType (Apply1 (TSeq TBool) TBool $heap@@0 |_module.__default.p_k#Handle| ($Box SeqType |$fh$0x#0@@0|)))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |561|
 :pattern ( (_module.__default.p_k |$fh$0x#0@@0|) ($IsGoodHeap $heap@@0))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.p_k)
...
(let ((anon8_Then_correct  (=> (and (> (|Seq#Length| |b#0@@1|) 0) (= (ControlFlow 0 3) (- 0 2))) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |b#0@@1|))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is SeqType |b#0@@1| (TSeq TBool))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 6) 5))) anon0_correct)))
