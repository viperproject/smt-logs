...
(assert (distinct TChar TagChar TagSeq alloc Tagclass._System.nat tytagFamily$nat)
)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon3_Else_correct  (=> (or (not (= |n#0| (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 7)) ($Is intType (int_2_U (- |n#0| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0| 1)) Tclass._System.nat) (=> (= |n##1_0@0| (- |n#0| 1)) (and (=> (= (ControlFlow 0 3) (- 0 6)) ($Is intType (int_2_U (+ |n#0| |acc#0|)) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ |n#0| |acc#0|)) Tclass._System.nat) (=> (and (= |acc##1_0@0| (+ |n#0| |acc#0|)) (= |prefix##1_0@0| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 32))) ($Box charType (|char#FromInt| 43))) ($Box charType (|char#FromInt| 32)))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (<= 0 |n#0|) (= |n##1_0@0| |n#0|))) (=> (or (<= 0 |n#0|) (= |n##1_0@0| |n#0|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (or (<= 0 |acc#0|) (< |n##1_0@0| |n#0|)) (= |acc##1_0@0| |acc#0|))) (=> (or (or (<= 0 |acc#0|) (< |n##1_0@0| |n#0|)) (= |acc##1_0@0| |acc#0|)) (=> (= (ControlFlow 0 3) (- 0 2)) (or (< |n##1_0@0| |n#0|) (and (= |n##1_0@0| |n#0|) (or (< |acc##1_0@0| |acc#0|) (and (= |acc##1_0@0| |acc#0|) (< (|Seq#Rank| |prefix##1_0@0|) (|Seq#Rank| |prefix#0|))))))))))))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 8) 1) anon3_Then_correct) (=> (= (ControlFlow 0 8) 3) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (<= (LitInt 0) |n#0|) (<= (LitInt 0) |acc#0|))) (=> (and (and (and ($Is SeqType |prefix#0| (TSeq TChar)) ($IsAlloc SeqType |prefix#0| (TSeq TChar) $Heap)) (<= (LitInt 0) |total#0|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct))))
