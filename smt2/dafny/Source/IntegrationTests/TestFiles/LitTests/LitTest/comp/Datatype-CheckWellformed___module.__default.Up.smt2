...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly T@U) (|m#0| Int) (|n#0| Int) ) (!  (=> (or (|_module.__default.Up#canCall| |m#0| |n#0|) (and (< 1 $FunctionContextHeight) (and (and (<= (LitInt 0) |m#0|) (<= (LitInt 0) |n#0|)) (<= |m#0| |n#0|)))) (and (=> (or (not (= |m#0| |n#0|)) (not true)) (|_module.__default.Up#canCall| (+ |m#0| 1) |n#0|)) (= (_module.__default.Up ($LS $ly) |m#0| |n#0|) (ite (= |m#0| |n#0|) |#_module.List.Nil| (|#_module.List.Cons| |m#0| (_module.__default.Up $ly (+ |m#0| 1) |n#0|))))))
 :qid |Datatypedfy.43:10|
 :skolemid |1979|
 :pattern ( (_module.__default.Up ($LS $ly) |m#0| |n#0|))
))))
...
(assert (forall (($ly@@0 T@U) (|m#0@@0| Int) (|n#0@@0| Int) ) (! (= (_module.__default.Up ($LS $ly@@0) |m#0@@0| |n#0@@0|) (_module.__default.Up $ly@@0 |m#0@@0| |n#0@@0|))
 :qid |Datatypedfy.43:10|
 :skolemid |1975|
 :pattern ( (_module.__default.Up ($LS $ly@@0) |m#0@@0| |n#0@@0|))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@1 T@U) (|m#0@@1| Int) (|n#0@@1| Int) ) (!  (=> (or (|_module.__default.Up#canCall| (LitInt |m#0@@1|) (LitInt |n#0@@1|)) (and (< 1 $FunctionContextHeight) (and (and (<= (LitInt 0) |m#0@@1|) (<= (LitInt 0) |n#0@@1|)) (<= (LitInt |m#0@@1|) (LitInt |n#0@@1|))))) (and (=> (or (not (= (LitInt |m#0@@1|) (LitInt |n#0@@1|))) (not true)) (|_module.__default.Up#canCall| (LitInt (+ |m#0@@1| 1)) (LitInt |n#0@@1|))) (= (_module.__default.Up ($LS $ly@@1) (LitInt |m#0@@1|) (LitInt |n#0@@1|)) (ite (= (LitInt |m#0@@1|) (LitInt |n#0@@1|)) |#_module.List.Nil| (|#_module.List.Cons| (LitInt |m#0@@1|) (Lit DatatypeTypeType (_module.__default.Up ($LS $ly@@1) (LitInt (+ |m#0@@1| 1)) (LitInt |n#0@@1|))))))))
 :qid |Datatypedfy.43:10|
 :weight 3
 :skolemid |1980|
 :pattern ( (_module.__default.Up ($LS $ly@@1) (LitInt |m#0@@1|) (LitInt |n#0@@1|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) (|m#0@@2| Int) (|n#0@@2| Int) ) (!  (=> (or (|_module.__default.Up#canCall| |m#0@@2| |n#0@@2|) (and (< 1 $FunctionContextHeight) (and (and (<= (LitInt 0) |m#0@@2|) (<= (LitInt 0) |n#0@@2|)) (<= |m#0@@2| |n#0@@2|)))) ($Is DatatypeTypeType (_module.__default.Up $ly@@2 |m#0@@2| |n#0@@2|) Tclass._module.List))
 :qid |Datatypedfy.43:10|
 :skolemid |1977|
 :pattern ( (_module.__default.Up $ly@@2 |m#0@@2| |n#0@@2|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Up)
