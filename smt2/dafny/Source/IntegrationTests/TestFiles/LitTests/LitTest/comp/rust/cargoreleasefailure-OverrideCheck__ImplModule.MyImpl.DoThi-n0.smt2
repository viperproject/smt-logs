...
(declare-fun Tagclass.ImplModule.MyImpl? () T@U)
(declare-fun Tagclass.ImplModule.MyImpl () T@U)
(declare-fun Tagclass.TraitModule.MyTrait? () T@U)
(declare-fun Tagclass.TraitModule.MyTrait () T@U)
(declare-fun tytagFamily$MyImpl () T@U)
...
(declare-fun implements$TraitModule.MyTrait (T@U) Bool)
(declare-fun Tclass.ImplModule.MyImpl? () T@U)
...
(declare-fun Tclass.ImplModule.MyImpl () T@U)
(declare-fun Tclass.TraitModule.MyTrait () T@U)
(declare-fun Tclass.TraitModule.MyTrait? () T@U)
...
(assert (= (TagFamily Tclass.ImplModule.MyImpl?) tytagFamily$MyImpl))
(assert (= (Tag Tclass.ImplModule.MyImpl) Tagclass.ImplModule.MyImpl))
(assert (= (TagFamily Tclass.ImplModule.MyImpl) tytagFamily$MyImpl))
