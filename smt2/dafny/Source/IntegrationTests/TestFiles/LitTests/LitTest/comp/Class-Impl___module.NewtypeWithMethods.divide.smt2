...
(set-info :boogie-vc-id Impl$$_module.NewtypeWithMethods.divide)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |d#0| 0)) (not true))) (=> (or (not (= |d#0| 0)) (not true)) (=> (= |newtype$check#1@0| (Div this |d#0|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 42))) (=> (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 42)) (=> (= |q#0@0| (Div this |d#0|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |d#0| 0)) (not true))) (=> (or (not (= |d#0| 0)) (not true)) (=> (and (= |newtype$check#2@0| (Mod this |d#0|)) (= (ControlFlow 0 2) (- 0 1))) (and (<= (LitInt 0) |newtype$check#2@0|) (< |newtype$check#2@0| 42))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (<= (LitInt 0) this) (< this 42))) (=> (and (and (and (<= (LitInt 0) |d#0|) (< |d#0| 42)) (= 1 $FunctionContextHeight)) (and (or (not (= |d#0| 0)) (not true)) (= (ControlFlow 0 6) 2))) anon0_correct))))
