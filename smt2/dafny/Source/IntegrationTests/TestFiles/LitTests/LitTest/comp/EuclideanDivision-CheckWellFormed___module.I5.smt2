...
(assert  (=> (< 0 $FunctionContextHeight) ($Is intType (int_2_U _module.__default.TWO__63) TInt)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.I5)
...
(let ((anon8_Else_correct  (=> (and (< |x#0| (- 0 _module.__default.TWO__63)) (= (ControlFlow 0 6) 4)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (<= (- 0 _module.__default.TWO__63) |x#0|) (= (ControlFlow 0 5) 4)) anon4_correct)))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (- 0 _module.__default.TWO__63) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 _module.__default.TWO__63)))))
