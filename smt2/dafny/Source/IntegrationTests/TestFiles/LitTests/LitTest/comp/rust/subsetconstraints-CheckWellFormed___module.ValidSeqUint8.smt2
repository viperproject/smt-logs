...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|i#0| T@U) ) (!  (=> (or (|_module.__default.SubtypePredicate#canCall| |i#0|) (and (< 1 $FunctionContextHeight) ($Is SeqType |i#0| (TSeq Tclass._module.uint8)))) (= (_module.__default.SubtypePredicate |i#0|) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |subsetconstraintsdfy.9:28|
 :skolemid |531|
 :pattern ( (_module.__default.SubtypePredicate |i#0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|i#0@@0| T@U) ) (!  (=> (or (|_module.__default.SubtypePredicate#canCall| (Lit SeqType |i#0@@0|)) (and (< 1 $FunctionContextHeight) ($Is SeqType |i#0@@0| (TSeq Tclass._module.uint8)))) (= (_module.__default.SubtypePredicate (Lit SeqType |i#0@@0|)) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |subsetconstraintsdfy.9:28|
 :weight 3
 :skolemid |532|
 :pattern ( (_module.__default.SubtypePredicate (Lit SeqType |i#0@@0|)))
))))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.ValidSeqUint8)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon6_Then_correct  (=> (and (and (|_module.__default.SubtypePredicate#canCall| (Lit SeqType |Seq#Empty|)) (= (ControlFlow 0 3) (- 0 2))) (|_module.__default.SubtypePredicate#canCall| (Lit SeqType |Seq#Empty|))) (or (U_2_bool (Lit boolType (bool_2_U (_module.__default.SubtypePredicate (Lit SeqType |Seq#Empty|))))) (U_2_bool (Lit boolType (bool_2_U true)))))))
