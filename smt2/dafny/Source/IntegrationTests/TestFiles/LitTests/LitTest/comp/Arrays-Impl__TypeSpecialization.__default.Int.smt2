...
(declare-fun TypeSpecialization._default.Int$T () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$TypeSpecialization.__default.Int)
