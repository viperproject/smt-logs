...
(set-info :boogie-vc-id CheckWellFormed$$_module.I3)
...
(let ((anon8_Else_correct  (=> (and (< |x#0| (- 0 _module.__default.TWO__127)) (= (ControlFlow 0 6) 4)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (<= (- 0 _module.__default.TWO__127) |x#0|) (= (ControlFlow 0 5) 4)) anon4_correct)))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (- 0 _module.__default.TWO__127) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 _module.__default.TWO__127)))))
