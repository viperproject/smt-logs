...
(declare-fun |s#0| () T@U)
(declare-fun |js#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.ToJavaString)
...
(assert (not
 ...
 :qid |ExternJavaStringdfy.12:62|
 :skolemid |480|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4))
)) ($HeapSucc $Heap $Heap@0))) (and (and ($Is refType |js#0@0| Tclass._module.JavaString) ($IsAlloc refType |js#0@0| Tclass._module.JavaString $Heap@0)) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= |js#0@0| null)) (not true))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SeqType |s#0| (TSeq TChar)) ($IsAlloc SeqType |s#0| (TSeq TChar) $Heap))) (and (and ($Is refType |js#0| Tclass._module.JavaString) ($IsAlloc refType |js#0| Tclass._module.JavaString $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
