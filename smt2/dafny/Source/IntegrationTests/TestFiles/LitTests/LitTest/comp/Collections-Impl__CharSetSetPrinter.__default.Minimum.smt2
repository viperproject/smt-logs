...
(let ((anon9_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (and ($Is SetType (Lit SetType |Set#Empty|) (TSet TChar)) (|Set#IsMember| |ss#0@1| ($Box SetType (Lit SetType |Set#Empty|)))) (exists ((|$as#i0_0#0_0| T@U) )  (and ($Is SetType |$as#i0_0#0_0| (TSet TChar)) (|Set#IsMember| |ss#0@1| ($Box SetType |$as#i0_0#0_0|)))))) (=> (or (and ($Is SetType (Lit SetType |Set#Empty|) (TSet TChar)) (|Set#IsMember| |ss#0@1| ($Box SetType (Lit SetType |Set#Empty|)))) (exists ((|$as#i0_0#0_0@@0| T@U) )  (and ($Is SetType |$as#i0_0#0_0@@0| (TSet TChar)) (|Set#IsMember| |ss#0@1| ($Box SetType |$as#i0_0#0_0@@0|))))) (=> (and (and (and ($Is SetType |i#0_0@1| (TSet TChar)) ($IsAlloc SetType |i#0_0@1| (TSet TChar) $Heap@0)) (and (|Set#IsMember| |ss#0@1| ($Box SetType |i#0_0@1|)) (= |ss#0@2| (|Set#Difference| |ss#0@1| (|Set#UnionOne| |Set#Empty| ($Box SetType |i#0_0@1|)))))) (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0)))
...
(let ((anon2_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (or (and ($Is SetType (Lit SetType |Set#Empty|) (TSet TChar)) (|Set#IsMember| |s#0| ($Box SetType (Lit SetType |Set#Empty|)))) (exists ((|$as#r0#0| T@U) )  (and ($Is SetType |$as#r0#0| (TSet TChar)) (|Set#IsMember| |s#0| ($Box SetType |$as#r0#0|)))))) (=> (or (and ($Is SetType (Lit SetType |Set#Empty|) (TSet TChar)) (|Set#IsMember| |s#0| ($Box SetType (Lit SetType |Set#Empty|)))) (exists ((|$as#r0#0@@0| T@U) )  (and ($Is SetType |$as#r0#0@@0| (TSet TChar)) (|Set#IsMember| |s#0| ($Box SetType |$as#r0#0@@0|))))) (=> (and (and (and ($Is SetType |r#0@0| (TSet TChar)) ($IsAlloc SetType |r#0@0| (TSet TChar) $Heap)) (|Set#IsMember| |s#0| ($Box SetType |r#0@0|))) (and (= |ss#0@0| (|Set#Difference| |s#0| (|Set#UnionOne| |Set#Empty| ($Box SetType |r#0@0|)))) (= (ControlFlow 0 18) 17))) anon14_LoopHead_correct)))))
