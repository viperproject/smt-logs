...
(assert (distinct TInt TagInt TagSet TagMap alloc |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass._module.MyClass Tagclass._module.MyClass? |tytagFamily$_tuple#2| tytagFamily$MyClass)
)
...
(assert (forall ((h@@5 T@U) (v@@10 T@U) ) (! ($IsAlloc intType v@@10 TInt h@@5)
 :qid |DafnyPreludebpl.289:14|
 :skolemid |4538|
 :pattern ( ($IsAlloc intType v@@10 TInt h@@5))
)))
(assert (forall ((m@@13 T@U) ) (!  (or (= m@@13 |Map#Empty|) (exists ((k@@3 T@U) (v@@11 T@U) ) (! (|Set#IsMember| (|Map#Items| m@@13) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| k@@3 v@@11)))
...
)) ($HeapSucc $Heap@2 $Heap@3))))) (and (=> (= (ControlFlow 0 2) (- 0 42)) true) (and (=> (= (ControlFlow 0 2) (- 0 41)) true) (=> (= |m#0@0| (|Map#Build| (|Map#Build| (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 0))) ($Box refType call2formal@this@0)) ($Box intType (int_2_U (LitInt 1))) ($Box refType call2formal@this@0@@0)) ($Box intType (int_2_U (LitInt 2))) ($Box refType null)) ($Box intType (int_2_U (LitInt 3))) ($Box refType null))) (and (=> (= (ControlFlow 0 2) (- 0 40)) true) (and (=> (= (ControlFlow 0 2) (- 0 39)) true) (and (=> (= (ControlFlow 0 2) (- 0 38)) true) (=> (= |n#0@0| (|Map#Build| (|Map#Build| (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 0))) ($Box refType call2formal@this@0@@1)) ($Box intType (int_2_U (LitInt 10))) ($Box refType call2formal@this@0@@0)) ($Box intType (int_2_U (LitInt 20))) ($Box refType null)) ($Box intType (int_2_U (LitInt 4))) ($Box refType call2formal@this@0@@2))) (and (=> (= (ControlFlow 0 2) (- 0 37)) true) (=> (= |o#0@0| (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 199))) ($Box refType null)) ($Box intType (int_2_U (LitInt 198))) ($Box refType call2formal@this@0))) (and (=> (= (ControlFlow 0 2) (- 0 36)) true) (and (=> (= (ControlFlow 0 2) (- 0 35)) true) (=> (= |o'#0@0| (|Map#Build| (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 199))) ($Box refType call2formal@this@0@@0)) ($Box intType (int_2_U (LitInt 55))) ($Box refType null)) ($Box intType (int_2_U (LitInt 198))) ($Box refType call2formal@this@0))) (and (=> (= (ControlFlow 0 2) (- 0 34)) true) (and (=> (= (ControlFlow 0 2) (- 0 33)) true) (=> (= |o''#0@0| (|Map#Build| (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 199))) ($Box refType call2formal@this@0@@0)) ($Box intType (int_2_U (LitInt 56))) ($Box refType null)) ($Box intType (int_2_U (LitInt 198))) ($Box refType call2formal@this@0))) (and (=> (= (ControlFlow 0 2) (- 0 32)) true) (=> (and (and (= |o3#0@0| (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 3))) ($Box refType null)) ($Box intType (int_2_U (LitInt 16))) ($Box refType call2formal@this@0@@1))) (= |$rhs#0@0| (|Map#Equal| |o#0@0| |o'#0@0|))) (and (= |$rhs#1@0| (|Map#Equal| |o'#0@0| |o''#0@0|)) (= |$rhs#2@0| (|Map#Equal| |o'#0@0| |o'#0@0|)))) (=> (and (and (and (= |p#0@0| (|Map#Merge| |m#0@0| |n#0@0|)) (= |q#0@0| (|Map#Merge| |n#0@0| |o#0@0|))) (and (= |r#0@0| (|Map#Merge| |o#0@0| |m#0@0|)) (= |s#0@0| (|Map#Merge| |o3#0@0| |o#0@0|)))) (and (and (= |$rhs#3@0| (|Map#Equal| |p#0@0| (|Map#Merge| |n#0@0| |m#0@0|))) (= |$rhs#4@0| (|Map#Equal| |q#0@0| (|Map#Merge| |o#0@0| |n#0@0|)))) (and (= |$rhs#5@0| (|Map#Equal| |r#0@0| (|Map#Merge| |m#0@0| |o#0@0|))) (= |$rhs#6@0| (|Map#Equal| |s#0@0| (|Map#Merge| |o#0@0| |o3#0@0|)))))) (and (=> (= (ControlFlow 0 2) (- 0 31)) (|Set#IsMember| (|Map#Domain| |p#0@0|) ($Box intType (int_2_U (LitInt 0))))) (and (=> (= (ControlFlow 0 2) (- 0 30)) (or (not (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| |p#0@0|) ($Box intType (int_2_U (LitInt 0))))) null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 29)) (|Set#IsMember| (|Map#Domain| |p#0@0|) ($Box intType (int_2_U (LitInt 1))))) (and (=> (= (ControlFlow 0 2) (- 0 28)) (or (not (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| |p#0@0|) ($Box intType (int_2_U (LitInt 1))))) null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 27)) (|Set#IsMember| (|Map#Domain| |p#0@0|) ($Box intType (int_2_U (LitInt 20))))) (and (=> (= (ControlFlow 0 2) (- 0 26)) (|Set#IsMember| (|Map#Domain| |q#0@0|) ($Box intType (int_2_U (LitInt 0))))) (and (=> (= (ControlFlow 0 2) (- 0 25)) (or (not (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| |q#0@0|) ($Box intType (int_2_U (LitInt 0))))) null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 24)) (|Set#IsMember| (|Map#Domain| |q#0@0|) ($Box intType (int_2_U (LitInt 199))))) (and (=> (= (ControlFlow 0 2) (- 0 23)) (|Set#IsMember| (|Map#Domain| |q#0@0|) ($Box intType (int_2_U (LitInt 20))))) (and (=> (= (ControlFlow 0 2) (- 0 22)) (|Set#IsMember| (|Map#Domain| |r#0@0|) ($Box intType (int_2_U (LitInt 0))))) (and (=> (= (ControlFlow 0 2) (- 0 21)) (or (not (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| |r#0@0|) ($Box intType (int_2_U (LitInt 0))))) null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 20)) (|Set#IsMember| (|Map#Domain| |r#0@0|) ($Box intType (int_2_U (LitInt 198))))) (and (=> (= (ControlFlow 0 2) (- 0 19)) (or (not (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| |r#0@0|) ($Box intType (int_2_U (LitInt 198))))) null)) (not true))) (=> (and (= |a##0@0| (LitInt 0)) (= |b##0@0| (LitInt 321))) (=> (and (and ($Is MapType |call8formal@p#0| (TMap call0formal@_module._default.GenericMap$K call1formal@_module._default.GenericMap$V)) ($IsAlloc MapType |call8formal@p#0| (TMap call0formal@_module._default.GenericMap$K call1formal@_module._default.GenericMap$V) $Heap)) (and ($Is MapType |call9formal@q#0| (TMap call0formal@_module._default.GenericMap$K call1formal@_module._default.GenericMap$V)) ($IsAlloc MapType |call9formal@q#0| (TMap call0formal@_module._default.GenericMap$K call1formal@_module._default.GenericMap$V) $Heap))) (=> (and (and (and ($Is MapType |call10formal@r#0| (TMap call0formal@_module._default.GenericMap$K call1formal@_module._default.GenericMap$V)) ($IsAlloc MapType |call10formal@r#0| (TMap call0formal@_module._default.GenericMap$K call1formal@_module._default.GenericMap$V) $Heap)) (= call1formal@_module._default.GenericMap$V@0 Tclass._module.MyClass?)) (and (= |call5formal@a#0@0| ($Box intType (int_2_U |a##0@0|))) (= |call6formal@b#0@0| ($Box intType (int_2_U |b##0@0|))))) (and (=> (= (ControlFlow 0 2) (- 0 18)) (|Set#IsMember| (|Map#Domain| |m#0@0|) |call5formal@a#0@0|)) (=> (|Set#IsMember| (|Map#Domain| |m#0@0|) |call5formal@a#0@0|) (and (=> (= (ControlFlow 0 2) (- 0 17)) (|Set#IsMember| (|Map#Domain| |n#0@0|) |call5formal@a#0@0|)) (=> (|Set#IsMember| (|Map#Domain| |n#0@0|) |call5formal@a#0@0|) (and (=> (= (ControlFlow 0 2) (- 0 16)) (not (|Set#IsMember| (|Map#Domain| |m#0@0|) |call6formal@b#0@0|))) (=> (not (|Set#IsMember| (|Map#Domain| |m#0@0|) |call6formal@b#0@0|)) (and (=> (= (ControlFlow 0 2) (- 0 15)) (not (|Set#IsMember| (|Map#Domain| |o#0@0|) |call6formal@b#0@0|))) (=> (not (|Set#IsMember| (|Map#Domain| |o#0@0|) |call6formal@b#0@0|)) (=> (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (=> (and (and ($Is MapType |call8formal@p#0@0| (TMap TInt call1formal@_module._default.GenericMap$V@0)) ($IsAlloc MapType |call8formal@p#0@0| (TMap TInt call1formal@_module._default.GenericMap$V@0) $Heap@4)) (and ($Is MapType |call9formal@q#0@0| (TMap TInt call1formal@_module._default.GenericMap$V@0)) ($IsAlloc MapType |call9formal@q#0@0| (TMap TInt call1formal@_module._default.GenericMap$V@0) $Heap@4))) (=> (and (and (and ($Is MapType |call10formal@r#0@0| (TMap TInt call1formal@_module._default.GenericMap$V@0)) ($IsAlloc MapType |call10formal@r#0@0| (TMap TInt call1formal@_module._default.GenericMap$V@0) $Heap@4)) (|Map#Equal| |call8formal@p#0@0| (|Map#Merge| |m#0@0| |n#0@0|))) (and (and (|Map#Equal| |call9formal@q#0@0| (|Map#Merge| |n#0@0| |o#0@0|)) (|Map#Equal| |call10formal@r#0@0| (|Map#Merge| |o#0@0| |m#0@0|))) (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@6) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@6)))
 :qid |Collectionsdfy.434:8|
 :skolemid |5046|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@6))
)) ($HeapSucc $Heap@3 $Heap@4)))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (|Set#IsMember| (|Map#Domain| |call8formal@p#0@0|) ($Box intType (int_2_U (LitInt 0))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (or (not (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| |call8formal@p#0@0|) ($Box intType (int_2_U (LitInt 0))))) null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (|Set#IsMember| (|Map#Domain| |call8formal@p#0@0|) ($Box intType (int_2_U (LitInt 1))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (or (not (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| |call8formal@p#0@0|) ($Box intType (int_2_U (LitInt 1))))) null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (|Set#IsMember| (|Map#Domain| |call8formal@p#0@0|) ($Box intType (int_2_U (LitInt 20))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (|Set#IsMember| (|Map#Domain| |call9formal@q#0@0|) ($Box intType (int_2_U (LitInt 0))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (or (not (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| |call9formal@q#0@0|) ($Box intType (int_2_U (LitInt 0))))) null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (|Set#IsMember| (|Map#Domain| |call9formal@q#0@0|) ($Box intType (int_2_U (LitInt 199))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (|Set#IsMember| (|Map#Domain| |call9formal@q#0@0|) ($Box intType (int_2_U (LitInt 20))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Set#IsMember| (|Map#Domain| |call10formal@r#0@0|) ($Box intType (int_2_U (LitInt 0))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| |call10formal@r#0@0|) ($Box intType (int_2_U (LitInt 0))))) null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#IsMember| (|Map#Domain| |call10formal@r#0@0|) ($Box intType (int_2_U (LitInt 198))))) (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| |call10formal@r#0@0|) ($Box intType (int_2_U (LitInt 198))))) null)) (not true)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (=> |defass#a#0| (and ($Is refType |a#0| Tclass._module.MyClass) ($IsAlloc refType |a#0| Tclass._module.MyClass $Heap))) true) (and (=> |defass#b#0| (and ($Is refType |b#0| Tclass._module.MyClass) ($IsAlloc refType |b#0| Tclass._module.MyClass $Heap))) true)) (=> (and (and (and (and (=> |defass#d#0| (and ($Is refType |d#0| Tclass._module.MyClass) ($IsAlloc refType |d#0| Tclass._module.MyClass $Heap))) true) (and (=> |defass#e#0| (and ($Is refType |e#0| Tclass._module.MyClass) ($IsAlloc refType |e#0| Tclass._module.MyClass $Heap))) true)) (and (and ($Is MapType |m#0| (TMap TInt Tclass._module.MyClass?)) ($IsAlloc MapType |m#0| (TMap TInt Tclass._module.MyClass?) $Heap)) true)) (and (and (and ($Is MapType |n#0| (TMap TInt Tclass._module.MyClass?)) ($IsAlloc MapType |n#0| (TMap TInt Tclass._module.MyClass?) $Heap)) true) (and (and ($Is MapType |o#0| (TMap TInt Tclass._module.MyClass?)) ($IsAlloc MapType |o#0| (TMap TInt Tclass._module.MyClass?) $Heap)) true))) (=> (and (and (and (and (and ($Is MapType |o'#0| (TMap TInt Tclass._module.MyClass?)) ($IsAlloc MapType |o'#0| (TMap TInt Tclass._module.MyClass?) $Heap)) true) (and (and ($Is MapType |o''#0| (TMap TInt Tclass._module.MyClass?)) ($IsAlloc MapType |o''#0| (TMap TInt Tclass._module.MyClass?) $Heap)) true)) (and (and (and ($Is MapType |o3#0| (TMap TInt Tclass._module.MyClass?)) ($IsAlloc MapType |o3#0| (TMap TInt Tclass._module.MyClass?) $Heap)) true) (and (and ($Is MapType |p#0| (TMap TInt Tclass._module.MyClass?)) ($IsAlloc MapType |p#0| (TMap TInt Tclass._module.MyClass?) $Heap)) true))) (and (and (and (and ($Is MapType |q#0| (TMap TInt Tclass._module.MyClass?)) ($IsAlloc MapType |q#0| (TMap TInt Tclass._module.MyClass?) $Heap)) true) (and (and ($Is MapType |r#0| (TMap TInt Tclass._module.MyClass?)) ($IsAlloc MapType |r#0| (TMap TInt Tclass._module.MyClass?) $Heap)) true)) (and (and (and ($Is MapType |s#0| (TMap TInt Tclass._module.MyClass?)) ($IsAlloc MapType |s#0| (TMap TInt Tclass._module.MyClass?) $Heap)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 43) 2))))) anon0_correct))))))
