...
(set-info :boogie-vc-id CheckWellFormed$$_module.int16)
...
(let ((anon8_Else_correct  (=> (and (< |x#0| (LitInt (- 0 32768))) (= (ControlFlow 0 6) 4)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (<= (LitInt (- 0 32768)) |x#0|) (= (ControlFlow 0 5) 4)) anon4_correct)))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt (- 0 32768)) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (Lit boolType (bool_2_U (< 0 32768))))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#5| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 7) 2) anon9_Then_correct) (=> (= (ControlFlow 0 7) 5) anon8_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon8_Else_correct)))))
