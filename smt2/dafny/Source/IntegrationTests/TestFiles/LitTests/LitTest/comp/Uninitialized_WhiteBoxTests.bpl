...
procedure {:verboseName "WhiteBoxTests.M (well-formedness)"} CheckWellFormed$$WhiteBoxTests.__default.M(xs#0: DatatypeType
       where $Is(xs#0, Tclass.WhiteBoxTests.RestrictedList())
         && $IsAlloc(xs#0, Tclass.WhiteBoxTests.RestrictedList(), $Heap)
         && $IsA#WhiteBoxTests.List(xs#0))
   returns (b#0: bool);
...
procedure {:verboseName "WhiteBoxTests.M (call)"} Call$$WhiteBoxTests.__default.M(xs#0: DatatypeType
       where $Is(xs#0, Tclass.WhiteBoxTests.RestrictedList())
         && $IsAlloc(xs#0, Tclass.WhiteBoxTests.RestrictedList(), $Heap)
         && $IsA#WhiteBoxTests.List(xs#0))
   returns (b#0: bool);
...
procedure {:verboseName "WhiteBoxTests.M (correctness)"} Impl$$WhiteBoxTests.__default.M(xs#0: DatatypeType
       where $Is(xs#0, Tclass.WhiteBoxTests.RestrictedList())
         && $IsAlloc(xs#0, Tclass.WhiteBoxTests.RestrictedList(), $Heap)
         && $IsA#WhiteBoxTests.List(xs#0))
...
axiom (forall a#4#0#0: int :: 
  { #WhiteBoxTests.List.Nilly(a#4#0#0) } 
  DatatypeCtorId(#WhiteBoxTests.List.Nilly(a#4#0#0)) == ##WhiteBoxTests.List.Nilly);
}
...
axiom (forall d: DatatypeType :: 
  { WhiteBoxTests.List.Nilly_q(d) } 
  WhiteBoxTests.List.Nilly_q(d)
     ==> (exists a#5#0#0: int :: d == #WhiteBoxTests.List.Nilly(a#5#0#0)));

// Constructor $Is
axiom (forall a#6#0#0: int :: 
  { $Is(#WhiteBoxTests.List.Nilly(a#6#0#0), Tclass.WhiteBoxTests.List()) } 
  $Is(#WhiteBoxTests.List.Nilly(a#6#0#0), Tclass.WhiteBoxTests.List())
     <==> $Is(a#6#0#0, TInt));
...
axiom (forall a#7#0#0: int :: 
  { #WhiteBoxTests.List.Nilly(LitInt(a#7#0#0)) } 
  #WhiteBoxTests.List.Nilly(LitInt(a#7#0#0))
     == Lit(#WhiteBoxTests.List.Nilly(a#7#0#0)));

function WhiteBoxTests.List.x(DatatypeType) : int;

// Constructor injectivity
axiom (forall a#8#0#0: int :: 
  { #WhiteBoxTests.List.Nilly(a#8#0#0) } 
  WhiteBoxTests.List.x(#WhiteBoxTests.List.Nilly(a#8#0#0)) == a#8#0#0);
...
axiom (forall a#9#0#0: int, a#9#1#0: DatatypeType :: 
  { #WhiteBoxTests.List.Konstig(a#9#0#0, a#9#1#0) } 
  DatatypeCtorId(#WhiteBoxTests.List.Konstig(a#9#0#0, a#9#1#0))
...
axiom (forall d: DatatypeType :: 
  { WhiteBoxTests.List.Konstig_q(d) } 
  WhiteBoxTests.List.Konstig_q(d)
     ==> (exists a#10#0#0: int, a#10#1#0: DatatypeType :: 
      d == #WhiteBoxTests.List.Konstig(a#10#0#0, a#10#1#0)));

// Constructor $Is
axiom (forall a#11#0#0: int, a#11#1#0: DatatypeType :: 
  { $Is(#WhiteBoxTests.List.Konstig(a#11#0#0, a#11#1#0), Tclass.WhiteBoxTests.List()) } 
  $Is(#WhiteBoxTests.List.Konstig(a#11#0#0, a#11#1#0), Tclass.WhiteBoxTests.List())
     <==> $Is(a#11#0#0, TInt) && $Is(a#11#1#0, Tclass.WhiteBoxTests.List()));
...
axiom (forall a#12#0#0: int, a#12#1#0: DatatypeType :: 
  { #WhiteBoxTests.List.Konstig(LitInt(a#12#0#0), Lit(a#12#1#0)) } 
  #WhiteBoxTests.List.Konstig(LitInt(a#12#0#0), Lit(a#12#1#0))
     == Lit(#WhiteBoxTests.List.Konstig(a#12#0#0, a#12#1#0)));

function WhiteBoxTests.List.head(DatatypeType) : int;

// Constructor injectivity
axiom (forall a#13#0#0: int, a#13#1#0: DatatypeType :: 
  { #WhiteBoxTests.List.Konstig(a#13#0#0, a#13#1#0) } 
  WhiteBoxTests.List.head(#WhiteBoxTests.List.Konstig(a#13#0#0, a#13#1#0))
     == a#13#0#0);
...
axiom (forall a#14#0#0: int, a#14#1#0: DatatypeType :: 
  { #WhiteBoxTests.List.Konstig(a#14#0#0, a#14#1#0) } 
  WhiteBoxTests.List.tail(#WhiteBoxTests.List.Konstig(a#14#0#0, a#14#1#0))
     == a#14#1#0);

// Inductive rank
axiom (forall a#15#0#0: int, a#15#1#0: DatatypeType :: 
  { #WhiteBoxTests.List.Konstig(a#15#0#0, a#15#1#0) } 
  DtRank(a#15#1#0) < DtRank(#WhiteBoxTests.List.Konstig(a#15#0#0, a#15#1#0)));
...
procedure {:verboseName "WhiteBoxTests.RestrictedList (well-formedness)"} CheckWellFormed$$WhiteBoxTests.RestrictedList(xs#0: DatatypeType);
