...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let (($generated@@108  (=> (= $generated@@97 ($generated@@32 $generated@@98 $generated@@99 $generated@@100 false)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= $generated@@101 0)) (not true))) (=> (or (not (= $generated@@101 0)) (not true)) (=> (= $generated@@102 ($generated@@24 $generated@@103 $generated@@101)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= $generated@@101 0)) (not true))) (=> (or (not (= $generated@@101 0)) (not true)) (=> (= $generated@@104 ($generated@@88 $generated@@103 $generated@@101)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= ($generated 0) $generated@@104)) (=> (<= ($generated 0) $generated@@104) (=> (= (ControlFlow 0 2) (- 0 1)) (= (+ ($generated@@91 $generated@@102 $generated@@101) $generated@@104) $generated@@103)))))))))))))
(let (($generated@@109  (=> (and (and (and ($generated@@105 $generated@@99) ($generated@@106 $generated@@99)) (= 0 $generated@@107)) (and (or (not (= $generated@@101 0)) (not true)) (= (ControlFlow 0 6) 2))) $generated@@108)))
$generated@@109)))
))
(check-sat)
(get-info :rlimit)
