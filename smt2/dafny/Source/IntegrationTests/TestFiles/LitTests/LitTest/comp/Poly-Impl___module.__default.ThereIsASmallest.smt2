...
(let ((anon2_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (or (and ($Is refType null Tclass._module.Shape) (|Set#IsMember| |s#0| ($Box refType null))) (exists ((|$as#shape0#0| T@U) )  (and ($Is refType |$as#shape0#0| Tclass._module.Shape) (|Set#IsMember| |s#0| ($Box refType |$as#shape0#0|)))))) (=> (or (and ($Is refType null Tclass._module.Shape) (|Set#IsMember| |s#0| ($Box refType null))) (exists ((|$as#shape0#0@@0| T@U) )  (and ($Is refType |$as#shape0#0@@0| Tclass._module.Shape) (|Set#IsMember| |s#0| ($Box refType |$as#shape0#0@@0|))))) (=> (and (=> true (and ($Is refType |shape#0@0| Tclass._module.Shape) ($IsAlloc refType |shape#0@0| Tclass._module.Shape $Heap@@0))) (|Set#IsMember| |s#0| ($Box refType |shape#0@0|))) (and (=> (= (ControlFlow 0 19) 18) anon10_Then_correct) (=> (= (ControlFlow 0 19) 12) anon10_Else_correct)))))))
