...
procedure {:verboseName "NilRegression.Test (correctness)"} Impl$$NilRegression.__default.Test() returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NilRegression.Test (correctness)"} Impl$$NilRegression.__default.Test() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var c#0: ref
     where $Is(c#0, Tclass.NilRegression.Class?())
       && $IsAlloc(c#0, Tclass.NilRegression.Class?(), $Heap);
  var $nw: ref;
  var cc##0: ref;
  var cc##1: ref;
  var newtype$check#0: ref;

    // AddMethodImpl: Test, Impl$$NilRegression.__default.Test
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(106,19)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id0"} Call$$NilRegression.__default.NilRegression0();
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(107,19)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id1"} Call$$NilRegression.__default.NilRegression1();
    // TrCallStmt: After ProcessCallStmt
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(108,19)
    assume true;
    havoc $nw;
    assume $nw != null && $Is($nw, Tclass.NilRegression.Class?());
    assume !$Unbox(read($Heap, $nw, alloc)): bool;
    $Heap := update($Heap, $nw, alloc, $Box(true));
    assume $IsGoodHeap($Heap);
    assume $IsHeapAnchor($Heap);
    c#0 := $nw;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(109,19)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    cc##0 := c#0;
    call {:id "id3"} Call$$NilRegression.__default.NilRegression2(cc##0);
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(110,19)
    // TrCallStmt: Before ProcessCallStmt
    newtype$check#0 := null;
    assume true;
    // ProcessCallStmt: CheckSubrange
    cc##1 := null;
    call {:id "id4"} Call$$NilRegression.__default.NilRegression2(cc##1);
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(111,19)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id5"} Call$$NilRegression.__default.NilRegression3();
    // TrCallStmt: After ProcessCallStmt
}



procedure {:verboseName "NilRegression.NilRegression0 (well-formedness)"} CheckWellFormed$$NilRegression.__default.NilRegression0();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "NilRegression.NilRegression0 (call)"} Call$$NilRegression.__default.NilRegression0();
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "NilRegression.NilRegression0 (correctness)"} Impl$$NilRegression.__default.NilRegression0() returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NilRegression.NilRegression0 (correctness)"} Impl$$NilRegression.__default.NilRegression0() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var uu#0: ref
     where $Is(uu#0, Tclass.NilRegression.Class?())
       && $IsAlloc(uu#0, Tclass.NilRegression.Class?(), $Heap);
  var newtype$check#0: ref;
  var newtype$check#0_0: ref;
  var newtype$check#1: ref;
  var ww#0: ref
     where $Is(ww#0, Tclass._System.object?())
       && $IsAlloc(ww#0, Tclass._System.object?(), $Heap);
  var newtype$check#2: ref;
  var newtype$check#3: ref;

    // AddMethodImpl: NilRegression0, Impl$$NilRegression.__default.NilRegression0
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    havoc uu#0 /* where $Is(uu#0, Tclass.NilRegression.Class?())
       && $IsAlloc(uu#0, Tclass.NilRegression.Class?(), $Heap) */;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(116,5)
    newtype$check#0 := null;
    assume true;
    if (uu#0 != null)
    {
        push;
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(117,10)
        assume true;
    ...
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(119,5)
    newtype$check#1 := null;
    assume true;
    assert {:id "id7"} uu#0 == null;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(120,21)
    assume true;
    assume true;
    ww#0 := uu#0;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(121,5)
    newtype$check#2 := null;
    assume true;
    assert {:id "id9"} ww#0 == null;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(122,5)
    newtype$check#3 := null;
    assume true;
    if (ww#0 == null)
    {
        // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(123,7)
        assume true;
    }
    else
    {
        // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(125,7)
        assume true;
        assert {:id "id10"} Lit(false);
        // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(126,7)
        assume true;
    }
}
...
procedure {:verboseName "NilRegression.NilRegression1 (well-formedness)"} CheckWellFormed$$NilRegression.__default.NilRegression1();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "NilRegression.NilRegression1 (call)"} Call$$NilRegression.__default.NilRegression1();
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "NilRegression.NilRegression1 (correctness)"} Impl$$NilRegression.__default.NilRegression1() returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
procedure {:verboseName "NilRegression.NilRegression2 (well-formedness)"} CheckWellFormed$$NilRegression.__default.NilRegression2(cc#0: ref
       where $Is(cc#0, Tclass.NilRegression.Class?())
         && $IsAlloc(cc#0, Tclass.NilRegression.Class?(), $Heap));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "NilRegression.NilRegression2 (call)"} Call$$NilRegression.__default.NilRegression2(cc#0: ref
       where $Is(cc#0, Tclass.NilRegression.Class?())
         && $IsAlloc(cc#0, Tclass.NilRegression.Class?(), $Heap));
  modifies $Heap;
  // frame condition: object granularity
...
procedure {:verboseName "NilRegression.NilRegression2 (correctness)"} Impl$$NilRegression.__default.NilRegression2(cc#0: ref
       where $Is(cc#0, Tclass.NilRegression.Class?())
         && $IsAlloc(cc#0, Tclass.NilRegression.Class?(), $Heap))
...
procedure {:verboseName "NilRegression.Gimmie (well-formedness)"} CheckWellFormed$$NilRegression.__default.Gimmie(NilRegression._default.Gimmie$R: Ty)
   returns (r#0: Box
       where $IsBox(r#0, NilRegression._default.Gimmie$R)
         && $IsAllocBox(r#0, NilRegression._default.Gimmie$R, $Heap));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "NilRegression.Gimmie (call)"} Call$$NilRegression.__default.Gimmie(NilRegression._default.Gimmie$R: Ty)
   returns (r#0: Box
       where $IsBox(r#0, NilRegression._default.Gimmie$R)
         && $IsAllocBox(r#0, NilRegression._default.Gimmie$R, $Heap));
  modifies $Heap;
...
procedure {:verboseName "NilRegression.Gimmie (correctness)"} Impl$$NilRegression.__default.Gimmie(NilRegression._default.Gimmie$R: Ty)
   returns (r#0: Box
       where $IsBox(r#0, NilRegression._default.Gimmie$R)
         && $IsAllocBox(r#0, NilRegression._default.Gimmie$R, $Heap), 
    $_reverifyPost: bool);
...
procedure {:verboseName "NilRegression.Gimmie2 (well-formedness)"} CheckWellFormed$$NilRegression.__default.Gimmie2(NilRegression._default.Gimmie2$R: Ty, NilRegression._default.Gimmie2$S: Ty)
   returns (r#0: Box
       where $IsBox(r#0, NilRegression._default.Gimmie2$R)
         && $IsAllocBox(r#0, NilRegression._default.Gimmie2$R, $Heap), 
    s#0: Box
       where $IsBox(s#0, NilRegression._default.Gimmie2$S)
         && $IsAllocBox(s#0, NilRegression._default.Gimmie2$S, $Heap));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "NilRegression.Gimmie2 (call)"} Call$$NilRegression.__default.Gimmie2(NilRegression._default.Gimmie2$R: Ty, NilRegression._default.Gimmie2$S: Ty)
   returns (r#0: Box
       where $IsBox(r#0, NilRegression._default.Gimmie2$R)
         && $IsAllocBox(r#0, NilRegression._default.Gimmie2$R, $Heap), 
    s#0: Box
...
procedure {:verboseName "NilRegression.Gimmie2 (correctness)"} Impl$$NilRegression.__default.Gimmie2(NilRegression._default.Gimmie2$R: Ty, NilRegression._default.Gimmie2$S: Ty)
   returns (r#0: Box
       where $IsBox(r#0, NilRegression._default.Gimmie2$R)
         && $IsAllocBox(r#0, NilRegression._default.Gimmie2$R, $Heap), 
    s#0: Box
...
axiom 0 <= $FunctionContextHeight
   ==> (forall NilRegression._default.Id$X: Ty, x#0: Box :: 
    ...
    NilRegression.__default.Id#canCall(NilRegression._default.Id$X, x#0)
         || (0 < $FunctionContextHeight && $IsBox(x#0, NilRegression._default.Id$X))
...
axiom 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, NilRegression._default.Id$X: Ty, x#0: Box :: 
...
procedure {:verboseName "NilRegression.Id (well-formedness)"} CheckWellformed$$NilRegression.__default.Id(NilRegression._default.Id$X: Ty, 
    x#0: Box where $IsBox(x#0, NilRegression._default.Id$X));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "NilRegression.NilRegression3 (well-formedness)"} CheckWellFormed$$NilRegression.__default.NilRegression3();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "NilRegression.NilRegression3 (call)"} Call$$NilRegression.__default.NilRegression3();
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "NilRegression.NilRegression3 (correctness)"} Impl$$NilRegression.__default.NilRegression3() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
// GClass.u': Type axiom
axiom 0 < $FunctionContextHeight
   ==> (forall NilRegression.GClass$U: Ty, 
      NilRegression.GClass$V: Ty, 
      NilRegression.GClass$W: Ty, 
      $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NilRegression.NilRegression3 (correctness)"} Impl$$NilRegression.__default.NilRegression3() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var x0#0: ref
  ...
  var $tmp##0: Box;
  var x1#0: ref
     where $Is(x1#0, Tclass.NilRegression.Trait?())
       && $IsAlloc(x1#0, Tclass.NilRegression.Trait?(), $Heap);
  var $rhs##1: ref;
  var $tmp##1: Box;
  var $rhs##2: ref;
  var $rhs##3: ref;
  ...
  var c#0: ref
     where defass#c#0
       ==> $Is(c#0, 
          Tclass.NilRegression.GClass(Tclass._System.object?(), 
            Tclass.NilRegression.Trait?(), 
            Tclass.NilRegression.MyClass?()))
         && $IsAlloc(c#0, 
          Tclass.NilRegression.GClass(Tclass._System.object?(), 
            Tclass.NilRegression.Trait?(), 
            Tclass.NilRegression.MyClass?()), 
  ...
  var $nw: ref;
  var u#0: ref
     where $Is(u#0, Tclass._System.object?())
       && $IsAlloc(u#0, Tclass._System.object?(), $Heap);
  var v#0: ref
     where $Is(v#0, Tclass.NilRegression.Trait?())
       && $IsAlloc(v#0, Tclass.NilRegression.Trait?(), $Heap);
  var w#0: ref
     where $Is(w#0, Tclass.NilRegression.MyClass?())
       && $IsAlloc(w#0, Tclass.NilRegression.MyClass?(), $Heap);
  var $rhs#0: ref;
  var $rhs#1: ref;
  var $rhs#2: ref;
  var $rhs#3: ref;
  ...
  var $rhs#8: ref;
  var x#0: ref
     where $Is(x#0, Tclass.NilRegression.Trait?())
       && $IsAlloc(x#0, Tclass.NilRegression.Trait?(), $Heap);
  var y#0: ref
     where $Is(y#0, Tclass.NilRegression.Trait?())
       && $IsAlloc(y#0, Tclass.NilRegression.Trait?(), $Heap);
  var ##x#0: ref;
  var $rhs#9: ref;
  var $rhs#10: ref;
  var $rhs#11: ref;
  ...
  var $rhs#14: ref;
    ...
    // AddMethodImpl: NilRegression3, Impl$$NilRegression.__default.NilRegression3
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(197,30)
    assume true;
    // TrCallStmt: Adding lhs with type object?
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id31"} $tmp##0 := Call$$NilRegression.__default.Gimmie(Tclass._System.object?());
    havoc $rhs##0;
    assume $rhs##0 == $Unbox($tmp##0): ref;
    // TrCallStmt: After ProcessCallStmt
    x0#0 := $rhs##0;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(198,29)
    assume true;
    // TrCallStmt: Adding lhs with type Trait?
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id33"} $tmp##1 := Call$$NilRegression.__default.Gimmie(Tclass.NilRegression.Trait?());
    havoc $rhs##1;
    assume $rhs##1 == $Unbox($tmp##1): ref;
    // TrCallStmt: After ProcessCallStmt
    x1#0 := $rhs##1;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(199,5)
    assume true;
    assume true;
    assume true;
    assume true;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(200,22)
    assume true;
    assume true;
    // TrCallStmt: Adding lhs with type object?
    // TrCallStmt: Adding lhs with type Trait?
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id35"} $tmp##2, $tmp##3 := Call$$NilRegression.__default.Gimmie2(Tclass._System.object?(), Tclass.NilRegression.Trait?());
    havoc $rhs##2;
    assume $rhs##2 == $Unbox($tmp##2): ref;
    havoc $rhs##3;
    assume $rhs##3 == $Unbox($tmp##3): ref;
    // TrCallStmt: After ProcessCallStmt
    x0#0 := $rhs##2;
    x1#0 := $rhs##3;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(201,5)
    assume true;
    assume true;
    assume true;
    assume true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(204,11)
    assume true;
    // ----- init call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(204,14)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id38"} $nw := Call$$NilRegression.GClass.__ctor(Tclass._System.object?(), Tclass.NilRegression.Trait?(), Tclass.NilRegression.MyClass?());
    // TrCallStmt: After ProcessCallStmt
    c#0 := $nw;
    defass#c#0 := true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(205,20)
    assume true;
    assert {:id "id40"} defass#c#0;
    assert {:id "id41"} c#0 != null;
    assume true;
    u#0 := $Unbox(read($Heap, c#0, NilRegression.GClass.u)): ref;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(206,19)
    assume true;
    assert {:id "id43"} defass#c#0;
    assert {:id "id44"} c#0 != null;
    assume true;
    v#0 := $Unbox(read($Heap, c#0, NilRegression.GClass.v)): ref;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(207,21)
    assume true;
    assert {:id "id46"} defass#c#0;
    assert {:id "id47"} c#0 != null;
    assume true;
    w#0 := $Unbox(read($Heap, c#0, NilRegression.GClass.w)): ref;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(208,5)
    assume true;
    assume true;
    assume true;
    assume true;
    assume true;
    assume true;
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(209,13)
    assume true;
    assume true;
    assume true;
    ...
    assume true;
    $rhs#0 := $Unbox(NilRegression.GClass.u_k(Tclass._System.object?(), 
        Tclass.NilRegression.Trait?(), 
        Tclass.NilRegression.MyClass?(), 
        c#0)): ref;
    ...
    assume true;
    $rhs#1 := $Unbox(NilRegression.GClass.v_k(Tclass._System.object?(), 
        Tclass.NilRegression.Trait?(), 
        Tclass.NilRegression.MyClass?(), 
        c#0)): ref;
    ...
    assume true;
    $rhs#2 := $Unbox(NilRegression.GClass.w_k(Tclass._System.object?(), 
        Tclass.NilRegression.Trait?(), 
        Tclass.NilRegression.MyClass?(), 
        c#0)): ref;
    u#0 := $rhs#0;
    v#0 := $rhs#1;
    w#0 := $rhs#2;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(210,5)
    assume true;
    assume true;
    assume true;
    assume true;
    assume true;
    assume true;
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(213,13)
    assume true;
    assume true;
    assume true;
    assert {:id "id61"} defass#c#0;
    assert {:id "id62"} c#0 != null;
    assert {:id "id63"} $Unbox(read($Heap, c#0, NilRegression.GClass.u1)): ref != null;
    assert {:id "id64"} 0 <= LitInt(0)
       && LitInt(0)
         < _System.array.Length($Unbox(read($Heap, c#0, NilRegression.GClass.u1)): ref);
    assume true;
    $rhs#3 := $Unbox(read($Heap, 
        $Unbox(read($Heap, c#0, NilRegression.GClass.u1)): ref, 
        IndexField(LitInt(0)))): ref;
    assert {:id "id66"} defass#c#0;
    assert {:id "id67"} c#0 != null;
    assert {:id "id68"} $Unbox(read($Heap, c#0, NilRegression.GClass.v1)): ref != null;
    assert {:id "id69"} 0 <= LitInt(0)
       && LitInt(0)
         < _System.array.Length($Unbox(read($Heap, c#0, NilRegression.GClass.v1)): ref);
    assume true;
    $rhs#4 := $Unbox(read($Heap, 
        $Unbox(read($Heap, c#0, NilRegression.GClass.v1)): ref, 
        IndexField(LitInt(0)))): ref;
    assert {:id "id71"} defass#c#0;
    assert {:id "id72"} c#0 != null;
    assert {:id "id73"} $Unbox(read($Heap, c#0, NilRegression.GClass.w1)): ref != null;
    assert {:id "id74"} 0 <= LitInt(0)
       && LitInt(0)
         < _System.array.Length($Unbox(read($Heap, c#0, NilRegression.GClass.w1)): ref);
    assume true;
    $rhs#5 := $Unbox(read($Heap, 
        $Unbox(read($Heap, c#0, NilRegression.GClass.w1)): ref, 
        IndexField(LitInt(0)))): ref;
    u#0 := $rhs#3;
    v#0 := $rhs#4;
    w#0 := $rhs#5;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(214,5)
    assume true;
    assume true;
    assume true;
    assume true;
    assume true;
    assume true;
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(215,13)
    assume true;
    assume true;
    assume true;
    assert {:id "id79"} defass#c#0;
    assert {:id "id80"} c#0 != null;
    assert {:id "id81"} $Unbox(read($Heap, c#0, NilRegression.GClass.u2)): ref != null;
    assert {:id "id82"} 0 <= LitInt(0)
       && LitInt(0)
         < _System.array2.Length0($Unbox(read($Heap, c#0, NilRegression.GClass.u2)): ref);
    assert {:id "id83"} 0 <= LitInt(0)
       && LitInt(0)
         < _System.array2.Length1($Unbox(read($Heap, c#0, NilRegression.GClass.u2)): ref);
    assume true;
    $rhs#6 := $Unbox(read($Heap, 
        $Unbox(read($Heap, c#0, NilRegression.GClass.u2)): ref, 
        MultiIndexField(IndexField(LitInt(0)), LitInt(0)))): ref;
    assert {:id "id85"} defass#c#0;
    assert {:id "id86"} c#0 != null;
    assert {:id "id87"} $Unbox(read($Heap, c#0, NilRegression.GClass.v2)): ref != null;
    assert {:id "id88"} 0 <= LitInt(0)
       && LitInt(0)
         < _System.array2.Length0($Unbox(read($Heap, c#0, NilRegression.GClass.v2)): ref);
    assert {:id "id89"} 0 <= LitInt(0)
       && LitInt(0)
         < _System.array2.Length1($Unbox(read($Heap, c#0, NilRegression.GClass.v2)): ref);
    assume true;
    $rhs#7 := $Unbox(read($Heap, 
        $Unbox(read($Heap, c#0, NilRegression.GClass.v2)): ref, 
        MultiIndexField(IndexField(LitInt(0)), LitInt(0)))): ref;
    assert {:id "id91"} defass#c#0;
    assert {:id "id92"} c#0 != null;
    assert {:id "id93"} $Unbox(read($Heap, c#0, NilRegression.GClass.w2)): ref != null;
    assert {:id "id94"} 0 <= LitInt(0)
       && LitInt(0)
         < _System.array2.Length0($Unbox(read($Heap, c#0, NilRegression.GClass.w2)): ref);
    assert {:id "id95"} 0 <= LitInt(0)
       && LitInt(0)
         < _System.array2.Length1($Unbox(read($Heap, c#0, NilRegression.GClass.w2)): ref);
    assume true;
    $rhs#8 := $Unbox(read($Heap, 
        $Unbox(read($Heap, c#0, NilRegression.GClass.w2)): ref, 
        MultiIndexField(IndexField(LitInt(0)), LitInt(0)))): ref;
    u#0 := $rhs#6;
    v#0 := $rhs#7;
    w#0 := $rhs#8;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(216,5)
    assume true;
    assume true;
    assume true;
    assume true;
    assume true;
    assume true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(219,19)
    assume true;
    if (u#0 == v#0)
    {
    ...
    {
        assert {:id "id102"} defass#c#0;
        assert {:id "id103"} c#0 != null;
    }

    assume true;
    x#0 := (if u#0 == v#0
       then $Unbox(read($Heap, c#0, NilRegression.GClass.v)): ref
       else $Unbox(read($Heap, c#0, NilRegression.GClass.v)): ref);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(221,19)
    assume true;
    ##x#0 := x#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#0, Tclass.NilRegression.Trait?(), $Heap);
    assume NilRegression.__default.Id#canCall(Tclass.NilRegression.Trait?(), $Box(x#0));
    assume NilRegression.__default.Id#canCall(Tclass.NilRegression.Trait?(), $Box(x#0));
    y#0 := $Unbox(NilRegression.__default.Id(Tclass.NilRegression.Trait?(), $Box(x#0))): ref;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(222,5)
    assume true;
    assume true;
    assume true;
    assume true;
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(225,13)
    assume true;
    assume true;
    assume true;
    assume NilRegression.DaTy.DaTy_q(#NilRegression.DaTy.DaTy($Box(u#0)));
    assume NilRegression.DaTy.DaTy_q(#NilRegression.DaTy.DaTy($Box(u#0)));
    $rhs#9 := $Unbox(NilRegression.DaTy.get(#NilRegression.DaTy.DaTy($Box(u#0)))): ref;
    assume NilRegression.DaTy.DaTy_q(#NilRegression.DaTy.DaTy($Box(v#0)));
    assume NilRegression.DaTy.DaTy_q(#NilRegression.DaTy.DaTy($Box(v#0)));
    $rhs#10 := $Unbox(NilRegression.DaTy.get(#NilRegression.DaTy.DaTy($Box(v#0)))): ref;
    assume NilRegression.DaTy.DaTy_q(#NilRegression.DaTy.DaTy($Box(w#0)));
    assume NilRegression.DaTy.DaTy_q(#NilRegression.DaTy.DaTy($Box(w#0)));
    $rhs#11 := $Unbox(NilRegression.DaTy.get(#NilRegression.DaTy.DaTy($Box(w#0)))): ref;
    u#0 := $rhs#9;
    v#0 := $rhs#10;
    w#0 := $rhs#11;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(226,5)
    assume true;
    assume true;
    assume true;
    assume true;
    assume true;
    assume true;
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(227,13)
    assume true;
    assume true;
    assume true;
    assert {:id "id112"} NilRegression.DaTy2.DaTy2_q(#NilRegression.DaTy2.DaTy2($Box(u#0)));
    assume true;
    $rhs#12 := $Unbox(NilRegression.DaTy2.get(#NilRegression.DaTy2.DaTy2($Box(u#0)))): ref;
    assert {:id "id114"} NilRegression.DaTy2.DaTy2_q(#NilRegression.DaTy2.DaTy2($Box(v#0)));
    assume true;
    $rhs#13 := $Unbox(NilRegression.DaTy2.get(#NilRegression.DaTy2.DaTy2($Box(v#0)))): ref;
    assert {:id "id116"} NilRegression.DaTy2.DaTy2_q(#NilRegression.DaTy2.DaTy2($Box(w#0)));
    assume true;
    $rhs#14 := $Unbox(NilRegression.DaTy2.get(#NilRegression.DaTy2.DaTy2($Box(w#0)))): ref;
    u#0 := $rhs#12;
    v#0 := $rhs#13;
    w#0 := $rhs#14;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(228,5)
    assume true;
    assume true;
    assume true;
    assume true;
...
procedure {:verboseName "NilRegression.GClass._ctor (well-formedness)"} CheckWellFormed$$NilRegression.GClass.__ctor(NilRegression.GClass$U: Ty, 
    NilRegression.GClass$V: Ty, 
    NilRegression.GClass$W: Ty)
   returns (this: ref);
  free requires 0 == $FunctionContextHeight;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NilRegression.GClass._ctor (well-formedness)"} CheckWellFormed$$NilRegression.GClass.__ctor(NilRegression.GClass$U: Ty, 
    NilRegression.GClass$V: Ty, 
    NilRegression.GClass$W: Ty)
   returns (this: ref)
{
  var $_ModifiesFrame: [ref,Field]bool;
    ...
    // AddMethodImpl: _ctor, CheckWellFormed$$NilRegression.GClass.__ctor
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    havoc $Heap;
    assume (forall $o: ref :: 
    ...
    assume this != null
      ...
      $Is(this, 
       ...
       && $IsAlloc(this, 
        Tclass.NilRegression.GClass(NilRegression.GClass$U, NilRegression.GClass$V, NilRegression.GClass$W), 
        $Heap);
    assert {:id "id121"} $Unbox(read($Heap, this, NilRegression.GClass.u1)): ref != null;
    assert {:id "id122"} $Unbox(read($Heap, this, NilRegression.GClass.v1)): ref != null;
    if (_System.array.Length($Unbox(read($Heap, this, NilRegression.GClass.u1)): ref)
       == _System.array.Length($Unbox(read($Heap, this, NilRegression.GClass.v1)): ref))
    {
        assert {:id "id123"} $Unbox(read($Heap, this, NilRegression.GClass.v1)): ref != null;
        assert {:id "id124"} $Unbox(read($Heap, this, NilRegression.GClass.w1)): ref != null;
    }

    if (_System.array.Length($Unbox(read($Heap, this, NilRegression.GClass.u1)): ref)
         == _System.array.Length($Unbox(read($Heap, this, NilRegression.GClass.v1)): ref)
       && _System.array.Length($Unbox(read($Heap, this, NilRegression.GClass.v1)): ref)
         == _System.array.Length($Unbox(read($Heap, this, NilRegression.GClass.w1)): ref))
    {
        assert {:id "id125"} $Unbox(read($Heap, this, NilRegression.GClass.w1)): ref != null;
    }

    assume {:id "id126"} _System.array.Length($Unbox(read($Heap, this, NilRegression.GClass.u1)): ref)
         == _System.array.Length($Unbox(read($Heap, this, NilRegression.GClass.v1)): ref)
       && _System.array.Length($Unbox(read($Heap, this, NilRegression.GClass.v1)): ref)
         == _System.array.Length($Unbox(read($Heap, this, NilRegression.GClass.w1)): ref)
       && _System.array.Length($Unbox(read($Heap, this, NilRegression.GClass.w1)): ref)
         == LitInt(1);
    assert {:id "id127"} $Unbox(read($Heap, this, NilRegression.GClass.u2)): ref != null;
    assert {:id "id128"} $Unbox(read($Heap, this, NilRegression.GClass.v2)): ref != null;
    if (_System.array2.Length0($Unbox(read($Heap, this, NilRegression.GClass.u2)): ref)
       == _System.array2.Length0($Unbox(read($Heap, this, NilRegression.GClass.v2)): ref))
    {
        assert {:id "id129"} $Unbox(read($Heap, this, NilRegression.GClass.v2)): ref != null;
        assert {:id "id130"} $Unbox(read($Heap, this, NilRegression.GClass.w2)): ref != null;
    }

    if (_System.array2.Length0($Unbox(read($Heap, this, NilRegression.GClass.u2)): ref)
         == _System.array2.Length0($Unbox(read($Heap, this, NilRegression.GClass.v2)): ref)
       && _System.array2.Length0($Unbox(read($Heap, this, NilRegression.GClass.v2)): ref)
         == _System.array2.Length0($Unbox(read($Heap, this, NilRegression.GClass.w2)): ref))
    {
        assert {:id "id131"} $Unbox(read($Heap, this, NilRegression.GClass.w2)): ref != null;
    }

    assume {:id "id132"} _System.array2.Length0($Unbox(read($Heap, this, NilRegression.GClass.u2)): ref)
         == _System.array2.Length0($Unbox(read($Heap, this, NilRegression.GClass.v2)): ref)
       && _System.array2.Length0($Unbox(read($Heap, this, NilRegression.GClass.v2)): ref)
         == _System.array2.Length0($Unbox(read($Heap, this, NilRegression.GClass.w2)): ref)
       && _System.array2.Length0($Unbox(read($Heap, this, NilRegression.GClass.w2)): ref)
         == LitInt(1);
    assert {:id "id133"} $Unbox(read($Heap, this, NilRegression.GClass.u2)): ref != null;
    assert {:id "id134"} $Unbox(read($Heap, this, NilRegression.GClass.v2)): ref != null;
    if (_System.array2.Length1($Unbox(read($Heap, this, NilRegression.GClass.u2)): ref)
       == _System.array2.Length1($Unbox(read($Heap, this, NilRegression.GClass.v2)): ref))
    {
        assert {:id "id135"} $Unbox(read($Heap, this, NilRegression.GClass.v2)): ref != null;
        assert {:id "id136"} $Unbox(read($Heap, this, NilRegression.GClass.w2)): ref != null;
    }

    if (_System.array2.Length1($Unbox(read($Heap, this, NilRegression.GClass.u2)): ref)
         == _System.array2.Length1($Unbox(read($Heap, this, NilRegression.GClass.v2)): ref)
       && _System.array2.Length1($Unbox(read($Heap, this, NilRegression.GClass.v2)): ref)
         == _System.array2.Length1($Unbox(read($Heap, this, NilRegression.GClass.w2)): ref))
    {
        assert {:id "id137"} $Unbox(read($Heap, this, NilRegression.GClass.w2)): ref != null;
    }

    assume {:id "id138"} _System.array2.Length1($Unbox(read($Heap, this, NilRegression.GClass.u2)): ref)
         == _System.array2.Length1($Unbox(read($Heap, this, NilRegression.GClass.v2)): ref)
       && _System.array2.Length1($Unbox(read($Heap, this, NilRegression.GClass.v2)): ref)
         == _System.array2.Length1($Unbox(read($Heap, this, NilRegression.GClass.w2)): ref)
       && _System.array2.Length1($Unbox(read($Heap, this, NilRegression.GClass.w2)): ref)
...
procedure {:verboseName "NilRegression.GClass._ctor (call)"} Call$$NilRegression.GClass.__ctor(NilRegression.GClass$U: Ty, 
    NilRegression.GClass$V: Ty, 
    NilRegression.GClass$W: Ty)
   returns (this: ref
       where this != null
  ...
  free ensures true;
  ensures {:id "id139"} _System.array.Length($Unbox(read($Heap, this, NilRegression.GClass.u1)): ref)
     == _System.array.Length($Unbox(read($Heap, this, NilRegression.GClass.v1)): ref);
  ensures {:id "id140"} _System.array.Length($Unbox(read($Heap, this, NilRegression.GClass.v1)): ref)
     == _System.array.Length($Unbox(read($Heap, this, NilRegression.GClass.w1)): ref);
  ensures {:id "id141"} _System.array.Length($Unbox(read($Heap, this, NilRegression.GClass.w1)): ref)
     == LitInt(1);
  free ensures true;
  ensures {:id "id142"} _System.array2.Length0($Unbox(read($Heap, this, NilRegression.GClass.u2)): ref)
     == _System.array2.Length0($Unbox(read($Heap, this, NilRegression.GClass.v2)): ref);
  ensures {:id "id143"} _System.array2.Length0($Unbox(read($Heap, this, NilRegression.GClass.v2)): ref)
     == _System.array2.Length0($Unbox(read($Heap, this, NilRegression.GClass.w2)): ref);
  ensures {:id "id144"} _System.array2.Length0($Unbox(read($Heap, this, NilRegression.GClass.w2)): ref)
     == LitInt(1);
  free ensures true;
  ensures {:id "id145"} _System.array2.Length1($Unbox(read($Heap, this, NilRegression.GClass.u2)): ref)
     == _System.array2.Length1($Unbox(read($Heap, this, NilRegression.GClass.v2)): ref);
  ensures {:id "id146"} _System.array2.Length1($Unbox(read($Heap, this, NilRegression.GClass.v2)): ref)
     == _System.array2.Length1($Unbox(read($Heap, this, NilRegression.GClass.w2)): ref);
  ensures {:id "id147"} _System.array2.Length1($Unbox(read($Heap, this, NilRegression.GClass.w2)): ref)
     == LitInt(1);
...
procedure {:verboseName "NilRegression.GClass._ctor (correctness)"} Impl$$NilRegression.GClass.__ctor(NilRegression.GClass$U: Ty, 
    NilRegression.GClass$V: Ty, 
    NilRegression.GClass$W: Ty)
  ...
  // user-defined postconditions
  free ensures true;
  ensures {:id "id148"} _System.array.Length($Unbox(read($Heap, this, NilRegression.GClass.u1)): ref)
     == _System.array.Length($Unbox(read($Heap, this, NilRegression.GClass.v1)): ref);
  ensures {:id "id149"} _System.array.Length($Unbox(read($Heap, this, NilRegression.GClass.v1)): ref)
     == _System.array.Length($Unbox(read($Heap, this, NilRegression.GClass.w1)): ref);
  ensures {:id "id150"} _System.array.Length($Unbox(read($Heap, this, NilRegression.GClass.w1)): ref)
     == LitInt(1);
  free ensures true;
  ensures {:id "id151"} _System.array2.Length0($Unbox(read($Heap, this, NilRegression.GClass.u2)): ref)
     == _System.array2.Length0($Unbox(read($Heap, this, NilRegression.GClass.v2)): ref);
  ensures {:id "id152"} _System.array2.Length0($Unbox(read($Heap, this, NilRegression.GClass.v2)): ref)
     == _System.array2.Length0($Unbox(read($Heap, this, NilRegression.GClass.w2)): ref);
  ensures {:id "id153"} _System.array2.Length0($Unbox(read($Heap, this, NilRegression.GClass.w2)): ref)
     == LitInt(1);
  free ensures true;
  ensures {:id "id154"} _System.array2.Length1($Unbox(read($Heap, this, NilRegression.GClass.u2)): ref)
     == _System.array2.Length1($Unbox(read($Heap, this, NilRegression.GClass.v2)): ref);
  ensures {:id "id155"} _System.array2.Length1($Unbox(read($Heap, this, NilRegression.GClass.v2)): ref)
     == _System.array2.Length1($Unbox(read($Heap, this, NilRegression.GClass.w2)): ref);
  ensures {:id "id156"} _System.array2.Length1($Unbox(read($Heap, this, NilRegression.GClass.w2)): ref)
     == LitInt(1);
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NilRegression.GClass._ctor (correctness)"} Impl$$NilRegression.GClass.__ctor(NilRegression.GClass$U: Ty, 
    NilRegression.GClass$V: Ty, 
    NilRegression.GClass$W: Ty)
   returns (this: ref, $_reverifyPost: bool)
{
  ...
  var $rhs#5: ref;
    ...
    // AddMethodImpl: _ctor, Impl$$NilRegression.GClass.__ctor
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- divided block before new; ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(179,5)
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(180,18)
    assume true;
    $obj0 := this;
    assume true;
    $obj1 := this;
    assume true;
    $obj2 := this;
    assert {:id "id157"} 0 <= LitInt(1);
    havoc $nw;
    assume $nw != null && $Is($nw, Tclass._System.array?(NilRegression.GClass$U));
    assume !$Unbox(read($Heap, $nw, alloc)): bool;
    ...
    assume $IsHeapAnchor($Heap);
    $rhs#0 := $nw;
    assert {:id "id159"} 0 <= LitInt(1);
    havoc $nw;
    assume $nw != null && $Is($nw, Tclass._System.array?(NilRegression.GClass$V));
    assume !$Unbox(read($Heap, $nw, alloc)): bool;
    assume _System.array.Length($nw) == LitInt(1);
    $Heap := update($Heap, $nw, alloc, $Box(true));
    assume $IsGoodHeap($Heap);
    assume $IsHeapAnchor($Heap);
    $rhs#1 := $nw;
    assert {:id "id161"} 0 <= LitInt(1);
    havoc $nw;
    assume $nw != null && $Is($nw, Tclass._System.array?(NilRegression.GClass$W));
    assume !$Unbox(read($Heap, $nw, alloc)): bool;
    assume _System.array.Length($nw) == LitInt(1);
    $Heap := update($Heap, $nw, alloc, $Box(true));
    assume $IsGoodHeap($Heap);
    ...
    this.v1 := $rhs#1;
    this.w1 := $rhs#2;
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(181,18)
    assume true;
    $obj0 := this;
    assume true;
    $obj1 := this;
    assume true;
    $obj2 := this;
    assert {:id "id166"} 0 <= LitInt(1);
    assert {:id "id167"} 0 <= LitInt(1);
    havoc $nw;
    assume $nw != null && $Is($nw, Tclass._System.array2?(NilRegression.GClass$U));
    assume !$Unbox(read($Heap, $nw, alloc)): bool;
    ...
    assume $IsHeapAnchor($Heap);
    $rhs#3 := $nw;
    assert {:id "id169"} 0 <= LitInt(1);
    assert {:id "id170"} 0 <= LitInt(1);
    havoc $nw;
    assume $nw != null && $Is($nw, Tclass._System.array2?(NilRegression.GClass$V));
    assume !$Unbox(read($Heap, $nw, alloc)): bool;
    assume _System.array2.Length0($nw) == LitInt(1);
    assume _System.array2.Length1($nw) == LitInt(1);
    $Heap := update($Heap, $nw, alloc, $Box(true));
    ...
    assume $IsHeapAnchor($Heap);
    $rhs#4 := $nw;
    assert {:id "id172"} 0 <= LitInt(1);
    assert {:id "id173"} 0 <= LitInt(1);
    havoc $nw;
    assume $nw != null && $Is($nw, Tclass._System.array2?(NilRegression.GClass$W));
    assume !$Unbox(read($Heap, $nw, alloc)): bool;
    assume _System.array2.Length0($nw) == LitInt(1);
    assume _System.array2.Length1($nw) == LitInt(1);
    $Heap := update($Heap, $nw, alloc, $Box(true));
    ...
    this.v2 := $rhs#4;
    this.w2 := $rhs#5;
    // ----- new; ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(179,5)
    assume this != null
       && $Is(this, 
        Tclass.NilRegression.GClass?(NilRegression.GClass$U, NilRegression.GClass$V, NilRegression.GClass$W));
    assume !$Unbox(read($Heap, this, alloc)): bool;
    assume read($Heap, this, NilRegression.GClass.u) == this.u;
    assume read($Heap, this, NilRegression.GClass.v) == this.v;
    assume read($Heap, this, NilRegression.GClass.w) == this.w;
    assume NilRegression.GClass.u_k(NilRegression.GClass$U, NilRegression.GClass$V, NilRegression.GClass$W, this)
       == this.u';
    assume NilRegression.GClass.v_k(NilRegression.GClass$U, NilRegression.GClass$V, NilRegression.GClass$W, this)
       == this.v';
    assume NilRegression.GClass.w_k(NilRegression.GClass$U, NilRegression.GClass$V, NilRegression.GClass$W, this)
       == this.w';
    assume $Unbox(read($Heap, this, NilRegression.GClass.u1)): ref == this.u1;
    assume $Unbox(read($Heap, this, NilRegression.GClass.v1)): ref == this.v1;
    assume $Unbox(read($Heap, this, NilRegression.GClass.w1)): ref == this.w1;
    assume $Unbox(read($Heap, this, NilRegression.GClass.u2)): ref == this.u2;
    assume $Unbox(read($Heap, this, NilRegression.GClass.v2)): ref == this.v2;
    assume $Unbox(read($Heap, this, NilRegression.GClass.w2)): ref == this.w2;
    $Heap := update($Heap, this, alloc, $Box(true));
    assume $IsGoodHeap($Heap);
    assume $IsHeapAnchor($Heap);
    // ----- divided block after new; ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/AutoInit.dfy(179,5)
}
