...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon17_Else_correct true))
...
(let ((anon15_LoopHead_correct  (=> (and (and (and (and (not false) (= |$rhs#0@0| 0)) (= |$rhs#1@0| 0)) |$w$loop#0@0|) (and (and (and (<= |lo#0| |i#1@0|) (<= |i#1@0| |hi#0|)) (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |ForLoopsCompilationdfy.63:3|
 :skolemid |523|
...
(let ((anon14_Then_correct  (=> (= |i#0@0| |hi#0|) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= |lo#0| |hi#0|)) (=> (<= |lo#0| |hi#0|) (=> (= (ControlFlow 0 11) 10) anon15_LoopHead_correct))))))
(let ((anon14_Else_correct true))
(let ((anon13_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 13) 11) anon14_Then_correct) (=> (= (ControlFlow 0 13) 3) anon14_Else_correct)))))
...
(let ((anon12_LoopHead_correct  (=> (and (and (and (and (= |$rhs#1@0| 0) (not false)) (= |$rhs#0@0| 0)) (= |$rhs#1@0| 0)) (and (and (and (<= |lo#0| |i#0@0|) (<= |i#0@0| |hi#0|)) (forall (($o@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2)))
 :qid |ForLoopsCompilationdfy.60:3|
 :skolemid |521|
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |$rhs#0@0| (LitInt 0)) (= |$rhs#1@0| (LitInt 0))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= |lo#0| |hi#0|)) (=> (<= |lo#0| |hi#0|) (=> (= (ControlFlow 0 16) 15) anon12_LoopHead_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 0 $FunctionContextHeight)) (and (<= |lo#0| |hi#0|) (= (ControlFlow 0 18) 16))) anon0_correct)))
