...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@1 Int) (|y#0@@1| Int) ) (!  (=> (or (|_module.uint32WithMethods.plus__overflow#canCall| this@@1 |y#0@@1|) (and (< 1 $FunctionContextHeight) (and (and (<= (LitInt 0) this@@1) (< this@@1 4294967296)) (and (<= (LitInt 0) |y#0@@1|) (< |y#0@@1| 4294967296))))) (and (<= (LitInt 0) (_module.uint32WithMethods.plus__overflow this@@1 |y#0@@1|)) (< (_module.uint32WithMethods.plus__overflow this@@1 |y#0@@1|) 4294967296)))
 :qid |newtypesdfy.37:12|
 :skolemid |591|
 :pattern ( (_module.uint32WithMethods.plus__overflow this@@1 |y#0@@1|))
))))
