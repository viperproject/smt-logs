...
(set-info :boogie-vc-id CheckWellFormed$$_module.MyBv)
...
(let ((anon8_Else_correct  (=> (and (not (bvule #b0010 |x#0|)) (= (ControlFlow 0 6) 4)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (bvule #b0010 |x#0|) (= (ControlFlow 0 5) 4)) anon4_correct)))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (bvule #b0010 #b0111)) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (Lit boolType (bool_2_U (bvult #b0111 #b1010))))))))
