...
(declare-fun $generated@@85 () (_ BitVec 4))
...
(let (($generated@@94  (=> (and (not (bvule #b0010 $generated@@85)) (= (ControlFlow 0 6) 4)) $generated@@93)))
(let (($generated@@95  (=> (and (bvule #b0010 $generated@@85) (= (ControlFlow 0 5) 4)) $generated@@93)))
(let (($generated@@96  (and (=> (= (ControlFlow 0 2) (- 0 3)) (bvule #b0010 #b0111)) (=> (= (ControlFlow 0 2) (- 0 1)) ($generated@@5 ($generated $generated@@1 ($generated@@4 (bvult #b0111 #b1010))))))))
