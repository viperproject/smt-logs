// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/CoverageReport.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/CoverageReport-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/CoverageReport.dfy
...
// function declaration for _module._default.FunctionNeverCalled
function _module.__default.FunctionNeverCalled() : int
uses {
// definition axiom for _module.__default.FunctionNeverCalled (revealed)
axiom {:id "id0"} _module.__default.FunctionNeverCalled() == LitInt(75);
// definition axiom for _module.__default.FunctionNeverCalled for all literals (revealed)
axiom {:id "id1"} _module.__default.FunctionNeverCalled() == LitInt(75);
}

function _module.__default.FunctionNeverCalled#canCall() : bool;

function _module.__default.FunctionNeverCalled#requires() : bool
uses {
// #requires axiom for _module.__default.FunctionNeverCalled
axiom _module.__default.FunctionNeverCalled#requires() == true;
}
...
axiom (forall $ly: LayerType, n#0: int :: 
  ...
  _module.__default.Fib#canCall(n#0) || LitInt(0) <= n#0
...
axiom {:id "id2"} (forall $ly: LayerType, n#0: int :: 
  { _module.__default.Fib($LS($ly), n#0) } 
  _module.__default.Fib#canCall(n#0) || LitInt(0) <= n#0
     ==> (2 <= n#0
         ==> 
...
axiom {:id "id3"} (forall $ly: LayerType, n#0: int :: 
  {:weight 3} { _module.__default.Fib($LS($ly), LitInt(n#0)) } 
  _module.__default.Fib#canCall(LitInt(n#0)) || LitInt(0) <= n#0
     ==> (!Lit(n#0 < 2)
         ==> 
        !Lit(false)
...
axiom (forall $ly: LayerType, n#0: int :: 
  { _module.__default.Factorial($ly, n#0) } 
  _module.__default.Factorial#canCall(n#0) || LitInt(0) <= n#0
...
axiom {:id "id4"} (forall $ly: LayerType, n#0: int :: 
  { _module.__default.Factorial($LS($ly), n#0) } 
  _module.__default.Factorial#canCall(n#0) || LitInt(0) <= n#0
...
axiom {:id "id5"} (forall $ly: LayerType, n#0: int :: 
  {:weight 3} { _module.__default.Factorial($LS($ly), LitInt(n#0)) } 
  _module.__default.Factorial#canCall(LitInt(n#0)) || LitInt(0) <= n#0
     ==> (LitInt(n#0) != LitInt(0)
