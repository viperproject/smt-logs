...
(assert (distinct TInt TagInt alloc Tagclass._System.array? Tagclass._System.array Tagclass.TypeSpecialization.byte tytagFamily$array tytagFamily$byte)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((bx@@0 T@U) ) (!  (=> ($IsBox bx@@0 Tclass.TypeSpecialization.byte) (and (= ($Box intType ($Unbox intType bx@@0)) bx@@0) ($Is intType ($Unbox intType bx@@0) Tclass.TypeSpecialization.byte)))
 :qid |unknown.0:0|
 :skolemid |6008|
 :pattern ( ($IsBox bx@@0 Tclass.TypeSpecialization.byte))
)))
...
(declare-fun TypeSpecialization._default.Byte$T () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$TypeSpecialization.__default.Byte)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap alloc |a#0| |b#0|)) (and (=> (= (ControlFlow 0 2) (- 0 15)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 14)) (and (<= 0 (LitInt 20)) (< (LitInt 20) (_System.array.Length |a#0|)))) (=> (and (<= 0 (LitInt 20)) (< (LitInt 20) (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField (LitInt 20))))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField (LitInt 20)))) (=> (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap |a#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField (LitInt 20)) |t#0|))) ($IsGoodHeap $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 12)) (or (not (= |b#0| null)) (not true))) (=> (or (not (= |b#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 11)) (and (<= 0 (LitInt 20)) (< (LitInt 20) (_System.array.Length |b#0|)))) (=> (and (<= 0 (LitInt 20)) (< (LitInt 20) (_System.array.Length |b#0|))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |b#0| (IndexField (LitInt 20))))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |b#0| (IndexField (LitInt 20)))) (=> (= |newtype$check#0@0| (LitInt 69)) (and (=> (= (ControlFlow 0 2) (- 0 9)) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 256))) (=> (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 256)) (=> (= |$rhs#1@0| (LitInt 69)) (=> (and (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 |b#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |b#0|) (IndexField (LitInt 20)) ($Box intType (int_2_U |$rhs#1@0|))))) ($IsGoodHeap $Heap@1)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (or (not (= |b#0| null)) (not true))) (=> (or (not (= |b#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (and (<= 0 (LitInt 21)) (< (LitInt 21) (_System.array.Length |b#0|)))) (=> (and (<= 0 (LitInt 21)) (< (LitInt 21) (_System.array.Length |b#0|))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |b#0| (IndexField (LitInt 21))))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |b#0| (IndexField (LitInt 21)))) (=> (= |newtype$check#1@0| (LitInt 69)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 256))) (=> (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 256)) (=> (= |$rhs#2@0| (LitInt 69)) (=> (and (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 |b#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b#0|) (IndexField (LitInt 21)) ($Box intType (int_2_U |$rhs#2@0|))))) ($IsGoodHeap $Heap@2)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 (LitInt 21)) (< (LitInt 21) (_System.array.Length |a#0|)))) (=> (and (<= 0 (LitInt 21)) (< (LitInt 21) (_System.array.Length |a#0|))) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField (LitInt 21)))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |a#0| (Tclass._System.array TypeSpecialization._default.Byte$T)) ($IsAlloc refType |a#0| (Tclass._System.array TypeSpecialization._default.Byte$T) $Heap))) (=> (and (and (and ($Is refType |b#0| (Tclass._System.array Tclass.TypeSpecialization.byte)) ($IsAlloc refType |b#0| (Tclass._System.array Tclass.TypeSpecialization.byte) $Heap)) (and ($IsBox |t#0| TypeSpecialization._default.Byte$T) ($IsAllocBox |t#0| TypeSpecialization._default.Byte$T $Heap))) (and (and (= 1 $FunctionContextHeight) (= (_System.array.Length |a#0|) (_System.array.Length |b#0|))) (and (= (_System.array.Length |b#0|) (LitInt 100)) (= (ControlFlow 0 16) 2)))) anon0_correct))))
