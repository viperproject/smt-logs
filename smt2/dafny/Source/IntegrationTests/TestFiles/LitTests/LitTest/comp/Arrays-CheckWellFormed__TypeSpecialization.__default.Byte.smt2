...
(set-info :boogie-vc-id CheckWellFormed$$TypeSpecialization.__default.Byte)
...
(let ((anon4_Else_correct  (=> (and (or (not (= (_System.array.Length |a#0|) (_System.array.Length |b#0|))) (not true)) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon4_Then_correct  (=> (= (_System.array.Length |a#0|) (_System.array.Length |b#0|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |b#0| null)) (not true))) (=> (or (not (= |b#0| null)) (not true)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap alloc |a#0| |b#0|)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= |b#0| null)) (not true))) (=> (or (not (= |b#0| null)) (not true)) (and (=> (= (ControlFlow 0 5) 2) anon4_Then_correct) (=> (= (ControlFlow 0 5) 4) anon4_Else_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array TypeSpecialization._default.Byte$T)) ($IsAlloc refType |a#0| (Tclass._System.array TypeSpecialization._default.Byte$T) $Heap)) (and ($Is refType |b#0| (Tclass._System.array Tclass.TypeSpecialization.byte)) ($IsAlloc refType |b#0| (Tclass._System.array Tclass.TypeSpecialization.byte) $Heap))) (and (and ($IsBox |t#0| TypeSpecialization._default.Byte$T) ($IsAllocBox |t#0| TypeSpecialization._default.Byte$T $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 5)))) anon0_correct))))
