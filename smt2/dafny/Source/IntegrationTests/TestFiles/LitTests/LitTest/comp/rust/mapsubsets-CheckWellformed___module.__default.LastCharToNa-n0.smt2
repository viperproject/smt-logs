...
(declare-fun _module.__default.LastCharToNat (T@U T@U) Int)
(declare-fun SeqType () T@T)
(declare-fun MapType () T@T)
(declare-fun |_module.__default.LastCharToNat#canCall| (T@U T@U) Bool)
...
(assert  (and (and (and (and (and (= (Ctor SeqType) 5) (= (Ctor MapType) 6)) (= (Ctor charType) 7)) (forall ((t0@@0 T@T) (t1 T@T) (val T@U) (m T@U) (x0 T@U) ) (! (= (MapType0Select t0@@0 t1 (MapType0Store t0@@0 t1 m x0 val) x0) val)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|str#0| T@U) (|digits#0| T@U) ) (!  (=> (or (|_module.__default.LastCharToNat#canCall| (Lit SeqType |str#0|) (Lit MapType |digits#0|)) (and (< 0 $FunctionContextHeight) (and (and ($Is SeqType |str#0| (TSeq TChar)) ($Is MapType |digits#0| (TMap TChar Tclass._System.nat))) (forall ((|c#2| T@U) ) (!  (=> (and ($Is charType |c#2| TChar) (|Seq#Contains| |str#0| ($Box charType |c#2|))) (|Set#IsMember| (|Map#Domain| |digits#0|) ($Box charType |c#2|)))
 :qid |mapsubsetsdfy.40:19|
 :skolemid |545|
 :pattern ( (|Set#IsMember| (|Map#Domain| |digits#0|) ($Box charType |c#2|)))
 :pattern ( (|Seq#Contains| |str#0| ($Box charType |c#2|)))
))))) (= (_module.__default.LastCharToNat (Lit SeqType |str#0|) (Lit MapType |digits#0|)) (ite (|Seq#Equal| |str#0| |Seq#Empty|) 0 (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType |digits#0|)) (|Seq#Index| (Lit SeqType |str#0|) (- (|Seq#Length| (Lit SeqType |str#0|)) 1))))))))
 :qid |mapsubsetsdfy.39:24|
 :weight 3
 :skolemid |546|
 :pattern ( (_module.__default.LastCharToNat (Lit SeqType |str#0|) (Lit MapType |digits#0|)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|str#0@@0| T@U) (|digits#0@@0| T@U) ) (!  (=> (or (|_module.__default.LastCharToNat#canCall| |str#0@@0| |digits#0@@0|) (and (< 0 $FunctionContextHeight) (and (and ($Is SeqType |str#0@@0| (TSeq TChar)) ($Is MapType |digits#0@@0| (TMap TChar Tclass._System.nat))) (forall ((|c#1| T@U) ) (!  (=> (and ($Is charType |c#1| TChar) (|Seq#Contains| |str#0@@0| ($Box charType |c#1|))) (|Set#IsMember| (|Map#Domain| |digits#0@@0|) ($Box charType |c#1|)))
 :qid |mapsubsetsdfy.40:19|
 :skolemid |542|
 :pattern ( (|Set#IsMember| (|Map#Domain| |digits#0@@0|) ($Box charType |c#1|)))
 :pattern ( (|Seq#Contains| |str#0@@0| ($Box charType |c#1|)))
))))) (= (_module.__default.LastCharToNat |str#0@@0| |digits#0@@0|) (ite (|Seq#Equal| |str#0@@0| |Seq#Empty|) 0 (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |digits#0@@0|) (|Seq#Index| |str#0@@0| (- (|Seq#Length| |str#0@@0|) 1))))))))
 :qid |mapsubsetsdfy.39:24|
 :skolemid |544|
 :pattern ( (_module.__default.LastCharToNat |str#0@@0| |digits#0@@0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|str#0@@1| T@U) (|digits#0@@1| T@U) ) (!  (=> (or (|_module.__default.LastCharToNat#canCall| |str#0@@1| |digits#0@@1|) (and (< 0 $FunctionContextHeight) (and (and ($Is SeqType |str#0@@1| (TSeq TChar)) ($Is MapType |digits#0@@1| (TMap TChar Tclass._System.nat))) (forall ((|c#0| T@U) ) (!  (=> (and ($Is charType |c#0| TChar) (|Seq#Contains| |str#0@@1| ($Box charType |c#0|))) (|Set#IsMember| (|Map#Domain| |digits#0@@1|) ($Box charType |c#0|)))
 :qid |mapsubsetsdfy.40:19|
 :skolemid |540|
 :pattern ( (|Set#IsMember| (|Map#Domain| |digits#0@@1|) ($Box charType |c#0|)))
 :pattern ( (|Seq#Contains| |str#0@@1| ($Box charType |c#0|)))
))))) (<= (LitInt 0) (_module.__default.LastCharToNat |str#0@@1| |digits#0@@1|)))
 :qid |mapsubsetsdfy.39:24|
 :skolemid |541|
 :pattern ( (_module.__default.LastCharToNat |str#0@@1| |digits#0@@1|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.LastCharToNat)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon12_Else_correct  (=> (not (|Seq#Equal| |str#0@@2| |Seq#Empty|)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (and (<= 0 (- (|Seq#Length| |str#0@@2|) 1)) (< (- (|Seq#Length| |str#0@@2|) 1) (|Seq#Length| |str#0@@2|)))) (=> (and (<= 0 (- (|Seq#Length| |str#0@@2|) 1)) (< (- (|Seq#Length| |str#0@@2|) 1) (|Seq#Length| |str#0@@2|))) (=> (= (ControlFlow 0 5) (- 0 4)) (|Set#IsMember| (|Map#Domain| |digits#0@@2|) (|Seq#Index| |str#0@@2| (- (|Seq#Length| |str#0@@2|) 1)))))))))
(let ((anon12_Then_correct  (=> (and (|Seq#Equal| |str#0@@2| |Seq#Empty|) (= (ControlFlow 0 3) (- 0 2))) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat))))
(let ((anon11_Then_correct true))
(let ((anon4_correct  (=> (forall ((|c#0@@0| T@U) ) (!  (=> (and ($Is charType |c#0@@0| TChar) (|Seq#Contains| |str#0@@2| ($Box charType |c#0@@0|))) (|Set#IsMember| (|Map#Domain| |digits#0@@2|) ($Box charType |c#0@@0|)))
 :qid |mapsubsetsdfy.40:19|
 :skolemid |547|
 :pattern ( (|Set#IsMember| (|Map#Domain| |digits#0@@2|) ($Box charType |c#0@@0|)))
 :pattern ( (|Seq#Contains| |str#0@@2| ($Box charType |c#0@@0|)))
)) (and (and (=> (= (ControlFlow 0 7) 1) anon11_Then_correct) (=> (= (ControlFlow 0 7) 3) anon12_Then_correct)) (=> (= (ControlFlow 0 7) 5) anon12_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (=> (|Seq#Contains| |str#0@@2| ($Box charType |c#3@0|)) (|Set#IsMember| (|Map#Domain| |digits#0@@2|) ($Box charType |c#3@0|))) (= (ControlFlow 0 9) 7)) anon4_correct)))
(let ((anon10_Then_correct  (=> (|Seq#Contains| |str#0@@2| ($Box charType |c#3@0|)) (=> (and (|Set#IsMember| (|Map#Domain| |digits#0@@2|) ($Box charType |c#3@0|)) (= (ControlFlow 0 8) 7)) anon4_correct))))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) ($Is charType |c#3@0| TChar)) (and (=> (= (ControlFlow 0 10) 8) anon10_Then_correct) (=> (= (ControlFlow 0 10) 9) anon10_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |str#0@@2| (TSeq TChar)) ($Is MapType |digits#0@@2| (TMap TChar Tclass._System.nat))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct))))
