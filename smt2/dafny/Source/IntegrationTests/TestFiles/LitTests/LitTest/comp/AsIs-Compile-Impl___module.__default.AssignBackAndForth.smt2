...
(assert (distinct TInt TagInt alloc Tagclass._System.object? Tagclass._System.object Tagclass._module.A Tagclass._module.B Tagclass._module.C Tagclass._module.K Tagclass._module.L Tagclass._module.K? Tagclass._module.L? Tagclass._module.A? Tagclass._module.B? Tagclass._module.C? tytagFamily$object tytagFamily$A tytagFamily$B tytagFamily$C tytagFamily$K tytagFamily$L)
)
...
(assert (forall ((_module.A$X@@4 T@U) ($o@@12 T@U) ($heap@@2 T@U) ) (!  (=> ($IsAlloc refType $o@@12 (Tclass._module.A? _module.A$X@@4) $heap@@2) ($IsAlloc refType $o@@12 Tclass._System.object? $heap@@2))
 :qid |unknown.0:0|
 :skolemid |701|
 :pattern ( ($IsAlloc refType $o@@12 (Tclass._module.A? _module.A$X@@4) $heap@@2))
)))
(assert (forall ((_module.K$U@@9 T@U) ($o@@13 T@U) ($heap@@3 T@U) ) (!  (=> ($IsAlloc refType $o@@13 (Tclass._module.K? _module.K$U@@9) $heap@@3) ($IsAlloc refType $o@@13 Tclass._System.object? $heap@@3))
 :qid |unknown.0:0|
 :skolemid |713|
 :pattern ( ($IsAlloc refType $o@@13 (Tclass._module.K? _module.K$U@@9) $heap@@3))
)))
(assert (forall ((_module.B$Y0@@1 T@U) (_module.B$Y1@@1 T@U) ($o@@14 T@U) ($h@@10 T@U) ) (! (= ($IsAlloc refType $o@@14 (Tclass._module.B? _module.B$Y0@@1 _module.B$Y1@@1) $h@@10)  (or (= $o@@14 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@14) alloc)))))
 :qid |unknown.0:0|
 :skolemid |609|
 :pattern ( ($IsAlloc refType $o@@14 (Tclass._module.B? _module.B$Y0@@1 _module.B$Y1@@1) $h@@10))
)))
...
(assert (forall ((_module.B$Y0@@6 T@U) (_module.B$Y1@@6 T@U) ($o@@16 T@U) ) (! (= ($Is refType $o@@16 (Tclass._module.B? _module.B$Y0@@6 _module.B$Y1@@6))  (or (= $o@@16 null) (implements$_module.B (dtype $o@@16) _module.B$Y0@@6 _module.B$Y1@@6)))
 :qid |unknown.0:0|
 :skolemid |608|
 :pattern ( ($Is refType $o@@16 (Tclass._module.B? _module.B$Y0@@6 _module.B$Y1@@6)))
)))
...
(assert (forall ((_module.A$X@@7 T@U) ($o@@17 T@U) ) (! (= ($Is refType $o@@17 (Tclass._module.A? _module.A$X@@7))  (or (= $o@@17 null) (implements$_module.A (dtype $o@@17) _module.A$X@@7)))
 :qid |unknown.0:0|
 :skolemid |600|
 :pattern ( ($Is refType $o@@17 (Tclass._module.A? _module.A$X@@7)))
)))
(assert (forall ((_module.C$Z@@8 T@U) ($o@@18 T@U) ) (! (= ($Is refType $o@@18 (Tclass._module.C? _module.C$Z@@8))  (or (= $o@@18 null) (implements$_module.C (dtype $o@@18) _module.C$Z@@8)))
 :qid |unknown.0:0|
 :skolemid |615|
 :pattern ( ($Is refType $o@@18 (Tclass._module.C? _module.C$Z@@8)))
)))
(assert (forall ((_module.B$Y0@@7 T@U) (_module.B$Y1@@7 T@U) ($o@@19 T@U) ) (!  (=> ($Is refType $o@@19 (Tclass._module.B? _module.B$Y0@@7 _module.B$Y1@@7)) ($Is refType $o@@19 Tclass._System.object?))
 :qid |unknown.0:0|
 :skolemid |704|
 :pattern ( ($Is refType $o@@19 (Tclass._module.B? _module.B$Y0@@7 _module.B$Y1@@7)))
)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@20 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@20 $f))  (=> (and (or (not (= $o@@20 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@20) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |786|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@20 $f))
)))
(assert (forall ((_module.A$X@@8 T@U) ($o@@21 T@U) ) (!  (=> ($Is refType $o@@21 (Tclass._module.A? _module.A$X@@8)) ($Is refType $o@@21 Tclass._System.object?))
 :qid |unknown.0:0|
 :skolemid |700|
 :pattern ( ($Is refType $o@@21 (Tclass._module.A? _module.A$X@@8)))
)))
(assert (forall ((_module.K$U@@12 T@U) ($o@@22 T@U) ) (!  (=> ($Is refType $o@@22 (Tclass._module.K? _module.K$U@@12)) ($Is refType $o@@22 Tclass._System.object?))
 :qid |unknown.0:0|
 :skolemid |712|
 :pattern ( ($Is refType $o@@22 (Tclass._module.K? _module.K$U@@12)))
)))
...
(assert (= (Tag Tclass._System.object) Tagclass._System.object))
(assert (= (TagFamily Tclass._System.object) tytagFamily$object))
(assert (forall ((_module.B$Y0@@10 T@U) (_module.B$Y1@@10 T@U) ($o@@23 T@U) ($heap@@4 T@U) ) (!  (=> ($IsAlloc refType $o@@23 (Tclass._module.B? _module.B$Y0@@10 _module.B$Y1@@10) $heap@@4) ($IsAlloc refType $o@@23 Tclass._System.object? $heap@@4))
 :qid |unknown.0:0|
 :skolemid |705|
 :pattern ( ($IsAlloc refType $o@@23 (Tclass._module.B? _module.B$Y0@@10 _module.B$Y1@@10) $heap@@4))
)))
...
(declare-fun |a#0| () T@U)
(declare-fun _module._default.AssignBackAndForth$W () T@U)
(declare-fun |b#0| () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.AssignBackAndForth)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and ($Is refType |o#0@0| Tclass._System.object?) ($IsAlloc refType |o#0@0| Tclass._System.object? $Heap)) (and (=> (= (ControlFlow 0 2) (- 0 16)) ($Is refType |a#0| (Tclass._module.A _module._default.AssignBackAndForth$W))) (=> ($Is refType |a#0| (Tclass._module.A _module._default.AssignBackAndForth$W)) (and (=> (= (ControlFlow 0 2) (- 0 15)) ($Is refType |b#0| (Tclass._module.B TInt _module._default.AssignBackAndForth$W))) (=> ($Is refType |b#0| (Tclass._module.B TInt _module._default.AssignBackAndForth$W)) (and (=> (= (ControlFlow 0 2) (- 0 14)) ($Is refType |c#0@@11| (Tclass._module.C _module._default.AssignBackAndForth$W))) (=> ($Is refType |c#0@@11| (Tclass._module.C _module._default.AssignBackAndForth$W)) (and (=> (= (ControlFlow 0 2) (- 0 13)) ($Is refType |k#0| (Tclass._module.K _module._default.AssignBackAndForth$W))) (=> ($Is refType |k#0| (Tclass._module.K _module._default.AssignBackAndForth$W)) (and (=> (= (ControlFlow 0 2) (- 0 12)) ($Is refType |l#0@@0| (Tclass._module.L _module._default.AssignBackAndForth$W))) (=> ($Is refType |l#0@@0| (Tclass._module.L _module._default.AssignBackAndForth$W)) (and (=> (= (ControlFlow 0 2) (- 0 11)) true) (and (=> (= (ControlFlow 0 2) (- 0 10)) true) (and (=> (= (ControlFlow 0 2) (- 0 9)) true) (and (=> (= (ControlFlow 0 2) (- 0 8)) true) (and (=> (= (ControlFlow 0 2) (- 0 7)) true) (and (=> (= (ControlFlow 0 2) (- 0 6)) (= |a#0| |a#0|)) (=> (= |a#0| |a#0|) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= |b#0| |b#0|)) (=> (= |b#0| |b#0|) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= |c#0@@11| |c#0@@11|)) (=> (= |c#0@@11| |c#0@@11|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= |k#0| |k#0|)) (=> (= |k#0| |k#0|) (=> (= (ControlFlow 0 2) (- 0 1)) (= |l#0@@0| |l#0@@0|)))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |a#0| (Tclass._module.A _module._default.AssignBackAndForth$W)) ($IsAlloc refType |a#0| (Tclass._module.A _module._default.AssignBackAndForth$W) $Heap)) (and ($Is refType |b#0| (Tclass._module.B TInt _module._default.AssignBackAndForth$W)) ($IsAlloc refType |b#0| (Tclass._module.B TInt _module._default.AssignBackAndForth$W) $Heap))) (and (and ($Is refType |c#0@@11| (Tclass._module.C _module._default.AssignBackAndForth$W)) ($IsAlloc refType |c#0@@11| (Tclass._module.C _module._default.AssignBackAndForth$W) $Heap)) (and ($Is refType |k#0| (Tclass._module.K _module._default.AssignBackAndForth$W)) ($IsAlloc refType |k#0| (Tclass._module.K _module._default.AssignBackAndForth$W) $Heap)))) (=> (and (and (and (and ($Is refType |l#0@@0| (Tclass._module.L _module._default.AssignBackAndForth$W)) ($IsAlloc refType |l#0@@0| (Tclass._module.L _module._default.AssignBackAndForth$W) $Heap)) (=> |defass#a'#0| (and ($Is refType |a'#0| (Tclass._module.A _module._default.AssignBackAndForth$W)) ($IsAlloc refType |a'#0| (Tclass._module.A _module._default.AssignBackAndForth$W) $Heap)))) (and (and (=> |defass#b'#0| (and ($Is refType |b'#0| (Tclass._module.B TInt _module._default.AssignBackAndForth$W)) ($IsAlloc refType |b'#0| (Tclass._module.B TInt _module._default.AssignBackAndForth$W) $Heap))) (=> |defass#c'#0| (and ($Is refType |c'#0| (Tclass._module.C _module._default.AssignBackAndForth$W)) ($IsAlloc refType |c'#0| (Tclass._module.C _module._default.AssignBackAndForth$W) $Heap)))) (and (=> |defass#k'#0| (and ($Is refType |k'#0| (Tclass._module.K _module._default.AssignBackAndForth$W)) ($IsAlloc refType |k'#0| (Tclass._module.K _module._default.AssignBackAndForth$W) $Heap))) (=> |defass#l'#0| (and ($Is refType |l'#0| (Tclass._module.L _module._default.AssignBackAndForth$W)) ($IsAlloc refType |l'#0| (Tclass._module.L _module._default.AssignBackAndForth$W) $Heap)))))) (and (and (and ($Is refType |o#0| Tclass._System.object?) ($IsAlloc refType |o#0| Tclass._System.object? $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 17) 2)))) anon0_correct)))))
