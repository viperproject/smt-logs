...
(declare-fun |lambda#13| (T@U T@U Int) T@U)
...
(assert (distinct TagSet TagSeq alloc Tagclass._System.nat tytagFamily$nat)
)
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| Int) (|$y#0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#13| |l#0| |l#1| |l#2|) |$y#0|))  (and ($IsBox |$y#0| |l#0|) (and (|Set#IsMember| |l#1| |$y#0|) (< (U_2_int ($Unbox intType |$y#0|)) |l#2|))))
 :qid |unknown.0:0|
 :skolemid |1318|
 :pattern ( (MapType0Select BoxType boolType (|lambda#13| |l#0| |l#1| |l#2|) |$y#0|))
)))
...
(assert (forall ((|l#0@@0| T@U) (|l#1@@0| T@U) (|l#2@@0| Int) (|$y#1| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#14| |l#0@@0| |l#1@@0| |l#2@@0|) |$y#1|))  (and ($IsBox |$y#1| |l#0@@0|) (and (|Set#IsMember| |l#1@@0| |$y#1|) (< |l#2@@0| (U_2_int ($Unbox intType |$y#1|))))))
 :qid |unknown.0:0|
 :skolemid |1319|
 :pattern ( (MapType0Select BoxType boolType (|lambda#14| |l#0@@0| |l#1@@0| |l#2@@0|) |$y#1|))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.SetToSeq)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon16_correct  (=> (= |larger#0@0| (|Set#FromBoogieMap| (|lambda#14| Tclass._System.nat |S#0| |x#0@0|))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (|Set#Subset| |smaller#0@0| |S#0|) (not (|Set#Subset| |S#0| |smaller#0@0|)))) (=> (and (|Set#Subset| |smaller#0@0| |S#0|) (not (|Set#Subset| |S#0| |smaller#0@0|))) (=> (and (and ($Is SeqType |call2formal@r#0| (TSeq Tclass._System.nat)) ($IsAlloc SeqType |call2formal@r#0| (TSeq Tclass._System.nat) $Heap)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (=> (and (and (and ($Is SeqType |call2formal@r#0@0| (TSeq Tclass._System.nat)) ($IsAlloc SeqType |call2formal@r#0@0| (TSeq Tclass._System.nat) $Heap@0)) (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |TailRecursiondfy.214:8|
 :skolemid |1192|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0))
))) (and ($HeapSucc $Heap $Heap@0) (= (ControlFlow 0 3) (- 0 2)))) (and (|Set#Subset| |larger#0@0| |S#0|) (not (|Set#Subset| |S#0| |larger#0@0|))))))))))
(let ((anon24_Else_correct  (=> (and (not (and (|Set#IsMember| |S#0| ($Box intType (int_2_U |y#2@0|))) (< |x#0@0| |y#2@0|))) (= (ControlFlow 0 7) 3)) anon16_correct)))
(let ((anon24_Then_correct  (=> (and (and (|Set#IsMember| |S#0| ($Box intType (int_2_U |y#2@0|))) (< |x#0@0| |y#2@0|)) (= (ControlFlow 0 6) 3)) anon16_correct)))
(let ((anon23_Else_correct  (=> (not (|Set#IsMember| |S#0| ($Box intType (int_2_U |y#2@0|)))) (and (=> (= (ControlFlow 0 9) 6) anon24_Then_correct) (=> (= (ControlFlow 0 9) 7) anon24_Else_correct)))))
(let ((anon23_Then_correct  (=> (|Set#IsMember| |S#0| ($Box intType (int_2_U |y#2@0|))) (and (=> (= (ControlFlow 0 8) 6) anon24_Then_correct) (=> (= (ControlFlow 0 8) 7) anon24_Else_correct)))))
(let ((anon22_Then_correct  (=> (<= (LitInt 0) |y#2@0|) (and (=> (= (ControlFlow 0 10) 8) anon23_Then_correct) (=> (= (ControlFlow 0 10) 9) anon23_Else_correct)))))
(let ((anon22_Else_correct  (=> (and (< |y#2@0| (LitInt 0)) (= (ControlFlow 0 5) 3)) anon16_correct)))
(let ((anon11_correct  (=> (= |smaller#0@0| (|Set#FromBoogieMap| (|lambda#13| Tclass._System.nat |S#0| |x#0@0|))) (and (=> (= (ControlFlow 0 11) 10) anon22_Then_correct) (=> (= (ControlFlow 0 11) 5) anon22_Else_correct)))))
(let ((anon21_Else_correct  (=> (and (not (and (|Set#IsMember| |S#0| ($Box intType (int_2_U |y#0@0|))) (< |y#0@0| |x#0@0|))) (= (ControlFlow 0 14) 11)) anon11_correct)))
(let ((anon21_Then_correct  (=> (and (and (|Set#IsMember| |S#0| ($Box intType (int_2_U |y#0@0|))) (< |y#0@0| |x#0@0|)) (= (ControlFlow 0 13) 11)) anon11_correct)))
(let ((anon20_Else_correct  (=> (not (|Set#IsMember| |S#0| ($Box intType (int_2_U |y#0@0|)))) (and (=> (= (ControlFlow 0 16) 13) anon21_Then_correct) (=> (= (ControlFlow 0 16) 14) anon21_Else_correct)))))
(let ((anon20_Then_correct  (=> (|Set#IsMember| |S#0| ($Box intType (int_2_U |y#0@0|))) (and (=> (= (ControlFlow 0 15) 13) anon21_Then_correct) (=> (= (ControlFlow 0 15) 14) anon21_Else_correct)))))
(let ((anon19_Then_correct  (=> (<= (LitInt 0) |y#0@0|) (and (=> (= (ControlFlow 0 17) 15) anon20_Then_correct) (=> (= (ControlFlow 0 17) 16) anon20_Else_correct)))))
(let ((anon19_Else_correct  (=> (and (< |y#0@0| (LitInt 0)) (= (ControlFlow 0 12) 11)) anon11_correct)))
(let ((anon6_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (|Set#IsMember| |S#0| ($Box intType (int_2_U (LitInt 0))))) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (|Set#IsMember| |S#0| ($Box intType (int_2_U (LitInt 0))))) (exists ((|$as#x0#0| T@U) ) (!  (and (<= (LitInt 0) (U_2_int |$as#x0#0|)) (|Set#IsMember| |S#0| ($Box intType |$as#x0#0|)))
 :qid |TailRecursiondfy.218:7|
 :skolemid |1194|
 ...
 :qid |TailRecursiondfy.218:7|
 :skolemid |1194|
)))) (=> (and (<= (LitInt 0) |x#0@0|) (|Set#IsMember| |S#0| ($Box intType (int_2_U |x#0@0|)))) (and (=> (= (ControlFlow 0 18) 17) anon19_Then_correct) (=> (= (ControlFlow 0 18) 12) anon19_Else_correct)))))))
(let ((anon18_Else_correct  (=> (and (< |x#1@0| (LitInt 0)) (= (ControlFlow 0 21) 18)) anon6_correct)))
(let ((anon18_Then_correct  (=> (and (<= (LitInt 0) |x#1@0|) (= (ControlFlow 0 20) 18)) anon6_correct)))
(let ((anon17_Else_correct  (=> (not (|Set#Equal| |S#0| |Set#Empty|)) (and (=> (= (ControlFlow 0 22) 20) anon18_Then_correct) (=> (= (ControlFlow 0 22) 21) anon18_Else_correct)))))
(let ((anon17_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 23) 1) anon17_Then_correct) (=> (= (ControlFlow 0 23) 22) anon17_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SetType |S#0| (TSet Tclass._System.nat)) ($IsAlloc SetType |S#0| (TSet Tclass._System.nat) $Heap))) (=> (and (and (and ($Is SeqType |r#0| (TSeq Tclass._System.nat)) ($IsAlloc SeqType |r#0| (TSeq Tclass._System.nat) $Heap)) (and (<= (LitInt 0) |x#0@@1|) true)) (and (and ($Is SetType |smaller#0| (TSet Tclass._System.nat)) ($IsAlloc SetType |smaller#0| (TSet Tclass._System.nat) $Heap)) true)) (=> (and (and (and (and ($Is SetType |larger#0| (TSet Tclass._System.nat)) ($IsAlloc SetType |larger#0| (TSet Tclass._System.nat) $Heap)) true) (and (and ($Is SeqType |s#0| (TSeq Tclass._System.nat)) ($IsAlloc SeqType |s#0| (TSeq Tclass._System.nat) $Heap)) true)) (and (and (and ($Is SeqType |l#0@@2| (TSeq Tclass._System.nat)) ($IsAlloc SeqType |l#0@@2| (TSeq Tclass._System.nat) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 24) 23)))) anon0_correct)))))
