...
(let ((anon6_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (|Set#IsMember| |S#0| ($Box intType (int_2_U (LitInt 0))))) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (|Set#IsMember| |S#0| ($Box intType (int_2_U (LitInt 0))))) (exists ((|$as#x0#0| T@U) )  (and (<= (LitInt 0) (U_2_int |$as#x0#0|)) (|Set#IsMember| |S#0| ($Box intType |$as#x0#0|))))))) (=> (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (|Set#IsMember| |S#0| ($Box intType (int_2_U (LitInt 0))))) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (|Set#IsMember| |S#0| ($Box intType (int_2_U (LitInt 0))))) (exists ((|$as#x0#0@@0| Int) )  (and (<= (LitInt 0) |$as#x0#0@@0|) (|Set#IsMember| |S#0| ($Box intType (int_2_U |$as#x0#0@@0|))))))) (=> (and (<= (LitInt 0) |x#0@0|) (|Set#IsMember| |S#0| ($Box intType (int_2_U |x#0@0|)))) (and (=> (= (ControlFlow 0 18) 17) anon19_Then_correct) (=> (= (ControlFlow 0 18) 12) anon19_Else_correct)))))))
