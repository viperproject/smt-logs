...
(assert (forall ((TypeSynonym.buffer$T@@0 T@U) ) (!  (and (= (Tag (Tclass.TypeSynonym.buffer TypeSynonym.buffer$T@@0)) Tagclass.TypeSynonym.buffer) (= (TagFamily (Tclass.TypeSynonym.buffer TypeSynonym.buffer$T@@0)) tytagFamily$buffer))
 :pattern ( (Tclass.TypeSynonym.buffer TypeSynonym.buffer$T@@0))
)))
...
(assert (forall ((TypeSynonym.buffer$T@@1 T@U) (|a#0@@0| T@U) ) (! (= ($Is refType |a#0@@0| (Tclass.TypeSynonym.buffer TypeSynonym.buffer$T@@1))  (and ($Is refType |a#0@@0| (Tclass._System.array TypeSynonym.buffer$T@@1)) (< (_System.array.Length |a#0@@0|) 4294967296)))
 :pattern ( ($Is refType |a#0@@0| (Tclass.TypeSynonym.buffer TypeSynonym.buffer$T@@1)))
)))
