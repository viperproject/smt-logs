...
(set-info :boogie-vc-id Impl$$Arrays.Stack.U)
...
(assert (not
 ...
 :qid |Uninitializeddfy.265:20|
 :skolemid |3905|
))) (=> (forall (($o@@11 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@11 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@11) alloc)))) (= $o@@11 |a##0@0|)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@11 $f@@1)))
 :qid |Uninitializeddfy.265:20|
 :skolemid |3905|
)) (=> (and (and ($Is refType |call4formal@r#0| (Tclass._System.array call0formal@Arrays._default.Update$T)) ($IsAlloc refType |call4formal@r#0| (Tclass._System.array call0formal@Arrays._default.Update$T) $Heap)) (and (= call0formal@Arrays._default.Update$T@0 (Tclass.Arrays.MaybeInitialized Arrays.Stack$T@@15)) (= |call2formal@t#0@0| ($Box DatatypeTypeType |t##0@0|)))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and ($Is refType |call4formal@r#0@0| (Tclass._System.array call0formal@Arrays._default.Update$T@0)) ($IsAlloc refType |call4formal@r#0@0| (Tclass._System.array call0formal@Arrays._default.Update$T@0) $Heap@0))) (and (and (forall (($o@@12 T@U) ) (!  (=> (and (or (not (= $o@@12 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@12) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@12) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@12)) (= $o@@12 |a##0@0|)))
 :qid |Uninitializeddfy.271:10|
 :skolemid |3840|
 ...
 :qid |Uninitializeddfy.266:20|
 :skolemid |3906|
))) (=> (forall (($o@@14 T@U) ($f@@3 T@U) ) (!  (=> (and (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@14) alloc)))) (= $o@@14 |a##1@0|)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@14 $f@@3)))
 :qid |Uninitializeddfy.266:20|
 :skolemid |3906|
)) (=> (and ($Is refType |call4formal@r#0@@0| (Tclass._System.array call0formal@Arrays._default.Update$T@@0)) ($IsAlloc refType |call4formal@r#0@@0| (Tclass._System.array call0formal@Arrays._default.Update$T@@0) $Heap)) (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (and ($Is refType |call4formal@r#0@0@@0| (Tclass._System.array Arrays.Stack$T@@15)) ($IsAlloc refType |call4formal@r#0@0@@0| (Tclass._System.array Arrays.Stack$T@@15) $Heap@2))) (and (and (forall (($o@@15 T@U) ) (!  (=> (and (or (not (= $o@@15 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@15) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@15) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@15)) (= $o@@15 |a##1@0|)))
 :qid |Uninitializeddfy.271:10|
 :skolemid |3840|
