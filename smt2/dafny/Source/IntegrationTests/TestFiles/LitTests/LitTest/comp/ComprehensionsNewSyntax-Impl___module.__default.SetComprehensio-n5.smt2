...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|$y#0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#9| |l#0| |l#1|) |$y#0|))  (and ($IsBox |$y#0| |l#0|) (|Set#IsMember| |l#1| |$y#0|)))
 :qid |unknown.0:0|
 :skolemid |1206|
...
(let ((anon9_correct  (=> (= |bb#0@0| (|Set#FromBoogieMap| (|lambda#9| Tclass._module.ClassB |s#0@0|))) (and (=> (= (ControlFlow 0 6) 5) anon19_Then_correct) (=> (= (ControlFlow 0 6) 2) anon19_Else_correct)))))
...
(let ((anon6_correct  (=> (= |aa#0@0| (|Set#FromBoogieMap| (|lambda#9| Tclass._module.ClassA |s#0@0|))) (and (=> (= (ControlFlow 0 11) 10) anon17_Then_correct) (=> (= (ControlFlow 0 11) 7) anon17_Else_correct)))))
...
(let ((anon3_correct  (=> (= |all#0@0| (|Set#FromBoogieMap| (|lambda#9| Tclass._System.object |s#0@0|))) (and (=> (= (ControlFlow 0 16) 15) anon15_Then_correct) (=> (= (ControlFlow 0 16) 12) anon15_Else_correct)))))
