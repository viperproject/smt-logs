...
(assert (distinct TInt TagInt alloc Tagclass.TraitDefinitions.SubTrait Tagclass.All.Y Tagclass.TraitDefinitions.SuperTrait Tagclass.All.Y? Tagclass.TraitDefinitions.NoMemberTrait Tagclass.TraitDefinitions.NoMemberTrait2 Tagclass.TraitDefinitions.NoMemberTrait? Tagclass.TraitDefinitions.NoMemberTrait2? Tagclass.TraitDefinitions.SuperTrait? Tagclass.TraitDefinitions.SubTrait? tytagFamily$SubTrait tytagFamily$Y tytagFamily$SuperTrait tytagFamily$NoMemberTrait tytagFamily$NoMemberTrait2)
)
...
(assert (forall ((All.Y$I@@3 T@U) (|c#0@@4| T@U) ) (! (= ($Is refType |c#0@@4| (Tclass.All.Y All.Y$I@@3))  (and ($Is refType |c#0@@4| (Tclass.All.Y? All.Y$I@@3)) (or (not (= |c#0@@4| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |2173|
 :pattern ( ($Is refType |c#0@@4| (Tclass.All.Y All.Y$I@@3)))
 :pattern ( ($Is refType |c#0@@4| (Tclass.All.Y? All.Y$I@@3)))
)))
(assert (forall ((All.Y$I@@4 T@U) ) (!  (and (= (Tag (Tclass.All.Y All.Y$I@@4)) Tagclass.All.Y) (= (TagFamily (Tclass.All.Y All.Y$I@@4)) tytagFamily$Y))
 :qid |unknown.0:0|
 :skolemid |2069|
 :pattern ( (Tclass.All.Y All.Y$I@@4))
)))
...
(assert (forall ((TraitDefinitions.SubTrait$T@@0 T@U) (TraitDefinitions.SubTrait$I@@0 T@U) (|c#0@@5| T@U) ($h@@7 T@U) ) (! (= ($IsAlloc refType |c#0@@5| (Tclass.TraitDefinitions.SubTrait TraitDefinitions.SubTrait$T@@0 TraitDefinitions.SubTrait$I@@0) $h@@7) ($IsAlloc refType |c#0@@5| (Tclass.TraitDefinitions.SubTrait? TraitDefinitions.SubTrait$T@@0 TraitDefinitions.SubTrait$I@@0) $h@@7))
 :qid |unknown.0:0|
 :skolemid |2271|
 :pattern ( ($IsAlloc refType |c#0@@5| (Tclass.TraitDefinitions.SubTrait TraitDefinitions.SubTrait$T@@0 TraitDefinitions.SubTrait$I@@0) $h@@7))
 :pattern ( ($IsAlloc refType |c#0@@5| (Tclass.TraitDefinitions.SubTrait? TraitDefinitions.SubTrait$T@@0 TraitDefinitions.SubTrait$I@@0) $h@@7))
)))
(assert (forall ((All.Y$I@@6 T@U) ($o@@4 T@U) ) (! (= ($Is refType $o@@4 (Tclass.All.Y? All.Y$I@@6))  (or (= $o@@4 null) (= (dtype $o@@4) (Tclass.All.Y? All.Y$I@@6))))
 :qid |unknown.0:0|
 :skolemid |2116|
 :pattern ( ($Is refType $o@@4 (Tclass.All.Y? All.Y$I@@6)))
)))
(assert (forall ((All.Y$I@@7 T@U) ($o@@5 T@U) ($heap T@U) ) (!  (=> ($IsAlloc refType $o@@5 (Tclass.All.Y? All.Y$I@@7) $heap) ($IsAlloc refType $o@@5 (Tclass.TraitDefinitions.SubTrait? TInt All.Y$I@@7) $heap))
 :qid |unknown.0:0|
 :skolemid |2287|
 :pattern ( ($IsAlloc refType $o@@5 (Tclass.All.Y? All.Y$I@@7) $heap))
)))
...
(assert (forall ((TraitDefinitions.SubTrait$T@@1 T@U) (TraitDefinitions.SubTrait$I@@1 T@U) ($o@@8 T@U) ($h@@8 T@U) ) (! (= ($IsAlloc refType $o@@8 (Tclass.TraitDefinitions.SubTrait? TraitDefinitions.SubTrait$T@@1 TraitDefinitions.SubTrait$I@@1) $h@@8)  (or (= $o@@8 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@8) alloc)))))
 :qid |unknown.0:0|
 :skolemid |2264|
 :pattern ( ($IsAlloc refType $o@@8 (Tclass.TraitDefinitions.SubTrait? TraitDefinitions.SubTrait$T@@1 TraitDefinitions.SubTrait$I@@1) $h@@8))
)))
...
(assert (forall ((TraitDefinitions.SubTrait$T@@6 T@U) (TraitDefinitions.SubTrait$I@@6 T@U) ($o@@9 T@U) ) (! (= ($Is refType $o@@9 (Tclass.TraitDefinitions.SubTrait? TraitDefinitions.SubTrait$T@@6 TraitDefinitions.SubTrait$I@@6))  (or (= $o@@9 null) (implements$TraitDefinitions.SubTrait (dtype $o@@9) TraitDefinitions.SubTrait$T@@6 TraitDefinitions.SubTrait$I@@6)))
 :qid |unknown.0:0|
 :skolemid |2263|
 :pattern ( ($Is refType $o@@9 (Tclass.TraitDefinitions.SubTrait? TraitDefinitions.SubTrait$T@@6 TraitDefinitions.SubTrait$I@@6)))
)))
(assert (forall ((All.Y$I@@8 T@U) ) (! (= (Tclass.All.Y_0 (Tclass.All.Y All.Y$I@@8)) All.Y$I@@8)
 :qid |unknown.0:0|
 :skolemid |2070|
 :pattern ( (Tclass.All.Y All.Y$I@@8))
)))
(assert (forall ((All.Y$I@@9 T@U) ) (! (= (Tclass.All.Y?_0 (Tclass.All.Y? All.Y$I@@9)) All.Y$I@@9)
 :qid |unknown.0:0|
 :skolemid |2091|
...
(assert (forall ((TraitDefinitions.SubTrait$T@@7 T@U) (TraitDefinitions.SubTrait$I@@7 T@U) ($o@@10 T@U) ) (!  (=> ($Is refType $o@@10 (Tclass.TraitDefinitions.SubTrait? TraitDefinitions.SubTrait$T@@7 TraitDefinitions.SubTrait$I@@7)) ($Is refType $o@@10 Tclass.TraitDefinitions.SuperTrait?))
 :qid |unknown.0:0|
 :skolemid |2282|
 :pattern ( ($Is refType $o@@10 (Tclass.TraitDefinitions.SubTrait? TraitDefinitions.SubTrait$T@@7 TraitDefinitions.SubTrait$I@@7)))
)))
...
(assert (forall ((TraitDefinitions.SubTrait$T@@10 T@U) (TraitDefinitions.SubTrait$I@@10 T@U) ($o@@17 T@U) ($heap@@2 T@U) ) (!  (=> ($IsAlloc refType $o@@17 (Tclass.TraitDefinitions.SubTrait? TraitDefinitions.SubTrait$T@@10 TraitDefinitions.SubTrait$I@@10) $heap@@2) ($IsAlloc refType $o@@17 Tclass.TraitDefinitions.SuperTrait? $heap@@2))
 :qid |unknown.0:0|
 :skolemid |2283|
 :pattern ( ($IsAlloc refType $o@@17 (Tclass.TraitDefinitions.SubTrait? TraitDefinitions.SubTrait$T@@10 TraitDefinitions.SubTrait$I@@10) $heap@@2))
)))
...
(declare-fun All.Y$I@@10 () T@U)
(declare-fun Y_$_ReadsFrame@0 () T@U)
(declare-fun $Heap () T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun this () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id OverrideCheck$$All.Y.GetDFunc)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= TraitDefinitions.SubTrait$T@@11 TInt) (= TraitDefinitions.SubTrait$I@@11 All.Y$I@@10)) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (and (= Y_$_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (forall (($o@@18 T@U) ($f@@0 T@U) ) (! true
 :qid |traitsdfy.121:14|
 :skolemid |2172|
)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass.All.Y All.Y$I@@10)) ($IsAlloc refType this (Tclass.All.Y All.Y$I@@10) $Heap))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
