...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|$y#0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#3| |l#0| |l#1|) |$y#0|))  (and ($IsBox |$y#0| |l#0|) (and (|Set#Subset| ($Unbox SetType |$y#0|) |l#1|) (_module.__default.P ($Unbox SetType |$y#0|)))))
 :qid |unknown.0:0|
 :skolemid |5163|
