...
procedure {:verboseName "TypeTests.Test (correctness)"} Impl$$TypeTests.__default.Test() returns ($_reverifyPost: bool);
  free requires 5 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TypeTests.Test (correctness)"} Impl$$TypeTests.__default.Test() returns ($_reverifyPost: bool)
{
  ...
  var smallCharSet#0: Set
     where $Is(smallCharSet#0, TSet(TChar)) && $IsAlloc(smallCharSet#0, TSet(TChar), $Heap);
  var s#0: Set where $Is(s#0, TSet(TChar)) && $IsAlloc(s#0, TSet(TChar), $Heap);
  var d#0: char;
  var t#0: Set
     where $Is(t#0, TSet(Tclass.TypeTests.MyChar()))
       && $IsAlloc(t#0, TSet(Tclass.TypeTests.MyChar()), $Heap);
  var e#0: char;
  var u#0: Set
     where $Is(u#0, TSet(Tclass.TypeTests.Little()))
       && $IsAlloc(u#0, TSet(Tclass.TypeTests.Little()), $Heap);
  var ltl#0: int;
  ...
  var newtype$check#5: int;
    ...
    // AddMethodImpl: Test, Impl$$TypeTests.__default.Test
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(666,11)
    assume true;
    assume true;
    r#0 := LitReal(314e-2);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(667,11)
    assume true;
    assume true;
    i#0 := LitInt(100);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(668,12)
    assume true;
    assume true;
    ch#0 := Lit(char#FromInt(99));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(669,22)
    assume true;
    assume true;
    ord#0 := Lit(ORD#FromNat(9876));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(670,17)
    assume true;
    assume true;
    b7#0 := Lit(77bv7);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(671,21)
    assume true;
    assume true;
    b129#0 := Lit(129bv129);
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(673,5)
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(674,5)
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(675,5)
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(676,5)
    newtype$check#0 := ord#0;
    assert {:id "id161"} ORD#IsNat(newtype$check#0);
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(677,5)
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(678,5)
    assume true;
    assume true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(680,33)
    assume true;
    assume true;
    smallCharSet#0 := Lit(Set#UnionOne(Set#UnionOne(Set#UnionOne(Set#UnionOne(Set#UnionOne(Set#UnionOne(Set#Empty(): Set, $Box(Lit(char#FromInt(55)))), 
                $Box(Lit(char#FromInt(68)))), 
              $Box(Lit(char#FromInt(88)))), 
            $Box(Lit(char#FromInt(100)))), 
          $Box(Lit(char#FromInt(120)))), 
        $Box(Lit(char#FromInt(64)))));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(681,11)
    assume true;
    // Begin Comprehension WF check
    havoc d#0;
    if ($Is(d#0, TChar))
    {
        if (Set#IsMember(smallCharSet#0, $Box(d#0)))
        {
        }
    }
    ...
    assume true;
    s#0 := Set#FromBoogieMap((lambda $y#0: Box :: $IsBox($y#0, TChar) && Set#IsMember(smallCharSet#0, $y#0)));
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(682,5)
    assume true;
    assume true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(684,11)
    assume true;
    // Begin Comprehension WF check
    havoc e#0;
    if ($Is(e#0, Tclass.TypeTests.MyChar()))
    {
        if (Set#IsMember(s#0, $Box(e#0)))
        {
        }
    }
    ...
    t#0 := Set#FromBoogieMap((lambda $y#1: Box :: 
        $IsBox($y#1, Tclass.TypeTests.MyChar()) && Set#IsMember(s#0, $y#1)));
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(685,5)
    assume true;
    assume true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(687,11)
    assume true;
    // Begin Comprehension WF check
    havoc ltl#0;
    if (LitInt(0) <= ltl#0
       ...
       && ltl#0 != 16)
    {
        ...
        assert {:id "id165"} LitInt(0) <= newtype$check#1 && newtype$check#1 < 10000 && newtype$check#1 != 22;
        assert {:id "id166"} newtype$check#1 != 10;
        assert {:id "id167"} newtype$check#1 != 34
           && Seq#Length(Lit(TypeTests.__default.EmptySequence(TBool)))
             == Seq#Length(Lit(TypeTests.__default.EmptySequence(TChar)));
        assert {:id "id168"} newtype$check#1 < 200 && newtype$check#1 != 16;
        if (LitInt(3) <= ltl#0)
        {
            newtype$check#2 := LitInt(35);
            assert {:id "id169"} LitInt(0) <= newtype$check#2 && newtype$check#2 < 10000 && newtype$check#2 != 22;
            assert {:id "id170"} newtype$check#2 != 10;
            assert {:id "id171"} newtype$check#2 != 34
               && Seq#Length(Lit(TypeTests.__default.EmptySequence(TBool)))
                 == Seq#Length(Lit(TypeTests.__default.EmptySequence(TChar)));
            assert {:id "id172"} newtype$check#2 < 200 && newtype$check#2 != 16;
        }

        if (LitInt(3) <= ltl#0 && ltl#0 < 35)
        {
            newtype$check#3 := LitInt(3);
            assert {:id "id173"} LitInt(0) <= newtype$check#3 && newtype$check#3 < 10000 && newtype$check#3 != 22;
            assert {:id "id174"} newtype$check#3 != 10;
            assert {:id "id175"} newtype$check#3 != 34
               && Seq#Length(Lit(TypeTests.__default.EmptySequence(TBool)))
                 == Seq#Length(Lit(TypeTests.__default.EmptySequence(TChar)));
            assert {:id "id176"} newtype$check#3 < 200 && newtype$check#3 != 16;
            assert {:id "id177"} LitInt(3) != 0;
            newtype$check#4 := Mod(ltl#0, LitInt(3));
            assert {:id "id178"} LitInt(0) <= newtype$check#4 && newtype$check#4 < 10000 && newtype$check#4 != 22;
            assert {:id "id179"} newtype$check#4 != 10;
            assert {:id "id180"} newtype$check#4 != 34
               && Seq#Length(Lit(TypeTests.__default.EmptySequence(TBool)))
                 == Seq#Length(Lit(TypeTests.__default.EmptySequence(TChar)));
            assert {:id "id181"} newtype$check#4 < 200 && newtype$check#4 != 16;
            newtype$check#5 := LitInt(1);
            assert {:id "id182"} LitInt(0) <= newtype$check#5 && newtype$check#5 < 10000 && newtype$check#5 != 22;
            assert {:id "id183"} newtype$check#5 != 10;
            assert {:id "id184"} newtype$check#5 != 34
               && Seq#Length(Lit(TypeTests.__default.EmptySequence(TBool)))
                 == Seq#Length(Lit(TypeTests.__default.EmptySequence(TChar)));
            assert {:id "id185"} newtype$check#5 < 200 && newtype$check#5 != 16;
        }

        if (LitInt(3) <= ltl#0 && ltl#0 < 35 && Mod(ltl#0, LitInt(3)) == LitInt(1))
        {
        }
    }
    ...
    u#0 := Set#FromBoogieMap((lambda $y#2: Box :: 
        $IsBox($y#2, Tclass.TypeTests.Little())
           && 
          LitInt(3) <= $Unbox($y#2): int
           && $Unbox($y#2): int < 35
           && Mod($Unbox($y#2): int, LitInt(3)) == LitInt(1)));
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/comp/Numbers.dfy(688,5)
    assume true;
    assume true;
}
...
axiom {:id "id187"} 0 <= $FunctionContextHeight
   ==> (forall ch#0: char :: 
    ...
    TypeTests.__default.GoodChar#canCall(ch#0)
...
axiom {:id "id188"} 0 <= $FunctionContextHeight
   ==> (forall ch#0: char :: 
    ...
    TypeTests.__default.GoodChar#canCall(Lit(ch#0))
         || (0 < $FunctionContextHeight && $Is(ch#0, TChar))
...
procedure {:verboseName "TypeTests.GoodChar (well-formedness)"} CheckWellformed$$TypeTests.__default.GoodChar(ch#0: char where $Is(ch#0, TChar));
...
axiom 0 <= $FunctionContextHeight
   ==> (forall TypeTests._default.EmptySequence$Y: Ty :: 
    { TypeTests.__default.EmptySequence(TypeTests._default.EmptySequence$Y) } 
    TypeTests.__default.EmptySequence#canCall(TypeTests._default.EmptySequence$Y)
...
axiom 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, TypeTests._default.EmptySequence$Y: Ty :: 
...
procedure {:verboseName "TypeTests.EmptySequence (well-formedness)"} CheckWellformed$$TypeTests.__default.EmptySequence(TypeTests._default.EmptySequence$Y: Ty);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "TypeTests.MyChar (well-formedness)"} CheckWellFormed$$TypeTests.MyChar(chr#0: char);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TypeTests.MyChar (well-formedness)"} CheckWellFormed$$TypeTests.MyChar(chr#0: char)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assume $Is(chr#0, TChar);
        if (char#ToInt(Lit(char#FromInt(65))) <= char#ToInt(chr#0))
        {
        }

        assume {:id "id193"} char#ToInt(Lit(char#FromInt(65))) <= char#ToInt(chr#0)
    ...
    if (*)
    {
        ...
        assume true;
        assert {:id "id194"} {:subsumption 0} char#ToInt(Lit(char#FromInt(65))) <= char#ToInt(Lit(char#FromInt(66)));
        assert {:id "id195"} {:subsumption 0} char#ToInt(Lit(char#FromInt(66))) <= char#ToInt(Lit(char#FromInt(90)));
        assume false;
    }
}
...
procedure {:verboseName "TypeTests.Big (well-formedness)"} CheckWellFormed$$TypeTests.Big(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TypeTests.Big (well-formedness)"} CheckWellFormed$$TypeTests.Big(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assume {:id "id196"} LitInt(0) <= x#0 && x#0 < 10000;
        assume {:id "id197"} x#0 != 22;
        assume false;
    }
    ...
    if (*)
    {
        ...
        assume true;
        assert {:id "id198"} {:subsumption 0} LitInt(0) <= LitInt(0);
        assert {:id "id199"} {:subsumption 0} Lit(0 < 10000);
        assert {:id "id200"} {:subsumption 0} Lit(0 != 22);
        assume false;
    }
}
...
procedure {:verboseName "TypeTests.AnotherInBetween (well-formedness)"} CheckWellFormed$$TypeTests.AnotherInBetween(TypeTests.AnotherInBetween$HH: Ty, TypeTests.AnotherInBetween$GG: Ty, y#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TypeTests.AnotherInBetween (well-formedness)"} CheckWellFormed$$TypeTests.AnotherInBetween(TypeTests.AnotherInBetween$HH: Ty, TypeTests.AnotherInBetween$GG: Ty, y#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  ...
  var newtype$check#1: int;
    ...
    // AddWellformednessCheck for subset type AnotherInBetween
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    if (*)
    {
        // check well-formedness of subset type constraint
        assume LitInt(0) <= y#0 && y#0 < 10000 && y#0 != 22;
        newtype$check#0 := LitInt(10);
        assert {:id "id201"} LitInt(0) <= newtype$check#0 && newtype$check#0 < 10000 && newtype$check#0 != 22;
        assume {:id "id202"} y#0 != 10;
        assume false;
    }
    ...
    if (*)
    {
        ...
        assert {:id "id203"} LitInt(0) <= newtype$check#1 && newtype$check#1 < 10000 && newtype$check#1 != 22;
        assume true;
        assert {:id "id204"} Lit(0 != 10);
        assume false;
    }
}
...
procedure {:verboseName "TypeTests.SubsetInBetween (well-formedness)"} CheckWellFormed$$TypeTests.SubsetInBetween(TypeTests.SubsetInBetween$G: Ty, TypeTests.SubsetInBetween$H: Ty, y#0: int);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TypeTests.SubsetInBetween (well-formedness)"} CheckWellFormed$$TypeTests.SubsetInBetween(TypeTests.SubsetInBetween$G: Ty, TypeTests.SubsetInBetween$H: Ty, y#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var newtype$check#0: int;
  var newtype$check#1: int;
    ...
    // AddWellformednessCheck for subset type SubsetInBetween
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    if (*)
    {
        // check well-formedness of subset type constraint
        assume LitInt(0) <= y#0 && y#0 < 10000 && y#0 != 22 && y#0 != 10;
        newtype$check#0 := LitInt(34);
        assert {:id "id205"} LitInt(0) <= newtype$check#0 && newtype$check#0 < 10000 && newtype$check#0 != 22;
        assume {:id "id206"} y#0 != 34;
        assume TypeTests.__default.EmptySequence#canCall(TypeTests.SubsetInBetween$G);
        assume TypeTests.__default.EmptySequence#canCall(TypeTests.SubsetInBetween$H);
        assume {:id "id207"} Seq#Length(Lit(TypeTests.__default.EmptySequence(TypeTests.SubsetInBetween$G)))
    ...
    if (*)
    {
        // check well-formedness of subset type witness, and that it satisfies the constraint
        newtype$check#1 := LitInt(0);
        assert {:id "id208"} LitInt(0) <= newtype$check#1 && newtype$check#1 < 10000 && newtype$check#1 != 22;
        assert {:id "id209"} newtype$check#1 != 10;
        assume Lit(0 != 34)
           ==> TypeTests.__default.EmptySequence#canCall(TypeTests.SubsetInBetween$G)
             && TypeTests.__default.EmptySequence#canCall(TypeTests.SubsetInBetween$H);
        assert {:id "id210"} {:subsumption 0} Lit(0 != 34);
        assert {:id "id211"} {:subsumption 0} Seq#Length(Lit(TypeTests.__default.EmptySequence(TypeTests.SubsetInBetween$G)))
           == Seq#Length(Lit(TypeTests.__default.EmptySequence(TypeTests.SubsetInBetween$H)));
        assume false;
    }
}
...
procedure {:verboseName "TypeTests.Middle (well-formedness)"} CheckWellFormed$$TypeTests.Middle();
  free requires 3 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TypeTests.Middle (well-formedness)"} CheckWellFormed$$TypeTests.Middle()
{
  var $_ReadsFrame: [ref,Field]bool;
  var newtype$check#0: int;


    // AddWellformednessCheck for newtype Middle
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    if (*)
    {
    ...
    if (*)
    {
        ...
        assert {:id "id212"} LitInt(0) <= newtype$check#0 && newtype$check#0 < 10000 && newtype$check#0 != 22;
        assert {:id "id213"} newtype$check#0 != 10;
        assert {:id "id214"} newtype$check#0 != 34
           && Seq#Length(Lit(TypeTests.__default.EmptySequence(TBool)))
             == Seq#Length(Lit(TypeTests.__default.EmptySequence(TChar)));
        assume false;
    }
...
axiom (forall c0#0: int :: 
  { $Is(c0#0, Tclass.TypeTests.Middle()) } 
  $Is(c0#0, Tclass.TypeTests.Middle())
     <==> LitInt(0) <= c0#0
       && c0#0 < 10000
       && c0#0 != 22
...
axiom (forall c1#0: int, $h: Heap :: 
  { $IsAlloc(c1#0, Tclass.TypeTests.Middle(), $h) } 
  $IsAlloc(c1#0, Tclass.TypeTests.Middle(), $h));

const unique class.TypeTests.Middle: ClassName;

procedure {:verboseName "TypeTests.Little (well-formedness)"} CheckWellFormed$$TypeTests.Little(z#0: int);
  free requires 4 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TypeTests.Little (well-formedness)"} CheckWellFormed$$TypeTests.Little(z#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var newtype$check#0: int;
  var newtype$check#1: int;
  var newtype$check#2: int;
    ...
    if (*)
    {
        ...
        assert {:id "id215"} LitInt(0) <= newtype$check#0 && newtype$check#0 < 10000 && newtype$check#0 != 22;
        assert {:id "id216"} newtype$check#0 != 10;
        assert {:id "id217"} newtype$check#0 != 34
           && Seq#Length(Lit(TypeTests.__default.EmptySequence(TBool)))
             == Seq#Length(Lit(TypeTests.__default.EmptySequence(TChar)));
        assume {:id "id218"} z#0 < 200;
        newtype$check#1 := LitInt(16);
        assert {:id "id219"} LitInt(0) <= newtype$check#1 && newtype$check#1 < 10000 && newtype$check#1 != 22;
        assert {:id "id220"} newtype$check#1 != 10;
        assert {:id "id221"} newtype$check#1 != 34
           && Seq#Length(Lit(TypeTests.__default.EmptySequence(TBool)))
             == Seq#Length(Lit(TypeTests.__default.EmptySequence(TChar)));
        assume {:id "id222"} z#0 != 16;
        assume false;
    }
    ...
    if (*)
    {
        ...
        assert {:id "id223"} LitInt(0) <= newtype$check#2 && newtype$check#2 < 10000 && newtype$check#2 != 22;
        assert {:id "id224"} newtype$check#2 != 10;
        assert {:id "id225"} newtype$check#2 != 34
           && Seq#Length(Lit(TypeTests.__default.EmptySequence(TBool)))
             == Seq#Length(Lit(TypeTests.__default.EmptySequence(TChar)));
        assume true;
        assert {:id "id226"} {:subsumption 0} Lit(0 < 200);
        assert {:id "id227"} {:subsumption 0} Lit(0 != 16);
        assume false;
    }
}
