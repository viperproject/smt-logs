...
(assert (forall ((bx@@5 T@U) (s@@3 T@U) (t@@9 T@U) ) (!  (=> ($IsBox bx@@5 (TMap s@@3 t@@9)) (and (= ($Box MapType ($Unbox MapType bx@@5)) bx@@5) ($Is MapType ($Unbox MapType bx@@5) (TMap s@@3 t@@9))))
 :qid |DafnyPreludebpl.207:15|
 :skolemid |4513|
 :pattern ( ($IsBox bx@@5 (TMap s@@3 t@@9)))
)))
...
(assert (forall ((m@@10 T@U) (n@@1 T@U) ) (! (= (|Map#Domain| (|Map#Merge| m@@10 n@@1)) (|Set#Union| (|Map#Domain| m@@10) (|Map#Domain| n@@1)))
 :qid |DafnyPreludebpl.1476:15|
 :skolemid |4770|
 :pattern ( (|Map#Domain| (|Map#Merge| m@@10 n@@1)))
)))
...
(declare-fun |ages#0@0| () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |a#0| () T@U)
(declare-fun |b#0| () T@U)
(declare-fun |ages#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.TestMapMerge)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |a#0@0| (Lit MapType (|Map#Build| (|Map#Build| (|Map#Build| |Map#Empty| ($Box SeqType (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 114))) ($Box charType (|char#FromInt| 111))) ($Box charType (|char#FromInt| 110))) ($Box charType (|char#FromInt| 97))) ($Box charType (|char#FromInt| 108))) ($Box charType (|char#FromInt| 100))))) ($Box intType (int_2_U (LitInt 66)))) ($Box SeqType (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 106))) ($Box charType (|char#FromInt| 97))) ($Box charType (|char#FromInt| 99))) ($Box charType (|char#FromInt| 107))))) ($Box intType (int_2_U (LitInt 70)))) ($Box SeqType (Lit SeqType (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 98))) ($Box charType (|char#FromInt| 107))))) ($Box intType (int_2_U (LitInt 8))))))) (and (= |b#0@0| (Lit MapType (|Map#Build| (|Map#Build| |Map#Empty| ($Box SeqType (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 119))) ($Box charType (|char#FromInt| 101))) ($Box charType (|char#FromInt| 110))) ($Box charType (|char#FromInt| 100))) ($Box charType (|char#FromInt| 121))))) ($Box intType (int_2_U (LitInt 52)))) ($Box SeqType (Lit SeqType (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 98))) ($Box charType (|char#FromInt| 107))))) ($Box intType (int_2_U (LitInt 67)))))) (= |ages#0@0| (|Map#Merge| |a#0@0| |b#0@0|)))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (|Set#IsMember| (|Map#Domain| |ages#0@0|) ($Box SeqType (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 106))) ($Box charType (|char#FromInt| 97))) ($Box charType (|char#FromInt| 99))) ($Box charType (|char#FromInt| 107))))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ages#0@0|) ($Box SeqType (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 106))) ($Box charType (|char#FromInt| 97))) ($Box charType (|char#FromInt| 99))) ($Box charType (|char#FromInt| 107)))))))) (LitInt 70))) (=> (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ages#0@0|) ($Box SeqType (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 106))) ($Box charType (|char#FromInt| 97))) ($Box charType (|char#FromInt| 99))) ($Box charType (|char#FromInt| 107)))))))) (LitInt 70)) (and (=> (= (ControlFlow 0 2) (- 0 10)) (|Set#IsMember| (|Map#Domain| |ages#0@0|) ($Box SeqType (Lit SeqType (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 98))) ($Box charType (|char#FromInt| 107))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ages#0@0|) ($Box SeqType (Lit SeqType (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 98))) ($Box charType (|char#FromInt| 107)))))))) (LitInt 67))) (=> (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ages#0@0|) ($Box SeqType (Lit SeqType (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 98))) ($Box charType (|char#FromInt| 107)))))))) (LitInt 67)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (not (|Set#IsMember| (|Map#Domain| |ages#0@0|) ($Box SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 115))) ($Box charType (|char#FromInt| 97))) ($Box charType (|char#FromInt| 110))) ($Box charType (|char#FromInt| 100))) ($Box charType (|char#FromInt| 101))) ($Box charType (|char#FromInt| 114))) ($Box charType (|char#FromInt| 115))))))) (=> (not (|Set#IsMember| (|Map#Domain| |ages#0@0|) ($Box SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 115))) ($Box charType (|char#FromInt| 97))) ($Box charType (|char#FromInt| 110))) ($Box charType (|char#FromInt| 100))) ($Box charType (|char#FromInt| 101))) ($Box charType (|char#FromInt| 114))) ($Box charType (|char#FromInt| 115)))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (|Set#IsMember| (|Map#Domain| |ages#0@0|) ($Box SeqType (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 106))) ($Box charType (|char#FromInt| 97))) ($Box charType (|char#FromInt| 99))) ($Box charType (|char#FromInt| 107))))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (|Set#IsMember| (|Map#Domain| |ages#0@0|) ($Box SeqType (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 119))) ($Box charType (|char#FromInt| 101))) ($Box charType (|char#FromInt| 110))) ($Box charType (|char#FromInt| 100))) ($Box charType (|char#FromInt| 121))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Set#IsMember| (|Map#Domain| |ages#0@0|) ($Box SeqType (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 114))) ($Box charType (|char#FromInt| 111))) ($Box charType (|char#FromInt| 110))) ($Box charType (|char#FromInt| 97))) ($Box charType (|char#FromInt| 108))) ($Box charType (|char#FromInt| 100))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Set#IsMember| (|Map#Domain| |a#0@0|) ($Box SeqType (Lit SeqType (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 98))) ($Box charType (|char#FromInt| 107))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#IsMember| (|Map#Domain| |b#0@0|) ($Box SeqType (Lit SeqType (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 98))) ($Box charType (|char#FromInt| 107))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#IsMember| (|Map#Domain| |ages#0@0|) ($Box SeqType (Lit SeqType (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 98))) ($Box charType (|char#FromInt| 107)))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is MapType |a#0| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |a#0| (TMap (TSeq TChar) TInt) $Heap)) true) (and (and ($Is MapType |b#0| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |b#0| (TMap (TSeq TChar) TInt) $Heap)) true)) (and (and (and ($Is MapType |ages#0| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |ages#0| (TMap (TSeq TChar) TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 13) 2)))) anon0_correct))))
