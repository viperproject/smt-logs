...
(set-info :boogie-vc-id CheckWellFormed$$_module.uint128)
...
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 _module.__default.TWO__TO__THE__128)))))
