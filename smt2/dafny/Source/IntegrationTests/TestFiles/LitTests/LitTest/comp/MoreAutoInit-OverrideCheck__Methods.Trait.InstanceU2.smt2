...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (= Methods.UberTrait$Au@@9 Methods.Trait$At@@13) (= Methods.UberTrait.InstanceU2$Bu Methods.Trait.InstanceU2$Bt)) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@9 T@U) ($f T@U) ) true)) (=> (forall (($o@@10 T@U) ($f@@0 T@U) ) true) (=> (= (ControlFlow 0 2) (- 0 1)) (forall (($o@@11 T@U) ($f@@1 T@U) ) true))))))))
