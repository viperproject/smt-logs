...
(declare-fun |defass#bottom#0_0@0| () Bool)
...
(declare-fun |defass#bottom#0_0| () Bool)
(declare-fun |bottom#0_0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$PrintOrderedSet.__default.Print)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon9_Else_correct  (=> (not (|Set#Equal| |ss#0@0| |Set#Empty|)) (=> (and ($IsBox |call2formal@r#0| Tclass.PrintOrderedSet.O.Abs.T) ($IsAllocBox |call2formal@r#0| Tclass.PrintOrderedSet.O.Abs.T $Heap)) (and (=> (= (ControlFlow 0 5) (- 0 8)) (> (|Set#Card| |ss#0@0|) 0)) (=> (> (|Set#Card| |ss#0@0|) 0) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and ($IsBox |call2formal@r#0@0| Tclass.PrintOrderedSet.O.Abs.T) ($IsAllocBox |call2formal@r#0@0| Tclass.PrintOrderedSet.O.Abs.T $Heap@1)) (|Set#IsMember| |ss#0@0| |call2formal@r#0@0|)) (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0)))
 :qid |Collectionsdfy.90:10|
 :skolemid |2441|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@0))
)) ($HeapSucc $Heap@0 $Heap@1))) (and (=> (= (ControlFlow 0 5) (- 0 7)) true) (=> (= |ss#0@1| (|Set#Difference| |ss#0@0| (|Set#UnionOne| |Set#Empty| |call2formal@r#0@0|))) (and (=> (= (ControlFlow 0 5) (- 0 6)) true) (=> (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (=> (and (and (forall (($o@@1 T@U) ) (!  (=> (and (or (not (= $o@@1 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@1) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@1) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@1)))
 :qid |Collectionsdfy.88:10|
 :skolemid |2439|
...
(let ((anon7_LoopHead_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> |defass#bottom#0_0@0| (and ($IsBox |bottom#0_0@0| Tclass.PrintOrderedSet.O.Abs.T) ($IsAllocBox |bottom#0_0@0| Tclass.PrintOrderedSet.O.Abs.T $Heap@0)))) (and ($Is SetType |ss#0@0| (TSet Tclass.PrintOrderedSet.O.Abs.T)) ($IsAlloc SetType |ss#0@0| (TSet Tclass.PrintOrderedSet.O.Abs.T) $Heap@0))) (and (and (and ($Is SeqType |sep#0@1| (TSeq TChar)) ($IsAlloc SeqType |sep#0@1| (TSeq TChar) $Heap@0)) (not false)) (and (and (forall (($o@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@2) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2)))
...
)) (|Set#Subset| |ss#0@0| |s#0|))))) (and (=> (= (ControlFlow 0 11) 1) anon7_LoopDone_correct) (=> (= (ControlFlow 0 11) 10) anon7_LoopBody_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |sep#0@0| (Lit SeqType |Seq#Empty|)) (= (ControlFlow 0 12) 11)) anon7_LoopHead_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SetType |s#0| (TSet Tclass.PrintOrderedSet.O.Abs.T)) ($IsAlloc SetType |s#0| (TSet Tclass.PrintOrderedSet.O.Abs.T) $Heap))) (and (and ($Is SetType |ss#0| (TSet Tclass.PrintOrderedSet.O.Abs.T)) ($IsAlloc SetType |ss#0| (TSet Tclass.PrintOrderedSet.O.Abs.T) $Heap)) true)) (and (and (and ($Is SeqType |sep#0| (TSeq TChar)) ($IsAlloc SeqType |sep#0| (TSeq TChar) $Heap)) true) (and (and (=> |defass#bottom#0_0| (and ($IsBox |bottom#0_0| Tclass.PrintOrderedSet.O.Abs.T) ($IsAllocBox |bottom#0_0| Tclass.PrintOrderedSet.O.Abs.T $Heap))) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 13) 12))))) anon0_correct)))
