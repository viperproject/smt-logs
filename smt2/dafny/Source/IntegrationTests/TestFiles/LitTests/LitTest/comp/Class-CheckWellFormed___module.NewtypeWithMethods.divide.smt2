...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let (($generated@@105  (=> (= $generated@@96 ($generated@@60 $generated@@97 $generated@@98 $generated@@5 false)) (=> (and (= $generated@@99 ($generated@@46 0)) (= (ControlFlow 0 2) (- 0 1))) (and (<= ($generated@@46 0) $generated@@99) (< $generated@@99 42))))))
(let (($generated@@106  (=> (and (and (and ($generated@@100 $generated@@98) ($generated@@101 $generated@@98)) (and (<= ($generated@@46 0) $generated@@102) (< $generated@@102 42))) (and (and (<= ($generated@@46 0) $generated@@103) (< $generated@@103 42)) (and (= 1 $generated@@104) (= (ControlFlow 0 3) 2)))) $generated@@105)))
$generated@@106)))
))
(check-sat)
(get-info :rlimit)
