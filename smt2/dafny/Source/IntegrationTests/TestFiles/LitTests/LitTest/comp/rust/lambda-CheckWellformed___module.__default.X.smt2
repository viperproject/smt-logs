...
(declare-fun _module.__default.p (Bool) Bool)
(declare-fun $Unbox (T@T T@U) T@U)
(declare-fun Apply1 (T@U T@U T@U T@U T@U) T@U)
(declare-fun |_module.__default.p#Handle| () T@U)
(declare-fun $Box (T@T T@U) T@U)
(declare-fun Requires1 (T@U T@U T@U T@U T@U) Bool)
(declare-fun |_module.__default.p#requires| (Bool) Bool)
(declare-fun $FunctionContextHeight () Int)
(declare-fun _module.__default.X () Bool)
(declare-fun |_module.__default.X#canCall| () Bool)
...
(declare-fun |_module.__default.p#canCall| (Bool) Bool)
...
(assert (distinct TBool TagBool alloc Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 Tagclass._System.___hTotalFunc1 |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1| |tytagFamily$_#TotalFunc1|)
)
...
(assert (forall (($heap T@U) (|$fh$0x#0| Bool) ) (! (= (_module.__default.p |$fh$0x#0|) (U_2_bool ($Unbox boolType (Apply1 TBool TBool $heap |_module.__default.p#Handle| ($Box boolType (bool_2_U |$fh$0x#0|))))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |544|
 :pattern ( (_module.__default.p |$fh$0x#0|) ($IsGoodHeap $heap))
)))
...
(assert (forall (($heap@@0 T@U) (|$fh$0x#0@@0| T@U) ) (! (= (Requires1 TBool TBool $heap@@0 |_module.__default.p#Handle| |$fh$0x#0@@0|) (|_module.__default.p#requires| (U_2_bool ($Unbox boolType |$fh$0x#0@@0|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |542|
 :pattern ( (Requires1 TBool TBool $heap@@0 |_module.__default.p#Handle| |$fh$0x#0@@0|))
)))
(assert ($IsGoodHeap $OneHeap))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) ) (!  (=> (or |_module.__default.X#canCall| (and (< 1 $FunctionContextHeight) ($IsGoodHeap $Heap))) (and (|_module.__default.F#canCall| |_module.__default.p#Handle|) (= _module.__default.X (_module.__default.F |_module.__default.p#Handle|))))
 :qid |lambdadfy.11:11|
 :skolemid |545|
 :pattern ( _module.__default.X ($IsGoodHeap $Heap))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) ) (!  (=> (or |_module.__default.X#canCall| (and (< 1 $FunctionContextHeight) ($IsGoodHeap $Heap@@0))) (and (|_module.__default.F#canCall| |_module.__default.p#Handle|) (= _module.__default.X (_module.__default.F |_module.__default.p#Handle|))))
 :qid |lambdadfy.11:11|
 :weight 3
 :skolemid |546|
 :pattern ( _module.__default.X ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall (($bx T@U) ($heap@@1 T@U) (|$fh$0x#0@@1| T@U) ) (! (= (|Set#IsMember| (Reads1 TBool TBool $heap@@1 |_module.__default.p#Handle| |$fh$0x#0@@1|) $bx) false)
 :qid |unknown.0:0|
 :skolemid |543|
 :pattern ( (|Set#IsMember| (Reads1 TBool TBool $heap@@1 |_module.__default.p#Handle| |$fh$0x#0@@1|) $bx))
)))
...
(assert (forall (($heap@@2 T@U) (|$fh$0x#0@@2| T@U) ) (! (= (Apply1 TBool TBool $heap@@2 |_module.__default.p#Handle| |$fh$0x#0@@2|) ($Box boolType (bool_2_U (_module.__default.p (U_2_bool ($Unbox boolType |$fh$0x#0@@2|))))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |541|
 :pattern ( (Apply1 TBool TBool $heap@@2 |_module.__default.p#Handle| |$fh$0x#0@@2|))
)))
(assert (forall ((|b#0| Bool) ) (! (= (|_module.__default.p#requires| |b#0|) true)
 :qid |lambdadfy.7:13|
 :skolemid |533|
 :pattern ( (|_module.__default.p#requires| |b#0|))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|b#0@@0| Bool) ) (!  (=> (or (|_module.__default.p#canCall| |b#0@@0|) (< 0 $FunctionContextHeight)) (= (_module.__default.p |b#0@@0|)  (not |b#0@@0|)))
 :qid |lambdadfy.7:13|
 :skolemid |534|
 :pattern ( (_module.__default.p |b#0@@0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@1 T@U) (|f#0@@1| T@U) ) (!  (=> (or (|_module.__default.F#canCall| |f#0@@1|) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@1) ($Is HandleTypeType |f#0@@1| (Tclass._System.___hTotalFunc1 TBool TBool))))) (= (_module.__default.F |f#0@@1|) (U_2_bool ($Unbox boolType (Apply1 TBool TBool $Heap@@1 |f#0@@1| ($Box boolType (Lit boolType (bool_2_U false))))))))
 :qid |lambdadfy.5:11|
 :skolemid |530|
 :pattern ( (_module.__default.F |f#0@@1|) ($IsGoodHeap $Heap@@1))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|b#0@@1| T@U) ) (!  (=> (or (|_module.__default.p#canCall| (U_2_bool (Lit boolType |b#0@@1|))) (< 0 $FunctionContextHeight)) (= (_module.__default.p (U_2_bool (Lit boolType |b#0@@1|)))  (not (U_2_bool (Lit boolType |b#0@@1|)))))
 :qid |lambdadfy.7:13|
 :weight 3
 :skolemid |535|
 :pattern ( (_module.__default.p (U_2_bool (Lit boolType |b#0@@1|))))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@2 T@U) (|f#0@@4| T@U) ) (!  (=> (or (|_module.__default.F#canCall| (Lit HandleTypeType |f#0@@4|)) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@2) ($Is HandleTypeType |f#0@@4| (Tclass._System.___hTotalFunc1 TBool TBool))))) (= (_module.__default.F (Lit HandleTypeType |f#0@@4|)) (U_2_bool ($Unbox boolType (Apply1 TBool TBool $Heap@@2 (Lit HandleTypeType |f#0@@4|) ($Box boolType (Lit boolType (bool_2_U false))))))))
 :qid |lambdadfy.5:11|
 :weight 3
 :skolemid |531|
 :pattern ( (_module.__default.F (Lit HandleTypeType |f#0@@4|)) ($IsGoodHeap $Heap@@2))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.X)
