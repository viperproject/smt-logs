...
(declare-fun Arrays._default.Print$X () T@U)
(declare-fun |suffix#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$Arrays.__default.Print)
...
(let ((anon3_Then_correct  (=> (or (not (= (_System.array.Length |x#0|) 0)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |x#0| null)) (not true))) (=> (or (not (= |x#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |x#0| null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= (LitInt 2) 0)) (not true))) (=> (= (ControlFlow 0 2) (- 0 1)) (and (<= 0 (Div (_System.array.Length |x#0|) (LitInt 2))) (< (Div (_System.array.Length |x#0|) (LitInt 2)) (_System.array.Length |x#0|)))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (not (= |x#0| null)) (not true))) (=> (or (not (= |x#0| null)) (not true)) (and (=> (= (ControlFlow 0 7) 2) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |x#0| (Tclass._System.array Arrays._default.Print$X)) ($IsAlloc refType |x#0| (Tclass._System.array Arrays._default.Print$X) $Heap))) (and (and ($Is SeqType |suffix#0| (TSeq TChar)) ($IsAlloc SeqType |suffix#0| (TSeq TChar) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 9) 7)))) anon0_correct)))
