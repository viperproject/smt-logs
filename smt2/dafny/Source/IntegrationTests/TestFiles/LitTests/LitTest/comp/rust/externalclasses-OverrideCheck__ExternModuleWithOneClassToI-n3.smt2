...
(assert (forall (($h0 T@U) ($h1 T@U) (this@@0 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass.ExternModuleWithOneClassToImport.NonShareableBox))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@3 T@U) ($f T@U) )  (=> (and (or (not (= $o@@3 null)) (not true)) (= $o@@3 this@@0)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@3) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@3) $f)))) (= (ExternModuleWithOneClassToImport.NonShareableBox.Get $h0 this@@0) (ExternModuleWithOneClassToImport.NonShareableBox.Get $h1 this@@0))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 5)) (<= (|Seq#Rank| |s#0|) (|Seq#Rank| |s#0|))) (=> (<= (|Seq#Rank| |s#0|) (|Seq#Rank| |s#0|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@6 T@U) ($f@@0 T@U) ) true)) (=> (forall (($o@@7 T@U) ($f@@1 T@U) ) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@8 T@U) ($f@@2 T@U) )  (=> (and (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@8) alloc)))) (= $o@@8 this@@1)) (= $o@@8 this@@1)))) (=> (forall (($o@@9 T@U) ($f@@3 T@U) )  (=> (and (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@9) alloc)))) (= $o@@9 this@@1)) (= $o@@9 this@@1))) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (forall (($o@@10 T@U) ) (!  (=> (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@10) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@10) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@10)) (= $o@@10 this@@1)))
