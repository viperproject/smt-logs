...
(declare-fun |a#0| () T@U)
(declare-fun _module.Class$A () T@U)
(declare-fun |b#0| () T@U)
(declare-fun _module.Class.M$B () T@U)
(declare-fun |defass#bb#0| () Bool)
(declare-fun |bb#0| () T@U)
(declare-fun |aa#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.Class.M)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($IsBox |a#0| _module.Class$A) ($IsAllocBox |a#0| _module.Class$A $Heap))) (=> (and (and (and ($IsBox |b#0| _module.Class.M$B) ($IsAllocBox |b#0| _module.Class.M$B $Heap)) (=> |defass#bb#0| (and ($IsBox |bb#0| _module.Class.M$B) ($IsAllocBox |bb#0| _module.Class.M$B $Heap)))) (and (and ($IsBox |aa#0| _module.Class$A) ($IsAllocBox |aa#0| _module.Class$A $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct))))
