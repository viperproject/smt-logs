...
(declare-fun _module._default.PrintArray$A () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon12_Else_correct  (=> (and (< |i#1_0@1| (_System.array.Length |a#0|)) (= |$decr$loop#1_00@1| (- (_System.array.Length |a#0|) |i#1_0@1|))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (and (<= 0 |i#1_0@1|) (< |i#1_0@1| (_System.array.Length |a#0|)))) (=> (= |i#1_0@2| (+ |i#1_0@1| 1)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (<= 0 |$decr$loop#1_00@1|) (= (- (_System.array.Length |a#0|) |i#1_0@2|) |$decr$loop#1_00@1|))) (=> (or (<= 0 |$decr$loop#1_00@1|) (= (- (_System.array.Length |a#0|) |i#1_0@2|) |$decr$loop#1_00@1|)) (=> (= (ControlFlow 0 7) (- 0 6)) (< (- (_System.array.Length |a#0|) |i#1_0@2|) |$decr$loop#1_00@1|)))))))))))
(let ((anon12_Then_correct true))
(let ((anon11_Else_correct  (=> |$w$loop#1_0@0| (and (=> (= (ControlFlow 0 11) (- 0 12)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 11) 5) anon12_Then_correct) (=> (= (ControlFlow 0 11) 7) anon12_Else_correct)))))))
(let ((anon11_Then_correct  (=> (and (not |$w$loop#1_0@0|) (= (ControlFlow 0 4) (- 0 3))) (or (not (= |a#0| null)) (not true)))))
(let ((anon10_LoopBody_correct  (and (=> (= (ControlFlow 0 13) 4) anon11_Then_correct) (=> (= (ControlFlow 0 13) 11) anon11_Else_correct))))
(let ((anon10_LoopDone_correct true))
(let ((anon10_LoopHead_correct  (=> (and (not false) (<= 0 |i#1_0@1|)) (=> (and (and (forall (($o@@4 T@U) ) (!  (=> (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@4) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@4) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@4)))
 :qid |_7Arraysdfy.25:5|
 :skolemid |554|
...
)) (<= (- (_System.array.Length |a#0|) |i#1_0@1|) |$decr_init$loop#1_00@0|))) (and (=> (= (ControlFlow 0 14) 2) anon10_LoopDone_correct) (=> (= (ControlFlow 0 14) 13) anon10_LoopBody_correct))))))
(let ((anon9_Else_correct  (=> (and (and (or (not (= |a#0| null)) (not true)) (= |i#1_0@0| (LitInt 0))) (and (= |$decr_init$loop#1_00@0| (- (_System.array.Length |a#0|) |i#1_0@0|)) (= (ControlFlow 0 15) 14))) anon10_LoopHead_correct)))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 16) 1) anon9_Then_correct) (=> (= (ControlFlow 0 16) 15) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |a#0| (Tclass._System.array? _module._default.PrintArray$A)) ($IsAlloc refType |a#0| (Tclass._System.array? _module._default.PrintArray$A) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 17) 16))) anon0_correct))))
