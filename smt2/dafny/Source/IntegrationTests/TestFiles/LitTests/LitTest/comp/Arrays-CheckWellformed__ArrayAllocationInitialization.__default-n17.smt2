...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((ArrayAllocationInitialization._default.MatrixToSequence$T T@U) ($Heap@@1 T@U) (|m#0@@1| T@U) ) (!  (=> (or (|ArrayAllocationInitialization.__default.MatrixToSequence#canCall| ArrayAllocationInitialization._default.MatrixToSequence$T $Heap@@1 |m#0@@1|) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@1) ($Is refType |m#0@@1| (Tclass._System.array2 ArrayAllocationInitialization._default.MatrixToSequence$T))))) (and (|ArrayAllocationInitialization.__default.M2S#canCall| ArrayAllocationInitialization._default.MatrixToSequence$T $Heap@@1 |m#0@@1| (LitInt 0) (LitInt 0)) (= (ArrayAllocationInitialization.__default.MatrixToSequence ArrayAllocationInitialization._default.MatrixToSequence$T $Heap@@1 |m#0@@1|) (ArrayAllocationInitialization.__default.M2S ArrayAllocationInitialization._default.MatrixToSequence$T ($LS $LZ) $Heap@@1 |m#0@@1| (LitInt 0) (LitInt 0)))))
 :qid |unknown.0:0|
 :skolemid |4508|
 :pattern ( (ArrayAllocationInitialization.__default.MatrixToSequence ArrayAllocationInitialization._default.MatrixToSequence$T $Heap@@1 |m#0@@1|) ($IsGoodHeap $Heap@@1))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((ArrayAllocationInitialization._default.MatrixToSequence$T@@0 T@U) ($Heap@@2 T@U) (|m#0@@2| T@U) ) (!  (=> (or (|ArrayAllocationInitialization.__default.MatrixToSequence#canCall| ArrayAllocationInitialization._default.MatrixToSequence$T@@0 $Heap@@2 |m#0@@2|) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@2) (and ($Is refType |m#0@@2| (Tclass._System.array2 ArrayAllocationInitialization._default.MatrixToSequence$T@@0)) ($IsAlloc refType |m#0@@2| (Tclass._System.array2 ArrayAllocationInitialization._default.MatrixToSequence$T@@0) $Heap@@2))))) ($IsAlloc SeqType (ArrayAllocationInitialization.__default.MatrixToSequence ArrayAllocationInitialization._default.MatrixToSequence$T@@0 $Heap@@2 |m#0@@2|) (TSeq ArrayAllocationInitialization._default.MatrixToSequence$T@@0) $Heap@@2))
 :qid |unknown.0:0|
 :skolemid |4506|
 :pattern ( ($IsAlloc SeqType (ArrayAllocationInitialization.__default.MatrixToSequence ArrayAllocationInitialization._default.MatrixToSequence$T@@0 $Heap@@2 |m#0@@2|) (TSeq ArrayAllocationInitialization._default.MatrixToSequence$T@@0) $Heap@@2))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((ArrayAllocationInitialization._default.M2S$T@@1 T@U) ($ly@@1 T@U) ($Heap@@3 T@U) (|m#0@@3| T@U) (|i#0@@1| Int) (|j#0@@1| Int) ) (!  (=> (or (|ArrayAllocationInitialization.__default.M2S#canCall| ArrayAllocationInitialization._default.M2S$T@@1 $Heap@@3 |m#0@@3| |i#0@@1| |j#0@@1|) (and (< 0 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $Heap@@3) (and ($Is refType |m#0@@3| (Tclass._System.array2 ArrayAllocationInitialization._default.M2S$T@@1)) ($IsAlloc refType |m#0@@3| (Tclass._System.array2 ArrayAllocationInitialization._default.M2S$T@@1) $Heap@@3))) (<= (LitInt 0) |i#0@@1|)) (<= (LitInt 0) |j#0@@1|)) (and (and (<= |i#0@@1| (_System.array2.Length0 |m#0@@3|)) (<= |j#0@@1| (_System.array2.Length1 |m#0@@3|))) (=> (= |i#0@@1| (_System.array2.Length0 |m#0@@3|)) (= |j#0@@1| (LitInt 0))))))) ($Is SeqType (ArrayAllocationInitialization.__default.M2S ArrayAllocationInitialization._default.M2S$T@@1 $ly@@1 $Heap@@3 |m#0@@3| |i#0@@1| |j#0@@1|) (TSeq ArrayAllocationInitialization._default.M2S$T@@1)))
 :qid |unknown.0:0|
 :skolemid |4514|
 :pattern ( (ArrayAllocationInitialization.__default.M2S ArrayAllocationInitialization._default.M2S$T@@1 $ly@@1 $Heap@@3 |m#0@@3| |i#0@@1| |j#0@@1|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((ArrayAllocationInitialization._default.MatrixToSequence$T@@1 T@U) ($Heap@@4 T@U) (|m#0@@4| T@U) ) (!  (=> (or (|ArrayAllocationInitialization.__default.MatrixToSequence#canCall| ArrayAllocationInitialization._default.MatrixToSequence$T@@1 $Heap@@4 |m#0@@4|) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@4) (and ($Is refType |m#0@@4| (Tclass._System.array2 ArrayAllocationInitialization._default.MatrixToSequence$T@@1)) ($IsAlloc refType |m#0@@4| (Tclass._System.array2 ArrayAllocationInitialization._default.MatrixToSequence$T@@1) $Heap@@4))))) ($Is SeqType (ArrayAllocationInitialization.__default.MatrixToSequence ArrayAllocationInitialization._default.MatrixToSequence$T@@1 $Heap@@4 |m#0@@4|) (TSeq ArrayAllocationInitialization._default.MatrixToSequence$T@@1)))
 :qid |unknown.0:0|
 :skolemid |4505|
 :pattern ( (ArrayAllocationInitialization.__default.MatrixToSequence ArrayAllocationInitialization._default.MatrixToSequence$T@@1 $Heap@@4 |m#0@@4|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((ArrayAllocationInitialization._default.M2S$T@@2 T@U) ($ly@@2 T@U) ($Heap@@5 T@U) (|m#0@@5| T@U) (|i#0@@2| Int) (|j#0@@2| Int) ) (!  (=> (or (|ArrayAllocationInitialization.__default.M2S#canCall| ArrayAllocationInitialization._default.M2S$T@@2 $Heap@@5 |m#0@@5| |i#0@@2| |j#0@@2|) (and (< 0 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $Heap@@5) ($Is refType |m#0@@5| (Tclass._System.array2 ArrayAllocationInitialization._default.M2S$T@@2))) (<= (LitInt 0) |i#0@@2|)) (<= (LitInt 0) |j#0@@2|)) (and (and (<= |i#0@@2| (_System.array2.Length0 |m#0@@5|)) (<= |j#0@@2| (_System.array2.Length1 |m#0@@5|))) (=> (= |i#0@@2| (_System.array2.Length0 |m#0@@5|)) (= |j#0@@2| (LitInt 0))))))) (and (=> (or (not (= |i#0@@2| (_System.array2.Length0 |m#0@@5|))) (not true)) (and (=> (= |j#0@@2| (_System.array2.Length1 |m#0@@5|)) (|ArrayAllocationInitialization.__default.M2S#canCall| ArrayAllocationInitialization._default.M2S$T@@2 $Heap@@5 |m#0@@5| (+ |i#0@@2| 1) (LitInt 0))) (=> (or (not (= |j#0@@2| (_System.array2.Length1 |m#0@@5|))) (not true)) (|ArrayAllocationInitialization.__default.M2S#canCall| ArrayAllocationInitialization._default.M2S$T@@2 $Heap@@5 |m#0@@5| |i#0@@2| (+ |j#0@@2| 1))))) (= (ArrayAllocationInitialization.__default.M2S ArrayAllocationInitialization._default.M2S$T@@2 ($LS $ly@@2) $Heap@@5 |m#0@@5| |i#0@@2| |j#0@@2|) (ite (= |i#0@@2| (_System.array2.Length0 |m#0@@5|)) |Seq#Empty| (ite (= |j#0@@2| (_System.array2.Length1 |m#0@@5|)) (ArrayAllocationInitialization.__default.M2S ArrayAllocationInitialization._default.M2S$T@@2 $ly@@2 $Heap@@5 |m#0@@5| (+ |i#0@@2| 1) (LitInt 0)) (|Seq#Append| (|Seq#Build| |Seq#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 |m#0@@5|) (MultiIndexField (IndexField |i#0@@2|) |j#0@@2|))) (ArrayAllocationInitialization.__default.M2S ArrayAllocationInitialization._default.M2S$T@@2 $ly@@2 $Heap@@5 |m#0@@5| |i#0@@2| (+ |j#0@@2| 1))))))))
 :qid |unknown.0:0|
 :skolemid |4517|
 :pattern ( (ArrayAllocationInitialization.__default.M2S ArrayAllocationInitialization._default.M2S$T@@2 ($LS $ly@@2) $Heap@@5 |m#0@@5| |i#0@@2| |j#0@@2|) ($IsGoodHeap $Heap@@5))
))))
...
(declare-fun ArrayAllocationInitialization._default.MatrixToSequence$T@@2 () T@U)
...
(set-info :boogie-vc-id CheckWellformed$$ArrayAllocationInitialization.__default.MatrixToSequence)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon5_Else_correct  (=> ($IsAlloc refType |m#0@@6| (Tclass._System.array2 ArrayAllocationInitialization._default.MatrixToSequence$T@@2) $Heap@@6) (and (=> (= (ControlFlow 0 3) (- 0 8)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (and (= |##i#0@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##i#0@0|) Tclass._System.nat $Heap@@6)) (and (=> (= (ControlFlow 0 3) (- 0 7)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (and (= |##j#0@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##j#0@0|) Tclass._System.nat $Heap@@6)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (<= |##i#0@0| (_System.array2.Length0 |m#0@@6|))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (<= |##j#0@0| (_System.array2.Length1 |m#0@@6|))) (=> (and (<= |##i#0@0| (_System.array2.Length0 |m#0@@6|)) (<= |##j#0@0| (_System.array2.Length1 |m#0@@6|))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> (= |##i#0@0| (_System.array2.Length0 |m#0@@6|)) (= |##j#0@0| (LitInt 0)))) (=> (=> (= |##i#0@0| (_System.array2.Length0 |m#0@@6|)) (= |##j#0@0| (LitInt 0))) (=> (and (= |b$reqreads#0@0| (forall (($o@@8 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 $o@@8) alloc)))) (= $o@@8 |m#0@@6|)) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@8 $f@@0)))
 :qid |Arraysdfy.722:5|
 :skolemid |4509|
))) (|ArrayAllocationInitialization.__default.M2S#canCall| ArrayAllocationInitialization._default.MatrixToSequence$T@@2 $Heap@@6 |m#0@@6| (LitInt 0) (LitInt 0))) (=> (and (and (= (ArrayAllocationInitialization.__default.MatrixToSequence ArrayAllocationInitialization._default.MatrixToSequence$T@@2 $Heap@@6 |m#0@@6|) (ArrayAllocationInitialization.__default.M2S ArrayAllocationInitialization._default.MatrixToSequence$T@@2 ($LS $LZ) $Heap@@6 |m#0@@6| (LitInt 0) (LitInt 0))) (|ArrayAllocationInitialization.__default.M2S#canCall| ArrayAllocationInitialization._default.MatrixToSequence$T@@2 $Heap@@6 |m#0@@6| (LitInt 0) (LitInt 0))) (and ($Is SeqType (ArrayAllocationInitialization.__default.MatrixToSequence ArrayAllocationInitialization._default.MatrixToSequence$T@@2 $Heap@@6 |m#0@@6|) (TSeq ArrayAllocationInitialization._default.MatrixToSequence$T@@2)) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|))))))))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#12| null $Heap@@6 alloc |m#0@@6|)) (and (=> (= (ControlFlow 0 9) 1) anon5_Then_correct) (=> (= (ControlFlow 0 9) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) ($Is refType |m#0@@6| (Tclass._System.array2 ArrayAllocationInitialization._default.MatrixToSequence$T@@2))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct)))
