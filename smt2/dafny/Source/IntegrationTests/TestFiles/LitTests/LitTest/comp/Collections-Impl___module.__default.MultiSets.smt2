...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (= |a#0@0| (Lit MultiSetType |MultiSet#Empty|)) (= |b#0@0| (Lit MultiSetType (|MultiSet#UnionOne| (|MultiSet#UnionOne| (|MultiSet#UnionOne| (|MultiSet#UnionOne| |MultiSet#Empty| ($Box intType (int_2_U (LitInt 17)))) ($Box intType (int_2_U (LitInt 82)))) ($Box intType (int_2_U (LitInt 17)))) ($Box intType (int_2_U (LitInt 82))))))) (and (= |c#0@0| (Lit MultiSetType (|MultiSet#UnionOne| (|MultiSet#UnionOne| |MultiSet#Empty| ($Box intType (int_2_U (LitInt 12)))) ($Box intType (int_2_U (LitInt 17)))))) (= |d#0@0| (Lit MultiSetType (|MultiSet#UnionOne| (|MultiSet#UnionOne| (|MultiSet#UnionOne| |MultiSet#Empty| ($Box intType (int_2_U (LitInt 12)))) ($Box intType (int_2_U (LitInt 12)))) ($Box intType (int_2_U (LitInt 17)))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= 0 (LitInt 2))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= 0 (LitInt 2))) (=> (= (ControlFlow 0 2) (- 0 1)) (<= 0 (LitInt 2)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is MultiSetType |a#0| (TMultiSet TInt)) ($IsAlloc MultiSetType |a#0| (TMultiSet TInt) $Heap)) true) (=> (and (and (and (and ($Is MultiSetType |b#0| (TMultiSet TInt)) ($IsAlloc MultiSetType |b#0| (TMultiSet TInt) $Heap)) true) (and (and ($Is MultiSetType |c#0| (TMultiSet TInt)) ($IsAlloc MultiSetType |c#0| (TMultiSet TInt) $Heap)) true)) (and (and (and ($Is MultiSetType |d#0| (TMultiSet TInt)) ($IsAlloc MultiSetType |d#0| (TMultiSet TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 2)))) anon0_correct)))))
