...
(assert (distinct TBool TagBool alloc Tagclass._System.nat Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 Tagclass._System.___hTotalFunc1 tytagFamily$nat |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1| |tytagFamily$_#TotalFunc1|)
)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and ($Is HandleTypeType |f#0@0| (Tclass._System.___hTotalFunc1 Tclass._System.nat (Tclass._System.___hTotalFunc1 Tclass._System.nat TBool))) ($IsAlloc HandleTypeType |f#0@0| (Tclass._System.___hTotalFunc1 Tclass._System.nat (Tclass._System.___hTotalFunc1 Tclass._System.nat TBool)) $Heap)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (= (ControlFlow 0 2) (- 0 1)) ($Is intType (int_2_U (LitInt 1)) Tclass._System.nat))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 Tclass._System.nat (Tclass._System.___hTotalFunc1 Tclass._System.nat TBool))) ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 Tclass._System.nat (Tclass._System.___hTotalFunc1 Tclass._System.nat TBool)) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
