...
(set-info :boogie-vc-id CheckWellFormed$$EuclideanDivisionRegressions.MyIntWithConstraint)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon6_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (<= (LitInt (- 0 200)) (LitInt 0)))))
