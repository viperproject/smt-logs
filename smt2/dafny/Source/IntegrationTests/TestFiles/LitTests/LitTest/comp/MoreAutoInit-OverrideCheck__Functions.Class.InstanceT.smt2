...
(declare-fun Functions.Trait$At@@12 () T@U)
(declare-fun Functions.Class$Ac@@13 () T@U)
(declare-fun Functions.Trait.InstanceT$Bt () T@U)
(declare-fun Functions.Class.InstanceT$Bc () T@U)
...
(set-info :boogie-vc-id OverrideCheck$$Functions.Class.InstanceT)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= Functions.Trait$At@@12 Functions.Class$Ac@@13) (= Functions.Trait.InstanceT$Bt Functions.Class.InstanceT$Bc)) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (and (= Class_$_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (forall (($o@@14 T@U) ($f@@0 T@U) ) (! true
 :qid |MoreAutoInitdfy.156:14|
 :skolemid |1633|
)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass.Functions.Class Functions.Class$Ac@@13)) ($IsAlloc refType this (Tclass.Functions.Class Functions.Class$Ac@@13) $Heap)))) (and (and ($IsBox |a#0| Functions.Class$Ac@@13) ($IsBox |b#0| Functions.Class.InstanceT$Bc)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct)))
