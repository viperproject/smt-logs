...
(set-info :boogie-vc-id CheckWellformed$$CharSetSetOrder.__default.Pow2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon8_Else_correct  (=> (or (not (= |i#0@@3| (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 8)) ($Is intType (int_2_U (- |i#0@@3| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |i#0@@3| 1)) Tclass._System.nat) (=> (and (= |##i#0@0| (- |i#0@@3| 1)) ($IsAlloc intType (int_2_U |##i#0@0|) Tclass._System.nat $Heap)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (or (<= 0 |i#0@@3|) (= |##i#0@0| |i#0@@3|))) (=> (or (<= 0 |i#0@@3|) (= |##i#0@0| |i#0@@3|)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< |##i#0@0| |i#0@@3|)) (=> (< |##i#0@0| |i#0@@3|) (=> (and (|CharSetSetOrder.__default.Pow2#canCall| (- |i#0@@3| 1)) (= (ControlFlow 0 5) (- 0 4))) ($Is intType (int_2_U (Mul (LitInt 2) (CharSetSetOrder.__default.Pow2 ($LS $LZ) (- |i#0@@3| 1)))) Tclass._System.nat))))))))))))
(let ((anon8_Then_correct  (=> (and (= |i#0@@3| (LitInt 0)) (= (ControlFlow 0 3) (- 0 2))) ($Is intType (int_2_U (LitInt 1)) Tclass._System.nat))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |i#0@@3|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct)))
