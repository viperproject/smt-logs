...
(assert (forall (($ly@@0 T@U) (|xs#0@@0| T@U) ) (! (= (_module.__default.SumAgain ($LS $ly@@0) |xs#0@@0|) (_module.__default.SumAgain $ly@@0 |xs#0@@0|))
 :qid |Datatypedfy.56:10|
 :skolemid |1989|
 :pattern ( (_module.__default.SumAgain ($LS $ly@@0) |xs#0@@0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@1 T@U) (|xs#0@@1| T@U) ) (!  (=> (or (|_module.__default.SumAgain#canCall| |xs#0@@1|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@1| Tclass._module.List))) (and (=> (not (_module.List.Nil_q |xs#0@@1|)) (let ((|tail#1| (_module.List.tail |xs#0@@1|)))
(|_module.__default.SumAgain#canCall| |tail#1|))) (= (_module.__default.SumAgain ($LS $ly@@1) |xs#0@@1|) (let ((|r#0| (ite (_module.List.Nil_q |xs#0@@1|) 0 (let ((|tail#0| (_module.List.tail |xs#0@@1|)))
(let ((|x#0| (_module.List.head |xs#0@@1|)))
(+ |x#0| (_module.__default.SumAgain $ly@@1 |tail#0|)))))))
|r#0|))))
 :qid |Datatypedfy.56:10|
 :skolemid |1993|
 :pattern ( (_module.__default.SumAgain ($LS $ly@@1) |xs#0@@1|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.SumAgain)
...
(let ((anon11_Then_correct  (=> (= |xs#0@@2| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) (=> (and (and (and ($Is DatatypeTypeType |_mcc#1#0| Tclass._module.List) (= |let#1#0#0| |_mcc#1#0|)) (and ($Is DatatypeTypeType |let#1#0#0| Tclass._module.List) (= |tail#Z#0@0| |let#1#0#0|))) (and (and (= |let#2#0#0| |_mcc#0#0|) ($Is intType (int_2_U |let#2#0#0|) TInt)) (and (= |x#Z#0@0| |let#2#0#0|) ($IsAlloc DatatypeTypeType |tail#Z#0@0| Tclass._module.List $Heap)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< (DtRank |tail#Z#0@0|) (DtRank |xs#0@@2|))) (=> (< (DtRank |tail#Z#0@0|) (DtRank |xs#0@@2|)) (=> (|_module.__default.SumAgain#canCall| |tail#Z#0@0|) (=> (and (and (= |let#0#0#0| (+ |x#Z#0@0| (_module.__default.SumAgain ($LS $LZ) |tail#Z#0@0|))) (|_module.__default.SumAgain#canCall| |tail#Z#0@0|)) (and ($Is intType (int_2_U |let#0#0#0|) TInt) (= (ControlFlow 0 5) 3))) anon7_correct))))))))
(let ((anon10_Then_correct  (=> (and (and (= |xs#0@@2| |#_module.List.Nil|) (= |let#0#0#0| (LitInt 0))) (and ($Is intType (int_2_U |let#0#0#0|) TInt) (= (ControlFlow 0 4) 3))) anon7_correct)))
(let ((anon11_Else_correct true))
(let ((anon10_Else_correct  (=> (or (not (= |xs#0@@2| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 7) 5) anon11_Then_correct) (=> (= (ControlFlow 0 7) 2) anon11_Else_correct)))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 8) 1) anon9_Then_correct) (=> (= (ControlFlow 0 8) 4) anon10_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon10_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |xs#0@@2| Tclass._module.List)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct)))
