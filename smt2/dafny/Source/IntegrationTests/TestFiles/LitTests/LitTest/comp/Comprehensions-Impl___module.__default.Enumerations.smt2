...
(declare-fun |lambda#71| (T@U T@U T@U T@U Int) T@U)
...
(assert (forall ((a@@4 T@U) (b@@1 T@U) (t0@@0 T@U) (t1@@0 T@U) ) (!  (=> (forall ((bx@@1 T@U) ) (!  (=> (|Set#IsMember| a@@4 bx@@1) (and ($IsBox bx@@1 t0@@0) ($IsBox (MapType0Select BoxType BoxType b@@1 bx@@1) t1@@0)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| Int) (|$y#0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#71| |l#0| |l#1| |l#2| |l#3| |l#4|) |$y#0|))  (and ($IsBox |$y#0| |l#0|) (and (|Set#IsMember| |l#1| |$y#0|) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#2| ($Unbox refType |$y#0|)) |l#3|))) |l#4|))))
 :qid |Comprehensionsdfy.345:7|
 :skolemid |3349|
 :pattern ( (MapType0Select BoxType boolType (|lambda#71| |l#0| |l#1| |l#2| |l#3| |l#4|) |$y#0|))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.Enumerations)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 88) (let ((anon20_correct  (=> (= |m#0@0| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#71| Tclass._module.CellA |s#0@0| $Heap@9 _module.ICell.data 6)) (|lambda#73| ($Box intType (int_2_U (LitInt 3)))) (TMap Tclass._module.CellA TInt))) (and (=> (= (ControlFlow 0 13) (- 0 14)) true) (=> (= (ControlFlow 0 13) (- 0 12)) true)))))
...
(let ((anon15_correct  (=> (= |r#0@0| (|Set#FromBoogieMap| (|lambda#71| Tclass._module.CellA |s#0@0| $Heap@9 _module.ICell.data 6))) (and (=> (= (ControlFlow 0 22) 21) anon28_Then_correct) (=> (= (ControlFlow 0 22) 15) anon28_Else_correct)))))
...
(let ((anon22_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@7) ($IsHeapAnchor $Heap@7)) ($HeapSucc $Heap@6 $Heap@7)) (and (forall (($o@@12 T@U) ($f@@0 T@U) ) (!  (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@12) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@12) $f@@0)) (exists ((|a#1_2| T@U) ) (!  (and (and (and ($Is refType |a#1_2| Tclass._module.CellA) (|Set#IsMember| |s#0@0| ($Box refType |a#1_2|))) (= $o@@12 |a#1_2|)) (= $f@@0 _module.ICell.data))
 :qid |Comprehensionsdfy.361:10|
 :skolemid |3166|
)))
 :qid |Comprehensionsdfy.361:3|
 :skolemid |3167|
...
(let ((anon21_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@6) ($IsHeapAnchor $Heap@6)) ($HeapSucc $Heap@5 $Heap@6)) (and (forall (($o@@13 T@U) ($f@@1 T@U) ) (!  (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@13) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@13) $f@@1)) (exists ((|a#0_2| T@U) ) (!  (and (and (and ($Is refType |a#0_2| Tclass._module.CellA) (|Set#IsMember| |s#0@0| ($Box refType |a#0_2|))) (= $o@@13 |a#0_2|)) (= $f@@1 _module.ICell.data))
 :qid |Comprehensionsdfy.355:10|
 :skolemid |3163|
)))
 :qid |Comprehensionsdfy.355:3|
 :skolemid |3164|
