...
(assert (forall ((v@@3 T@U) (t0@@15 T@U) ) (! (= ($Is SeqType v@@3 (TSeq t0@@15)) (forall ((i@@0 Int) ) (!  (=> (and (<= 0 i@@0) (< i@@0 (|Seq#Length| v@@3))) ($IsBox (|Seq#Index| v@@3 i@@0) t0@@15))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.AllCases)
...
(let ((anon11_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (|Seq#Length| _module.__default.AllCasesAsCodePoints)))) (= (ControlFlow 0 9) 5)) anon6_correct)))
(let ((anon11_Then_correct  (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (|Seq#Length| _module.__default.AllCasesAsCodePoints))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| _module.__default.AllCasesAsCodePoints)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| _module.__default.AllCasesAsCodePoints))) (=> (= |newtype$check#0@0| (U_2_int ($Unbox intType (|Seq#Index| _module.__default.AllCasesAsCodePoints |i#0@0|)))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (and (<= 0 |newtype$check#0@0|) (< |newtype$check#0@0| 55296)) (and (<= 57344 |newtype$check#0@0|) (< |newtype$check#0@0| 1114112)))) (=> (or (and (<= 0 |newtype$check#0@0|) (< |newtype$check#0@0| 55296)) (and (<= 57344 |newtype$check#0@0|) (< |newtype$check#0@0| 1114112))) (=> (= |lambdaResult#0| (|char#FromInt| (U_2_int ($Unbox intType (|Seq#Index| _module.__default.AllCasesAsCodePoints |i#0@0|))))) (=> (and ($Is charType |lambdaResult#0| TChar) (= (ControlFlow 0 6) 5)) anon6_correct))))))))))
(let ((anon10_Else_correct  (=> (< |i#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 11) 6) anon11_Then_correct) (=> (= (ControlFlow 0 11) 9) anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 10) 6) anon11_Then_correct) (=> (= (ControlFlow 0 10) 9) anon11_Else_correct)))))
(let ((anon9_Then_correct  (=> (= |$_Frame#l0@0| (|lambda#5| null |$lambdaHeap#0@0| alloc false)) (and (=> (= (ControlFlow 0 12) 10) anon10_Then_correct) (=> (= (ControlFlow 0 12) 11) anon10_Else_correct)))))
(let ((anon9_Else_correct true))
(let ((anon8_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 13) 12) anon9_Then_correct) (=> (= (ControlFlow 0 13) 4) anon9_Else_correct)))))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((|seqinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| (|Seq#Length| _module.__default.AllCasesAsCodePoints))) (Requires1 TInt TChar $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#0| _module.__default.AllCasesAsCodePoints) (|lambda#1| TInt (LitInt 0) (|Seq#Length| _module.__default.AllCasesAsCodePoints)) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0|))))
 :qid |UnicodeStringsdfy.48:3|
 :skolemid |483|
))) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|seqinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0@@0|) (< |seqinit#0#i0#0@@0| (|Seq#Length| _module.__default.AllCasesAsCodePoints))) (forall (($o@@1 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@1 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $o@@1) alloc)))) (|Set#IsMember| (Reads1 TInt TChar $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#0| _module.__default.AllCasesAsCodePoints) (|lambda#1| TInt (LitInt 0) (|Seq#Length| _module.__default.AllCasesAsCodePoints)) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0@@0|))) ($Box refType $o@@1))) (U_2_bool (MapType0Select refType FieldType boolType $_ReadsFrame@0 $o@@1 $f@@0)))
 :qid |UnicodeStringsdfy.48:3|
 :skolemid |484|
)))
 :qid |UnicodeStringsdfy.48:3|
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#5| null $Heap alloc false)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= 0 (|Seq#Length| _module.__default.AllCasesAsCodePoints))) (=> (<= 0 (|Seq#Length| _module.__default.AllCasesAsCodePoints)) (and (=> (= (ControlFlow 0 14) 13) anon8_Then_correct) (=> (= (ControlFlow 0 14) 2) anon8_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 16) 14))) anon0_correct)))
