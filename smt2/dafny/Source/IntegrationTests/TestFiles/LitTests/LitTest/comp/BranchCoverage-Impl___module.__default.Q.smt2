...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let (($generated@@96  (=> (and (and (and (<= 100 $generated@@88) (<= 1000 $generated@@88)) (< $generated@@88 ($generated 50))) (= (ControlFlow 0 7) (- 0 6))) false)))
(let (($generated@@97 true))
(let (($generated@@98 true))
(let (($generated@@99 true))
(let (($generated@@100  (=> (<= ($generated 50) $generated@@88) (and (and (and (=> (= (ControlFlow 0 11) 3) $generated@@99) (=> (= (ControlFlow 0 11) 4) $generated@@98)) (=> (= (ControlFlow 0 11) 5) $generated@@97)) (=> (= (ControlFlow 0 11) 7) $generated@@96)))))
(let (($generated@@101  (=> (< $generated@@88 1000) (and (=> (= (ControlFlow 0 9) (- 0 10)) (< $generated@@88 1000000)) (=> (< $generated@@88 1000000) (and (and (and (=> (= (ControlFlow 0 9) 3) $generated@@99) (=> (= (ControlFlow 0 9) 4) $generated@@98)) (=> (= (ControlFlow 0 9) 5) $generated@@97)) (=> (= (ControlFlow 0 9) 7) $generated@@96)))))))
(let (($generated@@102  (=> (< $generated@@88 100) (and (and (and (=> (= (ControlFlow 0 8) 3) $generated@@99) (=> (= (ControlFlow 0 8) 4) $generated@@98)) (=> (= (ControlFlow 0 8) 5) $generated@@97)) (=> (= (ControlFlow 0 8) 7) $generated@@96)))))
(let (($generated@@103  (=> (and (and (and (<= 100 $generated@@88) (<= 1000 $generated@@88)) (< $generated@@88 ($generated 50))) (= (ControlFlow 0 2) (- 0 1))) false)))
(let (($generated@@104  (=> (= $generated@@89 ($generated@@29 $generated@@90 $generated@@91 $generated@@92 false)) (and (and (and (=> (= (ControlFlow 0 12) 8) $generated@@102) (=> (= (ControlFlow 0 12) 9) $generated@@101)) (=> (= (ControlFlow 0 12) 11) $generated@@100)) (=> (= (ControlFlow 0 12) 2) $generated@@103)))))
(let (($generated@@105  (=> (and (and ($generated@@93 $generated@@91) ($generated@@94 $generated@@91)) (and (= 0 $generated@@95) (= (ControlFlow 0 13) 12))) $generated@@104)))
$generated@@105)))))))))))
))
(check-sat)
(get-info :rlimit)
