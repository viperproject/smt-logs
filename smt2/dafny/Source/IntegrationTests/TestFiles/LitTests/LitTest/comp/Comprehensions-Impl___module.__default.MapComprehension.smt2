...
(declare-fun |lambda#6| (Int) T@U)
(declare-fun Div (Int Int) Int)
(declare-fun |lambda#5| (T@U Int Int) T@U)
(declare-fun |lambda#7| (T@U Int Int) T@U)
...
(assert (forall ((|l#0| Int) (|$w#0| T@U) ) (! (= (MapType0Select BoxType BoxType (|lambda#6| |l#0|) |$w#0|) ($Box intType (int_2_U (Div (U_2_int ($Unbox intType |$w#0|)) |l#0|))))
 :qid |unknown.0:0|
 :skolemid |3338|
 :pattern ( (MapType0Select BoxType BoxType (|lambda#6| |l#0|) |$w#0|))
)))
...
(assert (forall ((|l#0@@0| T@U) (|l#1| Int) (|l#2| Int) (|$w#0@@0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#5| |l#0@@0| |l#1| |l#2|) |$w#0@@0|))  (and ($IsBox |$w#0@@0| |l#0@@0|) (and (<= |l#1| (U_2_int ($Unbox intType |$w#0@@0|))) (< (U_2_int ($Unbox intType |$w#0@@0|)) |l#2|))))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |3337|
 :pattern ( (MapType0Select BoxType boolType (|lambda#5| |l#0@@0| |l#1| |l#2|) |$w#0@@0|))
)))
(assert (forall ((|l#0@@1| T@U) (|l#1@@0| Int) (|l#2@@0| Int) (|$w#1| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#7| |l#0@@1| |l#1@@0| |l#2@@0|) |$w#1|))  (and ($IsBox |$w#1| |l#0@@1|) (exists ((|a#0#0#0| Int) ) (!  (and (and (<= |l#1@@0| |a#0#0#0|) (< |a#0#0#0| |l#2@@0|)) (= (U_2_int ($Unbox intType |$w#1|)) (_module.__default.FourMore |a#0#0#0|)))
 :qid |Comprehensionsdfy.63:12|
 :skolemid |2998|
))))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |3339|
 :pattern ( (MapType0Select BoxType boolType (|lambda#7| |l#0@@1| |l#1@@0| |l#2@@0|) |$w#1|))
)))
...
(assert (forall ((|$w#1@@0| T@U) ) (! (= (MapType0Select BoxType BoxType |lambda#8| |$w#1@@0|) ($Box intType (int_2_U (|map$project$0#0#x#0| (U_2_int ($Unbox intType |$w#1@@0|))))))
 :qid |Comprehensionsdfy.63:8|
 :skolemid |3340|
 :pattern ( (MapType0Select BoxType BoxType |lambda#8| |$w#1@@0|))
)))
...
(let ((anon22_Else_correct  (=> (and (not (and (and (<= (LitInt 12) |x#2@0|) (< |x#2@0| 15)) (and (<= (LitInt 12) |x#prime#0@0|) (< |x#prime#0@0| 15)))) (= (ControlFlow 0 6) 3)) anon14_correct)))
(let ((anon22_Then_correct  (=> (and (and (<= (LitInt 12) |x#2@0|) (< |x#2@0| 15)) (and (<= (LitInt 12) |x#prime#0@0|) (< |x#prime#0@0| 15))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (or (not (= (_module.__default.FourMore |x#2@0|) (_module.__default.FourMore |x#prime#0@0|))) (not true)) (= |x#2@0| |x#prime#0@0|))) (=> (or (or (not (= (_module.__default.FourMore |x#2@0|) (_module.__default.FourMore |x#prime#0@0|))) (not true)) (= |x#2@0| |x#prime#0@0|)) (=> (= (ControlFlow 0 4) 3) anon14_correct))))))
(let ((anon21_Else_correct  (=> (not (and (<= (LitInt 12) |x#2@0|) (< |x#2@0| 15))) (and (=> (= (ControlFlow 0 8) 4) anon22_Then_correct) (=> (= (ControlFlow 0 8) 6) anon22_Else_correct)))))
(let ((anon21_Then_correct  (=> (and (<= (LitInt 12) |x#2@0|) (< |x#2@0| 15)) (and (=> (= (ControlFlow 0 7) 4) anon22_Then_correct) (=> (= (ControlFlow 0 7) 6) anon22_Else_correct)))))
(let ((anon20_Else_correct  (=> (not (and (<= (LitInt 12) |x#2@0|) (< |x#2@0| 15))) (and (=> (= (ControlFlow 0 10) 7) anon21_Then_correct) (=> (= (ControlFlow 0 10) 8) anon21_Else_correct)))))
(let ((anon20_Then_correct  (=> (and (and (<= (LitInt 12) |x#2@0|) (< |x#2@0| 15)) (and ($IsAlloc intType (int_2_U |x#2@0|) TInt $Heap) (|_module.__default.FourMore#canCall| |x#2@0|))) (and (=> (= (ControlFlow 0 9) 7) anon21_Then_correct) (=> (= (ControlFlow 0 9) 8) anon21_Else_correct)))))
(let ((anon19_Else_correct  (=> (< |x#2@0| (LitInt 12)) (and (=> (= (ControlFlow 0 12) 9) anon20_Then_correct) (=> (= (ControlFlow 0 12) 10) anon20_Else_correct)))))
(let ((anon19_Then_correct  (=> (<= (LitInt 12) |x#2@0|) (and (=> (= (ControlFlow 0 11) 9) anon20_Then_correct) (=> (= (ControlFlow 0 11) 10) anon20_Else_correct)))))
(let ((anon18_Then_correct  (and (=> (= (ControlFlow 0 13) 11) anon19_Then_correct) (=> (= (ControlFlow 0 13) 12) anon19_Else_correct))))
(let ((anon18_Else_correct true))
(let ((anon5_correct  (=> (= |m#0@0| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#5| TInt (LitInt 12) 15)) (|lambda#6| (LitInt 2)) (TMap TInt TInt))) (and (=> (= (ControlFlow 0 14) 13) anon18_Then_correct) (=> (= (ControlFlow 0 14) 2) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (not (and (<= (LitInt 12) |x#0@0|) (< |x#0@0| 15))) (= (ControlFlow 0 17) 14)) anon5_correct)))
(let ((anon17_Then_correct  (=> (and (<= (LitInt 12) |x#0@0|) (< |x#0@0| 15)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (or (not (= (LitInt 2) 0)) (not true))) (=> (or (not (= (LitInt 2) 0)) (not true)) (=> (= (ControlFlow 0 15) 14) anon5_correct))))))
(let ((anon16_Else_correct  (=> (< |x#0@0| (LitInt 12)) (and (=> (= (ControlFlow 0 19) 15) anon17_Then_correct) (=> (= (ControlFlow 0 19) 17) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (<= (LitInt 12) |x#0@0|) (and (=> (= (ControlFlow 0 18) 15) anon17_Then_correct) (=> (= (ControlFlow 0 18) 17) anon17_Else_correct)))))
(let ((anon15_Then_correct  (and (=> (= (ControlFlow 0 20) 18) anon16_Then_correct) (=> (= (ControlFlow 0 20) 19) anon16_Else_correct))))
(let ((anon15_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 21) 20) anon15_Then_correct) (=> (= (ControlFlow 0 21) 1) anon15_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |m#0| (TMap TInt TInt)) ($IsAlloc MapType |m#0| (TMap TInt TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 22) 21))) anon0_correct))))
