...
(set-info :boogie-vc-id CheckWellFormed$$EnumerationRegression.Long)
...
(let ((anon8_Else_correct  (=> (and (< |x#0| (LitInt 137438953456)) (= (ControlFlow 0 6) 4)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (<= (LitInt 137438953456) |x#0|) (= (ControlFlow 0 5) 4)) anon4_correct)))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 137438953456) (LitInt 137438953456))) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (Lit boolType (bool_2_U (< 137438953456 137438953728))))))))
