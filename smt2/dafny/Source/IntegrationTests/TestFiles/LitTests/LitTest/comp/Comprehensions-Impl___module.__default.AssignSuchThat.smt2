...
(let ((anon23_Then_correct  (=> (and (and (<= (LitInt 12) |x#2@0|) (< |x#2@0| |y#2@0|)) (and ($IsAlloc intType (int_2_U |x#2@0|) TInt $Heap) (|_module.__default.Thirteen#canCall| |x#2@0|))) (and (=> (= (ControlFlow 0 10) 8) anon24_Then_correct) (=> (= (ControlFlow 0 10) 9) anon24_Else_correct)))))
(let ((anon22_Else_correct  (=> (< |x#2@0| (LitInt 12)) (and (=> (= (ControlFlow 0 13) 10) anon23_Then_correct) (=> (= (ControlFlow 0 13) 11) anon23_Else_correct)))))
...
(let ((anon19_Then_correct  (=> (<= (LitInt 12) |x#1@0|) (and (=> (= (ControlFlow 0 19) 17) anon20_Then_correct) (=> (= (ControlFlow 0 19) 18) anon20_Else_correct)))))
(let ((anon18_Then_correct  (and (=> (= (ControlFlow 0 21) 19) anon19_Then_correct) (=> (= (ControlFlow 0 21) 20) anon19_Else_correct))))
(let ((anon18_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (= |##x#0@0| (LitInt 13)) ($IsAlloc intType (int_2_U |##x#0@0|) TInt $Heap)) (and (|_module.__default.Thirteen#canCall| (LitInt 13)) (|_module.__default.Thirteen#canCall| (LitInt 13)))) (and (=> (= (ControlFlow 0 22) (- 0 23)) (=> (|_module.__default.Thirteen#canCall| (LitInt 13)) (or (U_2_bool (Lit boolType (bool_2_U (_module.__default.Thirteen (LitInt 13))))) (= (LitInt 13) (LitInt 13))))) (=> (U_2_bool (Lit boolType (bool_2_U (_module.__default.Thirteen (LitInt 13))))) (and (=> (= (ControlFlow 0 22) 21) anon18_Then_correct) (=> (= (ControlFlow 0 22) 1) anon18_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 24) 22))) anon0_correct)))
