...
(declare-fun |x#0| () (_ BitVec 7))
(declare-fun |newtype$check#1@0| () Int)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.ConvertFromBv)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= (LitInt 0) (nat_from_bv7 |x#0|)) (< (nat_from_bv7 |x#0|) 4294967296))) (=> (and (<= (LitInt 0) (nat_from_bv7 |x#0|)) (< (nat_from_bv7 |x#0|) 4294967296)) (=> (and (= |newtype$check#1@0| (nat_from_bv7 |x#0|)) (= (ControlFlow 0 2) (- 0 1))) (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 4294967296))))))))
