...
(set-info :boogie-vc-id Impl$$_module.Cell.MArray)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |x#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.Cell.arr))) (= (ControlFlow 0 2) (- 0 1))) (= |x#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.Cell.arr)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass._module.Cell _module.Cell$T@@9)) ($IsAlloc refType this (Tclass._module.Cell _module.Cell$T@@9) $Heap)))) (and (and ($Is refType |x#0| (Tclass._System.array _module.Cell$T@@9)) ($IsAlloc refType |x#0| (Tclass._System.array _module.Cell$T@@9) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
