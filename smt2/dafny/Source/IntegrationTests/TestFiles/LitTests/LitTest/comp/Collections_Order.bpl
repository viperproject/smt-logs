...
function Tclass.Order.T() : Ty;

procedure {:verboseName "Order.lt (well-formedness)"} CheckWellFormed$$Order.__default.lt(a#0: Box
       where $IsBox(a#0, Tclass.Order.T()) && $IsAllocBox(a#0, Tclass.Order.T(), $Heap), 
    b#0: Box
       where $IsBox(b#0, Tclass.Order.T()) && $IsAllocBox(b#0, Tclass.Order.T(), $Heap))
   returns (r#0: bool);
...
procedure {:verboseName "Order.lt (call)"} Call$$Order.__default.lt(a#0: Box
       where $IsBox(a#0, Tclass.Order.T()) && $IsAllocBox(a#0, Tclass.Order.T(), $Heap), 
    b#0: Box
       where $IsBox(b#0, Tclass.Order.T()) && $IsAllocBox(b#0, Tclass.Order.T(), $Heap))
   returns (r#0: bool);
