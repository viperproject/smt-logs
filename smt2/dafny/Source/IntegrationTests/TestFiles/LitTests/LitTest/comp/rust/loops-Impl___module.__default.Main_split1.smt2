...
(assert (forall ((|l#0@@3| T@U) (|l#1@@2| T@U) (|l#2@@2| T@U) (|l#3@@0| T@U) (|$w#2@@0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#6| |l#0@@3| |l#1@@2| |l#2@@2| |l#3@@0|) |$w#2@@0|))  (and ($IsBox |$w#2@@0| |l#0@@3|) (exists ((|a#4#0#0@@1| Int) ) (!  (and (|Set#IsMember| |l#1@@2| ($Box intType (int_2_U |a#4#0#0@@1|))) (= ($Unbox SeqType |$w#2@@0|) ($Unbox SeqType (MapType0Select BoxType BoxType |l#2@@2| (MapType0Select BoxType BoxType |l#3@@0| ($Box intType (int_2_U |a#4#0#0@@1|)))))))
 :qid |loopsdfy.39:30|
 :skolemid |503|
))))
 :qid |unknown.0:0|
 :skolemid |575|
 :pattern ( (MapType0Select BoxType boolType (|lambda#6| |l#0@@3| |l#1@@2| |l#2@@2| |l#3@@0|) |$w#2@@0|))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.Main_split1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 39) (let ((anon124_Then_correct  (=> (and (and (|Set#IsMember| (|Map#Domain| |s#0@0|) ($Box intType (int_2_U |k#9@0|))) (|Set#IsMember| (|Map#Domain| |s#0@0|) ($Box intType (int_2_U |k'#1@0|)))) (or (not (= |k#9@0| |k'#1@0|)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Set#IsMember| (|Map#Domain| |s#0@0|) ($Box intType (int_2_U |k#9@0|)))) (=> (|Set#IsMember| (|Map#Domain| |s#0@0|) ($Box intType (int_2_U |k#9@0|))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (_module.Result.Success_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |s#0@0|) ($Box intType (int_2_U |k#9@0|)))))) (=> (_module.Result.Success_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |s#0@0|) ($Box intType (int_2_U |k#9@0|))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#IsMember| (|Map#Domain| |s#0@0|) ($Box intType (int_2_U |k'#1@0|)))) (=> (|Set#IsMember| (|Map#Domain| |s#0@0|) ($Box intType (int_2_U |k'#1@0|))) (=> (= (ControlFlow 0 2) (- 0 1)) (_module.Result.Success_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |s#0@0|) ($Box intType (int_2_U |k'#1@0|)))))))))))))))
(let ((anon123_Else_correct  (=> (and (not (|Set#IsMember| (|Map#Domain| |s#0@0|) ($Box intType (int_2_U |k#9@0|)))) (= (ControlFlow 0 7) 2)) anon124_Then_correct)))
(let ((anon123_Then_correct  (=> (and (|Set#IsMember| (|Map#Domain| |s#0@0|) ($Box intType (int_2_U |k#9@0|))) (= (ControlFlow 0 6) 2)) anon124_Then_correct)))
(let ((anon26_correct  (=> (and (forall ((|a#5#0#0@@1| T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |u8toInt#0@0|) ($Box intType |a#5#0#0@@1|)) (and (|Set#IsMember| (|Map#Domain| |u8toInt#0@0|) ($Box intType (int_2_U (|map$project$2#0#k#0| ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| |x#0@0|) (MapType0Select BoxType BoxType (|Map#Elements| |u8toInt#0@0|) ($Box intType |a#5#0#0@@1|)))))))) (= ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| |x#0@0|) (MapType0Select BoxType BoxType (|Map#Elements| |u8toInt#0@0|) ($Box intType |a#5#0#0@@1|)))) ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| |x#0@0|) (MapType0Select BoxType BoxType (|Map#Elements| |u8toInt#0@0|) ($Box intType (int_2_U (|map$project$2#0#k#0| ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| |x#0@0|) (MapType0Select BoxType BoxType (|Map#Elements| |u8toInt#0@0|) ($Box intType |a#5#0#0@@1|)))))))))))))
 :qid |loopsdfy.39:30|
 :skolemid |504|
...
)) (= |helloWorldAgain#0@0| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#6| (TSeq TChar) (|Map#Domain| |u8toInt#0@0|) (|Map#Elements| |x#0@0|) (|Map#Elements| |u8toInt#0@0|))) |lambda#7| (TMap (TSeq TChar) (Tclass._module.Result Tclass._module.u8))))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (U_2_bool (Lit boolType (bool_2_U true)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (=> (= |successbool#0@0| (Lit DatatypeTypeType (|#_module.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Result.Success| ($Box boolType (Lit boolType (bool_2_U true))))))))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (_module.Result.Success_q |successbool#0@0|)) (=> (_module.Result.Success_q |successbool#0@0|) (and (=> (= (ControlFlow 0 8) (- 0 9)) (_module.Result.Success_q ($Unbox DatatypeTypeType (_module.Result.value |successbool#0@0|)))) (=> (_module.Result.Success_q ($Unbox DatatypeTypeType (_module.Result.value |successbool#0@0|))) (=> (and (= (U_2_bool ($Unbox boolType (_module.Result.value ($Unbox DatatypeTypeType (_module.Result.value |successbool#0@0|))))) (U_2_bool (Lit boolType (bool_2_U true)))) (= |s#0@0| (Lit MapType (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 1))) ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Result.Success| ($Box SeqType (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 104))) ($Box charType (|char#FromInt| 101))) ($Box charType (|char#FromInt| 108))) ($Box charType (|char#FromInt| 108))) ($Box charType (|char#FromInt| 111))))))))) ($Box intType (int_2_U (LitInt 2))) ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_module.Result.Success| ($Box SeqType (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 119))) ($Box charType (|char#FromInt| 111))) ($Box charType (|char#FromInt| 114))) ($Box charType (|char#FromInt| 108))) ($Box charType (|char#FromInt| 100)))))))))))) (and (=> (= (ControlFlow 0 8) 6) anon123_Then_correct) (=> (= (ControlFlow 0 8) 7) anon123_Else_correct)))))))))))))
(let ((anon120_Else_correct  (=> (and (not (and (|Set#IsMember| (|Map#Domain| |u8toInt#0@0|) ($Box intType (int_2_U |k#6@0|))) (|Set#IsMember| (|Map#Domain| |u8toInt#0@0|) ($Box intType (int_2_U |k#prime#2@0|))))) (= (ControlFlow 0 14) 8)) anon26_correct)))
(let ((anon120_Then_correct  (=> (and (and (|Set#IsMember| (|Map#Domain| |u8toInt#0@0|) ($Box intType (int_2_U |k#6@0|))) (|Set#IsMember| (|Map#Domain| |u8toInt#0@0|) ($Box intType (int_2_U |k#prime#2@0|)))) (and (or (or (not (= ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| |x#0@0|) (MapType0Select BoxType BoxType (|Map#Elements| |u8toInt#0@0|) ($Box intType (int_2_U |k#6@0|))))) ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| |x#0@0|) (MapType0Select BoxType BoxType (|Map#Elements| |u8toInt#0@0|) ($Box intType (int_2_U |k#prime#2@0|))))))) (not true)) (= (|#_module.Result.Success| ($Box intType (int_2_U |k#6@0|))) (|#_module.Result.Success| ($Box intType (int_2_U |k#prime#2@0|))))) (= (ControlFlow 0 13) 8))) anon26_correct)))
(let ((anon119_Else_correct  (=> (not (|Set#IsMember| (|Map#Domain| |u8toInt#0@0|) ($Box intType (int_2_U |k#6@0|)))) (and (=> (= (ControlFlow 0 16) 13) anon120_Then_correct) (=> (= (ControlFlow 0 16) 14) anon120_Else_correct)))))
(let ((anon119_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |u8toInt#0@0|) ($Box intType (int_2_U |k#6@0|))) (and (=> (= (ControlFlow 0 15) 13) anon120_Then_correct) (=> (= (ControlFlow 0 15) 14) anon120_Else_correct)))))
(let ((anon118_Else_correct  (=> (not (|Set#IsMember| (|Map#Domain| |u8toInt#0@0|) ($Box intType (int_2_U |k#6@0|)))) (and (=> (= (ControlFlow 0 18) 15) anon119_Then_correct) (=> (= (ControlFlow 0 18) 16) anon119_Else_correct)))))
(let ((anon118_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |u8toInt#0@0|) ($Box intType (int_2_U |k#6@0|))) (=> (and (|Set#IsMember| (|Map#Domain| |u8toInt#0@0|) ($Box intType (int_2_U |k#6@0|))) (|Set#IsMember| (|Map#Domain| |x#0@0|) (MapType0Select BoxType BoxType (|Map#Elements| |u8toInt#0@0|) ($Box intType (int_2_U |k#6@0|))))) (and (=> (= (ControlFlow 0 17) 15) anon119_Then_correct) (=> (= (ControlFlow 0 17) 16) anon119_Else_correct))))))
(let ((anon117_Then_correct  (=> (and (and (<= (LitInt 0) |k#6@0|) (< |k#6@0| 10)) (and (<= (LitInt 0) |k#prime#2@0|) (< |k#prime#2@0| 10))) (and (=> (= (ControlFlow 0 19) 17) anon118_Then_correct) (=> (= (ControlFlow 0 19) 18) anon118_Else_correct)))))
(let ((anon117_Else_correct  (=> (and (not (and (<= (LitInt 0) |k#6@0|) (< |k#6@0| 10))) (= (ControlFlow 0 12) 8)) anon26_correct)))
...
)) (= |IntToU8#0@0| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#4| TInt (|Map#Domain| |u8toInt#0@0|) (|Map#Elements| |u8toInt#0@0|))) |lambda#5| (TMap TInt Tclass._module.u8)))) (and (=> (= (ControlFlow 0 20) 19) anon117_Then_correct) (=> (= (ControlFlow 0 20) 12) anon117_Else_correct)))))
(let ((anon116_Else_correct  (=> (and (not (and (|Set#IsMember| (|Map#Domain| |u8toInt#0@0|) ($Box intType (int_2_U |k#4@0|))) (|Set#IsMember| (|Map#Domain| |u8toInt#0@0|) ($Box intType (int_2_U |k#prime#1@0|))))) (= (ControlFlow 0 23) 20)) anon19_correct)))
(let ((anon116_Then_correct  (=> (and (and (|Set#IsMember| (|Map#Domain| |u8toInt#0@0|) ($Box intType (int_2_U |k#4@0|))) (|Set#IsMember| (|Map#Domain| |u8toInt#0@0|) ($Box intType (int_2_U |k#prime#1@0|)))) (and (or (or (not (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |u8toInt#0@0|) ($Box intType (int_2_U |k#4@0|))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |u8toInt#0@0|) ($Box intType (int_2_U |k#prime#1@0|))))))) (not true)) (= |k#4@0| |k#prime#1@0|)) (= (ControlFlow 0 22) 20))) anon19_correct)))
(let ((anon115_Else_correct  (=> (not (|Set#IsMember| (|Map#Domain| |u8toInt#0@0|) ($Box intType (int_2_U |k#4@0|)))) (and (=> (= (ControlFlow 0 25) 22) anon116_Then_correct) (=> (= (ControlFlow 0 25) 23) anon116_Else_correct)))))
(let ((anon115_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |u8toInt#0@0|) ($Box intType (int_2_U |k#4@0|))) (and (=> (= (ControlFlow 0 24) 22) anon116_Then_correct) (=> (= (ControlFlow 0 24) 23) anon116_Else_correct)))))
(let ((anon114_Else_correct  (=> (not (|Set#IsMember| (|Map#Domain| |u8toInt#0@0|) ($Box intType (int_2_U |k#4@0|)))) (and (=> (= (ControlFlow 0 27) 24) anon115_Then_correct) (=> (= (ControlFlow 0 27) 25) anon115_Else_correct)))))
(let ((anon114_Then_correct  (=> (and (|Set#IsMember| (|Map#Domain| |u8toInt#0@0|) ($Box intType (int_2_U |k#4@0|))) (|Set#IsMember| (|Map#Domain| |u8toInt#0@0|) ($Box intType (int_2_U |k#4@0|)))) (and (=> (= (ControlFlow 0 26) 24) anon115_Then_correct) (=> (= (ControlFlow 0 26) 25) anon115_Else_correct)))))
(let ((anon113_Then_correct  (=> (and (and (<= (LitInt 0) |k#4@0|) (< |k#4@0| 10)) (and (<= (LitInt 0) |k#prime#1@0|) (< |k#prime#1@0| 10))) (and (=> (= (ControlFlow 0 28) 26) anon114_Then_correct) (=> (= (ControlFlow 0 28) 27) anon114_Else_correct)))))
(let ((anon113_Else_correct  (=> (and (not (and (<= (LitInt 0) |k#4@0|) (< |k#4@0| 10))) (= (ControlFlow 0 21) 20)) anon19_correct)))
...
))) (and ($HeapSucc $Heap $Heap@0) (= |newtype$check#0@0| (LitInt 1)))) (=> (and (and (and (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 10)) (= |newtype$check#1@0| (LitInt 1))) (and (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| 10)) (= |newtype$check#2@0| (LitInt 2)))) (and (and (and (<= (LitInt 0) |newtype$check#2@0|) (< |newtype$check#2@0| 10)) (= |newtype$check#3@0| (LitInt 2))) (and (and (<= (LitInt 0) |newtype$check#3@0|) (< |newtype$check#3@0| 10)) (= |u8toInt#0@0| (Lit MapType (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 1))) ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 2))))))))) (and (=> (= (ControlFlow 0 29) 28) anon113_Then_correct) (=> (= (ControlFlow 0 29) 21) anon113_Else_correct)))))))))
(let ((anon112_Else_correct  (=> (and (not (and (|Set#IsMember| (|Map#Domain| |x#0@0|) ($Box intType (int_2_U |k#2@0|))) (|Set#IsMember| (|Map#Domain| |x#0@0|) ($Box intType (int_2_U |k#prime#0@0|))))) (= (ControlFlow 0 31) 29)) anon12_correct)))
(let ((anon112_Then_correct  (=> (and (and (|Set#IsMember| (|Map#Domain| |x#0@0|) ($Box intType (int_2_U |k#2@0|))) (|Set#IsMember| (|Map#Domain| |x#0@0|) ($Box intType (int_2_U |k#prime#0@0|)))) (and (or (or (not (= (+ |k#2@0| 1) (+ |k#prime#0@0| 1))) (not true)) (= ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| |x#0@0|) ($Box intType (int_2_U |k#2@0|)))) ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| |x#0@0|) ($Box intType (int_2_U |k#prime#0@0|)))))) (= (ControlFlow 0 30) 29))) anon12_correct)))
(let ((anon111_Else_correct  (=> (not (|Set#IsMember| (|Map#Domain| |x#0@0|) ($Box intType (int_2_U |k#2@0|)))) (and (=> (= (ControlFlow 0 33) 30) anon112_Then_correct) (=> (= (ControlFlow 0 33) 31) anon112_Else_correct)))))
(let ((anon111_Then_correct  (=> (and (|Set#IsMember| (|Map#Domain| |x#0@0|) ($Box intType (int_2_U |k#2@0|))) (|Set#IsMember| (|Map#Domain| |x#0@0|) ($Box intType (int_2_U |k#2@0|)))) (and (=> (= (ControlFlow 0 32) 30) anon112_Then_correct) (=> (= (ControlFlow 0 32) 31) anon112_Else_correct)))))
(let ((anon110_Else_correct  (=> (not (|Set#IsMember| (|Map#Domain| |x#0@0|) ($Box intType (int_2_U |k#2@0|)))) (and (=> (= (ControlFlow 0 35) 32) anon111_Then_correct) (=> (= (ControlFlow 0 35) 33) anon111_Else_correct)))))
(let ((anon110_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |x#0@0|) ($Box intType (int_2_U |k#2@0|))) (and (=> (= (ControlFlow 0 34) 32) anon111_Then_correct) (=> (= (ControlFlow 0 34) 33) anon111_Else_correct)))))
