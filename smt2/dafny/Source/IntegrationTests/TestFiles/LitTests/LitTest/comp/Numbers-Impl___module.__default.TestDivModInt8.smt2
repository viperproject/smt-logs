...
(set-info :boogie-vc-id Impl$$_module.__default.TestDivModInt8)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |b#0| 0)) (not true))) (=> (= |newtype$check#2@0| (Div |a#0| |b#0|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= (LitInt (- 0 128)) |newtype$check#2@0|) (< |newtype$check#2@0| 128))) (=> (and (<= (LitInt (- 0 128)) |newtype$check#2@0|) (< |newtype$check#2@0| 128)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |b#0| 0)) (not true))) (=> (and (= |newtype$check#3@0| (Mod |a#0| |b#0|)) (= (ControlFlow 0 2) (- 0 1))) (and (<= (LitInt (- 0 128)) |newtype$check#3@0|) (< |newtype$check#3@0| 128)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (<= (LitInt (- 0 128)) |a#0|) (< |a#0| 128))) (=> (and (and (and (<= (LitInt (- 0 128)) |b#0|) (< |b#0| 128)) (and ($Is SeqType |suffix#0| (TSeq TChar)) ($IsAlloc SeqType |suffix#0| (TSeq TChar) $Heap))) (and (and (= 1 $FunctionContextHeight) (or (not (= |b#0| 0)) (not true))) (and (<= (LitInt (- 0 127)) |a#0|) (= (ControlFlow 0 6) 2)))) anon0_correct))))
