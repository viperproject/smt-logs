...
axiom (forall a#12#0#0: Box :: 
  { #RustStdCompare.Option.Some(a#12#0#0) } 
  DatatypeCtorId(#RustStdCompare.Option.Some(a#12#0#0))
...
axiom (forall d: DatatypeType :: 
  { RustStdCompare.Option.Some_q(d) } 
  RustStdCompare.Option.Some_q(d)
     ==> (exists a#13#0#0: Box :: d == #RustStdCompare.Option.Some(a#13#0#0)));
...
// Constructor $Is
axiom (forall RustStdCompare.Option$T: Ty, a#14#0#0: Box :: 
  { $Is(#RustStdCompare.Option.Some(a#14#0#0), 
      Tclass.RustStdCompare.Option(RustStdCompare.Option$T)) } 
  $Is(#RustStdCompare.Option.Some(a#14#0#0), 
      Tclass.RustStdCompare.Option(RustStdCompare.Option$T))
     <==> $IsBox(a#14#0#0, RustStdCompare.Option$T));

// Constructor $IsAlloc
axiom (forall RustStdCompare.Option$T: Ty, a#14#0#0: Box, $h: Heap :: 
  { $IsAlloc(#RustStdCompare.Option.Some(a#14#0#0), 
      Tclass.RustStdCompare.Option(RustStdCompare.Option$T), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#RustStdCompare.Option.Some(a#14#0#0), 
        Tclass.RustStdCompare.Option(RustStdCompare.Option$T), 
        $h)
       <==> $IsAllocBox(a#14#0#0, RustStdCompare.Option$T, $h)));
...
axiom (forall a#15#0#0: Box :: 
  { #RustStdCompare.Option.Some(Lit(a#15#0#0)) } 
  #RustStdCompare.Option.Some(Lit(a#15#0#0))
     == Lit(#RustStdCompare.Option.Some(a#15#0#0)));

function RustStdCompare.Option.value(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#16#0#0: Box :: 
  { #RustStdCompare.Option.Some(a#16#0#0) } 
  RustStdCompare.Option.value(#RustStdCompare.Option.Some(a#16#0#0)) == a#16#0#0);

// Inductive rank
axiom (forall a#17#0#0: Box :: 
  { #RustStdCompare.Option.Some(a#17#0#0) } 
  BoxRank(a#17#0#0) < DtRank(#RustStdCompare.Option.Some(a#17#0#0)));
