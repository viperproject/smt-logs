...
(declare-fun Methods.Trait.InstanceT$Bt () T@U)
(declare-fun Methods.Class.InstanceT$Bc () T@U)
...
(set-info :boogie-vc-id OverrideCheck$$Methods.Class.InstanceT)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (= Methods.Trait$At@@13 Methods.Class$Ac@@14) (= Methods.Trait.InstanceT$Bt Methods.Class.InstanceT$Bc)) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@13 T@U) ($f T@U) ) (! true
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass.Methods.Class Methods.Class$Ac@@14)) ($IsAlloc refType this (Tclass.Methods.Class Methods.Class$Ac@@14) $Heap))) (and ($IsBox |a#0| Methods.Class$Ac@@14) ($IsAllocBox |a#0| Methods.Class$Ac@@14 $Heap))) (=> (and (and (and ($IsBox |b#0| Methods.Class.InstanceT$Bc) ($IsAllocBox |b#0| Methods.Class.InstanceT$Bc $Heap)) (and ($IsBox |aa#0| Methods.Class$Ac@@14) ($IsAllocBox |aa#0| Methods.Class$Ac@@14 $Heap))) (and (and ($IsBox |bb#0| Methods.Class.InstanceT$Bc) ($IsAllocBox |bb#0| Methods.Class.InstanceT$Bc $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 2)))) anon0_correct)))))
