...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (= Methods.Trait$At@@13 Methods.Class$Ac@@14) (= Methods.Trait.InstanceT$Bt Methods.Class.InstanceT$Bc)) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@13 T@U) ($f T@U) ) true)) (=> (forall (($o@@14 T@U) ($f@@0 T@U) ) true) (=> (= (ControlFlow 0 2) (- 0 1)) (forall (($o@@15 T@U) ($f@@1 T@U) ) true))))))))
