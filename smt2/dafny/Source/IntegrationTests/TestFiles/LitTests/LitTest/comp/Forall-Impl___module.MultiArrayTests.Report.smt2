...
(assert (forall (($h@@6 T@U) ($o@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (or (not (= $o@@9 null)) (not true)) (= (dtype $o@@9) Tclass._module.MultiArrayTests?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@9) _module.MultiArrayTests.a)) (Tclass._System.array2 TInt)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1225|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@9) _module.MultiArrayTests.a)))
)))
...
(set-info :boogie-vc-id Impl$$_module.MultiArrayTests.Report)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) ($IsAllocBox ($Box refType this@@0) Tclass._module.MultiArrayTests? $Heap@@0)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.MultiArrayTests.Valid#canCall| $Heap@@0 this@@0) (or (_module.MultiArrayTests.Valid $Heap@@0 this@@0) (= (_System.array2.Length0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.MultiArrayTests.a))) (LitInt 3))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.MultiArrayTests.Valid#canCall| $Heap@@0 this@@0) (or (_module.MultiArrayTests.Valid $Heap@@0 this@@0) (= (_System.array2.Length1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.MultiArrayTests.a))) (LitInt 3))))) (=> (and (|_module.MultiArrayTests.StateAsSeq#canCall| $Heap@@0 this@@0) (|_module.MultiArrayTests.StateAsSeq#canCall| $Heap@@0 this@@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.MultiArrayTests.Valid#canCall| $Heap@@0 this@@0) (or (_module.MultiArrayTests.Valid $Heap@@0 this@@0) (= (_System.array2.Length0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.MultiArrayTests.a))) (LitInt 3))))) (=> (=> (|_module.MultiArrayTests.Valid#canCall| $Heap@@0 this@@0) (or (_module.MultiArrayTests.Valid $Heap@@0 this@@0) (= (_System.array2.Length0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.MultiArrayTests.a))) (LitInt 3)))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.MultiArrayTests.Valid#canCall| $Heap@@0 this@@0) (or (_module.MultiArrayTests.Valid $Heap@@0 this@@0) (= (_System.array2.Length1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.MultiArrayTests.a))) (LitInt 3)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.MultiArrayTests) ($IsAlloc refType this@@0 Tclass._module.MultiArrayTests $Heap@@0))) (= 2 $FunctionContextHeight)) (and (and (|_module.MultiArrayTests.Valid#canCall| $Heap@@0 this@@0) (and (_module.MultiArrayTests.Valid $Heap@@0 this@@0) (and (= (_System.array2.Length0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.MultiArrayTests.a))) (LitInt 3)) (= (_System.array2.Length1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.MultiArrayTests.a))) (LitInt 3))))) (= (ControlFlow 0 6) 2))) anon0_correct))))
