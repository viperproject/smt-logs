...
(declare-fun _module.__default.TWO__15 () Int)
...
(assert  (=> (< 0 $FunctionContextHeight) ($Is intType (int_2_U _module.__default.TWO__15) TInt)))
(assert (forall ((x@@5 T@U) (T@@1 T@T) ) (! (= ($Unbox T@@1 ($Box T@@1 x@@5)) x@@5)
 :qid |DafnyPreludebpl.167:18|
 :skolemid |25|
 :pattern ( ($Box T@@1 x@@5))
)))
(assert (= _module.__default.TWO__15 (LitInt 32768)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.I4)
...
(let ((anon8_Else_correct  (=> (and (< |x#0| (- 0 _module.__default.TWO__15)) (= (ControlFlow 0 6) 4)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (<= (- 0 _module.__default.TWO__15) |x#0|) (= (ControlFlow 0 5) 4)) anon4_correct)))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (- 0 _module.__default.TWO__15) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 _module.__default.TWO__15)))))
