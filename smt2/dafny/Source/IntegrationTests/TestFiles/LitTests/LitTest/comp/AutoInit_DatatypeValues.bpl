...
procedure {:verboseName "DatatypeValues.Test (correctness)"} Impl$$DatatypeValues.__default.Test() returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
axiom 1 <= $FunctionContextHeight
   ==> (forall DatatypeValues._default.CoCalls$G: Ty, $ly: LayerType, g#0: Box :: 
    ...
    DatatypeValues.__default.CoCalls#canCall(DatatypeValues._default.CoCalls$G, g#0)
         || (1 < $FunctionContextHeight && $IsBox(g#0, DatatypeValues._default.CoCalls$G))
...
axiom 1 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, DatatypeValues._default.CoCalls$G: Ty, $ly: LayerType, g#0: Box :: 
...
procedure {:verboseName "DatatypeValues.CoCalls (well-formedness)"} CheckWellformed$$DatatypeValues.__default.CoCalls(DatatypeValues._default.CoCalls$G: Ty, 
    g#0: Box where $IsBox(g#0, DatatypeValues._default.CoCalls$G));
...
axiom 1 <= $FunctionContextHeight
   ==> (forall DatatypeValues._default.AutoCoCalls$G: Ty, $ly: LayerType, g#0: Box :: 
...
axiom 1 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, DatatypeValues._default.AutoCoCalls$G: Ty, $ly: LayerType, g#0: Box :: 
...
axiom {:id "id194"} 1 <= $FunctionContextHeight
   ==> (forall DatatypeValues._default.AutoCoCalls$G: Ty, $ly: LayerType, g#0: Box :: 
...
procedure {:verboseName "DatatypeValues.AutoCoCalls (well-formedness)"} CheckWellformed$$DatatypeValues.__default.AutoCoCalls(DatatypeValues._default.AutoCoCalls$G: Ty, 
    g#0: Box where $IsBox(g#0, DatatypeValues._default.AutoCoCalls$G));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
