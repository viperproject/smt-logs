...
(assert (distinct TInt TagInt alloc Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 Tagclass._System.___hTotalFunc1 Tagclass._module.Pos Tagclass._module.Index |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1| |tytagFamily$_#TotalFunc1| tytagFamily$Pos tytagFamily$Index)
)
...
(assert  (=> (< 1 $FunctionContextHeight) (forall (($h@@1 T@U) ) (!  (=> ($IsGoodHeap $h@@1) ($IsAlloc intType (int_2_U _module.__default.N) Tclass._module.Pos $h@@1))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |529|
 :pattern ( ($IsAlloc intType (int_2_U _module.__default.N) Tclass._module.Pos $h@@1))
))))
...
(assert (forall ((bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 Tclass._module.Index) (and (= ($Box intType ($Unbox intType bx@@2)) bx@@2) ($Is intType ($Unbox intType bx@@2) Tclass._module.Index)))
 :qid |unknown.0:0|
 :skolemid |533|
 :pattern ( ($IsBox bx@@2 Tclass._module.Index))
)))
...
(declare-fun call1formal@_module._default.FunEq$Y@0 () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon7_Else_correct  (=> (= |f##0_0@0| ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap |a#0| ($Box intType (int_2_U |x#0_0@0|))))) (=> (and (= |g##0_0@0| ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap |b#0| ($Box intType (int_2_U |x#0_0@0|))))) (= call0formal@_module._default.FunEq$X@0 Tclass._module.Index)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((|x#1| T@U) ) (!  (=> (and ($IsBox |x#1| call0formal@_module._default.FunEq$X@0) ($IsAllocBox |x#1| call0formal@_module._default.FunEq$X@0 $Heap)) (= (Apply1 call0formal@_module._default.FunEq$X@0 TInt $Heap |f##0_0@0| |x#1|) (Apply1 call0formal@_module._default.FunEq$X@0 TInt $Heap |g##0_0@0| |x#1|)))
 :qid |MatrixAssocdfy.16:19|
 :skolemid |531|
 :pattern ( (Apply1 call0formal@_module._default.FunEq$X@0 TInt $Heap |g##0_0@0| |x#1|))
 :pattern ( (Apply1 call0formal@_module._default.FunEq$X@0 TInt $Heap |f##0_0@0| |x#1|))
))) (=> (forall ((|x#1@@0| T@U) ) (!  (=> (and ($IsBox |x#1@@0| call0formal@_module._default.FunEq$X@0) ($IsAllocBox |x#1@@0| call0formal@_module._default.FunEq$X@0 $Heap)) (= (Apply1 call0formal@_module._default.FunEq$X@0 TInt $Heap |f##0_0@0| |x#1@@0|) (Apply1 call0formal@_module._default.FunEq$X@0 TInt $Heap |g##0_0@0| |x#1@@0|)))
 :qid |MatrixAssocdfy.16:19|
 :skolemid |531|
 :pattern ( (Apply1 call0formal@_module._default.FunEq$X@0 TInt $Heap |g##0_0@0| |x#1@@0|))
 :pattern ( (Apply1 call0formal@_module._default.FunEq$X@0 TInt $Heap |f##0_0@0| |x#1@@0|))
)) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= |f##0_0@0| |g##0_0@0|)) (and (= $Heap $Heap@1) (= (ControlFlow 0 7) (- 0 6)))) (= ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@1 |a#0| ($Box intType (int_2_U |x#0_0@0|)))) ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@1 |b#0| ($Box intType (int_2_U |x#0_0@0|))))))))))))
(let ((anon7_Then_correct true))
(let ((anon6_Then_correct  (=> (and (<= (LitInt 0) |x#0_0@0|) (< |x#0_0@0| _module.__default.N)) (and (=> (= (ControlFlow 0 9) 5) anon7_Then_correct) (=> (= (ControlFlow 0 9) 7) anon7_Else_correct)))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (= |a#0| |b#0|))))
(let ((anon6_Else_correct  (=> (forall ((|x#0_1| T@U) ) (!  (=> (and (and (<= (LitInt 0) (U_2_int |x#0_1|)) (< (U_2_int |x#0_1|) _module.__default.N)) (U_2_bool (Lit boolType (bool_2_U true)))) (= ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap |a#0| ($Box intType |x#0_1|))) ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap |b#0| ($Box intType |x#0_1|)))))
 :qid |MatrixAssocdfy.26:10|
 :skolemid |538|
 :pattern ( ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap |b#0| ($Box intType |x#0_1|))))
 :pattern ( ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap |a#0| ($Box intType |x#0_1|))))
)) (=> (and (= call0formal@_module._default.FunEq$X@0@@0 Tclass._module.Index) (= call1formal@_module._default.FunEq$Y@0 (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((|x#1@@1| T@U) ) (!  (=> (and ($IsBox |x#1@@1| call0formal@_module._default.FunEq$X@0@@0) ($IsAllocBox |x#1@@1| call0formal@_module._default.FunEq$X@0@@0 $Heap)) (= (Apply1 call0formal@_module._default.FunEq$X@0@@0 call1formal@_module._default.FunEq$Y@0 $Heap |a#0| |x#1@@1|) (Apply1 call0formal@_module._default.FunEq$X@0@@0 call1formal@_module._default.FunEq$Y@0 $Heap |b#0| |x#1@@1|)))
 :qid |MatrixAssocdfy.16:19|
 :skolemid |531|
 :pattern ( (Apply1 call0formal@_module._default.FunEq$X@0@@0 call1formal@_module._default.FunEq$Y@0 $Heap |b#0| |x#1@@1|))
 :pattern ( (Apply1 call0formal@_module._default.FunEq$X@0@@0 call1formal@_module._default.FunEq$Y@0 $Heap |a#0| |x#1@@1|))
))) (=> (forall ((|x#1@@2| T@U) ) (!  (=> (and ($IsBox |x#1@@2| call0formal@_module._default.FunEq$X@0@@0) ($IsAllocBox |x#1@@2| call0formal@_module._default.FunEq$X@0@@0 $Heap)) (= (Apply1 call0formal@_module._default.FunEq$X@0@@0 call1formal@_module._default.FunEq$Y@0 $Heap |a#0| |x#1@@2|) (Apply1 call0formal@_module._default.FunEq$X@0@@0 call1formal@_module._default.FunEq$Y@0 $Heap |b#0| |x#1@@2|)))
 :qid |MatrixAssocdfy.16:19|
 :skolemid |531|
 :pattern ( (Apply1 call0formal@_module._default.FunEq$X@0@@0 call1formal@_module._default.FunEq$Y@0 $Heap |b#0| |x#1@@2|))
 :pattern ( (Apply1 call0formal@_module._default.FunEq$X@0@@0 call1formal@_module._default.FunEq$Y@0 $Heap |a#0| |x#1@@2|))
)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= |a#0| |b#0|)) (and (= $Heap $Heap@0) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct)))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is HandleTypeType |a#0| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt))) ($IsAlloc HandleTypeType |a#0| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) $Heap))) (=> (and (and (and ($Is HandleTypeType |b#0| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt))) ($IsAlloc HandleTypeType |b#0| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) $Heap)) (= 4 $FunctionContextHeight)) (and (forall ((|x#1@@3| T@U) (|y#1| T@U) ) (!  (=> (and (and (<= (LitInt 0) (U_2_int |x#1@@3|)) (< (U_2_int |x#1@@3|) _module.__default.N)) (and (<= (LitInt 0) (U_2_int |y#1|)) (< (U_2_int |y#1|) _module.__default.N))) (= (U_2_int ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap |a#0| ($Box intType |x#1@@3|))) ($Box intType |y#1|)))) (U_2_int ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap |b#0| ($Box intType |x#1@@3|))) ($Box intType |y#1|))))))
 :qid |MatrixAssocdfy.23:19|
 :skolemid |536|
 :pattern ( ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap |b#0| ($Box intType |x#1@@3|))) ($Box intType |y#1|))))
 :pattern ( ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap |a#0| ($Box intType |x#1@@3|))) ($Box intType |y#1|))))
