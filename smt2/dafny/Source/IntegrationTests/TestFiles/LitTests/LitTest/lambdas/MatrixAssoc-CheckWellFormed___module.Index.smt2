...
(assert (forall ((|x#0| T@U) ) (! (= ($Is intType |x#0| Tclass._module.Pos) (< 0 (U_2_int |x#0|)))
 :qid |unknown.0:0|
 :skolemid |737|
...
(set-info :boogie-vc-id CheckWellFormed$$_module.Index)
...
(let ((anon8_Else_correct  (=> (and (< |x#0@@0| (LitInt 0)) (= (ControlFlow 0 6) 4)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (<= (LitInt 0) |x#0@@0|) (= (ControlFlow 0 5) 4)) anon4_correct)))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 _module.__default.N)))))
