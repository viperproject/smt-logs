...
(assert (forall ((|l#0@@3| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#x#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#4| |l#0@@3|) |$l#0#heap#0@@1| |$l#0#x#0@@1|) |l#0@@3|)
 :qid |LambdaEqdfy.6:24|
 :skolemid |483|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#4| |l#0@@3|) |$l#0#heap#0@@1| |$l#0#x#0@@1|))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.Eq2)
...
(let ((anon10_Else_correct  (=> (and (< |x#0@0| (LitInt 0)) (= (ControlFlow 0 9) 7)) anon3_correct)))
(let ((anon10_Then_correct  (=> (<= (LitInt 0) |x#0@0|) (=> (and (and (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (= |lambdaResult#0| |x#0@0|)) (and ($Is intType (int_2_U |lambdaResult#0|) Tclass._System.nat) (= (ControlFlow 0 8) 7))) anon3_correct))))
(let ((anon9_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 10) 8) anon10_Then_correct) (=> (= (ControlFlow 0 10) 9) anon10_Else_correct)))))
(let ((anon12_Else_correct true))
(let ((anon12_Then_correct true))
(let ((anon11_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#1@0|) (or (= $Heap |$lambdaHeap#1@0|) ($HeapSucc $Heap |$lambdaHeap#1@0|))) (and (=> (= (ControlFlow 0 5) 3) anon12_Then_correct) (=> (= (ControlFlow 0 5) 4) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (= |i#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 |lambda#1| (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))) (= (ControlFlow 0 2) (- 0 1))) (= |f#0@0| |i#0@0|))))
(let ((anon9_Else_correct  (=> (= |f#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 |lambda#1| (|lambda#2| Tclass._System.nat) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))) (and (=> (= (ControlFlow 0 6) 5) anon11_Then_correct) (=> (= (ControlFlow 0 6) 2) anon11_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 11) 10) anon9_Then_correct) (=> (= (ControlFlow 0 11) 6) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 Tclass._System.nat TInt)) ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 Tclass._System.nat TInt) $Heap)) true) (=> (and (and (and ($Is HandleTypeType |i#0| (Tclass._System.___hTotalFunc1 Tclass._System.nat TInt)) ($IsAlloc HandleTypeType |i#0| (Tclass._System.___hTotalFunc1 Tclass._System.nat TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 12) 11))) anon0_correct)))))
