
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#157| |l#0@@5| |l#1@@2| |l#2@@2| |l#3@@2| |l#4@@2| |l#5@@2| |l#6@@1| |l#7@@1| |l#8@@1| |l#9@@1|) |$l#9#heap#0| |$l#9#k#0|))
)))
(assert (forall ((|l#0@@6| T@U) (|l#1@@3| T@U) (|l#2@@3| T@U) (|l#3@@3| T@U) (|l#4@@3| T@U) (|l#5@@3| T@U) (|l#6@@2| T@U) (|l#7@@2| T@U) (|l#8@@2| T@U) (|l#9@@2| Int) (|$l#22#heap#0| T@U) (|$l#22#l#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#177| |l#0@@6| |l#1@@3| |l#2@@3| |l#3@@3| |l#4@@3| |l#5@@3| |l#6@@2| |l#7@@2| |l#8@@2| |l#9@@2|) |$l#22#heap#0| |$l#22#l#0|) ($Box intType (int_2_U (_module.__default.Sum__n |l#0@@6| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#172| |l#1@@3| |l#2@@3| |l#3@@3| |l#4@@3| |l#5@@3| ($Box intType ($Unbox intType |$l#22#l#0|))) |l#6@@2| |l#7@@2|)) |l#8@@2|)) |l#9@@2|))))
 :qid |unknown.0:0|
 :skolemid |757|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#177| |l#0@@6| |l#1@@3| |l#2@@3| |l#3@@3| |l#4@@3| |l#5@@3| |l#6@@2| |l#7@@2| |l#8@@2| |l#9@@2|) |$l#22#heap#0| |$l#22#l#0|))
)))
...
(assert (forall ((|l#0@@7| T@U) (|l#1@@4| T@U) (|l#2@@4| T@U) (|l#3@@4| T@U) (|l#4@@4| T@U) (|l#5@@4| T@U) (|$l#10#heap#0| T@U) (|$l#10#l#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#152| |l#0@@7| |l#1@@4| |l#2@@4| |l#3@@4| |l#4@@4| |l#5@@4|) |$l#10#heap#0| |$l#10#l#0|) ($Box intType ($Unbox intType (Apply1 |l#0@@7| |l#1@@4| |$l#10#heap#0| ($Unbox HandleTypeType (Apply1 |l#2@@4| |l#3@@4| |$l#10#heap#0| |l#4@@4| |l#5@@4|)) ($Box intType ($Unbox intType |$l#10#l#0|))))))
 :qid |MatrixAssocdfy.10:6|
 :skolemid |753|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#152| |l#0@@7| |l#1@@4| |l#2@@4| |l#3@@4| |l#4@@4| |l#5@@4|) |$l#10#heap#0| |$l#10#l#0|))
)))
...
(assert (forall ((|l#0@@9| T@U) (|$l#6#heap#0@@0| T@U) (|$l#6#k#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#7| |l#0@@9|) |$l#6#heap#0@@0| |$l#6#k#0@@0|) |l#0@@9|)
 :qid |MatrixAssocdfy.50:9|
 :skolemid |745|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#7| |l#0@@9|) |$l#6#heap#0@@0| |$l#6#k#0@@0|))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.sum__assoc__n)
...
(let ((anon21_Else_correct  (=> (and (not (and (<= (LitInt 0) |l#0@0|) (< |l#0@0| _module.__default.N))) (= (ControlFlow 0 21) 19)) anon6_correct)))
(let ((anon21_Then_correct  (=> (and (<= (LitInt 0) |l#0@0|) (< |l#0@0| _module.__default.N)) (=> (and (and (= |$_Frame#l1@0| (|lambda#0| null |$lambdaHeap#1@0| alloc false)) (= |lambdaResult#1| (U_2_int ($Unbox intType (Apply1 Tclass._module.Index TInt |$lambdaHeap#0@0| ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) |$lambdaHeap#0@0| |m#0| ($Box intType (int_2_U |k#0@0|)))) ($Box intType (int_2_U |l#0@0|))))))) (and ($Is intType (int_2_U |lambdaResult#1|) TInt) (= (ControlFlow 0 20) 19))) anon6_correct))))
(let ((anon20_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#1@0|) (or (= |$lambdaHeap#0@0| |$lambdaHeap#1@0|) ($HeapSucc |$lambdaHeap#0@0| |$lambdaHeap#1@0|))) (and (=> (= (ControlFlow 0 22) 20) anon21_Then_correct) (=> (= (ControlFlow 0 22) 21) anon21_Else_correct)))))
(let ((anon8_correct true))
(let ((anon20_Else_correct  (=> (= |##f#1@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#152| Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) |m#0| ($Box intType (int_2_U |k#0@0|))) (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ)))) (=> (and ($IsAlloc HandleTypeType |##f#1@0| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) |$lambdaHeap#0@0|) ($IsAlloc intType (int_2_U |n1#0|) Tclass._System.nat |$lambdaHeap#0@0|)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (<= |n1#0| _module.__default.N)) (=> (and (<= |n1#0| _module.__default.N) (|_module.__default.Sum__n#canCall| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#152| Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) |m#0| ($Box intType (int_2_U |k#0@0|))) (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) |n1#0|)) (=> (and (and (= |lambdaResult#0| (_module.__default.Sum__n ($LS $LZ) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#152| Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) |m#0| ($Box intType (int_2_U |k#0@0|))) (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) |n1#0|)) (|_module.__default.Sum__n#canCall| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#152| Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) |m#0| ($Box intType (int_2_U |k#0@0|))) (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) |n1#0|)) (and ($Is intType (int_2_U |lambdaResult#0|) TInt) (= (ControlFlow 0 17) 15))) anon8_correct)))))))
(let ((anon19_Then_correct  (=> (and (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| _module.__default.N)) (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false))) (and (=> (= (ControlFlow 0 23) 22) anon20_Then_correct) (=> (= (ControlFlow 0 23) 17) anon20_Else_correct)))))
(let ((anon19_Else_correct  (=> (and (not (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| _module.__default.N))) (= (ControlFlow 0 16) 15)) anon8_correct)))
(let ((anon18_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@0 |$lambdaHeap#0@0|) ($HeapSucc $Heap@0 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 24) 23) anon19_Then_correct) (=> (= (ControlFlow 0 24) 16) anon19_Else_correct)))))
(let ((anon14_correct true))
(let ((anon25_Else_correct  (=> (and (not (and (<= (LitInt 0) |k#1@0|) (< |k#1@0| _module.__default.N))) (= (ControlFlow 0 9) 7)) anon14_correct)))
(let ((anon25_Then_correct  (=> (and (<= (LitInt 0) |k#1@0|) (< |k#1@0| _module.__default.N)) (=> (and (and (= |$_Frame#l3@0| (|lambda#0| null |$lambdaHeap#3@0| alloc false)) (= |lambdaResult#3| (U_2_int ($Unbox intType (Apply1 Tclass._module.Index TInt |$lambdaHeap#2@0| ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) |$lambdaHeap#2@0| |m#0| ($Box intType (int_2_U |k#1@0|)))) ($Box intType (int_2_U |l#1@0|))))))) (and ($Is intType (int_2_U |lambdaResult#3|) TInt) (= (ControlFlow 0 8) 7))) anon14_correct))))
(let ((anon24_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#3@0|) (or (= |$lambdaHeap#2@0| |$lambdaHeap#3@0|) ($HeapSucc |$lambdaHeap#2@0| |$lambdaHeap#3@0|))) (and (=> (= (ControlFlow 0 10) 8) anon25_Then_correct) (=> (= (ControlFlow 0 10) 9) anon25_Else_correct)))))
(let ((anon16_correct true))
(let ((anon24_Else_correct  (=> (= |##f#3@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#172| Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) |m#0| ($Box intType (int_2_U |l#1@0|))) (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ)))) (=> (and ($IsAlloc HandleTypeType |##f#3@0| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) |$lambdaHeap#2@0|) ($IsAlloc intType (int_2_U |n2#0|) Tclass._System.nat |$lambdaHeap#2@0|)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= |n2#0| _module.__default.N)) (=> (and (<= |n2#0| _module.__default.N) (|_module.__default.Sum__n#canCall| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#172| Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) |m#0| ($Box intType (int_2_U |l#1@0|))) (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) |n2#0|)) (=> (and (and (= |lambdaResult#2| (_module.__default.Sum__n ($LS $LZ) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#172| Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) |m#0| ($Box intType (int_2_U |l#1@0|))) (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) |n2#0|)) (|_module.__default.Sum__n#canCall| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#172| Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) |m#0| ($Box intType (int_2_U |l#1@0|))) (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) |n2#0|)) (and ($Is intType (int_2_U |lambdaResult#2|) TInt) (= (ControlFlow 0 5) 3))) anon16_correct)))))))
(let ((anon23_Then_correct  (=> (and (and (<= (LitInt 0) |l#1@0|) (< |l#1@0| _module.__default.N)) (= |$_Frame#l2@0| (|lambda#0| null |$lambdaHeap#2@0| alloc false))) (and (=> (= (ControlFlow 0 11) 10) anon24_Then_correct) (=> (= (ControlFlow 0 11) 5) anon24_Else_correct)))))
(let ((anon23_Else_correct  (=> (and (not (and (<= (LitInt 0) |l#1@0|) (< |l#1@0| _module.__default.N))) (= (ControlFlow 0 4) 3)) anon16_correct)))
(let ((anon22_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#2@0|) (or (= $Heap@0 |$lambdaHeap#2@0|) ($HeapSucc $Heap@0 |$lambdaHeap#2@0|))) (and (=> (= (ControlFlow 0 12) 11) anon23_Then_correct) (=> (= (ControlFlow 0 12) 4) anon23_Else_correct)))))
(let ((anon22_Else_correct  (=> (and (and (= |##f#2@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#181| Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) |m#0| (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))) |n2#0| (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false)))) ($LS $LZ)))) ($IsAlloc HandleTypeType |##f#2@0| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@0)) (and ($IsAlloc intType (int_2_U |n1#0|) Tclass._System.nat $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (<= |n1#0| _module.__default.N))))
(let ((anon18_Else_correct  (=> (= |##f#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#161| Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) |m#0| (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))) |n1#0| (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false)))) ($LS $LZ)))) (=> (and ($IsAlloc HandleTypeType |##f#0@0| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@0) ($IsAlloc intType (int_2_U |n2#0|) Tclass._System.nat $Heap@0)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= |n2#0| _module.__default.N)) (=> (and (<= |n2#0| _module.__default.N) (|_module.__default.Sum__n#canCall| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#161| Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) |m#0| (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))) |n1#0| (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false)))) ($LS $LZ))) |n2#0|)) (and (=> (= (ControlFlow 0 13) 12) anon22_Then_correct) (=> (= (ControlFlow 0 13) 2) anon22_Else_correct))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (=> (and (<= |n1#0| _module.__default.N) (<= |n2#0| _module.__default.N)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@2 $Heap@0)) (and (=> (= (ControlFlow 0 25) 24) anon18_Then_correct) (=> (= (ControlFlow 0 25) 13) anon18_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and ($Is HandleTypeType |m#0| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt))) ($IsAlloc HandleTypeType |m#0| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) $Heap@@2))) (and (and (<= (LitInt 0) |n1#0|) (<= (LitInt 0) |n2#0|)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 26) 25)))) anon0_correct)))
