...
(assert (forall ((v@@2 T@U) (t0@@9 T@U) (h@@5 T@U) ) (! (= ($IsAlloc SetType v@@2 (TSet t0@@9) h@@5) (forall ((bx@@10 T@U) ) (!  (=> (|Set#IsMember| v@@2 bx@@10) ($IsAllocBox bx@@10 t0@@9 h@@5))
...
(set-info :boogie-vc-id Impl$$_module.__default.distr__mult)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($Is intType (int_2_U _module.__default.N) Tclass._System.nat)) (=> ($Is intType (int_2_U _module.__default.N) Tclass._System.nat) (=> (= |n##0@0| _module.__default.N) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= |n##0@0| _module.__default.N)) (=> (<= |n##0@0| _module.__default.N) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (|_module.__default.Sum__n#canCall| |f#0@@9| |n##0@0|) (|_module.__default.Sum__n#canCall| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#88| Tclass._module.Index TInt |f#0@@9| |x#0@@5|) (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) |n##0@0|)) (= (Mul (_module.__default.Sum__n ($LS ($LS $LZ)) |f#0@@9| |n##0@0|) |x#0@@5|) (_module.__default.Sum__n ($LS ($LS $LZ)) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#88| Tclass._module.Index TInt |f#0@@9| |x#0@@5|) (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) |n##0@0|))) (and (= $Heap@@2 $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (= (Mul (_module.__default.Sum |f#0@@9|) |x#0@@5|) (LitInt (_module.__default.Sum (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#88| Tclass._module.Index TInt |f#0@@9| |x#0@@5|) (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and ($Is HandleTypeType |f#0@@9| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) ($IsAlloc HandleTypeType |f#0@@9| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@2)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct))))
