...
(set-info :boogie-vc-id Impl$$_module.__default.mult__assoc__ij_split0)
...
)) (= (ControlFlow 0 2) (- 0 1))) (forall ((|k#0_8_2@@0| Int) ) (!  (=> (and (<= (LitInt 0) |k#0_8_2@@0|) (< |k#0_8_2@@0| _module.__default.N)) (= (U_2_int ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@@4 ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@4 (_module.__default.mult |a#0@@2| |b#0@@2|) ($Box intType (int_2_U |i#0|)))) ($Box intType (int_2_U |k#0_8_2@@0|))))) (LitInt (_module.__default.Sum (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#4| Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) |a#0@@2| ($Box intType (int_2_U |i#0|)) Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) |b#0@@2| ($Box intType (int_2_U |k#0_8_2@@0|))) (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ)))))))
 :qid |MatrixAssocdfy.180:22|
 :skolemid |726|
 :pattern ( ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@@4 ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@4 (_module.__default.mult |a#0@@2| |b#0@@2|) ($Box intType (int_2_U |i#0|)))) ($Box intType (int_2_U |k#0_8_2@@0|)))))
)))))
