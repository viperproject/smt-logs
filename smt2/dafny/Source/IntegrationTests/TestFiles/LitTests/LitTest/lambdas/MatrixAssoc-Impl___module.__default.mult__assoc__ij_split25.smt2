...
(set-info :boogie-vc-id Impl$$_module.__default.mult__assoc__ij_split25)
...
(assert (not
 ...
 :qid |unknown.0:0|
 :skolemid |666|
)) (= |f##0_1_0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#2456| Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) |a#0@@2| ($Box intType (int_2_U |i#0|)) Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) |b#0@@2| Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) |c#0@@1| ($Box intType (int_2_U |j#0|)) (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))) (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false)))) ($LS $LZ)))))) (and (and (|_module.__default.mult#canCall| |b#0@@2| |c#0@@1|) (= |g##0_1_0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#4| Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) |a#0@@2| ($Box intType (int_2_U |i#0|)) Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) (_module.__default.mult |b#0@@2| |c#0@@1|) ($Box intType (int_2_U |j#0|))) (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))))) (and (= call0formal@_module._default.FunEq$X@0 Tclass._module.Index) (= (ControlFlow 0 2) (- 0 1)))))) (forall ((|x#1| T@U) ) (!  (=> (and ($IsBox |x#1| call0formal@_module._default.FunEq$X@0) ($IsAllocBox |x#1| call0formal@_module._default.FunEq$X@0 $Heap@@4)) (= (Apply1 call0formal@_module._default.FunEq$X@0 TInt $Heap@@4 |f##0_1_0@0| |x#1|) (Apply1 call0formal@_module._default.FunEq$X@0 TInt $Heap@@4 |g##0_1_0@0| |x#1|)))
