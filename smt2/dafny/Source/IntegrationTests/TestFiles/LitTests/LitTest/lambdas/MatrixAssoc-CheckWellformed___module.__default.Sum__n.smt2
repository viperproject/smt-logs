...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Sum__n)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon8_Else_correct  (=> (or (not (= |n#0@@3| (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 8)) ($Is intType (int_2_U (- |n#0@@3| 1)) Tclass._module.Index)) (=> ($Is intType (int_2_U (- |n#0@@3| 1)) Tclass._module.Index) (=> ($IsAlloc HandleTypeType |f#0@@7| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@2) (and (=> (= (ControlFlow 0 4) (- 0 7)) ($Is intType (int_2_U (- |n#0@@3| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0@@3| 1)) Tclass._System.nat) (=> (and (= |##n#0@0| (- |n#0@@3| 1)) ($IsAlloc intType (int_2_U |##n#0@0|) Tclass._System.nat $Heap@@2)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (<= |##n#0@0| _module.__default.N)) (=> (<= |##n#0@0| _module.__default.N) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (<= 0 |n#0@@3|) (= |##n#0@0| |n#0@@3|))) (=> (or (<= 0 |n#0@@3|) (= |##n#0@0| |n#0@@3|)) (=> (= (ControlFlow 0 4) (- 0 3)) (< |##n#0@0| |n#0@@3|)))))))))))))))
(let ((anon8_Then_correct true))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (<= |n#0@@3| _module.__default.N)) (and (and (=> (= (ControlFlow 0 9) 1) anon7_Then_correct) (=> (= (ControlFlow 0 9) 2) anon8_Then_correct)) (=> (= (ControlFlow 0 9) 4) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and ($Is HandleTypeType |f#0@@7| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) (<= (LitInt 0) |n#0@@3|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct))))
