...
(assert (forall ((|l#0@@0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Int) (|$l#1#heap#0| T@U) (|$l#1#i#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#88| |l#0@@0| |l#1| |l#2| |l#3|) |$l#1#heap#0| |$l#1#i#0|) ($Box intType (int_2_U (Mul (U_2_int ($Unbox intType (Apply1 |l#0@@0| |l#1| |$l#1#heap#0| |l#2| ($Box intType ($Unbox intType |$l#1#i#0|))))) |l#3|))))
 :qid |MatrixAssocdfy.10:6|
 :skolemid |752|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#88| |l#0@@0| |l#1| |l#2| |l#3|) |$l#1#heap#0| |$l#1#i#0|))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.distr__mult__n)
...
(let ((anon7_Then_correct  (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| _module.__default.N)) (=> (and (and (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (= |lambdaResult#0| (Mul (U_2_int ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@0 |f#0@@7| ($Box intType (int_2_U |i#0@0|))))) |x#0@@5|))) (and ($Is intType (int_2_U |lambdaResult#0|) TInt) (= (ControlFlow 0 4) 3))) anon4_correct))))
...
(let ((anon6_Else_correct  (=> (and (and (= |##f#1@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#88| Tclass._module.Index TInt |f#0@@7| |x#0@@5|) (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ)))) ($IsAlloc HandleTypeType |##f#1@0| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@0)) (and ($IsAlloc intType (int_2_U |n#0@@3|) Tclass._System.nat $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (<= |n#0@@3| _module.__default.N))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (<= |n#0@@3| _module.__default.N)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@2 $Heap@0)) (and ($IsAlloc HandleTypeType |f#0@@7| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@0) ($IsAlloc intType (int_2_U |n#0@@3|) Tclass._System.nat $Heap@0))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= |n#0@@3| _module.__default.N)) (=> (and (<= |n#0@@3| _module.__default.N) (|_module.__default.Sum__n#canCall| |f#0@@7| |n#0@@3|)) (and (=> (= (ControlFlow 0 7) 6) anon6_Then_correct) (=> (= (ControlFlow 0 7) 2) anon6_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (and ($Is HandleTypeType |f#0@@7| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) ($IsAlloc HandleTypeType |f#0@@7| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@2)) (<= (LitInt 0) |n#0@@3|)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 9) 7))) anon0_correct))))
