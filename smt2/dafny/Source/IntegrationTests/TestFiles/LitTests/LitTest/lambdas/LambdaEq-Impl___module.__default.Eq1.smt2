...
(set-info :boogie-vc-id Impl$$_module.__default.Eq1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon3_correct true))
(let ((anon14_Else_correct  (=> (and (< |x#0@0| (LitInt 0)) (= (ControlFlow 0 14) 12)) anon3_correct)))
(let ((anon14_Then_correct  (=> (<= (LitInt 0) |x#0@0|) (=> (and (and (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (= |lambdaResult#0| |x#0@0|)) (and ($Is intType (int_2_U |lambdaResult#0|) Tclass._System.nat) (= (ControlFlow 0 13) 12))) anon3_correct))))
(let ((anon13_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 15) 13) anon14_Then_correct) (=> (= (ControlFlow 0 15) 14) anon14_Else_correct)))))
(let ((anon16_Else_correct true))
(let ((anon16_Then_correct true))
(let ((anon15_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#1@0|) (or (= $Heap |$lambdaHeap#1@0|) ($HeapSucc $Heap |$lambdaHeap#1@0|))) (and (=> (= (ControlFlow 0 10) 8) anon16_Then_correct) (=> (= (ControlFlow 0 10) 9) anon16_Else_correct)))))
(let ((anon18_Else_correct true))
(let ((anon18_Then_correct true))
(let ((anon17_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#2@0|) (or (= $Heap |$lambdaHeap#2@0|) ($HeapSucc $Heap |$lambdaHeap#2@0|))) (and (=> (= (ControlFlow 0 6) 4) anon18_Then_correct) (=> (= (ControlFlow 0 6) 5) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (= |h#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 |lambda#1| (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= |g#0@0| |h#0@0|)) (=> (= |g#0@0| |h#0@0|) (=> (= (ControlFlow 0 2) (- 0 1)) (= |f#0@0| |g#0@0|)))))))
(let ((anon15_Else_correct  (=> (= |g#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 |lambda#1| (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))) (and (=> (= (ControlFlow 0 7) 6) anon17_Then_correct) (=> (= (ControlFlow 0 7) 2) anon17_Else_correct)))))
(let ((anon13_Else_correct  (=> (= |f#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 |lambda#1| (|lambda#2| Tclass._System.nat) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))) (and (=> (= (ControlFlow 0 11) 10) anon15_Then_correct) (=> (= (ControlFlow 0 11) 7) anon15_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 16) 15) anon13_Then_correct) (=> (= (ControlFlow 0 16) 11) anon13_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 Tclass._System.nat TInt)) ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 Tclass._System.nat TInt) $Heap)) true) (and (and ($Is HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap)) true)) (and (and (and ($Is HandleTypeType |h#0| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |h#0| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 17) 16)))) anon0_correct))))
