...
(set-info :boogie-vc-id Impl$$_module.__default.mult__assoc__ij_split28)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and (and (and (and (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (and ($Is HandleTypeType |a#0@@2| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt))) ($IsAlloc HandleTypeType |a#0@@2| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) $Heap@@4))) (and (and ($Is HandleTypeType |b#0@@2| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt))) ($IsAlloc HandleTypeType |b#0@@2| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) $Heap@@4)) (and ($Is HandleTypeType |c#0@@1| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt))) ($IsAlloc HandleTypeType |c#0@@1| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) $Heap@@4)))) (and (and (and (<= (LitInt 0) |i#0|) (< |i#0| _module.__default.N)) (and (<= (LitInt 0) |j#0|) (< |j#0| _module.__default.N))) (and (and ($Is HandleTypeType |g#0_3_0_0| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) ($IsAlloc HandleTypeType |g#0_3_0_0| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@4)) true))) (and (and (and (and ($Is HandleTypeType |g#0_7_0_0| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) ($IsAlloc HandleTypeType |g#0_7_0_0| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@4)) true) (= 8 $FunctionContextHeight)) (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (= (U_2_int ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@@4 ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@4 (_module.__default.mult (_module.__default.mult |a#0@@2| |b#0@@2|) |c#0@@1|) ($Box intType (int_2_U |i#0|)))) ($Box intType (int_2_U |j#0|))))) (U_2_int ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@@4 ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@4 (_module.__default.mult |a#0@@2| (_module.__default.mult |b#0@@2| |c#0@@1|)) ($Box intType (int_2_U |i#0|)))) ($Box intType (int_2_U |j#0|))))))) (and (= $Heap@12 $Heap@@4) (= (ControlFlow 0 2) (- 0 1)))))) (= (U_2_int ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@12 ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@12 (_module.__default.mult (_module.__default.mult |a#0@@2| |b#0@@2|) |c#0@@1|) ($Box intType (int_2_U |i#0|)))) ($Box intType (int_2_U |j#0|))))) (U_2_int ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@12 ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@12 (_module.__default.mult |a#0@@2| (_module.__default.mult |b#0@@2| |c#0@@1|)) ($Box intType (int_2_U |i#0|)))) ($Box intType (int_2_U |j#0|)))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
