...
(let ((anon165_Else_correct  (=> (forall ((|$l#0_1_1#heap#0| T@U) )  (=> ($IsGoodHeap |$l#0_1_1#heap#0|) (State.M.State_q ($Unbox DatatypeTypeType (Apply1 State._default.LeftIdentity$A (Tclass.State.M State._default.LeftIdentity$B) |$l#0_1_1#heap#0| |f#0@@8| |x#0@@3|))))) (and (=> (= (ControlFlow 0 98) 97) anon168_Then_correct) (=> (= (ControlFlow 0 98) 91) anon168_Else_correct)))))
...
(State.M.State_q ($Unbox DatatypeTypeType (Apply1 State._default.LeftIdentity$A (Tclass.State.M State._default.LeftIdentity$B) |$l#0_2_1#heap#0| |f#0@@8| |a#0_2_1|)))))))) (and (=> (= (ControlFlow 0 82) 81) anon154_Then_correct) (=> (= (ControlFlow 0 82) 74) anon154_Else_correct)))))
...
(State.M.State_q ($Unbox DatatypeTypeType (Apply1 State._default.LeftIdentity$A (Tclass.State.M State._default.LeftIdentity$B) |$l#0_3_5#heap#0| |f#0@@8| |a#0_3_1|)))))))) (and (=> (= (ControlFlow 0 49) 48) anon135_Then_correct) (=> (= (ControlFlow 0 49) 38) anon135_Else_correct)))))
