...
(declare-fun |##b#0_0_1@0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.mult__assoc__ij_split27)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (and ($Is HandleTypeType |a#0@@2| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt))) ($IsAlloc HandleTypeType |a#0@@2| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) $Heap@@4))) (and (and ($Is HandleTypeType |b#0@@2| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt))) ($IsAlloc HandleTypeType |b#0@@2| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) $Heap@@4)) (and ($Is HandleTypeType |c#0@@1| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt))) ($IsAlloc HandleTypeType |c#0@@1| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) $Heap@@4)))) (and (and (and (<= (LitInt 0) |i#0|) (< |i#0| _module.__default.N)) (and (<= (LitInt 0) |j#0|) (< |j#0| _module.__default.N))) (and (and ($Is HandleTypeType |g#0_3_0_0| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) ($IsAlloc HandleTypeType |g#0_3_0_0| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@4)) true))) (=> (and (and (and (and (and ($Is HandleTypeType |g#0_7_0_0| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) ($IsAlloc HandleTypeType |g#0_7_0_0| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@4)) true) (= 8 $FunctionContextHeight)) (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (= |##f#0_0_0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#4| Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) |a#0@@2| ($Box intType (int_2_U |i#0|)) Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) (_module.__default.mult |b#0@@2| |c#0@@1|) ($Box intType (int_2_U |j#0|))) (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))))) (and ($IsAlloc HandleTypeType |##f#0_0_0@0| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@4) (|_module.__default.Sum#canCall| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#4| Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) |a#0@@2| ($Box intType (int_2_U |i#0|)) Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) (_module.__default.mult |b#0@@2| |c#0@@1|) ($Box intType (int_2_U |j#0|))) (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))))))) (and (and (and (and (|_module.__default.mult#canCall| |b#0@@2| |c#0@@1|) (|_module.__default.Sum#canCall| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#4| Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) |a#0@@2| ($Box intType (int_2_U |i#0|)) Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) (_module.__default.mult |b#0@@2| |c#0@@1|) ($Box intType (int_2_U |j#0|))) (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))))) ($IsAlloc HandleTypeType |a#0@@2| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) $Heap@@4)) (and ($IsAlloc HandleTypeType |b#0@@2| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) $Heap@@4) ($IsAlloc HandleTypeType |c#0@@1| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) $Heap@@4))) (and (and (and (|_module.__default.mult#canCall| |b#0@@2| |c#0@@1|) (= |##b#0_0_1@0| (_module.__default.mult |b#0@@2| |c#0@@1|))) (and ($IsAlloc HandleTypeType |##b#0_0_1@0| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) $Heap@@4) (|_module.__default.mult#canCall| |a#0@@2| (_module.__default.mult |b#0@@2| |c#0@@1|)))) (and (and (|_module.__default.mult#canCall| |b#0@@2| |c#0@@1|) (|_module.__default.mult#canCall| |a#0@@2| (_module.__default.mult |b#0@@2| |c#0@@1|))) (= (ControlFlow 0 2) (- 0 1)))))) (= (LitInt (_module.__default.Sum (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#4| Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) |a#0@@2| ($Box intType (int_2_U |i#0|)) Tclass._module.Index TInt Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) (_module.__default.mult |b#0@@2| |c#0@@1|) ($Box intType (int_2_U |j#0|))) (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))))) (U_2_int ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@@4 ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@4 (_module.__default.mult |a#0@@2| (_module.__default.mult |b#0@@2| |c#0@@1|)) ($Box intType (int_2_U |i#0|)))) ($Box intType (int_2_U |j#0|))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
