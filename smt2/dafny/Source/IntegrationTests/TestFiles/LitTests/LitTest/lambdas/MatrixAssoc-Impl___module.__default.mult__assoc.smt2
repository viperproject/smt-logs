...
(set-info :boogie-vc-id Impl$$_module.__default.mult__assoc)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon7_Else_correct  (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and (and (|_module.__default.mult#canCall| |a#0@@2| |b#0@@2|) (|_module.__default.mult#canCall| (_module.__default.mult |a#0@@2| |b#0@@2|) |c#0@@1|)) (and (|_module.__default.mult#canCall| |b#0@@2| |c#0@@1|) (|_module.__default.mult#canCall| |a#0@@2| (_module.__default.mult |b#0@@2| |c#0@@1|)))) (= (U_2_int ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@1 ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@1 (_module.__default.mult (_module.__default.mult |a#0@@2| |b#0@@2|) |c#0@@1|) ($Box intType (int_2_U |i#0_0@0|)))) ($Box intType (int_2_U |j#0_0@0|))))) (U_2_int ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@1 ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@1 (_module.__default.mult |a#0@@2| (_module.__default.mult |b#0@@2| |c#0@@1|)) ($Box intType (int_2_U |i#0_0@0|)))) ($Box intType (int_2_U |j#0_0@0|))))))) (and (= $Heap@@4 $Heap@1) (= (ControlFlow 0 7) (- 0 6)))) (= (U_2_int ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@1 ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@1 (_module.__default.mult (_module.__default.mult |a#0@@2| |b#0@@2|) |c#0@@1|) ($Box intType (int_2_U |i#0_0@0|)))) ($Box intType (int_2_U |j#0_0@0|))))) (U_2_int ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@1 ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@1 (_module.__default.mult |a#0@@2| (_module.__default.mult |b#0@@2| |c#0@@1|)) ($Box intType (int_2_U |i#0_0@0|)))) ($Box intType (int_2_U |j#0_0@0|))))))))))
(let ((anon7_Then_correct true))
(let ((anon6_Then_correct  (=> (and (and (<= (LitInt 0) |i#0_0@0|) (< |i#0_0@0| _module.__default.N)) (and (<= (LitInt 0) |j#0_0@0|) (< |j#0_0@0| _module.__default.N))) (and (=> (= (ControlFlow 0 8) 5) anon7_Then_correct) (=> (= (ControlFlow 0 8) 7) anon7_Else_correct)))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (= (_module.__default.mult (_module.__default.mult |a#0@@2| |b#0@@2|) |c#0@@1|) (_module.__default.mult |a#0@@2| (_module.__default.mult |b#0@@2| |c#0@@1|))))))
(let ((anon6_Else_correct  (=> (and (forall ((|i#0_1| T@U) (|j#0_1| T@U) ) (!  (=> (and (and (and (<= (LitInt 0) (U_2_int |i#0_1|)) (< (U_2_int |i#0_1|) _module.__default.N)) (and (<= (LitInt 0) (U_2_int |j#0_1|)) (< (U_2_int |j#0_1|) _module.__default.N))) (U_2_bool (Lit boolType (bool_2_U true)))) (= (U_2_int ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@@4 ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@4 (_module.__default.mult (_module.__default.mult |a#0@@2| |b#0@@2|) |c#0@@1|) ($Box intType |i#0_1|))) ($Box intType |j#0_1|)))) (U_2_int ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@@4 ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@4 (_module.__default.mult |a#0@@2| (_module.__default.mult |b#0@@2| |c#0@@1|)) ($Box intType |i#0_1|))) ($Box intType |j#0_1|))))))
 :qid |MatrixAssocdfy.262:10|
 :skolemid |735|
 :pattern ( ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@@4 ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@4 (_module.__default.mult |a#0@@2| (_module.__default.mult |b#0@@2| |c#0@@1|)) ($Box intType |i#0_1|))) ($Box intType |j#0_1|))))
 :pattern ( ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@@4 ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@4 (_module.__default.mult (_module.__default.mult |a#0@@2| |b#0@@2|) |c#0@@1|) ($Box intType |i#0_1|))) ($Box intType |j#0_1|))))
)) ($IsAlloc HandleTypeType |a#0@@2| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) $Heap@@4)) (=> (and (and ($IsAlloc HandleTypeType |b#0@@2| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) $Heap@@4) (|_module.__default.mult#canCall| |a#0@@2| |b#0@@2|)) (and (= |##a#4@0| (_module.__default.mult |a#0@@2| |b#0@@2|)) ($IsAlloc HandleTypeType |##a#4@0| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) $Heap@@4))) (=> (and (and (and (and ($IsAlloc HandleTypeType |c#0@@1| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) $Heap@@4) (|_module.__default.mult#canCall| (_module.__default.mult |a#0@@2| |b#0@@2|) |c#0@@1|)) (and (|_module.__default.mult#canCall| |a#0@@2| |b#0@@2|) (|_module.__default.mult#canCall| (_module.__default.mult |a#0@@2| |b#0@@2|) |c#0@@1|))) (and (and (= |a##0@0| (_module.__default.mult (_module.__default.mult |a#0@@2| |b#0@@2|) |c#0@@1|)) ($IsAlloc HandleTypeType |a#0@@2| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) $Heap@@4)) (and ($IsAlloc HandleTypeType |b#0@@2| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) $Heap@@4) ($IsAlloc HandleTypeType |c#0@@1| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) $Heap@@4)))) (and (and (and (|_module.__default.mult#canCall| |b#0@@2| |c#0@@1|) (= |##b#6@0| (_module.__default.mult |b#0@@2| |c#0@@1|))) (and ($IsAlloc HandleTypeType |##b#6@0| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) $Heap@@4) (|_module.__default.mult#canCall| |a#0@@2| (_module.__default.mult |b#0@@2| |c#0@@1|)))) (and (and (|_module.__default.mult#canCall| |b#0@@2| |c#0@@1|) (|_module.__default.mult#canCall| |a#0@@2| (_module.__default.mult |b#0@@2| |c#0@@1|))) (= |b##0@0| (_module.__default.mult |a#0@@2| (_module.__default.mult |b#0@@2| |c#0@@1|)))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((|x#1| Int) (|y#1| Int) ) (!  (=> (and (and (<= (LitInt 0) |x#1|) (< |x#1| _module.__default.N)) (and (<= (LitInt 0) |y#1|) (< |y#1| _module.__default.N))) (= (U_2_int ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@@4 ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@4 |a##0@0| ($Box intType (int_2_U |x#1|)))) ($Box intType (int_2_U |y#1|))))) (U_2_int ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@@4 ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@4 |b##0@0| ($Box intType (int_2_U |x#1|)))) ($Box intType (int_2_U |y#1|)))))))
 :qid |MatrixAssocdfy.23:19|
 :skolemid |535|
 :pattern ( ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@@4 ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@4 |b##0@0| ($Box intType (int_2_U |x#1|)))) ($Box intType (int_2_U |y#1|)))))
 :pattern ( ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@@4 ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@4 |a##0@0| ($Box intType (int_2_U |x#1|)))) ($Box intType (int_2_U |y#1|)))))
))) (=> (forall ((|x#1@@0| T@U) (|y#1@@0| T@U) ) (!  (=> (and (and (<= (LitInt 0) (U_2_int |x#1@@0|)) (< (U_2_int |x#1@@0|) _module.__default.N)) (and (<= (LitInt 0) (U_2_int |y#1@@0|)) (< (U_2_int |y#1@@0|) _module.__default.N))) (= (U_2_int ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@@4 ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@4 |a##0@0| ($Box intType |x#1@@0|))) ($Box intType |y#1@@0|)))) (U_2_int ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@@4 ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@4 |b##0@0| ($Box intType |x#1@@0|))) ($Box intType |y#1@@0|))))))
 :qid |MatrixAssocdfy.23:19|
 :skolemid |535|
 :pattern ( ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@@4 ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@4 |b##0@0| ($Box intType |x#1@@0|))) ($Box intType |y#1@@0|))))
 :pattern ( ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@@4 ($Unbox HandleTypeType (Apply1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@4 |a##0@0| ($Box intType |x#1@@0|))) ($Box intType |y#1@@0|))))
)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= |a##0@0| |b##0@0|)) (and (= $Heap@@4 $Heap@0) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (and (=> (= (ControlFlow 0 9) 8) anon6_Then_correct) (=> (= (ControlFlow 0 9) 3) anon6_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (=> (and (and (and ($Is HandleTypeType |a#0@@2| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt))) ($IsAlloc HandleTypeType |a#0@@2| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) $Heap@@4)) (and ($Is HandleTypeType |b#0@@2| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt))) ($IsAlloc HandleTypeType |b#0@@2| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) $Heap@@4))) (and (and ($Is HandleTypeType |c#0@@1| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt))) ($IsAlloc HandleTypeType |c#0@@1| (Tclass._System.___hTotalFunc1 Tclass._module.Index (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) $Heap@@4)) (and (= 9 $FunctionContextHeight) (= (ControlFlow 0 10) 9)))) anon0_correct))))
