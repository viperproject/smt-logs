...
(set-info :boogie-vc-id Impl$$_module.__default.distr__mult__n)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@2 $Heap@0)) (and (forall ((|$ih#n0#0| Int) ) (!  (=> (and (and (<= (LitInt 0) |$ih#n0#0|) (<= |$ih#n0#0| _module.__default.N)) (or (and (<= 0 |$ih#n0#0|) (< |$ih#n0#0| |n#0@@3|)) (and (= |$ih#n0#0| |n#0@@3|) (and (<= 0 |x#0@@3|) (< |x#0@@3| |x#0@@3|))))) (= (Mul (_module.__default.Sum__n ($LS $LZ) |f#0@@7| |$ih#n0#0|) |x#0@@3|) (_module.__default.Sum__n ($LS $LZ) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#88| Tclass._module.Index TInt |f#0@@7| |x#0@@3|) (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) |$ih#n0#0|)))
 :qid |MatrixAssocdfy.62:52|
 :skolemid |566|
 :pattern ( (_module.__default.Sum__n ($LS $LZ) |f#0@@7| |$ih#n0#0|))
)) (= (ControlFlow 0 2) (- 0 1)))) (= (Mul (_module.__default.Sum__n ($LS ($LS $LZ)) |f#0@@7| |n#0@@3|) |x#0@@3|) (_module.__default.Sum__n ($LS ($LS $LZ)) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#88| Tclass._module.Index TInt |f#0@@7| |x#0@@3|) (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) |n#0@@3|))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and ($Is HandleTypeType |f#0@@7| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) ($IsAlloc HandleTypeType |f#0@@7| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@2))) (and (and (<= (LitInt 0) |n#0@@3|) (= 4 $FunctionContextHeight)) (and (<= |n#0@@3| _module.__default.N) (= (ControlFlow 0 3) 2)))) anon0_correct)))
