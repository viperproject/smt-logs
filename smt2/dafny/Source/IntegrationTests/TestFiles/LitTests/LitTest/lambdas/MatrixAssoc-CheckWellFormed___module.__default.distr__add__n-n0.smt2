...
(assert (forall ((|l#0@@0| Bool) (|$l#6#o#0| T@U) ) (! (= (U_2_bool (MapType1Select refType boolType (|lambda#6| |l#0@@0|) |$l#6#o#0|)) |l#0@@0|)
 :qid |unknown.0:0|
 :skolemid |744|
 :pattern ( (MapType1Select refType boolType (|lambda#6| |l#0@@0|) |$l#6#o#0|))
)))
(assert (forall ((|l#0@@1| T@U) (|$l#6#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#8| |l#0@@1|) |$l#6#ly#0|) |l#0@@1|)
 :qid |MatrixAssocdfy.50:9|
 :skolemid |746|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#8| |l#0@@1|) |$l#6#ly#0|))
)))
...
(assert (forall ((|l#0@@3| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3@@0| T@U) (|l#4| T@U) (|l#5| T@U) (|$l#1#heap#0| T@U) (|$l#1#i#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#45| |l#0@@3| |l#1@@0| |l#2@@0| |l#3@@0| |l#4| |l#5|) |$l#1#heap#0| |$l#1#i#0|) ($Box intType (int_2_U (+ (U_2_int ($Unbox intType (Apply1 |l#0@@3| |l#1@@0| |$l#1#heap#0| |l#2@@0| ($Box intType ($Unbox intType |$l#1#i#0|))))) (U_2_int ($Unbox intType (Apply1 |l#3@@0| |l#4| |$l#1#heap#0| |l#5| ($Box intType ($Unbox intType |$l#1#i#0|)))))))))
 :qid |MatrixAssocdfy.10:6|
 :skolemid |751|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#45| |l#0@@3| |l#1@@0| |l#2@@0| |l#3@@0| |l#4| |l#5|) |$l#1#heap#0| |$l#1#i#0|))
)))
...
(assert (forall ((|l#0@@4| T@U) (|$l#6#heap#0@@0| T@U) (|$l#6#k#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#7| |l#0@@4|) |$l#6#heap#0@@0| |$l#6#k#0@@0|) |l#0@@4|)
 :qid |MatrixAssocdfy.50:9|
 :skolemid |745|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#7| |l#0@@4|) |$l#6#heap#0@@0| |$l#6#k#0@@0|))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.distr__add__n)
...
(let ((anon7_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| _module.__default.N))) (= (ControlFlow 0 5) 3)) anon4_correct)))
(let ((anon7_Then_correct  (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| _module.__default.N)) (=> (and (and (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (= |lambdaResult#0| (+ (U_2_int ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@0 |f#0@@7| ($Box intType (int_2_U |i#0@0|))))) (U_2_int ($Unbox intType (Apply1 Tclass._module.Index TInt $Heap@0 |g#0| ($Box intType (int_2_U |i#0@0|)))))))) (and ($Is intType (int_2_U |lambdaResult#0|) TInt) (= (ControlFlow 0 4) 3))) anon4_correct))))
(let ((anon6_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@0 |$lambdaHeap#0@0|) ($HeapSucc $Heap@0 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 6) 4) anon7_Then_correct) (=> (= (ControlFlow 0 6) 5) anon7_Else_correct)))))
(let ((anon6_Else_correct  (=> (and (and (= |##f#2@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#45| Tclass._module.Index TInt |f#0@@7| Tclass._module.Index TInt |g#0|) (|lambda#5| Tclass._module.Index) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ)))) ($IsAlloc HandleTypeType |##f#2@0| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@0)) (and ($IsAlloc intType (int_2_U |n#0@@3|) Tclass._System.nat $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (<= |n#0@@3| _module.__default.N))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (<= |n#0@@3| _module.__default.N)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@2 $Heap@0)) (and ($IsAlloc HandleTypeType |f#0@@7| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@0) ($IsAlloc intType (int_2_U |n#0@@3|) Tclass._System.nat $Heap@0))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (<= |n#0@@3| _module.__default.N)) (=> (and (and (<= |n#0@@3| _module.__default.N) (|_module.__default.Sum__n#canCall| |f#0@@7| |n#0@@3|)) (and ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@0) ($IsAlloc intType (int_2_U |n#0@@3|) Tclass._System.nat $Heap@0))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= |n#0@@3| _module.__default.N)) (=> (and (<= |n#0@@3| _module.__default.N) (|_module.__default.Sum__n#canCall| |g#0| |n#0@@3|)) (and (=> (= (ControlFlow 0 7) 6) anon6_Then_correct) (=> (= (ControlFlow 0 7) 2) anon6_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and ($Is HandleTypeType |f#0@@7| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) ($IsAlloc HandleTypeType |f#0@@7| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@2))) (=> (and (and (and ($Is HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt)) ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 Tclass._module.Index TInt) $Heap@@2)) (<= (LitInt 0) |n#0@@3|)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 10) 7))) anon0_correct))))
