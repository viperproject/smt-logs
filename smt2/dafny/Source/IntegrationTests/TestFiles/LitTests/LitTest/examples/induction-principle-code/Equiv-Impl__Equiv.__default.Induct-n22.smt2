...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|e#0@@2| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| |st#0@@1| |e#0@@2|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@1| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@2| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@1|) (=> (Equiv.__default.Inv |st#0@@1|) (and (Equiv.MState.MState_q |st#0@@1|) (|Interp.__default.InterpExpr#canCall| |e#0@@2| (Equiv.MState.ctx |st#0@@1|))))) (= (Equiv.__default.P__Fail |st#0@@1| |e#0@@2|)  (=> (Equiv.__default.Inv |st#0@@1|) (Utils.Result.Failure_q (Interp.__default.InterpExpr ($LS $LZ) |e#0@@2| (Equiv.MState.ctx |st#0@@1|)))))))
 :qid |Inductiondfy.36:26|
 :skolemid |706|
 :pattern ( (Equiv.__default.P__Fail |st#0@@1| |e#0@@2|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|es#0@@2| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Fail#canCall| |st#0@@2| |es#0@@2|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@2| Tclass.Equiv.MState) ($Is SeqType |es#0@@2| (TSeq Tclass.AST.Expr))))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@2|) (=> (Equiv.__default.Inv |st#0@@2|) (and (Equiv.MState.MState_q |st#0@@2|) (|Interp.__default.InterpExprs#canCall| |es#0@@2| (Equiv.MState.ctx |st#0@@2|))))) (= (Equiv.__default.Pes__Fail |st#0@@2| |es#0@@2|)  (=> (Equiv.__default.Inv |st#0@@2|) (Utils.Result.Failure_q (Interp.__default.InterpExprs ($LS $LZ) |es#0@@2| (Equiv.MState.ctx |st#0@@2|)))))))
 :qid |Inductiondfy.41:28|
 :skolemid |732|
 :pattern ( (Equiv.__default.Pes__Fail |st#0@@2| |es#0@@2|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0@@3| T@U) ) (!  (=> (or (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@3|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |st#0@@3| Tclass.Equiv.MState))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@3|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@3|))) (|Equiv.__default.EqCtx#canCall| (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@3|))) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@3|)))))) (= (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@3|))  (and true (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@3|))) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@3|))))))))
 :qid |Equivdfy.72:23|
 :weight 3
 :skolemid |683|
 :pattern ( (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@3|)))
))))
...
(assert (forall (($ly@@4 T@U) (|e#0@@6| T@U) (|ctx#0@@3| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@6| |ctx#0@@3|) (and ($Is DatatypeTypeType |e#0@@6| Tclass.AST.Expr) ($Is MapType |ctx#0@@3| (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType (Interp.__default.InterpExpr $ly@@4 |e#0@@6| |ctx#0@@3|) (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))))
 :qid |Interpdfy.24:12|
 :skolemid |1198|
 :pattern ( (Interp.__default.InterpExpr $ly@@4 |e#0@@6| |ctx#0@@3|))
)))
(assert (forall (($ly@@5 T@U) (|e#0@@7| T@U) (|ctx#0@@4| T@U) ) (! (= (Interp.__default.InterpExpr ($LS $ly@@5) |e#0@@7| |ctx#0@@4|) (Interp.__default.InterpExpr $ly@@5 |e#0@@7| |ctx#0@@4|))
 :qid |Interpdfy.24:12|
 :skolemid |1196|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@5) |e#0@@7| |ctx#0@@4|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|e#0@@8| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| |st#0@@4| (Lit DatatypeTypeType |e#0@@8|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@4| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@4|) (=> (Equiv.__default.Inv |st#0@@4|) (and (Equiv.MState.MState_q |st#0@@4|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@8|) (Equiv.MState.ctx |st#0@@4|))))) (= (Equiv.__default.P__Fail |st#0@@4| (Lit DatatypeTypeType |e#0@@8|))  (=> (Equiv.__default.Inv |st#0@@4|) (Utils.Result.Failure_q (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@8|) (Equiv.MState.ctx |st#0@@4|)))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |707|
 :pattern ( (Equiv.__default.P__Fail |st#0@@4| (Lit DatatypeTypeType |e#0@@8|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|es#0@@6| T@U) (|st'#0| T@U) (|vs#0@@1| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Succ#canCall| |st#0@@5| |es#0@@6| |st'#0| |vs#0@@1|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@5| Tclass.Equiv.MState) ($Is SeqType |es#0@@6| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#0@@1| Tclass.Equiv.VS)))) (and (and (and (Equiv.MState.MState_q |st#0@@5|) (|Interp.__default.InterpExprs#canCall| |es#0@@6| (Equiv.MState.ctx |st#0@@5|))) (let ((|res#0@@0| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@6| (Equiv.MState.ctx |st#0@@5|))))
 (and (and (Equiv.MState.MState_q |st#0@@5|) (|Interp.__default.InterpExprs#canCall| |es#0@@6| (Equiv.MState.ctx_k |st#0@@5|))) (let ((|res'#0@@0| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@6| (Equiv.MState.ctx_k |st#0@@5|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@5|) (=> (Equiv.__default.Inv |st#0@@5|) (and (|Equiv.__default.EqResultSeq#canCall| |res#0@@0| |res'#0@@0|) (=> (Equiv.__default.EqResultSeq |res#0@@0| |res'#0@@0|) (and (and (|$IsA#Utils.Result| |res#0@@0|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@1|) (Equiv.MState.MState_q |st'#0|))) (=> (|Utils.Result#Equal| |res#0@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@1|)) ($Box MapType (Equiv.MState.ctx |st'#0|)))))) (and (|$IsA#Utils.Result| |res'#0@@0|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@1|) (Equiv.MState.MState_q |st'#0|))))))))))))) (= (Equiv.__default.Pes__Succ |st#0@@5| |es#0@@6| |st'#0| |vs#0@@1|) (let ((|res#0@@1| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@6| (Equiv.MState.ctx |st#0@@5|))))
(let ((|res'#0@@1| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@6| (Equiv.MState.ctx_k |st#0@@5|))))
 (and (and (and (Equiv.__default.Inv |st#0@@5|) (Equiv.__default.EqResultSeq |res#0@@1| |res'#0@@1|)) (|Utils.Result#Equal| |res#0@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@1|)) ($Box MapType (Equiv.MState.ctx |st'#0|))))))) (|Utils.Result#Equal| |res'#0@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs_k |vs#0@@1|)) ($Box MapType (Equiv.MState.ctx_k |st'#0|))))))))))))
 :qid |Inductiondfy.40:28|
 :skolemid |723|
 :pattern ( (Equiv.__default.Pes__Succ |st#0@@5| |es#0@@6| |st'#0| |vs#0@@1|))
))))
...
(assert (forall (($ly@@9 T@U) (|es#0@@7| T@U) (|ctx#0@@7| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@7| |ctx#0@@7|) (and ($Is SeqType |es#0@@7| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@7| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@7| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@7| (LitInt 0))) |ctx#0@@7|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@9 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@7| (LitInt 0))) |ctx#0@@7|)))
...
(let ((|valueOrError1#0@@1| (Interp.__default.InterpExprs $ly@@9 (|Seq#Drop| |es#0@@7| (LitInt 1)) |ctx1#0@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0|))) |vs#0@@2|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1207|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@9) |es#0@@7| |ctx#0@@7|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|es#0@@8| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Fail#canCall| |st#0@@6| (Lit SeqType |es#0@@8|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.Equiv.MState) ($Is SeqType |es#0@@8| (TSeq Tclass.AST.Expr))))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@6|) (=> (Equiv.__default.Inv |st#0@@6|) (and (Equiv.MState.MState_q |st#0@@6|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@8|) (Equiv.MState.ctx |st#0@@6|))))) (= (Equiv.__default.Pes__Fail |st#0@@6| (Lit SeqType |es#0@@8|))  (=> (Equiv.__default.Inv |st#0@@6|) (Utils.Result.Failure_q (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@8|) (Equiv.MState.ctx |st#0@@6|)))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |733|
 :pattern ( (Equiv.__default.Pes__Fail |st#0@@6| (Lit SeqType |es#0@@8|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|es#0@@9| T@U) (|st'#0@@0| T@U) (|vs#0@@3| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Succ#canCall| (Lit DatatypeTypeType |st#0@@7|) (Lit SeqType |es#0@@9|) (Lit DatatypeTypeType |st'#0@@0|) (Lit DatatypeTypeType |vs#0@@3|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@7| Tclass.Equiv.MState) ($Is SeqType |es#0@@9| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@0| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#0@@3| Tclass.Equiv.VS)))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@7|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@9|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@7|))))) (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@9|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@7|)))))))
 (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@7|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@9|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@7|))))) (let ((|res'#2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@9|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@7|)))))))
 (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@7|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@7|))))) (and (|Equiv.__default.EqResultSeq#canCall| |res#2| |res'#2|) (=> (Equiv.__default.EqResultSeq |res#2| |res'#2|) (and (and (|$IsA#Utils.Result| |res#2|) (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |vs#0@@3|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|)))) (=> (|Utils.Result#Equal| |res#2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |vs#0@@3|)))) ($Box MapType (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st'#0@@0|))))))))) (and (|$IsA#Utils.Result| |res'#2|) (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |vs#0@@3|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|)))))))))))))) (= (Equiv.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@7|) (Lit SeqType |es#0@@9|) (Lit DatatypeTypeType |st'#0@@0|) (Lit DatatypeTypeType |vs#0@@3|)) (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@9|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@7|)))))))
(let ((|res'#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@9|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@7|)))))))
 (and (and (and (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@7|)) (Equiv.__default.EqResultSeq |res#2@@0| |res'#2@@0|)) (|Utils.Result#Equal| |res#2@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |vs#0@@3|)))) ($Box MapType (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st'#0@@0|)))))))))) (|Utils.Result#Equal| |res'#2@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType (Equiv.MSeqValue.vs_k (Lit DatatypeTypeType |vs#0@@3|)))) ($Box MapType (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st'#0@@0|)))))))))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |725|
 :pattern ( (Equiv.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@7|) (Lit SeqType |es#0@@9|) (Lit DatatypeTypeType |st'#0@@0|) (Lit DatatypeTypeType |vs#0@@3|)))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|vars#0@@1| T@U) (|argvs#0| T@U) ) (!  (=> (or (|Equiv.__default.UpdateState__Pre#canCall| |st#0@@8| |vars#0@@1| |argvs#0|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@8| Tclass.Equiv.MState) ($Is SeqType |vars#0@@1| (TSeq (TSeq TChar)))) ($Is DatatypeTypeType |argvs#0| Tclass.Equiv.VS)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@8|) (=> (Equiv.__default.Inv |st#0@@8|) (and (Equiv.MSeqValue.MSeqValue_q |argvs#0|) (=> (= (|Seq#Length| |vars#0@@1|) (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0|))) (and (and (Equiv.MSeqValue.MSeqValue_q |argvs#0|) (Equiv.MSeqValue.MSeqValue_q |argvs#0|)) (=> (= (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0|)) (|Seq#Length| (Equiv.MSeqValue.vs_k |argvs#0|))) (and (and (Equiv.MSeqValue.MSeqValue_q |argvs#0|) (Equiv.MSeqValue.MSeqValue_q |argvs#0|)) (|Equiv.__default.EqSeqValue#canCall| (Equiv.MSeqValue.vs |argvs#0|) (Equiv.MSeqValue.vs_k |argvs#0|))))))))) (= (Equiv.__default.UpdateState__Pre |st#0@@8| |vars#0@@1| |argvs#0|)  (and (and (Equiv.__default.Inv |st#0@@8|) (and (= (|Seq#Length| |vars#0@@1|) (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0|))) (= (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0|)) (|Seq#Length| (Equiv.MSeqValue.vs_k |argvs#0|))))) (Equiv.__default.EqSeqValue (Equiv.MSeqValue.vs |argvs#0|) (Equiv.MSeqValue.vs_k |argvs#0|))))))
 :qid |Inductiondfy.51:35|
 :skolemid |748|
 :pattern ( (Equiv.__default.UpdateState__Pre |st#0@@8| |vars#0@@1| |argvs#0|))
))))
...
(assert (forall (($ly@@10 T@U) (|es#0@@10| T@U) (|ctx#0@@8| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@10|) |ctx#0@@8|) (and ($Is SeqType |es#0@@10| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@8| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@10| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@10|) (LitInt 0))) |ctx#0@@8|) (let ((|valueOrError0#1@@0| (Interp.__default.InterpExpr ($LS $ly@@10) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@10|) (LitInt 0))) |ctx#0@@8|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType |es#0@@10|) |ctx#0@@8|) (ite (|Seq#Equal| |es#0@@10| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@8|)))) (let ((|valueOrError0#1@@1| (Interp.__default.InterpExpr ($LS $ly@@10) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@10|) (LitInt 0))) |ctx#0@@8|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#1|))) |vs#1@@0|)) ($Box MapType |ctx2#1@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |1208|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType |es#0@@10|) |ctx#0@@8|))
)))
...
(let ((|ctx#0@@9| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))))))))))
(let ((|vs#0@@4| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))))))))))
 (and (Equiv.__default.EqSeqValue |vs#0@@4| |vs'#0|) (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#0@@9| |ctx'#0@@1|)))))) false) true))))
 :qid |Equivdfy.45:31|
 :skolemid |673|
...
(assert (forall (($ly@@11 T@U) (|e#0@@10| T@U) (|ctx#0@@10| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@10|) (Lit MapType |ctx#0@@10|)) (and ($Is DatatypeTypeType |e#0@@10| Tclass.AST.Expr) ($Is MapType |ctx#0@@10| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@10|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@10|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@10|))))) (let ((|body#5| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@10|)))))
...
(Lit DatatypeTypeType (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#4|)) ($Box MapType (Lit MapType |ctx#0@@10|)))))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@10|)) (let ((|body#4| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@10|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1202|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@11) (Lit DatatypeTypeType |e#0@@10|) (Lit MapType |ctx#0@@10|)))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@9| T@U) (|es#0@@11| T@U) (|st'#0@@1| T@U) (|vs#0@@5| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Succ#canCall| |st#0@@9| (Lit SeqType |es#0@@11|) |st'#0@@1| |vs#0@@5|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@9| Tclass.Equiv.MState) ($Is SeqType |es#0@@11| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@1| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#0@@5| Tclass.Equiv.VS)))) (and (and (and (Equiv.MState.MState_q |st#0@@9|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@11|) (Equiv.MState.ctx |st#0@@9|))) (let ((|res#1@@1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) (Equiv.MState.ctx |st#0@@9|))))
 (and (and (Equiv.MState.MState_q |st#0@@9|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@11|) (Equiv.MState.ctx_k |st#0@@9|))) (let ((|res'#1@@1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) (Equiv.MState.ctx_k |st#0@@9|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@9|) (=> (Equiv.__default.Inv |st#0@@9|) (and (|Equiv.__default.EqResultSeq#canCall| |res#1@@1| |res'#1@@1|) (=> (Equiv.__default.EqResultSeq |res#1@@1| |res'#1@@1|) (and (and (|$IsA#Utils.Result| |res#1@@1|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@5|) (Equiv.MState.MState_q |st'#0@@1|))) (=> (|Utils.Result#Equal| |res#1@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@5|)) ($Box MapType (Equiv.MState.ctx |st'#0@@1|)))))) (and (|$IsA#Utils.Result| |res'#1@@1|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@5|) (Equiv.MState.MState_q |st'#0@@1|))))))))))))) (= (Equiv.__default.Pes__Succ |st#0@@9| (Lit SeqType |es#0@@11|) |st'#0@@1| |vs#0@@5|) (let ((|res#1@@2| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) (Equiv.MState.ctx |st#0@@9|))))
(let ((|res'#1@@2| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) (Equiv.MState.ctx_k |st#0@@9|))))
 (and (and (and (Equiv.__default.Inv |st#0@@9|) (Equiv.__default.EqResultSeq |res#1@@2| |res'#1@@2|)) (|Utils.Result#Equal| |res#1@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@5|)) ($Box MapType (Equiv.MState.ctx |st'#0@@1|))))))) (|Utils.Result#Equal| |res'#1@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs_k |vs#0@@5|)) ($Box MapType (Equiv.MState.ctx_k |st'#0@@1|))))))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |724|
 :pattern ( (Equiv.__default.Pes__Succ |st#0@@9| (Lit SeqType |es#0@@11|) |st'#0@@1| |vs#0@@5|))
))))
...
(assert (forall (($ly@@12 T@U) (|vars#0@@2| T@U) (|values#0@@1| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@2| |values#0@@1|) (and (and ($Is SeqType |vars#0@@2| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@1| (TSeq TInt))) (= (|Seq#Length| |vars#0@@2|) (|Seq#Length| |values#0@@1|)))) (and (=> (not (|Seq#Equal| |vars#0@@2| |Seq#Empty|)) (|Interp.__default.VarsAndValuesToContext#canCall| (|Seq#Drop| |vars#0@@2| (LitInt 1)) (|Seq#Drop| |values#0@@1| (LitInt 1)))) (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@12) |vars#0@@2| |values#0@@1|) (ite (|Seq#Equal| |vars#0@@2| |Seq#Empty|) |Map#Empty| (|Map#Merge| (|Map#Build| |Map#Empty| (|Seq#Index| |vars#0@@2| (LitInt 0)) (|Seq#Index| |values#0@@1| (LitInt 0))) (Interp.__default.VarsAndValuesToContext $ly@@12 (|Seq#Drop| |vars#0@@2| (LitInt 1)) (|Seq#Drop| |values#0@@1| (LitInt 1))))))))
 :qid |Interpdfy.80:12|
 :skolemid |1214|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@12) |vars#0@@2| |values#0@@1|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@10| T@U) (|es#0@@12| T@U) ) (!  (=> (or (|Equiv.__default.Pes#canCall| |st#0@@10| |es#0@@12|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@10| Tclass.Equiv.MState) ($Is SeqType |es#0@@12| (TSeq Tclass.AST.Expr))))) (and (and (and (Equiv.MState.MState_q |st#0@@10|) (|Interp.__default.InterpExprs#canCall| |es#0@@12| (Equiv.MState.ctx |st#0@@10|))) (let ((|res#0@@3| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@12| (Equiv.MState.ctx |st#0@@10|))))
 (and (and (Equiv.MState.MState_q |st#0@@10|) (|Interp.__default.InterpExprs#canCall| |es#0@@12| (Equiv.MState.ctx_k |st#0@@10|))) (let ((|res'#0@@3| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@12| (Equiv.MState.ctx_k |st#0@@10|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@10|) (=> (Equiv.__default.Inv |st#0@@10|) (|Equiv.__default.EqResultSeq#canCall| |res#0@@3| |res'#0@@3|))))))) (= (Equiv.__default.Pes |st#0@@10| |es#0@@12|) (let ((|res#0@@4| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@12| (Equiv.MState.ctx |st#0@@10|))))
(let ((|res'#0@@4| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@12| (Equiv.MState.ctx_k |st#0@@10|))))
 (=> (Equiv.__default.Inv |st#0@@10|) (Equiv.__default.EqResultSeq |res#0@@4| |res'#0@@4|)))))))
 :qid |Inductiondfy.39:23|
 :skolemid |713|
 :pattern ( (Equiv.__default.Pes |st#0@@10| |es#0@@12|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@11| T@U) (|e#0@@11| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| (Lit DatatypeTypeType |st#0@@11|) (Lit DatatypeTypeType |e#0@@11|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@11| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@11| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@11|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@11|))))) (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@11|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@11|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@11|))))))) (= (Equiv.__default.P__Fail (Lit DatatypeTypeType |st#0@@11|) (Lit DatatypeTypeType |e#0@@11|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@11|)) (Utils.Result.Failure_q (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@11|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@11|)))))))))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |708|
 :pattern ( (Equiv.__default.P__Fail (Lit DatatypeTypeType |st#0@@11|) (Lit DatatypeTypeType |e#0@@11|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@12| T@U) (|es#0@@13| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Fail#canCall| (Lit DatatypeTypeType |st#0@@12|) (Lit SeqType |es#0@@13|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@12| Tclass.Equiv.MState) ($Is SeqType |es#0@@13| (TSeq Tclass.AST.Expr))))) (and (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@12|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@12|))))) (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@12|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@13|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@12|))))))) (= (Equiv.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@12|) (Lit SeqType |es#0@@13|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@12|)) (Utils.Result.Failure_q (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@13|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@12|)))))))))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |734|
 :pattern ( (Equiv.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@12|) (Lit SeqType |es#0@@13|)))
))))
(assert (forall (($ly@@13 T@U) (|e#0@@12| T@U) (|ctx#0@@11| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@12|) |ctx#0@@11|) (and ($Is DatatypeTypeType |e#0@@12| Tclass.AST.Expr) ($Is MapType |ctx#0@@11| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@12|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@12|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@12|))))) (let ((|body#3| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@12|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#3| |v1#3| |v2#3|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@12|)))))) (let ((|es#3| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@12|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#3|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@13) (Lit DatatypeTypeType |e#0@@12|) |ctx#0@@11|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@12|)) (let ((|name#2| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@12|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#2|)) ($Box MapType |ctx#0@@11|))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@12|)) (let ((|body#2| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@12|)))))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1201|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@13) (Lit DatatypeTypeType |e#0@@12|) |ctx#0@@11|))
)))
...
(assert (forall (($ly@@14 T@U) (|vars#0@@3| T@U) (|values#0@@2| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@3|) (Lit SeqType |values#0@@2|)) (and (and ($Is SeqType |vars#0@@3| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@2| (TSeq TInt))) (= (|Seq#Length| (Lit SeqType |vars#0@@3|)) (|Seq#Length| (Lit SeqType |values#0@@2|))))) (and (=> (not (|Seq#Equal| |vars#0@@3| |Seq#Empty|)) (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |vars#0@@3|) (LitInt 1))) (Lit SeqType (|Seq#Drop| (Lit SeqType |values#0@@2|) (LitInt 1))))) (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@14) (Lit SeqType |vars#0@@3|) (Lit SeqType |values#0@@2|)) (ite (|Seq#Equal| |vars#0@@3| |Seq#Empty|) |Map#Empty| (|Map#Merge| (|Map#Build| |Map#Empty| (|Seq#Index| (Lit SeqType |vars#0@@3|) (LitInt 0)) (|Seq#Index| (Lit SeqType |values#0@@2|) (LitInt 0))) (Interp.__default.VarsAndValuesToContext ($LS $ly@@14) (Lit SeqType (|Seq#Drop| (Lit SeqType |vars#0@@3|) (LitInt 1))) (Lit SeqType (|Seq#Drop| (Lit SeqType |values#0@@2|) (LitInt 1)))))))))
 :qid |Interpdfy.80:12|
 :weight 3
 :skolemid |1215|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@14) (Lit SeqType |vars#0@@3|) (Lit SeqType |values#0@@2|)))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@13| T@U) (|es#0@@14| T@U) ) (!  (=> (or (|Equiv.__default.Pes#canCall| (Lit DatatypeTypeType |st#0@@13|) (Lit SeqType |es#0@@14|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@13| Tclass.Equiv.MState) ($Is SeqType |es#0@@14| (TSeq Tclass.AST.Expr))))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@13|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@14|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@13|))))) (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@14|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@13|)))))))
 (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@13|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@14|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@13|))))) (let ((|res'#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@14|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@13|)))))))
 (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@13|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@13|))))) (|Equiv.__default.EqResultSeq#canCall| |res#2@@1| |res'#2@@1|))))))) (= (Equiv.__default.Pes (Lit DatatypeTypeType |st#0@@13|) (Lit SeqType |es#0@@14|)) (U_2_bool (let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@14|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@13|)))))))
(let ((|res'#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@14|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@13|)))))))
(Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@13|)) (Equiv.__default.EqResultSeq |res#2@@2| |res'#2@@2|))))))))))
 :qid |Inductiondfy.39:23|
 :weight 3
 :skolemid |715|
 :pattern ( (Equiv.__default.Pes (Lit DatatypeTypeType |st#0@@13|) (Lit SeqType |es#0@@14|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@14| T@U) (|vars#0@@4| T@U) (|argvs#0@@0| T@U) ) (!  (=> (or (|Equiv.__default.UpdateState__Pre#canCall| |st#0@@14| (Lit SeqType |vars#0@@4|) |argvs#0@@0|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@14| Tclass.Equiv.MState) ($Is SeqType |vars#0@@4| (TSeq (TSeq TChar)))) ($Is DatatypeTypeType |argvs#0@@0| Tclass.Equiv.VS)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@14|) (=> (Equiv.__default.Inv |st#0@@14|) (and (Equiv.MSeqValue.MSeqValue_q |argvs#0@@0|) (=> (= (|Seq#Length| (Lit SeqType |vars#0@@4|)) (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0@@0|))) (and (and (Equiv.MSeqValue.MSeqValue_q |argvs#0@@0|) (Equiv.MSeqValue.MSeqValue_q |argvs#0@@0|)) (=> (= (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0@@0|)) (|Seq#Length| (Equiv.MSeqValue.vs_k |argvs#0@@0|))) (and (and (Equiv.MSeqValue.MSeqValue_q |argvs#0@@0|) (Equiv.MSeqValue.MSeqValue_q |argvs#0@@0|)) (|Equiv.__default.EqSeqValue#canCall| (Equiv.MSeqValue.vs |argvs#0@@0|) (Equiv.MSeqValue.vs_k |argvs#0@@0|))))))))) (= (Equiv.__default.UpdateState__Pre |st#0@@14| (Lit SeqType |vars#0@@4|) |argvs#0@@0|)  (and (and (Equiv.__default.Inv |st#0@@14|) (and (= (|Seq#Length| (Lit SeqType |vars#0@@4|)) (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0@@0|))) (= (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0@@0|)) (|Seq#Length| (Equiv.MSeqValue.vs_k |argvs#0@@0|))))) (Equiv.__default.EqSeqValue (Equiv.MSeqValue.vs |argvs#0@@0|) (Equiv.MSeqValue.vs_k |argvs#0@@0|))))))
 :qid |Inductiondfy.51:35|
 :weight 3
 :skolemid |749|
 :pattern ( (Equiv.__default.UpdateState__Pre |st#0@@14| (Lit SeqType |vars#0@@4|) |argvs#0@@0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@15| T@U) (|vars#0@@5| T@U) (|argvs#0@@1| T@U) ) (!  (=> (or (|Equiv.__default.UpdateState__Pre#canCall| (Lit DatatypeTypeType |st#0@@15|) (Lit SeqType |vars#0@@5|) (Lit DatatypeTypeType |argvs#0@@1|)) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@15| Tclass.Equiv.MState) ($Is SeqType |vars#0@@5| (TSeq (TSeq TChar)))) ($Is DatatypeTypeType |argvs#0@@1| Tclass.Equiv.VS)))) (and (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@15|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@15|))))) (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |argvs#0@@1|)) (=> (= (|Seq#Length| (Lit SeqType |vars#0@@5|)) (|Seq#Length| (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |argvs#0@@1|))))) (and (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |argvs#0@@1|)) (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |argvs#0@@1|))) (=> (= (|Seq#Length| (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |argvs#0@@1|)))) (|Seq#Length| (Lit SeqType (Equiv.MSeqValue.vs_k (Lit DatatypeTypeType |argvs#0@@1|))))) (and (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |argvs#0@@1|)) (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |argvs#0@@1|))) (|Equiv.__default.EqSeqValue#canCall| (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |argvs#0@@1|))) (Lit SeqType (Equiv.MSeqValue.vs_k (Lit DatatypeTypeType |argvs#0@@1|))))))))))) (= (Equiv.__default.UpdateState__Pre (Lit DatatypeTypeType |st#0@@15|) (Lit SeqType |vars#0@@5|) (Lit DatatypeTypeType |argvs#0@@1|))  (and (and (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@15|)) (and (= (|Seq#Length| (Lit SeqType |vars#0@@5|)) (|Seq#Length| (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |argvs#0@@1|))))) (= (|Seq#Length| (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |argvs#0@@1|)))) (|Seq#Length| (Lit SeqType (Equiv.MSeqValue.vs_k (Lit DatatypeTypeType |argvs#0@@1|))))))) (Equiv.__default.EqSeqValue (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |argvs#0@@1|))) (Lit SeqType (Equiv.MSeqValue.vs_k (Lit DatatypeTypeType |argvs#0@@1|))))))))
 :qid |Inductiondfy.51:35|
 :weight 3
 :skolemid |750|
 :pattern ( (Equiv.__default.UpdateState__Pre (Lit DatatypeTypeType |st#0@@15|) (Lit SeqType |vars#0@@5|) (Lit DatatypeTypeType |argvs#0@@1|)))
))))
...
(set-info :boogie-vc-id Impl$$Equiv.__default.InductAssign__Fail)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (Equiv.__default.Pes__Fail |st#0@@16| |avals#0@@2|))) (=> (not (Equiv.__default.Pes__Fail |st#0@@16| |avals#0@@2|)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|st1#1| T@U) (|vs#1@@2| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |st1#1| Tclass.Equiv.MState) ($Is DatatypeTypeType |vs#1@@2| Tclass.Equiv.VS)) (Equiv.__default.Pes__Succ |st#0@@16| |avals#0@@2| |st1#1| |vs#1@@2|)) (Equiv.__default.UpdateState__Pre |st1#1| |avars#0@@1| |vs#1@@2|))
 :qid |Inductiondfy.145:20|
 :skolemid |821|
 :pattern ( (Equiv.__default.UpdateState__Pre |st1#1| |avars#0@@1| |vs#1@@2|))
 :pattern ( (Equiv.__default.Pes__Succ |st#0@@16| |avals#0@@2| |st1#1| |vs#1@@2|))
))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@16| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st#0@@16| Tclass.Equiv.MState $Heap@@6)) (|$IsA#Equiv.MState| |st#0@@16|)) (=> (and (and (and ($Is DatatypeTypeType |e#0@@16| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@16| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@16|)) (and ($Is SeqType |avars#0@@1| (TSeq (TSeq TChar))) ($IsAlloc SeqType |avars#0@@1| (TSeq (TSeq TChar)) $Heap@@6))) (=> (and (and (and (and ($Is SeqType |avals#0@@2| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |avals#0@@2| (TSeq Tclass.AST.Expr) $Heap@@6)) (= 4 $FunctionContextHeight)) (and (AST.Expr__Raw.Assign_q |e#0@@16|) (|Seq#Equal| (AST.Expr__Raw.avars |e#0@@16|) |avars#0@@1|))) (and (and (|Seq#Equal| (AST.Expr__Raw.avals |e#0@@16|) |avals#0@@2|) (not (Equiv.__default.P__Fail |st#0@@16| |e#0@@16|))) (and (Equiv.__default.Pes |st#0@@16| |avals#0@@2|) (= (ControlFlow 0 4) 2)))) anon0_correct))))))
