...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|e#0@@4| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| (Lit DatatypeTypeType |st#0@@4|) (Lit DatatypeTypeType |e#0@@4|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@4| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@4| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@4|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@4|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@4|))))) (|Pure.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@4|) (Lit DatatypeTypeType |e#0@@4|))) (= (Pure.__default.P__Fail (Lit DatatypeTypeType |st#0@@4|) (Lit DatatypeTypeType |e#0@@4|)) (U_2_bool (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@4|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@4|)))))))
(Lit boolType (bool_2_U  (=> (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@4|) (Lit DatatypeTypeType |e#0@@4|)) (Utils.Result.Failure_q |res#2|)))))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |724|
 :pattern ( (Pure.__default.P__Fail (Lit DatatypeTypeType |st#0@@4|) (Lit DatatypeTypeType |e#0@@4|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|es#0@@4| T@U) ) (!  (=> (or (|Pure.__default.Pes#canCall| |st#0@@5| (Lit SeqType |es#0@@4|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@5| Tclass.Pure.MState) ($Is SeqType |es#0@@4| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@5|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@4|) (Pure.MState.ctx |st#0@@5|))) (let ((|res#1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@4|) (Pure.MState.ctx |st#0@@5|))))
 (and (|Pure.__default.PreEs#canCall| |st#0@@5| (Lit SeqType |es#0@@4|)) (=> (Pure.__default.PreEs |st#0@@5| (Lit SeqType |es#0@@4|)) (|Pure.__default.ResultSameState#canCall| (TSeq TInt) |st#0@@5| |res#1|))))) (= (Pure.__default.Pes |st#0@@5| (Lit SeqType |es#0@@4|)) (let ((|res#1@@0| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@4|) (Pure.MState.ctx |st#0@@5|))))
 (=> (Pure.__default.PreEs |st#0@@5| (Lit SeqType |es#0@@4|)) (Pure.__default.ResultSameState (TSeq TInt) |st#0@@5| |res#1@@0|))))))
 :qid |Inductiondfy.39:23|
 :weight 3
 :skolemid |730|
 :pattern ( (Pure.__default.Pes |st#0@@5| (Lit SeqType |es#0@@4|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|es#0@@5| T@U) ) (!  (=> (or (|Pure.__default.Pes__Fail#canCall| (Lit DatatypeTypeType |st#0@@6|) (Lit SeqType |es#0@@5|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.Pure.MState) ($Is SeqType |es#0@@5| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@6|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@5|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@6|))))) (|Pure.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@6|) (Lit SeqType |es#0@@5|))) (= (Pure.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@6|) (Lit SeqType |es#0@@5|)) (U_2_bool (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@5|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@6|)))))))
(Lit boolType (bool_2_U  (=> (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@6|) (Lit SeqType |es#0@@5|)) (Utils.Result.Failure_q |res#2@@0|)))))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |747|
 :pattern ( (Pure.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@6|) (Lit SeqType |es#0@@5|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|e#0@@8| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| |st#0@@7| (Lit DatatypeTypeType |e#0@@8|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@7| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@7|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@8|) (Pure.MState.ctx |st#0@@7|))) (|Pure.__default.Pre#canCall| |st#0@@7| (Lit DatatypeTypeType |e#0@@8|))) (= (Pure.__default.P__Fail |st#0@@7| (Lit DatatypeTypeType |e#0@@8|)) (let ((|res#1@@1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@8|) (Pure.MState.ctx |st#0@@7|))))
 (=> (Pure.__default.Pre |st#0@@7| (Lit DatatypeTypeType |e#0@@8|)) (Utils.Result.Failure_q |res#1@@1|))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |723|
 :pattern ( (Pure.__default.P__Fail |st#0@@7| (Lit DatatypeTypeType |e#0@@8|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|es#0@@9| T@U) (|st'#0@@0| T@U) (|vs#0@@1| T@U) ) (!  (=> (or (|Pure.__default.Pes__Succ#canCall| (Lit DatatypeTypeType |st#0@@8|) (Lit SeqType |es#0@@9|) (Lit DatatypeTypeType |st'#0@@0|) (Lit SeqType |vs#0@@1|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@8| Tclass.Pure.MState) ($Is SeqType |es#0@@9| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@0| Tclass.Pure.MState)) ($Is SeqType |vs#0@@1| (TSeq TInt))))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@8|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@9|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@8|))))) (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@9|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@8|)))))))
 (and (|Pure.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@8|) (Lit SeqType |es#0@@9|)) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@8|) (Lit SeqType |es#0@@9|))))) (and (|Pure.__default.ResultSameState#canCall| (TSeq TInt) (Lit DatatypeTypeType |st#0@@8|) |res#2@@1|) (=> (Pure.__default.ResultSameState (TSeq TInt) (Lit DatatypeTypeType |st#0@@8|) |res#2@@1|) (and (and (|$IsA#Utils.Result| |res#2@@1|) (Pure.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|))) (=> (|Utils.Result#Equal| |res#2@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |vs#0@@1|)) ($Box MapType (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st'#0@@0|))))))))) (and (Pure.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|)) (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@8|))))))))))) (= (Pure.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@8|) (Lit SeqType |es#0@@9|) (Lit DatatypeTypeType |st'#0@@0|) (Lit SeqType |vs#0@@1|)) (let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@9|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@8|)))))))
 (and (and (and (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@8|) (Lit SeqType |es#0@@9|)) (Pure.__default.ResultSameState (TSeq TInt) (Lit DatatypeTypeType |st#0@@8|) |res#2@@2|)) (|Utils.Result#Equal| |res#2@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |vs#0@@1|)) ($Box MapType (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st'#0@@0|)))))))))) (|Set#Equal| (Pure.MState.locals (Lit DatatypeTypeType |st'#0@@0|)) (Pure.MState.locals (Lit DatatypeTypeType |st#0@@8|))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |739|
 :pattern ( (Pure.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@8|) (Lit SeqType |es#0@@9|) (Lit DatatypeTypeType |st'#0@@0|) (Lit SeqType |vs#0@@1|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@9| T@U) (|es#0@@10| T@U) ) (!  (=> (or (|Pure.__default.Pes__Fail#canCall| |st#0@@9| (Lit SeqType |es#0@@10|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@9| Tclass.Pure.MState) ($Is SeqType |es#0@@10| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@9|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@10|) (Pure.MState.ctx |st#0@@9|))) (|Pure.__default.PreEs#canCall| |st#0@@9| (Lit SeqType |es#0@@10|))) (= (Pure.__default.Pes__Fail |st#0@@9| (Lit SeqType |es#0@@10|)) (let ((|res#1@@2| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@10|) (Pure.MState.ctx |st#0@@9|))))
 (=> (Pure.__default.PreEs |st#0@@9| (Lit SeqType |es#0@@10|)) (Utils.Result.Failure_q |res#1@@2|))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |746|
 :pattern ( (Pure.__default.Pes__Fail |st#0@@9| (Lit SeqType |es#0@@10|)))
))))
...
(assert (forall (($ly@@12 T@U) (|vars#0@@0| T@U) (|values#0| T@U) ) (! (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@12) |vars#0@@0| |values#0|) (Interp.__default.VarsAndValuesToContext $ly@@12 |vars#0@@0| |values#0|))
 :qid |Interpdfy.80:12|
 :skolemid |1210|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@12) |vars#0@@0| |values#0|))
)))
(assert (forall (($ly@@13 T@U) (|vars#0@@1| T@U) (|values#0@@0| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@1| |values#0@@0|) (and (and ($Is SeqType |vars#0@@1| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@0| (TSeq TInt))) (= (|Seq#Length| |vars#0@@1|) (|Seq#Length| |values#0@@0|)))) (and (|Set#Equal| (|Map#Domain| (Interp.__default.VarsAndValuesToContext $ly@@13 |vars#0@@1| |values#0@@0|)) (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |vars#0@@1|))) ($Is MapType (Interp.__default.VarsAndValuesToContext $ly@@13 |vars#0@@1| |values#0@@0|) (TMap (TSeq TChar) TInt))))
 :qid |Interpdfy.80:12|
 :skolemid |1212|
 :pattern ( (Interp.__default.VarsAndValuesToContext $ly@@13 |vars#0@@1| |values#0@@0|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@10| T@U) (|e#0@@13| T@U) ) (!  (=> (or (|Pure.__default.Pre#canCall| |st#0@@10| |e#0@@13|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@10| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@13| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@10|) (|Pure.__default.IsPure#canCall| |e#0@@13| (Pure.MState.locals |st#0@@10|))) (=> (Pure.__default.IsPure ($LS $LZ) |e#0@@13| (Pure.MState.locals |st#0@@10|)) (and (Pure.MState.MState_q |st#0@@10|) (Pure.MState.MState_q |st#0@@10|)))) (= (Pure.__default.Pre |st#0@@10| |e#0@@13|)  (and (Pure.__default.IsPure ($LS $LZ) |e#0@@13| (Pure.MState.locals |st#0@@10|)) (|Set#Subset| (Pure.MState.locals |st#0@@10|) (|Map#Domain| (Pure.MState.ctx |st#0@@10|)))))))
 :qid |Puredfy.85:23|
 :skolemid |696|
 :pattern ( (Pure.__default.Pre |st#0@@10| |e#0@@13|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((Pure._default.ResultSameState$V@@0 T@U) (|st#0@@11| T@U) (|res#0@@2| T@U) ) (!  (=> (or (|Pure.__default.ResultSameState#canCall| Pure._default.ResultSameState$V@@0 |st#0@@11| |res#0@@2|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@11| Tclass.Pure.MState) ($Is DatatypeTypeType |res#0@@2| (Tclass.Utils.Result (Tclass._System.Tuple2 Pure._default.ResultSameState$V@@0 (TMap (TSeq TChar) TInt))))))) (and (and (and (Pure.MState.MState_q |st#0@@11|) (Pure.MState.MState_q |st#0@@11|)) (|Pure.__default.ResultSameCtx#canCall| Pure._default.ResultSameState$V@@0 (Pure.MState.locals |st#0@@11|) (Pure.MState.ctx |st#0@@11|) |res#0@@2|)) (= (Pure.__default.ResultSameState Pure._default.ResultSameState$V@@0 |st#0@@11| |res#0@@2|) (Pure.__default.ResultSameCtx Pure._default.ResultSameState$V@@0 (Pure.MState.locals |st#0@@11|) (Pure.MState.ctx |st#0@@11|) |res#0@@2|))))
 :qid |unknown.0:0|
 :skolemid |690|
 :pattern ( (Pure.__default.ResultSameState Pure._default.ResultSameState$V@@0 |st#0@@11| |res#0@@2|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@12| T@U) (|es#0@@13| T@U) ) (!  (=> (or (|Pure.__default.PreEs#canCall| |st#0@@12| |es#0@@13|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@12| Tclass.Pure.MState) ($Is SeqType |es#0@@13| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@12|) (|Pure.__default.IsPure__Es#canCall| |es#0@@13| (Pure.MState.locals |st#0@@12|))) (=> (Pure.__default.IsPure__Es ($LS $LZ) |es#0@@13| (Pure.MState.locals |st#0@@12|)) (and (Pure.MState.MState_q |st#0@@12|) (Pure.MState.MState_q |st#0@@12|)))) (= (Pure.__default.PreEs |st#0@@12| |es#0@@13|)  (and (Pure.__default.IsPure__Es ($LS $LZ) |es#0@@13| (Pure.MState.locals |st#0@@12|)) (|Set#Subset| (Pure.MState.locals |st#0@@12|) (|Map#Domain| (Pure.MState.ctx |st#0@@12|)))))))
 :qid |Puredfy.91:25|
 :skolemid |701|
 :pattern ( (Pure.__default.PreEs |st#0@@12| |es#0@@13|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@13| T@U) (|e#0@@14| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| |st#0@@13| |e#0@@14|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@13| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@14| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@13|) (|Interp.__default.InterpExpr#canCall| |e#0@@14| (Pure.MState.ctx |st#0@@13|))) (|Pure.__default.Pre#canCall| |st#0@@13| |e#0@@14|)) (= (Pure.__default.P__Fail |st#0@@13| |e#0@@14|) (let ((|res#0@@3| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@14| (Pure.MState.ctx |st#0@@13|))))
 (=> (Pure.__default.Pre |st#0@@13| |e#0@@14|) (Utils.Result.Failure_q |res#0@@3|))))))
 :qid |Inductiondfy.36:26|
 :skolemid |722|
 :pattern ( (Pure.__default.P__Fail |st#0@@13| |e#0@@14|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@14| T@U) (|es#0@@15| T@U) ) (!  (=> (or (|Pure.__default.Pes#canCall| |st#0@@14| |es#0@@15|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@14| Tclass.Pure.MState) ($Is SeqType |es#0@@15| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@14|) (|Interp.__default.InterpExprs#canCall| |es#0@@15| (Pure.MState.ctx |st#0@@14|))) (let ((|res#0@@5| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@15| (Pure.MState.ctx |st#0@@14|))))
 (and (|Pure.__default.PreEs#canCall| |st#0@@14| |es#0@@15|) (=> (Pure.__default.PreEs |st#0@@14| |es#0@@15|) (|Pure.__default.ResultSameState#canCall| (TSeq TInt) |st#0@@14| |res#0@@5|))))) (= (Pure.__default.Pes |st#0@@14| |es#0@@15|) (let ((|res#0@@6| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@15| (Pure.MState.ctx |st#0@@14|))))
 (=> (Pure.__default.PreEs |st#0@@14| |es#0@@15|) (Pure.__default.ResultSameState (TSeq TInt) |st#0@@14| |res#0@@6|))))))
 :qid |Inductiondfy.39:23|
 :skolemid |729|
 :pattern ( (Pure.__default.Pes |st#0@@14| |es#0@@15|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@17 T@U) (|es#0@@16| T@U) (|locals#0@@5| T@U) ) (!  (=> (or (|Pure.__default.IsPure__Es#canCall| |es#0@@16| |locals#0@@5|) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |es#0@@16| (TSeq Tclass.AST.Expr)) ($Is SetType |locals#0@@5| (TSet (TSeq TChar)))))) (and (=> (not (|Seq#Equal| |es#0@@16| |Seq#Empty|)) (and (|Pure.__default.IsPure#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@16| (LitInt 0))) |locals#0@@5|) (=> (Pure.__default.IsPure $ly@@17 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@16| (LitInt 0))) |locals#0@@5|) (|Pure.__default.IsPure__Es#canCall| (|Seq#Drop| |es#0@@16| (LitInt 1)) |locals#0@@5|)))) (= (Pure.__default.IsPure__Es ($LS $ly@@17) |es#0@@16| |locals#0@@5|) (ite (|Seq#Equal| |es#0@@16| |Seq#Empty|) true  (and (Pure.__default.IsPure $ly@@17 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@16| (LitInt 0))) |locals#0@@5|) (Pure.__default.IsPure__Es $ly@@17 (|Seq#Drop| |es#0@@16| (LitInt 1)) |locals#0@@5|))))))
 :qid |Puredfy.39:13|
 :skolemid |671|
 :pattern ( (Pure.__default.IsPure__Es ($LS $ly@@17) |es#0@@16| |locals#0@@5|))
))))
(assert (forall (($ly@@18 T@U) (|vars#0@@2| T@U) (|values#0@@1| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@2| |values#0@@1|) (and (and ($Is SeqType |vars#0@@2| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@1| (TSeq TInt))) (= (|Seq#Length| |vars#0@@2|) (|Seq#Length| |values#0@@1|)))) (and (=> (not (|Seq#Equal| |vars#0@@2| |Seq#Empty|)) (|Interp.__default.VarsAndValuesToContext#canCall| (|Seq#Drop| |vars#0@@2| (LitInt 1)) (|Seq#Drop| |values#0@@1| (LitInt 1)))) (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@18) |vars#0@@2| |values#0@@1|) (ite (|Seq#Equal| |vars#0@@2| |Seq#Empty|) |Map#Empty| (|Map#Merge| (|Map#Build| |Map#Empty| (|Seq#Index| |vars#0@@2| (LitInt 0)) (|Seq#Index| |values#0@@1| (LitInt 0))) (Interp.__default.VarsAndValuesToContext $ly@@18 (|Seq#Drop| |vars#0@@2| (LitInt 1)) (|Seq#Drop| |values#0@@1| (LitInt 1))))))))
 :qid |Interpdfy.80:12|
 :skolemid |1214|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@18) |vars#0@@2| |values#0@@1|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@15| T@U) (|es#0@@17| T@U) (|st'#0@@1| T@U) (|vs#0@@3| T@U) ) (!  (=> (or (|Pure.__default.Pes__Succ#canCall| |st#0@@15| (Lit SeqType |es#0@@17|) |st'#0@@1| |vs#0@@3|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@15| Tclass.Pure.MState) ($Is SeqType |es#0@@17| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@1| Tclass.Pure.MState)) ($Is SeqType |vs#0@@3| (TSeq TInt))))) (and (and (and (Pure.MState.MState_q |st#0@@15|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@17|) (Pure.MState.ctx |st#0@@15|))) (let ((|res#1@@3| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@17|) (Pure.MState.ctx |st#0@@15|))))
 (and (|Pure.__default.PreEs#canCall| |st#0@@15| (Lit SeqType |es#0@@17|)) (=> (Pure.__default.PreEs |st#0@@15| (Lit SeqType |es#0@@17|)) (and (|Pure.__default.ResultSameState#canCall| (TSeq TInt) |st#0@@15| |res#1@@3|) (=> (Pure.__default.ResultSameState (TSeq TInt) |st#0@@15| |res#1@@3|) (and (and (|$IsA#Utils.Result| |res#1@@3|) (Pure.MState.MState_q |st'#0@@1|)) (=> (|Utils.Result#Equal| |res#1@@3| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@3|) ($Box MapType (Pure.MState.ctx |st'#0@@1|)))))) (and (Pure.MState.MState_q |st'#0@@1|) (Pure.MState.MState_q |st#0@@15|)))))))))) (= (Pure.__default.Pes__Succ |st#0@@15| (Lit SeqType |es#0@@17|) |st'#0@@1| |vs#0@@3|) (let ((|res#1@@4| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@17|) (Pure.MState.ctx |st#0@@15|))))
 (and (and (and (Pure.__default.PreEs |st#0@@15| (Lit SeqType |es#0@@17|)) (Pure.__default.ResultSameState (TSeq TInt) |st#0@@15| |res#1@@4|)) (|Utils.Result#Equal| |res#1@@4| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@3|) ($Box MapType (Pure.MState.ctx |st'#0@@1|))))))) (|Set#Equal| (Pure.MState.locals |st'#0@@1|) (Pure.MState.locals |st#0@@15|)))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |738|
 :pattern ( (Pure.__default.Pes__Succ |st#0@@15| (Lit SeqType |es#0@@17|) |st'#0@@1| |vs#0@@3|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@16| T@U) (|es#0@@18| T@U) ) (!  (=> (or (|Pure.__default.Pes__Fail#canCall| |st#0@@16| |es#0@@18|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@16| Tclass.Pure.MState) ($Is SeqType |es#0@@18| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@16|) (|Interp.__default.InterpExprs#canCall| |es#0@@18| (Pure.MState.ctx |st#0@@16|))) (|Pure.__default.PreEs#canCall| |st#0@@16| |es#0@@18|)) (= (Pure.__default.Pes__Fail |st#0@@16| |es#0@@18|) (let ((|res#0@@7| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@18| (Pure.MState.ctx |st#0@@16|))))
 (=> (Pure.__default.PreEs |st#0@@16| |es#0@@18|) (Utils.Result.Failure_q |res#0@@7|))))))
 :qid |Inductiondfy.41:28|
 :skolemid |745|
 :pattern ( (Pure.__default.Pes__Fail |st#0@@16| |es#0@@18|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@17| T@U) (|vars#0@@3| T@U) (|argvs#0@@0| T@U) ) (!  (=> (or (|Pure.__default.UpdateState__Pre#canCall| |st#0@@17| (Lit SeqType |vars#0@@3|) |argvs#0@@0|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@17| Tclass.Pure.MState) ($Is SeqType |vars#0@@3| (TSeq (TSeq TChar)))) ($Is SeqType |argvs#0@@0| (TSeq TInt))))) (= (Pure.__default.UpdateState__Pre |st#0@@17| (Lit SeqType |vars#0@@3|) |argvs#0@@0|)  (and true (= (|Seq#Length| (Lit SeqType |vars#0@@3|)) (|Seq#Length| |argvs#0@@0|)))))
 :qid |Inductiondfy.51:35|
 :weight 3
 :skolemid |762|
 :pattern ( (Pure.__default.UpdateState__Pre |st#0@@17| (Lit SeqType |vars#0@@3|) |argvs#0@@0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@18| T@U) (|vars#0@@4| T@U) (|argvs#0@@1| T@U) ) (!  (=> (or (|Pure.__default.UpdateState__Pre#canCall| (Lit DatatypeTypeType |st#0@@18|) (Lit SeqType |vars#0@@4|) (Lit SeqType |argvs#0@@1|)) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@18| Tclass.Pure.MState) ($Is SeqType |vars#0@@4| (TSeq (TSeq TChar)))) ($Is SeqType |argvs#0@@1| (TSeq TInt))))) (= (Pure.__default.UpdateState__Pre (Lit DatatypeTypeType |st#0@@18|) (Lit SeqType |vars#0@@4|) (Lit SeqType |argvs#0@@1|))  (and true (= (|Seq#Length| (Lit SeqType |vars#0@@4|)) (|Seq#Length| (Lit SeqType |argvs#0@@1|))))))
 :qid |Inductiondfy.51:35|
 :weight 3
 :skolemid |763|
 :pattern ( (Pure.__default.UpdateState__Pre (Lit DatatypeTypeType |st#0@@18|) (Lit SeqType |vars#0@@4|) (Lit SeqType |argvs#0@@1|)))
))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#2|)) ($Box MapType |ctx#0@@9|))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|body#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@17|)))))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1201|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@19) (Lit DatatypeTypeType |e#0@@17|) |ctx#0@@9|))
)))
...
(assert (forall (($ly@@20 T@U) (|vars#0@@5| T@U) (|values#0@@2| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@5|) (Lit SeqType |values#0@@2|)) (and (and ($Is SeqType |vars#0@@5| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@2| (TSeq TInt))) (= (|Seq#Length| (Lit SeqType |vars#0@@5|)) (|Seq#Length| (Lit SeqType |values#0@@2|))))) (and (=> (not (|Seq#Equal| |vars#0@@5| |Seq#Empty|)) (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |vars#0@@5|) (LitInt 1))) (Lit SeqType (|Seq#Drop| (Lit SeqType |values#0@@2|) (LitInt 1))))) (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@20) (Lit SeqType |vars#0@@5|) (Lit SeqType |values#0@@2|)) (ite (|Seq#Equal| |vars#0@@5| |Seq#Empty|) |Map#Empty| (|Map#Merge| (|Map#Build| |Map#Empty| (|Seq#Index| (Lit SeqType |vars#0@@5|) (LitInt 0)) (|Seq#Index| (Lit SeqType |values#0@@2|) (LitInt 0))) (Interp.__default.VarsAndValuesToContext ($LS $ly@@20) (Lit SeqType (|Seq#Drop| (Lit SeqType |vars#0@@5|) (LitInt 1))) (Lit SeqType (|Seq#Drop| (Lit SeqType |values#0@@2|) (LitInt 1)))))))))
 :qid |Interpdfy.80:12|
 :weight 3
 :skolemid |1215|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@20) (Lit SeqType |vars#0@@5|) (Lit SeqType |values#0@@2|)))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@21 T@U) (|es#0@@19| T@U) (|locals#0@@6| T@U) ) (!  (=> (or (|Pure.__default.IsPure__Es#canCall| (Lit SeqType |es#0@@19|) |locals#0@@6|) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |es#0@@19| (TSeq Tclass.AST.Expr)) ($Is SetType |locals#0@@6| (TSet (TSeq TChar)))))) (and (=> (not (|Seq#Equal| |es#0@@19| |Seq#Empty|)) (and (|Pure.__default.IsPure#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@19|) (LitInt 0))) |locals#0@@6|) (=> (Pure.__default.IsPure ($LS $ly@@21) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@19|) (LitInt 0))) |locals#0@@6|) (|Pure.__default.IsPure__Es#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@19|) (LitInt 1))) |locals#0@@6|)))) (= (Pure.__default.IsPure__Es ($LS $ly@@21) (Lit SeqType |es#0@@19|) |locals#0@@6|) (ite (|Seq#Equal| |es#0@@19| |Seq#Empty|) true  (and (Pure.__default.IsPure ($LS $ly@@21) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@19|) (LitInt 0))) |locals#0@@6|) (Pure.__default.IsPure__Es ($LS $ly@@21) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@19|) (LitInt 1))) |locals#0@@6|))))))
 :qid |Puredfy.39:13|
 :weight 3
 :skolemid |672|
 :pattern ( (Pure.__default.IsPure__Es ($LS $ly@@21) (Lit SeqType |es#0@@19|) |locals#0@@6|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@19| T@U) (|es#0@@20| T@U) ) (!  (=> (or (|Pure.__default.Pes#canCall| (Lit DatatypeTypeType |st#0@@19|) (Lit SeqType |es#0@@20|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@19| Tclass.Pure.MState) ($Is SeqType |es#0@@20| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@19|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@20|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@19|))))) (let ((|res#2@@3| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@20|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@19|)))))))
 (and (|Pure.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@19|) (Lit SeqType |es#0@@20|)) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@19|) (Lit SeqType |es#0@@20|))))) (|Pure.__default.ResultSameState#canCall| (TSeq TInt) (Lit DatatypeTypeType |st#0@@19|) |res#2@@3|))))) (= (Pure.__default.Pes (Lit DatatypeTypeType |st#0@@19|) (Lit SeqType |es#0@@20|)) (U_2_bool (let ((|res#2@@4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@20|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@19|)))))))
(Lit boolType (bool_2_U  (=> (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@19|) (Lit SeqType |es#0@@20|)) (Pure.__default.ResultSameState (TSeq TInt) (Lit DatatypeTypeType |st#0@@19|) |res#2@@4|)))))))))
 :qid |Inductiondfy.39:23|
 :weight 3
 :skolemid |731|
 :pattern ( (Pure.__default.Pes (Lit DatatypeTypeType |st#0@@19|) (Lit SeqType |es#0@@20|)))
))))
...
(let ((|oe1#0@@0| (AST.Expr__Raw.oe1 |e#0@@21|)))
 (and (Pure.__default.IsPure $ly@@24 |oe1#0@@0| |locals#0@@8|) (Pure.__default.IsPure $ly@@24 |oe2#0@@0| |locals#0@@8|)))) (let ((|es#0@@21| (AST.Expr__Raw.es |e#0@@21|)))
(Pure.__default.IsPure__Es $ly@@24 |es#0@@21| |locals#0@@8|)))))))))))
 :qid |Puredfy.15:13|
 :skolemid |645|
...
(set-info :boogie-vc-id Impl$$Pure.__default.InductAssign__Fail)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#6| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (Pure.__default.Pes__Fail |st#0@@20| |avals#0@@3|))) (=> (not (Pure.__default.Pes__Fail |st#0@@20| |avals#0@@3|)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|st1#1| T@U) (|vs#1@@1| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |st1#1| Tclass.Pure.MState) ($Is SeqType |vs#1@@1| (TSeq TInt))) (Pure.__default.Pes__Succ |st#0@@20| |avals#0@@3| |st1#1| |vs#1@@1|)) (Pure.__default.UpdateState__Pre |st1#1| |avars#0@@2| |vs#1@@1|))
 :qid |Inductiondfy.145:20|
 :skolemid |832|
 :pattern ( (Pure.__default.UpdateState__Pre |st1#1| |avars#0@@2| |vs#1@@1|))
 :pattern ( (Pure.__default.Pes__Succ |st#0@@20| |avals#0@@3| |st1#1| |vs#1@@1|))
))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@20| Tclass.Pure.MState) ($IsAlloc DatatypeTypeType |st#0@@20| Tclass.Pure.MState $Heap@@6)) (|$IsA#Pure.MState| |st#0@@20|)) (=> (and (and (and ($Is DatatypeTypeType |e#0@@22| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@22| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@22|)) (and ($Is SeqType |avars#0@@2| (TSeq (TSeq TChar))) ($IsAlloc SeqType |avars#0@@2| (TSeq (TSeq TChar)) $Heap@@6))) (=> (and (and (and (and ($Is SeqType |avals#0@@3| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |avals#0@@3| (TSeq Tclass.AST.Expr) $Heap@@6)) (= 4 $FunctionContextHeight)) (and (AST.Expr__Raw.Assign_q |e#0@@22|) (|Seq#Equal| (AST.Expr__Raw.avars |e#0@@22|) |avars#0@@2|))) (and (and (|Seq#Equal| (AST.Expr__Raw.avals |e#0@@22|) |avals#0@@3|) (not (Pure.__default.P__Fail |st#0@@20| |e#0@@22|))) (and (Pure.__default.Pes |st#0@@20| |avals#0@@3|) (= (ControlFlow 0 4) 2)))) anon0_correct))))))
