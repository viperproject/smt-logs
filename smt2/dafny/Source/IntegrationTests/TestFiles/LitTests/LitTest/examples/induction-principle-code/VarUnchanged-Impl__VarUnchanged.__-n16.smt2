...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@0| T@U) (|e#0@@2| T@U) ) (!  (=> (or (|VarUnchanged.__default.P__Fail#canCall| (Lit DatatypeTypeType |st#0@@0|) (Lit DatatypeTypeType |e#0@@2|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@0| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@2| Tclass.AST.Expr)))) (and (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@0|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@2|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@0|))))) (|VarUnchanged.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@0|) (Lit DatatypeTypeType |e#0@@2|))) (= (VarUnchanged.__default.P__Fail (Lit DatatypeTypeType |st#0@@0|) (Lit DatatypeTypeType |e#0@@2|)) (U_2_bool (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@2|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@0|)))))))
(Lit boolType (bool_2_U  (=> (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@0|) (Lit DatatypeTypeType |e#0@@2|)) (Utils.Result.Failure_q |res#2|)))))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |739|
 :pattern ( (VarUnchanged.__default.P__Fail (Lit DatatypeTypeType |st#0@@0|) (Lit DatatypeTypeType |e#0@@2|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|e#0@@9| T@U) ) (!  (=> (or (|VarUnchanged.__default.P__Fail#canCall| |st#0@@4| (Lit DatatypeTypeType |e#0@@9|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@4| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@9| Tclass.AST.Expr)))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@4|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@9|) (VarUnchanged.MState.ctx |st#0@@4|))) (|VarUnchanged.__default.Pre#canCall| |st#0@@4| (Lit DatatypeTypeType |e#0@@9|))) (= (VarUnchanged.__default.P__Fail |st#0@@4| (Lit DatatypeTypeType |e#0@@9|)) (let ((|res#1@@1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@9|) (VarUnchanged.MState.ctx |st#0@@4|))))
 (=> (VarUnchanged.__default.Pre |st#0@@4| (Lit DatatypeTypeType |e#0@@9|)) (Utils.Result.Failure_q |res#1@@1|))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |738|
 :pattern ( (VarUnchanged.__default.P__Fail |st#0@@4| (Lit DatatypeTypeType |e#0@@9|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|res#0| T@U) ) (!  (=> (or (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@5| |res#0|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@5| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |res#0| (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt))))))) (and (=> (Utils.Result.Success_q |res#0|) (and (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value |res#0|))) (let ((|ctx#1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#0|))))))
 (and (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value |res#0|))) (and (VarUnchanged.MState.MState_q |st#0@@5|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@5|)) (and (VarUnchanged.MState.MState_q |st#0@@5|) (=> (|Set#IsMember| (|Map#Domain| |ctx#1|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@5|))) (and (and (VarUnchanged.MState.MState_q |st#0@@5|) (VarUnchanged.MState.MState_q |st#0@@5|)) (VarUnchanged.MState.MState_q |st#0@@5|)))))))))) (= (VarUnchanged.__default.ResultSameX |st#0@@5| |res#0|) (ite (Utils.Result.Success_q |res#0|) (let ((|ctx#0@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#0|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@5|)) (and (|Set#IsMember| (|Map#Domain| |ctx#0@@2|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@5|))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (VarUnchanged.MState.ctx |st#0@@5|)) (Utils.Option.value (VarUnchanged.MState.x |st#0@@5|))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@2|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@5|))))))))) true))))
 :qid |VarUnchangeddfy.41:31|
 :skolemid |695|
 :pattern ( (VarUnchanged.__default.ResultSameX |st#0@@5| |res#0|))
))))
...
(assert (forall (($ly@@6 T@U) (|e#0@@11| T@U) (|ctx#0@@3| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@11| |ctx#0@@3|) (and ($Is DatatypeTypeType |e#0@@11| Tclass.AST.Expr) ($Is MapType |ctx#0@@3| (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType (Interp.__default.InterpExpr $ly@@6 |e#0@@11| |ctx#0@@3|) (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))))
 :qid |Interpdfy.24:12|
 :skolemid |1212|
 :pattern ( (Interp.__default.InterpExpr $ly@@6 |e#0@@11| |ctx#0@@3|))
)))
(assert (forall (($ly@@7 T@U) (|e#0@@12| T@U) (|ctx#0@@4| T@U) ) (! (= (Interp.__default.InterpExpr ($LS $ly@@7) |e#0@@12| |ctx#0@@4|) (Interp.__default.InterpExpr $ly@@7 |e#0@@12| |ctx#0@@4|))
 :qid |Interpdfy.24:12|
 :skolemid |1210|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@7) |e#0@@12| |ctx#0@@4|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|e#0@@15| T@U) ) (!  (=> (or (|VarUnchanged.__default.P__Fail#canCall| |st#0@@7| |e#0@@15|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@7| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr)))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@7|) (|Interp.__default.InterpExpr#canCall| |e#0@@15| (VarUnchanged.MState.ctx |st#0@@7|))) (|VarUnchanged.__default.Pre#canCall| |st#0@@7| |e#0@@15|)) (= (VarUnchanged.__default.P__Fail |st#0@@7| |e#0@@15|) (let ((|res#0@@0| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@15| (VarUnchanged.MState.ctx |st#0@@7|))))
 (=> (VarUnchanged.__default.Pre |st#0@@7| |e#0@@15|) (Utils.Result.Failure_q |res#0@@0|))))))
 :qid |Inductiondfy.36:26|
 :skolemid |737|
 :pattern ( (VarUnchanged.__default.P__Fail |st#0@@7| |e#0@@15|))
))))
...
(Lit DatatypeTypeType (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#4|)) ($Box MapType (Lit MapType |ctx#0@@8|)))))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|body#4| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@17|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1216|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@14) (Lit DatatypeTypeType |e#0@@17|) (Lit MapType |ctx#0@@8|)))
)))
...
(assert (forall ((d@@40 T@U) ) (!  (=> (|$IsA#AST.BinOp| d@@40) (or (or (AST.BinOp.Add_q d@@40) (AST.BinOp.Sub_q d@@40)) (AST.BinOp.Mul_q d@@40)))
 :qid |unknown.0:0|
 :skolemid |1035|
 :pattern ( (|$IsA#AST.BinOp| d@@40))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|res#0@@1| T@U) ) (!  (=> (or (|VarUnchanged.__default.ResultSameX#canCall| (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |res#0@@1|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@8| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |res#0@@1| (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt))))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@1|))))) (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@1|))))) (let ((|ctx#3| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@1|)))))))))
 (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@1|))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@8|)) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@8|))))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@8|)) (=> (|Set#IsMember| (|Map#Domain| |ctx#3|) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@8|)))))))) (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@8|)) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@8|))) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@8|))))))))))) (= (VarUnchanged.__default.ResultSameX (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |res#0@@1|)) (ite (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@1|)) (let ((|ctx#2| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@1|)))))))))
 ...
 :weight 3
 :skolemid |696|
 :pattern ( (VarUnchanged.__default.ResultSameX (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |res#0@@1|)))
))))
...
(assert (forall ((d@@41 T@U) (Utils.Result$T@@14 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (Utils.Result.Success_q d@@41) ($IsAlloc DatatypeTypeType d@@41 (Tclass.Utils.Result Utils.Result$T@@14) $h@@8))) ($IsAllocBox (Utils.Result.value d@@41) Utils.Result$T@@14 $h@@8))
 :qid |unknown.0:0|
 :skolemid |982|
 :pattern ( ($IsAllocBox (Utils.Result.value d@@41) Utils.Result$T@@14 $h@@8))
)))
(assert (forall ((d@@42 T@U) (Utils.Option$T@@6 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) (and (Utils.Option.Some_q d@@42) ($IsAlloc DatatypeTypeType d@@42 (Tclass.Utils.Option Utils.Option$T@@6) $h@@9))) ($IsAllocBox (Utils.Option.value d@@42) Utils.Option$T@@6 $h@@9))
 :qid |unknown.0:0|
 :skolemid |1015|
 :pattern ( ($IsAllocBox (Utils.Option.value d@@42) Utils.Option$T@@6 $h@@9))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@9| T@U) (|e#0@@19| T@U) (|st'#0@@1| T@U) (|v#0@@2| Int) ) (!  (=> (or (|VarUnchanged.__default.P__Succ#canCall| |st#0@@9| |e#0@@19| |st'#0@@1| |v#0@@2|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@9| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@19| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@1| Tclass.VarUnchanged.S)))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@9|) (|Interp.__default.InterpExpr#canCall| |e#0@@19| (VarUnchanged.MState.ctx |st#0@@9|))) (let ((|res#0@@2| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@19| (VarUnchanged.MState.ctx |st#0@@9|))))
 (and (|VarUnchanged.__default.Pre#canCall| |st#0@@9| |e#0@@19|) (=> (VarUnchanged.__default.Pre |st#0@@9| |e#0@@19|) (and (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@9| |res#0@@2|) (=> (VarUnchanged.__default.ResultSameX |st#0@@9| |res#0@@2|) (and (and (|$IsA#Utils.Result| |res#0@@2|) (VarUnchanged.MState.MState_q |st'#0@@1|)) (=> (|Utils.Result#Equal| |res#0@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0@@2|)) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@1|)))))) (and (and (|$IsA#Utils.Option| (VarUnchanged.MState.x |st'#0@@1|)) (|$IsA#Utils.Option| (VarUnchanged.MState.x |st#0@@9|))) (and (VarUnchanged.MState.MState_q |st'#0@@1|) (VarUnchanged.MState.MState_q |st#0@@9|))))))))))) (= (VarUnchanged.__default.P__Succ |st#0@@9| |e#0@@19| |st'#0@@1| |v#0@@2|) (let ((|res#0@@3| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@19| (VarUnchanged.MState.ctx |st#0@@9|))))
 (and (and (and (VarUnchanged.__default.Pre |st#0@@9| |e#0@@19|) (VarUnchanged.__default.ResultSameX |st#0@@9| |res#0@@3|)) (|Utils.Result#Equal| |res#0@@3| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0@@2|)) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@1|))))))) (|Utils.Option#Equal| (VarUnchanged.MState.x |st'#0@@1|) (VarUnchanged.MState.x |st#0@@9|)))))))
 :qid |Inductiondfy.35:26|
 :skolemid |729|
...
(assert (forall ((d@@46 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) ($Is DatatypeTypeType d@@46 Tclass.VarUnchanged.MState)) ($IsAlloc DatatypeTypeType d@@46 Tclass.VarUnchanged.MState $h@@11))
 :qid |unknown.0:0|
 :skolemid |951|
 :pattern ( ($IsAlloc DatatypeTypeType d@@46 Tclass.VarUnchanged.MState $h@@11))
)))
(assert (forall ((d@@47 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) ($Is DatatypeTypeType d@@47 Tclass.AST.BinOp)) ($IsAlloc DatatypeTypeType d@@47 Tclass.AST.BinOp $h@@12))
 :qid |unknown.0:0|
 :skolemid |1034|
 :pattern ( ($IsAlloc DatatypeTypeType d@@47 Tclass.AST.BinOp $h@@12))
)))
(assert (forall ((d@@48 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) ($Is DatatypeTypeType d@@48 Tclass.AST.Expr__Raw)) ($IsAlloc DatatypeTypeType d@@48 Tclass.AST.Expr__Raw $h@@13))
 :qid |unknown.0:0|
 :skolemid |1130|
 :pattern ( ($IsAlloc DatatypeTypeType d@@48 Tclass.AST.Expr__Raw $h@@13))
)))
...
(assert (forall ((d@@49 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (AST.Expr__Raw.Var_q d@@49) ($IsAlloc DatatypeTypeType d@@49 Tclass.AST.Expr__Raw $h@@14))) ($IsAlloc SeqType (AST.Expr__Raw.name d@@49) (TSeq TChar) $h@@14))
 :qid |unknown.0:0|
 :skolemid |1046|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.name d@@49) (TSeq TChar) $h@@14))
)))
...
(assert (forall ((|a#7#0#0@@0| T@U) (|a#7#1#0@@0| T@U) (d@@50 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#7#1#0@@0|) ($Box DatatypeTypeType d@@50)) (< (DtRank d@@50) (DtRank (|#VarUnchanged.MState.MState| |a#7#0#0@@0| |a#7#1#0@@0|))))
 :qid |VarUnchangeddfy.73:28|
 :skolemid |949|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#7#1#0@@0|) ($Box DatatypeTypeType d@@50)) (|#VarUnchanged.MState.MState| |a#7#0#0@@0| |a#7#1#0@@0|))
)))
...
(assert (forall ((d@@51 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (VarUnchanged.MState.MState_q d@@51) ($IsAlloc DatatypeTypeType d@@51 Tclass.VarUnchanged.MState $h@@15))) ($IsAlloc MapType (VarUnchanged.MState.ctx d@@51) (TMap (TSeq TChar) TInt) $h@@15))
 :qid |unknown.0:0|
 :skolemid |944|
 :pattern ( ($IsAlloc MapType (VarUnchanged.MState.ctx d@@51) (TMap (TSeq TChar) TInt) $h@@15))
)))
(assert (forall ((d@@52 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (_System.Tuple2.___hMake2_q d@@52) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@52 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@16)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@52 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@16))
)))) ($IsAllocBox (_System.Tuple2._0 d@@52) |_System._tuple#2$T0@@6| $h@@16))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@52) |_System._tuple#2$T0@@6| $h@@16))
)))
(assert (forall ((d@@53 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (_System.Tuple2.___hMake2_q d@@53) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@53 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@17)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@53 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@17))
)))) ($IsAllocBox (_System.Tuple2._1 d@@53) |_System._tuple#2$T1@@7| $h@@17))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@53) |_System._tuple#2$T1@@7| $h@@17))
)))
...
(assert (forall ((d@@54 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (AST.Expr__Raw.Bind_q d@@54) ($IsAlloc DatatypeTypeType d@@54 Tclass.AST.Expr__Raw $h@@18))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@54) Tclass.AST.Expr__Raw $h@@18))
 :qid |unknown.0:0|
 :skolemid |1066|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@54) Tclass.AST.Expr__Raw $h@@18))
)))
(assert (forall ((d@@55 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (AST.Expr__Raw.If_q d@@55) ($IsAlloc DatatypeTypeType d@@55 Tclass.AST.Expr__Raw $h@@19))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@55) Tclass.AST.Expr__Raw $h@@19))
 :qid |unknown.0:0|
 :skolemid |1095|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@55) Tclass.AST.Expr__Raw $h@@19))
)))
(assert (forall ((d@@56 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (AST.Expr__Raw.If_q d@@56) ($IsAlloc DatatypeTypeType d@@56 Tclass.AST.Expr__Raw $h@@20))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@56) Tclass.AST.Expr__Raw $h@@20))
 :qid |unknown.0:0|
 :skolemid |1096|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@56) Tclass.AST.Expr__Raw $h@@20))
)))
(assert (forall ((d@@57 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (AST.Expr__Raw.If_q d@@57) ($IsAlloc DatatypeTypeType d@@57 Tclass.AST.Expr__Raw $h@@21))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@57) Tclass.AST.Expr__Raw $h@@21))
 :qid |unknown.0:0|
 :skolemid |1097|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@57) Tclass.AST.Expr__Raw $h@@21))
)))
(assert (forall ((d@@58 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (AST.Expr__Raw.Op_q d@@58) ($IsAlloc DatatypeTypeType d@@58 Tclass.AST.Expr__Raw $h@@22))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@58) Tclass.AST.BinOp $h@@22))
 :qid |unknown.0:0|
 :skolemid |1110|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@58) Tclass.AST.BinOp $h@@22))
)))
(assert (forall ((d@@59 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (AST.Expr__Raw.Op_q d@@59) ($IsAlloc DatatypeTypeType d@@59 Tclass.AST.Expr__Raw $h@@23))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@59) Tclass.AST.Expr__Raw $h@@23))
 :qid |unknown.0:0|
 :skolemid |1111|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@59) Tclass.AST.Expr__Raw $h@@23))
)))
(assert (forall ((d@@60 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (AST.Expr__Raw.Op_q d@@60) ($IsAlloc DatatypeTypeType d@@60 Tclass.AST.Expr__Raw $h@@24))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@60) Tclass.AST.Expr__Raw $h@@24))
 :qid |unknown.0:0|
 :skolemid |1112|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@60) Tclass.AST.Expr__Raw $h@@24))
)))
...
(assert (forall ((d@@61 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (VarUnchanged.MState.MState_q d@@61) ($IsAlloc DatatypeTypeType d@@61 Tclass.VarUnchanged.MState $h@@25))) ($IsAlloc DatatypeTypeType (VarUnchanged.MState.x d@@61) (Tclass.Utils.Option (TSeq TChar)) $h@@25))
 :qid |unknown.0:0|
 :skolemid |943|
 :pattern ( ($IsAlloc DatatypeTypeType (VarUnchanged.MState.x d@@61) (Tclass.Utils.Option (TSeq TChar)) $h@@25))
)))
...
(set-info :boogie-vc-id Impl$$VarUnchanged.__default.InductOp__Fail)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (VarUnchanged.__default.P__Fail |st#0@@11| |e1#0@@0|))) (=> (not (VarUnchanged.__default.P__Fail |st#0@@11| |e1#0@@0|)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|st1#1| T@U) (|v1#1@@0| Int) ) (!  (=> (and ($Is DatatypeTypeType |st1#1| Tclass.VarUnchanged.S) (VarUnchanged.__default.P__Succ |st#0@@11| |e1#0@@0| |st1#1| |v1#1@@0|)) (not (VarUnchanged.__default.P__Fail |st1#1| |e2#0@@0|)))
 :qid |Inductiondfy.120:20|
 :skolemid |833|
 :pattern ( (VarUnchanged.__default.P__Succ |st#0@@11| |e1#0@@0| |st1#1| |v1#1@@0|))
))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and (and ($Is DatatypeTypeType |st#0@@11| Tclass.VarUnchanged.S) ($IsAlloc DatatypeTypeType |st#0@@11| Tclass.VarUnchanged.S $Heap@@6)) (|$IsA#VarUnchanged.MState| |st#0@@11|)) (and (and ($Is DatatypeTypeType |e#0@@25| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@25| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@25|))) (and (and (and ($Is DatatypeTypeType |op#0@@2| Tclass.AST.BinOp) ($IsAlloc DatatypeTypeType |op#0@@2| Tclass.AST.BinOp $Heap@@6)) (|$IsA#AST.BinOp| |op#0@@2|)) (and (and ($Is DatatypeTypeType |e1#0@@0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e1#0@@0| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e1#0@@0|)))) (=> (and (and (and (and (and ($Is DatatypeTypeType |e2#0@@0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e2#0@@0| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e2#0@@0|)) (= 4 $FunctionContextHeight)) (and (AST.Expr__Raw.Op_q |e#0@@25|) (|AST.BinOp#Equal| (AST.Expr__Raw.op |e#0@@25|) |op#0@@2|))) (and (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.oe1 |e#0@@25|) |e1#0@@0|) (|AST.Expr__Raw#Equal| (AST.Expr__Raw.oe2 |e#0@@25|) |e2#0@@0|)) (and (not (VarUnchanged.__default.P__Fail |st#0@@11| |e#0@@25|)) (= (ControlFlow 0 4) 2)))) anon0_correct)))))
