...
(set-info :boogie-vc-id CheckWellFormed$$Induction.__default.InductSeq__Fail)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (and ($IsBox |st#0| Tclass.Induction.S) ($IsAllocBox |st#0| Tclass.Induction.S $Heap@@4))) (=> (and (and (and ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@8| Tclass.AST.Expr $Heap@@4)) (|$IsA#AST.Expr__Raw| |e#0@@8|)) (and (and ($Is SeqType |es#0@@0| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |es#0@@0| (TSeq Tclass.AST.Expr) $Heap@@4)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct))))
