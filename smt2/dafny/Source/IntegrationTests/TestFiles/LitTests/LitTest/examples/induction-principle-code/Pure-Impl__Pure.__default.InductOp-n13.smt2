...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|e#0@@5| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| (Lit DatatypeTypeType |st#0@@2|) (Lit DatatypeTypeType |e#0@@5|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@2| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@5| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@2|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@5|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@2|))))) (|Pure.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@2|) (Lit DatatypeTypeType |e#0@@5|))) (= (Pure.__default.P__Fail (Lit DatatypeTypeType |st#0@@2|) (Lit DatatypeTypeType |e#0@@5|)) (U_2_bool (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@5|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@2|)))))))
(Lit boolType (bool_2_U  (=> (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@2|) (Lit DatatypeTypeType |e#0@@5|)) (Utils.Result.Failure_q |res#2|)))))))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|e#0@@6| T@U) (|st'#0@@0| T@U) (|v#0@@0| Int) ) (!  (=> (or (|Pure.__default.P__Succ#canCall| (Lit DatatypeTypeType |st#0@@3|) (Lit DatatypeTypeType |e#0@@6|) (Lit DatatypeTypeType |st'#0@@0|) (LitInt |v#0@@0|)) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@3| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@6| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@0| Tclass.Pure.MState)))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@3|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@6|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@3|))))) (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@6|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@3|)))))))
 (and (|Pure.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@3|) (Lit DatatypeTypeType |e#0@@6|)) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@3|) (Lit DatatypeTypeType |e#0@@6|))))) (and (|Pure.__default.ResultSameState#canCall| TInt (Lit DatatypeTypeType |st#0@@3|) |res#2@@0|) (=> (Pure.__default.ResultSameState TInt (Lit DatatypeTypeType |st#0@@3|) |res#2@@0|) (and (and (|$IsA#Utils.Result| |res#2@@0|) (Pure.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|))) (=> (|Utils.Result#Equal| |res#2@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt |v#0@@0|))) ($Box MapType (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st'#0@@0|))))))))) (and (Pure.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|)) (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@3|))))))))))) (= (Pure.__default.P__Succ (Lit DatatypeTypeType |st#0@@3|) (Lit DatatypeTypeType |e#0@@6|) (Lit DatatypeTypeType |st'#0@@0|) (LitInt |v#0@@0|)) (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@6|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@3|)))))))
 (and (and (and (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@3|) (Lit DatatypeTypeType |e#0@@6|)) (Pure.__default.ResultSameState TInt (Lit DatatypeTypeType |st#0@@3|) |res#2@@1|)) (|Utils.Result#Equal| |res#2@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt |v#0@@0|))) ($Box MapType (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st'#0@@0|)))))))))) (|Set#Equal| (Pure.MState.locals (Lit DatatypeTypeType |st'#0@@0|)) (Pure.MState.locals (Lit DatatypeTypeType |st#0@@3|))))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |716|
 :pattern ( (Pure.__default.P__Succ (Lit DatatypeTypeType |st#0@@3|) (Lit DatatypeTypeType |e#0@@6|) (Lit DatatypeTypeType |st'#0@@0|) (LitInt |v#0@@0|)))
))))
...
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@7|)))
 (and (AST.Expr__Raw.All $ly@@3 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@3 |oe2#0| |p#0|)))) (let ((|es#0@@2| (AST.Expr__Raw.es |e#0@@7|)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((Pure._default.ResultSameState$V@@0 T@U) (|st#0@@6| T@U) (|res#0@@2| T@U) ) (!  (=> (or (|Pure.__default.ResultSameState#canCall| Pure._default.ResultSameState$V@@0 |st#0@@6| |res#0@@2|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.Pure.MState) ($Is DatatypeTypeType |res#0@@2| (Tclass.Utils.Result (Tclass._System.Tuple2 Pure._default.ResultSameState$V@@0 (TMap (TSeq TChar) TInt))))))) (and (and (and (Pure.MState.MState_q |st#0@@6|) (Pure.MState.MState_q |st#0@@6|)) (|Pure.__default.ResultSameCtx#canCall| Pure._default.ResultSameState$V@@0 (Pure.MState.locals |st#0@@6|) (Pure.MState.ctx |st#0@@6|) |res#0@@2|)) (= (Pure.__default.ResultSameState Pure._default.ResultSameState$V@@0 |st#0@@6| |res#0@@2|) (Pure.__default.ResultSameCtx Pure._default.ResultSameState$V@@0 (Pure.MState.locals |st#0@@6|) (Pure.MState.ctx |st#0@@6|) |res#0@@2|))))
 :qid |unknown.0:0|
 :skolemid |690|
 :pattern ( (Pure.__default.ResultSameState Pure._default.ResultSameState$V@@0 |st#0@@6| |res#0@@2|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|e#0@@16| T@U) (|st'#0@@1| T@U) (|v#0@@2| Int) ) (!  (=> (or (|Pure.__default.P__Succ#canCall| |st#0@@7| (Lit DatatypeTypeType |e#0@@16|) |st'#0@@1| |v#0@@2|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@7| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@16| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@1| Tclass.Pure.MState)))) (and (and (and (Pure.MState.MState_q |st#0@@7|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@16|) (Pure.MState.ctx |st#0@@7|))) (let ((|res#1@@0| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@16|) (Pure.MState.ctx |st#0@@7|))))
 (and (|Pure.__default.Pre#canCall| |st#0@@7| (Lit DatatypeTypeType |e#0@@16|)) (=> (Pure.__default.Pre |st#0@@7| (Lit DatatypeTypeType |e#0@@16|)) (and (|Pure.__default.ResultSameState#canCall| TInt |st#0@@7| |res#1@@0|) (=> (Pure.__default.ResultSameState TInt |st#0@@7| |res#1@@0|) (and (and (|$IsA#Utils.Result| |res#1@@0|) (Pure.MState.MState_q |st'#0@@1|)) (=> (|Utils.Result#Equal| |res#1@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0@@2|)) ($Box MapType (Pure.MState.ctx |st'#0@@1|)))))) (and (Pure.MState.MState_q |st'#0@@1|) (Pure.MState.MState_q |st#0@@7|)))))))))) (= (Pure.__default.P__Succ |st#0@@7| (Lit DatatypeTypeType |e#0@@16|) |st'#0@@1| |v#0@@2|) (let ((|res#1@@1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@16|) (Pure.MState.ctx |st#0@@7|))))
 (and (and (and (Pure.__default.Pre |st#0@@7| (Lit DatatypeTypeType |e#0@@16|)) (Pure.__default.ResultSameState TInt |st#0@@7| |res#1@@1|)) (|Utils.Result#Equal| |res#1@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0@@2|)) ($Box MapType (Pure.MState.ctx |st'#0@@1|))))))) (|Set#Equal| (Pure.MState.locals |st'#0@@1|) (Pure.MState.locals |st#0@@7|)))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |715|
 :pattern ( (Pure.__default.P__Succ |st#0@@7| (Lit DatatypeTypeType |e#0@@16|) |st'#0@@1| |v#0@@2|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|e#0@@17| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| |st#0@@8| |e#0@@17|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@8| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@17| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@8|) (|Interp.__default.InterpExpr#canCall| |e#0@@17| (Pure.MState.ctx |st#0@@8|))) (|Pure.__default.Pre#canCall| |st#0@@8| |e#0@@17|)) (= (Pure.__default.P__Fail |st#0@@8| |e#0@@17|) (let ((|res#0@@3| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@17| (Pure.MState.ctx |st#0@@8|))))
 (=> (Pure.__default.Pre |st#0@@8| |e#0@@17|) (Utils.Result.Failure_q |res#0@@3|))))))
 :qid |Inductiondfy.36:26|
 :skolemid |722|
 :pattern ( (Pure.__default.P__Fail |st#0@@8| |e#0@@17|))
))))
...
(set-info :boogie-vc-id Impl$$Pure.__default.InductOp__Fail)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#6| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (Pure.__default.P__Fail |st#0@@9| |e1#0@@0|))) (=> (not (Pure.__default.P__Fail |st#0@@9| |e1#0@@0|)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|st1#1| T@U) (|v1#1@@0| Int) ) (!  (=> (and ($Is DatatypeTypeType |st1#1| Tclass.Pure.MState) (Pure.__default.P__Succ |st#0@@9| |e1#0@@0| |st1#1| |v1#1@@0|)) (not (Pure.__default.P__Fail |st1#1| |e2#0@@0|)))
 :qid |Inductiondfy.120:20|
 :skolemid |819|
 :pattern ( (Pure.__default.P__Succ |st#0@@9| |e1#0@@0| |st1#1| |v1#1@@0|))
))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and (and ($Is DatatypeTypeType |st#0@@9| Tclass.Pure.MState) ($IsAlloc DatatypeTypeType |st#0@@9| Tclass.Pure.MState $Heap@@6)) (|$IsA#Pure.MState| |st#0@@9|)) (and (and ($Is DatatypeTypeType |e#0@@25| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@25| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@25|))) (and (and (and ($Is DatatypeTypeType |op#0@@2| Tclass.AST.BinOp) ($IsAlloc DatatypeTypeType |op#0@@2| Tclass.AST.BinOp $Heap@@6)) (|$IsA#AST.BinOp| |op#0@@2|)) (and (and ($Is DatatypeTypeType |e1#0@@0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e1#0@@0| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e1#0@@0|)))) (=> (and (and (and (and (and ($Is DatatypeTypeType |e2#0@@0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e2#0@@0| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e2#0@@0|)) (= 4 $FunctionContextHeight)) (and (AST.Expr__Raw.Op_q |e#0@@25|) (|AST.BinOp#Equal| (AST.Expr__Raw.op |e#0@@25|) |op#0@@2|))) (and (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.oe1 |e#0@@25|) |e1#0@@0|) (|AST.Expr__Raw#Equal| (AST.Expr__Raw.oe2 |e#0@@25|) |e2#0@@0|)) (and (not (Pure.__default.P__Fail |st#0@@9| |e#0@@25|)) (= (ControlFlow 0 4) 2)))) anon0_correct)))))
