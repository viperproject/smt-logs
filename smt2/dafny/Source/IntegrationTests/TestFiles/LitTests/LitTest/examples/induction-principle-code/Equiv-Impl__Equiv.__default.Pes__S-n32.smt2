...
(let ((|v#0@@1| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS $LZ) |e#0@@1| (Equiv.MState.ctx |st#0@@0|)))))))))
...
(|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#Equiv.MState.MState| |ctx1#0| |ctx1'#0|)) ($Box DatatypeTypeType (|#Equiv.MValue.MValue| |v#0@@1| |v'#0|))))))))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|e#0@@3| T@U) (|st'#0@@0| T@U) (|v#0@@2| T@U) ) (!  (=> (or (|Equiv.__default.P__Succ#canCall| (Lit DatatypeTypeType |st#0@@1|) (Lit DatatypeTypeType |e#0@@3|) (Lit DatatypeTypeType |st'#0@@0|) (Lit DatatypeTypeType |v#0@@2|)) (and (< 2 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@1| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@3| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@0| Tclass.Equiv.MState)) ($Is DatatypeTypeType |v#0@@2| Tclass.Equiv.MValue)))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@1|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@3|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@1|))))) (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@3|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@1|)))))))
 ...
 (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@1|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@1|))))) (and (|Equiv.__default.EqResult#canCall| |res#2| |res'#2|) (=> (Equiv.__default.EqResult |res#2| |res'#2|) (and (and (|$IsA#Utils.Result| |res#2|) (and (Equiv.MValue.MValue_q (Lit DatatypeTypeType |v#0@@2|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|)))) (=> (|Utils.Result#Equal| |res#2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt (Equiv.MValue.v (Lit DatatypeTypeType |v#0@@2|))))) ($Box MapType (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st'#0@@0|))))))))) (and (|$IsA#Utils.Result| |res'#2|) (and (Equiv.MValue.MValue_q (Lit DatatypeTypeType |v#0@@2|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|)))))))))))))) (= (Equiv.__default.P__Succ (Lit DatatypeTypeType |st#0@@1|) (Lit DatatypeTypeType |e#0@@3|) (Lit DatatypeTypeType |st'#0@@0|) (Lit DatatypeTypeType |v#0@@2|)) (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@3|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@1|)))))))
(let ((|res'#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@3|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@1|)))))))
 (and (and (and (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@1|)) (Equiv.__default.EqResult |res#2@@0| |res'#2@@0|)) (|Utils.Result#Equal| |res#2@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt (Equiv.MValue.v (Lit DatatypeTypeType |v#0@@2|))))) ($Box MapType (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st'#0@@0|)))))))))) (|Utils.Result#Equal| |res'#2@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt (Equiv.MValue.v_k (Lit DatatypeTypeType |v#0@@2|))))) ($Box MapType (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st'#0@@0|)))))))))))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |699|
 :pattern ( (Equiv.__default.P__Succ (Lit DatatypeTypeType |st#0@@1|) (Lit DatatypeTypeType |e#0@@3|) (Lit DatatypeTypeType |st'#0@@0|) (Lit DatatypeTypeType |v#0@@2|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|es#0@@0| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Step#canCall| |st#0@@2| |es#0@@0|) (and (< 4 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@2| Tclass.Equiv.MState) ($Is SeqType |es#0@@0| (TSeq Tclass.AST.Expr))) (and (Equiv.__default.Pes |st#0@@2| |es#0@@0|) (not (Equiv.__default.Pes__Fail |st#0@@2| |es#0@@0|)))))) (and (and (and (Equiv.MState.MState_q |st#0@@2|) (|Interp.__default.InterpExprs#canCall| |es#0@@0| (Equiv.MState.ctx |st#0@@2|))) (and (Equiv.MState.MState_q |st#0@@2|) (|Interp.__default.InterpExprs#canCall| |es#0@@0| (Equiv.MState.ctx_k |st#0@@2|)))) (= (Equiv.__default.Pes__Step |st#0@@2| |es#0@@0|) (let ((|ctx1#0@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs ($LS $LZ) |es#0@@0| (Equiv.MState.ctx |st#0@@2|))))))))
(let ((|vs#0@@1| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs ($LS $LZ) |es#0@@0| (Equiv.MState.ctx |st#0@@2|))))))))
(let ((|ctx1'#0@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs ($LS $LZ) |es#0@@0| (Equiv.MState.ctx_k |st#0@@2|))))))))
(let ((|vs'#0| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs ($LS $LZ) |es#0@@0| (Equiv.MState.ctx_k |st#0@@2|))))))))
(|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#Equiv.MState.MState| |ctx1#0@@0| |ctx1'#0@@0|)) ($Box DatatypeTypeType (|#Equiv.MSeqValue.MSeqValue| |vs#0@@1| |vs'#0|))))))))))
 :qid |Inductiondfy.71:27|
 :skolemid |801|
 :pattern ( (Equiv.__default.Pes__Step |st#0@@2| |es#0@@0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|e#0@@4| T@U) ) (!  (=> (or (|Equiv.__default.P#canCall| |st#0@@3| (Lit DatatypeTypeType |e#0@@4|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@3| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@4| Tclass.AST.Expr)))) (and (and (and (Equiv.MState.MState_q |st#0@@3|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@4|) (Equiv.MState.ctx |st#0@@3|))) (let ((|res#1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@4|) (Equiv.MState.ctx |st#0@@3|))))
 (and (and (Equiv.MState.MState_q |st#0@@3|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@4|) (Equiv.MState.ctx_k |st#0@@3|))) (let ((|res'#1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@4|) (Equiv.MState.ctx_k |st#0@@3|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@3|) (=> (Equiv.__default.Inv |st#0@@3|) (|Equiv.__default.EqResult#canCall| |res#1| |res'#1|))))))) (= (Equiv.__default.P |st#0@@3| (Lit DatatypeTypeType |e#0@@4|)) (let ((|res#1@@0| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@4|) (Equiv.MState.ctx |st#0@@3|))))
(let ((|res'#1@@0| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@4|) (Equiv.MState.ctx_k |st#0@@3|))))
 (=> (Equiv.__default.Inv |st#0@@3|) (Equiv.__default.EqResult |res#1@@0| |res'#1@@0|)))))))
 :qid |Inductiondfy.34:21|
 :weight 3
 :skolemid |689|
 :pattern ( (Equiv.__default.P |st#0@@3| (Lit DatatypeTypeType |e#0@@4|)))
))))
...
(let ((|v#0@@3| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|)))))))))))
 (and (Equiv.__default.EqValue |v#0@@3| |v'#0@@0|) (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#0@@0| |ctx'#0|)))))) false) true))))
 :qid |Equivdfy.33:28|
 :skolemid |667|
...
(let ((|ctx2#0| (|Map#Merge| |ctx1#0@@1| |bindings#0|)))
...
(let ((|ctx4#0| (|Map#Merge| |ctx1#0@@1| (|Map#Subtract| |ctx3#0| (|Set#FromBoogieMap| (|lambda#9| (TSeq TChar) |bvars#0@@0|))))))
...
(let ((|valueOrError6#0| (Interp.__default.InterpExprs $ly@@0 |es#0@@1| |ctx#0@@1|)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|es#0@@2| T@U) ) (!  (=> (or (|Equiv.__default.Pes#canCall| |st#0@@4| (Lit SeqType |es#0@@2|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@4| Tclass.Equiv.MState) ($Is SeqType |es#0@@2| (TSeq Tclass.AST.Expr))))) (and (and (and (Equiv.MState.MState_q |st#0@@4|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@2|) (Equiv.MState.ctx |st#0@@4|))) (let ((|res#1@@1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@2|) (Equiv.MState.ctx |st#0@@4|))))
 (and (and (Equiv.MState.MState_q |st#0@@4|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@2|) (Equiv.MState.ctx_k |st#0@@4|))) (let ((|res'#1@@1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@2|) (Equiv.MState.ctx_k |st#0@@4|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@4|) (=> (Equiv.__default.Inv |st#0@@4|) (|Equiv.__default.EqResultSeq#canCall| |res#1@@1| |res'#1@@1|))))))) (= (Equiv.__default.Pes |st#0@@4| (Lit SeqType |es#0@@2|)) (let ((|res#1@@2| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@2|) (Equiv.MState.ctx |st#0@@4|))))
(let ((|res'#1@@2| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@2|) (Equiv.MState.ctx_k |st#0@@4|))))
 (=> (Equiv.__default.Inv |st#0@@4|) (Equiv.__default.EqResultSeq |res#1@@2| |res'#1@@2|)))))))
 :qid |Inductiondfy.39:23|
 :weight 3
 :skolemid |714|
 :pattern ( (Equiv.__default.Pes |st#0@@4| (Lit SeqType |es#0@@2|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|e#0@@6| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| |st#0@@6| |e#0@@6|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@6| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@6|) (=> (Equiv.__default.Inv |st#0@@6|) (and (Equiv.MState.MState_q |st#0@@6|) (|Interp.__default.InterpExpr#canCall| |e#0@@6| (Equiv.MState.ctx |st#0@@6|))))) (= (Equiv.__default.P__Fail |st#0@@6| |e#0@@6|)  (=> (Equiv.__default.Inv |st#0@@6|) (Utils.Result.Failure_q (Interp.__default.InterpExpr ($LS $LZ) |e#0@@6| (Equiv.MState.ctx |st#0@@6|)))))))
 :qid |Inductiondfy.36:26|
 :skolemid |706|
 :pattern ( (Equiv.__default.P__Fail |st#0@@6| |e#0@@6|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|e#0@@7| T@U) (|st'#0@@1| T@U) (|v#0@@4| T@U) ) (!  (=> (or (|Equiv.__default.P__Succ#canCall| |st#0@@7| (Lit DatatypeTypeType |e#0@@7|) |st'#0@@1| |v#0@@4|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@7| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@7| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@1| Tclass.Equiv.MState)) ($Is DatatypeTypeType |v#0@@4| Tclass.Equiv.MValue)))) (and (and (and (Equiv.MState.MState_q |st#0@@7|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@7|) (Equiv.MState.ctx |st#0@@7|))) (let ((|res#1@@3| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@7|) (Equiv.MState.ctx |st#0@@7|))))
 (and (and (Equiv.MState.MState_q |st#0@@7|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@7|) (Equiv.MState.ctx_k |st#0@@7|))) (let ((|res'#1@@3| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@7|) (Equiv.MState.ctx_k |st#0@@7|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@7|) (=> (Equiv.__default.Inv |st#0@@7|) (and (|Equiv.__default.EqResult#canCall| |res#1@@3| |res'#1@@3|) (=> (Equiv.__default.EqResult |res#1@@3| |res'#1@@3|) (and (and (|$IsA#Utils.Result| |res#1@@3|) (and (Equiv.MValue.MValue_q |v#0@@4|) (Equiv.MState.MState_q |st'#0@@1|))) (=> (|Utils.Result#Equal| |res#1@@3| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v |v#0@@4|))) ($Box MapType (Equiv.MState.ctx |st'#0@@1|)))))) (and (|$IsA#Utils.Result| |res'#1@@3|) (and (Equiv.MValue.MValue_q |v#0@@4|) (Equiv.MState.MState_q |st'#0@@1|))))))))))))) (= (Equiv.__default.P__Succ |st#0@@7| (Lit DatatypeTypeType |e#0@@7|) |st'#0@@1| |v#0@@4|) (let ((|res#1@@4| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@7|) (Equiv.MState.ctx |st#0@@7|))))
(let ((|res'#1@@4| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@7|) (Equiv.MState.ctx_k |st#0@@7|))))
 (and (and (and (Equiv.__default.Inv |st#0@@7|) (Equiv.__default.EqResult |res#1@@4| |res'#1@@4|)) (|Utils.Result#Equal| |res#1@@4| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v |v#0@@4|))) ($Box MapType (Equiv.MState.ctx |st'#0@@1|))))))) (|Utils.Result#Equal| |res'#1@@4| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v_k |v#0@@4|))) ($Box MapType (Equiv.MState.ctx_k |st'#0@@1|))))))))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |698|
 :pattern ( (Equiv.__default.P__Succ |st#0@@7| (Lit DatatypeTypeType |e#0@@7|) |st'#0@@1| |v#0@@4|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|es#0@@3| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Fail#canCall| |st#0@@8| |es#0@@3|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@8| Tclass.Equiv.MState) ($Is SeqType |es#0@@3| (TSeq Tclass.AST.Expr))))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@8|) (=> (Equiv.__default.Inv |st#0@@8|) (and (Equiv.MState.MState_q |st#0@@8|) (|Interp.__default.InterpExprs#canCall| |es#0@@3| (Equiv.MState.ctx |st#0@@8|))))) (= (Equiv.__default.Pes__Fail |st#0@@8| |es#0@@3|)  (=> (Equiv.__default.Inv |st#0@@8|) (Utils.Result.Failure_q (Interp.__default.InterpExprs ($LS $LZ) |es#0@@3| (Equiv.MState.ctx |st#0@@8|)))))))
 :qid |Inductiondfy.41:28|
 :skolemid |732|
 :pattern ( (Equiv.__default.Pes__Fail |st#0@@8| |es#0@@3|))
))))
...
(assert (forall ((d@@26 T@U) ) (!  (=> (Equiv.MSeqValue.MSeqValue_q d@@26) (exists ((|a#17#0#0| T@U) (|a#17#1#0| T@U) ) (! (= d@@26 (|#Equiv.MSeqValue.MSeqValue| |a#17#0#0| |a#17#1#0|))
 :qid |Equivdfy.64:34|
 :skolemid |921|
)))
 :qid |unknown.0:0|
 :skolemid |922|
 :pattern ( (Equiv.MSeqValue.MSeqValue_q d@@26))
)))
(assert (forall ((d@@27 T@U) ) (!  (=> (AST.Expr__Raw.Assign_q d@@27) (exists ((|a#47#0#0| T@U) (|a#47#1#0| T@U) ) (! (= d@@27 (|#AST.Expr_Raw.Assign| |a#47#0#0| |a#47#1#0|))
 :qid |ASTdfy.18:14|
 :skolemid |1064|
)))
 :qid |unknown.0:0|
 :skolemid |1065|
 :pattern ( (AST.Expr__Raw.Assign_q d@@27))
)))
...
(assert (forall ((d@@28 T@U) ) (!  (=> (Utils.Result.Failure_q d@@28) (= d@@28 |#Utils.Result.Failure|))
 :qid |unknown.0:0|
 :skolemid |970|
 :pattern ( (Utils.Result.Failure_q d@@28))
)))
(assert (forall ((d@@29 T@U) ) (!  (=> (AST.BinOp.Add_q d@@29) (= d@@29 |#AST.BinOp.Add|))
 :qid |unknown.0:0|
 :skolemid |1015|
 :pattern ( (AST.BinOp.Add_q d@@29))
)))
(assert (forall ((d@@30 T@U) ) (!  (=> (AST.BinOp.Sub_q d@@30) (= d@@30 |#AST.BinOp.Sub|))
 :qid |unknown.0:0|
 :skolemid |1017|
 :pattern ( (AST.BinOp.Sub_q d@@30))
)))
(assert (forall ((d@@31 T@U) ) (!  (=> (AST.BinOp.Mul_q d@@31) (= d@@31 |#AST.BinOp.Mul|))
 :qid |unknown.0:0|
 :skolemid |1019|
 :pattern ( (AST.BinOp.Mul_q d@@31))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|v#0@@5| T@U) (|vs#0@@3| T@U) ) (!  (=> (or (|Equiv.__default.AppendValue#canCall| |v#0@@5| |vs#0@@3|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |v#0@@5| Tclass.Equiv.MValue) ($Is DatatypeTypeType |vs#0@@3| Tclass.Equiv.VS)))) (and (and (and (Equiv.MValue.MValue_q |v#0@@5|) (Equiv.MSeqValue.MSeqValue_q |vs#0@@3|)) (and (Equiv.MValue.MValue_q |v#0@@5|) (Equiv.MSeqValue.MSeqValue_q |vs#0@@3|))) (= (Equiv.__default.AppendValue |v#0@@5| |vs#0@@3|) (|#Equiv.MSeqValue.MSeqValue| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (Equiv.MValue.v |v#0@@5|)))) (Equiv.MSeqValue.vs |vs#0@@3|)) (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (Equiv.MValue.v_k |v#0@@5|)))) (Equiv.MSeqValue.vs_k |vs#0@@3|))))))
 :qid |Inductiondfy.43:30|
 :skolemid |739|
 :pattern ( (Equiv.__default.AppendValue |v#0@@5| |vs#0@@3|))
))))
...
(assert (forall ((d@@32 T@U) ) (!  (=> (Utils.Result.Success_q d@@32) (exists ((|a#1#0#0@@1| T@U) ) (! (= d@@32 (|#Utils.Result.Success| |a#1#0#0@@1|))
 :qid |Utilsdfy.23:34|
 :skolemid |961|
)))
 :qid |unknown.0:0|
 :skolemid |962|
 :pattern ( (Utils.Result.Success_q d@@32))
)))
(assert (forall ((d@@33 T@U) ) (!  (=> (AST.Expr__Raw.Var_q d@@33) (exists ((|a#23#0#0| T@U) ) (! (= d@@33 (|#AST.Expr_Raw.Var| |a#23#0#0|))
 :qid |ASTdfy.15:11|
 :skolemid |1029|
)))
 :qid |unknown.0:0|
 :skolemid |1030|
 :pattern ( (AST.Expr__Raw.Var_q d@@33))
)))
(assert (forall ((d@@34 T@U) ) (!  (=> (AST.Expr__Raw.Literal_q d@@34) (exists ((|a#30#0#0| Int) ) (! (= d@@34 (|#AST.Expr_Raw.Literal| |a#30#0#0|))
 :qid |ASTdfy.16:15|
 :skolemid |1039|
)))
 :qid |unknown.0:0|
 :skolemid |1040|
 :pattern ( (AST.Expr__Raw.Literal_q d@@34))
)))
(assert (forall ((d@@35 T@U) ) (!  (=> (AST.Expr__Raw.Seq_q d@@35) (exists ((|a#77#0#0| T@U) ) (! (= d@@35 (|#AST.Expr_Raw.Seq| |a#77#0#0|))
 :qid |ASTdfy.21:11|
 :skolemid |1108|
)))
 :qid |unknown.0:0|
 :skolemid |1109|
 :pattern ( (AST.Expr__Raw.Seq_q d@@35))
)))
(assert (forall ((d@@36 T@U) ) (!  (=> ($Is DatatypeTypeType d@@36 Tclass.AST.Expr__Raw) (or (or (or (or (or (or (AST.Expr__Raw.Var_q d@@36) (AST.Expr__Raw.Literal_q d@@36)) (AST.Expr__Raw.Bind_q d@@36)) (AST.Expr__Raw.Assign_q d@@36)) (AST.Expr__Raw.If_q d@@36)) (AST.Expr__Raw.Op_q d@@36)) (AST.Expr__Raw.Seq_q d@@36)))
 :qid |unknown.0:0|
 :skolemid |1118|
 :pattern ( (AST.Expr__Raw.Seq_q d@@36) ($Is DatatypeTypeType d@@36 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Op_q d@@36) ($Is DatatypeTypeType d@@36 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.If_q d@@36) ($Is DatatypeTypeType d@@36 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Assign_q d@@36) ($Is DatatypeTypeType d@@36 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Bind_q d@@36) ($Is DatatypeTypeType d@@36 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Literal_q d@@36) ($Is DatatypeTypeType d@@36 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Var_q d@@36) ($Is DatatypeTypeType d@@36 Tclass.AST.Expr__Raw))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0@@9| T@U) ) (!  (=> (or (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@9|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |st#0@@9| Tclass.Equiv.MState))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@9|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@9|))) (|Equiv.__default.EqCtx#canCall| (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@9|))) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@9|)))))) (= (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@9|))  (and true (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@9|))) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@9|))))))))
 :qid |Equivdfy.72:23|
 :weight 3
 :skolemid |683|
 :pattern ( (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@9|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@10| T@U) (|e#0@@11| T@U) ) (!  (=> (or (|Equiv.__default.P__Step#canCall| (Lit DatatypeTypeType |st#0@@10|) (Lit DatatypeTypeType |e#0@@11|)) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@10| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@11| Tclass.AST.Expr)) (and (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.P (Lit DatatypeTypeType |st#0@@10|) (Lit DatatypeTypeType |e#0@@11|))))) (not (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.P__Fail (Lit DatatypeTypeType |st#0@@10|) (Lit DatatypeTypeType |e#0@@11|)))))))))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@10|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@11|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@10|))))) (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@10|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@11|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@10|)))))) (= (Equiv.__default.P__Step (Lit DatatypeTypeType |st#0@@10|) (Lit DatatypeTypeType |e#0@@11|)) (let ((|ctx1#2@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@11|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@10|)))))))))))
(let ((|v#2@@0| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@11|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@10|))))))))))))
(let ((|ctx1'#2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@11|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@10|)))))))))))
(let ((|v'#2| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@11|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@10|))))))))))))
(|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#Equiv.MState.MState| |ctx1#2@@2| |ctx1'#2|)) ($Box DatatypeTypeType (|#Equiv.MValue.MValue| |v#2@@0| |v'#2|))))))))))
 ...
 :weight 3
 :skolemid |794|
 :pattern ( (Equiv.__default.P__Step (Lit DatatypeTypeType |st#0@@10|) (Lit DatatypeTypeType |e#0@@11|)))
))))
...
(assert (forall (($ly@@6 T@U) (|es#0@@6| T@U) (|ctx#0@@6| T@U) ) (! (= (Interp.__default.InterpExprs ($LS $ly@@6) |es#0@@6| |ctx#0@@6|) (Interp.__default.InterpExprs $ly@@6 |es#0@@6| |ctx#0@@6|))
 :qid |Interpdfy.69:12|
 :skolemid |1203|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@6) |es#0@@6| |ctx#0@@6|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@11| T@U) (|e#0@@14| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| |st#0@@11| (Lit DatatypeTypeType |e#0@@14|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@11| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@14| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@11|) (=> (Equiv.__default.Inv |st#0@@11|) (and (Equiv.MState.MState_q |st#0@@11|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@14|) (Equiv.MState.ctx |st#0@@11|))))) (= (Equiv.__default.P__Fail |st#0@@11| (Lit DatatypeTypeType |e#0@@14|))  (=> (Equiv.__default.Inv |st#0@@11|) (Utils.Result.Failure_q (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@14|) (Equiv.MState.ctx |st#0@@11|)))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |707|
 :pattern ( (Equiv.__default.P__Fail |st#0@@11| (Lit DatatypeTypeType |e#0@@14|)))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@12| T@U) (|es#0@@7| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Step#canCall| (Lit DatatypeTypeType |st#0@@12|) (Lit SeqType |es#0@@7|)) (and (< 4 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@12| Tclass.Equiv.MState) ($Is SeqType |es#0@@7| (TSeq Tclass.AST.Expr))) (and (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Pes (Lit DatatypeTypeType |st#0@@12|) (Lit SeqType |es#0@@7|))))) (not (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@12|) (Lit SeqType |es#0@@7|)))))))))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@12|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@7|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@12|))))) (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@12|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@7|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@12|)))))) (= (Equiv.__default.Pes__Step (Lit DatatypeTypeType |st#0@@12|) (Lit SeqType |es#0@@7|)) (let ((|ctx1#2@@3| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@7|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@12|)))))))))))
(let ((|vs#2@@2| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@7|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@12|)))))))))))
(let ((|ctx1'#2@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@7|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@12|)))))))))))
(let ((|vs'#2@@0| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@7|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@12|)))))))))))
(|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#Equiv.MState.MState| |ctx1#2@@3| |ctx1'#2@@0|)) ($Box DatatypeTypeType (|#Equiv.MSeqValue.MSeqValue| |vs#2@@2| |vs'#2@@0|))))))))))
 ...
 :weight 3
 :skolemid |803|
 :pattern ( (Equiv.__default.Pes__Step (Lit DatatypeTypeType |st#0@@12|) (Lit SeqType |es#0@@7|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@13| T@U) (|es#0@@8| T@U) (|st'#0@@2| T@U) (|vs#0@@4| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Succ#canCall| |st#0@@13| |es#0@@8| |st'#0@@2| |vs#0@@4|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@13| Tclass.Equiv.MState) ($Is SeqType |es#0@@8| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@2| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#0@@4| Tclass.Equiv.VS)))) (and (and (and (Equiv.MState.MState_q |st#0@@13|) (|Interp.__default.InterpExprs#canCall| |es#0@@8| (Equiv.MState.ctx |st#0@@13|))) (let ((|res#0@@3| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@8| (Equiv.MState.ctx |st#0@@13|))))
 (and (and (Equiv.MState.MState_q |st#0@@13|) (|Interp.__default.InterpExprs#canCall| |es#0@@8| (Equiv.MState.ctx_k |st#0@@13|))) (let ((|res'#0@@3| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@8| (Equiv.MState.ctx_k |st#0@@13|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@13|) (=> (Equiv.__default.Inv |st#0@@13|) (and (|Equiv.__default.EqResultSeq#canCall| |res#0@@3| |res'#0@@3|) (=> (Equiv.__default.EqResultSeq |res#0@@3| |res'#0@@3|) (and (and (|$IsA#Utils.Result| |res#0@@3|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@4|) (Equiv.MState.MState_q |st'#0@@2|))) (=> (|Utils.Result#Equal| |res#0@@3| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@4|)) ($Box MapType (Equiv.MState.ctx |st'#0@@2|)))))) (and (|$IsA#Utils.Result| |res'#0@@3|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@4|) (Equiv.MState.MState_q |st'#0@@2|))))))))))))) (= (Equiv.__default.Pes__Succ |st#0@@13| |es#0@@8| |st'#0@@2| |vs#0@@4|) (let ((|res#0@@4| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@8| (Equiv.MState.ctx |st#0@@13|))))
(let ((|res'#0@@4| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@8| (Equiv.MState.ctx_k |st#0@@13|))))
 (and (and (and (Equiv.__default.Inv |st#0@@13|) (Equiv.__default.EqResultSeq |res#0@@4| |res'#0@@4|)) (|Utils.Result#Equal| |res#0@@4| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@4|)) ($Box MapType (Equiv.MState.ctx |st'#0@@2|))))))) (|Utils.Result#Equal| |res'#0@@4| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs_k |vs#0@@4|)) ($Box MapType (Equiv.MState.ctx_k |st'#0@@2|))))))))))))
 :qid |Inductiondfy.40:28|
 :skolemid |723|
 :pattern ( (Equiv.__default.Pes__Succ |st#0@@13| |es#0@@8| |st'#0@@2| |vs#0@@4|))
))))
...
(assert (forall (($ly@@9 T@U) (|es#0@@9| T@U) (|ctx#0@@8| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@9| |ctx#0@@8|) (and ($Is SeqType |es#0@@9| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@8| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@9| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@9| (LitInt 0))) |ctx#0@@8|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@9 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@9| (LitInt 0))) |ctx#0@@8|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (|Seq#Drop| |es#0@@9| (LitInt 1)) |ctx1#0@@2|) (let ((|valueOrError1#0@@0| (Interp.__default.InterpExprs $ly@@9 (|Seq#Drop| |es#0@@9| (LitInt 1)) |ctx1#0@@2|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@9) |es#0@@9| |ctx#0@@8|) (ite (|Seq#Equal| |es#0@@9| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@8|)))) (let ((|valueOrError0#0@@1| (Interp.__default.InterpExpr $ly@@9 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@9| (LitInt 0))) |ctx#0@@8|)))
...
(let ((|valueOrError1#0@@1| (Interp.__default.InterpExprs $ly@@9 (|Seq#Drop| |es#0@@9| (LitInt 1)) |ctx1#0@@3|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0@@6|))) |vs#0@@5|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1207|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@9) |es#0@@9| |ctx#0@@8|))
)))
(assert (forall ((d@@37 T@U) ) (!  (=> (|$IsA#Utils.Result| d@@37) (or (Utils.Result.Success_q d@@37) (Utils.Result.Failure_q d@@37)))
 :qid |unknown.0:0|
 :skolemid |973|
 :pattern ( (|$IsA#Utils.Result| d@@37))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@14| T@U) (|es#0@@10| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Fail#canCall| |st#0@@14| (Lit SeqType |es#0@@10|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@14| Tclass.Equiv.MState) ($Is SeqType |es#0@@10| (TSeq Tclass.AST.Expr))))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@14|) (=> (Equiv.__default.Inv |st#0@@14|) (and (Equiv.MState.MState_q |st#0@@14|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@10|) (Equiv.MState.ctx |st#0@@14|))))) (= (Equiv.__default.Pes__Fail |st#0@@14| (Lit SeqType |es#0@@10|))  (=> (Equiv.__default.Inv |st#0@@14|) (Utils.Result.Failure_q (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@10|) (Equiv.MState.ctx |st#0@@14|)))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |733|
 :pattern ( (Equiv.__default.Pes__Fail |st#0@@14| (Lit SeqType |es#0@@10|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@15| T@U) (|es#0@@11| T@U) (|st'#0@@3| T@U) (|vs#0@@6| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Succ#canCall| (Lit DatatypeTypeType |st#0@@15|) (Lit SeqType |es#0@@11|) (Lit DatatypeTypeType |st'#0@@3|) (Lit DatatypeTypeType |vs#0@@6|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@15| Tclass.Equiv.MState) ($Is SeqType |es#0@@11| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@3| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#0@@6| Tclass.Equiv.VS)))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@15|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@11|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@15|))))) (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@15|)))))))
 (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@15|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@11|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@15|))))) (let ((|res'#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@15|)))))))
 (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@15|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@15|))))) (and (|Equiv.__default.EqResultSeq#canCall| |res#2@@1| |res'#2@@1|) (=> (Equiv.__default.EqResultSeq |res#2@@1| |res'#2@@1|) (and (and (|$IsA#Utils.Result| |res#2@@1|) (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |vs#0@@6|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st'#0@@3|)))) (=> (|Utils.Result#Equal| |res#2@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |vs#0@@6|)))) ($Box MapType (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st'#0@@3|))))))))) (and (|$IsA#Utils.Result| |res'#2@@1|) (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |vs#0@@6|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st'#0@@3|)))))))))))))) (= (Equiv.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@15|) (Lit SeqType |es#0@@11|) (Lit DatatypeTypeType |st'#0@@3|) (Lit DatatypeTypeType |vs#0@@6|)) (let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@15|)))))))
(let ((|res'#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@15|)))))))
 (and (and (and (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@15|)) (Equiv.__default.EqResultSeq |res#2@@2| |res'#2@@2|)) (|Utils.Result#Equal| |res#2@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |vs#0@@6|)))) ($Box MapType (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st'#0@@3|)))))))))) (|Utils.Result#Equal| |res'#2@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType (Equiv.MSeqValue.vs_k (Lit DatatypeTypeType |vs#0@@6|)))) ($Box MapType (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st'#0@@3|)))))))))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |725|
 :pattern ( (Equiv.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@15|) (Lit SeqType |es#0@@11|) (Lit DatatypeTypeType |st'#0@@3|) (Lit DatatypeTypeType |vs#0@@6|)))
))))
...
(assert (forall (($ly@@10 T@U) (|es#0@@12| T@U) (|ctx#0@@9| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@12|) |ctx#0@@9|) (and ($Is SeqType |es#0@@12| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@9| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@12| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@12|) (LitInt 0))) |ctx#0@@9|) (let ((|valueOrError0#1@@0| (Interp.__default.InterpExpr ($LS $ly@@10) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@12|) (LitInt 0))) |ctx#0@@9|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType |es#0@@12|) |ctx#0@@9|) (ite (|Seq#Equal| |es#0@@12| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@9|)))) (let ((|valueOrError0#1@@1| (Interp.__default.InterpExpr ($LS $ly@@10) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@12|) (LitInt 0))) |ctx#0@@9|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#1@@0|))) |vs#1@@0|)) ($Box MapType |ctx2#1@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |1208|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType |es#0@@12|) |ctx#0@@9|))
)))
...
(let ((|vs#0@@7| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@6|) ($Box DatatypeTypeType |res'#0@@6|))))))))))
 (and (Equiv.__default.EqSeqValue |vs#0@@7| |vs'#0@@0|) (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#0@@10| |ctx'#0@@2|)))))) false) true))))
 :qid |Equivdfy.45:31|
 :skolemid |673|
 :pattern ( (Equiv.__default.EqResultSeq |res#0@@6| |res'#0@@6|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@16| T@U) (|e#0@@15| T@U) ) (!  (=> (or (|Equiv.__default.P#canCall| |st#0@@16| |e#0@@15|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@16| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr)))) (and (and (and (Equiv.MState.MState_q |st#0@@16|) (|Interp.__default.InterpExpr#canCall| |e#0@@15| (Equiv.MState.ctx |st#0@@16|))) (let ((|res#0@@7| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@15| (Equiv.MState.ctx |st#0@@16|))))
 (and (and (Equiv.MState.MState_q |st#0@@16|) (|Interp.__default.InterpExpr#canCall| |e#0@@15| (Equiv.MState.ctx_k |st#0@@16|))) (let ((|res'#0@@7| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@15| (Equiv.MState.ctx_k |st#0@@16|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@16|) (=> (Equiv.__default.Inv |st#0@@16|) (|Equiv.__default.EqResult#canCall| |res#0@@7| |res'#0@@7|))))))) (= (Equiv.__default.P |st#0@@16| |e#0@@15|) (let ((|res#0@@8| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@15| (Equiv.MState.ctx |st#0@@16|))))
(let ((|res'#0@@8| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@15| (Equiv.MState.ctx_k |st#0@@16|))))
 (=> (Equiv.__default.Inv |st#0@@16|) (Equiv.__default.EqResult |res#0@@8| |res'#0@@8|)))))))
 :qid |Inductiondfy.34:21|
 :skolemid |688|
 :pattern ( (Equiv.__default.P |st#0@@16| |e#0@@15|))
))))
...
(Lit DatatypeTypeType (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#4|)) ($Box MapType (Lit MapType |ctx#0@@11|)))))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|body#4| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@17|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1202|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@11) (Lit DatatypeTypeType |e#0@@17|) (Lit MapType |ctx#0@@11|)))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@17| T@U) (|es#0@@13| T@U) (|st'#0@@4| T@U) (|vs#0@@8| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Succ#canCall| |st#0@@17| (Lit SeqType |es#0@@13|) |st'#0@@4| |vs#0@@8|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@17| Tclass.Equiv.MState) ($Is SeqType |es#0@@13| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@4| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#0@@8| Tclass.Equiv.VS)))) (and (and (and (Equiv.MState.MState_q |st#0@@17|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@13|) (Equiv.MState.ctx |st#0@@17|))) (let ((|res#1@@5| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@13|) (Equiv.MState.ctx |st#0@@17|))))
 (and (and (Equiv.MState.MState_q |st#0@@17|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@13|) (Equiv.MState.ctx_k |st#0@@17|))) (let ((|res'#1@@5| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@13|) (Equiv.MState.ctx_k |st#0@@17|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@17|) (=> (Equiv.__default.Inv |st#0@@17|) (and (|Equiv.__default.EqResultSeq#canCall| |res#1@@5| |res'#1@@5|) (=> (Equiv.__default.EqResultSeq |res#1@@5| |res'#1@@5|) (and (and (|$IsA#Utils.Result| |res#1@@5|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@8|) (Equiv.MState.MState_q |st'#0@@4|))) (=> (|Utils.Result#Equal| |res#1@@5| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@8|)) ($Box MapType (Equiv.MState.ctx |st'#0@@4|)))))) (and (|$IsA#Utils.Result| |res'#1@@5|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@8|) (Equiv.MState.MState_q |st'#0@@4|))))))))))))) (= (Equiv.__default.Pes__Succ |st#0@@17| (Lit SeqType |es#0@@13|) |st'#0@@4| |vs#0@@8|) (let ((|res#1@@6| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@13|) (Equiv.MState.ctx |st#0@@17|))))
(let ((|res'#1@@6| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@13|) (Equiv.MState.ctx_k |st#0@@17|))))
 (and (and (and (Equiv.__default.Inv |st#0@@17|) (Equiv.__default.EqResultSeq |res#1@@6| |res'#1@@6|)) (|Utils.Result#Equal| |res#1@@6| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@8|)) ($Box MapType (Equiv.MState.ctx |st'#0@@4|))))))) (|Utils.Result#Equal| |res'#1@@6| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs_k |vs#0@@8|)) ($Box MapType (Equiv.MState.ctx_k |st'#0@@4|))))))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |724|
 :pattern ( (Equiv.__default.Pes__Succ |st#0@@17| (Lit SeqType |es#0@@13|) |st'#0@@4| |vs#0@@8|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@18| T@U) (|es#0@@14| T@U) ) (!  (=> (or (|Equiv.__default.Pes#canCall| |st#0@@18| |es#0@@14|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@18| Tclass.Equiv.MState) ($Is SeqType |es#0@@14| (TSeq Tclass.AST.Expr))))) (and (and (and (Equiv.MState.MState_q |st#0@@18|) (|Interp.__default.InterpExprs#canCall| |es#0@@14| (Equiv.MState.ctx |st#0@@18|))) (let ((|res#0@@9| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@14| (Equiv.MState.ctx |st#0@@18|))))
 (and (and (Equiv.MState.MState_q |st#0@@18|) (|Interp.__default.InterpExprs#canCall| |es#0@@14| (Equiv.MState.ctx_k |st#0@@18|))) (let ((|res'#0@@9| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@14| (Equiv.MState.ctx_k |st#0@@18|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@18|) (=> (Equiv.__default.Inv |st#0@@18|) (|Equiv.__default.EqResultSeq#canCall| |res#0@@9| |res'#0@@9|))))))) (= (Equiv.__default.Pes |st#0@@18| |es#0@@14|) (let ((|res#0@@10| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@14| (Equiv.MState.ctx |st#0@@18|))))
(let ((|res'#0@@10| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@14| (Equiv.MState.ctx_k |st#0@@18|))))
 (=> (Equiv.__default.Inv |st#0@@18|) (Equiv.__default.EqResultSeq |res#0@@10| |res'#0@@10|)))))))
 :qid |Inductiondfy.39:23|
 :skolemid |713|
 :pattern ( (Equiv.__default.Pes |st#0@@18| |es#0@@14|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@19| T@U) (|e#0@@18| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |e#0@@18|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@19| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@18| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@19|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@19|))))) (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@19|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@18|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@19|))))))) (= (Equiv.__default.P__Fail (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |e#0@@18|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@19|)) (Utils.Result.Failure_q (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@18|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@19|)))))))))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |708|
 :pattern ( (Equiv.__default.P__Fail (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |e#0@@18|)))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@20| T@U) (|e#0@@19| T@U) ) (!  (=> (or (|Equiv.__default.P__Step#canCall| |st#0@@20| (Lit DatatypeTypeType |e#0@@19|)) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@20| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@19| Tclass.AST.Expr)) (and (Equiv.__default.P |st#0@@20| (Lit DatatypeTypeType |e#0@@19|)) (not (Equiv.__default.P__Fail |st#0@@20| (Lit DatatypeTypeType |e#0@@19|))))))) (and (and (and (Equiv.MState.MState_q |st#0@@20|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@19|) (Equiv.MState.ctx |st#0@@20|))) (and (Equiv.MState.MState_q |st#0@@20|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@19|) (Equiv.MState.ctx_k |st#0@@20|)))) (= (Equiv.__default.P__Step |st#0@@20| (Lit DatatypeTypeType |e#0@@19|)) (let ((|ctx1#1@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@19|) (Equiv.MState.ctx |st#0@@20|))))))))
(let ((|v#1@@1| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@19|) (Equiv.MState.ctx |st#0@@20|)))))))))
(let ((|ctx1'#1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@19|) (Equiv.MState.ctx_k |st#0@@20|))))))))
(let ((|v'#1@@0| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@19|) (Equiv.MState.ctx_k |st#0@@20|)))))))))
(|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#Equiv.MState.MState| |ctx1#1@@2| |ctx1'#1|)) ($Box DatatypeTypeType (|#Equiv.MValue.MValue| |v#1@@1| |v'#1@@0|))))))))))
 ...
 :weight 3
 :skolemid |793|
 :pattern ( (Equiv.__default.P__Step |st#0@@20| (Lit DatatypeTypeType |e#0@@19|)))
))))
...
(assert (forall ((d@@39 T@U) (Utils.Result$T@@14 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (Utils.Result.Success_q d@@39) ($IsAlloc DatatypeTypeType d@@39 (Tclass.Utils.Result Utils.Result$T@@14) $h@@7))) ($IsAllocBox (Utils.Result.value d@@39) Utils.Result$T@@14 $h@@7))
 :qid |unknown.0:0|
 :skolemid |965|
 :pattern ( ($IsAllocBox (Utils.Result.value d@@39) Utils.Result$T@@14 $h@@7))
)))
...
(assert (forall ((d@@40 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (Equiv.MValue.MValue_q d@@40) ($IsAlloc DatatypeTypeType d@@40 Tclass.Equiv.MValue $h@@8))) ($IsAlloc intType (int_2_U (Equiv.MValue.v d@@40)) TInt $h@@8))
 :qid |unknown.0:0|
 :skolemid |909|
 :pattern ( ($IsAlloc intType (int_2_U (Equiv.MValue.v d@@40)) TInt $h@@8))
)))
(assert (forall ((d@@41 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) (and (Equiv.MValue.MValue_q d@@41) ($IsAlloc DatatypeTypeType d@@41 Tclass.Equiv.MValue $h@@9))) ($IsAlloc intType (int_2_U (Equiv.MValue.v_k d@@41)) TInt $h@@9))
 :qid |unknown.0:0|
 :skolemid |910|
 :pattern ( ($IsAlloc intType (int_2_U (Equiv.MValue.v_k d@@41)) TInt $h@@9))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@21| T@U) (|es#0@@15| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Step#canCall| |st#0@@21| (Lit SeqType |es#0@@15|)) (and (< 4 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@21| Tclass.Equiv.MState) ($Is SeqType |es#0@@15| (TSeq Tclass.AST.Expr))) (and (Equiv.__default.Pes |st#0@@21| (Lit SeqType |es#0@@15|)) (not (Equiv.__default.Pes__Fail |st#0@@21| (Lit SeqType |es#0@@15|))))))) (and (and (and (Equiv.MState.MState_q |st#0@@21|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@15|) (Equiv.MState.ctx |st#0@@21|))) (and (Equiv.MState.MState_q |st#0@@21|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@15|) (Equiv.MState.ctx_k |st#0@@21|)))) (= (Equiv.__default.Pes__Step |st#0@@21| (Lit SeqType |es#0@@15|)) (let ((|ctx1#1@@3| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@15|) (Equiv.MState.ctx |st#0@@21|))))))))
(let ((|vs#1@@2| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@15|) (Equiv.MState.ctx |st#0@@21|))))))))
(let ((|ctx1'#1@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@15|) (Equiv.MState.ctx_k |st#0@@21|))))))))
(let ((|vs'#1@@0| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@15|) (Equiv.MState.ctx_k |st#0@@21|))))))))
(|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#Equiv.MState.MState| |ctx1#1@@3| |ctx1'#1@@0|)) ($Box DatatypeTypeType (|#Equiv.MSeqValue.MSeqValue| |vs#1@@2| |vs'#1@@0|))))))))))
 :qid |Inductiondfy.71:27|
 :weight 3
 :skolemid |802|
 :pattern ( (Equiv.__default.Pes__Step |st#0@@21| (Lit SeqType |es#0@@15|)))
))))
...
(assert (forall ((|vs#0@@9| T@U) ) (! (= ($Is DatatypeTypeType |vs#0@@9| Tclass.Equiv.VS)  (and ($Is DatatypeTypeType |vs#0@@9| Tclass.Equiv.MSeqValue) (= (|Seq#Length| (Equiv.MSeqValue.vs |vs#0@@9|)) (|Seq#Length| (Equiv.MSeqValue.vs_k |vs#0@@9|)))))
 :qid |unknown.0:0|
 :skolemid |939|
 :pattern ( ($Is DatatypeTypeType |vs#0@@9| Tclass.Equiv.VS))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@22| T@U) (|es#0@@16| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Fail#canCall| (Lit DatatypeTypeType |st#0@@22|) (Lit SeqType |es#0@@16|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@22| Tclass.Equiv.MState) ($Is SeqType |es#0@@16| (TSeq Tclass.AST.Expr))))) (and (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@22|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@22|))))) (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@22|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@16|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@22|))))))) (= (Equiv.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@22|) (Lit SeqType |es#0@@16|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@22|)) (Utils.Result.Failure_q (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@16|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@22|)))))))))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |734|
 :pattern ( (Equiv.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@22|) (Lit SeqType |es#0@@16|)))
))))
(assert (forall (($ly@@13 T@U) (|e#0@@20| T@U) (|ctx#0@@12| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@20|) |ctx#0@@12|) (and ($Is DatatypeTypeType |e#0@@20| Tclass.AST.Expr) ($Is MapType |ctx#0@@12| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@20|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@20|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@20|))))) (let ((|body#3| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@20|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#3| |v1#3| |v2#3|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@20|)))))) (let ((|es#3| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@20|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#3|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@13) (Lit DatatypeTypeType |e#0@@20|) |ctx#0@@12|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@20|)) (let ((|name#2| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@20|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#2|)) ($Box MapType |ctx#0@@12|))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@20|)) (let ((|body#2| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@20|)))))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1201|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@13) (Lit DatatypeTypeType |e#0@@20|) |ctx#0@@12|))
)))
...
(assert (forall ((d@@45 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) ($Is DatatypeTypeType d@@45 Tclass.Equiv.MState)) ($IsAlloc DatatypeTypeType d@@45 Tclass.Equiv.MState $h@@11))
 :qid |unknown.0:0|
 :skolemid |899|
 :pattern ( ($IsAlloc DatatypeTypeType d@@45 Tclass.Equiv.MState $h@@11))
)))
(assert (forall ((d@@46 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) ($Is DatatypeTypeType d@@46 Tclass.Equiv.MValue)) ($IsAlloc DatatypeTypeType d@@46 Tclass.Equiv.MValue $h@@12))
 :qid |unknown.0:0|
 :skolemid |914|
 :pattern ( ($IsAlloc DatatypeTypeType d@@46 Tclass.Equiv.MValue $h@@12))
)))
(assert (forall ((d@@47 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) ($Is DatatypeTypeType d@@47 Tclass.Equiv.MSeqValue)) ($IsAlloc DatatypeTypeType d@@47 Tclass.Equiv.MSeqValue $h@@13))
 :qid |unknown.0:0|
 :skolemid |934|
 :pattern ( ($IsAlloc DatatypeTypeType d@@47 Tclass.Equiv.MSeqValue $h@@13))
)))
(assert (forall ((d@@48 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) ($Is DatatypeTypeType d@@48 Tclass.AST.BinOp)) ($IsAlloc DatatypeTypeType d@@48 Tclass.AST.BinOp $h@@14))
 :qid |unknown.0:0|
 :skolemid |1020|
 :pattern ( ($IsAlloc DatatypeTypeType d@@48 Tclass.AST.BinOp $h@@14))
)))
(assert (forall ((d@@49 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) ($Is DatatypeTypeType d@@49 Tclass.AST.Expr__Raw)) ($IsAlloc DatatypeTypeType d@@49 Tclass.AST.Expr__Raw $h@@15))
 :qid |unknown.0:0|
 :skolemid |1116|
 :pattern ( ($IsAlloc DatatypeTypeType d@@49 Tclass.AST.Expr__Raw $h@@15))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@23| T@U) (|e#0@@21| T@U) ) (!  (=> (or (|Equiv.__default.P#canCall| (Lit DatatypeTypeType |st#0@@23|) (Lit DatatypeTypeType |e#0@@21|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@23| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@21| Tclass.AST.Expr)))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@23|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@21|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@23|))))) (let ((|res#2@@3| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@21|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@23|)))))))
 (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@23|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@21|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@23|))))) (let ((|res'#2@@3| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@21|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@23|)))))))
 (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@23|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@23|))))) (|Equiv.__default.EqResult#canCall| |res#2@@3| |res'#2@@3|))))))) (= (Equiv.__default.P (Lit DatatypeTypeType |st#0@@23|) (Lit DatatypeTypeType |e#0@@21|)) (U_2_bool (let ((|res#2@@4| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@21|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@23|)))))))
(let ((|res'#2@@4| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@21|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@23|)))))))
(Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@23|)) (Equiv.__default.EqResult |res#2@@4| |res'#2@@4|))))))))))
 :qid |Inductiondfy.34:21|
 :weight 3
 :skolemid |690|
 :pattern ( (Equiv.__default.P (Lit DatatypeTypeType |st#0@@23|) (Lit DatatypeTypeType |e#0@@21|)))
))))
...
(assert (forall ((d@@50 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (Equiv.MSeqValue.MSeqValue_q d@@50) ($IsAlloc DatatypeTypeType d@@50 Tclass.Equiv.MSeqValue $h@@16))) ($IsAlloc SeqType (Equiv.MSeqValue.vs d@@50) (TSeq TInt) $h@@16))
 :qid |unknown.0:0|
 :skolemid |925|
 :pattern ( ($IsAlloc SeqType (Equiv.MSeqValue.vs d@@50) (TSeq TInt) $h@@16))
)))
(assert (forall ((d@@51 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (Equiv.MSeqValue.MSeqValue_q d@@51) ($IsAlloc DatatypeTypeType d@@51 Tclass.Equiv.MSeqValue $h@@17))) ($IsAlloc SeqType (Equiv.MSeqValue.vs_k d@@51) (TSeq TInt) $h@@17))
 :qid |unknown.0:0|
 :skolemid |926|
 :pattern ( ($IsAlloc SeqType (Equiv.MSeqValue.vs_k d@@51) (TSeq TInt) $h@@17))
)))
(assert (forall ((d@@52 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (AST.Expr__Raw.Var_q d@@52) ($IsAlloc DatatypeTypeType d@@52 Tclass.AST.Expr__Raw $h@@18))) ($IsAlloc SeqType (AST.Expr__Raw.name d@@52) (TSeq TChar) $h@@18))
 :qid |unknown.0:0|
 :skolemid |1032|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.name d@@52) (TSeq TChar) $h@@18))
)))
...
(assert (forall ((|a#5#0#0@@1| T@U) (|a#5#1#0@@0| T@U) (d@@53 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#5#0#0@@1|) ($Box DatatypeTypeType d@@53)) (< (DtRank d@@53) (DtRank (|#Equiv.MState.MState| |a#5#0#0@@1| |a#5#1#0@@0|))))
 :qid |Equivdfy.62:28|
 :skolemid |894|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#5#0#0@@1|) ($Box DatatypeTypeType d@@53)) (|#Equiv.MState.MState| |a#5#0#0@@1| |a#5#1#0@@0|))
)))
(assert (forall ((|a#8#0#0| T@U) (|a#8#1#0| T@U) (d@@54 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#8#1#0|) ($Box DatatypeTypeType d@@54)) (< (DtRank d@@54) (DtRank (|#Equiv.MState.MState| |a#8#0#0| |a#8#1#0|))))
 :qid |Equivdfy.62:28|
 :skolemid |897|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#8#1#0|) ($Box DatatypeTypeType d@@54)) (|#Equiv.MState.MState| |a#8#0#0| |a#8#1#0|))
)))
...
(assert (forall ((d@@55 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (Equiv.MState.MState_q d@@55) ($IsAlloc DatatypeTypeType d@@55 Tclass.Equiv.MState $h@@19))) ($IsAlloc MapType (Equiv.MState.ctx d@@55) (TMap (TSeq TChar) TInt) $h@@19))
 :qid |unknown.0:0|
 :skolemid |890|
 :pattern ( ($IsAlloc MapType (Equiv.MState.ctx d@@55) (TMap (TSeq TChar) TInt) $h@@19))
)))
(assert (forall ((d@@56 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (Equiv.MState.MState_q d@@56) ($IsAlloc DatatypeTypeType d@@56 Tclass.Equiv.MState $h@@20))) ($IsAlloc MapType (Equiv.MState.ctx_k d@@56) (TMap (TSeq TChar) TInt) $h@@20))
 :qid |unknown.0:0|
 :skolemid |891|
 :pattern ( ($IsAlloc MapType (Equiv.MState.ctx_k d@@56) (TMap (TSeq TChar) TInt) $h@@20))
)))
(assert (forall ((d@@57 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (_System.Tuple2.___hMake2_q d@@57) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@57 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@21)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@57 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@21))
)))) ($IsAllocBox (_System.Tuple2._0 d@@57) |_System._tuple#2$T0@@6| $h@@21))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@57) |_System._tuple#2$T0@@6| $h@@21))
)))
(assert (forall ((d@@58 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (_System.Tuple2.___hMake2_q d@@58) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@58 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@22)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@58 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@22))
)))) ($IsAllocBox (_System.Tuple2._1 d@@58) |_System._tuple#2$T1@@7| $h@@22))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@58) |_System._tuple#2$T1@@7| $h@@22))
)))
...
(assert (forall ((d@@59 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (AST.Expr__Raw.Bind_q d@@59) ($IsAlloc DatatypeTypeType d@@59 Tclass.AST.Expr__Raw $h@@23))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@59) Tclass.AST.Expr__Raw $h@@23))
 :qid |unknown.0:0|
 :skolemid |1052|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@59) Tclass.AST.Expr__Raw $h@@23))
)))
(assert (forall ((d@@60 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (AST.Expr__Raw.If_q d@@60) ($IsAlloc DatatypeTypeType d@@60 Tclass.AST.Expr__Raw $h@@24))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@60) Tclass.AST.Expr__Raw $h@@24))
 :qid |unknown.0:0|
 :skolemid |1081|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@60) Tclass.AST.Expr__Raw $h@@24))
)))
(assert (forall ((d@@61 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (AST.Expr__Raw.If_q d@@61) ($IsAlloc DatatypeTypeType d@@61 Tclass.AST.Expr__Raw $h@@25))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@61) Tclass.AST.Expr__Raw $h@@25))
 :qid |unknown.0:0|
 :skolemid |1082|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@61) Tclass.AST.Expr__Raw $h@@25))
)))
(assert (forall ((d@@62 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (AST.Expr__Raw.If_q d@@62) ($IsAlloc DatatypeTypeType d@@62 Tclass.AST.Expr__Raw $h@@26))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@62) Tclass.AST.Expr__Raw $h@@26))
 :qid |unknown.0:0|
 :skolemid |1083|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@62) Tclass.AST.Expr__Raw $h@@26))
)))
(assert (forall ((d@@63 T@U) ($h@@27 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (AST.Expr__Raw.Op_q d@@63) ($IsAlloc DatatypeTypeType d@@63 Tclass.AST.Expr__Raw $h@@27))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@63) Tclass.AST.BinOp $h@@27))
 :qid |unknown.0:0|
 :skolemid |1096|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@63) Tclass.AST.BinOp $h@@27))
)))
(assert (forall ((d@@64 T@U) ($h@@28 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (AST.Expr__Raw.Op_q d@@64) ($IsAlloc DatatypeTypeType d@@64 Tclass.AST.Expr__Raw $h@@28))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@64) Tclass.AST.Expr__Raw $h@@28))
 :qid |unknown.0:0|
 :skolemid |1097|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@64) Tclass.AST.Expr__Raw $h@@28))
)))
(assert (forall ((d@@65 T@U) ($h@@29 T@U) ) (!  (=> (and ($IsGoodHeap $h@@29) (and (AST.Expr__Raw.Op_q d@@65) ($IsAlloc DatatypeTypeType d@@65 Tclass.AST.Expr__Raw $h@@29))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@65) Tclass.AST.Expr__Raw $h@@29))
 :qid |unknown.0:0|
 :skolemid |1098|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@65) Tclass.AST.Expr__Raw $h@@29))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@24| T@U) (|e#0@@24| T@U) ) (!  (=> (or (|Equiv.__default.P__Step#canCall| |st#0@@24| |e#0@@24|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@24| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@24| Tclass.AST.Expr)) (and (Equiv.__default.P |st#0@@24| |e#0@@24|) (not (Equiv.__default.P__Fail |st#0@@24| |e#0@@24|)))))) (and (Equiv.__default.P__Succ |st#0@@24| |e#0@@24| ($Unbox DatatypeTypeType (_System.Tuple2._0 (Equiv.__default.P__Step |st#0@@24| |e#0@@24|))) ($Unbox DatatypeTypeType (_System.Tuple2._1 (Equiv.__default.P__Step |st#0@@24| |e#0@@24|)))) ($Is DatatypeTypeType (Equiv.__default.P__Step |st#0@@24| |e#0@@24|) (Tclass._System.Tuple2 Tclass.Equiv.MState Tclass.Equiv.MValue))))
 :qid |Inductiondfy.66:25|
 :skolemid |790|
 :pattern ( (Equiv.__default.P__Step |st#0@@24| |e#0@@24|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@25| T@U) (|es#0@@17| T@U) ) (!  (=> (or (|Equiv.__default.Pes#canCall| (Lit DatatypeTypeType |st#0@@25|) (Lit SeqType |es#0@@17|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@25| Tclass.Equiv.MState) ($Is SeqType |es#0@@17| (TSeq Tclass.AST.Expr))))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@25|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@17|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@25|))))) (let ((|res#2@@5| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@17|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@25|)))))))
 (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@25|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@17|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@25|))))) (let ((|res'#2@@5| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@17|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@25|)))))))
 (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@25|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@25|))))) (|Equiv.__default.EqResultSeq#canCall| |res#2@@5| |res'#2@@5|))))))) (= (Equiv.__default.Pes (Lit DatatypeTypeType |st#0@@25|) (Lit SeqType |es#0@@17|)) (U_2_bool (let ((|res#2@@6| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@17|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@25|)))))))
(let ((|res'#2@@6| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@17|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@25|)))))))
(Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@25|)) (Equiv.__default.EqResultSeq |res#2@@6| |res'#2@@6|))))))))))
 :qid |Inductiondfy.39:23|
 :weight 3
 :skolemid |715|
 :pattern ( (Equiv.__default.Pes (Lit DatatypeTypeType |st#0@@25|) (Lit SeqType |es#0@@17|)))
))))
...
(assert (forall ((d@@66 T@U) ($h@@30 T@U) ) (!  (=> (and ($IsGoodHeap $h@@30) (and (AST.Expr__Raw.Bind_q d@@66) ($IsAlloc DatatypeTypeType d@@66 Tclass.AST.Expr__Raw $h@@30))) ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@66) (TSeq (TSeq TChar)) $h@@30))
 :qid |unknown.0:0|
 :skolemid |1050|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@66) (TSeq (TSeq TChar)) $h@@30))
)))
(assert (forall ((d@@67 T@U) ($h@@31 T@U) ) (!  (=> (and ($IsGoodHeap $h@@31) (and (AST.Expr__Raw.Assign_q d@@67) ($IsAlloc DatatypeTypeType d@@67 Tclass.AST.Expr__Raw $h@@31))) ($IsAlloc SeqType (AST.Expr__Raw.avars d@@67) (TSeq (TSeq TChar)) $h@@31))
 :qid |unknown.0:0|
 :skolemid |1067|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avars d@@67) (TSeq (TSeq TChar)) $h@@31))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|v#0@@7| T@U) (|vs#0@@10| T@U) ) (!  (=> (or (|Equiv.__default.AppendValue#canCall| (Lit DatatypeTypeType |v#0@@7|) (Lit DatatypeTypeType |vs#0@@10|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |v#0@@7| Tclass.Equiv.MValue) ($Is DatatypeTypeType |vs#0@@10| Tclass.Equiv.VS)))) (and (and (and (Equiv.MValue.MValue_q (Lit DatatypeTypeType |v#0@@7|)) (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |vs#0@@10|))) (and (Equiv.MValue.MValue_q (Lit DatatypeTypeType |v#0@@7|)) (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |vs#0@@10|)))) (= (Equiv.__default.AppendValue (Lit DatatypeTypeType |v#0@@7|) (Lit DatatypeTypeType |vs#0@@10|)) (|#Equiv.MSeqValue.MSeqValue| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt (Equiv.MValue.v (Lit DatatypeTypeType |v#0@@7|)))))) (Equiv.MSeqValue.vs (Lit DatatypeTypeType |vs#0@@10|))) (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt (Equiv.MValue.v_k (Lit DatatypeTypeType |v#0@@7|)))))) (Equiv.MSeqValue.vs_k (Lit DatatypeTypeType |vs#0@@10|)))))))
 :qid |Inductiondfy.43:30|
 :weight 3
 :skolemid |740|
 :pattern ( (Equiv.__default.AppendValue (Lit DatatypeTypeType |v#0@@7|) (Lit DatatypeTypeType |vs#0@@10|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@26| T@U) (|es#0@@18| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Step#canCall| |st#0@@26| |es#0@@18|) (and (< 4 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@26| Tclass.Equiv.MState) ($Is SeqType |es#0@@18| (TSeq Tclass.AST.Expr))) (and (Equiv.__default.Pes |st#0@@26| |es#0@@18|) (not (Equiv.__default.Pes__Fail |st#0@@26| |es#0@@18|)))))) (and (Equiv.__default.Pes__Succ |st#0@@26| |es#0@@18| ($Unbox DatatypeTypeType (_System.Tuple2._0 (Equiv.__default.Pes__Step |st#0@@26| |es#0@@18|))) ($Unbox DatatypeTypeType (_System.Tuple2._1 (Equiv.__default.Pes__Step |st#0@@26| |es#0@@18|)))) ($Is DatatypeTypeType (Equiv.__default.Pes__Step |st#0@@26| |es#0@@18|) (Tclass._System.Tuple2 Tclass.Equiv.MState Tclass.Equiv.VS))))
 :qid |Inductiondfy.71:27|
 :skolemid |799|
 :pattern ( (Equiv.__default.Pes__Step |st#0@@26| |es#0@@18|))
))))
(assert (forall ((d@@68 T@U) ($h@@32 T@U) ) (!  (=> (and ($IsGoodHeap $h@@32) (and (AST.Expr__Raw.Bind_q d@@68) ($IsAlloc DatatypeTypeType d@@68 Tclass.AST.Expr__Raw $h@@32))) ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@68) (TSeq Tclass.AST.Expr__Raw) $h@@32))
 :qid |unknown.0:0|
 :skolemid |1051|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@68) (TSeq Tclass.AST.Expr__Raw) $h@@32))
)))
(assert (forall ((d@@69 T@U) ($h@@33 T@U) ) (!  (=> (and ($IsGoodHeap $h@@33) (and (AST.Expr__Raw.Assign_q d@@69) ($IsAlloc DatatypeTypeType d@@69 Tclass.AST.Expr__Raw $h@@33))) ($IsAlloc SeqType (AST.Expr__Raw.avals d@@69) (TSeq Tclass.AST.Expr__Raw) $h@@33))
 :qid |unknown.0:0|
 :skolemid |1068|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avals d@@69) (TSeq Tclass.AST.Expr__Raw) $h@@33))
)))
(assert (forall ((d@@70 T@U) ($h@@34 T@U) ) (!  (=> (and ($IsGoodHeap $h@@34) (and (AST.Expr__Raw.Seq_q d@@70) ($IsAlloc DatatypeTypeType d@@70 Tclass.AST.Expr__Raw $h@@34))) ($IsAlloc SeqType (AST.Expr__Raw.es d@@70) (TSeq Tclass.AST.Expr__Raw) $h@@34))
 :qid |unknown.0:0|
 :skolemid |1111|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.es d@@70) (TSeq Tclass.AST.Expr__Raw) $h@@34))
)))
...
(set-info :boogie-vc-id Impl$$Equiv.__default.Pes__Satisfied__Succ)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (Equiv.__default.Pes |st#0@@27| |es#0@@19|)))))
(let ((anon9_Else_correct  (=> (not (Equiv.__default.Pes__Fail |st1#1_1_0@0| |es'#1_0@0|)) (=> (and ($Is DatatypeTypeType |st2#1_1_1_0@0| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st2#1_1_1_0@0| Tclass.Equiv.MState $Heap@5)) (=> (and (and (and (and ($Is DatatypeTypeType |vs#1_1_1_0@0| Tclass.Equiv.VS) ($IsAlloc DatatypeTypeType |vs#1_1_1_0@0| Tclass.Equiv.VS $Heap@5)) (and ($IsAlloc DatatypeTypeType |st1#1_1_0@0| Tclass.Equiv.MState $Heap@5) ($IsAlloc SeqType |es'#1_0@0| (TSeq Tclass.AST.Expr) $Heap@5))) (and (and (Equiv.__default.Pes |st1#1_1_0@0| |es'#1_0@0|) (not (Equiv.__default.Pes__Fail |st1#1_1_0@0| |es'#1_0@0|))) (and (|Equiv.__default.Pes__Step#canCall| |st1#1_1_0@0| |es'#1_0@0|) (_System.Tuple2.___hMake2_q (Equiv.__default.Pes__Step |st1#1_1_0@0| |es'#1_0@0|))))) (and (and (and (= |let#1_1_1_0#0#0| (Equiv.__default.Pes__Step |st1#1_1_0@0| |es'#1_0@0|)) (|Equiv.__default.Pes__Step#canCall| |st1#1_1_0@0| |es'#1_0@0|)) (and (|Equiv.__default.Pes__Step#canCall| |st1#1_1_0@0| |es'#1_0@0|) ($Is DatatypeTypeType |let#1_1_1_0#0#0| (Tclass._System.Tuple2 Tclass.Equiv.MState Tclass.Equiv.VS)))) (and (and (_System.Tuple2.___hMake2_q |let#1_1_1_0#0#0|) (= (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |st2#1_1_1_0@0|) ($Box DatatypeTypeType |vs#1_1_1_0@0|)) |let#1_1_1_0#0#0|)) (and ($IsGoodHeap $Heap@8) ($IsHeapAnchor $Heap@8))))) (=> (and (and (and (and (and (|Equiv.__default.P__Fail#canCall| |st#0@@27| |e#1_0@0|) (=> (Equiv.__default.P__Fail |st#0@@27| |e#1_0@0|) (|Equiv.__default.Pes__Fail#canCall| |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))) (=> (Equiv.__default.P__Fail |st#0@@27| |e#1_0@0|) (and (|Equiv.__default.Pes__Fail#canCall| |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (and (Equiv.__default.Pes__Fail |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (=> (Equiv.__default.Inv |st#0@@27|) (Utils.Result.Failure_q (Interp.__default.InterpExprs ($LS $LZ) (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) (Equiv.MState.ctx |st#0@@27|)))))))) (and (and (|Equiv.__default.P__Fail#canCall| |st#0@@27| |e#1_0@0|) (=> (not (Equiv.__default.P__Fail |st#0@@27| |e#1_0@0|)) (forall ((|st1#1| T@U) (|v#1@@2| T@U) ) (!  (=> (and ($Is DatatypeTypeType |st1#1| Tclass.Equiv.MState) ($Is DatatypeTypeType |v#1@@2| Tclass.Equiv.MValue)) (and (|Equiv.__default.P__Succ#canCall| |st#0@@27| |e#1_0@0| |st1#1| |v#1@@2|) (=> (Equiv.__default.P__Succ |st#0@@27| |e#1_0@0| |st1#1| |v#1@@2|) (and (|Equiv.__default.Pes__Fail#canCall| |st1#1| |es'#1_0@0|) (=> (Equiv.__default.Pes__Fail |st1#1| |es'#1_0@0|) (|Equiv.__default.Pes__Fail#canCall| |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))))))
 :qid |Inductiondfy.186:39|
 :skolemid |836|
 :pattern ( (Equiv.__default.P__Succ |st#0@@27| |e#1_0@0| |st1#1| |v#1@@2|))
)))) (=> (not (Equiv.__default.P__Fail |st#0@@27| |e#1_0@0|)) (forall ((|st1#1@@0| T@U) (|v#1@@3| T@U) ) (!  (=> (and ($Is DatatypeTypeType |st1#1@@0| Tclass.Equiv.MState) ($Is DatatypeTypeType |v#1@@3| Tclass.Equiv.MValue)) (=> (and (Equiv.__default.P__Succ |st#0@@27| |e#1_0@0| |st1#1@@0| |v#1@@3|) (Equiv.__default.Pes__Fail |st1#1@@0| |es'#1_0@0|)) (Equiv.__default.Pes__Fail |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|))))
 :qid |Inductiondfy.186:39|
 :skolemid |837|
 :pattern ( (Equiv.__default.P__Succ |st#0@@27| |e#1_0@0| |st1#1@@0| |v#1@@3|))
))))) (and (and (and (forall ((|st1#3| T@U) (|v#3@@0| T@U) (|st2#1| T@U) (|vs#1@@3| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |st1#3| Tclass.Equiv.MState) ($Is DatatypeTypeType |v#3@@0| Tclass.Equiv.MValue)) ($Is DatatypeTypeType |st2#1| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#1@@3| Tclass.Equiv.VS)) (and (|Equiv.__default.P__Succ#canCall| |st#0@@27| |e#1_0@0| |st1#3| |v#3@@0|) (=> (Equiv.__default.P__Succ |st#0@@27| |e#1_0@0| |st1#3| |v#3@@0|) (and (|Equiv.__default.Pes__Succ#canCall| |st1#3| |es'#1_0@0| |st2#1| |vs#1@@3|) (=> (Equiv.__default.Pes__Succ |st1#3| |es'#1_0@0| |st2#1| |vs#1@@3|) (and (|Equiv.__default.AppendValue#canCall| |v#3@@0| |vs#1@@3|) (|Equiv.__default.Pes__Succ#canCall| |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1| (Equiv.__default.AppendValue |v#3@@0| |vs#1@@3|))))))))
 :qid |Inductiondfy.187:20|
 :skolemid |838|
 :pattern ( (Equiv.__default.AppendValue |v#3@@0| |vs#1@@3|) (Equiv.__default.Pes__Succ |st1#3| |es'#1_0@0| |st2#1| |vs#1@@3|))
 :pattern ( (Equiv.__default.Pes__Succ |st1#3| |es'#1_0@0| |st2#1| |vs#1@@3|) (Equiv.__default.P__Succ |st#0@@27| |e#1_0@0| |st1#3| |v#3@@0|))
)) (forall ((|st1#3@@0| T@U) (|v#3@@1| T@U) (|st2#1@@0| T@U) (|vs#1@@4| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |st1#3@@0| Tclass.Equiv.MState) ($Is DatatypeTypeType |v#3@@1| Tclass.Equiv.MValue)) ($Is DatatypeTypeType |st2#1@@0| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#1@@4| Tclass.Equiv.VS)) (=> (and (Equiv.__default.P__Succ |st#0@@27| |e#1_0@0| |st1#3@@0| |v#3@@1|) (Equiv.__default.Pes__Succ |st1#3@@0| |es'#1_0@0| |st2#1@@0| |vs#1@@4|)) (Equiv.__default.Pes__Succ |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1@@0| (Equiv.__default.AppendValue |v#3@@1| |vs#1@@4|))))
 :qid |Inductiondfy.187:20|
 :skolemid |839|
 :pattern ( (Equiv.__default.AppendValue |v#3@@1| |vs#1@@4|) (Equiv.__default.Pes__Succ |st1#3@@0| |es'#1_0@0| |st2#1@@0| |vs#1@@4|))
 :pattern ( (Equiv.__default.Pes__Succ |st1#3@@0| |es'#1_0@0| |st2#1@@0| |vs#1@@4|) (Equiv.__default.P__Succ |st#0@@27| |e#1_0@0| |st1#3@@0| |v#3@@1|))
))) (and (= $Heap@5 $Heap@8) ($IsAlloc DatatypeTypeType |st#0@@27| Tclass.Equiv.MState $Heap@8))) (and (and (= |##es#1_1_1_1@0| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) ($IsAlloc SeqType |##es#1_1_1_1@0| (TSeq Tclass.AST.Expr) $Heap@8)) (and ($IsAlloc DatatypeTypeType |st2#1_1_1_0@0| Tclass.Equiv.MState $Heap@8) ($IsAlloc DatatypeTypeType |v#1_1_0@0| Tclass.Equiv.MValue $Heap@8))))) (and (and (and (and ($IsAlloc DatatypeTypeType |vs#1_1_1_0@0| Tclass.Equiv.VS $Heap@8) (|Equiv.__default.AppendValue#canCall| |v#1_1_0@0| |vs#1_1_1_0@0|)) (and (Equiv.MSeqValue.MSeqValue_q (Equiv.__default.AppendValue |v#1_1_0@0| |vs#1_1_1_0@0|)) (= |##vs#1_1_1_0@0| (Equiv.__default.AppendValue |v#1_1_0@0| |vs#1_1_1_0@0|)))) (and (and ($IsAlloc DatatypeTypeType |##vs#1_1_1_0@0| Tclass.Equiv.VS $Heap@8) (|Equiv.__default.Pes__Succ#canCall| |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1_1_1_0@0| (Equiv.__default.AppendValue |v#1_1_0@0| |vs#1_1_1_0@0|))) (and (|Equiv.__default.AppendValue#canCall| |v#1_1_0@0| |vs#1_1_1_0@0|) (|Equiv.__default.Pes__Succ#canCall| |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1_1_1_0@0| (Equiv.__default.AppendValue |v#1_1_0@0| |vs#1_1_1_0@0|))))) (and (and (and (Equiv.__default.Pes__Succ |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1_1_1_0@0| (Equiv.__default.AppendValue |v#1_1_0@0| |vs#1_1_1_0@0|)) (= |es##1_1_1_1@0| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|))) (and ($IsAlloc DatatypeTypeType |v#1_1_0@0| Tclass.Equiv.MValue $Heap@8) ($IsAlloc DatatypeTypeType |vs#1_1_1_0@0| Tclass.Equiv.VS $Heap@8))) (and (and (|Equiv.__default.AppendValue#canCall| |v#1_1_0@0| |vs#1_1_1_0@0|) (Equiv.MSeqValue.MSeqValue_q (Equiv.__default.AppendValue |v#1_1_0@0| |vs#1_1_1_0@0|))) (and (|Equiv.__default.AppendValue#canCall| |v#1_1_0@0| |vs#1_1_1_0@0|) (= |vs##1_1_1_0@0| (Equiv.__default.AppendValue |v#1_1_0@0| |vs#1_1_1_0@0|))))))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (Equiv.__default.Pes__Succ |st#0@@27| |es##1_1_1_1@0| |st2#1_1_1_0@0| |vs##1_1_1_0@0|)) (=> (Equiv.__default.Pes__Succ |st#0@@27| |es##1_1_1_1@0| |st2#1_1_1_0@0| |vs##1_1_1_0@0|) (=> (and ($IsGoodHeap $Heap@9) ($IsHeapAnchor $Heap@9)) (=> (and (and (|Equiv.__default.Pes#canCall| |st#0@@27| |es##1_1_1_1@0|) (Equiv.__default.Pes |st#0@@27| |es##1_1_1_1@0|)) (and (= $Heap@8 $Heap@9) (= (ControlFlow 0 9) 2))) GeneratedUnifiedExit_correct))))))))))
(let ((anon9_Then_correct  (=> (Equiv.__default.Pes__Fail |st1#1_1_0@0| |es'#1_0@0|) (=> (and ($IsGoodHeap $Heap@6) ($IsHeapAnchor $Heap@6)) (=> (and (and (|Equiv.__default.P__Fail#canCall| |st#0@@27| |e#1_0@0|) (=> (Equiv.__default.P__Fail |st#0@@27| |e#1_0@0|) (|Equiv.__default.Pes__Fail#canCall| |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))) (=> (Equiv.__default.P__Fail |st#0@@27| |e#1_0@0|) (and (|Equiv.__default.Pes__Fail#canCall| |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (and (Equiv.__default.Pes__Fail |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (=> (Equiv.__default.Inv |st#0@@27|) (Utils.Result.Failure_q (Interp.__default.InterpExprs ($LS $LZ) (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) (Equiv.MState.ctx |st#0@@27|)))))))) (=> (and (and (and (and (|Equiv.__default.P__Fail#canCall| |st#0@@27| |e#1_0@0|) (=> (not (Equiv.__default.P__Fail |st#0@@27| |e#1_0@0|)) (forall ((|st1#1@@1| T@U) (|v#1@@4| T@U) ) (!  (=> (and ($Is DatatypeTypeType |st1#1@@1| Tclass.Equiv.MState) ($Is DatatypeTypeType |v#1@@4| Tclass.Equiv.MValue)) (and (|Equiv.__default.P__Succ#canCall| |st#0@@27| |e#1_0@0| |st1#1@@1| |v#1@@4|) (=> (Equiv.__default.P__Succ |st#0@@27| |e#1_0@0| |st1#1@@1| |v#1@@4|) (and (|Equiv.__default.Pes__Fail#canCall| |st1#1@@1| |es'#1_0@0|) (=> (Equiv.__default.Pes__Fail |st1#1@@1| |es'#1_0@0|) (|Equiv.__default.Pes__Fail#canCall| |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))))))
 :qid |Inductiondfy.186:39|
 :skolemid |836|
 :pattern ( (Equiv.__default.P__Succ |st#0@@27| |e#1_0@0| |st1#1@@1| |v#1@@4|))
)))) (=> (not (Equiv.__default.P__Fail |st#0@@27| |e#1_0@0|)) (forall ((|st1#1@@2| T@U) (|v#1@@5| T@U) ) (!  (=> (and ($Is DatatypeTypeType |st1#1@@2| Tclass.Equiv.MState) ($Is DatatypeTypeType |v#1@@5| Tclass.Equiv.MValue)) (=> (and (Equiv.__default.P__Succ |st#0@@27| |e#1_0@0| |st1#1@@2| |v#1@@5|) (Equiv.__default.Pes__Fail |st1#1@@2| |es'#1_0@0|)) (Equiv.__default.Pes__Fail |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|))))
 :qid |Inductiondfy.186:39|
 :skolemid |837|
 :pattern ( (Equiv.__default.P__Succ |st#0@@27| |e#1_0@0| |st1#1@@2| |v#1@@5|))
)))) (and (forall ((|st1#3@@1| T@U) (|v#3@@2| T@U) (|st2#1@@1| T@U) (|vs#1@@5| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |st1#3@@1| Tclass.Equiv.MState) ($Is DatatypeTypeType |v#3@@2| Tclass.Equiv.MValue)) ($Is DatatypeTypeType |st2#1@@1| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#1@@5| Tclass.Equiv.VS)) (and (|Equiv.__default.P__Succ#canCall| |st#0@@27| |e#1_0@0| |st1#3@@1| |v#3@@2|) (=> (Equiv.__default.P__Succ |st#0@@27| |e#1_0@0| |st1#3@@1| |v#3@@2|) (and (|Equiv.__default.Pes__Succ#canCall| |st1#3@@1| |es'#1_0@0| |st2#1@@1| |vs#1@@5|) (=> (Equiv.__default.Pes__Succ |st1#3@@1| |es'#1_0@0| |st2#1@@1| |vs#1@@5|) (and (|Equiv.__default.AppendValue#canCall| |v#3@@2| |vs#1@@5|) (|Equiv.__default.Pes__Succ#canCall| |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1@@1| (Equiv.__default.AppendValue |v#3@@2| |vs#1@@5|))))))))
 :qid |Inductiondfy.187:20|
 :skolemid |838|
 :pattern ( (Equiv.__default.AppendValue |v#3@@2| |vs#1@@5|) (Equiv.__default.Pes__Succ |st1#3@@1| |es'#1_0@0| |st2#1@@1| |vs#1@@5|))
 :pattern ( (Equiv.__default.Pes__Succ |st1#3@@1| |es'#1_0@0| |st2#1@@1| |vs#1@@5|) (Equiv.__default.P__Succ |st#0@@27| |e#1_0@0| |st1#3@@1| |v#3@@2|))
)) (forall ((|st1#3@@2| T@U) (|v#3@@3| T@U) (|st2#1@@2| T@U) (|vs#1@@6| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |st1#3@@2| Tclass.Equiv.MState) ($Is DatatypeTypeType |v#3@@3| Tclass.Equiv.MValue)) ($Is DatatypeTypeType |st2#1@@2| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#1@@6| Tclass.Equiv.VS)) (=> (and (Equiv.__default.P__Succ |st#0@@27| |e#1_0@0| |st1#3@@2| |v#3@@3|) (Equiv.__default.Pes__Succ |st1#3@@2| |es'#1_0@0| |st2#1@@2| |vs#1@@6|)) (Equiv.__default.Pes__Succ |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1@@2| (Equiv.__default.AppendValue |v#3@@3| |vs#1@@6|))))
 :qid |Inductiondfy.187:20|
 :skolemid |839|
 :pattern ( (Equiv.__default.AppendValue |v#3@@3| |vs#1@@6|) (Equiv.__default.Pes__Succ |st1#3@@2| |es'#1_0@0| |st2#1@@2| |vs#1@@6|))
 :pattern ( (Equiv.__default.Pes__Succ |st1#3@@2| |es'#1_0@0| |st2#1@@2| |vs#1@@6|) (Equiv.__default.P__Succ |st#0@@27| |e#1_0@0| |st1#3@@2| |v#3@@3|))
)))) (and (and (and (= $Heap@5 $Heap@6) ($IsAlloc DatatypeTypeType |st#0@@27| Tclass.Equiv.MState $Heap@6)) (and (= |##es#1_1_0_0@0| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) ($IsAlloc SeqType |##es#1_1_0_0@0| (TSeq Tclass.AST.Expr) $Heap@6))) (and (and (|Equiv.__default.Pes__Fail#canCall| |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (|Equiv.__default.Pes__Fail#canCall| |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|))) (and (Equiv.__default.Pes__Fail |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (= |es##1_1_0_1@0| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (Equiv.__default.Pes__Fail |st#0@@27| |es##1_1_0_1@0|)) (=> (Equiv.__default.Pes__Fail |st#0@@27| |es##1_1_0_1@0|) (=> (and ($IsGoodHeap $Heap@7) ($IsHeapAnchor $Heap@7)) (=> (and (and (|Equiv.__default.Pes#canCall| |st#0@@27| |es##1_1_0_1@0|) (Equiv.__default.Pes |st#0@@27| |es##1_1_0_1@0|)) (and (= $Heap@6 $Heap@7) (= (ControlFlow 0 7) 2))) GeneratedUnifiedExit_correct))))))))))
(let ((anon8_Else_correct  (=> (not (Equiv.__default.P__Fail |st#0@@27| |e#1_0@0|)) (=> (and ($Is DatatypeTypeType |st1#1_1_0@0| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st1#1_1_0@0| Tclass.Equiv.MState $Heap@2)) (=> (and (and (and (and (and ($Is DatatypeTypeType |v#1_1_0@0| Tclass.Equiv.MValue) ($IsAlloc DatatypeTypeType |v#1_1_0@0| Tclass.Equiv.MValue $Heap@2)) (and ($IsAlloc DatatypeTypeType |st#0@@27| Tclass.Equiv.MState $Heap@2) ($IsAlloc DatatypeTypeType |e#1_0@0| Tclass.AST.Expr $Heap@2))) (and (and (Equiv.__default.P |st#0@@27| |e#1_0@0|) (not (Equiv.__default.P__Fail |st#0@@27| |e#1_0@0|))) (and (|Equiv.__default.P__Step#canCall| |st#0@@27| |e#1_0@0|) (_System.Tuple2.___hMake2_q (Equiv.__default.P__Step |st#0@@27| |e#1_0@0|))))) (and (and (and (= |let#1_1_0#0#0| (Equiv.__default.P__Step |st#0@@27| |e#1_0@0|)) (|Equiv.__default.P__Step#canCall| |st#0@@27| |e#1_0@0|)) (and (|Equiv.__default.P__Step#canCall| |st#0@@27| |e#1_0@0|) ($Is DatatypeTypeType |let#1_1_0#0#0| (Tclass._System.Tuple2 Tclass.Equiv.MState Tclass.Equiv.MValue)))) (and (and (_System.Tuple2.___hMake2_q |let#1_1_0#0#0|) (= (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |st1#1_1_0@0|) ($Box DatatypeTypeType |v#1_1_0@0|)) |let#1_1_0#0#0|)) (and (or (or (<= 0 (LitInt 0)) (< (|Seq#Rank| |es'#1_0@0|) (|Seq#Rank| |es#0@@19|))) (= (LitInt 1) (LitInt 0))) (or (< (|Seq#Rank| |es'#1_0@0|) (|Seq#Rank| |es#0@@19|)) (and (= (|Seq#Rank| |es'#1_0@0|) (|Seq#Rank| |es#0@@19|)) (< (LitInt 1) (LitInt 0)))))))) (and (and (and (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5)) (|Equiv.__default.Pes#canCall| |st1#1_1_0@0| |es'#1_0@0|)) (and (Equiv.__default.Pes |st1#1_1_0@0| |es'#1_0@0|) (= $Heap@2 $Heap@5))) (and (and ($IsAlloc DatatypeTypeType |st1#1_1_0@0| Tclass.Equiv.MState $Heap@5) ($IsAlloc SeqType |es'#1_0@0| (TSeq Tclass.AST.Expr) $Heap@5)) (and (|Equiv.__default.Pes__Fail#canCall| |st1#1_1_0@0| |es'#1_0@0|) (|Equiv.__default.Pes__Fail#canCall| |st1#1_1_0@0| |es'#1_0@0|))))) (and (=> (= (ControlFlow 0 11) 7) anon9_Then_correct) (=> (= (ControlFlow 0 11) 9) anon9_Else_correct)))))))
(let ((anon8_Then_correct  (=> (Equiv.__default.P__Fail |st#0@@27| |e#1_0@0|) (=> (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (=> (and (and (|Equiv.__default.P__Fail#canCall| |st#0@@27| |e#1_0@0|) (=> (Equiv.__default.P__Fail |st#0@@27| |e#1_0@0|) (|Equiv.__default.Pes__Fail#canCall| |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))) (=> (Equiv.__default.P__Fail |st#0@@27| |e#1_0@0|) (and (|Equiv.__default.Pes__Fail#canCall| |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (and (Equiv.__default.Pes__Fail |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (=> (Equiv.__default.Inv |st#0@@27|) (Utils.Result.Failure_q (Interp.__default.InterpExprs ($LS $LZ) (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) (Equiv.MState.ctx |st#0@@27|)))))))) (=> (and (and (and (and (|Equiv.__default.P__Fail#canCall| |st#0@@27| |e#1_0@0|) (=> (not (Equiv.__default.P__Fail |st#0@@27| |e#1_0@0|)) (forall ((|st1#1@@3| T@U) (|v#1@@6| T@U) ) (!  (=> (and ($Is DatatypeTypeType |st1#1@@3| Tclass.Equiv.MState) ($Is DatatypeTypeType |v#1@@6| Tclass.Equiv.MValue)) (and (|Equiv.__default.P__Succ#canCall| |st#0@@27| |e#1_0@0| |st1#1@@3| |v#1@@6|) (=> (Equiv.__default.P__Succ |st#0@@27| |e#1_0@0| |st1#1@@3| |v#1@@6|) (and (|Equiv.__default.Pes__Fail#canCall| |st1#1@@3| |es'#1_0@0|) (=> (Equiv.__default.Pes__Fail |st1#1@@3| |es'#1_0@0|) (|Equiv.__default.Pes__Fail#canCall| |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))))))
 :qid |Inductiondfy.186:39|
 :skolemid |836|
 :pattern ( (Equiv.__default.P__Succ |st#0@@27| |e#1_0@0| |st1#1@@3| |v#1@@6|))
)))) (=> (not (Equiv.__default.P__Fail |st#0@@27| |e#1_0@0|)) (forall ((|st1#1@@4| T@U) (|v#1@@7| T@U) ) (!  (=> (and ($Is DatatypeTypeType |st1#1@@4| Tclass.Equiv.MState) ($Is DatatypeTypeType |v#1@@7| Tclass.Equiv.MValue)) (=> (and (Equiv.__default.P__Succ |st#0@@27| |e#1_0@0| |st1#1@@4| |v#1@@7|) (Equiv.__default.Pes__Fail |st1#1@@4| |es'#1_0@0|)) (Equiv.__default.Pes__Fail |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|))))
 :qid |Inductiondfy.186:39|
 :skolemid |837|
 :pattern ( (Equiv.__default.P__Succ |st#0@@27| |e#1_0@0| |st1#1@@4| |v#1@@7|))
)))) (and (forall ((|st1#3@@3| T@U) (|v#3@@4| T@U) (|st2#1@@3| T@U) (|vs#1@@7| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |st1#3@@3| Tclass.Equiv.MState) ($Is DatatypeTypeType |v#3@@4| Tclass.Equiv.MValue)) ($Is DatatypeTypeType |st2#1@@3| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#1@@7| Tclass.Equiv.VS)) (and (|Equiv.__default.P__Succ#canCall| |st#0@@27| |e#1_0@0| |st1#3@@3| |v#3@@4|) (=> (Equiv.__default.P__Succ |st#0@@27| |e#1_0@0| |st1#3@@3| |v#3@@4|) (and (|Equiv.__default.Pes__Succ#canCall| |st1#3@@3| |es'#1_0@0| |st2#1@@3| |vs#1@@7|) (=> (Equiv.__default.Pes__Succ |st1#3@@3| |es'#1_0@0| |st2#1@@3| |vs#1@@7|) (and (|Equiv.__default.AppendValue#canCall| |v#3@@4| |vs#1@@7|) (|Equiv.__default.Pes__Succ#canCall| |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1@@3| (Equiv.__default.AppendValue |v#3@@4| |vs#1@@7|))))))))
 :qid |Inductiondfy.187:20|
 :skolemid |838|
 :pattern ( (Equiv.__default.AppendValue |v#3@@4| |vs#1@@7|) (Equiv.__default.Pes__Succ |st1#3@@3| |es'#1_0@0| |st2#1@@3| |vs#1@@7|))
 :pattern ( (Equiv.__default.Pes__Succ |st1#3@@3| |es'#1_0@0| |st2#1@@3| |vs#1@@7|) (Equiv.__default.P__Succ |st#0@@27| |e#1_0@0| |st1#3@@3| |v#3@@4|))
)) (forall ((|st1#3@@4| T@U) (|v#3@@5| T@U) (|st2#1@@4| T@U) (|vs#1@@8| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |st1#3@@4| Tclass.Equiv.MState) ($Is DatatypeTypeType |v#3@@5| Tclass.Equiv.MValue)) ($Is DatatypeTypeType |st2#1@@4| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#1@@8| Tclass.Equiv.VS)) (=> (and (Equiv.__default.P__Succ |st#0@@27| |e#1_0@0| |st1#3@@4| |v#3@@5|) (Equiv.__default.Pes__Succ |st1#3@@4| |es'#1_0@0| |st2#1@@4| |vs#1@@8|)) (Equiv.__default.Pes__Succ |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1@@4| (Equiv.__default.AppendValue |v#3@@5| |vs#1@@8|))))
 :qid |Inductiondfy.187:20|
 :skolemid |839|
 :pattern ( (Equiv.__default.AppendValue |v#3@@5| |vs#1@@8|) (Equiv.__default.Pes__Succ |st1#3@@4| |es'#1_0@0| |st2#1@@4| |vs#1@@8|))
 :pattern ( (Equiv.__default.Pes__Succ |st1#3@@4| |es'#1_0@0| |st2#1@@4| |vs#1@@8|) (Equiv.__default.P__Succ |st#0@@27| |e#1_0@0| |st1#3@@4| |v#3@@5|))
)))) (and (and (and (= $Heap@2 $Heap@3) ($IsAlloc DatatypeTypeType |st#0@@27| Tclass.Equiv.MState $Heap@3)) (and (= |##es#1_0_0@0| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) ($IsAlloc SeqType |##es#1_0_0@0| (TSeq Tclass.AST.Expr) $Heap@3))) (and (and (|Equiv.__default.Pes__Fail#canCall| |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (|Equiv.__default.Pes__Fail#canCall| |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|))) (and (Equiv.__default.Pes__Fail |st#0@@27| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (= |es##1_0_1@0| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (Equiv.__default.Pes__Fail |st#0@@27| |es##1_0_1@0|)) (=> (Equiv.__default.Pes__Fail |st#0@@27| |es##1_0_1@0|) (=> (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (=> (and (and (|Equiv.__default.Pes#canCall| |st#0@@27| |es##1_0_1@0|) (Equiv.__default.Pes |st#0@@27| |es##1_0_1@0|)) (and (= $Heap@3 $Heap@4) (= (ControlFlow 0 5) 2))) GeneratedUnifiedExit_correct))))))))))
(let ((anon7_Else_correct  (=> (not (|Seq#Equal| |es#0@@19| |Seq#Empty|)) (=> (and (and (and (and (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |es#0@@19|))) (= |e#1_0@0| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@19| (LitInt 0))))) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |es#0@@19|)))) (and (and (= |es'#1_0@0| (|Seq#Drop| |es#0@@19| (LitInt 1))) (|Seq#Equal| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |es#0@@19|)) (and (or (or (<= 0 (LitInt 0)) (< (DtRank |e#1_0@0|) (|Seq#Rank| |es#0@@19|))) (= (LitInt 3) (LitInt 0))) (< (DtRank |e#1_0@0|) (|Seq#Rank| |es#0@@19|))))) (and (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (|Equiv.__default.P#canCall| |st#0@@27| |e#1_0@0|)) (and (Equiv.__default.P |st#0@@27| |e#1_0@0|) (= $Heap@@6 $Heap@2))) (and (and ($IsAlloc DatatypeTypeType |st#0@@27| Tclass.Equiv.MState $Heap@2) ($IsAlloc DatatypeTypeType |e#1_0@0| Tclass.AST.Expr $Heap@2)) (and (|Equiv.__default.P__Fail#canCall| |st#0@@27| |e#1_0@0|) (|Equiv.__default.P__Fail#canCall| |st#0@@27| |e#1_0@0|))))) (and (=> (= (ControlFlow 0 12) 5) anon8_Then_correct) (=> (= (ControlFlow 0 12) 11) anon8_Else_correct))))))
(let ((anon7_Then_correct  (=> (|Seq#Equal| |es#0@@19| |Seq#Empty|) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (and (|Equiv.__default.Pes__Fail#canCall| |st#0@@27| (Lit SeqType |Seq#Empty|)) (=> (not (Equiv.__default.Pes__Fail |st#0@@27| (Lit SeqType |Seq#Empty|))) (|Equiv.__default.Pes__Succ#canCall| |st#0@@27| (Lit SeqType |Seq#Empty|) |st#0@@27| Equiv.__default.NilVS))) (=> (not (Equiv.__default.Pes__Fail |st#0@@27| (Lit SeqType |Seq#Empty|))) (and (|Equiv.__default.Pes__Succ#canCall| |st#0@@27| (Lit SeqType |Seq#Empty|) |st#0@@27| Equiv.__default.NilVS) (and (Equiv.__default.Pes__Succ |st#0@@27| (Lit SeqType |Seq#Empty|) |st#0@@27| Equiv.__default.NilVS) (let ((|res#0@@11| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |Seq#Empty|) (Equiv.MState.ctx |st#0@@27|))))
(let ((|res'#0@@11| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |Seq#Empty|) (Equiv.MState.ctx_k |st#0@@27|))))
 (and (and (and (Equiv.__default.Inv |st#0@@27|) (Equiv.__default.EqResultSeq |res#0@@11| |res'#0@@11|)) (|Utils.Result#Equal| |res#0@@11| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs Equiv.__default.NilVS)) ($Box MapType (Equiv.MState.ctx |st#0@@27|))))))) (|Utils.Result#Equal| |res'#0@@11| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs_k Equiv.__default.NilVS)) ($Box MapType (Equiv.MState.ctx_k |st#0@@27|))))))))))))) (and (and (= $Heap@@6 $Heap@0) ($IsAlloc DatatypeTypeType |st#0@@27| Tclass.Equiv.MState $Heap@0)) (and (= |##es#0_0@0| (Lit SeqType |Seq#Empty|)) ($IsAlloc SeqType |##es#0_0@0| (TSeq Tclass.AST.Expr) $Heap@0)))) (and (and (and ($IsAlloc DatatypeTypeType |st#0@@27| Tclass.Equiv.MState $Heap@0) (= |##vs#0_0@0| Equiv.__default.NilVS)) (and ($IsAlloc DatatypeTypeType |##vs#0_0@0| Tclass.Equiv.VS $Heap@0) (|Equiv.__default.Pes__Succ#canCall| |st#0@@27| (Lit SeqType |Seq#Empty|) |st#0@@27| Equiv.__default.NilVS))) (and (and (|Equiv.__default.Pes__Succ#canCall| |st#0@@27| (Lit SeqType |Seq#Empty|) |st#0@@27| Equiv.__default.NilVS) (Equiv.__default.Pes__Succ |st#0@@27| (Lit SeqType |Seq#Empty|) |st#0@@27| Equiv.__default.NilVS)) (and (= |es##0_0@0| (Lit SeqType |Seq#Empty|)) (= |vs##0_0@0| Equiv.__default.NilVS))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (Equiv.__default.Pes__Succ |st#0@@27| |es##0_0@0| |st#0@@27| |vs##0_0@0|)) (=> (Equiv.__default.Pes__Succ |st#0@@27| |es##0_0@0| |st#0@@27| |vs##0_0@0|) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (|Equiv.__default.Pes#canCall| |st#0@@27| |es##0_0@0|) (Equiv.__default.Pes |st#0@@27| |es##0_0@0|)) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct)))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and (and (and ($Is DatatypeTypeType |st#0@@27| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st#0@@27| Tclass.Equiv.MState $Heap@@6)) (|$IsA#Equiv.MState| |st#0@@27|)) (and ($Is SeqType |es#0@@19| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |es#0@@19| (TSeq Tclass.AST.Expr) $Heap@@6))) (and (and ($Is DatatypeTypeType |e#1_0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#1_0| Tclass.AST.Expr $Heap@@6)) true)) (and (and (and (and ($Is SeqType |es'#1_0| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |es'#1_0| (TSeq Tclass.AST.Expr) $Heap@@6)) true) (= 6 $FunctionContextHeight)) (and (not (Equiv.__default.Pes__Fail |st#0@@27| |es#0@@19|)) (= (ControlFlow 0 14) 13)))) anon0_correct))))
