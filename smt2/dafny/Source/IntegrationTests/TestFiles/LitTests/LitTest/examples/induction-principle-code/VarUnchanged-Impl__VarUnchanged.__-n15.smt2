...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|e#0@@3| T@U) ) (!  (=> (or (|VarUnchanged.__default.P__Fail#canCall| (Lit DatatypeTypeType |st#0@@1|) (Lit DatatypeTypeType |e#0@@3|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@1| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@3| Tclass.AST.Expr)))) (and (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@1|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@3|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@1|))))) (|VarUnchanged.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@1|) (Lit DatatypeTypeType |e#0@@3|))) (= (VarUnchanged.__default.P__Fail (Lit DatatypeTypeType |st#0@@1|) (Lit DatatypeTypeType |e#0@@3|)) (U_2_bool (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@3|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@1|)))))))
(Lit boolType (bool_2_U  (=> (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@1|) (Lit DatatypeTypeType |e#0@@3|)) (Utils.Result.Failure_q |res#2|)))))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |739|
 :pattern ( (VarUnchanged.__default.P__Fail (Lit DatatypeTypeType |st#0@@1|) (Lit DatatypeTypeType |e#0@@3|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|e#0@@4| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pre#canCall| |st#0@@2| |e#0@@4|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@2| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@4| Tclass.AST.Expr)))) (and (and (VarUnchanged.MState.MState_q |st#0@@2|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@2|)) (and (VarUnchanged.MState.MState_q |st#0@@2|) (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@2|))) |e#0@@4|)))) (= (VarUnchanged.__default.Pre |st#0@@2| |e#0@@4|)  (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@2|)) (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@2|))) |e#0@@4|)))))
 :qid |VarUnchangeddfy.82:23|
 :skolemid |704|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@2| |e#0@@4|))
))))
...
(let ((|cond#1@@0| (AST.Expr__Raw.cond |e#0@@5|)))
 (and (|AST.Expr__Raw.All#canCall| |cond#1@@0| |p#0|) (=> (AST.Expr__Raw.All $ly@@1 |cond#1@@0| |p#0|) (and (|AST.Expr__Raw.All#canCall| |thn#1@@0| |p#0|) (=> (AST.Expr__Raw.All $ly@@1 |thn#1@@0| |p#0|) (|AST.Expr__Raw.All#canCall| |els#1@@0| |p#0|))))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@5|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@5|) (let ((|oe2#1| (AST.Expr__Raw.oe2 |e#0@@5|)))
(let ((|oe1#1| (AST.Expr__Raw.oe1 |e#0@@5|)))
 (and (|AST.Expr__Raw.All#canCall| |oe1#1| |p#0|) (=> (AST.Expr__Raw.All $ly@@1 |oe1#1| |p#0|) (|AST.Expr__Raw.All#canCall| |oe2#1| |p#0|)))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@5|)) (let ((|es#1@@0| (AST.Expr__Raw.es |e#0@@5|)))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@1) |e#0@@5| |p#0|)  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@1 |p#0| ($Box DatatypeTypeType |e#0@@5|)))) (ite (AST.Expr__Raw.Var_q |e#0@@5|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q |e#0@@5|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q |e#0@@5|) (let ((|body#0@@0| (AST.Expr__Raw.body |e#0@@5|)))
...
)) (AST.Expr__Raw.All $ly@@1 |body#0@@0| |p#0|)))) (ite (AST.Expr__Raw.Assign_q |e#0@@5|) (let ((|avals#0@@1| (AST.Expr__Raw.avals |e#0@@5|)))
...
(let ((|cond#0@@0| (AST.Expr__Raw.cond |e#0@@5|)))
 (and (and (AST.Expr__Raw.All $ly@@1 |cond#0@@0| |p#0|) (AST.Expr__Raw.All $ly@@1 |thn#0@@0| |p#0|)) (AST.Expr__Raw.All $ly@@1 |els#0@@0| |p#0|))))) (ite (AST.Expr__Raw.Op_q |e#0@@5|) (let ((|oe2#0| (AST.Expr__Raw.oe2 |e#0@@5|)))
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@5|)))
 (and (AST.Expr__Raw.All $ly@@1 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@1 |oe2#0| |p#0|)))) (let ((|es#0@@1| (AST.Expr__Raw.es |e#0@@5|)))
 ...
 :qid |ASTdfy.44:22|
 :skolemid |1164|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@1) |e#0@@5| |p#0|) ($IsGoodHeap $Heap@@1))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|e#0@@6| T@U) (|st'#0| T@U) (|v#0| Int) ) (!  (=> (or (|VarUnchanged.__default.P__Succ#canCall| |st#0@@4| (Lit DatatypeTypeType |e#0@@6|) |st'#0| |v#0|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@4| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@6| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0| Tclass.VarUnchanged.S)))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@4|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@6|) (VarUnchanged.MState.ctx |st#0@@4|))) (let ((|res#1@@1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@6|) (VarUnchanged.MState.ctx |st#0@@4|))))
 (and (|VarUnchanged.__default.Pre#canCall| |st#0@@4| (Lit DatatypeTypeType |e#0@@6|)) (=> (VarUnchanged.__default.Pre |st#0@@4| (Lit DatatypeTypeType |e#0@@6|)) (and (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@4| |res#1@@1|) (=> (VarUnchanged.__default.ResultSameX |st#0@@4| |res#1@@1|) (and (and (|$IsA#Utils.Result| |res#1@@1|) (VarUnchanged.MState.MState_q |st'#0|)) (=> (|Utils.Result#Equal| |res#1@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0|)) ($Box MapType (VarUnchanged.MState.ctx |st'#0|)))))) (and (and (|$IsA#Utils.Option| (VarUnchanged.MState.x |st'#0|)) (|$IsA#Utils.Option| (VarUnchanged.MState.x |st#0@@4|))) (and (VarUnchanged.MState.MState_q |st'#0|) (VarUnchanged.MState.MState_q |st#0@@4|))))))))))) (= (VarUnchanged.__default.P__Succ |st#0@@4| (Lit DatatypeTypeType |e#0@@6|) |st'#0| |v#0|) (let ((|res#1@@2| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@6|) (VarUnchanged.MState.ctx |st#0@@4|))))
 (and (and (and (VarUnchanged.__default.Pre |st#0@@4| (Lit DatatypeTypeType |e#0@@6|)) (VarUnchanged.__default.ResultSameX |st#0@@4| |res#1@@2|)) (|Utils.Result#Equal| |res#1@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0|)) ($Box MapType (VarUnchanged.MState.ctx |st'#0|))))))) (|Utils.Option#Equal| (VarUnchanged.MState.x |st'#0|) (VarUnchanged.MState.x |st#0@@4|)))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |730|
 :pattern ( (VarUnchanged.__default.P__Succ |st#0@@4| (Lit DatatypeTypeType |e#0@@6|) |st'#0| |v#0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@3 T@U) (|x#0@@0| T@U) (|e#0@@7| T@U) ) (!  (=> (or (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| (Lit DatatypeTypeType |e#0@@7|)) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |x#0@@0| (TSeq TChar)) ($Is DatatypeTypeType |e#0@@7| Tclass.AST.Expr)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@7|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@7|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@7|))))) (let ((|body#3| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@7|)))))
(let ((|bvals#3| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@7|)))))
(let ((|bvars#3| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@7|)))))
...
)) (=> (not (|Seq#Contains| |bvars#3| ($Box SeqType |x#0@@0|))) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |body#3|)))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@7|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@7|))))) (let ((|avals#3| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@7|)))))
(let ((|avars#3| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@7|)))))
...
)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@7|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@7|))))) (let ((|els#3| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@7|)))))
(let ((|thn#3| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@7|)))))
(let ((|cond#3| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@7|)))))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |cond#3|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |cond#3|) (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |thn#3|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |thn#3|) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |els#3|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@7|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@7|))))) (let ((|oe2#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@7|)))))
(let ((|oe1#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@7|)))))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |oe1#3|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |oe1#3|) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |oe2#3|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@7|)))))) (let ((|es#3| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@7|)))))
...
))))))))))))) (= (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| (Lit DatatypeTypeType |e#0@@7|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@7|)) (U_2_bool (Lit boolType (bool_2_U false))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@7|)) (U_2_bool (Lit boolType (bool_2_U false))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@7|)) (let ((|body#2| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@7|)))))
...
)) (or (|Seq#Contains| |bvars#2| ($Box SeqType |x#0@@0|)) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |body#2|)))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@7|)) (let ((|avals#2| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@7|)))))
...
))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@7|)) (let ((|els#2| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@7|)))))
(let ((|thn#2| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@7|)))))
(let ((|cond#2| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@7|)))))
 (and (and (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |cond#2|) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |thn#2|)) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |els#2|))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@7|)) (let ((|oe2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@7|)))))
(let ((|oe1#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@7|)))))
 (and (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |oe1#2|) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |oe2#2|)))) (let ((|es#2| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@7|)))))
(forall ((|e#9| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#9| Tclass.AST.Expr__Raw) (|Seq#Contains| |es#2| ($Box DatatypeTypeType |e#9|))) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |e#9|))
 ...
 :weight 3
 :skolemid |659|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| (Lit DatatypeTypeType |e#0@@7|)))
))))
(assert (forall (($ly@@4 T@U) (|x#0@@1| T@U) (|e#0@@8| T@U) ) (! (= (VarUnchanged.__default.VarUnchanged ($LS $ly@@4) |x#0@@1| |e#0@@8|) (VarUnchanged.__default.VarUnchanged $ly@@4 |x#0@@1| |e#0@@8|))
 :qid |VarUnchangeddfy.17:13|
 :skolemid |638|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@4) |x#0@@1| |e#0@@8|))
)))
(assert (forall (($ly@@5 T@U) (|e#0@@9| T@U) (|p#0@@0| T@U) ) (! (= (AST.Expr__Raw.All ($LS $ly@@5) |e#0@@9| |p#0@@0|) (AST.Expr__Raw.All $ly@@5 |e#0@@9| |p#0@@0|))
 :qid |ASTdfy.44:22|
 :skolemid |1153|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@5) |e#0@@9| |p#0@@0|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|e#0@@10| T@U) ) (!  (=> (or (|VarUnchanged.__default.P__Fail#canCall| |st#0@@5| (Lit DatatypeTypeType |e#0@@10|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@5| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@10| Tclass.AST.Expr)))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@5|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@10|) (VarUnchanged.MState.ctx |st#0@@5|))) (|VarUnchanged.__default.Pre#canCall| |st#0@@5| (Lit DatatypeTypeType |e#0@@10|))) (= (VarUnchanged.__default.P__Fail |st#0@@5| (Lit DatatypeTypeType |e#0@@10|)) (let ((|res#1@@3| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@10|) (VarUnchanged.MState.ctx |st#0@@5|))))
 (=> (VarUnchanged.__default.Pre |st#0@@5| (Lit DatatypeTypeType |e#0@@10|)) (Utils.Result.Failure_q |res#1@@3|))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |738|
 :pattern ( (VarUnchanged.__default.P__Fail |st#0@@5| (Lit DatatypeTypeType |e#0@@10|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|res#0| T@U) ) (!  (=> (or (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@6| |res#0|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |res#0| (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt))))))) (and (=> (Utils.Result.Success_q |res#0|) (and (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value |res#0|))) (let ((|ctx#1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#0|))))))
 (and (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value |res#0|))) (and (VarUnchanged.MState.MState_q |st#0@@6|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@6|)) (and (VarUnchanged.MState.MState_q |st#0@@6|) (=> (|Set#IsMember| (|Map#Domain| |ctx#1|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@6|))) (and (and (VarUnchanged.MState.MState_q |st#0@@6|) (VarUnchanged.MState.MState_q |st#0@@6|)) (VarUnchanged.MState.MState_q |st#0@@6|)))))))))) (= (VarUnchanged.__default.ResultSameX |st#0@@6| |res#0|) (ite (Utils.Result.Success_q |res#0|) (let ((|ctx#0@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#0|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@6|)) (and (|Set#IsMember| (|Map#Domain| |ctx#0@@2|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@6|))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (VarUnchanged.MState.ctx |st#0@@6|)) (Utils.Option.value (VarUnchanged.MState.x |st#0@@6|))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@2|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@6|))))))))) true))))
 :qid |VarUnchangeddfy.41:31|
 :skolemid |695|
 :pattern ( (VarUnchanged.__default.ResultSameX |st#0@@6| |res#0|))
))))
(assert (forall ((|e#0@@11| T@U) ) (!  (=> (or (|AST.Expr__Raw.WellFormed__Single#canCall| (Lit DatatypeTypeType |e#0@@11|)) ($Is DatatypeTypeType |e#0@@11| Tclass.AST.Expr__Raw)) (= (AST.Expr__Raw.WellFormed__Single (Lit DatatypeTypeType |e#0@@11|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@11|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@11|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@11|)) (let ((|bvals#2@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@11|)))))
(let ((|bvars#2@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@11|)))))
(= (|Seq#Length| |bvars#2@@0|) (|Seq#Length| |bvals#2@@0|)))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@11|)) (let ((|avals#2@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@11|)))))
(let ((|avars#2@@0| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@11|)))))
(= (|Seq#Length| |avars#2@@0|) (|Seq#Length| |avals#2@@0|)))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@11|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@11|)) (U_2_bool (Lit boolType (bool_2_U true))) (U_2_bool (Lit boolType (bool_2_U true)))))))))))
 :qid |ASTdfy.71:46|
 :weight 3
 :skolemid |1195|
 :pattern ( (AST.Expr__Raw.WellFormed__Single (Lit DatatypeTypeType |e#0@@11|)))
)))
...
(assert (forall (($ly@@6 T@U) (|e#0@@12| T@U) (|ctx#0@@3| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@12| |ctx#0@@3|) (and ($Is DatatypeTypeType |e#0@@12| Tclass.AST.Expr) ($Is MapType |ctx#0@@3| (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType (Interp.__default.InterpExpr $ly@@6 |e#0@@12| |ctx#0@@3|) (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))))
 :qid |Interpdfy.24:12|
 :skolemid |1212|
 :pattern ( (Interp.__default.InterpExpr $ly@@6 |e#0@@12| |ctx#0@@3|))
)))
(assert (forall (($ly@@7 T@U) (|e#0@@13| T@U) (|ctx#0@@4| T@U) ) (! (= (Interp.__default.InterpExpr ($LS $ly@@7) |e#0@@13| |ctx#0@@4|) (Interp.__default.InterpExpr $ly@@7 |e#0@@13| |ctx#0@@4|))
 :qid |Interpdfy.24:12|
 :skolemid |1210|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@7) |e#0@@13| |ctx#0@@4|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|e#0@@14| T@U) ) (!  (=> (or (|VarUnchanged.__default.P#canCall| |st#0@@7| |e#0@@14|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@7| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@14| Tclass.AST.Expr)))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@7|) (|Interp.__default.InterpExpr#canCall| |e#0@@14| (VarUnchanged.MState.ctx |st#0@@7|))) (let ((|res#0@@0| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@14| (VarUnchanged.MState.ctx |st#0@@7|))))
 (and (|VarUnchanged.__default.Pre#canCall| |st#0@@7| |e#0@@14|) (=> (VarUnchanged.__default.Pre |st#0@@7| |e#0@@14|) (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@7| |res#0@@0|))))) (= (VarUnchanged.__default.P |st#0@@7| |e#0@@14|) (let ((|res#0@@1| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@14| (VarUnchanged.MState.ctx |st#0@@7|))))
 (=> (VarUnchanged.__default.Pre |st#0@@7| |e#0@@14|) (VarUnchanged.__default.ResultSameX |st#0@@7| |res#0@@1|))))))
 :qid |Inductiondfy.34:21|
 :skolemid |721|
 :pattern ( (VarUnchanged.__default.P |st#0@@7| |e#0@@14|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@12 T@U) (|x#0@@2| T@U) (|e#0@@15| T@U) ) (!  (=> (or (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |e#0@@15|) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |x#0@@2| (TSeq TChar)) ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr)))) (and (=> (not (AST.Expr__Raw.Var_q |e#0@@15|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@15|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@15|) (let ((|body#1@@1| (AST.Expr__Raw.body |e#0@@15|)))
(let ((|bvals#1@@1| (AST.Expr__Raw.bvals |e#0@@15|)))
(let ((|bvars#1@@0| (AST.Expr__Raw.bvars |e#0@@15|)))
...
)) (=> (not (|Seq#Contains| |bvars#1@@0| ($Box SeqType |x#0@@2|))) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |body#1@@1|)))))))) (=> (not (AST.Expr__Raw.Bind_q |e#0@@15|)) (and (=> (AST.Expr__Raw.Assign_q |e#0@@15|) (let ((|avals#1@@1| (AST.Expr__Raw.avals |e#0@@15|)))
(let ((|avars#1@@0| (AST.Expr__Raw.avars |e#0@@15|)))
...
)))))) (=> (not (AST.Expr__Raw.Assign_q |e#0@@15|)) (and (=> (AST.Expr__Raw.If_q |e#0@@15|) (let ((|els#1@@1| (AST.Expr__Raw.els |e#0@@15|)))
(let ((|thn#1@@1| (AST.Expr__Raw.thn |e#0@@15|)))
(let ((|cond#1@@1| (AST.Expr__Raw.cond |e#0@@15|)))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |cond#1@@1|) (=> (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |cond#1@@1|) (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |thn#1@@1|) (=> (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |thn#1@@1|) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |els#1@@1|))))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@15|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@15|) (let ((|oe2#1@@0| (AST.Expr__Raw.oe2 |e#0@@15|)))
(let ((|oe1#1@@0| (AST.Expr__Raw.oe1 |e#0@@15|)))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |oe1#1@@0|) (=> (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |oe1#1@@0|) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |oe2#1@@0|)))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@15|)) (let ((|es#1@@1| (AST.Expr__Raw.es |e#0@@15|)))
...
))))))))))))) (= (VarUnchanged.__default.VarUnchanged ($LS $ly@@12) |x#0@@2| |e#0@@15|) (ite (AST.Expr__Raw.Var_q |e#0@@15|) (U_2_bool (Lit boolType (bool_2_U false))) (ite (AST.Expr__Raw.Literal_q |e#0@@15|) (U_2_bool (Lit boolType (bool_2_U false))) (ite (AST.Expr__Raw.Bind_q |e#0@@15|) (let ((|body#0@@1| (AST.Expr__Raw.body |e#0@@15|)))
(let ((|bvals#0@@2| (AST.Expr__Raw.bvals |e#0@@15|)))
(let ((|bvars#0@@1| (AST.Expr__Raw.bvars |e#0@@15|)))
...
)) (or (|Seq#Contains| |bvars#0@@1| ($Box SeqType |x#0@@2|)) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |body#0@@1|)))))) (ite (AST.Expr__Raw.Assign_q |e#0@@15|) (let ((|avals#0@@2| (AST.Expr__Raw.avals |e#0@@15|)))
(let ((|avars#0@@1| (AST.Expr__Raw.avars |e#0@@15|)))
...
))))) (ite (AST.Expr__Raw.If_q |e#0@@15|) (let ((|els#0@@1| (AST.Expr__Raw.els |e#0@@15|)))
(let ((|thn#0@@1| (AST.Expr__Raw.thn |e#0@@15|)))
(let ((|cond#0@@1| (AST.Expr__Raw.cond |e#0@@15|)))
 (and (and (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |cond#0@@1|) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |thn#0@@1|)) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |els#0@@1|))))) (ite (AST.Expr__Raw.Op_q |e#0@@15|) (let ((|oe2#0@@0| (AST.Expr__Raw.oe2 |e#0@@15|)))
(let ((|oe1#0@@0| (AST.Expr__Raw.oe1 |e#0@@15|)))
 (and (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |oe1#0@@0|) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |oe2#0@@0|)))) (let ((|es#0@@5| (AST.Expr__Raw.es |e#0@@15|)))
(forall ((|e#3@@0| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#3@@0| Tclass.AST.Expr__Raw) (|Seq#Contains| |es#0@@5| ($Box DatatypeTypeType |e#3@@0|))) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |e#3@@0|))
 ...
 :qid |VarUnchangeddfy.17:13|
 :skolemid |651|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@12) |x#0@@2| |e#0@@15|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|e#0@@16| T@U) (|st'#0@@0| T@U) (|v#0@@1| Int) ) (!  (=> (or (|VarUnchanged.__default.P__Succ#canCall| (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |e#0@@16|) (Lit DatatypeTypeType |st'#0@@0|) (LitInt |v#0@@1|)) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@8| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@16| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@0| Tclass.VarUnchanged.S)))) (and (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@8|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@16|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@8|))))) (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@16|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@8|)))))))
 (and (|VarUnchanged.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |e#0@@16|)) (=> (U_2_bool (Lit boolType (bool_2_U (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |e#0@@16|))))) (and (|VarUnchanged.__default.ResultSameX#canCall| (Lit DatatypeTypeType |st#0@@8|) |res#2@@0|) (=> (VarUnchanged.__default.ResultSameX (Lit DatatypeTypeType |st#0@@8|) |res#2@@0|) (and (and (|$IsA#Utils.Result| |res#2@@0|) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|))) (=> (|Utils.Result#Equal| |res#2@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt |v#0@@1|))) ($Box MapType (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st'#0@@0|))))))))) (and (and (|$IsA#Utils.Option| (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st'#0@@0|)))) (|$IsA#Utils.Option| (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@8|))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|)) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@8|)))))))))))) (= (VarUnchanged.__default.P__Succ (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |e#0@@16|) (Lit DatatypeTypeType |st'#0@@0|) (LitInt |v#0@@1|)) (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@16|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@8|)))))))
 (and (and (and (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |e#0@@16|)) (VarUnchanged.__default.ResultSameX (Lit DatatypeTypeType |st#0@@8|) |res#2@@1|)) (|Utils.Result#Equal| |res#2@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt |v#0@@1|))) ($Box MapType (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st'#0@@0|)))))))))) (|Utils.Option#Equal| (VarUnchanged.MState.x (Lit DatatypeTypeType |st'#0@@0|)) (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@8|))))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |731|
 :pattern ( (VarUnchanged.__default.P__Succ (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |e#0@@16|) (Lit DatatypeTypeType |st'#0@@0|) (LitInt |v#0@@1|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@9| T@U) (|e#0@@17| T@U) ) (!  (=> (or (|VarUnchanged.__default.P__Fail#canCall| |st#0@@9| |e#0@@17|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@9| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@17| Tclass.AST.Expr)))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@9|) (|Interp.__default.InterpExpr#canCall| |e#0@@17| (VarUnchanged.MState.ctx |st#0@@9|))) (|VarUnchanged.__default.Pre#canCall| |st#0@@9| |e#0@@17|)) (= (VarUnchanged.__default.P__Fail |st#0@@9| |e#0@@17|) (let ((|res#0@@2| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@17| (VarUnchanged.MState.ctx |st#0@@9|))))
 (=> (VarUnchanged.__default.Pre |st#0@@9| |e#0@@17|) (Utils.Result.Failure_q |res#0@@2|))))))
 :qid |Inductiondfy.36:26|
 :skolemid |737|
 :pattern ( (VarUnchanged.__default.P__Fail |st#0@@9| |e#0@@17|))
))))
...
(assert (forall (($ly@@14 T@U) (|e#0@@19| T@U) (|ctx#0@@8| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@19|) (Lit MapType |ctx#0@@8|)) (and ($Is DatatypeTypeType |e#0@@19| Tclass.AST.Expr) ($Is MapType |ctx#0@@8| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@19|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@19|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@19|))))) (let ((|body#5| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@19|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#5| |v1#5| |v2#5|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@19|)))))) (let ((|es#5| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@19|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#5|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@14) (Lit DatatypeTypeType |e#0@@19|) (Lit MapType |ctx#0@@8|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@19|)) (let ((|name#4| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@19|)))))
...
(Lit DatatypeTypeType (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#4|)) ($Box MapType (Lit MapType |ctx#0@@8|)))))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@19|)) (let ((|body#4| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@19|)))))
...
(ite  (or (not (= |condv#4| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@14) |thn#4| |ctx_cond#4|) (Interp.__default.InterpExpr ($LS $ly@@14) |els#4| |ctx_cond#4|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@19|)) (let ((|e2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@19|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1216|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@14) (Lit DatatypeTypeType |e#0@@19|) (Lit MapType |ctx#0@@8|)))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@15 T@U) (|x#0@@3| T@U) (|e#0@@20| T@U) ) (!  (=> (or (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) (Lit DatatypeTypeType |e#0@@20|)) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |x#0@@3| (TSeq TChar)) ($Is DatatypeTypeType |e#0@@20| Tclass.AST.Expr)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@20|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@20|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@20|))))) (let ((|body#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@20|)))))
...
)) (=> (not (|Seq#Contains| |bvars#5@@0| ($Box SeqType |x#0@@3|))) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |body#5@@0|)))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@20|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@20|))))) (let ((|avals#5@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@20|)))))
...
)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@20|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@20|))))) (let ((|els#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@20|)))))
...
(let ((|cond#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@20|)))))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |cond#5@@0|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |cond#5@@0|) (and (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |thn#5@@0|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |thn#5@@0|) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |els#5@@0|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@20|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@20|))))) (let ((|oe2#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|oe1#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@20|)))))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |oe1#5|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |oe1#5|) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |oe2#5|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@20|)))))) (let ((|es#5@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@20|)))))
...
))))))))))))) (= (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) (Lit DatatypeTypeType |e#0@@20|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@20|)) (U_2_bool (Lit boolType (bool_2_U false))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@20|)) (U_2_bool (Lit boolType (bool_2_U false))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@20|)) (let ((|body#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@20|)))))
...
)) (or (|Seq#Contains| |bvars#4@@0| ($Box SeqType |x#0@@3|)) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |body#4@@0|)))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@20|)) (let ((|avals#4@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@20|)))))
...
))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@20|)) (U_2_bool (let ((|els#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@20|)))))
...
(Lit boolType (bool_2_U  (and (and (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |cond#4@@0|) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |thn#4@@0|)) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |els#4@@0|)))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@20|)) (U_2_bool (let ((|oe2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|oe1#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@20|)))))
(Lit boolType (bool_2_U  (and (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |oe1#4|) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |oe2#4|))))))) (let ((|es#4@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@20|)))))
(forall ((|e#15| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#15| Tclass.AST.Expr__Raw) (|Seq#Contains| |es#4@@0| ($Box DatatypeTypeType |e#15|))) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |e#15|))
 ...
 :weight 3
 :skolemid |667|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) (Lit DatatypeTypeType |e#0@@20|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@10| T@U) (|e#0@@21| T@U) ) (!  (=> (or (|VarUnchanged.__default.P#canCall| (Lit DatatypeTypeType |st#0@@10|) (Lit DatatypeTypeType |e#0@@21|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@10| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@21| Tclass.AST.Expr)))) (and (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@10|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@21|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@10|))))) (let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@21|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@10|)))))))
 (and (|VarUnchanged.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@10|) (Lit DatatypeTypeType |e#0@@21|)) (=> (U_2_bool (Lit boolType (bool_2_U (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@10|) (Lit DatatypeTypeType |e#0@@21|))))) (|VarUnchanged.__default.ResultSameX#canCall| (Lit DatatypeTypeType |st#0@@10|) |res#2@@2|))))) (= (VarUnchanged.__default.P (Lit DatatypeTypeType |st#0@@10|) (Lit DatatypeTypeType |e#0@@21|)) (U_2_bool (let ((|res#2@@3| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@21|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@10|)))))))
(Lit boolType (bool_2_U  (=> (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@10|) (Lit DatatypeTypeType |e#0@@21|)) (VarUnchanged.__default.ResultSameX (Lit DatatypeTypeType |st#0@@10|) |res#2@@3|)))))))))
 :qid |Inductiondfy.34:21|
 :weight 3
 :skolemid |723|
 :pattern ( (VarUnchanged.__default.P (Lit DatatypeTypeType |st#0@@10|) (Lit DatatypeTypeType |e#0@@21|)))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@11| T@U) (|res#0@@3| T@U) ) (!  (=> (or (|VarUnchanged.__default.ResultSameX#canCall| (Lit DatatypeTypeType |st#0@@11|) (Lit DatatypeTypeType |res#0@@3|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@11| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |res#0@@3| (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt))))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@3|))))) (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@3|))))) (let ((|ctx#3| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@3|)))))))))
 (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@3|))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@11|)) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@11|))))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@11|)) (=> (|Set#IsMember| (|Map#Domain| |ctx#3|) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@11|)))))))) (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@11|)) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@11|))) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@11|))))))))))) (= (VarUnchanged.__default.ResultSameX (Lit DatatypeTypeType |st#0@@11|) (Lit DatatypeTypeType |res#0@@3|)) (ite (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@3|)) (let ((|ctx#2| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@3|)))))))))
 (=> (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@11|)))) (and (|Set#IsMember| (Lit SetType (|Map#Domain| |ctx#2|)) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@11|)))))))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@11|)))) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@11|)))))))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#2|) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@11|)))))))))))))) true))))
 :qid |VarUnchangeddfy.41:31|
 :weight 3
 :skolemid |696|
 :pattern ( (VarUnchanged.__default.ResultSameX (Lit DatatypeTypeType |st#0@@11|) (Lit DatatypeTypeType |res#0@@3|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@12| T@U) (|e#0@@22| T@U) (|st'#0@@1| T@U) (|v#0@@2| Int) ) (!  (=> (or (|VarUnchanged.__default.P__Succ#canCall| |st#0@@12| |e#0@@22| |st'#0@@1| |v#0@@2|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@12| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@22| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@1| Tclass.VarUnchanged.S)))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@12|) (|Interp.__default.InterpExpr#canCall| |e#0@@22| (VarUnchanged.MState.ctx |st#0@@12|))) (let ((|res#0@@4| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@22| (VarUnchanged.MState.ctx |st#0@@12|))))
 (and (|VarUnchanged.__default.Pre#canCall| |st#0@@12| |e#0@@22|) (=> (VarUnchanged.__default.Pre |st#0@@12| |e#0@@22|) (and (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@12| |res#0@@4|) (=> (VarUnchanged.__default.ResultSameX |st#0@@12| |res#0@@4|) (and (and (|$IsA#Utils.Result| |res#0@@4|) (VarUnchanged.MState.MState_q |st'#0@@1|)) (=> (|Utils.Result#Equal| |res#0@@4| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0@@2|)) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@1|)))))) (and (and (|$IsA#Utils.Option| (VarUnchanged.MState.x |st'#0@@1|)) (|$IsA#Utils.Option| (VarUnchanged.MState.x |st#0@@12|))) (and (VarUnchanged.MState.MState_q |st'#0@@1|) (VarUnchanged.MState.MState_q |st#0@@12|))))))))))) (= (VarUnchanged.__default.P__Succ |st#0@@12| |e#0@@22| |st'#0@@1| |v#0@@2|) (let ((|res#0@@5| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@22| (VarUnchanged.MState.ctx |st#0@@12|))))
 (and (and (and (VarUnchanged.__default.Pre |st#0@@12| |e#0@@22|) (VarUnchanged.__default.ResultSameX |st#0@@12| |res#0@@5|)) (|Utils.Result#Equal| |res#0@@5| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0@@2|)) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@1|))))))) (|Utils.Option#Equal| (VarUnchanged.MState.x |st'#0@@1|) (VarUnchanged.MState.x |st#0@@12|)))))))
 :qid |Inductiondfy.35:26|
 :skolemid |729|
 :pattern ( (VarUnchanged.__default.P__Succ |st#0@@12| |e#0@@22| |st'#0@@1| |v#0@@2|))
))))
...
(assert (forall (($ly@@17 T@U) (|e#0@@23| T@U) (|ctx#0@@9| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@23|) |ctx#0@@9|) (and ($Is DatatypeTypeType |e#0@@23| Tclass.AST.Expr) ($Is MapType |ctx#0@@9| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@23|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@23|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@23|))))) (let ((|body#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@23|)))))
(let ((|bvals#3@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@23|)))))
(let ((|bvars#3@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@23|)))))
...
(|Interp.__default.VarsAndValuesToContext#canCall| |avars#3@@0| |vs#10|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@23|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@23|))))) (let ((|els#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@23|)))))
(let ((|thn#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@23|)))))
(let ((|cond#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@23|)))))
...
(let ((|condv#3| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError3#3|)))))))
 (and (=> (or (not (= |condv#3| 0)) (not true)) (|Interp.__default.InterpExpr#canCall| |thn#3@@0| |ctx_cond#3|)) (=> (= |condv#3| 0) (|Interp.__default.InterpExpr#canCall| |els#3@@0| |ctx_cond#3|)))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@23|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@23|))))) (let ((|e2#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@23|)))))
(let ((|e1#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@23|)))))
(let ((|op#3| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@23|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#3| |v1#3| |v2#3|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@23|)))))) (let ((|es#3@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@23|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#3|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@17) (Lit DatatypeTypeType |e#0@@23|) |ctx#0@@9|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@23|)) (let ((|name#2| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@23|)))))
(ite (|Set#IsMember| (|Map#Domain| |ctx#0@@9|) ($Box SeqType |name#2|)) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@9|) ($Box SeqType |name#2|)) ($Box MapType |ctx#0@@9|)))) |#Utils.Result.Failure|)) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@23|)) (let ((|n#2| (LitInt (AST.Expr__Raw.n (Lit DatatypeTypeType |e#0@@23|)))))
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#2|)) ($Box MapType |ctx#0@@9|))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@23|)) (let ((|body#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@23|)))))
(let ((|bvals#2@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@23|)))))
(let ((|bvars#2@@1| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@23|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |bodyv#2|)) ($Box MapType |ctx4#2|)))))))))))))))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@23|)) (let ((|avals#2@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@23|)))))
(let ((|avars#2@@1| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@23|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType (|Map#Merge| |ctx1#9| |bindings#5|)))))))))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@23|)) (let ((|els#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@23|)))))
(let ((|thn#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@23|)))))
(let ((|cond#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@23|)))))
...
(ite  (or (not (= |condv#2| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@17) |thn#2@@0| |ctx_cond#2|) (Interp.__default.InterpExpr ($LS $ly@@17) |els#2@@0| |ctx_cond#2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@23|)) (let ((|e2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@23|)))))
(let ((|e1#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@23|)))))
(let ((|op#2| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@23|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#2| |v1#2| |v2#2|))) ($Box MapType |ctx2#5|))))))))))))))) (let ((|es#2@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@23|)))))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1215|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@17) (Lit DatatypeTypeType |e#0@@23|) |ctx#0@@9|))
)))
...
(let ((|cond#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@24|)))))
 (and (|AST.Expr__Raw.All#canCall| |cond#3@@1| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@19) |cond#3@@1| |p#0@@1|) (and (|AST.Expr__Raw.All#canCall| |thn#3@@1| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@19) |thn#3@@1| |p#0@@1|) (|AST.Expr__Raw.All#canCall| |els#3@@1| |p#0@@1|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@24|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@24|))))) (let ((|oe2#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|oe1#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@24|)))))
 (and (|AST.Expr__Raw.All#canCall| |oe1#3@@0| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@19) |oe1#3@@0| |p#0@@1|) (|AST.Expr__Raw.All#canCall| |oe2#3@@0| |p#0@@1|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@24|)))))) (let ((|es#3@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@24|)))))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@19) (Lit DatatypeTypeType |e#0@@24|) |p#0@@1|)  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@2 |p#0@@1| ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@24|))))) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@24|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@24|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@24|)) (let ((|body#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@24|)))))
...
)) (AST.Expr__Raw.All ($LS $ly@@19) |body#2@@1| |p#0@@1|)))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@24|)) (let ((|avals#2@@2| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@24|)))))
...
(let ((|cond#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@24|)))))
 (and (and (AST.Expr__Raw.All ($LS $ly@@19) |cond#2@@1| |p#0@@1|) (AST.Expr__Raw.All ($LS $ly@@19) |thn#2@@1| |p#0@@1|)) (AST.Expr__Raw.All ($LS $ly@@19) |els#2@@1| |p#0@@1|))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@24|)) (let ((|oe2#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|oe1#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@24|)))))
 (and (AST.Expr__Raw.All ($LS $ly@@19) |oe1#2@@0| |p#0@@1|) (AST.Expr__Raw.All ($LS $ly@@19) |oe2#2@@0| |p#0@@1|)))) (let ((|es#2@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@24|)))))
 ...
 :weight 3
 :skolemid |1172|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@19) (Lit DatatypeTypeType |e#0@@24|) |p#0@@1|) ($IsGoodHeap $Heap@@2))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@13| T@U) (|e#0@@25| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@13|) (Lit DatatypeTypeType |e#0@@25|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@13| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@25| Tclass.AST.Expr)))) (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@13|)) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@13|))))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@13|)) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@13|)))))) (Lit DatatypeTypeType |e#0@@25|))))) (= (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@13|) (Lit DatatypeTypeType |e#0@@25|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@13|)))) (VarUnchanged.__default.VarUnchanged ($LS $LZ) (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@13|)))))) (Lit DatatypeTypeType |e#0@@25|)))))))))
 :qid |VarUnchangeddfy.82:23|
 :weight 3
 :skolemid |705|
 :pattern ( (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@13|) (Lit DatatypeTypeType |e#0@@25|)))
))))
...
(assert (forall ((|e#0@@26| T@U) ) (! (= ($Is DatatypeTypeType |e#0@@26| Tclass.AST.Expr)  (and ($Is DatatypeTypeType |e#0@@26| Tclass.AST.Expr__Raw) (AST.Expr__Raw.WellFormed |e#0@@26|)))
 :qid |unknown.0:0|
 :skolemid |1204|
 :pattern ( ($Is DatatypeTypeType |e#0@@26| Tclass.AST.Expr))
)))
...
(assert (forall (($ly@@20 T@U) ($Heap@@4 T@U) (|e#0@@27| T@U) (|p#0@@2| T@U) ) (!  (=> (or (|AST.Expr__Raw.All#canCall| (Lit DatatypeTypeType |e#0@@27|) (Lit HandleTypeType |p#0@@2|)) (and (and ($IsGoodHeap $Heap@@4) ($Is DatatypeTypeType |e#0@@27| Tclass.AST.Expr__Raw)) ($Is HandleTypeType |p#0@@2| (Tclass._System.___hTotalFunc1 Tclass.AST.Expr__Raw TBool)))) (and (=> (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@4 (Lit HandleTypeType |p#0@@2|) ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@27|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@27|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@27|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@27|))))) (let ((|body#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@27|)))))
(let ((|bvals#5@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@27|)))))
...
)) (|AST.Expr__Raw.All#canCall| |body#5@@1| (Lit HandleTypeType |p#0@@2|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@27|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@27|))))) (let ((|avals#5@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@27|)))))
...
))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@27|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@27|))))) (let ((|els#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@27|)))))
(let ((|thn#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@27|)))))
(let ((|cond#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@27|)))))
 (and (|AST.Expr__Raw.All#canCall| |cond#5@@1| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@20) |cond#5@@1| (Lit HandleTypeType |p#0@@2|)) (and (|AST.Expr__Raw.All#canCall| |thn#5@@1| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@20) |thn#5@@1| (Lit HandleTypeType |p#0@@2|)) (|AST.Expr__Raw.All#canCall| |els#5@@1| (Lit HandleTypeType |p#0@@2|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@27|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@27|))))) (let ((|oe2#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@27|)))))
(let ((|oe1#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@27|)))))
 (and (|AST.Expr__Raw.All#canCall| |oe1#5@@0| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@20) |oe1#5@@0| (Lit HandleTypeType |p#0@@2|)) (|AST.Expr__Raw.All#canCall| |oe2#5@@0| (Lit HandleTypeType |p#0@@2|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@27|)))))) (let ((|es#5@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@27|)))))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@20) (Lit DatatypeTypeType |e#0@@27|) (Lit HandleTypeType |p#0@@2|))  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@4 (Lit HandleTypeType |p#0@@2|) ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@27|))))) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@27|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@27|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@27|)) (let ((|body#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@27|)))))
(let ((|bvals#4@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@27|)))))
...
)) (AST.Expr__Raw.All ($LS $ly@@20) |body#4@@1| (Lit HandleTypeType |p#0@@2|))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@27|)) (let ((|avals#4@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@27|)))))
...
)))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@27|)) (U_2_bool (let ((|els#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@27|)))))
(let ((|thn#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@27|)))))
(let ((|cond#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@27|)))))
(Lit boolType (bool_2_U  (and (and (AST.Expr__Raw.All ($LS $ly@@20) |cond#4@@1| (Lit HandleTypeType |p#0@@2|)) (AST.Expr__Raw.All ($LS $ly@@20) |thn#4@@1| (Lit HandleTypeType |p#0@@2|))) (AST.Expr__Raw.All ($LS $ly@@20) |els#4@@1| (Lit HandleTypeType |p#0@@2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@27|)) (U_2_bool (let ((|oe2#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@27|)))))
(let ((|oe1#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@27|)))))
(Lit boolType (bool_2_U  (and (AST.Expr__Raw.All ($LS $ly@@20) |oe1#4@@0| (Lit HandleTypeType |p#0@@2|)) (AST.Expr__Raw.All ($LS $ly@@20) |oe2#4@@0| (Lit HandleTypeType |p#0@@2|)))))))) (let ((|es#4@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@27|)))))
 ...
 :weight 3
 :skolemid |1180|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@20) (Lit DatatypeTypeType |e#0@@27|) (Lit HandleTypeType |p#0@@2|)) ($IsGoodHeap $Heap@@4))
)))
...
(set-info :boogie-vc-id Impl$$VarUnchanged.__default.InductIf__Succ)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|VarUnchanged.__default.P#canCall| |st#0@@14| |e#0@@28|) (or (VarUnchanged.__default.P |st#0@@14| |e#0@@28|) (let ((|res#1@@4| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@28| (VarUnchanged.MState.ctx |st#0@@14|))))
 (=> (VarUnchanged.__default.Pre |st#0@@14| |e#0@@28|) (=> (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@14| |res#1@@4|) (or (VarUnchanged.__default.ResultSameX |st#0@@14| |res#1@@4|) (=> (Utils.Result.Success_q |res#1@@4|) (let ((|ctx#2@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@4|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@14|)) (|Set#IsMember| (|Map#Domain| |ctx#2@@0|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@14|))))))))))))) (=> (=> (|VarUnchanged.__default.P#canCall| |st#0@@14| |e#0@@28|) (or (VarUnchanged.__default.P |st#0@@14| |e#0@@28|) (let ((|res#1@@5| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@28| (VarUnchanged.MState.ctx |st#0@@14|))))
 (=> (VarUnchanged.__default.Pre |st#0@@14| |e#0@@28|) (=> (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@14| |res#1@@5|) (or (VarUnchanged.__default.ResultSameX |st#0@@14| |res#1@@5|) (=> (Utils.Result.Success_q |res#1@@5|) (let ((|ctx#2@@1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@5|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@14|)) (|Set#IsMember| (|Map#Domain| |ctx#2@@1|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@14|)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|VarUnchanged.__default.P#canCall| |st#0@@14| |e#0@@28|) (or (VarUnchanged.__default.P |st#0@@14| |e#0@@28|) (let ((|res#1@@6| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@28| (VarUnchanged.MState.ctx |st#0@@14|))))
 (=> (VarUnchanged.__default.Pre |st#0@@14| |e#0@@28|) (=> (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@14| |res#1@@6|) (or (VarUnchanged.__default.ResultSameX |st#0@@14| |res#1@@6|) (=> (Utils.Result.Success_q |res#1@@6|) (let ((|ctx#2@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@6|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@14|)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (VarUnchanged.MState.ctx |st#0@@14|)) (Utils.Option.value (VarUnchanged.MState.x |st#0@@14|))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#2@@2|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@14|)))))))))))))))) (=> (=> (|VarUnchanged.__default.P#canCall| |st#0@@14| |e#0@@28|) (or (VarUnchanged.__default.P |st#0@@14| |e#0@@28|) (let ((|res#1@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@28| (VarUnchanged.MState.ctx |st#0@@14|))))
 (=> (VarUnchanged.__default.Pre |st#0@@14| |e#0@@28|) (=> (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@14| |res#1@@7|) (or (VarUnchanged.__default.ResultSameX |st#0@@14| |res#1@@7|) (=> (Utils.Result.Success_q |res#1@@7|) (let ((|ctx#2@@3| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@7|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@14|)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (VarUnchanged.MState.ctx |st#0@@14|)) (Utils.Option.value (VarUnchanged.MState.x |st#0@@14|))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#2@@3|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@14|))))))))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|VarUnchanged.__default.P#canCall| |st#0@@14| |e#0@@28|) (or (VarUnchanged.__default.P |st#0@@14| |e#0@@28|) (let ((|res#1@@8| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@28| (VarUnchanged.MState.ctx |st#0@@14|))))
 (=> (VarUnchanged.__default.Pre |st#0@@14| |e#0@@28|) (=> (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@14| |res#1@@8|) (or (VarUnchanged.__default.ResultSameX |st#0@@14| |res#1@@8|) (=> (not (Utils.Result.Success_q |res#1@@8|)) (U_2_bool (Lit boolType (bool_2_U true))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@14| Tclass.VarUnchanged.S) ($IsAlloc DatatypeTypeType |st#0@@14| Tclass.VarUnchanged.S $Heap@@6)) (|$IsA#VarUnchanged.MState| |st#0@@14|)) (=> (and (and (and (and (and ($Is DatatypeTypeType |e#0@@28| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@28| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@28|)) (and (and ($Is DatatypeTypeType |cond#0@@2| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |cond#0@@2| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |cond#0@@2|))) (and (and (and ($Is DatatypeTypeType |thn#0@@2| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |thn#0@@2| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |thn#0@@2|)) (and (and ($Is DatatypeTypeType |els#0@@2| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |els#0@@2| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |els#0@@2|)))) (and (and (and (and ($Is DatatypeTypeType |st_cond#0| Tclass.VarUnchanged.S) ($IsAlloc DatatypeTypeType |st_cond#0| Tclass.VarUnchanged.S $Heap@@6)) (|$IsA#VarUnchanged.MState| |st_cond#0|)) (and (= 4 $FunctionContextHeight) (AST.Expr__Raw.If_q |e#0@@28|))) (and (and (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.cond |e#0@@28|) |cond#0@@2|) (|AST.Expr__Raw#Equal| (AST.Expr__Raw.thn |e#0@@28|) |thn#0@@2|)) (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.els |e#0@@28|) |els#0@@2|) (not (VarUnchanged.__default.P__Fail |st#0@@14| |e#0@@28|)))) (and (and (VarUnchanged.__default.P__Succ |st#0@@14| |cond#0@@2| |st_cond#0| |condv#0@@0|) (VarUnchanged.__default.P |st_cond#0| |thn#0@@2|)) (and (VarUnchanged.__default.P |st_cond#0| |els#0@@2|) (= (ControlFlow 0 5) 2)))))) anon0_correct)))))
