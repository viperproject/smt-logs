...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0| T@U) (|vars#0| T@U) (|vals#0| T@U) ) (!  (=> (or (|Induction.__default.BindStartScope#canCall| |st#0| |vars#0| |vals#0|) (and (< 1 $FunctionContextHeight) (and (and (and ($IsBox |st#0| Tclass.Induction.S) ($Is SeqType |vars#0| (TSeq (TSeq TChar)))) ($IsBox |vals#0| Tclass.Induction.VS)) (Induction.__default.UpdateState__Pre |st#0| |vars#0| |vals#0|)))) ($IsBox (Induction.__default.BindStartScope |st#0| |vars#0| |vals#0|) Tclass.Induction.S))
 :qid |Inductiondfy.58:33|
 :skolemid |662|
 :pattern ( (Induction.__default.BindStartScope |st#0| |vars#0| |vals#0|))
))))
...
(set-info :boogie-vc-id CheckWellFormed$$Induction.__default.InductBind__Fail)
...
(let ((anon5_Else_correct  (=> (and (=> (Induction.__default.Pes__Succ |st#0@@0| |bvals#0@@1| |st1#0@0| |vs#0@0|) (and (Induction.__default.UpdateState__Pre |st1#0@0| |bvars#0@@0| |vs#0@0|) (not (Induction.__default.P__Fail (Induction.__default.BindStartScope |st1#0@0| |bvars#0@@0| |vs#0@0|) |body#0@@0|)))) (= (ControlFlow 0 4) 1)) anon4_correct)))
(let ((anon5_Then_correct  (=> (and ($IsAllocBox |st#0@@0| Tclass.Induction.S $Heap@0) ($IsAlloc SeqType |bvals#0@@1| (TSeq Tclass.AST.Expr) $Heap@0)) (=> (and (and ($IsAllocBox |st1#0@0| Tclass.Induction.S $Heap@0) ($IsAllocBox |vs#0@0| Tclass.Induction.VS $Heap@0)) (and (|Induction.__default.Pes__Succ#canCall| |st#0@@0| |bvals#0@@1| |st1#0@0| |vs#0@0|) (Induction.__default.Pes__Succ |st#0@@0| |bvals#0@@1| |st1#0@0| |vs#0@0|))) (=> (and (and (and ($IsAllocBox |st1#0@0| Tclass.Induction.S $Heap@0) ($IsAlloc SeqType |bvars#0@@0| (TSeq (TSeq TChar)) $Heap@0)) (and ($IsAllocBox |vs#0@0| Tclass.Induction.VS $Heap@0) (|Induction.__default.UpdateState__Pre#canCall| |st1#0@0| |bvars#0@@0| |vs#0@0|))) (and (and (Induction.__default.UpdateState__Pre |st1#0@0| |bvars#0@@0| |vs#0@0|) ($IsAllocBox |st1#0@0| Tclass.Induction.S $Heap@0)) (and ($IsAlloc SeqType |bvars#0@@0| (TSeq (TSeq TChar)) $Heap@0) ($IsAllocBox |vs#0@0| Tclass.Induction.VS $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (Induction.__default.UpdateState__Pre |st1#0@0| |bvars#0@@0| |vs#0@0|)) (=> (and (and (and (Induction.__default.UpdateState__Pre |st1#0@0| |bvars#0@@0| |vs#0@0|) (|Induction.__default.BindStartScope#canCall| |st1#0@0| |bvars#0@@0| |vs#0@0|)) (and (= |##st#5@0| (Induction.__default.BindStartScope |st1#0@0| |bvars#0@@0| |vs#0@0|)) ($IsAllocBox |##st#5@0| Tclass.Induction.S $Heap@0))) (and (and ($IsAlloc DatatypeTypeType |body#0@@0| Tclass.AST.Expr $Heap@0) (|Induction.__default.P__Fail#canCall| (Induction.__default.BindStartScope |st1#0@0| |bvars#0@@0| |vs#0@0|) |body#0@@0|)) (and (not (Induction.__default.P__Fail (Induction.__default.BindStartScope |st1#0@0| |bvars#0@@0| |vs#0@0|) |body#0@@0|)) (= (ControlFlow 0 2) 1)))) anon4_correct)))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (AST.Expr__Raw.Bind_q |e#0@@8|)) (and (=> (= (ControlFlow 0 5) (- 0 8)) (AST.Expr__Raw.Bind_q |e#0@@8|)) (=> (AST.Expr__Raw.Bind_q |e#0@@8|) (=> (|Seq#Equal| (AST.Expr__Raw.bvars |e#0@@8|) |bvars#0@@0|) (and (=> (= (ControlFlow 0 5) (- 0 7)) (AST.Expr__Raw.Bind_q |e#0@@8|)) (=> (AST.Expr__Raw.Bind_q |e#0@@8|) (=> (|Seq#Equal| (AST.Expr__Raw.bvals |e#0@@8|) |bvals#0@@1|) (and (=> (= (ControlFlow 0 5) (- 0 6)) (AST.Expr__Raw.Bind_q |e#0@@8|)) (=> (AST.Expr__Raw.Bind_q |e#0@@8|) (=> (|AST.Expr__Raw#Equal| (AST.Expr__Raw.body |e#0@@8|) |body#0@@0|) (=> (and (and ($IsAllocBox |st#0@@0| Tclass.Induction.S $Heap@@4) ($IsAlloc DatatypeTypeType |e#0@@8| Tclass.AST.Expr $Heap@@4)) (and (|Induction.__default.P__Fail#canCall| |st#0@@0| |e#0@@8|) (not (Induction.__default.P__Fail |st#0@@0| |e#0@@8|)))) (=> (and (and (and (and ($IsAllocBox |st#0@@0| Tclass.Induction.S $Heap@@4) ($IsAlloc SeqType |bvals#0@@1| (TSeq Tclass.AST.Expr) $Heap@@4)) (and (|Induction.__default.Pes#canCall| |st#0@@0| |bvals#0@@1|) (Induction.__default.Pes |st#0@@0| |bvals#0@@1|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@4 $Heap@0))) (and (and (and ($IsAllocBox |st#0@@0| Tclass.Induction.S $Heap@0) ($IsAlloc SeqType |bvals#0@@1| (TSeq Tclass.AST.Expr) $Heap@0)) (and (|Induction.__default.Pes__Fail#canCall| |st#0@@0| |bvals#0@@1|) (not (Induction.__default.Pes__Fail |st#0@@0| |bvals#0@@1|)))) (and (and ($IsBox |st1#0@0| Tclass.Induction.S) ($IsAllocBox |st1#0@0| Tclass.Induction.S $Heap@0)) (and ($IsBox |vs#0@0| Tclass.Induction.VS) ($IsAllocBox |vs#0@0| Tclass.Induction.VS $Heap@0))))) (and (=> (= (ControlFlow 0 5) 2) anon5_Then_correct) (=> (= (ControlFlow 0 5) 4) anon5_Else_correct))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (and ($IsBox |st#0@@0| Tclass.Induction.S) ($IsAllocBox |st#0@@0| Tclass.Induction.S $Heap@@4))) (=> (and (and (and (and ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@8| Tclass.AST.Expr $Heap@@4)) (|$IsA#AST.Expr__Raw| |e#0@@8|)) (and (and ($Is SeqType |bvars#0@@0| (TSeq (TSeq TChar))) ($IsAlloc SeqType |bvars#0@@0| (TSeq (TSeq TChar)) $Heap@@4)) (and ($Is SeqType |bvals#0@@1| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |bvals#0@@1| (TSeq Tclass.AST.Expr) $Heap@@4)))) (and (and (and ($Is DatatypeTypeType |body#0@@0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |body#0@@0| Tclass.AST.Expr $Heap@@4)) (|$IsA#AST.Expr__Raw| |body#0@@0|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 9) 5)))) anon0_correct))))
