...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|es#0@@1| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Fail#canCall| (Lit DatatypeTypeType |st#0@@2|) (Lit SeqType |es#0@@1|)) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@2| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@1| (TSeq Tclass.AST.Expr))))) (and (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@2|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@1|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@2|))))) (|VarUnchanged.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@2|) (Lit SeqType |es#0@@1|))) (= (VarUnchanged.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@2|) (Lit SeqType |es#0@@1|)) (U_2_bool (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@1|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@2|)))))))
(Lit boolType (bool_2_U  (=> (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@2|) (Lit SeqType |es#0@@1|)) (Utils.Result.Failure_q |res#2@@0|)))))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |762|
 :pattern ( (VarUnchanged.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@2|) (Lit SeqType |es#0@@1|)))
))))
...
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@4|)))
 (and (AST.Expr__Raw.All $ly@@1 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@1 |oe2#0| |p#0|)))) (let ((|es#0@@2| (AST.Expr__Raw.es |e#0@@4|)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|e#0@@8| T@U) ) (!  (=> (or (|VarUnchanged.__default.P__Fail#canCall| |st#0@@4| (Lit DatatypeTypeType |e#0@@8|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@4| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr)))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@4|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@8|) (VarUnchanged.MState.ctx |st#0@@4|))) (|VarUnchanged.__default.Pre#canCall| |st#0@@4| (Lit DatatypeTypeType |e#0@@8|))) (= (VarUnchanged.__default.P__Fail |st#0@@4| (Lit DatatypeTypeType |e#0@@8|)) (let ((|res#1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@8|) (VarUnchanged.MState.ctx |st#0@@4|))))
 (=> (VarUnchanged.__default.Pre |st#0@@4| (Lit DatatypeTypeType |e#0@@8|)) (Utils.Result.Failure_q |res#1|))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |738|
 :pattern ( (VarUnchanged.__default.P__Fail |st#0@@4| (Lit DatatypeTypeType |e#0@@8|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|es#0@@4| T@U) ) (!  (=> (or (|VarUnchanged.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |es#0@@4|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@5| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@4| (TSeq Tclass.AST.Expr))))) (and (forall ((|e#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |e#1@@0| Tclass.AST.Expr) (=> (|Seq#Contains| |es#0@@4| ($Box DatatypeTypeType |e#1@@0|)) (|VarUnchanged.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@5|) |e#1@@0|)))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |713|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@5| |e#1@@0|))
 :pattern ( (|Seq#Contains| |es#0@@4| ($Box DatatypeTypeType |e#1@@0|)))
)) (= (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |es#0@@4|)) (forall ((|e#1@@1| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#1@@1| Tclass.AST.Expr) (|Seq#Contains| |es#0@@4| ($Box DatatypeTypeType |e#1@@1|))) (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@5|) |e#1@@1|))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |712|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@5| |e#1@@1|))
 :pattern ( (|Seq#Contains| |es#0@@4| ($Box DatatypeTypeType |e#1@@1|)))
)))))
 :qid |VarUnchangeddfy.87:25|
 :weight 3
 :skolemid |714|
 :pattern ( (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |es#0@@4|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|es#0@@5| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Fail#canCall| |st#0@@6| (Lit SeqType |es#0@@5|)) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@5| (TSeq Tclass.AST.Expr))))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@6|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@5|) (VarUnchanged.MState.ctx |st#0@@6|))) (|VarUnchanged.__default.PreEs#canCall| |st#0@@6| (Lit SeqType |es#0@@5|))) (= (VarUnchanged.__default.Pes__Fail |st#0@@6| (Lit SeqType |es#0@@5|)) (let ((|res#1@@0| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@5|) (VarUnchanged.MState.ctx |st#0@@6|))))
 (=> (VarUnchanged.__default.PreEs |st#0@@6| (Lit SeqType |es#0@@5|)) (Utils.Result.Failure_q |res#1@@0|))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |761|
 :pattern ( (VarUnchanged.__default.Pes__Fail |st#0@@6| (Lit SeqType |es#0@@5|)))
))))
(assert (forall (($ly@@6 T@U) (|e#0@@10| T@U) (|ctx#0@@2| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@10| |ctx#0@@2|) (and ($Is DatatypeTypeType |e#0@@10| Tclass.AST.Expr) ($Is MapType |ctx#0@@2| (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType (Interp.__default.InterpExpr $ly@@6 |e#0@@10| |ctx#0@@2|) (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))))
 :qid |Interpdfy.24:12|
 :skolemid |1212|
 :pattern ( (Interp.__default.InterpExpr $ly@@6 |e#0@@10| |ctx#0@@2|))
)))
(assert (forall (($ly@@7 T@U) (|e#0@@11| T@U) (|ctx#0@@3| T@U) ) (! (= (Interp.__default.InterpExpr ($LS $ly@@7) |e#0@@11| |ctx#0@@3|) (Interp.__default.InterpExpr $ly@@7 |e#0@@11| |ctx#0@@3|))
 :qid |Interpdfy.24:12|
 :skolemid |1210|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@7) |e#0@@11| |ctx#0@@3|))
)))
(assert (forall (($ly@@8 T@U) (|es#0@@6| T@U) (|ctx#0@@4| T@U) ) (! (= (Interp.__default.InterpExprs ($LS $ly@@8) |es#0@@6| |ctx#0@@4|) (Interp.__default.InterpExprs $ly@@8 |es#0@@6| |ctx#0@@4|))
 :qid |Interpdfy.69:12|
 :skolemid |1217|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@8) |es#0@@6| |ctx#0@@4|))
)))
...
(assert (forall (($ly@@11 T@U) (|es#0@@7| T@U) (|ctx#0@@5| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@7| |ctx#0@@5|) (and ($Is SeqType |es#0@@7| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@5| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@7| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@7| (LitInt 0))) |ctx#0@@5|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@11 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@7| (LitInt 0))) |ctx#0@@5|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0|))) |vs#0@@0|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1221|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@11) |es#0@@7| |ctx#0@@5|))
)))
...
(let ((|oe1#0@@0| (AST.Expr__Raw.oe1 |e#0@@12|)))
 (and (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |oe1#0@@0|) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |oe2#0@@0|)))) (let ((|es#0@@8| (AST.Expr__Raw.es |e#0@@12|)))
...
(assert (forall (($ly@@13 T@U) (|es#0@@9| T@U) (|ctx#0@@6| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@9|) |ctx#0@@6|) (and ($Is SeqType |es#0@@9| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@6| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@9| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@9|) (LitInt 0))) |ctx#0@@6|) (let ((|valueOrError0#1@@0| (Interp.__default.InterpExpr ($LS $ly@@13) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@9|) (LitInt 0))) |ctx#0@@6|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@13) (Lit SeqType |es#0@@9|) |ctx#0@@6|) (ite (|Seq#Equal| |es#0@@9| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@6|)))) (let ((|valueOrError0#1@@1| (Interp.__default.InterpExpr ($LS $ly@@13) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@9|) (LitInt 0))) |ctx#0@@6|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#1|))) |vs#1@@0|)) ($Box MapType |ctx2#1@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |1222|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@13) (Lit SeqType |es#0@@9|) |ctx#0@@6|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|e#0@@13| T@U) ) (!  (=> (or (|VarUnchanged.__default.P__Fail#canCall| |st#0@@7| |e#0@@13|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@7| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@13| Tclass.AST.Expr)))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@7|) (|Interp.__default.InterpExpr#canCall| |e#0@@13| (VarUnchanged.MState.ctx |st#0@@7|))) (|VarUnchanged.__default.Pre#canCall| |st#0@@7| |e#0@@13|)) (= (VarUnchanged.__default.P__Fail |st#0@@7| |e#0@@13|) (let ((|res#0| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@13| (VarUnchanged.MState.ctx |st#0@@7|))))
 (=> (VarUnchanged.__default.Pre |st#0@@7| |e#0@@13|) (Utils.Result.Failure_q |res#0|))))))
 :qid |Inductiondfy.36:26|
 :skolemid |737|
 :pattern ( (VarUnchanged.__default.P__Fail |st#0@@7| |e#0@@13|))
))))
...
(assert (forall (($ly@@14 T@U) (|e#0@@15| T@U) (|ctx#0@@7| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@15|) (Lit MapType |ctx#0@@7|)) (and ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr) ($Is MapType |ctx#0@@7| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@15|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@15|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@15|))))) (let ((|body#5| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@15|)))))
...
(let ((|bvars#5| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@15|)))))
 (and (|Interp.__default.InterpExprs#canCall| |bvals#5| (Lit MapType |ctx#0@@7|)) (let ((|valueOrError0#5| (Interp.__default.InterpExprs ($LS $ly@@14) |bvals#5| (Lit MapType |ctx#0@@7|))))
...
(let ((|avars#5| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@15|)))))
 (and (|Interp.__default.InterpExprs#canCall| |avals#5| (Lit MapType |ctx#0@@7|)) (let ((|valueOrError2#5| (Interp.__default.InterpExprs ($LS $ly@@14) |avals#5| (Lit MapType |ctx#0@@7|))))
...
(let ((|cond#5| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@15|)))))
 (and (|Interp.__default.InterpExpr#canCall| |cond#5| (Lit MapType |ctx#0@@7|)) (let ((|valueOrError3#5| (Interp.__default.InterpExpr ($LS $ly@@14) |cond#5| (Lit MapType |ctx#0@@7|))))
...
(let ((|op#5| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@15|)))))
 (and (|Interp.__default.InterpExpr#canCall| |e1#5| (Lit MapType |ctx#0@@7|)) (let ((|valueOrError4#5| (Interp.__default.InterpExpr ($LS $ly@@14) |e1#5| (Lit MapType |ctx#0@@7|))))
...
(|Interp.__default.InterpBinOp#canCall| |op#5| |v1#5| |v2#5|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@15|)))))) (let ((|es#5| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@15|)))))
 (and (|Interp.__default.InterpExprs#canCall| |es#5| (Lit MapType |ctx#0@@7|)) (let ((|valueOrError6#5| (Interp.__default.InterpExprs ($LS $ly@@14) |es#5| (Lit MapType |ctx#0@@7|))))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#5|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@14) (Lit DatatypeTypeType |e#0@@15|) (Lit MapType |ctx#0@@7|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|name#4| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@15|)))))
...
(Lit DatatypeTypeType (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#4|)) ($Box MapType (Lit MapType |ctx#0@@7|)))))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|body#4| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@15|)))))
...
(let ((|valueOrError0#4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $ly@@14) |bvals#4| (Lit MapType |ctx#0@@7|)))))
...
(let ((|valueOrError2#4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $ly@@14) |avals#4| (Lit MapType |ctx#0@@7|)))))
...
(let ((|valueOrError3#4| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $ly@@14) |cond#4| (Lit MapType |ctx#0@@7|)))))
...
(let ((|valueOrError4#4| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $ly@@14) |e1#4| (Lit MapType |ctx#0@@7|)))))
...
(let ((|valueOrError6#4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $ly@@14) |es#4| (Lit MapType |ctx#0@@7|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1216|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@14) (Lit DatatypeTypeType |e#0@@15|) (Lit MapType |ctx#0@@7|)))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|es#0@@10| T@U) ) (!  (=> (or (|VarUnchanged.__default.PreEs#canCall| |st#0@@8| |es#0@@10|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@8| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@10| (TSeq Tclass.AST.Expr))))) (and (forall ((|e#0@@17| T@U) ) (!  (=> ($Is DatatypeTypeType |e#0@@17| Tclass.AST.Expr) (=> (|Seq#Contains| |es#0@@10| ($Box DatatypeTypeType |e#0@@17|)) (|VarUnchanged.__default.Pre#canCall| |st#0@@8| |e#0@@17|)))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |710|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@8| |e#0@@17|))
 :pattern ( (|Seq#Contains| |es#0@@10| ($Box DatatypeTypeType |e#0@@17|)))
)) (= (VarUnchanged.__default.PreEs |st#0@@8| |es#0@@10|) (forall ((|e#0@@18| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#0@@18| Tclass.AST.Expr) (|Seq#Contains| |es#0@@10| ($Box DatatypeTypeType |e#0@@18|))) (VarUnchanged.__default.Pre |st#0@@8| |e#0@@18|))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |709|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@8| |e#0@@18|))
 :pattern ( (|Seq#Contains| |es#0@@10| ($Box DatatypeTypeType |e#0@@18|)))
)))))
 :qid |VarUnchangeddfy.87:25|
 :skolemid |711|
 :pattern ( (VarUnchanged.__default.PreEs |st#0@@8| |es#0@@10|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@9| T@U) (|es#0@@11| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Fail#canCall| |st#0@@9| |es#0@@11|) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@9| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@11| (TSeq Tclass.AST.Expr))))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@9|) (|Interp.__default.InterpExprs#canCall| |es#0@@11| (VarUnchanged.MState.ctx |st#0@@9|))) (|VarUnchanged.__default.PreEs#canCall| |st#0@@9| |es#0@@11|)) (= (VarUnchanged.__default.Pes__Fail |st#0@@9| |es#0@@11|) (let ((|res#0@@0| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@11| (VarUnchanged.MState.ctx |st#0@@9|))))
 (=> (VarUnchanged.__default.PreEs |st#0@@9| |es#0@@11|) (Utils.Result.Failure_q |res#0@@0|))))))
 :qid |Inductiondfy.41:28|
 :skolemid |760|
 :pattern ( (VarUnchanged.__default.Pes__Fail |st#0@@9| |es#0@@11|))
))))
...
(assert (forall (($ly@@17 T@U) (|e#0@@19| T@U) (|ctx#0@@8| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@19|) |ctx#0@@8|) (and ($Is DatatypeTypeType |e#0@@19| Tclass.AST.Expr) ($Is MapType |ctx#0@@8| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@19|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@19|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@19|))))) (let ((|body#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@19|)))))
...
(let ((|bvars#3@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@19|)))))
 (and (|Interp.__default.InterpExprs#canCall| |bvals#3@@0| |ctx#0@@8|) (let ((|valueOrError0#3| (Interp.__default.InterpExprs ($LS $ly@@17) |bvals#3@@0| |ctx#0@@8|)))
...
(let ((|avars#3@@0| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@19|)))))
 (and (|Interp.__default.InterpExprs#canCall| |avals#3@@0| |ctx#0@@8|) (let ((|valueOrError2#3| (Interp.__default.InterpExprs ($LS $ly@@17) |avals#3@@0| |ctx#0@@8|)))
...
(let ((|cond#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@19|)))))
 (and (|Interp.__default.InterpExpr#canCall| |cond#3@@0| |ctx#0@@8|) (let ((|valueOrError3#3| (Interp.__default.InterpExpr ($LS $ly@@17) |cond#3@@0| |ctx#0@@8|)))
...
(let ((|op#3| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@19|)))))
 (and (|Interp.__default.InterpExpr#canCall| |e1#3| |ctx#0@@8|) (let ((|valueOrError4#3| (Interp.__default.InterpExpr ($LS $ly@@17) |e1#3| |ctx#0@@8|)))
...
(|Interp.__default.InterpBinOp#canCall| |op#3| |v1#3| |v2#3|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@19|)))))) (let ((|es#3@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@19|)))))
 (and (|Interp.__default.InterpExprs#canCall| |es#3@@0| |ctx#0@@8|) (let ((|valueOrError6#3| (Interp.__default.InterpExprs ($LS $ly@@17) |es#3@@0| |ctx#0@@8|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#3|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@17) (Lit DatatypeTypeType |e#0@@19|) |ctx#0@@8|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@19|)) (let ((|name#2| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@19|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#2|)) ($Box MapType |ctx#0@@8|))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@19|)) (let ((|body#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@19|)))))
...
(let ((|valueOrError0#2@@1| (Interp.__default.InterpExprs ($LS $ly@@17) |bvals#2@@1| |ctx#0@@8|)))
...
(let ((|valueOrError2#2| (Interp.__default.InterpExprs ($LS $ly@@17) |avals#2@@1| |ctx#0@@8|)))
...
(let ((|valueOrError3#2| (Interp.__default.InterpExpr ($LS $ly@@17) |cond#2@@0| |ctx#0@@8|)))
...
(let ((|valueOrError4#2| (Interp.__default.InterpExpr ($LS $ly@@17) |e1#2| |ctx#0@@8|)))
...
(let ((|valueOrError6#2| (Interp.__default.InterpExprs ($LS $ly@@17) |es#2@@0| |ctx#0@@8|)))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1215|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@17) (Lit DatatypeTypeType |e#0@@19|) |ctx#0@@8|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@10| T@U) (|e#0@@21| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@10|) (Lit DatatypeTypeType |e#0@@21|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@10| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@21| Tclass.AST.Expr)))) (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@10|)) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@10|))))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@10|)) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@10|)))))) (Lit DatatypeTypeType |e#0@@21|))))) (= (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@10|) (Lit DatatypeTypeType |e#0@@21|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@10|)))) (VarUnchanged.__default.VarUnchanged ($LS $LZ) (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@10|)))))) (Lit DatatypeTypeType |e#0@@21|)))))))))
 :qid |VarUnchangeddfy.82:23|
 :weight 3
 :skolemid |705|
 :pattern ( (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@10|) (Lit DatatypeTypeType |e#0@@21|)))
))))
...
(set-info :boogie-vc-id Impl$$VarUnchanged.__default.InductSeq__Fail)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (= (ControlFlow 0 2) (- 0 1))) (not (VarUnchanged.__default.Pes__Fail |st#0@@11| |es#0@@12|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and (and ($Is DatatypeTypeType |st#0@@11| Tclass.VarUnchanged.S) ($IsAlloc DatatypeTypeType |st#0@@11| Tclass.VarUnchanged.S $Heap@@6)) (|$IsA#VarUnchanged.MState| |st#0@@11|)) (and (and ($Is DatatypeTypeType |e#0@@24| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@24| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@24|))) (and (and (and ($Is SeqType |es#0@@12| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |es#0@@12| (TSeq Tclass.AST.Expr) $Heap@@6)) (= 5 $FunctionContextHeight)) (and (and (AST.Expr__Raw.Seq_q |e#0@@24|) (|Seq#Equal| (AST.Expr__Raw.es |e#0@@24|) |es#0@@12|)) (and (not (VarUnchanged.__default.P__Fail |st#0@@11| |e#0@@24|)) (= (ControlFlow 0 3) 2))))) anon0_correct))))
