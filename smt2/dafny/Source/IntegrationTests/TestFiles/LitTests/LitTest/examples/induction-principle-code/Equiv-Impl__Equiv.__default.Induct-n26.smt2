...
(assert (forall ((d@@1 T@U) ) (!  (=> (|$IsA#Equiv.MSeqValue| d@@1) (Equiv.MSeqValue.MSeqValue_q d@@1))
 :qid |unknown.0:0|
 :skolemid |935|
 :pattern ( (|$IsA#Equiv.MSeqValue| d@@1))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|e#0@@2| T@U) (|st'#0@@1| T@U) (|v#0@@0| T@U) ) (!  (=> (or (|Equiv.__default.P__Succ#canCall| (Lit DatatypeTypeType |st#0@@2|) (Lit DatatypeTypeType |e#0@@2|) (Lit DatatypeTypeType |st'#0@@1|) (Lit DatatypeTypeType |v#0@@0|)) (and (< 2 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@2| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@2| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@1| Tclass.Equiv.MState)) ($Is DatatypeTypeType |v#0@@0| Tclass.Equiv.MValue)))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@2|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@2|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@2|))))) (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@2|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@2|)))))))
 (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@2|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@2|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@2|))))) (let ((|res'#2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@2|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@2|)))))))
 (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@2|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@2|))))) (and (|Equiv.__default.EqResult#canCall| |res#2| |res'#2|) (=> (Equiv.__default.EqResult |res#2| |res'#2|) (and (and (|$IsA#Utils.Result| |res#2|) (and (Equiv.MValue.MValue_q (Lit DatatypeTypeType |v#0@@0|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st'#0@@1|)))) (=> (|Utils.Result#Equal| |res#2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt (Equiv.MValue.v (Lit DatatypeTypeType |v#0@@0|))))) ($Box MapType (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st'#0@@1|))))))))) (and (|$IsA#Utils.Result| |res'#2|) (and (Equiv.MValue.MValue_q (Lit DatatypeTypeType |v#0@@0|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st'#0@@1|)))))))))))))) (= (Equiv.__default.P__Succ (Lit DatatypeTypeType |st#0@@2|) (Lit DatatypeTypeType |e#0@@2|) (Lit DatatypeTypeType |st'#0@@1|) (Lit DatatypeTypeType |v#0@@0|)) (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@2|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@2|)))))))
(let ((|res'#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@2|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@2|)))))))
 (and (and (and (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@2|)) (Equiv.__default.EqResult |res#2@@0| |res'#2@@0|)) (|Utils.Result#Equal| |res#2@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt (Equiv.MValue.v (Lit DatatypeTypeType |v#0@@0|))))) ($Box MapType (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st'#0@@1|)))))))))) (|Utils.Result#Equal| |res'#2@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt (Equiv.MValue.v_k (Lit DatatypeTypeType |v#0@@0|))))) ($Box MapType (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st'#0@@1|)))))))))))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |699|
 :pattern ( (Equiv.__default.P__Succ (Lit DatatypeTypeType |st#0@@2|) (Lit DatatypeTypeType |e#0@@2|) (Lit DatatypeTypeType |st'#0@@1|) (Lit DatatypeTypeType |v#0@@0|)))
))))
(assert (forall ((d@@3 T@U) ) (!  (=> ($Is DatatypeTypeType d@@3 Tclass.Equiv.MState) (Equiv.MState.MState_q d@@3))
 :qid |unknown.0:0|
 :skolemid |901|
 :pattern ( (Equiv.MState.MState_q d@@3) ($Is DatatypeTypeType d@@3 Tclass.Equiv.MState))
)))
(assert (forall ((d@@4 T@U) ) (!  (=> ($Is DatatypeTypeType d@@4 Tclass.Equiv.MValue) (Equiv.MValue.MValue_q d@@4))
 :qid |unknown.0:0|
 :skolemid |916|
 :pattern ( (Equiv.MValue.MValue_q d@@4) ($Is DatatypeTypeType d@@4 Tclass.Equiv.MValue))
)))
(assert (forall ((d@@5 T@U) ) (!  (=> ($Is DatatypeTypeType d@@5 Tclass.Equiv.MSeqValue) (Equiv.MSeqValue.MSeqValue_q d@@5))
 :qid |unknown.0:0|
 :skolemid |936|
 :pattern ( (Equiv.MSeqValue.MSeqValue_q d@@5) ($Is DatatypeTypeType d@@5 Tclass.Equiv.MSeqValue))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|vars#0@@1| T@U) (|vals#0@@1| T@U) ) (!  (=> (or (|Equiv.__default.AssignState#canCall| |st#0@@3| |vars#0@@1| |vals#0@@1|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@3| Tclass.Equiv.MState) ($Is SeqType |vars#0@@1| (TSeq (TSeq TChar)))) ($Is DatatypeTypeType |vals#0@@1| Tclass.Equiv.VS)) (Equiv.__default.UpdateState__Pre |st#0@@3| |vars#0@@1| |vals#0@@1|)))) (and (Equiv.__default.Inv (Equiv.__default.AssignState |st#0@@3| |vars#0@@1| |vals#0@@1|)) ($Is DatatypeTypeType (Equiv.__default.AssignState |st#0@@3| |vars#0@@1| |vals#0@@1|) Tclass.Equiv.MState)))
 :qid |Inductiondfy.54:30|
 :skolemid |760|
 :pattern ( (Equiv.__default.AssignState |st#0@@3| |vars#0@@1| |vals#0@@1|))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|vars#0@@2| T@U) (|vals#0@@2| T@U) ) (!  (=> (or (|Equiv.__default.BindStartScope#canCall| |st#0@@4| |vars#0@@2| |vals#0@@2|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@4| Tclass.Equiv.MState) ($Is SeqType |vars#0@@2| (TSeq (TSeq TChar)))) ($Is DatatypeTypeType |vals#0@@2| Tclass.Equiv.VS)) (Equiv.__default.UpdateState__Pre |st#0@@4| |vars#0@@2| |vals#0@@2|)))) (and (Equiv.__default.Inv (Equiv.__default.BindStartScope |st#0@@4| |vars#0@@2| |vals#0@@2|)) ($Is DatatypeTypeType (Equiv.__default.BindStartScope |st#0@@4| |vars#0@@2| |vals#0@@2|) Tclass.Equiv.MState)))
 :qid |Inductiondfy.58:33|
 :skolemid |773|
 :pattern ( (Equiv.__default.BindStartScope |st#0@@4| |vars#0@@2| |vals#0@@2|))
))))
(assert (forall (($ly@@0 T@U) (|e#0@@3| T@U) (|ctx#0@@2| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@3| |ctx#0@@2|) (and ($Is DatatypeTypeType |e#0@@3| Tclass.AST.Expr) ($Is MapType |ctx#0@@2| (TMap (TSeq TChar) TInt)))) (and (=> (not (AST.Expr__Raw.Var_q |e#0@@3|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@3|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@3|) (let ((|body#1| (AST.Expr__Raw.body |e#0@@3|)))
...
(|Interp.__default.InterpBinOp#canCall| |op#1| |v1#1| |v2#1|)))))))))))))))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@3|)) (let ((|es#1| (AST.Expr__Raw.es |e#0@@3|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#1|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@0) |e#0@@3| |ctx#0@@2|) (ite (AST.Expr__Raw.Var_q |e#0@@3|) (let ((|name#0| (AST.Expr__Raw.name |e#0@@3|)))
(ite (|Set#IsMember| (|Map#Domain| |ctx#0@@2|) ($Box SeqType |name#0|)) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@2|) ($Box SeqType |name#0|)) ($Box MapType |ctx#0@@2|)))) |#Utils.Result.Failure|)) (ite (AST.Expr__Raw.Literal_q |e#0@@3|) (let ((|n#0| (AST.Expr__Raw.n |e#0@@3|)))
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#0|)) ($Box MapType |ctx#0@@2|))))) (ite (AST.Expr__Raw.Bind_q |e#0@@3|) (let ((|body#0| (AST.Expr__Raw.body |e#0@@3|)))
...
(ite (|Seq#Equal| |vs#2@@1| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#3|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#2@@1| (- (|Seq#Length| |vs#2@@1|) 1)) ($Box MapType |ctx1#3|)))))))))))))))))))
 :qid |Interpdfy.24:12|
 :skolemid |1200|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@0) |e#0@@3| |ctx#0@@2|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0@@5| T@U) ) (!  (=> (or (|Equiv.__default.Inv#canCall| |st#0@@5|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |st#0@@5| Tclass.Equiv.MState))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (and (Equiv.MState.MState_q |st#0@@5|) (Equiv.MState.MState_q |st#0@@5|)) (|Equiv.__default.EqCtx#canCall| (Equiv.MState.ctx |st#0@@5|) (Equiv.MState.ctx_k |st#0@@5|)))) (= (Equiv.__default.Inv |st#0@@5|)  (and true (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx (Equiv.MState.ctx |st#0@@5|) (Equiv.MState.ctx_k |st#0@@5|))))))
 :qid |Equivdfy.72:23|
 :skolemid |682|
 :pattern ( (Equiv.__default.Inv |st#0@@5|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st0#0| T@U) (|st#0@@6| T@U) (|vars#0@@3| T@U) ) (!  (=> (or (|Equiv.__default.BindEndScope#canCall| |st0#0| |st#0@@6| |vars#0@@3|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st0#0| Tclass.Equiv.MState) ($Is DatatypeTypeType |st#0@@6| Tclass.Equiv.MState)) ($Is SeqType |vars#0@@3| (TSeq (TSeq TChar)))))) (and (and (|Equiv.__default.Inv#canCall| |st0#0|) (=> (Equiv.__default.Inv |st0#0|) (|Equiv.__default.Inv#canCall| |st#0@@6|))) (= (Equiv.__default.BindEndScope |st0#0| |st#0@@6| |vars#0@@3|) (let ((|ctx0'#0| (Equiv.MState.ctx_k |st0#0|)))
(let ((|ctx0#0| (Equiv.MState.ctx |st0#0|)))
(let ((|ctx'#0@@1| (Equiv.MState.ctx_k |st#0@@6|)))
(let ((|ctx#0@@3| (Equiv.MState.ctx |st#0@@6|)))
(let ((|ctx1#0@@1| (|Map#Merge| |ctx0#0| (|Map#Subtract| |ctx#0@@3| (|Set#FromBoogieMap| (|lambda#9| (TSeq TChar) |vars#0@@3|))))))
(let ((|ctx1'#0@@0| (|Map#Merge| |ctx0'#0| (|Map#Subtract| |ctx'#0@@1| (|Set#FromBoogieMap| (|lambda#9| (TSeq TChar) |vars#0@@3|))))))
(let ((|st'#0@@2| (|#Equiv.MState.MState| |ctx1#0@@1| |ctx1'#0@@0|)))
|st'#0@@2|))))))))))
 :qid |Inductiondfy.64:31|
 :skolemid |782|
 :pattern ( (Equiv.__default.BindEndScope |st0#0| |st#0@@6| |vars#0@@3|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|e#0@@4| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| |st#0@@7| |e#0@@4|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@7| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@4| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@7|) (=> (Equiv.__default.Inv |st#0@@7|) (and (Equiv.MState.MState_q |st#0@@7|) (|Interp.__default.InterpExpr#canCall| |e#0@@4| (Equiv.MState.ctx |st#0@@7|))))) (= (Equiv.__default.P__Fail |st#0@@7| |e#0@@4|)  (=> (Equiv.__default.Inv |st#0@@7|) (Utils.Result.Failure_q (Interp.__default.InterpExpr ($LS $LZ) |e#0@@4| (Equiv.MState.ctx |st#0@@7|)))))))
 :qid |Inductiondfy.36:26|
 :skolemid |706|
 :pattern ( (Equiv.__default.P__Fail |st#0@@7| |e#0@@4|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|e#0@@5| T@U) (|st'#0@@3| T@U) (|v#0@@2| T@U) ) (!  (=> (or (|Equiv.__default.P__Succ#canCall| |st#0@@8| (Lit DatatypeTypeType |e#0@@5|) |st'#0@@3| |v#0@@2|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@8| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@5| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@3| Tclass.Equiv.MState)) ($Is DatatypeTypeType |v#0@@2| Tclass.Equiv.MValue)))) (and (and (and (Equiv.MState.MState_q |st#0@@8|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@5|) (Equiv.MState.ctx |st#0@@8|))) (let ((|res#1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@5|) (Equiv.MState.ctx |st#0@@8|))))
 (and (and (Equiv.MState.MState_q |st#0@@8|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@5|) (Equiv.MState.ctx_k |st#0@@8|))) (let ((|res'#1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@5|) (Equiv.MState.ctx_k |st#0@@8|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@8|) (=> (Equiv.__default.Inv |st#0@@8|) (and (|Equiv.__default.EqResult#canCall| |res#1| |res'#1|) (=> (Equiv.__default.EqResult |res#1| |res'#1|) (and (and (|$IsA#Utils.Result| |res#1|) (and (Equiv.MValue.MValue_q |v#0@@2|) (Equiv.MState.MState_q |st'#0@@3|))) (=> (|Utils.Result#Equal| |res#1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v |v#0@@2|))) ($Box MapType (Equiv.MState.ctx |st'#0@@3|)))))) (and (|$IsA#Utils.Result| |res'#1|) (and (Equiv.MValue.MValue_q |v#0@@2|) (Equiv.MState.MState_q |st'#0@@3|))))))))))))) (= (Equiv.__default.P__Succ |st#0@@8| (Lit DatatypeTypeType |e#0@@5|) |st'#0@@3| |v#0@@2|) (let ((|res#1@@0| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@5|) (Equiv.MState.ctx |st#0@@8|))))
(let ((|res'#1@@0| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@5|) (Equiv.MState.ctx_k |st#0@@8|))))
 (and (and (and (Equiv.__default.Inv |st#0@@8|) (Equiv.__default.EqResult |res#1@@0| |res'#1@@0|)) (|Utils.Result#Equal| |res#1@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v |v#0@@2|))) ($Box MapType (Equiv.MState.ctx |st'#0@@3|))))))) (|Utils.Result#Equal| |res'#1@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v_k |v#0@@2|))) ($Box MapType (Equiv.MState.ctx_k |st'#0@@3|))))))))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |698|
 :pattern ( (Equiv.__default.P__Succ |st#0@@8| (Lit DatatypeTypeType |e#0@@5|) |st'#0@@3| |v#0@@2|))
))))
...
(assert (forall ((d@@6 T@U) ) (!  (=> (|$IsA#AST.Expr__Raw| d@@6) (or (or (or (or (or (or (AST.Expr__Raw.Var_q d@@6) (AST.Expr__Raw.Literal_q d@@6)) (AST.Expr__Raw.Bind_q d@@6)) (AST.Expr__Raw.Assign_q d@@6)) (AST.Expr__Raw.If_q d@@6)) (AST.Expr__Raw.Op_q d@@6)) (AST.Expr__Raw.Seq_q d@@6)))
 :qid |unknown.0:0|
 :skolemid |1117|
 :pattern ( (|$IsA#AST.Expr__Raw| d@@6))
)))
...
(assert (forall ((d@@8 T@U) ) (! (= (Equiv.MState.MState_q d@@8) (= (DatatypeCtorId d@@8) |##Equiv.MState.MState|))
 :qid |unknown.0:0|
 :skolemid |886|
 :pattern ( (Equiv.MState.MState_q d@@8))
)))
(assert (forall ((d@@9 T@U) ) (! (= (Equiv.MValue.MValue_q d@@9) (= (DatatypeCtorId d@@9) |##Equiv.MValue.MValue|))
 :qid |unknown.0:0|
 :skolemid |905|
 :pattern ( (Equiv.MValue.MValue_q d@@9))
)))
(assert (forall ((d@@10 T@U) ) (! (= (Equiv.MSeqValue.MSeqValue_q d@@10) (= (DatatypeCtorId d@@10) |##Equiv.MSeqValue.MSeqValue|))
 :qid |unknown.0:0|
 :skolemid |920|
 :pattern ( (Equiv.MSeqValue.MSeqValue_q d@@10))
)))
(assert (forall ((d@@11 T@U) ) (! (= (Utils.Result.Success_q d@@11) (= (DatatypeCtorId d@@11) |##Utils.Result.Success|))
 :qid |unknown.0:0|
 :skolemid |960|
 :pattern ( (Utils.Result.Success_q d@@11))
)))
(assert (forall ((d@@12 T@U) ) (! (= (Utils.Result.Failure_q d@@12) (= (DatatypeCtorId d@@12) |##Utils.Result.Failure|))
 :qid |unknown.0:0|
 :skolemid |969|
 :pattern ( (Utils.Result.Failure_q d@@12))
)))
(assert (forall ((d@@13 T@U) ) (! (= (AST.BinOp.Add_q d@@13) (= (DatatypeCtorId d@@13) |##AST.BinOp.Add|))
 :qid |unknown.0:0|
 :skolemid |1014|
 :pattern ( (AST.BinOp.Add_q d@@13))
)))
(assert (forall ((d@@14 T@U) ) (! (= (AST.BinOp.Sub_q d@@14) (= (DatatypeCtorId d@@14) |##AST.BinOp.Sub|))
 :qid |unknown.0:0|
 :skolemid |1016|
 :pattern ( (AST.BinOp.Sub_q d@@14))
)))
(assert (forall ((d@@15 T@U) ) (! (= (AST.BinOp.Mul_q d@@15) (= (DatatypeCtorId d@@15) |##AST.BinOp.Mul|))
 :qid |unknown.0:0|
 :skolemid |1018|
 :pattern ( (AST.BinOp.Mul_q d@@15))
)))
(assert (forall ((d@@16 T@U) ) (! (= (AST.Expr__Raw.Var_q d@@16) (= (DatatypeCtorId d@@16) |##AST.Expr_Raw.Var|))
 :qid |unknown.0:0|
 :skolemid |1028|
 :pattern ( (AST.Expr__Raw.Var_q d@@16))
)))
(assert (forall ((d@@17 T@U) ) (! (= (AST.Expr__Raw.Literal_q d@@17) (= (DatatypeCtorId d@@17) |##AST.Expr_Raw.Literal|))
 :qid |unknown.0:0|
 :skolemid |1038|
 :pattern ( (AST.Expr__Raw.Literal_q d@@17))
)))
(assert (forall ((d@@18 T@U) ) (! (= (AST.Expr__Raw.Bind_q d@@18) (= (DatatypeCtorId d@@18) |##AST.Expr_Raw.Bind|))
 :qid |unknown.0:0|
 :skolemid |1046|
 :pattern ( (AST.Expr__Raw.Bind_q d@@18))
)))
(assert (forall ((d@@19 T@U) ) (! (= (AST.Expr__Raw.Assign_q d@@19) (= (DatatypeCtorId d@@19) |##AST.Expr_Raw.Assign|))
 :qid |unknown.0:0|
 :skolemid |1063|
 :pattern ( (AST.Expr__Raw.Assign_q d@@19))
)))
(assert (forall ((d@@20 T@U) ) (! (= (AST.Expr__Raw.If_q d@@20) (= (DatatypeCtorId d@@20) |##AST.Expr_Raw.If|))
 :qid |unknown.0:0|
 :skolemid |1077|
 :pattern ( (AST.Expr__Raw.If_q d@@20))
)))
(assert (forall ((d@@21 T@U) ) (! (= (AST.Expr__Raw.Op_q d@@21) (= (DatatypeCtorId d@@21) |##AST.Expr_Raw.Op|))
 :qid |unknown.0:0|
 :skolemid |1092|
 :pattern ( (AST.Expr__Raw.Op_q d@@21))
)))
(assert (forall ((d@@22 T@U) ) (! (= (AST.Expr__Raw.Seq_q d@@22) (= (DatatypeCtorId d@@22) |##AST.Expr_Raw.Seq|))
 :qid |unknown.0:0|
 :skolemid |1107|
...
(assert (forall ((d@@23 T@U) ) (!  (=> (AST.Expr__Raw.Bind_q d@@23) (exists ((|a#35#0#0| T@U) (|a#35#1#0| T@U) (|a#35#2#0| T@U) ) (! (= d@@23 (|#AST.Expr_Raw.Bind| |a#35#0#0| |a#35#1#0| |a#35#2#0|))
 :qid |ASTdfy.17:12|
 :skolemid |1047|
)))
 :qid |unknown.0:0|
 :skolemid |1048|
 :pattern ( (AST.Expr__Raw.Bind_q d@@23))
)))
(assert (forall ((d@@24 T@U) ) (!  (=> (AST.Expr__Raw.If_q d@@24) (exists ((|a#57#0#0| T@U) (|a#57#1#0| T@U) (|a#57#2#0| T@U) ) (! (= d@@24 (|#AST.Expr_Raw.If| |a#57#0#0| |a#57#1#0| |a#57#2#0|))
 :qid |ASTdfy.19:10|
 :skolemid |1078|
)))
 :qid |unknown.0:0|
 :skolemid |1079|
 :pattern ( (AST.Expr__Raw.If_q d@@24))
)))
(assert (forall ((d@@25 T@U) ) (!  (=> (AST.Expr__Raw.Op_q d@@25) (exists ((|a#67#0#0| T@U) (|a#67#1#0| T@U) (|a#67#2#0| T@U) ) (! (= d@@25 (|#AST.Expr_Raw.Op| |a#67#0#0| |a#67#1#0| |a#67#2#0|))
 :qid |ASTdfy.20:10|
 :skolemid |1093|
)))
 :qid |unknown.0:0|
 :skolemid |1094|
 :pattern ( (AST.Expr__Raw.Op_q d@@25))
)))
...
(assert (forall ((d@@27 T@U) ) (!  (=> (Equiv.MState.MState_q d@@27) (exists ((|a#1#0#0@@0| T@U) (|a#1#1#0@@0| T@U) ) (! (= d@@27 (|#Equiv.MState.MState| |a#1#0#0@@0| |a#1#1#0@@0|))
 :qid |Equivdfy.62:28|
 :skolemid |887|
)))
 :qid |unknown.0:0|
 :skolemid |888|
 :pattern ( (Equiv.MState.MState_q d@@27))
)))
(assert (forall ((d@@28 T@U) ) (!  (=> (Equiv.MValue.MValue_q d@@28) (exists ((|a#11#0#0| Int) (|a#11#1#0| Int) ) (! (= d@@28 (|#Equiv.MValue.MValue| |a#11#0#0| |a#11#1#0|))
 :qid |Equivdfy.63:28|
 :skolemid |906|
)))
 :qid |unknown.0:0|
 :skolemid |907|
 :pattern ( (Equiv.MValue.MValue_q d@@28))
)))
(assert (forall ((d@@29 T@U) ) (!  (=> (Equiv.MSeqValue.MSeqValue_q d@@29) (exists ((|a#17#0#0| T@U) (|a#17#1#0| T@U) ) (! (= d@@29 (|#Equiv.MSeqValue.MSeqValue| |a#17#0#0| |a#17#1#0|))
 :qid |Equivdfy.64:34|
 :skolemid |921|
)))
 :qid |unknown.0:0|
 :skolemid |922|
 :pattern ( (Equiv.MSeqValue.MSeqValue_q d@@29))
)))
(assert (forall ((d@@30 T@U) ) (!  (=> (AST.Expr__Raw.Assign_q d@@30) (exists ((|a#47#0#0| T@U) (|a#47#1#0| T@U) ) (! (= d@@30 (|#AST.Expr_Raw.Assign| |a#47#0#0| |a#47#1#0|))
 :qid |ASTdfy.18:14|
 :skolemid |1064|
)))
 :qid |unknown.0:0|
 :skolemid |1065|
 :pattern ( (AST.Expr__Raw.Assign_q d@@30))
)))
...
(assert (forall ((d@@31 T@U) ) (!  (=> (Utils.Result.Failure_q d@@31) (= d@@31 |#Utils.Result.Failure|))
 :qid |unknown.0:0|
 :skolemid |970|
 :pattern ( (Utils.Result.Failure_q d@@31))
)))
(assert (forall ((d@@32 T@U) ) (!  (=> (AST.BinOp.Add_q d@@32) (= d@@32 |#AST.BinOp.Add|))
 :qid |unknown.0:0|
 :skolemid |1015|
 :pattern ( (AST.BinOp.Add_q d@@32))
)))
(assert (forall ((d@@33 T@U) ) (!  (=> (AST.BinOp.Sub_q d@@33) (= d@@33 |#AST.BinOp.Sub|))
 :qid |unknown.0:0|
 :skolemid |1017|
 :pattern ( (AST.BinOp.Sub_q d@@33))
)))
(assert (forall ((d@@34 T@U) ) (!  (=> (AST.BinOp.Mul_q d@@34) (= d@@34 |#AST.BinOp.Mul|))
 :qid |unknown.0:0|
 :skolemid |1019|
 :pattern ( (AST.BinOp.Mul_q d@@34))
)))
...
(assert (forall ((d@@35 T@U) ) (!  (=> (Utils.Result.Success_q d@@35) (exists ((|a#1#0#0@@1| T@U) ) (! (= d@@35 (|#Utils.Result.Success| |a#1#0#0@@1|))
 :qid |Utilsdfy.23:34|
 :skolemid |961|
)))
 :qid |unknown.0:0|
 :skolemid |962|
 :pattern ( (Utils.Result.Success_q d@@35))
)))
(assert (forall ((d@@36 T@U) ) (!  (=> (AST.Expr__Raw.Var_q d@@36) (exists ((|a#23#0#0| T@U) ) (! (= d@@36 (|#AST.Expr_Raw.Var| |a#23#0#0|))
 :qid |ASTdfy.15:11|
 :skolemid |1029|
)))
 :qid |unknown.0:0|
 :skolemid |1030|
 :pattern ( (AST.Expr__Raw.Var_q d@@36))
)))
(assert (forall ((d@@37 T@U) ) (!  (=> (AST.Expr__Raw.Literal_q d@@37) (exists ((|a#30#0#0| Int) ) (! (= d@@37 (|#AST.Expr_Raw.Literal| |a#30#0#0|))
 :qid |ASTdfy.16:15|
 :skolemid |1039|
)))
 :qid |unknown.0:0|
 :skolemid |1040|
 :pattern ( (AST.Expr__Raw.Literal_q d@@37))
)))
(assert (forall ((d@@38 T@U) ) (!  (=> (AST.Expr__Raw.Seq_q d@@38) (exists ((|a#77#0#0| T@U) ) (! (= d@@38 (|#AST.Expr_Raw.Seq| |a#77#0#0|))
 :qid |ASTdfy.21:11|
 :skolemid |1108|
)))
 :qid |unknown.0:0|
 :skolemid |1109|
 :pattern ( (AST.Expr__Raw.Seq_q d@@38))
)))
(assert (forall ((d@@39 T@U) ) (!  (=> ($Is DatatypeTypeType d@@39 Tclass.AST.Expr__Raw) (or (or (or (or (or (or (AST.Expr__Raw.Var_q d@@39) (AST.Expr__Raw.Literal_q d@@39)) (AST.Expr__Raw.Bind_q d@@39)) (AST.Expr__Raw.Assign_q d@@39)) (AST.Expr__Raw.If_q d@@39)) (AST.Expr__Raw.Op_q d@@39)) (AST.Expr__Raw.Seq_q d@@39)))
 :qid |unknown.0:0|
 :skolemid |1118|
 :pattern ( (AST.Expr__Raw.Seq_q d@@39) ($Is DatatypeTypeType d@@39 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Op_q d@@39) ($Is DatatypeTypeType d@@39 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.If_q d@@39) ($Is DatatypeTypeType d@@39 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Assign_q d@@39) ($Is DatatypeTypeType d@@39 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Bind_q d@@39) ($Is DatatypeTypeType d@@39 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Literal_q d@@39) ($Is DatatypeTypeType d@@39 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Var_q d@@39) ($Is DatatypeTypeType d@@39 Tclass.AST.Expr__Raw))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st0#0@@0| T@U) (|st#0@@9| T@U) (|vars#0@@4| T@U) ) (!  (=> (or (|Equiv.__default.BindEndScope#canCall| |st0#0@@0| |st#0@@9| (Lit SeqType |vars#0@@4|)) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st0#0@@0| Tclass.Equiv.MState) ($Is DatatypeTypeType |st#0@@9| Tclass.Equiv.MState)) ($Is SeqType |vars#0@@4| (TSeq (TSeq TChar)))))) (and (and (|Equiv.__default.Inv#canCall| |st0#0@@0|) (=> (Equiv.__default.Inv |st0#0@@0|) (|Equiv.__default.Inv#canCall| |st#0@@9|))) (= (Equiv.__default.BindEndScope |st0#0@@0| |st#0@@9| (Lit SeqType |vars#0@@4|)) (let ((|ctx0'#1| (Equiv.MState.ctx_k |st0#0@@0|)))
(let ((|ctx0#1| (Equiv.MState.ctx |st0#0@@0|)))
(let ((|ctx'#1@@0| (Equiv.MState.ctx_k |st#0@@9|)))
(let ((|ctx#1@@0| (Equiv.MState.ctx |st#0@@9|)))
...
|st'#1|))))))))))
 ...
 :weight 3
 :skolemid |783|
 :pattern ( (Equiv.__default.BindEndScope |st0#0@@0| |st#0@@9| (Lit SeqType |vars#0@@4|)))
))))
...
(assert (forall (($ly@@2 T@U) (|es#0@@2| T@U) (|ctx#0@@4| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@2| |ctx#0@@4|) (and ($Is SeqType |es#0@@2| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@4| (TMap (TSeq TChar) TInt)))) (and (=> (Utils.Result.Success_q (Interp.__default.InterpExprs $ly@@2 |es#0@@2| |ctx#0@@4|)) (= (|Seq#Length| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs $ly@@2 |es#0@@2| |ctx#0@@4|)))))) (|Seq#Length| |es#0@@2|))) ($Is DatatypeTypeType (Interp.__default.InterpExprs $ly@@2 |es#0@@2| |ctx#0@@4|) (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))
 :qid |Interpdfy.69:12|
 :skolemid |1205|
 :pattern ( (Interp.__default.InterpExprs $ly@@2 |es#0@@2| |ctx#0@@4|))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0@@10| T@U) ) (!  (=> (or (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@10|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |st#0@@10| Tclass.Equiv.MState))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@10|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@10|))) (|Equiv.__default.EqCtx#canCall| (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@10|))) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@10|)))))) (= (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@10|))  (and true (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@10|))) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@10|))))))))
 :qid |Equivdfy.72:23|
 :weight 3
 :skolemid |683|
 :pattern ( (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@10|)))
))))
...
(assert (forall (($ly@@4 T@U) (|e#0@@9| T@U) (|ctx#0@@6| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@9| |ctx#0@@6|) (and ($Is DatatypeTypeType |e#0@@9| Tclass.AST.Expr) ($Is MapType |ctx#0@@6| (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType (Interp.__default.InterpExpr $ly@@4 |e#0@@9| |ctx#0@@6|) (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))))
 :qid |Interpdfy.24:12|
 :skolemid |1198|
 :pattern ( (Interp.__default.InterpExpr $ly@@4 |e#0@@9| |ctx#0@@6|))
)))
...
(assert (forall (($ly@@5 T@U) (|e#0@@10| T@U) (|ctx#0@@7| T@U) ) (! (= (Interp.__default.InterpExpr ($LS $ly@@5) |e#0@@10| |ctx#0@@7|) (Interp.__default.InterpExpr $ly@@5 |e#0@@10| |ctx#0@@7|))
 :qid |Interpdfy.24:12|
 :skolemid |1196|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@5) |e#0@@10| |ctx#0@@7|))
)))
(assert (forall (($ly@@6 T@U) (|es#0@@3| T@U) (|ctx#0@@8| T@U) ) (! (= (Interp.__default.InterpExprs ($LS $ly@@6) |es#0@@3| |ctx#0@@8|) (Interp.__default.InterpExprs $ly@@6 |es#0@@3| |ctx#0@@8|))
 :qid |Interpdfy.69:12|
 :skolemid |1203|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@6) |es#0@@3| |ctx#0@@8|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@11| T@U) (|e#0@@11| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| |st#0@@11| (Lit DatatypeTypeType |e#0@@11|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@11| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@11| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@11|) (=> (Equiv.__default.Inv |st#0@@11|) (and (Equiv.MState.MState_q |st#0@@11|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@11|) (Equiv.MState.ctx |st#0@@11|))))) (= (Equiv.__default.P__Fail |st#0@@11| (Lit DatatypeTypeType |e#0@@11|))  (=> (Equiv.__default.Inv |st#0@@11|) (Utils.Result.Failure_q (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@11|) (Equiv.MState.ctx |st#0@@11|)))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |707|
 :pattern ( (Equiv.__default.P__Fail |st#0@@11| (Lit DatatypeTypeType |e#0@@11|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@12| T@U) (|es#0@@4| T@U) (|st'#0@@4| T@U) (|vs#0@@1| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Succ#canCall| |st#0@@12| |es#0@@4| |st'#0@@4| |vs#0@@1|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@12| Tclass.Equiv.MState) ($Is SeqType |es#0@@4| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@4| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#0@@1| Tclass.Equiv.VS)))) (and (and (and (Equiv.MState.MState_q |st#0@@12|) (|Interp.__default.InterpExprs#canCall| |es#0@@4| (Equiv.MState.ctx |st#0@@12|))) (let ((|res#0@@3| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@4| (Equiv.MState.ctx |st#0@@12|))))
 (and (and (Equiv.MState.MState_q |st#0@@12|) (|Interp.__default.InterpExprs#canCall| |es#0@@4| (Equiv.MState.ctx_k |st#0@@12|))) (let ((|res'#0@@3| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@4| (Equiv.MState.ctx_k |st#0@@12|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@12|) (=> (Equiv.__default.Inv |st#0@@12|) (and (|Equiv.__default.EqResultSeq#canCall| |res#0@@3| |res'#0@@3|) (=> (Equiv.__default.EqResultSeq |res#0@@3| |res'#0@@3|) (and (and (|$IsA#Utils.Result| |res#0@@3|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@1|) (Equiv.MState.MState_q |st'#0@@4|))) (=> (|Utils.Result#Equal| |res#0@@3| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@1|)) ($Box MapType (Equiv.MState.ctx |st'#0@@4|)))))) (and (|$IsA#Utils.Result| |res'#0@@3|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@1|) (Equiv.MState.MState_q |st'#0@@4|))))))))))))) (= (Equiv.__default.Pes__Succ |st#0@@12| |es#0@@4| |st'#0@@4| |vs#0@@1|) (let ((|res#0@@4| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@4| (Equiv.MState.ctx |st#0@@12|))))
(let ((|res'#0@@4| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@4| (Equiv.MState.ctx_k |st#0@@12|))))
 (and (and (and (Equiv.__default.Inv |st#0@@12|) (Equiv.__default.EqResultSeq |res#0@@4| |res'#0@@4|)) (|Utils.Result#Equal| |res#0@@4| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@1|)) ($Box MapType (Equiv.MState.ctx |st'#0@@4|))))))) (|Utils.Result#Equal| |res'#0@@4| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs_k |vs#0@@1|)) ($Box MapType (Equiv.MState.ctx_k |st'#0@@4|))))))))))))
 :qid |Inductiondfy.40:28|
 :skolemid |723|
 :pattern ( (Equiv.__default.Pes__Succ |st#0@@12| |es#0@@4| |st'#0@@4| |vs#0@@1|))
))))
...
(assert (forall (($ly@@9 T@U) (|es#0@@5| T@U) (|ctx#0@@10| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@5| |ctx#0@@10|) (and ($Is SeqType |es#0@@5| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@10| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@5| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@5| (LitInt 0))) |ctx#0@@10|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@9 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@5| (LitInt 0))) |ctx#0@@10|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (|Seq#Drop| |es#0@@5| (LitInt 1)) |ctx1#0@@2|) (let ((|valueOrError1#0@@0| (Interp.__default.InterpExprs $ly@@9 (|Seq#Drop| |es#0@@5| (LitInt 1)) |ctx1#0@@2|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@9) |es#0@@5| |ctx#0@@10|) (ite (|Seq#Equal| |es#0@@5| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@10|)))) (let ((|valueOrError0#0@@1| (Interp.__default.InterpExpr $ly@@9 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@5| (LitInt 0))) |ctx#0@@10|)))
...
(let ((|valueOrError1#0@@1| (Interp.__default.InterpExprs $ly@@9 (|Seq#Drop| |es#0@@5| (LitInt 1)) |ctx1#0@@3|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0@@3|))) |vs#0@@2|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1207|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@9) |es#0@@5| |ctx#0@@10|))
)))
(assert (forall ((d@@40 T@U) ) (!  (=> (|$IsA#Utils.Result| d@@40) (or (Utils.Result.Success_q d@@40) (Utils.Result.Failure_q d@@40)))
 :qid |unknown.0:0|
 :skolemid |973|
 :pattern ( (|$IsA#Utils.Result| d@@40))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@13| T@U) (|es#0@@6| T@U) (|st'#0@@5| T@U) (|vs#0@@3| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Succ#canCall| (Lit DatatypeTypeType |st#0@@13|) (Lit SeqType |es#0@@6|) (Lit DatatypeTypeType |st'#0@@5|) (Lit DatatypeTypeType |vs#0@@3|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@13| Tclass.Equiv.MState) ($Is SeqType |es#0@@6| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@5| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#0@@3| Tclass.Equiv.VS)))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@13|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@6|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@13|))))) (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@6|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@13|)))))))
 (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@13|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@6|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@13|))))) (let ((|res'#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@6|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@13|)))))))
 (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@13|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@13|))))) (and (|Equiv.__default.EqResultSeq#canCall| |res#2@@1| |res'#2@@1|) (=> (Equiv.__default.EqResultSeq |res#2@@1| |res'#2@@1|) (and (and (|$IsA#Utils.Result| |res#2@@1|) (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |vs#0@@3|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st'#0@@5|)))) (=> (|Utils.Result#Equal| |res#2@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |vs#0@@3|)))) ($Box MapType (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st'#0@@5|))))))))) (and (|$IsA#Utils.Result| |res'#2@@1|) (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |vs#0@@3|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st'#0@@5|)))))))))))))) (= (Equiv.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@13|) (Lit SeqType |es#0@@6|) (Lit DatatypeTypeType |st'#0@@5|) (Lit DatatypeTypeType |vs#0@@3|)) (let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@6|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@13|)))))))
(let ((|res'#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@6|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@13|)))))))
 (and (and (and (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@13|)) (Equiv.__default.EqResultSeq |res#2@@2| |res'#2@@2|)) (|Utils.Result#Equal| |res#2@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |vs#0@@3|)))) ($Box MapType (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st'#0@@5|)))))))))) (|Utils.Result#Equal| |res'#2@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType (Equiv.MSeqValue.vs_k (Lit DatatypeTypeType |vs#0@@3|)))) ($Box MapType (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st'#0@@5|)))))))))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |725|
 :pattern ( (Equiv.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@13|) (Lit SeqType |es#0@@6|) (Lit DatatypeTypeType |st'#0@@5|) (Lit DatatypeTypeType |vs#0@@3|)))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@14| T@U) (|vars#0@@7| T@U) (|argvs#0| T@U) ) (!  (=> (or (|Equiv.__default.UpdateState__Pre#canCall| |st#0@@14| |vars#0@@7| |argvs#0|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@14| Tclass.Equiv.MState) ($Is SeqType |vars#0@@7| (TSeq (TSeq TChar)))) ($Is DatatypeTypeType |argvs#0| Tclass.Equiv.VS)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@14|) (=> (Equiv.__default.Inv |st#0@@14|) (and (Equiv.MSeqValue.MSeqValue_q |argvs#0|) (=> (= (|Seq#Length| |vars#0@@7|) (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0|))) (and (and (Equiv.MSeqValue.MSeqValue_q |argvs#0|) (Equiv.MSeqValue.MSeqValue_q |argvs#0|)) (=> (= (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0|)) (|Seq#Length| (Equiv.MSeqValue.vs_k |argvs#0|))) (and (and (Equiv.MSeqValue.MSeqValue_q |argvs#0|) (Equiv.MSeqValue.MSeqValue_q |argvs#0|)) (|Equiv.__default.EqSeqValue#canCall| (Equiv.MSeqValue.vs |argvs#0|) (Equiv.MSeqValue.vs_k |argvs#0|))))))))) (= (Equiv.__default.UpdateState__Pre |st#0@@14| |vars#0@@7| |argvs#0|)  (and (and (Equiv.__default.Inv |st#0@@14|) (and (= (|Seq#Length| |vars#0@@7|) (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0|))) (= (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0|)) (|Seq#Length| (Equiv.MSeqValue.vs_k |argvs#0|))))) (Equiv.__default.EqSeqValue (Equiv.MSeqValue.vs |argvs#0|) (Equiv.MSeqValue.vs_k |argvs#0|))))))
 :qid |Inductiondfy.51:35|
 :skolemid |748|
 :pattern ( (Equiv.__default.UpdateState__Pre |st#0@@14| |vars#0@@7| |argvs#0|))
))))
(assert (forall ((Utils.Result$T@@8 T@U) (d@@41 T@U) ) (!  (=> ($Is DatatypeTypeType d@@41 (Tclass.Utils.Result Utils.Result$T@@8)) (or (Utils.Result.Success_q d@@41) (Utils.Result.Failure_q d@@41)))
 :qid |unknown.0:0|
 :skolemid |974|
 :pattern ( (Utils.Result.Failure_q d@@41) ($Is DatatypeTypeType d@@41 (Tclass.Utils.Result Utils.Result$T@@8)))
 :pattern ( (Utils.Result.Success_q d@@41) ($Is DatatypeTypeType d@@41 (Tclass.Utils.Result Utils.Result$T@@8)))
)))
...
(assert (forall (($ly@@10 T@U) (|es#0@@7| T@U) (|ctx#0@@11| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@7|) |ctx#0@@11|) (and ($Is SeqType |es#0@@7| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@11| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@7| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@7|) (LitInt 0))) |ctx#0@@11|) (let ((|valueOrError0#1@@0| (Interp.__default.InterpExpr ($LS $ly@@10) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@7|) (LitInt 0))) |ctx#0@@11|)))
...
(let ((|valueOrError1#1@@1| (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@7|) (LitInt 1))) |ctx1#1@@2|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#1@@0|))) |vs#1@@0|)) ($Box MapType |ctx2#1@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |1208|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType |es#0@@7|) |ctx#0@@11|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@15| T@U) (|vars#0@@8| T@U) (|vals#0@@3| T@U) ) (!  (=> (or (|Equiv.__default.AssignState#canCall| (Lit DatatypeTypeType |st#0@@15|) (Lit SeqType |vars#0@@8|) (Lit DatatypeTypeType |vals#0@@3|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@15| Tclass.Equiv.MState) ($Is SeqType |vars#0@@8| (TSeq (TSeq TChar)))) ($Is DatatypeTypeType |vals#0@@3| Tclass.Equiv.VS)) (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.UpdateState__Pre (Lit DatatypeTypeType |st#0@@15|) (Lit SeqType |vars#0@@8|) (Lit DatatypeTypeType |vals#0@@3|)))))))) (and (and (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |vals#0@@3|)) (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@8|) (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |vals#0@@3|))))) (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |vals#0@@3|)) (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@8|) (Lit SeqType (Equiv.MSeqValue.vs_k (Lit DatatypeTypeType |vals#0@@3|)))))) (= (Equiv.__default.AssignState (Lit DatatypeTypeType |st#0@@15|) (Lit SeqType |vars#0@@8|) (Lit DatatypeTypeType |vals#0@@3|)) (let ((|ctx'#2@@1| (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@15|))))
(let ((|ctx#2@@1| (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@15|))))
...
|st'#2|))))))))))
 ...
 :weight 3
 :skolemid |764|
 :pattern ( (Equiv.__default.AssignState (Lit DatatypeTypeType |st#0@@15|) (Lit SeqType |vars#0@@8|) (Lit DatatypeTypeType |vals#0@@3|)))
))))
...
(let ((|vs#0@@4| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@6|) ($Box DatatypeTypeType |res'#0@@6|))))))))))
 (and (Equiv.__default.EqSeqValue |vs#0@@4| |vs'#0|) (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#0@@12| |ctx'#0@@4|)))))) false) true))))
 :qid |Equivdfy.45:31|
 :skolemid |673|
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st0#0@@1| T@U) (|st#0@@16| T@U) (|vars#0@@9| T@U) ) (!  (=> (or (|Equiv.__default.BindEndScope#canCall| (Lit DatatypeTypeType |st0#0@@1|) (Lit DatatypeTypeType |st#0@@16|) (Lit SeqType |vars#0@@9|)) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st0#0@@1| Tclass.Equiv.MState) ($Is DatatypeTypeType |st#0@@16| Tclass.Equiv.MState)) ($Is SeqType |vars#0@@9| (TSeq (TSeq TChar)))))) (and (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st0#0@@1|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st0#0@@1|))))) (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@16|)))) (= (Equiv.__default.BindEndScope (Lit DatatypeTypeType |st0#0@@1|) (Lit DatatypeTypeType |st#0@@16|) (Lit SeqType |vars#0@@9|)) (let ((|ctx0'#2| (Equiv.MState.ctx_k (Lit DatatypeTypeType |st0#0@@1|))))
(let ((|ctx0#2| (Equiv.MState.ctx (Lit DatatypeTypeType |st0#0@@1|))))
(let ((|ctx'#2@@2| (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@16|))))
(let ((|ctx#2@@2| (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@16|))))
(let ((|ctx1#2@@3| (|Map#Merge| |ctx0#2| (|Map#Subtract| |ctx#2@@2| (|Set#FromBoogieMap| (|lambda#9| (TSeq TChar) |vars#0@@9|))))))
(let ((|ctx1'#2@@0| (|Map#Merge| |ctx0'#2| (|Map#Subtract| |ctx'#2@@2| (|Set#FromBoogieMap| (|lambda#9| (TSeq TChar) |vars#0@@9|))))))
(let ((|st'#2@@0| (|#Equiv.MState.MState| |ctx1#2@@3| |ctx1'#2@@0|)))
|st'#2@@0|))))))))))
 :qid |Inductiondfy.64:31|
 :weight 3
 :skolemid |784|
 :pattern ( (Equiv.__default.BindEndScope (Lit DatatypeTypeType |st0#0@@1|) (Lit DatatypeTypeType |st#0@@16|) (Lit SeqType |vars#0@@9|)))
))))
...
(assert (forall (($ly@@11 T@U) (|e#0@@13| T@U) (|ctx#0@@13| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@13|) (Lit MapType |ctx#0@@13|)) (and ($Is DatatypeTypeType |e#0@@13| Tclass.AST.Expr) ($Is MapType |ctx#0@@13| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@13|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@13|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@13|))))) (let ((|body#5| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@13|)))))
...
(Lit DatatypeTypeType (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#4|)) ($Box MapType (Lit MapType |ctx#0@@13|)))))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@13|)) (let ((|body#4| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@13|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1202|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@11) (Lit DatatypeTypeType |e#0@@13|) (Lit MapType |ctx#0@@13|)))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@17| T@U) (|es#0@@8| T@U) (|st'#0@@6| T@U) (|vs#0@@5| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Succ#canCall| |st#0@@17| (Lit SeqType |es#0@@8|) |st'#0@@6| |vs#0@@5|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@17| Tclass.Equiv.MState) ($Is SeqType |es#0@@8| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@6| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#0@@5| Tclass.Equiv.VS)))) (and (and (and (Equiv.MState.MState_q |st#0@@17|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@8|) (Equiv.MState.ctx |st#0@@17|))) (let ((|res#1@@1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@8|) (Equiv.MState.ctx |st#0@@17|))))
 (and (and (Equiv.MState.MState_q |st#0@@17|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@8|) (Equiv.MState.ctx_k |st#0@@17|))) (let ((|res'#1@@1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@8|) (Equiv.MState.ctx_k |st#0@@17|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@17|) (=> (Equiv.__default.Inv |st#0@@17|) (and (|Equiv.__default.EqResultSeq#canCall| |res#1@@1| |res'#1@@1|) (=> (Equiv.__default.EqResultSeq |res#1@@1| |res'#1@@1|) (and (and (|$IsA#Utils.Result| |res#1@@1|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@5|) (Equiv.MState.MState_q |st'#0@@6|))) (=> (|Utils.Result#Equal| |res#1@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@5|)) ($Box MapType (Equiv.MState.ctx |st'#0@@6|)))))) (and (|$IsA#Utils.Result| |res'#1@@1|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@5|) (Equiv.MState.MState_q |st'#0@@6|))))))))))))) (= (Equiv.__default.Pes__Succ |st#0@@17| (Lit SeqType |es#0@@8|) |st'#0@@6| |vs#0@@5|) (let ((|res#1@@2| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@8|) (Equiv.MState.ctx |st#0@@17|))))
(let ((|res'#1@@2| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@8|) (Equiv.MState.ctx_k |st#0@@17|))))
 (and (and (and (Equiv.__default.Inv |st#0@@17|) (Equiv.__default.EqResultSeq |res#1@@2| |res'#1@@2|)) (|Utils.Result#Equal| |res#1@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@5|)) ($Box MapType (Equiv.MState.ctx |st'#0@@6|))))))) (|Utils.Result#Equal| |res'#1@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs_k |vs#0@@5|)) ($Box MapType (Equiv.MState.ctx_k |st'#0@@6|))))))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |724|
 :pattern ( (Equiv.__default.Pes__Succ |st#0@@17| (Lit SeqType |es#0@@8|) |st'#0@@6| |vs#0@@5|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@18| T@U) (|vars#0@@11| T@U) (|vals#0@@4| T@U) ) (!  (=> (or (|Equiv.__default.BindStartScope#canCall| |st#0@@18| (Lit SeqType |vars#0@@11|) |vals#0@@4|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@18| Tclass.Equiv.MState) ($Is SeqType |vars#0@@11| (TSeq (TSeq TChar)))) ($Is DatatypeTypeType |vals#0@@4| Tclass.Equiv.VS)) (Equiv.__default.UpdateState__Pre |st#0@@18| (Lit SeqType |vars#0@@11|) |vals#0@@4|)))) (and (|Equiv.__default.AssignState#canCall| |st#0@@18| (Lit SeqType |vars#0@@11|) |vals#0@@4|) (= (Equiv.__default.BindStartScope |st#0@@18| (Lit SeqType |vars#0@@11|) |vals#0@@4|) (Equiv.__default.AssignState |st#0@@18| (Lit SeqType |vars#0@@11|) |vals#0@@4|))))
 :qid |Inductiondfy.58:33|
 :weight 3
 :skolemid |776|
 :pattern ( (Equiv.__default.BindStartScope |st#0@@18| (Lit SeqType |vars#0@@11|) |vals#0@@4|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@19| T@U) (|e#0@@14| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |e#0@@14|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@19| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@14| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@19|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@19|))))) (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@19|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@14|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@19|))))))) (= (Equiv.__default.P__Fail (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |e#0@@14|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@19|)) (Utils.Result.Failure_q (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@14|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@19|)))))))))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |708|
 :pattern ( (Equiv.__default.P__Fail (Lit DatatypeTypeType |st#0@@19|) (Lit DatatypeTypeType |e#0@@14|)))
))))
...
(assert (forall ((d@@42 T@U) (Utils.Result$T@@14 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (Utils.Result.Success_q d@@42) ($IsAlloc DatatypeTypeType d@@42 (Tclass.Utils.Result Utils.Result$T@@14) $h@@6))) ($IsAllocBox (Utils.Result.value d@@42) Utils.Result$T@@14 $h@@6))
 :qid |unknown.0:0|
 :skolemid |965|
 :pattern ( ($IsAllocBox (Utils.Result.value d@@42) Utils.Result$T@@14 $h@@6))
)))
...
(assert (forall ((d@@43 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (Equiv.MValue.MValue_q d@@43) ($IsAlloc DatatypeTypeType d@@43 Tclass.Equiv.MValue $h@@7))) ($IsAlloc intType (int_2_U (Equiv.MValue.v d@@43)) TInt $h@@7))
 :qid |unknown.0:0|
 :skolemid |909|
 :pattern ( ($IsAlloc intType (int_2_U (Equiv.MValue.v d@@43)) TInt $h@@7))
)))
(assert (forall ((d@@44 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (Equiv.MValue.MValue_q d@@44) ($IsAlloc DatatypeTypeType d@@44 Tclass.Equiv.MValue $h@@8))) ($IsAlloc intType (int_2_U (Equiv.MValue.v_k d@@44)) TInt $h@@8))
 :qid |unknown.0:0|
 :skolemid |910|
 :pattern ( ($IsAlloc intType (int_2_U (Equiv.MValue.v_k d@@44)) TInt $h@@8))
)))
(assert (forall ((d@@45 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) (and (AST.Expr__Raw.Literal_q d@@45) ($IsAlloc DatatypeTypeType d@@45 Tclass.AST.Expr__Raw $h@@9))) ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@45)) TInt $h@@9))
 :qid |unknown.0:0|
 :skolemid |1042|
 :pattern ( ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@45)) TInt $h@@9))
)))
(assert (forall ((d@@46 T@U) ) (!  (=> ($Is DatatypeTypeType d@@46 Tclass.AST.BinOp) (or (or (AST.BinOp.Add_q d@@46) (AST.BinOp.Sub_q d@@46)) (AST.BinOp.Mul_q d@@46)))
 :qid |unknown.0:0|
 :skolemid |1022|
 :pattern ( (AST.BinOp.Mul_q d@@46) ($Is DatatypeTypeType d@@46 Tclass.AST.BinOp))
 :pattern ( (AST.BinOp.Sub_q d@@46) ($Is DatatypeTypeType d@@46 Tclass.AST.BinOp))
 :pattern ( (AST.BinOp.Add_q d@@46) ($Is DatatypeTypeType d@@46 Tclass.AST.BinOp))
)))
...
(assert (forall (($ly@@13 T@U) (|e#0@@15| T@U) (|ctx#0@@14| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@15|) |ctx#0@@14|) (and ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr) ($Is MapType |ctx#0@@14| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@15|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@15|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@15|))))) (let ((|body#3| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@15|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#3| |v1#3| |v2#3|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@15|)))))) (let ((|es#3| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@15|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#3|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@13) (Lit DatatypeTypeType |e#0@@15|) |ctx#0@@14|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|name#2| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@15|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#2|)) ($Box MapType |ctx#0@@14|))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|body#2| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@15|)))))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1201|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@13) (Lit DatatypeTypeType |e#0@@15|) |ctx#0@@14|))
)))
...
(assert (forall ((d@@48 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) ($Is DatatypeTypeType d@@48 Tclass.Equiv.MState)) ($IsAlloc DatatypeTypeType d@@48 Tclass.Equiv.MState $h@@10))
 :qid |unknown.0:0|
 :skolemid |899|
 :pattern ( ($IsAlloc DatatypeTypeType d@@48 Tclass.Equiv.MState $h@@10))
)))
(assert (forall ((d@@49 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) ($Is DatatypeTypeType d@@49 Tclass.Equiv.MValue)) ($IsAlloc DatatypeTypeType d@@49 Tclass.Equiv.MValue $h@@11))
 :qid |unknown.0:0|
 :skolemid |914|
 :pattern ( ($IsAlloc DatatypeTypeType d@@49 Tclass.Equiv.MValue $h@@11))
)))
(assert (forall ((d@@50 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) ($Is DatatypeTypeType d@@50 Tclass.Equiv.MSeqValue)) ($IsAlloc DatatypeTypeType d@@50 Tclass.Equiv.MSeqValue $h@@12))
 :qid |unknown.0:0|
 :skolemid |934|
 :pattern ( ($IsAlloc DatatypeTypeType d@@50 Tclass.Equiv.MSeqValue $h@@12))
)))
(assert (forall ((d@@51 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) ($Is DatatypeTypeType d@@51 Tclass.AST.BinOp)) ($IsAlloc DatatypeTypeType d@@51 Tclass.AST.BinOp $h@@13))
 :qid |unknown.0:0|
 :skolemid |1020|
 :pattern ( ($IsAlloc DatatypeTypeType d@@51 Tclass.AST.BinOp $h@@13))
)))
(assert (forall ((d@@52 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) ($Is DatatypeTypeType d@@52 Tclass.AST.Expr__Raw)) ($IsAlloc DatatypeTypeType d@@52 Tclass.AST.Expr__Raw $h@@14))
 :qid |unknown.0:0|
 :skolemid |1116|
 :pattern ( ($IsAlloc DatatypeTypeType d@@52 Tclass.AST.Expr__Raw $h@@14))
)))
...
(assert (forall ((d@@53 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (Equiv.MSeqValue.MSeqValue_q d@@53) ($IsAlloc DatatypeTypeType d@@53 Tclass.Equiv.MSeqValue $h@@15))) ($IsAlloc SeqType (Equiv.MSeqValue.vs d@@53) (TSeq TInt) $h@@15))
 :qid |unknown.0:0|
 :skolemid |925|
 :pattern ( ($IsAlloc SeqType (Equiv.MSeqValue.vs d@@53) (TSeq TInt) $h@@15))
)))
(assert (forall ((d@@54 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (Equiv.MSeqValue.MSeqValue_q d@@54) ($IsAlloc DatatypeTypeType d@@54 Tclass.Equiv.MSeqValue $h@@16))) ($IsAlloc SeqType (Equiv.MSeqValue.vs_k d@@54) (TSeq TInt) $h@@16))
 :qid |unknown.0:0|
 :skolemid |926|
 :pattern ( ($IsAlloc SeqType (Equiv.MSeqValue.vs_k d@@54) (TSeq TInt) $h@@16))
)))
(assert (forall ((d@@55 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (AST.Expr__Raw.Var_q d@@55) ($IsAlloc DatatypeTypeType d@@55 Tclass.AST.Expr__Raw $h@@17))) ($IsAlloc SeqType (AST.Expr__Raw.name d@@55) (TSeq TChar) $h@@17))
 :qid |unknown.0:0|
 :skolemid |1032|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.name d@@55) (TSeq TChar) $h@@17))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@20| T@U) (|vars#0@@13| T@U) (|vals#0@@5| T@U) ) (!  (=> (or (|Equiv.__default.AssignState#canCall| |st#0@@20| (Lit SeqType |vars#0@@13|) |vals#0@@5|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@20| Tclass.Equiv.MState) ($Is SeqType |vars#0@@13| (TSeq (TSeq TChar)))) ($Is DatatypeTypeType |vals#0@@5| Tclass.Equiv.VS)) (Equiv.__default.UpdateState__Pre |st#0@@20| (Lit SeqType |vars#0@@13|) |vals#0@@5|)))) (and (and (and (Equiv.MSeqValue.MSeqValue_q |vals#0@@5|) (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@13|) (Equiv.MSeqValue.vs |vals#0@@5|))) (and (Equiv.MSeqValue.MSeqValue_q |vals#0@@5|) (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@13|) (Equiv.MSeqValue.vs_k |vals#0@@5|)))) (= (Equiv.__default.AssignState |st#0@@20| (Lit SeqType |vars#0@@13|) |vals#0@@5|) (let ((|ctx'#1@@2| (Equiv.MState.ctx_k |st#0@@20|)))
(let ((|ctx#1@@2| (Equiv.MState.ctx |st#0@@20|)))
...
(let ((|ctx1#1@@3| (|Map#Merge| |ctx#1@@2| |bindings#1@@0|)))
(let ((|ctx1'#1@@0| (|Map#Merge| |ctx'#1@@2| |bindings'#1|)))
(let ((|st'#1@@0| (|#Equiv.MState.MState| |ctx1#1@@3| |ctx1'#1@@0|)))
|st'#1@@0|))))))))))
 :qid |Inductiondfy.54:30|
 :weight 3
 :skolemid |763|
 :pattern ( (Equiv.__default.AssignState |st#0@@20| (Lit SeqType |vars#0@@13|) |vals#0@@5|))
))))
(assert (forall ((|a#5#0#0@@1| T@U) (|a#5#1#0@@0| T@U) (d@@56 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#5#0#0@@1|) ($Box DatatypeTypeType d@@56)) (< (DtRank d@@56) (DtRank (|#Equiv.MState.MState| |a#5#0#0@@1| |a#5#1#0@@0|))))
 :qid |Equivdfy.62:28|
 :skolemid |894|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#5#0#0@@1|) ($Box DatatypeTypeType d@@56)) (|#Equiv.MState.MState| |a#5#0#0@@1| |a#5#1#0@@0|))
)))
(assert (forall ((|a#8#0#0| T@U) (|a#8#1#0| T@U) (d@@57 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#8#1#0|) ($Box DatatypeTypeType d@@57)) (< (DtRank d@@57) (DtRank (|#Equiv.MState.MState| |a#8#0#0| |a#8#1#0|))))
 :qid |Equivdfy.62:28|
 :skolemid |897|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#8#1#0|) ($Box DatatypeTypeType d@@57)) (|#Equiv.MState.MState| |a#8#0#0| |a#8#1#0|))
)))
...
(assert (forall ((d@@58 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (Equiv.MState.MState_q d@@58) ($IsAlloc DatatypeTypeType d@@58 Tclass.Equiv.MState $h@@18))) ($IsAlloc MapType (Equiv.MState.ctx d@@58) (TMap (TSeq TChar) TInt) $h@@18))
 :qid |unknown.0:0|
 :skolemid |890|
 :pattern ( ($IsAlloc MapType (Equiv.MState.ctx d@@58) (TMap (TSeq TChar) TInt) $h@@18))
)))
(assert (forall ((d@@59 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (Equiv.MState.MState_q d@@59) ($IsAlloc DatatypeTypeType d@@59 Tclass.Equiv.MState $h@@19))) ($IsAlloc MapType (Equiv.MState.ctx_k d@@59) (TMap (TSeq TChar) TInt) $h@@19))
 :qid |unknown.0:0|
 :skolemid |891|
 :pattern ( ($IsAlloc MapType (Equiv.MState.ctx_k d@@59) (TMap (TSeq TChar) TInt) $h@@19))
)))
(assert (forall ((d@@60 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (_System.Tuple2.___hMake2_q d@@60) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@60 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@20)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@60 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@20))
)))) ($IsAllocBox (_System.Tuple2._0 d@@60) |_System._tuple#2$T0@@6| $h@@20))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@60) |_System._tuple#2$T0@@6| $h@@20))
)))
(assert (forall ((d@@61 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (_System.Tuple2.___hMake2_q d@@61) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@61 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@21)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@61 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@21))
)))) ($IsAllocBox (_System.Tuple2._1 d@@61) |_System._tuple#2$T1@@7| $h@@21))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@61) |_System._tuple#2$T1@@7| $h@@21))
)))
...
(assert (forall ((d@@62 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (AST.Expr__Raw.Bind_q d@@62) ($IsAlloc DatatypeTypeType d@@62 Tclass.AST.Expr__Raw $h@@22))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@62) Tclass.AST.Expr__Raw $h@@22))
 :qid |unknown.0:0|
 :skolemid |1052|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@62) Tclass.AST.Expr__Raw $h@@22))
)))
(assert (forall ((d@@63 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (AST.Expr__Raw.If_q d@@63) ($IsAlloc DatatypeTypeType d@@63 Tclass.AST.Expr__Raw $h@@23))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@63) Tclass.AST.Expr__Raw $h@@23))
 :qid |unknown.0:0|
 :skolemid |1081|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@63) Tclass.AST.Expr__Raw $h@@23))
)))
(assert (forall ((d@@64 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (AST.Expr__Raw.If_q d@@64) ($IsAlloc DatatypeTypeType d@@64 Tclass.AST.Expr__Raw $h@@24))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@64) Tclass.AST.Expr__Raw $h@@24))
 :qid |unknown.0:0|
 :skolemid |1082|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@64) Tclass.AST.Expr__Raw $h@@24))
)))
(assert (forall ((d@@65 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (AST.Expr__Raw.If_q d@@65) ($IsAlloc DatatypeTypeType d@@65 Tclass.AST.Expr__Raw $h@@25))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@65) Tclass.AST.Expr__Raw $h@@25))
 :qid |unknown.0:0|
 :skolemid |1083|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@65) Tclass.AST.Expr__Raw $h@@25))
)))
(assert (forall ((d@@66 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (AST.Expr__Raw.Op_q d@@66) ($IsAlloc DatatypeTypeType d@@66 Tclass.AST.Expr__Raw $h@@26))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@66) Tclass.AST.BinOp $h@@26))
 :qid |unknown.0:0|
 :skolemid |1096|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@66) Tclass.AST.BinOp $h@@26))
)))
(assert (forall ((d@@67 T@U) ($h@@27 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (AST.Expr__Raw.Op_q d@@67) ($IsAlloc DatatypeTypeType d@@67 Tclass.AST.Expr__Raw $h@@27))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@67) Tclass.AST.Expr__Raw $h@@27))
 :qid |unknown.0:0|
 :skolemid |1097|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@67) Tclass.AST.Expr__Raw $h@@27))
)))
(assert (forall ((d@@68 T@U) ($h@@28 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (AST.Expr__Raw.Op_q d@@68) ($IsAlloc DatatypeTypeType d@@68 Tclass.AST.Expr__Raw $h@@28))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@68) Tclass.AST.Expr__Raw $h@@28))
 :qid |unknown.0:0|
 :skolemid |1098|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@68) Tclass.AST.Expr__Raw $h@@28))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st0#0@@2| T@U) (|st#0@@21| T@U) (|vars#0@@14| T@U) ) (!  (=> (or (|Equiv.__default.BindEndScope#canCall| |st0#0@@2| |st#0@@21| |vars#0@@14|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st0#0@@2| Tclass.Equiv.MState) ($Is DatatypeTypeType |st#0@@21| Tclass.Equiv.MState)) ($Is SeqType |vars#0@@14| (TSeq (TSeq TChar)))))) (and (=> (and (Equiv.__default.Inv |st0#0@@2|) (Equiv.__default.Inv |st#0@@21|)) (Equiv.__default.Inv (Equiv.__default.BindEndScope |st0#0@@2| |st#0@@21| |vars#0@@14|))) ($Is DatatypeTypeType (Equiv.__default.BindEndScope |st0#0@@2| |st#0@@21| |vars#0@@14|) Tclass.Equiv.MState)))
 :qid |Inductiondfy.64:31|
 :skolemid |780|
 :pattern ( (Equiv.__default.BindEndScope |st0#0@@2| |st#0@@21| |vars#0@@14|))
))))
...
(assert (forall ((d@@69 T@U) ($h@@29 T@U) ) (!  (=> (and ($IsGoodHeap $h@@29) (and (AST.Expr__Raw.Bind_q d@@69) ($IsAlloc DatatypeTypeType d@@69 Tclass.AST.Expr__Raw $h@@29))) ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@69) (TSeq (TSeq TChar)) $h@@29))
 :qid |unknown.0:0|
 :skolemid |1050|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@69) (TSeq (TSeq TChar)) $h@@29))
)))
(assert (forall ((d@@70 T@U) ($h@@30 T@U) ) (!  (=> (and ($IsGoodHeap $h@@30) (and (AST.Expr__Raw.Assign_q d@@70) ($IsAlloc DatatypeTypeType d@@70 Tclass.AST.Expr__Raw $h@@30))) ($IsAlloc SeqType (AST.Expr__Raw.avars d@@70) (TSeq (TSeq TChar)) $h@@30))
 :qid |unknown.0:0|
 :skolemid |1067|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avars d@@70) (TSeq (TSeq TChar)) $h@@30))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@22| T@U) (|vars#0@@15| T@U) (|argvs#0@@0| T@U) ) (!  (=> (or (|Equiv.__default.UpdateState__Pre#canCall| |st#0@@22| (Lit SeqType |vars#0@@15|) |argvs#0@@0|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@22| Tclass.Equiv.MState) ($Is SeqType |vars#0@@15| (TSeq (TSeq TChar)))) ($Is DatatypeTypeType |argvs#0@@0| Tclass.Equiv.VS)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@22|) (=> (Equiv.__default.Inv |st#0@@22|) (and (Equiv.MSeqValue.MSeqValue_q |argvs#0@@0|) (=> (= (|Seq#Length| (Lit SeqType |vars#0@@15|)) (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0@@0|))) (and (and (Equiv.MSeqValue.MSeqValue_q |argvs#0@@0|) (Equiv.MSeqValue.MSeqValue_q |argvs#0@@0|)) (=> (= (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0@@0|)) (|Seq#Length| (Equiv.MSeqValue.vs_k |argvs#0@@0|))) (and (and (Equiv.MSeqValue.MSeqValue_q |argvs#0@@0|) (Equiv.MSeqValue.MSeqValue_q |argvs#0@@0|)) (|Equiv.__default.EqSeqValue#canCall| (Equiv.MSeqValue.vs |argvs#0@@0|) (Equiv.MSeqValue.vs_k |argvs#0@@0|))))))))) (= (Equiv.__default.UpdateState__Pre |st#0@@22| (Lit SeqType |vars#0@@15|) |argvs#0@@0|)  (and (and (Equiv.__default.Inv |st#0@@22|) (and (= (|Seq#Length| (Lit SeqType |vars#0@@15|)) (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0@@0|))) (= (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0@@0|)) (|Seq#Length| (Equiv.MSeqValue.vs_k |argvs#0@@0|))))) (Equiv.__default.EqSeqValue (Equiv.MSeqValue.vs |argvs#0@@0|) (Equiv.MSeqValue.vs_k |argvs#0@@0|))))))
 :qid |Inductiondfy.51:35|
 :weight 3
 :skolemid |749|
 :pattern ( (Equiv.__default.UpdateState__Pre |st#0@@22| (Lit SeqType |vars#0@@15|) |argvs#0@@0|))
))))
...
(assert (forall ((d@@71 T@U) ($h@@31 T@U) ) (!  (=> (and ($IsGoodHeap $h@@31) (and (AST.Expr__Raw.Bind_q d@@71) ($IsAlloc DatatypeTypeType d@@71 Tclass.AST.Expr__Raw $h@@31))) ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@71) (TSeq Tclass.AST.Expr__Raw) $h@@31))
 :qid |unknown.0:0|
 :skolemid |1051|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@71) (TSeq Tclass.AST.Expr__Raw) $h@@31))
)))
(assert (forall ((d@@72 T@U) ($h@@32 T@U) ) (!  (=> (and ($IsGoodHeap $h@@32) (and (AST.Expr__Raw.Assign_q d@@72) ($IsAlloc DatatypeTypeType d@@72 Tclass.AST.Expr__Raw $h@@32))) ($IsAlloc SeqType (AST.Expr__Raw.avals d@@72) (TSeq Tclass.AST.Expr__Raw) $h@@32))
 :qid |unknown.0:0|
 :skolemid |1068|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avals d@@72) (TSeq Tclass.AST.Expr__Raw) $h@@32))
)))
(assert (forall ((d@@73 T@U) ($h@@33 T@U) ) (!  (=> (and ($IsGoodHeap $h@@33) (and (AST.Expr__Raw.Seq_q d@@73) ($IsAlloc DatatypeTypeType d@@73 Tclass.AST.Expr__Raw $h@@33))) ($IsAlloc SeqType (AST.Expr__Raw.es d@@73) (TSeq Tclass.AST.Expr__Raw) $h@@33))
 :qid |unknown.0:0|
 :skolemid |1111|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.es d@@73) (TSeq Tclass.AST.Expr__Raw) $h@@33))
)))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@23| T@U) (|vars#0@@16| T@U) (|vals#0@@6| T@U) ) (!  (=> (or (|Equiv.__default.BindStartScope#canCall| (Lit DatatypeTypeType |st#0@@23|) (Lit SeqType |vars#0@@16|) (Lit DatatypeTypeType |vals#0@@6|)) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@23| Tclass.Equiv.MState) ($Is SeqType |vars#0@@16| (TSeq (TSeq TChar)))) ($Is DatatypeTypeType |vals#0@@6| Tclass.Equiv.VS)) (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.UpdateState__Pre (Lit DatatypeTypeType |st#0@@23|) (Lit SeqType |vars#0@@16|) (Lit DatatypeTypeType |vals#0@@6|)))))))) (and (|Equiv.__default.AssignState#canCall| (Lit DatatypeTypeType |st#0@@23|) (Lit SeqType |vars#0@@16|) (Lit DatatypeTypeType |vals#0@@6|)) (= (Equiv.__default.BindStartScope (Lit DatatypeTypeType |st#0@@23|) (Lit SeqType |vars#0@@16|) (Lit DatatypeTypeType |vals#0@@6|)) (Lit DatatypeTypeType (Equiv.__default.AssignState (Lit DatatypeTypeType |st#0@@23|) (Lit SeqType |vars#0@@16|) (Lit DatatypeTypeType |vals#0@@6|))))))
 :qid |Inductiondfy.58:33|
 :weight 3
 :skolemid |777|
 :pattern ( (Equiv.__default.BindStartScope (Lit DatatypeTypeType |st#0@@23|) (Lit SeqType |vars#0@@16|) (Lit DatatypeTypeType |vals#0@@6|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@24| T@U) (|vars#0@@17| T@U) (|argvs#0@@1| T@U) ) (!  (=> (or (|Equiv.__default.UpdateState__Pre#canCall| (Lit DatatypeTypeType |st#0@@24|) (Lit SeqType |vars#0@@17|) (Lit DatatypeTypeType |argvs#0@@1|)) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@24| Tclass.Equiv.MState) ($Is SeqType |vars#0@@17| (TSeq (TSeq TChar)))) ($Is DatatypeTypeType |argvs#0@@1| Tclass.Equiv.VS)))) (and (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@24|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@24|))))) (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |argvs#0@@1|)) (=> (= (|Seq#Length| (Lit SeqType |vars#0@@17|)) (|Seq#Length| (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |argvs#0@@1|))))) (and (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |argvs#0@@1|)) (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |argvs#0@@1|))) (=> (= (|Seq#Length| (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |argvs#0@@1|)))) (|Seq#Length| (Lit SeqType (Equiv.MSeqValue.vs_k (Lit DatatypeTypeType |argvs#0@@1|))))) (and (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |argvs#0@@1|)) (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |argvs#0@@1|))) (|Equiv.__default.EqSeqValue#canCall| (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |argvs#0@@1|))) (Lit SeqType (Equiv.MSeqValue.vs_k (Lit DatatypeTypeType |argvs#0@@1|))))))))))) (= (Equiv.__default.UpdateState__Pre (Lit DatatypeTypeType |st#0@@24|) (Lit SeqType |vars#0@@17|) (Lit DatatypeTypeType |argvs#0@@1|))  (and (and (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@24|)) (and (= (|Seq#Length| (Lit SeqType |vars#0@@17|)) (|Seq#Length| (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |argvs#0@@1|))))) (= (|Seq#Length| (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |argvs#0@@1|)))) (|Seq#Length| (Lit SeqType (Equiv.MSeqValue.vs_k (Lit DatatypeTypeType |argvs#0@@1|))))))) (Equiv.__default.EqSeqValue (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |argvs#0@@1|))) (Lit SeqType (Equiv.MSeqValue.vs_k (Lit DatatypeTypeType |argvs#0@@1|))))))))
 :qid |Inductiondfy.51:35|
 :weight 3
 :skolemid |750|
 :pattern ( (Equiv.__default.UpdateState__Pre (Lit DatatypeTypeType |st#0@@24|) (Lit SeqType |vars#0@@17|) (Lit DatatypeTypeType |argvs#0@@1|)))
))))
...
(set-info :boogie-vc-id Impl$$Equiv.__default.InductBind__Succ)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@6 $Heap@0) reveal_Equiv._default.EqCtx)) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|Equiv.__default.P__Succ#canCall| |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (or (Equiv.__default.P__Succ |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (=> (|Equiv.__default.Inv#canCall| |st#0@@25|) (or (Equiv.__default.Inv |st#0@@25|) (U_2_bool (Lit boolType (bool_2_U true)))))))) (=> (=> (|Equiv.__default.P__Succ#canCall| |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (or (Equiv.__default.P__Succ |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (=> (|Equiv.__default.Inv#canCall| |st#0@@25|) (or (Equiv.__default.Inv |st#0@@25|) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|Equiv.__default.P__Succ#canCall| |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (or (Equiv.__default.P__Succ |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (=> (|Equiv.__default.Inv#canCall| |st#0@@25|) (or (Equiv.__default.Inv |st#0@@25|) (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx (Equiv.MState.ctx |st#0@@25|) (Equiv.MState.ctx_k |st#0@@25|))))))) (=> (=> (|Equiv.__default.P__Succ#canCall| |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (or (Equiv.__default.P__Succ |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (=> (|Equiv.__default.Inv#canCall| |st#0@@25|) (or (Equiv.__default.Inv |st#0@@25|) (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx (Equiv.MState.ctx |st#0@@25|) (Equiv.MState.ctx_k |st#0@@25|)))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|Equiv.__default.P__Succ#canCall| |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (or (Equiv.__default.P__Succ |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (let ((|res#1@@3| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx |st#0@@25|))))
(let ((|res'#1@@3| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx_k |st#0@@25|))))
...
(let ((|v#3@@0| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#1@@3|)))))))))))
 (=> (|Equiv.__default.EqValue#canCall| |v#3@@0| |v'#2@@0|) (or (Equiv.__default.EqValue |v#3@@0| |v'#2@@0|) (= |v#3@@0| |v'#2@@0|)))))))))))))) (=> (=> (|Equiv.__default.P__Succ#canCall| |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (or (Equiv.__default.P__Succ |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (let ((|res#1@@4| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx |st#0@@25|))))
(let ((|res'#1@@4| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx_k |st#0@@25|))))
...
(let ((|v#3@@1| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#1@@4|)))))))))))
 (=> (|Equiv.__default.EqValue#canCall| |v#3@@1| |v'#2@@1|) (or (Equiv.__default.EqValue |v#3@@1| |v'#2@@1|) (= |v#3@@1| |v'#2@@1|))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|Equiv.__default.P__Succ#canCall| |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (or (Equiv.__default.P__Succ |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (let ((|res#1@@5| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx |st#0@@25|))))
(let ((|res'#1@@5| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx_k |st#0@@25|))))
...
(let ((|ctx#2@@3| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#1@@5|))))))))))
(Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#2@@3| |ctx'#2@@3|)))))))))))) (=> (=> (|Equiv.__default.P__Succ#canCall| |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (or (Equiv.__default.P__Succ |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (let ((|res#1@@6| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx |st#0@@25|))))
(let ((|res'#1@@6| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx_k |st#0@@25|))))
 (=> (|Equiv.__default.EqResult#canCall| |res#1@@6| |res'#1@@6|) (or (Equiv.__default.EqResult |res#1@@6| |res'#1@@6|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#1@@6|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#1@@6|))))) (let ((|ctx'#2@@4| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#1@@6|))))))))))
(let ((|ctx#2@@4| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#1@@6|))))))))))
(Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#2@@4| |ctx'#2@@4|))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|Equiv.__default.P__Succ#canCall| |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (or (Equiv.__default.P__Succ |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (let ((|res#1@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx |st#0@@25|))))
(let ((|res'#1@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx_k |st#0@@25|))))
 (=> (|Equiv.__default.EqResult#canCall| |res#1@@7| |res'#1@@7|) (or (Equiv.__default.EqResult |res#1@@7| |res'#1@@7|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@7|) ($Box DatatypeTypeType |res'#1@@7|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@7|) ($Box DatatypeTypeType |res'#1@@7|)))))) (U_2_bool (Lit boolType (bool_2_U false)))))))))))) (=> (=> (|Equiv.__default.P__Succ#canCall| |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (or (Equiv.__default.P__Succ |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (let ((|res#1@@8| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx |st#0@@25|))))
(let ((|res'#1@@8| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx_k |st#0@@25|))))
 (=> (|Equiv.__default.EqResult#canCall| |res#1@@8| |res'#1@@8|) (or (Equiv.__default.EqResult |res#1@@8| |res'#1@@8|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@8|) ($Box DatatypeTypeType |res'#1@@8|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@8|) ($Box DatatypeTypeType |res'#1@@8|)))))) (U_2_bool (Lit boolType (bool_2_U false))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|Equiv.__default.P__Succ#canCall| |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (or (Equiv.__default.P__Succ |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (let ((|res#1@@9| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx |st#0@@25|))))
(let ((|res'#1@@9| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx_k |st#0@@25|))))
 (=> (|Equiv.__default.EqResult#canCall| |res#1@@9| |res'#1@@9|) (or (Equiv.__default.EqResult |res#1@@9| |res'#1@@9|) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@9|) ($Box DatatypeTypeType |res'#1@@9|)))))) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (=> (=> (|Equiv.__default.P__Succ#canCall| |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (or (Equiv.__default.P__Succ |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (let ((|res#1@@10| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx |st#0@@25|))))
(let ((|res'#1@@10| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx_k |st#0@@25|))))
 (=> (|Equiv.__default.EqResult#canCall| |res#1@@10| |res'#1@@10|) (or (Equiv.__default.EqResult |res#1@@10| |res'#1@@10|) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@10|) ($Box DatatypeTypeType |res'#1@@10|)))))) (U_2_bool (Lit boolType (bool_2_U true)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|Equiv.__default.P__Succ#canCall| |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (or (Equiv.__default.P__Succ |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (let ((|res#1@@11| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx |st#0@@25|))))
(|Utils.Result#Equal| |res#1@@11| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v |v#0@@4|))) ($Box MapType (Equiv.MState.ctx |st4#0|)))))))))) (=> (=> (|Equiv.__default.P__Succ#canCall| |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (or (Equiv.__default.P__Succ |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (let ((|res#1@@12| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx |st#0@@25|))))
(|Utils.Result#Equal| |res#1@@12| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v |v#0@@4|))) ($Box MapType (Equiv.MState.ctx |st4#0|))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|Equiv.__default.P__Succ#canCall| |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (or (Equiv.__default.P__Succ |st#0@@25| |e#0@@19| |st4#0| |v#0@@4|) (let ((|res'#1@@11| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx_k |st#0@@25|))))
(|Utils.Result#Equal| |res'#1@@11| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Equiv.MValue.v_k |v#0@@4|))) ($Box MapType (Equiv.MState.ctx_k |st4#0|))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@25| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st#0@@25| Tclass.Equiv.MState $Heap@@6)) (|$IsA#Equiv.MState| |st#0@@25|)) (=> (and (and (and (and ($Is DatatypeTypeType |e#0@@19| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@19| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@19|)) (and (and ($Is SeqType |bvars#0@@1| (TSeq (TSeq TChar))) ($IsAlloc SeqType |bvars#0@@1| (TSeq (TSeq TChar)) $Heap@@6)) (and ($Is SeqType |bvals#0@@2| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |bvals#0@@2| (TSeq Tclass.AST.Expr) $Heap@@6)))) (and (and (and ($Is DatatypeTypeType |body#0@@1| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |body#0@@1| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |body#0@@1|)) (and (and ($Is DatatypeTypeType |st1#0| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st1#0| Tclass.Equiv.MState $Heap@@6)) (|$IsA#Equiv.MState| |st1#0|)))) (=> (and (and (and (and (and ($Is DatatypeTypeType |bvarvs#0| Tclass.Equiv.VS) ($IsAlloc DatatypeTypeType |bvarvs#0| Tclass.Equiv.VS $Heap@@6)) (|$IsA#Equiv.MSeqValue| |bvarvs#0|)) (and (and ($Is DatatypeTypeType |st2#0| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st2#0| Tclass.Equiv.MState $Heap@@6)) (|$IsA#Equiv.MState| |st2#0|))) (and (and (and ($Is DatatypeTypeType |st3#0| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st3#0| Tclass.Equiv.MState $Heap@@6)) (|$IsA#Equiv.MState| |st3#0|)) (and (and ($Is DatatypeTypeType |v#0@@4| Tclass.Equiv.MValue) ($IsAlloc DatatypeTypeType |v#0@@4| Tclass.Equiv.MValue $Heap@@6)) (|$IsA#Equiv.MValue| |v#0@@4|)))) (and (and (and (and ($Is DatatypeTypeType |st4#0| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st4#0| Tclass.Equiv.MState $Heap@@6)) (|$IsA#Equiv.MState| |st4#0|)) (and (and (= 5 $FunctionContextHeight) (AST.Expr__Raw.Bind_q |e#0@@19|)) (and (|Seq#Equal| (AST.Expr__Raw.bvars |e#0@@19|) |bvars#0@@1|) (|Seq#Equal| (AST.Expr__Raw.bvals |e#0@@19|) |bvals#0@@2|)))) (and (and (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.body |e#0@@19|) |body#0@@1|) (not (Equiv.__default.P__Fail |st#0@@25| |e#0@@19|))) (and (Equiv.__default.Pes__Succ |st#0@@25| |bvals#0@@2| |st1#0| |bvarvs#0|) (Equiv.__default.UpdateState__Pre |st1#0| |bvars#0@@1| |bvarvs#0|))) (and (and (|Equiv.MState#Equal| |st2#0| (Equiv.__default.BindStartScope |st1#0| |bvars#0@@1| |bvarvs#0|)) (Equiv.__default.P__Succ |st2#0| |body#0@@1| |st3#0| |v#0@@4|)) (and (|Equiv.MState#Equal| |st4#0| (Equiv.__default.BindEndScope |st1#0| |st3#0| |bvars#0@@1|)) (= (ControlFlow 0 10) 2)))))) anon0_correct))))))
