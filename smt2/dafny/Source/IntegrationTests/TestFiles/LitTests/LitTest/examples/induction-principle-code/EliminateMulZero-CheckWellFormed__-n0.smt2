...
(set-info :boogie-vc-id CheckWellFormed$$EliminateMulZero.__default.ZeroExpr)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (= (ControlFlow 0 2) (- 0 1))) ($Is DatatypeTypeType (Lit DatatypeTypeType (|#AST.Expr_Raw.Literal| (LitInt 0))) Tclass.AST.Expr))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct)))
