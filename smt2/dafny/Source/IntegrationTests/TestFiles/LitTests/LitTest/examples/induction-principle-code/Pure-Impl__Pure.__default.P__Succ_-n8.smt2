...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|e#0@@6| T@U) (|st'#0@@0| T@U) (|v#0@@0| Int) ) (!  (=> (or (|Pure.__default.P__Succ#canCall| (Lit DatatypeTypeType |st#0@@3|) (Lit DatatypeTypeType |e#0@@6|) (Lit DatatypeTypeType |st'#0@@0|) (LitInt |v#0@@0|)) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@3| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@6| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@0| Tclass.Pure.MState)))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@3|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@6|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@3|))))) (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@6|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@3|)))))))
 (and (|Pure.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@3|) (Lit DatatypeTypeType |e#0@@6|)) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@3|) (Lit DatatypeTypeType |e#0@@6|))))) (and (|Pure.__default.ResultSameState#canCall| TInt (Lit DatatypeTypeType |st#0@@3|) |res#2@@1|) (=> (Pure.__default.ResultSameState TInt (Lit DatatypeTypeType |st#0@@3|) |res#2@@1|) (and (and (|$IsA#Utils.Result| |res#2@@1|) (Pure.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|))) (=> (|Utils.Result#Equal| |res#2@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt |v#0@@0|))) ($Box MapType (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st'#0@@0|))))))))) (and (Pure.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|)) (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@3|))))))))))) (= (Pure.__default.P__Succ (Lit DatatypeTypeType |st#0@@3|) (Lit DatatypeTypeType |e#0@@6|) (Lit DatatypeTypeType |st'#0@@0|) (LitInt |v#0@@0|)) (let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@6|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@3|)))))))
 (and (and (and (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@3|) (Lit DatatypeTypeType |e#0@@6|)) (Pure.__default.ResultSameState TInt (Lit DatatypeTypeType |st#0@@3|) |res#2@@2|)) (|Utils.Result#Equal| |res#2@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt |v#0@@0|))) ($Box MapType (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st'#0@@0|)))))))))) (|Set#Equal| (Pure.MState.locals (Lit DatatypeTypeType |st'#0@@0|)) (Pure.MState.locals (Lit DatatypeTypeType |st#0@@3|))))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |716|
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|e#0@@8| T@U) ) (!  (=> (or (|Pure.__default.P#canCall| |st#0@@4| (Lit DatatypeTypeType |e#0@@8|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@4| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@4|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@8|) (Pure.MState.ctx |st#0@@4|))) (let ((|res#1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@8|) (Pure.MState.ctx |st#0@@4|))))
 (and (|Pure.__default.Pre#canCall| |st#0@@4| (Lit DatatypeTypeType |e#0@@8|)) (=> (Pure.__default.Pre |st#0@@4| (Lit DatatypeTypeType |e#0@@8|)) (|Pure.__default.ResultSameState#canCall| TInt |st#0@@4| |res#1|))))) (= (Pure.__default.P |st#0@@4| (Lit DatatypeTypeType |e#0@@8|)) (let ((|res#1@@0| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@8|) (Pure.MState.ctx |st#0@@4|))))
 (=> (Pure.__default.Pre |st#0@@4| (Lit DatatypeTypeType |e#0@@8|)) (Pure.__default.ResultSameState TInt |st#0@@4| |res#1@@0|))))))
 :qid |Inductiondfy.34:21|
 :weight 3
 :skolemid |707|
 :pattern ( (Pure.__default.P |st#0@@4| (Lit DatatypeTypeType |e#0@@8|)))
))))
(assert (forall (($ly@@5 T@U) (|e#0@@9| T@U) (|locals#0@@1| T@U) ) (! (= (Pure.__default.IsPure ($LS $ly@@5) |e#0@@9| |locals#0@@1|) (Pure.__default.IsPure $ly@@5 |e#0@@9| |locals#0@@1|))
 :qid |Puredfy.15:13|
 :skolemid |638|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@5) |e#0@@9| |locals#0@@1|))
)))
...
(assert (forall (($ly@@7 T@U) (|e#0@@10| T@U) (|p#0@@0| T@U) ) (! (= (AST.Expr__Raw.All ($LS $ly@@7) |e#0@@10| |p#0@@0|) (AST.Expr__Raw.All $ly@@7 |e#0@@10| |p#0@@0|))
 :qid |ASTdfy.44:22|
 :skolemid |1139|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@7) |e#0@@10| |p#0@@0|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|e#0@@20| T@U) ) (!  (=> (or (|Pure.__default.P#canCall| |st#0@@8| |e#0@@20|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@8| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@20| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@8|) (|Interp.__default.InterpExpr#canCall| |e#0@@20| (Pure.MState.ctx |st#0@@8|))) (let ((|res#0@@4| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@20| (Pure.MState.ctx |st#0@@8|))))
 (and (|Pure.__default.Pre#canCall| |st#0@@8| |e#0@@20|) (=> (Pure.__default.Pre |st#0@@8| |e#0@@20|) (|Pure.__default.ResultSameState#canCall| TInt |st#0@@8| |res#0@@4|))))) (= (Pure.__default.P |st#0@@8| |e#0@@20|) (let ((|res#0@@5| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@20| (Pure.MState.ctx |st#0@@8|))))
 (=> (Pure.__default.Pre |st#0@@8| |e#0@@20|) (Pure.__default.ResultSameState TInt |st#0@@8| |res#0@@5|))))))
 :qid |Inductiondfy.34:21|
 :skolemid |706|
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((Pure._default.ResultSameCtx$V@@0 T@U) (|locals#0@@7| T@U) (|ctx#0@@10| T@U) (|res#0@@6| T@U) ) (!  (=> (or (|Pure.__default.ResultSameCtx#canCall| Pure._default.ResultSameCtx$V@@0 (Lit SetType |locals#0@@7|) (Lit MapType |ctx#0@@10|) (Lit DatatypeTypeType |res#0@@6|)) (and (< 0 $FunctionContextHeight) (and (and ($Is SetType |locals#0@@7| (TSet (TSeq TChar))) ($Is MapType |ctx#0@@10| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |res#0@@6| (Tclass.Utils.Result (Tclass._System.Tuple2 Pure._default.ResultSameCtx$V@@0 (TMap (TSeq TChar) TInt))))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@6|))))) (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@6|)))))) (= (Pure.__default.ResultSameCtx Pure._default.ResultSameCtx$V@@0 (Lit SetType |locals#0@@7|) (Lit MapType |ctx#0@@10|) (Lit DatatypeTypeType |res#0@@6|)) (ite (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@6|)) (let ((|ctx'#2| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@6|)))))))))
 ...
 :weight 3
 :skolemid |684|
 :pattern ( (Pure.__default.ResultSameCtx Pure._default.ResultSameCtx$V@@0 (Lit SetType |locals#0@@7|) (Lit MapType |ctx#0@@10|) (Lit DatatypeTypeType |res#0@@6|)))
))))
...
(set-info :boogie-vc-id Impl$$Pure.__default.P__Succ__Sound)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#6| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|Pure.__default.P#canCall| |st#0@@9| |e#0@@25|) (or (Pure.__default.P |st#0@@9| |e#0@@25|) (let ((|res#1@@3| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@25| (Pure.MState.ctx |st#0@@9|))))
...
(|Set#Equal| (|Map#Domain| |ctx'#2@@0|) (|Map#Domain| (Pure.MState.ctx |st#0@@9|)))))))))))))) (=> (=> (|Pure.__default.P#canCall| |st#0@@9| |e#0@@25|) (or (Pure.__default.P |st#0@@9| |e#0@@25|) (let ((|res#1@@4| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@25| (Pure.MState.ctx |st#0@@9|))))
...
(|Set#Equal| (|Map#Domain| |ctx'#2@@1|) (|Map#Domain| (Pure.MState.ctx |st#0@@9|))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|Pure.__default.P#canCall| |st#0@@9| |e#0@@25|) (or (Pure.__default.P |st#0@@9| |e#0@@25|) (let ((|res#1@@5| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@25| (Pure.MState.ctx |st#0@@9|))))
 (=> (Pure.__default.Pre |st#0@@9| |e#0@@25|) (=> (|Pure.__default.ResultSameState#canCall| TInt |st#0@@9| |res#1@@5|) (or (Pure.__default.ResultSameState TInt |st#0@@9| |res#1@@5|) (=> (|Pure.__default.ResultSameCtx#canCall| TInt (Pure.MState.locals |st#0@@9|) (Pure.MState.ctx |st#0@@9|) |res#1@@5|) (or (Pure.__default.ResultSameCtx TInt (Pure.MState.locals |st#0@@9|) (Pure.MState.ctx |st#0@@9|) |res#1@@5|) (=> (Utils.Result.Success_q |res#1@@5|) (let ((|ctx'#2@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@5|))))))
...
)))))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|Pure.__default.P#canCall| |st#0@@9| |e#0@@25|) (or (Pure.__default.P |st#0@@9| |e#0@@25|) (let ((|res#1@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@25| (Pure.MState.ctx |st#0@@9|))))
 (=> (Pure.__default.Pre |st#0@@9| |e#0@@25|) (=> (|Pure.__default.ResultSameState#canCall| TInt |st#0@@9| |res#1@@7|) (or (Pure.__default.ResultSameState TInt |st#0@@9| |res#1@@7|) (=> (|Pure.__default.ResultSameCtx#canCall| TInt (Pure.MState.locals |st#0@@9|) (Pure.MState.ctx |st#0@@9|) |res#1@@7|) (or (Pure.__default.ResultSameCtx TInt (Pure.MState.locals |st#0@@9|) (Pure.MState.ctx |st#0@@9|) |res#1@@7|) (=> (not (Utils.Result.Success_q |res#1@@7|)) (U_2_bool (Lit boolType (bool_2_U true))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and ($Is DatatypeTypeType |st#0@@9| Tclass.Pure.MState) ($IsAlloc DatatypeTypeType |st#0@@9| Tclass.Pure.MState $Heap@@6)) (|$IsA#Pure.MState| |st#0@@9|)) (and (and ($Is DatatypeTypeType |e#0@@25| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@25| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@25|))) (=> (and (and (and (and ($Is DatatypeTypeType |st'#0@@2| Tclass.Pure.MState) ($IsAlloc DatatypeTypeType |st'#0@@2| Tclass.Pure.MState $Heap@@6)) (|$IsA#Pure.MState| |st'#0@@2|)) (= 4 $FunctionContextHeight)) (and (Pure.__default.P__Succ |st#0@@9| |e#0@@25| |st'#0@@2| |v#0@@3|) (= (ControlFlow 0 5) 2))) anon0_correct)))))
