...
axiom 1 <= $FunctionContextHeight
   ==> (forall LinkedList._default.Concat$T: Ty, 
      $ly: LayerType, 
      l1#0: DatatypeType, 
      l2#0: DatatypeType :: 
   ...
   ==> (forall LinkedList._default.Concat$T: Ty, 
    ...
    LinkedList.__default.Concat#canCall(LinkedList._default.Concat$T, l1#0, l2#0)
       ...
       ==> (LinkedList.List.Cons_q(l1#0)
           ==> (var t#1 := LinkedList.List.tl(l1#0); 
            LinkedList.__default.Concat#canCall(LinkedList._default.Concat$T, t#1, l2#0)))
         && LinkedList.__default.Concat(LinkedList._default.Concat$T, $LS($ly), l1#0, l2#0)
           == (if LinkedList.List.Cons_q(l1#0)
             then (var t#0 := LinkedList.List.tl(l1#0); 
              (var h#0 := LinkedList.List.hd(l1#0); 
                #LinkedList.List.Cons(h#0, LinkedList.__default.Concat(LinkedList._default.Concat$T, $ly, t#0, l2#0))))
             else l2#0));
   ...
   ==> (forall LinkedList._default.Concat$T: Ty, 
    ...
    LinkedList.__default.Concat#canCall(LinkedList._default.Concat$T, Lit(l1#0), Lit(l2#0))
       ...
       ==> (Lit(LinkedList.List.Cons_q(Lit(l1#0)))
           ==> (var t#3 := Lit(LinkedList.List.tl(Lit(l1#0))); 
            LinkedList.__default.Concat#canCall(LinkedList._default.Concat$T, t#3, Lit(l2#0))))
         && LinkedList.__default.Concat(LinkedList._default.Concat$T, $LS($ly), Lit(l1#0), Lit(l2#0))
           == (if LinkedList.List.Cons_q(Lit(l1#0))
             then (var t#2 := Lit(LinkedList.List.tl(Lit(l1#0))); 
              (var h#2 := Lit(LinkedList.List.hd(Lit(l1#0))); 
                Lit(#LinkedList.List.Cons(h#2, 
                    Lit(LinkedList.__default.Concat(LinkedList._default.Concat$T, $LS($ly), t#2, Lit(l2#0)))))))
             else l2#0));
}
...
procedure {:verboseName "LinkedList.Concat (well-formedness)"} CheckWellformed$$LinkedList.__default.Concat(LinkedList._default.Concat$T: Ty, 
    l1#0: DatatypeType
       where $Is(l1#0, Tclass.LinkedList.List(LinkedList._default.Concat$T)), 
    l2#0: DatatypeType
       where $Is(l2#0, Tclass.LinkedList.List(LinkedList._default.Concat$T)));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "LinkedList.Concat (well-formedness)"} CheckWellformed$$LinkedList.__default.Concat(LinkedList._default.Concat$T: Ty, l1#0: DatatypeType, l2#0: DatatypeType)
{
  ...
  var ##l2#0: DatatypeType;
    ...
    if (*)
    {
        ...
        assume $Is(LinkedList.__default.Concat(LinkedList._default.Concat$T, $LS($LZ), l1#0, l2#0), 
          Tclass.LinkedList.List(LinkedList._default.Concat$T));
        assume false;
    }
    else
    {
        ...
        if (l1#0 == #LinkedList.List.Cons(_mcc#0#0, _mcc#1#0))
        {
            assume $IsBox(_mcc#0#0, LinkedList._default.Concat$T);
            assume $Is(_mcc#1#0, Tclass.LinkedList.List(LinkedList._default.Concat$T));
            havoc t#Z#0;
            assume {:id "id299"} let#0#0#0 == _mcc#1#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#0#0#0, Tclass.LinkedList.List(LinkedList._default.Concat$T));
            assume {:id "id300"} t#Z#0 == let#0#0#0;
            havoc h#Z#0;
            assume {:id "id301"} let#1#0#0 == _mcc#0#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $IsBox(let#1#0#0, LinkedList._default.Concat$T);
            assume {:id "id302"} h#Z#0 == let#1#0#0;
            ##l1#0 := t#Z#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##l1#0, Tclass.LinkedList.List(LinkedList._default.Concat$T), $Heap);
            ##l2#0 := l2#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##l2#0, Tclass.LinkedList.List(LinkedList._default.Concat$T), $Heap);
            assert {:id "id303"} DtRank(##l1#0) < DtRank(l1#0)
               || (DtRank(##l1#0) == DtRank(l1#0) && DtRank(##l2#0) < DtRank(l2#0));
            assume LinkedList.__default.Concat#canCall(LinkedList._default.Concat$T, t#Z#0, l2#0);
            assume {:id "id304"} LinkedList.__default.Concat(LinkedList._default.Concat$T, $LS($LZ), l1#0, l2#0)
               == #LinkedList.List.Cons(h#Z#0, 
                LinkedList.__default.Concat(LinkedList._default.Concat$T, $LS($LZ), t#Z#0, l2#0));
            assume LinkedList.__default.Concat#canCall(LinkedList._default.Concat$T, t#Z#0, l2#0);
            // CheckWellformedWithResult: any expression
            assume $Is(LinkedList.__default.Concat(LinkedList._default.Concat$T, $LS($LZ), l1#0, l2#0), 
              Tclass.LinkedList.List(LinkedList._default.Concat$T));
        ...
        else if (l1#0 == #LinkedList.List.Nil())
        {
            assume {:id "id298"} LinkedList.__default.Concat(LinkedList._default.Concat$T, $LS($LZ), l1#0, l2#0)
               == l2#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(LinkedList.__default.Concat(LinkedList._default.Concat$T, $LS($LZ), l1#0, l2#0), 
