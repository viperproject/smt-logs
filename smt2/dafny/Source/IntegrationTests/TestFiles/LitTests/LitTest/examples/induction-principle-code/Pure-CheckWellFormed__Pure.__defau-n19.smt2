...
(declare-fun Pure.__default.Pes (T@U T@U) Bool)
(declare-fun |Pure.__default.Pes#canCall| (T@U T@U) Bool)
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|e#0@@2| T@U) ) (!  (=> (or (|Pure.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@1|) (Lit DatatypeTypeType |e#0@@2|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@1| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@2| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@1|)) (|Pure.__default.IsPure#canCall| (Lit DatatypeTypeType |e#0@@2|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@1|))))) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.IsPure ($LS $LZ) (Lit DatatypeTypeType |e#0@@2|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@1|))))))) (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@1|)) (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@1|))))) (= (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@1|) (Lit DatatypeTypeType |e#0@@2|))  (and (Pure.__default.IsPure ($LS $LZ) (Lit DatatypeTypeType |e#0@@2|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@1|)))) (|Set#Subset| (Pure.MState.locals (Lit DatatypeTypeType |st#0@@1|)) (|Map#Domain| (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@1|)))))))))
 :qid |Puredfy.85:23|
 :weight 3
 :skolemid |697|
 :pattern ( (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@1|) (Lit DatatypeTypeType |e#0@@2|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|vars#0| T@U) (|argvs#0| T@U) ) (!  (=> (or (|Pure.__default.UpdateState__Pre#canCall| |st#0@@2| |vars#0| |argvs#0|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@2| Tclass.Pure.MState) ($Is SeqType |vars#0| (TSeq (TSeq TChar)))) ($Is SeqType |argvs#0| (TSeq TInt))))) (= (Pure.__default.UpdateState__Pre |st#0@@2| |vars#0| |argvs#0|)  (and true (= (|Seq#Length| |vars#0|) (|Seq#Length| |argvs#0|)))))
 :qid |Inductiondfy.51:35|
 :skolemid |761|
 :pattern ( (Pure.__default.UpdateState__Pre |st#0@@2| |vars#0| |argvs#0|))
))))
(assert (forall (($ly@@1 T@U) (|e#0@@3| T@U) (|ctx#0@@0| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@3| |ctx#0@@0|) (and ($Is DatatypeTypeType |e#0@@3| Tclass.AST.Expr) ($Is MapType |ctx#0@@0| (TMap (TSeq TChar) TInt)))) (and (=> (not (AST.Expr__Raw.Var_q |e#0@@3|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@3|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@3|) (let ((|body#1| (AST.Expr__Raw.body |e#0@@3|)))
...
(|Interp.__default.InterpBinOp#canCall| |op#1| |v1#1| |v2#1|)))))))))))))))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@3|)) (let ((|es#1| (AST.Expr__Raw.es |e#0@@3|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#1|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@1) |e#0@@3| |ctx#0@@0|) (ite (AST.Expr__Raw.Var_q |e#0@@3|) (let ((|name#0| (AST.Expr__Raw.name |e#0@@3|)))
...
(ite  (or (not (= |condv#0| 0)) (not true)) (Interp.__default.InterpExpr $ly@@1 |thn#0| |ctx_cond#0|) (Interp.__default.InterpExpr $ly@@1 |els#0| |ctx_cond#0|))))))))) (ite (AST.Expr__Raw.Op_q |e#0@@3|) (let ((|e2#0| (AST.Expr__Raw.oe2 |e#0@@3|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#0@@0| |v1#0| |v2#0|))) ($Box MapType |ctx2#1|))))))))))))))) (let ((|es#0@@1| (AST.Expr__Raw.es |e#0@@3|)))
...
(ite (|Seq#Equal| |vs#2@@0| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#3|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#2@@0| (- (|Seq#Length| |vs#2@@0|) 1)) ($Box MapType |ctx1#3|)))))))))))))))))))
 :qid |Interpdfy.24:12|
 :skolemid |1200|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@1) |e#0@@3| |ctx#0@@0|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|vars#0@@0| T@U) (|vals#0| T@U) ) (!  (=> (or (|Pure.__default.BindStartScope#canCall| (Lit DatatypeTypeType |st#0@@3|) (Lit SeqType |vars#0@@0|) (Lit SeqType |vals#0|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@3| Tclass.Pure.MState) ($Is SeqType |vars#0@@0| (TSeq (TSeq TChar)))) ($Is SeqType |vals#0| (TSeq TInt))) (U_2_bool (Lit boolType (bool_2_U (Pure.__default.UpdateState__Pre (Lit DatatypeTypeType |st#0@@3|) (Lit SeqType |vars#0@@0|) (Lit SeqType |vals#0|)))))))) (and (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@0|) (Lit SeqType |vals#0|)) (= (Pure.__default.BindStartScope (Lit DatatypeTypeType |st#0@@3|) (Lit SeqType |vars#0@@0|) (Lit SeqType |vals#0|)) (let ((|ctx#2| (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@3|))))
(let ((|locals#2| (Pure.MState.locals (Lit DatatypeTypeType |st#0@@3|))))
(let ((|locals'#2| (|Set#Union| (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |vars#0@@0|)) |locals#2|)))
(let ((|bindings#2@@0| (Lit MapType (Interp.__default.VarsAndValuesToContext ($LS $LZ) (Lit SeqType |vars#0@@0|) (Lit SeqType |vals#0|)))))
...
|st'#2|)))))))))
 ...
 :weight 3
 :skolemid |775|
 :pattern ( (Pure.__default.BindStartScope (Lit DatatypeTypeType |st#0@@3|) (Lit SeqType |vars#0@@0|) (Lit SeqType |vals#0|)))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|es#0@@2| T@U) ) (!  (=> (or (|Pure.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@4|) (Lit SeqType |es#0@@2|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@4| Tclass.Pure.MState) ($Is SeqType |es#0@@2| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@4|)) (|Pure.__default.IsPure__Es#canCall| (Lit SeqType |es#0@@2|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@4|))))) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.IsPure__Es ($LS $LZ) (Lit SeqType |es#0@@2|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@4|))))))) (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@4|)) (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@4|))))) (= (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@4|) (Lit SeqType |es#0@@2|))  (and (Pure.__default.IsPure__Es ($LS $LZ) (Lit SeqType |es#0@@2|) (Lit SetType (Pure.MState.locals (Lit DatatypeTypeType |st#0@@4|)))) (|Set#Subset| (Pure.MState.locals (Lit DatatypeTypeType |st#0@@4|)) (|Map#Domain| (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@4|)))))))))
 :qid |Puredfy.91:25|
 :weight 3
 :skolemid |702|
 :pattern ( (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@4|) (Lit SeqType |es#0@@2|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|e#0@@4| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| (Lit DatatypeTypeType |st#0@@5|) (Lit DatatypeTypeType |e#0@@4|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@5| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@4| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@5|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@4|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@5|))))) (|Pure.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@5|) (Lit DatatypeTypeType |e#0@@4|))) (= (Pure.__default.P__Fail (Lit DatatypeTypeType |st#0@@5|) (Lit DatatypeTypeType |e#0@@4|)) (U_2_bool (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@4|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@5|)))))))
(Lit boolType (bool_2_U  (=> (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@5|) (Lit DatatypeTypeType |e#0@@4|)) (Utils.Result.Failure_q |res#2|)))))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |724|
 :pattern ( (Pure.__default.P__Fail (Lit DatatypeTypeType |st#0@@5|) (Lit DatatypeTypeType |e#0@@4|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|es#0@@4| T@U) ) (!  (=> (or (|Pure.__default.Pes#canCall| |st#0@@6| (Lit SeqType |es#0@@4|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.Pure.MState) ($Is SeqType |es#0@@4| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@6|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@4|) (Pure.MState.ctx |st#0@@6|))) (let ((|res#1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@4|) (Pure.MState.ctx |st#0@@6|))))
 (and (|Pure.__default.PreEs#canCall| |st#0@@6| (Lit SeqType |es#0@@4|)) (=> (Pure.__default.PreEs |st#0@@6| (Lit SeqType |es#0@@4|)) (|Pure.__default.ResultSameState#canCall| (TSeq TInt) |st#0@@6| |res#1|))))) (= (Pure.__default.Pes |st#0@@6| (Lit SeqType |es#0@@4|)) (let ((|res#1@@0| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@4|) (Pure.MState.ctx |st#0@@6|))))
 (=> (Pure.__default.PreEs |st#0@@6| (Lit SeqType |es#0@@4|)) (Pure.__default.ResultSameState (TSeq TInt) |st#0@@6| |res#1@@0|))))))
 :qid |Inductiondfy.39:23|
 :weight 3
 :skolemid |730|
 :pattern ( (Pure.__default.Pes |st#0@@6| (Lit SeqType |es#0@@4|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|es#0@@5| T@U) ) (!  (=> (or (|Pure.__default.Pes__Fail#canCall| (Lit DatatypeTypeType |st#0@@7|) (Lit SeqType |es#0@@5|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@7| Tclass.Pure.MState) ($Is SeqType |es#0@@5| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@7|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@5|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@7|))))) (|Pure.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@7|) (Lit SeqType |es#0@@5|))) (= (Pure.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@7|) (Lit SeqType |es#0@@5|)) (U_2_bool (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@5|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@7|)))))))
(Lit boolType (bool_2_U  (=> (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@7|) (Lit SeqType |es#0@@5|)) (Utils.Result.Failure_q |res#2@@0|)))))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |747|
 :pattern ( (Pure.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@7|) (Lit SeqType |es#0@@5|)))
))))
...
(let ((|cond#1@@0| (AST.Expr__Raw.cond |e#0@@5|)))
 (and (|AST.Expr__Raw.All#canCall| |cond#1@@0| |p#0|) (=> (AST.Expr__Raw.All $ly@@3 |cond#1@@0| |p#0|) (and (|AST.Expr__Raw.All#canCall| |thn#1@@0| |p#0|) (=> (AST.Expr__Raw.All $ly@@3 |thn#1@@0| |p#0|) (|AST.Expr__Raw.All#canCall| |els#1@@0| |p#0|))))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@5|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@5|) (let ((|oe2#1| (AST.Expr__Raw.oe2 |e#0@@5|)))
(let ((|oe1#1| (AST.Expr__Raw.oe1 |e#0@@5|)))
 (and (|AST.Expr__Raw.All#canCall| |oe1#1| |p#0|) (=> (AST.Expr__Raw.All $ly@@3 |oe1#1| |p#0|) (|AST.Expr__Raw.All#canCall| |oe2#1| |p#0|)))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@5|)) (let ((|es#1@@0| (AST.Expr__Raw.es |e#0@@5|)))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@3) |e#0@@5| |p#0|)  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@1 |p#0| ($Box DatatypeTypeType |e#0@@5|)))) (ite (AST.Expr__Raw.Var_q |e#0@@5|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q |e#0@@5|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q |e#0@@5|) (let ((|body#0@@0| (AST.Expr__Raw.body |e#0@@5|)))
...
)) (AST.Expr__Raw.All $ly@@3 |body#0@@0| |p#0|)))) (ite (AST.Expr__Raw.Assign_q |e#0@@5|) (let ((|avals#0@@1| (AST.Expr__Raw.avals |e#0@@5|)))
...
(let ((|cond#0@@0| (AST.Expr__Raw.cond |e#0@@5|)))
 (and (and (AST.Expr__Raw.All $ly@@3 |cond#0@@0| |p#0|) (AST.Expr__Raw.All $ly@@3 |thn#0@@0| |p#0|)) (AST.Expr__Raw.All $ly@@3 |els#0@@0| |p#0|))))) (ite (AST.Expr__Raw.Op_q |e#0@@5|) (let ((|oe2#0| (AST.Expr__Raw.oe2 |e#0@@5|)))
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@5|)))
 (and (AST.Expr__Raw.All $ly@@3 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@3 |oe2#0| |p#0|)))) (let ((|es#0@@6| (AST.Expr__Raw.es |e#0@@5|)))
 (and true (forall ((|e#3| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#3| Tclass.AST.Expr__Raw) (|Seq#Contains| |es#0@@6| ($Box DatatypeTypeType |e#3|))) (AST.Expr__Raw.All $ly@@3 |e#3| |p#0|))
 :qid |ASTdfy.60:21|
 :skolemid |1145|
 ...
 :qid |ASTdfy.44:22|
 :skolemid |1150|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@3) |e#0@@5| |p#0|) ($IsGoodHeap $Heap@@1))
)))
...
(assert (forall (($ly@@4 T@U) (|es#0@@7| T@U) (|ctx#0@@1| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@7| |ctx#0@@1|) (and ($Is SeqType |es#0@@7| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@1| (TMap (TSeq TChar) TInt)))) (and (=> (Utils.Result.Success_q (Interp.__default.InterpExprs $ly@@4 |es#0@@7| |ctx#0@@1|)) (= (|Seq#Length| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs $ly@@4 |es#0@@7| |ctx#0@@1|)))))) (|Seq#Length| |es#0@@7|))) ($Is DatatypeTypeType (Interp.__default.InterpExprs $ly@@4 |es#0@@7| |ctx#0@@1|) (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))
 :qid |Interpdfy.69:12|
 :skolemid |1205|
 :pattern ( (Interp.__default.InterpExprs $ly@@4 |es#0@@7| |ctx#0@@1|))
)))
(assert (forall (($ly@@5 T@U) (|e#0@@6| T@U) (|locals#0@@1| T@U) ) (! (= (Pure.__default.IsPure ($LS $ly@@5) |e#0@@6| |locals#0@@1|) (Pure.__default.IsPure $ly@@5 |e#0@@6| |locals#0@@1|))
 :qid |Puredfy.15:13|
 :skolemid |638|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@5) |e#0@@6| |locals#0@@1|))
)))
(assert (forall (($ly@@6 T@U) (|es#0@@8| T@U) (|locals#0@@2| T@U) ) (! (= (Pure.__default.IsPure__Es ($LS $ly@@6) |es#0@@8| |locals#0@@2|) (Pure.__default.IsPure__Es $ly@@6 |es#0@@8| |locals#0@@2|))
 :qid |Puredfy.39:13|
 :skolemid |667|
 :pattern ( (Pure.__default.IsPure__Es ($LS $ly@@6) |es#0@@8| |locals#0@@2|))
)))
(assert (forall (($ly@@7 T@U) (|e#0@@7| T@U) (|p#0@@0| T@U) ) (! (= (AST.Expr__Raw.All ($LS $ly@@7) |e#0@@7| |p#0@@0|) (AST.Expr__Raw.All $ly@@7 |e#0@@7| |p#0@@0|))
 :qid |ASTdfy.44:22|
 :skolemid |1139|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@7) |e#0@@7| |p#0@@0|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|e#0@@8| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| |st#0@@8| (Lit DatatypeTypeType |e#0@@8|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@8| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@8|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@8|) (Pure.MState.ctx |st#0@@8|))) (|Pure.__default.Pre#canCall| |st#0@@8| (Lit DatatypeTypeType |e#0@@8|))) (= (Pure.__default.P__Fail |st#0@@8| (Lit DatatypeTypeType |e#0@@8|)) (let ((|res#1@@1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@8|) (Pure.MState.ctx |st#0@@8|))))
 (=> (Pure.__default.Pre |st#0@@8| (Lit DatatypeTypeType |e#0@@8|)) (Utils.Result.Failure_q |res#1@@1|))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |723|
 :pattern ( (Pure.__default.P__Fail |st#0@@8| (Lit DatatypeTypeType |e#0@@8|)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@8 T@U) (|e#0@@9| T@U) (|locals#0@@3| T@U) ) (!  (=> (or (|Pure.__default.IsPure#canCall| (Lit DatatypeTypeType |e#0@@9|) (Lit SetType |locals#0@@3|)) (and (< 0 $FunctionContextHeight) (and ($Is DatatypeTypeType |e#0@@9| Tclass.AST.Expr) ($Is SetType |locals#0@@3| (TSet (TSeq TChar)))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@9|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@9|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@9|))))) (let ((|body#5| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@9|)))))
...
(let ((|bvars#5| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@9|)))))
 (and (|Pure.__default.IsPure__Es#canCall| |bvals#5| (Lit SetType |locals#0@@3|)) (=> (Pure.__default.IsPure__Es ($LS $ly@@8) |bvals#5| (Lit SetType |locals#0@@3|)) (|Pure.__default.IsPure#canCall| |body#5| (|Set#Union| (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |bvars#5|)) |locals#0@@3|)))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@9|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@9|))))) (let ((|avals#5| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@9|)))))
...
)) (|Pure.__default.IsPure__Es#canCall| |avals#5| (Lit SetType |locals#0@@3|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@9|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@9|))))) (let ((|els#5| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@9|)))))
...
(let ((|cond#5| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@9|)))))
 (and (|Pure.__default.IsPure#canCall| |cond#5| (Lit SetType |locals#0@@3|)) (=> (Pure.__default.IsPure ($LS $ly@@8) |cond#5| (Lit SetType |locals#0@@3|)) (and (|Pure.__default.IsPure#canCall| |thn#5| (Lit SetType |locals#0@@3|)) (=> (Pure.__default.IsPure ($LS $ly@@8) |thn#5| (Lit SetType |locals#0@@3|)) (|Pure.__default.IsPure#canCall| |els#5| (Lit SetType |locals#0@@3|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@9|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@9|))))) (let ((|oe2#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@9|)))))
(let ((|oe1#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@9|)))))
 (and (|Pure.__default.IsPure#canCall| |oe1#5| (Lit SetType |locals#0@@3|)) (=> (Pure.__default.IsPure ($LS $ly@@8) |oe1#5| (Lit SetType |locals#0@@3|)) (|Pure.__default.IsPure#canCall| |oe2#5| (Lit SetType |locals#0@@3|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@9|)))))) (let ((|es#5| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@9|)))))
(|Pure.__default.IsPure__Es#canCall| |es#5| (Lit SetType |locals#0@@3|))))))))))))) (= (Pure.__default.IsPure ($LS $ly@@8) (Lit DatatypeTypeType |e#0@@9|) (Lit SetType |locals#0@@3|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@9|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@9|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@9|)) (let ((|body#4| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@9|)))))
...
(let ((|bvars#4| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@9|)))))
 (and (Pure.__default.IsPure__Es ($LS $ly@@8) |bvals#4| (Lit SetType |locals#0@@3|)) (Pure.__default.IsPure ($LS $ly@@8) |body#4| (|Set#Union| (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |bvars#4|)) |locals#0@@3|)))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@9|)) (let ((|avals#4| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@9|)))))
...
)) (Pure.__default.IsPure__Es ($LS $ly@@8) |avals#4| (Lit SetType |locals#0@@3|))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@9|)) (U_2_bool (let ((|els#4| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@9|)))))
...
(Lit boolType (bool_2_U  (and (and (Pure.__default.IsPure ($LS $ly@@8) |cond#4| (Lit SetType |locals#0@@3|)) (Pure.__default.IsPure ($LS $ly@@8) |thn#4| (Lit SetType |locals#0@@3|))) (Pure.__default.IsPure ($LS $ly@@8) |els#4| (Lit SetType |locals#0@@3|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@9|)) (U_2_bool (let ((|oe2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@9|)))))
(let ((|oe1#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@9|)))))
(Lit boolType (bool_2_U  (and (Pure.__default.IsPure ($LS $ly@@8) |oe1#4| (Lit SetType |locals#0@@3|)) (Pure.__default.IsPure ($LS $ly@@8) |oe2#4| (Lit SetType |locals#0@@3|)))))))) (U_2_bool (let ((|es#4| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@9|)))))
(Lit boolType (bool_2_U (Pure.__default.IsPure__Es ($LS $ly@@8) |es#4| (Lit SetType |locals#0@@3|)))))))))))))))
 :qid |Puredfy.15:13|
 :weight 3
 :skolemid |651|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@8) (Lit DatatypeTypeType |e#0@@9|) (Lit SetType |locals#0@@3|)))
))))
(assert (forall ((|e#0@@10| T@U) ) (!  (=> (or (|AST.Expr__Raw.WellFormed__Single#canCall| (Lit DatatypeTypeType |e#0@@10|)) ($Is DatatypeTypeType |e#0@@10| Tclass.AST.Expr__Raw)) (= (AST.Expr__Raw.WellFormed__Single (Lit DatatypeTypeType |e#0@@10|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@10|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@10|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@10|)) (let ((|bvals#2@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|bvars#2@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@10|)))))
(= (|Seq#Length| |bvars#2@@0|) (|Seq#Length| |bvals#2@@0|)))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@10|)) (let ((|avals#2@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|avars#2@@0| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@10|)))))
(= (|Seq#Length| |avars#2@@0|) (|Seq#Length| |avals#2@@0|)))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@10|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@10|)) (U_2_bool (Lit boolType (bool_2_U true))) (U_2_bool (Lit boolType (bool_2_U true)))))))))))
 :qid |ASTdfy.71:46|
 :weight 3
 :skolemid |1181|
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@9| T@U) (|es#0@@9| T@U) (|st'#0@@0| T@U) (|vs#0@@1| T@U) ) (!  (=> (or (|Pure.__default.Pes__Succ#canCall| (Lit DatatypeTypeType |st#0@@9|) (Lit SeqType |es#0@@9|) (Lit DatatypeTypeType |st'#0@@0|) (Lit SeqType |vs#0@@1|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@9| Tclass.Pure.MState) ($Is SeqType |es#0@@9| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@0| Tclass.Pure.MState)) ($Is SeqType |vs#0@@1| (TSeq TInt))))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@9|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@9|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@9|))))) (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@9|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@9|)))))))
 (and (|Pure.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@9|) (Lit SeqType |es#0@@9|)) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@9|) (Lit SeqType |es#0@@9|))))) (and (|Pure.__default.ResultSameState#canCall| (TSeq TInt) (Lit DatatypeTypeType |st#0@@9|) |res#2@@1|) (=> (Pure.__default.ResultSameState (TSeq TInt) (Lit DatatypeTypeType |st#0@@9|) |res#2@@1|) (and (and (|$IsA#Utils.Result| |res#2@@1|) (Pure.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|))) (=> (|Utils.Result#Equal| |res#2@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |vs#0@@1|)) ($Box MapType (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st'#0@@0|))))))))) (and (Pure.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|)) (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@9|))))))))))) (= (Pure.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@9|) (Lit SeqType |es#0@@9|) (Lit DatatypeTypeType |st'#0@@0|) (Lit SeqType |vs#0@@1|)) (let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@9|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@9|)))))))
 (and (and (and (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@9|) (Lit SeqType |es#0@@9|)) (Pure.__default.ResultSameState (TSeq TInt) (Lit DatatypeTypeType |st#0@@9|) |res#2@@2|)) (|Utils.Result#Equal| |res#2@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |vs#0@@1|)) ($Box MapType (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st'#0@@0|)))))))))) (|Set#Equal| (Pure.MState.locals (Lit DatatypeTypeType |st'#0@@0|)) (Pure.MState.locals (Lit DatatypeTypeType |st#0@@9|))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |739|
 :pattern ( (Pure.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@9|) (Lit SeqType |es#0@@9|) (Lit DatatypeTypeType |st'#0@@0|) (Lit SeqType |vs#0@@1|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@10| T@U) (|es#0@@10| T@U) ) (!  (=> (or (|Pure.__default.Pes__Fail#canCall| |st#0@@10| (Lit SeqType |es#0@@10|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@10| Tclass.Pure.MState) ($Is SeqType |es#0@@10| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@10|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@10|) (Pure.MState.ctx |st#0@@10|))) (|Pure.__default.PreEs#canCall| |st#0@@10| (Lit SeqType |es#0@@10|))) (= (Pure.__default.Pes__Fail |st#0@@10| (Lit SeqType |es#0@@10|)) (let ((|res#1@@2| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@10|) (Pure.MState.ctx |st#0@@10|))))
 (=> (Pure.__default.PreEs |st#0@@10| (Lit SeqType |es#0@@10|)) (Utils.Result.Failure_q |res#1@@2|))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |746|
 :pattern ( (Pure.__default.Pes__Fail |st#0@@10| (Lit SeqType |es#0@@10|)))
))))
(assert (forall (($ly@@9 T@U) (|e#0@@11| T@U) (|ctx#0@@2| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@11| |ctx#0@@2|) (and ($Is DatatypeTypeType |e#0@@11| Tclass.AST.Expr) ($Is MapType |ctx#0@@2| (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType (Interp.__default.InterpExpr $ly@@9 |e#0@@11| |ctx#0@@2|) (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))))
 :qid |Interpdfy.24:12|
 :skolemid |1198|
 :pattern ( (Interp.__default.InterpExpr $ly@@9 |e#0@@11| |ctx#0@@2|))
)))
(assert (forall (($ly@@10 T@U) (|e#0@@12| T@U) (|ctx#0@@3| T@U) ) (! (= (Interp.__default.InterpExpr ($LS $ly@@10) |e#0@@12| |ctx#0@@3|) (Interp.__default.InterpExpr $ly@@10 |e#0@@12| |ctx#0@@3|))
 :qid |Interpdfy.24:12|
 :skolemid |1196|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@10) |e#0@@12| |ctx#0@@3|))
)))
(assert (forall (($ly@@11 T@U) (|es#0@@11| T@U) (|ctx#0@@4| T@U) ) (! (= (Interp.__default.InterpExprs ($LS $ly@@11) |es#0@@11| |ctx#0@@4|) (Interp.__default.InterpExprs $ly@@11 |es#0@@11| |ctx#0@@4|))
 :qid |Interpdfy.69:12|
 :skolemid |1203|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@11) |es#0@@11| |ctx#0@@4|))
)))
(assert (forall (($ly@@12 T@U) (|vars#0@@1| T@U) (|values#0| T@U) ) (! (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@12) |vars#0@@1| |values#0|) (Interp.__default.VarsAndValuesToContext $ly@@12 |vars#0@@1| |values#0|))
 :qid |Interpdfy.80:12|
 :skolemid |1210|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@12) |vars#0@@1| |values#0|))
)))
(assert (forall (($ly@@13 T@U) (|vars#0@@2| T@U) (|values#0@@0| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@2| |values#0@@0|) (and (and ($Is SeqType |vars#0@@2| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@0| (TSeq TInt))) (= (|Seq#Length| |vars#0@@2|) (|Seq#Length| |values#0@@0|)))) (and (|Set#Equal| (|Map#Domain| (Interp.__default.VarsAndValuesToContext $ly@@13 |vars#0@@2| |values#0@@0|)) (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |vars#0@@2|))) ($Is MapType (Interp.__default.VarsAndValuesToContext $ly@@13 |vars#0@@2| |values#0@@0|) (TMap (TSeq TChar) TInt))))
 :qid |Interpdfy.80:12|
 :skolemid |1212|
 :pattern ( (Interp.__default.VarsAndValuesToContext $ly@@13 |vars#0@@2| |values#0@@0|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@11| T@U) (|e#0@@13| T@U) ) (!  (=> (or (|Pure.__default.Pre#canCall| |st#0@@11| |e#0@@13|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@11| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@13| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@11|) (|Pure.__default.IsPure#canCall| |e#0@@13| (Pure.MState.locals |st#0@@11|))) (=> (Pure.__default.IsPure ($LS $LZ) |e#0@@13| (Pure.MState.locals |st#0@@11|)) (and (Pure.MState.MState_q |st#0@@11|) (Pure.MState.MState_q |st#0@@11|)))) (= (Pure.__default.Pre |st#0@@11| |e#0@@13|)  (and (Pure.__default.IsPure ($LS $LZ) |e#0@@13| (Pure.MState.locals |st#0@@11|)) (|Set#Subset| (Pure.MState.locals |st#0@@11|) (|Map#Domain| (Pure.MState.ctx |st#0@@11|)))))))
 :qid |Puredfy.85:23|
 :skolemid |696|
 :pattern ( (Pure.__default.Pre |st#0@@11| |e#0@@13|))
))))
...
(assert (forall (($ly@@14 T@U) (|es#0@@12| T@U) (|ctx#0@@5| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@12| |ctx#0@@5|) (and ($Is SeqType |es#0@@12| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@5| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@12| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@12| (LitInt 0))) |ctx#0@@5|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@14 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@12| (LitInt 0))) |ctx#0@@5|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (|Seq#Drop| |es#0@@12| (LitInt 1)) |ctx1#0@@0|) (let ((|valueOrError1#0@@0| (Interp.__default.InterpExprs $ly@@14 (|Seq#Drop| |es#0@@12| (LitInt 1)) |ctx1#0@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@14) |es#0@@12| |ctx#0@@5|) (ite (|Seq#Equal| |es#0@@12| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@5|)))) (let ((|valueOrError0#0@@1| (Interp.__default.InterpExpr $ly@@14 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@12| (LitInt 0))) |ctx#0@@5|)))
...
(let ((|valueOrError1#0@@1| (Interp.__default.InterpExprs $ly@@14 (|Seq#Drop| |es#0@@12| (LitInt 1)) |ctx1#0@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0|))) |vs#0@@2|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1207|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@14) |es#0@@12| |ctx#0@@5|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((Pure._default.ResultSameState$V@@0 T@U) (|st#0@@12| T@U) (|res#0@@2| T@U) ) (!  (=> (or (|Pure.__default.ResultSameState#canCall| Pure._default.ResultSameState$V@@0 |st#0@@12| |res#0@@2|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@12| Tclass.Pure.MState) ($Is DatatypeTypeType |res#0@@2| (Tclass.Utils.Result (Tclass._System.Tuple2 Pure._default.ResultSameState$V@@0 (TMap (TSeq TChar) TInt))))))) (and (and (and (Pure.MState.MState_q |st#0@@12|) (Pure.MState.MState_q |st#0@@12|)) (|Pure.__default.ResultSameCtx#canCall| Pure._default.ResultSameState$V@@0 (Pure.MState.locals |st#0@@12|) (Pure.MState.ctx |st#0@@12|) |res#0@@2|)) (= (Pure.__default.ResultSameState Pure._default.ResultSameState$V@@0 |st#0@@12| |res#0@@2|) (Pure.__default.ResultSameCtx Pure._default.ResultSameState$V@@0 (Pure.MState.locals |st#0@@12|) (Pure.MState.ctx |st#0@@12|) |res#0@@2|))))
 :qid |unknown.0:0|
 :skolemid |690|
 :pattern ( (Pure.__default.ResultSameState Pure._default.ResultSameState$V@@0 |st#0@@12| |res#0@@2|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@13| T@U) (|es#0@@13| T@U) ) (!  (=> (or (|Pure.__default.PreEs#canCall| |st#0@@13| |es#0@@13|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@13| Tclass.Pure.MState) ($Is SeqType |es#0@@13| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@13|) (|Pure.__default.IsPure__Es#canCall| |es#0@@13| (Pure.MState.locals |st#0@@13|))) (=> (Pure.__default.IsPure__Es ($LS $LZ) |es#0@@13| (Pure.MState.locals |st#0@@13|)) (and (Pure.MState.MState_q |st#0@@13|) (Pure.MState.MState_q |st#0@@13|)))) (= (Pure.__default.PreEs |st#0@@13| |es#0@@13|)  (and (Pure.__default.IsPure__Es ($LS $LZ) |es#0@@13| (Pure.MState.locals |st#0@@13|)) (|Set#Subset| (Pure.MState.locals |st#0@@13|) (|Map#Domain| (Pure.MState.ctx |st#0@@13|)))))))
 :qid |Puredfy.91:25|
 :skolemid |701|
 :pattern ( (Pure.__default.PreEs |st#0@@13| |es#0@@13|))
))))
...
(assert (forall (($ly@@15 T@U) (|es#0@@14| T@U) (|ctx#0@@6| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@14|) |ctx#0@@6|) (and ($Is SeqType |es#0@@14| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@6| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@14| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@14|) (LitInt 0))) |ctx#0@@6|) (let ((|valueOrError0#1@@0| (Interp.__default.InterpExpr ($LS $ly@@15) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@14|) (LitInt 0))) |ctx#0@@6|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@14|) (LitInt 1))) |ctx1#1@@0|) (let ((|valueOrError1#1@@0| (Interp.__default.InterpExprs ($LS $ly@@15) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@14|) (LitInt 1))) |ctx1#1@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@15) (Lit SeqType |es#0@@14|) |ctx#0@@6|) (ite (|Seq#Equal| |es#0@@14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@6|)))) (let ((|valueOrError0#1@@1| (Interp.__default.InterpExpr ($LS $ly@@15) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@14|) (LitInt 0))) |ctx#0@@6|)))
...
(let ((|valueOrError1#1@@1| (Interp.__default.InterpExprs ($LS $ly@@15) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@14|) (LitInt 1))) |ctx1#1@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#1|))) |vs#1@@0|)) ($Box MapType |ctx2#1@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |1208|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@15) (Lit SeqType |es#0@@14|) |ctx#0@@6|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@14| T@U) (|vars#0@@3| T@U) (|vals#0@@0| T@U) ) (!  (=> (or (|Pure.__default.BindStartScope#canCall| |st#0@@14| (Lit SeqType |vars#0@@3|) |vals#0@@0|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@14| Tclass.Pure.MState) ($Is SeqType |vars#0@@3| (TSeq (TSeq TChar)))) ($Is SeqType |vals#0@@0| (TSeq TInt))) (Pure.__default.UpdateState__Pre |st#0@@14| (Lit SeqType |vars#0@@3|) |vals#0@@0|)))) (and (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@3|) |vals#0@@0|) (= (Pure.__default.BindStartScope |st#0@@14| (Lit SeqType |vars#0@@3|) |vals#0@@0|) (let ((|ctx#1| (Pure.MState.ctx |st#0@@14|)))
(let ((|locals#1| (Pure.MState.locals |st#0@@14|)))
(let ((|locals'#1| (|Set#Union| (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |vars#0@@3|)) |locals#1|)))
(let ((|bindings#1@@0| (Interp.__default.VarsAndValuesToContext ($LS $LZ) (Lit SeqType |vars#0@@3|) |vals#0@@0|)))
(let ((|ctx1#1@@2| (|Map#Merge| |ctx#1| |bindings#1@@0|)))
(let ((|st'#1| (|#Pure.MState.MState| |locals'#1| |ctx1#1@@2|)))
|st'#1|)))))))))
 :qid |Inductiondfy.58:33|
 :weight 3
 :skolemid |774|
 :pattern ( (Pure.__default.BindStartScope |st#0@@14| (Lit SeqType |vars#0@@3|) |vals#0@@0|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@15| T@U) (|e#0@@14| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| |st#0@@15| |e#0@@14|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@15| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@14| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@15|) (|Interp.__default.InterpExpr#canCall| |e#0@@14| (Pure.MState.ctx |st#0@@15|))) (|Pure.__default.Pre#canCall| |st#0@@15| |e#0@@14|)) (= (Pure.__default.P__Fail |st#0@@15| |e#0@@14|) (let ((|res#0@@3| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@14| (Pure.MState.ctx |st#0@@15|))))
 (=> (Pure.__default.Pre |st#0@@15| |e#0@@14|) (Utils.Result.Failure_q |res#0@@3|))))))
 :qid |Inductiondfy.36:26|
 :skolemid |722|
 :pattern ( (Pure.__default.P__Fail |st#0@@15| |e#0@@14|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@16| T@U) (|vars#0@@4| T@U) (|vals#0@@1| T@U) ) (!  (=> (or (|Pure.__default.BindStartScope#canCall| |st#0@@16| |vars#0@@4| |vals#0@@1|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@16| Tclass.Pure.MState) ($Is SeqType |vars#0@@4| (TSeq (TSeq TChar)))) ($Is SeqType |vals#0@@1| (TSeq TInt))) (Pure.__default.UpdateState__Pre |st#0@@16| |vars#0@@4| |vals#0@@1|)))) ($Is DatatypeTypeType (Pure.__default.BindStartScope |st#0@@16| |vars#0@@4| |vals#0@@1|) Tclass.Pure.MState))
 :qid |Inductiondfy.58:33|
 :skolemid |771|
 :pattern ( (Pure.__default.BindStartScope |st#0@@16| |vars#0@@4| |vals#0@@1|))
))))
...
(assert (forall (($ly@@16 T@U) (|e#0@@16| T@U) (|ctx#0@@8| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@16|) (Lit MapType |ctx#0@@8|)) (and ($Is DatatypeTypeType |e#0@@16| Tclass.AST.Expr) ($Is MapType |ctx#0@@8| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@16|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@16|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@16|))))) (let ((|body#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@16|)))))
...
(let ((|ctx2#10| (|Map#Merge| |ctx1#20| |bindings#10|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|))))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@16|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@16|))))) (let ((|avals#5@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@16|)))))
...
(|Interp.__default.VarsAndValuesToContext#canCall| |avars#5@@0| |vs#16|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@16|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@16|))))) (let ((|els#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@16|)))))
...
(let ((|condv#5| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError3#5|)))))))
 (and (=> (or (not (= |condv#5| 0)) (not true)) (|Interp.__default.InterpExpr#canCall| |thn#5@@0| |ctx_cond#5|)) (=> (= |condv#5| 0) (|Interp.__default.InterpExpr#canCall| |els#5@@0| |ctx_cond#5|)))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@16|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@16|))))) (let ((|e2#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@16|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#5| |v1#5| |v2#5|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@16|)))))) (let ((|es#5@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@16|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#5|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@16) (Lit DatatypeTypeType |e#0@@16|) (Lit MapType |ctx#0@@8|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|name#4| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@16|)))))
...
(Lit DatatypeTypeType (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#4|)) ($Box MapType (Lit MapType |ctx#0@@8|)))))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|body#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@16|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |bodyv#4|)) ($Box MapType |ctx4#4|)))))))))))))))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|avals#4@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@16|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType (|Map#Merge| |ctx1#17| |bindings#9|)))))))))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|els#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@16|)))))
...
(ite  (or (not (= |condv#4| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@16) |thn#4@@0| |ctx_cond#4|) (Interp.__default.InterpExpr ($LS $ly@@16) |els#4@@0| |ctx_cond#4|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|e2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@16|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#4| |v1#4| |v2#4|))) ($Box MapType |ctx2#9|))))))))))))))) (let ((|es#4@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@16|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1202|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@16) (Lit DatatypeTypeType |e#0@@16|) (Lit MapType |ctx#0@@8|)))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@17| T@U) (|es#0@@15| T@U) ) (!  (=> (or (|Pure.__default.Pes#canCall| |st#0@@17| |es#0@@15|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@17| Tclass.Pure.MState) ($Is SeqType |es#0@@15| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@17|) (|Interp.__default.InterpExprs#canCall| |es#0@@15| (Pure.MState.ctx |st#0@@17|))) (let ((|res#0@@5| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@15| (Pure.MState.ctx |st#0@@17|))))
 (and (|Pure.__default.PreEs#canCall| |st#0@@17| |es#0@@15|) (=> (Pure.__default.PreEs |st#0@@17| |es#0@@15|) (|Pure.__default.ResultSameState#canCall| (TSeq TInt) |st#0@@17| |res#0@@5|))))) (= (Pure.__default.Pes |st#0@@17| |es#0@@15|) (let ((|res#0@@6| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@15| (Pure.MState.ctx |st#0@@17|))))
 (=> (Pure.__default.PreEs |st#0@@17| |es#0@@15|) (Pure.__default.ResultSameState (TSeq TInt) |st#0@@17| |res#0@@6|))))))
 :qid |Inductiondfy.39:23|
 :skolemid |729|
 :pattern ( (Pure.__default.Pes |st#0@@17| |es#0@@15|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@18| T@U) (|vars#0@@5| T@U) (|vals#0@@2| T@U) ) (!  (=> (or (|Pure.__default.BindStartScope#canCall| |st#0@@18| |vars#0@@5| |vals#0@@2|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@18| Tclass.Pure.MState) ($Is SeqType |vars#0@@5| (TSeq (TSeq TChar)))) ($Is SeqType |vals#0@@2| (TSeq TInt))) (Pure.__default.UpdateState__Pre |st#0@@18| |vars#0@@5| |vals#0@@2|)))) (and (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@5| |vals#0@@2|) (= (Pure.__default.BindStartScope |st#0@@18| |vars#0@@5| |vals#0@@2|) (let ((|ctx#0@@9| (Pure.MState.ctx |st#0@@18|)))
(let ((|locals#0@@5| (Pure.MState.locals |st#0@@18|)))
(let ((|locals'#0| (|Set#Union| (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |vars#0@@5|)) |locals#0@@5|)))
(let ((|bindings#0@@0| (Interp.__default.VarsAndValuesToContext ($LS $LZ) |vars#0@@5| |vals#0@@2|)))
(let ((|ctx1#0@@2| (|Map#Merge| |ctx#0@@9| |bindings#0@@0|)))
(let ((|st'#0@@1| (|#Pure.MState.MState| |locals'#0| |ctx1#0@@2|)))
|st'#0@@1|)))))))))
 :qid |Inductiondfy.58:33|
 :skolemid |773|
 :pattern ( (Pure.__default.BindStartScope |st#0@@18| |vars#0@@5| |vals#0@@2|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@17 T@U) (|es#0@@16| T@U) (|locals#0@@6| T@U) ) (!  (=> (or (|Pure.__default.IsPure__Es#canCall| |es#0@@16| |locals#0@@6|) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |es#0@@16| (TSeq Tclass.AST.Expr)) ($Is SetType |locals#0@@6| (TSet (TSeq TChar)))))) (and (=> (not (|Seq#Equal| |es#0@@16| |Seq#Empty|)) (and (|Pure.__default.IsPure#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@16| (LitInt 0))) |locals#0@@6|) (=> (Pure.__default.IsPure $ly@@17 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@16| (LitInt 0))) |locals#0@@6|) (|Pure.__default.IsPure__Es#canCall| (|Seq#Drop| |es#0@@16| (LitInt 1)) |locals#0@@6|)))) (= (Pure.__default.IsPure__Es ($LS $ly@@17) |es#0@@16| |locals#0@@6|) (ite (|Seq#Equal| |es#0@@16| |Seq#Empty|) true  (and (Pure.__default.IsPure $ly@@17 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@16| (LitInt 0))) |locals#0@@6|) (Pure.__default.IsPure__Es $ly@@17 (|Seq#Drop| |es#0@@16| (LitInt 1)) |locals#0@@6|))))))
 :qid |Puredfy.39:13|
 :skolemid |671|
 :pattern ( (Pure.__default.IsPure__Es ($LS $ly@@17) |es#0@@16| |locals#0@@6|))
))))
(assert (forall (($ly@@18 T@U) (|vars#0@@6| T@U) (|values#0@@1| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@6| |values#0@@1|) (and (and ($Is SeqType |vars#0@@6| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@1| (TSeq TInt))) (= (|Seq#Length| |vars#0@@6|) (|Seq#Length| |values#0@@1|)))) (and (=> (not (|Seq#Equal| |vars#0@@6| |Seq#Empty|)) (|Interp.__default.VarsAndValuesToContext#canCall| (|Seq#Drop| |vars#0@@6| (LitInt 1)) (|Seq#Drop| |values#0@@1| (LitInt 1)))) (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@18) |vars#0@@6| |values#0@@1|) (ite (|Seq#Equal| |vars#0@@6| |Seq#Empty|) |Map#Empty| (|Map#Merge| (|Map#Build| |Map#Empty| (|Seq#Index| |vars#0@@6| (LitInt 0)) (|Seq#Index| |values#0@@1| (LitInt 0))) (Interp.__default.VarsAndValuesToContext $ly@@18 (|Seq#Drop| |vars#0@@6| (LitInt 1)) (|Seq#Drop| |values#0@@1| (LitInt 1))))))))
 :qid |Interpdfy.80:12|
 :skolemid |1214|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@18) |vars#0@@6| |values#0@@1|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@19| T@U) (|es#0@@17| T@U) (|st'#0@@2| T@U) (|vs#0@@3| T@U) ) (!  (=> (or (|Pure.__default.Pes__Succ#canCall| |st#0@@19| (Lit SeqType |es#0@@17|) |st'#0@@2| |vs#0@@3|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@19| Tclass.Pure.MState) ($Is SeqType |es#0@@17| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@2| Tclass.Pure.MState)) ($Is SeqType |vs#0@@3| (TSeq TInt))))) (and (and (and (Pure.MState.MState_q |st#0@@19|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@17|) (Pure.MState.ctx |st#0@@19|))) (let ((|res#1@@3| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@17|) (Pure.MState.ctx |st#0@@19|))))
 (and (|Pure.__default.PreEs#canCall| |st#0@@19| (Lit SeqType |es#0@@17|)) (=> (Pure.__default.PreEs |st#0@@19| (Lit SeqType |es#0@@17|)) (and (|Pure.__default.ResultSameState#canCall| (TSeq TInt) |st#0@@19| |res#1@@3|) (=> (Pure.__default.ResultSameState (TSeq TInt) |st#0@@19| |res#1@@3|) (and (and (|$IsA#Utils.Result| |res#1@@3|) (Pure.MState.MState_q |st'#0@@2|)) (=> (|Utils.Result#Equal| |res#1@@3| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@3|) ($Box MapType (Pure.MState.ctx |st'#0@@2|)))))) (and (Pure.MState.MState_q |st'#0@@2|) (Pure.MState.MState_q |st#0@@19|)))))))))) (= (Pure.__default.Pes__Succ |st#0@@19| (Lit SeqType |es#0@@17|) |st'#0@@2| |vs#0@@3|) (let ((|res#1@@4| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@17|) (Pure.MState.ctx |st#0@@19|))))
 (and (and (and (Pure.__default.PreEs |st#0@@19| (Lit SeqType |es#0@@17|)) (Pure.__default.ResultSameState (TSeq TInt) |st#0@@19| |res#1@@4|)) (|Utils.Result#Equal| |res#1@@4| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@3|) ($Box MapType (Pure.MState.ctx |st'#0@@2|))))))) (|Set#Equal| (Pure.MState.locals |st'#0@@2|) (Pure.MState.locals |st#0@@19|)))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |738|
 :pattern ( (Pure.__default.Pes__Succ |st#0@@19| (Lit SeqType |es#0@@17|) |st'#0@@2| |vs#0@@3|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@20| T@U) (|es#0@@18| T@U) ) (!  (=> (or (|Pure.__default.Pes__Fail#canCall| |st#0@@20| |es#0@@18|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@20| Tclass.Pure.MState) ($Is SeqType |es#0@@18| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@20|) (|Interp.__default.InterpExprs#canCall| |es#0@@18| (Pure.MState.ctx |st#0@@20|))) (|Pure.__default.PreEs#canCall| |st#0@@20| |es#0@@18|)) (= (Pure.__default.Pes__Fail |st#0@@20| |es#0@@18|) (let ((|res#0@@7| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@18| (Pure.MState.ctx |st#0@@20|))))
 (=> (Pure.__default.PreEs |st#0@@20| |es#0@@18|) (Utils.Result.Failure_q |res#0@@7|))))))
 :qid |Inductiondfy.41:28|
 :skolemid |745|
 :pattern ( (Pure.__default.Pes__Fail |st#0@@20| |es#0@@18|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@21| T@U) (|vars#0@@7| T@U) (|argvs#0@@0| T@U) ) (!  (=> (or (|Pure.__default.UpdateState__Pre#canCall| |st#0@@21| (Lit SeqType |vars#0@@7|) |argvs#0@@0|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@21| Tclass.Pure.MState) ($Is SeqType |vars#0@@7| (TSeq (TSeq TChar)))) ($Is SeqType |argvs#0@@0| (TSeq TInt))))) (= (Pure.__default.UpdateState__Pre |st#0@@21| (Lit SeqType |vars#0@@7|) |argvs#0@@0|)  (and true (= (|Seq#Length| (Lit SeqType |vars#0@@7|)) (|Seq#Length| |argvs#0@@0|)))))
 :qid |Inductiondfy.51:35|
 :weight 3
 :skolemid |762|
 :pattern ( (Pure.__default.UpdateState__Pre |st#0@@21| (Lit SeqType |vars#0@@7|) |argvs#0@@0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@22| T@U) (|vars#0@@8| T@U) (|argvs#0@@1| T@U) ) (!  (=> (or (|Pure.__default.UpdateState__Pre#canCall| (Lit DatatypeTypeType |st#0@@22|) (Lit SeqType |vars#0@@8|) (Lit SeqType |argvs#0@@1|)) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@22| Tclass.Pure.MState) ($Is SeqType |vars#0@@8| (TSeq (TSeq TChar)))) ($Is SeqType |argvs#0@@1| (TSeq TInt))))) (= (Pure.__default.UpdateState__Pre (Lit DatatypeTypeType |st#0@@22|) (Lit SeqType |vars#0@@8|) (Lit SeqType |argvs#0@@1|))  (and true (= (|Seq#Length| (Lit SeqType |vars#0@@8|)) (|Seq#Length| (Lit SeqType |argvs#0@@1|))))))
 :qid |Inductiondfy.51:35|
 :weight 3
 :skolemid |763|
 :pattern ( (Pure.__default.UpdateState__Pre (Lit DatatypeTypeType |st#0@@22|) (Lit SeqType |vars#0@@8|) (Lit SeqType |argvs#0@@1|)))
))))
...
(|Interp.__default.VarsAndValuesToContext#canCall| |avars#3@@0| |vs#10|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@17|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@17|))))) (let ((|els#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|thn#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|cond#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@17|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#3| |v1#3| |v2#3|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@17|)))))) (let ((|es#3@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@17|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#3|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@19) (Lit DatatypeTypeType |e#0@@17|) |ctx#0@@10|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|name#2| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@17|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#2|)) ($Box MapType |ctx#0@@10|))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|body#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|bvals#2@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|bvars#2@@1| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@17|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |bodyv#2|)) ($Box MapType |ctx4#2|)))))))))))))))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|avals#2@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|avars#2@@1| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@17|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType (|Map#Merge| |ctx1#9| |bindings#5|)))))))))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|els#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|thn#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|cond#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@17|)))))
...
(ite  (or (not (= |condv#2| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@19) |thn#2@@0| |ctx_cond#2|) (Interp.__default.InterpExpr ($LS $ly@@19) |els#2@@0| |ctx_cond#2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|e2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@17|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#2| |v1#2| |v2#2|))) ($Box MapType |ctx2#5|))))))))))))))) (let ((|es#2@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@17|)))))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1201|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@19) (Lit DatatypeTypeType |e#0@@17|) |ctx#0@@10|))
)))
...
(assert (forall (($ly@@20 T@U) (|vars#0@@9| T@U) (|values#0@@2| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@9|) (Lit SeqType |values#0@@2|)) (and (and ($Is SeqType |vars#0@@9| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@2| (TSeq TInt))) (= (|Seq#Length| (Lit SeqType |vars#0@@9|)) (|Seq#Length| (Lit SeqType |values#0@@2|))))) (and (=> (not (|Seq#Equal| |vars#0@@9| |Seq#Empty|)) (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |vars#0@@9|) (LitInt 1))) (Lit SeqType (|Seq#Drop| (Lit SeqType |values#0@@2|) (LitInt 1))))) (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@20) (Lit SeqType |vars#0@@9|) (Lit SeqType |values#0@@2|)) (ite (|Seq#Equal| |vars#0@@9| |Seq#Empty|) |Map#Empty| (|Map#Merge| (|Map#Build| |Map#Empty| (|Seq#Index| (Lit SeqType |vars#0@@9|) (LitInt 0)) (|Seq#Index| (Lit SeqType |values#0@@2|) (LitInt 0))) (Interp.__default.VarsAndValuesToContext ($LS $ly@@20) (Lit SeqType (|Seq#Drop| (Lit SeqType |vars#0@@9|) (LitInt 1))) (Lit SeqType (|Seq#Drop| (Lit SeqType |values#0@@2|) (LitInt 1)))))))))
 :qid |Interpdfy.80:12|
 :weight 3
 :skolemid |1215|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@20) (Lit SeqType |vars#0@@9|) (Lit SeqType |values#0@@2|)))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@21 T@U) (|es#0@@19| T@U) (|locals#0@@7| T@U) ) (!  (=> (or (|Pure.__default.IsPure__Es#canCall| (Lit SeqType |es#0@@19|) |locals#0@@7|) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |es#0@@19| (TSeq Tclass.AST.Expr)) ($Is SetType |locals#0@@7| (TSet (TSeq TChar)))))) (and (=> (not (|Seq#Equal| |es#0@@19| |Seq#Empty|)) (and (|Pure.__default.IsPure#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@19|) (LitInt 0))) |locals#0@@7|) (=> (Pure.__default.IsPure ($LS $ly@@21) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@19|) (LitInt 0))) |locals#0@@7|) (|Pure.__default.IsPure__Es#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@19|) (LitInt 1))) |locals#0@@7|)))) (= (Pure.__default.IsPure__Es ($LS $ly@@21) (Lit SeqType |es#0@@19|) |locals#0@@7|) (ite (|Seq#Equal| |es#0@@19| |Seq#Empty|) true  (and (Pure.__default.IsPure ($LS $ly@@21) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@19|) (LitInt 0))) |locals#0@@7|) (Pure.__default.IsPure__Es ($LS $ly@@21) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@19|) (LitInt 1))) |locals#0@@7|))))))
 :qid |Puredfy.39:13|
 :weight 3
 :skolemid |672|
 :pattern ( (Pure.__default.IsPure__Es ($LS $ly@@21) (Lit SeqType |es#0@@19|) |locals#0@@7|))
))))
...
(assert (forall (($ly@@22 T@U) ($Heap@@2 T@U) (|e#0@@18| T@U) (|p#0@@1| T@U) ) (!  (=> (or (|AST.Expr__Raw.All#canCall| (Lit DatatypeTypeType |e#0@@18|) |p#0@@1|) (and (and ($IsGoodHeap $Heap@@2) ($Is DatatypeTypeType |e#0@@18| Tclass.AST.Expr__Raw)) ($Is HandleTypeType |p#0@@1| (Tclass._System.___hTotalFunc1 Tclass.AST.Expr__Raw TBool)))) (and (=> (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@2 |p#0@@1| ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@18|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@18|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@18|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@18|))))) (let ((|body#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|bvals#3@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@18|)))))
...
)) (|AST.Expr__Raw.All#canCall| |body#3@@1| |p#0@@1|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@18|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@18|))))) (let ((|avals#3@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@18|)))))
...
))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@18|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@18|))))) (let ((|els#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|thn#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|cond#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@18|)))))
 (and (|AST.Expr__Raw.All#canCall| |cond#3@@1| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@22) |cond#3@@1| |p#0@@1|) (and (|AST.Expr__Raw.All#canCall| |thn#3@@1| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@22) |thn#3@@1| |p#0@@1|) (|AST.Expr__Raw.All#canCall| |els#3@@1| |p#0@@1|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@18|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@18|))))) (let ((|oe2#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|oe1#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@18|)))))
 (and (|AST.Expr__Raw.All#canCall| |oe1#3@@0| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@22) |oe1#3@@0| |p#0@@1|) (|AST.Expr__Raw.All#canCall| |oe2#3@@0| |p#0@@1|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@18|)))))) (let ((|es#3@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@18|)))))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@22) (Lit DatatypeTypeType |e#0@@18|) |p#0@@1|)  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@2 |p#0@@1| ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@18|))))) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@18|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@18|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@18|)) (let ((|body#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|bvals#2@@2| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@18|)))))
...
)) (AST.Expr__Raw.All ($LS $ly@@22) |body#2@@1| |p#0@@1|)))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@18|)) (let ((|avals#2@@2| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@18|)))))
...
)))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@18|)) (let ((|els#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|thn#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|cond#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@18|)))))
 (and (and (AST.Expr__Raw.All ($LS $ly@@22) |cond#2@@1| |p#0@@1|) (AST.Expr__Raw.All ($LS $ly@@22) |thn#2@@1| |p#0@@1|)) (AST.Expr__Raw.All ($LS $ly@@22) |els#2@@1| |p#0@@1|))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@18|)) (let ((|oe2#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@18|)))))
(let ((|oe1#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@18|)))))
 (and (AST.Expr__Raw.All ($LS $ly@@22) |oe1#2@@0| |p#0@@1|) (AST.Expr__Raw.All ($LS $ly@@22) |oe2#2@@0| |p#0@@1|)))) (let ((|es#2@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@18|)))))
 ...
 :weight 3
 :skolemid |1158|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@22) (Lit DatatypeTypeType |e#0@@18|) |p#0@@1|) ($IsGoodHeap $Heap@@2))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@23| T@U) (|es#0@@20| T@U) ) (!  (=> (or (|Pure.__default.Pes#canCall| (Lit DatatypeTypeType |st#0@@23|) (Lit SeqType |es#0@@20|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@23| Tclass.Pure.MState) ($Is SeqType |es#0@@20| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@23|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@20|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@23|))))) (let ((|res#2@@3| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@20|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@23|)))))))
 (and (|Pure.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@23|) (Lit SeqType |es#0@@20|)) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@23|) (Lit SeqType |es#0@@20|))))) (|Pure.__default.ResultSameState#canCall| (TSeq TInt) (Lit DatatypeTypeType |st#0@@23|) |res#2@@3|))))) (= (Pure.__default.Pes (Lit DatatypeTypeType |st#0@@23|) (Lit SeqType |es#0@@20|)) (U_2_bool (let ((|res#2@@4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@20|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@23|)))))))
(Lit boolType (bool_2_U  (=> (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@23|) (Lit SeqType |es#0@@20|)) (Pure.__default.ResultSameState (TSeq TInt) (Lit DatatypeTypeType |st#0@@23|) |res#2@@4|)))))))))
 :qid |Inductiondfy.39:23|
 :weight 3
 :skolemid |731|
 :pattern ( (Pure.__default.Pes (Lit DatatypeTypeType |st#0@@23|) (Lit SeqType |es#0@@20|)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((Pure._default.ResultSameCtx$V@@0 T@U) (|locals#0@@8| T@U) (|ctx#0@@11| T@U) (|res#0@@8| T@U) ) (!  (=> (or (|Pure.__default.ResultSameCtx#canCall| Pure._default.ResultSameCtx$V@@0 (Lit SetType |locals#0@@8|) (Lit MapType |ctx#0@@11|) (Lit DatatypeTypeType |res#0@@8|)) (and (< 0 $FunctionContextHeight) (and (and ($Is SetType |locals#0@@8| (TSet (TSeq TChar))) ($Is MapType |ctx#0@@11| (TMap (TSeq TChar) TInt))) ($Is DatatypeTypeType |res#0@@8| (Tclass.Utils.Result (Tclass._System.Tuple2 Pure._default.ResultSameCtx$V@@0 (TMap (TSeq TChar) TInt))))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@8|))))) (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@8|)))))) (= (Pure.__default.ResultSameCtx Pure._default.ResultSameCtx$V@@0 (Lit SetType |locals#0@@8|) (Lit MapType |ctx#0@@11|) (Lit DatatypeTypeType |res#0@@8|)) (ite (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@8|)) (let ((|ctx'#2| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@8|)))))))))
 (and (|Set#Equal| (|Map#Domain| |ctx'#2|) (|Map#Domain| (Lit MapType |ctx#0@@11|))) (forall ((|x#2| T@U) ) (!  (=> (and ($Is SeqType |x#2| (TSeq TChar)) (and (|Set#IsMember| (Lit SetType (|Map#Domain| (Lit MapType |ctx#0@@11|))) ($Box SeqType |x#2|)) (not (|Set#IsMember| (Lit SetType |locals#0@@8|) ($Box SeqType |x#2|))))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx'#2|) ($Box SeqType |x#2|)))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType |ctx#0@@11|)) ($Box SeqType |x#2|))))))
 :qid |Puredfy.57:19|
 :skolemid |683|
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@11|) ($Box SeqType |x#2|))))
 ...
 :pattern ( (|Set#IsMember| (|Map#Domain| |ctx#0@@11|) ($Box SeqType |x#2|)))
)))) true))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |684|
 :pattern ( (Pure.__default.ResultSameCtx Pure._default.ResultSameCtx$V@@0 (Lit SetType |locals#0@@8|) (Lit MapType |ctx#0@@11|) (Lit DatatypeTypeType |res#0@@8|)))
))))
...
(let ((|cond#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@20|)))))
 (and (|AST.Expr__Raw.All#canCall| |cond#5@@1| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@23) |cond#5@@1| (Lit HandleTypeType |p#0@@2|)) (and (|AST.Expr__Raw.All#canCall| |thn#5@@1| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@23) |thn#5@@1| (Lit HandleTypeType |p#0@@2|)) (|AST.Expr__Raw.All#canCall| |els#5@@1| (Lit HandleTypeType |p#0@@2|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@20|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@20|))))) (let ((|oe2#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|oe1#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@20|)))))
 (and (|AST.Expr__Raw.All#canCall| |oe1#5@@0| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@23) |oe1#5@@0| (Lit HandleTypeType |p#0@@2|)) (|AST.Expr__Raw.All#canCall| |oe2#5@@0| (Lit HandleTypeType |p#0@@2|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@20|)))))) (let ((|es#5@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@20|)))))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@23) (Lit DatatypeTypeType |e#0@@20|) (Lit HandleTypeType |p#0@@2|))  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@4 (Lit HandleTypeType |p#0@@2|) ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@20|))))) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@20|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@20|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@20|)) (let ((|body#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@20|)))))
...
)) (AST.Expr__Raw.All ($LS $ly@@23) |body#4@@1| (Lit HandleTypeType |p#0@@2|))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@20|)) (let ((|avals#4@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@20|)))))
...
(Lit boolType (bool_2_U  (and (and (AST.Expr__Raw.All ($LS $ly@@23) |cond#4@@1| (Lit HandleTypeType |p#0@@2|)) (AST.Expr__Raw.All ($LS $ly@@23) |thn#4@@1| (Lit HandleTypeType |p#0@@2|))) (AST.Expr__Raw.All ($LS $ly@@23) |els#4@@1| (Lit HandleTypeType |p#0@@2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@20|)) (U_2_bool (let ((|oe2#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|oe1#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@20|)))))
(Lit boolType (bool_2_U  (and (AST.Expr__Raw.All ($LS $ly@@23) |oe1#4@@0| (Lit HandleTypeType |p#0@@2|)) (AST.Expr__Raw.All ($LS $ly@@23) |oe2#4@@0| (Lit HandleTypeType |p#0@@2|)))))))) (let ((|es#4@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@20|)))))
 ...
 :weight 3
 :skolemid |1166|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@23) (Lit DatatypeTypeType |e#0@@20|) (Lit HandleTypeType |p#0@@2|)) ($IsGoodHeap $Heap@@4))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@24 T@U) (|e#0@@21| T@U) (|locals#0@@9| T@U) ) (!  (=> (or (|Pure.__default.IsPure#canCall| |e#0@@21| |locals#0@@9|) (and (< 0 $FunctionContextHeight) (and ($Is DatatypeTypeType |e#0@@21| Tclass.AST.Expr) ($Is SetType |locals#0@@9| (TSet (TSeq TChar)))))) (and (=> (not (AST.Expr__Raw.Var_q |e#0@@21|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@21|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@21|) (let ((|body#1@@1| (AST.Expr__Raw.body |e#0@@21|)))
(let ((|bvals#1@@1| (AST.Expr__Raw.bvals |e#0@@21|)))
(let ((|bvars#1@@0| (AST.Expr__Raw.bvars |e#0@@21|)))
 (and (|Pure.__default.IsPure__Es#canCall| |bvals#1@@1| |locals#0@@9|) (=> (Pure.__default.IsPure__Es $ly@@24 |bvals#1@@1| |locals#0@@9|) (|Pure.__default.IsPure#canCall| |body#1@@1| (|Set#Union| (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |bvars#1@@0|)) |locals#0@@9|)))))))) (=> (not (AST.Expr__Raw.Bind_q |e#0@@21|)) (and (=> (AST.Expr__Raw.Assign_q |e#0@@21|) (let ((|avals#1@@1| (AST.Expr__Raw.avals |e#0@@21|)))
(let ((|avars#1@@0| (AST.Expr__Raw.avars |e#0@@21|)))
...
)) (|Pure.__default.IsPure__Es#canCall| |avals#1@@1| |locals#0@@9|))))) (=> (not (AST.Expr__Raw.Assign_q |e#0@@21|)) (and (=> (AST.Expr__Raw.If_q |e#0@@21|) (let ((|els#1@@1| (AST.Expr__Raw.els |e#0@@21|)))
(let ((|thn#1@@1| (AST.Expr__Raw.thn |e#0@@21|)))
(let ((|cond#1@@1| (AST.Expr__Raw.cond |e#0@@21|)))
 (and (|Pure.__default.IsPure#canCall| |cond#1@@1| |locals#0@@9|) (=> (Pure.__default.IsPure $ly@@24 |cond#1@@1| |locals#0@@9|) (and (|Pure.__default.IsPure#canCall| |thn#1@@1| |locals#0@@9|) (=> (Pure.__default.IsPure $ly@@24 |thn#1@@1| |locals#0@@9|) (|Pure.__default.IsPure#canCall| |els#1@@1| |locals#0@@9|))))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@21|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@21|) (let ((|oe2#1@@0| (AST.Expr__Raw.oe2 |e#0@@21|)))
(let ((|oe1#1@@0| (AST.Expr__Raw.oe1 |e#0@@21|)))
 (and (|Pure.__default.IsPure#canCall| |oe1#1@@0| |locals#0@@9|) (=> (Pure.__default.IsPure $ly@@24 |oe1#1@@0| |locals#0@@9|) (|Pure.__default.IsPure#canCall| |oe2#1@@0| |locals#0@@9|)))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@21|)) (let ((|es#1@@1| (AST.Expr__Raw.es |e#0@@21|)))
(|Pure.__default.IsPure__Es#canCall| |es#1@@1| |locals#0@@9|)))))))))))) (= (Pure.__default.IsPure ($LS $ly@@24) |e#0@@21| |locals#0@@9|) (ite (AST.Expr__Raw.Var_q |e#0@@21|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q |e#0@@21|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q |e#0@@21|) (let ((|body#0@@1| (AST.Expr__Raw.body |e#0@@21|)))
(let ((|bvals#0@@2| (AST.Expr__Raw.bvals |e#0@@21|)))
(let ((|bvars#0@@1| (AST.Expr__Raw.bvars |e#0@@21|)))
 (and (Pure.__default.IsPure__Es $ly@@24 |bvals#0@@2| |locals#0@@9|) (Pure.__default.IsPure $ly@@24 |body#0@@1| (|Set#Union| (|Set#FromBoogieMap| (|lambda#0| (TSeq TChar) |bvars#0@@1|)) |locals#0@@9|)))))) (ite (AST.Expr__Raw.Assign_q |e#0@@21|) (let ((|avals#0@@2| (AST.Expr__Raw.avals |e#0@@21|)))
(let ((|avars#0@@1| (AST.Expr__Raw.avars |e#0@@21|)))
...
)) (Pure.__default.IsPure__Es $ly@@24 |avals#0@@2| |locals#0@@9|)))) (ite (AST.Expr__Raw.If_q |e#0@@21|) (let ((|els#0@@1| (AST.Expr__Raw.els |e#0@@21|)))
(let ((|thn#0@@1| (AST.Expr__Raw.thn |e#0@@21|)))
(let ((|cond#0@@1| (AST.Expr__Raw.cond |e#0@@21|)))
 (and (and (Pure.__default.IsPure $ly@@24 |cond#0@@1| |locals#0@@9|) (Pure.__default.IsPure $ly@@24 |thn#0@@1| |locals#0@@9|)) (Pure.__default.IsPure $ly@@24 |els#0@@1| |locals#0@@9|))))) (ite (AST.Expr__Raw.Op_q |e#0@@21|) (let ((|oe2#0@@0| (AST.Expr__Raw.oe2 |e#0@@21|)))
(let ((|oe1#0@@0| (AST.Expr__Raw.oe1 |e#0@@21|)))
 (and (Pure.__default.IsPure $ly@@24 |oe1#0@@0| |locals#0@@9|) (Pure.__default.IsPure $ly@@24 |oe2#0@@0| |locals#0@@9|)))) (let ((|es#0@@21| (AST.Expr__Raw.es |e#0@@21|)))
(Pure.__default.IsPure__Es $ly@@24 |es#0@@21| |locals#0@@9|)))))))))))
 :qid |Puredfy.15:13|
 :skolemid |645|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@24) |e#0@@21| |locals#0@@9|))
))))
...
(set-info :boogie-vc-id CheckWellFormed$$Pure.__default.InductBind__Fail)
...
(let ((anon5_Else_correct  (=> (and (=> (Pure.__default.Pes__Succ |st#0@@24| |bvals#0@@3| |st1#0@0| |vs#0@0|) (and (Pure.__default.UpdateState__Pre |st1#0@0| |bvars#0@@2| |vs#0@0|) (not (Pure.__default.P__Fail (Pure.__default.BindStartScope |st1#0@0| |bvars#0@@2| |vs#0@0|) |body#0@@2|)))) (= (ControlFlow 0 4) 1)) anon4_correct)))
(let ((anon5_Then_correct  (=> (and ($IsAlloc DatatypeTypeType |st#0@@24| Tclass.Pure.MState $Heap@0) ($IsAlloc SeqType |bvals#0@@3| (TSeq Tclass.AST.Expr) $Heap@0)) (=> (and (and ($IsAlloc DatatypeTypeType |st1#0@0| Tclass.Pure.MState $Heap@0) ($IsAlloc SeqType |vs#0@0| (TSeq TInt) $Heap@0)) (and (|Pure.__default.Pes__Succ#canCall| |st#0@@24| |bvals#0@@3| |st1#0@0| |vs#0@0|) (Pure.__default.Pes__Succ |st#0@@24| |bvals#0@@3| |st1#0@0| |vs#0@0|))) (=> (and (and (and ($IsAlloc DatatypeTypeType |st1#0@0| Tclass.Pure.MState $Heap@0) ($IsAlloc SeqType |bvars#0@@2| (TSeq (TSeq TChar)) $Heap@0)) (and ($IsAlloc SeqType |vs#0@0| (TSeq TInt) $Heap@0) (|Pure.__default.UpdateState__Pre#canCall| |st1#0@0| |bvars#0@@2| |vs#0@0|))) (and (and (Pure.__default.UpdateState__Pre |st1#0@0| |bvars#0@@2| |vs#0@0|) ($IsAlloc DatatypeTypeType |st1#0@0| Tclass.Pure.MState $Heap@0)) (and ($IsAlloc SeqType |bvars#0@@2| (TSeq (TSeq TChar)) $Heap@0) ($IsAlloc SeqType |vs#0@0| (TSeq TInt) $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (Pure.__default.UpdateState__Pre |st1#0@0| |bvars#0@@2| |vs#0@0|)) (=> (Pure.__default.UpdateState__Pre |st1#0@0| |bvars#0@@2| |vs#0@0|) (=> (and (and (and (|Pure.__default.BindStartScope#canCall| |st1#0@0| |bvars#0@@2| |vs#0@0|) (Pure.MState.MState_q (Pure.__default.BindStartScope |st1#0@0| |bvars#0@@2| |vs#0@0|))) (and (= |##st#5@0| (Pure.__default.BindStartScope |st1#0@0| |bvars#0@@2| |vs#0@0|)) ($IsAlloc DatatypeTypeType |##st#5@0| Tclass.Pure.MState $Heap@0))) (and (and ($IsAlloc DatatypeTypeType |body#0@@2| Tclass.AST.Expr $Heap@0) (|Pure.__default.P__Fail#canCall| (Pure.__default.BindStartScope |st1#0@0| |bvars#0@@2| |vs#0@0|) |body#0@@2|)) (and (not (Pure.__default.P__Fail (Pure.__default.BindStartScope |st1#0@0| |bvars#0@@2| |vs#0@0|) |body#0@@2|)) (= (ControlFlow 0 2) 1)))) anon4_correct))))))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#6| null $Heap@@6 alloc false)) (AST.Expr__Raw.Bind_q |e#0@@22|)) (and (AST.Expr__Raw.Bind_q |e#0@@22|) (|Seq#Equal| (AST.Expr__Raw.bvars |e#0@@22|) |bvars#0@@2|))) (=> (and (and (and (AST.Expr__Raw.Bind_q |e#0@@22|) (|Seq#Equal| (AST.Expr__Raw.bvals |e#0@@22|) |bvals#0@@3|)) (and (AST.Expr__Raw.Bind_q |e#0@@22|) (|AST.Expr__Raw#Equal| (AST.Expr__Raw.body |e#0@@22|) |body#0@@2|))) (and (and ($IsAlloc DatatypeTypeType |st#0@@24| Tclass.Pure.MState $Heap@@6) ($IsAlloc DatatypeTypeType |e#0@@22| Tclass.AST.Expr $Heap@@6)) (and (|Pure.__default.P__Fail#canCall| |st#0@@24| |e#0@@22|) (not (Pure.__default.P__Fail |st#0@@24| |e#0@@22|))))) (=> (and (and (and (and ($IsAlloc DatatypeTypeType |st#0@@24| Tclass.Pure.MState $Heap@@6) ($IsAlloc SeqType |bvals#0@@3| (TSeq Tclass.AST.Expr) $Heap@@6)) (and (|Pure.__default.Pes#canCall| |st#0@@24| |bvals#0@@3|) (Pure.__default.Pes |st#0@@24| |bvals#0@@3|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@6 $Heap@0))) (and (and (and ($IsAlloc DatatypeTypeType |st#0@@24| Tclass.Pure.MState $Heap@0) ($IsAlloc SeqType |bvals#0@@3| (TSeq Tclass.AST.Expr) $Heap@0)) (and (|Pure.__default.Pes__Fail#canCall| |st#0@@24| |bvals#0@@3|) (not (Pure.__default.Pes__Fail |st#0@@24| |bvals#0@@3|)))) (and (and ($Is DatatypeTypeType |st1#0@0| Tclass.Pure.MState) ($IsAlloc DatatypeTypeType |st1#0@0| Tclass.Pure.MState $Heap@0)) (and ($Is SeqType |vs#0@0| (TSeq TInt)) ($IsAlloc SeqType |vs#0@0| (TSeq TInt) $Heap@0))))) (and (=> (= (ControlFlow 0 5) 2) anon5_Then_correct) (=> (= (ControlFlow 0 5) 4) anon5_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@24| Tclass.Pure.MState) ($IsAlloc DatatypeTypeType |st#0@@24| Tclass.Pure.MState $Heap@@6)) (|$IsA#Pure.MState| |st#0@@24|)) (=> (and (and (and (and ($Is DatatypeTypeType |e#0@@22| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@22| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@22|)) (and (and ($Is SeqType |bvars#0@@2| (TSeq (TSeq TChar))) ($IsAlloc SeqType |bvars#0@@2| (TSeq (TSeq TChar)) $Heap@@6)) (and ($Is SeqType |bvals#0@@3| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |bvals#0@@3| (TSeq Tclass.AST.Expr) $Heap@@6)))) (and (and (and ($Is DatatypeTypeType |body#0@@2| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |body#0@@2| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |body#0@@2|)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 6) 5)))) anon0_correct)))))
