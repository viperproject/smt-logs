...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|es#0@@0| T@U) (|st'#0| T@U) (|vs#0| T@U) ) (!  (=> (or (|Pure.__default.Pes__Succ#canCall| |st#0@@1| |es#0@@0| |st'#0| |vs#0|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@1| Tclass.Pure.MState) ($Is SeqType |es#0@@0| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0| Tclass.Pure.MState)) ($Is SeqType |vs#0| (TSeq TInt))))) (and (and (and (Pure.MState.MState_q |st#0@@1|) (|Interp.__default.InterpExprs#canCall| |es#0@@0| (Pure.MState.ctx |st#0@@1|))) (let ((|res#0@@0| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@0| (Pure.MState.ctx |st#0@@1|))))
 (and (|Pure.__default.PreEs#canCall| |st#0@@1| |es#0@@0|) (=> (Pure.__default.PreEs |st#0@@1| |es#0@@0|) (and (|Pure.__default.ResultSameState#canCall| (TSeq TInt) |st#0@@1| |res#0@@0|) (=> (Pure.__default.ResultSameState (TSeq TInt) |st#0@@1| |res#0@@0|) (and (and (|$IsA#Utils.Result| |res#0@@0|) (Pure.MState.MState_q |st'#0|)) (=> (|Utils.Result#Equal| |res#0@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0|) ($Box MapType (Pure.MState.ctx |st'#0|)))))) (and (Pure.MState.MState_q |st'#0|) (Pure.MState.MState_q |st#0@@1|)))))))))) (= (Pure.__default.Pes__Succ |st#0@@1| |es#0@@0| |st'#0| |vs#0|) (let ((|res#0@@1| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@0| (Pure.MState.ctx |st#0@@1|))))
 (and (and (and (Pure.__default.PreEs |st#0@@1| |es#0@@0|) (Pure.__default.ResultSameState (TSeq TInt) |st#0@@1| |res#0@@1|)) (|Utils.Result#Equal| |res#0@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0|) ($Box MapType (Pure.MState.ctx |st'#0|))))))) (|Set#Equal| (Pure.MState.locals |st'#0|) (Pure.MState.locals |st#0@@1|)))))))
 :qid |Inductiondfy.40:28|
 :skolemid |737|
 :pattern ( (Pure.__default.Pes__Succ |st#0@@1| |es#0@@0| |st'#0| |vs#0|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|e#0@@5| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| (Lit DatatypeTypeType |st#0@@4|) (Lit DatatypeTypeType |e#0@@5|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@4| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@5| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@4|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@5|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@4|))))) (|Pure.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@4|) (Lit DatatypeTypeType |e#0@@5|))) (= (Pure.__default.P__Fail (Lit DatatypeTypeType |st#0@@4|) (Lit DatatypeTypeType |e#0@@5|)) (U_2_bool (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@5|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@4|)))))))
(Lit boolType (bool_2_U  (=> (Pure.__default.Pre (Lit DatatypeTypeType |st#0@@4|) (Lit DatatypeTypeType |e#0@@5|)) (Utils.Result.Failure_q |res#2@@1|)))))))))
...
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@6|)))
 (and (AST.Expr__Raw.All $ly@@3 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@3 |oe2#0| |p#0|)))) (let ((|es#0@@4| (AST.Expr__Raw.es |e#0@@6|)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|e#0@@7| T@U) ) (!  (=> (or (|Pure.__default.P#canCall| |st#0@@5| (Lit DatatypeTypeType |e#0@@7|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@5| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@7| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@5|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@7|) (Pure.MState.ctx |st#0@@5|))) (let ((|res#1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@7|) (Pure.MState.ctx |st#0@@5|))))
 (and (|Pure.__default.Pre#canCall| |st#0@@5| (Lit DatatypeTypeType |e#0@@7|)) (=> (Pure.__default.Pre |st#0@@5| (Lit DatatypeTypeType |e#0@@7|)) (|Pure.__default.ResultSameState#canCall| TInt |st#0@@5| |res#1|))))) (= (Pure.__default.P |st#0@@5| (Lit DatatypeTypeType |e#0@@7|)) (let ((|res#1@@0| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@7|) (Pure.MState.ctx |st#0@@5|))))
 (=> (Pure.__default.Pre |st#0@@5| (Lit DatatypeTypeType |e#0@@7|)) (Pure.__default.ResultSameState TInt |st#0@@5| |res#1@@0|))))))
 :qid |Inductiondfy.34:21|
 :weight 3
 :skolemid |707|
 :pattern ( (Pure.__default.P |st#0@@5| (Lit DatatypeTypeType |e#0@@7|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|e#0@@10| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| |st#0@@6| (Lit DatatypeTypeType |e#0@@10|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@10| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@6|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@10|) (Pure.MState.ctx |st#0@@6|))) (|Pure.__default.Pre#canCall| |st#0@@6| (Lit DatatypeTypeType |e#0@@10|))) (= (Pure.__default.P__Fail |st#0@@6| (Lit DatatypeTypeType |e#0@@10|)) (let ((|res#1@@1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@10|) (Pure.MState.ctx |st#0@@6|))))
 (=> (Pure.__default.Pre |st#0@@6| (Lit DatatypeTypeType |e#0@@10|)) (Utils.Result.Failure_q |res#1@@1|))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |723|
 :pattern ( (Pure.__default.P__Fail |st#0@@6| (Lit DatatypeTypeType |e#0@@10|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|es#0@@7| T@U) (|st'#0@@0| T@U) (|vs#0@@1| T@U) ) (!  (=> (or (|Pure.__default.Pes__Succ#canCall| (Lit DatatypeTypeType |st#0@@7|) (Lit SeqType |es#0@@7|) (Lit DatatypeTypeType |st'#0@@0|) (Lit SeqType |vs#0@@1|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@7| Tclass.Pure.MState) ($Is SeqType |es#0@@7| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@0| Tclass.Pure.MState)) ($Is SeqType |vs#0@@1| (TSeq TInt))))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@7|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@7|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@7|))))) (let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@7|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@7|)))))))
 (and (|Pure.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@7|) (Lit SeqType |es#0@@7|)) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@7|) (Lit SeqType |es#0@@7|))))) (and (|Pure.__default.ResultSameState#canCall| (TSeq TInt) (Lit DatatypeTypeType |st#0@@7|) |res#2@@2|) (=> (Pure.__default.ResultSameState (TSeq TInt) (Lit DatatypeTypeType |st#0@@7|) |res#2@@2|) (and (and (|$IsA#Utils.Result| |res#2@@2|) (Pure.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|))) (=> (|Utils.Result#Equal| |res#2@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |vs#0@@1|)) ($Box MapType (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st'#0@@0|))))))))) (and (Pure.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|)) (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@7|))))))))))) (= (Pure.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@7|) (Lit SeqType |es#0@@7|) (Lit DatatypeTypeType |st'#0@@0|) (Lit SeqType |vs#0@@1|)) (let ((|res#2@@3| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@7|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@7|)))))))
 (and (and (and (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@7|) (Lit SeqType |es#0@@7|)) (Pure.__default.ResultSameState (TSeq TInt) (Lit DatatypeTypeType |st#0@@7|) |res#2@@3|)) (|Utils.Result#Equal| |res#2@@3| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |vs#0@@1|)) ($Box MapType (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st'#0@@0|)))))))))) (|Set#Equal| (Pure.MState.locals (Lit DatatypeTypeType |st'#0@@0|)) (Pure.MState.locals (Lit DatatypeTypeType |st#0@@7|))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |739|
 :pattern ( (Pure.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@7|) (Lit SeqType |es#0@@7|) (Lit DatatypeTypeType |st'#0@@0|) (Lit SeqType |vs#0@@1|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|e#0@@15| T@U) ) (!  (=> (or (|Pure.__default.Pre#canCall| |st#0@@8| |e#0@@15|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@8| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@8|) (|Pure.__default.IsPure#canCall| |e#0@@15| (Pure.MState.locals |st#0@@8|))) (=> (Pure.__default.IsPure ($LS $LZ) |e#0@@15| (Pure.MState.locals |st#0@@8|)) (and (Pure.MState.MState_q |st#0@@8|) (Pure.MState.MState_q |st#0@@8|)))) (= (Pure.__default.Pre |st#0@@8| |e#0@@15|)  (and (Pure.__default.IsPure ($LS $LZ) |e#0@@15| (Pure.MState.locals |st#0@@8|)) (|Set#Subset| (Pure.MState.locals |st#0@@8|) (|Map#Domain| (Pure.MState.ctx |st#0@@8|)))))))
 :qid |Puredfy.85:23|
 :skolemid |696|
 :pattern ( (Pure.__default.Pre |st#0@@8| |e#0@@15|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((Pure._default.ResultSameState$V@@0 T@U) (|st#0@@9| T@U) (|res#0@@2| T@U) ) (!  (=> (or (|Pure.__default.ResultSameState#canCall| Pure._default.ResultSameState$V@@0 |st#0@@9| |res#0@@2|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@9| Tclass.Pure.MState) ($Is DatatypeTypeType |res#0@@2| (Tclass.Utils.Result (Tclass._System.Tuple2 Pure._default.ResultSameState$V@@0 (TMap (TSeq TChar) TInt))))))) (and (and (and (Pure.MState.MState_q |st#0@@9|) (Pure.MState.MState_q |st#0@@9|)) (|Pure.__default.ResultSameCtx#canCall| Pure._default.ResultSameState$V@@0 (Pure.MState.locals |st#0@@9|) (Pure.MState.ctx |st#0@@9|) |res#0@@2|)) (= (Pure.__default.ResultSameState Pure._default.ResultSameState$V@@0 |st#0@@9| |res#0@@2|) (Pure.__default.ResultSameCtx Pure._default.ResultSameState$V@@0 (Pure.MState.locals |st#0@@9|) (Pure.MState.ctx |st#0@@9|) |res#0@@2|))))
 :qid |unknown.0:0|
 :skolemid |690|
 :pattern ( (Pure.__default.ResultSameState Pure._default.ResultSameState$V@@0 |st#0@@9| |res#0@@2|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@10| T@U) (|es#0@@10| T@U) ) (!  (=> (or (|Pure.__default.PreEs#canCall| |st#0@@10| |es#0@@10|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@10| Tclass.Pure.MState) ($Is SeqType |es#0@@10| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@10|) (|Pure.__default.IsPure__Es#canCall| |es#0@@10| (Pure.MState.locals |st#0@@10|))) (=> (Pure.__default.IsPure__Es ($LS $LZ) |es#0@@10| (Pure.MState.locals |st#0@@10|)) (and (Pure.MState.MState_q |st#0@@10|) (Pure.MState.MState_q |st#0@@10|)))) (= (Pure.__default.PreEs |st#0@@10| |es#0@@10|)  (and (Pure.__default.IsPure__Es ($LS $LZ) |es#0@@10| (Pure.MState.locals |st#0@@10|)) (|Set#Subset| (Pure.MState.locals |st#0@@10|) (|Map#Domain| (Pure.MState.ctx |st#0@@10|)))))))
 :qid |Puredfy.91:25|
 :skolemid |701|
 :pattern ( (Pure.__default.PreEs |st#0@@10| |es#0@@10|))
))))
...
(assert (forall (($ly@@15 T@U) (|es#0@@11| T@U) (|ctx#0@@6| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@11|) |ctx#0@@6|) (and ($Is SeqType |es#0@@11| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@6| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@11| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@11|) (LitInt 0))) |ctx#0@@6|) (let ((|valueOrError0#1@@0| (Interp.__default.InterpExpr ($LS $ly@@15) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@11|) (LitInt 0))) |ctx#0@@6|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@11|) (LitInt 1))) |ctx1#1@@0|) (let ((|valueOrError1#1@@0| (Interp.__default.InterpExprs ($LS $ly@@15) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@11|) (LitInt 1))) |ctx1#1@@0|)))
...
(let ((|valueOrError1#1@@1| (Interp.__default.InterpExprs ($LS $ly@@15) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@11|) (LitInt 1))) |ctx1#1@@1|)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@11| T@U) (|e#0@@16| T@U) ) (!  (=> (or (|Pure.__default.P__Fail#canCall| |st#0@@11| |e#0@@16|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@11| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@16| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@11|) (|Interp.__default.InterpExpr#canCall| |e#0@@16| (Pure.MState.ctx |st#0@@11|))) (|Pure.__default.Pre#canCall| |st#0@@11| |e#0@@16|)) (= (Pure.__default.P__Fail |st#0@@11| |e#0@@16|) (let ((|res#0@@3| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@16| (Pure.MState.ctx |st#0@@11|))))
 (=> (Pure.__default.Pre |st#0@@11| |e#0@@16|) (Utils.Result.Failure_q |res#0@@3|))))))
 :qid |Inductiondfy.36:26|
 :skolemid |722|
 :pattern ( (Pure.__default.P__Fail |st#0@@11| |e#0@@16|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@12| T@U) (|es#0@@13| T@U) (|st'#0@@1| T@U) (|vs#0@@3| T@U) ) (!  (=> (or (|Pure.__default.Pes__Succ#canCall| |st#0@@12| (Lit SeqType |es#0@@13|) |st'#0@@1| |vs#0@@3|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@12| Tclass.Pure.MState) ($Is SeqType |es#0@@13| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@1| Tclass.Pure.MState)) ($Is SeqType |vs#0@@3| (TSeq TInt))))) (and (and (and (Pure.MState.MState_q |st#0@@12|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@13|) (Pure.MState.ctx |st#0@@12|))) (let ((|res#1@@2| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@13|) (Pure.MState.ctx |st#0@@12|))))
 (and (|Pure.__default.PreEs#canCall| |st#0@@12| (Lit SeqType |es#0@@13|)) (=> (Pure.__default.PreEs |st#0@@12| (Lit SeqType |es#0@@13|)) (and (|Pure.__default.ResultSameState#canCall| (TSeq TInt) |st#0@@12| |res#1@@2|) (=> (Pure.__default.ResultSameState (TSeq TInt) |st#0@@12| |res#1@@2|) (and (and (|$IsA#Utils.Result| |res#1@@2|) (Pure.MState.MState_q |st'#0@@1|)) (=> (|Utils.Result#Equal| |res#1@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@3|) ($Box MapType (Pure.MState.ctx |st'#0@@1|)))))) (and (Pure.MState.MState_q |st'#0@@1|) (Pure.MState.MState_q |st#0@@12|)))))))))) (= (Pure.__default.Pes__Succ |st#0@@12| (Lit SeqType |es#0@@13|) |st'#0@@1| |vs#0@@3|) (let ((|res#1@@3| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@13|) (Pure.MState.ctx |st#0@@12|))))
 (and (and (and (Pure.__default.PreEs |st#0@@12| (Lit SeqType |es#0@@13|)) (Pure.__default.ResultSameState (TSeq TInt) |st#0@@12| |res#1@@3|)) (|Utils.Result#Equal| |res#1@@3| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@3|) ($Box MapType (Pure.MState.ctx |st'#0@@1|))))))) (|Set#Equal| (Pure.MState.locals |st'#0@@1|) (Pure.MState.locals |st#0@@12|)))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |738|
 :pattern ( (Pure.__default.Pes__Succ |st#0@@12| (Lit SeqType |es#0@@13|) |st'#0@@1| |vs#0@@3|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@13| T@U) (|e#0@@20| T@U) ) (!  (=> (or (|Pure.__default.P#canCall| |st#0@@13| |e#0@@20|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@13| Tclass.Pure.MState) ($Is DatatypeTypeType |e#0@@20| Tclass.AST.Expr)))) (and (and (and (Pure.MState.MState_q |st#0@@13|) (|Interp.__default.InterpExpr#canCall| |e#0@@20| (Pure.MState.ctx |st#0@@13|))) (let ((|res#0@@5| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@20| (Pure.MState.ctx |st#0@@13|))))
 (and (|Pure.__default.Pre#canCall| |st#0@@13| |e#0@@20|) (=> (Pure.__default.Pre |st#0@@13| |e#0@@20|) (|Pure.__default.ResultSameState#canCall| TInt |st#0@@13| |res#0@@5|))))) (= (Pure.__default.P |st#0@@13| |e#0@@20|) (let ((|res#0@@6| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@20| (Pure.MState.ctx |st#0@@13|))))
 (=> (Pure.__default.Pre |st#0@@13| |e#0@@20|) (Pure.__default.ResultSameState TInt |st#0@@13| |res#0@@6|))))))
 :qid |Inductiondfy.34:21|
 :skolemid |706|
 :pattern ( (Pure.__default.P |st#0@@13| |e#0@@20|))
))))
...
(let ((|oe1#0@@0| (AST.Expr__Raw.oe1 |e#0@@24|)))
 (and (Pure.__default.IsPure $ly@@24 |oe1#0@@0| |locals#0@@8|) (Pure.__default.IsPure $ly@@24 |oe2#0@@0| |locals#0@@8|)))) (let ((|es#0@@15| (AST.Expr__Raw.es |e#0@@24|)))
...
(declare-fun |es#0@@16| () T@U)
(declare-fun |st1#0| () T@U)
(declare-fun |vs#0@@4| () T@U)
(set-info :boogie-vc-id Impl$$Pure.__default.InductSeq__Succ)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#6| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|Pure.__default.P#canCall| |st#0@@14| |e#0@@25|) (or (Pure.__default.P |st#0@@14| |e#0@@25|) (let ((|res#1@@4| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@25| (Pure.MState.ctx |st#0@@14|))))
 (=> (Pure.__default.Pre |st#0@@14| |e#0@@25|) (=> (|Pure.__default.ResultSameState#canCall| TInt |st#0@@14| |res#1@@4|) (or (Pure.__default.ResultSameState TInt |st#0@@14| |res#1@@4|) (=> (|Pure.__default.ResultSameCtx#canCall| TInt (Pure.MState.locals |st#0@@14|) (Pure.MState.ctx |st#0@@14|) |res#1@@4|) (or (Pure.__default.ResultSameCtx TInt (Pure.MState.locals |st#0@@14|) (Pure.MState.ctx |st#0@@14|) |res#1@@4|) (=> (Utils.Result.Success_q |res#1@@4|) (let ((|ctx'#2@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@4|))))))
(|Set#Equal| (|Map#Domain| |ctx'#2@@0|) (|Map#Domain| (Pure.MState.ctx |st#0@@14|)))))))))))))) (=> (=> (|Pure.__default.P#canCall| |st#0@@14| |e#0@@25|) (or (Pure.__default.P |st#0@@14| |e#0@@25|) (let ((|res#1@@5| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@25| (Pure.MState.ctx |st#0@@14|))))
 (=> (Pure.__default.Pre |st#0@@14| |e#0@@25|) (=> (|Pure.__default.ResultSameState#canCall| TInt |st#0@@14| |res#1@@5|) (or (Pure.__default.ResultSameState TInt |st#0@@14| |res#1@@5|) (=> (|Pure.__default.ResultSameCtx#canCall| TInt (Pure.MState.locals |st#0@@14|) (Pure.MState.ctx |st#0@@14|) |res#1@@5|) (or (Pure.__default.ResultSameCtx TInt (Pure.MState.locals |st#0@@14|) (Pure.MState.ctx |st#0@@14|) |res#1@@5|) (=> (Utils.Result.Success_q |res#1@@5|) (let ((|ctx'#2@@1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@5|))))))
(|Set#Equal| (|Map#Domain| |ctx'#2@@1|) (|Map#Domain| (Pure.MState.ctx |st#0@@14|))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|Pure.__default.P#canCall| |st#0@@14| |e#0@@25|) (or (Pure.__default.P |st#0@@14| |e#0@@25|) (let ((|res#1@@6| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@25| (Pure.MState.ctx |st#0@@14|))))
 (=> (Pure.__default.Pre |st#0@@14| |e#0@@25|) (=> (|Pure.__default.ResultSameState#canCall| TInt |st#0@@14| |res#1@@6|) (or (Pure.__default.ResultSameState TInt |st#0@@14| |res#1@@6|) (=> (|Pure.__default.ResultSameCtx#canCall| TInt (Pure.MState.locals |st#0@@14|) (Pure.MState.ctx |st#0@@14|) |res#1@@6|) (or (Pure.__default.ResultSameCtx TInt (Pure.MState.locals |st#0@@14|) (Pure.MState.ctx |st#0@@14|) |res#1@@6|) (=> (Utils.Result.Success_q |res#1@@6|) (let ((|ctx'#2@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@6|))))))
(forall ((|x#2@@1| T@U) ) (!  (=> (and ($Is SeqType |x#2@@1| (TSeq TChar)) (and (|Set#IsMember| (|Map#Domain| (Pure.MState.ctx |st#0@@14|)) ($Box SeqType |x#2@@1|)) (not (|Set#IsMember| (Pure.MState.locals |st#0@@14|) ($Box SeqType |x#2@@1|))))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx'#2@@2|) ($Box SeqType |x#2@@1|)))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Pure.MState.ctx |st#0@@14|)) ($Box SeqType |x#2@@1|))))))
 :qid |Puredfy.57:19|
 :skolemid |826|
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Pure.MState.ctx |st#0@@14|)) ($Box SeqType |x#2@@1|))))
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx'#2@@2|) ($Box SeqType |x#2@@1|))))
 :pattern ( (|Set#IsMember| (Pure.MState.locals |st#0@@14|) ($Box SeqType |x#2@@1|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| (Pure.MState.ctx |st#0@@14|)) ($Box SeqType |x#2@@1|)))
))))))))))))) (=> (=> (|Pure.__default.P#canCall| |st#0@@14| |e#0@@25|) (or (Pure.__default.P |st#0@@14| |e#0@@25|) (let ((|res#1@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@25| (Pure.MState.ctx |st#0@@14|))))
 (=> (Pure.__default.Pre |st#0@@14| |e#0@@25|) (=> (|Pure.__default.ResultSameState#canCall| TInt |st#0@@14| |res#1@@7|) (or (Pure.__default.ResultSameState TInt |st#0@@14| |res#1@@7|) (=> (|Pure.__default.ResultSameCtx#canCall| TInt (Pure.MState.locals |st#0@@14|) (Pure.MState.ctx |st#0@@14|) |res#1@@7|) (or (Pure.__default.ResultSameCtx TInt (Pure.MState.locals |st#0@@14|) (Pure.MState.ctx |st#0@@14|) |res#1@@7|) (=> (Utils.Result.Success_q |res#1@@7|) (let ((|ctx'#2@@3| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@7|))))))
(forall ((|x#2@@2| T@U) ) (!  (=> (and ($Is SeqType |x#2@@2| (TSeq TChar)) (and (|Set#IsMember| (|Map#Domain| (Pure.MState.ctx |st#0@@14|)) ($Box SeqType |x#2@@2|)) (not (|Set#IsMember| (Pure.MState.locals |st#0@@14|) ($Box SeqType |x#2@@2|))))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx'#2@@3|) ($Box SeqType |x#2@@2|)))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Pure.MState.ctx |st#0@@14|)) ($Box SeqType |x#2@@2|))))))
 :qid |Puredfy.57:19|
 :skolemid |826|
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Pure.MState.ctx |st#0@@14|)) ($Box SeqType |x#2@@2|))))
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx'#2@@3|) ($Box SeqType |x#2@@2|))))
 :pattern ( (|Set#IsMember| (Pure.MState.locals |st#0@@14|) ($Box SeqType |x#2@@2|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| (Pure.MState.ctx |st#0@@14|)) ($Box SeqType |x#2@@2|)))
)))))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|Pure.__default.P#canCall| |st#0@@14| |e#0@@25|) (or (Pure.__default.P |st#0@@14| |e#0@@25|) (let ((|res#1@@8| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@25| (Pure.MState.ctx |st#0@@14|))))
 (=> (Pure.__default.Pre |st#0@@14| |e#0@@25|) (=> (|Pure.__default.ResultSameState#canCall| TInt |st#0@@14| |res#1@@8|) (or (Pure.__default.ResultSameState TInt |st#0@@14| |res#1@@8|) (=> (|Pure.__default.ResultSameCtx#canCall| TInt (Pure.MState.locals |st#0@@14|) (Pure.MState.ctx |st#0@@14|) |res#1@@8|) (or (Pure.__default.ResultSameCtx TInt (Pure.MState.locals |st#0@@14|) (Pure.MState.ctx |st#0@@14|) |res#1@@8|) (=> (not (Utils.Result.Success_q |res#1@@8|)) (U_2_bool (Lit boolType (bool_2_U true))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@14| Tclass.Pure.MState) ($IsAlloc DatatypeTypeType |st#0@@14| Tclass.Pure.MState $Heap@@6)) (|$IsA#Pure.MState| |st#0@@14|)) (=> (and (and (and (and (and ($Is DatatypeTypeType |e#0@@25| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@25| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@25|)) (and ($Is SeqType |es#0@@16| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |es#0@@16| (TSeq Tclass.AST.Expr) $Heap@@6))) (and (and ($Is DatatypeTypeType |st1#0| Tclass.Pure.MState) ($IsAlloc DatatypeTypeType |st1#0| Tclass.Pure.MState $Heap@@6)) (|$IsA#Pure.MState| |st1#0|))) (and (and (and ($Is SeqType |vs#0@@4| (TSeq TInt)) ($IsAlloc SeqType |vs#0@@4| (TSeq TInt) $Heap@@6)) (and (= 4 $FunctionContextHeight) (AST.Expr__Raw.Seq_q |e#0@@25|))) (and (and (|Seq#Equal| (AST.Expr__Raw.es |e#0@@25|) |es#0@@16|) (not (Pure.__default.P__Fail |st#0@@14| |e#0@@25|))) (and (Pure.__default.Pes__Succ |st#0@@14| |es#0@@16| |st1#0| |vs#0@@4|) (= (ControlFlow 0 5) 2))))) anon0_correct)))))
