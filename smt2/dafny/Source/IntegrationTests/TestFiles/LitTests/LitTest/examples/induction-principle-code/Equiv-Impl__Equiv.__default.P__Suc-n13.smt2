...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|e#0@@11| T@U) ) (!  (=> (or (|Equiv.__default.P#canCall| |st#0@@5| |e#0@@11|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@5| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@11| Tclass.AST.Expr)))) (and (and (and (Equiv.MState.MState_q |st#0@@5|) (|Interp.__default.InterpExpr#canCall| |e#0@@11| (Equiv.MState.ctx |st#0@@5|))) (let ((|res#0@@3| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@11| (Equiv.MState.ctx |st#0@@5|))))
 (and (and (Equiv.MState.MState_q |st#0@@5|) (|Interp.__default.InterpExpr#canCall| |e#0@@11| (Equiv.MState.ctx_k |st#0@@5|))) (let ((|res'#0@@3| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@11| (Equiv.MState.ctx_k |st#0@@5|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@5|) (=> (Equiv.__default.Inv |st#0@@5|) (|Equiv.__default.EqResult#canCall| |res#0@@3| |res'#0@@3|))))))) (= (Equiv.__default.P |st#0@@5| |e#0@@11|) (let ((|res#0@@4| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@11| (Equiv.MState.ctx |st#0@@5|))))
(let ((|res'#0@@4| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@11| (Equiv.MState.ctx_k |st#0@@5|))))
 (=> (Equiv.__default.Inv |st#0@@5|) (Equiv.__default.EqResult |res#0@@4| |res'#0@@4|)))))))
 :qid |Inductiondfy.34:21|
 :skolemid |688|
 :pattern ( (Equiv.__default.P |st#0@@5| |e#0@@11|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|e#0@@15| T@U) ) (!  (=> (or (|Equiv.__default.P#canCall| (Lit DatatypeTypeType |st#0@@6|) (Lit DatatypeTypeType |e#0@@15|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr)))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@6|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@15|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@6|))))) (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@15|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@6|)))))))
 (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@6|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@15|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@6|))))) (let ((|res'#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@15|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@6|)))))))
 (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@6|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@6|))))) (|Equiv.__default.EqResult#canCall| |res#2@@1| |res'#2@@1|))))))) (= (Equiv.__default.P (Lit DatatypeTypeType |st#0@@6|) (Lit DatatypeTypeType |e#0@@15|)) (U_2_bool (let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@15|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@6|)))))))
(let ((|res'#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@15|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@6|)))))))
(Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@6|)) (Equiv.__default.EqResult |res#2@@2| |res'#2@@2|))))))))))
 :qid |Inductiondfy.34:21|
 :weight 3
 :skolemid |690|
...
(declare-fun |v#0@@4| () T@U)
(set-info :boogie-vc-id Impl$$Equiv.__default.P__Succ__Sound)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|Equiv.__default.P#canCall| |st#0@@7| |e#0@@19|) (or (Equiv.__default.P |st#0@@7| |e#0@@19|) (let ((|res#1@@3| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx |st#0@@7|))))
...
(let ((|v#3@@0| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#1@@3|)))))))))))
 (=> (|Equiv.__default.EqValue#canCall| |v#3@@0| |v'#2@@0|) (or (Equiv.__default.EqValue |v#3@@0| |v'#2@@0|) (= |v#3@@0| |v'#2@@0|))))))))))))))) (=> (=> (|Equiv.__default.P#canCall| |st#0@@7| |e#0@@19|) (or (Equiv.__default.P |st#0@@7| |e#0@@19|) (let ((|res#1@@4| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx |st#0@@7|))))
...
(let ((|v#3@@1| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#1@@4|)))))))))))
 (=> (|Equiv.__default.EqValue#canCall| |v#3@@1| |v'#2@@1|) (or (Equiv.__default.EqValue |v#3@@1| |v'#2@@1|) (= |v#3@@1| |v'#2@@1|)))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|Equiv.__default.P#canCall| |st#0@@7| |e#0@@19|) (or (Equiv.__default.P |st#0@@7| |e#0@@19|) (let ((|res#1@@5| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx |st#0@@7|))))
...
(Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#2@@0| |ctx'#2@@0|))))))))))))) (=> (=> (|Equiv.__default.P#canCall| |st#0@@7| |e#0@@19|) (or (Equiv.__default.P |st#0@@7| |e#0@@19|) (let ((|res#1@@6| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx |st#0@@7|))))
...
(Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#2@@1| |ctx'#2@@1|)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|Equiv.__default.P#canCall| |st#0@@7| |e#0@@19|) (or (Equiv.__default.P |st#0@@7| |e#0@@19|) (let ((|res#1@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx |st#0@@7|))))
(let ((|res'#1@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx_k |st#0@@7|))))
 (=> (Equiv.__default.Inv |st#0@@7|) (=> (|Equiv.__default.EqResult#canCall| |res#1@@7| |res'#1@@7|) (or (Equiv.__default.EqResult |res#1@@7| |res'#1@@7|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@7|) ($Box DatatypeTypeType |res'#1@@7|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@7|) ($Box DatatypeTypeType |res'#1@@7|)))))) (U_2_bool (Lit boolType (bool_2_U false))))))))))))) (=> (=> (|Equiv.__default.P#canCall| |st#0@@7| |e#0@@19|) (or (Equiv.__default.P |st#0@@7| |e#0@@19|) (let ((|res#1@@8| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx |st#0@@7|))))
(let ((|res'#1@@8| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx_k |st#0@@7|))))
 (=> (Equiv.__default.Inv |st#0@@7|) (=> (|Equiv.__default.EqResult#canCall| |res#1@@8| |res'#1@@8|) (or (Equiv.__default.EqResult |res#1@@8| |res'#1@@8|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@8|) ($Box DatatypeTypeType |res'#1@@8|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@8|) ($Box DatatypeTypeType |res'#1@@8|)))))) (U_2_bool (Lit boolType (bool_2_U false)))))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|Equiv.__default.P#canCall| |st#0@@7| |e#0@@19|) (or (Equiv.__default.P |st#0@@7| |e#0@@19|) (let ((|res#1@@9| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx |st#0@@7|))))
(let ((|res'#1@@9| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx_k |st#0@@7|))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@7| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st#0@@7| Tclass.Equiv.MState $Heap@@6)) (|$IsA#Equiv.MState| |st#0@@7|)) (=> (and (and (and ($Is DatatypeTypeType |e#0@@19| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@19| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@19|)) (and (and ($Is DatatypeTypeType |st'#0@@2| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st'#0@@2| Tclass.Equiv.MState $Heap@@6)) (|$IsA#Equiv.MState| |st'#0@@2|))) (=> (and (and (and (and ($Is DatatypeTypeType |v#0@@4| Tclass.Equiv.MValue) ($IsAlloc DatatypeTypeType |v#0@@4| Tclass.Equiv.MValue $Heap@@6)) (|$IsA#Equiv.MValue| |v#0@@4|)) (= 3 $FunctionContextHeight)) (and (Equiv.__default.P__Succ |st#0@@7| |e#0@@19| |st'#0@@2| |v#0@@4|) (= (ControlFlow 0 6) 2))) anon0_correct))))))
