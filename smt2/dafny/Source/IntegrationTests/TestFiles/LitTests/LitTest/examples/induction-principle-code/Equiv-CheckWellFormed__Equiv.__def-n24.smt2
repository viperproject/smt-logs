...
(assert (distinct TBool TChar TInt TagBool TagChar TagInt TagSet TagSeq TagMap alloc Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 Tagclass._System.___hTotalFunc1 |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass.Utils.Result Tagclass.Equiv.MState Tagclass.AST.Expr Tagclass.Equiv.VS Tagclass.AST.BinOp Tagclass.AST.Expr__Raw |##Equiv.MState.MState| |##Equiv.MSeqValue.MSeqValue| Tagclass.Equiv.MSeqValue |##Utils.Result.Success| |##Utils.Result.Failure| |##AST.BinOp.Add| |##AST.BinOp.Sub| |##AST.BinOp.Mul| |##AST.Expr_Raw.Var| |##AST.Expr_Raw.Literal| |##AST.Expr_Raw.Bind| |##AST.Expr_Raw.Assign| |##AST.Expr_Raw.If| |##AST.Expr_Raw.Op| |##AST.Expr_Raw.Seq| |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1| |tytagFamily$_#TotalFunc1| |tytagFamily$_tuple#2| tytagFamily$Result tytagFamily$MState tytagFamily$Expr tytagFamily$VS tytagFamily$BinOp tytagFamily$Expr_Raw tytagFamily$MSeqValue)
)
...
(assert (forall ((d@@2 T@U) ) (!  (=> ($Is DatatypeTypeType d@@2 Tclass.Equiv.MSeqValue) (Equiv.MSeqValue.MSeqValue_q d@@2))
 :qid |unknown.0:0|
 :skolemid |936|
 :pattern ( (Equiv.MSeqValue.MSeqValue_q d@@2) ($Is DatatypeTypeType d@@2 Tclass.Equiv.MSeqValue))
)))
...
(assert (forall (($ly@@0 T@U) (|e#0@@1| T@U) (|ctx#0@@1| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@1| |ctx#0@@1|) (and ($Is DatatypeTypeType |e#0@@1| Tclass.AST.Expr) ($Is MapType |ctx#0@@1| (TMap (TSeq TChar) TInt)))) (and (=> (not (AST.Expr__Raw.Var_q |e#0@@1|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@1|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@1|) (let ((|body#1| (AST.Expr__Raw.body |e#0@@1|)))
...
(|Interp.__default.InterpBinOp#canCall| |op#1| |v1#1| |v2#1|)))))))))))))))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@1|)) (let ((|es#1| (AST.Expr__Raw.es |e#0@@1|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#1|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@0) |e#0@@1| |ctx#0@@1|) (ite (AST.Expr__Raw.Var_q |e#0@@1|) (let ((|name#0| (AST.Expr__Raw.name |e#0@@1|)))
(ite (|Set#IsMember| (|Map#Domain| |ctx#0@@1|) ($Box SeqType |name#0|)) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@1|) ($Box SeqType |name#0|)) ($Box MapType |ctx#0@@1|)))) |#Utils.Result.Failure|)) (ite (AST.Expr__Raw.Literal_q |e#0@@1|) (let ((|n#0| (AST.Expr__Raw.n |e#0@@1|)))
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#0|)) ($Box MapType |ctx#0@@1|))))) (ite (AST.Expr__Raw.Bind_q |e#0@@1|) (let ((|body#0| (AST.Expr__Raw.body |e#0@@1|)))
...
(ite (|Seq#Equal| |vs#2@@1| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#3|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#2@@1| (- (|Seq#Length| |vs#2@@1|) 1)) ($Box MapType |ctx1#3|)))))))))))))))))))
 :qid |Interpdfy.24:12|
 :skolemid |1200|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@0) |e#0@@1| |ctx#0@@1|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|es#0@@1| T@U) ) (!  (=> (or (|Equiv.__default.Pes#canCall| |st#0@@3| (Lit SeqType |es#0@@1|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@3| Tclass.Equiv.MState) ($Is SeqType |es#0@@1| (TSeq Tclass.AST.Expr))))) (and (and (and (Equiv.MState.MState_q |st#0@@3|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@1|) (Equiv.MState.ctx |st#0@@3|))) (let ((|res#1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@1|) (Equiv.MState.ctx |st#0@@3|))))
 (and (and (Equiv.MState.MState_q |st#0@@3|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@1|) (Equiv.MState.ctx_k |st#0@@3|))) (let ((|res'#1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@1|) (Equiv.MState.ctx_k |st#0@@3|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@3|) (=> (Equiv.__default.Inv |st#0@@3|) (|Equiv.__default.EqResultSeq#canCall| |res#1| |res'#1|))))))) (= (Equiv.__default.Pes |st#0@@3| (Lit SeqType |es#0@@1|)) (let ((|res#1@@0| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@1|) (Equiv.MState.ctx |st#0@@3|))))
(let ((|res'#1@@0| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@1|) (Equiv.MState.ctx_k |st#0@@3|))))
 (=> (Equiv.__default.Inv |st#0@@3|) (Equiv.__default.EqResultSeq |res#1@@0| |res'#1@@0|)))))))
 :qid |Inductiondfy.39:23|
 :weight 3
 :skolemid |714|
 :pattern ( (Equiv.__default.Pes |st#0@@3| (Lit SeqType |es#0@@1|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|e#0@@2| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| |st#0@@5| |e#0@@2|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@5| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@2| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@5|) (=> (Equiv.__default.Inv |st#0@@5|) (and (Equiv.MState.MState_q |st#0@@5|) (|Interp.__default.InterpExpr#canCall| |e#0@@2| (Equiv.MState.ctx |st#0@@5|))))) (= (Equiv.__default.P__Fail |st#0@@5| |e#0@@2|)  (=> (Equiv.__default.Inv |st#0@@5|) (Utils.Result.Failure_q (Interp.__default.InterpExpr ($LS $LZ) |e#0@@2| (Equiv.MState.ctx |st#0@@5|)))))))
 :qid |Inductiondfy.36:26|
 :skolemid |706|
 :pattern ( (Equiv.__default.P__Fail |st#0@@5| |e#0@@2|))
))))
...
(assert (forall ((d@@3 T@U) ) (!  (=> (|$IsA#AST.Expr__Raw| d@@3) (or (or (or (or (or (or (AST.Expr__Raw.Var_q d@@3) (AST.Expr__Raw.Literal_q d@@3)) (AST.Expr__Raw.Bind_q d@@3)) (AST.Expr__Raw.Assign_q d@@3)) (AST.Expr__Raw.If_q d@@3)) (AST.Expr__Raw.Op_q d@@3)) (AST.Expr__Raw.Seq_q d@@3)))
 :qid |unknown.0:0|
 :skolemid |1117|
 :pattern ( (|$IsA#AST.Expr__Raw| d@@3))
)))
...
(assert (forall ((d@@5 T@U) ) (! (= (Equiv.MState.MState_q d@@5) (= (DatatypeCtorId d@@5) |##Equiv.MState.MState|))
 :qid |unknown.0:0|
 :skolemid |886|
 :pattern ( (Equiv.MState.MState_q d@@5))
)))
(assert (forall ((d@@6 T@U) ) (! (= (Equiv.MSeqValue.MSeqValue_q d@@6) (= (DatatypeCtorId d@@6) |##Equiv.MSeqValue.MSeqValue|))
 :qid |unknown.0:0|
 :skolemid |920|
 :pattern ( (Equiv.MSeqValue.MSeqValue_q d@@6))
)))
(assert (forall ((d@@7 T@U) ) (! (= (Utils.Result.Success_q d@@7) (= (DatatypeCtorId d@@7) |##Utils.Result.Success|))
 :qid |unknown.0:0|
 :skolemid |960|
 :pattern ( (Utils.Result.Success_q d@@7))
)))
(assert (forall ((d@@8 T@U) ) (! (= (Utils.Result.Failure_q d@@8) (= (DatatypeCtorId d@@8) |##Utils.Result.Failure|))
 :qid |unknown.0:0|
 :skolemid |969|
 :pattern ( (Utils.Result.Failure_q d@@8))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|es#0@@2| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Fail#canCall| |st#0@@6| |es#0@@2|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.Equiv.MState) ($Is SeqType |es#0@@2| (TSeq Tclass.AST.Expr))))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@6|) (=> (Equiv.__default.Inv |st#0@@6|) (and (Equiv.MState.MState_q |st#0@@6|) (|Interp.__default.InterpExprs#canCall| |es#0@@2| (Equiv.MState.ctx |st#0@@6|))))) (= (Equiv.__default.Pes__Fail |st#0@@6| |es#0@@2|)  (=> (Equiv.__default.Inv |st#0@@6|) (Utils.Result.Failure_q (Interp.__default.InterpExprs ($LS $LZ) |es#0@@2| (Equiv.MState.ctx |st#0@@6|)))))))
 :qid |Inductiondfy.41:28|
 :skolemid |732|
 :pattern ( (Equiv.__default.Pes__Fail |st#0@@6| |es#0@@2|))
))))
...
(assert (forall ((d@@23 T@U) ) (!  (=> (Equiv.MState.MState_q d@@23) (exists ((|a#1#0#0@@0| T@U) (|a#1#1#0@@0| T@U) ) (! (= d@@23 (|#Equiv.MState.MState| |a#1#0#0@@0| |a#1#1#0@@0|))
 :qid |Equivdfy.62:28|
 :skolemid |887|
)))
 :qid |unknown.0:0|
 :skolemid |888|
 :pattern ( (Equiv.MState.MState_q d@@23))
)))
(assert (forall ((d@@24 T@U) ) (!  (=> (Equiv.MSeqValue.MSeqValue_q d@@24) (exists ((|a#17#0#0| T@U) (|a#17#1#0| T@U) ) (! (= d@@24 (|#Equiv.MSeqValue.MSeqValue| |a#17#0#0| |a#17#1#0|))
 :qid |Equivdfy.64:34|
 :skolemid |921|
)))
 :qid |unknown.0:0|
 :skolemid |922|
 :pattern ( (Equiv.MSeqValue.MSeqValue_q d@@24))
)))
(assert (forall ((d@@25 T@U) ) (!  (=> (AST.Expr__Raw.Assign_q d@@25) (exists ((|a#47#0#0| T@U) (|a#47#1#0| T@U) ) (! (= d@@25 (|#AST.Expr_Raw.Assign| |a#47#0#0| |a#47#1#0|))
 :qid |ASTdfy.18:14|
 :skolemid |1064|
)))
 :qid |unknown.0:0|
 :skolemid |1065|
 :pattern ( (AST.Expr__Raw.Assign_q d@@25))
)))
(assert (forall (($ly@@1 T@U) ($Heap@@1 T@U) (|e#0@@3| T@U) (|p#0| T@U) ) (!  (=> (or (|AST.Expr__Raw.All#canCall| |e#0@@3| |p#0|) (and (and ($IsGoodHeap $Heap@@1) ($Is DatatypeTypeType |e#0@@3| Tclass.AST.Expr__Raw)) ($Is HandleTypeType |p#0| (Tclass._System.___hTotalFunc1 Tclass.AST.Expr__Raw TBool)))) (and (=> (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@1 |p#0| ($Box DatatypeTypeType |e#0@@3|)))) (=> (not (AST.Expr__Raw.Var_q |e#0@@3|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@3|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@3|) (let ((|body#1@@0| (AST.Expr__Raw.body |e#0@@3|)))
...
(let ((|cond#1@@0| (AST.Expr__Raw.cond |e#0@@3|)))
 (and (|AST.Expr__Raw.All#canCall| |cond#1@@0| |p#0|) (=> (AST.Expr__Raw.All $ly@@1 |cond#1@@0| |p#0|) (and (|AST.Expr__Raw.All#canCall| |thn#1@@0| |p#0|) (=> (AST.Expr__Raw.All $ly@@1 |thn#1@@0| |p#0|) (|AST.Expr__Raw.All#canCall| |els#1@@0| |p#0|))))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@3|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@3|) (let ((|oe2#1| (AST.Expr__Raw.oe2 |e#0@@3|)))
(let ((|oe1#1| (AST.Expr__Raw.oe1 |e#0@@3|)))
 (and (|AST.Expr__Raw.All#canCall| |oe1#1| |p#0|) (=> (AST.Expr__Raw.All $ly@@1 |oe1#1| |p#0|) (|AST.Expr__Raw.All#canCall| |oe2#1| |p#0|)))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@3|)) (let ((|es#1@@0| (AST.Expr__Raw.es |e#0@@3|)))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@1) |e#0@@3| |p#0|)  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@1 |p#0| ($Box DatatypeTypeType |e#0@@3|)))) (ite (AST.Expr__Raw.Var_q |e#0@@3|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q |e#0@@3|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q |e#0@@3|) (let ((|body#0@@0| (AST.Expr__Raw.body |e#0@@3|)))
...
)) (AST.Expr__Raw.All $ly@@1 |body#0@@0| |p#0|)))) (ite (AST.Expr__Raw.Assign_q |e#0@@3|) (let ((|avals#0@@1| (AST.Expr__Raw.avals |e#0@@3|)))
...
(let ((|cond#0@@0| (AST.Expr__Raw.cond |e#0@@3|)))
 (and (and (AST.Expr__Raw.All $ly@@1 |cond#0@@0| |p#0|) (AST.Expr__Raw.All $ly@@1 |thn#0@@0| |p#0|)) (AST.Expr__Raw.All $ly@@1 |els#0@@0| |p#0|))))) (ite (AST.Expr__Raw.Op_q |e#0@@3|) (let ((|oe2#0| (AST.Expr__Raw.oe2 |e#0@@3|)))
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@3|)))
 (and (AST.Expr__Raw.All $ly@@1 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@1 |oe2#0| |p#0|)))) (let ((|es#0@@3| (AST.Expr__Raw.es |e#0@@3|)))
 ...
 :qid |ASTdfy.44:22|
 :skolemid |1150|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@1) |e#0@@3| |p#0|) ($IsGoodHeap $Heap@@1))
)))
(assert (forall ((d@@26 T@U) ) (!  (=> (Utils.Result.Failure_q d@@26) (= d@@26 |#Utils.Result.Failure|))
 :qid |unknown.0:0|
 :skolemid |970|
 :pattern ( (Utils.Result.Failure_q d@@26))
)))
...
(assert (forall ((d@@31 T@U) ) (!  (=> (AST.Expr__Raw.Var_q d@@31) (exists ((|a#23#0#0| T@U) ) (! (= d@@31 (|#AST.Expr_Raw.Var| |a#23#0#0|))
 :qid |ASTdfy.15:11|
 :skolemid |1029|
)))
 :qid |unknown.0:0|
 :skolemid |1030|
 :pattern ( (AST.Expr__Raw.Var_q d@@31))
)))
(assert (forall ((d@@32 T@U) ) (!  (=> (AST.Expr__Raw.Literal_q d@@32) (exists ((|a#30#0#0| Int) ) (! (= d@@32 (|#AST.Expr_Raw.Literal| |a#30#0#0|))
 :qid |ASTdfy.16:15|
 :skolemid |1039|
)))
 :qid |unknown.0:0|
 :skolemid |1040|
 :pattern ( (AST.Expr__Raw.Literal_q d@@32))
)))
(assert (forall ((d@@33 T@U) ) (!  (=> (AST.Expr__Raw.Seq_q d@@33) (exists ((|a#77#0#0| T@U) ) (! (= d@@33 (|#AST.Expr_Raw.Seq| |a#77#0#0|))
 :qid |ASTdfy.21:11|
 :skolemid |1108|
)))
 :qid |unknown.0:0|
 :skolemid |1109|
 :pattern ( (AST.Expr__Raw.Seq_q d@@33))
)))
(assert (forall ((d@@34 T@U) ) (!  (=> ($Is DatatypeTypeType d@@34 Tclass.AST.Expr__Raw) (or (or (or (or (or (or (AST.Expr__Raw.Var_q d@@34) (AST.Expr__Raw.Literal_q d@@34)) (AST.Expr__Raw.Bind_q d@@34)) (AST.Expr__Raw.Assign_q d@@34)) (AST.Expr__Raw.If_q d@@34)) (AST.Expr__Raw.Op_q d@@34)) (AST.Expr__Raw.Seq_q d@@34)))
 :qid |unknown.0:0|
 :skolemid |1118|
 :pattern ( (AST.Expr__Raw.Seq_q d@@34) ($Is DatatypeTypeType d@@34 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Op_q d@@34) ($Is DatatypeTypeType d@@34 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.If_q d@@34) ($Is DatatypeTypeType d@@34 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Assign_q d@@34) ($Is DatatypeTypeType d@@34 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Bind_q d@@34) ($Is DatatypeTypeType d@@34 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Literal_q d@@34) ($Is DatatypeTypeType d@@34 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Var_q d@@34) ($Is DatatypeTypeType d@@34 Tclass.AST.Expr__Raw))
)))
...
(assert (forall (($ly@@2 T@U) (|es#0@@4| T@U) (|ctx#0@@2| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@4| |ctx#0@@2|) (and ($Is SeqType |es#0@@4| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@2| (TMap (TSeq TChar) TInt)))) (and (=> (Utils.Result.Success_q (Interp.__default.InterpExprs $ly@@2 |es#0@@4| |ctx#0@@2|)) (= (|Seq#Length| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs $ly@@2 |es#0@@4| |ctx#0@@2|)))))) (|Seq#Length| |es#0@@4|))) ($Is DatatypeTypeType (Interp.__default.InterpExprs $ly@@2 |es#0@@4| |ctx#0@@2|) (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))
 :qid |Interpdfy.69:12|
 :skolemid |1205|
 :pattern ( (Interp.__default.InterpExprs $ly@@2 |es#0@@4| |ctx#0@@2|))
)))
...
(assert (forall (($ly@@3 T@U) (|e#0@@4| T@U) (|p#0@@0| T@U) ) (! (= (AST.Expr__Raw.All ($LS $ly@@3) |e#0@@4| |p#0@@0|) (AST.Expr__Raw.All $ly@@3 |e#0@@4| |p#0@@0|))
 :qid |ASTdfy.44:22|
 :skolemid |1139|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@3) |e#0@@4| |p#0@@0|))
)))
...
(assert (forall ((bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 Tclass.Equiv.VS) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@8)) bx@@8) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@8) Tclass.Equiv.VS)))
 :qid |unknown.0:0|
 :skolemid |720|
 :pattern ( ($IsBox bx@@8 Tclass.Equiv.VS))
)))
...
(assert (forall ((bx@@11 T@U) ) (!  (=> ($IsBox bx@@11 Tclass.Equiv.MSeqValue) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@11)) bx@@11) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@11) Tclass.Equiv.MSeqValue)))
 :qid |unknown.0:0|
 :skolemid |923|
 :pattern ( ($IsBox bx@@11 Tclass.Equiv.MSeqValue))
)))
...
(assert (forall (($ly@@4 T@U) (|e#0@@6| T@U) (|ctx#0@@4| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@6| |ctx#0@@4|) (and ($Is DatatypeTypeType |e#0@@6| Tclass.AST.Expr) ($Is MapType |ctx#0@@4| (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType (Interp.__default.InterpExpr $ly@@4 |e#0@@6| |ctx#0@@4|) (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))))
 :qid |Interpdfy.24:12|
 :skolemid |1198|
 :pattern ( (Interp.__default.InterpExpr $ly@@4 |e#0@@6| |ctx#0@@4|))
)))
(assert (forall (($ly@@5 T@U) (|e#0@@7| T@U) (|ctx#0@@5| T@U) ) (! (= (Interp.__default.InterpExpr ($LS $ly@@5) |e#0@@7| |ctx#0@@5|) (Interp.__default.InterpExpr $ly@@5 |e#0@@7| |ctx#0@@5|))
 :qid |Interpdfy.24:12|
 :skolemid |1196|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@5) |e#0@@7| |ctx#0@@5|))
)))
(assert (forall (($ly@@6 T@U) (|es#0@@5| T@U) (|ctx#0@@6| T@U) ) (! (= (Interp.__default.InterpExprs ($LS $ly@@6) |es#0@@5| |ctx#0@@6|) (Interp.__default.InterpExprs $ly@@6 |es#0@@5| |ctx#0@@6|))
 :qid |Interpdfy.69:12|
 :skolemid |1203|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@6) |es#0@@5| |ctx#0@@6|))
)))
(assert (forall (($ly@@7 T@U) (|vars#0@@3| T@U) (|values#0| T@U) ) (! (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@7) |vars#0@@3| |values#0|) (Interp.__default.VarsAndValuesToContext $ly@@7 |vars#0@@3| |values#0|))
 :qid |Interpdfy.80:12|
 :skolemid |1210|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@7) |vars#0@@3| |values#0|))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|e#0@@8| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| |st#0@@8| (Lit DatatypeTypeType |e#0@@8|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@8| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@8|) (=> (Equiv.__default.Inv |st#0@@8|) (and (Equiv.MState.MState_q |st#0@@8|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@8|) (Equiv.MState.ctx |st#0@@8|))))) (= (Equiv.__default.P__Fail |st#0@@8| (Lit DatatypeTypeType |e#0@@8|))  (=> (Equiv.__default.Inv |st#0@@8|) (Utils.Result.Failure_q (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@8|) (Equiv.MState.ctx |st#0@@8|)))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |707|
 :pattern ( (Equiv.__default.P__Fail |st#0@@8| (Lit DatatypeTypeType |e#0@@8|)))
))))
(assert (forall (($ly@@8 T@U) (|vars#0@@4| T@U) (|values#0@@0| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@4| |values#0@@0|) (and (and ($Is SeqType |vars#0@@4| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@0| (TSeq TInt))) (= (|Seq#Length| |vars#0@@4|) (|Seq#Length| |values#0@@0|)))) (and (|Set#Equal| (|Map#Domain| (Interp.__default.VarsAndValuesToContext $ly@@8 |vars#0@@4| |values#0@@0|)) (|Set#FromBoogieMap| (|lambda#9| (TSeq TChar) |vars#0@@4|))) ($Is MapType (Interp.__default.VarsAndValuesToContext $ly@@8 |vars#0@@4| |values#0@@0|) (TMap (TSeq TChar) TInt))))
 :qid |Interpdfy.80:12|
 :skolemid |1212|
 :pattern ( (Interp.__default.VarsAndValuesToContext $ly@@8 |vars#0@@4| |values#0@@0|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@9| T@U) (|es#0@@6| T@U) (|st'#0@@0| T@U) (|vs#0@@1| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Succ#canCall| |st#0@@9| |es#0@@6| |st'#0@@0| |vs#0@@1|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@9| Tclass.Equiv.MState) ($Is SeqType |es#0@@6| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@0| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#0@@1| Tclass.Equiv.VS)))) (and (and (and (Equiv.MState.MState_q |st#0@@9|) (|Interp.__default.InterpExprs#canCall| |es#0@@6| (Equiv.MState.ctx |st#0@@9|))) (let ((|res#0@@0| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@6| (Equiv.MState.ctx |st#0@@9|))))
 (and (and (Equiv.MState.MState_q |st#0@@9|) (|Interp.__default.InterpExprs#canCall| |es#0@@6| (Equiv.MState.ctx_k |st#0@@9|))) (let ((|res'#0@@0| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@6| (Equiv.MState.ctx_k |st#0@@9|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@9|) (=> (Equiv.__default.Inv |st#0@@9|) (and (|Equiv.__default.EqResultSeq#canCall| |res#0@@0| |res'#0@@0|) (=> (Equiv.__default.EqResultSeq |res#0@@0| |res'#0@@0|) (and (and (|$IsA#Utils.Result| |res#0@@0|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@1|) (Equiv.MState.MState_q |st'#0@@0|))) (=> (|Utils.Result#Equal| |res#0@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@1|)) ($Box MapType (Equiv.MState.ctx |st'#0@@0|)))))) (and (|$IsA#Utils.Result| |res'#0@@0|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@1|) (Equiv.MState.MState_q |st'#0@@0|))))))))))))) (= (Equiv.__default.Pes__Succ |st#0@@9| |es#0@@6| |st'#0@@0| |vs#0@@1|) (let ((|res#0@@1| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@6| (Equiv.MState.ctx |st#0@@9|))))
(let ((|res'#0@@1| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@6| (Equiv.MState.ctx_k |st#0@@9|))))
 (and (and (and (Equiv.__default.Inv |st#0@@9|) (Equiv.__default.EqResultSeq |res#0@@1| |res'#0@@1|)) (|Utils.Result#Equal| |res#0@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@1|)) ($Box MapType (Equiv.MState.ctx |st'#0@@0|))))))) (|Utils.Result#Equal| |res'#0@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs_k |vs#0@@1|)) ($Box MapType (Equiv.MState.ctx_k |st'#0@@0|))))))))))))
 :qid |Inductiondfy.40:28|
 :skolemid |723|
 :pattern ( (Equiv.__default.Pes__Succ |st#0@@9| |es#0@@6| |st'#0@@0| |vs#0@@1|))
))))
...
(assert (forall (($ly@@9 T@U) (|es#0@@7| T@U) (|ctx#0@@8| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@7| |ctx#0@@8|) (and ($Is SeqType |es#0@@7| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@8| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@7| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@7| (LitInt 0))) |ctx#0@@8|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@9 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@7| (LitInt 0))) |ctx#0@@8|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (|Seq#Drop| |es#0@@7| (LitInt 1)) |ctx1#0@@1|) (let ((|valueOrError1#0@@0| (Interp.__default.InterpExprs $ly@@9 (|Seq#Drop| |es#0@@7| (LitInt 1)) |ctx1#0@@1|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@9) |es#0@@7| |ctx#0@@8|) (ite (|Seq#Equal| |es#0@@7| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@8|)))) (let ((|valueOrError0#0@@1| (Interp.__default.InterpExpr $ly@@9 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@7| (LitInt 0))) |ctx#0@@8|)))
...
(let ((|valueOrError1#0@@1| (Interp.__default.InterpExprs $ly@@9 (|Seq#Drop| |es#0@@7| (LitInt 1)) |ctx1#0@@2|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0|))) |vs#0@@2|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1207|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@9) |es#0@@7| |ctx#0@@8|))
)))
(assert (forall ((d@@35 T@U) ) (!  (=> (|$IsA#Utils.Result| d@@35) (or (Utils.Result.Success_q d@@35) (Utils.Result.Failure_q d@@35)))
 :qid |unknown.0:0|
 :skolemid |973|
 :pattern ( (|$IsA#Utils.Result| d@@35))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@10| T@U) (|es#0@@8| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Fail#canCall| |st#0@@10| (Lit SeqType |es#0@@8|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@10| Tclass.Equiv.MState) ($Is SeqType |es#0@@8| (TSeq Tclass.AST.Expr))))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@10|) (=> (Equiv.__default.Inv |st#0@@10|) (and (Equiv.MState.MState_q |st#0@@10|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@8|) (Equiv.MState.ctx |st#0@@10|))))) (= (Equiv.__default.Pes__Fail |st#0@@10| (Lit SeqType |es#0@@8|))  (=> (Equiv.__default.Inv |st#0@@10|) (Utils.Result.Failure_q (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@8|) (Equiv.MState.ctx |st#0@@10|)))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |733|
 :pattern ( (Equiv.__default.Pes__Fail |st#0@@10| (Lit SeqType |es#0@@8|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@11| T@U) (|es#0@@9| T@U) (|st'#0@@1| T@U) (|vs#0@@3| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Succ#canCall| (Lit DatatypeTypeType |st#0@@11|) (Lit SeqType |es#0@@9|) (Lit DatatypeTypeType |st'#0@@1|) (Lit DatatypeTypeType |vs#0@@3|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@11| Tclass.Equiv.MState) ($Is SeqType |es#0@@9| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@1| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#0@@3| Tclass.Equiv.VS)))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@11|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@9|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@11|))))) (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@9|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@11|)))))))
 (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@11|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@9|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@11|))))) (let ((|res'#2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@9|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@11|)))))))
 (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@11|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@11|))))) (and (|Equiv.__default.EqResultSeq#canCall| |res#2| |res'#2|) (=> (Equiv.__default.EqResultSeq |res#2| |res'#2|) (and (and (|$IsA#Utils.Result| |res#2|) (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |vs#0@@3|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st'#0@@1|)))) (=> (|Utils.Result#Equal| |res#2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |vs#0@@3|)))) ($Box MapType (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st'#0@@1|))))))))) (and (|$IsA#Utils.Result| |res'#2|) (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |vs#0@@3|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st'#0@@1|)))))))))))))) (= (Equiv.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@11|) (Lit SeqType |es#0@@9|) (Lit DatatypeTypeType |st'#0@@1|) (Lit DatatypeTypeType |vs#0@@3|)) (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@9|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@11|)))))))
(let ((|res'#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@9|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@11|)))))))
 (and (and (and (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@11|)) (Equiv.__default.EqResultSeq |res#2@@0| |res'#2@@0|)) (|Utils.Result#Equal| |res#2@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |vs#0@@3|)))) ($Box MapType (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st'#0@@1|)))))))))) (|Utils.Result#Equal| |res'#2@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType (Equiv.MSeqValue.vs_k (Lit DatatypeTypeType |vs#0@@3|)))) ($Box MapType (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st'#0@@1|)))))))))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |725|
 :pattern ( (Equiv.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@11|) (Lit SeqType |es#0@@9|) (Lit DatatypeTypeType |st'#0@@1|) (Lit DatatypeTypeType |vs#0@@3|)))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@12| T@U) (|vars#0@@5| T@U) (|argvs#0| T@U) ) (!  (=> (or (|Equiv.__default.UpdateState__Pre#canCall| |st#0@@12| |vars#0@@5| |argvs#0|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@12| Tclass.Equiv.MState) ($Is SeqType |vars#0@@5| (TSeq (TSeq TChar)))) ($Is DatatypeTypeType |argvs#0| Tclass.Equiv.VS)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@12|) (=> (Equiv.__default.Inv |st#0@@12|) (and (Equiv.MSeqValue.MSeqValue_q |argvs#0|) (=> (= (|Seq#Length| |vars#0@@5|) (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0|))) (and (and (Equiv.MSeqValue.MSeqValue_q |argvs#0|) (Equiv.MSeqValue.MSeqValue_q |argvs#0|)) (=> (= (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0|)) (|Seq#Length| (Equiv.MSeqValue.vs_k |argvs#0|))) (and (and (Equiv.MSeqValue.MSeqValue_q |argvs#0|) (Equiv.MSeqValue.MSeqValue_q |argvs#0|)) (|Equiv.__default.EqSeqValue#canCall| (Equiv.MSeqValue.vs |argvs#0|) (Equiv.MSeqValue.vs_k |argvs#0|))))))))) (= (Equiv.__default.UpdateState__Pre |st#0@@12| |vars#0@@5| |argvs#0|)  (and (and (Equiv.__default.Inv |st#0@@12|) (and (= (|Seq#Length| |vars#0@@5|) (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0|))) (= (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0|)) (|Seq#Length| (Equiv.MSeqValue.vs_k |argvs#0|))))) (Equiv.__default.EqSeqValue (Equiv.MSeqValue.vs |argvs#0|) (Equiv.MSeqValue.vs_k |argvs#0|))))))
 :qid |Inductiondfy.51:35|
 :skolemid |748|
 :pattern ( (Equiv.__default.UpdateState__Pre |st#0@@12| |vars#0@@5| |argvs#0|))
))))
...
(assert (forall (($ly@@10 T@U) (|es#0@@10| T@U) (|ctx#0@@9| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@10|) |ctx#0@@9|) (and ($Is SeqType |es#0@@10| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@9| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@10| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@10|) (LitInt 0))) |ctx#0@@9|) (let ((|valueOrError0#1@@0| (Interp.__default.InterpExpr ($LS $ly@@10) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@10|) (LitInt 0))) |ctx#0@@9|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@10|) (LitInt 1))) |ctx1#1@@0|) (let ((|valueOrError1#1@@0| (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@10|) (LitInt 1))) |ctx1#1@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType |es#0@@10|) |ctx#0@@9|) (ite (|Seq#Equal| |es#0@@10| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@9|)))) (let ((|valueOrError0#1@@1| (Interp.__default.InterpExpr ($LS $ly@@10) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@10|) (LitInt 0))) |ctx#0@@9|)))
...
(let ((|valueOrError1#1@@1| (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@10|) (LitInt 1))) |ctx1#1@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#1|))) |vs#1@@0|)) ($Box MapType |ctx2#1@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |1208|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType |es#0@@10|) |ctx#0@@9|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@13| T@U) (|vars#0@@6| T@U) (|vals#0@@3| T@U) ) (!  (=> (or (|Equiv.__default.AssignState#canCall| (Lit DatatypeTypeType |st#0@@13|) (Lit SeqType |vars#0@@6|) (Lit DatatypeTypeType |vals#0@@3|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@13| Tclass.Equiv.MState) ($Is SeqType |vars#0@@6| (TSeq (TSeq TChar)))) ($Is DatatypeTypeType |vals#0@@3| Tclass.Equiv.VS)) (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.UpdateState__Pre (Lit DatatypeTypeType |st#0@@13|) (Lit SeqType |vars#0@@6|) (Lit DatatypeTypeType |vals#0@@3|)))))))) (and (and (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |vals#0@@3|)) (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@6|) (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |vals#0@@3|))))) (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |vals#0@@3|)) (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@6|) (Lit SeqType (Equiv.MSeqValue.vs_k (Lit DatatypeTypeType |vals#0@@3|)))))) (= (Equiv.__default.AssignState (Lit DatatypeTypeType |st#0@@13|) (Lit SeqType |vars#0@@6|) (Lit DatatypeTypeType |vals#0@@3|)) (let ((|ctx'#2@@0| (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@13|))))
(let ((|ctx#2@@0| (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@13|))))
(let ((|bindings#2@@0| (Lit MapType (Interp.__default.VarsAndValuesToContext ($LS $LZ) (Lit SeqType |vars#0@@6|) (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |vals#0@@3|)))))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|res#0@@2| T@U) (|res'#0@@2| T@U) ) (!  (=> (or (|Equiv.__default.EqResultSeq#canCall| |res#0@@2| |res'#0@@2|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |res#0@@2| (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType |res'#0@@2| (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))) (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))))) (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))))) (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|)))))))) (let ((|ctx'#1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))))))))))
 ...
 (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|)))))))) (let ((|vs#1@@1| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))))))))))
 (and (|Equiv.__default.EqSeqValue#canCall| |vs#1@@1| |vs'#1|) (=> (Equiv.__default.EqSeqValue |vs#1@@1| |vs'#1|) (|Equiv.__default.EqCtx#canCall| |ctx#1| |ctx'#1|))))))))))))))) (= (Equiv.__default.EqResultSeq |res#0@@2| |res'#0@@2|) (ite (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))))) (ite (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))))) (let ((|ctx'#0@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))))))))))
(let ((|vs'#0| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))))))))))
(let ((|ctx#0@@10| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))))))))))
(let ((|vs#0@@4| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))))))))))
 (and (Equiv.__default.EqSeqValue |vs#0@@4| |vs'#0|) (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#0@@10| |ctx'#0@@2|)))))) false) true))))
 :qid |Equivdfy.45:31|
 :skolemid |673|
 :pattern ( (Equiv.__default.EqResultSeq |res#0@@2| |res'#0@@2|))
))))
...
(assert (forall ((v@@6 T@U) (t0@@5 T@U) (h@@2 T@U) ) (! (= ($IsAlloc SetType v@@6 (TSet t0@@5) h@@2) (forall ((bx@@15 T@U) ) (!  (=> (|Set#IsMember| v@@6 bx@@15) ($IsAllocBox bx@@15 t0@@5 h@@2))
 :qid |DafnyPreludebpl.299:11|
 :skolemid |67|
 :pattern ( (|Set#IsMember| v@@6 bx@@15))
)))
...
(assert (forall ((|e#0@@9| T@U) ) (!  (=> ($Is DatatypeTypeType |e#0@@9| Tclass.AST.Expr__Raw) (= (|AST.Expr__Raw.WellFormed__Single#requires| |e#0@@9|) true))
 :qid |ASTdfy.71:46|
 :skolemid |1179|
 :pattern ( (|AST.Expr__Raw.WellFormed__Single#requires| |e#0@@9|))
)))
...
(assert (forall (($ly@@11 T@U) (|e#0@@10| T@U) (|ctx#0@@11| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@10|) (Lit MapType |ctx#0@@11|)) (and ($Is DatatypeTypeType |e#0@@10| Tclass.AST.Expr) ($Is MapType |ctx#0@@11| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@10|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@10|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@10|))))) (let ((|body#5| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|bvals#5| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|bvars#5| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@10|)))))
...
(let ((|ctx2#10| (|Map#Merge| |ctx1#20| |bindings#10|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|))))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@10|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@10|))))) (let ((|avals#5| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|avars#5| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@10|)))))
...
(|Interp.__default.VarsAndValuesToContext#canCall| |avars#5| |vs#16|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@10|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@10|))))) (let ((|els#5| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|thn#5| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|cond#5| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@10|)))))
...
(let ((|condv#5| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError3#5|)))))))
 (and (=> (or (not (= |condv#5| 0)) (not true)) (|Interp.__default.InterpExpr#canCall| |thn#5| |ctx_cond#5|)) (=> (= |condv#5| 0) (|Interp.__default.InterpExpr#canCall| |els#5| |ctx_cond#5|)))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@10|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@10|))))) (let ((|e2#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|e1#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|op#5| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@10|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#5| |v1#5| |v2#5|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@10|)))))) (let ((|es#5| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@10|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |bodyv#4|)) ($Box MapType |ctx4#4|)))))))))))))))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@10|)) (let ((|avals#4| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|avars#4| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@10|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType (|Map#Merge| |ctx1#17| |bindings#9|)))))))))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@10|)) (let ((|els#4| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|thn#4| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|cond#4| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@10|)))))
...
(ite  (or (not (= |condv#4| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@11) |thn#4| |ctx_cond#4|) (Interp.__default.InterpExpr ($LS $ly@@11) |els#4| |ctx_cond#4|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@10|)) (let ((|e2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|e1#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|op#4| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@10|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#4| |v1#4| |v2#4|))) ($Box MapType |ctx2#9|))))))))))))))) (let ((|es#4| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@10|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1202|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@11) (Lit DatatypeTypeType |e#0@@10|) (Lit MapType |ctx#0@@11|)))
)))
...
(assert (forall ((v@@8 T@U) (t0@@7 T@U) (t1@@4 T@U) (h@@4 T@U) ) (! (= ($IsAlloc MapType v@@8 (TMap t0@@7 t1@@4) h@@4) (forall ((bx@@16 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@8) bx@@16) (and ($IsAllocBox (MapType0Select BoxType BoxType (|Map#Elements| v@@8) bx@@16) t1@@4 h@@4) ($IsAllocBox bx@@16 t0@@7 h@@4)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@14| T@U) (|es#0@@11| T@U) (|st'#0@@2| T@U) (|vs#0@@5| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Succ#canCall| |st#0@@14| (Lit SeqType |es#0@@11|) |st'#0@@2| |vs#0@@5|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@14| Tclass.Equiv.MState) ($Is SeqType |es#0@@11| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@2| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#0@@5| Tclass.Equiv.VS)))) (and (and (and (Equiv.MState.MState_q |st#0@@14|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@11|) (Equiv.MState.ctx |st#0@@14|))) (let ((|res#1@@1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) (Equiv.MState.ctx |st#0@@14|))))
 (and (and (Equiv.MState.MState_q |st#0@@14|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@11|) (Equiv.MState.ctx_k |st#0@@14|))) (let ((|res'#1@@1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) (Equiv.MState.ctx_k |st#0@@14|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@14|) (=> (Equiv.__default.Inv |st#0@@14|) (and (|Equiv.__default.EqResultSeq#canCall| |res#1@@1| |res'#1@@1|) (=> (Equiv.__default.EqResultSeq |res#1@@1| |res'#1@@1|) (and (and (|$IsA#Utils.Result| |res#1@@1|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@5|) (Equiv.MState.MState_q |st'#0@@2|))) (=> (|Utils.Result#Equal| |res#1@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@5|)) ($Box MapType (Equiv.MState.ctx |st'#0@@2|)))))) (and (|$IsA#Utils.Result| |res'#1@@1|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@5|) (Equiv.MState.MState_q |st'#0@@2|))))))))))))) (= (Equiv.__default.Pes__Succ |st#0@@14| (Lit SeqType |es#0@@11|) |st'#0@@2| |vs#0@@5|) (let ((|res#1@@2| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) (Equiv.MState.ctx |st#0@@14|))))
(let ((|res'#1@@2| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) (Equiv.MState.ctx_k |st#0@@14|))))
 (and (and (and (Equiv.__default.Inv |st#0@@14|) (Equiv.__default.EqResultSeq |res#1@@2| |res'#1@@2|)) (|Utils.Result#Equal| |res#1@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@5|)) ($Box MapType (Equiv.MState.ctx |st'#0@@2|))))))) (|Utils.Result#Equal| |res'#1@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs_k |vs#0@@5|)) ($Box MapType (Equiv.MState.ctx_k |st'#0@@2|))))))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |724|
 :pattern ( (Equiv.__default.Pes__Succ |st#0@@14| (Lit SeqType |es#0@@11|) |st'#0@@2| |vs#0@@5|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@15| T@U) (|vars#0@@8| T@U) (|vals#0@@4| T@U) ) (!  (=> (or (|Equiv.__default.BindStartScope#canCall| |st#0@@15| (Lit SeqType |vars#0@@8|) |vals#0@@4|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@15| Tclass.Equiv.MState) ($Is SeqType |vars#0@@8| (TSeq (TSeq TChar)))) ($Is DatatypeTypeType |vals#0@@4| Tclass.Equiv.VS)) (Equiv.__default.UpdateState__Pre |st#0@@15| (Lit SeqType |vars#0@@8|) |vals#0@@4|)))) (and (|Equiv.__default.AssignState#canCall| |st#0@@15| (Lit SeqType |vars#0@@8|) |vals#0@@4|) (= (Equiv.__default.BindStartScope |st#0@@15| (Lit SeqType |vars#0@@8|) |vals#0@@4|) (Equiv.__default.AssignState |st#0@@15| (Lit SeqType |vars#0@@8|) |vals#0@@4|))))
 :qid |Inductiondfy.58:33|
 :weight 3
 :skolemid |776|
 :pattern ( (Equiv.__default.BindStartScope |st#0@@15| (Lit SeqType |vars#0@@8|) |vals#0@@4|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@16| T@U) (|es#0@@12| T@U) ) (!  (=> (or (|Equiv.__default.Pes#canCall| |st#0@@16| |es#0@@12|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@16| Tclass.Equiv.MState) ($Is SeqType |es#0@@12| (TSeq Tclass.AST.Expr))))) (and (and (and (Equiv.MState.MState_q |st#0@@16|) (|Interp.__default.InterpExprs#canCall| |es#0@@12| (Equiv.MState.ctx |st#0@@16|))) (let ((|res#0@@3| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@12| (Equiv.MState.ctx |st#0@@16|))))
 (and (and (Equiv.MState.MState_q |st#0@@16|) (|Interp.__default.InterpExprs#canCall| |es#0@@12| (Equiv.MState.ctx_k |st#0@@16|))) (let ((|res'#0@@3| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@12| (Equiv.MState.ctx_k |st#0@@16|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@16|) (=> (Equiv.__default.Inv |st#0@@16|) (|Equiv.__default.EqResultSeq#canCall| |res#0@@3| |res'#0@@3|))))))) (= (Equiv.__default.Pes |st#0@@16| |es#0@@12|) (let ((|res#0@@4| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@12| (Equiv.MState.ctx |st#0@@16|))))
(let ((|res'#0@@4| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@12| (Equiv.MState.ctx_k |st#0@@16|))))
 (=> (Equiv.__default.Inv |st#0@@16|) (Equiv.__default.EqResultSeq |res#0@@4| |res'#0@@4|)))))))
 :qid |Inductiondfy.39:23|
 :skolemid |713|
 :pattern ( (Equiv.__default.Pes |st#0@@16| |es#0@@12|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@17| T@U) (|e#0@@11| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| (Lit DatatypeTypeType |st#0@@17|) (Lit DatatypeTypeType |e#0@@11|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@17| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@11| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@17|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@17|))))) (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@17|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@11|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@17|))))))) (= (Equiv.__default.P__Fail (Lit DatatypeTypeType |st#0@@17|) (Lit DatatypeTypeType |e#0@@11|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@17|)) (Utils.Result.Failure_q (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@11|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@17|)))))))))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |708|
 :pattern ( (Equiv.__default.P__Fail (Lit DatatypeTypeType |st#0@@17|) (Lit DatatypeTypeType |e#0@@11|)))
))))
...
(assert (forall ((bx@@17 T@U) (s@@17 T@U) (t@@10 T@U) ) (!  (=> ($IsBox bx@@17 (TMap s@@17 t@@10)) (and (= ($Box MapType ($Unbox MapType bx@@17)) bx@@17) ($Is MapType ($Unbox MapType bx@@17) (TMap s@@17 t@@10))))
 :qid |DafnyPreludebpl.207:15|
 :skolemid |36|
 :pattern ( ($IsBox bx@@17 (TMap s@@17 t@@10)))
)))
(assert (forall ((|#$T0@@9| T@U) (|#$R@@9| T@U) (bx@@18 T@U) ) (!  (=> ($IsBox bx@@18 (Tclass._System.___hFunc1 |#$T0@@9| |#$R@@9|)) (and (= ($Box HandleTypeType ($Unbox HandleTypeType bx@@18)) bx@@18) ($Is HandleTypeType ($Unbox HandleTypeType bx@@18) (Tclass._System.___hFunc1 |#$T0@@9| |#$R@@9|))))
 :qid |unknown.0:0|
 :skolemid |369|
 :pattern ( ($IsBox bx@@18 (Tclass._System.___hFunc1 |#$T0@@9| |#$R@@9|)))
)))
(assert (forall ((|#$T0@@10| T@U) (|#$R@@10| T@U) (bx@@19 T@U) ) (!  (=> ($IsBox bx@@19 (Tclass._System.___hPartialFunc1 |#$T0@@10| |#$R@@10|)) (and (= ($Box HandleTypeType ($Unbox HandleTypeType bx@@19)) bx@@19) ($Is HandleTypeType ($Unbox HandleTypeType bx@@19) (Tclass._System.___hPartialFunc1 |#$T0@@10| |#$R@@10|))))
 :qid |unknown.0:0|
 :skolemid |400|
 :pattern ( ($IsBox bx@@19 (Tclass._System.___hPartialFunc1 |#$T0@@10| |#$R@@10|)))
)))
(assert (forall ((|#$T0@@11| T@U) (|#$R@@11| T@U) (bx@@20 T@U) ) (!  (=> ($IsBox bx@@20 (Tclass._System.___hTotalFunc1 |#$T0@@11| |#$R@@11|)) (and (= ($Box HandleTypeType ($Unbox HandleTypeType bx@@20)) bx@@20) ($Is HandleTypeType ($Unbox HandleTypeType bx@@20) (Tclass._System.___hTotalFunc1 |#$T0@@11| |#$R@@11|))))
 :qid |unknown.0:0|
 :skolemid |407|
 :pattern ( ($IsBox bx@@20 (Tclass._System.___hTotalFunc1 |#$T0@@11| |#$R@@11|)))
)))
(assert (forall ((|_System._tuple#2$T0@@4| T@U) (|_System._tuple#2$T1@@4| T@U) (bx@@21 T@U) ) (!  (=> ($IsBox bx@@21 (Tclass._System.Tuple2 |_System._tuple#2$T0@@4| |_System._tuple#2$T1@@4|)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@21)) bx@@21) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@21) (Tclass._System.Tuple2 |_System._tuple#2$T0@@4| |_System._tuple#2$T1@@4|))))
 :qid |unknown.0:0|
 :skolemid |455|
 :pattern ( ($IsBox bx@@21 (Tclass._System.Tuple2 |_System._tuple#2$T0@@4| |_System._tuple#2$T1@@4|)))
)))
...
(assert (forall ((d@@37 T@U) (Utils.Result$T@@14 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (Utils.Result.Success_q d@@37) ($IsAlloc DatatypeTypeType d@@37 (Tclass.Utils.Result Utils.Result$T@@14) $h@@6))) ($IsAllocBox (Utils.Result.value d@@37) Utils.Result$T@@14 $h@@6))
 :qid |unknown.0:0|
 :skolemid |965|
 :pattern ( ($IsAllocBox (Utils.Result.value d@@37) Utils.Result$T@@14 $h@@6))
)))
...
(assert (forall ((d@@38 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (AST.Expr__Raw.Literal_q d@@38) ($IsAlloc DatatypeTypeType d@@38 Tclass.AST.Expr__Raw $h@@7))) ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@38)) TInt $h@@7))
 :qid |unknown.0:0|
 :skolemid |1042|
 :pattern ( ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@38)) TInt $h@@7))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@18| T@U) (|es#0@@13| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Fail#canCall| (Lit DatatypeTypeType |st#0@@18|) (Lit SeqType |es#0@@13|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@18| Tclass.Equiv.MState) ($Is SeqType |es#0@@13| (TSeq Tclass.AST.Expr))))) (and (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@18|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@18|))))) (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@18|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@13|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@18|))))))) (= (Equiv.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@18|) (Lit SeqType |es#0@@13|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@18|)) (Utils.Result.Failure_q (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@13|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@18|)))))))))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |734|
 :pattern ( (Equiv.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@18|) (Lit SeqType |es#0@@13|)))
))))
(assert (forall (($ly@@13 T@U) (|e#0@@12| T@U) (|ctx#0@@12| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@12|) |ctx#0@@12|) (and ($Is DatatypeTypeType |e#0@@12| Tclass.AST.Expr) ($Is MapType |ctx#0@@12| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@12|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@12|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@12|))))) (let ((|body#3| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@12|)))))
(let ((|bvals#3| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@12|)))))
(let ((|bvars#3| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@12|)))))
...
(|Interp.__default.VarsAndValuesToContext#canCall| |avars#3| |vs#10|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@12|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@12|))))) (let ((|els#3| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@12|)))))
(let ((|thn#3| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@12|)))))
(let ((|cond#3| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@12|)))))
...
(let ((|condv#3| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError3#3|)))))))
 (and (=> (or (not (= |condv#3| 0)) (not true)) (|Interp.__default.InterpExpr#canCall| |thn#3| |ctx_cond#3|)) (=> (= |condv#3| 0) (|Interp.__default.InterpExpr#canCall| |els#3| |ctx_cond#3|)))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@12|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@12|))))) (let ((|e2#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@12|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#3| |v1#3| |v2#3|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@12|)))))) (let ((|es#3| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@12|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#3|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@13) (Lit DatatypeTypeType |e#0@@12|) |ctx#0@@12|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@12|)) (let ((|name#2| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@12|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#2|)) ($Box MapType |ctx#0@@12|))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@12|)) (let ((|body#2| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@12|)))))
(let ((|bvals#2@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@12|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |bodyv#2|)) ($Box MapType |ctx4#2|)))))))))))))))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@12|)) (let ((|avals#2@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@12|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType (|Map#Merge| |ctx1#9| |bindings#5|)))))))))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@12|)) (let ((|els#2| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@12|)))))
(let ((|thn#2| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@12|)))))
(let ((|cond#2| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@12|)))))
...
(ite  (or (not (= |condv#2| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@13) |thn#2| |ctx_cond#2|) (Interp.__default.InterpExpr ($LS $ly@@13) |els#2| |ctx_cond#2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@12|)) (let ((|e2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@12|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#2| |v1#2| |v2#2|))) ($Box MapType |ctx2#5|))))))))))))))) (let ((|es#2| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@12|)))))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1201|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@13) (Lit DatatypeTypeType |e#0@@12|) |ctx#0@@12|))
)))
(assert (forall ((bx@@22 T@U) (t@@11 T@U) ) (!  (=> ($IsBox bx@@22 (TSet t@@11)) (and (= ($Box SetType ($Unbox SetType bx@@22)) bx@@22) ($Is SetType ($Unbox SetType bx@@22) (TSet t@@11))))
 :qid |DafnyPreludebpl.195:15|
 :skolemid |32|
 :pattern ( ($IsBox bx@@22 (TSet t@@11)))
)))
(assert (forall ((bx@@23 T@U) (t@@12 T@U) ) (!  (=> ($IsBox bx@@23 (TSeq t@@12)) (and (= ($Box SeqType ($Unbox SeqType bx@@23)) bx@@23) ($Is SeqType ($Unbox SeqType bx@@23) (TSeq t@@12))))
 :qid |DafnyPreludebpl.204:15|
 :skolemid |35|
 :pattern ( ($IsBox bx@@23 (TSeq t@@12)))
)))
(assert (forall ((Utils.Result$T@@15 T@U) (bx@@24 T@U) ) (!  (=> ($IsBox bx@@24 (Tclass.Utils.Result Utils.Result$T@@15)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@24)) bx@@24) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@24) (Tclass.Utils.Result Utils.Result$T@@15))))
 :qid |unknown.0:0|
 :skolemid |664|
 :pattern ( ($IsBox bx@@24 (Tclass.Utils.Result Utils.Result$T@@15)))
)))
...
(assert (forall ((v@@12 T@U) (t0@@11 T@U) (t1@@8 T@U) ) (! (= ($Is MapType v@@12 (TMap t0@@11 t1@@8)) (forall ((bx@@25 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@12) bx@@25) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@12) bx@@25) t1@@8) ($IsBox bx@@25 t0@@11)))
 :qid |DafnyPreludebpl.261:19|
 :skolemid |55|
 :pattern ( (MapType0Select BoxType BoxType (|Map#Elements| v@@12) bx@@25))
 :pattern ( (|Set#IsMember| (|Map#Domain| v@@12) bx@@25))
)))
 :qid |DafnyPreludebpl.258:15|
 :skolemid |56|
 :pattern ( ($Is MapType v@@12 (TMap t0@@11 t1@@8)))
)))
(assert (forall (($ly@@14 T@U) (|vars#0@@9| T@U) (|values#0@@2| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@9|) (Lit SeqType |values#0@@2|)) (and (and ($Is SeqType |vars#0@@9| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@2| (TSeq TInt))) (= (|Seq#Length| (Lit SeqType |vars#0@@9|)) (|Seq#Length| (Lit SeqType |values#0@@2|))))) (and (=> (not (|Seq#Equal| |vars#0@@9| |Seq#Empty|)) (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |vars#0@@9|) (LitInt 1))) (Lit SeqType (|Seq#Drop| (Lit SeqType |values#0@@2|) (LitInt 1))))) (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@14) (Lit SeqType |vars#0@@9|) (Lit SeqType |values#0@@2|)) (ite (|Seq#Equal| |vars#0@@9| |Seq#Empty|) |Map#Empty| (|Map#Merge| (|Map#Build| |Map#Empty| (|Seq#Index| (Lit SeqType |vars#0@@9|) (LitInt 0)) (|Seq#Index| (Lit SeqType |values#0@@2|) (LitInt 0))) (Interp.__default.VarsAndValuesToContext ($LS $ly@@14) (Lit SeqType (|Seq#Drop| (Lit SeqType |vars#0@@9|) (LitInt 1))) (Lit SeqType (|Seq#Drop| (Lit SeqType |values#0@@2|) (LitInt 1)))))))))
 :qid |Interpdfy.80:12|
 :weight 3
 :skolemid |1215|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@14) (Lit SeqType |vars#0@@9|) (Lit SeqType |values#0@@2|)))
)))
...
(assert (forall ((d@@41 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) ($Is DatatypeTypeType d@@41 Tclass.Equiv.MState)) ($IsAlloc DatatypeTypeType d@@41 Tclass.Equiv.MState $h@@8))
 :qid |unknown.0:0|
 :skolemid |899|
 :pattern ( ($IsAlloc DatatypeTypeType d@@41 Tclass.Equiv.MState $h@@8))
)))
(assert (forall ((d@@42 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) ($Is DatatypeTypeType d@@42 Tclass.Equiv.MSeqValue)) ($IsAlloc DatatypeTypeType d@@42 Tclass.Equiv.MSeqValue $h@@9))
 :qid |unknown.0:0|
 :skolemid |934|
 :pattern ( ($IsAlloc DatatypeTypeType d@@42 Tclass.Equiv.MSeqValue $h@@9))
)))
(assert (forall ((d@@43 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) ($Is DatatypeTypeType d@@43 Tclass.AST.BinOp)) ($IsAlloc DatatypeTypeType d@@43 Tclass.AST.BinOp $h@@10))
 :qid |unknown.0:0|
 :skolemid |1020|
 :pattern ( ($IsAlloc DatatypeTypeType d@@43 Tclass.AST.BinOp $h@@10))
)))
(assert (forall ((d@@44 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) ($Is DatatypeTypeType d@@44 Tclass.AST.Expr__Raw)) ($IsAlloc DatatypeTypeType d@@44 Tclass.AST.Expr__Raw $h@@11))
 :qid |unknown.0:0|
 :skolemid |1116|
 :pattern ( ($IsAlloc DatatypeTypeType d@@44 Tclass.AST.Expr__Raw $h@@11))
)))
...
(assert (forall ((d@@45 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (Equiv.MSeqValue.MSeqValue_q d@@45) ($IsAlloc DatatypeTypeType d@@45 Tclass.Equiv.MSeqValue $h@@12))) ($IsAlloc SeqType (Equiv.MSeqValue.vs d@@45) (TSeq TInt) $h@@12))
 :qid |unknown.0:0|
 :skolemid |925|
 :pattern ( ($IsAlloc SeqType (Equiv.MSeqValue.vs d@@45) (TSeq TInt) $h@@12))
)))
(assert (forall ((d@@46 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (Equiv.MSeqValue.MSeqValue_q d@@46) ($IsAlloc DatatypeTypeType d@@46 Tclass.Equiv.MSeqValue $h@@13))) ($IsAlloc SeqType (Equiv.MSeqValue.vs_k d@@46) (TSeq TInt) $h@@13))
 :qid |unknown.0:0|
 :skolemid |926|
 :pattern ( ($IsAlloc SeqType (Equiv.MSeqValue.vs_k d@@46) (TSeq TInt) $h@@13))
)))
(assert (forall ((d@@47 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (AST.Expr__Raw.Var_q d@@47) ($IsAlloc DatatypeTypeType d@@47 Tclass.AST.Expr__Raw $h@@14))) ($IsAlloc SeqType (AST.Expr__Raw.name d@@47) (TSeq TChar) $h@@14))
 :qid |unknown.0:0|
 :skolemid |1032|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.name d@@47) (TSeq TChar) $h@@14))
)))
(assert (forall (($ly@@15 T@U) ($Heap@@2 T@U) (|e#0@@13| T@U) (|p#0@@1| T@U) ) (!  (=> (or (|AST.Expr__Raw.All#canCall| (Lit DatatypeTypeType |e#0@@13|) |p#0@@1|) (and (and ($IsGoodHeap $Heap@@2) ($Is DatatypeTypeType |e#0@@13| Tclass.AST.Expr__Raw)) ($Is HandleTypeType |p#0@@1| (Tclass._System.___hTotalFunc1 Tclass.AST.Expr__Raw TBool)))) (and (=> (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@2 |p#0@@1| ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@13|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@13|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@13|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@13|))))) (let ((|body#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|bvals#3@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@13|)))))
...
)) (|AST.Expr__Raw.All#canCall| |body#3@@0| |p#0@@1|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@13|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@13|))))) (let ((|avals#3@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@13|)))))
...
))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@13|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@13|))))) (let ((|els#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|thn#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|cond#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@13|)))))
 (and (|AST.Expr__Raw.All#canCall| |cond#3@@0| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@15) |cond#3@@0| |p#0@@1|) (and (|AST.Expr__Raw.All#canCall| |thn#3@@0| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@15) |thn#3@@0| |p#0@@1|) (|AST.Expr__Raw.All#canCall| |els#3@@0| |p#0@@1|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@13|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@13|))))) (let ((|oe2#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|oe1#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@13|)))))
 (and (|AST.Expr__Raw.All#canCall| |oe1#3| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@15) |oe1#3| |p#0@@1|) (|AST.Expr__Raw.All#canCall| |oe2#3| |p#0@@1|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@13|)))))) (let ((|es#3@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@13|)))))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@15) (Lit DatatypeTypeType |e#0@@13|) |p#0@@1|)  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@2 |p#0@@1| ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@13|))))) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@13|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@13|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@13|)) (let ((|body#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|bvals#2@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@13|)))))
...
)) (AST.Expr__Raw.All ($LS $ly@@15) |body#2@@0| |p#0@@1|)))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@13|)) (let ((|avals#2@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@13|)))))
...
)))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@13|)) (let ((|els#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|thn#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|cond#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@13|)))))
 (and (and (AST.Expr__Raw.All ($LS $ly@@15) |cond#2@@0| |p#0@@1|) (AST.Expr__Raw.All ($LS $ly@@15) |thn#2@@0| |p#0@@1|)) (AST.Expr__Raw.All ($LS $ly@@15) |els#2@@0| |p#0@@1|))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@13|)) (let ((|oe2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|oe1#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@13|)))))
 (and (AST.Expr__Raw.All ($LS $ly@@15) |oe1#2| |p#0@@1|) (AST.Expr__Raw.All ($LS $ly@@15) |oe2#2| |p#0@@1|)))) (let ((|es#2@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@13|)))))
 ...
 :weight 3
 :skolemid |1158|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@15) (Lit DatatypeTypeType |e#0@@13|) |p#0@@1|) ($IsGoodHeap $Heap@@2))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@19| T@U) (|vars#0@@10| T@U) (|vals#0@@5| T@U) ) (!  (=> (or (|Equiv.__default.AssignState#canCall| |st#0@@19| (Lit SeqType |vars#0@@10|) |vals#0@@5|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@19| Tclass.Equiv.MState) ($Is SeqType |vars#0@@10| (TSeq (TSeq TChar)))) ($Is DatatypeTypeType |vals#0@@5| Tclass.Equiv.VS)) (Equiv.__default.UpdateState__Pre |st#0@@19| (Lit SeqType |vars#0@@10|) |vals#0@@5|)))) (and (and (and (Equiv.MSeqValue.MSeqValue_q |vals#0@@5|) (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@10|) (Equiv.MSeqValue.vs |vals#0@@5|))) (and (Equiv.MSeqValue.MSeqValue_q |vals#0@@5|) (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@10|) (Equiv.MSeqValue.vs_k |vals#0@@5|)))) (= (Equiv.__default.AssignState |st#0@@19| (Lit SeqType |vars#0@@10|) |vals#0@@5|) (let ((|ctx'#1@@0| (Equiv.MState.ctx_k |st#0@@19|)))
(let ((|ctx#1@@0| (Equiv.MState.ctx |st#0@@19|)))
(let ((|bindings#1@@0| (Interp.__default.VarsAndValuesToContext ($LS $LZ) (Lit SeqType |vars#0@@10|) (Equiv.MSeqValue.vs |vals#0@@5|))))
(let ((|bindings'#1| (Interp.__default.VarsAndValuesToContext ($LS $LZ) (Lit SeqType |vars#0@@10|) (Equiv.MSeqValue.vs_k |vals#0@@5|))))
(let ((|ctx1#1@@2| (|Map#Merge| |ctx#1@@0| |bindings#1@@0|)))
(let ((|ctx1'#1| (|Map#Merge| |ctx'#1@@0| |bindings'#1|)))
(let ((|st'#1| (|#Equiv.MState.MState| |ctx1#1@@2| |ctx1'#1|)))
|st'#1|))))))))))
 :qid |Inductiondfy.54:30|
 :weight 3
 :skolemid |763|
 :pattern ( (Equiv.__default.AssignState |st#0@@19| (Lit SeqType |vars#0@@10|) |vals#0@@5|))
))))
(assert (forall ((|a#5#0#0@@1| T@U) (|a#5#1#0@@0| T@U) (d@@48 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#5#0#0@@1|) ($Box DatatypeTypeType d@@48)) (< (DtRank d@@48) (DtRank (|#Equiv.MState.MState| |a#5#0#0@@1| |a#5#1#0@@0|))))
 :qid |Equivdfy.62:28|
 :skolemid |894|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#5#0#0@@1|) ($Box DatatypeTypeType d@@48)) (|#Equiv.MState.MState| |a#5#0#0@@1| |a#5#1#0@@0|))
)))
(assert (forall ((|a#8#0#0| T@U) (|a#8#1#0| T@U) (d@@49 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#8#1#0|) ($Box DatatypeTypeType d@@49)) (< (DtRank d@@49) (DtRank (|#Equiv.MState.MState| |a#8#0#0| |a#8#1#0|))))
 :qid |Equivdfy.62:28|
 :skolemid |897|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#8#1#0|) ($Box DatatypeTypeType d@@49)) (|#Equiv.MState.MState| |a#8#0#0| |a#8#1#0|))
)))
...
(assert (forall ((d@@50 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (Equiv.MState.MState_q d@@50) ($IsAlloc DatatypeTypeType d@@50 Tclass.Equiv.MState $h@@15))) ($IsAlloc MapType (Equiv.MState.ctx d@@50) (TMap (TSeq TChar) TInt) $h@@15))
 :qid |unknown.0:0|
 :skolemid |890|
 :pattern ( ($IsAlloc MapType (Equiv.MState.ctx d@@50) (TMap (TSeq TChar) TInt) $h@@15))
)))
(assert (forall ((d@@51 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (Equiv.MState.MState_q d@@51) ($IsAlloc DatatypeTypeType d@@51 Tclass.Equiv.MState $h@@16))) ($IsAlloc MapType (Equiv.MState.ctx_k d@@51) (TMap (TSeq TChar) TInt) $h@@16))
 :qid |unknown.0:0|
 :skolemid |891|
 :pattern ( ($IsAlloc MapType (Equiv.MState.ctx_k d@@51) (TMap (TSeq TChar) TInt) $h@@16))
)))
(assert (forall ((d@@52 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (_System.Tuple2.___hMake2_q d@@52) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@52 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@17)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@52 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@17))
)))) ($IsAllocBox (_System.Tuple2._0 d@@52) |_System._tuple#2$T0@@6| $h@@17))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@52) |_System._tuple#2$T0@@6| $h@@17))
)))
(assert (forall ((d@@53 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (_System.Tuple2.___hMake2_q d@@53) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@53 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@18)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@53 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@18))
)))) ($IsAllocBox (_System.Tuple2._1 d@@53) |_System._tuple#2$T1@@7| $h@@18))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@53) |_System._tuple#2$T1@@7| $h@@18))
)))
...
(assert (forall ((d@@54 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (AST.Expr__Raw.Bind_q d@@54) ($IsAlloc DatatypeTypeType d@@54 Tclass.AST.Expr__Raw $h@@19))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@54) Tclass.AST.Expr__Raw $h@@19))
 :qid |unknown.0:0|
 :skolemid |1052|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@54) Tclass.AST.Expr__Raw $h@@19))
)))
(assert (forall ((d@@55 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (AST.Expr__Raw.If_q d@@55) ($IsAlloc DatatypeTypeType d@@55 Tclass.AST.Expr__Raw $h@@20))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@55) Tclass.AST.Expr__Raw $h@@20))
 :qid |unknown.0:0|
 :skolemid |1081|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@55) Tclass.AST.Expr__Raw $h@@20))
)))
(assert (forall ((d@@56 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (AST.Expr__Raw.If_q d@@56) ($IsAlloc DatatypeTypeType d@@56 Tclass.AST.Expr__Raw $h@@21))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@56) Tclass.AST.Expr__Raw $h@@21))
 :qid |unknown.0:0|
 :skolemid |1082|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@56) Tclass.AST.Expr__Raw $h@@21))
)))
(assert (forall ((d@@57 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (AST.Expr__Raw.If_q d@@57) ($IsAlloc DatatypeTypeType d@@57 Tclass.AST.Expr__Raw $h@@22))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@57) Tclass.AST.Expr__Raw $h@@22))
 :qid |unknown.0:0|
 :skolemid |1083|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@57) Tclass.AST.Expr__Raw $h@@22))
)))
(assert (forall ((d@@58 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (AST.Expr__Raw.Op_q d@@58) ($IsAlloc DatatypeTypeType d@@58 Tclass.AST.Expr__Raw $h@@23))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@58) Tclass.AST.BinOp $h@@23))
 :qid |unknown.0:0|
 :skolemid |1096|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@58) Tclass.AST.BinOp $h@@23))
)))
(assert (forall ((d@@59 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (AST.Expr__Raw.Op_q d@@59) ($IsAlloc DatatypeTypeType d@@59 Tclass.AST.Expr__Raw $h@@24))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@59) Tclass.AST.Expr__Raw $h@@24))
 :qid |unknown.0:0|
 :skolemid |1097|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@59) Tclass.AST.Expr__Raw $h@@24))
)))
(assert (forall ((d@@60 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (AST.Expr__Raw.Op_q d@@60) ($IsAlloc DatatypeTypeType d@@60 Tclass.AST.Expr__Raw $h@@25))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@60) Tclass.AST.Expr__Raw $h@@25))
 :qid |unknown.0:0|
 :skolemid |1098|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@60) Tclass.AST.Expr__Raw $h@@25))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@20| T@U) (|es#0@@14| T@U) ) (!  (=> (or (|Equiv.__default.Pes#canCall| (Lit DatatypeTypeType |st#0@@20|) (Lit SeqType |es#0@@14|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@20| Tclass.Equiv.MState) ($Is SeqType |es#0@@14| (TSeq Tclass.AST.Expr))))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@20|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@14|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@20|))))) (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@14|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@20|)))))))
 (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@20|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@14|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@20|))))) (let ((|res'#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@14|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@20|)))))))
 (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@20|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@20|))))) (|Equiv.__default.EqResultSeq#canCall| |res#2@@1| |res'#2@@1|))))))) (= (Equiv.__default.Pes (Lit DatatypeTypeType |st#0@@20|) (Lit SeqType |es#0@@14|)) (U_2_bool (let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@14|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@20|)))))))
(let ((|res'#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@14|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@20|)))))))
(Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@20|)) (Equiv.__default.EqResultSeq |res#2@@2| |res'#2@@2|))))))))))
 :qid |Inductiondfy.39:23|
 :weight 3
 :skolemid |715|
 :pattern ( (Equiv.__default.Pes (Lit DatatypeTypeType |st#0@@20|) (Lit SeqType |es#0@@14|)))
))))
...
(assert (forall (($ly@@16 T@U) ($Heap@@4 T@U) (|e#0@@15| T@U) (|p#0@@2| T@U) ) (!  (=> (or (|AST.Expr__Raw.All#canCall| (Lit DatatypeTypeType |e#0@@15|) (Lit HandleTypeType |p#0@@2|)) (and (and ($IsGoodHeap $Heap@@4) ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr__Raw)) ($Is HandleTypeType |p#0@@2| (Tclass._System.___hTotalFunc1 Tclass.AST.Expr__Raw TBool)))) (and (=> (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@4 (Lit HandleTypeType |p#0@@2|) ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@15|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@15|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@15|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@15|))))) (let ((|body#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@15|)))))
...
(let ((|cond#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@15|)))))
 (and (|AST.Expr__Raw.All#canCall| |cond#5@@0| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@16) |cond#5@@0| (Lit HandleTypeType |p#0@@2|)) (and (|AST.Expr__Raw.All#canCall| |thn#5@@0| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@16) |thn#5@@0| (Lit HandleTypeType |p#0@@2|)) (|AST.Expr__Raw.All#canCall| |els#5@@0| (Lit HandleTypeType |p#0@@2|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@15|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@15|))))) (let ((|oe2#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|oe1#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@15|)))))
 (and (|AST.Expr__Raw.All#canCall| |oe1#5| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@16) |oe1#5| (Lit HandleTypeType |p#0@@2|)) (|AST.Expr__Raw.All#canCall| |oe2#5| (Lit HandleTypeType |p#0@@2|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@15|)))))) (let ((|es#5@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@15|)))))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@16) (Lit DatatypeTypeType |e#0@@15|) (Lit HandleTypeType |p#0@@2|))  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@4 (Lit HandleTypeType |p#0@@2|) ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@15|))))) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@15|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@15|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|body#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@15|)))))
...
)) (AST.Expr__Raw.All ($LS $ly@@16) |body#4@@0| (Lit HandleTypeType |p#0@@2|))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|avals#4@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@15|)))))
...
(Lit boolType (bool_2_U  (and (and (AST.Expr__Raw.All ($LS $ly@@16) |cond#4@@0| (Lit HandleTypeType |p#0@@2|)) (AST.Expr__Raw.All ($LS $ly@@16) |thn#4@@0| (Lit HandleTypeType |p#0@@2|))) (AST.Expr__Raw.All ($LS $ly@@16) |els#4@@0| (Lit HandleTypeType |p#0@@2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@15|)) (U_2_bool (let ((|oe2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@15|)))))
(let ((|oe1#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@15|)))))
(Lit boolType (bool_2_U  (and (AST.Expr__Raw.All ($LS $ly@@16) |oe1#4| (Lit HandleTypeType |p#0@@2|)) (AST.Expr__Raw.All ($LS $ly@@16) |oe2#4| (Lit HandleTypeType |p#0@@2|)))))))) (let ((|es#4@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@15|)))))
 ...
 :weight 3
 :skolemid |1166|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@16) (Lit DatatypeTypeType |e#0@@15|) (Lit HandleTypeType |p#0@@2|)) ($IsGoodHeap $Heap@@4))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@21| T@U) (|vars#0@@11| T@U) (|argvs#0@@0| T@U) ) (!  (=> (or (|Equiv.__default.UpdateState__Pre#canCall| |st#0@@21| (Lit SeqType |vars#0@@11|) |argvs#0@@0|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@21| Tclass.Equiv.MState) ($Is SeqType |vars#0@@11| (TSeq (TSeq TChar)))) ($Is DatatypeTypeType |argvs#0@@0| Tclass.Equiv.VS)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@21|) (=> (Equiv.__default.Inv |st#0@@21|) (and (Equiv.MSeqValue.MSeqValue_q |argvs#0@@0|) (=> (= (|Seq#Length| (Lit SeqType |vars#0@@11|)) (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0@@0|))) (and (and (Equiv.MSeqValue.MSeqValue_q |argvs#0@@0|) (Equiv.MSeqValue.MSeqValue_q |argvs#0@@0|)) (=> (= (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0@@0|)) (|Seq#Length| (Equiv.MSeqValue.vs_k |argvs#0@@0|))) (and (and (Equiv.MSeqValue.MSeqValue_q |argvs#0@@0|) (Equiv.MSeqValue.MSeqValue_q |argvs#0@@0|)) (|Equiv.__default.EqSeqValue#canCall| (Equiv.MSeqValue.vs |argvs#0@@0|) (Equiv.MSeqValue.vs_k |argvs#0@@0|))))))))) (= (Equiv.__default.UpdateState__Pre |st#0@@21| (Lit SeqType |vars#0@@11|) |argvs#0@@0|)  (and (and (Equiv.__default.Inv |st#0@@21|) (and (= (|Seq#Length| (Lit SeqType |vars#0@@11|)) (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0@@0|))) (= (|Seq#Length| (Equiv.MSeqValue.vs |argvs#0@@0|)) (|Seq#Length| (Equiv.MSeqValue.vs_k |argvs#0@@0|))))) (Equiv.__default.EqSeqValue (Equiv.MSeqValue.vs |argvs#0@@0|) (Equiv.MSeqValue.vs_k |argvs#0@@0|))))))
 :qid |Inductiondfy.51:35|
 :weight 3
 :skolemid |749|
 :pattern ( (Equiv.__default.UpdateState__Pre |st#0@@21| (Lit SeqType |vars#0@@11|) |argvs#0@@0|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@22| T@U) (|vars#0@@12| T@U) (|vals#0@@6| T@U) ) (!  (=> (or (|Equiv.__default.BindStartScope#canCall| (Lit DatatypeTypeType |st#0@@22|) (Lit SeqType |vars#0@@12|) (Lit DatatypeTypeType |vals#0@@6|)) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@22| Tclass.Equiv.MState) ($Is SeqType |vars#0@@12| (TSeq (TSeq TChar)))) ($Is DatatypeTypeType |vals#0@@6| Tclass.Equiv.VS)) (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.UpdateState__Pre (Lit DatatypeTypeType |st#0@@22|) (Lit SeqType |vars#0@@12|) (Lit DatatypeTypeType |vals#0@@6|)))))))) (and (|Equiv.__default.AssignState#canCall| (Lit DatatypeTypeType |st#0@@22|) (Lit SeqType |vars#0@@12|) (Lit DatatypeTypeType |vals#0@@6|)) (= (Equiv.__default.BindStartScope (Lit DatatypeTypeType |st#0@@22|) (Lit SeqType |vars#0@@12|) (Lit DatatypeTypeType |vals#0@@6|)) (Lit DatatypeTypeType (Equiv.__default.AssignState (Lit DatatypeTypeType |st#0@@22|) (Lit SeqType |vars#0@@12|) (Lit DatatypeTypeType |vals#0@@6|))))))
 :qid |Inductiondfy.58:33|
 :weight 3
 :skolemid |777|
 :pattern ( (Equiv.__default.BindStartScope (Lit DatatypeTypeType |st#0@@22|) (Lit SeqType |vars#0@@12|) (Lit DatatypeTypeType |vals#0@@6|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@23| T@U) (|vars#0@@13| T@U) (|argvs#0@@1| T@U) ) (!  (=> (or (|Equiv.__default.UpdateState__Pre#canCall| (Lit DatatypeTypeType |st#0@@23|) (Lit SeqType |vars#0@@13|) (Lit DatatypeTypeType |argvs#0@@1|)) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@23| Tclass.Equiv.MState) ($Is SeqType |vars#0@@13| (TSeq (TSeq TChar)))) ($Is DatatypeTypeType |argvs#0@@1| Tclass.Equiv.VS)))) (and (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@23|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@23|))))) (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |argvs#0@@1|)) (=> (= (|Seq#Length| (Lit SeqType |vars#0@@13|)) (|Seq#Length| (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |argvs#0@@1|))))) (and (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |argvs#0@@1|)) (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |argvs#0@@1|))) (=> (= (|Seq#Length| (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |argvs#0@@1|)))) (|Seq#Length| (Lit SeqType (Equiv.MSeqValue.vs_k (Lit DatatypeTypeType |argvs#0@@1|))))) (and (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |argvs#0@@1|)) (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |argvs#0@@1|))) (|Equiv.__default.EqSeqValue#canCall| (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |argvs#0@@1|))) (Lit SeqType (Equiv.MSeqValue.vs_k (Lit DatatypeTypeType |argvs#0@@1|))))))))))) (= (Equiv.__default.UpdateState__Pre (Lit DatatypeTypeType |st#0@@23|) (Lit SeqType |vars#0@@13|) (Lit DatatypeTypeType |argvs#0@@1|))  (and (and (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@23|)) (and (= (|Seq#Length| (Lit SeqType |vars#0@@13|)) (|Seq#Length| (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |argvs#0@@1|))))) (= (|Seq#Length| (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |argvs#0@@1|)))) (|Seq#Length| (Lit SeqType (Equiv.MSeqValue.vs_k (Lit DatatypeTypeType |argvs#0@@1|))))))) (Equiv.__default.EqSeqValue (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |argvs#0@@1|))) (Lit SeqType (Equiv.MSeqValue.vs_k (Lit DatatypeTypeType |argvs#0@@1|))))))))
 :qid |Inductiondfy.51:35|
 :weight 3
 :skolemid |750|
 :pattern ( (Equiv.__default.UpdateState__Pre (Lit DatatypeTypeType |st#0@@23|) (Lit SeqType |vars#0@@13|) (Lit DatatypeTypeType |argvs#0@@1|)))
))))
...
(declare-fun |bvals#0@@2| () T@U)
(declare-fun |st1#0@0| () T@U)
(declare-fun |vs#0@0| () T@U)
(declare-fun |bvars#0@@1| () T@U)
(declare-fun |body#0@@1| () T@U)
(declare-fun $Heap@0 () T@U)
(declare-fun |##st#5@0| () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun $Heap@@6 () T@U)
(declare-fun |e#0@@16| () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellFormed$$Equiv.__default.InductBind__Fail)
...
(let ((anon5_Else_correct  (=> (and (=> (Equiv.__default.Pes__Succ |st#0@@24| |bvals#0@@2| |st1#0@0| |vs#0@0|) (and (Equiv.__default.UpdateState__Pre |st1#0@0| |bvars#0@@1| |vs#0@0|) (not (Equiv.__default.P__Fail (Equiv.__default.BindStartScope |st1#0@0| |bvars#0@@1| |vs#0@0|) |body#0@@1|)))) (= (ControlFlow 0 4) 1)) anon4_correct)))
(let ((anon5_Then_correct  (=> (and ($IsAlloc DatatypeTypeType |st#0@@24| Tclass.Equiv.MState $Heap@0) ($IsAlloc SeqType |bvals#0@@2| (TSeq Tclass.AST.Expr) $Heap@0)) (=> (and (and ($IsAlloc DatatypeTypeType |st1#0@0| Tclass.Equiv.MState $Heap@0) ($IsAlloc DatatypeTypeType |vs#0@0| Tclass.Equiv.VS $Heap@0)) (and (|Equiv.__default.Pes__Succ#canCall| |st#0@@24| |bvals#0@@2| |st1#0@0| |vs#0@0|) (Equiv.__default.Pes__Succ |st#0@@24| |bvals#0@@2| |st1#0@0| |vs#0@0|))) (=> (and (and (and ($IsAlloc DatatypeTypeType |st1#0@0| Tclass.Equiv.MState $Heap@0) ($IsAlloc SeqType |bvars#0@@1| (TSeq (TSeq TChar)) $Heap@0)) (and ($IsAlloc DatatypeTypeType |vs#0@0| Tclass.Equiv.VS $Heap@0) (|Equiv.__default.UpdateState__Pre#canCall| |st1#0@0| |bvars#0@@1| |vs#0@0|))) (and (and (Equiv.__default.UpdateState__Pre |st1#0@0| |bvars#0@@1| |vs#0@0|) ($IsAlloc DatatypeTypeType |st1#0@0| Tclass.Equiv.MState $Heap@0)) (and ($IsAlloc SeqType |bvars#0@@1| (TSeq (TSeq TChar)) $Heap@0) ($IsAlloc DatatypeTypeType |vs#0@0| Tclass.Equiv.VS $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (Equiv.__default.UpdateState__Pre |st1#0@0| |bvars#0@@1| |vs#0@0|)) (=> (Equiv.__default.UpdateState__Pre |st1#0@0| |bvars#0@@1| |vs#0@0|) (=> (and (and (and (|Equiv.__default.BindStartScope#canCall| |st1#0@0| |bvars#0@@1| |vs#0@0|) (Equiv.MState.MState_q (Equiv.__default.BindStartScope |st1#0@0| |bvars#0@@1| |vs#0@0|))) (and (= |##st#5@0| (Equiv.__default.BindStartScope |st1#0@0| |bvars#0@@1| |vs#0@0|)) ($IsAlloc DatatypeTypeType |##st#5@0| Tclass.Equiv.MState $Heap@0))) (and (and ($IsAlloc DatatypeTypeType |body#0@@1| Tclass.AST.Expr $Heap@0) (|Equiv.__default.P__Fail#canCall| (Equiv.__default.BindStartScope |st1#0@0| |bvars#0@@1| |vs#0@0|) |body#0@@1|)) (and (not (Equiv.__default.P__Fail (Equiv.__default.BindStartScope |st1#0@0| |bvars#0@@1| |vs#0@0|) |body#0@@1|)) (= (ControlFlow 0 2) 1)))) anon4_correct))))))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (AST.Expr__Raw.Bind_q |e#0@@16|)) (and (AST.Expr__Raw.Bind_q |e#0@@16|) (|Seq#Equal| (AST.Expr__Raw.bvars |e#0@@16|) |bvars#0@@1|))) (=> (and (and (and (AST.Expr__Raw.Bind_q |e#0@@16|) (|Seq#Equal| (AST.Expr__Raw.bvals |e#0@@16|) |bvals#0@@2|)) (and (AST.Expr__Raw.Bind_q |e#0@@16|) (|AST.Expr__Raw#Equal| (AST.Expr__Raw.body |e#0@@16|) |body#0@@1|))) (and (and ($IsAlloc DatatypeTypeType |st#0@@24| Tclass.Equiv.MState $Heap@@6) ($IsAlloc DatatypeTypeType |e#0@@16| Tclass.AST.Expr $Heap@@6)) (and (|Equiv.__default.P__Fail#canCall| |st#0@@24| |e#0@@16|) (not (Equiv.__default.P__Fail |st#0@@24| |e#0@@16|))))) (=> (and (and (and (and ($IsAlloc DatatypeTypeType |st#0@@24| Tclass.Equiv.MState $Heap@@6) ($IsAlloc SeqType |bvals#0@@2| (TSeq Tclass.AST.Expr) $Heap@@6)) (and (|Equiv.__default.Pes#canCall| |st#0@@24| |bvals#0@@2|) (Equiv.__default.Pes |st#0@@24| |bvals#0@@2|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@6 $Heap@0))) (and (and (and ($IsAlloc DatatypeTypeType |st#0@@24| Tclass.Equiv.MState $Heap@0) ($IsAlloc SeqType |bvals#0@@2| (TSeq Tclass.AST.Expr) $Heap@0)) (and (|Equiv.__default.Pes__Fail#canCall| |st#0@@24| |bvals#0@@2|) (not (Equiv.__default.Pes__Fail |st#0@@24| |bvals#0@@2|)))) (and (and ($Is DatatypeTypeType |st1#0@0| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st1#0@0| Tclass.Equiv.MState $Heap@0)) (and ($Is DatatypeTypeType |vs#0@0| Tclass.Equiv.VS) ($IsAlloc DatatypeTypeType |vs#0@0| Tclass.Equiv.VS $Heap@0))))) (and (=> (= (ControlFlow 0 5) 2) anon5_Then_correct) (=> (= (ControlFlow 0 5) 4) anon5_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@24| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st#0@@24| Tclass.Equiv.MState $Heap@@6)) (|$IsA#Equiv.MState| |st#0@@24|)) (=> (and (and (and (and ($Is DatatypeTypeType |e#0@@16| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@16| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@16|)) (and (and ($Is SeqType |bvars#0@@1| (TSeq (TSeq TChar))) ($IsAlloc SeqType |bvars#0@@1| (TSeq (TSeq TChar)) $Heap@@6)) (and ($Is SeqType |bvals#0@@2| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |bvals#0@@2| (TSeq Tclass.AST.Expr) $Heap@@6)))) (and (and (and ($Is DatatypeTypeType |body#0@@1| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |body#0@@1| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |body#0@@1|)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 6) 5)))) anon0_correct)))))
