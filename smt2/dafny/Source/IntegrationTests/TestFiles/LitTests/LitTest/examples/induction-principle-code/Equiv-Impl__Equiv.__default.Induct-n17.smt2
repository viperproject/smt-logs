...
(declare-fun |cond#0@@1| () T@U)
(declare-fun |thn#0@@1| () T@U)
(declare-fun |els#0@@1| () T@U)
(declare-fun |st_cond#0| () T@U)
(declare-fun |condv#0@@0| () T@U)
(set-info :boogie-vc-id Impl$$Equiv.__default.InductIf__Succ)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and ($Is DatatypeTypeType |st#0@@10| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st#0@@10| Tclass.Equiv.MState $Heap@@6)) (|$IsA#Equiv.MState| |st#0@@10|)) (and (and ($Is DatatypeTypeType |e#0@@22| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@22| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@22|))) (=> (and (and (and (and (and ($Is DatatypeTypeType |cond#0@@1| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |cond#0@@1| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |cond#0@@1|)) (and (and ($Is DatatypeTypeType |thn#0@@1| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |thn#0@@1| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |thn#0@@1|))) (and (and (and ($Is DatatypeTypeType |els#0@@1| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |els#0@@1| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |els#0@@1|)) (and (and ($Is DatatypeTypeType |st_cond#0| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st_cond#0| Tclass.Equiv.MState $Heap@@6)) (|$IsA#Equiv.MState| |st_cond#0|)))) (and (and (and (and ($Is DatatypeTypeType |condv#0@@0| Tclass.Equiv.MValue) ($IsAlloc DatatypeTypeType |condv#0@@0| Tclass.Equiv.MValue $Heap@@6)) (|$IsA#Equiv.MValue| |condv#0@@0|)) (and (= 3 $FunctionContextHeight) (AST.Expr__Raw.If_q |e#0@@22|))) (and (and (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.cond |e#0@@22|) |cond#0@@1|) (|AST.Expr__Raw#Equal| (AST.Expr__Raw.thn |e#0@@22|) |thn#0@@1|)) (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.els |e#0@@22|) |els#0@@1|) (not (Equiv.__default.P__Fail |st#0@@10| |e#0@@22|)))) (and (and (Equiv.__default.P__Succ |st#0@@10| |cond#0@@1| |st_cond#0| |condv#0@@0|) (Equiv.__default.P |st_cond#0| |thn#0@@1|)) (and (Equiv.__default.P |st_cond#0| |els#0@@1|) (= (ControlFlow 0 6) 2)))))) anon0_correct)))))
