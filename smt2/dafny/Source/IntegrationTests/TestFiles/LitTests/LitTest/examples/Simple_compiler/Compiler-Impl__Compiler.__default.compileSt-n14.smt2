...
(assert (forall ((d@@45 T@U) (LinkedList.List$T@@5 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (LinkedList.List.Cons_q d@@45) ($IsAlloc DatatypeTypeType d@@45 (Tclass.LinkedList.List LinkedList.List$T@@5) $h@@1))) ($IsAllocBox (LinkedList.List.hd d@@45) LinkedList.List$T@@5 $h@@1))
 :qid |unknown.0:0|
 :skolemid |3701|
 :pattern ( ($IsAllocBox (LinkedList.List.hd d@@45) LinkedList.List$T@@5 $h@@1))
)))
...
(assert (forall ((d@@46 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (DafnyAST.Expr.Const_q d@@46) ($IsAlloc DatatypeTypeType d@@46 Tclass.DafnyAST.Expr $h@@2))) ($IsAlloc intType (int_2_U (DafnyAST.Expr.n d@@46)) TInt $h@@2))
 :qid |unknown.0:0|
 :skolemid |3590|
 :pattern ( ($IsAlloc intType (int_2_U (DafnyAST.Expr.n d@@46)) TInt $h@@2))
)))
(assert (forall ((d@@47 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (StackMachine.Instr.PushConst_q d@@47) ($IsAlloc DatatypeTypeType d@@47 Tclass.StackMachine.Instr $h@@3))) ($IsAlloc intType (int_2_U (StackMachine.Instr.n d@@47)) TInt $h@@3))
 :qid |unknown.0:0|
 :skolemid |3737|
 :pattern ( ($IsAlloc intType (int_2_U (StackMachine.Instr.n d@@47)) TInt $h@@3))
)))
...
(assert (forall ((d@@50 T@U) (LinkedList.List$T@@7 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (LinkedList.List.Cons_q d@@50) ($IsAlloc DatatypeTypeType d@@50 (Tclass.LinkedList.List LinkedList.List$T@@7) $h@@4))) ($IsAlloc DatatypeTypeType (LinkedList.List.tl d@@50) (Tclass.LinkedList.List LinkedList.List$T@@7) $h@@4))
 :qid |unknown.0:0|
 :skolemid |3702|
 :pattern ( ($IsAlloc DatatypeTypeType (LinkedList.List.tl d@@50) (Tclass.LinkedList.List LinkedList.List$T@@7) $h@@4))
)))
(assert (forall ((d@@51 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) ($Is DatatypeTypeType d@@51 Tclass.DafnyAST.BinOp)) ($IsAlloc DatatypeTypeType d@@51 Tclass.DafnyAST.BinOp $h@@5))
 :qid |unknown.0:0|
 :skolemid |3579|
 :pattern ( ($IsAlloc DatatypeTypeType d@@51 Tclass.DafnyAST.BinOp $h@@5))
)))
(assert (forall ((d@@52 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) ($Is DatatypeTypeType d@@52 Tclass.DafnyAST.Expr)) ($IsAlloc DatatypeTypeType d@@52 Tclass.DafnyAST.Expr $h@@6))
 :qid |unknown.0:0|
 :skolemid |3618|
 :pattern ( ($IsAlloc DatatypeTypeType d@@52 Tclass.DafnyAST.Expr $h@@6))
)))
(assert (forall ((d@@53 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) ($Is DatatypeTypeType d@@53 Tclass.DafnyAST.Stmt)) ($IsAlloc DatatypeTypeType d@@53 Tclass.DafnyAST.Stmt $h@@7))
 :qid |unknown.0:0|
 :skolemid |3661|
 :pattern ( ($IsAlloc DatatypeTypeType d@@53 Tclass.DafnyAST.Stmt $h@@7))
)))
(assert (forall ((d@@54 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) ($Is DatatypeTypeType d@@54 Tclass.DafnyAST.InterpResult)) ($IsAlloc DatatypeTypeType d@@54 Tclass.DafnyAST.InterpResult $h@@8))
 :qid |unknown.0:0|
 :skolemid |3683|
 :pattern ( ($IsAlloc DatatypeTypeType d@@54 Tclass.DafnyAST.InterpResult $h@@8))
)))
(assert (forall ((d@@55 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) ($Is DatatypeTypeType d@@55 Tclass.StackMachine.Instr)) ($IsAlloc DatatypeTypeType d@@55 Tclass.StackMachine.Instr $h@@9))
 :qid |unknown.0:0|
 :skolemid |3766|
 :pattern ( ($IsAlloc DatatypeTypeType d@@55 Tclass.StackMachine.Instr $h@@9))
)))
(assert (forall ((d@@56 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) ($Is DatatypeTypeType d@@56 Tclass.StackMachine.State)) ($IsAlloc DatatypeTypeType d@@56 Tclass.StackMachine.State $h@@10))
 :qid |unknown.0:0|
 :skolemid |3793|
 :pattern ( ($IsAlloc DatatypeTypeType d@@56 Tclass.StackMachine.State $h@@10))
)))
...
(assert (forall ((d@@58 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (DafnyAST.Expr.Var_q d@@58) ($IsAlloc DatatypeTypeType d@@58 Tclass.DafnyAST.Expr $h@@11))) ($IsAlloc SeqType (DafnyAST.Expr.v d@@58) (TSeq TChar) $h@@11))
 :qid |unknown.0:0|
 :skolemid |3598|
 :pattern ( ($IsAlloc SeqType (DafnyAST.Expr.v d@@58) (TSeq TChar) $h@@11))
)))
(assert (forall ((d@@59 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (DafnyAST.Stmt.Assign_q d@@59) ($IsAlloc DatatypeTypeType d@@59 Tclass.DafnyAST.Stmt $h@@12))) ($IsAlloc SeqType (DafnyAST.Stmt.v d@@59) (TSeq TChar) $h@@12))
 :qid |unknown.0:0|
 :skolemid |3641|
 :pattern ( ($IsAlloc SeqType (DafnyAST.Stmt.v d@@59) (TSeq TChar) $h@@12))
)))
(assert (forall ((d@@60 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (DafnyAST.InterpResult.InterpResult_q d@@60) ($IsAlloc DatatypeTypeType d@@60 Tclass.DafnyAST.InterpResult $h@@13))) ($IsAlloc SeqType (DafnyAST.InterpResult.output d@@60) (TSeq TInt) $h@@13))
 :qid |unknown.0:0|
 :skolemid |3675|
 :pattern ( ($IsAlloc SeqType (DafnyAST.InterpResult.output d@@60) (TSeq TInt) $h@@13))
)))
(assert (forall ((d@@61 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (StackMachine.Instr.PushVar_q d@@61) ($IsAlloc DatatypeTypeType d@@61 Tclass.StackMachine.Instr $h@@14))) ($IsAlloc SeqType (StackMachine.Instr.v d@@61) (TSeq TChar) $h@@14))
 :qid |unknown.0:0|
 :skolemid |3745|
 :pattern ( ($IsAlloc SeqType (StackMachine.Instr.v d@@61) (TSeq TChar) $h@@14))
)))
(assert (forall ((d@@62 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (StackMachine.Instr.PopVar_q d@@62) ($IsAlloc DatatypeTypeType d@@62 Tclass.StackMachine.Instr $h@@15))) ($IsAlloc SeqType (StackMachine.Instr.v d@@62) (TSeq TChar) $h@@15))
 :qid |unknown.0:0|
 :skolemid |3761|
 :pattern ( ($IsAlloc SeqType (StackMachine.Instr.v d@@62) (TSeq TChar) $h@@15))
)))
(assert (forall ((d@@63 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (StackMachine.State.State_q d@@63) ($IsAlloc DatatypeTypeType d@@63 Tclass.StackMachine.State $h@@16))) ($IsAlloc DatatypeTypeType (StackMachine.State.stack d@@63) (Tclass.LinkedList.List TInt) $h@@16))
 :qid |unknown.0:0|
 :skolemid |3781|
 :pattern ( ($IsAlloc DatatypeTypeType (StackMachine.State.stack d@@63) (Tclass.LinkedList.List TInt) $h@@16))
)))
(assert (forall ((d@@64 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (StackMachine.State.State_q d@@64) ($IsAlloc DatatypeTypeType d@@64 Tclass.StackMachine.State $h@@17))) ($IsAlloc SeqType (StackMachine.State.output d@@64) (TSeq TInt) $h@@17))
 :qid |unknown.0:0|
 :skolemid |3783|
 :pattern ( ($IsAlloc SeqType (StackMachine.State.output d@@64) (TSeq TInt) $h@@17))
)))
...
(assert (forall ((d@@68 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (DafnyAST.InterpResult.InterpResult_q d@@68) ($IsAlloc DatatypeTypeType d@@68 Tclass.DafnyAST.InterpResult $h@@18))) ($IsAlloc MapType (DafnyAST.InterpResult.ctx d@@68) (TMap (TSeq TChar) TInt) $h@@18))
 :qid |unknown.0:0|
 :skolemid |3674|
 :pattern ( ($IsAlloc MapType (DafnyAST.InterpResult.ctx d@@68) (TMap (TSeq TChar) TInt) $h@@18))
)))
(assert (forall ((d@@69 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (StackMachine.State.State_q d@@69) ($IsAlloc DatatypeTypeType d@@69 Tclass.StackMachine.State $h@@19))) ($IsAlloc MapType (StackMachine.State.regs d@@69) (TMap (TSeq TChar) TInt) $h@@19))
 :qid |unknown.0:0|
 :skolemid |3782|
 :pattern ( ($IsAlloc MapType (StackMachine.State.regs d@@69) (TMap (TSeq TChar) TInt) $h@@19))
)))
(assert (forall ((d@@70 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (_System.Tuple2.___hMake2_q d@@70) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@70 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@20)
 :qid |unknown.0:0|
 :skolemid |3346|
 :pattern ( ($IsAlloc DatatypeTypeType d@@70 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@20))
)))) ($IsAllocBox (_System.Tuple2._0 d@@70) |_System._tuple#2$T0@@6| $h@@20))
 :qid |unknown.0:0|
 :skolemid |3347|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@70) |_System._tuple#2$T0@@6| $h@@20))
)))
(assert (forall ((d@@71 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (_System.Tuple2.___hMake2_q d@@71) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@71 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@21)
 :qid |unknown.0:0|
 :skolemid |3348|
 :pattern ( ($IsAlloc DatatypeTypeType d@@71 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@21))
)))) ($IsAllocBox (_System.Tuple2._1 d@@71) |_System._tuple#2$T1@@7| $h@@21))
 :qid |unknown.0:0|
 :skolemid |3349|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@71) |_System._tuple#2$T1@@7| $h@@21))
)))
...
(assert (forall ((d@@72 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (DafnyAST.Expr.Op_q d@@72) ($IsAlloc DatatypeTypeType d@@72 Tclass.DafnyAST.Expr $h@@22))) ($IsAlloc DatatypeTypeType (DafnyAST.Expr.op d@@72) Tclass.DafnyAST.BinOp $h@@22))
 :qid |unknown.0:0|
 :skolemid |3608|
 :pattern ( ($IsAlloc DatatypeTypeType (DafnyAST.Expr.op d@@72) Tclass.DafnyAST.BinOp $h@@22))
)))
(assert (forall ((d@@73 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (DafnyAST.Expr.Op_q d@@73) ($IsAlloc DatatypeTypeType d@@73 Tclass.DafnyAST.Expr $h@@23))) ($IsAlloc DatatypeTypeType (DafnyAST.Expr.e1 d@@73) Tclass.DafnyAST.Expr $h@@23))
 :qid |unknown.0:0|
 :skolemid |3609|
 :pattern ( ($IsAlloc DatatypeTypeType (DafnyAST.Expr.e1 d@@73) Tclass.DafnyAST.Expr $h@@23))
)))
(assert (forall ((d@@74 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (DafnyAST.Expr.Op_q d@@74) ($IsAlloc DatatypeTypeType d@@74 Tclass.DafnyAST.Expr $h@@24))) ($IsAlloc DatatypeTypeType (DafnyAST.Expr.e2 d@@74) Tclass.DafnyAST.Expr $h@@24))
 :qid |unknown.0:0|
 :skolemid |3610|
 :pattern ( ($IsAlloc DatatypeTypeType (DafnyAST.Expr.e2 d@@74) Tclass.DafnyAST.Expr $h@@24))
)))
(assert (forall ((d@@75 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (DafnyAST.Stmt.Print_q d@@75) ($IsAlloc DatatypeTypeType d@@75 Tclass.DafnyAST.Stmt $h@@25))) ($IsAlloc DatatypeTypeType (DafnyAST.Stmt.e d@@75) Tclass.DafnyAST.Expr $h@@25))
 :qid |unknown.0:0|
 :skolemid |3632|
 :pattern ( ($IsAlloc DatatypeTypeType (DafnyAST.Stmt.e d@@75) Tclass.DafnyAST.Expr $h@@25))
)))
(assert (forall ((d@@76 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (DafnyAST.Stmt.Assign_q d@@76) ($IsAlloc DatatypeTypeType d@@76 Tclass.DafnyAST.Stmt $h@@26))) ($IsAlloc DatatypeTypeType (DafnyAST.Stmt.e d@@76) Tclass.DafnyAST.Expr $h@@26))
 :qid |unknown.0:0|
 :skolemid |3642|
 :pattern ( ($IsAlloc DatatypeTypeType (DafnyAST.Stmt.e d@@76) Tclass.DafnyAST.Expr $h@@26))
)))
(assert (forall ((d@@77 T@U) ($h@@27 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (DafnyAST.Stmt.Seq_q d@@77) ($IsAlloc DatatypeTypeType d@@77 Tclass.DafnyAST.Stmt $h@@27))) ($IsAlloc DatatypeTypeType (DafnyAST.Stmt.s1 d@@77) Tclass.DafnyAST.Stmt $h@@27))
 :qid |unknown.0:0|
 :skolemid |3654|
 :pattern ( ($IsAlloc DatatypeTypeType (DafnyAST.Stmt.s1 d@@77) Tclass.DafnyAST.Stmt $h@@27))
)))
(assert (forall ((d@@78 T@U) ($h@@28 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (DafnyAST.Stmt.Seq_q d@@78) ($IsAlloc DatatypeTypeType d@@78 Tclass.DafnyAST.Stmt $h@@28))) ($IsAlloc DatatypeTypeType (DafnyAST.Stmt.s2 d@@78) Tclass.DafnyAST.Stmt $h@@28))
 :qid |unknown.0:0|
 :skolemid |3655|
 :pattern ( ($IsAlloc DatatypeTypeType (DafnyAST.Stmt.s2 d@@78) Tclass.DafnyAST.Stmt $h@@28))
)))
...
(assert (forall ((LinkedList.List$T@@8 T@U) (|a#2#0#0@@3| T@U) (|a#2#1#0@@2| T@U) ($h@@29 T@U) ) (!  (=> ($IsGoodHeap $h@@29) (= ($IsAlloc DatatypeTypeType (|#LinkedList.List.Cons| |a#2#0#0@@3| |a#2#1#0@@2|) (Tclass.LinkedList.List LinkedList.List$T@@8) $h@@29)  (and ($IsAllocBox |a#2#0#0@@3| LinkedList.List$T@@8 $h@@29) ($IsAlloc DatatypeTypeType |a#2#1#0@@2| (Tclass.LinkedList.List LinkedList.List$T@@8) $h@@29))))
 :qid |unknown.0:0|
 :skolemid |3700|
 :pattern ( ($IsAlloc DatatypeTypeType (|#LinkedList.List.Cons| |a#2#0#0@@3| |a#2#1#0@@2|) (Tclass.LinkedList.List LinkedList.List$T@@8) $h@@29))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (|StackMachine.State#Equal| (StackMachine.__default.interpProg_k ($LS ($LS $LZ)) (Compiler.__default.compileStmt ($LS ($LS $LZ)) |s#0@@7|) |st#0@@6|) (let ((|output#0| (DafnyAST.InterpResult.output (DafnyAST.__default.interpStmt_k ($LS ($LS $LZ)) |s#0@@7| (StackMachine.State.regs |st#0@@6|)))))
(let ((|ctx'#0| (DafnyAST.InterpResult.ctx (DafnyAST.__default.interpStmt_k ($LS ($LS $LZ)) |s#0@@7| (StackMachine.State.regs |st#0@@6|)))))
(let ((|dt_update_tmp#0#0| |st#0@@6|))
(let ((|dt_update#output#0#0| (|Seq#Append| (StackMachine.State.output |st#0@@6|) |output#0|)))
(let ((|dt_update#regs#0#0| |ctx'#0|))
(|#StackMachine.State.State| (StackMachine.State.stack |dt_update_tmp#0#0|) |dt_update#regs#0#0| |dt_update#output#0#0|))))))))))
(let ((anon9_Then_correct  (=> (= |s#0@@7| (|#DafnyAST.Stmt.Seq| |_mcc#3#0_0@0| |_mcc#4#0_0@0|)) (=> (and ($Is DatatypeTypeType |_mcc#3#0_0@0| Tclass.DafnyAST.Stmt) ($Is DatatypeTypeType |_mcc#4#0_0@0| Tclass.DafnyAST.Stmt)) (=> (and (and (and (and (and ($Is DatatypeTypeType |s2#0_0@0| Tclass.DafnyAST.Stmt) ($IsAlloc DatatypeTypeType |s2#0_0@0| Tclass.DafnyAST.Stmt $Heap@@0)) (= |let#0_0#0#0| |_mcc#4#0_0@0|)) (and ($Is DatatypeTypeType |let#0_0#0#0| Tclass.DafnyAST.Stmt) (= |s2#0_0@0| |let#0_0#0#0|))) (and (and (and ($Is DatatypeTypeType |s1#0_0@0| Tclass.DafnyAST.Stmt) ($IsAlloc DatatypeTypeType |s1#0_0@0| Tclass.DafnyAST.Stmt $Heap@@0)) (= |let#0_1#0#0| |_mcc#3#0_0@0|)) (and (and ($Is DatatypeTypeType |let#0_1#0#0| Tclass.DafnyAST.Stmt) (= |s1#0_0@0| |let#0_1#0#0|)) (and ($IsAlloc DatatypeTypeType |s2#0_0@0| Tclass.DafnyAST.Stmt $Heap@@0) (|Compiler.__default.compileStmt#canCall| |s2#0_0@0|))))) (and (and (and (and (|Compiler.__default.compileStmt#canCall| |s2#0_0@0|) (= |p1##0_0@0| (Compiler.__default.compileStmt ($LS $LZ) |s2#0_0@0|))) (and ($IsAlloc DatatypeTypeType |s1#0_0@0| Tclass.DafnyAST.Stmt $Heap@@0) (|Compiler.__default.compileStmt#canCall| |s1#0_0@0|))) (and (and (|Compiler.__default.compileStmt#canCall| |s1#0_0@0|) (= |p2##0_0@0| (Compiler.__default.compileStmt ($LS $LZ) |s1#0_0@0|))) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)))) (and (and (and (|$IsA#StackMachine.State| (StackMachine.__default.interpProg_k ($LS $LZ) (LinkedList.__default.Concat Tclass.StackMachine.Instr ($LS $LZ) |p1##0_0@0| |p2##0_0@0|) |st#0@@6|)) (|$IsA#StackMachine.State| (StackMachine.__default.interpProg_k ($LS $LZ) |p1##0_0@0| (StackMachine.__default.interpProg_k ($LS $LZ) |p2##0_0@0| |st#0@@6|)))) (and (and (|LinkedList.__default.Concat#canCall| Tclass.StackMachine.Instr |p1##0_0@0| |p2##0_0@0|) (|StackMachine.__default.interpProg_k#canCall| (LinkedList.__default.Concat Tclass.StackMachine.Instr ($LS $LZ) |p1##0_0@0| |p2##0_0@0|) |st#0@@6|)) (and (|StackMachine.__default.interpProg_k#canCall| |p2##0_0@0| |st#0@@6|) (|StackMachine.__default.interpProg_k#canCall| |p1##0_0@0| (StackMachine.__default.interpProg_k ($LS $LZ) |p2##0_0@0| |st#0@@6|))))) (and (|StackMachine.State#Equal| (StackMachine.__default.interpProg_k ($LS ($LS $LZ)) (LinkedList.__default.Concat Tclass.StackMachine.Instr ($LS ($LS $LZ)) |p1##0_0@0| |p2##0_0@0|) |st#0@@6|) (StackMachine.__default.interpProg_k ($LS ($LS $LZ)) |p1##0_0@0| (StackMachine.__default.interpProg_k ($LS ($LS $LZ)) |p2##0_0@0| |st#0@@6|))) (= $Heap@@0 $Heap@2))))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (or (< (DtRank |s1#0_0@0|) (DtRank |s#0@@7|)) (and (= (DtRank |s1#0_0@0|) (DtRank |s#0@@7|)) (< (DtRank |st#0@@6|) (DtRank |st#0@@6|))))) (=> (or (< (DtRank |s1#0_0@0|) (DtRank |s#0@@7|)) (and (= (DtRank |s1#0_0@0|) (DtRank |s#0@@7|)) (< (DtRank |st#0@@6|) (DtRank |st#0@@6|)))) (=> (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (=> (and (and (and (and (and (|$IsA#StackMachine.State| (StackMachine.__default.interpProg_k ($LS $LZ) (Compiler.__default.compileStmt ($LS $LZ) |s1#0_0@0|) |st#0@@6|)) (|$IsA#StackMachine.State| (let ((|output#0@@0| (DafnyAST.InterpResult.output (DafnyAST.__default.interpStmt_k ($LS $LZ) |s1#0_0@0| (StackMachine.State.regs |st#0@@6|)))))
(let ((|ctx'#0@@0| (DafnyAST.InterpResult.ctx (DafnyAST.__default.interpStmt_k ($LS $LZ) |s1#0_0@0| (StackMachine.State.regs |st#0@@6|)))))
(let ((|dt_update_tmp#0#0@@0| |st#0@@6|))
(let ((|dt_update#output#0#0@@0| (|Seq#Append| (StackMachine.State.output |st#0@@6|) |output#0@@0|)))
(let ((|dt_update#regs#0#0@@0| |ctx'#0@@0|))
(|#StackMachine.State.State| (StackMachine.State.stack |dt_update_tmp#0#0@@0|) |dt_update#regs#0#0@@0| |dt_update#output#0#0@@0|)))))))) (and (and (|Compiler.__default.compileStmt#canCall| |s1#0_0@0|) (|StackMachine.__default.interpProg_k#canCall| (Compiler.__default.compileStmt ($LS $LZ) |s1#0_0@0|) |st#0@@6|)) (and (and (StackMachine.State.State_q |st#0@@6|) (|DafnyAST.__default.interpStmt_k#canCall| |s1#0_0@0| (StackMachine.State.regs |st#0@@6|))) (let ((|dt_update_tmp#0#0@@1| |st#0@@6|))
 (and (StackMachine.State.State_q |st#0@@6|) (StackMachine.State.State_q |dt_update_tmp#0#0@@1|)))))) (|StackMachine.State#Equal| (StackMachine.__default.interpProg_k ($LS ($LS $LZ)) (Compiler.__default.compileStmt ($LS ($LS $LZ)) |s1#0_0@0|) |st#0@@6|) (let ((|output#0@@1| (DafnyAST.InterpResult.output (DafnyAST.__default.interpStmt_k ($LS ($LS $LZ)) |s1#0_0@0| (StackMachine.State.regs |st#0@@6|)))))
(let ((|ctx'#0@@1| (DafnyAST.InterpResult.ctx (DafnyAST.__default.interpStmt_k ($LS ($LS $LZ)) |s1#0_0@0| (StackMachine.State.regs |st#0@@6|)))))
(let ((|dt_update_tmp#0#0@@2| |st#0@@6|))
(let ((|dt_update#output#0#0@@1| (|Seq#Append| (StackMachine.State.output |st#0@@6|) |output#0@@1|)))
(let ((|dt_update#regs#0#0@@1| |ctx'#0@@1|))
(|#StackMachine.State.State| (StackMachine.State.stack |dt_update_tmp#0#0@@2|) |dt_update#regs#0#0@@1| |dt_update#output#0#0@@1|)))))))) (and (and (= $Heap@2 $Heap@3) ($IsAlloc DatatypeTypeType |s1#0_0@0| Tclass.DafnyAST.Stmt $Heap@3)) (and (|Compiler.__default.compileStmt#canCall| |s1#0_0@0|) (= |##p#0_0@0| (Compiler.__default.compileStmt ($LS $LZ) |s1#0_0@0|))))) (and (and (and ($IsAlloc DatatypeTypeType |##p#0_0@0| (Tclass.LinkedList.List Tclass.StackMachine.Instr) $Heap@3) ($IsAlloc DatatypeTypeType |st#0@@6| Tclass.StackMachine.State $Heap@3)) (and (|StackMachine.__default.interpProg_k#canCall| (Compiler.__default.compileStmt ($LS $LZ) |s1#0_0@0|) |st#0@@6|) (StackMachine.State.State_q (StackMachine.__default.interpProg_k ($LS $LZ) (Compiler.__default.compileStmt ($LS $LZ) |s1#0_0@0|) |st#0@@6|)))) (and (and (|Compiler.__default.compileStmt#canCall| |s1#0_0@0|) (|StackMachine.__default.interpProg_k#canCall| (Compiler.__default.compileStmt ($LS $LZ) |s1#0_0@0|) |st#0@@6|)) (= |st##0_2@0| (StackMachine.__default.interpProg_k ($LS $LZ) (Compiler.__default.compileStmt ($LS $LZ) |s1#0_0@0|) |st#0@@6|))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (< (DtRank |s2#0_0@0|) (DtRank |s#0@@7|)) (and (= (DtRank |s2#0_0@0|) (DtRank |s#0@@7|)) (< (DtRank |st##0_2@0|) (DtRank |st#0@@6|))))) (=> (or (< (DtRank |s2#0_0@0|) (DtRank |s#0@@7|)) (and (= (DtRank |s2#0_0@0|) (DtRank |s#0@@7|)) (< (DtRank |st##0_2@0|) (DtRank |st#0@@6|)))) (=> (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (=> (and (and (and (and (|$IsA#StackMachine.State| (StackMachine.__default.interpProg_k ($LS $LZ) (Compiler.__default.compileStmt ($LS $LZ) |s2#0_0@0|) |st##0_2@0|)) (|$IsA#StackMachine.State| (let ((|output#0@@2| (DafnyAST.InterpResult.output (DafnyAST.__default.interpStmt_k ($LS $LZ) |s2#0_0@0| (StackMachine.State.regs |st##0_2@0|)))))
(let ((|ctx'#0@@2| (DafnyAST.InterpResult.ctx (DafnyAST.__default.interpStmt_k ($LS $LZ) |s2#0_0@0| (StackMachine.State.regs |st##0_2@0|)))))
(let ((|dt_update_tmp#0#0@@3| |st##0_2@0|))
(let ((|dt_update#output#0#0@@2| (|Seq#Append| (StackMachine.State.output |st##0_2@0|) |output#0@@2|)))
(let ((|dt_update#regs#0#0@@2| |ctx'#0@@2|))
(|#StackMachine.State.State| (StackMachine.State.stack |dt_update_tmp#0#0@@3|) |dt_update#regs#0#0@@2| |dt_update#output#0#0@@2|)))))))) (and (and (|Compiler.__default.compileStmt#canCall| |s2#0_0@0|) (|StackMachine.__default.interpProg_k#canCall| (Compiler.__default.compileStmt ($LS $LZ) |s2#0_0@0|) |st##0_2@0|)) (and (and (StackMachine.State.State_q |st##0_2@0|) (|DafnyAST.__default.interpStmt_k#canCall| |s2#0_0@0| (StackMachine.State.regs |st##0_2@0|))) (let ((|dt_update_tmp#0#0@@4| |st##0_2@0|))
 (and (StackMachine.State.State_q |st##0_2@0|) (StackMachine.State.State_q |dt_update_tmp#0#0@@4|)))))) (|StackMachine.State#Equal| (StackMachine.__default.interpProg_k ($LS ($LS $LZ)) (Compiler.__default.compileStmt ($LS ($LS $LZ)) |s2#0_0@0|) |st##0_2@0|) (let ((|output#0@@3| (DafnyAST.InterpResult.output (DafnyAST.__default.interpStmt_k ($LS ($LS $LZ)) |s2#0_0@0| (StackMachine.State.regs |st##0_2@0|)))))
(let ((|ctx'#0@@3| (DafnyAST.InterpResult.ctx (DafnyAST.__default.interpStmt_k ($LS ($LS $LZ)) |s2#0_0@0| (StackMachine.State.regs |st##0_2@0|)))))
(let ((|dt_update_tmp#0#0@@5| |st##0_2@0|))
(let ((|dt_update#output#0#0@@3| (|Seq#Append| (StackMachine.State.output |st##0_2@0|) |output#0@@3|)))
(let ((|dt_update#regs#0#0@@3| |ctx'#0@@3|))
(|#StackMachine.State.State| (StackMachine.State.stack |dt_update_tmp#0#0@@5|) |dt_update#regs#0#0@@3| |dt_update#output#0#0@@3|)))))))) (and (= $Heap@3 $Heap@4) (= (ControlFlow 0 7) 3))) GeneratedUnifiedExit_correct)))))))))))))
(let ((anon8_Then_correct  (=> (= |s#0@@7| (|#DafnyAST.Stmt.Assign| |_mcc#1#1_0@0| |_mcc#2#1_0@0|)) (=> (and ($Is SeqType |_mcc#1#1_0@0| (TSeq TChar)) ($Is DatatypeTypeType |_mcc#2#1_0@0| Tclass.DafnyAST.Expr)) (=> (and (and (and (and (and ($Is DatatypeTypeType |e#1_0@0| Tclass.DafnyAST.Expr) ($IsAlloc DatatypeTypeType |e#1_0@0| Tclass.DafnyAST.Expr $Heap@@0)) (= |let#1_0#0#0| |_mcc#2#1_0@0|)) (and ($Is DatatypeTypeType |let#1_0#0#0| Tclass.DafnyAST.Expr) (= |e#1_0@0| |let#1_0#0#0|))) (and (and (and ($Is SeqType |v#1_0@0| (TSeq TChar)) ($IsAlloc SeqType |v#1_0@0| (TSeq TChar) $Heap@@0)) (= |let#1_1#0#0| |_mcc#1#1_0@0|)) (and (and ($Is SeqType |let#1_1#0#0| (TSeq TChar)) (= |v#1_0@0| |let#1_1#0#0|)) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1))))) (and (and (and (and (|$IsA#StackMachine.State| (StackMachine.__default.interpProg_k ($LS $LZ) (Compiler.__default.compileExpr ($LS $LZ) |e#1_0@0|) |st#0@@6|)) (|$IsA#StackMachine.State| (let ((|dt_update_tmp#0#0@@6| |st#0@@6|))
(let ((|dt_update#stack#0#0| (|#LinkedList.List.Cons| ($Box intType (int_2_U (DafnyAST.__default.interpExpr ($LS $LZ) |e#1_0@0| (StackMachine.State.regs |st#0@@6|)))) (StackMachine.State.stack |st#0@@6|))))
(|#StackMachine.State.State| |dt_update#stack#0#0| (StackMachine.State.regs |dt_update_tmp#0#0@@6|) (StackMachine.State.output |dt_update_tmp#0#0@@6|)))))) (and (and (|Compiler.__default.compileExpr#canCall| |e#1_0@0|) (|StackMachine.__default.interpProg_k#canCall| (Compiler.__default.compileExpr ($LS $LZ) |e#1_0@0|) |st#0@@6|)) (let ((|dt_update_tmp#0#0@@7| |st#0@@6|))
 (and (and (and (StackMachine.State.State_q |st#0@@6|) (|DafnyAST.__default.interpExpr#canCall| |e#1_0@0| (StackMachine.State.regs |st#0@@6|))) (StackMachine.State.State_q |st#0@@6|)) (and (StackMachine.State.State_q |dt_update_tmp#0#0@@7|) (StackMachine.State.State_q |dt_update_tmp#0#0@@7|)))))) (|StackMachine.State#Equal| (StackMachine.__default.interpProg_k ($LS ($LS $LZ)) (Compiler.__default.compileExpr ($LS ($LS $LZ)) |e#1_0@0|) |st#0@@6|) (let ((|dt_update_tmp#0#0@@8| |st#0@@6|))
(let ((|dt_update#stack#0#0@@0| (|#LinkedList.List.Cons| ($Box intType (int_2_U (DafnyAST.__default.interpExpr ($LS ($LS $LZ)) |e#1_0@0| (StackMachine.State.regs |st#0@@6|)))) (StackMachine.State.stack |st#0@@6|))))
(|#StackMachine.State.State| |dt_update#stack#0#0@@0| (StackMachine.State.regs |dt_update_tmp#0#0@@8|) (StackMachine.State.output |dt_update_tmp#0#0@@8|)))))) (and (= $Heap@@0 $Heap@1) (= (ControlFlow 0 6) 3)))) GeneratedUnifiedExit_correct)))))
(let ((anon7_Then_correct  (=> (and (= |s#0@@7| (|#DafnyAST.Stmt.Print| |_mcc#0#2_0@0|)) ($Is DatatypeTypeType |_mcc#0#2_0@0| Tclass.DafnyAST.Expr)) (=> (and (and (and ($Is DatatypeTypeType |e#2_0@0| Tclass.DafnyAST.Expr) ($IsAlloc DatatypeTypeType |e#2_0@0| Tclass.DafnyAST.Expr $Heap@@0)) (= |let#2_0#0#0| |_mcc#0#2_0@0|)) (and (and ($Is DatatypeTypeType |let#2_0#0#0| Tclass.DafnyAST.Expr) (= |e#2_0@0| |let#2_0#0#0|)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (=> (and (and (and (and (|$IsA#StackMachine.State| (StackMachine.__default.interpProg_k ($LS $LZ) (Compiler.__default.compileExpr ($LS $LZ) |e#2_0@0|) |st#0@@6|)) (|$IsA#StackMachine.State| (let ((|dt_update_tmp#0#0@@9| |st#0@@6|))
(let ((|dt_update#stack#0#0@@1| (|#LinkedList.List.Cons| ($Box intType (int_2_U (DafnyAST.__default.interpExpr ($LS $LZ) |e#2_0@0| (StackMachine.State.regs |st#0@@6|)))) (StackMachine.State.stack |st#0@@6|))))
(|#StackMachine.State.State| |dt_update#stack#0#0@@1| (StackMachine.State.regs |dt_update_tmp#0#0@@9|) (StackMachine.State.output |dt_update_tmp#0#0@@9|)))))) (and (and (|Compiler.__default.compileExpr#canCall| |e#2_0@0|) (|StackMachine.__default.interpProg_k#canCall| (Compiler.__default.compileExpr ($LS $LZ) |e#2_0@0|) |st#0@@6|)) (let ((|dt_update_tmp#0#0@@10| |st#0@@6|))
 (and (and (and (StackMachine.State.State_q |st#0@@6|) (|DafnyAST.__default.interpExpr#canCall| |e#2_0@0| (StackMachine.State.regs |st#0@@6|))) (StackMachine.State.State_q |st#0@@6|)) (and (StackMachine.State.State_q |dt_update_tmp#0#0@@10|) (StackMachine.State.State_q |dt_update_tmp#0#0@@10|)))))) (|StackMachine.State#Equal| (StackMachine.__default.interpProg_k ($LS ($LS $LZ)) (Compiler.__default.compileExpr ($LS ($LS $LZ)) |e#2_0@0|) |st#0@@6|) (let ((|dt_update_tmp#0#0@@11| |st#0@@6|))
(let ((|dt_update#stack#0#0@@2| (|#LinkedList.List.Cons| ($Box intType (int_2_U (DafnyAST.__default.interpExpr ($LS ($LS $LZ)) |e#2_0@0| (StackMachine.State.regs |st#0@@6|)))) (StackMachine.State.stack |st#0@@6|))))
(|#StackMachine.State.State| |dt_update#stack#0#0@@2| (StackMachine.State.regs |dt_update_tmp#0#0@@11|) (StackMachine.State.output |dt_update_tmp#0#0@@11|)))))) (and (= $Heap@@0 $Heap@0) (= (ControlFlow 0 5) 3))) GeneratedUnifiedExit_correct)))))
(let ((anon6_Then_correct  (=> (and (= |s#0@@7| |#DafnyAST.Stmt.Skip|) (= (ControlFlow 0 4) 3)) GeneratedUnifiedExit_correct)))
(let ((anon9_Else_correct true))
(let ((anon8_Else_correct  (=> (or (not (= |s#0@@7| (|#DafnyAST.Stmt.Assign| |_mcc#1#1_0@0| |_mcc#2#1_0@0|))) (not true)) (and (=> (= (ControlFlow 0 10) 7) anon9_Then_correct) (=> (= (ControlFlow 0 10) 1) anon9_Else_correct)))))
(let ((anon7_Else_correct  (=> (or (not (= |s#0@@7| (|#DafnyAST.Stmt.Print| |_mcc#0#2_0@0|))) (not true)) (and (=> (= (ControlFlow 0 11) 6) anon8_Then_correct) (=> (= (ControlFlow 0 11) 10) anon8_Else_correct)))))
(let ((anon6_Else_correct  (=> (or (not (= |s#0@@7| |#DafnyAST.Stmt.Skip|)) (not true)) (and (=> (= (ControlFlow 0 12) 5) anon7_Then_correct) (=> (= (ControlFlow 0 12) 11) anon7_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (and (=> (= (ControlFlow 0 13) 4) anon6_Then_correct) (=> (= (ControlFlow 0 13) 12) anon6_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is DatatypeTypeType |s#0@@7| Tclass.DafnyAST.Stmt) ($IsAlloc DatatypeTypeType |s#0@@7| Tclass.DafnyAST.Stmt $Heap@@0)) (|$IsA#DafnyAST.Stmt| |s#0@@7|)) (=> (and (and (and ($Is DatatypeTypeType |st#0@@6| Tclass.StackMachine.State) ($IsAlloc DatatypeTypeType |st#0@@6| Tclass.StackMachine.State $Heap@@0)) (|$IsA#StackMachine.State| |st#0@@6|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct)))))
