...
(set-info :boogie-vc-id Impl$$VarUnchanged.__default.InductBind__Fail)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (VarUnchanged.__default.Pes__Fail |st#0@@26| |bvals#0@@3|))) (=> (not (VarUnchanged.__default.Pes__Fail |st#0@@26| |bvals#0@@3|)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|st1#1| T@U) (|vs#1@@1| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |st1#1| Tclass.VarUnchanged.S) ($Is SeqType |vs#1@@1| (TSeq TInt))) (VarUnchanged.__default.Pes__Succ |st#0@@26| |bvals#0@@3| |st1#1| |vs#1@@1|)) (and (VarUnchanged.__default.UpdateState__Pre |st1#1| |bvars#0@@2| |vs#1@@1|) (not (VarUnchanged.__default.P__Fail (VarUnchanged.__default.BindStartScope |st1#1| |bvars#0@@2| |vs#1@@1|) |body#0@@2|))))
 :qid |Inductiondfy.165:14|
 :skolemid |861|
 :pattern ( (VarUnchanged.__default.BindStartScope |st1#1| |bvars#0@@2| |vs#1@@1|))
 :pattern ( (VarUnchanged.__default.UpdateState__Pre |st1#1| |bvars#0@@2| |vs#1@@1|))
 :pattern ( (VarUnchanged.__default.Pes__Succ |st#0@@26| |bvals#0@@3| |st1#1| |vs#1@@1|))
))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and ($Is DatatypeTypeType |st#0@@26| Tclass.VarUnchanged.S) ($IsAlloc DatatypeTypeType |st#0@@26| Tclass.VarUnchanged.S $Heap@@6)) (|$IsA#VarUnchanged.MState| |st#0@@26|)) (and (and ($Is DatatypeTypeType |e#0@@24| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@24| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@24|))) (=> (and (and (and (and ($Is SeqType |bvars#0@@2| (TSeq (TSeq TChar))) ($IsAlloc SeqType |bvars#0@@2| (TSeq (TSeq TChar)) $Heap@@6)) (and ($Is SeqType |bvals#0@@3| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |bvals#0@@3| (TSeq Tclass.AST.Expr) $Heap@@6))) (and (and ($Is DatatypeTypeType |body#0@@2| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |body#0@@2| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |body#0@@2|))) (and (and (and (= 5 $FunctionContextHeight) (AST.Expr__Raw.Bind_q |e#0@@24|)) (and (|Seq#Equal| (AST.Expr__Raw.bvars |e#0@@24|) |bvars#0@@2|) (|Seq#Equal| (AST.Expr__Raw.bvals |e#0@@24|) |bvals#0@@3|))) (and (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.body |e#0@@24|) |body#0@@2|) (not (VarUnchanged.__default.P__Fail |st#0@@26| |e#0@@24|))) (and (VarUnchanged.__default.Pes |st#0@@26| |bvals#0@@3|) (= (ControlFlow 0 4) 2))))) anon0_correct)))))
