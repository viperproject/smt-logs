...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0| T@U) (|es#0@@0| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Step#canCall| |st#0| |es#0@@0|) (and (< 4 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0| Tclass.Equiv.MState) ($Is SeqType |es#0@@0| (TSeq Tclass.AST.Expr))) (and (Equiv.__default.Pes |st#0| |es#0@@0|) (not (Equiv.__default.Pes__Fail |st#0| |es#0@@0|)))))) (and (and (and (Equiv.MState.MState_q |st#0|) (|Interp.__default.InterpExprs#canCall| |es#0@@0| (Equiv.MState.ctx |st#0|))) (and (Equiv.MState.MState_q |st#0|) (|Interp.__default.InterpExprs#canCall| |es#0@@0| (Equiv.MState.ctx_k |st#0|)))) (= (Equiv.__default.Pes__Step |st#0| |es#0@@0|) (let ((|ctx1#0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs ($LS $LZ) |es#0@@0| (Equiv.MState.ctx |st#0|))))))))
(let ((|vs#0@@0| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs ($LS $LZ) |es#0@@0| (Equiv.MState.ctx |st#0|))))))))
(let ((|ctx1'#0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs ($LS $LZ) |es#0@@0| (Equiv.MState.ctx_k |st#0|))))))))
(let ((|vs'#0| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs ($LS $LZ) |es#0@@0| (Equiv.MState.ctx_k |st#0|))))))))
(|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#Equiv.MState.MState| |ctx1#0| |ctx1'#0|)) ($Box DatatypeTypeType (|#Equiv.MSeqValue.MSeqValue| |vs#0@@0| |vs'#0|))))))))))
 :qid |Inductiondfy.71:27|
 :skolemid |801|
 :pattern ( (Equiv.__default.Pes__Step |st#0| |es#0@@0|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@0| T@U) (|es#0@@2| T@U) ) (!  (=> (or (|Equiv.__default.Pes#canCall| |st#0@@0| (Lit SeqType |es#0@@2|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@0| Tclass.Equiv.MState) ($Is SeqType |es#0@@2| (TSeq Tclass.AST.Expr))))) (and (and (and (Equiv.MState.MState_q |st#0@@0|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@2|) (Equiv.MState.ctx |st#0@@0|))) (let ((|res#1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@2|) (Equiv.MState.ctx |st#0@@0|))))
 (and (and (Equiv.MState.MState_q |st#0@@0|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@2|) (Equiv.MState.ctx_k |st#0@@0|))) (let ((|res'#1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@2|) (Equiv.MState.ctx_k |st#0@@0|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@0|) (=> (Equiv.__default.Inv |st#0@@0|) (|Equiv.__default.EqResultSeq#canCall| |res#1| |res'#1|))))))) (= (Equiv.__default.Pes |st#0@@0| (Lit SeqType |es#0@@2|)) (let ((|res#1@@0| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@2|) (Equiv.MState.ctx |st#0@@0|))))
(let ((|res'#1@@0| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@2|) (Equiv.MState.ctx_k |st#0@@0|))))
 (=> (Equiv.__default.Inv |st#0@@0|) (Equiv.__default.EqResultSeq |res#1@@0| |res'#1@@0|)))))))
 :qid |Inductiondfy.39:23|
 :weight 3
 :skolemid |714|
 :pattern ( (Equiv.__default.Pes |st#0@@0| (Lit SeqType |es#0@@2|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|es#0@@3| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Fail#canCall| |st#0@@2| |es#0@@3|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@2| Tclass.Equiv.MState) ($Is SeqType |es#0@@3| (TSeq Tclass.AST.Expr))))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@2|) (=> (Equiv.__default.Inv |st#0@@2|) (and (Equiv.MState.MState_q |st#0@@2|) (|Interp.__default.InterpExprs#canCall| |es#0@@3| (Equiv.MState.ctx |st#0@@2|))))) (= (Equiv.__default.Pes__Fail |st#0@@2| |es#0@@3|)  (=> (Equiv.__default.Inv |st#0@@2|) (Utils.Result.Failure_q (Interp.__default.InterpExprs ($LS $LZ) |es#0@@3| (Equiv.MState.ctx |st#0@@2|)))))))
 :qid |Inductiondfy.41:28|
 :skolemid |732|
 :pattern ( (Equiv.__default.Pes__Fail |st#0@@2| |es#0@@3|))
))))
...
(assert (forall ((d@@22 T@U) ) (!  (=> (Equiv.MSeqValue.MSeqValue_q d@@22) (exists ((|a#17#0#0| T@U) (|a#17#1#0| T@U) ) (! (= d@@22 (|#Equiv.MSeqValue.MSeqValue| |a#17#0#0| |a#17#1#0|))
 :qid |Equivdfy.64:34|
 :skolemid |921|
)))
 :qid |unknown.0:0|
 :skolemid |922|
 :pattern ( (Equiv.MSeqValue.MSeqValue_q d@@22))
)))
...
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@2|)))
 (and (AST.Expr__Raw.All $ly@@1 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@1 |oe2#0| |p#0|)))) (let ((|es#0@@4| (AST.Expr__Raw.es |e#0@@2|)))
...
(assert (forall (($ly@@2 T@U) (|es#0@@5| T@U) (|ctx#0@@1| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@5| |ctx#0@@1|) (and ($Is SeqType |es#0@@5| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@1| (TMap (TSeq TChar) TInt)))) (and (=> (Utils.Result.Success_q (Interp.__default.InterpExprs $ly@@2 |es#0@@5| |ctx#0@@1|)) (= (|Seq#Length| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs $ly@@2 |es#0@@5| |ctx#0@@1|)))))) (|Seq#Length| |es#0@@5|))) ($Is DatatypeTypeType (Interp.__default.InterpExprs $ly@@2 |es#0@@5| |ctx#0@@1|) (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))
 :qid |Interpdfy.69:12|
 :skolemid |1205|
 :pattern ( (Interp.__default.InterpExprs $ly@@2 |es#0@@5| |ctx#0@@1|))
)))
...
(assert (forall (($ly@@6 T@U) (|es#0@@6| T@U) (|ctx#0@@5| T@U) ) (! (= (Interp.__default.InterpExprs ($LS $ly@@6) |es#0@@6| |ctx#0@@5|) (Interp.__default.InterpExprs $ly@@6 |es#0@@6| |ctx#0@@5|))
 :qid |Interpdfy.69:12|
 :skolemid |1203|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@6) |es#0@@6| |ctx#0@@5|))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|es#0@@7| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Step#canCall| (Lit DatatypeTypeType |st#0@@4|) (Lit SeqType |es#0@@7|)) (and (< 4 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@4| Tclass.Equiv.MState) ($Is SeqType |es#0@@7| (TSeq Tclass.AST.Expr))) (and (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Pes (Lit DatatypeTypeType |st#0@@4|) (Lit SeqType |es#0@@7|))))) (not (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@4|) (Lit SeqType |es#0@@7|)))))))))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@4|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@7|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@4|))))) (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@4|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@7|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@4|)))))) (= (Equiv.__default.Pes__Step (Lit DatatypeTypeType |st#0@@4|) (Lit SeqType |es#0@@7|)) (let ((|ctx1#2@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@7|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@4|)))))))))))
(let ((|vs#2@@2| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@7|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@4|)))))))))))
(let ((|ctx1'#2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@7|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@4|)))))))))))
(let ((|vs'#2@@0| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@7|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@4|)))))))))))
(|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#Equiv.MState.MState| |ctx1#2@@2| |ctx1'#2|)) ($Box DatatypeTypeType (|#Equiv.MSeqValue.MSeqValue| |vs#2@@2| |vs'#2@@0|))))))))))
 :qid |Inductiondfy.71:27|
 :weight 3
 :skolemid |803|
 :pattern ( (Equiv.__default.Pes__Step (Lit DatatypeTypeType |st#0@@4|) (Lit SeqType |es#0@@7|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|es#0@@8| T@U) (|st'#0| T@U) (|vs#0@@2| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Succ#canCall| |st#0@@5| |es#0@@8| |st'#0| |vs#0@@2|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@5| Tclass.Equiv.MState) ($Is SeqType |es#0@@8| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#0@@2| Tclass.Equiv.VS)))) (and (and (and (Equiv.MState.MState_q |st#0@@5|) (|Interp.__default.InterpExprs#canCall| |es#0@@8| (Equiv.MState.ctx |st#0@@5|))) (let ((|res#0@@0| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@8| (Equiv.MState.ctx |st#0@@5|))))
 (and (and (Equiv.MState.MState_q |st#0@@5|) (|Interp.__default.InterpExprs#canCall| |es#0@@8| (Equiv.MState.ctx_k |st#0@@5|))) (let ((|res'#0@@0| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@8| (Equiv.MState.ctx_k |st#0@@5|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@5|) (=> (Equiv.__default.Inv |st#0@@5|) (and (|Equiv.__default.EqResultSeq#canCall| |res#0@@0| |res'#0@@0|) (=> (Equiv.__default.EqResultSeq |res#0@@0| |res'#0@@0|) (and (and (|$IsA#Utils.Result| |res#0@@0|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@2|) (Equiv.MState.MState_q |st'#0|))) (=> (|Utils.Result#Equal| |res#0@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@2|)) ($Box MapType (Equiv.MState.ctx |st'#0|)))))) (and (|$IsA#Utils.Result| |res'#0@@0|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@2|) (Equiv.MState.MState_q |st'#0|))))))))))))) (= (Equiv.__default.Pes__Succ |st#0@@5| |es#0@@8| |st'#0| |vs#0@@2|) (let ((|res#0@@1| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@8| (Equiv.MState.ctx |st#0@@5|))))
(let ((|res'#0@@1| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@8| (Equiv.MState.ctx_k |st#0@@5|))))
 (and (and (and (Equiv.__default.Inv |st#0@@5|) (Equiv.__default.EqResultSeq |res#0@@1| |res'#0@@1|)) (|Utils.Result#Equal| |res#0@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@2|)) ($Box MapType (Equiv.MState.ctx |st'#0|))))))) (|Utils.Result#Equal| |res'#0@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs_k |vs#0@@2|)) ($Box MapType (Equiv.MState.ctx_k |st'#0|))))))))))))
 :qid |Inductiondfy.40:28|
 :skolemid |723|
 :pattern ( (Equiv.__default.Pes__Succ |st#0@@5| |es#0@@8| |st'#0| |vs#0@@2|))
))))
...
(assert (forall (($ly@@9 T@U) (|es#0@@9| T@U) (|ctx#0@@7| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@9| |ctx#0@@7|) (and ($Is SeqType |es#0@@9| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@7| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@9| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@9| (LitInt 0))) |ctx#0@@7|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@9 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@9| (LitInt 0))) |ctx#0@@7|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (|Seq#Drop| |es#0@@9| (LitInt 1)) |ctx1#0@@1|) (let ((|valueOrError1#0@@0| (Interp.__default.InterpExprs $ly@@9 (|Seq#Drop| |es#0@@9| (LitInt 1)) |ctx1#0@@1|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@9) |es#0@@9| |ctx#0@@7|) (ite (|Seq#Equal| |es#0@@9| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@7|)))) (let ((|valueOrError0#0@@1| (Interp.__default.InterpExpr $ly@@9 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@9| (LitInt 0))) |ctx#0@@7|)))
...
(let ((|valueOrError1#0@@1| (Interp.__default.InterpExprs $ly@@9 (|Seq#Drop| |es#0@@9| (LitInt 1)) |ctx1#0@@2|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0|))) |vs#0@@3|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1207|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@9) |es#0@@9| |ctx#0@@7|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|es#0@@10| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Fail#canCall| |st#0@@6| (Lit SeqType |es#0@@10|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.Equiv.MState) ($Is SeqType |es#0@@10| (TSeq Tclass.AST.Expr))))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@6|) (=> (Equiv.__default.Inv |st#0@@6|) (and (Equiv.MState.MState_q |st#0@@6|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@10|) (Equiv.MState.ctx |st#0@@6|))))) (= (Equiv.__default.Pes__Fail |st#0@@6| (Lit SeqType |es#0@@10|))  (=> (Equiv.__default.Inv |st#0@@6|) (Utils.Result.Failure_q (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@10|) (Equiv.MState.ctx |st#0@@6|)))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |733|
 :pattern ( (Equiv.__default.Pes__Fail |st#0@@6| (Lit SeqType |es#0@@10|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|es#0@@11| T@U) (|st'#0@@0| T@U) (|vs#0@@4| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Succ#canCall| (Lit DatatypeTypeType |st#0@@7|) (Lit SeqType |es#0@@11|) (Lit DatatypeTypeType |st'#0@@0|) (Lit DatatypeTypeType |vs#0@@4|)) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@7| Tclass.Equiv.MState) ($Is SeqType |es#0@@11| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@0| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#0@@4| Tclass.Equiv.VS)))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@7|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@11|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@7|))))) (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@7|)))))))
 (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@7|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@11|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@7|))))) (let ((|res'#2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@7|)))))))
 (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@7|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@7|))))) (and (|Equiv.__default.EqResultSeq#canCall| |res#2| |res'#2|) (=> (Equiv.__default.EqResultSeq |res#2| |res'#2|) (and (and (|$IsA#Utils.Result| |res#2|) (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |vs#0@@4|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|)))) (=> (|Utils.Result#Equal| |res#2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |vs#0@@4|)))) ($Box MapType (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st'#0@@0|))))))))) (and (|$IsA#Utils.Result| |res'#2|) (and (Equiv.MSeqValue.MSeqValue_q (Lit DatatypeTypeType |vs#0@@4|)) (Equiv.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|)))))))))))))) (= (Equiv.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@7|) (Lit SeqType |es#0@@11|) (Lit DatatypeTypeType |st'#0@@0|) (Lit DatatypeTypeType |vs#0@@4|)) (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@7|)))))))
(let ((|res'#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@11|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@7|)))))))
 (and (and (and (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@7|)) (Equiv.__default.EqResultSeq |res#2@@0| |res'#2@@0|)) (|Utils.Result#Equal| |res#2@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType (Equiv.MSeqValue.vs (Lit DatatypeTypeType |vs#0@@4|)))) ($Box MapType (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st'#0@@0|)))))))))) (|Utils.Result#Equal| |res'#2@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType (Equiv.MSeqValue.vs_k (Lit DatatypeTypeType |vs#0@@4|)))) ($Box MapType (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st'#0@@0|)))))))))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |725|
 :pattern ( (Equiv.__default.Pes__Succ (Lit DatatypeTypeType |st#0@@7|) (Lit SeqType |es#0@@11|) (Lit DatatypeTypeType |st'#0@@0|) (Lit DatatypeTypeType |vs#0@@4|)))
))))
...
(assert (forall (($ly@@10 T@U) (|es#0@@12| T@U) (|ctx#0@@8| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@12|) |ctx#0@@8|) (and ($Is SeqType |es#0@@12| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@8| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@12| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@12|) (LitInt 0))) |ctx#0@@8|) (let ((|valueOrError0#1@@0| (Interp.__default.InterpExpr ($LS $ly@@10) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@12|) (LitInt 0))) |ctx#0@@8|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@12|) (LitInt 1))) |ctx1#1@@0|) (let ((|valueOrError1#1@@0| (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@12|) (LitInt 1))) |ctx1#1@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType |es#0@@12|) |ctx#0@@8|) (ite (|Seq#Equal| |es#0@@12| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@8|)))) (let ((|valueOrError0#1@@1| (Interp.__default.InterpExpr ($LS $ly@@10) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@12|) (LitInt 0))) |ctx#0@@8|)))
...
(let ((|valueOrError1#1@@1| (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@12|) (LitInt 1))) |ctx1#1@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#1|))) |vs#1@@0|)) ($Box MapType |ctx2#1@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |1208|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType |es#0@@12|) |ctx#0@@8|))
)))
...
(let ((|vs'#0@@0| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))))))))))
...
(let ((|vs#0@@5| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@2|) ($Box DatatypeTypeType |res'#0@@2|))))))))))
 (and (Equiv.__default.EqSeqValue |vs#0@@5| |vs'#0@@0|) (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#0@@9| |ctx'#0@@1|)))))) false) true))))
 :qid |Equivdfy.45:31|
 :skolemid |673|
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|es#0@@13| T@U) (|st'#0@@1| T@U) (|vs#0@@6| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Succ#canCall| |st#0@@8| (Lit SeqType |es#0@@13|) |st'#0@@1| |vs#0@@6|) (and (< 3 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@8| Tclass.Equiv.MState) ($Is SeqType |es#0@@13| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@1| Tclass.Equiv.MState)) ($Is DatatypeTypeType |vs#0@@6| Tclass.Equiv.VS)))) (and (and (and (Equiv.MState.MState_q |st#0@@8|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@13|) (Equiv.MState.ctx |st#0@@8|))) (let ((|res#1@@1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@13|) (Equiv.MState.ctx |st#0@@8|))))
 (and (and (Equiv.MState.MState_q |st#0@@8|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@13|) (Equiv.MState.ctx_k |st#0@@8|))) (let ((|res'#1@@1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@13|) (Equiv.MState.ctx_k |st#0@@8|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@8|) (=> (Equiv.__default.Inv |st#0@@8|) (and (|Equiv.__default.EqResultSeq#canCall| |res#1@@1| |res'#1@@1|) (=> (Equiv.__default.EqResultSeq |res#1@@1| |res'#1@@1|) (and (and (|$IsA#Utils.Result| |res#1@@1|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@6|) (Equiv.MState.MState_q |st'#0@@1|))) (=> (|Utils.Result#Equal| |res#1@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@6|)) ($Box MapType (Equiv.MState.ctx |st'#0@@1|)))))) (and (|$IsA#Utils.Result| |res'#1@@1|) (and (Equiv.MSeqValue.MSeqValue_q |vs#0@@6|) (Equiv.MState.MState_q |st'#0@@1|))))))))))))) (= (Equiv.__default.Pes__Succ |st#0@@8| (Lit SeqType |es#0@@13|) |st'#0@@1| |vs#0@@6|) (let ((|res#1@@2| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@13|) (Equiv.MState.ctx |st#0@@8|))))
(let ((|res'#1@@2| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@13|) (Equiv.MState.ctx_k |st#0@@8|))))
 (and (and (and (Equiv.__default.Inv |st#0@@8|) (Equiv.__default.EqResultSeq |res#1@@2| |res'#1@@2|)) (|Utils.Result#Equal| |res#1@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs |vs#0@@6|)) ($Box MapType (Equiv.MState.ctx |st'#0@@1|))))))) (|Utils.Result#Equal| |res'#1@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs_k |vs#0@@6|)) ($Box MapType (Equiv.MState.ctx_k |st'#0@@1|))))))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |724|
 :pattern ( (Equiv.__default.Pes__Succ |st#0@@8| (Lit SeqType |es#0@@13|) |st'#0@@1| |vs#0@@6|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@9| T@U) (|es#0@@14| T@U) ) (!  (=> (or (|Equiv.__default.Pes#canCall| |st#0@@9| |es#0@@14|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@9| Tclass.Equiv.MState) ($Is SeqType |es#0@@14| (TSeq Tclass.AST.Expr))))) (and (and (and (Equiv.MState.MState_q |st#0@@9|) (|Interp.__default.InterpExprs#canCall| |es#0@@14| (Equiv.MState.ctx |st#0@@9|))) (let ((|res#0@@3| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@14| (Equiv.MState.ctx |st#0@@9|))))
 (and (and (Equiv.MState.MState_q |st#0@@9|) (|Interp.__default.InterpExprs#canCall| |es#0@@14| (Equiv.MState.ctx_k |st#0@@9|))) (let ((|res'#0@@3| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@14| (Equiv.MState.ctx_k |st#0@@9|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@9|) (=> (Equiv.__default.Inv |st#0@@9|) (|Equiv.__default.EqResultSeq#canCall| |res#0@@3| |res'#0@@3|))))))) (= (Equiv.__default.Pes |st#0@@9| |es#0@@14|) (let ((|res#0@@4| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@14| (Equiv.MState.ctx |st#0@@9|))))
(let ((|res'#0@@4| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@14| (Equiv.MState.ctx_k |st#0@@9|))))
 (=> (Equiv.__default.Inv |st#0@@9|) (Equiv.__default.EqResultSeq |res#0@@4| |res'#0@@4|)))))))
 :qid |Inductiondfy.39:23|
 :skolemid |713|
 :pattern ( (Equiv.__default.Pes |st#0@@9| |es#0@@14|))
))))
...
(assert (forall ((d@@35 T@U) (Utils.Result$T@@14 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (Utils.Result.Success_q d@@35) ($IsAlloc DatatypeTypeType d@@35 (Tclass.Utils.Result Utils.Result$T@@14) $h@@6))) ($IsAllocBox (Utils.Result.value d@@35) Utils.Result$T@@14 $h@@6))
 :qid |unknown.0:0|
 :skolemid |965|
 :pattern ( ($IsAllocBox (Utils.Result.value d@@35) Utils.Result$T@@14 $h@@6))
)))
...
(assert (forall ((d@@36 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (AST.Expr__Raw.Literal_q d@@36) ($IsAlloc DatatypeTypeType d@@36 Tclass.AST.Expr__Raw $h@@7))) ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@36)) TInt $h@@7))
 :qid |unknown.0:0|
 :skolemid |1042|
 :pattern ( ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@36)) TInt $h@@7))
)))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@10| T@U) (|es#0@@15| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Step#canCall| |st#0@@10| (Lit SeqType |es#0@@15|)) (and (< 4 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@10| Tclass.Equiv.MState) ($Is SeqType |es#0@@15| (TSeq Tclass.AST.Expr))) (and (Equiv.__default.Pes |st#0@@10| (Lit SeqType |es#0@@15|)) (not (Equiv.__default.Pes__Fail |st#0@@10| (Lit SeqType |es#0@@15|))))))) (and (and (and (Equiv.MState.MState_q |st#0@@10|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@15|) (Equiv.MState.ctx |st#0@@10|))) (and (Equiv.MState.MState_q |st#0@@10|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@15|) (Equiv.MState.ctx_k |st#0@@10|)))) (= (Equiv.__default.Pes__Step |st#0@@10| (Lit SeqType |es#0@@15|)) (let ((|ctx1#1@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@15|) (Equiv.MState.ctx |st#0@@10|))))))))
(let ((|vs#1@@2| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@15|) (Equiv.MState.ctx |st#0@@10|))))))))
(let ((|ctx1'#1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@15|) (Equiv.MState.ctx_k |st#0@@10|))))))))
(let ((|vs'#1@@0| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@15|) (Equiv.MState.ctx_k |st#0@@10|))))))))
(|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#Equiv.MState.MState| |ctx1#1@@2| |ctx1'#1|)) ($Box DatatypeTypeType (|#Equiv.MSeqValue.MSeqValue| |vs#1@@2| |vs'#1@@0|))))))))))
 :qid |Inductiondfy.71:27|
 :weight 3
 :skolemid |802|
 :pattern ( (Equiv.__default.Pes__Step |st#0@@10| (Lit SeqType |es#0@@15|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@11| T@U) (|es#0@@16| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Fail#canCall| (Lit DatatypeTypeType |st#0@@11|) (Lit SeqType |es#0@@16|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@11| Tclass.Equiv.MState) ($Is SeqType |es#0@@16| (TSeq Tclass.AST.Expr))))) (and (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@11|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@11|))))) (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@11|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@16|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@11|))))))) (= (Equiv.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@11|) (Lit SeqType |es#0@@16|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@11|)) (Utils.Result.Failure_q (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@16|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@11|)))))))))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |734|
 :pattern ( (Equiv.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@11|) (Lit SeqType |es#0@@16|)))
))))
...
(assert (forall ((d@@39 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) ($Is DatatypeTypeType d@@39 Tclass.Equiv.MState)) ($IsAlloc DatatypeTypeType d@@39 Tclass.Equiv.MState $h@@8))
 :qid |unknown.0:0|
 :skolemid |899|
 :pattern ( ($IsAlloc DatatypeTypeType d@@39 Tclass.Equiv.MState $h@@8))
)))
(assert (forall ((d@@40 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) ($Is DatatypeTypeType d@@40 Tclass.Equiv.MSeqValue)) ($IsAlloc DatatypeTypeType d@@40 Tclass.Equiv.MSeqValue $h@@9))
 :qid |unknown.0:0|
 :skolemid |934|
 :pattern ( ($IsAlloc DatatypeTypeType d@@40 Tclass.Equiv.MSeqValue $h@@9))
)))
(assert (forall ((d@@41 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) ($Is DatatypeTypeType d@@41 Tclass.AST.BinOp)) ($IsAlloc DatatypeTypeType d@@41 Tclass.AST.BinOp $h@@10))
 :qid |unknown.0:0|
 :skolemid |1020|
 :pattern ( ($IsAlloc DatatypeTypeType d@@41 Tclass.AST.BinOp $h@@10))
)))
(assert (forall ((d@@42 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) ($Is DatatypeTypeType d@@42 Tclass.AST.Expr__Raw)) ($IsAlloc DatatypeTypeType d@@42 Tclass.AST.Expr__Raw $h@@11))
 :qid |unknown.0:0|
 :skolemid |1116|
 :pattern ( ($IsAlloc DatatypeTypeType d@@42 Tclass.AST.Expr__Raw $h@@11))
)))
...
(assert (forall ((d@@43 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (Equiv.MSeqValue.MSeqValue_q d@@43) ($IsAlloc DatatypeTypeType d@@43 Tclass.Equiv.MSeqValue $h@@12))) ($IsAlloc SeqType (Equiv.MSeqValue.vs d@@43) (TSeq TInt) $h@@12))
 :qid |unknown.0:0|
 :skolemid |925|
 :pattern ( ($IsAlloc SeqType (Equiv.MSeqValue.vs d@@43) (TSeq TInt) $h@@12))
)))
(assert (forall ((d@@44 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (Equiv.MSeqValue.MSeqValue_q d@@44) ($IsAlloc DatatypeTypeType d@@44 Tclass.Equiv.MSeqValue $h@@13))) ($IsAlloc SeqType (Equiv.MSeqValue.vs_k d@@44) (TSeq TInt) $h@@13))
 :qid |unknown.0:0|
 :skolemid |926|
 :pattern ( ($IsAlloc SeqType (Equiv.MSeqValue.vs_k d@@44) (TSeq TInt) $h@@13))
)))
...
(assert (forall ((d@@48 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (Equiv.MState.MState_q d@@48) ($IsAlloc DatatypeTypeType d@@48 Tclass.Equiv.MState $h@@15))) ($IsAlloc MapType (Equiv.MState.ctx d@@48) (TMap (TSeq TChar) TInt) $h@@15))
 :qid |unknown.0:0|
 :skolemid |890|
 :pattern ( ($IsAlloc MapType (Equiv.MState.ctx d@@48) (TMap (TSeq TChar) TInt) $h@@15))
)))
(assert (forall ((d@@49 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (Equiv.MState.MState_q d@@49) ($IsAlloc DatatypeTypeType d@@49 Tclass.Equiv.MState $h@@16))) ($IsAlloc MapType (Equiv.MState.ctx_k d@@49) (TMap (TSeq TChar) TInt) $h@@16))
 :qid |unknown.0:0|
 :skolemid |891|
 :pattern ( ($IsAlloc MapType (Equiv.MState.ctx_k d@@49) (TMap (TSeq TChar) TInt) $h@@16))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@12| T@U) (|es#0@@17| T@U) ) (!  (=> (or (|Equiv.__default.Pes#canCall| (Lit DatatypeTypeType |st#0@@12|) (Lit SeqType |es#0@@17|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@12| Tclass.Equiv.MState) ($Is SeqType |es#0@@17| (TSeq Tclass.AST.Expr))))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@12|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@17|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@12|))))) (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@17|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@12|)))))))
 (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@12|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@17|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@12|))))) (let ((|res'#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@17|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@12|)))))))
 (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@12|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@12|))))) (|Equiv.__default.EqResultSeq#canCall| |res#2@@1| |res'#2@@1|))))))) (= (Equiv.__default.Pes (Lit DatatypeTypeType |st#0@@12|) (Lit SeqType |es#0@@17|)) (U_2_bool (let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@17|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@12|)))))))
(let ((|res'#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@17|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@12|)))))))
(Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@12|)) (Equiv.__default.EqResultSeq |res#2@@2| |res'#2@@2|))))))))))
 :qid |Inductiondfy.39:23|
 :weight 3
 :skolemid |715|
 :pattern ( (Equiv.__default.Pes (Lit DatatypeTypeType |st#0@@12|) (Lit SeqType |es#0@@17|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@13| T@U) (|es#0@@18| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Step#canCall| |st#0@@13| |es#0@@18|) (and (< 4 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@13| Tclass.Equiv.MState) ($Is SeqType |es#0@@18| (TSeq Tclass.AST.Expr))) (and (Equiv.__default.Pes |st#0@@13| |es#0@@18|) (not (Equiv.__default.Pes__Fail |st#0@@13| |es#0@@18|)))))) (and (Equiv.__default.Pes__Succ |st#0@@13| |es#0@@18| ($Unbox DatatypeTypeType (_System.Tuple2._0 (Equiv.__default.Pes__Step |st#0@@13| |es#0@@18|))) ($Unbox DatatypeTypeType (_System.Tuple2._1 (Equiv.__default.Pes__Step |st#0@@13| |es#0@@18|)))) ($Is DatatypeTypeType (Equiv.__default.Pes__Step |st#0@@13| |es#0@@18|) (Tclass._System.Tuple2 Tclass.Equiv.MState Tclass.Equiv.VS))))
 :qid |Inductiondfy.71:27|
 :skolemid |799|
 :pattern ( (Equiv.__default.Pes__Step |st#0@@13| |es#0@@18|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$Equiv.__default.Pes__Step)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 3) (- 0 11)) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.Pes__Succ |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (=> (|Equiv.__default.Inv#canCall| |st#0@@14|) (or (Equiv.__default.Inv |st#0@@14|) (U_2_bool (Lit boolType (bool_2_U true)))))))) (=> (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.Pes__Succ |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (=> (|Equiv.__default.Inv#canCall| |st#0@@14|) (or (Equiv.__default.Inv |st#0@@14|) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 3) (- 0 10)) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.Pes__Succ |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (=> (|Equiv.__default.Inv#canCall| |st#0@@14|) (or (Equiv.__default.Inv |st#0@@14|) (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx (Equiv.MState.ctx |st#0@@14|) (Equiv.MState.ctx_k |st#0@@14|))))))) (=> (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.Pes__Succ |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (=> (|Equiv.__default.Inv#canCall| |st#0@@14|) (or (Equiv.__default.Inv |st#0@@14|) (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx (Equiv.MState.ctx |st#0@@14|) (Equiv.MState.ctx_k |st#0@@14|)))))) (and (=> (= (ControlFlow 0 3) (- 0 9)) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.Pes__Succ |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (let ((|res#1@@3| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@19| (Equiv.MState.ctx |st#0@@14|))))
(let ((|res'#0@@5| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@19| (Equiv.MState.ctx_k |st#0@@14|))))
 (=> (|Equiv.__default.EqResultSeq#canCall| |res#1@@3| |res'#0@@5|) (or (Equiv.__default.EqResultSeq |res#1@@3| |res'#0@@5|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#0@@5|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#0@@5|))))) (let ((|vs'#3@@0| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#0@@5|))))))))))
(let ((|vs#3@@1| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#0@@5|))))))))))
 (=> (|Equiv.__default.EqSeqValue#canCall| |vs#3@@1| |vs'#3@@0|) (or (Equiv.__default.EqSeqValue |vs#3@@1| |vs'#3@@0|) (= (|Seq#Length| |vs#3@@1|) (|Seq#Length| |vs'#3@@0|))))))))))))))) (=> (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.Pes__Succ |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (let ((|res#1@@4| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@19| (Equiv.MState.ctx |st#0@@14|))))
(let ((|res'#0@@6| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@19| (Equiv.MState.ctx_k |st#0@@14|))))
 (=> (|Equiv.__default.EqResultSeq#canCall| |res#1@@4| |res'#0@@6|) (or (Equiv.__default.EqResultSeq |res#1@@4| |res'#0@@6|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#0@@6|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#0@@6|))))) (let ((|vs'#3@@1| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#0@@6|))))))))))
(let ((|vs#3@@2| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#0@@6|))))))))))
 (=> (|Equiv.__default.EqSeqValue#canCall| |vs#3@@2| |vs'#3@@1|) (or (Equiv.__default.EqSeqValue |vs#3@@2| |vs'#3@@1|) (= (|Seq#Length| |vs#3@@2|) (|Seq#Length| |vs'#3@@1|)))))))))))))) (and (=> (= (ControlFlow 0 3) (- 0 8)) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.Pes__Succ |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (let ((|res#1@@5| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@19| (Equiv.MState.ctx |st#0@@14|))))
(let ((|res'#0@@7| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@19| (Equiv.MState.ctx_k |st#0@@14|))))
 (=> (|Equiv.__default.EqResultSeq#canCall| |res#1@@5| |res'#0@@7|) (or (Equiv.__default.EqResultSeq |res#1@@5| |res'#0@@7|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#0@@7|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#0@@7|))))) (let ((|vs'#3@@2| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#0@@7|))))))))))
(let ((|vs#3@@3| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#0@@7|))))))))))
 (=> (|Equiv.__default.EqSeqValue#canCall| |vs#3@@3| |vs'#3@@2|) (or (Equiv.__default.EqSeqValue |vs#3@@3| |vs'#3@@2|) (forall ((|i#0@@1| Int) ) (!  (=> (and (<= (LitInt 0) |i#0@@1|) (< |i#0@@1| (|Seq#Length| |vs#3@@3|))) (Equiv.__default.EqValue (U_2_int ($Unbox intType (|Seq#Index| |vs#3@@3| |i#0@@1|))) (U_2_int ($Unbox intType (|Seq#Index| |vs'#3@@2| |i#0@@1|)))))
 :qid |Equivdfy.24:15|
 :skolemid |804|
 :pattern ( ($Unbox intType (|Seq#Index| |vs'#3@@2| |i#0@@1|)))
 :pattern ( ($Unbox intType (|Seq#Index| |vs#3@@3| |i#0@@1|)))
))))))))))))))) (=> (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.Pes__Succ |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (let ((|res#1@@6| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@19| (Equiv.MState.ctx |st#0@@14|))))
(let ((|res'#0@@8| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@19| (Equiv.MState.ctx_k |st#0@@14|))))
 (=> (|Equiv.__default.EqResultSeq#canCall| |res#1@@6| |res'#0@@8|) (or (Equiv.__default.EqResultSeq |res#1@@6| |res'#0@@8|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#0@@8|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#0@@8|))))) (let ((|vs'#3@@3| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#0@@8|))))))))))
(let ((|vs#3@@4| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#0@@8|))))))))))
 (=> (|Equiv.__default.EqSeqValue#canCall| |vs#3@@4| |vs'#3@@3|) (or (Equiv.__default.EqSeqValue |vs#3@@4| |vs'#3@@3|) (forall ((|i#0@@2| Int) ) (!  (=> (and (<= (LitInt 0) |i#0@@2|) (< |i#0@@2| (|Seq#Length| |vs#3@@4|))) (Equiv.__default.EqValue (U_2_int ($Unbox intType (|Seq#Index| |vs#3@@4| |i#0@@2|))) (U_2_int ($Unbox intType (|Seq#Index| |vs'#3@@3| |i#0@@2|)))))
 :qid |Equivdfy.24:15|
 :skolemid |804|
 :pattern ( ($Unbox intType (|Seq#Index| |vs'#3@@3| |i#0@@2|)))
 :pattern ( ($Unbox intType (|Seq#Index| |vs#3@@4| |i#0@@2|)))
)))))))))))))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.Pes__Succ |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (let ((|res#1@@7| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@19| (Equiv.MState.ctx |st#0@@14|))))
(let ((|res'#0@@9| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@19| (Equiv.MState.ctx_k |st#0@@14|))))
 (=> (|Equiv.__default.EqResultSeq#canCall| |res#1@@7| |res'#0@@9|) (or (Equiv.__default.EqResultSeq |res#1@@7| |res'#0@@9|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@7|) ($Box DatatypeTypeType |res'#0@@9|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@7|) ($Box DatatypeTypeType |res'#0@@9|))))) (let ((|ctx'#0@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@7|) ($Box DatatypeTypeType |res'#0@@9|))))))))))
(let ((|ctx#0@@12| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@7|) ($Box DatatypeTypeType |res'#0@@9|))))))))))
(Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#0@@12| |ctx'#0@@2|)))))))))))) (=> (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.Pes__Succ |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (let ((|res#1@@8| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@19| (Equiv.MState.ctx |st#0@@14|))))
(let ((|res'#0@@10| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@19| (Equiv.MState.ctx_k |st#0@@14|))))
 (=> (|Equiv.__default.EqResultSeq#canCall| |res#1@@8| |res'#0@@10|) (or (Equiv.__default.EqResultSeq |res#1@@8| |res'#0@@10|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@8|) ($Box DatatypeTypeType |res'#0@@10|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@8|) ($Box DatatypeTypeType |res'#0@@10|))))) (let ((|ctx'#0@@3| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@8|) ($Box DatatypeTypeType |res'#0@@10|))))))))))
(let ((|ctx#0@@13| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@8|) ($Box DatatypeTypeType |res'#0@@10|))))))))))
(Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#0@@13| |ctx'#0@@3|))))))))))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.Pes__Succ |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (let ((|res#1@@9| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@19| (Equiv.MState.ctx |st#0@@14|))))
(let ((|res'#0@@11| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@19| (Equiv.MState.ctx_k |st#0@@14|))))
 (=> (|Equiv.__default.EqResultSeq#canCall| |res#1@@9| |res'#0@@11|) (or (Equiv.__default.EqResultSeq |res#1@@9| |res'#0@@11|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@9|) ($Box DatatypeTypeType |res'#0@@11|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@9|) ($Box DatatypeTypeType |res'#0@@11|)))))) (U_2_bool (Lit boolType (bool_2_U false)))))))))))) (=> (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.Pes__Succ |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (let ((|res#1@@10| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@19| (Equiv.MState.ctx |st#0@@14|))))
(let ((|res'#0@@12| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@19| (Equiv.MState.ctx_k |st#0@@14|))))
 (=> (|Equiv.__default.EqResultSeq#canCall| |res#1@@10| |res'#0@@12|) (or (Equiv.__default.EqResultSeq |res#1@@10| |res'#0@@12|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@10|) ($Box DatatypeTypeType |res'#0@@12|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@10|) ($Box DatatypeTypeType |res'#0@@12|)))))) (U_2_bool (Lit boolType (bool_2_U false))))))))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.Pes__Succ |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (let ((|res#1@@11| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@19| (Equiv.MState.ctx |st#0@@14|))))
(let ((|res'#0@@13| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@19| (Equiv.MState.ctx_k |st#0@@14|))))
 (=> (|Equiv.__default.EqResultSeq#canCall| |res#1@@11| |res'#0@@13|) (or (Equiv.__default.EqResultSeq |res#1@@11| |res'#0@@13|) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@11|) ($Box DatatypeTypeType |res'#0@@13|)))))) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (=> (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.Pes__Succ |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (let ((|res#1@@12| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@19| (Equiv.MState.ctx |st#0@@14|))))
(let ((|res'#0@@14| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@19| (Equiv.MState.ctx_k |st#0@@14|))))
 (=> (|Equiv.__default.EqResultSeq#canCall| |res#1@@12| |res'#0@@14|) (or (Equiv.__default.EqResultSeq |res#1@@12| |res'#0@@14|) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@12|) ($Box DatatypeTypeType |res'#0@@14|)))))) (U_2_bool (Lit boolType (bool_2_U true)))))))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.Pes__Succ |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (let ((|res#1@@13| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@19| (Equiv.MState.ctx |st#0@@14|))))
(|Utils.Result#Equal| |res#1@@13| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|)))) ($Box MapType (Equiv.MState.ctx ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)))))))))))) (=> (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.Pes__Succ |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (let ((|res#1@@14| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@19| (Equiv.MState.ctx |st#0@@14|))))
(|Utils.Result#Equal| |res#1@@14| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|)))) ($Box MapType (Equiv.MState.ctx ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|))))))))))) (=> (= (ControlFlow 0 3) (- 0 2)) (=> (|Equiv.__default.Pes__Succ#canCall| |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (or (Equiv.__default.Pes__Succ |st#0@@14| |es#0@@19| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|)) ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|))) (let ((|res'#0@@15| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@19| (Equiv.MState.ctx_k |st#0@@14|))))
(|Utils.Result#Equal| |res'#0@@15| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Equiv.MSeqValue.vs_k ($Unbox DatatypeTypeType (_System.Tuple2._1 |res#0@@5|)))) ($Box MapType (Equiv.MState.ctx_k ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@5|))))))))))))))))))))))))))))))
(let ((anon5_Else_correct  (=> (and ($IsAlloc SeqType |es#0@@19| (TSeq Tclass.AST.Expr) $Heap@@6) (Equiv.MState.MState_q |st#0@@14|)) (=> (and (and (and (= |##ctx#0@0| (Equiv.MState.ctx |st#0@@14|)) ($IsAlloc MapType |##ctx#0@0| (TMap (TSeq TChar) TInt) $Heap@@6)) (and (|Interp.__default.InterpExprs#canCall| |es#0@@19| (Equiv.MState.ctx |st#0@@14|)) (= |let#0#0#0| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@19| (Equiv.MState.ctx |st#0@@14|))))) (and (and (Equiv.MState.MState_q |st#0@@14|) (|Interp.__default.InterpExprs#canCall| |es#0@@19| (Equiv.MState.ctx |st#0@@14|))) ($Is DatatypeTypeType |let#0#0#0| (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)))))) (and (=> (= (ControlFlow 0 12) (- 0 15)) (Utils.Result.Success_q |let#0#0#0|)) (=> (Utils.Result.Success_q |let#0#0#0|) (=> (and (and (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value |let#0#0#0|))) (= (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#Z#0@0|) ($Box MapType |ctx1#Z#0@0|)))) |let#0#0#0|)) (and ($IsAlloc SeqType |es#0@@19| (TSeq Tclass.AST.Expr) $Heap@@6) (Equiv.MState.MState_q |st#0@@14|))) (=> (and (and (and (= |##ctx#1@0| (Equiv.MState.ctx_k |st#0@@14|)) ($IsAlloc MapType |##ctx#1@0| (TMap (TSeq TChar) TInt) $Heap@@6)) (and (|Interp.__default.InterpExprs#canCall| |es#0@@19| (Equiv.MState.ctx_k |st#0@@14|)) (= |let#1#0#0| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@19| (Equiv.MState.ctx_k |st#0@@14|))))) (and (and (Equiv.MState.MState_q |st#0@@14|) (|Interp.__default.InterpExprs#canCall| |es#0@@19| (Equiv.MState.ctx_k |st#0@@14|))) ($Is DatatypeTypeType |let#1#0#0| (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)))))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (Utils.Result.Success_q |let#1#0#0|)) (=> (Utils.Result.Success_q |let#1#0#0|) (=> (and (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value |let#1#0#0|))) (= (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs'#Z#0@0|) ($Box MapType |ctx1'#Z#0@0|)))) |let#1#0#0|)) (and (=> (= (ControlFlow 0 12) (- 0 13)) ($Is DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#Equiv.MState.MState| |ctx1#Z#0@0| |ctx1'#Z#0@0|)) ($Box DatatypeTypeType (|#Equiv.MSeqValue.MSeqValue| |vs#Z#0@0| |vs'#Z#0@0|))) (Tclass._System.Tuple2 Tclass.Equiv.MState Tclass.Equiv.VS))) (=> ($Is DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#Equiv.MState.MState| |ctx1#Z#0@0| |ctx1'#Z#0@0|)) ($Box DatatypeTypeType (|#Equiv.MSeqValue.MSeqValue| |vs#Z#0@0| |vs'#Z#0@0|))) (Tclass._System.Tuple2 Tclass.Equiv.MState Tclass.Equiv.VS)) (=> (and (and (= (Equiv.__default.Pes__Step |st#0@@14| |es#0@@19|) (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#Equiv.MState.MState| |ctx1#Z#0@0| |ctx1'#Z#0@0|)) ($Box DatatypeTypeType (|#Equiv.MSeqValue.MSeqValue| |vs#Z#0@0| |vs'#Z#0@0|)))) ($Is DatatypeTypeType (Equiv.__default.Pes__Step |st#0@@14| |es#0@@19|) (Tclass._System.Tuple2 Tclass.Equiv.MState Tclass.Equiv.VS))) (and (= (Equiv.__default.Pes__Step |st#0@@14| |es#0@@19|) |res#0@@5|) (= (ControlFlow 0 12) 3))) GeneratedUnifiedExit_correct))))))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (=> (and (and (and ($IsAlloc DatatypeTypeType |st#0@@14| Tclass.Equiv.MState $Heap@@6) ($IsAlloc SeqType |es#0@@19| (TSeq Tclass.AST.Expr) $Heap@@6)) (and (|Equiv.__default.Pes#canCall| |st#0@@14| |es#0@@19|) (Equiv.__default.Pes |st#0@@14| |es#0@@19|))) (and (and ($IsAlloc DatatypeTypeType |st#0@@14| Tclass.Equiv.MState $Heap@@6) ($IsAlloc SeqType |es#0@@19| (TSeq Tclass.AST.Expr) $Heap@@6)) (and (|Equiv.__default.Pes__Fail#canCall| |st#0@@14| |es#0@@19|) (not (Equiv.__default.Pes__Fail |st#0@@14| |es#0@@19|))))) (and (=> (= (ControlFlow 0 16) 1) anon5_Then_correct) (=> (= (ControlFlow 0 16) 12) anon5_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@14| Tclass.Equiv.MState) ($Is SeqType |es#0@@19| (TSeq Tclass.AST.Expr))) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 17) 16))) anon0_correct))))
