// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/examples/induction-principle-code/AST.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/examples/induction-principle-code/AST-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/examples/induction-principle-code/AST.dfy
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "AST.Expr_Raw.Depth (well-formedness)"} CheckWellformed$$AST.Expr__Raw.Depth(this: DatatypeType)
{
  ...
  var b$reqreads#2: bool;
    ...
    else
    {
        ...
        {
            havoc lit#Z#0;
            assume {:id "id52"} let#16#0#0 == _mcc#1#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#16#0#0, TInt);
            assume {:id "id53"} lit#Z#0 == let#16#0#0;
        }
        else if (this == #AST.Expr_Raw.Bind(_mcc#2#0, _mcc#3#0, _mcc#4#0))
        {
            ...
            havoc body#Z#0;
            assume {:id "id37"} let#11#0#0 == _mcc#4#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#11#0#0, Tclass.AST.Expr__Raw());
            assume {:id "id38"} body#Z#0 == let#11#0#0;
            havoc bvals#Z#0;
            assume {:id "id39"} let#12#0#0 == _mcc#3#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#12#0#0, TSeq(Tclass.AST.Expr__Raw()));
            assume {:id "id40"} bvals#Z#0 == let#12#0#0;
            havoc bvars#Z#0;
            assume {:id "id41"} let#13#0#0 == _mcc#2#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#13#0#0, TSeq(TSeq(TChar)));
            assume {:id "id42"} bvars#Z#0 == let#13#0#0;
            havoc m#Z#0;
            havoc f#Z#2;
            ...
            if (*)
            {
                   ...
                   && $IsAlloc(e#2, Tclass.AST.Expr__Raw(), $lambdaHeap#2))
                {
                    ...
                    if (Seq#Contains(bvals#Z#0, $Box(e#2)))
                    {
                        ...
                        assert {:id "id43"} DtRank(e#2) < DtRank(this);
                        assume AST.Expr__Raw.Depth#canCall(e#2);
                        assume {:id "id44"} lambdaResult#2 == AST.Expr__Raw.Depth($LS($LZ), e#2);
                        assume AST.Expr__Raw.Depth#canCall(e#2);
                        // CheckWellformedWithResult: any expression
            ...
            assume {:id "id46"} f#Z#2 == let#15#0#0;
            ...
            assert {:id "id47"} {:subsumption 0} (forall t#4: DatatypeType :: 
              { Requires1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#2, $Box(t#4)) } 
                { Seq#Contains(##ts#2, $Box(t#4)) } 
              $Is(t#4, Tclass.AST.Expr__Raw()) && Seq#Contains(##ts#2, $Box(t#4))
                 ==> Requires1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#2, $Box(t#4)));
            assume (forall t#4: DatatypeType :: 
              ...
              $Is(t#4, Tclass.AST.Expr__Raw()) && Seq#Contains(##ts#2, $Box(t#4))
                 ==> Requires1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#2, $Box(t#4)));
            assert {:id "id48"} {:subsumption 0} (forall t#5: DatatypeType :: 
              { $Unbox(Apply1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#2, $Box(t#5))): int } 
                { Seq#Contains(##ts#2, $Box(t#5)) } 
              $Is(t#5, Tclass.AST.Expr__Raw()) && Seq#Contains(##ts#2, $Box(t#5))
                 ==> ##default#2
                   <= $Unbox(Apply1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#2, $Box(t#5))): int);
            ...
            b$reqreads#2 := (forall $o: ref, $f: Field :: 
              $o != null
                   ...
                   && (exists x#2: DatatypeType, y#2: ref :: 
                    { Set#IsMember(Reads1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#2, $Box(x#2)), $Box(y#2)) } 
                    $Is(x#2, Tclass.AST.Expr__Raw())
                       && $Is(y#2, Tclass._System.object?())
                       && 
                      Seq#Contains(##ts#2, $Box(x#2))
                       && Set#IsMember(Reads1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#2, $Box(x#2)), $Box(y#2))
                       && $Box($o) == $Box(y#2))
                 ==> $_ReadsFrame[$o, $f]);
        ...
        else if (this == #AST.Expr_Raw.Assign(_mcc#5#0, _mcc#6#0))
        {
            ...
            havoc avals#Z#0;
            assume {:id "id27"} let#8#0#0 == _mcc#6#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#8#0#0, TSeq(Tclass.AST.Expr__Raw()));
            assume {:id "id28"} avals#Z#0 == let#8#0#0;
            havoc avars#Z#0;
            assume {:id "id29"} let#9#0#0 == _mcc#5#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#9#0#0, TSeq(TSeq(TChar)));
            assume {:id "id30"} avars#Z#0 == let#9#0#0;
            havoc f#Z#1;
            // Begin Comprehension WF check
            if (*)
            {
                   ...
                   && $IsAlloc(e#1, Tclass.AST.Expr__Raw(), $lambdaHeap#1))
                {
                    ...
                    if (Seq#Contains(avals#Z#0, $Box(e#1)))
                    {
                        ...
                        assert {:id "id31"} DtRank(e#1) < DtRank(this);
                        assume AST.Expr__Raw.Depth#canCall(e#1);
                        assume {:id "id32"} lambdaResult#1 == AST.Expr__Raw.Depth($LS($LZ), e#1);
                        assume AST.Expr__Raw.Depth#canCall(e#1);
                        // CheckWellformedWithResult: any expression
            ...
            assume $Is(let#10#0#0, 
              Tclass._System.___hPartialFunc1(Tclass.AST.Expr__Raw(), Tclass._System.nat()));
            assume {:id "id34"} f#Z#1 == let#10#0#0;
            ...
            assert {:id "id35"} {:subsumption 0} (forall t#2: DatatypeType :: 
              { Requires1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#1, $Box(t#2)) } 
                { Seq#Contains(##ts#1, $Box(t#2)) } 
              $Is(t#2, Tclass.AST.Expr__Raw()) && Seq#Contains(##ts#1, $Box(t#2))
                 ==> Requires1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#1, $Box(t#2)));
            assume (forall t#2: DatatypeType :: 
              { Requires1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#1, $Box(t#2)) } 
                { Seq#Contains(##ts#1, $Box(t#2)) } 
              $Is(t#2, Tclass.AST.Expr__Raw()) && Seq#Contains(##ts#1, $Box(t#2))
                 ==> Requires1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#1, $Box(t#2)));
            assert {:id "id36"} {:subsumption 0} (forall t#3: DatatypeType :: 
              { $Unbox(Apply1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#1, $Box(t#3))): int } 
            ...
            b$reqreads#1 := (forall $o: ref, $f: Field :: 
              $o != null
                   && $Unbox(read($Heap, $o, alloc)): bool
                   && (exists x#1: DatatypeType, y#1: ref :: 
                    { Set#IsMember(Reads1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#1, $Box(x#1)), $Box(y#1)) } 
                    $Is(x#1, Tclass.AST.Expr__Raw())
                       && $Is(y#1, Tclass._System.object?())
                       && 
                      Seq#Contains(##ts#1, $Box(x#1))
                       && Set#IsMember(Reads1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#1, $Box(x#1)), $Box(y#1))
                       && $Box($o) == $Box(y#1))
                 ==> $_ReadsFrame[$o, $f]);
            assume Utils.__default.MaxF#canCall(Tclass.AST.Expr__Raw(), 
        ...
        else if (this == #AST.Expr_Raw.If(_mcc#7#0, _mcc#8#0, _mcc#9#0))
        {
            ...
            havoc els#Z#0;
            assume {:id "id18"} let#5#0#0 == _mcc#9#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#5#0#0, Tclass.AST.Expr__Raw());
            assume {:id "id19"} els#Z#0 == let#5#0#0;
            havoc thn#Z#0;
            assume {:id "id20"} let#6#0#0 == _mcc#8#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#6#0#0, Tclass.AST.Expr__Raw());
            assume {:id "id21"} thn#Z#0 == let#6#0#0;
            havoc cond#Z#0;
            assume {:id "id22"} let#7#0#0 == _mcc#7#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#7#0#0, Tclass.AST.Expr__Raw());
            assume {:id "id23"} cond#Z#0 == let#7#0#0;
            // assume allocatedness for receiver argument to function
            assume $IsAllocBox($Box(cond#Z#0), Tclass.AST.Expr__Raw(), $Heap);
            assert {:id "id24"} DtRank(cond#Z#0) < DtRank(this);
            ...
            assert {:id "id25"} DtRank(thn#Z#0) < DtRank(this);
            ...
            assert {:id "id26"} DtRank(els#Z#0) < DtRank(this);
        ...
        else if (this == #AST.Expr_Raw.Op(_mcc#10#0, _mcc#11#0, _mcc#12#0))
        {
            ...
            havoc e2#Z#0;
            assume {:id "id10"} let#2#0#0 == _mcc#12#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#2#0#0, Tclass.AST.Expr__Raw());
            assume {:id "id11"} e2#Z#0 == let#2#0#0;
            havoc e1#Z#0;
            assume {:id "id12"} let#3#0#0 == _mcc#11#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#3#0#0, Tclass.AST.Expr__Raw());
            assume {:id "id13"} e1#Z#0 == let#3#0#0;
            havoc op#Z#0;
            assume {:id "id14"} let#4#0#0 == _mcc#10#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#4#0#0, Tclass.AST.BinOp());
            assume {:id "id15"} op#Z#0 == let#4#0#0;
            // assume allocatedness for receiver argument to function
            assume $IsAllocBox($Box(e1#Z#0), Tclass.AST.Expr__Raw(), $Heap);
            assert {:id "id16"} DtRank(e1#Z#0) < DtRank(this);
            ...
            assert {:id "id17"} DtRank(e2#Z#0) < DtRank(this);
        ...
        else if (this == #AST.Expr_Raw.Seq(_mcc#13#0))
        {
            ...
            havoc es#Z#0;
            assume {:id "id2"} let#0#0#0 == _mcc#13#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#0#0#0, TSeq(Tclass.AST.Expr__Raw()));
            assume {:id "id3"} es#Z#0 == let#0#0#0;
            havoc f#Z#0;
            // Begin Comprehension WF check
            if (*)
            {
                   ...
                   && $IsAlloc(e#0, Tclass.AST.Expr__Raw(), $lambdaHeap#0))
                {
                    ...
                    if (Seq#Contains(es#Z#0, $Box(e#0)))
                    {
                        ...
                        assert {:id "id4"} DtRank(e#0) < DtRank(this);
                        assume AST.Expr__Raw.Depth#canCall(e#0);
                        assume {:id "id5"} lambdaResult#0 == AST.Expr__Raw.Depth($LS($LZ), e#0);
                        assume AST.Expr__Raw.Depth#canCall(e#0);
                        // CheckWellformedWithResult: any expression
            ...
            assert {:id "id8"} {:subsumption 0} (forall t#0: DatatypeType :: 
            ...
            assume (forall t#0: DatatypeType :: 
              ...
              $Is(t#0, Tclass.AST.Expr__Raw()) && Seq#Contains(##ts#0, $Box(t#0))
                 ==> Requires1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#0, $Box(t#0)));
            assert {:id "id9"} {:subsumption 0} (forall t#1: DatatypeType :: 
            ...
            b$reqreads#0 := (forall $o: ref, $f: Field :: 
              $o != null
                   && $Unbox(read($Heap, $o, alloc)): bool
                   && (exists x#0: DatatypeType, y#0: ref :: 
                    { Set#IsMember(Reads1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#0, $Box(x#0)), $Box(y#0)) } 
                    $Is(x#0, Tclass.AST.Expr__Raw())
                       && $Is(y#0, Tclass._System.object?())
                       && 
                      Seq#Contains(##ts#0, $Box(x#0))
                       && Set#IsMember(Reads1(Tclass.AST.Expr__Raw(), TInt, $Heap, ##f#0, $Box(x#0)), $Box(y#0))
                       && $Box($o) == $Box(y#0))
                 ==> $_ReadsFrame[$o, $f]);
            assume Utils.__default.MaxF#canCall(Tclass.AST.Expr__Raw(), 
                        ...
                        (var thn#4 := AST.Expr__Raw.thn(this); 
                         ...
                         then (var e2#4 := AST.Expr__Raw.oe2(this); 
                          ...
                          Utils.__default.MaxF(Tclass.AST.Expr__Raw(), 
                            ...
                            LitInt(0))))))))), 
          Tclass._System.nat());
        assume {:id "id55"} AST.Expr__Raw.Depth($LS($LZ), this)
           == 1
             + (if AST.Expr__Raw.Var_q(this)
               then 0
               else (if AST.Expr__Raw.Literal_q(this)
    ...
    else
    {
        ...
        if ($Unbox(Apply1(Tclass.AST.Expr__Raw(), TBool, $Heap, p#0, $Box(e#0))): bool)
        {
            if (e#0 == #AST.Expr_Raw.Var(_mcc#0#0))
            {
                assume $Is(_mcc#0#0, TSeq(TChar));
                havoc name#Z#0;
                assume {:id "id97"} let#13#0#0 == _mcc#0#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#13#0#0, TSeq(TChar));
                assume {:id "id98"} name#Z#0 == let#13#0#0;
            }
            else if (e#0 == #AST.Expr_Raw.Literal(_mcc#1#0))
            {
                havoc n#Z#0;
                assume {:id "id95"} let#12#0#0 == _mcc#1#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#12#0#0, TInt);
                assume {:id "id96"} n#Z#0 == let#12#0#0;
            }
            else if (e#0 == #AST.Expr_Raw.Bind(_mcc#2#0, _mcc#3#0, _mcc#4#0))
            {
                ...
                assume $Is(_mcc#4#0, Tclass.AST.Expr__Raw());
                havoc body#Z#0;
                assume {:id "id87"} let#9#0#0 == _mcc#4#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#9#0#0, Tclass.AST.Expr__Raw());
                assume {:id "id88"} body#Z#0 == let#9#0#0;
                havoc bvals#Z#0;
                assume {:id "id89"} let#10#0#0 == _mcc#3#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#10#0#0, TSeq(Tclass.AST.Expr__Raw()));
                assume {:id "id90"} bvals#Z#0 == let#10#0#0;
                havoc bvars#Z#0;
                assume {:id "id91"} let#11#0#0 == _mcc#2#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#11#0#0, TSeq(TSeq(TChar)));
                assume {:id "id92"} bvars#Z#0 == let#11#0#0;
                // Begin Comprehension WF check
                havoc e#21;
                   ...
                   && $IsAlloc(e#21, Tclass.AST.Expr__Raw(), $Heap))
                {
                    if (Seq#Contains(bvals#Z#0, $Box(e#21)))
                    {
                        ...
                        assert {:id "id93"} DtRank(##e#7) < DtRank(e#0);
                     ...
                     ==> AST.Expr__Raw.All($LS($LZ), e#22, p#0)))
                {
                    ...
                    assert {:id "id94"} DtRank(##e#8) < DtRank(e#0);
            ...
            else if (e#0 == #AST.Expr_Raw.Assign(_mcc#5#0, _mcc#6#0))
            {
                ...
                assume $Is(_mcc#6#0, TSeq(Tclass.AST.Expr__Raw()));
                havoc avals#Z#0;
                assume {:id "id82"} let#7#0#0 == _mcc#6#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#7#0#0, TSeq(Tclass.AST.Expr__Raw()));
                assume {:id "id83"} avals#Z#0 == let#7#0#0;
                havoc avars#Z#0;
                assume {:id "id84"} let#8#0#0 == _mcc#5#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#8#0#0, TSeq(TSeq(TChar)));
                assume {:id "id85"} avars#Z#0 == let#8#0#0;
                if (Lit(true))
                {
                    // Begin Comprehension WF check
                    havoc e#20;
                       ...
                       && $IsAlloc(e#20, Tclass.AST.Expr__Raw(), $Heap))
                    {
                        if (Seq#Contains(avals#Z#0, $Box(e#20)))
                        {
                            ...
                            assert {:id "id86"} DtRank(##e#6) < DtRank(e#0);
            ...
            else if (e#0 == #AST.Expr_Raw.If(_mcc#7#0, _mcc#8#0, _mcc#9#0))
            {
                ...
                assume $Is(_mcc#9#0, Tclass.AST.Expr__Raw());
                havoc els#Z#0;
                assume {:id "id73"} let#4#0#0 == _mcc#9#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#4#0#0, Tclass.AST.Expr__Raw());
                assume {:id "id74"} els#Z#0 == let#4#0#0;
                havoc thn#Z#0;
                assume {:id "id75"} let#5#0#0 == _mcc#8#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#5#0#0, Tclass.AST.Expr__Raw());
                assume {:id "id76"} thn#Z#0 == let#5#0#0;
                havoc cond#Z#0;
                assume {:id "id77"} let#6#0#0 == _mcc#7#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#6#0#0, Tclass.AST.Expr__Raw());
                assume {:id "id78"} cond#Z#0 == let#6#0#0;
                ##e#3 := cond#Z#0;
                // assume allocatedness for argument to function
                ...
                assert {:id "id79"} DtRank(##e#3) < DtRank(e#0);
                ...
                if (AST.Expr__Raw.All($LS($LZ), cond#Z#0, p#0))
                {
                    ...
                    assert {:id "id80"} DtRank(##e#4) < DtRank(e#0);
            ...
            else if (e#0 == #AST.Expr_Raw.Op(_mcc#10#0, _mcc#11#0, _mcc#12#0))
            {
                ...
                assume $Is(_mcc#12#0, Tclass.AST.Expr__Raw());
                havoc oe2#Z#0;
                assume {:id "id65"} let#1#0#0 == _mcc#12#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#1#0#0, Tclass.AST.Expr__Raw());
                assume {:id "id66"} oe2#Z#0 == let#1#0#0;
                havoc oe1#Z#0;
                assume {:id "id67"} let#2#0#0 == _mcc#11#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#2#0#0, Tclass.AST.Expr__Raw());
                assume {:id "id68"} oe1#Z#0 == let#2#0#0;
                havoc op#Z#0;
                assume {:id "id69"} let#3#0#0 == _mcc#10#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#3#0#0, Tclass.AST.BinOp());
                assume {:id "id70"} op#Z#0 == let#3#0#0;
                ##e#1 := oe1#Z#0;
                // assume allocatedness for argument to function
                ...
                assert {:id "id71"} DtRank(##e#1) < DtRank(e#0);
                ...
                if (AST.Expr__Raw.All($LS($LZ), oe1#Z#0, p#0))
                {
                    ...
                    assert {:id "id72"} DtRank(##e#2) < DtRank(e#0);
                ...
                if (Lit(true))
                {
                       ...
                       && $IsAlloc(e#19, Tclass.AST.Expr__Raw(), $Heap))
                    {
                        if (Seq#Contains(es#Z#0, $Box(e#19)))
                        {
                            ...
                            assert {:id "id64"} DtRank(##e#0) < DtRank(e#0);
        ...
        assume {:id "id99"} AST.Expr__Raw.All($LS($LZ), e#0, p#0)
           == ($Unbox(Apply1(Tclass.AST.Expr__Raw(), TBool, $Heap, p#0, $Box(e#0))): bool
             && (if AST.Expr__Raw.Var_q(e#0)
...
axiom {:id "id105"} 2 <= $FunctionContextHeight
   ==> (forall e#0: DatatypeType :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "AST.Expr (well-formedness)"} CheckWellFormed$$AST.Expr(e#0: DatatypeType)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assume {:id "id145"} AST.Expr__Raw.WellFormed(e#0);
        assume false;
    }
    ...
    if (*)
    {
        ...
        assert {:id "id146"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
        ...
        assert {:id "id147"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
                 ...
                 || (Lit(AST.Expr__Raw.Var_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                   ==> (var name#0 := Lit(AST.Expr__Raw.name(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                    Lit(true))));
        assert {:id "id148"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
                 ...
                 || (!Lit(AST.Expr__Raw.Var_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                  ...
                  Lit(AST.Expr__Raw.Literal_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                   ==> (var n#0 := LitInt(AST.Expr__Raw.n(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                    Lit(true))));
        assert {:id "id149"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
                    ...
                    (var bvals#0 := Lit(AST.Expr__Raw.bvals(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                      (var bvars#0 := Lit(AST.Expr__Raw.bvars(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                        (forall e#1: DatatypeType :: 
                          ...
                          $Is(e#1, Tclass.AST.Expr__Raw()) && Seq#Contains(bvals#0, $Box(e#1))
                             ==> AST.Expr__Raw.All($LS($LS($LZ)), e#1, AST.Expr__Raw.WellFormed__Single#Handle())))))));
        assert {:id "id150"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
        ...
        assert {:id "id151"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
                  ...
                  Lit(AST.Expr__Raw.Assign_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                   ==> (var avals#0 := Lit(AST.Expr__Raw.avals(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                    (var avars#0 := Lit(AST.Expr__Raw.avars(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                      Lit(true)))));
        assert {:id "id152"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
                   ...
                   ==> (var avals#0 := Lit(AST.Expr__Raw.avals(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                    (var avars#0 := Lit(AST.Expr__Raw.avars(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                      (forall e#2: DatatypeType :: 
                        ...
                        $Is(e#2, Tclass.AST.Expr__Raw()) && Seq#Contains(avals#0, $Box(e#2))
                           ==> AST.Expr__Raw.All($LS($LS($LZ)), e#2, AST.Expr__Raw.WellFormed__Single#Handle()))))));
        assert {:id "id153"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
        ...
        assert {:id "id154"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
        ...
        assert {:id "id155"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
        ...
        assert {:id "id156"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
        ...
        assert {:id "id157"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
        ...
        assert {:id "id158"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
                 ...
                 || (!Lit(AST.Expr__Raw.Var_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                  ...
                  !Lit(AST.Expr__Raw.Op_q(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
                   ==> (var es#0 := Lit(AST.Expr__Raw.es(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))); 
                    Lit(true))));
        assert {:id "id159"} {:subsumption 0} AST.Expr__Raw.WellFormed#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))))
           ==> Lit(AST.Expr__Raw.WellFormed(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120))))))))
             || (AST.Expr__Raw.All#canCall(Lit(#AST.Expr_Raw.Var(Lit(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(120)))))), 
                AST.Expr__Raw.WellFormed__Single#Handle())
               ==> AST.Expr__Raw.All($LS($LZ), 
...
axiom {:id "id160"} (forall x#0: int, y#0: int :: 
...
axiom {:id "id161"} (forall x#0: int, y#0: int :: 
...
axiom {:id "id162"} (forall Utils._default.MaxF$T: Ty, 
    $ly: LayerType, 
    $Heap: Heap, 
    f#0: HandleType, 
    ts#0: Seq, 
...
axiom {:id "id163"} (forall Utils.Result$T: Ty, this: DatatypeType :: 
...
axiom {:id "id164"} (forall Utils.Result$T: Ty, this: DatatypeType :: 
...
axiom {:id "id165"} (forall Utils.Result$T: Ty, Utils.Result.PropagateFailure$U: Ty, this: DatatypeType :: 
  { Utils.Result.PropagateFailure(Utils.Result$T, Utils.Result.PropagateFailure$U, this) } 
  Utils.Result.PropagateFailure#canCall(Utils.Result$T, Utils.Result.PropagateFailure$U, this)
       || ($Is(this, Tclass.Utils.Result(Utils.Result$T)) && Utils.Result.Failure_q(this))
     ==> Utils.Result.PropagateFailure(Utils.Result$T, Utils.Result.PropagateFailure$U, this)
...
axiom {:id "id166"} (forall Utils.Result$T: Ty, Utils.Result.PropagateFailure$U: Ty, this: DatatypeType :: 
...
axiom {:id "id167"} (forall Utils.Result$T: Ty, this: DatatypeType :: 
  { Utils.Result.Extract(Utils.Result$T, this) } 
  Utils.Result.Extract#canCall(Utils.Result$T, this)
       || ($Is(this, Tclass.Utils.Result(Utils.Result$T)) && Utils.Result.Success_q(this))
...
axiom {:id "id168"} (forall Utils.Result$T: Ty, this: DatatypeType :: 
