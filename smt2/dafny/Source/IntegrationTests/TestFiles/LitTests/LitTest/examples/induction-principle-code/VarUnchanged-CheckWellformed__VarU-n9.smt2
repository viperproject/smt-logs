...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|res#0@@1| T@U) ) (!  (=> (or (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@3| |res#0@@1|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@3| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |res#0@@1| (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))) (and (=> (Utils.Result.Success_q |res#0@@1|) (and (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value |res#0@@1|))) (let ((|ctx#1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#0@@1|))))))
 (and (VarUnchanged.MState.MState_q |st#0@@3|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@3|)) (and (VarUnchanged.MState.MState_q |st#0@@3|) (=> (|Set#IsMember| (|Map#Domain| |ctx#1|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@3|))) (and (and (VarUnchanged.MState.MState_q |st#0@@3|) (VarUnchanged.MState.MState_q |st#0@@3|)) (VarUnchanged.MState.MState_q |st#0@@3|))))))))) (= (VarUnchanged.__default.ResultSeqSameX |st#0@@3| |res#0@@1|) (ite (Utils.Result.Success_q |res#0@@1|) (let ((|ctx#0@@1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#0@@1|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@3|)) (and (|Set#IsMember| (|Map#Domain| |ctx#0@@1|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@3|))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (VarUnchanged.MState.ctx |st#0@@3|)) (Utils.Option.value (VarUnchanged.MState.x |st#0@@3|))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@1|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@3|))))))))) true))))
 :qid |VarUnchangeddfy.52:34|
 :skolemid |699|
 :pattern ( (VarUnchanged.__default.ResultSeqSameX |st#0@@3| |res#0@@1|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|e#0@@2| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pre#canCall| |st#0@@4| |e#0@@2|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@4| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@2| Tclass.AST.Expr)))) (and (and (VarUnchanged.MState.MState_q |st#0@@4|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@4|)) (and (VarUnchanged.MState.MState_q |st#0@@4|) (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@4|))) |e#0@@2|)))) (= (VarUnchanged.__default.Pre |st#0@@4| |e#0@@2|)  (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@4|)) (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@4|))) |e#0@@2|)))))
 :qid |VarUnchangeddfy.82:23|
 :skolemid |704|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@4| |e#0@@2|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|es#0@@4| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Fail#canCall| (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |es#0@@4|)) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@5| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@4| (TSeq Tclass.AST.Expr))))) (and (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@5|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@4|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@5|))))) (|VarUnchanged.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |es#0@@4|))) (= (VarUnchanged.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |es#0@@4|)) (U_2_bool (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@4|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@5|)))))))
(Lit boolType (bool_2_U  (=> (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |es#0@@4|)) (Utils.Result.Failure_q |res#2@@1|)))))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |762|
 :pattern ( (VarUnchanged.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |es#0@@4|)))
))))
(assert (forall ((|st#0@@6| T@U) ) (! (= ($Is DatatypeTypeType |st#0@@6| Tclass.VarUnchanged.S)  (and ($Is DatatypeTypeType |st#0@@6| Tclass.VarUnchanged.MState) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@6|)) (|Set#IsMember| (|Map#Domain| (VarUnchanged.MState.ctx |st#0@@6|)) (Utils.Option.value (VarUnchanged.MState.x |st#0@@6|))))))
 :qid |unknown.0:0|
 :skolemid |956|
 :pattern ( ($Is DatatypeTypeType |st#0@@6| Tclass.VarUnchanged.S))
)))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|es#0@@5| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Step#canCall| |st#0@@7| |es#0@@5|) (and (< 5 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@7| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@5| (TSeq Tclass.AST.Expr))) (and (VarUnchanged.__default.Pes |st#0@@7| |es#0@@5|) (not (VarUnchanged.__default.Pes__Fail |st#0@@7| |es#0@@5|)))))) (and (VarUnchanged.__default.Pes__Succ |st#0@@7| |es#0@@5| ($Unbox DatatypeTypeType (_System.Tuple2._0 (VarUnchanged.__default.Pes__Step |st#0@@7| |es#0@@5|))) ($Unbox SeqType (_System.Tuple2._1 (VarUnchanged.__default.Pes__Step |st#0@@7| |es#0@@5|)))) ($Is DatatypeTypeType (VarUnchanged.__default.Pes__Step |st#0@@7| |es#0@@5|) (Tclass._System.Tuple2 Tclass.VarUnchanged.S (TSeq TInt)))))
 :qid |Inductiondfy.71:27|
 :skolemid |819|
 :pattern ( (VarUnchanged.__default.Pes__Step |st#0@@7| |es#0@@5|))
))))
...
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@3|)))
 (and (AST.Expr__Raw.All $ly@@1 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@1 |oe2#0| |p#0|)))) (let ((|es#0@@6| (AST.Expr__Raw.es |e#0@@3|)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@3 T@U) (|x#0@@0| T@U) (|e#0@@4| T@U) ) (!  (=> (or (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| (Lit DatatypeTypeType |e#0@@4|)) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |x#0@@0| (TSeq TChar)) ($Is DatatypeTypeType |e#0@@4| Tclass.AST.Expr)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@4|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@4|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@4|))))) (let ((|body#3| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@4|)))))
...
)) (=> (not (|Seq#Contains| |bvars#3| ($Box SeqType |x#0@@0|))) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |body#3|)))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@4|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@4|))))) (let ((|avals#3| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@4|)))))
...
)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@4|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@4|))))) (let ((|els#3| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@4|)))))
...
(let ((|cond#3| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@4|)))))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |cond#3|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |cond#3|) (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |thn#3|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |thn#3|) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |els#3|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@4|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@4|))))) (let ((|oe2#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@4|)))))
(let ((|oe1#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@4|)))))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |oe1#3|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |oe1#3|) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |oe2#3|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@4|)))))) (let ((|es#3| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@4|)))))
...
))))))))))))) (= (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| (Lit DatatypeTypeType |e#0@@4|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@4|)) (U_2_bool (Lit boolType (bool_2_U false))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@4|)) (U_2_bool (Lit boolType (bool_2_U false))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@4|)) (let ((|body#2| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@4|)))))
...
)) (or (|Seq#Contains| |bvars#2| ($Box SeqType |x#0@@0|)) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |body#2|)))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@4|)) (let ((|avals#2| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@4|)))))
...
))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@4|)) (let ((|els#2| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@4|)))))
...
(let ((|cond#2| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@4|)))))
 (and (and (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |cond#2|) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |thn#2|)) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |els#2|))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@4|)) (let ((|oe2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@4|)))))
(let ((|oe1#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@4|)))))
 (and (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |oe1#2|) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |oe2#2|)))) (let ((|es#2| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@4|)))))
(forall ((|e#9| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#9| Tclass.AST.Expr__Raw) (|Seq#Contains| |es#2| ($Box DatatypeTypeType |e#9|))) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |e#9|))
 ...
 :weight 3
 :skolemid |659|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| (Lit DatatypeTypeType |e#0@@4|)))
))))
(assert (forall (($ly@@4 T@U) (|x#0@@1| T@U) (|e#0@@5| T@U) ) (! (= (VarUnchanged.__default.VarUnchanged ($LS $ly@@4) |x#0@@1| |e#0@@5|) (VarUnchanged.__default.VarUnchanged $ly@@4 |x#0@@1| |e#0@@5|))
 :qid |VarUnchangeddfy.17:13|
 :skolemid |638|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@4) |x#0@@1| |e#0@@5|))
)))
(assert (forall (($ly@@5 T@U) (|e#0@@6| T@U) (|p#0@@0| T@U) ) (! (= (AST.Expr__Raw.All ($LS $ly@@5) |e#0@@6| |p#0@@0|) (AST.Expr__Raw.All $ly@@5 |e#0@@6| |p#0@@0|))
 :qid |ASTdfy.44:22|
 :skolemid |1153|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@5) |e#0@@6| |p#0@@0|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|es#0@@8| T@U) ) (!  (=> (or (|VarUnchanged.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@8|) (Lit SeqType |es#0@@8|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@8| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@8| (TSeq Tclass.AST.Expr))))) (and (forall ((|e#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |e#1@@0| Tclass.AST.Expr) (=> (|Seq#Contains| |es#0@@8| ($Box DatatypeTypeType |e#1@@0|)) (|VarUnchanged.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@8|) |e#1@@0|)))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |713|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@8| |e#1@@0|))
 :pattern ( (|Seq#Contains| |es#0@@8| ($Box DatatypeTypeType |e#1@@0|)))
)) (= (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@8|) (Lit SeqType |es#0@@8|)) (forall ((|e#1@@1| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#1@@1| Tclass.AST.Expr) (|Seq#Contains| |es#0@@8| ($Box DatatypeTypeType |e#1@@1|))) (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@8|) |e#1@@1|))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |712|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@8| |e#1@@1|))
 :pattern ( (|Seq#Contains| |es#0@@8| ($Box DatatypeTypeType |e#1@@1|)))
)))))
 :qid |VarUnchangeddfy.87:25|
 :weight 3
 :skolemid |714|
 :pattern ( (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@8|) (Lit SeqType |es#0@@8|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@9| T@U) (|es#0@@9| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Fail#canCall| |st#0@@9| (Lit SeqType |es#0@@9|)) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@9| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@9| (TSeq Tclass.AST.Expr))))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@9|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@9|) (VarUnchanged.MState.ctx |st#0@@9|))) (|VarUnchanged.__default.PreEs#canCall| |st#0@@9| (Lit SeqType |es#0@@9|))) (= (VarUnchanged.__default.Pes__Fail |st#0@@9| (Lit SeqType |es#0@@9|)) (let ((|res#1@@1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@9|) (VarUnchanged.MState.ctx |st#0@@9|))))
 (=> (VarUnchanged.__default.PreEs |st#0@@9| (Lit SeqType |es#0@@9|)) (Utils.Result.Failure_q |res#1@@1|))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |761|
 :pattern ( (VarUnchanged.__default.Pes__Fail |st#0@@9| (Lit SeqType |es#0@@9|)))
))))
(assert (forall (($ly@@6 T@U) (|e#0@@8| T@U) (|ctx#0@@3| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@8| |ctx#0@@3|) (and ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr) ($Is MapType |ctx#0@@3| (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType (Interp.__default.InterpExpr $ly@@6 |e#0@@8| |ctx#0@@3|) (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))))
 :qid |Interpdfy.24:12|
 :skolemid |1212|
 :pattern ( (Interp.__default.InterpExpr $ly@@6 |e#0@@8| |ctx#0@@3|))
)))
(assert (forall (($ly@@7 T@U) (|e#0@@9| T@U) (|ctx#0@@4| T@U) ) (! (= (Interp.__default.InterpExpr ($LS $ly@@7) |e#0@@9| |ctx#0@@4|) (Interp.__default.InterpExpr $ly@@7 |e#0@@9| |ctx#0@@4|))
 :qid |Interpdfy.24:12|
 :skolemid |1210|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@7) |e#0@@9| |ctx#0@@4|))
)))
(assert (forall (($ly@@8 T@U) (|es#0@@10| T@U) (|ctx#0@@5| T@U) ) (! (= (Interp.__default.InterpExprs ($LS $ly@@8) |es#0@@10| |ctx#0@@5|) (Interp.__default.InterpExprs $ly@@8 |es#0@@10| |ctx#0@@5|))
 :qid |Interpdfy.69:12|
 :skolemid |1217|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@8) |es#0@@10| |ctx#0@@5|))
)))
...
(assert (forall (($ly@@11 T@U) (|es#0@@11| T@U) (|ctx#0@@6| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@11| |ctx#0@@6|) (and ($Is SeqType |es#0@@11| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@6| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@11| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@11| (LitInt 0))) |ctx#0@@6|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@11 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@11| (LitInt 0))) |ctx#0@@6|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@11) |es#0@@11| |ctx#0@@6|) (ite (|Seq#Equal| |es#0@@11| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@6|)))) (let ((|valueOrError0#0@@1| (Interp.__default.InterpExpr $ly@@11 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@11| (LitInt 0))) |ctx#0@@6|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0|))) |vs#0@@2|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1221|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@11) |es#0@@11| |ctx#0@@6|))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@10| T@U) (|es#0@@12| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes#canCall| |st#0@@10| |es#0@@12|) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@10| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@12| (TSeq Tclass.AST.Expr))))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@10|) (|Interp.__default.InterpExprs#canCall| |es#0@@12| (VarUnchanged.MState.ctx |st#0@@10|))) (let ((|res#0@@2| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@12| (VarUnchanged.MState.ctx |st#0@@10|))))
 (and (|VarUnchanged.__default.PreEs#canCall| |st#0@@10| |es#0@@12|) (=> (VarUnchanged.__default.PreEs |st#0@@10| |es#0@@12|) (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@10| |res#0@@2|))))) (= (VarUnchanged.__default.Pes |st#0@@10| |es#0@@12|) (let ((|res#0@@3| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@12| (VarUnchanged.MState.ctx |st#0@@10|))))
 (=> (VarUnchanged.__default.PreEs |st#0@@10| |es#0@@12|) (VarUnchanged.__default.ResultSeqSameX |st#0@@10| |res#0@@3|))))))
 :qid |Inductiondfy.39:23|
 :skolemid |744|
 :pattern ( (VarUnchanged.__default.Pes |st#0@@10| |es#0@@12|))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@12 T@U) (|x#0@@2| T@U) (|e#0@@10| T@U) ) (!  (=> (or (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |e#0@@10|) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |x#0@@2| (TSeq TChar)) ($Is DatatypeTypeType |e#0@@10| Tclass.AST.Expr)))) (and (=> (not (AST.Expr__Raw.Var_q |e#0@@10|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@10|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@10|) (let ((|body#1@@1| (AST.Expr__Raw.body |e#0@@10|)))
(let ((|bvals#1@@1| (AST.Expr__Raw.bvals |e#0@@10|)))
(let ((|bvars#1@@0| (AST.Expr__Raw.bvars |e#0@@10|)))
...
)) (=> (not (|Seq#Contains| |bvars#1@@0| ($Box SeqType |x#0@@2|))) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |body#1@@1|)))))))) (=> (not (AST.Expr__Raw.Bind_q |e#0@@10|)) (and (=> (AST.Expr__Raw.Assign_q |e#0@@10|) (let ((|avals#1@@1| (AST.Expr__Raw.avals |e#0@@10|)))
(let ((|avars#1@@0| (AST.Expr__Raw.avars |e#0@@10|)))
...
)))))) (=> (not (AST.Expr__Raw.Assign_q |e#0@@10|)) (and (=> (AST.Expr__Raw.If_q |e#0@@10|) (let ((|els#1@@1| (AST.Expr__Raw.els |e#0@@10|)))
(let ((|thn#1@@1| (AST.Expr__Raw.thn |e#0@@10|)))
(let ((|cond#1@@1| (AST.Expr__Raw.cond |e#0@@10|)))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |cond#1@@1|) (=> (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |cond#1@@1|) (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |thn#1@@1|) (=> (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |thn#1@@1|) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |els#1@@1|))))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@10|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@10|) (let ((|oe2#1@@0| (AST.Expr__Raw.oe2 |e#0@@10|)))
(let ((|oe1#1@@0| (AST.Expr__Raw.oe1 |e#0@@10|)))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |oe1#1@@0|) (=> (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |oe1#1@@0|) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |oe2#1@@0|)))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@10|)) (let ((|es#1@@1| (AST.Expr__Raw.es |e#0@@10|)))
...
))))))))))))) (= (VarUnchanged.__default.VarUnchanged ($LS $ly@@12) |x#0@@2| |e#0@@10|) (ite (AST.Expr__Raw.Var_q |e#0@@10|) (U_2_bool (Lit boolType (bool_2_U false))) (ite (AST.Expr__Raw.Literal_q |e#0@@10|) (U_2_bool (Lit boolType (bool_2_U false))) (ite (AST.Expr__Raw.Bind_q |e#0@@10|) (let ((|body#0@@1| (AST.Expr__Raw.body |e#0@@10|)))
(let ((|bvals#0@@2| (AST.Expr__Raw.bvals |e#0@@10|)))
(let ((|bvars#0@@1| (AST.Expr__Raw.bvars |e#0@@10|)))
...
)) (or (|Seq#Contains| |bvars#0@@1| ($Box SeqType |x#0@@2|)) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |body#0@@1|)))))) (ite (AST.Expr__Raw.Assign_q |e#0@@10|) (let ((|avals#0@@2| (AST.Expr__Raw.avals |e#0@@10|)))
(let ((|avars#0@@1| (AST.Expr__Raw.avars |e#0@@10|)))
...
))))) (ite (AST.Expr__Raw.If_q |e#0@@10|) (let ((|els#0@@1| (AST.Expr__Raw.els |e#0@@10|)))
(let ((|thn#0@@1| (AST.Expr__Raw.thn |e#0@@10|)))
(let ((|cond#0@@1| (AST.Expr__Raw.cond |e#0@@10|)))
 (and (and (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |cond#0@@1|) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |thn#0@@1|)) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |els#0@@1|))))) (ite (AST.Expr__Raw.Op_q |e#0@@10|) (let ((|oe2#0@@0| (AST.Expr__Raw.oe2 |e#0@@10|)))
(let ((|oe1#0@@0| (AST.Expr__Raw.oe1 |e#0@@10|)))
 (and (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |oe1#0@@0|) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |oe2#0@@0|)))) (let ((|es#0@@13| (AST.Expr__Raw.es |e#0@@10|)))
(forall ((|e#3@@0| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#3@@0| Tclass.AST.Expr__Raw) (|Seq#Contains| |es#0@@13| ($Box DatatypeTypeType |e#3@@0|))) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |e#3@@0|))
 ...
 :qid |VarUnchangeddfy.17:13|
 :skolemid |651|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@12) |x#0@@2| |e#0@@10|))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|st#0@@11| T@U) (|es#0@@14| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Step#canCall| (Lit DatatypeTypeType |st#0@@11|) (Lit SeqType |es#0@@14|)) (and (< 5 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@11| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@14| (TSeq Tclass.AST.Expr))) (and (U_2_bool (Lit boolType (bool_2_U (VarUnchanged.__default.Pes (Lit DatatypeTypeType |st#0@@11|) (Lit SeqType |es#0@@14|))))) (not (U_2_bool (Lit boolType (bool_2_U (VarUnchanged.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@11|) (Lit SeqType |es#0@@14|)))))))))) (and (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@11|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@14|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@11|))))) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@11|))) (= (VarUnchanged.__default.Pes__Step (Lit DatatypeTypeType |st#0@@11|) (Lit SeqType |es#0@@14|)) (let ((|ctx1#2@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@14|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@11|)))))))))))
(let ((|vs#2@@1| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@14|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@11|)))))))))))
(|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#VarUnchanged.MState.MState| (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@11|))) |ctx1#2@@2|)) ($Box SeqType |vs#2@@1|)))))))
 :qid |Inductiondfy.71:27|
 :weight 3
 :skolemid |823|
 :pattern ( (VarUnchanged.__default.Pes__Step (Lit DatatypeTypeType |st#0@@11|) (Lit SeqType |es#0@@14|)))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@12| T@U) (|res#0@@4| T@U) ) (!  (=> (or (|VarUnchanged.__default.ResultSeqSameX#canCall| (Lit DatatypeTypeType |st#0@@12|) (Lit DatatypeTypeType |res#0@@4|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@12| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |res#0@@4| (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@4|))))) (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@4|))))) (let ((|ctx#3| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@4|)))))))))
 (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@12|)) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@12|))))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@12|)) (=> (|Set#IsMember| (|Map#Domain| |ctx#3|) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@12|)))))))) (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@12|)) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@12|))) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@12|)))))))))) (= (VarUnchanged.__default.ResultSeqSameX (Lit DatatypeTypeType |st#0@@12|) (Lit DatatypeTypeType |res#0@@4|)) (ite (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@4|)) (let ((|ctx#2| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@4|)))))))))
 (=> (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@12|)))) (and (|Set#IsMember| (Lit SetType (|Map#Domain| |ctx#2|)) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@12|)))))))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@12|)))) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@12|)))))))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#2|) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@12|)))))))))))))) true))))
 :qid |VarUnchangeddfy.52:34|
 :weight 3
 :skolemid |700|
 :pattern ( (VarUnchanged.__default.ResultSeqSameX (Lit DatatypeTypeType |st#0@@12|) (Lit DatatypeTypeType |res#0@@4|)))
))))
(assert (forall (($ly@@13 T@U) (|es#0@@15| T@U) (|ctx#0@@7| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@15|) |ctx#0@@7|) (and ($Is SeqType |es#0@@15| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@7| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@15| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@15|) (LitInt 0))) |ctx#0@@7|) (let ((|valueOrError0#1@@0| (Interp.__default.InterpExpr ($LS $ly@@13) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@15|) (LitInt 0))) |ctx#0@@7|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@13) (Lit SeqType |es#0@@15|) |ctx#0@@7|) (ite (|Seq#Equal| |es#0@@15| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@7|)))) (let ((|valueOrError0#1@@1| (Interp.__default.InterpExpr ($LS $ly@@13) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@15|) (LitInt 0))) |ctx#0@@7|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#1|))) |vs#1@@0|)) ($Box MapType |ctx2#1@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |1222|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@13) (Lit SeqType |es#0@@15|) |ctx#0@@7|))
)))
...
(assert (forall (($ly@@14 T@U) (|e#0@@12| T@U) (|ctx#0@@8| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@12|) (Lit MapType |ctx#0@@8|)) (and ($Is DatatypeTypeType |e#0@@12| Tclass.AST.Expr) ($Is MapType |ctx#0@@8| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@12|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@12|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@12|))))) (let ((|body#5| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@12|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#5| |v1#5| |v2#5|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@12|)))))) (let ((|es#5| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@12|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#5|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@14) (Lit DatatypeTypeType |e#0@@12|) (Lit MapType |ctx#0@@8|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@12|)) (let ((|name#4| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@12|)))))
...
(Lit DatatypeTypeType (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#4|)) ($Box MapType (Lit MapType |ctx#0@@8|)))))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@12|)) (let ((|body#4| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@12|)))))
...
(ite  (or (not (= |condv#4| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@14) |thn#4| |ctx_cond#4|) (Interp.__default.InterpExpr ($LS $ly@@14) |els#4| |ctx_cond#4|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@12|)) (let ((|e2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@12|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1216|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@14) (Lit DatatypeTypeType |e#0@@12|) (Lit MapType |ctx#0@@8|)))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@15 T@U) (|x#0@@3| T@U) (|e#0@@13| T@U) ) (!  (=> (or (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) (Lit DatatypeTypeType |e#0@@13|)) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |x#0@@3| (TSeq TChar)) ($Is DatatypeTypeType |e#0@@13| Tclass.AST.Expr)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@13|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@13|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@13|))))) (let ((|body#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@13|)))))
...
)) (=> (not (|Seq#Contains| |bvars#5@@0| ($Box SeqType |x#0@@3|))) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |body#5@@0|)))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@13|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@13|))))) (let ((|avals#5@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@13|)))))
...
(let ((|cond#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@13|)))))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |cond#5@@0|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |cond#5@@0|) (and (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |thn#5@@0|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |thn#5@@0|) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |els#5@@0|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@13|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@13|))))) (let ((|oe2#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|oe1#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@13|)))))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |oe1#5|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |oe1#5|) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |oe2#5|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@13|)))))) (let ((|es#5@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@13|)))))
...
))))))))))))) (= (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) (Lit DatatypeTypeType |e#0@@13|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@13|)) (U_2_bool (Lit boolType (bool_2_U false))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@13|)) (U_2_bool (Lit boolType (bool_2_U false))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@13|)) (let ((|body#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@13|)))))
...
)) (or (|Seq#Contains| |bvars#4@@0| ($Box SeqType |x#0@@3|)) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |body#4@@0|)))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@13|)) (let ((|avals#4@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@13|)))))
...
(Lit boolType (bool_2_U  (and (and (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |cond#4@@0|) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |thn#4@@0|)) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |els#4@@0|)))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@13|)) (U_2_bool (let ((|oe2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|oe1#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@13|)))))
(Lit boolType (bool_2_U  (and (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |oe1#4|) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |oe2#4|))))))) (let ((|es#4@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@13|)))))
(forall ((|e#15| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#15| Tclass.AST.Expr__Raw) (|Seq#Contains| |es#4@@0| ($Box DatatypeTypeType |e#15|))) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |e#15|))
 ...
 :weight 3
 :skolemid |667|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) (Lit DatatypeTypeType |e#0@@13|)))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|st#0@@13| T@U) (|es#0@@16| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Step#canCall| |st#0@@13| (Lit SeqType |es#0@@16|)) (and (< 5 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@13| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@16| (TSeq Tclass.AST.Expr))) (and (VarUnchanged.__default.Pes |st#0@@13| (Lit SeqType |es#0@@16|)) (not (VarUnchanged.__default.Pes__Fail |st#0@@13| (Lit SeqType |es#0@@16|))))))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@13|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@16|) (VarUnchanged.MState.ctx |st#0@@13|))) (VarUnchanged.MState.MState_q |st#0@@13|)) (= (VarUnchanged.__default.Pes__Step |st#0@@13| (Lit SeqType |es#0@@16|)) (let ((|ctx1#1@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@16|) (VarUnchanged.MState.ctx |st#0@@13|))))))))
(let ((|vs#1@@1| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@16|) (VarUnchanged.MState.ctx |st#0@@13|))))))))
(|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#VarUnchanged.MState.MState| (VarUnchanged.MState.x |st#0@@13|) |ctx1#1@@2|)) ($Box SeqType |vs#1@@1|)))))))
 :qid |Inductiondfy.71:27|
 :weight 3
 :skolemid |822|
 :pattern ( (VarUnchanged.__default.Pes__Step |st#0@@13| (Lit SeqType |es#0@@16|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@14| T@U) (|es#0@@17| T@U) ) (!  (=> (or (|VarUnchanged.__default.PreEs#canCall| |st#0@@14| |es#0@@17|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@14| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@17| (TSeq Tclass.AST.Expr))))) (and (forall ((|e#0@@14| T@U) ) (!  (=> ($Is DatatypeTypeType |e#0@@14| Tclass.AST.Expr) (=> (|Seq#Contains| |es#0@@17| ($Box DatatypeTypeType |e#0@@14|)) (|VarUnchanged.__default.Pre#canCall| |st#0@@14| |e#0@@14|)))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |710|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@14| |e#0@@14|))
 :pattern ( (|Seq#Contains| |es#0@@17| ($Box DatatypeTypeType |e#0@@14|)))
)) (= (VarUnchanged.__default.PreEs |st#0@@14| |es#0@@17|) (forall ((|e#0@@15| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr) (|Seq#Contains| |es#0@@17| ($Box DatatypeTypeType |e#0@@15|))) (VarUnchanged.__default.Pre |st#0@@14| |e#0@@15|))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |709|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@14| |e#0@@15|))
 :pattern ( (|Seq#Contains| |es#0@@17| ($Box DatatypeTypeType |e#0@@15|)))
)))))
 :qid |VarUnchangeddfy.87:25|
 :skolemid |711|
 :pattern ( (VarUnchanged.__default.PreEs |st#0@@14| |es#0@@17|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@15| T@U) (|es#0@@18| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Fail#canCall| |st#0@@15| |es#0@@18|) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@15| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@18| (TSeq Tclass.AST.Expr))))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@15|) (|Interp.__default.InterpExprs#canCall| |es#0@@18| (VarUnchanged.MState.ctx |st#0@@15|))) (|VarUnchanged.__default.PreEs#canCall| |st#0@@15| |es#0@@18|)) (= (VarUnchanged.__default.Pes__Fail |st#0@@15| |es#0@@18|) (let ((|res#0@@5| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@18| (VarUnchanged.MState.ctx |st#0@@15|))))
 (=> (VarUnchanged.__default.PreEs |st#0@@15| |es#0@@18|) (Utils.Result.Failure_q |res#0@@5|))))))
 :qid |Inductiondfy.41:28|
 :skolemid |760|
 :pattern ( (VarUnchanged.__default.Pes__Fail |st#0@@15| |es#0@@18|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@16| T@U) (|es#0@@19| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes#canCall| (Lit DatatypeTypeType |st#0@@16|) (Lit SeqType |es#0@@19|)) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@16| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@19| (TSeq Tclass.AST.Expr))))) (and (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@16|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@19|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@16|))))) (let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@19|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@16|)))))))
 (and (|VarUnchanged.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@16|) (Lit SeqType |es#0@@19|)) (=> (U_2_bool (Lit boolType (bool_2_U (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@16|) (Lit SeqType |es#0@@19|))))) (|VarUnchanged.__default.ResultSeqSameX#canCall| (Lit DatatypeTypeType |st#0@@16|) |res#2@@2|))))) (= (VarUnchanged.__default.Pes (Lit DatatypeTypeType |st#0@@16|) (Lit SeqType |es#0@@19|)) (U_2_bool (let ((|res#2@@3| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@19|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@16|)))))))
(Lit boolType (bool_2_U  (=> (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@16|) (Lit SeqType |es#0@@19|)) (VarUnchanged.__default.ResultSeqSameX (Lit DatatypeTypeType |st#0@@16|) |res#2@@3|)))))))))
 :qid |Inductiondfy.39:23|
 :weight 3
 :skolemid |746|
 :pattern ( (VarUnchanged.__default.Pes (Lit DatatypeTypeType |st#0@@16|) (Lit SeqType |es#0@@19|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@17| T@U) (|es#0@@20| T@U) (|st'#0@@1| T@U) (|vs#0@@3| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@17| (Lit SeqType |es#0@@20|) |st'#0@@1| |vs#0@@3|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@17| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@20| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@1| Tclass.VarUnchanged.S)) ($Is SeqType |vs#0@@3| (TSeq TInt))))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@17|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@20|) (VarUnchanged.MState.ctx |st#0@@17|))) (let ((|res#1@@2| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@20|) (VarUnchanged.MState.ctx |st#0@@17|))))
 (and (|VarUnchanged.__default.PreEs#canCall| |st#0@@17| (Lit SeqType |es#0@@20|)) (=> (VarUnchanged.__default.PreEs |st#0@@17| (Lit SeqType |es#0@@20|)) (and (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@17| |res#1@@2|) (=> (VarUnchanged.__default.ResultSeqSameX |st#0@@17| |res#1@@2|) (and (and (|$IsA#Utils.Result| |res#1@@2|) (VarUnchanged.MState.MState_q |st'#0@@1|)) (=> (|Utils.Result#Equal| |res#1@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@3|) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@1|)))))) (and (and (|$IsA#Utils.Option| (VarUnchanged.MState.x |st'#0@@1|)) (|$IsA#Utils.Option| (VarUnchanged.MState.x |st#0@@17|))) (and (VarUnchanged.MState.MState_q |st'#0@@1|) (VarUnchanged.MState.MState_q |st#0@@17|))))))))))) (= (VarUnchanged.__default.Pes__Succ |st#0@@17| (Lit SeqType |es#0@@20|) |st'#0@@1| |vs#0@@3|) (let ((|res#1@@3| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@20|) (VarUnchanged.MState.ctx |st#0@@17|))))
 (and (and (and (VarUnchanged.__default.PreEs |st#0@@17| (Lit SeqType |es#0@@20|)) (VarUnchanged.__default.ResultSeqSameX |st#0@@17| |res#1@@3|)) (|Utils.Result#Equal| |res#1@@3| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@3|) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@1|))))))) (|Utils.Option#Equal| (VarUnchanged.MState.x |st'#0@@1|) (VarUnchanged.MState.x |st#0@@17|)))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |753|
 :pattern ( (VarUnchanged.__default.Pes__Succ |st#0@@17| (Lit SeqType |es#0@@20|) |st'#0@@1| |vs#0@@3|))
))))
...
(assert (forall (($ly@@17 T@U) (|e#0@@16| T@U) (|ctx#0@@9| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@16|) |ctx#0@@9|) (and ($Is DatatypeTypeType |e#0@@16| Tclass.AST.Expr) ($Is MapType |ctx#0@@9| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@16|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@16|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@16|))))) (let ((|body#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@16|)))))
...
(|Interp.__default.VarsAndValuesToContext#canCall| |avars#3@@0| |vs#10|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@16|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@16|))))) (let ((|els#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@16|)))))
...
(let ((|condv#3| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError3#3|)))))))
 (and (=> (or (not (= |condv#3| 0)) (not true)) (|Interp.__default.InterpExpr#canCall| |thn#3@@0| |ctx_cond#3|)) (=> (= |condv#3| 0) (|Interp.__default.InterpExpr#canCall| |els#3@@0| |ctx_cond#3|)))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@16|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@16|))))) (let ((|e2#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|e1#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|op#3| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@16|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#3| |v1#3| |v2#3|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@16|)))))) (let ((|es#3@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@16|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#3|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@17) (Lit DatatypeTypeType |e#0@@16|) |ctx#0@@9|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|name#2| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@16|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#2|)) ($Box MapType |ctx#0@@9|))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|body#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|bvals#2@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|bvars#2@@1| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@16|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |bodyv#2|)) ($Box MapType |ctx4#2|)))))))))))))))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|avals#2@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|avars#2@@1| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@16|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType (|Map#Merge| |ctx1#9| |bindings#5|)))))))))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|els#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@16|)))))
...
(ite  (or (not (= |condv#2| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@17) |thn#2@@0| |ctx_cond#2|) (Interp.__default.InterpExpr ($LS $ly@@17) |els#2@@0| |ctx_cond#2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|e2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|e1#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@16|)))))
(let ((|op#2| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@16|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#2| |v1#2| |v2#2|))) ($Box MapType |ctx2#5|))))))))))))))) (let ((|es#2@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@16|)))))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1215|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@17) (Lit DatatypeTypeType |e#0@@16|) |ctx#0@@9|))
)))
...
(assert (forall (($ly@@19 T@U) ($Heap@@2 T@U) (|e#0@@17| T@U) (|p#0@@1| T@U) ) (!  (=> (or (|AST.Expr__Raw.All#canCall| (Lit DatatypeTypeType |e#0@@17|) |p#0@@1|) (and (and ($IsGoodHeap $Heap@@2) ($Is DatatypeTypeType |e#0@@17| Tclass.AST.Expr__Raw)) ($Is HandleTypeType |p#0@@1| (Tclass._System.___hTotalFunc1 Tclass.AST.Expr__Raw TBool)))) (and (=> (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@2 |p#0@@1| ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@17|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@17|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@17|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@17|))))) (let ((|body#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|bvals#3@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@17|)))))
...
)) (|AST.Expr__Raw.All#canCall| |body#3@@1| |p#0@@1|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@17|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@17|))))) (let ((|avals#3@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@17|)))))
...
))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@17|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@17|))))) (let ((|els#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|thn#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|cond#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@17|)))))
 (and (|AST.Expr__Raw.All#canCall| |cond#3@@1| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@19) |cond#3@@1| |p#0@@1|) (and (|AST.Expr__Raw.All#canCall| |thn#3@@1| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@19) |thn#3@@1| |p#0@@1|) (|AST.Expr__Raw.All#canCall| |els#3@@1| |p#0@@1|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@17|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@17|))))) (let ((|oe2#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|oe1#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@17|)))))
 (and (|AST.Expr__Raw.All#canCall| |oe1#3@@0| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@19) |oe1#3@@0| |p#0@@1|) (|AST.Expr__Raw.All#canCall| |oe2#3@@0| |p#0@@1|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@17|)))))) (let ((|es#3@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@17|)))))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@19) (Lit DatatypeTypeType |e#0@@17|) |p#0@@1|)  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@2 |p#0@@1| ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@17|))))) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@17|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@17|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|body#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|bvals#2@@2| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@17|)))))
...
)) (AST.Expr__Raw.All ($LS $ly@@19) |body#2@@1| |p#0@@1|)))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|avals#2@@2| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@17|)))))
...
)))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|els#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|thn#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|cond#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@17|)))))
 (and (and (AST.Expr__Raw.All ($LS $ly@@19) |cond#2@@1| |p#0@@1|) (AST.Expr__Raw.All ($LS $ly@@19) |thn#2@@1| |p#0@@1|)) (AST.Expr__Raw.All ($LS $ly@@19) |els#2@@1| |p#0@@1|))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|oe2#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|oe1#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@17|)))))
 (and (AST.Expr__Raw.All ($LS $ly@@19) |oe1#2@@0| |p#0@@1|) (AST.Expr__Raw.All ($LS $ly@@19) |oe2#2@@0| |p#0@@1|)))) (let ((|es#2@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@17|)))))
 ...
 :weight 3
 :skolemid |1172|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@19) (Lit DatatypeTypeType |e#0@@17|) |p#0@@1|) ($IsGoodHeap $Heap@@2))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@18| T@U) (|e#0@@18| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@18|) (Lit DatatypeTypeType |e#0@@18|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@18| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@18| Tclass.AST.Expr)))) (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@18|)) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@18|))))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@18|)) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@18|)))))) (Lit DatatypeTypeType |e#0@@18|))))) (= (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@18|) (Lit DatatypeTypeType |e#0@@18|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@18|)))) (VarUnchanged.__default.VarUnchanged ($LS $LZ) (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@18|)))))) (Lit DatatypeTypeType |e#0@@18|)))))))))
 :qid |VarUnchangeddfy.82:23|
 :weight 3
 :skolemid |705|
 :pattern ( (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@18|) (Lit DatatypeTypeType |e#0@@18|)))
))))
...
(let ((|cond#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@20|)))))
 (and (|AST.Expr__Raw.All#canCall| |cond#5@@1| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@20) |cond#5@@1| (Lit HandleTypeType |p#0@@2|)) (and (|AST.Expr__Raw.All#canCall| |thn#5@@1| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@20) |thn#5@@1| (Lit HandleTypeType |p#0@@2|)) (|AST.Expr__Raw.All#canCall| |els#5@@1| (Lit HandleTypeType |p#0@@2|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@20|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@20|))))) (let ((|oe2#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|oe1#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@20|)))))
 (and (|AST.Expr__Raw.All#canCall| |oe1#5@@0| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@20) |oe1#5@@0| (Lit HandleTypeType |p#0@@2|)) (|AST.Expr__Raw.All#canCall| |oe2#5@@0| (Lit HandleTypeType |p#0@@2|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@20|)))))) (let ((|es#5@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@20|)))))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@20) (Lit DatatypeTypeType |e#0@@20|) (Lit HandleTypeType |p#0@@2|))  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@4 (Lit HandleTypeType |p#0@@2|) ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@20|))))) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@20|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@20|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@20|)) (let ((|body#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@20|)))))
...
)) (AST.Expr__Raw.All ($LS $ly@@20) |body#4@@1| (Lit HandleTypeType |p#0@@2|))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@20|)) (let ((|avals#4@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@20|)))))
...
(Lit boolType (bool_2_U  (and (and (AST.Expr__Raw.All ($LS $ly@@20) |cond#4@@1| (Lit HandleTypeType |p#0@@2|)) (AST.Expr__Raw.All ($LS $ly@@20) |thn#4@@1| (Lit HandleTypeType |p#0@@2|))) (AST.Expr__Raw.All ($LS $ly@@20) |els#4@@1| (Lit HandleTypeType |p#0@@2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@20|)) (U_2_bool (let ((|oe2#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@20|)))))
(let ((|oe1#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@20|)))))
(Lit boolType (bool_2_U  (and (AST.Expr__Raw.All ($LS $ly@@20) |oe1#4@@0| (Lit HandleTypeType |p#0@@2|)) (AST.Expr__Raw.All ($LS $ly@@20) |oe2#4@@0| (Lit HandleTypeType |p#0@@2|)))))))) (let ((|es#4@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@20|)))))
 ...
 :weight 3
 :skolemid |1180|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@20) (Lit DatatypeTypeType |e#0@@20|) (Lit HandleTypeType |p#0@@2|)) ($IsGoodHeap $Heap@@4))
)))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall ((|st#0@@19| T@U) (|es#0@@21| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Step#canCall| |st#0@@19| |es#0@@21|) (and (< 5 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@19| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@21| (TSeq Tclass.AST.Expr))) (and (VarUnchanged.__default.Pes |st#0@@19| |es#0@@21|) (not (VarUnchanged.__default.Pes__Fail |st#0@@19| |es#0@@21|)))))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@19|) (|Interp.__default.InterpExprs#canCall| |es#0@@21| (VarUnchanged.MState.ctx |st#0@@19|))) (VarUnchanged.MState.MState_q |st#0@@19|)) (= (VarUnchanged.__default.Pes__Step |st#0@@19| |es#0@@21|) (let ((|ctx1#0@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs ($LS $LZ) |es#0@@21| (VarUnchanged.MState.ctx |st#0@@19|))))))))
(let ((|vs#0@@4| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs ($LS $LZ) |es#0@@21| (VarUnchanged.MState.ctx |st#0@@19|))))))))
(|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#VarUnchanged.MState.MState| (VarUnchanged.MState.x |st#0@@19|) |ctx1#0@@2|)) ($Box SeqType |vs#0@@4|)))))))
 :qid |Inductiondfy.71:27|
 :skolemid |821|
 :pattern ( (VarUnchanged.__default.Pes__Step |st#0@@19| |es#0@@21|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$VarUnchanged.__default.Pes__Step)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 3) (- 0 8)) (=> (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@20| |es#0@@22| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@6|)) ($Unbox SeqType (_System.Tuple2._1 |res#0@@6|))) (or (VarUnchanged.__default.Pes__Succ |st#0@@20| |es#0@@22| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@6|)) ($Unbox SeqType (_System.Tuple2._1 |res#0@@6|))) (=> (|VarUnchanged.__default.PreEs#canCall| |st#0@@20| |es#0@@22|) (or (VarUnchanged.__default.PreEs |st#0@@20| |es#0@@22|) (forall ((|e#0@@21| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#0@@21| Tclass.AST.Expr) (|Seq#Contains| |es#0@@22| ($Box DatatypeTypeType |e#0@@21|))) (VarUnchanged.__default.Pre |st#0@@20| |e#0@@21|))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |824|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@20| |e#0@@21|))
 :pattern ( (|Seq#Contains| |es#0@@22| ($Box DatatypeTypeType |e#0@@21|)))
))))))) (=> (=> (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@20| |es#0@@22| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@6|)) ($Unbox SeqType (_System.Tuple2._1 |res#0@@6|))) (or (VarUnchanged.__default.Pes__Succ |st#0@@20| |es#0@@22| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@6|)) ($Unbox SeqType (_System.Tuple2._1 |res#0@@6|))) (=> (|VarUnchanged.__default.PreEs#canCall| |st#0@@20| |es#0@@22|) (or (VarUnchanged.__default.PreEs |st#0@@20| |es#0@@22|) (forall ((|e#0@@22| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#0@@22| Tclass.AST.Expr) (|Seq#Contains| |es#0@@22| ($Box DatatypeTypeType |e#0@@22|))) (VarUnchanged.__default.Pre |st#0@@20| |e#0@@22|))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |824|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@20| |e#0@@22|))
 :pattern ( (|Seq#Contains| |es#0@@22| ($Box DatatypeTypeType |e#0@@22|)))
)))))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (=> (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@20| |es#0@@22| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@6|)) ($Unbox SeqType (_System.Tuple2._1 |res#0@@6|))) (or (VarUnchanged.__default.Pes__Succ |st#0@@20| |es#0@@22| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@6|)) ($Unbox SeqType (_System.Tuple2._1 |res#0@@6|))) (let ((|res#1@@4| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@22| (VarUnchanged.MState.ctx |st#0@@20|))))
 (=> (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@20| |res#1@@4|) (or (VarUnchanged.__default.ResultSeqSameX |st#0@@20| |res#1@@4|) (=> (Utils.Result.Success_q |res#1@@4|) (let ((|ctx#0@@10| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@4|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@20|)) (|Set#IsMember| (|Map#Domain| |ctx#0@@10|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@20|)))))))))))) (=> (=> (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@20| |es#0@@22| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@6|)) ($Unbox SeqType (_System.Tuple2._1 |res#0@@6|))) (or (VarUnchanged.__default.Pes__Succ |st#0@@20| |es#0@@22| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@6|)) ($Unbox SeqType (_System.Tuple2._1 |res#0@@6|))) (let ((|res#1@@5| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@22| (VarUnchanged.MState.ctx |st#0@@20|))))
 (=> (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@20| |res#1@@5|) (or (VarUnchanged.__default.ResultSeqSameX |st#0@@20| |res#1@@5|) (=> (Utils.Result.Success_q |res#1@@5|) (let ((|ctx#0@@11| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@5|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@20|)) (|Set#IsMember| (|Map#Domain| |ctx#0@@11|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@20|))))))))))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (=> (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@20| |es#0@@22| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@6|)) ($Unbox SeqType (_System.Tuple2._1 |res#0@@6|))) (or (VarUnchanged.__default.Pes__Succ |st#0@@20| |es#0@@22| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@6|)) ($Unbox SeqType (_System.Tuple2._1 |res#0@@6|))) (let ((|res#1@@6| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@22| (VarUnchanged.MState.ctx |st#0@@20|))))
 (=> (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@20| |res#1@@6|) (or (VarUnchanged.__default.ResultSeqSameX |st#0@@20| |res#1@@6|) (=> (Utils.Result.Success_q |res#1@@6|) (let ((|ctx#0@@12| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@6|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@20|)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (VarUnchanged.MState.ctx |st#0@@20|)) (Utils.Option.value (VarUnchanged.MState.x |st#0@@20|))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@12|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@20|))))))))))))))) (=> (=> (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@20| |es#0@@22| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@6|)) ($Unbox SeqType (_System.Tuple2._1 |res#0@@6|))) (or (VarUnchanged.__default.Pes__Succ |st#0@@20| |es#0@@22| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@6|)) ($Unbox SeqType (_System.Tuple2._1 |res#0@@6|))) (let ((|res#1@@7| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@22| (VarUnchanged.MState.ctx |st#0@@20|))))
 (=> (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@20| |res#1@@7|) (or (VarUnchanged.__default.ResultSeqSameX |st#0@@20| |res#1@@7|) (=> (Utils.Result.Success_q |res#1@@7|) (let ((|ctx#0@@13| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@7|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@20|)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (VarUnchanged.MState.ctx |st#0@@20|)) (Utils.Option.value (VarUnchanged.MState.x |st#0@@20|))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@13|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@20|)))))))))))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (=> (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@20| |es#0@@22| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@6|)) ($Unbox SeqType (_System.Tuple2._1 |res#0@@6|))) (or (VarUnchanged.__default.Pes__Succ |st#0@@20| |es#0@@22| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@6|)) ($Unbox SeqType (_System.Tuple2._1 |res#0@@6|))) (let ((|res#1@@8| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@22| (VarUnchanged.MState.ctx |st#0@@20|))))
 (=> (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@20| |res#1@@8|) (or (VarUnchanged.__default.ResultSeqSameX |st#0@@20| |res#1@@8|) (=> (not (Utils.Result.Success_q |res#1@@8|)) (U_2_bool (Lit boolType (bool_2_U true)))))))))) (=> (=> (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@20| |es#0@@22| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@6|)) ($Unbox SeqType (_System.Tuple2._1 |res#0@@6|))) (or (VarUnchanged.__default.Pes__Succ |st#0@@20| |es#0@@22| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@6|)) ($Unbox SeqType (_System.Tuple2._1 |res#0@@6|))) (let ((|res#1@@9| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@22| (VarUnchanged.MState.ctx |st#0@@20|))))
 (=> (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@20| |res#1@@9|) (or (VarUnchanged.__default.ResultSeqSameX |st#0@@20| |res#1@@9|) (=> (not (Utils.Result.Success_q |res#1@@9|)) (U_2_bool (Lit boolType (bool_2_U true))))))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@20| |es#0@@22| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@6|)) ($Unbox SeqType (_System.Tuple2._1 |res#0@@6|))) (or (VarUnchanged.__default.Pes__Succ |st#0@@20| |es#0@@22| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@6|)) ($Unbox SeqType (_System.Tuple2._1 |res#0@@6|))) (let ((|res#1@@10| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@22| (VarUnchanged.MState.ctx |st#0@@20|))))
(|Utils.Result#Equal| |res#1@@10| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (_System.Tuple2._1 |res#0@@6|) ($Box MapType (VarUnchanged.MState.ctx ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@6|)))))))))))) (=> (=> (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@20| |es#0@@22| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@6|)) ($Unbox SeqType (_System.Tuple2._1 |res#0@@6|))) (or (VarUnchanged.__default.Pes__Succ |st#0@@20| |es#0@@22| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@6|)) ($Unbox SeqType (_System.Tuple2._1 |res#0@@6|))) (let ((|res#1@@11| (Interp.__default.InterpExprs ($LS ($LS $LZ)) |es#0@@22| (VarUnchanged.MState.ctx |st#0@@20|))))
(|Utils.Result#Equal| |res#1@@11| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (_System.Tuple2._1 |res#0@@6|) ($Box MapType (VarUnchanged.MState.ctx ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@6|))))))))))) (=> (= (ControlFlow 0 3) (- 0 2)) (=> (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@20| |es#0@@22| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@6|)) ($Unbox SeqType (_System.Tuple2._1 |res#0@@6|))) (or (VarUnchanged.__default.Pes__Succ |st#0@@20| |es#0@@22| ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@6|)) ($Unbox SeqType (_System.Tuple2._1 |res#0@@6|))) (|Utils.Option#Equal| (VarUnchanged.MState.x ($Unbox DatatypeTypeType (_System.Tuple2._0 |res#0@@6|))) (VarUnchanged.MState.x |st#0@@20|)))))))))))))))))
(let ((anon5_Else_correct  (=> (and ($IsAlloc SeqType |es#0@@22| (TSeq Tclass.AST.Expr) $Heap@@6) (VarUnchanged.MState.MState_q |st#0@@20|)) (=> (and (and (and (= |##ctx#0@0| (VarUnchanged.MState.ctx |st#0@@20|)) ($IsAlloc MapType |##ctx#0@0| (TMap (TSeq TChar) TInt) $Heap@@6)) (and (|Interp.__default.InterpExprs#canCall| |es#0@@22| (VarUnchanged.MState.ctx |st#0@@20|)) (= |let#0#0#0| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@22| (VarUnchanged.MState.ctx |st#0@@20|))))) (and (and (VarUnchanged.MState.MState_q |st#0@@20|) (|Interp.__default.InterpExprs#canCall| |es#0@@22| (VarUnchanged.MState.ctx |st#0@@20|))) ($Is DatatypeTypeType |let#0#0#0| (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)))))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (Utils.Result.Success_q |let#0#0#0|)) (=> (Utils.Result.Success_q |let#0#0#0|) (=> (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value |let#0#0#0|))) (=> (and (= (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#Z#0@0|) ($Box MapType |ctx1#Z#0@0|)))) |let#0#0#0|) (VarUnchanged.MState.MState_q |st#0@@20|)) (and (=> (= (ControlFlow 0 9) (- 0 10)) ($Is DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#VarUnchanged.MState.MState| (VarUnchanged.MState.x |st#0@@20|) |ctx1#Z#0@0|)) ($Box SeqType |vs#Z#0@0|)) (Tclass._System.Tuple2 Tclass.VarUnchanged.S (TSeq TInt)))) (=> ($Is DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#VarUnchanged.MState.MState| (VarUnchanged.MState.x |st#0@@20|) |ctx1#Z#0@0|)) ($Box SeqType |vs#Z#0@0|)) (Tclass._System.Tuple2 Tclass.VarUnchanged.S (TSeq TInt))) (=> (= (VarUnchanged.__default.Pes__Step |st#0@@20| |es#0@@22|) (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (|#VarUnchanged.MState.MState| (VarUnchanged.MState.x |st#0@@20|) |ctx1#Z#0@0|)) ($Box SeqType |vs#Z#0@0|))) (=> (and (and (VarUnchanged.MState.MState_q |st#0@@20|) ($Is DatatypeTypeType (VarUnchanged.__default.Pes__Step |st#0@@20| |es#0@@22|) (Tclass._System.Tuple2 Tclass.VarUnchanged.S (TSeq TInt)))) (and (= (VarUnchanged.__default.Pes__Step |st#0@@20| |es#0@@22|) |res#0@@6|) (= (ControlFlow 0 9) 3))) GeneratedUnifiedExit_correct))))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (=> (and (and (and ($IsAlloc DatatypeTypeType |st#0@@20| Tclass.VarUnchanged.S $Heap@@6) ($IsAlloc SeqType |es#0@@22| (TSeq Tclass.AST.Expr) $Heap@@6)) (and (|VarUnchanged.__default.Pes#canCall| |st#0@@20| |es#0@@22|) (VarUnchanged.__default.Pes |st#0@@20| |es#0@@22|))) (and (and ($IsAlloc DatatypeTypeType |st#0@@20| Tclass.VarUnchanged.S $Heap@@6) ($IsAlloc SeqType |es#0@@22| (TSeq Tclass.AST.Expr) $Heap@@6)) (and (|VarUnchanged.__default.Pes__Fail#canCall| |st#0@@20| |es#0@@22|) (not (VarUnchanged.__default.Pes__Fail |st#0@@20| |es#0@@22|))))) (and (=> (= (ControlFlow 0 12) 1) anon5_Then_correct) (=> (= (ControlFlow 0 12) 9) anon5_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@20| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@22| (TSeq Tclass.AST.Expr))) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 13) 12))) anon0_correct))))
