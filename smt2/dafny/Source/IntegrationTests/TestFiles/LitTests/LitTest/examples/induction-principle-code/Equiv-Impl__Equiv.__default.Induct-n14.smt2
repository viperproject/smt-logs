...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0| T@U) (|e#0@@1| T@U) ) (!  (=> (or (|Equiv.__default.P#canCall| |st#0| (Lit DatatypeTypeType |e#0@@1|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@1| Tclass.AST.Expr)))) (and (and (and (Equiv.MState.MState_q |st#0|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@1|) (Equiv.MState.ctx |st#0|))) (let ((|res#1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@1|) (Equiv.MState.ctx |st#0|))))
 (and (and (Equiv.MState.MState_q |st#0|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@1|) (Equiv.MState.ctx_k |st#0|))) (let ((|res'#1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@1|) (Equiv.MState.ctx_k |st#0|))))
 (and (|Equiv.__default.Inv#canCall| |st#0|) (=> (Equiv.__default.Inv |st#0|) (|Equiv.__default.EqResult#canCall| |res#1| |res'#1|))))))) (= (Equiv.__default.P |st#0| (Lit DatatypeTypeType |e#0@@1|)) (let ((|res#1@@0| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@1|) (Equiv.MState.ctx |st#0|))))
(let ((|res'#1@@0| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@1|) (Equiv.MState.ctx_k |st#0|))))
 (=> (Equiv.__default.Inv |st#0|) (Equiv.__default.EqResult |res#1@@0| |res'#1@@0|)))))))
 :qid |Inductiondfy.34:21|
 :weight 3
 :skolemid |689|
 :pattern ( (Equiv.__default.P |st#0| (Lit DatatypeTypeType |e#0@@1|)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|res#0| T@U) (|res'#0| T@U) ) (!  (=> (or (|Equiv.__default.EqResult#canCall| |res#0| |res'#0|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |res#0| (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType |res'#0| (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt))))))) (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0|) ($Box DatatypeTypeType |res'#0|))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0|) ($Box DatatypeTypeType |res'#0|))))) (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0|) ($Box DatatypeTypeType |res'#0|))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0|) ($Box DatatypeTypeType |res'#0|))))) (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0|) ($Box DatatypeTypeType |res'#0|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0|) ($Box DatatypeTypeType |res'#0|)))))))) (let ((|ctx'#1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0|) ($Box DatatypeTypeType |res'#0|))))))))))
 (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0|) ($Box DatatypeTypeType |res'#0|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0|) ($Box DatatypeTypeType |res'#0|)))))))) (let ((|v'#1| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0|) ($Box DatatypeTypeType |res'#0|)))))))))))
 (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0|) ($Box DatatypeTypeType |res'#0|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0|) ($Box DatatypeTypeType |res'#0|)))))))) (let ((|ctx#1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0|) ($Box DatatypeTypeType |res'#0|))))))))))
 (and (and (_System.Tuple2.___hMake2_q (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0|) ($Box DatatypeTypeType |res'#0|))) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0|) ($Box DatatypeTypeType |res'#0|)))))))) (let ((|v#1| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0|) ($Box DatatypeTypeType |res'#0|)))))))))))
 (and (|Equiv.__default.EqValue#canCall| |v#1| |v'#1|) (=> (Equiv.__default.EqValue |v#1| |v'#1|) (|Equiv.__default.EqCtx#canCall| |ctx#1| |ctx'#1|))))))))))))))) (= (Equiv.__default.EqResult |res#0| |res'#0|) (ite (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0|) ($Box DatatypeTypeType |res'#0|))))) (ite (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0|) ($Box DatatypeTypeType |res'#0|))))) (let ((|ctx'#0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0|) ($Box DatatypeTypeType |res'#0|))))))))))
(let ((|v'#0| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0|) ($Box DatatypeTypeType |res'#0|)))))))))))
(let ((|ctx#0@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0|) ($Box DatatypeTypeType |res'#0|))))))))))
(let ((|v#0| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0|) ($Box DatatypeTypeType |res'#0|)))))))))))
 (and (Equiv.__default.EqValue |v#0| |v'#0|) (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#0@@0| |ctx'#0|)))))) false) true))))
 :qid |Equivdfy.33:28|
 :skolemid |667|
 :pattern ( (Equiv.__default.EqResult |res#0| |res'#0|))
))))
...
(assert (forall (($ly@@0 T@U) (|e#0@@2| T@U) (|ctx#0@@1| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@2| |ctx#0@@1|) (and ($Is DatatypeTypeType |e#0@@2| Tclass.AST.Expr) ($Is MapType |ctx#0@@1| (TMap (TSeq TChar) TInt)))) (and (=> (not (AST.Expr__Raw.Var_q |e#0@@2|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@2|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@2|) (let ((|body#1| (AST.Expr__Raw.body |e#0@@2|)))
...
(|Interp.__default.InterpBinOp#canCall| |op#1| |v1#1| |v2#1|)))))))))))))))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@2|)) (let ((|es#1| (AST.Expr__Raw.es |e#0@@2|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#1|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@0) |e#0@@2| |ctx#0@@1|) (ite (AST.Expr__Raw.Var_q |e#0@@2|) (let ((|name#0| (AST.Expr__Raw.name |e#0@@2|)))
(ite (|Set#IsMember| (|Map#Domain| |ctx#0@@1|) ($Box SeqType |name#0|)) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@1|) ($Box SeqType |name#0|)) ($Box MapType |ctx#0@@1|)))) |#Utils.Result.Failure|)) (ite (AST.Expr__Raw.Literal_q |e#0@@2|) (let ((|n#0| (AST.Expr__Raw.n |e#0@@2|)))
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#0|)) ($Box MapType |ctx#0@@1|))))) (ite (AST.Expr__Raw.Bind_q |e#0@@2|) (let ((|body#0| (AST.Expr__Raw.body |e#0@@2|)))
...
(ite (|Seq#Equal| |vs#2@@0| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#3|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#2@@0| (- (|Seq#Length| |vs#2@@0|) 1)) ($Box MapType |ctx1#3|)))))))))))))))))))
 :qid |Interpdfy.24:12|
 :skolemid |1200|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@0) |e#0@@2| |ctx#0@@1|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0@@0| T@U) ) (!  (=> (or (|Equiv.__default.Inv#canCall| |st#0@@0|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |st#0@@0| Tclass.Equiv.MState))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (and (Equiv.MState.MState_q |st#0@@0|) (Equiv.MState.MState_q |st#0@@0|)) (|Equiv.__default.EqCtx#canCall| (Equiv.MState.ctx |st#0@@0|) (Equiv.MState.ctx_k |st#0@@0|)))) (= (Equiv.__default.Inv |st#0@@0|)  (and true (Equiv.__default.EqCtx reveal_Equiv._default.EqCtx (Equiv.MState.ctx |st#0@@0|) (Equiv.MState.ctx_k |st#0@@0|))))))
 :qid |Equivdfy.72:23|
 :skolemid |682|
 :pattern ( (Equiv.__default.Inv |st#0@@0|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|e#0@@3| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| |st#0@@1| |e#0@@3|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@1| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@3| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@1|) (=> (Equiv.__default.Inv |st#0@@1|) (and (Equiv.MState.MState_q |st#0@@1|) (|Interp.__default.InterpExpr#canCall| |e#0@@3| (Equiv.MState.ctx |st#0@@1|))))) (= (Equiv.__default.P__Fail |st#0@@1| |e#0@@3|)  (=> (Equiv.__default.Inv |st#0@@1|) (Utils.Result.Failure_q (Interp.__default.InterpExpr ($LS $LZ) |e#0@@3| (Equiv.MState.ctx |st#0@@1|)))))))
 :qid |Inductiondfy.36:26|
 :skolemid |706|
 :pattern ( (Equiv.__default.P__Fail |st#0@@1| |e#0@@3|))
))))
...
(assert (forall ((d@@4 T@U) ) (! (= (Equiv.MState.MState_q d@@4) (= (DatatypeCtorId d@@4) |##Equiv.MState.MState|))
 :qid |unknown.0:0|
 :skolemid |886|
...
(assert (forall (($ly@@3 T@U) (|e#0@@5| T@U) (|p#0@@0| T@U) ) (! (= (AST.Expr__Raw.All ($LS $ly@@3) |e#0@@5| |p#0@@0|) (AST.Expr__Raw.All $ly@@3 |e#0@@5| |p#0@@0|))
 :qid |ASTdfy.44:22|
 :skolemid |1139|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@3) |e#0@@5| |p#0@@0|))
)))
...
(assert (forall ((bx@@6 T@U) ) (!  (=> ($IsBox bx@@6 Tclass.Equiv.MState) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@6)) bx@@6) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@6) Tclass.Equiv.MState)))
 :qid |unknown.0:0|
 :skolemid |679|
 :pattern ( ($IsBox bx@@6 Tclass.Equiv.MState))
)))
(assert (forall ((bx@@7 T@U) ) (!  (=> ($IsBox bx@@7 Tclass.AST.Expr) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@7)) bx@@7) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@7) Tclass.AST.Expr)))
 :qid |unknown.0:0|
 :skolemid |685|
 :pattern ( ($IsBox bx@@7 Tclass.AST.Expr))
)))
...
(assert (forall (($ly@@4 T@U) (|e#0@@7| T@U) (|ctx#0@@4| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@7| |ctx#0@@4|) (and ($Is DatatypeTypeType |e#0@@7| Tclass.AST.Expr) ($Is MapType |ctx#0@@4| (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType (Interp.__default.InterpExpr $ly@@4 |e#0@@7| |ctx#0@@4|) (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))))
 :qid |Interpdfy.24:12|
 :skolemid |1198|
 :pattern ( (Interp.__default.InterpExpr $ly@@4 |e#0@@7| |ctx#0@@4|))
)))
(assert (forall (($ly@@5 T@U) (|e#0@@8| T@U) (|ctx#0@@5| T@U) ) (! (= (Interp.__default.InterpExpr ($LS $ly@@5) |e#0@@8| |ctx#0@@5|) (Interp.__default.InterpExpr $ly@@5 |e#0@@8| |ctx#0@@5|))
 :qid |Interpdfy.24:12|
 :skolemid |1196|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@5) |e#0@@8| |ctx#0@@5|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|e#0@@9| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| |st#0@@3| (Lit DatatypeTypeType |e#0@@9|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@3| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@9| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@3|) (=> (Equiv.__default.Inv |st#0@@3|) (and (Equiv.MState.MState_q |st#0@@3|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@9|) (Equiv.MState.ctx |st#0@@3|))))) (= (Equiv.__default.P__Fail |st#0@@3| (Lit DatatypeTypeType |e#0@@9|))  (=> (Equiv.__default.Inv |st#0@@3|) (Utils.Result.Failure_q (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@9|) (Equiv.MState.ctx |st#0@@3|)))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |707|
 :pattern ( (Equiv.__default.P__Fail |st#0@@3| (Lit DatatypeTypeType |e#0@@9|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|res#0@@0| T@U) (|res'#0@@0| T@U) ) (!  (=> (or (|Equiv.__default.EqResult#canCall| (Lit DatatypeTypeType |res#0@@0|) (Lit DatatypeTypeType |res'#0@@0|)) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |res#0@@0| (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType |res'#0@@0| (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt))))))) (and (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@0|))))) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Result.Success_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@0|))))))))))) (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@0|))))) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Result.Success_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@0|))))))))))) (and (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@0|))))) (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@0|)))))))))))) (let ((|ctx'#3| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@0|)))))))))))))))
 (and (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@0|))))) (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@0|)))))))))))) (let ((|v'#3| (LitInt (U_2_int ($Unbox intType (_System.Tuple2._0 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@0|))))))))))))))))
 (and (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@0|))))) (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@0|)))))))))))) (let ((|ctx#3| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@0|)))))))))))))))
 (and (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@0|))))) (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@0|)))))))))))) (let ((|v#3| (LitInt (U_2_int ($Unbox intType (_System.Tuple2._0 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@0|))))))))))))))))
 (and (|Equiv.__default.EqValue#canCall| |v#3| |v'#3|) (=> (Equiv.__default.EqValue |v#3| |v'#3|) (|Equiv.__default.EqCtx#canCall| |ctx#3| |ctx'#3|))))))))))))))) (= (Equiv.__default.EqResult (Lit DatatypeTypeType |res#0@@0|) (Lit DatatypeTypeType |res'#0@@0|)) (ite (Utils.Result.Success_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@0|)))))))) (ite (Utils.Result.Success_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@0|)))))))) (let ((|ctx'#2| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._1 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@0|)))))))))))))))
...
(let ((|v#2@@0| (LitInt (U_2_int ($Unbox intType (_System.Tuple2._0 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_System.Tuple2._0 (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType (Lit DatatypeTypeType |res#0@@0|)) ($Box DatatypeTypeType (Lit DatatypeTypeType |res'#0@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |668|
 :pattern ( (Equiv.__default.EqResult (Lit DatatypeTypeType |res#0@@0|) (Lit DatatypeTypeType |res'#0@@0|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|e#0@@10| T@U) ) (!  (=> (or (|Equiv.__default.P#canCall| |st#0@@4| |e#0@@10|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@4| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@10| Tclass.AST.Expr)))) (and (and (and (Equiv.MState.MState_q |st#0@@4|) (|Interp.__default.InterpExpr#canCall| |e#0@@10| (Equiv.MState.ctx |st#0@@4|))) (let ((|res#0@@1| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@10| (Equiv.MState.ctx |st#0@@4|))))
 (and (and (Equiv.MState.MState_q |st#0@@4|) (|Interp.__default.InterpExpr#canCall| |e#0@@10| (Equiv.MState.ctx_k |st#0@@4|))) (let ((|res'#0@@1| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@10| (Equiv.MState.ctx_k |st#0@@4|))))
 (and (|Equiv.__default.Inv#canCall| |st#0@@4|) (=> (Equiv.__default.Inv |st#0@@4|) (|Equiv.__default.EqResult#canCall| |res#0@@1| |res'#0@@1|))))))) (= (Equiv.__default.P |st#0@@4| |e#0@@10|) (let ((|res#0@@2| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@10| (Equiv.MState.ctx |st#0@@4|))))
(let ((|res'#0@@2| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@10| (Equiv.MState.ctx_k |st#0@@4|))))
 (=> (Equiv.__default.Inv |st#0@@4|) (Equiv.__default.EqResult |res#0@@2| |res'#0@@2|)))))))
 :qid |Inductiondfy.34:21|
 :skolemid |688|
 :pattern ( (Equiv.__default.P |st#0@@4| |e#0@@10|))
))))
...
(assert (forall ((|e#0@@11| T@U) ) (!  (=> ($Is DatatypeTypeType |e#0@@11| Tclass.AST.Expr__Raw) (= (|AST.Expr__Raw.WellFormed__Single#requires| |e#0@@11|) true))
 :qid |ASTdfy.71:46|
 :skolemid |1179|
 :pattern ( (|AST.Expr__Raw.WellFormed__Single#requires| |e#0@@11|))
)))
...
(assert (forall (($ly@@11 T@U) (|e#0@@12| T@U) (|ctx#0@@10| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@12|) (Lit MapType |ctx#0@@10|)) (and ($Is DatatypeTypeType |e#0@@12| Tclass.AST.Expr) ($Is MapType |ctx#0@@10| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@12|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@12|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@12|))))) (let ((|body#5| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@12|)))))
...
(let ((|ctx2#10| (|Map#Merge| |ctx1#20| |bindings#10|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError1#5|))))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@12|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@12|))))) (let ((|avals#5| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@12|)))))
...
(|Interp.__default.VarsAndValuesToContext#canCall| |avars#5| |vs#16|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@12|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@12|))))) (let ((|els#5| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@12|)))))
...
(let ((|condv#5| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError3#5|)))))))
 (and (=> (or (not (= |condv#5| 0)) (not true)) (|Interp.__default.InterpExpr#canCall| |thn#5| |ctx_cond#5|)) (=> (= |condv#5| 0) (|Interp.__default.InterpExpr#canCall| |els#5| |ctx_cond#5|)))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@12|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@12|))))) (let ((|e2#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@12|)))))
(let ((|e1#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@12|)))))
(let ((|op#5| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@12|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#5| |v1#5| |v2#5|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@12|)))))) (let ((|es#5| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@12|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |bodyv#4|)) ($Box MapType |ctx4#4|)))))))))))))))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@12|)) (let ((|avals#4| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@12|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType (|Map#Merge| |ctx1#17| |bindings#9|)))))))))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@12|)) (let ((|els#4| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@12|)))))
...
(ite  (or (not (= |condv#4| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@11) |thn#4| |ctx_cond#4|) (Interp.__default.InterpExpr ($LS $ly@@11) |els#4| |ctx_cond#4|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@12|)) (let ((|e2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@12|)))))
(let ((|e1#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@12|)))))
(let ((|op#4| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@12|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#4| |v1#4| |v2#4|))) ($Box MapType |ctx2#9|))))))))))))))) (let ((|es#4| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@12|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1202|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@11) (Lit DatatypeTypeType |e#0@@12|) (Lit MapType |ctx#0@@10|)))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|e#0@@13| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| (Lit DatatypeTypeType |st#0@@5|) (Lit DatatypeTypeType |e#0@@13|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@5| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@13| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@5|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@5|))))) (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@5|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@13|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@5|))))))) (= (Equiv.__default.P__Fail (Lit DatatypeTypeType |st#0@@5|) (Lit DatatypeTypeType |e#0@@13|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@5|)) (Utils.Result.Failure_q (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@13|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@5|)))))))))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |708|
 :pattern ( (Equiv.__default.P__Fail (Lit DatatypeTypeType |st#0@@5|) (Lit DatatypeTypeType |e#0@@13|)))
))))
...
(assert (forall ((d@@33 T@U) (Utils.Result$T@@14 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (Utils.Result.Success_q d@@33) ($IsAlloc DatatypeTypeType d@@33 (Tclass.Utils.Result Utils.Result$T@@14) $h@@5))) ($IsAllocBox (Utils.Result.value d@@33) Utils.Result$T@@14 $h@@5))
 :qid |unknown.0:0|
 :skolemid |965|
 :pattern ( ($IsAllocBox (Utils.Result.value d@@33) Utils.Result$T@@14 $h@@5))
)))
...
(assert (forall ((d@@34 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (AST.Expr__Raw.Literal_q d@@34) ($IsAlloc DatatypeTypeType d@@34 Tclass.AST.Expr__Raw $h@@6))) ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@34)) TInt $h@@6))
 :qid |unknown.0:0|
 :skolemid |1042|
 :pattern ( ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@34)) TInt $h@@6))
)))
...
(assert (forall (($ly@@13 T@U) (|e#0@@14| T@U) (|ctx#0@@11| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@14|) |ctx#0@@11|) (and ($Is DatatypeTypeType |e#0@@14| Tclass.AST.Expr) ($Is MapType |ctx#0@@11| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@14|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@14|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@14|))))) (let ((|body#3| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|bvals#3| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|bvars#3| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@14|)))))
...
(|Interp.__default.VarsAndValuesToContext#canCall| |avars#3| |vs#10|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@14|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@14|))))) (let ((|els#3| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|thn#3| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|cond#3| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@14|)))))
...
(let ((|condv#3| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError3#3|)))))))
 (and (=> (or (not (= |condv#3| 0)) (not true)) (|Interp.__default.InterpExpr#canCall| |thn#3| |ctx_cond#3|)) (=> (= |condv#3| 0) (|Interp.__default.InterpExpr#canCall| |els#3| |ctx_cond#3|)))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@14|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@14|))))) (let ((|e2#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|e1#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|op#3| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@14|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#3| |v1#3| |v2#3|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@14|)))))) (let ((|es#3| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@14|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#3|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@13) (Lit DatatypeTypeType |e#0@@14|) |ctx#0@@11|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@14|)) (let ((|name#2| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@14|)))))
(ite (|Set#IsMember| (|Map#Domain| |ctx#0@@11|) ($Box SeqType |name#2|)) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@11|) ($Box SeqType |name#2|)) ($Box MapType |ctx#0@@11|)))) |#Utils.Result.Failure|)) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@14|)) (let ((|n#2| (LitInt (AST.Expr__Raw.n (Lit DatatypeTypeType |e#0@@14|)))))
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#2|)) ($Box MapType |ctx#0@@11|))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@14|)) (let ((|body#2| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@14|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |bodyv#2|)) ($Box MapType |ctx4#2|)))))))))))))))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@14|)) (let ((|avals#2@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@14|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType (|Map#Merge| |ctx1#9| |bindings#5|)))))))))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@14|)) (let ((|els#2| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|thn#2| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|cond#2| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@14|)))))
...
(ite  (or (not (= |condv#2| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@13) |thn#2| |ctx_cond#2|) (Interp.__default.InterpExpr ($LS $ly@@13) |els#2| |ctx_cond#2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@14|)) (let ((|e2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|e1#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|op#2| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@14|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#2| |v1#2| |v2#2|))) ($Box MapType |ctx2#5|))))))))))))))) (let ((|es#2| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@14|)))))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1201|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@13) (Lit DatatypeTypeType |e#0@@14|) |ctx#0@@11|))
)))
...
(assert (forall ((v@@12 T@U) (t0@@11 T@U) (t1@@8 T@U) ) (! (= ($Is MapType v@@12 (TMap t0@@11 t1@@8)) (forall ((bx@@23 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@12) bx@@23) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@12) bx@@23) t1@@8) ($IsBox bx@@23 t0@@11)))
 :qid |DafnyPreludebpl.261:19|
 :skolemid |55|
 :pattern ( (MapType0Select BoxType BoxType (|Map#Elements| v@@12) bx@@23))
 :pattern ( (|Set#IsMember| (|Map#Domain| v@@12) bx@@23))
)))
...
(assert (forall ((d@@37 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) ($Is DatatypeTypeType d@@37 Tclass.Equiv.MState)) ($IsAlloc DatatypeTypeType d@@37 Tclass.Equiv.MState $h@@7))
 :qid |unknown.0:0|
 :skolemid |899|
 :pattern ( ($IsAlloc DatatypeTypeType d@@37 Tclass.Equiv.MState $h@@7))
)))
(assert (forall ((d@@38 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) ($Is DatatypeTypeType d@@38 Tclass.AST.BinOp)) ($IsAlloc DatatypeTypeType d@@38 Tclass.AST.BinOp $h@@8))
 :qid |unknown.0:0|
 :skolemid |1020|
 :pattern ( ($IsAlloc DatatypeTypeType d@@38 Tclass.AST.BinOp $h@@8))
)))
(assert (forall ((d@@39 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) ($Is DatatypeTypeType d@@39 Tclass.AST.Expr__Raw)) ($IsAlloc DatatypeTypeType d@@39 Tclass.AST.Expr__Raw $h@@9))
 :qid |unknown.0:0|
 :skolemid |1116|
 :pattern ( ($IsAlloc DatatypeTypeType d@@39 Tclass.AST.Expr__Raw $h@@9))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|e#0@@15| T@U) ) (!  (=> (or (|Equiv.__default.P#canCall| (Lit DatatypeTypeType |st#0@@6|) (Lit DatatypeTypeType |e#0@@15|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr)))) (and (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@6|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@15|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@6|))))) (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@15|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@6|)))))))
 (and (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@6|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@15|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@6|))))) (let ((|res'#2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@15|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@6|)))))))
 (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@6|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@6|))))) (|Equiv.__default.EqResult#canCall| |res#2| |res'#2|))))))) (= (Equiv.__default.P (Lit DatatypeTypeType |st#0@@6|) (Lit DatatypeTypeType |e#0@@15|)) (U_2_bool (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@15|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@6|)))))))
(let ((|res'#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@15|) (Lit MapType (Equiv.MState.ctx_k (Lit DatatypeTypeType |st#0@@6|)))))))
(Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@6|)) (Equiv.__default.EqResult |res#2@@0| |res'#2@@0|))))))))))
 :qid |Inductiondfy.34:21|
 :weight 3
 :skolemid |690|
 :pattern ( (Equiv.__default.P (Lit DatatypeTypeType |st#0@@6|) (Lit DatatypeTypeType |e#0@@15|)))
))))
...
(assert (forall ((d@@40 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) (and (AST.Expr__Raw.Var_q d@@40) ($IsAlloc DatatypeTypeType d@@40 Tclass.AST.Expr__Raw $h@@10))) ($IsAlloc SeqType (AST.Expr__Raw.name d@@40) (TSeq TChar) $h@@10))
 :qid |unknown.0:0|
 :skolemid |1032|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.name d@@40) (TSeq TChar) $h@@10))
)))
...
(assert (forall ((|a#5#0#0@@1| T@U) (|a#5#1#0@@0| T@U) (d@@41 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#5#0#0@@1|) ($Box DatatypeTypeType d@@41)) (< (DtRank d@@41) (DtRank (|#Equiv.MState.MState| |a#5#0#0@@1| |a#5#1#0@@0|))))
 :qid |Equivdfy.62:28|
 :skolemid |894|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#5#0#0@@1|) ($Box DatatypeTypeType d@@41)) (|#Equiv.MState.MState| |a#5#0#0@@1| |a#5#1#0@@0|))
)))
(assert (forall ((|a#8#0#0| T@U) (|a#8#1#0| T@U) (d@@42 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#8#1#0|) ($Box DatatypeTypeType d@@42)) (< (DtRank d@@42) (DtRank (|#Equiv.MState.MState| |a#8#0#0| |a#8#1#0|))))
 :qid |Equivdfy.62:28|
 :skolemid |897|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#8#1#0|) ($Box DatatypeTypeType d@@42)) (|#Equiv.MState.MState| |a#8#0#0| |a#8#1#0|))
)))
...
(assert (forall ((d@@43 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (Equiv.MState.MState_q d@@43) ($IsAlloc DatatypeTypeType d@@43 Tclass.Equiv.MState $h@@11))) ($IsAlloc MapType (Equiv.MState.ctx d@@43) (TMap (TSeq TChar) TInt) $h@@11))
 :qid |unknown.0:0|
 :skolemid |890|
 :pattern ( ($IsAlloc MapType (Equiv.MState.ctx d@@43) (TMap (TSeq TChar) TInt) $h@@11))
)))
(assert (forall ((d@@44 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (Equiv.MState.MState_q d@@44) ($IsAlloc DatatypeTypeType d@@44 Tclass.Equiv.MState $h@@12))) ($IsAlloc MapType (Equiv.MState.ctx_k d@@44) (TMap (TSeq TChar) TInt) $h@@12))
 :qid |unknown.0:0|
 :skolemid |891|
 :pattern ( ($IsAlloc MapType (Equiv.MState.ctx_k d@@44) (TMap (TSeq TChar) TInt) $h@@12))
)))
(assert (forall ((d@@45 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (_System.Tuple2.___hMake2_q d@@45) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@45 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@13)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@45 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@13))
)))) ($IsAllocBox (_System.Tuple2._0 d@@45) |_System._tuple#2$T0@@6| $h@@13))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@45) |_System._tuple#2$T0@@6| $h@@13))
)))
(assert (forall ((d@@46 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (_System.Tuple2.___hMake2_q d@@46) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@46 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@14)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@46 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@14))
)))) ($IsAllocBox (_System.Tuple2._1 d@@46) |_System._tuple#2$T1@@7| $h@@14))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@46) |_System._tuple#2$T1@@7| $h@@14))
)))
...
(assert (forall ((d@@47 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (AST.Expr__Raw.Bind_q d@@47) ($IsAlloc DatatypeTypeType d@@47 Tclass.AST.Expr__Raw $h@@15))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@47) Tclass.AST.Expr__Raw $h@@15))
 :qid |unknown.0:0|
 :skolemid |1052|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@47) Tclass.AST.Expr__Raw $h@@15))
)))
(assert (forall ((d@@48 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (AST.Expr__Raw.If_q d@@48) ($IsAlloc DatatypeTypeType d@@48 Tclass.AST.Expr__Raw $h@@16))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@48) Tclass.AST.Expr__Raw $h@@16))
 :qid |unknown.0:0|
 :skolemid |1081|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@48) Tclass.AST.Expr__Raw $h@@16))
)))
(assert (forall ((d@@49 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (AST.Expr__Raw.If_q d@@49) ($IsAlloc DatatypeTypeType d@@49 Tclass.AST.Expr__Raw $h@@17))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@49) Tclass.AST.Expr__Raw $h@@17))
 :qid |unknown.0:0|
 :skolemid |1082|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@49) Tclass.AST.Expr__Raw $h@@17))
)))
(assert (forall ((d@@50 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (AST.Expr__Raw.If_q d@@50) ($IsAlloc DatatypeTypeType d@@50 Tclass.AST.Expr__Raw $h@@18))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@50) Tclass.AST.Expr__Raw $h@@18))
 :qid |unknown.0:0|
 :skolemid |1083|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@50) Tclass.AST.Expr__Raw $h@@18))
)))
(assert (forall ((d@@51 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (AST.Expr__Raw.Op_q d@@51) ($IsAlloc DatatypeTypeType d@@51 Tclass.AST.Expr__Raw $h@@19))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@51) Tclass.AST.BinOp $h@@19))
 :qid |unknown.0:0|
 :skolemid |1096|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@51) Tclass.AST.BinOp $h@@19))
)))
(assert (forall ((d@@52 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (AST.Expr__Raw.Op_q d@@52) ($IsAlloc DatatypeTypeType d@@52 Tclass.AST.Expr__Raw $h@@20))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@52) Tclass.AST.Expr__Raw $h@@20))
 :qid |unknown.0:0|
 :skolemid |1097|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@52) Tclass.AST.Expr__Raw $h@@20))
)))
(assert (forall ((d@@53 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (AST.Expr__Raw.Op_q d@@53) ($IsAlloc DatatypeTypeType d@@53 Tclass.AST.Expr__Raw $h@@21))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@53) Tclass.AST.Expr__Raw $h@@21))
 :qid |unknown.0:0|
 :skolemid |1098|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@53) Tclass.AST.Expr__Raw $h@@21))
)))
...
(assert (forall ((d@@54 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (AST.Expr__Raw.Bind_q d@@54) ($IsAlloc DatatypeTypeType d@@54 Tclass.AST.Expr__Raw $h@@22))) ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@54) (TSeq (TSeq TChar)) $h@@22))
 :qid |unknown.0:0|
 :skolemid |1050|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@54) (TSeq (TSeq TChar)) $h@@22))
)))
(assert (forall ((d@@55 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (AST.Expr__Raw.Assign_q d@@55) ($IsAlloc DatatypeTypeType d@@55 Tclass.AST.Expr__Raw $h@@23))) ($IsAlloc SeqType (AST.Expr__Raw.avars d@@55) (TSeq (TSeq TChar)) $h@@23))
 :qid |unknown.0:0|
 :skolemid |1067|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avars d@@55) (TSeq (TSeq TChar)) $h@@23))
)))
...
(assert (forall ((d@@56 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (AST.Expr__Raw.Bind_q d@@56) ($IsAlloc DatatypeTypeType d@@56 Tclass.AST.Expr__Raw $h@@24))) ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@56) (TSeq Tclass.AST.Expr__Raw) $h@@24))
 :qid |unknown.0:0|
 :skolemid |1051|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@56) (TSeq Tclass.AST.Expr__Raw) $h@@24))
)))
(assert (forall ((d@@57 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (AST.Expr__Raw.Assign_q d@@57) ($IsAlloc DatatypeTypeType d@@57 Tclass.AST.Expr__Raw $h@@25))) ($IsAlloc SeqType (AST.Expr__Raw.avals d@@57) (TSeq Tclass.AST.Expr__Raw) $h@@25))
 :qid |unknown.0:0|
 :skolemid |1068|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avals d@@57) (TSeq Tclass.AST.Expr__Raw) $h@@25))
)))
(assert (forall ((d@@58 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (AST.Expr__Raw.Seq_q d@@58) ($IsAlloc DatatypeTypeType d@@58 Tclass.AST.Expr__Raw $h@@26))) ($IsAlloc SeqType (AST.Expr__Raw.es d@@58) (TSeq Tclass.AST.Expr__Raw) $h@@26))
 :qid |unknown.0:0|
 :skolemid |1111|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.es d@@58) (TSeq Tclass.AST.Expr__Raw) $h@@26))
)))
...
(set-info :boogie-vc-id Impl$$Equiv.__default.InductVar)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@6 $Heap@0) reveal_Equiv._default.EqCtx)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|Equiv.__default.P#canCall| |st#0@@7| |e#0@@19|) (or (Equiv.__default.P |st#0@@7| |e#0@@19|) (let ((|res#1@@1| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx |st#0@@7|))))
(let ((|res'#1@@1| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx_k |st#0@@7|))))
 (=> (Equiv.__default.Inv |st#0@@7|) (=> (|Equiv.__default.EqResult#canCall| |res#1@@1| |res'#1@@1|) (or (Equiv.__default.EqResult |res#1@@1| |res'#1@@1|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@1|) ($Box DatatypeTypeType |res'#1@@1|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@1|) ($Box DatatypeTypeType |res'#1@@1|))))) (let ((|v'#2@@0| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@1|) ($Box DatatypeTypeType |res'#1@@1|)))))))))))
(let ((|v#2@@1| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@1|) ($Box DatatypeTypeType |res'#1@@1|)))))))))))
 (=> (|Equiv.__default.EqValue#canCall| |v#2@@1| |v'#2@@0|) (or (Equiv.__default.EqValue |v#2@@1| |v'#2@@0|) (= |v#2@@1| |v'#2@@0|))))))))))))))) (=> (=> (|Equiv.__default.P#canCall| |st#0@@7| |e#0@@19|) (or (Equiv.__default.P |st#0@@7| |e#0@@19|) (let ((|res#1@@2| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx |st#0@@7|))))
(let ((|res'#1@@2| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx_k |st#0@@7|))))
 (=> (Equiv.__default.Inv |st#0@@7|) (=> (|Equiv.__default.EqResult#canCall| |res#1@@2| |res'#1@@2|) (or (Equiv.__default.EqResult |res#1@@2| |res'#1@@2|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@2|) ($Box DatatypeTypeType |res'#1@@2|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@2|) ($Box DatatypeTypeType |res'#1@@2|))))) (let ((|v'#2@@1| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@2|) ($Box DatatypeTypeType |res'#1@@2|)))))))))))
(let ((|v#2@@2| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@2|) ($Box DatatypeTypeType |res'#1@@2|)))))))))))
 (=> (|Equiv.__default.EqValue#canCall| |v#2@@2| |v'#2@@1|) (or (Equiv.__default.EqValue |v#2@@2| |v'#2@@1|) (= |v#2@@2| |v'#2@@1|)))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|Equiv.__default.P#canCall| |st#0@@7| |e#0@@19|) (or (Equiv.__default.P |st#0@@7| |e#0@@19|) (let ((|res#1@@3| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx |st#0@@7|))))
(let ((|res'#1@@3| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx_k |st#0@@7|))))
 (=> (Equiv.__default.Inv |st#0@@7|) (=> (|Equiv.__default.EqResult#canCall| |res#1@@3| |res'#1@@3|) (or (Equiv.__default.EqResult |res#1@@3| |res'#1@@3|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#1@@3|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#1@@3|))))) (let ((|ctx'#2@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#1@@3|))))))))))
(let ((|ctx#2@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@3|) ($Box DatatypeTypeType |res'#1@@3|))))))))))
(Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#2@@0| |ctx'#2@@0|))))))))))))) (=> (=> (|Equiv.__default.P#canCall| |st#0@@7| |e#0@@19|) (or (Equiv.__default.P |st#0@@7| |e#0@@19|) (let ((|res#1@@4| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx |st#0@@7|))))
(let ((|res'#1@@4| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx_k |st#0@@7|))))
 (=> (Equiv.__default.Inv |st#0@@7|) (=> (|Equiv.__default.EqResult#canCall| |res#1@@4| |res'#1@@4|) (or (Equiv.__default.EqResult |res#1@@4| |res'#1@@4|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#1@@4|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#1@@4|))))) (let ((|ctx'#2@@1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#1@@4|))))))))))
(let ((|ctx#2@@1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@4|) ($Box DatatypeTypeType |res'#1@@4|))))))))))
(Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |ctx#2@@1| |ctx'#2@@1|)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|Equiv.__default.P#canCall| |st#0@@7| |e#0@@19|) (or (Equiv.__default.P |st#0@@7| |e#0@@19|) (let ((|res#1@@5| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx |st#0@@7|))))
(let ((|res'#1@@5| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx_k |st#0@@7|))))
 (=> (Equiv.__default.Inv |st#0@@7|) (=> (|Equiv.__default.EqResult#canCall| |res#1@@5| |res'#1@@5|) (or (Equiv.__default.EqResult |res#1@@5| |res'#1@@5|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#1@@5|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@5|) ($Box DatatypeTypeType |res'#1@@5|)))))) (U_2_bool (Lit boolType (bool_2_U false))))))))))))) (=> (=> (|Equiv.__default.P#canCall| |st#0@@7| |e#0@@19|) (or (Equiv.__default.P |st#0@@7| |e#0@@19|) (let ((|res#1@@6| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx |st#0@@7|))))
(let ((|res'#1@@6| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx_k |st#0@@7|))))
 (=> (Equiv.__default.Inv |st#0@@7|) (=> (|Equiv.__default.EqResult#canCall| |res#1@@6| |res'#1@@6|) (or (Equiv.__default.EqResult |res#1@@6| |res'#1@@6|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#1@@6|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@6|) ($Box DatatypeTypeType |res'#1@@6|)))))) (U_2_bool (Lit boolType (bool_2_U false)))))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|Equiv.__default.P#canCall| |st#0@@7| |e#0@@19|) (or (Equiv.__default.P |st#0@@7| |e#0@@19|) (let ((|res#1@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx |st#0@@7|))))
(let ((|res'#1@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@19| (Equiv.MState.ctx_k |st#0@@7|))))
 (=> (Equiv.__default.Inv |st#0@@7|) (=> (|Equiv.__default.EqResult#canCall| |res#1@@7| |res'#1@@7|) (or (Equiv.__default.EqResult |res#1@@7| |res'#1@@7|) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#1@@7|) ($Box DatatypeTypeType |res'#1@@7|)))))) (U_2_bool (Lit boolType (bool_2_U true))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@7| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st#0@@7| Tclass.Equiv.MState $Heap@@6)) (|$IsA#Equiv.MState| |st#0@@7|)) (=> (and (and (and ($Is DatatypeTypeType |e#0@@19| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@19| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@19|)) (and (and (= 3 $FunctionContextHeight) (AST.Expr__Raw.Var_q |e#0@@19|)) (and (not (Equiv.__default.P__Fail |st#0@@7| |e#0@@19|)) (= (ControlFlow 0 6) 2)))) anon0_correct)))))
