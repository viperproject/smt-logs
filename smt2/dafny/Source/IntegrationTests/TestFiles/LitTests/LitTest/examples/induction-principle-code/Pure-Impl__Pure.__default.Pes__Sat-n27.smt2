...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|es#0@@3| T@U) ) (!  (=> (or (|Pure.__default.Pes#canCall| |st#0@@1| (Lit SeqType |es#0@@3|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@1| Tclass.Pure.MState) ($Is SeqType |es#0@@3| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@1|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@3|) (Pure.MState.ctx |st#0@@1|))) (let ((|res#1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@3|) (Pure.MState.ctx |st#0@@1|))))
 (and (|Pure.__default.PreEs#canCall| |st#0@@1| (Lit SeqType |es#0@@3|)) (=> (Pure.__default.PreEs |st#0@@1| (Lit SeqType |es#0@@3|)) (|Pure.__default.ResultSameState#canCall| (TSeq TInt) |st#0@@1| |res#1|))))) (= (Pure.__default.Pes |st#0@@1| (Lit SeqType |es#0@@3|)) (let ((|res#1@@0| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@3|) (Pure.MState.ctx |st#0@@1|))))
 (=> (Pure.__default.PreEs |st#0@@1| (Lit SeqType |es#0@@3|)) (Pure.__default.ResultSameState (TSeq TInt) |st#0@@1| |res#1@@0|))))))
 :qid |Inductiondfy.39:23|
 :weight 3
 :skolemid |730|
 :pattern ( (Pure.__default.Pes |st#0@@1| (Lit SeqType |es#0@@3|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|es#0@@8| T@U) ) (!  (=> (or (|Pure.__default.Pes__Fail#canCall| |st#0@@3| (Lit SeqType |es#0@@8|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@3| Tclass.Pure.MState) ($Is SeqType |es#0@@8| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@3|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@8|) (Pure.MState.ctx |st#0@@3|))) (|Pure.__default.PreEs#canCall| |st#0@@3| (Lit SeqType |es#0@@8|))) (= (Pure.__default.Pes__Fail |st#0@@3| (Lit SeqType |es#0@@8|)) (let ((|res#1@@1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@8|) (Pure.MState.ctx |st#0@@3|))))
 (=> (Pure.__default.PreEs |st#0@@3| (Lit SeqType |es#0@@8|)) (Utils.Result.Failure_q |res#1@@1|))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |746|
 :pattern ( (Pure.__default.Pes__Fail |st#0@@3| (Lit SeqType |es#0@@8|)))
))))
...
(assert (forall (($ly@@11 T@U) (|es#0@@9| T@U) (|ctx#0@@4| T@U) ) (! (= (Interp.__default.InterpExprs ($LS $ly@@11) |es#0@@9| |ctx#0@@4|) (Interp.__default.InterpExprs $ly@@11 |es#0@@9| |ctx#0@@4|))
 :qid |Interpdfy.69:12|
 :skolemid |1203|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@11) |es#0@@9| |ctx#0@@4|))
)))
...
(assert (forall (($ly@@14 T@U) (|es#0@@10| T@U) (|ctx#0@@5| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@10| |ctx#0@@5|) (and ($Is SeqType |es#0@@10| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@5| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@10| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@10| (LitInt 0))) |ctx#0@@5|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@14 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@10| (LitInt 0))) |ctx#0@@5|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (|Seq#Drop| |es#0@@10| (LitInt 1)) |ctx1#0@@0|) (let ((|valueOrError1#0@@0| (Interp.__default.InterpExprs $ly@@14 (|Seq#Drop| |es#0@@10| (LitInt 1)) |ctx1#0@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@14) |es#0@@10| |ctx#0@@5|) (ite (|Seq#Equal| |es#0@@10| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@5|)))) (let ((|valueOrError0#0@@1| (Interp.__default.InterpExpr $ly@@14 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@10| (LitInt 0))) |ctx#0@@5|)))
...
(let ((|valueOrError1#0@@1| (Interp.__default.InterpExprs $ly@@14 (|Seq#Drop| |es#0@@10| (LitInt 1)) |ctx1#0@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0|))) |vs#0@@0|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1207|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@14) |es#0@@10| |ctx#0@@5|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|es#0@@11| T@U) ) (!  (=> (or (|Pure.__default.PreEs#canCall| |st#0@@5| |es#0@@11|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@5| Tclass.Pure.MState) ($Is SeqType |es#0@@11| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@5|) (|Pure.__default.IsPure__Es#canCall| |es#0@@11| (Pure.MState.locals |st#0@@5|))) (=> (Pure.__default.IsPure__Es ($LS $LZ) |es#0@@11| (Pure.MState.locals |st#0@@5|)) (and (Pure.MState.MState_q |st#0@@5|) (Pure.MState.MState_q |st#0@@5|)))) (= (Pure.__default.PreEs |st#0@@5| |es#0@@11|)  (and (Pure.__default.IsPure__Es ($LS $LZ) |es#0@@11| (Pure.MState.locals |st#0@@5|)) (|Set#Subset| (Pure.MState.locals |st#0@@5|) (|Map#Domain| (Pure.MState.ctx |st#0@@5|)))))))
 :qid |Puredfy.91:25|
 :skolemid |701|
 :pattern ( (Pure.__default.PreEs |st#0@@5| |es#0@@11|))
))))
...
(assert (forall (($ly@@15 T@U) (|es#0@@12| T@U) (|ctx#0@@6| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@12|) |ctx#0@@6|) (and ($Is SeqType |es#0@@12| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@6| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@12| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@12|) (LitInt 0))) |ctx#0@@6|) (let ((|valueOrError0#1@@0| (Interp.__default.InterpExpr ($LS $ly@@15) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@12|) (LitInt 0))) |ctx#0@@6|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@12|) (LitInt 1))) |ctx1#1@@0|) (let ((|valueOrError1#1@@0| (Interp.__default.InterpExprs ($LS $ly@@15) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@12|) (LitInt 1))) |ctx1#1@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@15) (Lit SeqType |es#0@@12|) |ctx#0@@6|) (ite (|Seq#Equal| |es#0@@12| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@6|)))) (let ((|valueOrError0#1@@1| (Interp.__default.InterpExpr ($LS $ly@@15) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@12|) (LitInt 0))) |ctx#0@@6|)))
...
(let ((|valueOrError1#1@@1| (Interp.__default.InterpExprs ($LS $ly@@15) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@12|) (LitInt 1))) |ctx1#1@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#1|))) |vs#1@@0|)) ($Box MapType |ctx2#1@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |1208|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@15) (Lit SeqType |es#0@@12|) |ctx#0@@6|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|es#0@@13| T@U) ) (!  (=> (or (|Pure.__default.Pes#canCall| |st#0@@6| |es#0@@13|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.Pure.MState) ($Is SeqType |es#0@@13| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@6|) (|Interp.__default.InterpExprs#canCall| |es#0@@13| (Pure.MState.ctx |st#0@@6|))) (let ((|res#0@@2| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@13| (Pure.MState.ctx |st#0@@6|))))
 (and (|Pure.__default.PreEs#canCall| |st#0@@6| |es#0@@13|) (=> (Pure.__default.PreEs |st#0@@6| |es#0@@13|) (|Pure.__default.ResultSameState#canCall| (TSeq TInt) |st#0@@6| |res#0@@2|))))) (= (Pure.__default.Pes |st#0@@6| |es#0@@13|) (let ((|res#0@@3| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@13| (Pure.MState.ctx |st#0@@6|))))
 (=> (Pure.__default.PreEs |st#0@@6| |es#0@@13|) (Pure.__default.ResultSameState (TSeq TInt) |st#0@@6| |res#0@@3|))))))
 :qid |Inductiondfy.39:23|
 :skolemid |729|
 :pattern ( (Pure.__default.Pes |st#0@@6| |es#0@@13|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|es#0@@15| T@U) ) (!  (=> (or (|Pure.__default.Pes__Fail#canCall| |st#0@@7| |es#0@@15|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@7| Tclass.Pure.MState) ($Is SeqType |es#0@@15| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q |st#0@@7|) (|Interp.__default.InterpExprs#canCall| |es#0@@15| (Pure.MState.ctx |st#0@@7|))) (|Pure.__default.PreEs#canCall| |st#0@@7| |es#0@@15|)) (= (Pure.__default.Pes__Fail |st#0@@7| |es#0@@15|) (let ((|res#0@@4| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@15| (Pure.MState.ctx |st#0@@7|))))
 (=> (Pure.__default.PreEs |st#0@@7| |es#0@@15|) (Utils.Result.Failure_q |res#0@@4|))))))
 :qid |Inductiondfy.41:28|
 :skolemid |745|
 :pattern ( (Pure.__default.Pes__Fail |st#0@@7| |es#0@@15|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@21 T@U) (|es#0@@16| T@U) (|locals#0@@6| T@U) ) (!  (=> (or (|Pure.__default.IsPure__Es#canCall| (Lit SeqType |es#0@@16|) |locals#0@@6|) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |es#0@@16| (TSeq Tclass.AST.Expr)) ($Is SetType |locals#0@@6| (TSet (TSeq TChar)))))) (and (=> (not (|Seq#Equal| |es#0@@16| |Seq#Empty|)) (and (|Pure.__default.IsPure#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@16|) (LitInt 0))) |locals#0@@6|) (=> (Pure.__default.IsPure ($LS $ly@@21) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@16|) (LitInt 0))) |locals#0@@6|) (|Pure.__default.IsPure__Es#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@16|) (LitInt 1))) |locals#0@@6|)))) (= (Pure.__default.IsPure__Es ($LS $ly@@21) (Lit SeqType |es#0@@16|) |locals#0@@6|) (ite (|Seq#Equal| |es#0@@16| |Seq#Empty|) true  (and (Pure.__default.IsPure ($LS $ly@@21) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@16|) (LitInt 0))) |locals#0@@6|) (Pure.__default.IsPure__Es ($LS $ly@@21) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@16|) (LitInt 1))) |locals#0@@6|))))))
 :qid |Puredfy.39:13|
 :weight 3
 :skolemid |672|
 :pattern ( (Pure.__default.IsPure__Es ($LS $ly@@21) (Lit SeqType |es#0@@16|) |locals#0@@6|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|es#0@@17| T@U) ) (!  (=> (or (|Pure.__default.Pes#canCall| (Lit DatatypeTypeType |st#0@@8|) (Lit SeqType |es#0@@17|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@8| Tclass.Pure.MState) ($Is SeqType |es#0@@17| (TSeq Tclass.AST.Expr))))) (and (and (and (Pure.MState.MState_q (Lit DatatypeTypeType |st#0@@8|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@17|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@8|))))) (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@17|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@8|)))))))
 (and (|Pure.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@8|) (Lit SeqType |es#0@@17|)) (=> (U_2_bool (Lit boolType (bool_2_U (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@8|) (Lit SeqType |es#0@@17|))))) (|Pure.__default.ResultSameState#canCall| (TSeq TInt) (Lit DatatypeTypeType |st#0@@8|) |res#2@@0|))))) (= (Pure.__default.Pes (Lit DatatypeTypeType |st#0@@8|) (Lit SeqType |es#0@@17|)) (U_2_bool (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@17|) (Lit MapType (Pure.MState.ctx (Lit DatatypeTypeType |st#0@@8|)))))))
(Lit boolType (bool_2_U  (=> (Pure.__default.PreEs (Lit DatatypeTypeType |st#0@@8|) (Lit SeqType |es#0@@17|)) (Pure.__default.ResultSameState (TSeq TInt) (Lit DatatypeTypeType |st#0@@8|) |res#2@@1|)))))))))
 :qid |Inductiondfy.39:23|
 :weight 3
 :skolemid |731|
 :pattern ( (Pure.__default.Pes (Lit DatatypeTypeType |st#0@@8|) (Lit SeqType |es#0@@17|)))
))))
...
(set-info :boogie-vc-id Impl$$Pure.__default.Pes__Satisfied)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (Pure.__default.Pes |st#0@@9| |es#0@@19|)))))
(let ((anon3_Else_correct  (=> (not (Pure.__default.Pes__Fail |st#0@@9| |es#0@@19|)) (=> (and (or (or (<= 0 (LitInt 1)) (< (|Seq#Rank| |es#0@@19|) (|Seq#Rank| |es#0@@19|))) (= (LitInt 0) (LitInt 1))) (or (< (|Seq#Rank| |es#0@@19|) (|Seq#Rank| |es#0@@19|)) (and (= (|Seq#Rank| |es#0@@19|) (|Seq#Rank| |es#0@@19|)) (< (LitInt 0) (LitInt 1))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (not (Pure.__default.Pes__Fail |st#0@@9| |es#0@@19|))) (=> (not (Pure.__default.Pes__Fail |st#0@@9| |es#0@@19|)) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (|Pure.__default.Pes#canCall| |st#0@@9| |es#0@@19|) (Pure.__default.Pes |st#0@@9| |es#0@@19|)) (and (= $Heap@@6 $Heap@1) (= (ControlFlow 0 5) 2))) GeneratedUnifiedExit_correct))))))))
(let ((anon3_Then_correct  (=> (Pure.__default.Pes__Fail |st#0@@9| |es#0@@19|) (and (=> (= (ControlFlow 0 3) (- 0 4)) (Pure.__default.Pes__Fail |st#0@@9| |es#0@@19|)) (=> (Pure.__default.Pes__Fail |st#0@@9| |es#0@@19|) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (|Pure.__default.Pes#canCall| |st#0@@9| |es#0@@19|) (Pure.__default.Pes |st#0@@9| |es#0@@19|)) (and (= $Heap@@6 $Heap@0) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct)))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#6| null $Heap@@6 alloc false)) (=> (and (and ($IsAlloc DatatypeTypeType |st#0@@9| Tclass.Pure.MState $Heap@@6) ($IsAlloc SeqType |es#0@@19| (TSeq Tclass.AST.Expr) $Heap@@6)) (and (|Pure.__default.Pes__Fail#canCall| |st#0@@9| |es#0@@19|) (|Pure.__default.Pes__Fail#canCall| |st#0@@9| |es#0@@19|))) (and (=> (= (ControlFlow 0 7) 3) anon3_Then_correct) (=> (= (ControlFlow 0 7) 5) anon3_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and ($Is DatatypeTypeType |st#0@@9| Tclass.Pure.MState) ($IsAlloc DatatypeTypeType |st#0@@9| Tclass.Pure.MState $Heap@@6)) (|$IsA#Pure.MState| |st#0@@9|)) (and (and ($Is SeqType |es#0@@19| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |es#0@@19| (TSeq Tclass.AST.Expr) $Heap@@6)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 8) 7)))) anon0_correct))))
