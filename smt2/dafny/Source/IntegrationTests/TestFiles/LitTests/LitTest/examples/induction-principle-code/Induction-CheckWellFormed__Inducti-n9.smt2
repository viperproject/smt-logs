...
(assert  (=> (< 0 $FunctionContextHeight) (forall (($h@@0 T@U) ) (!  (=> ($IsGoodHeap $h@@0) ($IsAllocBox Induction.__default.Zero Tclass.Induction.V $h@@0))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |638|
 :pattern ( ($IsAllocBox Induction.__default.Zero Tclass.Induction.V $h@@0))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0| T@U) (|vars#0| T@U) (|vals#0| T@U) ) (!  (=> (or (|Induction.__default.AssignState#canCall| |st#0| |vars#0| |vals#0|) (and (< 1 $FunctionContextHeight) (and (and (and ($IsBox |st#0| Tclass.Induction.S) ($Is SeqType |vars#0| (TSeq (TSeq TChar)))) ($IsBox |vals#0| Tclass.Induction.VS)) (Induction.__default.UpdateState__Pre |st#0| |vars#0| |vals#0|)))) ($IsBox (Induction.__default.AssignState |st#0| |vars#0| |vals#0|) Tclass.Induction.S))
 :qid |Inductiondfy.54:30|
 :skolemid |659|
 :pattern ( (Induction.__default.AssignState |st#0| |vars#0| |vals#0|))
))))
...
(assert (forall ((d@@15 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (AST.Expr__Raw.Literal_q d@@15) ($IsAlloc DatatypeTypeType d@@15 Tclass.AST.Expr__Raw $h@@3))) ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@15)) TInt $h@@3))
 :qid |unknown.0:0|
 :skolemid |837|
 :pattern ( ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@15)) TInt $h@@3))
)))
...
(assert (forall ((d@@16 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) ($Is DatatypeTypeType d@@16 Tclass.AST.BinOp)) ($IsAlloc DatatypeTypeType d@@16 Tclass.AST.BinOp $h@@4))
 :qid |unknown.0:0|
 :skolemid |815|
 :pattern ( ($IsAlloc DatatypeTypeType d@@16 Tclass.AST.BinOp $h@@4))
)))
(assert (forall ((d@@17 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) ($Is DatatypeTypeType d@@17 Tclass.AST.Expr__Raw)) ($IsAlloc DatatypeTypeType d@@17 Tclass.AST.Expr__Raw $h@@5))
 :qid |unknown.0:0|
 :skolemid |911|
 :pattern ( ($IsAlloc DatatypeTypeType d@@17 Tclass.AST.Expr__Raw $h@@5))
)))
...
(assert (forall ((d@@18 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (AST.Expr__Raw.Var_q d@@18) ($IsAlloc DatatypeTypeType d@@18 Tclass.AST.Expr__Raw $h@@6))) ($IsAlloc SeqType (AST.Expr__Raw.name d@@18) (TSeq TChar) $h@@6))
 :qid |unknown.0:0|
 :skolemid |827|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.name d@@18) (TSeq TChar) $h@@6))
)))
...
(assert (forall ((d@@19 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (AST.Expr__Raw.Bind_q d@@19) ($IsAlloc DatatypeTypeType d@@19 Tclass.AST.Expr__Raw $h@@7))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@19) Tclass.AST.Expr__Raw $h@@7))
 :qid |unknown.0:0|
 :skolemid |847|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@19) Tclass.AST.Expr__Raw $h@@7))
)))
(assert (forall ((d@@20 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (AST.Expr__Raw.If_q d@@20) ($IsAlloc DatatypeTypeType d@@20 Tclass.AST.Expr__Raw $h@@8))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@20) Tclass.AST.Expr__Raw $h@@8))
 :qid |unknown.0:0|
 :skolemid |876|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@20) Tclass.AST.Expr__Raw $h@@8))
)))
(assert (forall ((d@@21 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) (and (AST.Expr__Raw.If_q d@@21) ($IsAlloc DatatypeTypeType d@@21 Tclass.AST.Expr__Raw $h@@9))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@21) Tclass.AST.Expr__Raw $h@@9))
 :qid |unknown.0:0|
 :skolemid |877|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@21) Tclass.AST.Expr__Raw $h@@9))
)))
(assert (forall ((d@@22 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) (and (AST.Expr__Raw.If_q d@@22) ($IsAlloc DatatypeTypeType d@@22 Tclass.AST.Expr__Raw $h@@10))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@22) Tclass.AST.Expr__Raw $h@@10))
 :qid |unknown.0:0|
 :skolemid |878|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@22) Tclass.AST.Expr__Raw $h@@10))
)))
(assert (forall ((d@@23 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (AST.Expr__Raw.Op_q d@@23) ($IsAlloc DatatypeTypeType d@@23 Tclass.AST.Expr__Raw $h@@11))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@23) Tclass.AST.BinOp $h@@11))
 :qid |unknown.0:0|
 :skolemid |891|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@23) Tclass.AST.BinOp $h@@11))
)))
(assert (forall ((d@@24 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (AST.Expr__Raw.Op_q d@@24) ($IsAlloc DatatypeTypeType d@@24 Tclass.AST.Expr__Raw $h@@12))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@24) Tclass.AST.Expr__Raw $h@@12))
 :qid |unknown.0:0|
 :skolemid |892|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@24) Tclass.AST.Expr__Raw $h@@12))
)))
(assert (forall ((d@@25 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (AST.Expr__Raw.Op_q d@@25) ($IsAlloc DatatypeTypeType d@@25 Tclass.AST.Expr__Raw $h@@13))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@25) Tclass.AST.Expr__Raw $h@@13))
 :qid |unknown.0:0|
 :skolemid |893|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@25) Tclass.AST.Expr__Raw $h@@13))
)))
...
(assert (forall ((d@@26 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (AST.Expr__Raw.Bind_q d@@26) ($IsAlloc DatatypeTypeType d@@26 Tclass.AST.Expr__Raw $h@@14))) ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@26) (TSeq (TSeq TChar)) $h@@14))
 :qid |unknown.0:0|
 :skolemid |845|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@26) (TSeq (TSeq TChar)) $h@@14))
)))
(assert (forall ((d@@27 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (AST.Expr__Raw.Assign_q d@@27) ($IsAlloc DatatypeTypeType d@@27 Tclass.AST.Expr__Raw $h@@15))) ($IsAlloc SeqType (AST.Expr__Raw.avars d@@27) (TSeq (TSeq TChar)) $h@@15))
 :qid |unknown.0:0|
 :skolemid |862|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avars d@@27) (TSeq (TSeq TChar)) $h@@15))
)))
...
(assert (forall ((d@@28 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (AST.Expr__Raw.Bind_q d@@28) ($IsAlloc DatatypeTypeType d@@28 Tclass.AST.Expr__Raw $h@@16))) ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@28) (TSeq Tclass.AST.Expr__Raw) $h@@16))
 :qid |unknown.0:0|
 :skolemid |846|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@28) (TSeq Tclass.AST.Expr__Raw) $h@@16))
)))
(assert (forall ((d@@29 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (AST.Expr__Raw.Assign_q d@@29) ($IsAlloc DatatypeTypeType d@@29 Tclass.AST.Expr__Raw $h@@17))) ($IsAlloc SeqType (AST.Expr__Raw.avals d@@29) (TSeq Tclass.AST.Expr__Raw) $h@@17))
 :qid |unknown.0:0|
 :skolemid |863|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avals d@@29) (TSeq Tclass.AST.Expr__Raw) $h@@17))
)))
(assert (forall ((d@@30 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (AST.Expr__Raw.Seq_q d@@30) ($IsAlloc DatatypeTypeType d@@30 Tclass.AST.Expr__Raw $h@@18))) ($IsAlloc SeqType (AST.Expr__Raw.es d@@30) (TSeq Tclass.AST.Expr__Raw) $h@@18))
 :qid |unknown.0:0|
 :skolemid |906|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.es d@@30) (TSeq Tclass.AST.Expr__Raw) $h@@18))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$Induction.__default.InductAssign__Succ)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (AST.Expr__Raw.Assign_q |e#0@@8|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (AST.Expr__Raw.Assign_q |e#0@@8|)) (=> (AST.Expr__Raw.Assign_q |e#0@@8|) (=> (|Seq#Equal| (AST.Expr__Raw.avars |e#0@@8|) |avars#0@@0|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (AST.Expr__Raw.Assign_q |e#0@@8|)) (=> (AST.Expr__Raw.Assign_q |e#0@@8|) (=> (and (and (|Seq#Equal| (AST.Expr__Raw.avals |e#0@@8|) |avals#0@@1|) ($IsAllocBox |st#0@@0| Tclass.Induction.S $Heap@@4)) (and ($IsAlloc DatatypeTypeType |e#0@@8| Tclass.AST.Expr $Heap@@4) (|Induction.__default.P__Fail#canCall| |st#0@@0| |e#0@@8|))) (=> (and (and (and (and (not (Induction.__default.P__Fail |st#0@@0| |e#0@@8|)) ($IsAllocBox |st#0@@0| Tclass.Induction.S $Heap@@4)) (and ($IsAlloc SeqType |avals#0@@1| (TSeq Tclass.AST.Expr) $Heap@@4) ($IsAllocBox |st1#0| Tclass.Induction.S $Heap@@4))) (and (and ($IsAllocBox |vs#0| Tclass.Induction.VS $Heap@@4) (|Induction.__default.Pes__Succ#canCall| |st#0@@0| |avals#0@@1| |st1#0| |vs#0|)) (and (Induction.__default.Pes__Succ |st#0@@0| |avals#0@@1| |st1#0| |vs#0|) ($IsAllocBox |st1#0| Tclass.Induction.S $Heap@@4)))) (and (and (and ($IsAlloc SeqType |avars#0@@0| (TSeq (TSeq TChar)) $Heap@@4) ($IsAllocBox |vs#0| Tclass.Induction.VS $Heap@@4)) (and (|Induction.__default.UpdateState__Pre#canCall| |st1#0| |avars#0@@0| |vs#0|) (Induction.__default.UpdateState__Pre |st1#0| |avars#0@@0| |vs#0|))) (and (and ($IsAllocBox |st1#0| Tclass.Induction.S $Heap@@4) ($IsAlloc SeqType |avars#0@@0| (TSeq (TSeq TChar)) $Heap@@4)) (and ($IsAllocBox |vs#0| Tclass.Induction.VS $Heap@@4) (= (ControlFlow 0 2) (- 0 1)))))) (Induction.__default.UpdateState__Pre |st1#0| |avars#0@@0| |vs#0|)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (and ($IsBox |st#0@@0| Tclass.Induction.S) ($IsAllocBox |st#0@@0| Tclass.Induction.S $Heap@@4))) (=> (and (and (and (and ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@8| Tclass.AST.Expr $Heap@@4)) (|$IsA#AST.Expr__Raw| |e#0@@8|)) (and (and ($Is SeqType |avars#0@@0| (TSeq (TSeq TChar))) ($IsAlloc SeqType |avars#0@@0| (TSeq (TSeq TChar)) $Heap@@4)) (and ($Is SeqType |avals#0@@1| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |avals#0@@1| (TSeq Tclass.AST.Expr) $Heap@@4)))) (and (and (and ($IsBox |st1#0| Tclass.Induction.S) ($IsAllocBox |st1#0| Tclass.Induction.S $Heap@@4)) (and ($IsBox |vs#0| Tclass.Induction.VS) ($IsAllocBox |vs#0| Tclass.Induction.VS $Heap@@4))) (and (and ($IsBox |st2#0| Tclass.Induction.S) ($IsAllocBox |st2#0| Tclass.Induction.S $Heap@@4)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 5) 2))))) anon0_correct))))
