...
(declare-fun |zero#0@@4| () T@U)
(declare-fun |##n#1@0| () Int)
(declare-fun |##zero#1@0| () T@U)
(declare-fun |##n#2@0| () Int)
(declare-fun |##zero#2@0| () T@U)
(declare-fun |##n#0@0| () Int)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$PrettyPrint.__default.prettyPrintNum)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 25) (let ((anon21_Else_correct  (=> (> (LitInt 10) |n#0@@4|) (and (=> (= (ControlFlow 0 16) (- 0 18)) (U_2_bool (Lit boolType (bool_2_U false)))) (=> (U_2_bool (Lit boolType (bool_2_U false))) (=> (and ($IsAlloc intType (int_2_U |n#0@@4|) TInt $Heap) ($IsAlloc SeqType |zero#0@@4| (TSeq TChar) $Heap)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (or (or (<= 0 (ite (< |n#0@@4| 0) (- 0 |n#0@@4|) |n#0@@4|)) (and (<= 0 |n#0@@4|) (< |n#0@@4| 0))) (= (ite (< |n#0@@4| 0) (- 0 |n#0@@4|) |n#0@@4|) (ite (< |n#0@@4| 0) (- 0 |n#0@@4|) |n#0@@4|)))) (=> (or (or (<= 0 (ite (< |n#0@@4| 0) (- 0 |n#0@@4|) |n#0@@4|)) (and (<= 0 |n#0@@4|) (< |n#0@@4| 0))) (= (ite (< |n#0@@4| 0) (- 0 |n#0@@4|) |n#0@@4|) (ite (< |n#0@@4| 0) (- 0 |n#0@@4|) |n#0@@4|))) (=> (= (ControlFlow 0 16) (- 0 15)) (or (and (<= 0 |n#0@@4|) (< |n#0@@4| 0)) (and (= (< |n#0@@4| 0) (< |n#0@@4| 0)) (< (ite (< |n#0@@4| 0) (- 0 |n#0@@4|) |n#0@@4|) (ite (< |n#0@@4| 0) (- 0 |n#0@@4|) |n#0@@4|)))))))))))))
(let ((anon21_Then_correct  (=> (>= |n#0@@4| (LitInt 10)) (and (=> (= (ControlFlow 0 9) (- 0 14)) (or (not (= (LitInt 10) 0)) (not true))) (=> (or (not (= (LitInt 10) 0)) (not true)) (=> (and (and (= |##n#1@0| (Div |n#0@@4| (LitInt 10))) ($IsAlloc intType (int_2_U |##n#1@0|) TInt $Heap)) (and (= |##zero#1@0| (Lit SeqType |Seq#Empty|)) ($IsAlloc SeqType |##zero#1@0| (TSeq TChar) $Heap))) (and (=> (= (ControlFlow 0 9) (- 0 13)) (or (or (<= 0 (ite (< |n#0@@4| 0) (- 0 |n#0@@4|) |n#0@@4|)) (and (<= 0 |##n#1@0|) (< |n#0@@4| 0))) (= (ite (< |##n#1@0| 0) (- 0 |##n#1@0|) |##n#1@0|) (ite (< |n#0@@4| 0) (- 0 |n#0@@4|) |n#0@@4|)))) (=> (or (or (<= 0 (ite (< |n#0@@4| 0) (- 0 |n#0@@4|) |n#0@@4|)) (and (<= 0 |##n#1@0|) (< |n#0@@4| 0))) (= (ite (< |##n#1@0| 0) (- 0 |##n#1@0|) |##n#1@0|) (ite (< |n#0@@4| 0) (- 0 |n#0@@4|) |n#0@@4|))) (and (=> (= (ControlFlow 0 9) (- 0 12)) (or (and (<= 0 |##n#1@0|) (< |n#0@@4| 0)) (and (= (< |##n#1@0| 0) (< |n#0@@4| 0)) (< (ite (< |##n#1@0| 0) (- 0 |##n#1@0|) |##n#1@0|) (ite (< |n#0@@4| 0) (- 0 |n#0@@4|) |n#0@@4|))))) (=> (or (and (<= 0 |##n#1@0|) (< |n#0@@4| 0)) (and (= (< |##n#1@0| 0) (< |n#0@@4| 0)) (< (ite (< |##n#1@0| 0) (- 0 |##n#1@0|) |##n#1@0|) (ite (< |n#0@@4| 0) (- 0 |n#0@@4|) |n#0@@4|)))) (=> (|PrettyPrint.__default.prettyPrintNum#canCall| (Div |n#0@@4| (LitInt 10)) (Lit SeqType |Seq#Empty|)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (or (not (= (LitInt 10) 0)) (not true))) (=> (or (not (= (LitInt 10) 0)) (not true)) (=> (and (and (= |##n#2@0| (Mod |n#0@@4| (LitInt 10))) ($IsAlloc intType (int_2_U |##n#2@0|) TInt $Heap)) (and (= |##zero#2@0| (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 48))))) ($IsAlloc SeqType |##zero#2@0| (TSeq TChar) $Heap))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (or (<= 0 (ite (< |n#0@@4| 0) (- 0 |n#0@@4|) |n#0@@4|)) (and (<= 0 |##n#2@0|) (< |n#0@@4| 0))) (= (ite (< |##n#2@0| 0) (- 0 |##n#2@0|) |##n#2@0|) (ite (< |n#0@@4| 0) (- 0 |n#0@@4|) |n#0@@4|)))) (=> (or (or (<= 0 (ite (< |n#0@@4| 0) (- 0 |n#0@@4|) |n#0@@4|)) (and (<= 0 |##n#2@0|) (< |n#0@@4| 0))) (= (ite (< |##n#2@0| 0) (- 0 |##n#2@0|) |##n#2@0|) (ite (< |n#0@@4| 0) (- 0 |n#0@@4|) |n#0@@4|))) (=> (= (ControlFlow 0 9) (- 0 8)) (or (and (<= 0 |##n#2@0|) (< |n#0@@4| 0)) (and (= (< |##n#2@0| 0) (< |n#0@@4| 0)) (< (ite (< |##n#2@0| 0) (- 0 |##n#2@0|) |##n#2@0|) (ite (< |n#0@@4| 0) (- 0 |n#0@@4|) |n#0@@4|)))))))))))))))))))))
(let ((anon20_Else_correct  (=> (<= 10 |n#0@@4|) (and (=> (= (ControlFlow 0 19) 9) anon21_Then_correct) (=> (= (ControlFlow 0 19) 16) anon21_Else_correct)))))
(let ((anon20_Then_correct  (=> (and (< |n#0@@4| 10) (= (ControlFlow 0 7) (- 0 6))) (and (<= 0 |n#0@@4|) (< |n#0@@4| (|Seq#Length| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box SeqType (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 48)))))) ($Box SeqType (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 49)))))) ($Box SeqType (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 50)))))) ($Box SeqType (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 51)))))) ($Box SeqType (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 52)))))) ($Box SeqType (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 53)))))) ($Box SeqType (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 54)))))) ($Box SeqType (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 55)))))) ($Box SeqType (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 56)))))) ($Box SeqType (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 57)))))))))))))
(let ((anon19_Else_correct  (=> (<= 0 |n#0@@4|) (and (=> (= (ControlFlow 0 20) 7) anon20_Then_correct) (=> (= (ControlFlow 0 20) 19) anon20_Else_correct)))))
(let ((anon19_Then_correct  (=> (and (and (< |n#0@@4| 0) (= |##n#0@0| (- 0 |n#0@@4|))) (and ($IsAlloc intType (int_2_U |##n#0@0|) TInt $Heap) ($IsAlloc SeqType |zero#0@@4| (TSeq TChar) $Heap))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (or (<= 0 (ite (< |n#0@@4| 0) (- 0 |n#0@@4|) |n#0@@4|)) (and (<= 0 |##n#0@0|) (< |n#0@@4| 0))) (= (ite (< |##n#0@0| 0) (- 0 |##n#0@0|) |##n#0@0|) (ite (< |n#0@@4| 0) (- 0 |n#0@@4|) |n#0@@4|)))) (=> (or (or (<= 0 (ite (< |n#0@@4| 0) (- 0 |n#0@@4|) |n#0@@4|)) (and (<= 0 |##n#0@0|) (< |n#0@@4| 0))) (= (ite (< |##n#0@0| 0) (- 0 |##n#0@0|) |##n#0@0|) (ite (< |n#0@@4| 0) (- 0 |n#0@@4|) |n#0@@4|))) (=> (= (ControlFlow 0 4) (- 0 3)) (or (and (<= 0 |##n#0@0|) (< |n#0@@4| 0)) (and (= (< |##n#0@0| 0) (< |n#0@@4| 0)) (< (ite (< |##n#0@0| 0) (- 0 |##n#0@0|) |##n#0@0|) (ite (< |n#0@@4| 0) (- 0 |n#0@@4|) |n#0@@4|))))))))))
(let ((anon18_Else_correct  (=> (or (not (= |n#0@@4| (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 21) 4) anon19_Then_correct) (=> (= (ControlFlow 0 21) 20) anon19_Else_correct)))))
(let ((anon18_Then_correct true))
(let ((anon17_Then_correct true))
(let ((anon16_Else_correct  (=> (<= 0 |n#0@@4|) (and (and (=> (= (ControlFlow 0 23) 1) anon17_Then_correct) (=> (= (ControlFlow 0 23) 2) anon18_Then_correct)) (=> (= (ControlFlow 0 23) 21) anon18_Else_correct)))))
(let ((anon16_Then_correct  (=> (< |n#0@@4| 0) (and (and (=> (= (ControlFlow 0 22) 1) anon17_Then_correct) (=> (= (ControlFlow 0 22) 2) anon18_Then_correct)) (=> (= (ControlFlow 0 22) 21) anon18_Else_correct)))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 24) 22) anon16_Then_correct) (=> (= (ControlFlow 0 24) 23) anon16_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is SeqType |zero#0@@4| (TSeq TChar))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 25) 24))) anon0_correct)))
