...
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@3|)))
 (and (AST.Expr__Raw.All $ly@@5 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@5 |oe2#0| |p#0|)))) (let ((|es#0@@5| (AST.Expr__Raw.es |e#0@@3|)))
...
(let ((|oe1#0@@0| (AST.Expr__Raw.oe1 |e#0@@4|)))
 (and (Pure.__default.IsPure $ly@@6 |oe1#0@@0| |locals#0@@1|) (Pure.__default.IsPure $ly@@6 |oe2#0@@0| |locals#0@@1|)))) (let ((|es#0@@6| (AST.Expr__Raw.es |e#0@@4|)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@0| T@U) (|e#0@@8| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P#canCall| (Lit MapType |st#0@@0|) (Lit DatatypeTypeType |e#0@@8|)) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@0| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| (Lit DatatypeTypeType |e#0@@8|)) (let ((|e'#2| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@8|)))))
 (and (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@8|) (Lit MapType |st#0@@0|)) (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@8|) (Lit MapType |st#0@@0|)))))
...
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#2| |res'#2|))))))) (= (EliminateMulZero.__default.P (Lit MapType |st#0@@0|) (Lit DatatypeTypeType |e#0@@8|)) (U_2_bool (let ((|e'#2@@0| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@8|)))))
(let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@8|) (Lit MapType |st#0@@0|)))))
...
(Lit boolType (bool_2_U (EliminateMulZero.__default.EqResult TInt |res#2@@0| |res'#2@@0|))))))))))
 ...
 :weight 3
 :skolemid |693|
 :pattern ( (EliminateMulZero.__default.P (Lit MapType |st#0@@0|) (Lit DatatypeTypeType |e#0@@8|)))
))))
...
(ite  (and (AST.BinOp.Mul_q |op#0@@1|) (or (EliminateMulZero.__default.IsZeroMulPure |oe1'#0| |oe2'#0|) (EliminateMulZero.__default.IsZeroMulPure |oe2'#0| |oe1'#0|))) EliminateMulZero.__default.ZeroExpr (|#AST.Expr_Raw.Op| |op#0@@1| |oe1'#0| |oe2'#0|))))))) (let ((|es#0@@12| (AST.Expr__Raw.es |e#0@@14|)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|e#0@@15| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P#canCall| |st#0@@1| |e#0@@15|) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@1| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| |e#0@@15|) (let ((|e'#0@@0| (EliminateMulZero.__default.Eliminate ($LS $LZ) |e#0@@15|)))
 (and (|Interp.__default.InterpExpr#canCall| |e#0@@15| |st#0@@1|) (let ((|res#0@@0| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@15| |st#0@@1|)))
 (and (|Interp.__default.InterpExpr#canCall| |e'#0@@0| |st#0@@1|) (let ((|res'#0@@0| (Interp.__default.InterpExpr ($LS $LZ) |e'#0@@0| |st#0@@1|)))
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#0@@0| |res'#0@@0|))))))) (= (EliminateMulZero.__default.P |st#0@@1| |e#0@@15|) (let ((|e'#0@@1| (EliminateMulZero.__default.Eliminate ($LS $LZ) |e#0@@15|)))
(let ((|res#0@@1| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@15| |st#0@@1|)))
(let ((|res'#0@@1| (Interp.__default.InterpExpr ($LS $LZ) |e'#0@@1| |st#0@@1|)))
(EliminateMulZero.__default.EqResult TInt |res#0@@1| |res'#0@@1|)))))))
 :qid |Inductiondfy.34:21|
 :skolemid |691|
 :pattern ( (EliminateMulZero.__default.P |st#0@@1| |e#0@@15|))
))))
...
(Lit DatatypeTypeType (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#4|)) ($Box MapType (Lit MapType |ctx#0@@7|)))))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|body#4| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@17|)))))
...
(ite  (or (not (= |condv#4| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@23) |thn#4| |ctx_cond#4|) (Interp.__default.InterpExpr ($LS $ly@@23) |els#4| |ctx_cond#4|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|e2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@17|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1125|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@23) (Lit DatatypeTypeType |e#0@@17|) (Lit MapType |ctx#0@@7|)))
)))
...
(assert (forall (($ly@@25 T@U) (|e#0@@18| T@U) ) (! (= (EliminateMulZero.__default.Eliminate ($LS $ly@@25) |e#0@@18|) (EliminateMulZero.__default.Eliminate $ly@@25 |e#0@@18|))
 :qid |EliminateMulZerodfy.32:12|
 :skolemid |645|
 :pattern ( (EliminateMulZero.__default.Eliminate ($LS $ly@@25) |e#0@@18|))
)))
...
(set-info :boogie-vc-id Impl$$EliminateMulZero.__default.Eliminate__Eq)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (|$IsA#AST.Expr__Raw| |e#0@@24|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@6 $Heap@0) (forall ((|$ih#e0#0| T@U) (|$ih#ctx0#0| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |$ih#e0#0| Tclass.AST.Expr) ($Is MapType |$ih#ctx0#0| (TMap (TSeq TChar) TInt))) (U_2_bool (Lit boolType (bool_2_U true)))) (or (< (DtRank |$ih#e0#0|) (DtRank |e#0@@24|)) (and (= (DtRank |$ih#e0#0|) (DtRank |e#0@@24|)) (and (|Set#Subset| (|Map#Domain| |$ih#ctx0#0|) (|Map#Domain| |ctx#0@@9|)) (not (|Set#Subset| (|Map#Domain| |ctx#0@@9|) (|Map#Domain| |$ih#ctx0#0|))))))) (let ((|e'#1@@2| (EliminateMulZero.__default.Eliminate ($LS $LZ) |$ih#e0#0|)))
(let ((|res#1@@1| (Interp.__default.InterpExpr ($LS $LZ) |$ih#e0#0| |$ih#ctx0#0|)))
(let ((|res'#1@@1| (Interp.__default.InterpExpr ($LS $LZ) |e'#1@@2| |$ih#ctx0#0|)))
(EliminateMulZero.__default.EqResult TInt |res#1@@1| |res'#1@@1|)))))
 :qid |EliminateMulZerodfy.256:22|
 :skolemid |818|
 :pattern ( (Interp.__default.InterpExpr ($LS $LZ) (EliminateMulZero.__default.Eliminate ($LS $LZ) |$ih#e0#0|) |$ih#ctx0#0|))
)))) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (|EliminateMulZero.__default.P#canCall| |ctx#0@@9| |e#0@@24|)) (and (EliminateMulZero.__default.P |ctx#0@@9| |e#0@@24|) (= $Heap@0 $Heap@1))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (let ((|e'#0@@2| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@24|)))
(let ((|res#0@@3| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@24| |ctx#0@@9|)))
(let ((|res'#0@@3| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#0@@2| |ctx#0@@9|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| TInt |res#0@@3| |res'#0@@3|) (or (EliminateMulZero.__default.EqResult TInt |res#0@@3| |res'#0@@3|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@3|) ($Box DatatypeTypeType |res'#0@@3|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@3|) ($Box DatatypeTypeType |res'#0@@3|))))) (let ((|v'#2@@0| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@3|) ($Box DatatypeTypeType |res'#0@@3|)))))))))))
(let ((|v#2@@1| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@3|) ($Box DatatypeTypeType |res'#0@@3|)))))))))))
(= |v#2@@1| |v'#2@@0|))))))))))) (=> (let ((|e'#0@@3| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@24|)))
(let ((|res#0@@4| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@24| |ctx#0@@9|)))
(let ((|res'#0@@4| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#0@@3| |ctx#0@@9|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| TInt |res#0@@4| |res'#0@@4|) (or (EliminateMulZero.__default.EqResult TInt |res#0@@4| |res'#0@@4|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@4|) ($Box DatatypeTypeType |res'#0@@4|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@4|) ($Box DatatypeTypeType |res'#0@@4|))))) (let ((|v'#2@@1| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@4|) ($Box DatatypeTypeType |res'#0@@4|)))))))))))
(let ((|v#2@@2| (U_2_int ($Unbox intType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@4|) ($Box DatatypeTypeType |res'#0@@4|)))))))))))
(= |v#2@@2| |v'#2@@1|)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (let ((|e'#0@@4| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@24|)))
(let ((|res#0@@5| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@24| |ctx#0@@9|)))
(let ((|res'#0@@5| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#0@@4| |ctx#0@@9|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| TInt |res#0@@5| |res'#0@@5|) (or (EliminateMulZero.__default.EqResult TInt |res#0@@5| |res'#0@@5|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@5|) ($Box DatatypeTypeType |res'#0@@5|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@5|) ($Box DatatypeTypeType |res'#0@@5|))))) (let ((|ctx1'#2@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@5|) ($Box DatatypeTypeType |res'#0@@5|))))))))))
(let ((|ctx1#2@@3| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@5|) ($Box DatatypeTypeType |res'#0@@5|))))))))))
(|Map#Equal| |ctx1'#2@@0| |ctx1#2@@3|))))))))))) (=> (let ((|e'#0@@5| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@24|)))
(let ((|res#0@@6| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@24| |ctx#0@@9|)))
(let ((|res'#0@@6| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#0@@5| |ctx#0@@9|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| TInt |res#0@@6| |res'#0@@6|) (or (EliminateMulZero.__default.EqResult TInt |res#0@@6| |res'#0@@6|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@6|) ($Box DatatypeTypeType |res'#0@@6|))))) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@6|) ($Box DatatypeTypeType |res'#0@@6|))))) (let ((|ctx1'#2@@1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@6|) ($Box DatatypeTypeType |res'#0@@6|))))))))))
(let ((|ctx1#2@@4| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@6|) ($Box DatatypeTypeType |res'#0@@6|))))))))))
(|Map#Equal| |ctx1'#2@@1| |ctx1#2@@4|)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (let ((|e'#0@@6| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@24|)))
(let ((|res#0@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@24| |ctx#0@@9|)))
(let ((|res'#0@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#0@@6| |ctx#0@@9|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| TInt |res#0@@7| |res'#0@@7|) (or (EliminateMulZero.__default.EqResult TInt |res#0@@7| |res'#0@@7|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@7|) ($Box DatatypeTypeType |res'#0@@7|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@7|) ($Box DatatypeTypeType |res'#0@@7|)))))) (U_2_bool (Lit boolType (bool_2_U false))))))))))) (=> (let ((|e'#0@@7| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@24|)))
(let ((|res#0@@8| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@24| |ctx#0@@9|)))
(let ((|res'#0@@8| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#0@@7| |ctx#0@@9|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| TInt |res#0@@8| |res'#0@@8|) (or (EliminateMulZero.__default.EqResult TInt |res#0@@8| |res'#0@@8|) (=> (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@8|) ($Box DatatypeTypeType |res'#0@@8|))))) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._1 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@8|) ($Box DatatypeTypeType |res'#0@@8|)))))) (U_2_bool (Lit boolType (bool_2_U false)))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (let ((|e'#0@@8| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@24|)))
(let ((|res#0@@9| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@24| |ctx#0@@9|)))
(let ((|res'#0@@9| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e'#0@@8| |ctx#0@@9|)))
 (=> (|EliminateMulZero.__default.EqResult#canCall| TInt |res#0@@9| |res'#0@@9|) (or (EliminateMulZero.__default.EqResult TInt |res#0@@9| |res'#0@@9|) (=> (not (Utils.Result.Success_q ($Unbox DatatypeTypeType (_System.Tuple2._0 (|#_System._tuple#2._#Make2| ($Box DatatypeTypeType |res#0@@9|) ($Box DatatypeTypeType |res'#0@@9|)))))) (U_2_bool (Lit boolType (bool_2_U true)))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and ($Is DatatypeTypeType |e#0@@24| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@24| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@24|)) (and (and ($Is MapType |ctx#0@@9| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |ctx#0@@9| (TMap (TSeq TChar) TInt) $Heap@@6)) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 6) 2)))) anon0_correct))))
