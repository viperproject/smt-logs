...
(declare-fun |cond#0@@0| () T@U)
(declare-fun |thn#0@@0| () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |st#0| () T@U)
(declare-fun |els#0@@0| () T@U)
(declare-fun |st_cond#0| () T@U)
(declare-fun |condv#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id CheckWellFormed$$Induction.__default.InductIf__Succ)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (AST.Expr__Raw.If_q |e#0@@8|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (AST.Expr__Raw.If_q |e#0@@8|)) (=> (AST.Expr__Raw.If_q |e#0@@8|) (=> (|AST.Expr__Raw#Equal| (AST.Expr__Raw.cond |e#0@@8|) |cond#0@@0|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (AST.Expr__Raw.If_q |e#0@@8|)) (=> (AST.Expr__Raw.If_q |e#0@@8|) (=> (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.thn |e#0@@8|) |thn#0@@0|) (= (ControlFlow 0 2) (- 0 1))) (AST.Expr__Raw.If_q |e#0@@8|))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (and ($IsBox |st#0| Tclass.Induction.S) ($IsAllocBox |st#0| Tclass.Induction.S $Heap@@4))) (and (and ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@8| Tclass.AST.Expr $Heap@@4)) (|$IsA#AST.Expr__Raw| |e#0@@8|))) (and (and (and ($Is DatatypeTypeType |cond#0@@0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |cond#0@@0| Tclass.AST.Expr $Heap@@4)) (|$IsA#AST.Expr__Raw| |cond#0@@0|)) (and (and ($Is DatatypeTypeType |thn#0@@0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |thn#0@@0| Tclass.AST.Expr $Heap@@4)) (|$IsA#AST.Expr__Raw| |thn#0@@0|)))) (and (and (and (and ($Is DatatypeTypeType |els#0@@0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |els#0@@0| Tclass.AST.Expr $Heap@@4)) (|$IsA#AST.Expr__Raw| |els#0@@0|)) (and ($IsBox |st_cond#0| Tclass.Induction.S) ($IsAllocBox |st_cond#0| Tclass.Induction.S $Heap@@4))) (and (and ($IsBox |condv#0| Tclass.Induction.V) ($IsAllocBox |condv#0| Tclass.Induction.V $Heap@@4)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 2))))) anon0_correct)))
