...
(assert (distinct TBool TChar TInt TagBool TagChar TagInt TagSeq alloc Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 Tagclass._System.___hTotalFunc1 Tagclass.AST.Expr Tagclass.AST.BinOp Tagclass.AST.Expr__Raw |##AST.BinOp.Add| |##AST.BinOp.Sub| |##AST.BinOp.Mul| |##AST.Expr_Raw.Var| |##AST.Expr_Raw.Literal| |##AST.Expr_Raw.Bind| |##AST.Expr_Raw.Assign| |##AST.Expr_Raw.If| |##AST.Expr_Raw.Op| |##AST.Expr_Raw.Seq| |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1| |tytagFamily$_#TotalFunc1| tytagFamily$Expr tytagFamily$BinOp tytagFamily$Expr_Raw)
)
...
(assert (forall ((a@@10 T@U) (b@@10 T@U) ) (!  (=> (and (AST.BinOp.Add_q a@@10) (AST.BinOp.Add_q b@@10)) (|AST.BinOp#Equal| a@@10 b@@10))
 :qid |unknown.0:0|
 :skolemid |818|
 :pattern ( (|AST.BinOp#Equal| a@@10 b@@10) (AST.BinOp.Add_q a@@10))
 :pattern ( (|AST.BinOp#Equal| a@@10 b@@10) (AST.BinOp.Add_q b@@10))
)))
(assert (forall ((a@@11 T@U) (b@@11 T@U) ) (!  (=> (and (AST.BinOp.Sub_q a@@11) (AST.BinOp.Sub_q b@@11)) (|AST.BinOp#Equal| a@@11 b@@11))
 :qid |unknown.0:0|
 :skolemid |819|
 :pattern ( (|AST.BinOp#Equal| a@@11 b@@11) (AST.BinOp.Sub_q a@@11))
 :pattern ( (|AST.BinOp#Equal| a@@11 b@@11) (AST.BinOp.Sub_q b@@11))
)))
(assert (forall ((a@@12 T@U) (b@@12 T@U) ) (!  (=> (and (AST.BinOp.Mul_q a@@12) (AST.BinOp.Mul_q b@@12)) (|AST.BinOp#Equal| a@@12 b@@12))
 :qid |unknown.0:0|
 :skolemid |820|
 :pattern ( (|AST.BinOp#Equal| a@@12 b@@12) (AST.BinOp.Mul_q a@@12))
 :pattern ( (|AST.BinOp#Equal| a@@12 b@@12) (AST.BinOp.Mul_q b@@12))
)))
...
(assert (forall ((d@@21 T@U) ) (!  (=> (|$IsA#AST.BinOp| d@@21) (or (or (AST.BinOp.Add_q d@@21) (AST.BinOp.Sub_q d@@21)) (AST.BinOp.Mul_q d@@21)))
 :qid |unknown.0:0|
 :skolemid |816|
 :pattern ( (|$IsA#AST.BinOp| d@@21))
)))
...
(assert (forall ((d@@22 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (AST.Expr__Raw.Literal_q d@@22) ($IsAlloc DatatypeTypeType d@@22 Tclass.AST.Expr__Raw $h@@2))) ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@22)) TInt $h@@2))
 :qid |unknown.0:0|
 :skolemid |837|
 :pattern ( ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@22)) TInt $h@@2))
)))
(assert (forall ((d@@23 T@U) ) (!  (=> ($Is DatatypeTypeType d@@23 Tclass.AST.BinOp) (or (or (AST.BinOp.Add_q d@@23) (AST.BinOp.Sub_q d@@23)) (AST.BinOp.Mul_q d@@23)))
 :qid |unknown.0:0|
 :skolemid |817|
 :pattern ( (AST.BinOp.Mul_q d@@23) ($Is DatatypeTypeType d@@23 Tclass.AST.BinOp))
 :pattern ( (AST.BinOp.Sub_q d@@23) ($Is DatatypeTypeType d@@23 Tclass.AST.BinOp))
 :pattern ( (AST.BinOp.Add_q d@@23) ($Is DatatypeTypeType d@@23 Tclass.AST.BinOp))
)))
...
(assert (forall ((d@@24 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) ($Is DatatypeTypeType d@@24 Tclass.AST.BinOp)) ($IsAlloc DatatypeTypeType d@@24 Tclass.AST.BinOp $h@@3))
 :qid |unknown.0:0|
 :skolemid |815|
 :pattern ( ($IsAlloc DatatypeTypeType d@@24 Tclass.AST.BinOp $h@@3))
)))
(assert (forall ((d@@25 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) ($Is DatatypeTypeType d@@25 Tclass.AST.Expr__Raw)) ($IsAlloc DatatypeTypeType d@@25 Tclass.AST.Expr__Raw $h@@4))
 :qid |unknown.0:0|
 :skolemid |911|
 :pattern ( ($IsAlloc DatatypeTypeType d@@25 Tclass.AST.Expr__Raw $h@@4))
)))
...
(assert (forall ((d@@26 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (AST.Expr__Raw.Var_q d@@26) ($IsAlloc DatatypeTypeType d@@26 Tclass.AST.Expr__Raw $h@@5))) ($IsAlloc SeqType (AST.Expr__Raw.name d@@26) (TSeq TChar) $h@@5))
 :qid |unknown.0:0|
 :skolemid |827|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.name d@@26) (TSeq TChar) $h@@5))
)))
...
(assert (forall ((a@@13 T@U) (b@@13 T@U) ) (! (= (|Set#Equal| a@@13 b@@13) (forall ((o@@0 T@U) ) (! (= (|Set#IsMember| a@@13 o@@0) (|Set#IsMember| b@@13 o@@0))
...
(assert (forall ((d@@27 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (AST.Expr__Raw.Bind_q d@@27) ($IsAlloc DatatypeTypeType d@@27 Tclass.AST.Expr__Raw $h@@6))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@27) Tclass.AST.Expr__Raw $h@@6))
 :qid |unknown.0:0|
 :skolemid |847|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@27) Tclass.AST.Expr__Raw $h@@6))
)))
(assert (forall ((d@@28 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (AST.Expr__Raw.If_q d@@28) ($IsAlloc DatatypeTypeType d@@28 Tclass.AST.Expr__Raw $h@@7))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@28) Tclass.AST.Expr__Raw $h@@7))
 :qid |unknown.0:0|
 :skolemid |876|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@28) Tclass.AST.Expr__Raw $h@@7))
)))
(assert (forall ((d@@29 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (AST.Expr__Raw.If_q d@@29) ($IsAlloc DatatypeTypeType d@@29 Tclass.AST.Expr__Raw $h@@8))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@29) Tclass.AST.Expr__Raw $h@@8))
 :qid |unknown.0:0|
 :skolemid |877|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@29) Tclass.AST.Expr__Raw $h@@8))
)))
(assert (forall ((d@@30 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) (and (AST.Expr__Raw.If_q d@@30) ($IsAlloc DatatypeTypeType d@@30 Tclass.AST.Expr__Raw $h@@9))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@30) Tclass.AST.Expr__Raw $h@@9))
 :qid |unknown.0:0|
 :skolemid |878|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@30) Tclass.AST.Expr__Raw $h@@9))
)))
(assert (forall ((d@@31 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) (and (AST.Expr__Raw.Op_q d@@31) ($IsAlloc DatatypeTypeType d@@31 Tclass.AST.Expr__Raw $h@@10))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@31) Tclass.AST.BinOp $h@@10))
 :qid |unknown.0:0|
 :skolemid |891|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@31) Tclass.AST.BinOp $h@@10))
)))
(assert (forall ((d@@32 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (AST.Expr__Raw.Op_q d@@32) ($IsAlloc DatatypeTypeType d@@32 Tclass.AST.Expr__Raw $h@@11))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@32) Tclass.AST.Expr__Raw $h@@11))
 :qid |unknown.0:0|
 :skolemid |892|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@32) Tclass.AST.Expr__Raw $h@@11))
)))
(assert (forall ((d@@33 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (AST.Expr__Raw.Op_q d@@33) ($IsAlloc DatatypeTypeType d@@33 Tclass.AST.Expr__Raw $h@@12))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@33) Tclass.AST.Expr__Raw $h@@12))
 :qid |unknown.0:0|
 :skolemid |893|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@33) Tclass.AST.Expr__Raw $h@@12))
)))
...
(assert (forall ((d@@34 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (AST.Expr__Raw.Bind_q d@@34) ($IsAlloc DatatypeTypeType d@@34 Tclass.AST.Expr__Raw $h@@13))) ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@34) (TSeq (TSeq TChar)) $h@@13))
 :qid |unknown.0:0|
 :skolemid |845|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@34) (TSeq (TSeq TChar)) $h@@13))
)))
(assert (forall ((d@@35 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (AST.Expr__Raw.Assign_q d@@35) ($IsAlloc DatatypeTypeType d@@35 Tclass.AST.Expr__Raw $h@@14))) ($IsAlloc SeqType (AST.Expr__Raw.avars d@@35) (TSeq (TSeq TChar)) $h@@14))
 :qid |unknown.0:0|
 :skolemid |862|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avars d@@35) (TSeq (TSeq TChar)) $h@@14))
)))
...
(assert (forall ((d@@36 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (AST.Expr__Raw.Bind_q d@@36) ($IsAlloc DatatypeTypeType d@@36 Tclass.AST.Expr__Raw $h@@15))) ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@36) (TSeq Tclass.AST.Expr__Raw) $h@@15))
 :qid |unknown.0:0|
 :skolemid |846|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@36) (TSeq Tclass.AST.Expr__Raw) $h@@15))
)))
(assert (forall ((d@@37 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (AST.Expr__Raw.Assign_q d@@37) ($IsAlloc DatatypeTypeType d@@37 Tclass.AST.Expr__Raw $h@@16))) ($IsAlloc SeqType (AST.Expr__Raw.avals d@@37) (TSeq Tclass.AST.Expr__Raw) $h@@16))
 :qid |unknown.0:0|
 :skolemid |863|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avals d@@37) (TSeq Tclass.AST.Expr__Raw) $h@@16))
)))
(assert (forall ((d@@38 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (AST.Expr__Raw.Seq_q d@@38) ($IsAlloc DatatypeTypeType d@@38 Tclass.AST.Expr__Raw $h@@17))) ($IsAlloc SeqType (AST.Expr__Raw.es d@@38) (TSeq Tclass.AST.Expr__Raw) $h@@17))
 :qid |unknown.0:0|
 :skolemid |906|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.es d@@38) (TSeq Tclass.AST.Expr__Raw) $h@@17))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$Induction.__default.InductOp__Fail)
...
(let ((anon5_Else_correct  (=> (and (=> (Induction.__default.P__Succ |st#0| |e1#0| |st1#0@0| |v1#0@0|) (not (Induction.__default.P__Fail |st1#0@0| |e2#0|))) (= (ControlFlow 0 3) 1)) anon4_correct)))
(let ((anon5_Then_correct  (=> ($IsAllocBox |st#0| Tclass.Induction.S $Heap@0) (=> (and ($IsAlloc DatatypeTypeType |e1#0| Tclass.AST.Expr $Heap@0) ($IsAllocBox |st1#0@0| Tclass.Induction.S $Heap@0)) (=> (and (and (and ($IsAllocBox |v1#0@0| Tclass.Induction.V $Heap@0) (|Induction.__default.P__Succ#canCall| |st#0| |e1#0| |st1#0@0| |v1#0@0|)) (and (Induction.__default.P__Succ |st#0| |e1#0| |st1#0@0| |v1#0@0|) ($IsAllocBox |st1#0@0| Tclass.Induction.S $Heap@0))) (and (and ($IsAlloc DatatypeTypeType |e2#0| Tclass.AST.Expr $Heap@0) (|Induction.__default.P__Fail#canCall| |st1#0@0| |e2#0|)) (and (not (Induction.__default.P__Fail |st1#0@0| |e2#0|)) (= (ControlFlow 0 2) 1)))) anon4_correct)))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (AST.Expr__Raw.Op_q |e#0@@8|)) (and (=> (= (ControlFlow 0 4) (- 0 7)) (AST.Expr__Raw.Op_q |e#0@@8|)) (=> (AST.Expr__Raw.Op_q |e#0@@8|) (=> (|AST.BinOp#Equal| (AST.Expr__Raw.op |e#0@@8|) |op#0|) (and (=> (= (ControlFlow 0 4) (- 0 6)) (AST.Expr__Raw.Op_q |e#0@@8|)) (=> (AST.Expr__Raw.Op_q |e#0@@8|) (=> (|AST.Expr__Raw#Equal| (AST.Expr__Raw.oe1 |e#0@@8|) |e1#0|) (and (=> (= (ControlFlow 0 4) (- 0 5)) (AST.Expr__Raw.Op_q |e#0@@8|)) (=> (AST.Expr__Raw.Op_q |e#0@@8|) (=> (|AST.Expr__Raw#Equal| (AST.Expr__Raw.oe2 |e#0@@8|) |e2#0|) (=> (and (and (and (and ($IsAllocBox |st#0| Tclass.Induction.S $Heap@@4) ($IsAlloc DatatypeTypeType |e#0@@8| Tclass.AST.Expr $Heap@@4)) (and (|Induction.__default.P__Fail#canCall| |st#0| |e#0@@8|) (not (Induction.__default.P__Fail |st#0| |e#0@@8|)))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@4 $Heap@0))) (and (and (and ($IsAllocBox |st#0| Tclass.Induction.S $Heap@0) ($IsAlloc DatatypeTypeType |e1#0| Tclass.AST.Expr $Heap@0)) (and (|Induction.__default.P__Fail#canCall| |st#0| |e1#0|) (not (Induction.__default.P__Fail |st#0| |e1#0|)))) (and (and ($IsBox |st1#0@0| Tclass.Induction.S) ($IsAllocBox |st1#0@0| Tclass.Induction.S $Heap@0)) (and ($IsBox |v1#0@0| Tclass.Induction.V) ($IsAllocBox |v1#0@0| Tclass.Induction.V $Heap@0))))) (and (=> (= (ControlFlow 0 4) 2) anon5_Then_correct) (=> (= (ControlFlow 0 4) 3) anon5_Else_correct)))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (and ($IsBox |st#0| Tclass.Induction.S) ($IsAllocBox |st#0| Tclass.Induction.S $Heap@@4))) (and (and ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@8| Tclass.AST.Expr $Heap@@4)) (|$IsA#AST.Expr__Raw| |e#0@@8|))) (=> (and (and (and (and ($Is DatatypeTypeType |op#0| Tclass.AST.BinOp) ($IsAlloc DatatypeTypeType |op#0| Tclass.AST.BinOp $Heap@@4)) (|$IsA#AST.BinOp| |op#0|)) (and (and ($Is DatatypeTypeType |e1#0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e1#0| Tclass.AST.Expr $Heap@@4)) (|$IsA#AST.Expr__Raw| |e1#0|))) (and (and (and ($Is DatatypeTypeType |e2#0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e2#0| Tclass.AST.Expr $Heap@@4)) (|$IsA#AST.Expr__Raw| |e2#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 4)))) anon0_correct))))
