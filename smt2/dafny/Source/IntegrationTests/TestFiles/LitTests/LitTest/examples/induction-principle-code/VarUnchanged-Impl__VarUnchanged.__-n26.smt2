...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0| T@U) (|es#0@@0| T@U) (|st'#0| T@U) (|vs#0@@0| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Succ#canCall| (Lit DatatypeTypeType |st#0|) (Lit SeqType |es#0@@0|) (Lit DatatypeTypeType |st'#0|) (Lit SeqType |vs#0@@0|)) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@0| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0| Tclass.VarUnchanged.S)) ($Is SeqType |vs#0@@0| (TSeq TInt))))) (and (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@0|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0|))))) (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@0|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0|)))))))
 (and (|VarUnchanged.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0|) (Lit SeqType |es#0@@0|)) (=> (U_2_bool (Lit boolType (bool_2_U (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0|) (Lit SeqType |es#0@@0|))))) (and (|VarUnchanged.__default.ResultSeqSameX#canCall| (Lit DatatypeTypeType |st#0|) |res#2|) (=> (VarUnchanged.__default.ResultSeqSameX (Lit DatatypeTypeType |st#0|) |res#2|) (and (and (|$IsA#Utils.Result| |res#2|) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st'#0|))) (=> (|Utils.Result#Equal| |res#2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |vs#0@@0|)) ($Box MapType (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st'#0|))))))))) (and (and (|$IsA#Utils.Option| (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st'#0|)))) (|$IsA#Utils.Option| (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0|))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st'#0|)) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0|)))))))))))) (= (VarUnchanged.__default.Pes__Succ (Lit DatatypeTypeType |st#0|) (Lit SeqType |es#0@@0|) (Lit DatatypeTypeType |st'#0|) (Lit SeqType |vs#0@@0|)) (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@0|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0|)))))))
 (and (and (and (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0|) (Lit SeqType |es#0@@0|)) (VarUnchanged.__default.ResultSeqSameX (Lit DatatypeTypeType |st#0|) |res#2@@0|)) (|Utils.Result#Equal| |res#2@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |vs#0@@0|)) ($Box MapType (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st'#0|)))))))))) (|Utils.Option#Equal| (VarUnchanged.MState.x (Lit DatatypeTypeType |st'#0|)) (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0|))))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |754|
 :pattern ( (VarUnchanged.__default.Pes__Succ (Lit DatatypeTypeType |st#0|) (Lit SeqType |es#0@@0|) (Lit DatatypeTypeType |st'#0|) (Lit SeqType |vs#0@@0|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|es#0@@1| T@U) (|st'#0@@0| T@U) (|vs#0@@1| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@1| |es#0@@1| |st'#0@@0| |vs#0@@1|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@1| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@1| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@0| Tclass.VarUnchanged.S)) ($Is SeqType |vs#0@@1| (TSeq TInt))))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@1|) (|Interp.__default.InterpExprs#canCall| |es#0@@1| (VarUnchanged.MState.ctx |st#0@@1|))) (let ((|res#0| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@1| (VarUnchanged.MState.ctx |st#0@@1|))))
 (and (|VarUnchanged.__default.PreEs#canCall| |st#0@@1| |es#0@@1|) (=> (VarUnchanged.__default.PreEs |st#0@@1| |es#0@@1|) (and (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@1| |res#0|) (=> (VarUnchanged.__default.ResultSeqSameX |st#0@@1| |res#0|) (and (and (|$IsA#Utils.Result| |res#0|) (VarUnchanged.MState.MState_q |st'#0@@0|)) (=> (|Utils.Result#Equal| |res#0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@1|) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@0|)))))) (and (and (|$IsA#Utils.Option| (VarUnchanged.MState.x |st'#0@@0|)) (|$IsA#Utils.Option| (VarUnchanged.MState.x |st#0@@1|))) (and (VarUnchanged.MState.MState_q |st'#0@@0|) (VarUnchanged.MState.MState_q |st#0@@1|))))))))))) (= (VarUnchanged.__default.Pes__Succ |st#0@@1| |es#0@@1| |st'#0@@0| |vs#0@@1|) (let ((|res#0@@0| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@1| (VarUnchanged.MState.ctx |st#0@@1|))))
 (and (and (and (VarUnchanged.__default.PreEs |st#0@@1| |es#0@@1|) (VarUnchanged.__default.ResultSeqSameX |st#0@@1| |res#0@@0|)) (|Utils.Result#Equal| |res#0@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@1|) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@0|))))))) (|Utils.Option#Equal| (VarUnchanged.MState.x |st'#0@@0|) (VarUnchanged.MState.x |st#0@@1|)))))))
 :qid |Inductiondfy.40:28|
 :skolemid |752|
 :pattern ( (VarUnchanged.__default.Pes__Succ |st#0@@1| |es#0@@1| |st'#0@@0| |vs#0@@1|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|e#0@@2| T@U) ) (!  (=> (or (|VarUnchanged.__default.P__Fail#canCall| (Lit DatatypeTypeType |st#0@@2|) (Lit DatatypeTypeType |e#0@@2|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@2| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@2| Tclass.AST.Expr)))) (and (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@2|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@2|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@2|))))) (|VarUnchanged.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@2|) (Lit DatatypeTypeType |e#0@@2|))) (= (VarUnchanged.__default.P__Fail (Lit DatatypeTypeType |st#0@@2|) (Lit DatatypeTypeType |e#0@@2|)) (U_2_bool (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@2|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@2|)))))))
(Lit boolType (bool_2_U  (=> (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@2|) (Lit DatatypeTypeType |e#0@@2|)) (Utils.Result.Failure_q |res#2@@1|)))))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |739|
 :pattern ( (VarUnchanged.__default.P__Fail (Lit DatatypeTypeType |st#0@@2|) (Lit DatatypeTypeType |e#0@@2|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|e#0@@3| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pre#canCall| |st#0@@4| |e#0@@3|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@4| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@3| Tclass.AST.Expr)))) (and (and (VarUnchanged.MState.MState_q |st#0@@4|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@4|)) (and (VarUnchanged.MState.MState_q |st#0@@4|) (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@4|))) |e#0@@3|)))) (= (VarUnchanged.__default.Pre |st#0@@4| |e#0@@3|)  (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@4|)) (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@4|))) |e#0@@3|)))))
 :qid |VarUnchangeddfy.82:23|
 :skolemid |704|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@4| |e#0@@3|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|es#0@@3| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Fail#canCall| (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |es#0@@3|)) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@5| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@3| (TSeq Tclass.AST.Expr))))) (and (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@5|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@3|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@5|))))) (|VarUnchanged.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |es#0@@3|))) (= (VarUnchanged.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |es#0@@3|)) (U_2_bool (let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@3|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@5|)))))))
(Lit boolType (bool_2_U  (=> (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |es#0@@3|)) (Utils.Result.Failure_q |res#2@@2|)))))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |762|
 :pattern ( (VarUnchanged.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |es#0@@3|)))
))))
...
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@4|)))
 (and (AST.Expr__Raw.All $ly@@1 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@1 |oe2#0| |p#0|)))) (let ((|es#0@@4| (AST.Expr__Raw.es |e#0@@4|)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|e#0@@5| T@U) (|st'#0@@1| T@U) (|v#0@@2| Int) ) (!  (=> (or (|VarUnchanged.__default.P__Succ#canCall| |st#0@@7| (Lit DatatypeTypeType |e#0@@5|) |st'#0@@1| |v#0@@2|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@7| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@5| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@1| Tclass.VarUnchanged.S)))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@7|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@5|) (VarUnchanged.MState.ctx |st#0@@7|))) (let ((|res#1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@5|) (VarUnchanged.MState.ctx |st#0@@7|))))
 (and (|VarUnchanged.__default.Pre#canCall| |st#0@@7| (Lit DatatypeTypeType |e#0@@5|)) (=> (VarUnchanged.__default.Pre |st#0@@7| (Lit DatatypeTypeType |e#0@@5|)) (and (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@7| |res#1|) (=> (VarUnchanged.__default.ResultSameX |st#0@@7| |res#1|) (and (and (|$IsA#Utils.Result| |res#1|) (VarUnchanged.MState.MState_q |st'#0@@1|)) (=> (|Utils.Result#Equal| |res#1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0@@2|)) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@1|)))))) (and (and (|$IsA#Utils.Option| (VarUnchanged.MState.x |st'#0@@1|)) (|$IsA#Utils.Option| (VarUnchanged.MState.x |st#0@@7|))) (and (VarUnchanged.MState.MState_q |st'#0@@1|) (VarUnchanged.MState.MState_q |st#0@@7|))))))))))) (= (VarUnchanged.__default.P__Succ |st#0@@7| (Lit DatatypeTypeType |e#0@@5|) |st'#0@@1| |v#0@@2|) (let ((|res#1@@0| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@5|) (VarUnchanged.MState.ctx |st#0@@7|))))
 (and (and (and (VarUnchanged.__default.Pre |st#0@@7| (Lit DatatypeTypeType |e#0@@5|)) (VarUnchanged.__default.ResultSameX |st#0@@7| |res#1@@0|)) (|Utils.Result#Equal| |res#1@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0@@2|)) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@1|))))))) (|Utils.Option#Equal| (VarUnchanged.MState.x |st'#0@@1|) (VarUnchanged.MState.x |st#0@@7|)))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |730|
 :pattern ( (VarUnchanged.__default.P__Succ |st#0@@7| (Lit DatatypeTypeType |e#0@@5|) |st'#0@@1| |v#0@@2|))
))))
(assert (forall (($ly@@2 T@U) (|es#0@@5| T@U) (|ctx#0@@2| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@5| |ctx#0@@2|) (and ($Is SeqType |es#0@@5| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@2| (TMap (TSeq TChar) TInt)))) (and (=> (Utils.Result.Success_q (Interp.__default.InterpExprs $ly@@2 |es#0@@5| |ctx#0@@2|)) (= (|Seq#Length| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs $ly@@2 |es#0@@5| |ctx#0@@2|)))))) (|Seq#Length| |es#0@@5|))) ($Is DatatypeTypeType (Interp.__default.InterpExprs $ly@@2 |es#0@@5| |ctx#0@@2|) (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))
 :qid |Interpdfy.69:12|
 :skolemid |1219|
 :pattern ( (Interp.__default.InterpExprs $ly@@2 |es#0@@5| |ctx#0@@2|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|e#0@@9| T@U) ) (!  (=> (or (|VarUnchanged.__default.P__Fail#canCall| |st#0@@8| (Lit DatatypeTypeType |e#0@@9|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@8| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@9| Tclass.AST.Expr)))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@8|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@9|) (VarUnchanged.MState.ctx |st#0@@8|))) (|VarUnchanged.__default.Pre#canCall| |st#0@@8| (Lit DatatypeTypeType |e#0@@9|))) (= (VarUnchanged.__default.P__Fail |st#0@@8| (Lit DatatypeTypeType |e#0@@9|)) (let ((|res#1@@1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@9|) (VarUnchanged.MState.ctx |st#0@@8|))))
 (=> (VarUnchanged.__default.Pre |st#0@@8| (Lit DatatypeTypeType |e#0@@9|)) (Utils.Result.Failure_q |res#1@@1|))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |738|
 :pattern ( (VarUnchanged.__default.P__Fail |st#0@@8| (Lit DatatypeTypeType |e#0@@9|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@9| T@U) (|res#0@@2| T@U) ) (!  (=> (or (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@9| |res#0@@2|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@9| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |res#0@@2| (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt))))))) (and (=> (Utils.Result.Success_q |res#0@@2|) (and (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value |res#0@@2|))) (let ((|ctx#1@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#0@@2|))))))
 (and (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value |res#0@@2|))) (and (VarUnchanged.MState.MState_q |st#0@@9|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@9|)) (and (VarUnchanged.MState.MState_q |st#0@@9|) (=> (|Set#IsMember| (|Map#Domain| |ctx#1@@0|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@9|))) (and (and (VarUnchanged.MState.MState_q |st#0@@9|) (VarUnchanged.MState.MState_q |st#0@@9|)) (VarUnchanged.MState.MState_q |st#0@@9|)))))))))) (= (VarUnchanged.__default.ResultSameX |st#0@@9| |res#0@@2|) (ite (Utils.Result.Success_q |res#0@@2|) (let ((|ctx#0@@3| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#0@@2|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@9|)) (and (|Set#IsMember| (|Map#Domain| |ctx#0@@3|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@9|))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (VarUnchanged.MState.ctx |st#0@@9|)) (Utils.Option.value (VarUnchanged.MState.x |st#0@@9|))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@3|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@9|))))))))) true))))
 :qid |VarUnchangeddfy.41:31|
 :skolemid |695|
 :pattern ( (VarUnchanged.__default.ResultSameX |st#0@@9| |res#0@@2|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@10| T@U) (|es#0@@6| T@U) ) (!  (=> (or (|VarUnchanged.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@10|) (Lit SeqType |es#0@@6|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@10| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@6| (TSeq Tclass.AST.Expr))))) (and (forall ((|e#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |e#1@@0| Tclass.AST.Expr) (=> (|Seq#Contains| |es#0@@6| ($Box DatatypeTypeType |e#1@@0|)) (|VarUnchanged.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@10|) |e#1@@0|)))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |713|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@10| |e#1@@0|))
 :pattern ( (|Seq#Contains| |es#0@@6| ($Box DatatypeTypeType |e#1@@0|)))
)) (= (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@10|) (Lit SeqType |es#0@@6|)) (forall ((|e#1@@1| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#1@@1| Tclass.AST.Expr) (|Seq#Contains| |es#0@@6| ($Box DatatypeTypeType |e#1@@1|))) (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@10|) |e#1@@1|))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |712|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@10| |e#1@@1|))
 :pattern ( (|Seq#Contains| |es#0@@6| ($Box DatatypeTypeType |e#1@@1|)))
)))))
 :qid |VarUnchangeddfy.87:25|
 :weight 3
 :skolemid |714|
 :pattern ( (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@10|) (Lit SeqType |es#0@@6|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@11| T@U) (|es#0@@7| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Fail#canCall| |st#0@@11| (Lit SeqType |es#0@@7|)) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@11| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@7| (TSeq Tclass.AST.Expr))))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@11|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@7|) (VarUnchanged.MState.ctx |st#0@@11|))) (|VarUnchanged.__default.PreEs#canCall| |st#0@@11| (Lit SeqType |es#0@@7|))) (= (VarUnchanged.__default.Pes__Fail |st#0@@11| (Lit SeqType |es#0@@7|)) (let ((|res#1@@2| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@7|) (VarUnchanged.MState.ctx |st#0@@11|))))
 (=> (VarUnchanged.__default.PreEs |st#0@@11| (Lit SeqType |es#0@@7|)) (Utils.Result.Failure_q |res#1@@2|))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |761|
 :pattern ( (VarUnchanged.__default.Pes__Fail |st#0@@11| (Lit SeqType |es#0@@7|)))
))))
...
(assert (forall (($ly@@8 T@U) (|es#0@@8| T@U) (|ctx#0@@6| T@U) ) (! (= (Interp.__default.InterpExprs ($LS $ly@@8) |es#0@@8| |ctx#0@@6|) (Interp.__default.InterpExprs $ly@@8 |es#0@@8| |ctx#0@@6|))
 :qid |Interpdfy.69:12|
 :skolemid |1217|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@8) |es#0@@8| |ctx#0@@6|))
)))
...
(assert (forall (($ly@@11 T@U) (|es#0@@9| T@U) (|ctx#0@@7| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@9| |ctx#0@@7|) (and ($Is SeqType |es#0@@9| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@7| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@9| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@9| (LitInt 0))) |ctx#0@@7|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@11 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@9| (LitInt 0))) |ctx#0@@7|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (|Seq#Drop| |es#0@@9| (LitInt 1)) |ctx1#0@@0|) (let ((|valueOrError1#0@@0| (Interp.__default.InterpExprs $ly@@11 (|Seq#Drop| |es#0@@9| (LitInt 1)) |ctx1#0@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@11) |es#0@@9| |ctx#0@@7|) (ite (|Seq#Equal| |es#0@@9| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@7|)))) (let ((|valueOrError0#0@@1| (Interp.__default.InterpExpr $ly@@11 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@9| (LitInt 0))) |ctx#0@@7|)))
...
(let ((|valueOrError1#0@@1| (Interp.__default.InterpExprs $ly@@11 (|Seq#Drop| |es#0@@9| (LitInt 1)) |ctx1#0@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0@@3|))) |vs#0@@5|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1221|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@11) |es#0@@9| |ctx#0@@7|))
)))
...
(let ((|oe1#0@@0| (AST.Expr__Raw.oe1 |e#0@@13|)))
 (and (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |oe1#0@@0|) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |oe2#0@@0|)))) (let ((|es#0@@10| (AST.Expr__Raw.es |e#0@@13|)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@12| T@U) (|res#0@@3| T@U) ) (!  (=> (or (|VarUnchanged.__default.ResultSeqSameX#canCall| (Lit DatatypeTypeType |st#0@@12|) (Lit DatatypeTypeType |res#0@@3|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@12| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |res#0@@3| (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@3|))))) (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@3|))))) (let ((|ctx#3| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@3|)))))))))
 (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@12|)) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@12|))))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@12|)) (=> (|Set#IsMember| (|Map#Domain| |ctx#3|) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@12|)))))))) (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@12|)) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@12|))) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@12|)))))))))) (= (VarUnchanged.__default.ResultSeqSameX (Lit DatatypeTypeType |st#0@@12|) (Lit DatatypeTypeType |res#0@@3|)) (ite (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@3|)) (let ((|ctx#2| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@3|)))))))))
 ...
 :weight 3
 :skolemid |700|
 :pattern ( (VarUnchanged.__default.ResultSeqSameX (Lit DatatypeTypeType |st#0@@12|) (Lit DatatypeTypeType |res#0@@3|)))
))))
(assert (forall (($ly@@13 T@U) (|es#0@@11| T@U) (|ctx#0@@8| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@11|) |ctx#0@@8|) (and ($Is SeqType |es#0@@11| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@8| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@11| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@11|) (LitInt 0))) |ctx#0@@8|) (let ((|valueOrError0#1@@0| (Interp.__default.InterpExpr ($LS $ly@@13) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@11|) (LitInt 0))) |ctx#0@@8|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@13) (Lit SeqType |es#0@@11|) |ctx#0@@8|) (ite (|Seq#Equal| |es#0@@11| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@8|)))) (let ((|valueOrError0#1@@1| (Interp.__default.InterpExpr ($LS $ly@@13) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@11|) (LitInt 0))) |ctx#0@@8|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#1|))) |vs#1@@0|)) ($Box MapType |ctx2#1@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |1222|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@13) (Lit SeqType |es#0@@11|) |ctx#0@@8|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@13| T@U) (|e#0@@14| T@U) (|st'#0@@2| T@U) (|v#0@@4| Int) ) (!  (=> (or (|VarUnchanged.__default.P__Succ#canCall| (Lit DatatypeTypeType |st#0@@13|) (Lit DatatypeTypeType |e#0@@14|) (Lit DatatypeTypeType |st'#0@@2|) (LitInt |v#0@@4|)) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@13| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@14| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@2| Tclass.VarUnchanged.S)))) (and (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@13|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@14|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@13|))))) (let ((|res#2@@3| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@14|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@13|)))))))
 (and (|VarUnchanged.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@13|) (Lit DatatypeTypeType |e#0@@14|)) (=> (U_2_bool (Lit boolType (bool_2_U (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@13|) (Lit DatatypeTypeType |e#0@@14|))))) (and (|VarUnchanged.__default.ResultSameX#canCall| (Lit DatatypeTypeType |st#0@@13|) |res#2@@3|) (=> (VarUnchanged.__default.ResultSameX (Lit DatatypeTypeType |st#0@@13|) |res#2@@3|) (and (and (|$IsA#Utils.Result| |res#2@@3|) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st'#0@@2|))) (=> (|Utils.Result#Equal| |res#2@@3| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt |v#0@@4|))) ($Box MapType (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st'#0@@2|))))))))) (and (and (|$IsA#Utils.Option| (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st'#0@@2|)))) (|$IsA#Utils.Option| (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@13|))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st'#0@@2|)) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@13|)))))))))))) (= (VarUnchanged.__default.P__Succ (Lit DatatypeTypeType |st#0@@13|) (Lit DatatypeTypeType |e#0@@14|) (Lit DatatypeTypeType |st'#0@@2|) (LitInt |v#0@@4|)) (let ((|res#2@@4| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@14|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@13|)))))))
 (and (and (and (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@13|) (Lit DatatypeTypeType |e#0@@14|)) (VarUnchanged.__default.ResultSameX (Lit DatatypeTypeType |st#0@@13|) |res#2@@4|)) (|Utils.Result#Equal| |res#2@@4| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt |v#0@@4|))) ($Box MapType (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st'#0@@2|)))))))))) (|Utils.Option#Equal| (VarUnchanged.MState.x (Lit DatatypeTypeType |st'#0@@2|)) (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@13|))))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |731|
 :pattern ( (VarUnchanged.__default.P__Succ (Lit DatatypeTypeType |st#0@@13|) (Lit DatatypeTypeType |e#0@@14|) (Lit DatatypeTypeType |st'#0@@2|) (LitInt |v#0@@4|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@14| T@U) (|e#0@@15| T@U) ) (!  (=> (or (|VarUnchanged.__default.P__Fail#canCall| |st#0@@14| |e#0@@15|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@14| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr)))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@14|) (|Interp.__default.InterpExpr#canCall| |e#0@@15| (VarUnchanged.MState.ctx |st#0@@14|))) (|VarUnchanged.__default.Pre#canCall| |st#0@@14| |e#0@@15|)) (= (VarUnchanged.__default.P__Fail |st#0@@14| |e#0@@15|) (let ((|res#0@@4| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@15| (VarUnchanged.MState.ctx |st#0@@14|))))
 (=> (VarUnchanged.__default.Pre |st#0@@14| |e#0@@15|) (Utils.Result.Failure_q |res#0@@4|))))))
 :qid |Inductiondfy.36:26|
 :skolemid |737|
 :pattern ( (VarUnchanged.__default.P__Fail |st#0@@14| |e#0@@15|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@15| T@U) (|es#0@@12| T@U) ) (!  (=> (or (|VarUnchanged.__default.PreEs#canCall| |st#0@@15| |es#0@@12|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@15| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@12| (TSeq Tclass.AST.Expr))))) (and (forall ((|e#0@@19| T@U) ) (!  (=> ($Is DatatypeTypeType |e#0@@19| Tclass.AST.Expr) (=> (|Seq#Contains| |es#0@@12| ($Box DatatypeTypeType |e#0@@19|)) (|VarUnchanged.__default.Pre#canCall| |st#0@@15| |e#0@@19|)))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |710|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@15| |e#0@@19|))
 :pattern ( (|Seq#Contains| |es#0@@12| ($Box DatatypeTypeType |e#0@@19|)))
)) (= (VarUnchanged.__default.PreEs |st#0@@15| |es#0@@12|) (forall ((|e#0@@20| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#0@@20| Tclass.AST.Expr) (|Seq#Contains| |es#0@@12| ($Box DatatypeTypeType |e#0@@20|))) (VarUnchanged.__default.Pre |st#0@@15| |e#0@@20|))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |709|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@15| |e#0@@20|))
 :pattern ( (|Seq#Contains| |es#0@@12| ($Box DatatypeTypeType |e#0@@20|)))
)))))
 :qid |VarUnchangeddfy.87:25|
 :skolemid |711|
 :pattern ( (VarUnchanged.__default.PreEs |st#0@@15| |es#0@@12|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@16| T@U) (|res#0@@5| T@U) ) (!  (=> (or (|VarUnchanged.__default.ResultSameX#canCall| (Lit DatatypeTypeType |st#0@@16|) (Lit DatatypeTypeType |res#0@@5|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@16| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |res#0@@5| (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt))))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@5|))))) (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@5|))))) (let ((|ctx#3@@0| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@5|)))))))))
 (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@5|))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@16|)) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@16|))))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@16|)) (=> (|Set#IsMember| (|Map#Domain| |ctx#3@@0|) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@16|)))))))) (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@16|)) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@16|))) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@16|))))))))))) (= (VarUnchanged.__default.ResultSameX (Lit DatatypeTypeType |st#0@@16|) (Lit DatatypeTypeType |res#0@@5|)) (ite (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@5|)) (let ((|ctx#2@@0| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@5|)))))))))
 (=> (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@16|)))) (and (|Set#IsMember| (Lit SetType (|Map#Domain| |ctx#2@@0|)) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@16|)))))))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@16|)))) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@16|)))))))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#2@@0|) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@16|)))))))))))))) true))))
 :qid |VarUnchangeddfy.41:31|
 :weight 3
 :skolemid |696|
 :pattern ( (VarUnchanged.__default.ResultSameX (Lit DatatypeTypeType |st#0@@16|) (Lit DatatypeTypeType |res#0@@5|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@17| T@U) (|es#0@@13| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Fail#canCall| |st#0@@17| |es#0@@13|) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@17| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@13| (TSeq Tclass.AST.Expr))))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@17|) (|Interp.__default.InterpExprs#canCall| |es#0@@13| (VarUnchanged.MState.ctx |st#0@@17|))) (|VarUnchanged.__default.PreEs#canCall| |st#0@@17| |es#0@@13|)) (= (VarUnchanged.__default.Pes__Fail |st#0@@17| |es#0@@13|) (let ((|res#0@@6| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@13| (VarUnchanged.MState.ctx |st#0@@17|))))
 (=> (VarUnchanged.__default.PreEs |st#0@@17| |es#0@@13|) (Utils.Result.Failure_q |res#0@@6|))))))
 :qid |Inductiondfy.41:28|
 :skolemid |760|
 :pattern ( (VarUnchanged.__default.Pes__Fail |st#0@@17| |es#0@@13|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@18| T@U) (|e#0@@21| T@U) (|st'#0@@3| T@U) (|v#0@@5| Int) ) (!  (=> (or (|VarUnchanged.__default.P__Succ#canCall| |st#0@@18| |e#0@@21| |st'#0@@3| |v#0@@5|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@18| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@21| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@3| Tclass.VarUnchanged.S)))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@18|) (|Interp.__default.InterpExpr#canCall| |e#0@@21| (VarUnchanged.MState.ctx |st#0@@18|))) (let ((|res#0@@7| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@21| (VarUnchanged.MState.ctx |st#0@@18|))))
 (and (|VarUnchanged.__default.Pre#canCall| |st#0@@18| |e#0@@21|) (=> (VarUnchanged.__default.Pre |st#0@@18| |e#0@@21|) (and (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@18| |res#0@@7|) (=> (VarUnchanged.__default.ResultSameX |st#0@@18| |res#0@@7|) (and (and (|$IsA#Utils.Result| |res#0@@7|) (VarUnchanged.MState.MState_q |st'#0@@3|)) (=> (|Utils.Result#Equal| |res#0@@7| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0@@5|)) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@3|)))))) (and (and (|$IsA#Utils.Option| (VarUnchanged.MState.x |st'#0@@3|)) (|$IsA#Utils.Option| (VarUnchanged.MState.x |st#0@@18|))) (and (VarUnchanged.MState.MState_q |st'#0@@3|) (VarUnchanged.MState.MState_q |st#0@@18|))))))))))) (= (VarUnchanged.__default.P__Succ |st#0@@18| |e#0@@21| |st'#0@@3| |v#0@@5|) (let ((|res#0@@8| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@21| (VarUnchanged.MState.ctx |st#0@@18|))))
 (and (and (and (VarUnchanged.__default.Pre |st#0@@18| |e#0@@21|) (VarUnchanged.__default.ResultSameX |st#0@@18| |res#0@@8|)) (|Utils.Result#Equal| |res#0@@8| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0@@5|)) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@3|))))))) (|Utils.Option#Equal| (VarUnchanged.MState.x |st'#0@@3|) (VarUnchanged.MState.x |st#0@@18|)))))))
 :qid |Inductiondfy.35:26|
 :skolemid |729|
 :pattern ( (VarUnchanged.__default.P__Succ |st#0@@18| |e#0@@21| |st'#0@@3| |v#0@@5|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@19| T@U) (|es#0@@14| T@U) (|st'#0@@4| T@U) (|vs#0@@6| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Succ#canCall| |st#0@@19| (Lit SeqType |es#0@@14|) |st'#0@@4| |vs#0@@6|) (and (< 4 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@19| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@14| (TSeq Tclass.AST.Expr))) ($Is DatatypeTypeType |st'#0@@4| Tclass.VarUnchanged.S)) ($Is SeqType |vs#0@@6| (TSeq TInt))))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@19|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@14|) (VarUnchanged.MState.ctx |st#0@@19|))) (let ((|res#1@@3| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@14|) (VarUnchanged.MState.ctx |st#0@@19|))))
 (and (|VarUnchanged.__default.PreEs#canCall| |st#0@@19| (Lit SeqType |es#0@@14|)) (=> (VarUnchanged.__default.PreEs |st#0@@19| (Lit SeqType |es#0@@14|)) (and (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@19| |res#1@@3|) (=> (VarUnchanged.__default.ResultSeqSameX |st#0@@19| |res#1@@3|) (and (and (|$IsA#Utils.Result| |res#1@@3|) (VarUnchanged.MState.MState_q |st'#0@@4|)) (=> (|Utils.Result#Equal| |res#1@@3| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@6|) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@4|)))))) (and (and (|$IsA#Utils.Option| (VarUnchanged.MState.x |st'#0@@4|)) (|$IsA#Utils.Option| (VarUnchanged.MState.x |st#0@@19|))) (and (VarUnchanged.MState.MState_q |st'#0@@4|) (VarUnchanged.MState.MState_q |st#0@@19|))))))))))) (= (VarUnchanged.__default.Pes__Succ |st#0@@19| (Lit SeqType |es#0@@14|) |st'#0@@4| |vs#0@@6|) (let ((|res#1@@4| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@14|) (VarUnchanged.MState.ctx |st#0@@19|))))
 (and (and (and (VarUnchanged.__default.PreEs |st#0@@19| (Lit SeqType |es#0@@14|)) (VarUnchanged.__default.ResultSeqSameX |st#0@@19| |res#1@@4|)) (|Utils.Result#Equal| |res#1@@4| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType |vs#0@@6|) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@4|))))))) (|Utils.Option#Equal| (VarUnchanged.MState.x |st'#0@@4|) (VarUnchanged.MState.x |st#0@@19|)))))))
 :qid |Inductiondfy.40:28|
 :weight 3
 :skolemid |753|
 :pattern ( (VarUnchanged.__default.Pes__Succ |st#0@@19| (Lit SeqType |es#0@@14|) |st'#0@@4| |vs#0@@6|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@20| T@U) (|e#0@@24| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@20|) (Lit DatatypeTypeType |e#0@@24|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@20| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@24| Tclass.AST.Expr)))) (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@20|)) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@20|))))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@20|)) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@20|)))))) (Lit DatatypeTypeType |e#0@@24|))))) (= (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@20|) (Lit DatatypeTypeType |e#0@@24|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@20|)))) (VarUnchanged.__default.VarUnchanged ($LS $LZ) (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@20|)))))) (Lit DatatypeTypeType |e#0@@24|)))))))))
 :qid |VarUnchangeddfy.82:23|
 :weight 3
 :skolemid |705|
 :pattern ( (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@20|) (Lit DatatypeTypeType |e#0@@24|)))
))))
...
(declare-fun |st#0@@21| () T@U)
(declare-fun |e'#0@0| () T@U)
(declare-fun $Heap@@6 () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id Impl$$VarUnchanged.__default.InductExprs__Cons)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon3_correct  (=> (forall ((|e'#1| T@U) ) (!  (=> ($Is DatatypeTypeType |e'#1| Tclass.AST.Expr) (and (|$IsA#AST.Expr__Raw| |e'#1|) (|$IsA#AST.Expr__Raw| |e#0@@27|)))
 :qid |VarUnchangeddfy.209:19|
 :skolemid |895|
 :pattern ( (|Seq#Contains| |es#0@@15| ($Box DatatypeTypeType |e'#1|)))
 :pattern ( (|Seq#Contains| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@27|)) |es#0@@15|) ($Box DatatypeTypeType |e'#1|)))
)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall ((|e'#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |e'#1@@0| Tclass.AST.Expr) (= (|Seq#Contains| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@27|)) |es#0@@15|) ($Box DatatypeTypeType |e'#1@@0|))  (or (|AST.Expr__Raw#Equal| |e'#1@@0| |e#0@@27|) (|Seq#Contains| |es#0@@15| ($Box DatatypeTypeType |e'#1@@0|)))))
 :qid |VarUnchangeddfy.209:19|
 :skolemid |897|
 :pattern ( (|Seq#Contains| |es#0@@15| ($Box DatatypeTypeType |e'#1@@0|)))
 :pattern ( (|Seq#Contains| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@27|)) |es#0@@15|) ($Box DatatypeTypeType |e'#1@@0|)))
))) (=> (forall ((|e'#1@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |e'#1@@1| Tclass.AST.Expr) (= (|Seq#Contains| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@27|)) |es#0@@15|) ($Box DatatypeTypeType |e'#1@@1|))  (or (|AST.Expr__Raw#Equal| |e'#1@@1| |e#0@@27|) (|Seq#Contains| |es#0@@15| ($Box DatatypeTypeType |e'#1@@1|)))))
 :qid |VarUnchangeddfy.209:19|
 :skolemid |897|
 :pattern ( (|Seq#Contains| |es#0@@15| ($Box DatatypeTypeType |e'#1@@1|)))
 :pattern ( (|Seq#Contains| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@27|)) |es#0@@15|) ($Box DatatypeTypeType |e'#1@@1|)))
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (VarUnchanged.__default.P__Fail |st#0@@21| |e#0@@27|) (=> (|VarUnchanged.__default.Pes__Fail#canCall| |st#0@@21| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@27|)) |es#0@@15|)) (or (VarUnchanged.__default.Pes__Fail |st#0@@21| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@27|)) |es#0@@15|)) (let ((|res#1@@5| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@27|)) |es#0@@15|) (VarUnchanged.MState.ctx |st#0@@21|))))
 (=> (VarUnchanged.__default.PreEs |st#0@@21| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@27|)) |es#0@@15|)) (Utils.Result.Failure_q |res#1@@5|))))))) (=> (=> (VarUnchanged.__default.P__Fail |st#0@@21| |e#0@@27|) (=> (|VarUnchanged.__default.Pes__Fail#canCall| |st#0@@21| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@27|)) |es#0@@15|)) (or (VarUnchanged.__default.Pes__Fail |st#0@@21| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@27|)) |es#0@@15|)) (let ((|res#1@@6| (Interp.__default.InterpExprs ($LS ($LS $LZ)) (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@27|)) |es#0@@15|) (VarUnchanged.MState.ctx |st#0@@21|))))
 (=> (VarUnchanged.__default.PreEs |st#0@@21| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@27|)) |es#0@@15|)) (Utils.Result.Failure_q |res#1@@6|)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (not (VarUnchanged.__default.P__Fail |st#0@@21| |e#0@@27|)) (forall ((|st1#1| T@U) (|v#1@@0| Int) ) (!  (=> ($Is DatatypeTypeType |st1#1| Tclass.VarUnchanged.S) (=> (and (VarUnchanged.__default.P__Succ |st#0@@21| |e#0@@27| |st1#1| |v#1@@0|) (VarUnchanged.__default.Pes__Fail |st1#1| |es#0@@15|)) (VarUnchanged.__default.Pes__Fail |st#0@@21| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@27|)) |es#0@@15|))))
 :qid |Inductiondfy.186:39|
 :skolemid |892|
 :pattern ( (VarUnchanged.__default.P__Succ |st#0@@21| |e#0@@27| |st1#1| |v#1@@0|))
)))) (=> (=> (not (VarUnchanged.__default.P__Fail |st#0@@21| |e#0@@27|)) (forall ((|st1#1@@0| T@U) (|v#1@@1| Int) ) (!  (=> ($Is DatatypeTypeType |st1#1@@0| Tclass.VarUnchanged.S) (=> (and (VarUnchanged.__default.P__Succ |st#0@@21| |e#0@@27| |st1#1@@0| |v#1@@1|) (VarUnchanged.__default.Pes__Fail |st1#1@@0| |es#0@@15|)) (VarUnchanged.__default.Pes__Fail |st#0@@21| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@27|)) |es#0@@15|))))
 :qid |Inductiondfy.186:39|
 :skolemid |892|
 :pattern ( (VarUnchanged.__default.P__Succ |st#0@@21| |e#0@@27| |st1#1@@0| |v#1@@1|))
))) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|st1#3| T@U) (|v#3| Int) (|st2#1| T@U) (|vs#1@@1| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |st1#3| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |st2#1| Tclass.VarUnchanged.S)) ($Is SeqType |vs#1@@1| (TSeq TInt))) (=> (and (VarUnchanged.__default.P__Succ |st#0@@21| |e#0@@27| |st1#3| |v#3|) (VarUnchanged.__default.Pes__Succ |st1#3| |es#0@@15| |st2#1| |vs#1@@1|)) (VarUnchanged.__default.Pes__Succ |st#0@@21| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#0@@27|)) |es#0@@15|) |st2#1| (VarUnchanged.__default.AppendValue |v#3| |vs#1@@1|))))
 :qid |Inductiondfy.187:20|
 :skolemid |894|
 :pattern ( (VarUnchanged.__default.AppendValue |v#3| |vs#1@@1|) (VarUnchanged.__default.Pes__Succ |st1#3| |es#0@@15| |st2#1| |vs#1@@1|))
 :pattern ( (VarUnchanged.__default.Pes__Succ |st1#3| |es#0@@15| |st2#1| |vs#1@@1|) (VarUnchanged.__default.P__Succ |st#0@@21| |e#0@@27| |st1#3| |v#3|))
))))))))))))
(let ((anon5_Else_correct  (=> (and (|AST.Expr__Raw#Equal| |e'#0@0| |e#0@@27|) (= (ControlFlow 0 8) 2)) anon3_correct)))
(let ((anon5_Then_correct  (=> (and (not (|AST.Expr__Raw#Equal| |e'#0@0| |e#0@@27|)) (= (ControlFlow 0 7) 2)) anon3_correct)))
(let ((anon4_Then_correct  (=> (and ($Is DatatypeTypeType |e'#0@0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e'#0@0| Tclass.AST.Expr $Heap@@6)) (and (=> (= (ControlFlow 0 9) 7) anon5_Then_correct) (=> (= (ControlFlow 0 9) 8) anon5_Else_correct)))))
(let ((anon4_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |e'#0@0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e'#0@0| Tclass.AST.Expr $Heap@@6))) (= (ControlFlow 0 6) 2)) anon3_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 10) 9) anon4_Then_correct) (=> (= (ControlFlow 0 10) 6) anon4_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@21| Tclass.VarUnchanged.S) ($IsAlloc DatatypeTypeType |st#0@@21| Tclass.VarUnchanged.S $Heap@@6)) (|$IsA#VarUnchanged.MState| |st#0@@21|)) (=> (and (and (and ($Is DatatypeTypeType |e#0@@27| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@27| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@27|)) (and (and ($Is SeqType |es#0@@15| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |es#0@@15| (TSeq Tclass.AST.Expr) $Heap@@6)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 11) 10)))) anon0_correct)))))
