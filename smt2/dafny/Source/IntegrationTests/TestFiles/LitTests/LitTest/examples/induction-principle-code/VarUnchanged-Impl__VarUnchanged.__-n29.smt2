...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@0| T@U) (|es#0@@0| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes#canCall| |st#0@@0| (Lit SeqType |es#0@@0|)) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@0| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@0| (TSeq Tclass.AST.Expr))))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@0|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@0|) (VarUnchanged.MState.ctx |st#0@@0|))) (let ((|res#1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@0|) (VarUnchanged.MState.ctx |st#0@@0|))))
 (and (|VarUnchanged.__default.PreEs#canCall| |st#0@@0| (Lit SeqType |es#0@@0|)) (=> (VarUnchanged.__default.PreEs |st#0@@0| (Lit SeqType |es#0@@0|)) (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@0| |res#1|))))) (= (VarUnchanged.__default.Pes |st#0@@0| (Lit SeqType |es#0@@0|)) (let ((|res#1@@0| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@0|) (VarUnchanged.MState.ctx |st#0@@0|))))
 (=> (VarUnchanged.__default.PreEs |st#0@@0| (Lit SeqType |es#0@@0|)) (VarUnchanged.__default.ResultSeqSameX |st#0@@0| |res#1@@0|))))))
 :qid |Inductiondfy.39:23|
 :weight 3
 :skolemid |745|
 :pattern ( (VarUnchanged.__default.Pes |st#0@@0| (Lit SeqType |es#0@@0|)))
))))
...
(let ((|valueOrError6#0| (Interp.__default.InterpExprs $ly@@0 |es#0@@1| |ctx#0@@0|)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|res#0| T@U) ) (!  (=> (or (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@1| |res#0|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@1| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |res#0| (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))) (and (=> (Utils.Result.Success_q |res#0|) (and (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value |res#0|))) (let ((|ctx#1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#0|))))))
 (and (VarUnchanged.MState.MState_q |st#0@@1|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@1|)) (and (VarUnchanged.MState.MState_q |st#0@@1|) (=> (|Set#IsMember| (|Map#Domain| |ctx#1|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@1|))) (and (and (VarUnchanged.MState.MState_q |st#0@@1|) (VarUnchanged.MState.MState_q |st#0@@1|)) (VarUnchanged.MState.MState_q |st#0@@1|))))))))) (= (VarUnchanged.__default.ResultSeqSameX |st#0@@1| |res#0|) (ite (Utils.Result.Success_q |res#0|) (let ((|ctx#0@@1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#0|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@1|)) (and (|Set#IsMember| (|Map#Domain| |ctx#0@@1|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@1|))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (VarUnchanged.MState.ctx |st#0@@1|)) (Utils.Option.value (VarUnchanged.MState.x |st#0@@1|))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@1|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@1|))))))))) true))))
 :qid |VarUnchangeddfy.52:34|
 :skolemid |699|
 :pattern ( (VarUnchanged.__default.ResultSeqSameX |st#0@@1| |res#0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|e#0@@2| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pre#canCall| |st#0@@2| |e#0@@2|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@2| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@2| Tclass.AST.Expr)))) (and (and (VarUnchanged.MState.MState_q |st#0@@2|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@2|)) (and (VarUnchanged.MState.MState_q |st#0@@2|) (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@2|))) |e#0@@2|)))) (= (VarUnchanged.__default.Pre |st#0@@2| |e#0@@2|)  (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@2|)) (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@2|))) |e#0@@2|)))))
 :qid |VarUnchangeddfy.82:23|
 :skolemid |704|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@2| |e#0@@2|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|es#0@@2| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Fail#canCall| (Lit DatatypeTypeType |st#0@@3|) (Lit SeqType |es#0@@2|)) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@3| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@2| (TSeq Tclass.AST.Expr))))) (and (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@3|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@2|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@3|))))) (|VarUnchanged.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@3|) (Lit SeqType |es#0@@2|))) (= (VarUnchanged.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@3|) (Lit SeqType |es#0@@2|)) (U_2_bool (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@2|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@3|)))))))
(Lit boolType (bool_2_U  (=> (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@3|) (Lit SeqType |es#0@@2|)) (Utils.Result.Failure_q |res#2|)))))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |762|
 :pattern ( (VarUnchanged.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@3|) (Lit SeqType |es#0@@2|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|es#0@@5| T@U) ) (!  (=> (or (|VarUnchanged.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |es#0@@5|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@5| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@5| (TSeq Tclass.AST.Expr))))) (and (forall ((|e#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |e#1@@0| Tclass.AST.Expr) (=> (|Seq#Contains| |es#0@@5| ($Box DatatypeTypeType |e#1@@0|)) (|VarUnchanged.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@5|) |e#1@@0|)))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |713|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@5| |e#1@@0|))
 :pattern ( (|Seq#Contains| |es#0@@5| ($Box DatatypeTypeType |e#1@@0|)))
)) (= (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |es#0@@5|)) (forall ((|e#1@@1| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#1@@1| Tclass.AST.Expr) (|Seq#Contains| |es#0@@5| ($Box DatatypeTypeType |e#1@@1|))) (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@5|) |e#1@@1|))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |712|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@5| |e#1@@1|))
 :pattern ( (|Seq#Contains| |es#0@@5| ($Box DatatypeTypeType |e#1@@1|)))
)))))
 :qid |VarUnchangeddfy.87:25|
 :weight 3
 :skolemid |714|
 :pattern ( (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@5|) (Lit SeqType |es#0@@5|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|es#0@@6| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Fail#canCall| |st#0@@6| (Lit SeqType |es#0@@6|)) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@6| (TSeq Tclass.AST.Expr))))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@6|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@6|) (VarUnchanged.MState.ctx |st#0@@6|))) (|VarUnchanged.__default.PreEs#canCall| |st#0@@6| (Lit SeqType |es#0@@6|))) (= (VarUnchanged.__default.Pes__Fail |st#0@@6| (Lit SeqType |es#0@@6|)) (let ((|res#1@@1| (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@6|) (VarUnchanged.MState.ctx |st#0@@6|))))
 (=> (VarUnchanged.__default.PreEs |st#0@@6| (Lit SeqType |es#0@@6|)) (Utils.Result.Failure_q |res#1@@1|))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |761|
 :pattern ( (VarUnchanged.__default.Pes__Fail |st#0@@6| (Lit SeqType |es#0@@6|)))
))))
...
(assert (forall (($ly@@8 T@U) (|es#0@@7| T@U) (|ctx#0@@5| T@U) ) (! (= (Interp.__default.InterpExprs ($LS $ly@@8) |es#0@@7| |ctx#0@@5|) (Interp.__default.InterpExprs $ly@@8 |es#0@@7| |ctx#0@@5|))
 :qid |Interpdfy.69:12|
 :skolemid |1217|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@8) |es#0@@7| |ctx#0@@5|))
)))
...
(assert (forall (($ly@@11 T@U) (|es#0@@8| T@U) (|ctx#0@@6| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@8| |ctx#0@@6|) (and ($Is SeqType |es#0@@8| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@6| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@8| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@8| (LitInt 0))) |ctx#0@@6|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@11 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@8| (LitInt 0))) |ctx#0@@6|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (|Seq#Drop| |es#0@@8| (LitInt 1)) |ctx1#0@@0|) (let ((|valueOrError1#0@@0| (Interp.__default.InterpExprs $ly@@11 (|Seq#Drop| |es#0@@8| (LitInt 1)) |ctx1#0@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@11) |es#0@@8| |ctx#0@@6|) (ite (|Seq#Equal| |es#0@@8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@6|)))) (let ((|valueOrError0#0@@1| (Interp.__default.InterpExpr $ly@@11 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@8| (LitInt 0))) |ctx#0@@6|)))
...
(let ((|valueOrError1#0@@1| (Interp.__default.InterpExprs $ly@@11 (|Seq#Drop| |es#0@@8| (LitInt 1)) |ctx1#0@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0|))) |vs#0@@0|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1221|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@11) |es#0@@8| |ctx#0@@6|))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|es#0@@9| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes#canCall| |st#0@@7| |es#0@@9|) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@7| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@9| (TSeq Tclass.AST.Expr))))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@7|) (|Interp.__default.InterpExprs#canCall| |es#0@@9| (VarUnchanged.MState.ctx |st#0@@7|))) (let ((|res#0@@0| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@9| (VarUnchanged.MState.ctx |st#0@@7|))))
 (and (|VarUnchanged.__default.PreEs#canCall| |st#0@@7| |es#0@@9|) (=> (VarUnchanged.__default.PreEs |st#0@@7| |es#0@@9|) (|VarUnchanged.__default.ResultSeqSameX#canCall| |st#0@@7| |res#0@@0|))))) (= (VarUnchanged.__default.Pes |st#0@@7| |es#0@@9|) (let ((|res#0@@1| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@9| (VarUnchanged.MState.ctx |st#0@@7|))))
 (=> (VarUnchanged.__default.PreEs |st#0@@7| |es#0@@9|) (VarUnchanged.__default.ResultSeqSameX |st#0@@7| |res#0@@1|))))))
 :qid |Inductiondfy.39:23|
 :skolemid |744|
 :pattern ( (VarUnchanged.__default.Pes |st#0@@7| |es#0@@9|))
))))
...
(let ((|oe1#0@@0| (AST.Expr__Raw.oe1 |e#0@@10|)))
 (and (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |oe1#0@@0|) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |oe2#0@@0|)))) (let ((|es#0@@10| (AST.Expr__Raw.es |e#0@@10|)))
(forall ((|e#3@@0| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#3@@0| Tclass.AST.Expr__Raw) (|Seq#Contains| |es#0@@10| ($Box DatatypeTypeType |e#3@@0|))) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |e#3@@0|))
 :qid |VarUnchangeddfy.38:16|
 :skolemid |646|
 :pattern ( (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |e#3@@0|))
 :pattern ( (|Seq#Contains| |es#0@@10| ($Box DatatypeTypeType |e#3@@0|)))
))))))))))))
 :qid |VarUnchangeddfy.17:13|
 :skolemid |651|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@12) |x#0@@2| |e#0@@10|))
))))
(assert (forall ((Utils.Result$T@@8 T@U) (d@@35 T@U) ) (!  (=> ($Is DatatypeTypeType d@@35 (Tclass.Utils.Result Utils.Result$T@@8)) (or (Utils.Result.Success_q d@@35) (Utils.Result.Failure_q d@@35)))
 :qid |unknown.0:0|
 :skolemid |991|
 :pattern ( (Utils.Result.Failure_q d@@35) ($Is DatatypeTypeType d@@35 (Tclass.Utils.Result Utils.Result$T@@8)))
 :pattern ( (Utils.Result.Success_q d@@35) ($Is DatatypeTypeType d@@35 (Tclass.Utils.Result Utils.Result$T@@8)))
)))
(assert (forall ((Utils.Option$T@@3 T@U) (d@@36 T@U) ) (!  (=> ($Is DatatypeTypeType d@@36 (Tclass.Utils.Option Utils.Option$T@@3)) (or (Utils.Option.Some_q d@@36) (Utils.Option.None_q d@@36)))
 :qid |unknown.0:0|
 :skolemid |1024|
 :pattern ( (Utils.Option.None_q d@@36) ($Is DatatypeTypeType d@@36 (Tclass.Utils.Option Utils.Option$T@@3)))
 :pattern ( (Utils.Option.Some_q d@@36) ($Is DatatypeTypeType d@@36 (Tclass.Utils.Option Utils.Option$T@@3)))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|res#0@@2| T@U) ) (!  (=> (or (|VarUnchanged.__default.ResultSeqSameX#canCall| (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |res#0@@2|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@8| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |res#0@@2| (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@2|))))) (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@2|))))) (let ((|ctx#3| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@2|)))))))))
 (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@8|)) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@8|))))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@8|)) (=> (|Set#IsMember| (|Map#Domain| |ctx#3|) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@8|)))))))) (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@8|)) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@8|))) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@8|)))))))))) (= (VarUnchanged.__default.ResultSeqSameX (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |res#0@@2|)) (ite (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@2|)) (let ((|ctx#2| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@2|)))))))))
 ...
 :weight 3
 :skolemid |700|
 :pattern ( (VarUnchanged.__default.ResultSeqSameX (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |res#0@@2|)))
))))
(assert (forall (($ly@@13 T@U) (|es#0@@11| T@U) (|ctx#0@@7| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@11|) |ctx#0@@7|) (and ($Is SeqType |es#0@@11| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@7| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@11| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@11|) (LitInt 0))) |ctx#0@@7|) (let ((|valueOrError0#1@@0| (Interp.__default.InterpExpr ($LS $ly@@13) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@11|) (LitInt 0))) |ctx#0@@7|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@11|) (LitInt 1))) |ctx1#1@@0|) (let ((|valueOrError1#1@@0| (Interp.__default.InterpExprs ($LS $ly@@13) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@11|) (LitInt 1))) |ctx1#1@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@13) (Lit SeqType |es#0@@11|) |ctx#0@@7|) (ite (|Seq#Equal| |es#0@@11| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@7|)))) (let ((|valueOrError0#1@@1| (Interp.__default.InterpExpr ($LS $ly@@13) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@11|) (LitInt 0))) |ctx#0@@7|)))
...
(let ((|valueOrError1#1@@1| (Interp.__default.InterpExprs ($LS $ly@@13) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@11|) (LitInt 1))) |ctx1#1@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#1|))) |vs#1@@0|)) ($Box MapType |ctx2#1@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |1222|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@13) (Lit SeqType |es#0@@11|) |ctx#0@@7|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@9| T@U) (|es#0@@12| T@U) ) (!  (=> (or (|VarUnchanged.__default.PreEs#canCall| |st#0@@9| |es#0@@12|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@9| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@12| (TSeq Tclass.AST.Expr))))) (and (forall ((|e#0@@14| T@U) ) (!  (=> ($Is DatatypeTypeType |e#0@@14| Tclass.AST.Expr) (=> (|Seq#Contains| |es#0@@12| ($Box DatatypeTypeType |e#0@@14|)) (|VarUnchanged.__default.Pre#canCall| |st#0@@9| |e#0@@14|)))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |710|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@9| |e#0@@14|))
 :pattern ( (|Seq#Contains| |es#0@@12| ($Box DatatypeTypeType |e#0@@14|)))
)) (= (VarUnchanged.__default.PreEs |st#0@@9| |es#0@@12|) (forall ((|e#0@@15| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr) (|Seq#Contains| |es#0@@12| ($Box DatatypeTypeType |e#0@@15|))) (VarUnchanged.__default.Pre |st#0@@9| |e#0@@15|))
 :qid |VarUnchangeddfy.89:12|
 :skolemid |709|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@9| |e#0@@15|))
 :pattern ( (|Seq#Contains| |es#0@@12| ($Box DatatypeTypeType |e#0@@15|)))
)))))
 :qid |VarUnchangeddfy.87:25|
 :skolemid |711|
 :pattern ( (VarUnchanged.__default.PreEs |st#0@@9| |es#0@@12|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@10| T@U) (|es#0@@13| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes__Fail#canCall| |st#0@@10| |es#0@@13|) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@10| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@13| (TSeq Tclass.AST.Expr))))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@10|) (|Interp.__default.InterpExprs#canCall| |es#0@@13| (VarUnchanged.MState.ctx |st#0@@10|))) (|VarUnchanged.__default.PreEs#canCall| |st#0@@10| |es#0@@13|)) (= (VarUnchanged.__default.Pes__Fail |st#0@@10| |es#0@@13|) (let ((|res#0@@3| (Interp.__default.InterpExprs ($LS $LZ) |es#0@@13| (VarUnchanged.MState.ctx |st#0@@10|))))
 (=> (VarUnchanged.__default.PreEs |st#0@@10| |es#0@@13|) (Utils.Result.Failure_q |res#0@@3|))))))
 :qid |Inductiondfy.41:28|
 :skolemid |760|
 :pattern ( (VarUnchanged.__default.Pes__Fail |st#0@@10| |es#0@@13|))
))))
...
(assert (forall ((d@@37 T@U) (Utils.Result$T@@14 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (Utils.Result.Success_q d@@37) ($IsAlloc DatatypeTypeType d@@37 (Tclass.Utils.Result Utils.Result$T@@14) $h@@8))) ($IsAllocBox (Utils.Result.value d@@37) Utils.Result$T@@14 $h@@8))
 :qid |unknown.0:0|
 :skolemid |982|
 :pattern ( ($IsAllocBox (Utils.Result.value d@@37) Utils.Result$T@@14 $h@@8))
)))
(assert (forall ((d@@38 T@U) (Utils.Option$T@@6 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) (and (Utils.Option.Some_q d@@38) ($IsAlloc DatatypeTypeType d@@38 (Tclass.Utils.Option Utils.Option$T@@6) $h@@9))) ($IsAllocBox (Utils.Option.value d@@38) Utils.Option$T@@6 $h@@9))
 :qid |unknown.0:0|
 :skolemid |1015|
 :pattern ( ($IsAllocBox (Utils.Option.value d@@38) Utils.Option$T@@6 $h@@9))
)))
...
(assert (forall ((d@@39 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) (and (AST.Expr__Raw.Literal_q d@@39) ($IsAlloc DatatypeTypeType d@@39 Tclass.AST.Expr__Raw $h@@10))) ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@39)) TInt $h@@10))
 :qid |unknown.0:0|
 :skolemid |1056|
 :pattern ( ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@39)) TInt $h@@10))
)))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|st#0@@11| T@U) (|es#0@@14| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pes#canCall| (Lit DatatypeTypeType |st#0@@11|) (Lit SeqType |es#0@@14|)) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@11| Tclass.VarUnchanged.S) ($Is SeqType |es#0@@14| (TSeq Tclass.AST.Expr))))) (and (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@11|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@14|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@11|))))) (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@14|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@11|)))))))
 (and (|VarUnchanged.__default.PreEs#canCall| (Lit DatatypeTypeType |st#0@@11|) (Lit SeqType |es#0@@14|)) (=> (U_2_bool (Lit boolType (bool_2_U (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@11|) (Lit SeqType |es#0@@14|))))) (|VarUnchanged.__default.ResultSeqSameX#canCall| (Lit DatatypeTypeType |st#0@@11|) |res#2@@0|))))) (= (VarUnchanged.__default.Pes (Lit DatatypeTypeType |st#0@@11|) (Lit SeqType |es#0@@14|)) (U_2_bool (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@14|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@11|)))))))
(Lit boolType (bool_2_U  (=> (VarUnchanged.__default.PreEs (Lit DatatypeTypeType |st#0@@11|) (Lit SeqType |es#0@@14|)) (VarUnchanged.__default.ResultSeqSameX (Lit DatatypeTypeType |st#0@@11|) |res#2@@1|)))))))))
 :qid |Inductiondfy.39:23|
 :weight 3
 :skolemid |746|
 :pattern ( (VarUnchanged.__default.Pes (Lit DatatypeTypeType |st#0@@11|) (Lit SeqType |es#0@@14|)))
))))
...
(assert (forall ((d@@42 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) ($Is DatatypeTypeType d@@42 Tclass.VarUnchanged.MState)) ($IsAlloc DatatypeTypeType d@@42 Tclass.VarUnchanged.MState $h@@11))
 :qid |unknown.0:0|
 :skolemid |951|
 :pattern ( ($IsAlloc DatatypeTypeType d@@42 Tclass.VarUnchanged.MState $h@@11))
)))
(assert (forall ((d@@43 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) ($Is DatatypeTypeType d@@43 Tclass.AST.BinOp)) ($IsAlloc DatatypeTypeType d@@43 Tclass.AST.BinOp $h@@12))
 :qid |unknown.0:0|
 :skolemid |1034|
 :pattern ( ($IsAlloc DatatypeTypeType d@@43 Tclass.AST.BinOp $h@@12))
)))
(assert (forall ((d@@44 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) ($Is DatatypeTypeType d@@44 Tclass.AST.Expr__Raw)) ($IsAlloc DatatypeTypeType d@@44 Tclass.AST.Expr__Raw $h@@13))
 :qid |unknown.0:0|
 :skolemid |1130|
 :pattern ( ($IsAlloc DatatypeTypeType d@@44 Tclass.AST.Expr__Raw $h@@13))
)))
...
(assert (forall ((d@@45 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (AST.Expr__Raw.Var_q d@@45) ($IsAlloc DatatypeTypeType d@@45 Tclass.AST.Expr__Raw $h@@14))) ($IsAlloc SeqType (AST.Expr__Raw.name d@@45) (TSeq TChar) $h@@14))
 :qid |unknown.0:0|
 :skolemid |1046|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.name d@@45) (TSeq TChar) $h@@14))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@12| T@U) (|e#0@@18| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@12|) (Lit DatatypeTypeType |e#0@@18|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@12| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@18| Tclass.AST.Expr)))) (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@12|)) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@12|))))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@12|)) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@12|)))))) (Lit DatatypeTypeType |e#0@@18|))))) (= (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@12|) (Lit DatatypeTypeType |e#0@@18|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@12|)))) (VarUnchanged.__default.VarUnchanged ($LS $LZ) (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@12|)))))) (Lit DatatypeTypeType |e#0@@18|)))))))))
 :qid |VarUnchangeddfy.82:23|
 :weight 3
 :skolemid |705|
 :pattern ( (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@12|) (Lit DatatypeTypeType |e#0@@18|)))
))))
...
(assert (forall ((|a#7#0#0@@0| T@U) (|a#7#1#0@@0| T@U) (d@@46 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#7#1#0@@0|) ($Box DatatypeTypeType d@@46)) (< (DtRank d@@46) (DtRank (|#VarUnchanged.MState.MState| |a#7#0#0@@0| |a#7#1#0@@0|))))
 :qid |VarUnchangeddfy.73:28|
 :skolemid |949|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#7#1#0@@0|) ($Box DatatypeTypeType d@@46)) (|#VarUnchanged.MState.MState| |a#7#0#0@@0| |a#7#1#0@@0|))
)))
...
(assert (forall ((d@@47 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (VarUnchanged.MState.MState_q d@@47) ($IsAlloc DatatypeTypeType d@@47 Tclass.VarUnchanged.MState $h@@15))) ($IsAlloc MapType (VarUnchanged.MState.ctx d@@47) (TMap (TSeq TChar) TInt) $h@@15))
 :qid |unknown.0:0|
 :skolemid |944|
 :pattern ( ($IsAlloc MapType (VarUnchanged.MState.ctx d@@47) (TMap (TSeq TChar) TInt) $h@@15))
)))
(assert (forall ((d@@48 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (_System.Tuple2.___hMake2_q d@@48) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@48 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@16)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@48 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@16))
)))) ($IsAllocBox (_System.Tuple2._0 d@@48) |_System._tuple#2$T0@@6| $h@@16))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@48) |_System._tuple#2$T0@@6| $h@@16))
)))
(assert (forall ((d@@49 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (_System.Tuple2.___hMake2_q d@@49) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@49 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@17)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@49 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@17))
)))) ($IsAllocBox (_System.Tuple2._1 d@@49) |_System._tuple#2$T1@@7| $h@@17))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@49) |_System._tuple#2$T1@@7| $h@@17))
)))
...
(assert (forall ((d@@50 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (AST.Expr__Raw.Bind_q d@@50) ($IsAlloc DatatypeTypeType d@@50 Tclass.AST.Expr__Raw $h@@18))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@50) Tclass.AST.Expr__Raw $h@@18))
 :qid |unknown.0:0|
 :skolemid |1066|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@50) Tclass.AST.Expr__Raw $h@@18))
)))
(assert (forall ((d@@51 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (AST.Expr__Raw.If_q d@@51) ($IsAlloc DatatypeTypeType d@@51 Tclass.AST.Expr__Raw $h@@19))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@51) Tclass.AST.Expr__Raw $h@@19))
 :qid |unknown.0:0|
 :skolemid |1095|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@51) Tclass.AST.Expr__Raw $h@@19))
)))
(assert (forall ((d@@52 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (AST.Expr__Raw.If_q d@@52) ($IsAlloc DatatypeTypeType d@@52 Tclass.AST.Expr__Raw $h@@20))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@52) Tclass.AST.Expr__Raw $h@@20))
 :qid |unknown.0:0|
 :skolemid |1096|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@52) Tclass.AST.Expr__Raw $h@@20))
)))
(assert (forall ((d@@53 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (AST.Expr__Raw.If_q d@@53) ($IsAlloc DatatypeTypeType d@@53 Tclass.AST.Expr__Raw $h@@21))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@53) Tclass.AST.Expr__Raw $h@@21))
 :qid |unknown.0:0|
 :skolemid |1097|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@53) Tclass.AST.Expr__Raw $h@@21))
)))
(assert (forall ((d@@54 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (AST.Expr__Raw.Op_q d@@54) ($IsAlloc DatatypeTypeType d@@54 Tclass.AST.Expr__Raw $h@@22))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@54) Tclass.AST.BinOp $h@@22))
 :qid |unknown.0:0|
 :skolemid |1110|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@54) Tclass.AST.BinOp $h@@22))
)))
(assert (forall ((d@@55 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (AST.Expr__Raw.Op_q d@@55) ($IsAlloc DatatypeTypeType d@@55 Tclass.AST.Expr__Raw $h@@23))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@55) Tclass.AST.Expr__Raw $h@@23))
 :qid |unknown.0:0|
 :skolemid |1111|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@55) Tclass.AST.Expr__Raw $h@@23))
)))
(assert (forall ((d@@56 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (AST.Expr__Raw.Op_q d@@56) ($IsAlloc DatatypeTypeType d@@56 Tclass.AST.Expr__Raw $h@@24))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@56) Tclass.AST.Expr__Raw $h@@24))
 :qid |unknown.0:0|
 :skolemid |1112|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@56) Tclass.AST.Expr__Raw $h@@24))
)))
...
(assert (forall ((d@@57 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (VarUnchanged.MState.MState_q d@@57) ($IsAlloc DatatypeTypeType d@@57 Tclass.VarUnchanged.MState $h@@25))) ($IsAlloc DatatypeTypeType (VarUnchanged.MState.x d@@57) (Tclass.Utils.Option (TSeq TChar)) $h@@25))
 :qid |unknown.0:0|
 :skolemid |943|
 :pattern ( ($IsAlloc DatatypeTypeType (VarUnchanged.MState.x d@@57) (Tclass.Utils.Option (TSeq TChar)) $h@@25))
)))
(assert (forall ((d@@58 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (AST.Expr__Raw.Bind_q d@@58) ($IsAlloc DatatypeTypeType d@@58 Tclass.AST.Expr__Raw $h@@26))) ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@58) (TSeq (TSeq TChar)) $h@@26))
 :qid |unknown.0:0|
 :skolemid |1064|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@58) (TSeq (TSeq TChar)) $h@@26))
)))
(assert (forall ((d@@59 T@U) ($h@@27 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (AST.Expr__Raw.Assign_q d@@59) ($IsAlloc DatatypeTypeType d@@59 Tclass.AST.Expr__Raw $h@@27))) ($IsAlloc SeqType (AST.Expr__Raw.avars d@@59) (TSeq (TSeq TChar)) $h@@27))
 :qid |unknown.0:0|
 :skolemid |1081|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avars d@@59) (TSeq (TSeq TChar)) $h@@27))
)))
...
(assert (forall ((d@@60 T@U) ($h@@28 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (AST.Expr__Raw.Bind_q d@@60) ($IsAlloc DatatypeTypeType d@@60 Tclass.AST.Expr__Raw $h@@28))) ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@60) (TSeq Tclass.AST.Expr__Raw) $h@@28))
 :qid |unknown.0:0|
 :skolemid |1065|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@60) (TSeq Tclass.AST.Expr__Raw) $h@@28))
)))
(assert (forall ((d@@61 T@U) ($h@@29 T@U) ) (!  (=> (and ($IsGoodHeap $h@@29) (and (AST.Expr__Raw.Assign_q d@@61) ($IsAlloc DatatypeTypeType d@@61 Tclass.AST.Expr__Raw $h@@29))) ($IsAlloc SeqType (AST.Expr__Raw.avals d@@61) (TSeq Tclass.AST.Expr__Raw) $h@@29))
 :qid |unknown.0:0|
 :skolemid |1082|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avals d@@61) (TSeq Tclass.AST.Expr__Raw) $h@@29))
)))
(assert (forall ((d@@62 T@U) ($h@@30 T@U) ) (!  (=> (and ($IsGoodHeap $h@@30) (and (AST.Expr__Raw.Seq_q d@@62) ($IsAlloc DatatypeTypeType d@@62 Tclass.AST.Expr__Raw $h@@30))) ($IsAlloc SeqType (AST.Expr__Raw.es d@@62) (TSeq Tclass.AST.Expr__Raw) $h@@30))
 :qid |unknown.0:0|
 :skolemid |1125|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.es d@@62) (TSeq Tclass.AST.Expr__Raw) $h@@30))
)))
...
(declare-fun |es#0@@15| () T@U)
(declare-fun $Heap@1 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $Heap@@6 () T@U)
(declare-fun $Heap@0 () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(set-info :boogie-vc-id Impl$$VarUnchanged.__default.Pes__Satisfied)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (VarUnchanged.__default.Pes |st#0@@13| |es#0@@15|)))))
(let ((anon3_Else_correct  (=> (not (VarUnchanged.__default.Pes__Fail |st#0@@13| |es#0@@15|)) (=> (and (or (or (<= 0 (LitInt 1)) (< (|Seq#Rank| |es#0@@15|) (|Seq#Rank| |es#0@@15|))) (= (LitInt 0) (LitInt 1))) (or (< (|Seq#Rank| |es#0@@15|) (|Seq#Rank| |es#0@@15|)) (and (= (|Seq#Rank| |es#0@@15|) (|Seq#Rank| |es#0@@15|)) (< (LitInt 0) (LitInt 1))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (not (VarUnchanged.__default.Pes__Fail |st#0@@13| |es#0@@15|))) (=> (not (VarUnchanged.__default.Pes__Fail |st#0@@13| |es#0@@15|)) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (|VarUnchanged.__default.Pes#canCall| |st#0@@13| |es#0@@15|) (VarUnchanged.__default.Pes |st#0@@13| |es#0@@15|)) (and (= $Heap@@6 $Heap@1) (= (ControlFlow 0 5) 2))) GeneratedUnifiedExit_correct))))))))
(let ((anon3_Then_correct  (=> (VarUnchanged.__default.Pes__Fail |st#0@@13| |es#0@@15|) (and (=> (= (ControlFlow 0 3) (- 0 4)) (VarUnchanged.__default.Pes__Fail |st#0@@13| |es#0@@15|)) (=> (VarUnchanged.__default.Pes__Fail |st#0@@13| |es#0@@15|) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (|VarUnchanged.__default.Pes#canCall| |st#0@@13| |es#0@@15|) (VarUnchanged.__default.Pes |st#0@@13| |es#0@@15|)) (and (= $Heap@@6 $Heap@0) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct)))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (=> (and (and ($IsAlloc DatatypeTypeType |st#0@@13| Tclass.VarUnchanged.S $Heap@@6) ($IsAlloc SeqType |es#0@@15| (TSeq Tclass.AST.Expr) $Heap@@6)) (and (|VarUnchanged.__default.Pes__Fail#canCall| |st#0@@13| |es#0@@15|) (|VarUnchanged.__default.Pes__Fail#canCall| |st#0@@13| |es#0@@15|))) (and (=> (= (ControlFlow 0 7) 3) anon3_Then_correct) (=> (= (ControlFlow 0 7) 5) anon3_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and ($Is DatatypeTypeType |st#0@@13| Tclass.VarUnchanged.S) ($IsAlloc DatatypeTypeType |st#0@@13| Tclass.VarUnchanged.S $Heap@@6)) (|$IsA#VarUnchanged.MState| |st#0@@13|)) (and (and ($Is SeqType |es#0@@15| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |es#0@@15| (TSeq Tclass.AST.Expr) $Heap@@6)) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 8) 7)))) anon0_correct))))
