...
(set-info :boogie-vc-id Impl$$EliminateMulZero.__default.InductBind__Fail)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (EliminateMulZero.__default.Pes__Fail |st#0@@18| |bvals#0@@4|))) (=> (not (EliminateMulZero.__default.Pes__Fail |st#0@@18| |bvals#0@@4|)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|st1#1| T@U) (|vs#1@@1| T@U) ) (!  (=> (and (and ($Is MapType |st1#1| (TMap (TSeq TChar) TInt)) ($Is SeqType |vs#1@@1| (TSeq TInt))) (EliminateMulZero.__default.Pes__Succ |st#0@@18| |bvals#0@@4| |st1#1| |vs#1@@1|)) (and (EliminateMulZero.__default.UpdateState__Pre |st1#1| |bvars#0@@3| |vs#1@@1|) (not (EliminateMulZero.__default.P__Fail (EliminateMulZero.__default.BindStartScope |st1#1| |bvars#0@@3| |vs#1@@1|) |body#0@@3|))))
 :qid |Inductiondfy.165:14|
 :skolemid |806|
 :pattern ( (EliminateMulZero.__default.BindStartScope |st1#1| |bvars#0@@3| |vs#1@@1|))
 :pattern ( (EliminateMulZero.__default.UpdateState__Pre |st1#1| |bvars#0@@3| |vs#1@@1|))
 :pattern ( (EliminateMulZero.__default.Pes__Succ |st#0@@18| |bvals#0@@4| |st1#1| |vs#1@@1|))
))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (and ($Is MapType |st#0@@18| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |st#0@@18| (TMap (TSeq TChar) TInt) $Heap@@6))) (and (and ($Is DatatypeTypeType |e#0@@24| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@24| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@24|))) (=> (and (and (and (and ($Is SeqType |bvars#0@@3| (TSeq (TSeq TChar))) ($IsAlloc SeqType |bvars#0@@3| (TSeq (TSeq TChar)) $Heap@@6)) (and ($Is SeqType |bvals#0@@4| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |bvals#0@@4| (TSeq Tclass.AST.Expr) $Heap@@6))) (and (and ($Is DatatypeTypeType |body#0@@3| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |body#0@@3| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |body#0@@3|))) (and (and (and (= 4 $FunctionContextHeight) (AST.Expr__Raw.Bind_q |e#0@@24|)) (and (|Seq#Equal| (AST.Expr__Raw.bvars |e#0@@24|) |bvars#0@@3|) (|Seq#Equal| (AST.Expr__Raw.bvals |e#0@@24|) |bvals#0@@4|))) (and (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.body |e#0@@24|) |body#0@@3|) (not (EliminateMulZero.__default.P__Fail |st#0@@18| |e#0@@24|))) (and (EliminateMulZero.__default.Pes |st#0@@18| |bvals#0@@4|) (= (ControlFlow 0 4) 2))))) anon0_correct))))
