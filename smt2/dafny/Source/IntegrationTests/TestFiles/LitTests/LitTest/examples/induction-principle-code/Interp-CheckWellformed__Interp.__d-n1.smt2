...
(set-info :boogie-vc-id CheckWellformed$$Interp.__default.InterpExprs)
...
(let ((anon15_Else_correct  (=> (and (=> (Utils.Result.Success_q |r#0|) (= (|Seq#Length| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value |r#0|))))) (|Seq#Length| |es#0@@6|))) (= (ControlFlow 0 22) 19)) anon5_correct)))
(let ((anon15_Then_correct  (=> (Utils.Result.Success_q |r#0|) (and (=> (= (ControlFlow 0 20) (- 0 21)) (Utils.Result.Success_q |r#0|)) (=> (Utils.Result.Success_q |r#0|) (=> (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value |r#0|))) (=> (and (= (|Seq#Length| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value |r#0|))))) (|Seq#Length| |es#0@@6|)) (= (ControlFlow 0 20) 19)) anon5_correct)))))))
(let ((anon14_Then_correct  (=> (and ($Is DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) |es#0@@6| |ctx#0@@9|) (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType |r#0| (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))) (and (=> (= (ControlFlow 0 23) 20) anon15_Then_correct) (=> (= (ControlFlow 0 23) 22) anon15_Else_correct)))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (Utils.Result.Success_q |r#0|) (= (|Seq#Length| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value |r#0|))))) (|Seq#Length| |es#0@@6|))))))
(let ((anon18_Else_correct  (=> (and (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#Z#0@0|)) ($IsAllocBox ($Box DatatypeTypeType |valueOrError1#Z#0@0|) (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))) $Heap@@6)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (Utils.Result.Success_q |valueOrError1#Z#0@0|)) (=> (and (and (Utils.Result.Success_q |valueOrError1#Z#0@0|) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#Z#0@0|)) (and (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#Z#0@0|))) (= |let#3#0#0| ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#Z#0@0|))))) (=> (and (and (and (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#Z#0@0|) ($Is DatatypeTypeType |let#3#0#0| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)))) (and (_System.Tuple2.___hMake2_q |let#3#0#0|) (= (|#_System._tuple#2._#Make2| ($Box SeqType |vs#Z#0@0|) ($Box MapType |ctx2#Z#0@0|)) |let#3#0#0|))) (and (and (= (Interp.__default.InterpExprs ($LS $LZ) |es#0@@6| |ctx#0@@9|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#Z#0@0|))) |vs#Z#0@0|)) ($Box MapType |ctx2#Z#0@0|))))) ($Is DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) |es#0@@6| |ctx#0@@9|) (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))) (and (= (Interp.__default.InterpExprs ($LS $LZ) |es#0@@6| |ctx#0@@9|) |r#0|) (= (ControlFlow 0 8) 2)))) GeneratedUnifiedExit_correct))))))
(let ((anon18_Then_correct  (=> (and (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#Z#0@0|) ($IsAllocBox ($Box DatatypeTypeType |valueOrError1#Z#0@0|) (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))) $Heap@@6)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (Utils.Result.Failure_q |valueOrError1#Z#0@0|)) (=> (Utils.Result.Failure_q |valueOrError1#Z#0@0|) (=> (and (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#Z#0@0|) (= (Interp.__default.InterpExprs ($LS $LZ) |es#0@@6| |ctx#0@@9|) (Utils.Result.PropagateFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#Z#0@0|))) (=> (and (and (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#Z#0@0|) ($Is DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) |es#0@@6| |ctx#0@@9|) (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))) (and (= (Interp.__default.InterpExprs ($LS $LZ) |es#0@@6| |ctx#0@@9|) |r#0|) (= (ControlFlow 0 6) 2))) GeneratedUnifiedExit_correct)))))))
(let ((anon17_Else_correct  (=> (and (not (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError0#Z#0@0|)) ($IsAllocBox ($Box DatatypeTypeType |valueOrError0#Z#0@0|) (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt))) $Heap@@6)) (and (=> (= (ControlFlow 0 10) (- 0 14)) (Utils.Result.Success_q |valueOrError0#Z#0@0|)) (=> (and (and (and (Utils.Result.Success_q |valueOrError0#Z#0@0|) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError0#Z#0@0|)) (and (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError0#Z#0@0|))) (= |let#1#0#0| ($Unbox DatatypeTypeType (Utils.Result.Extract (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError0#Z#0@0|))))) (and (and (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError0#Z#0@0|) ($Is DatatypeTypeType |let#1#0#0| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))) (and (_System.Tuple2.___hMake2_q |let#1#0#0|) (= (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#Z#0@0|)) ($Box MapType |ctx1#Z#0@0|)) |let#1#0#0|)))) (and (=> (= (ControlFlow 0 10) (- 0 13)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |es#0@@6|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |es#0@@6|))) (=> (= |##es#0@0| (|Seq#Drop| |es#0@@6| (LitInt 1))) (=> (and ($IsAlloc SeqType |##es#0@0| (TSeq Tclass.AST.Expr) $Heap@@6) ($IsAlloc MapType |ctx1#Z#0@0| (TMap (TSeq TChar) TInt) $Heap@@6)) (and (=> (= (ControlFlow 0 10) (- 0 12)) (or (or (<= 0 (LitInt 0)) (< (|Seq#Rank| |##es#0@0|) (|Seq#Rank| |es#0@@6|))) (= (LitInt 0) (LitInt 0)))) (=> (or (or (<= 0 (LitInt 0)) (< (|Seq#Rank| |##es#0@0|) (|Seq#Rank| |es#0@@6|))) (= (LitInt 0) (LitInt 0))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (or (< (|Seq#Rank| |##es#0@0|) (|Seq#Rank| |es#0@@6|)) (and (= (|Seq#Rank| |##es#0@0|) (|Seq#Rank| |es#0@@6|)) (< (LitInt 0) (LitInt 0))))) (=> (or (< (|Seq#Rank| |##es#0@0|) (|Seq#Rank| |es#0@@6|)) (and (= (|Seq#Rank| |##es#0@0|) (|Seq#Rank| |es#0@@6|)) (< (LitInt 0) (LitInt 0)))) (=> (|Interp.__default.InterpExprs#canCall| (|Seq#Drop| |es#0@@6| (LitInt 1)) |ctx1#Z#0@0|) (=> (and (= |let#2#0#0| (Interp.__default.InterpExprs ($LS $LZ) (|Seq#Drop| |es#0@@6| (LitInt 1)) |ctx1#Z#0@0|)) (|Interp.__default.InterpExprs#canCall| (|Seq#Drop| |es#0@@6| (LitInt 1)) |ctx1#Z#0@0|)) (=> (and (and ($Is DatatypeTypeType |let#2#0#0| (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)))) (= |valueOrError1#Z#0@0| |let#2#0#0|)) (and ($IsAllocBox ($Box DatatypeTypeType |valueOrError1#Z#0@0|) (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))) $Heap@@6) (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#Z#0@0|))) (and (=> (= (ControlFlow 0 10) 6) anon18_Then_correct) (=> (= (ControlFlow 0 10) 8) anon18_Else_correct))))))))))))))))))
(let ((anon17_Then_correct  (=> (and (Utils.Result.IsFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError0#Z#0@0|) ($IsAllocBox ($Box DatatypeTypeType |valueOrError0#Z#0@0|) (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt))) $Heap@@6)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (Utils.Result.Failure_q |valueOrError0#Z#0@0|)) (=> (Utils.Result.Failure_q |valueOrError0#Z#0@0|) (=> (and (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError0#Z#0@0|) (= (Interp.__default.InterpExprs ($LS $LZ) |es#0@@6| |ctx#0@@9|) (Utils.Result.PropagateFailure (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError0#Z#0@0|))) (=> (and (and (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError0#Z#0@0|) ($Is DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) |es#0@@6| |ctx#0@@9|) (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))) (and (= (Interp.__default.InterpExprs ($LS $LZ) |es#0@@6| |ctx#0@@9|) |r#0|) (= (ControlFlow 0 4) 2))) GeneratedUnifiedExit_correct)))))))
(let ((anon16_Else_correct  (=> (not (|Seq#Equal| |es#0@@6| |Seq#Empty|)) (and (=> (= (ControlFlow 0 15) (- 0 18)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |es#0@@6|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |es#0@@6|))) (=> (= |##e#0@0| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@6| (LitInt 0)))) (=> (and ($IsAlloc DatatypeTypeType |##e#0@0| Tclass.AST.Expr $Heap@@6) ($IsAlloc MapType |ctx#0@@9| (TMap (TSeq TChar) TInt) $Heap@@6)) (and (=> (= (ControlFlow 0 15) (- 0 17)) (or (or (<= 0 (LitInt 0)) (< (DtRank |##e#0@0|) (|Seq#Rank| |es#0@@6|))) (= (LitInt 1) (LitInt 0)))) (=> (or (or (<= 0 (LitInt 0)) (< (DtRank |##e#0@0|) (|Seq#Rank| |es#0@@6|))) (= (LitInt 1) (LitInt 0))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (< (DtRank |##e#0@0|) (|Seq#Rank| |es#0@@6|))) (=> (< (DtRank |##e#0@0|) (|Seq#Rank| |es#0@@6|)) (=> (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@6| (LitInt 0))) |ctx#0@@9|) (=> (and (= |let#0#0#0| (Interp.__default.InterpExpr ($LS $LZ) ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@6| (LitInt 0))) |ctx#0@@9|)) (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@6| (LitInt 0))) |ctx#0@@9|)) (=> (and (and ($Is DatatypeTypeType |let#0#0#0| (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))) (= |valueOrError0#Z#0@0| |let#0#0#0|)) (and ($IsAllocBox ($Box DatatypeTypeType |valueOrError0#Z#0@0|) (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt))) $Heap@@6) (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError0#Z#0@0|))) (and (=> (= (ControlFlow 0 15) 4) anon17_Then_correct) (=> (= (ControlFlow 0 15) 10) anon17_Else_correct))))))))))))))))
(let ((anon16_Then_correct  (=> (|Seq#Equal| |es#0@@6| |Seq#Empty|) (=> (and (and (= (Interp.__default.InterpExprs ($LS $LZ) |es#0@@6| |ctx#0@@9|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@9|))))) ($Is DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) |es#0@@6| |ctx#0@@9|) (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))) (and (= (Interp.__default.InterpExprs ($LS $LZ) |es#0@@6| |ctx#0@@9|) |r#0|) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#3| null $Heap@@6 alloc false)) (and (and (=> (= (ControlFlow 0 24) 23) anon14_Then_correct) (=> (= (ControlFlow 0 24) 3) anon16_Then_correct)) (=> (= (ControlFlow 0 24) 15) anon16_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is SeqType |es#0@@6| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@9| (TMap (TSeq TChar) TInt))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 25) 24))) anon0_correct))))
