...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@0| T@U) (|e#0@@2| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| |st#0@@0| |e#0@@2|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@0| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@2| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@0|) (=> (Equiv.__default.Inv |st#0@@0|) (and (Equiv.MState.MState_q |st#0@@0|) (|Interp.__default.InterpExpr#canCall| |e#0@@2| (Equiv.MState.ctx |st#0@@0|))))) (= (Equiv.__default.P__Fail |st#0@@0| |e#0@@2|)  (=> (Equiv.__default.Inv |st#0@@0|) (Utils.Result.Failure_q (Interp.__default.InterpExpr ($LS $LZ) |e#0@@2| (Equiv.MState.ctx |st#0@@0|)))))))
 :qid |Inductiondfy.36:26|
 :skolemid |706|
 :pattern ( (Equiv.__default.P__Fail |st#0@@0| |e#0@@2|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|es#0@@1| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Fail#canCall| |st#0@@1| |es#0@@1|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@1| Tclass.Equiv.MState) ($Is SeqType |es#0@@1| (TSeq Tclass.AST.Expr))))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@1|) (=> (Equiv.__default.Inv |st#0@@1|) (and (Equiv.MState.MState_q |st#0@@1|) (|Interp.__default.InterpExprs#canCall| |es#0@@1| (Equiv.MState.ctx |st#0@@1|))))) (= (Equiv.__default.Pes__Fail |st#0@@1| |es#0@@1|)  (=> (Equiv.__default.Inv |st#0@@1|) (Utils.Result.Failure_q (Interp.__default.InterpExprs ($LS $LZ) |es#0@@1| (Equiv.MState.ctx |st#0@@1|)))))))
 :qid |Inductiondfy.41:28|
 :skolemid |732|
 :pattern ( (Equiv.__default.Pes__Fail |st#0@@1| |es#0@@1|))
))))
...
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@3|)))
 (and (AST.Expr__Raw.All $ly@@1 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@1 |oe2#0| |p#0|)))) (let ((|es#0@@2| (AST.Expr__Raw.es |e#0@@3|)))
...
(assert (forall (($ly@@2 T@U) (|es#0@@3| T@U) (|ctx#0@@1| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@3| |ctx#0@@1|) (and ($Is SeqType |es#0@@3| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@1| (TMap (TSeq TChar) TInt)))) (and (=> (Utils.Result.Success_q (Interp.__default.InterpExprs $ly@@2 |es#0@@3| |ctx#0@@1|)) (= (|Seq#Length| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs $ly@@2 |es#0@@3| |ctx#0@@1|)))))) (|Seq#Length| |es#0@@3|))) ($Is DatatypeTypeType (Interp.__default.InterpExprs $ly@@2 |es#0@@3| |ctx#0@@1|) (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))
 :qid |Interpdfy.69:12|
 :skolemid |1205|
 :pattern ( (Interp.__default.InterpExprs $ly@@2 |es#0@@3| |ctx#0@@1|))
)))
...
(assert (forall (($ly@@6 T@U) (|es#0@@4| T@U) (|ctx#0@@5| T@U) ) (! (= (Interp.__default.InterpExprs ($LS $ly@@6) |es#0@@4| |ctx#0@@5|) (Interp.__default.InterpExprs $ly@@6 |es#0@@4| |ctx#0@@5|))
 :qid |Interpdfy.69:12|
 :skolemid |1203|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@6) |es#0@@4| |ctx#0@@5|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|e#0@@8| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| |st#0@@3| (Lit DatatypeTypeType |e#0@@8|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@3| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@3|) (=> (Equiv.__default.Inv |st#0@@3|) (and (Equiv.MState.MState_q |st#0@@3|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@8|) (Equiv.MState.ctx |st#0@@3|))))) (= (Equiv.__default.P__Fail |st#0@@3| (Lit DatatypeTypeType |e#0@@8|))  (=> (Equiv.__default.Inv |st#0@@3|) (Utils.Result.Failure_q (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@8|) (Equiv.MState.ctx |st#0@@3|)))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |707|
 :pattern ( (Equiv.__default.P__Fail |st#0@@3| (Lit DatatypeTypeType |e#0@@8|)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|ctx#0@@6| T@U) (|ctx'#0@@0| T@U) ) (!  (=> (or (|Equiv.__default.EqCtx#canCall| |ctx#0@@6| |ctx'#0@@0|) (and (< 0 $FunctionContextHeight) (and ($Is MapType |ctx#0@@6| (TMap (TSeq TChar) TInt)) ($Is MapType |ctx'#0@@0| (TMap (TSeq TChar) TInt))))) (= (Equiv.__default.EqCtx true |ctx#0@@6| |ctx'#0@@0|)  (and (|Set#Equal| (|Map#Domain| |ctx#0@@6|) (|Map#Domain| |ctx'#0@@0|)) (forall ((|x#0@@0| T@U) ) (!  (=> (and ($Is SeqType |x#0@@0| (TSeq TChar)) (|Set#IsMember| (|Map#Domain| |ctx#0@@6|) ($Box SeqType |x#0@@0|))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@6|) ($Box SeqType |x#0@@0|)))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx'#0@@0|) ($Box SeqType |x#0@@0|))))))
 :qid |Equivdfy.30:15|
 :skolemid |656|
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx'#0@@0|) ($Box SeqType |x#0@@0|))))
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@6|) ($Box SeqType |x#0@@0|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| |ctx#0@@6|) ($Box SeqType |x#0@@0|)))
)))))
 :qid |Equivdfy.27:35|
 :skolemid |657|
...
(assert (forall (($ly@@9 T@U) (|es#0@@5| T@U) (|ctx#0@@7| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@5| |ctx#0@@7|) (and ($Is SeqType |es#0@@5| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@7| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@5| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@5| (LitInt 0))) |ctx#0@@7|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@9 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@5| (LitInt 0))) |ctx#0@@7|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@9) |es#0@@5| |ctx#0@@7|) (ite (|Seq#Equal| |es#0@@5| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@7|)))) (let ((|valueOrError0#0@@1| (Interp.__default.InterpExpr $ly@@9 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@5| (LitInt 0))) |ctx#0@@7|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0|))) |vs#0@@0|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1207|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@9) |es#0@@5| |ctx#0@@7|))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|es#0@@6| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Fail#canCall| |st#0@@4| (Lit SeqType |es#0@@6|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@4| Tclass.Equiv.MState) ($Is SeqType |es#0@@6| (TSeq Tclass.AST.Expr))))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@4|) (=> (Equiv.__default.Inv |st#0@@4|) (and (Equiv.MState.MState_q |st#0@@4|) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@6|) (Equiv.MState.ctx |st#0@@4|))))) (= (Equiv.__default.Pes__Fail |st#0@@4| (Lit SeqType |es#0@@6|))  (=> (Equiv.__default.Inv |st#0@@4|) (Utils.Result.Failure_q (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@6|) (Equiv.MState.ctx |st#0@@4|)))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |733|
 :pattern ( (Equiv.__default.Pes__Fail |st#0@@4| (Lit SeqType |es#0@@6|)))
))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#1|))) |vs#1@@0|)) ($Box MapType |ctx2#1@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |1208|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@10) (Lit SeqType |es#0@@7|) |ctx#0@@8|))
)))
...
(assert (forall (($ly@@11 T@U) (|e#0@@10| T@U) (|ctx#0@@9| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@10|) (Lit MapType |ctx#0@@9|)) (and ($Is DatatypeTypeType |e#0@@10| Tclass.AST.Expr) ($Is MapType |ctx#0@@9| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@10|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@10|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@10|))))) (let ((|body#5| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@10|)))))
...
(let ((|bvars#5| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@10|)))))
 (and (|Interp.__default.InterpExprs#canCall| |bvals#5| (Lit MapType |ctx#0@@9|)) (let ((|valueOrError0#5| (Interp.__default.InterpExprs ($LS $ly@@11) |bvals#5| (Lit MapType |ctx#0@@9|))))
...
(let ((|avars#5| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@10|)))))
 (and (|Interp.__default.InterpExprs#canCall| |avals#5| (Lit MapType |ctx#0@@9|)) (let ((|valueOrError2#5| (Interp.__default.InterpExprs ($LS $ly@@11) |avals#5| (Lit MapType |ctx#0@@9|))))
...
(let ((|cond#5| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@10|)))))
 (and (|Interp.__default.InterpExpr#canCall| |cond#5| (Lit MapType |ctx#0@@9|)) (let ((|valueOrError3#5| (Interp.__default.InterpExpr ($LS $ly@@11) |cond#5| (Lit MapType |ctx#0@@9|))))
...
(let ((|op#5| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@10|)))))
 (and (|Interp.__default.InterpExpr#canCall| |e1#5| (Lit MapType |ctx#0@@9|)) (let ((|valueOrError4#5| (Interp.__default.InterpExpr ($LS $ly@@11) |e1#5| (Lit MapType |ctx#0@@9|))))
...
(Lit DatatypeTypeType (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#4|)) ($Box MapType (Lit MapType |ctx#0@@9|)))))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@10|)) (let ((|body#4| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@10|)))))
...
(let ((|valueOrError0#4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $ly@@11) |bvals#4| (Lit MapType |ctx#0@@9|)))))
...
(let ((|valueOrError2#4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $ly@@11) |avals#4| (Lit MapType |ctx#0@@9|)))))
...
(let ((|valueOrError3#4| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $ly@@11) |cond#4| (Lit MapType |ctx#0@@9|)))))
...
(let ((|valueOrError4#4| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $ly@@11) |e1#4| (Lit MapType |ctx#0@@9|)))))
...
(let ((|valueOrError6#4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $ly@@11) |es#4| (Lit MapType |ctx#0@@9|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1202|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@11) (Lit DatatypeTypeType |e#0@@10|) (Lit MapType |ctx#0@@9|)))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|e#0@@11| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| (Lit DatatypeTypeType |st#0@@5|) (Lit DatatypeTypeType |e#0@@11|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@5| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@11| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@5|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@5|))))) (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@5|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@11|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@5|))))))) (= (Equiv.__default.P__Fail (Lit DatatypeTypeType |st#0@@5|) (Lit DatatypeTypeType |e#0@@11|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@5|)) (Utils.Result.Failure_q (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@11|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@5|)))))))))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |708|
 :pattern ( (Equiv.__default.P__Fail (Lit DatatypeTypeType |st#0@@5|) (Lit DatatypeTypeType |e#0@@11|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|es#0@@8| T@U) ) (!  (=> (or (|Equiv.__default.Pes__Fail#canCall| (Lit DatatypeTypeType |st#0@@6|) (Lit SeqType |es#0@@8|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.Equiv.MState) ($Is SeqType |es#0@@8| (TSeq Tclass.AST.Expr))))) (and (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@6|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@6|))))) (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@6|)) (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@8|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@6|))))))) (= (Equiv.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@6|) (Lit SeqType |es#0@@8|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@6|)) (Utils.Result.Failure_q (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $LZ) (Lit SeqType |es#0@@8|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@6|)))))))))))))
 :qid |Inductiondfy.41:28|
 :weight 3
 :skolemid |734|
 :pattern ( (Equiv.__default.Pes__Fail (Lit DatatypeTypeType |st#0@@6|) (Lit SeqType |es#0@@8|)))
))))
(assert (forall (($ly@@13 T@U) (|e#0@@12| T@U) (|ctx#0@@10| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@12|) |ctx#0@@10|) (and ($Is DatatypeTypeType |e#0@@12| Tclass.AST.Expr) ($Is MapType |ctx#0@@10| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@12|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@12|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@12|))))) (let ((|body#3| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@12|)))))
...
(let ((|bvars#3| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@12|)))))
 (and (|Interp.__default.InterpExprs#canCall| |bvals#3| |ctx#0@@10|) (let ((|valueOrError0#3| (Interp.__default.InterpExprs ($LS $ly@@13) |bvals#3| |ctx#0@@10|)))
...
(let ((|avars#3| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@12|)))))
 (and (|Interp.__default.InterpExprs#canCall| |avals#3| |ctx#0@@10|) (let ((|valueOrError2#3| (Interp.__default.InterpExprs ($LS $ly@@13) |avals#3| |ctx#0@@10|)))
...
(let ((|cond#3| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@12|)))))
 (and (|Interp.__default.InterpExpr#canCall| |cond#3| |ctx#0@@10|) (let ((|valueOrError3#3| (Interp.__default.InterpExpr ($LS $ly@@13) |cond#3| |ctx#0@@10|)))
...
(let ((|op#3| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@12|)))))
 (and (|Interp.__default.InterpExpr#canCall| |e1#3| |ctx#0@@10|) (let ((|valueOrError4#3| (Interp.__default.InterpExpr ($LS $ly@@13) |e1#3| |ctx#0@@10|)))
...
(|Interp.__default.InterpBinOp#canCall| |op#3| |v1#3| |v2#3|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@12|)))))) (let ((|es#3| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@12|)))))
 (and (|Interp.__default.InterpExprs#canCall| |es#3| |ctx#0@@10|) (let ((|valueOrError6#3| (Interp.__default.InterpExprs ($LS $ly@@13) |es#3| |ctx#0@@10|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#3|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@13) (Lit DatatypeTypeType |e#0@@12|) |ctx#0@@10|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@12|)) (let ((|name#2| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@12|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#2|)) ($Box MapType |ctx#0@@10|))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@12|)) (let ((|body#2| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@12|)))))
...
(let ((|valueOrError0#2@@1| (Interp.__default.InterpExprs ($LS $ly@@13) |bvals#2@@0| |ctx#0@@10|)))
...
(let ((|valueOrError2#2| (Interp.__default.InterpExprs ($LS $ly@@13) |avals#2@@0| |ctx#0@@10|)))
...
(let ((|valueOrError3#2| (Interp.__default.InterpExpr ($LS $ly@@13) |cond#2| |ctx#0@@10|)))
...
(let ((|valueOrError4#2| (Interp.__default.InterpExpr ($LS $ly@@13) |e1#2| |ctx#0@@10|)))
...
(let ((|valueOrError6#2| (Interp.__default.InterpExprs ($LS $ly@@13) |es#2| |ctx#0@@10|)))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1201|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@13) (Lit DatatypeTypeType |e#0@@12|) |ctx#0@@10|))
)))
...
(set-info :boogie-vc-id Impl$$Equiv.__default.InductSeq__Fail)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (= (ControlFlow 0 2) (- 0 1))) (not (Equiv.__default.Pes__Fail |st#0@@7| |es#0@@9|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and (and ($Is DatatypeTypeType |st#0@@7| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st#0@@7| Tclass.Equiv.MState $Heap@@6)) (|$IsA#Equiv.MState| |st#0@@7|)) (and (and ($Is DatatypeTypeType |e#0@@16| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@16| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@16|))) (and (and (and ($Is SeqType |es#0@@9| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |es#0@@9| (TSeq Tclass.AST.Expr) $Heap@@6)) (= 3 $FunctionContextHeight)) (and (and (AST.Expr__Raw.Seq_q |e#0@@16|) (|Seq#Equal| (AST.Expr__Raw.es |e#0@@16|) |es#0@@9|)) (and (not (Equiv.__default.P__Fail |st#0@@7| |e#0@@16|)) (= (ControlFlow 0 3) 2))))) anon0_correct))))
