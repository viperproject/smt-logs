...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@0| T@U) (|e#0@@2| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P__Fail#canCall| (Lit MapType |st#0@@0|) (Lit DatatypeTypeType |e#0@@2|)) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@0| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@2| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| (Lit DatatypeTypeType |e#0@@2|)) (let ((|e'#2| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@2|)))))
 (and (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@2|) (Lit MapType |st#0@@0|)) (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@2|) (Lit MapType |st#0@@0|)))))
...
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#2| |res'#2|))))))) (= (EliminateMulZero.__default.P__Fail (Lit MapType |st#0@@0|) (Lit DatatypeTypeType |e#0@@2|)) (U_2_bool (let ((|e'#2@@0| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@2|)))))
(let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@2|) (Lit MapType |st#0@@0|)))))
...
(Lit boolType (bool_2_U  (and (EliminateMulZero.__default.EqResult TInt |res#2@@0| |res'#2@@0|) (Utils.Result.Failure_q |res#2@@0|)))))))))))
 ...
 :weight 3
 :skolemid |711|
 :pattern ( (EliminateMulZero.__default.P__Fail (Lit MapType |st#0@@0|) (Lit DatatypeTypeType |e#0@@2|)))
))))
...
(let ((|cond#1@@0| (AST.Expr__Raw.cond |e#0@@4|)))
 (and (|AST.Expr__Raw.All#canCall| |cond#1@@0| |p#0|) (=> (AST.Expr__Raw.All $ly@@5 |cond#1@@0| |p#0|) (and (|AST.Expr__Raw.All#canCall| |thn#1@@0| |p#0|) (=> (AST.Expr__Raw.All $ly@@5 |thn#1@@0| |p#0|) (|AST.Expr__Raw.All#canCall| |els#1@@0| |p#0|))))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@4|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@4|) (let ((|oe2#1| (AST.Expr__Raw.oe2 |e#0@@4|)))
(let ((|oe1#1| (AST.Expr__Raw.oe1 |e#0@@4|)))
 (and (|AST.Expr__Raw.All#canCall| |oe1#1| |p#0|) (=> (AST.Expr__Raw.All $ly@@5 |oe1#1| |p#0|) (|AST.Expr__Raw.All#canCall| |oe2#1| |p#0|)))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@4|)) (let ((|es#1@@0| (AST.Expr__Raw.es |e#0@@4|)))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@5) |e#0@@4| |p#0|)  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@1 |p#0| ($Box DatatypeTypeType |e#0@@4|)))) (ite (AST.Expr__Raw.Var_q |e#0@@4|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q |e#0@@4|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q |e#0@@4|) (let ((|body#0@@0| (AST.Expr__Raw.body |e#0@@4|)))
...
)) (AST.Expr__Raw.All $ly@@5 |body#0@@0| |p#0|)))) (ite (AST.Expr__Raw.Assign_q |e#0@@4|) (let ((|avals#0@@1| (AST.Expr__Raw.avals |e#0@@4|)))
...
(let ((|cond#0@@0| (AST.Expr__Raw.cond |e#0@@4|)))
 (and (and (AST.Expr__Raw.All $ly@@5 |cond#0@@0| |p#0|) (AST.Expr__Raw.All $ly@@5 |thn#0@@0| |p#0|)) (AST.Expr__Raw.All $ly@@5 |els#0@@0| |p#0|))))) (ite (AST.Expr__Raw.Op_q |e#0@@4|) (let ((|oe2#0| (AST.Expr__Raw.oe2 |e#0@@4|)))
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@4|)))
 (and (AST.Expr__Raw.All $ly@@5 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@5 |oe2#0| |p#0|)))) (let ((|es#0@@5| (AST.Expr__Raw.es |e#0@@4|)))
 ...
 :qid |ASTdfy.44:22|
 :skolemid |1073|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@5) |e#0@@4| |p#0|) ($IsGoodHeap $Heap@@1))
)))
...
(assert (forall (($ly@@6 T@U) (|e#0@@5| T@U) (|locals#0@@1| T@U) ) (!  (=> (or (|Pure.__default.IsPure#canCall| |e#0@@5| |locals#0@@1|) (and ($Is DatatypeTypeType |e#0@@5| Tclass.AST.Expr) ($Is SetType |locals#0@@1| (TSet (TSeq TChar))))) (and (=> (not (AST.Expr__Raw.Var_q |e#0@@5|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@5|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@5|) (let ((|body#1@@1| (AST.Expr__Raw.body |e#0@@5|)))
(let ((|bvals#1@@1| (AST.Expr__Raw.bvals |e#0@@5|)))
(let ((|bvars#1@@0| (AST.Expr__Raw.bvars |e#0@@5|)))
 (and (|Pure.__default.IsPure__Es#canCall| |bvals#1@@1| |locals#0@@1|) (=> (Pure.__default.IsPure__Es $ly@@6 |bvals#1@@1| |locals#0@@1|) (|Pure.__default.IsPure#canCall| |body#1@@1| (|Set#Union| (|Set#FromBoogieMap| (|lambda#6| (TSeq TChar) |bvars#1@@0|)) |locals#0@@1|)))))))) (=> (not (AST.Expr__Raw.Bind_q |e#0@@5|)) (and (=> (AST.Expr__Raw.Assign_q |e#0@@5|) (let ((|avals#1@@1| (AST.Expr__Raw.avals |e#0@@5|)))
(let ((|avars#1@@0| (AST.Expr__Raw.avars |e#0@@5|)))
...
)) (|Pure.__default.IsPure__Es#canCall| |avals#1@@1| |locals#0@@1|))))) (=> (not (AST.Expr__Raw.Assign_q |e#0@@5|)) (and (=> (AST.Expr__Raw.If_q |e#0@@5|) (let ((|els#1@@1| (AST.Expr__Raw.els |e#0@@5|)))
(let ((|thn#1@@1| (AST.Expr__Raw.thn |e#0@@5|)))
(let ((|cond#1@@1| (AST.Expr__Raw.cond |e#0@@5|)))
 (and (|Pure.__default.IsPure#canCall| |cond#1@@1| |locals#0@@1|) (=> (Pure.__default.IsPure $ly@@6 |cond#1@@1| |locals#0@@1|) (and (|Pure.__default.IsPure#canCall| |thn#1@@1| |locals#0@@1|) (=> (Pure.__default.IsPure $ly@@6 |thn#1@@1| |locals#0@@1|) (|Pure.__default.IsPure#canCall| |els#1@@1| |locals#0@@1|))))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@5|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@5|) (let ((|oe2#1@@0| (AST.Expr__Raw.oe2 |e#0@@5|)))
(let ((|oe1#1@@0| (AST.Expr__Raw.oe1 |e#0@@5|)))
 (and (|Pure.__default.IsPure#canCall| |oe1#1@@0| |locals#0@@1|) (=> (Pure.__default.IsPure $ly@@6 |oe1#1@@0| |locals#0@@1|) (|Pure.__default.IsPure#canCall| |oe2#1@@0| |locals#0@@1|)))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@5|)) (let ((|es#1@@1| (AST.Expr__Raw.es |e#0@@5|)))
(|Pure.__default.IsPure__Es#canCall| |es#1@@1| |locals#0@@1|)))))))))))) (= (Pure.__default.IsPure ($LS $ly@@6) |e#0@@5| |locals#0@@1|) (ite (AST.Expr__Raw.Var_q |e#0@@5|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q |e#0@@5|) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q |e#0@@5|) (let ((|body#0@@1| (AST.Expr__Raw.body |e#0@@5|)))
(let ((|bvals#0@@2| (AST.Expr__Raw.bvals |e#0@@5|)))
(let ((|bvars#0@@1| (AST.Expr__Raw.bvars |e#0@@5|)))
 (and (Pure.__default.IsPure__Es $ly@@6 |bvals#0@@2| |locals#0@@1|) (Pure.__default.IsPure $ly@@6 |body#0@@1| (|Set#Union| (|Set#FromBoogieMap| (|lambda#6| (TSeq TChar) |bvars#0@@1|)) |locals#0@@1|)))))) (ite (AST.Expr__Raw.Assign_q |e#0@@5|) (let ((|avals#0@@2| (AST.Expr__Raw.avals |e#0@@5|)))
(let ((|avars#0@@1| (AST.Expr__Raw.avars |e#0@@5|)))
...
)) (Pure.__default.IsPure__Es $ly@@6 |avals#0@@2| |locals#0@@1|)))) (ite (AST.Expr__Raw.If_q |e#0@@5|) (let ((|els#0@@1| (AST.Expr__Raw.els |e#0@@5|)))
(let ((|thn#0@@1| (AST.Expr__Raw.thn |e#0@@5|)))
(let ((|cond#0@@1| (AST.Expr__Raw.cond |e#0@@5|)))
 (and (and (Pure.__default.IsPure $ly@@6 |cond#0@@1| |locals#0@@1|) (Pure.__default.IsPure $ly@@6 |thn#0@@1| |locals#0@@1|)) (Pure.__default.IsPure $ly@@6 |els#0@@1| |locals#0@@1|))))) (ite (AST.Expr__Raw.Op_q |e#0@@5|) (let ((|oe2#0@@0| (AST.Expr__Raw.oe2 |e#0@@5|)))
(let ((|oe1#0@@0| (AST.Expr__Raw.oe1 |e#0@@5|)))
 (and (Pure.__default.IsPure $ly@@6 |oe1#0@@0| |locals#0@@1|) (Pure.__default.IsPure $ly@@6 |oe2#0@@0| |locals#0@@1|)))) (let ((|es#0@@6| (AST.Expr__Raw.es |e#0@@5|)))
(Pure.__default.IsPure__Es $ly@@6 |es#0@@6| |locals#0@@1|)))))))))))
 :qid |Puredfy.15:13|
 :skolemid |1145|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@6) |e#0@@5| |locals#0@@1|))
)))
...
(assert (forall (($ly@@8 T@U) (|e#0@@6| T@U) (|p#0@@0| T@U) ) (! (= (AST.Expr__Raw.All ($LS $ly@@8) |e#0@@6| |p#0@@0|) (AST.Expr__Raw.All $ly@@8 |e#0@@6| |p#0@@0|))
 :qid |ASTdfy.44:22|
 :skolemid |1062|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@8) |e#0@@6| |p#0@@0|))
)))
(assert (forall (($ly@@9 T@U) (|e#0@@7| T@U) (|locals#0@@2| T@U) ) (! (= (Pure.__default.IsPure ($LS $ly@@9) |e#0@@7| |locals#0@@2|) (Pure.__default.IsPure $ly@@9 |e#0@@7| |locals#0@@2|))
 :qid |Puredfy.15:13|
 :skolemid |1139|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@9) |e#0@@7| |locals#0@@2|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|e#0@@9| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P__Fail#canCall| |st#0@@1| |e#0@@9|) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@1| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@9| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| |e#0@@9|) (let ((|e'#0@@0| (EliminateMulZero.__default.Eliminate ($LS $LZ) |e#0@@9|)))
 (and (|Interp.__default.InterpExpr#canCall| |e#0@@9| |st#0@@1|) (let ((|res#0| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@9| |st#0@@1|)))
 (and (|Interp.__default.InterpExpr#canCall| |e'#0@@0| |st#0@@1|) (let ((|res'#0| (Interp.__default.InterpExpr ($LS $LZ) |e'#0@@0| |st#0@@1|)))
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#0| |res'#0|))))))) (= (EliminateMulZero.__default.P__Fail |st#0@@1| |e#0@@9|) (let ((|e'#0@@1| (EliminateMulZero.__default.Eliminate ($LS $LZ) |e#0@@9|)))
(let ((|res#0@@0| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@9| |st#0@@1|)))
(let ((|res'#0@@0| (Interp.__default.InterpExpr ($LS $LZ) |e'#0@@1| |st#0@@1|)))
 ...
 :qid |Inductiondfy.36:26|
 :skolemid |709|
 :pattern ( (EliminateMulZero.__default.P__Fail |st#0@@1| |e#0@@9|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|e#0@@10| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P#canCall| (Lit MapType |st#0@@2|) (Lit DatatypeTypeType |e#0@@10|)) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@2| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@10| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| (Lit DatatypeTypeType |e#0@@10|)) (let ((|e'#2@@1| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@10|)))))
 (and (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@10|) (Lit MapType |st#0@@2|)) (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@10|) (Lit MapType |st#0@@2|)))))
 (and (|Interp.__default.InterpExpr#canCall| |e'#2@@1| (Lit MapType |st#0@@2|)) (let ((|res'#2@@1| (Interp.__default.InterpExpr ($LS $LZ) |e'#2@@1| (Lit MapType |st#0@@2|))))
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#2@@1| |res'#2@@1|))))))) (= (EliminateMulZero.__default.P (Lit MapType |st#0@@2|) (Lit DatatypeTypeType |e#0@@10|)) (U_2_bool (let ((|e'#2@@2| (Lit DatatypeTypeType (EliminateMulZero.__default.Eliminate ($LS $LZ) (Lit DatatypeTypeType |e#0@@10|)))))
(let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@10|) (Lit MapType |st#0@@2|)))))
(let ((|res'#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) |e'#2@@2| (Lit MapType |st#0@@2|)))))
...
(assert (forall (($ly@@17 T@U) (|e#0@@13| T@U) (|locals#0@@4| T@U) ) (!  (=> (or (|Pure.__default.IsPure#canCall| (Lit DatatypeTypeType |e#0@@13|) |locals#0@@4|) (and ($Is DatatypeTypeType |e#0@@13| Tclass.AST.Expr) ($Is SetType |locals#0@@4| (TSet (TSeq TChar))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@13|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@13|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@13|))))) (let ((|body#3| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|bvals#3| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|bvars#3| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@13|)))))
 (and (|Pure.__default.IsPure__Es#canCall| |bvals#3| |locals#0@@4|) (=> (Pure.__default.IsPure__Es ($LS $ly@@17) |bvals#3| |locals#0@@4|) (|Pure.__default.IsPure#canCall| |body#3| (|Set#Union| (|Set#FromBoogieMap| (|lambda#6| (TSeq TChar) |bvars#3|)) |locals#0@@4|)))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@13|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@13|))))) (let ((|avals#3| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|avars#3| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@13|)))))
...
)) (|Pure.__default.IsPure__Es#canCall| |avals#3| |locals#0@@4|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@13|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@13|))))) (let ((|els#3| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|thn#3| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|cond#3| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@13|)))))
 (and (|Pure.__default.IsPure#canCall| |cond#3| |locals#0@@4|) (=> (Pure.__default.IsPure ($LS $ly@@17) |cond#3| |locals#0@@4|) (and (|Pure.__default.IsPure#canCall| |thn#3| |locals#0@@4|) (=> (Pure.__default.IsPure ($LS $ly@@17) |thn#3| |locals#0@@4|) (|Pure.__default.IsPure#canCall| |els#3| |locals#0@@4|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@13|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@13|))))) (let ((|oe2#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|oe1#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@13|)))))
 (and (|Pure.__default.IsPure#canCall| |oe1#3| |locals#0@@4|) (=> (Pure.__default.IsPure ($LS $ly@@17) |oe1#3| |locals#0@@4|) (|Pure.__default.IsPure#canCall| |oe2#3| |locals#0@@4|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@13|)))))) (let ((|es#3| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@13|)))))
(|Pure.__default.IsPure__Es#canCall| |es#3| |locals#0@@4|)))))))))))) (= (Pure.__default.IsPure ($LS $ly@@17) (Lit DatatypeTypeType |e#0@@13|) |locals#0@@4|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@13|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@13|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@13|)) (let ((|body#2| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|bvals#2@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|bvars#2@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@13|)))))
 (and (Pure.__default.IsPure__Es ($LS $ly@@17) |bvals#2@@0| |locals#0@@4|) (Pure.__default.IsPure ($LS $ly@@17) |body#2| (|Set#Union| (|Set#FromBoogieMap| (|lambda#6| (TSeq TChar) |bvars#2@@0|)) |locals#0@@4|)))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@13|)) (let ((|avals#2@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|avars#2@@0| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@13|)))))
...
)) (Pure.__default.IsPure__Es ($LS $ly@@17) |avals#2@@0| |locals#0@@4|)))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@13|)) (let ((|els#2| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|thn#2| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|cond#2| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@13|)))))
 (and (and (Pure.__default.IsPure ($LS $ly@@17) |cond#2| |locals#0@@4|) (Pure.__default.IsPure ($LS $ly@@17) |thn#2| |locals#0@@4|)) (Pure.__default.IsPure ($LS $ly@@17) |els#2| |locals#0@@4|))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@13|)) (let ((|oe2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@13|)))))
(let ((|oe1#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@13|)))))
 (and (Pure.__default.IsPure ($LS $ly@@17) |oe1#2| |locals#0@@4|) (Pure.__default.IsPure ($LS $ly@@17) |oe2#2| |locals#0@@4|)))) (let ((|es#2| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@13|)))))
(Pure.__default.IsPure__Es ($LS $ly@@17) |es#2| |locals#0@@4|)))))))))))
 :qid |Puredfy.15:13|
 :weight 3
 :skolemid |1148|
 :pattern ( (Pure.__default.IsPure ($LS $ly@@17) (Lit DatatypeTypeType |e#0@@13|) |locals#0@@4|))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@18 T@U) (|e#0@@14| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Eliminate#canCall| (Lit DatatypeTypeType |e#0@@14|)) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |e#0@@14| Tclass.AST.Expr))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@14|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@14|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@14|))))) (let ((|body#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|bvals#3@@0| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@14|)))))
 (and (|EliminateMulZero.__default.Eliminate__Es#canCall| |bvals#3@@0|) (|EliminateMulZero.__default.Eliminate#canCall| |body#3@@0|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@14|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@14|))))) (let ((|avals#3@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@14|)))))
(|EliminateMulZero.__default.Eliminate__Es#canCall| |avals#3@@0|))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@14|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@14|))))) (let ((|els#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|thn#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|cond#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@14|)))))
 (and (|EliminateMulZero.__default.Eliminate#canCall| |cond#3@@0|) (and (|EliminateMulZero.__default.Eliminate#canCall| |thn#3@@0|) (|EliminateMulZero.__default.Eliminate#canCall| |els#3@@0|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@14|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@14|))))) (let ((|oe2#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@14|)))))
...
(let ((|op#3| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@14|)))))
 ...
 (=> (AST.BinOp.Mul_q |op#3|) (and (|EliminateMulZero.__default.IsZeroMulPure#canCall| |oe1'#3| |oe2'#3|) (=> (not (EliminateMulZero.__default.IsZeroMulPure |oe1'#3| |oe2'#3|)) (|EliminateMulZero.__default.IsZeroMulPure#canCall| |oe2'#3| |oe1'#3|)))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@14|)))))) (let ((|es#3@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@14|)))))
(|EliminateMulZero.__default.Eliminate__Es#canCall| |es#3@@0|)))))))))))) (= (EliminateMulZero.__default.Eliminate ($LS $ly@@18) (Lit DatatypeTypeType |e#0@@14|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@14|)) (Lit DatatypeTypeType |e#0@@14|) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@14|)) (Lit DatatypeTypeType |e#0@@14|) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@14|)) (let ((|body#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|bvals#2@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|bvars#2@@1| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@14|)))))
...
(Lit DatatypeTypeType (|#AST.Expr_Raw.Bind| |bvars#2@@1| |bvals'#2| |body'#2|))))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@14|)) (let ((|avals#2@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|avars#2@@1| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|avals'#2| (Lit SeqType (EliminateMulZero.__default.Eliminate__Es ($LS $ly@@18) |avals#2@@1|))))
(Lit DatatypeTypeType (|#AST.Expr_Raw.Assign| |avars#2@@1| |avals'#2|))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@14|)) (let ((|els#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|thn#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@14|)))))
(let ((|cond#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@14|)))))
...
(Lit DatatypeTypeType (|#AST.Expr_Raw.If| |cond'#2| |thn'#2| |els'#2|)))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@14|)) (let ((|oe2#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@14|)))))
...
(ite  (and (AST.BinOp.Mul_q |op#2|) (or (EliminateMulZero.__default.IsZeroMulPure |oe1'#2| |oe2'#2|) (EliminateMulZero.__default.IsZeroMulPure |oe2'#2| |oe1'#2|))) EliminateMulZero.__default.ZeroExpr (|#AST.Expr_Raw.Op| |op#2| |oe1'#2| |oe2'#2|))))))) (let ((|es#2@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@14|)))))
...
(Lit DatatypeTypeType (|#AST.Expr_Raw.Seq| |es'#2|)))))))))))))
 ...
 :weight 3
 :skolemid |650|
 :pattern ( (EliminateMulZero.__default.Eliminate ($LS $ly@@18) (Lit DatatypeTypeType |e#0@@14|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@19 T@U) (|e#0@@15| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Eliminate#canCall| |e#0@@15|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr))) ($Is DatatypeTypeType (EliminateMulZero.__default.Eliminate $ly@@19 |e#0@@15|) Tclass.AST.Expr))
 :qid |EliminateMulZerodfy.32:12|
 :skolemid |647|
 :pattern ( (EliminateMulZero.__default.Eliminate $ly@@19 |e#0@@15|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@21 T@U) (|e#0@@16| T@U) ) (!  (=> (or (|EliminateMulZero.__default.Eliminate#canCall| |e#0@@16|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |e#0@@16| Tclass.AST.Expr))) (and (=> (not (AST.Expr__Raw.Var_q |e#0@@16|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@16|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@16|) (let ((|body#1@@2| (AST.Expr__Raw.body |e#0@@16|)))
(let ((|bvals#1@@2| (AST.Expr__Raw.bvals |e#0@@16|)))
 (and (|EliminateMulZero.__default.Eliminate__Es#canCall| |bvals#1@@2|) (|EliminateMulZero.__default.Eliminate#canCall| |body#1@@2|))))) (=> (not (AST.Expr__Raw.Bind_q |e#0@@16|)) (and (=> (AST.Expr__Raw.Assign_q |e#0@@16|) (let ((|avals#1@@2| (AST.Expr__Raw.avals |e#0@@16|)))
(|EliminateMulZero.__default.Eliminate__Es#canCall| |avals#1@@2|))) (=> (not (AST.Expr__Raw.Assign_q |e#0@@16|)) (and (=> (AST.Expr__Raw.If_q |e#0@@16|) (let ((|els#1@@2| (AST.Expr__Raw.els |e#0@@16|)))
(let ((|thn#1@@2| (AST.Expr__Raw.thn |e#0@@16|)))
(let ((|cond#1@@2| (AST.Expr__Raw.cond |e#0@@16|)))
 (and (|EliminateMulZero.__default.Eliminate#canCall| |cond#1@@2|) (and (|EliminateMulZero.__default.Eliminate#canCall| |thn#1@@2|) (|EliminateMulZero.__default.Eliminate#canCall| |els#1@@2|))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@16|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@16|) (let ((|oe2#1@@1| (AST.Expr__Raw.oe2 |e#0@@16|)))
(let ((|oe1#1@@1| (AST.Expr__Raw.oe1 |e#0@@16|)))
(let ((|op#1@@0| (AST.Expr__Raw.op |e#0@@16|)))
 ...
 (=> (AST.BinOp.Mul_q |op#1@@0|) (and (|EliminateMulZero.__default.IsZeroMulPure#canCall| |oe1'#1| |oe2'#1|) (=> (not (EliminateMulZero.__default.IsZeroMulPure |oe1'#1| |oe2'#1|)) (|EliminateMulZero.__default.IsZeroMulPure#canCall| |oe2'#1| |oe1'#1|)))))))))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@16|)) (let ((|es#1@@2| (AST.Expr__Raw.es |e#0@@16|)))
(|EliminateMulZero.__default.Eliminate__Es#canCall| |es#1@@2|)))))))))))) (= (EliminateMulZero.__default.Eliminate ($LS $ly@@21) |e#0@@16|) (ite (AST.Expr__Raw.Var_q |e#0@@16|) |e#0@@16| (ite (AST.Expr__Raw.Literal_q |e#0@@16|) |e#0@@16| (ite (AST.Expr__Raw.Bind_q |e#0@@16|) (let ((|body#0@@2| (AST.Expr__Raw.body |e#0@@16|)))
(let ((|bvals#0@@3| (AST.Expr__Raw.bvals |e#0@@16|)))
(let ((|bvars#0@@2| (AST.Expr__Raw.bvars |e#0@@16|)))
...
(|#AST.Expr_Raw.Bind| |bvars#0@@2| |bvals'#0| |body'#0|)))))) (ite (AST.Expr__Raw.Assign_q |e#0@@16|) (let ((|avals#0@@3| (AST.Expr__Raw.avals |e#0@@16|)))
(let ((|avars#0@@2| (AST.Expr__Raw.avars |e#0@@16|)))
(let ((|avals'#0| (EliminateMulZero.__default.Eliminate__Es $ly@@21 |avals#0@@3|)))
(|#AST.Expr_Raw.Assign| |avars#0@@2| |avals'#0|)))) (ite (AST.Expr__Raw.If_q |e#0@@16|) (let ((|els#0@@2| (AST.Expr__Raw.els |e#0@@16|)))
(let ((|thn#0@@2| (AST.Expr__Raw.thn |e#0@@16|)))
(let ((|cond#0@@2| (AST.Expr__Raw.cond |e#0@@16|)))
...
(|#AST.Expr_Raw.If| |cond'#0| |thn'#0| |els'#0|))))))) (ite (AST.Expr__Raw.Op_q |e#0@@16|) (let ((|oe2#0@@1| (AST.Expr__Raw.oe2 |e#0@@16|)))
(let ((|oe1#0@@1| (AST.Expr__Raw.oe1 |e#0@@16|)))
(let ((|op#0@@1| (AST.Expr__Raw.op |e#0@@16|)))
(let ((|oe1'#0| (EliminateMulZero.__default.Eliminate $ly@@21 |oe1#0@@1|)))
(let ((|oe2'#0| (EliminateMulZero.__default.Eliminate $ly@@21 |oe2#0@@1|)))
(ite  (and (AST.BinOp.Mul_q |op#0@@1|) (or (EliminateMulZero.__default.IsZeroMulPure |oe1'#0| |oe2'#0|) (EliminateMulZero.__default.IsZeroMulPure |oe2'#0| |oe1'#0|))) EliminateMulZero.__default.ZeroExpr (|#AST.Expr_Raw.Op| |op#0@@1| |oe1'#0| |oe2'#0|))))))) (let ((|es#0@@12| (AST.Expr__Raw.es |e#0@@16|)))
(let ((|es'#0@@0| (EliminateMulZero.__default.Eliminate__Es $ly@@21 |es#0@@12|)))
(|#AST.Expr_Raw.Seq| |es'#0@@0|))))))))))))
 :qid |EliminateMulZerodfy.32:12|
 :skolemid |649|
 :pattern ( (EliminateMulZero.__default.Eliminate ($LS $ly@@21) |e#0@@16|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|e#0@@17| T@U) ) (!  (=> (or (|EliminateMulZero.__default.P#canCall| |st#0@@3| |e#0@@17|) (and (< 3 $FunctionContextHeight) (and ($Is MapType |st#0@@3| (TMap (TSeq TChar) TInt)) ($Is DatatypeTypeType |e#0@@17| Tclass.AST.Expr)))) (and (and (|EliminateMulZero.__default.Eliminate#canCall| |e#0@@17|) (let ((|e'#0@@2| (EliminateMulZero.__default.Eliminate ($LS $LZ) |e#0@@17|)))
 (and (|Interp.__default.InterpExpr#canCall| |e#0@@17| |st#0@@3|) (let ((|res#0@@2| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@17| |st#0@@3|)))
 (and (|Interp.__default.InterpExpr#canCall| |e'#0@@2| |st#0@@3|) (let ((|res'#0@@2| (Interp.__default.InterpExpr ($LS $LZ) |e'#0@@2| |st#0@@3|)))
(|EliminateMulZero.__default.EqResult#canCall| TInt |res#0@@2| |res'#0@@2|))))))) (= (EliminateMulZero.__default.P |st#0@@3| |e#0@@17|) (let ((|e'#0@@3| (EliminateMulZero.__default.Eliminate ($LS $LZ) |e#0@@17|)))
(let ((|res#0@@3| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@17| |st#0@@3|)))
(let ((|res'#0@@3| (Interp.__default.InterpExpr ($LS $LZ) |e'#0@@3| |st#0@@3|)))
(EliminateMulZero.__default.EqResult TInt |res#0@@3| |res'#0@@3|)))))))
 :qid |Inductiondfy.34:21|
 :skolemid |691|
 :pattern ( (EliminateMulZero.__default.P |st#0@@3| |e#0@@17|))
))))
...
(set-info :boogie-vc-id Impl$$EliminateMulZero.__default.P__Satisfied)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (EliminateMulZero.__default.P |st#0@@5| |e#0@@27|)))))
(let ((anon3_Else_correct  (=> (not (EliminateMulZero.__default.P__Fail |st#0@@5| |e#0@@27|)) (=> (and (or (or (<= 0 (LitInt 3)) (< (DtRank |e#0@@27|) (DtRank |e#0@@27|))) (= (LitInt 2) (LitInt 3))) (or (< (DtRank |e#0@@27|) (DtRank |e#0@@27|)) (and (= (DtRank |e#0@@27|) (DtRank |e#0@@27|)) (< (LitInt 2) (LitInt 3))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (not (EliminateMulZero.__default.P__Fail |st#0@@5| |e#0@@27|))) (=> (not (EliminateMulZero.__default.P__Fail |st#0@@5| |e#0@@27|)) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (|EliminateMulZero.__default.P#canCall| |st#0@@5| |e#0@@27|) (EliminateMulZero.__default.P |st#0@@5| |e#0@@27|)) (and (= $Heap@@6 $Heap@1) (= (ControlFlow 0 5) 2))) GeneratedUnifiedExit_correct))))))))
(let ((anon3_Then_correct  (=> (EliminateMulZero.__default.P__Fail |st#0@@5| |e#0@@27|) (and (=> (= (ControlFlow 0 3) (- 0 4)) (EliminateMulZero.__default.P__Fail |st#0@@5| |e#0@@27|)) (=> (EliminateMulZero.__default.P__Fail |st#0@@5| |e#0@@27|) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (|EliminateMulZero.__default.P#canCall| |st#0@@5| |e#0@@27|)) (and (and (|EliminateMulZero.__default.P#canCall| |st#0@@5| |e#0@@27|) (and (EliminateMulZero.__default.P |st#0@@5| |e#0@@27|) (let ((|e'#0@@4| (EliminateMulZero.__default.Eliminate ($LS $LZ) |e#0@@27|)))
(let ((|res#0@@5| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@27| |st#0@@5|)))
(let ((|res'#0@@5| (Interp.__default.InterpExpr ($LS $LZ) |e'#0@@4| |st#0@@5|)))
(EliminateMulZero.__default.EqResult TInt |res#0@@5| |res'#0@@5|)))))) (and (= $Heap@@6 $Heap@0) (= (ControlFlow 0 3) 2)))) GeneratedUnifiedExit_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (=> (and (and ($IsAlloc MapType |st#0@@5| (TMap (TSeq TChar) TInt) $Heap@@6) ($IsAlloc DatatypeTypeType |e#0@@27| Tclass.AST.Expr $Heap@@6)) (and (|EliminateMulZero.__default.P__Fail#canCall| |st#0@@5| |e#0@@27|) (|EliminateMulZero.__default.P__Fail#canCall| |st#0@@5| |e#0@@27|))) (and (=> (= (ControlFlow 0 7) 3) anon3_Then_correct) (=> (= (ControlFlow 0 7) 5) anon3_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (and ($Is MapType |st#0@@5| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |st#0@@5| (TMap (TSeq TChar) TInt) $Heap@@6))) (=> (and (and (and ($Is DatatypeTypeType |e#0@@27| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@27| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@27|)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
