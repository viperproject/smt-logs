...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0| T@U) (|vars#0| T@U) (|vals#0| T@U) ) (!  (=> (or (|EliminateMulZero.__default.BindStartScope#canCall| |st#0| |vars#0| |vals#0|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is MapType |st#0| (TMap (TSeq TChar) TInt)) ($Is SeqType |vars#0| (TSeq (TSeq TChar)))) ($Is SeqType |vals#0| (TSeq TInt))) (EliminateMulZero.__default.UpdateState__Pre |st#0| |vars#0| |vals#0|)))) (and (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0| |vals#0|) (= (EliminateMulZero.__default.BindStartScope |st#0| |vars#0| |vals#0|) (let ((|ctx#0| |st#0|))
...
|st'#0|)))))))
 ...
 :skolemid |757|
 :pattern ( (EliminateMulZero.__default.BindStartScope |st#0| |vars#0| |vals#0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@2| T@U) (|vars#0@@4| T@U) (|vals#0@@0| T@U) ) (!  (=> (or (|EliminateMulZero.__default.BindStartScope#canCall| (Lit MapType |st#0@@2|) (Lit SeqType |vars#0@@4|) (Lit SeqType |vals#0@@0|)) (and (< 2 $FunctionContextHeight) (and (and (and ($Is MapType |st#0@@2| (TMap (TSeq TChar) TInt)) ($Is SeqType |vars#0@@4| (TSeq (TSeq TChar)))) ($Is SeqType |vals#0@@0| (TSeq TInt))) (U_2_bool (Lit boolType (bool_2_U (EliminateMulZero.__default.UpdateState__Pre (Lit MapType |st#0@@2|) (Lit SeqType |vars#0@@4|) (Lit SeqType |vals#0@@0|)))))))) (and (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@4|) (Lit SeqType |vals#0@@0|)) (= (EliminateMulZero.__default.BindStartScope (Lit MapType |st#0@@2|) (Lit SeqType |vars#0@@4|) (Lit SeqType |vals#0@@0|)) (let ((|ctx#2| (Lit MapType |st#0@@2|)))
...
|st'#2|)))))))
 ...
 :weight 3
 :skolemid |759|
 :pattern ( (EliminateMulZero.__default.BindStartScope (Lit MapType |st#0@@2|) (Lit SeqType |vars#0@@4|) (Lit SeqType |vals#0@@0|)))
))))
...
|st'#1|)))))))
 ...
 :weight 3
 :skolemid |758|
 :pattern ( (EliminateMulZero.__default.BindStartScope |st#0@@4| (Lit SeqType |vars#0@@8|) |vals#0@@2|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$EliminateMulZero.__default.BindStartScope)
