...
(set-info :boogie-vc-id Impl$$Equiv.__default.P__Satisfied)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> false (Equiv.__default.P |st#0@@7| |e#0@@19|)))))
(let ((anon3_Else_correct  (=> (not (Equiv.__default.P__Fail |st#0@@7| |e#0@@19|)) (=> (and (or (or (<= 0 (LitInt 3)) (< (DtRank |e#0@@19|) (DtRank |e#0@@19|))) (= (LitInt 2) (LitInt 3))) (or (< (DtRank |e#0@@19|) (DtRank |e#0@@19|)) (and (= (DtRank |e#0@@19|) (DtRank |e#0@@19|)) (< (LitInt 2) (LitInt 3))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (not (Equiv.__default.P__Fail |st#0@@7| |e#0@@19|))) (=> (not (Equiv.__default.P__Fail |st#0@@7| |e#0@@19|)) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (|Equiv.__default.P#canCall| |st#0@@7| |e#0@@19|) (Equiv.__default.P |st#0@@7| |e#0@@19|)) (and (= $Heap@@6 $Heap@1) (= (ControlFlow 0 5) 2))) GeneratedUnifiedExit_correct))))))))
(let ((anon3_Then_correct  (=> (Equiv.__default.P__Fail |st#0@@7| |e#0@@19|) (and (=> (= (ControlFlow 0 3) (- 0 4)) (Equiv.__default.P__Fail |st#0@@7| |e#0@@19|)) (=> (Equiv.__default.P__Fail |st#0@@7| |e#0@@19|) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (|Equiv.__default.P#canCall| |st#0@@7| |e#0@@19|)) (and (and (|Equiv.__default.P#canCall| |st#0@@7| |e#0@@19|) (and (Equiv.__default.P |st#0@@7| |e#0@@19|) (let ((|res#0@@3| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@19| (Equiv.MState.ctx |st#0@@7|))))
(let ((|res'#0@@3| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@19| (Equiv.MState.ctx_k |st#0@@7|))))
 (=> (Equiv.__default.Inv |st#0@@7|) (Equiv.__default.EqResult |res#0@@3| |res'#0@@3|)))))) (and (= $Heap@@6 $Heap@0) (= (ControlFlow 0 3) 2)))) GeneratedUnifiedExit_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (=> (and (and ($IsAlloc DatatypeTypeType |st#0@@7| Tclass.Equiv.MState $Heap@@6) ($IsAlloc DatatypeTypeType |e#0@@19| Tclass.AST.Expr $Heap@@6)) (and (|Equiv.__default.P__Fail#canCall| |st#0@@7| |e#0@@19|) (|Equiv.__default.P__Fail#canCall| |st#0@@7| |e#0@@19|))) (and (=> (= (ControlFlow 0 7) 3) anon3_Then_correct) (=> (= (ControlFlow 0 7) 5) anon3_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@7| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st#0@@7| Tclass.Equiv.MState $Heap@@6)) (|$IsA#Equiv.MState| |st#0@@7|)) (=> (and (and (and ($Is DatatypeTypeType |e#0@@19| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@19| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@19|)) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct)))))
