...
(set-info :boogie-vc-id Impl$$EliminateMulZero.__default.P__Fail__Sound)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (and ($Is MapType |st#0@@5| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |st#0@@5| (TMap (TSeq TChar) TInt) $Heap@@6))) (=> (and (and (and (and ($Is DatatypeTypeType |e#0@@27| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@27| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@27|)) (= 4 $FunctionContextHeight)) (and (EliminateMulZero.__default.P__Fail |st#0@@5| |e#0@@27|) (= (ControlFlow 0 6) 2))) anon0_correct))))
