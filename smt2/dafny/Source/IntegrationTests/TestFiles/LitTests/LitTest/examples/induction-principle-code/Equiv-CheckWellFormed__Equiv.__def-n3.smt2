...
(assert (distinct TInt TagInt TagSeq alloc Tagclass.Equiv.VS |##Equiv.MSeqValue.MSeqValue| Tagclass.Equiv.MSeqValue tytagFamily$VS tytagFamily$MSeqValue)
)
...
(assert (forall ((bx T@U) ) (!  (=> ($IsBox bx Tclass.Equiv.VS) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx)) bx) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx) Tclass.Equiv.VS)))
 :qid |unknown.0:0|
 :skolemid |720|
 :pattern ( ($IsBox bx Tclass.Equiv.VS))
)))
(assert (forall ((bx@@0 T@U) ) (!  (=> ($IsBox bx@@0 Tclass.Equiv.MSeqValue) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@0)) bx@@0) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@0) Tclass.Equiv.MSeqValue)))
 :qid |unknown.0:0|
 :skolemid |923|
 :pattern ( ($IsBox bx@@0 Tclass.Equiv.MSeqValue))
)))
...
(assert (forall ((|vs#0| T@U) ) (! (= ($Is DatatypeTypeType |vs#0| Tclass.Equiv.VS)  (and ($Is DatatypeTypeType |vs#0| Tclass.Equiv.MSeqValue) (= (|Seq#Length| (Equiv.MSeqValue.vs |vs#0|)) (|Seq#Length| (Equiv.MSeqValue.vs_k |vs#0|)))))
 :qid |unknown.0:0|
 :skolemid |939|
 :pattern ( ($Is DatatypeTypeType |vs#0| Tclass.Equiv.VS))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$Equiv.__default.NilVS)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) ($Is DatatypeTypeType (Lit DatatypeTypeType (|#Equiv.MSeqValue.MSeqValue| (Lit SeqType |Seq#Empty|) (Lit SeqType |Seq#Empty|))) Tclass.Equiv.VS))))
