...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|e#0@@5| T@U) (|st'#0@@1| T@U) (|v#0@@2| T@U) ) (!  (=> (or (|Equiv.__default.P__Succ#canCall| |st#0@@3| (Lit DatatypeTypeType |e#0@@5|) |st'#0@@1| |v#0@@2|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |st#0@@3| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@5| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@1| Tclass.Equiv.MState)) ($Is DatatypeTypeType |v#0@@2| Tclass.Equiv.MValue)))) (and (and (and (Equiv.MState.MState_q |st#0@@3|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@5|) (Equiv.MState.ctx |st#0@@3|))) (let ((|res#1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@5|) (Equiv.MState.ctx |st#0@@3|))))
...
(let ((|res'#1@@0| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@5|) (Equiv.MState.ctx_k |st#0@@3|))))
 ...
 :weight 3
 :skolemid |698|
 :pattern ( (Equiv.__default.P__Succ |st#0@@3| (Lit DatatypeTypeType |e#0@@5|) |st'#0@@1| |v#0@@2|))
))))
...
(assert (forall ((d@@6 T@U) ) (! (= (Equiv.MValue.MValue_q d@@6) (= (DatatypeCtorId d@@6) |##Equiv.MValue.MValue|))
 :qid |unknown.0:0|
 :skolemid |905|
 :pattern ( (Equiv.MValue.MValue_q d@@6))
)))
...
(assert (forall ((d@@24 T@U) ) (!  (=> (Equiv.MValue.MValue_q d@@24) (exists ((|a#11#0#0| Int) (|a#11#1#0| Int) ) (! (= d@@24 (|#Equiv.MValue.MValue| |a#11#0#0| |a#11#1#0|))
 :qid |Equivdfy.63:28|
 :skolemid |906|
)))
 :qid |unknown.0:0|
 :skolemid |907|
 :pattern ( (Equiv.MValue.MValue_q d@@24))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|e#0@@11| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| |st#0@@5| (Lit DatatypeTypeType |e#0@@11|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@5| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@11| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| |st#0@@5|) (=> (Equiv.__default.Inv |st#0@@5|) (and (Equiv.MState.MState_q |st#0@@5|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@11|) (Equiv.MState.ctx |st#0@@5|))))) (= (Equiv.__default.P__Fail |st#0@@5| (Lit DatatypeTypeType |e#0@@11|))  (=> (Equiv.__default.Inv |st#0@@5|) (Utils.Result.Failure_q (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@11|) (Equiv.MState.ctx |st#0@@5|)))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |707|
 :pattern ( (Equiv.__default.P__Fail |st#0@@5| (Lit DatatypeTypeType |e#0@@11|)))
))))
...
(assert (forall (($ly@@11 T@U) (|e#0@@13| T@U) (|ctx#0@@10| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@13|) (Lit MapType |ctx#0@@10|)) (and ($Is DatatypeTypeType |e#0@@13| Tclass.AST.Expr) ($Is MapType |ctx#0@@10| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@13|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@13|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@13|))))) (let ((|body#5| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@13|)))))
...
(Lit DatatypeTypeType (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#4|)) ($Box MapType (Lit MapType |ctx#0@@10|)))))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@13|)) (let ((|body#4| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@13|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1202|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@11) (Lit DatatypeTypeType |e#0@@13|) (Lit MapType |ctx#0@@10|)))
)))
...
(assert (forall ((d@@37 T@U) ) (!  (=> (|$IsA#AST.BinOp| d@@37) (or (or (AST.BinOp.Add_q d@@37) (AST.BinOp.Sub_q d@@37)) (AST.BinOp.Mul_q d@@37)))
 :qid |unknown.0:0|
 :skolemid |1021|
 :pattern ( (|$IsA#AST.BinOp| d@@37))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|e#0@@14| T@U) ) (!  (=> (or (|Equiv.__default.P__Fail#canCall| (Lit DatatypeTypeType |st#0@@6|) (Lit DatatypeTypeType |e#0@@14|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.Equiv.MState) ($Is DatatypeTypeType |e#0@@14| Tclass.AST.Expr)))) (and (and (|Equiv.__default.Inv#canCall| (Lit DatatypeTypeType |st#0@@6|)) (=> (U_2_bool (Lit boolType (bool_2_U (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@6|))))) (and (Equiv.MState.MState_q (Lit DatatypeTypeType |st#0@@6|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@14|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@6|))))))) (= (Equiv.__default.P__Fail (Lit DatatypeTypeType |st#0@@6|) (Lit DatatypeTypeType |e#0@@14|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Equiv.__default.Inv (Lit DatatypeTypeType |st#0@@6|)) (Utils.Result.Failure_q (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@14|) (Lit MapType (Equiv.MState.ctx (Lit DatatypeTypeType |st#0@@6|)))))))))))))
 :qid |Inductiondfy.36:26|
 :weight 3
 :skolemid |708|
 :pattern ( (Equiv.__default.P__Fail (Lit DatatypeTypeType |st#0@@6|) (Lit DatatypeTypeType |e#0@@14|)))
))))
...
(assert (forall ((d@@38 T@U) (Utils.Result$T@@14 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (Utils.Result.Success_q d@@38) ($IsAlloc DatatypeTypeType d@@38 (Tclass.Utils.Result Utils.Result$T@@14) $h@@5))) ($IsAllocBox (Utils.Result.value d@@38) Utils.Result$T@@14 $h@@5))
 :qid |unknown.0:0|
 :skolemid |965|
 :pattern ( ($IsAllocBox (Utils.Result.value d@@38) Utils.Result$T@@14 $h@@5))
)))
...
(assert (forall ((d@@39 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (Equiv.MValue.MValue_q d@@39) ($IsAlloc DatatypeTypeType d@@39 Tclass.Equiv.MValue $h@@6))) ($IsAlloc intType (int_2_U (Equiv.MValue.v d@@39)) TInt $h@@6))
 :qid |unknown.0:0|
 :skolemid |909|
 :pattern ( ($IsAlloc intType (int_2_U (Equiv.MValue.v d@@39)) TInt $h@@6))
)))
(assert (forall ((d@@40 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (Equiv.MValue.MValue_q d@@40) ($IsAlloc DatatypeTypeType d@@40 Tclass.Equiv.MValue $h@@7))) ($IsAlloc intType (int_2_U (Equiv.MValue.v_k d@@40)) TInt $h@@7))
 :qid |unknown.0:0|
 :skolemid |910|
 :pattern ( ($IsAlloc intType (int_2_U (Equiv.MValue.v_k d@@40)) TInt $h@@7))
)))
(assert (forall ((d@@41 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (AST.Expr__Raw.Literal_q d@@41) ($IsAlloc DatatypeTypeType d@@41 Tclass.AST.Expr__Raw $h@@8))) ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@41)) TInt $h@@8))
 :qid |unknown.0:0|
 :skolemid |1042|
 :pattern ( ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@41)) TInt $h@@8))
)))
(assert (forall ((d@@42 T@U) ) (!  (=> ($Is DatatypeTypeType d@@42 Tclass.AST.BinOp) (or (or (AST.BinOp.Add_q d@@42) (AST.BinOp.Sub_q d@@42)) (AST.BinOp.Mul_q d@@42)))
 :qid |unknown.0:0|
 :skolemid |1022|
 :pattern ( (AST.BinOp.Mul_q d@@42) ($Is DatatypeTypeType d@@42 Tclass.AST.BinOp))
 :pattern ( (AST.BinOp.Sub_q d@@42) ($Is DatatypeTypeType d@@42 Tclass.AST.BinOp))
 :pattern ( (AST.BinOp.Add_q d@@42) ($Is DatatypeTypeType d@@42 Tclass.AST.BinOp))
)))
...
(assert (forall ((d@@43 T@U) ) (! (= (BoxRank ($Box DatatypeTypeType d@@43)) (DtRank d@@43))
 :qid |DafnyPreludebpl.391:15|
 :skolemid |84|
 :pattern ( (BoxRank ($Box DatatypeTypeType d@@43)))
)))
...
(assert (forall (($ly@@13 T@U) (|e#0@@15| T@U) (|ctx#0@@11| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@15|) |ctx#0@@11|) (and ($Is DatatypeTypeType |e#0@@15| Tclass.AST.Expr) ($Is MapType |ctx#0@@11| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@15|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@15|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@15|))))) (let ((|body#3| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@15|)))))
...
(|Interp.__default.InterpBinOp#canCall| |op#3| |v1#3| |v2#3|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@15|)))))) (let ((|es#3| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@15|)))))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#3|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@13) (Lit DatatypeTypeType |e#0@@15|) |ctx#0@@11|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|name#2| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@15|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#2|)) ($Box MapType |ctx#0@@11|))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@15|)) (let ((|body#2| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@15|)))))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1201|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@13) (Lit DatatypeTypeType |e#0@@15|) |ctx#0@@11|))
)))
...
(assert (forall ((d@@44 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) ($Is DatatypeTypeType d@@44 Tclass.Equiv.MState)) ($IsAlloc DatatypeTypeType d@@44 Tclass.Equiv.MState $h@@9))
 :qid |unknown.0:0|
 :skolemid |899|
 :pattern ( ($IsAlloc DatatypeTypeType d@@44 Tclass.Equiv.MState $h@@9))
)))
(assert (forall ((d@@45 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) ($Is DatatypeTypeType d@@45 Tclass.Equiv.MValue)) ($IsAlloc DatatypeTypeType d@@45 Tclass.Equiv.MValue $h@@10))
 :qid |unknown.0:0|
 :skolemid |914|
 :pattern ( ($IsAlloc DatatypeTypeType d@@45 Tclass.Equiv.MValue $h@@10))
)))
(assert (forall ((d@@46 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) ($Is DatatypeTypeType d@@46 Tclass.AST.BinOp)) ($IsAlloc DatatypeTypeType d@@46 Tclass.AST.BinOp $h@@11))
 :qid |unknown.0:0|
 :skolemid |1020|
 :pattern ( ($IsAlloc DatatypeTypeType d@@46 Tclass.AST.BinOp $h@@11))
)))
(assert (forall ((d@@47 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) ($Is DatatypeTypeType d@@47 Tclass.AST.Expr__Raw)) ($IsAlloc DatatypeTypeType d@@47 Tclass.AST.Expr__Raw $h@@12))
 :qid |unknown.0:0|
 :skolemid |1116|
 :pattern ( ($IsAlloc DatatypeTypeType d@@47 Tclass.AST.Expr__Raw $h@@12))
)))
...
(assert (forall ((d@@48 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (AST.Expr__Raw.Var_q d@@48) ($IsAlloc DatatypeTypeType d@@48 Tclass.AST.Expr__Raw $h@@13))) ($IsAlloc SeqType (AST.Expr__Raw.name d@@48) (TSeq TChar) $h@@13))
 :qid |unknown.0:0|
 :skolemid |1032|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.name d@@48) (TSeq TChar) $h@@13))
)))
...
(assert (forall ((d@@51 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (Equiv.MState.MState_q d@@51) ($IsAlloc DatatypeTypeType d@@51 Tclass.Equiv.MState $h@@14))) ($IsAlloc MapType (Equiv.MState.ctx d@@51) (TMap (TSeq TChar) TInt) $h@@14))
 :qid |unknown.0:0|
 :skolemid |890|
 :pattern ( ($IsAlloc MapType (Equiv.MState.ctx d@@51) (TMap (TSeq TChar) TInt) $h@@14))
)))
(assert (forall ((d@@52 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (Equiv.MState.MState_q d@@52) ($IsAlloc DatatypeTypeType d@@52 Tclass.Equiv.MState $h@@15))) ($IsAlloc MapType (Equiv.MState.ctx_k d@@52) (TMap (TSeq TChar) TInt) $h@@15))
 :qid |unknown.0:0|
 :skolemid |891|
 :pattern ( ($IsAlloc MapType (Equiv.MState.ctx_k d@@52) (TMap (TSeq TChar) TInt) $h@@15))
)))
(assert (forall ((d@@53 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (_System.Tuple2.___hMake2_q d@@53) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@53 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@16)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@53 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@16))
)))) ($IsAllocBox (_System.Tuple2._0 d@@53) |_System._tuple#2$T0@@6| $h@@16))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@53) |_System._tuple#2$T0@@6| $h@@16))
)))
(assert (forall ((d@@54 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (_System.Tuple2.___hMake2_q d@@54) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@54 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@17)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@54 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@17))
)))) ($IsAllocBox (_System.Tuple2._1 d@@54) |_System._tuple#2$T1@@7| $h@@17))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@54) |_System._tuple#2$T1@@7| $h@@17))
)))
...
(assert (forall ((d@@55 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (AST.Expr__Raw.Bind_q d@@55) ($IsAlloc DatatypeTypeType d@@55 Tclass.AST.Expr__Raw $h@@18))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@55) Tclass.AST.Expr__Raw $h@@18))
 :qid |unknown.0:0|
 :skolemid |1052|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@55) Tclass.AST.Expr__Raw $h@@18))
)))
(assert (forall ((d@@56 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (AST.Expr__Raw.If_q d@@56) ($IsAlloc DatatypeTypeType d@@56 Tclass.AST.Expr__Raw $h@@19))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@56) Tclass.AST.Expr__Raw $h@@19))
 :qid |unknown.0:0|
 :skolemid |1081|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@56) Tclass.AST.Expr__Raw $h@@19))
)))
(assert (forall ((d@@57 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (AST.Expr__Raw.If_q d@@57) ($IsAlloc DatatypeTypeType d@@57 Tclass.AST.Expr__Raw $h@@20))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@57) Tclass.AST.Expr__Raw $h@@20))
 :qid |unknown.0:0|
 :skolemid |1082|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@57) Tclass.AST.Expr__Raw $h@@20))
)))
(assert (forall ((d@@58 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (AST.Expr__Raw.If_q d@@58) ($IsAlloc DatatypeTypeType d@@58 Tclass.AST.Expr__Raw $h@@21))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@58) Tclass.AST.Expr__Raw $h@@21))
 :qid |unknown.0:0|
 :skolemid |1083|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@58) Tclass.AST.Expr__Raw $h@@21))
)))
(assert (forall ((d@@59 T@U) ($h@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@22) (and (AST.Expr__Raw.Op_q d@@59) ($IsAlloc DatatypeTypeType d@@59 Tclass.AST.Expr__Raw $h@@22))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@59) Tclass.AST.BinOp $h@@22))
 :qid |unknown.0:0|
 :skolemid |1096|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@59) Tclass.AST.BinOp $h@@22))
)))
(assert (forall ((d@@60 T@U) ($h@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@23) (and (AST.Expr__Raw.Op_q d@@60) ($IsAlloc DatatypeTypeType d@@60 Tclass.AST.Expr__Raw $h@@23))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@60) Tclass.AST.Expr__Raw $h@@23))
 :qid |unknown.0:0|
 :skolemid |1097|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@60) Tclass.AST.Expr__Raw $h@@23))
)))
(assert (forall ((d@@61 T@U) ($h@@24 T@U) ) (!  (=> (and ($IsGoodHeap $h@@24) (and (AST.Expr__Raw.Op_q d@@61) ($IsAlloc DatatypeTypeType d@@61 Tclass.AST.Expr__Raw $h@@24))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@61) Tclass.AST.Expr__Raw $h@@24))
 :qid |unknown.0:0|
 :skolemid |1098|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@61) Tclass.AST.Expr__Raw $h@@24))
)))
...
(assert (forall ((d@@62 T@U) ($h@@25 T@U) ) (!  (=> (and ($IsGoodHeap $h@@25) (and (AST.Expr__Raw.Bind_q d@@62) ($IsAlloc DatatypeTypeType d@@62 Tclass.AST.Expr__Raw $h@@25))) ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@62) (TSeq (TSeq TChar)) $h@@25))
 :qid |unknown.0:0|
 :skolemid |1050|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@62) (TSeq (TSeq TChar)) $h@@25))
)))
(assert (forall ((d@@63 T@U) ($h@@26 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (AST.Expr__Raw.Assign_q d@@63) ($IsAlloc DatatypeTypeType d@@63 Tclass.AST.Expr__Raw $h@@26))) ($IsAlloc SeqType (AST.Expr__Raw.avars d@@63) (TSeq (TSeq TChar)) $h@@26))
 :qid |unknown.0:0|
 :skolemid |1067|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avars d@@63) (TSeq (TSeq TChar)) $h@@26))
)))
...
(assert (forall ((d@@64 T@U) ($h@@27 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (AST.Expr__Raw.Bind_q d@@64) ($IsAlloc DatatypeTypeType d@@64 Tclass.AST.Expr__Raw $h@@27))) ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@64) (TSeq Tclass.AST.Expr__Raw) $h@@27))
 :qid |unknown.0:0|
 :skolemid |1051|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@64) (TSeq Tclass.AST.Expr__Raw) $h@@27))
)))
(assert (forall ((d@@65 T@U) ($h@@28 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (AST.Expr__Raw.Assign_q d@@65) ($IsAlloc DatatypeTypeType d@@65 Tclass.AST.Expr__Raw $h@@28))) ($IsAlloc SeqType (AST.Expr__Raw.avals d@@65) (TSeq Tclass.AST.Expr__Raw) $h@@28))
 :qid |unknown.0:0|
 :skolemid |1068|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avals d@@65) (TSeq Tclass.AST.Expr__Raw) $h@@28))
)))
(assert (forall ((d@@66 T@U) ($h@@29 T@U) ) (!  (=> (and ($IsGoodHeap $h@@29) (and (AST.Expr__Raw.Seq_q d@@66) ($IsAlloc DatatypeTypeType d@@66 Tclass.AST.Expr__Raw $h@@29))) ($IsAlloc SeqType (AST.Expr__Raw.es d@@66) (TSeq Tclass.AST.Expr__Raw) $h@@29))
 :qid |unknown.0:0|
 :skolemid |1111|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.es d@@66) (TSeq Tclass.AST.Expr__Raw) $h@@29))
)))
...
(set-info :boogie-vc-id Impl$$Equiv.__default.InductOp__Fail)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (Equiv.__default.P__Fail |st#0@@7| |e1#0@@0|))) (=> (not (Equiv.__default.P__Fail |st#0@@7| |e1#0@@0|)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|st1#1| T@U) (|v1#1@@0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |st1#1| Tclass.Equiv.MState) ($Is DatatypeTypeType |v1#1@@0| Tclass.Equiv.MValue)) (Equiv.__default.P__Succ |st#0@@7| |e1#0@@0| |st1#1| |v1#1@@0|)) (not (Equiv.__default.P__Fail |st1#1| |e2#0@@0|)))
 :qid |Inductiondfy.120:20|
 :skolemid |816|
 :pattern ( (Equiv.__default.P__Succ |st#0@@7| |e1#0@@0| |st1#1| |v1#1@@0|))
))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and (and ($Is DatatypeTypeType |st#0@@7| Tclass.Equiv.MState) ($IsAlloc DatatypeTypeType |st#0@@7| Tclass.Equiv.MState $Heap@@6)) (|$IsA#Equiv.MState| |st#0@@7|)) (and (and ($Is DatatypeTypeType |e#0@@19| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@19| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@19|))) (and (and (and ($Is DatatypeTypeType |op#0@@2| Tclass.AST.BinOp) ($IsAlloc DatatypeTypeType |op#0@@2| Tclass.AST.BinOp $Heap@@6)) (|$IsA#AST.BinOp| |op#0@@2|)) (and (and ($Is DatatypeTypeType |e1#0@@0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e1#0@@0| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e1#0@@0|)))) (=> (and (and (and (and (and ($Is DatatypeTypeType |e2#0@@0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e2#0@@0| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e2#0@@0|)) (= 3 $FunctionContextHeight)) (and (AST.Expr__Raw.Op_q |e#0@@19|) (|AST.BinOp#Equal| (AST.Expr__Raw.op |e#0@@19|) |op#0@@2|))) (and (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.oe1 |e#0@@19|) |e1#0@@0|) (|AST.Expr__Raw#Equal| (AST.Expr__Raw.oe2 |e#0@@19|) |e2#0@@0|)) (and (not (Equiv.__default.P__Fail |st#0@@7| |e#0@@19|)) (= (ControlFlow 0 4) 2)))) anon0_correct)))))
