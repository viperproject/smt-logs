...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0| T@U) (|e#0| T@U) ) (!  (=> (or (|VarUnchanged.__default.P#canCall| |st#0| (Lit DatatypeTypeType |e#0|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0| Tclass.AST.Expr)))) (and (and (and (VarUnchanged.MState.MState_q |st#0|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0|) (VarUnchanged.MState.ctx |st#0|))) (let ((|res#1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0|) (VarUnchanged.MState.ctx |st#0|))))
 (and (|VarUnchanged.__default.Pre#canCall| |st#0| (Lit DatatypeTypeType |e#0|)) (=> (VarUnchanged.__default.Pre |st#0| (Lit DatatypeTypeType |e#0|)) (|VarUnchanged.__default.ResultSameX#canCall| |st#0| |res#1|))))) (= (VarUnchanged.__default.P |st#0| (Lit DatatypeTypeType |e#0|)) (let ((|res#1@@0| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0|) (VarUnchanged.MState.ctx |st#0|))))
 (=> (VarUnchanged.__default.Pre |st#0| (Lit DatatypeTypeType |e#0|)) (VarUnchanged.__default.ResultSameX |st#0| |res#1@@0|))))))
 :qid |Inductiondfy.34:21|
 :weight 3
 :skolemid |722|
 :pattern ( (VarUnchanged.__default.P |st#0| (Lit DatatypeTypeType |e#0|)))
))))
...
(assert (forall ((a@@7 T@U) (b@@7 T@U) ) (! (= (|Utils.Option#Equal| a@@7 b@@7) (= a@@7 b@@7))
 :qid |unknown.0:0|
 :skolemid |1027|
 :pattern ( (|Utils.Option#Equal| a@@7 b@@7))
)))
...
(|Interp.__default.InterpBinOp#canCall| |op#1| |v1#1| |v2#1|)))))))))))))))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@2|)) (let ((|es#1| (AST.Expr__Raw.es |e#0@@2|)))
 ...
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#1|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#1|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@0) |e#0@@2| |ctx#0@@0|) (ite (AST.Expr__Raw.Var_q |e#0@@2|) (let ((|name#0| (AST.Expr__Raw.name |e#0@@2|)))
...
(ite  (or (not (= |condv#0| 0)) (not true)) (Interp.__default.InterpExpr $ly@@0 |thn#0| |ctx_cond#0|) (Interp.__default.InterpExpr $ly@@0 |els#0| |ctx_cond#0|))))))))) (ite (AST.Expr__Raw.Op_q |e#0@@2|) (let ((|e2#0| (AST.Expr__Raw.oe2 |e#0@@2|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (Interp.__default.InterpBinOp |op#0@@0| |v1#0| |v2#0|))) ($Box MapType |ctx2#1|))))))))))))))) (let ((|es#0@@0| (AST.Expr__Raw.es |e#0@@2|)))
(let ((|valueOrError6#0| (Interp.__default.InterpExprs $ly@@0 |es#0@@0| |ctx#0@@0|)))
...
(ite (|Seq#Equal| |vs#2@@0| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#3|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#2@@0| (- (|Seq#Length| |vs#2@@0|) 1)) ($Box MapType |ctx1#3|)))))))))))))))))))
 :qid |Interpdfy.24:12|
 :skolemid |1214|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@0) |e#0@@2| |ctx#0@@0|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@1| T@U) (|e#0@@3| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pre#canCall| |st#0@@1| |e#0@@3|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@1| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@3| Tclass.AST.Expr)))) (and (and (VarUnchanged.MState.MState_q |st#0@@1|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@1|)) (and (VarUnchanged.MState.MState_q |st#0@@1|) (|VarUnchanged.__default.VarUnchanged#canCall| ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@1|))) |e#0@@3|)))) (= (VarUnchanged.__default.Pre |st#0@@1| |e#0@@3|)  (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@1|)) (VarUnchanged.__default.VarUnchanged ($LS $LZ) ($Unbox SeqType (Utils.Option.value (VarUnchanged.MState.x |st#0@@1|))) |e#0@@3|)))))
 :qid |VarUnchangeddfy.82:23|
 :skolemid |704|
 :pattern ( (VarUnchanged.__default.Pre |st#0@@1| |e#0@@3|))
))))
...
(assert (forall ((|st#0@@2| T@U) ) (! (= ($Is DatatypeTypeType |st#0@@2| Tclass.VarUnchanged.S)  (and ($Is DatatypeTypeType |st#0@@2| Tclass.VarUnchanged.MState) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@2|)) (|Set#IsMember| (|Map#Domain| (VarUnchanged.MState.ctx |st#0@@2|)) (Utils.Option.value (VarUnchanged.MState.x |st#0@@2|))))))
 :qid |unknown.0:0|
 :skolemid |956|
 :pattern ( ($Is DatatypeTypeType |st#0@@2| Tclass.VarUnchanged.S))
)))
...
(assert (forall ((a@@8 T@U) (b@@8 T@U) ) (! (= (|Set#Disjoint| a@@8 b@@8) (forall ((o@@1 T@U) ) (!  (or (not (|Set#IsMember| a@@8 o@@1)) (not (|Set#IsMember| b@@8 o@@1)))
 :qid |DafnyPreludebpl.794:19|
 :skolemid |151|
 :pattern ( (|Set#IsMember| a@@8 o@@1))
 :pattern ( (|Set#IsMember| b@@8 o@@1))
)))
...
(let ((|oe1#0| (AST.Expr__Raw.oe1 |e#0@@4|)))
 (and (AST.Expr__Raw.All $ly@@1 |oe1#0| |p#0|) (AST.Expr__Raw.All $ly@@1 |oe2#0| |p#0|)))) (let ((|es#0@@1| (AST.Expr__Raw.es |e#0@@4|)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@3| T@U) (|e#0@@5| T@U) (|st'#0| T@U) (|v#0| Int) ) (!  (=> (or (|VarUnchanged.__default.P__Succ#canCall| |st#0@@3| (Lit DatatypeTypeType |e#0@@5|) |st'#0| |v#0|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@3| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@5| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0| Tclass.VarUnchanged.S)))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@3|) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@5|) (VarUnchanged.MState.ctx |st#0@@3|))) (let ((|res#1@@1| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@5|) (VarUnchanged.MState.ctx |st#0@@3|))))
 (and (|VarUnchanged.__default.Pre#canCall| |st#0@@3| (Lit DatatypeTypeType |e#0@@5|)) (=> (VarUnchanged.__default.Pre |st#0@@3| (Lit DatatypeTypeType |e#0@@5|)) (and (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@3| |res#1@@1|) (=> (VarUnchanged.__default.ResultSameX |st#0@@3| |res#1@@1|) (and (and (|$IsA#Utils.Result| |res#1@@1|) (VarUnchanged.MState.MState_q |st'#0|)) (=> (|Utils.Result#Equal| |res#1@@1| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0|)) ($Box MapType (VarUnchanged.MState.ctx |st'#0|)))))) (and (and (|$IsA#Utils.Option| (VarUnchanged.MState.x |st'#0|)) (|$IsA#Utils.Option| (VarUnchanged.MState.x |st#0@@3|))) (and (VarUnchanged.MState.MState_q |st'#0|) (VarUnchanged.MState.MState_q |st#0@@3|))))))))))) (= (VarUnchanged.__default.P__Succ |st#0@@3| (Lit DatatypeTypeType |e#0@@5|) |st'#0| |v#0|) (let ((|res#1@@2| (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@5|) (VarUnchanged.MState.ctx |st#0@@3|))))
 (and (and (and (VarUnchanged.__default.Pre |st#0@@3| (Lit DatatypeTypeType |e#0@@5|)) (VarUnchanged.__default.ResultSameX |st#0@@3| |res#1@@2|)) (|Utils.Result#Equal| |res#1@@2| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0|)) ($Box MapType (VarUnchanged.MState.ctx |st'#0|))))))) (|Utils.Option#Equal| (VarUnchanged.MState.x |st'#0|) (VarUnchanged.MState.x |st#0@@3|)))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |730|
 :pattern ( (VarUnchanged.__default.P__Succ |st#0@@3| (Lit DatatypeTypeType |e#0@@5|) |st'#0| |v#0|))
))))
(assert (forall (($ly@@2 T@U) (|es#0@@2| T@U) (|ctx#0@@1| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@2| |ctx#0@@1|) (and ($Is SeqType |es#0@@2| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@1| (TMap (TSeq TChar) TInt)))) (and (=> (Utils.Result.Success_q (Interp.__default.InterpExprs $ly@@2 |es#0@@2| |ctx#0@@1|)) (= (|Seq#Length| ($Unbox SeqType (_System.Tuple2._0 ($Unbox DatatypeTypeType (Utils.Result.value (Interp.__default.InterpExprs $ly@@2 |es#0@@2| |ctx#0@@1|)))))) (|Seq#Length| |es#0@@2|))) ($Is DatatypeTypeType (Interp.__default.InterpExprs $ly@@2 |es#0@@2| |ctx#0@@1|) (Tclass.Utils.Result (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt))))))
 :qid |Interpdfy.69:12|
 :skolemid |1219|
 :pattern ( (Interp.__default.InterpExprs $ly@@2 |es#0@@2| |ctx#0@@1|))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@3 T@U) (|x#0@@0| T@U) (|e#0@@6| T@U) ) (!  (=> (or (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| (Lit DatatypeTypeType |e#0@@6|)) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |x#0@@0| (TSeq TChar)) ($Is DatatypeTypeType |e#0@@6| Tclass.AST.Expr)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@6|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@6|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@6|))))) (let ((|body#3| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@6|)))))
...
(let ((|bvars#3| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@6|)))))
 (and (forall ((|e#10| T@U) ) (!  (=> ($Is DatatypeTypeType |e#10| Tclass.AST.Expr__Raw) (=> (|Seq#Contains| |bvals#3| ($Box DatatypeTypeType |e#10|)) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |e#10|)))
 :qid |VarUnchangeddfy.28:17|
 :skolemid |655|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |e#10|))
 :pattern ( (|Seq#Contains| |bvals#3| ($Box DatatypeTypeType |e#10|)))
)) (=> (forall ((|e#10@@0| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#10@@0| Tclass.AST.Expr__Raw) (|Seq#Contains| |bvals#3| ($Box DatatypeTypeType |e#10@@0|))) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |e#10@@0|))
 :qid |VarUnchangeddfy.28:17|
 :skolemid |656|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |e#10@@0|))
 :pattern ( (|Seq#Contains| |bvals#3| ($Box DatatypeTypeType |e#10@@0|)))
)) (=> (not (|Seq#Contains| |bvars#3| ($Box SeqType |x#0@@0|))) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |body#3|)))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@6|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@6|))))) (let ((|avals#3| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@6|)))))
(let ((|avars#3| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@6|)))))
 (=> (not (|Seq#Contains| |avars#3| ($Box SeqType |x#0@@0|))) (forall ((|e#11| T@U) ) (!  (=> ($Is DatatypeTypeType |e#11| Tclass.AST.Expr__Raw) (=> (|Seq#Contains| |avals#3| ($Box DatatypeTypeType |e#11|)) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |e#11|)))
 :qid |VarUnchangeddfy.32:32|
 :skolemid |657|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |e#11|))
 :pattern ( (|Seq#Contains| |avals#3| ($Box DatatypeTypeType |e#11|)))
)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@6|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@6|))))) (let ((|els#3| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@6|)))))
...
(let ((|cond#3| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@6|)))))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |cond#3|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |cond#3|) (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |thn#3|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |thn#3|) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |els#3|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@6|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@6|))))) (let ((|oe2#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@6|)))))
(let ((|oe1#3| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@6|)))))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |oe1#3|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |oe1#3|) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |oe2#3|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@6|)))))) (let ((|es#3| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@6|)))))
(forall ((|e#12| T@U) ) (!  (=> ($Is DatatypeTypeType |e#12| Tclass.AST.Expr__Raw) (=> (|Seq#Contains| |es#3| ($Box DatatypeTypeType |e#12|)) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@0| |e#12|)))
 :qid |VarUnchangeddfy.38:16|
 :skolemid |658|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |e#12|))
 :pattern ( (|Seq#Contains| |es#3| ($Box DatatypeTypeType |e#12|)))
))))))))))))) (= (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| (Lit DatatypeTypeType |e#0@@6|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@6|)) (U_2_bool (Lit boolType (bool_2_U false))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@6|)) (U_2_bool (Lit boolType (bool_2_U false))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@6|)) (let ((|body#2| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@6|)))))
(let ((|bvals#2| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@6|)))))
(let ((|bvars#2| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@6|)))))
 (and (forall ((|e#7| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#7| Tclass.AST.Expr__Raw) (|Seq#Contains| |bvals#2| ($Box DatatypeTypeType |e#7|))) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |e#7|))
 :qid |VarUnchangeddfy.28:17|
 :skolemid |652|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |e#7|))
 :pattern ( (|Seq#Contains| |bvals#2| ($Box DatatypeTypeType |e#7|)))
)) (or (|Seq#Contains| |bvars#2| ($Box SeqType |x#0@@0|)) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |body#2|)))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@6|)) (let ((|avals#2| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@6|)))))
(let ((|avars#2| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@6|)))))
 (and (not (|Seq#Contains| |avars#2| ($Box SeqType |x#0@@0|))) (forall ((|e#8| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#8| Tclass.AST.Expr__Raw) (|Seq#Contains| |avals#2| ($Box DatatypeTypeType |e#8|))) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |e#8|))
 :qid |VarUnchangeddfy.32:32|
 :skolemid |653|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |e#8|))
 :pattern ( (|Seq#Contains| |avals#2| ($Box DatatypeTypeType |e#8|)))
))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@6|)) (let ((|els#2| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@6|)))))
...
(let ((|cond#2| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@6|)))))
 (and (and (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |cond#2|) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |thn#2|)) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |els#2|))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@6|)) (let ((|oe2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@6|)))))
(let ((|oe1#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@6|)))))
 (and (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |oe1#2|) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |oe2#2|)))) (let ((|es#2| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@6|)))))
(forall ((|e#9| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#9| Tclass.AST.Expr__Raw) (|Seq#Contains| |es#2| ($Box DatatypeTypeType |e#9|))) (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |e#9|))
 :qid |VarUnchangeddfy.38:16|
 :skolemid |654|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| |e#9|))
 :pattern ( (|Seq#Contains| |es#2| ($Box DatatypeTypeType |e#9|)))
))))))))))))
 :qid |VarUnchangeddfy.17:13|
 :weight 3
 :skolemid |659|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@3) |x#0@@0| (Lit DatatypeTypeType |e#0@@6|)))
))))
(assert (forall (($ly@@4 T@U) (|x#0@@1| T@U) (|e#0@@7| T@U) ) (! (= (VarUnchanged.__default.VarUnchanged ($LS $ly@@4) |x#0@@1| |e#0@@7|) (VarUnchanged.__default.VarUnchanged $ly@@4 |x#0@@1| |e#0@@7|))
 :qid |VarUnchangeddfy.17:13|
 :skolemid |638|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@4) |x#0@@1| |e#0@@7|))
)))
(assert (forall (($ly@@5 T@U) (|e#0@@8| T@U) (|p#0@@0| T@U) ) (! (= (AST.Expr__Raw.All ($LS $ly@@5) |e#0@@8| |p#0@@0|) (AST.Expr__Raw.All $ly@@5 |e#0@@8| |p#0@@0|))
 :qid |ASTdfy.44:22|
 :skolemid |1153|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@5) |e#0@@8| |p#0@@0|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@4| T@U) (|res#0| T@U) ) (!  (=> (or (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@4| |res#0|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@4| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |res#0| (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt))))))) (and (=> (Utils.Result.Success_q |res#0|) (and (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value |res#0|))) (let ((|ctx#1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#0|))))))
 (and (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (Utils.Result.value |res#0|))) (and (VarUnchanged.MState.MState_q |st#0@@4|) (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@4|)) (and (VarUnchanged.MState.MState_q |st#0@@4|) (=> (|Set#IsMember| (|Map#Domain| |ctx#1|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@4|))) (and (and (VarUnchanged.MState.MState_q |st#0@@4|) (VarUnchanged.MState.MState_q |st#0@@4|)) (VarUnchanged.MState.MState_q |st#0@@4|)))))))))) (= (VarUnchanged.__default.ResultSameX |st#0@@4| |res#0|) (ite (Utils.Result.Success_q |res#0|) (let ((|ctx#0@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#0|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@4|)) (and (|Set#IsMember| (|Map#Domain| |ctx#0@@2|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@4|))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (VarUnchanged.MState.ctx |st#0@@4|)) (Utils.Option.value (VarUnchanged.MState.x |st#0@@4|))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#0@@2|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@4|))))))))) true))))
 :qid |VarUnchangeddfy.41:31|
 :skolemid |695|
 :pattern ( (VarUnchanged.__default.ResultSameX |st#0@@4| |res#0|))
))))
...
(assert (forall (($ly@@6 T@U) (|e#0@@10| T@U) (|ctx#0@@3| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| |e#0@@10| |ctx#0@@3|) (and ($Is DatatypeTypeType |e#0@@10| Tclass.AST.Expr) ($Is MapType |ctx#0@@3| (TMap (TSeq TChar) TInt)))) ($Is DatatypeTypeType (Interp.__default.InterpExpr $ly@@6 |e#0@@10| |ctx#0@@3|) (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)))))
 :qid |Interpdfy.24:12|
 :skolemid |1212|
 :pattern ( (Interp.__default.InterpExpr $ly@@6 |e#0@@10| |ctx#0@@3|))
)))
(assert (forall (($ly@@7 T@U) (|e#0@@11| T@U) (|ctx#0@@4| T@U) ) (! (= (Interp.__default.InterpExpr ($LS $ly@@7) |e#0@@11| |ctx#0@@4|) (Interp.__default.InterpExpr $ly@@7 |e#0@@11| |ctx#0@@4|))
 :qid |Interpdfy.24:12|
 :skolemid |1210|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@7) |e#0@@11| |ctx#0@@4|))
)))
(assert (forall (($ly@@8 T@U) (|es#0@@3| T@U) (|ctx#0@@5| T@U) ) (! (= (Interp.__default.InterpExprs ($LS $ly@@8) |es#0@@3| |ctx#0@@5|) (Interp.__default.InterpExprs $ly@@8 |es#0@@3| |ctx#0@@5|))
 :qid |Interpdfy.69:12|
 :skolemid |1217|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@8) |es#0@@3| |ctx#0@@5|))
)))
(assert (forall (($ly@@9 T@U) (|vars#0| T@U) (|values#0| T@U) ) (! (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@9) |vars#0| |values#0|) (Interp.__default.VarsAndValuesToContext $ly@@9 |vars#0| |values#0|))
 :qid |Interpdfy.80:12|
 :skolemid |1224|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@9) |vars#0| |values#0|))
)))
(assert (forall (($ly@@10 T@U) (|vars#0@@0| T@U) (|values#0@@0| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@0| |values#0@@0|) (and (and ($Is SeqType |vars#0@@0| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@0| (TSeq TInt))) (= (|Seq#Length| |vars#0@@0|) (|Seq#Length| |values#0@@0|)))) (and (|Set#Equal| (|Map#Domain| (Interp.__default.VarsAndValuesToContext $ly@@10 |vars#0@@0| |values#0@@0|)) (|Set#FromBoogieMap| (|lambda#7| (TSeq TChar) |vars#0@@0|))) ($Is MapType (Interp.__default.VarsAndValuesToContext $ly@@10 |vars#0@@0| |values#0@@0|) (TMap (TSeq TChar) TInt))))
 :qid |Interpdfy.80:12|
 :skolemid |1226|
 :pattern ( (Interp.__default.VarsAndValuesToContext $ly@@10 |vars#0@@0| |values#0@@0|))
)))
...
(assert (forall ((a@@9 T@U) (b@@9 T@U) (o@@2 T@U) ) (! (= (|Set#IsMember| (|Set#Union| a@@9 b@@9) o@@2)  (or (|Set#IsMember| a@@9 o@@2) (|Set#IsMember| b@@9 o@@2)))
 :qid |DafnyPreludebpl.704:15|
 :skolemid |133|
 :pattern ( (|Set#IsMember| (|Set#Union| a@@9 b@@9) o@@2))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@5| T@U) (|e#0@@12| T@U) ) (!  (=> (or (|VarUnchanged.__default.P#canCall| |st#0@@5| |e#0@@12|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@5| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@12| Tclass.AST.Expr)))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@5|) (|Interp.__default.InterpExpr#canCall| |e#0@@12| (VarUnchanged.MState.ctx |st#0@@5|))) (let ((|res#0@@0| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@12| (VarUnchanged.MState.ctx |st#0@@5|))))
 (and (|VarUnchanged.__default.Pre#canCall| |st#0@@5| |e#0@@12|) (=> (VarUnchanged.__default.Pre |st#0@@5| |e#0@@12|) (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@5| |res#0@@0|))))) (= (VarUnchanged.__default.P |st#0@@5| |e#0@@12|) (let ((|res#0@@1| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@12| (VarUnchanged.MState.ctx |st#0@@5|))))
 (=> (VarUnchanged.__default.Pre |st#0@@5| |e#0@@12|) (VarUnchanged.__default.ResultSameX |st#0@@5| |res#0@@1|))))))
 :qid |Inductiondfy.34:21|
 :skolemid |721|
 :pattern ( (VarUnchanged.__default.P |st#0@@5| |e#0@@12|))
))))
...
(assert (forall (($ly@@11 T@U) (|es#0@@4| T@U) (|ctx#0@@6| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| |es#0@@4| |ctx#0@@6|) (and ($Is SeqType |es#0@@4| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@6| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@4| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@4| (LitInt 0))) |ctx#0@@6|) (let ((|valueOrError0#0@@0| (Interp.__default.InterpExpr $ly@@11 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@4| (LitInt 0))) |ctx#0@@6|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (|Seq#Drop| |es#0@@4| (LitInt 1)) |ctx1#0@@0|) (let ((|valueOrError1#0@@0| (Interp.__default.InterpExprs $ly@@11 (|Seq#Drop| |es#0@@4| (LitInt 1)) |ctx1#0@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#0@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@11) |es#0@@4| |ctx#0@@6|) (ite (|Seq#Equal| |es#0@@4| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@6|)))) (let ((|valueOrError0#0@@1| (Interp.__default.InterpExpr $ly@@11 ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@4| (LitInt 0))) |ctx#0@@6|)))
...
(let ((|valueOrError1#0@@1| (Interp.__default.InterpExprs $ly@@11 (|Seq#Drop| |es#0@@4| (LitInt 1)) |ctx1#0@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#0@@0|))) |vs#0@@0|)) ($Box MapType |ctx2#0@@0|))))))))))))))))
 :qid |Interpdfy.69:12|
 :skolemid |1221|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@11) |es#0@@4| |ctx#0@@6|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@12 T@U) (|x#0@@2| T@U) (|e#0@@13| T@U) ) (!  (=> (or (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |e#0@@13|) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |x#0@@2| (TSeq TChar)) ($Is DatatypeTypeType |e#0@@13| Tclass.AST.Expr)))) (and (=> (not (AST.Expr__Raw.Var_q |e#0@@13|)) (=> (not (AST.Expr__Raw.Literal_q |e#0@@13|)) (and (=> (AST.Expr__Raw.Bind_q |e#0@@13|) (let ((|body#1@@1| (AST.Expr__Raw.body |e#0@@13|)))
(let ((|bvals#1@@1| (AST.Expr__Raw.bvals |e#0@@13|)))
(let ((|bvars#1@@0| (AST.Expr__Raw.bvars |e#0@@13|)))
 (and (forall ((|e#4@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |e#4@@1| Tclass.AST.Expr__Raw) (=> (|Seq#Contains| |bvals#1@@1| ($Box DatatypeTypeType |e#4@@1|)) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |e#4@@1|)))
 :qid |VarUnchangeddfy.28:17|
 :skolemid |647|
 :pattern ( (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |e#4@@1|))
 :pattern ( (|Seq#Contains| |bvals#1@@1| ($Box DatatypeTypeType |e#4@@1|)))
)) (=> (forall ((|e#4@@2| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#4@@2| Tclass.AST.Expr__Raw) (|Seq#Contains| |bvals#1@@1| ($Box DatatypeTypeType |e#4@@2|))) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |e#4@@2|))
 :qid |VarUnchangeddfy.28:17|
 :skolemid |648|
 :pattern ( (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |e#4@@2|))
 :pattern ( (|Seq#Contains| |bvals#1@@1| ($Box DatatypeTypeType |e#4@@2|)))
)) (=> (not (|Seq#Contains| |bvars#1@@0| ($Box SeqType |x#0@@2|))) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |body#1@@1|)))))))) (=> (not (AST.Expr__Raw.Bind_q |e#0@@13|)) (and (=> (AST.Expr__Raw.Assign_q |e#0@@13|) (let ((|avals#1@@1| (AST.Expr__Raw.avals |e#0@@13|)))
(let ((|avars#1@@0| (AST.Expr__Raw.avars |e#0@@13|)))
 (=> (not (|Seq#Contains| |avars#1@@0| ($Box SeqType |x#0@@2|))) (forall ((|e#5@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |e#5@@0| Tclass.AST.Expr__Raw) (=> (|Seq#Contains| |avals#1@@1| ($Box DatatypeTypeType |e#5@@0|)) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |e#5@@0|)))
 :qid |VarUnchangeddfy.32:32|
 :skolemid |649|
 :pattern ( (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |e#5@@0|))
 :pattern ( (|Seq#Contains| |avals#1@@1| ($Box DatatypeTypeType |e#5@@0|)))
)))))) (=> (not (AST.Expr__Raw.Assign_q |e#0@@13|)) (and (=> (AST.Expr__Raw.If_q |e#0@@13|) (let ((|els#1@@1| (AST.Expr__Raw.els |e#0@@13|)))
(let ((|thn#1@@1| (AST.Expr__Raw.thn |e#0@@13|)))
(let ((|cond#1@@1| (AST.Expr__Raw.cond |e#0@@13|)))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |cond#1@@1|) (=> (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |cond#1@@1|) (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |thn#1@@1|) (=> (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |thn#1@@1|) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |els#1@@1|))))))))) (=> (not (AST.Expr__Raw.If_q |e#0@@13|)) (and (=> (AST.Expr__Raw.Op_q |e#0@@13|) (let ((|oe2#1@@0| (AST.Expr__Raw.oe2 |e#0@@13|)))
(let ((|oe1#1@@0| (AST.Expr__Raw.oe1 |e#0@@13|)))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |oe1#1@@0|) (=> (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |oe1#1@@0|) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |oe2#1@@0|)))))) (=> (not (AST.Expr__Raw.Op_q |e#0@@13|)) (let ((|es#1@@1| (AST.Expr__Raw.es |e#0@@13|)))
(forall ((|e#6@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |e#6@@0| Tclass.AST.Expr__Raw) (=> (|Seq#Contains| |es#1@@1| ($Box DatatypeTypeType |e#6@@0|)) (|VarUnchanged.__default.VarUnchanged#canCall| |x#0@@2| |e#6@@0|)))
 :qid |VarUnchangeddfy.38:16|
 :skolemid |650|
 :pattern ( (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |e#6@@0|))
 :pattern ( (|Seq#Contains| |es#1@@1| ($Box DatatypeTypeType |e#6@@0|)))
))))))))))))) (= (VarUnchanged.__default.VarUnchanged ($LS $ly@@12) |x#0@@2| |e#0@@13|) (ite (AST.Expr__Raw.Var_q |e#0@@13|) (U_2_bool (Lit boolType (bool_2_U false))) (ite (AST.Expr__Raw.Literal_q |e#0@@13|) (U_2_bool (Lit boolType (bool_2_U false))) (ite (AST.Expr__Raw.Bind_q |e#0@@13|) (let ((|body#0@@1| (AST.Expr__Raw.body |e#0@@13|)))
(let ((|bvals#0@@2| (AST.Expr__Raw.bvals |e#0@@13|)))
(let ((|bvars#0@@1| (AST.Expr__Raw.bvars |e#0@@13|)))
 (and (forall ((|e#1@@0| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#1@@0| Tclass.AST.Expr__Raw) (|Seq#Contains| |bvals#0@@2| ($Box DatatypeTypeType |e#1@@0|))) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |e#1@@0|))
 :qid |VarUnchangeddfy.28:17|
 :skolemid |644|
 :pattern ( (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |e#1@@0|))
 :pattern ( (|Seq#Contains| |bvals#0@@2| ($Box DatatypeTypeType |e#1@@0|)))
)) (or (|Seq#Contains| |bvars#0@@1| ($Box SeqType |x#0@@2|)) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |body#0@@1|)))))) (ite (AST.Expr__Raw.Assign_q |e#0@@13|) (let ((|avals#0@@2| (AST.Expr__Raw.avals |e#0@@13|)))
(let ((|avars#0@@1| (AST.Expr__Raw.avars |e#0@@13|)))
 (and (not (|Seq#Contains| |avars#0@@1| ($Box SeqType |x#0@@2|))) (forall ((|e#2@@0| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#2@@0| Tclass.AST.Expr__Raw) (|Seq#Contains| |avals#0@@2| ($Box DatatypeTypeType |e#2@@0|))) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |e#2@@0|))
 :qid |VarUnchangeddfy.32:32|
 :skolemid |645|
 :pattern ( (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |e#2@@0|))
 :pattern ( (|Seq#Contains| |avals#0@@2| ($Box DatatypeTypeType |e#2@@0|)))
))))) (ite (AST.Expr__Raw.If_q |e#0@@13|) (let ((|els#0@@1| (AST.Expr__Raw.els |e#0@@13|)))
(let ((|thn#0@@1| (AST.Expr__Raw.thn |e#0@@13|)))
(let ((|cond#0@@1| (AST.Expr__Raw.cond |e#0@@13|)))
 (and (and (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |cond#0@@1|) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |thn#0@@1|)) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |els#0@@1|))))) (ite (AST.Expr__Raw.Op_q |e#0@@13|) (let ((|oe2#0@@0| (AST.Expr__Raw.oe2 |e#0@@13|)))
(let ((|oe1#0@@0| (AST.Expr__Raw.oe1 |e#0@@13|)))
 (and (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |oe1#0@@0|) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |oe2#0@@0|)))) (let ((|es#0@@5| (AST.Expr__Raw.es |e#0@@13|)))
(forall ((|e#3@@0| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#3@@0| Tclass.AST.Expr__Raw) (|Seq#Contains| |es#0@@5| ($Box DatatypeTypeType |e#3@@0|))) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |e#3@@0|))
 :qid |VarUnchangeddfy.38:16|
 :skolemid |646|
 :pattern ( (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |e#3@@0|))
 :pattern ( (|Seq#Contains| |es#0@@5| ($Box DatatypeTypeType |e#3@@0|)))
))))))))))))
 :qid |VarUnchangeddfy.17:13|
 :skolemid |651|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@12) |x#0@@2| |e#0@@13|))
))))
...
(assert (forall ((a@@12 T@U) (b@@12 T@U) ) (!  (=> (|Seq#Equal| a@@12 b@@12) (= a@@12 b@@12))
 :qid |DafnyPreludebpl.1225:15|
 :skolemid |241|
 :pattern ( (|Seq#Equal| a@@12 b@@12))
)))
(assert (forall (($ly@@13 T@U) (|es#0@@6| T@U) (|ctx#0@@7| T@U) ) (!  (=> (or (|Interp.__default.InterpExprs#canCall| (Lit SeqType |es#0@@6|) |ctx#0@@7|) (and ($Is SeqType |es#0@@6| (TSeq Tclass.AST.Expr)) ($Is MapType |ctx#0@@7| (TMap (TSeq TChar) TInt)))) (and (=> (not (|Seq#Equal| |es#0@@6| |Seq#Empty|)) (and (|Interp.__default.InterpExpr#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@6|) (LitInt 0))) |ctx#0@@7|) (let ((|valueOrError0#1@@0| (Interp.__default.InterpExpr ($LS $ly@@13) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@6|) (LitInt 0))) |ctx#0@@7|)))
 ...
 (and (|Interp.__default.InterpExprs#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@6|) (LitInt 1))) |ctx1#1@@0|) (let ((|valueOrError1#1@@0| (Interp.__default.InterpExprs ($LS $ly@@13) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@6|) (LitInt 1))) |ctx1#1@@0|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError1#1@@0|)))))))))))) (= (Interp.__default.InterpExprs ($LS $ly@@13) (Lit SeqType |es#0@@6|) |ctx#0@@7|) (ite (|Seq#Equal| |es#0@@6| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (Lit SeqType |Seq#Empty|)) ($Box MapType |ctx#0@@7|)))) (let ((|valueOrError0#1@@1| (Interp.__default.InterpExpr ($LS $ly@@13) ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType |es#0@@6|) (LitInt 0))) |ctx#0@@7|)))
...
(let ((|valueOrError1#1@@1| (Interp.__default.InterpExprs ($LS $ly@@13) (Lit SeqType (|Seq#Drop| (Lit SeqType |es#0@@6|) (LitInt 1))) |ctx1#1@@1|)))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box SeqType (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |v#1|))) |vs#1@@0|)) ($Box MapType |ctx2#1@@0|))))))))))))))))
 ...
 :weight 3
 :skolemid |1222|
 :pattern ( (Interp.__default.InterpExprs ($LS $ly@@13) (Lit SeqType |es#0@@6|) |ctx#0@@7|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|e#0@@14| T@U) (|st'#0@@0| T@U) (|v#0@@1| Int) ) (!  (=> (or (|VarUnchanged.__default.P__Succ#canCall| (Lit DatatypeTypeType |st#0@@6|) (Lit DatatypeTypeType |e#0@@14|) (Lit DatatypeTypeType |st'#0@@0|) (LitInt |v#0@@1|)) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@6| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@14| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@0| Tclass.VarUnchanged.S)))) (and (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@6|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@14|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@6|))))) (let ((|res#2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@14|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@6|)))))))
 (and (|VarUnchanged.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@6|) (Lit DatatypeTypeType |e#0@@14|)) (=> (U_2_bool (Lit boolType (bool_2_U (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@6|) (Lit DatatypeTypeType |e#0@@14|))))) (and (|VarUnchanged.__default.ResultSameX#canCall| (Lit DatatypeTypeType |st#0@@6|) |res#2|) (=> (VarUnchanged.__default.ResultSameX (Lit DatatypeTypeType |st#0@@6|) |res#2|) (and (and (|$IsA#Utils.Result| |res#2|) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|))) (=> (|Utils.Result#Equal| |res#2| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt |v#0@@1|))) ($Box MapType (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st'#0@@0|))))))))) (and (and (|$IsA#Utils.Option| (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st'#0@@0|)))) (|$IsA#Utils.Option| (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@6|))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st'#0@@0|)) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@6|)))))))))))) (= (VarUnchanged.__default.P__Succ (Lit DatatypeTypeType |st#0@@6|) (Lit DatatypeTypeType |e#0@@14|) (Lit DatatypeTypeType |st'#0@@0|) (LitInt |v#0@@1|)) (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@14|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@6|)))))))
 (and (and (and (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@6|) (Lit DatatypeTypeType |e#0@@14|)) (VarUnchanged.__default.ResultSameX (Lit DatatypeTypeType |st#0@@6|) |res#2@@0|)) (|Utils.Result#Equal| |res#2@@0| (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt |v#0@@1|))) ($Box MapType (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st'#0@@0|)))))))))) (|Utils.Option#Equal| (VarUnchanged.MState.x (Lit DatatypeTypeType |st'#0@@0|)) (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@6|))))))))
 :qid |Inductiondfy.35:26|
 :weight 3
 :skolemid |731|
 :pattern ( (VarUnchanged.__default.P__Succ (Lit DatatypeTypeType |st#0@@6|) (Lit DatatypeTypeType |e#0@@14|) (Lit DatatypeTypeType |st'#0@@0|) (LitInt |v#0@@1|)))
))))
...
(assert (forall ((a@@13 T@U) (b@@13 T@U) ) (!  (=> (and (Utils.Result.Failure_q a@@13) (Utils.Result.Failure_q b@@13)) (|Utils.Result#Equal| a@@13 b@@13))
 :qid |unknown.0:0|
 :skolemid |993|
 :pattern ( (|Utils.Result#Equal| a@@13 b@@13) (Utils.Result.Failure_q a@@13))
 :pattern ( (|Utils.Result#Equal| a@@13 b@@13) (Utils.Result.Failure_q b@@13))
)))
(assert (forall ((a@@14 T@U) (b@@14 T@U) ) (!  (=> (and (Utils.Option.None_q a@@14) (Utils.Option.None_q b@@14)) (|Utils.Option#Equal| a@@14 b@@14))
 :qid |unknown.0:0|
 :skolemid |1026|
 :pattern ( (|Utils.Option#Equal| a@@14 b@@14) (Utils.Option.None_q a@@14))
 :pattern ( (|Utils.Option#Equal| a@@14 b@@14) (Utils.Option.None_q b@@14))
)))
...
(assert (forall (($ly@@14 T@U) (|e#0@@16| T@U) (|ctx#0@@8| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@16|) (Lit MapType |ctx#0@@8|)) (and ($Is DatatypeTypeType |e#0@@16| Tclass.AST.Expr) ($Is MapType |ctx#0@@8| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@16|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@16|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@16|))))) (let ((|body#5| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@16|)))))
...
(let ((|bvars#5| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@16|)))))
 (and (|Interp.__default.InterpExprs#canCall| |bvals#5| (Lit MapType |ctx#0@@8|)) (let ((|valueOrError0#5| (Interp.__default.InterpExprs ($LS $ly@@14) |bvals#5| (Lit MapType |ctx#0@@8|))))
...
(let ((|avars#5| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@16|)))))
 (and (|Interp.__default.InterpExprs#canCall| |avals#5| (Lit MapType |ctx#0@@8|)) (let ((|valueOrError2#5| (Interp.__default.InterpExprs ($LS $ly@@14) |avals#5| (Lit MapType |ctx#0@@8|))))
...
(let ((|cond#5| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@16|)))))
 (and (|Interp.__default.InterpExpr#canCall| |cond#5| (Lit MapType |ctx#0@@8|)) (let ((|valueOrError3#5| (Interp.__default.InterpExpr ($LS $ly@@14) |cond#5| (Lit MapType |ctx#0@@8|))))
...
(let ((|op#5| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@16|)))))
 (and (|Interp.__default.InterpExpr#canCall| |e1#5| (Lit MapType |ctx#0@@8|)) (let ((|valueOrError4#5| (Interp.__default.InterpExpr ($LS $ly@@14) |e1#5| (Lit MapType |ctx#0@@8|))))
...
(|Interp.__default.InterpBinOp#canCall| |op#5| |v1#5| |v2#5|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@16|)))))) (let ((|es#5| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@16|)))))
 (and (|Interp.__default.InterpExprs#canCall| |es#5| (Lit MapType |ctx#0@@8|)) (let ((|valueOrError6#5| (Interp.__default.InterpExprs ($LS $ly@@14) |es#5| (Lit MapType |ctx#0@@8|))))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#5|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#5|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@14) (Lit DatatypeTypeType |e#0@@16|) (Lit MapType |ctx#0@@8|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|name#4| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@16|)))))
...
(Lit DatatypeTypeType (|#Utils.Result.Success| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#4|)) ($Box MapType (Lit MapType |ctx#0@@8|)))))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|body#4| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@16|)))))
...
(let ((|valueOrError0#4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $ly@@14) |bvals#4| (Lit MapType |ctx#0@@8|)))))
...
(let ((|valueOrError2#4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $ly@@14) |avals#4| (Lit MapType |ctx#0@@8|)))))
...
(let ((|valueOrError3#4| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $ly@@14) |cond#4| (Lit MapType |ctx#0@@8|)))))
...
(ite  (or (not (= |condv#4| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@14) |thn#4| |ctx_cond#4|) (Interp.__default.InterpExpr ($LS $ly@@14) |els#4| |ctx_cond#4|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@16|)) (let ((|e2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@16|)))))
...
(let ((|valueOrError4#4| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $ly@@14) |e1#4| (Lit MapType |ctx#0@@8|)))))
...
(let ((|valueOrError6#4| (Lit DatatypeTypeType (Interp.__default.InterpExprs ($LS $ly@@14) |es#4| (Lit MapType |ctx#0@@8|)))))
...
(ite (|Seq#Equal| |vs#14| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#19|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#14| (- (|Seq#Length| |vs#14|) 1)) ($Box MapType |ctx1#19|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1216|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@14) (Lit DatatypeTypeType |e#0@@16|) (Lit MapType |ctx#0@@8|)))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@15 T@U) (|x#0@@3| T@U) (|e#0@@17| T@U) ) (!  (=> (or (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) (Lit DatatypeTypeType |e#0@@17|)) (and (< 0 $FunctionContextHeight) (and ($Is SeqType |x#0@@3| (TSeq TChar)) ($Is DatatypeTypeType |e#0@@17| Tclass.AST.Expr)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@17|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@17|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@17|))))) (let ((|body#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@17|)))))
...
(let ((|bvars#5@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@17|)))))
 (and (forall ((|e#16| T@U) ) (!  (=> ($Is DatatypeTypeType |e#16| Tclass.AST.Expr__Raw) (=> (|Seq#Contains| |bvals#5@@0| ($Box DatatypeTypeType |e#16|)) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |e#16|)))
 :qid |VarUnchangeddfy.28:17|
 :skolemid |663|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) |x#0@@3| |e#16|))
 :pattern ( (|Seq#Contains| |bvals#5@@0| ($Box DatatypeTypeType |e#16|)))
)) (=> (forall ((|e#16@@0| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#16@@0| Tclass.AST.Expr__Raw) (|Seq#Contains| |bvals#5@@0| ($Box DatatypeTypeType |e#16@@0|))) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |e#16@@0|))
 :qid |VarUnchangeddfy.28:17|
 :skolemid |664|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) |x#0@@3| |e#16@@0|))
 :pattern ( (|Seq#Contains| |bvals#5@@0| ($Box DatatypeTypeType |e#16@@0|)))
)) (=> (not (|Seq#Contains| |bvars#5@@0| ($Box SeqType |x#0@@3|))) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |body#5@@0|)))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@17|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@17|))))) (let ((|avals#5@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|avars#5@@0| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@17|)))))
 (=> (not (|Seq#Contains| |avars#5@@0| ($Box SeqType |x#0@@3|))) (forall ((|e#17| T@U) ) (!  (=> ($Is DatatypeTypeType |e#17| Tclass.AST.Expr__Raw) (=> (|Seq#Contains| |avals#5@@0| ($Box DatatypeTypeType |e#17|)) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |e#17|)))
 :qid |VarUnchangeddfy.32:32|
 :skolemid |665|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) |x#0@@3| |e#17|))
 :pattern ( (|Seq#Contains| |avals#5@@0| ($Box DatatypeTypeType |e#17|)))
)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@17|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@17|))))) (let ((|els#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@17|)))))
...
(let ((|cond#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@17|)))))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |cond#5@@0|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |cond#5@@0|) (and (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |thn#5@@0|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |thn#5@@0|) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |els#5@@0|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@17|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@17|))))) (let ((|oe2#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|oe1#5| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@17|)))))
 (and (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |oe1#5|) (=> (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |oe1#5|) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |oe2#5|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@17|)))))) (let ((|es#5@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@17|)))))
(forall ((|e#18| T@U) ) (!  (=> ($Is DatatypeTypeType |e#18| Tclass.AST.Expr__Raw) (=> (|Seq#Contains| |es#5@@0| ($Box DatatypeTypeType |e#18|)) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType |x#0@@3|) |e#18|)))
 :qid |VarUnchangeddfy.38:16|
 :skolemid |666|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) |x#0@@3| |e#18|))
 :pattern ( (|Seq#Contains| |es#5@@0| ($Box DatatypeTypeType |e#18|)))
))))))))))))) (= (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) (Lit DatatypeTypeType |e#0@@17|)) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@17|)) (U_2_bool (Lit boolType (bool_2_U false))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@17|)) (U_2_bool (Lit boolType (bool_2_U false))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|body#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@17|)))))
...
(let ((|bvars#4@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@17|)))))
 (and (forall ((|e#13| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#13| Tclass.AST.Expr__Raw) (|Seq#Contains| |bvals#4@@0| ($Box DatatypeTypeType |e#13|))) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |e#13|))
 :qid |VarUnchangeddfy.28:17|
 :skolemid |660|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) |x#0@@3| |e#13|))
 :pattern ( (|Seq#Contains| |bvals#4@@0| ($Box DatatypeTypeType |e#13|)))
)) (or (|Seq#Contains| |bvars#4@@0| ($Box SeqType |x#0@@3|)) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |body#4@@0|)))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@17|)) (let ((|avals#4@@0| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|avars#4@@0| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@17|)))))
 (and (not (|Seq#Contains| |avars#4@@0| ($Box SeqType |x#0@@3|))) (forall ((|e#14| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#14| Tclass.AST.Expr__Raw) (|Seq#Contains| |avals#4@@0| ($Box DatatypeTypeType |e#14|))) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |e#14|))
 :qid |VarUnchangeddfy.32:32|
 :skolemid |661|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) |x#0@@3| |e#14|))
 :pattern ( (|Seq#Contains| |avals#4@@0| ($Box DatatypeTypeType |e#14|)))
))))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@17|)) (U_2_bool (let ((|els#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@17|)))))
...
(Lit boolType (bool_2_U  (and (and (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |cond#4@@0|) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |thn#4@@0|)) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |els#4@@0|)))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@17|)) (U_2_bool (let ((|oe2#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@17|)))))
(let ((|oe1#4| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@17|)))))
(Lit boolType (bool_2_U  (and (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |oe1#4|) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |oe2#4|))))))) (let ((|es#4@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@17|)))))
(forall ((|e#15| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#15| Tclass.AST.Expr__Raw) (|Seq#Contains| |es#4@@0| ($Box DatatypeTypeType |e#15|))) (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) |e#15|))
 :qid |VarUnchangeddfy.38:16|
 :skolemid |662|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) |x#0@@3| |e#15|))
 :pattern ( (|Seq#Contains| |es#4@@0| ($Box DatatypeTypeType |e#15|)))
))))))))))))
 :qid |VarUnchangeddfy.17:13|
 :weight 3
 :skolemid |667|
 :pattern ( (VarUnchanged.__default.VarUnchanged ($LS $ly@@15) (Lit SeqType |x#0@@3|) (Lit DatatypeTypeType |e#0@@17|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@7| T@U) (|e#0@@18| T@U) ) (!  (=> (or (|VarUnchanged.__default.P#canCall| (Lit DatatypeTypeType |st#0@@7|) (Lit DatatypeTypeType |e#0@@18|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@7| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@18| Tclass.AST.Expr)))) (and (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@7|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@18|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@7|))))) (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@18|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@7|)))))))
 (and (|VarUnchanged.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@7|) (Lit DatatypeTypeType |e#0@@18|)) (=> (U_2_bool (Lit boolType (bool_2_U (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@7|) (Lit DatatypeTypeType |e#0@@18|))))) (|VarUnchanged.__default.ResultSameX#canCall| (Lit DatatypeTypeType |st#0@@7|) |res#2@@1|))))) (= (VarUnchanged.__default.P (Lit DatatypeTypeType |st#0@@7|) (Lit DatatypeTypeType |e#0@@18|)) (U_2_bool (let ((|res#2@@2| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@18|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@7|)))))))
(Lit boolType (bool_2_U  (=> (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@7|) (Lit DatatypeTypeType |e#0@@18|)) (VarUnchanged.__default.ResultSameX (Lit DatatypeTypeType |st#0@@7|) |res#2@@2|)))))))))
 :qid |Inductiondfy.34:21|
 :weight 3
 :skolemid |723|
 :pattern ( (VarUnchanged.__default.P (Lit DatatypeTypeType |st#0@@7|) (Lit DatatypeTypeType |e#0@@18|)))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|res#0@@2| T@U) ) (!  (=> (or (|VarUnchanged.__default.ResultSameX#canCall| (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |res#0@@2|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@8| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |res#0@@2| (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt))))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@2|))))) (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@2|))))) (let ((|ctx#3| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@2|)))))))))
 (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@2|))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@8|)) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@8|))))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@8|)) (=> (|Set#IsMember| (|Map#Domain| |ctx#3|) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@8|)))))))) (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@8|)) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@8|))) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@8|))))))))))) (= (VarUnchanged.__default.ResultSameX (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |res#0@@2|)) (ite (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@2|)) (let ((|ctx#2| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@2|)))))))))
 (=> (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@8|)))) (and (|Set#IsMember| (Lit SetType (|Map#Domain| |ctx#2|)) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@8|)))))))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@8|)))) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@8|)))))))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#2|) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@8|)))))))))))))) true))))
 :qid |VarUnchangeddfy.41:31|
 :weight 3
 :skolemid |696|
 :pattern ( (VarUnchanged.__default.ResultSameX (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |res#0@@2|)))
))))
...
(assert (forall (($ly@@16 T@U) (|vars#0@@1| T@U) (|values#0@@1| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| |vars#0@@1| |values#0@@1|) (and (and ($Is SeqType |vars#0@@1| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@1| (TSeq TInt))) (= (|Seq#Length| |vars#0@@1|) (|Seq#Length| |values#0@@1|)))) (and (=> (not (|Seq#Equal| |vars#0@@1| |Seq#Empty|)) (|Interp.__default.VarsAndValuesToContext#canCall| (|Seq#Drop| |vars#0@@1| (LitInt 1)) (|Seq#Drop| |values#0@@1| (LitInt 1)))) (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@16) |vars#0@@1| |values#0@@1|) (ite (|Seq#Equal| |vars#0@@1| |Seq#Empty|) |Map#Empty| (|Map#Merge| (|Map#Build| |Map#Empty| (|Seq#Index| |vars#0@@1| (LitInt 0)) (|Seq#Index| |values#0@@1| (LitInt 0))) (Interp.__default.VarsAndValuesToContext $ly@@16 (|Seq#Drop| |vars#0@@1| (LitInt 1)) (|Seq#Drop| |values#0@@1| (LitInt 1))))))))
 :qid |Interpdfy.80:12|
 :skolemid |1228|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@16) |vars#0@@1| |values#0@@1|))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@9| T@U) (|e#0@@19| T@U) (|st'#0@@1| T@U) (|v#0@@2| Int) ) (!  (=> (or (|VarUnchanged.__default.P__Succ#canCall| |st#0@@9| |e#0@@19| |st'#0@@1| |v#0@@2|) (and (< 3 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |st#0@@9| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@19| Tclass.AST.Expr)) ($Is DatatypeTypeType |st'#0@@1| Tclass.VarUnchanged.S)))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@9|) (|Interp.__default.InterpExpr#canCall| |e#0@@19| (VarUnchanged.MState.ctx |st#0@@9|))) (let ((|res#0@@3| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@19| (VarUnchanged.MState.ctx |st#0@@9|))))
 (and (|VarUnchanged.__default.Pre#canCall| |st#0@@9| |e#0@@19|) (=> (VarUnchanged.__default.Pre |st#0@@9| |e#0@@19|) (and (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@9| |res#0@@3|) (=> (VarUnchanged.__default.ResultSameX |st#0@@9| |res#0@@3|) (and (and (|$IsA#Utils.Result| |res#0@@3|) (VarUnchanged.MState.MState_q |st'#0@@1|)) (=> (|Utils.Result#Equal| |res#0@@3| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0@@2|)) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@1|)))))) (and (and (|$IsA#Utils.Option| (VarUnchanged.MState.x |st'#0@@1|)) (|$IsA#Utils.Option| (VarUnchanged.MState.x |st#0@@9|))) (and (VarUnchanged.MState.MState_q |st'#0@@1|) (VarUnchanged.MState.MState_q |st#0@@9|))))))))))) (= (VarUnchanged.__default.P__Succ |st#0@@9| |e#0@@19| |st'#0@@1| |v#0@@2|) (let ((|res#0@@4| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@19| (VarUnchanged.MState.ctx |st#0@@9|))))
 (and (and (and (VarUnchanged.__default.Pre |st#0@@9| |e#0@@19|) (VarUnchanged.__default.ResultSameX |st#0@@9| |res#0@@4|)) (|Utils.Result#Equal| |res#0@@4| (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |v#0@@2|)) ($Box MapType (VarUnchanged.MState.ctx |st'#0@@1|))))))) (|Utils.Option#Equal| (VarUnchanged.MState.x |st'#0@@1|) (VarUnchanged.MState.x |st#0@@9|)))))))
 :qid |Inductiondfy.35:26|
 :skolemid |729|
 :pattern ( (VarUnchanged.__default.P__Succ |st#0@@9| |e#0@@19| |st'#0@@1| |v#0@@2|))
))))
...
(assert (forall (($ly@@17 T@U) (|e#0@@20| T@U) (|ctx#0@@9| T@U) ) (!  (=> (or (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@20|) |ctx#0@@9|) (and ($Is DatatypeTypeType |e#0@@20| Tclass.AST.Expr) ($Is MapType |ctx#0@@9| (TMap (TSeq TChar) TInt)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@20|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@20|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@20|))))) (let ((|body#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@20|)))))
...
(let ((|bvars#3@@0| (Lit SeqType (AST.Expr__Raw.bvars (Lit DatatypeTypeType |e#0@@20|)))))
 (and (|Interp.__default.InterpExprs#canCall| |bvals#3@@0| |ctx#0@@9|) (let ((|valueOrError0#3| (Interp.__default.InterpExprs ($LS $ly@@17) |bvals#3@@0| |ctx#0@@9|)))
...
(let ((|avars#3@@0| (Lit SeqType (AST.Expr__Raw.avars (Lit DatatypeTypeType |e#0@@20|)))))
 (and (|Interp.__default.InterpExprs#canCall| |avals#3@@0| |ctx#0@@9|) (let ((|valueOrError2#3| (Interp.__default.InterpExprs ($LS $ly@@17) |avals#3@@0| |ctx#0@@9|)))
...
(let ((|cond#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@20|)))))
 (and (|Interp.__default.InterpExpr#canCall| |cond#3@@0| |ctx#0@@9|) (let ((|valueOrError3#3| (Interp.__default.InterpExpr ($LS $ly@@17) |cond#3@@0| |ctx#0@@9|)))
...
(let ((|op#3| (Lit DatatypeTypeType (AST.Expr__Raw.op (Lit DatatypeTypeType |e#0@@20|)))))
 (and (|Interp.__default.InterpExpr#canCall| |e1#3| |ctx#0@@9|) (let ((|valueOrError4#3| (Interp.__default.InterpExpr ($LS $ly@@17) |e1#3| |ctx#0@@9|)))
...
(|Interp.__default.InterpBinOp#canCall| |op#3| |v1#3| |v2#3|)))))))))))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@20|)))))) (let ((|es#3@@0| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@20|)))))
 (and (|Interp.__default.InterpExprs#canCall| |es#3@@0| |ctx#0@@9|) (let ((|valueOrError6#3| (Interp.__default.InterpExprs ($LS $ly@@17) |es#3@@0| |ctx#0@@9|)))
 (and (and (|Utils.Result.IsFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (=> (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|) (|Utils.Result.PropagateFailure#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt)) |valueOrError6#3|))) (=> (not (Utils.Result.IsFailure (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)) (|Utils.Result.Extract#canCall| (Tclass._System.Tuple2 (TSeq TInt) (TMap (TSeq TChar) TInt)) |valueOrError6#3|)))))))))))))))) (= (Interp.__default.InterpExpr ($LS $ly@@17) (Lit DatatypeTypeType |e#0@@20|) |ctx#0@@9|) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@20|)) (let ((|name#2| (Lit SeqType (AST.Expr__Raw.name (Lit DatatypeTypeType |e#0@@20|)))))
...
(|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#2|)) ($Box MapType |ctx#0@@9|))))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@20|)) (let ((|body#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@20|)))))
...
(let ((|valueOrError0#2@@1| (Interp.__default.InterpExprs ($LS $ly@@17) |bvals#2@@1| |ctx#0@@9|)))
...
(let ((|valueOrError2#2| (Interp.__default.InterpExprs ($LS $ly@@17) |avals#2@@1| |ctx#0@@9|)))
...
(let ((|valueOrError3#2| (Interp.__default.InterpExpr ($LS $ly@@17) |cond#2@@0| |ctx#0@@9|)))
...
(ite  (or (not (= |condv#2| 0)) (not true)) (Interp.__default.InterpExpr ($LS $ly@@17) |thn#2@@0| |ctx_cond#2|) (Interp.__default.InterpExpr ($LS $ly@@17) |els#2@@0| |ctx_cond#2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@20|)) (let ((|e2#2| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@20|)))))
...
(let ((|valueOrError4#2| (Interp.__default.InterpExpr ($LS $ly@@17) |e1#2| |ctx#0@@9|)))
...
(let ((|valueOrError6#2| (Interp.__default.InterpExprs ($LS $ly@@17) |es#2@@0| |ctx#0@@9|)))
...
(ite (|Seq#Equal| |vs#8| |Seq#Empty|) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 0))) ($Box MapType |ctx1#11|)))) (|#Utils.Result.Success| ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| (|Seq#Index| |vs#8| (- (|Seq#Length| |vs#8|) 1)) ($Box MapType |ctx1#11|)))))))))))))))))))
 ...
 :weight 3
 :skolemid |1215|
 :pattern ( (Interp.__default.InterpExpr ($LS $ly@@17) (Lit DatatypeTypeType |e#0@@20|) |ctx#0@@9|))
)))
...
(assert (forall (($ly@@18 T@U) (|vars#0@@2| T@U) (|values#0@@2| T@U) ) (!  (=> (or (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType |vars#0@@2|) (Lit SeqType |values#0@@2|)) (and (and ($Is SeqType |vars#0@@2| (TSeq (TSeq TChar))) ($Is SeqType |values#0@@2| (TSeq TInt))) (= (|Seq#Length| (Lit SeqType |vars#0@@2|)) (|Seq#Length| (Lit SeqType |values#0@@2|))))) (and (=> (not (|Seq#Equal| |vars#0@@2| |Seq#Empty|)) (|Interp.__default.VarsAndValuesToContext#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |vars#0@@2|) (LitInt 1))) (Lit SeqType (|Seq#Drop| (Lit SeqType |values#0@@2|) (LitInt 1))))) (= (Interp.__default.VarsAndValuesToContext ($LS $ly@@18) (Lit SeqType |vars#0@@2|) (Lit SeqType |values#0@@2|)) (ite (|Seq#Equal| |vars#0@@2| |Seq#Empty|) |Map#Empty| (|Map#Merge| (|Map#Build| |Map#Empty| (|Seq#Index| (Lit SeqType |vars#0@@2|) (LitInt 0)) (|Seq#Index| (Lit SeqType |values#0@@2|) (LitInt 0))) (Interp.__default.VarsAndValuesToContext ($LS $ly@@18) (Lit SeqType (|Seq#Drop| (Lit SeqType |vars#0@@2|) (LitInt 1))) (Lit SeqType (|Seq#Drop| (Lit SeqType |values#0@@2|) (LitInt 1)))))))))
 :qid |Interpdfy.80:12|
 :weight 3
 :skolemid |1229|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $ly@@18) (Lit SeqType |vars#0@@2|) (Lit SeqType |values#0@@2|)))
)))
...
(let ((|cond#3@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@21|)))))
 (and (|AST.Expr__Raw.All#canCall| |cond#3@@1| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@19) |cond#3@@1| |p#0@@1|) (and (|AST.Expr__Raw.All#canCall| |thn#3@@1| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@19) |thn#3@@1| |p#0@@1|) (|AST.Expr__Raw.All#canCall| |els#3@@1| |p#0@@1|))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@21|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@21|))))) (let ((|oe2#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@21|)))))
(let ((|oe1#3@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@21|)))))
 (and (|AST.Expr__Raw.All#canCall| |oe1#3@@0| |p#0@@1|) (=> (AST.Expr__Raw.All ($LS $ly@@19) |oe1#3@@0| |p#0@@1|) (|AST.Expr__Raw.All#canCall| |oe2#3@@0| |p#0@@1|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@21|)))))) (let ((|es#3@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@21|)))))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@19) (Lit DatatypeTypeType |e#0@@21|) |p#0@@1|)  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@2 |p#0@@1| ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@21|))))) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@21|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@21|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@21|)) (let ((|body#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@21|)))))
...
)) (AST.Expr__Raw.All ($LS $ly@@19) |body#2@@1| |p#0@@1|)))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@21|)) (let ((|avals#2@@2| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@21|)))))
...
(let ((|cond#2@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@21|)))))
 (and (and (AST.Expr__Raw.All ($LS $ly@@19) |cond#2@@1| |p#0@@1|) (AST.Expr__Raw.All ($LS $ly@@19) |thn#2@@1| |p#0@@1|)) (AST.Expr__Raw.All ($LS $ly@@19) |els#2@@1| |p#0@@1|))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@21|)) (let ((|oe2#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@21|)))))
(let ((|oe1#2@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@21|)))))
 (and (AST.Expr__Raw.All ($LS $ly@@19) |oe1#2@@0| |p#0@@1|) (AST.Expr__Raw.All ($LS $ly@@19) |oe2#2@@0| |p#0@@1|)))) (let ((|es#2@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@21|)))))
 ...
 :weight 3
 :skolemid |1172|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@19) (Lit DatatypeTypeType |e#0@@21|) |p#0@@1|) ($IsGoodHeap $Heap@@2))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@10| T@U) (|e#0@@22| T@U) ) (!  (=> (or (|VarUnchanged.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@10|) (Lit DatatypeTypeType |e#0@@22|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@10| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@22| Tclass.AST.Expr)))) (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@10|)) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@10|))))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@10|)) (|VarUnchanged.__default.VarUnchanged#canCall| (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@10|)))))) (Lit DatatypeTypeType |e#0@@22|))))) (= (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@10|) (Lit DatatypeTypeType |e#0@@22|)) (U_2_bool (Lit boolType (bool_2_U  (=> (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@10|)))) (VarUnchanged.__default.VarUnchanged ($LS $LZ) (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@10|)))))) (Lit DatatypeTypeType |e#0@@22|)))))))))
 :qid |VarUnchangeddfy.82:23|
 :weight 3
 :skolemid |705|
 :pattern ( (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@10|) (Lit DatatypeTypeType |e#0@@22|)))
))))
...
(assert (forall ((|op#0@@1| T@U) (|x#0@@4| Int) (|y#0@@0| Int) ) (!  (=> (or (|Interp.__default.InterpBinOp#canCall| (Lit DatatypeTypeType |op#0@@1|) (LitInt |x#0@@4|) (LitInt |y#0@@0|)) ($Is DatatypeTypeType |op#0@@1| Tclass.AST.BinOp)) (= (Interp.__default.InterpBinOp (Lit DatatypeTypeType |op#0@@1|) (LitInt |x#0@@4|) (LitInt |y#0@@0|)) (ite (AST.BinOp.Add_q (Lit DatatypeTypeType |op#0@@1|)) (+ |x#0@@4| |y#0@@0|) (ite (AST.BinOp.Sub_q (Lit DatatypeTypeType |op#0@@1|)) (- |x#0@@4| |y#0@@0|) (Mul (LitInt |x#0@@4|) (LitInt |y#0@@0|))))))
 :qid |Interpdfy.16:24|
 :weight 3
 :skolemid |1209|
 :pattern ( (Interp.__default.InterpBinOp (Lit DatatypeTypeType |op#0@@1|) (LitInt |x#0@@4|) (LitInt |y#0@@0|)))
)))
...
(assert (forall (($ly@@20 T@U) ($Heap@@4 T@U) (|e#0@@24| T@U) (|p#0@@2| T@U) ) (!  (=> (or (|AST.Expr__Raw.All#canCall| (Lit DatatypeTypeType |e#0@@24|) (Lit HandleTypeType |p#0@@2|)) (and (and ($IsGoodHeap $Heap@@4) ($Is DatatypeTypeType |e#0@@24| Tclass.AST.Expr__Raw)) ($Is HandleTypeType |p#0@@2| (Tclass._System.___hTotalFunc1 Tclass.AST.Expr__Raw TBool)))) (and (=> (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@4 (Lit HandleTypeType |p#0@@2|) ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@24|))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@24|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@24|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@24|))))) (let ((|body#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|bvals#5@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@24|)))))
...
)) (|AST.Expr__Raw.All#canCall| |body#5@@1| (Lit HandleTypeType |p#0@@2|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@24|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@24|))))) (let ((|avals#5@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@24|)))))
...
))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@24|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@24|))))) (let ((|els#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|thn#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|cond#5@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@24|)))))
 (and (|AST.Expr__Raw.All#canCall| |cond#5@@1| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@20) |cond#5@@1| (Lit HandleTypeType |p#0@@2|)) (and (|AST.Expr__Raw.All#canCall| |thn#5@@1| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@20) |thn#5@@1| (Lit HandleTypeType |p#0@@2|)) (|AST.Expr__Raw.All#canCall| |els#5@@1| (Lit HandleTypeType |p#0@@2|)))))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@24|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@24|))))) (let ((|oe2#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|oe1#5@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@24|)))))
 (and (|AST.Expr__Raw.All#canCall| |oe1#5@@0| (Lit HandleTypeType |p#0@@2|)) (=> (AST.Expr__Raw.All ($LS $ly@@20) |oe1#5@@0| (Lit HandleTypeType |p#0@@2|)) (|AST.Expr__Raw.All#canCall| |oe2#5@@0| (Lit HandleTypeType |p#0@@2|))))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@24|)))))) (let ((|es#5@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@24|)))))
...
))))))))))))))) (= (AST.Expr__Raw.All ($LS $ly@@20) (Lit DatatypeTypeType |e#0@@24|) (Lit HandleTypeType |p#0@@2|))  (and (U_2_bool ($Unbox boolType (Apply1 Tclass.AST.Expr__Raw TBool $Heap@@4 (Lit HandleTypeType |p#0@@2|) ($Box DatatypeTypeType (Lit DatatypeTypeType |e#0@@24|))))) (ite (AST.Expr__Raw.Var_q (Lit DatatypeTypeType |e#0@@24|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Literal_q (Lit DatatypeTypeType |e#0@@24|)) (U_2_bool (Lit boolType (bool_2_U true))) (ite (AST.Expr__Raw.Bind_q (Lit DatatypeTypeType |e#0@@24|)) (let ((|body#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.body (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|bvals#4@@1| (Lit SeqType (AST.Expr__Raw.bvals (Lit DatatypeTypeType |e#0@@24|)))))
...
)) (AST.Expr__Raw.All ($LS $ly@@20) |body#4@@1| (Lit HandleTypeType |p#0@@2|))))) (ite (AST.Expr__Raw.Assign_q (Lit DatatypeTypeType |e#0@@24|)) (let ((|avals#4@@1| (Lit SeqType (AST.Expr__Raw.avals (Lit DatatypeTypeType |e#0@@24|)))))
...
)))) (ite (AST.Expr__Raw.If_q (Lit DatatypeTypeType |e#0@@24|)) (U_2_bool (let ((|els#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.els (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|thn#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.thn (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|cond#4@@1| (Lit DatatypeTypeType (AST.Expr__Raw.cond (Lit DatatypeTypeType |e#0@@24|)))))
(Lit boolType (bool_2_U  (and (and (AST.Expr__Raw.All ($LS $ly@@20) |cond#4@@1| (Lit HandleTypeType |p#0@@2|)) (AST.Expr__Raw.All ($LS $ly@@20) |thn#4@@1| (Lit HandleTypeType |p#0@@2|))) (AST.Expr__Raw.All ($LS $ly@@20) |els#4@@1| (Lit HandleTypeType |p#0@@2|))))))))) (ite (AST.Expr__Raw.Op_q (Lit DatatypeTypeType |e#0@@24|)) (U_2_bool (let ((|oe2#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe2 (Lit DatatypeTypeType |e#0@@24|)))))
(let ((|oe1#4@@0| (Lit DatatypeTypeType (AST.Expr__Raw.oe1 (Lit DatatypeTypeType |e#0@@24|)))))
(Lit boolType (bool_2_U  (and (AST.Expr__Raw.All ($LS $ly@@20) |oe1#4@@0| (Lit HandleTypeType |p#0@@2|)) (AST.Expr__Raw.All ($LS $ly@@20) |oe2#4@@0| (Lit HandleTypeType |p#0@@2|)))))))) (let ((|es#4@@1| (Lit SeqType (AST.Expr__Raw.es (Lit DatatypeTypeType |e#0@@24|)))))
 ...
 :weight 3
 :skolemid |1180|
 :pattern ( (AST.Expr__Raw.All ($LS $ly@@20) (Lit DatatypeTypeType |e#0@@24|) (Lit HandleTypeType |p#0@@2|)) ($IsGoodHeap $Heap@@4))
)))
...
(set-info :boogie-vc-id Impl$$VarUnchanged.__default.P__Succ__Sound)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|VarUnchanged.__default.P#canCall| |st#0@@11| |e#0@@25|) (or (VarUnchanged.__default.P |st#0@@11| |e#0@@25|) (let ((|res#1@@3| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@25| (VarUnchanged.MState.ctx |st#0@@11|))))
 (=> (VarUnchanged.__default.Pre |st#0@@11| |e#0@@25|) (=> (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@11| |res#1@@3|) (or (VarUnchanged.__default.ResultSameX |st#0@@11| |res#1@@3|) (=> (Utils.Result.Success_q |res#1@@3|) (let ((|ctx#2@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@3|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@11|)) (|Set#IsMember| (|Map#Domain| |ctx#2@@0|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@11|))))))))))))) (=> (=> (|VarUnchanged.__default.P#canCall| |st#0@@11| |e#0@@25|) (or (VarUnchanged.__default.P |st#0@@11| |e#0@@25|) (let ((|res#1@@4| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@25| (VarUnchanged.MState.ctx |st#0@@11|))))
 (=> (VarUnchanged.__default.Pre |st#0@@11| |e#0@@25|) (=> (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@11| |res#1@@4|) (or (VarUnchanged.__default.ResultSameX |st#0@@11| |res#1@@4|) (=> (Utils.Result.Success_q |res#1@@4|) (let ((|ctx#2@@1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@4|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@11|)) (|Set#IsMember| (|Map#Domain| |ctx#2@@1|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@11|)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|VarUnchanged.__default.P#canCall| |st#0@@11| |e#0@@25|) (or (VarUnchanged.__default.P |st#0@@11| |e#0@@25|) (let ((|res#1@@5| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@25| (VarUnchanged.MState.ctx |st#0@@11|))))
 (=> (VarUnchanged.__default.Pre |st#0@@11| |e#0@@25|) (=> (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@11| |res#1@@5|) (or (VarUnchanged.__default.ResultSameX |st#0@@11| |res#1@@5|) (=> (Utils.Result.Success_q |res#1@@5|) (let ((|ctx#2@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@5|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@11|)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (VarUnchanged.MState.ctx |st#0@@11|)) (Utils.Option.value (VarUnchanged.MState.x |st#0@@11|))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#2@@2|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@11|)))))))))))))))) (=> (=> (|VarUnchanged.__default.P#canCall| |st#0@@11| |e#0@@25|) (or (VarUnchanged.__default.P |st#0@@11| |e#0@@25|) (let ((|res#1@@6| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@25| (VarUnchanged.MState.ctx |st#0@@11|))))
 (=> (VarUnchanged.__default.Pre |st#0@@11| |e#0@@25|) (=> (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@11| |res#1@@6|) (or (VarUnchanged.__default.ResultSameX |st#0@@11| |res#1@@6|) (=> (Utils.Result.Success_q |res#1@@6|) (let ((|ctx#2@@3| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@6|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@11|)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (VarUnchanged.MState.ctx |st#0@@11|)) (Utils.Option.value (VarUnchanged.MState.x |st#0@@11|))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#2@@3|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@11|))))))))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|VarUnchanged.__default.P#canCall| |st#0@@11| |e#0@@25|) (or (VarUnchanged.__default.P |st#0@@11| |e#0@@25|) (let ((|res#1@@7| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@25| (VarUnchanged.MState.ctx |st#0@@11|))))
 (=> (VarUnchanged.__default.Pre |st#0@@11| |e#0@@25|) (=> (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@11| |res#1@@7|) (or (VarUnchanged.__default.ResultSameX |st#0@@11| |res#1@@7|) (=> (not (Utils.Result.Success_q |res#1@@7|)) (U_2_bool (Lit boolType (bool_2_U true))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (and ($Is DatatypeTypeType |st#0@@11| Tclass.VarUnchanged.S) ($IsAlloc DatatypeTypeType |st#0@@11| Tclass.VarUnchanged.S $Heap@@6)) (|$IsA#VarUnchanged.MState| |st#0@@11|)) (and (and ($Is DatatypeTypeType |e#0@@25| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@25| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@25|))) (=> (and (and (and (and ($Is DatatypeTypeType |st'#0@@2| Tclass.VarUnchanged.S) ($IsAlloc DatatypeTypeType |st'#0@@2| Tclass.VarUnchanged.S $Heap@@6)) (|$IsA#VarUnchanged.MState| |st'#0@@2|)) (= 4 $FunctionContextHeight)) (and (VarUnchanged.__default.P__Succ |st#0@@11| |e#0@@25| |st'#0@@2| |v#0@@3|) (= (ControlFlow 0 5) 2))) anon0_correct)))))
