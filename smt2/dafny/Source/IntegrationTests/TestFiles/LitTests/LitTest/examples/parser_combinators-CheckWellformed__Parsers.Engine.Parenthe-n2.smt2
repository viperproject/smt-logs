...
(declare-fun |pos#0@@12| () Int)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$Parsers.Engine.Parentheses)
...
(let ((anon11_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |r#0@0| (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.Tuple0)) ($IsAlloc DatatypeTypeType |r#0@0| (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.Tuple0) |$lambdaHeap#0@0|))) (= (ControlFlow 0 5) 3)) anon6_correct)))
(let ((anon11_Then_correct  (=> (and (and (and ($Is DatatypeTypeType |r#0@0| (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.Tuple0)) ($IsAlloc DatatypeTypeType |r#0@0| (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.Tuple0) |$lambdaHeap#0@0|)) (and (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (_System.Tuple2.___hMake2_q |r#0@0|))) (and (and (= |lambdaResult#0| (U_2_int ($Unbox intType (_System.Tuple2._0 |r#0@0|)))) (_System.Tuple2.___hMake2_q |r#0@0|)) (and ($Is intType (int_2_U |lambdaResult#0|) Tclass._System.nat) (= (ControlFlow 0 4) 3)))) anon6_correct)))
(let ((anon10_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@19 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@19 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 6) 4) anon11_Then_correct) (=> (= (ControlFlow 0 6) 5) anon11_Else_correct)))))
(let ((anon10_Else_correct true))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (or (not (= 3 $FunctionContextHeight)) (not true))) (=> (or (not (= 3 $FunctionContextHeight)) (not true)) (=> (= |##left#0@0| (|Parsers.Engine.Parentheses_k#Handle| ($LS $LZ) |reveal_Parsers.Engine.Parentheses'| this@@27)) (=> (and (and ($IsAlloc HandleTypeType |##left#0@0| (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Tclass._System.nat)) $Heap@@19) (= |##right#0@0| (Parsers.Engine.EOS this@@27))) (and ($IsAlloc HandleTypeType |##right#0@0| (Tclass._System.___hPartialFunc1 Tclass._System.nat (Tclass.Parsers.ParseResult Tclass._System.Tuple0)) $Heap@@19) (|Parsers.Engine.Concat#canCall| Tclass._System.nat Tclass._System.Tuple0 (|Parsers.Engine.Parentheses_k#Handle| ($LS $LZ) |reveal_Parsers.Engine.Parentheses'| this@@27) (Parsers.Engine.EOS this@@27)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (Requires1 Tclass._System.nat (Tclass.Parsers.ParseResult (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.Tuple0)) $Heap@@19 (Parsers.Engine.Concat Tclass._System.nat Tclass._System.Tuple0 reveal_Parsers.Engine.Concat (|Parsers.Engine.Parentheses_k#Handle| ($LS $LZ) |reveal_Parsers.Engine.Parentheses'| this@@27) (Parsers.Engine.EOS this@@27)) ($Box intType (int_2_U |pos#0@@12|)))) (=> (Requires1 Tclass._System.nat (Tclass.Parsers.ParseResult (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.Tuple0)) $Heap@@19 (Parsers.Engine.Concat Tclass._System.nat Tclass._System.Tuple0 reveal_Parsers.Engine.Concat (|Parsers.Engine.Parentheses_k#Handle| ($LS $LZ) |reveal_Parsers.Engine.Parentheses'| this@@27) (Parsers.Engine.EOS this@@27)) ($Box intType (int_2_U |pos#0@@12|))) (=> ($IsAllocBox (Apply1 Tclass._System.nat (Tclass.Parsers.ParseResult (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.Tuple0)) $Heap@@19 (Parsers.Engine.Concat Tclass._System.nat Tclass._System.Tuple0 reveal_Parsers.Engine.Concat (|Parsers.Engine.Parentheses_k#Handle| ($LS $LZ) |reveal_Parsers.Engine.Parentheses'| this@@27) (Parsers.Engine.EOS this@@27)) ($Box intType (int_2_U |pos#0@@12|))) (Tclass.Parsers.ParseResult (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.Tuple0)) $Heap@@19) (and (=> (= (ControlFlow 0 7) 6) anon10_Then_correct) (=> (= (ControlFlow 0 7) 2) anon10_Else_correct)))))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@19 alloc false)) (and (=> (= (ControlFlow 0 10) 1) anon9_Then_correct) (=> (= (ControlFlow 0 10) 7) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@19) ($IsHeapAnchor $Heap@@19)) (=> (and (and (and ($Is DatatypeTypeType this@@27 Tclass.Parsers.Engine) ($IsAlloc DatatypeTypeType this@@27 Tclass.Parsers.Engine $Heap@@19)) (<= (LitInt 0) |pos#0@@12|)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct))))
