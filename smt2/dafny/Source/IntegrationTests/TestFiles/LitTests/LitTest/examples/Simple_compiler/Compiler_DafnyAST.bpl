           ...
           ==> (DafnyAST.BinOp.Add_q(DafnyAST.Expr.op(e#0))
               ==> (var e2#2 := DafnyAST.Expr.e2(e#0); 
                (var e1#2 := DafnyAST.Expr.e1(e#0); 
                  DafnyAST.__default.interpExpr#canCall(e1#2, ctx#0)
                     && DafnyAST.__default.interpExpr#canCall(e2#2, ctx#0))))
             && (!DafnyAST.BinOp.Add_q(DafnyAST.Expr.op(e#0))
               ==> (var e2#3 := DafnyAST.Expr.e2(e#0); 
                (var e1#3 := DafnyAST.Expr.e1(e#0); 
                  DafnyAST.__default.interpExpr#canCall(e1#3, ctx#0)
                     && DafnyAST.__default.interpExpr#canCall(e2#3, ctx#0)))))
         && DafnyAST.__default.interpExpr($LS($ly), e#0, ctx#0)
           == (if DafnyAST.Expr.Const_q(e#0)
             then (var n#0 := DafnyAST.Expr.n(e#0); n#0)
             else (if DafnyAST.Expr.Var_q(e#0)
               then (var v#0 := DafnyAST.Expr.v(e#0); 
                (if Set#IsMember(Map#Domain(ctx#0), $Box(v#0))
                   then $Unbox(Map#Elements(ctx#0)[$Box(v#0)]): int
                   else 0))
               else (if DafnyAST.BinOp.Add_q(DafnyAST.Expr.op(e#0))
                 then (var e2#0 := DafnyAST.Expr.e2(e#0); 
                  (var e1#0 := DafnyAST.Expr.e1(e#0); 
                    DafnyAST.__default.interpExpr($ly, e1#0, ctx#0)
                       + DafnyAST.__default.interpExpr($ly, e2#0, ctx#0)))
                 else (var e2#1 := DafnyAST.Expr.e2(e#0); 
                  (var e1#1 := DafnyAST.Expr.e1(e#0); 
                    DafnyAST.__default.interpExpr($ly, e1#1, ctx#0)
                       - DafnyAST.__default.interpExpr($ly, e2#1, ctx#0)))))));
           ...
           ==> (Lit(DafnyAST.BinOp.Add_q(Lit(DafnyAST.Expr.op(Lit(e#0)))))
               ==> (var e2#6 := Lit(DafnyAST.Expr.e2(Lit(e#0))); 
                (var e1#6 := Lit(DafnyAST.Expr.e1(Lit(e#0))); 
                  DafnyAST.__default.interpExpr#canCall(e1#6, Lit(ctx#0))
                     && DafnyAST.__default.interpExpr#canCall(e2#6, Lit(ctx#0)))))
             && (!Lit(DafnyAST.BinOp.Add_q(Lit(DafnyAST.Expr.op(Lit(e#0)))))
               ==> (var e2#7 := Lit(DafnyAST.Expr.e2(Lit(e#0))); 
                (var e1#7 := Lit(DafnyAST.Expr.e1(Lit(e#0))); 
                  DafnyAST.__default.interpExpr#canCall(e1#7, Lit(ctx#0))
                     && DafnyAST.__default.interpExpr#canCall(e2#7, Lit(ctx#0))))))
         && DafnyAST.__default.interpExpr($LS($ly), Lit(e#0), Lit(ctx#0))
           == (if DafnyAST.Expr.Const_q(Lit(e#0))
             then (var n#2 := LitInt(DafnyAST.Expr.n(Lit(e#0))); n#2)
             else (if DafnyAST.Expr.Var_q(Lit(e#0))
               then (var v#2 := Lit(DafnyAST.Expr.v(Lit(e#0))); 
                (if Set#IsMember(Lit(Map#Domain(Lit(ctx#0))), $Box(v#2))
                   then $Unbox(Map#Elements(Lit(ctx#0))[$Box(v#2)]): int
                   else 0))
                 ...
                 then (var e2#4 := Lit(DafnyAST.Expr.e2(Lit(e#0))); 
                  (var e1#4 := Lit(DafnyAST.Expr.e1(Lit(e#0))); 
                    LitInt(DafnyAST.__default.interpExpr($LS($ly), e1#4, Lit(ctx#0))
                         + DafnyAST.__default.interpExpr($LS($ly), e2#4, Lit(ctx#0)))))
                 else (var e2#5 := Lit(DafnyAST.Expr.e2(Lit(e#0))); 
                  (var e1#5 := Lit(DafnyAST.Expr.e1(Lit(e#0))); 
                    LitInt(DafnyAST.__default.interpExpr($LS($ly), e1#5, Lit(ctx#0))
                         - DafnyAST.__default.interpExpr($LS($ly), e2#5, Lit(ctx#0)))))))));
}
...
procedure {:verboseName "DafnyAST.interpExpr (well-formedness)"} CheckWellformed$$DafnyAST.__default.interpExpr(e#0: DatatypeType where $Is(e#0, Tclass.DafnyAST.Expr()), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "DafnyAST.interpExpr (well-formedness)"} CheckWellformed$$DafnyAST.__default.interpExpr(e#0: DatatypeType, ctx#0: Map)
{
  ...
  var let#5#0#0: int;
    ...
    else
    {
        ...
        {
            havoc n#Z#0;
            assume {:id "id21"} let#5#0#0 == _mcc#0#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#5#0#0, TInt);
            assume {:id "id22"} n#Z#0 == let#5#0#0;
            assume {:id "id23"} DafnyAST.__default.interpExpr($LS($LZ), e#0, ctx#0) == n#Z#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(DafnyAST.__default.interpExpr($LS($LZ), e#0, ctx#0), TInt);
            return;
        }
        else if (e#0 == #DafnyAST.Expr.Var(_mcc#1#0))
        {
            ...
            havoc v#Z#0;
            assume {:id "id16"} let#4#0#0 == _mcc#1#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#4#0#0, TSeq(TChar));
            assume {:id "id17"} v#Z#0 == let#4#0#0;
            if (Set#IsMember(Map#Domain(ctx#0), $Box(v#Z#0)))
            {
                assert {:id "id18"} Set#IsMember(Map#Domain(ctx#0), $Box(v#Z#0));
                assume {:id "id19"} DafnyAST.__default.interpExpr($LS($LZ), e#0, ctx#0)
                   == $Unbox(Map#Elements(ctx#0)[$Box(v#Z#0)]): int;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(DafnyAST.__default.interpExpr($LS($LZ), e#0, ctx#0), TInt);
                return;
            ...
            {
                assume {:id "id20"} DafnyAST.__default.interpExpr($LS($LZ), e#0, ctx#0) == LitInt(0);
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(DafnyAST.__default.interpExpr($LS($LZ), e#0, ctx#0), TInt);
                return;
        ...
        else if (e#0 == #DafnyAST.Expr.Op(_mcc#2#0, _mcc#3#0, _mcc#4#0))
        {
            ...
            {
                havoc e2#Z#1;
                assume {:id "id9"} let#2#0#0 == _mcc#4#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#2#0#0, Tclass.DafnyAST.Expr());
                assume {:id "id10"} e2#Z#1 == let#2#0#0;
                havoc e1#Z#1;
                assume {:id "id11"} let#3#0#0 == _mcc#3#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#3#0#0, Tclass.DafnyAST.Expr());
                assume {:id "id12"} e1#Z#1 == let#3#0#0;
                ##e#2 := e1#Z#1;
                ...
                assert {:id "id13"} DtRank(##e#2) < DtRank(e#0)
                   || (DtRank(##e#2) == DtRank(e#0)
                     && 
                    Set#Subset(Map#Domain(##ctx#2), Map#Domain(ctx#0))
                     && !Set#Subset(Map#Domain(ctx#0), Map#Domain(##ctx#2)));
                assume DafnyAST.__default.interpExpr#canCall(e1#Z#1, ctx#0);
                ##e#3 := e2#Z#1;
                // assume allocatedness for argument to function
                ...
                assert {:id "id14"} DtRank(##e#3) < DtRank(e#0)
                   || (DtRank(##e#3) == DtRank(e#0)
                     && 
                    Set#Subset(Map#Domain(##ctx#3), Map#Domain(ctx#0))
                     && !Set#Subset(Map#Domain(ctx#0), Map#Domain(##ctx#3)));
                assume DafnyAST.__default.interpExpr#canCall(e2#Z#1, ctx#0);
                assume {:id "id15"} DafnyAST.__default.interpExpr($LS($LZ), e#0, ctx#0)
                   == DafnyAST.__default.interpExpr($LS($LZ), e1#Z#1, ctx#0)
                     + DafnyAST.__default.interpExpr($LS($LZ), e2#Z#1, ctx#0);
                assume DafnyAST.__default.interpExpr#canCall(e1#Z#1, ctx#0)
                   && DafnyAST.__default.interpExpr#canCall(e2#Z#1, ctx#0);
                // CheckWellformedWithResult: any expression
                assume $Is(DafnyAST.__default.interpExpr($LS($LZ), e#0, ctx#0), TInt);
                return;
            }
            else if (_mcc#2#0 == #DafnyAST.BinOp.Sub())
            {
                ...
                assert {:id "id6"} DtRank(##e#0) < DtRank(e#0)
                   || (DtRank(##e#0) == DtRank(e#0)
                     && 
                    Set#Subset(Map#Domain(##ctx#0), Map#Domain(ctx#0))
                     && !Set#Subset(Map#Domain(ctx#0), Map#Domain(##ctx#0)));
                assume DafnyAST.__default.interpExpr#canCall(e1#Z#0, ctx#0);
                ##e#1 := e2#Z#0;
                // assume allocatedness for argument to function
                ...
                assert {:id "id7"} DtRank(##e#1) < DtRank(e#0)
                   || (DtRank(##e#1) == DtRank(e#0)
                     && 
                    Set#Subset(Map#Domain(##ctx#1), Map#Domain(ctx#0))
                     && !Set#Subset(Map#Domain(ctx#0), Map#Domain(##ctx#1)));
                assume DafnyAST.__default.interpExpr#canCall(e2#Z#0, ctx#0);
                assume {:id "id8"} DafnyAST.__default.interpExpr($LS($LZ), e#0, ctx#0)
                   == DafnyAST.__default.interpExpr($LS($LZ), e1#Z#0, ctx#0)
                     - DafnyAST.__default.interpExpr($LS($LZ), e2#Z#0, ctx#0);
                assume DafnyAST.__default.interpExpr#canCall(e1#Z#0, ctx#0)
                   && DafnyAST.__default.interpExpr#canCall(e2#Z#0, ctx#0);
                // CheckWellformedWithResult: any expression
                assume $Is(DafnyAST.__default.interpExpr($LS($LZ), e#0, ctx#0), TInt);
                return;
            }
...
axiom 3 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, s#0: DatatypeType, ctx#0: Map :: 
    ...
    DafnyAST.__default.interpStmt_k#canCall(s#0, ctx#0)
       ...
       ==> (!DafnyAST.Stmt.Skip_q(s#0)
           ==> (DafnyAST.Stmt.Print_q(s#0)
               ==> (var e#2 := DafnyAST.Stmt.e(s#0); 
                DafnyAST.__default.interpExpr#canCall(e#2, ctx#0)))
             && (!DafnyAST.Stmt.Print_q(s#0)
               ==> (DafnyAST.Stmt.Assign_q(s#0)
                   ==> (var e#3 := DafnyAST.Stmt.e(s#0); 
                    DafnyAST.__default.interpExpr#canCall(e#3, ctx#0)))
                 && (!DafnyAST.Stmt.Assign_q(s#0)
                   ==> (var s2#1 := DafnyAST.Stmt.s2(s#0); 
                    (var s1#1 := DafnyAST.Stmt.s1(s#0); 
                      DafnyAST.__default.interpStmt_k#canCall(s1#1, ctx#0)
                         && (var ctx1#1 := DafnyAST.InterpResult.ctx(DafnyAST.__default.interpStmt_k($ly, s1#1, ctx#0)); 
                          DafnyAST.__default.interpStmt_k#canCall(s2#1, ctx1#1)))))))
         && DafnyAST.__default.interpStmt_k($LS($ly), s#0, ctx#0)
             ...
             then #DafnyAST.InterpResult.InterpResult(ctx#0, Lit(Seq#Empty(): Seq))
               ...
               then (var e#0 := DafnyAST.Stmt.e(s#0); 
                #DafnyAST.InterpResult.InterpResult(ctx#0, 
                  Seq#Build(Seq#Empty(): Seq, $Box(DafnyAST.__default.interpExpr($LS($LZ), e#0, ctx#0)))))
               else (if DafnyAST.Stmt.Assign_q(s#0)
                 then (var e#1 := DafnyAST.Stmt.e(s#0); 
                  (var v#0 := DafnyAST.Stmt.v(s#0); 
                    #DafnyAST.InterpResult.InterpResult(Map#Build(ctx#0, $Box(v#0), $Box(DafnyAST.__default.interpExpr($LS($LZ), e#1, ctx#0))), 
                      Lit(Seq#Empty(): Seq))))
                 else (var s2#0 := DafnyAST.Stmt.s2(s#0); 
                  (var s1#0 := DafnyAST.Stmt.s1(s#0); 
                    (var ctx1#0, o1#0 := DafnyAST.InterpResult.ctx(DafnyAST.__default.interpStmt_k($ly, s1#0, ctx#0)), 
                        DafnyAST.InterpResult.output(DafnyAST.__default.interpStmt_k($ly, s1#0, ctx#0)); 
                      (var ctx2#0, o2#0 := DafnyAST.InterpResult.ctx(DafnyAST.__default.interpStmt_k($ly, s2#0, ctx1#0)), 
                          DafnyAST.InterpResult.output(DafnyAST.__default.interpStmt_k($ly, s2#0, ctx1#0)); 
...
axiom {:id "id25"} 3 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, s#0: DatatypeType, ctx#0: Map :: 
       ...
       ==> (!Lit(DafnyAST.Stmt.Skip_q(Lit(s#0)))
           ==> (Lit(DafnyAST.Stmt.Print_q(Lit(s#0)))
               ==> (var e#6 := Lit(DafnyAST.Stmt.e(Lit(s#0))); 
                DafnyAST.__default.interpExpr#canCall(e#6, Lit(ctx#0))))
             && (!Lit(DafnyAST.Stmt.Print_q(Lit(s#0)))
               ==> (Lit(DafnyAST.Stmt.Assign_q(Lit(s#0)))
                   ==> (var e#7 := Lit(DafnyAST.Stmt.e(Lit(s#0))); 
                    DafnyAST.__default.interpExpr#canCall(e#7, Lit(ctx#0))))
                 && (!Lit(DafnyAST.Stmt.Assign_q(Lit(s#0)))
                   ==> (var s2#3 := Lit(DafnyAST.Stmt.s2(Lit(s#0))); 
                    (var s1#3 := Lit(DafnyAST.Stmt.s1(Lit(s#0))); 
                      DafnyAST.__default.interpStmt_k#canCall(s1#3, Lit(ctx#0))
                         && (var ctx1#3 := DafnyAST.InterpResult.ctx(DafnyAST.__default.interpStmt_k($LS($ly), s1#3, Lit(ctx#0))); 
                          DafnyAST.__default.interpStmt_k#canCall(s2#3, ctx1#3)))))))
               ...
               then (var e#4 := Lit(DafnyAST.Stmt.e(Lit(s#0))); 
                Lit(#DafnyAST.InterpResult.InterpResult(Lit(ctx#0), 
                    Lit(Seq#Build(Seq#Empty(): Seq, 
                        $Box(LitInt(DafnyAST.__default.interpExpr($LS($LZ), e#4, Lit(ctx#0)))))))))
                 ...
                 then (var e#5 := Lit(DafnyAST.Stmt.e(Lit(s#0))); 
                  (var v#2 := Lit(DafnyAST.Stmt.v(Lit(s#0))); 
                    #DafnyAST.InterpResult.InterpResult(Map#Build(Lit(ctx#0), 
                        $Box(v#2), 
                        $Box(LitInt(DafnyAST.__default.interpExpr($LS($LZ), e#5, Lit(ctx#0))))), 
                      Lit(Seq#Empty(): Seq))))
                 else (var s2#2 := Lit(DafnyAST.Stmt.s2(Lit(s#0))); 
                  (var s1#2 := Lit(DafnyAST.Stmt.s1(Lit(s#0))); 
                    (var ctx1#2, o1#2 := DafnyAST.InterpResult.ctx(Lit(DafnyAST.__default.interpStmt_k($LS($ly), s1#2, Lit(ctx#0)))), 
                        DafnyAST.InterpResult.output(Lit(DafnyAST.__default.interpStmt_k($LS($ly), s1#2, Lit(ctx#0)))); 
                      (var ctx2#2, o2#2 := DafnyAST.InterpResult.ctx(DafnyAST.__default.interpStmt_k($LS($ly), s2#2, ctx1#2)), 
                          DafnyAST.InterpResult.output(DafnyAST.__default.interpStmt_k($LS($ly), s2#2, ctx1#2)); 
...
procedure {:verboseName "DafnyAST.interpStmt' (well-formedness)"} CheckWellformed$$DafnyAST.__default.interpStmt_k(s#0: DatatypeType where $Is(s#0, Tclass.DafnyAST.Stmt()), 
    ctx#0: Map where $Is(ctx#0, TMap(TSeq(TChar), TInt)));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "DafnyAST.interpStmt' (well-formedness)"} CheckWellformed$$DafnyAST.__default.interpStmt_k(s#0: DatatypeType, ctx#0: Map)
{
  var $_ReadsFrame: [ref,Field]bool;
  var _mcc#3#0: DatatypeType;
  var _mcc#4#0: DatatypeType;
  ...
  var ##ctx#3: Map;
    ...
    {
        // Check well-formedness of postcondition and assume false
        assume $Is(DafnyAST.__default.interpStmt_k($LS($LZ), s#0, ctx#0), 
    ...
    else
    {
        ...
        {
            assume {:id "id45"} DafnyAST.__default.interpStmt_k($LS($LZ), s#0, ctx#0)
               == #DafnyAST.InterpResult.InterpResult(ctx#0, Lit(Seq#Empty(): Seq));
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(DafnyAST.__default.interpStmt_k($LS($LZ), s#0, ctx#0), 
              Tclass.DafnyAST.InterpResult());
        ...
        else if (s#0 == #DafnyAST.Stmt.Print(_mcc#0#0))
        {
            ...
            havoc e#Z#1;
            assume {:id "id42"} let#6#0#0 == _mcc#0#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#6#0#0, Tclass.DafnyAST.Expr());
            assume {:id "id43"} e#Z#1 == let#6#0#0;
            ##e#1 := e#Z#1;
            // assume allocatedness for argument to function
            assume $IsAlloc(##e#1, Tclass.DafnyAST.Expr(), $Heap);
            ##ctx#3 := ctx#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##ctx#3, TMap(TSeq(TChar), TInt), $Heap);
            assume DafnyAST.__default.interpExpr#canCall(e#Z#1, ctx#0);
            assume {:id "id44"} DafnyAST.__default.interpStmt_k($LS($LZ), s#0, ctx#0)
               == #DafnyAST.InterpResult.InterpResult(ctx#0, 
                Seq#Build(Seq#Empty(): Seq, $Box(DafnyAST.__default.interpExpr($LS($LZ), e#Z#1, ctx#0))));
            assume DafnyAST.__default.interpExpr#canCall(e#Z#1, ctx#0);
            // CheckWellformedWithResult: any expression
            assume $Is(DafnyAST.__default.interpStmt_k($LS($LZ), s#0, ctx#0), 
              Tclass.DafnyAST.InterpResult());
        ...
        else if (s#0 == #DafnyAST.Stmt.Assign(_mcc#1#0, _mcc#2#0))
        {
            ...
            havoc e#Z#0;
            assume {:id "id37"} let#4#0#0 == _mcc#2#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#4#0#0, Tclass.DafnyAST.Expr());
            assume {:id "id38"} e#Z#0 == let#4#0#0;
            havoc v#Z#0;
            assume {:id "id39"} let#5#0#0 == _mcc#1#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#5#0#0, TSeq(TChar));
            assume {:id "id40"} v#Z#0 == let#5#0#0;
            ##e#0 := e#Z#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##e#0, Tclass.DafnyAST.Expr(), $Heap);
            ##ctx#2 := ctx#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##ctx#2, TMap(TSeq(TChar), TInt), $Heap);
            assume DafnyAST.__default.interpExpr#canCall(e#Z#0, ctx#0);
            assume {:id "id41"} DafnyAST.__default.interpStmt_k($LS($LZ), s#0, ctx#0)
               == #DafnyAST.InterpResult.InterpResult(Map#Build(ctx#0, $Box(v#Z#0), $Box(DafnyAST.__default.interpExpr($LS($LZ), e#Z#0, ctx#0))), 
                Lit(Seq#Empty(): Seq));
            assume DafnyAST.__default.interpExpr#canCall(e#Z#0, ctx#0);
            // CheckWellformedWithResult: any expression
            assume $Is(DafnyAST.__default.interpStmt_k($LS($LZ), s#0, ctx#0), 
        ...
        else if (s#0 == #DafnyAST.Stmt.Seq(_mcc#3#0, _mcc#4#0))
        {
            ...
            havoc s2#Z#0;
            assume {:id "id26"} let#0#0#0 == _mcc#4#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#0#0#0, Tclass.DafnyAST.Stmt());
            assume {:id "id27"} s2#Z#0 == let#0#0#0;
            havoc s1#Z#0;
            assume {:id "id28"} let#1#0#0 == _mcc#3#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#1#0#0, Tclass.DafnyAST.Stmt());
            assume {:id "id29"} s1#Z#0 == let#1#0#0;
            havoc ctx1#Z#0;
            havoc o1#Z#0;
            ##s#0 := s1#Z#0;
            // assume allocatedness for argument to function
            ...
            // assume allocatedness for argument to function
            assume $IsAlloc(##ctx#0, TMap(TSeq(TChar), TInt), $Heap);
            assert {:id "id30"} DtRank(##s#0) < DtRank(s#0)
               || (DtRank(##s#0) == DtRank(s#0)
                 && 
                Set#Subset(Map#Domain(##ctx#0), Map#Domain(ctx#0))
                 && !Set#Subset(Map#Domain(ctx#0), Map#Domain(##ctx#0)));
            assume DafnyAST.__default.interpStmt_k#canCall(s1#Z#0, ctx#0);
            assume DafnyAST.InterpResult.InterpResult_q(DafnyAST.__default.interpStmt_k($LS($LZ), s1#Z#0, ctx#0));
            assume {:id "id31"} let#2#0#0 == DafnyAST.__default.interpStmt_k($LS($LZ), s1#Z#0, ctx#0);
            assume DafnyAST.__default.interpStmt_k#canCall(s1#Z#0, ctx#0);
            // CheckWellformedWithResult: any expression
            assume $Is(let#2#0#0, Tclass.DafnyAST.InterpResult());
            assume DafnyAST.InterpResult.InterpResult_q(let#2#0#0);
            assume {:id "id32"} #DafnyAST.InterpResult.InterpResult(ctx1#Z#0, o1#Z#0) == let#2#0#0;
            havoc ctx2#Z#0;
            havoc o2#Z#0;
            ##s#1 := s2#Z#0;
            // assume allocatedness for argument to function
            ...
            // assume allocatedness for argument to function
            assume $IsAlloc(##ctx#1, TMap(TSeq(TChar), TInt), $Heap);
            assert {:id "id33"} DtRank(##s#1) < DtRank(s#0)
               || (DtRank(##s#1) == DtRank(s#0)
                 && 
                Set#Subset(Map#Domain(##ctx#1), Map#Domain(ctx#0))
                 && !Set#Subset(Map#Domain(ctx#0), Map#Domain(##ctx#1)));
            assume DafnyAST.__default.interpStmt_k#canCall(s2#Z#0, ctx1#Z#0);
            assume DafnyAST.InterpResult.InterpResult_q(DafnyAST.__default.interpStmt_k($LS($LZ), s2#Z#0, ctx1#Z#0));
            assume {:id "id34"} let#3#0#0 == DafnyAST.__default.interpStmt_k($LS($LZ), s2#Z#0, ctx1#Z#0);
            assume DafnyAST.__default.interpStmt_k#canCall(s2#Z#0, ctx1#Z#0);
            // CheckWellformedWithResult: any expression
            assume $Is(let#3#0#0, Tclass.DafnyAST.InterpResult());
            assume DafnyAST.InterpResult.InterpResult_q(let#3#0#0);
            assume {:id "id35"} #DafnyAST.InterpResult.InterpResult(ctx2#Z#0, o2#Z#0) == let#3#0#0;
            assume {:id "id36"} DafnyAST.__default.interpStmt_k($LS($LZ), s#0, ctx#0)
               == #DafnyAST.InterpResult.InterpResult(ctx2#Z#0, Seq#Append(o1#Z#0, o2#Z#0));
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(DafnyAST.__default.interpStmt_k($LS($LZ), s#0, ctx#0), 
              Tclass.DafnyAST.InterpResult());
...
axiom 4 <= $FunctionContextHeight
   ==> (forall s#0: DatatypeType, ctx#0: Map :: 
...
axiom {:id "id46"} 4 <= $FunctionContextHeight
   ==> (forall s#0: DatatypeType, ctx#0: Map :: 
    { DafnyAST.__default.interpStmt(s#0, ctx#0) } 
    DafnyAST.__default.interpStmt#canCall(s#0, ctx#0)
         || (4 < $FunctionContextHeight
...
axiom {:id "id47"} 4 <= $FunctionContextHeight
   ==> (forall s#0: DatatypeType, ctx#0: Map :: 
...
procedure {:verboseName "DafnyAST.interpStmt (well-formedness)"} CheckWellformed$$DafnyAST.__default.interpStmt(s#0: DatatypeType where $Is(s#0, Tclass.DafnyAST.Stmt()), 
    ctx#0: Map where $Is(ctx#0, TMap(TSeq(TChar), TInt)));
