...
(set-info :boogie-vc-id Impl$$EliminateMulZero.__default.InductLiteral)
...
(= |v#2@@1| |v'#2@@0|))))))))))))) (=> (=> (|EliminateMulZero.__default.P#canCall| |st#0@@5| |e#0@@27|) (or (EliminateMulZero.__default.P |st#0@@5| |e#0@@27|) (let ((|e'#1@@5| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@27|)))
...
(= |v#2@@2| |v'#2@@1|)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|EliminateMulZero.__default.P#canCall| |st#0@@5| |e#0@@27|) (or (EliminateMulZero.__default.P |st#0@@5| |e#0@@27|) (let ((|e'#1@@6| (EliminateMulZero.__default.Eliminate ($LS ($LS $LZ)) |e#0@@27|)))
