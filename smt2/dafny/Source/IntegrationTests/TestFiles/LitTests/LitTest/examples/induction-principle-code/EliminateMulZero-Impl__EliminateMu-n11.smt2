...
(set-info :boogie-vc-id Impl$$EliminateMulZero.__default.InductIf__Fail)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (= (ControlFlow 0 2) (- 0 1))) (not (EliminateMulZero.__default.P__Fail |st#0@@5| |cond#0@@3|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (and ($Is MapType |st#0@@5| (TMap (TSeq TChar) TInt)) ($IsAlloc MapType |st#0@@5| (TMap (TSeq TChar) TInt) $Heap@@6))) (=> (and (and (and ($Is DatatypeTypeType |e#0@@27| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@27| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@27|)) (and (and ($Is DatatypeTypeType |cond#0@@3| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |cond#0@@3| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |cond#0@@3|))) (=> (and (and (and (and ($Is DatatypeTypeType |thn#0@@3| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |thn#0@@3| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |thn#0@@3|)) (and (and ($Is DatatypeTypeType |els#0@@3| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |els#0@@3| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |els#0@@3|))) (and (and (and (= 4 $FunctionContextHeight) (AST.Expr__Raw.If_q |e#0@@27|)) (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.cond |e#0@@27|) |cond#0@@3|) (|AST.Expr__Raw#Equal| (AST.Expr__Raw.thn |e#0@@27|) |thn#0@@3|))) (and (and (|AST.Expr__Raw#Equal| (AST.Expr__Raw.els |e#0@@27|) |els#0@@3|) (not (EliminateMulZero.__default.P__Fail |st#0@@5| |e#0@@27|))) (and (EliminateMulZero.__default.P |st#0@@5| |cond#0@@3|) (= (ControlFlow 0 3) 2))))) anon0_correct)))))
