...
(declare-fun |vars##1_0@0| () T@U)
(declare-fun |vs##1_0@0| () T@U)
(declare-fun |vs'##1_0@0| () T@U)
...
(set-info :boogie-vc-id Impl$$Equiv.__default.VarsAndValuesToContext__Eq)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (let ((|bindings#0| (Interp.__default.VarsAndValuesToContext ($LS ($LS $LZ)) |vars#0@@3| |vs#0|)))
(let ((|bindings'#0| (Interp.__default.VarsAndValuesToContext ($LS ($LS $LZ)) |vars#0@@3| |vs'#0|)))
(Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |bindings#0| |bindings'#0|))))))
(let ((anon3_Else_correct  (=> (not (|Seq#Equal| |vars#0@@3| |Seq#Empty|)) (and (=> (= (ControlFlow 0 4) (- 0 12)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |vars#0@@3|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |vars#0@@3|))) (=> (= |vars##1_0@0| (|Seq#Drop| |vars#0@@3| (LitInt 1))) (and (=> (= (ControlFlow 0 4) (- 0 11)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |vs#0|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |vs#0|))) (=> (= |vs##1_0@0| (|Seq#Drop| |vs#0| (LitInt 1))) (and (=> (= (ControlFlow 0 4) (- 0 10)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |vs'#0|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |vs'#0|))) (=> (= |vs'##1_0@0| (|Seq#Drop| |vs'#0| (LitInt 1))) (and (=> (= (ControlFlow 0 4) (- 0 9)) (or (< (|Seq#Rank| |vars##1_0@0|) (|Seq#Rank| |vars#0@@3|)) (and (= (|Seq#Rank| |vars##1_0@0|) (|Seq#Rank| |vars#0@@3|)) (or (< (|Seq#Rank| |vs##1_0@0|) (|Seq#Rank| |vs#0|)) (and (= (|Seq#Rank| |vs##1_0@0|) (|Seq#Rank| |vs#0|)) (< (|Seq#Rank| |vs'##1_0@0|) (|Seq#Rank| |vs'#0|))))))) (=> (or (< (|Seq#Rank| |vars##1_0@0|) (|Seq#Rank| |vars#0@@3|)) (and (= (|Seq#Rank| |vars##1_0@0|) (|Seq#Rank| |vars#0@@3|)) (or (< (|Seq#Rank| |vs##1_0@0|) (|Seq#Rank| |vs#0|)) (and (= (|Seq#Rank| |vs##1_0@0|) (|Seq#Rank| |vs#0|)) (< (|Seq#Rank| |vs'##1_0@0|) (|Seq#Rank| |vs'#0|)))))) (and (=> (= (ControlFlow 0 4) (- 0 8)) (= (|Seq#Length| |vars##1_0@0|) (|Seq#Length| |vs##1_0@0|))) (=> (= (|Seq#Length| |vars##1_0@0|) (|Seq#Length| |vs##1_0@0|)) (and (=> (= (ControlFlow 0 4) (- 0 7)) (= (|Seq#Length| |vs##1_0@0|) (|Seq#Length| |vs'##1_0@0|))) (=> (= (|Seq#Length| |vs##1_0@0|) (|Seq#Length| |vs'##1_0@0|)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (=> (|Equiv.__default.EqSeqValue#canCall| |vs##1_0@0| |vs'##1_0@0|) (or (Equiv.__default.EqSeqValue |vs##1_0@0| |vs'##1_0@0|) (= (|Seq#Length| |vs##1_0@0|) (|Seq#Length| |vs'##1_0@0|))))) (=> (=> (|Equiv.__default.EqSeqValue#canCall| |vs##1_0@0| |vs'##1_0@0|) (or (Equiv.__default.EqSeqValue |vs##1_0@0| |vs'##1_0@0|) (= (|Seq#Length| |vs##1_0@0|) (|Seq#Length| |vs'##1_0@0|)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (=> (|Equiv.__default.EqSeqValue#canCall| |vs##1_0@0| |vs'##1_0@0|) (or (Equiv.__default.EqSeqValue |vs##1_0@0| |vs'##1_0@0|) (forall ((|i#0@@1| Int) ) (!  (=> (and (<= (LitInt 0) |i#0@@1|) (< |i#0@@1| (|Seq#Length| |vs##1_0@0|))) (Equiv.__default.EqValue (U_2_int ($Unbox intType (|Seq#Index| |vs##1_0@0| |i#0@@1|))) (U_2_int ($Unbox intType (|Seq#Index| |vs'##1_0@0| |i#0@@1|)))))
 :qid |Equivdfy.24:15|
 :skolemid |753|
 :pattern ( ($Unbox intType (|Seq#Index| |vs'##1_0@0| |i#0@@1|)))
 :pattern ( ($Unbox intType (|Seq#Index| |vs##1_0@0| |i#0@@1|)))
))))) (=> (=> (|Equiv.__default.EqSeqValue#canCall| |vs##1_0@0| |vs'##1_0@0|) (or (Equiv.__default.EqSeqValue |vs##1_0@0| |vs'##1_0@0|) (forall ((|i#0@@2| Int) ) (!  (=> (and (<= (LitInt 0) |i#0@@2|) (< |i#0@@2| (|Seq#Length| |vs##1_0@0|))) (Equiv.__default.EqValue (U_2_int ($Unbox intType (|Seq#Index| |vs##1_0@0| |i#0@@2|))) (U_2_int ($Unbox intType (|Seq#Index| |vs'##1_0@0| |i#0@@2|)))))
 :qid |Equivdfy.24:15|
 :skolemid |753|
 :pattern ( ($Unbox intType (|Seq#Index| |vs'##1_0@0| |i#0@@2|)))
 :pattern ( ($Unbox intType (|Seq#Index| |vs##1_0@0| |i#0@@2|)))
)))) (=> (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (=> (and (and (and (|Interp.__default.VarsAndValuesToContext#canCall| |vars##1_0@0| |vs##1_0@0|) (let ((|bindings#0@@0| (Interp.__default.VarsAndValuesToContext ($LS $LZ) |vars##1_0@0| |vs##1_0@0|)))
 (and (|Interp.__default.VarsAndValuesToContext#canCall| |vars##1_0@0| |vs'##1_0@0|) (let ((|bindings'#0@@0| (Interp.__default.VarsAndValuesToContext ($LS $LZ) |vars##1_0@0| |vs'##1_0@0|)))
(|Equiv.__default.EqCtx#canCall| |bindings#0@@0| |bindings'#0@@0|))))) (let ((|bindings#0@@1| (Interp.__default.VarsAndValuesToContext ($LS ($LS $LZ)) |vars##1_0@0| |vs##1_0@0|)))
(let ((|bindings'#0@@1| (Interp.__default.VarsAndValuesToContext ($LS ($LS $LZ)) |vars##1_0@0| |vs'##1_0@0|)))
(Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |bindings#0@@1| |bindings'#0@@1|)))) (and (= $Heap@1 $Heap@2) (= (ControlFlow 0 4) 2))) GeneratedUnifiedExit_correct))))))))))))))))))))))))
(let ((anon3_Then_correct  (=> (and (|Seq#Equal| |vars#0@@3| |Seq#Empty|) (= (ControlFlow 0 3) 2)) GeneratedUnifiedExit_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#vars0#0| T@U) (|$ih#vs0#0| T@U) (|$ih#vs'0#0| T@U) ) (!  (=> (and (and (and (and ($Is SeqType |$ih#vars0#0| (TSeq (TSeq TChar))) ($Is SeqType |$ih#vs0#0| (TSeq TInt))) ($Is SeqType |$ih#vs'0#0| (TSeq TInt))) (and (and (= (|Seq#Length| |$ih#vars0#0|) (|Seq#Length| |$ih#vs0#0|)) (= (|Seq#Length| |$ih#vs0#0|) (|Seq#Length| |$ih#vs'0#0|))) (Equiv.__default.EqSeqValue |$ih#vs0#0| |$ih#vs'0#0|))) (or (< (|Seq#Rank| |$ih#vars0#0|) (|Seq#Rank| |vars#0@@3|)) (and (= (|Seq#Rank| |$ih#vars0#0|) (|Seq#Rank| |vars#0@@3|)) (or (< (|Seq#Rank| |$ih#vs0#0|) (|Seq#Rank| |vs#0|)) (and (= (|Seq#Rank| |$ih#vs0#0|) (|Seq#Rank| |vs#0|)) (< (|Seq#Rank| |$ih#vs'0#0|) (|Seq#Rank| |vs'#0|))))))) (let ((|bindings#1| (Interp.__default.VarsAndValuesToContext ($LS $LZ) |$ih#vars0#0| |$ih#vs0#0|)))
(let ((|bindings'#1| (Interp.__default.VarsAndValuesToContext ($LS $LZ) |$ih#vars0#0| |$ih#vs'0#0|)))
(Equiv.__default.EqCtx reveal_Equiv._default.EqCtx |bindings#1| |bindings'#1|))))
 :qid |Equivdfy.144:35|
 :skolemid |757|
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $LZ) |$ih#vars0#0| |$ih#vs'0#0|) (Interp.__default.VarsAndValuesToContext ($LS $LZ) |$ih#vars0#0| |$ih#vs0#0|))
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $LZ) |$ih#vars0#0| |$ih#vs'0#0|) (|Seq#Length| |$ih#vs0#0|))
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $LZ) |$ih#vars0#0| |$ih#vs0#0|) (Equiv.__default.EqSeqValue |$ih#vs0#0| |$ih#vs'0#0|))
 :pattern ( (Interp.__default.VarsAndValuesToContext ($LS $LZ) |$ih#vars0#0| |$ih#vs0#0|) (|Seq#Length| |$ih#vs'0#0|))
 :pattern ( (Equiv.__default.EqSeqValue |$ih#vs0#0| |$ih#vs'0#0|) (|Seq#Length| |$ih#vars0#0|))
 :pattern ( (|Seq#Length| |$ih#vs'0#0|) (|Seq#Length| |$ih#vs0#0|) (|Seq#Length| |$ih#vars0#0|))
)))) (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (= $Heap@0 $Heap@1) reveal_Equiv._default.EqCtx))) (and (=> (= (ControlFlow 0 13) 3) anon3_Then_correct) (=> (= (ControlFlow 0 13) 4) anon3_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |vars#0@@3| (TSeq (TSeq TChar))) ($IsAlloc SeqType |vars#0@@3| (TSeq (TSeq TChar)) $Heap)) (and ($Is SeqType |vs#0| (TSeq TInt)) ($IsAlloc SeqType |vs#0| (TSeq TInt) $Heap))) (=> (and (and (and (and ($Is SeqType |vs'#0| (TSeq TInt)) ($IsAlloc SeqType |vs'#0| (TSeq TInt) $Heap)) (= 2 $FunctionContextHeight)) (and (= (|Seq#Length| |vars#0@@3|) (|Seq#Length| |vs#0|)) (= (|Seq#Length| |vs#0|) (|Seq#Length| |vs'#0|)))) (and (and (|Equiv.__default.EqSeqValue#canCall| |vs#0| |vs'#0|) (and (Equiv.__default.EqSeqValue |vs#0| |vs'#0|) (and (= (|Seq#Length| |vs#0|) (|Seq#Length| |vs'#0|)) (forall ((|i#1@@1| Int) ) (!  (=> (and (<= (LitInt 0) |i#1@@1|) (< |i#1@@1| (|Seq#Length| |vs#0|))) (Equiv.__default.EqValue (U_2_int ($Unbox intType (|Seq#Index| |vs#0| |i#1@@1|))) (U_2_int ($Unbox intType (|Seq#Index| |vs'#0| |i#1@@1|)))))
 :qid |Equivdfy.24:15|
 :skolemid |756|
 :pattern ( ($Unbox intType (|Seq#Index| |vs'#0| |i#1@@1|)))
 :pattern ( ($Unbox intType (|Seq#Index| |vs#0| |i#1@@1|)))
