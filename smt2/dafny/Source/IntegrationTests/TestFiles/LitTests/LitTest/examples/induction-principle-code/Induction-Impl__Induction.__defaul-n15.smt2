...
(declare-fun Induction.__default.AppendValue (T@U T@U) T@U)
(declare-fun |Induction.__default.AppendValue#canCall| (T@U T@U) Bool)
...
(declare-fun Induction.__default.NilVS () T@U)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|v#0| T@U) (|vs#0| T@U) ) (!  (=> (or (|Induction.__default.AppendValue#canCall| |v#0| |vs#0|) (and (< 0 $FunctionContextHeight) (and ($IsBox |v#0| Tclass.Induction.V) ($IsBox |vs#0| Tclass.Induction.VS)))) ($IsBox (Induction.__default.AppendValue |v#0| |vs#0|) Tclass.Induction.VS))
 :qid |Inductiondfy.43:30|
 :skolemid |652|
 :pattern ( (Induction.__default.AppendValue |v#0| |vs#0|))
))))
...
(assert (forall ((d@@1 T@U) ) (! (= (AST.Expr__Raw.Var_q d@@1) (= (DatatypeCtorId d@@1) |##AST.Expr_Raw.Var|))
 :qid |unknown.0:0|
 :skolemid |823|
 :pattern ( (AST.Expr__Raw.Var_q d@@1))
)))
(assert (forall ((d@@2 T@U) ) (! (= (AST.Expr__Raw.Literal_q d@@2) (= (DatatypeCtorId d@@2) |##AST.Expr_Raw.Literal|))
 :qid |unknown.0:0|
 :skolemid |833|
 :pattern ( (AST.Expr__Raw.Literal_q d@@2))
)))
(assert (forall ((d@@3 T@U) ) (! (= (AST.Expr__Raw.Bind_q d@@3) (= (DatatypeCtorId d@@3) |##AST.Expr_Raw.Bind|))
 :qid |unknown.0:0|
 :skolemid |841|
 :pattern ( (AST.Expr__Raw.Bind_q d@@3))
)))
(assert (forall ((d@@4 T@U) ) (! (= (AST.Expr__Raw.Assign_q d@@4) (= (DatatypeCtorId d@@4) |##AST.Expr_Raw.Assign|))
 :qid |unknown.0:0|
 :skolemid |858|
 :pattern ( (AST.Expr__Raw.Assign_q d@@4))
)))
(assert (forall ((d@@5 T@U) ) (! (= (AST.Expr__Raw.If_q d@@5) (= (DatatypeCtorId d@@5) |##AST.Expr_Raw.If|))
 :qid |unknown.0:0|
 :skolemid |872|
 :pattern ( (AST.Expr__Raw.If_q d@@5))
)))
(assert (forall ((d@@6 T@U) ) (! (= (AST.Expr__Raw.Op_q d@@6) (= (DatatypeCtorId d@@6) |##AST.Expr_Raw.Op|))
 :qid |unknown.0:0|
 :skolemid |887|
 :pattern ( (AST.Expr__Raw.Op_q d@@6))
)))
(assert (forall ((d@@7 T@U) ) (! (= (AST.Expr__Raw.Seq_q d@@7) (= (DatatypeCtorId d@@7) |##AST.Expr_Raw.Seq|))
 :qid |unknown.0:0|
 :skolemid |902|
 :pattern ( (AST.Expr__Raw.Seq_q d@@7))
)))
...
(assert (forall ((d@@8 T@U) ) (!  (=> (AST.Expr__Raw.Bind_q d@@8) (exists ((|a#35#0#0| T@U) (|a#35#1#0| T@U) (|a#35#2#0| T@U) ) (! (= d@@8 (|#AST.Expr_Raw.Bind| |a#35#0#0| |a#35#1#0| |a#35#2#0|))
 :qid |ASTdfy.17:12|
 :skolemid |842|
)))
 :qid |unknown.0:0|
...
(assert (forall ((d@@9 T@U) ) (!  (=> (AST.Expr__Raw.If_q d@@9) (exists ((|a#57#0#0| T@U) (|a#57#1#0| T@U) (|a#57#2#0| T@U) ) (! (= d@@9 (|#AST.Expr_Raw.If| |a#57#0#0| |a#57#1#0| |a#57#2#0|))
 :qid |ASTdfy.19:10|
 :skolemid |873|
)))
 :qid |unknown.0:0|
...
(assert (forall ((d@@10 T@U) ) (!  (=> (AST.Expr__Raw.Op_q d@@10) (exists ((|a#67#0#0| T@U) (|a#67#1#0| T@U) (|a#67#2#0| T@U) ) (! (= d@@10 (|#AST.Expr_Raw.Op| |a#67#0#0| |a#67#1#0| |a#67#2#0|))
 :qid |ASTdfy.20:10|
 :skolemid |888|
)))
 :qid |unknown.0:0|
...
(assert (forall ((d@@12 T@U) ) (!  (=> (AST.Expr__Raw.Assign_q d@@12) (exists ((|a#47#0#0| T@U) (|a#47#1#0| T@U) ) (! (= d@@12 (|#AST.Expr_Raw.Assign| |a#47#0#0| |a#47#1#0|))
 :qid |ASTdfy.18:14|
 :skolemid |859|
)))
 :qid |unknown.0:0|
...
(assert (forall ((d@@13 T@U) ) (!  (=> (AST.Expr__Raw.Var_q d@@13) (exists ((|a#23#0#0| T@U) ) (! (= d@@13 (|#AST.Expr_Raw.Var| |a#23#0#0|))
 :qid |ASTdfy.15:11|
 :skolemid |824|
)))
 :qid |unknown.0:0|
...
(assert (forall ((d@@14 T@U) ) (!  (=> (AST.Expr__Raw.Literal_q d@@14) (exists ((|a#30#0#0| Int) ) (! (= d@@14 (|#AST.Expr_Raw.Literal| |a#30#0#0|))
 :qid |ASTdfy.16:15|
 :skolemid |834|
)))
 :qid |unknown.0:0|
...
(assert (forall ((d@@15 T@U) ) (!  (=> (AST.Expr__Raw.Seq_q d@@15) (exists ((|a#77#0#0| T@U) ) (! (= d@@15 (|#AST.Expr_Raw.Seq| |a#77#0#0|))
 :qid |ASTdfy.21:11|
 :skolemid |903|
)))
 :qid |unknown.0:0|
...
(assert (forall ((d@@16 T@U) ) (!  (=> ($Is DatatypeTypeType d@@16 Tclass.AST.Expr__Raw) (or (or (or (or (or (or (AST.Expr__Raw.Var_q d@@16) (AST.Expr__Raw.Literal_q d@@16)) (AST.Expr__Raw.Bind_q d@@16)) (AST.Expr__Raw.Assign_q d@@16)) (AST.Expr__Raw.If_q d@@16)) (AST.Expr__Raw.Op_q d@@16)) (AST.Expr__Raw.Seq_q d@@16)))
 :qid |unknown.0:0|
 :skolemid |913|
 :pattern ( (AST.Expr__Raw.Seq_q d@@16) ($Is DatatypeTypeType d@@16 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Op_q d@@16) ($Is DatatypeTypeType d@@16 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.If_q d@@16) ($Is DatatypeTypeType d@@16 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Assign_q d@@16) ($Is DatatypeTypeType d@@16 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Bind_q d@@16) ($Is DatatypeTypeType d@@16 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Literal_q d@@16) ($Is DatatypeTypeType d@@16 Tclass.AST.Expr__Raw))
 :pattern ( (AST.Expr__Raw.Var_q d@@16) ($Is DatatypeTypeType d@@16 Tclass.AST.Expr__Raw))
)))
...
(assert  (=> (< 0 $FunctionContextHeight) ($IsBox Induction.__default.NilVS Tclass.Induction.VS)))
...
(assert  (=> (< 0 $FunctionContextHeight) (forall (($h@@1 T@U) ) (!  (=> ($IsGoodHeap $h@@1) ($IsAllocBox Induction.__default.NilVS Tclass.Induction.VS $h@@1))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |654|
 :pattern ( ($IsAllocBox Induction.__default.NilVS Tclass.Induction.VS $h@@1))
))))
...
(assert (forall ((bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 Tclass.AST.Expr) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@2)) bx@@2) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@2) Tclass.AST.Expr)))
 :qid |unknown.0:0|
 :skolemid |639|
 :pattern ( ($IsBox bx@@2 Tclass.AST.Expr))
)))
...
(assert (forall ((s@@10 T@U) (i@@7 Int) (v@@3 T@U) ) (!  (and (=> (= i@@7 (|Seq#Length| s@@10)) (= (|Seq#Index| (|Seq#Build| s@@10 v@@3) i@@7) v@@3)) (=> (or (not (= i@@7 (|Seq#Length| s@@10))) (not true)) (= (|Seq#Index| (|Seq#Build| s@@10 v@@3) i@@7) (|Seq#Index| s@@10 i@@7))))
 :qid |DafnyPreludebpl.1148:15|
 :skolemid |225|
 :pattern ( (|Seq#Index| (|Seq#Build| s@@10 v@@3) i@@7))
)))
...
(assert (forall ((ty T@U) ) (!  (=> ($AlwaysAllocated ty) (forall ((h@@2 T@U) (v@@5 T@U) ) (!  (=> ($IsBox v@@5 ty) ($IsAllocBox v@@5 ty h@@2))
 :qid |DafnyPreludebpl.337:13|
 :skolemid |79|
 :pattern ( ($IsAllocBox v@@5 ty h@@2))
)))
...
(assert (forall ((v@@6 T@U) (t0@@3 T@U) (h@@3 T@U) ) (! (= ($IsAlloc SeqType v@@6 (TSeq t0@@3) h@@3) (forall ((i@@11 Int) ) (!  (=> (and (<= 0 i@@11) (< i@@11 (|Seq#Length| v@@6))) ($IsAllocBox (|Seq#Index| v@@6 i@@11) t0@@3 h@@3))
 :qid |DafnyPreludebpl.311:11|
 :skolemid |73|
 :pattern ( (|Seq#Index| v@@6 i@@11))
)))
...
(assert (forall ((d@@17 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (AST.Expr__Raw.Literal_q d@@17) ($IsAlloc DatatypeTypeType d@@17 Tclass.AST.Expr__Raw $h@@4))) ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@17)) TInt $h@@4))
 :qid |unknown.0:0|
 :skolemid |837|
 :pattern ( ($IsAlloc intType (int_2_U (AST.Expr__Raw.n d@@17)) TInt $h@@4))
)))
...
(assert (forall ((d@@19 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) ($Is DatatypeTypeType d@@19 Tclass.AST.BinOp)) ($IsAlloc DatatypeTypeType d@@19 Tclass.AST.BinOp $h@@5))
 :qid |unknown.0:0|
 :skolemid |815|
 :pattern ( ($IsAlloc DatatypeTypeType d@@19 Tclass.AST.BinOp $h@@5))
)))
(assert (forall ((d@@20 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) ($Is DatatypeTypeType d@@20 Tclass.AST.Expr__Raw)) ($IsAlloc DatatypeTypeType d@@20 Tclass.AST.Expr__Raw $h@@6))
 :qid |unknown.0:0|
 :skolemid |911|
 :pattern ( ($IsAlloc DatatypeTypeType d@@20 Tclass.AST.Expr__Raw $h@@6))
)))
...
(assert (forall ((d@@21 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (AST.Expr__Raw.Var_q d@@21) ($IsAlloc DatatypeTypeType d@@21 Tclass.AST.Expr__Raw $h@@7))) ($IsAlloc SeqType (AST.Expr__Raw.name d@@21) (TSeq TChar) $h@@7))
 :qid |unknown.0:0|
 :skolemid |827|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.name d@@21) (TSeq TChar) $h@@7))
)))
...
(assert (forall ((d@@22 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (_System.Tuple2.___hMake2_q d@@22) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@22 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@8)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@22 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@8))
)))) ($IsAllocBox (_System.Tuple2._0 d@@22) |_System._tuple#2$T0@@6| $h@@8))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@22) |_System._tuple#2$T0@@6| $h@@8))
)))
(assert (forall ((d@@23 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) (and (_System.Tuple2.___hMake2_q d@@23) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@23 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@9)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@23 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@9))
)))) ($IsAllocBox (_System.Tuple2._1 d@@23) |_System._tuple#2$T1@@7| $h@@9))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@23) |_System._tuple#2$T1@@7| $h@@9))
)))
...
(assert (forall ((d@@24 T@U) ($h@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) (and (AST.Expr__Raw.Bind_q d@@24) ($IsAlloc DatatypeTypeType d@@24 Tclass.AST.Expr__Raw $h@@10))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@24) Tclass.AST.Expr__Raw $h@@10))
 :qid |unknown.0:0|
 :skolemid |847|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.body d@@24) Tclass.AST.Expr__Raw $h@@10))
)))
(assert (forall ((d@@25 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (AST.Expr__Raw.If_q d@@25) ($IsAlloc DatatypeTypeType d@@25 Tclass.AST.Expr__Raw $h@@11))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@25) Tclass.AST.Expr__Raw $h@@11))
 :qid |unknown.0:0|
 :skolemid |876|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.cond d@@25) Tclass.AST.Expr__Raw $h@@11))
)))
(assert (forall ((d@@26 T@U) ($h@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (AST.Expr__Raw.If_q d@@26) ($IsAlloc DatatypeTypeType d@@26 Tclass.AST.Expr__Raw $h@@12))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@26) Tclass.AST.Expr__Raw $h@@12))
 :qid |unknown.0:0|
 :skolemid |877|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.thn d@@26) Tclass.AST.Expr__Raw $h@@12))
)))
(assert (forall ((d@@27 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (AST.Expr__Raw.If_q d@@27) ($IsAlloc DatatypeTypeType d@@27 Tclass.AST.Expr__Raw $h@@13))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@27) Tclass.AST.Expr__Raw $h@@13))
 :qid |unknown.0:0|
 :skolemid |878|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.els d@@27) Tclass.AST.Expr__Raw $h@@13))
)))
(assert (forall ((d@@28 T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (AST.Expr__Raw.Op_q d@@28) ($IsAlloc DatatypeTypeType d@@28 Tclass.AST.Expr__Raw $h@@14))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@28) Tclass.AST.BinOp $h@@14))
 :qid |unknown.0:0|
 :skolemid |891|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.op d@@28) Tclass.AST.BinOp $h@@14))
)))
(assert (forall ((d@@29 T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (AST.Expr__Raw.Op_q d@@29) ($IsAlloc DatatypeTypeType d@@29 Tclass.AST.Expr__Raw $h@@15))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@29) Tclass.AST.Expr__Raw $h@@15))
 :qid |unknown.0:0|
 :skolemid |892|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe1 d@@29) Tclass.AST.Expr__Raw $h@@15))
)))
(assert (forall ((d@@30 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (AST.Expr__Raw.Op_q d@@30) ($IsAlloc DatatypeTypeType d@@30 Tclass.AST.Expr__Raw $h@@16))) ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@30) Tclass.AST.Expr__Raw $h@@16))
 :qid |unknown.0:0|
 :skolemid |893|
 :pattern ( ($IsAlloc DatatypeTypeType (AST.Expr__Raw.oe2 d@@30) Tclass.AST.Expr__Raw $h@@16))
)))
...
(assert (forall ((d@@31 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (AST.Expr__Raw.Bind_q d@@31) ($IsAlloc DatatypeTypeType d@@31 Tclass.AST.Expr__Raw $h@@17))) ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@31) (TSeq (TSeq TChar)) $h@@17))
 :qid |unknown.0:0|
 :skolemid |845|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvars d@@31) (TSeq (TSeq TChar)) $h@@17))
)))
(assert (forall ((d@@32 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (AST.Expr__Raw.Assign_q d@@32) ($IsAlloc DatatypeTypeType d@@32 Tclass.AST.Expr__Raw $h@@18))) ($IsAlloc SeqType (AST.Expr__Raw.avars d@@32) (TSeq (TSeq TChar)) $h@@18))
 :qid |unknown.0:0|
 :skolemid |862|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avars d@@32) (TSeq (TSeq TChar)) $h@@18))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0| T@U) (|e#0@@8| T@U) ) (!  (=> (or (|Induction.__default.P__Step#canCall| |st#0| |e#0@@8|) (and (< 1 $FunctionContextHeight) (and (and ($IsBox |st#0| Tclass.Induction.S) ($Is DatatypeTypeType |e#0@@8| Tclass.AST.Expr)) (and (Induction.__default.P |st#0| |e#0@@8|) (not (Induction.__default.P__Fail |st#0| |e#0@@8|)))))) (and (Induction.__default.P__Succ |st#0| |e#0@@8| (_System.Tuple2._0 (Induction.__default.P__Step |st#0| |e#0@@8|)) (_System.Tuple2._1 (Induction.__default.P__Step |st#0| |e#0@@8|))) ($Is DatatypeTypeType (Induction.__default.P__Step |st#0| |e#0@@8|) (Tclass._System.Tuple2 Tclass.Induction.S Tclass.Induction.V))))
 :qid |Inductiondfy.66:25|
 :skolemid |667|
 :pattern ( (Induction.__default.P__Step |st#0| |e#0@@8|))
))))
...
(assert (forall ((d@@33 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (AST.Expr__Raw.Bind_q d@@33) ($IsAlloc DatatypeTypeType d@@33 Tclass.AST.Expr__Raw $h@@19))) ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@33) (TSeq Tclass.AST.Expr__Raw) $h@@19))
 :qid |unknown.0:0|
 :skolemid |846|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.bvals d@@33) (TSeq Tclass.AST.Expr__Raw) $h@@19))
)))
(assert (forall ((d@@34 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (AST.Expr__Raw.Assign_q d@@34) ($IsAlloc DatatypeTypeType d@@34 Tclass.AST.Expr__Raw $h@@20))) ($IsAlloc SeqType (AST.Expr__Raw.avals d@@34) (TSeq Tclass.AST.Expr__Raw) $h@@20))
 :qid |unknown.0:0|
 :skolemid |863|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.avals d@@34) (TSeq Tclass.AST.Expr__Raw) $h@@20))
)))
(assert (forall ((d@@35 T@U) ($h@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@21) (and (AST.Expr__Raw.Seq_q d@@35) ($IsAlloc DatatypeTypeType d@@35 Tclass.AST.Expr__Raw $h@@21))) ($IsAlloc SeqType (AST.Expr__Raw.es d@@35) (TSeq Tclass.AST.Expr__Raw) $h@@21))
 :qid |unknown.0:0|
 :skolemid |906|
 :pattern ( ($IsAlloc SeqType (AST.Expr__Raw.es d@@35) (TSeq Tclass.AST.Expr__Raw) $h@@21))
)))
...
(assert (forall ((v@@10 T@U) (t0@@8 T@U) ) (! (= ($Is SeqType v@@10 (TSeq t0@@8)) (forall ((i@@13 Int) ) (!  (=> (and (<= 0 i@@13) (< i@@13 (|Seq#Length| v@@10))) ($IsBox (|Seq#Index| v@@10 i@@13) t0@@8))
 :qid |DafnyPreludebpl.254:11|
 :skolemid |53|
 :pattern ( (|Seq#Index| v@@10 i@@13))
)))
 :qid |DafnyPreludebpl.252:15|
 :skolemid |54|
 :pattern ( ($Is SeqType v@@10 (TSeq t0@@8)))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|st#0@@0| T@U) (|es#0@@0| T@U) ) (!  (=> (or (|Induction.__default.Pes__Step#canCall| |st#0@@0| |es#0@@0|) (and (< 1 $FunctionContextHeight) (and (and ($IsBox |st#0@@0| Tclass.Induction.S) ($Is SeqType |es#0@@0| (TSeq Tclass.AST.Expr))) (and (Induction.__default.Pes |st#0@@0| |es#0@@0|) (not (Induction.__default.Pes__Fail |st#0@@0| |es#0@@0|)))))) (and (Induction.__default.Pes__Succ |st#0@@0| |es#0@@0| (_System.Tuple2._0 (Induction.__default.Pes__Step |st#0@@0| |es#0@@0|)) (_System.Tuple2._1 (Induction.__default.Pes__Step |st#0@@0| |es#0@@0|))) ($Is DatatypeTypeType (Induction.__default.Pes__Step |st#0@@0| |es#0@@0|) (Tclass._System.Tuple2 Tclass.Induction.S Tclass.Induction.VS))))
 :qid |Inductiondfy.71:27|
 :skolemid |671|
 :pattern ( (Induction.__default.Pes__Step |st#0@@0| |es#0@@0|))
))))
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(declare-fun |st#0@@1| () T@U)
(declare-fun |es#0@@1| () T@U)
...
(set-info :boogie-vc-id Impl$$Induction.__default.Pes__Satisfied__Succ)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 29) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (Induction.__default.Pes |st#0@@1| |es#0@@1|))))
(let ((anon9_Else_correct  (=> (not (Induction.__default.Pes__Fail |st1#1_1_0@0| |es'#1_0@0|)) (=> (and ($IsBox |st2#1_1_1_0@0| Tclass.Induction.S) ($IsAllocBox |st2#1_1_1_0@0| Tclass.Induction.S $Heap@5)) (=> (and (and ($IsBox |vs#1_1_1_0@0| Tclass.Induction.VS) ($IsAllocBox |vs#1_1_1_0@0| Tclass.Induction.VS $Heap@5)) (and ($IsAllocBox |st1#1_1_0@0| Tclass.Induction.S $Heap@5) ($IsAlloc SeqType |es'#1_0@0| (TSeq Tclass.AST.Expr) $Heap@5))) (and (=> (= (ControlFlow 0 12) (- 0 16)) (Induction.__default.Pes |st1#1_1_0@0| |es'#1_0@0|)) (and (=> (= (ControlFlow 0 12) (- 0 15)) (not (Induction.__default.Pes__Fail |st1#1_1_0@0| |es'#1_0@0|))) (=> (and (|Induction.__default.Pes__Step#canCall| |st1#1_1_0@0| |es'#1_0@0|) (_System.Tuple2.___hMake2_q (Induction.__default.Pes__Step |st1#1_1_0@0| |es'#1_0@0|))) (=> (and (and (and (and (and (= |let#1_1_1_0#0#0| (Induction.__default.Pes__Step |st1#1_1_0@0| |es'#1_0@0|)) (|Induction.__default.Pes__Step#canCall| |st1#1_1_0@0| |es'#1_0@0|)) (and (|Induction.__default.Pes__Step#canCall| |st1#1_1_0@0| |es'#1_0@0|) ($Is DatatypeTypeType |let#1_1_1_0#0#0| (Tclass._System.Tuple2 Tclass.Induction.S Tclass.Induction.VS)))) (and (and (_System.Tuple2.___hMake2_q |let#1_1_1_0#0#0|) (= (|#_System._tuple#2._#Make2| |st2#1_1_1_0@0| |vs#1_1_1_0@0|) |let#1_1_1_0#0#0|)) (and ($IsGoodHeap $Heap@8) ($IsHeapAnchor $Heap@8)))) (and (and (and (|Induction.__default.P__Fail#canCall| |st#0@@1| |e#1_0@0|) (=> (Induction.__default.P__Fail |st#0@@1| |e#1_0@0|) (|Induction.__default.Pes__Fail#canCall| |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))) (=> (Induction.__default.P__Fail |st#0@@1| |e#1_0@0|) (Induction.__default.Pes__Fail |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))) (and (|Induction.__default.P__Fail#canCall| |st#0@@1| |e#1_0@0|) (=> (not (Induction.__default.P__Fail |st#0@@1| |e#1_0@0|)) (forall ((|st1#1| T@U) (|v#1| T@U) ) (!  (=> (and ($IsBox |st1#1| Tclass.Induction.S) ($IsBox |v#1| Tclass.Induction.V)) (and (|Induction.__default.P__Succ#canCall| |st#0@@1| |e#1_0@0| |st1#1| |v#1|) (=> (Induction.__default.P__Succ |st#0@@1| |e#1_0@0| |st1#1| |v#1|) (and (|Induction.__default.Pes__Fail#canCall| |st1#1| |es'#1_0@0|) (=> (Induction.__default.Pes__Fail |st1#1| |es'#1_0@0|) (|Induction.__default.Pes__Fail#canCall| |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))))))
 :qid |Inductiondfy.186:39|
 :skolemid |688|
 :pattern ( (Induction.__default.P__Succ |st#0@@1| |e#1_0@0| |st1#1| |v#1|))
)))))) (and (and (and (and (=> (not (Induction.__default.P__Fail |st#0@@1| |e#1_0@0|)) (forall ((|st1#1@@0| T@U) (|v#1@@0| T@U) ) (!  (=> (and ($IsBox |st1#1@@0| Tclass.Induction.S) ($IsBox |v#1@@0| Tclass.Induction.V)) (=> (and (Induction.__default.P__Succ |st#0@@1| |e#1_0@0| |st1#1@@0| |v#1@@0|) (Induction.__default.Pes__Fail |st1#1@@0| |es'#1_0@0|)) (Induction.__default.Pes__Fail |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|))))
 :qid |Inductiondfy.186:39|
 :skolemid |689|
 :pattern ( (Induction.__default.P__Succ |st#0@@1| |e#1_0@0| |st1#1@@0| |v#1@@0|))
))) (forall ((|st1#3| T@U) (|v#3| T@U) (|st2#1| T@U) (|vs#1| T@U) ) (!  (=> (and (and (and ($IsBox |st1#3| Tclass.Induction.S) ($IsBox |v#3| Tclass.Induction.V)) ($IsBox |st2#1| Tclass.Induction.S)) ($IsBox |vs#1| Tclass.Induction.VS)) (and (|Induction.__default.P__Succ#canCall| |st#0@@1| |e#1_0@0| |st1#3| |v#3|) (=> (Induction.__default.P__Succ |st#0@@1| |e#1_0@0| |st1#3| |v#3|) (and (|Induction.__default.Pes__Succ#canCall| |st1#3| |es'#1_0@0| |st2#1| |vs#1|) (=> (Induction.__default.Pes__Succ |st1#3| |es'#1_0@0| |st2#1| |vs#1|) (and (|Induction.__default.AppendValue#canCall| |v#3| |vs#1|) (|Induction.__default.Pes__Succ#canCall| |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1| (Induction.__default.AppendValue |v#3| |vs#1|))))))))
 :qid |Inductiondfy.187:20|
 :skolemid |690|
 :pattern ( (Induction.__default.AppendValue |v#3| |vs#1|) (Induction.__default.Pes__Succ |st1#3| |es'#1_0@0| |st2#1| |vs#1|))
 :pattern ( (Induction.__default.Pes__Succ |st1#3| |es'#1_0@0| |st2#1| |vs#1|) (Induction.__default.P__Succ |st#0@@1| |e#1_0@0| |st1#3| |v#3|))
))) (and (forall ((|st1#3@@0| T@U) (|v#3@@0| T@U) (|st2#1@@0| T@U) (|vs#1@@0| T@U) ) (!  (=> (and (and (and ($IsBox |st1#3@@0| Tclass.Induction.S) ($IsBox |v#3@@0| Tclass.Induction.V)) ($IsBox |st2#1@@0| Tclass.Induction.S)) ($IsBox |vs#1@@0| Tclass.Induction.VS)) (=> (and (Induction.__default.P__Succ |st#0@@1| |e#1_0@0| |st1#3@@0| |v#3@@0|) (Induction.__default.Pes__Succ |st1#3@@0| |es'#1_0@0| |st2#1@@0| |vs#1@@0|)) (Induction.__default.Pes__Succ |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1@@0| (Induction.__default.AppendValue |v#3@@0| |vs#1@@0|))))
 :qid |Inductiondfy.187:20|
 :skolemid |691|
 :pattern ( (Induction.__default.AppendValue |v#3@@0| |vs#1@@0|) (Induction.__default.Pes__Succ |st1#3@@0| |es'#1_0@0| |st2#1@@0| |vs#1@@0|))
 :pattern ( (Induction.__default.Pes__Succ |st1#3@@0| |es'#1_0@0| |st2#1@@0| |vs#1@@0|) (Induction.__default.P__Succ |st#0@@1| |e#1_0@0| |st1#3@@0| |v#3@@0|))
)) (= $Heap@5 $Heap@8))) (and (and ($IsAllocBox |st#0@@1| Tclass.Induction.S $Heap@8) (= |##es#1_1_1_1@0| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|))) (and ($IsAlloc SeqType |##es#1_1_1_1@0| (TSeq Tclass.AST.Expr) $Heap@8) ($IsAllocBox |st2#1_1_1_0@0| Tclass.Induction.S $Heap@8)))) (and (and (and ($IsAllocBox |v#1_1_0@0| Tclass.Induction.V $Heap@8) ($IsAllocBox |vs#1_1_1_0@0| Tclass.Induction.VS $Heap@8)) (and (|Induction.__default.AppendValue#canCall| |v#1_1_0@0| |vs#1_1_1_0@0|) (= |##vs#1_1_1_0@0| (Induction.__default.AppendValue |v#1_1_0@0| |vs#1_1_1_0@0|)))) (and (and ($IsAllocBox |##vs#1_1_1_0@0| Tclass.Induction.VS $Heap@8) (|Induction.__default.Pes__Succ#canCall| |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1_1_1_0@0| (Induction.__default.AppendValue |v#1_1_0@0| |vs#1_1_1_0@0|))) (and (|Induction.__default.AppendValue#canCall| |v#1_1_0@0| |vs#1_1_1_0@0|) (|Induction.__default.Pes__Succ#canCall| |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1_1_1_0@0| (Induction.__default.AppendValue |v#1_1_0@0| |vs#1_1_1_0@0|))))))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (Induction.__default.Pes__Succ |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1_1_1_0@0| (Induction.__default.AppendValue |v#1_1_0@0| |vs#1_1_1_0@0|))) (=> (Induction.__default.Pes__Succ |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1_1_1_0@0| (Induction.__default.AppendValue |v#1_1_0@0| |vs#1_1_1_0@0|)) (=> (and (= |es##1_1_1_1@0| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) ($IsAllocBox |v#1_1_0@0| Tclass.Induction.V $Heap@8)) (=> (and (and ($IsAllocBox |vs#1_1_1_0@0| Tclass.Induction.VS $Heap@8) (|Induction.__default.AppendValue#canCall| |v#1_1_0@0| |vs#1_1_1_0@0|)) (and (|Induction.__default.AppendValue#canCall| |v#1_1_0@0| |vs#1_1_1_0@0|) (= |vs##1_1_1_0@0| (Induction.__default.AppendValue |v#1_1_0@0| |vs#1_1_1_0@0|)))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (Induction.__default.Pes__Succ |st#0@@1| |es##1_1_1_1@0| |st2#1_1_1_0@0| |vs##1_1_1_0@0|)) (=> (Induction.__default.Pes__Succ |st#0@@1| |es##1_1_1_1@0| |st2#1_1_1_0@0| |vs##1_1_1_0@0|) (=> (and ($IsGoodHeap $Heap@9) ($IsHeapAnchor $Heap@9)) (=> (and (and (|Induction.__default.Pes#canCall| |st#0@@1| |es##1_1_1_1@0|) (Induction.__default.Pes |st#0@@1| |es##1_1_1_1@0|)) (and (= $Heap@8 $Heap@9) (= (ControlFlow 0 12) 2))) GeneratedUnifiedExit_correct)))))))))))))))))
(let ((anon9_Then_correct  (=> (Induction.__default.Pes__Fail |st1#1_1_0@0| |es'#1_0@0|) (=> (and ($IsGoodHeap $Heap@6) ($IsHeapAnchor $Heap@6)) (=> (and (and (and (and (|Induction.__default.P__Fail#canCall| |st#0@@1| |e#1_0@0|) (=> (Induction.__default.P__Fail |st#0@@1| |e#1_0@0|) (|Induction.__default.Pes__Fail#canCall| |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))) (=> (Induction.__default.P__Fail |st#0@@1| |e#1_0@0|) (Induction.__default.Pes__Fail |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))) (and (and (|Induction.__default.P__Fail#canCall| |st#0@@1| |e#1_0@0|) (=> (not (Induction.__default.P__Fail |st#0@@1| |e#1_0@0|)) (forall ((|st1#1@@1| T@U) (|v#1@@1| T@U) ) (!  (=> (and ($IsBox |st1#1@@1| Tclass.Induction.S) ($IsBox |v#1@@1| Tclass.Induction.V)) (and (|Induction.__default.P__Succ#canCall| |st#0@@1| |e#1_0@0| |st1#1@@1| |v#1@@1|) (=> (Induction.__default.P__Succ |st#0@@1| |e#1_0@0| |st1#1@@1| |v#1@@1|) (and (|Induction.__default.Pes__Fail#canCall| |st1#1@@1| |es'#1_0@0|) (=> (Induction.__default.Pes__Fail |st1#1@@1| |es'#1_0@0|) (|Induction.__default.Pes__Fail#canCall| |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))))))
 :qid |Inductiondfy.186:39|
 :skolemid |688|
 :pattern ( (Induction.__default.P__Succ |st#0@@1| |e#1_0@0| |st1#1@@1| |v#1@@1|))
)))) (=> (not (Induction.__default.P__Fail |st#0@@1| |e#1_0@0|)) (forall ((|st1#1@@2| T@U) (|v#1@@2| T@U) ) (!  (=> (and ($IsBox |st1#1@@2| Tclass.Induction.S) ($IsBox |v#1@@2| Tclass.Induction.V)) (=> (and (Induction.__default.P__Succ |st#0@@1| |e#1_0@0| |st1#1@@2| |v#1@@2|) (Induction.__default.Pes__Fail |st1#1@@2| |es'#1_0@0|)) (Induction.__default.Pes__Fail |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|))))
 :qid |Inductiondfy.186:39|
 :skolemid |689|
 :pattern ( (Induction.__default.P__Succ |st#0@@1| |e#1_0@0| |st1#1@@2| |v#1@@2|))
))))) (and (and (and (forall ((|st1#3@@1| T@U) (|v#3@@1| T@U) (|st2#1@@1| T@U) (|vs#1@@1| T@U) ) (!  (=> (and (and (and ($IsBox |st1#3@@1| Tclass.Induction.S) ($IsBox |v#3@@1| Tclass.Induction.V)) ($IsBox |st2#1@@1| Tclass.Induction.S)) ($IsBox |vs#1@@1| Tclass.Induction.VS)) (and (|Induction.__default.P__Succ#canCall| |st#0@@1| |e#1_0@0| |st1#3@@1| |v#3@@1|) (=> (Induction.__default.P__Succ |st#0@@1| |e#1_0@0| |st1#3@@1| |v#3@@1|) (and (|Induction.__default.Pes__Succ#canCall| |st1#3@@1| |es'#1_0@0| |st2#1@@1| |vs#1@@1|) (=> (Induction.__default.Pes__Succ |st1#3@@1| |es'#1_0@0| |st2#1@@1| |vs#1@@1|) (and (|Induction.__default.AppendValue#canCall| |v#3@@1| |vs#1@@1|) (|Induction.__default.Pes__Succ#canCall| |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1@@1| (Induction.__default.AppendValue |v#3@@1| |vs#1@@1|))))))))
 :qid |Inductiondfy.187:20|
 :skolemid |690|
 :pattern ( (Induction.__default.AppendValue |v#3@@1| |vs#1@@1|) (Induction.__default.Pes__Succ |st1#3@@1| |es'#1_0@0| |st2#1@@1| |vs#1@@1|))
 :pattern ( (Induction.__default.Pes__Succ |st1#3@@1| |es'#1_0@0| |st2#1@@1| |vs#1@@1|) (Induction.__default.P__Succ |st#0@@1| |e#1_0@0| |st1#3@@1| |v#3@@1|))
)) (forall ((|st1#3@@2| T@U) (|v#3@@2| T@U) (|st2#1@@2| T@U) (|vs#1@@2| T@U) ) (!  (=> (and (and (and ($IsBox |st1#3@@2| Tclass.Induction.S) ($IsBox |v#3@@2| Tclass.Induction.V)) ($IsBox |st2#1@@2| Tclass.Induction.S)) ($IsBox |vs#1@@2| Tclass.Induction.VS)) (=> (and (Induction.__default.P__Succ |st#0@@1| |e#1_0@0| |st1#3@@2| |v#3@@2|) (Induction.__default.Pes__Succ |st1#3@@2| |es'#1_0@0| |st2#1@@2| |vs#1@@2|)) (Induction.__default.Pes__Succ |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1@@2| (Induction.__default.AppendValue |v#3@@2| |vs#1@@2|))))
 :qid |Inductiondfy.187:20|
 :skolemid |691|
 :pattern ( (Induction.__default.AppendValue |v#3@@2| |vs#1@@2|) (Induction.__default.Pes__Succ |st1#3@@2| |es'#1_0@0| |st2#1@@2| |vs#1@@2|))
 :pattern ( (Induction.__default.Pes__Succ |st1#3@@2| |es'#1_0@0| |st2#1@@2| |vs#1@@2|) (Induction.__default.P__Succ |st#0@@1| |e#1_0@0| |st1#3@@2| |v#3@@2|))
))) (and (= $Heap@5 $Heap@6) ($IsAllocBox |st#0@@1| Tclass.Induction.S $Heap@6))) (and (and (= |##es#1_1_0_0@0| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) ($IsAlloc SeqType |##es#1_1_0_0@0| (TSeq Tclass.AST.Expr) $Heap@6)) (and (|Induction.__default.Pes__Fail#canCall| |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (|Induction.__default.Pes__Fail#canCall| |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (Induction.__default.Pes__Fail |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|))) (=> (Induction.__default.Pes__Fail |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (=> (= |es##1_1_0_1@0| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (Induction.__default.Pes__Fail |st#0@@1| |es##1_1_0_1@0|)) (=> (Induction.__default.Pes__Fail |st#0@@1| |es##1_1_0_1@0|) (=> (and ($IsGoodHeap $Heap@7) ($IsHeapAnchor $Heap@7)) (=> (and (and (|Induction.__default.Pes#canCall| |st#0@@1| |es##1_1_0_1@0|) (Induction.__default.Pes |st#0@@1| |es##1_1_0_1@0|)) (and (= $Heap@6 $Heap@7) (= (ControlFlow 0 9) 2))) GeneratedUnifiedExit_correct))))))))))))
(let ((anon8_Else_correct  (=> (not (Induction.__default.P__Fail |st#0@@1| |e#1_0@0|)) (=> (and ($IsBox |st1#1_1_0@0| Tclass.Induction.S) ($IsAllocBox |st1#1_1_0@0| Tclass.Induction.S $Heap@2)) (=> (and (and ($IsBox |v#1_1_0@0| Tclass.Induction.V) ($IsAllocBox |v#1_1_0@0| Tclass.Induction.V $Heap@2)) (and ($IsAllocBox |st#0@@1| Tclass.Induction.S $Heap@2) ($IsAlloc DatatypeTypeType |e#1_0@0| Tclass.AST.Expr $Heap@2))) (and (=> (= (ControlFlow 0 17) (- 0 21)) (Induction.__default.P |st#0@@1| |e#1_0@0|)) (and (=> (= (ControlFlow 0 17) (- 0 20)) (not (Induction.__default.P__Fail |st#0@@1| |e#1_0@0|))) (=> (and (and (and (|Induction.__default.P__Step#canCall| |st#0@@1| |e#1_0@0|) (_System.Tuple2.___hMake2_q (Induction.__default.P__Step |st#0@@1| |e#1_0@0|))) (and (= |let#1_1_0#0#0| (Induction.__default.P__Step |st#0@@1| |e#1_0@0|)) (|Induction.__default.P__Step#canCall| |st#0@@1| |e#1_0@0|))) (and (and (|Induction.__default.P__Step#canCall| |st#0@@1| |e#1_0@0|) ($Is DatatypeTypeType |let#1_1_0#0#0| (Tclass._System.Tuple2 Tclass.Induction.S Tclass.Induction.V))) (and (_System.Tuple2.___hMake2_q |let#1_1_0#0#0|) (= (|#_System._tuple#2._#Make2| |st1#1_1_0@0| |v#1_1_0@0|) |let#1_1_0#0#0|)))) (and (=> (= (ControlFlow 0 17) (- 0 19)) (or (or (<= 0 (LitInt 0)) (< (|Seq#Rank| |es'#1_0@0|) (|Seq#Rank| |es#0@@1|))) (= (LitInt 1) (LitInt 0)))) (=> (or (or (<= 0 (LitInt 0)) (< (|Seq#Rank| |es'#1_0@0|) (|Seq#Rank| |es#0@@1|))) (= (LitInt 1) (LitInt 0))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (or (< (|Seq#Rank| |es'#1_0@0|) (|Seq#Rank| |es#0@@1|)) (and (= (|Seq#Rank| |es'#1_0@0|) (|Seq#Rank| |es#0@@1|)) (< (LitInt 1) (LitInt 0))))) (=> (or (< (|Seq#Rank| |es'#1_0@0|) (|Seq#Rank| |es#0@@1|)) (and (= (|Seq#Rank| |es'#1_0@0|) (|Seq#Rank| |es#0@@1|)) (< (LitInt 1) (LitInt 0)))) (=> (and (and (and (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5)) (|Induction.__default.Pes#canCall| |st1#1_1_0@0| |es'#1_0@0|)) (and (Induction.__default.Pes |st1#1_1_0@0| |es'#1_0@0|) (= $Heap@2 $Heap@5))) (and (and ($IsAllocBox |st1#1_1_0@0| Tclass.Induction.S $Heap@5) ($IsAlloc SeqType |es'#1_0@0| (TSeq Tclass.AST.Expr) $Heap@5)) (and (|Induction.__default.Pes__Fail#canCall| |st1#1_1_0@0| |es'#1_0@0|) (|Induction.__default.Pes__Fail#canCall| |st1#1_1_0@0| |es'#1_0@0|)))) (and (=> (= (ControlFlow 0 17) 9) anon9_Then_correct) (=> (= (ControlFlow 0 17) 12) anon9_Else_correct)))))))))))))))
(let ((anon8_Then_correct  (=> (Induction.__default.P__Fail |st#0@@1| |e#1_0@0|) (=> (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (=> (and (and (and (and (|Induction.__default.P__Fail#canCall| |st#0@@1| |e#1_0@0|) (=> (Induction.__default.P__Fail |st#0@@1| |e#1_0@0|) (|Induction.__default.Pes__Fail#canCall| |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))) (=> (Induction.__default.P__Fail |st#0@@1| |e#1_0@0|) (Induction.__default.Pes__Fail |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))) (and (and (|Induction.__default.P__Fail#canCall| |st#0@@1| |e#1_0@0|) (=> (not (Induction.__default.P__Fail |st#0@@1| |e#1_0@0|)) (forall ((|st1#1@@3| T@U) (|v#1@@3| T@U) ) (!  (=> (and ($IsBox |st1#1@@3| Tclass.Induction.S) ($IsBox |v#1@@3| Tclass.Induction.V)) (and (|Induction.__default.P__Succ#canCall| |st#0@@1| |e#1_0@0| |st1#1@@3| |v#1@@3|) (=> (Induction.__default.P__Succ |st#0@@1| |e#1_0@0| |st1#1@@3| |v#1@@3|) (and (|Induction.__default.Pes__Fail#canCall| |st1#1@@3| |es'#1_0@0|) (=> (Induction.__default.Pes__Fail |st1#1@@3| |es'#1_0@0|) (|Induction.__default.Pes__Fail#canCall| |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))))))
 :qid |Inductiondfy.186:39|
 :skolemid |688|
 :pattern ( (Induction.__default.P__Succ |st#0@@1| |e#1_0@0| |st1#1@@3| |v#1@@3|))
)))) (=> (not (Induction.__default.P__Fail |st#0@@1| |e#1_0@0|)) (forall ((|st1#1@@4| T@U) (|v#1@@4| T@U) ) (!  (=> (and ($IsBox |st1#1@@4| Tclass.Induction.S) ($IsBox |v#1@@4| Tclass.Induction.V)) (=> (and (Induction.__default.P__Succ |st#0@@1| |e#1_0@0| |st1#1@@4| |v#1@@4|) (Induction.__default.Pes__Fail |st1#1@@4| |es'#1_0@0|)) (Induction.__default.Pes__Fail |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|))))
 :qid |Inductiondfy.186:39|
 :skolemid |689|
 :pattern ( (Induction.__default.P__Succ |st#0@@1| |e#1_0@0| |st1#1@@4| |v#1@@4|))
))))) (and (and (and (forall ((|st1#3@@3| T@U) (|v#3@@3| T@U) (|st2#1@@3| T@U) (|vs#1@@3| T@U) ) (!  (=> (and (and (and ($IsBox |st1#3@@3| Tclass.Induction.S) ($IsBox |v#3@@3| Tclass.Induction.V)) ($IsBox |st2#1@@3| Tclass.Induction.S)) ($IsBox |vs#1@@3| Tclass.Induction.VS)) (and (|Induction.__default.P__Succ#canCall| |st#0@@1| |e#1_0@0| |st1#3@@3| |v#3@@3|) (=> (Induction.__default.P__Succ |st#0@@1| |e#1_0@0| |st1#3@@3| |v#3@@3|) (and (|Induction.__default.Pes__Succ#canCall| |st1#3@@3| |es'#1_0@0| |st2#1@@3| |vs#1@@3|) (=> (Induction.__default.Pes__Succ |st1#3@@3| |es'#1_0@0| |st2#1@@3| |vs#1@@3|) (and (|Induction.__default.AppendValue#canCall| |v#3@@3| |vs#1@@3|) (|Induction.__default.Pes__Succ#canCall| |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1@@3| (Induction.__default.AppendValue |v#3@@3| |vs#1@@3|))))))))
 :qid |Inductiondfy.187:20|
 :skolemid |690|
 :pattern ( (Induction.__default.AppendValue |v#3@@3| |vs#1@@3|) (Induction.__default.Pes__Succ |st1#3@@3| |es'#1_0@0| |st2#1@@3| |vs#1@@3|))
 :pattern ( (Induction.__default.Pes__Succ |st1#3@@3| |es'#1_0@0| |st2#1@@3| |vs#1@@3|) (Induction.__default.P__Succ |st#0@@1| |e#1_0@0| |st1#3@@3| |v#3@@3|))
)) (forall ((|st1#3@@4| T@U) (|v#3@@4| T@U) (|st2#1@@4| T@U) (|vs#1@@4| T@U) ) (!  (=> (and (and (and ($IsBox |st1#3@@4| Tclass.Induction.S) ($IsBox |v#3@@4| Tclass.Induction.V)) ($IsBox |st2#1@@4| Tclass.Induction.S)) ($IsBox |vs#1@@4| Tclass.Induction.VS)) (=> (and (Induction.__default.P__Succ |st#0@@1| |e#1_0@0| |st1#3@@4| |v#3@@4|) (Induction.__default.Pes__Succ |st1#3@@4| |es'#1_0@0| |st2#1@@4| |vs#1@@4|)) (Induction.__default.Pes__Succ |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |st2#1@@4| (Induction.__default.AppendValue |v#3@@4| |vs#1@@4|))))
 :qid |Inductiondfy.187:20|
 :skolemid |691|
 :pattern ( (Induction.__default.AppendValue |v#3@@4| |vs#1@@4|) (Induction.__default.Pes__Succ |st1#3@@4| |es'#1_0@0| |st2#1@@4| |vs#1@@4|))
 :pattern ( (Induction.__default.Pes__Succ |st1#3@@4| |es'#1_0@0| |st2#1@@4| |vs#1@@4|) (Induction.__default.P__Succ |st#0@@1| |e#1_0@0| |st1#3@@4| |v#3@@4|))
))) (and (= $Heap@2 $Heap@3) ($IsAllocBox |st#0@@1| Tclass.Induction.S $Heap@3))) (and (and (= |##es#1_0_0@0| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) ($IsAlloc SeqType |##es#1_0_0@0| (TSeq Tclass.AST.Expr) $Heap@3)) (and (|Induction.__default.Pes__Fail#canCall| |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (|Induction.__default.Pes__Fail#canCall| |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)))))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (Induction.__default.Pes__Fail |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|))) (=> (Induction.__default.Pes__Fail |st#0@@1| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (=> (= |es##1_0_1@0| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (Induction.__default.Pes__Fail |st#0@@1| |es##1_0_1@0|)) (=> (Induction.__default.Pes__Fail |st#0@@1| |es##1_0_1@0|) (=> (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (=> (and (and (|Induction.__default.Pes#canCall| |st#0@@1| |es##1_0_1@0|) (Induction.__default.Pes |st#0@@1| |es##1_0_1@0|)) (and (= $Heap@3 $Heap@4) (= (ControlFlow 0 6) 2))) GeneratedUnifiedExit_correct))))))))))))
(let ((anon7_Else_correct  (=> (not (|Seq#Equal| |es#0@@1| |Seq#Empty|)) (and (=> (= (ControlFlow 0 22) (- 0 27)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |es#0@@1|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |es#0@@1|))) (=> (= |e#1_0@0| ($Unbox DatatypeTypeType (|Seq#Index| |es#0@@1| (LitInt 0)))) (and (=> (= (ControlFlow 0 22) (- 0 26)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |es#0@@1|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |es#0@@1|))) (=> (= |es'#1_0@0| (|Seq#Drop| |es#0@@1| (LitInt 1))) (and (=> (= (ControlFlow 0 22) (- 0 25)) (|Seq#Equal| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |es#0@@1|)) (=> (|Seq#Equal| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |e#1_0@0|)) |es'#1_0@0|) |es#0@@1|) (and (=> (= (ControlFlow 0 22) (- 0 24)) (or (or (<= 0 (LitInt 0)) (< (DtRank |e#1_0@0|) (|Seq#Rank| |es#0@@1|))) (= (LitInt 3) (LitInt 0)))) (=> (or (or (<= 0 (LitInt 0)) (< (DtRank |e#1_0@0|) (|Seq#Rank| |es#0@@1|))) (= (LitInt 3) (LitInt 0))) (and (=> (= (ControlFlow 0 22) (- 0 23)) (< (DtRank |e#1_0@0|) (|Seq#Rank| |es#0@@1|))) (=> (< (DtRank |e#1_0@0|) (|Seq#Rank| |es#0@@1|)) (=> (and (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (|Induction.__default.P#canCall| |st#0@@1| |e#1_0@0|)) (and (Induction.__default.P |st#0@@1| |e#1_0@0|) (= $Heap@@4 $Heap@2))) (and (and ($IsAllocBox |st#0@@1| Tclass.Induction.S $Heap@2) ($IsAlloc DatatypeTypeType |e#1_0@0| Tclass.AST.Expr $Heap@2)) (and (|Induction.__default.P__Fail#canCall| |st#0@@1| |e#1_0@0|) (|Induction.__default.P__Fail#canCall| |st#0@@1| |e#1_0@0|)))) (and (=> (= (ControlFlow 0 22) 6) anon8_Then_correct) (=> (= (ControlFlow 0 22) 17) anon8_Else_correct))))))))))))))))))
(let ((anon7_Then_correct  (=> (|Seq#Equal| |es#0@@1| |Seq#Empty|) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (|Induction.__default.Pes__Fail#canCall| |st#0@@1| (Lit SeqType |Seq#Empty|)) (=> (not (Induction.__default.Pes__Fail |st#0@@1| (Lit SeqType |Seq#Empty|))) (|Induction.__default.Pes__Succ#canCall| |st#0@@1| (Lit SeqType |Seq#Empty|) |st#0@@1| Induction.__default.NilVS))) (and (=> (not (Induction.__default.Pes__Fail |st#0@@1| (Lit SeqType |Seq#Empty|))) (Induction.__default.Pes__Succ |st#0@@1| (Lit SeqType |Seq#Empty|) |st#0@@1| Induction.__default.NilVS)) (= $Heap@@4 $Heap@0))) (=> (and (and (and ($IsAllocBox |st#0@@1| Tclass.Induction.S $Heap@0) (= |##es#0_0@0| (Lit SeqType |Seq#Empty|))) (and ($IsAlloc SeqType |##es#0_0@0| (TSeq Tclass.AST.Expr) $Heap@0) ($IsAllocBox |st#0@@1| Tclass.Induction.S $Heap@0))) (and (and (= |##vs#0_0@0| Induction.__default.NilVS) ($IsAllocBox |##vs#0_0@0| Tclass.Induction.VS $Heap@0)) (and (|Induction.__default.Pes__Succ#canCall| |st#0@@1| (Lit SeqType |Seq#Empty|) |st#0@@1| Induction.__default.NilVS) (|Induction.__default.Pes__Succ#canCall| |st#0@@1| (Lit SeqType |Seq#Empty|) |st#0@@1| Induction.__default.NilVS)))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (Induction.__default.Pes__Succ |st#0@@1| (Lit SeqType |Seq#Empty|) |st#0@@1| Induction.__default.NilVS)) (=> (Induction.__default.Pes__Succ |st#0@@1| (Lit SeqType |Seq#Empty|) |st#0@@1| Induction.__default.NilVS) (=> (and (= |es##0_0@0| (Lit SeqType |Seq#Empty|)) (= |vs##0_0@0| Induction.__default.NilVS)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (Induction.__default.Pes__Succ |st#0@@1| |es##0_0@0| |st#0@@1| |vs##0_0@0|)) (=> (Induction.__default.Pes__Succ |st#0@@1| |es##0_0@0| |st#0@@1| |vs##0_0@0|) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (|Induction.__default.Pes#canCall| |st#0@@1| |es##0_0@0|) (Induction.__default.Pes |st#0@@1| |es##0_0@0|)) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct)))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (and (=> (= (ControlFlow 0 28) 3) anon7_Then_correct) (=> (= (ControlFlow 0 28) 22) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (=> (and (and (and ($IsBox |st#0@@1| Tclass.Induction.S) ($IsAllocBox |st#0@@1| Tclass.Induction.S $Heap@@4)) (and ($Is SeqType |es#0@@1| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |es#0@@1| (TSeq Tclass.AST.Expr) $Heap@@4))) (and (and ($Is DatatypeTypeType |e#1_0| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#1_0| Tclass.AST.Expr $Heap@@4)) true)) (=> (and (and (and (and ($Is SeqType |es'#1_0| (TSeq Tclass.AST.Expr)) ($IsAlloc SeqType |es'#1_0| (TSeq Tclass.AST.Expr) $Heap@@4)) true) (= 3 $FunctionContextHeight)) (and (not (Induction.__default.Pes__Fail |st#0@@1| |es#0@@1|)) (= (ControlFlow 0 29) 28))) anon0_correct)))))
