...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@6| T@U) (|e#0@@13| T@U) ) (!  (=> (or (|VarUnchanged.__default.P#canCall| |st#0@@6| |e#0@@13|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@6| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@13| Tclass.AST.Expr)))) (and (and (and (VarUnchanged.MState.MState_q |st#0@@6|) (|Interp.__default.InterpExpr#canCall| |e#0@@13| (VarUnchanged.MState.ctx |st#0@@6|))) (let ((|res#0@@0| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@13| (VarUnchanged.MState.ctx |st#0@@6|))))
 (and (|VarUnchanged.__default.Pre#canCall| |st#0@@6| |e#0@@13|) (=> (VarUnchanged.__default.Pre |st#0@@6| |e#0@@13|) (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@6| |res#0@@0|))))) (= (VarUnchanged.__default.P |st#0@@6| |e#0@@13|) (let ((|res#0@@1| (Interp.__default.InterpExpr ($LS $LZ) |e#0@@13| (VarUnchanged.MState.ctx |st#0@@6|))))
 (=> (VarUnchanged.__default.Pre |st#0@@6| |e#0@@13|) (VarUnchanged.__default.ResultSameX |st#0@@6| |res#0@@1|))))))
 :qid |Inductiondfy.34:21|
 :skolemid |721|
 :pattern ( (VarUnchanged.__default.P |st#0@@6| |e#0@@13|))
))))
...
(let ((|oe1#0@@0| (AST.Expr__Raw.oe1 |e#0@@14|)))
 (and (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |oe1#0@@0|) (VarUnchanged.__default.VarUnchanged $ly@@12 |x#0@@2| |oe2#0@@0|)))) (let ((|es#0@@5| (AST.Expr__Raw.es |e#0@@14|)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|st#0@@8| T@U) (|e#0@@19| T@U) ) (!  (=> (or (|VarUnchanged.__default.P#canCall| (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |e#0@@19|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@8| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |e#0@@19| Tclass.AST.Expr)))) (and (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@8|)) (|Interp.__default.InterpExpr#canCall| (Lit DatatypeTypeType |e#0@@19|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@8|))))) (let ((|res#2@@0| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@19|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@8|)))))))
 (and (|VarUnchanged.__default.Pre#canCall| (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |e#0@@19|)) (=> (U_2_bool (Lit boolType (bool_2_U (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |e#0@@19|))))) (|VarUnchanged.__default.ResultSameX#canCall| (Lit DatatypeTypeType |st#0@@8|) |res#2@@0|))))) (= (VarUnchanged.__default.P (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |e#0@@19|)) (U_2_bool (let ((|res#2@@1| (Lit DatatypeTypeType (Interp.__default.InterpExpr ($LS $LZ) (Lit DatatypeTypeType |e#0@@19|) (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@8|)))))))
(Lit boolType (bool_2_U  (=> (VarUnchanged.__default.Pre (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |e#0@@19|)) (VarUnchanged.__default.ResultSameX (Lit DatatypeTypeType |st#0@@8|) |res#2@@1|)))))))))
 :qid |Inductiondfy.34:21|
 :weight 3
 :skolemid |723|
 :pattern ( (VarUnchanged.__default.P (Lit DatatypeTypeType |st#0@@8|) (Lit DatatypeTypeType |e#0@@19|)))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|st#0@@9| T@U) (|res#0@@3| T@U) ) (!  (=> (or (|VarUnchanged.__default.ResultSameX#canCall| (Lit DatatypeTypeType |st#0@@9|) (Lit DatatypeTypeType |res#0@@3|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |st#0@@9| Tclass.VarUnchanged.S) ($Is DatatypeTypeType |res#0@@3| (Tclass.Utils.Result (Tclass._System.Tuple2 TInt (TMap (TSeq TChar) TInt))))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@3|))))) (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@3|))))) (let ((|ctx#3| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@3|)))))))))
 (and (_System.Tuple2.___hMake2_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@3|))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@9|)) (=> (U_2_bool (Lit boolType (bool_2_U (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@9|))))))) (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@9|)) (=> (|Set#IsMember| (|Map#Domain| |ctx#3|) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@9|)))))))) (and (and (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@9|)) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@9|))) (VarUnchanged.MState.MState_q (Lit DatatypeTypeType |st#0@@9|))))))))))) (= (VarUnchanged.__default.ResultSameX (Lit DatatypeTypeType |st#0@@9|) (Lit DatatypeTypeType |res#0@@3|)) (ite (Utils.Result.Success_q (Lit DatatypeTypeType |res#0@@3|)) (let ((|ctx#2| (Lit MapType ($Unbox MapType (_System.Tuple2._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (Utils.Result.value (Lit DatatypeTypeType |res#0@@3|)))))))))
 (=> (Utils.Option.Some_q (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@9|)))) (and (|Set#IsMember| (Lit SetType (|Map#Domain| |ctx#2|)) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@9|)))))))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| (Lit MapType (VarUnchanged.MState.ctx (Lit DatatypeTypeType |st#0@@9|)))) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@9|)))))))))) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |ctx#2|) ($Box SeqType (Lit SeqType ($Unbox SeqType (Utils.Option.value (Lit DatatypeTypeType (VarUnchanged.MState.x (Lit DatatypeTypeType |st#0@@9|)))))))))))))) true))))
 :qid |VarUnchangeddfy.41:31|
 :weight 3
 :skolemid |696|
 :pattern ( (VarUnchanged.__default.ResultSameX (Lit DatatypeTypeType |st#0@@9|) (Lit DatatypeTypeType |res#0@@3|)))
))))
...
(set-info :boogie-vc-id Impl$$VarUnchanged.__default.InductLiteral)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@6 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|VarUnchanged.__default.P#canCall| |st#0@@11| |e#0@@25|) (or (VarUnchanged.__default.P |st#0@@11| |e#0@@25|) (let ((|res#1@@2| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@25| (VarUnchanged.MState.ctx |st#0@@11|))))
 (=> (VarUnchanged.__default.Pre |st#0@@11| |e#0@@25|) (=> (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@11| |res#1@@2|) (or (VarUnchanged.__default.ResultSameX |st#0@@11| |res#1@@2|) (=> (Utils.Result.Success_q |res#1@@2|) (let ((|ctx#2@@0| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@2|))))))
 (=> (Utils.Option.Some_q (VarUnchanged.MState.x |st#0@@11|)) (|Set#IsMember| (|Map#Domain| |ctx#2@@0|) (Utils.Option.value (VarUnchanged.MState.x |st#0@@11|))))))))))))) (=> (=> (|VarUnchanged.__default.P#canCall| |st#0@@11| |e#0@@25|) (or (VarUnchanged.__default.P |st#0@@11| |e#0@@25|) (let ((|res#1@@3| (Interp.__default.InterpExpr ($LS ($LS $LZ)) |e#0@@25| (VarUnchanged.MState.ctx |st#0@@11|))))
 (=> (VarUnchanged.__default.Pre |st#0@@11| |e#0@@25|) (=> (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@11| |res#1@@3|) (or (VarUnchanged.__default.ResultSameX |st#0@@11| |res#1@@3|) (=> (Utils.Result.Success_q |res#1@@3|) (let ((|ctx#2@@1| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@3|))))))
 ...
 (=> (VarUnchanged.__default.Pre |st#0@@11| |e#0@@25|) (=> (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@11| |res#1@@4|) (or (VarUnchanged.__default.ResultSameX |st#0@@11| |res#1@@4|) (=> (Utils.Result.Success_q |res#1@@4|) (let ((|ctx#2@@2| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@4|))))))
 ...
 (=> (VarUnchanged.__default.Pre |st#0@@11| |e#0@@25|) (=> (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@11| |res#1@@5|) (or (VarUnchanged.__default.ResultSameX |st#0@@11| |res#1@@5|) (=> (Utils.Result.Success_q |res#1@@5|) (let ((|ctx#2@@3| ($Unbox MapType (_System.Tuple2._1 ($Unbox DatatypeTypeType (Utils.Result.value |res#1@@5|))))))
 ...
 (=> (VarUnchanged.__default.Pre |st#0@@11| |e#0@@25|) (=> (|VarUnchanged.__default.ResultSameX#canCall| |st#0@@11| |res#1@@6|) (or (VarUnchanged.__default.ResultSameX |st#0@@11| |res#1@@6|) (=> (not (Utils.Result.Success_q |res#1@@6|)) (U_2_bool (Lit boolType (bool_2_U true))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and ($Is DatatypeTypeType |st#0@@11| Tclass.VarUnchanged.S) ($IsAlloc DatatypeTypeType |st#0@@11| Tclass.VarUnchanged.S $Heap@@6)) (|$IsA#VarUnchanged.MState| |st#0@@11|)) (=> (and (and (and ($Is DatatypeTypeType |e#0@@25| Tclass.AST.Expr) ($IsAlloc DatatypeTypeType |e#0@@25| Tclass.AST.Expr $Heap@@6)) (|$IsA#AST.Expr__Raw| |e#0@@25|)) (and (and (= 4 $FunctionContextHeight) (AST.Expr__Raw.Literal_q |e#0@@25|)) (and (not (VarUnchanged.__default.P__Fail |st#0@@11| |e#0@@25|)) (= (ControlFlow 0 5) 2)))) anon0_correct)))))
